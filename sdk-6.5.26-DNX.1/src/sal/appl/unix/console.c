...
static int sal_thread_name_print_enabled = 1;
#endif
...
/*
 * Function:
 *	sal_console_thread_name_print_disable
 * Purpose:
 *	disable thread name prefix in console prints
...
int
sal_console_thread_name_print_enable(int enable)
{
    sal_thread_name_print_enabled = enable;
    return 0;
}
#endif
...
#ifndef	SAL_THREAD_NAME_PRINT_DISABLE
    if (sal_thread_name_print_enabled && thread_name[0] != 0) {
