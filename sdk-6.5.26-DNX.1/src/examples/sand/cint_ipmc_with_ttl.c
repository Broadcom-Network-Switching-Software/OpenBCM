 ...
 *
 * BCM.0> trap last info
 *
 * Core 0:
 * -------
 * No IRPP trap was resolved
 *
 * API: bcm_rx_trap_action_profile_get(0,154,...) -> 0 Ok
 * API: bcm_rx_trap_action_profile_get(0,154,...) -> 0 Ok
 * API: bcm_rx_trap_get(0,2049,...) -> 0 Ok
 * 
 * No ETPP trap forward action was resolved
 * No ETPP trap snoop action was resolved
 *
 * Core 1:
 * -------
 * No IRPP trap was resolved
