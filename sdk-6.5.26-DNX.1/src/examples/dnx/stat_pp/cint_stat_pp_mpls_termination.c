 ...
 * 
 ...
 Copyright 2007-2022 Broadcom Inc. All rights reserved. File: cint_stat_pp_mpls_termination.c Purpose: Statistics collection on 4 mpls tunnels.
 */
 ...
 * cint ../../../../src/examples/dnx/stat_pp/cint_stat_pp_mpls_termination.c
 * cint
 * cint_stat_pp_mpls_termination_main(0,200,201);
 * exit;
 *
 * // ETH-RIF packet
 * tx 1 psrc=200 data=0x000c0002000000110000011281000000884701770040017710400177204001773140450000350000000080005874a0000011a0a1a1a2000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f20
 *
 * // Received packets on unit 0 should be:
 * // Source port: 0, Destination port: 0
 * // Data: 0x00000000cd1d000c0002000181000032080045000035000000007f005974a0000011a0a1a1a2000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f20
 *
 * Test Scenario - end
 */
    ...
    int port2)
{
    ...
    rv = get_first_fec_in_range_which_not_in_ecmp_range(unit, 0, 0, &cint_stat_pp_mpls_4_labels_term_info.fec_id);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = l3__egress_only_fec__create(unit, cint_stat_pp_mpls_4_labels_term_info.fec_id,
                                     ...
                                     cint_stat_pp_mpls_4_labels_term_info.out_port, 0, 0);
    if (rv != BCM_E_NONE)
    {
