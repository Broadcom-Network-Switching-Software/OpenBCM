    ...
    int out_port)
{
    ...
    rv = get_first_fec_in_range_which_not_in_ecmp_range(unit, 2, 0, &cint_stat_pp_ipv6_route_info.fec_id3);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = get_first_fec_in_range_which_not_in_ecmp_range(unit, 1, 0, &cint_stat_pp_ipv6_route_info.fec_id2);
    if (rv != BCM_E_NONE)
    {
        printf("Error, get_first_fec_in_range_which_not_in_ecmp_range\n");
        return rv;
    ...
    rv = get_first_fec_in_range_which_not_in_ecmp_range(unit, 0, 0, &cint_stat_pp_ipv6_route_info.fec_id1);
    if (rv != BCM_E_NONE)
    {
        printf("Error, get_first_fec_in_range_which_not_in_ecmp_range\n");
        return rv;
