...
cint_field_udh_cascading_action_info_t field_udh_cascading_ipmf1_stacking_action_info_array[CINT_FIELD_UDH_CASCADING_NOF_BASIC_ACTIONS] = {
 /**     action_type       |   action_value   */
...
/** Stacking Qualifiers info. */
cint_field_udh_cascading_qual_info_t field_udh_cascading_epmf_j2_mode_stacking_qual_info_array[CINT_FIELD_UDH_CASCADING_NOF_BASIC_QUALS] = {
 /**  qual_type                 |   qual_value              |   qual_mask    |  input_type    |    input_arg  |  qual_offset  */
    {bcmFieldQualifyStackingRoute, CINT_FIELD_UDH_CASCADING_STACKING_ACT_VALUE << 3, 0xFFF8, {bcmFieldInputTypeMetaData, 0, 0}}
};
...
cint_field_udh_cascading_fg_info_t field_udh_cascading_j1_mode_stacking_fg_info_array[CINT_FIELD_UDH_CASCADING_NOF_BASIC_FG] = {
    /** IPMF1 info. */
    {
     ...
     field_udh_cascading_cs_info_array[0],     /** Context Selection info */
     &field_udh_cascading_user_qual_info_array[0],         /** Qualifiers info */
     field_udh_cascading_ipmf1_stacking_action_info_array        /** Actions info */
     },
    /** EPMF info. */
    {
     0,         /** Field group ID */
...
cint_field_udh_cascading_fg_info_t field_udh_cascading_j2_mode_stacking_fg_info_array[CINT_FIELD_UDH_CASCADING_NOF_BASIC_FG] = {
    /** IPMF1 info. */
    {
     0,         /** Field group ID */
     "stack_casc_ipmf1",          /** Field group Name */
    ...
    /** EPMF info. */
    {
     ...
     CINT_FIELD_UDH_CASCADING_NOF_BASIC_ACTIONS,       /** Number of tested actions */
     field_udh_cascading_cs_info_array[2],     /** Context Selection info */
     field_udh_cascading_epmf_j2_mode_stacking_qual_info_array,         /** Qualifiers info */
     field_udh_cascading_basic_action_info_array        /** Actions info */
     }
};
    ...
    cint_field_udh_cascading_action_info_t * udh_cacading_action_info)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_action_create(unit, 0, &action_info, &(udh_cacading_action_info->action_type)));
   return BCM_E_NONE;
}
    ...
    cint_field_udh_cascading_fg_info_t * udh_fg_info)
{
    ...
    {
        /** Create FWD context. */
        BCM_IF_ERROR_RETURN(field_presel_fwd_layer_main(unit, udh_fg_info->udh_cs_info.presel_id, field_stage,
    ...
    for (qual_index = 0; qual_index < udh_fg_info->nof_quals; qual_index++)
    {
        ...
        if (udh_fg_info->udh_qual_info[qual_index].qual_type == bcmFieldQualifyCount)
        {
            ...
            BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info, &(udh_fg_info->udh_qual_info[qual_index].qual_type)));
    ...
    for (action_index = 0; action_index < udh_fg_info->nof_actions; action_index++)
    {
        ...
        {
            BCM_IF_ERROR_RETURN(cint_field_udh_cascading_user_action_config(unit, fg_info.stage,
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &(udh_fg_info->fg_id)));
    printf("Field Group ID %d was created. \n", udh_fg_info->fg_id);

    
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, udh_fg_info->fg_id, udh_fg_info->udh_cs_info.context_id, &attach_info));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, udh_fg_info->fg_id, &entry_info, &(udh_fg_info->entry_handle)));
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_ipmf2_ipmf3_fg_info_array[0]));
   /** Creating IPMF3 Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_ipmf2_ipmf3_fg_info_array[1]));
   return BCM_E_NONE;
}
    ...
    int unit)
{
    ...
    /** Creating IPMF2 Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_ipmf2_epmf_fg_info_array[0]));
   /** Creating EPMF Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_ipmf2_epmf_fg_info_array[1]));
   return BCM_E_NONE;
}
    ...
    int unit)
{
    ...
    /** Creating IPMF3 Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_ipmf3_epmf_fg_info_array[0]));
   /** Creating EPMF Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_ipmf3_epmf_fg_info_array[1]));
   return BCM_E_NONE;
}
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_ipmf1_ipmf3_fg_info_array[0]));
   /** Creating IPMF3 Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_ipmf1_ipmf3_fg_info_array[1]));
   return BCM_E_NONE;
}
    ...
    int unit)
{
    ...
    /** Creating IPMF1 Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_ipmf1_epmf_fg_info_array[0]));
   /** Creating EPMF Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_ipmf1_epmf_fg_info_array[1]));
   return BCM_E_NONE;
}
    ...
    int unit)
{
    ...
    /** Creating IPMF1 Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_ipmf1_ipmf3_multiple_fg_info_array[0]));
   /** Creating IPMF3 Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_ipmf1_ipmf3_multiple_fg_info_array[1]));
   return BCM_E_NONE;
}
    ...
    int unit)
{
    ...
    /** Creating IPMF1 Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_ipmf12_ipmf3_exhaustive_fg_info_array[0]));
   /** Reuse the context of IPMF1 in IPMF2 stage. */
    ...
    /** Creating IPMF2 Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_ipmf12_ipmf3_exhaustive_fg_info_array[1]));
   /** Creating IPMF3 Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_ipmf12_ipmf3_exhaustive_fg_info_array[2]));
   return BCM_E_NONE;
}
    ...
    int unit)
{
    ...
    /** Creating IPMF1 Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_train_fg_info_array[0]));
   /** Reuse the context of IPMF1 in IPMF2 stage. */
    ...
    /** Creating IPMF2 Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_train_fg_info_array[1]));
   /** Creating IPMF3 Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_train_fg_info_array[2]));
   /** Creating EPMF Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_train_fg_info_array[3]));
   return BCM_E_NONE;
}
    ...
    int unit)
{
    ...
    /** Creating IPMF1 Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_j1_mode_fg_info_array[0]));
   /** Creating EPMF Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_j1_mode_fg_info_array[1]));
   return BCM_E_NONE;
}
    ...
    int unit)
{
    ...
    /** Creating IPMF2 Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_j1_mode_ipmf2_epmf_fg_info_array[0]));
   /** Creating EPMF Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_j1_mode_ipmf2_epmf_fg_info_array[1]));
   return BCM_E_NONE;
}
    ...
    int unit)
{
    ...
    /** Creating IPMF3 Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_j1_mode_ipmf3_epmf_fg_info_array[0]));
   /** Creating EPMF Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_j1_mode_ipmf3_epmf_fg_info_array[1]));
   return BCM_E_NONE;
}
    ...
    int unit)
{
    ...
    /** Creating IPMF1 Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_j1_mode_ipmf12_epmf_comb_fg_info_array[0]));
   /** Reuse the context of IPMF1 in IPMF2 stage. */
    ...
    /** Creating IPMF2 Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_j1_mode_ipmf12_epmf_comb_fg_info_array[1]));
   /** Creating EPMF Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_j1_mode_ipmf12_epmf_comb_fg_info_array[2]));
   return BCM_E_NONE;
}
    ...
    int unit)
{
    ...
    /** Creating IPMF1 Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_j1_mode_ipmf13_epmf_comb_fg_info_array[0]));
   /** Creating IPMF3 Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_j1_mode_ipmf13_epmf_comb_fg_info_array[1]));
   /** Creating EPMF Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_j1_mode_ipmf13_epmf_comb_fg_info_array[2]));
   return BCM_E_NONE;
}
    ...
    int unit)
{
    ...
    /** Creating IPMF2 Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_j1_mode_ipmf23_epmf_comb_fg_info_array[0]));
   /** Creating IPMF3 Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_j1_mode_ipmf23_epmf_comb_fg_info_array[1]));
   /** Creating EPMF Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_j1_mode_ipmf23_epmf_comb_fg_info_array[2]));
   return BCM_E_NONE;
}
    ...
    int unit)
{
    ...
    /** Creating IPMF1 Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_j1_mode_ipmf13_epmf_train_fg_info_array[0]));
   /** Creating IPMF3 Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_j1_mode_ipmf13_epmf_train_fg_info_array[1]));
   /** Creating EPMF Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_j1_mode_ipmf13_epmf_train_fg_info_array[2]));
   return BCM_E_NONE;
}
    ...
    int unit)
{
    ...
    /** Creating IPMF1 Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_j1_mode_ipmf1_epmf_diff_sizes_fg_info_array[0]));
   field_udh_cascading_j1_mode_ipmf1_epmf_diff_sizes_fg_info_array[1].nof_quals = CINT_FIELD_UDH_CASCADING_NOF_BASIC_QUALS;
    ...
    /** Creating EPMF Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_j1_mode_ipmf1_epmf_diff_sizes_fg_info_array[1]));
   return BCM_E_NONE;
}
    ...
    int unit)
{
    ...
    /** Creating IPMF1 Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_j1_mode_stacking_fg_info_array[0]));
   /** Creating EPMF Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_j1_mode_stacking_fg_info_array[1]));
   return BCM_E_NONE;
}

/**
 * Configure stacking cascading between IPMF1 and EPMF stages in JR2 mode.
 * Using StackingRoute to pass values from Ingress to Egress.
 */
int
cint_field_udh_cascading_j2_mode_stacking_main(
    int unit)
{

    /** Creating IPMF1 Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_j2_mode_stacking_fg_info_array[0]));
   /** Creating EPMF Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_j2_mode_stacking_fg_info_array[1]));
   return BCM_E_NONE;
}
    ...
    int unit)
{
    ...
    /** Creating IPMF1 Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_j1_mode_udh_stacking_fg_info_array[0]));
   /** Creating EPMF Field Group. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, field_udh_cascading_j1_mode_udh_stacking_fg_info_array[1]));
   return BCM_E_NONE;
}
    ...
    int is_ipmf2_exist)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, udh_fg_info->fg_id, NULL, udh_fg_info->entry_handle));
   BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, udh_fg_info->fg_id, udh_fg_info->udh_cs_info.context_id));
   BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, udh_fg_info->fg_id));
   /** In case of IPMF2 stage the context was created in IPMF1 stage. */
    ...
    {
        BCM_IF_ERROR_RETURN(field_presel_fwd_layer_destroy(unit, udh_fg_info->udh_cs_info.presel_id, field_stage,
                                            udh_fg_info->udh_cs_info.context_id));
    ...
    for (qual_index = 0; qual_index < udh_fg_info->nof_quals; qual_index++)
    {
        ...
        {
            BCM_IF_ERROR_RETURN(bcm_field_qualifier_destroy(unit, udh_fg_info->udh_qual_info[qual_index].qual_type));
    ...
    for (action_index = 0; action_index < udh_fg_info->nof_actions; action_index++)
    {
        if (udh_fg_info->udh_action_info[action_index].name != NULL)
        {
            BCM_IF_ERROR_RETURN(bcm_field_action_destroy(unit, udh_fg_info->udh_action_info[action_index].action_type));
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_ipmf2_ipmf3_fg_info_array[0], FALSE));
   /** Destroying IPMF3 Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_ipmf2_ipmf3_fg_info_array[1], FALSE));
   return BCM_E_NONE;
}
    ...
    int unit)
{
    ...
    /** Destroying IPMF2 Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_ipmf2_epmf_fg_info_array[0], FALSE));
   /** Destroying EPMF Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_ipmf2_epmf_fg_info_array[1], FALSE));
   return BCM_E_NONE;
}
    ...
    int unit)
{
    ...
    /** Destroying IPMF3 Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_ipmf3_epmf_fg_info_array[0], FALSE));
   /** Destroying EPMF Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_ipmf3_epmf_fg_info_array[1], FALSE));
   return BCM_E_NONE;
}
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_ipmf1_ipmf3_fg_info_array[0], FALSE));
   /** Destroying IPMF3 Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_ipmf1_ipmf3_fg_info_array[1], FALSE));
   return BCM_E_NONE;
}
    ...
    int unit)
{
    ...
    /** Destroying IPMF1 Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_ipmf1_epmf_fg_info_array[0], FALSE));
   /** Destroying EPMF Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_ipmf1_epmf_fg_info_array[1], FALSE));
   return BCM_E_NONE;
}
    ...
    int unit)
{
    ...
    /** Destroying IPMF1 Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_ipmf1_ipmf3_multiple_fg_info_array[0], FALSE));
   /** Destroying IPMF3 Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_ipmf1_ipmf3_multiple_fg_info_array[1], FALSE));
   return BCM_E_NONE;
}
    ...
    int unit)
{
    ...
    /** Destroying IPMF1 Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_ipmf12_ipmf3_exhaustive_fg_info_array[0], TRUE));
   /** Destroying IPMF2 Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_ipmf12_ipmf3_exhaustive_fg_info_array[1], FALSE));
   /** Destroying IPMF3 Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_ipmf12_ipmf3_exhaustive_fg_info_array[2], FALSE));
   return BCM_E_NONE;
}
    ...
    int unit)
{
    ...
    /** Destroying IPMF1 Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_train_fg_info_array[0], TRUE));
   /** Destroying IPMF2 Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_train_fg_info_array[1], FALSE));
   /** Destroying IPMF3 Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_train_fg_info_array[2], FALSE));
   /** Destroying EPMF Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_train_fg_info_array[3], FALSE));
   return BCM_E_NONE;
}
    ...
    int unit)
{
    ...
    /** Destroying IPMF1 Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_j1_mode_fg_info_array[0], TRUE));
   /** Destroying EPMF Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_j1_mode_fg_info_array[1], FALSE));
   return BCM_E_NONE;
}/** Destroy j1_mode configuration*/
    ...
    int unit)
{
    ...
    /** Destroying IPMF1 Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_j1_mode_stacking_fg_info_array[0], TRUE));
   /** Destroying EPMF Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_j1_mode_stacking_fg_info_array[1], FALSE));
   return BCM_E_NONE;
}

int
cint_field_udh_cascading_j2_mode_stacking_destroy(
    int unit)
{

    /** Destroying IPMF1 Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_j2_mode_stacking_fg_info_array[0], TRUE));
   /** Destroying EPMF Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_j2_mode_stacking_fg_info_array[1], FALSE));
   return BCM_E_NONE;
}
    ...
    int unit)
{
    ...
    /** Destroying IPMF1 Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_j1_mode_udh_stacking_fg_info_array[0], TRUE));
   /** Destroying EPMF Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_j1_mode_udh_stacking_fg_info_array[1], FALSE));
   return BCM_E_NONE;
}
    ...
    int unit)
{
    ...
    /** Destroying IPMF2 Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_j1_mode_ipmf2_epmf_fg_info_array[0], TRUE));
   /** Destroying EPMF Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_j1_mode_ipmf2_epmf_fg_info_array[1], FALSE));
   return BCM_E_NONE;
}
    ...
    int unit)
{
    ...
    /** Destroying IPMF3 Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_j1_mode_ipmf3_epmf_fg_info_array[0], TRUE));
   /** Destroying EPMF Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_j1_mode_ipmf3_epmf_fg_info_array[1], FALSE));
   return BCM_E_NONE;
}
    ...
    int unit)
{
    ...
    /** Destroying IPMF1 Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_j1_mode_ipmf12_epmf_comb_fg_info_array[0], TRUE));
   /** Destroying IPMF2 Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_j1_mode_ipmf12_epmf_comb_fg_info_array[1], FALSE));
   /** Destroying EPMF Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_j1_mode_ipmf12_epmf_comb_fg_info_array[2], FALSE));
   return BCM_E_NONE;
}
    ...
    int unit)
{
    ...
    /** Destroying IPMF1 Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_j1_mode_ipmf13_epmf_comb_fg_info_array[0], TRUE));
   /** Destroying IPMF3 Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_j1_mode_ipmf13_epmf_comb_fg_info_array[1], FALSE));
   /** Destroying EPMF Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_j1_mode_ipmf13_epmf_comb_fg_info_array[2], FALSE));
   return BCM_E_NONE;
}
...
{
    /** Destroying IPMF2 Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_j1_mode_ipmf23_epmf_comb_fg_info_array[0], TRUE));
   /** Destroying IPMF3 Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_j1_mode_ipmf23_epmf_comb_fg_info_array[1], FALSE));
   /** Destroying EPMF Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_j1_mode_ipmf23_epmf_comb_fg_info_array[2], FALSE));
   return BCM_E_NONE;
}
...
{
    /** Destroying IPMF1 Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_j1_mode_ipmf13_epmf_train_fg_info_array[0], TRUE));
   /** Destroying IPMF3 Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_j1_mode_ipmf13_epmf_train_fg_info_array[1], FALSE));
   /** Destroying EPMF Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_j1_mode_ipmf13_epmf_train_fg_info_array[2], FALSE));
    return BCM_E_NONE;
}
    ...
    int unit)
{
    ...
    /** Destroying IPMF1 Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_j1_mode_ipmf1_epmf_diff_sizes_fg_info_array[0], TRUE));
   /** Destroying EPMF Field Configuration. */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_destroy(unit, field_udh_cascading_j1_mode_ipmf1_epmf_diff_sizes_fg_info_array[1], FALSE));
   return BCM_E_NONE;
}
