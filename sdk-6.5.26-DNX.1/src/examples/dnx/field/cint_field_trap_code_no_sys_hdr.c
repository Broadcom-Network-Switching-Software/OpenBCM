...
int field_trap_code_no_sys_hdr_main(int unit, bcm_field_presel_t presel_id, uint32 trap_code, uint32 trap_mask)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_context_param_set(unit, 0, bcmFieldStageIngressPMF1, context_id, &context_param));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_presel_set(unit, 0, &presel_entry_id, &presel_data));
