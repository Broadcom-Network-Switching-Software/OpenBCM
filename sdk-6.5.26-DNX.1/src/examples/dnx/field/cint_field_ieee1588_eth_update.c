...
int cint_field_ieee1588_eth_update_main(int unit, bcm_field_context_t context_id, int nif_1_port, int nif_t_port)
{
    ...
    BCM_IF_ERROR_RETURN(get_first_fec_in_range_which_not_in_ecmp_range(unit, 0, 0, &fec_id_enc));

    BCM_IF_ERROR_RETURN(l3__egress_only_fec__create(unit, fec_id_enc, 0, arp_id_enc, gport, 0, fec_flags2));
