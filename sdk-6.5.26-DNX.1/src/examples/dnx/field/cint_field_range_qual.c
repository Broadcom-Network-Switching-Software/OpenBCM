    ...
    uint32 mask_value)
{
     ...
     * Add the FG.
     */
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &CINT_FIELD_RANGE_QUAL_FG_ID));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, CINT_FIELD_RANGE_QUAL_FG_ID, context_id, &attach_info));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, CINT_FIELD_RANGE_QUAL_FG_ID, &entry_info, &CINT_FIELD_RANGE_QUAL_ENTRY_ID));
    ...
    bcm_field_context_t context_id)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_range_set(unit, 0, stage, CINT_FIELD_RANGE_ID_PACKET_HEADER_SIZE, &range_info));
     ...
     */
    BCM_IF_ERROR_RETURN(cint_field_range_fg_create_context_attach_entry_add(unit, bcmFieldQualifyPacketLengthRangeCheck, context_id, stage, qual_value, mask_value));
    ...
    bcm_field_context_t context_id)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_range_set(unit, 0, stage, CINT_FIELD_RANGE_ID_L4_PORT, &range_info));
     ...
     * Create a FG, attach it to a context and add an entry.
     */
    BCM_IF_ERROR_RETURN(cint_field_range_fg_create_context_attach_entry_add(unit, bcmFieldQualifyL4PortRangeCheck, context_id, stage, qual_value, mask_value));
    ...
    bcm_field_context_t context_id)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, CINT_FIELD_RANGE_QUAL_FG_ID, NULL, CINT_FIELD_RANGE_QUAL_ENTRY_ID));

    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, CINT_FIELD_RANGE_QUAL_FG_ID, context_id));

    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, CINT_FIELD_RANGE_QUAL_FG_ID));
