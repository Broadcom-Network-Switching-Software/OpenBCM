...
int cint_field_in_port_qual_main(int unit, bcm_field_context_t context_id, int in_port)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &cint_in_port_qaul_fg_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, cint_in_port_qaul_fg_id, context_id, &attach_info));
    ...
    printf("Adding Entry\n");
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, cint_in_port_qaul_fg_id, &ent_info, &ent1_id));
...
{
    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, cint_in_port_qaul_fg_id, NULL, ent1_id));

    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, cint_in_port_qaul_fg_id, context_id));

    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, cint_in_port_qaul_fg_id));
