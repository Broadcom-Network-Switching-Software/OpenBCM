    ...
    bcm_field_context_t context_id)
{
    ...
    * Init function
    */
   BCM_IF_ERROR_RETURN(cint_field_range_qual_ext_init(unit));

   /**
    * Set ranges
    */
   BCM_IF_ERROR_RETURN(cint_field_range_qual_ext_create_range(unit));


   /**
    * Create field group
    */
   BCM_IF_ERROR_RETURN(cint_field_range_qual_ext_add_fg(unit, context_id));
       ...
       int unit)
{
     ...
     * Set operator
     */
    BCM_IF_ERROR_RETURN(bcm_switch_control_set(unit, bcmSwitchRangeOperator, bcmSwitchRangeOperatorNone));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_range_set(unit, 0, bcmFieldStageIngressPMF1, 0, &range_info));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_range_set(unit, 0, bcmFieldStageIngressPMF1, 1, &range_info));
    ...
    bcm_field_context_t context_id)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &cint_field_range_qual_ext_fg_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, cint_field_range_qual_ext_fg_id, context_id, &attach_info));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, cint_field_range_qual_ext_fg_id, &entry_info, cint_field_range_qual_ext_entry_id));
...
int cint_field_range_qual_ext_destroy(
    ...
    bcm_field_context_t context_id)
{
    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, cint_field_range_qual_ext_fg_id, NULL, cint_field_range_qual_ext_entry_id));

    printf("Entry 0x%X (%d) was deleted. \n", cint_field_range_qual_ext_entry_id, cint_field_range_qual_ext_entry_id);

    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, cint_field_range_qual_ext_fg_id, context_id));

    printf("Field Group %d was detach from context %d. \n", cint_field_range_qual_ext_fg_id, context_id);

    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, cint_field_range_qual_ext_fg_id));
