...
int cint_field_cascading_320b_ipmf2_fg_create(int unit, bcm_field_group_t *fg_id)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info1, &cint_field_cascading_320b_cas_qual1));


    qual_info2.size = 2;
    dst = &(qual_info2.name[0]);
    sal_strncpy_s(dst, "cascad2", 8);
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info2, &cint_field_cascading_320b_cas_qual2));
...
int cint_field_cascading_320b_ipmf2_failing_attach(int unit, bcm_field_group_t fg_id, bcm_field_context_t context_id)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_action_offset_get(unit, 0, cint_field_cascading_320b_ipmf1_fg_id, bcmFieldActionUDHData0, &action_offset));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_action_offset_get(unit, 0, cint_field_cascading_320b_ipmf1_fg_id, bcmFieldActionDropPrecedence, &action_offset));
...
int cint_field_cascading_320b_ipmf2_attach(int unit, bcm_field_group_t fg_id, bcm_field_context_t context_id)
{
    ...
    attach_info.key_info.qual_info[0].input_type = bcmFieldInputTypeCascaded;
    attach_info.key_info.qual_info[0].input_arg = cint_field_cascading_320b_ipmf1_fg_id;
    BCM_IF_ERROR_RETURN(bcm_field_group_action_offset_get(unit, 0, cint_field_cascading_320b_ipmf1_fg_id, bcmFieldActionUDHData1, &action_offset));
...
int cint_field_cascading_320b_main(int unit, bcm_field_context_t context_id)
{
    ...
    BCM_IF_ERROR_RETURN(cint_field_cascading_320b_fg_create(unit, &cint_field_cascading_320b_ipmf1_fg_id));

    /* It's a better practice to add entries, first then attach the FG */
    BCM_IF_ERROR_RETURN(cint_field_cascading_320b_ipmf1_entry_add(unit, cint_field_cascading_320b_ipmf1_fg_id, &cint_field_cascading_320b_entry_id1));

    BCM_IF_ERROR_RETURN(cint_field_cascading_320b_fg_attach(unit, cint_field_cascading_320b_ipmf1_fg_id, context_id));

    BCM_IF_ERROR_RETURN(cint_field_cascading_320b_ipmf2_fg_create(unit, &cint_field_cascading_320b_ipmf2_fg_id));
    BCM_IF_ERROR_RETURN(cint_field_cascading_320b_ipmf2_entry_add(unit, cint_field_cascading_320b_ipmf2_fg_id, &cint_field_cascading_320b_entry_id2));


    BCM_IF_ERROR_RETURN(cint_field_cascading_320b_ipmf2_failing_attach(unit, cint_field_cascading_320b_ipmf2_fg_id, context_id));

    BCM_IF_ERROR_RETURN(cint_field_cascading_320b_ipmf2_attach(unit, cint_field_cascading_320b_ipmf2_fg_id, context_id));
...
{
    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, cint_field_cascading_320b_ipmf1_fg_id, NULL, cint_field_cascading_320b_entry_id1));
    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, cint_field_cascading_320b_ipmf2_fg_id, NULL, cint_field_cascading_320b_entry_id2));

    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, cint_field_cascading_320b_ipmf2_fg_id, context_id));

    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, cint_field_cascading_320b_ipmf1_fg_id, context_id));


    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, cint_field_cascading_320b_ipmf2_fg_id));

    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, cint_field_cascading_320b_ipmf1_fg_id));
