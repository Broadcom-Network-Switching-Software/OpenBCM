...
cint_field_efes_invalidate_main(int unit)
{
    ...
    printf("Running: cint_field_efes_invalidate_main()\n");
    ...
    BCM_IF_ERROR_RETURN(bcm_field_context_create(unit, 0, bcmFieldStageIngressPMF1, &context_info, &Cint_field_efes_invalidate_context_id_ipv4_tcp));

    bcm_field_context_info_t_init(&context_info);
    dest_char = &(context_info.name[0]);
    sal_strncpy_s(dest_char, "IPv4_OTHER", sizeof(context_info.name));
    BCM_IF_ERROR_RETURN(bcm_field_context_create(unit, 0, bcmFieldStageIngressPMF1, &context_info, &Cint_field_efes_invalidate_context_id_ipv4_other));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &Cint_field_efes_invalidate_fg_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, Cint_field_efes_invalidate_fg_id, Cint_field_efes_invalidate_context_id_ipv4_tcp, &fg_attach_info));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, Cint_field_efes_invalidate_fg_id, Cint_field_efes_invalidate_context_id_ipv4_other, &fg_attach_info));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, Cint_field_efes_invalidate_fg_id, &entry_info, &Cint_field_efes_invalidate_entry_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_presel_set(unit, 0, &entry_id, &entry_data));
...
cint_field_efes_invalidate_destroy(int unit)
{
    ...
    printf("Running: cint_field_efes_invalidate_destroy()\n");
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, Cint_field_efes_invalidate_fg_id, Cint_field_efes_invalidate_context_id_ipv4_tcp));

    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, Cint_field_efes_invalidate_fg_id, Cint_field_efes_invalidate_context_id_ipv4_other));

    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, Cint_field_efes_invalidate_fg_id, NULL, Cint_field_efes_invalidate_entry_id));

    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, Cint_field_efes_invalidate_fg_id));

    BCM_IF_ERROR_RETURN(bcm_field_context_destroy(unit, bcmFieldStageIngressPMF1, Cint_field_efes_invalidate_context_id_ipv4_tcp));

    BCM_IF_ERROR_RETURN(bcm_field_context_destroy(unit, bcmFieldStageIngressPMF1, Cint_field_efes_invalidate_context_id_ipv4_other));
