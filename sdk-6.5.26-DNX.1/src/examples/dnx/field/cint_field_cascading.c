    ...
    bcm_field_group_info_t * fg_info_p)
{
    ...
    switch (stage)
    {
        ...
        case bcmFieldStageIngressPMF2:
        {
            ...
            BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info, &bcm_udf_qual));
        ...
        bcm_field_group_attach_info_t * attach_info_p)
{
    ...
    switch (stage)
    {
        ...
        case bcmFieldStageIngressPMF2:
        {
             ...
             */
            BCM_IF_ERROR_RETURN(bcm_field_group_action_offset_get(unit, 0, ipmf1_cascaded_fg_id,
        ...
        bcm_field_group_info_t * cascaded_fg_info_p)
{
    ...
    BCM_IF_ERROR_RETURN(cint_field_cascading_set_attach_info(unit, stage, ipmf1_cascaded_fg_id, cascaded_fg_info_p, &attach_info));
...
int cint_field_cascading_context_create(int unit, bcm_field_context_t ipmf1_context_id)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_context_create(unit, BCM_FIELD_FLAG_WITH_ID, bcmFieldStageIngressPMF1, &ipmf1_context_info, &ipmf1_context_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_presel_set(unit, 0, &ipmf1_p_id, &p_data));
...
int cint_field_cascading_cascaded_context_create(int unit, bcm_field_context_t ipmf1_context_id, bcm_field_context_t ipmf2_context_id, bcm_field_group_t ipmf1_fg_id, int cascaded_action_value)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_context_create(unit, BCM_FIELD_FLAG_WITH_ID, bcmFieldStageIngressPMF2, &ipmf2_context_info, &ipmf2_context_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_presel_set(unit, 0, &ipmf2_p_id, &p_data));
...
int cint_field_cascading_main(int unit, bcm_field_context_t ipmf1_context_id, bcm_field_context_t ipmf2_context_id)
{
    ...
    /******************IPMF1 Configuration* *******/
    /**********************************************/
    BCM_IF_ERROR_RETURN(cint_field_cascading_context_create(unit, ipmf1_context_id));


    BCM_IF_ERROR_RETURN(cint_field_cascading_fg_add(unit, bcmFieldStageIngressPMF1, bcmFieldGroupTypeTcam, &ipmf1_fg_id, &Cint_field_cascading_ipmf1_fg_info));


    BCM_IF_ERROR_RETURN(cint_field_cascading_fg_attach(unit, bcmFieldStageIngressPMF1, ipmf1_context_id, ipmf1_fg_id,
    ...
    if (ipmf2_context_id != ipmf1_context_id)
    {
         ...
         */
        BCM_IF_ERROR_RETURN(cint_field_cascading_cascaded_context_create(unit, ipmf1_context_id, ipmf2_context_id, ipmf1_fg_id, cascaded_action_value));

    }

    BCM_IF_ERROR_RETURN(cint_field_cascading_fg_add(unit, bcmFieldStageIngressPMF2, bcmFieldGroupTypeTcam, &ipmf2_fg_id, &Cint_field_cascading_ipmf2_fg_info));


    BCM_IF_ERROR_RETURN(cint_field_cascading_fg_attach(unit, bcmFieldStageIngressPMF2, ipmf2_context_id, ipmf2_fg_id, ipmf1_fg_id, &Cint_field_cascading_ipmf2_fg_info, &Cint_field_cascading_ipmf1_fg_info));


    /**********************************************/
    /******************Entry Configuration* *******/
    /**********************************************/
    BCM_IF_ERROR_RETURN(cint_field_cascading_entry_add(unit, bcmFieldStageIngressPMF1, ipmf1_context_id, ipmf1_fg_id, &Cint_field_cascading_ipmf1_fg_info, cascaded_action_value, 2, &ipmf1_entry_handle));

    BCM_IF_ERROR_RETURN(cint_field_cascading_entry_add(unit, bcmFieldStageIngressPMF2, ipmf2_context_id, ipmf2_fg_id, &Cint_field_cascading_ipmf2_fg_info, cascaded_action_value, 0, &ipmf2_entry_handle));
...
int cint_field_cascading_destroy(int unit, bcm_field_context_t ipmf1_context_id, bcm_field_context_t ipmf2_context_id)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_presel_set(unit, 0, &ipmf1_p_id, &presel_entry_data));
    ...
    if (ipmf1_context_id != ipmf2_context_id)
    {
        bcm_field_presel_entry_data_info_init(&presel_entry_data);
        presel_entry_data.entry_valid = FALSE;
        BCM_IF_ERROR_RETURN(bcm_field_presel_set(unit, 0, &ipmf2_p_id, &presel_entry_data));
    }

    /* delete the entry from the IPMF1 FG*/
    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, ipmf1_fg_id, NULL, ipmf1_entry_handle));

    /* delete the entry from the IPMF2 FG*/
    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, ipmf2_fg_id, NULL, ipmf2_entry_handle));

    /* Detach the IPMF2 FG from its context */
    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, ipmf2_fg_id, ipmf2_context_id));


    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, ipmf1_fg_id, ipmf1_context_id));


    /* destroy the field group from the IPMF1 */
    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, ipmf1_fg_id));


    /* destroy the field group from the IPMF2 */
    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, ipmf2_fg_id));


    /* destroy the qualifier from the IPMF1 FG*/
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_destroy(unit, bcm_udf_qual));
    ...
    if (ipmf1_context_id != ipmf2_context_id)
    {
        BCM_IF_ERROR_RETURN(bcm_field_context_destroy(unit, bcmFieldStageIngressPMF2, ipmf2_context_id));

    }

    BCM_IF_ERROR_RETURN(bcm_field_context_destroy(unit, bcmFieldStageIngressPMF1, ipmf1_context_id));
