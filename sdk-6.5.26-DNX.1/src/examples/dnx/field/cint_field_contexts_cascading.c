...
int field_contexts_cascading_main(int unit, uint32 presel_id, bcm_field_context_t context_id_ipmf1)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_context_create(unit, 0, bcmFieldStageIngressPMF2, &context_info, &context_id_ipmf2));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_presel_set(unit, 0, &presel_ent, &presel_data));
...
int field_contexts_cascading_destroy(int unit)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_context_destroy(unit, bcmFieldStageIngressPMF2, context_id_ipmf2));
