    ...
    bcm_field_group_t * fg_id_p)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_action_create(unit, 0, &action_info, &cint_field_external_per_core_external_uda));
    ...
    bcm_core_t core_id)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, external_fg_id, &entry_info, &cint_field_external_per_core_entry_id));
    ...
    bcm_core_t core_id)
{
    ...
    BCM_IF_ERROR_RETURN(cint_field_external_per_core_fg_add(unit, &fg_info, &cint_field_external_per_core_fg_id));

    BCM_IF_ERROR_RETURN(cint_field_external_per_core_fg_attach(unit, cint_field_external_per_core_fg_id, &fg_info, cint_field_external_per_core_external_app_type, cint_field_external_per_core_payload_id, cint_field_external_per_core_payload_offset));

    BCM_IF_ERROR_RETURN(bcm_switch_control_set(unit, bcmSwitchExternalTcamSync, 0));

    BCM_IF_ERROR_RETURN(cint_field_external_per_core_entry_add(unit, cint_field_external_per_core_fg_id, &fg_info, core_id));
...
cint_field_external_per_core_destroy(int unit)
{
     ...
     */
    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, cint_field_external_per_core_fg_id, NULL, cint_field_external_per_core_entry_id));
