       ...
       int ctx_id)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &cint_field_tcam_entry_cache_fg_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, cint_field_tcam_entry_cache_fg_id, cint_field_tcam_entry_cache_ctx_id, &attach_info));
     ...
     */
    BCM_IF_ERROR_RETURN(bcm_field_group_cache(unit, 0, cint_field_tcam_entry_cache_fg_id, bcmFieldGroupCacheModeStart));
    ...
    for (ii = 0; ii < nof_entries; ii++)
    {
        ...
        BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, cint_field_tcam_entry_cache_fg_id, &entry_info, &cint_field_tcam_entry_cache_entry_ids[ii]));
     ...
     */
    BCM_IF_ERROR_RETURN(bcm_field_group_cache(unit, 0, cint_field_tcam_entry_cache_fg_id, bcmFieldGroupCacheModeClear));
     ...
     */
    BCM_IF_ERROR_RETURN(bcm_field_group_cache(unit, 0, cint_field_tcam_entry_cache_fg_id, bcmFieldGroupCacheModeInstall));
        ...
        int ctx_id)
{
    ...
    for (ii = 0; ii < nof_entries; ii++)
    {
        BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, cint_field_tcam_entry_cache_fg_id, NULL, cint_field_tcam_entry_cache_entry_ids[ii]));
        printf("Entry 0x%X (%d) was deleted. \n", cint_field_tcam_entry_cache_entry_ids[ii], cint_field_tcam_entry_cache_entry_ids[ii]);
    }

    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, cint_field_tcam_entry_cache_fg_id, ctx_id));

    printf("Field Group %d was detach from context %d. \n", cint_field_tcam_entry_cache_fg_id, ctx_id);

    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, cint_field_tcam_entry_cache_fg_id));
