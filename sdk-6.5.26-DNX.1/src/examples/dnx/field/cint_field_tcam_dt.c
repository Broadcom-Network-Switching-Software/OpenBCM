    ...
    int bank_mode)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_context_create(unit, 0, field_stage_internal, &context_info, &cint_field_tcam_dt_context_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_presel_set(unit, 0, &cint_field_tcam_dt_presel_entry_id, &presel_data));
    ...
    if (field_stage == bcmFieldStageIngressPMF3)
    {
        ...
        qual_info.size = 8;
        BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_tcam_dt_qual_id));
    }
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &fg_dt_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, fg_dt_id, cint_field_tcam_dt_context_id, &attach_info));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &fg_special_id));


    printf("Creating new context for the special FG...\n");
    bcm_field_context_info_t_init(&context_info);
    BCM_IF_ERROR_RETURN(bcm_field_context_create(unit, 0, field_stage_internal, &context_info, &cint_field_tcam_context_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, fg_special_id, cint_field_tcam_context_id, &attach_info));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, fg_dt_id, &ent_dt_info, &ent_dt_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, fg_special_id, &ent_special_info, &ent_special_id));
    ...
    bcm_field_stage_t field_stage)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, fg_special_id, NULL, ent_special_id));


    printf("Deleting DT entry...\r\n");
    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, fg_dt_id, NULL, ent_dt_id));


    printf("Detaching special FG from created context...\r\n");
    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, fg_special_id, cint_field_tcam_context_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_context_destroy(unit, field_stage_internal, cint_field_tcam_context_id));


    printf("Detaching DT FG from context...\r\n");
    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, fg_dt_id, cint_field_tcam_dt_context_id));

    printf("Deleting special FG...\r\n");
    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, fg_special_id));

 
    printf("Deleting DT FG...\r\n");
    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, fg_dt_id));


    if (field_stage == bcmFieldStageIngressPMF3)
    {
        BCM_IF_ERROR_RETURN(bcm_field_qualifier_destroy(unit, cint_field_tcam_dt_qual_id));
    }
    ...
    printf("Destroying created context...\r\n");
    BCM_IF_ERROR_RETURN(bcm_field_context_destroy(unit, field_stage_internal, cint_field_tcam_dt_context_id));
