                             ...
                             /* in */ bcm_gport_t snoop_trap_gport_id)
{
    ...
    */
    ...
    BCM_IF_ERROR_RETURN(bcm_field_range_set(unit, 0, bcmFieldStageIngressPMF1, range_id, &range_info));
    ...
    */
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &cint_field_ip_snoop_fg_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, cint_field_ip_snoop_fg_id, context_id, &attach_info));
    ...
    */
    ...
    printf("Adding Entry\n");
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, cint_field_ip_snoop_fg_id, &ent_info, &cint_field_ip_snoop_ent_id));
...
int cint_field_ip_snoop_main(int unit,bcm_field_context_t context_id, bcm_port_t in_port, int dest_local_port, int udp_port_min, int udp_port_max)
{
    ...
    BCM_IF_ERROR_RETURN(cint_field_ip_snoop_set(unit, dest_local_port,0, 0, 0, &snoop_trap_gport_id, &mirror_dest_id_dummy));

    BCM_IF_ERROR_RETURN(cint_field_ip_snoop_fg_set(unit, context_id, in_port, udp_port_min, udp_port_max, snoop_trap_gport_id));
...
int cint_field_ip_snoop_destroy(int unit, bcm_field_context_t context_id)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_mirror_destination_destroy(unit, mirror_dest.mirror_dest_id));

    BCM_IF_ERROR_RETURN(bcm_rx_trap_type_destroy(unit, trap_id));

    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, cint_field_ip_snoop_fg_id, NULL, cint_field_ip_snoop_ent_id));
    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, cint_field_ip_snoop_fg_id, context_id));
    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, cint_field_ip_snoop_fg_id));
