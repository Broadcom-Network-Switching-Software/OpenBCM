    ...
    bcm_field_action_t *action_drop_id)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_action_create(unit, 0, &action_info, action_drop_id));
...
int cint_field_action_drop_destroy(
    ...
    bcm_field_action_t action_drop_id)
{
    BCM_IF_ERROR_RETURN(bcm_field_action_destroy(unit, action_drop_id));
    ...
    uint32 src_ip_val)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &actio_drop_fg_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, actio_drop_fg_id, context_id, &attach_info));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, actio_drop_fg_id, &ent_info, &action_drop_entry_id));
    ...
    bcm_field_context_t context_id)
{
    ...
    bcm_field_entry_info_t_init(&ent_info);
    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, actio_drop_fg_id, ent_info.entry_qual, action_drop_entry_id));

    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit,actio_drop_fg_id,context_id));

    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, actio_drop_fg_id));

    BCM_IF_ERROR_RETURN(cint_field_action_drop_destroy(unit, action_drop));
