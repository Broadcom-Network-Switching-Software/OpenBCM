    ...
    uint32 non_first_fragmented)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &Cint_field_ipv6_fragmented_non_first_fg_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, Cint_field_ipv6_fragmented_non_first_fg_id, context_id, &attach_info));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, Cint_field_ipv6_fragmented_non_first_fg_id, &entry_info, &Cint_field_ipv6_fragmented_non_first_entry_handle));
...
cint_field_ipv6_fragmented_non_first_destroy(
    ...
    bcm_field_context_t context_id)
{
    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, Cint_field_ipv6_fragmented_non_first_fg_id, NULL, Cint_field_ipv6_fragmented_non_first_entry_handle));

    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, Cint_field_ipv6_fragmented_non_first_fg_id, context_id));

    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, Cint_field_ipv6_fragmented_non_first_fg_id));
