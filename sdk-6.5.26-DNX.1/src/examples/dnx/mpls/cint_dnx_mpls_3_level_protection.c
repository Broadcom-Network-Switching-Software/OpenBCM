    ...
    uint8 ttl_value)
{
    ...
    rv = get_first_fec_in_range_which_not_in_ecmp_range(unit, 0, 0, &cint_mpls_3_level_protection_basic_info.fec_ids_primary[0]);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = get_first_fec_in_range_which_not_in_ecmp_range(unit, 1, 0, &cint_mpls_3_level_protection_basic_info.fec_ids_primary[1]);
    if (rv != BCM_E_NONE)
    {
        printf("Error, get_first_fec_in_range_which_not_in_ecmp_range\n");
        return rv;
    ...
    rv = get_first_fec_in_range_which_not_in_ecmp_range(unit, 2, 0, &cint_mpls_3_level_protection_basic_info.fec_ids_primary[2]);
    if (rv != BCM_E_NONE)
    {
        printf("Error, get_first_fec_in_range_which_not_in_ecmp_range\n");
        return rv;
