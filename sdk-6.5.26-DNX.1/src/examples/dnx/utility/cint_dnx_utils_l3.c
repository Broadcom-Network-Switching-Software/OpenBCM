...
int default_esem_invalid = -1;
int default_egr_vlan_port_id_out = default_esem_invalid;
...
/*******************************************************************************
 *
 * Example translations for the usages of L3 APIs from DNX(JR2) begin
 ...
 *
 */
int dnx_l3_egress_create(int unit, uint32 flags, bcm_l3_egress_t *egr, bcm_if_t *if_id)
{
    int rv;
...
void dnx_utils_l3_fec_s_init(int unit, uint32 flags, dnx_utils_l3_fec_s *fec_structure)
{
...
void dnx_utils_l3_fec_s_common_init(int unit, uint32 allocation_flags, uint32 flags, dnx_utils_l3_fec_s *fec_structure, uint32 fec_id, uint32 l3_flags, uint32 l3_flags2, bcm_gport_t destination, bcm_if_t tunnel_gport, bcm_if_t tunnel_gport2)
{
    dnx_utils_l3_fec_s_init(unit, 0, fec_structure);
 ...
 * Note: Assume dnx_utils_l3_fec_s_*_init function is being called before.
 */
int dnx_utils_l3_fec_create(int unit, dnx_utils_l3_fec_s *fec_structure) {
    int rc;
...
void dnx_utils_l3_arp_s_init(int unit, uint32 flags, dnx_utils_l3_arp_s *arp_structure)
{
    sal_memset(arp_structure, 0, sizeof (*arp_structure));
}

/* Initilize ARP structure with common params */
void dnx_utils_l3_arp_s_common_init(int unit, uint32 flags, dnx_utils_l3_arp_s *arp_structure, uint32 arp_id, uint32 l3_flags, uint32 l3_flags2, bcm_mac_t next_hop, int eth_rif)
{
    dnx_utils_l3_arp_s_init(unit, 0, arp_structure);
...
int dnx_utils_l3_arp_create(int unit, dnx_utils_l3_arp_s *arp_structure)
{
    int rc;
    uint32 flags;
    bcm_l3_egress_t l3eg;
    ...
    bcm_l3_egress_t_init(&l3eg);
    printf("inside dnx_utils_l3_arp_create");
    ...
    printf("done dnx_utils_l3_arp_create");
...
void dnx_utils_l3_egress_s_init(int unit, uint32 flags, l3_egress_s *l3_egress)
{
    sal_memset(l3_egress, 0, sizeof (*l3_egress));
}

/* Create egress object(FEC and ARP entry)*/
int dnx_utils_l3_egress_create(int unit, l3_egress_s *l3_egress) {
    int rc;
    ...
    rc = dnx_l3_egress_create(unit, l3_egress->allocation_flags, &l3eg, &l3egid);
    if (rc != BCM_E_NONE) {
        printf("Error, create egress object, unit=%d, \n", unit);
        return rc;
    }
    ...
    int is_set)
{
    ...
    int snp_strength = 0;
    int trap_id = 0;
    int mtu_profile = 1; /* Use value different than default */
...
void dnx_utils_l3_eth_rif_s_init(int unit, uint32 flags, dnx_utils_l3_eth_rif_s *eth_rif_structure)
{
    sal_memset(eth_rif_structure, 0, sizeof (*eth_rif_structure));
}
/* Initilize ETH-RIF structure with common params */
void dnx_utils_l3_eth_rif_s_common_init(int unit, uint32 flags, dnx_utils_l3_eth_rif_s *eth_rif_structure, uint32 eth_rif_id, uint32 l3_flags, uint32 l3_ingress_flags, bcm_mac_t my_mac, int vrf)
{
    dnx_utils_l3_eth_rif_s_init(unit, 0, eth_rif_structure);
...
int dnx_utils_l3_eth_rif_create(int unit, dnx_utils_l3_eth_rif_s *eth_rif_structure)
{
    bcm_l3_intf_t l3if;
    bcm_l3_ingress_t l3_ing_if;
    int rc;
    int compressed_layer_type = (*(dnxc_data_get(unit, "trap", "etpp", "mtu_layer_to_compressed_layer_mapping_support", NULL))) ? 2 : bcmRxTrapMtuLayerTypeIpv4 ;
    ...
    if (eth_rif_structure->mtu_valid) {
        ...
        rc = mtu_check_etpp_rif_set(unit, eth_rif_structure->l3_rif, compressed_layer_type , eth_rif_structure->mtu, 1/*is_set*/);
        if (rc != BCM_E_NONE) {
 ...
 */
struct dnx_utils_l3_host_ipv4_s
{
    /* IN */
    uint32 flags; /* BCM_L3_XXX */
    uint32 flags2; /* BCM_L3_FLAGS2_XXX */
...
void dnx_utils_l3_host_ipv4_s_init(int unit, uint32 flags, dnx_utils_l3_host_ipv4_s *host_ipv4_structure)
{
    sal_memset(host_ipv4_structure, 0, sizeof (*host_ipv4_structure));
}
/* Initilize Host structure with common params */
void dnx_utils_l3_host_ipv4_s_common_init(
        int unit, uint32 flags,
        dnx_utils_l3_host_ipv4_s *host_ipv4_structure,
        bcm_ip_t addr, bcm_vrf_t vrf, uint32 l3_flags, uint32 l3_flags2, bcm_if_t fec_id)
{
    dnx_utils_l3_host_ipv4_s_init(unit, 0, host_ipv4_structure);
...
int dnx_utils_l3_host_ipv4_add(int unit, dnx_utils_l3_host_ipv4_s *host_ipv4_structure)
{
    int rc;
    bcm_l3_host_t host;
    ...
    if (host_ipv4_structure->destination != 0)
    {
        ...
        {
            printf("dnx_utils_l3_host_ipv4_add failed on invalid params: intf is FEC 0x%08x but destination 0x%08x is non 0 \n", host_ipv4_structure->fec_id, host_ipv4_structure->destination);
            return BCM_E_PARAM;
        }
 ...
 */
struct dnx_utils_l3_host_ipv6_s
{
    /* IN */
    uint32 flags; /* BCM_L3_XXX */
    uint32 flags2; /* BCM_L3_FLAGS2_XXX */
...
/* Initilize Host ipv4  structure to all 0s */
void dnx_utils_l3_host_ipv6_s_init(int unit, uint32 flags, dnx_utils_l3_host_ipv6_s *host_ipv6_structure)
{
    sal_memset(host_ipv6_structure, 0, sizeof (*host_ipv6_structure));
}
/* Initilize Host structure with common params */
void dnx_utils_l3_host_ipv6_s_common_init(int unit, uint32 flags, dnx_utils_l3_host_ipv6_s *host_ipv6_structure, bcm_ip6_t addr, bcm_vrf_t vrf, uint32 l3_flags, uint32 l3_flags2, bcm_if_t fec_id)
{
    dnx_utils_l3_host_ipv6_s_init(unit, 0, host_ipv6_structure);
...
int dnx_utils_l3_host_ipv6_add(int unit, dnx_utils_l3_host_ipv6_s *host_ipv6_structure)
{
    int rc;
    bcm_l3_host_t host;
    bcm_l3_host_t_init(&host);
    ...
    if (host_ipv6_structure->destination != 0)
    {
        ...
        {
            printf("dnx_utils_l3_host_ipv6_add failed on invalid params: intf is FEC 0x%08x but destination 0x%08x is non 0 \n", host_ipv4_structure->fec_id, host_ipv4_structure->destination);
            return BCM_E_PARAM;
        }
    }
    rc = bcm_l3_host_add(unit, host);
 ...
 */
struct dnx_utils_l3_route_ipv4_s
{
    /* IN */
    uint32 flags; /* BCM_L3_XXX */
    uint32 flags2; /* BCM_L3_FLAGS2_XXX */
...
void dnx_utils_l3_route_ipv4_s_init(int unit, uint32 flags, dnx_utils_l3_route_ipv4_s *route_ipv4_structure)
{
    sal_memset(route_ipv4_structure, 0, sizeof (*route_ipv4_structure));
}
/* Initilize Route structure with common params */
void dnx_utils_l3_route_ipv4_s_common_init(int unit, uint32 flags, dnx_utils_l3_route_ipv4_s *route_ipv4_structure, bcm_ip_t addr, bcm_ip_t mask, bcm_vrf_t vrf, uint32 l3_flags, uint32 l3_flags2, bcm_if_t fec_id)
{
    dnx_utils_l3_route_ipv4_s_init(unit, 0, route_ipv4_structure);
...
int dnx_utils_l3_route_ipv4_add(int unit, dnx_utils_l3_route_ipv4_s *route_ipv4_structure)
{
    int rc;
    bcm_l3_route_t l3rt;
 ...
 */
struct dnx_utils_l3_route_ipv6_s
{
    /* IN */
    uint32 flags; /* BCM_L3_XXX */
    uint32 flags2; /* BCM_L3_FLAGS2_XXX */
...
/* Initilize Route ipv4  structure to all 0s */
void dnx_utils_l3_route_ipv6_s_init(int unit, uint32 flags, dnx_utils_l3_route_ipv6_s *route_ipv6_structure)
{
    sal_memset(route_ipv6_structure, 0, sizeof (*route_ipv6_structure));
}
/* Initilize Route structure with common params */
void dnx_utils_l3_route_ipv6_s_common_init(int unit, uint32 flags, dnx_utils_l3_route_ipv6_s *route_ipv6_structure, bcm_ip6_t addr, bcm_ip6_t mask, bcm_vrf_t vrf, uint32 l3_flags, uint32 l3_flags2, bcm_if_t fec_id)
{
    dnx_utils_l3_route_ipv6_s_init(unit, 0, route_ipv6_structure);
...
int dnx_utils_l3_route_ipv6_add(int unit, dnx_utils_l3_route_ipv6_s *route_ipv6_structure)
{
    int rc;
    bcm_l3_route_t l3rt;
    bcm_l3_route_t_init(l3rt);
 ...
 */
struct dnx_utils_l3_vpbr_ipv4_s
{
    /* IN */
    uint32 flags; /* BCM_L3_XXX */
    uint32 flags2; /* BCM_L3_FLAGS2_XXX */
...
/* Initilize Route ipv4  structure to all 0s */
void dnx_utils_l3_vpbr_ipv4_s_init(int unit, uint32 flags, dnx_utils_l3_vpbr_ipv4_s *vpbr_ipv4_structure)
{
    sal_memset(vpbr_ipv4_structure, 0, sizeof (*vpbr_ipv4_structure));
}
/* Initilize ARP structure with common params */
void dnx_utils_l3_vpbr_ipv4_s_common_init(int unit, uint32 flags, dnx_utils_l3_vpbr_ipv4_s *vpbr_ipv4_structure, bcm_ip_t dip_addr, bcm_ip_t dip_mask,
        bcm_ip_t sip_addr, bcm_ip_t sip_mask, bcm_vrf_t vrf, uint32 vpbr_flags, bcm_vrf_t new_vrf)
{
    dnx_utils_l3_vpbr_ipv4_s_init(unit, 0, vpbr_ipv4_structure);
...
int dnx_utils_l3_vpbr_ipv4_add(int unit, dnx_utils_l3_vpbr_ipv4_s *vpbr_ipv4_structure)
{
    int rc;
...
/* Initilize L3-port structure to all 0s */
void dnx_utils_l3_port_s_init(int unit, uint32 flags, dnx_utils_l3_port_s *l3_port_structure)
{
    sal_memset(l3_port_structure, 0, sizeof (*l3_port_structure));
}
/* Initilize L3-port structure with common params */
void dnx_utils_l3_port_s_common_init(int unit, uint32 flags, dnx_utils_l3_port_s *l3_port_structure, bcm_gport_t port, uint32 eth_rif_id)
{
    dnx_utils_l3_port_s_init(unit, 0, l3_port_structure);

    l3_port_structure->port = port;
    l3_port_structure->eth_rif_id = eth_rif_id;
    l3_port_structure->eg_vlan_port_id = default_esem_invalid;
}

int dnx_utils_l3_port_set(int unit, dnx_utils_l3_port_s *l3_port_structure)
{
    ...
    if (l3_port_structure->eg_vlan_port_id != default_esem_invalid)
    {
 ...
 *
 */
int dnx_utils_l3__intf_rif__create(int unit, create_l3_intf_s *l3_intf){
...
int dnx_utils_l3__egress_only_encap__create(int unit, create_l3_egress_s *l3_egress) {
...
int dnx_utils_l3__egress_only_fec__create(int unit, create_l3_egress_s *l3_egress) {
    int rc;
    bcm_l3_egress_t l3eg;
    bcm_if_t l3egid;
    bcm_l3_egress_t_init(&l3eg);
...
/* Delete l3 Interface*/
int dnx_utils_l3__intf__delete(int unit, int intf)
{
    int rc;
    bcm_l3_intf_t l3if;
