...
int dnx_utils_vxlan_open_vpn(int unit, int vpn, int port_class, int vni){
    ...
    rv =  dnx_utils_vxlan_multicast_create(unit, vpn);
    if (rv != BCM_E_NONE) {
        printf("Error, dnx_utils_vxlan_multicast_create\n");
        return rv;
    }    
...
int dnx_utils_vxlan_multicast_destroy(int unit, int vpn) 
{
    ...
    rv = bcm_multicast_group_destroy(unit, flags, vpn);
    if (rv != BCM_E_NONE)
    {
...
int dnx_utils_vxlan_close_vpn(int unit, int vpn, int port_class, int vni) 
{
    ...
    rv = dnx_utils_vxlan_multicast_destroy(unit, vpn);
    if (rv != BCM_E_NONE)
    {
        printf("Error in dnx_utils_vxlan_multicast_destroy \n");
        return rv;
    }
