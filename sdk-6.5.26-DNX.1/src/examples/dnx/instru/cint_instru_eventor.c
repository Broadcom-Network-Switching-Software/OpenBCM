        ...
        int generate_eventor_header, int push, int use_little_endian_packet_words, int nof_operations)
{
    ...
    diag_reg_info_get(unit, "ECI_SCRATCH_PAD_0", &reg_id, &block_instance_id, &block_instance_number, &array_index);
    bcm_instru_get_register_access_info(unit, 0, reg_id, 0, 0, &operations[0].access_info);
    bcm_instru_get_register_access_info(unit, 0, reg_id, 0, 0, &operations[1].access_info);
    bcm_instru_get_register_access_info(unit, 0, reg_id, 0, 0, &operations[2].access_info);
    diag_reg_info_get(unit, "ECI_SCRATCH_PAD_1", &reg_id, &block_instance_id, &block_instance_number, &array_index);
    bcm_instru_get_register_access_info(unit, 0, reg_id, 0, 0, &operations[3].access_info);
