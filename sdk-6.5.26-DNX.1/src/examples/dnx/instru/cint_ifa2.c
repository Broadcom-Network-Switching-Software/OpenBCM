...
int cint_ifa2_node_parameters_config(int unit)
{
    ...
    rv = bcm_switch_control_get(unit, bcmSwitchHashIP4OuterField, &ipv4_hash_args);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = bcm_switch_control_set(unit, bcmSwitchHashIP4OuterField, ipv4_hash_args);
    if (rv != BCM_E_NONE)
    {
...
int cint_field_IFA2_datapath_initiator_main(int unit)
{
    ...
    rv = bcm_field_group_add(unit, 0, &fg_info, &cint_field_IFA_datapath_ingress_fg_id);
    if (rv != BCM_E_NONE)
    {
...
int cint_field_IFA2_datapath_intermediate_main(int unit)
{
    ...
    rv = cint_ifa2_hash_configuration(unit, cint_field_IFA_datapath_ingress_context_id_ipv4);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d), in cint_ifa2_hash_configuration\n", rv);
        return rv;
    }
...
int cint_field_IFA2_datapath_termination_main(int unit, int out_port)
{
    ...
    /* *********************** */
      ...
      */
      ...
      rv = bcm_field_group_add(unit, 0, &fg_info, &cint_field_IFA_datapath_ingress_node_egress_fg_id);
      if (rv != BCM_E_NONE)
      {
          printf("Error (%d), in bcm_field_group_add\n", rv);
          return rv;
      ...
      if(estimate_encap_size==1)
      {
        ...
        rv = bcm_field_qualifier_create(unit,0,&qual_info,&cint_field_IFA_2_estimate_encap_size_multiply_4);
        if (rv != BCM_E_NONE)
        {
            printf("Error (%d), in bcm_field_group_add\n", rv);
            return rv;
        ...
        rv = bcm_field_qualifier_create(unit,0,&qual_info,&cint_field_IFA_2_estimate_encap_size_current_length);
        if (rv != BCM_E_NONE)
        {
            printf("Error (%d), in bcm_field_group_add\n", rv);
            return rv;
        ...
        rv = bcm_field_group_add(unit, 0, &fg_info, &cint_field_IFA_datapath_egress_estimate_encap_size_epmf);
        if (rv != BCM_E_NONE)
        {
            printf("Error (%d), in bcm_field_group_add\n", rv);
            return rv;
        ...
        rv = bcm_field_group_context_attach(unit, 0, cint_field_IFA_datapath_egress_estimate_encap_size_epmf, cint_field_IFA_datapath_ingress_node_egress_context_id_ipv4, &attach_info);
        if (rv != BCM_E_NONE)
        {
            printf("Error (%d), in bcm_field_group_context_attach\n", rv);
            return rv;
...
int cint_field_destroy(int unit)
{
    ...
    rv = bcm_field_group_context_detach(unit, cint_field_IFA_datapath_ingress_fg_id, cint_field_IFA_datapath_ipmf1_context_id_ipv4);
    if (rv != BCM_E_NONE)
    {
...
int cint_instru_ifa2_termination(int unit, int out_port)
{
    ...
    /* Configure Field */
    rv = cint_field_IFA2_datapath_termination_main(unit,out_port);
    if (rv != BCM_E_NONE)
    {
       printf("Error (%d), in adding iPMF1 rule \n", rv);
       return rv;
...
int cint_field_IFA2_egress_datapath_group(int unit,int IFA2_IP_protocol)
{
    ...
    */
    ...
    rv = bcm_field_group_add(unit, 0, &fg_info, &cint_field_IFA_datapath_egress_fg_id);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d), in bcm_field_group_add\n", rv);
        return rv;
...
int cint_field_IFA2_datapath_egress_entry_add(int unit, bcm_field_entry_t *entry_handle, int out_port)
{
    ...
    if(estimate_encap_size==1)
    {
      ...
      /**The value should be encoded as GPORT_SYTEM_PORT*/
       ...
       rv = bcm_field_entry_add(unit, 0, cint_field_IFA_datapath_egress_fg_id, &ent_info, &cint_field_IFA_datapath_ingress_node_egress_entry_handle);
       if (rv != BCM_E_NONE)
       {
          printf("Error (%d), in bcm_field_entry_add\n", rv);
          return rv;
       ...
       rv = bcm_field_group_context_attach(unit, 0, cint_field_IFA_datapath_egress_estimate_encap_size_epmf, cint_field_IFA_datapath_egress_context_id_ipv4, &attach_info);
       if (rv != BCM_E_NONE)
       {
           printf("Error (%d), in bcm_field_group_context_attach\n", rv);
           return rv;
        ...
        int collector_port)
{
    ...
    rv = cint_field_IFA2_datapath_egress_entry_add(unit,&entry_handle, out_port);
    if (rv != BCM_E_NONE)
    {
...
int cint_instru_ifa2_termination_with_md(int unit, int in_port, int recycle_port_0, int recycle_port_1, int out_port)
{
    ...
    /* Configure Initiator Node Parameters */
    rv = cint_set_IFA2_protocol(unit);
    if (rv != BCM_E_NONE)
    {
       printf("Error (%d), in configuration of IFA protocol.\n", rv);
       return rv;
    }
    ...
    if (rv != BCM_E_NONE)
    {
       printf("Error (%d), in adding IFA2 termination rule \n", rv);
       return rv;
    }
...
int cint_ifa2_hash_configuration(int unit, bcm_field_context_t context_id)
{
    ...
    rv = bcm_field_qualifier_info_get(unit, bcmFieldQualifyIp4Protocol, bcmFieldStageIngressPMF1, &qual_info_get);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = bcm_field_qualifier_create(unit, 0, &qual_info, &user_defined_qual);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = bcm_field_context_hash_create(unit, 0, bcmFieldStageIngressPMF1, context_id, &hash_info);
    if (rv != BCM_E_NONE)
    {
