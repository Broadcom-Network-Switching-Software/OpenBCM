                    ...
                    int is_default)          /** If set, USIDwith cascaded lookup is performed */
{
    ...
    if (*dnxc_data_get(unit, "l3", "fwd", "host_entry_support", NULL))
    {
        ...
        if(is_default)
        {
            ...
            rv = add_host_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[(is_prefix_48b_enabled ? END_POINT_1_DIP_48B_PREFIX_NO_DEF : END_POINT_3_DIP)], cint_srv6_tunnel_info.vrf_in[NO_DEFAULT], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
            if (rv != BCM_E_NONE)
            {
                printf("%s(): Error, in function add_host_ipv6 for End-Point-3: vrf = %d, fec = %d, err_id = %d\n", proc_name, cint_srv6_tunnel_info.vrf_in[NO_DEFAULT], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID], rv);
                return rv;
            }

            /** add End-Point-3's next IP (u-SID) as host to do forwarding on to FEC (same VRF lookup as End-Point-1) */
            rv = add_host_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[(is_prefix_48b_enabled ? END_POINT_2_DIP_48B_PREFIX_NO_DEF : END_POINT_4_DIP)], cint_srv6_tunnel_info.vrf_in[NO_DEFAULT], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
            if (rv != BCM_E_NONE)
            {
            ...
            rv = add_host_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[(is_prefix_48b_enabled ? END_POINT_3_DIP_48B_PREFIX_NO_DEF : END_POINT_5_DIP)], cint_srv6_tunnel_info.vrf_in[NO_DEFAULT], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
            if (rv != BCM_E_NONE)
            {
           ...
           {
               /**Add last dip destination, when the packet is egress node, but the layer above is TCP, so no TT will occur */
                rv = add_host_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[END_POINT_4_DIP], cint_srv6_tunnel_info.vrf_in[EGRESS], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
                if (rv != BCM_E_NONE)
                {
                    printf("%s(): Error, in function add_host_ipv6 for End-Point-Classic: vrf = %d, fec = %d, err_id = %d\n", proc_name, cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID], rv);
                    return rv;
        ...
        else
        {
            ...
            rv = add_host_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[(is_prefix_48b_enabled ? END_POINT_1_DIP_48B_PREFIX : END_POINT_2_DIP)], cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
            if (rv != BCM_E_NONE)
            {
            ...
            /** add End-Point-2's next IP (u-SID) as host to do forwarding on to FEC (same VRF lookup as End-Point-1) */
            rv = add_host_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[(is_prefix_48b_enabled ? END_POINT_2_DIP_48B_PREFIX : END_POINT_3_DIP)], cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
            if (rv != BCM_E_NONE)
            {
                printf("%s(): Error, in function add_host_ipv6 for End-Point-3: vrf = %d, fec = %d, err_id = %d\n", proc_name, cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID], rv);
                return rv;
            ...
            /** add End-Point-3's next IP (u-SID) as host to do forwarding on to FEC (same VRF lookup as End-Point-1) */
            rv = add_host_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[(is_prefix_48b_enabled ? END_POINT_3_DIP_48B_PREFIX : END_POINT_4_DIP)], cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
            if (rv != BCM_E_NONE)
            {
                printf("%s(): Error, in function add_host_ipv6 for End-Point-4: vrf = %d, fec = %d, err_id = %d\n", proc_name, cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID], rv);
                return rv;
            ...
            /** add End-Point-4's next IP (u-SID) as host to do forwarding on to FEC (same VRF lookup as End-Point-1) */
            rv = add_host_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[(is_prefix_48b_enabled ? END_POINT_4_DIP_48B_PREFIX : END_POINT_5_DIP)], cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
            if (rv != BCM_E_NONE)
            {
                printf("%s(): Error, in function add_host_ipv6 for End-Point-5: vrf = %d, fec = %d, err_id = %d\n", proc_name, cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID], rv);
                return rv;
    ...
    else
    {
        ...
        {
            /** add End-Point-2's next IP (u-SID) as host to do forwarding on to FEC (same VRF lookup as End-Point-1) */
            rv = add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[(is_prefix_48b_enabled ? END_POINT_1_DIP_48B_PREFIX_NO_DEF : END_POINT_3_DIP)], ip6_mask, cint_srv6_tunnel_info.vrf_in[NO_DEFAULT], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
            if (rv != BCM_E_NONE)
            {
                printf("%s(): Error, in function add_host_ipv6 for End-Point-3: vrf = %d, fec = %d, err_id = %d\n", proc_name, cint_srv6_tunnel_info.vrf_in[NO_DEFAULT], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID], rv);
                return rv;
            ...
            /** add End-Point-3's next IP (u-SID) as host to do forwarding on to FEC (same VRF lookup as End-Point-1) */
            rv = add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[(is_prefix_48b_enabled ? END_POINT_2_DIP_48B_PREFIX_NO_DEF : END_POINT_4_DIP)], ip6_mask, cint_srv6_tunnel_info.vrf_in[NO_DEFAULT], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
            if (rv != BCM_E_NONE)
            {
                printf("%s(): Error, in function add_host_ipv6 for End-Point-4: vrf = %d, fec = %d, err_id = %d\n", proc_name, cint_srv6_tunnel_info.vrf_in[NO_DEFAULT], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID], rv);
                return rv;
            ...
            /** add End-Point-4's next IP (u-SID) as host to do forwarding on to FEC (same VRF lookup as End-Point-1) */
            rv = add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[(is_prefix_48b_enabled ? END_POINT_3_DIP_48B_PREFIX_NO_DEF : END_POINT_5_DIP)], ip6_mask, cint_srv6_tunnel_info.vrf_in[NO_DEFAULT], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
            if (rv != BCM_E_NONE)
            {
                printf("%s(): Error, in function add_host_ipv6 for End-Point-5: vrf = %d, fec = %d, err_id = %d\n", proc_name, cint_srv6_tunnel_info.vrf_in[NO_DEFAULT], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID], rv);
                return rv;
            ...
            /**Add last dip destination, when the packet is egress node, but the layer above is TCP, so no TT will occur */
            rv = add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[EGRESS_DIP], ip6_mask, cint_srv6_tunnel_info.vrf_in[NO_DEFAULT], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
            if (rv != BCM_E_NONE)
            {
                printf("%s(): Error, in function add_host_ipv6 for End-Point-Classic: vrf = %d, fec = %d, err_id = %d\n", proc_name, cint_srv6_tunnel_info.vrf_in[NO_DEFAULT], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID], rv);
                return rv;
            ...
            /** add Egress 2nd-Pass, IPv4 Packet DIP as host to do forwarding on to FEC when IPv4 is next header over SRv6*/
            rv = add_route_ipv4(unit, cint_srv6_tunnel_info.route_ipv4_dip, ip4_mask, cint_srv6_tunnel_info.vrf_in[NO_DEFAULT], _l3_itf);
            if (rv != BCM_E_NONE)
            {
                printf("%s(): Error, in function add_host_ipv4(), \n",proc_name);
                return rv;
            ...
            /** add End-Point-Classic case as host to do forwarding on to FEC - using the uSID Egress VRF (cause classic SID happens when SL > 0 and uSID Egress) */
            rv = add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[END_POINT_CLASSIC], ip6_mask, cint_srv6_tunnel_info.vrf_in[NO_DEFAULT], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
            if (rv != BCM_E_NONE)
            {
                printf("%s(): Error, in function add_host_ipv6 for End-Point-Classic: vrf = %d, fec = %d, err_id = %d\n", proc_name, cint_srv6_tunnel_info.vrf_in[NO_DEFAULT], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID], rv);
                return rv;
            ...
            /** add Egress 2nd-Pass, IPv6 Packet DIP as host to do forwarding on to FEC when IPv6 is next header over SRv6 */
            rv = add_route_ipv6(unit, cint_srv6_tunnel_info.route_ipv6_dip, ip6_mask, cint_srv6_tunnel_info.vrf_in[NO_DEFAULT], _l3_itf);
            if (rv != BCM_E_NONE)
            {
           ...
           {
               /**Add last dip destination, when the packet is egress node, but the layer above is TCP, so no TT will occur */
                rv = add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[END_POINT_4_DIP], ip6_mask, cint_srv6_tunnel_info.vrf_in[NO_DEFAULT], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
                if (rv != BCM_E_NONE)
                {
                    printf("%s(): Error, in function add_route_ipv6 for End-Point-Classic: vrf = %d, fec = %d, err_id = %d\n", proc_name, cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID], rv);
                    return rv;
                }
           }
        }
        ...
        {
            /** add End-Point-1's next IP (u-SID) as host to do forwarding on to FEC */
            rv = add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[(is_prefix_48b_enabled ? END_POINT_1_DIP_48B_PREFIX : END_POINT_2_DIP)], ip6_mask, cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
            if (rv != BCM_E_NONE)
            {
                printf("%s(): Error, in function add_host_ipv6 for End-Point-2: vrf = %d, fec = %d, err_id = %d\n", proc_name, cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID], rv);
                return rv;
            ...
            /** add End-Point-2's next IP (u-SID) as host to do forwarding on to FEC (same VRF lookup as End-Point-1) */
            rv = add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[(is_prefix_48b_enabled ? END_POINT_2_DIP_48B_PREFIX : END_POINT_3_DIP)], ip6_mask, cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
            if (rv != BCM_E_NONE)
            {
                printf("%s(): Error, in function add_host_ipv6 for End-Point-3: vrf = %d, fec = %d, err_id = %d\n", proc_name, cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID], rv);
                return rv;
            ...
            /** add End-Point-3's next IP (u-SID) as host to do forwarding on to FEC (same VRF lookup as End-Point-1) */
            rv = add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[(is_prefix_48b_enabled ? END_POINT_3_DIP_48B_PREFIX : END_POINT_4_DIP)], ip6_mask, cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
            if (rv != BCM_E_NONE)
            {
                printf("%s(): Error, in function add_host_ipv6 for End-Point-4: vrf = %d, fec = %d, err_id = %d\n", proc_name, cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID], rv);
                return rv;
            ...
            /** add End-Point-4's next IP (u-SID) as host to do forwarding on to FEC (same VRF lookup as End-Point-1) */
            rv = add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[(is_prefix_48b_enabled ? END_POINT_4_DIP_48B_PREFIX : END_POINT_5_DIP)], ip6_mask, cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
            if (rv != BCM_E_NONE)
            {
                printf("%s(): Error, in function add_host_ipv6 for End-Point-5: vrf = %d, fec = %d, err_id = %d\n", proc_name, cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID], rv);
                return rv;
            ...
            /**Add last dip destination, when the packet is egress node, but the layer above is TCP, so no TT will occur */
            rv = add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[(is_prefix_48b_enabled ? END_POINT_5_DIP : EGRESS_DIP)], ip6_mask, cint_srv6_tunnel_info.vrf_in[EGRESS], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
            if (rv != BCM_E_NONE)
            {
                printf("%s(): Error, in function add_host_ipv6 for End-Point-Classic: vrf = %d, fec = %d, err_id = %d\n", proc_name, cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID], rv);
                return rv;
     ...
     */
    {
        ...
        if (is_prefix_48b_enabled)
        {
            ...
            srv6_tunnel_termination(unit, (is_default ? END_POINT_4_DIP : END_POINT_5_DIP), 1, srh_present, cint_srv6_tunnel_info.vrf_in[EGRESS], tunnel_type_endpoint, is_default);
        }
        else
        {
            /** no default */
