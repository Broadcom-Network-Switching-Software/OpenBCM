        ...
        int unit)
{
    ...
    rv = get_first_fec_in_range_which_not_in_ecmp_range(unit, 2, 0, &first_fec);
    if (rv != BCM_E_NONE)
    {
        printf("Error, get_first_fec_in_range_which_not_in_ecmp_range\n");
        return rv;
                        ...
                        uint8 is_gsid_prefix_64b) /** if set, the last GSID Prefix is 64b, otherwise 48b */
{
    ...
    if(*dnxc_data_get(unit, "l3", "fwd", "host_entry_support", NULL))
    {
        ...
        rv = l3__egress_only_fec__create_inner(unit, cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_SRH_FEC_ID], 0 , srv6_basic_lif_encode, gport, 0, fec_flags2,
                                               0, 0,&encoded_fec);
    ...
    else
    {
        ...
        BCM_L3_ITF_SET(srv6_basic_lif_encode, BCM_L3_ITF_TYPE_LIF, cint_srv6_tunnel_info.tunnel_global_lif[INGRESS_SRH_GLOBAL_LIF]);
        rv = l3__egress_only_fec__create_inner(unit, cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_SRH_FEC_ID], 0 , srv6_basic_lif_encode, gport_2nd, 0,
        ...
        rv = l3__egress_only_fec__create_inner(unit, cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_SRH_FEC_ID_2ND_HIER], 0 , srv6_basic_lif_encode, gport_3rd, BCM_L3_2ND_HIERARCHY,
        ...
        rv = l3__egress_only_fec__create_inner(unit, cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_SRH_FEC_ID_3RD_HIER], 0, cint_srv6_tunnel_info.tunnel_arp_id[INGRESS], gport, BCM_L3_3RD_HIERARCHY,
                                           fec_flags2, 0, 0, &encoded_fec3);
        if (rv != BCM_E_NONE)
        {
            printf("%s(): Error, create egress object FEC of ARP+AC only\n", proc_name);
            return rv;
    ...
    BCM_GPORT_LOCAL_SET(gport, out_port);
    rv = l3__egress_only_fec__create_inner(unit, cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_FIRST_SID_FEC_ID], 0 , srv6_first_lif_encode, gport, BCM_L3_2ND_HIERARCHY, fec_flags2,
                                           0, 0,&encoded_fec2);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = l3__egress_only_fec__create(unit, cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID], cint_srv6_tunnel_info.eth_rif_intf_out[ENDPOINT_GSID1],
                                            cint_srv6_tunnel_info.tunnel_arp_id[ENDPOINT_GSID1], gport, 0, fec_flags2);
    if (rv != BCM_E_NONE)
    {
        printf
    ...
    rv = l3__egress_only_fec__create(unit, cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_2_FEC_ID], cint_srv6_tunnel_info.eth_rif_intf_out[ENDPOINT_GSID0],
                                            cint_srv6_tunnel_info.tunnel_arp_id[ENDPOINT_GSID0], gport, 0, fec_flags2);
    if (rv != BCM_E_NONE)
    {
        printf
    ...
    if(*dnxc_data_get(unit, "l3", "fwd", "host_entry_support", NULL))
    {
        ...
        rv = l3__egress_only_fec__create_inner(unit, cint_srv6_tunnel_info.tunnel_fec_id[EGRESS_FEC_ID], 0 , cint_srv6_tunnel_info.tunnel_arp_id[EGRESS], gport, 0, fec_flags2,
                                                                   0, 0,&encoded_fec);
        if (rv != BCM_E_NONE)
        {
    ...
    else
    {
        ...
        /** SRV6 Tunnel Ingress Forwarding for IPv4 as next header over SRv6 to FEC Hierarchy to bring out IPV6, SRH, SIDs - not including OUT-ETH-RIF entry */
        BCM_GPORT_FORWARD_PORT_SET(gport, cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_SRH_FEC_ID]);
        rv = add_route_ipv4(unit, cint_srv6_tunnel_info.route_ipv4_dip,ip4_mask, cint_srv6_tunnel_info.vrf_in[INGRESS], cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_SRH_FEC_ID]);
        if (rv != BCM_E_NONE)
        {
            printf("%s(): Error, in function add_host_ipv4() for SRV6 Ingress Tunnel\n",proc_name);
            return rv;
        ...
        /** SRV6 Tunnel Ingress Forwarding for IPv6 as next header over SRv6 to FEC Hierarchy to bring out IPV6, SRH, SIDs - not including OUT-ETH-RIF entry */
        rv = add_route_ipv6(unit, cint_srv6_tunnel_info.route_ipv6_dip, ip6_mask, cint_srv6_tunnel_info.vrf_in[INGRESS], cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_SRH_FEC_ID]);
        if (rv != BCM_E_NONE)
        {
            printf("%s(): Error, in function add_host_ipv6_encap_dest() for SRV6 Ingress Tunnel\n",proc_name);
            return rv;
        ...
        if (is_gsid_prefix_64b)
        {
            rv = add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip_64b[DIP_ENDPOINT_GSID0], ip6_mask, cint_srv6_tunnel_info.vrf_in[ENDPOINT_GSID1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
        }
        else
        {
            rv = add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[DIP_ENDPOINT_GSID0], ip6_mask, cint_srv6_tunnel_info.vrf_in[ENDPOINT_GSID1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
        }
        ...
        if (is_gsid_eoc)
        {
            ...
            if (is_gsid_prefix_64b)
            {
                rv = add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip_64b[DIP_ENDPOINT_CLASSIC], ip6_mask, cint_srv6_tunnel_info.vrf_in[ENDPOINT_GSID0], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_2_FEC_ID]);
            }
            else
            {
                rv = add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[DIP_ENDPOINT_CLASSIC], ip6_mask, cint_srv6_tunnel_info.vrf_in[ENDPOINT_GSID0], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_2_FEC_ID]);
            }
        ...
        else
        {
            ...
            if (is_gsid_prefix_64b)
            {
                rv = add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip_64b[DIP_EGRESS], ip6_mask, cint_srv6_tunnel_info.vrf_in[ENDPOINT_GSID0], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_2_FEC_ID]);
            }
            else
            {
                rv = add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[DIP_EGRESS], ip6_mask, cint_srv6_tunnel_info.vrf_in[ENDPOINT_GSID0], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_2_FEC_ID]);
            }
        ...
        if (is_gsid_prefix_64b)
        {
            rv = add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip_64b[DIP_ENDPOINT_GSID2], ip6_mask, cint_srv6_tunnel_info.vrf_in[EGRESS], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
        }
        else
        {
            rv = add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[DIP_ENDPOINT_GSID2], ip6_mask, cint_srv6_tunnel_info.vrf_in[EGRESS], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
        }
