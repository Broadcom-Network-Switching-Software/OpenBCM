 ...
 *
 * File: cint_dnx_multi_device_vxlan_roo.c
 ...
 struct cint_multi_dev_vxlan_roo_info_s
{
    ...
    bcm_ip_t tunnel_type;                   /* bcmTunnelTypeVxlan or bcmTunnelTypeGeneve */
    ...
    int access_side_sys_port)
{
    ...
    rv = get_first_fec_in_range_which_not_in_ecmp_range(access_side_unit, 0, 0, &cint_vxlan_roo_info.core_native_fec_id);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = get_first_fec_in_range_which_not_in_ecmp_range(access_side_unit, 1, 0, &cint_vxlan_roo_info.core_overlay_fec_id);
    if (rv != BCM_E_NONE)
    {
        printf("Error, get_first_fec_in_range_which_not_in_ecmp_range\n");
        return rv;
    ...
    rv = get_first_fec_in_range_which_not_in_ecmp_range(core_side_unit, 0, 0, &cint_vxlan_roo_info.access_fec_id);
    if (rv != BCM_E_NONE)
    {
        printf("Error, get_first_fec_in_range_which_not_in_ecmp_range\n");
        return rv;
    ...
    int access_side_sys_port)
{
    ...
    if (rv != BCM_E_NONE) {
        ...
        dnx_utils_l3_eth_rif_s_common_init(access_side_unit, 0, &eth_rif_structure, cint_vxlan_roo_info.access_eth_rif, 0, 0, cint_vxlan_roo_info.access_eth_rif_mac, cint_vxlan_roo_info.access_eth_vrf);
        rv = dnx_utils_l3_eth_rif_create(access_side_unit, &eth_rif_structure);
        if (rv != BCM_E_NONE)
        {
    ...
    if (rv != BCM_E_NONE) {
        ...
        dnx_utils_l3_eth_rif_s_common_init(core_side_unit, 0, &eth_rif_structure, cint_vxlan_roo_info.core_native_eth_rif, 0, 0, cint_vxlan_roo_info.core_native_eth_rif_mac, cint_vxlan_roo_info.core_native_eth_vrf);
        rv = dnx_utils_l3_eth_rif_create(core_side_unit, &eth_rif_structure);
        if (rv != BCM_E_NONE)
        {
             printf("Error, dnx_utils_l3_eth_rif_create core_native_eth_rif\n");
             return rv;
    ...
    if (rv != BCM_E_NONE) {
        ...
        dnx_utils_l3_eth_rif_s_common_init(core_side_unit, 0, &eth_rif_structure, cint_vxlan_roo_info.core_overlay_eth_rif, 0, 0, cint_vxlan_roo_info.core_overlay_eth_rif_mac, cint_vxlan_roo_info.core_overlay_eth_vrf);
        rv = dnx_utils_l3_eth_rif_create(core_side_unit, &eth_rif_structure);
        if (rv != BCM_E_NONE)
        {
             printf("Error, dnx_utils_l3_eth_rif_create core_native_eth_rif\n");
    ...
    int into_overlay)
{
    ...
    if (into_overlay) {
        ...
        dnx_utils_l3_arp_s_common_init(core_side_unit, 0, &arp_structure, cint_vxlan_roo_info.core_native_arp_id,
                                        BCM_L3_NATIVE_ENCAP, 0,
                                        cint_vxlan_roo_info.core_native_next_hop_mac, native_eth_rif);
        rv = dnx_utils_l3_arp_create(core_side_unit, &arp_structure);
        if (rv != BCM_E_NONE)
        {
        ...
        dnx_utils_l3_arp_s_common_init(core_side_unit, 0, &arp_structure, cint_vxlan_roo_info.core_overlay_arp_id, 0, BCM_L3_FLAGS2_VLAN_TRANSLATION, cint_vxlan_roo_info.core_overlay_next_hop_mac, cint_vxlan_roo_info.core_overlay_eth_rif);
        rv = dnx_utils_l3_arp_create(core_side_unit, &arp_structure);
        if (rv != BCM_E_NONE)
        {
            printf("Error, create AC egress object ARP only\n");
        ...
        /*1.access side arp*/
        dnx_utils_l3_arp_s_common_init(access_side_unit, 0, &arp_structure, cint_vxlan_roo_info.access_arp_id, 0, BCM_L3_FLAGS2_VLAN_TRANSLATION, cint_vxlan_roo_info.access_next_hop_mac, cint_vxlan_roo_info.access_eth_rif);
        rv = dnx_utils_l3_arp_create(access_side_unit, &arp_structure);
        if (rv != BCM_E_NONE)
        {
            printf("Error, create AC egress object ARP only\n");
            return rv;
    ...
    int into_overlay)
{
    ...
    if (into_overlay) {
        ...
        dnx_utils_l3_fec_s_init(access_side_unit, 0x0, &fec_structure);
        ...
        if(*dnxc_data_get(access_side_unit, "l3", "feature", "separate_fwd_rpf_dbs", NULL))
        {
            fec_structure.flags2 |= BCM_L3_FLAGS2_FWD_ONLY;
        }
        rv = dnx_utils_l3_fec_create(access_side_unit, &fec_structure);
        if (rv != BCM_E_NONE)
        {
        ...
        dnx_utils_l3_fec_s_init(core_side_unit, 0x0, &fec_structure);
        ...
        rv = dnx_utils_l3_fec_create(core_side_unit, &fec_structure);
        if (rv != BCM_E_NONE)
        {
    ...
    int core_side_unit)
{
    ...
    tunnel_term.type = cint_vxlan_roo_info.tunnel_type;
    ...
    int core_side_unit)
{
    ...
    tunnel_init.type = cint_vxlan_roo_info.tunnel_type;
 ...
 */
int multi_dev_vxlan_roo_vxlan_port_destroy(
    int unit,
    int vxlan_port_exist)
{
    int rv = BCM_E_NONE;
    ...
    {
        /* Delete VXLAN port */
        rv = bcm_vxlan_port_delete(unit, cint_vxlan_roo_info.vpn_id, cint_vxlan_roo_info.vxlan_port_id);
        if (rv != BCM_E_NONE)
        {
    ...
    /* Destroy VPN */
    rv = bcm_vxlan_vpn_destroy(unit, cint_vxlan_roo_info.vpn_id);
    if (rv != BCM_E_NONE)
    {
    ...
    /* Destroy multicast */
    rv = bcm_multicast_destroy(unit, cint_vxlan_roo_info.vpn_id);
    if (rv != BCM_E_NONE)
    {
    ...
    int access_side_sys_port)
{
     ...
     *    So call this first.
     */
    rv = dnx_utils_vxlan_open_vpn(core_side_unit, cint_vxlan_roo_info.vpn_id, 0, cint_vxlan_roo_info.vni);
    if (rv != BCM_E_NONE)
    {
    ...
    int access_side_sys_port)
{
     ...
     */
    rv = multi_dev_vxlan_roo_vxlan_port_add(core_side_unit, core_side_sys_port, cint_vxlan_roo_info.vxlan_tunnel_if, &cint_vxlan_roo_info.vxlan_port_id);
    if (rv != BCM_E_NONE)
    {
