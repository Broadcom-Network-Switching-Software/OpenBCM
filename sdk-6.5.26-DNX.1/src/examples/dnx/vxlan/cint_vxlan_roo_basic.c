    ...
    int core_port)
{
    ...
    rv = vxlan_roo_basic_configure_port_properties(unit, cint_vxlan_roo_basic_info.access_port1, cint_vxlan_roo_basic_info.access_port2,
    ...
    {
        rv = vxlan_roo_my_mac_vrrp(unit);
        if (rv != BCM_E_NONE)
        {
            printf("%s(): Error, in function vxlan_roo_my_mac_vrrp \n", proc_name);
            return rv;
        }
    }
     ...
     */
    rv = vxlan_tunnel_terminator_create(unit, &cint_vxlan_roo_basic_info.term_tunnel_id);
    if (rv != BCM_E_NONE)
    {
     ...
     */
    rv = vxlan_tunnel_initiator_create(unit, cint_vxlan_roo_basic_info.core_overlay_arp_id, &(cint_vxlan_roo_basic_info.core_overlay_encap_tunnel_intf), &cint_vxlan_roo_basic_info.encap_tunnel_id);
    if (rv != BCM_E_NONE)
    {
     ...
     */
    rv = vxlan_port_add(unit, core_port, cint_vxlan_roo_basic_info.term_tunnel_id, &vxlan_port_id);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = vlan_port_add(unit, access_port1, cint_vxlan_roo_basic_info.access_vid, &vlan_port_id);
    if (rv != BCM_E_NONE)
    {
     ...
     */
    rv = l2_fwd_entry_add(unit, cint_vxlan_roo_basic_info.access_eth_fwd_mac, cint_vxlan_roo_basic_info.vpn_id, vxlan_port_id);
    if (rv != BCM_E_NONE)
    {
        printf("%s(): Error, l2_fwd_entry_add\n", proc_name);
        return rv;
    }

    rv = l2_fwd_entry_add(unit, cint_vxlan_roo_basic_info.access_eth_fwd_mac, cint_vxlan_roo_basic_info.access_eth_rif, vxlan_port_id);
    if (rv != BCM_E_NONE)
    {
        printf("%s(): Error, l2_fwd_entry_add\n", proc_name);
        return rv;
    ...
    int unit)
{
    ...
    rv = add_route_ipv6(unit, cint_vxlan_roo_basic_info.routev6_dip_in_of_overlay, cint_vxlan_roo_basic_info.maskv6_dip_out_of_overlay,
    ...
    rv = add_route_ipv6(unit, cint_vxlan_roo_basic_info.routev6_dip_out_of_overlay, cint_vxlan_roo_basic_info.maskv6_dip_out_of_overlay,
     ...
     */
    rv = add_route_ipv6(unit, cint_vxlan_roo_basic_info.routev6_dip_in_of_overlay, cint_vxlan_roo_basic_info.maskv6_dip_out_of_overlay, cint_vxlan_roo_basic_info.access_eth_vrf, cint_vxlan_roo_basic_info.core_native_fec_id);
    if (rv != BCM_E_NONE)
    {
    ...
    int unit)
{
    ...
    if (bfd_vxlan_extended_sip)
    {
        /* When BFD extended SIP is used, FEC points to extrened-sip outlif which points to native ARP and includes the RIF.
           ...
           bcmEncapAccessRif*/
        rv = dnx_bfd_extended_sip_configuration(unit, 0x10203040, next_if, bcmEncapAccessRif, &next_if);
        if (rv != BCM_E_NONE)
        {
            printf("Error, dnx_bfd_extended_sip_configuration\n");
            return rv;
        }
    }
    ...
    rv = l3__egress_only_fec__create(unit, cint_vxlan_roo_basic_info.access_fec_id,
                                     ...
                                     cint_vxlan_roo_basic_info.access_port1, flags, fwd_flag);
    if (rv != BCM_E_NONE)
    {
    ...
    int core_port)
{
     ...
     * set class for ports
     */
    rv = bcm_port_class_set(unit, access_port1, bcmPortClassId, access_port1);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = bcm_port_class_set(unit, access_port2, bcmPortClassId, access_port2);
    if (rv != BCM_E_NONE)
    {
        printf("Error, in bcm_port_class_set, port=%d, \n", access_port1);
        return rv;
     ...
     */
    rv = in_port_intf_set(unit, cint_vxlan_roo_basic_info.access_port1, cint_vxlan_roo_basic_info.access_eth_rif);
    if (rv != BCM_E_NONE)
    {
     ...
     * Set In-Port to In ETh-RIF
     */
    rv = in_port_intf_set(unit, cint_vxlan_roo_basic_info.access_port2, cint_vxlan_roo_basic_info.vpn_id);
    if (rv != BCM_E_NONE)
    {
        printf("Error, in_port_intf_set intf_in\n");
        return rv;
    ...
    rv = out_port_set(unit, cint_vxlan_roo_basic_info.access_port1);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = out_port_set(unit, cint_vxlan_roo_basic_info.access_port2);
    if (rv != BCM_E_NONE)
    {
        printf("Error, out_port_set intf_out\n");
        return rv;
    ...
    if (cint_vxlan_roo_basic_info.egr_qos_id)
    {
        ...
        rv = bcm_qos_port_map_set(unit, vp.vlan_port_id, -1, cint_vxlan_roo_basic_info.egr_qos_id);
        if (rv != BCM_E_NONE) {
         ...
         * Configure native VLAN translation
         */
        rv = vlan_translate_ive_eve_translation_set_with_pri_action(unit, vp.vlan_port_id,               /* outlif                  */
                                                                          0x8100,                        /* outer_tpid              */
                                                                          0,                             /* inner_tpid              */
                                                                          bcmVlanTpidActionModify,       /* Outer tpid action modify*/
                                                                          bcmVlanTpidActionNone,         /* Inner tpid action none  */
    ...
    int unit)
{
    ...
    {
        rv = bcm_l3_vrrp_config_add(unit, vrrp_ip_flags[ip_flag_iter] , cint_vxlan_roo_basic_info.access_eth_rif, vrid);
        if (rv != BCM_E_NONE) {
            printf("Error, in bcm_l3_vrrp_config_add. \n");
            return rv;
        }

        rv = bcm_l3_vrrp_config_add(unit, vrrp_ip_flags[ip_flag_iter] , cint_vxlan_roo_basic_info.core_overlay_eth_rif, vrid);
        if (rv != BCM_E_NONE) {
            printf("Error, in bcm_l3_vrrp_config_add. \n");
            return rv;
        }

        rv = bcm_l3_vrrp_config_add(unit, vrrp_ip_flags[ip_flag_iter] , cint_vxlan_roo_basic_info.core_native_eth_rif, vrid);
        if (rv != BCM_E_NONE) {
            printf("Error, in bcm_l3_vrrp_config_add. \n");
            return rv;
        }
    ...
    int *term_tunnel_id)
{
    ...
    *term_tunnel_id = tunnel_term.tunnel_id;
    ...
    if (cint_vxlan_roo_basic_info.ing_qos_id) {
        rv = bcm_qos_port_map_set(unit, tunnel_term.tunnel_id, cint_vxlan_roo_basic_info.ing_qos_id, -1);
        if (rv != BCM_E_NONE)
        {
            printf("Error, bcm_qos_port_map_set for tunnel termination \n");
            return rv;
        }
    }
    ...
    int access_port2)
{
    ...
    rv = vxlan_tunnel_initiator_create(unit, egress_core_overlay_arp_id, &(cint_vxlan_roo_basic_info.core_overlay_encap_tunnel_intf), &encap_tunnel_id);
    if (rv != BCM_E_NONE)
    {
        printf("%s(): Error, in function tunnel_initiator_configure \n", proc_name);
        return rv;
    ...
    int core_port)
{
    ...
    rv = vxlan_roo_basic(unit, access_port, 0, core_port);
    if (rv != BCM_E_NONE)
    {
