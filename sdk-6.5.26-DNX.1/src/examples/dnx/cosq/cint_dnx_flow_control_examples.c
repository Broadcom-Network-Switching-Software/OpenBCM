/*
 * File: cint_dnx_flow_control_examples.c
 * Purpose: Examples of flow control generation and receive
 * Example include:
 *        LLFC, PFC receive
 ...
 * cint ../../../../src/examples/dnx/cosq/cint_dnx_flow_control_examples.c
 * cint
 * exit;
 *
 * cint
 * dnx_test_fc_gen_vsqf_pfc_set_example(0,13,1);
 * exit;
 *
 * Test Scenario - end
 ...
 * int oob_port_tx=0;
 * int oob_port_rx=0;
 * int glb_src_p0_byte=13;
 * int calander_index=0;
 * int priority=0;
 * int global_thr =0xFFFFFE00;
 * rv = dnx_test_fc_gen_gl_to_cal_set_example(unit,glb_src_p0_byte,oob_port_tx,calander_index,priority,global_thr,1);
 * rv = dnx_test_fc_rcv_cal_to_intf_set_example(unit,port,oob_port_rx,calander_index,1);
 * exit;
 *
 * Test Scenario - end
 ...
 *            100G                               Loopback
 * Ixia ======> port 17 ======> ILKN port X ========> ILKN port X ======> port 17 ======> Ixia
 * Test Scenario - start
 *
 * ./bcm.user
 *
 ...
 * int port=17;
 * int IXIA_PORT=7;
 * int glb_src_ocb_db=3;
 * int calander_index=0;
 * int priority=0;
 * int global_thr=0x10000;
 * print bcm_port_force_forward_set(unit,port,IXIA_PORT,1);
 * print bcm_port_loopback_set(unit,IXIA_PORT,2);
 * print bcm_port_force_forward_set(unit,IXIA_PORT,port,1);
 * print dnx_test_fc_gen_gl_to_cal_set_example(unit,glb_src_ocb_db,IXIA_PORT,calander_index,priority,global_thr,0);
 * print dnx_test_fc_rcv_cal_to_intf_set_example(unit,port,IXIA_PORT,calander_index,0);
 * exit;
 *
 * Test Scenario - end
 * Then sending traffic to port 17, FC will be generated to ILKN Inband calendar 0
...
enum global_vsq_src_e
{
    ...
    global_vsq_src_mix_pool0,
    global_vsq_src_mix_pool1,
    global_vsq_src_ocb_pool0,
    global_vsq_src_ocb_pool1,
    global_vsq_src_ocb_pdb,
    global_vsq_src_p0_db,
    global_vsq_src_p1_db,
    global_vsq_src_p0_pd,
    global_vsq_src_p1_pd,
    global_vsq_src_p0_byte,
    global_vsq_src_p1_byte,
    global_vsq_src_hdrm_db,
    global_vsq_src_hdrm_pd
};
...
int
set_egg_bandwidth(int unit, int shaped_port, int rate)
{
...
int
set_force_forward(int unit, int src_port, int dst_port)
{
...
/* Enable LLFC receive */
int
dnx_test_fc_rcv_llfc_set(int unit, int port)
{
...
*/
int
dnx_test_fc_gen_vsqe_llfc_set_example(int unit, int source_port, int flags)
{
...
*/
int
dnx_test_fc_gen_vsqe_llfc_thr_set_example(int unit, int source_port, int flags, int vsq_thr)
{
    bcm_error_t rv = BCM_E_NONE;
    bcm_gport_t src_port_vsq_gport;
    bcm_gport_t pg_base_vsq_gport;
...
/* Enable PFC receive */
int
dnx_test_fc_rcv_pfc_set(int unit, int port)
{
    int rv = BCM_E_NONE;
...
/* Enable PFC receive to stop interface */
int
dnx_test_fc_rcv_pfc_stop_if_set(int unit, int port, int source_pfc)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_reception;
    bcm_cosq_fc_endpoint_t fc_target;
...
/* Enable PFC receive to stop interface */
int
dnx_test_fc_rcv_pfc_stop_if_unset(int unit, int port, int source_pfc)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_reception;
    bcm_cosq_fc_endpoint_t fc_target;
...
*/
int
dnx_test_fc_rcv_pfc_bitmap_set_example(int unit, int port, int source_cosq, int target_cosq, int flags)
{
    int rv = BCM_E_NONE;
...
int
dnx_test_fc_rcv_pfc_bitmap_unset_example(int unit, int port, int source_cosq, int target_cosq, int flags)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_trigger;
    bcm_cosq_fc_endpoint_t fc_handler;
...
*/
int
dnx_test_fc_gen_vsqf_pfc_set_example(int unit, int source_port, int flags)
{
    bcm_error_t rv = BCM_E_NONE;
    bcm_gport_t src_port_vsq_gport;
    bcm_gport_t pg_base_vsq_gport;
...
*/
int
dnx_test_fc_gen_vsqf_pfc_thr_set_example(int unit, int source_port, int flags, int vsq_thr_1, int vsq_thr_2)
{
    bcm_error_t rv = BCM_E_NONE;
    bcm_gport_t src_port_vsq_gport;
    bcm_gport_t pg_base_vsq_gport;
 ...
 *   Note: for pool0/1 byte/pd/buffer resources
...
*/
int
dnx_test_fc_gen_gl_llfc_set_example(int unit, global_vsq_src_e global_vsq_src, int port, int global_thr)
{
    int rv = BCM_E_NONE;
    int flags = 0;
    bcm_cosq_fc_endpoint_t fc_trigger;
    ...
    dnx_test_fc_gl_thr_set(unit, global_vsq_src, 0, global_thr, global_thr);
...
int
dnx_test_fc_gen_gl_llfc_unset_example(int unit, global_vsq_src_e global_vsq_src, int port)
{
    int rv = BCM_E_NONE;
    int flags = 0;
    bcm_cosq_fc_endpoint_t fc_trigger;
...
*/
int
dnx_test_fc_gen_gl_pfc_set_example(int unit, global_vsq_src_e global_vsq_src,int port, int priority,
                                        int target_cosq, int global_thr)
{
    ...
    /* Set global vsq threshold */
    dnx_test_fc_gl_thr_set(unit, global_vsq_src, priority, global_thr, global_thr);
...
int
dnx_test_fc_gen_gl_pfc_unset_example(int unit, global_vsq_src_e global_vsq_src, int port, int priority, int target_cosq)
{
    int rv = BCM_E_NONE;
    int flags = 0;
    bcm_cosq_fc_endpoint_t fc_trigger;
...
*/
int
dnx_test_fc_gen_gl_to_cal_set_example(int unit, global_vsq_src_e global_vsq_src, int port,
...
int
dnx_test_fc_gen_gl_to_cal_unset_example(int unit, global_vsq_src_e global_vsq_src, int port, int calendar_idx, int priority, int is_oob)
{
    int rv = BCM_E_NONE;
    int flags = 0;
    bcm_cosq_fc_endpoint_t fc_trigger;
...
*/
int
dnx_test_fc_gen_cttc_pfc_set_example(int unit, int src_port, int dest_port, int target_cosq, int flags, int vsq_thr)
{
    int rv = BCM_E_NONE;
    int i;
    bcm_cosq_fc_endpoint_t fc_trigger;
    ...
    if (rv != BCM_E_NONE)
    {
        printf("fc generation configuration failed(%d) in bcm_cosq_fc_path_add\n", rv);
        return rv;
    }
...
int
dnx_test_fc_gen_cttc_pfc_unset_example(int unit, int port, int target_cosq, int flags)
{
    int rv = BCM_E_NONE;
    int i;
    bcm_cosq_fc_endpoint_t fc_trigger;
...
int
dnx_test_fc_gen_ct_oob_set_example(int unit, int oob_port, int oob_calendar_idx, int flags, int vsq_thr)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_trigger;
    bcm_cosq_fc_endpoint_t fc_handler;
...
int
dnx_test_fc_gen_ct_oob_unset_example(int unit, int oob_port, int oob_calendar_idx, int flags)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_trigger;
    bcm_cosq_fc_endpoint_t fc_handler;
 ...
 */
int
dnx_test_fc_gen_cttc_oob_set_example(int unit, int port, int oob_port, int oob_calendar_idx, int flags, int vsq_thr)
{
    int rv = BCM_E_NONE;
    int i;
    bcm_cosq_fc_endpoint_t fc_trigger;
...
int
dnx_test_fc_gen_cttc_oob_unset_example(int unit, int port, int oob_port, int oob_calendar_idx, int flags)
{
    int rv = BCM_E_NONE;
    int i;
    bcm_cosq_fc_endpoint_t fc_trigger;
...
int
dnx_test_fc_gen_ctcc_oob_set_example(int unit, int oob_port, int oob_calendar_idx, int flags, int vsq_thr)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_trigger;
    bcm_cosq_fc_endpoint_t fc_handler;
...
int
dnx_test_fc_gen_ctcc_oob_unset_example(int unit, int oob_port, int oob_calendar_idx, int flags)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_trigger;
    bcm_cosq_fc_endpoint_t fc_handler;
...
int
dnx_test_fc_gen_pp_vsq_oob_set_example(int unit, int oob_port, int oob_calendar_idx, int flags, int vsq_thr)
{
    int rv = BCM_E_NONE;
    bcm_cosq_vsq_info_t vsq_inf;
    bcm_cosq_fc_endpoint_t fc_trigger;
...
int
dnx_test_fc_gen_pp_vsq_oob_unset_example(int unit, int oob_port, int oob_calendar_idx, int flags)
{
    int rv = BCM_E_NONE;
    bcm_cosq_vsq_info_t vsq_inf;
    bcm_cosq_fc_endpoint_t fc_trigger;
...
int
dnx_test_fc_gen_vsqe_oob_set_example(int unit, int source_port,int oob_port,int oob_calendar_idx, int flags, int vsq_thr)
{
    bcm_error_t rv = BCM_E_NONE;
    bcm_gport_t local_gport;
    bcm_gport_t src_port_vsq_gport;
...
int
dnx_test_fc_gen_vsqe_oob_unset_example(int unit, int source_port,int oob_port,int oob_calendar_idx, int flags)
{
    bcm_error_t rv = BCM_E_NONE;
    bcm_gport_t local_gport;
    bcm_gport_t src_port_vsq_gport;
...
int
dnx_test_fc_gen_vsqf_oob_set_example(int unit, int source_port,int oob_port,int oob_calendar_idx,
...
int
dnx_test_fc_rcv_cal_to_intf_set_example(int unit, int target_port, int port, int calendar_idx, int is_oob)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_reception;
    bcm_cosq_fc_endpoint_t fc_target;
...
int
dnx_test_fc_rcv_cal_to_intf_unset_example(int unit, int target_port, int port, int calendar_idx, int is_oob)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_reception;
    bcm_cosq_fc_endpoint_t fc_target;
...
int
dnx_test_fc_rcv_cal_to_port_set_example(int unit, int target_port, int port, int calendar_idx, int is_oob)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_reception;
    bcm_cosq_fc_endpoint_t fc_target;
...
int
dnx_test_fc_rcv_cal_to_port_unset_example(int unit, int target_port, int port, int calendar_idx, int is_oob)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_reception;
    bcm_cosq_fc_endpoint_t fc_target;
...
int
dnx_test_fc_rcv_cal_to_port_cosq_set_example(int unit, int target_port, int port, int calendar_idx, int target_cosq, int is_oob)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_reception;
    bcm_cosq_fc_endpoint_t fc_target;
...
int
dnx_test_fc_rcv_cal_to_port_cosq_unset_example(int unit, int target_port, int port, int calendar_idx, int target_cosq, int is_oob)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_reception;
    bcm_cosq_fc_endpoint_t fc_target;
 ...
 */
int
dnx_test_fc_rcv_cal_to_bitmap_set_example(int unit, int target_port, int port, int calendar_idx, int target_cosq, int flags, int is_oob)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_reception;
    bcm_cosq_fc_endpoint_t fc_target;
...
int
dnx_test_fc_rcv_cal_to_bitmap_unset_example(int unit, int target_port, int port, int calendar_idx, int target_cosq, int flags, int is_oob)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_reception;
    bcm_cosq_fc_endpoint_t fc_target;
...
*/
int
dnx_test_fc_rcv_coe_oob_intf_set_example(int unit, int target_port, int calendar_port, int calendar_idx, int is_oob)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_reception;
    bcm_cosq_fc_endpoint_t fc_target;
...
int
dnx_test_fc_rcv_coe_oob_intf_unset_example(int unit, int target_port, int calendar_port, int calendar_idx, int is_oob)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_reception;
    bcm_cosq_fc_endpoint_t fc_target;
...
int
dnx_test_fc_rcv_coe_oob_port_set_example(int unit, int target_port, int calendar_port, int calendar_idx, int is_oob)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_reception;
    bcm_cosq_fc_endpoint_t fc_target;
...
int
dnx_test_fc_rcv_coe_oob_port_unset_example(int unit, int target_port, int calendar_port, int calendar_idx, int is_oob)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_reception;
    bcm_cosq_fc_endpoint_t fc_target;
...
int
dnx_test_fc_rcv_coe_oob_port_cosq_set_example(int unit, int target_port, int calendar_port, int calendar_idx, int target_cosq, int is_oob)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_reception;
    bcm_cosq_fc_endpoint_t fc_target;
...
int
dnx_test_fc_rcv_coe_oob_port_cosq_unset_example(int unit, int target_port, int calendar_port, int calendar_idx, int target_cosq, int is_oob)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_reception;
    bcm_cosq_fc_endpoint_t fc_target;
...
*/
int
dnx_test_fc_rcv_coe_bitmap_set_example(int unit, int target_port, int calendar_port, int calendar_idx, int target_cosq, int flags, int is_oob)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_reception;
    bcm_cosq_fc_endpoint_t fc_target;
...
int
dnx_test_fc_rcv_coe_bitmap_unset_example(int unit, int target_port, int calendar_port, int calendar_idx, int target_cosq, int flags, int is_oob)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_reception;
    bcm_cosq_fc_endpoint_t fc_target;
 ...
 */
int
dnx_test_fc_gen_mlf_set_example(int unit, bcm_port_control_t fc_control,
 ...
 */
int
dnx_test_fc_gen_mlf_unset_example(int unit, bcm_port_control_t fc_control, int port, int target_cosq)
{
    int rv = BCM_E_NONE;
    bcm_gport_t child_port;
    bcm_cosq_threshold_t threshold;
 ...
 */
int
dnx_test_fc_gen_mlf_oob_set_example(int unit, int source_port, int oob_port, int oob_calendar_idx, int set_thr, int clear_thr)
{
    int rv = BCM_E_NONE;
    bcm_gport_t child_port;
    bcm_cosq_threshold_t threshold;
...
int
dnx_test_fc_gen_mlf_oob_unset_example(int unit, int source_port, int oob_port, int oob_calendar_idx)
{
    int rv = BCM_E_NONE;
    bcm_gport_t child_port;
    bcm_cosq_threshold_t threshold;
...
int
dnx_test_fc_rcv_cmic_intf_set_example(int unit, int cpu_port)
{
    int rv = BCM_E_NONE;
...
int
dnx_test_fc_rcv_cmic_intf_unset_example(int unit, int cpu_port)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_source;
    bcm_cosq_fc_endpoint_t fc_target;
...
int
dnx_test_fc_rcv_cmic_port_cosq_set_example(int unit, int cpu_port, int cosq)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_source;
    bcm_cosq_fc_endpoint_t fc_target;
...
int
dnx_test_fc_rcv_cmic_port_cosq_unset_example(int unit, int cpu_port, int cosq)
{
    int rv = BCM_E_NONE;
    bcm_cosq_fc_endpoint_t fc_source;
    bcm_cosq_fc_endpoint_t fc_target;
...
/* Global VSQ threshold setting */
int
dnx_test_fc_gl_thr_set(int unit, global_vsq_src_e global_vsq_src, int priority, int thr_set, int thr_clr)
{
    int rv = BCM_E_NONE;
    bcm_cosq_vsq_info_t vsq_inf;
    bcm_gport_t vsq_gport;
    ...
    if (rv != BCM_E_NONE)
    {
        printf("Failed(%d) to set fc set threshold in dnx_test_fc_gl_thr_set_example\n", rv);
        return rv;
    }
    ...
    if (rv != BCM_E_NONE)
    {
        printf("Failed(%d) to set fc clear threshold in dnx_test_fc_gl_thr_set_example\n", rv);
        return rv;
    }
...
dnx_test_fc_gl_thr_set(int unit, global_vsq_src_e global_vsq_src, int priority, int thr_set, int thr_clr)
{
    ...
    if (rv != BCM_E_NONE)
    {
        printf("Failed(%d) to set fc set threshold in dnx_test_fc_gl_thr_set\n", rv);
        return rv;
    }
 ...
 */
int
dnx_redirect_traffic_to_dram(int unit, bcm_port_t logical_port)
{
 ...
 */
int
dnx_pfc_deadlock_recovery_config(int unit, bcm_port_t logical_port, int priority, uint32 detection_time_ms, int recovery_time_ms, int recovery_action)
{
    int rv = 0;
