    ...
    int vpbr_enabled)
{
    ...
    if (!(*dnxc_data_get(unit, "l3", "feature", "separate_fwd_rpf_dbs", NULL)))
    {
        rv = l3__egress_only_fec__create(unit, fec_rpf_strict_kaps, cint_rpf_route_info.intf_in_strict, 0/*encap_id_rpf_strict*/, gport, 0, 0);
        if (rv != BCM_E_NONE)
        {
            printf("Error, create egress object FEC only, intf_in_strict\n");
            return rv;
        }
        rv = l3__egress_only_fec__create(unit, fec_rpf_strict_kaps_default_route, cint_rpf_route_info.intf_in_strict, 0/*encap_id_rpf_strict*/, gport, 0, 0);
        if (rv != BCM_E_NONE)
        {
            printf("Error, create egress object FEC only, intf_in_strict\n");
            return rv;
    ...
    if (is_jericho2_kbp_ipv4_split_rpf_enabled(unit) || *dnxc_data_get(unit, "l3", "feature", "separate_fwd_rpf_dbs", NULL)) {
        ...
        rv = add_host_ipv4(unit, cint_rpf_route_info.sip, vrf_loose, (cint_rpf_route_info.loose_rpf_with_no_payload ? 0 : fec_fwd), 0,0);
    }
    if (rv != BCM_E_NONE)
    {
    ...
    if (is_jericho2_kbp_ipv4_split_rpf_enabled(unit) || *dnxc_data_get(unit, "l3", "feature", "separate_fwd_rpf_dbs", NULL)) {
        ...
        rv = add_host_ipv4(unit, cint_rpf_route_info.sip + 1, vrf_loose, fec_rpf_loose, 0, 0);
    }
    if (rv != BCM_E_NONE)
    {
    ...
    if (is_jericho2_kbp_ipv4_split_rpf_enabled(unit) || *dnxc_data_get(unit, "l3", "feature", "separate_fwd_rpf_dbs", NULL)) {
        ...
        rv = add_host_ipv4(unit, cint_rpf_route_info.sip, vrf_strict, fec_fwd, 0,0);
    }
    rv = add_route_ipv4_rpf(unit, cint_rpf_route_info.sip, 0xffffffff, vrf_strict, fec_fwd);
    if (rv != BCM_E_NONE)
    {
    ...
    if (is_jericho2_kbp_ipv4_split_rpf_enabled(unit) || *dnxc_data_get(unit, "l3", "feature", "separate_fwd_rpf_dbs", NULL)) {
        ...
        rv = add_host_ipv4(unit, cint_rpf_route_info.sip + 1, vrf_strict, fec_rpf_strict, 0,0);
    }
    if (rv != BCM_E_NONE)
    {
    ...
    int vpbr_enabled)
{
    ...
    if (is_jericho2_kbp_ipv6_split_rpf_enabled(unit) || *dnxc_data_get(unit, "l3", "feature", "separate_fwd_rpf_dbs", NULL)) {
        ...
        rv = add_host_ipv6(unit, host_sip_1, vrf_loose, (cint_rpf_route_info.loose_rpf_with_no_payload ? 0 : fec_fwd));
    }
    if (rv != BCM_E_NONE)
    {
        printf("Error, in function add_host, sip_1, vrf_loose, fec\n");
    ...
    if (is_jericho2_kbp_ipv6_split_rpf_enabled(unit) || *dnxc_data_get(unit, "l3", "feature", "separate_fwd_rpf_dbs", NULL)) {
        ...
        rv = add_host_ipv6(unit, host_sip_1, vrf_strict, fec_fwd);
    }
    if (rv != BCM_E_NONE)
    {
        printf("Error, in function add_host, sip_1, vrf_strict, fec\n");
