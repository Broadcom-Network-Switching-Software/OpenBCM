...
cint_sflow_extended_gateway_first_pass_create(int unit, int in_port, int nof_cores, int sflow_recycle_port_core_0, int sflow_recycle_port_core_1)
{
    ...
    rv = cint_sflow_field_extended_gateway_first_pass_group_create_and_attach(unit, nof_cores, sflow_mirror_destination_core_0, sflow_mirror_destination_core_1, -1, -1, cint_sflow_extended_gateway_info.first_pass_context_id);
    if (rv != BCM_E_NONE)
    {
...
cint_sflow_extended_gateway_route_setup_port_add(int unit, int in_port_to_add)
{
    ...
    rv = bcm_port_match_add(unit, in_port_intf[0], &match_info);
    if (rv != BCM_E_NONE)
    {
 ...
 */
   rv = cint_sflow_field_utils_entry_add_eventor_port(unit, eventor_port, cint_sflow_snoop_field_fg_id, &cint_sflow_eventor_port_entry_id, cint_field_eventor_port_entry_priority);
   if (rv != BCM_E_NONE)
   {
