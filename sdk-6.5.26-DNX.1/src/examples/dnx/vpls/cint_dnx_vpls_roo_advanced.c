    ...
    int unit)
{
    ...
    rv = dnx_utils_l3_egress_create(unit, &l3_egress);
    if (rv != BCM_E_NONE)
    {
        ...
        int unit)
{
    ...
    rv = get_first_fec_in_range_which_not_in_ecmp_range(unit, 0, 1, &cint_vpls_roo_advanced_info.rpf_fec_id);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = l3__egress_only_fec__create(unit, cint_vpls_roo_advanced_info.rpf_fec_id, cint_vpls_roo_basic_info.core_native_eth_rif, 0/*encap_id_rpf_strict*/, gport, 0, fec_flags2);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = add_route_ipv4_raw_rpf(unit, cint_vpls_roo_advanced_info.sip ,0xffffffff, l3_ing_if.vrf, cint_vpls_roo_advanced_info.rpf_fec_id);
    if (rv != BCM_E_NONE)
    {
        ...
        int unit)
{
    ...
    rv = add_route_ipv6_rpf(unit,cint_vpls_roo_advanced_info.v6_sip,cint_vpls_roo_advanced_info.v6_mask, 0, cint_vpls_roo_advanced_info.rpf_fec_id );
    if (rv != BCM_E_NONE)
    {
