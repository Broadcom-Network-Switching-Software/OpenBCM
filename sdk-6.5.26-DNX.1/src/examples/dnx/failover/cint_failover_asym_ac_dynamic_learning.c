 ...
 * cint ../../src/examples/dnx/failover/cint_failover_asym_ac_dynamic_learning.c
 * cint ../../src/examples/dnx/field/cint_dnx_field_fec_id_align.c
 * cint
...
int dnx_asym_ac_fec_encap_failover_update(int unit) {
    ...
    if (rv != BCM_E_NONE) {
        printf("%s(): Error during dnx_utils_l3_fec_create secondary fec creation \n
    ...
    rv = dnx_utils_l3_fec_create(unit, &fec_structure);
    if (rv != BCM_E_NONE) {
        printf("%s(): Error during  dnx_utils_l3_fec_create primary fec creation \n
