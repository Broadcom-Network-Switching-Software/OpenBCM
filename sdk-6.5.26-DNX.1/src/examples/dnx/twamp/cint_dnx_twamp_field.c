...
int cint_field_twamp_reflector_user_qual_create(int unit) {    
    ...
    rv = bcm_field_qualifier_create(unit, 0, &qual_info, &twamp_reflecor_pmf2_q1_qual_id);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = bcm_field_qualifier_create(unit, 0, &qual_info, &twamp_reflecor_pmf2_q2_qual_id);
    if (rv != BCM_E_NONE)
    {
        printf("%s Error (%d), in bcm_field_qualifier_create\n", rv);
        return rv;
    ...
    rv = bcm_field_qualifier_create(unit, 0, &qual_info, &twamp_reflecor_member_link_id_qual_id);
    if (rv != BCM_E_NONE)
    {
...
int cint_field_twamp_reflector_user_act_create(int unit) {    
    ...
    */
    ...
    rv = bcm_field_action_create(unit, 0, &user_action_info, &twamp_reflector_pass_act_id);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = bcm_field_action_create(unit, 0, &user_action_info, &twamp_reflector_dest_act_id);
    if(rv != BCM_E_NONE)
    {
...
int cint_field_twamp_reflector_1st_pass_set_ipmf1(int unit, int is_ipv6, int is_lag, 
    ...
    int i, ent_nums = 1, rv = BCM_E_NONE;
    void *dest_char;
    ...
    rv = bcm_field_group_add(unit, 0, &fg_info, &twamp_reflector_1st_pass_ipmf1_fg_id);
    if (rv != BCM_E_NONE)
    {
...
int cint_field_twamp_reflector_2nd_pass_set_ipmf1(int unit, int is_ipv6, int is_lag, int is_stateless, 
    ...
    rv = bcm_field_group_add(unit, 0, &fg_info, &twamp_reflector_2nd_pass_ipmf1_fg_id);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d), in bcm_field_group_add\n", rv);
        return rv;
...
{   int i, rv = BCM_E_NONE;   
    ...
    * 13 MSB as force for oam_offset, oam_sub_type and oam_up_mep */
    ...
    /* Get the offset for the action */
    rv = bcm_field_group_action_offset_get(unit, 0, twamp_reflector_2nd_pass_ipmf1_fg_id, fg_info.action_types[0], &action_offset);
    if (rv != BCM_E_NONE)
    {
        printf("%s Error (%d), in bcm_field_group_action_offset_get\n", rv);
        return rv;
    ...
    /* Get the offset for the action */
    rv = bcm_field_group_action_offset_get(unit, 0, twamp_reflector_2nd_pass_ipmf1_fg_id, fg_info.action_types[1], &action_offset);
    if (rv != BCM_E_NONE)
    {
        printf("%s Error (%d), in bcm_field_group_action_offset_get\n", rv);
        return rv;
...
int cint_field_twamp_reflector_rule(int unit, int is_ipv6, int is_lag, int is_stateless,
    ...
    {
        rv = appl_dnx_field_flow_id_init(unit,twamp_context_id);
        if (rv != BCM_E_NONE)
        {
    ...
    rv = cint_field_twamp_reflector_user_qual_create(unit);
    if(rv != BCM_E_NONE)
    {
        printf("cint_field_twamp_reflector_user_qual_create error %d\n", rv);
        return rv;
    }
    ...
    rv = cint_field_twamp_reflector_1st_pass_set_ipmf1(unit, is_ipv6, is_lag, local_ip_addr, remote_ip_addr, 
    ...
    rv = cint_field_twamp_reflector_2nd_pass_set_ipmf1(unit, is_ipv6, is_lag, is_stateless, local_ip_addr, remote_ip_addr, 
...
int cint_field_twamp_rx_set_ipmf1(int unit, int is_ipv6, bcm_gport_t gport_trap1, int trap_code_qual, 
    ...
    rv = bcm_field_group_add(unit, 0, &fg_info, &twamp_rx_ipmf1_fg_id);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d), in bcm_field_group_add\n", rv);
        return rv;
...
int cint_field_twamp_tx_set_ipmf1(int unit, int is_ipv6, uint32 local_ip_addr, uint32 remote_ip_addr, 
    ...
    rv = bcm_field_group_add(unit, 0, &fg_info, &twamp_tx_ipmf1_fg_id);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d), in bcm_field_group_add\n", rv);
        return rv;
...
{   int i, rv = BCM_E_NONE;   
    ...
    bcm_field_group_attach_info_t attach_info;    
    bcm_field_fem_action_info_t  fem_action_info;
    int fem_action_oam_value = 0x1F0000; /* MEP-type: Up, MEP-sub-type: TWAMP-TX */
    int action_offset;
...
int cint_field_twamp_tx_rx_rule(int unit, int is_ipv6, bcm_gport_t gport_trap1, int trap_code_qual, 
    ...
    rv = cint_field_twamp_rx_set_ipmf1(unit, is_ipv6, gport_trap1, trap_code_qual, 
    ...
    rv = cint_field_twamp_tx_set_ipmf1(unit, is_ipv6, local_ip_addr, remote_ip_addr, local_ip6_addr, remote_ip6_addr);
    if(rv != BCM_E_NONE)
    {
