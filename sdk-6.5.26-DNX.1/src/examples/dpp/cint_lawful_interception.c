...
int lawful_interception_tunnel_add(int unit) {
    ...
    if (lawful_interception_get.l3_intf_id != vxlan_intf.l3a_intf_id) {
        printf("Error, bcm_tunnel_initiator_get, get wrong next pointer for LI tunnel\n");
        printf("vxlan_intf.l3a_intf_id[%#x] - %#x\n", vxlan_intf.l3a_intf_id, lawful_interception_get.l3_intf_id);
        return BCM_E_INTERNAL;
    }
