 ...
 *  	cint
 *  	int rv;
 *  	int nof_units = 1; // <nof_units>;
 *  	int units[nof_units] = {0}; // {<unit1>, <unit2>, ...};
 *  	int outP = 200;
 *  	int inP = 13;
 ...
 *  Scenario 2:
 *      rv = lsr_basic_example(units, nof_units, inSysport, outSysport);
 * Traffic:
 *   Scenario 1:
 *   Sending packet from ingress port 1:
 *   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 *   |    +-+-+-+-+-+-+-+-+-+-+-+-+-++-+-+-+-+-+-+-+-+-+    |
 ...
 *   |    +-+-+-+-+-+-+-+-+-+-+-+-+-+--+-+-+-+-+-+-+-+-+    |
 *   |   +~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~+   |
 *   |   | Figure 23: Sending Packet from Ingress Port 1 |   |
 *   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 *
 *   tx 1 psrc=13 data=0x00000000001100000000aabb8100006488470138810345000026000000000a00db240a0a0a01c0a801014d16a2488ca0ac440a189f4de072ec55c73c5d8ea6ab
 *
 ...
 *   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 *
 *   Egress packet: 000000000022000000000011884701f4010245000026000000000a00db240a0a0a01c0a801014d16a2488ca0ac440a189f4de072ec55c73c5d8ea6ab
 *
 *   The packet is forwarded to port 200, queue 1624.
 *
 *   Scenario 2:
 *   Sending packet from ingress port 1:
 *   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 *   |    +-+-+-+-+-+-+-+-+-+-+-+-+-+--+-+-+-+-+-+-+-+-+-+-+-+-+-+-+    |
 *   |   +~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~+    |
 *   |   | Figure 25: Sending Packet from Ingress Port 1            |    |
 *   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 *
 *   tx 1 psrc=13 data=0x00000000001100000000aabb8100000a884700190003003e810245000022000000000000e5280a0a0a01c0a801017be99c0b6fd83ecd2bc83ee611c267990955
 *
 * * The packet will be received in egress port 1 with following header
 ...
 *   |    +-+-+-+-+-+-+-+-+-+-+-+-+-++-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+    |
 *   |    |DA|SA  ||TIPD1 |Prio|VID||   MPLS   ||   MPLS   || Data |    |
 *   |    |  |0:11||0x8100|    |   ||Label:200 ||Label:2000||      |    |
 *   |    +-+-+-+-+-+-+-+-+-+-+-+-+-+--+-+-+-+-+-+-+-+-+-+-+-+-+-+-+    |
 *   |   +~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~+    |
 *   |   | Figure 26: Packet Received on Egress Port 1             |    |
 *   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 *
 *   Egress packet: 0000000000220000000000118847000c8014007d010245000022000000000000e5280a0a0a01c0a801017be99c0b6fd83ecd2bc83ee611c267990955
 *
 *   The packet is forwarded to port 200, queue 1624.
 *
 * Mpls Raw processing:
 ...
 *  -  Vid, my_mac:     ethernet attribute, MPLS packets arrived on this VLAN with this MAC as DA,
    ...
    int extend_example)
{
    ...
    for (i = 0 ; i < nof_units ; i++){
        ...
        if (rv != BCM_E_NONE)
        {
            printf("Error, in vlan_create with vid = %d and unit %d\n", mpls_lsr_info_1.in_vid, unit);
            return rv;
        }

        rv = vlan_create(unit, mpls_lsr_info_1.eg_vid);
        if (rv != BCM_E_NONE)
        {
