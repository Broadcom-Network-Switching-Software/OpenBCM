...
int dnxc_sw_state_sem_create(int unit, uint32 node_id, sw_state_sem_t *ptr_sem, int is_binary, int initial_count, char *desc, uint32 flags)
{
...
int dnxc_sw_state_sem_destroy(int unit, uint32 node_id, sw_state_sem_t *ptr_sem, uint32 flags)
{
#ifdef BCM_DNX_SUPPORT
    int is_binary = 0;
    int initial_count = 0;
...
int dnxc_sw_state_sem_take(int unit, uint32 node_id, sw_state_sem_t *ptr_sem, int usec, uint32 flags)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int dnxc_sw_state_sem_give(int unit, uint32 node_id, sw_state_sem_t *ptr_sem, uint32 flags)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
