...
#define WH3_MAX_VS_CONFIG   8
static i2c_ltc_t sense_resistor_config_53642[WH3_MAX_VS_CONFIG]={
    { 0, "Analog",   I2C_LTC2974_63, I2C_LTC2974_CH0, 0xDA80,  0 },
    { 1, "0.8V",     I2C_LTC2974_63, I2C_LTC2974_CH1, 0xF320,  0 },
    { 2, "1.2V",     I2C_LTC2974_63, I2C_LTC2974_CH2, 0xEA20,  0 },
    { 3, "1.8V",     I2C_LTC2974_63, I2C_LTC2974_CH3, 0xEA20,  0 },
    { 4, "2.5V",     I2C_LTC2974_64, I2C_LTC2974_CH0, 0xFE,    0 },
    { 5, "3.3V_Dut", I2C_LTC2974_64, I2C_LTC2974_CH1, 0xD280,  0 },
    { 6, "3.3V",     I2C_LTC2974_64, I2C_LTC2974_CH2, 0xD100,  0 },
    { 7, "5.0V",     I2C_LTC2974_64, I2C_LTC2974_CH3, 0xEA20,  0 }
};
...
static _ltc_board_resistor_map_t board_resistor_map[] = {
    ...
    {28, sense_resistor_config_53642},   /* WOLFHOUND3(G70) */
};
              ...
              void* data, int len)
{
    ...
    sal_mutex_take(ioctl_lock, sal_mutex_FOREVER);
     ...
     switch (opcode) {
	     ...
	     if ((SOC_CONTROL(unit)->board_type != 0x98) && (SOC_CONTROL(unit)->board_type != 0xAA) &&
                 ...
                 (SOC_CONTROL(unit)->board_type != 0xCE) && (SOC_CONTROL(unit)->board_type != 0xD6)) {
    ...
    case I2C_LTC_IOC_SET_VOUT:
        ...
        if (DEV_DAC_PARAMS(dev)) {
            ...
            if (SOC_CONTROL(unit)->board_type == 0xD6) {
                max_vs_config = WH3_MAX_VS_CONFIG;
            }
#endif
