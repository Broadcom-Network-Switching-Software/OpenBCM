...
/* LTC7132 an integrated power control IC */
extern i2c_driver_t _soc_i2c_ltc7132_driver;
...
STATIC i2c_device_t i2c_53642_devices[] = {
    I2CDEV(LPT, 1, pcf8574),      /* I2C address 0x27 (board ID) */
    I2CDEVTD(NVRAM, 1, eep24c64), /* I2C address 0x54 (EEPROM) */
    I2CDEV(MUX, 3, pca9548),      /* I2C address 0x73 (mux 3) */
    I2CDEV(LTC7132, 40, ltc7132),
    I2CDEV(LTC2974, 63, ltc2974),
    I2CDEV(LTC2974, 64, ltc2974),
};
    ...
    if (num_custom_i2c_devices[unit]) {
        ...
        switch (board_id) {
            ...
            case 0xCE: i2c_devices = i2c_56175_devices;
                       ...
                       break; /* 56175K */
            case 0xD6: i2c_devices = i2c_53642_devices;
                       num_i2c_devices = COUNTOF(i2c_53642_devices);
                       break; /* 53642K */
