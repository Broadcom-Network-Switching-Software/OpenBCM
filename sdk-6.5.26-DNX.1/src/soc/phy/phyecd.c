...
phy_ecd_cable_diag_init_40nm_541xx(int l1,soc_port_t l2){phy_ctrl_t*l3;uint16 l4;l3
= EXT_PHY_SW_STATE(l1,l2);SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00
...
0x0f00|((0xcc)&0xff),0x15,(0x0000)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1
...
,(0x0106)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xe1
)&0xff),0x15,(0x0208)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,
0x0f00|((0xe2)&0xff),0x15,(0x380F)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1
),(l3),0x00,0x0f00|((0xe3)&0xff),0x15,(0x5700)));SOC_IF_ERROR_RETURN(
phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xe4)&0xff),0x15,(0x92ac)));
SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xe5)&0xff),0x15
,(0x5000)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xe6
)&0xff),0x15,(0x9000)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,
...
SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xe0)&0xff),0x15
,(0x0e00)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xe1
)&0xff),0x15,(0x390b)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,
0x0f00|((0xe2)&0xff),0x15,(0x0078)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1
...
0x0f00|((0xe2)&0xff),0x15,(0x0440)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1
),(l3),0x00,0x0f00|((0xe3)&0xff),0x15,(0x0f40)));SOC_IF_ERROR_RETURN(
phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xe4)&0xff),0x15,(0x1345)));
SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xe5)&0xff),0x15
,(0x1523)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xe7
)&0xff),0x15,(0x0004)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00
,0x0f00|((0xe8)&0xff),0x15,(0xc590)));SOC_IF_ERROR_RETURN(phy_reg_ge_write(
(l1),(l3),0x00,0x0f00|((0xe9)&0xff),0x15,(0x5c2e)));SOC_IF_ERROR_RETURN(
phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xea)&0xff),0x15,(0x2278)));
SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00,0x0f00|((0xCD)&0xff),0x15
,(0x00D0)));SOC_IF_ERROR_RETURN(phy_reg_ge_read((l1),(l3),0x00,0x0f00|(
(0xc0)&0xff),0x15,(&l4)));SOC_IF_ERROR_RETURN(phy_reg_ge_write((l1),(l3),0x00
,0x0f00|((0xc0)&0xff),0x15,(0x0000)));return SOC_E_NONE;}int
