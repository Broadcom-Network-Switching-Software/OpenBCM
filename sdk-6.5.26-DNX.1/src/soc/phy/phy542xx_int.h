...
/* QSGMII TX control register defines */
/* QSGMII1 TX control register */
#define PHY_BCM542XX_QSGMII1_TX_CONTROL_BAR (0x8060)
#define PHY_BCM542XX_QSGMII1_TX_CONTROL_AER (0x0004)
#define PHY_BCM542XX_QSGMII1_TX_CONTROL0_REG_ADDR (0x15)
#define PHY_BCM542XX_QSGMII1_TX_CONTROL1_REG_ADDR (0x16)
#define PHY_BCM542XX_QSGMII1_TX_CONTOL0_MAIN_TAP_BIT_MASK (0x3f)
#define PHY_BCM542XX_QSGMII1_TX_CONTOL1_POST_TAP_BIT_MASK (0x3f)
#define PHY_BCM542XX_QSGMII1_TX_CONTROL0_QUARTER_EN_BIT_POS  (14)
#define PHY_BCM542XX_QSGMII1_TX_CONTROL0_MAIN_CONTROL_BIT_POS  (8)
#define PHY_BCM542XX_QSGMII1_TX_CONTROL1_POST_CONTROL_BIT_POS  (6)
#define PHY_BCM542XX_QSGMII1_TX_CONTROL1_POST_ENABLE_BIT_POS  (12)
#define PHY_BCM542XX_QSGMII1_TX_CONTROL1_CONST_IMPEDANCE_BIT_POS  (2)
#define PHY_BCM542XX_QSGMII1_TX_CONTROL1_AMP_MODE_BIT_POS  (1)
/* QSGMII0 TX control register */
#define PHY_BCM542XX_QSGMII_AER_BAR (0xFFDE)
#define PHY_BCM542XX_QSGMII_AER_REG_ADDR (0x1E)

#define PHY_BCM542XX_QSGMII0_AMS_TX_CONTROL_REG_ADDR (0xD0A2)
#define PHY_BCM542XX_QSGMII0_TX_FIR_CONTROL1_REG_ADDR (0xD110)
#define PHY_BCM542XX_QSGMII0_TX_FIR_CONTROL2_REG_ADDR (0xD111)

#define PHY_BCM542XX_QSGMII0_TX_AMP_CTRL_BIT_MASK (0xf)
#define PHY_BCM542XX_QSGMII0_TX_CONTOL1_PRE_TAP_BIT_MASK (0x1f)
#define PHY_BCM542XX_QSGMII0_TX_CONTOL1_POST_TAP_BIT_MASK (0x3f)
#define PHY_BCM542XX_QSGMII0_TX_CONTOL2_MAIN_TAP_BIT_MASK (0x7f)

#define PHY_BCM542XX_QSGMII0_TX_AMP_CTRL_BIT_POS (0)
#define PHY_BCM542XX_QSGMII0_TX_CONTOL1_PRE_TAP_BIT_POS   (0)
#define PHY_BCM542XX_QSGMII0_TX_CONTOL1_POST_TAP_BIT_POS  (5)
#define PHY_BCM542XX_QSGMII0_TX_CONTOL2_MAIN_TAP_BIT_POS  (0)
...
#endif
#define PHY_MODE_CTRL_MODE_SEL_COPPER       0x0
#define PHY_MODE_CTRL_MODE_SEL_FIBER        BIT(1)
#define PHY_MODE_CTRL_MODE_SEL             (BIT(2) | BIT(1))
#define PHY_MODE_CTRL_REG_1000X_EN          BIT(0)
...
#define PHY_BCM542XX_XGMII_AN_MOD_CTRL_INFO  (BIT4)
/* RDB_Reg. 0x022d */
#define PHY_READ_BCM542XX_AN_MODE_CTRL_INFOr(_unit, _pc, _val) \
            PHY_BCM542XX_RDB_RD(_unit, _pc, 0x22d, _val)
#define PHY_WRITE_BCM542XX_AN_MODE_CTRL_INFOr(_unit, _pc, _val) \
            PHY_BCM542XX_RDB_WR(_unit, _pc, 0x22d, _val)
#define PHY_MODIFY_BCM542XX_AN_MODE_CTRL_INFOr(_unit, _pc, _val, _mask) \
            PHY_BCM542XX_RDB_MO(_unit, _pc, 0x22d, _val, _mask)
/*
 *
 * CL45 Registers: EEE
 * 
