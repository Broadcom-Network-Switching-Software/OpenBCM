...
STATIC
 ...
 jerp_hard_reset_w_fabric(int unit, int block_instance, uint32 en_interrupt, char *msg)
 {
    ...
    char info_msg[240];
    SOCDNX_INIT_FUNC_DEFS;
    rc = dcmn_interrupt_print_info(unit, block_instance, en_interrupt, 0, DCMN_INT_CORR_ACT_SOFT_RESET, NULL);
    SOCDNX_IF_ERR_EXIT(rc);
...
STATIC int jerp_event_ready_handler(int unit, 
                            int block_instance, 
                            uint32 en_interrupt,
                            char* msg)
{
...
STATIC dcmn_intr_action_t jerp_intr_action[] =
{
    ...
    {jerp_event_ready_handler, DCMN_INT_CORR_ACT_EVENT_READY},
...
void jerp_interrupt_cb_init(int unit)
{
    ...
    dcmn_intr_add_handler(unit, JERP_INT_IPT_OCB_ONLY_DATA_OVERFLOW,             0, 0,  dcmn_interrupt_handle_IPTOcbOnlyDataOverflow_Int, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_IPT_OCB_MIX_0_DATA_OVERFLOW,            0, 0,  dcmn_interrupt_handle_IPTOcbMix0DataOverflow_Int, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_IPT_OCB_MIX_1_DATA_OVERFLOW,            0, 0,  dcmn_interrupt_handle_IPTOcbMix1DataOverflow_Int, NULL);

    
    dcmn_intr_add_handler(unit, JERP_INT_IPS_EMPTY_DQCQ_WRITE,    0, 0, dcmn_interrupt_handle_IngressSoftReset, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_IPS_DEQ_COMMAND_TIMEOUT, 0, 0,	dcmn_interrupt_handle_IngressSoftReset, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_IPS_DQCQ_OVERFLOW,       0, 0, dcmn_interrupt_handle_IngressSoftReset, NULL);

    
    dcmn_intr_add_handler_ext(unit, JERP_INT_SCH_FCT_FIFO_OVF,             0, 0,  jerp_none, jerp_none, "Check the FCT.");
    dcmn_intr_add_handler_ext(unit, JERP_INT_SCH_AGGR_FIFO_AF,             0, 0,  jerp_reprogram_resource, jerp_none, "Change the scheduling scheme.");
    dcmn_intr_add_handler_ext(unit, JERP_INT_SCH_DVS_FIFO_AF,              0, 0,  jerp_reprogram_resource, jerp_none, "Change the scheduling scheme.");
    dcmn_intr_add_handler_ext(unit, JERP_INT_SCH_UP_CREDIT_FIFO_AF,        0, 0,  jerp_reprogram_resource, jerp_none, "Consider changing the group-assignments or the scheduling scheme ");
    dcmn_intr_add_handler_ext(unit, JERP_INT_SCH_RETURNED_CREDIT_FIFO_AF,  0, 0,  jerp_reprogram_resource, jerp_none, "Change the scheduling scheme.");
    dcmn_intr_add_handler_ext(unit, JERP_INT_SCH_MCAST_CREDIT_FIFO_AF,     0, 0,  jerp_reprogram_resource, jerp_none, "Change the scheduling scheme.");
    dcmn_intr_add_handler_ext(unit, JERP_INT_SCH_ING_SHAPE_CREDIT_FIFO_AF, 0, 0,  jerp_reprogram_resource, jerp_none, "Change the scheduling scheme.");
    dcmn_intr_add_handler(unit, JERP_INT_SCH_SMP_THROW_SCL_MSG,            0, 0,  dcmn_interrupt_handle_SCHSmpThrowSclMsg, jerp_reprogram_resource);
    dcmn_intr_add_handler(unit, JERP_INT_SCH_SMP_FABRIC_MSGS_FIFO_FULL,    0, 0,  dcmn_interrupt_handle_SCHSmpFabricMsgsFifoFull, jerp_none);
    
    dcmn_intr_add_handler(unit, JERP_INT_SCH_SHP_FLOW_BAD_PARAMS, 0, 0,  dcmn_interrupt_handle_SCHShpFlowBadParams, jerp_reprogram_resource);
    dcmn_intr_add_handler(unit, JERP_INT_SCH_ACT_FLOW_BAD_PARAMS, 0, 0,  dcmn_interrupt_handle_SCHActFlowBadParams, jerp_reprogram_resource);
    dcmn_intr_add_handler(unit, JERP_INT_SCH_RESTART_FLOW_EVENT,  0, 0,  dcmn_interrupt_handle_SCHRestartFlowEvent, jerp_reprogram_resource);
    dcmn_intr_add_handler(unit, JERP_INT_SCH_SCL_GROUP_CHANGED,   0, 0,  dcmn_interrupt_handle_SCHSclGroupChanged, jerp_none);
    dcmn_intr_add_handler(unit, JERP_INT_SCH_SMP_BAD_MSG,         0, 0,  dcmn_interrupt_handle_SCHSmpBadMsg, jerp_none);

    
    dcmn_intr_add_handler(unit, JERP_INT_FMAC_FMAC_2_LOS_INT_0,                 0, 0,  dcmn_interrupt_handle_FMACLOS_Int, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_FMAC_FMAC_2_LOS_INT_1,                 0, 0,  dcmn_interrupt_handle_FMACLOS_Int, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_FMAC_FMAC_2_LOS_INT_2,                 0, 0,  dcmn_interrupt_handle_FMACLOS_Int, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_FMAC_FMAC_2_LOS_INT_3,                 0, 0,  dcmn_interrupt_handle_FMACLOS_Int, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_FMAC_FMAC_2_RX_LOST_OF_SYNC_0,         0, 0,  dcmn_interrupt_handle_FMACRxLostOfSync, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_FMAC_FMAC_2_RX_LOST_OF_SYNC_1,         0, 0,  dcmn_interrupt_handle_FMACRxLostOfSync, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_FMAC_FMAC_2_RX_LOST_OF_SYNC_2,         0, 0,  dcmn_interrupt_handle_FMACRxLostOfSync, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_FMAC_FMAC_2_RX_LOST_OF_SYNC_3,         0, 0,  dcmn_interrupt_handle_FMACRxLostOfSync, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_FMAC_FMAC_4_OOF_INT_0,              1000, 1,  dcmn_interrupt_handle_FMACOOF_Int, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_FMAC_FMAC_4_OOF_INT_1,              1000, 1,  dcmn_interrupt_handle_FMACOOF_Int, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_FMAC_FMAC_4_OOF_INT_2,              1000, 1,  dcmn_interrupt_handle_FMACOOF_Int, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_FMAC_FMAC_4_OOF_INT_3,              1000, 1,  dcmn_interrupt_handle_FMACOOF_Int, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_FMAC_FMAC_4_DEC_ERR_INT_0,      10000000, 1,  dcmn_interrupt_handle_FMACDecErr_Int, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_FMAC_FMAC_4_DEC_ERR_INT_1,      10000000, 1,  dcmn_interrupt_handle_FMACDecErr_Int, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_FMAC_FMAC_4_DEC_ERR_INT_2,      10000000, 1,  dcmn_interrupt_handle_FMACDecErr_Int, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_FMAC_FMAC_4_DEC_ERR_INT_3,      10000000, 1,  dcmn_interrupt_handle_FMACDecErr_Int, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_FMAC_FMAC_5_TRANSMIT_ERR_INT_0,        0, 0,  dcmn_interrupt_handle_FMACTransmitErr_Int, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_FMAC_FMAC_5_TRANSMIT_ERR_INT_1,        0, 0,  dcmn_interrupt_handle_FMACTransmitErr_Int, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_FMAC_FMAC_5_TRANSMIT_ERR_INT_2,        0, 0,  dcmn_interrupt_handle_FMACTransmitErr_Int, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_FMAC_FMAC_5_TRANSMIT_ERR_INT_3,        0, 0,  dcmn_interrupt_handle_FMACTransmitErr_Int, NULL);

    
    dcmn_intr_add_handler(unit, JERP_INT_FSRD_QUAD_0_FSRD_N_SYNC_STATUS_CHANGED_0, 0,0,dcmn_interrupt_handle_fsrd_fsrd_SyncStatusChanged,NULL);
    dcmn_intr_add_handler(unit, JERP_INT_FSRD_QUAD_0_FSRD_N_SYNC_STATUS_CHANGED_1, 0,0,dcmn_interrupt_handle_fsrd_fsrd_SyncStatusChanged,NULL);
    dcmn_intr_add_handler(unit, JERP_INT_FSRD_QUAD_0_FSRD_N_SYNC_STATUS_CHANGED_2, 0,0,dcmn_interrupt_handle_fsrd_fsrd_SyncStatusChanged,NULL);
    dcmn_intr_add_handler(unit, JERP_INT_FSRD_QUAD_0_FSRD_N_SYNC_STATUS_CHANGED_3, 0,0,dcmn_interrupt_handle_fsrd_fsrd_SyncStatusChanged,NULL);
    dcmn_intr_add_handler(unit, JERP_INT_FSRD_QUAD_1_FSRD_N_SYNC_STATUS_CHANGED_0, 0,0,dcmn_interrupt_handle_fsrd_fsrd_SyncStatusChanged,NULL);
    dcmn_intr_add_handler(unit, JERP_INT_FSRD_QUAD_1_FSRD_N_SYNC_STATUS_CHANGED_1, 0,0,dcmn_interrupt_handle_fsrd_fsrd_SyncStatusChanged,NULL);
    dcmn_intr_add_handler(unit, JERP_INT_FSRD_QUAD_1_FSRD_N_SYNC_STATUS_CHANGED_2, 0,0,dcmn_interrupt_handle_fsrd_fsrd_SyncStatusChanged,NULL);
    dcmn_intr_add_handler(unit, JERP_INT_FSRD_QUAD_1_FSRD_N_SYNC_STATUS_CHANGED_3, 0,0,dcmn_interrupt_handle_fsrd_fsrd_SyncStatusChanged,NULL);
    dcmn_intr_add_handler(unit, JERP_INT_FSRD_QUAD_2_FSRD_N_SYNC_STATUS_CHANGED_0, 0,0,dcmn_interrupt_handle_fsrd_fsrd_SyncStatusChanged,NULL);
    dcmn_intr_add_handler(unit, JERP_INT_FSRD_QUAD_2_FSRD_N_SYNC_STATUS_CHANGED_1, 0,0,dcmn_interrupt_handle_fsrd_fsrd_SyncStatusChanged,NULL);
    dcmn_intr_add_handler(unit, JERP_INT_FSRD_QUAD_2_FSRD_N_SYNC_STATUS_CHANGED_2, 0,0,dcmn_interrupt_handle_fsrd_fsrd_SyncStatusChanged,NULL);
    dcmn_intr_add_handler(unit, JERP_INT_FSRD_QUAD_2_FSRD_N_SYNC_STATUS_CHANGED_3, 0,0,dcmn_interrupt_handle_fsrd_fsrd_SyncStatusChanged,NULL);
    dcmn_intr_add_handler(unit, JERP_INT_FSRD_QUAD_0_FSRD_N_TXPLL_LOCK_CHANGED,    0,0,dcmn_interrupt_handle_fsrd_fsrd_TxpllLockChanged,NULL);
    dcmn_intr_add_handler(unit, JERP_INT_FSRD_QUAD_1_FSRD_N_TXPLL_LOCK_CHANGED,    0,0,dcmn_interrupt_handle_fsrd_fsrd_TxpllLockChanged,NULL);
    dcmn_intr_add_handler(unit, JERP_INT_FSRD_QUAD_2_FSRD_N_TXPLL_LOCK_CHANGED,    0,0,dcmn_interrupt_handle_fsrd_fsrd_TxpllLockChanged,NULL);
    dcmn_intr_add_handler_ext(unit, JERP_INT_FSRD_QUAD_0_FSRD_N_RX_LOCK_CHANGED_0, 0,0,jerp_none,NULL, "Rx lock status indication has been changed");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FSRD_QUAD_0_FSRD_N_RX_LOCK_CHANGED_1, 0,0,jerp_none,NULL, "Rx lock status indication has been changed");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FSRD_QUAD_0_FSRD_N_RX_LOCK_CHANGED_2, 0,0,jerp_none,NULL, "Rx lock status indication has been changed");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FSRD_QUAD_0_FSRD_N_RX_LOCK_CHANGED_3, 0,0,jerp_none,NULL, "Rx lock status indication has been changed");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FSRD_QUAD_1_FSRD_N_RX_LOCK_CHANGED_0, 0,0,jerp_none,NULL, "Rx lock status indication has been changed");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FSRD_QUAD_1_FSRD_N_RX_LOCK_CHANGED_1, 0,0,jerp_none,NULL, "Rx lock status indication has been changed");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FSRD_QUAD_1_FSRD_N_RX_LOCK_CHANGED_2, 0,0,jerp_none,NULL, "Rx lock status indication has been changed");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FSRD_QUAD_1_FSRD_N_RX_LOCK_CHANGED_3, 0,0,jerp_none,NULL, "Rx lock status indication has been changed");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FSRD_QUAD_2_FSRD_N_RX_LOCK_CHANGED_0, 0,0,jerp_none,NULL, "Rx lock status indication has been changed");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FSRD_QUAD_2_FSRD_N_RX_LOCK_CHANGED_1, 0,0,jerp_none,NULL, "Rx lock status indication has been changed");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FSRD_QUAD_2_FSRD_N_RX_LOCK_CHANGED_2, 0,0,jerp_none,NULL, "Rx lock status indication has been changed");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FSRD_QUAD_2_FSRD_N_RX_LOCK_CHANGED_3, 0,0,jerp_none,NULL, "Rx lock status indication has been changed");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FSRD_QUAD_0_FSRD_N_ENERGY_DETECT_CHANGED_0, 0,0,jerp_none,NULL, "Energy Detect Changed");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FSRD_QUAD_0_FSRD_N_ENERGY_DETECT_CHANGED_1, 0,0,jerp_none,NULL, "Energy Detect Changed");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FSRD_QUAD_0_FSRD_N_ENERGY_DETECT_CHANGED_2, 0,0,jerp_none,NULL, "Energy Detect Changed");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FSRD_QUAD_0_FSRD_N_ENERGY_DETECT_CHANGED_3, 0,0,jerp_none,NULL, "Energy Detect Changed");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FSRD_QUAD_1_FSRD_N_ENERGY_DETECT_CHANGED_0, 0,0,jerp_none,NULL, "Energy Detect Changed");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FSRD_QUAD_1_FSRD_N_ENERGY_DETECT_CHANGED_1, 0,0,jerp_none,NULL, "Energy Detect Changed");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FSRD_QUAD_1_FSRD_N_ENERGY_DETECT_CHANGED_2, 0,0,jerp_none,NULL, "Energy Detect Changed");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FSRD_QUAD_1_FSRD_N_ENERGY_DETECT_CHANGED_3, 0,0,jerp_none,NULL, "Energy Detect Changed");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FSRD_QUAD_2_FSRD_N_ENERGY_DETECT_CHANGED_0, 0,0,jerp_none,NULL, "Energy Detect Changed");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FSRD_QUAD_2_FSRD_N_ENERGY_DETECT_CHANGED_1, 0,0,jerp_none,NULL, "Energy Detect Changed");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FSRD_QUAD_2_FSRD_N_ENERGY_DETECT_CHANGED_2, 0,0,jerp_none,NULL, "Energy Detect Changed");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FSRD_QUAD_2_FSRD_N_ENERGY_DETECT_CHANGED_3, 0,0,jerp_none,NULL, "Energy Detect Changed");

    

    
    dcmn_intr_add_handler(unit, JERP_INT_MRPS_MCDA_WRAP,     0, 0,  dcmn_interrupt_handle_MRPSMcdaWrap,     NULL);
    dcmn_intr_add_handler(unit, JERP_INT_MRPS_MCDB_WRAP,     0, 0,  dcmn_interrupt_handle_MRPSMcdbWrap,     NULL);
    dcmn_intr_add_handler(unit, JERP_INT_MTRPS_EM_MCDA_WRAP, 0, 0,  dcmn_interrupt_handle_MTRPS_EMMcdaWrap, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_MTRPS_EM_MCDB_WRAP, 0, 0,  dcmn_interrupt_handle_MTRPS_EMMcdbWrap, NULL);
    ...
    dcmn_intr_add_handler(unit, JERP_INT_OAMP_RX_STATS_DONE,       0,      0,  dcmn_interrupt_handle_OAMPRxStatsDone, NULL);
    dcmn_intr_add_handler_ext(unit, JERP_INT_OAMP_REMOTE_MEP_EXACT_MATCH_ONE_RMAPEM_ERROR_TABLE_COHERENCY, 0, 0,
                              jerp_hard_reset, NULL, "JERP_INT_OAMP_REMOTE_MEP_EXACT_MATCH_ONE_RMAPEM_ERROR_TABLE_COHERENCY");
    dcmn_intr_add_handler(unit, JERP_INT_OAMP_REMOTE_MEP_EXACT_MATCH_ONE_RMAPEM_MANAGEMENT_UNIT_FAILURE_VALID, 0, 0,
                              dcmn_interrupt_handle_OAMPRmapemManagementUnitFailureValid, NULL);

    

        
    dcmn_intr_add_handler_ext(unit, JERP_INT_FDR_FDR_1_P_1_IFMAFO_A, 1, 1000000,  dcmn_interrupt_handle_FDRIFMFifoOverflow_Int, NULL, "Adjust link level flow conrol thresholds.");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FDR_FDR_1_P_1_IFMBFO_A, 1, 1000000,  dcmn_interrupt_handle_FDRIFMFifoOverflow_Int, NULL, "Adjust link level flow conrol thresholds.");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FDR_FDR_1_P_1_IFMAFO_B, 1, 1000000,  dcmn_interrupt_handle_FDRIFMFifoOverflow_Int, NULL, "Adjust link level flow conrol thresholds.");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FDR_FDR_1_P_1_IFMBFO_B, 1, 1000000,  dcmn_interrupt_handle_FDRIFMFifoOverflow_Int, NULL, "Adjust link level flow conrol thresholds.");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FDR_FDR_2_P_2_IFMAFO_A, 1, 1000000,  dcmn_interrupt_handle_FDRIFMFifoOverflow_Int, NULL, "Adjust link level flow conrol thresholds.");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FDR_FDR_2_P_2_IFMBFO_A, 1, 1000000,  dcmn_interrupt_handle_FDRIFMFifoOverflow_Int, NULL, "Adjust link level flow conrol thresholds.");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FDR_FDR_2_P_2_IFMAFO_B, 1, 1000000,  dcmn_interrupt_handle_FDRIFMFifoOverflow_Int, NULL, "Adjust link level flow conrol thresholds.");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FDR_FDR_2_P_2_IFMBFO_B, 1, 1000000,  dcmn_interrupt_handle_FDRIFMFifoOverflow_Int, NULL, "Adjust link level flow conrol thresholds.");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FDR_FDR_3_P_3_IFMAFO_A, 1, 1000000,  dcmn_interrupt_handle_FDRIFMFifoOverflow_Int, NULL, "Adjust link level flow conrol thresholds.");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FDR_FDR_3_P_3_IFMBFO_A, 1, 1000000,  dcmn_interrupt_handle_FDRIFMFifoOverflow_Int, NULL, "Adjust link level flow conrol thresholds.");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FDR_FDR_3_P_3_IFMAFO_B, 1, 1000000,  dcmn_interrupt_handle_FDRIFMFifoOverflow_Int, NULL, "Adjust link level flow conrol thresholds.");
    dcmn_intr_add_handler_ext(unit, JERP_INT_FDR_FDR_3_P_3_IFMBFO_B, 1, 1000000,  dcmn_interrupt_handle_FDRIFMFifoOverflow_Int, NULL, "Adjust link level flow conrol thresholds.");

    

    
    dcmn_intr_add_handler(unit, JERP_INT_FCR_CPU_CNT_CELL_FNE,   0, 0,  dcmn_interrupt_handle_FCRCpuCntCellFne, NULL);
    ...
    dcmn_intr_add_handler(unit, JERP_INT_FDT_BURST_TOO_LARGE,    0,   0,  dcmn_interrupt_handle_FDTBurstTooLarge, NULL);

    

        
    dcmn_intr_add_handler(unit, JERP_INT_IQM_FREE_BDB_OVF,             0, 0, dcmn_interrupt_handle_IQMFreeBdbOvf, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_IQM_FREE_BDB_UNF,             0, 0, dcmn_interrupt_handle_IQMFreeBdbUnf, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_IQM_DEQ_COM_EMPTY_Q,          0, 0, dcmn_interrupt_handle_IQMDeqComEmptyQ, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_IQM_FULL_USCNT_OVF,           0, 0, dcmn_interrupt_handle_IQMFullUscntOvf, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_IQM_MINI_USCNT_OVF,           0, 0, dcmn_interrupt_handle_IQMMiniUscntOvf, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_IQM_UPDT_FIFO_OVF,            0, 0, dcmn_interrupt_handle_IQMUpdtFifoOvf, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_IQM_TXDSCR_FIFO_OVF,          0, 0, dcmn_interrupt_handle_IQMIngressReset, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_IQM_TXDSCR_BURST_FIFO_OVF,    0, 0, dcmn_interrupt_handle_IQMIngressReset, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_IQM_PD_FIFO_OVF,              0, 0, dcmn_interrupt_handle_IQMIngressReset, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_IQM_FREE_BDB_PROT_ERR,        0, 0, dcmn_interrupt_handle_IQMFreeBdbProtErr, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_IQM_DOUBLE_CD_ERR,            0, 0, dcmn_interrupt_handle_IQMIngressReset, NULL);
    dcmn_intr_add_handler_ext(unit, JERP_INT_IQM_QROLL_OVER,           0, 0, dcmn_interrupt_handle_IQMIngressReset, NULL, "check soft error indication on bdb ll and  pdm tables");
    dcmn_intr_add_handler_ext(unit, JERP_INT_IQM_VSQ_ROLL_OVER,        0, 0, dcmn_interrupt_handle_IQMIngressReset, NULL, "check soft error indication on bdb ll and  pdm tables");
    dcmn_intr_add_handler_ext(unit, JERP_INT_IQM_FR_FLMC_DB_ROLL_OVER, 0, 0, dcmn_interrupt_handle_IQMIngressReset, NULL, "check buffer configurations, check soft errors in other modules (all the dbuff number path)");
    dcmn_intr_add_handler_ext(unit, JERP_INT_IQM_FR_MNMC_DB_ROLL_OVER, 0, 0, dcmn_interrupt_handle_IQMIngressReset, NULL, "check buffer configurations, check soft errors in other modules (all the dbuff number path)");
    dcmn_intr_add_handler_ext(unit, JERP_INT_IQM_DEQ_STOP_PDM_ERR,     0, 0, dcmn_interrupt_handle_IQMIngressReset,NULL,"ingress soft init ");
    dcmn_intr_add_handler_ext(unit, JERP_INT_IQM_RST_USCNT_ERR,        0, 0, dcmn_interrupt_handle_IQMIngressReset,NULL,"ingress soft init ");

    

    
    dcmn_intr_add_handler(unit, JERP_INT_IHB_KAPS_DIRECT_LOOKUP_ERR,                         0,      0,  dcmn_interrupt_handle_IHBKapsDirectLookupErr,  NULL);
    dcmn_intr_add_handler(unit, JERP_INT_IHB_ISEM_ONE_ISEM_ERROR_TABLE_COHERENCY,            0,      0,  dcmn_interrupt_handle_IHBIsemErrorTableCoherency, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_IHB_ISEM_ONE_ISEM_ERROR_CAM_TABLE_FULL,             0,      0,  dcmn_interrupt_handle_IHBIsemErrorCamTableFull,         NULL);
    dcmn_intr_add_handler(unit, JERP_INT_IHB_ISEM_ONE_ISEM_ERROR_DELETE_UNKNOWN_KEY,         0,      0,  dcmn_interrupt_handle_IHBIsemErrorDeleteUnknownKey,     NULL);
    dcmn_intr_add_handler(unit, JERP_INT_IHB_ISEM_ONE_ISEM_ERROR_REACHED_MAX_ENTRY_LIMIT,    0,      0,  dcmn_interrupt_handle_IHBIsemErrorReachedMaxEntryLimit, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_IHB_ISEM_ONE_ISEM_WARNING_INSERTED_EXISTING,        0,      0,  dcmn_interrupt_handle_IHBIsemWarningInsertedExisting,  NULL);
    dcmn_intr_add_handler(unit, JERP_INT_IHB_INVALID_DESTINATION_VALID,                      0,      0,  dcmn_interrupt_handle_IHBInvalidDestinationValid,    NULL);
    dcmn_intr_add_handler(unit, JERP_INT_IHB_ISEM_ONE_ISEM_MANAGEMENT_UNIT_FAILURE_VALID,    0,      0,  dcmn_interrupt_handle_IHBIsemManagementUnitFailureValid,       NULL);

    
    dcmn_intr_add_handler(unit, JERP_INT_PPDB_B_LARGE_EM_TWO_LARGE_EM_MASTER_EVENT_READY,        0, 0,  jerp_event_ready_handler,                    NULL);
    dcmn_intr_add_handler(unit, JERP_INT_PPDB_B_LARGE_EM_TWO_LARGE_EM_SLAVE_EVENT_READY,         0, 0,  jerp_event_ready_handler,                    NULL);
    dcmn_intr_add_handler(unit, JERP_INT_PPDB_B_LARGE_EM_ONE_MACT_ERROR_TABLE_COHERENCY,         0, 0,  dcmn_interrupt_handle_PPDB_BMactErrorTableCoherency_Int, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_PPDB_B_LARGE_EM_ONE_MACT_MANAGEMENT_UNIT_FAILURE_VALID, 0, 0,  dcmn_interrupt_handle_PPDB_BMactManagementUnitFailureValid_Int, NULL);
    ...
    dcmn_intr_add_handler(unit, JERP_INT_IDR_ERROR_MINI_MULTICAST_0_EXTERNAL_OVERFLOW, 0, 0,  dcmn_interrupt_handle_IDRErrorMiniMulticast0ExtOverflow, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_IDR_ERROR_FULL_MULTICAST_0_EXTERNAL_OVERFLOW, 0, 0,  dcmn_interrupt_handle_IDRErrorFullMulticast0ExtOverflow, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_IDR_ERROR_MINI_MULTICAST_1_EXTERNAL_OVERFLOW, 0, 0,  dcmn_interrupt_handle_IDRErrorMiniMulticast1ExtOverflow, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_IDR_ERROR_FULL_MULTICAST_1_EXTERNAL_OVERFLOW, 0, 0,  dcmn_interrupt_handle_IDRErrorFullMulticast1ExtOverflow, NULL);

    
    dcmn_intr_add_handler(unit, JERP_INT_IRR_ERR_MAX_REPLICATION_0,      0, 0,  dcmn_interrupt_handle_IRRErrMaxReplication, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_IRR_ERR_MAX_REPLICATION_1,      0, 0,  dcmn_interrupt_handle_IRRErrMaxReplication, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_IRR_ERR_IS_MAX_REPLICATION_0,   0, 0,  dcmn_interrupt_handle_IRRErrIsMaxReplication, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_IRR_ERR_IS_MAX_REPLICATION_1,   0, 0,  dcmn_interrupt_handle_IRRErrIsMaxReplication, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_IRR_ERR_REPLICATION_EMPTY_0,    0, 0,  dcmn_interrupt_handle_IRRErrReplicationEmpty, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_IRR_ERR_REPLICATION_EMPTY_1,    0, 0,  dcmn_interrupt_handle_IRRErrReplicationEmpty, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_IRR_ERR_IS_REPLICATION_EMPTY_0, 0, 0,  dcmn_interrupt_handle_IRRErrIsReplicationEmpty, NULL);
    dcmn_intr_add_handler(unit, JERP_INT_IRR_ERR_IS_REPLICATION_EMPTY_1, 0, 0,  dcmn_interrupt_handle_IRRErrIsReplicationEmpty, NULL);
    ...
    dcmn_intr_add_handler(unit, JERP_INT_EDB_ESEM_0_ONE_ESEM_0_ERROR_TABLE_COHERENCY, 0,0,jerp_hard_reset,NULL);
    dcmn_intr_add_handler(unit, JERP_INT_EDB_ESEM_1_ONE_ESEM_1_ERROR_TABLE_COHERENCY, 0,0,jerp_hard_reset,NULL);
    dcmn_intr_add_handler(unit, JERP_INT_EDB_GLEM_ONE_GLEM_ERROR_TABLE_COHERENCY, 0,0,dcmn_interrupt_handle_EDB_GlemErrorTableCoherency_Int,NULL);
