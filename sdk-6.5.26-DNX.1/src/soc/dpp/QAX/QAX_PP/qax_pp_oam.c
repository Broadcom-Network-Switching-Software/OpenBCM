...
soc_error_t soc_maid_48_qax_mep_pe_profile(
    ...
    SOC_SAND_IN      uint32            maid_48_or_20,
    SOC_SAND_OUT     uint32            *mep_pe_profile)
{
    ...
    int oamp_pe_profile_maid, oamp_pe_profile_maid_udh;
    SOCDNX_INIT_FUNC_DEFS;
    ...
    if (maid_48_or_20) {
        oamp_pe_profile_maid = ARAD_PP_OAMP_PE_PROGS_MAID_48;
        oamp_pe_profile_maid_udh = ARAD_PP_OAMP_PE_PROGS_MAID_48_UDH;
    } else {
        oamp_pe_profile_maid = ARAD_PP_OAMP_PE_PROGS_20_MAID;
        oamp_pe_profile_maid_udh = ARAD_PP_OAMP_PE_PROGS_20_MAID_UDH;
    }
    ...
    if(out_lif != 0) {
        ...
        *mep_pe_profile = reg_val;
        ...
        if(is_upmep) {
            arad_pp_oamp_pe_program_profile_get(unit,oamp_pe_profile_maid, &reg_val);
        }else{
            
            if(user_header_size){
                 arad_pp_oamp_pe_program_profile_get(unit,oamp_pe_profile_maid_udh, &reg_val);
            } else{
                 arad_pp_oamp_pe_program_profile_get(unit,oamp_pe_profile_maid, &reg_val);
            }
        }
