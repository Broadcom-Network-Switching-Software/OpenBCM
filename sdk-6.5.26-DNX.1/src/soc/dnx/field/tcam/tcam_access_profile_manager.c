    ...
    int access_profile_id)
{
    ...
    {
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_IS_CASCADED, INST_SINGLE, 1);
    }
    ...
    uint32 handler_id)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_tcam_access_profile_sw.access_profiles.
                    key_size.set(unit, access_profile_id, DNX_FIELD_KEY_LENGTH_TYPE_INVALID));
    SHR_IF_ERR_EXIT(dnx_field_tcam_access_profile_sw.access_profiles.
                    action_size.set(unit, access_profile_id, DNX_FIELD_ACTION_LENGTH_TYPE_INVALID));
    SHR_IF_ERR_EXIT(dnx_field_tcam_access_profile_sw.access_profiles.is_direct.set(unit, access_profile_id, 0));
    SHR_IF_ERR_EXIT(dnx_field_tcam_access_profile_sw.access_profiles.prefix.set(unit, access_profile_id, 0));
    SHR_IF_ERR_EXIT(dnx_field_tcam_access_profile_sw.access_profiles.handler_id.set(unit, access_profile_id, 0));
    ...
    if (fg_params.key_size == dnx_data_field.tcam.key_size_double_get(unit))
    {
        ...
        SHR_IF_ERR_EXIT(dnx_field_tcam_access_profile_sw.access_profiles.
                        key_size.set(unit, paired_profile_id, DNX_FIELD_KEY_LENGTH_TYPE_INVALID));
        SHR_IF_ERR_EXIT(dnx_field_tcam_access_profile_sw.access_profiles.
                        action_size.set(unit, paired_profile_id, DNX_FIELD_ACTION_LENGTH_TYPE_INVALID));
        SHR_IF_ERR_EXIT(dnx_field_tcam_access_profile_sw.access_profiles.is_direct.set(unit, paired_profile_id, 0));
        SHR_IF_ERR_EXIT(dnx_field_tcam_access_profile_sw.access_profiles.prefix.set(unit, paired_profile_id, 0));
        SHR_IF_ERR_EXIT(dnx_field_tcam_access_profile_sw.access_profiles.handler_id.set(unit, paired_profile_id, 0));
    }
...
shr_error_e
dnx_field_tcam_access_profile_reserve(
    int unit,
    int access_profile_id)
{
    SHR_FUNC_INIT_VARS(unit);
