    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_dram_dram_block_table_wpr_leaky_bucket_increment_th].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_dram_dram_block_table_write_leaky_bucket_increment_th].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_dram_dram_block_table_gddr6_average_read_inflights_leaky_bucket_config_params].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_dram_dram_block_table_gddr6_average_read_inflights_leaky_bucket_config_params].values[1].doc = "";
