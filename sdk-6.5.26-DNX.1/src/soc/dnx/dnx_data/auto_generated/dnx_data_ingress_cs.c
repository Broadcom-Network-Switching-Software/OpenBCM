...
extern shr_error_e j2x_a0_data_ingress_cs_attach(
    int unit);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_ingress_cs_properties_define_cs_buffer_nof_bits_max].doc = "";
    ...
    submodule_data->defines[dnx_data_ingress_cs_properties_define_nof_bits_entry_size_prefix].doc = "";
    ...
    submodule_data->tables[dnx_data_ingress_cs_properties_table_per_stage].doc = "";
    ...
    submodule_data->tables[dnx_data_ingress_cs_properties_table_per_stage].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_ingress_cs_properties_table_per_stage].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_ingress_cs_properties_table_per_stage].values[1].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_ingress_cs_parser_parsing_context_map_enable].doc = "";
    ...
    dnxc_data_module_t *module_data)
{
    ...
    {
        SHR_IF_ERR_EXIT(jr2_a0_data_ingress_cs_attach(unit));
        SHR_IF_ERR_EXIT(j2x_a0_data_ingress_cs_attach(unit));
    }
    else
