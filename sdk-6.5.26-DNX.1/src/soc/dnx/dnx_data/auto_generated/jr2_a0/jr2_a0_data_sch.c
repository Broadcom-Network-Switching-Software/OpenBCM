...
static shr_error_e
jr2_a0_dnx_data_sch_general_low_rate_connectors_token_count_update_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_sch;
    int submodule_index = dnx_data_sch_submodule_general;
    int feature_index = dnx_data_sch_general_low_rate_connectors_token_count_update;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_sch_general_scheduler_allocation_legacy_api_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_sch;
    int submodule_index = dnx_data_sch_submodule_general;
    int feature_index = dnx_data_sch_general_scheduler_allocation_legacy_api_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_sch_general_is_used_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_sch;
    int submodule_index = dnx_data_sch_submodule_general;
    int feature_index = dnx_data_sch_general_is_used;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_sch_flow_quartet_type_t, (1 * (table->keys[0].size) * (table->keys[1].size) + 1  ), "data of dnx_data_sch_flow_table_quartet_type");
    ...
    int unit)
{
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_sch_flow_quartet_index_conversion_t, (1 * (table->keys[0].size) + 1  ), "data of dnx_data_sch_flow_table_quartet_index_conversion");
    ...
    int unit)
{
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_sch_sch_alloc_region_t, (1 * (table->keys[0].size) * (table->keys[1].size) + 1  ), "data of dnx_data_sch_sch_alloc_table_region");
...
static shr_error_e
jr2_a0_dnx_data_sch_dbal_flow_shaper_max_burst_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_sch;
    int submodule_index = dnx_data_sch_submodule_dbal;
    int define_index = dnx_data_sch_dbal_define_flow_shaper_max_burst_bits;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_sch_general_low_rate_connectors_token_count_update;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_sch_general_low_rate_connectors_token_count_update_set;
    data_index = dnx_data_sch_general_scheduler_allocation_legacy_api_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_sch_general_scheduler_allocation_legacy_api_supported_set;
    data_index = dnx_data_sch_general_is_used;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_sch_general_is_used_set;
    ...
    data_index = dnx_data_sch_dbal_define_flow_shaper_max_burst_bits;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_sch_dbal_flow_shaper_max_burst_bits_set;
