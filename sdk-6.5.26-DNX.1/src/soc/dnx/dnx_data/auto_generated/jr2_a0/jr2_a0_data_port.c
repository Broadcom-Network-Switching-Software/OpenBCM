...
static shr_error_e
jr2_a0_dnx_data_port_general_is_phy_rx_taps_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_port;
    int submodule_index = dnx_data_port_submodule_general;
    int feature_index = dnx_data_port_general_is_phy_rx_taps_supported;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_port_general_is_phy_rx_taps_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_port_general_is_phy_rx_taps_supported_set;
