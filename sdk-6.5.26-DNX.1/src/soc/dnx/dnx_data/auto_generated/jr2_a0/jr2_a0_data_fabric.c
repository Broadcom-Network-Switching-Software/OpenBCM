...
static shr_error_e
jr2_a0_dnx_data_fabric_general_fsrd_clock_power_down_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_fabric;
    int submodule_index = dnx_data_fabric_submodule_general;
    int feature_index = dnx_data_fabric_general_fsrd_clock_power_down;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_fabric_general_is_used_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_fabric;
    int submodule_index = dnx_data_fabric_submodule_general;
    int feature_index = dnx_data_fabric_general_is_used;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_fabric_general_retimer_functionality_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_fabric;
    int submodule_index = dnx_data_fabric_submodule_general;
    int feature_index = dnx_data_fabric_general_retimer_functionality_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_fabric_general_is_nrz_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_fabric;
    int submodule_index = dnx_data_fabric_submodule_general;
    int feature_index = dnx_data_fabric_general_is_nrz_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_fabric_general_fec_ber_proj_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_fabric;
    int submodule_index = dnx_data_fabric_submodule_general;
    int feature_index = dnx_data_fabric_general_fec_ber_proj_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_fabric_general_linkup_indication_map_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_fabric;
    int submodule_index = dnx_data_fabric_submodule_general;
    int feature_index = dnx_data_fabric_general_linkup_indication_map_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_fabric_general_is_ber_calc_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_fabric;
    int submodule_index = dnx_data_fabric_submodule_general;
    int feature_index = dnx_data_fabric_general_is_ber_calc_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_fabric_general_nof_ber_proj_error_analyzer_counters_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_fabric;
    int submodule_index = dnx_data_fabric_submodule_general;
    int define_index = dnx_data_fabric_general_define_nof_ber_proj_error_analyzer_counters;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_fabric_general_force_single_pll_t, (1 * (table->keys[0].size) + 1  ), "data of dnx_data_fabric_general_table_force_single_pll");
...
static shr_error_e
jr2_a0_dnx_data_fabric_links_serdes_lock_determines_link_status_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_fabric;
    int submodule_index = dnx_data_fabric_submodule_links;
    int feature_index = dnx_data_fabric_links_serdes_lock_determines_link_status;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_fabric_links_fabric_pm_type_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_fabric;
    int submodule_index = dnx_data_fabric_submodule_links;
    int define_index = dnx_data_fabric_links_define_fabric_pm_type;
    SHR_FUNC_INIT_VARS(unit);

    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    
    define->default_data = portmodDispatchTypePm8x50_fabric;

    
    define->data = portmodDispatchTypePm8x50_fabric;
...
static shr_error_e
jr2_a0_dnx_data_fabric_links_default_fec_key_map(
    int unit,
    int key0_val,
    int key1_val,
    int *key0_index,
...
static shr_error_e
jr2_a0_dnx_data_fabric_links_default_fec_key_reverse_map(
    int unit,
    int key0_index,
    int key1_index,
    int *key0_val,
...
static shr_error_e
jr2_a0_dnx_data_fabric_links_default_fec_set(
    int unit)
{
    int speed_index;
    dnx_data_fabric_links_default_fec_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnx_data_module_fabric;
    int submodule_index = dnx_data_fabric_submodule_links;
    int table_index = dnx_data_fabric_links_table_default_fec;
    SHR_FUNC_INIT_VARS(unit);
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_fabric_links_default_fec_t, (1 * (table->keys[0].size) + 1  ), "data of dnx_data_fabric_links_table_default_fec");

    
    default_data = (dnx_data_fabric_links_default_fec_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    default_data->fec_type = bcmPortPhyFecInvalid;
    
    for (speed_index = 0; speed_index < table->keys[0].size; speed_index++)
    {
        data = (dnx_data_fabric_links_default_fec_t *) dnxc_data_mgmt_table_data_get(unit, table, speed_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
    table->key_map = jr2_a0_dnx_data_fabric_links_default_fec_key_map;
    table->key_map_reverse = jr2_a0_dnx_data_fabric_links_default_fec_key_reverse_map;
    
    data = (dnx_data_fabric_links_default_fec_t *) dnxc_data_mgmt_table_data_get(unit, table, 10312, 0);
    data->fec_type = bcmPortPhyFecRs206;
    data = (dnx_data_fabric_links_default_fec_t *) dnxc_data_mgmt_table_data_get(unit, table, 11500, 0);
    data->fec_type = bcmPortPhyFecRs206;
    data = (dnx_data_fabric_links_default_fec_t *) dnxc_data_mgmt_table_data_get(unit, table, 20625, 0);
    data->fec_type = bcmPortPhyFecRs206;
    data = (dnx_data_fabric_links_default_fec_t *) dnxc_data_mgmt_table_data_get(unit, table, 23000, 0);
    data->fec_type = bcmPortPhyFecRs206;
    data = (dnx_data_fabric_links_default_fec_t *) dnxc_data_mgmt_table_data_get(unit, table, 25000, 0);
    data->fec_type = bcmPortPhyFecRs206;
    data = (dnx_data_fabric_links_default_fec_t *) dnxc_data_mgmt_table_data_get(unit, table, 25781, 0);
    data->fec_type = bcmPortPhyFecRs206;
    data = (dnx_data_fabric_links_default_fec_t *) dnxc_data_mgmt_table_data_get(unit, table, 50000, 0);
    data->fec_type = bcmPortPhyFecRs545;
    data = (dnx_data_fabric_links_default_fec_t *) dnxc_data_mgmt_table_data_get(unit, table, 53125, 0);
    data->fec_type = bcmPortPhyFecRs545;
...
static shr_error_e
jr2_a0_dnx_data_fabric_links_supported_fec_controls_set(
    int unit)
{
    int index_index;
    dnx_data_fabric_links_supported_fec_controls_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnx_data_module_fabric;
    int submodule_index = dnx_data_fabric_submodule_links;
    int table_index = dnx_data_fabric_links_table_supported_fec_controls;
    SHR_FUNC_INIT_VARS(unit);
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_fabric_links_supported_fec_controls_t, (1 * (table->keys[0].size) + 1  ), "data of dnx_data_fabric_links_table_supported_fec_controls");

    
    default_data = (dnx_data_fabric_links_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    default_data->fec_type = bcmPortPhyFecInvalid;
    ...
    for (index_index = 0; index_index < table->keys[0].size; index_index++)
    {
        data = (dnx_data_fabric_links_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, index_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
    
    if (0 < table->keys[0].size)
    {
        data = (dnx_data_fabric_links_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, 0, 0);
        data->fec_type = bcmPortPhyFecBaseR;
        data->control_type = bcmPortControlLowLatencyLLFCEnable;
    }
    if (1 < table->keys[0].size)
    {
        data = (dnx_data_fabric_links_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, 1, 0);
        data->fec_type = bcmPortPhyFecBaseR;
        data->control_type = bcmPortControlFecErrorDetectEnable;
    }
    if (2 < table->keys[0].size)
    {
        data = (dnx_data_fabric_links_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, 2, 0);
        data->fec_type = bcmPortPhyFecBaseR;
        data->control_type = bcmPortControlLlfcCellsCongestionIndEnable;
    }
    if (3 < table->keys[0].size)
    {
        data = (dnx_data_fabric_links_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, 3, 0);
        data->fec_type = bcmPortPhyFecRs206;
        data->control_type = bcmPortControlFecErrorDetectEnable;
    }
    if (4 < table->keys[0].size)
    {
        data = (dnx_data_fabric_links_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, 4, 0);
        data->fec_type = bcmPortPhyFecRs206;
        data->control_type = bcmPortControlLLFCAfterFecEnable;
    }
    if (5 < table->keys[0].size)
    {
        data = (dnx_data_fabric_links_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, 5, 0);
        data->fec_type = bcmPortPhyFecRs206;
        data->control_type = bcmPortControlControlCellsFecBypassEnable;
    }
    if (6 < table->keys[0].size)
    {
        data = (dnx_data_fabric_links_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, 6, 0);
        data->fec_type = bcmPortPhyFecRs108;
        data->control_type = bcmPortControlFecErrorDetectEnable;
    }
    if (7 < table->keys[0].size)
    {
        data = (dnx_data_fabric_links_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, 7, 0);
        data->fec_type = bcmPortPhyFecRs108;
        data->control_type = bcmPortControlLLFCAfterFecEnable;
    }
    if (8 < table->keys[0].size)
    {
        data = (dnx_data_fabric_links_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, 8, 0);
        data->fec_type = bcmPortPhyFecRs108;
        data->control_type = bcmPortControlControlCellsFecBypassEnable;
    }
    if (9 < table->keys[0].size)
    {
        data = (dnx_data_fabric_links_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, 9, 0);
        data->fec_type = bcmPortPhyFecRs545;
        data->control_type = bcmPortControlFecErrorDetectEnable;
    }
    if (10 < table->keys[0].size)
    {
        data = (dnx_data_fabric_links_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, 10, 0);
        data->fec_type = bcmPortPhyFecRs545;
        data->control_type = bcmPortControlLLFCAfterFecEnable;
    }
    if (11 < table->keys[0].size)
    {
        data = (dnx_data_fabric_links_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, 11, 0);
        data->fec_type = bcmPortPhyFecRs545;
        data->control_type = bcmPortControlControlCellsFecBypassEnable;
    }
    if (12 < table->keys[0].size)
    {
        data = (dnx_data_fabric_links_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, 12, 0);
        data->fec_type = bcmPortPhyFecRs304;
        data->control_type = bcmPortControlFecErrorDetectEnable;
    }
    if (13 < table->keys[0].size)
    {
        data = (dnx_data_fabric_links_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, 13, 0);
        data->fec_type = bcmPortPhyFecRs304;
        data->control_type = bcmPortControlLLFCAfterFecEnable;
    }
    if (14 < table->keys[0].size)
    {
        data = (dnx_data_fabric_links_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, 14, 0);
        data->fec_type = bcmPortPhyFecRs304;
        data->control_type = bcmPortControlControlCellsFecBypassEnable;
    }
    ...
    int unit)
{
    ...
    int module_index = dnx_data_module_fabric;
    int submodule_index = dnx_data_fabric_submodule_cell;
    int feature_index = dnx_data_fabric_cell_pcp_force_no_packing;
    SHR_FUNC_INIT_VARS(unit);
    ...
    feature->property.suffix = "pcp_force_no_packing";
...
static shr_error_e
jr2_a0_dnx_data_fabric_cell_max_vsc_format_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_fabric;
    int submodule_index = dnx_data_fabric_submodule_cell;
    int define_index = dnx_data_fabric_cell_define_max_vsc_format_size;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_fabric_cell_cell_format_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_fabric;
    int submodule_index = dnx_data_fabric_submodule_cell;
    int define_index = dnx_data_fabric_cell_define_cell_format;
    SHR_FUNC_INIT_VARS(unit);

    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    
    define->default_data = BCM_FABRIC_LINK_CELL_FORMAT_VSC256_V2;

    
    define->data = BCM_FABRIC_LINK_CELL_FORMAT_VSC256_V2;
...
static shr_error_e
jr2_a0_dnx_data_fabric_cell_supported_pcp_modes_set(
    int unit)
{
    int pcp_mode_index;
    dnx_data_fabric_cell_supported_pcp_modes_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnx_data_module_fabric;
    int submodule_index = dnx_data_fabric_submodule_cell;
    int table_index = dnx_data_fabric_cell_table_supported_pcp_modes;
    SHR_FUNC_INIT_VARS(unit);
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_fabric_cell_supported_pcp_modes_t, (1 * (table->keys[0].size) + 1  ), "data of dnx_data_fabric_cell_table_supported_pcp_modes");

    
    default_data = (dnx_data_fabric_cell_supported_pcp_modes_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    default_data->supported = 0;
    
    for (pcp_mode_index = 0; pcp_mode_index < table->keys[0].size; pcp_mode_index++)
    {
        data = (dnx_data_fabric_cell_supported_pcp_modes_t *) dnxc_data_mgmt_table_data_get(unit, table, pcp_mode_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
    
    if (bcmFabricPcpModeNoPacking < table->keys[0].size)
    {
        data = (dnx_data_fabric_cell_supported_pcp_modes_t *) dnxc_data_mgmt_table_data_get(unit, table, bcmFabricPcpModeNoPacking, 0);
        data->supported = 1;
    }
    if (bcmFabricPcpModeSimple < table->keys[0].size)
    {
        data = (dnx_data_fabric_cell_supported_pcp_modes_t *) dnxc_data_mgmt_table_data_get(unit, table, bcmFabricPcpModeSimple, 0);
        data->supported = 1;
    }
    if (bcmFabricPcpModeContinuous < table->keys[0].size)
    {
        data = (dnx_data_fabric_cell_supported_pcp_modes_t *) dnxc_data_mgmt_table_data_get(unit, table, bcmFabricPcpModeContinuous, 0);
        data->supported = 1;
    }
...
static shr_error_e
jr2_a0_dnx_data_fabric_dtqs_max_nof_dtqs_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_fabric;
    int submodule_index = dnx_data_fabric_submodule_dtqs;
    int define_index = dnx_data_fabric_dtqs_define_max_nof_dtqs;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_fabric_dbal_cgm_egress_dynamic_wfq_th_bits_nof_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_fabric;
    int submodule_index = dnx_data_fabric_submodule_dbal;
    int define_index = dnx_data_fabric_dbal_define_cgm_egress_dynamic_wfq_th_bits_nof;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_fabric_dbal_fdr_links_offset_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_fabric;
    int submodule_index = dnx_data_fabric_submodule_dbal;
    int define_index = dnx_data_fabric_dbal_define_fdr_links_offset;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_fabric_dbal_fabric_cgm_rci_high_severity_min_nof_links_bits_nof_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_fabric;
    int submodule_index = dnx_data_fabric_submodule_dbal;
    int define_index = dnx_data_fabric_dbal_define_fabric_cgm_rci_high_severity_min_nof_links_bits_nof;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    define->default_data = utilex_log2_round_up(dnx_data_fabric.links.nof_links_get(unit));

    
    define->data = utilex_log2_round_up(dnx_data_fabric.links.nof_links_get(unit));
    ...
    int unit)
{
    ...
    table->keys[0].size = DBAL_NOF_ENUM_FABRIC_DTQ_FC_VALUES;
    table->info_get.key_size[0] = DBAL_NOF_ENUM_FABRIC_DTQ_FC_VALUES;
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_fabric_transmit_dtq_fc_fabric_thresholds_t, (1 * (table->keys[0].size) + 1  ), "data of dnx_data_fabric_transmit_table_dtq_fc_fabric_thresholds");
    ...
    int unit)
{
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_fabric_transmit_dtq_fc_ocb_thresholds_t, (1 * (table->keys[0].size) + 1  ), "data of dnx_data_fabric_transmit_table_dtq_fc_ocb_thresholds");
...
static shr_error_e
jr2_a0_dnx_data_fabric_transmit_dtq_to_pdq_fc_mapping_set(
    int unit)
{
    int index_index;
    dnx_data_fabric_transmit_dtq_to_pdq_fc_mapping_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnx_data_module_fabric;
    int submodule_index = dnx_data_fabric_submodule_transmit;
    int table_index = dnx_data_fabric_transmit_table_dtq_to_pdq_fc_mapping;
    SHR_FUNC_INIT_VARS(unit);
    ...
    table->values[2].default_val = "DBAL_FIELD_EMPTY";
    table->values[3].default_val = "DBAL_FIELD_EMPTY";
    table->values[4].default_val = "DBAL_FIELD_EMPTY";
    table->values[5].default_val = "0";
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_fabric_transmit_dtq_to_pdq_fc_mapping_t, (1 * (table->keys[0].size) + 1  ), "data of dnx_data_fabric_transmit_table_dtq_to_pdq_fc_mapping");

    
    default_data = (dnx_data_fabric_transmit_dtq_to_pdq_fc_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    default_data->context = 0;
    default_data->fc = 0;
    default_data->single_dtq = DBAL_FIELD_EMPTY;
    default_data->dual_dtq = DBAL_FIELD_EMPTY;
    default_data->triple_dtq = DBAL_FIELD_EMPTY;
    default_data->valid = 0;
    
    for (index_index = 0; index_index < table->keys[0].size; index_index++)
    {
        data = (dnx_data_fabric_transmit_dtq_to_pdq_fc_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, index_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
    
    if (0 < table->keys[0].size)
    {
        data = (dnx_data_fabric_transmit_dtq_to_pdq_fc_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 0, 0);
        data->context = DBAL_ENUM_FVAL_FABRIC_PDQ_CONTEXT_LOCAL_0_HP;
        data->fc = DBAL_ENUM_FVAL_FABRIC_DTQ_FC_HP;
        data->single_dtq = DBAL_FIELD_LOCAL_0_DTQ_FC_ENABLE;
        data->dual_dtq = DBAL_FIELD_LOCAL_0_DTQ_FC_ENABLE;
        data->triple_dtq = DBAL_FIELD_LOCAL_0_DTQ_FC_ENABLE;
        data->valid = 1;
    }
    if (1 < table->keys[0].size)
    {
        data = (dnx_data_fabric_transmit_dtq_to_pdq_fc_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 1, 0);
        data->context = DBAL_ENUM_FVAL_FABRIC_PDQ_CONTEXT_LOCAL_0_LP;
        data->fc = DBAL_ENUM_FVAL_FABRIC_DTQ_FC_LP;
        data->single_dtq = DBAL_FIELD_LOCAL_0_DTQ_FC_ENABLE;
        data->dual_dtq = DBAL_FIELD_LOCAL_0_DTQ_FC_ENABLE;
        data->triple_dtq = DBAL_FIELD_LOCAL_0_DTQ_FC_ENABLE;
        data->valid = 1;
    ...
    if (2 < table->keys[0].size)
    {
        data = (dnx_data_fabric_transmit_dtq_to_pdq_fc_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 2, 0);
        data->context = DBAL_ENUM_FVAL_FABRIC_PDQ_CONTEXT_LOCAL_1_HP;
        data->fc = DBAL_ENUM_FVAL_FABRIC_DTQ_FC_HP;
        data->single_dtq = DBAL_FIELD_LOCAL_1_DTQ_FC_ENABLE;
        data->dual_dtq = DBAL_FIELD_LOCAL_1_DTQ_FC_ENABLE;
        data->triple_dtq = DBAL_FIELD_LOCAL_1_DTQ_FC_ENABLE;
        data->valid = dnx_data_device.general.feature_get(unit, dnx_data_device_general_multi_core);
    }
    if (3 < table->keys[0].size)
    {
        data = (dnx_data_fabric_transmit_dtq_to_pdq_fc_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 3, 0);
        data->context = DBAL_ENUM_FVAL_FABRIC_PDQ_CONTEXT_LOCAL_1_LP;
        data->fc = DBAL_ENUM_FVAL_FABRIC_DTQ_FC_LP;
        data->single_dtq = DBAL_FIELD_LOCAL_1_DTQ_FC_ENABLE;
        data->dual_dtq = DBAL_FIELD_LOCAL_1_DTQ_FC_ENABLE;
        data->triple_dtq = DBAL_FIELD_LOCAL_1_DTQ_FC_ENABLE;
    ...
    if (4 < table->keys[0].size)
    {
        data = (dnx_data_fabric_transmit_dtq_to_pdq_fc_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 4, 0);
        data->context = DBAL_ENUM_FVAL_FABRIC_PDQ_CONTEXT_FUC_DEV1_HP;
        data->fc = DBAL_ENUM_FVAL_FABRIC_DTQ_FC_HP;
        data->single_dtq = DBAL_FIELD_FABRIC_0_DTQ_FC_ENABLE;
        data->dual_dtq = DBAL_FIELD_FABRIC_0_DTQ_FC_ENABLE;
        data->triple_dtq = DBAL_FIELD_FABRIC_0_DTQ_FC_ENABLE;
        data->valid = dnx_data_fabric.general.feature_get(unit, dnx_data_fabric_general_blocks_exist);
    }
    if (5 < table->keys[0].size)
    {
        data = (dnx_data_fabric_transmit_dtq_to_pdq_fc_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 5, 0);
        data->context = DBAL_ENUM_FVAL_FABRIC_PDQ_CONTEXT_FUC_DEV1_LP;
        data->fc = DBAL_ENUM_FVAL_FABRIC_DTQ_FC_LP;
        data->single_dtq = DBAL_FIELD_FABRIC_0_DTQ_FC_ENABLE;
        data->dual_dtq = DBAL_FIELD_FABRIC_0_DTQ_FC_ENABLE;
        data->triple_dtq = DBAL_FIELD_FABRIC_0_DTQ_FC_ENABLE;
    ...
    if (6 < table->keys[0].size)
    {
        data = (dnx_data_fabric_transmit_dtq_to_pdq_fc_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 6, 0);
        data->context = DBAL_ENUM_FVAL_FABRIC_PDQ_CONTEXT_FMC_DEV3_HP;
        data->fc = DBAL_ENUM_FVAL_FABRIC_DTQ_FC_HP;
        data->single_dtq = DBAL_FIELD_FABRIC_0_DTQ_FC_ENABLE;
        data->dual_dtq = DBAL_FIELD_FABRIC_1_DTQ_FC_ENABLE;
        data->triple_dtq = DBAL_FIELD_FABRIC_1_DTQ_FC_ENABLE;
        data->valid = dnx_data_fabric.general.feature_get(unit, dnx_data_fabric_general_blocks_exist) && (dnx_data_fabric.general.connect_mode_get(unit) == DNX_FABRIC_CONNECT_MODE_FE) ? 1 : 0;
    }
    if (7 < table->keys[0].size)
    {
        data = (dnx_data_fabric_transmit_dtq_to_pdq_fc_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 7, 0);
        data->context = DBAL_ENUM_FVAL_FABRIC_PDQ_CONTEXT_FMC_DEV3_LP;
        data->fc = DBAL_ENUM_FVAL_FABRIC_DTQ_FC_LP;
        data->single_dtq = DBAL_FIELD_FABRIC_0_DTQ_FC_ENABLE;
        data->dual_dtq = DBAL_FIELD_FABRIC_1_DTQ_FC_ENABLE;
        data->triple_dtq = DBAL_FIELD_FABRIC_2_DTQ_FC_ENABLE;
        data->valid = dnx_data_fabric.general.feature_get(unit, dnx_data_fabric_general_blocks_exist) && (dnx_data_fabric.general.connect_mode_get(unit) == DNX_FABRIC_CONNECT_MODE_FE) ? 1 : 0;
    }
    if (8 < table->keys[0].size)
    {
        data = (dnx_data_fabric_transmit_dtq_to_pdq_fc_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 8, 0);
        data->context = DBAL_ENUM_FVAL_FABRIC_PDQ_CONTEXT_DEV2_HP;
        data->fc = DBAL_ENUM_FVAL_FABRIC_DTQ_FC_HP;
        data->triple_dtq = DBAL_FIELD_FABRIC_1_DTQ_FC_ENABLE;
        data->valid = dnx_data_fabric.general.feature_get(unit, dnx_data_fabric_general_blocks_exist) && (dnx_data_fabric.general.connect_mode_get(unit) != DNX_FABRIC_CONNECT_MODE_FE) ? 1 : 0;
    }
    if (9 < table->keys[0].size)
    {
        data = (dnx_data_fabric_transmit_dtq_to_pdq_fc_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 9, 0);
        data->context = DBAL_ENUM_FVAL_FABRIC_PDQ_CONTEXT_DEV2_LP;
        data->fc = DBAL_ENUM_FVAL_FABRIC_DTQ_FC_LP;
        data->triple_dtq = DBAL_FIELD_FABRIC_1_DTQ_FC_ENABLE;
        data->valid = dnx_data_fabric.general.feature_get(unit, dnx_data_fabric_general_blocks_exist) && (dnx_data_fabric.general.connect_mode_get(unit) != DNX_FABRIC_CONNECT_MODE_FE) ? 1 : 0;
    }
    if (10 < table->keys[0].size)
    {
        data = (dnx_data_fabric_transmit_dtq_to_pdq_fc_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 10, 0);
        data->context = DBAL_ENUM_FVAL_FABRIC_PDQ_CONTEXT_FMC_DEV3_HP;
        data->fc = DBAL_ENUM_FVAL_FABRIC_DTQ_FC_HP;
        data->triple_dtq = DBAL_FIELD_FABRIC_2_DTQ_FC_ENABLE;
        data->valid = dnx_data_fabric.general.feature_get(unit, dnx_data_fabric_general_blocks_exist) && (dnx_data_fabric.general.connect_mode_get(unit) != DNX_FABRIC_CONNECT_MODE_FE) ? 1 : 0;
    ...
    if (11 < table->keys[0].size)
    {
        data = (dnx_data_fabric_transmit_dtq_to_pdq_fc_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 11, 0);
        data->context = DBAL_ENUM_FVAL_FABRIC_PDQ_CONTEXT_FMC_DEV3_LP;
        data->fc = DBAL_ENUM_FVAL_FABRIC_DTQ_FC_LP;
        data->triple_dtq = DBAL_FIELD_FABRIC_2_DTQ_FC_ENABLE;
        data->valid = dnx_data_fabric.general.feature_get(unit, dnx_data_fabric_general_blocks_exist) && (dnx_data_fabric.general.connect_mode_get(unit) != DNX_FABRIC_CONNECT_MODE_FE) ? 1 : 0;
...
static shr_error_e
jr2_a0_dnx_data_fabric_system_upgrade_is_system_upgrade_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_fabric;
    int submodule_index = dnx_data_fabric_submodule_system_upgrade;
    int feature_index = dnx_data_fabric_system_upgrade_is_system_upgrade_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_fabric_system_upgrade_is_system_upgrade_master_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_fabric;
    int submodule_index = dnx_data_fabric_submodule_system_upgrade;
    int feature_index = dnx_data_fabric_system_upgrade_is_system_upgrade_master_supported;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_fabric_system_upgrade_target_t, (1 * (table->keys[0].size) + 1  ), "data of dnx_data_fabric_system_upgrade_table_target");
...
static shr_error_e
jr2_a0_dnx_data_fabric_regression_is_hist_errcnt_thresh_used_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_fabric;
    int submodule_index = dnx_data_fabric_submodule_regression;
    int feature_index = dnx_data_fabric_regression_is_hist_errcnt_thresh_used;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_fabric_regression_minimum_system_ref_clk_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_fabric;
    int submodule_index = dnx_data_fabric_submodule_regression;
    int define_index = dnx_data_fabric_regression_define_minimum_system_ref_clk;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_fabric_regression_soft_reset_with_fabric_max_exec_time_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_fabric;
    int submodule_index = dnx_data_fabric_submodule_regression;
    int define_index = dnx_data_fabric_regression_define_soft_reset_with_fabric_max_exec_time;
    SHR_FUNC_INIT_VARS(unit);

    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    
    define->default_data = 540000;
...
static shr_error_e
jr2_a0_dnx_data_fabric_regression_soft_reset_with_fabric_avg_exec_time_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_fabric;
    int submodule_index = dnx_data_fabric_submodule_regression;
    int define_index = dnx_data_fabric_regression_define_soft_reset_with_fabric_avg_exec_time;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_fabric_general_define_nof_ber_proj_error_analyzer_counters;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_fabric_general_nof_ber_proj_error_analyzer_counters_set;
    ...
    data_index = dnx_data_fabric_general_fsrd_clock_power_down;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_fabric_general_fsrd_clock_power_down_set;
    data_index = dnx_data_fabric_general_is_used;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_fabric_general_is_used_set;
    ...
    data_index = dnx_data_fabric_general_retimer_functionality_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_fabric_general_retimer_functionality_supported_set;
    data_index = dnx_data_fabric_general_is_nrz_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_fabric_general_is_nrz_supported_set;
    data_index = dnx_data_fabric_general_fec_ber_proj_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_fabric_general_fec_ber_proj_supported_set;
    data_index = dnx_data_fabric_general_linkup_indication_map_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_fabric_general_linkup_indication_map_supported_set;
    data_index = dnx_data_fabric_general_is_ber_calc_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_fabric_general_is_ber_calc_supported_set;
    ...
    data_index = dnx_data_fabric_links_define_fabric_pm_type;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_fabric_links_fabric_pm_type_set;
    ...
    data_index = dnx_data_fabric_links_serdes_lock_determines_link_status;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_fabric_links_serdes_lock_determines_link_status_set;
    ...
    data_index = dnx_data_fabric_links_table_default_fec;
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_fabric_links_default_fec_set;
    data_index = dnx_data_fabric_links_table_supported_fec_controls;
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_fabric_links_supported_fec_controls_set;
    ...
    data_index = dnx_data_fabric_cell_define_max_vsc_format_size;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_fabric_cell_max_vsc_format_size_set;
    ...
    data_index = dnx_data_fabric_cell_define_cell_format;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_fabric_cell_cell_format_set;
    ...
    data_index = dnx_data_fabric_cell_pcp_force_no_packing;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_fabric_cell_pcp_force_no_packing_set;

    
    data_index = dnx_data_fabric_cell_table_supported_pcp_modes;
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_fabric_cell_supported_pcp_modes_set;
    ...
    data_index = dnx_data_fabric_dtqs_define_max_nof_dtqs;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_fabric_dtqs_max_nof_dtqs_set;
    ...
    data_index = dnx_data_fabric_dbal_define_cgm_egress_dynamic_wfq_th_bits_nof;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_fabric_dbal_cgm_egress_dynamic_wfq_th_bits_nof_set;
    ...
    data_index = dnx_data_fabric_dbal_define_fdr_links_offset;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_fabric_dbal_fdr_links_offset_set;
    data_index = dnx_data_fabric_dbal_define_fabric_cgm_rci_high_severity_min_nof_links_bits_nof;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_fabric_dbal_fabric_cgm_rci_high_severity_min_nof_links_bits_nof_set;
    ...
    data_index = dnx_data_fabric_transmit_table_dtq_to_pdq_fc_mapping;
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_fabric_transmit_dtq_to_pdq_fc_mapping_set;
    ...
    data_index = dnx_data_fabric_system_upgrade_is_system_upgrade_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_fabric_system_upgrade_is_system_upgrade_supported_set;
    data_index = dnx_data_fabric_system_upgrade_is_system_upgrade_master_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_fabric_system_upgrade_is_system_upgrade_master_supported_set;
    ...
    submodule_index = dnx_data_fabric_submodule_regression;
    submodule = &module->submodules[submodule_index];

    
    data_index = dnx_data_fabric_regression_define_minimum_system_ref_clk;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_fabric_regression_minimum_system_ref_clk_set;
    data_index = dnx_data_fabric_regression_define_soft_reset_with_fabric_max_exec_time;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_fabric_regression_soft_reset_with_fabric_max_exec_time_set;
    data_index = dnx_data_fabric_regression_define_soft_reset_with_fabric_avg_exec_time;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_fabric_regression_soft_reset_with_fabric_avg_exec_time_set;

    
    data_index = dnx_data_fabric_regression_is_hist_errcnt_thresh_used;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_fabric_regression_is_hist_errcnt_thresh_used_set;
