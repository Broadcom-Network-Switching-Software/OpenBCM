...
static shr_error_e
jr2_a0_dnx_data_trap_egress_egress_divided_to_erpp_and_etpp_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
    int submodule_index = dnx_data_trap_submodule_egress;
    int feature_index = dnx_data_trap_egress_egress_divided_to_erpp_and_etpp;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_trap_egress_fabric_ptp_trap_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
    int submodule_index = dnx_data_trap_submodule_egress;
    int feature_index = dnx_data_trap_egress_fabric_ptp_trap_support;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_trap_egress_deep_editing_trap_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
    int submodule_index = dnx_data_trap_submodule_egress;
    int feature_index = dnx_data_trap_egress_deep_editing_trap_support;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_trap_egress_ffc_out_of_bound_trap_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
    int submodule_index = dnx_data_trap_submodule_egress;
    int feature_index = dnx_data_trap_egress_ffc_out_of_bound_trap_support;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    submodule_index = dnx_data_trap_submodule_egress;
    submodule = &module->submodules[submodule_index];

    

    
    data_index = dnx_data_trap_egress_egress_divided_to_erpp_and_etpp;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_trap_egress_egress_divided_to_erpp_and_etpp_set;
    data_index = dnx_data_trap_egress_fabric_ptp_trap_support;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_trap_egress_fabric_ptp_trap_support_set;
    data_index = dnx_data_trap_egress_deep_editing_trap_support;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_trap_egress_deep_editing_trap_support_set;
    data_index = dnx_data_trap_egress_ffc_out_of_bound_trap_support;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_trap_egress_ffc_out_of_bound_trap_support_set;
