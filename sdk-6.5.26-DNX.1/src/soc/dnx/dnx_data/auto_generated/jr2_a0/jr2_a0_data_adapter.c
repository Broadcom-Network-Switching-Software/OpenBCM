...
static shr_error_e
jr2_a0_dnx_data_adapter_general_tx_packet_header_signal_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
jr2_a0_dnx_data_adapter_general_tx_packet_tag_swap_res_signal_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
jr2_a0_dnx_data_adapter_general_tx_packet_recycle_command_signal_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
jr2_a0_dnx_data_adapter_general_tx_packet_recycle_context_signal_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
jr2_a0_dnx_data_adapter_general_tx_packet_valid_bytes_signal_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
jr2_a0_dnx_data_adapter_general_tx_packet_header_signal_width_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
jr2_a0_dnx_data_adapter_general_tx_packet_tag_swap_res_signal_width_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
jr2_a0_dnx_data_adapter_general_tx_packet_recycle_command_signal_width_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
jr2_a0_dnx_data_adapter_general_tx_packet_recycle_context_signal_width_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
jr2_a0_dnx_data_adapter_general_tx_packet_valid_bytes_signal_width_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
jr2_a0_dnx_data_adapter_mdb_lookup_caller_id_mapping_key_map(
    int unit,
    int key0_val,
    int key1_val,
    int *key0_index,
    int *key1_index)
{
    ...
    switch (key1_val)
    {
        ...
        case DNX_PP_STAGE_VTT2+100*DBAL_PHYSICAL_TABLE_TCAM:
            *key1_index = 26;
            break;
        case DNX_PP_STAGE_IFWD2+100*DBAL_PHYSICAL_TABLE_LEM:
            *key1_index = 27;
            break;
...
static shr_error_e
jr2_a0_dnx_data_adapter_mdb_lookup_caller_id_mapping_key_reverse_map(
    int unit,
    int key0_index,
    int key1_index,
    int *key0_val,
    ...
    switch (key1_index)
    {
        ...
        case 26:
            *key1_val = DNX_PP_STAGE_VTT2+100*DBAL_PHYSICAL_TABLE_TCAM;
            break;
        case 27:
            *key1_val = DNX_PP_STAGE_IFWD2+100*DBAL_PHYSICAL_TABLE_LEM;
            break;
        case 28:
    ...
    int unit)
{
    ...
    table->keys[1].size = 30;
    table->info_get.key_size[1] = 30;
    ...
    table->key_map = jr2_a0_dnx_data_adapter_mdb_lookup_caller_id_mapping_key_map;
    table->key_map_reverse = jr2_a0_dnx_data_adapter_mdb_lookup_caller_id_mapping_key_reverse_map;
    ...
    data->mdb = DBAL_PHYSICAL_TABLE_EOEM_1;
    data->interface = "3";
    data = (dnx_data_adapter_mdb_lookup_caller_id_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 105, DNX_PP_STAGE_LLR+100*DBAL_PHYSICAL_TABLE_TCAM);
    ...
    data->interface = "UnknownInterface";
    data = (dnx_data_adapter_mdb_lookup_caller_id_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 130, DNX_PP_STAGE_VTT1+100*DBAL_PHYSICAL_TABLE_TCAM);
    data->stage = DNX_PP_STAGE_VTT1;
    data->mdb = DBAL_PHYSICAL_TABLE_TCAM;
    data->interface = "UnknownInterface";
    ...
    data->mdb = DBAL_PHYSICAL_TABLE_TCAM;
    data->interface = "UnknownInterface";
    data = (dnx_data_adapter_mdb_lookup_caller_id_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 134, DNX_PP_STAGE_VTT3+100*DBAL_PHYSICAL_TABLE_TCAM);
    data->stage = DNX_PP_STAGE_VTT3;
    data->mdb = DBAL_PHYSICAL_TABLE_TCAM;
    data->interface = "UnknownInterface";
    data = (dnx_data_adapter_mdb_lookup_caller_id_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 138, DNX_PP_STAGE_VTT2+100*DBAL_PHYSICAL_TABLE_TCAM);
    ...
    data->mdb = DBAL_PHYSICAL_TABLE_TCAM;
    data->interface = "UnknownInterface";
    data = (dnx_data_adapter_mdb_lookup_caller_id_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 111, DNX_PP_STAGE_VTT4+100*DBAL_PHYSICAL_TABLE_TCAM);
    ...
    data->mdb = DBAL_PHYSICAL_TABLE_TCAM;
    data->interface = "UnknownInterface";
    data = (dnx_data_adapter_mdb_lookup_caller_id_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 115, DNX_PP_STAGE_VTT5+100*DBAL_PHYSICAL_TABLE_TCAM);
    ...
    data->mdb = DBAL_PHYSICAL_TABLE_TCAM;
    data->interface = "UnknownInterface";
    data = (dnx_data_adapter_mdb_lookup_caller_id_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 157, DNX_PP_STAGE_IFWD1+100*DBAL_PHYSICAL_TABLE_TCAM);
    ...
    data->mdb = DBAL_PHYSICAL_TABLE_TCAM;
    data->interface = "UnknownInterface";
    data = (dnx_data_adapter_mdb_lookup_caller_id_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 161, DNX_PP_STAGE_IFWD2+100*DBAL_PHYSICAL_TABLE_TCAM);
    ...
    data->mdb = DBAL_PHYSICAL_TABLE_TCAM;
    data->interface = "UnknownInterface";
    data = (dnx_data_adapter_mdb_lookup_caller_id_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 228, DNX_PP_STAGE_IPMF1+100*DBAL_PHYSICAL_TABLE_TCAM);
    data->stage = DNX_PP_STAGE_IPMF1;
    data->mdb = DBAL_PHYSICAL_TABLE_TCAM;
    data->interface = "UnknownInterface";
    ...
    data->mdb = DBAL_PHYSICAL_TABLE_TCAM;
    data->interface = "UnknownInterface";
    data = (dnx_data_adapter_mdb_lookup_caller_id_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 182, DNX_PP_STAGE_IPMF1+100*DBAL_PHYSICAL_TABLE_TCAM);
    data->stage = DNX_PP_STAGE_IPMF1;
    data->mdb = DBAL_PHYSICAL_TABLE_TCAM;
    data->interface = "UnknownInterface";
    ...
    data->mdb = DBAL_PHYSICAL_TABLE_TCAM;
    data->interface = "UnknownInterface";
    data = (dnx_data_adapter_mdb_lookup_caller_id_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 228, DNX_PP_STAGE_IPMF2+100*DBAL_PHYSICAL_TABLE_TCAM);
    data->stage = DNX_PP_STAGE_IPMF2;
    data->mdb = DBAL_PHYSICAL_TABLE_TCAM;
    data->interface = "UnknownInterface";
    ...
    data->mdb = DBAL_PHYSICAL_TABLE_TCAM;
    data->interface = "UnknownInterface";
    data = (dnx_data_adapter_mdb_lookup_caller_id_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 128, DNX_PP_STAGE_EPMF+100*DBAL_PHYSICAL_TABLE_TCAM);
    data->stage = DNX_PP_STAGE_EPMF;
    data->mdb = DBAL_PHYSICAL_TABLE_TCAM;
    data->interface = "UnknownInterface";
    data = (dnx_data_adapter_mdb_lookup_caller_id_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 80, DNX_PP_STAGE_ERPRP+100*DBAL_PHYSICAL_TABLE_TCAM);
    data->stage = DNX_PP_STAGE_ERPRP;
    data->mdb = DBAL_PHYSICAL_TABLE_TCAM;
    data->interface = "UnknownInterface";
    ...
    data->mdb = DBAL_PHYSICAL_TABLE_TCAM;
    data->interface = "UnknownInterface";
    data = (dnx_data_adapter_mdb_lookup_caller_id_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 7, DNX_PP_STAGE_EPMF+100*DBAL_PHYSICAL_TABLE_TCAM);
    data->stage = DNX_PP_STAGE_EPMF;
    data->mdb = DBAL_PHYSICAL_TABLE_TCAM;
    data->interface = "UnknownInterface";
    ...
    data->interface = "UnknownInterface";
    data = (dnx_data_adapter_mdb_lookup_caller_id_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 6, DNX_PP_STAGE_IFWD2+100*DBAL_PHYSICAL_TABLE_LEM);
    data->stage = DNX_PP_STAGE_IFWD2;
    data->mdb = DBAL_PHYSICAL_TABLE_LEM;
    data->interface = "UnknownInterface";
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_adapter_general_tx_packet_header_signal_id_set;
    data_index = dnx_data_adapter_general_define_tx_packet_tag_swap_res_signal_id;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_adapter_general_tx_packet_tag_swap_res_signal_id_set;
    data_index = dnx_data_adapter_general_define_tx_packet_recycle_command_signal_id;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_adapter_general_tx_packet_recycle_command_signal_id_set;
    data_index = dnx_data_adapter_general_define_tx_packet_recycle_context_signal_id;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_adapter_general_tx_packet_recycle_context_signal_id_set;
    data_index = dnx_data_adapter_general_define_tx_packet_valid_bytes_signal_id;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_adapter_general_tx_packet_valid_bytes_signal_id_set;
    data_index = dnx_data_adapter_general_define_tx_packet_header_signal_width;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_adapter_general_tx_packet_header_signal_width_set;
    data_index = dnx_data_adapter_general_define_tx_packet_tag_swap_res_signal_width;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_adapter_general_tx_packet_tag_swap_res_signal_width_set;
    data_index = dnx_data_adapter_general_define_tx_packet_recycle_command_signal_width;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_adapter_general_tx_packet_recycle_command_signal_width_set;
    data_index = dnx_data_adapter_general_define_tx_packet_recycle_context_signal_width;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_adapter_general_tx_packet_recycle_context_signal_width_set;
    data_index = dnx_data_adapter_general_define_tx_packet_valid_bytes_signal_width;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_adapter_general_tx_packet_valid_bytes_signal_width_set;
