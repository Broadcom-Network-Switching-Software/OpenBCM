...
static shr_error_e
jr2_a0_dnx_data_vlan_vlan_translate_ive_4_tag_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_vlan;
    int submodule_index = dnx_data_vlan_submodule_vlan_translate;
    int feature_index = dnx_data_vlan_vlan_translate_ive_4_tag_support;
    ...
    int unit)
{
    ...
    data_index = dnx_data_vlan_vlan_translate_ive_4_tag_support;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_vlan_vlan_translate_ive_4_tag_support_set;
