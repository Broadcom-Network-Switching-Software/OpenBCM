...
static shr_error_e
jr2_a0_dnx_data_field_tests_mdb_dt_in_ipmf3_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_tests;
    int define_index = dnx_data_field_tests_define_mdb_dt_in_ipmf3;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_field_tests_mdb_dt_has_key_result_signals_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_tests;
    int define_index = dnx_data_field_tests_define_mdb_dt_has_key_result_signals;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_field_tests_define_mdb_dt_in_ipmf3;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_tests_mdb_dt_in_ipmf3_set;
    data_index = dnx_data_field_tests_define_mdb_dt_has_key_result_signals;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_tests_mdb_dt_has_key_result_signals_set;
