...
static shr_error_e
jr2_a0_dnx_data_headers_system_headers_itmh_itpp_termination_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_headers;
    int submodule_index = dnx_data_headers_submodule_system_headers;
    int define_index = dnx_data_headers_system_headers_define_itmh_itpp_termination;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_headers_system_headers_define_itmh_itpp_termination;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_headers_system_headers_itmh_itpp_termination_set;
