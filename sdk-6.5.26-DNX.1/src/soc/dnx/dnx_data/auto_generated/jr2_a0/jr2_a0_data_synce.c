...
static shr_error_e
jr2_a0_dnx_data_synce_general_multi_set_is_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_synce;
    int submodule_index = dnx_data_synce_submodule_general;
    int feature_index = dnx_data_synce_general_multi_set_is_supported;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_synce_general_multi_set_is_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_synce_general_multi_set_is_supported_set;
