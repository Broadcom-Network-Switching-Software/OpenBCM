...
static shr_error_e
jr2_a0_dnx_data_ingr_reassembly_general_is_used_set(
    int unit)
{
...
static shr_error_e
jr2_a0_dnx_data_ingr_reassembly_context_port_termination_in_context_table_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_ingr_reassembly;
    int submodule_index = dnx_data_ingr_reassembly_submodule_context;
    int feature_index = dnx_data_ingr_reassembly_context_port_termination_in_context_table;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_ingr_reassembly_context_reassembly_timeout_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ingr_reassembly;
    int submodule_index = dnx_data_ingr_reassembly_submodule_context;
    int define_index = dnx_data_ingr_reassembly_context_define_reassembly_timeout;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_ingr_reassembly_context_rcy_unique_context_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ingr_reassembly;
    int submodule_index = dnx_data_ingr_reassembly_submodule_context;
    int define_index = dnx_data_ingr_reassembly_context_define_rcy_unique_context;
    SHR_FUNC_INIT_VARS(unit);
    ...
    define->property.name = spn_INGRESS_REASSEMBLY_UNIQUE_CONTEXT_RCY;
    define->property.doc = 
        "\n"
    ;
    ...
    int unit)
{
    ...
    if (DNX_ALGO_PORT_TYPE_CRPS < table->keys[0].size && 0 < table->keys[1].size)
    {
    ...
    int unit)
{
    ...
    feature->set = jr2_a0_dnx_data_ingr_reassembly_general_is_used_set;
    ...
    data_index = dnx_data_ingr_reassembly_context_define_reassembly_timeout;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_ingr_reassembly_context_reassembly_timeout_set;
    data_index = dnx_data_ingr_reassembly_context_define_rcy_unique_context;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_ingr_reassembly_context_rcy_unique_context_set;
    ...
    data_index = dnx_data_ingr_reassembly_context_port_termination_in_context_table;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_ingr_reassembly_context_port_termination_in_context_table_set;
