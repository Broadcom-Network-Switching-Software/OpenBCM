...
static shr_error_e
jr2_a0_dnx_data_bfd_general_bfd_over_php_tcam_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_bfd;
...
static shr_error_e
jr2_a0_dnx_data_bfd_general_bfd_over_php_oam_tcam_oam_offset_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_bfd;
...
static shr_error_e
jr2_a0_dnx_data_bfd_general_bfd_echo_support_in_parser_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_bfd;
    int submodule_index = dnx_data_bfd_submodule_general;
    int define_index = dnx_data_bfd_general_define_bfd_echo_support_in_parser;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_bfd_general_bfd_nof_server_device_profile_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_bfd;
    int submodule_index = dnx_data_bfd_submodule_general;
    int define_index = dnx_data_bfd_general_define_bfd_nof_server_device_profile;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_bfd_general_bfd_over_php_oam_tcam_oam_offset_set;
    data_index = dnx_data_bfd_general_define_bfd_echo_support_in_parser;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_bfd_general_bfd_echo_support_in_parser_set;
    data_index = dnx_data_bfd_general_define_bfd_nof_server_device_profile;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_bfd_general_bfd_nof_server_device_profile_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_bfd_general_bfd_over_php_tcam_support_set;
