    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_system_red_config_define_enable].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_system_red_info_is_share_res_with_latency_based_admission].doc = "";
    ...
    submodule_data->defines[dnx_data_system_red_info_define_nof_red_q_size].doc = "";
    ...
    submodule_data->defines[dnx_data_system_red_info_define_max_red_q_size].doc = "";
    ...
    submodule_data->defines[dnx_data_system_red_info_define_max_ing_aging_period].doc = "";
    ...
    submodule_data->defines[dnx_data_system_red_info_define_max_sch_aging_period].doc = "";
    ...
    submodule_data->defines[dnx_data_system_red_info_define_sch_aging_period_factor].doc = "";
    ...
    submodule_data->defines[dnx_data_system_red_info_define_max_free_res_thr_range].doc = "";
    ...
    submodule_data->tables[dnx_data_system_red_info_table_resource].doc = "";
    ...
    submodule_data->tables[dnx_data_system_red_info_table_resource].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_system_red_info_table_resource].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_system_red_info_table_resource].values[1].doc = "";
    ...
    submodule_data->tables[dnx_data_system_red_info_table_resource].values[2].doc = "";
    ...
    submodule_data->tables[dnx_data_system_red_info_table_dbal].doc = "";
    ...
    submodule_data->tables[dnx_data_system_red_info_table_dbal].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_system_red_info_table_dbal].values[0].doc = "";
