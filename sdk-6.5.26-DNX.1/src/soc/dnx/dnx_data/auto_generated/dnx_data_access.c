    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_access_mdio_define_nof_pms_per_ring].doc = "";
    ...
    submodule_data->defines[dnx_data_access_mdio_define_ring_offset].doc = "";
    ...
    submodule_data->defines[dnx_data_access_mdio_define_offset_in_ring].doc = "";
    ...
    submodule_data->defines[dnx_data_access_mdio_define_ext_divisor].doc = "";
    ...
    submodule_data->defines[dnx_data_access_mdio_define_int_divisor].doc = "";
    ...
    submodule_data->defines[dnx_data_access_mdio_define_int_div_out_delay].doc = "";
    ...
    submodule_data->defines[dnx_data_access_mdio_define_ext_div_out_delay].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_access_rcpu_table_rx].doc = "";
    ...
    submodule_data->tables[dnx_data_access_rcpu_table_rx].values[0].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_access_blocks_table_override].doc = "";
    ...
    submodule_data->tables[dnx_data_access_blocks_table_override].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_access_blocks_table_override].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_access_blocks_table_override].values[1].doc = "";
    ...
    submodule_data->tables[dnx_data_access_blocks_table_override].values[2].doc = "";
