    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_trap_egress_ffc_out_of_bound_trap_support].name = "ffc_out_of_bound_trap_support";
    submodule_data->features[dnx_data_trap_egress_ffc_out_of_bound_trap_support].doc = "";
    submodule_data->features[dnx_data_trap_egress_ffc_out_of_bound_trap_support].flags |= DNXC_DATA_F_FEATURE;
