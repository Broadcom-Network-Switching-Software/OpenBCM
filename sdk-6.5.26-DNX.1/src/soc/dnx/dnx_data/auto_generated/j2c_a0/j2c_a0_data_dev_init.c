    ...
    int unit)
{
    ...
    table->keys[0].size = 59;
    table->info_get.key_size[0] = 59;
...
static shr_error_e
j2c_a0_dnx_data_dev_init_general_erpp_threshold_prp_per_port_info_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
j2c_a0_dnx_data_dev_init_general_clock_power_down_set(
    int unit)
{
    int index_index;
...
static shr_error_e
j2c_a0_dnx_data_dev_init_context_forwarding_context_selection_mask_offset_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
j2c_a0_dnx_data_dev_init_context_forwarding_context_selection_result_offset_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
j2c_a0_dnx_data_dev_init_context_termination_context_selection_mask_offset_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
j2c_a0_dnx_data_dev_init_context_termination_context_selection_result_offset_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
j2c_a0_dnx_data_dev_init_context_prp_pem_context_selection_mask_offset_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
j2c_a0_dnx_data_dev_init_context_prp_context_selection_result_offset_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
    ...
    int unit)
{
    ...
    table->keys[0].size = 105;
    table->info_get.key_size[0] = 105;
    ...
    int unit)
{
    ...
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_dev_init_general_erpp_threshold_prp_per_port_info_set;

    
    data_index = dnx_data_dev_init_general_table_clock_power_down;
    table = &submodule->tables[data_index];
    table->set = j2c_a0_dnx_data_dev_init_general_clock_power_down_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_dev_init_context_forwarding_context_selection_mask_offset_set;
    data_index = dnx_data_dev_init_context_define_forwarding_context_selection_result_offset;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_dev_init_context_forwarding_context_selection_result_offset_set;
    data_index = dnx_data_dev_init_context_define_termination_context_selection_mask_offset;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_dev_init_context_termination_context_selection_mask_offset_set;
    data_index = dnx_data_dev_init_context_define_termination_context_selection_result_offset;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_dev_init_context_termination_context_selection_result_offset_set;
    data_index = dnx_data_dev_init_context_define_prp_pem_context_selection_mask_offset;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_dev_init_context_prp_pem_context_selection_mask_offset_set;
    data_index = dnx_data_dev_init_context_define_prp_context_selection_result_offset;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_dev_init_context_prp_context_selection_result_offset_set;
