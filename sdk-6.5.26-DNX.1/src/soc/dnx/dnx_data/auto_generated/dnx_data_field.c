    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_field_tests_define_mdb_dt_in_ipmf3].name = "mdb_dt_in_ipmf3";
    submodule_data->defines[dnx_data_field_tests_define_mdb_dt_in_ipmf3].doc = "";
    
    submodule_data->defines[dnx_data_field_tests_define_mdb_dt_in_ipmf3].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_field_tests_define_mdb_dt_has_key_result_signals].name = "mdb_dt_has_key_result_signals";
    submodule_data->defines[dnx_data_field_tests_define_mdb_dt_has_key_result_signals].doc = "";
    
    submodule_data->defines[dnx_data_field_tests_define_mdb_dt_has_key_result_signals].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_field_tests_mdb_dt_in_ipmf3_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_tests, dnx_data_field_tests_define_mdb_dt_in_ipmf3);
}

uint32
dnx_data_field_tests_mdb_dt_has_key_result_signals_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_tests, dnx_data_field_tests_define_mdb_dt_has_key_result_signals);
}
