    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_iqs_deq_default_table_sqm_read_weight_profiles].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_iqs_deq_default_table_dqm_read_weight_profiles].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_iqs_deq_default_table_params].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_iqs_deq_default_table_params].values[1].doc = "";
    ...
    submodule_data->tables[dnx_data_iqs_deq_default_table_params].values[2].doc = "";
    ...
    submodule_data->tables[dnx_data_iqs_deq_default_table_params].values[3].doc = "";
    ...
    submodule_data->tables[dnx_data_iqs_deq_default_table_params].values[4].doc = "";
    ...
    submodule_data->tables[dnx_data_iqs_deq_default_table_params].values[5].doc = "";
    ...
    submodule_data->tables[dnx_data_iqs_deq_default_table_dram_params].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_iqs_deq_default_table_dram_params].values[1].doc = "";
    ...
    submodule_data->tables[dnx_data_iqs_deq_default_table_max_deq_cmd].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_iqs_deq_default_table_s2d_max_deq_cmd].values[0].doc = "";
