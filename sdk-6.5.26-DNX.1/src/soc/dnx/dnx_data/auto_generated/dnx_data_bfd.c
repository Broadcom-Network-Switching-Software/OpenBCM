    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_bfd_general_extended_sip_support].doc = "";
    ...
    submodule_data->features[dnx_data_bfd_general_vxlan_support].doc = "";
    ...
    submodule_data->features[dnx_data_bfd_general_bfd_over_php_support].doc = "";
    ...
    submodule_data->features[dnx_data_bfd_general_bfd_over_php_tcam_support].doc = "";
    ...
    submodule_data->defines[dnx_data_bfd_general_define_nof_bits_bfd_endpoints].doc = "";
    ...
    submodule_data->defines[dnx_data_bfd_general_define_nof_endpoints].doc = "";
    ...
    submodule_data->defines[dnx_data_bfd_general_define_nof_dips_for_bfd_multihop].doc = "";
    ...
    submodule_data->defines[dnx_data_bfd_general_define_nof_bits_dips_for_bfd_multihop].doc = "";
    ...
    submodule_data->defines[dnx_data_bfd_general_define_nof_bfd_server_trap_codes].doc = "";
    ...
    submodule_data->defines[dnx_data_bfd_general_define_nof_profiles_for_tx_rate].doc = "";
    ...
    submodule_data->defines[dnx_data_bfd_general_define_nof_bits_bfd_server_trap_codes].doc = "";
    ...
    submodule_data->defines[dnx_data_bfd_general_define_rmep_index_db_ipv4_const].doc = "";
    ...
    submodule_data->defines[dnx_data_bfd_general_define_rmep_index_db_mpls_const].doc = "";
    ...
    submodule_data->defines[dnx_data_bfd_general_define_rmep_index_db_pwe_const].doc = "";
    ...
    submodule_data->defines[dnx_data_bfd_general_define_nof_req_int_profiles].doc = "";
    ...
    submodule_data->defines[dnx_data_bfd_general_define_nof_bits_your_discr_to_lif].doc = "";
    ...
    submodule_data->defines[dnx_data_bfd_general_define_oamp_bfd_cw_valid_dis_supp].doc = "";
    ...
    submodule_data->defines[dnx_data_bfd_general_define_bfd_over_php_oam_tcam_oam_offset].doc = "";
    ...
    submodule_data->defines[dnx_data_bfd_general_define_bfd_echo_support_in_parser].doc = "";
    
    submodule_data->defines[dnx_data_bfd_general_define_bfd_echo_support_in_parser].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_bfd_general_define_bfd_nof_server_device_profile].name = "bfd_nof_server_device_profile";
    submodule_data->defines[dnx_data_bfd_general_define_bfd_nof_server_device_profile].doc = "";
    
    submodule_data->defines[dnx_data_bfd_general_define_bfd_nof_server_device_profile].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_bfd_general_bfd_nof_server_device_profile_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_bfd, dnx_data_bfd_submodule_general, dnx_data_bfd_general_define_bfd_nof_server_device_profile);
}
