...
static shr_error_e
jr2_b0_dnx_data_l3_fec_supported_fec_flags_set(
    int unit)
{
...
static shr_error_e
jr2_b0_dnx_data_l3_fec_supported_fec_flags2_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_l3;
    ...
    int unit)
{
    ...
    define->set = jr2_b0_dnx_data_l3_fec_supported_fec_flags_set;
    data_index = dnx_data_l3_fec_define_supported_fec_flags2;
    define = &submodule->defines[data_index];
    define->set = jr2_b0_dnx_data_l3_fec_supported_fec_flags2_set;
