...
static shr_error_e
jr2_b0_dnx_data_mdb_em_scan_bank_participate_in_cuckoo_partial_support_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_mdb;
    ...
    int unit)
{
    ...
    if (DBAL_PHYSICAL_TABLE_LEM < table->keys[0].size)
    {
        ...
        data->emp_age_cfg_reg = MDB_REG_191r;
    ...
    if (DBAL_PHYSICAL_TABLE_SEXEM_3 < table->keys[0].size)
    {
        ...
        data->emp_scan_status_field = ITEM_36_37f;
        data->emp_age_cfg_reg = MDB_REG_483r;
        data->global_value = ITEM_0_63f;
        data->global_masks = ITEM_64_127f;
        data->external_profile = ITEM_128_135f;
        data->age_disable = ITEM_136_143f;
    ...
    if (DBAL_PHYSICAL_TABLE_LEXEM < table->keys[0].size)
    {
        ...
        data->emp_scan_status_field = ITEM_36_37f;
        data->emp_age_cfg_reg = MDB_REG_536r;
        data->global_value = ITEM_0_63f;
        data->global_masks = ITEM_64_127f;
        data->external_profile = ITEM_128_135f;
        data->age_disable = ITEM_136_143f;
...
static shr_error_e
jr2_b0_dnx_data_mdb_em_mdb_em_dbal_phy_tables_info_set(
    int unit)
{
    int dbal_id_index;
...
static shr_error_e
jr2_b0_dnx_data_mdb_direct_mdb_direct_mdb_phy_tables_info_set(
    int unit)
{
    int mdb_table_id_index;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_b0_dnx_data_mdb_em_scan_bank_participate_in_cuckoo_partial_support_set;
    ...
    table = &submodule->tables[data_index];
    table->set = jr2_b0_dnx_data_mdb_em_mdb_em_dbal_phy_tables_info_set;
    ...
    table = &submodule->tables[data_index];
    table->set = jr2_b0_dnx_data_mdb_direct_mdb_direct_mdb_phy_tables_info_set;
