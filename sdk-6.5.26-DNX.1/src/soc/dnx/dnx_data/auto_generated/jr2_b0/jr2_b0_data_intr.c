    ...
    int unit)
{
    ...
    table->keys[0].size = 438;
    table->info_get.key_size[0] = 438;
    ...
    int unit)
{
    ...
    if (1 < table->keys[0].size)
    {
        ...
        data->reg = CDUM_ECC_ERR_1B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (2 < table->keys[0].size)
    {
    ...
    if (9 < table->keys[0].size)
    {
        ...
        data->reg = DHC_ECC_ERR_1B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (10 < table->keys[0].size)
    {
    ...
    if (65 < table->keys[0].size)
    {
        ...
        data->reg = CDUM_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (66 < table->keys[0].size)
    {
    ...
    if (73 < table->keys[0].size)
    {
        ...
        data->reg = DHC_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (74 < table->keys[0].size)
    {
    ...
    if (128 < table->keys[0].size)
    {
        ...
        data->reg = CDUM_PAR_ERR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (129 < table->keys[0].size)
    {
...
static shr_error_e
jr2_b0_dnx_data_intr_ser_severity_mem_set(
    int unit)
{
    int index_index;
    ...
    if (21 < table->keys[0].size)
    {
        ...
        data->mem = ERPP_PRP_SAVE_NETWORK_HEADER_FIFOm;
        data->severity = SOC_MEM_SEVERE_HIGH;
    }
    ...
    int unit)
{
    ...
    table = &submodule->tables[data_index];
    table->set = jr2_b0_dnx_data_intr_ser_severity_mem_set;
