    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_techsupport_tm_table_tm_block].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_techsupport_tm_table_tm_block].values[1].doc = "";
    ...
    submodule_data->tables[dnx_data_techsupport_tm_table_tm_block].values[2].doc = "";
    ...
    submodule_data->tables[dnx_data_techsupport_tm_table_tm_command].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_techsupport_tm_table_tm_mem].values[0].doc = "";
