...
static shr_error_e
q2a_b1_dnx_data_latency_based_admission_cgm_extended_profiles_enable_set(
    int unit)
{
...
static shr_error_e
q2a_b1_dnx_data_latency_based_admission_reject_flow_profile_value_set(
    int unit)
{
...
static shr_error_e
q2a_b1_dnx_data_latency_based_admission_cgm_extended_profiles_enable_value_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_latency;
...
static shr_error_e
q2a_b1_dnx_data_latency_based_admission_max_supported_profile_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_latency;
    ...
    int unit)
{
    ...
    define->set = q2a_b1_dnx_data_latency_based_admission_reject_flow_profile_value_set;
    data_index = dnx_data_latency_based_admission_define_cgm_extended_profiles_enable_value;
    define = &submodule->defines[data_index];
    define->set = q2a_b1_dnx_data_latency_based_admission_cgm_extended_profiles_enable_value_set;
    data_index = dnx_data_latency_based_admission_define_max_supported_profile;
    define = &submodule->defines[data_index];
    define->set = q2a_b1_dnx_data_latency_based_admission_max_supported_profile_set;

    
    data_index = dnx_data_latency_based_admission_cgm_extended_profiles_enable;
    feature = &submodule->features[data_index];
    feature->set = q2a_b1_dnx_data_latency_based_admission_cgm_extended_profiles_enable_set;
