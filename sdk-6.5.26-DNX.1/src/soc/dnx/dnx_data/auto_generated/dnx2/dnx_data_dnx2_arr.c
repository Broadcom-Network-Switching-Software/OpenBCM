    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_ETPP_ETPS_FORMATS___prefix_Empty].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_ETPP_ETPS_FORMATS___prefix_FORWARD_DOMAIN_VRF_Encoding].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_ETPP_ETPS_FORMATS___prefix_ENCAP_TTL_IDX_MPLS_FHEI].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_ETPP_ETPS_FORMATS___prefix_Empty2].name = "ETPP_ETPS_FORMATS___prefix_Empty2";
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_ETPP_ETPS_FORMATS___prefix_Empty2].doc = "";
        
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_ETPP_ETPS_FORMATS___prefix_Empty2].flags |= DNXC_DATA_F_DEFINE;
    }
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_ETPP_ETPS_FORMATS___prefix_Always_Last_Layer].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_ETPP_ETPS_FORMATS___prefix_LIF_AHP_MPLS_Prefix].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_ETPP_ETPS_FORMATS___prefix_ENCAP_QOS_MODEL_MPLS_FHEI].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_ETPP_ETPS_FORMATS___prefix_ENCAP_QOS_IDX_MPLS_FHEI].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_ETPP_ETPS_FORMATS___prefix_OutLIF_Profile_Orientation_Only].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_ETPP_ETPS_FORMATS___prefix_FORWARD_DOMAIN_VRF_IPvX_Tunnel].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_ETPP_ETPS_FORMATS___prefix_QOS_MODEL_1].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_IPv6_TUNNELS_FODO_Namespace].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_ETPP_ETPS_FORMATS___prefix_ENCAP_TTL_MODEL_MPLS_FHEI].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_IPv4_VxLAN_OR_VXLAN_GPE_FODO_Namespace].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_ETPP_ETPS_FORMATS___prefix_FORWARD_QOS_MODEL_NWK_QOS].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_ARP_PLUS_AC].name = "ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_ARP_PLUS_AC";
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_ARP_PLUS_AC].doc = "";
        
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_ARP_PLUS_AC].flags |= DNXC_DATA_F_DEFINE;
    }
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_FEC_ENTRY_FORMAT___prefix_Empty].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_FEC_ENTRY_FORMAT___prefix_EEI_W_OUTLIF].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_FEC_ENTRY_FORMAT___prefix_OUTLIF_ETH_RIF].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_FEC_ENTRY_FORMAT___prefix_EEI_W_POP_Command].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_FEC_ENTRY_FORMAT___prefix_EEI_W_SWAP_Command].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_FEC_SUPER_ENTRY_FORMAT___prefix_Empty].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_FWD_STAGE_FORMATS___prefix_Empty].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_FWD_STAGE_FORMATS___prefix_msb_with_b11].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_FWD_STAGE_FORMATS___prefix_msb_with_b0001].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_FWD_STAGE_FORMATS___prefix_msb_with_b0010].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_FWD_STAGE_FORMATS___prefix_msb_with_b0011].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_FWD_STAGE_FORMATS___prefix_msb_with_b0100].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_FWD_STAGE_FORMATS___prefix_msb_with_b0101].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_FWD_STAGE_FORMATS___prefix_msb_with_b01111].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_IN_LIF_FORMATS___prefix_Empty].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_IN_LIF_FORMATS___prefix_Service_Type_Extended_P2P_W_Learning_Prefix].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_IN_LIF_FORMATS___prefix_Parser_Context_IPvX_DEMUX_or_ETH_B1__4b_Prefix].name = "IRPP_IN_LIF_FORMATS___prefix_Parser_Context_IPvX_DEMUX_or_ETH_B1__4b_Prefix";
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_IN_LIF_FORMATS___prefix_Parser_Context_IPvX_DEMUX_or_ETH_B1__4b_Prefix].doc = "";
        
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_IN_LIF_FORMATS___prefix_Parser_Context_IPvX_DEMUX_or_ETH_B1__4b_Prefix].flags |= DNXC_DATA_F_DEFINE;
    }

    if (soc_is(unit, DNX2_DEVICE))
    {
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_IN_LIF_FORMATS___prefix_Empty2].name = "IRPP_IN_LIF_FORMATS___prefix_Empty2";
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_IN_LIF_FORMATS___prefix_Empty2].doc = "";
        
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_IN_LIF_FORMATS___prefix_Empty2].flags |= DNXC_DATA_F_DEFINE;
    }

    if (soc_is(unit, DNX2_DEVICE))
    {
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_IN_LIF_FORMATS___prefix_XL_LEARN_INFO_PMF_DATA_PROTECT_CTX].name = "IRPP_IN_LIF_FORMATS___prefix_XL_LEARN_INFO_PMF_DATA_PROTECT_CTX";
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_IN_LIF_FORMATS___prefix_XL_LEARN_INFO_PMF_DATA_PROTECT_CTX].doc = "";
        
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_IN_LIF_FORMATS___prefix_XL_LEARN_INFO_PMF_DATA_PROTECT_CTX].flags |= DNXC_DATA_F_DEFINE;
    }
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_IN_LIF_FORMATS___prefix_VRF_VSI_Not_Found].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_IN_LIF_FORMATS___prefix_Forward_Domain_Assignment_Mode_LIF_or_VLAN].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_IN_LIF_FORMATS___prefix_Forward_Domain_VRF].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_IN_LIF_FORMATS___prefix_NEXT_LAYER_NETWORK_DOMAIN_TNIorVNI].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_IN_LIF_FORMATS___prefix_NEXT_LAYER_NETWORK_DOMAIN_PWE_WO_SD_TAGS].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_IN_LIF_FORMATS___prefix_LEARN_PAYLOAD_CONTEXT_SYMMETRIC_LIF_OPTIMIZED].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_IN_LIF_FORMATS___prefix_VSI_P2P_MSBS].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_IN_LIF_FORMATS___prefix_QoS_Profile_short_Prefix].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_IN_LIF_FORMATS___prefix_Learn_info_destination_port_encoding].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_VSI_FORMATS___prefix_Empty].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_VSI_FORMATS___prefix_VSI_Profile_Prefix].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_VSI_FORMATS___prefix_Dest_MC_ID_Prefix].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_VSI_FORMATS___prefix_Dest_FEC_Port_Trap_Prefix].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_VSI_FORMATS___prefix_Topology_ID_Prefix].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_VSI_FORMATS___prefix_QOS_Profile_Prefix].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_VSI_FORMATS___prefix_My_Mac_Prefix_Prefix].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_VSI_FORMATS___prefix_VSI_Stat_Obj_Cmd_Prefix].doc = "";
...
uint32
dnx_data_dnx2_arr_prefix_ETPP_ETPS_FORMATS___prefix_Empty2_get(
    int unit)
{
    
    if (!soc_is(unit, DNX2_DEVICE))
    {
        dnxc_data_mgmt_inaccessible_data_get(unit, "ETPP_ETPS_FORMATS___prefix_Empty2", "DNX2");
    }
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_dnx2_arr, dnx_data_dnx2_arr_submodule_prefix, dnx_data_dnx2_arr_prefix_define_ETPP_ETPS_FORMATS___prefix_Empty2);
}
...
uint32
dnx_data_dnx2_arr_prefix_ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_ARP_PLUS_AC_get(
    int unit)
{
    
    if (!soc_is(unit, DNX2_DEVICE))
    {
        dnxc_data_mgmt_inaccessible_data_get(unit, "ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_ARP_PLUS_AC", "DNX2");
    }
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_dnx2_arr, dnx_data_dnx2_arr_submodule_prefix, dnx_data_dnx2_arr_prefix_define_ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_ARP_PLUS_AC);
}
...
uint32
dnx_data_dnx2_arr_prefix_IRPP_IN_LIF_FORMATS___prefix_Parser_Context_IPvX_DEMUX_or_ETH_B1__4b_Prefix_get(
    int unit)
{
    
    if (!soc_is(unit, DNX2_DEVICE))
    {
        dnxc_data_mgmt_inaccessible_data_get(unit, "IRPP_IN_LIF_FORMATS___prefix_Parser_Context_IPvX_DEMUX_or_ETH_B1__4b_Prefix", "DNX2");
    }
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_dnx2_arr, dnx_data_dnx2_arr_submodule_prefix, dnx_data_dnx2_arr_prefix_define_IRPP_IN_LIF_FORMATS___prefix_Parser_Context_IPvX_DEMUX_or_ETH_B1__4b_Prefix);
}

uint32
dnx_data_dnx2_arr_prefix_IRPP_IN_LIF_FORMATS___prefix_Empty2_get(
    int unit)
{
    
    if (!soc_is(unit, DNX2_DEVICE))
    {
        dnxc_data_mgmt_inaccessible_data_get(unit, "IRPP_IN_LIF_FORMATS___prefix_Empty2", "DNX2");
    }
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_dnx2_arr, dnx_data_dnx2_arr_submodule_prefix, dnx_data_dnx2_arr_prefix_define_IRPP_IN_LIF_FORMATS___prefix_Empty2);
}

uint32
dnx_data_dnx2_arr_prefix_IRPP_IN_LIF_FORMATS___prefix_XL_LEARN_INFO_PMF_DATA_PROTECT_CTX_get(
    int unit)
{
    
    if (!soc_is(unit, DNX2_DEVICE))
    {
        dnxc_data_mgmt_inaccessible_data_get(unit, "IRPP_IN_LIF_FORMATS___prefix_XL_LEARN_INFO_PMF_DATA_PROTECT_CTX", "DNX2");
    }
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_dnx2_arr, dnx_data_dnx2_arr_submodule_prefix, dnx_data_dnx2_arr_prefix_define_IRPP_IN_LIF_FORMATS___prefix_XL_LEARN_INFO_PMF_DATA_PROTECT_CTX);
}
