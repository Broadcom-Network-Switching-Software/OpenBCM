    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_synce_general_measure_rate_on_down_port_is_supported].doc = "";
    ...
    submodule_data->defines[dnx_data_synce_general_define_nof_plls].doc = "";
