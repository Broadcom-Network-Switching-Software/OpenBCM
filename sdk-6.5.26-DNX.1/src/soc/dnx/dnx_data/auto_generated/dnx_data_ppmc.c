    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_ppmc_param_configurable_ppmc_range].name = "configurable_ppmc_range";
    submodule_data->features[dnx_data_ppmc_param_configurable_ppmc_range].doc = "";
    submodule_data->features[dnx_data_ppmc_param_configurable_ppmc_range].flags |= DNXC_DATA_F_FEATURE;
    ...
    submodule_data->defines[dnx_data_ppmc_param_define_max_mc_replication_id].doc = "";
    ...
    submodule_data->defines[dnx_data_ppmc_param_define_min_mc_replication_id].doc = "";
    
    submodule_data->defines[dnx_data_ppmc_param_define_min_mc_replication_id].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_ppmc_param_define_mc_replication_id_offset].name = "mc_replication_id_offset";
    submodule_data->defines[dnx_data_ppmc_param_define_mc_replication_id_offset].doc = "";
    
    submodule_data->defines[dnx_data_ppmc_param_define_mc_replication_id_offset].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_ppmc_param_define_ace_implementation].name = "ace_implementation";
    submodule_data->defines[dnx_data_ppmc_param_define_ace_implementation].doc = "";
    
    submodule_data->defines[dnx_data_ppmc_param_define_ace_implementation].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_ppmc_param_mc_replication_id_offset_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_ppmc, dnx_data_ppmc_submodule_param, dnx_data_ppmc_param_define_mc_replication_id_offset);
}

uint32
dnx_data_ppmc_param_ace_implementation_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_ppmc, dnx_data_ppmc_submodule_param, dnx_data_ppmc_param_define_ace_implementation);
}
