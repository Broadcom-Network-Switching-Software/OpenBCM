...
static shr_error_e
j2x_a0_dnx_data_spb_ocb_blocks_in_ring_set(
    int unit)
{
...
static shr_error_e
j2x_a0_dnx_data_spb_ocb_dbg_disable_enable_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_spb;
...
static shr_error_e
j2x_a0_dnx_data_spb_ocb_is_power_optimization_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_spb;
    int submodule_index = dnx_data_spb_submodule_ocb;
    int feature_index = dnx_data_spb_ocb_is_power_optimization_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
j2x_a0_dnx_data_spb_ocb_nof_blocks_set(
    int unit)
{
...
static shr_error_e
j2x_a0_dnx_data_spb_ocb_nof_rings_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_spb;
...
static shr_error_e
j2x_a0_dnx_data_spb_ocb_nof_banks_per_ring_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_spb;
...
static shr_error_e
j2x_a0_dnx_data_spb_ocb_nof_logical_banks_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_spb;
...
static shr_error_e
j2x_a0_dnx_data_spb_ocb_buffer_ptr_nof_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_spb;
...
static shr_error_e
j2x_a0_dnx_data_spb_ocb_sram_in_power_down_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_spb;
...
static shr_error_e
j2x_a0_dnx_data_spb_ocb_last_in_chain_set(
    int unit)
{
    int ocb_index_index;
    ...
    int unit)
{
    ...
    define->set = j2x_a0_dnx_data_spb_ocb_nof_blocks_set;
    data_index = dnx_data_spb_ocb_define_nof_rings;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_spb_ocb_nof_rings_set;
    data_index = dnx_data_spb_ocb_define_nof_banks_per_ring;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_spb_ocb_nof_banks_per_ring_set;
    data_index = dnx_data_spb_ocb_define_nof_logical_banks;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_spb_ocb_nof_logical_banks_set;
    data_index = dnx_data_spb_ocb_define_buffer_ptr_nof_bits;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_spb_ocb_buffer_ptr_nof_bits_set;
    data_index = dnx_data_spb_ocb_define_sram_in_power_down;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_spb_ocb_sram_in_power_down_set;

    
    data_index = dnx_data_spb_ocb_blocks_in_ring;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_spb_ocb_blocks_in_ring_set;
    data_index = dnx_data_spb_ocb_dbg_disable_enable;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_spb_ocb_dbg_disable_enable_set;
    data_index = dnx_data_spb_ocb_is_power_optimization_supported;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_spb_ocb_is_power_optimization_supported_set;

    
    data_index = dnx_data_spb_ocb_table_last_in_chain;
    table = &submodule->tables[data_index];
    table->set = j2x_a0_dnx_data_spb_ocb_last_in_chain_set;
