    ...
    int unit)
{
    ...
    table->keys[0].size = 257;
    table->info_get.key_size[0] = 257;
    ...
    if (3 < table->keys[0].size)
    {
        ...
        data->reg = BRDC_HBC_ECC_ERR_1B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (4 < table->keys[0].size)
    {
    ...
    if (76 < table->keys[0].size)
    {
        ...
        data->reg = FRA_ECC_ERR_1B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (77 < table->keys[0].size)
    {
    ...
    if (123 < table->keys[0].size)
    {
        ...
        data->reg = BRDC_HBC_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (124 < table->keys[0].size)
    {
    ...
    if (164 < table->keys[0].size)
    {
        ...
        data->reg = FECPB_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (165 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 165, 0);
        data->reg = FECRL_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (166 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 166, 0);
        data->reg = FECRS_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (167 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 167, 0);
        data->reg = FFLXO_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (168 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 168, 0);
        data->reg = FFOA_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (169 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 169, 0);
        data->reg = FFOB_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (170 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 170, 0);
        data->reg = FGDMP_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (171 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 171, 0);
        data->reg = FGMAP_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (172 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 172, 0);
        data->reg = FICPB_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (173 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 173, 0);
        data->reg = FLFR_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (174 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 174, 0);
        data->reg = FLFT_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (175 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 175, 0);
        data->reg = FLOTN_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (176 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 176, 0);
        data->reg = FMACR_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (177 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 177, 0);
        data->reg = FMACT_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (178 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 178, 0);
        data->reg = FMAC_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (179 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 179, 0);
        data->reg = FMAP_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (180 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 180, 0);
        data->reg = FMXAI_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (181 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 181, 0);
        data->reg = FMXAJ_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (182 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 182, 0);
        data->reg = FMXBI_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (183 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 183, 0);
        data->reg = FMXBJ_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (184 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 184, 0);
        data->reg = FMXBK_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (185 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 185, 0);
        data->reg = FMXC_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (186 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 186, 0);
        data->reg = FMXT_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (187 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 187, 0);
        data->reg = FMX_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (188 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 188, 0);
        data->reg = FOAM_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (189 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 189, 0);
        data->reg = FODUO_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (190 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 190, 0);
        data->reg = FOSW_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (191 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 191, 0);
        data->reg = FPMR_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (192 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 192, 0);
        data->reg = FPMT_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (193 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 193, 0);
        data->reg = FPTPR_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (194 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 194, 0);
        data->reg = FPTPT_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (195 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 195, 0);
        data->reg = FQP_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (196 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 196, 0);
        data->reg = FRA_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (197 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 197, 0);
        data->reg = FRWA_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (198 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 198, 0);
        data->reg = FRWBC_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (199 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 199, 0);
        data->reg = FSAR_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (200 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 200, 0);
        data->reg = HBC_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (201 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 201, 0);
        data->reg = ILE_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (202 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 202, 0);
        data->reg = ILU_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (203 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 203, 0);
        data->reg = IPPA_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (204 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 204, 0);
        data->reg = IPPB_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (205 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 205, 0);
        data->reg = IPPC_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (206 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 206, 0);
        data->reg = IPPD_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (207 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 207, 0);
        data->reg = IPPE_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (208 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 208, 0);
        data->reg = IPPF_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (209 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 209, 0);
        data->reg = IPS_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (210 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 210, 0);
        data->reg = IPT_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (211 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 211, 0);
        data->reg = IQM_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (212 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 212, 0);
        data->reg = IRE_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (213 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 213, 0);
        data->reg = ITPPD_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (214 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 214, 0);
        data->reg = ITPP_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (215 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 215, 0);
        data->reg = KAPS_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (216 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 216, 0);
        data->reg = MACT_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (217 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 217, 0);
        data->reg = MCP_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (218 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 218, 0);
        data->reg = MDB_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (219 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 219, 0);
        data->reg = MRPS_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (220 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 220, 0);
        data->reg = MTM_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (221 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 221, 0);
        data->reg = OAMP_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (222 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 222, 0);
        data->reg = OCBM_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (223 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 223, 0);
        data->reg = OCB_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (224 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 224, 0);
        data->reg = OFR_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (225 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 225, 0);
        data->reg = OFT_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (226 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 226, 0);
        data->reg = OLP_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (227 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 227, 0);
        data->reg = PDM_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (228 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 228, 0);
        data->reg = PEM_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (229 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 229, 0);
        data->reg = PQP_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (230 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 230, 0);
        data->reg = RQP_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (231 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 231, 0);
        data->reg = RTP_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (232 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 232, 0);
        data->reg = SCH_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (233 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 233, 0);
        data->reg = SIF_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (234 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 234, 0);
        data->reg = SPB_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (235 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 235, 0);
        data->reg = SQM_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (236 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 236, 0);
        data->reg = TCAM_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (237 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 237, 0);
        data->reg = TDU_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (238 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 238, 0);
        data->reg = TSN_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (239 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 239, 0);
        data->reg = WB_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (240 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 240, 0);
        data->reg = ERPP_PAR_ERR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (241 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 241, 0);
        data->reg = ETPPA_PAR_ERR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (242 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 242, 0);
        data->reg = ETPPB_PAR_ERR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (243 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 243, 0);
        data->reg = ETPPC_PAR_ERR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (244 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 244, 0);
        data->reg = IPPA_PAR_ERR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (245 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 245, 0);
        data->reg = IPPB_PAR_ERR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (246 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 246, 0);
        data->reg = IPPC_PAR_ERR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (247 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 247, 0);
        data->reg = IPPD_PAR_ERR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (248 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 248, 0);
        data->reg = IPPE_PAR_ERR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (249 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 249, 0);
        data->reg = IPPF_PAR_ERR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (250 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 250, 0);
        data->reg = IRE_PAR_ERR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (251 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 251, 0);
        data->reg = MDB_PAR_ERR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (252 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 252, 0);
        data->reg = OFR_PAR_ERR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (253 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 253, 0);
        data->reg = OFT_PAR_ERR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (254 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 254, 0);
        data->reg = RQP_PAR_ERR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (255 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 255, 0);
        data->reg = SCH_PAR_ERR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (256 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 256, 0);
