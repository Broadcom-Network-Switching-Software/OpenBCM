...
static shr_error_e
j2x_a0_dnx_data_field_ace_hw_invalid_action_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
...
static shr_error_e
j2x_a0_dnx_data_field_init_j1_same_port_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
...
static shr_error_e
j2x_a0_dnx_data_field_tests_parsing_start_offset_exists_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_field_ace_hw_invalid_action_id_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_field_init_j1_same_port_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_field_tests_parsing_start_offset_exists_set;
