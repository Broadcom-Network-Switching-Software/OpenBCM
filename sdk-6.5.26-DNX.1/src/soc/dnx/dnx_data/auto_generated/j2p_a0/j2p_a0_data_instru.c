...
static shr_error_e
j2p_a0_dnx_data_instru_ipt_estimated_encap_size_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_instru;
...
static shr_error_e
j2p_a0_dnx_data_instru_ipt_telemetry_queue_occ_check_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_instru;
...
static shr_error_e
j2p_a0_dnx_data_instru_ipt_telemetry_queue_occ_max_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_instru;
...
static shr_error_e
j2p_a0_dnx_data_instru_ifa_ifa2_is_supported_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_instru;
...
static shr_error_e
j2p_a0_dnx_data_instru_hbh_pt_Ingress_1588_ToD_LSB_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_instru;
...
static shr_error_e
j2p_a0_dnx_data_instru_eventor_is_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_instru;
...
static shr_error_e
j2p_a0_dnx_data_instru_eventor_is_periodic_events_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_instru;
...
static shr_error_e
j2p_a0_dnx_data_instru_eventor_is_rx_en_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_instru;
...
static shr_error_e
j2p_a0_dnx_data_instru_synced_triggers_synced_trigger_version_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_instru;
...
static shr_error_e
j2p_a0_dnx_data_instru_synced_counters_period_adjusted_to_ns_through_time_ratio_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_instru;
...
static shr_error_e
j2p_a0_dnx_data_instru_synced_counters_counters_info_set(
    int unit)
{
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_instru_ipt_telemetry_queue_occ_check_set;
    data_index = dnx_data_instru_ipt_define_telemetry_queue_occ_max;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_instru_ipt_telemetry_queue_occ_max_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_instru_ipt_estimated_encap_size_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_instru_ifa_ifa2_is_supported_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_instru_hbh_pt_Ingress_1588_ToD_LSB_size_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_instru_eventor_is_rx_en_set;

    
    data_index = dnx_data_instru_eventor_is_supported;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_instru_eventor_is_supported_set;
    data_index = dnx_data_instru_eventor_is_periodic_events_supported;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_instru_eventor_is_periodic_events_supported_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_instru_synced_triggers_synced_trigger_version_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_instru_synced_counters_period_adjusted_to_ns_through_time_ratio_set;
    ...
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_instru_synced_counters_counters_info_set;
