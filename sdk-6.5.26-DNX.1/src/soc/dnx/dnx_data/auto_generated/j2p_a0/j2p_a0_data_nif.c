...
static shr_error_e
j2p_a0_dnx_data_nif_phys_txpi_supported_in_pm8x50_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
...
static shr_error_e
j2p_a0_dnx_data_nif_phys_max_phys_in_core_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
...
static shr_error_e
j2p_a0_dnx_data_nif_phys_vco_div_set(
    int unit)
{
    ...
    {
        data = (dnx_data_nif_phys_vco_div_t *) dnxc_data_mgmt_table_data_get(unit, table, 12, 0);
        data->vco_div = 20;
    }
    if (13 < table->keys[0].size)
    {
        data = (dnx_data_nif_phys_vco_div_t *) dnxc_data_mgmt_table_data_get(unit, table, 13, 0);
        data->vco_div = 20;
    }
    if (14 < table->keys[0].size)
    {
        data = (dnx_data_nif_phys_vco_div_t *) dnxc_data_mgmt_table_data_get(unit, table, 14, 0);
        data->vco_div = 20;
    }
    if (15 < table->keys[0].size)
    {
        data = (dnx_data_nif_phys_vco_div_t *) dnxc_data_mgmt_table_data_get(unit, table, 15, 0);
        data->vco_div = 20;
    }
    if (16 < table->keys[0].size)
    {
        data = (dnx_data_nif_phys_vco_div_t *) dnxc_data_mgmt_table_data_get(unit, table, 16, 0);
        data->vco_div = 20;
    }
    if (17 < table->keys[0].size)
    {
        data = (dnx_data_nif_phys_vco_div_t *) dnxc_data_mgmt_table_data_get(unit, table, 17, 0);
        data->vco_div = 20;
    }
...
static shr_error_e
j2p_a0_dnx_data_nif_phys_nof_phys_per_core_set(
    int unit)
{
    int core_index_index;
...
static shr_error_e
j2p_a0_dnx_data_nif_ilkn_legacy_lane_format_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
...
static shr_error_e
j2p_a0_dnx_data_nif_ilkn_is_10p3G_speed_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
...
static shr_error_e
j2p_a0_dnx_data_nif_ilkn_is_12p5G_speed_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
...
static shr_error_e
j2p_a0_dnx_data_nif_ilkn_port_0_status_intr_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    ...
    define->default_data = J2P_INT_ILE_ILKN_RX_PORT_0_STATUS_CHANGE_INT;

    
    define->data = J2P_INT_ILE_ILKN_RX_PORT_0_STATUS_CHANGE_INT;
...
static shr_error_e
j2p_a0_dnx_data_nif_ilkn_port_1_status_intr_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    ...
    define->default_data = J2P_INT_ILE_ILKN_RX_PORT_1_STATUS_CHANGE_INT;

    
    define->data = J2P_INT_ILE_ILKN_RX_PORT_1_STATUS_CHANGE_INT;
...
static shr_error_e
j2p_a0_dnx_data_nif_ilkn_connectivity_options_set(
    int unit)
{
    int ilkn_id_index;
    int connectivity_mode_index;
    dnx_data_nif_ilkn_connectivity_options_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_ilkn;
    int table_index = dnx_data_nif_ilkn_table_connectivity_options;
    SHR_FUNC_INIT_VARS(unit);
    ...
    table->keys[0].size = dnx_data_nif.ilkn.ilkn_if_nof_get(unit);
    table->info_get.key_size[0] = dnx_data_nif.ilkn.ilkn_if_nof_get(unit);
    table->keys[1].size = DNX_ALGO_PORT_ILKN_CONNECTIVITY_MODE_COUNT;
    table->info_get.key_size[1] = DNX_ALGO_PORT_ILKN_CONNECTIVITY_MODE_COUNT;
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_nif_ilkn_connectivity_options_t, (1 * (table->keys[0].size) * (table->keys[1].size) + 1  ), "data of dnx_data_nif_ilkn_table_connectivity_options");

    
    default_data = (dnx_data_nif_ilkn_connectivity_options_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    default_data->first_phy = -1;
    default_data->last_phy = -1;
    
    for (ilkn_id_index = 0; ilkn_id_index < table->keys[0].size; ilkn_id_index++)
    {
        for (connectivity_mode_index = 0; connectivity_mode_index < table->keys[1].size; connectivity_mode_index++)
        {
            data = (dnx_data_nif_ilkn_connectivity_options_t *) dnxc_data_mgmt_table_data_get(unit, table, ilkn_id_index, connectivity_mode_index);
            sal_memcpy(data, default_data, table->size_of_values);
        }
    }
    
    if (0 < table->keys[0].size && DNX_ALGO_PORT_ILKN_CONNECTIVITY_MODE_UNDETERMINED < table->keys[1].size)
    {
        data = (dnx_data_nif_ilkn_connectivity_options_t *) dnxc_data_mgmt_table_data_get(unit, table, 0, DNX_ALGO_PORT_ILKN_CONNECTIVITY_MODE_UNDETERMINED);
        data->first_phy = 0;
        data->last_phy = 5;
    }
    if (0 < table->keys[0].size && DNX_ALGO_PORT_ILKN_CONNECTIVITY_MODE_8_LANES_PER_INTERFACE < table->keys[1].size)
    {
        data = (dnx_data_nif_ilkn_connectivity_options_t *) dnxc_data_mgmt_table_data_get(unit, table, 0, DNX_ALGO_PORT_ILKN_CONNECTIVITY_MODE_8_LANES_PER_INTERFACE);
        data->first_phy = 0;
        data->last_phy = 7;
    }
    if (1 < table->keys[0].size && DNX_ALGO_PORT_ILKN_CONNECTIVITY_MODE_6_LANES_PER_INTERFACE < table->keys[1].size)
    {
        data = (dnx_data_nif_ilkn_connectivity_options_t *) dnxc_data_mgmt_table_data_get(unit, table, 1, DNX_ALGO_PORT_ILKN_CONNECTIVITY_MODE_6_LANES_PER_INTERFACE);
        data->first_phy = 6;
        data->last_phy = 11;
    }
    if (1 < table->keys[0].size && DNX_ALGO_PORT_ILKN_CONNECTIVITY_MODE_8_LANES_PER_INTERFACE < table->keys[1].size)
    {
        data = (dnx_data_nif_ilkn_connectivity_options_t *) dnxc_data_mgmt_table_data_get(unit, table, 1, DNX_ALGO_PORT_ILKN_CONNECTIVITY_MODE_8_LANES_PER_INTERFACE);
        data->first_phy = 8;
        data->last_phy = 15;
    }
    if (2 < table->keys[0].size && DNX_ALGO_PORT_ILKN_CONNECTIVITY_MODE_UNDETERMINED < table->keys[1].size)
    {
        data = (dnx_data_nif_ilkn_connectivity_options_t *) dnxc_data_mgmt_table_data_get(unit, table, 2, DNX_ALGO_PORT_ILKN_CONNECTIVITY_MODE_UNDETERMINED);
        data->first_phy = 96;
        data->last_phy = 101;
    }
    if (2 < table->keys[0].size && DNX_ALGO_PORT_ILKN_CONNECTIVITY_MODE_8_LANES_PER_INTERFACE < table->keys[1].size)
    {
        data = (dnx_data_nif_ilkn_connectivity_options_t *) dnxc_data_mgmt_table_data_get(unit, table, 2, DNX_ALGO_PORT_ILKN_CONNECTIVITY_MODE_8_LANES_PER_INTERFACE);
        data->first_phy = 96;
        data->last_phy = 103;
    }
    if (3 < table->keys[0].size && DNX_ALGO_PORT_ILKN_CONNECTIVITY_MODE_6_LANES_PER_INTERFACE < table->keys[1].size)
    {
        data = (dnx_data_nif_ilkn_connectivity_options_t *) dnxc_data_mgmt_table_data_get(unit, table, 3, DNX_ALGO_PORT_ILKN_CONNECTIVITY_MODE_6_LANES_PER_INTERFACE);
        data->first_phy = 102;
        data->last_phy = 107;
    }
    if (3 < table->keys[0].size && DNX_ALGO_PORT_ILKN_CONNECTIVITY_MODE_8_LANES_PER_INTERFACE < table->keys[1].size)
    {
        data = (dnx_data_nif_ilkn_connectivity_options_t *) dnxc_data_mgmt_table_data_get(unit, table, 3, DNX_ALGO_PORT_ILKN_CONNECTIVITY_MODE_8_LANES_PER_INTERFACE);
        data->first_phy = 104;
        data->last_phy = 111;
    }
...
static shr_error_e
j2p_a0_dnx_data_nif_eth_pm8x50_clk_repeater_disable_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
...
static shr_error_e
j2p_a0_dnx_data_nif_eth_start_tx_threshold_table_set(
    int unit)
{
    int idx_index;
    ...
    int unit)
{
    ...
    default_data->tvco_pll_index = 0x0;
...
static shr_error_e
j2p_a0_dnx_data_nif_eth_ethu_per_core_set(
    int unit)
{
    int ethu_index_index;
    ...
    if (12 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_ethu_per_core_t *) dnxc_data_mgmt_table_data_get(unit, table, 12, 0);
        data->core_id = 1;
    }
    if (13 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_ethu_per_core_t *) dnxc_data_mgmt_table_data_get(unit, table, 13, 0);
        data->core_id = 1;
    }
    if (14 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_ethu_per_core_t *) dnxc_data_mgmt_table_data_get(unit, table, 14, 0);
        data->core_id = 1;
    }
    if (15 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_ethu_per_core_t *) dnxc_data_mgmt_table_data_get(unit, table, 15, 0);
        data->core_id = 1;
    }
    if (16 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_ethu_per_core_t *) dnxc_data_mgmt_table_data_get(unit, table, 16, 0);
        data->core_id = 1;
    }
    if (17 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_ethu_per_core_t *) dnxc_data_mgmt_table_data_get(unit, table, 17, 0);
        data->core_id = 1;
    }
...
static shr_error_e
j2p_a0_dnx_data_nif_eth_nif_cores_ethus_set(
    int unit)
{
    int core_id_index;
...
static shr_error_e
j2p_a0_dnx_data_nif_prd_is_mask_parser_tdm_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_nif_phys_max_phys_in_core_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_nif_phys_txpi_supported_in_pm8x50_set;
    ...
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_nif_phys_vco_div_set;
    data_index = dnx_data_nif_phys_table_nof_phys_per_core;
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_nif_phys_nof_phys_per_core_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_nif_ilkn_port_0_status_intr_id_set;
    data_index = dnx_data_nif_ilkn_define_port_1_status_intr_id;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_nif_ilkn_port_1_status_intr_id_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_nif_ilkn_legacy_lane_format_set;
    data_index = dnx_data_nif_ilkn_is_10p3G_speed_supported;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_nif_ilkn_is_10p3G_speed_supported_set;
    data_index = dnx_data_nif_ilkn_is_12p5G_speed_supported;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_nif_ilkn_is_12p5G_speed_supported_set;
    data_index = dnx_data_nif_ilkn_is_25G_speed_supported;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_nif_ilkn_is_25G_speed_supported_set;
    ...
    data_index = dnx_data_nif_ilkn_table_connectivity_options;
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_nif_ilkn_connectivity_options_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_nif_eth_pm8x50_clk_repeater_disable_set;

    
    data_index = dnx_data_nif_eth_table_start_tx_threshold_table;
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_nif_eth_start_tx_threshold_table_set;
    ...
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_nif_eth_ethu_per_core_set;
    data_index = dnx_data_nif_eth_table_nif_cores_ethus;
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_nif_eth_nif_cores_ethus_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_nif_prd_is_mask_parser_tdm_supported_set;
