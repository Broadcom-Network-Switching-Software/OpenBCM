...
static shr_error_e
j2p_a0_dnx_data_field_base_epmf_dir_ext_first_key_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    ...
    int unit)
{
    ...
    if (DNX_FIELD_STAGE_IPMF2 < table->keys[0].size && DBAL_ENUM_FVAL_FIELD_IO_DIRECT_1 < table->keys[1].size)
    {
        ...
        data->key_select[4] = DBAL_ENUM_FVAL_FIELD_PMF_A_FES_KEY_SELECT_STATE_TABLE_DATA_7_0_STATE_TABLE_ADDRESS_12_0_11_B0_DIRECT_1_119_88;
        SHR_RANGE_VERIFY(5, 0, DNX_DATA_MAX_FIELD_EFES_MAX_NOF_KEY_SELECTS_PER_FIELD_IO, _SHR_E_INTERNAL, "out of bound access to array")
        data->num_bits[0] = 24;
        data->num_bits[1] = 56;
        data->num_bits[2] = 64;
    ...
    if (DNX_FIELD_STAGE_EPMF < table->keys[0].size && DBAL_ENUM_FVAL_FIELD_IO_LEXEM < table->keys[1].size)
    {
        ...
        SHR_RANGE_VERIFY(2, 0, DNX_DATA_MAX_FIELD_EFES_MAX_NOF_KEY_SELECTS_PER_FIELD_IO, _SHR_E_INTERNAL, "out of bound access to array")
        data->num_bits[0] = (60+(dnx_data_field.efes.epmf_exem_zero_padding_added_to_field_io_get(unit)));
        data->num_bits[1] = 32;
        SHR_RANGE_VERIFY(2, 0, DNX_DATA_MAX_FIELD_EFES_MAX_NOF_KEY_SELECTS_PER_FIELD_IO, _SHR_E_INTERNAL, "out of bound access to array")
        data->lsb[0] = 0;
        data->lsb[1] = (28+(dnx_data_field.efes.epmf_exem_zero_padding_added_to_field_io_get(unit)));
        SHR_RANGE_VERIFY(2, 0, DNX_DATA_MAX_FIELD_EFES_MAX_NOF_KEY_SELECTS_PER_FIELD_IO, _SHR_E_INTERNAL, "out of bound access to array")
        data->num_bits_not_on_key[0] = (4-(dnx_data_field.efes.epmf_exem_zero_padding_added_to_field_io_get(unit)));
        data->num_bits_not_on_key[1] = 0;
    }
    ...
    if (DNX_FIELD_STAGE_EPMF < table->keys[0].size && DBAL_ENUM_FVAL_FIELD_IO_INTERNAL_TCAM_1 < table->keys[1].size)
    {
        ...
        data->key_select[1] = DBAL_ENUM_FVAL_FIELD_E_PMF_FES_KEY_SELECT_KEY_D_31_0_TCAM_1_PAYLOAD_63_32;
    ...
    int unit)
{
    ...
    if (DBAL_ENUM_FVAL_FIELD_IO_DIRECT_1 < table->keys[0].size)
    {
        ...
        data->key_select[8] = DBAL_ENUM_FVAL_FIELD_PMF_A_FEM_KEY_SELECT_STATE_TABLE_ADDRESS_4_0_11_B0_DIRECT_1_119_104;
        SHR_RANGE_VERIFY(9, 0, DNX_DATA_MAX_FIELD_FEM_MAX_NOF_KEY_SELECTS_PER_FIELD_IO, _SHR_E_INTERNAL, "out of bound access to array")
        data->num_bits[0] = 8;
        data->num_bits[1] = 24;
        data->num_bits[2] = 32;
...
static shr_error_e
j2p_a0_dnx_data_field_qual_l4_ops_pbus_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
...
static shr_error_e
j2p_a0_dnx_data_field_state_table_supported_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
...
static shr_error_e
j2p_a0_dnx_data_field_exem_ipmf1_key_configurable_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
...
static shr_error_e
j2p_a0_dnx_data_field_exem_ipmf1_key_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
...
static shr_error_e
j2p_a0_dnx_data_field_ace_hw_invalid_action_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_ace;
    int define_index = dnx_data_field_ace_define_hw_invalid_action_id;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
j2p_a0_dnx_data_field_init_l4_trap_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
...
static shr_error_e
j2p_a0_dnx_data_field_init_j1_same_port_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
...
static shr_error_e
j2p_a0_dnx_data_field_features_ecmp_tunnel_priority_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
...
static shr_error_e
j2p_a0_dnx_data_field_tests_epmf_debug_rely_on_tcam0_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
...
static shr_error_e
j2p_a0_dnx_data_field_tests_parsing_start_offset_exists_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_field_base_epmf_dir_ext_first_key_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_field_qual_l4_ops_pbus_size_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_field_state_table_supported_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_field_exem_ipmf1_key_configurable_set;
    data_index = dnx_data_field_exem_define_ipmf1_key;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_field_exem_ipmf1_key_set;
    ...
    data_index = dnx_data_field_ace_define_hw_invalid_action_id;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_field_ace_hw_invalid_action_id_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_field_init_l4_trap_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_field_init_j1_same_port_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_field_features_ecmp_tunnel_priority_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_field_tests_epmf_debug_rely_on_tcam0_set;
    data_index = dnx_data_field_tests_define_parsing_start_offset_exists;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_field_tests_parsing_start_offset_exists_set;
