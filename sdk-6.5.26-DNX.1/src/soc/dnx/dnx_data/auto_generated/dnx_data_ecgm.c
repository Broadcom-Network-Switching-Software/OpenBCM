    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_ecgm_general_v1_supported].doc = "";
    ...
    submodule_data->defines[dnx_data_ecgm_general_define_ecgm_is_supported].doc = "";
    ...
    submodule_data->defines[dnx_data_ecgm_general_define_max_fadt_references].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_ecgm_core_resources_define_nof_sp].doc = "";
    ...
    submodule_data->defines[dnx_data_ecgm_core_resources_define_nof_interface_profiles].doc = "";
    ...
    submodule_data->defines[dnx_data_ecgm_core_resources_define_nof_port_profiles].doc = "";
    ...
    submodule_data->defines[dnx_data_ecgm_core_resources_define_total_pds].doc = "";
    ...
    submodule_data->defines[dnx_data_ecgm_core_resources_define_total_pds_nof_bits].doc = "";
    ...
    submodule_data->defines[dnx_data_ecgm_core_resources_define_total_dbs].doc = "";
    ...
    submodule_data->defines[dnx_data_ecgm_core_resources_define_total_dbs_nof_bits].doc = "";
    ...
    submodule_data->defines[dnx_data_ecgm_core_resources_define_reserved_dbs_per_sp_nof_bits].doc = "";
    ...
    submodule_data->defines[dnx_data_ecgm_core_resources_define_max_alpha_value].doc = "";
    ...
    submodule_data->defines[dnx_data_ecgm_core_resources_define_min_alpha_value].doc = "";
    ...
    submodule_data->defines[dnx_data_ecgm_core_resources_define_max_core_bandwidth_Mbps].doc = "";
    ...
    submodule_data->defines[dnx_data_ecgm_core_resources_define_mc_rcy_reserved_interface_th_ids].doc = "";
    ...
    submodule_data->defines[dnx_data_ecgm_core_resources_define_mc_rcy_reserved_port_th_ids].doc = "";
    ...
    submodule_data->defines[dnx_data_ecgm_core_resources_define_nof_tc_dp_admission_profiles].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_ecgm_port_resources_define_max_nof_ports].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_ecgm_queue_resources_no_profile_management].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_ecgm_interface_resources_per_priority_is_not_supported].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_ecgm_delete_fifo_table_thresholds].doc = "";
    ...
    submodule_data->tables[dnx_data_ecgm_delete_fifo_table_thresholds].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_ecgm_delete_fifo_table_thresholds].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_ecgm_delete_fifo_table_thresholds].values[1].doc = "";
    ...
    submodule_data->tables[dnx_data_ecgm_delete_fifo_table_thresholds].values[2].doc = "";
    ...
    submodule_data->tables[dnx_data_ecgm_delete_fifo_table_thresholds].values[3].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_ecgm_info_fc_egr_if_vector_select].doc = "";
    ...
    submodule_data->defines[dnx_data_ecgm_info_define_fc_q_pair_vector_select_nof_bits].doc = "";
    ...
    submodule_data->defines[dnx_data_ecgm_info_define_fc_q_pair_vector_nof_presented].doc = "";
    ...
    submodule_data->defines[dnx_data_ecgm_info_define_fc_egr_if_vector_select_nof_bits].doc = "";
    ...
    submodule_data->defines[dnx_data_ecgm_info_define_fc_egr_if_vector_nof_presented].doc = "";
    ...
    submodule_data->defines[dnx_data_ecgm_info_define_nof_dropped_reasons_rqp].doc = "";
    ...
    submodule_data->defines[dnx_data_ecgm_info_define_nof_dropped_reasons_pqp].doc = "";
    ...
    submodule_data->defines[dnx_data_ecgm_info_define_nof_bits_in_pd_count].doc = "";
    ...
    submodule_data->tables[dnx_data_ecgm_info_table_dropped_reason_rqp].doc = "";
    ...
    submodule_data->tables[dnx_data_ecgm_info_table_dropped_reason_rqp].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_ecgm_info_table_dropped_reason_rqp].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_ecgm_info_table_dropped_reason_pqp].doc = "";
    ...
    submodule_data->tables[dnx_data_ecgm_info_table_dropped_reason_pqp].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_ecgm_info_table_dropped_reason_pqp].values[0].doc = "";
