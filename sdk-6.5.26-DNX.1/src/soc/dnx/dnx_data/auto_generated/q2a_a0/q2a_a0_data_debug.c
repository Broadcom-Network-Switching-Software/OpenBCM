...
static shr_error_e
q2a_a0_dnx_data_debug_feature_esem_result_signals_valid_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_debug;
...
static shr_error_e
q2a_a0_dnx_data_debug_general_lbp_debug_signals_register_based_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_debug;
    ...
    int unit)
{
    ...
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_debug_feature_esem_result_signals_valid_set;
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_debug_general_lbp_debug_signals_register_based_set;
