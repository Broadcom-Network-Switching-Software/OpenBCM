...
static shr_error_e
q2a_a0_dnx_data_l3_fec_bank_nof_physical_rows_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_l3;
...
static shr_error_e
q2a_a0_dnx_data_l3_fec_supported_fec_flags_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_l3;
...
static shr_error_e
q2a_a0_dnx_data_l3_fec_supported_fec_flags2_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_l3;
...
static shr_error_e
q2a_a0_dnx_data_l3_fer_mdb_granularity_ratio_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_l3;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_l3_fec_bank_nof_physical_rows_set;
    data_index = dnx_data_l3_fec_define_supported_fec_flags;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_l3_fec_supported_fec_flags_set;
    data_index = dnx_data_l3_fec_define_supported_fec_flags2;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_l3_fec_supported_fec_flags2_set;
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_l3_fer_mdb_granularity_ratio_set;
