    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_infra_tests_res_mngr_example_define_advanced_algorithm].name = "advanced_algorithm";
    submodule_data->defines[dnx_data_infra_tests_res_mngr_example_define_advanced_algorithm].doc = "";
    
    submodule_data->defines[dnx_data_infra_tests_res_mngr_example_define_advanced_algorithm].flags |= DNXC_DATA_F_NUMERIC;

    submodule_data->defines[dnx_data_infra_tests_res_mngr_example_define_data_per_entry_size].name = "data_per_entry_size";
    submodule_data->defines[dnx_data_infra_tests_res_mngr_example_define_data_per_entry_size].doc = "";
    
    submodule_data->defines[dnx_data_infra_tests_res_mngr_example_define_data_per_entry_size].flags |= DNXC_DATA_F_NUMERIC;
...
uint32
dnx_data_infra_tests_res_mngr_example_advanced_algorithm_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_infra_tests, dnx_data_infra_tests_submodule_res_mngr_example, dnx_data_infra_tests_res_mngr_example_define_advanced_algorithm);
}

uint32
dnx_data_infra_tests_res_mngr_example_data_per_entry_size_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_infra_tests, dnx_data_infra_tests_submodule_res_mngr_example, dnx_data_infra_tests_res_mngr_example_define_data_per_entry_size);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_infra_tests_sw_state_define_htb_hashing].name = "htb_hashing";
    submodule_data->defines[dnx_data_infra_tests_sw_state_define_htb_hashing].doc = "";
    
    submodule_data->defines[dnx_data_infra_tests_sw_state_define_htb_hashing].flags |= DNXC_DATA_F_NUMERIC;
...
uint32
dnx_data_infra_tests_sw_state_htb_hashing_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_infra_tests, dnx_data_infra_tests_submodule_sw_state, dnx_data_infra_tests_sw_state_define_htb_hashing);
}
