    ...
    int unit)
{
...

    {
        ...
        soc_mem_field32_set(unit, IPPA_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_XL_LEARN_INFO_PMF_DATA_PROTECT_CTX_get(unit));
...

    {
        ...
        soc_mem_field32_set(unit, IPPF_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_XL_LEARN_INFO_PMF_DATA_PROTECT_CTX_get(unit));
