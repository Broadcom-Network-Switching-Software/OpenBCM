    ...
    uint32 *field_value_out)
{
    ...
    if (parent_field_type != DBAL_FIELD_TYPE_DEF_EMPTY)
    {
        ...
        rv = dbal_fields_field_type_sub_field_info_get_internal(unit, field_id, parent_field_type, &sub_field_info);
        if (rv)
        {
...
shr_error_e
dbal_fields_field_type_sub_field_info_get_internal(
    int unit,
    dbal_fields_e field_id,
    dbal_field_types_defs_e parent_type,
    dbal_sub_field_info_t ** sub_field_info)
    ...
    dbal_sub_field_info_t ** sub_field_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_fields_subfield_info_get(unit, field_id, parent_field_id, sub_field_info));
    ...
    uint32 *hw_value)
{
    ...
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "Illegal input value for enum field %s. Input value: %d, max value: %d\n",
                     FIELD_TYPE_INFO(field_type)->name, enum_value, FIELD_TYPE_INFO(field_type)->nof_enum_values);
    }
