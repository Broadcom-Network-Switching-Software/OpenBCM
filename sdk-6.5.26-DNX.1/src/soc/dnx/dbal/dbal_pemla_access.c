...
#define DBAL_PEMLA_WRITE_CORE_ID ((entry_handle->core_id == DBAL_CORE_ALL) ? (-1) : entry_handle->core_id)
#define DBAL_PEMLA_READ_CORE_ID  ((entry_handle->core_id == DBAL_CORE_ALL) ? DBAL_CORE_DEFAULT : entry_handle->core_id)
