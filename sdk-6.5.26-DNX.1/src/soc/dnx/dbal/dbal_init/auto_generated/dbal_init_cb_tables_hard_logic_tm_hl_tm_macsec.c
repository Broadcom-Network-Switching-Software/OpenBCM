...
{
    dbal_entry_handle_t *  eh = (dbal_entry_handle_t *) entry_handle;
    uint32 key_value__msw_macsec_id;
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_MSW_MACSEC_ID, key_value__msw_macsec_id);
    *offset = (key_value__msw_macsec_id-1-(key_value__msw_macsec_id/dnx_data_macsec.general.macsec_in_core_nof_get(unit)));
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_MSW_MACSEC_ID, key_value__msw_macsec_id);
    *offset = key_value__msw_macsec_id;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
{
    dbal_entry_handle_t *  eh = (dbal_entry_handle_t *) entry_handle;
    uint32 key_value__macsec_nif_port;
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_MACSEC_NIF_PORT, key_value__macsec_nif_port);
    *offset = key_value__macsec_nif_port;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
