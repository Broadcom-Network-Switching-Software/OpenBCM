...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_BDB_ERRORS_COUNTER, is_valid, maturity_level, "BDB_ERRORS_COUNTER", DBAL_ACCESS_METHOD_SW_STATE, custom_image, is_compatible_with_all_images, &is_skip_table_init));
    ...
    dbal_db_init_sw_state_set_indirect_table_size(unit, table_entry, NULL, 1000);
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_DELETED_BDB_COUNTER, is_valid, maturity_level, "DELETED_BDB_COUNTER", DBAL_ACCESS_METHOD_SW_STATE, custom_image, is_compatible_with_all_images, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
