...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_STAT_PP_IRPP_PROFILE_INFO, is_valid, maturity_level, "STAT_PP_IRPP_PROFILE_INFO", DBAL_ACCESS_METHOD_HARD_LOGIC, custom_image, is_compatible_with_all_images, &is_skip_table_init));
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HL_ACCESS_HW_ENTITY_INVALID, STATISTICS_IFf));
                    DBAL_DB_INIT_ACCESS_PARAMS_GROUP_SET(access_params, DBAL_HW_ENTITY_GROUP_MAP_STATISTIC_OBJECT_TABLE);
                }
            }
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_MEMORY;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HL_ACCESS_HW_ENTITY_INVALID, TYPEf));
                    DBAL_DB_INIT_ACCESS_PARAMS_GROUP_SET(access_params, DBAL_HW_ENTITY_GROUP_MAP_STATISTIC_OBJECT_TABLE);
                }
            }
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_MEMORY;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HL_ACCESS_HW_ENTITY_INVALID, IS_METERf));
                    DBAL_DB_INIT_ACCESS_PARAMS_GROUP_SET(access_params, DBAL_HW_ENTITY_GROUP_MAP_STATISTIC_OBJECT_TABLE);
                }
            }
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_MEMORY;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HL_ACCESS_HW_ENTITY_INVALID, MAPPING_REQUIREDf));
                    DBAL_DB_INIT_ACCESS_PARAMS_GROUP_SET(access_params, DBAL_HW_ENTITY_GROUP_MAP_STATISTIC_OBJECT_TABLE);
                }
            }
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HL_ACCESS_HW_ENTITY_INVALID, STAT_OBJ_PROFILE_ATTR_VECf));
                    DBAL_DB_INIT_ACCESS_PARAMS_GROUP_SET(access_params, DBAL_HW_ENTITY_GROUP_INGRESS_STAT_OBJ_PROFILE_ATTR);
        ...
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_CURRENT_LAYER_STATISTICS_META_DATA_INSTRUCTION_MAPr, CURRENT_LAYER_STATISTICS_META_DATA_INSTRUCTION_MAPf));
        ...
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_LAYER_PLUS_ONE_STATISTICS_META_DATA_INSTRUCTION_MAPr, LAYER_PLUS_ONE_STATISTICS_META_DATA_INSTRUCTION_MAPf));
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_STAT_PP_ETPP_PROFILE_INFO, is_valid, maturity_level, "STAT_PP_ETPP_PROFILE_INFO", DBAL_ACCESS_METHOD_HARD_LOGIC, custom_image, is_compatible_with_all_images, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ETPPB_MAP_STS_TO_INTERFACEr, MAP_STS_TO_INTERFACEf));
        ...
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ETPPB_MAP_STS_TO_TYPEr, MAP_STS_TO_TYPEf));
        ...
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ETPPC_CFG_STAT_OBJ_CMD_TO_IS_METERr, CFG_STAT_OBJ_CMD_TO_IS_METERf));
        ...
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ETPPC_CFG_STAT_OBJ_CMD_TO_METER_IFr, CFG_STAT_OBJ_CMD_TO_METER_IFf));
        ...
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ETPPC_CFG_STAT_OBJ_CMD_TO_METER_QOS_PROFILEr, CFG_STAT_OBJ_CMD_TO_METER_QOS_PROFILEf));
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_STAT_PP_ERPP_PROFILE_INFO, is_valid, maturity_level, "STAT_PP_ERPP_PROFILE_INFO", DBAL_ACCESS_METHOD_HARD_LOGIC, custom_image, is_compatible_with_all_images, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_MEMORY;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ERPP_COUNTER_0_TYPE_TABLEm, COUNTER_0_TYPEf));
                }
            }
            {
                access_params = &cur_table_param->hl_access[map_idx].access[access_counter];
                ...
                access_params->access_type = DBAL_HL_ACCESS_MEMORY;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ERPP_COUNTER_1_TYPE_TABLEm, COUNTER_1_TYPEf));
                }
            }
        }
        cur_table_param->hl_access[map_idx].nof_access = access_counter;
...
shr_error_e
_dbal_init_tables_hard_logic_pp_stat_hl_pp_stat_pp_stat_pp_erpp_counter_profile_values_init(
int unit,
table_db_struct_t * cur_table_param,
dbal_logical_table_t * table_info)
{
    dbal_logical_table_t * table_entry = table_info + DBAL_TABLE_STAT_PP_ERPP_COUNTER_PROFILE_VALUES;
    int is_valid = TRUE;
    uint8 is_skip_table_init = FALSE;
    uint8 is_compatible_with_all_images = TRUE;
    char * custom_image = NULL;
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_STAT_PP_ERPP_COUNTER_PROFILE_VALUES, is_valid, maturity_level, "STAT_PP_ERPP_COUNTER_PROFILE_VALUES", DBAL_ACCESS_METHOD_HARD_LOGIC, custom_image, is_compatible_with_all_images, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
    ...
    table_entry->table_labels[0] = DBAL_LABEL_PP_STATISTICS;
    {
        ...
        {
            dbal_db_field = &table_entry->multi_res_info[result_type_counter].results_info[field_index];
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_mandatory_values(unit, DBAL_FIELD_ERPP_COUNTER_PROFILE_INVALID_VALUE, DBAL_FIELD_TYPE_DEF_UINT, dbal_db_field));
            dbal_db_init_table_field_params_init(&db_field);
            db_field.size = 3;
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_optional_or_default_values(unit, table_entry, dbal_db_field, &db_field, FALSE));
            field_index += dbal_db_field->nof_instances;
        ...
        {
            dbal_db_field = &table_entry->multi_res_info[result_type_counter].results_info[field_index];
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_mandatory_values(unit, DBAL_FIELD_ERPP_COUNTER_PROFILE_SKIP_VALUE, DBAL_FIELD_TYPE_DEF_UINT, dbal_db_field));
            dbal_db_init_table_field_params_init(&db_field);
            db_field.size = 3;
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_optional_or_default_values(unit, table_entry, dbal_db_field, &db_field, FALSE));
            field_index += dbal_db_field->nof_instances;
        ...
        {
            dbal_db_field = &table_entry->multi_res_info[result_type_counter].results_info[field_index];
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_mandatory_values(unit, DBAL_FIELD_ERPP_COUNTER_PTR_NULL_VALUE, DBAL_FIELD_TYPE_DEF_UINT, dbal_db_field));
            dbal_db_init_table_field_params_init(&db_field);
            db_field.size = 20;
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_optional_or_default_values(unit, table_entry, dbal_db_field, &db_field, FALSE));
            field_index += dbal_db_field->nof_instances;
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                dbal_db_init_table_db_struct_hl_access_params_clear(access_params);
                access_counter++;
                access_params->access_field_id = DBAL_FIELD_ERPP_COUNTER_PROFILE_INVALID_VALUE;
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ERPP_COUNTERr, COUNTER_PROFILE_INVALIDf));
                }
            }
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                dbal_db_init_table_db_struct_hl_access_params_clear(access_params);
                access_counter++;
                access_params->access_field_id = DBAL_FIELD_ERPP_COUNTER_PROFILE_SKIP_VALUE;
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ERPP_COUNTERr, COUNTER_PROFILE_SKIPf));
                }
            }
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                dbal_db_init_table_db_struct_hl_access_params_clear(access_params);
                access_counter++;
                access_params->access_field_id = DBAL_FIELD_ERPP_COUNTER_PTR_NULL_VALUE;
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ERPP_COUNTERr, COUNTER_PTR_NULLf));
                }
            }
        }
        cur_table_param->hl_access[map_idx].nof_access = access_counter;
    }
    SHR_IF_ERR_EXIT(dbal_db_init_table_add(unit, cur_table_param, DBAL_TABLE_STAT_PP_ERPP_COUNTER_PROFILE_VALUES, table_info));
exit:
    SHR_FUNC_EXIT;
}

shr_error_e
_dbal_init_tables_hard_logic_pp_stat_hl_pp_stat_pp_stat_pp_erpp_counter_profile_per_outlif_init(
int unit,
table_db_struct_t * cur_table_param,
dbal_logical_table_t * table_info)
{
    dbal_logical_table_t * table_entry = table_info + DBAL_TABLE_STAT_PP_ERPP_COUNTER_PROFILE_PER_OUTLIF;
    int is_valid = TRUE;
    uint8 is_skip_table_init = FALSE;
    uint8 is_compatible_with_all_images = TRUE;
    char * custom_image = NULL;
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_STAT_PP_ERPP_COUNTER_PROFILE_PER_OUTLIF, is_valid, maturity_level, "STAT_PP_ERPP_COUNTER_PROFILE_PER_OUTLIF", DBAL_ACCESS_METHOD_HARD_LOGIC, custom_image, is_compatible_with_all_images, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
    ...
    }
    {
        ...
        {
            dbal_db_field = &table_entry->multi_res_info[result_type_counter].results_info[field_index];
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_mandatory_values(unit, DBAL_FIELD_COUNTER_0_PROFILE, DBAL_FIELD_TYPE_DEF_ERPP_COUNTER_PROFILE, dbal_db_field));
            dbal_db_init_table_field_params_init(&db_field);
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_optional_or_default_values(unit, table_entry, dbal_db_field, &db_field, FALSE));
            field_index += dbal_db_field->nof_instances;
        }
        {
            dbal_db_field = &table_entry->multi_res_info[result_type_counter].results_info[field_index];
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_mandatory_values(unit, DBAL_FIELD_COUNTER_1_PROFILE, DBAL_FIELD_TYPE_DEF_ERPP_COUNTER_PROFILE, dbal_db_field));
            dbal_db_init_table_field_params_init(&db_field);
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_optional_or_default_values(unit, table_entry, dbal_db_field, &db_field, FALSE));
            field_index += dbal_db_field->nof_instances;
        }
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                dbal_db_init_table_db_struct_hl_access_params_clear(access_params);
                access_counter++;
                access_params->access_field_id = DBAL_FIELD_COUNTER_0_PROFILE;
                access_params->access_type = DBAL_HL_ACCESS_MEMORY;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ERPP_OUTLIF_PROFILE_TO_COUNTER_PROFILE_TABLEm, OUTLIF_PROFILE_COUNTER_0_PROFILEf));
                    access_params->entry_offset.formula_cb = stat_pp_erpp_counter_profile_per_outlif_counter_0_profile_entryoffset_0_cb;
                }
            }
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                dbal_db_init_table_db_struct_hl_access_params_clear(access_params);
                access_counter++;
                access_params->access_field_id = DBAL_FIELD_COUNTER_1_PROFILE;
                access_params->access_type = DBAL_HL_ACCESS_MEMORY;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ERPP_OUTLIF_PROFILE_TO_COUNTER_PROFILE_TABLEm, OUTLIF_PROFILE_COUNTER_1_PROFILEf));
                    access_params->entry_offset.formula_cb = stat_pp_erpp_counter_profile_per_outlif_counter_0_profile_entryoffset_0_cb;
                }
            }
        }
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_table_add(unit, cur_table_param, DBAL_TABLE_STAT_PP_ERPP_COUNTER_PROFILE_PER_OUTLIF, table_info));
exit:
    SHR_FUNC_EXIT;
}
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_STAT_PP_IRPP_VTT_STATISTICS_METADATA_VALUE_MAP, is_valid, maturity_level, "STAT_PP_IRPP_VTT_STATISTICS_METADATA_VALUE_MAP", DBAL_ACCESS_METHOD_HARD_LOGIC, custom_image, is_compatible_with_all_images, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HL_ACCESS_HW_ENTITY_INVALID, STAT_META_DATA_MAPf));
                    DBAL_DB_INIT_ACCESS_PARAMS_GROUP_SET(access_params, DBAL_HW_ENTITY_GROUP_INGRESS_STATISTICS_INFO);
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_STAT_PP_IRPP_FWD_STATISTICS_METADATA_VALUE_MAP, is_valid, maturity_level, "STAT_PP_IRPP_FWD_STATISTICS_METADATA_VALUE_MAP", DBAL_ACCESS_METHOD_HARD_LOGIC, custom_image, is_compatible_with_all_images, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_CURRENT_LAYER_STATISTICS_META_DATA_INFORMATION_MAPr, CURRENT_LAYER_STATISTICS_META_DATA_INFORMATION_MAPf));
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_STAT_PP_IRPP_FWD_PLUS_ONE_STATISTICS_METADATA_VALUE_MAP, is_valid, maturity_level, "STAT_PP_IRPP_FWD_PLUS_ONE_STATISTICS_METADATA_VALUE_MAP", DBAL_ACCESS_METHOD_HARD_LOGIC, custom_image, is_compatible_with_all_images, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_LAYER_PLUS_ONE_STATISTICS_META_DATA_INFORMATION_MAPr, LAYER_PLUS_ONE_STATISTICS_META_DATA_INFORMATION_MAPf));
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_STAT_PP_IRPP_FEC_ECMP_STATISTICS_PROFILE_MAP, is_valid, maturity_level, "STAT_PP_IRPP_FEC_ECMP_STATISTICS_PROFILE_MAP", DBAL_ACCESS_METHOD_HARD_LOGIC, custom_image, is_compatible_with_all_images, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPD_STATISTIC_PROFILE_MAPr, SUPER_STATISTIC_PROFILE_MAPf));
        ...
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPD_STATISTIC_PROFILE_MAPr, ECMP_STATISTIC_PROFILE_MAPf));
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_STAT_PP_ETPP_FWD_STATISTICS_METADATA_VALUE_MAP, is_valid, maturity_level, "STAT_PP_ETPP_FWD_STATISTICS_METADATA_VALUE_MAP", DBAL_ACCESS_METHOD_HARD_LOGIC, custom_image, is_compatible_with_all_images, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ETPPC_STATISTICS_FWD_CODE_TO_PROTOCOL_TYPEr, METADATA_CURRENT_PROTOCOL_TYPEf));
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_STAT_PP_ETPP_ENC_STATISTICS_METADATA_VALUE_MAP, is_valid, maturity_level, "STAT_PP_ETPP_ENC_STATISTICS_METADATA_VALUE_MAP", DBAL_ACCESS_METHOD_HARD_LOGIC, custom_image, is_compatible_with_all_images, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HL_ACCESS_HW_ENTITY_INVALID, CFG_STAT_METADATA_CURRENT_PROTOCOL_TYPEf));
                    DBAL_DB_INIT_ACCESS_PARAMS_GROUP_SET(access_params, DBAL_HW_ENTITY_GROUP_CFG_STAT_METADATA_CURRENT_PROTOCOL_TYPE);
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(_dbal_init_tables_hard_logic_pp_stat_hl_pp_stat_pp_stat_pp_erpp_counter_profile_values_init(unit, cur_table_param, table_info));
    SHR_IF_ERR_EXIT(_dbal_init_tables_hard_logic_pp_stat_hl_pp_stat_pp_stat_pp_erpp_counter_profile_per_outlif_init(unit, cur_table_param, table_info));
