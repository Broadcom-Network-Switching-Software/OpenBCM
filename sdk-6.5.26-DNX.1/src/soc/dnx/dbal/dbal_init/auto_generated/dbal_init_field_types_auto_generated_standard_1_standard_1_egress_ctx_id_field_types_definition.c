...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    if (DBAL_IS_J2C_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_REFLECTORS___TWAMP_STATELESS_2ND_PASS].value_from_mapping = 42;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_REFLECTORS___L2_OAM_TERM].value_from_mapping = 43;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___SFLOW_SEQUENCE_RESET].value_from_mapping = 44;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_REFLECTORS___IP_UDP_SWAP].value_from_mapping = 45;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_REFLECTORS___IPV6_UDP_SWAP].value_from_mapping = 46;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_REFLECTORS___UDP_SWAP].value_from_mapping = 47;
            ...
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_SRV6___PSP].value_from_mapping = 52;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_TM___TX_INJECT].value_from_mapping = 54;
            ...
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_SRV6___T_OR_B_INSERT_EXTENDED_PASS].value_from_mapping = 53;
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    DBAL_INIT_FIELD_TYPES_ENUMS_CLEAR(cur_field_type_param);
    {
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_GENERAL___ARP_AC_ETH_FOR_SEC_TOD_TO_RCPU, "GENERAL___ARP_AC_ETH_FOR_SEC_TOD_TO_RCPU");
    ...
    if (DBAL_IS_J2C_A0 || DBAL_IS_Q2A_A0 || DBAL_IS_Q2A_B0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_GENERAL___ARP_AC_ETH_FOR_SEC_TOD_TO_RCPU].value_from_mapping = 22;
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    if (DBAL_IS_J2C_A0 || DBAL_IS_Q2A_A0 || DBAL_IS_Q2A_B0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV4___IPV4_GRE8_GRE12_GENEVE].value_from_mapping = 18;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV6___TUNNEL].value_from_mapping = 19;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV6___TUNNEL_ECN].value_from_mapping = 20;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV6___VXLAN_ONLY].value_from_mapping = 21;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV6___GENEVE_ONLY].value_from_mapping = 22;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV6___GRE_ONLY].value_from_mapping = 23;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV6___GRE_ONLY_WO_TNI].value_from_mapping = 24;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV6___UDP_ONLY].value_from_mapping = 25;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_MPLS___IMPLICIT_NULL].value_from_mapping = 26;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_MPLS___MPLS_1].value_from_mapping = 27;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_MPLS___MPLS_2].value_from_mapping = 28;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_MPLS___MPLS_1PLUS1].value_from_mapping = 29;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_MPLS___MPLS_1PLUS2].value_from_mapping = 30;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_MPLS___MPLS_2PLUS1].value_from_mapping = 31;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_MPLS___MPLS_2PLUS2].value_from_mapping = 32;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___TWO_SEGMENTS].value_from_mapping = 33;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___ONE_SEGMENT].value_from_mapping = 34;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___ZERO_SEGMENTS].value_from_mapping = 35;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___SRH_AND_2_SEGMENTS].value_from_mapping = 36;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___SRH_AND_1_SEGMENT].value_from_mapping = 37;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___SRH_AND_0_SEGMENT].value_from_mapping = 38;
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___T_INSERT_SRH_AND_2_SEGMENTS].value_from_mapping = 39;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___T_INSERT_SRH_AND_1_SEGMENT].value_from_mapping = 40;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___T_INSERT_SRH_AND_0_SEGMENT].value_from_mapping = 41;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___T_INSERT_TWO_SEGMENTS].value_from_mapping = 42;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___T_INSERT_ONE_SEGMENT].value_from_mapping = 43;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___T_INSERT_ZERO_SEGMENTS].value_from_mapping = 44;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___VPN_ENHANCED_SRH_AND_1_SEGMENT].value_from_mapping = 45;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___VPN_ENHANCED_SRH_AND_0_SEGMENT].value_from_mapping = 46;
