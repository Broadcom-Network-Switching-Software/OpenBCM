...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_PEM_PER_PORT_DB, is_valid, maturity_level, "PEM_PER_PORT_DB", DBAL_ACCESS_METHOD_PEMLA, custom_image, is_compatible_with_all_images, &is_skip_table_init));
