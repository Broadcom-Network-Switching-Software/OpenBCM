...
shr_error_e
_dbal_init_field_types_field_types_encoding_destination_encoding_example_init(
int unit,
field_type_db_struct_t * cur_field_type_param,
dbal_field_types_basic_info_t ** field_types_info)
{
    dbal_field_types_basic_info_t * cur_field_types_info = field_types_info[DBAL_FIELD_TYPE_DEF_DESTINATION_ENCODING_EXAMPLE];
    int is_valid = TRUE;
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_field_type_db_struct_clear(unit, cur_field_type_param);
    SHR_IF_ERR_EXIT(dbal_db_init_field_type_general_info_set(unit, cur_field_types_info, "DESTINATION_ENCODING_EXAMPLE", 5, is_valid, FALSE, DBAL_FIELD_PRINT_TYPE_ENUM, 1, FALSE));
    cur_field_type_param->nof_enum_vals = DBAL_ENUM_FVAL_DESTINATION_ENCODING_EXAMPLE_MC_ID_DUMMY + 1;
    DBAL_INIT_FIELD_TYPES_ENUMS_CLEAR(cur_field_type_param);
    {
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_DESTINATION_ENCODING_EXAMPLE_FEC, "FEC");
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_DESTINATION_ENCODING_EXAMPLE_PORT_ID_DUMMY, "PORT_ID_DUMMY");
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_DESTINATION_ENCODING_EXAMPLE_LAG_ID_DUMMY, "LAG_ID_DUMMY");
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_DESTINATION_ENCODING_EXAMPLE_MC_ID_DUMMY, "MC_ID_DUMMY");
    }
    dbal_init_field_type_default_restrict_values(cur_field_type_param);
    {
        dbal_db_enum_info_struct_t * enum_info = cur_field_type_param->enums;
        enum_info[DBAL_ENUM_FVAL_DESTINATION_ENCODING_EXAMPLE_FEC].value_from_mapping = 0;
        enum_info[DBAL_ENUM_FVAL_DESTINATION_ENCODING_EXAMPLE_PORT_ID_DUMMY].value_from_mapping = 29;
        enum_info[DBAL_ENUM_FVAL_DESTINATION_ENCODING_EXAMPLE_LAG_ID_DUMMY].value_from_mapping = 23;
        enum_info[DBAL_ENUM_FVAL_DESTINATION_ENCODING_EXAMPLE_MC_ID_DUMMY].value_from_mapping = 15;
    }
    SHR_IF_ERR_EXIT(dbal_db_init_field_type_add(unit, cur_field_type_param, cur_field_types_info));
exit:
    SHR_FUNC_EXIT;
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    SHR_IF_ERR_EXIT(_dbal_init_field_types_field_types_encoding_destination_encoding_example_init(unit, cur_field_type_param, field_types_info));
exit:
    SHR_FUNC_EXIT;
}
