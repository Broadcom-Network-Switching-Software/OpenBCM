...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_QOS_PROFIILE_SW_INFO, is_valid, maturity_level, "QOS_PROFIILE_SW_INFO", DBAL_ACCESS_METHOD_SW_STATE, custom_image, is_compatible_with_all_images, &is_skip_table_init));
