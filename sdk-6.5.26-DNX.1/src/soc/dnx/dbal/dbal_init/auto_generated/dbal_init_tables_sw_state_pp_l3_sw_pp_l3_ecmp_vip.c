...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_ECMP_VIP_CONFIG_SW, is_valid, maturity_level, "ECMP_VIP_CONFIG_SW", DBAL_ACCESS_METHOD_SW_STATE, custom_image, is_compatible_with_all_images, &is_skip_table_init));
