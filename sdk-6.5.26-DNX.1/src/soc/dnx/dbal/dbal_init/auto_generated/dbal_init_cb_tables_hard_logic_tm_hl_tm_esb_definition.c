...
{
    dbal_entry_handle_t *  eh = (dbal_entry_handle_t *) entry_handle;
    uint32 key_value__egq_eth_nif_if;
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_EGQ_ETH_NIF_IF, key_value__egq_eth_nif_if);
    *offset = key_value__egq_eth_nif_if;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
