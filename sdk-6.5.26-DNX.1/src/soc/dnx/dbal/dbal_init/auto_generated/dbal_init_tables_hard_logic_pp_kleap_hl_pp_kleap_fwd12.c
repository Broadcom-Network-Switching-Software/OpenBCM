...
shr_error_e
_dbal_init_tables_hard_logic_pp_kleap_hl_pp_kleap_fwd12_kleap_fwd12_exem_mux_init(
int unit,
table_db_struct_t * cur_table_param,
dbal_logical_table_t * table_info)
{
    dbal_logical_table_t * table_entry = table_info + DBAL_TABLE_KLEAP_FWD12_EXEM_MUX;
    int is_valid = TRUE;
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_KLEAP_FWD12_EXEM_MUX, is_valid, maturity_level, "KLEAP_FWD12_EXEM_MUX", DBAL_ACCESS_METHOD_HARD_LOGIC, custom_image, is_compatible_with_all_images, &is_skip_table_init));
    ...
    table_entry->table_labels[0] = DBAL_LABEL_L3;
    {
        ...
        DBAL_DB_INIT_TABLE_INTERFACE_RESULT_FIELDS_ALLOC(table_entry, table_entry->multi_res_info[result_type_counter]);
        {
            ...
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_mandatory_values(unit, DBAL_FIELD_LOOKUP_IN_LEXEM, DBAL_FIELD_TYPE_DEF_BOOL, dbal_db_field));
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_counter++;
                access_params->access_field_id = DBAL_FIELD_LOOKUP_IN_LEXEM;
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_EXEM_SELECTORr, EXEM_SELECTORf));
                }
            }
        }
        cur_table_param->hl_access[map_idx].nof_access = access_counter;
    }
    SHR_IF_ERR_EXIT(dbal_db_init_table_add(unit, cur_table_param, DBAL_TABLE_KLEAP_FWD12_EXEM_MUX, table_info));
exit:
    SHR_FUNC_EXIT;
}
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_KLEAP_FWD12_RESOURCES_MAPPING, is_valid, maturity_level, "KLEAP_FWD12_RESOURCES_MAPPING", DBAL_ACCESS_METHOD_HARD_LOGIC, custom_image, is_compatible_with_all_images, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
            ...
            {
                {
                    ...
                    for (field_instance = 0; field_instance < 18; field_instance++)
                    {
                        ...
                        {
                            SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_CONFIGr, KEYS_BUILDER_STAGE_SELECTORSf));
            ...
            {
                {
                    ...
                    for (field_instance = 0; field_instance < 5; field_instance++)
                    {
                        ...
                        access_params->inst_idx = field_instance;
                        {
                            SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_CONFIGr, FFC_GROUP_STAGE_SELECTORf));
                            access_params->data_offset.formula_cb = kleap_fwd12_resources_mapping_kbr_selector_dataoffset_0_cb;
                        }
                    }
                }
            ...
            {
                {
                    ...
                    for (field_instance = 0; field_instance < 2; field_instance++)
                    {
                        ...
                        access_params->inst_idx = field_instance;
                        {
                            SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_CONFIGr, SHARED_PDS_STAGE_SELECTORSf));
                            access_params->data_offset.formula_cb = kleap_fwd12_resources_mapping_kbr_selector_dataoffset_0_cb;
                        }
                    }
                }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_KLEAP_FWD12_FFC_QUAD_IS_ACL, is_valid, maturity_level, "KLEAP_FWD12_FFC_QUAD_IS_ACL", DBAL_ACCESS_METHOD_HARD_LOGIC, custom_image, is_compatible_with_all_images, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_FFC_GROUP_0_QUAD_IS_ACL_CONTEXTm, FFC_GROUP_0_QUAD_IS_ACL_CONTEXTf));
            ...
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_FFC_GROUP_1_QUAD_IS_ACL_CONTEXTm, FFC_GROUP_1_QUAD_IS_ACL_CONTEXTf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
                }
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_FFC_GROUP_2_QUAD_IS_ACL_CONTEXTm, FFC_GROUP_2_QUAD_IS_ACL_CONTEXTf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
            ...
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_FFC_GROUP_3_QUAD_IS_ACL_CONTEXTm, FFC_GROUP_3_QUAD_IS_ACL_CONTEXTf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
            ...
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_FFC_GROUP_4_QUAD_IS_ACL_CONTEXTm, FFC_GROUP_4_QUAD_IS_ACL_CONTEXTf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_KLEAP_FWD12_KBR_INFO, is_valid, maturity_level, "KLEAP_FWD12_KBR_INFO", DBAL_ACCESS_METHOD_HARD_LOGIC, custom_image, is_compatible_with_all_images, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_MEMORY;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_KEY_BUILDER_IS_ACL_CONTEXTm, KEY_BUILDER_IS_ACL_CONTEXTf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
        ...
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_MEMORY;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_KBRm, APP_DBf));
        ...
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_MEMORY;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_KBRm, KBRf));
                    access_params->array_offset.formula_cb = kleap_fwd12_kbr_info_kbr_is_acl_dataoffset_0_cb;
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
                }
            }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_KLEAP_FWD12_FFC_INSTRUCTION, is_valid, maturity_level, "KLEAP_FWD12_FFC_INSTRUCTION", DBAL_ACCESS_METHOD_HARD_LOGIC, custom_image, is_compatible_with_all_images, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                dbal_db_init_table_db_struct_hl_access_params_clear(access_params);
                access_counter++;
                access_params->access_field_id = DBAL_FIELD_FWD12_FFC_INSTRUCTION;
                access_params->access_type = DBAL_HL_ACCESS_MEMORY;
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_FFC_GROUP_0_QUAD_0m, DBAL_HL_ACCESS_HW_FIELD_INVALID));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
            ...
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_FFC_GROUP_1_QUAD_0m, DBAL_HL_ACCESS_HW_FIELD_INVALID));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
            ...
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_FFC_GROUP_2_QUADm, DBAL_HL_ACCESS_HW_FIELD_INVALID));
                    {
            ...
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_FFC_GROUP_3_QUADm, DBAL_HL_ACCESS_HW_FIELD_INVALID));
                    {
                        access_params->array_offset.formula_int = 0;
                    }
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
            ...
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_FFC_GROUP_4_QUADm, DBAL_HL_ACCESS_HW_FIELD_INVALID));
                    {
                        access_params->array_offset.formula_int = 0;
                    }
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_KLEAP_FWD12_PD_INFO, is_valid, maturity_level, "KLEAP_FWD12_PD_INFO", DBAL_ACCESS_METHOD_HARD_LOGIC, custom_image, is_compatible_with_all_images, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_PD_0m, STRENGTH_WIDTH_VECf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
            ...
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_PD_1m, STRENGTH_WIDTH_VECf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
                    access_params->data_offset.formula_cb = kleap_fwd12_pd_info_pd_strength_width_dataoffset_0_cb;
                }
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_PD_2m, STRENGTH_WIDTH_VECf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
                    access_params->data_offset.formula_cb = kleap_fwd12_pd_info_pd_strength_width_dataoffset_0_cb;
                }
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_PD_3m, STRENGTH_WIDTH_VECf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
                    access_params->data_offset.formula_cb = kleap_fwd12_pd_info_pd_strength_width_dataoffset_0_cb;
                }
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_PD_4m, STRENGTH_WIDTH_VECf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
                    access_params->data_offset.formula_cb = kleap_fwd12_pd_info_pd_strength_width_dataoffset_0_cb;
                }
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_PD_5m, STRENGTH_WIDTH_VECf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
                    access_params->data_offset.formula_cb = kleap_fwd12_pd_info_pd_strength_width_dataoffset_0_cb;
                }
            }
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_PD_0m, ORDER_VECf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
            ...
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_PD_1m, ORDER_VECf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
                    access_params->data_offset.formula_cb = kleap_fwd12_pd_info_pd_order_dataoffset_0_cb;
                }
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_PD_2m, ORDER_VECf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
                    access_params->data_offset.formula_cb = kleap_fwd12_pd_info_pd_order_dataoffset_0_cb;
                }
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_PD_3m, ORDER_VECf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
                    access_params->data_offset.formula_cb = kleap_fwd12_pd_info_pd_order_dataoffset_0_cb;
                }
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_PD_4m, ORDER_VECf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
                    access_params->data_offset.formula_cb = kleap_fwd12_pd_info_pd_order_dataoffset_0_cb;
                }
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_PD_5m, ORDER_VECf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
                    access_params->data_offset.formula_cb = kleap_fwd12_pd_info_pd_order_dataoffset_0_cb;
                }
            }
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_PD_0m, CONST_STRENGTH_VECf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
            ...
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_PD_1m, CONST_STRENGTH_VECf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
                    access_params->data_offset.formula_cb = kleap_fwd12_pd_info_pd_const_strength_dataoffset_0_cb;
                }
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_PD_2m, CONST_STRENGTH_VECf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
                    access_params->data_offset.formula_cb = kleap_fwd12_pd_info_pd_const_strength_dataoffset_0_cb;
                }
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_PD_3m, CONST_STRENGTH_VECf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
                    access_params->data_offset.formula_cb = kleap_fwd12_pd_info_pd_const_strength_dataoffset_0_cb;
                }
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_PD_4m, CONST_STRENGTH_VECf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
                    access_params->data_offset.formula_cb = kleap_fwd12_pd_info_pd_const_strength_dataoffset_0_cb;
                }
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_PD_5m, CONST_STRENGTH_VECf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
                    access_params->data_offset.formula_cb = kleap_fwd12_pd_info_pd_const_strength_dataoffset_0_cb;
                }
            }
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_PD_0_CONTEXT_TO_PROFILES_DATAm, PD_0_CONTEXT_TO_PROFILE_DATAf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
            ...
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_PD_1_CONTEXT_TO_PROFILES_DATAm, PD_1_CONTEXT_TO_PROFILE_DATAf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
                    access_params->data_offset.formula_cb = kleap_fwd12_pd_info_pd_profile_dataoffset_0_cb;
                }
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_PD_2_CONTEXT_TO_PROFILES_DATAm, PD_2_CONTEXT_TO_PROFILE_DATAf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
                    access_params->data_offset.formula_cb = kleap_fwd12_pd_info_pd_profile_dataoffset_0_cb;
                }
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_PD_3_CONTEXT_TO_PROFILES_DATAm, PD_3_CONTEXT_TO_PROFILE_DATAf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
                    access_params->data_offset.formula_cb = kleap_fwd12_pd_info_pd_profile_dataoffset_0_cb;
                }
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_PD_4_CONTEXT_TO_PROFILES_DATAm, PD_4_CONTEXT_TO_PROFILE_DATAf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
                    access_params->data_offset.formula_cb = kleap_fwd12_pd_info_pd_profile_dataoffset_0_cb;
                }
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_PD_5_CONTEXT_TO_PROFILES_DATAm, PD_5_CONTEXT_TO_PROFILE_DATAf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
                    access_params->data_offset.formula_cb = kleap_fwd12_pd_info_pd_profile_dataoffset_0_cb;
                }
            }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_KLEAP_FWD12_ALIGNER_MAPPING, is_valid, maturity_level, "KLEAP_FWD12_ALIGNER_MAPPING", DBAL_ACCESS_METHOD_HARD_LOGIC, custom_image, is_compatible_with_all_images, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                dbal_db_init_table_db_struct_hl_access_params_clear(access_params);
                access_counter++;
                access_params->access_field_id = DBAL_FIELD_FWD_KEY_SIZE;
                access_params->access_type = DBAL_HL_ACCESS_MEMORY;
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_ELK_ALIGNER_MAPPING_MEMm, KEY_0_SIZEf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
                }
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_ELK_ALIGNER_MAPPING_MEMm, KEY_1_SIZEf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
                }
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_ELK_ALIGNER_MAPPING_MEMm, KEY_2_SIZEf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
                }
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_ELK_ALIGNER_MAPPING_MEMm, KEY_3_SIZEf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
                }
            }
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                dbal_db_init_table_db_struct_hl_access_params_clear(access_params);
                access_counter++;
                access_params->access_field_id = DBAL_FIELD_ACL_KEY_SIZE;
                access_params->access_type = DBAL_HL_ACCESS_MEMORY;
                SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_condition(unit, &access_params->access_condition[condition_index], DBAL_CONDITION_EQUAL_TO, DBAL_FIELD_KBP_KBR_IDX, 0, (uint32) DBAL_ENUM_FVAL_KBP_KBR_IDX_KEY_0));
                condition_index++;
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_ELK_ACL_ALIGNER_MAPPING_MEMm, KEY_0_SIZEf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
                }
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_ELK_ACL_ALIGNER_MAPPING_MEMm, KEY_1_SIZEf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
                }
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_ELK_ACL_ALIGNER_MAPPING_MEMm, KEY_2_SIZEf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
                }
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_ELK_ACL_ALIGNER_MAPPING_MEMm, KEY_3_SIZEf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
                }
            }
        }
...
shr_error_e
_dbal_init_tables_hard_logic_pp_kleap_hl_pp_kleap_fwd12_kleap_fwd_context_profile_init(
int unit,
table_db_struct_t * cur_table_param,
dbal_logical_table_t * table_info)
{
    dbal_logical_table_t * table_entry = table_info + DBAL_TABLE_KLEAP_FWD_CONTEXT_PROFILE;
    int is_valid = TRUE;
    uint8 is_skip_table_init = FALSE;
    uint8 is_compatible_with_all_images = TRUE;
    char * custom_image = NULL;
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_KLEAP_FWD_CONTEXT_PROFILE, is_valid, maturity_level, "KLEAP_FWD_CONTEXT_PROFILE", DBAL_ACCESS_METHOD_HARD_LOGIC, custom_image, is_compatible_with_all_images, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
    ...
    }
    {
        ...
        {
            dbal_db_field = &table_entry->multi_res_info[result_type_counter].results_info[field_index];
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_mandatory_values(unit, DBAL_FIELD_CURRENT_ACL_CONTEXT_PROFILE, DBAL_FIELD_TYPE_DEF_CONTEXT_PROFILE, dbal_db_field));
            dbal_db_init_table_field_params_init(&db_field);
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_optional_or_default_values(unit, table_entry, dbal_db_field, &db_field, FALSE));
            field_index += dbal_db_field->nof_instances;
        }
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                dbal_db_init_table_db_struct_hl_access_params_clear(access_params);
                access_counter++;
                access_params->access_field_id = DBAL_FIELD_CURRENT_ACL_CONTEXT_PROFILE;
                access_params->access_type = DBAL_HL_ACCESS_MEMORY;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPB_CURRENT_CONTEXT_PROFILE_MAPm, CURRENT_CONTEXT_PROFILEf));
                    access_params->entry_offset.formula_cb = kleap_fwd_context_profile_current_acl_context_profile_entryoffset_0_cb;
                }
            }
        }
        cur_table_param->hl_access[map_idx].nof_access = access_counter;
    }
    SHR_IF_ERR_EXIT(dbal_db_init_table_add(unit, cur_table_param, DBAL_TABLE_KLEAP_FWD_CONTEXT_PROFILE, table_info));
exit:
    SHR_FUNC_EXIT;
}
...
{
    SHR_FUNC_INIT_VARS(unit);
    SHR_IF_ERR_EXIT(_dbal_init_tables_hard_logic_pp_kleap_hl_pp_kleap_fwd12_kleap_fwd12_exem_mux_init(unit, cur_table_param, table_info));
    ...
    SHR_IF_ERR_EXIT(_dbal_init_tables_hard_logic_pp_kleap_hl_pp_kleap_fwd12_kleap_fwd_context_profile_init(unit, cur_table_param, table_info));
exit:
    SHR_FUNC_EXIT;
}
