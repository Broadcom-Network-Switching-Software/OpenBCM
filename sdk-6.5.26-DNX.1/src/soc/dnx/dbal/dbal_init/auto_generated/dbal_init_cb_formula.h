...
shr_error_e
nif_framer_nb_pcs_port_ctrl_tx_reset_arrayoffset_0_cb(
int unit,
void * entry_handle,
dbal_fields_e current_mapped_field_id,
uint32 * offset);
...
shr_error_e
nif_ofr_rx_fifo_status_counter_map_nif_port_id_arrayoffset_0_cb(
int unit,
void * entry_handle,
dbal_fields_e current_mapped_field_id,
uint32 * offset);
...
shr_error_e
nif_oft_tx_fifo_status_counter_map_nif_port_id_dataoffset_0_cb(
int unit,
void * entry_handle,
dbal_fields_e current_mapped_field_id,
uint32 * offset);
