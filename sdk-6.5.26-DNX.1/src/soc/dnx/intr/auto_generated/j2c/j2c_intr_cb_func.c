    ...
    int unit)
{
    ...
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPPD_ILLEGAL_CONSTRUCTED_HEADER_SIZE, 0, 0, j2c_none, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPPD_INVALID_DESTINATION_VALID, 0, 0, j2c_none, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPPD_NIF_PHYSICAL_ERR, 0, 0, j2c_special_handling, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPPD_SEQ_RX_BIGER_SEQ_EXP_AND_SMALLER_SEQ_TX, 0, 0, j2c_special_handling,
                              NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPPD_SEQ_RX_SMALLER_SEQ_EXP_OR_BIGGER_EQ_SEQ_TX, 0, 0, j2c_special_handling,
                              NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPPD_FLP_FIFO_FULL, 0, 0, j2c_soft_reset, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPPD_FLP_LOOKUP_TIMEOUT, 0, 0, j2c_soft_reset, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPPD_NIF_RX_FIFO_OVF, 0, 0, j2c_soft_reset, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPPD_CPU_LOOKUP_REPLY_OVF, 0, 0, j2c_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPPD_BAD_CHANNEL_NUM, 0, 0, j2c_special_handling, NULL,
                              "check if SER on memories, either Jericho/OP2, or link. If so, action");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPPD_CPU_INFO_REPLY_OVF, 0, 0, j2c_soft_reset, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPPD_BAD_LKP_TYPE, 0, 0, j2c_reprogram_resource, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPPD_NIF_TX_FIFO_FULL, 0, 0, j2c_soft_reset, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPPD_RX_BROKEN_RECORD, 0, 0, j2c_special_handling, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPPD_CPU_INFO_REPLY_VALID, 0, 0, j2c_special_handling, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPPD_CPU_INFO_REPLY_ERR, 0, 0, j2c_special_handling, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPPD_CPU_LOOKUP_REPLY_VALID, 0, 0, j2c_special_handling, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPPD_CPU_LOOKUP_REPLY_ERR, 0, 0, j2c_special_handling, NULL,
                              "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, J2C_INT_DDP_ERROR_PACKET_OVERSIZE, 0, 0, j2c_none, j2c_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_DDP_ERROR_DRAM_BUNDLE_OVERSIZE, 0, 0, j2c_soft_reset, j2c_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_DDP_ERROR_SRAM_16B_CNT_OVRF, 0, 0, j2c_none, j2c_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_DDP_ERROR_OMAC_CNT_OVRF, 0, 0, j2c_none, j2c_none, "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, J2C_INT_DDP_EXT_MEM_ERR_PKUP_CPYDAT_ECC_1B_ERR_INT, 0, 0, j2c_none, j2c_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_DDP_EXT_MEM_ERR_PKUP_CPYDAT_ECC_2B_ERR_INT, 0, 0, j2c_soft_reset, j2c_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_DDP_EXT_MEM_ERR_PKUP_CPYDAT_CRC_ERR_INT, 0, 0, j2c_soft_reset, j2c_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_DDP_EXT_MEM_ERR_PKUP_PACKET_CRC_ERR_INT, 0, 0, j2c_none, j2c_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_DDP_EXT_MEM_ERR_BTC_TDU_ECC_1B_ERR_INT, 0, 0, j2c_none, j2c_none,
    ...
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_ECC_ECC_2B_ERR_INT, 0, 0, j2c_intr_ecc_2b_handler,
                              j2c_intr_ecc_2b_recurr, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_FIFO_ERROR_RRF_OVERFLOW_0, 0, 0, j2c_special_handling, j2c_none,
                              "Fix rrf size in rrf_cfg");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_FIFO_ERROR_RRF_OVERFLOW_1, 0, 0, j2c_special_handling, j2c_none,
                              "Fix rrf size in rrf_cfg");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_FIFO_ERROR_RRF_OVERFLOW_2, 0, 0, j2c_special_handling, j2c_none,
                              "Fix rrf size in rrf_cfg");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_FIFO_ERROR_RRF_UNDERFLOW_0, 0, 0, j2c_soft_reset, j2c_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_FIFO_ERROR_RRF_UNDERFLOW_1, 0, 0, j2c_soft_reset, j2c_none,
    ...
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_FIFO_ERROR_RRF_UNDERFLOW_2, 0, 0, j2c_soft_reset, j2c_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_FIFO_ERROR_RRF_MISCONFIG_0, 0, 0, j2c_special_handling, j2c_none,
                              "fix rrf size in rrf_cfg");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_FIFO_ERROR_RRF_MISCONFIG_1, 0, 0, j2c_special_handling, j2c_none,
                              "fix rrf size in rrf_cfg");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_FIFO_ERROR_RRF_MISCONFIG_2, 0, 0, j2c_special_handling, j2c_none,
                              "fix rrf size in rrf_cfg");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_FIFO_ERROR_RRF_OVERSIZE, 0, 0, j2c_special_handling, j2c_none,
    ...
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_FIFO_ERROR_RDF_SRAM_UNDERFLOW_2, 0, 0, j2c_soft_reset, j2c_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_FIFO_ERROR_RDF_SRAM_OVERSIZE, 0, 0, j2c_special_handling, j2c_none,
                              "Fix rdf size in rdf_cfg");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_FIFO_ERROR_DQCF_OVERFLOW, 0, 0, j2c_soft_reset, j2c_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_FIFO_ERROR_DQCF_UNDERFLOW, 0, 0, j2c_soft_reset, j2c_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_FIFO_ERROR_DQCF_OVERSIZE, 0, 0, j2c_special_handling, j2c_none,
    ...
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_FIFO_ERROR_PBF_UNDERFLOW, 0, 0, j2c_soft_reset, j2c_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_FIFO_ERROR_PBF_MISCONFIG, 0, 0, j2c_special_handling, j2c_none,
                              "fix pbf size");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_FIFO_ERROR_PBF_OVERSIZE, 0, 0, j2c_special_handling, j2c_none,
                              "Configuration error in Pdq_Cfg. Make sure size of each queue is correct");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_FIFO_ERROR_S_2D_DQCF_OVERFLOW, 0, 0, j2c_soft_reset, j2c_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_FIFO_ERROR_S_2D_DQCF_UNDERFLOW, 0, 0, j2c_soft_reset, j2c_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_FIFO_ERROR_S_2D_DQCF_OVERSIZE, 0, 0, j2c_special_handling, j2c_none,
                              "Fix Dqcf size in pdq_cfg");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_FIFO_ERROR_S_2D_D_BLF_OVERFLOW, 0, 0, j2c_soft_reset, j2c_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_FIFO_ERROR_S_2D_D_BLF_UNDERFLOW, 0, 0, j2c_soft_reset, j2c_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_FIFO_ERROR_S_2D_D_BLF_MISCONFIG, 0, 0, j2c_special_handling, j2c_none,
                              "fix dblf fifo size in pdq_cfg");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_FIFO_ERROR_S_2D_PBF_OVERFLOW, 0, 0, j2c_soft_reset, j2c_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_FIFO_ERROR_S_2D_PBF_UNDERFLOW, 0, 0, j2c_soft_reset, j2c_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_FIFO_ERROR_S_2D_PBF_MISCONFIG, 0, 0, j2c_special_handling, j2c_none,
                              "fix pbf size in pdq_cfg");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_FIFO_ERROR_S_2D_PBF_OVERSIZE, 0, 0, j2c_special_handling, j2c_none,
                              "Configuration error in Pdq_Cf. Make sure size of each queue is correct");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_FIFO_COMP_CNT_UNDERFLOW, 0, 0, j2c_soft_reset, j2c_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_FIFO_COMP_CNT_OVERFLOW, 0, 0, j2c_soft_reset, j2c_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_FIFO_SCS_UNDERFLOW, 0, 0, j2c_soft_reset, j2c_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_ITE_ERR_FTMH_PKT_SIZE_IS_NOT_STAMPPED, 0, 0, j2c_special_handling,
                              j2c_none,
                              "Configuration problem in ITPP is casuing packet size not to be stamped. Check and correct the ITPP configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_ITE_ERR_FTMH_IS_NOT_STAMPPED, 0, 0, j2c_special_handling, j2c_none,
                              "Configuration problem in ITPP is casuing unstamped FTMH. Check and correct the ITPP configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_ITE_ERR_BYTES_TO_ADD_ABOVE_MAX, 0, 0, j2c_special_handling, j2c_none,
                              "Configuration problem in ITPP is casuing wrong editing command to be sent to ITE. Check and correct the ITPP configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_ITE_ERR_BYTES_TO_REMOVE_ABOVE_PSIZE, 0, 0, j2c_special_handling,
                              j2c_none,
                              "Configuration problem in ITPP is casuing wrong editing command to be sent to ITE. Check and correct the ITPP configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_ITE_ERR_FTMH_PSIZE_MISMATCH, 0, 0, j2c_special_handling, j2c_none,
                              "Configuration problem in ITPP is casuing wrong packet size to be stamped in FTMH. Check and correct the ITPP configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_ITE_ERR_PSIZE_MISMATCH, 0, 0, j2c_special_handling, j2c_none,
                              "Configuration problem in ITPP is casuing wrong packet size to be stamped in FTMH. Check and correct the ITPP configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_ITE_ERR_EXPECTED_ITPP_DELTA_MISMATCH, 0, 0, j2c_special_handling,
                              j2c_none,
                              "Configuration problem in ITPP is casuing wrong editing which conflicts with the CGM calcualtion of the packet size after editing. Check and correct the ITPP configuration");
    dnxc_intr_add_handler_ext(unit, J2C_INT_IPT_ITE_ERR_NEGATIVE_DELTA, 0, 0, j2c_special_handling, j2c_none,
                              "Configuration problem in ITPP is casuing wrong editing command to be sent to ITE. Check and correct the ITPP configuration");
