    ...
    uint8 is_comparison)
{
    ...
    sal_snprintf(comparison_perm_excluded[20], sizeof(comparison_perm_excluded[20]),
                 "lif_mngr_db[%d]->egress_local_lif[5]", unit);
    sal_snprintf(comparison_perm_excluded[21], sizeof(comparison_perm_excluded[21]),
                 "local_outlif_info[%d]->outlif_bank_info[5].in_use", unit);
    sal_snprintf(comparison_perm_excluded[22], sizeof(comparison_perm_excluded[22]),
                 "local_outlif_info[%d]->outlif_bank_info[5].used_logical_phase", unit);
