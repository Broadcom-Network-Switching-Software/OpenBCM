...
dnx_algo_mib_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_algo_mib[idx].doc = "Mib Data Base";
    ...
    layout_array_dnx_algo_mib[idx].doc = "MIB counter bitmap Data Base";
    layout_array_dnx_algo_mib[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_algo_mib[idx].doc = "MIB counter interval Data Base";
    layout_array_dnx_algo_mib[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
