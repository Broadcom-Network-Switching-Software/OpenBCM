...
dnx_iqs_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_iqs[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_iqs[idx].size_of = sizeof(dnx_iqs_db_t);
    layout_array_dnx_iqs[idx].parent  = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_iqs[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_IQS_DB__FIRST);
    layout_array_dnx_iqs[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_IQS_DB__LAST)-1;
    ...
    layout_array_dnx_iqs[idx].array_indexes[0].num_elements = dnx_data_iqs.credit.nof_profiles_get(unit);
    ...
    layout_array_dnx_iqs[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_IQS_DB__CREDIT_REQUEST_PROFILE__FIRST);
    layout_array_dnx_iqs[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_IQS_DB__CREDIT_REQUEST_PROFILE__LAST)-1;
    ...
    layout_array_dnx_iqs[idx].parent  = 0;
    layout_array_dnx_iqs[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_IQS_DB__CREDIT_WATCHDOG__FIRST);
    layout_array_dnx_iqs[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_IQS_DB__CREDIT_WATCHDOG__LAST)-1;
    ...
    layout_array_dnx_iqs[idx].parent  = 0;
    layout_array_dnx_iqs[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_IQS_DB__DELETE_CREDIT_REQUEST_PROFILE__FIRST);
    layout_array_dnx_iqs[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_IQS_DB__DELETE_CREDIT_REQUEST_PROFILE__LAST)-1;
