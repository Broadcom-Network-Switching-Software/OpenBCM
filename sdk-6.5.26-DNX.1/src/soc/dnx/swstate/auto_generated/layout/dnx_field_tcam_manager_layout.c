...
dnx_field_tcam_manager_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_field_tcam_manager[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_field_tcam_manager[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_TCAM_MANAGER_SW__LAST)-1;
    ...
    layout_array_dnx_field_tcam_manager[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_TCAM_MANAGER_SW__TCAM_HANDLERS__LAST)-1;
