...
tdm_init_layout_structure(int unit)
{
    ...
    layout_array_tdm[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_tdm[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_TDM_FTMH_INFO__LAST)-1;
