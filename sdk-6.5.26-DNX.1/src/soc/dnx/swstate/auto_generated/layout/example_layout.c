...
example_init_layout_structure(int unit)
{
    ...
    layout_array_example[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_example[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_EXAMPLE__LAST)-1;
    ...
    layout_array_example[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_EXAMPLE__DEFAULT_VALUE_TREE__LAST)-1;
    ...
    idx = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_EXAMPLE__HTB_RH);
    layout_array_example[idx].name = "example__htb_rh";
    layout_array_example[idx].type = "sw_state_htb_t";
    layout_array_example[idx].doc = "Hash Table RH example.";
    layout_array_example[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_example[idx].size_of = sizeof(sw_state_htb_t);
    layout_array_example[idx].parent  = 0;
    layout_array_example[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_example[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_example[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_EXPANDED_INTERFACE | DNXC_SW_STATE_LAYOUT_LABEL_ALLOC_EXCEPTION ;
    ...
    layout_array_example[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_EXAMPLE__LEAF_STRUCT__LAST)-1;
    ...
    layout_array_example[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_EXAMPLE__PACKED__LAST)-1;
    ...
    layout_array_example[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_EXAMPLE__PARAMS_FLAGS__LAST)-1;
    ...
    layout_array_example[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_EXAMPLE__MY_UNION__LAST)-1;
    ...
    layout_array_example[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_EXAMPLE__ALLOC_CHILD_CHECK__LAST)-1;
    ...
    layout_array_example[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_EXAMPLE__LARGE_DS_EXAMPLES__LAST)-1;
    ...
    layout_array_example[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_EXAMPLE__DEFAULT_VALUE_TREE__ARRAY_DNXDATA__LAST)-1;
    layout_array_example[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_GENERATE_FREE;
    ...
    layout_array_example[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_EXAMPLE__DEFAULT_VALUE_TREE__DEFAULT_VALUE_L1__LAST)-1;
    ...
    layout_array_example[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_EXAMPLE__DEFAULT_VALUE_TREE__ARRAY_DNXDATA__ARRAY_DYNAMIC__LAST)-1;
    ...
    layout_array_example[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_EXAMPLE__DEFAULT_VALUE_TREE__ARRAY_DNXDATA__DEFAULT_VALUE_L2__LAST)-1;
    ...
    layout_array_example[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_EXAMPLE__DEFAULT_VALUE_TREE__ARRAY_DNXDATA__ARRAY_DYNAMIC__ARRAY_STATIC_STATIC__LAST)-1;
    ...
    layout_array_example[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_EXAMPLE__DEFAULT_VALUE_TREE__ARRAY_DNXDATA__ARRAY_DYNAMIC__DEFAULT_VALUE_L3__LAST)-1;
    ...
    layout_array_example[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_EXAMPLE__DEFAULT_VALUE_TREE__ARRAY_DNXDATA__ARRAY_DYNAMIC__ARRAY_DYNAMIC_DYNAMIC__LAST)-1;
    ...
    layout_array_example[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_example[idx].size_of = sizeof(uint32);
    layout_array_example[idx].parent  = 69;
    layout_array_example[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_example[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_example[idx].array_indexes[0].num_elements = 2;
    layout_array_example[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_example[idx].parent  = 58;
    layout_array_example[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_example[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
