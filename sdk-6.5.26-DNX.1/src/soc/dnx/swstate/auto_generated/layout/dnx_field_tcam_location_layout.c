...
dnx_field_tcam_location_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_field_tcam_location[idx].doc = "Holds all information needed for the TCAM Location Manager";
    ...
    layout_array_dnx_field_tcam_location[idx].doc = "This linked list enlists the currently added priorites, along with the range of each priority's entries in TCAM.";
    layout_array_dnx_field_tcam_location[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_field_tcam_location[idx].doc = "Information for each tcam handler relevant to TCAM Location Manager";
    layout_array_dnx_field_tcam_location[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_field_tcam_location[idx].doc = "Array that saves for each TCAM location the priority of the entry at the given location";
    ...
    layout_array_dnx_field_tcam_location[idx].doc = "Occupation bitmap per half entry that represents all the TCAM banks";
    layout_array_dnx_field_tcam_location[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_field_tcam_location[idx].type = "sw_state_occ_bm_t*";
    layout_array_dnx_field_tcam_location[idx].doc = "Occupation bitmap for this handler's entries";
    layout_array_dnx_field_tcam_location[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_tcam_location[idx].size_of = sizeof(sw_state_occ_bm_t*);
    layout_array_dnx_field_tcam_location[idx].array_indexes[0].num_elements = dnx_data_device.general.nof_cores_get(unit);
    layout_array_dnx_field_tcam_location[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    ...
    layout_array_dnx_field_tcam_location[idx].type = "uint32*";
    layout_array_dnx_field_tcam_location[idx].doc = "handler's first iterator in priority list";
    layout_array_dnx_field_tcam_location[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_tcam_location[idx].size_of = sizeof(uint32*);
    layout_array_dnx_field_tcam_location[idx].array_indexes[0].num_elements = dnx_data_device.general.nof_cores_get(unit);
    layout_array_dnx_field_tcam_location[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    ...
    layout_array_dnx_field_tcam_location[idx].type = "uint32*";
    layout_array_dnx_field_tcam_location[idx].doc = "handler's last iterator in priority list";
    layout_array_dnx_field_tcam_location[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_tcam_location[idx].size_of = sizeof(uint32*);
    layout_array_dnx_field_tcam_location[idx].array_indexes[0].num_elements = dnx_data_device.general.nof_cores_get(unit);
    layout_array_dnx_field_tcam_location[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
