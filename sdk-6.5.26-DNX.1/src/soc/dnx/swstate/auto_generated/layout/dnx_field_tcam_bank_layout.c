...
dnx_field_tcam_bank_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_field_tcam_bank[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_field_tcam_bank[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_TCAM_BANK_SW__FIRST);
    layout_array_dnx_field_tcam_bank[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_TCAM_BANK_SW__LAST)-1;
    ...
    layout_array_dnx_field_tcam_bank[idx].array_indexes[0].num_elements = dnx_data_field.tcam.nof_banks_get(unit);
    ...
    layout_array_dnx_field_tcam_bank[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_TCAM_BANK_SW__TCAM_BANKS__FIRST);
    layout_array_dnx_field_tcam_bank[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_TCAM_BANK_SW__TCAM_BANKS__LAST)-1;
    ...
    layout_array_dnx_field_tcam_bank[idx].array_indexes[0].num_elements = dnx_data_device.general.nof_cores_get(unit);
    layout_array_dnx_field_tcam_bank[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    ...
    layout_array_dnx_field_tcam_bank[idx].array_indexes[0].num_elements = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_tcam_bank[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC;
    layout_array_dnx_field_tcam_bank[idx].array_indexes[1].num_elements = DNXC_SW_STATE_LAYOUT_INVALID;
