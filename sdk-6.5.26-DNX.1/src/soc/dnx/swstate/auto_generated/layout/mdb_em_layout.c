...
mdb_em_init_layout_structure(int unit)
{
    ...
    layout_array_mdb_em[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_mdb_em[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_MDB_EM_DB__LAST)-1;
    ...
    layout_array_mdb_em[idx].array_indexes[1].num_elements = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb_em[idx].array_indexes[1].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC;
    ...
    layout_array_mdb_em[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_MDB_EM_DB__VMV_INFO__LAST)-1;
    ...
    layout_array_mdb_em[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_MDB_EM_DB__VMV_INFO__ENCODING_MAP__LAST)-1;
