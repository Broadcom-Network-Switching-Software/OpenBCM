...
mdb_init_layout_structure(int unit)
{
    ...
    layout_array_mdb[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_MDB_DB_INFOS__LAST)-1;
    ...
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_MDB_DB_INFOS__EM_KEY_FORMAT__LAST)-1;
    ...
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_MDB_DB_INFOS__DB__LAST)-1;
    ...
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_MDB_DB_INFOS__MDB_CLUSTER_INFOS__LAST)-1;
    ...
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_MDB_DB_INFOS__EEDB_BANK_TRAFFIC_LOCK__LAST)-1;
    ...
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_MDB_DB_INFOS__FEC_DB_INFO__LAST)-1;
    ...
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_MDB_DB_INFOS__EM_KEY_FORMAT__EM_BANK_INFO__LAST)-1;
    ...
    layout_array_mdb[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].size_of = sizeof(uint8);
    layout_array_mdb[idx].parent  = 16;
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_MDB_DB_INFOS__DB__CLUSTERS_INFO__LAST)-1;
    layout_array_mdb[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
    ...
    layout_array_mdb[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].size_of = sizeof(mdb_macro_types_e);
    layout_array_mdb[idx].parent  = 28;
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_MDB_DB_INFOS__MDB_CLUSTER_INFOS__MACRO_CLUSTER_ASSOC__LAST)-1;
    ...
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_MDB_DB_INFOS__MDB_CLUSTER_INFOS__MACRO_CLUSTER_CACHE__LAST)-1;
    ...
    layout_array_mdb[idx].parent  = 37;
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_mdb[idx].array_indexes[1].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_mdb[idx].parent  = 38;
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_ARRAY_RANGE_FUNCTIONS | DNXC_SW_STATE_LAYOUT_LABEL_ALLOC_EXCEPTION ;
    ...
    layout_array_mdb[idx].array_indexes[0].num_elements = dnx_data_mdb.direct.nof_fec_dbs_get(unit);
    layout_array_mdb[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    layout_array_mdb[idx].parent  = 10;
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
