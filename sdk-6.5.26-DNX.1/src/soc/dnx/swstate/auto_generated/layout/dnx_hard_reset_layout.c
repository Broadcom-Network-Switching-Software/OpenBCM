...
dnx_hard_reset_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_hard_reset[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_hard_reset[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_HARD_RESET_DB__FIRST);
    layout_array_dnx_hard_reset[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_HARD_RESET_DB__LAST)-1;
    ...
    layout_array_dnx_hard_reset[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_HARD_RESET_DB__HARD_RESET_CALLBACK__FIRST);
    layout_array_dnx_hard_reset[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_HARD_RESET_DB__HARD_RESET_CALLBACK__LAST)-1;
