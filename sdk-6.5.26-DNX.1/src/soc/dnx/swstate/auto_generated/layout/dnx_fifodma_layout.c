...
dnx_fifodma_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_fifodma[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_fifodma[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIFODMA_INFO__LAST)-1;
    ...
    layout_array_dnx_fifodma[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIFODMA_INFO__ENTRY__LAST)-1;
