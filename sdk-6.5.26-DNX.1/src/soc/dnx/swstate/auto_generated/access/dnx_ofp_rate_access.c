...
int
dnx_ofp_rate_db_otm_cal_rate_set(int unit, uint32 otm_cal_idx_0, uint32 otm_cal_idx_1, uint64 rate)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dnx_ofp_rate_db_otm_cal_rate_get(int unit, uint32 otm_cal_idx_0, uint32 otm_cal_idx_1, uint64 *rate)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
