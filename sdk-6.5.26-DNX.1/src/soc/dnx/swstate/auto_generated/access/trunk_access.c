...
int
trunk_db_psc_general_info_user_profile_info_range_read(int unit, uint32 nof_elements, user_profile_info_t *dest)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
trunk_db_psc_general_info_user_profile_info_range_write(int unit, uint32 nof_elements, const user_profile_info_t *source)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
