...
kbp_sw_state_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(kbp_sw_state_fwd_caching_enabled_dump(unit, filters));
...
int
kbp_sw_state_fwd_caching_enabled_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "kbp fwd_caching_enabled") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    {
         DNX_SW_STATE_PRINT(unit, "swstate kbp fwd_caching_enabled\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "kbp_sw_state/fwd_caching_enabled.txt",
            "kbp_sw_state[%d]->","((kbp_sw_state_t*)sw_state_roots_array[%d][KBP_MODULE_ID])->","fwd_caching_enabled: ");
...
kbp_sw_state_db_handles_info_dump(int  unit,  int  db_handles_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(kbp_sw_state_db_handles_info_core_id_dump(unit, db_handles_info_idx_0, filters));
    SHR_IF_ERR_EXIT(kbp_sw_state_db_handles_info_caching_enabled_dump(unit, db_handles_info_idx_0, filters));
    ...
    SHR_IF_ERR_EXIT(kbp_sw_state_db_handles_info_large_opt_result_size_dump(unit, db_handles_info_idx_0, filters));
...
int
kbp_sw_state_db_handles_info_core_id_dump(int  unit,  int  db_handles_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = db_handles_info_idx_0, I0 = db_handles_info_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "kbp db_handles_info core_id") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate kbp db_handles_info core_id\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "kbp_sw_state/db_handles_info/core_id.txt",
            "kbp_sw_state[%d]->","((kbp_sw_state_t*)sw_state_roots_array[%d][KBP_MODULE_ID])->","db_handles_info[].core_id: ");
        ...
        if(i0 >= DNX_KBP_NOF_DBS)
        {
            LOG_CLI((BSL_META("kbp_sw_state[]->((kbp_sw_state_t*)sw_state_roots_array[][KBP_MODULE_ID])->db_handles_info[].core_id: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "kbp_sw_state[%d]->","((kbp_sw_state_t*)sw_state_roots_array[%d][KBP_MODULE_ID])->","db_handles_info[%s%d].core_id: ", s0, i0);
            ...
            dnx_sw_state_print_uint8(
                unit,
                &((kbp_sw_state_t*)sw_state_roots_array[unit][KBP_MODULE_ID])->db_handles_info[i0].core_id);
...
int
kbp_sw_state_db_handles_info_caching_enabled_dump(int  unit,  int  db_handles_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = db_handles_info_idx_0, I0 = db_handles_info_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "kbp db_handles_info caching_enabled") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate kbp db_handles_info caching_enabled\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "kbp_sw_state/db_handles_info/caching_enabled.txt",
            "kbp_sw_state[%d]->","((kbp_sw_state_t*)sw_state_roots_array[%d][KBP_MODULE_ID])->","db_handles_info[].caching_enabled: ");
        ...
        if(i0 >= DNX_KBP_NOF_DBS)
        {
            LOG_CLI((BSL_META("kbp_sw_state[]->((kbp_sw_state_t*)sw_state_roots_array[][KBP_MODULE_ID])->db_handles_info[].caching_enabled: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "kbp_sw_state[%d]->","((kbp_sw_state_t*)sw_state_roots_array[%d][KBP_MODULE_ID])->","db_handles_info[%s%d].caching_enabled: ", s0, i0);
            ...
            dnx_sw_state_print_int(
                unit,
                &((kbp_sw_state_t*)sw_state_roots_array[unit][KBP_MODULE_ID])->db_handles_info[i0].caching_enabled);
...
int
kbp_sw_state_db_handles_info_large_opt_result_size_dump(int  unit,  int  db_handles_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    DNXC_SW_STATE_FUNC_RETURN;
}
...
const char* kbp_sw_state_layout_str[KBP_SW_STATE_INFO_NOF_ENTRIES] = {
    "KBP_SW_STATE~",
    "KBP_SW_STATE~FWD_CACHING_ENABLED~",
    "KBP_SW_STATE~IS_DEVICE_LOCKED~",
    "KBP_SW_STATE~DB_HANDLES_INFO~",
    "KBP_SW_STATE~DB_HANDLES_INFO~CACHING_BMP~",
    "KBP_SW_STATE~DB_HANDLES_INFO~CORE_ID~",
    "KBP_SW_STATE~DB_HANDLES_INFO~CACHING_ENABLED~",
    ...
    "KBP_SW_STATE~DB_HANDLES_INFO~LARGE_OPT_RESULT_SIZE~",
