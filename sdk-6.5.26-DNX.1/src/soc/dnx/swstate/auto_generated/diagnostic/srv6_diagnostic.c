...
int
srv6_modes_gsid_prefix_is_64b_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "srv6 gsid_prefix_is_64b") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate srv6 gsid_prefix_is_64b\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "srv6_modes/gsid_prefix_is_64b.txt",
            "srv6_modes[%d]->","((srv6_modes_struct*)sw_state_roots_array[%d][SRV6_MODULE_ID])->","gsid_prefix_is_64b: ");
...
int
srv6_modes_usid_prefix_is_48b_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "srv6 usid_prefix_is_48b") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate srv6 usid_prefix_is_48b\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "srv6_modes/usid_prefix_is_48b.txt",
            "srv6_modes[%d]->","((srv6_modes_struct*)sw_state_roots_array[%d][SRV6_MODULE_ID])->","usid_prefix_is_48b: ");
...
const char* srv6_modes_layout_str[SRV6_MODES_INFO_NOF_ENTRIES] = {
    ...
    "SRV6_MODES~GSID_PREFIX_IS_64B~",
    "SRV6_MODES~USID_PREFIX_IS_48B~",
};
#endif 
