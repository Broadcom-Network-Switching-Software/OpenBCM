...
dnx_algo_lane_map_db_lane_map_lane2serdes_rx_id_dump(int  unit,  int  lane_map_idx_0,  int  lane2serdes_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_ALGO_LANE_MAP_DB__LANE_MAP__LANE2SERDES__RX_ID, ((dnx_algo_lane_map_db_t*)sw_state_roots_array[unit][DNX_ALGO_LANE_MAP_MODULE_ID])->lane_map[i0].lane2serdes))
            {
                LOG_CLI((BSL_META("dnx_algo_lane_map_db[]->((dnx_algo_lane_map_db_t*)sw_state_roots_array[][DNX_ALGO_LANE_MAP_MODULE_ID])->lane_map[].lane2serdes[].rx_id: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_ALGO_LANE_MAP_DB__LANE_MAP__LANE2SERDES__RX_ID, ((dnx_algo_lane_map_db_t*)sw_state_roots_array[unit][DNX_ALGO_LANE_MAP_MODULE_ID])->lane_map[i0].lane2serdes) == 0)
            {
                SHR_EXIT();
            }
...
dnx_algo_lane_map_db_lane_map_lane2serdes_tx_id_dump(int  unit,  int  lane_map_idx_0,  int  lane2serdes_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_ALGO_LANE_MAP_DB__LANE_MAP__LANE2SERDES__TX_ID, ((dnx_algo_lane_map_db_t*)sw_state_roots_array[unit][DNX_ALGO_LANE_MAP_MODULE_ID])->lane_map[i0].lane2serdes))
            {
                LOG_CLI((BSL_META("dnx_algo_lane_map_db[]->((dnx_algo_lane_map_db_t*)sw_state_roots_array[][DNX_ALGO_LANE_MAP_MODULE_ID])->lane_map[].lane2serdes[].tx_id: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_ALGO_LANE_MAP_DB__LANE_MAP__LANE2SERDES__TX_ID, ((dnx_algo_lane_map_db_t*)sw_state_roots_array[unit][DNX_ALGO_LANE_MAP_MODULE_ID])->lane_map[i0].lane2serdes) == 0)
            {
                SHR_EXIT();
            }
...
dnx_algo_lane_map_db_lane_map_serdes2lane_rx_id_dump(int  unit,  int  lane_map_idx_0,  int  serdes2lane_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_ALGO_LANE_MAP_DB__LANE_MAP__SERDES2LANE__RX_ID, ((dnx_algo_lane_map_db_t*)sw_state_roots_array[unit][DNX_ALGO_LANE_MAP_MODULE_ID])->lane_map[i0].serdes2lane))
            {
                LOG_CLI((BSL_META("dnx_algo_lane_map_db[]->((dnx_algo_lane_map_db_t*)sw_state_roots_array[][DNX_ALGO_LANE_MAP_MODULE_ID])->lane_map[].serdes2lane[].rx_id: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_ALGO_LANE_MAP_DB__LANE_MAP__SERDES2LANE__RX_ID, ((dnx_algo_lane_map_db_t*)sw_state_roots_array[unit][DNX_ALGO_LANE_MAP_MODULE_ID])->lane_map[i0].serdes2lane) == 0)
            {
                SHR_EXIT();
            }
...
dnx_algo_lane_map_db_lane_map_serdes2lane_tx_id_dump(int  unit,  int  lane_map_idx_0,  int  serdes2lane_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_ALGO_LANE_MAP_DB__LANE_MAP__SERDES2LANE__TX_ID, ((dnx_algo_lane_map_db_t*)sw_state_roots_array[unit][DNX_ALGO_LANE_MAP_MODULE_ID])->lane_map[i0].serdes2lane))
            {
                LOG_CLI((BSL_META("dnx_algo_lane_map_db[]->((dnx_algo_lane_map_db_t*)sw_state_roots_array[][DNX_ALGO_LANE_MAP_MODULE_ID])->lane_map[].serdes2lane[].tx_id: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_ALGO_LANE_MAP_DB__LANE_MAP__SERDES2LANE__TX_ID, ((dnx_algo_lane_map_db_t*)sw_state_roots_array[unit][DNX_ALGO_LANE_MAP_MODULE_ID])->lane_map[i0].serdes2lane) == 0)
            {
                SHR_EXIT();
            }
...
int
dnx_algo_lane_map_db_otn_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_algo_lane_map_db_otn_logical_lanes_dump(unit, filters));
    SHR_IF_ERR_EXIT(dnx_algo_lane_map_db_otn_logical_lane_map_dump(unit, -1, filters));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
int
dnx_algo_lane_map_db_otn_logical_lanes_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_algo_lane_map otn logical_lanes") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_algo_lane_map otn logical_lanes\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_algo_lane_map_db/otn/logical_lanes.txt",
            "dnx_algo_lane_map_db[%d]->","((dnx_algo_lane_map_db_t*)sw_state_roots_array[%d][DNX_ALGO_LANE_MAP_MODULE_ID])->","otn.logical_lanes: ");
...
int
dnx_algo_lane_map_db_otn_logical_lane_map_dump(int  unit,  int  logical_lane_map_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dnx_algo_lane_map_db_otn_logical_lane_map_logical_otn_lane_dump(int  unit,  int  logical_lane_map_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = logical_lane_map_idx_0, I0 = logical_lane_map_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_algo_lane_map otn logical_lane_map logical_otn_lane") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_algo_lane_map otn logical_lane_map logical_otn_lane\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_algo_lane_map_db/otn/logical_lane_map/logical_otn_lane.txt",
            "dnx_algo_lane_map_db[%d]->","((dnx_algo_lane_map_db_t*)sw_state_roots_array[%d][DNX_ALGO_LANE_MAP_MODULE_ID])->","otn.logical_lane_map[].logical_otn_lane: ");
        ...
        if (i0 == -1) {
            ...
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ((dnx_algo_lane_map_db_t*)sw_state_roots_array[unit][DNX_ALGO_LANE_MAP_MODULE_ID])->otn.logical_lane_map
                , sizeof(*((dnx_algo_lane_map_db_t*)sw_state_roots_array[unit][DNX_ALGO_LANE_MAP_MODULE_ID])->otn.logical_lane_map), I0, &s0) ? I0 - 1 : 0;
        }

        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_ALGO_LANE_MAP_DB__OTN__LOGICAL_LANE_MAP__LOGICAL_OTN_LANE, ((dnx_algo_lane_map_db_t*)sw_state_roots_array[unit][DNX_ALGO_LANE_MAP_MODULE_ID])->otn.logical_lane_map))
        {
            LOG_CLI((BSL_META("dnx_algo_lane_map_db[]->((dnx_algo_lane_map_db_t*)sw_state_roots_array[][DNX_ALGO_LANE_MAP_MODULE_ID])->otn.logical_lane_map[].logical_otn_lane: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_ALGO_LANE_MAP_DB__OTN__LOGICAL_LANE_MAP__LOGICAL_OTN_LANE, ((dnx_algo_lane_map_db_t*)sw_state_roots_array[unit][DNX_ALGO_LANE_MAP_MODULE_ID])->otn.logical_lane_map) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "dnx_algo_lane_map_db[%d]->","((dnx_algo_lane_map_db_t*)sw_state_roots_array[%d][DNX_ALGO_LANE_MAP_MODULE_ID])->","otn.logical_lane_map[%s%d].logical_otn_lane: ", s0, i0);
            ...
            dnx_sw_state_print_uint16(
                unit,
                &((dnx_algo_lane_map_db_t*)sw_state_roots_array[unit][DNX_ALGO_LANE_MAP_MODULE_ID])->otn.logical_lane_map[i0].logical_otn_lane);
...
int
dnx_algo_lane_map_db_otn_logical_lane_map_nof_lanes_dump(int  unit,  int  logical_lane_map_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = logical_lane_map_idx_0, I0 = logical_lane_map_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_algo_lane_map otn logical_lane_map nof_lanes") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_algo_lane_map otn logical_lane_map nof_lanes\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_algo_lane_map_db/otn/logical_lane_map/nof_lanes.txt",
            "dnx_algo_lane_map_db[%d]->","((dnx_algo_lane_map_db_t*)sw_state_roots_array[%d][DNX_ALGO_LANE_MAP_MODULE_ID])->","otn.logical_lane_map[].nof_lanes: ");
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_ALGO_LANE_MAP_DB__OTN__LOGICAL_LANE_MAP__NOF_LANES, ((dnx_algo_lane_map_db_t*)sw_state_roots_array[unit][DNX_ALGO_LANE_MAP_MODULE_ID])->otn.logical_lane_map))
        {
            LOG_CLI((BSL_META("dnx_algo_lane_map_db[]->((dnx_algo_lane_map_db_t*)sw_state_roots_array[][DNX_ALGO_LANE_MAP_MODULE_ID])->otn.logical_lane_map[].nof_lanes: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_ALGO_LANE_MAP_DB__OTN__LOGICAL_LANE_MAP__NOF_LANES, ((dnx_algo_lane_map_db_t*)sw_state_roots_array[unit][DNX_ALGO_LANE_MAP_MODULE_ID])->otn.logical_lane_map) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "dnx_algo_lane_map_db[%d]->","((dnx_algo_lane_map_db_t*)sw_state_roots_array[%d][DNX_ALGO_LANE_MAP_MODULE_ID])->","otn.logical_lane_map[%s%d].nof_lanes: ", s0, i0);
            ...
            dnx_sw_state_print_uint16(
                unit,
                &((dnx_algo_lane_map_db_t*)sw_state_roots_array[unit][DNX_ALGO_LANE_MAP_MODULE_ID])->otn.logical_lane_map[i0].nof_lanes);
...
const char* dnx_algo_lane_map_db_layout_str[DNX_ALGO_LANE_MAP_DB_INFO_NOF_ENTRIES] = {
    ...
    "DNX_ALGO_LANE_MAP_DB~OTN~",
    "DNX_ALGO_LANE_MAP_DB~OTN~LOGICAL_LANES~",
    "DNX_ALGO_LANE_MAP_DB~OTN~LOGICAL_LANE_MAP~",
    "DNX_ALGO_LANE_MAP_DB~OTN~LOGICAL_LANE_MAP~LOGICAL_OTN_LANE~",
    "DNX_ALGO_LANE_MAP_DB~OTN~LOGICAL_LANE_MAP~NOF_LANES~",
};
#endif 
