...
dnx_iqs_db_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(dnx_iqs_db_delete_credit_request_profile_dump(unit, filters));
...
dnx_iqs_db_credit_request_profile_valid_dump(int  unit,  int  credit_request_profile_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_IQS_DB__CREDIT_REQUEST_PROFILE__VALID, ((dnx_iqs_db_t*)sw_state_roots_array[unit][DNX_IQS_MODULE_ID])->credit_request_profile))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_IQS_DB__CREDIT_REQUEST_PROFILE__VALID, ((dnx_iqs_db_t*)sw_state_roots_array[unit][DNX_IQS_MODULE_ID])->credit_request_profile) == 0)
        {
            SHR_EXIT();
        }
...
dnx_iqs_db_credit_request_profile_thresholds_dump(int  unit,  int  credit_request_profile_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_IQS_DB__CREDIT_REQUEST_PROFILE__THRESHOLDS, ((dnx_iqs_db_t*)sw_state_roots_array[unit][DNX_IQS_MODULE_ID])->credit_request_profile))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_IQS_DB__CREDIT_REQUEST_PROFILE__THRESHOLDS, ((dnx_iqs_db_t*)sw_state_roots_array[unit][DNX_IQS_MODULE_ID])->credit_request_profile) == 0)
        {
            SHR_EXIT();
        }
...
dnx_iqs_db_credit_watchdog_delete_th_dump(int  unit,  int  delete_th_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_IQS_DB__CREDIT_WATCHDOG__DELETE_TH, ((dnx_iqs_db_t*)sw_state_roots_array[unit][DNX_IQS_MODULE_ID])->credit_watchdog.delete_th))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_IQS_DB__CREDIT_WATCHDOG__DELETE_TH, ((dnx_iqs_db_t*)sw_state_roots_array[unit][DNX_IQS_MODULE_ID])->credit_watchdog.delete_th) == 0)
        {
            SHR_EXIT();
        }
...
int
dnx_iqs_db_delete_credit_request_profile_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_iqs_db_delete_credit_request_profile_valid_dump(unit, filters));
    SHR_IF_ERR_EXIT(dnx_iqs_db_delete_credit_request_profile_id_dump(unit, filters));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
int
dnx_iqs_db_delete_credit_request_profile_valid_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_iqs delete_credit_request_profile valid") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_iqs delete_credit_request_profile valid\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_iqs_db/delete_credit_request_profile/valid.txt",
            "dnx_iqs_db[%d]->","((dnx_iqs_db_t*)sw_state_roots_array[%d][DNX_IQS_MODULE_ID])->","delete_credit_request_profile.valid: ");
...
int
dnx_iqs_db_delete_credit_request_profile_id_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_iqs delete_credit_request_profile id") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_iqs delete_credit_request_profile id\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_iqs_db/delete_credit_request_profile/id.txt",
            "dnx_iqs_db[%d]->","((dnx_iqs_db_t*)sw_state_roots_array[%d][DNX_IQS_MODULE_ID])->","delete_credit_request_profile.id: ");
...
const char* dnx_iqs_db_layout_str[DNX_IQS_DB_INFO_NOF_ENTRIES] = {
    ...
    "DNX_IQS_DB~DELETE_CREDIT_REQUEST_PROFILE~",
    "DNX_IQS_DB~DELETE_CREDIT_REQUEST_PROFILE~VALID~",
    "DNX_IQS_DB~DELETE_CREDIT_REQUEST_PROFILE~ID~",
};
#endif 
