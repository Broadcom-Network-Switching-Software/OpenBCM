    ...
    int unit)
{
...
#ifdef ADAPTER_SERVER_MODE
    {
        SHR_IF_ERR_EXIT(soc_reg32_set(unit, OLP_RESERVED_SPARE_3r, REG_PORT_ANY, 0, 1));
    }
#endif
    ...
    {
        reg_val = 0;
        soc_reg_field_set(unit, ETPPA_ETPP_LATENCY_SETTINGSr, &reg_val, ETPP_FIXED_LATENCY_ENf, 1);
        soc_reg_field_set(unit, ETPPA_ETPP_LATENCY_SETTINGSr, &reg_val, ETPP_FIXED_LATENCYf, 670);
        SHR_IF_ERR_EXIT(WRITE_ETPPA_ETPP_LATENCY_SETTINGSr(unit, _SHR_CORE_ALL, reg_val));
    }
