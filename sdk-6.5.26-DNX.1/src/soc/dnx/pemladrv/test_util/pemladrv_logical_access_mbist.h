...
unsigned int get_mbist_val_by_ndx(
...
shr_error_e dnx_pemladrv_pem_mem_direct_db_virtual_bist(
    int unit);
...
shr_error_e dnx_pemladrv_pem_mem_tcam_db_virtual_bist(
    int unit);
...
shr_error_e dnx_pemladrv_pem_mem_em_db_virtual_bist(
    int unit);

shr_error_e dnx_pemladrv_pem_mem_lpm_db_virtual_bist(
    int unit);

shr_error_e dnx_pemladrv_pem_mem_reg_virtual_bist(
    int unit);

shr_error_e dnx_pemladrv_pem_mem_virtual_bist(
    int unit);
