...
__portmod__dispatch__t__ portmod_pm4x10_driver = {
    ...
    pm4x10_port_synce_clk_ctrl_set,
    pm4x10_port_synce_clk_ctrl_get,
    ...
    pm4x10_port_txpi_rxcdr_clk_get,
    ...
    pm4x10_pm_wb_debug_log,
    pm4x10_port_fec_error_inject_set,
    pm4x10_port_fec_error_inject_get,
#ifdef CPRIMOD_SUPPORT
    ...
    pm4x10_port_pmd_rx_lock_status_get,
