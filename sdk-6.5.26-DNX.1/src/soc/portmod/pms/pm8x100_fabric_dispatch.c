...
__portmod__dispatch__t__ portmod_pm8x100_fabric_driver = {

    NULL, /* portmod_port_speed_ability_local_get */
    pm8x100_fabric_pm_interface_type_is_supported,
    pm8x100_fabric_pm_init,
    pm8x100_fabric_pm_destroy,
    pm8x100_fabric_port_attach,
    NULL, /* portmod_default_bus_update */
    NULL, /* portmod_pm_bypass_set */
    pm8x100_fabric_pm_core_info_get,
    NULL, /* portmod_pm_aggregated_update */
    pm8x100_fabric_pm_phys_get,
    pm8x100_fabric_port_detach,
    NULL, /* portmod_port_callback_unregister */
    NULL, /* portmod_port_replace */
    pm8x100_fabric_port_enable_set,
    pm8x100_fabric_port_enable_get,
    NULL, /* portmod_port_cdr_lock_get */
    pm8x100_fabric_port_electrical_idle_enable_set,
    ...
    pm8x100_fabric_port_encoding_set,
    pm8x100_fabric_port_encoding_get,
    NULL, /* portmod_port_cl72_set */
    NULL, /* portmod_port_cl72_get */
    NULL, /* portmod_port_cl72_status_get */
    pm8x100_fabric_port_loopback_set,
    pm8x100_fabric_port_loopback_get,
    ...
    pm8x100_fabric_port_prbs_config_set,
    pm8x100_fabric_port_prbs_config_get,
    pm8x100_fabric_port_prbs_enable_set,
    pm8x100_fabric_port_prbs_enable_get,
    pm8x100_fabric_port_prbs_status_get,
    ...
    pm8x100_fabric_port_core_access_get,
    pm8x100_fabric_port_phy_lane_access_get,
    pm8x100_fabric_pm_phy_lane_access_get,
    pm8x100_fabric_port_duplex_set,
    pm8x100_fabric_port_duplex_get,
    ...
    pm8x100_fabric_port_mode_set,
    pm8x100_fabric_port_mode_get,
    ...
    pm8x100_fabric_port_lane_map_set,
    pm8x100_fabric_port_lane_map_get,
    pm8x100_fabric_port_polarity_set,
    pm8x100_fabric_port_polarity_get,
    ...
    pm8x100_fabric_pm_vco_reconfig,
    pm8x100_fabric_port_speed_config_set,
    pm8x100_fabric_port_speed_config_get,
    ...
    pm8x100_fabric_pm_speed_config_validate,
    ...
    pm8x100_fabric_port_synce_clk_ctrl_set,
    pm8x100_fabric_port_synce_clk_ctrl_get,
    pm8x100_fabric_port_tx_padding_set,
    pm8x100_fabric_port_tx_padding_get,
    pm8x100_fabric_port_rate_egress_ppt_set,
    pm8x100_fabric_port_rate_egress_ppt_get,
#ifdef CPRIMOD_SUPPORT
