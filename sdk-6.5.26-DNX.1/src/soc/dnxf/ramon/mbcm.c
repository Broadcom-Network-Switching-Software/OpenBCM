...
mbcm_dnxf_functions_t mbcm_ramon_driver = {
    ...
    soc_ramon_cgm_register_field_max_value_get,
    soc_ramon_cgm_register_set,
    soc_ramon_cgm_register_get,
    ...
    soc_ramon_port_valid_block_database_get,
    ...
    soc_ramon_drv_device_reset_init,
    soc_ramon_drv_device_reset_deinit,
    soc_ramon_drv_interrupts_init,
    soc_ramon_drv_interrupts_deinit,
    NULL
};
