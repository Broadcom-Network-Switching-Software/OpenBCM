    ...
    int unit)
{
    ...
    dnxf_data_port.signal_quality.feature_get = dnxf_data_port_signal_quality_feature_get;

    
    dnxf_data_port.signal_quality.max_interval_in_cycles_get = dnxf_data_port_signal_quality_max_interval_in_cycles_get;
    dnxf_data_port.signal_quality.max_degrade_threshold_get = dnxf_data_port_signal_quality_max_degrade_threshold_get;
    dnxf_data_port.signal_quality.min_degrade_threshold_get = dnxf_data_port_signal_quality_min_degrade_threshold_get;
    dnxf_data_port.signal_quality.max_fail_threshold_get = dnxf_data_port_signal_quality_max_fail_threshold_get;
    dnxf_data_port.signal_quality.min_fail_threshold_get = dnxf_data_port_signal_quality_min_fail_threshold_get;
    dnxf_data_port.signal_quality.max_interval_get = dnxf_data_port_signal_quality_max_interval_get;
    dnxf_data_port.signal_quality.min_interval_get = dnxf_data_port_signal_quality_min_interval_get;
