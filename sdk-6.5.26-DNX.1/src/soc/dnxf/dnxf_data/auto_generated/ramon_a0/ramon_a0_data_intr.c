...
static shr_error_e
ramon_a0_dnxf_data_intr_general_ser_event_generate_support_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_intr;
    int submodule_index = dnxf_data_intr_submodule_general;
    int define_index = dnxf_data_intr_general_define_ser_event_generate_support;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_intr_general_ser_reset_cb_en_support_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_intr;
    int submodule_index = dnxf_data_intr_submodule_general;
    int define_index = dnxf_data_intr_general_define_ser_reset_cb_en_support;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_intr_general_skip_clear_on_regress_set(
    int unit)
{
    int offset_index;
    dnxf_data_intr_general_skip_clear_on_regress_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnxf_data_module_intr;
    int submodule_index = dnxf_data_intr_submodule_general;
    int table_index = dnxf_data_intr_general_table_skip_clear_on_regress;
    SHR_FUNC_INIT_VARS(unit);
    ...
    DNXC_DATA_ALLOC(table->data, dnxf_data_intr_general_skip_clear_on_regress_t, (1 * (table->keys[0].size) + 1  ), "data of dnxf_data_intr_general_table_skip_clear_on_regress");

    
    default_data = (dnxf_data_intr_general_skip_clear_on_regress_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    default_data->intr = INVALIDr;
    
    for (offset_index = 0; offset_index < table->keys[0].size; offset_index++)
    {
        data = (dnxf_data_intr_general_skip_clear_on_regress_t *) dnxc_data_mgmt_table_data_get(unit, table, offset_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
...
static shr_error_e
ramon_a0_dnxf_data_intr_general_block_intr_field_mapping_set(
    int unit)
{
    int offset_index;
    dnxf_data_intr_general_block_intr_field_mapping_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnxf_data_module_intr;
    int submodule_index = dnxf_data_intr_submodule_general;
    int table_index = dnxf_data_intr_general_table_block_intr_field_mapping;
    SHR_FUNC_INIT_VARS(unit);
    ...
    DNXC_DATA_ALLOC(table->data, dnxf_data_intr_general_block_intr_field_mapping_t, (1 * (table->keys[0].size) + 1  ), "data of dnxf_data_intr_general_table_block_intr_field_mapping");

    
    default_data = (dnxf_data_intr_general_block_intr_field_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    default_data->intr = INVALIDr;
    
    for (offset_index = 0; offset_index < table->keys[0].size; offset_index++)
    {
        data = (dnxf_data_intr_general_block_intr_field_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, offset_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
...
static shr_error_e
ramon_a0_dnxf_data_intr_general_chip_intr_remap_set(
    int unit)
{
    int offset_index;
    dnxf_data_intr_general_chip_intr_remap_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnxf_data_module_intr;
    int submodule_index = dnxf_data_intr_submodule_general;
    int table_index = dnxf_data_intr_general_table_chip_intr_remap;
    SHR_FUNC_INIT_VARS(unit);
    ...
    DNXC_DATA_ALLOC(table->data, dnxf_data_intr_general_chip_intr_remap_t, (1 * (table->keys[0].size) + 1  ), "data of dnxf_data_intr_general_table_chip_intr_remap");

    
    default_data = (dnxf_data_intr_general_chip_intr_remap_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    default_data->start = 0;
    default_data->end = 0;
    default_data->vector = 0;
    
    for (offset_index = 0; offset_index < table->keys[0].size; offset_index++)
    {
        data = (dnxf_data_intr_general_chip_intr_remap_t *) dnxc_data_mgmt_table_data_get(unit, table, offset_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
...
static shr_error_e
ramon_a0_dnxf_data_intr_general_chip_intr_enable_set(
    int unit)
{
    int offset_index;
    dnxf_data_intr_general_chip_intr_enable_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnxf_data_module_intr;
    int submodule_index = dnxf_data_intr_submodule_general;
    int table_index = dnxf_data_intr_general_table_chip_intr_enable;
    SHR_FUNC_INIT_VARS(unit);
    ...
    DNXC_DATA_ALLOC(table->data, dnxf_data_intr_general_chip_intr_enable_t, (1 * (table->keys[0].size) + 1  ), "data of dnxf_data_intr_general_table_chip_intr_enable");

    
    default_data = (dnxf_data_intr_general_chip_intr_enable_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    default_data->bit = 0;
    
    for (offset_index = 0; offset_index < table->keys[0].size; offset_index++)
    {
        data = (dnxf_data_intr_general_chip_intr_enable_t *) dnxc_data_mgmt_table_data_get(unit, table, offset_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
    ...
    int unit)
{
    ...
    data_index = dnxf_data_intr_general_define_ser_event_generate_support;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_intr_general_ser_event_generate_support_set;
    data_index = dnxf_data_intr_general_define_ser_reset_cb_en_support;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_intr_general_ser_reset_cb_en_support_set;
    ...
    data_index = dnxf_data_intr_general_table_skip_clear_on_regress;
    table = &submodule->tables[data_index];
    table->set = ramon_a0_dnxf_data_intr_general_skip_clear_on_regress_set;
    data_index = dnxf_data_intr_general_table_block_intr_field_mapping;
    table = &submodule->tables[data_index];
    table->set = ramon_a0_dnxf_data_intr_general_block_intr_field_mapping_set;
    data_index = dnxf_data_intr_general_table_chip_intr_remap;
    table = &submodule->tables[data_index];
    table->set = ramon_a0_dnxf_data_intr_general_chip_intr_remap_set;
    data_index = dnxf_data_intr_general_table_chip_intr_enable;
    table = &submodule->tables[data_index];
    table->set = ramon_a0_dnxf_data_intr_general_chip_intr_enable_set;
