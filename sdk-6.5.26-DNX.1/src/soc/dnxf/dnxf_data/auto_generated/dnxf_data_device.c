    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].nof_values = 14;
    ...
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[12].name = "voltage_sel";
    ...
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[12].offset = UTILEX_OFFSETOF(dnxf_data_device_vtmon_vtmon_access_t, voltage_sel);
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[13].name = "voltage_bit";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[13].type = "int";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[13].doc = "";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[13].offset = UTILEX_OFFSETOF(dnxf_data_device_vtmon_vtmon_access_t, voltage_bit);
