    ...
    soc_port_t port)
{
    ...
    SHR_IF_ERR_EXIT(soc_dnxf_drv_link_to_block_mapping(unit, port, &pm_id, &fsrd_lane, SOC_BLK_FSRD));
    ...
    bcm_pbmp_t * fmac_bmp)
{
    ...
    {
        SHR_IF_ERR_EXIT(soc_dnxf_drv_link_to_block_mapping(unit, port, &fmac, &fmac_inner_link, SOC_BLK_FMAC));
