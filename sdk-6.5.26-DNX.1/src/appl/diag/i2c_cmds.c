...
cmd_xpoe(int unit, args_t *a)
{
    ...
    if (sal_strcasecmp(subcmd, "ver") == 0) {
        sal_memset(data, PD63000_NULL_DATA, 15);
...
get_bits(uint8 byte)
{
    static char buf[12];
    int i;
    sal_memset(buf,0x0,12);
    strncat(buf,"0b", (12 - strlen(buf) - 1));
    for(i = 7; i >= 0;i--){
        if( byte & (1 << i)){
            cli_out("bit %d set\n",i);
            strncat(buf,"1", (12 - strlen(buf) - 1));
        }
        else
            strncat(buf,"0", (12 - strlen(buf) - 1));
    }
    return buf;
}
...
soc_i2c_detect_board(void)
{
    ...
    else if (id_detected && ((board_id == 0xCD) || (board_id == 0xCE))) {
        /* Trident3-x1 */
        board_type = G69;
    }

    else if (id_detected && (board_id == 0xD6)) {
        /* Wolfhound3 */
        board_type = G70;
    }
...
_i2c_mux_default_dev_name_get(void)
{
    ...
    if (soc_get_board_id() == G27) {
        ...
        dev_name = I2C_MUX_70;
               ...
               (soc_get_board_id() == G69) || (soc_get_board_id() == G70)) {
        dev_name = I2C_MUX_3;
    } else {
        dev_name = I2C_LPT_0;
    }
...
dac_params[NUM_BOARD_TYPES][MAX_VS_CONFIG_PER_BOARD] = {
    ...
    /* Trident3x1 design: aka G69 */
    {{0,"Core",-1,1,0,0,LTM4676A_1_04V_DACVAL_TD3X1,LTM4676A_0_72V_DACVAL_TD3X1,LTM4676A_0_88V_DACVAL_TD3X1,1},
     {1,"Analog",-1,1,0,0,LTC2974_0_88V_DACVAL_TD3X1,LTC2974_0_72V_DACVAL_TD3X1,LTC2974_0_80V_DACVAL_TD3X1,1},
     {2,"0.8V",-1,1,0,0,LTC2974_0_88V_DACVAL_TD3X1,LTC2974_0_72V_DACVAL_TD3X1,LTC2974_0_80V_DACVAL_TD3X1,1},
     {3,"1.2V",-1,1,0,0,LTC2974_1_32V_DACVAL_TD3X1,LTC2974_1_08V_DACVAL_TD3X1,LTC2974_1_20V_DACVAL_TD3X1,1},
     {4,"1.8V",-1,1,0,0,LTC2974_1_98V_DACVAL_TD3X1,LTC2974_1_62V_DACVAL_TD3X1,LTC2974_1_80V_DACVAL_TD3X1,1},
     {5,"2.5V",-1,1,0,0,LTC2974_2_75V_DACVAL_TD3X1,LTC2974_2_25V_DACVAL_TD3X1,LTC2974_2_50V_DACVAL_TD3X1,1},
     {6,"3.3V_Dut",-1,1,0,0,LTC2974_3_63V_DACVAL_TD3X1,LTC2974_2_97V_DACVAL_TD3X1,LTC2974_3_30V_DACVAL_TD3X1,1},
     {7,"3.3V",-1,1,0,0,LTC2974_3_80V_DACVAL_TD3X1,LTC2974_2_71V_DACVAL_TD3X1,LTC2974_3_30V_DACVAL_TD3X1,1},
     {8,"5.0V",-1,1,0,0,LTC2974_5_50V_DACVAL_TD3X1,LTC2974_4_50V_DACVAL_TD3X1,LTC2974_5_00V_DACVAL_TD3X1,1},
    },
    /* Wolfhound3 design: aka G70 */
    {{0,"Core",-1,1,0,0,LTC7132_1_04V_DACVAL_WH3,LTC7132_0_72V_DACVAL_WH3,LTC7132_0_88V_DACVAL_WH3,1},
     {1,"Analog",-1,1,0,0,LTC2974_0_88V_DACVAL_WH3,LTC2974_0_72V_DACVAL_WH3,LTC2974_0_80V_DACVAL_WH3,1},
     {2,"0.8V",-1,1,0,0,LTC2974_0_97V_DACVAL_WH3,LTC2974_0_79V_DACVAL_WH3,LTC2974_0_88V_DACVAL_WH3,1},
     {3,"1.2V",-1,1,0,0,LTC2974_1_32V_DACVAL_WH3,LTC2974_1_08V_DACVAL_WH3,LTC2974_1_20V_DACVAL_WH3,1},
     {4,"1.8V",-1,1,0,0,LTC2974_1_98V_DACVAL_WH3,LTC2974_1_62V_DACVAL_WH3,LTC2974_1_80V_DACVAL_WH3,1},
     {5,"2.5V",-1,1,0,0,LTC2974_2_75V_DACVAL_WH3,LTC2974_2_25V_DACVAL_WH3,LTC2974_2_50V_DACVAL_WH3,1},
     {6,"3.3V_Dut",-1,1,0,0,LTC2974_3_63V_DACVAL_WH3,LTC2974_2_97V_DACVAL_WH3,LTC2974_3_30V_DACVAL_WH3,1},
     {7,"3.3V",-1,1,0,0,LTC2974_3_80V_DACVAL_WH3,LTC2974_2_71V_DACVAL_WH3,LTC2974_3_30V_DACVAL_WH3,1},
     {8,"5.0V",-1,1,0,0,LTC2974_5_50V_DACVAL_WH3,LTC2974_4_50V_DACVAL_WH3,LTC2974_5_00V_DACVAL_WH3,1},
    },
...
bb_vs_config[NUM_BOARD_TYPES][MAX_VS_CONFIG_PER_BOARD] = {
    ...
    /* Trident3x1 design: aka G69 */
    {{0,"Core", 1 << MUX_4, I2C_LTM4676A_40, I2C_LTM4676A_CH0, I2C_LTM4676A_40, PWR_DAC_IO_SRC },
     {1,"Analog", 1 << MUX_4, I2C_LTC2974_63, I2C_LTC2974_CH0, I2C_LTC2974_63, DAC_UNCALIBRATED },
     {2,"0.8V", 1 << MUX_4, I2C_LTC2974_63, I2C_LTC2974_CH1, I2C_LTC2974_63, DAC_UNCALIBRATED },
     {3,"1.2V", 1 << MUX_4, I2C_LTC2974_63, I2C_LTC2974_CH2, I2C_LTC2974_63, DAC_UNCALIBRATED },
     {4,"1.8V", 1 << MUX_4, I2C_LTC2974_63, I2C_LTC2974_CH3, I2C_LTC2974_63, DAC_UNCALIBRATED },
     {5,"2.5V", 1 << MUX_4, I2C_LTC2974_64, I2C_LTC2974_CH0, I2C_LTC2974_64, DAC_UNCALIBRATED },
     {6,"3.3V_Dut", 1 << MUX_4, I2C_LTC2974_64, I2C_LTC2974_CH1, I2C_LTC2974_64, DAC_UNCALIBRATED },
    ...
    /* Wolfhound3 design: aka G70 */
    {{0,"Core", 1 << MUX_4, I2C_LTC7132_40, I2C_LTC7132_CH0, I2C_LTC7132_40, PWR_DAC_IO_SRC },
     {1,"Analog", 1 << MUX_4, I2C_LTC2974_63, I2C_LTC2974_CH0, I2C_LTC2974_63, DAC_UNCALIBRATED },
     {2,"0.8V", 1 << MUX_4, I2C_LTC2974_63, I2C_LTC2974_CH1, I2C_LTC2974_63, DAC_UNCALIBRATED },
     {3,"1.2V", 1 << MUX_4, I2C_LTC2974_63, I2C_LTC2974_CH2, I2C_LTC2974_63, DAC_UNCALIBRATED },
     {4,"1.8V", 1 << MUX_4, I2C_LTC2974_63, I2C_LTC2974_CH3, I2C_LTC2974_63, DAC_UNCALIBRATED },
...
bb_vs_all[NUM_BOARD_TYPES][MAX_VOLTAGES_PER_BOARD] = {
    ...
    /* Trident3x1 design: aka G69 */
    {{0,"Core*", 1 << MUX_4, I2C_LTM4676A_40, I2C_LTM4676A_CH0, NULL, PWR_DAC_IO_SRC },
     {1,"Analog*", 1 << MUX_4, I2C_LTC2974_63, I2C_LTC2974_CH0, NULL, DAC_UNCALIBRATED },
     {2,"0.8V*", 1 << MUX_4, I2C_LTC2974_63, I2C_LTC2974_CH1, NULL, DAC_UNCALIBRATED },
     {3,"1.2V*", 1 << MUX_4, I2C_LTC2974_63, I2C_LTC2974_CH2, NULL, DAC_UNCALIBRATED },
     {4,"1.8V*", 1 << MUX_4, I2C_LTC2974_63, I2C_LTC2974_CH3, NULL, DAC_UNCALIBRATED },
     {5,"2.5V*", 1 << MUX_4, I2C_LTC2974_64, I2C_LTC2974_CH0, NULL, DAC_UNCALIBRATED },
     {6,"3.3V_Dut*", 1 << MUX_4, I2C_LTC2974_64, I2C_LTC2974_CH1, NULL, DAC_UNCALIBRATED },
    ...
    /* Wolfhound3 design: aka G70 */
    {{0,"Core*", 1 << MUX_4, I2C_LTC7132_40, I2C_LTC7132_CH0, NULL, PWR_DAC_IO_SRC },
     {1,"Analog*", 1 << MUX_4, I2C_LTC2974_63, I2C_LTC2974_CH0, NULL, DAC_UNCALIBRATED },
     {2,"0.8V*", 1 << MUX_4, I2C_LTC2974_63, I2C_LTC2974_CH1, NULL, DAC_UNCALIBRATED },
     {3,"1.2V*", 1 << MUX_4, I2C_LTC2974_63, I2C_LTC2974_CH2, NULL, DAC_UNCALIBRATED },
     {4,"1.8V*", 1 << MUX_4, I2C_LTC2974_63, I2C_LTC2974_CH3, NULL, DAC_UNCALIBRATED },
...
#undef BB_DEBUG
    ...
    if(!sal_strncasecmp(function,"voltage",sal_strlen(function))) {
        ...
        if ((soc_get_board_id() == G50) || (soc_get_board_id() == G51) ||
             ...
             (soc_get_board_id() == G68) || (soc_get_board_id() == G69) ||
             (soc_get_board_id() == G70)) {
            char *dev_name;
            /* Configure the mux */
            for (i = 0; i < bb_vs_all_len[bx]; i++) {
                dev_name = _i2c_mux_default_dev_name_get();
            ...
            if (!source) {
                for (i = 0; i < bb_vs_all_len[bx]; i++) {
                    ...
                    cli_out("VDD_%s = %d.%03d Volts "
                            ...
                            adc_data.nsamples);
#endif
		    /* Invoke I2C_LTC_IOC_SET_RCONFIG for Helix5/HR4/TD3x1/WH3 to setup sense_resistor_data */
		    if ((soc_get_board_id() == G65) || (soc_get_board_id() == G66) ||
                (soc_get_board_id() == G67) || (soc_get_board_id() == G69) ||
                (soc_get_board_id() == G70)) {
            ...
            cli_out("VDD_%s = %d.%03d Volts "
                    ...
                    adc_data.nsamples);
#endif
            /* Invoke I2C_LTC_IOC_SET_RCONFIG for HR4/TD3x1/WH3 to setup sense_resistor_data */
