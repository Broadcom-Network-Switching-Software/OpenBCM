...
CINT_FWRAPPER_CREATE_RP5(const uint32 *,
                         uint32,
                         1,
                         0,
                         ...
                         1,
                         0);
CINT_FWRAPPER_CREATE_RP6(const uint32 *,
                         uint32,
                         1,
                         0,
                         ...
                         0,
                         0);
CINT_FWRAPPER_CREATE_RP7(const uint32 *,
                         uint32,
                         1,
                         0,
...
static cint_function_t __cint_dnxc_functions[] = {
    ...
    CINT_FWRAPPER_NENTRY("dnxc_data_table_size_get", dnxc_data_utils_table_size_get),
