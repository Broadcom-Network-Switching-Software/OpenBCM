...
/* *INDENT-OFF* */
    ...
    {"non_empty",   sh_dnx_tm_queue_non_empty_cmd,      NULL,   sh_dnx_tm_queue_non_empty_options,      &sh_dnx_tm_queue_non_empty_man,  NULL, NULL, SH_CMD_CONDITIONAL, sh_dnx_tm_skip_on_emulation},
