...
sh_sand_cmd_t sh_dnx_swstate_switch_cmds[] = {
    ...
    {"predefined_mpls_special_label_bitmap", NULL, sh_dnx_swstate_switch_predefined_mpls_special_label_bitmap_cmds, NULL, &dnx_swstate_switch_predefined_mpls_special_label_bitmap_man},
...
sh_sand_cmd_t sh_dnx_swstate_switch_predefined_mpls_special_label_bitmap_cmds[] = {
    {"dump", sh_dnx_swstate_switch_predefined_mpls_special_label_bitmap_dump_cmd, NULL, dnx_swstate_switch_predefined_mpls_special_label_bitmap_dump_options, &dnx_swstate_switch_predefined_mpls_special_label_bitmap_dump_man},
    {"size_get", sh_dnx_swstate_switch_predefined_mpls_special_label_bitmap_size_get_cmd, NULL, dnx_swstate_switch_predefined_mpls_special_label_bitmap_size_get_options, &dnx_swstate_switch_predefined_mpls_special_label_bitmap_size_get_man},
    {NULL}
};


sh_sand_man_t dnx_swstate_switch_predefined_mpls_special_label_bitmap_man = {
    cmd_dnx_swstate_switch_predefined_mpls_special_label_bitmap_desc,
    NULL,
    NULL,
    NULL,
};
...
const char cmd_dnx_swstate_switch_predefined_mpls_special_label_bitmap_desc[] = "switch_db predefined_mpls_special_label_bitmap commands";


shr_error_e sh_dnx_swstate_switch_predefined_mpls_special_label_bitmap_dump_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
...
sh_sand_option_t dnx_swstate_switch_predefined_mpls_special_label_bitmap_dump_options[] = {
    {"nocontent",      SAL_FIELD_TYPE_BOOL, "Decision if to perform content dump or to print the access tree.",  "false"},
    {"typefilter",     SAL_FIELD_TYPE_STR,  "Filter for the variable type.",         ""},
    {"namefilter",     SAL_FIELD_TYPE_STR,  "Filter for the variable name.",         ""},
    {NULL}
...
sh_sand_man_t dnx_swstate_switch_predefined_mpls_special_label_bitmap_dump_man = {
    "swstate dump",
    "print the variable value",
    "switch_db predefined_mpls_special_label_bitmap dump []\n",
    "switch_db predefined_mpls_special_label_bitmap dump nocontent=false typefilter="" namefilter="" ",
};


shr_error_e sh_dnx_swstate_switch_predefined_mpls_special_label_bitmap_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    uint32 size = 0;
    ...
    size = dnx_sw_state_info_size_get(switch_db_info[unit], switch_db_layout_str, SWITCH_DB_INFO_NOF_ENTRIES, "SWITCH_DB~PREDEFINED_MPLS_SPECIAL_LABEL_BITMAP~", sizeof(((switch_sw_state_t*)sw_state_roots_array[unit][SWITCH_MODULE_ID])->predefined_mpls_special_label_bitmap));
    dnx_sw_state_size_print(size);
...
sh_sand_option_t dnx_swstate_switch_predefined_mpls_special_label_bitmap_size_get_options[] = {
    {NULL}
};


sh_sand_man_t dnx_swstate_switch_predefined_mpls_special_label_bitmap_size_get_man = {
    "swstate size_get",
    "print the variable size",
    "switch_db predefined_mpls_special_label_bitmap size_get",
    "switch_db predefined_mpls_special_label_bitmap size_get",
};
