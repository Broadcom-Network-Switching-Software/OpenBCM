...
#ifndef __DNX_ALGO_TRUNK_COMMANDLINE_H__
#define __DNX_ALGO_TRUNK_COMMANDLINE_H__
...
extern sh_sand_cmd_t sh_dnx_swstate_algo_trunk_user_profile_manager_cmds[];
extern sh_sand_man_t dnx_swstate_algo_trunk_user_profile_manager_man;
extern const char cmd_dnx_swstate_algo_trunk_user_profile_manager_desc[];
shr_error_e sh_dnx_swstate_algo_trunk_user_profile_manager_dump_cmd(int unit, args_t *args, sh_sand_control_t *sand_control);
extern sh_sand_option_t dnx_swstate_algo_trunk_user_profile_manager_dump_options[];
extern sh_sand_man_t dnx_swstate_algo_trunk_user_profile_manager_dump_man;


shr_error_e sh_dnx_swstate_algo_trunk_user_profile_manager_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control);
extern sh_sand_option_t dnx_swstate_algo_trunk_user_profile_manager_size_get_options[];
extern sh_sand_man_t dnx_swstate_algo_trunk_user_profile_manager_size_get_man;


#endif /* DNX_SW_STATE_DIAGNOSTIC */

#endif /* __DNX_ALGO_TRUNK_COMMANDLINE_H__ */
