...
/**
 * \brief - Dump the OTN lane map info
 */
shr_error_e sh_dnx_nif_otn_lane_map_cmd(
    int unit,
    args_t * args,
    sh_sand_control_t * sand_control);
