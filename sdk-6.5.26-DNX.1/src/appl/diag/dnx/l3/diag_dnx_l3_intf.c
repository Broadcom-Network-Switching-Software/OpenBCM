    ...
    char *action)
{
    ...
    sal_snprintf(buffer, DIAG_DNX_L3_MAC_ADDRESS_PRINTABLE_STRING_SIZE, "%02X:%02X:%02X:%02X:%02X:%02X",
                 intf_info->l3a_mac_addr[0], intf_info->l3a_mac_addr[1], intf_info->l3a_mac_addr[2],
                 intf_info->l3a_mac_addr[3], intf_info->l3a_mac_addr[4], intf_info->l3a_mac_addr[5]);
