...
static int __macro__bcm_plp_base_t_state_mfg_diag(char *chip_name, bcm_plp_access_t phy_info, unsigned int inst,\
                                                  bcm_plp_base_t_diag_ctrl_type_t op_type, bcm_plp_base_t_diag_ctrl_cmd_t  op_cmd, void *arg) {
    return PLP_CALL((chip_name),  __base_t_state_mfg_diag, ((phy_info), (inst), (op_type), (op_cmd), (arg)));
}
