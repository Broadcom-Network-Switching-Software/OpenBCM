    ...
    cint_struct_type_t * parent)
{
    ...
    switch (mnum)
    {
        case 0:
            ...
            break;
        case 1:
            rv = &(s->interrupts_status);
            break;
        case 2:
            rv = &(s->failure_stage_flags);
            break;
        default:
            rv = NULL;
            break;
    ...
    cint_struct_type_t * parent)
{
    ...
    switch (mnum)
    {
        ...
        case 8:
            ...
            break;
        case 9:
            rv = &(s->reachability_bitmap);
            break;
        case 10:
            rv = &(s->base_index);
            break;
        case 11:
            rv = &(s->source_link_number);
            break;
        default:
            rv = NULL;
            break;
...
static cint_constants_t __cint_dnxf_constants[] = {
    ...
    {"SOC_DNXF_SNAKE_TEST_FAILURE_STAGE_CONTROL_CELL_GENERATION",
     SOC_DNXF_SNAKE_TEST_FAILURE_STAGE_CONTROL_CELL_GENERATION},
    {"SOC_DNXF_SNAKE_TEST_FAILURE_STAGE_DATA_CELL_FILTER_WRITE_COMMAND",
     SOC_DNXF_SNAKE_TEST_FAILURE_STAGE_DATA_CELL_FILTER_WRITE_COMMAND},
    {"SOC_DNXF_SNAKE_TEST_FAILURE_STAGE_CONTROL_CELL_FILTER_WRITE_COMMAND",
     SOC_DNXF_SNAKE_TEST_FAILURE_STAGE_CONTROL_CELL_FILTER_WRITE_COMMAND},
