    ...
    lsm_init_info_t * init_info)
{
    ...
    /** When this flag is not present, The rx Thread prints have name prints.
     * This makes the output of the tool to be unclear
     * therefore for such a case, the prints are disabled*/
