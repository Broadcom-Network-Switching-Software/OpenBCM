...
#endif
#if defined (BCM_DNX_SUPPORT)
TEST(132,   "Scheduling scheme",       TS_DNX,        0,                      0,                      test_dnx_sch_scheduling_scheme_test, 1,   0)
TEST(133,   "EGQ test",                TS_DNX,        0,                      0,                      test_dnx_egq_qpair_test,             1,   0)
#endif
...
#endif
#if defined(BCM_DNX_SUPPORT) || defined(BCM_DNXF_SUPPORT)
TEST(190,     "New Access",       TS_DNX | TS_DNXF,     0,      0,      access_test,        1,      0)
