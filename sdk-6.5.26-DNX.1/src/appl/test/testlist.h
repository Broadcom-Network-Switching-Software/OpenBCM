...
extern int access_test(int, args_t *, void *);
#ifdef BCM_ACCESS_SUPPORT
...
/* blast_tx.c*/
extern int blast_tx_init(int unit, args_t *arg, void **p);
extern int blast_tx_test(int unit, args_t *arg, void *p);
extern int blast_tx_done(int unit, void *p);
...
extern soc_error_t tomahawk3_half_chip_mem_bist(int unit);
...
#if defined(BCM_DNX_SUPPORT)
/* scheduling_scheme_test.c */
extern int      test_dnx_sch_scheduling_scheme_test(int, args_t *, void *);
#endif

#if defined(BCM_DNX_SUPPORT)
/* test_dnx_egq.c */
extern int test_dnx_egq_qpair_test(int, args_t *, void *);
#endif
