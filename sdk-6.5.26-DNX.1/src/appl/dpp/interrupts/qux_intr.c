 ...
 */
    ...
    QUX_INT_DRCA_DRAM_CMD_PARITY_ERR,
    QUX_INT_DDP_EXT_MEM_ERR_PKUP_CPYDAT_ECC_1B_ERR_INT,
    QUX_INT_DDP_EXT_MEM_ERR_PKUP_CPYDAT_ECC_2B_ERR_INT,
    QUX_INT_DDP_EXT_MEM_ERR_PKUP_CPYDAT_CRC_ERR_INT,
