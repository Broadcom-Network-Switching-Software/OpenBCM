...
/*
 * Function:
 *     bcm_subport_id_map_entry_t_init
 * Description:
 *     Initialize a subport ID map entry structure
 * Parameters:
 *     subport_entry - pointer to subport ID map entry structure
 * Return: none
 */
void
bcm_subport_id_map_entry_t_init(bcm_subport_id_map_entry_t *subport_entry)
{
    sal_memset(subport_entry, 0, sizeof(bcm_subport_id_map_entry_t));
}
