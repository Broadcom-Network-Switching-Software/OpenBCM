...
void bcm_udf_multi_flow_based_extraction_info_t_init(
    bcm_udf_multi_flow_based_extraction_info_t *udf_multi_flow_based_extraction_info)
{
    if (udf_multi_flow_based_extraction_info != NULL) {
        sal_memset(udf_multi_flow_based_extraction_info, 0,
                sizeof(bcm_udf_multi_flow_based_extraction_info_t));
    }
    return;
}
