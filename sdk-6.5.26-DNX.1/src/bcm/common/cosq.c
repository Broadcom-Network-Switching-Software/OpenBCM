...
/*
 *Function:
 *   bcm_cosq_device_info_t_init
 *Purpose:
 *   Initialize bcm_cosq_device_info_t structure
 *Parameters:
 *   info - Pointer to the struct to be init'ed
 **/
void bcm_cosq_device_info_t_init(
    bcm_cosq_device_info_t *info)
{
    if (info != NULL) {
        sal_memset(info, 0, sizeof(bcm_cosq_device_info_t));
    }
}

/*
 * Function:
 *      bcm_cosq_scheduler_gport_params_t_init
 * Purpose:
 *      Initialize scheduling element parameters structure
 * Parameters:
 *      params - Pointer to the struct to be init'ed
 */
void
bcm_cosq_scheduler_gport_params_t_init(bcm_cosq_scheduler_gport_params_t *params)
{
    if (params != NULL) {
...
/*
 *Function:
 *   bcm_cosq_global_voq_info_t_init
 *Purpose:
 *   Initialize bcm_cosq_global_voq_info_t structure
 *Parameters:
 *   info - Pointer to the struct to be init'ed
 **/
void bcm_cosq_global_voq_info_t_init(
    bcm_cosq_global_voq_info_t *info)
{
    if (info != NULL) {
        sal_memset(info, 0, sizeof(bcm_cosq_global_voq_info_t));
    }
}

/*
 *Function:
 *   bcm_cosq_pfc_monitor_control_t_init
 *Purpose:
 *   Initialize bcm_cosq_pfc_monitor_control_t structure
 *Parameters:
 *   control - Pointer to the struct to be init'ed
 **/
void bcm_cosq_pfc_monitor_control_t_init(
    bcm_cosq_pfc_monitor_control_t *control)
{
    if (control != NULL) {
        sal_memset(control, 0, sizeof(bcm_cosq_pfc_monitor_control_t));
    }
}

/*
 *Function:
 *   bcm_cosq_pfc_monitor_port_control_t_init
 *Purpose:
 *   Initialize bcm_cosq_pfc_monitor_port_control_t structure
 *Parameters:
 *   control - Pointer to the struct to be init'ed
 **/
void bcm_cosq_pfc_monitor_port_control_t_init(
    bcm_cosq_pfc_monitor_port_control_t *control)
{
    if (control != NULL) {
        sal_memset(control, 0, sizeof(bcm_cosq_pfc_monitor_port_control_t));
    }
}

/*
 *Function:
 *   bcm_cosq_dynamic_ecn_threshold_t_init
 *Purpose:
 *   Initialize bcm_cosq_dynamic_ecn_threshold_t structure
 *Parameters:
 *   threshold - Pointer to the struct to be init'ed
 **/
void bcm_cosq_dynamic_ecn_threshold_t_init(
    bcm_cosq_dynamic_ecn_threshold_t *threshold)
{
    if (threshold != NULL) {
        sal_memset(threshold, 0, sizeof(bcm_cosq_dynamic_ecn_threshold_t));
    }
}
