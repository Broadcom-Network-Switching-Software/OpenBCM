...
/*
 * Function:
 *      bcm_policer_action_profile_t_init
 * Purpose:
 *      Initialize the policer profile struct
 * Parameters:
 *      act_profile - Pointer to the struct to be init'ed
 */
void
bcm_policer_action_profile_t_init(bcm_policer_action_profile_t *act_profile)
{
    if (act_profile != NULL) {
        sal_memset(act_profile, 0, sizeof(bcm_policer_action_profile_t));
    }
    return;
}
