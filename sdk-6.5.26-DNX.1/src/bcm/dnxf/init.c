 ...
 */
#define MEM_TEST_SKIP             DNXF_INIT_STEP_F_MEM_TEST_SKIP
...
const dnxf_init_step_t dnxf_ha_modules_init_deinit_seq[] = {
    ...
    {DNXF_INIT_STEP_HA,                  "HA Init",              soc_dnxf_ha_init,             soc_dnxf_ha_deinit,                  TIME_PER_DEV,     NULL},
    
    {DNXF_INIT_STEP_SW_STATE,            "SW_State",             soc_dnxf_sw_state_init,       soc_dnxf_sw_state_deinit,            TIME_PER_DEV | MEM_TEST_SKIP,     NULL},
...
const dnxf_init_step_t dnxf_init_deinit_seq[] = {
  ...
  /*                                                              V                             |                                                       */
    ...
    {DNXF_INIT_STEP_DNX_DATA,          "DNXF_Data",            _dnxf_data_init,               dnxf_data_deinit,                   0,                NULL},
    ...
    {DNXF_INIT_STEP_LINKSCAN,          "Linkscan",             dnxf_linkscan_init,            dnxf_linkscan_deinit,               TIME_PER_DEV | MEM_TEST_SKIP,     NULL},
