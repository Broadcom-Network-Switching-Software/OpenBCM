...
#define TWAMP_REFLECTOR_ERROR_ESTIMATE_NOF_BITS (16)
#define TWAMP_REFLECTOR_ERROR_ESTIMATE_MAX (SAL_UPTO_BIT(TWAMP_REFLECTOR_ERROR_ESTIMATE_NOF_BITS))
#define TWAMP_REFLECTOR_MEMBER_LINK_ID_NOF_BITS (16)
#define TWAMP_REFLECTOR_MEMBER_LINK_ID_MAX (SAL_UPTO_BIT(TWAMP_REFLECTOR_MEMBER_LINK_ID_NOF_BITS))
...
/**
 * \brief
 * Used by dnx_switch_reflector_twamp_encap_se to verify API input.
 */
static shr_error_e
dnx_switch_reflector_twamp_encap_set_verify(
    int unit,
    bcm_switch_reflector_data_t * data)
{
    SHR_FUNC_INIT_VARS(unit);
    ...
    /*
     * Check error_estimate range
     */
    if (data->error_estimate > (TWAMP_REFLECTOR_ERROR_ESTIMATE_MAX))
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "error_estimate is out of range \r\n");
    }

    /*
     * Check error_estimate range
     */
    if (data->reflector_member_link_id > (TWAMP_REFLECTOR_MEMBER_LINK_ID_MAX))
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "reflector_member_link_id is out of range \r\n");
    }
    ...
    bcm_switch_reflector_data_t * data)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_switch_reflector_twamp_encap_set_verify(unit, data));
 ...
 */
shr_error_e
dnx_switch_reflector_rcy_priority_set(
    int unit,
    int priority)
{
    uint32 entry_handle_id;
    ...
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "Priority should be high(0) or normal(1).\n");
    }

    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_PEMLA_TRAP, &entry_handle_id));
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_CFG_RCY_PRIO_PTCH2, INST_SINGLE, (uint32) priority);
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
 ...
 */
shr_error_e
dnx_switch_reflector_rcy_priority_get(
    int unit,
    int *priority)
{
    uint32 entry_handle_id;
    ...
    dbal_value_field32_request(unit, entry_handle_id, DBAL_FIELD_CFG_RCY_PRIO_PTCH2, INST_SINGLE, (uint32 *) priority);
    SHR_IF_ERR_EXIT(dbal_entry_get(unit, entry_handle_id, DBAL_COMMIT));
