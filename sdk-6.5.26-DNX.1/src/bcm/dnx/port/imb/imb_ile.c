    ...
    bcm_port_t port)
{
    ...
    {
        /*
         * 3. Remove the PM mapping if port is master
         */
    ...
    int power_down)
{
    ...
    if (ilkn_access_info.pm_imb_type == imbDispatchTypeImb_cdu)
    {
        ...
        _SHR_PBMP_ITER(cdu_bmp, ethu_id)
        {
            ...
            SHR_IF_ERR_EXIT(dnx_algo_port_nif_ethu_global_to_local_and_core_get(unit, ethu_id, &core, &cdu_id));
