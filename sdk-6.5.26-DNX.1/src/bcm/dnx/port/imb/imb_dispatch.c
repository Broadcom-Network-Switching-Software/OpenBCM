...
#endif
#ifdef BCM_DNX_SUPPORT
extern __imb__dispatch__t__ imb_imb_framer_driver;
#endif
#ifdef BCM_DNX_SUPPORT
extern __imb__dispatch__t__ imb_imb_otnu_phy_driver;
#endif
...
#endif
#ifdef BCM_DNX_SUPPORT
    &imb_imb_framer_driver,
#endif
#ifdef BCM_DNX_SUPPORT
    &imb_imb_otnu_phy_driver,
#endif
    ...
    int enable)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_port_link_recovery_enable_set)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_port_link_recovery_enable_set(unit, port, enable);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_port_link_recovery_enable_set isn't implemented for driver type");
    }
    ...
    int *enable)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_port_link_recovery_enable_get)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_port_link_recovery_enable_get(unit, port, enable);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_port_link_recovery_enable_get isn't implemented for driver type");
    }
    ...
    int loopback)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_port_phy_loopback_adapter_set)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_port_phy_loopback_adapter_set(unit, port, curr_loopback, loopback);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_port_phy_loopback_adapter_set isn't implemented for driver type");
    }
    ...
    uint32 *valid)
{
    ...
    if (tdm == NULL)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "tdm NULL parameter");
    }
    if (valid == NULL)
    {
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_prd_port_last_packet_priority_get)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_prd_port_last_packet_priority_get(unit, port, priority, tdm, valid);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_prd_port_last_packet_priority_get isn't implemented for driver type");
    }
    ...
    uint32 *mapped)
{
    ...
    if (mapped == NULL)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "mapped NULL parameter");
    }
    /*
     * Dispatch 
     */
    ...
    uint8 *is_continuous)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_instru_synced_counters_config_get)
    {
        __rv__ =
            __imb__dispatch__[__type__]->f_imb_instru_synced_counters_config_get(unit, imb_id, nof_intervals,
                                                                                 is_continuous);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_instru_synced_counters_config_get isn't implemented for driver type");
    }
    ...
    uint8 reset)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_instru_counters_reset_set)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_instru_counters_reset_set(unit, imb_id, reset);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_instru_counters_reset_set isn't implemented for driver type");
    }
    ...
    uint8 *reset)
{
    ...
    if (reset == NULL)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "reset NULL parameter");
    }
    /*
     * Dispatch 
     */
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_instru_counters_reset_get)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_instru_counters_reset_get(unit, imb_id, reset);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_instru_counters_reset_get isn't implemented for driver type");
    }
    ...
    int speed)
{
    ...
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_flexe_core_port_config_set(unit, port, instance_id, speed);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
    ...
    int enable)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_port_l1_eth_transcode_set)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_port_l1_eth_transcode_set(unit, port, is_rx, map_type, enable);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_port_l1_eth_transcode_set isn't implemented for driver type");
    }
    ...
    const portmod_txpi_override_t * override)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_port_txpi_sdm_override_set)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_port_txpi_sdm_override_set(unit, port, override);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_port_txpi_sdm_override_set isn't implemented for driver type");
    }
    ...
    portmod_txpi_override_t * override)
{
    ...
    if (override == NULL)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "override NULL parameter");
    }
    /*
     * Dispatch 
     */
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_port_txpi_sdm_override_get)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_port_txpi_sdm_override_get(unit, port, override);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_port_txpi_sdm_override_get isn't implemented for driver type");
    }
    ...
    int *val)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_port_txpi_sdm_status_get)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_port_txpi_sdm_status_get(unit, port, val);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_port_txpi_sdm_status_get isn't implemented for driver type");
    }
    ...
    int nof_lanes)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_port_lane_map_set)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_port_lane_map_set(unit, port, flags, lanes, nof_lanes);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_port_lane_map_set isn't implemented for driver type");
    }
    ...
    int *nof_actual_lanes)
{
    ...
    if (lanes == NULL)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "lanes NULL parameter");
    }
    if (nof_actual_lanes == NULL)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "nof_actual_lanes NULL parameter");
    }
    /*
     * Dispatch 
     */
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_port_lane_map_get)
    {
        __rv__ =
            __imb__dispatch__[__type__]->f_imb_port_lane_map_get(unit, port, flags, nof_max_lanes, lanes,
                                                                 nof_actual_lanes);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_port_lane_map_get isn't implemented for driver type");
    }
    ...
    uint32 value)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_preemption_control_set)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_preemption_control_set(unit, port, type, value);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_preemption_control_set isn't implemented for driver type");
    }
    ...
    uint32 *value)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_preemption_control_get)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_preemption_control_get(unit, port, type, value);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_preemption_control_get isn't implemented for driver type");
    }
    ...
    uint32 *value)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_preemption_verify_status_get)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_preemption_verify_status_get(unit, port, value);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_preemption_verify_status_get isn't implemented for driver type");
    }
    ...
    uint32 *value)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_preemption_tx_status_get)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_preemption_tx_status_get(unit, port, value);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_preemption_tx_status_get isn't implemented for driver type");
    }
    ...
    const bcm_port_flr_link_config_t * config)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_port_flr_link_config_set)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_port_flr_link_config_set(unit, port, config);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_port_flr_link_config_set isn't implemented for driver type");
    }
    ...
    bcm_port_flr_link_config_t * config)
{
    ...
    if (config == NULL)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "config NULL parameter");
    }
    /*
     * Dispatch 
     */
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_port_flr_link_config_get)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_port_flr_link_config_get(unit, port, config);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_port_flr_link_config_get isn't implemented for driver type");
    }
    ...
    int speed)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_port_mac_tx_threshold_set)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_port_mac_tx_threshold_set(unit, port, speed);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_port_mac_tx_threshold_set isn't implemented for driver type");
    }
    ...
    int speed)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_port_ghao_speed_config_set)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_port_ghao_speed_config_set(unit, port, speed);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_port_ghao_speed_config_set isn't implemented for driver type");
    }
    ...
    int enable)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_port_l1_eth_1588_enable_set)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_port_l1_eth_1588_enable_set(unit, port, flags, enable);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_port_l1_eth_1588_enable_set isn't implemented for driver type");
    }
    ...
    int *enable)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_port_l1_eth_1588_enable_get)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_port_l1_eth_1588_enable_get(unit, port, flags, enable);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_port_l1_eth_1588_enable_get isn't implemented for driver type");
    }
    ...
    int speed)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_port_txpi_sdm_divider_set)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_port_txpi_sdm_divider_set(unit, port, speed);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_port_txpi_sdm_divider_set isn't implemented for driver type");
    }
