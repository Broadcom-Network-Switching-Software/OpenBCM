    ...
    int client_id)
{
    ...
    /** get old list data */
    SHR_IF_ERR_EXIT(dnx_port_nif_link_list_head_get(unit, list_type, client_id, &old_list_head, &old_nof_sections));
    ...
    int nof_sections)
{
    ...
    uint32 threshold[DNX_DATA_MAX_NIF_PRD_NOF_PRIORITIES] = { 0 };
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FUNC_INIT_VARS(unit);
