...
#include <j2x_sal_framer_ieee1588.h>
#endif
/* } */
    ...
    int unit)
{
    ...
    flags = flexe_std_gen2_init_flags_get(unit);
    FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_chip_init(unit, J2X_RST_STORE, flags));
    ...
    int nof_flexe_core_ports)
{
    ...
    /** FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_sal_framer_flexe_oam_mode_cfg
                                   (unit, LC_FLEXE1_OAM_MODULE, client_channel, OAM_MODE_FLEXE_BAS32)); */
exit:
    SHR_FREE(ts_array);
    SHR_FUNC_EXIT;
}
    ...
    int is_busb)
{
    ...
    if (is_ptp)
    {
        FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_rx_cfg_reg_field_set
                                   (unit, TUNNEL_FRAMER_CCU_RX_CFG, CCU_RX_EN, ccu_rx_cfg_lc_ccu_rx_path_sel, is_busb));
        FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_tx_cfg_reg_field_set
                                   (unit, TUNNEL_FRAMER_CCU_TX_CFG, CCU_TX_EN, ccu_tx_cfg_lc_ccu_tx_path_sel, is_busb));
    }
    else
    {
        FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ohif_flexe_upi_3th_ab_en_set
                                   (unit, TUNNEL_FRAMER_OHIF_FLEXE, ohif_flexe_lc_a_b_en, is_busb));
    }
exit:
    SHR_FUNC_EXIT;
}
    ...
    int speed)
{
    ...
    if (flags & BCM_PORT_FLEXE_TX)
    {
        ...
        {
            FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_sal_framer_subsys_flexe_adapter_busb_cfg
    ...
    int speed)
{
    ...
    FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_sal_framer_env_mac1_busb_ghao_resize(unit, LC_ENV_BUSB, client_channel, speed));
exit:
    SHR_FUNC_EXIT;
}
/**
    ...
    int flexe_cal)
{
    ...
    if (flags & BCM_PORT_FLEXE_TX)
    {
        FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_sal_framer_flexe_mux1_core_schedule_config(unit, group_index, 0, flexe_cal, 1));
    }
    if (flags & BCM_PORT_FLEXE_RX)
    {
        FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_sal_framer_flexe_demux1_core_schedule_cfg(unit, group_index, 0, flexe_cal, 1));
    }
exit:
    SHR_FUNC_EXIT;
}
    ...
    int enable)
{
     ...
     */
    FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_sal_framer_ieee1588_ccu_list_cfg
    ...
    if (flags & BCM_PORT_FLEXE_RX)
    {
        FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_tx_cfg_ram_field_set
                                   (unit, TUNNEL_FRAMER_CCU_TX_CFG, CCU_TX_CFG_LIST, ccu_id, ccu_tx_cfg_lc_l2_uni_en,
                                    (J2X_U32 *) & enable));
        FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_tx_cfg_ram_field_set
                                   (unit, TUNNEL_FRAMER_CCU_TX_CFG, CCU_TX_CFG_LIST, ccu_id,
                                    ccu_tx_cfg_lc_l3_ipv4_uni_en, (J2X_U32 *) & enable));
        FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_tx_cfg_ram_field_set
                                   (unit, TUNNEL_FRAMER_CCU_TX_CFG, CCU_TX_CFG_LIST, ccu_id,
                                    ccu_tx_cfg_lc_l3_ipv6_uni_en, (J2X_U32 *) & enable));
    }
    if (flags & BCM_PORT_FLEXE_TX)
    {
        FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_rx_cfg_ram_field_set
                                   (unit, TUNNEL_FRAMER_CCU_RX_CFG, CCU_RX_CFG_LIST, ccu_id, ccu_rx_cfg_lc_l2_uni_en,
                                    (J2X_U32 *) & enable));
        FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_rx_cfg_ram_field_set
                                   (unit, TUNNEL_FRAMER_CCU_RX_CFG, CCU_RX_CFG_LIST, ccu_id,
                                    ccu_rx_cfg_lc_l3_ipv4_uni_en, (J2X_U32 *) & enable));
        FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_rx_cfg_ram_field_set
                                   (unit, TUNNEL_FRAMER_CCU_RX_CFG, CCU_RX_CFG_LIST, ccu_id,
                                    ccu_rx_cfg_lc_l3_ipv6_uni_en, (J2X_U32 *) & enable));
    }
exit:
    SHR_FUNC_EXIT;
}
    ...
    int enable)
{
     ...
     */
    if ((port_type == J2X_MAC_ENV_PORT_PTP_10G) || (port_type == J2X_MAC_ENV_PORT_OHIF_25G))
    {
        SHR_IF_ERR_EXIT(flexe_std_gen2_mgmt_path_sel_set(unit, (port_type == J2X_MAC_ENV_PORT_PTP_10G), 0));
    }
    /*
     * Configure CCU port
     */
    ...
    {
        ccu_traffic_type = channel_map_info->is_eth ? FRAMER_IEEE1588_TRAFFIC_ETH : FRAMER_IEEE1588_TRAFFIC_FLEXE;
    ...
    uint32 enable)
{
    ...
    val[1] = client_channel;
    val[2] = enable;
    FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_sal_framer_flexe_oam_cmd(unit, J2X_CMD_FLEXE_OAM_TX_INSERT_RDI_SET(0), val));
    ...
    uint32 *enable)
{
    ...
    val[0] = TUNNEL_FRAMER_FLEXE_OAM_RX_M0;
    val[1] = client_channel;
    FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_sal_framer_flexe_oam_cmd(unit, J2X_CMD_FLEXE_OAM_TX_INSERT_RDI_GET(0), val));
    *enable = val[2];
    ...
    int enable)
{
    ...
    FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_flexe_oam_rx_reg_field_set
                               (unit, TUNNEL_FRAMER_FLEXE_OAM_RX_M0, OAM_RX_CONFIG, flexe_oam_rx_lc_bip_recal_en,
                                enable));
    ...
    int *enable)
{
    ...
    FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_flexe_oam_rx_reg_field_get
                               (unit, TUNNEL_FRAMER_FLEXE_OAM_RX_M0, OAM_RX_CONFIG, flexe_oam_rx_lc_bip_recal_en,
                                &val_get));
    *enable = (int) val_get;
    ...
    int val)
{
    ...
    FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_flexe_oam_rx_reg_field_set
                               (unit, TUNNEL_FRAMER_FLEXE_OAM_RX_M0, OAM_RX_CONFIG,
    ...
    int val)
{
     ...
     */
    FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_sal_framer_flexe_deskew_alm_en_set(unit, 0, (J2X_U8) group_index, 2, (J2X_U32) val));
    ...
    int *val)
{
     ...
     * tunnel_id is always 0, alarm type is 2 for local fault
     */
    FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_sal_framer_flexe_deskew_alm_en_get(unit, 0, (J2X_U8) group_index, 2, &val_get));
    ...
    int speed)
{
    ...
    if (flags & BCM_PORT_FLEXE_RX)
    {
         ...
         */
        FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_sal_framer_rateadp_ghao_resize_new1
                                   (unit, LC_RATEADP_MODULE_FLEXE2, client_channel, speed));
        /*
         * Adjust LCR
         */
        FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_sal_framer_sar_tx_traffic_ghao_lcr_cfg(unit, client_channel));
        /*
         * Adjust BWR
         */
        FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_sal_framer_sar_tx_traffic_ghao_bwr_cfg(unit, client_channel, bp_id));
        /*
         * Complete G.hao in rate adapter
         */
        FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_sal_framer_rateadp_ghao_resize_new2
                                   (unit, LC_RATEADP_MODULE_FLEXE2, client_channel, speed));
        /*
         * Update SW
         */
        FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_sal_framer_rateadp_ghao_resize_new3
                                   (unit, LC_RATEADP_MODULE_FLEXE2, client_channel, speed));
    }
    if (flags & BCM_PORT_FLEXE_TX)
    {
         ...
         * Adjust LCR
         */
        FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_sal_framer_sar_rx_traffic_ghao_lcr_cfg(unit, client_channel, bp_id));
        /*
         * Adjust BWR
         */
        FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_sal_framer_sar_rx_traffic_ghao_bwr_cfg(unit, client_channel, bp_id));
    }
exit:
    SHR_FUNC_EXIT;
}
    ...
    flexe_std_gen2_sch_cal_control_type_t type)
{
    ...
    FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_sal_framer_flexe_demux1_core_algorithm_chip_info_get(unit, demux_info));
    /*
     ...
     * Get original value
     */
    FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_flexe_demux_reg_get
                               (unit, TUNNEL_FRAMER_FLEXE_DEMUX_M0, AB_ENABLE_1, (J2X_U32 *) ab_enable));
    ...
    FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_flexe_demux_reg_set
                               (unit, TUNNEL_FRAMER_FLEXE_DEMUX_M0, AB_ENABLE_1, ab_enable[0]));
exit:
    SHR_FUNC_EXIT;
}
/**
    ...
    int speed)
{
    ...
    if (flags & BCM_PORT_FLEXE_RX)
    {
        ...
        {
            SHR_IF_ERR_EXIT(flexe_std_gen2_schedule_calendar_switch
                            (unit, group_index, BCM_PORT_FLEXE_RX, working_cal_id));
        }
        /*
         ...
         */
        SHR_IF_ERR_EXIT(flexe_std_gen2_schedule_calendar_switch(unit, group_index, BCM_PORT_FLEXE_RX, cal_id));
    }
    if (flags & BCM_PORT_FLEXE_TX)
    {
        /*
         ...
         */
        SHR_IF_ERR_EXIT(flexe_std_gen2_schedule_calendar_switch(unit, group_index, BCM_PORT_FLEXE_TX, cal_id));
    ...
    uint16 *filters)
{
    ...
    {
        FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_mac1_1588_by_port_cfg_get
                                   (unit, TUNNEL_FRAMER_MAC1_RX, port_1588, filter_fields[count],
                                    (J2X_U32 *) & tmp_filter));
    ...
    int enable)
{
    ...
    /*
     * Configure 1588 in MAC1
     */
    FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_sal_framer_subsys_mac_1588_cfg
                               (unit, enable, eth_1588_info->mac1_channel, &mac1_info, !(flags & BCM_PORT_FLEXE_RX)));
    /*
     * Configure path between MAC1 and MAC2
     */
    FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_sal_framer_subsys_mac1_mac2_cfg
                               (unit, enable, eth_1588_info->mac1_channel, eth_1588_info->mac2_channel,
                                eth_1588_info->speed, !(flags & BCM_PORT_FLEXE_RX)));
    /*
    ...
    uint32 val)
{
         ...
         FLEXE_CORE_1588_SRC_MAC_LO | FLEXE_CORE_1588_OVER_ETH_UNI_DA_HI | FLEXE_CORE_1588_OVER_ETH_UNI_DA_LO))
    {
        ...
        if (flags & FLEXE_CORE_1588_RX)
        {
            ...
            {
                FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_rx_cfg_reg_get
                                           (unit, TUNNEL_FRAMER_CCU_RX_CFG, CCU_RX_DA_W0, (J2X_U32 *) & new_mac_lo));
            }
            else if (flags & (FLEXE_CORE_1588_SRC_MAC_HI | FLEXE_CORE_1588_SRC_MAC_LO))
            {
                FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_rx_cfg_reg_get
                                           (unit, TUNNEL_FRAMER_CCU_RX_CFG, CCU_RX_SA_W0, (J2X_U32 *) & new_mac_lo));
            }
            else if (flags & (FLEXE_CORE_1588_OVER_ETH_UNI_DA_HI | FLEXE_CORE_1588_OVER_ETH_UNI_DA_LO))
            {
                FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_rx_cfg_reg_get
                                           (unit, TUNNEL_FRAMER_CCU_RX_CFG, CCU_RX_ETH_UNI_DA_W0,
                                            (J2X_U32 *) & new_mac_lo));
            }
        }
        else if (flags & FLEXE_CORE_1588_TX)
        {
            if (flags & (FLEXE_CORE_1588_DEST_MAC_HI | FLEXE_CORE_1588_DEST_MAC_LO))
            {
                FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_tx_cfg_reg_get
                                           (unit, TUNNEL_FRAMER_CCU_TX_CFG, CCU_TX_DA_W0, (J2X_U32 *) & new_mac_lo));
            }
            else if (flags & (FLEXE_CORE_1588_SRC_MAC_HI | FLEXE_CORE_1588_SRC_MAC_LO))
            {
                FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_tx_cfg_reg_get
                                           (unit, TUNNEL_FRAMER_CCU_TX_CFG, CCU_TX_SA_W0, (J2X_U32 *) & new_mac_lo));
            }
            else if (flags & (FLEXE_CORE_1588_OVER_ETH_UNI_DA_HI | FLEXE_CORE_1588_OVER_ETH_UNI_DA_LO))
            {
                FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_tx_cfg_reg_get
                                           (unit, TUNNEL_FRAMER_CCU_TX_CFG, CCU_TX_ETH_UNI_DA_W0,
                                            (J2X_U32 *) & new_mac_lo));
            }
        }
        ...
        if (flags & FLEXE_CORE_1588_RX)
        {
            if (flags & (FLEXE_CORE_1588_DEST_MAC_HI | FLEXE_CORE_1588_DEST_MAC_LO))
            {
                ...
                {
                    FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_rx_cfg_reg_set
                                               (unit, TUNNEL_FRAMER_CCU_RX_CFG, CCU_RX_DA_W1, new_mac_hi));
                }
                FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_rx_cfg_reg_set
                                           (unit, TUNNEL_FRAMER_CCU_RX_CFG, CCU_RX_DA_W0, new_mac_lo));
            }
            else if (flags & (FLEXE_CORE_1588_SRC_MAC_HI | FLEXE_CORE_1588_SRC_MAC_LO))
            {
                ...
                {
                    FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_rx_cfg_reg_set
                                               (unit, TUNNEL_FRAMER_CCU_RX_CFG, CCU_RX_SA_W1, new_mac_hi));
                }
                FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_rx_cfg_reg_set
                                           (unit, TUNNEL_FRAMER_CCU_RX_CFG, CCU_RX_SA_W0, new_mac_lo));
            }
            else if (flags & (FLEXE_CORE_1588_OVER_ETH_UNI_DA_HI | FLEXE_CORE_1588_OVER_ETH_UNI_DA_LO))
            {
                ...
                {
                    FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_rx_cfg_reg_set
                                               (unit, TUNNEL_FRAMER_CCU_RX_CFG, CCU_RX_ETH_UNI_DA_W1, new_mac_hi));
                }
                FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_rx_cfg_reg_set
                                           (unit, TUNNEL_FRAMER_CCU_RX_CFG, CCU_RX_ETH_UNI_DA_W0, new_mac_lo));
            }
        }
        else if (flags & FLEXE_CORE_1588_TX)
        {
            if (flags & (FLEXE_CORE_1588_DEST_MAC_HI | FLEXE_CORE_1588_DEST_MAC_LO))
            {
                if (flags & FLEXE_CORE_1588_DEST_MAC_HI)
                {
                    FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_tx_cfg_reg_set
                                               (unit, TUNNEL_FRAMER_CCU_TX_CFG, CCU_TX_DA_W1, new_mac_hi));
                }
                FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_tx_cfg_reg_set
                                           (unit, TUNNEL_FRAMER_CCU_TX_CFG, CCU_TX_DA_W0, new_mac_lo));
            }
            else if (flags & (FLEXE_CORE_1588_SRC_MAC_HI | FLEXE_CORE_1588_SRC_MAC_LO))
            {
                if (flags & FLEXE_CORE_1588_SRC_MAC_HI)
                {
                    FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_tx_cfg_reg_set
                                               (unit, TUNNEL_FRAMER_CCU_TX_CFG, CCU_TX_SA_W1, new_mac_hi));
                }
                FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_tx_cfg_reg_set
                                           (unit, TUNNEL_FRAMER_CCU_TX_CFG, CCU_TX_SA_W0, new_mac_lo));
            }
            else if (flags & (FLEXE_CORE_1588_OVER_ETH_UNI_DA_HI | FLEXE_CORE_1588_OVER_ETH_UNI_DA_LO))
            {
                if (flags & FLEXE_CORE_1588_OVER_ETH_UNI_DA_HI)
                {
                    FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_tx_cfg_reg_set
                                               (unit, TUNNEL_FRAMER_CCU_TX_CFG, CCU_TX_ETH_UNI_DA_W1, new_mac_hi));
                }
                FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_tx_cfg_reg_set
                                           (unit, TUNNEL_FRAMER_CCU_TX_CFG, CCU_TX_ETH_UNI_DA_W0, new_mac_lo));
            }
        }
    }
    else
    {
        ...
        {
            FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_rx_cfg_reg_get
                                       (unit, TUNNEL_FRAMER_CCU_RX_CFG, CCU_RX_IPV4_UNI_DA, (J2X_U32 *) & dip));
        }
        else
        {
            FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_tx_cfg_reg_get
                                       (unit, TUNNEL_FRAMER_CCU_TX_CFG, CCU_TX_IPV4_UNI_DA, (J2X_U32 *) & dip));
        }
        ...
        {
            FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_rx_cfg_reg_set
                                       (unit, TUNNEL_FRAMER_CCU_RX_CFG, CCU_RX_IPV4_UNI_DA, dip));
        }
        else
        {
            FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_tx_cfg_reg_set
                                       (unit, TUNNEL_FRAMER_CCU_TX_CFG, CCU_TX_IPV4_UNI_DA, dip));
        }
    }
exit:
    SHR_FUNC_EXIT;
         ...
         FLEXE_CORE_1588_SRC_MAC_LO | FLEXE_CORE_1588_OVER_ETH_UNI_DA_HI | FLEXE_CORE_1588_OVER_ETH_UNI_DA_LO))
    {
        if (flags & FLEXE_CORE_1588_RX)
        {
            if (flags & (FLEXE_CORE_1588_DEST_MAC_HI | FLEXE_CORE_1588_DEST_MAC_LO))
            {
                ...
                {
                    FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_rx_cfg_reg_get
                                               (unit, TUNNEL_FRAMER_CCU_RX_CFG, CCU_RX_DA_W1,
                                                (J2X_U32 *) & new_mac_hi));
                }
                FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_rx_cfg_reg_get
                                           (unit, TUNNEL_FRAMER_CCU_RX_CFG, CCU_RX_DA_W0, (J2X_U32 *) & new_mac_lo));
            ...
            else if (flags & (FLEXE_CORE_1588_SRC_MAC_HI | FLEXE_CORE_1588_SRC_MAC_LO))
            {
                ...
                {
                    FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_rx_cfg_reg_get
                                               (unit, TUNNEL_FRAMER_CCU_RX_CFG, CCU_RX_SA_W1,
                                                (J2X_U32 *) & new_mac_hi));
                }
                FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_rx_cfg_reg_get
                                           (unit, TUNNEL_FRAMER_CCU_RX_CFG, CCU_RX_SA_W1, (J2X_U32 *) & new_mac_lo));
            }
            else if (flags & (FLEXE_CORE_1588_OVER_ETH_UNI_DA_HI | FLEXE_CORE_1588_OVER_ETH_UNI_DA_LO))
            {
                if (flags & FLEXE_CORE_1588_OVER_ETH_UNI_DA_HI)
                {
                    FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_rx_cfg_reg_get
                                               (unit, TUNNEL_FRAMER_CCU_RX_CFG, CCU_RX_ETH_UNI_DA_W1,
                                                (J2X_U32 *) & new_mac_hi));
                }
                FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_rx_cfg_reg_get
                                           (unit, TUNNEL_FRAMER_CCU_RX_CFG, CCU_RX_ETH_UNI_DA_W0,
        ...
        else if (flags & FLEXE_CORE_1588_TX)
        {
            if (flags & (FLEXE_CORE_1588_DEST_MAC_HI | FLEXE_CORE_1588_DEST_MAC_LO))
            {
                ...
                {
                    FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_tx_cfg_reg_get
                                               (unit, TUNNEL_FRAMER_CCU_TX_CFG, CCU_TX_DA_W1,
                                                (J2X_U32 *) & new_mac_hi));
                }
                FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_tx_cfg_reg_get
                                           (unit, TUNNEL_FRAMER_CCU_TX_CFG, CCU_TX_DA_W0, (J2X_U32 *) & new_mac_lo));
            ...
            else if (flags & (FLEXE_CORE_1588_SRC_MAC_HI | FLEXE_CORE_1588_SRC_MAC_LO))
            {
                ...
                {
                    FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_tx_cfg_reg_get
                                               (unit, TUNNEL_FRAMER_CCU_TX_CFG, CCU_TX_SA_W1,
                                                (J2X_U32 *) & new_mac_hi));
                }
                FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_tx_cfg_reg_get
                                           (unit, TUNNEL_FRAMER_CCU_TX_CFG, CCU_TX_SA_W0, (J2X_U32 *) & new_mac_lo));
            ...
            else if (flags & (FLEXE_CORE_1588_OVER_ETH_UNI_DA_HI | FLEXE_CORE_1588_OVER_ETH_UNI_DA_LO))
            {
                ...
                {
                    FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_tx_cfg_reg_get
                                               (unit, TUNNEL_FRAMER_CCU_TX_CFG, CCU_TX_ETH_UNI_DA_W1,
                                                (J2X_U32 *) & new_mac_hi));
                }
                FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_ccu_tx_cfg_reg_get
                                           (unit, TUNNEL_FRAMER_CCU_TX_CFG, CCU_TX_ETH_UNI_DA_W0,
    ...
    int enable)
{
     ...
     * Configure stat Rx
     */
    FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_sal_framer_stat_rx_traffic_cfg(unit, enable, stat_channel, LC_BP_INVLAND_CH, 0));
    /*
    ...
    uint64 *counter_val)
{
    ...
    {
        FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_stat_rx_frame_cnt_ram_get(unit, 0, stat_channel, index, tmp_val));
        COMPILER_64_SET(counter_val[index], tmp_val[1], tmp_val[0]);
    }
    /*
     * Clear counters
     */
    FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_stat_rx_reg_field_set
                               (unit, 0, STATRX_CNT_CLR_CHAN_CFG, stat_rx_lc_statrx_cnt_clr_chan_cfg, stat_channel));
    FLEXE_STD_GEN2_IF_ERR_EXIT(j2x_uas_framer_stat_rx_reg_field_set
                               (unit, 0, STATRX_CNT_CLR, stat_rx_lc_statrx_cnt_chan_clr, 1));
exit:
    SHR_FUNC_EXIT;
}
