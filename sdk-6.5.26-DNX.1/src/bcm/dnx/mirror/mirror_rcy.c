    ...
    int *mapped_egress_interface)
{
    ...
    {
        SHR_IF_ERR_EXIT(dnx_algo_port_in_channel_get(unit, rcy_mirror_port, &mirror_channel));
    ...
    bcm_port_t * rcy_mirror_port)
{
    ...
    else
    {
        ...
        SHR_IF_ERR_EXIT(dnx_algo_port_interface_and_channel_to_logical_get
                        (unit, core_id, port_info_rcy_mirror, rcy_channel_id, FALSE, rcy_mirror_port));
    }
    ...
    bcm_port_t rcy_mirror_port)
{
    ...
    {
        SHR_IF_ERR_EXIT(dnx_algo_port_in_channel_get(unit, rcy_mirror_port, &rcy_channel_id));
    }
    ...
    bcm_mirror_port_to_rcy_map_info_t * rcy_map_info)
{
    ...
    /** make sure forward port is not mapped to a different egress interface */
    ...
    /*
     * check if there is a limitation on changing priority
     */
    ...
    bcm_mirror_port_to_rcy_map_info_t * rcy_map_info)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_mirror_port_to_rcy_port_map_set_verify(unit, forward_port, rcy_map_info));
    ...
    bcm_mirror_port_to_rcy_map_info_t * rcy_map_info)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_mirror_port_to_rcy_port_unmap_set_verify(unit, forward_port, rcy_map_info));
    ...
    /** get all ports of the same interface */
    SHR_IF_ERR_EXIT(dnx_algo_port_channels_get(unit, forward_port, DNX_ALGO_PORT_CHANNELS_F_NON_L1_ONLY, &ports_pbmp));
