    ...
    int *dbal_table)
{
    ...
    switch (block_type)
    {
        ...
        case SOC_BLK_MSW:
        {
            *dbal_table = DBAL_TABLE_MSW_GTIMER_CONTROL;
            break;
        }
        case SOC_BLK_ARB:
        {
            *dbal_table = DBAL_TABLE_ARB_GTIMER_CONTROL;
            break;
        }
        case SOC_BLK_OFR:
        {
            *dbal_table = DBAL_TABLE_OFR_GTIMER_CONTROL;
            break;
        }
        case SOC_BLK_OFT:
        {
            *dbal_table = DBAL_TABLE_OFT_GTIMER_CONTROL;
            break;
        }
        default:
        {
