 ...
 *
 * \param [in] unit - unit number
 * \param [in] unique_id - unique id of the object
...
/**
 * \brief - relevant is_first configurations for a new psc_profile allocated.
 *          sets both SW and HW based on profile_info.
 *
 * \param [in] unit - unit number
 * \param [in] psc_profile - profile ID
 * \param [in] profile_info - profile info
 *
 * \return
 *   shr_error_e
 *
 ...
 *   * None
 */
shr_error_e dnx_trunk_chm_psc_profile_is_first_config(
    int unit,
    int psc_profile,
...
/**
 * \brief - function to get the profile type based on profile input data
 *
 * \param [in] unit - unit number
 ...
 *   * None
 */
shr_error_e dnx_trunk_user_profile_type_get(
    int unit,
    bcm_trunk_profile_t * profile,
    int *profile_type);

/**
 * \brief - get the max possible member ID based on profile info
 *
 * \param [in] unit - unit number
 * \param [in] profile - profile data
 * \param [out] max_member_id - max member ID
 *
 * \return
 *   shr_error_e
 *
 ...
 *   * None
 */
shr_error_e dnx_trunk_user_profile_max_member_id_get(
    int unit,
    bcm_trunk_profile_t * profile,
    int *max_member_id);

/**
 * \brief - get the number of hw entries used based on profile info
 *
 * \param [in] unit - unit number
 * \param [in] profile - profile data
 * \param [out] hw_entries_used - nof hw entries used
 *
 * \return
 *   shr_error_e
 *
 ...
 *   * None
 */
shr_error_e dnx_trunk_user_profile_hw_entries_used_get(
    int unit,
    bcm_trunk_profile_t * profile,
    int *hw_entries_used);

/**
 * \brief - get user profile info based on psc profile id in sw-state and configured members calendar
 *
 * \param [in] unit - unit number
 * \param [in] psc_profile - psc profile id in sw-state
 * \param [in] calendar - configured members calendar
 * \param [out] profile - output configured profile
 *
 * \return
 *   shr_error_e
 *
 ...
 *   * None
 */
shr_error_e dnx_trunk_user_profile_get(
    int unit,
    int psc_profile,
    consistent_hashing_calendar_t * calendar,
    bcm_trunk_profile_t * profile);
