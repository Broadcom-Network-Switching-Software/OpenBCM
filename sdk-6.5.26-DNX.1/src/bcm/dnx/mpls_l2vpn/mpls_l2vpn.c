...
{
    SHR_FUNC_INIT_VARS(unit);
    SHR_INVOKE_VERIFY_DNXC(dnx_mpls_l2vpn_add_verify(unit, l2vpn_info));
...
{
    SHR_FUNC_INIT_VARS(unit);
    SHR_INVOKE_VERIFY_DNXC(dnx_mpls_l2vpn_delete_verify(unit, l2vpn_type, mpls_l2vpn_id));
...
{
    SHR_FUNC_INIT_VARS(unit);
    SHR_INVOKE_VERIFY_DNXC(dnx_mpls_l2vpn_get_verify(unit, l2vpn_info));
