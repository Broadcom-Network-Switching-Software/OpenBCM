    ...
    dnx_field_entry_t * entry_info_p)
{
    ...
    {
        SHR_IF_ERR_EXIT(dbal_entry_attribute_get(unit, entry_handle_id, DBAL_ENTRY_ATTR_CACHED, &is_entry_cached));
    }

    /*
     * Get entry's priority
     */
    SHR_IF_ERR_EXIT(dbal_entry_attribute_get(unit, entry_handle_id, DBAL_ENTRY_ATTR_PRIORITY, &entry_info_p->priority));
    ...
    uint32 access_id)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_tcam_handler_entry_core_get(unit, access_id, &core));
    ...
    uint8 *entry_hit_core_bmp_p)
{
    ...
    *entry_hit_core_bmp_p = 0;
    ...
    SHR_IF_ERR_EXIT(dbal_entry_attribute_get
                    (unit, entry_handle_id, DBAL_ENTRY_ATTR_HITBIT, &entry_hit_core_bmp_uint32));
    ...
    uint32 entry_handle)
{
    uint32 entry_handle_id;
    uint32 entry_hit_core_bmp_uint32;
    uint32 hitbit_flags = DBAL_ENTRY_ATTR_FLAG_HIT_CLEAR;
