    ...
    bcm_if_t * encap_id)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_oam_reflector_encap_create_verify(unit, flags, encap_id));
    ...
    bcm_if_t encap_id)
{
    ...
    /** Verification of input parameters */
    SHR_INVOKE_VERIFY_DNXC(dnx_oam_reflector_encap_destroy_verify(unit, flags, encap_id));
