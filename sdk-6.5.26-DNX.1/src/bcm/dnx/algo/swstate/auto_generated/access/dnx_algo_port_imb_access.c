...
dnx_algo_port_imb_db_is_init(int unit, uint8 *is_init)
{
    ...
    VERIFY_FUNCTION_CALL_ALLOWED(
        unit,
        DNX_SW_STATE_DNX_ALGO_PORT_IMB_DB,
...
dnx_algo_port_imb_db_init(int unit)
{
    ...
    DNX_SW_STATE_MODULE_INIT(
        ...
        dnx_algo_port_imb_init_layout_structure);
    ...
    DNX_SW_STATE_DIAG_INFO_POST(
        ...
        DNX_SW_STATE_DIAG_ALLOC,
        ((dnx_algo_port_imb_db_t*)sw_state_roots_array[unit][DNX_ALGO_PORT_IMB_MODULE_ID]),
        sw_state_layout_array[unit][DNX_ALGO_PORT_IMB_MODULE_ID]);
...
dnx_algo_port_imb_db_rmc_id_res_alloc(int unit)
{
    ...
    DNX_SW_STATE_DOUBLE_DYNAMIC_ARRAY_SIZE_CHECK(
        ...
        dnx_data_nif.eth.max_ethu_nof_per_core_get(unit),
    ...
    DNX_SW_STATE_LOG(
        ...
        unit,
        dnx_data_nif.eth.max_ethu_nof_per_core_get(unit) * sizeof(dnx_algo_res_t) / sizeof(*((dnx_algo_port_imb_db_t*)sw_state_roots_array[unit][DNX_ALGO_PORT_IMB_MODULE_ID])->rmc_id_res)+(dnx_data_nif.eth.max_ethu_nof_per_core_get(unit) * sizeof(dnx_algo_res_t)));
