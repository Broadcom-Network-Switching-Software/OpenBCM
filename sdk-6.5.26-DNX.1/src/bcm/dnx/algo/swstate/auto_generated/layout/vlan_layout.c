...
vlan_init_layout_structure(int unit)
{
    ...
    layout_array_vlan[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_vlan[idx].size_of = sizeof(vlan_unit_state_t);
    layout_array_vlan[idx].parent  = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_vlan[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_VLAN_DB__FIRST);
    layout_array_vlan[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_VLAN_DB__LAST)-1;
    ...
    layout_array_vlan[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_VLAN_DB__VLAN_INFO__FIRST);
    layout_array_vlan[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_VLAN_DB__VLAN_INFO__LAST)-1;
