    ...
    const void *data)
{
    ...
    {
        SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT8, "IPv4 rpf mode", template_data->rpf_mode_ipv4,
                                       NULL, "0x%08x");
        SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT8, "IPv6 rpf mode", template_data->rpf_mode_ipv6,
                                       NULL, "0x%08x");
    }
    else
    {
