    ...
    bcm_if_t * intf_array)
{
    ...
    uint8 protection_per_super_fec_type[4] = { 255, 255, 255, 255 };
    ...
    for (fec_iter = 0, max_fec = 0, min_fec = max_fec_id; fec_iter < intf_count; fec_iter++)
    {
        ...
        if (protection_per_super_fec_type[super_fec_resource_type] == 255)
        {
            protection_per_super_fec_type[super_fec_resource_type] =
                (dnx_data_l3.fec.
                 fec_resource_info_get(unit, super_fec_resource_type)->is_protection_type) ? TRUE : FALSE;
        }
