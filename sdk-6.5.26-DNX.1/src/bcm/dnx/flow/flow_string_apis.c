...
static const char *flow_app_init_indications_string[FLOW_NOF_APP_INIT_IND] = {
    ...
    "L2_GLOBAL_LIF",
    "VIRTUAL_LIF_ONLY",
    "VIRTUAL_LIF_SUPPORTED",
    "NO_LOCAL_LIF",
    "MANDATORY_L3_INTF",
    "IGNORE_L3_INTF",
    "SRC_ADDR_PROFILE_LSB",
    "SHARED_PHY_DB_MANAGEMENT"
};
...
static const char *flow_app_term_indications_string[FLOW_NOF_APP_TERM_IND] = {
    "QOS_PHB_DEFAULT_PIPE",
    "QOS_RM_DEFAULT_PIPE",
    "QOS_TTL_DEFAULT_PIPE",
    "IGNORE_L2_LEARN_INFO_SET",
    "VIRTUAL_LIF_ONLY",
    "VIRTUAL_LIF_SUPPORTED",
    "SUPPORT_EXTENDED_TERMINATION",
    "L2_GLOBAL_LIF",
    "SUPPORT_MPLS_PROFILE",
    "L2_LEARN_STANDARD_SET",
    "L2_LEARN_NO_OPTIMIZATION"
};
