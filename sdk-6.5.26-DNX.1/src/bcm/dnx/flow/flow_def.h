...
typedef enum
{
    ...
    FLOW_APP_TERM_IND_L2_LEARN_INFO_STANDARD_SET, /** \brief L2 learn info indication to use a standard sequence instead of the Tunnel cb */
    FLOW_APP_TERM_IND_L2_LEARN_NO_OPTIMIZATION, /** \brief L2 learn info indication to avoid Optimization learning (In case the learn destination is a physical port
