    ...
    bcm_flow_special_fields_t * special_fields)
{
    ...
    {
        if (_SHR_IS_FLAG_SET(bcm_app_info->valid_elements_set, BCM_FLOW_INITIATOR_ELEMENT_TPID_CLASS_ID_VALID))
        {
            SHR_ERR_EXIT(_SHR_E_PARAM, "cannot set common field tpid_class_id for virtual ports");
        }
        if (_SHR_IS_FLAG_SET(bcm_app_info->valid_elements_set, BCM_FLOW_INITIATOR_ELEMENT_FIELD_CLASS_ID_VALID))
        {
            SHR_ERR_EXIT(_SHR_E_PARAM, "cannot set common field class_id for virtual ports");
        }
        if (_SHR_IS_FLAG_SET(bcm_app_info->valid_elements_set, BCM_FLOW_INITIATOR_ELEMENT_FIELD_CLASS_CS_ID_VALID))
        {
            SHR_ERR_EXIT(_SHR_E_PARAM, "cannot set common field class_cs_id for virtual ports");
        }
    }
