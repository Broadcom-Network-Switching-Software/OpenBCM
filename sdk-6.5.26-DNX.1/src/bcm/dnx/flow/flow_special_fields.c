...
const flow_special_field_info_t flow_special_fields_db[NOF_FLOW_SPECIAL_FIELDS+1] = {
    ...
    {"",                            FLOW_S_F_UNMAPPED,                      FLOW_PAYLOAD_TYPE_UINT32,           FLOW_S_FIELD_DIRECT_MAPPING},
    ...
    {"SVTAG_TXSCI",                 DBAL_FIELD_SVTAG_TXSCI,                 FLOW_PAYLOAD_TYPE_UINT32,           FLOW_S_FIELD_DIRECT_MAPPING},
    ...
    {"VLAN_PORT_SVTAG_PORT",        FLOW_S_F_UNMAPPED,                      FLOW_PAYLOAD_TYPE_ENABLER,          FLOW_S_FIELD_UNLINKED, NULL,                  NULL,       FLOW_S_FIELD_SHOULD_BE_IGNORED,  FLOW_S_FIELD_NO_MAPPING_CBS}, 
    ...
    {"TUNNEL_CLASS",                FLOW_S_F_UNMAPPED,                      FLOW_PAYLOAD_TYPE_UINT32,           FLOW_S_FIELD_UNLINKED,   NULL, NULL, (FLOW_S_FIELD_LIF_SHOULD_BE_IGNORED| FLOW_S_FIELD_IS_ALWAYS_MANDATORY | FLOW_S_FIELD_IS_LIF_UNCHANGEABLE), flow_special_field_tunnel_class_set, flow_special_field_tunnel_class_get, NULL, NULL},
    ...
    {"IPV4_TUNNEL_TYPE",            DBAL_FIELD_IPV4_TUNNEL_TYPE,            FLOW_PAYLOAD_TYPE_BCM_ENUM,         FLOW_S_FIELD_UNLINKED,   flow_special_field_ipv4_tunnel_desc, flow_special_field_ipv4_tunnel_print, (FLOW_S_FIELD_LIF_SHOULD_BE_IGNORED| FLOW_S_FIELD_IS_ALWAYS_MANDATORY | FLOW_S_FIELD_IS_LIF_UNCHANGEABLE | FLOW_S_FIELD_MATCH_SHOULD_BE_IGNORED), NULL, NULL, NULL, NULL},
    ...
    {"IPVX_TUNNEL_TYPE",            FLOW_S_F_UNMAPPED,                      FLOW_PAYLOAD_TYPE_BCM_ENUM,         FLOW_S_FIELD_UNLINKED,   flow_special_field_ipvx_tunnel_desc, flow_special_field_ipvx_tunnel_print,  (FLOW_S_FIELD_LIF_SHOULD_BE_IGNORED | FLOW_S_FIELD_IS_LIF_MANDATORY | FLOW_S_FIELD_IS_LIF_UNCHANGEABLE), NULL, NULL, NULL, NULL},
    ...
    {"MPLS_NOF_SERVICE_TAGS",           FLOW_S_F_UNMAPPED,                  FLOW_PAYLOAD_TYPE_UINT32,           FLOW_S_FIELD_UNLINKED, NULL,                  NULL,           FLOW_S_FIELD_SHOULD_BE_IGNORED,  FLOW_S_FIELD_NO_MAPPING_CBS},

    {"MPLS_PORT_VCCV_TYPE",         DBAL_FIELD_TERMINATION_TYPE,            FLOW_PAYLOAD_TYPE_BCM_ENUM,         FLOW_S_FIELD_UNLINKED,   flow_special_field_mpls_port_vccv_type_desc, flow_special_field_mpls_port_vccv_type_print, (FLOW_S_FIELD_SHOULD_BE_IGNORED | FLOW_S_FIELD_IS_LIF_MANDATORY),  FLOW_S_FIELD_NO_MAPPING_CBS},
    ...
    {"EXPECT_NON_BOS",                FLOW_S_F_UNMAPPED,                    FLOW_PAYLOAD_TYPE_ENABLER,          FLOW_S_FIELD_UNLINKED, NULL,                  NULL,           FLOW_S_FIELD_SHOULD_BE_IGNORED,  FLOW_S_FIELD_NO_MAPPING_CBS},
    ...
    {"OUT_LIF_MATCH",               DBAL_FIELD_OUT_LIF,                     FLOW_PAYLOAD_TYPE_UINT32,           FLOW_S_FIELD_UNLINKED,  NULL,               NULL,           (FLOW_S_FIELD_VIRTUAL_MATCH_KEY | FLOW_S_FIELD_IS_LIF_MANDATORY),   flow_special_field_outlif_match_set, flow_special_field_outlif_match_get, NULL, NULL},
    ...
    {"SYSTEM_PORT_MATCH",           DBAL_FIELD_SYSTEM_PORT_AGGREGATE,       FLOW_PAYLOAD_TYPE_UINT32,           FLOW_S_FIELD_UNLINKED,  NULL,               NULL,           (FLOW_S_FIELD_VIRTUAL_MATCH_KEY | FLOW_S_FIELD_IS_LIF_MANDATORY),   FLOW_S_FIELD_NO_MAPPING_CBS},

    {"RCH_VRF",                     DBAL_FIELD_VRF,                         FLOW_PAYLOAD_TYPE_UINT32,           FLOW_S_FIELD_DIRECT_MAPPING},
    ...
    {"RCH_ADDITIONAL_BYTES_TO_STRIP", DBAL_FIELD_BTS_ADDITIONAL_TERMINATION_SIZE, FLOW_PAYLOAD_TYPE_UINT32,    FLOW_S_FIELD_DIRECT_MAPPING},
    ...
    {"REFLECTOR_EGRESS_LAST_LAYER", DBAL_FIELD_EGRESS_LAST_LAYER,           FLOW_PAYLOAD_TYPE_ENABLER,          FLOW_S_FIELD_DIRECT_MAPPING},
    ...
    {"FWD_DOMAIN_NWK_NAME",         DBAL_FIELD_FWD_DOMAIN_NWK_NAME,         FLOW_PAYLOAD_TYPE_UINT32,           FLOW_S_FIELD_DIRECT_MAPPING},
    {"OAM_REFLECTOR_RAW_DATA",      DBAL_FIELD_RAW_DATA,                    FLOW_PAYLOAD_TYPE_UINT32,           FLOW_S_FIELD_DIRECT_MAPPING},
    /** The INVALID must be the last entry */
    {"LAST",                        FLOW_S_F_UNMAPPED,                      FLOW_PAYLOAD_TYPE_UINT32,           FLOW_S_FIELD_DIRECT_MAPPING},
};
    ...
    bcm_flow_special_field_t * special_field)
{
    ...
    if ((control_lif != recycle_default_lif_mp) && (control_lif != recycle_default_lif_p2p))
    {
        ...
        rv = dnx_algo_gpm_gport_from_lif(unit, flags, _SHR_CORE_ALL, (int) control_lif, &flow_id);
        SHR_IF_ERR_EXIT_EXCEPT_IF(rv, _SHR_E_NOT_FOUND);
        if (rv == _SHR_E_NOT_FOUND)
        {
            /** if global not found, check if it is virtual lif */
            SHR_IF_ERR_EXIT(dnx_flow_ingress_virtual_gport_get(unit, control_lif, _SHR_CORE_ALL, &virtual_id));
            BCM_GPORT_SUB_TYPE_VIRTUAL_INGRESS_SET(virtual_id, virtual_id);
            /** Set the virtual id as a gport flow_id */
            BCM_GPORT_FLOW_LIF_ID_SET(flow_id, virtual_id);

        }
        else
        {
            SHR_IF_ERR_EXIT(algo_gpm_gport_flow_convert(unit,
                                                        flow_id, BCM_GPORT_TYPE_FLOW_LIF,
