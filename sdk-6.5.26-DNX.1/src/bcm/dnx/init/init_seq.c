...
static const  dnx_init_step_t dnx_init_deinit_tm_seq[] = {
  ...
  {DNX_INIT_STEP_LINKSCAN,                      "LINKSCAN",             dnx_linkscan_init,              dnx_linkscan_deinit,        NULL,           MEM_TEST_SKIP | NEVER_SKIP_DEINIT | MANDATORY_DEINIT,   NULL},
...
static const dnx_init_step_t dnx_init_deinit_pp_seq[] = {
  ...
  {DNX_INIT_STEP_BIER_PP,                "bier",                  dnx_bier_pp_init,                         NULL,                       NULL,            WB_SKIP,                 NULL},
  {DNX_INIT_STEP_LAST_STEP,              "Last Step",             NULL,                                     NULL,                       NULL,            0,                       NULL}
};
...
static const  dnx_init_step_t dnx_init_deinit_thread_seq[] = {
    /*          STEP_ID,                       STEP_NAME,                     STEP_INIT,                                 STEP_DEINIT,                                 FLAG_CB             STEP_FLAGS          SUB_STEP_LIST_PTR */
    {DNX_INIT_STEP_TEMPERATURE_MONITOR,        "Dram Temperature Monitor",    dnx_hbmc_temp_monitor_init,                dnx_hbmc_temp_monitor_deinit,                NULL,               MANDATORY_DEINIT,   NULL},
...
const dnx_init_step_t dnx_init_deinit_seq[] = {
  ...
  {DNX_INIT_STEP_ERROR_RECOVERY,  "Error Recovery",               dnx_err_recovery_module_init,     dnx_err_recovery_module_deinit,  wb_test_mode_skip,  ACCESS | MEM_TEST_SKIP,                     NULL},
