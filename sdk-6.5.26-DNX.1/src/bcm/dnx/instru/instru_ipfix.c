    ...
    int ipfix_encap_id)
{
    ...
    if ((hw_res.outlif_dbal_table_id != DBAL_TABLE_EEDB_DATA_IPFIX_CODE)
    ...
    bcm_instru_ipfix_encap_info_t * ipfix_encap_info)
{
    ...
    if (dnx_data_instru.ipfix.ipfix_v2_get(unit) == 1)
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "Error: Not supported for device\n");
    }
    ...
    uint32 dbal_result_type)
{
    ...
    outlif_info.dbal_table_id = DBAL_TABLE_EEDB_DATA_IPFIX_CODE;
    ...
    uint32 dbal_result_type)
{
    ...
    /** Take DBAL handle */
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_EEDB_DATA_IPFIX_CODE, &entry_handle_id));
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_EGRESS_FWD_CODE, INST_SINGLE,
    ...
    uint32 *fwd_code)
{
    ...
    dbal_value_field32_request(unit, entry_handle_id, DBAL_FIELD_EGRESS_FWD_CODE, INST_SINGLE, fwd_code);
    ...
    bcm_instru_ipfix_encap_info_t * ipfix_encap_info)
{
    ...
    uint32 result_type = DBAL_RESULT_TYPE_EEDB_DATA_IPFIX_CODE_ETPS_DATA_IPFIX_CODE;
    ...
    bcm_instru_ipfix_interface_info_t * ipfix_interface_info)
{
    ...
    {
        if (dnx_data_instru.ipfix.ipfix_v2_get(unit) == 0)
        {
