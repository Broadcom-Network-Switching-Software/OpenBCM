...
_bcm_compat6520in_fcoe_vsan_action_set_t(
    ...
    bcm_compat6521_fcoe_vsan_action_set_t *to)
{
...
{
    int rv = BCM_E_NONE;
    bcm_compat6521_fcoe_vsan_action_set_t *new_action = NULL;

    if (action != NULL) {
        new_action = (bcm_compat6521_fcoe_vsan_action_set_t *)
                     sal_alloc(sizeof(bcm_compat6521_fcoe_vsan_action_set_t),
                     "New action");
        if (new_action == NULL) {
            return BCM_E_MEMORY;
        }
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_fcoe_vsan_translate_action_add(unit, key, new_action);
...
{
    int rv = BCM_E_NONE;
    bcm_compat6521_vlan_action_set_t *new_vlan_action_set = NULL;

    if (vlan_action_set != NULL) {
        new_vlan_action_set = (bcm_compat6521_vlan_action_set_t *)
                     sal_alloc(sizeof(bcm_compat6521_vlan_action_set_t),
                     "New vlan_action_set");
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_field_action_vlan_actions_add(unit, entry, action, new_vlan_action_set);
    ...
    bcm_compat6520_vlan_action_set_t *vlan_action_set)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_field_action_vlan_actions_get(unit, entry, action, new_vlan_action_set);
...
{
    int rv = BCM_E_NONE;
    bcm_compat6521_vlan_action_set_t *new_action = NULL;

    if (action != NULL) {
        new_action = (bcm_compat6521_vlan_action_set_t *)
                     sal_alloc(sizeof(bcm_compat6521_vlan_action_set_t),
                     "New action");
        if (new_action == NULL) {
            return BCM_E_MEMORY;
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_vlan_port_default_action_get(unit, port, new_action);
    ...
    bcm_compat6520_vlan_action_set_t *action)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_vlan_port_default_action_set(unit, port, new_action);
    ...
    bcm_compat6520_vlan_action_set_t *action)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_vlan_port_egress_default_action_get(unit, port, new_action);
    ...
    bcm_compat6520_vlan_action_set_t *action)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_vlan_port_egress_default_action_set(unit, port, new_action);
    ...
    bcm_compat6520_vlan_action_set_t *action)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_vlan_port_protocol_action_add(unit, port, frame, ether, new_action);
    ...
    bcm_compat6520_vlan_action_set_t *action)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_vlan_port_protocol_action_get(unit, port, frame, ether, new_action);
    ...
    bcm_compat6520_vlan_action_set_t *action)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_vlan_mac_action_add(unit, mac, new_action);
    ...
    bcm_compat6520_vlan_action_set_t *action)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_vlan_mac_action_get(unit, mac, new_action);
    ...
    bcm_compat6520_vlan_action_set_t *action)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_vlan_translate_action_add(unit, port, key_type, outer_vlan, inner_vlan, new_action);
    ...
    bcm_compat6520_vlan_action_set_t *action)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_vlan_translate_action_create(unit, port, key_type, outer_vlan, inner_vlan, new_action);
    ...
    bcm_compat6520_vlan_action_set_t *action)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_vlan_translate_action_get(unit, port, key_type, outer_vlan, inner_vlan, new_action);
    ...
    bcm_compat6520_vlan_action_set_t *action)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_vlan_translate_egress_action_add(unit, port_class, outer_vlan, inner_vlan, new_action);
    ...
    bcm_compat6520_vlan_action_set_t *action)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_vlan_translate_egress_action_get(unit, port_class, outer_vlan, inner_vlan, new_action);
    ...
    bcm_compat6520_vlan_action_set_t *action)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_vlan_translate_egress_gport_action_add(unit, port, outer_vlan, inner_vlan, new_action);
    ...
    bcm_compat6520_vlan_action_set_t *action)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_vlan_translate_egress_gport_action_get(unit, port, outer_vlan, inner_vlan, new_action);
    ...
    bcm_compat6520_vlan_action_set_t *action)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_vlan_translate_action_range_add(unit, port, outer_vlan_low, outer_vlan_high, inner_vlan_low, inner_vlan_high, new_action);
    ...
    bcm_compat6520_vlan_action_set_t *action)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_vlan_translate_action_range_get(unit, port, outer_vlan_low, outer_vlan_high, inner_vlan_low, inner_vlan_high, new_action);
    ...
    bcm_compat6520_vlan_action_set_t *action)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_vlan_translate_action_id_set(unit, flags, action_id, new_action);
    ...
    bcm_compat6520_vlan_action_set_t *action)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_vlan_translate_action_id_get(unit, flags, action_id, new_action);
    ...
    bcm_compat6520_vlan_action_set_t *action)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_vlan_ip_action_add(unit, vlan_ip, new_action);
    ...
    bcm_compat6520_vlan_action_set_t *action)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_vlan_ip_action_get(unit, vlan_ip, new_action);
...
{
    int rv = BCM_E_NONE;
    bcm_compat6521_vlan_action_set_t *new_action_set = NULL;

    if (action_set != NULL) {
        new_action_set = (bcm_compat6521_vlan_action_set_t *)
                     sal_alloc(sizeof(bcm_compat6521_vlan_action_set_t),
                     "New action_set");
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_vlan_match_action_add(unit, options, match_info, new_action_set);
    ...
    bcm_compat6520_vlan_action_set_t *action_set)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_vlan_match_action_get(unit, match_info, new_action_set);
...
{
    int rv = BCM_E_NONE;
    bcm_compat6521_vlan_action_set_t *new_action_set_array = NULL;
    int i = 0;

    if (action_set_array != NULL && size > 0) {
        new_action_set_array = (bcm_compat6521_vlan_action_set_t *)
                     sal_alloc(size * sizeof(bcm_compat6521_vlan_action_set_t),
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_vlan_match_action_multi_get(unit, match, size, match_info_array, new_action_set_array, count);
...
{
    int rv = BCM_E_NONE;
    bcm_compat6521_vlan_control_vlan_t *new_control = NULL;

    if (control != NULL) {
        new_control = (bcm_compat6521_vlan_control_vlan_t *)
                     sal_alloc(sizeof(bcm_compat6521_vlan_control_vlan_t),
                     "New control");
        if (new_control == NULL) {
            return BCM_E_MEMORY;
        }
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_vlan_control_vlan_selective_get(unit, vlan, valid_fields, new_control);
    ...
    bcm_compat6520_vlan_control_vlan_t *control)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_vlan_control_vlan_selective_set(unit, vlan, valid_fields, new_control);
    ...
    bcm_compat6520_vlan_control_vlan_t *control)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_vlan_control_vlan_get(unit, vlan, new_control);
...
{
    int rv = BCM_E_NONE;
    bcm_compat6521_vlan_control_vlan_t new_control;

    /* Transform the entry from the old format to new one */
    _bcm_compat6520in_vlan_control_vlan_t(&control, &new_control);
    /* Call the BCM API with new format */
    rv = bcm_compat6521_vlan_control_vlan_set(unit, vlan, new_control);
...
{
    int rv = BCM_E_NONE;
    bcm_compat6521_vlan_translate_egress_action_set_t *new_action = NULL;

    if (action != NULL) {
        new_action = (bcm_compat6521_vlan_translate_egress_action_set_t *)
                     sal_alloc(sizeof(bcm_compat6521_vlan_translate_egress_action_set_t),
                     "New action");
        if (new_action == NULL) {
            return BCM_E_MEMORY;
        }
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_vlan_translate_egress_action_extended_add(unit, key_config, new_action);
    ...
    bcm_compat6520_vlan_translate_egress_action_set_t *action)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_vlan_translate_egress_action_extended_get(unit, key_config, new_action);
...
{
    int rv = BCM_E_NONE;
    bcm_compat6525_mpls_port_t *new_mpls_port = NULL;

    if (mpls_port != NULL) {
        new_mpls_port = (bcm_compat6525_mpls_port_t *)
                     sal_alloc(sizeof(bcm_compat6525_mpls_port_t),
                     "New mpls_port");
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6525_mpls_port_add(unit, vpn, new_mpls_port);
    ...
    bcm_compat6520_mpls_port_t *mpls_port)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6525_mpls_port_get(unit, vpn, new_mpls_port);
...
{
    int rv = BCM_E_NONE;
    bcm_compat6525_mpls_port_t *new_port_array = NULL;
    int i = 0;

    if (port_array != NULL && port_max > 0) {
        new_port_array = (bcm_compat6525_mpls_port_t *)
                     sal_alloc(port_max * sizeof(bcm_compat6525_mpls_port_t),
                     "New port_array");
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6525_mpls_port_get_all(unit, vpn, port_max, new_port_array, port_count);
...
{
    int rv = BCM_E_NONE;
    bcm_compat6523_tunnel_initiator_t *new_tunnel = NULL;

    if (tunnel != NULL) {
        new_tunnel = (bcm_compat6523_tunnel_initiator_t *)
                     sal_alloc(sizeof(bcm_compat6523_tunnel_initiator_t),
                     "New tunnel");
        if (new_tunnel == NULL) {
            return BCM_E_MEMORY;
        }
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6523_tunnel_initiator_set(unit, intf, new_tunnel);
    ...
    bcm_compat6520_tunnel_initiator_t *tunnel)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6523_tunnel_initiator_create(unit, intf, new_tunnel);
    ...
    bcm_compat6520_tunnel_initiator_t *tunnel)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6523_tunnel_initiator_get(unit, intf, new_tunnel);
...
{
    int rv = BCM_E_NONE;
    bcm_compat6523_tunnel_initiator_t *new_info = NULL;

    if (info != NULL) {
        new_info = (bcm_compat6523_tunnel_initiator_t *)
                     sal_alloc(sizeof(bcm_compat6523_tunnel_initiator_t),
                     "New info");
        if (new_info == NULL) {
            return BCM_E_MEMORY;
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6523_vxlan_tunnel_initiator_create(unit, new_info);
    ...
    bcm_compat6520_tunnel_initiator_t *info)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6523_vxlan_tunnel_initiator_get(unit, new_info);
    ...
    bcm_compat6520_tunnel_initiator_t *info)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6523_wlan_tunnel_initiator_create(unit, new_info);
    ...
    bcm_compat6520_tunnel_initiator_t *info)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6523_wlan_tunnel_initiator_get(unit, new_info);
    ...
    bcm_compat6520_tunnel_initiator_t *info)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6523_l2gre_tunnel_initiator_create(unit, new_info);
    ...
    bcm_compat6520_tunnel_initiator_t *info)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6523_l2gre_tunnel_initiator_get(unit, new_info);
...
{
    int rv = BCM_E_NONE;
    bcm_compat6526_bfd_endpoint_info_t *new_endpoint_info = NULL;

    if (endpoint_info != NULL) {
        new_endpoint_info = (bcm_compat6526_bfd_endpoint_info_t *)
                     sal_alloc(sizeof(bcm_compat6526_bfd_endpoint_info_t),
                     "New endpoint_info");
        if (new_endpoint_info == NULL) {
            return BCM_E_MEMORY;
        }
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6526_bfd_endpoint_create(unit, new_endpoint_info);
    ...
    bcm_compat6520_bfd_endpoint_info_t *endpoint_info)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6526_bfd_endpoint_get(unit, endpoint, new_endpoint_info);
    ...
    bcm_compat6520_mirror_destination_t *mirror_dest)
{
    ...
    if (mirror_dest != NULL) {
        new_mirror_dest = (bcm_compat6522_mirror_destination_t*)
            sal_alloc(sizeof(bcm_compat6522_mirror_destination_t), "New destination");
...
{
    int rv = BCM_E_NONE;
    bcm_compat6526_flow_encap_config_t *new_info = NULL;

    if (info != NULL) {
        new_info = (bcm_compat6526_flow_encap_config_t *)
                     sal_alloc(sizeof(bcm_compat6526_flow_encap_config_t),
                     "New info");
        if (new_info == NULL) {
            return BCM_E_MEMORY;
        }
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6526_flow_encap_add(unit, new_info, num_of_fields, field);
    ...
    bcm_flow_logical_field_t *field)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6526_flow_encap_delete(unit, new_info, num_of_fields, field);
    ...
    bcm_flow_logical_field_t *field)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6526_flow_encap_get(unit, new_info, num_of_fields, field);
    ...
    uint32 value)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6526_flow_encap_flexctr_object_set(unit, new_info, value);
    ...
    uint32 *value)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6526_flow_encap_flexctr_object_get(unit, new_info, value);
    ...
    uint32 stat_counter_id)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6526_flow_encap_stat_attach(unit, new_info, num_of_fields, field, stat_counter_id);
    ...
    bcm_flow_logical_field_t *field)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6526_flow_encap_stat_detach(unit, new_info, num_of_fields, field);
    ...
    uint32 *stat_counter_id)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6526_flow_encap_stat_id_get(unit, new_info, num_of_fields, field, stat_counter_id);
    ...
    bcm_compat6520_port_config_t *config)
{
    ...
    if (config != NULL) {
        new_config = (bcm_compat6523_port_config_t *)
                     sal_alloc(sizeof(bcm_compat6523_port_config_t),
                     "New config");
        if (new_config == NULL) {
            return BCM_E_MEMORY;
        }
...
{
    int rv = BCM_E_NONE;
    bcm_compat6521_flow_tunnel_initiator_t *new_info = NULL;

    if (info != NULL) {
        new_info = (bcm_compat6521_flow_tunnel_initiator_t *)
                     sal_alloc(sizeof(bcm_compat6521_flow_tunnel_initiator_t),
                     "New info");
        if (new_info == NULL) {
            return BCM_E_MEMORY;
        }
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_flow_tunnel_initiator_create(unit, new_info, num_of_fields, field);
    ...
    bcm_flow_logical_field_t *field)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6521_flow_tunnel_initiator_get(unit, new_info, num_of_fields, field);
...
/*
 * Function:
 *      _bcm_compat6520in_port_phy_tx_t
 * Purpose:
 *      Convert the bcm_port_phy_tx_t datatype from <=6.5.20 to
 *      SDK 6.5.21+
 * Parameters:
 *      from        - (IN) The <=6.5.20 version of the datatype
 *      to          - (OUT) The SDK 6.5.21+ version of the datatype
...
STATIC void
_bcm_compat6520in_port_phy_tx_t(
    bcm_compat6520_port_phy_tx_t *from,
    bcm_port_phy_tx_t *to)
{
    bcm_port_phy_tx_t_init(to);
    to->pre2 = from->pre2;
    to->pre = from->pre;
    to->main = from->main;
    to->post = from->post;
...
/*
 * Function:
 *      _bcm_compat6520out_port_phy_tx_t
 * Purpose:
 *      Convert the bcm_port_phy_tx_t datatype from SDK 6.5.21+ to
 *      <=6.5.20
 * Parameters:
 *      from        - (IN) The SDK 6.5.21+ version of the datatype
 *      to          - (OUT) The <=6.5.20 version of the datatype
...
_bcm_compat6520out_port_phy_tx_t(
    ...
    bcm_compat6520_port_phy_tx_t *to)
{
    to->pre2 = from->pre2;
    to->pre = from->pre;
    to->main = from->main;
...
/*
 * Function:
 *      bcm_compat6520_port_phy_tx_set
 * Purpose:
 *      Compatibility function for RPC call to bcm_port_phy_tx_set.
 * Parameters:
 *      unit - (IN) Unit number.
 *      port - (IN) 
 *      tx - (IN) 
 ...
 *      BCM_E_XXX
 */
int bcm_compat6520_port_phy_tx_set(
    int unit,
    bcm_port_t port,
    bcm_compat6520_port_phy_tx_t *tx)
{
    int rv = BCM_E_NONE;
    bcm_port_phy_tx_t *new_tx = NULL;

    if (tx != NULL) {
        new_tx = (bcm_port_phy_tx_t *)
                     sal_alloc(sizeof(bcm_port_phy_tx_t),
                     "New tx");
        if (new_tx == NULL) {
            return BCM_E_MEMORY;
        }
        /* Transform the entry from the old format to new one */
        _bcm_compat6520in_port_phy_tx_t(tx, new_tx);
    } else {
        return BCM_E_PARAM;
    }

    /* Call the BCM API with new format */
    rv = bcm_port_phy_tx_set(unit, port, new_tx);
...
/*
 * Function:
 *      bcm_compat6520_port_phy_tx_get
 * Purpose:
 *      Compatibility function for RPC call to bcm_port_phy_tx_get.
 * Parameters:
 *      unit - (IN) Unit number.
 *      port - (IN) 
 *      tx - (OUT) 
 ...
 *      BCM_E_XXX
 */
int bcm_compat6520_port_phy_tx_get(
    int unit,
    bcm_port_t port,
    bcm_compat6520_port_phy_tx_t *tx)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_port_phy_tx_get(unit, port, new_tx);

    /* Transform the entry from the new format to old one */
    _bcm_compat6520out_port_phy_tx_t(new_tx, tx);
    ...
    bcm_compat6520_field_presel_config_t *presel_config)
{
    ...
    if (presel_config != NULL) {
        ...
        bcm_field_presel_config_t_init(new_presel_config);
    } else {
        return BCM_E_PARAM;
    }
