...
{
    int rv = BCM_E_NONE;
    bcm_compat6525_l2_egress_t *new_egr = NULL;

    if (egr != NULL) {
        new_egr = (bcm_compat6525_l2_egress_t *)
                     sal_alloc(sizeof(bcm_compat6525_l2_egress_t),
                     "New egr");
        if (new_egr == NULL) {
            return BCM_E_MEMORY;
        }
    ...
    rv = bcm_compat6525_l2_egress_create(unit, new_egr);
    ...
    bcm_compat6521_l2_egress_t *egr)
{
    ...
    rv = bcm_compat6525_l2_egress_get(unit, encap_id, new_egr);
    ...
    bcm_if_t *encap_id)
{
    ...
    if (egr != NULL) {
        ...
        rv = bcm_compat6525_l2_egress_find(unit, new_egr, encap_id);
