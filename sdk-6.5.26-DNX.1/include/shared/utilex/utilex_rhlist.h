...
{
  /**
   * List itself may be member of list of lists, so it need to have this definition as first in its control structure
   */
    rhentry_t entry;
  /**
   ...
   */
    int sanity;
  /**
   * Flag that enables including unsupported tests in the test lists
   */
    int include_unsupported;
} rhlist_t;
/**
