...
#define _SHR_FABRIC_LINK_UP_SOURCE_MAP_INDICATION_SERDES                    (0x00000001)
#define _SHR_FABRIC_LINK_UP_SOURCE_MAP_INDICATION_SERDES_SET(arg)           (arg |= _SHR_FABRIC_LINK_UP_SOURCE_MAP_INDICATION_SERDES)
#define _SHR_FABRIC_LINK_UP_SOURCE_MAP_INDICATION_SERDES_GET(arg)           ((arg & _SHR_FABRIC_LINK_UP_SOURCE_MAP_INDICATION_SERDES))
...
#define _SHR_FABRIC_LINK_UP_SOURCE_MAP_INDICATION_LOCAL_FAULT               (0x00000002)
...
#define _SHR_FABRIC_LINK_UP_SOURCE_MAP_INDICATION_LOCAL_FAULT_GET(arg)      ((arg & _SHR_FABRIC_LINK_UP_SOURCE_MAP_INDICATION_LOCAL_FAULT) >> 1)
...
#define _SHR_FABRIC_LINK_UP_SOURCE_MAP_INDICATION_REMOTE_FAULT              (0x00000004)
...
#define _SHR_FABRIC_LINK_UP_SOURCE_MAP_INDICATION_REMOTE_FAULT_GET(arg)     ((arg & _SHR_FABRIC_LINK_UP_SOURCE_MAP_INDICATION_REMOTE_FAULT) >> 2)
...
#define _SHR_FABRIC_LINK_UP_SOURCE_MAP_INDICATION_LINK_INTEGRITY             (0x00000008)
#define _SHR_FABRIC_LINK_UP_SOURCE_MAP_INDICATION_LINK_INTEGRITY_SET(arg)    (arg |= _SHR_FABRIC_LINK_UP_SOURCE_MAP_INDICATION_LINK_INTEGRITY)
#define _SHR_FABRIC_LINK_UP_SOURCE_MAP_INDICATION_LINK_INTEGRITY_GET(arg)    ((arg & _SHR_FABRIC_LINK_UP_SOURCE_MAP_INDICATION_LINK_INTEGRITY) >> 3)
#define _SHR_FABRIC_LINK_UP_SOURCE_MAP_INDICATION_LINK_INTEGRITY_CLEAR(arg)  \
        (arg &= (_SHR_FABRIC_LINK_UP_SOURCE_MAP_INDICATION_MASK ^ _SHR_FABRIC_LINK_UP_SOURCE_MAP_INDICATION_LINK_INTEGRITY))
...
typedef enum _shr_dnxf_threshold_type_e {
    ...
    _SHR_FABRIC_MID_MC_LOW_PRIO_DROP_LOW_TH = 32,
    _SHR_FABRIC_MID_MC_LOW_PRIO_DROP_HIGH_TH = 33,
    _SHR_FABRIC_RX_FRAG_GCI_PIPE_TH = 34,
    _SHR_FABRIC_RX_LLFCFC_PIPE_TH = 35,
    _SHR_FABRIC_RX_FIFO_SIZE_PIPE_TH = 36,
    _SHR_FABRIC_MID_FIFO_SIZE_PIPE_TH = 37,
    _SHR_FABRIC_TX_FIFO_SIZE_PIPE_TH = 38,
    _SHR_FABRIC_RX_WFQ_DYNAMIC_WEIGHT_PIPE_TH = 39, /* Dynamic weights*/
    _SHR_FABRIC_MID_WFQ_DYNAMIC_WEIGHT_PIPE_TH = 40,
    _SHR_FABRIC_TX_WFQ_DYNAMIC_WEIGHT_PIPE_TH = 41,
    _SHR_FABRIC_THRESHOLDS_COUNT = 42 /*This value should always be last*/
