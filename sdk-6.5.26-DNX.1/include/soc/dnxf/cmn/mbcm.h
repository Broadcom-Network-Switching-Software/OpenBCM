...
typedef int (
    *mbcm_dnxf_unused_blocks_init_f) (
    int unit);
...
typedef int (
    *mbcm_dnxf_port_valid_block_database_get_f) (
    int unit,
    int block_type,
    int block_number,
    int *enable);
...
typedef shr_error_e(
    *mbcm_dnxf_port_internal_block_power_down_get_f) (
    int unit,
...
typedef struct mbcm_dnxf_functions_s
{
    ...
    mbcm_dnxf_unused_blocks_init_f mbcm_dnxf_unused_blocks_init;
    ...
    mbcm_dnxf_port_valid_block_database_get_f mbcm_dnxf_port_valid_block_database_get;
    ...
    mbcm_dnxf_port_internal_block_power_down_get_f mbcm_dnxf_port_internal_block_power_down_get;
