...
typedef enum
{
    ...
    dnxf_data_port_submodule_signal_quality,
...
int dnxf_data_port_signal_quality_feature_get(
    int unit,
...
typedef enum
{
    dnxf_data_port_signal_quality_define_max_interval_in_cycles,
    dnxf_data_port_signal_quality_define_max_degrade_threshold,
    dnxf_data_port_signal_quality_define_min_degrade_threshold,
    dnxf_data_port_signal_quality_define_max_fail_threshold,
    dnxf_data_port_signal_quality_define_min_fail_threshold,
    dnxf_data_port_signal_quality_define_max_interval,
    dnxf_data_port_signal_quality_define_min_interval,

    
    _dnxf_data_port_signal_quality_define_nof
} dnxf_data_port_signal_quality_define_e;



uint32 dnxf_data_port_signal_quality_max_interval_in_cycles_get(
    int unit);


uint32 dnxf_data_port_signal_quality_max_degrade_threshold_get(
    int unit);


uint32 dnxf_data_port_signal_quality_min_degrade_threshold_get(
    int unit);


uint32 dnxf_data_port_signal_quality_max_fail_threshold_get(
    int unit);


uint32 dnxf_data_port_signal_quality_min_fail_threshold_get(
    int unit);


uint32 dnxf_data_port_signal_quality_max_interval_get(
    int unit);


uint32 dnxf_data_port_signal_quality_min_interval_get(
    int unit);
...
typedef enum
{
    ...
    _dnxf_data_port_signal_quality_table_nof
} dnxf_data_port_signal_quality_table_e;
