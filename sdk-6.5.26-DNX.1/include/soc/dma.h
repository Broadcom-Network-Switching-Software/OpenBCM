...
extern int      soc_cmicx_gen2_dma_drv_init(int unit, soc_cmic_dma_drv_t *drv);
...
#if (SRC_SOC_COMMON_ACTIVATE_UNUSED) || defined(BCM_ESW_SUPPORT) || defined(BCM_CMICM_SUPPORT)
...
#define SOC_DMA_ROM_TX_CHANNEL 6
#else
...
#ifdef BCM_CMICX_SUPPORT
#define SOC_DMA_ROM_RX_CHANNEL 7
#else
...
#if (SRC_SOC_COMMON_ACTIVATE_UNUSED) || defined(BCM_ESW_SUPPORT) ||  defined (BCM_DFE_SUPPORT)|| defined (BCM_PETRA_SUPPORT)
extern sal_vaddr_t soc_cmicx_pktdma_desc_addr_get(int unit, int cmc, int channel);
#endif

extern void     soc_cmicx_gen2_pktdma_desc_endian_set(int unit, int cmc, int channel, int big_endian);
extern void     soc_cmicx_gen2_pktdma_hdr_endian_set(int unit, int cmc, int channel, int big_endian);
extern void     soc_cmicx_gen2_pktdma_data_endian_set(int unit, int cmc, int channel, int big_endian);
extern uint32   soc_cmicx_gen2_pktdma_header_size_get(int unit);
extern uint32   soc_cmicx_gen2_pktdma_cos_ctrl_rx0_get(int unit, int cmc, int channel);
extern uint32   soc_cmicx_gen2_pktdma_cos_ctrl_rx1_get(int unit, int cmc, int channel);
extern uint32   soc_cmicx_gen2_pktdma_cos_ctrl_rx0_reg_addr_get(int unit, int cmc, int channel);
extern uint32   soc_cmicx_gen2_pktdma_cos_ctrl_rx1_reg_addr_get(int unit, int cmc, int channel);
extern uint32   soc_cmicx_gen2_pktdma_cos_ctrl_queue_id_get(int unit, int cmc, int channel, int queue);
extern sal_vaddr_t soc_cmicx_gen2_pktdma_desc_addr_get(int unit, int cmc, int channel);
