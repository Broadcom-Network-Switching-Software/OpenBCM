...
#define CMICX2_SW_INTR_SET(unit, target) do { \
    if (target == CMICM_SW_INTR_UC0) { \
        WRITE_RTS0_MHOST_0_SW_PROG_INTR_SETr(unit, 0x1<<0);   \
    } else if (target == CMICM_SW_INTR_UC1) { \
        WRITE_RTS0_MHOST_1_SW_PROG_INTR_SETr(unit, 0x1<<0);   \
    } else if (target == CMICM_SW_INTR_UC2) { \
        WRITE_RTS1_MHOST_0_SW_PROG_INTR_SETr(unit, 0x1<<0);   \
    } else if (target == CMICM_SW_INTR_UC3) { \
        WRITE_RTS1_MHOST_1_SW_PROG_INTR_SETr(unit, 0x1<<0);   \
    } \
} while (0)
#endif
