...
typedef enum
{
    ...
    DNX_SW_STATE_DNX_IPQ_DB__FIRST,
    DNX_SW_STATE_DNX_IPQ_DB__FIRST_SUB = DNX_SW_STATE_DNX_IPQ_DB__FIRST - 1,
    DNX_SW_STATE_DNX_IPQ_DB__BASE_QUEUES,
    DNX_SW_STATE_DNX_IPQ_DB__BASE_QUEUE_IS_ASYMM,
    DNX_SW_STATE_DNX_IPQ_DB__LAST,
    DNX_SW_STATE_DNX_IPQ_DB__LAST_SUB = DNX_SW_STATE_DNX_IPQ_DB__LAST - 1,
    DNX_SW_STATE_DNX_IPQ_DB__BASE_QUEUES__FIRST,
    DNX_SW_STATE_DNX_IPQ_DB__BASE_QUEUES__FIRST_SUB = DNX_SW_STATE_DNX_IPQ_DB__BASE_QUEUES__FIRST - 1,
    DNX_SW_STATE_DNX_IPQ_DB__BASE_QUEUES__NUM_COS,
    DNX_SW_STATE_DNX_IPQ_DB__BASE_QUEUES__SYS_PORT_REF_COUNTER,
    DNX_SW_STATE_DNX_IPQ_DB__BASE_QUEUES__LAST,
    DNX_SW_STATE_DNX_IPQ_DB__BASE_QUEUES__LAST_SUB = DNX_SW_STATE_DNX_IPQ_DB__BASE_QUEUES__LAST - 1,
