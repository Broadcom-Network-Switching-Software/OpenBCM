...
typedef int (*dnx_dram_db_temperature_monitoring_last_read_set_cb)(
    int unit, uint32 temperature_monitoring_last_read_idx_0, uint32 temperature_monitoring_last_read);


typedef int (*dnx_dram_db_temperature_monitoring_last_read_get_cb)(
    int unit, uint32 temperature_monitoring_last_read_idx_0, uint32 *temperature_monitoring_last_read);
...
typedef struct {
    dnx_dram_db_temperature_monitoring_last_read_set_cb set;
    dnx_dram_db_temperature_monitoring_last_read_get_cb get;
} dnx_dram_db_temperature_monitoring_last_read_cbs;
...
typedef struct {
    ...
    dnx_dram_db_temperature_monitoring_last_read_cbs temperature_monitoring_last_read;
