...
typedef int (*dnx_field_action_sw_db_predefined_set_cb)(
    int unit, uint32 predefined_idx_0, CONST dnx_field_predefined_action_info_t *predefined);


typedef int (*dnx_field_action_sw_db_predefined_get_cb)(
    int unit, uint32 predefined_idx_0, dnx_field_predefined_action_info_t *predefined);


typedef int (*dnx_field_action_sw_db_predefined_field_id_set_cb)(
    int unit, uint32 predefined_idx_0, dbal_fields_e field_id);


typedef int (*dnx_field_action_sw_db_predefined_field_id_get_cb)(
    int unit, uint32 predefined_idx_0, dbal_fields_e *field_id);
...
typedef struct {
    dnx_field_action_sw_db_predefined_field_id_set_cb set;
    dnx_field_action_sw_db_predefined_field_id_get_cb get;
} dnx_field_action_sw_db_predefined_field_id_cbs;


typedef struct {
    dnx_field_action_sw_db_predefined_set_cb set;
    dnx_field_action_sw_db_predefined_get_cb get;
    
    dnx_field_action_sw_db_predefined_field_id_cbs field_id;
} dnx_field_action_sw_db_predefined_cbs;
...
typedef struct {
    ...
    dnx_field_action_sw_db_predefined_cbs predefined;
