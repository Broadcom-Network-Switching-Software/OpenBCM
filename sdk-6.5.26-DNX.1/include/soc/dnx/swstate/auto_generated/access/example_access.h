...
typedef int (*example_bitmap_include_only_example_alloc_bitmap_cb)(
    int unit, uint32 _nof_bits_to_alloc);


typedef int (*example_bitmap_include_only_example_bit_set_cb)(
    int unit, uint32 _bit_num);


typedef int (*example_bitmap_include_only_example_bit_get_cb)(
    int unit, uint32 _bit_num, uint8* result);
...
typedef int (*example_bitmap_variable_access_get_cb)(
    int unit, CONST SHR_BITDCL **bitmap_variable_access);


typedef int (*example_bitmap_variable_access_bit_set_cb)(
    int unit, uint32 _bit_num);


typedef int (*example_bitmap_variable_access_bit_clear_cb)(
    int unit, uint32 _bit_num);


typedef int (*example_bitmap_variable_access_bit_get_cb)(
    int unit, uint32 _bit_num, uint8* result);


typedef int (*example_bitmap_variable_access_bit_range_read_cb)(
    int unit, uint32 sw_state_bmp_first, uint32 result_first, uint32 _range, SHR_BITDCL *result);


typedef int (*example_bitmap_variable_access_bit_range_write_cb)(
    int unit, uint32 sw_state_bmp_first, uint32 input_bmp_first, uint32 _range, SHR_BITDCL *input_bmp);


typedef int (*example_bitmap_variable_access_bit_range_and_cb)(
    int unit, uint32 _first, uint32 _count, SHR_BITDCL *input_bmp);


typedef int (*example_bitmap_variable_access_bit_range_or_cb)(
    int unit, uint32 _first, uint32 _count, SHR_BITDCL *input_bmp);


typedef int (*example_bitmap_variable_access_bit_range_xor_cb)(
    int unit, uint32 _first, uint32 _count, SHR_BITDCL *input_bmp);


typedef int (*example_bitmap_variable_access_bit_range_remove_cb)(
    int unit, uint32 _first, uint32 _count, SHR_BITDCL *input_bmp);


typedef int (*example_bitmap_variable_access_bit_range_negate_cb)(
    int unit, uint32 _first, uint32 _count);


typedef int (*example_bitmap_variable_access_bit_range_clear_cb)(
    int unit, uint32 _first, uint32 _count);


typedef int (*example_bitmap_variable_access_bit_range_set_cb)(
    int unit, uint32 _first, uint32 _count);


typedef int (*example_bitmap_variable_access_bit_range_null_cb)(
    int unit, uint32 _first, uint32 _count, uint8 *result);


typedef int (*example_bitmap_variable_access_bit_range_test_cb)(
    int unit, uint32 _first, uint32 _count, uint8 *result);


typedef int (*example_bitmap_variable_access_bit_range_eq_cb)(
    int unit, SHR_BITDCL *input_bmp, uint32 _first, uint32 _count, uint8 *result);


typedef int (*example_bitmap_variable_access_bit_range_count_cb)(
    int unit, uint32 _first, uint32 _range, int *result);
...
typedef int (*example_sorted_multihead_ll_create_empty_cb)(
    int unit, sw_state_ll_init_info_t *init_info);


typedef int (*example_sorted_multihead_ll_nof_elements_cb)(
    int unit, uint32 ll_head_index, uint32 *nof_elements);


typedef int (*example_sorted_multihead_ll_node_value_cb)(
    int unit, sw_state_ll_node_t node, uint32 *value);


typedef int (*example_sorted_multihead_ll_node_update_cb)(
    int unit, sw_state_ll_node_t node, const uint32 *value);


typedef int (*example_sorted_multihead_ll_next_node_cb)(
    int unit, uint32 ll_head_index, sw_state_ll_node_t node, sw_state_ll_node_t *next_node);


typedef int (*example_sorted_multihead_ll_previous_node_cb)(
    int unit, uint32 ll_head_index, sw_state_ll_node_t node, sw_state_ll_node_t *prev_node);


typedef int (*example_sorted_multihead_ll_remove_node_cb)(
    int unit, uint32 ll_head_index, sw_state_ll_node_t node);


typedef int (*example_sorted_multihead_ll_get_last_cb)(
    int unit, uint32 ll_head_index, sw_state_ll_node_t *node);


typedef int (*example_sorted_multihead_ll_get_first_cb)(
    int unit, uint32 ll_head_index, sw_state_ll_node_t *node);


typedef int (*example_sorted_multihead_ll_print_cb)(
    int unit);


typedef int (*example_sorted_multihead_ll_add_cb)(
    int unit, uint32 ll_head_index, const uint32 *key, const uint32 *value);


typedef int (*example_sorted_multihead_ll_node_key_cb)(
    int unit, sw_state_ll_node_t node, uint32 *key);


typedef int (*example_sorted_multihead_ll_find_cb)(
    int unit, uint32 ll_head_index, sw_state_ll_node_t *node, const uint32 *key, uint8 *found);
...
typedef int (*example_htb_create_cb)(
    int unit, uint32 htb_idx_0, sw_state_htbl_init_info_t *init_info);


typedef int (*example_htb_find_cb)(
    int unit, uint32 htb_idx_0, const int *key, int *value, uint8 *found);


typedef int (*example_htb_insert_cb)(
    int unit, uint32 htb_idx_0, const int *key, const int *value, uint8 *success);


typedef int (*example_htb_get_next_cb)(
    int unit, uint32 htb_idx_0, SW_STATE_HASH_TABLE_ITER *iter, const int *key, const int *value);


typedef int (*example_htb_clear_cb)(
    int unit, uint32 htb_idx_0);


typedef int (*example_htb_delete_cb)(
    int unit, uint32 htb_idx_0, const int *key);
...
typedef int (*example_htb_rh_create_cb)(
    int unit, sw_state_htb_create_info_t *init_info);


typedef int (*example_htb_rh_find_cb)(
    int unit, uint32 table_idx, const int *key, int *value, uint32 *offset);


typedef int (*example_htb_rh_insert_cb)(
    int unit, uint32 table_idx, const int *key, const int *value);


typedef int (*example_htb_rh_replace_cb)(
    int unit, uint32 table_idx, const int *key, const int *value);


typedef int (*example_htb_rh_delete_cb)(
    int unit, uint32 table_idx, const int *key);


typedef int (*example_htb_rh_delete_all_cb)(
    int unit);


typedef int (*example_htb_rh_print_cb)(
    int unit);
...
typedef int (*example_htb_arr_print_cb)(
    int unit, uint32 htb_arr_idx_0);
...
typedef int (*example_occ2_create_cb)(
    int unit, sw_state_occ_bitmap_init_info_t * init_info);


typedef int (*example_occ2_get_next_cb)(
    int unit, uint32 *place, uint8 *found);


typedef int (*example_occ2_get_next_in_range_cb)(
    int unit, uint32 start, uint32 end, uint8 forward, uint8 val, uint32 *place, uint8 *found);


typedef int (*example_occ2_status_set_cb)(
    int unit, uint32 place, uint8 occupied);


typedef int (*example_occ2_is_occupied_cb)(
    int unit, uint32 place, uint8 *occupied);


typedef int (*example_occ2_alloc_next_cb)(
    int unit, uint32 *place, uint8 *found);


typedef int (*example_occ2_clear_cb)(
    int unit);


typedef int (*example_occ2_print_cb)(
    int unit);
...
typedef int (*example_defragmented_chunk_example_offset_unreserve_cb)(
    int unit, uint32 defragmented_chunk_example_idx_0, uint32 slots_in_offset, uint32 piece_offset);


typedef int (*example_defragmented_chunk_example_offset_reserve_cb)(
    int unit, uint32 defragmented_chunk_example_idx_0, uint32 slots_in_offset, uint32 piece_offset);


typedef int (*example_defragmented_chunk_example_defrag_cb)(
    int unit, uint32 defragmented_chunk_example_idx_0, uint32 wanted_size, void *move_cb_additional_info, uint32 *piece_offset);
...
typedef int (*example_params_flags_var_warm_boot_ifdef_set_cb)(
    int unit, int var_warm_boot_ifdef);

#endif  
#ifdef BCM_WARM_BOOT_SUPPORT

typedef int (*example_params_flags_var_warm_boot_ifdef_get_cb)(
    int unit, int *var_warm_boot_ifdef);

#endif  
#ifndef BCM_WARM_BOOT_SUPPORT

typedef int (*example_params_flags_var_warm_boot_ifndef_set_cb)(
    int unit, int var_warm_boot_ifndef);

#endif  
#ifndef BCM_WARM_BOOT_SUPPORT

typedef int (*example_params_flags_var_warm_boot_ifndef_get_cb)(
    int unit, int *var_warm_boot_ifndef);

#endif  
#if defined(BCM_WARM_BOOT_SUPPORT)

typedef int (*example_params_flags_var_warm_boot_if_set_cb)(
    int unit, int var_warm_boot_if);

#endif  
#if defined(BCM_WARM_BOOT_SUPPORT)

typedef int (*example_params_flags_var_warm_boot_if_get_cb)(
    int unit, int *var_warm_boot_if);

#endif  
#if defined(BCM_WARM_BOOT_SUPPORT) && defined(BCM_DNX_SUPPORT) 

typedef int (*example_params_flags_integer_multiple_flags_set_cb)(
    int unit, int integer_multiple_flags);

#endif  
#if defined(BCM_WARM_BOOT_SUPPORT) && defined(BCM_DNX_SUPPORT) 

typedef int (*example_params_flags_integer_multiple_flags_get_cb)(
    int unit, int *integer_multiple_flags);

#endif  

typedef int (*example_params_flags_buff_variable_set_cb)(
    int unit, uint32 buff_variable_idx_0, DNX_SW_STATE_BUFF buff_variable);


typedef int (*example_params_flags_buff_variable_get_cb)(
    int unit, uint32 buff_variable_idx_0, DNX_SW_STATE_BUFF *buff_variable);


typedef int (*example_params_flags_buff_variable_memread_cb)(
    int unit, uint8 *_dst, uint32 _offset, size_t _len);


typedef int (*example_params_flags_buff_variable_memwrite_cb)(
    int unit, const uint8 *_src, uint32 _offset, size_t _len);


typedef int (*example_params_flags_buff_variable_memcmp_cb)(
    int unit, const uint8 *_buff, uint32 _offset, size_t _len, int *cmp_result);


typedef int (*example_params_flags_buff_variable_memset_cb)(
    int unit, uint32 _offset, size_t _len, int _value);
...
typedef int (*example_large_DS_examples_large_htb_create_cb)(
    int unit, uint32 large_htb_idx_0, sw_state_htbl_init_info_t *init_info);


typedef int (*example_large_DS_examples_large_htb_find_cb)(
    int unit, uint32 large_htb_idx_0, const int *key, int *value, uint8 *found);


typedef int (*example_large_DS_examples_large_htb_insert_cb)(
    int unit, uint32 large_htb_idx_0, const int *key, const int *value, uint8 *success);


typedef int (*example_large_DS_examples_large_htb_get_next_cb)(
    int unit, uint32 large_htb_idx_0, SW_STATE_HASH_TABLE_ITER *iter, const int *key, const int *value);


typedef int (*example_large_DS_examples_large_htb_clear_cb)(
    int unit, uint32 large_htb_idx_0);


typedef int (*example_large_DS_examples_large_htb_delete_cb)(
    int unit, uint32 large_htb_idx_0, const int *key);
...
typedef struct {
    example_bitmap_include_only_example_alloc_bitmap_cb alloc_bitmap;
    example_bitmap_include_only_example_bit_set_cb bit_set;
    example_bitmap_include_only_example_bit_get_cb bit_get;
} example_bitmap_include_only_example_cbs;
...
typedef struct {
    example_bitmap_variable_access_get_cb get;
    example_bitmap_variable_access_bit_set_cb bit_set;
    example_bitmap_variable_access_bit_clear_cb bit_clear;
    example_bitmap_variable_access_bit_get_cb bit_get;
    example_bitmap_variable_access_bit_range_read_cb bit_range_read;
    example_bitmap_variable_access_bit_range_write_cb bit_range_write;
    example_bitmap_variable_access_bit_range_and_cb bit_range_and;
    example_bitmap_variable_access_bit_range_or_cb bit_range_or;
    example_bitmap_variable_access_bit_range_xor_cb bit_range_xor;
    example_bitmap_variable_access_bit_range_remove_cb bit_range_remove;
    example_bitmap_variable_access_bit_range_negate_cb bit_range_negate;
    example_bitmap_variable_access_bit_range_clear_cb bit_range_clear;
    example_bitmap_variable_access_bit_range_set_cb bit_range_set;
    example_bitmap_variable_access_bit_range_null_cb bit_range_null;
    example_bitmap_variable_access_bit_range_test_cb bit_range_test;
    example_bitmap_variable_access_bit_range_eq_cb bit_range_eq;
    example_bitmap_variable_access_bit_range_count_cb bit_range_count;
} example_bitmap_variable_access_cbs;
...
typedef struct {
    example_sorted_multihead_ll_create_empty_cb create_empty;
    example_sorted_multihead_ll_nof_elements_cb nof_elements;
    example_sorted_multihead_ll_node_value_cb node_value;
    example_sorted_multihead_ll_node_update_cb node_update;
    example_sorted_multihead_ll_next_node_cb next_node;
    example_sorted_multihead_ll_previous_node_cb previous_node;
    example_sorted_multihead_ll_remove_node_cb remove_node;
    example_sorted_multihead_ll_get_last_cb get_last;
    example_sorted_multihead_ll_get_first_cb get_first;
    example_sorted_multihead_ll_print_cb print;
    example_sorted_multihead_ll_add_cb add;
    example_sorted_multihead_ll_node_key_cb node_key;
    example_sorted_multihead_ll_find_cb find;
} example_sorted_multihead_ll_cbs;
...
typedef struct {
    example_htb_rh_create_cb create;
    example_htb_rh_find_cb find;
    example_htb_rh_insert_cb insert;
    example_htb_rh_replace_cb replace;
    example_htb_rh_delete_cb delete;
    example_htb_rh_delete_all_cb delete_all;
    example_htb_rh_print_cb print;
} example_htb_rh_cbs;
...
typedef struct {
    ...
    example_htb_arr_print_cb print;
} example_htb_arr_cbs;
...
typedef struct {
    example_occ2_create_cb create;
    example_occ2_get_next_cb get_next;
    example_occ2_get_next_in_range_cb get_next_in_range;
    example_occ2_status_set_cb status_set;
    example_occ2_is_occupied_cb is_occupied;
    example_occ2_alloc_next_cb alloc_next;
    example_occ2_clear_cb clear;
    example_occ2_print_cb print;
} example_occ2_cbs;
...
typedef struct {
    ...
    example_defragmented_chunk_example_offset_unreserve_cb offset_unreserve;
    example_defragmented_chunk_example_offset_reserve_cb offset_reserve;
    example_defragmented_chunk_example_defrag_cb defrag;
...
typedef struct {
    example_params_flags_var_warm_boot_ifdef_set_cb set;
    example_params_flags_var_warm_boot_ifdef_get_cb get;
} example_params_flags_var_warm_boot_ifdef_cbs;

#endif  
#ifndef BCM_WARM_BOOT_SUPPORT

typedef struct {
    example_params_flags_var_warm_boot_ifndef_set_cb set;
    example_params_flags_var_warm_boot_ifndef_get_cb get;
} example_params_flags_var_warm_boot_ifndef_cbs;

#endif  
#if defined(BCM_WARM_BOOT_SUPPORT)

typedef struct {
    example_params_flags_var_warm_boot_if_set_cb set;
    example_params_flags_var_warm_boot_if_get_cb get;
} example_params_flags_var_warm_boot_if_cbs;

#endif  
#if defined(BCM_WARM_BOOT_SUPPORT) && defined(BCM_DNX_SUPPORT) 

typedef struct {
    example_params_flags_integer_multiple_flags_set_cb set;
    example_params_flags_integer_multiple_flags_get_cb get;
} example_params_flags_integer_multiple_flags_cbs;

#endif  

typedef struct {
    example_params_flags_buff_variable_set_cb set;
    example_params_flags_buff_variable_get_cb get;
    example_params_flags_buff_variable_memread_cb memread;
    example_params_flags_buff_variable_memwrite_cb memwrite;
    example_params_flags_buff_variable_memcmp_cb memcmp;
    example_params_flags_buff_variable_memset_cb memset;
} example_params_flags_buff_variable_cbs;


typedef struct {
#ifdef BCM_WARM_BOOT_SUPPORT
    
    example_params_flags_var_warm_boot_ifdef_cbs var_warm_boot_ifdef;
#endif  
#ifndef BCM_WARM_BOOT_SUPPORT
    
    example_params_flags_var_warm_boot_ifndef_cbs var_warm_boot_ifndef;
#endif  
#if defined(BCM_WARM_BOOT_SUPPORT)
    
    example_params_flags_var_warm_boot_if_cbs var_warm_boot_if;
#endif  
#if defined(BCM_WARM_BOOT_SUPPORT) && defined(BCM_DNX_SUPPORT) 
    
    example_params_flags_integer_multiple_flags_cbs integer_multiple_flags;
#endif  
    
    example_params_flags_buff_variable_cbs buff_variable;
} example_params_flags_cbs;
...
typedef struct {
    ...
    example_bitmap_include_only_example_cbs bitmap_include_only_example;
    
    example_bitmap_array_cbs bitmap_array;
    
    example_bitmap_variable_access_cbs bitmap_variable_access;
    ...
    example_sorted_multihead_ll_cbs sorted_multihead_ll;
    ...
    example_params_flags_cbs params_flags;
