...
typedef int (*dnx_field_tcam_access_sw_entry_location_hash_create_cb)(
    int unit, uint32 entry_location_hash_idx_0, sw_state_idx_htbl_init_info_t *init_info);
...
typedef int (*dnx_field_tcam_access_sw_entry_location_hash_get_next_cb)(
    int unit, uint32 entry_location_hash_idx_0, SW_STATE_INDEX_HASH_TABLE_ITER *iter, const uint32 *key, const uint32 *data_index);
...
typedef int (*dnx_field_tcam_access_sw_fg_prefix_per_core_set_cb)(
    int unit, uint32 fg_prefix_per_core_idx_0, uint32 fg_prefix_per_core_idx_1, uint32 fg_prefix_per_core);


typedef int (*dnx_field_tcam_access_sw_fg_prefix_per_core_get_cb)(
    int unit, uint32 fg_prefix_per_core_idx_0, uint32 fg_prefix_per_core_idx_1, uint32 *fg_prefix_per_core);


typedef int (*dnx_field_tcam_access_sw_fg_prefix_per_core_alloc_cb)(
    int unit);


typedef int (*dnx_field_tcam_access_sw_cache_install_in_progress_set_cb)(
    int unit, uint8 cache_install_in_progress);


typedef int (*dnx_field_tcam_access_sw_cache_install_in_progress_get_cb)(
    int unit, uint8 *cache_install_in_progress);
...
typedef struct {
    dnx_field_tcam_access_sw_fg_prefix_per_core_set_cb set;
    dnx_field_tcam_access_sw_fg_prefix_per_core_get_cb get;
    dnx_field_tcam_access_sw_fg_prefix_per_core_alloc_cb alloc;
} dnx_field_tcam_access_sw_fg_prefix_per_core_cbs;


typedef struct {
    dnx_field_tcam_access_sw_cache_install_in_progress_set_cb set;
    dnx_field_tcam_access_sw_cache_install_in_progress_get_cb get;
} dnx_field_tcam_access_sw_cache_install_in_progress_cbs;
...
typedef struct {
    ...
    dnx_field_tcam_access_sw_fg_prefix_per_core_cbs fg_prefix_per_core;
    
    dnx_field_tcam_access_sw_cache_install_in_progress_cbs cache_install_in_progress;
