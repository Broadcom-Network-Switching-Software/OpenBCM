...
typedef int (*mdb_em_db_shadow_em_db_alloc_cb)(
    int unit, uint32 shadow_em_db_idx_0, uint32 nof_instances_to_alloc_1);


typedef int (*mdb_em_db_shadow_em_db_create_cb)(
    int unit, uint32 shadow_em_db_idx_0, uint32 shadow_em_db_idx_1, sw_state_htbl_init_info_t *init_info, int key_size, int value_size);


typedef int (*mdb_em_db_shadow_em_db_find_cb)(
    int unit, uint32 shadow_em_db_idx_0, uint32 shadow_em_db_idx_1, const void *key, void *value, uint8 *found);


typedef int (*mdb_em_db_shadow_em_db_insert_cb)(
    int unit, uint32 shadow_em_db_idx_0, uint32 shadow_em_db_idx_1, const void *key, const void *value, uint8 *success);


typedef int (*mdb_em_db_shadow_em_db_get_next_cb)(
    int unit, uint32 shadow_em_db_idx_0, uint32 shadow_em_db_idx_1, SW_STATE_HASH_TABLE_ITER *iter, const void *key, const void *value);


typedef int (*mdb_em_db_shadow_em_db_clear_cb)(
    int unit, uint32 shadow_em_db_idx_0, uint32 shadow_em_db_idx_1);


typedef int (*mdb_em_db_shadow_em_db_delete_cb)(
    int unit, uint32 shadow_em_db_idx_0, uint32 shadow_em_db_idx_1, const void *key);
...
typedef struct {
    mdb_em_db_shadow_em_db_alloc_cb alloc;
