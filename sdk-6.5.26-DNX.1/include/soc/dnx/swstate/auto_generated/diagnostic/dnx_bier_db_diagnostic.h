...
typedef enum {
    ...
    DNX_BIER_DB_INGRESS_INFO,
    DNX_BIER_DB_INGRESS_ACTIVE_INFO,
    DNX_BIER_DB_EGRESS_INFO,
...
int dnx_bier_db_ingress_dump(
    int unit, dnx_sw_state_dump_filters_t filters);

int dnx_bier_db_ingress_active_dump(
    int unit, int active_idx_0, dnx_sw_state_dump_filters_t filters);

int dnx_bier_db_egress_dump(
    int unit, dnx_sw_state_dump_filters_t filters);

int dnx_bier_db_egress_active_dump(
    int unit, int active_idx_0, dnx_sw_state_dump_filters_t filters);
