...
#ifndef __DNX_MDB_EM_DIAGNOSTIC_H__
#define __DNX_MDB_EM_DIAGNOSTIC_H__
...
int mdb_em_db_shadow_em_db_dump(
    int unit, int shadow_em_db_idx_0, int shadow_em_db_idx_1, dnx_sw_state_dump_filters_t filters);
