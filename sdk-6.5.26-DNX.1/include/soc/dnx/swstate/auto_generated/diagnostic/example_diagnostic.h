...
int example_sorted_multihead_ll_dump(
    int unit, dnx_sw_state_dump_filters_t filters);
...
int example_params_flags_dump(
    int unit, dnx_sw_state_dump_filters_t filters);

#ifdef BCM_WARM_BOOT_SUPPORT
int example_params_flags_var_warm_boot_ifdef_dump(
    int unit, dnx_sw_state_dump_filters_t filters);

#endif  
#ifndef BCM_WARM_BOOT_SUPPORT
int example_params_flags_var_warm_boot_ifndef_dump(
    int unit, dnx_sw_state_dump_filters_t filters);

#endif  
#if defined(BCM_WARM_BOOT_SUPPORT)
int example_params_flags_var_warm_boot_if_dump(
    int unit, dnx_sw_state_dump_filters_t filters);

#endif  
#if defined(BCM_WARM_BOOT_SUPPORT) && defined(BCM_DNX_SUPPORT) 
int example_params_flags_integer_multiple_flags_dump(
    int unit, dnx_sw_state_dump_filters_t filters);

#endif  
int example_params_flags_buff_variable_dump(
    int unit, int buff_variable_idx_0, dnx_sw_state_dump_filters_t filters);
