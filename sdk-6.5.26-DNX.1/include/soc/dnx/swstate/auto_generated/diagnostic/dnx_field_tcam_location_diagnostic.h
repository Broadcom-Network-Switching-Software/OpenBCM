...
int dnx_field_tcam_location_sw_priorities_range_dump(
    int unit, int priorities_range_idx_0, dnx_sw_state_dump_filters_t filters);
...
int dnx_field_tcam_location_sw_tcam_handlers_info_prio_list_first_iter_dump(
    int unit, int tcam_handlers_info_idx_0, int prio_list_first_iter_idx_0, dnx_sw_state_dump_filters_t filters);

int dnx_field_tcam_location_sw_tcam_handlers_info_prio_list_last_iter_dump(
    int unit, int tcam_handlers_info_idx_0, int prio_list_last_iter_idx_0, dnx_sw_state_dump_filters_t filters);
