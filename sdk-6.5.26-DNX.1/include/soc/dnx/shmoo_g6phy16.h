...
typedef struct g6phy16_training_bist_info_s
{
    ...
    uint32 ldff_data_pattern[SHMOO_G6PHY16_BIST_NOF_PATTERNS][4];
    uint32 ldff_dbi_pattern[SHMOO_G6PHY16_BIST_NOF_PATTERNS];
    uint32 ldff_edc_pattern[SHMOO_G6PHY16_BIST_NOF_PATTERNS];
    uint32 fifo_depth;
...
typedef struct g6phy16_shmoo_cbi_s
{
    ...
    *g6phy16_phy_reg_modify) (
    ...
    int (
    *g6phy16_drc_bist_conf_set) (
    int unit,
    int drc_ndx,
    const g6phy16_bist_info_t * info);

    int (
    *g6phy16_drc_bist_run) (
    int unit,
    int drc_ndx,
    const g6phy16_bist_info_t * info);

    int (
    *g6phy16_drc_bist_err_cnt) (
    int unit,
    int drc_ndx,
    g6phy16_bist_err_cnt_t * info);

    int (
    *g6phy16_drc_dram_init) (
    int unit,
    int drc_ndx,
    ...
    *g6phy16_drc_modify_mrs) (
    ...
    int (
    *g6phy16_drc_enable_wck2ck_training) (
    int unit,
    int drc_ndx,
    int enable);

    int (
    *g6phy16_drc_enable_write_leveling) (
    int unit,
    int drc_ndx,
    uint32 command_parity_lattency,
    int use_continious_gddr6_dqs,
    int enable);
    ...
    *g6phy16_drc_mpr_en) (
    ...
    int (
    *g6phy16_drc_mpr_load) (
    int unit,
    int drc_ndx,
    uint8 *mpr_pattern);

    int (
    *g6phy16_drc_vendor_info_get) (
    int unit,
    int drc_ndx,
    g6phy16_vendor_info_t * info);

    int (
    *g6phy16_drc_dqs_pulse_gen) (
    int unit,
    int drc_ndx,
    int use_continious_gddr6_dqs);

    int (
    *g6phy16_training_bist_conf_set) (
    int unit,
    int drc_ndx,
    g6phy16_training_bist_info_t * info);

    int (
    *g6phy16_training_bist_err_cnt) (
    int unit,
    int drc_ndx,
    g6phy16_training_bist_err_cnt_t * info);

    int (
    *g6phy16_gddr6_shmoo_drc_dq_byte_pairs_swap_info_get) (
    int unit,
    int drc_ndx,
    int *pairs_were_swapped);

    int (
    *g6phy16_drc_enable_wr_crc) (
    int unit,
    int drc_ndx,
    int enable);

    int (
    *g6phy16_drc_enable_rd_crc) (
    int unit,
    int drc_ndx,
    int enable);

    int (
    *g6phy16_drc_enable_wr_dbi) (
    int unit,
    int drc_ndx,
    int enable);

    int (
    *g6phy16_drc_enable_rd_dbi) (
    int unit,
    int drc_ndx,
    int enable);

    int (
    *g6phy16_drc_force_dqs) (
    int unit,
    int drc_ndx,
    uint32 force_dqs);

    int (
    *g6phy16_drc_soft_reset_drc_without_dram) (
    int unit,
    int drc_ndx);

    int (
    *g6phy16_shmoo_dram_info_access) (
    int unit,
...
typedef int (
    *soc_g6phy16_phy_reg_read_t) (
    int unit,
    int drc_ndx,
    uint32 addr,
    uint32 *data);
typedef int (
    *soc_g6phy16_phy_reg_write_t) (
    int unit,
    int drc_ndx,
    uint32 addr,
    uint32 data);
typedef int (
    *soc_g6phy16_phy_reg_modify_t) (
    int unit,
    int drc_ndx,
    uint32 addr,
    uint32 data,
    uint32 mask);
typedef int (
    *_shmoo_g6phy16_drc_bist_conf_set_t) (
    int unit,
    int drc_ndx,
    const g6phy16_bist_info_t * info);
typedef int (
    *_shmoo_g6phy16_drc_bist_run_t) (
    int unit,
    int drc_ndx,
    const g6phy16_bist_info_t * info);
typedef int (
    *_shmoo_g6phy16_drc_bist_err_cnt_t) (
    int unit,
    int drc_ndx,
    g6phy16_bist_err_cnt_t * info);
typedef int (
    *_shmoo_g6phy16_drc_dram_init_t) (
    int unit,
    int drc_ndx,
    gddr6_dram_init_phase_t phase);
typedef int (
    *_shmoo_g6phy16_drc_pll_set_t) (
    int unit,
    int drc_ndx,
    const g6phy16_drc_pll_t * pll_info);
typedef int (
    *_shmoo_g6phy16_drc_modify_mrs_t) (
    int unit,
    int drc_ndx,
    int channel_index,
    uint32 mr_ndx,
    ...
    uint32 mask);
typedef int (
    *_shmoo_g6phy16_drc_enable_wck2ck_training_t) (
    int unit,
    int drc_ndx,
    int enable);
typedef int (
    *_shmoo_g6phy16_drc_enable_write_leveling_t) (
    int unit,
    int drc_ndx,
    uint32 command_parity_lattency,
    int use_continious_gddr6_dqs,
    int enable);
typedef int (
    *_shmoo_g6phy16_drc_mpr_en_t) (
    int unit,
    int drc_ndx,
    int enable);
typedef int (
    *_shmoo_g6phy16_drc_mpr_load_t) (
    int unit,
    int drc_ndx,
    uint8 *mpr_pattern);
typedef int (
    *_shmoo_g6phy16_drc_vendor_info_get_t) (
    int unit,
    int drc_ndx,
    g6phy16_vendor_info_t * info);
typedef int (
    *_shmoo_g6phy16_drc_dqs_pulse_gen_t) (
    int unit,
    int drc_ndx,
    int use_continious_gddr6_dqs);
typedef int (
    *_shmoo_g6phy16_training_bist_conf_set_t) (
    int unit,
    int drc_ndx,
    g6phy16_training_bist_info_t * info);
typedef int (
    *_shmoo_g6phy16_drc_gddr6_bist_err_cnt_t) (
    int unit,
    int drc_ndx,
    g6phy16_training_bist_err_cnt_t * info);
typedef int (
    *_shmoo_g6phy16_drc_gddr6_dq_byte_pairs_swap_info_get_t) (
    int unit,
    int drc_ndx,
    int *pairs_were_swapped);
typedef int (
    *_shmoo_g6phy16_drc_enable_wr_crc_t) (
    int unit,
    int drc_ndx,
    int enable);
typedef int (
    *_shmoo_g6phy16_drc_enable_rd_crc_t) (
    int unit,
    int drc_ndx,
    int enable);
typedef int (
    *_shmoo_g6phy16_drc_enable_wr_dbi_t) (
    int unit,
    int drc_ndx,
    int enable);
typedef int (
    *_shmoo_g6phy16_drc_enable_rd_dbi_t) (
    int unit,
    int drc_ndx,
    int enable);
typedef int (
    *_shmoo_g6phy16_drc_force_dqs_t) (
    int unit,
    int drc_ndx,
    uint32 force_dqs);
typedef int (
    *_shmoo_g6phy16_drc_soft_reset_drc_without_dram_t) (
    int unit,
    int drc_ndx);
typedef int (
    *_shmoo_g6phy16_drc_dram_info_access_t) (
    int unit,
    g6phy16_shmoo_dram_info_t * shmoo_info);
...
extern int soc_g6phy16_shmoo_interface_cb_register(
    int unit,
    g6phy16_shmoo_cbi_t shmoo_cbi);
extern int soc_g6phy16_calculate_step_size(
    int unit,
    int drc_ndx,
    g6phy16_step_size_t * ssPtr);
extern int soc_g6phy16_shmoo_dram_info_set(
    int unit,
    CONST g6phy16_shmoo_dram_info_t * sdi);
extern int soc_g6phy16_shmoo_phy_cfg_pll(
    int unit,
    int drc_ndx);
extern int soc_g6phy16_shmoo_phy_init(
    int unit,
    int drc_ndx);
extern int soc_g6phy16_shmoo_ctl(
    int unit,
    int drc_ndx,
...
extern int soc_g6phy16_cdr_ctl(
    int unit,
    int drc_ndx,
    int stat,
    g6phy16_cdr_config_param_t * config_param);

int shmoo_g6phy16_restore(
    int unit,
    int drc_ndx,
    g6phy16_shmoo_config_param_t * config_param);
...
int soc_g6phy16_cdr_disable(
    int unit,
    int dram_index);

int soc_g6phy16_cdr_is_enabled(
    int unit,
    int dram_index,
    int *cdr_is_enabled);

int soc_g6phy16_cdr_status(
    int unit,
    int dram_index);
