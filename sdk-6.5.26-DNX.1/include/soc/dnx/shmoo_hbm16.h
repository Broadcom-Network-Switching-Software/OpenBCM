...
int soc_hbm16_shmoo_interface_cb_register(
    int unit,
    hbmc_shmoo_cbi_t shmoo_cbi);
int soc_hbm16_calculate_step_size(
    int unit,
    int hbc_ndx,
    hbm16_step_size_t * ssPtr);
int soc_hbm16_shmoo_dram_info_set(
    int unit,
    CONST hbmc_shmoo_dram_info_t * sdi);
int soc_hbm16_shmoo_phy_cfg_pll(
    int unit,
    int hbc_ndx);
int soc_hbm16_shmoo_phy_init(
    int unit,
    int hbc_ndx,
    int channel);
int soc_hbm16_shmoo_ctl(
    int unit,
    int hbc_ndx,
    int channel,
    int shmoo_type,
...
const hbmc_shmoo_channel_config_param_t *soc_hbm16_shmoo_channel_config_param_metadata_get(
    void);
const hbmc_shmoo_midstack_config_param_t *soc_hbm16_shmoo_midstack_config_param_metadata_get(
    void);

int _hbm16_phy_channel_reset(
    int unit,
    int flags,
    int hbm_ndx,
    int channel);
