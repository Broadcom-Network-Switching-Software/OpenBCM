...
extern int soc_hbm16_midstack_read(
    int unit,
    int hbm_idx,
    soc_reg_t reg,
    int instance,
    uint32 *data);
extern int soc_hbm16_midstack_write(
    int unit,
    int hbm_idx,
    soc_reg_t reg,
    int instance,
    uint32 data);
extern int soc_hbm16_midstack_field_set(
    int unit,
    soc_reg_t reg,
    uint32 *regval,
    soc_field_t field,
    uint32 value);
extern int soc_hbm16_midstack_field_get(
    int unit,
    soc_reg_t reg,
    uint32 regval,
    soc_field_t field,
    uint32 *field_val);
extern int soc_hbm16_midstack_field_size_get(
    int unit,
    soc_reg_t reg,
    soc_field_t field,
    uint32 *field_size);

extern int soc_hbm16_channel_read(
    int unit,
    int hbm_idx,
    int channel,
    soc_reg_t reg,
    int instance,
    uint32 *data);
extern int soc_hbm16_channel_write(
    int unit,
    int hbm_idx,
    int channel,
    soc_reg_t reg,
    int instance,
    uint32 data);
extern int soc_hbm16_channel_field_set(
    int unit,
    soc_reg_t reg,
    uint32 *regval,
    soc_field_t field,
    uint32 value);
extern int soc_hbm16_channel_field_get(
    int unit,
    soc_reg_t reg,
    uint32 regval,
    soc_field_t field,
    uint32 *field_val);
extern int soc_hbm16_channel_field_size_get(
    int unit,
    soc_reg_t reg,
    soc_field_t field,
    uint32 *field_size);
