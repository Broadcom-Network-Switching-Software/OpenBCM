...
typedef uint32(
    *dnx_data_dnx2_arr_prefix_IRPP_IN_LIF_FORMATS___prefix_XL_LEARN_INFO_PMF_DATA_PROTECT_CTX_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_dnx2_arr_prefix_IRPP_IN_LIF_FORMATS___prefix_XL_LEARN_INFO_PMF_DATA_PROTECT_CTX_get_f IRPP_IN_LIF_FORMATS___prefix_XL_LEARN_INFO_PMF_DATA_PROTECT_CTX_get;
...
typedef uint32(
    *dnx_data_dnx2_arr_max_nof_entries_IPPB_EXISTING_ARR_get_f) (
    int unit);


typedef uint32(
    *dnx_data_dnx2_arr_max_nof_entries_IPPB_EXISTING_INCOMING_STRENGTH_ARR_get_f) (
    int unit);


typedef uint32(
    *dnx_data_dnx2_arr_max_nof_entries_IPPB_INCOMING_ARR_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_dnx2_arr_max_nof_entries_IPPB_EXISTING_ARR_get_f IPPB_EXISTING_ARR_get;
    
    dnx_data_dnx2_arr_max_nof_entries_IPPB_EXISTING_INCOMING_STRENGTH_ARR_get_f IPPB_EXISTING_INCOMING_STRENGTH_ARR_get;
    
    dnx_data_dnx2_arr_max_nof_entries_IPPB_INCOMING_ARR_get_f IPPB_INCOMING_ARR_get;
