...
typedef enum
{
    ...
    dnx_data_dnx2_arr_prefix_define_IRPP_IN_LIF_FORMATS___prefix_XL_LEARN_INFO_PMF_DATA_PROTECT_CTX,
...
uint32 dnx_data_dnx2_arr_prefix_IRPP_IN_LIF_FORMATS___prefix_XL_LEARN_INFO_PMF_DATA_PROTECT_CTX_get(
    int unit);
