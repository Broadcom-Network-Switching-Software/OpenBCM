...
typedef enum
{
    ...
    dnx_data_bier_params_define_mcdb_copies_per_entry,
    dnx_data_bier_params_define_nof_bfr_entries,
    dnx_data_bier_params_define_bier_mcdb_size,
...
uint32 dnx_data_bier_params_mcdb_copies_per_entry_get(
    int unit);
...
uint32 dnx_data_bier_params_bier_mcdb_size_get(
    int unit);
