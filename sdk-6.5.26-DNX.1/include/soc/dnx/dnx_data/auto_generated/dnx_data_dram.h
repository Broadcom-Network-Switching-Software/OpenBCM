...
typedef struct
{
    ...
    uint32 field_val;
} dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_t;
...
typedef const dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_t *(
    *dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_get_f) (
    int unit,
    int index);
...
typedef struct
{
    ...
    dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_get_f gddr6_average_read_inflights_leaky_bucket_config_params_get;
    
    dnxc_data_table_info_get_f gddr6_average_read_inflights_leaky_bucket_config_params_info_get;
