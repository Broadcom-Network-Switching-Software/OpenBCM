...
typedef enum
{
    dnx_data_trap_egress_egress_divided_to_erpp_and_etpp,
    dnx_data_trap_egress_fabric_ptp_trap_support,
    dnx_data_trap_egress_deep_editing_trap_support,
    dnx_data_trap_egress_ffc_out_of_bound_trap_support,

    
    _dnx_data_trap_egress_feature_nof
} dnx_data_trap_egress_feature_e;



typedef int(
    *dnx_data_trap_egress_feature_get_f) (
    int unit,
...
typedef struct
{
    ...
    dnx_data_trap_egress_feature_get_f feature_get;
} dnx_data_if_trap_egress_t;
...
typedef struct
{
    ...
    dnx_data_if_trap_egress_t egress;
