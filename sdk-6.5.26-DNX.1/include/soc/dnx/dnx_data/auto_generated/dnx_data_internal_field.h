...
typedef enum
{
    ...
    dnx_data_field_tests_define_mdb_dt_in_ipmf3,
    dnx_data_field_tests_define_mdb_dt_has_key_result_signals,
...
uint32 dnx_data_field_tests_mdb_dt_in_ipmf3_get(
    int unit);


uint32 dnx_data_field_tests_mdb_dt_has_key_result_signals_get(
    int unit);
