...
typedef uint32(
    *dnx_data_failover_path_select_ingress_mc_size_get_f) (
    int unit);
...
typedef uint32(
    *dnx_data_failover_path_select_ing_mc_no_protection_get_f) (
    int unit);
...
typedef uint32(
    *dnx_data_failover_path_select_nof_fec_path_select_banks_in_hw_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_failover_path_select_ingress_mc_size_get_f ingress_mc_size_get;
    ...
    dnx_data_failover_path_select_ing_mc_no_protection_get_f ing_mc_no_protection_get;
    ...
    dnx_data_failover_path_select_nof_fec_path_select_banks_in_hw_get_f nof_fec_path_select_banks_in_hw_get;
...
typedef enum
{
    dnx_data_failover_facility_wcmp_facility_protection_supported,
