...
typedef enum
{
    ...
    dnx_data_dev_init_mem_table_sw_mem_init,
...
const dnx_data_dev_init_mem_sw_mem_init_t * dnx_data_dev_init_mem_sw_mem_init_get(
    int unit,
    int index);
...
shr_error_e dnx_data_dev_init_mem_sw_mem_init_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
const dnxc_data_table_info_t * dnx_data_dev_init_mem_sw_mem_init_info_get(
    int unit);
...
typedef enum
{
    ...
    dnx_data_dev_init_shadow_table_uncacheable_regmem,
...
const dnx_data_dev_init_shadow_uncacheable_regmem_t * dnx_data_dev_init_shadow_uncacheable_regmem_get(
    int unit,
    int index);
...
shr_error_e dnx_data_dev_init_shadow_uncacheable_regmem_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
const dnxc_data_table_info_t * dnx_data_dev_init_shadow_uncacheable_regmem_info_get(
    int unit);
