...
typedef uint32(
    *dnx_data_field_tests_mdb_dt_in_ipmf3_get_f) (
    int unit);


typedef uint32(
    *dnx_data_field_tests_mdb_dt_has_key_result_signals_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_field_tests_mdb_dt_in_ipmf3_get_f mdb_dt_in_ipmf3_get;
    
    dnx_data_field_tests_mdb_dt_has_key_result_signals_get_f mdb_dt_has_key_result_signals_get;
