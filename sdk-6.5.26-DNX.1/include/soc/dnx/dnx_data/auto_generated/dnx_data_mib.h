...
typedef enum
{
    ...
    dnx_data_mib_general_mib_counters_statdma_support,
    dnx_data_mib_general_mib_preempt_counters_support,
...
typedef uint32(
    *dnx_data_mib_general_nof_express_rows_per_cdmib_port_get_f) (
    int unit);


typedef uint32(
    *dnx_data_mib_general_nof_preempt_rows_per_cdmib_port_get_f) (
    int unit);


typedef uint32(
    *dnx_data_mib_general_nof_rows_per_cdmib_port_get_f) (
    int unit);


typedef uint32(
    *dnx_data_mib_general_nof_cdmib_port_per_pm_get_f) (
    int unit);


typedef uint32(
    *dnx_data_mib_general_nof_cdmib_port_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_mib_general_nof_express_rows_per_cdmib_port_get_f nof_express_rows_per_cdmib_port_get;
    
    dnx_data_mib_general_nof_preempt_rows_per_cdmib_port_get_f nof_preempt_rows_per_cdmib_port_get;
    
    dnx_data_mib_general_nof_rows_per_cdmib_port_get_f nof_rows_per_cdmib_port_get;
    
    dnx_data_mib_general_nof_cdmib_port_per_pm_get_f nof_cdmib_port_per_pm_get;
    
    dnx_data_mib_general_nof_cdmib_port_get_f nof_cdmib_port_get;
...
typedef struct
{
    int length;
    char *doc;
} dnx_data_mib_controlled_counters_flexmac_counter_data_t;
...
typedef uint32(
    *dnx_data_mib_controlled_counters_flexmac_mib_general_cnt_len_get_f) (
    int unit);


typedef uint32(
    *dnx_data_mib_controlled_counters_flexmac_mib_rbyt_cnt_len_get_f) (
    int unit);


typedef uint32(
    *dnx_data_mib_controlled_counters_flexmac_mib_rrbyt_cnt_len_get_f) (
    int unit);


typedef uint32(
    *dnx_data_mib_controlled_counters_flexmac_mib_tbyt_cnt_len_get_f) (
    int unit);
...
typedef const dnx_data_mib_controlled_counters_flexmac_counter_data_t *(
    *dnx_data_mib_controlled_counters_flexmac_counter_data_get_f) (
    int unit,
    int counter_id);
...
typedef struct
{
    ...
    dnx_data_mib_controlled_counters_flexmac_mib_general_cnt_len_get_f flexmac_mib_general_cnt_len_get;
    
    dnx_data_mib_controlled_counters_flexmac_mib_rbyt_cnt_len_get_f flexmac_mib_rbyt_cnt_len_get;
    
    dnx_data_mib_controlled_counters_flexmac_mib_rrbyt_cnt_len_get_f flexmac_mib_rrbyt_cnt_len_get;
    
    dnx_data_mib_controlled_counters_flexmac_mib_tbyt_cnt_len_get_f flexmac_mib_tbyt_cnt_len_get;
    ...
    dnx_data_mib_controlled_counters_flexmac_counter_data_get_f flexmac_counter_data_get;
    
    dnxc_data_table_info_get_f flexmac_counter_data_info_get;
