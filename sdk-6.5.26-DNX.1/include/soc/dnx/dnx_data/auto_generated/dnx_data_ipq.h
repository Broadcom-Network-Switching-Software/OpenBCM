...
typedef enum
{
    dnx_data_ipq_general_is_used,
    dnx_data_ipq_general_power_down_supported,

    
    _dnx_data_ipq_general_feature_nof
} dnx_data_ipq_general_feature_e;



typedef int(
    *dnx_data_ipq_general_feature_get_f) (
    int unit,
...
typedef struct
{
    ...
    dnx_data_ipq_general_feature_get_f feature_get;
} dnx_data_if_ipq_general_t;
...
typedef struct
{
    ...
    dnx_data_if_ipq_general_t general;
} dnx_data_if_ipq_t;
