...
} dnx_data_mpls_general_fwd_trap_destination_t;
...
typedef const dnx_data_mpls_general_fwd_trap_destination_t *(
    *dnx_data_mpls_general_fwd_trap_destination_get_f) (
    int unit,
    int index);
...
typedef struct
{
    ...
    dnx_data_mpls_general_fwd_trap_destination_get_f fwd_trap_destination_get;
    
    dnxc_data_table_info_get_f fwd_trap_destination_info_get;
