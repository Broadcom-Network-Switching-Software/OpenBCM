...
typedef enum
{
    ...
    dnx_data_switch_submodule_load_balancing_sim,
    dnx_data_switch_submodule_svtag,
    dnx_data_switch_submodule_feature,
    dnx_data_switch_submodule_wide_data,
...
typedef enum
{
    ...
    dnx_data_switch_load_balancing_define_nof_bits_mpls_protocol_identifier,
    dnx_data_switch_load_balancing_define_seed_configuration_per_pp_port,
    dnx_data_switch_load_balancing_define_swig_base_offline_simulation,
    dnx_data_switch_load_balancing_define_pmf_simulation_support,
...
uint32 dnx_data_switch_load_balancing_nof_bits_mpls_protocol_identifier_get(
    int unit);


uint32 dnx_data_switch_load_balancing_seed_configuration_per_pp_port_get(
    int unit);


uint32 dnx_data_switch_load_balancing_swig_base_offline_simulation_get(
    int unit);


uint32 dnx_data_switch_load_balancing_pmf_simulation_support_get(
    int unit);
...
int dnx_data_switch_load_balancing_sim_feature_get(
    int unit,
...
typedef enum
{
    dnx_data_switch_load_balancing_sim_define_device_enum,

    
    _dnx_data_switch_load_balancing_sim_define_nof
} dnx_data_switch_load_balancing_sim_define_e;



uint32 dnx_data_switch_load_balancing_sim_device_enum_get(
    int unit);
...
typedef enum
{
    ...
    _dnx_data_switch_load_balancing_sim_table_nof
} dnx_data_switch_load_balancing_sim_table_e;
...
typedef enum
{
    ...
    dnx_data_switch_svtag_define_svtag_physical_db,
...
uint32 dnx_data_switch_svtag_svtag_physical_db_get(
    int unit);
...
int dnx_data_switch_wide_data_feature_get(
    int unit,
...
typedef enum
{
    ...
    _dnx_data_switch_wide_data_define_nof
} dnx_data_switch_wide_data_define_e;
...
typedef enum
{
    ...
    _dnx_data_switch_wide_data_table_nof
} dnx_data_switch_wide_data_table_e;
