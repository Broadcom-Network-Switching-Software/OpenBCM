...
char *dbal_field_with_inst_to_string(
    int unit,
    dbal_fields_e field_id,
    uint8 inst_idx,
...
dbal_field_encoded_with_inst_to_string(
    int unit,
    dbal_fields_e encoded_field_id,
    char inst_field_name_str[DBAL_MAX_STRING_LENGTH]);


shr_error_e dbal_field_string_to_inst_idx(
    int unit,
    char *str,
    dbal_fields_e *field_id,
    uint8 *inst_idx);
...
shr_error_e dbal_physical_table_string_to_id_no_error(
    int unit,
    char *str,
...
char *dbal_physical_table_name_no_index(
    int unit,
