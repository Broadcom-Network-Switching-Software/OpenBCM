...
typedef struct
{
    dnx_dbal_formula_offset_cb array_offset_info_cb;
    dnx_dbal_formula_offset_cb entry_offset_info_cb;
    dnx_dbal_formula_offset_cb data_offset_info_cb;
    dnx_dbal_formula_offset_cb block_index_info_cb;
    dnx_dbal_formula_offset_cb group_offset_info_cb;

} dbal_hl_access_cbs_t;
...
shr_error_e dbal_fields_name_update(
    int unit,
    dbal_fields_e field_id,
    char new_field_name[DBAL_MAX_STRING_LENGTH]);

shr_error_e dbal_fields_name_restore(
    int unit,
    dbal_fields_e field_id);
...
shr_error_e dbal_tables_field_size_set(
    int unit,
    dbal_tables_e table_id,
    dbal_fields_e field_id,
    uint8 is_key,
...
shr_error_e dbal_tables_hl_access_field_cbs_set(
    int unit,
    dbal_tables_e table_id,
    dbal_fields_e field_id,
    int result_type_idx,
