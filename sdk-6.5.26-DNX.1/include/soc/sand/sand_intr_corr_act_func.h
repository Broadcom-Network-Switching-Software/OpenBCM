...
typedef enum {
    ...
    SAND_INT_CORR_ACT_MSS_MACSEC_SA_EXPIRY,
    SAND_INT_CORR_ACT_MSD_MACSEC_SA_EXPIRY,
    SAND_INT_CORR_ACT_MSW_MACSEC_SA_EXPIRY,
    SAND_INT_CORR_ACT_KAPS_TECC,
    SAND_INT_CORR_ACT_EPNI_TOTAL_INC_ABOVE_TH_WITH_EBD,
    SAND_INT_CORR_ACT_EPNI_EBD_ERR_INT,
    SAND_INT_CORR_ACT_SIGNAL_QUALITY_ERR_INT,
    SAND_INT_CORR_ACT_RETRAIN_LINK,
...
typedef enum sand_intr_reset_callback_e
{
    ASIC_RESET_NONE,
    ASIC_PON_RESET,
    ASIC_HARD_RESET,
    ...
    ASIC_SOFT_RESET_BLOCKS_ILE,
    ASIC_SOFT_RESET_BLOCKS_FABRIC_ILE
} sand_intr_reset_callback_t;
