...
typedef struct bcm_cosq_fadt_threshold_s {
    ...
    int alpha1;                 /* alpha1 parameter of the FADT threshold */
...
#define BCM_COSQ_DEFICIT_ROUND_ROBIN        0x05       /* Deficit round robin. */
...
#define BCM_COSQ_BW_ROUND_TO_CLOSEST        0x00001000 /* Round up or down to
                                                          the closest number. */
#define BCM_COSQ_BW_SHAPER_DISABLED         0x00002000 /* Indicates if we want
                                                          to disable shaper. */
#define BCM_COSQ_BW_TOTAL                   0x00004000 /* Indicates if we want
                                                          to configure total
                                                          shapers (CIR+EIR). */
...
#define BCM_COSQ_DISCARD_GRANULARITY_1K     0x0008     /* Threshold values are
                                                          expected in 1K
                                                          granularity */
#define BCM_COSQ_DISCARD_CONTINUOUS_DROP_PROBABILITY 0x0010     
...
#define BCM_COSQ_DISCARD_INSTANT_ECT_MARKED 0x80000000 /* WRED curve sets for
                                                          instantaneous ECN
                                                          Marked packets */
#define BCM_COSQ_DISCARD_INSTANT_QUEUE_SIZE 0x1000000  /* Instantaneous  queue
...
/* Flags used for cosq_control_set API */
#define BCM_COSQ_CONTROL_BANDWIDTH_BURST_MAX_UNDER_TRAFFIC (1U << 31) /*  Used for changing max
                                                          burst under traffic */
...
typedef enum bcm_cosq_control_e {
    ...
    bcmCosqControlLatencyEgressAqmFlowId = 226, /* Egress latency AQM - map port and tc
                                           to flow id gport */
    bcmCosqControlEgressAqmFlowId = 226, /* Egress AQM - map port and tc to flow
                                           id gport */
    bcmCosqControlLatencyEgressAqmFlowIdToProfile = 227, /* Egress latency AQM - Map AQM flow id
                                           to AQM profile */
    bcmCosqControlEgressAqmFlowIdToProfile = 227, /* Egress AQM - Map AQM flow id to AQM
                                           profile */
    ...
    bcmCosqControlHeaderTruncateSchedCompensationEnable = 249, /* Enable Header-Truncate compensation */
    bcmCosqControlEgressPortPoolColorLimitEnable = 250, /* Enable Discards based on configured
                                           threshold for Egress port service
                                           pool color discard thresholds */
    bcmCosqControlServicePoolUcSize = 251, /* Set Egress UniCast pool size */
    bcmCosqControlServicePoolMcSize = 252, /* Set Egress MultiCast pool size */
    bcmCosqControlGlobalVoqIngressGranularity = 253, /* Specify the quanta size of in global
                                           VOQ buffers. Global VOQ delta
                                           mnessages will only be sent when a
                                           samples queue crosses a buffer chunk
                                           of size 'qunta'. */
    bcmCosqControlGlobalVoqIngressRefreshPeriod = 254, /* Specify the time interval between
                                           queue depth check between consecutive
                                           VOQ in configured range. */
    bcmCosqControlGlobalVoqPhaseMode = 255, /* Specify whether phase transition is
                                           triggered using API or automatically
                                           using a periodic timer. */
    bcmCosqControlGlobalVoqEgressPhaseTransitionTimeout = 256, /* Specify the phase transition timeout. */
    bcmCosqControlGlobalVoqEgressPhaseStart = 257, /* Trigger a phase transition in egress
                                           side. */
    bcmCosqControlGlobalVoqIngressPhaseStart = 258, /* Trigger a phase transition in ingress
                                           side. */
    bcmCosqControlGlobalVoqEgressNofConsecutiveDown = 259, /* Specify the amount of consecutive
                                           'negative delta' messages to receive
                                           before considering the Global VOQ
                                           trend as not congested. When trend is
                                           'not congested', packets will not be
                                           Droped and CNI indication will not be
                                           sent. */
    bcmCosqControlGlobalVoqDropProbYellowEnable = 260, /* Enable probabilistic drop based on
                                           Global VOQ for traffic colored as
                                           yellow. */
    bcmCosqControlGlobalVoqDropProbYellowThreshold = 261, /* Global VOQ probabilistic drop
                                           threshold. */
    bcmCosqControlGlobalVoqDropYellowEnable = 262, /* Enable drop based on Global VOQ for
                                           traffic colored as yellow. */
    bcmCosqControlGlobalVoqDropYellowThreshold = 263, /* Global VOQ yellow drop threshold. */
    bcmCosqControlGlobalVoqDropProbGreenEnable = 264, /* Enable probabilistic drop based on
                                           Global VOQ for traffic colored as
                                           Green. */
    bcmCosqControlGlobalVoqDropProbGreenThreshold = 265, /* Global VOQ Green probabilistic drop
                                           threshold. */
    bcmCosqControlGlobalVoqDropGreenEnable = 266, /* Enable drop based on Global VOQ for
                                           traffic colored as Green */
    bcmCosqControlGlobalVoqDropGreenThreshold = 267, /* Global VOQ Green drop threshold */
    bcmCosqControlGlobalVoqEcnProbEnable = 268, /* Enable probabilistic ECN marking
                                           based on Global VOQ */
    bcmCosqControlGlobalVoqEcnProbThreshold = 269, /* Global VOQ probabilistic ECN marking
                                           threshold */
    bcmCosqControlGlobalVoqEcnEnable = 270, /* Enable ECN marking based on Global
                                           VOQ. */
    bcmCosqControlGlobalVoqEcnThreshold = 271, /* Global VOQ ECN marking threshold. */
    bcmCosqControlGlobalVoqBinThreshold = 272, /* Global VOQ binning threshold. */
    bcmCosqControlGlobalVoqEgressSuspend = 273, /* Suspend processing of traffic based
                                           on global VOQ */
    bcmCosqControlIngressPortLossyPgXoffOffsetBytes = 274, /*  Set ingress port lossy priority
                                           group offset for XOFF limit. */
    bcmCosqControlIngressPortLossyPgXonOffsetBytes = 275, /*  Set ingress port lossy priority
                                           group offset for XON limit. */
    bcmCosqControlIngressPortLossyPgFloorBytes = 276, /*  Set ingress port lossy priority
                                           group reset floor. */
    bcmCosqControlEgressPortTCSchedSpEnable = 277, /*  Enable strict priority for CIR
                                           element in Egress port TC scheduler. */
    bcmCosqControlEgressShaperEnable = 278, /*  Enable Egress shaper. */
    bcmCosqControlBandwidthBurstMaxEmptyPort = 279 
} bcm_cosq_control_t;

#define BCM_COSQ_CONTROL_STR \
    ...
    "bcmCosqControlFabricConnectMax", \
    "", \
    "", \
    "", \
    "", \
    ...
    "", \
    "", \
    "bcmCosqControlSchedulable", \
    "", \
    "bcmCosqControlPacketLengthAdjust", \
    "bcmCosqControlCongestionManagedQueue", \
    "bcmCosqControlCongestionFeedbackWeight", \
    "bcmCosqControlCongestionSetPoint", \
    "bcmCosqControlCongestionSampleBytesMin", \
    "bcmCosqControlCongestionSampleBytesMax", \
    "bcmCosqControlFabricPortIngressScheduler", \
    ...
    "bcmCosqControlDropLimitBytes", \
    "bcmCosqControlResumeLimitBytes", \
    "bcmCosqControlYellowDropLimitBytes", \
    "bcmCosqControlRedDropLimitBytes", \
    "bcmCosqControlQselOffset", \
    "bcmCosqControlEgressFlowControlThreshold0", \
    "bcmCosqControlEgressFlowControlThreshold1", \
    "bcmCosqControlEgressFlowControlThreshold2", \
    "bcmCosqControlEgressFlowControlThreshold3", \
    "bcmCosqControlFabricPortScheduler", \
    "bcmCosqControlClassMap", \
    "bcmCosqControlSchedulerAdoptAllPriority", \
    ...
    "bcmCosqControlEfPropagation", \
    "bcmCosqControlFlowControlState", \
    "bcmCosqControlHeaderUpdateField", \
    "bcmCosqControlFlowSlowRate1", \
    "bcmCosqControlFlowSlowRate2", \
    ...
    "bcmCosqControlAdmissionTestProfileA", \
    "bcmCosqControlAdmissionTestProfileB", \
    "bcmCosqControlFlowControlEnable", \
    "bcmCosqControlEgressBandwidthEnable", \
    "bcmCosqControlCongestionFeedbackMax", \
    "bcmCosqControlCongestionManagedQueueMin", \
    "bcmCosqControlCongestionManagedQueueMax", \
    "bcmCosqControlCongestionThresholdRandom", \
    "bcmCosqControlIgnoreAnemic", \
    "bcmCosqControlCongestionProxy", \
    "", \
    "", \
    "", \
    "", \
    "bcmCosqControlMulticastPriorityIngressScheduling", \
    ...
    "bcmCosqControlSPPortLimitState", \
    "bcmCosqControlPGPortLimitState", \
    "bcmCosqControlPGPortXoffState", \
    "bcmCosqControlPoolRedDropState", \
    "bcmCosqControlPoolYellowDropState", \
    "bcmCosqControlPoolGreenDropState", \
    "bcmCosqControlIngressPool", \
    "bcmCosqControlEEEQueueThresholdProfileSelect", \
    "bcmCosqControlEEEPacketLatencyProfileSelect", \
    "bcmCosqControlPortQueueUcast", \
    "bcmCosqControlPortQueueMcast", \
    "bcmCosqControlEgressPortPoolYellowLimitBytes", \
    "bcmCosqControlEgressPortPoolRedLimitBytes", \
    "bcmCosqControlSingleCalendarMode", \
    "bcmCosqControlPriorityPropagationEnable", \
    ...
    "bcmCosqControlRedirectQueueSharedLimitBytes", \
    "bcmCosqControlRedirectQueueMinLimitBytes", \
    "bcmCosqControlRedirectSharedDynamicEnable", \
    "bcmCosqControlRedirectQueueLimitEnable", \
    "bcmCosqControlRedirectColorDynamicEnable", \
    "bcmCosqControlRedirectColorEnable", \
    "bcmCosqControlUCDropLimitAlpha", \
    "bcmCosqControlMCDropLimitAlpha", \
    "bcmCosqControlIngressPoolLimitBytes", \
    "bcmCosqControlIngressHeadroomPoolLimitBytes", \
    "bcmCosqControlIngressHeadroomPool", \
    "bcmCosqControlPFCBackpressureEnable", \
    "bcmCosqControlE2ECCTransmitEnable", \
    ...
    "bcmCosqControlEgressPoolYellowSharedLimitBytes", \
    "bcmCosqControlEgressPoolYellowResumeLimitBytes", \
    "bcmCosqControlEgressPoolRedSharedLimitBytes", \
    "bcmCosqControlEgressPoolRedResumeLimitBytes", \
    "bcmCosqControlOCBOnly", \
    "bcmCosqControlDefaultInvalidQueue", \
    "bcmCosqControlIngressPortDropTpid1", \
    "bcmCosqControlIngressPortDropTpid2", \
    "bcmCosqControlIngressPortDropUntaggedPCP", \
    "bcmCosqControlIngressLatencyEnable", \
    "bcmCosqControlIngressPortDropTpid3", \
    "bcmCosqControlIngressPortDropTpid4", \
    "bcmCosqControlIngressPortDropIgnoreIpDscp", \
    "bcmCosqControlIngressPortDropIgnoreMplsExp", \
    "bcmCosqControlIngressPortDropIgnoreInnerTag", \
    "bcmCosqControlIngressPortDropIgonreOuterTag", \
    "bcmCosqControlEgressUCQueueGroupMinEnable", \
    "bcmCosqControlEgressUCQueueGroupSharedLimitEnable", \
    "bcmCosqControlEgressUCQueueGroupMinLimitBytes", \
    "bcmCosqControlEgressUCQueueGroupSharedLimitBytes", \
    "bcmCosqControlEgressUCQueueGroupSharedDynamicEnable", \
    "bcmCosqControlAlternateStoreForward", \
    "bcmCosqControlEgressUCQueueGroupDropLimitAlpha", \
    "bcmCosqControlOcbFadtDropEnable", \
    "bcmCosqControlEgressPriorityOverCast", \
    "bcmCosqControlEgressMCQueueGroupMinLimitBytes", \
    "bcmCosqControlEgressMCQueueGroupMinEnable", \
    "bcmCosqControlIsHighPriority", \
    "bcmCosqControlIsFabric", \
    "bcmCosqControlMulticastQueueToPdSpMap", \
    "bcmCosqControlSourcePortSchedCompensationEnable", \
    "bcmCosqControlIngressPortPGResetOffsetBytes", \
    "bcmCosqControlIngressPublicPoolLimitBytes", \
    ...
    "bcmCosqControlObmDiscardLimit", \
    "bcmCosqControlObmMinLimit", \
    "bcmCosqControlPgVsqFadtFcEnable", \
    "bcmCosqControlIngressPortPGGlobalHeadroomEnable", \
    "bcmCosqControlEgressTCGCirSpEnable", \
    "bcmCosqControlLatencyCounterEnable", \
    ...
    "bcmCosqControlLatencyTrackDropPacket", \
    "bcmCosqControlLatencyEgressCounterCommand", \
    "bcmCosqControlLatencyBinThreshold", \
    "bcmCosqControlLatencyTrack", \
    "bcmCosqControlIsInDram", \
    "bcmCosqControlGroup", \
    ...
    "bcmCosqControlLatencyVoqRejectBinThreshold", \
    "bcmCosqControlLatencyVoqRejectFilterMulticast", \
    "bcmCosqControlLatencyVoqRejectFilterSniff", \
    "bcmCosqControlMirrorOnDropAgingGlobal", \
    "bcmCosqControlMirrorOnDropAgingVoq", \
    "bcmCosqControlMirrorOnDropAgingVsq", \
    "bcmCosqControlFlush", \
    "bcmCosqControlPhantomQueueThreshold", \
    "bcmCosqControlEgrRateMeasurementInterval", \
    "bcmCosqControlEgrRateMeasurementWeight", \
    "bcmCosqControlShaperPacketMode", \
    "bcmCosqControlEgressPoolMCSharedLimitEntries", \
    "bcmCosqControlEgressMCQueueSharedLimitEntries", \
    "bcmCosqControlEgressRQESharedLimitBytes", \
    "bcmCosqControlEgressMCQueueDataBufferSharedLimitBytes", \
    "bcmCosqControlEgressMCQueueDataBufferRedLimit", \
    "bcmCosqControlEgressMCQueueEntryRedLimit", \
    "bcmCosqControlEgressMCQueueDataBufferYellowLimit", \
    "bcmCosqControlEgressMCQueueEntryYellowLimit", \
    "bcmCosqControlOcbRangeSelectThreshold", \
    "bcmCosqLowRateVoqConnectorFactor", \
    "bcmCosqControlIngressPortDropPortProfileMap", \
    "bcmCosqControlE2ETCGCirSpEnable", \
    "bcmCosqControlLatencyDropProbEnable", \
    ...
    "bcmCosqControlEgressAqmFlowId", \
    "bcmCosqControlEgressAqmFlowIdToProfile", \
    ...
    "bcmCosqControlLatencyEcnInstantThreshold", \
    "bcmCosqControlIngressMinLowPriority", \
    "bcmCosqControlAdtPriGroup", \
    "bcmCosqControlEgressPoolAdtHighPriAlpha", \
    ...
    "bcmCosqControlAdtLowPriMonitorPool", \
    "bcmCosqControlEgressPoolToIngressPoolMap", \
    "bcmCosqControlEgressPoolMCSharedEntryLimit", \
    "bcmCosqControlPolicerTCSMThresh", \
    "bcmCosqControlHeaderTruncateSchedCompensationEnable", \
    "bcmCosqControlEgressPortPoolColorLimitEnable", \
    "bcmCosqControlServicePoolUcSize", \
    "bcmCosqControlServicePoolMcSize", \
    "bcmCosqControlGlobalVoqIngressGranularity", \
    "bcmCosqControlGlobalVoqIngressRefreshPeriod", \
    "bcmCosqControlGlobalVoqPhaseMode", \
    "bcmCosqControlGlobalVoqEgressPhaseTransitionTimeout", \
    "bcmCosqControlGlobalVoqEgressPhaseStart", \
    "bcmCosqControlGlobalVoqIngressPhaseStart", \
    "bcmCosqControlGlobalVoqEgressNofConsecutiveDown", \
    "bcmCosqControlGlobalVoqDropProbYellowEnable", \
    "bcmCosqControlGlobalVoqDropProbYellowThreshold", \
    "bcmCosqControlGlobalVoqDropYellowEnable", \
    "bcmCosqControlGlobalVoqDropYellowThreshold", \
    "bcmCosqControlGlobalVoqDropProbGreenEnable", \
    "bcmCosqControlGlobalVoqDropProbGreenThreshold", \
    "bcmCosqControlGlobalVoqDropGreenEnable", \
    "bcmCosqControlGlobalVoqDropGreenThreshold", \
    "bcmCosqControlGlobalVoqEcnProbEnable", \
    "bcmCosqControlGlobalVoqEcnProbThreshold", \
    "bcmCosqControlGlobalVoqEcnEnable", \
    "bcmCosqControlGlobalVoqEcnThreshold", \
    "bcmCosqControlGlobalVoqBinThreshold", \
    "bcmCosqControlGlobalVoqEgressSuspend", \
    "bcmCosqControlIngressPortLossyPgXoffOffsetBytes", \
    "bcmCosqControlIngressPortLossyPgXonOffsetBytes", \
    "bcmCosqControlIngressPortLossyPgFloorBytes", \
    "bcmCosqControlEgressPortTCSchedSpEnable", \
    "bcmCosqControlEgressShaperEnable", \
    "bcmCosqControlBandwidthBurstMaxEmptyPort" 
...
#define BCM_COSQ_VOQ_CONNECTOR_GPORT_F_VIRTUAL 0x00000004 /* Virtual flow VOQ
                                                          connector */
...
#define BCM_COSQ_RATE_CLASS_CREATE_ATTR_MULTICAST 0x8        /* rate class for FMQs
                                                          (Fabric Multicast
                                                          Queues) */
#define BCM_COSQ_RATE_CLASS_CREATE_ATTR_PUSH_QUEUE 0x10       /* rate class to be used
                                                          for push queues */
...
#define BCM_COSQ_DELAY_TOLERANCE_PUSH_QUEUE 0x20       /* Specifies that the
                                                          profile is for push
                                                          queue. */
#define BCM_COSQ_DELAY_TOLERANCE_DELETE     0x40       /* Specifies that the
                                                          profile is for delete. */
...
#define BCM_COSQ_DELAY_TOLERANCE_PRESET_ATTR_F_PUSH_QUEUE 0x10       /* Used to get parameters
                                                          for push queue
                                                          profile. */
#define BCM_COSQ_DELAY_TOLERANCE_PRESET_ATTR_F_DELETE 0x20       /* Used to get parameters
                                                          for delete profile. */
...
/* Flag values for cosq_src_vsqs_gport_add API */
#define BCM_COSQ_SRC_VSQS_GPORT_WITH_ID 0x00000001 /*  Allocate with ID */
...
typedef enum bcm_cosq_gport_type_e {
    ...
    bcmCosqGportTypeSchedSharedShaper7 = 127, /* Element at index 7 inside shared
                                           shaper */
    bcmCosqGportTypePortTCSched = 128   /* Port TC Sched in Egress transmit
                                           hierarchy */
...
typedef enum bcm_cosq_stat_e {
    ...
    bcmCosqStatEgressPoolSharedUCBytesCurrent = 122, /* Current value of egress service pool
                                           total number of cells in use by all
                                           the ports in bytes. */
    bcmCosqStatEgressPoolSharedMCBytesCurrent = 123, /* Current value of egress service pool
                                           total number of multicast cell
                                           entries in use by all the ports in
                                           bytes. */
    ...
    bcmCosqStatSourcePortDroppedBytes = 130, /* Number of bytes dropped per Source
                                           Port */
    bcmCosqStatEgressPortPoolUCTotalBytesCurrent = 131, /* Per port service pool unicast packet
                                           total buffer use count. */
    bcmCosqStatObmRxBytes = 132,        /* Per port OBM received bytes. */
    bcmCosqStatObmRxPackets = 133,      /* Per port OBM received packets. */
    bcmCosqStatSamplingPortTxBytes = 134, /* Port TX bytes for sampling. */
    bcmCosqStatSamplingUcQueueTxBytes = 135, /* UC queue TX bytes for sampling. */
    bcmCosqStatMaxCount = 136           /* this should be the last one. */
} bcm_cosq_stat_t;
...
#define BCM_COSQ_BST_STAT_CACHE_BYPASS  0x1        /* Bypass cache and get BST
                                                      stats from HW. */
#define BCM_COSQ_BST_STAT_CLEAR_ON_READ BCM_COSQ_STAT_CLEAR /* Enable clear on read of
                                                      BST stats. */

/* BST Tracing statistics resources type enumerations. */
typedef enum bcm_bst_stat_id_e {
    ...
    bcmBstStatIdUCQueueGroup = 15,      /* BST Tracing resource for unicast
                                           queue group */
    bcmBstStatIdRqeQueuePacket = 16,    /* RQE queue size on packet */
    bcmBstStatIdRqePoolPacket = 17,     /* RQE pool size on packet */
    bcmBstStatIdMaxCount = 18           /* Must be the last. Not a usable value. */
} bcm_bst_stat_id_t;
...
typedef enum bcm_cosq_control_range_type_e {
    ...
    bcmCosqRangeGlobalVoqActive = 14    /* Range of VOQs that participate in the
                                           Global VOQ mechanism. */
...
#define BCM_COSQ_RSRC_ALLOC_NO_COLOR    0x0002     
...
typedef enum bcm_cosq_resource_e {
    ...
    bcmResourceDataBuffers = 8          /* Resource data buffers. */
} bcm_cosq_resource_t;
...
typedef enum bcm_cosq_icgm_resource_stat_type_e {
    ...
    bcmCosqICgmCurrTotalBytes = 18,     /* Current total bytes size */
    bcmCosqICgmAvrgTotalBytes = 19,     /* Average total bytes size */
    bcmCosqICgmCurrOcbBytes = 20,       /* Current OCB bytes size */
    bcmCosqICgmCurrOcbBuffers = 21,     /* Current OCB buffers size */
    bcmCosqICgmMaxGrntdBytes = 22,      /* Maximal bytes size in guaranteed
                                           space */
    bcmCosqICgmMaxHdrmBytes = 23        /* Maximal bytes size in headroom space */
...
typedef struct bcm_cosq_icgm_resource_stat_key_s {
    bcm_gport_t gport;                  /* gport value */
    bcm_cos_queue_t cosq;               /* Index of specific queue to get
                                           statistics from */
    uint32 flags;                       /* flags */
    uint32 index;                       /* statistics index */
...
/* ICGM Index creation macros. */
#define BCM_COSQ_ICGM_STAT_INDEX_POOL_SET(pool_id)  _SHR_COSQ_ICGM_STAT_INDEX_POOL_SET(pool_id) 
...
typedef enum bcm_cosq_gport_fadt_threshold_type_e {
    ...
    bcmCosqFadtEgressReceiveDrop = 3,   /* Egress receive admission drop
                                           settings */
    bcmCosqFadtEgressEnqueueDrop = 4,   /* Egress enqueue admission drop
                                           settings */
    bcmCosqFadtEgressEnqueueFcHigh = 5, /* Egress enqueue admission FC high
                                           settings */
    bcmCosqFadtEgressEnqueueFcLow = 6,  /* Egress enqueue admission FC low
                                           settings */
    bcmCosqFadtEgressEnqueueFcPfcOn = 7, /* Egress enqueue admission FC pfc on
                                           settings */
    bcmCosqFadtEgressEnqueueFcPfcOff = 8 /* Egress enqueue admission FC pfc off
                                           settings */
...
typedef enum bcm_cosq_tas_control_e {
    ...
    bcmCosqTASControlTASPTPLock = 6,    /* Indicate the PTP time is locked or
                                           ...
                                           basis. */
    bcmCosqTASControlTASReset = 7,      /* Reset the TAS. */
    bcmCosqTASCountrolCount = 8         /* This should be the last one. */
...
typedef struct bcm_cosq_tas_profile_s {
    ...
    uint32 ptp_cycle_time_upper;        /* Specify cycle time in ns (upper 32
                                           bits for devices supporting 64 bit
                                           cycle time). */
...
/* flag values for static threshold setting */
#define BCM_COSQ_STATIC_THRESHOLD_EGRESS    0x00000001 /* egress flag for static
                                                          threshold */
...
#define BCM_COSQ_TH_INDEX_CAST_PRIO_FWDACT_DP_SET(cast, priority, forward_action, dp)  _SHR_COSQ_TH_INDEX_CAST_PRIO_FWDACT_DP_SET(cast, priority, forward_action, dp) 
...
#define BCM_COSQ_TH_INDEX_CAST_SET(cast)    _SHR_COSQ_TH_INDEX_CAST_SET(cast) 
...
typedef enum bcm_cosq_profile_type_e {
    ...
    bcmCosqProfilePfc = 4,              /*  Profile for setting per-PFC priority
                                           flow control enable and COS map
                                           configuration. */
    bcmCosqProfileDynamicEcnThreshold = 5, /*  Profile for dynamic ECN threshold. */
    bcmCosqProfileCount = 6             /* This should be the last one */
...
/* Dynamic ECN threshold flags. */
#define BCM_COSQ_DYNAMIC_ECN_THRESHOLD_ENABLE 0x00000001 /* Enable dynamic ECN. */

/* Dynamic ECN threshold information. */
typedef struct bcm_cosq_dynamic_ecn_threshold_s {
    uint32 flags;   /* BCM_COSQ_DYNAMIC_ECN_THRESHOLD_XXX flags. */
    uint32 offset;  /* Dynamic ECN threshold offset in bytes. */
    uint32 floor;   /* Minimum value for dynamic ECN threshold in bytes. */
} bcm_cosq_dynamic_ecn_threshold_t;

/* Initialize bcm_cosq_dynamic_ecn_threshold_t. */
extern void bcm_cosq_dynamic_ecn_threshold_t_init(
    bcm_cosq_dynamic_ecn_threshold_t *threshold);

/* Dynamic ECN profile options. */
#define BCM_COSQ_DYNAMIC_ECN_PROFILE_OPTIONS_WITH_ID 0x00000001 /* Create a dynamic ECN
                                                          profile with ID. */

#ifndef BCM_HIDE_DISPATCHABLE

/* Create a dynamic ECN threshold profile. */
extern int bcm_cosq_dynamic_ecn_threshold_profile_create(
    int unit, 
    uint32 options, 
    int *profile_id);

/* Destroy a dynamic ECN threshold profile. */
extern int bcm_cosq_dynamic_ecn_threshold_profile_destroy(
    int unit, 
    int profile_id);

/* Set dynamic ECN threshold information. */
extern int bcm_cosq_dynamic_ecn_threshold_set(
    int unit, 
    int profile_id, 
    bcm_cosq_object_id_t *object_id, 
    bcm_cosq_dynamic_ecn_threshold_t *threshold);

/* Get dynamic ECN threshold information. */
extern int bcm_cosq_dynamic_ecn_threshold_get(
    int unit, 
    int profile_id, 
    bcm_cosq_object_id_t *object_id, 
    bcm_cosq_dynamic_ecn_threshold_t *threshold);
...
/* Setup COS queue to scheduling queue mapping */
extern int bcm_cosq_port_schedq_mapping_set(
    int unit, 
    bcm_port_t port, 
    int array_size, 
    bcm_cosq_mapping_t *cosq_mapping_arr);

/* Get COS queue to scheduling queue mapping */
extern int bcm_cosq_port_schedq_mapping_get(
    int unit, 
    bcm_port_t port, 
    int array_size, 
    bcm_cosq_mapping_t *cosq_mapping_array, 
    int *count);
...
typedef enum bcm_cosq_pfc_deadlock_control_e {
    bcmCosqPFCDeadlockDetectionAndRecoveryEnable = 0, /* Enable/disable PFC deadlock detection
                                           and recovery per-port per-PFC
                                           priority. */
    bcmCosqPFCDeadlockRecoveryOccurrences = 1, /* Accumulated time a port stays in pfc
                                           deadlock state per-PFC priority [in
                                           milliseconds]. */
    bcmCosqPFCDeadlockDetectionTimer = 2, /* PFC deadlock Hardware timer in
                                           milliseconds. */
    bcmCosqPFCDeadlockRecoveryTimer = 3, /* Software recovery timer in multiples
                                           of 100 milliseconds. */
    bcmCosqPFCDeadlockTimerGranularity = 4, /* See \ref PFC_DEADLOCK_TIMER_table for
                                           valid values. */
    bcmCosqPFCDeadlockRecoveryManual = 5, /* Manual recovery. */
    bcmCosqPFCDeadlockControlTypeCount = 6 
...
/* Shared shaper order */
typedef enum bcm_cosq_scheduler_gport_shared_order_e {
    bcmCosqSchedulerGportSharedOrderNone = 0, /* Not relevant */
    bcmCosqSchedulerGportSharedOrderClFq = 1, /* Dual shaper with flow order of CL-FQ */
    bcmCosqSchedulerGportSharedOrderClCl = 2, /* Dual shaper with flow order of CL-CL */
    bcmCosqSchedulerGportSharedOrderFqCl = 3, /* Dual shaper with flow order of FQ-CL */
    bcmCosqSchedulerGportSharedOrderClFqClFq = 5, /* Quad, Octa shaper with flow order of
                                           CL-FQ-CL-FQ */
    bcmCosqSchedulerGportSharedOrderClClFqFq = 6, /* Quad, Octa shaper with flow order of
                                           CL-CL-FQ-FQ */
    bcmCosqSchedulerGportSharedOrderClFqFqCl = 7, /* Quad, Octa shaper with flow order of
                                           CL-FQ-FQ-CL */
    bcmCosqSchedulerGportSharedOrderFqClFqCl = 8, /* Quad, Octa shaper with flow order of
                                           FQ-CL-FQ-CL */
    bcmCosqSchedulerGportSharedOrderFqFqClCl = 9, /* Quad, Octa shaper with flow order of
                                           FQ-FQ-CL-CL */
    bcmCosqSchedulerGportSharedOrderFqClClFq = 10 /* Quad, Octa shaper with flow order of
                                           FQ-CL-CL-FQ */
} bcm_cosq_scheduler_gport_shared_order_t;
...
typedef struct bcm_cosq_scheduler_gport_params_s {
    ...
    bcm_cosq_scheduler_gport_shared_order_t shared_order; /* Shared shaper order. */
} bcm_cosq_scheduler_gport_params_t;

/* Initialize scheduling element parameters structure */
extern void bcm_cosq_scheduler_gport_params_t_init(
...
#define BCM_COSQ_GENERIC_KEY_TC_DP_SET(key, tc, dp)  _SHR_COSQ_GENERIC_KEY_TC_DP_SET(key, tc, dp) 
#define BCM_COSQ_GENERIC_KEY_TC_DP_TC_GET(key)  _SHR_COSQ_GENERIC_KEY_TC_DP_TC_GET(key) 
#define BCM_COSQ_GENERIC_KEY_TC_DP_DP_GET(key)  _SHR_COSQ_GENERIC_KEY_TC_DP_DP_GET(key) 
#define BCM_COSQ_GENERIC_KEY_PRIO_SET(key, prio)  _SHR_COSQ_GENERIC_KEY_PRIO_SET(key, prio) 
#define BCM_COSQ_GENERIC_KEY_PRIO_GET(key)  _SHR_COSQ_GENERIC_KEY_PRIO_GET(key) 
...
typedef enum bcm_cosq_generic_control_e {
    ...
    bcmCosqGenericControlLatencyVoqRejectMinThreshold = 2, /* Generic control latency reject
                                           threshold. */
    bcmCosqGenericControlOcbGlobalDropPriorityMap = 3, /* Generic control to configure priority
                                           per OCB global drop profile, TC, DP. */
    bcmCosqGenericControlOcbGlobalDropThreshold = 4, /* Generic control to configure OCB
                                           global drop thresholds. */
    bcmCosqGenericControlLatencyEcnMinSize = 5 /* Minimal queue size for latency-based
                                           ECN marking. */
...
typedef enum bcm_cosq_control_track_mode_e {
    ...
    bcmCosqControlLatencyTrackOutPortTc = 2, 
...
typedef struct bcm_cosq_ebst_data_entry_s {
    ...
    bcm_cosq_control_drop_limit_alpha_value_t alpha; /* Alpha value for calculating the
...
#define BCM_COSQ_MOD_INGRESS_LIMIT_DROP_ENABLE 0x00000001 /* Enable mirror on drop
                                                          for ingress limit
                                                          drop. */
#define BCM_COSQ_MOD_POOL_LIMIT_DROP_ENABLE 0x00000002 /* Enable mirror on drop
                                                          for all shared pool
                                                          limit drop covering
                                                          both ingress and
                                                          egress. */
#define BCM_COSQ_MOD_EGRESS_PORT_POOL_DROP_ENABLE 0x00000004 /* Enable mirror on drop
                                                          for egress port
                                                          service pool limit
                                                          drop */
#define BCM_COSQ_MOD_EGRESS_QUEUE_DROP_ENABLE 0x00000008 /* Enable mirror on drop
                                                          for egress queue
                                                          shared limit drop. */
#define BCM_COSQ_MOD_EGRESS_WRED_DROP_ENABLE 0x00000010 /* Enable mirror on drop
                                                          for WRED drop. */
...
typedef struct bcm_cosq_mod_profile_s {
    ...
    uint16 percent_75_100;  /* Sampling probability when current filled cells in
                               ...
                               maximum cell number. */
    uint8 enable;           /* Mirror on Drop enable/disable. */
    uint32 flags;           /* Flags defined by BCM_COSQ_MOD_XXX. */
...
/* COSQ device level information. */
typedef struct bcm_cosq_device_info_s {
    uint16 max_pkt_size;            /* Maximum packet size in bytes */
    uint16 pkt_header_size;         /* Packet header size in bytes */
    uint16 jumbo_pkt_size;          /* Jumbo packet size in bytes */
    uint16 default_mtu;             /* Default mtu size in bytes */
    uint32 cell_size;               /* Cell size in bytes */
    uint32 cell_num;                /* Buffer size in cells */
    uint8 buffer_num;               /* Buffer number */
    uint16 service_pool_num;        /* Service pool number */
    uint16 port_priority_group_num; /* Port priority group number */
    uint8 uc_queue_num;             /* Unicast queue number supported for non
                                       CPU ports */
    uint8 mc_queue_num;             /* Multicast queue number supported for non
                                       CPU ports */
    uint8 cpu_queue_num;            /* Queue number supported for CPU port where
                                       only multicast queues are supported */
} bcm_cosq_device_info_t;

/* Initialize the structure of COSQ device level information. */
extern void bcm_cosq_device_info_t_init(
    bcm_cosq_device_info_t *info);

#ifndef BCM_HIDE_DISPATCHABLE

/* Get COSQ device level information. */
extern int bcm_cosq_device_info_get(
    int unit, 
    bcm_cosq_device_info_t *info);

#endif /* BCM_HIDE_DISPATCHABLE */

/* COSQ Global VOQ information. */
typedef struct bcm_cosq_global_voq_info_s {
    bcm_port_t tc_profile;  /* TC profile */
    bcm_port_t bin_profile; /* Binning profile */
} bcm_cosq_global_voq_info_t;

/* Initialize COSQ Global VOQ information. */
extern void bcm_cosq_global_voq_info_t_init(
    bcm_cosq_global_voq_info_t *info);

#ifndef BCM_HIDE_DISPATCHABLE

/* Set Global VOQ aggregation mapping for a specific port */
extern int bcm_cosq_global_voq_set(
    int unit, 
    uint32 flags, 
    bcm_port_t port, 
    bcm_cosq_global_voq_info_t *info, 
...
/* Get the Global VOQ aggregation mapping of a specific port */
extern int bcm_cosq_global_voq_get(
    int unit, 
    uint32 flags, 
    bcm_port_t port, 
    bcm_cosq_global_voq_info_t *info, 
...
/* Create an AQM profile */
extern int bcm_cosq_aqm_profile_create(
    int unit, 
    int flags, 
    bcm_gport_t *profile_gport);
...
#define BCM_COSQ_GLOBAL_VOQ_UNSET           0x1        /* Used to indicate to
                                                          the
                                                          bcm_cosq_global_voq_set
                                                          API to unset the
                                                          mapping */
#define BCM_COSQ_GLOBAL_VOQ_STATUS_DEFRAGMENTED 0x1        /* Used to indicate that
                                                          the tables of the
                                                          global VOQ mapping
                                                          were defragmented and
                                                          the user should make
                                                          sure a phase
                                                          transition takes place */

/* PFC monitor threshold enumerations. */
typedef enum bcm_cosq_pfc_monitor_threshold_e {
    bcmCosqPfcMonitorThresholdPercent25 = 0, /* Percent 25. */
    bcmCosqPfcMonitorThresholdPercent50 = 1, /* Percent 50. */
    bcmCosqPfcMonitorThresholdPercent75 = 2, /* Percent 75. */
    bcmCosqPfcMonitorThresholdCount = 3 /* Must be the last. Not a usable value. */
} bcm_cosq_pfc_monitor_threshold_t;

/* PFC monitor sample window enumerations. */
typedef enum bcm_cosq_pfc_monitor_window_e {
    bcmCosqPfcMonitorWindow100Us = 0,   /* 100us. */
    bcmCosqPfcMonitorWindow500Us = 1,   /* 500us. */
    bcmCosqPfcMonitorWindow1Ms = 2,     /* 1ms. */
    bcmCosqPfcMonitorWindow5Ms = 3,     /* 5ms. */
    bcmCosqPfcMonitorWindow10Ms = 4,    /* 10ms. */
    bcmCosqPfcMonitorWindow50Ms = 5,    /* 50ms. */
    bcmCosqPfcMonitorWindow100Ms = 6,   /* 100ms. */
    bcmCosqPfcMonitorWindow500Ms = 7,   /* 500ms. */
    bcmCosqPfcMonitorWindow1S = 8,      /* 1s. */
    bcmCosqPfcMonitorWindow10Us = 9,    /* 10us. */
    bcmCosqPfcMonitorWindow15Us = 10,   /* 15us. */
    bcmCosqPfcMonitorWindow20Us = 11,   /* 20us. */
    bcmCosqPfcMonitorWindowCount = 12   /* Must be the last. Not a usable value. */
} bcm_cosq_pfc_monitor_window_t;

/* PFC monitor TOD (Time of day) clock source enumerations. */
typedef enum bcm_cosq_pfc_monitor_tod_src_e {
    bcmCosqPfcMonitorTodSrcNtp = 0,     /* NTP source. */
    bcmCosqPfcMonitorTodSrcPtp = 1,     /* PTP source. */
    bcmCosqPfcMonitorTodSrcCount = 2    /* Must be the last. Not a usable value. */
} bcm_cosq_pfc_monitor_tod_src_t;

/* PFC monitor control structure. */
typedef struct bcm_cosq_pfc_monitor_control_s {
    int enable;                         /* Enable PFC monitor. */
    bcm_cosq_pfc_monitor_threshold_t monitor_threshold; /* PFC monitor threshold.The specified
                                           value is a percentage of host
                                           circular FIFO.PFC monitor data set is
                                           collected if the number of data set
                                           exceeds the specified threshold. */
    bcm_cosq_pfc_monitor_window_t sample_window; /* Sample window. */
    bcm_cosq_pfc_monitor_tod_src_t tod_src; /* TOD clock source. */
} bcm_cosq_pfc_monitor_control_t;

/* Initialize PFC monitor control structure. */
extern void bcm_cosq_pfc_monitor_control_t_init(
    bcm_cosq_pfc_monitor_control_t *control);

#ifndef BCM_HIDE_DISPATCHABLE

/* Set PFC monitor control. */
extern int bcm_cosq_pfc_monitor_control_set(
    int unit, 
    bcm_cosq_pfc_monitor_control_t *control);

/* Get PFC monitor control. */
extern int bcm_cosq_pfc_monitor_control_get(
    int unit, 
    bcm_cosq_pfc_monitor_control_t *control);

#endif /* BCM_HIDE_DISPATCHABLE */

/* PFC monitor direction enumerations. */
typedef enum bcm_cosq_pfc_monitor_direction_e {
    bcmCosqPfcMonitorDirectionRx = 0,   /* PFC RX monitor. */
    bcmCosqPfcMonitorDirectionTx = 1,   /* PFC TX monitor. */
    bcmCosqPfcMonitorDirectionCount = 2 /* Must be the last. Not a usable value. */
} bcm_cosq_pfc_monitor_direction_t;

/* Port PFC monitor control structure. */
typedef struct bcm_cosq_pfc_monitor_port_control_s {
    int enable;                         /* Enable PFC monitor. */
    bcm_cosq_pfc_monitor_direction_t direction; /* Set PFC monitor direction. */
} bcm_cosq_pfc_monitor_port_control_t;

/* Initialize port PFC monitor control structure. */
extern void bcm_cosq_pfc_monitor_port_control_t_init(
    bcm_cosq_pfc_monitor_port_control_t *control);

#ifndef BCM_HIDE_DISPATCHABLE

/* Set port PFC monitor control. */
extern int bcm_cosq_pfc_monitor_port_control_set(
    int unit, 
    bcm_port_t port, 
    bcm_cosq_pfc_monitor_port_control_t *control);

/* Get port PFC monitor control. */
extern int bcm_cosq_pfc_monitor_port_control_get(
    int unit, 
    bcm_port_t port, 
    bcm_cosq_pfc_monitor_port_control_t *control);
...
/* PFC monitor state events. */
typedef enum bcm_cosq_pfc_monitor_event_e {
    bcmCosqPfcMonitorEventDataSetUpdate = 0, /* Latest data set update. */
    bcmCosqPfcMonitorEventFifoOverflow = 1, /* Hardware FIFO overflow event occurs. */
    bcmCosqPfcMonitorEventDataFull = 2, /* Host circular FIFO is full. */
    bcmCosqPfcMonitorEventCount = 3     /* Must be the last. Not a usable value. */
} bcm_cosq_pfc_monitor_event_t;

typedef int (*bcm_cosq_pfc_monitor_event_cb_t)(
    int unit, 
    bcm_cosq_pfc_monitor_event_t event, 
    uint32 arg1, 
    uint32 arg2, 
    uint32 arg3, 
    void *userdata);
...
/* Register PFC monitor event callback. */
extern int bcm_cosq_pfc_monitor_event_register(
    int unit, 
    bcm_cosq_pfc_monitor_event_cb_t callback, 
    void *userdata);

/* Unregister PFC monitor event callback. */
extern int bcm_cosq_pfc_monitor_event_unregister(
    int unit, 
    bcm_cosq_pfc_monitor_event_cb_t callback, 
    void *userdata);
...
/* PFC monitor data set information structure. */
typedef struct bcm_cosq_pfc_monitor_dataset_info_s {
    uint32 num_entries; /* Number of data set entries of this data set. */
    uint64 tod;         /* TOD of data set. */
} bcm_cosq_pfc_monitor_dataset_info_t;

#ifndef BCM_HIDE_DISPATCHABLE

/* Get PFC monitor data set information for a given data set ID. */
extern int bcm_cosq_pfc_monitor_dataset_info_get(
    int unit, 
    int dataset_id, 
    bcm_cosq_pfc_monitor_dataset_info_t *info);

#endif /* BCM_HIDE_DISPATCHABLE */

/* PFC monitor data set entry structure. */
typedef struct bcm_cosq_pfc_monitor_dataset_entry_s {
    int port;                   /* Port ID. */
    int pfc_pri;                /* PFC priority. */
    uint32 xoff_count;          /* Number of XOFF assertions in one sample
                                   window. */
    uint32 max_xoff_duration;   /* Maximum duration of XOFF state in 1us unit. */
    uint32 total_xoff_duration; /* Total duration of XOFF state in 1us unit. */
} bcm_cosq_pfc_monitor_dataset_entry_t;

#ifndef BCM_HIDE_DISPATCHABLE

/* Get PFC monitor data set entries for a given data set ID. */
extern int bcm_cosq_pfc_monitor_dataset_entry_get(
    int unit, 
    int dataset_id, 
    int array_size, 
    bcm_cosq_pfc_monitor_dataset_entry_t *entry_array, 
    int *count);

/* Get the current XOFF/Pause status for the given Queue Gport. */
extern int bcm_cosq_pause_queue_status_get(
    int unit, 
    bcm_gport_t gport, 
    uint8 *pause_status);
...
/* flag values for cosq_port_egress_mapping API */
#define BCM_COSQ_PORT_EGRESS_MAPPING_UNICAST 0x00000001 /* egress_mapping unicast
                                                          flag */
#define BCM_COSQ_PORT_EGRESS_MAPPING_MULTICAST 0x00000002 /* egress_mapping
                                                          multicast flag */
