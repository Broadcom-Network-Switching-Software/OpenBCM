...
typedef enum bcm_flowtracker_export_element_type_e {
    ...
    bcmFlowtrackerExportElementTypeCount = 116 
...
typedef enum bcm_flowtracker_tracking_param_type_e {
    ...
    bcmFlowtrackerTrackingParamTypeCount = 99 
...
typedef enum bcm_flowtracker_group_action_e {
    ...
    bcmFlowtrackerGroupActionFlexCtrIndexUpper = 35, /* Upper bits of the flex counter index.
                                           ...
                                           counter index. */
    bcmFlowtrackerGroupActionSrcBindFail = 36, /* Source Bind failure. param0: 1 - Bind
                                           failure, 0 - No failure. */
    bcmFlowtrackerGroupActionCount = 37 /* Always Last. Not a usable value. */
