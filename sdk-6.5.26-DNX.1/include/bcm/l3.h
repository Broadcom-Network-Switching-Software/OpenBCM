...
/* 
 * Set multiple port adjustments to an L3 ECMP DLB quality adjustment
 * profile.
 */
extern int bcm_l3_ecmp_dlb_port_quality_adjust_multi_set(
    int unit, 
    int profile_id, 
    int array_size, 
...
/* 
 * Get multiple port adjustments from an L3 ECMP DLB quality adjustment
 * profile.
 */
extern int bcm_l3_ecmp_dlb_port_quality_adjust_multi_get(
    int unit, 
    int profile_id, 
    int array_size, 
    bcm_port_t *port_array, 
