 ...
 */
shr_error_e dnx_l3_egress_ecmp_vip_fec_id_min_get(
    int unit,
    uint32 *fec_id_min);
 ...
 *   \retval Negative if error was detected. See \ref shr_error_e
 */
shr_error_e dnx_l3_egress_ecmp_vip_fec_id_max_get(
    int unit,
    uint32 *fec_id_max);
 ...
 *   \retval Negative if error was detected. See \ref shr_error_e
 */
shr_error_e dnx_l3_egress_ecmp_vip_init(
    int unit);
 ...
 *   \retval Negative if error was detected. See \ref shr_error_e
 */
shr_error_e dnx_l3_egress_ecmp_vip_create(
    int unit,
 ...
 *   \retval Negative if error was detected. See \ref shr_error_e
 */
shr_error_e dnx_l3_egress_ecmp_vip_traverse(
    int unit,
 ...
 *   \retval Negative if error was detected. See \ref shr_error_e
 */
shr_error_e dnx_l3_egress_ecmp_vip_destroy(
    int unit,
    bcm_l3_egress_ecmp_t * ecmp);
 ...
 *   \retval Negative if error was detected. See \ref shr_error_e
 */
shr_error_e dnx_l3_egress_ecmp_vip_get(
    int unit,
    bcm_l3_egress_ecmp_t * ecmp,
    int intf_size,
    bcm_if_t * intf_array,
 ...
 *   \retval Negative if error was detected. See \ref shr_error_e
 */
shr_error_e dnx_l3_egress_ecmp_pcc_resilient_add(
    int unit,
    uint32 flags,
 ...
 *   \retval Negative if error was detected. See \ref shr_error_e
 */
shr_error_e dnx_l3_egress_ecmp_pcc_resilient_delete(
    int unit,
    uint32 flags,
    bcm_l3_egress_ecmp_resilient_entry_t * entry);
 ...
 *   \retval Negative if error was detected. See \ref shr_error_e
 */
shr_error_e dnx_l3_egress_ecmp_pcc_resilient_replace(
    int unit,
    uint32 flags,
 ...
 *   \retval Negative if error was detected. See \ref shr_error_e
 */
shr_error_e dnx_l3_egress_ecmp_pcc_resilient_traverse(
    int unit,
    uint32 flags,
    bcm_l3_egress_ecmp_resilient_entry_t * match_entry,
 ...
 *   * None
 */
shr_error_e dnx_switch_control_sllb_default_destination_set(
    int unit,
    int arg);
 ...
 *   * None
 */
shr_error_e dnx_switch_control_sllb_default_destination_get(
    int unit,
    int *arg);
 ...
 *   * None
 */
shr_error_e dnx_switch_control_sllb_table_size_set(
    int unit,
    int arg);
 ...
 *   * None
 */
shr_error_e dnx_switch_control_sllb_table_size_get(
    int unit,
    int *arg);
 ...
 *   * None
 */
shr_error_e dnx_switch_control_vip_l3_egress_id_min_set(
    int unit,
    int arg);

/**
 * \brief
 *   Verify the intf is a VIP ECMP group
 * \param [in] unit - The unit number.
 * \param [in] ecmp - The ECMP group information.
 * \param [out] is_vip_id - 1: ecmp intf FEC ID is a VIP ECMP group
 * \return
 *   \retval Zero if no error was detected
 *   \retval Negative if error was detected. See \ref shr_error_e
 * \see
 *  * dnx_l3_egress_ecmp_destroy
 *  * dnx_l3_egress_ecmp_get
 */
shr_error_e dnx_l3_egress_ecmp_vip_is_vip_id_get(
    int unit,
    bcm_l3_egress_ecmp_t * ecmp,
    int *is_vip_id);
