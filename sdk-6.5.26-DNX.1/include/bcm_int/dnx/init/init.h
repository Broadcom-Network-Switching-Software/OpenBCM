 ...
 */
#define DNX_INIT_STEP_F_NEVER_SKIP_DEINIT           UTILEX_SEQ_STEP_F_NEVER_SKIP_DEINIT
/**
 * \brief
 * Steps will use DMA for writing to memories or registers
 */
#define DNX_INIT_STEP_F_USE_DMA                     UTILEX_SEQ_STEP_F_USE_DMA
/**
 * \brief
* Steps that should be called on exiting the device.
 */
#define DNX_INIT_STEP_F_MANDATORY_DEINIT            UTILEX_SEQ_STEP_F_MANDATORY_DEINIT
/**
...
typedef enum
{
    ...
    /**
     * Init SW State general.
     */
    DNX_INIT_STEP_SW_STATE_GENERAL,
    /**
    * Init SW State example.
    */
    DNX_INIT_STEP_SW_STATE_EXAMPLE,
    /**
    * Init SW State resource manager example.
    */
    DNX_INIT_STEP_SW_STATE_EXAMPLE_RES_MNGR,
    /**
    * Init SW State template manager example.
    */
    DNX_INIT_STEP_SW_STATE_EXAMPLE_TEMP_MNGR,
    /**
     * Init SW State template manager example.
    */
    DNX_INIT_STEP_SW_STATE_EXAMPLE_LINKED_LIST,
    /**
     * Init sw memories init values.
     */
    DNX_INIT_STEP_MEM_SW_INIT_VALUES,
    /**
     * Init DBAL.
     */
    DNX_INIT_STEP_DBAL,
    ...
    */
    ...
    /**
     * Init algo Flow module.
     */
    DNX_INIT_STEP_ALGO_FLOW,
    /**
     * init L3 Algo Res
     */
    ...
    * init MACSec/IPSec module
    ...
    /**
    * init MACSec/IPSec memories
     */
    DNX_INIT_STEP_SEC_MEM_INIT,
    /**
     ...
     * Power down clocks
     */
    DNX_INIT_STEP_CLOCK_POWER_DOWN,
    ...
    /**
     * Configuration of resources for Field Group.
     */
    DNX_INIT_STEP_FLD_GROUP,
    /**
    ...
    DNX_INIT_STEP_RESERVED_1,
    DNX_INIT_STEP_RESERVED_2,
    /**
     * Configuration of resources for TCAM manager and within DNX FIELD.
     */
     ...
     *  Blocks enable
     */
    DNX_INIT_STEP_BLOCKS_ENABLE,
    /**
     *  DRAM initial configuration
     */
    DNX_INIT_STEP_DRAM_INITIAL_CONFIG,
    /**
     *  DRAM PHY BIST
     */
    DNX_INIT_STEP_DRAM_PHY_BIST,
    /**
    * init Port Interrupts
     ...
     *  L2 CPU learn thread
     */
    DNX_INIT_STEP_L2_CPU_LEARN_THREAD,
    /**
     * flow init.
     */
    DNX_INIT_STEP_FLOW,
    ...
    /**
     * OAMP EVENT FIFODMA THREAD init.
     */

    DNX_INIT_STEP_OAMP_EVENT_FIFODMA_THREAD,

    /**
     * FLR SW linkscan thread init.
     */
    DNX_INIT_STEP_FLR_SW_LINKSCAN_THREAD,

    /**
     * TSN thread init.
     */
    DNX_INIT_STEP_TSN_THREAD,

    /**
     * init cosq aqm module
     */
    DNX_INIT_STEP_COSQ_AQM_MODULE,

    /**
     * init cosq global voq module
     */
    DNX_INIT_STEP_COSQ_GLOBAL_VOQ_MODULE,

    /**
     * init Cross Connect transmit module
     */
    DNX_INIT_STEP_CROSS_CONNECT_TRANSMIT_MODULE,

    /**
     * init Cross Connect module
     */
    DNX_INIT_STEP_CROSS_CONNECT_MODULE,

    /**
     * Initialize the FIFO DMA access API module.
     */
    DNX_INIT_FIFODMA_ACCESS,

    /**
     * init BIER
     */
    DNX_INIT_STEP_BIER_PP,
...
/**
 * \brief
 *  Increment the dma init step enabled counter
 * \par DIRECT INPUT
 *  \param [in] unit - The unit number.
 * \par DIRECT OUTPUT: 
 *  Non-zero in case of an error
 */
shr_error_e dnx_sbusdma_desc_init_step_enabled_counter_inc(
    int unit);

/**
 * \brief
 *  Decrement the dma init step enabled counter
 * \par DIRECT INPUT
 *  \param [in] unit - The unit number.
 * \par DIRECT OUTPUT: 
 *  Non-zero in case of an error
 */
shr_error_e dnx_sbusdma_desc_init_step_enabled_counter_dec(
    int unit);

/**
 * \brief
 *  Increment the dma suppress counter
 * \par DIRECT INPUT
 *  \param [in] unit - The unit number.
 * \par DIRECT OUTPUT: 
 *  Non-zero in case of an error
 */
void dnx_sbusdma_desc_init_suppress_counter_inc(
    int unit);

/**
 * \brief
 *  Decrement the dma suppress counter
 * \par DIRECT INPUT
 *  \param [in] unit - The unit number.
 * \par DIRECT OUTPUT: 
 *  Non-zero in case of an error
 */
void dnx_sbusdma_desc_init_suppress_counter_dec(
    int unit);

/**
 * \brief
 *  Returns the dma init step enabled counter
 * \par DIRECT INPUT
 *  \param [in] unit - The unit number.
 * \par DIRECT OUTPUT: 
 *  dma init step enabled counter
 */
uint32 dnx_sbusdma_desc_init_step_enabled_counter_return(
    int unit);
