...
*   3) The 'last' key ID it resides on (in the given context) is equal to the key ID given
*  In case no such FG exists, this function throws an error.
*   Third condition will not be checked if the first key is DNX_FIELD_KEY_ID_INVALID.
*
* \param [in] unit       - Device ID
...
*                          If DNX_FIELD_KEY_ID_INVALID, will not verify key.
