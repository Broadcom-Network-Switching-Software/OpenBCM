...
/** Size of index to the table that maps VSI(or other field in MACT entry to profile) for SVL, 16 means 64 entries */
 ...
 */
#define MACT_ENTRY_OUTLIF_OFFSET_LEARN_RES_OPT       (MACT_ENTRY_SIZE - 6 - 5 - 21 - 2 - 11 - 1 - 22)
