...
typedef enum {
    ...
    DNX_ALGO_PORT_DB_RX_FIFO_COUNTER_PORT_MAP_INFO,
    DNX_ALGO_PORT_DB_RX_FIFO_COUNTER_PORT_MAP_PORT_INFO,
...
int dnx_algo_port_db_rx_fifo_counter_port_map_dump(
    int unit, int rx_fifo_counter_port_map_idx_0, dnx_sw_state_dump_filters_t filters);

int dnx_algo_port_db_rx_fifo_counter_port_map_port_dump(
    int unit, int rx_fifo_counter_port_map_idx_0, dnx_sw_state_dump_filters_t filters);
