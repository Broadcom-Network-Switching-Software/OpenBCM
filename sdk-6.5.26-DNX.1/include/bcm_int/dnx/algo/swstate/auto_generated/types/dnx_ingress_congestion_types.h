...
typedef struct {
    /**
     * stores value of Global VSQ shared max occupancy counter in bytes units
     */
    uint32 shared_size_max[DNX_DATA_MAX_DEVICE_GENERAL_NOF_CORES][DNX_DATA_MAX_INGR_CONGESTION_VSQ_POOL_NOF];
    /**
     * stores value of Global VSQ guaranteed max occupancy counter in bytes units
     */
    uint32 guaranteed_size_max[DNX_DATA_MAX_DEVICE_GENERAL_NOF_CORES][DNX_DATA_MAX_INGR_CONGESTION_VSQ_POOL_NOF];
    /**
     * stores value of Global VSQ headroom max occupancy counter in bytes units
     */
...
typedef struct {
    ...
    /**
     * stores Global VSQ occupancy counter
     */
