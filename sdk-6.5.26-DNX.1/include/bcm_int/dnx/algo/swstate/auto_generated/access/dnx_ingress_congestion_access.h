...
/**
 * implemented by: dnx_ingress_congestion_db_global_vsq_occupancy_shared_size_max_set
 */
...
/**
 * implemented by: dnx_ingress_congestion_db_global_vsq_occupancy_shared_size_max_get
 */
typedef int (*dnx_ingress_congestion_db_global_vsq_occupancy_shared_size_max_get_cb)(
    int unit, uint32 shared_size_max_idx_0, uint32 shared_size_max_idx_1, uint32 *shared_size_max);

/**
 * implemented by: dnx_ingress_congestion_db_global_vsq_occupancy_guaranteed_size_max_set
 */
...
/**
 * implemented by: dnx_ingress_congestion_db_global_vsq_occupancy_guaranteed_size_max_get
 */
typedef int (*dnx_ingress_congestion_db_global_vsq_occupancy_guaranteed_size_max_get_cb)(
    int unit, uint32 guaranteed_size_max_idx_0, uint32 guaranteed_size_max_idx_1, uint32 *guaranteed_size_max);

/**
 * implemented by: dnx_ingress_congestion_db_global_vsq_occupancy_headroom_size_max_set
 */
...
/**
 * implemented by: dnx_ingress_congestion_db_global_vsq_occupancy_headroom_size_max_get
 */
...
/**
 * This structure holds the access functions for the variable shared_size_max
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable guaranteed_size_max
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable headroom_size_max
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable dnx_cosq_ingress_congestion_gl_vsq_occupancy_info_t
 */
typedef struct {
    /**
     * Access struct for shared_size_max
     */
    dnx_ingress_congestion_db_global_vsq_occupancy_shared_size_max_cbs shared_size_max;
    /**
     * Access struct for guaranteed_size_max
     */
    dnx_ingress_congestion_db_global_vsq_occupancy_guaranteed_size_max_cbs guaranteed_size_max;
    /**
     * Access struct for headroom_size_max
     */
...
typedef struct {
    ...
    /**
     * Access struct for global_vsq_occupancy
     */
