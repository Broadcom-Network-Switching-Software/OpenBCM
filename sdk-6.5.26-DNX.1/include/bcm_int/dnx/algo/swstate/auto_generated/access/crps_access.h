...
/**
 * implemented by: dnx_crps_db_proc_rate_rate_calculation_enable_set
 */
...
/**
 * implemented by: dnx_crps_db_proc_rate_rate_calculation_enable_get
 */
typedef int (*dnx_crps_db_proc_rate_rate_calculation_enable_get_cb)(
    int unit, uint32 proc_idx_0, uint32 proc_idx_1, int *rate_calculation_enable);

/**
 * implemented by: dnx_crps_db_proc_rate_next_seq_counter_idx_set
 */
...
/**
 * implemented by: dnx_crps_db_proc_rate_next_seq_counter_idx_get
 */
typedef int (*dnx_crps_db_proc_rate_next_seq_counter_idx_get_cb)(
    int unit, uint32 proc_idx_0, uint32 proc_idx_1, uint32 *next_seq_counter_idx);

/**
 * implemented by: dnx_crps_db_proc_rate_sequence_num_set
 */
...
/**
 * implemented by: dnx_crps_db_proc_rate_sequence_num_get
 */
typedef int (*dnx_crps_db_proc_rate_sequence_num_get_cb)(
    int unit, uint32 proc_idx_0, uint32 proc_idx_1, uint32 sequence_num_idx_0, uint8 *sequence_num);

/**
 * implemented by: dnx_crps_db_proc_rate_sequence_num_alloc
 */
...
/**
 * implemented by: dnx_crps_db_proc_rate_sequence_num_is_allocated
 */
...
/**
 * implemented by: dnx_crps_db_proc_rate_seq_period_shadow_set
 */
...
/**
 * implemented by: dnx_crps_db_proc_rate_seq_period_shadow_get
 */
typedef int (*dnx_crps_db_proc_rate_seq_period_shadow_get_cb)(
    int unit, uint32 proc_idx_0, uint32 proc_idx_1, uint32 seq_period_shadow_idx_0, uint32 seq_period_shadow_idx_1, uint8 *seq_period_shadow);

/**
 * implemented by: dnx_crps_db_proc_rate_seq_period_shadow_alloc
 */
typedef int (*dnx_crps_db_proc_rate_seq_period_shadow_alloc_cb)(
    int unit, uint32 proc_idx_0, uint32 proc_idx_1, uint32 nof_instances_to_alloc_0);

/**
 * implemented by: dnx_crps_db_proc_rate_seq_period_shadow_is_allocated
 */
typedef int (*dnx_crps_db_proc_rate_seq_period_shadow_is_allocated_cb)(
    int unit, uint32 proc_idx_0, uint32 proc_idx_1, uint8 *is_allocated);

/**
 * implemented by: dnx_crps_db_proc_rate_algo_shadow_set
 */
...
/**
 * implemented by: dnx_crps_db_proc_rate_algo_shadow_get
 */
typedef int (*dnx_crps_db_proc_rate_algo_shadow_get_cb)(
    int unit, uint32 proc_idx_0, uint32 proc_idx_1, uint32 algo_shadow_idx_0, uint32 algo_shadow_idx_1, uint8 *algo_shadow);

/**
 * implemented by: dnx_crps_db_proc_rate_algo_shadow_alloc
 */
typedef int (*dnx_crps_db_proc_rate_algo_shadow_alloc_cb)(
    int unit, uint32 proc_idx_0, uint32 proc_idx_1, uint32 nof_instances_to_alloc_0);

/**
 * implemented by: dnx_crps_db_proc_rate_algo_shadow_is_allocated
 */
...
/**
 * This structure holds the access functions for the variable rate_calculation_enable
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable next_seq_counter_idx
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable sequence_num
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable seq_period_shadow
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable algo_shadow
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable dnx_engine_rate_info_t
 */
typedef struct {
    /**
     * Access struct for rate_calculation_enable
     */
    dnx_crps_db_proc_rate_rate_calculation_enable_cbs rate_calculation_enable;
    /**
     * Access struct for next_seq_counter_idx
     */
    dnx_crps_db_proc_rate_next_seq_counter_idx_cbs next_seq_counter_idx;
    /**
     * Access struct for sequence_num
     */
    dnx_crps_db_proc_rate_sequence_num_cbs sequence_num;
    /**
     * Access struct for seq_period_shadow
     */
    dnx_crps_db_proc_rate_seq_period_shadow_cbs seq_period_shadow;
    /**
     * Access struct for algo_shadow
     */
