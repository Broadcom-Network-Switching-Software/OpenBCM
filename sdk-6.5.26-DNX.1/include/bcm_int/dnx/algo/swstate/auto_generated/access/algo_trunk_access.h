...
/**
 * implemented by: algo_trunk_db_user_profile_manager_free_single
 */
typedef int (*algo_trunk_db_user_profile_manager_free_single_cb)(
    int unit, int element, void *extra_arguments);

/**
 * implemented by: algo_trunk_db_user_profile_manager_free_several
 */
...
/**
 * implemented by: algo_trunk_db_user_profile_manager_advanced_algorithm_info_set
 */
typedef int (*algo_trunk_db_user_profile_manager_advanced_algorithm_info_set_cb)(
    int unit, void *algorithm_info);

/**
 * implemented by: algo_trunk_db_user_profile_manager_advanced_algorithm_info_get
 */
typedef int (*algo_trunk_db_user_profile_manager_advanced_algorithm_info_get_cb)(
    int unit, void *algorithm_info);

/**
 * implemented by: algo_trunk_db_user_profile_manager_data_per_entry_get
 */
...
/**
 * This structure holds the access functions for the variable user_profile_manager
 */
typedef struct {
...
typedef struct {
    ...
    /**
     * Access struct for user_profile_manager
     */
