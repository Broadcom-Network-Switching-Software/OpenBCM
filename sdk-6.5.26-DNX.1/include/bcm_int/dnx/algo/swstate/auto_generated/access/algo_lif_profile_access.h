...
/**
 * implemented by: algo_lif_profile_db_in_lif_lb_profile_disablers_flags_set
 */
...
/**
 * implemented by: algo_lif_profile_db_in_lif_lb_profile_disablers_flags_get
 */
typedef int (*algo_lif_profile_db_in_lif_lb_profile_disablers_flags_get_cb)(
    int unit, dnx_algo_template_t *in_lif_lb_profile_disablers_flags);

/**
 * implemented by: algo_lif_profile_db_in_lif_lb_profile_disablers_flags_create
 */
typedef int (*algo_lif_profile_db_in_lif_lb_profile_disablers_flags_create_cb)(
    int unit, dnx_algo_template_create_data_t * data, void *extra_arguments);

/**
 * implemented by: algo_lif_profile_db_in_lif_lb_profile_disablers_flags_exchange
 */
typedef int (*algo_lif_profile_db_in_lif_lb_profile_disablers_flags_exchange_cb)(
    int unit, uint32 flags, const uint32 *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference);

/**
 * implemented by: algo_lif_profile_db_in_lif_lb_profile_disablers_flags_profile_data_get
 */
typedef int (*algo_lif_profile_db_in_lif_lb_profile_disablers_flags_profile_data_get_cb)(
    int unit, int profile, int *ref_count, uint32 *profile_data);

/**
 * implemented by: algo_lif_profile_db_in_lif_lb_profile_disablers_flags_clear
 */
...
/**
 * implemented by: algo_lif_profile_db_in_lif_profile_advanced_algorithm_info_set
 */
typedef int (*algo_lif_profile_db_in_lif_profile_advanced_algorithm_info_set_cb)(
    int unit, void *algorithm_info);

/**
 * implemented by: algo_lif_profile_db_in_lif_profile_advanced_algorithm_info_get
 */
...
/**
 * implemented by: algo_lif_profile_db_eth_rif_profile_advanced_algorithm_info_set
 */
typedef int (*algo_lif_profile_db_eth_rif_profile_advanced_algorithm_info_set_cb)(
    int unit, void *algorithm_info);

/**
 * implemented by: algo_lif_profile_db_eth_rif_profile_advanced_algorithm_info_get
 */
...
/**
 * This structure holds the access functions for the variable in_lif_lb_profile_disablers_flags
 */
typedef struct {
...
typedef struct {
    ...
    /**
     * Access struct for in_lif_lb_profile_disablers_flags
     */
