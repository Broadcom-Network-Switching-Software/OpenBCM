...
#define DNX_ALGO_RES_MNGR_DATA_PER_ENTRY_SET(node_id, algo_res, element, data)\
        SHR_IF_ERR_EXIT(dnx_algo_res_data_per_entry_set\
                (unit, node_id, algo_res, element, data))

#define DNX_ALGO_RES_MNGR_DATA_PER_ENTRY_GET(node_id, algo_res, element, data)\
        SHR_IF_ERR_EXIT(dnx_algo_res_data_per_entry_get\
                (unit, node_id, algo_res, element, data))
...
*
    \param [in] unit - Relevant unit.
*   \param [in] node_id - Node ID.
*   \param [in] algo_res - Relevant res tag bitmap.
*   \param [in] element - Element to which will be added a data
*   \param [in] data - Pointer to save data per entry into.
*  \return
*    shr_error_e - Error return value
*  \remark
*    None
...
*    shr_error_e
*/
shr_error_e dnx_algo_res_data_per_entry_set(
    int unit,
    uint32 node_id,
    dnx_algo_res_t algo_res,
    int element,
...
*    shr_error_e
*/
shr_error_e dnx_algo_res_data_per_entry_get(
    int unit,
    uint32 node_id,
    dnx_algo_res_t algo_res,
    int element,
