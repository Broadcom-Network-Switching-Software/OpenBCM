...
#define _DNX_ALGO_GET_MACRO(a, b, c, d, e, f, g, NAME, ...) NAME
#define DNX_ALGO_PORT_TYPE_INCLUDE(...) _DNX_ALGO_GET_MACRO(__VA_ARGS__, _DNX_ALGO_PORT_TYPE_MASK_7, _DNX_ALGO_PORT_TYPE_MASK_6, _DNX_ALGO_PORT_TYPE_MASK_5, _DNX_ALGO_PORT_TYPE_MASK_4, _DNX_ALGO_PORT_TYPE_MASK_3, _DNX_ALGO_PORT_TYPE_MASK_2, _DNX_ALGO_PORT_TYPE_MASK_1, dummy)(__VA_ARGS__)
/**
...
shr_error_e dnx_algo_port_flr_timer_to_tick_get(
    ...
    uint32 *tick_count);
/**
 * \brief - Get the timer value from tick count and tick unit
 *
 * \param [in] unit - chip unit id
 * \param [in] tick_unit - the number of tick unit
 * \param [in] tick_count - the number of tick count
 * \param [out] timer - the timer
 *
 * \return
 *   int - see _SHR_E_*
 *
 ...
 *   * None
 */
shr_error_e dnx_algo_port_flr_tick_to_timer_get(
    int unit,
    uint32 tick_unit,
    uint32 tick_count,
    uint32 *timer);
