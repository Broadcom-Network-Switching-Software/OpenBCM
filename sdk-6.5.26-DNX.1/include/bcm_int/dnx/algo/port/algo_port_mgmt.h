 ...
 *   * None
 */
shr_error_e dnx_algo_port_sar_channel_to_logical_get(
    int unit,
    int client_channel,
    bcm_port_t * logical_port);
/**
 * \brief - Get framer MAC logical port ID
 *
 * \param [in] unit - unit #.
 * \param [in] client_channel - Framer MAC client channel.
 * \param [out] logical_port - logical port #.
 *
 * \return
 *   see shr_error_e
 ...
 *   * None
 */
shr_error_e dnx_algo_port_framer_mac_channel_to_logical_get(
    int unit,
    int client_channel,
    bcm_port_t * logical_port);
/**
