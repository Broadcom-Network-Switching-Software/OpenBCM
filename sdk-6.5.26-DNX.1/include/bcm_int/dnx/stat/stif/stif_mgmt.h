...
typedef enum
{
    dnx_stat_stif_mgmt_port_mode_single = 0,
    dnx_stat_stif_mgmt_port_mode_dual = 1,
    dnx_stat_stif_mgmt_port_mode_quad = 2,
    dnx_stat_stif_mgmt_port_nof_modes = 3
} dnx_stat_stif_mgmt_port_mode_t;

typedef enum
{
    dnx_stat_stif_mgmt_port_speed_100000 = 0,
    dnx_stat_stif_mgmt_port_speed_200000 = 1,
    dnx_stat_stif_mgmt_port_speed_400000 = 2,
    dnx_stat_stif_mgmt_port_nof_speeds = 3
} dnx_stat_stif_mgmt_port_speed_t;
 ...
 */
extern const dnx_stif_mgmt_report_format_element_t ingress_element_enum_to_dbal_fields_binding_table[];
