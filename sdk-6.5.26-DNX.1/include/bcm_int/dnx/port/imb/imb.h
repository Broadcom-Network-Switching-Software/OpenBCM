 ...
 *
 * @brief Configure transcode configuration for L1 ETH port.  
 *
 * @param [in]  unit            - unit id
 * @param [in]  port            - logical port
 * @param [in]  is_rx           - Rx or tx direction
 * @param [in]  map_type        - OTN map type
 * @param [in]  enable          - enable or disable the trancode configuration
 */
int imb_port_l1_eth_transcode_set(
    int unit,
    bcm_port_t port,
    int is_rx,
 ...
 *
 * @brief Port FLR link configuration set/get 
 *
 * @param [in]  unit            - unit id
 * @param [in]  port            - logical port
 ...
 * @param [in]  unit            - unit id
 * @param [in]  port            - logical port
 * @param [out]  config          - returns configured value for FLR link config
 */
int imb_port_flr_link_config_get(
    int unit,
    bcm_port_t port,
