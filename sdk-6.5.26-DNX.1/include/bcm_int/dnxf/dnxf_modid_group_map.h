...
int dnxf_modid_group_map_clear(
    int unit);

int dnxf_modid_group_map_clear_group(
    int unit,
    bcm_module_t group);

int dnxf_modid_group_map_add(
    int unit,
    bcm_module_t group,
    bcm_module_t module);

int dnxf_modid_group_map_get_list(
    int unit,
    bcm_module_t group,
    int modid_max_count,
...
int dnxf_modid_group_map_get_group(
    int unit,
    bcm_module_t module,
    bcm_module_t * group);
