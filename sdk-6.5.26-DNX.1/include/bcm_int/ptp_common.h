...
extern int bcm_common_ptp_clock_port_delay_asymmetry_get(int,bcm_ptp_stack_id_t,int,uint32,int *);
extern int bcm_common_ptp_clock_port_delay_asymmetry_set(int,bcm_ptp_stack_id_t,int,uint32,int);
...
extern int _bcm_tdpll_output_clock_TS1_1ppsref_create(int , int , int , bcm_ptp_clock_input_pin_t);
extern int _bcm_tdpll_output_clock_TS1_1ppsref_enable(int unit, int stack_id, int enable);
...
int _bcm_ptp_servo_init(int, bcm_ptp_stack_id_t, int, bcm_ptp_osc_type_t, T_srvReferenceTrackerType, uint32);
...
extern int bcm_common_ptp_clock_apts_input_source_set( int unit, bcm_ptp_stack_id_t ptp_id, int clock_num, bcm_ptp_clock_apts_source_t apts_source, 
        bcm_ptp_clock_apts_input_source_config_t *input_source_config);
extern int bcm_common_ptp_clock_apts_input_source_get( int unit, bcm_ptp_stack_id_t ptp_id, int clock_num, bcm_ptp_clock_apts_source_t apts_source, 
        bcm_ptp_clock_apts_input_source_config_t *input_source_config);

#ifndef __KERNEL__
extern int _bcm_ptp_servo_phase_offset_set( int unit, bcm_ptp_stack_id_t ptp_id, int clock_num, const double *phase_offset);
#else
extern int _bcm_ptp_servo_phase_offset_set( int unit, bcm_ptp_stack_id_t ptp_id, int clock_num, const int64 *phase_offset);
#endif /* __KERNEL__ */

extern int bcm_common_ptp_servo_performance_get(int,bcm_ptp_stack_id_t,int,bcm_ptp_servo_performance_t *);

extern int bcm_common_ptp_ntp_tod_offset_set(int unit,bcm_ptp_stack_id_t ptp_id,
             int clock_num, uint32 flags, bcm_ptp_time_spec_t *ptp_tod_offset,
             bcm_ptp_time_spec_t *ntp_tod_offset);
extern int bcm_common_ptp_ntp_tod_offset_get(int unit,bcm_ptp_stack_id_t ptp_id,
             int clock_num, uint32 flags, bcm_ptp_time_spec_t *ptp_tod_offset,
             bcm_ptp_time_spec_t *ntp_tod_offset);
