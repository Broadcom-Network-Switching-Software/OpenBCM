...
typedef struct {
	...
	int (*cosq_dynamic_ecn_threshold_get)(int,int,bcm_cosq_object_id_t *,bcm_cosq_dynamic_ecn_threshold_t *);
	int (*cosq_dynamic_ecn_threshold_profile_create)(int,uint32,int *);
	int (*cosq_dynamic_ecn_threshold_profile_destroy)(int,int);
	int (*cosq_dynamic_ecn_threshold_set)(int,int,bcm_cosq_object_id_t *,bcm_cosq_dynamic_ecn_threshold_t *);
	...
	int (*field_qualify_StatefulMirrorOnDropDropPkt)(int,bcm_field_entry_t,uint8,uint8);
	int (*field_qualify_StatefulMirrorOnDropDropPkt_get)(int,bcm_field_entry_t,uint8 *,uint8 *);
	int (*field_qualify_StatefulMirrorOnDropEligible)(int,bcm_field_entry_t,uint8,uint8);
	int (*field_qualify_StatefulMirrorOnDropEligible_get)(int,bcm_field_entry_t,uint8 *,uint8 *);
	...
	int (*l3_ecmp_dlb_port_quality_adjust_multi_get)(int,int,int,bcm_port_t *,bcm_l3_ecmp_dlb_quality_adjust_t *,int *);
	int (*l3_ecmp_dlb_port_quality_adjust_multi_set)(int,int,int,bcm_port_t *,bcm_l3_ecmp_dlb_quality_adjust_t *);
	...
	int (*policer_action_profile_create)(int,bcm_policer_action_id_t,bcm_policer_action_profile_t *);
	int (*policer_action_profile_destroy)(int,bcm_policer_action_id_t);
	int (*policer_action_profile_get)(int,bcm_policer_action_id_t,bcm_policer_action_profile_t *);
