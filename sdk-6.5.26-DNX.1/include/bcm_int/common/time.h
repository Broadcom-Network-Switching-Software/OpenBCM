...
typedef enum _bcm_time_message_type_e {
    ...
    _BCM_TIME_BS_NTP_TOD_DISABLE_SET,
    _BCM_TIME_BS_PTP_TOD_DISABLE_SET,
    _BCM_TIME_PTP_OFFSET_SET,
    _BCM_TIME_PTP_OFFSET_GET
...
int bcmi_esw_time_fl_synce_L1_rcvd_clk_port_get(int unit, int phy_port);
int bcmi_esw_time_fl_phy_port_get(int unit, int port_sel);
