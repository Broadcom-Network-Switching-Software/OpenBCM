...
extern int _bcm_linkscan_port_deinit(int unit, int port);

extern int bcm_common_linkscan_flr_init(int unit);
extern int bcm_common_linkscan_flr_enable_get(
    int unit,
    bcm_port_t port,
    int *enable,
    bcm_port_flr_timeout_t *timeout);
extern int bcm_common_linkscan_flr_enable_set(
    int unit,
    bcm_port_t port,
    int enable,
    bcm_port_flr_timeout_t timeout);
extern int bcm_common_linkscan_flr_linkup_count_get(
    int unit,
    int port,
    int *count);
extern int bcm_common_linkscan_flr_wb_restore(int unit);
