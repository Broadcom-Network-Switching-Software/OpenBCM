...
#define BFD_SDK_VERSION         BFD_SDK_BASE_VERSION |              \
                                ...
                                (1 << BFD_FEATURE_VXLAN) | \
                                (1 << BFD_FEATURE_RX_DEBUG_CTRS_ENHANCED) | \
                                (1 << BFD_FEATURE_L3IIF_VRF) | \
                                (1 << BFD_FEATURE_L3IIF_LOOKUP_FOR_VRF)
...
/* BFD over VXLAN */
#define BFD_FEATURE_VXLAN 16

/* Enhanced Debug Counters */
#define BFD_FEATURE_RX_DEBUG_CTRS_ENHANCED 17

/* BFD over VRF instance */
#define BFD_FEATURE_L3IIF_VRF 18

/* L3IIF to VRF map Table lookup */
#define BFD_FEATURE_L3IIF_LOOKUP_FOR_VRF 19
...
/* BFD EDK Notification EVENT ID. */
#define BFD_EDK_EVENT_ID 15

/* BFD EDK host version. */
#define BFD_EDK_HOST_VERSION 0x1
