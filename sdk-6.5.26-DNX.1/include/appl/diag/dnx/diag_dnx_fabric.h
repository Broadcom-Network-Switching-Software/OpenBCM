...
extern sh_sand_man_t dnx_fabric_cgm_man;
extern sh_sand_cmd_t sh_dnx_fabric_cgm_cmds[];
...
/**
 * \brief - Callback in shell command framework allowing to enable command for DNX CGM device
 */
extern shr_error_e sh_cmd_is_dnx_cgm(
    int unit,
    rhlist_t * test_list);
