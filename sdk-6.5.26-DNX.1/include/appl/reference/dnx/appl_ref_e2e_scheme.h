...
/**
 * \brief - Get delay tolerance profile from port speed including push queue profiles
 *
 * \param [in] unit - Unit ID
 * \param [in] sys_port_map - system port mapping info
 * \param [out] delay_tolerance_level - delay_tolerance_level
 ...
 *   * None
 */
shr_error_e appl_dnx_e2e_voq_profiles_final_get(
    int unit,
    const system_port_mapping_t * sys_port_map,
    int *delay_tolerance_level,
    int *rate_class);
...
/**
 * \brief - Get discard rate class profile
 *
 * \param [in] unit - Unit ID
 * \param [out] discard_rate_class - discard rate class profile
 *
 * \return
 *   shr_error_e
 *
...
/**
 * \brief - create rate class with tail drop 0. destroyed voqs will be mapped to this rate class to discard all traffic.
 *
 * \param [in] unit - Unit ID
 *
 * \return
 ...
 */
shr_error_e
appl_dnx_e2e_discard_rate_class_create(int unit);
