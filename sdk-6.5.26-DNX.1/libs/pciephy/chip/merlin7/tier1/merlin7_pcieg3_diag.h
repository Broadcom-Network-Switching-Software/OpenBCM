...
/** Parameterized diagnostic function which provides access to all merlin7_pcieg3 control and status bits
 * This function is required to be implemented by upper level software to enable merlin7_pcieg3 support.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] merlin7_pcieg3_info_ptr Used for retrieving the diag mem RAM_size.
