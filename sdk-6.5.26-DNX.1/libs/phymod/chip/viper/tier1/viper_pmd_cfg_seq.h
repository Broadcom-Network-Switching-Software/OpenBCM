...
extern int viper_phy_enable_set(const PHYMOD_ST *pa, const phymod_phy_power_t* power, int combo);
extern int viper_phy_enable_get(const PHYMOD_ST *pa, phymod_phy_power_t* power);
...
extern int viper_tx_squelch_set(const PHYMOD_ST *pa, int enable);
extern int viper_tx_squelch_get(const PHYMOD_ST *pa, int *enable);
