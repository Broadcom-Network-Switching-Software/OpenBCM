...
err_code_t
merlin7_rx_pmd_lock_status_get(phymod_access_t *sa__, uint32_t *pmd_lock, uint32_t *pmd_lock_change)
{
...
err_code_t merlin7_tx_pi_control_get(phymod_access_t *sa__, int16_t* value)
{
