...
__phymod__dispatch__t__ phymod_tscbh_gen2_driver = {
    ...
    tscbh_gen2_phy_fec_override_set,
    tscbh_gen2_phy_fec_override_get,
    ...
    tscbh_gen2_phy_serdes_power_set,
    tscbh_phy_an_timer_set,
    tscbh_phy_an_timer_get,
    tscbh_gen2_phy_flr_config_set,
    tscbh_gen2_phy_flr_config_get,
    NULL, /* phymod_phy_fec_degraded_ser_set */
    NULL, /* phymod_phy_fec_degraded_ser_get */
    NULL, /* phymod_phy_fec_degraded_ser_status_get */
    tscbh_gen2_phy_am_loss_align_multi_state_get,
    NULL, /* phymod_phy_temp_offset_set */
    NULL, /* phymod_phy_temp_offset_get */
    tscbh_gen2_phy_fw_is_flr_supported,
