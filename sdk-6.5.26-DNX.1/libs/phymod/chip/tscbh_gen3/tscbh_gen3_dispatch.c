...
__phymod__dispatch__t__ phymod_tscbh_gen3_driver = {
    ...
    blackhawk7_v1l8p1_phy_signal_detect_status_get,
    ...
    tscbh_gen3_phy_flr_config_set,
    tscbh_gen3_phy_flr_config_get,
    ...
    tscbh_gen3_phy_fw_is_flr_supported,
    blackhawk7_v1l8p1_phy_rx_dc_offset_get,
