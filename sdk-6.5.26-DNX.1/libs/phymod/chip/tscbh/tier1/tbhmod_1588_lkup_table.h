...
#define TBHMOD_TS_400G_MEM_SIZE 40
#define TBHMOD_TS_DEFAULT_TABLE_SIZE 40
#define TBHMOD_TS_TABLE_SIZE  60
...
typedef enum {
    ...
    TBHMOD_SPEED_50G_BRCM_FEC_272_CR1_KR1,
    ...
    TBHMOD_SPEED_100G_BRCM_FEC_272_CR2_KR2,
    TBHMOD_SPEED_200G_BRCM_NO_FEC_KR4_CR4,
    TBHMOD_SPEED_200G_BRCM_KR4_CR4,
    TBHMOD_SPEED_200G_BRCM_FEC_272_N4,
    TBHMOD_SPEED_400G_BRCM_FEC_KR8_CR8,
...
typedef uint32_t ts_table_entry_mem[TBHMOD_TS_ENTRY_SIZE];

int tbhmod_1588_table_index_get(uint32_t speed_index, phymod_fec_type_t fec, int *ts_table_index, uint32_t* table_size);
...
extern ts_table_entry* ts_table_tx_sop_get(void);
extern ts_table_entry* ts_table_rx_sop_get(void);
extern ts_table_entry* ts_table_tx_sfd_get(void);
extern ts_table_entry* ts_table_rx_sfd_get(void);
