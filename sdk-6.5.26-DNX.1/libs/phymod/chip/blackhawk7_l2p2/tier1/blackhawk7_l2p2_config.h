...
/** Clear the blackhawk7_l2p2_info for the uC.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors).
 */
 ...
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[out] mode An enable/disable option from the enum blackhawk7_l2p2_force_cdr_mode_enum.
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors).
 */
 ...
 * Note: Calling this API will overwrite any OSR mode value previously programmed through blackhawk7_l2p2_set_osr_mode(),
 *       blackhawk7_l2p2_set_tx_osr_mode(), or blackhawk7_l2p2_set_rx_osr_mode().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * Note: Calling this API will overwrite any OSR mode value previously programmed through blackhawk7_l2p2_set_osr_mode()
 *        or blackhawk7_l2p2_set_rx_osr_mode().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * Note: Calling this API will overwrite any OSR mode value previously programmed through blackhawk7_l2p2_set_osr_mode()
 *        or blackhawk7_l2p2_set_tx_osr_mode().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * Note: Calling this API will overwrite the blackhawk7_l2p2_set_use_osr_mode_pins_only() setting if it was previously set.
 ...
 * Note: This API returns the control status, not the actual hardware status. Use blackhawk7_l2p2_INTERNAL_get_osr_mode()
...
/** Set the RX osr mode.
 * Note: Calling this API will overwrite the blackhawk7_l2p2_set_use_rx_osr_mode_pins_only() setting if it was previously set.
 * Note: This API should be used for configuring TX and RX osr modes when pins aren't being used. Do not write directly to the following
 *       register fields: rx_osr_mode_frc, rx_osr_mode_frc_val, tx_osr_mode_frc, tx_osr_mode_frc_val, osr_mode_frc, and osr_mode_frc_val.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
...
/** Set the TX osr mode.
 * Note: Calling this API will overwrite the blackhawk7_l2p2_set_use_tx_osr_mode_pins_only() setting if it was previously set.
 * Note: This API should be used for configuring TX and RX osr modes when pins aren't being used. Do not write directly to the following
 *       register fields: rx_osr_mode_frc, rx_osr_mode_frc_val, tx_osr_mode_frc, tx_osr_mode_frc_val, osr_mode_frc, and osr_mode_frc_val.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
