...
#define rdcv_ahb_reg_address(xx)                                     falcon16_v1l4p1_rdwc_uc_var(sa__,__ERR,(uint16_t)(0x20 + (xx*2)))
#define wrcv_ahb_reg_address(xx,wr_val)                              falcon16_v1l4p1_wrwc_uc_var(sa__,(uint16_t)(0x20 + (xx*2)),wr_val)
...
#define rdcv_ahb_reg_data(xx)                                        falcon16_v1l4p1_rdwc_uc_var(sa__,__ERR,(uint16_t)(0x34 + (xx*2)))
#define wrcv_ahb_reg_data(xx,wr_val)                                 falcon16_v1l4p1_wrwc_uc_var(sa__,(uint16_t)(0x34 + (xx*2)),wr_val)
