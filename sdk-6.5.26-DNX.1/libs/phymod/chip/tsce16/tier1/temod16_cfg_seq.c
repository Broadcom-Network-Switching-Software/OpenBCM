...
int temod16_pll_div_get(uint32_t pll_div)
{
    switch (pll_div) {
        case TEMOD16_PLL_MODE_DIV_70: return 70;
        case TEMOD16_PLL_MODE_DIV_66: return 66;
        case TEMOD16_PLL_MODE_DIV_64: return 64;
        case TEMOD16_PLL_MODE_DIV_60: return 60;
        case TEMOD16_PLL_MODE_DIV_92: return 92;
        case TEMOD16_PLL_MODE_DIV_80: return 80;
        case TEMOD16_PLL_MODE_DIV_54: return 54;
        default: return 0;
     }
}
...
int temod16_scramble_mode_get(PHYMOD_ST* pc, temod16_scrambler_type_t *mode)
{
  SC_X4_RSLVD0r_t    reg_resolved;
  ...
  *mode = SC_X4_RSLVD0r_SCR_MODEf_GET(reg_resolved);
