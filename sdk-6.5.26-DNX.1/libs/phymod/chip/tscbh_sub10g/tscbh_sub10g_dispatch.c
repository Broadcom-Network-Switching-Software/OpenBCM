...
__phymod__dispatch__t__ phymod_tscbh_sub10g_driver = {

    tscbh_sub10g_core_identify,
    tscbh_sub10g_core_info_get,
    tscbh_sub10g_core_lane_map_set,
    tscbh_sub10g_core_lane_map_get,
    tscbh_sub10g_core_reset_set,
    tscbh_sub10g_core_reset_get,
    NULL, /* phymod_core_firmware_info_get */
    NULL, /* phymod_phy_firmware_core_config_set */
    NULL, /* phymod_phy_firmware_core_config_get */
    tscbh_sub10g_phy_firmware_lane_config_set,
    tscbh_sub10g_phy_firmware_lane_config_get,
    NULL, /* phymod_core_pll_sequencer_restart */
    NULL, /* phymod_core_wait_event */
    tscbh_sub10g_phy_rx_restart,
    tscbh_sub10g_phy_polarity_set,
    tscbh_sub10g_phy_polarity_get,
    tscbh_sub10g_phy_tx_set,
    tscbh_sub10g_phy_tx_get,
    NULL, /* phymod_phy_training_tx_fir_post_set */
    NULL, /* phymod_phy_training_tx_fir_post_get */
    tscbh_sub10g_phy_media_type_tx_get,
    blackhawk7_l8p2_phy_tx_override_set,
    blackhawk7_l8p2_phy_tx_override_get,
    NULL, /* phymod_phy_txpi_config_set */
    NULL, /* phymod_phy_txpi_config_get */
    blackhawk7_l8p2_phy_rx_set,
    blackhawk7_l8p2_phy_rx_get,
    blackhawk7_l8p2_phy_rx_adaptation_resume,
    tscbh_sub10g_phy_reset_set,
    tscbh_sub10g_phy_reset_get,
    tscbh_sub10g_phy_power_set,
    tscbh_sub10g_phy_power_get,
    tscbh_sub10g_phy_hg2_codec_control_set,
    tscbh_sub10g_phy_hg2_codec_control_get,
    tscbh_sub10g_phy_tx_lane_control_set,
    tscbh_sub10g_phy_tx_lane_control_get,
    tscbh_sub10g_phy_rx_lane_control_set,
    tscbh_sub10g_phy_rx_lane_control_get,
    tscbh_sub10g_phy_fec_enable_set,
    tscbh_sub10g_phy_fec_enable_get,
    ...
    tscbh_sub10g_phy_autoneg_oui_set,
    tscbh_sub10g_phy_autoneg_oui_get,
    tscbh_sub10g_phy_eee_set,
    tscbh_sub10g_phy_eee_get,
    tscbh_sub10g_phy_interface_config_set,
    tscbh_sub10g_phy_interface_config_get,
    tscbh_sub10g_phy_cl72_set,
    tscbh_sub10g_phy_cl72_get,
    tscbh_sub10g_phy_cl72_status_get,
    tscbh_sub10g_phy_autoneg_ability_set,
    tscbh_sub10g_phy_autoneg_ability_get,
    tscbh_sub10g_phy_autoneg_remote_ability_get,
    tscbh_sub10g_phy_autoneg_set,
    tscbh_sub10g_phy_autoneg_get,
    tscbh_sub10g_phy_autoneg_restart_set,
    tscbh_sub10g_phy_autoneg_status_get,
    tscbh_sub10g_core_init,
    tscbh_sub10g_phy_pll_multiplier_get,
    tscbh_sub10g_phy_init,
    tscbh_sub10g_phy_loopback_set,
    tscbh_sub10g_phy_loopback_get,
    tscbh_sub10g_phy_rx_pmd_locked_get,
    blackhawk7_l8p2_phy_rx_pmd_lock_status_get,
    NULL, /* phymod_phy_local_fault_info_get */
    tscbh_sub10g_phy_rx_signal_detect_get,
    NULL, /* phymod_phy_signal_detect_status_get */
    tscbh_sub10g_phy_link_status_get,
    NULL, /* phymod_phy_status_dump */
    NULL, /* phymod_phy_pcs_userspeed_set */
    NULL, /* phymod_phy_pcs_userspeed_get */
    tscbh_sub10g_phy_reg_read,
    tscbh_sub10g_phy_reg_write,
    ...
    tscbh_sub10g_timesync_enable_set,
    tscbh_sub10g_timesync_enable_get,
    ...
    tscbh_sub10g_timesync_adjust_set,
    ...
    blackhawk7_l8p2_phy_eye_margin_est_get,
    ...
    tscbh_sub10g_phy_tx_taps_default_get,
    tscbh_sub10g_phy_lane_config_default_get,
    tscbh_sub10g_phy_firmware_load_info_get,
    ...
    tscbh_sub10g_phy_pll_reconfig,
    NULL, /* phymod_phy_pll_pwrdn */
    NULL, /* phymod_phy_linkdown_transmit_set */
    NULL, /* phymod_phy_linkdown_transmit_get */
    tscbh_sub10g_phy_synce_clk_ctrl_set,
    tscbh_sub10g_phy_synce_clk_ctrl_get,
    NULL, /* phymod_phy_pcs_enable_set */
    tscbh_sub10g_phy_rx_ppm_get,
    blackhawk7_l8p2_phy_channel_loss_hint_set,
    blackhawk7_l8p2_phy_channel_loss_hint_get,
    NULL, /* phymod_intr_handler */
    tscbh_sub10g_timesync_tx_info_get,
    ...
    blackhawk7_l8p2_phy_pmd_info_init,
    tscbh_sub10g_phy_pll_powerdown_get,
    ...
    tscbh_sub10g_phy_serdes_power_set,
