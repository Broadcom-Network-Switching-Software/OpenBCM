...
__phymod__dispatch__t__ phymod_tscbh_fe_gen2_driver = {

    tscbh_fe_gen2_core_identify,
    tscbh_fe_gen2_core_info_get,
    tscbh_fe_gen2_core_lane_map_set,
    tscbh_fe_gen2_core_lane_map_get,
    ...
    tscbh_fe_gen2_phy_firmware_lane_config_set,
    tscbh_fe_gen2_phy_firmware_lane_config_get,
    NULL, /* phymod_core_pll_sequencer_restart */
    NULL, /* phymod_core_wait_event */
    NULL, /* phymod_phy_rx_restart */
    tscbh_fe_gen2_phy_polarity_set,
    tscbh_fe_gen2_phy_polarity_get,
    tscbh_fe_gen2_phy_tx_set,
    tscbh_fe_gen2_phy_tx_get,
    NULL, /* phymod_phy_training_tx_fir_post_set */
    NULL, /* phymod_phy_training_tx_fir_post_get */
    tscbh_fe_gen2_phy_media_type_tx_get,
    blackhawk7_l2p2_phy_tx_override_set,
    blackhawk7_l2p2_phy_tx_override_get,
    blackhawk7_l2p2_phy_txpi_config_set,
    blackhawk7_l2p2_phy_txpi_config_get,
    blackhawk7_l2p2_phy_rx_set,
    blackhawk7_l2p2_phy_rx_get,
    blackhawk7_l2p2_phy_rx_adaptation_resume,
    ...
    tscbh_fe_gen2_phy_tx_lane_control_set,
    tscbh_fe_gen2_phy_tx_lane_control_get,
    tscbh_fe_gen2_phy_rx_lane_control_set,
    tscbh_fe_gen2_phy_rx_lane_control_get,
    NULL, /* phymod_phy_fec_enable_set */
    NULL, /* phymod_phy_fec_enable_get */
    tscbh_fe_gen2_phy_fec_override_set,
    tscbh_fe_gen2_phy_fec_override_get,
    ...
    tscbh_fe_gen2_phy_cl72_set,
    tscbh_fe_gen2_phy_cl72_get,
    tscbh_fe_gen2_phy_cl72_status_get,
    NULL, /* phymod_phy_autoneg_ability_set */
    NULL, /* phymod_phy_autoneg_ability_get */
    NULL, /* phymod_phy_autoneg_remote_ability_get */
    tscbh_fe_gen2_phy_autoneg_set,
    tscbh_fe_gen2_phy_autoneg_get,
    NULL, /* phymod_phy_autoneg_restart_set */
    tscbh_fe_gen2_phy_autoneg_status_get,
    tscbh_fe_gen2_core_init,
    tscbh_fe_gen2_phy_pll_multiplier_get,
    tscbh_fe_gen2_phy_init,
    tscbh_fe_gen2_phy_loopback_set,
    tscbh_fe_gen2_phy_loopback_get,
    tscbh_fe_gen2_phy_rx_pmd_locked_get,
    NULL, /* phymod_phy_rx_pmd_lock_status_get */
    NULL, /* phymod_phy_local_fault_info_get */
    tscbh_fe_gen2_phy_rx_signal_detect_get,
    ...
    tscbh_fe_gen2_phy_reg_read,
    tscbh_fe_gen2_phy_reg_write,
    ...
    tscbh_fe_gen2_timesync_enable_set,
    tscbh_fe_gen2_timesync_enable_get,
    ...
    tscbh_fe_gen2_timesync_adjust_set,
    ...
    tscbh_fe_gen2_port_enable_set,
    tscbh_fe_gen2_port_enable_get,
    blackhawk7_l2p2_phy_eye_margin_est_get,
    ...
    tscbh_fe_gen2_phy_speed_config_set,
    tscbh_fe_gen2_phy_speed_config_get,
    NULL, /* phymod_phy_op_mode_get */
    tscbh_gen2_phy_tx_taps_default_get,
    tscbh_gen2_phy_lane_config_default_get,
    tscbh_fe_gen2_phy_firmware_load_info_get,
    tscbh_fe_gen2_phy_autoneg_advert_ability_set,
    tscbh_fe_gen2_phy_autoneg_advert_ability_get,
    tscbh_fe_gen2_phy_autoneg_remote_advert_ability_get,
    NULL, /* phymod_phy_bond_in_pwrdn_override */
    tscbh_fe_gen2_phy_tx_pam4_precoder_enable_set,
    tscbh_fe_gen2_phy_tx_pam4_precoder_enable_get,
    NULL, /* phymod_phy_tx_phase_lock_rx_set */
    NULL, /* phymod_phy_tx_phase_lock_tx_set */
    tscbh_fe_gen2_phy_pll_reconfig,
    blackhawk7_l2p2_phy_pll_pwrdn,
    NULL, /* phymod_phy_linkdown_transmit_set */
    NULL, /* phymod_phy_linkdown_transmit_get */
    tscbh_fe_gen2_phy_synce_clk_ctrl_set,
    tscbh_fe_gen2_phy_synce_clk_ctrl_get,
    tscbh_fe_gen2_phy_pcs_enable_set,
    tscbh_fe_gen2_phy_rx_ppm_get,
    blackhawk7_l2p2_phy_channel_loss_hint_set,
    blackhawk7_l2p2_phy_channel_loss_hint_get,
    tscbh_intr_handler,
    tscbh_fe_gen2_timesync_tx_info_get,
    ...
    blackhawk7_l2p2_phy_pmd_info_init,
    tscbh_fe_gen2_phy_pll_powerdown_get,
    NULL, /* phymod_phy_pmd_info_size_get */
    tscbh_fe_gen2_phy_fec_bypass_indication_set,
    tscbh_fe_gen2_phy_fec_bypass_indication_get,
    tscbh_fe_gen2_phy_fec_corruption_period_set,
    tscbh_fe_gen2_phy_fec_corruption_period_get,
    ...
    tscbh_fe_gen2_phy_rx_pmd_lock_counter_get,
    tscbh_gen2_phy_fec_three_cw_bad_state_get,
    ...
    tscbh_fe_gen2_phy_flr_config_set,
    tscbh_fe_gen2_phy_flr_config_get,
    tscbh_fe_gen2_phy_fec_degraded_ser_set,
    tscbh_fe_gen2_phy_fec_degraded_ser_get,
    tscbh_fe_gen2_phy_fec_degraded_ser_status_get,
    NULL, /* phymod_phy_am_loss_align_multi_state_get */
    NULL, /* phymod_phy_temp_offset_set */
    NULL, /* phymod_phy_temp_offset_get */
    tscbh_fe_gen2_phy_fw_is_flr_supported,
    NULL, /* phymod_phy_rx_dc_offset_get */
    NULL, /* phymod_phy_uc_ram_var_set */
    NULL, /* phymod_phy_uc_ram_var_get */
    blackhawk7_l2p2_phy_external_los_enable_set,
    blackhawk7_l2p2_phy_external_los_enable_get,
};
