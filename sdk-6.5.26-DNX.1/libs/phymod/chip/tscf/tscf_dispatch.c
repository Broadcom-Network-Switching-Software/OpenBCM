...
__phymod__dispatch__t__ phymod_tscf_driver = {
    ...
    tscf_phy_fec_override_set,
    tscf_phy_fec_override_get,
    ...
    falcon_phy_rx_pmd_lock_status_get,
    NULL, /* phymod_phy_local_fault_info_get */
    tscf_phy_rx_signal_detect_get,
    tscf_phy_signal_detect_status_get,
    ...
    tscf_phy_synce_clk_ctrl_set,
    tscf_phy_synce_clk_ctrl_get,
