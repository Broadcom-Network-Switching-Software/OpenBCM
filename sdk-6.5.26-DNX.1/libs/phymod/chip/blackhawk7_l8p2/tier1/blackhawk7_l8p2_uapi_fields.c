...
uint16_t blackhawk7_l8p2_ex_uapi_ams_pll_i_clkchnl_2(srds_access_t *sa__, uint16_t reg_value) {
    BLACKHAWK7_L8P2_UAPI_INIT
    uint16_t ex_val = 0;
    switch(BLACKHAWK7_L8P2_UAPI_SWITCH) {
        case(BLACKHAWK7_L8P2_UAPI_CASE0):
            ex_val = extract_field((reg_value), 13, 11);
            break;
        default:
            EFUN_PRINTF(("ERROR: Invalid BLACKHAWK7_L8P2_UAPI_SWITCH value of '%d' for blackhawk7_l8p2_ex_uapi_ams_pll_i_clkchnl_2(..)\n", BLACKHAWK7_L8P2_UAPI_SWITCH)); 
    }
    BLACKHAWK7_L8P2_UAPI_TERMINATE
    return ex_val;
}
...
uint16_t blackhawk7_l8p2_ex_uapi_ams_pll_swind_clkchnl_2(srds_access_t *sa__, uint16_t reg_value) {
    BLACKHAWK7_L8P2_UAPI_INIT
    uint16_t ex_val = 0;
    switch(BLACKHAWK7_L8P2_UAPI_SWITCH) {
        case(BLACKHAWK7_L8P2_UAPI_CASE0):
            ex_val = extract_field((reg_value), 7, 7);
            break;
        default:
            EFUN_PRINTF(("ERROR: Invalid BLACKHAWK7_L8P2_UAPI_SWITCH value of '%d' for blackhawk7_l8p2_ex_uapi_ams_pll_swind_clkchnl_2(..)\n", BLACKHAWK7_L8P2_UAPI_SWITCH)); 
    }
    BLACKHAWK7_L8P2_UAPI_TERMINATE
    return ex_val;
}
...
uint16_t blackhawk7_l8p2_ex_uapi_ams_rx_ibias_pibuf(srds_access_t *sa__, uint16_t reg_value) {
    BLACKHAWK7_L8P2_UAPI_INIT
    uint16_t ex_val = 0;
    switch(BLACKHAWK7_L8P2_UAPI_SWITCH) {
        case(BLACKHAWK7_L8P2_UAPI_CASE0):
        ...
        case(BLACKHAWK7_L8P2_UAPI_CASE1):
            ...
            break;
        default:
            EFUN_PRINTF(("ERROR: Invalid BLACKHAWK7_L8P2_UAPI_SWITCH value of '%d' for blackhawk7_l8p2_ex_uapi_ams_rx_ibias_pibuf(..)\n", BLACKHAWK7_L8P2_UAPI_SWITCH)); 
    }
    BLACKHAWK7_L8P2_UAPI_TERMINATE
    return ex_val;
}
...
uint16_t blackhawk7_l8p2_ex_uapi_ams_pll_cap_clkchnl_1(srds_access_t *sa__, uint16_t reg_value) {
    BLACKHAWK7_L8P2_UAPI_INIT
    uint16_t ex_val = 0;
    switch(BLACKHAWK7_L8P2_UAPI_SWITCH) {
        case(BLACKHAWK7_L8P2_UAPI_CASE1):
            ...
            break;
        default:
            EFUN_PRINTF(("ERROR: Invalid BLACKHAWK7_L8P2_UAPI_SWITCH value of '%d' for blackhawk7_l8p2_ex_uapi_ams_pll_cap_clkchnl_1(..)\n", BLACKHAWK7_L8P2_UAPI_SWITCH)); 
    }
    BLACKHAWK7_L8P2_UAPI_TERMINATE
    return ex_val;
}
...
uint16_t blackhawk7_l8p2_ex_uapi_ams_pll_cap_clkchnl_1_3(srds_access_t *sa__, uint16_t reg_value) {
    BLACKHAWK7_L8P2_UAPI_INIT
    uint16_t ex_val = 0;
    switch(BLACKHAWK7_L8P2_UAPI_SWITCH) {
        case(BLACKHAWK7_L8P2_UAPI_CASE1):
            ...
            break;
        default:
            EFUN_PRINTF(("ERROR: Invalid BLACKHAWK7_L8P2_UAPI_SWITCH value of '%d' for blackhawk7_l8p2_ex_uapi_ams_pll_cap_clkchnl_1_3(..)\n", BLACKHAWK7_L8P2_UAPI_SWITCH)); 
    }
    BLACKHAWK7_L8P2_UAPI_TERMINATE
    return ex_val;
}
...
uint16_t blackhawk7_l8p2_ex_uapi_ams_rx_eq2_ctrl4(srds_access_t *sa__, uint16_t reg_value) {
    BLACKHAWK7_L8P2_UAPI_INIT
    uint16_t ex_val = 0;
    switch(BLACKHAWK7_L8P2_UAPI_SWITCH) {
        case(BLACKHAWK7_L8P2_UAPI_CASE1):
            ...
            break;
        default:
            EFUN_PRINTF(("ERROR: Invalid BLACKHAWK7_L8P2_UAPI_SWITCH value of '%d' for blackhawk7_l8p2_ex_uapi_ams_rx_eq2_ctrl4(..)\n", BLACKHAWK7_L8P2_UAPI_SWITCH)); 
    }
    BLACKHAWK7_L8P2_UAPI_TERMINATE
    return ex_val;
}
