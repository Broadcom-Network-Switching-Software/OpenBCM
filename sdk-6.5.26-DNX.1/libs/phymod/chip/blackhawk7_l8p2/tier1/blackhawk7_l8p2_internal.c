...
err_code_t blackhawk7_l8p2_INTERNAL_read_lane_state(srds_access_t *sa__, blackhawk7_l8p2_lane_state_st_t *istate) {
   INIT_SRDS_ERR_CODE
    ...
    EFUN(blackhawk7_l8p2_INTERNAL_get_stop_state_lane_state(sa__, istate)); /* Dependency on istate->pmd_lock. Updates istate->stop_state AND stop micro as well */
    istate->laneid = blackhawk7_l8p2_acc_get_lane(sa__);
    EFUN(blackhawk7_l8p2_get_rx_tuning_status(sa__, &istate->rx_tuning_done));

    EFUN(blackhawk7_l8p2_INTERNAL_get_osr_mode(sa__, &istate->osr_mode));
    EFUN(blackhawk7_l8p2_INTERNAL_get_osr_str_lane_state(sa__, istate)); /* Dependency on istate->osr_mode */
    EFUN(blackhawk7_l8p2_INTERNAL_get_uc_cfg_lane_state(sa__, istate));
    ESTM(istate->UC_STS = rdv_status_byte());
    ESTM(istate->UC_STS_EXT = rdv_ext_status_word());
    EFUN(blackhawk7_l8p2_INTERNAL_get_rx_pam_mode_lane_state(sa__, istate));
    ...
    EFUN(blackhawk7_l8p2_INTERNAL_get_clk_lane_state(sa__, istate));
    EFUN(blackhawk7_l8p2_INTERNAL_decode_br_os_mode(sa__, &istate->CDR));
    EFUN(blackhawk7_l8p2_INTERNAL_get_pf_lane_state(sa__, istate));
    ...
    EFUN(blackhawk7_l8p2_INTERNAL_get_TP0_lane_state(sa__, istate)); /* Dependency on istate->rx_pam_mode */
    ...
    EFUN(blackhawk7_l8p2_INTERNAL_get_eq_debug1_lane_state(sa__, istate)); /* Dependency on istate->rx_pam_mode */
    EFUN(blackhawk7_l8p2_INTERNAL_get_afe_bw_lane_state(sa__, istate)); /* Dependency on istate->rx_pam_mode */
    ...
    EFUN(blackhawk7_l8p2_INTERNAL_get_afe_bw_metric_lane_state(sa__, istate)); /* Dependency on istate->TP1 and istate->blind_ctle_trnsum */
    ESTM(istate->tp_metric_prec1 = rdv_usr_status_tp_metric_1());
    EFUN(blackhawk7_l8p2_INTERNAL_get_dfe_lane_state(sa__, istate)); /* Dependency on istate->rx_pam_mode */
    ...
    EFUN(blackhawk7_l8p2_INTERNAL_get_txfir_lane_state(sa__, istate));
    ...
    EFUN(blackhawk7_l8p2_INTERNAL_get_disable_eye_lane_state(sa__, istate));
    EFUN(blackhawk7_l8p2_INTERNAL_get_link_time(sa__, &istate->link_time));
    EFUN(blackhawk7_l8p2_INTERNAL_get_pmd_lock_chg_lane_state(sa__, istate));  /* Depedency on istate->pmd_lock */
    ...
    EFUN(blackhawk7_l8p2_INTERNAL_resume_micro_lane_state(sa__, istate)); /* Dependency on istate->stop_state */

    EFUN(blackhawk7_l8p2_INTERNAL_get_BER_string(sa__, 100, istate->BER, sizeof(istate->BER)));
    EFUN(blackhawk7_l8p2_INTERNAL_get_uc_sts_decoded_lane_state(sa__, istate)); /* Dependency on istate->UC_STS and istate->UC_STS_EXT */
...
err_code_t blackhawk7_l8p2_INTERNAL_get_stop_state_lane_state(srds_access_t *sa__, blackhawk7_l8p2_lane_state_st_t *st) {
    ...
    st->stop_state = blackhawk7_l8p2_INTERNAL_stop_micro(sa__,st->pmd_lock,&err_code);
...
err_code_t blackhawk7_l8p2_INTERNAL_get_pmd_lock_chg_lane_state(srds_access_t *sa__, blackhawk7_l8p2_lane_state_st_t *st) {
    ...
    if (st->pmd_lock != rx_lock_at_end) {
        USR_PRINTF(("WARNING: Lane %d rx_lock status changed while reading lane state (rx_lock_start=%d, rx_lock_chg_start=%d, rx_lock_at_end=%d, rx_lock_chg_at_end=%d) \n",
                    blackhawk7_l8p2_acc_get_lane(sa__), st->pmd_lock, st->pmd_lock_chg, rx_lock_at_end, rx_lock_chg_at_end));
    }
...
err_code_t blackhawk7_l8p2_INTERNAL_get_osr_str_lane_state(srds_access_t *sa__, blackhawk7_l8p2_lane_state_st_t *st) {
    ...
    if(st->osr_mode.tx_rx != 255) {
        tx = blackhawk7_l8p2_INTERNAL_get_osr_str(st->osr_mode.tx_rx, GET_OSR_STR_LONG);
        USR_SNPRINTF(st->tx_osr_mode_str, sizeof(st->tx_osr_mode_str), "%s", tx);
    }
    else {
        tx = blackhawk7_l8p2_INTERNAL_get_osr_str(st->osr_mode.tx, GET_OSR_STR_SHORT);
        rx = blackhawk7_l8p2_INTERNAL_get_osr_str(st->osr_mode.rx, GET_OSR_STR_SHORT);
        USR_SNPRINTF(st->tx_osr_mode_str, sizeof(st->tx_osr_mode_str), "%s", tx);
...
err_code_t blackhawk7_l8p2_INTERNAL_get_uc_sts_decoded_lane_state(srds_access_t *sa__, blackhawk7_l8p2_lane_state_st_t *st) {
    ...
    if(st->UC_STS != 0) {
        EFUN(blackhawk7_l8p2_decode_uc_sts(sa__, st->UC_STS, st->uc_sts_decoded, sizeof(st->uc_sts_decoded), prepend));
    }
    if(st->UC_STS_EXT != 0) {
        EFUN(blackhawk7_l8p2_decode_uc_sts_ext(sa__, st->UC_STS_EXT, st->uc_sts_ext_decoded, sizeof(st->uc_sts_ext_decoded), prepend));
    }
    return ERR_CODE_NONE;
}
...
err_code_t blackhawk7_l8p2_INTERNAL_get_TP0_lane_state(srds_access_t *sa__, blackhawk7_l8p2_lane_state_st_t *st) {
    ...
    if (st->rx_pam_mode == NRZ) {
        ...
        EFUN(blackhawk7_l8p2_INTERNAL_ladder_setting_to_mV(sa__, (int8_t)st->TP0, 0, INVALID_SLICER, &st->TP0));
    }
    else {
...
err_code_t blackhawk7_l8p2_INTERNAL_get_pf_lane_state(srds_access_t *sa__, blackhawk7_l8p2_lane_state_st_t *st) {
    INIT_SRDS_ERR_CODE
    EFUN(blackhawk7_l8p2_read_rx_afe(sa__, RX_AFE_PF2, &st->pf2_ctrl));
    EFUN(blackhawk7_l8p2_read_rx_afe(sa__, RX_AFE_PF3, &st->pf3_ctrl));
    EFUN(blackhawk7_l8p2_read_rx_afe(sa__, RX_AFE_PF, &st->pf_main));
    return ERR_CODE_NONE;
}
...
err_code_t blackhawk7_l8p2_INTERNAL_get_dfe_lane_state(srds_access_t *sa__, blackhawk7_l8p2_lane_state_st_t *st) {
    INIT_SRDS_ERR_CODE
    if (st->rx_pam_mode == NRZ) {
        EFUN(blackhawk7_l8p2_INTERNAL_get_rx_dfe1(sa__, &st->DFE1));
    }
    EFUN(blackhawk7_l8p2_INTERNAL_get_rx_dfe2(sa__, &st->DFE2));
    EFUN(blackhawk7_l8p2_INTERNAL_get_rx_dfe3(sa__, &st->DFE3));
    EFUN(blackhawk7_l8p2_INTERNAL_get_rx_dfe4(sa__, &st->DFE4));
    EFUN(blackhawk7_l8p2_INTERNAL_get_rx_dfe5(sa__, &st->DFE5));
    EFUN(blackhawk7_l8p2_INTERNAL_get_rx_dfe6(sa__, &st->dfe6));
    return ERR_CODE_NONE;
}
...
err_code_t blackhawk7_l8p2_INTERNAL_get_txfir_lane_state(srds_access_t *sa__, blackhawk7_l8p2_lane_state_st_t *st) {
    ...
    for (tap_num=0; tap_num<TXFIR_ST_NUM_TAPS; ++tap_num) {
        EFUN(blackhawk7_l8p2_INTERNAL_get_tx_tap(sa__, tap_num, &st->txfir.tap[tap_num]));
    }
...
static const enum blackhawk7_l8p2_pll_div_enum _blackhawk7_l8p2_div_candidates[] = {
    ...
    BLACKHAWK7_L8P2_PLL_DIV_141P4285714,
    BLACKHAWK7_L8P2_PLL_DIV_165P0025695,
    BLACKHAWK7_L8P2_PLL_DIV_170P0026474,
    BLACKHAWK7_L8P2_PLL_DIV_171P347605,
    BLACKHAWK7_L8P2_PLL_DIV_176P7857143,
    BLACKHAWK7_L8P2_PLL_DIV_177P5316456,
