...
enum_mapping_t phymod_core_version_t_mapping[] = {
    ...
    {"TscbhFeGen2", phymodCoreVersionTscbhFeGen2},
    {"Blackhawk7_l2p2", phymodCoreVersionBlackhawk7_l2p2},
    {"Tscbh_sub10g", phymodCoreVersionTscbh_sub10g},
    {NULL, 0}
};
...
enum_mapping_t phymod_tscbh_pll_multiplier_t_mapping[] = {
    ...
    {"DIV179P6875327", phymod_TSCBH_PLL_DIV179P6875327},
    {"DIV141P4285714", phymod_TSCBH_PLL_DIV141P4285714},
    {"DIV171P347605", phymod_TSCBH_PLL_DIV171P347605},
    {"DIV176P7857143", phymod_TSCBH_PLL_DIV176P7857143},
    {"DIV177P5316456", phymod_TSCBH_PLL_DIV177P5316456},
    {"DIV178P8955584", phymod_TSCBH_PLL_DIV178P8955584},
    {NULL, 0}
};
...
enum_mapping_t phymod_fec_type_t_mapping[] = {
    ...
    {"RS276", phymod_fec_RS276},
    {"RS552", phymod_fec_RS552},
    {NULL, 0}
};
...
enum_mapping_t phymod_interrupt_type_t_mapping[] = {
    ...
    {"EccDslDataFifo", phymodIntrEccDslDataFifo},
    {"EccTx1588_2Mpp0", phymodIntrEccTx1588_2Mpp0},
    {"EccRx1588_2Mpp1", phymodIntrEccRx1588_2Mpp1},
    {"EccRx1588_2Mpp0", phymodIntrEccRx1588_2Mpp0},
    {NULL, 0}
};
...
enum_mapping_t phymod_an_timer_t_mapping[] = {
    {"None", phymodAnTimerNone},
    {"LinkFailInhibitLtPam4", phymodAnTimerLinkFailInhibitLtPam4},
    {NULL, 0}
};

enum_mapping_t phymod_phy_flr_timeout_t_mapping[] = {
    {"Invaild", phymodFlrTimeoutInvaild},
    {"50ms", phymodFlrTimeout50ms},
    {"75ms", phymodFlrTimeout75ms},
    {"100ms", phymodFlrTimeout100ms},
    {"150ms", phymodFlrTimeout150ms},
    {"250ms", phymodFlrTimeout250ms},
    {"500ms", phymodFlrTimeout500ms},
    {NULL, 0}
};

enum_mapping_t phymod_uc_ram_variable_t_mapping[] = {
    {"PAM4_LT_NR_ER_LMT_BIAS_OSX1", phymodUcRAMVar_PAM4_LT_NR_ER_LMT_BIAS_OSX1},
    {"PAM4_LT_NR_ER_LMT_BIAS_OSX2", phymodUcRAMVar_PAM4_LT_NR_ER_LMT_BIAS_OSX2},
    {"PAM4_LT_NR_ER_LMT2_BIAS_OSX1", phymodUcRAMVar_PAM4_LT_NR_ER_LMT2_BIAS_OSX1},
    {"PAM4_LT_NR_ER_LMT2_BIAS_OSX2", phymodUcRAMVar_PAM4_LT_NR_ER_LMT2_BIAS_OSX2},
    {"SIGNAL_DETECT_THRESHOLD", phymodUcRAMVar_SIGNAL_DETECT_THRESHOLD},
    {NULL, 0}
};
