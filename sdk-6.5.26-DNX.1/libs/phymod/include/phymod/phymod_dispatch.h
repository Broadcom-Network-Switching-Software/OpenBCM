...
typedef int (*__dispatch__phymod_phy_signal_detect_status_get_f)(const phymod_phy_access_t* phy, phymod_signal_detect_status_t* sd_status);
...
typedef int (*__dispatch__phymod_timesync_adjust_set_f)(const phymod_phy_access_t* phy, uint32_t flags, const phymod_timesync_adjust_config_info_t* config_info);
...
typedef int (*__dispatch__phymod_intr_handler_f)(const phymod_phy_access_t* phy, phymod_interrupt_type_t type, uint32_t* is_handled, phymod_intr_info_t* info);
...
typedef int (*__dispatch__phymod_phy_temp_offset_set_f)(const phymod_phy_access_t* phy, int temp_offset);
typedef int (*__dispatch__phymod_phy_temp_offset_get_f)(const phymod_phy_access_t* phy, int* temp_offset);
typedef int (*__dispatch__phymod_phy_fw_is_flr_supported_f)(const phymod_phy_access_t* phy, uint32_t* flr_support);
typedef int (*__dispatch__phymod_phy_rx_dc_offset_get_f)(const phymod_phy_access_t* phy, uint32_t* rx_dc_offset);
typedef int (*__dispatch__phymod_phy_uc_ram_var_set_f)(const phymod_phy_access_t* phy, phymod_uc_ram_variable_t ram_var, int16_t value);
typedef int (*__dispatch__phymod_phy_uc_ram_var_get_f)(const phymod_phy_access_t* phy, phymod_uc_ram_variable_t ram_var, int16_t* value);
typedef int (*__dispatch__phymod_phy_external_los_enable_set_f)(const phymod_phy_access_t* phy, uint32_t enable);
typedef int (*__dispatch__phymod_phy_external_los_enable_get_f)(const phymod_phy_access_t* phy, uint32_t* enable);
...
typedef struct __phymod__dispatch__s__ {
    ...
    __dispatch__phymod_phy_signal_detect_status_get_f                                f_phymod_phy_signal_detect_status_get;
    ...
    __dispatch__phymod_phy_temp_offset_set_f                                         f_phymod_phy_temp_offset_set;
    __dispatch__phymod_phy_temp_offset_get_f                                         f_phymod_phy_temp_offset_get;
    __dispatch__phymod_phy_fw_is_flr_supported_f                                     f_phymod_phy_fw_is_flr_supported;
    __dispatch__phymod_phy_rx_dc_offset_get_f                                        f_phymod_phy_rx_dc_offset_get;
    __dispatch__phymod_phy_uc_ram_var_set_f                                          f_phymod_phy_uc_ram_var_set;
    __dispatch__phymod_phy_uc_ram_var_get_f                                          f_phymod_phy_uc_ram_var_get;
    __dispatch__phymod_phy_external_los_enable_set_f                                 f_phymod_phy_external_los_enable_set;
    __dispatch__phymod_phy_external_los_enable_get_f                                 f_phymod_phy_external_los_enable_get;
