...
typedef enum phymod_dispatch_type_e {
    ...
    phymodDispatchTypeTscbh_sub10g,
...
#define PHYMOD_ACC_F_DUAL_CORE 0x100 /**< Dual PCS core access */
...
#define PHYMOD_ACC_F_DUAL_CORE_SET(access) ((access)->flags |= PHYMOD_ACC_F_DUAL_CORE)
...
#define PHYMOD_ACC_F_DUAL_CORE_CLR(access) ((access)->flags &= ~PHYMOD_ACC_F_DUAL_CORE)
...
#define PHYMOD_ACC_F_DUAL_CORE_GET(access) ((access)->flags & PHYMOD_ACC_F_DUAL_CORE ? 1 : 0)
...
typedef struct phymod_firmware_lane_config_s {
    ...
    uint32_t AnForceExtendedReach; /**< Forced extended reach mode during AN */
    uint32_t AnForceNormalReach; /**< Forced normal reach mode during AN */
...
typedef struct phymod_tx_s {
    ...
    int16_t is_cpo; /**< Indicates whether the lane belongs to a CoPackaged Optics (CPO) port */
} phymod_tx_t;
...
#define PHYMOD_PHY_INIT_F_TX_PCS_INTF_DLY_MODE_EN 0x10 /**< flag to enable tx_pcs_intf_dly_mode */
...
#define PHYMOD_PHY_INIT_F_TX_PCS_INTF_DLY_MODE_EN_SET(conf) ((conf)->flags |= PHYMOD_PHY_INIT_F_TX_PCS_INTF_DLY_MODE_EN)
...
#define PHYMOD_PHY_INIT_F_TX_PCS_INTF_DLY_MODE_EN_CLR(conf) ((conf)->flags &= ~PHYMOD_PHY_INIT_F_TX_PCS_INTF_DLY_MODE_EN)
...
#define PHYMOD_PHY_INIT_F_TX_PCS_INTF_DLY_MODE_EN_GET(conf) ((conf)->flags & PHYMOD_PHY_INIT_F_TX_PCS_INTF_DLY_MODE_EN ? 1 : 0)
 ...
 *
 * @brief Get rx signal detect indication 
 *
 * @param [in]  phy             - phy access information
...
typedef struct phymod_signal_detect_status_s {
    uint32_t signal_detect_bmp; /**< The SD bitmap for the lane mask */
    uint32_t signal_detect_change_bmp; /**< The SD change bimap for the lane mask */
} phymod_signal_detect_status_t;

/* phymod_signal_detect_status_t initialization and validation */
...
/*! 
 * phymod_phy_signal_detect_status_get
 *
 * @brief Get phy signal detect and signal detect change status 
 *
 * @param [in]  phy             - phy access information
 * @param [out]  sd_status       - phy signal detect status
 */
...
/*!
 * @struct phymod_timesync_adjust_config_info_s
 * @brief 1588 timesync configuration information. 
 */ 
typedef struct phymod_timesync_adjust_config_info_s {
    phymod_timesync_compensation_mode_t am_norm_mode; /**< AM Compensation Mode */
...
/* phymod_timesync_adjust_config_info_t initialization and validation */
 ...
 * @param [in]  config_info     - Timesync Adjust Configuration info.
 */
...
#define PHYMOD_SPEED_CONFIG_IN_OTN_MODE 0x8
...
#define PHYMOD_SPEED_CONFIG_IN_OTN_MODE_SET(speed_config) ((speed_config)->flags |= PHYMOD_SPEED_CONFIG_IN_OTN_MODE)
...
#define PHYMOD_SPEED_CONFIG_IN_OTN_MODE_CLR(speed_config) ((speed_config)->flags &= ~PHYMOD_SPEED_CONFIG_IN_OTN_MODE)
...
#define PHYMOD_SPEED_CONFIG_IN_OTN_MODE_GET(speed_config) ((speed_config)->flags & PHYMOD_SPEED_CONFIG_IN_OTN_MODE ? 1 : 0)
...
typedef struct phymod_intr_info_s {
    phymod_mem_type_t mem_type; /**< Memory Type */
    int mem_addr; /**< Memory Address */
} phymod_intr_info_t;

/* phymod_intr_info_t initialization and validation */
 ...
 * @param [out]  info            - Interrupt information.
 */
 ...
 *
 * @brief  set or get the Die Temperature Offset for Port Macro 
 *
 * @param [in]  phy             - phy access information
 * @param [in]  temp_offset     - Die Temp Offset
 */
 ...
 *
 * @param [in]  phy             - phy access information
 * @param [out]  temp_offset     - Die Temp Offset
 */
 ...
 *
 * @brief  Checks if firmware is FLR supported 
 *
 * @param [in]  phy             - phy access information
 * @param [out]  flr_support     - Firmware supports Fast link recovery
 */
int phymod_phy_fw_is_flr_supported(const phymod_phy_access_t* phy, uint32_t* flr_support);

/*! 
 * phymod_phy_rx_dc_offset_get
 *
 * @brief Get rx dc offset 
 *
 * @param [in]  phy             - phy access information
 * @param [out]  rx_dc_offset    - rx dc offset
 */
int phymod_phy_rx_dc_offset_get(const phymod_phy_access_t* phy, uint32_t* rx_dc_offset);


/*!
 * @enum phymod_uc_ram_variable_e
 * @brief Access UC RAM variable 
 */ 
typedef enum phymod_uc_ram_variable_e {
    phymodUcRAMVar_PAM4_LT_NR_ER_LMT_BIAS_OSX1 = 1, /**< PAM4 NR and ER lmt bias in OSX1 */
    phymodUcRAMVar_PAM4_LT_NR_ER_LMT_BIAS_OSX2, /**< PAM4 NR and ER lmt bias in OSX2 */
    phymodUcRAMVar_PAM4_LT_NR_ER_LMT2_BIAS_OSX1, /**< PAM4 NR and ER lmt2 bias in OSX1 */
    phymodUcRAMVar_PAM4_LT_NR_ER_LMT2_BIAS_OSX2, /**< PAM4 NR and ER lmt2 bias in OSX2 */
    phymodUcRAMVar_SIGNAL_DETECT_THRESHOLD, /**< Signal detect threshold */
    phymodUcRAMVar_Count
} phymod_uc_ram_variable_t;

#ifdef PHYMOD_DIAG
extern enum_mapping_t phymod_uc_ram_variable_t_mapping[];
#endif /*PHYMOD_DIAG*/

/* phymod_uc_ram_variable_t validation */
int phymod_uc_ram_variable_t_validate(phymod_uc_ram_variable_t phymod_uc_ram_variable);
/*! 
 * phymod_phy_uc_ram_var_set
 *
 * @brief  Set/Get Uc RAM variable value 
 *
 * @param [in]  phy             - phy access information
 * @param [in]  ram_var         - uC RAM variable
 * @param [in]  value           - set value to uC RAM variable
 */
int phymod_phy_uc_ram_var_set(const phymod_phy_access_t* phy, phymod_uc_ram_variable_t ram_var, int16_t value);
/*! 
 * phymod_phy_uc_ram_var_get
 *
 * @brief  Set/Get Uc RAM variable value 
 *
 * @param [in]  phy             - phy access information
 * @param [in]  ram_var         - uC RAM variable
 * @param [out]  value           - get value from uC RAM variable
 */
int phymod_phy_uc_ram_var_get(const phymod_phy_access_t* phy, phymod_uc_ram_variable_t ram_var, int16_t* value);

/*! 
 * phymod_phy_external_los_enable_set
 *
 * @brief port enable set 
 *
 * @param [in]  phy             - phy access information
 * @param [in]  enable          - 
 */
int phymod_phy_external_los_enable_set(const phymod_phy_access_t* phy, uint32_t enable);
/*! 
 * phymod_phy_external_los_enable_get
 *
 * @brief port enable set 
 *
 * @param [in]  phy             - phy access information
 * @param [out]  enable          - 
 */
int phymod_phy_external_los_enable_get(const phymod_phy_access_t* phy, uint32_t* enable);
