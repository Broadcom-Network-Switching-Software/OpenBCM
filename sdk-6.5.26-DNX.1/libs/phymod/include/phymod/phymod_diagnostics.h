...
typedef enum phymod_eyescan_mode_e {
    ...
    phymodEyescanModeIntrusive, /**< Intrusive eyescan resolution. */
...
typedef enum phymod_diag_type_e {
    ...
    phymod_diag_DFE_TAPS = 0x00040000, /**< General device wide information.  */
    phymod_diag_Count
} phymod_diag_type_t;
...
/*!
 * @enum phymod_phy_tx_pattern_e
 * @brief phy tx pattern 
 */ 
typedef enum phymod_phy_tx_pattern_e {
    phymodPhyTxPatternOff = 0, /**< Tx Pattern Off */
    phymodPhyTxPatternPAM4_JP03B, /**< JP03B tx pattern enable */
    phymodPhyTxPatternPAM4_Linear, /**< PAM4 linear tx pattern  */
    phymodPhyTxPatternCustom, /**< User defined Custom Phy tx pattern  */
    phymodPhyTxPatternCount
} phymod_phy_tx_pattern_t;

#ifdef PHYMOD_DIAG
extern enum_mapping_t phymod_phy_tx_pattern_t_mapping[];
#endif /*PHYMOD_DIAGNOSTICS_DIAG*/

/* phymod_phy_tx_pattern_t validation */
int phymod_phy_tx_pattern_t_validate(phymod_phy_tx_pattern_t phymod_phy_tx_pattern);
#define PHYMOD_NUM_CUSTOM_PATTERN_WORD 8 /**< Nummber of PHY Tx Custom pattern 32 bit words */

/*! 
 * phymod_phy_tx_pattern_set
 *
 * @brief  phy tx pattern mode set/get 
 *
 * @param [in]  phy             - phy access information
 * @param [in]  tx_pattern      - Phy Tx Pattern 
 */
 ...
 *
 * @param [in]  phy             - phy access information
 * @param [out]  tx_pattern      - Phy Tx Pattern 
 */
...
typedef enum phymod_linkCAT_op_mode_e {
    ...
    phymodlinkCAT_RX_MODE = 1, /**< Receive */
    phymodlinkCAT_LPBK_MODE = 2, /**< Loop back */
    phymodlinkCAT_PRE_RX = 7, /**< Pre Rx */
    phymodlinkCAT_RX_MEASURE = 8, /**< Rx Measure */
    phymodlinkCAT_DNC_OSR_UNSET = 256, /**< 50G NRZ */
    phymodlinkCAT_DNC_OSR_SET = 257, /**< 25G NRZ */
    phymodlinkCAT_Count
...
/*!
 * @struct phymod_linkcat_config_s
 * @brief  Link Channel Analysis Tool configuration. 
 */ 
typedef struct phymod_linkcat_config_s {
    phymod_linkCAT_op_mode_t mode;
    int donot_change_osr;
} phymod_linkcat_config_t;

/* phymod_linkcat_config_t initialization and validation */
 ...
 *
 * @param [in]  phy             - phy access information
 * @param [in]  linkcat_config   - LinkCat configuration
 */
 ...
 *
 * @brief Get FEC error bits Counter 
 *
 * @param [in]  phy             - phy access information
 * @param [out]  count           - FEC error bits counter
 */
