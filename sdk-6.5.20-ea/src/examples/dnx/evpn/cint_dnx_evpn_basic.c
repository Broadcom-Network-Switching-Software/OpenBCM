    ...
    int unit)
{
    ...
    if (egress_mc && (system_headers_mode == 0) && (*dnxc_data_get(unit, "fabric", "general", "is_supported", NULL)))
    {
    ...
    int p2_port)
{
    ...
    rv = bcm_port_control_set(unit, recyle_port, bcmPortControlOverlayRecycle, 1);
    if (rv != BCM_E_NONE)
    {
