...
typedef enum bcm_switch_control_e {
    ...
    bcmSwitch__Count = 1376             /* Must be last.  Not a usable value. */
...
typedef enum bcm_switch_reflector_type_e {
    ...
    bcmSwitchReflectorTwampIp4 = 3,     /* TWAMP reflector over IPv4 */
    bcmSwitchReflectorTwampIp6 = 4,     /* TWAMP reflector over IPv6 */
    bcmSwitchReflectorSbfdIp4 = 5,      /* SBFD reflector over IPv4 */
    bcmSwitchReflectorSbfdIp6 = 6,      /* SBFD reflector over IPv6 */
    bcmSwitchReflectorSbfdMpls = 7      /* SBFD reflector over MPLS */
