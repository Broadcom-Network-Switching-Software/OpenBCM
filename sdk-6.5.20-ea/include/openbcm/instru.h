...
typedef enum bcm_instru_synced_counters_icgm_type_e {
    ...
    bcmInstruSyncedCountersIcgmTypeMinFreeVsqSharedPoolIndex0Bytes = 8, 
    bcmInstruSyncedCountersIcgmTypeMinFreeVsqSharedPoolIndex1Bytes = 9, 
    bcmInstruSyncedCountersIcgmTypeMinFreeVsqOcbHeadroomBuffers = 10, 
    bcmInstruSyncedCountersIcgmTypeMinFreeVsqOcbSharedPoolIndex0Buffers = 11, 
    bcmInstruSyncedCountersIcgmTypeMinFreeVsqOcbSharedPoolIndex1Buffers = 12, 
    bcmInstruSyncedCountersIcgmTypeMinFreeVsqOcbHeadroomPDBs = 13, 
    bcmInstruSyncedCountersIcgmTypeMinFreeVsqOcbSharedPoolIndex0PDBs = 14, 
    bcmInstruSyncedCountersIcgmTypeMinFreeVsqOcbSharedPoolIndex1PDBs = 15, 
    bcmInstruSyncedCountersIcgmTypeEnqueuePackets = 16, 
    bcmInstruSyncedCountersIcgmTypeEnqueueBytes = 17, 
    bcmInstruSyncedCountersIcgmTypeRejectPackets = 18, 
    bcmInstruSyncedCountersIcgmTypeRejectBytes = 19, 
    bcmInstruSyncedCountersIcgmTypeDequeuePackets = 20, 
    bcmInstruSyncedCountersIcgmTypeDequeueBytes = 21 
...
/* Defines the types of synchronized counters mechanism to be collected */
typedef enum bcm_instru_synced_counters_record_source_type_e {
    bcmInstruSyncedCountersRecordTypeIcgm = 0, 
    bcmInstruSyncedCountersRecordTypeNifTraffic = 1, 
    bcmInstruSyncedCountersRecordTypeNifPfc = 2, 
    bcmInstruSyncedCountersRecordTypeCount = 3 
} bcm_instru_synced_counters_record_source_type_t;
...
typedef struct bcm_instru_synced_counters_data_s {
    ...
    int record_arr_counters_type[BCM_INSTRU_SYNCED_COUNTERS_STATS_MAX]; /* The list of counters in each record,
                                           represented as the relevant ENUM
                                           (bcm_instru_synced_counters_icgm_type_t
                                           or
                                           bcm_instru_synced_counters_nif_type_t) */
...
typedef struct bcm_instru_synced_counters_records_key_s {
    bcm_core_t core_id;                 /* The core from which we read the
                                           counters. */
    bcm_instru_synced_counters_record_source_type_t record_source_type; /* Source type of synchronized counters
                                           mechanism. */
