...
typedef enum bcm_mirror_truncate_mode_e {
    ...
    bcmMirrorTruncateCount = 2          /* Last member, not a usable value. */
...
typedef enum bcm_mirror_source_type_e {
    ...
    bcmMirrorSourceTypeCount = 7        /* Must Be Last. Not a valid value. */
...
typedef enum bcm_mirror_ingress_mod_event_e {
    ...
    bcmMirrorIngModEventBpduProtocol = 141, /* Enable to select BPDU packet copied
                                           to CPU. */
    bcmMirrorIngModEventCount = 142     /* Must be last. Not a valid value. */
...
typedef struct bcm_mirror_truncate_length_profile_s {
    int adjustment_length;  /* Mirror payload adjustment length after
                               truncation. */
