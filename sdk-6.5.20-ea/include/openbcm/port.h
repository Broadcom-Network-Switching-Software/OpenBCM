...
typedef enum bcm_port_class_e {
    ...
    bcmPortClassOpaqueCtrlId = 42,      /* Control ID available for IFP key
                                           selection */
    bcmPortClassEgressOpaqueCtrlId = 43, /* Control ID available for EFP key
                                           selection */
    bcmPortClassCount = 44              /* Last enum value. */
} bcm_port_class_t;
