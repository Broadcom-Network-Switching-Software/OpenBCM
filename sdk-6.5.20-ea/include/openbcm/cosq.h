...
typedef enum bcm_cosq_control_e {
    ...
    bcmCosqControlEgressPoolToIngressPoolMap = 246, /* Associate egress service pool to
                                           ...
                                           ingress pool [3..0]. */
    bcmCosqControlEgressPoolRQEDataBufferSharedLimitBytes = 247, /* Specify the per egress pool RQE share
                                           limit of data buffers. */
    bcmCosqControlEgressPoolRQEDataBufferResumeLimitBytes = 248 /* Specify the per egress pool RQE
                                           resume limit of data buffers. */
} bcm_cosq_control_t;
