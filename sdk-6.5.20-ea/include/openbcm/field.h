...
typedef enum bcm_field_qualify_e {
    ...
    bcmFieldQualifyPccHit = 1205,       /* Qualifies on SLLB PCC table hit
                                           status. */
    bcmFieldQualifyCount = 1206         /* Always Last. Not a usable value. */
} bcm_field_qualify_t;
...
typedef enum bcm_field_AppType_e {
    ...
    bcmFieldAppTypeVip6Direct = 48,     /* SLLB non-VIP IPv6 forwarding on VIP
                                           enabled interfaces. */
    bcmFieldAppTypeCount = 49           /* Always Last. Not a usable value. */
} bcm_field_AppType_t;
...
typedef enum bcm_field_LoopbackType_e {
    ...
    bcmFieldLoopbackTypeMasqueradeWithSwitchDropIndication = 20, /* Loopback header with switch probe
                                           Drop Indicator */
    bcmFieldLoopbackTypeCount = 21      /* Always Last. Not a usable value. */
...
typedef enum bcm_field_action_e {
    ...
    bcmFieldActionIntStatReq1 = 727,    /* Inband telemetry stat request 1
                                           actions. */
    bcmFieldActionSubportSvtagSignature = 728, /* This action adds SVTAG signature in
                                           the SVTAG header. */
    bcmFieldActionSubportSvtagPayloadOffset = 729, /* This action adds payload offset in
                                           the SVTAG header. */
    bcmFieldActionSubportSvtagPrio = 730, /* This action adds priority in the
                                           SVTAG header. */
    bcmFieldActionSubportSvtagDeviceId = 731, /* This action adds device id in the
                                           SVTAG header. */
    bcmFieldActionSubportSvtagPktType = 732, /* This action adds packet type in the
                                           SVTAG header. It can be MACSEC packet
                                           type also */
    bcmFieldActionSubportSvtagSubportNum = 733, /* This action adds channel or subport
                                           number in the SVTAG header. */
    bcmFieldActionSubportSvtagEnable = 734, /* This action enables SVTAG addition to
                                           the packet. */
    ...
    bcmFieldActionCount = 794           /* Always Last. Not a usable value. */
} bcm_field_action_t;
...
{ \
    ...
    "IntStatReq0", \
    "IntStatReq1", \
    "SubportSvtagSignature", \
    "SubportSvtagPayloadOffset", \
    "SubportSvtagPrio", \
    "SubportSvtagDeviceId", \
    "SubportSvtagPktType", \
    "SubportSvtagSubportNum", \
    "SubportSvtagEnable", \
...
typedef enum bcm_field_control_e {
    ...
    bcmFieldControlCount = 36           /* Always last. Not a usable value. */
} bcm_field_control_t;
...
typedef enum bcm_field_hint_type_e {
    ...
    bcmFieldHintTypeCount = 7           /* Always Last. Not a usable value. */
...
typedef enum bcm_field_l2_pkt_type_e {
    ...
    bcmFieldL2PktTypeLastCount = 7  /* Always Last. Not a usable value. */
...
typedef enum bcm_field_egress_flow_control_e {
    ...
    bcmFieldEgressFlowControlCount = 24 /* Always last. Not to be used. */
...
typedef enum bcm_field_egress_flow_encap_e {
    ...
    bcmFieldEgressFlowEncapCount = 14   /* Always last. Not to be used. */
...
typedef enum bcm_field_ace_context_e {
    ...
    bcmFieldAceContextCount = 7         /* Always last. Not a usable value. */
...
/* 
 * This enum contains all values of configurable(user-defined) range
 * types
 */
typedef enum bcm_field_range_config_e {
    bcmFieldRangeConfigInvalid = -1,    /* Invalid Param. */
    bcmFieldRangeConfigFirst = 0,       /* First param */
    bcmFieldRangeConfigUserDefined1 = bcmFieldRangeConfigFirst, /* First user-defined range */
    bcmFieldRangeConfigUserDefined2 = 1, /* Second user-defined range */
    bcmFieldRangeConfigCount = 2        /* Always last. Not a usable value. */
...
typedef enum bcm_field_drop_reason_e {
    ...
    bcmFieldDropReasonCMLFlags = 1,     /* Drop reason CML flags */
    bcmFieldDropReasonL2SrcStaticMove = 2, /* Drop reason L2 src static move */
    bcmFieldDropReasonL2SrcDiscard = 3, /* Drop reason L2 src discard */
    bcmFieldDropReasonMacSaMulticast = 4, /* Drop reason MacSa Multicast */
    bcmFieldDropReasonOuterTpidCheckFailed = 5, /* Drop reason Outer TPID check failed */
    bcmFieldDropReasonIncomingPvlanCheckFailed = 6, /* Drop reason Incoming PVLAN check
                                           failed */
    bcmFieldDropReasonPktIntegrityCheckFailed = 7, /* Drop reason Pkt integrity check
                                           failed */
    bcmFieldDropReasonProtocolPktDrop = 8, /* Drop reason Protocol packet drop */
    bcmFieldDropReasonMembershipCheckFailed = 9, /* Drop reason Membership check failed */
    bcmFieldDropReasonSpanningTreeCheckFailed = 10, /* Drop reason spanning tree check
                                           failed */
    bcmFieldDropReasonL2DstLookupMiss = 11, /* Drop reason L2 Dst lookup miss */
    bcmFieldDropReasonL2DstDiscard = 12, /* Drop reason L2 Dst discard */
    bcmFieldDropReasonL3DstLookupMiss = 13, /* Drop reason L3 Dst lookup miss */
    bcmFieldDropReasonL3DstDiscard = 14, /* Drop reason L3 Dst discard */
    bcmFieldDropReasonL3HdrError = 15,  /* Drop reason L3 header Error */
    bcmFieldDropReasonL3TTLError = 16,  /* Drop reason L3 TTL error */
    bcmFieldDropReasonIPMCL3IIFOrRPAIDCheckFailed = 17, /* Drop reason IPMC L3 IIF or RPA ID
                                           check failed */
    bcmFieldDropReasonTunnelTTLCheckFailed = 18, /* Drop reason Tunnel TTL check failed */
    bcmFieldDropReasonTunnelShimHdrError = 19, /* Drop reason Tunnel Shim header error */
    bcmFieldDropReasonTunnelObjectValidationFailed = 20, /* Drop reason Tunnel object validation
                                           failed */
    bcmFieldDropReasonTunnelAdaptDrop = 21, /* Drop reason Tunnel adapt drop */
    bcmFieldDropReasonPVLANDrop = 22,   /* Drop reason PVLAN Drop */
    bcmFieldDropReasonVFP = 23,         /* Drop reason VFP */
    bcmFieldDropReasonIFP = 24,         /* Drop reason IFP */
    bcmFieldDropReasonIFPMeter = 25,    /* Drop reason IFP Meter */
    bcmFieldDropReasonDSTFP = 26,       /* Drop reason Destination FP */
    bcmFieldDropReasonMplsProtectionDrop = 27, /* Drop reason Mpls protection drop */
    bcmFieldDropReasonMplsLabelActionInvalid = 28, /* Drop reason Mpls label action invalid */
    bcmFieldDropReasonMplsTermPolicySelectTableDrop = 29, /* Drop reason Mpls term policy select
                                           table drop */
    bcmFieldDropReasonMPLSReservedLabelExposed = 30, /* Drop reason Mpls reserved label
                                           exposed */
    bcmFieldDropReasonMplsTTLError = 31, /* Drop reason Mpls TTL error */
    bcmFieldDropReasonMplsEcnError = 32, /* Drop reason Mpls Ecn error */
    bcmFieldDropReasonEMFT = 33,        /* Drop reason EM FT */
    bcmFieldDropReasonIVXLT = 34,       /* Drop reason IVXLT */
    bcmFieldDropReasonUrpfCheckFailed = 35, /* Drop reason Urpf check failed */
    bcmFieldDropReasonSrcPortKnockoutDrop = 36, /* Drop reason Srcport knockout drop */
    bcmFieldDropReasonLagFailoverPortDown = 37, /* Drop reason Lag failover port down */
    bcmFieldDropReasonSplitHorizonCheckFailed = 38, /* Drop reason Split horizon check
                                           failed */
    bcmFieldDropReasonDstLinkDown = 39, /* Drop reason Dst linkdown */
    bcmFieldDropReasonBlockMaskDrop = 40, /* Drop reason Block mask drop */
    bcmFieldDropReasonL3MtuCheckFailed = 41, /* Drop reason L3 Mtu check failed */
    bcmFieldDropReasonSeqNumCheckFailed = 42, /* Drop reason Seq num check failed */
    bcmFieldDropReasonL3IIFEqL3OIF = 43, /* Drop reason L3 IIF Equals L3 OIF */
    bcmFieldDropReasonStromControlDrop = 44, /* Drop reason Strom control drop */
    bcmFieldDropReasonEgrMembershipCheckFailed = 45, /* Drop reason Egr membership check
                                           failed */
    bcmFieldDropReasonEgrSpanningTreeCheckFailed = 46, /* Drop reason Egr spanning tree check
                                           failed */
    bcmFieldDropReasonDstPBMZero = 47,  /* Drop reason Dst PBM zero */
    bcmFieldDropReasonMplsCtrlPktDrop = 48, /* Drop reason Mpls ctrl pkt drop */
    bcmFieldDropReasonLastCount = 49    /* Always Last. Not a usable value. */
...
typedef enum bcm_field_compression_map_type_e {
    ...
    bcmFieldCompressionLastMapTypeCount = 5 /* Always Last. Not a usable value. */
