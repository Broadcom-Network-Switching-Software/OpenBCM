...
int tefmod16_gen3_autoneg_ability_set(PHYMOD_ST* pc, tefmod16_gen3_an_adv_ability_t *cl73_adv)
{
    ...
    */
    if((cl73_adv->an_cl72 & 0x1) == 1) {
         override_v = (((uint32_t)OVERRIDE_CL72_EN_DIS<<16) | 1);
         tefmod16_gen3_set_override_1(pc, override_v);
    } else {
         override_v = (((uint32_t)OVERRIDE_CL72_EN<<16) | 0);
         tefmod16_gen3_set_override_1(pc, override_v);
    }
...
@details
  TBD
*/
int tefmod16_gen3_set_override_0(PHYMOD_ST* pc, uint32_t per_field_override_en)
{
    int or_value;
...
@details
  TBD
*/
int tefmod16_gen3_set_override_1(PHYMOD_ST* pc, uint32_t per_field_override_en)   /* OVERRIDE_SET */
{
    int or_value;
    override_type_t or_en;
    MAIN0_SETUPr_t                     MAIN0_SETUPr_reg;
...
int tefmod16_gen3_hg2_codec_set(PHYMOD_ST* pc, tefmod16_gen3_hg2_codec_t hg2_codec)
{
    ...
    case TEFMOD_HG2_CODEC_OFF:
        ...
        PHYMOD_IF_ERR_RETURN(tefmod16_gen3_set_override_0(pc, field_override));
        ...
        PHYMOD_IF_ERR_RETURN(tefmod16_gen3_set_override_1(pc, field_override));
...
int tefmod16_gen3_1588_ts_offset_get(PHYMOD_ST *pc, uint32_t *offset)
{
    MAIN0_TS_TMR_OFFSr_t MAIN0_TS_TMR_OFFSr_reg;

    MAIN0_TS_TMR_OFFSr_CLR(MAIN0_TS_TMR_OFFSr_reg);
    PHYMOD_IF_ERR_RETURN(READ_MAIN0_TS_TMR_OFFSr(pc, &MAIN0_TS_TMR_OFFSr_reg));
    *offset = MAIN0_TS_TMR_OFFSr_U_TS_OFFSETf_GET(MAIN0_TS_TMR_OFFSr_reg);
    return PHYMOD_E_NONE;
}
...
int tefmod16_gen3_port_start_lane_get(PHYMOD_ST *pc,
                                      ...
                                      int *port_num_lane)
{
    ...
    if (num_of_lane > 1) {
        ...
        *port_num_lane = num_of_lane;
        ...
        PHYMOD_IF_ERR_RETURN
            (_tefmod16_gen3_port_lane_config_get(pc,
                                                 port_mode_sel_reg,
                                                 port_starting_lane,
                                                 port_num_lane));
    }
