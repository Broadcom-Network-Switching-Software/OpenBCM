...
/** @file falcon16_v1l4p1_internal.h
 * Internal API functions
 */

#ifndef FALCON16_V1L4P1_API_INTERNAL_H
#define FALCON16_V1L4P1_API_INTERNAL_H

#include "falcon16_v1l4p1_ipconfig.h"
#include "falcon16_v1l4p1_select_defns.h"
#include "common/srds_api_err_code.h"
#include "common/srds_api_uc_common.h"
#include "common/srds_api_types.h"
#include "falcon16_v1l4p1_enum.h"
#include "falcon16_v1l4p1_types.h"
#include "falcon16_v1l4p1_usr_includes.h"
#include "falcon16_v1l4p1_prbs.h"
...
/*---------------------------------------*/
enum falcon16_v1l4p1_prbs_chk_timer_selection_enum {
    USE_HW_TIMERS = 0,
    USE_SW_TIMERS = 1
};
...
typedef struct {
  ...
  /** PLL Divider value.  (Same encoding as enum #falcon16_v1l4p1_pll_div_enum.) */
  uint32_t pll_div;
  /** PLL Lock */
  uint8_t  pll_lock;
  /** PLL Lock Change */
...
/** Checks to see if the stored ucode_version in falcon16_v1l4p1_info is matching with the current thread ucode
 * @param sa__ is an opaque state vector passed through to device access functions.
...
/** Verify the internal falcon16_v1l4p1_info.
 * @param *falcon16_v1l4p1_info_ptr Info_table to be verified
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @return Error code, if generated (returns ERR_CODE_NONE if no errors)
 */
...
/** Return whether the fraction portion of a #falcon16_v1l4p1_pll_div_enum value is nonzero. */
#define SRDS_INTERNAL_IS_PLL_DIV_FRACTIONAL(div_) (((uint32_t)(div_) & 0xFFFFF000UL) != 0)

/** Extract the integer portion of a #falcon16_v1l4p1_pll_div_enum value. */
#define SRDS_INTERNAL_GET_PLL_DIV_INTEGER(div_) ((uint32_t)(((uint32_t)(div_)) & 0x00000FFFUL))

/** Extract the fraction portion of a #falcon16_v1l4p1_pll_div_enum value.
...
/** Compose a value in the same format as a #falcon16_v1l4p1_pll_div_enum value.
 ...
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param refclk Reference clock frequency (enumerated), or FALCON16_V1L4P1_PLL_REFCLK_UNKNOWN to auto-compute.
 * @param *refclk_freq_hz Resultant reference clock frequency, in Hz.
 * @param *srds_div Divider value (enumerated), or FALCON16_V1L4P1_PLL_DIV_UNKNOWN to auto-compute.
 *             The final divider value will be filled in if FALCON16_V1L4P1_PLL_DIV_UNKNOWN.
 * @param *vco_freq_khz VCO output frequency, in kHz, or 0 to auto-compute.
 *                      The final VCO output frequency will be filled in if 0.
 * @param pll_option Select PLL configuration option from enum #falcon16_v1l4p1_pll_option_enum.
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon16_v1l4p1_INTERNAL_configure_pll(srds_access_t *sa__,
                                         enum falcon16_v1l4p1_pll_refclk_enum refclk,
                                         enum falcon16_v1l4p1_pll_div_enum srds_div,
                                         uint32_t vco_freq_khz,
                                         enum falcon16_v1l4p1_pll_option_enum pll_option);
 ...
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *srds_div Divider value, in the same encoding as enum #falcon16_v1l4p1_pll_div_enum.
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon16_v1l4p1_INTERNAL_read_pll_div(srds_access_t *sa__, uint32_t *srds_div);

/** Convert the PLL_DIV to actual PLL divider value and display
 * as part of falcon16_v1l4p1_display_core_state_line()
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param srds_div Divider value, in the same encoding as enum #falcon16_v1l4p1_pll_div_enum.
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon16_v1l4p1_INTERNAL_get_vco_from_refclk_div(srds_access_t *sa__,
                                                   uint32_t refclk_freq_hz,
                                                   enum falcon16_v1l4p1_pll_div_enum srds_div,
                                                   uint32_t *vco_freq_khz,
                                                   enum falcon16_v1l4p1_pll_option_enum pll_option);
...
} falcon16_v1l4p1_INTERNAL_event_log_dump_state_t;

/** Callback function for dumping event log, intended to be called by falcon16_v1l4p1_INTERNAL_read_event_log_with_callback.
 *  It must also be called once after, with a byte count of 0, to finish printing.
 * @param *arg is a falcon16_v1l4p1_INTERNAL_event_log_dump_state_t pointer for holding state.
...
/*-----------------------------*/
/** Read current falcon16_v1l4p1 core status.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *istate Current falcon16_v1l4p1 core status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
...
/*-----------------------------*/
/** Read current falcon16_v1l4p1 lane status.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *istate Current falcon16_v1l4p1 lane status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon16_v1l4p1_INTERNAL_get_osr_mode(srds_access_t *sa__, falcon16_v1l4p1_osr_mode_st *mode);
 ...
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *pmd_lock Current falcon16_v1l4p1 lane pmd_rx_lock status read back and populated by the API
 * @param *pmd_lock_chg Current falcon16_v1l4p1 lane pmd_rx_lock_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *sig_det Current falcon16_v1l4p1 lane signal_detect status read back and populated by the API
 * @param *sig_det_chg Current falcon16_v1l4p1 lane signal_detect_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *pll_lock Current falcon16_v1l4p1 lane pll_lock status read back and populated by the API
 * @param *pll_lock_chg Current falcon16_v1l4p1 lane pll_lock_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * Along with falcon16_v1l4p1_core_clkgate(), all lanes should also be clock gated using falcon16_v1l4p1_lane_clkgate() to complete a Core Clockgate
 * @param sa__ is an opaque state vector passed through to device access functions.
 ...
 * Define macro CUSTOM_REG_POLLING to replace the default implementation provided in falcon16_v1l4p1_internal.c.
 *
 * @param sa__ is an opaque state vector passed through to device access functions.
...
typedef struct {
    uint8_t *mem_ptr;
    srds_access_t *sa;
} falcon16_v1l4p1_INTERNAL_rdblk_callback_arg_t;

/** Callback function for reading uc RAM memory by falcon16_v1l4p1_INTERNAL_rdblk_uc_generic_ram().
 * @param *arg is a falcon16_v1l4p1_INTERNAL_rdblk_callback_arg_t pointer for holding state.
 ...
 *         indefinitely, until cnt bytes total are read.
 *  In other words, this is the same as falcon16_v1l4p1_INTERNAL_rdblk_uc_generic_ram(), but reading in descending address order.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param block_addr Address of RAM block to be read.
 *                   For program RAM, the upper 16 bits are 0x0000.  Otherwise, the upper 16 bits are 0x2000.
 * @param block_size Length of RAM block to read.
