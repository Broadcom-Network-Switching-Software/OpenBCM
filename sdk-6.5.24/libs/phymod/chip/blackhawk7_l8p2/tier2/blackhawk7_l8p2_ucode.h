...
#define BLACKHAWK7_V2L8P2_FLR_UCODE_IMAGE_VERSION "D005_16"  /* matches the version number from microcode */
#define BLACKHAWK7_V2L8P2_FLR_UCODE_IMAGE_SIZE    119772
#define BLACKHAWK7_V2L8P2_FLR_UCODE_STACK_SIZE    0x9F2
#define BLACKHAWK7_V2L8P2_FLR_UCODE_IMAGE_CRC     0x5694
