...
#if  defined(CMD_PROC) && !defined(linux)

  #define TOTAL_PI_STEPS 64
  #define TOTAL_PI_STEPS_LOG_BASE_2 6
...
/** Char ISI Enum */
enum srds_char_isi_enum {
  SRDS_CHAR_ISI_SETUP     = 0,
  SRDS_CHAR_ISI_START     = 1,
  SRDS_CHAR_ISI_DISABLE   = 2
};
...
\*                                                                           */
#define INFO_TABLE_SIGNATURE (0x37464E49)
/*                                                                           *\
