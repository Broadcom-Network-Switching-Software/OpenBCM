...
#endif  /* BCM_TRIDENT3_SUPPORT || BCM_MAVERICK2_SUPPORT || defined(BCM_TOMAHAWK3_SUPPORT) */
#if defined(BCM_WARM_BOOT_SUPPORT) && defined(BCM_TRIDENT3_SUPPORT) || defined(BCM_MAVERICK2_SUPPORT)
    if ((SOC_WARM_BOOT(unit)) && ((SOC_IS_TRIDENT3(unit) || (SOC_IS_MAVERICK2(unit))))) {
