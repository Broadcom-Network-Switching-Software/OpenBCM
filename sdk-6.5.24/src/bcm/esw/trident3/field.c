    ...
    *base_offset = field_info->bp;
    ...
    switch (field) {
       ...
       case UDF_2_CHUNK_1_0f:
           *field_pos = 5;
            break;
       case UDF_2_CHUNK_0_BITS_15_0f:
           *field_pos = 46;
            break;
       case UDF_2_CHUNK_1_BITS_15_0f:
           *field_pos = 47;
            break;
       default:
            return BCM_E_PARAM;
...
#define _FP_QUAL_FLEX_DB_ADD(_u_, _qual_, _32bit_ext_, _16bit_ext_, _8bit_ext_, _4bit_ext_,    \
        ...
        {                                                                         \
             ...
             sal_strcpy(_flex_data_->field_str_arr[1], _fld2_str_);               \
                                                                                  \
             rv = _fp_flex_qual_ceh_db_insert(_u_, _flex_data_);                  \
             if (rv != BCM_E_NONE) {                                              \
                 sal_free(_flex_data_);                                           \
                 if (BCM_E_NOT_FOUND == rv) {                                     \
                     rv = BCM_E_NONE;                                             \
                 }                                                                \
             }                                                                    \
...
_bcm_field_td3_flex_qual_ceh_db_init(int unit)
{
    ...
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyHiGig3Class,            1, 0, 0, 0, 0, 1, "UDF_1_CHUNK_5",   "\0",        "HG3_CLASS_ID", "\0");
    ...
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyMplsEsiLabel0to15,        0, 1, 0, 0, 0, 1, "UDF_2_CHUNK_0_BITS_15_0",             "\0", "ESI_LABEL_LOWER_TWO_BYTES", "\0");
    _FP_QUAL_FLEX_DB_ADD(unit, bcmFieldQualifyMplsEsiLabel16to31,       1, 0, 0, 0, 0, 1, "UDF_2_CHUNK_0",                       "\0", "ESI_LABEL_UPPER_TWO_BYTES", "\0");
...
_field_td3_flex_extractor_qual_init(int unit, _field_stage_t *stage_fc)
{
    ...
    uint32 udf_2_chunk_0_bits_15_0_pos = 0;
    uint32 udf_2_chunk_0_bits_15_0_offset = 0;
    uint32 udf_2_chunk_1_bits_15_0_pos = 0;
    uint32 udf_2_chunk_1_bits_15_0_offset = 0;
    _bcm_field_flex_qual_ceh_data_t *flex_db = NULL;
    ...
    rv = _field_ifp_base_offset_get(unit,
                                    IFP_L0_BUS_SECTION_16BITfmt,
                                    UDF_2_CHUNK_0_BITS_15_0f,
                                    &udf_2_chunk_0_bits_15_0_offset,
                                    &udf_2_chunk_0_bits_15_0_pos);
    BCM_IF_ERROR_RETURN(rv);

    rv = _field_ifp_base_offset_get(unit,
                                    IFP_L0_BUS_SECTION_16BITfmt,
                                    UDF_2_CHUNK_1_BITS_15_0f,
                                    &udf_2_chunk_1_bits_15_0_offset,
                                    &udf_2_chunk_1_bits_15_0_pos);
    BCM_IF_ERROR_RETURN(rv);
       ...
       for (; flex_db != NULL; flex_db = flex_db->next) {
           ...
           for (obj_ct = 0; obj_ct < flex_db->num_obj; obj_ct++) {
               if (sal_strcmp(flex_db->obj_str_arr[obj_ct], "Z0_MATCH_ID") == 0) {
                   ...
                   valid_field = 1;
               } else if (0 == sal_strcmp(flex_db->obj_str_arr[obj_ct], "UDF_2_CHUNK_0")) {
                   field_pos[obj_ct] = udf_2_chunk_1_0_pos;
                   field_offset[obj_ct] = udf_2_chunk_1_0_offset;
                   valid_field = 1;
               } else if (0 == sal_strcmp(flex_db->obj_str_arr[obj_ct], "UDF_2_CHUNK_1")) {
                   field_pos[obj_ct] = udf_2_chunk_1_0_pos;
                   field_offset[obj_ct] = udf_2_chunk_1_0_offset + 16;
                   valid_field = 1;
               } else if (0 == sal_strcmp(flex_db->obj_str_arr[obj_ct], "UDF_2_CHUNK_0_BITS_15_0")) {
                   field_pos[obj_ct] = udf_2_chunk_0_bits_15_0_pos;
                   field_offset[obj_ct] = udf_2_chunk_0_bits_15_0_offset;
                   valid_field = 1;
               } else if (0 == sal_strcmp(flex_db->obj_str_arr[obj_ct], "UDF_2_CHUNK_1_BITS_15_0")) {
                   field_pos[obj_ct] = udf_2_chunk_1_bits_15_0_pos;
                   field_offset[obj_ct] = udf_2_chunk_1_bits_15_0_offset;
                   valid_field = 1;
               }
           }
...
_field_td3_common_actions_init(int unit, _field_stage_t *stage_fc)
{
    ...
    /* Dummy actions */
    _FP_ACTION_WITH_ASET_ADD_ONE(unit, stage_fc, bcmFieldActionPolicerGroup,
                                 0, _FieldActionMeterSet, offset, 0, 0);
    _FP_ACTION_WITH_ASET_ADD_ONE(unit, stage_fc, bcmFieldActionStatGroup,
                                 0, _FieldActionCounterSet, offset, 0, 0);
    ...
    _FP_ACTION_WITH_ASET_ADD_ONE(unit, stage_fc, bcmFieldActionLoopbackSubtype,
                                 0, _FieldActionOpaque3ActionSet, 0, 16, -1);
    _FP_ACTION_WITH_ASET_ADD_ONE(unit, stage_fc, bcmFieldActionLoopbackCustomSubtype,
                                 0, _FieldActionOpaque3ActionSet, 0, 16, -1);
    /* OPAQUE_2_ACTION_SET */
                                         ...
                                         bcm_field_aset_t  *aset)
{
    ...
    _bcm_field_aset_t aset_clr;            /* action set to be removed */
    ...
    sal_memset(&(aset_clr), 0, sizeof(_bcm_field_aset_t));
    ...
    for (a_idx = 0; a_idx < bcmFieldActionCount; a_idx++) {
        if (BCM_FIELD_ASET_TEST(fg->aset, a_idx)) {
            if (!BCM_FIELD_ASET_TEST(aset_incoming, a_idx)) {
                BCM_FIELD_ASET_ADD(aset_clr, a_idx);
                BCM_FIELD_ASET_ADD(aset_new, a_idx);
                BCM_FIELD_ASET_REMOVE(fg->aset, a_idx);
                aset_diff = 1;
            }
        }
        if (BCM_FIELD_ASET_TEST(aset_incoming, a_idx)) {
        ...
        for (a_idx = 0; a_idx < _bcmFieldActionCount; a_idx++) {
            if (BCM_FIELD_ASET_TEST(aset_new, a_idx)) {
                ...
                if ((0 == field_action_set) ||
                    ...
                    val = (0 == (BCM_FIELD_ASET_TEST(aset_clr, a_idx)));
                    soc_mem_field32_set(unit, action_profile_mem, act_prof_entry[0],
                            action_set_ptr[field_action_set].hw_field, val);
    ...
    /*
     * Delete the actions which are yet to be cleared
     * from all the entries under thr group
     */
    for (a_idx = 0; a_idx < bcmFieldActionCount; a_idx++) {
        if (BCM_FIELD_ASET_TEST(aset_clr, a_idx)) {
            (void)_bcm_esw_field_action_remove_from_group(unit, fg, a_idx, 1);
        }
    }
    return rv;
...
_field_td3_stage_quals_ibus_map_init(int unit, _field_stage_t *stage_fc)
{
    ...
    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 9, 144, 16);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, bcmFieldQualifyLoopbackCustomSubtype, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, (bcm_field_qualify_t)_bcmFieldQualifyExactMatchGroupClassIdLookup1, qual_flags);
    ...
    if (soc_feature(unit, soc_feature_field_aacl_compression)) {
        ...
        BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 15, 240, 16);
        BCMI_KEYGEN_QUAL_CFG_PRI_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_A, 16);
        BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, (bcm_field_qualify_t)_bcmFieldQualifySrcIpv4CompressedClassId, qual_flags);
        ...
        BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 15, 240, 16);
        BCMI_KEYGEN_QUAL_CFG_PRI_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_A, 16);
        BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, (bcm_field_qualify_t)_bcmFieldQualifySrcIpv6CompressedClassId, qual_flags);
        ...
        BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 15, 240, 16);
        BCMI_KEYGEN_QUAL_CFG_PRI_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_A, 17);
        BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, (bcm_field_qualify_t)_bcmFieldQualifyDstIpv4CompressedClassId, qual_flags);
        ...
        BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 15, 240, 16);
        BCMI_KEYGEN_QUAL_CFG_PRI_CTRL_SEL_ADD(BCMI_KEYGEN_EXT_CTRL_SEL_CLASSID_A, 17);
        BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, (bcm_field_qualify_t)_bcmFieldQualifyDstIpv6CompressedClassId, qual_flags);
    ...
    } else if (soc_feature(unit, soc_feature_hr4_l3mtu_fail_tocpu_war)) {
        BCMI_KEYGEN_QUAL_CFG_INIT(unit);
        BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD
            (0, BCMI_KEYGEN_EXT_SECTION_NAT_DST_REALMID, 2, 156, 2);
        BCMI_KEYGEN_QUAL_CFG_INSERT
    ...
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db,
                  (bcm_field_qualify_t)_bcmFieldQualifyExactMatchActionClassIdLookup0, qual_flags);
    ...
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db,
                   (bcm_field_qualify_t)_bcmFieldQualifyExactMatchActionClassIdLookup1, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0,
        BCMI_KEYGEN_EXT_SECTION_EM_FIRST_LOOKUP_HIT, 3, 154, 1);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db,
        (bcm_field_qualify_t)_bcmFieldQualifyExactMatchHitStatusLookup0, qual_flags);

    BCMI_KEYGEN_QUAL_CFG_INIT(unit);
    BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0,
        BCMI_KEYGEN_EXT_SECTION_EM_SECOND_LOOKUP_HIT, 3, 155, 1);
    BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db,
        (bcm_field_qualify_t)_bcmFieldQualifyExactMatchHitStatusLookup1, qual_flags);
    ...
    if (!soc_feature(unit, soc_feature_ifp_no_inports_support)) {
       ...
       BCMI_KEYGEN_QUAL_CFG_INIT(unit);
       BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 44, 704, 16);
       BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, (bcm_field_qualify_t)_bcmFieldQualifyInPorts_1, qual_flags);

       /* OPAQUE_4 */
       BCMI_KEYGEN_QUAL_CFG_INIT(unit);
       BCMI_KEYGEN_QUAL_CFG_OFFSET_ADD(0, BCMI_KEYGEN_EXT_SECTION_L1E16, 45, 720, 16);
       BCMI_KEYGEN_QUAL_CFG_INSERT(unit, db, (bcm_field_qualify_t)_bcmFieldQualifyInPorts_2, qual_flags);
    }
                                  ...
                                  uint8 *data, uint8 *mask)
{
    ...
    if (0 == sal_strcmp(flex_syshdr_type_arr[type].field_str, "\0")) {
        return BCM_E_UNAVAIL;
    }
                                      ...
                                      bcm_field_sys_hdr_type_t *type)
{
    ...
    *type = bcmFieldSysHdrLastCount;
    ...
    for (idx = 0; idx < COUNTOF(flex_syshdr_type_arr); idx++) {
        if (0 == sal_strcmp(flex_syshdr_type_arr[idx].field_str, "\0")) {
            continue;
        }
        rv = (soc_cancun_ceh_obj_field_get(unit, "Z0_MATCH_ID",
        ...
        case bcmFieldActionEgressFlowControlEnable:
            ...
            switch (fa->param[0]) {
                ...
                case bcmFieldEgressFlowControlIfaHdrInsertionOverTrunk:
                     ...
                     valid = 1;
                     break;
                case bcmFieldEgressFlowControlVxlanGbpSrcIdInherit:
                     object = "INHERIT_VXLAN_GBP_TO_ANOTHER_TUNNEL";
                     object_mask = "INHERIT_VXLAN_GBP_TO_ANOTHER_TUNNEL_MASK";
                     valid = 1;
                     break;
                case bcmFieldEgressFlowControlIfaProbeInit:
                     object = "IFA_PROBE_INIT_UNTAG";
                     object_mask = "IFA_PROBE_INIT_UNTAG_MASK";
                     valid = 1;
                     break;
                case bcmFieldEgressFlowControlIfaProbeInitOverTrunk:
                     object = "IFA_PROBE_INIT_OVER_LAG_UNTAG_WITH_UDP_UPDATE";
                     object_mask = "IFA_PROBE_INIT_OVER_LAG_UNTAG_WITH_UDP_UPDATE_MASK";
                     valid = 1;
                     break;
                case bcmFieldEgressFlowControlIfaSingleNode:
                     object = "IFA_SINGLE_NODE_UNTAG";
                     object_mask = "IFA_SINGLE_NODE_UNTAG_MASK";
                     valid = 1;
                     break;
                case bcmFieldEgressFlowControlIfaOverTrunkCopyToCpuSingleNode:
                     object = "IFA_OVER_LAG_COPY_TO_CPU_SINGLE_NODE_UNTAG";
                     object_mask = "IFA_OVER_LAG_COPY_TO_CPU_SINGLE_NODE_UNTAG_MASK";
                     valid = 1;
                     break;
                case bcmFieldEgressFlowControlIfaMetadataAfterVxLanDecap:
                     object = "IFA_METADATA_AFTER_VXLAN_DECAP";
                     object_mask = "IFA_METADATA_AFTER_VXLAN_DECAP_MASK";
                     valid = 1;
                     break;
                case bcmFieldEgressFlowControlIfaLastNodeVxLanDecapWithPayload:
                     object = "VXLAN_DECAP_WITH_IFA_PYLD_LAST_NODE";
                     object_mask = "VXLAN_DECAP_WITH_IFA_PYLD_LAST_NODE_MASK";
                     valid = 1;
                     break;
                case bcmFieldEgressFlowControlIfaOverTrunkUdpUpdate:
                     object = "IFA_OVER_LAG_UDP_UPDATE";
                     object_mask = "IFA_OVER_LAG_UDP_UPDATE_MASK";
                     valid = 1;
                     break;
                case bcmFieldEgressFlowControlMplsEvpnEsiFilter:
                     object = "MPLS_EVPN_ESI_FILTER";
                     object_mask = "MPLS_EVPN_ESI_FILTER_MASK";
                     valid = 1;
                     break;
                default:
                    break;
        ...
        case bcmFieldActionEgressFlowEncapEnable:
            ...
            switch (fa->param[0]) {
                ...
                case bcmFieldEgressFlowEncapIfaOverTrunkEnable:
                     ...
                     valid = 1;
                     break;
                case bcmFieldEgressFlowEncapIfaProbeInitUntagWithUdpUpdate:
                     object = "IFA_PROBE_INIT_UNTAG_WITH_UDP_UPDATE";
                     object_mask = "IFA_PROBE_INIT_UNTAG_WITH_UDP_UPDATE_MASK";
                     valid = 1;
                     break;
                case bcmFieldEgressFlowEncapIfaProbeInitStagWithUdpUpdate:
                     object = "IFA_PROBE_INIT_STAG_WITH_UDP_UPDATE";
                     object_mask = "IFA_PROBE_INIT_STAG_WITH_UDP_UPDATE_MASK";
                     valid = 1;
                     break;
                case bcmFieldEgressFlowEncapIfaProbeInitDtagWithUdpUpdate:
                     object = "IFA_PROBE_INIT_DTAG_WITH_UDP_UPDATE";
                     object_mask = "IFA_PROBE_INIT_DTAG_WITH_UDP_UPDATE_MASK";
                     valid = 1;
                     break;
                case bcmFieldEgressFlowEncapIfaProbeInitOverTrunkUntagWithUdpUpdate:
                     object = "IFA_PROBE_INIT_OVER_LAG_UNTAG_WITH_UDP_UPDATE";
                     object_mask = "IFA_PROBE_INIT_OVER_LAG_UNTAG_WITH_UDP_UPDATE_MASK";
                     valid = 1;
                     break;
                case bcmFieldEgressFlowEncapIfaProbeInitOverTrunkStagWithUdpUpdate:
                     object = "IFA_PROBE_INIT_OVER_LAG_STAG_WITH_UDP_UPDATE";
                     object_mask = "IFA_PROBE_INIT_OVER_LAG_STAG_WITH_UDP_UPDATE_MASK";
                     valid = 1;
                     break;
                case bcmFieldEgressFlowEncapIfaProbeInitOverTrunkDtagWithUdpUpdate:
                     object = "IFA_PROBE_INIT_OVER_LAG_DTAG_WITH_UDP_UPDATE";
                     object_mask = "IFA_PROBE_INIT_OVER_LAG_DTAG_WITH_UDP_UPDATE_MASK";
                     valid = 1;
                     break;
                case bcmFieldEgressFlowEncapIfaSingleNodeUntag:
                     object = "IFA_SINGLE_NODE_UNTAG";
                     object_mask = "IFA_SINGLE_NODE_UNTAG_MASK";
                     valid = 1;
                     break;
                case bcmFieldEgressFlowEncapIfaSingleNodeStag:
                     object = "IFA_SINGLE_NODE_STAG";
                     object_mask = "IFA_SINGLE_NODE_STAG_MASK";
                     valid = 1;
                     break;
                case bcmFieldEgressFlowEncapIfaSingleNodeDtag:
                     object = "IFA_SINGLE_NODE_DTAG";
                     object_mask = "IFA_SINGLE_NODE_DTAG_MASK";
                     valid = 1;
                     break;
                case bcmFieldEgressFlowEncapIfaProbeInitUntag:
                     object = "IFA_PROBE_INIT_UNTAG";
                     object_mask = "IFA_PROBE_INIT_UNTAG_MASK";
                     valid = 1;
                     break;
                case bcmFieldEgressFlowEncapIfaProbeInitStag:
                     object = "IFA_PROBE_INIT_STAG";
                     object_mask = "IFA_PROBE_INIT_STAG_MASK";
                     valid = 1;
                     break;
                case bcmFieldEgressFlowEncapIfaProbeInitDtag:
                     object = "IFA_PROBE_INIT_DTAG";
                     object_mask = "IFA_PROBE_INIT_DTAG_MASK";
                     valid = 1;
                     break;
                case bcmFieldEgressFlowEncapIfaOverTrunkCopyToCpuSingleNodeUntag:
                     object = "IFA_OVER_LAG_COPY_TO_CPU_SINGLE_NODE_UNTAG";
                     object_mask = "IFA_OVER_LAG_COPY_TO_CPU_SINGLE_NODE_UNTAG_MASK";
                     valid = 1;
                     break;
                case bcmFieldEgressFlowEncapIfaOverTrunkCopyToCpuSingleNodeStag:
                     object = "IFA_OVER_LAG_COPY_TO_CPU_SINGLE_NODE_STAG";
                     object_mask = "IFA_OVER_LAG_COPY_TO_CPU_SINGLE_NODE_STAG_MASK";
                     valid = 1;
                     break;
                case bcmFieldEgressFlowEncapIfaOverTrunkCopyToCpuSingleNodeDtag:
                     object = "IFA_OVER_LAG_COPY_TO_CPU_SINGLE_NODE_DTAG";
                     object_mask = "IFA_OVER_LAG_COPY_TO_CPU_SINGLE_NODE_STAG_MASK";
                     valid = 1;
                     break;
                case bcmFieldEgressFlowEncapIfaMetadataAfterVxLanDecap:
                     object = "IFA_METADATA_AFTER_VXLAN_DECAP";
                     object_mask = "IFA_METADATA_AFTER_VXLAN_DECAP_MASK";
                     valid = 1;
                     break;
                case bcmFieldEgressFlowEncapIfaMetadataAfterVxLanDecapWithUdpUpdate:
                     object = "IFA_METADATA_AFTER_VXLAN_DECAP_WITH_UDP_UPDATE";
                     object_mask = "IFA_METADATA_AFTER_VXLAN_DECAP_WITH_UDP_UPDATE_MASK";
                     valid = 1;
                     break;
                case bcmFieldEgressFlowEncapIfaLastNodeVxLanDecapWithPayload:
                     object = "VXLAN_DECAP_WITH_IFA_PYLD_LAST_NODE";
                     object_mask = "VXLAN_DECAP_WITH_IFA_PYLD_LAST_NODE_MASK";
                     valid = 1;
                     break;
                case bcmFieldEgressFlowEncapIfaLastNodeVxLanDecapWithPayloadWithUdpUpdate:
                     object = "VXLAN_DECAP_WITH_IFA_PYLD_LAST_NODE_AND_UDP_UPDATE";
                     object_mask = "VXLAN_DECAP_WITH_IFA_PYLD_LAST_NODE_AND_UDP_UPDATE_MASK";
                     valid = 1;
                     break;
                case bcmFieldEgressFlowEncapIfaOverTrunkUdpUpdate:
                     object = "IFA_OVER_LAG_UDP_UPDATE";
                     object_mask = "IFA_OVER_LAG_UDP_UPDATE_MASK";
                     valid = 1;
                     break;
                case bcmFieldEgressFlowEncapIfaHdrInsertionOverTrunkUdpUpdate:
                     object = "IFA_HDR_INSERTION_OVER_LAG_UDP_UPDATE";
                     object_mask = "IFA_HDR_INSERTION_OVER_LAG_UDP_UPDATE_MASK";
                     valid = 1;
                     break;
                default:
                    break;
        ...
        case bcmFieldActionLoopbackType:
            switch (fa->param[0]) {
                ...
                case bcmFieldLoopbackTypeMasqueradeWithSwitchDropIndication:
                    ...
                    a_offset->value[0] = ceh_info1.value;
                    break;
                case bcmFieldLoopbackTypeIfaVxLanDecapPayload:
                    rv1 = soc_cancun_ceh_obj_field_get(unit, "LOOPBACK_PROFILE_PTR",
                                                       "VXLAN_DECAP_IFA_PYLD",
                                                        &ceh_info1);
                    if (SOC_FAILURE(rv1)) {
                        return BCM_E_UNAVAIL;
                    }
                                                ...
                                                _field_em_action_set_t *acts_buf)
{
    ...
    if ((fa->action == bcmFieldActionIntEncapEnable) ||
       ...
       rv = _bcm_field_action_offset_get(unit, stage_fc, (bcm_field_action_t)_bcmFieldActionEditCtrlId, &edit_action_offset, 0);
       BCM_IF_ERROR_RETURN(rv);
    }
    ...
    if ((fa->action == bcmFieldActionIntEncapEnable) ||
       ...
       rv = _bcm_field_action_offset_get(unit, stage_fc, (bcm_field_action_t)_bcmFieldActionExtractionCtrlId, &ext_action_offset, 0);
       BCM_IF_ERROR_RETURN(rv);
    }
                               ...
                               bcm_pbmp_t mask)
{
    ...
    if (bcmFieldGroupOperModePipeLocal == stage_fc->oper_mode) {
       ...
       BCM_PBMP_ITER(mask, port) {
          ...
          BCM_IF_ERROR_RETURN(bcm_esw_stk_my_modid_get(unit, &local_mod));
          BCM_GPORT_MODPORT_SET(gport, local_mod, port);
...
STATIC int _bcm_field_td3_drop_mask_reason_arr[][2] = {
    {DISCARD_PROC_DROP_VECTORfmt, CONTROL_FRAMEf}, /* ControlFrame */
    {DISCARD_PROC_DROP_VECTORfmt, L3_DOS_ATTACKf}, /* L3DosAttack */
    {DISCARD_PROC_DROP_VECTORfmt, HIGIG_LOOPBACKf}, /* HiGigLoopback */
    {DISCARD_PROC_DROP_VECTORfmt, HIGIG_UNKNOWN_OPCODEf}, /* HiGigUnknownOpcode */
    {DISCARD_PROC_DROP_VECTORfmt, HIGIG_HDR_ERRORf}, /* HiGigHdrError */
    {DISCARD_PROC_DROP_VECTORfmt, LAG_FAIL_LOOPBACKf}, /* LagFailLoopback */
    {DISCARD_PROC_DROP_VECTORfmt, MACSA_EQUALS_DAf}, /* SrcMacEqualsDstMac */
    {DISCARD_PROC_DROP_VECTORfmt, L4_DOS_ATTACKf}, /* L4DosAttack */
    {DISCARD_PROC_DROP_VECTORfmt, NIV_DOT1Pf}, /* NivDot1p */
    {DISCARD_PROC_DROP_VECTORfmt, NIV_VNTAG_PRESENTf}, /* NivVntagPresent */
    {DISCARD_PROC_DROP_VECTORfmt, NIV_VNTAG_NOT_PRESENTf}, /* NivVntagNotPresent */
    {DISCARD_PROC_DROP_VECTORfmt, NIV_VNTAG_FORMATf}, /* NivVntagFormat */
    {DISCARD_PROC_DROP_VECTORfmt, UNKNOWN_SUBTENDING_PORTf}, /* UnknownSubtendingPort */
    {VXLT_DROP_VECTORfmt, MAC_IP_BIND_CHECK_FAILf}, /* HostPostureAssementSrcMacCheckFail */
    {TUNNEL_PROC_DROP_VECTORfmt, TUNNEL_OBJECT_VALIDATION_FAILf}, /* TunnelObjectValidationFail */
    {TUNNEL_PROC_DROP_VECTORfmt, TUNNEL_SHIM_HDR_ERRORf}, /* TunnelShimHdrError */
    {TUNNEL_PROC_DROP_VECTORfmt, TUNNEL_TTL_CHECK_FAILf}, /* TunnelTtlCheckFail */
    {TUNNEL_PROC_DROP_VECTORfmt, MPLS_INVALID_ACTIONf}, /* MplsInvalidAction */
    {TUNNEL_PROC_DROP_VECTORfmt, MPLS_LABEL_MISSf}, /* MplsLabelMiss */
    {TUNNEL_PROC_DROP_VECTORfmt, MPLS_ENTROPY_LABELf}, /* MplsEntropyLabel */
    {TUNNEL_PROC_DROP_VECTORfmt, MPLS_INVALID_PAYLOADf}, /* MplsInvalidPayload */
    {TUNNEL_PROC_DROP_VECTORfmt, MPLS_GAL_NOT_BOSf}, /* MplsGalIsNotBos */
    {TUNNEL_PROC_DROP_VECTORfmt, MPLS_CONTROL_PKTf}, /* MplsControlPkt */
    {TUNNEL_PROC_DROP_VECTORfmt, TUNNEL_INTERFACE_CHECK_FAILf}, /* TunnelInterfaceCheckFail */
    {TUNNEL_PROC_DROP_VECTORfmt, MIM_TUNNEL_PROCf}, /* MimTunnelProcessFail */
    {TUNNEL_PROC_DROP_VECTORfmt, IPINIP_TUNNEL_PROCf}, /* IpInIpTunnelProcessFail */
    {RSEL2_DROP_VECTORfmt, IFP_DROPf}, /* FieldStageIngressDrop */
    {VLAN_DROP_VECTORfmt, INVALID_VLANf}, /* InvalidVlan */
    {VLAN_DROP_VECTORfmt, ENIFILTERf}, /* InportNotInVlan */
    {VLAN_DROP_VECTORfmt, INVALID_TPIDf}, /* InvalidTpid */
    {VLAN_DROP_VECTORfmt, PVLAN_VID_MISMATCHf}, /* PvlanVlanIdMismatch */
    {FWD_DROP_VECTORfmt, FCOE_VFTf}, /* FcoeVft */
    {FWD_DROP_VECTORfmt, FCOE_SRC_BIND_CHECKf}, /* FcoeSrcBindCheck */
    {FWD_DROP_VECTORfmt, FCOE_SRC_FPMA_CHECKf}, /* FcoeSrcFpmaCheck */
    {FWD_DROP_VECTORfmt, VFI_PT2PTf}, /* VfiPointToPoint */
    {PKT_PROC_DROP_VECTORfmt, SPANNING_TREE_STATEf}, /* SpanningTreeCheckFail */
    {PKT_PROC_DROP_VECTORfmt, MULTICAST_INDEX_ERRORf}, /* MulticastIndexError */
    {PKT_PROC_DROP_VECTORfmt, BPDUf}, /* BpduDrop */
    {PKT_PROC_DROP_VECTORfmt, CMLf}, /* CmlCheckFail */
    {PKT_PROC_DROP_VECTORfmt, SRC_ROUTEf}, /* SrcMacIsMulticast */
    {PKT_PROC_DROP_VECTORfmt, L2SRC_DISCARDf}, /* L2SrcLookupFail */
    {PKT_PROC_DROP_VECTORfmt, L2SRC_STATIC_MOVEf}, /* L2SrcStaticMoveDrop */
    {PKT_PROC_DROP_VECTORfmt, L2DST_DISCARDf}, /* L2DstLookupFail */
    {PKT_PROC_DROP_VECTORfmt, L3DISABLEf}, /* L3DisableDrop */
    {PKT_PROC_DROP_VECTORfmt, MACSA0f}, /* SrcMacIsZero */
    {PKT_PROC_DROP_VECTORfmt, VLAN_CC_OR_PBTf}, /* L3FwdLookupMissOrNonUcastPktDrop */
    {PKT_PROC_DROP_VECTORfmt, CLASS_BASED_SMf}, /* ClassBasedLearningDrop */
    {PKT_PROC_DROP_VECTORfmt, TIME_SYNC_PKTf}, /* TimeSyncPkt */
    {PKT_PROC_DROP_VECTORfmt, IPMC_PROCf}, /* IpmcProcessDrop */
    {PKT_PROC_DROP_VECTORfmt, MY_STATIONf}, /* MyStationDrop */
    {PKT_PROC_DROP_VECTORfmt, PVLAN_VP_EFILTERf}, /* VpBasedPvlanDrop */
    {PKT_PROC_DROP_VECTORfmt, L3DST_DISCARDf}, /* L3DstLookup */
    {PKT_PROC_DROP_VECTORfmt, TUNNEL_DECAP_ECNf}, /* TunnelDecapEcn */
    {PKT_PROC_DROP_VECTORfmt, L3SRC_DISCARDf}, /* L3SrcLookup */
    {PKT_PROC_DROP_VECTORfmt, FCOE_ZONE_LOOKUP_MISSf}, /* FcoeZoneLookupMiss */
    {PKT_PROC_DROP_VECTORfmt, L3_TTL_ERRORf}, /* L3TtlError */
    {PKT_PROC_DROP_VECTORfmt, L3_HDR_ERRORf}, /* L3HdrError */
    {PKT_PROC_DROP_VECTORfmt, L2_HDR_ERRORf}, /* L2HdrError */
    {PKT_PROC_DROP_VECTORfmt, L2_RPF_CHECK_FAILf}, /* L2RpfCheckFail */
    {PKT_PROC_DROP_VECTORfmt, PFMf}, /* PfmCheckFail */
    {PKT_PROC_DROP_VECTORfmt, TAG_UNTAG_DISCARDf}, /* TagUntagDiscard */
    {RSEL2_DROP_VECTORfmt, ECMP_RESOLUTION_ERRORf}, /* EcmpResolutionError */
    {RSEL2_DROP_VECTORfmt, STORM_CONTROL_DROPf}, /* StromControlDrop */
    {RSEL2_DROP_VECTORfmt, FCOE_ZONE_CHECK_FAILf}, /* FcoeZoneCheckFail */
    {RSEL2_DROP_VECTORfmt, MULTICAST_DROPf}, /* MulticastDrop */
    {RSEL2_DROP_VECTORfmt, TUNNEL_ERRORf}, /* TunnelError */
    {RSEL2_DROP_VECTORfmt, NEXT_HOP_DROPf}, /* NextHopDrop */
    {RSEL2_DROP_VECTORfmt, URPF_CHECK_FAILf}, /* UrpfCheckFail */
    {RSEL2_DROP_VECTORfmt, NAT_DROPf}, /* NatDrop */
    {RSEL2_DROP_VECTORfmt, PROTECTION_DATA_DROPf}, /* ProtectionDataDrop */
    {VXLT_DROP_VECTORfmt, VFPf}, /* FieldStageLookupDrop */
    {VXLT_DROP_VECTORfmt, TUNNEL_ADAPT_1_LOOKUP_MISSf}, /* InterfaceClassMplsLookup1Miss */
    {VXLT_DROP_VECTORfmt, TUNNEL_ADAPT_2_LOOKUP_MISSf}, /* InterfaceClassMplsLookup2Miss */
    {VXLT_DROP_VECTORfmt, TUNNEL_ADAPT_3_LOOKUP_MISSf}, /* InterfaceClassMplsLookup3Miss */
    {VXLT_DROP_VECTORfmt, TUNNEL_ADAPT_4_LOOKUP_MISSf}, /* InterfaceClassL3TunnelMiss */
};

STATIC int
_bcm_field_td3_control_drop_mask_set(
        int unit,
        _field_control_t *fc,
        bcm_field_control_t control,
        bcm_field_control_config_t *fc_cfg)
{
    int rv = BCM_E_NONE;
    int iter = 0;
    uint32 valid = 0;
    ...
    soc_field_t field = INVALIDf;
    uint32 disc_buf = -1, vxlt_buf = -1, tnl_buf = -1;
    uint32 rsel2_buf = -1, vlan_buf = -1, fwd_buf = -1;
    uint32 drop_buf[3] = {-1, -1, -1};
    int buf[6] = {-1, -1, -1, -1, -1, -1};
    uint8 len = 0;

    if ((NULL == fc) || (NULL == fc_cfg)) {
        return BCM_E_PARAM;
    }

    if (bcmFieldControlDropMask != control) {
        return BCM_E_INTERNAL;
    }

    len = soc_format_field_length(unit,
    ...
    for (iter = 0; iter < bcmFieldDropMaskReasonLastCount; iter++) {
        if (0 == SHR_BITGET(fc_cfg->drop_mask_set.w, iter)) {
            fmt = _bcm_field_td3_drop_mask_reason_arr[iter][0];
            field = _bcm_field_td3_drop_mask_reason_arr[iter][1];
            switch (fmt) {
                case DISCARD_PROC_DROP_VECTORfmt:
                    SHR_BITSET(&valid, 0);
                    soc_format_field32_set(unit, fmt, &disc_buf, field, 0);
                    break;
                case VXLT_DROP_VECTORfmt:
                    SHR_BITSET(&valid, 1);
                    soc_format_field32_set(unit, fmt, &vxlt_buf, field, 0);
                    break;
                case TUNNEL_PROC_DROP_VECTORfmt:
                    SHR_BITSET(&valid, 2);
                    soc_format_field32_set(unit, fmt, &tnl_buf, field, 0);
                    break;
                case RSEL2_DROP_VECTORfmt:
                    SHR_BITSET(&valid, 3);
                    soc_format_field32_set(unit, fmt, &rsel2_buf, field, 0);
                    break;
                case VLAN_DROP_VECTORfmt:
                    SHR_BITSET(&valid, 4);
                    soc_format_field32_set(unit, fmt, &vlan_buf, field, 0);
                    break;
                case FWD_DROP_VECTORfmt:
                    SHR_BITSET(&valid, 5);
                    soc_format_field32_set(unit, fmt, &fwd_buf, field, 0);
                    break;
                case PKT_PROC_DROP_VECTORfmt:
                    SHR_BITSET(&valid, 6);
                    soc_format_field32_set(unit, fmt, drop_buf, field, 0);
                    break;
                default:
                    return BCM_E_INTERNAL;
            }
    ...
    if (SHR_BITGET(&valid, 0)) {
        soc_format_field32_set(unit, PKT_PROC_DROP_VECTORfmt,
                               drop_buf, DISCARD_PROC_DROP_VECTORf,
                               disc_buf);
    }

    if (SHR_BITGET(&valid, 1)) {
        soc_format_field32_set(unit, PKT_PROC_DROP_VECTORfmt,
                               drop_buf, VXLT_DROP_VECTORf,
                               vxlt_buf);
    }

    if (SHR_BITGET(&valid, 2)) {
        soc_format_field32_set(unit, PKT_PROC_DROP_VECTORfmt,
                               drop_buf, TUNNEL_PROC_DROP_VECTORf,
                               tnl_buf);
    }

    if (SHR_BITGET(&valid, 3)) {
        soc_format_field32_set(unit, PKT_PROC_DROP_VECTORfmt,
                               drop_buf, RSEL2_DROP_VECTORf,
                               rsel2_buf);
    }

    if (SHR_BITGET(&valid, 4)) {
        soc_format_field32_set(unit, PKT_PROC_DROP_VECTORfmt,
                               drop_buf, VLAN_DROP_VECTORf,
                               vlan_buf);
    }

    if (SHR_BITGET(&valid, 5)) {
        soc_format_field32_set(unit, PKT_PROC_DROP_VECTORfmt,
                               drop_buf, FWD_DROP_VECTORf,
                               fwd_buf);
    }

    switch (fc_cfg->profile) {
        case bcmFieldDropMaskControlProfile0:
            field = IFP_EM_KEY_MASK_0f;
            break;
        case bcmFieldDropMaskControlProfile1:
            field = IFP_EM_KEY_MASK_1f;
            break;
        default:
            return BCM_E_INTERNAL;
    }
    rv = soc_mem_read(unit, IFP_EM_DROP_VECTOR_MASK_PROFILE_1m,
                       MEM_BLOCK_ANY, 1, &buf);
    BCM_IF_ERROR_RETURN(rv);
    soc_mem_field_set(unit, IFP_EM_DROP_VECTOR_MASK_PROFILE_1m,
            (uint32 *)buf, field, drop_buf);
    rv = soc_mem_write(unit, IFP_EM_DROP_VECTOR_MASK_PROFILE_1m,
                       MEM_BLOCK_ANY, 1, buf);
...
STATIC int
_bcm_field_td3_control_drop_mask_get(
        int unit,
        _field_control_t *fc,
        bcm_field_control_t control,
        bcm_field_control_config_t *fc_cfg)
{
    ...
    soc_mem_field_get(unit, IFP_EM_DROP_VECTOR_MASK_PROFILE_1m, (uint32 *)buf,
                      field, drop_buf);
    disc_buf = soc_format_field32_get(unit, PKT_PROC_DROP_VECTORfmt,
                                      drop_buf, DISCARD_PROC_DROP_VECTORf);
    vxlt_buf = soc_format_field32_get(unit, PKT_PROC_DROP_VECTORfmt,
                                      drop_buf, VXLT_DROP_VECTORf);
    tnl_buf = soc_format_field32_get(unit, PKT_PROC_DROP_VECTORfmt,
                                     drop_buf, TUNNEL_PROC_DROP_VECTORf);
    rsel2_buf = soc_format_field32_get(unit, PKT_PROC_DROP_VECTORfmt,
                                     drop_buf, RSEL2_DROP_VECTORf);
    vlan_buf = soc_format_field32_get(unit, PKT_PROC_DROP_VECTORfmt,
                                     drop_buf, VLAN_DROP_VECTORf);
    fwd_buf = soc_format_field32_get(unit, PKT_PROC_DROP_VECTORfmt,
                                     drop_buf, FWD_DROP_VECTORf);
    ...
    for (iter = 0; iter < bcmFieldDropMaskReasonLastCount; iter++) {
        ...
        switch (fmt) {
            case DISCARD_PROC_DROP_VECTORfmt:
                val = soc_format_field32_get(unit, fmt, &disc_buf, field);
                break;
            case VXLT_DROP_VECTORfmt:
                val = soc_format_field32_get(unit, fmt, &vxlt_buf, field);
                break;
            case TUNNEL_PROC_DROP_VECTORfmt:
                val = soc_format_field32_get(unit, fmt, &tnl_buf, field);
                break;
            case RSEL2_DROP_VECTORfmt:
                val = soc_format_field32_get(unit, fmt, &rsel2_buf, field);
                break;
            case VLAN_DROP_VECTORfmt:
                val = soc_format_field32_get(unit, fmt, &vlan_buf, field);
                break;
            case FWD_DROP_VECTORfmt:
                val = soc_format_field32_get(unit, fmt, &fwd_buf, field);
                break;
            case PKT_PROC_DROP_VECTORfmt:
                val = soc_format_field32_get(unit, fmt, drop_buf, field);
                break;
            default:
                return BCM_E_INTERNAL;
        }
        if (val) {
            SHR_BITSET(fc_cfg->drop_mask_set.w, iter);
        }
    }
    return rv;
}
...
_bcm_field_td3_functions_init(_field_funct_t *functions)
{
    ...
    functions->fp_control_drop_mask_set = _bcm_field_td3_control_drop_mask_set;
    functions->fp_control_drop_mask_get = _bcm_field_td3_control_drop_mask_get;
}
