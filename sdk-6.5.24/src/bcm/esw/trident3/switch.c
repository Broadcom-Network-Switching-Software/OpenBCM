...
bcm_switch_binding_t trident3_bindings[] =
{
   ...
   { bcmSwitchRemoteLearnTrust, 0,
    ...
    { bcmSwitchSrv6Adapt4NonSrhAction, 1,
        ...
        NULL, soc_feature_srv6_enable},
    { bcmSwitchSrv6Adapt1DipPrefixLen, 1,
        TUNNEL_ADAPT_1_SRV6_CTRLr, DIP_PREFIX_LENGTHf,
        NULL, soc_feature_srv6_enable},
    { bcmSwitchSrv6Adapt2DipPrefixLen, 1,
        TUNNEL_ADAPT_2_SRV6_CTRLr, DIP_PREFIX_LENGTHf,
        NULL, soc_feature_srv6_enable},
    { bcmSwitchSrv6Adapt4DipPrefixLen, 1,
        TUNNEL_ADAPT_4_SRV6_CTRLr, DIP_PREFIX_LENGTHf,
        NULL, soc_feature_srv6_enable},
    ...
    { bcmSwitchSrv6GsidPrefix2, 1,
        ...
        NULL, soc_feature_srv6_enable},
    { bcmSwitchSrv6FunctionSelect, 1,
        EGR_SRV6_CONFIGr, FUNCTION_OFFSET_AND_SIZEf,
        NULL, soc_feature_srv6_enable},
#endif
#if defined(BCM_HELIX5_SUPPORT)
    ...
    { bcmSwitchHashUseFlowSelVpTrunk, 1,
        ...
        NULL, 0},
#endif
#if defined(BCM_HELIX5_SUPPORT) || defined(BCM_TRIDENT3_SUPPORT)
