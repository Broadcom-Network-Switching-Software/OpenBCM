...
#ifdef BCM_MONTEREY_SUPPORT
   if (SOC_IS_MONTEREY(unit)) {
       return bcm_mn_cosq_stat_set(unit, gport, cosq, stat, value);
   }
#endif /* BCM_MONTEREY_SUPPORT */
                                 ...
                                 bcm_cosq_bst_profile_t *profile)
{
    ...
    if (SOC_IS_TOMAHAWK3(unit)) {
        if (bid == bcmBstStatIdDevice) {
            /* Profile is unique per ITM only for bcmBstStatIdDevice */
            int itm;
...
#ifdef BCM_TRIDENT3_SUPPORT
    if (SOC_IS_TRIDENT3(unit)) {
        result = bcm_td3_cosq_burst_monitor_init(unit);
    }
#endif /* BCM_TRIDENT3_SUPPORT */
...
#ifdef BCM_TRIDENT3_SUPPORT
    if (SOC_IS_TRIDENT3(unit)) {
        result = bcm_td3_cosq_burst_monitor_detach(unit);
    }
#endif /* BCM_TRIDENT3_SUPPORT */
...
#ifdef BCM_TRIDENT3_SUPPORT
    if (SOC_IS_TRIDENT3(unit)) {
        result = bcm_td3_cosq_burst_monitor_flow_view_config_set(unit, options,
                                                                view_cfg);
    }
#endif /* BCM_TRIDENT3_SUPPORT*/
    /* Release lock */
...
#ifdef BCM_TRIDENT3_SUPPORT
    if (SOC_IS_TRIDENT3(unit)) {
        result = bcm_td3_cosq_burst_monitor_flow_view_config_get(unit,
                                                              view_cfg);
    }
#endif /* BCM_TRIDENT3_SUPPORT */
...
#ifdef BCM_TRIDENT3_SUPPORT
    if (SOC_IS_TRIDENT3(unit)) {
        result = bcm_td3_cosq_burst_monitor_flow_view_data_clear(unit);
    }
#endif /* BCM_TRIDENT3_SUPPORT */
...
#ifdef BCM_TRIDENT3_SUPPORT
    if (SOC_IS_TRIDENT3(unit)) {
        result = bcm_td3_cosq_burst_monitor_flow_view_data_get(unit, usr_mem_size,
                                                              usr_mem_addr);
    }
#endif /* BCM_TRIDENT3_SUPPORT */
...
#ifdef BCM_TRIDENT3_SUPPORT
    if (SOC_IS_TRIDENT3(unit)) {
        result = bcm_td3_cosq_burst_monitor_get_current_time(unit,
                                                            time_usecs);
    }
#endif /* BCM_TRIDENT3_SUPPORT */
...
#ifdef BCM_TRIDENT3_SUPPORT
    if (SOC_IS_TRIDENT3(unit)) {
        result = bcm_td3_cosq_burst_monitor_view_summary_get(unit, mem_size,
                                                            mem_addr, max_num_views,
                                                            num_views);
    }
#endif /* BCM_TRIDENT3_SUPPORT */
...
#ifdef BCM_TRIDENT3_SUPPORT
    if (SOC_IS_TRIDENT3(unit)) {
        result = bcm_td3_cosq_burst_monitor_flow_view_stats_get(unit, mem_size,
                                                               mem_addr, max_num_flows,
                                                               view_id, flags, num_flows);
    }
#endif /* BCM_TRIDENT3_SUPPORT*/
