...
shr_error_e dnx_field_map_global_action_map_get(
    int unit,
...
shr_error_e dnx_field_map_meta_qual_info_get(
    int unit,
    dnx_field_stage_e stage,
...
shr_error_e dnx_field_action_description_is_empty(
    int unit,
    bcm_field_action_t bcm_action,
    uint8 *is_empty);
...
shr_error_e dnx_field_qual_description_is_empty(
    int unit,
    bcm_field_qualify_t bcm_qual,
    uint8 *is_empty);
