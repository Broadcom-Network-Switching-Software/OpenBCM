    ...
    dnx_field_presel_entry_data_t * entry_data_p)
{
    ...
    if (entry_data_p->entry_valid)
    {
         ...
         */
        SHR_IF_ERR_EXIT(dnx_field_map_stage_info_get_dispatch(unit, entry_id_p->stage, &field_map_stage_info));
    ...
    int unit)
{
    ...
    DNX_FIELD_STAGE_CS_QUAL_ITERATOR(field_stage, field_map_stage_info)
    {
