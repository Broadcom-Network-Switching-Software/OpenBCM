    ...
    uint32 *access_id)
{
    ...
    if (is_dt || (flags & DNX_FIELD_ENTRY_ADD_FLAG_WITH_ID) || (flags & DNX_FIELD_ENTRY_ADD_FLAG_UPDATE))
    {
    ...
    uint32 *entry_handle_p)
{
    ...
    {
        int access_id = (flags & DNX_FIELD_ENTRY_ADD_FLAG_WITH_ID) ? *entry_handle_p : 0;
