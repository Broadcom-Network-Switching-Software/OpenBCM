    ...
    bcm_field_AppType_t * apptype_p)
{
    ...
    DNX_TCAM_EXTERNAL_TCAM_FUNCTION(unit, dnx_field_kbp_context_apptype_create(unit, flags, apptype_info_p, apptype_p));
    ...
    int unit)
{
    ...
    {
        DNX_TCAM_EXTERNAL_TCAM_FUNCTION(unit, dnx_field_kbp_context_ifwd2_kbp_acl_init(unit));
    }
