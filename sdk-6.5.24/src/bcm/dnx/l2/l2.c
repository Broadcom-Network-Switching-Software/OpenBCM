    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(dnx_l2_traverse_thread_sem_create(unit));
    ...
    int unit)
{
    ...
    dnx_l2_traverse_thread_sem_destroy(unit);
    ...
    bcm_l2_gport_forward_info_t * frwrd_info)
{
    ...
    SHR_IF_ERR_EXIT(algo_gpm_gport_and_encap_to_forward_information
                    (unit, ALGO_GPM_ENCODE_DESTINATION_FLAGS_NONE, gport_id, BCM_FORWARD_ENCAP_ID_INVALID,
                     &forward_info));
    /*
