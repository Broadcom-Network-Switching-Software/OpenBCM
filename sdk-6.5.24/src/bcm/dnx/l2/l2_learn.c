    ...
    void **user_data_unused)
{
    ...
    table_id_svl = dnx_data_l2.general.fwd_mact_info_get(unit, l2AddrLearnMact)->data_base;
    ...
    int bcm_learn_mode)
{
     ...
     */
    if (dnx_data_l3.feature.feature_get(unit, dnx_data_l3_feature_routed_learning) == 0)
    {
    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(dbal_tables_capacity_get
                    (unit, (dbal_tables_e) (dnx_data_l2.general.fwd_mact_info_get(unit, l2AddrFwdMact)->data_base),
                     &max_capacity));
    ...
    int lpkgv_one_outlif)
{
    ...
    uint32 learn_ffc_instruction;
    uint32 currect_offset;
    uint32 learn_payload_context_val = DBAL_ENUM_FVAL_LEARN_PAYLOAD_CONTEXT_SYMMETRIC_LIF_BASIC_SVL;
    ...
    int lpkgv_one_outlif)
{
    ...
    uint32 learn_ffc_instruction;
    uint32 currect_offset;
    uint32 learn_payload_context_val = DBAL_ENUM_FVAL_LEARN_PAYLOAD_CONTEXT_ASYMMETRIC_LIF_BASIC_SVL;
    ...
    {
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_LEARN_PAYLOAD_CONTEXT,
                                   DBAL_ENUM_FVAL_LEARN_PAYLOAD_CONTEXT_ASYMMETRIC_LIF_BASIC_IVL);
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_LEARN_FORMAT_INDEX, INST_SINGLE,
                                     DBAL_DEFINE_MACT_LEARN_FORMAT_IDX_ONE);
        SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
    }
    ...
    int lpkgv_one_outlif)
{
    ...
    uint32 learn_ffc_instruction;
    uint32 currect_offset;
    uint32 learn_payload_context_val = DBAL_ENUM_FVAL_LEARN_PAYLOAD_CONTEXT_SYMMETRIC_LIF_EXTENDED_SVL;
    ...
    int lpkgv_one_outlif)
{
    ...
    uint32 learn_ffc_instruction;
    uint32 currect_offset;
    uint32 learn_payload_context_val = DBAL_ENUM_FVAL_LEARN_PAYLOAD_CONTEXT_ASYMMETRIC_LIF_EXTENDED_SVL;
    ...
    {
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_LEARN_PAYLOAD_CONTEXT,
                                   DBAL_ENUM_FVAL_LEARN_PAYLOAD_CONTEXT_ASYMMETRIC_LIF_EXTENDED_IVL);
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_LEARN_FORMAT_INDEX, INST_SINGLE,
                                     DBAL_DEFINE_MACT_LEARN_FORMAT_IDX_ONE);
        SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
    }
    ...
    int lpkgv_one_outlif)
{
    ...
    uint32 learn_ffc_instruction;
    uint32 currect_offset;
    uint32 learn_payload_context_val = DBAL_ENUM_FVAL_LEARN_PAYLOAD_CONTEXT_SYMMETRIC_LIF_OPTIMIZED_SVL;
    ...
    int lpkgv_one_outlif)
{
    ...
    uint32 learn_ffc_instruction;
    uint32 currect_offset;
    uint32 learn_payload_context_val = DBAL_ENUM_FVAL_LEARN_PAYLOAD_CONTEXT_ASYMMETRIC_LIF_OPTIMIZED_SVL;
    ...
    {
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_LEARN_PAYLOAD_CONTEXT,
                                   DBAL_ENUM_FVAL_LEARN_PAYLOAD_CONTEXT_ASYMMETRIC_LIF_OPTIMIZED_IVL);
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_LEARN_FORMAT_INDEX, INST_SINGLE,
                                     DBAL_DEFINE_MACT_LEARN_FORMAT_IDX_ONE);
        SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
    }
