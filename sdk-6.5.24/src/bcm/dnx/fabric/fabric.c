    ...
    int unit)
{
    ...
    {
        SHR_IF_ERR_EXIT(dbal_fields_32_hw_value_get
                        (unit, DBAL_FIELD_FABRIC_CELL_OT_SIZE, DBAL_ENUM_FVAL_FABRIC_CELL_OT_SIZE_20_BITS, &o_size));
        SHR_IF_ERR_EXIT(dbal_fields_32_hw_value_get
                        (unit, DBAL_FIELD_FABRIC_CELL_GT_SIZE, DBAL_ENUM_FVAL_FABRIC_CELL_GT_SIZE_20_BITS, &g_size));
    }
    else
    {
        SHR_IF_ERR_EXIT(dbal_fields_32_hw_value_get
                        (unit, DBAL_FIELD_FABRIC_CELL_OT_SIZE, DBAL_ENUM_FVAL_FABRIC_CELL_OT_SIZE_24_BITS, &o_size));
        SHR_IF_ERR_EXIT(dbal_fields_32_hw_value_get
                        (unit, DBAL_FIELD_FABRIC_CELL_GT_SIZE, DBAL_ENUM_FVAL_FABRIC_CELL_GT_SIZE_24_BITS, &g_size));
    }
    ...
    int arg)
{
    ...
    switch (type)
    {
        ...
        case bcmFabricLLFControlSource:
        {
            ...
            {
                SHR_IF_ERR_EXIT(dnx_fabric_cgm_llfc_enable_hw_set(unit, link_i, -1, arg));
            }
            break;
        }
        case bcmFabricLLFControlType:
        {
            if (dnx_data_fabric.links.feature_get(unit, dnx_data_fabric_links_credit_based_llfc_supported))
            {
                 ...
                 */
                SHR_IF_ERR_EXIT(dnx_fabric_cgm_llfc_enable_hw_set(unit, link_i, arg, 1));
            }
            else
            {
                SHR_ERR_EXIT(_SHR_E_UNAVAIL,
    ...
    bcm_gport_t * parent_port)
{
    ...
    {
        SHR_ERR_EXIT(_SHR_E_PORT, "child_port can not be fabric port");
    }
    else
    {
        port = child_port;
 ...
 * \param [in] links_count - size of wfd_config array.
