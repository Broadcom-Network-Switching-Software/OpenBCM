    ...
    bcm_pbmp_t * okay_pbmp)
{
    ...
    if (!is_init_sequence)
    {
        ...
        {
            /*
             * Set the defautl per soc property after the papi
             */
    ...
    dnx_fabric_force_e force)
{
    ...
    int mutli_core_dev = dnx_data_device.general.feature_get(unit, dnx_data_device_general_multi_core);
    ...
    else if (force == DNX_FABRIC_FORCE_LOCAL1 && mutli_core_dev)
    {
