 ...
 * \param [in] core - device core
 * \param [in] lane - lane to set the flush for
 * \param [out] flush_enable - Enable/Disable value
 *
 * \return
 *   int - see _SHR_E_*
 *
 ...
 *   * None
 */
int imb_ethu_tx_egress_flush_hw_get(
    int unit,
    bcm_core_t core,
    int lane,
    uint32 *flush_enable);
 ...
 *   * None
 */
int imb_ethu_internal_port_pfc_force_enable_set(
    int unit,
    bcm_core_t core,
    uint32 lane_in_core,
    int pfc,
 ...
 *   * None
 */
int imb_ethu_internal_pfc_mask_on_link_fail_enable_set(
    int unit,
    bcm_core_t core,
    int lane_in_core,
    uint32 enable);
...
* \param [in] core - core id
* \param [in] lane_in_core - lane inside the core
* \param [in] reset_traffic - reset the traffic counters
* \param [in] reset_pfc - reset the pfc counters
* \return
*   int - see _SHR_E_ *
*
* \remarks
...
*   * None
*/
int imb_ethu_internal_instru_traffic_pfc_deadlock_counters_reset(
    int unit,
    bcm_core_t core,
    uint32 lane_in_core,
    int reset_traffic,
...
*   * None
*/
int imb_ethu_internal_instru_synced_counters_config_set(
    int unit,
    bcm_core_t core,
    int ethu_in_core,
    uint8 nof_intervals,
...
*   * None
*/
int imb_ethu_internal_instru_synced_counters_last_write_get(
    int unit,
    bcm_core_t core,
    int ethu_in_core,
    uint32 *last_write,
...
* \param [in] core - core id
* \param [in] ethu_in_core - ethu id in core
* \param [in] port_in_ethu - First lane of the port in the ETHU.
* \param [in] imb_type - Indication whether the ETHU is CDU or CLU.
...
*   * None
*/
int imb_ethu_internal_instru_synced_counters_per_record_get(
    int unit,
    bcm_core_t core,
    int ethu_in_core,
    int port_in_ethu,
...
/**
 * \brief - Get the current PFC duration for a specified lane and priority.
 *
 * \param [in] unit - chip unit id
 * \param [in] lane_in_core - lane in core
 * \param [in] core - chip core id
 * \param [in] pfc - PFC for which we want to get the duration
 * \param [out] duration - duration of PFC for that lane
 * \return
 *   int - see _SHR_E_ *
 *
 * \remarks
 ...
 *   * None
 */
int imb_ethu_internal_pfc_deadlock_current_duration_get(
    int unit,
    int lane_in_core,
    bcm_core_t core,
    int pfc,
 ...
 */
int imb_ethu_global_to_local_id_and_core_get(
    int unit,
    int inst_id,
    bcm_core_t * core,
    int *ethu_id_in_core);
