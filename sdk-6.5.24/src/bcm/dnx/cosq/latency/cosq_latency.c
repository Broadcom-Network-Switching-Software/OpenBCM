    ...
    int arg)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_latency_aqm_flow_profile_mapping_verify(unit, port, cosq, type, arg, TRUE));
    ...
    int *arg)
{
    ...
    /** Verify inputs parameters */
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_latency_aqm_flow_profile_mapping_verify(unit, port, cosq, type, *arg, FALSE));
    ...
    bcm_gport_t * gport)
{
    ...
    /** Verify parameters */
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_latency_aqm_flow_id_gport_verify(unit, flags, gport));
