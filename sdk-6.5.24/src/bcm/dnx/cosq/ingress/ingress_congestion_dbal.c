    ...
    dnx_ingress_congestion_wred_hw_params_t * params)
{
    ...
    {
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_C11, INST_SINGLE, params->c1);
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_C12, INST_SINGLE, params->c12);
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_C13, INST_SINGLE, params->c13);
    }
    ...
    {
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_CONTINUOUS_PROBABILITY, INST_SINGLE,
                                     params->continuous_probability);
    }
    ...
    dnx_ingress_congestion_wred_hw_params_t * params)
{
    ...
    {
        dbal_value_field32_request(unit, entry_handle_id, DBAL_FIELD_C11, INST_SINGLE, &params->c1);
        dbal_value_field32_request(unit, entry_handle_id, DBAL_FIELD_C12, INST_SINGLE, &params->c12);
        dbal_value_field32_request(unit, entry_handle_id, DBAL_FIELD_C13, INST_SINGLE, &params->c13);
    }
    ...
    if (dnx_data_ingr_congestion.
        info.feature_get(unit, dnx_data_ingr_congestion_info_wred_continuous_probabilty_supported))
    {
        dbal_value_field32_request(unit, entry_handle_id, DBAL_FIELD_CONTINUOUS_PROBABILITY, INST_SINGLE,
                                   (uint32 *) &params->continuous_probability);
    }
    ...
    *enable = 0;
    ...
    while (!is_end)
    {
        ...
        SHR_IF_ERR_EXIT(dbal_entry_handle_value_field_arr32_get
                        (unit, entry_handle_id, DBAL_FIELD_ENABLE, INST_SINGLE, &curr_enable));
    ...
    int pg_base)
{
    ...
    /** Setting key fields */
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_IN_CGM_PORT, in_port);
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CORE_ID, core);
    ...
    int tc_pg_profile)
{
    ...
    /** Setting key fields */
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_IN_CGM_PORT, port);
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CORE_ID, core);
    ...
    uint32 clear_threshold)
{
    ...
    /** Setting key fields */
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_DP, drop_priority);
    ...
    int arg)
{
    ...
    switch (type)
    {
        ...
        {
            field_id = DBAL_FIELD_GROUP_TYPE_VSQ;
            break;
        }
        default:
        {
    ...
    int *arg)
{
    ...
    SHR_IF_ERR_EXIT(dnxc_time_clock_cycles_to_time_get(unit, nof_clock_cycles, DNXC_TIME_UNIT_USEC, &time));
    ...
    uint32 set_threshold)
{
    ...
    /** allocate handle*/
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC
                    (unit, DBAL_TABLE_INGRESS_CONG_GLOBAL_ECN_MARKING_THRESHOLDS_TABLE, &entry_handle_id));
