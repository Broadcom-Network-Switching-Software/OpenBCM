...
dnx_ingress_reassembly_db_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(dnx_ingress_reassembly_db_mapped_ports_dump(unit, -1, filters));
...
/*
 *
 * dump function for the variable mapped_ports
 * AUTO-GENERATED - DO NOT MODIFY
 */
int
dnx_ingress_reassembly_db_mapped_ports_dump(int  unit,  int  mapped_ports_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = mapped_ports_idx_0, I0 = mapped_ports_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_ingress_reassembly mapped_ports") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_ingress_reassembly mapped_ports\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_ingress_reassembly_db/mapped_ports.txt",
            "dnx_ingress_reassembly_db[%d]->","((dnx_ingress_reassembly_db_t*)sw_state_roots_array[%d][DNX_INGRESS_REASSEMBLY_MODULE_ID])->","mapped_ports[]: ");
        ...
        if (i0 == -1) {
            ...
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ((dnx_ingress_reassembly_db_t*)sw_state_roots_array[unit][DNX_INGRESS_REASSEMBLY_MODULE_ID])->mapped_ports
                , sizeof(*((dnx_ingress_reassembly_db_t*)sw_state_roots_array[unit][DNX_INGRESS_REASSEMBLY_MODULE_ID])->mapped_ports), I0, &s0) ? I0 - 1 : 0;
        }

        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_INGRESS_REASSEMBLY_MODULE_ID, ((dnx_ingress_reassembly_db_t*)sw_state_roots_array[unit][DNX_INGRESS_REASSEMBLY_MODULE_ID])->mapped_ports))
        {
            LOG_CLI((BSL_META("dnx_ingress_reassembly_db[]->((dnx_ingress_reassembly_db_t*)sw_state_roots_array[][DNX_INGRESS_REASSEMBLY_MODULE_ID])->mapped_ports[]: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_INGRESS_REASSEMBLY_MODULE_ID, ((dnx_ingress_reassembly_db_t*)sw_state_roots_array[unit][DNX_INGRESS_REASSEMBLY_MODULE_ID])->mapped_ports) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "dnx_ingress_reassembly_db[%d]->","((dnx_ingress_reassembly_db_t*)sw_state_roots_array[%d][DNX_INGRESS_REASSEMBLY_MODULE_ID])->","mapped_ports[%s%d]: ", s0, i0);
            ...
            DNX_ALGO_RES_MNGR_PRINT(
                DNX_INGRESS_REASSEMBLY_MODULE_ID,
                ((dnx_ingress_reassembly_db_t*)sw_state_roots_array[unit][DNX_INGRESS_REASSEMBLY_MODULE_ID])->mapped_ports[i0]);
...
dnx_ingress_reassembly_db_rcy_reassembly_context_dump(int  unit,  int  reassembly_context_idx_0,  int  reassembly_context_idx_1,  int  reassembly_context_idx_2,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            if (i1 == -1) {
                I1 = DNX_DATA_MAX_EGR_QUEUING_PARAMS_NOF_EGR_RCY_INTERFACES;
            ...
            if(i1 >= DNX_DATA_MAX_EGR_QUEUING_PARAMS_NOF_EGR_RCY_INTERFACES)
            {
                LOG_CLI((BSL_META("dnx_ingress_reassembly_db[]->((dnx_ingress_reassembly_db_t*)sw_state_roots_array[][DNX_INGRESS_REASSEMBLY_MODULE_ID])->rcy.reassembly_context[][][]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(DNX_DATA_MAX_EGR_QUEUING_PARAMS_NOF_EGR_RCY_INTERFACES == 0)
            {
                SHR_EXIT();
            }
...
const char* dnx_ingress_reassembly_db_layout_str[DNX_INGRESS_REASSEMBLY_DB_INFO_NOF_ENTRIES] = {
    ...
    "DNX_INGRESS_REASSEMBLY_DB~MAPPED_PORTS~",
