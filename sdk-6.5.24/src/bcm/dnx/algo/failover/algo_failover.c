    ...
    void *extra_argument)
{
    ...
    SHR_IF_ERR_EXIT(resource_tag_bitmap_free(unit, module_id, res_tag_bitmap, element, extra_argument));
    ...
    void *extra_argument)
{
    ...
    SHR_IF_ERR_EXIT(resource_tag_bitmap_free_several
                    (unit, module_id, res_tag_bitmap, nof_elements, element, extra_argument));
    ...
    int bank_id)
{
    ...
    failover_id = bank_id * dnx_data_l3.ecmp.nof_failover_banks_per_extended_ecmp_bank_get(unit) *
