...
/**
 * \brief - template mngr for egress probability profiles
 */
#define DNX_ALGO_SNIF_TEMP_MNGR_EGRESS_PROBABILITY_PROFILES         "SNIF_EGRESS_PROBABILITY_PROFILES"
/**
 * \brief - template mngr for egress crop size profiles
 */
#define DNX_ALGO_SNIF_TEMP_MNGR_EGRESS_CROP_SIZE_PROFILES           "SNIF_EGRESS_CROP_SIZE_PROFILES"

/**
 * \brief - default egress probability profile (100% probability)
 */
#define DNX_ALGO_SNIF_TEMP_MNGR_EGRESS_PROBABILITY_DEFAULT_PROFILE    (0)

/**
 * \brief - default crop size profile (no crop)
 */
#define DNX_ALGO_SNIF_TEMP_MNGR_EGRESS_CROP_SIZE_DEFAULT_PROFILE    (0)
