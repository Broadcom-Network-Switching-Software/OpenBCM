...
*/
static shr_error_e
dnx_rx_trap_v1_etpp_recycle_cmd_hw_set(
    int unit,
    uint32 core_id,
    uint8 recycle_cmd,
...
*/
static shr_error_e
dnx_rx_trap_v1_etpp_recycle_cmd_hw_clear(
    int unit,
    uint32 core_id,
    uint8 recycle_cmd)
{
...
*/
shr_error_e
dnx_rx_trap_v1_etpp_recycle_cmd_profile_set(
    int unit,
    ...
    int *new_recycle_cmd_p)
{
    ...
    if (is_first)
    {
        SHR_IF_ERR_EXIT(dnx_rx_trap_v1_etpp_recycle_cmd_hw_set
    ...
    if (is_last)
    {
        SHR_IF_ERR_EXIT(dnx_rx_trap_v1_etpp_recycle_cmd_hw_clear(unit, BCM_CORE_ALL, old_recycle_cmd));
    }
    ...
    dnx_rx_trap_etpp_config_t * etpp_config_p)
{
    ...
    {
        SHR_IF_ERR_EXIT(dnx_rx_trap_v1_etpp_recycle_cmd_profile_set
    ...
    SHR_IF_ERR_EXIT(dnx_rx_trap_v1_etpp_user_defined_action_hw_set(unit, profile, &(etpp_config_p->action)));
    ...
    int unit)
{
     ...
     */
    SHR_IF_ERR_EXIT(dnx_rx_trap_v1_erpp_filters_init(unit));
    /*
    ...
    bcm_rx_trap_config_t * config_p)
{
    ...
    switch (trap_class)
    {
        case DNX_RX_TRAP_CLASS_USER_DEFINED:
            ...
            {
                SHR_IF_ERR_EXIT(dnx_rx_trap_v1_etpp_user_defined_set(unit, trap_type, &etpp_config));
            }
            break;
        case DNX_RX_TRAP_CLASS_OAM:
