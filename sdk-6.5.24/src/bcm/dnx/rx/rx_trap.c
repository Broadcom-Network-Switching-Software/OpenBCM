    ...
    int trap_id)
{
    ...
    dnx_rx_trap_map_type_t trap_type_info;
    uint8 is_allocated = FALSE, is_oam_punt_or_protection = FALSE, is_user_defined = FALSE;
    ...
    uint8 *is_legal)
{
    ...
    *is_legal = FALSE;
    ...
    {
        SHR_IF_ERR_EXIT(dnx_rx_trap_type_map_info_get_dispatch(unit, oam_etpp_traps[trap_type], &trap_type_info));
    ...
    bcm_gport_t * gport_p)
{
    ...
    {
        /** In case of snoop need to convert profile value */
        dnx_action_profile = DNX_MIRROR_EGRESS_PROFILE_GET(unit, action_profile.profile);
    }
    else
    {
    ...
    bcm_rx_trap_protocol_profiles_t protocol_profiles)
{
    ...
    {
        BCM_GPORT_TUNNEL_ID_SET(in_lif_profile_info.ingress_fields.lif_gport, BCM_GPORT_SUB_TYPE_LIF_VAL_GET(gport));
    }
    ...
    bcm_gport_t * action_gport_p)
{
    ...
    else
    {
        ...
        {
            SHR_IF_ERR_EXIT(dnx_rx_trap_etpp_action_profile_get(unit, dbal_trap_id, &trap_action_profile));
