...
/** used to mark that a special field is not mapped to a specific special field
...
const flow_special_field_info_t flow_special_fields_db[NOF_FLOW_SPECIAL_FIELDS] = {
    ...
    {"IPV6",                        DBAL_FIELD_IPV6,                        FLOW_PAYLOAD_TYPE_UINT8_ARR,        FLOW_S_F_IPV6_DIP_MASK,     NULL,                   NULL,           (FLOW_S_FIELD_LIF_SHOULD_BE_IGNORED   | FLOW_S_FIELD_IS_LIF_MANDATORY   | FLOW_S_FIELD_CAN_BE_MASKED),                                         FLOW_S_FIELD_NO_MAPPING_CBS},
    ...
    {"TUNNEL_CLASS",                DBAL_FIELD_IPV6_MP_TUNNEL_IDX,          FLOW_PAYLOAD_TYPE_UINT32,           FLOW_S_FIELD_DIRECT_MAPPING},
    ...
    {"MPLS_CONTROL_PLATFORM_NAMESPACE", DBAL_FIELD_ESEM_COMMAND,            FLOW_PAYLOAD_TYPE_ENABLER,          FLOW_S_FIELD_UNLINKED, NULL,                  NULL,           FLOW_S_FIELD_SHOULD_BE_IGNORED,  FLOW_S_FIELD_NO_MAPPING_CBS},
    ...
    {"MATCH_LABEL_L3_INGRESS_INTF", DBAL_FIELD_MPLS_EXTENDED_FODO,          FLOW_PAYLOAD_TYPE_UINT32,           FLOW_S_FIELD_DIRECT_MAPPING},
    ...
    bcm_flow_special_fields_t * special_fields)
{
    ...
    if (user_val != 0)
    {
        ...
        SHR_IF_ERR_REPLACE_AND_EXIT(dnx_algo_gpm_gport_to_hw_resources
                                    (unit, user_val, flags, &gport_hw_resources), _SHR_E_NOT_FOUND, _SHR_E_PARAM);
        control_lif = (uint32) gport_hw_resources.local_in_lif;
    }
    else
    {
