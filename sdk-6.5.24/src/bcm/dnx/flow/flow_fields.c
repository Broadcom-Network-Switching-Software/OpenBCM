...
#include "app_defs/flow_ipvx_tunnel.h"
    ...
    void *field_data)
{
    ...
    /** set the inlif_profile */
    if (terminator_info->l2_ingress_info.service_type < bcmFlowServiceTypeCount)
    {
        SHR_IF_ERR_EXIT(dnx_flow_service_type_set
                        (unit, entry_handle_id, terminator_info->l2_ingress_info.service_type));
    }
    ...
    void *field_data)
{
    ...
    if (is_set)
    {
        SHR_IF_ERR_EXIT(dnx_rx_trap_lif_etpp_profile_lif_set(unit, gport_hw_resources, BCM_GPORT_INVALID,
    ...
    void *field_data)
{
    ...
    SHR_IF_ERR_EXIT(dbal_tables_field_max_value_get
                    (unit, flow_app_info->flow_table, DBAL_FIELD_LIF_GENERIC_DATA_0, FALSE, table->nof_result_types, 0,
    ...
    void *field_data)
{
    ...
    SHR_IF_ERR_EXIT(dbal_tables_field_max_value_get
                    (unit, flow_app_info->flow_table, DBAL_FIELD_LIF_GENERIC_DATA_0, FALSE,
    ...
    {
        SHR_IF_ERR_EXIT(dbal_tables_field_max_value_get
                        (unit, flow_app_info->flow_table, DBAL_FIELD_LIF_GENERIC_DATA_1, FALSE,
                         gport_hw_resources->inlif_dbal_result_type, 0, (int *) &max_field_size[0]));
