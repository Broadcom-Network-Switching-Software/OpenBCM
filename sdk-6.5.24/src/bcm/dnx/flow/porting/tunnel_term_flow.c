    ...
    bcm_tunnel_terminator_t * tunnel)
{
    ...
    SHR_IF_ERR_EXIT(bcm_dnx_flow_handle_get(unit, FLOW_APP_NAME_IPV4_P2P_EM_TERM_MATCH, &flow_handle));
    ...
    special_fields.special_fields[3].symbol = bcmTunnelTypeGreAnyIn4;
    ...
    bcm_tunnel_terminator_t * tunnel)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_dnx_flow_logical_field_id_get
                        (unit, flow_handle, TUNNEL_TERM_FLOW_FIELD_VRF, &vrf_field_id));
    ...
    special_fields.special_fields[3].symbol = DBAL_ENUM_FVAL_IPV4_QUALIFIER_TUNNEL_TYPE_GRE4;
