...
#define FLOW_IS_FLOW_ID_VIRTUAL(_flow_id)                   (_SHR_GPORT_SUB_TYPE_GET(_flow_id)) /** receives gport and checks if it is vritual */
...
typedef enum
{
    FLOW_APP_TERM_MATCH_IND_MANY_TO_ONE,  /** \brief using this indication to allow that many 
    applications will relate to the same DBAL table. */
...
typedef enum
{
    ...
    FLOW_S_F_MATCH_LABEL_L3_INGRESS_INTF,
