    ...
    l3_fec_entry_info_t * fec_entry_info)
{
     ...
     */
    if (dnx_data_l3.fec.fec_result_type_fields_get(unit, fec_entry)->has_global_outlif)
    {
     ...
     */
    if (dnx_data_l3.fec.fec_result_type_fields_get(unit, fec_entry)->has_global_outlif_second)
    {
    ...
    * hierarchical tm flow resolution
     */
    if (dnx_data_l3.fec.fec_result_type_fields_get(unit, fec_entry)->has_htm)
    {
     ...
     * eei resolution
     */
    if (dnx_data_l3.fec.fec_result_type_fields_get(unit, fec_entry)->has_eei)
    {
    ...
    dnx_l3_fec_entry_actions_e entry_action)
{
    ...
    else
    {
         ...
         */
        if (dnx_data_l3.fec.fec_result_type_fields_get(unit, fec_type)->has_global_outlif)
        {
    ...
    bcm_if_t * if_id)
{
    ...
    {
        if (_SHR_IS_FLAG_SET(egr->flags, BCM_L3_MC_RPF_SIP_BASE) && (!_SHR_IS_FLAG_SET(egr->flags, BCM_L3_IPMC)))
        {
