    ...
    bcm_l3_egress_t * egr_prev)
{
    ...
    {
        SHR_ERR_EXIT(_SHR_E_PARAM,
                     "bcmEncapAccessAc should not be used with BCM_L3_NATIVE_ENCAP and BCM_L3_FLAGS2_VLAN_TRANSLATION flags.\r\n");
    }
    /*
    ...
    bcm_l3_egress_t * egr)
{
    ...
    if (dnx_data_flow.arp.feature_get(unit, dnx_data_flow_arp_flow_in_use))
    {
    ...
    if (!((flags & (BCM_L3_KEEP_DSTMAC | BCM_L3_KEEP_VLAN)) == (BCM_L3_KEEP_DSTMAC | BCM_L3_KEEP_VLAN)))
    {
        ...
        if (_SHR_IS_FLAG_SET(egr->flags2, BCM_L3_FLAGS2_SRC_MAC))
        {
            SHR_IF_ERR_EXIT(dnx_l3_intf_egress_mymac_prefix_exchange
                            (unit, TRUE, egr->src_mac_addr, old_src_mac_addr_profile,
