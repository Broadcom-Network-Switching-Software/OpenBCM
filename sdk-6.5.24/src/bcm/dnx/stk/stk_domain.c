    ...
    uint32 *is_same_domain)
{
    ...
    /** Verify local_modid */
    SHR_INVOKE_VERIFY_DNXC(dnx_stk_domain_modid_verify(unit, local_modid));

    /** Verify sysport_modid */
    SHR_INVOKE_VERIFY_DNXC(dnx_stk_domain_modid_verify(unit, sysport_modid));
    ...
    int *tm_domain)
{
    ...
    /** Verify */
    SHR_INVOKE_VERIFY_DNXC(dnx_stk_domain_stk_domain_modid_get_verify(unit, modid, tm_domain));
