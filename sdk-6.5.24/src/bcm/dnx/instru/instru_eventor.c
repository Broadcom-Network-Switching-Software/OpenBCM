    ...
    bcm_instru_eventor_periodic_config_t *config)
{
    ...
    if ((source->source != bcmInstruSyncedCountersTypeIcgm) && (source->source != bcmInstruSyncedCountersTypeNif))
    {
    ...
    bcm_instru_eventor_context_conf_t *conf)
{
    ...
    } else if ((conf->flags & ~(BCM_INSTRU_EVENTOR_CONTEXT_CONF_NO_AGGREGATION | BCM_INSTRU_EVENTOR_CONTEXT_CONF_MAX_AGGREGATION_2)) != 0) { 
