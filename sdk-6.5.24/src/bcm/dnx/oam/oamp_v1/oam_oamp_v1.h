 ...
 *   * None
 */
shr_error_e dnx_oam_oamp_v1_init_general_configuration(
    int unit);

/**
 * \brief
 */
shr_error_e dnx_oam_oamp_v1_init_mep_db_cfg(
    int unit);
 ...
 */
shr_error_e dnx_oam_oamp_v1_init_response_table(
    int unit);

/*
 * Allow LM per priority per trap code.
 * This function should initialize OAMP_INIT_MAP_OAM_ID table.
 */
shr_error_e dnx_oam_oamp_v1_init_trap_map_cfg(
    int unit);
 ...
 * \see
 */
shr_error_e dnx_oam_oamp_v1_generic_memory_allocation(
    int unit);
