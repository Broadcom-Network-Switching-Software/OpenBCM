...
typedef struct
{
    ...
    /** Array of LIFs EP count */
    uint8 ref_count[DNX_OAM_MAX_MDL + 1];
} dnx_oam_lif_info_t;
...
typedef struct oam_lif_configured_lif_s
{
   ...
   /** mdl_mp_types of the mep for ingress and egress */
    ...
    uint8 nof_lm_meps;
    /** the number of opcodes per endpoint */
    uint8 ref_count[DNX_OAM_CLASSIFIER_BOTH_SIDES][DNX_OAM_MAX_MDL + 1];
