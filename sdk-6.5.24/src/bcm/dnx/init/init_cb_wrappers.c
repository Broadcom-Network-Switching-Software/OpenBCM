    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(dbal_device_init_done(unit));
    {
         ...
         */
        dnx_drv_soc_flags_set(unit, dnx_drv_soc_flags_get(unit) | dnx_drv_soc_f_inited());
        dnx_drv_soc_flags_set(unit, dnx_drv_soc_flags_get(unit) | dnx_drv_soc_f_all_modules_inited());
    }
