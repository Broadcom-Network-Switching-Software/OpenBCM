...
/* Hurricane4 does not supports RangeGroup set of APIs */
opt_UseRangeGroupSetOfApis = 0;
/* Hurricane4 Supports only Pipe Local */
opt_PipeLocal = 0;
/* Hurricane4 supports only one range of a given flag */
...
/* bcmSwitchRangeCheckersAPIType is not supported on Hurricane4 and is set to 1 always */
/*    if( !opt_UseRangeGroupSetOfApis ) {
