    ...
    int unit)
{
    ...
    if (rv != BCM_E_NONE) {
        ...
        if (rv != BCM_E_NONE)
        {
         printf("Error, dnx_utils_l3_eth_rif_create core_side_in_rif\n");
         return rv;
        }
    }
    ...
    if (rv != BCM_E_NONE) {
        ...
        if (rv != BCM_E_NONE)
        {
         printf("Error, dnx_utils_l3_eth_rif_create core_side_out_rif\n");
         return rv;
        }
    ...
    if (rv != BCM_E_NONE) {
        ...
        if (rv != BCM_E_NONE)
        {
         printf("Error, dnx_utils_l3_eth_rif_create access_side_out_rif\n");
         return rv;
        }
    ...
    int unit)
{
 ...
 {
     int rv = BCM_E_NONE;
     rv = create_recycle_entry_with_defaults(unit, &cint_mpls_mldp_info.recycle_entry_encap_id);
     if (rv != BCM_E_NONE)
     {
