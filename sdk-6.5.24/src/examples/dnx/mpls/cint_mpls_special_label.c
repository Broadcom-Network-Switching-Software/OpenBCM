 ...
 * 
 ...
 Copyright 2007-2021 Broadcom Inc. All rights reserved. File: cint_mpls_special_label.c Purpose: special label termination and encapsulation example. 
 */
    ...
    int unit)
{
    ...
    for (i = 0;i <= outer_mpls_tunnel_index;i++) {
        ...
        mpls_encap_tunnel[i].tunnel_id = 28194 + i ;
