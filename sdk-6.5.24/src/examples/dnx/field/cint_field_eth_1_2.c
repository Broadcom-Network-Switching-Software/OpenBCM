    ...
    bcm_field_context_t context_id)
{
    ...
    rv = bcm_field_group_add(unit, 0, &fg_info, &fg_eth_1_2_id);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = bcm_field_group_context_attach(unit, 0, fg_eth_1_2_id, context_id, &attach_info);
    if (rv != BCM_E_NONE)
    {
    ...
    bcm_field_context_t context_id)
{
    ...
    rv = bcm_field_group_context_detach(unit, fg_eth_1_2_id, context_id);
    if (rv != BCM_E_NONE)
    {
