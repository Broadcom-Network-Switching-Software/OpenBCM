    ...
    bcm_field_group_t * fg_id_p)
{
    ...
    void *dest_char;
    char *tmp_ptr;
    proc_name = "cint_field_external_pmf_fg_add_flags";
    ...
    int unit)
{
    ...
    rv = bcm_field_group_action_offset_get(unit, 0, cint_field_external_pmf_fg_id, cint_field_external_pmf_external_uda, &action_offset_in_fg);
    if(rv != BCM_E_NONE)
    {
