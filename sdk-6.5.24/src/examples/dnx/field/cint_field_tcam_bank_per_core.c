       ...
       int context_id)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &cint_field_tcam_bank_per_core_fg_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, cint_field_tcam_bank_per_core_fg_id, context_id, &attach_info));
    ...
    entry_info.core = 0;
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, cint_field_tcam_bank_per_core_fg_id, &entry_info, &cint_field_tcam_bank_per_core_entry_id0));
       ...
       int unit)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_tcam_bank_add(unit, 0, &tcam_bank_info));
    ...
    entry_info.core = 1;
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, cint_field_tcam_bank_per_core_fg_id, &entry_info, &cint_field_tcam_bank_per_core_entry_id1));
        ...
        int context_id)
{
    ...
    */
    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, cint_field_tcam_bank_per_core_fg_id, NULL, cint_field_tcam_bank_per_core_entry_id0));
    printf("Entry 0x%X (%d) was deleted from field group. \n", cint_field_tcam_bank_per_core_entry_id0, cint_field_tcam_bank_per_core_entry_id0, cint_field_tcam_bank_per_core_fg_id);
    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, cint_field_tcam_bank_per_core_fg_id, NULL, cint_field_tcam_bank_per_core_entry_id1));
    printf("Entry 0x%X (%d) was deleted from field group. \n", cint_field_tcam_bank_per_core_entry_id1, cint_field_tcam_bank_per_core_entry_id1, cint_field_tcam_bank_per_core_fg_id);

    /*
     * Detach the FG from its context
     */
    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, cint_field_tcam_bank_per_core_fg_id, context_id));
    printf("Field Group %d was detach from context %d. \n", cint_field_tcam_bank_per_core_fg_id, context_id);

    /*
     * Delete the FG
     */
    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, cint_field_tcam_bank_per_core_fg_id));
