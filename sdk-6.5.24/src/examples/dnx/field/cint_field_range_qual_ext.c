    ...
    bcm_field_context_t context_id)
{
    ...
    * Create field group
    */
   rv = cint_field_range_qual_ext_add_fg(unit, context_id);
   if (rv != BCM_E_NONE)
   {
    ...
    bcm_field_context_t context_id)
{
    ...
    rv = bcm_field_group_add(unit, 0, &fg_info, &cint_field_range_qual_ext_fg_id);
    if(rv != BCM_E_NONE)
    {
    ...
    rv = bcm_field_group_context_attach(unit, 0, cint_field_range_qual_ext_fg_id, context_id, &attach_info);
    if(rv != BCM_E_NONE)
    {
    ...
    bcm_field_context_t context_id)
{
    ...
    */
     ...
     */
    rv = bcm_field_group_context_detach(unit, cint_field_range_qual_ext_fg_id, context_id);
    if (rv != BCM_E_NONE)
    {
