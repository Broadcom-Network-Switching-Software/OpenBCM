    ...
    uint32 non_first_fragmented)
{
    ...
    rv = bcm_field_group_add(unit, 0, &fg_info, &Cint_field_ipv6_fragmented_non_first_fg_id);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = bcm_field_group_context_attach(unit, 0, Cint_field_ipv6_fragmented_non_first_fg_id, context_id, &attach_info);
    if (rv != BCM_E_NONE)
    {
    ...
    bcm_field_context_t context_id)
{
    ...
    rv = bcm_field_group_context_detach(unit, Cint_field_ipv6_fragmented_non_first_fg_id, context_id);
    if (rv != BCM_E_NONE)
    {
