...
int cint_sflow_field_advanced_group_create(int unit)
{
    ...
    */
    ...
    rv = bcm_field_range_set(unit, 0, bcmFieldStageIngressPMF1, cint_sflow_field_range_id_0, &range_info);
    if (rv != BCM_E_NONE)
    {
       printf("%s: Error (%d), in bcm_field_range_set cint_sflow_field_range_id_0\n", proc_name, rv);
       return rv;
    }
    range_info.min_val = 128;
    range_info.max_val = 144;
    rv = bcm_field_range_set(unit, 0, bcmFieldStageIngressPMF1, cint_sflow_field_range_id_1, &range_info);
    if (rv != BCM_E_NONE)
    {
       printf("%s: Error (%d), in bcm_field_range_set cint_sflow_field_range_id_1\n", proc_name, rv);
       return rv;
    }
 ...
 */
    ...
    rv = bcm_field_group_add(unit, 0, &cint_sflow_field_group_info, &cint_sflow_field_fg_id);
    if (rv != BCM_E_NONE)
    {
...
int cint_sflow_field_advanced_group_context_create(int unit, bcm_field_context_t *context_id, char *context_name)
{
    ...
    proc_name = "cint_sflow_field_advanced_group_context_create";
...
int cint_sflow_field_advanced_destroy(int unit,bcm_field_context_t context_id)
{
    ...
    proc_name = "cint_sflow_field_advanced_destroy";
