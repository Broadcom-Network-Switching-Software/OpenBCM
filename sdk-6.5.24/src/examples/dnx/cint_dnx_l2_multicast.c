...
int l2_multicast_flood__main_config__start_run(int unit,  l2_multicast_flood_s *param, int step){
    ...
    flags = (BCM_MULTICAST_WITH_ID | ((g_l2_multicast_flood.type == known_egress_multicast)?BCM_MULTICAST_EGRESS_GROUP:BCM_MULTICAST_INGRESS_GROUP));
    ...
    flags = ((g_l2_multicast_flood.type == known_egress_multicast)?BCM_MULTICAST_EGRESS_GROUP:BCM_MULTICAST_INGRESS_GROUP);
