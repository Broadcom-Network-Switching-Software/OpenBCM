 ...
 *
 *
 * For Jericho2 only: ETPP stat pp per VNI 
 *
 ...
 * int unit = 0; 
 * vxlan_eth_encapsulation(unit,201,202);
 * // Configure ETPP CRPS database/engine,create pp profile
 * cint_stat_pp_config_main(unit,ipv4_tunnel_outlif_statistics_properties,bcmStatCounterInterfaceEgressTransmitPp,0,BCM_CORE_ALL,0);
 ...
 * vxlan_encapsulation_vpn_to_vni_configuration(unit); 
 * exit;
 *
 ...
 * // Data: 0x00000000cd1d000c000200008100a0640800450a00620000000040112f6fa0000001ab000011ae4b12b5004e000008000000001388000000000000f10000123456788100000fffff000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f200000000000000000000000 
 *
 * // ETH1 packet into VXLAN tunnel
 *
 * tx 1 psrc=202 data=0x0000000000f10000123456788100000fffff000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f20
