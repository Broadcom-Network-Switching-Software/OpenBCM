...
static void*
xml_realloc(void *addr, size_t org_size, size_t new_size)
{
	return realloc(addr, new_size);
}
#endif /* !defined(DEBUG_MEMORY_LOCATION) && !defined(DEBUG_MEMORY) */
 ...
 */
xmlMallocFunc xmlMalloc = xml_alloc;
/**
 * xmlMallocAtomic:
 * @size:  the size requested in bytes
 *
 ...
 * Returns a pointer to the newly allocated block or NULL in case of error
 */
xmlMallocFunc xmlMallocAtomic = xml_alloc;
/**
 * xmlRealloc:
 * @mem: an already allocated block of memory
...
xmlInitializeGlobalState(xmlGlobalStatePtr gs)
{
    ...
    gs->xmlMalloc = (xmlMallocFunc) xml_alloc;
    gs->xmlMallocAtomic = (xmlMallocFunc) xml_alloc;
