...
char * techsupport_xflow_macsec_monterey_diag_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};

#ifndef BCM_SW_STATE_DUMP_DISABLE
/* "xflow-macsec" feature's software dump command list for specific device, currently NULL */
char * techsupport_xflow_macsec_monterey_sw_dump_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};
 ...
 * for monterey device */
techsupport_reg_t techsupport_xflow_macsec_monterey_reg_list[] = {
    ...
    {ESEC_OLP_RX_ETYPEr, register_type_global },
    {ESEC_OLP_RX_MAC_DA0r, register_type_global },
    {ESEC_OLP_RX_MAC_DA1r, register_type_global },
    {ESEC_OLP_RX_MAC_SA0r, register_type_global },
    {ESEC_OLP_RX_MAC_SA1r, register_type_global },
    {ESEC_OLP_RX_VLANr, register_type_global },
    ...
    { ISEC_OLP_TX_ETYPEr,register_type_global },
    { ISEC_OLP_TX_MAC_DA0r,register_type_global },
    { ISEC_OLP_TX_MAC_DA1r,register_type_global },
    { ISEC_OLP_TX_MAC_SA0r,register_type_global },
    { ISEC_OLP_TX_MAC_SA1r,register_type_global },
    { ISEC_OLP_TX_MISCr,register_type_global },
    { ISEC_OLP_TX_TYPEr,register_type_global },
    { ISEC_OLP_TX_VLANr,register_type_global },
    { ISEC_PN_EXPIRE_THDr,register_type_global },
    { ISEC_PP_CNTRLr,register_type_global },
    { ISEC_RUD_MGMT_RULEr,register_type_global },
    { ISEC_SPECIAL_TPIDr,register_type_global },
 ...
 * for monterey device */
static soc_mem_t techsupport_xflow_macsec_monterey_memory_table_list[] = {
...
techsupport_data_t techsupport_xflow_macsec_monterey_data = {
    techsupport_xflow_macsec_diag_cmdlist,
    techsupport_xflow_macsec_monterey_reg_list,
    techsupport_xflow_macsec_monterey_memory_table_list,
    techsupport_xflow_macsec_monterey_diag_cmdlist
#ifndef BCM_SW_STATE_DUMP_DISABLE
    , techsupport_xflow_macsec_sw_dump_cmdlist,
    techsupport_xflow_macsec_monterey_sw_dump_cmdlist
#endif /* BCM_SW_STATE_DUMP_DISABLE */
};
#endif
