    ...
    if(!sal_strncasecmp(function,"voltage",sal_strlen(function))) {
        ...
        if ((soc_get_board_id() == G50) || (soc_get_board_id() == G51) ||
            ...
            if (!source) {
                for (i = 0; i < bb_vs_all_len[bx]; i++) {
                    ...
                    cli_out("VDD_%s = %d.%03d Volts "
                            ...
                            adc_data.nsamples);
#endif
		    /* Invoke I2C_LTC_IOC_SET_RCONFIG for Helix5/HR4/TD3x1 to setup sense_resistor_data */
            ...
            cli_out("VDD_%s = %d.%03d Volts "
                    ...
                    adc_data.nsamples);
#endif
            /* Invoke I2C_LTC_IOC_SET_RCONFIG for HR4/TD3x1 to setup sense_resistor_data */
