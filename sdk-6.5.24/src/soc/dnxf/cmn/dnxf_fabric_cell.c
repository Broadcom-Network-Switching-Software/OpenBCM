    ...
    int *count)
{
    ...
    uint32 reg32_val;
    soc_reg_t dch_prg_cell_cnt_reg[] = { DCH_PRG_CELL_CNT_0r, DCH_PRG_CELL_CNT_1r, DCH_PRG_CELL_CNT_2r };
    soc_field_t prg_cell_cnt_field[] = { PRG_CELL_CNT_0f, PRG_CELL_CNT_1f, PRG_CELL_CNT_2f };
