    ...
    int unit)
{
    ...
    table->property.doc =
        ...
        "\n"
        "Assign unicast traffic meant to take a local route to a specific pipe.\n"
        "Assigning a local route unicast is done by a suffix lr_uc.\n"
        "\n"
        "fabric_pipe_map=0/1\n"
    ...
    int unit)
{
    ...
    table->keys[0].size = 37;
    table->info_get.key_size[0] = 37;
