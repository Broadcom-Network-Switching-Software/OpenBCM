...
static shr_error_e
ramon_a0_dnxf_data_port_regression_is_nrz_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnxf_data_module_port;
    int submodule_index = dnxf_data_port_submodule_regression;
    int feature_index = dnxf_data_port_regression_is_nrz_supported;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnxf_data_port_regression_is_nrz_supported;
    feature = &submodule->features[data_index];
    feature->set = ramon_a0_dnxf_data_port_regression_is_nrz_supported_set;
