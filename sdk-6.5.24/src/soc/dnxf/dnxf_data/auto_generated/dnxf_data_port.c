    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnxf_data_port_general_define_speed_max].labels[0] = "data_notrev";
    ...
    submodule_data->tables[dnxf_data_port_general_table_supported_phys].labels[0] = "data_notrev";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnxf_data_port_features_link_local_remote_fault_support].name = "link_local_remote_fault_support";
    submodule_data->features[dnxf_data_port_features_link_local_remote_fault_support].doc = "";
    submodule_data->features[dnxf_data_port_features_link_local_remote_fault_support].flags |= DNXC_DATA_F_FEATURE;
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnxf_data_port_regression_is_nrz_supported].name = "is_nrz_supported";
    submodule_data->features[dnxf_data_port_regression_is_nrz_supported].doc = "Is NRZ modulation supported";
    submodule_data->features[dnxf_data_port_regression_is_nrz_supported].flags |= DNXC_DATA_F_FEATURE;
