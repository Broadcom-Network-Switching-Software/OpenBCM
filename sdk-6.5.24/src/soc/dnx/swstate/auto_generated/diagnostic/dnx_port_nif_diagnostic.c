...
dnx_port_nif_db_arb_link_list_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(dnx_port_nif_db_arb_link_list_is_client_allocated_dump(unit, -1, filters));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
int
dnx_port_nif_db_arb_link_list_is_client_allocated_dump(int  unit,  int  is_client_allocated_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = is_client_allocated_idx_0, I0 = is_client_allocated_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_port_nif arb_link_list is_client_allocated") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_port_nif arb_link_list is_client_allocated\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_port_nif_db/arb_link_list/is_client_allocated.txt",
            "dnx_port_nif_db[%d]->","((dnx_port_nif_db_t*)sw_state_roots_array[%d][DNX_PORT_NIF_MODULE_ID])->","arb_link_list.is_client_allocated[]: ");
        ...
        if (i0 == -1) {
            ...
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ((dnx_port_nif_db_t*)sw_state_roots_array[unit][DNX_PORT_NIF_MODULE_ID])->arb_link_list.is_client_allocated
                , sizeof(*((dnx_port_nif_db_t*)sw_state_roots_array[unit][DNX_PORT_NIF_MODULE_ID])->arb_link_list.is_client_allocated), I0, &s0) ? I0 - 1 : 0;
        }

        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_PORT_NIF_MODULE_ID, ((dnx_port_nif_db_t*)sw_state_roots_array[unit][DNX_PORT_NIF_MODULE_ID])->arb_link_list.is_client_allocated))
        {
            LOG_CLI((BSL_META("dnx_port_nif_db[]->((dnx_port_nif_db_t*)sw_state_roots_array[][DNX_PORT_NIF_MODULE_ID])->arb_link_list.is_client_allocated[]: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_PORT_NIF_MODULE_ID, ((dnx_port_nif_db_t*)sw_state_roots_array[unit][DNX_PORT_NIF_MODULE_ID])->arb_link_list.is_client_allocated) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "dnx_port_nif_db[%d]->","((dnx_port_nif_db_t*)sw_state_roots_array[%d][DNX_PORT_NIF_MODULE_ID])->","arb_link_list.is_client_allocated[%s%d]: ", s0, i0);
            ...
            dnx_sw_state_print_uint8(
                unit,
                &((dnx_port_nif_db_t*)sw_state_roots_array[unit][DNX_PORT_NIF_MODULE_ID])->arb_link_list.is_client_allocated[i0]);
...
dnx_port_nif_db_oft_link_list_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(dnx_port_nif_db_oft_link_list_is_client_allocated_dump(unit, -1, filters));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
int
dnx_port_nif_db_oft_link_list_is_client_allocated_dump(int  unit,  int  is_client_allocated_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = is_client_allocated_idx_0, I0 = is_client_allocated_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_port_nif oft_link_list is_client_allocated") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_port_nif oft_link_list is_client_allocated\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_port_nif_db/oft_link_list/is_client_allocated.txt",
            "dnx_port_nif_db[%d]->","((dnx_port_nif_db_t*)sw_state_roots_array[%d][DNX_PORT_NIF_MODULE_ID])->","oft_link_list.is_client_allocated[]: ");
        ...
        if (i0 == -1) {
            ...
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ((dnx_port_nif_db_t*)sw_state_roots_array[unit][DNX_PORT_NIF_MODULE_ID])->oft_link_list.is_client_allocated
                , sizeof(*((dnx_port_nif_db_t*)sw_state_roots_array[unit][DNX_PORT_NIF_MODULE_ID])->oft_link_list.is_client_allocated), I0, &s0) ? I0 - 1 : 0;
        }

        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_PORT_NIF_MODULE_ID, ((dnx_port_nif_db_t*)sw_state_roots_array[unit][DNX_PORT_NIF_MODULE_ID])->oft_link_list.is_client_allocated))
        {
            LOG_CLI((BSL_META("dnx_port_nif_db[]->((dnx_port_nif_db_t*)sw_state_roots_array[][DNX_PORT_NIF_MODULE_ID])->oft_link_list.is_client_allocated[]: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_PORT_NIF_MODULE_ID, ((dnx_port_nif_db_t*)sw_state_roots_array[unit][DNX_PORT_NIF_MODULE_ID])->oft_link_list.is_client_allocated) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "dnx_port_nif_db[%d]->","((dnx_port_nif_db_t*)sw_state_roots_array[%d][DNX_PORT_NIF_MODULE_ID])->","oft_link_list.is_client_allocated[%s%d]: ", s0, i0);
            ...
            dnx_sw_state_print_uint8(
                unit,
                &((dnx_port_nif_db_t*)sw_state_roots_array[unit][DNX_PORT_NIF_MODULE_ID])->oft_link_list.is_client_allocated[i0]);
...
dnx_port_nif_db_ofr_link_list_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(dnx_port_nif_db_ofr_link_list_linking_info_dump(unit, -1, filters));
    SHR_IF_ERR_EXIT(dnx_port_nif_db_ofr_link_list_is_client_allocated_dump(unit, -1, filters));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
int
dnx_port_nif_db_ofr_link_list_list_info_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dnx_port_nif_db_ofr_link_list_list_info_head_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dnx_port_nif_db_ofr_link_list_list_info_tail_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dnx_port_nif_db_ofr_link_list_list_info_size_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dnx_port_nif_db_ofr_link_list_linking_info_dump(int  unit,  int  linking_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dnx_port_nif_db_ofr_link_list_linking_info_next_section_dump(int  unit,  int  linking_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = linking_info_idx_0, I0 = linking_info_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "dnx_port_nif_db[%d]->","((dnx_port_nif_db_t*)sw_state_roots_array[%d][DNX_PORT_NIF_MODULE_ID])->","ofr_link_list.linking_info[%s%d].next_section: ", s0, i0);
            ...
            dnx_sw_state_print_int(
                unit,
                &((dnx_port_nif_db_t*)sw_state_roots_array[unit][DNX_PORT_NIF_MODULE_ID])->ofr_link_list.linking_info[i0].next_section);
...
int
dnx_port_nif_db_ofr_link_list_is_client_allocated_dump(int  unit,  int  is_client_allocated_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = is_client_allocated_idx_0, I0 = is_client_allocated_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_port_nif ofr_link_list is_client_allocated") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_port_nif ofr_link_list is_client_allocated\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_port_nif_db/ofr_link_list/is_client_allocated.txt",
            "dnx_port_nif_db[%d]->","((dnx_port_nif_db_t*)sw_state_roots_array[%d][DNX_PORT_NIF_MODULE_ID])->","ofr_link_list.is_client_allocated[]: ");
        ...
        if (i0 == -1) {
            ...
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ((dnx_port_nif_db_t*)sw_state_roots_array[unit][DNX_PORT_NIF_MODULE_ID])->ofr_link_list.is_client_allocated
                , sizeof(*((dnx_port_nif_db_t*)sw_state_roots_array[unit][DNX_PORT_NIF_MODULE_ID])->ofr_link_list.is_client_allocated), I0, &s0) ? I0 - 1 : 0;
        }

        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_PORT_NIF_MODULE_ID, ((dnx_port_nif_db_t*)sw_state_roots_array[unit][DNX_PORT_NIF_MODULE_ID])->ofr_link_list.is_client_allocated))
        {
            LOG_CLI((BSL_META("dnx_port_nif_db[]->((dnx_port_nif_db_t*)sw_state_roots_array[][DNX_PORT_NIF_MODULE_ID])->ofr_link_list.is_client_allocated[]: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_PORT_NIF_MODULE_ID, ((dnx_port_nif_db_t*)sw_state_roots_array[unit][DNX_PORT_NIF_MODULE_ID])->ofr_link_list.is_client_allocated) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "dnx_port_nif_db[%d]->","((dnx_port_nif_db_t*)sw_state_roots_array[%d][DNX_PORT_NIF_MODULE_ID])->","ofr_link_list.is_client_allocated[%s%d]: ", s0, i0);
            ...
            dnx_sw_state_print_uint8(
                unit,
                &((dnx_port_nif_db_t*)sw_state_roots_array[unit][DNX_PORT_NIF_MODULE_ID])->ofr_link_list.is_client_allocated[i0]);
...
const char* dnx_port_nif_db_layout_str[DNX_PORT_NIF_DB_INFO_NOF_ENTRIES] = {
    ...
    "DNX_PORT_NIF_DB~ARB_LINK_LIST~IS_CLIENT_ALLOCATED~",
    ...
    "DNX_PORT_NIF_DB~OFT_LINK_LIST~IS_CLIENT_ALLOCATED~",
    ...
    "DNX_PORT_NIF_DB~OFR_LINK_LIST~IS_CLIENT_ALLOCATED~",
};
#endif 
