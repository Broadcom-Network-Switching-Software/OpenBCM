...
dnx_fabric_db_cable_swap_is_enable_dump(int  unit,  int  is_enable_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_FABRIC_MODULE_ID, ((dnx_fabric_db_t*)sw_state_roots_array[unit][DNX_FABRIC_MODULE_ID])->cable_swap.is_enable))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_FABRIC_MODULE_ID, ((dnx_fabric_db_t*)sw_state_roots_array[unit][DNX_FABRIC_MODULE_ID])->cable_swap.is_enable) == 0)
        {
            SHR_EXIT();
        }
...
dnx_fabric_db_cable_swap_is_master_dump(int  unit,  int  is_master_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_FABRIC_MODULE_ID, ((dnx_fabric_db_t*)sw_state_roots_array[unit][DNX_FABRIC_MODULE_ID])->cable_swap.is_master))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_FABRIC_MODULE_ID, ((dnx_fabric_db_t*)sw_state_roots_array[unit][DNX_FABRIC_MODULE_ID])->cable_swap.is_master) == 0)
        {
            SHR_EXIT();
        }
