...
mdb_db_infos_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(mdb_db_infos_em_interface_blk_dump(unit, -1, filters));
...
int
mdb_db_infos_em_interface_blk_dump(int  unit,  int  em_interface_blk_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = em_interface_blk_idx_0, I0 = em_interface_blk_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "mdb em_interface_blk") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate mdb em_interface_blk\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "mdb_db_infos/em_interface_blk.txt",
            "mdb_db_infos[%d]->","((mdb_tables_info*)sw_state_roots_array[%d][MDB_MODULE_ID])->","em_interface_blk[]: ");
        ...
        if (i0 == -1) {
            I0 = DBAL_NOF_PHYSICAL_TABLES;
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->em_interface_blk
                , sizeof(*((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->em_interface_blk), I0, &s0) ? I0 - 1 : 0;
        }

        if(i0 >= DBAL_NOF_PHYSICAL_TABLES)
        {
            LOG_CLI((BSL_META("mdb_db_infos[]->((mdb_tables_info*)sw_state_roots_array[][MDB_MODULE_ID])->em_interface_blk[]: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "mdb_db_infos[%d]->","((mdb_tables_info*)sw_state_roots_array[%d][MDB_MODULE_ID])->","em_interface_blk[%s%d]: ", s0, i0);
            ...
            dnx_sw_state_print_int(
                unit,
                &((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->em_interface_blk[i0]);
...
mdb_db_infos_fec_db_info_fec_db_map_dump(int  unit,  int  bank_id,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, MDB_MODULE_ID, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->fec_db_info.fec_db_map))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, MDB_MODULE_ID, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->fec_db_info.fec_db_map) == 0)
        {
            SHR_EXIT();
        }
...
mdb_db_infos_fec_db_info_fec_id_range_start_dump(int  unit,  int  index,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, MDB_MODULE_ID, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->fec_db_info.fec_id_range_start))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, MDB_MODULE_ID, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->fec_db_info.fec_id_range_start) == 0)
        {
            SHR_EXIT();
        }
...
mdb_db_infos_fec_db_info_fec_id_range_size_dump(int  unit,  int  index,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, MDB_MODULE_ID, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->fec_db_info.fec_id_range_size))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, MDB_MODULE_ID, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->fec_db_info.fec_id_range_size) == 0)
        {
            SHR_EXIT();
        }
