...
dnx_field_tcam_cache_shadow_init(int unit)
{
    ...
    DNX_SW_STATE_DIAG_INFO_UPDATE(
        ...
        sizeof(dnx_field_tcam_cache_shadow_t),
        NULL);
...
int
dnx_field_tcam_cache_shadow_tcam_bank_entry_key_key_data_range_read(int unit, uint32 tcam_bank_idx_0, uint32 tcam_bank_idx_1, uint32 entry_key_idx_0, uint32 nof_elements, uint8 *dest)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dnx_field_tcam_cache_shadow_tcam_bank_entry_key_key_data_range_write(int unit, uint32 tcam_bank_idx_0, uint32 tcam_bank_idx_1, uint32 entry_key_idx_0, uint32 nof_elements, const uint8 *source)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dnx_field_tcam_cache_shadow_payload_table_entry_payload_payload_data_range_read(int unit, uint32 payload_table_idx_0, uint32 payload_table_idx_1, uint32 entry_payload_idx_0, uint32 nof_elements, uint8 *dest)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dnx_field_tcam_cache_shadow_payload_table_entry_payload_payload_data_range_write(int unit, uint32 payload_table_idx_0, uint32 payload_table_idx_1, uint32 entry_payload_idx_0, uint32 nof_elements, const uint8 *source)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
