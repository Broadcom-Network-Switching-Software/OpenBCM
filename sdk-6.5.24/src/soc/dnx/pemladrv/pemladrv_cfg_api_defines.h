...
#define PEM_CFG_API_MAP_CHUNK_N_ENTRIES         ((SOC_IS_J2P(unit))?1024:256)
#define PEM_CFG_API_CAM_TCAM_CHUNK_N_ENTRIES    ((SOC_IS_J2P(unit))?16:32)
#define PEM_CFG_API_CAM_RESULT_CHUNK_N_ENTRIES  ((SOC_IS_J2P(unit))?16:32)
