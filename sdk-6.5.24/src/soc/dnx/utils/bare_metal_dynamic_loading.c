    ...
    char arr_prefix_dynamic_file[RHFILE_MAX_SIZE])
{
    ...
    sal_strncat_s(file_name, "bare_metal/auto_generated/dnx_data/arr/", sizeof(file_name));
    sal_strncat_s(file_name, image_name, sizeof(file_name));
    sal_strncat_s(file_name, "_arr.xml", sizeof(file_name));
    ...
    char aod_dynamic_file[RHFILE_MAX_SIZE])
{
    ...
    sal_strncat_s(file_name, image_name, sizeof(file_name));
    sal_strncat_s(file_name, "_aod.xml", sizeof(file_name));
    ...
    char mdb_app_db_dynamic_file[RHFILE_MAX_SIZE])
{
    ...
    sal_strncat_s(file_name, image_name, sizeof(file_name));
    sal_strncat_s(file_name, "_mdb_app_db.xml", sizeof(file_name));
    ...
    char pemal_soc_file[RHFILE_MAX_SIZE])
{
    ...
    sal_strncat_s(file_name, image_name, sizeof(file_name));
    sal_strncat_s(file_name, "_pemla_soc.xml", sizeof(file_name));
    ...
    char aod_sizes_file[RHFILE_MAX_SIZE])
{
    ...
    sal_strncat_s(file_name, image_name, sizeof(file_name));
    sal_strncat_s(file_name, "_aod_sizes.xml", sizeof(file_name));
