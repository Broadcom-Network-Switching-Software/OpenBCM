...
static shr_error_e
j2c_a0_dnx_data_latency_features_egress_latency_track_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_latency;
...
static shr_error_e
j2c_a0_dnx_data_latency_features_ingress_based_admission_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_latency;
...
static shr_error_e
j2c_a0_dnx_data_latency_based_admission_reject_flow_profile_value_set(
    int unit)
{
...
static shr_error_e
j2c_a0_dnx_data_latency_based_admission_max_supported_profile_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_latency;
    ...
    int unit)
{
    ...
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_latency_features_egress_latency_track_support_set;
    data_index = dnx_data_latency_features_ingress_based_admission;
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_latency_features_ingress_based_admission_set;
    ...
    define->set = j2c_a0_dnx_data_latency_based_admission_reject_flow_profile_value_set;
    data_index = dnx_data_latency_based_admission_define_max_supported_profile;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_latency_based_admission_max_supported_profile_set;
