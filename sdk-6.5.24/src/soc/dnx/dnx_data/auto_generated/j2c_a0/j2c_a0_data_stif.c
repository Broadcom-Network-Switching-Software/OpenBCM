...
static shr_error_e
j2c_a0_dnx_data_stif_config_mixing_ports_limitation_set(
    int unit)
{
...
static shr_error_e
j2c_a0_dnx_data_stif_port_max_nof_instances_set(
    int unit)
{
...
static shr_error_e
j2c_a0_dnx_data_stif_port_stif_ethu_select_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_stif;
...
static shr_error_e
j2c_a0_dnx_data_stif_port_stif_lane_mapping_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_stif;
...
static shr_error_e
j2c_a0_dnx_data_stif_port_ethu_id_stif_valid_set(
    int unit)
{
    int ethu_id_index;
...
static shr_error_e
j2c_a0_dnx_data_stif_report_etpp_core_in_portmetadata_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_stif;
...
static shr_error_e
j2c_a0_dnx_data_stif_report_stif_record_is_last_copy_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_stif;
...
static shr_error_e
j2c_a0_dnx_data_stif_flow_control_instance_0_must_be_on_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_stif;
...
static shr_error_e
j2c_a0_dnx_data_stif_regression_supported_modes_set(
    int unit)
{
    int mode_index;
    int speed_index;
    ...
    int unit)
{
    ...
    feature->set = j2c_a0_dnx_data_stif_config_mixing_ports_limitation_set;
    ...
    define->set = j2c_a0_dnx_data_stif_port_max_nof_instances_set;
    data_index = dnx_data_stif_port_define_stif_ethu_select_size;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_stif_port_stif_ethu_select_size_set;
    data_index = dnx_data_stif_port_define_stif_lane_mapping_size;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_stif_port_stif_lane_mapping_size_set;
    ...
    table->set = j2c_a0_dnx_data_stif_port_ethu_id_stif_valid_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_stif_report_etpp_core_in_portmetadata_set;
    data_index = dnx_data_stif_report_stif_record_is_last_copy;
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_stif_report_stif_record_is_last_copy_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_stif_flow_control_instance_0_must_be_on_set;
    ...
    table = &submodule->tables[data_index];
    table->set = j2c_a0_dnx_data_stif_regression_supported_modes_set;
