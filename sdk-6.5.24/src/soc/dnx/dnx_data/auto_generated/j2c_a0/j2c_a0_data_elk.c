...
static shr_error_e
j2c_a0_dnx_data_elk_general_elk_nif_if_type_sel_set(
    int unit)
{
...
static shr_error_e
j2c_a0_dnx_data_elk_connectivity_connect_mode_set(
    int unit)
{
    ...
    int unit)
{
    ...
    feature->set = j2c_a0_dnx_data_elk_general_elk_nif_if_type_sel_set;
    ...
    define->set = j2c_a0_dnx_data_elk_connectivity_connect_mode_set;
