    ...
    int unit)
{
    ...
    feature->property.doc = 
        "\n"
        "1:Enable Srv6 GSID Prefix 64b\n"
        "0:Disable Srv6 GSID Prefix 64b (Default 48b)\n"
        "\n"
    ;
    ...
    int unit)
{
    ...
    feature->property.doc = 
        "\n"
        "1:Enable Srv6 PSP mode\n"
        "0:Disable Srv6 PSP mode\n"
        "\n"
    ;
    feature->property.method = dnxc_data_property_method_suffix_enable;
    feature->property.method_str = "suffix_enable";
...
static shr_error_e
jr2_a0_dnx_data_srv6_termination_min_nof_terminated_sids_psp_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_srv6;
    int submodule_index = dnx_data_srv6_submodule_termination;
    int define_index = dnx_data_srv6_termination_define_min_nof_terminated_sids_psp;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_srv6_termination_min_nof_terminated_sids_usp_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_srv6;
    int submodule_index = dnx_data_srv6_submodule_termination;
    int define_index = dnx_data_srv6_termination_define_min_nof_terminated_sids_usp;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    feature->property.doc = 
        "\n"
        "1:Enable Srv6 reduce mode\n"
        "0:Disable Srv6 reduce mode\n"
        "\n"
    ;
    feature->property.method = dnxc_data_property_method_suffix_enable;
    feature->property.method_str = "suffix_enable";
    ...
    int unit)
{
    ...
    data_index = dnx_data_srv6_termination_define_min_nof_terminated_sids_psp;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_srv6_termination_min_nof_terminated_sids_psp_set;
    ...
    data_index = dnx_data_srv6_termination_define_min_nof_terminated_sids_usp;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_srv6_termination_min_nof_terminated_sids_usp_set;
