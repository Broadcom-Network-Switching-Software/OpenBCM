...
static shr_error_e
jr2_a0_dnx_data_switch_load_balancing_field_enablers_per_header_valid_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_switch;
    int submodule_index = dnx_data_switch_submodule_load_balancing;
    int define_index = dnx_data_switch_load_balancing_define_field_enablers_per_header_valid;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_switch_load_balancing_define_field_enablers_per_header_valid;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_switch_load_balancing_field_enablers_per_header_valid_set;
