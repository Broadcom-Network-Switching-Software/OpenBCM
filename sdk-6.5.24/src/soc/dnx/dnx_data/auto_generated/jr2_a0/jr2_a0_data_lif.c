...
static shr_error_e
jr2_a0_dnx_data_lif_global_lif_rif_not_in_glem_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_lif;
    int submodule_index = dnx_data_lif_submodule_global_lif;
    int define_index = dnx_data_lif_global_lif_define_rif_not_in_glem;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_lif_out_lif_out_lif_profile_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_lif;
    int submodule_index = dnx_data_lif_submodule_out_lif;
    int feature_index = dnx_data_lif_out_lif_out_lif_profile_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_lif_out_lif_mpls_data_table_skip_phase_check_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_lif;
    int submodule_index = dnx_data_lif_submodule_out_lif;
    int define_index = dnx_data_lif_out_lif_define_mpls_data_table_skip_phase_check;
    SHR_FUNC_INIT_VARS(unit);

    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    
    define->default_data = DBAL_TABLE_EMPTY;

    
    define->data = DBAL_TABLE_EMPTY;
    ...
    int unit)
{
    ...
    data_index = dnx_data_lif_global_lif_define_rif_not_in_glem;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_lif_global_lif_rif_not_in_glem_set;
    ...
    data_index = dnx_data_lif_out_lif_define_mpls_data_table_skip_phase_check;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_lif_out_lif_mpls_data_table_skip_phase_check_set;

    
    data_index = dnx_data_lif_out_lif_out_lif_profile_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_lif_out_lif_out_lif_profile_supported_set;
