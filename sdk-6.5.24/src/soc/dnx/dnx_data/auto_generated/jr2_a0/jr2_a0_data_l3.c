    ...
    int unit)
{
    ...
    {
        data = (dnx_data_l3_routing_enablers_layer_enablers_t *) dnxc_data_mgmt_table_data_get(unit, table, idx_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
    
    if (0 < table->keys[0].size)
    {
        data = (dnx_data_l3_routing_enablers_layer_enablers_t *) dnxc_data_mgmt_table_data_get(unit, table, 0, 0);
    ...
    {
        data = (dnx_data_l3_routing_enablers_layer_enablers_t *) dnxc_data_mgmt_table_data_get(unit, table, 1, 0);
    ...
    {
        data = (dnx_data_l3_routing_enablers_layer_enablers_t *) dnxc_data_mgmt_table_data_get(unit, table, 2, 0);
    ...
    {
        data = (dnx_data_l3_routing_enablers_layer_enablers_t *) dnxc_data_mgmt_table_data_get(unit, table, 3, 0);
    ...
    {
        data = (dnx_data_l3_routing_enablers_layer_enablers_t *) dnxc_data_mgmt_table_data_get(unit, table, 4, 0);
    ...
    {
        data = (dnx_data_l3_routing_enablers_layer_enablers_t *) dnxc_data_mgmt_table_data_get(unit, table, 5, 0);
    ...
    {
        data = (dnx_data_l3_routing_enablers_layer_enablers_t *) dnxc_data_mgmt_table_data_get(unit, table, 6, 0);
    ...
    {
        data = (dnx_data_l3_routing_enablers_layer_enablers_t *) dnxc_data_mgmt_table_data_get(unit, table, 7, 0);
    ...
    {
        data = (dnx_data_l3_routing_enablers_layer_enablers_t *) dnxc_data_mgmt_table_data_get(unit, table, 8, 0);
    ...
    {
        data = (dnx_data_l3_routing_enablers_layer_enablers_t *) dnxc_data_mgmt_table_data_get(unit, table, 9, 0);
    ...
    {
        data = (dnx_data_l3_routing_enablers_layer_enablers_t *) dnxc_data_mgmt_table_data_get(unit, table, 10, 0);
    ...
    {
        data = (dnx_data_l3_routing_enablers_layer_enablers_t *) dnxc_data_mgmt_table_data_get(unit, table, 11, 0);
    ...
    {
        data = (dnx_data_l3_routing_enablers_layer_enablers_t *) dnxc_data_mgmt_table_data_get(unit, table, 12, 0);
    ...
    int unit)
{
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_l3_fwd_ipmc_compression_mode_t, (1 * (table->keys[0].size) + 1  ), "data of dnx_data_l3_fwd_table_ipmc_compression_mode");
