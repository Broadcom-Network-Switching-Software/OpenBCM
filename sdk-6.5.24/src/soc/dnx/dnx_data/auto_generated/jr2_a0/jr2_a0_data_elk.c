...
static shr_error_e
jr2_a0_dnx_data_elk_general_is_kbp_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_elk;
    int submodule_index = dnx_data_elk_submodule_general;
    int feature_index = dnx_data_elk_general_is_kbp_supported;
    SHR_FUNC_INIT_VARS(unit);

    feature = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].features[feature_index];
    
    feature->default_data = g_kbp_compiled;

    
    feature->data = g_kbp_compiled;
...
static shr_error_e
jr2_a0_dnx_data_elk_general_elk_nif_if_type_sel_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_elk;
    int submodule_index = dnx_data_elk_submodule_general;
    int feature_index = dnx_data_elk_general_elk_nif_if_type_sel;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_elk_application_large_mc_mode1_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_elk;
    int submodule_index = dnx_data_elk_submodule_application;
    int define_index = dnx_data_elk_application_define_large_mc_mode1;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_elk_application_large_mc_mode2_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_elk;
    int submodule_index = dnx_data_elk_submodule_application;
    int define_index = dnx_data_elk_application_define_large_mc_mode2;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_elk_application_large_mc_mode3_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_elk;
    int submodule_index = dnx_data_elk_submodule_application;
    int define_index = dnx_data_elk_application_define_large_mc_mode3;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    define->property.doc = 
        ...
        "Mode 3: Supports higher capacity by enabling ACL algo mode 3.\n"
        "And VRF and DIP need not to be fully specified.\n"
        "\n"
    ;
    ...
    int unit)
{
    ...
    default_data->use_large_optimized_result = 0;
    ...
    data->use_large_optimized_result = 1;
    data->xl_db = 1;
    data->locality = 0;
    data->zero_size_ad = 0;
    ...
    data->initial_regular_capacity = 0;
    data->initial_optimized_capacity = 524288;
    data->xl_db = 0;
    data->locality = 2;
    data->zero_size_ad = 1;
    ...
    data->initial_regular_capacity = 0;
    data->initial_optimized_capacity = 131072;
    data->xl_db = 0;
    data->locality = 2;
    data->zero_size_ad = 1;
    data->dbal_none_direct_optimized = 1;
    ...
    int unit)
{
    ...
    define->property.mapping[5].name = "SINGLE_PORT_SMT";
    define->property.mapping[5].val = 4;
    ...
    int unit)
{
    ...
    data_index = dnx_data_elk_general_is_kbp_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_elk_general_is_kbp_supported_set;
    data_index = dnx_data_elk_general_elk_nif_if_type_sel;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_elk_general_elk_nif_if_type_sel_set;
    ...
    data_index = dnx_data_elk_application_define_large_mc_mode1;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_elk_application_large_mc_mode1_set;
    data_index = dnx_data_elk_application_define_large_mc_mode2;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_elk_application_large_mc_mode2_set;
    data_index = dnx_data_elk_application_define_large_mc_mode3;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_elk_application_large_mc_mode3_set;
