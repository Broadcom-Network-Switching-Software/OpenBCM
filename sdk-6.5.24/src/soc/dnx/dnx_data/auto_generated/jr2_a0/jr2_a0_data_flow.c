...
static shr_error_e
jr2_a0_dnx_data_flow_vlan_port_inlif_result_type_missing_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_flow;
    int submodule_index = dnx_data_flow_submodule_vlan_port;
    int feature_index = dnx_data_flow_vlan_port_inlif_result_type_missing;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_flow_vlan_port_inlif_result_type_missing;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_flow_vlan_port_inlif_result_type_missing_set;
