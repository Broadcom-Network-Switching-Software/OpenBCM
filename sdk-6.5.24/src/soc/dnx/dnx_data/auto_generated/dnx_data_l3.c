    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_l3_fec_separate_fwd_rpf_dbs].name = "separate_fwd_rpf_dbs";
    submodule_data->features[dnx_data_l3_fec_separate_fwd_rpf_dbs].doc = "FWD and RPF entries are placed in separate DBs.";
    submodule_data->features[dnx_data_l3_fec_separate_fwd_rpf_dbs].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_l3_fec_uneven_bank_sizes].name = "uneven_bank_sizes";
    submodule_data->features[dnx_data_l3_fec_uneven_bank_sizes].doc = "FER bank size information.";
    ...
    submodule_data->defines[dnx_data_l3_fec_define_bank_nof_physical_rows].doc = "The NOF rows that a FEC bank has.";
    ...
    submodule_data->defines[dnx_data_l3_fec_define_first_shared_bank].doc = "The first FEC bank id index which has values in the ECMP and the FEC ranges.";
    ...
    submodule_data->defines[dnx_data_l3_fec_define_nof_fec_directions].doc = "The number of FEC directions.";
    ...
    submodule_data->defines[dnx_data_l3_fec_define_fec_z_max_fec_id].doc = "The maximal FEC ID that is supported for FEC_Z.";
    ...
    submodule_data->defines[dnx_data_l3_fec_define_nof_dpc_fec_db].doc = "The number of DPC FEC DBs.";
    ...
    submodule_data->defines[dnx_data_l3_fec_define_nof_fec_dbs_all_cores].doc = "The number of FEC DBs for all cores.";
    ...
    submodule_data->defines[dnx_data_l3_fec_define_fer_hw_version].doc = "This value indicates the HW version of the FER";
    ...
    submodule_data->defines[dnx_data_l3_fec_define_fec_property_supported_flags].doc = "Supported BCM_SWITCH_FEC_PROPERTY_* flags to verify the bcm_switch_fec_property_get API.";
    ...
    submodule_data->tables[dnx_data_l3_fec_table_fec_resource_info].doc = "FEC recource types information";
    ...
    submodule_data->tables[dnx_data_l3_fec_table_fec_resource_info].keys[0].doc = "FEC resouce type.";

    
    submodule_data->tables[dnx_data_l3_fec_table_fec_resource_info].nof_values = 2;
    ...
    submodule_data->tables[dnx_data_l3_fec_table_super_fec_result_types_map].doc = "Map FEC dbal result type to an actual FEC type and FEC recource type.";
    ...
    submodule_data->tables[dnx_data_l3_fec_table_super_fec_result_types_map].keys[0].doc = "DBAL FEC result type.";
    ...
    submodule_data->tables[dnx_data_l3_fec_table_fec_result_type_fields].doc = "FEC table result type information.";
    ...
    submodule_data->tables[dnx_data_l3_fec_table_fec_result_type_fields].keys[0].doc = "FEC table result types.";
    ...
    submodule_data->tables[dnx_data_l3_fec_table_fec_physical_db].doc = "A list with FEC physical DBs";
    ...
    submodule_data->tables[dnx_data_l3_fec_table_fec_tables_info].doc = "FEC tables Information.";
    ...
    submodule_data->tables[dnx_data_l3_fec_table_fec_tables_info].keys[0].doc = "MDB FEC physical tables.";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->doc = "FER block data";
    ...
    submodule_data->features[dnx_data_l3_fer_mux_connection_supported].doc = "Allows different FER mux connectivity.";
    ...
    submodule_data->defines[dnx_data_l3_fer_define_mdb_granularity_ratio].doc = "This value indicate the ratio between the FER FEC granularity relative to the MDB";
    ...
    submodule_data->defines[dnx_data_l3_fer_define_nof_fer_sort_to_mdb_table_muxes].doc = "The number of muxes that selects between FER stages sorting blocks to MDB physical tables";
    ...
    submodule_data->defines[dnx_data_l3_fer_define_max_nof_sorting_blocks_per_fec_db].doc = "The maximal number of FEC sorting blocks for a signle FEC DB";
    ...
    submodule_data->tables[dnx_data_l3_fer_table_mux_configuration].doc = "Configuration of FER MUX connectivity";
    ...
    submodule_data->tables[dnx_data_l3_fer_table_mux_configuration].keys[0].doc = "The ID of the FER MUX.";
    ...
    submodule_data->tables[dnx_data_l3_fer_table_mux_connection].doc = "Information about the MUX connected to each FEC DB";
    ...
    submodule_data->tables[dnx_data_l3_fer_table_mux_connection].keys[0].doc = "The physical FEC database";
    ...
    submodule_data->tables[dnx_data_l3_fer_table_sorting_stages_info].doc = "FER sorting stages information";
    ...
    submodule_data->tables[dnx_data_l3_fer_table_sorting_stages_info].keys[0].doc = "The FER sorting stage";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_l3_source_address_table_address_type_info].doc = "Information about how many entries each address type takes in source_address_map table.";
    ...
    submodule_data->tables[dnx_data_l3_source_address_table_address_type_info].keys[0].doc = "Address type.";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_l3_routing_enablers_define_routing_enable_vector_length].doc = "The length in bits of the routing enablers vector.";
    ...
    submodule_data->defines[dnx_data_l3_routing_enablers_define_routing_enable_action_support].doc = "Indication whether routing enable action profiles are used to determine layer termination.";
    ...
    submodule_data->defines[dnx_data_l3_routing_enablers_define_routing_enable_action_profile_size].doc = "Size in bits of the routing enable action profile";
    ...
    submodule_data->defines[dnx_data_l3_routing_enablers_define_routing_enable_indication_nof_bits_per_layer].doc = "Number of bits in the routing enable vector responsible for a single uc/mc indication per layer type.";
    ...
    submodule_data->defines[dnx_data_l3_routing_enablers_define_routing_enable_nof_profiles_per_layer].doc = "Number of routing enabled indications (UC/MC) per layer type.";
    ...
    submodule_data->defines[dnx_data_l3_routing_enablers_define_routing_enabled_action_profile_id].doc = "The ID of the action profile which indicates that layer termination is enabled";
    ...
    submodule_data->tables[dnx_data_l3_routing_enablers_table_layer_enablers].doc = "Map layer type to routing enabled/disabled indication";
    ...
    submodule_data->tables[dnx_data_l3_routing_enablers_table_layer_enablers].keys[0].name = "idx";
    submodule_data->tables[dnx_data_l3_routing_enablers_table_layer_enablers].keys[0].doc = "Table entry index";

    
    submodule_data->tables[dnx_data_l3_routing_enablers_table_layer_enablers].nof_values = 4;
    ...
    submodule_data->tables[dnx_data_l3_routing_enablers_table_layer_enablers].values[0].name = "layer_type";
    submodule_data->tables[dnx_data_l3_routing_enablers_table_layer_enablers].values[0].type = "uint32";
    submodule_data->tables[dnx_data_l3_routing_enablers_table_layer_enablers].values[0].doc = "Layer type protocol";
    submodule_data->tables[dnx_data_l3_routing_enablers_table_layer_enablers].values[0].offset = UTILEX_OFFSETOF(dnx_data_l3_routing_enablers_layer_enablers_t, layer_type);
    submodule_data->tables[dnx_data_l3_routing_enablers_table_layer_enablers].values[1].name = "uc_enable";
    submodule_data->tables[dnx_data_l3_routing_enablers_table_layer_enablers].values[1].type = "uint8";
    submodule_data->tables[dnx_data_l3_routing_enablers_table_layer_enablers].values[1].doc = "UC enable value.";
    submodule_data->tables[dnx_data_l3_routing_enablers_table_layer_enablers].values[1].offset = UTILEX_OFFSETOF(dnx_data_l3_routing_enablers_layer_enablers_t, uc_enable);
    submodule_data->tables[dnx_data_l3_routing_enablers_table_layer_enablers].values[2].name = "mc_enable";
    submodule_data->tables[dnx_data_l3_routing_enablers_table_layer_enablers].values[2].type = "uint8";
    submodule_data->tables[dnx_data_l3_routing_enablers_table_layer_enablers].values[2].doc = "MC enable value.";
    submodule_data->tables[dnx_data_l3_routing_enablers_table_layer_enablers].values[2].offset = UTILEX_OFFSETOF(dnx_data_l3_routing_enablers_layer_enablers_t, mc_enable);
    submodule_data->tables[dnx_data_l3_routing_enablers_table_layer_enablers].values[3].name = "disable_profile";
    submodule_data->tables[dnx_data_l3_routing_enablers_table_layer_enablers].values[3].type = "uint8";
    submodule_data->tables[dnx_data_l3_routing_enablers_table_layer_enablers].values[3].doc = "Profile when routing is disabled.";
    submodule_data->tables[dnx_data_l3_routing_enablers_table_layer_enablers].values[3].offset = UTILEX_OFFSETOF(dnx_data_l3_routing_enablers_layer_enablers_t, disable_profile);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_l3_rif_out_rif_part_of_lif_mngr].doc = "Indication that the Out-RIF handling is part of the LIF manager.";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_l3_fwd_ipmc_rif_key_participation].doc = "Indicates whether the RIF participates in key entry construction.";
    ...
    submodule_data->features[dnx_data_l3_fwd_host_entry_support].doc = "Indicates whether the EM tables are used in forwarding.";
    ...
    submodule_data->features[dnx_data_l3_fwd_ipmc_config_cmprs_vrf_group].doc = "Indicates whether compressed VRF + group entries are supported";
    ...
    submodule_data->features[dnx_data_l3_fwd_lpm_default_entry_set_by_prefix].doc = "Indicates if LPM default prefix map is used for default route indication";
    ...
    submodule_data->features[dnx_data_l3_fwd_kaps_lpm_strength_profile_map_support].doc = "Indicates whether different LPM strength profile mapping is supported per KAPS application";
    ...
    submodule_data->defines[dnx_data_l3_fwd_define_lpm_strength_profiles_support].doc = "Indicates whether the KAPS strength mapping is different per LPM profile.";
    ...
    submodule_data->defines[dnx_data_l3_fwd_define_nof_lpm_strength_profiles].doc = "The number of LPM strength profiles";
    ...
    submodule_data->defines[dnx_data_l3_fwd_define_compressed_sip_ivl_size].doc = "The size in bits of the IPMC IP6 compressed SIP for IVL table";
    ...
    submodule_data->defines[dnx_data_l3_fwd_define_nof_compressed_ivl_sip].doc = "Number of supported IPMC compressed SIPs for IVL table.";
    ...
    submodule_data->defines[dnx_data_l3_fwd_define_uc_supported_route_flags].doc = "Supported L3 unicast route flags.";
    ...
    submodule_data->defines[dnx_data_l3_fwd_define_uc_supported_route_flags2].doc = "Supported L3 unicast route flags2.";
    ...
    submodule_data->defines[dnx_data_l3_fwd_define_uc_supported_kbp_route_flags].doc = "Supported L3 unicast KBP route flags.";
    ...
    submodule_data->defines[dnx_data_l3_fwd_define_uc_supported_kbp_route_flags2].doc = "Supported L3 unicast KBP route flags2.";
    ...
    submodule_data->defines[dnx_data_l3_fwd_define_ipmc_supported_flags].doc = "Supported flags for the IPMC APIs.";
    ...
    submodule_data->defines[dnx_data_l3_fwd_define_last_kaps_intf_id].doc = "The last valid KAPS interface used in KAPS LPM strength profile configuration";
    ...
    submodule_data->tables[dnx_data_l3_fwd_table_routing_tables].doc = "IPv4/IPv6 routing tables information";
    ...
    submodule_data->tables[dnx_data_l3_fwd_table_routing_tables].keys[0].doc = "Internet protocol version(IPv4 or IPv6)";
    ...
    submodule_data->tables[dnx_data_l3_fwd_table_mc_tables].doc = "IPv4/IPv6 MC tables information";
    ...
    submodule_data->tables[dnx_data_l3_fwd_table_mc_tables].keys[0].doc = "Internet protocol version(IPv4 or IPv6)";
    submodule_data->tables[dnx_data_l3_fwd_table_mc_tables].keys[1].name = "route_enable";
    submodule_data->tables[dnx_data_l3_fwd_table_mc_tables].keys[1].doc = "Indicates whether the tables are routing tables or bridge tables";
    ...
    submodule_data->tables[dnx_data_l3_fwd_table_ipmc_compression_mode].doc = "IPv4/IPv6 MC tables information";
    ...
    submodule_data->tables[dnx_data_l3_fwd_table_ipmc_compression_mode].nof_keys = 1;
    submodule_data->tables[dnx_data_l3_fwd_table_ipmc_compression_mode].keys[0].name = "route_enable";
    submodule_data->tables[dnx_data_l3_fwd_table_ipmc_compression_mode].keys[0].doc = "Indicates whether the tables are routing tables or bridge tables";
    ...
    submodule_data->tables[dnx_data_l3_fwd_table_lpm_default_prefix_length_info].doc = "LPM default prefix length information";
    ...
    submodule_data->tables[dnx_data_l3_fwd_table_lpm_default_prefix_length_info].keys[0].doc = "LPM physical table ID";
    ...
    submodule_data->tables[dnx_data_l3_fwd_table_lpm_app_db_to_strength_profile].doc = "LPM APP DB to entry strength profile mapping";
    ...
    submodule_data->tables[dnx_data_l3_fwd_table_lpm_app_db_to_strength_profile].keys[0].doc = "KAPS interface";
    ...
    int route_enable)
{
    ...
    data = dnxc_data_mgmt_table_data_get(unit, table, route_enable, 0);
    ...
    int value_index)
{
    ...
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_l3, dnx_data_l3_submodule_fwd, dnx_data_l3_fwd_table_ipmc_compression_mode);
    data = (const dnx_data_l3_fwd_ipmc_compression_mode_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_l3_ecmp_ecmp_group_profile_multiple_result_types_support].doc = "Indicates whether different ECMP group profile result types are supported";
    ...
    submodule_data->defines[dnx_data_l3_ecmp_define_nof_extended_ecmp_per_failover_bank].doc = "The upper 8k ECMP (from 32k to 40k) are placed in a memory shared by Failover and ECMP. The memory has 32 banks by 512 lines each.";
    ...
    submodule_data->defines[dnx_data_l3_ecmp_define_nof_failover_banks_per_extended_ecmp_bank].doc = "nof fec protection banks to be used for 1 ecmp extended bank";
    ...
    submodule_data->defines[dnx_data_l3_ecmp_define_ecmp_bank_size].doc = "The number of groups per HW bank. All groups in a bank belong to one hierarchy.";
    ...
    submodule_data->defines[dnx_data_l3_ecmp_define_consistent_bank_size_in_bits].doc = "The size of a single bank used for the consistent hashing members tables.";
    ...
    submodule_data->defines[dnx_data_l3_ecmp_define_ecmp_small_consistent_group_nof_entries].doc = "The nof entries in small consistent group";
    ...
    submodule_data->defines[dnx_data_l3_ecmp_define_ecmp_small_consistent_group_entry_size_in_bits].doc = "The nof bits for each entry in consistent small group";
    ...
    submodule_data->defines[dnx_data_l3_ecmp_define_nof_consistent_resources].doc = "The total number of consistent resources available";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_l3_vip_ecmp_supported].doc = "Indicates whether the ECMP VIP is supported in the device.";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_l3_wcmp_define_group_size_nof_bits].doc = "The max NOF bits of the WCMP group size field.";
    ...
    submodule_data->defines[dnx_data_l3_wcmp_define_max_member_weight].doc = "The max weight that can be assigned to a member of a WCMP group";
    ...
    submodule_data->defines[dnx_data_l3_wcmp_define_member_weight_quant_factor].doc = "Quantization factor used in the conversion of member's weight to HW units";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_l3_vrrp_define_nof_tcam_entries_used_by_exem].doc = "The number of TCAM entries used by the EXEM.";
    ...
    submodule_data->defines[dnx_data_l3_vrrp_define_exem_default_tcam_index].doc = "TCAM index for EXEM VSI LSB, SOURCE PORT or SRC PORT-protocol multiple my mac";
    ...
    submodule_data->defines[dnx_data_l3_vrrp_define_is_multiple_my_mac_da_table_per_msb_bit].name = "is_multiple_my_mac_da_table_per_msb_bit";
    submodule_data->defines[dnx_data_l3_vrrp_define_is_multiple_my_mac_da_table_per_msb_bit].doc = "Indication if the VRRP table PER_VSI_MULTIPLE_MY_MAC_DA_MSB is split";
    
    submodule_data->defines[dnx_data_l3_vrrp_define_is_multiple_my_mac_da_table_per_msb_bit].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_l3_vrrp_define_is_mapped_pp_port_used].name = "is_mapped_pp_port_used";
    submodule_data->defines[dnx_data_l3_vrrp_define_is_mapped_pp_port_used].doc = "Indication if mapped pp port is used in VRRP tables or in pp port as a key";
    ...
    submodule_data->defines[dnx_data_l3_vrrp_define_nof_dbs].doc = "The number of physical DBs used";
    ...
    submodule_data->tables[dnx_data_l3_vrrp_table_vrrp_tables].doc = "VRRP tables";
    ...
    submodule_data->tables[dnx_data_l3_vrrp_table_vrrp_tables].keys[0].doc = "Table type.";
    ...
    submodule_data->tables[dnx_data_l3_vrrp_table_data_bases].doc = "Information about physical DBs used.";
...
uint32
dnx_data_l3_vrrp_is_multiple_my_mac_da_table_per_msb_bit_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_l3, dnx_data_l3_submodule_vrrp, dnx_data_l3_vrrp_define_is_multiple_my_mac_da_table_per_msb_bit);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_l3_feature_routed_learning].doc = "Routed learning with pipe SA lookup and hasn't host lookup";
    ...
    submodule_data->features[dnx_data_l3_feature_ingress_frag_not_first].doc = "IPv4 fragmented but not first bit on layer qualifier, for ingress pipe";
    ...
    submodule_data->features[dnx_data_l3_feature_public_routing_support].doc = "Indication if public routing is supported.";
    ...
    submodule_data->features[dnx_data_l3_feature_separate_fwd_rpf_dbs].doc = "FWD and RPF entries are placed in separate DBs.";
    ...
    submodule_data->features[dnx_data_l3_feature_default_fec_limitation].doc = "Default FEC ID range limitation due to LPM table destination encoding.";
    ...
    submodule_data->features[dnx_data_l3_feature_wcmp_support].doc = "Indication if WCMP is supported";
    ...
    submodule_data->features[dnx_data_l3_feature_default_kaps_interface].doc = "Default KAPS interface indication.";
    submodule_data->features[dnx_data_l3_feature_default_kaps_interface].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_l3_feature_init_skip].name = "init_skip";
    submodule_data->features[dnx_data_l3_feature_init_skip].doc = "Indicates that not all parts of the init procedure are ready";
    submodule_data->features[dnx_data_l3_feature_init_skip].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_l3_feature_my_mac_prefix_0_is_invalid].name = "my_mac_prefix_0_is_invalid";
    submodule_data->features[dnx_data_l3_feature_my_mac_prefix_0_is_invalid].doc = "my mac prefix 0 is invalid";
