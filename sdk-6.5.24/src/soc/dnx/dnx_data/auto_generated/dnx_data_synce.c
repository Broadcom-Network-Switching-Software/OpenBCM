    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_synce_general_measure_rate_on_down_port_is_supported].name = "measure_rate_on_down_port_is_supported";
    submodule_data->features[dnx_data_synce_general_measure_rate_on_down_port_is_supported].doc = "Indicates SyncE support measure serdes rate on down port or not";
    submodule_data->features[dnx_data_synce_general_measure_rate_on_down_port_is_supported].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_synce_general_synce_ouput_force_is_supported].name = "synce_ouput_force_is_supported";
    submodule_data->features[dnx_data_synce_general_synce_ouput_force_is_supported].doc = "Indicates SyncE support output are always enabled (not only syncE clock is valid)";
    ...
    submodule_data->features[dnx_data_synce_general_synce_in_nanosync].doc = "Indicates SyncE is in nanasync block";
    ...
    submodule_data->features[dnx_data_synce_general_synce_no_fdr_cfg].doc = "Indicates SyncE has some configuration in FDR block for fabirc ";
    ...
    submodule_data->features[dnx_data_synce_general_synce_no_nif_div_cfg].doc = "Indicates SyncE doesn't need to configure nif div ";
    ...
    submodule_data->features[dnx_data_synce_general_synce_nif_clk_en_cfg].doc = "Indicates SyncE need to configure nif clk en ";
    ...
    submodule_data->defines[dnx_data_synce_general_define_nof_mas].doc = "Number of mas in the device.";
