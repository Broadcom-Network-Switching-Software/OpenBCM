    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_field_external_tcam_define_use_kbp].name = "use_kbp";
    submodule_data->defines[dnx_data_field_external_tcam_define_use_kbp].doc = "Device is a device that supports KBP.";
    
    submodule_data->defines[dnx_data_field_external_tcam_define_use_kbp].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->defines[dnx_data_field_external_tcam_define_nof_acl_keys_master_max].doc = "The maximum number of keys that can be used by ACL (not FWD) in KBP for a single context";
    ...
    submodule_data->defines[dnx_data_field_external_tcam_define_nof_acl_keys_fg_max].doc = "The maximum number of keys that can be used by ACL (not FWD) in KBP for a single field group";
    ...
    submodule_data->defines[dnx_data_field_external_tcam_define_nof_keys_total].doc = "The maximum number of keys that can be used in KBP. The number of ones in key_bmp.";
    ...
    submodule_data->defines[dnx_data_field_external_tcam_define_max_payload_size_per_opcode].doc = "The total payload size of the KBP";
...
uint32
dnx_data_field_external_tcam_use_kbp_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_external_tcam, dnx_data_field_external_tcam_define_use_kbp);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_field_qual_table_params].nof_values = 1;
    ...
    submodule_data->tables[dnx_data_field_qual_table_special_metadata_qual].name = "special_metadata_qual";
    submodule_data->tables[dnx_data_field_qual_table_special_metadata_qual].doc = "Per stage Per qualifier special metadata qualifiers";
    submodule_data->tables[dnx_data_field_qual_table_special_metadata_qual].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_field_qual_table_special_metadata_qual].size_of_values = sizeof(dnx_data_field_qual_special_metadata_qual_t);
    submodule_data->tables[dnx_data_field_qual_table_special_metadata_qual].entry_get = dnx_data_field_qual_special_metadata_qual_entry_str_get;

    
    submodule_data->tables[dnx_data_field_qual_table_special_metadata_qual].nof_keys = 2;
    submodule_data->tables[dnx_data_field_qual_table_special_metadata_qual].keys[0].name = "stage";
    submodule_data->tables[dnx_data_field_qual_table_special_metadata_qual].keys[0].doc = "stage enum";
    submodule_data->tables[dnx_data_field_qual_table_special_metadata_qual].keys[1].name = "qual";
    submodule_data->tables[dnx_data_field_qual_table_special_metadata_qual].keys[1].doc = "dnx qualifier";

    
    submodule_data->tables[dnx_data_field_qual_table_special_metadata_qual].nof_values = 3;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_field_qual_table_special_metadata_qual].values, dnxc_data_value_t, submodule_data->tables[dnx_data_field_qual_table_special_metadata_qual].nof_values, "_dnx_data_field_qual_table_special_metadata_qual table values");
    submodule_data->tables[dnx_data_field_qual_table_special_metadata_qual].values[0].name = "nof_parts";
    submodule_data->tables[dnx_data_field_qual_table_special_metadata_qual].values[0].type = "uint8";
    submodule_data->tables[dnx_data_field_qual_table_special_metadata_qual].values[0].doc = "number of parts of the qualfier.";
    submodule_data->tables[dnx_data_field_qual_table_special_metadata_qual].values[0].offset = UTILEX_OFFSETOF(dnx_data_field_qual_special_metadata_qual_t, nof_parts);
    submodule_data->tables[dnx_data_field_qual_table_special_metadata_qual].values[1].name = "offsets";
    submodule_data->tables[dnx_data_field_qual_table_special_metadata_qual].values[1].type = "uint16[DNX_DATA_MAX_FIELD_QUAL_SPECIAL_METADATA_QUAL_MAX_PARTS]";
    submodule_data->tables[dnx_data_field_qual_table_special_metadata_qual].values[1].doc = "qualifier offset for each part.";
    submodule_data->tables[dnx_data_field_qual_table_special_metadata_qual].values[1].offset = UTILEX_OFFSETOF(dnx_data_field_qual_special_metadata_qual_t, offsets);
    submodule_data->tables[dnx_data_field_qual_table_special_metadata_qual].values[2].name = "sizes";
    submodule_data->tables[dnx_data_field_qual_table_special_metadata_qual].values[2].type = "uint8[DNX_DATA_MAX_FIELD_QUAL_SPECIAL_METADATA_QUAL_MAX_PARTS]";
    submodule_data->tables[dnx_data_field_qual_table_special_metadata_qual].values[2].doc = "qualifier size for each part.";
    submodule_data->tables[dnx_data_field_qual_table_special_metadata_qual].values[2].offset = UTILEX_OFFSETOF(dnx_data_field_qual_special_metadata_qual_t, sizes);
...
const dnx_data_field_qual_special_metadata_qual_t *
dnx_data_field_qual_special_metadata_qual_get(
    int unit,
    int stage,
    int qual)
{
    ...
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_field, dnx_data_field_submodule_qual, dnx_data_field_qual_table_special_metadata_qual);
    
    data = dnxc_data_mgmt_table_data_get(unit, table, stage, qual);
    return (const dnx_data_field_qual_special_metadata_qual_t *) data;
...
shr_error_e
dnx_data_field_qual_special_metadata_qual_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_field_qual_special_metadata_qual_t *data;
    SHR_FUNC_INIT_VARS(unit);

    
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_field, dnx_data_field_submodule_qual, dnx_data_field_qual_table_special_metadata_qual);
    data = (const dnx_data_field_qual_special_metadata_qual_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, key1);
    switch (value_index)
    {
        case 0:
...
const dnxc_data_table_info_t *
dnx_data_field_qual_special_metadata_qual_info_get(
    int unit)
{

    
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_field, dnx_data_field_submodule_qual, dnx_data_field_qual_table_special_metadata_qual);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_field_map_define_supported].name = "supported";
    submodule_data->defines[dnx_data_field_map_define_supported].doc = "Maps supported";
    
    submodule_data->defines[dnx_data_field_map_define_supported].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_field_map_supported_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_map, dnx_data_field_map_define_supported);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_field_exem_define_supported].name = "supported";
    submodule_data->defines[dnx_data_field_exem_define_supported].doc = "indicated if EXEM FG's are supported";
    
    submodule_data->defines[dnx_data_field_exem_define_supported].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_field_exem_supported_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_exem, dnx_data_field_exem_define_supported);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_field_exem_learn_flush_machine_define_supported].name = "supported";
    submodule_data->defines[dnx_data_field_exem_learn_flush_machine_define_supported].doc = "EXEM Learn is supported";
    
    submodule_data->defines[dnx_data_field_exem_learn_flush_machine_define_supported].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_field_exem_learn_flush_machine_supported_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_exem_learn_flush_machine, dnx_data_field_exem_learn_flush_machine_define_supported);
}
