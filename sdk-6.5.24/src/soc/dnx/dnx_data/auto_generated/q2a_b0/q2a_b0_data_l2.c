...
static shr_error_e
q2a_b0_dnx_data_l2_feature_mact_access_by_opportunistic_learning_set(
    int unit)
{
    ...
    int unit)
{
    ...
    feature->set = q2a_b0_dnx_data_l2_feature_mact_access_by_opportunistic_learning_set;
