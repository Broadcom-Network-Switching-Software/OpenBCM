    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_nif_global_is_ilkn_after_flexe].doc = "Does ilkn ports come before flexe ports";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_nif_eth_is_ethu_nof_per_core_supported].name = "is_ethu_nof_per_core_supported";
    submodule_data->features[dnx_data_nif_eth_is_ethu_nof_per_core_supported].doc = "Indicates if the device supportes ethu_per_core table.";
    submodule_data->features[dnx_data_nif_eth_is_ethu_nof_per_core_supported].flags |= DNXC_DATA_F_FEATURE;
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_nif_ofr_define_nof_context].name = "nof_context";
    submodule_data->defines[dnx_data_nif_ofr_define_nof_context].doc = "Number of OFR contexts (Eth+Framer)";
    
    submodule_data->defines[dnx_data_nif_ofr_define_nof_context].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_nif_ofr_nof_context_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_nif, dnx_data_nif_submodule_ofr, dnx_data_nif_ofr_define_nof_context);
}
