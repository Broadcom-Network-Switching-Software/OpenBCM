    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_srv6_termination_define_min_nof_terminated_sids_psp].doc = "Min number of SIDs that can be terminated in SRv6 PSP Egress node";
    ...
    submodule_data->defines[dnx_data_srv6_termination_define_max_nof_terminated_sids_psp].doc = "Max number of SIDs that can be terminated in SRv6 PSP Egress node";
    ...
    submodule_data->defines[dnx_data_srv6_termination_define_min_nof_terminated_sids_usp].doc = "Min number of SIDs that can be terminated in SRv6 USP Egress node";
