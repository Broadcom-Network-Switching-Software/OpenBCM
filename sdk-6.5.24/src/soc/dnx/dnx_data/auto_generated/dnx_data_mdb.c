    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_mdb_em_table_em_emp].nof_values = 3;
    ...
    submodule_data->tables[dnx_data_mdb_em_table_data_rules].values[1].name = "valid";
    ...
    submodule_data->tables[dnx_data_mdb_em_table_data_rules].values[1].offset = UTILEX_OFFSETOF(dnx_data_mdb_em_data_rules_t, valid);
    submodule_data->tables[dnx_data_mdb_em_table_data_rules].values[2].name = "entry_mask";
    ...
    submodule_data->tables[dnx_data_mdb_em_table_data_rules].values[2].offset = UTILEX_OFFSETOF(dnx_data_mdb_em_data_rules_t, entry_mask);
    submodule_data->tables[dnx_data_mdb_em_table_data_rules].values[3].name = "entry_filter";
    ...
    submodule_data->tables[dnx_data_mdb_em_table_data_rules].values[3].offset = UTILEX_OFFSETOF(dnx_data_mdb_em_data_rules_t, entry_filter);
