    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_dbal_diag_table_example_1_key].doc = "dbal example_1_key";
    ...
    submodule_data->tables[dnx_data_dbal_diag_table_example_1_key].keys[0].doc = "key1 value";
    ...
    submodule_data->tables[dnx_data_dbal_diag_table_example_1_key].values[0].doc = "value1";
    ...
    submodule_data->tables[dnx_data_dbal_diag_table_example_2_keys].doc = "dbal example_2_keys";
    ...
    submodule_data->tables[dnx_data_dbal_diag_table_example_2_keys].keys[0].doc = "key1 value";
    submodule_data->tables[dnx_data_dbal_diag_table_example_2_keys].keys[1].name = "key2";
    submodule_data->tables[dnx_data_dbal_diag_table_example_2_keys].keys[1].doc = "key2 value";
    ...
    submodule_data->tables[dnx_data_dbal_diag_table_example_2_keys].values[0].doc = "value1";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_dbal_db_init_zero_size_payload_support].doc = "Indicates device supports 0 size payload";
    ...
    submodule_data->features[dnx_data_dbal_db_init_support_encoding_for_hl_tcam].doc = "Apply the encoding/decoding calculation for write/read operations in HL TCAM tables";
