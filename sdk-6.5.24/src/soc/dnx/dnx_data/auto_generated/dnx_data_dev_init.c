    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_dev_init_time_define_init_total_thresh].doc = "Default time threshold (in microseconds) for the overall time that the BCM Init takes. This value will be set to the worst run measurement plus 10%";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_dev_init_mem_table_default].values[4].doc = "determine if this mem is valid";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_dev_init_general_multithreading].doc = "If set, allow multithreading during device init";
    ...
    submodule_data->features[dnx_data_dev_init_general_egress_estimated_bta_btr_config].name = "egress_estimated_bta_btr_config";
    submodule_data->features[dnx_data_dev_init_general_egress_estimated_bta_btr_config].doc = "Set estimated byte to add and estimated byte to remove configuration in egress pipe";
    submodule_data->features[dnx_data_dev_init_general_egress_estimated_bta_btr_config].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_dev_init_general_application_v1].name = "application_v1";
    submodule_data->features[dnx_data_dev_init_general_application_v1].doc = "indicates whether the device supports application_v1";
    ...
    submodule_data->features[dnx_data_dev_init_general_application_v2].doc = "indicates whether the device supports application_v2";
    ...
    submodule_data->features[dnx_data_dev_init_general_erpp_threshold_prp_per_port_info].doc = "If set, indicates that in ERPP_FIFO_ALMOST_FULL_THRESHOLD is present ALMOST_FULL_THRESHOLD_PRP_PER_PORT_INFO_FIFO";
    ...
    submodule_data->features[dnx_data_dev_init_general_ippe_sync_counter].doc = "If needed, every SyncCounter number of clocks a bubble will be inserted to the IHP pipe, to allow database managements and/or CPU indirect access at an assured rate";
    ...
    submodule_data->features[dnx_data_dev_init_general_fai_namespace].doc = "support FAI namespace for different protocol";
    ...
    submodule_data->tables[dnx_data_dev_init_general_table_clock_power_down].doc = "clock power down registers";
    ...
    submodule_data->tables[dnx_data_dev_init_general_table_clock_power_down].keys[0].doc = "running index";
    ...
    submodule_data->tables[dnx_data_dev_init_general_table_clock_power_down].values[0].doc = "power down register";
    ...
    submodule_data->tables[dnx_data_dev_init_general_table_clock_power_down].values[1].doc = "power down field";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_dev_init_context_etps_selection_profile].doc = "Enabled for devices supporting etps type id to etps type profile mapping at egress CS tables";
    ...
    submodule_data->defines[dnx_data_dev_init_context_define_prp_pem_context_selection_mask_offset].doc = "Mask fields offset for PRP PEM CAM";
    ...
    submodule_data->defines[dnx_data_dev_init_context_define_prp_context_selection_result_offset].doc = "Result fields offset for PRP PEM CAM";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_dev_init_ha_example_init].name = "example_init";
    submodule_data->features[dnx_data_dev_init_ha_example_init].doc = "specify if example ctest should be init. Disabled in default";
    submodule_data->features[dnx_data_dev_init_ha_example_init].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_dev_init_ha_sw_state_diagnostics].name = "sw_state_diagnostics";
    submodule_data->features[dnx_data_dev_init_ha_sw_state_diagnostics].doc = "Enable sw state diagnostics (e.g. size_get)";
    ...
    submodule_data->defines[dnx_data_dev_init_ha_define_warmboot_backoff_rate].name = "warmboot_backoff_rate";
    submodule_data->defines[dnx_data_dev_init_ha_define_warmboot_backoff_rate].doc = "Exponential rate at which to skip tests in WarmBoot regression sessions";
    
    submodule_data->defines[dnx_data_dev_init_ha_define_warmboot_backoff_rate].flags |= DNXC_DATA_F_NUMERIC;

    submodule_data->defines[dnx_data_dev_init_ha_define_nof_guaranteed_reboots].name = "nof_guaranteed_reboots";
    submodule_data->defines[dnx_data_dev_init_ha_define_nof_guaranteed_reboots].doc = "Specify number of tests at beginning of session to run reboots for";
    
    submodule_data->defines[dnx_data_dev_init_ha_define_nof_guaranteed_reboots].flags |= DNXC_DATA_F_NUMERIC;
...
uint32
dnx_data_dev_init_ha_warmboot_backoff_rate_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_dev_init, dnx_data_dev_init_submodule_ha, dnx_data_dev_init_ha_define_warmboot_backoff_rate);
}

uint32
dnx_data_dev_init_ha_nof_guaranteed_reboots_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_dev_init, dnx_data_dev_init_submodule_ha, dnx_data_dev_init_ha_define_nof_guaranteed_reboots);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->doc = "BCM RX init";
    ...
    submodule_data->defines[dnx_data_dev_init_rx_define_rx_pool_nof_pkts].doc = "specify number of packets for BCM RX buffer allocation";
