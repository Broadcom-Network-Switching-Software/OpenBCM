    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_bier_params_hw_supported].doc = "Is bier hw supported";
    ...
    submodule_data->features[dnx_data_bier_params_egress_only].doc = "no ingress replication in the system";
    ...
    submodule_data->features[dnx_data_bier_params_ingress_only].doc = "no egress replication in the system, can be set only in devices that don't require ETPP access to MCDB";
    ...
    submodule_data->features[dnx_data_bier_params_ingress_bfr_pos_msb_start].doc = "ingress bfr table start from msb";
    ...
    submodule_data->features[dnx_data_bier_params_bfr_bit_str_in_mcdb].doc = "bit string is resolved from MCDB";
