    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_fc_general_ilu_fc_status_per_tdm].doc = "Indication that the presented status indication for FC from and to ILU is separate for TDM and non-TDM trafic.";
    ...
    submodule_data->features[dnx_data_fc_general_disable_pfc_mask_on_link_fail].doc = "Disable PFC ignore when RX link is failing";
    ...
    submodule_data->features[dnx_data_fc_general_gen_pfc_from_llfc_bitmap_per_type].doc = "The bitmap for generation of PFC based on LLFC signal is per bitmap type A/B/C/D ";
    ...
    submodule_data->features[dnx_data_fc_general_llfc_handled_in_cfc].doc = "LLFC signals from NIF are handled in CFC.";
    ...
    submodule_data->features[dnx_data_fc_general_coe_vid_mapping].doc = "COE channel ID is based on VID logic.";
    ...
    submodule_data->features[dnx_data_fc_general_ilkn_inband_support].doc = "ILKN Inband Flow Control is supported";
    ...
    submodule_data->features[dnx_data_fc_general_oob_support].doc = "OOB Flow Control is supported";
    ...
    submodule_data->features[dnx_data_fc_general_coe_support].doc = "COE Flow Control is supported";
    ...
    submodule_data->features[dnx_data_fc_general_nif_pfc_bitmaps_e_f_support].doc = "Additional types (E and F) of NIF RX PFC Bitmap and NIF TX PFC Bitmap supported";
    ...
    submodule_data->features[dnx_data_fc_general_qmlf_fc_high_and_low_rmcs_support].doc = "QMLF thresholds are set separately for dedicated high and low RMCs";
    ...
    submodule_data->defines[dnx_data_fc_general_define_gen_bmp_first_id].doc = "First ID of Generic bitmaps that can be used by users.";
    ...
    submodule_data->defines[dnx_data_fc_general_define_nof_bits_in_pfc_status_select].doc = "Number of bits in selector 64 of the NIF PFC statuses to be presented.";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->doc = "Calendar Flow Control parameters that are common for all calendar types(OOB, COE, Inband ILKN).";
    ...
    submodule_data->defines[dnx_data_fc_calendar_common_define_rx_dest_pfc].doc = "Index to write in HW to indicate that the calendar entry's destination is one of the PFCs.";
    ...
    submodule_data->defines[dnx_data_fc_calendar_common_define_rx_dest_nif_llfc].doc = "Index to write in HW to indicate that the calendar entry's destination is one of the nof-links NIF's link-level FCs.";
    ...
    submodule_data->defines[dnx_data_fc_calendar_common_define_rx_dest_port_2_prio].doc = "Index to write in HW to indicate that the calendar entry's destination is one port (2 priorities mode).";
    ...
    submodule_data->defines[dnx_data_fc_calendar_common_define_rx_dest_port_4_prio].doc = "Index to write in HW to indicate that the calendar entry's destination is one port (4 priorities mode).";
    ...
    submodule_data->defines[dnx_data_fc_calendar_common_define_rx_dest_port_8_prio].doc = "Index to write in HW to indicate that the calendar entry's destination is one port (8 priorities mode).";
    ...
    submodule_data->defines[dnx_data_fc_calendar_common_define_rx_dest_pfc_generic_bmp].doc = "Index to write in HW to indicate that the calendar entry's destination is one of the the generic PFC bitmaps.";
    ...
    submodule_data->defines[dnx_data_fc_calendar_common_define_rx_dest_empty].doc = "Index to write in HW to indicate that the calendar entry's destination is currently empty.";
    ...
    submodule_data->defines[dnx_data_fc_calendar_common_define_tx_src_vsq_a_b_c].doc = "Index to write in HW to indicate that the calendar entry's source is one of STE VSQs (Groups A/B/C).";
    ...
    submodule_data->defines[dnx_data_fc_calendar_common_define_tx_src_vsq_d].doc = "Index to write in HW to indicate that the calendar entry's source is one of STE STAT VSQs (Groups D).";
    ...
    submodule_data->defines[dnx_data_fc_calendar_common_define_tx_src_llfc_vsq].doc = "Index to write in HW to indicate that the calendar entry's source is one of STE LLFC VSQs (Groups E).";
    ...
    submodule_data->defines[dnx_data_fc_calendar_common_define_tx_src_pfc_vsq].doc = "Index to write in HW to indicate that the calendar entry's source is one of STE PFC VSQs (Groups F).";
    ...
    submodule_data->defines[dnx_data_fc_calendar_common_define_tx_src_glb_rsc].doc = "Index to write in HW to indicate that the calendar entry's source is one of the Global Resource FCs.";
    ...
    submodule_data->defines[dnx_data_fc_calendar_common_define_tx_src_nif_llfc].doc = "Index to write in HW to indicate that the calendar entry's source is one of the Link-Level FC from the NIF-RX-MLF.";
    ...
    submodule_data->defines[dnx_data_fc_calendar_common_define_tx_src_empty].doc = "Index to write in HW to indicate that the calendar entry's source is currently empty.";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_fc_coe_define_nof_supported_chan_ids].doc = "Number of supported channel IDs in COE flow control";
    ...
    submodule_data->defines[dnx_data_fc_coe_define_nof_coe_ptc_mask_width].doc = "Number of COE_PTC_MASK width";
    ...
    submodule_data->defines[dnx_data_fc_coe_define_nof_coe_ptc_left_shift_width].doc = "Number of COE PTC left shift width";
    ...
    submodule_data->defines[dnx_data_fc_coe_define_map_value_size_in_bits].doc = "For DBAL - size in bits of the Map value field of the calendar.";
    ...
    submodule_data->defines[dnx_data_fc_coe_define_coe_ptc_mask].doc = "Set mask for COE PTC";
    ...
    submodule_data->defines[dnx_data_fc_coe_define_coe_ptc_left_shift].doc = "Set right shift for COE PTC shift";
