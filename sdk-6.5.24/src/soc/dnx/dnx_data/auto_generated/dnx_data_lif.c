    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_lif_global_lif_define_rif_not_in_glem].name = "rif_not_in_glem";
    submodule_data->defines[dnx_data_lif_global_lif_define_rif_not_in_glem].doc = "One dbal table for glem that is mapped to all 3 phy tables.";
    
    submodule_data->defines[dnx_data_lif_global_lif_define_rif_not_in_glem].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->defines[dnx_data_lif_global_lif_define_mpls_data_table_skip_phase_check].name = "mpls_data_table_skip_phase_check";
    submodule_data->defines[dnx_data_lif_global_lif_define_mpls_data_table_skip_phase_check].doc = "EEDB_MPLS_DATA_TUNNEL table id to skip phase validation";
    
    submodule_data->defines[dnx_data_lif_global_lif_define_mpls_data_table_skip_phase_check].flags |= DNXC_DATA_F_NUMERIC;
...
uint32
dnx_data_lif_global_lif_rif_not_in_glem_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_lif, dnx_data_lif_submodule_global_lif, dnx_data_lif_global_lif_define_rif_not_in_glem);
}
...
uint32
dnx_data_lif_global_lif_mpls_data_table_skip_phase_check_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_lif, dnx_data_lif_submodule_global_lif, dnx_data_lif_global_lif_define_mpls_data_table_skip_phase_check);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_lif_out_lif_out_lif_profile_supported].name = "out_lif_profile_supported";
    submodule_data->features[dnx_data_lif_out_lif_out_lif_profile_supported].doc = "True if in_lif profile is supported";
    submodule_data->features[dnx_data_lif_out_lif_out_lif_profile_supported].flags |= DNXC_DATA_F_FEATURE;
    ...
    submodule_data->defines[dnx_data_lif_out_lif_define_mpls_data_table_skip_phase_check].name = "mpls_data_table_skip_phase_check";
    submodule_data->defines[dnx_data_lif_out_lif_define_mpls_data_table_skip_phase_check].doc = "EEDB_MPLS_DATA_TUNNEL table id to skip phase validation";
    
    submodule_data->defines[dnx_data_lif_out_lif_define_mpls_data_table_skip_phase_check].flags |= DNXC_DATA_F_NUMERIC;
...
uint32
dnx_data_lif_out_lif_mpls_data_table_skip_phase_check_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_lif, dnx_data_lif_submodule_out_lif, dnx_data_lif_out_lif_define_mpls_data_table_skip_phase_check);
}
