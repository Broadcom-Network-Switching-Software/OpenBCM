    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_esb_general_define_nof_eth_tdm_queues].name = "nof_eth_tdm_queues";
    submodule_data->defines[dnx_data_esb_general_define_nof_eth_tdm_queues].doc = "Number of ESB queue IDs dedicated for ETH TDM interleave";
    
    submodule_data->defines[dnx_data_esb_general_define_nof_eth_tdm_queues].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->defines[dnx_data_esb_general_define_ilkn_tdm_queue_id_base].name = "ilkn_tdm_queue_id_base";
    submodule_data->defines[dnx_data_esb_general_define_ilkn_tdm_queue_id_base].doc = "Base for start of ILKN TDM interleave queues.";
    
    submodule_data->defines[dnx_data_esb_general_define_ilkn_tdm_queue_id_base].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_esb_general_define_eth_tdm_queue_id_base].name = "eth_tdm_queue_id_base";
    submodule_data->defines[dnx_data_esb_general_define_eth_tdm_queue_id_base].doc = "Base for start of ETH TDM interleave queues.";
    
    submodule_data->defines[dnx_data_esb_general_define_eth_tdm_queue_id_base].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_esb_general_nof_eth_tdm_queues_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_esb, dnx_data_esb_submodule_general, dnx_data_esb_general_define_nof_eth_tdm_queues);
}
...
uint32
dnx_data_esb_general_ilkn_tdm_queue_id_base_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_esb, dnx_data_esb_submodule_general, dnx_data_esb_general_define_ilkn_tdm_queue_id_base);
}

uint32
dnx_data_esb_general_eth_tdm_queue_id_base_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_esb, dnx_data_esb_submodule_general, dnx_data_esb_general_define_eth_tdm_queue_id_base);
}
