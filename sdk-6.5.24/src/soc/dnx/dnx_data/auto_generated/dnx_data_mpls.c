    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_mpls_general_mpls_module_init_enabled].name = "mpls_module_init_enabled";
    submodule_data->features[dnx_data_mpls_general_mpls_module_init_enabled].doc = "indicates if the current step in mpls_module_init is supported";
    submodule_data->features[dnx_data_mpls_general_mpls_module_init_enabled].flags |= DNXC_DATA_F_FEATURE;
