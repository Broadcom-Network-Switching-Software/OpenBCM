    ...
    int unit)
{
    ...
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_IPMF1, DNX_FIELD_QUAL_ENCODER3);
        data->offset = 3383;
    }
    if (DNX_FIELD_STAGE_IPMF1 < table->keys[0].size && DNX_FIELD_QUAL_ENCODER2 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_IPMF1, DNX_FIELD_QUAL_ENCODER2);
        data->offset = 3375;
    }
    if (DNX_FIELD_STAGE_IPMF1 < table->keys[0].size && DNX_FIELD_QUAL_ENCODER1 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_IPMF1, DNX_FIELD_QUAL_ENCODER1);
        data->offset = 3367;
    }
    if (DNX_FIELD_STAGE_IPMF1 < table->keys[0].size && DNX_FIELD_QUAL_ENCODER0 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_IPMF1, DNX_FIELD_QUAL_ENCODER0);
        data->offset = 3359;
    }
    ...
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_IPMF2, DNX_FIELD_QUAL_STATE_DATA_WRITE);
        data->offset = 938;
    }
    ...
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_IPMF3, DNX_FIELD_QUAL_BTC_MINUS_BTK);
        data->offset = 1840;
    }
    if (DNX_FIELD_STAGE_IPMF3 < table->keys[0].size && DNX_FIELD_QUAL_BTC_OFFSET_SOP < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_IPMF3, DNX_FIELD_QUAL_BTC_OFFSET_SOP);
        data->offset = 1831;
    }
    if (DNX_FIELD_STAGE_IPMF3 < table->keys[0].size && DNX_FIELD_QUAL_BTK_OFFSET_SOP < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_IPMF3, DNX_FIELD_QUAL_BTK_OFFSET_SOP);
        data->offset = 1823;
    }
    if (DNX_FIELD_STAGE_IPMF3 < table->keys[0].size && DNX_FIELD_QUAL_ECL_VALID < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_IPMF3, DNX_FIELD_QUAL_ECL_VALID);
        data->offset = 1822;
    }
    ...
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_DP);
        data->offset = 2591;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_ECN < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_ECN);
        data->offset = 2588;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_EEI < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_EEI);
        data->offset = 2564;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_ELK_LKP_HIT_0 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_ELK_LKP_HIT_0);
        data->offset = 2563;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_ELK_LKP_HIT_1 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_ELK_LKP_HIT_1);
        data->offset = 2562;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_ELK_LKP_HIT_2 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_ELK_LKP_HIT_2);
        data->offset = 2561;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_ELK_LKP_HIT_3 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_ELK_LKP_HIT_3);
        data->offset = 2560;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_ELK_LKP_HIT_4 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_ELK_LKP_HIT_4);
        data->offset = 2559;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_ELK_LKP_HIT_5 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_ELK_LKP_HIT_5);
        data->offset = 2558;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_ELK_LKP_HIT_6 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_ELK_LKP_HIT_6);
        data->offset = 2557;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_ELK_LKP_HIT_7 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_ELK_LKP_HIT_7);
        data->offset = 2556;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_EXTERNAL_RESULT_BUFFER_PART_1 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_EXTERNAL_RESULT_BUFFER_PART_1);
        data->offset = 2468;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_EXTERNAL_RESULT_BUFFER_PART_0 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_EXTERNAL_RESULT_BUFFER_PART_0);
        data->offset = 2308;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_FWD_DOMAIN < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_FWD_DOMAIN);
        data->offset = 2290;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_FWD_LAYER_ADDITIONAL_INFO < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_FWD_LAYER_ADDITIONAL_INFO);
        data->offset = 2286;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_GENERAL_DATA_2 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_GENERAL_DATA_2);
        data->offset = 2158;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_GENERAL_DATA_1 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_GENERAL_DATA_1);
        data->offset = 2030;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_GENERAL_DATA_0 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_GENERAL_DATA_0);
        data->offset = 1902;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_GLOB_IN_LIF_1 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_GLOB_IN_LIF_1);
        data->offset = 1880;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_GLOB_IN_LIF_0 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_GLOB_IN_LIF_0);
        data->offset = 1858;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_NWK_QOS < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_NWK_QOS);
        data->offset = 1850;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_GLOB_OUT_LIF_1 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_GLOB_OUT_LIF_1);
        data->offset = 1828;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_GLOB_OUT_LIF_0 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_GLOB_OUT_LIF_0);
        data->offset = 1806;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_PRT_QUALIFIER < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_PRT_QUALIFIER);
        data->offset = 1803;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_RPF_DST < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_RPF_DST);
        data->offset = 1782;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_RPF_DST_VALID < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_RPF_DST_VALID);
        data->offset = 1781;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_RPF_OUT_LIF < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_RPF_OUT_LIF);
        data->offset = 1759;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_SRC_SYS_PORT < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_SRC_SYS_PORT);
        data->offset = 1743;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_STATISTICS_OBJ_12 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_STATISTICS_OBJ_12);
        data->offset = 1723;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_STATISTICS_OBJ_11 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_STATISTICS_OBJ_11);
        data->offset = 1703;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_STATISTICS_OBJ_10 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_STATISTICS_OBJ_10);
        data->offset = 1683;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_STATISTICS_OBJ_9 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_STATISTICS_OBJ_9);
        data->offset = 1663;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_STATISTICS_OBJ_8 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_STATISTICS_OBJ_8);
        data->offset = 1643;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_STATISTICS_OBJ_7 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_STATISTICS_OBJ_7);
        data->offset = 1623;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_STATISTICS_OBJ_6 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_STATISTICS_OBJ_6);
        data->offset = 1603;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_STATISTICS_OBJ_5 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_STATISTICS_OBJ_5);
        data->offset = 1583;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_STATISTICS_OBJ_4 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_STATISTICS_OBJ_4);
        data->offset = 1563;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_STATISTICS_OBJ_3 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_STATISTICS_OBJ_3);
        data->offset = 1543;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_STATISTICS_OBJ_2 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_STATISTICS_OBJ_2);
        data->offset = 1523;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_STATISTICS_OBJ_1 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_STATISTICS_OBJ_1);
        data->offset = 1503;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_STATISTICS_OBJ_0 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_STATISTICS_OBJ_0);
        data->offset = 1483;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_OAM_STATISTICS_OBJ_2 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_OAM_STATISTICS_OBJ_2);
        data->offset = 1463;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_OAM_STATISTICS_OBJ_1 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_OAM_STATISTICS_OBJ_1);
        data->offset = 1443;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_OAM_STATISTICS_OBJ_0 < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_OAM_STATISTICS_OBJ_0);
        data->offset = 1423;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_TC < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_TC);
        data->offset = 1420;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_CORE_ID < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_CORE_ID);
        data->offset = 1411;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_IN_PORT < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_IN_PORT);
        data->offset = 1411;
    }
    if (DNX_FIELD_STAGE_L4_OPS < table->keys[0].size && DNX_FIELD_QUAL_FWD_LAYER_INDEX < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_L4_OPS, DNX_FIELD_QUAL_FWD_LAYER_INDEX);
        data->offset = 1408;
    }
...
static shr_error_e
j2p_a0_dnx_data_field_qual_special_metadata_qual_set(
    int unit)
{
    int stage_index;
    int qual_index;
    ...
    int unit)
{
    ...
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_field_qual_special_metadata_qual_set;
