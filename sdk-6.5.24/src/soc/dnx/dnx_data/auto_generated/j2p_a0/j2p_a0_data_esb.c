...
static shr_error_e
j2p_a0_dnx_data_esb_general_nof_eth_tdm_queues_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_esb;
...
static shr_error_e
j2p_a0_dnx_data_esb_general_ilkn_tdm_queue_id_base_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_esb;
...
static shr_error_e
j2p_a0_dnx_data_esb_general_eth_tdm_queue_id_base_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_esb;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_esb_general_nof_eth_tdm_queues_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_esb_general_ilkn_tdm_queue_id_base_set;
    data_index = dnx_data_esb_general_define_eth_tdm_queue_id_base;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_esb_general_eth_tdm_queue_id_base_set;
