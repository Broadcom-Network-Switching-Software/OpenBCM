    ...
    int unit)
{
    ...
    if (2 < table->keys[0].size && 1 < table->keys[1].size)
    {
        data = (dnx_data_dnx2_aod_tables_ERPP_FORWARD_CODE_SELECTION_t *) dnxc_data_mgmt_table_data_get(unit, table, 2, 1);
        data->valid = 1;
        data->FAI = 0;
        data->FAI_mask = 15;
        data->FAI_valid = 1;
    ...
    if (3 < table->keys[0].size && 1 < table->keys[1].size)
    {
        data = (dnx_data_dnx2_aod_tables_ERPP_FORWARD_CODE_SELECTION_t *) dnxc_data_mgmt_table_data_get(unit, table, 3, 1);
        data->valid = 1;
        data->FAI = 0;
        data->FAI_mask = 15;
        data->FAI_valid = 1;
    ...
    if (7 < table->keys[0].size && 1 < table->keys[1].size)
    {
        data = (dnx_data_dnx2_aod_tables_ERPP_FORWARD_CODE_SELECTION_t *) dnxc_data_mgmt_table_data_get(unit, table, 7, 1);
        data->valid = 1;
        data->FAI = 0;
        data->FAI_mask = 15;
        data->FAI_valid = 1;
