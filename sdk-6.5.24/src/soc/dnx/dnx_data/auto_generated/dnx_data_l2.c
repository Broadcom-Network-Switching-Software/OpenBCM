    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_l2_general_ivl_feature_support].doc = "IVL is not supported due to VTT1 No PEM resource";
    ...
    submodule_data->features[dnx_data_l2_general_dma_support].doc = "Indicates if DMA is supported";
    ...
    submodule_data->features[dnx_data_l2_general_separate_fwd_learn_mact].doc = "The farwarding MACT and learning MACT are separated";
    ...
    submodule_data->features[dnx_data_l2_general_SLLB_v1_support].doc = "support Elastic-State Load Balancer";
    ...
    submodule_data->features[dnx_data_l2_general_enhanced_learn_key_generation].doc = "support enhancement of learn key generation";
    ...
    submodule_data->defines[dnx_data_l2_general_define_lem_nof_dbs].doc = "The number of lem DBs used";
    ...
    submodule_data->defines[dnx_data_l2_general_define_mact_mngmnt_fid_exceed_limit_int].doc = "mact management fid exceed limit interrupt";
    ...
    submodule_data->defines[dnx_data_l2_general_define_mact_lela_fid_exceed_limit_int].doc = "mact lela fid exceed limit interrupt";
    ...
    submodule_data->defines[dnx_data_l2_general_define_l2_api_supported_flags2].doc = "Supported L2 API flags2.";
    ...
    submodule_data->defines[dnx_data_l2_general_define_l2_traverse_api_supported_flags].doc = "Supported L2 traverse API flags.";
    ...
    submodule_data->defines[dnx_data_l2_general_define_l2_delete_api_supported_flags].doc = "Supported L2 delete API flags.";
    ...
    submodule_data->tables[dnx_data_l2_general_table_mact_result_type_map].doc = "This table maps MACT result types for each table";
    ...
    submodule_data->tables[dnx_data_l2_general_table_mact_result_type_map].nof_values = 6;
    ...
    submodule_data->tables[dnx_data_l2_general_table_mact_result_type_map].values[2].name = "double_outlif";
    ...
    submodule_data->tables[dnx_data_l2_general_table_mact_result_type_map].values[2].offset = UTILEX_OFFSETOF(dnx_data_l2_general_mact_result_type_map_t, double_outlif);
    submodule_data->tables[dnx_data_l2_general_table_mact_result_type_map].values[3].name = "eei";
    ...
    submodule_data->tables[dnx_data_l2_general_table_mact_result_type_map].values[3].offset = UTILEX_OFFSETOF(dnx_data_l2_general_mact_result_type_map_t, eei);
    submodule_data->tables[dnx_data_l2_general_table_mact_result_type_map].values[4].name = "no_outlif";
    ...
    submodule_data->tables[dnx_data_l2_general_table_mact_result_type_map].values[4].offset = UTILEX_OFFSETOF(dnx_data_l2_general_mact_result_type_map_t, no_outlif);
    submodule_data->tables[dnx_data_l2_general_table_mact_result_type_map].values[5].name = "single_outlif";
    submodule_data->tables[dnx_data_l2_general_table_mact_result_type_map].values[5].type = "uint32";
    submodule_data->tables[dnx_data_l2_general_table_mact_result_type_map].values[5].doc = "";
    submodule_data->tables[dnx_data_l2_general_table_mact_result_type_map].values[5].offset = UTILEX_OFFSETOF(dnx_data_l2_general_mact_result_type_map_t, single_outlif);

    
    submodule_data->tables[dnx_data_l2_general_table_scan_data_bases_info].name = "scan_data_bases_info";
    submodule_data->tables[dnx_data_l2_general_table_scan_data_bases_info].doc = "Age scan, and scan cycles lem data bases";
    ...
    submodule_data->tables[dnx_data_l2_general_table_scan_data_bases_info].values[0].doc = "age scan data bases";
    ...
    submodule_data->tables[dnx_data_l2_general_table_scan_data_bases_info].values[1].doc = "scan cycles data bases";
    ...
    submodule_data->tables[dnx_data_l2_general_table_fwd_mact_info].doc = "fwd mact info";
    ...
    submodule_data->tables[dnx_data_l2_general_table_fwd_mact_info].nof_keys = 1;
    submodule_data->tables[dnx_data_l2_general_table_fwd_mact_info].keys[0].name = "data_base_id";
    submodule_data->tables[dnx_data_l2_general_table_fwd_mact_info].keys[0].doc = "";

    
    submodule_data->tables[dnx_data_l2_general_table_fwd_mact_info].nof_values = 1;
    ...
    submodule_data->tables[dnx_data_l2_general_table_fwd_mact_info].values[0].name = "data_base";
    submodule_data->tables[dnx_data_l2_general_table_fwd_mact_info].values[0].type = "dbal_tables_e";
    submodule_data->tables[dnx_data_l2_general_table_fwd_mact_info].values[0].doc = "Holds the dbal physical table id";
    submodule_data->tables[dnx_data_l2_general_table_fwd_mact_info].values[0].offset = UTILEX_OFFSETOF(dnx_data_l2_general_fwd_mact_info_t, data_base);
    ...
    int data_base_id)
{
    ...
    data = dnxc_data_mgmt_table_data_get(unit, table, data_base_id, 0);
    ...
    int value_index)
{
    ...
    switch (value_index)
    {
        ...
        case 1:
            ...
            break;
        case 2:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->double_outlif);
            break;
        case 3:
    ...
    int value_index)
{
    ...
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_l2, dnx_data_l2_submodule_general, dnx_data_l2_general_table_fwd_mact_info);
    data = (const dnx_data_l2_general_fwd_mact_info_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->data_base);
            break;
    }
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_l2_vsi_define_vsi_table].doc = "The ID of the VSI DBAL table.";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_l2_dma_define_l2_dma_cpu_learn_thread_priority].doc = "cpu learning thread priority";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_l2_age_and_flush_machine_define_flush_buffer_nof_entries].doc = "Size of flush buffer in number of entries.";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_l2_olp_define_olp_learning_block_id].doc = "The block ID of the learning OLP block";
