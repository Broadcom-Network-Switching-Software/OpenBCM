    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_adapter_general_define_nof_sub_units].name = "nof_sub_units";
    submodule_data->defines[dnx_data_adapter_general_define_nof_sub_units].doc = "Number of sub units in the adapter device.";
    
    submodule_data->defines[dnx_data_adapter_general_define_nof_sub_units].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_adapter_general_nof_sub_units_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_adapter, dnx_data_adapter_submodule_general, dnx_data_adapter_general_define_nof_sub_units);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_swap_core_ignore_map].doc = "ignore swap core feature, for blocks in this map";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_adapter_mdb_table_lookup_caller_id_mapping].keys[1].name = "stage";
    submodule_data->tables[dnx_data_adapter_mdb_table_lookup_caller_id_mapping].keys[1].doc = "";

    
    submodule_data->tables[dnx_data_adapter_mdb_table_lookup_caller_id_mapping].nof_values = 2;
    ...
    submodule_data->tables[dnx_data_adapter_mdb_table_lookup_caller_id_mapping].values[0].name = "mdb";
    ...
    submodule_data->tables[dnx_data_adapter_mdb_table_lookup_caller_id_mapping].values[0].offset = UTILEX_OFFSETOF(dnx_data_adapter_mdb_lookup_caller_id_mapping_t, mdb);
    submodule_data->tables[dnx_data_adapter_mdb_table_lookup_caller_id_mapping].values[1].name = "interface";
    submodule_data->tables[dnx_data_adapter_mdb_table_lookup_caller_id_mapping].values[1].type = "char *";
    submodule_data->tables[dnx_data_adapter_mdb_table_lookup_caller_id_mapping].values[1].doc = "";
    submodule_data->tables[dnx_data_adapter_mdb_table_lookup_caller_id_mapping].values[1].offset = UTILEX_OFFSETOF(dnx_data_adapter_mdb_lookup_caller_id_mapping_t, interface);
    ...
    int stage)
{
    ...
    data = dnxc_data_mgmt_table_data_get(unit, table, caller_id, stage);
