    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->doc = "standard submodule used to test family exclusive feature";
    ...
    submodule_data->features[dnx_data_module_testing_standard_submodule_standard_feature].doc = "standard feature to test family exclusive feature";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->features[dnx_data_module_testing_standard_submodule_feature_family_dnx2].doc = "feature configured as family exclusive for DNX2 family to test family exclusive feature";
    ...
    submodule_data->defines[dnx_data_module_testing_standard_submodule_define_standard_define].doc = "standard define to test family exclusive feature";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_module_testing_standard_submodule_define_define_family_dnx2].doc = "test of family exclusive feature for define";
    ...
    submodule_data->defines[dnx_data_module_testing_standard_submodule_define_standard_numeric].doc = "standard numeric to test family exclusive feature";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_module_testing_standard_submodule_define_num_family_dnx2].doc = "numeric configured as family exclusive for DNX2 family to test family exclusive feature";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_module_testing_standard_submodule_define_num_property_family_dnx2].doc = "test of family exclusive feature for numeric assigned with SOC property";
    ...
    submodule_data->tables[dnx_data_module_testing_standard_submodule_table_standard_table].doc = "standard feature to test family exclusive feature";
    ...
    submodule_data->tables[dnx_data_module_testing_standard_submodule_table_standard_table].keys[0].doc = "table key";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->tables[dnx_data_module_testing_standard_submodule_table_table_family_dnx2].doc = "table configured as family exclusive for DNX2 family to test family exclusive feature";
        ...
        submodule_data->tables[dnx_data_module_testing_standard_submodule_table_table_family_dnx2].keys[0].doc = "table key";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->doc = "Values for example tests";
    ...
    submodule_data->defines[dnx_data_module_testing_example_tests_define_field_size].doc = "field size test";
    ...
    submodule_data->defines[dnx_data_module_testing_example_tests_define_large_nof_elements].doc = "large number of elements in the test";
    ...
    submodule_data->tables[dnx_data_module_testing_example_tests_table_all].doc = "test all supported types";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->doc = "submodule configured as family exclusive for DNX2 family to test family exclusive feature";
    ...
    submodule_data->features[dnx_data_module_testing_submodule_family_dnx2_dnx2_submodule_feature].doc = "standard feature in submodule that is configured as family exclusive of DNX2";
    ...
    submodule_data->defines[dnx_data_module_testing_submodule_family_dnx2_define_dnx2_submodule_define].doc = "standard define in submodule that is configured as family exclusive of DNX2";
    ...
    submodule_data->defines[dnx_data_module_testing_submodule_family_dnx2_define_dnx2_submodule_numeric].doc = "standard numeric in submodule that is configured as family exclusive of DNX2";
    ...
    submodule_data->tables[dnx_data_module_testing_submodule_family_dnx2_table_dnx2_submodule_table].doc = "standard table in submodule that is configured as family exclusive of DNX2";
    ...
    submodule_data->tables[dnx_data_module_testing_submodule_family_dnx2_table_dnx2_submodule_table].keys[0].doc = "table_key";
...
static shr_error_e
dnx_data_module_testing_compileflags_submodule_standard_init(
    int unit,
    dnxc_data_submodule_t *submodule_data)
{
    SHR_FUNC_INIT_VARS(unit);

    submodule_data->name = "compileflags_submodule_standard";
    submodule_data->doc = "submodule used to test compile flags feature";
    
    submodule_data->nof_features = _dnx_data_module_testing_compileflags_submodule_standard_feature_nof;
    DNXC_DATA_ALLOC(submodule_data->features, dnxc_data_feature_t,  submodule_data->nof_features, "_dnxc_data module_testing compileflags_submodule_standard features");

#ifdef INCLUDE_XFLOW_MACSEC

    submodule_data->features[dnx_data_module_testing_compileflags_submodule_standard_feature_flags].name = "feature_flags";
    submodule_data->features[dnx_data_module_testing_compileflags_submodule_standard_feature_flags].doc = "feature configured with no family and with a compile flag";
    submodule_data->features[dnx_data_module_testing_compileflags_submodule_standard_feature_flags].flags |= DNXC_DATA_F_FEATURE;

#endif 

    
    submodule_data->nof_defines = _dnx_data_module_testing_compileflags_submodule_standard_define_nof;
    DNXC_DATA_ALLOC(submodule_data->defines, dnxc_data_define_t, submodule_data->nof_defines, "_dnxc_data module_testing compileflags_submodule_standard defines");

#ifdef INCLUDE_XFLOW_MACSEC

    submodule_data->defines[dnx_data_module_testing_compileflags_submodule_standard_define_define_flags].name = "define_flags";
    submodule_data->defines[dnx_data_module_testing_compileflags_submodule_standard_define_define_flags].doc = "define configured with no family and with a compile flag";
    
    submodule_data->defines[dnx_data_module_testing_compileflags_submodule_standard_define_define_flags].flags |= DNXC_DATA_F_DEFINE;

#endif 

#ifdef INCLUDE_XFLOW_MACSEC

    submodule_data->defines[dnx_data_module_testing_compileflags_submodule_standard_define_numeric_flags].name = "numeric_flags";
    submodule_data->defines[dnx_data_module_testing_compileflags_submodule_standard_define_numeric_flags].doc = "numeric configured with no family and with a compile flag";
    
    submodule_data->defines[dnx_data_module_testing_compileflags_submodule_standard_define_numeric_flags].flags |= DNXC_DATA_F_NUMERIC;

#endif 

    
    submodule_data->nof_tables = _dnx_data_module_testing_compileflags_submodule_standard_table_nof;
    DNXC_DATA_ALLOC(submodule_data->tables, dnxc_data_table_t, submodule_data->nof_tables, "_dnxc_data module_testing compileflags_submodule_standard tables");

#ifdef INCLUDE_XFLOW_MACSEC

    
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_standard_table_table_flags].name = "table_flags";
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_standard_table_table_flags].doc = "table configured with a compile flag of macsec";
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_standard_table_table_flags].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_standard_table_table_flags].size_of_values = sizeof(dnx_data_module_testing_compileflags_submodule_standard_table_flags_t);
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_standard_table_table_flags].entry_get = dnx_data_module_testing_compileflags_submodule_standard_table_flags_entry_str_get;

    
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_standard_table_table_flags].nof_keys = 1;
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_standard_table_table_flags].keys[0].name = "table_flags_key";
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_standard_table_table_flags].keys[0].doc = "table_key";

    
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_standard_table_table_flags].nof_values = 1;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_module_testing_compileflags_submodule_standard_table_table_flags].values, dnxc_data_value_t, submodule_data->tables[dnx_data_module_testing_compileflags_submodule_standard_table_table_flags].nof_values, "_dnx_data_module_testing_compileflags_submodule_standard_table_table_flags table values");
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_standard_table_table_flags].values[0].name = "table_flags_value";
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_standard_table_table_flags].values[0].type = "uint32";
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_standard_table_table_flags].values[0].doc = "table_value";
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_standard_table_table_flags].values[0].offset = UTILEX_OFFSETOF(dnx_data_module_testing_compileflags_submodule_standard_table_flags_t, table_flags_value);
...
int
dnx_data_module_testing_compileflags_submodule_standard_feature_get(
    int unit,
    dnx_data_module_testing_compileflags_submodule_standard_feature_e feature)
{
    return dnxc_data_mgmt_feature_data_get(unit, dnx_data_module_module_testing, dnx_data_module_testing_submodule_compileflags_submodule_standard, feature);
}
...
uint32
dnx_data_module_testing_compileflags_submodule_standard_define_flags_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_module_testing, dnx_data_module_testing_submodule_compileflags_submodule_standard, dnx_data_module_testing_compileflags_submodule_standard_define_define_flags);
}
...
uint32
dnx_data_module_testing_compileflags_submodule_standard_numeric_flags_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_module_testing, dnx_data_module_testing_submodule_compileflags_submodule_standard, dnx_data_module_testing_compileflags_submodule_standard_define_numeric_flags);
}
...
const dnx_data_module_testing_compileflags_submodule_standard_table_flags_t *
dnx_data_module_testing_compileflags_submodule_standard_table_flags_get(
    int unit,
    int table_flags_key)
{
    char *data;
    ...
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_module_testing, dnx_data_module_testing_submodule_compileflags_submodule_standard, dnx_data_module_testing_compileflags_submodule_standard_table_table_flags);
    
    data = dnxc_data_mgmt_table_data_get(unit, table, table_flags_key, 0);
    return (const dnx_data_module_testing_compileflags_submodule_standard_table_flags_t *) data;
...
shr_error_e
dnx_data_module_testing_compileflags_submodule_standard_table_flags_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_module_testing_compileflags_submodule_standard_table_flags_t *data;
    SHR_FUNC_INIT_VARS(unit);

    
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_module_testing, dnx_data_module_testing_submodule_compileflags_submodule_standard, dnx_data_module_testing_compileflags_submodule_standard_table_table_flags);
    data = (const dnx_data_module_testing_compileflags_submodule_standard_table_flags_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
...
const dnxc_data_table_info_t *
dnx_data_module_testing_compileflags_submodule_standard_table_flags_info_get(
    int unit)
{

    
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_module_testing, dnx_data_module_testing_submodule_compileflags_submodule_standard, dnx_data_module_testing_compileflags_submodule_standard_table_table_flags);
...
static shr_error_e
dnx_data_module_testing_compileflags_submodule_flags_init(
    int unit,
    dnxc_data_submodule_t *submodule_data)
{
    SHR_FUNC_INIT_VARS(unit);

    submodule_data->name = "compileflags_submodule_flags";
    submodule_data->doc = "submodule configured with compile flags used to test compile flags feature";
    
    submodule_data->nof_features = _dnx_data_module_testing_compileflags_submodule_flags_feature_nof;
    DNXC_DATA_ALLOC(submodule_data->features, dnxc_data_feature_t,  submodule_data->nof_features, "_dnxc_data module_testing compileflags_submodule_flags features");

    submodule_data->features[dnx_data_module_testing_compileflags_submodule_flags_feature_no_flags].name = "feature_no_flags";
    submodule_data->features[dnx_data_module_testing_compileflags_submodule_flags_feature_no_flags].doc = "standard feature in submodule that is configured with compile flag of macsec";
    submodule_data->features[dnx_data_module_testing_compileflags_submodule_flags_feature_no_flags].flags |= DNXC_DATA_F_FEATURE;

#ifdef BCM_WARM_BOOT_SUPPORT

    submodule_data->features[dnx_data_module_testing_compileflags_submodule_flags_feature_flags].name = "feature_flags";
    submodule_data->features[dnx_data_module_testing_compileflags_submodule_flags_feature_flags].doc = "feature configured with compile flag of warmboot in submodule configured with a compile flag of macsec";
    submodule_data->features[dnx_data_module_testing_compileflags_submodule_flags_feature_flags].flags |= DNXC_DATA_F_FEATURE;

#endif 

    
    submodule_data->nof_defines = _dnx_data_module_testing_compileflags_submodule_flags_define_nof;
    DNXC_DATA_ALLOC(submodule_data->defines, dnxc_data_define_t, submodule_data->nof_defines, "_dnxc_data module_testing compileflags_submodule_flags defines");

    submodule_data->defines[dnx_data_module_testing_compileflags_submodule_flags_define_define_no_flags].name = "define_no_flags";
    submodule_data->defines[dnx_data_module_testing_compileflags_submodule_flags_define_define_no_flags].doc = "standard define in submodule that is configured with compile flag of macsec";
    
    submodule_data->defines[dnx_data_module_testing_compileflags_submodule_flags_define_define_no_flags].flags |= DNXC_DATA_F_DEFINE;

#ifdef BCM_WARM_BOOT_SUPPORT

    submodule_data->defines[dnx_data_module_testing_compileflags_submodule_flags_define_define_flags].name = "define_flags";
    submodule_data->defines[dnx_data_module_testing_compileflags_submodule_flags_define_define_flags].doc = "define configured with compile flag of warmboot in submodule configured with a compile flag of macsec";
    
    submodule_data->defines[dnx_data_module_testing_compileflags_submodule_flags_define_define_flags].flags |= DNXC_DATA_F_DEFINE;

#endif 

    submodule_data->defines[dnx_data_module_testing_compileflags_submodule_flags_define_numeric_no_flags].name = "numeric_no_flags";
    submodule_data->defines[dnx_data_module_testing_compileflags_submodule_flags_define_numeric_no_flags].doc = "standard numeric in submodule that is configured with compile flag of macsec";
    
    submodule_data->defines[dnx_data_module_testing_compileflags_submodule_flags_define_numeric_no_flags].flags |= DNXC_DATA_F_NUMERIC;

#ifdef BCM_WARM_BOOT_SUPPORT

    submodule_data->defines[dnx_data_module_testing_compileflags_submodule_flags_define_numeric_flags].name = "numeric_flags";
    submodule_data->defines[dnx_data_module_testing_compileflags_submodule_flags_define_numeric_flags].doc = "numeric configured with compile flag of warmboot in submodule configured with a compile flag of macsec";
    
    submodule_data->defines[dnx_data_module_testing_compileflags_submodule_flags_define_numeric_flags].flags |= DNXC_DATA_F_NUMERIC;

#endif 

    
    submodule_data->nof_tables = _dnx_data_module_testing_compileflags_submodule_flags_table_nof;
    DNXC_DATA_ALLOC(submodule_data->tables, dnxc_data_table_t, submodule_data->nof_tables, "_dnxc_data module_testing compileflags_submodule_flags tables");

    
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_flags_table_table_no_flags].name = "table_no_flags";
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_flags_table_table_no_flags].doc = "standard table in submodule that is configured with compile flag of macsec";
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_flags_table_table_no_flags].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_flags_table_table_no_flags].size_of_values = sizeof(dnx_data_module_testing_compileflags_submodule_flags_table_no_flags_t);
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_flags_table_table_no_flags].entry_get = dnx_data_module_testing_compileflags_submodule_flags_table_no_flags_entry_str_get;

    
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_flags_table_table_no_flags].nof_keys = 1;
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_flags_table_table_no_flags].keys[0].name = "table_no_flags_key";
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_flags_table_table_no_flags].keys[0].doc = "table_key";

    
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_flags_table_table_no_flags].nof_values = 1;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_module_testing_compileflags_submodule_flags_table_table_no_flags].values, dnxc_data_value_t, submodule_data->tables[dnx_data_module_testing_compileflags_submodule_flags_table_table_no_flags].nof_values, "_dnx_data_module_testing_compileflags_submodule_flags_table_table_no_flags table values");
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_flags_table_table_no_flags].values[0].name = "table_no_flags_value";
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_flags_table_table_no_flags].values[0].type = "uint32";
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_flags_table_table_no_flags].values[0].doc = "table_value";
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_flags_table_table_no_flags].values[0].offset = UTILEX_OFFSETOF(dnx_data_module_testing_compileflags_submodule_flags_table_no_flags_t, table_no_flags_value);

#ifdef BCM_WARM_BOOT_SUPPORT

    
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_flags_table_table_flags].name = "table_flags";
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_flags_table_table_flags].doc = "table configured with compile flag of warmboot in submodule configured with a compile flag of macsec";
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_flags_table_table_flags].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_flags_table_table_flags].size_of_values = sizeof(dnx_data_module_testing_compileflags_submodule_flags_table_flags_t);
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_flags_table_table_flags].entry_get = dnx_data_module_testing_compileflags_submodule_flags_table_flags_entry_str_get;

    
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_flags_table_table_flags].nof_keys = 1;
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_flags_table_table_flags].keys[0].name = "table_flag_key";
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_flags_table_table_flags].keys[0].doc = "table_key";

    
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_flags_table_table_flags].nof_values = 1;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_module_testing_compileflags_submodule_flags_table_table_flags].values, dnxc_data_value_t, submodule_data->tables[dnx_data_module_testing_compileflags_submodule_flags_table_table_flags].nof_values, "_dnx_data_module_testing_compileflags_submodule_flags_table_table_flags table values");
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_flags_table_table_flags].values[0].name = "table_flag_value";
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_flags_table_table_flags].values[0].type = "uint32";
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_flags_table_table_flags].values[0].doc = "table_value";
    submodule_data->tables[dnx_data_module_testing_compileflags_submodule_flags_table_table_flags].values[0].offset = UTILEX_OFFSETOF(dnx_data_module_testing_compileflags_submodule_flags_table_flags_t, table_flag_value);
...
int
dnx_data_module_testing_compileflags_submodule_flags_feature_get(
    int unit,
    dnx_data_module_testing_compileflags_submodule_flags_feature_e feature)
{
    return dnxc_data_mgmt_feature_data_get(unit, dnx_data_module_module_testing, dnx_data_module_testing_submodule_compileflags_submodule_flags, feature);
}


uint32
dnx_data_module_testing_compileflags_submodule_flags_define_no_flags_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_module_testing, dnx_data_module_testing_submodule_compileflags_submodule_flags, dnx_data_module_testing_compileflags_submodule_flags_define_define_no_flags);
}

#ifdef BCM_WARM_BOOT_SUPPORT

uint32
dnx_data_module_testing_compileflags_submodule_flags_define_flags_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_module_testing, dnx_data_module_testing_submodule_compileflags_submodule_flags, dnx_data_module_testing_compileflags_submodule_flags_define_define_flags);
}


#endif 
uint32
dnx_data_module_testing_compileflags_submodule_flags_numeric_no_flags_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_module_testing, dnx_data_module_testing_submodule_compileflags_submodule_flags, dnx_data_module_testing_compileflags_submodule_flags_define_numeric_no_flags);
}

#ifdef BCM_WARM_BOOT_SUPPORT

uint32
dnx_data_module_testing_compileflags_submodule_flags_numeric_flags_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_module_testing, dnx_data_module_testing_submodule_compileflags_submodule_flags, dnx_data_module_testing_compileflags_submodule_flags_define_numeric_flags);
}
...
const dnx_data_module_testing_compileflags_submodule_flags_table_no_flags_t *
dnx_data_module_testing_compileflags_submodule_flags_table_no_flags_get(
    int unit,
    int table_no_flags_key)
{
    ...
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_module_testing, dnx_data_module_testing_submodule_compileflags_submodule_flags, dnx_data_module_testing_compileflags_submodule_flags_table_table_no_flags);
    
    data = dnxc_data_mgmt_table_data_get(unit, table, table_no_flags_key, 0);
    return (const dnx_data_module_testing_compileflags_submodule_flags_table_no_flags_t *) data;

}

#ifdef BCM_WARM_BOOT_SUPPORT

const dnx_data_module_testing_compileflags_submodule_flags_table_flags_t *
dnx_data_module_testing_compileflags_submodule_flags_table_flags_get(
    int unit,
    int table_flag_key)
{
    char *data;
    ...
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_module_testing, dnx_data_module_testing_submodule_compileflags_submodule_flags, dnx_data_module_testing_compileflags_submodule_flags_table_table_flags);
    
    data = dnxc_data_mgmt_table_data_get(unit, table, table_flag_key, 0);
    return (const dnx_data_module_testing_compileflags_submodule_flags_table_flags_t *) data;
...
shr_error_e
dnx_data_module_testing_compileflags_submodule_flags_table_no_flags_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_module_testing_compileflags_submodule_flags_table_no_flags_t *data;
    SHR_FUNC_INIT_VARS(unit);

    
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_module_testing, dnx_data_module_testing_submodule_compileflags_submodule_flags, dnx_data_module_testing_compileflags_submodule_flags_table_table_no_flags);
    data = (const dnx_data_module_testing_compileflags_submodule_flags_table_no_flags_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
...
shr_error_e
dnx_data_module_testing_compileflags_submodule_flags_table_flags_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_module_testing_compileflags_submodule_flags_table_flags_t *data;
    SHR_FUNC_INIT_VARS(unit);

    
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_module_testing, dnx_data_module_testing_submodule_compileflags_submodule_flags, dnx_data_module_testing_compileflags_submodule_flags_table_table_flags);
    data = (const dnx_data_module_testing_compileflags_submodule_flags_table_flags_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
...
const dnxc_data_table_info_t *
dnx_data_module_testing_compileflags_submodule_flags_table_no_flags_info_get(
    int unit)
{

    
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_module_testing, dnx_data_module_testing_submodule_compileflags_submodule_flags, dnx_data_module_testing_compileflags_submodule_flags_table_table_no_flags);
...
const dnxc_data_table_info_t *
dnx_data_module_testing_compileflags_submodule_flags_table_flags_info_get(
    int unit)
{

    
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_module_testing, dnx_data_module_testing_submodule_compileflags_submodule_flags, dnx_data_module_testing_compileflags_submodule_flags_table_table_flags);
...
#endif 
    SHR_IF_ERR_EXIT(dnx_data_module_testing_compileflags_submodule_standard_init(unit, &module_data->submodules[dnx_data_module_testing_submodule_compileflags_submodule_standard]));
#ifdef INCLUDE_XFLOW_MACSEC

    SHR_IF_ERR_EXIT(dnx_data_module_testing_compileflags_submodule_flags_init(unit, &module_data->submodules[dnx_data_module_testing_submodule_compileflags_submodule_flags]));
