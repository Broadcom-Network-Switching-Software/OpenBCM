    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_switch_load_balancing_fwd_hashing_method].doc = "LB forwarding hashing method";
    ...
    submodule_data->features[dnx_data_switch_load_balancing_layer_record_mode_selection].doc = "Indicate whether layer record mode selection is enabled";
    ...
    submodule_data->features[dnx_data_switch_load_balancing_seed_config_per_pp_port].doc = "Indicates whether seed configuration per pp port is enabled";
    ...
    submodule_data->defines[dnx_data_switch_load_balancing_define_nof_bits_mpls_protocol_identifier].doc = "The NOF MPLS bits to using describe MPLS protocol identifier";
    ...
    submodule_data->defines[dnx_data_switch_load_balancing_define_seed_configuration_per_pp_port].doc = "Indicate whether configuration of LB seed per pp port is enabled";
    
    submodule_data->defines[dnx_data_switch_load_balancing_define_seed_configuration_per_pp_port].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_switch_load_balancing_define_field_enablers_per_header_valid].name = "field_enablers_per_header_valid";
    submodule_data->defines[dnx_data_switch_load_balancing_define_field_enablers_per_header_valid].doc = "Indicate whether load balancing field enablers per header is valid";
    
    submodule_data->defines[dnx_data_switch_load_balancing_define_field_enablers_per_header_valid].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_switch_load_balancing_field_enablers_per_header_valid_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_switch, dnx_data_switch_submodule_load_balancing, dnx_data_switch_load_balancing_define_field_enablers_per_header_valid);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_switch_svtag_define_svtag_init_valid].name = "svtag_init_valid";
    submodule_data->defines[dnx_data_switch_svtag_define_svtag_init_valid].doc = "Indicate whether svtag init function is valid";
    
    submodule_data->defines[dnx_data_switch_svtag_define_svtag_init_valid].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_switch_svtag_svtag_init_valid_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_switch, dnx_data_switch_submodule_svtag, dnx_data_switch_svtag_define_svtag_init_valid);
}
