    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_egr_queuing_params_fqp_enhanced_attribuites].name = "fqp_enhanced_attribuites";
    submodule_data->features[dnx_data_egr_queuing_params_fqp_enhanced_attribuites].doc = "fqp TXQ_MAX_BYTES_TH MIN_GAP ALLOW_CONS_SEL existance";
    submodule_data->features[dnx_data_egr_queuing_params_fqp_enhanced_attribuites].flags |= DNXC_DATA_F_FEATURE;
