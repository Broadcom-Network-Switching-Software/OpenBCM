...
static shr_error_e
q2a_a0_dnx_data_pll_general_ts_freq_lock_set(
    int unit)
{
...
static shr_error_e
q2a_a0_dnx_data_pll_general_ts_phase_initial_hi_config_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_pll;
...
static shr_error_e
q2a_a0_dnx_data_pll_general_ts_phase_initial_lo_set(
    int unit)
{
...
static shr_error_e
q2a_a0_dnx_data_pll_general_ts_phase_initial_hi_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_pll;
...
static shr_error_e
q2a_a0_dnx_data_pll_general_ts_nof_bits_hi_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_pll;
...
static shr_error_e
q2a_a0_dnx_data_pll_general_nif_pll_set(
    int unit)
{
    int pll_index_index;
...
static shr_error_e
q2a_a0_dnx_data_pll_general_fabric_pll_set(
    int unit)
{
    int pll_index_index;
...
static shr_error_e
q2a_a0_dnx_data_pll_pll1_nof_pll1_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_pll;
...
static shr_error_e
q2a_a0_dnx_data_pll_pll1_ts_pll1_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_pll;
...
static shr_error_e
q2a_a0_dnx_data_pll_pll1_bs_pll1_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_pll;
...
static shr_error_e
q2a_a0_dnx_data_pll_pll1_nif_pll1_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_pll;
    int submodule_index = dnx_data_pll_submodule_pll1;
    int define_index = dnx_data_pll_pll1_define_nif_pll1_id;
    SHR_FUNC_INIT_VARS(unit);

    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    
    define->default_data = dnx_data_pll.pll1.config_get(unit, DNX_PLL1_TYPE_NIF)->pll1_id;

    
    define->data = dnx_data_pll.pll1.config_get(unit, DNX_PLL1_TYPE_NIF)->pll1_id;
...
static shr_error_e
q2a_a0_dnx_data_pll_pll1_flexe_pll1_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_pll;
    int submodule_index = dnx_data_pll_submodule_pll1;
    int define_index = dnx_data_pll_pll1_define_flexe_pll1_id;
    SHR_FUNC_INIT_VARS(unit);

    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    
    define->default_data = dnx_data_pll.pll1.config_get(unit, DNX_PLL1_TYPE_FLEXE)->pll1_id;

    
    define->data = dnx_data_pll.pll1.config_get(unit, DNX_PLL1_TYPE_FLEXE)->pll1_id;
...
static shr_error_e
q2a_a0_dnx_data_pll_pll1_config_set(
    int unit)
{
    int pll1_type_index;
    ...
    if (DNX_PLL1_TYPE_NIF < table->keys[0].size)
    {
        data = (dnx_data_pll_pll1_config_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_PLL1_TYPE_NIF, 0);
        data->pll1_id = 2;
        data->valid = 1;
        data->pdiv = 4;
        data->ndiv_int = 130;
    ...
    if (DNX_PLL1_TYPE_FLEXE < table->keys[0].size)
    {
        data = (dnx_data_pll_pll1_config_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_PLL1_TYPE_FLEXE, 0);
        data->pll1_id = 3;
        data->valid = (dnx_data_nif.flexe.flexe_mode_get(unit) == DNX_FLEXE_MODE_DISTRIBUTED) ? 1 : DNX_PLL1_TYPE_INVALID;
        data->pdiv = 5;
        data->ndiv_int = 120;
        data->ch0_mdiv = 12;
        data->ch2_mdiv = 27;
...
static shr_error_e
q2a_a0_dnx_data_pll_pll3_nof_pll3_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_pll;
...
static shr_error_e
q2a_a0_dnx_data_pll_pll4_nof_pll4_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_pll;
...
static shr_error_e
q2a_a0_dnx_data_pll_synce_pll_present_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_pll;
    ...
    int unit)
{
    ...
    define->set = q2a_a0_dnx_data_pll_general_ts_phase_initial_lo_set;
    data_index = dnx_data_pll_general_define_ts_phase_initial_hi;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_pll_general_ts_phase_initial_hi_set;
    data_index = dnx_data_pll_general_define_ts_nof_bits_hi;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_pll_general_ts_nof_bits_hi_set;

    
    data_index = dnx_data_pll_general_ts_freq_lock;
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_pll_general_ts_freq_lock_set;
    data_index = dnx_data_pll_general_ts_phase_initial_hi_config;
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_pll_general_ts_phase_initial_hi_config_set;

    
    data_index = dnx_data_pll_general_table_nif_pll;
    table = &submodule->tables[data_index];
    table->set = q2a_a0_dnx_data_pll_general_nif_pll_set;
    data_index = dnx_data_pll_general_table_fabric_pll;
    table = &submodule->tables[data_index];
    table->set = q2a_a0_dnx_data_pll_general_fabric_pll_set;
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_pll_pll1_nof_pll1_set;
    data_index = dnx_data_pll_pll1_define_ts_pll1_id;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_pll_pll1_ts_pll1_id_set;
    data_index = dnx_data_pll_pll1_define_bs_pll1_id;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_pll_pll1_bs_pll1_id_set;
    data_index = dnx_data_pll_pll1_define_nif_pll1_id;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_pll_pll1_nif_pll1_id_set;
    data_index = dnx_data_pll_pll1_define_flexe_pll1_id;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_pll_pll1_flexe_pll1_id_set;
    ...
    table = &submodule->tables[data_index];
    table->set = q2a_a0_dnx_data_pll_pll1_config_set;
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_pll_pll3_nof_pll3_set;
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_pll_pll4_nof_pll4_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_pll_synce_pll_present_set;
