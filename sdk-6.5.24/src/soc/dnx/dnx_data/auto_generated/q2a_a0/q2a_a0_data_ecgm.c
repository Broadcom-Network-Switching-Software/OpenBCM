...
static shr_error_e
q2a_a0_dnx_data_ecgm_core_resources_reserved_dbs_per_sp_nof_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ecgm;
...
static shr_error_e
q2a_a0_dnx_data_ecgm_info_fc_egr_if_vector_select_set(
    int unit)
{
...
static shr_error_e
q2a_a0_dnx_data_ecgm_info_fc_egr_if_vector_select_nof_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ecgm;
...
static shr_error_e
q2a_a0_dnx_data_ecgm_info_fc_egr_if_vector_nof_presented_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ecgm;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_ecgm_core_resources_reserved_dbs_per_sp_nof_bits_set;
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_ecgm_info_fc_egr_if_vector_select_nof_bits_set;
    data_index = dnx_data_ecgm_info_define_fc_egr_if_vector_nof_presented;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_ecgm_info_fc_egr_if_vector_nof_presented_set;
    ...
    feature->set = q2a_a0_dnx_data_ecgm_info_fc_egr_if_vector_select_set;
