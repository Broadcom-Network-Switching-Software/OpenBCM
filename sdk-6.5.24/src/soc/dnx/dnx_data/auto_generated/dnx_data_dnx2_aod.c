    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_FER_FILTERS_PER_FWD_CONTEXT___image].doc = "table related image";
    ...
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_FER_FILTERS_PER_FWD_CONTEXT].doc = "FER_FILTERS_PER_FWD_CONTEXT";
    ...
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_FER_FILTERS_PER_FWD_CONTEXT].keys[0].doc = "entry index";
    ...
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_MPLS_SPECIAL_LABEL_PROFILE_MAP___image].doc = "table related image";
    ...
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_MPLS_SPECIAL_LABEL_PROFILE_MAP].doc = "MPLS_SPECIAL_LABEL_PROFILE_MAP";
    ...
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_MPLS_SPECIAL_LABEL_PROFILE_MAP].keys[0].doc = "entry index";
