...
dbal_logical_table_t * table_info)
{
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        access_params->access_type = DBAL_HL_ACCESS_MEMORY;
        {
            SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ETPPA_TERMINATION_CONTEXT_SELECTION_CAMm, INVALIDf));
            {
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_PRP_PEM_CONTEXT_SELECTION, is_valid, "PRP_PEM_CONTEXT_SELECTION", DBAL_ACCESS_METHOD_HARD_LOGIC));
    table_entry->maturity_level = DBAL_MATURITY_HIGH;
    table_entry->table_type = DBAL_TABLE_TYPE_TCAM_DIRECT;
    table_entry->nof_labels = 1;
    DBAL_DB_INIT_TABLE_LABELS_ALLOC(table_entry)
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        access_params->access_type = DBAL_HL_ACCESS_MEMORY;
        {
            SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ETPPA_PRP_PEM_CAMm, INVALIDf));
            {
                access_params->data_offset.formula_int = 0;
            }
        }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        access_params->access_type = DBAL_HL_ACCESS_MEMORY;
        {
            SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ETPPC_FORWARDING_CONTEXT_SELECTION_CAMm, INVALIDf));
            {
                access_params->data_offset.formula_int = 0;
            }
        }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        access_params->access_type = DBAL_HL_ACCESS_MEMORY;
        {
            SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ETPPC_ENCAPSULATION_1_CONTEXT_SELECTION_CAMm, INVALIDf));
            {
                access_params->data_offset.formula_int = 0;
            }
        }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        access_params->access_type = DBAL_HL_ACCESS_MEMORY;
        {
            SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ETPPC_ENCAPSULATION_2_CONTEXT_SELECTION_CAMm, INVALIDf));
            {
                access_params->data_offset.formula_int = 0;
            }
        }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        access_params->access_type = DBAL_HL_ACCESS_MEMORY;
        {
            SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ETPPB_ENCAPSULATION_3_CONTEXT_SELECTION_CAMm, INVALIDf));
            {
                access_params->data_offset.formula_int = 0;
            }
        }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        access_params->access_type = DBAL_HL_ACCESS_MEMORY;
        {
            SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ETPPB_ENCAPSULATION_4_CONTEXT_SELECTION_CAMm, INVALIDf));
            {
                access_params->data_offset.formula_int = 0;
            }
        }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        access_params->access_type = DBAL_HL_ACCESS_MEMORY;
        {
            SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ETPPB_ENCAPSULATION_5_CONTEXT_SELECTION_CAMm, INVALIDf));
            {
                access_params->data_offset.formula_int = 0;
            }
        }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        access_params->access_type = DBAL_HL_ACCESS_MEMORY;
        {
            SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ETPPB_TRAP_CONTEXT_SELECTION_CAMm, INVALIDf));
            {
                access_params->data_offset.formula_int = 0;
            }
        }
