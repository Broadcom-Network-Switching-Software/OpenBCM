...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_KLEAP_IPMF1_INITIAL_KBR_INFO, is_valid, "KLEAP_IPMF1_INITIAL_KBR_INFO", DBAL_ACCESS_METHOD_HARD_LOGIC));
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPC_PMF_KBR_PASS_1m, KEY_F_FFC_VALIDSf));
            ...
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPC_PMF_KBR_PASS_1m, KEY_G_FFC_VALIDSf));
                    access_params->entry_offset.formula_cb = field_context_hash_configuration_compression_dataoffset_0_cb;
                }
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPC_PMF_KBR_PASS_1m, KEY_H_FFC_VALIDSf));
                    access_params->entry_offset.formula_cb = field_context_hash_configuration_compression_dataoffset_0_cb;
                }
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPC_PMF_KBR_PASS_1m, KEY_I_FFC_VALIDSf));
                    access_params->entry_offset.formula_cb = field_context_hash_configuration_compression_dataoffset_0_cb;
                }
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPC_PMF_KBR_PASS_1m, KEY_J_FFC_VALIDSf));
                    access_params->entry_offset.formula_cb = field_context_hash_configuration_compression_dataoffset_0_cb;
                }
            }
        }
