...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    DBAL_INIT_FIELD_TYPES_ENUMS_CLEAR(cur_field_type_param);
    {
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_NETWORK_HEADER_SIZES_L2TPV2_6B, "L2TPV2_6B");
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_NETWORK_HEADER_SIZES_PPPOL2TPV2_6B, "PPPOL2TPV2_6B");
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_field_type_db_struct_clear(unit, cur_field_type_param);
    SHR_IF_ERR_EXIT(dbal_db_init_field_type_general_info_set(unit, cur_field_types_info, "TDM_TRAP_CANDIDATE_HEADER", 152, is_valid, FALSE, DBAL_FIELD_PRINT_TYPE_STRUCTURE, 1, FALSE));
    cur_field_types_info->nof_struct_fields = 5;
    SHR_IF_ERR_EXIT(dbal_db_init_field_type_struct_alloc(unit, cur_field_types_info));
    ...
    cur_field_types_info->struct_field_info[3].length = 10;
    cur_field_types_info->struct_field_info[4].struct_field_id = DBAL_FIELD_STAMP_VALUE_AG;
    cur_field_types_info->struct_field_info[4].length = 16;
    dbal_init_field_type_default_restrict_values(cur_field_type_param);
    SHR_IF_ERR_EXIT(dbal_db_init_field_type_add(unit, cur_field_type_param, cur_field_types_info));
