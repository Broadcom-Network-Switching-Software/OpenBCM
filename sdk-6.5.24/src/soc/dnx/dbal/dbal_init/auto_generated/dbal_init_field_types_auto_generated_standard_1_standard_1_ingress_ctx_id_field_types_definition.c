...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    if (DBAL_IS_J2P_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_FWD1_CONTEXT_ID_IPV6___MC_PRIVATE_PUBLIC].value_from_mapping = 32;
            enum_info[DBAL_ENUM_FVAL_FWD1_CONTEXT_ID_IPV6___MC_PRIVATE].value_from_mapping = 33;
            enum_info[DBAL_ENUM_FVAL_FWD1_CONTEXT_ID_IPV6___MC_PRIVATE_PUBLIC_MACT_SA_LKP].value_from_mapping = 34;
            enum_info[DBAL_ENUM_FVAL_FWD1_CONTEXT_ID_IPV6___MC_PRIVATE_MACT_SA_LKP].value_from_mapping = 35;
            enum_info[DBAL_ENUM_FVAL_FWD1_CONTEXT_ID_IPV6___PRIVATE_PUBLIC_OPTIMIZED_UC].value_from_mapping = 36;
            enum_info[DBAL_ENUM_FVAL_FWD1_CONTEXT_ID_IPV6___PRIVATE_UC].value_from_mapping = 37;
            enum_info[DBAL_ENUM_FVAL_FWD1_CONTEXT_ID_IPV6___PRIVATE_PUBLIC_OPTIMIZED_UC_MACT_SA_LKP].value_from_mapping = 38;
            enum_info[DBAL_ENUM_FVAL_FWD1_CONTEXT_ID_IPV6___PRIVATE_UC_MACT_SA_LKP].value_from_mapping = 39;
            enum_info[DBAL_ENUM_FVAL_FWD1_CONTEXT_ID_IPV6___NOP_CTX_MACT_SA_LKP].value_from_mapping = 40;
