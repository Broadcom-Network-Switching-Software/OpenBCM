...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_INSTANCE_IDX(unit, current_mapped_field_id, instance_idx);
    *offset = instance_idx*dnx_data_headers.feature.fhei_mpls_swap_remark_size_get(unit);
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    uint32 result_size__fhei_swap_remark_profile = 0;
    uint32 instance_idx;
    SHR_FUNC_INIT_VARS(unit);
    result_size__fhei_swap_remark_profile += 5;
    DBAL_FORMULA_CB_GET_INSTANCE_IDX(unit, current_mapped_field_id, instance_idx);
    *offset = instance_idx*dnx_data_headers.feature.fhei_mpls_swap_remark_size_get(unit)+result_size__fhei_swap_remark_profile;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
{
    uint32 result_size__fhei_swap_remark_profile = 0;
    uint32 result_size__fhei_swap_nwk_qos_idx = 0;
    uint32 instance_idx;
    SHR_FUNC_INIT_VARS(unit);
    result_size__fhei_swap_remark_profile += 5;
    if (dnx_data_headers.feature.feature_get(unit, dnx_data_headers_feature_fhei_mpls_cmd_from_eei))
    {
        result_size__fhei_swap_nwk_qos_idx += 1;
    }
    DBAL_FORMULA_CB_GET_INSTANCE_IDX(unit, current_mapped_field_id, instance_idx);
    *offset = instance_idx*dnx_data_headers.feature.fhei_mpls_swap_remark_size_get(unit)+result_size__fhei_swap_remark_profile+result_size__fhei_swap_nwk_qos_idx;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    uint32 result_size__fhei_swap_remark_profile = 0;
    uint32 result_size__fhei_swap_nwk_qos_idx = 0;
    uint32 result_size__fhei_swap_qos_model = 0;
    uint32 instance_idx;
    SHR_FUNC_INIT_VARS(unit);
    result_size__fhei_swap_remark_profile += 5;
    if (dnx_data_headers.feature.feature_get(unit, dnx_data_headers_feature_fhei_mpls_cmd_from_eei))
    ...
    if (dnx_data_headers.feature.feature_get(unit, dnx_data_headers_feature_fhei_mpls_cmd_from_eei))
    {
        result_size__fhei_swap_qos_model += 1;
    }
    DBAL_FORMULA_CB_GET_INSTANCE_IDX(unit, current_mapped_field_id, instance_idx);
    *offset = instance_idx*dnx_data_headers.feature.fhei_mpls_swap_remark_size_get(unit)+result_size__fhei_swap_remark_profile+result_size__fhei_swap_nwk_qos_idx+result_size__fhei_swap_qos_model;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
