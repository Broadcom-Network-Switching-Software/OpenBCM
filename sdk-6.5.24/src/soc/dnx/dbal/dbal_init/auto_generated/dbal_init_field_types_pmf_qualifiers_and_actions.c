...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_field_type_general_info_set(unit, cur_field_types_info, "IPMF1_QUALIFIERS_CONTAINER", 256, is_valid, FALSE, DBAL_FIELD_PRINT_TYPE_STRUCTURE, 1, FALSE));
    ...
    cur_field_types_info->struct_field_info[136].struct_field_id = DBAL_FIELD_IP_TUNNEL_IN_LIF_WIDE_DATA;
    cur_field_types_info->struct_field_info[137].struct_field_id = DBAL_FIELD_NATIVE_AC_IN_LIF_WIDE_DATA;
    cur_field_types_info->struct_field_info[138].struct_field_id = DBAL_FIELD_PP_PORT_PMF_PROFILE;
    cur_field_types_info->struct_field_info[138].length = dnx_data_field.profile_bits.nof_bits_in_port_profile_get(unit);
    cur_field_types_info->struct_field_info[139].struct_field_id = DBAL_FIELD_TM_PORT_PMF_PROFILE;
    cur_field_types_info->struct_field_info[139].length = dnx_data_field.profile_bits.nof_bits_in_port_profile_get(unit);
    cur_field_types_info->struct_field_info[140].struct_field_id = DBAL_FIELD_PP_PORT_PMF_GENERAL_DATA;
    cur_field_types_info->struct_field_info[140].length = dnx_data_field.profile_bits.nof_bits_in_ingress_pp_port_general_data_get(unit);
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_field_type_db_struct_clear(unit, cur_field_type_param);
    SHR_IF_ERR_EXIT(dbal_db_init_field_type_general_info_set(unit, cur_field_types_info, "IPMF2_QUALIFIERS_CONTAINER", 256, is_valid, FALSE, DBAL_FIELD_PRINT_TYPE_STRUCTURE, 1, FALSE));
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_field_type_db_struct_clear(unit, cur_field_type_param);
    SHR_IF_ERR_EXIT(dbal_db_init_field_type_general_info_set(unit, cur_field_types_info, "IPMF3_QUALIFIERS_CONTAINER", 256, is_valid, FALSE, DBAL_FIELD_PRINT_TYPE_STRUCTURE, 1, FALSE));
...
shr_error_e
_dbal_init_field_types_pmf_qualifiers_and_actions_external_qualifiers_container_init(
int unit,
field_type_db_struct_t * cur_field_type_param,
dbal_field_types_basic_info_t ** field_types_info)
{
    dbal_field_types_basic_info_t * cur_field_types_info = field_types_info[DBAL_FIELD_TYPE_DEF_EXTERNAL_QUALIFIERS_CONTAINER];
    int is_valid = TRUE;
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_field_type_db_struct_clear(unit, cur_field_type_param);
    SHR_IF_ERR_EXIT(dbal_db_init_field_type_general_info_set(unit, cur_field_types_info, "EXTERNAL_QUALIFIERS_CONTAINER", 256, is_valid, FALSE, DBAL_FIELD_PRINT_TYPE_STRUCTURE, 1, FALSE));
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_field_type_db_struct_clear(unit, cur_field_type_param);
    SHR_IF_ERR_EXIT(dbal_db_init_field_type_general_info_set(unit, cur_field_types_info, "EPMF_QUALIFIERS_CONTAINER", 256, is_valid, FALSE, DBAL_FIELD_PRINT_TYPE_STRUCTURE, 1, FALSE));
    ...
    cur_field_types_info->struct_field_info[96].struct_field_id = DBAL_FIELD_PPH_FWD_LAYER_INDEX;
    dbal_init_field_type_default_restrict_values(cur_field_type_param);
    SHR_IF_ERR_EXIT(dbal_db_init_field_type_add(unit, cur_field_type_param, cur_field_types_info));
exit:
    SHR_FUNC_EXIT;
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_field_type_db_struct_clear(unit, cur_field_type_param);
    SHR_IF_ERR_EXIT(dbal_db_init_field_type_general_info_set(unit, cur_field_types_info, "L4OPS_QUALIFIERS_CONTAINER", 256, is_valid, FALSE, DBAL_FIELD_PRINT_TYPE_STRUCTURE, 1, FALSE));
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    SHR_IF_ERR_EXIT(_dbal_init_field_types_pmf_qualifiers_and_actions_external_qualifiers_container_init(unit, cur_field_type_param, field_types_info));
