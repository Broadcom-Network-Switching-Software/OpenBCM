...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_ECGM_CORE_GLOBAL_THRESHOLDS, is_valid, "ECGM_CORE_GLOBAL_THRESHOLDS", DBAL_ACCESS_METHOD_HARD_LOGIC));
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_ECGM_CORE_UNICAST_THRESHOLDS, is_valid, "ECGM_CORE_UNICAST_THRESHOLDS", DBAL_ACCESS_METHOD_HARD_LOGIC));
    table_entry->maturity_level = DBAL_MATURITY_HIGH;
    table_entry->table_type = DBAL_TABLE_TYPE_DIRECT;
    table_entry->nof_labels = 3;
    DBAL_DB_INIT_TABLE_LABELS_ALLOC(table_entry)
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_ECGM_CORE_MULTICAST_THRESHOLDS, is_valid, "ECGM_CORE_MULTICAST_THRESHOLDS", DBAL_ACCESS_METHOD_HARD_LOGIC));
    table_entry->maturity_level = DBAL_MATURITY_HIGH;
    table_entry->table_type = DBAL_TABLE_TYPE_DIRECT;
    table_entry->nof_labels = 3;
    DBAL_DB_INIT_TABLE_LABELS_ALLOC(table_entry)
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_ECGM_CORE_MULTICAST_SP_THRESHOLDS, is_valid, "ECGM_CORE_MULTICAST_SP_THRESHOLDS", DBAL_ACCESS_METHOD_HARD_LOGIC));
    table_entry->maturity_level = DBAL_MATURITY_HIGH;
    table_entry->table_type = DBAL_TABLE_TYPE_DIRECT;
    table_entry->nof_labels = 3;
    DBAL_DB_INIT_TABLE_LABELS_ALLOC(table_entry)
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_ECGM_CORE_TC_MULTICAST_THRESHOLDS, is_valid, "ECGM_CORE_TC_MULTICAST_THRESHOLDS", DBAL_ACCESS_METHOD_HARD_LOGIC));
    table_entry->maturity_level = DBAL_MATURITY_HIGH;
    table_entry->table_type = DBAL_TABLE_TYPE_DIRECT;
    table_entry->nof_labels = 3;
    DBAL_DB_INIT_TABLE_LABELS_ALLOC(table_entry)
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ECGM_CGM_MC_PD_TC_FC_THr, INVALIDf));
        ...
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ECGM_CONGESTION_MANAGEMENT_MULTICAST_FLOW_CONTROL_PER_TC_THREHOSLDSr, INVALIDf));
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_ECGM_CORE_TC_MULTICAST_SP_THRESHOLDS, is_valid, "ECGM_CORE_TC_MULTICAST_SP_THRESHOLDS", DBAL_ACCESS_METHOD_HARD_LOGIC));
    table_entry->maturity_level = DBAL_MATURITY_HIGH;
    table_entry->table_type = DBAL_TABLE_TYPE_DIRECT;
    table_entry->nof_labels = 3;
    DBAL_DB_INIT_TABLE_LABELS_ALLOC(table_entry)
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ECGM_CONGESTION_MANAGEMENT_PD_SERVICE_POOL_THRESHOLDSr, INVALIDf));
        ...
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ECGM_CONGESTION_MANAGEMENT_DB_SERVICE_POOL_MAXIMUM_THRESHOLDSr, INVALIDf));
        ...
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ECGM_CONGESTION_MANAGEMENT_DB_SERVICE_POOL_MINIMUM_THRESHOLDSr, INVALIDf));
                    access_params->data_offset.formula_cb = ecgm_core_tc_multicast_sp_thresholds_db_drop_max_dataoffset_0_cb;
                }
            }
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ECGM_CONGESTION_MANAGEMENT_DB_SERVICE_POOL_ALPHA_0r, INVALIDf));
        ...
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ECGM_CONGESTION_MANAGEMENT_DB_SERVICE_POOL_ALPHA_1r, INVALIDf));
                    access_params->data_offset.formula_cb = ecgm_core_tc_multicast_sp_thresholds_db_drop_alpha_0_dataoffset_0_cb;
                }
            }
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ECGM_CONGESTION_MANAGEMENT_MULTICAST_RESERVED_RESOURCES_PER_CLASSr, INVALIDf));
                    access_params->data_offset.formula_cb = ecgm_core_tc_multicast_sp_thresholds_db_drop_max_dataoffset_0_cb;
                }
            }
        }
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_ECGM_INTERFACE_UNICAST_THRESHOLDS, is_valid, "ECGM_INTERFACE_UNICAST_THRESHOLDS", DBAL_ACCESS_METHOD_HARD_LOGIC));
    table_entry->maturity_level = DBAL_MATURITY_HIGH;
    table_entry->table_type = DBAL_TABLE_TYPE_DIRECT;
    table_entry->nof_labels = 3;
    DBAL_DB_INIT_TABLE_LABELS_ALLOC(table_entry)
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_ECGM_EGQ_IF_TO_INTERFACE_PROFILE_MAP, is_valid, "ECGM_EGQ_IF_TO_INTERFACE_PROFILE_MAP", DBAL_ACCESS_METHOD_HARD_LOGIC));
    table_entry->maturity_level = DBAL_MATURITY_HIGH;
    table_entry->table_type = DBAL_TABLE_TYPE_DIRECT;
    table_entry->nof_labels = 3;
    DBAL_DB_INIT_TABLE_LABELS_ALLOC(table_entry)
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_ECGM_QUEUE_DISABLE, is_valid, "ECGM_QUEUE_DISABLE", DBAL_ACCESS_METHOD_HARD_LOGIC));
    table_entry->maturity_level = DBAL_MATURITY_HIGH;
    table_entry->table_type = DBAL_TABLE_TYPE_DIRECT;
    table_entry->nof_labels = 3;
    DBAL_DB_INIT_TABLE_LABELS_ALLOC(table_entry)
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_ECGM_INTERFACE_MULTICAST_THRESHOLDS, is_valid, "ECGM_INTERFACE_MULTICAST_THRESHOLDS", DBAL_ACCESS_METHOD_HARD_LOGIC));
    table_entry->maturity_level = DBAL_MATURITY_HIGH;
    table_entry->table_type = DBAL_TABLE_TYPE_DIRECT;
    table_entry->nof_labels = 3;
    DBAL_DB_INIT_TABLE_LABELS_ALLOC(table_entry)
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_ECGM_UNICAST_PORT_THRESHOLDS, is_valid, "ECGM_UNICAST_PORT_THRESHOLDS", DBAL_ACCESS_METHOD_HARD_LOGIC));
    table_entry->maturity_level = DBAL_MATURITY_HIGH;
    table_entry->table_type = DBAL_TABLE_TYPE_DIRECT;
    table_entry->nof_labels = 3;
    DBAL_DB_INIT_TABLE_LABELS_ALLOC(table_entry)
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_ECGM_OUT_TM_PORT_TO_PORT_PROFILE_MAP, is_valid, "ECGM_OUT_TM_PORT_TO_PORT_PROFILE_MAP", DBAL_ACCESS_METHOD_HARD_LOGIC));
    table_entry->maturity_level = DBAL_MATURITY_HIGH;
    table_entry->table_type = DBAL_TABLE_TYPE_DIRECT;
    table_entry->nof_labels = 3;
    DBAL_DB_INIT_TABLE_LABELS_ALLOC(table_entry)
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_ECGM_BASE_Q_PAIR_TO_PORT_PROFILE_MAP, is_valid, "ECGM_BASE_Q_PAIR_TO_PORT_PROFILE_MAP", DBAL_ACCESS_METHOD_HARD_LOGIC));
    table_entry->maturity_level = DBAL_MATURITY_HIGH;
    table_entry->table_type = DBAL_TABLE_TYPE_DIRECT;
    table_entry->nof_labels = 3;
    DBAL_DB_INIT_TABLE_LABELS_ALLOC(table_entry)
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_ECGM_UNICAST_QUEUE_THRESHOLDS, is_valid, "ECGM_UNICAST_QUEUE_THRESHOLDS", DBAL_ACCESS_METHOD_HARD_LOGIC));
    table_entry->maturity_level = DBAL_MATURITY_HIGH;
    table_entry->table_type = DBAL_TABLE_TYPE_DIRECT;
    table_entry->nof_labels = 3;
    DBAL_DB_INIT_TABLE_LABELS_ALLOC(table_entry)
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_ECGM_MULTICAST_PORT_THRESHOLDS, is_valid, "ECGM_MULTICAST_PORT_THRESHOLDS", DBAL_ACCESS_METHOD_HARD_LOGIC));
    table_entry->maturity_level = DBAL_MATURITY_HIGH;
    table_entry->table_type = DBAL_TABLE_TYPE_DIRECT;
    table_entry->nof_labels = 3;
    DBAL_DB_INIT_TABLE_LABELS_ALLOC(table_entry)
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_ECGM_MULTICAST_QUEUE_TC_DP_THRESHOLDS, is_valid, "ECGM_MULTICAST_QUEUE_TC_DP_THRESHOLDS", DBAL_ACCESS_METHOD_HARD_LOGIC));
    table_entry->maturity_level = DBAL_MATURITY_HIGH;
    table_entry->table_type = DBAL_TABLE_TYPE_DIRECT;
    table_entry->nof_labels = 3;
    DBAL_DB_INIT_TABLE_LABELS_ALLOC(table_entry)
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_ECGM_MULTICAST_QUEUE_TC_THRESHOLDS, is_valid, "ECGM_MULTICAST_QUEUE_TC_THRESHOLDS", DBAL_ACCESS_METHOD_HARD_LOGIC));
    table_entry->maturity_level = DBAL_MATURITY_HIGH;
    table_entry->table_type = DBAL_TABLE_TYPE_DIRECT;
    table_entry->nof_labels = 3;
    DBAL_DB_INIT_TABLE_LABELS_ALLOC(table_entry)
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_ECGM_DELETE_FIFO_MODE, is_valid, "ECGM_DELETE_FIFO_MODE", DBAL_ACCESS_METHOD_HARD_LOGIC));
    table_entry->maturity_level = DBAL_MATURITY_HIGH;
    table_entry->table_type = DBAL_TABLE_TYPE_DIRECT;
    table_entry->nof_labels = 3;
    DBAL_DB_INIT_TABLE_LABELS_ALLOC(table_entry)
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_ECGM_DELETE_FIFO_THRESHOLDS, is_valid, "ECGM_DELETE_FIFO_THRESHOLDS", DBAL_ACCESS_METHOD_HARD_LOGIC));
    table_entry->maturity_level = DBAL_MATURITY_HIGH;
    table_entry->table_type = DBAL_TABLE_TYPE_DIRECT;
    table_entry->nof_labels = 3;
    DBAL_DB_INIT_TABLE_LABELS_ALLOC(table_entry)
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_ECGM_DELETE_FIFO_TDM_SHORT_THRESHOLDS, is_valid, "ECGM_DELETE_FIFO_TDM_SHORT_THRESHOLDS", DBAL_ACCESS_METHOD_HARD_LOGIC));
    table_entry->maturity_level = DBAL_MATURITY_HIGH;
    table_entry->table_type = DBAL_TABLE_TYPE_DIRECT;
    table_entry->nof_labels = 3;
    DBAL_DB_INIT_TABLE_LABELS_ALLOC(table_entry)
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_ECGM_THRESHOLDS_STRICT_PRIORITY_OR_DISCRETE_PARTITIONING, is_valid, "ECGM_THRESHOLDS_STRICT_PRIORITY_OR_DISCRETE_PARTITIONING", DBAL_ACCESS_METHOD_HARD_LOGIC));
    table_entry->maturity_level = DBAL_MATURITY_HIGH;
    table_entry->table_type = DBAL_TABLE_TYPE_DIRECT;
    table_entry->nof_labels = 3;
    DBAL_DB_INIT_TABLE_LABELS_ALLOC(table_entry)
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ECGM_CGM_PD_TH_SP_OR_SHAREDr, INVALIDf));
                }
            }
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ECGM_CGM_DB_TH_SP_OR_SHAREDr, INVALIDf));
                }
            }
        }
        cur_table_param->hl_access[map_idx].nof_access = access_counter;
