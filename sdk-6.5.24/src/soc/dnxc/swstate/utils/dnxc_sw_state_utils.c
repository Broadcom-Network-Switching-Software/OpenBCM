...
{
    uint32 pre_len = sal_strnlen(pre,SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH);
    uint32 str_len = sal_strnlen(str,SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH);
    if (str_len < pre_len) {
        return 0;
    }
