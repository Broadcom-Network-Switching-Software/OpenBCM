...
int dnxc_sw_state_alloc_wb(
    ...
    DNXC_VERIFY_INVOKE(DNXC_SW_STATE_IF_ERR_EXIT(dnxc_sw_state_alloc_verify_common(unit, module_id, ptr_location, _nof_elements, element_size, flags, dbg_string)));
...
int dnxc_sw_state_free_wb(
    ...
    DNXC_VERIFY_INVOKE(DNXC_SW_STATE_IF_ERR_EXIT(dnxc_sw_state_free_verify_common(unit, module_id, ptr_location, flags, dbg_string)));
...
int dnxc_sw_state_alloc_size_wb(
    ...
    DNXC_VERIFY_INVOKE(DNXC_SW_STATE_IF_ERR_EXIT(dnxc_sw_state_alloc_size_verify_common(unit, module, location, nof_elements, element_size)));
