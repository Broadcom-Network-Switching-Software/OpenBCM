...
soc_hurricane4_mem_config(int unit)
{
    ...
    if (soc_feature(unit, soc_feature_td3x1_reduced_ipmc)) {
        sop->memState[MMU_REPL_GROUP_INFO_TBL_PIPE0m].index_max = 2047;
        sop->memState[MMU_REPL_HEAD_TBL_SPLIT0_PIPE0m].index_max = 8191;
        sop->memState[MMU_REPL_HEAD_TBL_SPLIT1_PIPE0m].index_max = 8191;
        sop->memState[MMU_REPL_LIST_TBL_PIPE0m].index_max = 8191;
    }
