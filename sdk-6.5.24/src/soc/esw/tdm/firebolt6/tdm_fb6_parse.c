...
int param_dummy = 0;
    ...
    switch (param_clk_freq) {
       case FB6_CLK_4740_1012: param_mgmt_size = 16; param_lpbk=3; param_fae = 3; param_null = 8; param_dummy = 1; break;
...
int param_dummy = 0;
   ...
   switch (param_clk_freq) {
       case FB6_CLK_4740_1012: param_mgmt_size = 16; param_lpbk=3; param_fae = 0; param_null = 9; param_dummy = 4;  break;
 ...
 /*   } */
    ...
    mgmt_init = 1;
     ...
     switch(param_clk_freq){
        ...
        break;
        case     FB6_CLK_4740_1012: exp_no_of_mgmt_ports = 4;
        break;
