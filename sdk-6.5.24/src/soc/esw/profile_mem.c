        ...
        for (table_index = 0; table_index < profile->table_count;
            ...
            for (i = 0; i < num_entries; i++) {
                ...
                if (SOC_IS_TOMAHAWK3(unit) &&
                        ...
                        ((table->mem != IFP_KEY_GEN_PROGRAM_PROFILEm) &&
                         (table->mem != IFP_KEY_GEN_PROGRAM_PROFILEm) &&
                         (table->mem != IFP_KEY_GEN_PROGRAM_PROFILE2m) &&
                         (table->mem != EXACT_MATCH_KEY_GEN_PROGRAM_PROFILEm) &&
                         (table->mem != EXACT_MATCH_KEY_GEN_MASKm))) {
