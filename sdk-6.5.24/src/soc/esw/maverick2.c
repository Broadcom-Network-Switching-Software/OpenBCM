...
soc_functions_t soc_maverick2_drv_funs = {
 ...
 /*
  * Function: bcm_maverick2_mmu_pfc_tx_config_set
  * Purpose:
...
int
soc_maverick2_mmu_pfc_tx_config_set(int unit, bcm_port_t port, int pfc_enable)
{
    ...
    soc_reg_t obm_fc_config_regs[] = {
      IDB_OBM0_FLOW_CONTROL_CONFIGr, IDB_OBM1_FLOW_CONTROL_CONFIGr, IDB_OBM2_FLOW_CONTROL_CONFIGr,
      IDB_OBM3_FLOW_CONTROL_CONFIGr,
      IDB_OBM4_FLOW_CONTROL_CONFIGr, IDB_OBM5_FLOW_CONTROL_CONFIGr, IDB_OBM6_FLOW_CONTROL_CONFIGr,
      IDB_OBM7_FLOW_CONTROL_CONFIGr,
      IDB_OBM8_FLOW_CONTROL_CONFIGr, IDB_OBM9_FLOW_CONTROL_CONFIGr, IDB_OBM10_FLOW_CONTROL_CONFIGr,
      IDB_OBM11_FLOW_CONTROL_CONFIGr,
      IDB_OBM12_FLOW_CONTROL_CONFIGr, IDB_OBM13_FLOW_CONTROL_CONFIGr, IDB_OBM14_FLOW_CONTROL_CONFIGr,
      IDB_OBM15_FLOW_CONTROL_CONFIGr,
      IDB_OBM16_FLOW_CONTROL_CONFIGr, IDB_OBM17_FLOW_CONTROL_CONFIGr, IDB_OBM18_FLOW_CONTROL_CONFIGr,
 ...
 * Note: mv2 has three different OBM register sets
 */

int
soc_maverick2_port_obm_info_get(int unit, soc_port_t port,
                               int *obm_id, int *lane)
{
    soc_info_t *si;
    soc_port_t phy_port;
    ...
    if (lane != NULL) {
        *lane = (phy_port - port_block_base) % _MV2_PORTS_PER_PBLK;
    }
