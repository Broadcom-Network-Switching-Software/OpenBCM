...
int
soc_fe3200_drv_link_to_block_mapping(int unit, int link, int* block_id,int* inner_link, int block_type)
{   
...
int
soc_fe3200_set_mesh_topology_config(int unit) {
...
soc_fe3200_set_fmac_config(int unit)
{
    ...
    if (SOC_DFE_IS_FE13(unit))
    {
       PBMP_SFI_ITER(unit, link)
       {
           ...
           SOCDNX_IF_ERR_EXIT(soc_reg32_get(unit, FMAC_FMAL_TX_COMMA_BURST_CONFIGURATIONr, blk, inner_link, &reg_val32));
           ...
           SOCDNX_IF_ERR_EXIT(soc_reg32_set(unit, FMAC_FMAL_TX_COMMA_BURST_CONFIGURATIONr, blk, inner_link, reg_val32));
       }
    } else {
        SOCDNX_IF_ERR_EXIT(soc_reg32_get(unit, FMAC_FMAL_TX_COMMA_BURST_CONFIGURATIONr, 0, 0, &reg_val32));
        soc_reg_field_set(unit, FMAC_FMAL_TX_COMMA_BURST_CONFIGURATIONr, &reg_val32, FMAL_N_CM_TX_BYTE_MODEf, 0x1);
