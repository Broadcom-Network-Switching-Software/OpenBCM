...
extern __portmod__dispatch__t__ portmod_pm8x100_gen2_driver;
#endif
...
int portmod_pm8x100_fabric_create_info_t_validate(int unit, const portmod_pm8x100_fabric_create_info_t* portmod_pm8x100_fabric_create_info)
{        
    SOC_INIT_FUNC_DEFS;
    if(portmod_pm8x100_fabric_create_info == NULL) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("NULL parameter"));
    }
...
int portmod_pm8x100_fabric_create_info_t_init(int unit, portmod_pm8x100_fabric_create_info_t* portmod_pm8x100_fabric_create_info)
{
    int _array_iter;
    ...
    if(portmod_pm8x100_fabric_create_info == NULL){
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("portmod_pm8x100_fabric_create_info NULL parameter"));
    }
    sal_memset(portmod_pm8x100_fabric_create_info, 0, sizeof(portmod_pm8x100_fabric_create_info_t));
    portmod_pm8x100_fabric_create_info->ref_clk = phymodRefClkCount;
    phymod_access_t_init(&portmod_pm8x100_fabric_create_info->access);
    portmod_pm8x100_fabric_create_info->fw_load_method = phymodFirmwareLoadMethodCount;
    portmod_pm8x100_fabric_create_info->external_fw_loader = NULL;
    for(_array_iter = 0 ; _array_iter < PORTMOD_NOF_FMACS_PER_PM8X100_FABRIC ; _array_iter++){        portmod_pm8x100_fabric_create_info->fmac_schan_id[_array_iter] = -1;
    }    portmod_pm8x100_fabric_create_info->fsrd_schan_id = -1;
    portmod_pm8x100_fabric_create_info->first_phy_offset = 0;
    portmod_pm8x100_fabric_create_info->core_index = -1;
    portmod_pm8x100_fabric_create_info->force_single_pll0 = 0;
    portmod_pm8x100_fabric_create_info->force_single_pll1 = 0;
    for(_array_iter = 0 ; _array_iter < PORTMOD_NOF_WORDS_PER_PM8X100_FABRIC_LANES_BITMAP ; _array_iter++){        portmod_pm8x100_fabric_create_info->bypass_lanes_bitmap[_array_iter] = 0;
    }    portmod_pm8x100_fabric_create_info->is_rx_ctrl_bypass_supported = 0;
    portmod_pm8x100_fabric_create_info->clock_buffer_disable_required = 0;
    portmod_pm8x100_fabric_create_info->clock_buffer_bw_update_required = 0;
    portmod_pm8x100_fabric_create_info->native_single_pll = 0;
...
int portmod_ilkn_os_create_info_t_init(int unit, portmod_ilkn_os_create_info_t* portmod_ilkn_os_create_info)
{
    ...
    portmod_ilkn_os_create_info->fec_dependency = 0;
...
int portmod_pm8x100_gen2_create_info_t_validate(int unit, const portmod_pm8x100_gen2_create_info_t* portmod_pm8x100_gen2_create_info)
{        
    SOC_INIT_FUNC_DEFS;
    if(portmod_pm8x100_gen2_create_info == NULL) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("NULL parameter"));
    }
...
int portmod_pm8x100_gen2_create_info_t_init(int unit, portmod_pm8x100_gen2_create_info_t* portmod_pm8x100_gen2_create_info)
{        
    SOC_INIT_FUNC_DEFS;
    
    if(portmod_pm8x100_gen2_create_info == NULL){
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("portmod_pm8x100_gen2_create_info NULL parameter"));
    }
    sal_memset(portmod_pm8x100_gen2_create_info, 0, sizeof(portmod_pm8x100_gen2_create_info_t));
    portmod_pm8x100_gen2_create_info->ref_clk = phymodRefClkCount;
    phymod_phy_access_t_init(&portmod_pm8x100_gen2_create_info->access);
    phymod_lane_map_t_init(&portmod_pm8x100_gen2_create_info->lane_map);
    portmod_pm8x100_gen2_create_info->fw_load_method = phymodFirmwareLoadMethodCount;
    portmod_pm8x100_gen2_create_info->external_fw_loader = NULL;
    portmod_pm8x100_gen2_create_info->portmod_mac_soft_reset = NULL;
    portmod_pm8x100_gen2_create_info->rescal = -1;
