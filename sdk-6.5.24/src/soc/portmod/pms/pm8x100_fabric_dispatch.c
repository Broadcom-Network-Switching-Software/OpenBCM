...
__portmod__dispatch__t__ portmod_pm8x100_fabric_driver = {
    ...
    pm8x100_fabric_port_pass_through_set,
    pm8x100_fabric_port_pass_through_get,
    pm8x100_fabric_port_phase_interpolator_rx_set,
    pm8x100_fabric_port_phase_interpolator_tx_set,
    pm8x100_fabric_port_pass_through_calibrate,
    pm8x100_fabric_port_pass_through_fec_enable_set,
    pm8x100_fabric_port_pass_through_fec_enable_get,
    ...
    pm8x100_fabric_port_credits_enable_set,
