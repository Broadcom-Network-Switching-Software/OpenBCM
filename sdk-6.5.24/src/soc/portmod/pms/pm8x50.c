...
int _pm8x50_three_cw_bad_recover(int unit, int port, pm_info_t pm_info, int* is_completed)
{
    ...
    uint32_t signal_detect, three_bad, pmd_x4_status = 0;
    ...
    *is_completed = 0;
    ...
    switch (war_state) {
        case PM8X50_PORT_3_CW_BAD_CHECK:
        {
            ...
            _SOC_IF_ERR_EXIT
                (phymod_phy_reg_read(&phy_access, PMD_X4_STATUSr_REG, &pmd_x4_status));
            signal_detect =
