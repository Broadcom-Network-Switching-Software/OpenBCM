...
#define PM8X100_FABRIC_LANE_INDEX_IN_PM_GET(lane_index_in_pm) \
    ((lane_index_in_pm) % PM8X100_FABRIC_LANES_PER_CORE)
...
int pm8x100_fabric_pm_fmac_tx_lane_mapping_set(int unit, int port, pm_info_t pm_info, const phymod_lane_map_t *lane_map)
{
    ...
    int lane_index, serdes_index, serdes_index_in_fmac, serdes_index_in_pm;
    int fmac_blk_id, fmac_rev_blk_id, lane_index_in_fmac, lane_index_in_pm;
