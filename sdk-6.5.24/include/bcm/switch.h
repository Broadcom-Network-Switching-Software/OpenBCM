...
typedef enum bcm_switch_control_e {
    ...
    bcmSwitchSrv6Adapt1DipPrefixLen = 1536, /* SRv6 locator + function length in
                                           adaptation table1. */
    bcmSwitchSrv6Adapt2DipPrefixLen = 1537, /* SRv6 locator + function length in
                                           adaptation table2. */
    bcmSwitchSrv6Adapt4DipPrefixLen = 1538, /* SRv6 locator + function length in
                                           adaptation table4. */
    ...
    bcmSwitchSrv6FunctionSelect = 1547, /* SRv6 SID function field size and
                                           offset selection. */
    ...
    bcmSwitchDbgCntTxMcDropSkipEnable = 1549, /* Do not count any multicast packet
                                           ...
                                           disabled by default. */
    bcmSwitch__Count = 1550             /* Must be last.  Not a usable value. */
...
#define BCM_SWITCH_CONTROL_STR \
    ...
    "Srv6Adapt1DipPrefixLen", \
    "Srv6Adapt2DipPrefixLen", \
    "Srv6Adapt4DipPrefixLen", \
...
#define BCM_SWITCH_SRV6_SRH_ACTION_PSP      (1 << 0)   /* SRv6 SRH PSP action. */
#define BCM_SWITCH_SRV6_SRH_ACTION_TERM     (1 << 1)   /* SRv6 SRH termination
                                                          action. */
#define BCM_SWITCH_SRV6_SRH_ACTION_TRANSIT  (1 << 2)   /* SRv6 SRH transit
                                                          action. */
...
typedef enum bcm_switch_pkt_trace_drop_reason_e {
    ...
    bcmSwitchPktTraceDropReasonL3DstLookupMiss = 71, /* Packcet dropped due to L3 destination
                                           lookup miss failure. */
    bcmSwitchPktTraceDropReasonCount = 72 
