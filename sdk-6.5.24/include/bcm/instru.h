...
typedef enum bcm_instru_synced_trigger_source_type_e {
    bcmInstruSyncedTriggerTypeIcgm = bcmInstruSyncedCountersTypeIcgm, 
    bcmInstruSyncedTriggerTypeNif = bcmInstruSyncedCountersTypeNif, 
    bcmInstruSyncedTriggerTypeCrps = bcmInstruSyncedCountersTypeCrps, 
    bcmInstruSyncedTriggerTypeCount = bcmInstruSyncedCountersTypeCount 
...
typedef struct bcm_instru_synced_trigger_config_s {
    uint64 start_time;      /* Start triggers after the lsb part of the time of
                               day counter is greater than the specified number
                               in ns. A 0 value means start immediately when
                               enabled. */
...
typedef struct bcm_instru_eventor_periodic_source_s {
    bcm_instru_synced_counters_source_type_t source; /* the triggers source CGM,CDU. */
