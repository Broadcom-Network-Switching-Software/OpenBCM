...
typedef enum bcm_flow_tunnel_srv6_action_e {
    bcmFlowTunnelSrv6ActionTransitStdSid = 0, 
    bcmFlowTunnelSrv6ActionTransitGsid = 1, 
    bcmFlowTunnelSrv6ActionTransitUsid = 2, 
    bcmFlowTunnelSrv6ActionPsp = 3 
...
#define BCM_FLOW_HANDLE_INFO_VIRTUAL        (1 << 3)   /* A FLOW ID that doesn't
                                                          use a Global-LIF
                                                          allocation */
#define BCM_FLOW_HANDLE_INFO_BUD            (1 << 4)   /* Use to delete entries
                                                          using traverse, in
                                                          this case cb function
                                                          will not be invoked
                                                          and entries will be
                                                          deleted. */
#define BCM_FLOW_HANDLE_TRAVERSE_DELETE_ALL (1 << 5)   /* Use to create Flow
                                                          termination for BUD
                                                          node. */
