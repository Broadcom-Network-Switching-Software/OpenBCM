...
typedef enum bcm_cosq_stat_e {
    ...
    bcmCosqStatMaxCount = 132           /* this should be the last one. */
} bcm_cosq_stat_t;
...
typedef enum bcm_cosq_gport_fadt_threshold_type_e {
    ...
    bcmCosqFadtEgressReceiveAdmissonDrop = 3, /* Egress receive admission drop
                                           settings */
    bcmCosqFadtEgressEnqueueAdmissonDrop = 4, /* Egress enqueue admission drop
                                           settings */
    bcmCosqFadtEgressEnqueueAdmissionFcHigh = 5, /* Egress enqueue admission FC high
                                           settings */
    bcmCosqFadtEgressEnqueueAdmissionFcLow = 6, /* Egress enqueue admission FC low
                                           settings */
    bcmCosqFadtEgressEnqueueAdmissionFcPfcOn = 7, /* Egress enqueue admission FC pfc on
                                           settings */
    bcmCosqFadtEgressEnqueueAdmissionFcPfcOff = 8 /* Egress enqueue admission FC pfc off
                                           settings */
