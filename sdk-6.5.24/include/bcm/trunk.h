...
#define BCM_TRUNK_FLAG_MULTI_SET            0x10000    /* If set, trunk is part
                                                          of trunk_multi_set. */
#define BCM_TRUNK_FLAG_FORCED_RH_SEED       0x20000    /* If set, indicates the
                                                          RH seed is derived
                                                          from rh_random_seed.
                                                          Otherwise, it is
 ...
 * member of a Trunk
 */
extern int bcm_trunk_member_hash_range_set(
    int unit, 
    uint32 flags, 
 ...
 * member of a Trunk
 */
extern int bcm_trunk_member_hash_range_get(
    int unit, 
    uint32 flags, 
    bcm_trunk_t trunk_id, 
    bcm_gport_t member, 
...
/* Set flow aggregate. */
extern int bcm_trunk_flow_agg_set(
    int unit, 
    int flow_agg_id, 
    int flags, 
...
/* Get flow aggregate. */
extern int bcm_trunk_flow_agg_get(
    int unit, 
    int flow_agg_id, 
    int flags, 
    bcm_flow_agg_info_t *flow_agg_info);
