...
#else
#define BCM_ESW_ALPM_EPB_MAX        15 /* TH3 route FMT1 */
#endif
...
/* ALPM standard route groups 0-5 defined in bcm_l3_route_group_t */
#define ALPM_STD_ROUTE_GROUP_COUNT 6

/* ALPM resource info structure */
typedef struct _alpm_resource_info_s {
    bcm_l3_alpm_resource_t res[ALPM_STD_ROUTE_GROUP_COUNT];
} _alpm_resource_info_t;


/* ESW externs */
extern int bcm_esw_alpm_init(int u);
extern int bcm_esw_alpm_deinit(int u);
...
extern int alpm_dist_hitbit_thread_stop(int u);
