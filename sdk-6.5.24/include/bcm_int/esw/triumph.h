...
extern int bcm_tr_l2_cross_connect_traverse(int unit,
                                            ...
                                            void *user_data);
extern int bcmi_tr_l2_cross_connect_control_set(int unit,
                               bcm_vlan_t outer_vlan, bcm_vlan_t inner_vlan,
                               bcm_vlan_cross_connect_control_t type, int arg);
extern int bcmi_tr_l2_cross_connect_control_get(int unit,
                               bcm_vlan_t outer_vlan, bcm_vlan_t inner_vlan,
                               bcm_vlan_cross_connect_control_t type, int *arg);
extern int bcmi_tr_l2_vlan_cross_connect_replace(int unit,
                   uint32 options,
...
extern int bcmi_td3_mpls_php_vcswap_info_delete(int unit, int nh_index, int ecmp_index, int dest_type);

extern int bcmi_td3_mpls_default_port_add(int unit, bcm_vpn_t vpn, bcm_mpls_port_t *mpls_port);
extern int bcmi_td3_mpls_default_port_delete(int unit, int vp);
#endif
#endif /* INCLUDE_L3 */
