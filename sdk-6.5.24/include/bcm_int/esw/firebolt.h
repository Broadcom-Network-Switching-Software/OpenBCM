...
#define  _BCM_L3_SHR_UNDERLAY_ONLY_OBJECT   (1 << 15) /* L3 object created
                                                       * in underlay domain unusable
                                                       * as standalone group. */
...
#define BCM_XGS3_L3_ECMP_MAX_GROUPS(_u_)                  \
    ...
    (SOC_IS_HURRICANE4(_u_)) ? ((soc_feature(_u_, soc_feature_td3x1_reduced_ecmp)) ? (128) : (256)) : \
    (SOC_IS_TRIDENT2PLUS(_u_) || SOC_IS_TOMAHAWK2(_u_) || \
      SOC_IS_TRIDENT3X(_u_)) ? (4096) : \
    (SOC_IS_MONTEREY(_u_)) ? (512) : \
    (SOC_IS_TOMAHAWK3(_u_)) ? (6144) : \
