...
/* L2 MACT learning/forwarding options */
typedef enum l2_addr_mact_e
{
    l2AddrNA = 0,               /* For devices in which the L2 learn and forwarding share the same table */
    l2AddrFwdMact = 0,  /* The forwarding table (MACT DA) */
    l2AddrLearnMact = 1,        /* The learning table (MACT SA) */
} l2_addr_mact_t;
