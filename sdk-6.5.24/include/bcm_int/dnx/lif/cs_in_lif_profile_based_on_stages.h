...
/*
 * \brief
 *      initialize default values for VTT and FLP P2P or MP indication
 * \param [in] unit -
 *   The unit number.
 * \param [out] vtt_p2p_or_mp -
 *   encoded default value for VTT P2P or MP indication
 * \param [out] flp_p2p_or_mp -
 *   encoded default value for FLP P2P or MP indication
 * \return
 *   \retval Negative if error was detected. See \ref shr_error_e
 * \remark
 *   * None
 ...
 *   * None
 */
shr_error_e dnx_cs_in_lif_profile_get_default_p2p_mp_value(
    int unit,
    uint32 *vtt_p2p_or_mp,
    uint32 *flp_p2p_or_mp);
