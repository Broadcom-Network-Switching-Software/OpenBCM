 ...
 */
#define DNX_OFP_RATES_CAL_LEN_SCH_MAX                  0x3000
/**
...
/*
 * Default value for burst on total shaper
 */
#define DNX_TOTAL_SHAPER_RATES_BURST_DEFAULT                    0x4B000
/*
 * }
 */
/*
 ...
 *   port shapers.
 * \param [in] alt_cal_alg -
 *   Use alternative calendar algorithm
 * \return
 *   If zero (_SHR_E_NONE), then no error was encountered.
 *   Otherwise, see shr_error_e
 * \remark
