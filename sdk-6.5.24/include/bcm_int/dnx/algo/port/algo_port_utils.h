...
/**
 * \brief return true if imb type represents CDU
 */
#define DNX_ALGO_PORT_IMB_TYPE_IS_CDU(imb_type) ((imb_type) == imbDispatchTypeImb_cdu || (imb_type) == imbDispatchTypeImb_cdu_shr)

/**
 * \brief return true if imb type represents CLU
 */
#define DNX_ALGO_PORT_IMB_TYPE_IS_CLU(imb_type) ((imb_type) == imbDispatchTypeImb_clu)
#endif
/**
