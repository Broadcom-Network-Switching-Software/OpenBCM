 ...
 *  Each address type takes a different number of entries in Source_address_map table.
 *  Dnxdata table is used to map between the address type and the number of entries taken.
 */
typedef enum
{
    /*
