...
typedef struct {
    /**
     * FlexE Mux logical PHY allocation manager
     */
    dnx_algo_res_t mux_lphy;
    /**
     * FlexE Demux logical PHY allocation manager
     */
...
typedef struct {
    ...
    int nof_instances;
    /**
     * Mux LPHY bitmap allocated for this FlexE port.
     */
    SHR_BITDCL mux_lphy_bitmap[((DNX_DATA_MAX_NIF_FLEXE_NOF_FLEXE_LPHYS)/SHR_BITWID)+1];
    /**
     * Demux LPHY bitmap allocated for this FlexE port.
     */
