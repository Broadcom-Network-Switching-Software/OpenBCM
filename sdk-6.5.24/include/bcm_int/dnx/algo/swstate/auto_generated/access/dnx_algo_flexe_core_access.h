...
/**
 * implemented by: dnx_algo_flexe_core_db_resource_alloc_mux_lphy_set
 */
typedef int (*dnx_algo_flexe_core_db_resource_alloc_mux_lphy_set_cb)(
    int unit, dnx_algo_res_t mux_lphy);

/**
 * implemented by: dnx_algo_flexe_core_db_resource_alloc_mux_lphy_get
 */
typedef int (*dnx_algo_flexe_core_db_resource_alloc_mux_lphy_get_cb)(
    int unit, dnx_algo_res_t *mux_lphy);

/**
 * implemented by: dnx_algo_flexe_core_db_resource_alloc_mux_lphy_create
 */
...
/**
 * implemented by: dnx_algo_flexe_core_db_resource_alloc_mux_lphy_allocate_single
 */
...
/**
 * implemented by: dnx_algo_flexe_core_db_port_mux_lphy_bitmap_bit_set
 */
typedef int (*dnx_algo_flexe_core_db_port_mux_lphy_bitmap_bit_set_cb)(
    int unit, uint32 port_idx_0, uint32 _bit_num);

/**
 * implemented by: dnx_algo_flexe_core_db_port_mux_lphy_bitmap_bit_clear
 */
typedef int (*dnx_algo_flexe_core_db_port_mux_lphy_bitmap_bit_clear_cb)(
    int unit, uint32 port_idx_0, uint32 _bit_num);

/**
 * implemented by: dnx_algo_flexe_core_db_port_mux_lphy_bitmap_bit_get
 */
...
/**
 * implemented by: dnx_algo_flexe_core_db_port_mux_lphy_bitmap_bit_range_read
 */
...
/**
 * implemented by: dnx_algo_flexe_core_db_port_mux_lphy_bitmap_bit_range_write
 */
...
/**
 * implemented by: dnx_algo_flexe_core_db_port_mux_lphy_bitmap_bit_range_and
 */
...
/**
 * implemented by: dnx_algo_flexe_core_db_port_mux_lphy_bitmap_bit_range_or
 */
typedef int (*dnx_algo_flexe_core_db_port_mux_lphy_bitmap_bit_range_or_cb)(
    int unit, uint32 port_idx_0, uint32 _first, uint32 _count, SHR_BITDCL *input_bmp);

/**
 * implemented by: dnx_algo_flexe_core_db_port_mux_lphy_bitmap_bit_range_xor
 */
typedef int (*dnx_algo_flexe_core_db_port_mux_lphy_bitmap_bit_range_xor_cb)(
    int unit, uint32 port_idx_0, uint32 _first, uint32 _count, SHR_BITDCL *input_bmp);

/**
 * implemented by: dnx_algo_flexe_core_db_port_mux_lphy_bitmap_bit_range_remove
 */
typedef int (*dnx_algo_flexe_core_db_port_mux_lphy_bitmap_bit_range_remove_cb)(
    int unit, uint32 port_idx_0, uint32 _first, uint32 _count, SHR_BITDCL *input_bmp);

/**
 * implemented by: dnx_algo_flexe_core_db_port_mux_lphy_bitmap_bit_range_negate
 */
...
/**
 * implemented by: dnx_algo_flexe_core_db_port_mux_lphy_bitmap_bit_range_clear
 */
typedef int (*dnx_algo_flexe_core_db_port_mux_lphy_bitmap_bit_range_clear_cb)(
    int unit, uint32 port_idx_0, uint32 _first, uint32 _count);

/**
 * implemented by: dnx_algo_flexe_core_db_port_mux_lphy_bitmap_bit_range_set
 */
typedef int (*dnx_algo_flexe_core_db_port_mux_lphy_bitmap_bit_range_set_cb)(
    int unit, uint32 port_idx_0, uint32 _first, uint32 _count);

/**
 * implemented by: dnx_algo_flexe_core_db_port_mux_lphy_bitmap_bit_range_null
 */
...
/**
 * implemented by: dnx_algo_flexe_core_db_port_mux_lphy_bitmap_bit_range_test
 */
typedef int (*dnx_algo_flexe_core_db_port_mux_lphy_bitmap_bit_range_test_cb)(
    int unit, uint32 port_idx_0, uint32 _first, uint32 _count, uint8 *result);

/**
 * implemented by: dnx_algo_flexe_core_db_port_mux_lphy_bitmap_bit_range_eq
 */
...
/**
 * implemented by: dnx_algo_flexe_core_db_port_mux_lphy_bitmap_bit_range_count
 */
...
/**
 * implemented by: dnx_algo_flexe_core_db_port_demux_lphy_bitmap_bit_set
 */
typedef int (*dnx_algo_flexe_core_db_port_demux_lphy_bitmap_bit_set_cb)(
    int unit, uint32 port_idx_0, uint32 _bit_num);

/**
 * implemented by: dnx_algo_flexe_core_db_port_demux_lphy_bitmap_bit_clear
 */
typedef int (*dnx_algo_flexe_core_db_port_demux_lphy_bitmap_bit_clear_cb)(
    int unit, uint32 port_idx_0, uint32 _bit_num);

/**
 * implemented by: dnx_algo_flexe_core_db_port_demux_lphy_bitmap_bit_get
 */
typedef int (*dnx_algo_flexe_core_db_port_demux_lphy_bitmap_bit_get_cb)(
    int unit, uint32 port_idx_0, uint32 _bit_num, uint8* result);

/**
 * implemented by: dnx_algo_flexe_core_db_port_demux_lphy_bitmap_bit_range_read
 */
typedef int (*dnx_algo_flexe_core_db_port_demux_lphy_bitmap_bit_range_read_cb)(
    int unit, uint32 port_idx_0, uint32 sw_state_bmp_first, uint32 result_first, uint32 _range, SHR_BITDCL *result);

/**
 * implemented by: dnx_algo_flexe_core_db_port_demux_lphy_bitmap_bit_range_write
 */
typedef int (*dnx_algo_flexe_core_db_port_demux_lphy_bitmap_bit_range_write_cb)(
    int unit, uint32 port_idx_0, uint32 sw_state_bmp_first, uint32 input_bmp_first, uint32 _range, SHR_BITDCL *input_bmp);

/**
 * implemented by: dnx_algo_flexe_core_db_port_demux_lphy_bitmap_bit_range_and
 */
typedef int (*dnx_algo_flexe_core_db_port_demux_lphy_bitmap_bit_range_and_cb)(
    int unit, uint32 port_idx_0, uint32 _first, uint32 _count, SHR_BITDCL *input_bmp);

/**
 * implemented by: dnx_algo_flexe_core_db_port_demux_lphy_bitmap_bit_range_or
 */
typedef int (*dnx_algo_flexe_core_db_port_demux_lphy_bitmap_bit_range_or_cb)(
    int unit, uint32 port_idx_0, uint32 _first, uint32 _count, SHR_BITDCL *input_bmp);

/**
 * implemented by: dnx_algo_flexe_core_db_port_demux_lphy_bitmap_bit_range_xor
 */
typedef int (*dnx_algo_flexe_core_db_port_demux_lphy_bitmap_bit_range_xor_cb)(
    int unit, uint32 port_idx_0, uint32 _first, uint32 _count, SHR_BITDCL *input_bmp);

/**
 * implemented by: dnx_algo_flexe_core_db_port_demux_lphy_bitmap_bit_range_remove
 */
typedef int (*dnx_algo_flexe_core_db_port_demux_lphy_bitmap_bit_range_remove_cb)(
    int unit, uint32 port_idx_0, uint32 _first, uint32 _count, SHR_BITDCL *input_bmp);

/**
 * implemented by: dnx_algo_flexe_core_db_port_demux_lphy_bitmap_bit_range_negate
 */
typedef int (*dnx_algo_flexe_core_db_port_demux_lphy_bitmap_bit_range_negate_cb)(
    int unit, uint32 port_idx_0, uint32 _first, uint32 _count);

/**
 * implemented by: dnx_algo_flexe_core_db_port_demux_lphy_bitmap_bit_range_clear
 */
typedef int (*dnx_algo_flexe_core_db_port_demux_lphy_bitmap_bit_range_clear_cb)(
    int unit, uint32 port_idx_0, uint32 _first, uint32 _count);

/**
 * implemented by: dnx_algo_flexe_core_db_port_demux_lphy_bitmap_bit_range_set
 */
typedef int (*dnx_algo_flexe_core_db_port_demux_lphy_bitmap_bit_range_set_cb)(
    int unit, uint32 port_idx_0, uint32 _first, uint32 _count);

/**
 * implemented by: dnx_algo_flexe_core_db_port_demux_lphy_bitmap_bit_range_null
 */
typedef int (*dnx_algo_flexe_core_db_port_demux_lphy_bitmap_bit_range_null_cb)(
    int unit, uint32 port_idx_0, uint32 _first, uint32 _count, uint8 *result);

/**
 * implemented by: dnx_algo_flexe_core_db_port_demux_lphy_bitmap_bit_range_test
 */
typedef int (*dnx_algo_flexe_core_db_port_demux_lphy_bitmap_bit_range_test_cb)(
    int unit, uint32 port_idx_0, uint32 _first, uint32 _count, uint8 *result);

/**
 * implemented by: dnx_algo_flexe_core_db_port_demux_lphy_bitmap_bit_range_eq
 */
typedef int (*dnx_algo_flexe_core_db_port_demux_lphy_bitmap_bit_range_eq_cb)(
    int unit, uint32 port_idx_0, SHR_BITDCL *input_bmp, uint32 _first, uint32 _count, uint8 *result);

/**
 * implemented by: dnx_algo_flexe_core_db_port_demux_lphy_bitmap_bit_range_count
 */
...
/**
 * This structure holds the access functions for the variable mux_lphy
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable demux_lphy
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable mux_lphy_bitmap
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable demux_lphy_bitmap
 */
typedef struct {
...
typedef struct {
    ...
    /**
     * Access struct for mux_lphy_bitmap
     */
    dnx_algo_flexe_core_db_port_mux_lphy_bitmap_cbs mux_lphy_bitmap;
    /**
     * Access struct for demux_lphy_bitmap
     */
