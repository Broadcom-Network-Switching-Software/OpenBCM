...
typedef int (*dnx_sec_db_ingress_sec_flow_res_mngr_free_single_cb)(
    int unit, uint32 flow_res_mngr_idx_0, int element, void *extra_arguments);
...
typedef int (*dnx_sec_db_ingress_sec_flow_res_mngr_free_several_cb)(
    int unit, uint32 flow_res_mngr_idx_0, uint32 nof_elements, int element, void *extra_arguments);
...
typedef int (*dnx_sec_db_ingress_sec_policy_res_mngr_free_single_cb)(
    int unit, uint32 policy_res_mngr_idx_0, int element, void *extra_arguments);
...
typedef int (*dnx_sec_db_ingress_sec_policy_res_mngr_free_several_cb)(
    int unit, uint32 policy_res_mngr_idx_0, uint32 nof_elements, int element, void *extra_arguments);
...
typedef int (*dnx_sec_db_ingress_sec_sc_res_mngr_free_single_cb)(
    int unit, uint32 sc_res_mngr_idx_0, int element, void *extra_arguments);
...
typedef int (*dnx_sec_db_ingress_sec_sc_res_mngr_free_several_cb)(
    int unit, uint32 sc_res_mngr_idx_0, uint32 nof_elements, int element, void *extra_arguments);
...
typedef int (*dnx_sec_db_ingress_sec_sc_tcam_res_mngr_free_single_cb)(
    int unit, uint32 sc_tcam_res_mngr_idx_0, int element, void *extra_arguments);
...
typedef int (*dnx_sec_db_ingress_sec_sc_tcam_res_mngr_free_several_cb)(
    int unit, uint32 sc_tcam_res_mngr_idx_0, uint32 nof_elements, int element, void *extra_arguments);
...
typedef int (*dnx_sec_db_ingress_sec_sa_res_mngr_free_single_cb)(
    int unit, uint32 sa_res_mngr_idx_0, int element, void *extra_arguments);
...
typedef int (*dnx_sec_db_ingress_sec_sa_res_mngr_free_several_cb)(
    int unit, uint32 sa_res_mngr_idx_0, uint32 nof_elements, int element, void *extra_arguments);
...
/**
 * implemented by: dnx_sec_db_control_sec_power_down_info_alloc
 */
typedef int (*dnx_sec_db_control_sec_power_down_info_alloc_cb)(
    int unit);

/**
 * implemented by: dnx_sec_db_control_sec_power_down_info_is_powered_down_set
 */
typedef int (*dnx_sec_db_control_sec_power_down_info_is_powered_down_set_cb)(
    int unit, uint32 power_down_info_idx_0, uint32 is_powered_down_idx_0, int is_powered_down);

/**
 * implemented by: dnx_sec_db_control_sec_power_down_info_is_powered_down_get
 */
typedef int (*dnx_sec_db_control_sec_power_down_info_is_powered_down_get_cb)(
    int unit, uint32 power_down_info_idx_0, uint32 is_powered_down_idx_0, int *is_powered_down);

/**
 * implemented by: dnx_sec_db_control_sec_power_down_info_is_powered_down_alloc
 */
typedef int (*dnx_sec_db_control_sec_power_down_info_is_powered_down_alloc_cb)(
    int unit, uint32 power_down_info_idx_0, uint32 nof_instances_to_alloc_0);

/**
 * implemented by: dnx_sec_db_control_sec_power_down_info_is_forced_power_up_state_set
 */
typedef int (*dnx_sec_db_control_sec_power_down_info_is_forced_power_up_state_set_cb)(
    int unit, uint32 power_down_info_idx_0, int is_forced_power_up_state);

/**
 * implemented by: dnx_sec_db_control_sec_power_down_info_is_forced_power_up_state_get
 */
typedef int (*dnx_sec_db_control_sec_power_down_info_is_forced_power_up_state_get_cb)(
    int unit, uint32 power_down_info_idx_0, int *is_forced_power_up_state);

/**
 * implemented by: dnx_sec_db_control_sec_port_state_info_alloc
 */
typedef int (*dnx_sec_db_control_sec_port_state_info_alloc_cb)(
    int unit);

/**
 * implemented by: dnx_sec_db_control_sec_port_state_info_is_macsec_enabled_set
 */
typedef int (*dnx_sec_db_control_sec_port_state_info_is_macsec_enabled_set_cb)(
    int unit, uint32 port_state_info_idx_0, uint32 port_state_info_idx_1, int is_macsec_enabled);

/**
 * implemented by: dnx_sec_db_control_sec_port_state_info_is_macsec_enabled_get
 */
typedef int (*dnx_sec_db_control_sec_port_state_info_is_macsec_enabled_get_cb)(
    int unit, uint32 port_state_info_idx_0, uint32 port_state_info_idx_1, int *is_macsec_enabled);

/**
 * implemented by: dnx_sec_db_stat_sec_stat_info_alloc
 */
typedef int (*dnx_sec_db_stat_sec_stat_info_alloc_cb)(
    int unit, uint32 nof_instances_to_alloc_0, uint32 nof_instances_to_alloc_1);

/**
 * implemented by: dnx_sec_db_stat_sec_stat_info_value_info_set
 */
typedef int (*dnx_sec_db_stat_sec_stat_info_value_info_set_cb)(
    int unit, uint32 stat_info_idx_0, uint32 stat_info_idx_1, uint32 value_info_idx_0, uint64 value_info);

/**
 * implemented by: dnx_sec_db_stat_sec_stat_info_value_info_get
 */
typedef int (*dnx_sec_db_stat_sec_stat_info_value_info_get_cb)(
    int unit, uint32 stat_info_idx_0, uint32 stat_info_idx_1, uint32 value_info_idx_0, uint64 *value_info);

/**
 * implemented by: dnx_sec_db_stat_sec_stat_info_value_info_alloc
 */
typedef int (*dnx_sec_db_stat_sec_stat_info_value_info_alloc_cb)(
    int unit, uint32 stat_info_idx_0, uint32 stat_info_idx_1, uint32 nof_instances_to_alloc_0);

/**
 * implemented by: dnx_sec_db_wrapper_sec_wrapper_info_alloc
 */
typedef int (*dnx_sec_db_wrapper_sec_wrapper_info_alloc_cb)(
    int unit);

/**
 * implemented by: dnx_sec_db_wrapper_sec_wrapper_info_subscribed_speed_set
 */
typedef int (*dnx_sec_db_wrapper_sec_wrapper_info_subscribed_speed_set_cb)(
    int unit, uint32 wrapper_info_idx_0, int subscribed_speed);

/**
 * implemented by: dnx_sec_db_wrapper_sec_wrapper_info_subscribed_speed_get
 */
typedef int (*dnx_sec_db_wrapper_sec_wrapper_info_subscribed_speed_get_cb)(
    int unit, uint32 wrapper_info_idx_0, int *subscribed_speed);

/**
 * implemented by: dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_set
 */
typedef int (*dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_set_cb)(
    int unit, uint32 wrapper_info_idx_0, dnx_algo_res_t sec_port_res_mngr);

/**
 * implemented by: dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_get
 */
typedef int (*dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_get_cb)(
    int unit, uint32 wrapper_info_idx_0, dnx_algo_res_t *sec_port_res_mngr);

/**
 * implemented by: dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_create
 */
typedef int (*dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_create_cb)(
    int unit, uint32 wrapper_info_idx_0, dnx_algo_res_create_data_t * data, void *extra_arguments);

/**
 * implemented by: dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_allocate_single
 */
typedef int (*dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_allocate_single_cb)(
    int unit, uint32 wrapper_info_idx_0, uint32 flags, void *extra_arguments, int *element);

/**
 * implemented by: dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_allocate_several
 */
typedef int (*dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_allocate_several_cb)(
    int unit, uint32 wrapper_info_idx_0, uint32 flags, uint32 nof_elements, void *extra_arguments, int *element);

/**
 * implemented by: dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_free_single
 */
typedef int (*dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_free_single_cb)(
    int unit, uint32 wrapper_info_idx_0, int element, void *extra_arguments);

/**
 * implemented by: dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_free_several
 */
typedef int (*dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_free_several_cb)(
    int unit, uint32 wrapper_info_idx_0, uint32 nof_elements, int element, void *extra_arguments);

/**
 * implemented by: dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_is_allocated
 */
typedef int (*dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_is_allocated_cb)(
    int unit, uint32 wrapper_info_idx_0, int element, uint8 *is_allocated);

/**
 * implemented by: dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_clear
 */
typedef int (*dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_clear_cb)(
    int unit, uint32 wrapper_info_idx_0);

/**
 * implemented by: dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_nof_free_elements_get
 */
typedef int (*dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_nof_free_elements_get_cb)(
    int unit, uint32 wrapper_info_idx_0, int *nof_free_elements);

/**
 * implemented by: dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_get_next
 */
typedef int (*dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_get_next_cb)(
    int unit, uint32 wrapper_info_idx_0, int *element);

/**
 * implemented by: dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_dump_info_get
 */
typedef int (*dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_dump_info_get_cb)(
    int unit, uint32 wrapper_info_idx_0, dnx_algo_res_dump_data_t * info);

/**
 * implemented by: dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_nof_allocated_elements_in_range_get
 */
typedef int (*dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_nof_allocated_elements_in_range_get_cb)(
    int unit, uint32 wrapper_info_idx_0, int range_start, int nof_elements_in_range, int *nof_allocated_elements);

/**
 * implemented by: dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_advanced_algorithm_info_set
 */
typedef int (*dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_advanced_algorithm_info_set_cb)(
    int unit, uint32 wrapper_info_idx_0, void *algorithm_info);

/**
 * implemented by: dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_advanced_algorithm_info_get
 */
typedef int (*dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_advanced_algorithm_info_get_cb)(
    int unit, uint32 wrapper_info_idx_0, void *algorithm_info);

/**
 * implemented by: dnx_sec_db_wrapper_sec_wrapper_info_active_calendar_set
 */
typedef int (*dnx_sec_db_wrapper_sec_wrapper_info_active_calendar_set_cb)(
    int unit, uint32 wrapper_info_idx_0, int active_calendar);

/**
 * implemented by: dnx_sec_db_wrapper_sec_wrapper_info_active_calendar_get
 */
typedef int (*dnx_sec_db_wrapper_sec_wrapper_info_active_calendar_get_cb)(
    int unit, uint32 wrapper_info_idx_0, int *active_calendar);

/**
 * implemented by: dnx_sec_db_wrapper_sec_nif_port_info_alloc
 */
typedef int (*dnx_sec_db_wrapper_sec_nif_port_info_alloc_cb)(
    int unit);

/**
 * implemented by: dnx_sec_db_wrapper_sec_nif_port_info_sec_port_set
 */
typedef int (*dnx_sec_db_wrapper_sec_nif_port_info_sec_port_set_cb)(
    int unit, uint32 nif_port_info_idx_0, int sec_port);

/**
 * implemented by: dnx_sec_db_wrapper_sec_nif_port_info_sec_port_get
 */
typedef int (*dnx_sec_db_wrapper_sec_nif_port_info_sec_port_get_cb)(
    int unit, uint32 nif_port_info_idx_0, int *sec_port);

/**
 * implemented by: dnx_sec_db_wrapper_sec_nif_port_info_wrapper_id_set
 */
typedef int (*dnx_sec_db_wrapper_sec_nif_port_info_wrapper_id_set_cb)(
    int unit, uint32 nif_port_info_idx_0, int wrapper_id);

/**
 * implemented by: dnx_sec_db_wrapper_sec_nif_port_info_wrapper_id_get
 */
typedef int (*dnx_sec_db_wrapper_sec_nif_port_info_wrapper_id_get_cb)(
    int unit, uint32 nif_port_info_idx_0, int *wrapper_id);

/**
 * implemented by: dnx_sec_db_wrapper_sec_nif_port_info_is_bypass_set
 */
typedef int (*dnx_sec_db_wrapper_sec_nif_port_info_is_bypass_set_cb)(
    int unit, uint32 nif_port_info_idx_0, int is_bypass);

/**
 * implemented by: dnx_sec_db_wrapper_sec_nif_port_info_is_bypass_get
 */
typedef int (*dnx_sec_db_wrapper_sec_nif_port_info_is_bypass_get_cb)(
    int unit, uint32 nif_port_info_idx_0, int *is_bypass);

/**
 * implemented by: dnx_sec_db_wrapper_sec_nif_port_info_is_macsec_requested_set
 */
typedef int (*dnx_sec_db_wrapper_sec_nif_port_info_is_macsec_requested_set_cb)(
    int unit, uint32 nif_port_info_idx_0, int is_macsec_requested);

/**
 * implemented by: dnx_sec_db_wrapper_sec_nif_port_info_is_macsec_requested_get
 */
typedef int (*dnx_sec_db_wrapper_sec_nif_port_info_is_macsec_requested_get_cb)(
    int unit, uint32 nif_port_info_idx_0, int *is_macsec_requested);
...
/**
 * This structure holds the access functions for the variable is_powered_down
 */
typedef struct {
    dnx_sec_db_control_sec_power_down_info_is_powered_down_set_cb set;
    dnx_sec_db_control_sec_power_down_info_is_powered_down_get_cb get;
    dnx_sec_db_control_sec_power_down_info_is_powered_down_alloc_cb alloc;
} dnx_sec_db_control_sec_power_down_info_is_powered_down_cbs;

/**
 * This structure holds the access functions for the variable is_forced_power_up_state
 */
typedef struct {
    dnx_sec_db_control_sec_power_down_info_is_forced_power_up_state_set_cb set;
    dnx_sec_db_control_sec_power_down_info_is_forced_power_up_state_get_cb get;
} dnx_sec_db_control_sec_power_down_info_is_forced_power_up_state_cbs;

/**
 * This structure holds the access functions for the variable dnx_control_powr_down_info_t
 */
typedef struct {
    dnx_sec_db_control_sec_power_down_info_alloc_cb alloc;
    /**
     * Access struct for is_powered_down
     */
    dnx_sec_db_control_sec_power_down_info_is_powered_down_cbs is_powered_down;
    /**
     * Access struct for is_forced_power_up_state
     */
    dnx_sec_db_control_sec_power_down_info_is_forced_power_up_state_cbs is_forced_power_up_state;
} dnx_sec_db_control_sec_power_down_info_cbs;

/**
 * This structure holds the access functions for the variable is_macsec_enabled
 */
typedef struct {
    dnx_sec_db_control_sec_port_state_info_is_macsec_enabled_set_cb set;
    dnx_sec_db_control_sec_port_state_info_is_macsec_enabled_get_cb get;
} dnx_sec_db_control_sec_port_state_info_is_macsec_enabled_cbs;

/**
 * This structure holds the access functions for the variable dnx_control_port_state_info_t
 */
typedef struct {
    dnx_sec_db_control_sec_port_state_info_alloc_cb alloc;
    /**
     * Access struct for is_macsec_enabled
     */
    dnx_sec_db_control_sec_port_state_info_is_macsec_enabled_cbs is_macsec_enabled;
} dnx_sec_db_control_sec_port_state_info_cbs;
...
typedef struct {
    ...
    /**
     * Access struct for power_down_info
     */
    dnx_sec_db_control_sec_power_down_info_cbs power_down_info;
    /**
     * Access struct for port_state_info
     */
    dnx_sec_db_control_sec_port_state_info_cbs port_state_info;
} dnx_sec_db_control_sec_cbs;

/**
 * This structure holds the access functions for the variable value_info
 */
typedef struct {
    dnx_sec_db_stat_sec_stat_info_value_info_set_cb set;
    dnx_sec_db_stat_sec_stat_info_value_info_get_cb get;
    dnx_sec_db_stat_sec_stat_info_value_info_alloc_cb alloc;
} dnx_sec_db_stat_sec_stat_info_value_info_cbs;

/**
 * This structure holds the access functions for the variable dnx_stat_sec_info_t
 */
typedef struct {
    dnx_sec_db_stat_sec_stat_info_alloc_cb alloc;
    /**
     * Access struct for value_info
     */
    dnx_sec_db_stat_sec_stat_info_value_info_cbs value_info;
} dnx_sec_db_stat_sec_stat_info_cbs;

/**
 * This structure holds the access functions for the variable dnx_stat_sec_t
 */
typedef struct {
    /**
     * Access struct for stat_info
     */
    dnx_sec_db_stat_sec_stat_info_cbs stat_info;
} dnx_sec_db_stat_sec_cbs;

/**
 * This structure holds the access functions for the variable subscribed_speed
 */
typedef struct {
    dnx_sec_db_wrapper_sec_wrapper_info_subscribed_speed_set_cb set;
    dnx_sec_db_wrapper_sec_wrapper_info_subscribed_speed_get_cb get;
} dnx_sec_db_wrapper_sec_wrapper_info_subscribed_speed_cbs;

/**
 * This structure holds the access functions for the variable sec_port_res_mngr
 */
typedef struct {
    dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_set_cb set;
    dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_get_cb get;
    dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_create_cb create;
    dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_allocate_single_cb allocate_single;
    dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_allocate_several_cb allocate_several;
    dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_free_single_cb free_single;
    dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_free_several_cb free_several;
    dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_is_allocated_cb is_allocated;
    dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_clear_cb clear;
    dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_nof_free_elements_get_cb nof_free_elements_get;
    dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_get_next_cb get_next;
    dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_dump_info_get_cb dump_info_get;
    dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_nof_allocated_elements_in_range_get_cb nof_allocated_elements_in_range_get;
    dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_advanced_algorithm_info_set_cb advanced_algorithm_info_set;
    dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_advanced_algorithm_info_get_cb advanced_algorithm_info_get;
} dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_cbs;

/**
 * This structure holds the access functions for the variable active_calendar
 */
typedef struct {
    dnx_sec_db_wrapper_sec_wrapper_info_active_calendar_set_cb set;
    dnx_sec_db_wrapper_sec_wrapper_info_active_calendar_get_cb get;
} dnx_sec_db_wrapper_sec_wrapper_info_active_calendar_cbs;

/**
 * This structure holds the access functions for the variable dnx_wrapper_wrapper_info_t
 */
typedef struct {
    dnx_sec_db_wrapper_sec_wrapper_info_alloc_cb alloc;
    /**
     * Access struct for subscribed_speed
     */
    dnx_sec_db_wrapper_sec_wrapper_info_subscribed_speed_cbs subscribed_speed;
    /**
     * Access struct for sec_port_res_mngr
     */
    dnx_sec_db_wrapper_sec_wrapper_info_sec_port_res_mngr_cbs sec_port_res_mngr;
    /**
     * Access struct for active_calendar
     */
    dnx_sec_db_wrapper_sec_wrapper_info_active_calendar_cbs active_calendar;
} dnx_sec_db_wrapper_sec_wrapper_info_cbs;

/**
 * This structure holds the access functions for the variable sec_port
 */
typedef struct {
    dnx_sec_db_wrapper_sec_nif_port_info_sec_port_set_cb set;
    dnx_sec_db_wrapper_sec_nif_port_info_sec_port_get_cb get;
} dnx_sec_db_wrapper_sec_nif_port_info_sec_port_cbs;

/**
 * This structure holds the access functions for the variable wrapper_id
 */
typedef struct {
    dnx_sec_db_wrapper_sec_nif_port_info_wrapper_id_set_cb set;
    dnx_sec_db_wrapper_sec_nif_port_info_wrapper_id_get_cb get;
} dnx_sec_db_wrapper_sec_nif_port_info_wrapper_id_cbs;

/**
 * This structure holds the access functions for the variable is_bypass
 */
typedef struct {
    dnx_sec_db_wrapper_sec_nif_port_info_is_bypass_set_cb set;
    dnx_sec_db_wrapper_sec_nif_port_info_is_bypass_get_cb get;
} dnx_sec_db_wrapper_sec_nif_port_info_is_bypass_cbs;

/**
 * This structure holds the access functions for the variable is_macsec_requested
 */
typedef struct {
    dnx_sec_db_wrapper_sec_nif_port_info_is_macsec_requested_set_cb set;
    dnx_sec_db_wrapper_sec_nif_port_info_is_macsec_requested_get_cb get;
} dnx_sec_db_wrapper_sec_nif_port_info_is_macsec_requested_cbs;

/**
 * This structure holds the access functions for the variable dnx_wrapper_nif_port_info_t
 */
typedef struct {
    dnx_sec_db_wrapper_sec_nif_port_info_alloc_cb alloc;
    /**
     * Access struct for sec_port
     */
    dnx_sec_db_wrapper_sec_nif_port_info_sec_port_cbs sec_port;
    /**
     * Access struct for wrapper_id
     */
    dnx_sec_db_wrapper_sec_nif_port_info_wrapper_id_cbs wrapper_id;
    /**
     * Access struct for is_bypass
     */
    dnx_sec_db_wrapper_sec_nif_port_info_is_bypass_cbs is_bypass;
    /**
     * Access struct for is_macsec_requested
     */
    dnx_sec_db_wrapper_sec_nif_port_info_is_macsec_requested_cbs is_macsec_requested;
} dnx_sec_db_wrapper_sec_nif_port_info_cbs;

/**
 * This structure holds the access functions for the variable dnx_wrapper_sec_t
 */
typedef struct {
    /**
     * Access struct for wrapper_info
     */
    dnx_sec_db_wrapper_sec_wrapper_info_cbs wrapper_info;
    /**
     * Access struct for nif_port_info
     */
    dnx_sec_db_wrapper_sec_nif_port_info_cbs nif_port_info;
} dnx_sec_db_wrapper_sec_cbs;
...
typedef struct {
    ...
    /**
     * Access struct for stat_sec
     */
    dnx_sec_db_stat_sec_cbs stat_sec;
    /**
     * Access struct for wrapper_sec
     */
    dnx_sec_db_wrapper_sec_cbs wrapper_sec;
} dnx_sec_db_cbs;
