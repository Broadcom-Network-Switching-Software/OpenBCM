...
/**
 * implemented by: algo_rx_db_trap_lif_etpp_profile_data_get
 */
typedef int (*algo_rx_db_trap_lif_etpp_profile_data_get_cb)(
    int unit, int profile, int *ref_count, bcm_gport_t *profile_data);

/**
 * implemented by: algo_rx_db_trap_lif_etpp_profile_get
 */
typedef int (*algo_rx_db_trap_lif_etpp_profile_get_cb)(
    int unit, const bcm_gport_t *profile_data, int *profile);

/**
 * implemented by: algo_rx_db_trap_mtu_set
 */
typedef int (*algo_rx_db_trap_mtu_set_cb)(
    int unit, dnx_algo_template_t trap_mtu);

/**
 * implemented by: algo_rx_db_trap_mtu_get
 */
typedef int (*algo_rx_db_trap_mtu_get_cb)(
    int unit, dnx_algo_template_t *trap_mtu);

/**
 * implemented by: algo_rx_db_trap_mtu_create
 */
typedef int (*algo_rx_db_trap_mtu_create_cb)(
    int unit, dnx_algo_template_create_data_t * data, void *extra_arguments);

/**
 * implemented by: algo_rx_db_trap_mtu_exchange
 */
typedef int (*algo_rx_db_trap_mtu_exchange_cb)(
    int unit, uint32 flags, const bcm_gport_t *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference);

/**
 * implemented by: algo_rx_db_trap_mtu_profile_data_get
 */
typedef int (*algo_rx_db_trap_mtu_profile_data_get_cb)(
    int unit, int profile, int *ref_count, bcm_gport_t *profile_data);

/**
 * implemented by: algo_rx_db_trap_mtu_profile_get
 */
...
/**
 * This structure holds the access functions for the variable trap_mtu
 */
typedef struct {
