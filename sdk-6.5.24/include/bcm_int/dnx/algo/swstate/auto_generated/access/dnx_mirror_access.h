...
typedef int (*dnx_mirror_db_mirror_on_drop_profile_set_cb)(
    int unit, uint32 mirror_on_drop_profile_idx_0, uint32 mirror_on_drop_profile_idx_1, int mirror_on_drop_profile);
...
typedef int (*dnx_mirror_db_mirror_on_drop_profile_alloc_cb)(
    int unit, uint32 mirror_on_drop_profile_idx_0);
