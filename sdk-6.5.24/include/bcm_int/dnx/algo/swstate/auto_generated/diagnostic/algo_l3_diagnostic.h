...
int algo_l3_db_fec_db_info_fecz_dump(
    int unit, int fecz_idx_0, dnx_sw_state_dump_filters_t filters);

int algo_l3_db_fec_db_info_fecz_hierarchy_dump(
    int unit, int fecz_idx_0, dnx_sw_state_dump_filters_t filters);

int algo_l3_db_fec_db_info_fecz_direction_dump(
    int unit, int fecz_idx_0, dnx_sw_state_dump_filters_t filters);
