...
/* imb_nbu_create_info_t initialization and validation */
int imb_nbu_create_info_t_validate(
    int unit,
    const imb_nbu_create_info_t * imb_nbu_create_info);
int imb_nbu_create_info_t_init(
    int unit,
...
/* imb_mgu_create_info_t initialization and validation */
int imb_mgu_create_info_t_validate(
    int unit,
    const imb_mgu_create_info_t * imb_mgu_create_info);
int imb_mgu_create_info_t_init(
    int unit,
 ...
 *
 * @brief Get the per IMB configuration for instrumentation counters 
 *
 * @param [in]  unit            - unit id
 * @param [in]  imb_id          - imb instance id
 ...
 */
int imb_instru_sunced_counters_config_get(
    int unit,
    int imb_id,
    uint8 *nof_intervals,
    uint8 *is_continuous);
 ...
 *
 * @param [in]  unit            - Unit ID
 * @param [in]  bring_back_up   - If TRUE, enable counters after reset
 */
