...
typedef struct
{
     ...
     */
    const dnx_field_meta_qual_info_t *meta_qual_info;
    /**
...
#define DNX_FIELD_STAGE_ACTION_ITERATOR(stage, field_map_stage_info)                    \
        for(stage = DNX_FIELD_STAGE_FIRST; stage < DNX_FIELD_STAGE_NOF; stage++)        \
            if(dnx_field_map_stage_info_get_dispatch(unit, stage, &field_map_stage_info) == _SHR_E_NONE && field_map_stage_info.static_action_id_map != NULL)
...
shr_error_e dnx_field_map_qual_description_get_dispatch(
    int unit,
    bcm_field_qualify_t bcm_qual,
 ...
 * \param [out] action_map_entry_p - action map entry should be returned
...
/**
* \brief
* Get field map static action info per stage
*
* \param [in] unit              - Device id
* \param [in] stage             - Stage id
* \param [in] bcm_action        - BCM action
* \param [out] static_action_info_p - Pointer to field map action info.
*\return
*   shr_error_e - Error Type
*\see
*   bcm_error_e
*/
shr_error_e dnx_field_map_static_action_map_get_dispatch(
    int unit,
    dnx_field_stage_e stage,
    bcm_field_action_t bcm_action,
...
*   bcm_error_e
*/
shr_error_e dnx_field_map_meta_qual_info_get_dispatch(
    int unit,
    dnx_field_stage_e stage,
...
* \param [in] unit                  - Device id
* \param [in] stage                 - Stage id
* \param [in] action_id             - DBAL action
* \param [out] static_action_info_p - Pointer to field map action info.
*\return
*   shr_error_e - Error Type
*\see
*   bcm_error_e
*/
shr_error_e dnx_field_map_static_action_info_get_dispatch(
    int unit,
    dnx_field_stage_e stage,
...
/**
* \brief
* Get field map context param
*
* \param [in] unit              - Device id
* \param [in] param_type        - Param type
* \param [in] stage             - Stage id
* \param [out] context_param_p  - Pointer to context param info.
*\return
*   shr_error_e - Error Type
*\see
*   bcm_error_e
*/
shr_error_e dnx_field_context_param_info_get_dispatch(
    int unit,
...
* \param [in] stage                 - Stage id
* \param [out] range_map_legacy_p   - Pointer to range map legacy.
*\return
*   shr_error_e - Error Type
*\see
*   bcm_error_e
*/
shr_error_e dnx_field_range_map_legacy_get_dispatch(
    int unit,
...
/**
* \brief
* Get field map input type info
*
* \param [in] unit                - Device id
* \param [in] input_type          - Input type
* \param [out] input_type_info_p  - Pointer to input type info.
*\return
*   shr_error_e - Error Type
*\see
*   bcm_error_e
*/
shr_error_e dnx_field_map_input_type_info_get_dispatch(
    int unit,
    dnx_field_input_type_e input_type,
...
*
* \param [in] unit               - Device id
* \param [in] bcm_action          - Action id
* \param [out] is_empty          - TRue if action doesnt have description
*\return
*   shr_error_e - Error Type
*\see
*   bcm_error_e
*/
shr_error_e dnx_field_action_description_is_empty_dispatch(
    int unit,
    bcm_field_action_t bcm_action,
    uint8 *is_empty);
...
/**
* \brief
*  If qualifier has description
*
* \param [in] unit               - Device id
* \param [in] bcm_qual          -  Qualify id
* \param [out] is_empty          - TRue if qual doesnt have description
*\return
*   shr_error_e - Error Type
*\see
*   bcm_error_e
*/
shr_error_e dnx_field_qual_description_is_empty_dispatch(
    int unit,
    bcm_field_qualify_t bcm_qual,
    uint8 *is_empty);
/**
