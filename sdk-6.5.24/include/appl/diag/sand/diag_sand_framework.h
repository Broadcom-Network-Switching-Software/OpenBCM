 ...
 */
#define CTEST_PRECOMMIT                          PRIME_FLAG_0
/**
 ...
 */
#define CTEST_POSTCOMMIT                         PRIME_FLAG_1
/**
 ...
 */
#define SH_CMD_SKIP_EXEC                         PRIME_FLAG_4
/**
 ...
 */
#define SH_CMD_LOG                               PRIME_FLAG_5
/**
 ...
 */
#define SH_CMD_SKIP_ROOT                         PRIME_FLAG_8
/**
 ...
 */
#define SH_CMD_SKIP_MEMORY_CHECK                 PRIME_FLAG_19
/**
 ...
 */
#define CTEST_ALL                                PRIME_FLAG_26
/**
 * Flag used to mark tests and test groups to be skipped if export/list/run command invoked with param skippable
 */
#define CTEST_SKIPPABLE                          PRIME_FLAG_27
/**
 * Flag used to mark tests and test groups as unsupported in cmodel.
 * Will be skipped in cmodel when export is run and included only when run with option 'full'.
 */
#define CTEST_ADAPTER_UNSUPPORTED                 PRIME_FLAG_28
/**
 * Flag used to continue running remaining tests after first failure
 */
#define CTEST_CONT_ON_FAIL                       PRIME_FLAG_29
/**
 * Flag used to mark tests and test groups to be included if export/list command invoked with param verify
 */
#define CTEST_VERIFY                             PRIME_FLAG_30
/**
 * Flag to disable the prefix lookup in sh_sand_cmd_get
 */
#define SH_CMD_NO_PREFIX_NAME_LOOKUP             PRIME_FLAG_31
...
#define SH_SAND_CMD_ITERATOR_COND(sh_sand_cmd_curr, sh_sand_cmd_array, flags)                                          \
        for (sh_sand_cmd_curr = sh_sand_cmd_array;                                                                     \
            ...
            if(!utilex_is_prime_flag_set(sh_sand_cmd_curr->flags, SH_CMD_CONDITIONAL)                        ||        \
                ...
                utilex_is_prime_flag_set(flags, CTEST_ALL) )
