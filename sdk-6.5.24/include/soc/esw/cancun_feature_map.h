...
static cancun_branch_version_map_t cancun_branch_version_map[] = {
    ...
    /* For HX5, B370-HGOE.4.5.0 version of CANCUN
     * is based on B370.4.5.0 version of CANCUN and
     * should have the same soc_feature enables as
     * B770.4.5.0
     */
    {
        SOC_INFO_CHIP_TYPE_HELIX5,
        SOC_CANCUN_FULL_VERSION(CANCUN_FILE_BRANCH_ID_HGoE,4,5,0),
        SOC_CANCUN_FULL_VERSION(CANCUN_FILE_BRANCH_ID_DEF,4,5,0)
    },
