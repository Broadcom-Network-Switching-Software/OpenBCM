...
typedef struct {
    ...
    uint32  src_port_num:7,             /* Source Port Number, PBE field */
            reserved_src_port_num:1,    /* Reserved */
            pkt_length:14,              /* Packet length */
            matched_rule:8,             /* Matched Rule */
    ...
    uint32  hgi:2,                      /* Higig+ module header field */
            ...
            pkt_length:14,              /* Packet length */
            :1,                         /* Reserved */
            src_port_num:7;             /* Source Port Number, PBE field */
    ...
    uint32 rsvd0;                        /* padding to get header to 16 words */
    uint32 rsvd1;                        /* padding to get header to 16 words */
    uint32 rsvd2;                        /* padding to get header to 16 words */
} ep_to_cpu_hdr41_t;
