...
typedef uint32(
    *dnx_data_switch_load_balancing_field_enablers_per_header_valid_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_switch_load_balancing_field_enablers_per_header_valid_get_f field_enablers_per_header_valid_get;
