...
typedef enum
{
    dnx_data_field_external_tcam_define_use_kbp,
...
uint32 dnx_data_field_external_tcam_use_kbp_get(
    int unit);
...
typedef enum
{
    ...
    dnx_data_field_qual_table_special_metadata_qual,
...
const dnx_data_field_qual_special_metadata_qual_t * dnx_data_field_qual_special_metadata_qual_get(
    int unit,
    int stage,
    int qual);
...
shr_error_e dnx_data_field_qual_special_metadata_qual_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
const dnxc_data_table_info_t * dnx_data_field_qual_special_metadata_qual_info_get(
    int unit);
...
typedef enum
{
    dnx_data_field_map_define_supported,
...
uint32 dnx_data_field_map_supported_get(
    int unit);
