...
#endif 
    dnx_data_module_testing_submodule_compileflags_submodule_standard,
#ifdef INCLUDE_XFLOW_MACSEC

    dnx_data_module_testing_submodule_compileflags_submodule_flags,
...
int dnx_data_module_testing_compileflags_submodule_standard_feature_get(
    int unit,
...
typedef enum
{
    ...
    dnx_data_module_testing_compileflags_submodule_standard_define_define_flags,

#endif 
#ifdef INCLUDE_XFLOW_MACSEC

    dnx_data_module_testing_compileflags_submodule_standard_define_numeric_flags,

#endif 

    
    _dnx_data_module_testing_compileflags_submodule_standard_define_nof
} dnx_data_module_testing_compileflags_submodule_standard_define_e;


#ifdef INCLUDE_XFLOW_MACSEC


uint32 dnx_data_module_testing_compileflags_submodule_standard_define_flags_get(
    int unit);
...
uint32 dnx_data_module_testing_compileflags_submodule_standard_numeric_flags_get(
    int unit);
...
typedef enum
{
    ...
    dnx_data_module_testing_compileflags_submodule_standard_table_table_flags,

#endif 

    
    _dnx_data_module_testing_compileflags_submodule_standard_table_nof
} dnx_data_module_testing_compileflags_submodule_standard_table_e;


#ifdef INCLUDE_XFLOW_MACSEC


const dnx_data_module_testing_compileflags_submodule_standard_table_flags_t * dnx_data_module_testing_compileflags_submodule_standard_table_flags_get(
    int unit,
    int table_flags_key);
...
shr_error_e dnx_data_module_testing_compileflags_submodule_standard_table_flags_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
const dnxc_data_table_info_t * dnx_data_module_testing_compileflags_submodule_standard_table_flags_info_get(
    int unit);
...
int dnx_data_module_testing_compileflags_submodule_flags_feature_get(
    int unit,
...
typedef enum
{
    dnx_data_module_testing_compileflags_submodule_flags_define_define_no_flags,
#ifdef BCM_WARM_BOOT_SUPPORT

    dnx_data_module_testing_compileflags_submodule_flags_define_define_flags,

#endif 
    dnx_data_module_testing_compileflags_submodule_flags_define_numeric_no_flags,
#ifdef BCM_WARM_BOOT_SUPPORT

    dnx_data_module_testing_compileflags_submodule_flags_define_numeric_flags,

#endif 

    
    _dnx_data_module_testing_compileflags_submodule_flags_define_nof
} dnx_data_module_testing_compileflags_submodule_flags_define_e;



uint32 dnx_data_module_testing_compileflags_submodule_flags_define_no_flags_get(
    int unit);

#ifdef BCM_WARM_BOOT_SUPPORT


uint32 dnx_data_module_testing_compileflags_submodule_flags_define_flags_get(
    int unit);

#endif 


uint32 dnx_data_module_testing_compileflags_submodule_flags_numeric_no_flags_get(
    int unit);

#ifdef BCM_WARM_BOOT_SUPPORT


uint32 dnx_data_module_testing_compileflags_submodule_flags_numeric_flags_get(
    int unit);
...
typedef enum
{
    dnx_data_module_testing_compileflags_submodule_flags_table_table_no_flags,
#ifdef BCM_WARM_BOOT_SUPPORT

    dnx_data_module_testing_compileflags_submodule_flags_table_table_flags,

#endif 

    
    _dnx_data_module_testing_compileflags_submodule_flags_table_nof
} dnx_data_module_testing_compileflags_submodule_flags_table_e;



const dnx_data_module_testing_compileflags_submodule_flags_table_no_flags_t * dnx_data_module_testing_compileflags_submodule_flags_table_no_flags_get(
    int unit,
...
const dnx_data_module_testing_compileflags_submodule_flags_table_flags_t * dnx_data_module_testing_compileflags_submodule_flags_table_flags_get(
    int unit,
    int table_flag_key);
...
shr_error_e dnx_data_module_testing_compileflags_submodule_flags_table_no_flags_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
shr_error_e dnx_data_module_testing_compileflags_submodule_flags_table_flags_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
const dnxc_data_table_info_t * dnx_data_module_testing_compileflags_submodule_flags_table_no_flags_info_get(
    int unit);

#ifdef BCM_WARM_BOOT_SUPPORT


const dnxc_data_table_info_t * dnx_data_module_testing_compileflags_submodule_flags_table_flags_info_get(
    int unit);
