...
typedef uint32(
    *dnx_data_field_external_tcam_use_kbp_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_field_external_tcam_use_kbp_get_f use_kbp_get;
...
} dnx_data_field_qual_special_metadata_qual_t;
...
typedef const dnx_data_field_qual_special_metadata_qual_t *(
    *dnx_data_field_qual_special_metadata_qual_get_f) (
    int unit,
    int stage,
    int qual);
...
typedef struct
{
    ...
    dnx_data_field_qual_special_metadata_qual_get_f special_metadata_qual_get;
...
typedef uint32(
    *dnx_data_field_features_tcam_cs_inlif_profile_supported_get_f) (
    int unit);
...
typedef uint32(
    *dnx_data_field_features_result_signal_exists_get_f) (
    int unit);


typedef uint32(
    *dnx_data_field_features_apptype_based_on_fwd2_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_field_features_tcam_cs_inlif_profile_supported_get_f tcam_cs_inlif_profile_supported_get;
    ...
    dnx_data_field_features_result_signal_exists_get_f result_signal_exists_get;
    
    dnx_data_field_features_apptype_based_on_fwd2_get_f apptype_based_on_fwd2_get;
