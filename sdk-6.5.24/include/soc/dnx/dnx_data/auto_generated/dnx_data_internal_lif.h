...
typedef enum
{
    ...
    dnx_data_lif_global_lif_define_rif_not_in_glem,
    ...
    dnx_data_lif_global_lif_define_mpls_data_table_skip_phase_check,
...
uint32 dnx_data_lif_global_lif_rif_not_in_glem_get(
    int unit);
...
uint32 dnx_data_lif_global_lif_mpls_data_table_skip_phase_check_get(
    int unit);
