...
typedef enum
{
    ...
    dnx_data_esb_general_define_nof_eth_tdm_queues,
    ...
    dnx_data_esb_general_define_ilkn_tdm_queue_id_base,
    dnx_data_esb_general_define_eth_tdm_queue_id_base,
...
uint32 dnx_data_esb_general_nof_eth_tdm_queues_get(
    int unit);
...
uint32 dnx_data_esb_general_ilkn_tdm_queue_id_base_get(
    int unit);


uint32 dnx_data_esb_general_eth_tdm_queue_id_base_get(
    int unit);
