...
typedef enum
{
    ...
    dnx_data_tdm_params_is_egress_bypass_supported,
    
    dnx_data_tdm_params_is_sid_wide_mode_supported,
    
    dnx_data_tdm_params_egress_bypass_enable,
...
typedef uint32(
    *dnx_data_tdm_params_sid_max_size_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_tdm_params_sid_max_size_get_f sid_max_size_get;
