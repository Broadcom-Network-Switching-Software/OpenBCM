...
typedef enum
{
    ...
    dnx_data_nif_eth_is_ethu_nof_per_core_supported,
...
typedef struct
{
    ...
    int high_level;
} dnx_data_nif_flexe_sar_jitter_fifo_levels_t;
...
typedef uint32(
    *dnx_data_nif_flexe_sar_jitter_tolerance_max_level_get_f) (
    int unit);


typedef uint32(
    *dnx_data_nif_flexe_mac_pad_size_get_f) (
    int unit);
...
typedef const dnx_data_nif_flexe_sar_jitter_fifo_levels_t *(
    *dnx_data_nif_flexe_sar_jitter_fifo_levels_get_f) (
    int unit,
    int tolerance_level);
...
typedef struct
{
    ...
    dnx_data_nif_flexe_sar_jitter_tolerance_max_level_get_f sar_jitter_tolerance_max_level_get;
    
    dnx_data_nif_flexe_mac_pad_size_get_f mac_pad_size_get;
    ...
    dnx_data_nif_flexe_sar_jitter_fifo_levels_get_f sar_jitter_fifo_levels_get;
...
typedef uint32(
    *dnx_data_nif_ofr_nof_context_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_nif_ofr_nof_context_get_f nof_context_get;
