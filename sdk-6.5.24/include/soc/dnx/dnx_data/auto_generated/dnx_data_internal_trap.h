...
typedef enum
{
    ...
    dnx_data_trap_submodule_egress,
...
typedef enum
{
    ...
    dnx_data_trap_etpp_define_first_etpp_user_configurable_profile,
    ...
    dnx_data_trap_etpp_define_nof_mtu_trap_action_profiles,
    dnx_data_trap_etpp_define_nof_mtu_map_table_entries,
...
uint32 dnx_data_trap_etpp_first_etpp_user_configurable_profile_get(
    int unit);
...
uint32 dnx_data_trap_etpp_nof_mtu_trap_action_profiles_get(
    int unit);


uint32 dnx_data_trap_etpp_nof_mtu_map_table_entries_get(
    int unit);
...
int dnx_data_trap_egress_feature_get(
    int unit,
...
typedef enum
{
    ...
    _dnx_data_trap_egress_define_nof
} dnx_data_trap_egress_define_e;
...
typedef enum
{
    ...
    _dnx_data_trap_egress_table_nof
} dnx_data_trap_egress_table_e;
