...
typedef uint32(
    *dnx_data_esb_general_nof_eth_tdm_queues_get_f) (
    int unit);
...
typedef uint32(
    *dnx_data_esb_general_ilkn_tdm_queue_id_base_get_f) (
    int unit);


typedef uint32(
    *dnx_data_esb_general_eth_tdm_queue_id_base_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_esb_general_nof_eth_tdm_queues_get_f nof_eth_tdm_queues_get;
    ...
    dnx_data_esb_general_ilkn_tdm_queue_id_base_get_f ilkn_tdm_queue_id_base_get;
    
    dnx_data_esb_general_eth_tdm_queue_id_base_get_f eth_tdm_queue_id_base_get;
