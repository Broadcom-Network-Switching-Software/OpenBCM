...
typedef uint32(
    *dnx_data_dev_init_ha_warmboot_backoff_rate_get_f) (
    int unit);


typedef uint32(
    *dnx_data_dev_init_ha_nof_guaranteed_reboots_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_dev_init_ha_warmboot_backoff_rate_get_f warmboot_backoff_rate_get;
    
    dnx_data_dev_init_ha_nof_guaranteed_reboots_get_f nof_guaranteed_reboots_get;
