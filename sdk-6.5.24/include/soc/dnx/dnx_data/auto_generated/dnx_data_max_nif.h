...
#define DNX_DATA_MAX_NIF_PRD_NOF_OFR_NIF_INTERFACES (0)
...
#define DNX_DATA_MAX_NIF_ARB_NOF_RX_QPMS (0)


#define DNX_DATA_MAX_NIF_ARB_NOF_RX_PPMS_IN_QPM (0)


#define DNX_DATA_MAX_NIF_ARB_NOF_LANES_IN_QPM (0)


#define DNX_DATA_MAX_NIF_ARB_NOF_MAP_DESTINATIONS (0)


#define DNX_DATA_MAX_NIF_ARB_MAX_CALENDAR_LENGTH (0)


#define DNX_DATA_MAX_NIF_ARB_NOF_RX_SOURCES (0)


#define DNX_DATA_MAX_NIF_ARB_RX_SCH_CALENDAR_NOF_MODES (0)


#define DNX_DATA_MAX_NIF_ARB_RX_QPM_CALENDAR_LENGTH (0)


#define DNX_DATA_MAX_NIF_ARB_RX_SCH_CALENDAR_LENGTH (0)


#define DNX_DATA_MAX_NIF_ARB_CDPM_CALENDAR_LENGTH (0)


#define DNX_DATA_MAX_NIF_ARB_TMAC_CALENDAR_LENGTH (0)


#define DNX_DATA_MAX_NIF_ARB_RX_QPM_CALENDAR_NOF_CLIENTS (0)


#define DNX_DATA_MAX_NIF_ARB_RX_SCH_CALENDAR_NOF_CLIENTS (0)


#define DNX_DATA_MAX_NIF_ARB_RX_QPM_PORT_SPEED_GRANULARITY (0)


#define DNX_DATA_MAX_NIF_ARB_RX_SCH_PORT_SPEED_GRANULARITY (0)


#define DNX_DATA_MAX_NIF_ARB_TX_ETH_PORT_SPEED_GRANULARITY (0)


#define DNX_DATA_MAX_NIF_ARB_TX_TMAC_PORT_SPEED_GRANULARITY (0)


#define DNX_DATA_MAX_NIF_ARB_TX_TMAC_NOF_SECTIONS (0)


#define DNX_DATA_MAX_NIF_ARB_TX_TMAC_LINK_LIST_SPEED_GRANULARITY (0)


#define DNX_DATA_MAX_NIF_ARB_NOF_ENTRIES_IN_MEMORY_ROW_FOR_RX_CALENDAR (0)


#define DNX_DATA_MAX_NIF_ARB_NOF_BIT_PER_ENTRY_IN_RX_CALENDAR (0)


#define DNX_DATA_MAX_NIF_ARB_NOF_ENTRIES_IN_TMAC_CALENDAR (0)


#define DNX_DATA_MAX_NIF_ARB_NOF_BIT_PER_ENTRY_IN_TMAC_CALENDAR (0)


#define DNX_DATA_MAX_NIF_ARB_NOF_BIT_PER_ENTRY_IN_PPM_CALENDAR (0)


#define DNX_DATA_MAX_NIF_ARB_MIN_PORT_SPEED_FOR_LINK_LIST_SECTION (0)


#define DNX_DATA_MAX_NIF_ARB_LINK_LIST_SECTIONS_DENOMINATOR (0)


#define DNX_DATA_MAX_NIF_OFR_NOF_CONTEXT (0)


#define DNX_DATA_MAX_NIF_OFR_NOF_RMC_PER_PRIORITY_GROUP (0)


#define DNX_DATA_MAX_NIF_OFR_NOF_TOTAL_RMCS (0)


#define DNX_DATA_MAX_NIF_OFR_NOF_RX_MEM_SECTIONS_PER_GROUP (0)


#define DNX_DATA_MAX_NIF_OFR_NOF_RX_MEMORY_GROUPS (0)


#define DNX_DATA_MAX_NIF_OFR_NOF_RX_MEMORY_SECTIONS (0)


#define DNX_DATA_MAX_NIF_OFR_NOF_RX_MEMORY_ENTRIES_PER_SECTION (0)


#define DNX_DATA_MAX_NIF_OFR_RX_MEMORY_LINK_LIST_SPEED_GRANULARITY (0)


#define DNX_DATA_MAX_NIF_OFR_RX_SCH_GRANULARITY (0)


#define DNX_DATA_MAX_NIF_OFT_CALENDAR_LENGTH (0)


#define DNX_DATA_MAX_NIF_OFT_NOF_SECTIONS (0)


#define DNX_DATA_MAX_NIF_OFT_NOF_INTERNAL_CALENDAR_ENTRIES (0)


#define DNX_DATA_MAX_NIF_OFT_NOF_BIT_PER_INTERNAL_ENTRY_IN_CALENDAR (0)


#define DNX_DATA_MAX_NIF_OFT_NOF_CONTEXTS (0)


#define DNX_DATA_MAX_NIF_OFT_PORT_SPEED_GRANULARITY (0)
