...
typedef int (*dnx_iqs_db_delete_credit_request_profile_valid_set_cb)(
    int unit, uint32 valid);


typedef int (*dnx_iqs_db_delete_credit_request_profile_valid_get_cb)(
    int unit, uint32 *valid);


typedef int (*dnx_iqs_db_delete_credit_request_profile_id_set_cb)(
    int unit, int id);


typedef int (*dnx_iqs_db_delete_credit_request_profile_id_get_cb)(
    int unit, int *id);
...
typedef struct {
    dnx_iqs_db_delete_credit_request_profile_valid_set_cb set;
    dnx_iqs_db_delete_credit_request_profile_valid_get_cb get;
} dnx_iqs_db_delete_credit_request_profile_valid_cbs;


typedef struct {
    dnx_iqs_db_delete_credit_request_profile_id_set_cb set;
    dnx_iqs_db_delete_credit_request_profile_id_get_cb get;
} dnx_iqs_db_delete_credit_request_profile_id_cbs;


typedef struct {
    
    dnx_iqs_db_delete_credit_request_profile_valid_cbs valid;
    
    dnx_iqs_db_delete_credit_request_profile_id_cbs id;
} dnx_iqs_db_delete_credit_request_profile_cbs;
...
typedef struct {
    ...
    dnx_iqs_db_delete_credit_request_profile_cbs delete_credit_request_profile;
} dnx_iqs_db_cbs;
