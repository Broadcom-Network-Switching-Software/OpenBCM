...
int dnx_port_nif_db_arb_link_list_is_client_allocated_dump(
    int unit, int is_client_allocated_idx_0, dnx_sw_state_dump_filters_t filters);
...
int dnx_port_nif_db_oft_link_list_is_client_allocated_dump(
    int unit, int is_client_allocated_idx_0, dnx_sw_state_dump_filters_t filters);
...
int dnx_port_nif_db_ofr_link_list_is_client_allocated_dump(
    int unit, int is_client_allocated_idx_0, dnx_sw_state_dump_filters_t filters);
