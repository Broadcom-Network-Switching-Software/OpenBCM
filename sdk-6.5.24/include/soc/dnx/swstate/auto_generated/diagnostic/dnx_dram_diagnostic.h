...
int dnx_dram_db_sync_manager_firmware_mutex_dump(
    int unit, dnx_sw_state_dump_filters_t filters);
...
int dnx_dram_db_temperature_monitoring_last_read_dump(
    int unit, int temperature_monitoring_last_read_idx_0, dnx_sw_state_dump_filters_t filters);
