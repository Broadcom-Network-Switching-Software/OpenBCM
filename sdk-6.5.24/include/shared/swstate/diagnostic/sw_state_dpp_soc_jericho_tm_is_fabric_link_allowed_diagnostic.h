...
#ifndef _SHR_SW_STATE_DPP_SOC_JERICHO_TM_IS_FABRIC_LINK_ALLOWED_DIAGNOSTIC_H_
#define _SHR_SW_STATE_DPP_SOC_JERICHO_TM_IS_FABRIC_LINK_ALLOWED_DIAGNOSTIC_H_
...
/* implemented by: sw_state_dpp_soc_jericho_tm_is_fabric_link_allowed_dump */
typedef int (*sw_state_dpp_soc_jericho_tm_is_fabric_link_allowed_dump_cb)(
    int unit);
...
int sw_state_dpp_soc_jericho_tm_is_fabric_link_allowed_diagnostic_cb_init(int unit);

#endif /* BCM_WARM_BOOT_SUPPORT */

#endif /* _SHR_SW_STATE_DPP_SOC_JERICHO_TM_IS_FABRIC_LINK_ALLOWED_DIAGNOSTIC_H_ */
