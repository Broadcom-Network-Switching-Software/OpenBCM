...
extern void shr_format_macaddr(char buf[], sal_mac_addr_t macaddr);
extern void shr_format_ipaddr(char buf[], sal_ip_addr_t ipaddr);
extern void shr_format_ip6addr(char buf[], sal_ip6_addr_t ipaddr);
