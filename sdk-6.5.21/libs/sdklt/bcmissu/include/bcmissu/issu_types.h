...
typedef struct {
    ...
    const char *device; /*!< The device associated with this patch */
...
/*!
 * \brief Structure containing LT field rename information.
 */
typedef struct {
    const char *lt; /*!< LT name */
    const char *old_fname; /*!< Old field name */
    const char *new_fname; /*!< New field name */
    const char *ver;       /*!< Transition version */
    const char *device;    /*!< Device associated with the change */
    const char *variant;   /*!< Variant associated with the change */
} bcmissu_lt_renamed_fields_t;
...
/*!
 * \brief Obtain the dictionary of all the renamed fields
 *
 * \return The field renamed dictionary - Success
 */
extern const bcmissu_lt_renamed_fields_t *bcmissu_renamed_fields_dict_get(void);
