...
/*!
 * \brief Determine if a version is within the given upgrade range.
 *
 * This function checks the ISSU DB to determine if a given version is present
 * within the ISSU DB.
 *
 * \param [in] ver The version string to check.
 *
 * \retval true The version is within the range.
 * \retval false The version is not within the range.
 */
extern bool bcmissu_version_in_range(const char *ver);
 ...
 * \param [in] last_idx Indicate the target version index.
...
/*!
 *\brief Find the structure definition within the target version.
 *
 * This function searches the issu_struct_version for the structure definition
 * in a given index.
 *
 * \param [in] id The structure ID to search for.
 * \param [in] idx The search index in the ISSU DB.
 ...
 */
extern int bcmissu_struct_def_find(bcmissu_struct_id_t id,
                                   uint32_t idx,
