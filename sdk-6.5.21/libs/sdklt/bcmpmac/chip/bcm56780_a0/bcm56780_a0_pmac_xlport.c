/*! \file bcm56780_a0_pmac_xlport.c
 *
 * The XLPORT driver for BCM56780.
 */
/*
...
#include <bcmpmac/chip/bcm56780_a0_xlport_defs.h>
...
static int
bcm56780_a0_xlport_port_init(bcmpmac_access_t *pa, bcmpmac_pport_t port,
                             uint32_t init)
{
    int rv, ioerr = 0;
    ...
    /* Use CRC_MODE_REPLACE for BCM56780. */
...
bcmpmac_drv_t bcm56780_a0_pmac_xlport = {
    .name = "xlport",
    ...
    .port_init = bcm56780_a0_xlport_port_init,
    ...
    .port_link_status_get = xlport_link_status_get,
};
