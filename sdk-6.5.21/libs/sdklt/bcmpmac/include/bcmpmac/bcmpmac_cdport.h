...
typedef enum cdmac_hdr_mode_e {
    ...
    CDMAC_HDR_MODE_REDUCED_PREAMBLE = 6,
                 ...
                 bcmpmac_encap_mode_t encap)
{
    ...
    switch (encap) {
        ...
        case BCMPMAC_ENCAP_IEEE_REDUCED_IPG:
            hdr_mode = CDMAC_HDR_MODE_REDUCED_PREAMBLE;
            break;
        default:
            return SHR_E_PARAM;
    }
                 ...
                 bcmpmac_encap_mode_t *encap)
{
    ...
    switch (hdr_mode) {
         ...
         * set CDMAC_MODRr.HDR_MODE as REDUCED_PREAMBLE. Return HG3
         * type here, and BCMPC code will determine the corresponding
         * encap type.
         */
        case CDMAC_HDR_MODE_REDUCED_PREAMBLE:
                           ...
                           uint32_t *en)
{
    ...
    ioerr += READ_CDMAC_CTRLr(pa, port, &mac_ctrl);
    *en = CDMAC_CTRLr_LAG_FAILOVER_ENf_GET(mac_ctrl);
