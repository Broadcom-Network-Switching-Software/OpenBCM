...
/*!
 * @enum phymod_power_option_e
 * @brief Serdes power on(down) options 
 */ 
typedef enum phymod_power_option_e {
    phymodSerdesOptionLane = 0x0, /**< power on(down) serdes lane */
    phymodSerdesOptionCore = 0x1, /**< power on(down) serdes core and PLLs within the core */
    phymodSerdesOptionAll = 0x2, /**< power on(down) core along with all PLLs and all lanes within the core */
...
/*!
 * @enum phymod_power_mode_e
 * @brief Serdes power on(down) operations 
 */ 
typedef enum phymod_power_mode_e {
    phymodSerdesPWR_ON = 0x0,
    phymodSerdesPWRDN,
