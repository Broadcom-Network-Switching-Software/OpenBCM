...
#define TSCBH_SPEED_ID_TABLE_SIZE  74
...
extern uint32_t* tscbh_spd_id_entry_26_get(void);
extern uint32_t* tscbh_spd_id_entry_25_get(void);
extern uint32_t* tscbh_spd_id_entry_20_get(void);
extern uint32_t* tscbh_spd_id_entry_26_gsh_get(void);
extern uint32_t* tscbh_spd_id_entry_25_gsh_get(void);
extern uint32_t* tscbh_spd_id_entry_20_gsh_get(void);
extern uint32_t* tscbh_am_table_entry_get(void);
extern uint32_t* tscbh_gen2_am_table_entry_get(void);
extern uint32_t* tscbh_um_table_entry_get(void);
extern uint32_t* tscbh_spd_id_entry_100g_4lane_no_fec_26_get(void);
extern uint32_t* tscbh_spd_id_entry_100g_4lane_no_fec_25_get(void);
extern uint32_t* tscbh_speed_priority_mapping_table_get(void);
