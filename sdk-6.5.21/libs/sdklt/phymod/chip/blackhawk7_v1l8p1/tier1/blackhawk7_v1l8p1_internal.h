...
/** Checks to see if the stored ucode_version in blackhawk7_v1l8p1_info is matching with the current thread ucode_version.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] blackhawk7_v1l8p1_info_ptr pointer to Info_table to be verified.
 ...
 * blackhawk7_v1l8p1_INTERNAL_get_blackhawk7_v1l8p1_info_ptr_with_check and blackhawk7_v1l8p1_INTERNAL_match_ucode_from_info
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] blackhawk7_v1l8p1_info_ptr pointer to Info_table to be verified.
 * @return Error code, if generated (returns ERR_CODE_NONE if no errors).
 */
 ...
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] refclk Reference clock frequency (enumerated), or BLACKHAWK7_V1L8P1_PLL_REFCLK_UNKNOWN to auto-compute.
 * @param[in,out] refclk_freq_hz Resultant reference clock frequency, in Hz.
 * @param[in,out] srds_div Divider value (enumerated), or BLACKHAWK7_V1L8P1_PLL_DIV_UNKNOWN to auto-compute.
 ...
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] refclk Reference clock frequency (enumerated), or BLACKHAWK7_V1L8P1_PLL_REFCLK_UNKNOWN to auto-compute.
 * @param[in] srds_div Divider value (enumerated), or BLACKHAWK7_V1L8P1_PLL_DIV_UNKNOWN to auto-compute.
 ...
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[out] srds_div Divider value, in the same encoding as enum #blackhawk7_v1l8p1_pll_div_enum.
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors).
 */
 ...
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in,out] arg is a blackhawk7_v1l8p1_INTERNAL_event_log_dump_state_t pointer for holding state.
 ...
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[out] istate Current blackhawk7_v1l8p1 core status read back and populated by the API.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors).
 */
 ...
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[out] istate Current blackhawk7_v1l8p1 lane status read back and populated by the API.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors).
 */
...
/** Get a string representation of an blackhawk7_v1l8p1_osr_mode_enum enum value.
 * @param[in] osr_val a blackhawk7_v1l8p1_osr_mode_enum value.
 ...
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[out] sig_det Current blackhawk7_v1l8p1 lane signal_detect status read back and populated by the API.
 * @param[out] sig_det_chg Current blackhawk7_v1l8p1 lane signal_detect_change status read back and populated by the API.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors).
 */
 ...
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[out] pll_lock Current blackhawk7_v1l8p1 lane pll_lock status read back and populated by the API.
 * @param[out] pll_lock_chg Current blackhawk7_v1l8p1 lane pll_lock_change status read back and populated by the API.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors).
 */
 ...
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[out] pmd_lock Current blackhawk7_v1l8p1 lane pmd_rx_lock status read back and populated by the API.
 * @param[out] pmd_lock_chg Current blackhawk7_v1l8p1 lane pmd_rx_lock_change status read back and populated by the API.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors).
 */
...
} blackhawk7_v1l8p1_eye_margin_t; 
 ...
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in,out] arg is a blackhawk7_v1l8p1_INTERNAL_rdblk_callback_arg_t pointer for holding state.
 ...
 * @param[out] dbgfb_stats pointer of type blackhawk7_v1l8p1_dbgfb_stats_st.
 * @return Error Code generated by API (ERR_CODE_NONE if no errors).
 */
 ...
 * Note: Call before releasing blackhawk7_v1l8p1_ln_dp_reset().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
