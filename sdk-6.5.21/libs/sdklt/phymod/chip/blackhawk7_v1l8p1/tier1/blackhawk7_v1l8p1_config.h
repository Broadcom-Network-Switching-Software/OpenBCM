...
if (BLACKHAWK7_V1L8P1_REVID_MODEL_DEFAULT != revid || BLACKHAWK7_V1L8P1_REVID2_DEFAULT != revid2 || ((BLACKHAWK7_V1L8P1_AFE_IPVERSION_ID_DEFAULT != ipversion) && (ipversion != 0xE))) { \
    EFUN_PRINTF(("ERROR: IP Hardware ID Mismatch. Expected: 0x%08X or %08X. Actual: 0x%08X.\n",                                             \
                ...
                (uint32_t)((BLACKHAWK7_V1L8P1_REVID_MODEL_DEFAULT << 16) | (BLACKHAWK7_V1L8P1_REVID2_DEFAULT << 8) | (0xE)),                                      \
