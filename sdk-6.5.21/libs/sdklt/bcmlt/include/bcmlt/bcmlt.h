 ...
 * \ref bcmlt_capture_replay() and \ref bcmlt_replay_action_f()).
 * However, it can also been used on entries that were committed.
 *
 * \param [in] entry_hdl The handle associated with the entry.
 ...
 * entry.
 */
typedef void (*bcmlt_replay_action_f)(int unit, bcmlt_object_hdl_t *object);
 ...
 * a human readable format. See \ref bcmlt_replay_action_f for more information.
