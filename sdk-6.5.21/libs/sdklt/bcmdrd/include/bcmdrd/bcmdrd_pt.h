...
/*!
 * \brief Indicates if given physical memory table is DMAable.
 *
 * Indicates that a physical memory table is applicalbe for DMA operation.
 *
 * \param [in] unit Unit number.
 * \param [in] sid Symbol ID.
 *
 * \retval true Memory table is DMAable.
 * \retval false Memory table is not DMAable.
 */
bool
