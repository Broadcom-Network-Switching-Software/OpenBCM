...
static bcmdrd_chip_param_t bcm56889_a0_chip_params[] = {
    { NULL }
};

static bcmdrd_chip_mod_t bcm56889_a0_chip_mods[] = {
    ...
    { .sid = DLB_LAG_CURRENT_TIMEr, .valid = { true, 0 } },
    { .sid = DLB_LAG_DLB_ID_0_TO_63_ENABLEr, .valid = { true, 0 } },
    { .sid = DLB_LAG_DLB_ID_64_TO_127_ENABLEr, .valid = { true, 0 } },
    { .sid = DLB_LAG_DLB_ID_OFFSETr, .valid = { true, 0 } },
    { .sid = DLB_LAG_FLOWSETm, .valid = { true, 0 } },
    { .sid = DLB_LAG_FLOWSET_MEMBERm, .valid = { true, 0 } },
    { .sid = DLB_LAG_FLOWSET_TIMESTAMP_PAGEm, .valid = { true, 0 } },
    { .sid = DLB_LAG_GROUP_ALT_PORT_MEMBERS_0_TO_15m, .valid = { true, 0 } },
    { .sid = DLB_LAG_GROUP_ALT_PORT_MEMBERS_16_TO_31m, .valid = { true, 0 } },
    { .sid = DLB_LAG_GROUP_ALT_PORT_MEMBERS_32_TO_47m, .valid = { true, 0 } },
    { .sid = DLB_LAG_GROUP_ALT_PORT_MEMBERS_48_TO_63m, .valid = { true, 0 } },
    { .sid = DLB_LAG_GROUP_CONTROLm, .valid = { true, 0 } },
    { .sid = DLB_LAG_GROUP_MEMBERSHIPm, .valid = { true, 0 } },
    { .sid = DLB_LAG_GROUP_MONITOR_CONTROLm, .valid = { true, 0 } },
    { .sid = DLB_LAG_GROUP_PORT_MEMBERS_0_TO_15m, .valid = { true, 0 } },
    { .sid = DLB_LAG_GROUP_PORT_MEMBERS_16_TO_31m, .valid = { true, 0 } },
    { .sid = DLB_LAG_GROUP_PORT_MEMBERS_32_TO_47m, .valid = { true, 0 } },
    { .sid = DLB_LAG_GROUP_PORT_MEMBERS_48_TO_63m, .valid = { true, 0 } },
    { .sid = DLB_LAG_GROUP_STATSm, .valid = { true, 0 } },
    { .sid = DLB_LAG_LINK_CONTROLm, .valid = { true, 0 } },
    { .sid = DLB_LAG_MONITOR_CONTROLr, .valid = { true, 0 } },
    { .sid = DLB_LAG_MONITOR_IFP_CONTROLr, .valid = { true, 0 } },
    { .sid = DLB_LAG_OPTIMAL_CANDIDATEm, .valid = { true, 0 } },
    { .sid = DLB_LAG_PORT_STATEm, .valid = { true, 0 } },
    { .sid = DLB_LAG_RAM_CONTROL_0r, .valid = { true, 0 } },
    { .sid = DLB_LAG_RANDOM_SELECTION_CONTROLr, .valid = { true, 0 } },
    { .sid = DLB_LAG_REFRESH_DISABLEr, .valid = { true, 0 } },
    { .sid = DLB_LAG_REFRESH_INDEXr, .valid = { true, 0 } },
    { .sid = DLB_LAG_SER_CONTROLr, .valid = { true, 0 } },
    { .sid = BCMDRD_INVALID_ID }
};

static bcmdrd_chip_profile_t bcm56889_a0_chip_profile = {
    bcm56889_a0_chip_params,
    bcm56889_a0_chip_mods
};
...
bcmdrd_chip_info_t bcm56889_a0_drd_chip_info = {
