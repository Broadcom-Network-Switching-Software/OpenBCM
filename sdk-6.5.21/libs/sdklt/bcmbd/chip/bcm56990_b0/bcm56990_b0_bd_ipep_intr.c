/*! \file bcm56990_b0_bd_ipep_intr.c
 *
    ...
    if (intr_num >= CENTRAL_CTR_EVICTION_BIT_BASE) {
        ...
        if (intr_num >= ING_DOI_EVENT_FIFO_0_READ_FAIL &&
            ...
            ioerr += WRITE_ING_DOI_HW_STATUSr(unit, inst, idoi_hw_st);
                   ...
                   intr_num <= ING_DOI_PKT_BUFFER_3_UNCORRECTED_ECC_ERR) {
            READ_ING_DOI_SER_STATUSr(unit, inst, &idoi_ser_st);
            val = ING_DOI_SER_STATUSr_GET(idoi_ser_st);
            val &= ~(0x1 << (intr_num - ING_DOI_EVENT_FIFO_0_UNCORRECTED_ECC_ERR));
            ING_DOI_SER_STATUSr_SET(idoi_ser_st, val);
            ioerr += WRITE_ING_DOI_SER_STATUSr(unit, inst, idoi_ser_st);
        }
    } else if (intr_num >= ING_DII_BIT_BASE) {
        if (intr_num == ING_DII_MEM_RESET_COMPLETE) {
        ...
        if (intr_num >= EGR_DOI_EVENT_FIFO_0_READ_FAIL &&
            ...
            ioerr += WRITE_EGR_DOI_HW_STATUSr(unit, inst, edoi_hw_st);
                   ...
                   intr_num <= EGR_DOI_EVENT_FIFO_DATA_3_UNCORRECTED_ECC_ERR) {
            READ_EGR_DOI_SER_STATUSr(unit, inst, &edoi_ser_st);
            val = EGR_DOI_SER_STATUSr_GET(edoi_ser_st);
            val &= ~(0x1 << (intr_num - EGR_DOI_EVENT_FIFO_CTRL_0_UNCORRECTED_ECC_ERR));
            EGR_DOI_SER_STATUSr_SET(edoi_ser_st, val);
            ioerr += WRITE_EGR_DOI_SER_STATUSr(unit, inst, edoi_ser_st);
        }
    } else {
        if (intr_num == EGR_DII_MEM_RESET_COMPLETE) {
...
ipep_intr_clear(int unit, unsigned int intr_num)
{
    ...
    inst = IPEP_INTR_INST_GET(intr_num);
    intr_num = IPEP_INTR_NUM_GET(intr_num);
    ...
    if (fifo_sid == INVALIDm) {
        ipep_intr_write_clear(unit, inst, intr_num);
    } else {
        uint32_t entry_data[BCMDRD_MAX_PT_WSIZE];
        bcmbd_pt_dyn_info_t dyn_info;

        while (ipep_fifo_intr_status_get(unit, inst, intr_num)) {
...
ipep_intr(int unit, uint32_t intr_idx)
{
    ...
    if (intr_idx < ipep_lp.ip_base) {
        /* Interrupt for one instance only */
        stat = ipep_stat[0].bmp;
        ...
        if (ipep_lp.intrs[intr_idx] == DLB_CREDIT_TO_CMIC_INTR) {
            ...
            if (DLB_ECMP_INTR_STATUSr_SER_FIFO_NON_EMPTYf_GET(dlb_st)) {
                SHR_BITSET(stat, DLB_ECMP_SER_FIFO_NON_EMPTY);
            }
        } else {
            if (READ_CENTRAL_CTR_EVICTION_INTR_STATUSr(unit, &cev_st) != 0) {
                return;
            ...
            if (CENTRAL_CTR_EVICTION_INTR_STATUSr_FIFO_NOT_EMPTYf_GET(cev_st)) {
                SHR_BITSET(stat, CENTRAL_CTR_EVICTION_FIFO_NOT_EMPTY);
            }
            if (CENTRAL_CTR_EVICTION_INTR_STATUSr_FIFO_OVERFLOWf_GET(cev_st)) {
                SHR_BITSET(stat, CENTRAL_CTR_EVICTION_FIFO_OVERFLOW);
            }
            if (CENTRAL_CTR_EVICTION_INTR_STATUSr_FIFO_PARITY_ERRORf_GET(cev_st)) {
                SHR_BITSET(stat, CENTRAL_CTR_EVICTION_FIFO_PARITY_ERROR);
            }
        }
    } else if (intr_idx < ipep_lp.ep_base) {
        /* Interrupt for 4 IP instances */
        inst = (intr_idx - ipep_lp.ip_base);
        stat = ipep_stat[inst].bmp;
        ...
        if (IP_TO_CMIC_INTR_STATUSr_IP0f_GET(ip2c_st)) {
            ...
            if (ING_DII_INTR_STATUSr_MEM_RESET_COMPLETEf_GET(idii_st)) {
                SHR_BITSET(stat, ING_DII_MEM_RESET_COMPLETE);
            }
        ...
        if (IP_TO_CMIC_INTR_STATUSr_IP4f_GET(ip2c_st)) {
            ...
            if (IP4_INTR_STATUSr_FLEX_CTRf_GET(ip4_st)) {
                SHR_BITSET(stat, FLEX_CTR_ING_SER_FIFO_NON_EMPTY);
            }
            if (IP4_INTR_STATUSr_IPOSTf_GET(ip4_st)) {
                ...
                if (ING_DOI_INTR_STATUSr_SER_FIFO_NON_EMPTYf_GET(idoi_st)) {
                    SHR_BITSET(stat, ING_DOI_SER_FIFO_NON_EMPTY);
                }
                if (ING_DOI_INTR_STATUSr_EVENT_FIFO_READ_FAILf_GET(idoi_st)) {
                    ...
                    if (ING_DOI_HW_STATUSr_EVENT_FIFO_0_READ_FAILf_GET(idoi_hw_st)) {
                        SHR_BITSET(stat, ING_DOI_EVENT_FIFO_0_READ_FAIL);
                    }
                    if (ING_DOI_HW_STATUSr_EVENT_FIFO_1_READ_FAILf_GET(idoi_hw_st)) {
                        SHR_BITSET(stat, ING_DOI_EVENT_FIFO_1_READ_FAIL);
                    }
                    if (ING_DOI_HW_STATUSr_EVENT_FIFO_2_READ_FAILf_GET(idoi_hw_st)) {
                        SHR_BITSET(stat, ING_DOI_EVENT_FIFO_2_READ_FAIL);
                    }
                    if (ING_DOI_HW_STATUSr_EVENT_FIFO_3_READ_FAILf_GET(idoi_hw_st)) {
                        SHR_BITSET(stat, ING_DOI_EVENT_FIFO_3_READ_FAIL);
                    }
                }
                if (ING_DOI_INTR_STATUSr_EVENT_FIFO_WRITE_FAILf_GET(idoi_st)) {
                    ...
                    if (ING_DOI_HW_STATUSr_EVENT_FIFO_0_WRITE_FAILf_GET(idoi_hw_st)) {
                        SHR_BITSET(stat, ING_DOI_EVENT_FIFO_0_WRITE_FAIL);
                    }
                    if (ING_DOI_HW_STATUSr_EVENT_FIFO_1_WRITE_FAILf_GET(idoi_hw_st)) {
                        SHR_BITSET(stat, ING_DOI_EVENT_FIFO_1_WRITE_FAIL);
                    }
                    if (ING_DOI_HW_STATUSr_EVENT_FIFO_2_WRITE_FAILf_GET(idoi_hw_st)) {
                        SHR_BITSET(stat, ING_DOI_EVENT_FIFO_2_WRITE_FAIL);
                    }
                    if (ING_DOI_HW_STATUSr_EVENT_FIFO_3_WRITE_FAILf_GET(idoi_hw_st)) {
                        SHR_BITSET(stat, ING_DOI_EVENT_FIFO_3_WRITE_FAIL);
                    }
                }
                if (ING_DOI_INTR_STATUSr_EVENT_FIFO_UNCORRECTED_ECC_ERRf_GET(idoi_st)) {
                    if (READ_ING_DOI_SER_STATUSr(unit, inst, &idoi_ser_st) != 0) {
                        return;
                    }
                    if (ING_DOI_SER_STATUSr_EVENT_FIFO_0_UNCORRECTED_ECC_ERRf_GET(idoi_ser_st)) {
                        SHR_BITSET(stat, ING_DOI_EVENT_FIFO_0_UNCORRECTED_ECC_ERR);
                    }
                    if (ING_DOI_SER_STATUSr_EVENT_FIFO_1_UNCORRECTED_ECC_ERRf_GET(idoi_ser_st)) {
                        SHR_BITSET(stat, ING_DOI_EVENT_FIFO_1_UNCORRECTED_ECC_ERR);
                    }
                    if (ING_DOI_SER_STATUSr_EVENT_FIFO_2_UNCORRECTED_ECC_ERRf_GET(idoi_ser_st)) {
                        SHR_BITSET(stat, ING_DOI_EVENT_FIFO_2_UNCORRECTED_ECC_ERR);
                    }
                    if (ING_DOI_SER_STATUSr_EVENT_FIFO_3_UNCORRECTED_ECC_ERRf_GET(idoi_ser_st)) {
                        SHR_BITSET(stat, ING_DOI_EVENT_FIFO_3_UNCORRECTED_ECC_ERR);
                    }
                }
                if (ING_DOI_INTR_STATUSr_CELL_QUEUE_UNCORRECTED_ECC_ERRf_GET(idoi_st)) {
                    ...
                    if (ING_DOI_SER_STATUSr_CELL_QUEUE_0_UNCORRECTED_ECC_ERRf_GET(idoi_ser_st)) {
                        SHR_BITSET(stat, ING_DOI_CELL_QUEUE_0_UNCORRECTED_ECC_ERR);
                    }
                    if (ING_DOI_SER_STATUSr_CELL_QUEUE_1_UNCORRECTED_ECC_ERRf_GET(idoi_ser_st)) {
                        SHR_BITSET(stat, ING_DOI_CELL_QUEUE_1_UNCORRECTED_ECC_ERR);
                    }
                    if (ING_DOI_SER_STATUSr_CELL_QUEUE_2_UNCORRECTED_ECC_ERRf_GET(idoi_ser_st)) {
                        SHR_BITSET(stat, ING_DOI_CELL_QUEUE_2_UNCORRECTED_ECC_ERR);
                    }
                    if (ING_DOI_SER_STATUSr_CELL_QUEUE_3_UNCORRECTED_ECC_ERRf_GET(idoi_ser_st)) {
                        SHR_BITSET(stat, ING_DOI_CELL_QUEUE_3_UNCORRECTED_ECC_ERR);
                    }
                }
                if (ING_DOI_INTR_STATUSr_SLOT_PIPELINE_UNCORRECTED_ECC_ERRf_GET(idoi_st)) {
                    ...
                    if (ING_DOI_SER_STATUSr_SLOT_PIPELINE_0_UNCORRECTED_ECC_ERRf_GET(idoi_ser_st)) {
                        SHR_BITSET(stat, ING_DOI_SLOT_PIPELINE_0_UNCORRECTED_ECC_ERR);
                    }
                    if (ING_DOI_SER_STATUSr_SLOT_PIPELINE_1_UNCORRECTED_ECC_ERRf_GET(idoi_ser_st)) {
                        SHR_BITSET(stat, ING_DOI_SLOT_PIPELINE_1_UNCORRECTED_ECC_ERR);
                    }
                    if (ING_DOI_SER_STATUSr_SLOT_PIPELINE_2_UNCORRECTED_ECC_ERRf_GET(idoi_ser_st)) {
                        SHR_BITSET(stat, ING_DOI_SLOT_PIPELINE_2_UNCORRECTED_ECC_ERR);
                    }
                    if (ING_DOI_SER_STATUSr_SLOT_PIPELINE_3_UNCORRECTED_ECC_ERRf_GET(idoi_ser_st)) {
                        SHR_BITSET(stat, ING_DOI_SLOT_PIPELINE_3_UNCORRECTED_ECC_ERR);
                    }
                }
                if (ING_DOI_INTR_STATUSr_PKT_BUFFER_UNCORRECTED_ECC_ERRf_GET(idoi_st)) {
                    ...
                    if (ING_DOI_SER_STATUSr_PKT_BUFFER_0_UNCORRECTED_ECC_ERRf_GET(idoi_ser_st)) {
                        SHR_BITSET(stat, ING_DOI_PKT_BUFFER_0_UNCORRECTED_ECC_ERR);
                    }
                    if (ING_DOI_SER_STATUSr_PKT_BUFFER_1_UNCORRECTED_ECC_ERRf_GET(idoi_ser_st)) {
                        SHR_BITSET(stat, ING_DOI_PKT_BUFFER_1_UNCORRECTED_ECC_ERR);
                    }
                    if (ING_DOI_SER_STATUSr_PKT_BUFFER_2_UNCORRECTED_ECC_ERRf_GET(idoi_ser_st)) {
                        SHR_BITSET(stat, ING_DOI_PKT_BUFFER_2_UNCORRECTED_ECC_ERR);
                    }
                    if (ING_DOI_SER_STATUSr_PKT_BUFFER_3_UNCORRECTED_ECC_ERRf_GET(idoi_ser_st)) {
                        SHR_BITSET(stat, ING_DOI_PKT_BUFFER_3_UNCORRECTED_ECC_ERR);
                    }
                }
            }
            if (IP4_INTR_STATUSr_ISWf_GET(ip4_st)) {
                SHR_BITSET(stat, IP4_ISW);
            }
        }

        if (IP_TO_CMIC_INTR_STATUSr_IP1f_GET(ip2c_st)) {
            SHR_BITSET(stat, IP_TO_CMIC_IP1);
        }
        if (IP_TO_CMIC_INTR_STATUSr_IP2f_GET(ip2c_st)) {
            SHR_BITSET(stat, IP_TO_CMIC_IP2);
        }
        if (IP_TO_CMIC_INTR_STATUSr_IP3f_GET(ip2c_st)) {
            SHR_BITSET(stat, IP_TO_CMIC_IP3);
        }
    } else {
        /* Interrupt for 4 EP instances */
        ...
        if (EP_TO_CMIC_INTR_STATUSr_EARBf_GET(ep2c_st)) {
            ...
            if (EGR_DII_INTR_STATUSr_MEM_RESET_COMPLETEf_GET(edii_st)) {
                SHR_BITSET(stat, EGR_DII_MEM_RESET_COMPLETE);
            }
        ...
        if (EP_TO_CMIC_INTR_STATUSr_EPOSTf_GET(ep2c_st)) {
            ...
            if (EGR_DOI_INTR_STATUSr_SER_FIFO_NON_EMPTYf_GET(edoi_st)) {
                SHR_BITSET(stat, EGR_DOI_SER_FIFO_NON_EMPTY);
            }
            if (EGR_DOI_INTR_STATUSr_EVENT_FIFO_READ_FAILf_GET(edoi_st)) {
                ...
                if (EGR_DOI_HW_STATUSr_EVENT_FIFO_0_READ_FAILf_GET(edoi_hw_st)) {
                    SHR_BITSET(stat, EGR_DOI_EVENT_FIFO_0_READ_FAIL);
                }
                if (EGR_DOI_HW_STATUSr_EVENT_FIFO_1_READ_FAILf_GET(edoi_hw_st)) {
                    SHR_BITSET(stat, EGR_DOI_EVENT_FIFO_1_READ_FAIL);
                }
                if (EGR_DOI_HW_STATUSr_EVENT_FIFO_2_READ_FAILf_GET(edoi_hw_st)) {
                    SHR_BITSET(stat, EGR_DOI_EVENT_FIFO_2_READ_FAIL);
                }
                if (EGR_DOI_HW_STATUSr_EVENT_FIFO_3_READ_FAILf_GET(edoi_hw_st)) {
                    SHR_BITSET(stat, EGR_DOI_EVENT_FIFO_3_READ_FAIL);
                }
            }
            if (EGR_DOI_INTR_STATUSr_EVENT_FIFO_WRITE_FAILf_GET(edoi_st)) {
                ...
                if (EGR_DOI_HW_STATUSr_EVENT_FIFO_0_WRITE_FAILf_GET(edoi_hw_st)) {
                    SHR_BITSET(stat, EGR_DOI_EVENT_FIFO_0_WRITE_FAIL);
                }
                if (EGR_DOI_HW_STATUSr_EVENT_FIFO_1_WRITE_FAILf_GET(edoi_hw_st)) {
                    SHR_BITSET(stat, EGR_DOI_EVENT_FIFO_1_WRITE_FAIL);
                }
                if (EGR_DOI_HW_STATUSr_EVENT_FIFO_2_WRITE_FAILf_GET(edoi_hw_st)) {
                    SHR_BITSET(stat, EGR_DOI_EVENT_FIFO_2_WRITE_FAIL);
                }
                if (EGR_DOI_HW_STATUSr_EVENT_FIFO_3_WRITE_FAILf_GET(edoi_hw_st)) {
                    SHR_BITSET(stat, EGR_DOI_EVENT_FIFO_3_WRITE_FAIL);
                }
            }
            if (EGR_DOI_INTR_STATUSr_EVENT_FIFO_CTRL_UNCORRECTED_ECC_ERRf_GET(edoi_st)) {
                if (READ_EGR_DOI_SER_STATUSr(unit, inst, &edoi_ser_st) != 0) {
                    return;
                }
                if (EGR_DOI_SER_STATUSr_EVENT_FIFO_CTRL_0_UNCORRECTED_ECC_ERRf_GET(edoi_ser_st)) {
                    SHR_BITSET(stat, EGR_DOI_EVENT_FIFO_CTRL_0_UNCORRECTED_ECC_ERR);
                }
                if (EGR_DOI_SER_STATUSr_EVENT_FIFO_CTRL_1_UNCORRECTED_ECC_ERRf_GET(edoi_ser_st)) {
                    SHR_BITSET(stat, EGR_DOI_EVENT_FIFO_CTRL_1_UNCORRECTED_ECC_ERR);
                }
                if (EGR_DOI_SER_STATUSr_EVENT_FIFO_CTRL_2_UNCORRECTED_ECC_ERRf_GET(edoi_ser_st)) {
                    SHR_BITSET(stat, EGR_DOI_EVENT_FIFO_CTRL_2_UNCORRECTED_ECC_ERR);
                }
                if (EGR_DOI_SER_STATUSr_EVENT_FIFO_CTRL_3_UNCORRECTED_ECC_ERRf_GET(edoi_ser_st)) {
                    SHR_BITSET(stat, EGR_DOI_EVENT_FIFO_CTRL_3_UNCORRECTED_ECC_ERR);
                }
            }
            if (EGR_DOI_INTR_STATUSr_CELL_QUEUE_UNCORRECTED_ECC_ERRf_GET(edoi_st)) {
                ...
                if (EGR_DOI_SER_STATUSr_CELL_QUEUE_0_UNCORRECTED_ECC_ERRf_GET(edoi_ser_st)) {
                    SHR_BITSET(stat, EGR_DOI_CELL_QUEUE_0_UNCORRECTED_ECC_ERR);
                }
                if (EGR_DOI_SER_STATUSr_CELL_QUEUE_1_UNCORRECTED_ECC_ERRf_GET(edoi_ser_st)) {
                    SHR_BITSET(stat, EGR_DOI_CELL_QUEUE_1_UNCORRECTED_ECC_ERR);
                }
                if (EGR_DOI_SER_STATUSr_CELL_QUEUE_2_UNCORRECTED_ECC_ERRf_GET(edoi_ser_st)) {
                    SHR_BITSET(stat, EGR_DOI_CELL_QUEUE_2_UNCORRECTED_ECC_ERR);
                }
                if (EGR_DOI_SER_STATUSr_CELL_QUEUE_3_UNCORRECTED_ECC_ERRf_GET(edoi_ser_st)) {
                    SHR_BITSET(stat, EGR_DOI_CELL_QUEUE_3_UNCORRECTED_ECC_ERR);
                }
            }
            if (EGR_DOI_INTR_STATUSr_SLOT_PIPELINE_UNCORRECTED_ECC_ERRf_GET(edoi_st)) {
                ...
                if (EGR_DOI_SER_STATUSr_SLOT_PIPELINE_0_UNCORRECTED_ECC_ERRf_GET(edoi_ser_st)) {
                    SHR_BITSET(stat, EGR_DOI_SLOT_PIPELINE_0_UNCORRECTED_ECC_ERR);
                }
                if (EGR_DOI_SER_STATUSr_SLOT_PIPELINE_1_UNCORRECTED_ECC_ERRf_GET(edoi_ser_st)) {
                    SHR_BITSET(stat, EGR_DOI_SLOT_PIPELINE_1_UNCORRECTED_ECC_ERR);
                }
                if (EGR_DOI_SER_STATUSr_SLOT_PIPELINE_2_UNCORRECTED_ECC_ERRf_GET(edoi_ser_st)) {
                    SHR_BITSET(stat, EGR_DOI_SLOT_PIPELINE_2_UNCORRECTED_ECC_ERR);
                }
                if (EGR_DOI_SER_STATUSr_SLOT_PIPELINE_3_UNCORRECTED_ECC_ERRf_GET(edoi_ser_st)) {
                    SHR_BITSET(stat, EGR_DOI_SLOT_PIPELINE_3_UNCORRECTED_ECC_ERR);
                }
            }
            if (EGR_DOI_INTR_STATUSr_PKT_BUFFER_UNCORRECTED_ECC_ERRf_GET(edoi_st)) {
                ...
                if (EGR_DOI_SER_STATUSr_PKT_BUFFER_0_UNCORRECTED_ECC_ERRf_GET(edoi_ser_st)) {
                    SHR_BITSET(stat, EGR_DOI_PKT_BUFFER_0_UNCORRECTED_ECC_ERR);
                }
                if (EGR_DOI_SER_STATUSr_PKT_BUFFER_1_UNCORRECTED_ECC_ERRf_GET(edoi_ser_st)) {
                    SHR_BITSET(stat, EGR_DOI_PKT_BUFFER_1_UNCORRECTED_ECC_ERR);
                }
                if (EGR_DOI_SER_STATUSr_PKT_BUFFER_2_UNCORRECTED_ECC_ERRf_GET(edoi_ser_st)) {
                    SHR_BITSET(stat, EGR_DOI_PKT_BUFFER_2_UNCORRECTED_ECC_ERR);
                }
                if (EGR_DOI_SER_STATUSr_PKT_BUFFER_3_UNCORRECTED_ECC_ERRf_GET(edoi_ser_st)) {
                    SHR_BITSET(stat, EGR_DOI_PKT_BUFFER_3_UNCORRECTED_ECC_ERR);
                }
            }
            if (EGR_DOI_INTR_STATUSr_EVENT_FIFO_DATA_UNCORRECTED_ECC_ERRf_GET(edoi_st)) {
                if (READ_EGR_DOI_SER_STATUSr(unit, inst, &edoi_ser_st) != 0) {
                    return;
                }
                if (EGR_DOI_SER_STATUSr_EVENT_FIFO_DATA_0_UNCORRECTED_ECC_ERRf_GET(edoi_ser_st)) {
                    SHR_BITSET(stat, EGR_DOI_EVENT_FIFO_DATA_0_UNCORRECTED_ECC_ERR);
                }
                if (EGR_DOI_SER_STATUSr_EVENT_FIFO_DATA_1_UNCORRECTED_ECC_ERRf_GET(edoi_ser_st)) {
                    SHR_BITSET(stat, EGR_DOI_EVENT_FIFO_DATA_1_UNCORRECTED_ECC_ERR);
                }
                if (EGR_DOI_SER_STATUSr_EVENT_FIFO_DATA_2_UNCORRECTED_ECC_ERRf_GET(edoi_ser_st)) {
                    SHR_BITSET(stat, EGR_DOI_EVENT_FIFO_DATA_2_UNCORRECTED_ECC_ERR);
                }
                if (EGR_DOI_SER_STATUSr_EVENT_FIFO_DATA_3_UNCORRECTED_ECC_ERRf_GET(edoi_ser_st)) {
                    SHR_BITSET(stat, EGR_DOI_EVENT_FIFO_DATA_3_UNCORRECTED_ECC_ERR);
                }
            }
        }

        if (EP_TO_CMIC_INTR_STATUSr_EFPMODf_GET(ep2c_st)) {
            SHR_BITSET(stat, EP2C_EFPMOD);
        }
    }

    /* Now call interrupt handlers according to the interrupt source matrix */
    SHR_BIT_ITER(stat, MAX_INTRS, intr_num) {
        if (SHR_BITGET(stat, intr_num) == 0) {
            /* No interrupt */
            continue;
        }
 ...
 */
int
bcm56990_b0_bd_ipep_intr_drv_init(int unit)
{
    int rv;
    uint32_t pipe_map;
...
int
bcm56990_b0_bd_ipep_intr_drv_cleanup(int unit)
{
