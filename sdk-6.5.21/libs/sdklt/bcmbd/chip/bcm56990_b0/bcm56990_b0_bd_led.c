...
/* Device-specific LED driver. */
static bcmbd_led_drv_t bcm56990_b0_bd_led_drv;

/*******************************************************************************
 * Device-specific driver.
 */
static int
bcm56990_b0_bd_led_init(int unit)
{
...
bcm56990_b0_bd_led_drv_init(int unit)
{
    ...
    sal_memcpy(&bcm56990_b0_bd_led_drv, base_drv, sizeof(bcmbd_led_drv_t));

    /* Override with chip-specific driver methods. */
    bcm56990_b0_bd_led_drv.init = bcm56990_b0_bd_led_init;

    /* Install driver methods. */
    SHR_IF_ERR_EXIT
        (bcmbd_led_drv_init(unit, &bcm56990_b0_bd_led_drv));
