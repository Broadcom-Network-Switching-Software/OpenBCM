/*! \file bcm56990_b0_bd_dev_init.c
 *
...
static int
dii_aux_config(int unit)
{
    ING_DII_NULL_SLOT_CFGr_t ing_dii_null_slot_cfg;
    EGR_DII_NULL_SLOT_CFGr_t egr_dii_null_slot_cfg;
    ING_DII_SER_SCAN_CONFIGr_t ing_dii_ser_scan_cfg;
    EGR_DII_SER_SCAN_CONFIGr_t egr_dii_ser_scan_cfg;
    ING_DII_AUX_ARB_CONTROLr_t ing_dii_aux_arb_ctrl;
    EGR_DII_AUX_ARB_CONTROLr_t egr_dii_aux_arb_ctrl;
    ING_DII_DEBUG_CONFIGr_t ing_dii_debug_cfg;
    EGR_DII_DEBUG_CONFIGr_t egr_dii_debug_cfg;
    FLEX_CTR_ING_MISC_CTRLr_t flex_ctr_ing_misc_ctrl;
    FLEX_CTR_EGR_MISC_CTRLr_t flex_ctr_egr_misc_ctrl;
    uint32_t id, core_clock, pp_clock, pipe_map, threshold;
    int rv, ioerr = 0, pipe;
    ...
    for (pipe = 0; pipe < PP_PIPE_NUM; pipe++) {
        ...
        ioerr += READ_ING_DII_NULL_SLOT_CFGr(unit, pipe,
                                             &ing_dii_null_slot_cfg);
        ING_DII_NULL_SLOT_CFGr_COUNTER_THRESHOLDf_SET(ing_dii_null_slot_cfg,
                                                      threshold);
        ING_DII_NULL_SLOT_CFGr_FLEX_CTR_NULL_THRESHOLDf_SET(
            ing_dii_null_slot_cfg, 154);
        ioerr += WRITE_ING_DII_NULL_SLOT_CFGr(unit, pipe,
                                              ing_dii_null_slot_cfg);

        ioerr += READ_ING_DII_SER_SCAN_CONFIGr(unit, pipe,
                                               &ing_dii_ser_scan_cfg);
        ING_DII_SER_SCAN_CONFIGr_REFRESH_SPACINGf_SET(ing_dii_ser_scan_cfg, 40);
        ioerr += WRITE_ING_DII_SER_SCAN_CONFIGr(unit, pipe,
                                                ing_dii_ser_scan_cfg);

        ioerr += READ_ING_DII_AUX_ARB_CONTROLr(unit, pipe,
                                               &ing_dii_aux_arb_ctrl);
        ING_DII_AUX_ARB_CONTROLr_FP_REFRESH_ENABLEf_SET(ing_dii_aux_arb_ctrl,
                                                        1);
        ING_DII_AUX_ARB_CONTROLr_FP_REFRESH_MODEf_SET(ing_dii_aux_arb_ctrl, 0);
        ioerr += WRITE_ING_DII_AUX_ARB_CONTROLr(unit, pipe,
                                                ing_dii_aux_arb_ctrl);

        ioerr += READ_ING_DII_DEBUG_CONFIGr(unit, pipe, &ing_dii_debug_cfg);
        ING_DII_DEBUG_CONFIGr_NULL_REQ_MODEf_SET(ing_dii_debug_cfg, 0);
        ioerr += WRITE_ING_DII_DEBUG_CONFIGr(unit, pipe, ing_dii_debug_cfg);

        ioerr += READ_EGR_DII_NULL_SLOT_CFGr(unit, pipe, &egr_dii_null_slot_cfg);
        EGR_DII_NULL_SLOT_CFGr_COUNTER_THRESHOLDf_SET(egr_dii_null_slot_cfg,
                                                      threshold);
        EGR_DII_NULL_SLOT_CFGr_FLEX_CTR_NULL_THRESHOLDf_SET(
            egr_dii_null_slot_cfg, threshold);
        ioerr += WRITE_EGR_DII_NULL_SLOT_CFGr(unit, pipe,
                                              egr_dii_null_slot_cfg);

        ioerr += READ_EGR_DII_SER_SCAN_CONFIGr(unit, pipe,
                                               &egr_dii_ser_scan_cfg);
        EGR_DII_SER_SCAN_CONFIGr_REFRESH_SPACINGf_SET(egr_dii_ser_scan_cfg, 40);
        ioerr += WRITE_EGR_DII_SER_SCAN_CONFIGr(unit, pipe,
                                                egr_dii_ser_scan_cfg);

        ioerr += READ_EGR_DII_AUX_ARB_CONTROLr(unit, pipe,
                                               &egr_dii_aux_arb_ctrl);
        EGR_DII_AUX_ARB_CONTROLr_FP_REFRESH_ENABLEf_SET(egr_dii_aux_arb_ctrl,
                                                        1);
        EGR_DII_AUX_ARB_CONTROLr_FP_REFRESH_MODEf_SET(egr_dii_aux_arb_ctrl, 0);
        ioerr += WRITE_EGR_DII_AUX_ARB_CONTROLr(unit, pipe,
                                                egr_dii_aux_arb_ctrl);

        ioerr += READ_EGR_DII_DEBUG_CONFIGr(unit, pipe, &egr_dii_debug_cfg);
        EGR_DII_DEBUG_CONFIGr_NULL_REQ_MODEf_SET(egr_dii_debug_cfg, 0);
        ioerr += WRITE_EGR_DII_DEBUG_CONFIGr(unit, pipe, egr_dii_debug_cfg);

        threshold = pp_clock / 4;

        ioerr += READ_FLEX_CTR_ING_MISC_CTRLr(unit, pipe,
                                              &flex_ctr_ing_misc_ctrl);
        FLEX_CTR_ING_MISC_CTRLr_DIS_NULL_REQf_SET(flex_ctr_ing_misc_ctrl, 1);
        FLEX_CTR_ING_MISC_CTRLr_NULL_REQ_THf_SET(flex_ctr_ing_misc_ctrl,
                                                 threshold);
        ioerr += WRITE_FLEX_CTR_ING_MISC_CTRLr(unit, pipe,
                                               flex_ctr_ing_misc_ctrl);

        ioerr += READ_FLEX_CTR_EGR_MISC_CTRLr(unit, pipe,
                                              &flex_ctr_egr_misc_ctrl);
        FLEX_CTR_EGR_MISC_CTRLr_DIS_NULL_REQf_SET(flex_ctr_egr_misc_ctrl, 1);
        FLEX_CTR_EGR_MISC_CTRLr_NULL_REQ_THf_SET(flex_ctr_egr_misc_ctrl,
                                                 threshold);
        ioerr += WRITE_FLEX_CTR_EGR_MISC_CTRLr(unit, pipe,
                                               flex_ctr_egr_misc_ctrl);
    }
 ...
 * all memories. TH4 hash memory list
...
static int
mem_range_clear(int unit, bcmdrd_sid_t sid)
{
    bcmbd_pt_dyn_info_t dyn_info;
    int wsize = bcmdrd_pt_entry_wsize(unit, sid);
    int inst_num = bcmdrd_pt_num_tbl_inst(unit, sid);
    int mem_size, inst, count;
    uint32_t *dma_buf = NULL;
    uint64_t dma_addr = 0;
    int flags = BCMBD_ROF_SGL_DATA;

    SHR_FUNC_ENTER(unit);

    mem_size = wsize * sizeof(uint32_t);

    dma_buf = bcmdrd_hal_dma_alloc(unit, mem_size, "bdDevInitMemRangeClear",
                                  &dma_addr);
    SHR_NULL_CHECK(dma_buf, SHR_E_MEMORY);
    sal_memset(dma_buf, 0, mem_size);

    dyn_info.index = bcmdrd_pt_index_min(unit, sid);
    count = bcmdrd_pt_index_count(unit, sid);
    ...
    for (inst = 0; inst < inst_num; inst++) {
        ...
        SHR_IF_ERR_EXIT
            (bcmbd_pt_range_write(unit, sid, &dyn_info, NULL, count,
                                  dma_buf, dma_addr, flags));
    }

exit:
    if (dma_buf != NULL) {
        bcmdrd_hal_dma_free(unit, mem_size, dma_buf, dma_addr);
    }
...
static int
obm_mem_init(int unit)
{
    bcmdrd_sid_t obm_sids[] = {IDB_OBM0_IOM_STATS_WINDOW_RESULTSm,
    ...
    for (idx = 0; idx < COUNTOF(obm_sids); idx++) {
        SHR_IF_ERR_EXIT
            (mem_range_clear(unit, obm_sids[idx]));
    }
...
int
bcm56990_b0_bd_dev_init(int unit)
{
    SHR_FUNC_ENTER(unit);
    ...
    SHR_IF_ERR_EXIT
        (bcm56990_b0_bd_pvt_drv_init(unit));
