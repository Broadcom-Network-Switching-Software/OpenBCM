/*! \file bcm56990_b0_bd_dev_reset.c
 *
...
#include <bcmdrd/chip/bcm56990_b0_cmic_defs.h>
...
#define SEQ_RESET_T(_t)    (BCM56990_B0_LRD_DEVICE_SEQ_RESET_T_T_SEQ_RESET_##_t)
...
#define TS_CLK(mhz)      (BCM56990_B0_LRD_DEVICE_TS_PLL_REF_CLK_T_T_CLK_##mhz)
...
#define BS_CLK(mhz)      (BCM56990_B0_LRD_DEVICE_BS_PLL_REF_CLK_T_T_CLK_##mhz)
...
int
bcm56990_b0_bd_dev_reset(int unit)
{
    int rv;
    int ioerr = 0;
    int wait_usec;
