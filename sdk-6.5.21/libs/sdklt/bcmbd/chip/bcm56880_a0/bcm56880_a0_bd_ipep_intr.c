/*! \file bcm56880_a0_bd_ipep_intr.c
 *
...
ipep_thread(shr_thread_t tc, void *arg)
{
    ...
    while (1) {
        ...
        bcmbd_cmicx_lp_intr_enable(unit, QUAD0_IP_TO_CMIC_INTR);
        bcmbd_cmicx_lp_intr_enable(unit, QUAD1_IP_TO_CMIC_INTR);
        bcmbd_cmicx_lp_intr_enable(unit, QUAD2_IP_TO_CMIC_INTR);
        bcmbd_cmicx_lp_intr_enable(unit, QUAD3_IP_TO_CMIC_INTR);
        bcmbd_cmicx_lp_intr_enable(unit, QUAD0_EP_TO_CMIC_INTR);
        bcmbd_cmicx_lp_intr_enable(unit, QUAD1_EP_TO_CMIC_INTR);
        bcmbd_cmicx_lp_intr_enable(unit, QUAD2_EP_TO_CMIC_INTR);
        bcmbd_cmicx_lp_intr_enable(unit, QUAD3_EP_TO_CMIC_INTR);
    }
}
...
ipep_isr(int unit, uint32_t param)
{
    ...
    bcmbd_cmicx_lp_intr_disable_nosync(unit, QUAD0_IP_TO_CMIC_INTR);
    bcmbd_cmicx_lp_intr_disable_nosync(unit, QUAD1_IP_TO_CMIC_INTR);
    bcmbd_cmicx_lp_intr_disable_nosync(unit, QUAD2_IP_TO_CMIC_INTR);
    bcmbd_cmicx_lp_intr_disable_nosync(unit, QUAD3_IP_TO_CMIC_INTR);
    bcmbd_cmicx_lp_intr_disable_nosync(unit, QUAD0_EP_TO_CMIC_INTR);
    bcmbd_cmicx_lp_intr_disable_nosync(unit, QUAD1_EP_TO_CMIC_INTR);
    bcmbd_cmicx_lp_intr_disable_nosync(unit, QUAD2_EP_TO_CMIC_INTR);
    bcmbd_cmicx_lp_intr_disable_nosync(unit, QUAD3_EP_TO_CMIC_INTR);
...
ipep_intr_cleanup(int unit)
{
    ...
    bcmbd_cmicx_lp_intr_disable(unit, QUAD0_IP_TO_CMIC_INTR);
    bcmbd_cmicx_lp_intr_disable(unit, QUAD1_IP_TO_CMIC_INTR);
    bcmbd_cmicx_lp_intr_disable(unit, QUAD2_IP_TO_CMIC_INTR);
    bcmbd_cmicx_lp_intr_disable(unit, QUAD3_IP_TO_CMIC_INTR);
    bcmbd_cmicx_lp_intr_disable(unit, QUAD0_EP_TO_CMIC_INTR);
    bcmbd_cmicx_lp_intr_disable(unit, QUAD1_EP_TO_CMIC_INTR);
    bcmbd_cmicx_lp_intr_disable(unit, QUAD2_EP_TO_CMIC_INTR);
    bcmbd_cmicx_lp_intr_disable(unit, QUAD3_EP_TO_CMIC_INTR);
                  ...
                  bcmbd_intr_f intr_func, uint32_t intr_param)
{
    ...
    if (!ipep_intr_connected[unit]) {
        ...
        bcmbd_cmicx_lp_intr_func_set(unit, QUAD0_IP_TO_CMIC_INTR, ipep_isr, 0);
        bcmbd_cmicx_lp_intr_func_set(unit, QUAD1_IP_TO_CMIC_INTR, ipep_isr, 0);
        bcmbd_cmicx_lp_intr_func_set(unit, QUAD2_IP_TO_CMIC_INTR, ipep_isr, 0);
        bcmbd_cmicx_lp_intr_func_set(unit, QUAD3_IP_TO_CMIC_INTR, ipep_isr, 0);
        bcmbd_cmicx_lp_intr_func_set(unit, QUAD0_EP_TO_CMIC_INTR, ipep_isr, 0);
        bcmbd_cmicx_lp_intr_func_set(unit, QUAD1_EP_TO_CMIC_INTR, ipep_isr, 0);
        bcmbd_cmicx_lp_intr_func_set(unit, QUAD2_EP_TO_CMIC_INTR, ipep_isr, 0);
        bcmbd_cmicx_lp_intr_func_set(unit, QUAD3_EP_TO_CMIC_INTR, ipep_isr, 0);
