...
static bcmdrd_port_info_t bcm56880_a0_port_info[] = {
    /* Phys  Port type             Logic  MMU */
    {     0, BCMDRD_PORT_TYPE_CPU,     0,   0 },
    {   261, BCMDRD_PORT_TYPE_LB,     39,  50 },
    {   262, BCMDRD_PORT_TYPE_LB,     79, 114 },
    {   263, BCMDRD_PORT_TYPE_LB,    119, 178 },
    {   264, BCMDRD_PORT_TYPE_LB,    159, 242 },
    {   257, BCMDRD_PORT_TYPE_MGMT,   38,  51 },
    {   258, BCMDRD_PORT_TYPE_MGMT,   78, 115 },
    {   259, BCMDRD_PORT_TYPE_MGMT,  118, 179 },
    {   260, BCMDRD_PORT_TYPE_MGMT,  158, 243 },
    {    -1, BCMDRD_PORT_TYPE_RSVD,   19,  18 },
    {    -1, BCMDRD_PORT_TYPE_RSVD,   58,  83 },
    {    -1, BCMDRD_PORT_TYPE_RSVD,   59,  82 },
    {    -1, BCMDRD_PORT_TYPE_RSVD,   98, 147 },
    {    -1, BCMDRD_PORT_TYPE_RSVD,   99, 146 },
    {    -1, BCMDRD_PORT_TYPE_RSVD,  138, 211 },
    {    -1, BCMDRD_PORT_TYPE_RSVD,  139, 210 },
    { -1 }
};

static bcmdrd_port_info_t bcm56883_a0_port_info[] = {
    /* Phys  Port type             Logic  MMU */
    {     0, BCMDRD_PORT_TYPE_CPU,     0,   0 },
    {   261, BCMDRD_PORT_TYPE_LB,     39,  50 },
    {   262, BCMDRD_PORT_TYPE_LB,     79, 114 },
    ...
    {    -1, BCMDRD_PORT_TYPE_RSVD,  138, 211 },
    {    -1, BCMDRD_PORT_TYPE_RSVD,  139, 210 },
    {    -1, BCMDRD_PORT_TYPE_RSVD,   78, 115 },
    {    -1, BCMDRD_PORT_TYPE_RSVD,  118, 179 },
    { -1 }
};
/*******************************************************************************
* Private functions
...
static bool
bcm56880_a0_addr_bypass(int unit, uint32_t adext, uint32_t addr)
{
    int block;
...
static int
bcm56880_a0_feature_init(int unit)
{
...
static int
bcm56880_a0_bd_dev_start(int unit)
{
    bool emul;
    bool ts_en = false;
...
static int
bcm56880_a0_bd_dev_stop(int unit)
{
    bool emul;
    SHR_FUNC_ENTER(unit);
...
static int
bcm56880_a0_pt_param_get(int unit, bcmdrd_sid_t sid,
                         bcmbd_pt_param_t ptype, uint32_t *pval)
{
    switch (ptype) {
    case BCMBD_PT_PARAM_MOR_CLKS_READ:
        *pval = bcm56880_a0_bd_mor_clks_read_get(unit, sid);
        return SHR_E_NONE;
    default:
        break;
    }
...
static int
bcm56880_a0_dev_param_get(int unit, bcmbd_dev_param_t dev_param, uint32_t *val)
{
    switch (dev_param) {
    case BCMBD_DEV_PRM_AVS_VOLTAGE:
        return bcm56880_a0_bd_avs_voltage_get(unit, val);
    case BCMBD_DEV_PRM_HMI_CMDBUF_SIZE:
        /* Note that X11 does not have a real SBUS command buffer */
        *val = 32;
        return SHR_E_NONE;
    default:
        break;
...
bcm56880_a0_drv_init(int unit)
{
    ...
    bd->dev_reset = bcm56880_a0_bd_dev_reset;
    bd->dev_init = bcm56880_a0_bd_dev_init;
    bd->dev_start = bcm56880_a0_bd_dev_start;
    bd->dev_stop = bcm56880_a0_bd_dev_stop;
    bd->knet_enable_set = bcmbd_cmicx_intr_knet_enable_set;
    bd->knet_enable_get = bcmbd_cmicx_intr_knet_enable_get;
    bd->addr_bypass = bcm56880_a0_addr_bypass;
    bd->pt_param_get = bcm56880_a0_pt_param_get;
    bd->dev_param_get = bcm56880_a0_dev_param_get;

    return SHR_E_NONE;
}

static int
bcm56880_a0_iproc_init(int unit, unsigned int iomem_idx, size_t size)
{
    bcmdrd_hal_iproc_cfg_t iproc_cfg, *icfg = &iproc_cfg;

    sal_memset(icfg, 0, sizeof(*icfg));

    /* iProc configuration for BCM56880 family. */
    icfg->iproc_ver = 15;
...
static int
bcm56880_a0_emul_valid_pbmps_set(int unit, uint32_t valid_pipes)
{
    ...
    for (pnd = 0; pnd < BCMDRD_PND_COUNT; pnd++) {
        ...
        BCMDRD_PBMP_ITER(*valid_pbmp, port) {
            ...
            if (pnd == BCMDRD_PND_PHYS && (port == 257 || port == 260)) {
...
static int
bcm56880_a0_hc_subpipe_error(int unit, int ch, uint32_t *schan_msg, uint32_t reg_val)
{
...
static int
bcm56883_a0_pt_index_valid(int unit, bcmdrd_sid_t sid,
                           int tbl_inst, int tbl_idx, bool *valid)
{
    int idx = -1;
    uint32_t check_bit;
    uint32_t tsc_disable = 0x2a542a54;
    const char *sname;
    char n;
...
int
bcm56880_a0_bd_attach(int unit)
{
    uint64_t chip_debug;
    uint32_t pipe_map;
    ...
    SHR_IF_ERR_EXIT
        (bcm56880_a0_feature_init(unit));
    SHR_IF_ERR_EXIT
        (bcm56880_a0_drv_init(unit));

    if ((flags & CHIP_FLAG_BW8T) == CHIP_FLAG_BW8T) {
        SHR_IF_ERR_EXIT
            (bcmdrd_port_info_init(unit, bcm56883_a0_port_info));
    } else {
        SHR_IF_ERR_EXIT
            (bcmdrd_port_info_init(unit, bcm56880_a0_port_info));
    }

    /* Update tile information. */
    mux_info_list = bcm56880_a0_mux_info_db_list_get();
    ...
    if (chip_debug != 0) {
        SHR_IF_ERR_EXIT
            (bcmbd_cmicx_schan_error_func_set(unit, bcm56880_a0_hc_subpipe_error));
    }
    SHR_IF_ERR_EXIT
        (bcmdrd_dev_valid_pipes_get(unit, &pipe_map));
    pipe_map &= ~chip_debug;
    SHR_IF_ERR_EXIT
        (bcm56880_a0_emul_valid_pbmps_set(unit, pipe_map));

    if ((flags & CHIP_FLAG_BW8T) == CHIP_FLAG_BW8T) {
        SHR_IF_ERR_EXIT
            (bcmdrd_dev_pt_index_valid_func_set(unit,
                                                bcm56883_a0_pt_index_valid));
    }

    SHR_IF_ERR_EXIT
        (bcmdrd_hal_reg32_init(unit, 0, BCMBD_CMICX_IOMEM_SIZE));
    SHR_IF_ERR_EXIT
        (bcm56880_a0_iproc_init(unit, 1, 0));
    SHR_IF_ERR_EXIT
        (bcmbd_cmicx_hotswap_init(unit));
    SHR_IF_ERR_EXIT
    ...
    SHR_IF_ERR_EXIT
        (bcm56880_a0_bd_port_intr_drv_init(unit));
    SHR_IF_ERR_EXIT
        (bcm56880_a0_bd_ipep_intr_drv_init(unit));
    SHR_IF_ERR_EXIT
        (bcm56880_a0_bd_mmu_intr_drv_init(unit));
    SHR_IF_ERR_EXIT
        (bcm56880_a0_bd_pvt_intr_drv_init(unit));

    SHR_IF_ERR_EXIT
        (bcmbd_fwm_dev_create(unit));
    SHR_IF_ERR_EXIT
        (bcm56880_a0_bd_mcs_drv_init(unit));
    SHR_IF_ERR_EXIT
        (bcm56880_a0_bd_m0ssq_drv_init(unit));
    SHR_IF_ERR_EXIT
        (bcm56880_a0_bd_led_drv_init(unit));
    SHR_IF_ERR_EXIT
        (bcm56880_a0_bd_ts_drv_init(unit));
...
int
bcm56880_a0_bd_detach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_CONT
        (bcm56880_a0_bd_led_drv_cleanup(unit));
    SHR_IF_ERR_CONT
        (bcm56880_a0_bd_m0ssq_drv_cleanup(unit));
    SHR_IF_ERR_CONT
        (bcm56880_a0_bd_mcs_drv_cleanup(unit));
    SHR_IF_ERR_CONT
        (bcmbd_fwm_dev_destroy(unit));
    SHR_IF_ERR_CONT
        (bcm56880_a0_bd_ts_drv_cleanup(unit));

    SHR_IF_ERR_CONT
        (bcm56880_a0_bd_pvt_intr_drv_cleanup(unit));
    SHR_IF_ERR_CONT
        (bcm56880_a0_bd_mmu_intr_drv_cleanup(unit));
    SHR_IF_ERR_CONT
        (bcm56880_a0_bd_ipep_intr_drv_cleanup(unit));
    SHR_IF_ERR_CONT
        (bcm56880_a0_bd_port_intr_drv_cleanup(unit));
