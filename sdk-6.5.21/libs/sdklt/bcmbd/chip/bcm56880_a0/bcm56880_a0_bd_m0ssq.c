/*! \file bcm56880_a0_bd_m0ssq.c
 *
 * bcm56880_a0 device-specific M0SSQ driver.
 */
/*
...
static bcmbd_m0ssq_drv_t bcm56880_a0_m0ssq_drv;

/*******************************************************************************
 * BCM56880_A0 CMICX M0SSQ Driver
 */
static int
bcm56880_a0_m0ssq_init(int unit)
{
...
bcm56880_a0_bd_m0ssq_drv_init(int unit)
{
    ...
    sal_memcpy(&bcm56880_a0_m0ssq_drv, base_drv, sizeof(bcmbd_m0ssq_drv_t));

    /* Override chip-specific method. */
    bcm56880_a0_m0ssq_drv.init = bcm56880_a0_m0ssq_init;

    SHR_IF_ERR_EXIT
        (bcmbd_m0ssq_drv_init(unit, &bcm56880_a0_m0ssq_drv));
