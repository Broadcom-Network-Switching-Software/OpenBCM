/*! \file bcm56990_a0_bd_dev_init.c
 *
...
#define DPR_IP_BASE                     202
/* early retrieval + default margin */
#define DPR_IP_ADJUST                   -56
/* total_latency + pipe_num * maxAccumulation */
#define DPR_EP_BASE                     118
/* early retrieval + default margin */
#define DPR_EP_ADJUST                   -6
/*
...
hash_init(int unit)
{
    ...
    L2_ENTRY_HASH_CONTROLm_ROBUST_HASH_ENf_SET(l2_entry_hash_control, 0x1);
    L2_ENTRY_HASH_CONTROLm_HASH_OFFSET_DEDICATED_BANK_1f_SET(l2_entry_hash_control, 0x20);
    L2_ENTRY_HASH_CONTROLm_HASH_TABLE_BANK_CONFIGf_SET(l2_entry_hash_control, 0x3);
    ioerr += WRITE_L2_ENTRY_HASH_CONTROLm(unit, 0, l2_entry_hash_control);

    L3_TUNNEL_HASH_CONTROLm_CLR(l3_tunnel_hash_control);
    L3_TUNNEL_HASH_CONTROLm_ROBUST_HASH_ENf_SET(l3_tunnel_hash_control, 0x1);
    ...
    MPLS_ENTRY_HASH_CONTROLm_ROBUST_HASH_ENf_SET(mpls_entry_hash_control, 0x1);
    ...
    EXACT_MATCH_HASH_CONTROLm_ROBUST_HASH_ENf_SET(exact_match_hash_control, 0x1);
    EXACT_MATCH_HASH_CONTROLm_LOGICAL_BANK_1_PHYSICAL_BANK_LOCATIONf_SET(exact_match_hash_control, 0x1);
    EXACT_MATCH_HASH_CONTROLm_LOGICAL_BANK_2_PHYSICAL_BANK_LOCATIONf_SET(exact_match_hash_control, 0x2);
    EXACT_MATCH_HASH_CONTROLm_LOGICAL_BANK_3_PHYSICAL_BANK_LOCATIONf_SET(exact_match_hash_control, 0x3);
    ioerr += WRITE_EXACT_MATCH_HASH_CONTROLm(unit, 0, exact_match_hash_control);

    EGR_ADAPT_HASH_CONTROLm_CLR(egr_adapt_hash_control);
    EGR_ADAPT_HASH_CONTROLm_ROBUST_HASH_ENf_SET(egr_adapt_hash_control, 0x1);
    EGR_ADAPT_HASH_CONTROLm_HASH_OFFSET_DEDICATED_BANK_1f_SET(egr_adapt_hash_control, 0x20);
    ...
    UFT_SHARED_BANKS_CONTROLm_B4_HASH_OFFSETf_SET(uft_shared_banks_control, 30);
    UFT_SHARED_BANKS_CONTROLm_B5_HASH_OFFSETf_SET(uft_shared_banks_control, 38);
    UFT_SHARED_BANKS_CONTROLm_B6_HASH_OFFSETf_SET(uft_shared_banks_control, 44);
    UFT_SHARED_BANKS_CONTROLm_B7_HASH_OFFSETf_SET(uft_shared_banks_control, 50);
    ...
    MINI_UFT_SHARED_BANKS_CONTROLm_B0_HASH_OFFSETf_SET(mini_uft_shared_banks_control, 6);
    MINI_UFT_SHARED_BANKS_CONTROLm_B1_HASH_OFFSETf_SET(mini_uft_shared_banks_control, 12);
    MINI_UFT_SHARED_BANKS_CONTROLm_B2_HASH_OFFSETf_SET(mini_uft_shared_banks_control, 18);
    MINI_UFT_SHARED_BANKS_CONTROLm_B3_HASH_OFFSETf_SET(mini_uft_shared_banks_control, 24);
    MINI_UFT_SHARED_BANKS_CONTROLm_B4_HASH_OFFSETf_SET(mini_uft_shared_banks_control, 30);
    MINI_UFT_SHARED_BANKS_CONTROLm_B5_HASH_OFFSETf_SET(mini_uft_shared_banks_control, 38);
...
/* Enable Power load line feature and enable hardware selection. (SDKLT-18655) */
static int
power_load_line_config(int unit)
{
    int ioerr = 0;
    ...
    /* Reset hardware line control. */
    ioerr += READ_DMU_PCU_IPROC_CONTROLr(unit, &iproc_ctrl);
    DMU_PCU_IPROC_CONTROLr_VCOBYPASSf_SET(iproc_ctrl, 0);
    ioerr += WRITE_DMU_PCU_IPROC_CONTROLr(unit, iproc_ctrl);
    DMU_PCU_IPROC_CONTROLr_VCOBYPASSf_SET(iproc_ctrl, 1);
    ioerr += WRITE_DMU_PCU_IPROC_CONTROLr(unit, iproc_ctrl);

    /* Enable load line control feature and set traffic load line. */
    DMU_PCU_IPROC_CONTROLr_IHOST_PWRCTRLI0f_SET(iproc_ctrl, 0x3);
    ioerr += WRITE_DMU_PCU_IPROC_CONTROLr(unit, iproc_ctrl);
...
bcm56990_a0_bd_dev_init(int unit)
{
    ...
    SHR_IF_ERR_EXIT
        (power_load_line_config(unit));

    SHR_IF_ERR_EXIT
        (bcm56990_a0_bd_pvt_drv_init(unit));
