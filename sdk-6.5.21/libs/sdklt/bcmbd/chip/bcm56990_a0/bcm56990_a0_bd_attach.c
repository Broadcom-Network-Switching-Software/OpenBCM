...
static bcmdrd_port_info_t bcm56990_a0_port_info[] = {
...
static bool
bcm56990_a0_addr_bypass(int unit, uint32_t adext, uint32_t addr)
{
    int block;

    if (bcmdrd_dev_bypass_mode_get(unit) == BYPASS_MODE_EPIP) {
        block = (adext & 0xff);
        if (block == IPIPE || block == EPIPE || block == FLEX_CTR) {
...
static int
bcm56990_a0_feature_init(int unit)
{
...
static int
bcm56990_a0_bd_dev_start(int unit)
{
    bool ts_en = false;
    uint64_t ts_ns = 0;
    ...
    if (!ts_en) {
        ...
        SHR_IF_ERR_EXIT
            (bcmbd_ts_timestamp_nanosec_get(unit, 1, &ts_ns));
        if (!ts_ns) {
            SHR_IF_ERR_EXIT
                (bcmbd_ts_timestamp_enable_set(unit, 1, false));
            SHR_IF_ERR_EXIT
                (bcmbd_ts_timestamp_enable_set(unit, 1, true));
        }
    }
...
static int
bcm56990_a0_bd_dev_stop(int unit)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56990_a0_pt_param_get(int unit, bcmdrd_sid_t sid,
                         bcmbd_pt_param_t ptype, uint32_t *pval)
{
    switch (ptype) {
    case BCMBD_PT_PARAM_MOR_CLKS_READ:
        *pval = bcm56990_a0_bd_mor_clks_read_get(unit, sid);
        return SHR_E_NONE;
    default:
        break;
    }
...
static int
bcm56990_a0_dev_param_get(int unit, bcmbd_dev_param_t dev_param, uint32_t *val)
{
    switch (dev_param) {
    case BCMBD_DEV_PRM_AVS_VOLTAGE:
        return bcm56990_a0_bd_avs_voltage_get(unit, val);
    default:
        break;
    }
    return SHR_E_UNAVAIL;
...
bcm56990_a0_drv_init(int unit)
{
    ...
    bd->dev_reset = bcm56990_a0_bd_dev_reset;
    bd->dev_init = bcm56990_a0_bd_dev_init;
    bd->dev_start = bcm56990_a0_bd_dev_start;
    bd->dev_stop = bcm56990_a0_bd_dev_stop;
    bd->knet_enable_set = bcmbd_cmicx_intr_knet_enable_set;
    bd->knet_enable_get = bcmbd_cmicx_intr_knet_enable_get;
    bd->addr_bypass = bcm56990_a0_addr_bypass;
    bd->pt_param_get = bcm56990_a0_pt_param_get;
    bd->dev_param_get = bcm56990_a0_dev_param_get;

    return SHR_E_NONE;
}

static int
bcm56990_a0_iproc_init(int unit, unsigned int iomem_idx, size_t size)
{
 ...
 */
static int
bcm56990_a0_valid_pbmps_set(int unit, uint32_t valid_pipes)
{
...
static int
bcm56990_a0_pipe_init(int unit)
{
    ...
    return bcm56990_a0_valid_pbmps_set(unit, valid_pipes);
}

static int
bcm56990_a0_pt_index_valid(int unit, bcmdrd_sid_t sid,
                           int tbl_inst, int tbl_idx, bool *valid)
{
     ...
     * BCM56990 emulation mode or BCM56994.
     */
...
static int
bcm56990_a0_hc_schan_error(int unit, int ch, uint32_t *schan_msg, uint32_t reg_val)
{
...
static int
bcm56990_a0_cmicx_schan_error_func_set(int unit)
{
    ...
    if (emul && (valid_pipes == 0xF00F)) {
        SHR_IF_ERR_EXIT
            (bcmbd_cmicx_schan_error_func_set(unit, bcm56990_a0_hc_schan_error));
    }
...
int
bcm56990_a0_bd_attach(int unit)
{
    SHR_FUNC_ENTER(unit);
    ...
    SHR_IF_ERR_EXIT
        (bcm56990_a0_feature_init(unit));
    SHR_IF_ERR_EXIT
        (bcm56990_a0_drv_init(unit));
    SHR_IF_ERR_EXIT
        (bcmdrd_port_info_init(unit, bcm56990_a0_port_info));
    SHR_IF_ERR_EXIT
        (bcm56990_a0_pipe_init(unit));

    SHR_IF_ERR_EXIT
        (bcm56990_a0_cmicx_schan_error_func_set(unit));
    SHR_IF_ERR_EXIT
        (bcmdrd_dev_pt_index_valid_func_set(unit, bcm56990_a0_pt_index_valid));

    SHR_IF_ERR_EXIT
        (bcmdrd_hal_reg32_init(unit, 0, BCMBD_CMICX_IOMEM_SIZE));
    SHR_IF_ERR_EXIT
        (bcm56990_a0_iproc_init(unit, 1, 0));
    SHR_IF_ERR_EXIT
    ...
    SHR_IF_ERR_EXIT
        (bcm56990_a0_bd_db_intr_drv_init(unit));
    SHR_IF_ERR_EXIT
        (bcm56990_a0_bd_ipep_intr_drv_init(unit));
    SHR_IF_ERR_EXIT
        (bcm56990_a0_bd_port_intr_drv_init(unit));
    SHR_IF_ERR_EXIT
        (bcm56990_a0_bd_mmu_intr_drv_init(unit));
    SHR_IF_ERR_EXIT
        (bcm56990_a0_bd_mmui_intr_drv_init(unit));
    SHR_IF_ERR_EXIT
        (bcm56990_a0_bd_pvt_intr_drv_init(unit));

    SHR_IF_ERR_EXIT
        (bcmbd_fwm_dev_create(unit));
    SHR_IF_ERR_EXIT
        (bcm56990_a0_bd_m0ssq_drv_init(unit));
    SHR_IF_ERR_EXIT
        (bcm56990_a0_bd_led_drv_init(unit));
    SHR_IF_ERR_EXIT
        (bcm56990_a0_bd_ts_drv_init(unit));
...
int
bcm56990_a0_bd_detach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_CONT
        (bcm56990_a0_bd_led_drv_cleanup(unit));
    SHR_IF_ERR_CONT
        (bcm56990_a0_bd_m0ssq_drv_cleanup(unit));
    SHR_IF_ERR_CONT
        (bcmbd_fwm_dev_destroy(unit));
    SHR_IF_ERR_CONT
        (bcm56990_a0_bd_ts_drv_cleanup(unit));
    SHR_IF_ERR_CONT
        (bcm56990_a0_bd_pvt_drv_cleanup(unit));

    SHR_IF_ERR_CONT
        (bcm56990_a0_bd_pvt_intr_drv_cleanup(unit));
    SHR_IF_ERR_CONT
        (bcm56990_a0_bd_mmu_intr_drv_cleanup(unit));
    SHR_IF_ERR_CONT
        (bcm56990_a0_bd_port_intr_drv_cleanup(unit));
    SHR_IF_ERR_CONT
        (bcm56990_a0_bd_mmui_intr_drv_cleanup(unit));
    SHR_IF_ERR_CONT
        (bcm56990_a0_bd_ipep_intr_drv_cleanup(unit));
    SHR_IF_ERR_CONT
        (bcm56990_a0_bd_db_intr_drv_cleanup(unit));
