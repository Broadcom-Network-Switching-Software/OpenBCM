...
ipep_intr_clear(int unit, unsigned int intr_num)
{
    ...
    LEARN_CACHE_INTR_STATUSr_t intr_status;
    ...
    case IPOST_SER_STATUS_BLK_ING_SER_FIFO_NON_EMPTY:
        ...
        break;
    case LEARN_CACHE_INTR:
        READ_LEARN_CACHE_INTR_ENABLEr(unit, &intr_enable);
        LEARN_CACHE_INTR_ENABLEr_LEARN_CACHE_NOT_EMPTYf_SET(intr_enable, 0);
        WRITE_LEARN_CACHE_INTR_ENABLEr(unit, intr_enable);

        LEARN_CACHE_INTR_STATUSr_CLR(intr_status);
        WRITE_LEARN_CACHE_INTR_STATUSr(unit, 0, intr_status);
        WRITE_LEARN_CACHE_INTR_STATUSr(unit, 1, intr_status);

        LEARN_CACHE_INTR_ENABLEr_LEARN_CACHE_NOT_EMPTYf_SET(intr_enable, 1);
        WRITE_LEARN_CACHE_INTR_ENABLEr(unit, intr_enable);
        break;
    case ING_DOI_SER_FIFO_NON_EMPTY:
