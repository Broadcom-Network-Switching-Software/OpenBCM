...
{
    bool macsec_init = 0;
    static const uint32_t def_val = 0;
    ...
    macsec_init = bcmbd_config_get(unit, def_val,
                                   "SEC_CONFIG", "SEC_ENABLE");
    if (macsec_init && bcmdrd_dev_flags_get(unit) & CHIP_FLAG_MACSEC) {
        bcmdrd_feature_enable(unit, BCMDRD_FT_MACSEC);
    }
                         ...
                         bcmbd_pt_param_t ptype, uint32_t *pval)
{
    ...
    case BCMBD_PT_PARAM_MOR_CLKS_READ:
        *pval = bcm56780_a0_bd_mor_clks_read_get(unit, sid);
        return SHR_E_NONE;
    case BCMBD_PT_PARAM_MOR_CLKS_WRITE:
        *pval = bcm56780_a0_bd_mor_clks_write_get(unit, sid);
        return SHR_E_NONE;
    default:
        break;
    }
...
static int
bcm56780_a0_dev_param_get(int unit, bcmbd_dev_param_t dev_param, uint32_t *val)
{
    switch (dev_param) {
...
bcm56780_a0_drv_init(int unit)
{
    ...
    bd->dev_param_get = bcm56780_a0_dev_param_get;
