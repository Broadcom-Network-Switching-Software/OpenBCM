...
cmicx_fifodma_start(cmicx_fifodma_dev_t *dev, int chan)
{
    ...
    cmd_spacing = work->data->cmd_spacing;
    if (cmd_spacing) {
        CMIC_FIFO_RD_DMA_CFGr_MULTIPLE_SBUS_CMD_SPACINGf_SET(cfg, cmd_spacing);
    }
    ...
    if (cmd_spacing) {
        ...
        CMIC_FIFO_RD_DMA_CFG_1r_MULTIPLE_SBUS_CMD_SPACING_MSB_BITSf_SET(cfg1, cmd_spacing >> 5);
    } else {
