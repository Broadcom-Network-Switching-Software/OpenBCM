...
#ifndef BCMBD_CMICX_HOTSWAP_H
#define BCMBD_CMICX_HOTSWAP_H

#include <bcmdrd/bcmdrd_types.h>

/*!
 * \brief PAXB hotswap driver init and hotswap recovery.
 *
 ...
 */
int
bcmbd_cmicx_hotswap_init(int unit);

#endif /* BCMBD_CMICX_HOTSWAP_H */
