...
#define CMICX_IRQ_CMC0_XC_MEMDMA_CH2_DONE       (IPROC_IRQ_BASE5 + 8)
#define CMICX_IRQ_CMC0_XC_MEMDMA_CH3_DONE       (IPROC_IRQ_BASE5 + 9)
...
#define CMICX_IRQ_CMC1_SBUSDMA_CH4_DONE         (IPROC_IRQ_BASE6 + 26)
#define CMICX_IRQ_CMC1_SBUSDMA_CH5_DONE         (IPROC_IRQ_BASE6 + 27)
#define CMICX_IRQ_CMC1_SBUSDMA_CH6_DONE         (IPROC_IRQ_BASE6 + 28)
#define CMICX_IRQ_CMC1_SBUSDMA_CH7_DONE         (IPROC_IRQ_BASE6 + 29)
