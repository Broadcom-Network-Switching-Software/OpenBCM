/*! \file bcm56990_a0_ipep_intr.h
 *
 * IPEP interrupt sources for BCM56990_A0.
 */
/*
...
#ifndef BCM56990_A0_IPEP_INTR_H
#define BCM56990_A0_IPEP_INTR_H
...
#define EGR_DII_EVENT_FIFO0_SER_ERR                   (EGR_DII_BIT_BASE + 3)
#define EGR_DII_EVENT_FIFO1_SER_ERR                   (EGR_DII_BIT_BASE + 4)
#define EGR_DII_EVENT_FIFO2_SER_ERR                   (EGR_DII_BIT_BASE + 5)
#define EGR_DII_EVENT_FIFO3_SER_ERR                   (EGR_DII_BIT_BASE + 6)
...
#define EGR_DOI_EVENT_FIFO_CTRL_0_UNCORRECTED_ECC_ERR (EGR_DOI_BIT_BASE + 3)
#define EGR_DOI_CELL_QUEUE_0_UNCORRECTED_ECC_ERR      (EGR_DOI_BIT_BASE + 4)
#define EGR_DOI_SLOT_PIPELINE_0_UNCORRECTED_ECC_ERR   (EGR_DOI_BIT_BASE + 5)
#define EGR_DOI_EVENT_FIFO_1_READ_FAIL                (EGR_DOI_BIT_BASE + 6)
#define EGR_DOI_EVENT_FIFO_1_WRITE_FAIL               (EGR_DOI_BIT_BASE + 7)
#define EGR_DOI_EVENT_FIFO_CTRL_1_UNCORRECTED_ECC_ERR (EGR_DOI_BIT_BASE + 8)
#define EGR_DOI_CELL_QUEUE_1_UNCORRECTED_ECC_ERR      (EGR_DOI_BIT_BASE + 9)
#define EGR_DOI_SLOT_PIPELINE_1_UNCORRECTED_ECC_ERR   (EGR_DOI_BIT_BASE + 10)
#define EGR_DOI_EVENT_FIFO_2_READ_FAIL                (EGR_DOI_BIT_BASE + 11)
#define EGR_DOI_EVENT_FIFO_2_WRITE_FAIL               (EGR_DOI_BIT_BASE + 12)
#define EGR_DOI_EVENT_FIFO_CTRL_2_UNCORRECTED_ECC_ERR (EGR_DOI_BIT_BASE + 13)
#define EGR_DOI_CELL_QUEUE_2_UNCORRECTED_ECC_ERR      (EGR_DOI_BIT_BASE + 14)
#define EGR_DOI_SLOT_PIPELINE_2_UNCORRECTED_ECC_ERR   (EGR_DOI_BIT_BASE + 15)
#define EGR_DOI_EVENT_FIFO_3_READ_FAIL                (EGR_DOI_BIT_BASE + 16)
#define EGR_DOI_EVENT_FIFO_3_WRITE_FAIL               (EGR_DOI_BIT_BASE + 17)
#define EGR_DOI_EVENT_FIFO_CTRL_3_UNCORRECTED_ECC_ERR (EGR_DOI_BIT_BASE + 18)
#define EGR_DOI_CELL_QUEUE_3_UNCORRECTED_ECC_ERR      (EGR_DOI_BIT_BASE + 19)
...
/* EVENT_FIFO_SER_ERR[3:0], each bit for a fifo */
#define ING_DII_EVENT_FIFO0_SER_ERR                   (ING_DII_BIT_BASE + 3)
#define ING_DII_EVENT_FIFO1_SER_ERR                   (ING_DII_BIT_BASE + 4)
#define ING_DII_EVENT_FIFO2_SER_ERR                   (ING_DII_BIT_BASE + 5)
#define ING_DII_EVENT_FIFO3_SER_ERR                   (ING_DII_BIT_BASE + 6)
...
#define ING_DOI_EVENT_FIFO_0_UNCORRECTED_ECC_ERR      (ING_DOI_BIT_BASE + 3)
#define ING_DOI_CELL_QUEUE_0_UNCORRECTED_ECC_ERR      (ING_DOI_BIT_BASE + 4)
#define ING_DOI_SLOT_PIPELINE_0_UNCORRECTED_ECC_ERR   (ING_DOI_BIT_BASE + 5)
#define ING_DOI_EVENT_FIFO_1_READ_FAIL                (ING_DOI_BIT_BASE + 6)
#define ING_DOI_EVENT_FIFO_1_WRITE_FAIL               (ING_DOI_BIT_BASE + 7)
#define ING_DOI_EVENT_FIFO_1_UNCORRECTED_ECC_ERR      (ING_DOI_BIT_BASE + 8)
#define ING_DOI_CELL_QUEUE_1_UNCORRECTED_ECC_ERR      (ING_DOI_BIT_BASE + 9)
#define ING_DOI_SLOT_PIPELINE_1_UNCORRECTED_ECC_ERR   (ING_DOI_BIT_BASE + 10)
#define ING_DOI_EVENT_FIFO_2_READ_FAIL                (ING_DOI_BIT_BASE + 11)
#define ING_DOI_EVENT_FIFO_2_WRITE_FAIL               (ING_DOI_BIT_BASE + 12)
#define ING_DOI_EVENT_FIFO_2_UNCORRECTED_ECC_ERR      (ING_DOI_BIT_BASE + 13)
#define ING_DOI_CELL_QUEUE_2_UNCORRECTED_ECC_ERR      (ING_DOI_BIT_BASE + 14)
#define ING_DOI_SLOT_PIPELINE_2_UNCORRECTED_ECC_ERR   (ING_DOI_BIT_BASE + 15)
#define ING_DOI_EVENT_FIFO_3_READ_FAIL                (ING_DOI_BIT_BASE + 16)
#define ING_DOI_EVENT_FIFO_3_WRITE_FAIL               (ING_DOI_BIT_BASE + 17)
#define ING_DOI_EVENT_FIFO_3_UNCORRECTED_ECC_ERR      (ING_DOI_BIT_BASE + 18)
#define ING_DOI_CELL_QUEUE_3_UNCORRECTED_ECC_ERR      (ING_DOI_BIT_BASE + 19)
