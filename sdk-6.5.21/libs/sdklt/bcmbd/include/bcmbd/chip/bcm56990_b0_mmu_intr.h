/*! \file bcm56990_b0_mmu_intr.h
 *
 * MMU interrupt sources for BCM56990_B0.
 */
/*
...
#ifndef BCM56990_B0_MMU_INTR_H
#define BCM56990_B0_MMU_INTR_H
...
#define GLB_NUM_BITS                            3
#define MMU_INTR_GLB_MEM_PAR_ERR                (GLB_BIT_BASE + 0)
#define MMU_INTR_GLB_TS_OVERFLOW                (GLB_BIT_BASE + 1)
#define MMU_INTR_GLB_TS_UNDERFLOW               (GLB_BIT_BASE + 2)
...
#define MMU_INTR_THDR_CNT_OVERFLOW              (THDR_BIT_BASE + 0)
#define MMU_INTR_THDR_CNT_UNDERFLOW             (THDR_BIT_BASE + 1)

/* MMU_CFAP_INT */
#define CFAP_BIT_BASE                           (THDR_BIT_BASE + THDR_NUM_BITS)
#define CFAP_NUM_BITS                           1
#define MMU_INTR_CFAP_STACK_ERROR               (CFAP_BIT_BASE + 0)

/* MMU_THDO_CPU_INT */
#define THDO_BIT_BASE                           (CFAP_BIT_BASE + CFAP_NUM_BITS)
...
#define MAX_MMU_INTR                            (THDO_BIT_BASE + THDO_NUM_BITS)

/*! \} */

#endif /* BCM56990_B0_MMU_INTR_H */
