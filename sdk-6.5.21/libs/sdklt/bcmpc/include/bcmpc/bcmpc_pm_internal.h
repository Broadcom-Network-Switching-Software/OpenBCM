...
#define BCMPC_LANE_CFG_SET(_core, _lane, _bits, _val) \
            (_core |= ((_val & ((1 << _bits) - 1)) << (_lane * _bits)))
 ...
 *
 * This function is called when we INSERT or Update prbs config
 *
 * \param [in] unit Unit number.
 * \param [in] port_lane Combination of port and lane.
 * \param [in] prbs_control PRBS configuration.
 *
 * \retval SHR_E_NONE No errors.
 * \retval SHR_E_FAIL Failure.
 */
extern int
bcmpc_internal_phy_prbs_control_set(int unit, bcmpc_port_lane_t *port_lane,
                                    bcmpc_phy_prbs_control_t *prbs_control);

/*!
 * \brief Delete Phy PRBS configuration.
 *
 * This function is called when we delete prbs config
 *
 * \param [in] unit Unit number.
 * \param [in] port_lane Combination of port and lane.
 *
 ...
 */
extern int
bcmpc_internal_phy_prbs_control_delete(int unit, bcmpc_port_lane_t *port_lane);

/*!
 * \brief Set Port Diag configuration.
 *
 * This function is called when we INSERT or Update diag config
 *
 * \param [in] unit Unit number.
 * \param [in] lport logical port.
 * \param [in] diag_control PRBS configuration.
 *
 * \retval SHR_E_NONE No errors.
 * \retval SHR_E_FAIL Failure.
 */
extern int
bcmpc_internal_port_diag_control_set(int unit, bcmpc_lport_t *lport,
                                     bcmpc_port_diag_control_t *diag_control);

/*!
 * \brief Delete Port Diag configuration.
 *
 * This function is called when we delete diag config
 *
 * \param [in] unit Unit number.
 * \param [in] lport logical port
 *
 ...
 */
extern int
bcmpc_internal_port_diag_control_delete(int unit, bcmpc_lport_t *lport);
