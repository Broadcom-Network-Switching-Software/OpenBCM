...
typedef struct bcmpc_pmgr_phy_status_s {
    ...
    /*! Phy AutoNeg FEC Override status */
    uint32_t phy_autoneg_fec_override;
...
typedef struct bcmpc_pmgr_port_diag_stats_s {
    ...
    uint64_t fec_corrected_blocks;

    /*! FEC uncorrected block counter for Base-R FEC */
    uint64_t fec_uncorrected_blocks;
...
/*!
 * \brief Phy PRBS control set function.
 *
 ...
 * \param [in] port_lane combination of port and lane.
 * \param [in] pport Physical port number.
 * \param [in] pctrl Phy prbs config info
 *
 * \retval SHR_E_NONE No errors.
 * \retval SHR_E_FAIL Failure.
 */
...
bcmpc_pmgr_phy_prbs_control_set(int unit, bcmpc_port_lane_t *port_lane,
                                bcmpc_pport_t pport, bcmpc_phy_prbs_control_t *pctrl);

/*!
 * \brief Phy PRBS control delete function.
 *
...
/*!
 * \brief Get the phy prbs status of the given port-lane
 *
 * \param [in] unit Unit number.
 * \param [in] port_lane combination of logical port and lane index.
 * \param [out] pst phy prbs status buffer for the given physical port.
 *
 * \retval SHR_E_NONE No errors.
 */
extern int
...
/*!
 * \brief Port Diag control set function.
 *
 ...
 * \param [in] lport Logical port.
 * \param [in] pport Physical port number.
 * \param [in] pctrl Port diag config info
 *
 * \retval SHR_E_NONE No errors.
 * \retval SHR_E_FAIL Failure.
 */
...
bcmpc_pmgr_port_diag_control_set(int unit, bcmpc_lport_t *lport,
                                 bcmpc_pport_t pport, bcmpc_port_diag_control_t *pctrl);

/*!
 * \brief Port Diag control delete function.
 *
