...
#ifndef BCMPC_LTH_PORT_STATUS_H
#define BCMPC_LTH_PORT_STATUS_H

#include <bcmltd/bcmltd_handler.h>

/*!
 * \brief PC_PORT_STATUS table validation.
 *
...
/*!
 * \brief PC_PORT_STATUS table insert.
 *
 * \param [in] unit Unit Number.
...
/*!
 * \brief PC_PORT_STATUS table lookup.
 *
 * \param [in] unit Unit Number.
 * \param [in] op_arg Operation arguments.
 * \param [in] in Input field values.
...
/*!
 * \brief PC_PORT_STATUS table delete.
 *
 * \param [in] unit Unit Number.
 * \param [in] op_arg Operation arguments.
 * \param [in] in Input field values.
...
/*!
 * \brief PC_PORT_STATUS table update.
 *
 * \param [in] unit Unit Number.
 * \param [in] op_arg Operation arguments.
 * \param [in] in Input field values.
...
/*!
 * \brief PC_PORT_STATUS traverse get first.
 *
 * Get the first PC_PORT_STATUS LT entry.
 *
 * \param [in] unit Unit Number.
 * \param [in] op_arg Operation arguments.
...
/*!
 * \brief PC_PORT_STATUS traverse get next.
 *
 * Get the next PC_PORT_STATUS LT entry.
 *
 * \param [in] unit Unit Number.
 * \param [in] op_arg Operation arguments.
 * \param [in] in Input field values.
 ...
 */
extern int
bcmpc_lth_port_status_table_entry_inuse_get(int unit,
                     uint32_t trans_id,
                     bcmltd_sid_t sid,
