/*! \file bcmpc_lth_phy_prbs_status.h
 *
 ...
 * the logical table custom handlers for PC_PHY_PRBS_STATUS.
 */
/*
...
#ifndef BCMPC_LTH_PHY_PRBS_STATUS_H
#define BCMPC_LTH_PHY_PRBS_STATUS_H

#include <bcmltd/bcmltd_handler.h>

/*!
 * \brief PC_PHY_PRBS_STATUS table validation.
 *
...
/*!
 * \brief PC_PHY_PRBS_STATUS table insert.
 *
 * \param [in] unit Unit Number.
...
/*!
 * \brief PC_PHY_PRBS_STATUS table lookup.
 *
 * \param [in] unit Unit Number.
 * \param [in] op_arg Operation arguments.
 * \param [in] in Input field values.
...
/*!
 * \brief PC_PHY_PRBS_STATUS table delete.
 *
 * \param [in] unit Unit Number.
 * \param [in] op_arg Operation arguments.
 * \param [in] in Input field values.
...
/*!
 * \brief PC_PHY_PRBS_STATUS table update.
 *
 * \param [in] unit Unit Number.
 * \param [in] op_arg Operation arguments.
 * \param [in] in Input field values.
...
/*!
 * \brief PC_PHY_PRBS_STATUS traverse get first.
 *
 * Get the first PC_PHY_PRBS_STATUS LT entry.
 *
 * \param [in] unit Unit Number.
 * \param [in] op_arg Operation arguments.
...
/*!
 * \brief PC_PHY_PRBS_STATUS traverse get next.
 *
 * Get the next PC_PHY_PRBS_STATUS LT entry.
 *
 * \param [in] unit Unit Number.
 * \param [in] op_arg Operation arguments.
 * \param [in] in Input field values.
...
bcmpc_lth_phy_prbs_status_table_max_entries_set(int unit,
                     ...
                     const bcmltd_generic_arg_t *arg);
#endif /* BCMPC_LTH_PHY_PRBS_STATUS_H */
