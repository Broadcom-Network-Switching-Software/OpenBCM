...
/*!
 * \brief Set PM TSC power.
 *
 * \param [in] unit Unit number
 * \param [in] pport Device physical port.
 * \param [in] Enable Enable/disable PM TSC power.
 *
 * \retval SHR_E_NONE No errors.
 * \retval SHR_E_FAIL Failure.
 */
typedef int
(*bcmpc_pmgr_pm_tsc_power_on_set_f)(int unit, bcmpc_pport_t pport, int enble);
 ...
 */
typedef int
(*bcmpc_pmgr_port_interrupt_process_f)(int unit,
                                       bcmpc_pport_t pport,
                                       bcmpc_intr_type_t intr_type,
                                       uint32_t *is_handled);

/*!
 * \brief Set the phy prbs control of the given port and lane.
 *
 * See \ref bcmpc_pmgr_phy_prbs_control_set
 *
 * \param [in] unit Unit number.
 * \param [in] port_lane pointer to data structure of port_lane.
 * \param [in] pport Device physical port.
 * \param [in] pctrl Prbs control to be configured.
 *
 * \retval SHR_E_NONE No errors.
 * \retval SHR_E_FAIL Failure.
 */
typedef int
(*bcmpc_pmgr_phy_prbs_control_set_f)(int unit, bcmpc_port_lane_t *port_lane,
                                     bcmpc_pport_t pport,
                                     bcmpc_phy_prbs_control_t *pctrl);

/*!
 * \brief Delete the phy prbs control of the given port and lane.
 *
 * See \ref bcmpc_pmgr_phy_prbs_control_delete.
 *
 * \param [in] unit Unit number.
 * \param [in] port_lane pointer to data structure of port_lane.
 * \param [in] pport Device physical port.
 ...
 */
typedef int
(*bcmpc_pmgr_phy_prbs_control_delete_f)(int unit, bcmpc_port_lane_t *port_lane,
                                        bcmpc_pport_t pport);

/*!
 * \brief Get the phy prbs status for the given port and lane.
 *
 * See \ref bcmpc_pmgr_phy_prbs_control_delete.
 *
 * \param [in] unit Unit number.
 * \param [in] port_lane pointer to data structure of port_lane.
 * \param [in] pport Device physical port.
 * \param [out] pst PRBS status returned
 *
 * \retval SHR_E_NONE No errors.
 * \retval SHR_E_FAIL Failure.
 */
typedef int
(*bcmpc_pmgr_phy_prbs_status_get_f)(int unit, bcmpc_port_lane_t *port_lane,
                                    bcmpc_pport_t pport,
                                    bcmpc_phy_prbs_status_t *pst);

/*!
 * \brief Power cycle PM.
 *
 * \param [in] unit Unit number
 * \param [in] lport Logical port number.
 *
 ...
 */
typedef int
(*bcmpc_pmgr_pm_tsc_power_cycle_f)(int unit, bcmpc_pport_t pport);

/*!
 * \brief Set the port diag control of the given port.
 *
 * See \ref bcmpc_pmgr_port_diag_control_set
 *
 * \param [in] unit Unit number.
 * \param [in] port pointer to logical port.
 * \param [in] pport Device physical port.
 * \param [in] pctrl diag control to be configured.
 *
 * \retval SHR_E_NONE No errors.
 * \retval SHR_E_FAIL Failure.
 */
typedef int
(*bcmpc_pmgr_port_diag_control_set_f)(int unit, bcmpc_lport_t *lport,
                                      bcmpc_pport_t pport,
                                      bcmpc_port_diag_control_t *pctrl);

/*!
 * \brief Delete the port diag control of the given port.
 *
 * See \ref bcmpc_pmgr_port_diag_control_delete.
 *
 * \param [in] unit Unit number.
 * \param [in] lport pointer to logical port.
 * \param [in] pport Device physical port.
 *
 * \retval SHR_E_NONE No errors.
 * \retval SHR_E_FAIL Failure.
 */
typedef int
(*bcmpc_pmgr_port_diag_control_delete_f)(int unit,
                                         bcmpc_pport_t pport);
...
typedef struct bcmpc_pmgr_drv_s {
    ...
    /*! PM TSC power on. */
    bcmpc_pmgr_pm_tsc_power_on_set_f pm_tsc_power_on_set;
    ...
    /*! PRBS config update */
    bcmpc_pmgr_phy_prbs_control_set_f pm_phy_prbs_control_set;

    /*! PRBS config delete */
    bcmpc_pmgr_phy_prbs_control_delete_f pm_phy_prbs_control_delete;

    /*! PRBS status get */
    bcmpc_pmgr_phy_prbs_status_get_f pm_phy_prbs_status_get;

    /*! Power cycle PM. */
    bcmpc_pmgr_pm_tsc_power_cycle_f pm_tsc_power_cycle;

    /*! Port Diag config update */
    bcmpc_pmgr_port_diag_control_set_f pm_port_diag_control_set;

    /*! Port Diag config delete */
    bcmpc_pmgr_port_diag_control_delete_f pm_port_diag_control_delete;
