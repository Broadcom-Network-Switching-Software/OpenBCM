/*! \file bcmpc_lth_pmd_firmware_status.h
 *
 ...
 * the logical table custom handlers for PC_PMD_FIRMWARE_STATUS.
 */
/*
...
#ifndef BCMPC_LTH_PMD_FIRMWARE_STATUS_H
#define BCMPC_LTH_PMD_FIRMWARE_STATUS_H

#include <bcmltd/bcmltd_handler.h>

/*!
 * \brief PC_PMD_FIRMWARE_STATUS table validation.
 *
 * \param [in] unit Unit Number.
 * \param [in] opcode L opcode.
...
/*!
 * \brief PC_PMD_FIRMWARE_STATUS table insert.
 *
 * \param [in] unit Unit Number.
...
/*!
 * \brief PC_PMD_FIRMWARE_STATUS table lookup.
 *
 * \param [in] unit Unit Number.
 * \param [in] op_arg Operation arguments.
 * \param [in] in Input field values.
...
/*!
 * \brief PC_PMD_FIRMWARE_STATUS table delete.
 *
 * \param [in] unit Unit Number.
 * \param [in] op_arg Operation arguments.
 * \param [in] in Input field values.
...
/*!
 * \brief PC_PMD_FIRMWARE_STATUS table update.
 *
 * \param [in] unit Unit Number.
 * \param [in] op_arg Operation arguments.
 * \param [in] in Input field values.
...
/*!
 * \brief PC_PMD_FIRMWARE_STATUS traverse get first.
 *
 * Get the first PC_PMD_FIRMWARE_STATUS LT entry.
 *
 * \param [in] unit Unit Number.
 * \param [in] op_arg Operation arguments.
...
/*!
 * \brief PC_PMD_FIRMWARE_STATUS traverse get next.
 *
 * Get the next PC_PMD_FIRMWARE_STATUS LT entry.
 *
 * \param [in] unit Unit Number.
 * \param [in] op_arg Operation arguments.
 * \param [in] in Input field values.
 ...
 */
extern int
bcmpc_lth_pmd_firmware_status_table_entry_inuse_get(int unit,
                     uint32_t trans_id,
                     bcmltd_sid_t sid,
 ...
 */
extern int
bcmpc_lth_pmd_firmware_status_table_max_entries_set(int unit,
                     uint32_t trans_id,
                     bcmltd_sid_t sid,
                     const bcmltd_table_max_entries_arg_t *table_arg,
                     const bcmltd_table_max_entries_t *table_data,
                     const bcmltd_generic_arg_t *arg);
#endif /* BCMPC_LTH_PMD_FIRMWARE_STATUS_H */
