/*! \file bcmpc_pm_drv_pm8x100_common.h
 *
...
#ifndef BCMPC_PM_DRV_PM8X100_COMMON_H
#define BCMPC_PM_DRV_PM8X100_COMMON_H

/* !  RLM state definitions.
 * Defines:
 *     pm8x100_common_port_rlm_fsm_t *
 * Purpose:
 *     Valid values Reduced Lane Mode state
 */
typedef enum pm8x100_common_port_rlm_fsm_e {
    PM8X100_COMMON_PORT_RLM_SEND_PACKET_DATA,  /*entry state for RLM */
    PM8X100_COMMON_PORT_RLM_STOP_MAC,          /* STALL TX */
    PM8X100_COMMON_PORT_RLM_SEND_LI,           /* SEND link interrupt protocol */
    PM8X100_COMMON_PORT_RLM_SEND_PRBS,         /* SEND prbs data  */
    PM8X100_COMMON_PORT_RLM_SEND_IDLE,         /* send idle */
    PM8X100_COMMON_PORT_RLM_DONE,              /* RLM transition done */
    PM8X100_COMMON_PORT_RLM_ERROR,             /* RLM error state */
 ...
 */
int
pm8x100_common_port_lag_failover_loopback_get(int unit, const pm_access_t *pm_acc,
                                         pm_oper_status_t *op_st,
...
/*!
 * \brief Set FEC error inject (diag control) for a port
 *
 * \param [in] unit Unit number.
 * \param [in] pm_acc MAC and PHY access information structure.
 * \param [in] pm_info PM state structure.
 * \param [in] port_diag_ctrl FEC Error inject information
 *
 * \retval SHR_E_NONE No errors.
 * \retval SHR_E_PARAM Invalid input parameter.
 * \retval SHR_E_ACCESS Failed to access the register.
...
#endif /* BCMPC_PM_DRV_PM8x100_COMMON_H */
