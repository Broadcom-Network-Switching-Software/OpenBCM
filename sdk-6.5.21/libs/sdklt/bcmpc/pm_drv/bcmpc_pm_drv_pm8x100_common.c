/*! \file bcmpc_pm_drv_pm8x100_common.c
 *
 * PM common driver for PM8X100.
 */
/*
...
/* Number of PMD lanes per core in PM8x100. */
#define PM8X100_COMMON_NUM_LANES_PER_CORE 8

#define PM8X100_COMMON_NRZ_LANE_SPEED_MAX 25000
#define PM8X100_COMMON_50G_PAM4_LANE_SPEED_MAX 50000
#define PM8X100_COMMON_PHY_SIGNALLING_MODE_GET(speed, num_lanes) \
        (speed/num_lanes) > PM8X100_COMMON_50G_PAM4_LANE_SPEED_MAX ? \
                        phymodSignallingMethodPAM4 : \
        (speed/num_lanes) > PM8X100_COMMON_NRZ_LANE_SPEED_MAX ? \
...
int
pm8x100_common_pm_destroy(int unit, pm_info_t *pm_info)
{
...
int
pm8x100_common_port_speed_config_get(int unit, const pm_access_t *pm_acc,
                                    ...
                                    pm_speed_config_t *speed_config)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (pm8x100_common_port_pmd_lane_cfg_get(unit, pm_acc, op_st, pm_info,
...
int
pm8x100_common_port_loopback_set(int unit, const pm_access_t *pm_acc,
                                pm_oper_status_t *op_st, pm_info_t *pm_info,
...
int
pm8x100_common_port_loopback_get(int unit, const pm_access_t *pm_acc,
                                pm_oper_status_t *op_st, pm_info_t *pm_info,
                                pm_loopback_mode_t loopback_type, int *enable)
{
    int rv = PHYMOD_E_NONE;
    ...
    switch (loopback_type) {
        ...
        case PM_PORT_LPBK_REMOTE_PCS:
        default:
            rv = phymod_phy_loopback_get(phy_acc,phymodLoopbackRemotePCS,
                                         &lpbk_en);
...
int
pm8x100_common_port_encap_get(int unit, const pm_access_t *pm_acc,
                             pm_oper_status_t *op_st, pm_info_t *pm_info,
                             pm_encap_t *encap)
{
    bcmpmac_drv_t *pmacd;
...
int
pm8x100_common_port_encap_set(int unit, const pm_access_t *pm_acc,
                             pm_oper_status_t *op_st, pm_info_t *pm_info,
                             pm_encap_t encap)
{
    bcmpmac_drv_t *pmacd;
    ...
    status = PM_MAC_OPER_ERROR;
    SHR_IF_ERR_VERBOSE_EXIT(pm8x100_common_port_encap_get(unit, pm_acc, op_st,
                                                     pm_info, &current_encap));

    if (encap == BCMPMAC_ENCAP_HG3) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmpc_pm_drv_pm8x100.pm_mac_avg_ipg_get(unit, pm_acc, op_st,
                                                    pm_info, &ipg_size));
...
int
pm8x100_common_port_pause_ctrl_set(int unit, const pm_access_t *pm_acc,
                                  pm_oper_status_t *op_st, pm_info_t *pm_info,
...
int
pm8x100_common_port_pause_ctrl_get(int unit, const pm_access_t *pm_acc,
                                  pm_oper_status_t *op_st, pm_info_t *pm_info,
                                  pm_pause_ctrl_t *pause_ctrl)
{
    bcmpmac_drv_t *pmacd;
...
int
pm8x100_common_port_pause_addr_set(int unit, const pm_access_t *pm_acc,
                                  pm_oper_status_t *op_st, pm_info_t *pm_info,
                                  pm_mac_t pause_addr)
{
    bcmpmac_drv_t *pmacd;
...
int
pm8x100_common_port_pause_addr_get(int unit, const pm_access_t *pm_acc,
                                  pm_oper_status_t *op_st, pm_info_t *pm_info,
                                  pm_mac_t pause_addr)
{
    bcmpmac_drv_t *pmacd;
...
int
pm8x100_common_port_frame_max_set(int unit, const pm_access_t *pm_acc,
                                 pm_oper_status_t *op_st, pm_info_t *pm_info,
...
int
pm8x100_common_port_frame_max_get(int unit, const pm_access_t *pm_acc,
                                 pm_oper_status_t *op_st, pm_info_t *pm_info,
                                 uint32_t *max_frame_size)
{
    bcmpmac_drv_t *pmacd;
...
int
pm8x100_common_port_enable_set(int unit, const pm_access_t *pm_acc,
                              pm_oper_status_t *op_st, pm_info_t *pm_info,
                              uint32_t flag,  uint32_t enable)
{
    ...
    if (flag & PM_PORT_ENABLE_PHY) {
        status = PM_PHY_OPER_ERROR;
        if ((pm_info->type == PM_TYPE_PM8X100) && bcmdrd_feature_is_real_hw(unit))  {
            SHR_IF_ERR_VERBOSE_EXIT
...
int
pm8x100_common_port_enable_get(int unit, const pm_access_t *pm_acc,
                              pm_oper_status_t *op_st, pm_info_t *pm_info,
                              uint32_t flag, uint32_t *enable)
{
...
int
pm8x100_common_port_lag_failover_loopback_get(int unit,
...
int
pm8x100_common_port_tx_set(int unit, const pm_access_t *pm_acc,
                          pm_oper_status_t *op_st, pm_info_t *pm_info,
                          phymod_tx_t *tx_cfg)
{
    const phymod_phy_access_t *phy_acc = &(pm_acc->phy_acc);
...
int
pm8x100_common_port_tx_get(int unit, const pm_access_t *pm_acc,
                          pm_oper_status_t *op_st, pm_info_t *pm_info,
                          phymod_tx_t *tx_cfg)
{
    const phymod_phy_access_t *phy_acc = &(pm_acc->phy_acc);
...
int
pm8x100_common_port_pmd_lane_cfg_get(int unit, const pm_access_t *pm_acc,
                                    pm_oper_status_t *op_st, pm_info_t *pm_info,
...
int
pm8x100_common_port_failover_enable_set(int unit, const pm_access_t *pm_acc,
                                       pm_oper_status_t *op_st,
                                       pm_info_t *pm_info,
                                       uint32_t enable)
{
...
int
pm8x100_common_port_failover_enable_get(int unit, const pm_access_t *pm_acc,
                                       pm_oper_status_t *op_st,
                                       pm_info_t *pm_info,
                                       uint32_t *enable)
{
...
int
pm8x100_common_port_link_training_set(int unit, const pm_access_t *pm_acc,
                                     pm_oper_status_t *op_st,
                                     pm_info_t *pm_info,
                                     uint32_t enable)
{
...
int
pm8x100_common_port_link_training_get(int unit, const pm_access_t *pm_acc,
                                     pm_oper_status_t *op_st,
                                     pm_info_t *pm_info,
                                     uint32_t *enable)
{
...
int
pm8x100_common_phy_status_get(int unit, const pm_access_t *pm_acc,
                             pm_oper_status_t *op_st, pm_info_t *pm_info,
                             pm_phy_status_t *phy_st)
{
   ...
   /* get the tx pi override value */
    ...
    SHR_IF_ERR_EXIT
        (phymod_phy_fec_override_get(phy_acc,
                                     &phy_st->phy_autoneg_fec_override));
exit:
    SHR_FUNC_EXIT();
}

int
pm8x100_common_phy_control_set(int unit, const pm_access_t *pm_acc,
                              pm_oper_status_t *op_st, pm_info_t *pm_info,
                              uint32_t flags, pm_phy_control_t *pctrl)
{
    ...
    if (flags & PM_PHY_CTRL_F_AUTONEG_FEC_OVERRIDE) {
        PHY_IF_ERR_EXIT
            (phymod_phy_fec_override_set(phy_acc, pctrl->phy_autoneg_fec_override));
    }
...
int
pm8x100_common_avg_ipg_get(int unit, const pm_access_t *pm_acc,
                          pm_oper_status_t *op_st, pm_info_t *pm_info,
                          uint8_t *ipg_size)
{
    bcmpmac_drv_t *pmacd;
...
int
pm8x100_common_avg_ipg_set(int unit, const pm_access_t *pm_acc,
                          pm_oper_status_t *op_st, pm_info_t *pm_info,
                          uint8_t ipg_size)
{
    bcmpmac_drv_t *pmacd;
...
int
pm8x100_common_port_synce_clk_ctrl_set(int unit, const pm_access_t *pm_acc,
                                      pm_oper_status_t *op_st,
                                      pm_info_t *pm_info,
...
int
pm8x100_common_port_synce_clk_ctrl_get(int unit, const pm_access_t *pm_acc,
                                      pm_oper_status_t *op_st,
                                      pm_info_t *pm_info,
                                      pm_port_synce_clk_ctrl_t *cfg)
{
...
int
pm8x100_common_port_link_training_status_get(int unit, const pm_access_t *pm_acc,
                                            pm_oper_status_t *op_st,
                                            pm_info_t *pm_info,
                                            uint32_t *locked)
{
...
int
pm8x100_common_port_default_tx_taps_config_get(int unit, const pm_access_t *pm_acc,
                                               pm_oper_status_t *op_st, pm_info_t *pm_info,
                                               pm_speed_config_t *speed_config,
                                               phymod_tx_t *tx_taps_config)
{
    ...
    sig_mode = PM8X100_COMMON_PHY_SIGNALLING_MODE_GET(speed_config->speed,
...
int
pm8x100_common_phy_polarity_get(int unit, const pm_access_t *pm_acc,
                                pm_oper_status_t *op_st, pm_info_t *pm_info,
...
int
pm8x100_common_core_lane_map_get(int unit, const pm_access_t *pm_acc,
                                 pm_oper_status_t *op_st, pm_info_t *pm_info,
...
int
pm8x100_common_port_tx_timestamp_info_get(int unit, const pm_access_t *pm_acc,
                                        pm_oper_status_t *op_st,
                                        pm_info_t *pm_info,
...
int
pm8x100_common_phy_rsfec_uncorrectable_counter_get(int unit,
                                                   const pm_access_t *pm_acc,
                                                   pm_info_t *pm_info,
                                                   uint64_t *count)
{
...
int
pm8x100_common_phy_rsfec_correctable_counter_get(int unit,
                                                 const pm_access_t *pm_acc,
                                                 pm_info_t *pm_info,
                                                 uint64_t *count)
{
...
int
pm8x100_common_phy_rsfec_symbol_error_counter_get(int unit,
                                                  const pm_access_t *pm_acc,
                                                  pm_info_t *pm_info,
                                                  uint64_t *count)
{
    uint32_t err_count[PM8X100_COMMON_NUM_LANES_PER_CORE];
    int i, actual_count;
    ...
    *count = 0;
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (phymod_phy_rsfec_symbol_error_counter_get(phy_acc,
                                                   PM8X100_COMMON_NUM_LANES_PER_CORE,
                                                   &actual_count,
                                                   err_count));

    for (i = 0; i < PM8X100_COMMON_NUM_LANES_PER_CORE; i++) {
        if (i < actual_count) {
            *count += err_count[i];
        } else {
            break;
...
int
pm8x100_common_diag_control_set (int unit,
                                 const pm_access_t *pm_acc,
                                 pm_info_t *pm_info,
                                 pm_port_diag_control_t port_diag_ctrl)
{
    ...
    bit_error_mask.error_mask_bit_31_0 = (0xFFFFFFFF & port_diag_ctrl.error_mask_63_0);
    bit_error_mask.error_mask_bit_63_32 = (0xFFFFFFFF & (port_diag_ctrl.error_mask_63_0 >> 32));
    bit_error_mask.error_mask_bit_79_64 = (0xFFFF & port_diag_ctrl.error_mask_127_64);

    SHR_IF_ERR_VERBOSE_EXIT
        (phymod_phy_fec_error_inject_set(phy_acc,
                                         (uint16_t)(port_diag_ctrl.error_control_map),
                                         bit_error_mask));
exit:
    SHR_FUNC_EXIT();
}
