...
static void
bcm56880_a0_pc_port_intr_func(int unit, uint32_t intr_param)
{
    int rv, i;
    bcmpc_lport_t lport = BCMPC_INVALID_LPORT;
    bcmpc_pport_t pport = PORT_INTR_INST_GET(intr_param);
    bcmpc_intr_type_t intr_type = BCMPC_INTR_ECC_1B_ERR_BASE_R_FEC;
    uint32_t intr_num = PORT_INTR_PARAM_GET(intr_param);
    uint32_t is_handled = 0;
    CDPORT_TSC_INTR_STATUSr_t cdp_stat;
    uint32_t ecc_bitmap;
    uint32_t ecc_type_mask;
    enum {
        TSC_ECC_1B_ERR_BASE_R_FEC = 0,
        TSC_ECC_1B_ERR_RSFEC_RBUF_MPP0 = 1,
        TSC_ECC_1B_ERR_RSFEC_RBUF_MPP1 = 2,
        TSC_ECC_1B_ERR_RSFEC_MPP0 = 3,
        TSC_ECC_1B_ERR_RSFEC_MPP1 = 4,
        TSC_ECC_1B_ERR_DESKEW = 5,
        TSC_ECC_1B_ERR_SPEED = 6,
        TSC_ECC_1B_ERR_AM = 7,
        TSC_ECC_1B_ERR_UM = 8,
        TSC_ECC_1B_ERR_TX_1588_MPP0 = 9,
        TSC_ECC_1B_ERR_TX_1588_MPP1 = 10,
        TSC_ECC_1B_ERR_TX_1588_400G = 11,
        TSC_ECC_1B_ERR_RX_1588_MPP0 = 12,
        TSC_ECC_1B_ERR_RX_1588_MPP1 = 13,
        TSC_ECC_1B_ERR_RX_1588_400G = 14,
    };
    enum {
        TSC_ECC_2B_ERR_BASE_R_FEC = 0,
        TSC_ECC_2B_ERR_RSFEC_RBUF_MPP0 = 1,
        TSC_ECC_2B_ERR_RSFEC_RBUF_MPP1 = 2,
        TSC_ECC_2B_ERR_RSFEC_MPP0 = 3,
        TSC_ECC_2B_ERR_RSFEC_MPP1 = 4,
        TSC_ECC_2B_ERR_DESKEW = 5,
        TSC_ECC_2B_ERR_SPEED = 6,
        TSC_ECC_2B_ERR_AM = 7,
        TSC_ECC_2B_ERR_UM = 8,
        TSC_ECC_2B_ERR_TX_1588_MPP0 = 9,
        TSC_ECC_2B_ERR_TX_1588_MPP1 = 10,
        TSC_ECC_2B_ERR_TX_1588_400G = 11,
        TSC_ECC_2B_ERR_RX_1588_MPP0 = 12,
        TSC_ECC_2B_ERR_RX_1588_MPP1 = 13,
        TSC_ECC_2B_ERR_RX_1588_400G = 14,
    };

    switch (intr_num) {
        case CDPORT_INTR_TSC_CORE0_ERR:
        case CDPORT_INTR_TSC_CORE1_ERR:

            if (READ_CDPORT_TSC_INTR_STATUSr(unit, &cdp_stat, pport) != 0) {
                return;
            }
             ...
             */
            if ((ecc_bitmap = CDPORT_TSC_INTR_STATUSr_TSC_ECC_1B_ERRf_GET(cdp_stat))) {
                for (i = TSC_ECC_1B_ERR_BASE_R_FEC;
                        i <= TSC_ECC_1B_ERR_RX_1588_400G;
                        i++) {
                    ecc_type_mask = 1 << i;
                ...
                switch (i) {
                    case TSC_ECC_1B_ERR_BASE_R_FEC:
                        intr_type = BCMPC_INTR_ECC_1B_ERR_BASE_R_FEC;
                        break;
                    ...
                    case TSC_ECC_1B_ERR_UM:
                        ...
                        break;
                    case TSC_ECC_1B_ERR_TX_1588_MPP0:
                        intr_type = BCMPC_INTR_ECC_1B_ERR_TX_1588_MPP0;
                        break;
                    case TSC_ECC_1B_ERR_TX_1588_MPP1:
                        intr_type = BCMPC_INTR_ECC_1B_ERR_TX_1588_MPP1;
                        break;
                    case TSC_ECC_1B_ERR_TX_1588_400G:
                        intr_type = BCMPC_INTR_ECC_1B_ERR_TX_1588_400G;
                        break;
                    ...
                    case TSC_ECC_1B_ERR_RX_1588_MPP1:
                        ...
                        break;
                    case TSC_ECC_1B_ERR_RX_1588_400G:
                        intr_type = BCMPC_INTR_ECC_1B_ERR_RX_1588_400G;
                        break;
                    default:
            ...
            } else if ((ecc_bitmap = CDPORT_TSC_INTR_STATUSr_TSC_ECC_2B_ERRf_GET(cdp_stat))) {
                for (i = TSC_ECC_2B_ERR_BASE_R_FEC;
                        i <= TSC_ECC_2B_ERR_RX_1588_400G;
                        i++) {
                    ecc_type_mask = 1 << i;
                    if (ecc_bitmap & ecc_type_mask) {
                        break;
                ...
                switch (i) {
                    case TSC_ECC_2B_ERR_BASE_R_FEC:
                        intr_type = BCMPC_INTR_ECC_2B_ERR_BASE_R_FEC;
                        break;
                    ...
                    case TSC_ECC_2B_ERR_UM:
                        ...
                        break;
                    case TSC_ECC_2B_ERR_TX_1588_MPP0:
                        intr_type = BCMPC_INTR_ECC_2B_ERR_TX_1588_MPP0;
                        break;
                    case TSC_ECC_2B_ERR_TX_1588_MPP1:
                        intr_type = BCMPC_INTR_ECC_2B_ERR_TX_1588_MPP1;
                        break;
                    case TSC_ECC_2B_ERR_TX_1588_400G:
                        intr_type = BCMPC_INTR_ECC_2B_ERR_TX_1588_400G;
                        break;
                    ...
                    case TSC_ECC_2B_ERR_RX_1588_MPP1:
                        ...
                        break;
                    case TSC_ECC_2B_ERR_RX_1588_400G:
                        intr_type = BCMPC_INTR_ECC_2B_ERR_RX_1588_400G;
                        break;
                    default:
                        /* Unexpected interrupt */
                        return;
            ...
            rv = bcmpc_interrupt_process(unit, pport, intr_type,
                    &is_handled);
            if (SHR_FAILURE(rv)) {
                LOG_WARN(BSL_LOG_MODULE,
                        (BSL_META_U(unit,
                                    "Failed to process PHYMOD ECC interrupt on pport(%d)\n"),
                         pport));
            }
            ...
            if (SHR_FAILURE(rv)) {
                LOG_WARN(BSL_LOG_MODULE,
                        (BSL_META_U(unit,
                                    "Failed to clear PHYMOD ECC interrupt on pport(%d)\n"), pport));
            }
            break;
        default:
            /* Unexpected interrupt */
    ...
    if (lport == BCMPC_INVALID_LPORT) {
        LOG_WARN(BSL_LOG_MODULE,
                (BSL_META_U(unit,
                            "ECC intr on physical port(%d) intr_type (%d)\n"),
                 pport, intr_type));
    }
...
static int
bcm56880_a0_port_interrupt_set(int unit, bcmpc_pport_t pport,
                               bool intr_op)
{
    uint32_t i = 0;
    int pm_id;
    ...
    uint32_t intr_nums[] = {
                            CDPORT_INTR_TSC_CORE0_ERR,
                            CDPORT_INTR_TSC_CORE1_ERR,
                           };
    SHR_FUNC_ENTER(unit);
    ...
    SHR_IF_ERR_EXIT
        (bcm56880_a0_is_internal_port(unit, pport, &is_internal));
...
static int
bcm56880_a0_num_of_rx_dfe_tap_get(int unit, int pm_id, uint32_t *num_of_rx_taps)
{
    int rv;
    bcmpc_topo_t pm_info;
...
static bcmpc_drv_t bcm56880_a0_pc_drv = {
    ...
    .interrupt_set = bcm56880_a0_port_interrupt_set,
    .num_of_rx_dfe_tap_get = bcm56880_a0_num_of_rx_dfe_tap_get,
};
