/*! \file bcm56780_a0_pc_drv_attach.c
 *
 * BCM56780 device specific PC driver.
 */
/*
...
#include <bcmpmac/chip/bcm56780_a0_pmac_drv_list.h>
...
#define BCM56780_MAX_LPORTS 80
/*
 * 160 (20 * PM8X50) + 2 (1 * PM4X10) +
 * 1 CPU port + 2 (Internal Loopback ports) + 2 RDB ports.
 */
#define BCM56780_MAX_PPORTS 167
...
/* The port abilities that bcm56780 PM8x50 doesn't support. */
 ...
 */
static int
bcm56780_a0_tsce_reg_write(void *user_acc, uint32_t phy_addr,
 ...
 */
static int
bcm56780_a0_tsce_reg_read(void *user_acc, uint32_t phy_addr,
                          uint32_t reg_addr, uint32_t *val)
{
    int rv = SHR_E_NONE;
    int unit, port, idx;
 ...
 */
static int
bcm56780_a0_tscbh_reg_write(void *user_acc, uint32_t phy_addr,
                            uint32_t reg_addr, uint32_t val)
{
    int rv = SHR_E_NONE;
    int unit, port, idx;
 ...
 */
static int
bcm56780_a0_tscbh_reg_read(void *user_acc, uint32_t phy_addr,
                           uint32_t reg_addr, uint32_t *val)
{
    int rv = SHR_E_NONE;
    int unit, port, idx;
...
static int
bcm56780_a0_pc_phy_addr_get(int unit, bcmpc_pport_t pport);
 ...
 */
static int
bcm56780_a0_tsce_raw_reg_read(int unit, bcmpc_pport_t base_port,
                               uint32_t reg_addr, uint32_t *val)
{
    int rv = SHR_E_NONE;
    uint32_t data[16];
    ...
    phy_addr = (uint32_t)bcm56780_a0_pc_phy_addr_get(unit, base_port);
    TSC_REG_ADDR_TSCID_SET(reg_addr, phy_addr);
    data[0] = reg_addr & 0xffffffff ;
    data[2] = 0;
 ...
 */
static int
bcm56780_a0_tsce_raw_reg_write(int unit, bcmpc_pport_t base_port,
                               uint32_t reg_addr, uint32_t val)
{
    int rv = SHR_E_NONE;
    uint32_t data[16];
 ...
 */
static int
bcm56780_a0_tscbh_raw_reg_read(int unit, bcmpc_pport_t base_port,
                               uint32_t reg_addr, uint32_t *val)
{
    int rv = SHR_E_NONE;
    uint32_t data[16];
 ...
 */
static int
bcm56780_a0_tscbh_raw_reg_write(int unit, bcmpc_pport_t base_port,
                                uint32_t reg_addr, uint32_t val)
{
    int rv = SHR_E_NONE;
    uint32_t data[16];
 ...
 */
static int
bcm56780_a0_raw_reg_read(int unit, bcmpc_pport_t base_port,
                               uint32_t reg_addr, uint32_t *val)
{
    SHR_FUNC_ENTER(unit);
    ...
    if (base_port == 161) {
       SHR_IF_ERR_EXIT
            (bcm56780_a0_tsce_raw_reg_read(unit, base_port,  reg_addr, val));
    } else {
        SHR_IF_ERR_EXIT
            (bcm56780_a0_tscbh_raw_reg_read(unit, base_port,  reg_addr, val));
    }
 ...
 */
static int
bcm56780_a0_raw_reg_write(int unit, bcmpc_pport_t base_port,
                          uint32_t reg_addr, uint32_t val)
{
    SHR_FUNC_ENTER(unit);
    ...
    if (base_port == 161) {
        SHR_IF_ERR_EXIT
            (bcm56780_a0_tsce_raw_reg_write(unit, base_port, reg_addr, val));
    } else {
        SHR_IF_ERR_EXIT
            (bcm56780_a0_tscbh_raw_reg_write(unit, base_port, reg_addr, val));
    }
 ...
 */
static int
bcm56780_a0_tscbh_mem_read(void *user_acc, phymod_mem_type_t mem_type,
 ...
 */
static int
bcm56780_a0_tscbh_mem_write(void *user_acc, phymod_mem_type_t mem_type,
...
static phymod_bus_t bcm56780_a0_tsce_bus = {
    .bus_name = "TSCE Bus",
    .mutex_take = bcmpc_phymod_bus_mutex_take,
    .mutex_give = bcmpc_phymod_bus_mutex_give,
    .read = bcm56780_a0_tsce_reg_read,
    .write = bcm56780_a0_tsce_reg_write,
    .bus_capabilities = PHYMOD_BUS_CAP_WR_MODIFY | PHYMOD_BUS_CAP_LANE_CTRL
};

static phymod_bus_t bcm56780_a0_tscbh_bus = {
    .bus_name = "TSCBH Bus",
    .mutex_take = bcmpc_phymod_bus_mutex_take,
    .mutex_give = bcmpc_phymod_bus_mutex_give,
    .read = bcm56780_a0_tscbh_reg_read,
    .write = bcm56780_a0_tscbh_reg_write,
    .mem_read = bcm56780_a0_tscbh_mem_read,
    .mem_write = bcm56780_a0_tscbh_mem_write,
    .bus_capabilities = PHYMOD_BUS_CAP_WR_MODIFY | PHYMOD_BUS_CAP_LANE_CTRL
};
...
static int
pm_master_get(int unit, int pm_id, int *is_master_pm)
{
    if ((pm_id == 1 || pm_id == 10 || pm_id == 11 || pm_id == 20)) {
        *is_master_pm = 1;
    }
...
{
    bcmpc_sec_handler_t *hdl;
    bcmpc_is_pm_sec_enabled_f func;

    (void)bcmpc_sec_handler_get(unit, &hdl);
    if (!hdl) {
        return 0;
    }

    func = hdl->is_pm_sec_enabled;
    if (func) {
        return func(unit, pm_id);
    }
...
static int
bcm56780_a0_pm_type_create(int unit)
{
...
static int
bcm56780_a0_pm_instance_create(int unit, bool warm)
{
...
static int
bcm56780_a0_type_destroy(int unit, int tid, bcmpc_topo_type_t *tinfo,
                         void *cookie)
{
...
static int
bcm56780_a0_inst_destroy(int unit, int pm_id, bcmpc_topo_t *pm_info,
                         void *cookie)
{
...
static int
pm_master_set(int unit, int pm_id, bcmpc_topo_t *pm_info, void *cookie)
{
    int is_master = 0;

    pm_master_get(unit, pm_id, &is_master);

    (pm_info->pm_info->pm_data.pm_ha_info)->is_master_pm = is_master;
...
static int
bcm56780_a0_pc_pblk_get(int unit, bcmpc_pport_t pport,
...
bcm56780_a0_pc_phy_addr_get(int unit, bcmpc_pport_t pport)
{
     ...
     * Bus  0: PHYID 1-16 are mapped to physical ports 1-16
     * Bus  1: PHYID 1-16 are mapped to physical ports 17-32
     * Bus  2: PHYID 1-16 are mapped to physical ports 33-48
     * Bus  3: PHYID 1-8 are mapped to physical ports  49-56
     * Bus  4: PHYID 1-16 are mapped to physical ports 57-72
     * Bus  5: PHYID 1-24 are mapped to physical ports 73-96
     * Bus  6: PHYID 1-8 are mapped to physical ports  97-104
     * Bus  7: PHYID 1-16 are mapped to physical ports 105-120
     * Bus  8: PHYID 1-16 are mapped to physical ports 121-136
     * Bus  9: PHYID 1-8 are mapped to physical ports  137-144
     * Bus 10: PHYID 1-16 are mapped to physical ports 145-160
     * Bus 11: PHYID 1,3 are mapped to physical  ports 161,162
     */

    uint32_t ibus = 0, offset = 0, addr_mask = 0;

    if (pport > 166  || pport == CMIC_PORT) {
        return -1;
    }
    ...
    if (pport > 160) {
        ...
        if (pport >= 1 && pport <= 48) {
            ...
            offset = ibus * 16 + 1;
            addr_mask = ~0x7;
        } else if (pport >=49 && pport <= 56) {
            ibus = 3;
            offset = 49;
            addr_mask = ~0x7;
        } else if (pport >= 57 && pport<= 72){
            ibus = 4;
            offset = 57;
            addr_mask = ~0x7;
        } else if (pport >= 73 && pport <= 96) {
            ibus = 5;
            offset = 73;
            addr_mask = ~0x7;
        } else if (pport >= 97 && pport <= 104) {
            ibus = 6;
            offset = 97;
            addr_mask = ~0x7;
        } else if (pport >= 105 && pport <= 136) {
            ibus = (pport - 105) / 16 + 7;
            offset = 105 + (ibus - 7) * 16;
            addr_mask = ~0x7;
        } else if (pport >= 137 && pport <= 144) {
            ibus = 9;
            offset = 137;
            addr_mask = ~0x7;
        } else if (pport >= 145 && pport <= 160) {
            ibus = 10;
            offset = 145;
            addr_mask = ~0x7;
        }
    ...
    return ((pport - offset) & addr_mask) + 1 + BCM56780_A0_PC_MIIM_IBUS(ibus);
}

static phymod_bus_t *
bcm56780_a0_pc_phy_bus_get(int unit, bcmpc_pport_t pport)
{
    int rv, pm_id;
    bcmpc_topo_t pm_info;
    ...
    if (pm_info.tid == TD4_PM_TYPE_PM4X10) {
        ...
        if (bcmdrd_feature_enabled(unit, BCMDRD_FT_PHYMOD_SIM)) {
            ...
            phymod_sim_bus->mem_read = bcm56780_a0_tscbh_mem_read;
            phymod_sim_bus->mem_write = bcm56780_a0_tscbh_mem_write;
            return phymod_sim_bus;
        }
        return &bcm56780_a0_tscbh_bus;
    }
...
bcm56780_a0_pc_phy_drv_get(int unit, bcmpc_pport_t pport)
{
    int rv, pm_id;
    bcmpc_topo_t pm_info;
...
bcm56780_a0_pc_pmac_drv_get(int unit, bcmpc_pport_t pport)
{
    int rv, pm_id;
    bcmpc_topo_t pm_info;
    ...
    if (pm_info.tid == TD4_PM_TYPE_PM4X10) {
        return &bcm56780_a0_pmac_xlport;
    } else if (pm_info.tid == TD4_PM_TYPE_PM8X50) {
        return &bcm56780_a0_pmac_cdport;
    }
...
static uint8_t
bcm56780_a0_pc_phy_pll_idx_get(int unit, bcmpc_pport_t pport,
...
static bool
bcm56780_a0_pc_link_update_required(int unit, bcmpc_pport_t pport)
{
    int rv, pm_id;
    bcmpc_topo_t pm_info;
...
bcm56780_a0_pc_port_up_prof_get(int unit, bcmpc_pport_t pport)
{
    int rv, pm_id;
    bool is_macsec_port;
    ...
    static bcmpc_operation_t macsec_port_up_ops[] = {
        { "tm", "ep_credit", BCMPC_OP_PARAM_NONE },
        { "tm", "egr_up", 1 },
        { "tm", "ing_up", 1 },
        { "sec", "tx_up", 1},
        { "pmac", "rx_strip_crc_set", 1 },
        { "pmac", "tx_threshold_set", 3 },
        { "pmac", "tx_crc_mode", 0 },
        { "pmac", "speed_set", BCMPC_OP_PARAM_NONE },
        { "phy", "link_up_event", 0},
        { "pmac", "rx_enable", 1 },
    ...
    if (!bcm56780_a0_pc_link_update_required(unit, pport)) {
        return NULL;
    }
    ...
    /* If MACSEC enabled port, return MACSEC port up sequence. */
    is_macsec_port = bcm56780_a0_is_pm_sec_enabled(unit, pm_id);

    if (is_macsec_port) {
        port_up_prof.ops = macsec_port_up_ops;
        port_up_prof.op_cnt = COUNTOF(macsec_port_up_ops);
    } else {
...
static bcmpc_cfg_profile_t *
bcm56780_a0_pc_port_down_prof_get(int unit, bcmpc_pport_t pport)
{
    int rv, pm_id;
    bool is_macsec_port;
    ...
    static bcmpc_operation_t macsec_port_down_ops[] = {
        { "tm", "fwd_enable", 0 },
        { "pmac", "rx_enable", 0 },
        { "pmac", "tx_flush", 1 },
        { "pmac", "force_pfc_xon_set", 1 },
        ...
        { "tm", "egr_up", 0 },
        { "sec", "tx_up", 0},
        { "pmac", "rx_strip_crc_set", 0 },
        { "pmac", "tx_threshold_set", 1 },
        { "pmac", "tx_crc_mode", 2 },
        { "pmac", "tx_flush", 0 },
        { "pmac", "mac_reset", 1 },
    };
    ...
    /* If MACSEC enabled port, return MACSEC port down sequence. */
    is_macsec_port = bcm56780_a0_is_pm_sec_enabled(unit, pm_id);

    if (is_macsec_port) {
        port_down_prof.ops = macsec_port_down_ops;
        port_down_prof.op_cnt = COUNTOF(macsec_port_down_ops);
    } else {
...
static bcmpc_cfg_profile_t *
bcm56780_a0_pc_port_resume_prof_get(int unit, bcmpc_pport_t pport)
{
...
static bcmpc_cfg_profile_t *
bcm56780_a0_pc_port_suspend_prof_get(int unit, bcmpc_pport_t pport)
{
...
static int
bcm56780_a0_pc_topo_init(int unit, bool warm)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_EXIT
        (bcm56780_a0_pm_type_create(unit));

    SHR_IF_ERR_EXIT
        (bcm56780_a0_pm_instance_create(unit, warm));

    SHR_IF_ERR_EXIT
        (bcmpc_topo_traverse(unit, pm_master_set, NULL));
...
static int
bcm56780_a0_pc_dev_init(int unit, bool pre_load,  bool warm)
{
    SHR_FUNC_ENTER(unit);
    ...
    if (!bcmdrd_feature_enabled(unit, BCMDRD_FT_PHYMOD_SIM)) {
        if (!warm && pre_load) {
            SHR_IF_ERR_EXIT
                (bcm56780_a0_phy_firmware_loader(unit, 0 , 0, NULL));
        }
    }
...
static int
bcm56780_a0_pc_dev_cleanup(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_EXIT
        (bcmpc_topo_traverse(unit, bcm56780_a0_inst_destroy, NULL));

    SHR_IF_ERR_EXIT
        (bcmpc_topo_type_traverse(unit, bcm56780_a0_type_destroy, NULL));
...
static int
bcm56780_a0_pc_pm_firmware_loader(int unit, bcmpc_pport_t pport,
                                  ...
                                  phymod_firmware_loader_f *fw_loader)
{
    ...
    port = pport;
    SHR_IF_ERR_EXIT
        (bcm56780_a0_phy_firmware_loader(unit, port, fw_loader_req, fw_loader));
exit:
    SHR_FUNC_EXIT();
}

static int
bcm56780_a0_is_internal_port(int unit, bcmpc_pport_t pport,
                             bool *is_internal)
{
    int rv, pm_id;
    bcmpc_topo_t pm_info;
...
static int
bcm56780_a0_max_num_ports_get(int unit, uint32_t *max_pport,
                              uint32_t *max_lport)
{
    *max_pport = BCM56780_MAX_PPORTS;
    *max_lport = BCM56780_MAX_LPORTS;

    return SHR_E_NONE;
}

static int
bcm56780_a0_is_internal_pm(int unit, int pm_id, bool *is_internal)
{
    int rv;
    bcmpc_topo_t pm_info;
...
static void
bcm56780_a0_port_lbmp_get (int unit,
                             bcmpc_pport_t pport,
                             int pm_phys_port,
                             uint32_t *lbmp)
{
...
bcm56780_a0_unsupported_abilities_get(int unit, bcmpc_pport_t pport, int *abil_size)
{
     phymod_dispatch_type_t phymod_type;

     phymod_type = bcm56780_a0_pc_phy_drv_get(unit, pport);
...
static int
bcm56780_a0_link_sequence_exec_timeout_get(int unit, uint32_t *to_up,
                                           uint32_t *to_down)
{
    *to_up = 300000 * BCM56780_MAX_LPORTS;
    *to_down = 300000 * BCM56780_MAX_LPORTS;
    return  SHR_E_NONE;
}

static int
bcm56780_a0_is_stall_tx_supported(int unit, bcmpc_pport_t pport,
                                  bool *is_supported)
{
    int rv, pm_id;
    bcmpc_topo_t pm_info;
...
static int
bcm56780_a0_is_sec_supported(int unit)
{
    bcmpc_sec_handler_t *hdl;
    bcmpc_sec_valid_get_f func;
...
static int
bcm56780_a0_port_to_mac_rsv_mask(int unit, bcmpc_pport_t pport,
...
static int
bcm56780_a0_mac_to_port_rsv_mask(int unit, bcmpc_pport_t pport,
                                 uint32_t in_flags, uint32_t in_value,
                                 uint32_t *out_flags, uint32_t *out_value)
{
    int rv, pm_id;
...
static bcmpc_pm_pkg_core_cfg_t
bcm56780_a0_pkg_level_core_config_get (int unit, int pm_id)
{
    bcmpc_pm_pkg_core_cfg_t null_core_config = {0};
    bcmpc_pm_pkg_core_cfg_t bcm56780_a0_pkg_core_config[] = {
        [2]  = {
                .tx_lane_map = 0x76540213 /* TSC1_TD0  <--> TD3 */,
                .rx_polarity_flip = 0x62  /* TSC1_RD1, RD5, RD6 */,
                .tx_polarity_flip = 0xA6  /* TSC1_TD1, TD2, TD5, TD7 */,
        },
        [3]  = {
                .rx_polarity_flip = 0x3   /* TSC2_RD0, RD1 */,
                .tx_polarity_flip = 0x80  /* TSC2_TD7 */,
        },
        [4] = {
                .rx_polarity_flip = 0x3   /* TSC3_RD0, RD1 */,
                .tx_polarity_flip = 0x80  /* TSC3_TD7 */,
        },
        [5] =  {
                .tx_polarity_flip = 0x80  /* TSC4_TD7 */,
        },
        [6]  = {
                .rx_lane_map = 0x75643210 /* TSC5_RD5  <--> RD6 */,
                .tx_polarity_flip = 0x80  /* TSC5_TD7 */,
        },
        [7] = {
                .rx_polarity_flip = 0x3   /* TSC6_RD0, RD1 */,
                .tx_polarity_flip = 0x80  /* TSC6_TD7 */,
        },
        [8] = {
                .rx_polarity_flip = 0x3   /* TSC7_RD0, RD1 */,
                .tx_polarity_flip = 0x80  /* TSC7_TD7 */,
        },
        [9]  = {
                .tx_lane_map = 0x76540213 /* TSC8_TD0  <--> TD3 */,
                .rx_polarity_flip = 0x32  /* TSC8_RD1, RD4, RD5 */,
                .tx_polarity_flip = 0xA6  /* TSC8_TD1, TD2, TD5, TD7 */,
        },
        [12] = {
                .tx_lane_map = 0x76540213 /* TSC11_TD0 <--> TD3 */,
                .rx_polarity_flip = 0x32  /* TSC11_RD1, RD4, RD5 */,
                .tx_polarity_flip = 0xA6  /* TSC11_TD1, TD2, TD5, TD7 */,
        },
        [13] = {
                .rx_polarity_flip = 0x3   /* TSC12_RD0, RD1 */,
                .tx_polarity_flip = 0x80  /* TSC12_TD7 */,
        },
        [14] = {
                .rx_polarity_flip = 0x3   /* TSC13_RD0, RD1 */,
                .tx_polarity_flip = 0x80  /* TSC13_TD7 */,
        },
        [15] = {
                .rx_lane_map = 0x75643210 /* TSC14_RD5 <--> RD6 */,
                .tx_polarity_flip = 0x80  /* TSC14_TD7 */,
        },
        [16] = {
                .tx_polarity_flip = 0x80  /* TSC15_TD7 */,
        },
        [17] = {
                .rx_polarity_flip = 0x3   /* TSC16_RD0, RD1 */,
                .tx_polarity_flip = 0x80  /* TSC16_TD7 */,
        },
        [18] = {
                .rx_polarity_flip = 0x3   /* TSC17_RD0, RD1 */,
                .tx_polarity_flip = 0x80  /* TSC17_TD7 */,
        },
        [19] = {
                .tx_lane_map = 0x76540213 /* TSC18_TD0 <--> TD3 */,
                .rx_polarity_flip = 0x72  /* TSC18_RD1, RD4, RD5, RD6 */,
                .tx_polarity_flip = 0xA6  /* TSC18_TD1, TD2, TD5, TD7 */,
        },
    };

    if ((uint32_t)pm_id < sizeof(bcm56780_a0_pkg_core_config)/sizeof(bcm56780_a0_pkg_core_config[0])) {
        return bcm56780_a0_pkg_core_config[pm_id];
    } else {
        return null_core_config;
    }
}

static void
bcm56780_a0_pc_port_intr_func(int unit, uint32_t intr_param)
{
    int rv, i;
...
static int
bcm56780_a0_port_interrupt_set(int unit, bcmpc_pport_t pport,
                               bool intr_op)
{
    uint32_t i = 0;
    int pm_id;
    ...
    SHR_IF_ERR_EXIT
        (bcm56780_a0_is_internal_port(unit, pport, &is_internal));
...
static int
bcm56780_a0_num_of_rx_dfe_tap_get(int unit, int pm_id, uint32_t *num_of_rx_taps)
{
    int rv;
    bcmpc_topo_t pm_info;
...
static bcmpc_drv_t bcm56780_a0_pc_drv = {
    .topology_init = bcm56780_a0_pc_topo_init,
    .dev_init = bcm56780_a0_pc_dev_init,
    .dev_cleanup = bcm56780_a0_pc_dev_cleanup,
    .phy_addr_get = bcm56780_a0_pc_phy_addr_get,
    .pblk_get = bcm56780_a0_pc_pblk_get,
    .phy_bus_get = bcm56780_a0_pc_phy_bus_get,
    .pmac_bus_get = bcmpc_cmicx_pmac_bus_get,
    .phy_drv_get = bcm56780_a0_pc_phy_drv_get,
    .pmac_drv_get = bcm56780_a0_pc_pmac_drv_get,
    .phy_pll_idx_get = bcm56780_a0_pc_phy_pll_idx_get,
    .port_up_prof_get = bcm56780_a0_pc_port_up_prof_get,
    .port_down_prof_get = bcm56780_a0_pc_port_down_prof_get,
    .port_suspend_prof_get = bcm56780_a0_pc_port_suspend_prof_get,
    .port_resume_prof_get = bcm56780_a0_pc_port_resume_prof_get,
    .port_lbmp_get = bcm56780_a0_port_lbmp_get,
    .pm_firmware_loader = bcm56780_a0_pc_pm_firmware_loader,
    .pm_phy_raw_read = bcm56780_a0_raw_reg_read,
    .pm_phy_raw_write = bcm56780_a0_raw_reg_write,
    .is_internal_port = bcm56780_a0_is_internal_port,
    .max_num_ports_get = bcm56780_a0_max_num_ports_get,
    .is_internal_pm = bcm56780_a0_is_internal_pm,
    .dev_unsupported_abilities_get = bcm56780_a0_unsupported_abilities_get,
    .link_sequence_exec_timeout_get = bcm56780_a0_link_sequence_exec_timeout_get,
    .is_stall_tx_supported = bcm56780_a0_is_stall_tx_supported,
    .is_sec_supported = bcm56780_a0_is_sec_supported,
    .is_pm_sec_enabled = bcm56780_a0_is_pm_sec_enabled,
    .port_to_mac_rsv = bcm56780_a0_port_to_mac_rsv_mask,
    .mac_to_port_rsv = bcm56780_a0_mac_to_port_rsv_mask,
    .pkg_level_core_config_get = bcm56780_a0_pkg_level_core_config_get,
    .interrupt_set = bcm56780_a0_port_interrupt_set,
    .num_of_rx_dfe_tap_get = bcm56780_a0_num_of_rx_dfe_tap_get,
};
...
int
bcm56780_a0_pc_drv_attach(int unit)
{
    return bcmpc_drv_set(unit, &bcm56780_a0_pc_drv);
}
