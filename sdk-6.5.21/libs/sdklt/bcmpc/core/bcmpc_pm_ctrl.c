                                     ...
                                     bcmpc_phy_prbs_control_t *prbs_control)
{
    ...
    if (rv == SHR_E_NOT_FOUND) {
        ...
        SHR_IF_ERR_EXIT
            (bcmpc_pmgr_phy_prbs_control_set(unit, port_lane, pport, prbs_control));
    }
...
bcmpc_internal_phy_prbs_control_delete (int unit, bcmpc_port_lane_t *port_lane)
{
    ...
    if (rv == SHR_E_NOT_FOUND) {
        ...
        SHR_IF_ERR_EXIT
            (bcmpc_pmgr_phy_prbs_control_delete(unit, port_lane, pport));
    }
                                     ...
                                     bcmpc_port_diag_control_t *diag_control)
{
    ...
    if (rv == SHR_E_NOT_FOUND) {
        ...
        SHR_IF_ERR_EXIT
            (bcmpc_pmgr_port_diag_control_set(unit, lport, pport, diag_control));
    }
...
bcmpc_internal_port_diag_control_delete (int unit, bcmpc_lport_t *lport)
{
    ...
    if (rv == SHR_E_NOT_FOUND) {
        ...
        SHR_IF_ERR_EXIT
            (bcmpc_pmgr_port_diag_control_delete(unit, pport));
    }
