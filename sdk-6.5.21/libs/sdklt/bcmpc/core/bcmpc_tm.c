             ...
             bcmpc_mmu_port_cfg_t *mmu_pcfg_new)
{
    ...
    if (func) {
        SHR_IF_ERR_EXIT
            (func(unit, num_ports, mmu_pcfg_new));
    }
...
bcmpc_tm_port_add(int unit, bcmpc_lport_t lport, bcmpc_port_cfg_t *pcfg)
{
    ...
    bcmpc_mmu_port_cfg_t *mmu_pcfg;
    bcmpc_sec_port_cfg_t *sec_pcfg_new = NULL;
    ...
    SHR_IF_ERR_EXIT
        (pc_tm_update(unit, num_ports, mmu_pcfg_new));
    ...
    if (bcmpc_sec_valid_get(unit)) {
        ...
        SHR_IF_ERR_EXIT
            (pc_sec_update(unit, num_ports, sec_pcfg_new));
    }
