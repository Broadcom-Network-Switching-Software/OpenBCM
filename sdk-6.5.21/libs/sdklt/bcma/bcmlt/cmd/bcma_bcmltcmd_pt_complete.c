/*! \file bcma_bcmltcmd_pt_complete.c
 *
 * Completion support for physical table access command in CLI.
 */
/*
...
{
    return bcmltcmd_complete(cli, ctoks, true, text, start, end, complete);
}
