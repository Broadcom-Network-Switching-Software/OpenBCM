/*! \file bcm56780_a0_bcma_pkttest_drv.c
 *
...
static bcma_bcmpkt_test_drv_t bcm56780_a0_pkttest_drv = {
...
int
bcma_bcmpkt_test_bcm56780_a0_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_EXIT
        (bcma_bcmpkt_test_drv_set(unit, &bcm56780_a0_pkttest_drv));
