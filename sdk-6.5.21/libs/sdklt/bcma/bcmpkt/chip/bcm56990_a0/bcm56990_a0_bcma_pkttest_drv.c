/*! \file bcm56990_a0_bcma_pkttest_drv.c
 *
...
static int
lt_ifp_policy_add(int unit, int redirect_port, int new_pri,
                  fp_policy_type_t policy_type, uint64_t *policy_id)
{
    bcmlt_entry_handle_t ent_hdl = BCMLT_INVALID_HDL;
    ...
    if (new_pri > 0) {
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(ent_hdl, "ACTION_NEW_CPU_COS", new_pri));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_commit(ent_hdl, BCMLT_OPCODE_UPDATE,
                                BCMLT_PRIORITY_NORMAL));
    }
...
static int
pkttest_dpath_create(int unit, int port, int redirect_port, int new_pri,
                     bcma_bcmpkt_test_fp_cfg_t *ifp_cfg)
{
    ...
    SHR_IF_ERR_EXIT
        (lt_ifp_policy_add(unit, -1, -1, FP_POLICY_DROP,
                           &ifp_cfg->drop_policy_id));
    SHR_IF_ERR_EXIT
        (lt_ifp_policy_add(unit, redirect_port, new_pri, FP_POLICY_COPYTOCPU,
...
static bcma_bcmpkt_test_drv_t bcm56990_a0_pkttest_drv = {
...
int
bcma_bcmpkt_test_bcm56990_a0_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_EXIT
        (bcma_bcmpkt_test_drv_set(unit, &bcm56990_a0_pkttest_drv));
