/*! \file bcma_testutil_xgs_vfi_l2.c
 *
...
static int
xgs_l2_unicast_add(int unit, int port, const shr_mac_t mac,
...
static int
xgs_l2_unicast_update(int unit, int port, const shr_mac_t mac,
                              int vid, int copy2cpu)
{
    SHR_FUNC_ENTER(unit);
...
static int
xgs_l2_unicast_delete(int unit, int port, const shr_mac_t mac,
                              int vid, int copy2cpu)
{
    SHR_FUNC_ENTER(unit);
                             ...
                             const shr_mac_t mac, int vid, int copy2cpu)
{
    ...
    /* Insert L2_FDB_VLAN */
    SHR_IF_ERR_EXIT
        (bcmlt_entry_allocate(unit, "L2_VFI_FDB", &entry_hdl_2));

    SHR_IF_ERR_EXIT
        (bcmlt_entry_field_add(entry_hdl_2, "VFI_ID", vid));
    ...
    SHR_IF_ERR_EXIT
        (bcmlt_entry_field_add(entry_hdl_2, "L2_MC_GROUP_ID", group_id));
...
static bcma_testutil_l2_op_t bcma_testutil_xgs_vfi_l2_op = {
...
bcma_testutil_l2_op_t *bcma_testutil_xgs_vfi_l2_op_get(int unit)
{
    return &bcma_testutil_xgs_vfi_l2_op;
}
