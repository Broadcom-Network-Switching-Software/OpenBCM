...
cmicx_sbusdma_sname_get(int unit, const char **sname)
{
     ...
     */
    ss.aflags |= BCMDRD_SYMBOL_FLAG_CAM;
    ss.aflags |= BCMDRD_SYMBOL_FLAG_EXT_CAM;
    ss.aflags |= BCMDRD_SYMBOL_FLAG_FIFO;
    ss.aflags |= BCMDRD_SYMBOL_FLAG_OVERLAY;
    ss.aflags |= BCMDRD_SYMBOL_FLAG_WRITEONLY;
