...
#define TRAFFIC_MAX_POWER_DEFAULT_SPEED_GROUPS       (0)
                              ...
                              traffic_max_power_param_t *param, bool show)
{
    ...
    char *parse_pbmp_all = NULL, *parse_pbmp_oversub = NULL, *parse_mirror_pbmp1 = NULL, *parse_mirror_pbmp2 = NULL, *parse_mirror_pbmp3 = NULL, *parse_mirror_pbmp4 = NULL;
    ...
    SHR_IF_ERR_EXIT
        (bcma_cli_parse_table_add(&pt, "MirrorPortList1", "str",
                                  &parse_mirror_pbmp1, NULL));

   SHR_IF_ERR_EXIT
        (bcma_cli_parse_table_add(&pt, "MirrorPortList2", "str",
                                  &parse_mirror_pbmp2, NULL));

   SHR_IF_ERR_EXIT
        (bcma_cli_parse_table_add(&pt, "MirrorPortList3", "str",
                                  &parse_mirror_pbmp3, NULL));

   SHR_IF_ERR_EXIT
        (bcma_cli_parse_table_add(&pt, "MirrorPortList4", "str",
                                  &parse_mirror_pbmp4, NULL));
   ...
   SHR_IF_ERR_EXIT
    ...
    SHR_IF_ERR_EXIT
        (bcma_cli_parse_table_add(&pt, "SpeedGroups", "int",
                                  &param->speed_groups, NULL));
   ...
   SHR_IF_ERR_EXIT
    ...
    SHR_IF_ERR_EXIT
        (bcma_cli_parse_table_add(&pt, "Scenario", "int",
                                  &param->scenario, NULL));
    ...
    if (parse_mirror_pbmp1 != NULL) {
        SHR_IF_ERR_EXIT
            (bcma_testutil_parse_port_bmp(parse_mirror_pbmp1,
                                          &(param->mirror_pbmp1)));
    } else {
        BCMDRD_PBMP_CLEAR(param->mirror_pbmp1);
    }

    if (parse_mirror_pbmp2 != NULL) {
        SHR_IF_ERR_EXIT
            (bcma_testutil_parse_port_bmp(parse_mirror_pbmp2,
                                          &(param->mirror_pbmp2)));
    } else {
        BCMDRD_PBMP_CLEAR(param->mirror_pbmp2);
    }
    if (parse_mirror_pbmp3 != NULL) {
        SHR_IF_ERR_EXIT
            (bcma_testutil_parse_port_bmp(parse_mirror_pbmp3,
                                          &(param->mirror_pbmp3)));
    } else {
        BCMDRD_PBMP_CLEAR(param->mirror_pbmp3);
    }
    if (parse_mirror_pbmp4 != NULL) {
        SHR_IF_ERR_EXIT
            (bcma_testutil_parse_port_bmp(parse_mirror_pbmp4,
                                          &(param->mirror_pbmp4)));
    } else {
        BCMDRD_PBMP_CLEAR(param->mirror_pbmp4);
    }
...
print_test_params(int unit, void *bp)
{
    ...
    cli_out("  Speed groups     =%0d\n", tra_param->speed_groups);
    cli_out("  runtime          =%0d\n", tra_param->runtime);
    cli_out("  interval         =%0d\n", tra_param->interval);
                      ...
                      uint32_t flags, void **bp)
{
    ...
    tra_param->speed_groups = TRAFFIC_MAX_POWER_DEFAULT_SPEED_GROUPS;
