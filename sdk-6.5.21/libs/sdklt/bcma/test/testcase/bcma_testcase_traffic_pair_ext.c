                         ...
                         traffic_pair_ext_param_t *param, bool show)
{
    ...
    SHR_IF_ERR_EXIT
        (bcma_cli_parse_table_add(&pt, "CheckDataTime", "int",
                                  &param->check_data_time, NULL));
            ...
            SHR_IF_ERR_EXIT
                (bcma_testutil_packet_dev_simple_init
                    (unit, TRAFFIC_PAIR_TX_CHAN, TRAFFIC_PAIR_RX_CHAN,
                     TRAFFIC_PAIR_PKT_MAX_FRAME_SIZE, &netif_id, &pktdev_id));
            SHR_IF_ERR_EXIT
