...
static bcma_test_case_t testcase_pkt_multi = {
    "pkt",
    42,
    "Tx/Rx performance with multiple channels",
    BCMA_TESTCASE_PKT_MULTI_DESC,
    BCMA_TESTCASE_PKT_MULTI_FLAGS,
    1,
    NULL,
    bcma_testcase_pkt_multi_op_get,
};
...
bcma_testcase_add_pkt_cases(bcma_test_db_t *tdb)
{
    ...
    bcma_test_testcase_add(tdb, &testcase_pkt_multi, 0);
}
