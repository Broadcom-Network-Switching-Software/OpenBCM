...
lb_param_init(int unit, lb_param_t *lb_param)
{
    ...
    lb_param->check_link_time = BCMA_TEST_DEFAULT_CHECK_LINK_TIME;
               ...
               lb_param_t *lb_param, bool show)
{
    ...
    bcma_cli_parse_table_add(&pt, "CheckLinkTime", "int", &lb_param->check_link_time, NULL);
