...
static bcma_test_case_t testcase_cmicx_sbusdma_perf = {
    "hmi",
    530,
    "SBUS DMA performance",
    BCMA_TESTCASE_CMICX_SBUSDMA_PERF_DESC,
    BCMA_TESTCASE_CMICX_SBUSDMA_PERF_FLAGS,
    1,
    NULL,
    bcma_testcase_cmicx_sbusdma_perf_op_get,
};
...
bcma_testcase_add_cmicx_cases(bcma_test_db_t *tdb)
{
    ...
    bcma_test_testcase_add(tdb, &testcase_cmicx_sbusdma_perf, BCMDRD_FT_CMICX);
}
