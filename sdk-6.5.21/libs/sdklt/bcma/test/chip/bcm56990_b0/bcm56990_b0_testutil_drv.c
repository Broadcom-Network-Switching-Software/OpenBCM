/*! \file bcm56990_b0_testutil_drv.c
 *
...
static bcmdrd_sid_t bcm56990_b0_reg_reset_skip_pt[] = {
    ...
    ING_DII_SER_SCAN_CONFIGr,
    EGR_DII_SER_SCAN_CONFIGr,
    ING_DII_AUX_ARB_CONTROLr,
    EGR_DII_AUX_ARB_CONTROLr,
    ING_DII_DEBUG_CONFIGr,
    EGR_DII_DEBUG_CONFIGr,
    FLEX_CTR_ING_MISC_CTRLr,
    FLEX_CTR_EGR_MISC_CTRLr,
    TOP_SEQ_RST_0r,
...
static bcmdrd_sid_t bcm56990_b0_reg_wr_skip_pt[] = {
    /* These registers should be added NOTEST flag. */
    AVS_TMON_SPARE_0r,
...
static bcmdrd_sid_t bcm56990_b0_mem_skip_pt[] = {
...
static bcmdrd_sid_t bcm56990_b0_mem_reset_skip_pt[] = {
...
static shr_enum_map_t bcm56990_b0_blktype_name_id_map[] = {
    {"avs", BLKTYPE_AVS},
...
static bcmdrd_sid_t bcm56990_b0_tr144_skip_pt_list[] = {
...
static bcmdrd_sid_t bcm56990_b0_tr530_skip_pt_list[] = {
    TOP_CPU2TAP_DMA_CMD_MEMm,
    TOP_CPU2TAP_DMA_RESULT_ERROR_MEMm,
};

static bcmdrd_sid_t bcm56990_b0_tr901_skip_pt_list[] = {
    MPLS_ENTRY_DOUBLEm
};

static const bcma_testutil_pkt_lt_cfg_t bcm56990_b0_pkt_traffic_lt_cfg[] = {
...
static uint8_t bcm56990_b0_pkt_raw_data[] = {
...
static uint32_t bcm56990_b0_tx_pmd[][3] = {
    {0x81000000, 0x1, 0x4000}
};

bcmdrd_ser_rmr_id_t bcm56990_b0_bb_skip_pt[8] = {0};

static const bcma_testutil_pkt_data_t bcm56990_b0_pkt_data = {
    bcm56990_b0_tx_pmd,
    sizeof(bcm56990_b0_tx_pmd),
    NULL, 0, NULL, 0,
    bcm56990_b0_pkt_raw_data,
    sizeof(bcm56990_b0_pkt_raw_data)
};

static const uint32_t default_all_zero[BCMDRD_MAX_PT_WSIZE] = {0x0};

static bool
bcm56990_b0_pt_skip(int unit, bcmdrd_sid_t sid, bcma_testutil_pt_type_t type)
{
    ...
    case BCMA_TESTUTIL_PT_REG_RESET:
        skip_pt = bcm56990_b0_reg_reset_skip_pt;
        count = COUNTOF(bcm56990_b0_reg_reset_skip_pt);
        break;

    case BCMA_TESTUTIL_PT_REG_RD_WR:
        skip_pt = bcm56990_b0_reg_wr_skip_pt;
        count = COUNTOF(bcm56990_b0_reg_wr_skip_pt);
        break;
    ...
    case BCMA_TESTUTIL_PT_MEM_DMA_RD_WR:
        ...
        case BLKTYPE_PFC_COLLECTOR:
            skip_pt = bcm56990_b0_mem_skip_pt;
            count = COUNTOF(bcm56990_b0_mem_skip_pt);
            break;
        default:
            return TRUE;
        }
    ...
    case BCMA_TESTUTIL_PT_MEM_RESET:
        ...
        case BLKTYPE_MGMT_OBM:
        case BLKTYPE_PFC_COLLECTOR:
            skip_pt = bcm56990_b0_mem_reset_skip_pt;
            count = COUNTOF(bcm56990_b0_mem_reset_skip_pt);
            break;
        default:
            return TRUE;
        }
    ...
    case BCMA_TESTUTIL_PT_MEM_TR_144:
        skip_pt = bcm56990_b0_tr144_skip_pt_list;
        count = COUNTOF(bcm56990_b0_tr144_skip_pt_list);
        break;

    case BCMA_TESTUTIL_PT_MEM_TR_143:
        bcmdrd_pt_ser_name_to_rmr(unit, "EGR_DII_EVENT_FIFO_0", &bcm56990_b0_bb_skip_pt[0]);
        bcmdrd_pt_ser_name_to_rmr(unit, "EGR_DII_EVENT_FIFO_1", &bcm56990_b0_bb_skip_pt[1]);
        bcmdrd_pt_ser_name_to_rmr(unit, "EGR_DII_EVENT_FIFO_2", &bcm56990_b0_bb_skip_pt[2]);
        bcmdrd_pt_ser_name_to_rmr(unit, "EGR_DII_EVENT_FIFO_3", &bcm56990_b0_bb_skip_pt[3]);
        bcmdrd_pt_ser_name_to_rmr(unit, "ING_DII_EVENT_FIFO_0", &bcm56990_b0_bb_skip_pt[4]);
        bcmdrd_pt_ser_name_to_rmr(unit, "ING_DII_EVENT_FIFO_1", &bcm56990_b0_bb_skip_pt[5]);
        bcmdrd_pt_ser_name_to_rmr(unit, "ING_DII_EVENT_FIFO_2", &bcm56990_b0_bb_skip_pt[6]);
        bcmdrd_pt_ser_name_to_rmr(unit, "ING_DII_EVENT_FIFO_3", &bcm56990_b0_bb_skip_pt[7]);
        skip_pt = bcm56990_b0_bb_skip_pt;
        count = COUNTOF(bcm56990_b0_bb_skip_pt);
        break;

    case BCMA_TESTUTIL_PT_MEM_TR_530:
        skip_pt = bcm56990_b0_tr530_skip_pt_list;
        count = COUNTOF(bcm56990_b0_tr530_skip_pt_list);
        break;

    case BCMA_TESTUTIL_PT_MEM_TR_901:
        skip_pt = bcm56990_b0_tr901_skip_pt_list;
        count = COUNTOF(bcm56990_b0_tr901_skip_pt_list);
        break;
...
static void
bcm56990_b0_pkt_cfg_data_get(int unit, const bcma_testutil_pkt_lt_cfg_t **pkt_lt_cfg,
                             int *lt_cfg_num,
                             const bcma_testutil_pkt_data_t **pkt_data)
{
    *lt_cfg_num = COUNTOF(bcm56990_b0_pkt_traffic_lt_cfg);
    *pkt_lt_cfg = bcm56990_b0_pkt_traffic_lt_cfg;

    *pkt_data = &bcm56990_b0_pkt_data;
}
...
mem_hw_update(int unit, const char *name, bool enable)
{
    ...
    if (!enable) {
        /* Prevent HW update IFP_MEMTER_TABLE. */
        sid = ING_DII_AUX_ARB_CONTROLr;
        fid = FP_REFRESH_ENABLEf;
        field_data = 0;
        SHR_IF_ERR_EXIT
            (bcma_testutil_pt_field_set(unit, sid, fid, 0, -1, field_data));
    }
...
static int
bcm56990_b0_pt_hw_update(int unit, const char *name,
...
static int
bcm56990_b0_mem_address_adjust(int unit, bcmdrd_sid_t sid,
...
static int
bcm56990_b0_cmc_chan_get(int unit, int *cmc_num, int *cmc_chan_num)
{
    if (cmc_num != NULL) {
        *cmc_num = CMC_NUM;
    }
...
static int
bcm56990_b0_chip_blktype_get(int unit, const char *blktype_name,
                             int *blktype_id)
{
    int count = COUNTOF(bcm56990_b0_blktype_name_id_map), block;

    block = bcma_testutil_name2id(bcm56990_b0_blktype_name_id_map,
                                  count, blktype_name);
...
static int
bcm56990_b0_mem_hash_data_adjust(int unit, bcmdrd_sid_t sid,
...
static int
bcm56990_b0_pt_mask_override(int unit, bcmdrd_sid_t sid, int index,
...
static int
bcm56990_b0_mem_range_write(int unit, bcmdrd_sid_t sid, int index_start,
                            ...
                            bool intr_mode)
{
    ...
    if (psim || asim) {
        ...
        rv = bcma_testutil_cmicx_mem_range_write(unit, sid, index_start,
                                                 index_end, tbl_inst, buf, intr_mode);
        SHR_ERR_EXIT(rv);
    }
...
static int
bcm56990_b0_mem_range_read(int unit, bcmdrd_sid_t sid, int index_start,
                           int index_end, int tbl_inst, uint64_t buf,
                           bool intr_mode)
{
    bool psim = bcmdrd_feature_enabled(unit, BCMDRD_FT_PASSIVE_SIM);
...
static const bcmdrd_sid_t bcm56990_b0_becchmark_reg[] = {
    VFI_CTRLr,         /* socreg */
    CMIC_RPE_PKT_CTRLr /* cmicreg */
};

static const bcmdrd_sid_t bcm56990_b0_becchmark_mem[] = {
    EGR_VFIm,         /* index */
...
static int
bcm56990_b0_benchmark_reglist_get(int unit, const bcmdrd_sid_t **reg_arr,
                                  int *reg_cnt)
{
    SHR_FUNC_ENTER(unit);
    ...
    *reg_arr = bcm56990_b0_becchmark_reg;
    *reg_cnt = COUNTOF(bcm56990_b0_becchmark_reg);
...
static int
bcm56990_b0_benchmark_memlist_get(int unit, const bcmdrd_sid_t **mem_arr,
                                  int *mem_cnt)
{
    SHR_FUNC_ENTER(unit);
    ...
    *mem_arr = bcm56990_b0_becchmark_mem;
    *mem_cnt = COUNTOF(bcm56990_b0_becchmark_mem);
...
static int
bcm56990_b0_mem_cambist_info(int unit, bcmdrd_sid_t sid, bool *is_bist,
...
static int
bcm56990_b0_pt_entity_override(int unit, bcmdrd_sid_t sid,
                               bcmbd_pt_dyn_info_t *dyn_info,
...
static int
bcm56990_b0_mem_mbist_preconfig(int unit)
{
    ...
    /* Disable clock gating before run MBIST */
    TOP_IP_CLOCK_GATING_DISABLE_REGr_SET(ip_clk_disable, 0x3fff);
    ioerr += WRITE_TOP_IP_CLOCK_GATING_DISABLE_REGr(unit, ip_clk_disable);
    TOP_EP_CLOCK_GATING_DISABLE_REGr_SET(ep_clk_disable, 0xfff);
    ioerr += WRITE_TOP_EP_CLOCK_GATING_DISABLE_REGr(unit, ep_clk_disable);

    if (ioerr) {
        SHR_IF_ERR_EXIT(SHR_E_IO);
    }
...
bcm56990_b0_pt_default_value_get(int unit, bcmdrd_sid_t sid)
{
    /*
...
bcma_testutil_drv_power_op_t bcm56990_b0_power_op = {
    .power_help         = bcm56990_b0_power_help,
    .power_init         = bcm56990_b0_power_init,
    .power_port_set     = bcm56990_b0_power_port_set,
    .power_config_set   = bcm56990_b0_power_config_set,
    .power_txrx         = bcm56990_b0_power_txrx
};

int
bcm56990_b0_testutil_drv_attach(int unit)
{
    ...
    testutil_drv->pt_skip = bcm56990_b0_pt_skip;
    testutil_drv->pt_hw_update = bcm56990_b0_pt_hw_update;
    testutil_drv->mem_address_adjust = bcm56990_b0_mem_address_adjust;
    testutil_drv->mem_hash_data_adjust = bcm56990_b0_mem_hash_data_adjust;
    testutil_drv->mem_range_write = bcm56990_b0_mem_range_write;
    testutil_drv->mem_range_read = bcm56990_b0_mem_range_read;
    testutil_drv->mem_mbist_info = bcm56990_b0_mem_mbist_info;
    testutil_drv->mem_mbist_dma_info = bcm56990_b0_mem_mbist_dma_info;
    testutil_drv->mem_mbist_preconfig = bcm56990_b0_mem_mbist_preconfig;
    testutil_drv->cmc_chan_get = bcm56990_b0_cmc_chan_get;
    testutil_drv->benchmark_reglist_get = bcm56990_b0_benchmark_reglist_get;
    testutil_drv->benchmark_memlist_get = bcm56990_b0_benchmark_memlist_get;
    testutil_drv->mem_cambist_info = bcm56990_b0_mem_cambist_info;
    ...
    testutil_drv->traffic_expeceted_rate_get = bcm56990_b0_traffic_get_expeceted_rate;
    testutil_drv->traffic_fixed_packet_list_get = bcm56990_b0_traffic_get_fixed_packet_list;
    testutil_drv->traffic_random_packet_list_get = bcm56990_b0_traffic_get_random_packet_list;
    testutil_drv->traffic_worstcase_pktlen_get = bcm56990_b0_traffic_get_worstcase_pktlen;
    testutil_drv->power_op_get = &bcm56990_b0_power_op;
    testutil_drv->traffic_default_pktcnt = 1200;
    testutil_drv->chip_blktype_get = bcm56990_b0_chip_blktype_get;
    testutil_drv->pkt_cfg_data_get = bcm56990_b0_pkt_cfg_data_get;
    testutil_drv->pt_mask_override = bcm56990_b0_pt_mask_override;
    testutil_drv->pt_entity_override = bcm56990_b0_pt_entity_override;
    testutil_drv->pt_write = bcm56990_b0_pt_write;
    testutil_drv->pt_read = bcmbd_pt_read;
    testutil_drv->qos_lt_op_get = bcma_testutil_xgs_qos_lt_op_get;
    testutil_drv->check_health = bcm56990_b0_check_health;
    testutil_drv->pt_default_value_get = bcm56990_b0_pt_default_value_get;
