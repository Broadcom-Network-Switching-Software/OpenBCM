/*! \file bcm56880_a0_testutil_check_health.c
 *
...
static const check_health_info_t td4_check_health_ipep_sids[] = {
    /* IPEP registers */
    ...
    {FLEX_CTR_ST_EGR_FC_TOO_MANY_ACTIONS_COUNTERr, COUNTf, {0x0, 0x0}},
...
static const check_health_info_t  td4_check_health_port_sids[] = {
    /* Port registers */
...
static const check_health_info_t td4_check_health_idb_global_sids[] = {
    /* IDB Global */
...
static const check_health_info_t td4_check_health_mmu_sids[] = {
    /* Unexpected counters */
    ...
    {MMU_OQS_TOQ_CELL_TX_CREDITr, CREDIT_COUNTf, {32, 0x0}},
    {INVALIDr, INVALIDf, {0x0, 0x0}}

};

static const check_health_info_t td4_check_health_mmu_usage_sids[] = {
...
static int
td4_check_obm_per_port_regs(int unit, int *err_count) {
    int j;
    bcmdrd_sid_t sid;
    bcmdrd_fid_t fid;
    uint32_t exp_value[2];
    ...
    static const bcmdrd_sid_t obm_usage_regs[TD4_PBLKS_PER_PIPE] = {
        IDB_OBM0_USAGE_1r, IDB_OBM1_USAGE_1r, IDB_OBM2_USAGE_1r,
            IDB_OBM3_USAGE_1r};
    static const bcmdrd_sid_t obm_usage_regs_2[TD4_PBLKS_PER_PIPE] = {
        IDB_OBM0_USAGEr, IDB_OBM1_USAGEr, IDB_OBM2_USAGEr,
            IDB_OBM3_USAGEr};
    static const bcmdrd_sid_t obm_hw_status_regs[TD4_PBLKS_PER_PIPE] = {
        IDB_OBM0_HW_STATUSr, IDB_OBM1_HW_STATUSr, IDB_OBM2_HW_STATUSr,
        IDB_OBM3_HW_STATUSr
    };
    static const bcmdrd_fid_t obm_hw_status_fields[TD4_PORTS_PER_PBLK] = {
    ...
    static const bcmdrd_sid_t ca_hw_status_regs[TD4_PBLKS_PER_PIPE] = {
        IDB_CA0_HW_STATUSr, IDB_CA1_HW_STATUSr, IDB_CA2_HW_STATUSr,
        IDB_CA3_HW_STATUSr
    };
    static const bcmdrd_fid_t ca_fifo_full_fields[TD4_PORTS_PER_PBLK] = {
    ...
    static const bcmdrd_fid_t ca_fifo_ovrrun_fields[TD4_PORTS_PER_PBLK] = {
    ...
    static const bcmdrd_sid_t ca_hw_status_2_regs[TD4_PBLKS_PER_PIPE] = {
        IDB_CA0_HW_STATUS_2r, IDB_CA1_HW_STATUS_2r, IDB_CA2_HW_STATUS_2r,
        IDB_CA3_HW_STATUS_2r
    };
    static const bcmdrd_fid_t ca_cell_len_err_fields[TD4_PORTS_PER_PBLK] = {
    ...
    static const bcmdrd_fid_t ca_sop_eop_err_fields[TD4_PORTS_PER_PBLK] = {
    ...
    static const bcmdrd_fid_t ca_fifo_underrun_fields[TD4_PORTS_PER_PBLK] = {
    ...
    for (pport = 0; pport < TD4_NUM_PHYS_PORTS; pport++) {
...
int
bcm56880_a0_check_health(int unit, bool *test_result) {
    int err = 0, check_err = 0;

    SHR_FUNC_ENTER(unit);
    LOG_INFO(BSL_LOG_MODULE,
                    (BSL_META_U(unit, "Calling Check Health for TD4 \n")));
    if (test_result != NULL) {
        *test_result = true;
    }
    /* IPEP check health */
    check_err = 0;
    SHR_IF_ERR_EXIT(check_sid_exp_value(unit, td4_check_health_ipep_sids, &check_err));
    err += check_err;
    if (check_err > 0) {
    ...
    /* Port check health */
    check_err = 0;
    SHR_IF_ERR_EXIT(check_sid_exp_value(unit, td4_check_health_port_sids, &check_err));
    err += check_err;
    if (check_err > 0) {
    ...
    /* MMU check health */
    check_err = 0;
    SHR_IF_ERR_EXIT(check_sid_exp_value(unit, td4_check_health_mmu_sids, &check_err));
    err += check_err;
    if (check_err > 0) {
    ...
    /* MMU usage sids */
    check_err = 0;
    SHR_IF_ERR_EXIT(check_sid_exp_value(unit, td4_check_health_mmu_usage_sids, &check_err));
    err += check_err;
    if (check_err > 0) {
    ...
    check_err = 0;
    SHR_IF_ERR_EXIT(check_sid_exp_value(unit, td4_check_health_idb_global_sids, &check_err));
    err += check_err;
    if (check_err > 0) {
    ...
    check_err = 0;
    SHR_IF_ERR_EXIT
        (td4_check_obm_per_port_regs(unit, &check_err));
    err += check_err;
    if (check_err > 0) {
