...
static bcmdrd_sid_t bcm56880_a0_tr530_skip_pt_list[] = {
...
static bcmdrd_sid_t bcm56880_a0_reset_mem_skip_pt[] = {
    CDPORT_TSC_UCMEM_DATAm,
    XLPORT_WC_UCMEM_DATAm,
    LPM_IP_CONTROLm,
    ...
    MMU_SCB_SCQ_FLm,
    MMU_TOQ_CQEB_FAPm,
    MMU_TOQ_CQEB_FAP_MMU_ITM0_ITM0m,
    MMU_TOQ_CQEB_FAP_MMU_ITM1_ITM1m,
...
bcm56880_a0_pt_skip(int unit, bcmdrd_sid_t sid, bcma_testutil_pt_type_t type)
{
    ...
    case BCMA_TESTUTIL_PT_MEM_TR_530:
        skip_pt = bcm56880_a0_tr530_skip_pt_list;
        count = COUNTOF(bcm56880_a0_tr530_skip_pt_list);
        break;
    ...
    case BCMA_TESTUTIL_PT_MEM_RESET:
        ...
        if (sal_strstr(pt_name, "MMU_CFAP_BANK") != NULL) {
            ...
            return TRUE;
        } else if (sal_strstr(pt_name, "MMU_EBMB_PAYLOAD_SLICE") != NULL) {
            return TRUE;
        ...
        /* Block for EDB, IDB */
        case BLKTYPE_PORT_IF:
            skip_pt = bcm56880_a0_reset_mem_skip_pt;
            count = COUNTOF(bcm56880_a0_reset_mem_skip_pt);
            break;
        default:
            return TRUE;
        }
