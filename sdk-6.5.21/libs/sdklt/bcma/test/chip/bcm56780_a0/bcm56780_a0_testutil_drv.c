...
static bcmdrd_sid_t bcm56780_a0_reset_mem_skip_pt[] = {
    /*
     * These tables are used to configure UFT table attributes,
     * such as bucket mode, key width.
     */
    ...
    M_LPM_IP_CONTROLm,
    LPM_IP_CONTROLm,
    EPRE_EDEV_CONFIG_CPU_DMA_FLEX_WORD_MUX_PROFILEm,
    MMU_CFAP_BANK0m,
    MMU_CFAP_BANK1m,
    MMU_CFAP_BANK2m,
    MMU_CFAP_BANK3m,
    ...
    FIELD_COMPRESSION_ENGINE_REMAP_OBJECT_TABLE_0m,
    ...
    MMU_MB_PAYLOAD_SLICE0H_CPUm,
    MMU_MB_PAYLOAD_SLICE0L_CPUm,
    MMU_MB_PAYLOAD_SLICE1H_CPUm,
    MMU_MB_PAYLOAD_SLICE1L_CPUm,
    MMU_MB_PAYLOAD_SLICE2H_CPUm,
    MMU_MB_PAYLOAD_SLICE2L_CPUm,
    MMU_MB_PAYLOAD_SLICE3H_CPUm,
    MMU_MB_PAYLOAD_SLICE3L_CPUm,
    MMU_MB_PAYLOAD_SLICE4H_CPUm,
    MMU_MB_PAYLOAD_SLICE4L_CPUm,
    MMU_MB_PAYLOAD_SLICE5H_CPUm,
    MMU_MB_PAYLOAD_SLICE5L_CPUm,
    MMU_MB_PAYLOAD_SLICE6H_CPUm,
    MMU_MB_PAYLOAD_SLICE6L_CPUm,
    MMU_MB_PAYLOAD_SLICE7H_CPUm,
    MMU_MB_PAYLOAD_SLICE7L_CPUm,
    FIELD_COMPRESSION_ENGINE_REMAP_OBJECT_TABLE_1m
};
...
static bcmdrd_sid_t bcm56780_a0_tr530_skip_pt_list[] = {
    TOP_CPU2TAP_DMA_CMD_MEMm,
    TOP_CPU2TAP_DMA_RESULT_ERROR_MEMm,
};

static bcmdrd_sid_t bcm56780_a0_tr901_skip_pt_list[] = {
    CDMIB_MEMm,
    ...
    MMU_EBMB_PAYLOAD_ITM1_CH0L_SERm,
    MMU_EBMB_PAYLOAD_ITM1_CH1L_SERm,
    MMU_MB_PAYLOAD_SER_CH0m,
    MMU_MB_PAYLOAD_SER_CH1m,
    MMU_MB_PAYLOAD_SER_CH2m,
    MMU_MB_PAYLOAD_SER_CH3m,
    MMU_EBMB_PAYLOAD_ITM1_CH1H_SERm,

    /* hash computed by  hardware sdk does not write in this memory */
    ISEC_SA_HASH_TABLEm,
    ESEC_SA_HASH_TABLEm,
...
bcm56780_a0_pt_skip(int unit, bcmdrd_sid_t sid, bcma_testutil_pt_type_t type)
{
    ...
    if ((blktype == BLKTYPE_MACSEC) &&
        !bcmsec_is_sec_supported(unit)) {
        return TRUE;
    }
    ...
    case BCMA_TESTUTIL_PT_MEM_RESET:
        ...
        /* Block for EDB, IDB */
        case BLKTYPE_PORT_IF:
            skip_pt = bcm56780_a0_reset_mem_skip_pt;
            count = COUNTOF(bcm56780_a0_reset_mem_skip_pt);
            break;
        default:
            return TRUE;
        }
    ...
    case BCMA_TESTUTIL_PT_MEM_TR_530:
        skip_pt = bcm56780_a0_tr530_skip_pt_list;
        count = COUNTOF(bcm56780_a0_tr530_skip_pt_list);
        break;

    case BCMA_TESTUTIL_PT_MEM_TR_901:
        skip_pt = bcm56780_a0_tr901_skip_pt_list;
        count = COUNTOF(bcm56780_a0_tr901_skip_pt_list);
        break;
                               ...
                               bcma_testutil_pt_type_t type)
{
    ...
    case M_E2T_01_REMAP_TABLE_Bm:
        *index_end = bcmdrd_dev_mem_maxidx(unit, sid, *index_end);
        SHR_IF_ERR_EXIT
...
static int
bcm56780_a0_mem_mbist_preconfig(int unit)
{
    int phy_lport[] = {1, 2, 3, 4, 5, 20, 21, 22, 23, 24,
    ...
    for (i = 0; i < COUNTOF(phy_lport); i++) {
        SHR_IF_ERR_EXIT
            (bcma_testutil_phy_set_raw(unit, phy_lport[i], 0x1d30a, 0x0500));
    }
...
bcm56780_a0_testutil_drv_attach(int unit)
{
    ...
    testutil_drv->mem_mbist_preconfig= bcm56780_a0_mem_mbist_preconfig;
    ...
    testutil_drv->flex_pipe_macsec_config_set  = bcm56780_a0_traffic_flex_pipe_macsec_config_set;
    testutil_drv->flex_pipe_macsec_config_delete  = bcm56780_a0_traffic_flex_pipe_macsec_config_delete;
