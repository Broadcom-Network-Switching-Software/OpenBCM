                                   ...
                                   uint32_t str_size, char *fec_mode_str)
{
    ...
    if (local_fec_mode_str != NULL) {
        ...
        sal_strcpy(fec_mode_str, "PC_FEC_NONE");
    }
...
int
bcm56780_a0_traffic_flex_pipe_macsec_config_set(int unit , int port , int vid,
                                                int pid , bcmdrd_pbmp_t *ms_bmp)
{
    ...
    SHR_IF_ERR_EXIT
        (bcmlt_entry_field_add(entry_hdl_1, "PORT_ID", port));
    ...
    BCMDRD_PBMP_ASSIGN( pbmp_ms , (*ms_bmp));

    if (macsec_enabled == 1) {

        BCMDRD_PBMP_PORT_ADD(pbmp_ms, port);
        ...
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "PORT_ID", port));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_array_add(entry_hdl_1, "MGMT_DST_MAC",0,
                                           &mc_en,1));
        SHR_IF_ERR_EXIT
        ...
        bcmlt_entry_free(entry_hdl_1);
        SHR_IF_ERR_EXIT
            (bcmlt_entry_allocate(unit, "SEC_ENCRYPT_MACSEC_SC_POLICY", &entry_hdl_1));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "SEC_BLOCK_ID", macsec_block_id));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "SEC_ENCRYPT_MACSEC_SC_POLICY_ID", 0x0));
        ...
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "SEC_ENCRYPT_MACSEC_SC_POLICY_ID", 0x0));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "MTU", 1518));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_symbol_add(entry_hdl_1, "UNSECURED_DATA_MODE", "ALLOW"));

        if (lv == SHR_E_NOT_FOUND) {
            SHR_IF_ERR_EXIT
                (bcmlt_entry_commit(entry_hdl_1, BCMLT_OPCODE_INSERT, BCMLT_PRIORITY_NORMAL));
        } else {
            SHR_IF_ERR_EXIT
                (bcmlt_entry_commit(entry_hdl_1, BCMLT_OPCODE_UPDATE, BCMLT_PRIORITY_NORMAL));
        }
        ...
        SHR_IF_ERR_EXIT
            (bcmlt_entry_allocate(unit, "IDEV_CONFIG_TABLEm", &entry_hdl_1));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "BCMLT_PT_INDEX", port));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "SYSTEM_PORT", port));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "PARSER0_CTRL_ID", 0x4));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "DEVICE_PORT", port));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "ING_PP_PORT", port));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "CONFIG_DEVICE_PORT_TYPE", 1));
        SHR_IF_ERR_EXIT
            (bcmlt_pt_entry_commit(entry_hdl_1, BCMLT_PT_OPCODE_SET, BCMLT_PRIORITY_NORMAL));
        bcmlt_entry_free(entry_hdl_1);
        SHR_IF_ERR_EXIT
            (bcmlt_entry_allocate(unit, "EPRE_EDEV_CONFIG_DEVICE_PORT_TABLEm", &entry_hdl_1));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "BCMLT_PT_INDEX", port));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "DEVICE_OPQ_CMD1", 0x1));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "L2_OIF", port));
        SHR_IF_ERR_EXIT
            (bcmlt_pt_entry_commit(entry_hdl_1, BCMLT_PT_OPCODE_SET, BCMLT_PRIORITY_NORMAL));
        bcmlt_entry_free(entry_hdl_1);

        SHR_IF_ERR_EXIT
            (bcmlt_entry_allocate(unit, "EGR_L2_OIF", &entry_hdl_1));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "L2_OIF", port));
        lv = (bcmlt_entry_commit(entry_hdl_1, BCMLT_OPCODE_LOOKUP, BCMLT_PRIORITY_NORMAL));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "EDIT_CTRL_ID", 0x2));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "TPID_0", 0x8100));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "TPID_1", 0x9100));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "STRENGTH_PRFL_IDX", 0x3));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "EGR_PORT_GROUP_ID", port));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "L2_PROCESS_CTRL", 0x1));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "L2_OIF", port));
        ...
        SHR_IF_ERR_EXIT
            (bcmlt_entry_allocate(unit, "DEVICE_EM_TILE", &entry_hdl_1));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_symbol_add(entry_hdl_1, "DEVICE_EM_TILE_ID", "EFTA30_E2T_00"));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_symbol_add(entry_hdl_1, "mode", "EFTA30_E2T_00_MODE0"));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_commit(entry_hdl_1, BCMLT_OPCODE_UPDATE, BCMLT_PRIORITY_NORMAL));
        bcmlt_entry_free(entry_hdl_1);
        SHR_IF_ERR_EXIT
            (bcmlt_entry_allocate(unit, "DEVICE_EM_GROUP", &entry_hdl_1));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_symbol_add(entry_hdl_1, "DEVICE_EM_GROUP_ID", "EFTA30_E2T_00_MODE0_GROUP0"));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "NUM_BANKS", 2));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_array_symbol_add(entry_hdl_1, "DEVICE_EM_BANK_ID", 0, l2_bank, 2));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_commit(entry_hdl_1, BCMLT_OPCODE_UPDATE, BCMLT_PRIORITY_NORMAL));
        bcmlt_entry_free(entry_hdl_1);
        SHR_IF_ERR_EXIT
            (bcmlt_entry_allocate(unit, "TABLE_CONTROL", &entry_hdl_1));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_symbol_add(entry_hdl_1, "TABLE_ID", "EGR_VLAN_TRANSLATION_SVTAG_ASSIGN_TABLE"));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "MAX_ENTRIES", 16384));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_commit(entry_hdl_1, BCMLT_OPCODE_UPDATE, BCMLT_PRIORITY_NORMAL));
        bcmlt_entry_free(entry_hdl_1);

        SHR_IF_ERR_EXIT
            (bcmlt_entry_allocate(unit, "EGR_VLAN_TRANSLATION_SVTAG_ASSIGN_TABLE", &entry_hdl_1));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "VFI", vid));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "GROUP_ID", port));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "PRESERVE_OTAG", 1));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "PRESERVE_ITAG", 0));
        lv = (bcmlt_entry_commit(entry_hdl_1, BCMLT_OPCODE_LOOKUP, BCMLT_PRIORITY_NORMAL));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "VFI", vid));
        SHR_IF_ERR_EXIT
        ...
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "PRESERVE_ITAG", 0));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "SVTAG_OFFSET", 2));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "SVTAG_PKT_TYPE", 0));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "SVTAG_SC_INDEX", 0));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "STRENGTH_PRFL_IDX", 0xf));
        ...
        SHR_IF_ERR_EXIT
            (bcmlt_entry_allocate(unit,"ING_L2_IIF_TABLE", &entry_hdl_1));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "L2_IIF", port));
        lv = (bcmlt_entry_commit(entry_hdl_1, BCMLT_OPCODE_LOOKUP, BCMLT_PRIORITY_NORMAL));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "L2_IIF", port));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "VLAN_TAG_PRESERVE_CTRL", 0x1));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "VLAN_TO_VFI_MAPPING_ENABLE", 0x0));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "VFI", vid));
        ...
        SHR_IF_ERR_EXIT
            (bcmlt_entry_allocate(unit, "EGR_VXLT_SVTAG_ASSIGN_TABLE_STR_PROFILE", &entry_hdl_1));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "EGR_VXLT_SVTAG_ASSIGN_TABLE_STR_PROFILE_INDEX", 0xf));
        lv = (bcmlt_entry_commit(entry_hdl_1, BCMLT_OPCODE_LOOKUP, BCMLT_PRIORITY_NORMAL));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "EGR_VXLT_SVTAG_ASSIGN_TABLE_STR_PROFILE_INDEX", 0xf));
        ...
        SHR_IF_ERR_EXIT
            (bcmlt_entry_allocate(unit, "R_EGR_SVTAG_SIGNATURE", &entry_hdl_1));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "VALUE", 0x88));
        lv = (bcmlt_entry_commit(entry_hdl_1, BCMLT_OPCODE_LOOKUP, BCMLT_PRIORITY_NORMAL));
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry_hdl_1, "VALUE", 0x88));
    ...
    BCMDRD_PBMP_ASSIGN((*ms_bmp), pbmp_ms);
...
int
bcm56780_a0_traffic_flex_pipe_macsec_config_delete(int unit, int port , int pid , int vid)
{
    bcmlt_entry_handle_t entry_hdl_1 = BCMLT_INVALID_HDL;
    uint64_t macsec_block_id, macsec_enabled;
    int lv;
    ...
    SHR_IF_ERR_EXIT
        (bcmlt_entry_field_add(entry_hdl_1, "SEC_BLOCK_ID",
                               macsec_block_id));
    lv = (bcmlt_entry_commit(entry_hdl_1, BCMLT_OPCODE_DELETE,
                             BCMLT_PRIORITY_NORMAL));
    bcmlt_entry_free(entry_hdl_1);
    ...
    SHR_IF_ERR_EXIT
        (bcmlt_entry_field_add(entry_hdl_1, "SVTAG_OFFSET", 2));
    SHR_IF_ERR_EXIT
        (bcmlt_entry_field_add(entry_hdl_1, "SVTAG_PKT_TYPE", 2));
    SHR_IF_ERR_EXIT
        (bcmlt_entry_field_add(entry_hdl_1, "SVTAG_SC_INDEX", 1));
    SHR_IF_ERR_EXIT
        (bcmlt_entry_field_add(entry_hdl_1, "STRENGTH_PRFL_IDX", 0xf));

    if (lv == SHR_E_EXISTS){
        SHR_IF_ERR_EXIT
            (bcmlt_entry_commit(entry_hdl_1, BCMLT_OPCODE_DELETE, BCMLT_PRIORITY_NORMAL));
    }
    bcmlt_entry_free(entry_hdl_1);
