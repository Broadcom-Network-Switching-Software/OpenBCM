...
power_test_param_init(int unit, void *bp)
{
    ...
    BCMDRD_PBMP_ITER(tra_param->pbmp_all, port) {
        if ((bcmtm_lport_is_fp(unit, port) == 1) &&
            ...
            if (SHR_FAILURE(bcmtm_lport_max_speed_get(unit, port, &max_speed))) {
...
static int power_test_set_hash_control(int unit)
{
    ...
    TH4_PWRT_SET_FIELD(HASH_OFFSET_DEDICATED_BANK_0f,
                       bcma_testutil_sal_rand32() % 48);
    TH4_PWRT_SET_FIELD(HASH_OFFSET_DEDICATED_BANK_1f,
                       bcma_testutil_sal_rand32() % 48);
    ...
    TH4_PWRT_SET_FIELD(HASH_OFFSET_DEDICATED_BANK_1f,
                       bcma_testutil_sal_rand32() % 48);
    TH4_PWRT_SET_FIELD(HASH_OFFSET_DEDICATED_BANK_2f,
                       bcma_testutil_sal_rand32() % 48);
    TH4_PWRT_SET_FIELD(HASH_OFFSET_DEDICATED_BANK_3f,
                       bcma_testutil_sal_rand32() % 48);
    TH4_PWRT_SET_FIELD(HASH_TABLE_TEST_MODEf, 0x0);
    index = 0;
    TH4_PWRT_PT_DYN_INFO(pt_dyn_info, index, 0);
    ...
    sal_memset(entry, 0, sizeof(entry));
    sal_memset(memfld, 0, sizeof(memfld));
    TH4_PWRT_SET_FIELD(B7_HASH_OFFSETf, bcma_testutil_sal_rand32() % 48);
    TH4_PWRT_SET_FIELD(B6_HASH_OFFSETf, bcma_testutil_sal_rand32() % 48);
    TH4_PWRT_SET_FIELD(B5_HASH_OFFSETf, bcma_testutil_sal_rand32() % 48);
    TH4_PWRT_SET_FIELD(B4_HASH_OFFSETf, bcma_testutil_sal_rand32() % 48);
    TH4_PWRT_SET_FIELD(B3_HASH_OFFSETf, bcma_testutil_sal_rand32() % 48);
    TH4_PWRT_SET_FIELD(B2_HASH_OFFSETf, bcma_testutil_sal_rand32() % 48);
    TH4_PWRT_SET_FIELD(B1_HASH_OFFSETf, bcma_testutil_sal_rand32() % 48);
    TH4_PWRT_SET_FIELD(B0_HASH_OFFSETf, bcma_testutil_sal_rand32() % 48);
...
static int power_test_set_hash_remap_and_action(int unit)
{
    ...
    for (tab = 0; tab < 8; tab++) {
        ...
        for (i = 0; i < remap_table_size; i++) {
            sal_memset(entry, 0, sizeof(entry));
            sal_memset(memfld, 0, sizeof(memfld));
            TH4_PWRT_SET_FIELD(REMAP_DATAf, bcma_testutil_sal_rand32() & 0xfff);
...
static int setup_ing_ctrl_regs(int unit)
{
    ...
    TH4_PWRT_SET_FIELD(MACRO_FLOW_HASH_FUNC_SELf,
    ...
    TH4_PWRT_SET_FIELD(HASH_A0_FUNCTION_SELECTf,
                       3 + (bcma_testutil_sal_rand32() % 13));
    TH4_PWRT_SET_FIELD(HASH_A1_FUNCTION_SELECTf,
                       3 + (bcma_testutil_sal_rand32() % 13));
    TH4_PWRT_SET_FIELD(HASH_B0_FUNCTION_SELECTf,
                       3 + (bcma_testutil_sal_rand32() % 13));
    TH4_PWRT_SET_FIELD(HASH_B1_FUNCTION_SELECTf,
                       3 + (bcma_testutil_sal_rand32() % 13));
    ...
    sal_memset(entry, 0, sizeof(entry));
    sal_memset(memfld, 0, sizeof(memfld));
    TH4_PWRT_SET_FIELD(HASH_SEED_Af, bcma_testutil_sal_rand32());
    TH4_PWRT_PT_DYN_INFO(pt_dyn_info, 0, 0);
    SHR_IF_ERR_EXIT(th4_pwrt_pt_write(unit, sid, ltid, &pt_dyn_info, entry));
    ...
    sal_memset(entry, 0, sizeof(entry));
    sal_memset(memfld, 0, sizeof(memfld));
    TH4_PWRT_SET_FIELD(HASH_SEED_Bf, bcma_testutil_sal_rand32());
    TH4_PWRT_PT_DYN_INFO(pt_dyn_info, 0, 0);
    SHR_IF_ERR_EXIT(th4_pwrt_pt_write(unit, sid, ltid, &pt_dyn_info, entry));
    ...
    sal_memset(entry, 0, sizeof(entry));
    sal_memset(memfld, 0, sizeof(memfld));
    TH4_PWRT_SET_FIELD(VH_INIT_VAL_0f, bcma_testutil_sal_rand32());
    TH4_PWRT_SET_FIELD(VH_INIT_VAL_1f, bcma_testutil_sal_rand32());
    TH4_PWRT_PT_DYN_INFO(pt_dyn_info, 0, 0);
    SHR_IF_ERR_EXIT(th4_pwrt_pt_write(unit, sid, ltid, &pt_dyn_info, entry));
    ...
    int flow_id)
{
    ...
    /* Randomize the rest */
    TH4_PWRT_SET_FIELD(IPMC_MISS_AS_L2MCf, bcma_testutil_sal_rand32() & 0x1);
    TH4_PWRT_SET_FIELD(UNKNOWN_IPV4_MC_TOCPUf,
                       bcma_testutil_sal_rand32() & 0x1);
    TH4_PWRT_SET_FIELD(UNRESOLVEDL3SRC_TOCPUf, 0x0);
    TH4_PWRT_SET_FIELD(RESERVEDf, bcma_testutil_sal_rand32() & 0x1f);
    if (((power_test_p->enable_map >> TH4_PWRT_EN_RND_PRI) & 0x1) == 0x1) {
    ...
    int flow_id)
{
    ...
    sal_memset(memfld, 0, sizeof(memfld));
    for (i = 0; i < 16; i++) {
        TH4_PWRT_SET_FIELD(udf_base_offset[i],
                           1 + (bcma_testutil_sal_rand32() % 4)); /* range 1:4 */
        TH4_PWRT_SET_FIELD(udf_offset[i],
                           1 + (bcma_testutil_sal_rand32() % 5)); /* range 1:4 */
    }
    TH4_PWRT_SET_FIELD(HASH_MASK_1f, bcma_testutil_sal_rand32() & 0xffff);
    TH4_PWRT_SET_FIELD(HASH_MASK_2f, bcma_testutil_sal_rand32() & 0xffff);
    ...
    int is_cpu)
{
    ...
    TH4_PWRT_SET_FIELD(WECMPv_WEIGHTf, bcma_testutil_sal_rand32() & 0xfff);
    ...
    int flow_id)
{
    ...
    if (is_mpls_en(unit, flow_id, 0) == 1) {
        ...
        TH4_PWRT_SET_FIELD(MPLSv_LOOPBACK_PROFILE_IDXf,
        ...
        TH4_PWRT_SET_FIELD(L3v_LOOPBACK_PROFILE_IDXf,
                           1 + (bcma_testutil_sal_rand32() % 3));
        sal_memset(memfld, 0, sizeof(memfld));
        get_mac_da(unit, flow_id, mac_addr);
        convert_mac(mac_addr, memfld);
    ...
    int flow_id)
{
    ...
    TH4_PWRT_SET_FIELD(EGR_PORT_GROUP_IDf, bcma_testutil_sal_rand32() & 0x1ff);
    TH4_PWRT_SET_FIELD(LATENCY_ECN_PROFILE_PTRf, flow_id % 8);
    TH4_PWRT_SET_FIELD(MIRROR_ENCAP_INDEXf, bcma_testutil_sal_rand32() & 0x7);
    TH4_PWRT_SET_FIELD(VXLAN_VRF_LOOKUP_KEY_TYPEf,
                       bcma_testutil_sal_rand32() & 0x1);
        ...
        for (ipep_acc = 0; ipep_acc < 4; ipep_acc++) {
            if (pp_map & (1 << ipep_acc)) {
                for (slice = 0; slice < 8; slice++) {
                    ...
                    TH4_PWRT_SET_FIELD(HASH_FIELD_BITMAP_PTR_Af,
                                       1 + (bcma_testutil_sal_rand32() % 15));
                    TH4_PWRT_SET_FIELD(HASH_FIELD_BITMAP_PTR_Bf,
                                       1 + (bcma_testutil_sal_rand32() % 15));
    ...
    int flow_id)
{
    ...
    sal_memset(entry, 0, sizeof(entry));
    sal_memset(memfld, 0, sizeof(memfld));
    TH4_PWRT_SET_FIELD(FRAGMENT_IDf, bcma_testutil_sal_rand32() & 0xffff);
    ...
    int unit)
{
    ...
    for (index = 1; index < 16; index ++) {
        ...
        TH4_PWRT_SET_FIELD(MD_HDR_TYPEf, bcma_testutil_sal_rand32() & 0x7);
        TH4_PWRT_SET_FIELD(MD_HDR_LEN_GRANULARITYf, 0);
        TH4_PWRT_SET_FIELD(IFA_FLAGSf, bcma_testutil_sal_rand32() & 0xff);
        TH4_PWRT_SET_FIELD(MAX_OR_REMAINING_LENf,
                           bcma_testutil_sal_rand32() & 0xffff);
        TH4_PWRT_SET_FIELD(IP_HDR_TTLf, bcma_testutil_sal_rand32() & 0x3fff);
        TH4_PWRT_PT_DYN_INFO(pt_dyn_info, index, 0);
        SHR_IF_ERR_EXIT(th4_pwrt_pt_write(
            unit, sid, ltid, &pt_dyn_info, entry));
    }
    ...
    for (index = 0; index < 4; index ++) {
        ...
        sal_memset(entry, 0, sizeof(entry));
        sal_memset(memfld, 0, sizeof(memfld));
        TH4_PWRT_SET_FIELD(DCN_PKT_SIZEf, bcma_testutil_sal_rand32() & 0x3);
        TH4_PWRT_SET_FIELD(DCN_PKT_TOSf, bcma_testutil_sal_rand32() & 0xff);
        TH4_PWRT_SET_FIELD(DCN_PKT_TOS_MASKf, bcma_testutil_sal_rand32() & 0xff);
        TH4_PWRT_SET_FIELD(DCN_PKT_UPDATE_TOSf,
                           bcma_testutil_sal_rand32() & 0x1);
        TH4_PWRT_PT_DYN_INFO(pt_dyn_info, index, 0);
        SHR_IF_ERR_EXIT(th4_pwrt_pt_write(
            unit, sid, ltid, &pt_dyn_info, entry));
    ...
    for (index = 0; index < 512; index ++) {
        ...
        sal_memset(entry, 0, sizeof(entry));
        sal_memset(memfld, 0, sizeof(memfld));
        TH4_PWRT_SET_FIELD(OPAQUE_FIELD_1f, bcma_testutil_sal_rand32());
        TH4_PWRT_SET_FIELD(OPAQUE_FIELD_2f, bcma_testutil_sal_rand32());
        TH4_PWRT_SET_FIELD(OPAQUE_FIELD_3f, bcma_testutil_sal_rand32());
        TH4_PWRT_PT_DYN_INFO(pt_dyn_info, index, 0);
        SHR_IF_ERR_EXIT(th4_pwrt_pt_write(
            unit, sid, ltid, &pt_dyn_info, entry));
    }
...
static int setup_ing_pri_dscp_cn(int unit)
{
    ...
    for (i = 0; i < 8; i++) {
        sal_memset(entry, 0, sizeof(entry));
        sal_memset(memfld, 0, sizeof(memfld));
        TH4_PWRT_SET_FIELD(CHANGE_INNER_ECNf,
                           bcma_testutil_sal_rand32() & 0x1);
        TH4_PWRT_SET_FIELD(INCREMENT_ECN_COUNTERf,
                           bcma_testutil_sal_rand32() & 0x1);
        TH4_PWRT_SET_FIELD(INNER_ECNf,
                           bcma_testutil_sal_rand32() & 0x3);
    ...
    SHR_IF_ERR_EXIT
        (bcma_testutil_packet_dev_simple_init
            (unit, TRAFFIC_MAX_POWER_PKTDEV_CHAN_TX, TRAFFIC_MAX_POWER_PKTDEV_CHAN_RX,
             TRAFFIC_MAX_POWER_PKT_SIZE_MAX, &netif_id, &pktdev_id));
    ...
    if (tra_param->config_n_send) {
        BCMDRD_PBMP_ITER(power_test_p->pbmp_traffic, port) {
            ...
            for (idx = 0; idx < tra_param->pkt_cnt[port]; idx++) {
                ...
                rv = bcm56990_a0_power_fill_pkt(unit, packet->data_buf,
                                                &pkt_attr);
                if (SHR_FAILURE(rv)) {
