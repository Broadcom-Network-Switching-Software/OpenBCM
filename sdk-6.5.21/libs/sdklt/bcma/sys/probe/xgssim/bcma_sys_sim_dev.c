...
/*
 * By default we do not create any simulated devices for a full build.
 *
 * For partial builds we create one of each supported device, unless
 * the application overrides this explicitly.
 */
#ifndef BCMA_SYS_SIM_OVERRIDE_ONLY
#define BCMA_SYS_SIM_OVERRIDE_ONLY BCMDRD_CONFIG_INCLUDE_CHIP_DEFAULT
#endif
...
{
    int override_only = BCMA_SYS_SIM_OVERRIDE_ONLY;
