 ...
 * h/w engg
 */
#define VOLTAGE_RANGE_UPPER_A0 875
...
static int
bcm56780_a0_board_avs_voltage_set(int unit, uint32_t otp_voltage_val)
{
    char *regulator_name;
    int rv = SHR_E_NONE;
    double voltage;
...
static int
bcm56780_a0_board_avs_configure(int unit)
{
    ...
    if (avs_initialized == FALSE) {
        ...
        SHR_IF_ERR_EXIT(bcmbd_dev_param_get(unit, BCMBD_DEV_PRM_AVS_VOLTAGE,
                                            &otp_voltage));
        ...
        SHR_IF_ERR_EXIT(bcm56780_a0_board_avs_voltage_set(unit, otp_voltage));
...
static int
bcm56780_a0_board_init(int unit)
{
    ...
    SHR_IF_ERR_EXIT(bcm56780_a0_board_avs_configure(unit));

exit:
    SHR_FUNC_EXIT();
}

static bcma_board_drv_t bcm56780_a0_board_drv = {
    .board_init = bcm56780_a0_board_init
};

bcma_board_drv_t *
bcm56780_a0_board_drv_get(int unit)
{
    return &bcm56780_a0_board_drv;
}
