/*! \file bcm56880_a0_bcma_tecsup_device_attach.c
 *
...
static int
bcm56880_a0_bcma_tecsup_src(const bcmdrd_symbol_t *s, bcmdrd_sid_t sid,
                            void *vptr)
{
    uint32_t *src = vptr;
 ...
 */
static uint32_t
bcm56880_a0_bcma_tecsup_src_get(int unit, uint32_t sel)
{
    ...
    iter.function = bcm56880_a0_bcma_tecsup_src;
    iter.vptr = &src;
...
int
bcm56880_a0_bcma_tecsup_dev_data_get(int unit, uint32_t sel,
                                     bcma_tecsup_dev_data_t *data)
{
    ...
    data->src = bcm56880_a0_bcma_tecsup_src_get(unit, sel);
    return SHR_E_NONE;
}