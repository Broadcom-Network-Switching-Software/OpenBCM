...
/*!
 * \brief Initialize CLI with basic switch commands.
 *
 * This is a convenience function for initializing the CLI and adding
 * the most common switch commands.
 *
 * The CLI initialization of the public demo application is built
 * around this function.
 *
 * \param [in] sc System configuration data structure.
 *
 * \retval SHR_E_NONE No errors.
 * \retval SHR_E_FAIL CLI initialization failed.
 */
extern int
bcma_sys_conf_cli_basic(bcma_sys_conf_t *sc);

/*!
 * \brief Initialize CLI with default switch commands.
 *
 * This is a convenience function for initializing the CLI and adding
 * the default set of switch commands.
 *
 * The CLI initialization of the HSDK and of the SDK reference
 * initialization (used in the internal apps) are both built around
 * this function.
 *
 * \param [in] sc System configuration data structure.
 *
...
/*!
 * \brief Initialize DRD CLI extensions.
 *
 * This function will install CLI support functions for unit
 * management within the CLI.
 *
 * The function should be invoked after the DRD has been initialized,
 * i.e. after devices have been probed.
 *
 * \param [in] sc Initialized system configuration data structure.
 *
 * \return 0 if no errors, otherwise -1.
...
/*!
 * \brief Clean up DRD CLI extensions.
 *
 * \param [in] sc System configuration data structure.
 *
 * \return 0 if no errors, otherwise -1.
...
/*!
 * \brief Initialize base driver CLI extensions.
 *
 * This function will install BD CLI support functions e.g. for
 * capturing debug output from embedded firmware code.
 *
 * \param [in] sc Initialized system configuration data structure.
 *
 * \return 0 if no errors, otherwise -1.
...
/*!
 * \brief Clean up base driver CLI extensions.
 *
 * \param [in] sc System configuration data structure.
 *
 * \return 0 if no errors, otherwise -1.
