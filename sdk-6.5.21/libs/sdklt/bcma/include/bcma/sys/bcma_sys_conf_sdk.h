...
/*!
 * \brief Configure unit callbacks for CLI.
 *
 * This function will also initialize the default CLI unit number, so
 * it should be called after devices have been added to the DRD.
 *
 * \retval 0 No errors
 */
extern int
bcma_sys_conf_sdk_default_unit_update(void);
