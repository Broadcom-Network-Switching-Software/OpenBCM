...
/*!
 * \brief Get CPU statistic.
 *
 * \param [out] cpu_stats Returned CPU statistic.
 *
...
/*!
 * \brief Dump testing statistic.
 *
 * \param [in] time_diff Time duration in the testing.
 * \param [in] pkt_count Packet count.
 * \param [in] pkt_count_2 The second Packet count.
 * \param [in] pkt_len Packet length.
 * \param [in] cpu_end CPU statistic in the end.
 * \param [in] cpu_start CPU statistic in the beginning.
 * \param [in] show_time Whether to dump time information.
 * \param [in] show_pkt_count_2 Whether to dump the second packet count.
 *
 * \return SHR_E_NONE on success and error code otherwise.
 */
extern void
 ...
 * \param [in] new_pri New internal priority.
