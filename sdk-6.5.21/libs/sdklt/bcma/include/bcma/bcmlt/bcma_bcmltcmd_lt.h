...
/*! Help for CLI command. */
#define BCMA_BCMLTCMD_LT_HELP_2 \
    "\n" \
    ...
    "The number of tables listed or traversed will also be saved in the\n" \
    "local environment variable \"$0\", which can be useful for scripting."
