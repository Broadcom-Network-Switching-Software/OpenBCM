...
#define BCMA_BCMMGMTCMD_DEV_SYNOP "stop|start|restart|status [all] [warm=0|1]"

/*! Help for CLI command. */
#define BCMA_BCMMGMTCMD_DEV_HELP \
    "Add \'all\' for the whole system operation.\n" \
    "Add \'warm=0\' or \'warm=1\' to specify the warm-boot configuration of\n" \
    "command \'start\' or \'restart\'. Default setting is \'warm=0\'.\n" \
