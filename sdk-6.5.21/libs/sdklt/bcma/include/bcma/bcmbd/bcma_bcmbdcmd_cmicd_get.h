/*! \file bcma_bcmbdcmd_cmicd_get.h
 *
...
#ifndef BCMA_BCMBDCMD_CMICD_GET_H
#define BCMA_BCMBDCMD_CMICD_GET_H

#include <bcma/cli/bcma_cli.h>

/*! Brief description for CLI command. */
#define BCMA_BCMBDCMD_CMICD_GET_DESC \
    "Get chip register/memory contents."

/*! Syntax for CLI command. */
#define BCMA_BCMBDCMD_CMICD_GET_SYNOP \
    "<expr> [nz] [diff] [raw] [cf] [flags=<symflags>] [<field-filters>]"

/*! Help for CLI command. */
#define BCMA_BCMBDCMD_CMICD_GET_HELP \
...
/*! Help for CLI command. */
#define BCMA_BCMBDCMD_CMICD_GET_HELP_2 \
...
#define BCMA_BCMBDCMD_CMICD_GET_EXAMPLES \
    "GMACC1r.0\n" \
    "GMACC1r.gport0.1,4\n" \
...
/*!
 * \brief CLI 'get' command implementation for CMICd.
 *
...
#endif /* BCMA_BCMBDCMD_CMICD_GET_H */
