/*! \file bcma_bcmbdcmd_cmicd_list.h
 *
...
#ifndef BCMA_BCMBDCMD_CMICD_LIST_H
#define BCMA_BCMBDCMD_CMICD_LIST_H

#include <bcma/cli/bcma_cli.h>

/*! Brief description for CLI command. */
#define BCMA_BCMBDCMD_CMICD_LIST_DESC \
    "List symbols for a chip."

/*! Syntax for CLI command. */
#define BCMA_BCMBDCMD_CMICD_LIST_SYNOP \
    "[raw] [cf] <symbol-string>"

/*! Help for CLI command. */
#define BCMA_BCMBDCMD_CMICD_LIST_HELP \
...
/*!
 * \brief CLI 'list' command implementation for CMICd.
 *
...
#endif /* BCMA_BCMBDCMD_CMICD_LIST_H */
