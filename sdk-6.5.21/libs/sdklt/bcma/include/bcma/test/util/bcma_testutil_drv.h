...
typedef enum bcma_testutil_pt_type_e {
    ...
    /*! PT does not support SBUSDMA performance TR530. */
    BCMA_TESTUTIL_PT_MEM_TR_530,
 ...
 * \param [in] intr_mode Whether to use interrupt mode for memory DMA access.
 *
 * \return SHR_E_NONE on success, error code otherwise.
 */
...
/*!
 * \brief project specific macsec & ip/ep configurations
 *
 * \param [in] unit Unit number.
 * \param [in] port logical port.
 * \param [in] vid vlanid port.
 * \param [in] pid portid port.
 * \param [out] ms_bmp  Port bitmap.
 * \return SHR_E_NONE on success, error code otherwise.
 */
typedef int
( *bcma_testutil_drv_flex_pipe_macsec_config_set_f ) (
                int unit ,int port ,int vid , int pid , bcmdrd_pbmp_t *ms_bmp ) ;

/*!
 * \brief Delete port macsec configuration
 *
 * \param [in] unit Unit number.
 * \param [in] port logical port.
 * \param [in] pid portid port.
 ...
 */
typedef int
( *bcma_testutil_drv_flex_pipe_macsec_config_delete_f ) (
                int unit , int port , int pid , int vid ) ;
 ...
 */
extern int
 bcma_testutil_drv_flex_pipe_macsec_config_set (
              int unit , int port ,int vid , int pid , bcmdrd_pbmp_t *ms_bmp ) ;
 ...
 */
extern int
 bcma_testutil_drv_flex_pipe_macsec_config_delete (
              int unit, int port , int pid , int vid) ;
...
/*!
 * \brief Get the statistic of packet DMA.
 *
 * \param [in] unit Unit number.
 * \param [in] chan_id Packet DMA channel number.
 * \param [in] is_tx Chanel direction (true : TX, false: RX).
 * \param [out] ret_count Returned counter.
 *
 * \return SHR_E_NONE on success, error code otherwise.
 */
typedef int (*bcma_testutil_drv_pktdma_counter_get_f)(int unit, int chan_id,
                                                      bool is_tx, uint32_t *ret_count);

/*!
 * \brief Get port lane number.
 *
 * \param [in] unit Unit number.
 * \param [in] pm_mode_str PM mode.
 * \param [in] speed Port speed.
 * \param [out] num_lanes Returned lane number.
 *
 * \return SHR_E_NONE on success, error code otherwise.
 */
typedef int (*bcma_testutil_drv_flex_port_num_lanes_get_f)(int unit, char *pm_mode_str,
...
typedef struct bcma_testutil_drv_s {
    ...
    bcma_testutil_drv_flex_pipe_macsec_config_set_f flex_pipe_macsec_config_set ;

    /*! delete macsec configuration  */
    bcma_testutil_drv_flex_pipe_macsec_config_delete_f flex_pipe_macsec_config_delete ;
    ...
    /*! Get the statistic of packet DMA. */
    bcma_testutil_drv_pktdma_counter_get_f pktdma_counter_get;

    /*! Get port lane number. */
    bcma_testutil_drv_flex_port_num_lanes_get_f flex_port_num_lanes_get;
 ...
 */
extern int
bcma_testutil_drv_pktdma_counter_get(int unit, int chan_id,
                                     bool is_tx, uint32_t *ret_count);
