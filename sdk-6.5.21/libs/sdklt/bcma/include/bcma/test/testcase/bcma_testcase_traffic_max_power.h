...
typedef struct traffic_max_power_param_s {
    ...
    /*! Mirror ports speedgroup1 */
    bcmdrd_pbmp_t mirror_pbmp;

    /*! Mirror ports speedgroup1 */
    bcmdrd_pbmp_t mirror_pbmp1;
    /*! Mirror ports speedgroup2 */
    bcmdrd_pbmp_t mirror_pbmp2;
    /*! Mirror ports speedgroup3 */
    bcmdrd_pbmp_t mirror_pbmp3;
    /*! Mirror ports  speedgroup4*/
    bcmdrd_pbmp_t mirror_pbmp4;
