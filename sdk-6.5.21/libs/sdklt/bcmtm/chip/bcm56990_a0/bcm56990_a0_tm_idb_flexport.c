...
static const struct th4_obm_setting_s th4_mgmt_obm_settings[2] = {
    /* LOSSY Settings */
        { /* Index 0: Used for 10G port */
            828,             /* discard_limit */
...
th4_mgmt_obm_shared_config(int unit, int lport)
{
    ...
    setting_index = th4_get_mgmt_obm_setting_index(
                    port_map->lport_map[lport].cur_speed);
    sop_discard_mode =
        th4_mgmt_obm_settings[setting_index].sop_discard_mode;
    fid = SOP_DISCARD_MODEf;
    fval = sop_discard_mode;
    BCMTM_PT_DYN_INFO(pt_dyn_info, 0, pipe_num);
...
th4_mgmt_obm_thresh(int unit, int lport)
{
    ...
    subp = th4_get_subp_from_phy_port(phy_port);
    discard_limit =
        th4_mgmt_obm_settings[setting_index].discard_limit;
    lossless1_discard =
        th4_mgmt_obm_settings[setting_index].lossless_discard;
    lossless0_discard =
        th4_mgmt_obm_settings[setting_index].lossless_discard;
    lossy_discard =
        th4_mgmt_obm_settings[setting_index].lossy_discard;
    lossy_low_pri =
        th4_mgmt_obm_settings[setting_index].lossy_low_pri;
...
th4_mgmt_obm_fc_threshold(int unit, int lport)
{
    ...
    subp = th4_get_subp_from_phy_port(phy_port);
    lossless0_xon  =
        th4_mgmt_obm_settings[setting_index].lossless_xon;
    lossless1_xon  =
        th4_mgmt_obm_settings[setting_index].lossless_xon;
    lossless0_xoff =
        th4_mgmt_obm_settings[setting_index].lossless_xoff;
    lossless1_xoff =
        th4_mgmt_obm_settings[setting_index].lossless_xoff;
    port_xon       =
        th4_mgmt_obm_settings[setting_index].port_xon;
    port_xoff      =
        th4_mgmt_obm_settings[setting_index].port_xoff;
