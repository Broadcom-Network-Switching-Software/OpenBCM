...
#ifndef BCM56990_B0_TM_PFC_H
#define BCM56990_B0_TM_PFC_H
...
int
bcm56990_b0_pfc_deadlock_recovery_begin(int unit, int lport, int pri, int mode);
...
int
bcm56990_b0_pfc_deadlock_hw_status_clear(int unit, int lport, int pri);
#endif /* BCM56990_B0_TM_PFC_H */
