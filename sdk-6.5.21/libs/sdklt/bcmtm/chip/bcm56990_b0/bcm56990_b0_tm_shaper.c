/*! \file bcm56990_b0_tm_shaper.c
 *
 * Shaper related api and function for bcm56990_b0.
 */
/*
 ...
 */
static int
bcm56990_b0_tm_shaper_port_set(int unit,
        bcmtm_lport_t lport,
        bcmltd_sid_t ltid,
 ...
 */
static int
bcm56990_b0_tm_shaper_node_set(int unit,
        bcmtm_lport_t lport,
        ...
        bcmtm_shaper_cfg_t *shaper_cfg)
{
    ...
    SHR_IF_ERR_EXIT
        (bcm56990_b0_tm_sched_node_l0_map_get(unit, shaper_cfg->profile_id,
 ...
 */
static int
bcm56990_b0_tm_shaper_cpu_node_set(int unit,
        uint32_t sched_node_id,
        uint32_t sched_level,
        bcmltd_sid_t ltid,
        bcmtm_shaper_cfg_t *shaper_cfg)
...
bcm56990_b0_tm_shaper_drv_get(int unit, void *shaper_drv)
{
    ...
    bcmtm_shaper_drv_t bcm56990_b0_shaper_drv = {
        .port_set = bcm56990_b0_tm_shaper_port_set,
        .node_set = bcm56990_b0_tm_shaper_node_set,
        .cpu_node_set = bcm56990_b0_tm_shaper_cpu_node_set,
        .rate_to_bucket = bcm56990_b0_tm_shaper_rate_to_bucket,
        .bucket_to_rate = bcm56990_b0_tm_shaper_bucket_to_rate
    };
    SHR_FUNC_ENTER(unit);
    SHR_NULL_CHECK(shaper_drv, SHR_E_INTERNAL);
    *((bcmtm_shaper_drv_t *)shaper_drv) = bcm56990_b0_shaper_drv;
