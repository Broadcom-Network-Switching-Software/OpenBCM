...
#define TD4_EBST_FIFODMA_BUFFER_ENTRIES 16384
#define TD4_EBST_FIFO_CHAN0 1
#define TD4_EBST_FIFO_CHAN1 2
 ...
 */
static int
bcm56880_a0_tm_ebst_timestamp_init(int unit)
{
    bcmdrd_sid_t sid = 0;
    bcmdrd_fid_t fid = 0;
 ...
 */
static int
bcm56880_a0_tm_ebst_port_config_set(int unit,
                                    bcmltd_sid_t ltid,
                                    bcmtm_lport_t lport,
 ...
 */
static int
bcm56880_a0_tm_ebst_q_config_set(int unit,
                                 bcmltd_sid_t ltid,
                                 bcmtm_lport_t lport,
                                 uint16_t q_id,
                                 bcmtm_ebst_q_cfg_t *q_cfg)
{
    ...
    if (bcmtm_lport_is_cpu(unit, lport)) {
        ...
        if (q_cfg->q_type == MC_Q) {
            q_id += bcm56880_a0_tm_num_uc_q_non_cpu_port_get(unit);
        }
    }
 ...
 */
static int
bcm56880_a0_tm_ebst_scan_config_set(int unit,
                                    bcmltd_sid_t ltid,
 ...
 */
static int
bcm56880_a0_tm_ebst_data_parse(int unit,
                               uint32_t *entry,
 ...
 */
static int
bcm56880_a0_tm_ebst_enable(int unit,
                           bcmltd_sid_t ltid,
                           bool enable)
{
    uint32_t intr_num;
    ...
    for (itm = 0; itm < TD4_ITMS_PER_DEV; itm++) {
        MMU_INTR_INST_SET(intr_num, itm);
        SHR_IF_ERR_EXIT
 ...
 */
static int
bcm56880_a0_tm_ebst_map_alloc(int unit)
{
    int size;
    ...
    /* EBST queue map. */
    size = TD4_TM_CHIP_QUEUES * sizeof(bcmtm_ebst_entity_map_t);
    ...
    size = TD4_DEV_PORTS_PER_DEV * TD4_MAX_SERVICE_POOLS *
 ...
 */
static int
bcm56880_a0_tm_ebst_portsp_index_get(int unit,
                                     bcmtm_lport_t lport,
                                     uint8_t spid,
                                     uint16_t *map_idx)
{
 ...
 */
static int
bcm56880_a0_tm_ebst_q_map_index_get(int unit,
                                    bcmtm_lport_t lport,
                                    uint16_t q_id,
                                    ...
                                    uint16_t *map_idx)
{
    ...
    SHR_IF_ERR_EXIT
        (bcm56880_a0_tm_chip_q_get(unit, lport, q_id, &chip_q));
    *map_idx = chip_q;
exit:
    SHR_FUNC_EXIT();
}
...
{
    bcmtm_ebst_drv_t bcm56880_a0_tm_ebst_drv = {
        .ebst_port_config_set = bcm56880_a0_tm_ebst_port_config_set,
        .ebst_scan_config_set = bcm56880_a0_tm_ebst_scan_config_set,
        .ebst_portsp_index_get = bcm56880_a0_tm_ebst_portsp_index_get,
        .ebst_map_alloc = bcm56880_a0_tm_ebst_map_alloc,
        .ebst_q_config_set = bcm56880_a0_tm_ebst_q_config_set,
        .ebst_q_map_index_get = bcm56880_a0_tm_ebst_q_map_index_get,
        .ebst_data_parse = bcm56880_a0_tm_ebst_data_parse,
        .ebst_enable = bcm56880_a0_tm_ebst_enable
    };

    SHR_FUNC_ENTER(unit);

    SHR_NULL_CHECK(ebst_drv, SHR_E_INTERNAL);
    *((bcmtm_ebst_drv_t *)ebst_drv) = bcm56880_a0_tm_ebst_drv;
exit:
    SHR_FUNC_EXIT();
}
...
{
    bcmtm_ebst_dev_info_t *ebst_info;
    uint16_t chan_id[TD4_ITMS_PER_DEV] = {TD4_EBST_FIFO_CHAN0,
                                          TD4_EBST_FIFO_CHAN1};
    int idx;

    SHR_FUNC_ENTER(unit);
    SHR_IF_ERR_EXIT
        (bcmtm_ebst_dev_info_alloc(unit));

    bcmtm_ebst_dev_info_get(unit, &ebst_info);
    /* populate ebst info */
    ebst_info->max_buffer_pool = TD4_ITMS_PER_DEV;
    ebst_info->num_entries = TD4_EBST_FIFODMA_BUFFER_ENTRIES;
    ebst_info->thd_entries = TD4_EBST_FIFODMA_BUFFER_ENTRIES / 10;
    for (idx = 0; idx < TD4_ITMS_PER_DEV; idx++) {
    ...
    if (!warm) {
        SHR_IF_ERR_EXIT
            (bcm56880_a0_tm_ebst_timestamp_init(unit));
    }
exit:
    SHR_FUNC_EXIT();
}
