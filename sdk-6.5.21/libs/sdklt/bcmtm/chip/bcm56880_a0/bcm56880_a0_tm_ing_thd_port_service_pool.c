/*! \file bcm56880_a0_tm_ing_thd_port_service_pool.c
 *
...
tm_thd_ing_port_service_pool_populate_entry(int unit, int lport, int pool, int up)
{
    ...
    fid = TM_ING_THD_PORT_SERVICE_POOLt_SHARED_LIMIT_CELLSf;
    SHR_IF_ERR_EXIT
        (bcmtm_field_list_set(unit, &entry, fid, 0, fval));

    fid = TM_ING_THD_PORT_SERVICE_POOLt_RESUME_LIMIT_CELLSf;
    SHR_IF_ERR_EXIT
        (bcmtm_field_list_set(unit, &entry, fid, 0, fval));
                                    ...
                                    bool port_add)
{
    ...
    buf_port_pool = &buf->ports[lport].pools[pool];
    ...
    /* Retrieve current configuration from LT or HW. */
        /* Not port_add. Read values from LT OPER fields */
        SHR_IF_ERR_EXIT
    ...
    while (data_ptr) {
        ...
        switch (data_ptr->id) {
            ...
            case TM_ING_THD_PORT_SERVICE_POOLt_MIN_GUARANTEE_CELLSf:
                ...
                SHR_IF_ERR_EXIT
                    (bcm56880_a0_tm_thdi_port_to_itm_mapping_get(unit, lport, &itm));
...
static int
tm_thd_ing_port_service_pool_delete(int unit, int sid, int lport, int pool)
{
    ...
    SHR_IF_ERR_EXIT
        (tm_thd_ing_port_service_pool_update(unit, sid, lport, pool,
                                   ...
                                   bcmltd_fields_t *output_fields)
{
    ...
    switch (event_reason) {
        ...
        case BCMIMM_ENTRY_DELETE:
            SHR_IF_ERR_EXIT
                (tm_thd_ing_port_service_pool_delete(unit, sid, lport, pool));
            break;
        default:
            SHR_ERR_EXIT(SHR_E_PARAM);
    }
...
int
bcm56880_a0_tm_thd_ing_port_service_pool_register(int unit)
{
    ...
    tm_thd_cb_handler.stage    = tm_thd_ing_port_service_pool_stage;
...
int
bcm56880_a0_tm_thd_ing_port_service_pool_populate(int unit)
{
    int lport;
    int pool, rv;
    const bcmlrd_map_t *map = NULL;
...
int
bcm56880_a0_tm_thd_ing_port_service_pool_update(int unit, int pport, int up)
{
    int lport;
    int pool, rv;
    const bcmlrd_map_t *map = NULL;
