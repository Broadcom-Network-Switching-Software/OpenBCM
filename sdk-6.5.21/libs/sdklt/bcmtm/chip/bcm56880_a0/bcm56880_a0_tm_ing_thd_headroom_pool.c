/*! \file bcm56880_a0_tm_ing_thd_headroom_pool.c
 *
...
int
bcm56880_a0_tm_thd_ing_headroom_pool_register(int unit)
{
...
int
bcm56880_a0_tm_thd_ing_headroom_pool_populate(int unit)
{
    int itm;
    int pool, rv;
    const bcmlrd_map_t *map = NULL;
