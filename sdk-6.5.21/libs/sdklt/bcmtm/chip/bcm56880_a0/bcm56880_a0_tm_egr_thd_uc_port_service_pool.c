                                       ...
                                       bcmltd_fields_t *output_fields)
{
    ...
    bcmdrd_fid_t field_sp_color_en[TD4_MMU_NUM_POOL] = {
    ...
    bcmdrd_fid_t field_sp_yellow[TD4_MMU_NUM_POOL] = {
            SP0_YELLOW_LIMITf, SP1_YELLOW_LIMITf,
            SP2_YELLOW_LIMITf, SP3_YELLOW_LIMITf};
    bcmdrd_fid_t field_sp_red[TD4_MMU_NUM_POOL] = {
    ...
    bcmdrd_fid_t field_ebst_profile[TD4_MMU_NUM_POOL] = {
