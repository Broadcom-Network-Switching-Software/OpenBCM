/*! \file bcm56880_a0_tm_ing_thd_service_pool.c
 *
...
static int
tm_thd_ing_service_pool_delete(int unit, bcmltd_sid_t sid, int itm, int pool)
{
    ...
    SHR_IF_ERR_EXIT
        (tm_thd_ing_service_pool_update(unit, sid, itm, pool, data_fields,
                                        &dummy_fields));
                              ...
                              bcmltd_fields_t *output_fields)
{
    ...
    switch (event_reason) {
        ...
        case BCMIMM_ENTRY_UPDATE:
            SHR_IF_ERR_EXIT
                (tm_thd_ing_service_pool_update(unit, sid, itm, pool,
                                                data_fields, output_fields));
            break;
        case BCMIMM_ENTRY_DELETE:
            SHR_IF_ERR_EXIT
                (tm_thd_ing_service_pool_delete(unit, sid, itm, pool));
            break;
        default:
            SHR_ERR_EXIT(SHR_E_PARAM);
    }
...
int
bcm56880_a0_tm_thd_ing_service_pool_register(int unit)
{
    ...
    tm_thd_cb_handler.stage    = tm_thd_ing_service_pool_stage;
...
int
bcm56880_a0_tm_thd_ing_service_pool_populate(int unit)
{
    int itm;
    int pool, rv;
    const bcmlrd_map_t *map = NULL;
