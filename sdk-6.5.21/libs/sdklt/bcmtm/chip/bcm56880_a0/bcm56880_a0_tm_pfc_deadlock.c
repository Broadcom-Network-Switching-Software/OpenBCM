/*! \file bcm56880_a0_tm_pfc_deadlock.c
 *
 ...
 */
int
bcm56880_a0_tm_pfc_deadlock_recovery_status_populate(int unit)
{
...
int
bcm56880_a0_tm_pfc_deadlock_recovery_status_update(int unit,
                                              int pport, int up)
{
    int lport, rv, pri = 0;
...
int
bcm56880_a0_tm_pfc_deadlock_recovery_update(int unit,
                                            int pport, int up)
{
    int lport, rv, pri = 0;
    const bcmlrd_map_t *map = NULL;
