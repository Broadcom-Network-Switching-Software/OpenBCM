/*! \file bcm56880_a0_tm_egr_thd_mc_port_service_pool.c
 *
 ...
 */
int
bcm56880_a0_tm_thd_egr_mc_port_service_pool_register(int unit)
{
...
int
bcm56880_a0_tm_thd_egr_mc_port_service_pool_populate(int unit)
{
    int lport, pool, rv;
    const bcmlrd_map_t *map = NULL;
...
int
bcm56880_a0_tm_thd_egr_mc_port_service_pool_update(int unit, int pport, int up)
{
    int lport, pool, rv;
    const bcmlrd_map_t *map = NULL;
