...
static struct bst_sid_list_s {
    ...
    {MMU_GLBCFG_BST_TRACKING_ENABLEr, BST_TRACK_EN_THDO0f}, /* 1 */
    {MMU_GLBCFG_BST_TRACKING_ENABLEr, BST_TRACK_EN_THDR0f}, /* 2 */
    {MMU_GLBCFG_BST_TRACKING_ENABLEr, BST_TRACK_EN_CFAP0f}, /* 3 */

    /* Skip BST interrupt enable. State = Armed. Set via API.*/

    /* BST interrupt set. State = Triggered. */
    {MMU_THDI_CPU_INT_SETr, BST_TRIGf},                     /* 4 */
    {MMU_THDO_BST_CPU_INT_SETr, BSTf},                      /* 5 */
    {MMU_THDR_QE_CPU_INT_SETr, BSTf},                       /* 6 */
    {MMU_CFAP_INT_SETr, BST_TRIGf},                         /* 7 */
};
 ...
 */
static int
bst_state_sid_map[BST_EVENT_CLASS_MAX][BST_EVENT_STATE_MAX] =
{
 ...
 */
static int
bst_state_sid_map_off[BST_EVENT_CLASS_MAX][2] =
{
    /* INT_SET */
    {0, 4},  /* Ingress */
    {1, 5},  /* Egress */
 ...
 */
static int
bcm56780_a0_bst_event_notify_triggered(int unit,
                                       int buffer_pool,
                                       bcmtm_bst_event_class_t class)
{
    ...
    bst_dev_info->trigger_state[buffer_pool][class] = 0;
exit:
    SHR_FUNC_EXIT();
}
 ...
 */
static int
bcm56780_a0_tm_bst_event_ing_src(int unit,
                                 bcmltd_sid_t ltid,
                                 int pipe,
                                 ...
                                 bcmltd_fields_t *in)
{
    ...
    switch (type) {
        ...
        case PORT_SERVICE_POOL:
            ...
            local_mport = (data >> 2);
            mport =  pipe * TD4_X9_MMU_PORTS_PER_PIPE + local_mport;
            SHR_IF_ERR_EXIT
 ...
 */
static int
bcm56780_a0_bst_event_ingress(int unit,
                              int buffer_pool)
{
    uint32_t pipe_bmp;
    ...
    in.count = 0;
    SHR_IF_ERR_EXIT
        (bcmdrd_dev_valid_pipes_get(unit, &pipe_bmp));
        ...
        if (pipe_bmp & 0x1) {
            ...
            for (idx = 0; idx < MAX_BST_ING_STATUS; idx++) {
                ...
                if (fval) {
                    ...
                    SHR_IF_ERR_EXIT
                        (bcm56780_a0_tm_bst_event_ing_src(unit, ltid, pipe,
                                                          idx, fval, &in));
                }
            }
    ...
    SHR_IF_ERR_EXIT
        (bcm56780_a0_bst_event_notify_triggered(unit, buffer_pool,
                                                BST_EVENT_CLASS_ING));
exit:
 ...
 */
static int
bcm56780_a0_bst_event_egress_source(int unit,
                                    bcmltd_sid_t ltid,
                                    ...
                                    bcmltd_fields_t *in)
{
    ...
    switch (type) {
        ...
        case QUEUE:
            SHR_IF_ERR_EXIT
                (bcm56780_a0_tm_mmu_q_from_chip_q_get(unit, fval, &lport,
                                                      &q_id, &q_type));
        ...
        case UC_PORT_SERVICE_POOL:
            ...
            mchip_port = fval >> 2;
            SHR_IF_ERR_EXIT
                (bcm56780_a0_tm_mchip_port_lport_get(unit, mchip_port, &lport));
 ...
 */
static int
bcm56780_a0_bst_event_egress(int unit, int itm)
{
    uint32_t fval;
    uint32_t ltmbuf = 0, ltmbuf1 = 0;
    ...
    if (fval) {
        ...
        SHR_IF_ERR_EXIT
            (bcmtm_field_get(unit, sid, fid, &ltmbuf, &fval));
        SHR_IF_ERR_EXIT
            (bcm56780_a0_bst_event_egress_source(unit, ltid, type, fval, &in));
    }
    ...
    SHR_IF_ERR_EXIT
        (bcmimm_entry_update(unit, 0, ltid, &in));
    SHR_IF_ERR_EXIT
        (bcm56780_a0_bst_event_notify_triggered(unit, itm,
                                                BST_EVENT_CLASS_EGR));
exit:
    SHR_FUNC_EXIT();
}
 ...
 */
static int
bcm56780_a0_bst_event_repl_queue(int unit, int itm)
{
    uint32_t fval;
    uint32_t ltm_buf0 = {0};
    bcmtm_pt_info_t pt_info = {0};
 ...
 */
static int
bcm56780_a0_bst_event_cfap(int unit, int itm)
{
    SHR_FUNC_ENTER(unit);
 ...
 */
static int
bcm56780_a0_tm_bst_intr_enable(int unit,
                               bcmtm_bst_event_class_t class,
                               bcmtm_intr_enable_t enable)
{
    ...
    switch (class) {
        case BST_EVENT_CLASS_ING:
            intr_num = MMU_INTR_THDI_BST;
            break;
        case BST_EVENT_CLASS_EGR:
            intr_num = MMU_INTR_THDO_BST;
            break;
        case BST_EVENT_CLASS_REPL_QUEUE:
            intr_num = MMU_INTR_THDR_BST;
            break;
        case BST_EVENT_CLASS_DEVICE:
            intr_num = MMU_INTR_CFAP_BST;
            break;
        default:
            SHR_ERR_EXIT(SHR_E_PARAM);
    }
    SHR_IF_ERR_EXIT
        (bcmtm_interrupt_enable(unit, intr_num,
                                bcm56780_a0_tm_bst_intr_notify, enable));
exit:
    SHR_FUNC_EXIT();
}
 ...
 */
static int
bcm56780_a0_tm_bst_intr_clear(int unit,
                              int buffer_pool,
                              bcmtm_bst_event_class_t class)
{
    uint32_t intr_num;
 ...
 */
static int
bcm56780_a0_tm_bst_trigger(int unit,
                           bcmtm_bst_trigger_t *trigger_info)
{
    ...
    class = trigger_info->class;

    /*
     * If trigger state is disable application is not expecting any
    ...
    if (bst_dev_info->trigger_state[buffer_pool][class]) {
        switch (class) {
            ...
            case BST_EVENT_CLASS_ING:
                SHR_IF_ERR_EXIT
                    (bcm56780_a0_bst_event_ingress(unit, buffer_pool));
                break;
                /* Egress BST events */
            case BST_EVENT_CLASS_EGR:
                SHR_IF_ERR_EXIT
                    (bcm56780_a0_bst_event_egress(unit, buffer_pool));
                break;
                /* Replication queue BST events */
            case BST_EVENT_CLASS_REPL_QUEUE:
                SHR_IF_ERR_EXIT
                    (bcm56780_a0_bst_event_repl_queue(unit, buffer_pool));
                break;
                /* Device CFAP BST events */
            case BST_EVENT_CLASS_DEVICE:
                SHR_IF_ERR_EXIT
                    (bcm56780_a0_bst_event_cfap(unit, buffer_pool));
                break;
            default:
                SHR_ERR_EXIT(SHR_E_PARAM);
        }
        SHR_IF_ERR_EXIT
            (bcm56780_a0_tm_bst_intr_clear(unit, buffer_pool, class));

    } else {
        SHR_IF_ERR_EXIT
            (bcm56780_a0_tm_bst_intr_clear(unit, buffer_pool, class));
        SHR_IF_ERR_EXIT
            (bcm56780_a0_tm_bst_intr_enable(unit, class, INTR_ENABLE));
    }
exit:
    SHR_FUNC_EXIT();
}
 ...
 */
static int
bcm56780_a0_tm_bst_control_pt_set(int unit,
                                  bcmltd_sid_t ltid,
 ...
 */
static int
bcm56780_a0_tm_bst_event_state_enable(int unit,
                                      bcmltd_sid_t ltid,
                                      uint8_t buffer_pool,
                                      bcmtm_bst_event_class_t class,
                                      bcmtm_bst_event_state_t state)
{
    ...
    map_id = bst_state_sid_map[class][state];
 ...
 */
static int
bcm56780_a0_tm_bst_event_state_disable(int unit,
                                       bcmltd_sid_t ltid,
                                       uint8_t buffer_pool,
                                       bcmtm_bst_event_class_t class)
{
...
/*!
 * \brief BST Event interrupt enable.
 * This disabled interrupt event registers when the state changes from any stated to
 * OFF state.
 *
 * \param [in] unit Logical unit number.
 * \param [in] ltid Logical table ID.
 ...
 */
static int
bcm56780_a0_tm_bst_intr_state_disable(int unit,
                                      bcmltd_sid_t ltid,
                                      uint8_t buffer_pool,
                                      bcmtm_bst_event_class_t class)
{
     ...
     */
    map_id = bst_state_sid_map_off[class][1];
    sid = bst_event_sid_list[map_id].sid;
    fid = bst_event_sid_list[map_id].fid;
    BCMTM_PT_DYN_INFO(pt_info, 0, buffer_pool);
 ...
 */
static int
bcm56780_a0_tm_bst_event_control_set(int unit,
                                     bcmltd_sid_t ltid,
                                     bcmtm_bst_event_cfg_t *bst_event_cfg)
{
    uint8_t buffer_pool;
    ...
    SHR_IF_ERR_EXIT
        (bcm56780_a0_tm_bst_event_state_disable(unit, ltid, buffer_pool, class));
    ...
    switch (state) {
        ...
        case BST_EVENT_STATE_ARMED_PASSIVE:
            ...
            SHR_IF_ERR_EXIT
                (bcm56780_a0_tm_bst_event_state_enable(unit, ltid, buffer_pool,
                                                       class, state));
            break;
            /*! BST Event state switched to OFF. */
        case BST_EVENT_STATE_OFF:
            SHR_IF_ERR_EXIT
                (bcm56780_a0_tm_bst_intr_state_disable(unit, ltid,
                                                       buffer_pool, class));
            /* Clear all the interrupts. */
            SHR_IF_ERR_EXIT
                (bcm56780_a0_tm_bst_intr_clear(unit, buffer_pool, class));
            SHR_IF_ERR_EXIT
                (bcm56780_a0_tm_bst_intr_enable(unit, class, INTR_DISABLE));
            break;
        default:
            break;
    }
 ...
 */
void
bcm56780_a0_tm_bst_intr_notify(int unit,
                               uint32_t intr_param)
{
    uint32_t intr_num;
...
int
bcm56780_a0_tm_bst_drv_get(int unit, void *bst_drv)
{
    bcmtm_bst_drv_t bcm56780_a0_bst_drv = {
        .bst_event_control_set = bcm56780_a0_tm_bst_event_control_set,
        .bst_control_pt_set = bcm56780_a0_tm_bst_control_pt_set,
        .bst_trigger = bcm56780_a0_tm_bst_trigger,
    };
    SHR_FUNC_ENTER(unit);

    SHR_NULL_CHECK(bst_drv, SHR_E_INTERNAL);
    *((bcmtm_bst_drv_t *)bst_drv) = bcm56780_a0_bst_drv;
exit:
    SHR_FUNC_EXIT();
}
