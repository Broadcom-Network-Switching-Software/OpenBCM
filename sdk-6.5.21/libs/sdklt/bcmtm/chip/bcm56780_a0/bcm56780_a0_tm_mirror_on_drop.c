/*! \file bcm56780_a0_tm_mirror_on_drop.c
 *
 ...
 */
static int
bcm56780_a0_tm_mod_enable_hw_write(int unit,
                                   bcmltd_sid_t ltid,
                                   uint32_t enable,
                                   uint32_t *enable_opr)
{
 ...
 */
static int
bcm56780_a0_tm_mod_buffer_limit_hw_write(int unit,
                                   bcmltd_sid_t ltid,
                                   uint32_t buf_limit,
                                   uint32_t *buf_limit_opr)
{
    ...
    if (SHR_SUCCESS
            (bcm56780_a0_tm_shared_buffer_update(unit, 0, -1,
                                                 delta, RESERVED_BUFFER_UPDATE,
                                                 TRUE))) {
        SHR_IF_ERR_EXIT
            (bcm56780_a0_tm_shared_buffer_update(unit, 0, -1, delta,
...
static int
bcm56780_a0_tm_mod_dest_delete_hw(int unit,
                                  bcmltd_sid_t sid)
{
    bcmdrd_sid_t ptid;
    uint32_t ltmbuf[BCMTM_MAX_THD_ENTRY_WSIZE] = {0};
...
static int
bcm56780_a0_tm_mod_dest_delete(int unit,
                               bcmltd_sid_t sid)

{
    ...
    SHR_IF_ERR_EXIT
        (bcm56780_a0_tm_mod_dest_delete_hw(unit, sid));
...
static int
bcm56780_a0_tm_mod_dest_set_hw(int unit,
                               bcmltd_sid_t sid,
                               uint32_t lport,
                               uint32_t queue)
{
    ...
    inst = pipe;
    BCMTM_PT_DYN_INFO(pt_dyn_info, 0, inst);
    lcl_mmu_port = mport % TD4_X9_MMU_PORT_PIPE_OFFSET;
 ...
 */
static int
bcm56780_a0_tm_mod_dest_set(int unit,
                   bcmltd_sid_t ltid,
                   uint32_t dest_id,
    ...
    if ((action == ACTION_INSERT) || (action == ACTION_UPDATE) ||
        ...
        if ((!port_valid) || (!queue_valid)) {
             ...
             if ((action == ACTION_UPDATE) && (opr_old == MOD_MRDP_VALID)) {
                    SHR_IF_ERR_EXIT
                        (bcm56780_a0_tm_mod_dest_delete(unit, ltid));
             }
        }
        ...
        if (!port_valid) {
            ...
            *opcode = MOD_MRDP_INCORRECT_QUEUE;
            ...
            SHR_IF_ERR_EXIT
                (bcm56780_a0_tm_mod_dest_set_hw(unit, ltid, dest_info.lport, q_out));
            *opcode = MOD_MRDP_VALID;
        }
        SHR_EXIT();
    } else if ( action == ACTION_DELETE) {
        SHR_IF_ERR_EXIT
            (bcm56780_a0_tm_mod_dest_delete_hw(unit, ltid));
 ...
 */
static int
bcm56780_a0_tm_mod_encap_set(int unit,
                             bcmltd_sid_t ltid,
 ...
 */
int
bcm56780_a0_tm_mod_drv_get(int unit, void *mod_drv)
{
    bcmtm_mod_drv_t bcm56780_a0_mod_drv = {
        .enable_set = bcm56780_a0_tm_mod_enable_hw_write,
        .buffer_set = bcm56780_a0_tm_mod_buffer_limit_hw_write,
        .dest_set = bcm56780_a0_tm_mod_dest_set,
        .encap_set = bcm56780_a0_tm_mod_encap_set,
    };
    SHR_FUNC_ENTER(unit);

    SHR_NULL_CHECK(mod_drv, SHR_E_INTERNAL);
    *((bcmtm_mod_drv_t *)mod_drv) = bcm56780_a0_mod_drv;
exit:
    SHR_FUNC_EXIT();
}
