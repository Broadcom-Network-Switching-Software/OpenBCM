/*! \file bcm56780_a0_tm_edb_flexport.c
 *
 ...
 */
static int
bcm56780_a0_tm_edb_pt_write(int unit, int pt_id, int pt_inst, bcmdrd_sid_t mem,
...
static int
bcm56780_a0_tm_edb_pt_read(int unit, int pt_id, int pt_inst, bcmdrd_sid_t mem,
                bcmdrd_fid_t fid, uint32_t *fval)
{
    bcmtm_pt_info_t pt_info = {0};
    bcmltd_sid_t ltid = -1; /* Requesting LT ID not available */
    ...
    SHR_IF_ERR_EXIT
        (bcmtm_field_get(unit, mem, fid, ltmbuf, &fval_tmp));
    *fval = fval_tmp;
exit:
    SHR_FUNC_EXIT();
}
 ...
 */
static int
bcm56780_a0_tm_edb_e2e_tbl_speed_encoding_get(int unit, int lport)
{
    int idx, speed;
    int spd_encoding = 0;
    ...
    for (idx = 0; idx < TD4_X9_EDB_NUM_CT_CLASSES; idx++) {
        if (bcm56780_a0_edb_e2e_tbl[idx].speed == speed) {
            spd_encoding = idx;
            break;
        }
    }
 ...
 */
static int
bcm56780_a0_tm_edb_e2e_tbl_opt_encoding_get(int unit)
{
    ...
    return (opt_encoding % TD4_X9_EDB_E2E_NUM_PFC_OPT_CFG);
}
 ...
 */
static int
bcm56780_a0_tm_edb_e2e_tbl_ct_class_get(int unit, int lport)
{
    int spd_encoding, ct_class;

    spd_encoding = bcm56780_a0_tm_edb_e2e_tbl_speed_encoding_get(unit, lport);
    ct_class = bcm56780_a0_edb_e2e_tbl[spd_encoding].ct_class;
 ...
 */
static int
bcm56780_a0_tm_edb_e2e_tbl_mmu_credit_get(int unit, int lport)
{
    int spd_encoding, opt_encoding;
    int credit = 0;

    spd_encoding = bcm56780_a0_tm_edb_e2e_tbl_speed_encoding_get(unit, lport);
    opt_encoding = bcm56780_a0_tm_edb_e2e_tbl_opt_encoding_get(unit);

    if (opt_encoding == 0) {
        /* General cases */
        credit = bcm56780_a0_edb_e2e_tbl[spd_encoding].mmu_credit;
    } else {
        /* PFC Optimized cases for 1350MHz or 1500MHz */
        credit = bcm56780_a0_edb_e2e_tbl[spd_encoding].mmu_credit_pfc_opt;
    }
    return credit;
}
 ...
 */
static int
bcm56780_a0_tm_edb_e2e_tbl_xmit_cnt_get(int unit, int lport, int ct_valid)
{
    int spd_encoding, opt_encoding;
    int xmit_cnt = 0;
    ...
    if (bcmtm_lport_is_fp(unit, lport)) {
        opt_encoding = bcm56780_a0_tm_edb_e2e_tbl_opt_encoding_get(unit);
        spd_encoding =
                bcm56780_a0_tm_edb_e2e_tbl_speed_encoding_get(unit, lport);

        if (ct_valid == 0) {
            xmit_cnt =
            bcm56780_a0_edb_e2e_tbl[spd_encoding].xmit_cnt[opt_encoding].saf;
        } else {
            xmit_cnt =
            bcm56780_a0_edb_e2e_tbl[spd_encoding].xmit_cnt[opt_encoding].ct;
        }
        ...
        xmit_cnt = TD4_X9_EDB_XMIT_START_CNT_MGMT;
 ...
 */
static int
bcm56780_a0_tm_edb_drain_port(int unit, int lport)
{
    bcmtm_port_map_info_t *port_map;
    ...
    SHR_IF_ERR_EXIT
        (bcm56780_a0_tm_edb_pt_read(unit, pt_id, pt_inst, reg, fid, &fval_saved));
    SHR_IF_ERR_EXIT
        (bcm56780_a0_tm_edb_pt_write(unit, pt_id, pt_inst, reg, fid, fval));
    ...
    do {
        ...
        SHR_IF_ERR_EXIT
            (bcm56780_a0_tm_edb_pt_read(unit, pt_id, pt_inst, mem, fid, &num_entries));
 ...
 */
static int
bcm56780_a0_tm_edb_port_enable_set(int unit, int lport, int rst_on)
{
    bcmtm_port_map_info_t *port_map;
    bcmdrd_sid_t mem;
    bcmdrd_fid_t fid;
    ...
    SHR_IF_ERR_EXIT
        (bcm56780_a0_tm_edb_pt_write(unit, pt_id, pt_inst, mem, fid, fval));
exit:
    SHR_FUNC_EXIT();
}
 ...
 */
static int
bcm56780_a0_tm_edb_port_buf_sft_rst_set(int unit, int lport, int rst_on)
{
    bcmtm_port_map_info_t *port_map;
    bcmdrd_sid_t mem;
    bcmdrd_fid_t fid;
 ...
 */
static int
bcm56780_a0_tm_edb_dev2phy_mapping_set(int unit, int lport, int rst_on)
{
    bcmtm_port_map_info_t *port_map;
    bcmdrd_sid_t mem;
    bcmdrd_fid_t fid;
 ...
 */
static int
bcm56780_a0_tm_edb_ep2mmu_port_credit_get(int unit, int lport)
{
    int credit = 0;
    int opt_encoding;
    ...
    if (bcmtm_lport_is_fp(unit, lport)) {
        /* FP */
        credit = bcm56780_a0_tm_edb_e2e_tbl_mmu_credit_get(unit, lport);
    } else if (bcmtm_lport_is_lb(unit, lport)) {
        /* LPBK: LBK credits for >100G */
        credit = TD4_X9_EDB_EP2MMU_CRED_LBK;
 ...
 */
static int
bcm56780_a0_tm_edb_port_xmit_cnt_array_get(int unit, int lport,
                                int *xmit_cnt, int xmit_cnt_size)
{
    ...
    if (bcmtm_lport_is_fp(unit, lport)) {
        /* FP */
        dst_ct_class = bcm56780_a0_tm_edb_e2e_tbl_ct_class_get(unit, lport);
        saf_xmit_cnt = bcm56780_a0_tm_edb_e2e_tbl_xmit_cnt_get(unit, lport, 0);
        ct_xmit_cnt  = bcm56780_a0_tm_edb_e2e_tbl_xmit_cnt_get(unit, lport, 1);
        ...
        /* LPBK, CPU and MGM */
        xmit_cnt[0] = bcm56780_a0_tm_edb_e2e_tbl_xmit_cnt_get(unit, lport, 0);
    }
    return 0;
}
 ...
 */
static int
bcm56780_a0_tm_edb_mmu_cell_credit_set(int unit, int lport, int rst_on)
{
    bcmtm_port_map_info_t *port_map;
    bcmdrd_sid_t mem;
    bcmdrd_fid_t fid;
    ...
    pport  = port_map->lport_map[lport].pport;
    credit =
    (rst_on == 1) ? 0 : (bcm56780_a0_tm_edb_ep2mmu_port_credit_get(unit, lport));
 ...
 */
static int
bcm56780_a0_tm_edb_ct_class_set(int unit, int lport, int rst_on)
{
    bcmdrd_sid_t mem;
    bcmdrd_fid_t fid;
    uint32_t fval;
     ...
     */
    ct_class =
    (rst_on == 1) ? 0 : (bcm56780_a0_tm_edb_e2e_tbl_ct_class_get(unit, lport));
 ...
 */
static int
bcm56780_a0_tm_edb_xmit_start_cnt_set(int unit, int lport, int rst_on)
{
    bcmtm_port_map_info_t *port_map;
    bcmdrd_sid_t mem;
    bcmdrd_fid_t fid;
    ...
    int pport, pipe_num;
    int local_lport;
    int xmit_cnt[TD4_X9_EDB_MAX_CT_CLASSES];
    ...
    if (rst_on == 1) {
        sal_memset(xmit_cnt, 0, TD4_X9_EDB_MAX_CT_CLASSES * sizeof(int));
    } else {
        bcm56780_a0_tm_edb_port_xmit_cnt_array_get(unit, lport, xmit_cnt,
                                        TD4_X9_EDB_MAX_CT_CLASSES);
    }
    ...
    for (ct_class = 0; ct_class < TD4_X9_EDB_MAX_CT_CLASSES; ct_class++) {
        local_lport = lport % TD4_X9_DEV_PORTS_PER_PIPE;
        pt_id = local_lport * TD4_X9_EDB_MAX_CT_CLASSES + ct_class;
 ...
 */
static int
bcm56780_a0_tm_port_edb_up_config_ports(int unit, int lport)
{
    int rst_on = 0;
    SHR_FUNC_ENTER(unit);
     ...
     */
    SHR_IF_ERR_EXIT
        (bcm56780_a0_tm_edb_dev2phy_mapping_set(unit, lport, rst_on));
    SHR_IF_ERR_EXIT
        (bcm56780_a0_tm_edb_mmu_cell_credit_set(unit, lport, rst_on));
    SHR_IF_ERR_EXIT
        (bcm56780_a0_tm_edb_ct_class_set(unit, lport, rst_on));
    SHR_IF_ERR_EXIT
        (bcm56780_a0_tm_edb_xmit_start_cnt_set(unit, lport, rst_on));
exit:
    SHR_FUNC_EXIT();
}
 ...
 */
static int
bcm56780_a0_tm_port_edb_up_enable_ports(int unit, int lport)
{
    int rst_on = 0;
    SHR_FUNC_ENTER(unit);
    ...
    rst_on = 1;
    SHR_IF_ERR_EXIT
        (bcm56780_a0_tm_edb_port_buf_sft_rst_set(unit, lport, rst_on));
    rst_on = 0;
    SHR_IF_ERR_EXIT
        (bcm56780_a0_tm_edb_port_buf_sft_rst_set(unit, lport, rst_on));
    SHR_IF_ERR_EXIT
        (bcm56780_a0_tm_edb_port_enable_set(unit, lport, rst_on));
exit:
    SHR_FUNC_EXIT();
}
...
bcm56780_a0_tm_port_edb_down(int unit, bcmtm_pport_t pport)
{
    ...
    if (lport != -1) {
         ...
         */
        SHR_IF_ERR_EXIT
            (bcm56780_a0_tm_edb_drain_port(unit, lport));
...
bcm56780_a0_tm_port_edb_up(int unit, bcmtm_pport_t pport)
{
    ...
    if (lport != -1) {
         ...
         */
        SHR_IF_ERR_EXIT
            (bcm56780_a0_tm_port_edb_up_enable_ports(unit, lport));
    }
...
bcm56780_a0_tm_port_edb_add(int unit, bcmtm_pport_t pport)
{
    ...
    if (lport != -1) {
        SHR_IF_ERR_EXIT
            (bcm56780_a0_tm_port_edb_up_config_ports(unit, lport));
    }
exit:
    SHR_FUNC_EXIT();
}
