/*! \file bcm56780_a0_tm_ing_thd_port_service_pool.c
 *
    ...
    while (data_ptr) {
        ...
        switch (data_ptr->id) {
            ...
            case TM_ING_THD_PORT_SERVICE_POOLt_MIN_GUARANTEE_CELLSf:
                ...
                rv = bcm56780_a0_tm_shared_buffer_update(unit, 0, pool, delta,
