/*! \file bcm56780_a0_tm_egr_thd_uc_port_service_pool.c
 *
                                       ...
                                       bcmltd_fields_t *output_fields)
{
    ...
    bcmdrd_fid_t field_sp_color_en[TD4_X9_MAX_SERVICE_POOLS] = {
    ...
    bcmdrd_fid_t field_sp_yellow[TD4_X9_MAX_SERVICE_POOLS] = {
            SP0_YELLOW_LIMITf, SP1_YELLOW_LIMITf,
            SP2_YELLOW_LIMITf, SP3_YELLOW_LIMITf};
    bcmdrd_fid_t field_sp_red[TD4_X9_MAX_SERVICE_POOLS] = {
    ...
    bcmdrd_fid_t field_ebst_profile[TD4_X9_MAX_SERVICE_POOLS] = {
...
bcm56780_a0_tm_thd_egr_uc_port_service_pool_populate(int unit)
{
    ...
    for (lport = 1; lport < TD4_X9_MMU_NUM_LPORT; lport++) {
