...
bcm56780_a0_bcmtm_pfc_ddr_drv_get(int unit)
{
    static bcmtm_pfc_ddr_drv_t drv = {
        ...
        .hw_status_clear =  bcm56780_a0_pfc_deadlock_hw_status_clear,
    };
...
bcmtm_drv_t bcm56780_a0_tm_drv = {
    ...
    .ts_tod_drv_get = bcm56780_a0_tm_ts_tod_drv_get,
    ...
    .update_unicast_drop_config = bcm56780_a0_tm_update_unicast_drop_config,
    .check_ep_mmu_credit = bcm56780_a0_tm_check_ep_mmu_credit,
    .check_port_ep_credit = bcm56780_a0_tm_check_port_ep_credit,
};
