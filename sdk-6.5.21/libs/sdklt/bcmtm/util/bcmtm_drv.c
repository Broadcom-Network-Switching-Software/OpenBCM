...
bcmtm_drv_info_alloc(int unit, bool warm)
{
    ...
    if (!warm || (bcmissu_struct_info_get(unit,
        ...
        drv_info = (bcmtm_drv_info_t *)
                        ((uint8_t *)drv_info + offset);
    }
...
bcmtm_mc_dev_info_alloc(int unit, bool warm)
{
    ...
    if (!warm || (bcmissu_struct_info_get(unit,
        ...
        mc_dev_info = (bcmtm_mc_dev_info_t *)
                        ((uint8_t *)mc_dev_info + offset);
    }
...
bcmtm_thd_info_alloc(int unit, bool warm)
{
    ...
    if (!warm || (bcmissu_struct_info_get(unit,
        ...
        thd_info = (bcmtm_thd_info_t *)
                        ((uint8_t *)thd_info + offset);
    }
...
bcmtm_obm_usage_pbmp_info_alloc(int unit, bool warm)
{
    ...
    if (!warm || (bcmissu_struct_info_get(unit,
        ...
        obm_usage_info = (bcmtm_obm_usage_info_t *)
                        ((uint8_t *)obm_usage_info + offset);
    }
