...
/*!
 * Device specific function pointers for max usage mode set for obm logical tables.
 */
typedef int (*bcmtm_obm_pc_pm_max_usage_mode_set_f)(int unit,
                                                bcmltd_sid_t ltid,
                                                uint8_t pm_id,
                                                uint8_t mode);
...
typedef struct bcmtm_obm_drv_s {
    ...
    /*! OBM max usage mode set. */
    bcmtm_obm_pc_pm_max_usage_mode_set_f max_usage_mode_set;
} bcmtm_obm_drv_t;
