...
/*! TD4 Number of pipes per device. */
#define TD4_PIPES_PER_DEV            8
/*! TD4 Number of ITMs per device. */
#define TD4_ITMS_PER_DEV             2
/*! TD4 Number of phyical ports. */
#define TD4_NUM_PHYS_PORTS           267
/*! TD4 Maximum front panel ports per device. */
#define TD4_MAX_NUM_FP_PORTS         144

/*! TD4 Number of ports per port block. */
#define TD4_PORTS_PER_PBLK           8
/*! TD4 Number of port blocks per pipe. */
#define TD4_PBLKS_PER_PIPE           4

/*! TD4 Number of physical ports per pipe. */
#define TD4_PHYS_PORTS_PER_PIPE      32
/*! TD4 Number of logical ports per pipe. */
#define TD4_DEV_PORTS_PER_PIPE       20
/*! TD4 Number of MMU ports per pipe. */
#define TD4_MMU_PORTS_PER_PIPE       32
/*! TD4 Number of front panel ports per pipe. */
#define TD4_FP_PORTS_PER_PIPE        18


/*! TD4 Number of logical ports per device. */
#define TD4_DEV_PORTS_PER_DEV        (TD4_DEV_PORTS_PER_PIPE * TD4_PIPES_PER_DEV)
/*! TD4 Number of port blocks per device. */
#define TD4_PBLKS_PER_DEV            (TD4_PBLKS_PER_PIPE * TD4_PIPES_PER_DEV)
/*! TD4 Number of ports per pipe. */
#define TD4_PORTS_PER_PIPE           (TD4_PORTS_PER_PBLK * TD4_PBLKS_PER_PIPE)
/*! TD4 Number of ports per device. */
#define TD4_PORTS_PER_DEV            (TD4_PORTS_PER_PIPE * TD4_PIPES_PER_DEV)
/*! TD4 Number of physical ports per device. */
#define TD4_PHY_PORTS_PER_DEV        (TD4_PHY_PORTS_PER_PIPE * TD4_PIPES_PER_DEV)

/*! TD4 Number of CPU ports. */
#define TD4_NUM_CPU_PORTS            1
/*! TD4 Number of loopback ports. */
#define TD4_NUM_LB_PORTS             4
/*! TD4 Number of spare ports. */
#define TD4_NUM_SPARE_PORTS          7
/*! TD4 Number of management ports. */
#define TD4_NUM_MGMT_PORTS           4
/*! TD4 Local physical port number used for management ports. */
#define TD4_MGMT_LOCAL_PHYS_PORT     32
/*! TD4 Local physical port number used for loopback ports. */
#define TD4_LB_LOCAL_PHYS_PORT       33
/*! TD4 Number of lanes used by auxiliary port. */
#define TD4_NUM_LANES_AUX_PORT       1
/*! TD4 CPU, loopback port speed used for internal purposes. */
#define BCMTM_TD4_CPU_LB_PORT_SPEED 10000


/*! TD4 Number of queues per general purpose port. */
#define TD4_NUM_GP_QUEUES            12
/*! TD4 Number of queues per CPU port. */
#define TD4_NUM_CPU_QUEUES           48
/*! TD4 Number of queues in MMU all ports. */
#define TD4_TM_CHIP_QUEUES           1920

/*! TD4 Maximum number of service pools. */
 ...
 * \param [in] up port add/delete operation.
 *
 * \retval SHR_E_NONE success.
 * \retval SHR_E_PARAM invalid LT field values.
 * \retval SHR_E_NOT_FOUND lt not found.
 ...
 * @param [in] flag Flag indicating port add or delete sequence.
 *
 * \retval SHR_E_NONE No errors.
 */
extern int
