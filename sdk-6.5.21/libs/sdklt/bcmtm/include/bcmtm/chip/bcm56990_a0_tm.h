/*! \file bcm56990_a0_tm.h
 *
 * File containing chip related defines and internal functions for bcm56990_a0.
 */
/*
...
#ifndef BCM56990_A0_TM_H
#define BCM56990_A0_TM_H

#include <bcmpc/bcmpc_tm.h>
#include <bcmtm/bcmtm_drv.h>
#include <bcmtm/bcmtm_utils_internal.h>

/*! TH4 physical port number. */
#define TH4_NUM_PHYS_PORTS              272
/*! TH4 per PBLK port number. */
#define TH4_PORTS_PER_PBLK              4
/*! TH4 per pipe PBLK number. */
#define TH4_PBLKS_PER_PIPE              4
/*! TH4 per device port number. */
#define TH4_DEV_PORTS_PER_DEV           272
/*! TH4 per device pipe number. */
#define TH4_PIPES_PER_DEV               16
/*! TH4 per device itm number. */
#define TH4_ITMS_PER_DEV                2
/*! TH4 per device IDB number. */
#define TH4_IDBS_PER_DEV                TH4_PIPES_PER_DEV

/*! TH4 per device PBLK number. */
#define TH4_PBLKS_PER_DEV               (TH4_PBLKS_PER_PIPE * TH4_PIPES_PER_DEV)
/*! TH4 cpu port number. */
#define TH4_NUM_CPU_PORTS               1
/*! TH4 cpu port ID. */
#define TH4_CPU_LPORT                   0
/*! TH4 loopback port number. */
#define TH4_NUM_LB_PORTS                8
/*! TH4 management port number. */
#define TH4_NUM_MGMT_PORTS              2
/*! TH4 spare port number. */
#define TH4_NUM_SPARE_PORTS             5
/*! TH4 per pipe physical port number. */
#define TH4_PHYS_PORTS_PER_PIPE         16
/*! TH4 per pipe device port number. */
#define TH4_DEV_PORTS_PER_PIPE          17
/*! TH4 per pipe mmu port number. */
#define TH4_MMU_PORTS_PER_PIPE          32
/*! TH4 itm number. */
#define TH4_NUM_ITM                     2
/*! TH4 local management port physical port number. */
#define TH4_MGMT_LOCAL_PHYS_PORT        16
/*! TH4 per pipe front panel port number. */
#define TH4_FP_PORTS_PER_PIPE           16
/*! TH4 local loopback port physical port number. */
#define TH4_LB_LOCAL_PHYS_PORT          16
/*! TH4 cpu low priority rqe queue number. */
#define TH4_CPU_LO_RQE_Q_NUM            6
/*! TH4 cpu high priority rqe queue number. */
#define TH4_CPU_HI_RQE_Q_NUM            7
/*! TH4 mirror rqe queue number. */
#define TH4_MIRR_RQE_Q_NUM              8
/*! TH4 per port queue number. */
#define TH4_NUM_GP_QUEUES               12

/*! TH4 front panel port max port ID. */
#define TH4_MAX_NUM_FP_PORTS            256
/*! TH4 per pipe max front panel port number. */
#define TH4_MAX_NUM_FP_PORTS_PIPE       16
/*! TH4 10G management port lane number. */
#define TH4_NUM_LANES_10G_MGMT_PORT     1
/*! TH4 40G management port lane number. */
#define TH4_NUM_LANES_40G_MGMT_PORT     4
/*! TH4 auxiliary port lane number. */
#define TH4_NUM_LANES_AUX_PORT          1
/*! TH4 maximum number of service pools. */
#define TH4_MAX_SERVICE_POOLS           4
/*! TH4 MMU number of chip queues. */
#define TH4_TM_CHIP_QUEUES              3264
/*!
 ...
 */
extern void
bcm56990_a0_tm_pt_sid_rename(int unit,
                             bcmdrd_sid_t in_sid,
                             int in_inst,
 ...
 */
int
bcm56990_a0_tm_port_thd_configure (int unit, int lport);
...
/*!
 * \brief number of unicast queue for front panel port for bcm56990_a0.
 *
 * \param [in] unit unit number.
 *
 * \retval SHR_E_NONE success.
 ...
 * \brief number of multicast queue for front panel ports for bcm56990_a0.
 *
 * \param [in] unit unit number.
 *
 * \retval SHR_E_NONE success.
...
/*!
 * \brief IMM Initialization functions for bcm56990_a0.
 *
 * \param [in] unit unit number.
 *
 * \retval SHR_E_NONE success.
 ...
 */
extern int
bcm56990_a0_tm_imm_init(int unit);

/*!
 * \brief IMM pre-population functions for bcm56990_a0.
 *
 * \param [in] unit unit number.
 *
 * \retval SHR_E_NONE success.
 ...
 */
extern int
bcm56990_a0_tm_imm_populate(int unit);

/*!
 * \brief IMM update functions for bcm56990_a0.
 *
 * \param [in] unit unit number.
 ...
 */
extern int
bcm56990_a0_tm_imm_update(int unit, int pport, int up);
 ...
 */
extern int
bcm56990_a0_tm_num_mc_queues_per_port_get(int unit);
 ...
 */
extern int
bcm56990_a0_tm_num_uc_queues_per_port_get(int unit);
...
/*!
 * \brief Port-level IDB flexport port-down function for bcm56990_a0.
 *
 * \param [in] unit unit number.
...
/*!
 * \brief Port-level IDB flexport port-up function for bcm56990_a0.
 *
 * \param [in] unit unit number.
 * \param [in] pport physical port number.
 *
...
/*!
 * \brief Port-level MMU flexport port-down function for bcm56990_a0.
 *
 * \param [in] unit unit number.
 * \param [in] pport physical port number.
 *
 ...
 */
extern int
bcm56990_a0_tm_port_mmu_down(int unit, bcmtm_pport_t pport);

/*!
 * \brief Port-level EDB flexport port-down function for bcm56990_a0.
 *
 * \param [in] unit unit number.
 * \param [in] pport physical port number.
 *
...
/*!
 * \brief Port-level EDB flexport port-up function for bcm56990_a0.
 *
 * \param [in] unit unit number.
 * \param [in] pport physical port number.
 *
 ...
 */
extern int
bcm56990_a0_ip_port_forwarding_bitmap_enable(int unit, bcmtm_pport_t pport);
 ...
 */
extern int
bcm56990_a0_ip_port_forwarding_bitmap_disable(int unit, bcmtm_pport_t pport);
...
extern int
bcm56990_a0_tm_mmu_port_clear_edb_credit_counter(int unit,
                                                 bcmtm_pport_t pport);
/*!
