 ...
 * \param [out] num_mcq Number of multicast queues for logical port.
 *
...
/*!
 * \brief Verify logical port for fae port.
 *
 * \param [in] unit Unit number.
 * \param [in] lport Logical port number.
 *
 * \retval TRUE logical port is FAE port.
 * \retval FALSE logical port is not FAE port.
 */
extern int
...
/*!
 * \brief Get pm and subport from logical port.
 *
 * \param [in] unit unit number.
 * \param [in] lport Logical Port Number.
 * \param [in] pports_per_pipe Number of physical ports per pipe.
 * \param [in] pms_per_pipe Number of PMs(port blocks) per pipe.
 * \param [out] pm_num PM number corresponding to lport.
 * \param [out] subp subport corresponding to lport.
 *
 * \retval SHR_E_NONE success.
 */
extern int
