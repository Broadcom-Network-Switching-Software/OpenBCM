...
static const bcmlrd_map_entry_t bcm56780_a0_lrd_sec_decrypt_ipsec_sc_policyt_isec_sc_table_map_entry[] = {
    ...
    { /* 3 */
        ...
        .u = {
            .mapped = {
                .src = {
                    .field_id = SEC_DECRYPT_IPSEC_SC_POLICYt_L3_L4_HEADER_UPDATEf,
                    .field_idx = 0,
                    .minbit    = 0,
                    .maxbit    = 1,
                    .entry_idx = 0,
...
bcm56780_a0_lrd_bcmltx_sec_decrypt_ipsec_sc_policy_table_entry_limit_entry[] = {
    { /* 0 */
        ...
        .u = {
            /* handler: bcm56780_a0_lta_bcmltx_sec_decrypt_ipsec_sc_policy_sec_valid_table_entry_limit_handler */
            .handler_id = BCMLTD_TABLE_ENTRY_LIMIT_BCM56780_A0_LTA_BCMLTX_SEC_DECRYPT_IPSEC_SC_POLICY_SEC_VALID_TABLE_ENTRY_LIMIT_HANDLER_ID
        }
    },
};
static const bcmlrd_map_group_t bcm56780_a0_lrd_sec_decrypt_ipsec_sc_policy_map_group[] = {
    ...
    },
    {
        ...
        .entries = 1,
        .entry = bcm56780_a0_lrd_bcmltx_sec_decrypt_ipsec_sc_policy_table_entry_limit_entry
    },
};
