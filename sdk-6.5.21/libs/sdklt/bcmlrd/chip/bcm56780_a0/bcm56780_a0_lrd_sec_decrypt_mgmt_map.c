...
bcm56780_a0_lrd_bcmltx_sec_decrypt_mgmt_table_entry_limit_entry[] = {
    { /* 0 */
        ...
        .u = {
            /* handler: bcm56780_a0_lta_bcmltx_sec_decrypt_mgmt_sec_valid_table_entry_limit_handler */
            .handler_id = BCMLTD_TABLE_ENTRY_LIMIT_BCM56780_A0_LTA_BCMLTX_SEC_DECRYPT_MGMT_SEC_VALID_TABLE_ENTRY_LIMIT_HANDLER_ID
        }
    },
};
static const bcmlrd_map_group_t bcm56780_a0_lrd_sec_decrypt_mgmt_map_group[] = {
    ...
    },
    {
        ...
        .entries = 1,
        .entry = bcm56780_a0_lrd_bcmltx_sec_decrypt_mgmt_table_entry_limit_entry
    },
};
