 ...
 *    INTERNAL/fltg/xgs/tnl/bcm56990_b0/bcm56990_b0_TNL_L2_VXLAN_CONTROL.map.ltl for
 *      bcm56990_b0
 *
...
static const bcmlrd_field_data_t bcm56990_b0_lrd_tnl_l2_vxlan_control_map_field_data_mmd[] = {
    { /* 0 DECAP_DST_L4_PORT */
      .flags = 0,
    ...
    { /* 11 SRC_L4_PORT_SELECT */
      ...
      .depth = 0,
      .width = 2,
      .edata = BCM56990_B0_LRD_VXLAN_SRC_L4_PORT_SELECT_T_DATA,
    },
...
const bcmlrd_map_field_data_t bcm56990_b0_lrd_tnl_l2_vxlan_control_map_field_data = {
    .fields = 15,
    .field = bcm56990_b0_lrd_tnl_l2_vxlan_control_map_field_data_mmd
};

static const bcmlrd_map_table_attr_t bcm56990_b0_lrd_tnl_l2_vxlan_controlt_attr_entry[] = {
    { /* 0 */
...
static const bcmlrd_map_attr_t bcm56990_b0_lrd_tnl_l2_vxlan_controlt_attr_group = {
    .attributes = 1,
    .attr = bcm56990_b0_lrd_tnl_l2_vxlan_controlt_attr_entry,
};

static const bcmlrd_map_entry_t bcm56990_b0_lrd_tnl_l2_vxlan_controlt_cpu_control_m_map_entry[] = {
    { /* 0 */
...
static const bcmlrd_map_entry_t bcm56990_b0_lrd_tnl_l2_vxlan_controlt_egr_vxlan_control_map_entry[] = {
    { /* 0 */
        .entry_type = BCMLRD_MAP_ENTRY_MAPPED_VALUE,
        .desc = {
...
static const bcmlrd_map_entry_t bcm56990_b0_lrd_tnl_l2_vxlan_controlt_ing_l2_tunnel_parse_control_map_entry[] = {
    { /* 0 */
        .entry_type = BCMLRD_MAP_ENTRY_MAPPED_VALUE,
        .desc = {
...
static const bcmlrd_map_entry_t bcm56990_b0_lrd_tnl_l2_vxlan_controlt_vxlan_control_map_entry[] = {
    { /* 0 */
...
static const bcmlrd_map_entry_t bcm56990_b0_lrd_tnl_l2_vxlan_controlt_vxlan_default_network_svp_map_entry[] = {
    { /* 0 */
        .entry_type = BCMLRD_MAP_ENTRY_MAPPED_VALUE,
        .desc = {
            .field_id  = SVPf,
...
static const bcmlrd_map_group_t bcm56990_b0_lrd_tnl_l2_vxlan_control_map_group[] = {
    {
        .dest = {
        ...
        .entries = 2,
        .entry = bcm56990_b0_lrd_tnl_l2_vxlan_controlt_cpu_control_m_map_entry
    },
    {
        .dest = {
            .kind = BCMLRD_MAP_PHYSICAL,
        ...
        .entries = 4,
        .entry = bcm56990_b0_lrd_tnl_l2_vxlan_controlt_egr_vxlan_control_map_entry
    },
    {
        .dest = {
            .kind = BCMLRD_MAP_PHYSICAL,
        ...
        .entries = 4,
        .entry = bcm56990_b0_lrd_tnl_l2_vxlan_controlt_ing_l2_tunnel_parse_control_map_entry
    },
    {
        .dest = {
            .kind = BCMLRD_MAP_PHYSICAL,
        ...
        .entries = 5,
        .entry = bcm56990_b0_lrd_tnl_l2_vxlan_controlt_vxlan_control_map_entry
    },
    {
        .dest = {
            .kind = BCMLRD_MAP_PHYSICAL,
        ...
        .entries = 1,
        .entry = bcm56990_b0_lrd_tnl_l2_vxlan_controlt_vxlan_default_network_svp_map_entry
    },
};
const bcmlrd_map_t bcm56990_b0_lrd_tnl_l2_vxlan_control_map = {
    .src_id = TNL_L2_VXLAN_CONTROLt,
    .field_data = &bcm56990_b0_lrd_tnl_l2_vxlan_control_map_field_data,
    .groups = 5,
    .group  = bcm56990_b0_lrd_tnl_l2_vxlan_control_map_group,
    .table_attr = &bcm56990_b0_lrd_tnl_l2_vxlan_controlt_attr_group,
