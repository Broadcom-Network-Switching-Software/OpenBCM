 ...
 *    INTERNAL/fltg/xgs/fp/bcm56990_b0/bcm56990_b0_FP_ING_PRESEL_TEMPLATE_PARTITION_INFO.map.ltl for
 *      bcm56990_b0
 *
...
static const bcmlrd_field_data_t bcm56990_b0_lrd_fp_ing_presel_template_partition_info_map_field_data_mmd[] = {
...
const bcmlrd_map_field_data_t bcm56990_b0_lrd_fp_ing_presel_template_partition_info_map_field_data = {
    .fields = 128,
    .field = bcm56990_b0_lrd_fp_ing_presel_template_partition_info_map_field_data_mmd
};

static const bcmlrd_map_table_attr_t bcm56990_b0_lrd_fp_ing_presel_template_partition_infot_attr_entry[] = {
    { /* 0 */
...
static const bcmlrd_map_attr_t bcm56990_b0_lrd_fp_ing_presel_template_partition_infot_attr_group = {
    .attributes = 2,
    .attr = bcm56990_b0_lrd_fp_ing_presel_template_partition_infot_attr_entry,
};

static const bcmlrd_map_entry_t bcm56990_b0_lrd_bcmfp_fp_ing_presel_template_partition_info_entry[] = {
    { /* 0 */
        ...
        .u = {
            /* handler: bcm56990_b0_lta_bcmfp_fp_ing_presel_template_partition_info_cth_handler */
            .handler_id = BCMLTD_TABLE_BCM56990_B0_LTA_BCMFP_FP_ING_PRESEL_TEMPLATE_PARTITION_INFO_CTH_HANDLER_ID
        }
    },
};
static const bcmlrd_map_group_t bcm56990_b0_lrd_fp_ing_presel_template_partition_info_map_group[] = {
    {
        .dest = {
        ...
        .entries = 1,
        .entry = bcm56990_b0_lrd_bcmfp_fp_ing_presel_template_partition_info_entry
    },
};
const bcmlrd_map_t bcm56990_b0_lrd_fp_ing_presel_template_partition_info_map = {
    .src_id = FP_ING_PRESEL_TEMPLATE_PARTITION_INFOt,
    .field_data = &bcm56990_b0_lrd_fp_ing_presel_template_partition_info_map_field_data,
    .groups = 1,
    .group  = bcm56990_b0_lrd_fp_ing_presel_template_partition_info_map_group,
    .table_attr = &bcm56990_b0_lrd_fp_ing_presel_template_partition_infot_attr_group,
