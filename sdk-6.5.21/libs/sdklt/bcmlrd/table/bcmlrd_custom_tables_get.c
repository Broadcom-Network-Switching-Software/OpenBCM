/*! \file bcmlrd_custom_tables_get.c
 *
 * Get the list of logical tables for the given combination of
                         ...
                         size_t *actual)
{
    ...
    if ((tables == NULL) || (actual == NULL) ||
        (component_name == NULL) || (handler_name == NULL)) {
        LOG_ERROR(BSL_LOG_MODULE,
