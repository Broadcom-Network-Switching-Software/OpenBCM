...
/*!
 * \brief HMF tile mode map specification.
 *
 * Tile mode specification.
 */

typedef struct bcmlrd_hmf_tile_mode_map_s {
    /*! Tile mapped to SP PT. */
    uint32_t tile;
...
typedef struct bcmlrd_hmf_memory_s {
    ...
    /*! Number of tile mode mappings. */
    uint32_t tile_mode_map_count;

    /*! List of tile mode mappings. */
    const bcmlrd_hmf_tile_mode_map_t *tile_mode_map;
