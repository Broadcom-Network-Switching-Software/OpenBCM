...
/*! enum type for DEVICE_TS_BROADSYNC_INTERFACE_MODE_T
 * Enum defines the Broadsync mode.
 */
typedef enum bcmltd_common_device_ts_broadsync_interface_mode_t_e {
    /*! Input mode.  */
    BCMLTD_COMMON_DEVICE_TS_BROADSYNC_INTERFACE_MODE_T_T_INPUT_MODE = 0,
    /*! Output mode.  */
    BCMLTD_COMMON_DEVICE_TS_BROADSYNC_INTERFACE_MODE_T_T_OUTPUT_MODE = 1,
} bcmltd_common_device_ts_broadsync_interface_mode_t_t;

/*! enum type for DEVICE_TS_BROADSYNC_OPERATIONAL_STATE_T
 * Enum defines the operational state of the
 *  BroadSync table entry.
 */
typedef enum bcmltd_common_device_ts_broadsync_operational_state_t_e {
    /*! Success.  */
    BCMLTD_COMMON_DEVICE_TS_BROADSYNC_OPERATIONAL_STATE_T_T_SUCCESS = 0,
    /*! BroadSync embedded application is not initialized.  */
    BCMLTD_COMMON_DEVICE_TS_BROADSYNC_OPERATIONAL_STATE_T_T_APP_NOT_INITIALIZED = 1,
} bcmltd_common_device_ts_broadsync_operational_state_t_t;

/*! enum type for DEVICE_TS_BROADSYNC_STATE_T
 * Enum defines the state of the BroadSync interface.
 */
typedef enum bcmltd_common_device_ts_broadsync_state_t_e {
    /*! No time-code received, holdover mode or not locked.  */
    BCMLTD_COMMON_DEVICE_TS_BROADSYNC_STATE_T_T_NOT_LOCKED = 0,
    /*! Acquiring state.  */
    BCMLTD_COMMON_DEVICE_TS_BROADSYNC_STATE_T_T_ACQUIRING = 1,
    /*! Acquiring state but locked with excessive jitter.  */
    BCMLTD_COMMON_DEVICE_TS_BROADSYNC_STATE_T_T_EXCESSIVE_JITTER = 2,
    /*! Locked state.  */
    BCMLTD_COMMON_DEVICE_TS_BROADSYNC_STATE_T_T_LOCKED = 3,
} bcmltd_common_device_ts_broadsync_state_t_t;
...
/*! enum type for L3_L4_HEADER_UPDATE_T
 * Enums defining the various secured L3 L4
 *  packet update operations.
 */
typedef enum bcmltd_common_l3_l4_header_update_t_e {
    /*! No L3 or L4 updates for secured packets.  */
    BCMLTD_COMMON_L3_L4_HEADER_UPDATE_T_T_UPDATE_NONE = 0,
    /*!
     ...
     */
    BCMLTD_COMMON_L3_L4_HEADER_UPDATE_T_T_UPDATE_LENGTH = 1,
    /*!
     ...
     */
    BCMLTD_COMMON_L3_L4_HEADER_UPDATE_T_T_UPDATE_DEST_PORT = 2,
    /*!
     ...
     */
    BCMLTD_COMMON_L3_L4_HEADER_UPDATE_T_T_UPDATE_L3_L4 = 3,
} bcmltd_common_l3_l4_header_update_t_t;

/*! enum type for L3_L4_PKT_TYPE_T
 * Enums defining the various L3 or L4 secured
 *  packet types.
 */
typedef enum bcmltd_common_l3_l4_pkt_type_t_e {
    /*! An IPv4 packet with untagged VLAN.  */
    BCMLTD_COMMON_L3_L4_PKT_TYPE_T_T_IPV4_UNTAG = 0,
    /*! An IPv4 packet with single VLAN tag.  */
    BCMLTD_COMMON_L3_L4_PKT_TYPE_T_T_IPV4_SINGLE_TAG = 1,
    /*! An IPv4 packet with 2 VLAN tags.  */
    BCMLTD_COMMON_L3_L4_PKT_TYPE_T_T_IPV4_DOUBLE_TAG = 2,
    /*! An IPv6 packet with 0 VLAN tags.  */
    BCMLTD_COMMON_L3_L4_PKT_TYPE_T_T_IPV6_UNTAG = 3,
    /*! An IPv6 packet with 1 VLAN tag.  */
    BCMLTD_COMMON_L3_L4_PKT_TYPE_T_T_IPV6_SINGLE_TAG = 4,
    /*! An IPv6 packet with 2 VLAN tags.  */
    BCMLTD_COMMON_L3_L4_PKT_TYPE_T_T_IPV6_DOUBLE_TAG = 5,
    /*! A TCP over IPv4 packet with 0 VLAN tags.  */
    BCMLTD_COMMON_L3_L4_PKT_TYPE_T_T_TCP_IPV4_UNTAG = 6,
    /*! A TCP over IPv4 packet with 1 VLAN tag.  */
    BCMLTD_COMMON_L3_L4_PKT_TYPE_T_T_TCP_IPV4_SINGLE_TAG = 7,
    /*! A TCP over IPv4 packet with 2 VLAN tags.  */
    BCMLTD_COMMON_L3_L4_PKT_TYPE_T_T_TCP_IPV4_DOUBLE_TAG = 8,
    /*! A TCP over IPv6 packet with 0 VLAN tags.  */
    BCMLTD_COMMON_L3_L4_PKT_TYPE_T_T_TCP_IPV6_UNTAG = 9,
    /*! A TCP over IPv6 packet with 1 VLAN tags.  */
    BCMLTD_COMMON_L3_L4_PKT_TYPE_T_T_TCP_IPV6_SINGLE_TAG = 10,
    /*! A TCP over IPv6 packet with 2 VLAN tags.  */
    BCMLTD_COMMON_L3_L4_PKT_TYPE_T_T_TCP_IPV6_DOUBLE_TAG = 11,
    /*! A UDP over IPv4 packet with 0 VLAN tags.  */
    BCMLTD_COMMON_L3_L4_PKT_TYPE_T_T_UDP_IPV4_UNTAG = 12,
    /*! A UDP over IPv4 packet with 1 VLAN tags.  */
    BCMLTD_COMMON_L3_L4_PKT_TYPE_T_T_UDP_IPV4_SINGLE_TAG = 13,
    /*! A UDP over IPv4 packet with 2 VLAN tags.  */
    BCMLTD_COMMON_L3_L4_PKT_TYPE_T_T_UDP_IPV4_DOUBLE_TAG = 14,
    /*! A UDP over IPv6 packet with 0 VLAN tags.  */
    BCMLTD_COMMON_L3_L4_PKT_TYPE_T_T_UDP_IPV6_UNTAG = 15,
    /*! A UDP over IPv6 packet with 1 VLAN tags.  */
    BCMLTD_COMMON_L3_L4_PKT_TYPE_T_T_UDP_IPV6_SINGLE_TAG = 16,
    /*! A UDP over IPv6 packet with 2 VLAN tags.  */
    BCMLTD_COMMON_L3_L4_PKT_TYPE_T_T_UDP_IPV6_DOUBLE_TAG = 17,
    /*! Not an L3 or L4 secured packet.  */
    BCMLTD_COMMON_L3_L4_PKT_TYPE_T_T_NOT_L3_L4_PKT = 18,
} bcmltd_common_l3_l4_pkt_type_t_t;
...
/*! enum type for MON_FLOWTRACKER_LEARN_FAIL_EVENT_CONTROL_STATE_T
 * Enum defines various states of a flowtracker learn fail event
 *  notification controls.
 */
typedef enum bcmltd_common_mon_flowtracker_learn_fail_event_control_state_t_e {
    BCMLTD_COMMON_MON_FLOWTRACKER_LEARN_FAIL_EVENT_CONTROL_STATE_T_T_OFF = 0,
    BCMLTD_COMMON_MON_FLOWTRACKER_LEARN_FAIL_EVENT_CONTROL_STATE_T_T_ARMED = 1,
} bcmltd_common_mon_flowtracker_learn_fail_event_control_state_t_t;

/*! enum type for MON_FLOWTRACKER_LEARN_FAIL_EVENT_STATE_T
 * Enum defines various states of a flowtracker learn fail event
 *  notification.
 */
typedef enum bcmltd_common_mon_flowtracker_learn_fail_event_state_t_e {
    BCMLTD_COMMON_MON_FLOWTRACKER_LEARN_FAIL_EVENT_STATE_T_T_OFF = 0,
    BCMLTD_COMMON_MON_FLOWTRACKER_LEARN_FAIL_EVENT_STATE_T_T_ARMED = 1,
    BCMLTD_COMMON_MON_FLOWTRACKER_LEARN_FAIL_EVENT_STATE_T_T_TRIGGERED = 2,
} bcmltd_common_mon_flowtracker_learn_fail_event_state_t_t;
...
typedef enum bcmltd_common_oam_bfd_endpoint_type_t_e {
    ...
    /*! BFD over VxLAN endpoint.  */
    BCMLTD_COMMON_OAM_BFD_ENDPOINT_TYPE_T_T_TNL_L2_VXLAN = 5,
...
/*! enum type for OAM_BFD_TNL_L2_VXLAN_ENDPOINT_IP_ENCAP_TYPE_T
 * Enum defines the IP encapsulation types used by BFD over VxLAN
 *  endpoints.
 */
typedef enum bcmltd_common_oam_bfd_tnl_l2_vxlan_endpoint_ip_encap_type_t_e {
    /*! OUTER IPv4, INNER IPv4.  */
    BCMLTD_COMMON_OAM_BFD_TNL_L2_VXLAN_ENDPOINT_IP_ENCAP_TYPE_T_T_UNDERLAY_IPV4_OVERLAY_IPV4 = 0,
    /*! OUTER IPv6, INNER IPv4.  */
    BCMLTD_COMMON_OAM_BFD_TNL_L2_VXLAN_ENDPOINT_IP_ENCAP_TYPE_T_T_UNDERLAY_IPV6_OVERLAY_IPV4 = 1,
    /*! OUTER IPv4, INNER IPv6.  */
    BCMLTD_COMMON_OAM_BFD_TNL_L2_VXLAN_ENDPOINT_IP_ENCAP_TYPE_T_T_UNDERLAY_IPV4_OVERLAY_IPV6 = 2,
    /*! OUTER IPv6, INNER IPv6.  */
    BCMLTD_COMMON_OAM_BFD_TNL_L2_VXLAN_ENDPOINT_IP_ENCAP_TYPE_T_T_UNDERLAY_IPV6_OVERLAY_IPV6 = 3,
} bcmltd_common_oam_bfd_tnl_l2_vxlan_endpoint_ip_encap_type_t_t;
...
typedef enum bcmltd_common_pc_encap_t_e {
    ...
    BCMLTD_COMMON_PC_ENCAP_T_T_PC_ENCAP_IEEE_REDUCED_IPG = 3,
...
/*! enum type for PC_PRBS_POLY_T
 * Pseudo Random Binary Sequence (PRBS) polynomial types.
 */
typedef enum bcmltd_common_pc_prbs_poly_t_e {
    /*! PRBS7 = X^7 + X^6 + 1.  */
    BCMLTD_COMMON_PC_PRBS_POLY_T_T_PC_PRBS_POLY_7 = 0,
    /*! PRBS9 = X^9 + X^5 + 1.  */
    BCMLTD_COMMON_PC_PRBS_POLY_T_T_PC_PRBS_POLY_9 = 1,
    /*! PRBS10 = X^10 + X^7 + 1.  */
    BCMLTD_COMMON_PC_PRBS_POLY_T_T_PC_PRBS_POLY_10 = 2,
    /*! PRBS11 = X^11 + X^9 + 1.  */
    BCMLTD_COMMON_PC_PRBS_POLY_T_T_PC_PRBS_POLY_11 = 3,
    /*! PRBS13 = X^13 + X^12 + X^2 + 1.  */
    BCMLTD_COMMON_PC_PRBS_POLY_T_T_PC_PRBS_POLY_13 = 4,
    /*! PRBS15 = X^15 + X^14 + 1.  */
    BCMLTD_COMMON_PC_PRBS_POLY_T_T_PC_PRBS_POLY_15 = 5,
    /*! PRBS20 = X^20 + X^3 + 1.  */
    BCMLTD_COMMON_PC_PRBS_POLY_T_T_PC_PRBS_POLY_20 = 6,
    /*! PRBS23 = X^23 + X^18 + 1.  */
    BCMLTD_COMMON_PC_PRBS_POLY_T_T_PC_PRBS_POLY_23 = 7,
    /*! PRBS31 = X^31 + X^28 + 1.  */
    BCMLTD_COMMON_PC_PRBS_POLY_T_T_PC_PRBS_POLY_31 = 8,
    /*! PRBS49 = X^49 + X^40 + 1.  */
    BCMLTD_COMMON_PC_PRBS_POLY_T_T_PC_PRBS_POLY_49 = 9,
    /*! PRBS58 = X^58 + X^31 + 1.  */
    BCMLTD_COMMON_PC_PRBS_POLY_T_T_PC_PRBS_POLY_58 = 10,
} bcmltd_common_pc_prbs_poly_t_t;
...
typedef enum bcmltd_common_pc_serdes_fw_load_method_t_e {
    ...
    BCMLTD_COMMON_PC_SERDES_FW_LOAD_METHOD_T_T_PC_SERDES_FW_BCAST_DMA_LOAD = 2,
    /*! PM firmware with PRAM infterface via UCMEM SBUS download. PM by PM  */
    BCMLTD_COMMON_PC_SERDES_FW_LOAD_METHOD_T_T_PC_SERDES_FW_PRAM_NON_BCAST_LOAD = 3,
    /*! PM firmware download with PRAM interface and UCMEM SBUS Broadcast.  */
    BCMLTD_COMMON_PC_SERDES_FW_LOAD_METHOD_T_T_PC_SERDES_FW_PRAM_BCAST_LOAD = 4,
...
/*! enum type for TM_PFC_DEADLOCK_RECOVERY_MANUAL_STATE_CONTROL_STATE_T
 * Manual deadlock recovery state controls.
 */
typedef enum bcmltd_common_tm_pfc_deadlock_recovery_manual_state_control_state_t_e {
    /*! Terminate ongoing deadlock recovery.  */
    BCMLTD_COMMON_TM_PFC_DEADLOCK_RECOVERY_MANUAL_STATE_CONTROL_STATE_T_T_IDLE = 0,
    /*! Start the deadlock recovery.  */
    BCMLTD_COMMON_TM_PFC_DEADLOCK_RECOVERY_MANUAL_STATE_CONTROL_STATE_T_T_RECOVERY = 1,
} bcmltd_common_tm_pfc_deadlock_recovery_manual_state_control_state_t_t;

/*! enum type for TM_PFC_DEADLOCK_RECOVERY_MANUAL_STATE_STATE_T
 * Manual deadlock recovery states.
 */
typedef enum bcmltd_common_tm_pfc_deadlock_recovery_manual_state_state_t_e {
    /*! Normal state.  */
    BCMLTD_COMMON_TM_PFC_DEADLOCK_RECOVERY_MANUAL_STATE_STATE_T_T_IDLE = 0,
    /*! Recovery state.  */
    BCMLTD_COMMON_TM_PFC_DEADLOCK_RECOVERY_MANUAL_STATE_STATE_T_T_RECOVERY = 1,
    /*! Deadlock state.  */
    BCMLTD_COMMON_TM_PFC_DEADLOCK_RECOVERY_MANUAL_STATE_STATE_T_T_DEADLOCK = 2,
} bcmltd_common_tm_pfc_deadlock_recovery_manual_state_state_t_t;

/*! enum type for TM_PFC_DEADLOCK_RECOVERY_MODE_T
 * Enum definition for the supported deadlock recovery mode
 *  specified by TM_PFC_DEADLOCK_RECOVERY.RECOVERY_MODE.
 */
typedef enum bcmltd_common_tm_pfc_deadlock_recovery_mode_t_e {
    /*! Recovery based on configured recovery time out.  */
    BCMLTD_COMMON_TM_PFC_DEADLOCK_RECOVERY_MODE_T_T_TIMER_MODE = 0,
    /*! Recovery based on examining the PFC state.  */
    BCMLTD_COMMON_TM_PFC_DEADLOCK_RECOVERY_MODE_T_T_PFC_STATE_MODE = 1,
} bcmltd_common_tm_pfc_deadlock_recovery_mode_t_t;

/*! enum type for TM_PFC_DEADLOCK_RECOVERY_STATE_CONTROL_STATE_T
 * Deadlock recovery state controls.
 */
typedef enum bcmltd_common_tm_pfc_deadlock_recovery_state_control_state_t_e {
    /*! Terminate ongoing deadlock recovery.  */
    BCMLTD_COMMON_TM_PFC_DEADLOCK_RECOVERY_STATE_CONTROL_STATE_T_T_IDLE = 0,
} bcmltd_common_tm_pfc_deadlock_recovery_state_control_state_t_t;

/*! enum type for TM_PFC_DEADLOCK_RECOVERY_STATE_STATE_T
 * Deadlock recovery states.
 */
typedef enum bcmltd_common_tm_pfc_deadlock_recovery_state_state_t_e {
    /*! Normal state.  */
    BCMLTD_COMMON_TM_PFC_DEADLOCK_RECOVERY_STATE_STATE_T_T_IDLE = 0,
    /*! Recovery state.  */
    BCMLTD_COMMON_TM_PFC_DEADLOCK_RECOVERY_STATE_STATE_T_T_RECOVERY = 1,
} bcmltd_common_tm_pfc_deadlock_recovery_state_state_t_t;
