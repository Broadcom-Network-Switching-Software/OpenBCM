...
{
    if (BKT_MGMT(u, m) && BKT_MGMT_EXEC(u, m, bucket_defrag)) {
        return BKT_MGMT_EXEC(u, m, bucket_defrag)(u, m, db);
    }
    return SHR_E_UNAVAIL;
}
...
{
    if (BKT_MGMT(u, m) && BKT_MGMT_EXEC(u, m, buckets_sanity)) {
        BKT_MGMT_EXEC(u, m, buckets_sanity)(u, m, db, ln);
    }
