...
#define BCMPTM_ALLOW_SERC_AFTER_WRITE_OP FALSE
                     ...
                     uint32_t *rsp_flags)
{
    ...
    SHR_IF_ERR_EXIT(sid == INVALIDm? SHR_E_PARAM : SHR_E_NONE);
     ...
     */
    if (bcmptm_scor_req_pending(unit) && BCMPTM_ALLOW_SERC_AFTER_WRITE_OP) {
