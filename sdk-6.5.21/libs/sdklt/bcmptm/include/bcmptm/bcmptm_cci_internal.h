...
/*!
 * \brief Update direct access attribute in counter information.
 *
 * \param [in] unit Logical device id.
 * \param [OUT] ctr_info Counter information.
 *
 * \retval.
 */
extern void
...
/*!
 * \brief Get CTR_ING_PFC counter field value.
 *
 * \param [in] unit Logical device id.
 * \param [in] ctr_info Counter information.
 * \param [in] sid Symbol ID.
 * \param [in] sw_ctr Cache counter.
 * \param [OUT] counter buffer.
 * \param [in] size_ctr, size of counter buffer.
 *
 * \retval SHR_E_NONE No errors.
