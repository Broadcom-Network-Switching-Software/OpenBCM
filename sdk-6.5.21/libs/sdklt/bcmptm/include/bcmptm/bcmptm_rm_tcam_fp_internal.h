 ...
 * \param [out] phy_slice_id Slice number.
...
/*
 * \brief Check if enough resources are available for requested
 *  resources.
 *
 * \param [in] unit BCM device unit number
 * \param [in] iomd Input and Output metadata
 ...
 */
extern int
bcmptm_rm_tcam_fp_req_resources_scope(int unit,
                                bcmptm_rm_tcam_entry_iomd_t *iomd);
/*
