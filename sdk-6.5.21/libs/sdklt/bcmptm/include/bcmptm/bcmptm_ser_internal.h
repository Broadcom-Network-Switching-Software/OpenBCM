...
/*!\brief Handler to map SID reported by H/W to SID used to correct SER error for ALPM. */
...
/*!\brief Handler to map SID reported by H/W to SID used to correct SER error for TCAM. */
typedef int (*bcmptm_ser_tcam_cb_info_get_f)(int unit, bcmdrd_sid_t hw_sid,
                                             bcmbd_pt_dyn_info_t hw_dyn_info,
                                             bcmdrd_sid_t *out_sid,
                                             bcmbd_pt_dyn_info_t *out_dyn_info,
                                             int *out_count);
...
/*!
 * \brief RM-TCAM can register callback routine into SER logic. Then
 * SER logic calls the routine to get right SER correction data of TCAM PTs.
 *
 * SER can't call APIs defined in RM-TCAM directly.
 *
 * \param [in] unit Unit number
 * \param [in] tcam_info_get registered callback routine.
 *
 * \retval NONE
 */
extern void
 ...
 * \param [in] flags   BCMPTM_SCOR_REQ_FLAGS_DONT_USE_CACHE.
 *
