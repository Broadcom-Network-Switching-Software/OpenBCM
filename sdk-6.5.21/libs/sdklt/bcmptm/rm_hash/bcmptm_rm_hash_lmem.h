...
/*!
 * \brief Allocate memory for rm_hash_ltpr_info_t structure.
 *
 * \retval SHR_E_NONE No errors.
 * \retval !SHR_E_NONE Failure.
 */
extern rm_hash_ltpr_info_t *bcmptm_rm_hash_ltpr_info_alloc(void);

/*!
 * \brief Free memory for rm_hash_ltpr_info_t structure.
 *
 * \param [in] ltpr_info Pointer to rm_hash_ltpr_info_t structure.
 */
extern void
