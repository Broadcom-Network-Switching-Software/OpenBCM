...
int
bcmptm_rm_hash_entry_narrow_mode_get(int unit,
                                     bcmptm_rm_hash_entry_narrow_format_t format,
                                     rm_hash_entry_narrow_mode_t *e_nm)
{
    SHR_FUNC_ENTER(unit);

    switch (format) {
    case BCMPTM_RM_HASH_NARROW_FORMAT_NONE:
        *e_nm = BCMPTM_RM_HASH_ENTRY_NARROW_MODE_NONE;
        break;
    case BCMPTM_RM_HASH_NARROW_FORMAT_HALF:
        *e_nm = BCMPTM_RM_HASH_ENTRY_NARROW_MODE_HALF;
        break;
    case BCMPTM_RM_HASH_NARROW_FORMAT_THIRD:
