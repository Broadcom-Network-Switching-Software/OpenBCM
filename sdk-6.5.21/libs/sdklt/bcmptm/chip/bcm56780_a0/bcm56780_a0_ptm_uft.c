 ...
 */
static int
bcm56780_a0_uft_regs_init(int unit,
                          uft_dev_info_t *dev,
 ...
 */
static int
bcm56780_a0_uft_device_info_init(int unit,
 ...
 */
static int
bcm56780_a0_uft_device_deinit(int unit)
{
...
static int
bcm56780_a0_uft_tbl_em_ctrl_validate(int unit,
...
static int
bcm56780_a0_uft_dev_em_grp_validate(int unit,
...
static int
bcm56780_a0_uft_dev_em_grp_set(int unit,
                               uft_dev_em_grp_t *grp,
                               uft_dev_info_t *dev,
                               uft_regs_info_t *regs)
{
    ...
    bool b2_assigned = FALSE, b3_assigned = FALSE;
    bool b2_alpm = FALSE, b3_alpm = FALSE;
    uint32_t value_0 = 0, value_1 = 0;
    int cnt = 0;
    ...
    /* Fetch tile mode to get default lane0/lane1 */
    tile_mode = var->em_group[grp->grp_id]->tile_mode;
    if (tile_mode > var->tile_mode_cnt) {
        SHR_ERR_EXIT(SHR_E_PARAM);
    }

    /* Default lane0/lane1 for the mode */
    value_0 = var->tile_mode[tile_mode]->hash_lane0_bitmap;
    value_1 = var->tile_mode[tile_mode]->hash_lane1_bitmap;

    /* Check if bank is associated to ALPM */
    SHR_IF_ERR_VERBOSE_EXIT
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (uft_bank_assigned_get(unit, dev, b0_id + 2,
                               &b2_assigned, NULL, &b2_alpm));
    SHR_IF_ERR_VERBOSE_EXIT
        (uft_bank_assigned_get(unit, dev, b0_id + 3,
                               &b3_assigned, NULL, &b3_alpm));
    /*
     * For 56780, UFT E-Tile is can do two lookups per packet.
     * if 1 lookup + ALPM (upper bank - B1 & B3) : LANE0=b0101 & LANE1=b0000
     * if 1 lookup + ALPM (lower bank - B0 & B2) : LANE0=b1010 & LANE1=b0000
     * if 2 lookup + No ALPM                     : LANE0=b0011 & LANE1=b1100
     * if 1 lookup + No ALPM                     : LANE0=b1111 & LANE1=b0000
     * if All ALPM                               : LANE0=b0000 & LANE1=b0000
     */

     /* Remove ALPM banks for the hash lane0/lane1 */
    if (b0_alpm == TRUE) {
        value_0 &= 0xE; /* b1110 */
        value_1 &= 0xE;
    }
...
static int
bcm56780_a0_uft_dev_em_bank_validate(int unit, uft_dev_em_bank_t *bank)
{
...
static int
bcm56780_a0_uft_dev_em_bank_set(int unit,
...
static int
bcm56780_a0_uft_dev_em_tile_set(int unit,
...
bcm56780_a0_uft_driver_register(int unit, uft_driver_t *drv)
{
    ...
    if (drv) {
        drv->regs_init            = bcm56780_a0_uft_regs_init;
        drv->device_info_init     = bcm56780_a0_uft_device_info_init;
        drv->device_deinit        = bcm56780_a0_uft_device_deinit;
        drv->tbl_em_ctrl_validate = bcm56780_a0_uft_tbl_em_ctrl_validate;
        drv->dev_em_grp_validate  = bcm56780_a0_uft_dev_em_grp_validate;
        drv->dev_em_grp_set       = bcm56780_a0_uft_dev_em_grp_set;
        drv->dev_em_bank_validate = bcm56780_a0_uft_dev_em_bank_validate;
        drv->dev_em_bank_set      = bcm56780_a0_uft_dev_em_bank_set;
        drv->dev_em_tile_set      = bcm56780_a0_uft_dev_em_tile_set;
    } else {
