...
bcm56780_a0_rm_tcam_sid_info_get(int unit,
                                 ...
                                 bool multi_aggr_no_data_sid,
                                 bool multi_mem_aggr_sid)
{
    SHR_FUNC_ENTER(unit);
    ...
    if (multi_mem_aggr_sid == TRUE) {
        switch (bank_sid) {
        case MEMDB_TCAM_IFTA80_MEM0_0m:
        case MEMDB_TCAM_IFTA80_MEM0_1m:
            bank_sids[0] = MEMDB_TCAM_IFTA80_MEM0_0m;
            bank_sids[1] = MEMDB_TCAM_IFTA80_MEM0_1m;
            tcam_sid[0] = MEMDB_TCAM_IFTA80_MEM0_0_MEM0_1m;
            break;
        case MEMDB_TCAM_IFTA80_MEM1_0m:
        case MEMDB_TCAM_IFTA80_MEM1_1m:
            bank_sids[0] = MEMDB_TCAM_IFTA80_MEM1_0m;
            bank_sids[1] = MEMDB_TCAM_IFTA80_MEM1_1m;
            tcam_sid[0] = MEMDB_TCAM_IFTA80_MEM1_0_MEM1_1m;
            break;
        case MEMDB_TCAM_IFTA80_MEM2_0m:
        case MEMDB_TCAM_IFTA80_MEM2_1m:
            bank_sids[0] = MEMDB_TCAM_IFTA80_MEM2_0m;
            bank_sids[1] = MEMDB_TCAM_IFTA80_MEM2_1m;
            tcam_sid[0] = MEMDB_TCAM_IFTA80_MEM2_0_MEM2_1m;
            break;
        case MEMDB_TCAM_IFTA80_MEM3_0m:
        case MEMDB_TCAM_IFTA80_MEM3_1m:
            bank_sids[0] = MEMDB_TCAM_IFTA80_MEM3_0m;
            bank_sids[1] = MEMDB_TCAM_IFTA80_MEM3_1m;
            tcam_sid[0] = MEMDB_TCAM_IFTA80_MEM3_0_MEM3_1m;
            break;
        case MEMDB_TCAM_IFTA80_MEM4_0m:
        case MEMDB_TCAM_IFTA80_MEM4_1m:
            bank_sids[0] = MEMDB_TCAM_IFTA80_MEM4_0m;
            bank_sids[1] = MEMDB_TCAM_IFTA80_MEM4_1m;
            tcam_sid[0] = MEMDB_TCAM_IFTA80_MEM4_0_MEM4_1m;
            break;
        case MEMDB_TCAM_IFTA80_MEM5_0m:
        case MEMDB_TCAM_IFTA80_MEM5_1m:
            bank_sids[0] = MEMDB_TCAM_IFTA80_MEM5_0m;
            bank_sids[1] = MEMDB_TCAM_IFTA80_MEM5_1m;
            tcam_sid[0] = MEMDB_TCAM_IFTA80_MEM5_0_MEM5_1m;
            break;
        case MEMDB_TCAM_IFTA80_MEM6_0m:
        case MEMDB_TCAM_IFTA80_MEM6_1m:
            bank_sids[0] = MEMDB_TCAM_IFTA80_MEM6_0m;
            bank_sids[1] = MEMDB_TCAM_IFTA80_MEM6_1m;
            tcam_sid[0] = MEMDB_TCAM_IFTA80_MEM6_0_MEM6_1m;
            break;
        case MEMDB_TCAM_IFTA80_MEM7_0m:
        case MEMDB_TCAM_IFTA80_MEM7_1m:
            bank_sids[0] = MEMDB_TCAM_IFTA80_MEM7_0m;
            bank_sids[1] = MEMDB_TCAM_IFTA80_MEM7_1m;
            tcam_sid[0] = MEMDB_TCAM_IFTA80_MEM7_0_MEM7_1m;
            break;
        default:
            SHR_ERR_EXIT(SHR_E_PARAM);
        }
        ...
        switch (bank_sid) {
        case MEMDB_TCAM_IFTA80_MEM0_0m:
            if (multi_aggr_no_data_sid == TRUE) {
                                 ...
                                 bool multi_mem_aggr_sid)
{
    ...
    if (multi_mem_aggr_sid == TRUE) {
        ...
        case MEMDB_TCAM_IFTA80_MEM1_1m:
            ...
            bank_sids[3] = MEMDB_TCAM_IFTA80_MEM1_1m;
            tcam_sid[0] = MEMDB_TCAM_IFTA80_MEM0_0_MEM0_1m;
            tcam_sid[1] = MEMDB_TCAM_IFTA80_MEM1_0_MEM1_1m;
            break;
        case MEMDB_TCAM_IFTA80_MEM2_0m:
        case MEMDB_TCAM_IFTA80_MEM2_1m:
        case MEMDB_TCAM_IFTA80_MEM3_0m:
        case MEMDB_TCAM_IFTA80_MEM3_1m:
            ...
            bank_sids[3] = MEMDB_TCAM_IFTA80_MEM3_1m;
            tcam_sid[0] = MEMDB_TCAM_IFTA80_MEM2_0_MEM2_1m;
            tcam_sid[1] = MEMDB_TCAM_IFTA80_MEM3_0_MEM3_1m;
            break;
        case MEMDB_TCAM_IFTA80_MEM4_0m:
        case MEMDB_TCAM_IFTA80_MEM4_1m:
        case MEMDB_TCAM_IFTA80_MEM5_0m:
        case MEMDB_TCAM_IFTA80_MEM5_1m:
            ...
            bank_sids[3] = MEMDB_TCAM_IFTA80_MEM5_1m;
            tcam_sid[0] = MEMDB_TCAM_IFTA80_MEM4_0_MEM4_1m;
            tcam_sid[1] = MEMDB_TCAM_IFTA80_MEM5_0_MEM5_1m;
            break;
        case MEMDB_TCAM_IFTA80_MEM6_0m:
        case MEMDB_TCAM_IFTA80_MEM6_1m:
        case MEMDB_TCAM_IFTA80_MEM7_0m:
        case MEMDB_TCAM_IFTA80_MEM7_1m:
            ...
            bank_sids[3] = MEMDB_TCAM_IFTA80_MEM7_1m;
            tcam_sid[0] = MEMDB_TCAM_IFTA80_MEM6_0_MEM6_1m;
            tcam_sid[1] = MEMDB_TCAM_IFTA80_MEM7_0_MEM7_1m;
            break;
        default:
            SHR_ERR_EXIT(SHR_E_PARAM);
        }
                                 ...
                                 bool multi_mem_aggr_sid)
{
    ...
    if (multi_mem_aggr_sid == TRUE) {
        ...
        case MEMDB_TCAM_IFTA80_MEM3_1m:
            ...
            bank_sids[2] = MEMDB_TCAM_IFTA80_MEM1_0m;
            bank_sids[3] = MEMDB_TCAM_IFTA80_MEM1_1m;
            bank_sids[4] = MEMDB_TCAM_IFTA80_MEM2_0m;
            bank_sids[5] = MEMDB_TCAM_IFTA80_MEM2_1m;
            bank_sids[6] = MEMDB_TCAM_IFTA80_MEM3_0m;
            bank_sids[7] = MEMDB_TCAM_IFTA80_MEM3_1m;
            tcam_sid[0] = MEMDB_TCAM_IFTA80_MEM0_0_MEM0_1m;
            tcam_sid[1] = MEMDB_TCAM_IFTA80_MEM1_0_MEM1_1m;
            tcam_sid[2] = MEMDB_TCAM_IFTA80_MEM2_0_MEM2_1m;
            tcam_sid[3] = MEMDB_TCAM_IFTA80_MEM3_0_MEM3_1m;
            break;
        case MEMDB_TCAM_IFTA80_MEM4_0m:
        case MEMDB_TCAM_IFTA80_MEM4_1m:
        case MEMDB_TCAM_IFTA80_MEM5_0m:
        ...
        case MEMDB_TCAM_IFTA80_MEM7_1m:
            ...
            bank_sids[2] = MEMDB_TCAM_IFTA80_MEM5_0m;
            bank_sids[3] = MEMDB_TCAM_IFTA80_MEM5_1m;
            bank_sids[4] = MEMDB_TCAM_IFTA80_MEM6_0m;
            bank_sids[5] = MEMDB_TCAM_IFTA80_MEM6_1m;
            bank_sids[6] = MEMDB_TCAM_IFTA80_MEM7_0m;
            bank_sids[7] = MEMDB_TCAM_IFTA80_MEM7_1m;
            tcam_sid[0] = MEMDB_TCAM_IFTA80_MEM4_0_MEM4_1m;
            tcam_sid[1] = MEMDB_TCAM_IFTA80_MEM5_0_MEM5_1m;
            tcam_sid[2] = MEMDB_TCAM_IFTA80_MEM6_0_MEM6_1m;
            tcam_sid[3] = MEMDB_TCAM_IFTA80_MEM7_0_MEM7_1m;
            break;
        default:
            SHR_ERR_EXIT(SHR_E_PARAM);
        }
                                 ...
                                 bool multi_mem_aggr_sid)
{
    ...
    if (multi_mem_aggr_sid == TRUE) {
        ...
        case MEMDB_TCAM_IFTA80_MEM2_1m:
            ...
            bank_sids[3] = MEMDB_TCAM_IFTA80_MEM2_1m;
            tcam_sid[0] = MEMDB_TCAM_IFTA80_MEM0_0_MEM0_1m;
            tcam_sid[1] = MEMDB_TCAM_IFTA80_MEM2_0_MEM2_1m;
            break;
        case MEMDB_TCAM_IFTA80_MEM1_0m:
        case MEMDB_TCAM_IFTA80_MEM1_1m:
        case MEMDB_TCAM_IFTA80_MEM3_0m:
        ...
        case MEMDB_TCAM_IFTA80_MEM6_1m:
            ...
            bank_sids[3] = MEMDB_TCAM_IFTA80_MEM6_1m;
            tcam_sid[0] = MEMDB_TCAM_IFTA80_MEM4_0_MEM4_1m;
            tcam_sid[1] = MEMDB_TCAM_IFTA80_MEM6_0_MEM6_1m;
            break;
        case MEMDB_TCAM_IFTA80_MEM5_0m:
        case MEMDB_TCAM_IFTA80_MEM5_1m:
        case MEMDB_TCAM_IFTA80_MEM7_0m:
                                        ...
                                        uint8_t *is_change)
{
    ...
    bool multi_aggr_no_data_sid = FALSE;
    bool multi_mem_aggr_sid = FALSE;
    ...
    if (lrd_info->pt_type == LT_PT_TYPE_FP) {
        ...
        *is_change = 1;
        ...
        if (lrd_info->aggr_ekw_edw > 0) {
            multi_aggr_no_data_sid = TRUE;
            if (more_info->is_multi_mem_aggr) {
                multi_mem_aggr_sid = TRUE;
            }
        } else {
        ...
        for (idx = 0; idx < num_banks; idx++) {
            ...
            for (i = 0; i < BCMPTM_RM_TCAM_MAX_WIDTH_INSTANCES; i++) {
                if (bank_not_present[i] == 1) {
                    ...
                    if (multi_mem_aggr_sid == TRUE) {
                        tcam_sid[i/2] = INVALIDm;
                        data_sid[i/2] = INVALIDm;
                    } else {
                        tcam_sid[i] = INVALIDm;
                        data_sid[i] = INVALIDm;
                    }
            ...
            if (multi_aggr_no_data_sid == FALSE) {
                sid = NULL;
...
static
int check_ser_corr_info_needed(int unit,
                           bcmptm_rm_tcam_more_info_t *more_info,
                           bool *ser_info_needed)
{
    const lt_mreq_info_t *shr_lrd_info = NULL;
    bcmptm_rm_tcam_more_info_t *shr_more_info = NULL;
    bcmltd_sid_t shr_ltid;
    int i = 0;

    SHR_FUNC_ENTER(unit);

    for (i = 0; i < more_info->shared_lt_count; i++) {
        shr_ltid = more_info->shared_lt_info[i];
        ...
        SHR_NULL_CHECK(shr_lrd_info, SHR_E_FAIL);

        shr_more_info = (bcmptm_rm_tcam_more_info_t *)
                         (shr_lrd_info->rm_more_info);

        if (shr_more_info->is_multi_mem_aggr == 1) {
            *ser_info_needed = true;
            break;
        }
    }
                                          ...
                                          bool warm)
{
    ...
    uint8_t is_ifta80_bank = 0;
    uint8_t is_change = 0;
    bool ser_corr_info_needed = false;
    ...
    if (rv == SHR_E_NONE) {
        ...
        /*
         * If an LT has is_multi_mem_aggr set,
         * or LT shares hw resources with LT having
         * is_multi_mem_aggr set, LT is marked for ser
         * correction info
         */
        if (more_info->is_multi_mem_aggr == 1) {
            more_info->flags |= BCMPTM_RM_TCAM_NEEDS_SER_CORR_INFO;
        } else {
            if (more_info->shared_lt_count >= 1) {
                SHR_IF_ERR_VERBOSE_EXIT
                    (check_ser_corr_info_needed(unit,
                                           more_info,
                                           &ser_corr_info_needed));
                if (ser_corr_info_needed) {
                    more_info->flags |= BCMPTM_RM_TCAM_NEEDS_SER_CORR_INFO;
                }
            }
        }
