...
static bcmptm_ser_fld_info_t ifta90_e2t_0x_hash_ctrl_fld_lst[] = {
    { HASH_TABLE_BANK_CONFIG_LANE1f, {0}, 0xf, 0},
    { HASH_TABLE_BANK_CONFIG_LANE0f, {0}, 0xf, 0}
};
...
/*! Can't enable parity checking for macsec memory tables. */
static bcmdrd_sid_t  bcm56780_a0_mem_ser_mute_macsec[] = {
    SUB_PORT_MAP_TABLEm,
...
static bcmptm_ser_ctrl_en_t bcm56780_a0_ser_blocks_ctrl_regs[] = {
    ...
    { IDB_OBM4_SER_CONTROLr, INVALIDf, bcm56780_a0_idb_obm_en_fields },

    { IDB_CA4_SER_CONTROLr, INVALIDf, bcm56780_a0_idb_ca_fifo_en_fields },
};

static bcmptm_ser_ctrl_en_t bcm56780_a0_ser_blocks_ctrl_regs_with_macsec[] = {
                                  ...
                                  int *mem_ser_mute_num)
{
    if (!bcmsec_is_sec_supported(unit)) {
        *mem_ser_mute_list = bcm56780_a0_mem_ser_mute_macsec;
        *mem_ser_mute_num = COUNTOF(bcm56780_a0_mem_ser_mute_macsec);
    } else {
...
{
    if (bcmsec_is_sec_supported(unit)) {
        *ser_blks_ctrl_regs = bcm56780_a0_ser_blocks_ctrl_regs_with_macsec;
        *ctrl_item_num = COUNTOF(bcm56780_a0_ser_blocks_ctrl_regs_with_macsec);
    } else {
...
static int
bcm56780_a0_ser_ip_ep_sram_remap(int unit, bcmptm_ser_correct_info_t *spci)
{
    ...
    if (spci->sid[0] == EDB_XMIT_START_COUNTm) {
        spci->sid[1] = spci->sid[0];
        if (spci->index[0] < 64) {
            spci->index[1] = spci->index[0] + 256;
        } else {
            spci->index[1] = spci->index[0] - 1;
        }
    }
    return SHR_E_NONE;
}
...
bcm56780_a0_ser_sram_scan_mem_skip(int unit, bcmdrd_sid_t sid, bool *skip)
{
    ...
    if (sid != sid_ecc) {
        ...
        *skip = FALSE;
        if ((BLKTYPE_MACSEC == bcmdrd_pt_blktype_get(unit, sid, 0)) &&
