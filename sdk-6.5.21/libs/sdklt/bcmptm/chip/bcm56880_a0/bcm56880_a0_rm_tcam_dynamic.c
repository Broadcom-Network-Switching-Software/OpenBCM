/*! \file bcm56880_a0_tcam_fp_dynamic.c
 *
...
#include "bcm56880_a0_rm_tcam_dynamic.h"
...
static int
bcm56880_a0_rm_tcam_get_ifta80_bank_usage(int unit,
                                          bcmltd_sid_t ltid,
                                          uint8_t *t2t_0_banks,
                                          uint8_t *t2t_1_banks)
{
...
static int
bcm56880_a0_rm_tcam_defip_acc_modes_write(int unit,
                                        uint32_t trans_id,
                                        bcmltd_sid_t ltid,
                                        uint8_t *t2t_0_banks,
                                        uint8_t *t2t_1_banks)
...
static int
bcm56880_a0_rm_tcam_defip_acc_modes_update(int unit,
                                        uint32_t trans_id,
                                        bcmltd_sid_t ltid)
{
    ...
    while (dyn_tbl != NULL) {
        ...
        if (lrd_info->pt_type != LT_PT_TYPE_FP) {
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56880_a0_rm_tcam_get_ifta80_bank_usage(unit,
                                               dyn_tbl->sid,
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_rm_tcam_defip_acc_modes_write(unit,
                                                trans_id,
                                                ltid,
                                                ifta80_t2t_00_banks_bitmap,
                                                ifta80_t2t_01_banks_bitmap));
...
static int
bcm56880_a0_rm_tcam_slice_sid_info_get(int unit,
...
static int
bcm56880_a0_rm_tcam_sid_info_get(int unit,
                                 bcmdrd_sid_t bank_sid,
                                 bcmdrd_sid_t *bank_sids,
...
static int
bcm56880_a0_rm_tcam_dbl_sid_info_get(int unit,
                                 bcmdrd_sid_t bank_sid,
                                 bcmdrd_sid_t *bank_sids,
                                 bcmdrd_sid_t *tcam_sid,
                                 bcmdrd_sid_t *data_sid)
...
static int
bcm56880_a0_rm_tcam_dbl_urpf_sid_info_get(int unit,
                                 bcmdrd_sid_t bank_sid,
                                 bcmdrd_sid_t *bank_sids,
                                 bcmdrd_sid_t *tcam_sid,
                                 bcmdrd_sid_t *data_sid)
...
static int
bcm56880_a0_rm_tcam_urpf_paired_bank_get(int unit,
                                 bcmdrd_sid_t bank_sid,
                                 bcmdrd_sid_t *bank_sids,
                                 bcmdrd_sid_t *tcam_sid,
                                 bcmdrd_sid_t *data_sid)
...
static int
bcm56880_a0_rm_tcam_lts_tcam_sid(int unit,
                                 bcmdrd_sid_t lts_tcam_sid,
                                 bcmdrd_sid_t *lts_data_sid)
{
    SHR_FUNC_ENTER(unit);

    SHR_NULL_CHECK(lts_data_sid, SHR_E_PARAM);

    switch (lts_tcam_sid) {
    case IFTA80_E2T_00_LTS_TCAM_0_ONLYm:
        lts_data_sid[0] = IFTA80_E2T_00_LTS_POLICY_FLOP_0m;
        lts_data_sid[1] = IFTA80_E2T_00_LTS_TCAM_0_DATA_ONLYm;
        lts_data_sid[2] = IFTA80_E2T_00_LTS_POLICY_EXT_0m;
        break;
    case IFTA80_E2T_00_LTS_TCAM_1_ONLYm:
        lts_data_sid[0] = IFTA80_E2T_00_LTS_POLICY_FLOP_1m;
        lts_data_sid[1] = IFTA80_E2T_00_LTS_TCAM_1_DATA_ONLYm;
        lts_data_sid[2] = IFTA80_E2T_00_LTS_POLICY_EXT_1m;
        break;
    case IFTA80_E2T_01_LTS_TCAM_0_ONLYm:
        lts_data_sid[0] = IFTA80_E2T_01_LTS_POLICY_FLOP_0m;
        lts_data_sid[1] = IFTA80_E2T_01_LTS_TCAM_0_DATA_ONLYm;
        lts_data_sid[2] = IFTA80_E2T_01_LTS_POLICY_EXT_0m;
        break;
    case IFTA80_E2T_01_LTS_TCAM_1_ONLYm:
        lts_data_sid[0] = IFTA80_E2T_01_LTS_POLICY_FLOP_1m;
        lts_data_sid[1] = IFTA80_E2T_01_LTS_TCAM_1_DATA_ONLYm;
        lts_data_sid[2] = IFTA80_E2T_01_LTS_POLICY_EXT_1m;
        break;
    case IFTA80_E2T_02_LTS_TCAM_0_ONLYm:
        lts_data_sid[0] = IFTA80_E2T_02_LTS_POLICY_FLOP_0m;
        lts_data_sid[1] = IFTA80_E2T_02_LTS_TCAM_0_DATA_ONLYm;
        lts_data_sid[2] = IFTA80_E2T_02_LTS_POLICY_EXT_0m;
        break;
    case IFTA80_E2T_02_LTS_TCAM_1_ONLYm:
        lts_data_sid[0] = IFTA80_E2T_02_LTS_POLICY_FLOP_1m;
        lts_data_sid[1] = IFTA80_E2T_02_LTS_TCAM_1_DATA_ONLYm;
        lts_data_sid[2] = IFTA80_E2T_02_LTS_POLICY_EXT_1m;
        break;
    case IFTA80_E2T_03_LTS_TCAM_0_ONLYm:
        lts_data_sid[0] = IFTA80_E2T_03_LTS_POLICY_FLOP_0m;
        lts_data_sid[1] = IFTA80_E2T_03_LTS_TCAM_0_DATA_ONLYm;
        lts_data_sid[2] = IFTA80_E2T_03_LTS_POLICY_EXT_0m;
        break;
    case IFTA80_E2T_03_LTS_TCAM_1_ONLYm:
        lts_data_sid[0] = IFTA80_E2T_03_LTS_POLICY_FLOP_1m;
        lts_data_sid[1] = IFTA80_E2T_03_LTS_TCAM_1_DATA_ONLYm;
        lts_data_sid[2] = IFTA80_E2T_03_LTS_POLICY_EXT_1m;
        break;
    case IFTA90_E2T_00_LTS_TCAM_0_ONLYm:
        lts_data_sid[0] = IFTA90_E2T_00_LTS_POLICY_FLOP_0m;
        lts_data_sid[1] = IFTA90_E2T_00_LTS_TCAM_0_DATA_ONLYm;
        lts_data_sid[2] = IFTA90_E2T_00_LTS_POLICY_EXT_0m;
        break;
    case IFTA90_E2T_00_LTS_TCAM_1_ONLYm:
        lts_data_sid[0] = IFTA90_E2T_00_LTS_POLICY_FLOP_1m;
        lts_data_sid[1] = IFTA90_E2T_00_LTS_TCAM_1_DATA_ONLYm;
        lts_data_sid[2] = IFTA90_E2T_00_LTS_POLICY_EXT_1m;
        break;
    case IFTA90_E2T_01_LTS_TCAM_0_ONLYm:
        lts_data_sid[0] = IFTA90_E2T_01_LTS_POLICY_FLOP_0m;
        lts_data_sid[1] = IFTA90_E2T_01_LTS_TCAM_0_DATA_ONLYm;
        lts_data_sid[2] = IFTA90_E2T_01_LTS_POLICY_EXT_0m;
        break;
    case IFTA90_E2T_01_LTS_TCAM_1_ONLYm:
        lts_data_sid[0] = IFTA90_E2T_01_LTS_POLICY_FLOP_1m;
        lts_data_sid[1] = IFTA90_E2T_01_LTS_TCAM_1_DATA_ONLYm;
        lts_data_sid[2] = IFTA90_E2T_01_LTS_POLICY_EXT_1m;
        break;
    case IFTA90_E2T_02_LTS_TCAM_0_ONLYm:
        lts_data_sid[0] = IFTA90_E2T_02_LTS_POLICY_FLOP_0m;
        lts_data_sid[1] = IFTA90_E2T_02_LTS_TCAM_0_DATA_ONLYm;
        lts_data_sid[2] = IFTA90_E2T_02_LTS_POLICY_EXT_0m;
        break;
    case IFTA90_E2T_02_LTS_TCAM_1_ONLYm:
        lts_data_sid[0] = IFTA90_E2T_02_LTS_POLICY_FLOP_1m;
        lts_data_sid[1] = IFTA90_E2T_02_LTS_TCAM_1_DATA_ONLYm;
        lts_data_sid[2] = IFTA90_E2T_02_LTS_POLICY_EXT_1m;
        break;
    case IFTA90_E2T_03_LTS_TCAM_0_ONLYm:
        lts_data_sid[0] = IFTA90_E2T_03_LTS_POLICY_FLOP_0m;
        lts_data_sid[1] = IFTA90_E2T_03_LTS_TCAM_0_DATA_ONLYm;
        lts_data_sid[2] = IFTA90_E2T_03_LTS_POLICY_EXT_0m;
        break;
    case IFTA90_E2T_03_LTS_TCAM_1_ONLYm:
        lts_data_sid[0] = IFTA90_E2T_03_LTS_POLICY_FLOP_1m;
        lts_data_sid[1] = IFTA90_E2T_03_LTS_TCAM_1_DATA_ONLYm;
        lts_data_sid[2] = IFTA90_E2T_03_LTS_POLICY_EXT_1m;
        break;
    default:
        SHR_ERR_EXIT(SHR_E_PARAM);
    }
...
static int
bcm56880_a0_rm_tcam_defip_program_ltpr_table(int unit,
                                        uint32_t trans_id,
                                        bcmltd_sid_t ltid,
                                        ...
                                        bool warm)
{
    ...
    for (lookup_id = 0; lookup_id < 2; lookup_id++) {
        ...
        for (idx = 0; idx < bank_cnt; idx++) {
            ...
            SHR_IF_ERR_VERBOSE_EXIT
               (bcm56880_a0_rm_tcam_slice_sid_info_get(unit,
                                     bank_sid,
                                     banks_info,
                                     &slice_id,
                                     &ltpr_value,
                                      ...
                                      bcmptm_pt_banks_info_t *pt_banks_info)
{
    ...
    const bcmdrd_sid_t **presel_sid_data_arr = NULL;
    ...
    for (i = 0; i < BCMPTM_RM_TCAM_MAX_DEPTH_INSTANCES; i++) {
        ...
        SHR_ALLOC(presel_data_sid[i], alloc_sz, "bcmptmRmPreselDataSidArr");
    }
    ...
    for (idx = 0; idx < orig_lrd_info->hw_entry_info_count; idx++) {
        ...
        for (i = 0; i < BCMPTM_RM_TCAM_MAX_DEPTH_INSTANCES; i++) {
            ...
            sal_memset(presel_tcam_sid[i], 0,
                       (BCMPTM_RM_TCAM_MAX_WIDTH_INSTANCES *
                        sizeof(bcmdrd_sid_t)));
            sal_memset(presel_data_sid[i], 0,
                       (BCMPTM_RM_TCAM_MAX_WIDTH_INSTANCES *
                        sizeof(bcmdrd_sid_t)));
        }
        ...
        presel_num_data_rows = shared_hw_entry_info[idx].num_data_rows;
        bank_id = 0;
        ...
        for (iter = 0; iter < num_rows; iter++) {
            for (bank_id = 0; bank_id < pt_banks_info->bank_cnt; bank_id++) {
                ...
                if (pt_banks_info->bank[bank_id].bank_sid ==
                    ...
                    sal_memcpy((presel_data_sid[new_depth_inst]),
                               shared_hw_entry_info[idx].sid_data_only[iter],
                               presel_num_data_rows * sizeof(bcmdrd_sid_t));
                    if (idx == 0) {
        ...
        presel_sid_data_arr = NULL;
        SHR_ALLOC(presel_sid_data_arr, alloc_sz, "bcmptmRmTcamSidArr");
        sal_memset(presel_sid_data_arr, 0, alloc_sz);
        ...
        for (iter = 0; iter < new_depth_inst; iter++) {
            ...
            sid = NULL;
            alloc_sz = (presel_num_data_rows * sizeof(bcmdrd_sid_t));
            SHR_ALLOC(sid, alloc_sz, "bcmptmRmPreselDataSid");
            sal_memset(sid, 0, alloc_sz);
            sal_memcpy(sid, presel_data_sid[iter], alloc_sz);
            presel_sid_data_arr[iter] = sid;
        ...
        new_shared_hw_entry_info[idx].sid_data_only = presel_sid_data_arr;
...
exit:
    for (i = 0; i <  BCMPTM_RM_TCAM_MAX_DEPTH_INSTANCES; i++) {
        ...
        if (presel_data_sid != NULL && presel_data_sid[i] != NULL) {
            SHR_FREE(presel_data_sid[i]);
        }
    }
    SHR_FREE(tcam_sid);
    SHR_FREE(data_sid);
    SHR_FREE(presel_tcam_sid);
    SHR_FREE(presel_data_sid);
...
static int
bcm56880_a0_rm_tcam_dyn_lt_hw_info_init(int unit,
                                        uint32_t trans_id,
                                        bcmltd_sid_t ltid,
                                        ...
                                        uint8_t *is_change)
{
    ...
    if (rv != SHR_E_NONE || pt_banks_info.bank_cnt == 0) {
        ...
        if (warm == false && is_ifta80_bank == 1) {
            ...
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56880_a0_rm_tcam_defip_acc_modes_update(unit,
                                                    trans_id,
                                                    main_ltid));
        }
        SHR_EXIT();
    ...
    if (lrd_info->pt_type == LT_PT_TYPE_FP) {
        ...
        for (idx = 0; idx < num_banks; idx++) {
            ...
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56880_a0_rm_tcam_lts_tcam_sid(unit,
                                                  lts_tcam_sid,
                                                  data_sid));
            sid = NULL;
            ...
            sid = NULL;
            alloc_sz = (3 * sizeof(bcmdrd_sid_t));
            SHR_ALLOC(sid, alloc_sz, "bcmptmRmDataSid");
            sal_memset(sid, 0, alloc_sz);
            sal_memcpy(sid, data_sid, alloc_sz);
            sid_data_arr[idx] = sid;
        ...
        *is_change = 1;
        ...
        for (idx = 0; idx < num_banks; idx++) {
            ...
            if (num_key_rows == 2) {
                if (pt_banks_info.lookup1_bank_cnt != 0) {
                    SHR_IF_ERR_VERBOSE_EXIT
                        (bcm56880_a0_rm_tcam_dbl_urpf_sid_info_get(unit,
                                                  bank_sid,
                                                  banks_info,
                                                  tcam_sid,
                                                  data_sid));
                    ...
                    /* double wide mode */
                    SHR_IF_ERR_VERBOSE_EXIT
                        (bcm56880_a0_rm_tcam_dbl_sid_info_get(unit,
                                                  bank_sid,
                                                  banks_info,
                                                  tcam_sid,
                                                  data_sid));
                ...
                SHR_IF_ERR_VERBOSE_EXIT
                    (bcm56880_a0_rm_tcam_urpf_paired_bank_get(unit,
                                                  bank_sid,
                                                  banks_info,
                                                  tcam_sid,
                                                  data_sid));
                ...
                SHR_IF_ERR_VERBOSE_EXIT
                    (bcm56880_a0_rm_tcam_sid_info_get(unit,
                                                  bank_sid,
                                                  banks_info,
                                                  tcam_sid,
                                                  data_sid));
        ...
        /* LTPR programming */
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56880_a0_rm_tcam_defip_program_ltpr_table(unit,
                                                    trans_id,
                                                    main_ltid,
                                                    &hw_entry_info[0],
                                                    &pt_banks_info,
...
static int
bcm56880_a0_rm_tcam_dyn_shared_lt_mreq_info_init(int unit,
                                           bcmltd_sid_t ltid)
{
 ...
 */
int
bcm56880_a0_rm_tcam_dynamic_lt_validate(int unit,
                                           bcmltd_sid_t ltid)
{
    int rv = 0;
...
int
bcm56880_a0_rm_tcam_dyn_lt_mreq_info_init(int unit,
                                          uint32_t trans_id,
                                          bcmltd_sid_t ltid,
                                          bool warm)
{
    ...
    if (rv == SHR_E_NONE) {
        lt_first_init = false;
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56880_a0_rm_tcam_dyn_lt_hw_info_init(unit,
                                                     trans_id,
                                                     ltid,
                                                     lrd_info,
                                                     warm,
        ...
        if (orig_lrd_info->pt_type == LT_PT_TYPE_FP
           ...
           && more_info->flags & BCMPTM_RM_TCAM_UFT_T4T_BANKS) {
            ...
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56880_a0_rm_tcam_dyn_shared_lt_mreq_info_init(unit,
