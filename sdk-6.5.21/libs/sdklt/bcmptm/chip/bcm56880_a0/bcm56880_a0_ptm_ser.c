...
static bcmptm_ser_mem_clr_list_t bcm56880_a0_mem_clr_lst[] = {
...
static bcmptm_ser_fld_info_t ifta80_e2t_00_hash_ctrl_fld_lst[] = {
    { SBUS_NUM_BANKSf, {0}, 0, 0}
};

static bcmptm_ser_fld_info_t ifta90_e2t_0x_hash_ctrl_fld_lst[] = {
    { HASH_TABLE_BANK_CONFIG_LANE1f, {0}, 0, 0},
    { HASH_TABLE_BANK_CONFIG_LANE0f, {0}, 0, 0}
};

static bcmptm_ser_fld_info_t egr_ing_doi_ser_ctrl_fld_lst[] = {
    { SLOT_PIPELINE_ECC_ENf, {0}, 1, 0 }
};
 ...
 */
static bcmptm_ser_ctrl_reg_info_t bcm56880_a0_clear_mem_before_ser_enable_info[] = {
    /* Clear EGR SER FIFO */
    ...
    /* Keep PTcache value with H/W value which had been modified in BD init. */
    { IFTA80_E2T_00_HASH_CONTROLm, 0, &ifta80_e2t_00_hash_ctrl_fld_lst[0], 1, 0},
    { IFTA90_E2T_00_HASH_CONTROLm, 0, &ifta90_e2t_0x_hash_ctrl_fld_lst[0], 2, 0},
    { IFTA90_E2T_01_HASH_CONTROLm, 0, &ifta90_e2t_0x_hash_ctrl_fld_lst[0], 2, 0},
    { IFTA90_E2T_02_HASH_CONTROLm, 0, &ifta90_e2t_0x_hash_ctrl_fld_lst[0], 2, 0},
    { IFTA90_E2T_03_HASH_CONTROLm, 0, &ifta90_e2t_0x_hash_ctrl_fld_lst[0], 2, 0},
    { EGR_DOI_SER_CONTROL_0r, 0, &egr_ing_doi_ser_ctrl_fld_lst[0], 1, 0},
    { EGR_DOI_SER_CONTROL_1r, 0, &egr_ing_doi_ser_ctrl_fld_lst[0], 1, 0},
    { ING_DOI_SER_CONTROL_0r, 0, &egr_ing_doi_ser_ctrl_fld_lst[0], 1, 0},
    { ING_DOI_SER_CONTROL_1r, 0, &egr_ing_doi_ser_ctrl_fld_lst[0], 1, 0},

    { MMU_GLBCFG_MISCCONFIGr, 0, &mmu_gcfg_miscconfig_fld_lst[0], 1, 0}
    /* Add new items here */
};
 ...
 */
static bcmptm_ser_ctrl_reg_info_t bcm56880_a0_clear_mem_after_ser_enable_info[] = {
 ...
 */
static bcmptm_ser_ctrl_reg_info_t bcm56880_a0_tcam_scan_ctrl_reg_lst_en[] = {
 ...
 */
static bcmptm_ser_ctrl_reg_info_t bcm56880_a0_tcam_scan_ctrl_reg_lst_dis[] = {
...
static bcmdrd_sid_t  bcm56880_a0_mem_ser_mute[] = {
    /* Must */
    INVALIDr
};
 ...
 */
static bcmdrd_sid_t  bcm56880_a0_ctrl_reg_drop_ptk_mute[] = {
...
static bcmdrd_fid_t bcm56880_a0_ecc_status_fields[] = {
    MULTIPLE_ERRf,
    ENTRY_IDXf,
    DOUBLE_BIT_ERRf,
    INVALIDf /* must */
...
static bcmdrd_fid_t bcm56880_a0_edb_ctrl_buffer_ecc_en_fields[] = {
    PM3_ECC_ENf,
    PM2_ECC_ENf,
    PM1_ECC_ENf,
    PM0_ECC_ENf,
...
static bcmdrd_fid_t bcm56880_a0_edb_data_buffer_en_fields[] = {
    PM3_ECC_ENf,
    PM2_ECC_ENf,
    PM1_ECC_ENf,
    PM0_ECC_ENf,
...
static bcmdrd_fid_t bcm56880_a0_edb_ctrl_buffer_1b_en_fields[] = {
    PM3_ENf,
    PM2_ENf,
    PM1_ENf,
    PM0_ENf,
...
static bcmdrd_fid_t bcm56880_a0_edb_data_buffer_1b_en_fields[] = {
    PM3_ENf,
    PM2_ENf,
    PM1_ENf,
    PM0_ENf,
...
/*
 * In bcm56880_a0_ser_hwmem_base_info, we need to use 'membase' to find 'bd_name'.
 ...
 */
static bcmptm_ser_buf_bus_ctrl_reg_t bcm56880_a0_idb_obm0_status_reg[] = {
...
static bcmptm_ser_buf_bus_ctrl_reg_t bcm56880_a0_idb_obm1_status_reg[] = {
...
static bcmptm_ser_buf_bus_ctrl_reg_t bcm56880_a0_idb_obm2_status_reg[] = {
...
static bcmptm_ser_buf_bus_ctrl_reg_t bcm56880_a0_idb_obm3_status_reg[] = {
...
static bcmptm_ser_buf_bus_ctrl_reg_t bcm56880_a0_idb_ca0_status_reg[] = {
    { IDB_CA_ECC_STATUSr, "IDB_CA_ECC_STATUS", 2, 0 },
    { INVALIDr, "INVALID" }
};

static bcmptm_ser_buf_bus_ctrl_reg_t bcm56880_a0_idb_ca1_status_reg[] = {
    { IDB_CA_ECC_STATUSr, "IDB_CA_ECC_STATUS", 2, 1 },
    { INVALIDr, "INVALID" }
};

static bcmptm_ser_buf_bus_ctrl_reg_t bcm56880_a0_idb_ca2_status_reg[] = {
    { IDB_CA_ECC_STATUSr, "IDB_CA_ECC_STATUS", 2, 2 },
    { INVALIDr, "INVALID" }
};

static bcmptm_ser_buf_bus_ctrl_reg_t bcm56880_a0_idb_ca3_status_reg[] = {
    { IDB_CA_ECC_STATUSr, "IDB_CA_ECC_STATUS", 2, 3 },
    { INVALIDr, "INVALID" }
};

static bcmptm_ser_buf_bus_ctrl_reg_t bcm56880_a0_idb_ca_cpu_status_reg[] = {
    { IDB_CA_CPU_ECC_STATUSr, "IDB_CA_CPU_ECC_STATUS", 3, -1 },
    { INVALIDr, "INVALID" }
};

static bcmptm_ser_buf_bus_ctrl_reg_t bcm56880_a0_idb_ca_lpbk_status_reg[] = {
    { IDB_CA_LPBK_ECC_STATUSr, "IDB_CA_LPBK_ECC_STATUS", 4, -1 },
    { INVALIDr, "INVALID" }
};

static bcmdrd_fid_t bcm56880_a0_idb_ca_lpbk_en_fields[] = {
    CA_LPBK_FIFO_ECC_ENABLEf,
    CA_LPBK_FIFO_EN_COR_ERR_RPTf,
    INVALIDf /* must */
};

static bcmdrd_fid_t bcm56880_a0_idb_ca_cpu_en_fields[] = {
    CA_CPU_FIFO_ECC_ENABLEf,
    CA_CPU_FIFO_EN_COR_ERR_RPTf,
    INVALIDf /* must */
};

static bcmdrd_fid_t bcm56880_a0_idb_ca_fifo_en_fields[] = {
    CA_FIFO_EN_COR_ERR_RPTf,
    CA_FIFO_ECC_ENABLEf,
    INVALIDf /* must */
};

static bcmdrd_fid_t bcm56880_a0_idb_obm_en_fields[] = {
    MON_EN_COR_ERR_RPTf,
    MON_ECC_ENABLEf,
...
static bcmptm_ser_mac_status_fld_t bcm56880_a0_cdmac_ecc_tx_1bit_flds[] = {
    { TX_CDC_SINGLE_BIT_ERRf, INVALIDf, 1, BCMPTM_SER_CLR_INTR_READ },
    { INVALIDf, INVALIDf, -1 } /* must */
};

static bcmptm_ser_mac_status_fld_t bcm56880_a0_cdmac_ecc_tx_2bit_flds[] = {
    { TX_CDC_DOUBLE_BIT_ERRf, INVALIDf, 0, BCMPTM_SER_CLR_INTR_READ },
    { INVALIDf, INVALIDf, -1 } /* must */
};

static bcmptm_ser_mac_status_fld_t bcm56880_a0_cdmac_ecc_mib_1bit_flds[] = {
    { MIB_COUNTER_SINGLE_BIT_ERRf, INVALIDf, 1, BCMPTM_SER_CLR_INTR_READ },
    { INVALIDf, INVALIDf, -1 } /* must */
};

static bcmptm_ser_mac_status_fld_t bcm56880_a0_cdmac_ecc_mib_2bit_flds[] = {
    { MIB_COUNTER_DOUBLE_BIT_ERRf, INVALIDf, 0, BCMPTM_SER_CLR_INTR_READ },
    { INVALIDf, INVALIDf, -1 } /* must */
};

static bcmptm_ser_mac_status_fld_t bcm56880_a0_cdmac_ecc_mib_multi_flds[] = {
    { MIB_COUNTER_MULTIPLE_ERRf, INVALIDf, 2, BCMPTM_SER_CLR_INTR_READ },
    { INVALIDf, INVALIDf, -1 } /* must */
};

static bcmdrd_fid_t bcm56880_a0_cdmac_ecc_ctrl_flds[] = {
    TX_CDC_ECC_CTRL_ENf,
    MIB_COUNTER_ECC_CTRL_ENf,
    INVALIDf /* must */
};

static bcmptm_ser_buf_bus_ctrl_reg_t bcm56880_a0_pm_xlp_rx_status_reg[] = {
    { XLPORT_MIB_RSC0_ECC_STATUSr, "XLP MIB RSC0 ECC", -1, -1 },
    { XLPORT_MIB_RSC1_ECC_STATUSr, "XLP MIB RSC1 ECC", -1, -1 },
    { INVALIDr } /* must */
};

static bcmptm_ser_buf_bus_ctrl_reg_t bcm56880_a0_pm_xlp_tx_status_reg[] = {
    { XLPORT_MIB_TSC0_ECC_STATUSr, "XLP MIB TSC0 ECC", -1, -1 },
    { XLPORT_MIB_TSC1_ECC_STATUSr, "XLP MIB TSC1 ECC", -1, -1 },
    { INVALIDr } /* must */
};

static bcmptm_ser_mac_status_fld_t bcm56880_a0_xlmac_rx_cdc_1bit_err[] = {
    { RX_CDC_SINGLE_BIT_ERRf, CLEAR_RX_CDC_SINGLE_BIT_ERRf, 1, BCMPTM_SER_CLR_INTR_RAISE_EDGE },
    { INVALIDf, INVALIDf, -1 } /* must */
};

static bcmptm_ser_mac_status_fld_t bcm56880_a0_xlmac_rx_cdc_2bit_err[] = {
    { RX_CDC_DOUBLE_BIT_ERRf, CLEAR_RX_CDC_DOUBLE_BIT_ERRf, 0, BCMPTM_SER_CLR_INTR_RAISE_EDGE},
    { INVALIDf, INVALIDf, -1 } /* must */
};

static bcmptm_ser_mac_status_fld_t bcm56880_a0_xlmac_tx_cdc_1bit_err[] = {
    { TX_CDC_SINGLE_BIT_ERRf, CLEAR_TX_CDC_SINGLE_BIT_ERRf, 1, BCMPTM_SER_CLR_INTR_RAISE_EDGE },
    { INVALIDf, INVALIDf, -1 } /* must */
};

static bcmptm_ser_mac_status_fld_t bcm56880_a0_xlmac_tx_cdc_2bit_err[] = {
    { TX_CDC_DOUBLE_BIT_ERRf, CLEAR_TX_CDC_DOUBLE_BIT_ERRf, 0, BCMPTM_SER_CLR_INTR_RAISE_EDGE },
    { INVALIDf, INVALIDf, -1 } /* must */
};

static bcmdrd_fid_t bcm56880_a0_xlmac_ecc_ctrl_flds[] = {
    TX_CDC_ECC_CTRL_ENf,
    RX_CDC_ECC_CTRL_ENf,
    INVALIDf /* must */
};

static bcmdrd_fid_t bcm56880_a0_xlport_ecc_ctrl_flds[] = {
    MIB_TSC_MEM_ENf,
    MIB_RSC_MEM_ENf,
    INVALIDf /* must */
};

static bcmdrd_fid_t bcm56880_a0_idb_intr_en_flds[] = {
    LPBK_FIFO_ECC_ERRf,
    CPU_FIFO_ECC_ERRf,
    CA3_FIFO_ECC_ERRf,
    OBM3_ECC_ERRf,
...
static bcmptm_ser_ecc_status_fld_t bcm56880_a0_ecc_status_flds = {
    ECC_ERRf, bcm56880_a0_ecc_status_fields
};

static bcmptm_ser_ctrl_en_t bcm56880_a0_ser_blocks_ctrl_regs[] = {

    { EPOST_EGR_INTR_ENABLEr, ENABLEf, NULL },

    { IPOST_SER_STATUS_BLK_ING_INTR_ENABLEr, ENABLEf, NULL },

    { CDMAC_ECC_CTRLr, INVALIDf, bcm56880_a0_cdmac_ecc_ctrl_flds },

    { XLMAC_ECC_CTRLr, INVALIDf, bcm56880_a0_xlmac_ecc_ctrl_flds },

    { XLPORT_ECC_CONTROLr, INVALIDf, bcm56880_a0_xlport_ecc_ctrl_flds },

    { EDB_INTR_ENABLEr, SER_FIFO_NON_EMPTYf, NULL },

    { EDB_CONTROL_BUFFER_ECC_ENr, INVALIDf, bcm56880_a0_edb_ctrl_buffer_ecc_en_fields },

    { EDB_DATA_BUFFER_ECC_ENr, INVALIDf, bcm56880_a0_edb_data_buffer_en_fields },

    { EDB_CONTROL_BUFFER_EN_COR_ERR_RPTr, INVALIDf, bcm56880_a0_edb_ctrl_buffer_1b_en_fields },

    { EDB_DATA_BUFFER_EN_COR_ERR_RPTr, INVALIDf, bcm56880_a0_edb_data_buffer_1b_en_fields },

    { IDB_INTR_ENABLEr, INVALIDf, bcm56880_a0_idb_intr_en_flds },

    { IDB_CA_LPBK_SER_CONTROLr, INVALIDf, bcm56880_a0_idb_ca_lpbk_en_fields },

    { IDB_CA_CPU_SER_CONTROLr, INVALIDf, bcm56880_a0_idb_ca_cpu_en_fields },

    { IDB_CA3_SER_CONTROLr, INVALIDf, bcm56880_a0_idb_ca_fifo_en_fields },

    { IDB_OBM3_SER_CONTROLr, INVALIDf, bcm56880_a0_idb_obm_en_fields },

    { IDB_CA2_SER_CONTROLr, INVALIDf, bcm56880_a0_idb_ca_fifo_en_fields },

    { IDB_OBM2_SER_CONTROLr, INVALIDf, bcm56880_a0_idb_obm_en_fields },

    { IDB_CA1_SER_CONTROLr, INVALIDf, bcm56880_a0_idb_ca_fifo_en_fields },

    { IDB_OBM1_SER_CONTROLr, INVALIDf, bcm56880_a0_idb_obm_en_fields },

    { IDB_CA0_SER_CONTROLr, INVALIDf, bcm56880_a0_idb_ca_fifo_en_fields },

    { IDB_OBM0_SER_CONTROLr, INVALIDf, bcm56880_a0_idb_obm_en_fields },
 ...
 */
bcmdrd_fid_t  bcm56880_a0_fs_ser_status_bus[] = {
    VALIDf,
    ECC_PARITYf,
    MEM_TYPEf,
    ADDRESSf,
 ...
 */
bcmdrd_fid_t  bcm56880_a0_ser_status_bus[] = {
    VALIDf,
    ECC_PARITYf,
    MEM_TYPEf,
    ADDRESSf,
 ...
 */
static bcmdrd_fid_t bcm56880_a0_mem_fail_addr_flds[] = {
    ERR_MULTf,
    ERR_TYPEf,
    EADDRf
};

static bcmptm_serc_non_fifo_t bcm56880_a0_serc_idb_info[] = {
    {
        IDB_INTR_STATUSr, LPBK_FIFO_ECC_ERRf,
        1, INVALIDr, bcm56880_a0_idb_ca_lpbk_status_reg, INVALIDr,
        &bcm56880_a0_ecc_status_flds, NULL, NULL,
        BLKTYPE_PORT_IF, "CA-LPBK packet buffer memory"
    },
    {
        IDB_INTR_STATUSr, CPU_FIFO_ECC_ERRf,
        1, INVALIDr, bcm56880_a0_idb_ca_cpu_status_reg, INVALIDr,
        &bcm56880_a0_ecc_status_flds, NULL, NULL,
        BLKTYPE_PORT_IF, "CA-CPU packet buffer memory"
    },
    {
        IDB_INTR_STATUSr, CA3_FIFO_ECC_ERRf,
        1, INVALIDr, bcm56880_a0_idb_ca3_status_reg, INVALIDr,
        &bcm56880_a0_ecc_status_flds, NULL, NULL,
        BLKTYPE_PORT_IF, "CA3 FIFO"
    },
    {
        IDB_INTR_STATUSr, OBM3_ECC_ERRf,
        1, INVALIDr, bcm56880_a0_idb_obm3_status_reg, INVALIDr,
        &bcm56880_a0_ecc_status_flds, NULL, NULL,
        BLKTYPE_PORT_IF, "IDB OBM3 packet data memory"
    },
    {
        IDB_INTR_STATUSr, CA2_FIFO_ECC_ERRf,
        1, INVALIDr, bcm56880_a0_idb_ca2_status_reg, INVALIDr,
        &bcm56880_a0_ecc_status_flds, NULL, NULL,
        BLKTYPE_PORT_IF, "CA2 FIFO"
    },
    {
        IDB_INTR_STATUSr, OBM2_ECC_ERRf,
        1, INVALIDr, bcm56880_a0_idb_obm2_status_reg, INVALIDr,
        &bcm56880_a0_ecc_status_flds, NULL, NULL,
        BLKTYPE_PORT_IF, "IDB OBM2 packet data memory"
    },
    {
        IDB_INTR_STATUSr, CA1_FIFO_ECC_ERRf,
        1, INVALIDr, bcm56880_a0_idb_ca1_status_reg, INVALIDr,
        &bcm56880_a0_ecc_status_flds, NULL, NULL,
        BLKTYPE_PORT_IF, "CA1 FIFO"
    },
    {
        IDB_INTR_STATUSr, OBM1_ECC_ERRf,
        1, INVALIDr, bcm56880_a0_idb_obm1_status_reg, INVALIDr,
        &bcm56880_a0_ecc_status_flds, NULL, NULL,
        BLKTYPE_PORT_IF, "IDB OBM1 packet data memory"
    },
    {
        IDB_INTR_STATUSr, CA0_FIFO_ECC_ERRf,
        1, INVALIDr, bcm56880_a0_idb_ca0_status_reg, INVALIDr,
        &bcm56880_a0_ecc_status_flds, NULL, NULL,
        BLKTYPE_PORT_IF, "CA0 FIFO"
    },
    {
        IDB_INTR_STATUSr, OBM0_ECC_ERRf,
        1, INVALIDr, bcm56880_a0_idb_obm0_status_reg, INVALIDr,
        &bcm56880_a0_ecc_status_flds, NULL, NULL,
        BLKTYPE_PORT_IF, "IDB OBM0 packet data memory"
    },
};

static bcmptm_serc_fifo_t bcm56880_a0_serc_edb_info[] = {
    {
        EDB_INTR_STATUSr, SER_FIFO_NON_EMPTYf,
        EDB_SER_FIFOm, bcm56880_a0_ser_status_bus,
        INVALIDr, BLKTYPE_PORT_IF, "PORT_IF_EDB"
    }
};

static bcmptm_serc_fifo_t bcm56880_a0_serc_mmu_info[] = {
    {
        MMU_GLBCFG_MEM_SER_FIFO_STSr, EMPTYf,
        MMU_GLBCFG_MEM_FAIL_ADDR_64m, bcm56880_a0_mem_fail_addr_flds,
        MMU_GLBCFG_MEM_FAIL_INT_CTRr, BLKTYPE_MMU_GLB, "MMU_GLB"
    },
    {
        MMU_ITMCFG_MEM_SER_FIFO_STSr, EMPTYf,
        MMU_ITMCFG_MEM_FAIL_ADDR_64m, bcm56880_a0_mem_fail_addr_flds,
        MMU_ITMCFG_MEM_FAIL_INT_CTRr, BLKTYPE_MMU_ITM, "MMU_ITM"
    },
    {
        MMU_EBCFG_MEM_SER_FIFO_STSr, EMPTYf,
        MMU_EBCFG_MEM_FAIL_ADDR_64m, bcm56880_a0_mem_fail_addr_flds,
        MMU_EBCFG_MEM_FAIL_INT_CTRr, BLKTYPE_MMU_EB, "MMU_EB"
    }
};

static bcmptm_serc_fifo_t bcm56880_a0_serc_ep_info[] = {
    {
        INVALIDr, INVALIDf,
        EGR_DOI_SER_FIFOm, bcm56880_a0_fs_ser_status_bus,
        INVALIDr, BLKTYPE_EPIPE, "EPIPE"
    },
    {
        EPOST_EGR_INTR_STATUSr, SER_FIFO_NON_EMPTYf,
        EPOST_EGR_SER_FIFOm, bcm56880_a0_fs_ser_status_bus,
        INVALIDr, BLKTYPE_EPIPE, "EPIPE_EPOST"
    }
};

static bcmptm_serc_fifo_t bcm56880_a0_serc_ip_info[] = {
    {
        IPOST_SER_STATUS_BLK_ING_INTR_STATUSr, SER_FIFO_NON_EMPTYf,
        IPOST_SER_STATUS_BLK_ING_SER_FIFOm, bcm56880_a0_fs_ser_status_bus,
        INVALIDr, BLKTYPE_IPIPE, "IPIPE_IPOST"
    },
    {
        INVALIDr, INVALIDf,
        ING_DOI_SER_FIFOm, bcm56880_a0_fs_ser_status_bus,
        INVALIDr, BLKTYPE_IPIPE, "IPIPE"
    }
};

static bcmptm_serc_fifo_t bcm56880_a0_serc_ip_dlb_info[] = {
    {
        DLB_ECMP_INTR_STATUSr, SER_FIFO_NON_EMPTYf,
        DLB_ECMP_SER_FIFOm, bcm56880_a0_fs_ser_status_bus,
        INVALIDr, BLKTYPE_IPIPE, "IPIPE_DLB"
    }
};

/* CDMAC_ECC_STATUSr is cleared-on-read */
static bcmptm_serc_non_fifo_t bcm56880_a0_serc_cdp_info[] = {
    {
        INVALIDr, INVALIDf,
        0, CDMAC_ECC_STATUSr, NULL, INVALIDr,
        NULL, bcm56880_a0_cdmac_ecc_tx_1bit_flds, NULL,
        BLKTYPE_CDPORT, "CDMAC SER error"
    },
    {
        INVALIDr, INVALIDf,
        0, CDMAC_ECC_STATUSr, NULL, INVALIDr,
        NULL, bcm56880_a0_cdmac_ecc_tx_2bit_flds, NULL,
        BLKTYPE_CDPORT, "CDMAC SER error"
    },
    {
        INVALIDr, INVALIDf,
        0, CDMAC_ECC_STATUSr, NULL, INVALIDr,
        NULL, bcm56880_a0_cdmac_ecc_mib_1bit_flds, NULL,
        BLKTYPE_CDPORT, "CDMAC SER error"
    },
    {
        INVALIDr, INVALIDf,
        0, CDMAC_ECC_STATUSr, NULL, INVALIDr,
        NULL, bcm56880_a0_cdmac_ecc_mib_2bit_flds, NULL,
        BLKTYPE_CDPORT, "CDMAC SER error"
    },
    {
        INVALIDr, INVALIDf,
        0, CDMAC_ECC_STATUSr, NULL, INVALIDr,
        NULL, bcm56880_a0_cdmac_ecc_mib_multi_flds, NULL,
        BLKTYPE_CDPORT, "CDMAC SER error"
    }
};

static bcmptm_serc_non_fifo_t bcm56880_a0_serc_xlp_info[] = {
    {
        INVALIDr, INVALIDf,
        0, XLMAC_RX_CDC_ECC_STATUSr, NULL, XLMAC_CLEAR_ECC_STATUSr,
        NULL, bcm56880_a0_xlmac_rx_cdc_1bit_err, NULL,
        BLKTYPE_XLPORT, "XLP MAC RX 1 bit error"
    },
    {
        INVALIDr, INVALIDf,
        0, XLMAC_RX_CDC_ECC_STATUSr, NULL, XLMAC_CLEAR_ECC_STATUSr,
        NULL, bcm56880_a0_xlmac_rx_cdc_2bit_err, NULL,
        BLKTYPE_XLPORT, "XLP MAC RX 2 bit error"
    },
    {
        INVALIDr, INVALIDf,
        0, XLMAC_TX_CDC_ECC_STATUSr, NULL, XLMAC_CLEAR_ECC_STATUSr,
        NULL, bcm56880_a0_xlmac_tx_cdc_1bit_err, NULL,
        BLKTYPE_XLPORT, "XLP MAC TX 1 bit error"
    },
    {
        INVALIDr, INVALIDf,
        0, XLMAC_TX_CDC_ECC_STATUSr, NULL, XLMAC_CLEAR_ECC_STATUSr,
        NULL, bcm56880_a0_xlmac_tx_cdc_2bit_err, NULL,
        BLKTYPE_XLPORT, "XLP MAC TX 2 bit error"
    },
    /* W1TC */
    {
        XLPORT_INTR_STATUSr, MIB_TX_MEM_ERRf,
        1, INVALIDr, bcm56880_a0_pm_xlp_tx_status_reg, INVALIDr,
        &bcm56880_a0_ecc_status_flds, NULL, NULL,
    ...
    /* W1TC */
    {
        ...
        1, INVALIDr, bcm56880_a0_pm_xlp_rx_status_reg, INVALIDr,
        &bcm56880_a0_ecc_status_flds, NULL, NULL,
        BLKTYPE_XLPORT, "XLP MIB RX Statistic Counter memory"
    }
};

static bcmptm_ser_intr_route_info_t bcm56880_a0_intr_map[] = {
    {
        ...
        (void *)bcm56880_a0_serc_mmu_info, COUNTOF(bcm56880_a0_serc_mmu_info), 1
    },
    {
        ...
        (void *)bcm56880_a0_serc_ep_info, COUNTOF(bcm56880_a0_serc_ep_info), 1
    },
    {
        BCMPTM_SER_IPEP_INTR_FLG,
        { IPOST_SER_STATUS_BLK_ING_SER_FIFO_NON_EMPTY, ING_DOI_SER_FIFO_NON_EMPTY },
        QUAD0_IP_TO_CMIC_INTR, QUAD3_IP_TO_CMIC_INTR, 0,
        BCMPTM_SER_INFO_TYPE_IPIPE,
        (void *)bcm56880_a0_serc_ip_info, COUNTOF(bcm56880_a0_serc_ip_info), 1
    },
    {
        BCMPTM_SER_IPEP_INTR_FLG,
        { DLB_ECMP_INTR },
        ...
        (void *)bcm56880_a0_serc_ip_dlb_info, COUNTOF(bcm56880_a0_serc_ip_dlb_info), 1
    },
    {
        BCMPTM_SER_NON_SUB_LVL_INT,
        { BCMPTM_SER_NON_SUB_LVL_INT },
        PIPE0_EDB_TO_CMIC_PERR_INTR, PIPE7_EDB_TO_CMIC_PERR_INTR, 0,
        BCMPTM_SER_INFO_TYPE_PORT_IF_EDB,
        (void *)bcm56880_a0_serc_edb_info, COUNTOF(bcm56880_a0_serc_edb_info), 1
    },
    {
        BCMPTM_SER_NON_SUB_LVL_INT,
        { BCMPTM_SER_NON_SUB_LVL_INT },
        PIPE0_IDB_TO_CMIC_PERR_INTR, PIPE7_IDB_TO_CMIC_PERR_INTR, 0,
        BCMPTM_SER_INFO_TYPE_PORT_IF_IDB,
        (void *)bcm56880_a0_serc_idb_info, COUNTOF(bcm56880_a0_serc_idb_info), 0
    },
    /* Use to clear SER error */
    {
        ...
        PM0_INTR, PM31_INTR, 0,
        BCMPTM_SER_INFO_TYPE_CDPORT,
        (void *)bcm56880_a0_serc_cdp_info, COUNTOF(bcm56880_a0_serc_cdp_info), 0
    },
    {
        BCMPTM_SER_PORT_INTR_FLG,
        {
        ...
        (void *)bcm56880_a0_serc_xlp_info, COUNTOF(bcm56880_a0_serc_xlp_info), 0
    }
};
 ...
 */
static bcmptm_ser_buffer_bus_info_t bcm56880_a0_ser_hwmem_base_info[] = {
    /* XFS */
    { "ING_DII_EVENT_FIFO_0", "ING DII 0", 48, 0xff, 1},
    { "ING_DII_EVENT_FIFO_1", "ING DII 1", 49, 0xff, 1},
    { "ING_DOI_OUTPUT_FIFO_0", "Ingress DOI output event fifo 0", 50, 0xff, 1},
    { "ING_DOI_OUTPUT_FIFO_1", "Ingress DOI output event fifo 1", 54, 0xff, 1},
    { "ING_DOI_SLOT_PIPELINE_0", "Ingress DOI slot pipeline 0", 51, 0xff, 0},
    { "ING_DOI_SLOT_PIPELINE_0", "Ingress DOI slot pipeline 1", 55, 0xff, 0},
    { "ING_DOI_PACKET_BUFFER_0", "Ingress DOI packet buffer 0", 52, 0xff, 1},
    { "ING_DOI_PACKET_BUFFER_1", "Ingress DOI packet buffer 1", 56, 0xff, 1},
    { "ING_DOI_CELL_QUEUE_0", "Ingress DOI cell queues 0", 53, 0xff, 1},
    { "ING_DOI_CELL_QUEUE_1", "Ingress DOI cell queues 1", 57, 0xff, 1},
    { "EGR_DOI_OUTPUT_FIFO_0", "Egress DOI output event fifo 0", 80, 0xff, 1},
    { "EGR_DOI_OUTPUT_FIFO_1", "Egress DOI output event fifo 1", 85, 0xff, 1},
    { "EGR_DOI_SLOT_PIPELINE_0", "Egress DOI slot pipeline 0", 81, 0xff, 0},
    { "EGR_DOI_SLOT_PIPELINE_1", "Egress DOI slot pipeline 1", 86, 0xff, 0},
    { "EGR_DOI_PKT_BUFFER_0", "Egress DOI packet buffer 0", 82, 0xff, 1},
    { "EGR_DOI_PKT_BUFFER_1", "Egress DOI packet buffer 1", 87, 0xff, 1},
    { "EP_PACKET_DATA_0", "Egress DOI packet data 0", 83, 0xff, 1},
    { "EP_PACKET_DATA_1", "Egress DOI packet data 1", 88, 0xff, 1},
    { "EP_MPB_BUS_0", "Egress DOI 0", 84, 0xff, 0},
    { "EP_MPB_BUS_1", "Egress DOI 1", 89, 0xff, 0},
    { "EGR_DII_EVENT_FIFO_0", "EGR DII 0", 90, 0xff, 1},
    { "EGR_DII_EVENT_FIFO_1", "EGR DII 1", 91, 0xff, 1},
    { "CENTRAL_EVICTION_FIFO", "In CEV", 64, 0xff, 1},
    { "EP_INITBUF", "Einitbuf", 92, 0xff, 1},
    { "EGR_COMPOSITES", "Egr composites buffer", 93, 0xff, 1},
    { "FIFO_PTHRU_EP1_1_0", "PTHRU FIFO EP1_1", 94, 0xff, 1},
    { "FIFO_PTHRU_IP0_0", "PTHRU FIFO IP0_0", 58, 0xff, 1},
    { "FIFO_PTHRU_IP0_1", "PTHRU FIFO IP0_1", 59, 0xff, 1},
    { "FIFO_PTHRU_IP1_0", "PTHRU FIFO IP1_0", 60, 0xff, 1},
    { "FIFO_PTHRU_IP3_0_0", "PTHRU FIFO IP3_0", 61, 0xff, 1},
    { "FIFO_PTHRU_IP4_0", "PTHRU FIFO IP4_0", 62, 0xff, 1},
    { "FIFO_PTHRU_IP5_0", "PTHRU FIFO IP5_0", 63, 0xff, 1},
    { "FIFO_PTHRU_IP8_1_0", "PTHRU FIFO IP8_1", 64, 0xff, 1},
    { "FIFO_PTHRU_IP9_0_0", "PTHRU FIFO IP9_0", 65, 0xff, 1},
...
static bcmptm_ser_ctrl_reg_info_t bcm56880_a0_clear_refresh_registers[] = {
    { ING_DII_AUX_ARB_CONTROLr, 0, &dii_aux_arb_control_fld_lst[0], 2, 0},
    { EGR_DII_AUX_ARB_CONTROLr, 0, &dii_aux_arb_control_fld_lst[0], 2, 0},
    { DLB_ECMP_REFRESH_DISABLEr, 0, &dlb_refresh_disable_fld_lst[0], 1, 0},
    { DLB_LAG_REFRESH_DISABLEr, 0, &dlb_refresh_disable_fld_lst[0], 1, 0},
...
static bcmptm_ser_acctype_info_t bcm56880_a0_acctype_info[] = {
...
static bcmptm_ser_blk_map_t bcm56880_a0_blktype_info[] = {
...
static const bcmdrd_sid_t bcm56880_a0_idb_obm_mem_list[] = {
 ...
 */
static int
bcm56880_a0_ser_mem_clr_list_get(int unit,
                                 bcmptm_ser_mem_clr_list_t **mem_list,
                                 int *entry_num)
{
    *mem_list = bcm56880_a0_mem_clr_lst;
    *entry_num = COUNTOF(bcm56880_a0_mem_clr_lst);

    return SHR_E_NONE;
}

static int
bcm56880_a0_ser_clear_mem_before_ser_enable(int unit,
                                            bcmptm_ser_ctrl_reg_info_t **reg_ctrl_lst,
                                            int *reg_num)
{
    *reg_ctrl_lst = bcm56880_a0_clear_mem_before_ser_enable_info;
    *reg_num = COUNTOF(bcm56880_a0_clear_mem_before_ser_enable_info);
    return SHR_E_NONE;
}

static int
bcm56880_a0_ser_clear_mem_after_ser_enable(int unit,
                                           bcmptm_ser_ctrl_reg_info_t **reg_ctrl_lst,
                                           int *reg_num)
{
    *reg_ctrl_lst = bcm56880_a0_clear_mem_after_ser_enable_info;
    *reg_num = COUNTOF(bcm56880_a0_clear_mem_after_ser_enable_info);

    return SHR_E_NONE;
}

static int
bcm56880_a0_ser_tcam_hw_scan_ctrl_info_get(int unit, int enable,
                                           bcmptm_ser_ctrl_reg_info_t **reg_ctrl_lst,
                                           int *reg_num)
{
    if (enable) {
        *reg_ctrl_lst = bcm56880_a0_tcam_scan_ctrl_reg_lst_en;
        *reg_num = COUNTOF(bcm56880_a0_tcam_scan_ctrl_reg_lst_en);
    } else {
        *reg_ctrl_lst = bcm56880_a0_tcam_scan_ctrl_reg_lst_dis;
        *reg_num = COUNTOF(bcm56880_a0_tcam_scan_ctrl_reg_lst_dis);
    }
    return SHR_E_NONE;
}

static int
bcm56880_a0_ser_mem_mute_list_get(int unit,
                                  bcmdrd_sid_t **mem_ser_mute_list,
                                  int *mem_ser_mute_num)
{
    *mem_ser_mute_list = bcm56880_a0_mem_ser_mute;
    *mem_ser_mute_num = COUNTOF(bcm56880_a0_mem_ser_mute);

    return SHR_E_NONE;
}

static int
bcm56880_a0_ser_drop_ptk_ctrl_reg_mute_list_get(int unit,
                                  bcmdrd_sid_t **ctrl_reg_mute_list,
                                  int *ctrl_reg_mute_num)
{
    *ctrl_reg_mute_list = bcm56880_a0_ctrl_reg_drop_ptk_mute;
    *ctrl_reg_mute_num = COUNTOF(bcm56880_a0_ctrl_reg_drop_ptk_mute);

    return SHR_E_NONE;
}

static int
bcm56880_a0_ser_blk_ctrl_get(int unit,
                             bcmptm_ser_ctrl_en_t **ser_blks_ctrl_regs,
                             int *ctrl_item_num)
{
    *ser_blks_ctrl_regs = bcm56880_a0_ser_blocks_ctrl_regs;
    *ctrl_item_num = COUNTOF(bcm56880_a0_ser_blocks_ctrl_regs);

    return SHR_E_NONE;
}

static int
bcm56880_a0_ser_intr_map_get(int unit,
                             int *cdmac_inst,
                             bcmptm_ser_intr_route_info_t **intr_map,
                             int *intr_map_num)
{

    *intr_map = bcm56880_a0_intr_map;
    *intr_map_num = COUNTOF(bcm56880_a0_intr_map);
...
static int
bcm56880_a0_ser_blk_type_map(int unit,
                             int blk_type, int *blk_type_overlay,
                             int *ser_blk_type)
{
    int count = COUNTOF(bcm56880_a0_blktype_info);
    int i = 0, index = -1;

    for (i = 0; i < count; i++) {
        if (blk_type == bcm56880_a0_blktype_info[i].blk_type) {
            index = i;
            break;
        }
    }
    if (index >= 0) {
        if (ser_blk_type != NULL) {
            *ser_blk_type = bcm56880_a0_blktype_info[index].ser_blk_type;
        }
        if (blk_type_overlay != NULL) {
            for (i = 0; i < BCMPTM_SER_OVERLAY_BLK_TYPE_NUM; i++) {
                blk_type_overlay[i] =
                    bcm56880_a0_blktype_info[index].blk_type_overlay[i];
            }
        }
        return SHR_E_NONE;
    } else {
...
static void
bcm56880_a0_ser_lp_intr_enable(int unit, int sync, int cmicx_intr_num, int enable)
{
    if (enable) {
...
static int
bcm56880_a0_ser_lp_intr_func_set(int unit,
...
static int
bcm56880_a0_ser_cmicx_adext_get(int unit, bcmptm_cmic_adext_info_t adext_info,
                                uint32_t *adext)
{
...
static int
bcm56880_a0_ser_acc_type_get(int unit, bcmdrd_sid_t sid,
                             uint32_t *acc_type, const char **acctype_str)
{
    int rv = SHR_E_NONE;
    bcmdrd_sym_info_t sym_info, *sinfo = &sym_info;
    uint32_t blkacc = 0, acctype_tmp = 0;
    int i = 0, acctype_num = COUNTOF(bcm56880_a0_acctype_info);
    bcmptm_ser_acctype_info_t *acctype_info = bcm56880_a0_acctype_info;
...
static bool
bcm56880_a0_ser_pt_inst_remap(int unit, bcmdrd_sid_t sid,
                              int *tbl_inst, int *tbl_copy)
{
    ...
    if (ipep_valid_pipes < 0xf) {
        ...
        if (blk_type == BLKTYPE_EPIPE || blk_type == BLKTYPE_IPIPE) {
            ...
            num_item = 2;
            inst_v_bmp = (ipep_valid_pipes == 9) ? 0x1 : 0x2;
            base_type = ((sinfo->offset) >> 23) & 0x7;
            /* Base type is IP EP */
            if (base_type == 2 || base_type == 3) {
                num_item = 8;
                inst_v_bmp = (ipep_valid_pipes == 9) ? 0xC3 : 0x3C;
            }
...
static int
bcm56880_a0_ser_cmicx_schan_opcode_get(int unit, int cmd, int blk_num,
...
static int
bcm56880_a0_ser_hwmem_base_info_get(int unit, int membase, int stage_id,
                                    char **bd_bb_name, char **bb_name, bool *mem)
{
    int base_num = COUNTOF(bcm56880_a0_ser_hwmem_base_info), i = 0;
    bcmptm_ser_buffer_bus_info_t *hwmem_info = bcm56880_a0_ser_hwmem_base_info;
...
static int
bcm56880_a0_ser_hw_info_remap(int unit, uint32_t address, int blk_type,
                              uint32_t membase, uint32_t instruction,
                              uint32_t *address_mapped, int *non_sbus)
{
    uint32_t address_map[][4] = {
        { 0x28000000, 0x28280000, 0x3FFF0000, BLKTYPE_PORT_IF }, /* EDB_XMIT_START_COUNT */

        { 0x010d0000, 0x01040000, 0xFFF0000, BLKTYPE_IPIPE }, /* L3_DEFIP_ALPM_LEVEL2_B0m_OFFSET */
        { 0x011a0000, 0x01110000, 0xFFF0000, BLKTYPE_IPIPE }, /* L3_DEFIP_ALPM_LEVEL2_B1m_OFFSET */
        { 0x01070000, 0x00fe0000, 0xFFF0000, BLKTYPE_IPIPE }, /* L3_DEFIP_ALPM_LEVEL2_B2m_OFFSET */
        { 0x00f70000, 0x01180000, 0xFFF0000, BLKTYPE_IPIPE }, /* L3_DEFIP_ALPM_LEVEL2_B3m_OFFSET */
        { 0x01140000, 0x01000000, 0xFFF0000, BLKTYPE_IPIPE }, /* L3_DEFIP_ALPM_LEVEL2_B4m_OFFSET */
        { 0x010b0000, 0x00fc0000, 0xFFF0000, BLKTYPE_IPIPE }, /* L3_DEFIP_ALPM_LEVEL2_B5m_OFFSET */

        { 0x00f30000, 0x20f00000, 0x3FFF0000, BLKTYPE_IPIPE }, /* L3_DEFIP_ALPM_LEVEL3_B0m_OFFSET */
        { 0x00f80000, 0x21050000, 0x3FFF0000, BLKTYPE_IPIPE }, /* L3_DEFIP_ALPM_LEVEL3_B1m_OFFSET */
        { 0x010a0000, 0x21120000, 0x3FFF0000, BLKTYPE_IPIPE }, /* L3_DEFIP_ALPM_LEVEL3_B2m_OFFSET */
        { 0x00f40000, 0x21100000, 0x3FFF0000, BLKTYPE_IPIPE }, /* L3_DEFIP_ALPM_LEVEL3_B3m_OFFSET */
        { 0x010f0000, 0x21170000, 0x3FFF0000, BLKTYPE_IPIPE }, /* L3_DEFIP_ALPM_LEVEL3_B4m_OFFSET */
        { 0x011b0000, 0x20fa0000, 0x3FFF0000, BLKTYPE_IPIPE }, /* L3_DEFIP_ALPM_LEVEL3_B5m_OFFSET */
        { 0x01010000, 0x21150000, 0x3FFF0000, BLKTYPE_IPIPE }, /* L3_DEFIP_ALPM_LEVEL3_B6m_OFFSET */
        { 0x010c0000, 0x21130000, 0x3FFF0000, BLKTYPE_IPIPE }  /* L3_DEFIP_ALPM_LEVEL3_B7m_OFFSET */
    };
...
static int
bcm56880_a0_ser_mmu_phy2log_mem_remap(int unit, bcmptm_ser_correct_info_t *spci)
{
...
static int
bcm56880_a0_ser_mmu_mem_remap(int unit, bcmptm_ser_correct_info_t *spci,
                              uint32_t adext, int blk_inst)
{
    return bcm56880_a0_ser_mmu_phy2log_mem_remap(unit, spci);
}


static int
bcm56880_a0_ser_ip_ep_sram_remap(int unit, bcmptm_ser_correct_info_t *spci )
{
...
static int
bcm56880_a0_ser_tcam_remap(int unit, bcmdrd_sid_t tcam_sid,
...
static int
bcm56880_a0_ser_tcam_sticky_bit_clr_get(int unit, bcmdrd_sid_t tcam_sid,
                                        bcmdrd_sid_t *ctrl_sid,
                                        bcmdrd_fid_t *ctrl_fid)
{
    static uint32_t mem_map_info[][2] = {
        { EDIT_CTRL_TCAM_0_A_ONLYm, EDIT_CTRL_TCAM_0_A_ONLY_SER_CONTROLr },
        { EDIT_CTRL_TCAM_0_B_ONLYm, EDIT_CTRL_TCAM_0_B_ONLY_SER_CONTROLr },
        { EDIT_CTRL_TCAM_0_C_ONLYm, EDIT_CTRL_TCAM_0_C_ONLY_SER_CONTROLr },
        { EDIT_CTRL_TCAM_1_A_ONLYm, EDIT_CTRL_TCAM_1_A_ONLY_SER_CONTROLr },
        { EDIT_CTRL_TCAM_1_B_ONLYm, EDIT_CTRL_TCAM_1_B_ONLY_SER_CONTROLr },
        { EDIT_CTRL_TCAM_1_C_ONLYm, EDIT_CTRL_TCAM_1_C_ONLY_SER_CONTROLr },
        { EDIT_CTRL_TCAM_2_A_ONLYm, EDIT_CTRL_TCAM_2_A_ONLY_SER_CONTROLr },
        { EDIT_CTRL_TCAM_2_B_ONLYm, EDIT_CTRL_TCAM_2_B_ONLY_SER_CONTROLr },
        { EDIT_CTRL_TCAM_2_C_ONLYm, EDIT_CTRL_TCAM_2_C_ONLY_SER_CONTROLr },
        { EDIT_CTRL_TCAM_3_A_ONLYm, EDIT_CTRL_TCAM_3_A_ONLY_SER_CONTROLr },
        { EDIT_CTRL_TCAM_3_B_ONLYm, EDIT_CTRL_TCAM_3_B_ONLY_SER_CONTROLr },
        { EDIT_CTRL_TCAM_3_C_ONLYm, EDIT_CTRL_TCAM_3_C_ONLY_SER_CONTROLr },
        { EDIT_CTRL_TCAM_4_A_ONLYm, EDIT_CTRL_TCAM_4_A_ONLY_SER_CONTROLr },
        { EDIT_CTRL_TCAM_4_B_ONLYm, EDIT_CTRL_TCAM_4_B_ONLY_SER_CONTROLr },
        { EDIT_CTRL_TCAM_4_C_ONLYm, EDIT_CTRL_TCAM_4_C_ONLY_SER_CONTROLr },
        { EFTA30_E2T_00_LTS_TCAM_0_ONLYm, EFTA30_E2T_00_LTS_TCAM_0_ONLY_SER_CONTROLr },
        { EFTA30_E2T_00_LTS_TCAM_1_ONLYm, EFTA30_E2T_00_LTS_TCAM_1_ONLY_SER_CONTROLr },
        { EFTA30_T4T_00_LTS_TCAM_0_ONLYm, EFTA30_T4T_00_LTS_TCAM_0_ONLY_SER_CONTROLr },
        { EFTA30_T4T_00_LTS_TCAM_1_ONLYm, EFTA30_T4T_00_LTS_TCAM_1_ONLY_SER_CONTROLr },
        { EFTA30_T4T_00_LTS_TCAM_2_ONLYm, EFTA30_T4T_00_LTS_TCAM_2_ONLY_SER_CONTROLr },
        { EFTA30_T4T_00_LTS_TCAM_3_ONLYm, EFTA30_T4T_00_LTS_TCAM_3_ONLY_SER_CONTROLr },
        ...
        { FLEX_QOS_PHB2_LTS_TCAM_ONLYm, FLEX_QOS_PHB2_LTS_TCAM_ONLY_SER_CONTROLr },
        { FLEX_QOS_PHB_LTS_TCAM_ONLYm, FLEX_QOS_PHB_LTS_TCAM_ONLY_SER_CONTROLr },
        { IFTA100_T4T_00_LTS_TCAM_0_ONLYm, IFTA100_T4T_00_LTS_TCAM_0_ONLY_SER_CONTROLr },
        { IFTA100_T4T_00_LTS_TCAM_1_ONLYm, IFTA100_T4T_00_LTS_TCAM_1_ONLY_SER_CONTROLr },
        { IFTA100_T4T_00_LTS_TCAM_2_ONLYm, IFTA100_T4T_00_LTS_TCAM_2_ONLY_SER_CONTROLr },
        { IFTA100_T4T_00_LTS_TCAM_3_ONLYm, IFTA100_T4T_00_LTS_TCAM_3_ONLY_SER_CONTROLr },
        { IFTA100_T4T_01_LTS_TCAM_0_ONLYm, IFTA100_T4T_01_LTS_TCAM_0_ONLY_SER_CONTROLr },
        { IFTA100_T4T_01_LTS_TCAM_1_ONLYm, IFTA100_T4T_01_LTS_TCAM_1_ONLY_SER_CONTROLr },
        { IFTA100_T4T_01_LTS_TCAM_2_ONLYm, IFTA100_T4T_01_LTS_TCAM_2_ONLY_SER_CONTROLr },
        { IFTA100_T4T_01_LTS_TCAM_3_ONLYm, IFTA100_T4T_01_LTS_TCAM_3_ONLY_SER_CONTROLr },
        { IFTA100_T4T_02_LTS_TCAM_0_ONLYm, IFTA100_T4T_02_LTS_TCAM_0_ONLY_SER_CONTROLr },
        { IFTA100_T4T_02_LTS_TCAM_1_ONLYm, IFTA100_T4T_02_LTS_TCAM_1_ONLY_SER_CONTROLr },
        { IFTA100_T4T_02_LTS_TCAM_2_ONLYm, IFTA100_T4T_02_LTS_TCAM_2_ONLY_SER_CONTROLr },
        { IFTA100_T4T_02_LTS_TCAM_3_ONLYm, IFTA100_T4T_02_LTS_TCAM_3_ONLY_SER_CONTROLr },
        { IFTA150_T4T_00_LTS_TCAM_0_ONLYm, IFTA150_T4T_00_LTS_TCAM_0_ONLY_SER_CONTROLr },
        { IFTA150_T4T_00_LTS_TCAM_1_ONLYm, IFTA150_T4T_00_LTS_TCAM_1_ONLY_SER_CONTROLr },
        { IFTA150_T4T_00_LTS_TCAM_2_ONLYm, IFTA150_T4T_00_LTS_TCAM_2_ONLY_SER_CONTROLr },
        { IFTA150_T4T_00_LTS_TCAM_3_ONLYm, IFTA150_T4T_00_LTS_TCAM_3_ONLY_SER_CONTROLr },
        { IFTA30_E2T_00_LTS_TCAM_0_ONLYm, IFTA30_E2T_00_LTS_TCAM_0_ONLY_SER_CONTROLr },
        { IFTA30_E2T_00_LTS_TCAM_1_ONLYm, IFTA30_E2T_00_LTS_TCAM_1_ONLY_SER_CONTROLr },
        { IFTA40_E2T_00_LTS_TCAM_0_ONLYm, IFTA40_E2T_00_LTS_TCAM_0_ONLY_SER_CONTROLr },
        { IFTA40_E2T_00_LTS_TCAM_1_ONLYm, IFTA40_E2T_00_LTS_TCAM_1_ONLY_SER_CONTROLr },
        { IFTA40_E2T_01_LTS_TCAM_0_ONLYm, IFTA40_E2T_01_LTS_TCAM_0_ONLY_SER_CONTROLr },
        { IFTA40_E2T_01_LTS_TCAM_1_ONLYm, IFTA40_E2T_01_LTS_TCAM_1_ONLY_SER_CONTROLr },
        { IFTA40_T4T_00_LTS_TCAM_0_ONLYm, IFTA40_T4T_00_LTS_TCAM_0_ONLY_SER_CONTROLr },
        { IFTA40_T4T_00_LTS_TCAM_1_ONLYm, IFTA40_T4T_00_LTS_TCAM_1_ONLY_SER_CONTROLr },
        { IFTA40_T4T_00_LTS_TCAM_2_ONLYm, IFTA40_T4T_00_LTS_TCAM_2_ONLY_SER_CONTROLr },
        { IFTA40_T4T_00_LTS_TCAM_3_ONLYm, IFTA40_T4T_00_LTS_TCAM_3_ONLY_SER_CONTROLr },
        { IFTA40_T4T_01_LTS_TCAM_0_ONLYm, IFTA40_T4T_01_LTS_TCAM_0_ONLY_SER_CONTROLr },
        { IFTA40_T4T_01_LTS_TCAM_1_ONLYm, IFTA40_T4T_01_LTS_TCAM_1_ONLY_SER_CONTROLr },
        { IFTA40_T4T_01_LTS_TCAM_2_ONLYm, IFTA40_T4T_01_LTS_TCAM_2_ONLY_SER_CONTROLr },
        { IFTA40_T4T_01_LTS_TCAM_3_ONLYm, IFTA40_T4T_01_LTS_TCAM_3_ONLY_SER_CONTROLr },
        { IFTA50_T4T_00_LTS_TCAM_0_ONLYm, IFTA50_T4T_00_LTS_TCAM_0_ONLY_SER_CONTROLr },
        { IFTA50_T4T_00_LTS_TCAM_1_ONLYm, IFTA50_T4T_00_LTS_TCAM_1_ONLY_SER_CONTROLr },
        { IFTA50_T4T_00_LTS_TCAM_2_ONLYm, IFTA50_T4T_00_LTS_TCAM_2_ONLY_SER_CONTROLr },
        { IFTA50_T4T_00_LTS_TCAM_3_ONLYm, IFTA50_T4T_00_LTS_TCAM_3_ONLY_SER_CONTROLr },
        { IFTA80_E2T_00_LTS_TCAM_0_ONLYm, IFTA80_E2T_00_LTS_TCAM_0_ONLY_SER_CONTROLr },
        { IFTA80_E2T_00_LTS_TCAM_1_ONLYm, IFTA80_E2T_00_LTS_TCAM_1_ONLY_SER_CONTROLr },
        { IFTA80_E2T_01_LTS_TCAM_0_ONLYm, IFTA80_E2T_01_LTS_TCAM_0_ONLY_SER_CONTROLr },
        { IFTA80_E2T_01_LTS_TCAM_1_ONLYm, IFTA80_E2T_01_LTS_TCAM_1_ONLY_SER_CONTROLr },
        { IFTA80_E2T_02_LTS_TCAM_0_ONLYm, IFTA80_E2T_02_LTS_TCAM_0_ONLY_SER_CONTROLr },
        { IFTA80_E2T_02_LTS_TCAM_1_ONLYm, IFTA80_E2T_02_LTS_TCAM_1_ONLY_SER_CONTROLr },
        { IFTA80_E2T_03_LTS_TCAM_0_ONLYm, IFTA80_E2T_03_LTS_TCAM_0_ONLY_SER_CONTROLr },
        { IFTA80_E2T_03_LTS_TCAM_1_ONLYm, IFTA80_E2T_03_LTS_TCAM_1_ONLY_SER_CONTROLr },
        { IFTA80_T2T_00_LTS_TCAM_0_ONLYm, IFTA80_T2T_00_LTS_TCAM_0_ONLY_SER_CONTROLr },
        { IFTA80_T2T_00_LTS_TCAM_1_ONLYm, IFTA80_T2T_00_LTS_TCAM_1_ONLY_SER_CONTROLr },
        { IFTA80_T2T_01_LTS_TCAM_0_ONLYm, IFTA80_T2T_01_LTS_TCAM_0_ONLY_SER_CONTROLr },
        { IFTA80_T2T_01_LTS_TCAM_1_ONLYm, IFTA80_T2T_01_LTS_TCAM_1_ONLY_SER_CONTROLr },
        { IFTA90_E2T_00_LTS_TCAM_0_ONLYm, IFTA90_E2T_00_LTS_TCAM_0_ONLY_SER_CONTROLr },
        { IFTA90_E2T_00_LTS_TCAM_1_ONLYm, IFTA90_E2T_00_LTS_TCAM_1_ONLY_SER_CONTROLr },
        { IFTA90_E2T_01_LTS_TCAM_0_ONLYm, IFTA90_E2T_01_LTS_TCAM_0_ONLY_SER_CONTROLr },
        { IFTA90_E2T_01_LTS_TCAM_1_ONLYm, IFTA90_E2T_01_LTS_TCAM_1_ONLY_SER_CONTROLr },
        { IFTA90_E2T_02_LTS_TCAM_0_ONLYm, IFTA90_E2T_02_LTS_TCAM_0_ONLY_SER_CONTROLr },
        { IFTA90_E2T_02_LTS_TCAM_1_ONLYm, IFTA90_E2T_02_LTS_TCAM_1_ONLY_SER_CONTROLr },
        { IFTA90_E2T_03_LTS_TCAM_0_ONLYm, IFTA90_E2T_03_LTS_TCAM_0_ONLY_SER_CONTROLr },
        { IFTA90_E2T_03_LTS_TCAM_1_ONLYm, IFTA90_E2T_03_LTS_TCAM_1_ONLY_SER_CONTROLr },
        { IPARSER0_HME_STAGE0_TCAM_ONLYm, IPARSER0_HME_STAGE0_TCAM_ONLY_SER_CONTROLr },
        { IPARSER1_HME_STAGE0_TCAM_ONLYm, IPARSER1_HME_STAGE0_TCAM_ONLY_SER_CONTROLr },
        { IPARSER1_HME_STAGE1_TCAM_ONLYm, IPARSER1_HME_STAGE1_TCAM_ONLY_SER_CONTROLr },
        { IPARSER1_HME_STAGE2_TCAM_ONLYm, IPARSER1_HME_STAGE2_TCAM_ONLY_SER_CONTROLr },
        { IPARSER1_HME_STAGE3_TCAM_ONLYm, IPARSER1_HME_STAGE3_TCAM_ONLY_SER_CONTROLr },
        { IPARSER1_HME_STAGE4_TCAM_ONLYm, IPARSER1_HME_STAGE4_TCAM_ONLY_SER_CONTROLr },
        { IPARSER1_HME_STAGE5_TCAM_ONLYm, IPARSER1_HME_STAGE5_TCAM_ONLY_SER_CONTROLr },
        { IPARSER2_HME_STAGE0_TCAM_ONLYm, IPARSER2_HME_STAGE0_TCAM_ONLY_SER_CONTROLr },
        { IPARSER2_HME_STAGE1_TCAM_ONLYm, IPARSER2_HME_STAGE1_TCAM_ONLY_SER_CONTROLr },
        { IPARSER2_HME_STAGE2_TCAM_ONLYm, IPARSER2_HME_STAGE2_TCAM_ONLY_SER_CONTROLr },
        { IPARSER2_HME_STAGE3_TCAM_ONLYm, IPARSER2_HME_STAGE3_TCAM_ONLY_SER_CONTROLr },
        { IPARSER2_HME_STAGE4_TCAM_ONLYm, IPARSER2_HME_STAGE4_TCAM_ONLY_SER_CONTROLr },
        ...
        { MEMDB_IFTA100_MEM10_0_ONLYm, MEMDB_IFTA100_MEM10_0_ONLY_SER_CONTROLr },
        { MEMDB_IFTA100_MEM10_1_ONLYm, MEMDB_IFTA100_MEM10_0_ONLY_SER_CONTROLr },
        { MEMDB_IFTA100_MEM10_2_ONLYm, MEMDB_IFTA100_MEM10_0_ONLY_SER_CONTROLr },
        { MEMDB_IFTA100_MEM10_3_ONLYm, MEMDB_IFTA100_MEM10_0_ONLY_SER_CONTROLr },
        { MEMDB_IFTA100_MEM11_0_ONLYm, MEMDB_IFTA100_MEM11_0_ONLY_SER_CONTROLr },
        { MEMDB_IFTA100_MEM11_1_ONLYm, MEMDB_IFTA100_MEM11_0_ONLY_SER_CONTROLr },
        { MEMDB_IFTA100_MEM11_2_ONLYm, MEMDB_IFTA100_MEM11_0_ONLY_SER_CONTROLr },
        { MEMDB_IFTA100_MEM11_3_ONLYm, MEMDB_IFTA100_MEM11_0_ONLY_SER_CONTROLr },
        ...
        { MEMDB_IFTA100_MEM4_0_ONLYm, MEMDB_IFTA100_MEM4_0_ONLY_SER_CONTROLr },
        { MEMDB_IFTA100_MEM4_1_ONLYm, MEMDB_IFTA100_MEM4_0_ONLY_SER_CONTROLr },
        { MEMDB_IFTA100_MEM4_2_ONLYm, MEMDB_IFTA100_MEM4_0_ONLY_SER_CONTROLr },
        { MEMDB_IFTA100_MEM4_3_ONLYm, MEMDB_IFTA100_MEM4_0_ONLY_SER_CONTROLr },
        { MEMDB_IFTA100_MEM5_0_ONLYm, MEMDB_IFTA100_MEM5_0_ONLY_SER_CONTROLr },
        { MEMDB_IFTA100_MEM5_1_ONLYm, MEMDB_IFTA100_MEM5_0_ONLY_SER_CONTROLr },
        { MEMDB_IFTA100_MEM5_2_ONLYm, MEMDB_IFTA100_MEM5_0_ONLY_SER_CONTROLr },
        { MEMDB_IFTA100_MEM5_3_ONLYm, MEMDB_IFTA100_MEM5_0_ONLY_SER_CONTROLr },
        { MEMDB_IFTA100_MEM6_0_ONLYm, MEMDB_IFTA100_MEM6_0_ONLY_SER_CONTROLr },
        { MEMDB_IFTA100_MEM6_1_ONLYm, MEMDB_IFTA100_MEM6_0_ONLY_SER_CONTROLr },
        { MEMDB_IFTA100_MEM6_2_ONLYm, MEMDB_IFTA100_MEM6_0_ONLY_SER_CONTROLr },
        { MEMDB_IFTA100_MEM6_3_ONLYm, MEMDB_IFTA100_MEM6_0_ONLY_SER_CONTROLr },
        { MEMDB_IFTA100_MEM7_0_ONLYm, MEMDB_IFTA100_MEM7_0_ONLY_SER_CONTROLr },
        { MEMDB_IFTA100_MEM7_1_ONLYm, MEMDB_IFTA100_MEM7_0_ONLY_SER_CONTROLr },
        { MEMDB_IFTA100_MEM7_2_ONLYm, MEMDB_IFTA100_MEM7_0_ONLY_SER_CONTROLr },
        { MEMDB_IFTA100_MEM7_3_ONLYm, MEMDB_IFTA100_MEM7_0_ONLY_SER_CONTROLr },
        { MEMDB_IFTA100_MEM8_0_ONLYm, MEMDB_IFTA100_MEM8_0_ONLY_SER_CONTROLr },
        { MEMDB_IFTA100_MEM8_1_ONLYm, MEMDB_IFTA100_MEM8_0_ONLY_SER_CONTROLr },
        { MEMDB_IFTA100_MEM8_2_ONLYm, MEMDB_IFTA100_MEM8_0_ONLY_SER_CONTROLr },
        { MEMDB_IFTA100_MEM8_3_ONLYm, MEMDB_IFTA100_MEM8_0_ONLY_SER_CONTROLr },
        { MEMDB_IFTA100_MEM9_0_ONLYm, MEMDB_IFTA100_MEM9_0_ONLY_SER_CONTROLr },
        { MEMDB_IFTA100_MEM9_1_ONLYm, MEMDB_IFTA100_MEM9_0_ONLY_SER_CONTROLr },
        { MEMDB_IFTA100_MEM9_2_ONLYm, MEMDB_IFTA100_MEM9_0_ONLY_SER_CONTROLr },
        { MEMDB_IFTA100_MEM9_3_ONLYm, MEMDB_IFTA100_MEM9_0_ONLY_SER_CONTROLr },
        ...
        { MEMDB_TCAM_IFTA50_MEM0_0_ONLYm, MEMDB_TCAM_IFTA50_MEM0_0_ONLY_SER_CONTROLr },
        { MEMDB_TCAM_IFTA50_MEM0_1_ONLYm, MEMDB_TCAM_IFTA50_MEM0_0_ONLY_SER_CONTROLr },
        { MEMDB_TCAM_IFTA50_MEM0_2_ONLYm, MEMDB_TCAM_IFTA50_MEM0_0_ONLY_SER_CONTROLr },
        { MEMDB_TCAM_IFTA50_MEM0_3_ONLYm, MEMDB_TCAM_IFTA50_MEM0_0_ONLY_SER_CONTROLr },
...
static int
bcm56880_a0_ser_mem_ecc_info_get(int unit, bcmdrd_sid_t sid_fv, int index_fv,
                                 bcmdrd_sid_t *sid, int *index, int *ecc_checking)
{
    uint32_t mem_map_info[][3] = {
        ...
        { IFTA90_E2T_02_B0_SINGLEm,  IFTA90_E2T_02_B0_ECCm, 1 }, /* 1 : 1 */
        { IFTA90_E2T_02_B0_DOUBLEm,  IFTA90_E2T_02_B0_ECCm, 2 }, /* 1 : 2 */
        { IFTA90_E2T_02_B0_QUADm,    IFTA90_E2T_02_B0_ECCm, 4 }, /* 1 : 4 */
        { IFTA90_E2T_02_B1_SINGLEm,  IFTA90_E2T_02_B1_ECCm, 1 }, /* 1 : 1 */
        { IFTA90_E2T_02_B1_DOUBLEm,  IFTA90_E2T_02_B1_ECCm, 2 }, /* 1 : 2 */
        { IFTA90_E2T_02_B1_QUADm,    IFTA90_E2T_02_B1_ECCm, 4 }, /* 1 : 4 */

        { IFTA90_E2T_03_B0_SINGLEm,  IFTA90_E2T_03_B0_ECCm, 1 }, /* 1 : 1 */
        { IFTA90_E2T_03_B0_DOUBLEm,  IFTA90_E2T_03_B0_ECCm, 2 }, /* 1 : 2 */
        { IFTA90_E2T_03_B0_QUADm,    IFTA90_E2T_03_B0_ECCm, 4 }, /* 1 : 4 */
        { IFTA90_E2T_03_B1_SINGLEm,  IFTA90_E2T_03_B1_ECCm, 1 }, /* 1 : 1 */
        { IFTA90_E2T_03_B1_DOUBLEm,  IFTA90_E2T_03_B1_ECCm, 2 }, /* 1 : 2 */
        { IFTA90_E2T_03_B1_QUADm,    IFTA90_E2T_03_B1_ECCm, 4 }, /* 1 : 4 */
    ...
    (void)bcm56880_a0_ser_tcam_remap(unit, sid_fv, &sid_tcam_only,
...
static int
bcm56880_a0_ser_refresh_regs_info_get(int unit,
                                      bcmptm_ser_ctrl_reg_info_t **mem_refresh_info,
                                      uint32_t *info_num)
{
    *mem_refresh_info = bcm56880_a0_clear_refresh_registers;
    *info_num = COUNTOF(bcm56880_a0_clear_refresh_registers);

    return SHR_E_NONE;
}

static int
bcm56880_a0_ser_ecc_status_translate(int unit,
                                     ...
                                     uint32_t *sid_num)
{
    ...
    *sid_num = 0;
    ...
    if (found) {
        *corrected_sids = &bcm56880_a0_idb_obm_mem_list[idx];
        *index = spci->index[0];
        *sid_num = 1;
    }
    return SHR_E_NONE;
...
static int
bcm56880_a0_ser_mem_xor_info_get(int unit, bcmdrd_sid_t sid, uint32_t index,
                                 bcmptm_ser_sram_info_t *sram_info)
{
    ...
    uint32_t xor_sram_info[][3] = {
        ...
        { IFTA90_E2T_02_B0_ECCm, 8192, 8 },
        { IFTA90_E2T_02_B1_ECCm, 8192, 8 },
        { IFTA90_E2T_03_B0_ECCm, 8192, 8 },
        { IFTA90_E2T_03_B1_ECCm, 8192, 8 },
...
static int
bcm56880_a0_ser_sram_ctrl_register_get(int unit, bcmdrd_sid_t sid, uint32_t index,
                                       bcmptm_ser_control_reg_info_t *sram_ctrl_reg_info)
{
    ...
    uint32_t xor_write_reg_map[][3] = {
        ...
        { IFTA90_E2T_02_B0_ECCm, IFTA90_E2T_02_SHARED_BANKS_CONTROLm, DISABLE_XOR_WRITEf },
        { IFTA90_E2T_02_B1_ECCm, IFTA90_E2T_02_SHARED_BANKS_CONTROLm, DISABLE_XOR_WRITEf },
        { IFTA90_E2T_03_B0_ECCm, IFTA90_E2T_03_SHARED_BANKS_CONTROLm, DISABLE_XOR_WRITEf },
        { IFTA90_E2T_03_B1_ECCm, IFTA90_E2T_03_SHARED_BANKS_CONTROLm, DISABLE_XOR_WRITEf },
        ...
        { L3_DEFIP_ALPM_LEVEL3_B2_ECCm, IFTA90_E2T_01_SHARED_BANKS_CONTROLm, DISABLE_XOR_WRITEf },
        { L3_DEFIP_ALPM_LEVEL3_B3_ECCm, IFTA90_E2T_01_SHARED_BANKS_CONTROLm, DISABLE_XOR_WRITEf },
        { L3_DEFIP_ALPM_LEVEL3_B4_ECCm, IFTA90_E2T_02_SHARED_BANKS_CONTROLm, DISABLE_XOR_WRITEf },
        { L3_DEFIP_ALPM_LEVEL3_B5_ECCm, IFTA90_E2T_02_SHARED_BANKS_CONTROLm, DISABLE_XOR_WRITEf },
        { L3_DEFIP_ALPM_LEVEL3_B6_ECCm, IFTA90_E2T_03_SHARED_BANKS_CONTROLm, DISABLE_XOR_WRITEf },
        { L3_DEFIP_ALPM_LEVEL3_B7_ECCm, IFTA90_E2T_03_SHARED_BANKS_CONTROLm, DISABLE_XOR_WRITEf },
    };
    ...
    (void)bcm56880_a0_ser_mem_ecc_info_get(unit, sid, index, &sid_ecc, &index_ecc, NULL);
...
static int
bcm56880_a0_ser_sram_scan_mem_skip(int unit, bcmdrd_sid_t sid, bool *skip)
{
    ...
    (void)bcm56880_a0_ser_mem_ecc_info_get(unit, sid, 0, &sid_ecc,
                                           &index_ecc, NULL);
    /* scan ECC view */
    if (sid != sid_ecc) {
        *skip = TRUE;
...
static int
bcm56880_a0_num_bit_interleave_get(int unit, bcmdrd_sid_t sid,
...
static int
bcm56880_a0_ser_status_field_parse(int unit, bcmdrd_sid_t sid,
...
static int
bcm56880_a0_ser_expected_value_get(int unit, bcmdrd_sid_t sid,
...
static int
bcm56880_a0_ser_force_error_value_get(int unit, bcmdrd_sid_t sid,
                                      bcmdrd_fid_t fid, uint32_t *value)
{
...
static const bcmptm_ser_data_driver_t bcm56880_a0_data_driver = {

    .mem_clr_list_get = bcm56880_a0_ser_mem_clr_list_get,

    .clear_mem_after_ser_enable = bcm56880_a0_ser_clear_mem_after_ser_enable,

    .clear_mem_before_ser_enable = bcm56880_a0_ser_clear_mem_before_ser_enable,

    .tcam_ser_hw_scan_reg_info_get = bcm56880_a0_ser_tcam_hw_scan_ctrl_info_get,

    .acc_type_map_info_get = NULL,

    .tcam_cmic_ser_info_get = NULL,

    .mute_mem_list_get = bcm56880_a0_ser_mem_mute_list_get,

    .mute_ctrl_reg_list_get = bcm56880_a0_ser_drop_ptk_ctrl_reg_mute_list_get,

    .blk_ctrl_regs_get = bcm56880_a0_ser_blk_ctrl_get,

    .intr_map_get = bcm56880_a0_ser_intr_map_get,

    .blk_type_map = bcm56880_a0_ser_blk_type_map,

    .ser_intr_enable = bcm56880_a0_ser_lp_intr_enable,

    .intr_cb_func_set = bcm56880_a0_ser_lp_intr_func_set,
    ...
    .cmic_adext_get = bcm56880_a0_ser_cmicx_adext_get,

    .pt_acctype_get = bcm56880_a0_ser_acc_type_get,

    .pt_inst_remap = bcm56880_a0_ser_pt_inst_remap,

    .cmic_schan_opcode_get = bcm56880_a0_ser_cmicx_schan_opcode_get,

    .hwmem_base_info_get = bcm56880_a0_ser_hwmem_base_info_get,

    .ip_ep_hw_info_remap = bcm56880_a0_ser_hw_info_remap,

    .mmu_mem_remap = bcm56880_a0_ser_mmu_mem_remap,

    .ip_ep_mem_remap = bcm56880_a0_ser_ip_ep_sram_remap,

    .data_split_mem_test_fid_get = NULL,

    .mem_ecc_info_get = bcm56880_a0_ser_mem_ecc_info_get,

    .tcam_remap = bcm56880_a0_ser_tcam_remap,

    .tcam_sticky_bit_clr_get = bcm56880_a0_ser_tcam_sticky_bit_clr_get,

    .refresh_regs_info_get = bcm56880_a0_ser_refresh_regs_info_get,

    .ser_status_reg_translate = bcm56880_a0_ser_ecc_status_translate,

    .sram_ctrl_reg_get = bcm56880_a0_ser_sram_ctrl_register_get,

    .xor_lp_mem_info_get = bcm56880_a0_ser_mem_xor_info_get,

    .sram_scan_mem_skip = bcm56880_a0_ser_sram_scan_mem_skip,

    .copy_to_cpu_regs_info_get = NULL,

    .num_bit_interleave_get = bcm56880_a0_num_bit_interleave_get,

    .ser_status_field_parse = bcm56880_a0_ser_status_field_parse,

    .expected_value_get = bcm56880_a0_ser_expected_value_get,

    .force_error_value_get = bcm56880_a0_ser_force_error_value_get,
...
{
    return &bcm56880_a0_data_driver;
}
