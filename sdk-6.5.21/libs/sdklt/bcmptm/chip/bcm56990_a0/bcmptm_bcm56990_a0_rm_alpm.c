...
static void
bcm56990_l1_lpm_vt_decode(int u, int sub_prio, alpm_arg_t *arg)
{
...
static void
bcm56990_l1_lpm_wvrf_decode(int u, int sub_prio, int vrf,
                              ...
                              uint32_t *entry)
{
    int rv;
    if (format_type == FORMAT_ROUTE) {
        rv = bcm56990_ln_route_format_encode(u, format_value, kshift, arg, entry);
    } else {
        rv = bcm56990_ln_pivot_format_encode(u, format_value, kshift, arg, entry);
    }
    return rv;
}
...
bcm56990_l1_fmt0_narrow_lpm_decode_n1(int u, alpm_arg_t *arg, UNPAIR0_T *de)
{
    ...
    bcm56990_l1_lpm_vt_decode(u, sub_prio, arg);
    ...
    bcm56990_l1_lpm_wvrf_decode(u, sub_prio, vrf, vrf_mask, arg);
