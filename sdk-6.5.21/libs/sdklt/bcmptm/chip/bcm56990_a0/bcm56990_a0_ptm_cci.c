/*! \file bcm56990_a0_ptm_cci.c
 *
 * This file contains the misc utils for bcm56990_a0's CCI
 */
/*
...
int
bcm56990_a0_pt_cci_ctrtype_get(int unit,
                               bcmdrd_sid_t sid)
{
    int rv = SHR_E_NONE;
    int blktype;
...
bool
bcm56990_a0_pt_cci_ctr_is_bypass(int unit, bcmdrd_sid_t sid)
{
    int blktype;
    bool rv = false;
...
int
bcm56990_a0_pt_cci_frmt_index_from_port(int unit, bcmdrd_sid_t sid, int port,
...
int
bcm56990_a0_pt_cci_ctr_sym_map(int unit,
                               bcmptm_cci_ctr_info_t *ctr_info)
{
    ...
    do {
        ...
        rv = bcm56990_a0_pt_cci_frmt_index_from_port(unit, ctr_info->sid,
...
int
bcm56990_a0_pt_cci_frmt_sym_get(int unit, int index, int field,
...
bool
bcm56990_a0_pt_cci_index_valid(int unit, bcmdrd_sid_t sid, int tbl_inst, int index)
{
    bool rv;
...
uint32_t
bcm56990_a0_pt_cci_reg_addr_gap_get(int unit, bcmdrd_sid_t sid)
{
    int blktype;
    ...
    if (blktype == BLKTYPE_XLPORT) {
        if (bcmdrd_feature_enabled(unit, BCMDRD_FT_EMUL)) {
            /* In emulator, XLPORT block takes sbus v6 */
            gap = 10;
        } else {
            /* sbus v4 */
            gap = 8;
...
int
bcm56990_a0_pt_cci_ctr_evict_control_get(int unit, bcmdrd_sid_t sid,
                                    bcmdrd_sid_t *ctrl_sid)
{
    SHR_FUNC_ENTER(unit);
...
int
bcm56990_a0_pt_cci_ctr_evict_enable_field_get(int unit,
                                              bcmdrd_fid_t *fid)
{
    SHR_FUNC_ENTER(unit);
...
int
bcm56990_a0_pt_cci_ctr_evict_clr_on_read_field_get(int unit,
                                                   bcmdrd_fid_t *fid)
{
    SHR_FUNC_ENTER(unit);
...
int
bcm56990_a0_pt_cci_ctr_evict_default_enable_list_get(int unit,
                                                     size_t *size,
                                                     bcmdrd_sid_t *sid)
{
    SHR_FUNC_ENTER(unit);
...
int
bcm56990_a0_pt_cci_fifodma_chan_get(int unit)
{
    return MEM_FIFO_DMA_CHANNEL_0;
}

int
bcm56990_a0_pt_cci_ctr_evict_fifo_sym_get(int unit, bcmdrd_sid_t *sid)
{
    SHR_FUNC_ENTER(unit);
...
int
bcm56990_a0_pt_cci_ctr_evict_fifo_entry_get(int unit,
                                            uint32_t *evict,
                                            uint32_t *pool,
...
uint32_t
bcm56990_a0_pt_cci_ctr_evict_fifo_buf_size_get(int unit)
{
    return CTR_EVICT_ENTRY_NUM;
}

int
bcm56990_a0_pt_cci_ctr_evict_field_num_get(int unit,
...
int
bcm56990_a0_pt_cci_ctr_evict_field_width_get(int unit,
                                             bcmptm_cci_ctr_mode_t ctr_mode,
                                             size_t *width)
{
    int rv = SHR_E_NONE;
...
int
bcm56990_a0_pt_cci_ctr_evict_normal_val_get(int unit,
                                            size_t fld_width,
                                            uint32_t *entry,
                                            size_t size_e,
                                            uint64_t *ctr,
...
int
bcm56990_a0_pt_cci_ctr_evict_wide_val_get(int unit,
                                          size_t fld_width,
                                          uint32_t *entry,
                                          size_t size_e,
                                          uint64_t *ctr,
...
int
bcm56990_a0_pt_cci_ctr_evict_slim_val_get(int unit,
                                          size_t fld_width,
                                          uint32_t *entry,
                                          size_t size_e,
                                          uint32_t *ctr,
...
int
bcm56990_a0_pt_cci_ctr_evict_fifo_enable_sym_get(int unit,
                                                 bcmdrd_sid_t *sid,
                                                 bcmdrd_fid_t *fid)
{
    SHR_FUNC_ENTER(unit);
...
int
bcm56990_a0_pt_cci_ctr_evict_update_mode_num_get(int unit,
                                                 size_t *num)
{
    SHR_FUNC_ENTER(unit);
...
void
bcm56990_a0_pt_cci_ctr_direct_access(int unit,
                                     bcmptm_cci_ctr_info_t *ctr_info)
{
...
int
bcm56990_a0_pt_cci_ctr_ing_pfc_field_val_get(int unit,
