...
bcmptm_bcm56990_a0_fnptr_attach(int unit, fn_ptr_all_t *fn_ptr_all)
{
    ...
    fn_ptr_all->fn_pt_rm_tcam_update_flex_ctr_action =
            &bcm56990_a0_rm_tcam_update_flex_ctr_action;
    fn_ptr_all->fn_pt_rm_tcam_ser_corr_sid_info_get =
            &bcm56990_a0_rm_tcam_ser_corr_sid_info_get;
    /* CCI */
    ...
    fn_ptr_all->fn_pt_cci_ctr_direct_access =
            &bcm56990_a0_pt_cci_ctr_direct_access;
    fn_ptr_all->fn_pt_cci_ctr_ing_pfc_field_val_get =
            &bcm56990_a0_pt_cci_ctr_ing_pfc_field_val_get;
