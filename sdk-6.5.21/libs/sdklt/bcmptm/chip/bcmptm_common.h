...
typedef int(*fn_pt_rm_tcam_prio_only_hw_key_info_init_t)(int unit,
                            ...
                            void *hw_field_list);
typedef int(*fn_pt_rm_tcam_prio_only_shared_sid_compare_t)(int unit,
                            bcmdrd_sid_t sid,
                            bcmdrd_sid_t shr_sid,
                            uint32_t *neg_shr_flags,
                            bool *compare);
typedef int (*fn_pt_rm_tcam_update_flex_ctr_action_t)(int unit,
                                     bcmptm_rm_tcam_lt_info_t *ltid_info,
                                     uint8_t ctr_action_prof_id,
                                     uint32_t **policy_words);
typedef int (*fn_pt_rm_tcam_ser_corr_sid_info_get_t)(int unit,
                                      bcmdrd_sid_t sid,
...
typedef void (*fn_pt_cci_link_status_data_get_t)(int unit, bcmdrd_sid_t *xlmib_rxsid,
                                        bcmdrd_sid_t *xlmib_txsid, int *rxpkt_fieldnum,
                                        int *txpkt_fieldnum);
typedef void (*fn_pt_cci_link_status_update_t)(int unit, uint32_t index, uint32_t instance,
...
typedef int (*fn_pt_cci_ctr_evict_update_mode_num_get_t)(int unit,
                                                         size_t *num);
typedef void (*fn_pt_cci_ctr_direct_access_t)(int unit,
                                              bcmptm_cci_ctr_info_t *ctr_info);
typedef int (*fn_pt_cci_ctr_ing_pfc_field_val_get_t)(int unit,
...
typedef struct fn_ptr_all_s {
    ...
    fn_pt_cci_ctr_direct_access_t fn_pt_cci_ctr_direct_access;
    fn_pt_cci_ctr_ing_pfc_field_val_get_t fn_pt_cci_ctr_ing_pfc_field_val_get;
    fn_pt_cci_link_status_update_t fn_pt_cci_link_status_update;
    fn_pt_cci_link_status_data_get_t fn_pt_cci_link_status_data_get;
    ...
    fn_pt_rm_tcam_prio_only_shared_sid_compare_t fn_pt_rm_tcam_prio_only_shared_sid_compare;

    /* FP EM */
    fn_pt_dyn_lt_mreq_info_init_t       fn_pt_dyn_lt_mreq_info_init;
    fn_pt_dynamic_lt_validate_t    fn_pt_dynamic_lt_validate;
    fn_pt_rm_tcam_update_flex_ctr_action_t fn_pt_rm_tcam_update_flex_ctr_action;
    fn_pt_rm_tcam_ser_corr_sid_info_get_t fn_pt_rm_tcam_ser_corr_sid_info_get;
