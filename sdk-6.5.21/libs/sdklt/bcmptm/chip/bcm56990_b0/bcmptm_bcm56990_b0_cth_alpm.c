/*! \file bcmptm_bcm56990_b0_cth_alpm.c
 *
...
#define BCM56990_B0_ALPM_L1_BLOCKS     10

/*******************************************************************************
 * Typedefs
 */
typedef struct bcm56990_b0_lpm_ip_control_s {
    int level1_database_sel_block[10];
    int level2_database_sel_block[4];
    int level3_database_sel_block[4];

    int level1_key_input_sel_block[10];
    ...
    int data_sel[4];
    int result_mode;
} bcm56990_b0_lpm_ip_control_t;

typedef struct bcm56990_b0_lpm_lane_control_s {
    uint8_t comp_src_enable;
    uint8_t comp_dst_enable;
    uint8_t l3_src_enable;
    uint8_t l3_dst_enable;
} bcm56990_b0_lpm_lane_control_t;
 ...
 */
static uint8_t
bcm56990_b0_combined_blocks[2][4] = {       /* DB0 */
    {IPDBX, IPDBX, IPDBX, IPDBX},           /*  0  */
    {IPDB0, IPDB0, IPDB0, IPDB0}            /*  1  */
};
static uint8_t
bcm56990_b0_parallel_l2_blocks[4][4] = {    /* DB0 DB1 */
...
static uint8_t
bcm56990_b0_parallel_l3_blocks[4][4] = {    /* DB0 DB1 */
    {IPDBX, IPDBX, IPDBX, IPDBX},           /*  0   0  */
    {IPDB1, IPDB1, IPDB1, IPDB1},           /*  0   1  */
    {IPDB0, IPDB0, IPDB0, IPDB0},           /*  1   0  */
...
static uint8_t
bcm56990_b0_combined_rpf_l2_blocks[4][4] = {/* DB0 DB2 */
    {IPDBX, IPDBX, IPDBX, IPDBX},           /*  0   0  */
...
static uint8_t
bcm56990_b0_combined_rpf_l3_blocks[4][4] = {/* DB0 DB2 */
    {IPDBX, IPDBX, IPDBX, IPDBX},           /*  0   0  */
    {IPDB2, IPDB2, IPDB2, IPDB2},           /*  0   1  */
    {IPDB0, IPDB0, IPDB0, IPDB0},           /*  1   0  */
...
static uint8_t
bcm56990_b0_parallel_rpf_blocks[16][4] = {  /* DB0 DB1 DB2 DB3 */
...
static uint8_t
bcm56990_b0_fp_combined_blocks[8][4] = {    /* DB0 DB2 DB3 */
...
static uint8_t
bcm56990_b0_fp_parallel_blocks[16][4] = {   /* DB0 DB1 DB2 DB3 */
    {IPDBX, IPDBX, IPDBX, IPDBX},           /*  0   0   0   0  */
    {IPDB3, IPDB3, IPDB3, IPDB3},           /*  0   0   0   1  */
    {IPDB2, IPDB2, IPDB2, IPDB2},           /*  0   0   1   0  */
    {IPDB2, IPDB2, IPDB3, IPDB3},           /*  0   0   1   1  */
...
static uint8_t
bcm56990_b0_fp_combined_rpf_blocks[16][4] = {  /* DB0 DB1 DB2 DB3 */
    {IPDBX, IPDBX, IPDBX, IPDBX},              /*  0   0   0   0  */
    {IPDB3, IPDB3, IPDB3, IPDB3},              /*  0   0   0   1  */
    {IPDB2, IPDB2, IPDB2, IPDB2},              /*  0   0   1   0  */
    {IPDB2, IPDB2, IPDB3, IPDB3},              /*  0   0   1   1  */
...
static int
bcm56990_b0_cth_alpm_l1_parse_check(int u, int *l1_key_input, int *l1_db,
                                    int db0_levels,
                                    int db1_levels,
                                    int db2_levels,
                                    int db3_levels,
                                    int *alpm_mode_out, int *alpm_dbs_out)
{
    ...
    for (i = 1; i < BCM56990_B0_ALPM_L1_BLOCKS; i++) {
        ...
        */
        if ((i + 1) < BCM56990_B0_ALPM_L1_BLOCKS && l1_db[i] == l1_db[i + 1]) {
    ...
    for (i = 0; i < BCM56990_B0_ALPM_L1_BLOCKS; i++) {
        if (l1_key_input[i] == KEY_INPUT_LPM_L3MC_Q ||
            l1_key_input[i] == KEY_INPUT_LPM_L3MC_D ||
            l1_key_input[i] == KEY_INPUT_LPM_L3MC_S ||
...
static int
bcm56990_b0_cth_alpm_combined_check_and_set(int u,
                                   ...
                                   bcmptm_cth_alpm_control_t *ctrl_out)
{
    ...
    blocks = &bcm56990_b0_combined_blocks[sub][0];
...
static int
bcm56990_b0_cth_alpm_parallel_check_and_set(int u,
                                   bcmptm_cth_alpm_control_t *ctrl,
                                   bcmptm_cth_alpm_control_t *ctrl_out)
{
    int rv = SHR_E_NONE;
...
static int
bcm56990_b0_cth_alpm_combined_rpf_check_and_set(int u,
                                   bcmptm_cth_alpm_control_t *ctrl,
                                   bcmptm_cth_alpm_control_t *ctrl_out)
{
    int rv = SHR_E_NONE;
...
static int
bcm56990_b0_cth_alpm_parallel_rpf_check_and_set(int u,
                                   bcmptm_cth_alpm_control_t *ctrl,
                                   bcmptm_cth_alpm_control_t *ctrl_out)
{
    /*
    ...
    sub = ((ctrl->db0_levels >= 2) << 3) |
          ...
          ((ctrl->db2_levels >= 2) << 1) |
           (ctrl->db3_levels >= 2);
    blocks = &bcm56990_b0_parallel_rpf_blocks[sub][0];
    l2_bitmap_check_and_set(blocks, IPDB0, ctrl->tot.l2_bank_bitmap, ctrl_out, &rv);
    l2_bitmap_check_and_set(blocks, IPDB1, ctrl->tot.l2_bank_bitmap, ctrl_out, &rv);
    l2_bitmap_check_and_set(blocks, IPDB2, ctrl->tot.l2_bank_bitmap, ctrl_out, &rv);
...
static int
bcm56990_b0_cth_alpm_fp_combined_check_and_set(int u,
                                   bcmptm_cth_alpm_control_t *ctrl,
                                   bcmptm_cth_alpm_control_t *ctrl_out)
{
    /*
    ...
    sub = ((ctrl->db0_levels >= 2) << 2) |
          ((ctrl->db2_levels >= 2) << 1) |
           (ctrl->db3_levels >= 2);
    blocks = &bcm56990_b0_fp_combined_blocks[sub][0];
    l2_bitmap_check_and_set(blocks, IPDB0, ctrl->tot.l2_bank_bitmap, ctrl_out, &rv);
    l2_bitmap_check_and_set(blocks, IPDB2, ctrl->tot.l2_bank_bitmap, ctrl_out, &rv);
    l2_bitmap_check_and_set(blocks, IPDB3, ctrl->tot.l2_bank_bitmap, ctrl_out, &rv);
...
static int
bcm56990_b0_cth_alpm_fp_parallel_check_and_set(int u,
                                   bcmptm_cth_alpm_control_t *ctrl,
                                   bcmptm_cth_alpm_control_t *ctrl_out)
{
    /*
    ...
    sub = ((ctrl->db0_levels >= 2) << 3) |
          ...
          ((ctrl->db2_levels >= 2) << 1) |
           (ctrl->db3_levels >= 2);
    blocks = &bcm56990_b0_fp_parallel_blocks[sub][0];
    l2_bitmap_check_and_set(blocks, IPDB0, ctrl->tot.l2_bank_bitmap, ctrl_out, &rv);
    l2_bitmap_check_and_set(blocks, IPDB1, ctrl->tot.l2_bank_bitmap, ctrl_out, &rv);
    l2_bitmap_check_and_set(blocks, IPDB2, ctrl->tot.l2_bank_bitmap, ctrl_out, &rv);
    l2_bitmap_check_and_set(blocks, IPDB3, ctrl->tot.l2_bank_bitmap, ctrl_out, &rv);
...
static int
bcm56990_b0_cth_alpm_fp_combined_rpf_check_and_set(int u,
                                   bcmptm_cth_alpm_control_t *ctrl,
                                   bcmptm_cth_alpm_control_t *ctrl_out)
{
    ...
    sub = ((ctrl->db0_levels >= 2) << 3) |
          ...
          ((ctrl->db2_levels >= 2) << 1) |
           (ctrl->db3_levels >= 2);
    blocks = &bcm56990_b0_fp_combined_rpf_blocks[sub][0];
    l2_bitmap_check_and_set(blocks, IPDB0, ctrl->tot.l2_bank_bitmap, ctrl_out, &rv);
    l2_bitmap_check_and_set(blocks, IPDB1, ctrl->tot.l2_bank_bitmap, ctrl_out, &rv);
    l2_bitmap_check_and_set(blocks, IPDB2, ctrl->tot.l2_bank_bitmap, ctrl_out, &rv);
    l2_bitmap_check_and_set(blocks, IPDB3, ctrl->tot.l2_bank_bitmap, ctrl_out, &rv);
...
static void
bcm56990_b0_cth_alpm_combined_init(int u,
                                   bcmptm_cth_alpm_control_t *ctrl,
                                   bcm56990_b0_lpm_ip_control_t *ip_ctrl)
{
    ...
    bcm56990_b0_cth_alpm_combined_check_and_set(u, ctrl, ctrl);

}

static void
bcm56990_b0_cth_alpm_parallel_init(int u,
                                   bcmptm_cth_alpm_control_t *ctrl,
                                   bcm56990_b0_lpm_ip_control_t *ip_ctrl)
{
    uint8_t sub;
    ...
    bcm56990_b0_cth_alpm_parallel_check_and_set(u, ctrl, ctrl);
}

static void
bcm56990_b0_cth_alpm_combined_rpf_init(int u,
                                       bcmptm_cth_alpm_control_t *ctrl,
                                       bcm56990_b0_lpm_ip_control_t *ip_ctrl)
{
    uint8_t sub;
    ...
    ip_ctrl->data_sel[3] = IPDBX;
    ip_ctrl->result_mode = FOUR_RESULTS_MODE;
    bcm56990_b0_cth_alpm_combined_rpf_check_and_set(u, ctrl, ctrl);
}

static void
bcm56990_b0_cth_alpm_parallel_rpf_init(int u,
                                       bcmptm_cth_alpm_control_t *ctrl,
                                       bcm56990_b0_lpm_ip_control_t *ip_ctrl)
{
    /*
    ...
    bcm56990_b0_cth_alpm_parallel_rpf_check_and_set(u, ctrl, ctrl);
}


static void
bcm56990_b0_cth_alpm_fp_combined_init(int u,
                                      bcmptm_cth_alpm_control_t *ctrl,
                                      bcm56990_b0_lpm_ip_control_t *ip_ctrl)
{
    /*
    ...
    ip_ctrl->data_sel[3] = IPDB3;
    ip_ctrl->result_mode = FOUR_RESULTS_MODE;
    bcm56990_b0_cth_alpm_fp_combined_check_and_set(u, ctrl, ctrl);
}

static void
bcm56990_b0_cth_alpm_fp_parallel_init(int u,
                                      bcmptm_cth_alpm_control_t *ctrl,
                                      bcm56990_b0_lpm_ip_control_t *ip_ctrl)
{
    /*
    ...
    ip_ctrl->data_sel[3] = IPDB3;
    ip_ctrl->result_mode = THREE_RESULTS_MODE;
    bcm56990_b0_cth_alpm_fp_parallel_check_and_set(u, ctrl, ctrl);
}

static void
bcm56990_b0_cth_alpm_fp_combined_rpf_init(int u,
                                          bcmptm_cth_alpm_control_t *ctrl,
                                          bcm56990_b0_lpm_ip_control_t *ip_ctrl)
{
    ...
    ip_ctrl->data_sel[3] = IPDB3;
    ip_ctrl->result_mode = FOUR_RESULTS_MODE;
    bcm56990_b0_cth_alpm_fp_combined_rpf_check_and_set(u, ctrl, ctrl);
}
 ...
 */
static void
bcm56990_b0_cth_alpm_ip_ctrl_init(int u,
                                  bcmptm_cth_alpm_control_t *ctrl,
                                  bcm56990_b0_lpm_ip_control_t *ip_ctrl,
                                  bcm56990_b0_lpm_lane_control_t *lane_ctrl)
{
     ...
     *  +-----+---------+------------+
 */
    bcm56990_b0_cth_alpm_l1_parse_check(u, &ctrl->l1_key_input[0],
                                        &ctrl->l1_db[0],
                                        ctrl->db0_levels,
                                        ctrl->db1_levels,
                                        ctrl->db2_levels,
    ...
    ip_ctrl->level1_key_input_sel_block[8] = ctrl->l1_phy_key_input[8];
    ip_ctrl->level1_key_input_sel_block[9] = ctrl->l1_phy_key_input[9];
    ...
    ip_ctrl->level1_database_sel_block[8] = ctrl->l1_phy_db[8];
    ip_ctrl->level1_database_sel_block[9] = ctrl->l1_phy_db[9];
    ...
    if (ctrl->alpm_mode & ALPM_MODE_FP_COMP) {
        ...
        if (ctrl->alpm_mode & ALPM_MODE_RPF) {
            bcm56990_b0_cth_alpm_fp_combined_rpf_init(u, ctrl, ip_ctrl);
            lane_ctrl->l3_src_enable = 1;
        } else if (ctrl->alpm_mode & ALPM_MODE_PARALLEL) {
            bcm56990_b0_cth_alpm_fp_parallel_init(u, ctrl, ip_ctrl);
        } else {
            bcm56990_b0_cth_alpm_fp_combined_init(u, ctrl, ip_ctrl);
        }
    } else {
        if (ctrl->alpm_mode & ALPM_MODE_RPF) {
            if (ctrl->alpm_mode & ALPM_MODE_PARALLEL) {
                bcm56990_b0_cth_alpm_parallel_rpf_init(u, ctrl, ip_ctrl);
            } else {
                bcm56990_b0_cth_alpm_combined_rpf_init(u, ctrl, ip_ctrl);
            }
            lane_ctrl->l3_src_enable = 1;
        } else {
            if (ctrl->alpm_mode & ALPM_MODE_PARALLEL) {
                bcm56990_b0_cth_alpm_parallel_init(u, ctrl, ip_ctrl);
            } else {
                bcm56990_b0_cth_alpm_combined_init(u, ctrl, ip_ctrl);
            }
        }
    }
...
static int
bcm56990_b0_cth_alpm_control_encode(int u, int mtop, bcmptm_cth_alpm_control_t *ctrl,
                                    cth_alpm_control_pt_t *pts)
{
    LPM_IP_CONTROLm_t ce;
    LPM_LANE_CTRLr_t le;
    ING_PROC_CONTROLr_t pe;
    bcm56990_b0_lpm_ip_control_t lpm_ctrl;
    bcm56990_b0_lpm_lane_control_t lane_ctrl;
    ...
    CONTROL_FIELD_SET(LEVEL1_DATABASE_SEL_BLOCK_8f,
                      lpm_ctrl.level1_database_sel_block[8]);
    CONTROL_FIELD_SET(LEVEL1_DATABASE_SEL_BLOCK_9f,
                      lpm_ctrl.level1_database_sel_block[9]);
    ...
    CONTROL_FIELD_SET(LEVEL1_KEY_INPUT_SEL_BLOCK_8f,
                      lpm_ctrl.level1_key_input_sel_block[8]);
    CONTROL_FIELD_SET(LEVEL1_KEY_INPUT_SEL_BLOCK_9f,
                      lpm_ctrl.level1_key_input_sel_block[9]);
    ...
    ING_PROC_CONTROLr_UC_DISABLE_SIP_LOOKUPf_SET(pe, !lane_ctrl.l3_src_enable);
    ING_PROC_CONTROLr_MC_DISABLE_SIP_LOOKUPf_SET(pe, !lane_ctrl.l3_src_enable);

    pts->sid[0] = LPM_IP_CONTROLm;
    pts->sid[1] = LPM_LANE_CTRLr;
    pts->sid[2] = ING_PROC_CONTROLr;
    sal_memcpy(pts->entry[0], &ce, sizeof(ce));
    sal_memcpy(pts->entry[1], &le, sizeof(le));
    sal_memcpy(pts->entry[2], &pe, sizeof(pe));
...
static int
bcm56990_b0_cth_alpm_control_validate_stage1(int u,
                                             bcmptm_cth_alpm_control_t *ctrl)
{
...
static bool
bcm56990_b0_cth_alpm_control_validate_stage2(int u,
                                             bcmptm_cth_alpm_control_t *ctrl)
{
    bool ok;
    uint8_t i;
    ...
    if (ctrl->alpm_mode & ALPM_MODE_FP_COMP) {
        if (ctrl->alpm_mode & ALPM_MODE_RPF) {
            rv = bcm56990_b0_cth_alpm_fp_combined_rpf_check_and_set(u, ctrl, NULL);
        } else if (ctrl->alpm_mode & ALPM_MODE_PARALLEL) {
            rv = bcm56990_b0_cth_alpm_fp_parallel_check_and_set(u, ctrl, NULL);
        } else {
            rv = bcm56990_b0_cth_alpm_fp_combined_check_and_set(u, ctrl, NULL);
        }
    } else {
        if (ctrl->alpm_mode & ALPM_MODE_RPF) {
            if (ctrl->alpm_mode & ALPM_MODE_PARALLEL) {
                rv = bcm56990_b0_cth_alpm_parallel_rpf_check_and_set(u, ctrl, NULL);
            } else {
                rv = bcm56990_b0_cth_alpm_combined_rpf_check_and_set(u, ctrl, NULL);
            }
        } else {
            if (ctrl->alpm_mode & ALPM_MODE_PARALLEL) {
                rv = bcm56990_b0_cth_alpm_parallel_check_and_set(u, ctrl, NULL);
            } else {
                rv = bcm56990_b0_cth_alpm_combined_check_and_set(u, ctrl, NULL);
            }
        }
    }
    if (SHR_FAILURE(rv)) {
...
static int
bcm56990_b0_cth_alpm_control_validate(int u, int mtop, uint8_t stage,
                                      bcmptm_cth_alpm_control_t *ctrl)
{
    bool ok = true;
    ...
    switch (stage) {
        case 1:
        SHR_ERR_EXIT(
            bcm56990_b0_cth_alpm_control_validate_stage1(u, ctrl));
        break;

        case 2:
        default:
        ok = bcm56990_b0_cth_alpm_control_validate_stage2(u, ctrl);
        break;
    }
    if (!ok) {
        SHR_ERR_EXIT(SHR_E_PARAM);
...
static int
bcm56990_b0_cth_alpm_device_info_init(int u, int m, cth_alpm_device_info_t *dev)
{
    bcmptm_cth_alpm_control_t *ctrl;
    ...
    if (dev) {
        ...
        dev->spec.tcam_blocks = 20;
        dev->spec.tcam_depth = 128;
        dev->feature_pkms = 11;
        dev->feature_urpf = 0; /* no urpf support for TH3 */
        dev->spec.l1_blocks = 10;
        ...
        ctrl->l1_phy_key_input[8] = KEY_INPUT_LPM_DST_S;
        ctrl->l1_phy_key_input[9] = KEY_INPUT_LPM_DST_S;
        ...
        ctrl->l1_phy_db[8] = L1_DB0;
        ctrl->l1_phy_db[9] = L1_DB0;
        ctrl->urpf = 0;
    } else {
...
int
bcm56990_b0_cth_alpm_driver_register(int u, bcmptm_cth_alpm_driver_t *drv)
{
    SHR_FUNC_ENTER(u);

    if (drv) {
        drv->control_encode = bcm56990_b0_cth_alpm_control_encode;
        drv->control_validate = bcm56990_b0_cth_alpm_control_validate;
        drv->device_info_init = bcm56990_b0_cth_alpm_device_info_init;
    } else {
        SHR_ERR_EXIT(SHR_E_INIT);
    }
