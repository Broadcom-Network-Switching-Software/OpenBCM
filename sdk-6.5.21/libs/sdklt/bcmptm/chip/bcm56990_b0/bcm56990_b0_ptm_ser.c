...
static bcmptm_ser_ctrl_reg_info_t bcm56990_b0_tcam_scan_ctrl_reg_lst_en[] = {
    ...
    {ING_DII_SER_SCAN_CONFIGr, 0, &iarb_ser_scan_config_fld_lst[0], 5, 0},
    {ING_DII_SER_SCAN_CONFIGr, 0, &iarb_ser_scan_config_fld_lst[5], 1, 0},
    {EGR_DII_SER_SCAN_CONFIGr, 0, &egr_arb_ser_scan_config_fld_lst[0], 5, 0},
    {EGR_DII_SER_SCAN_CONFIGr, 0, &egr_arb_ser_scan_config_fld_lst[5], 1, 0},
    {EGR_DII_AUX_ARB_CONTROLr, 0, &egr_dii_aux_arb_control_fld_lst[0], 2, 0}
};
...
static bcmptm_ser_ctrl_reg_info_t bcm56990_b0_tcam_scan_ctrl_reg_lst_dis[] = {
    ...
    {ING_DII_SER_SCAN_CONFIGr, 0, &iarb_ser_scan_config_fld_lst[0], 5, 0},
    {ING_DII_SER_SCAN_CONFIGr, 0, &iarb_ser_scan_config_fld_lst[6], 1, 0},
    {EGR_DII_SER_SCAN_CONFIGr, 0, &egr_arb_ser_scan_config_fld_lst[0], 5, 0},
    {EGR_DII_SER_SCAN_CONFIGr, 0, &egr_arb_ser_scan_config_fld_lst[6], 1, 0},
    {EGR_DII_AUX_ARB_CONTROLr, 0, &egr_dii_aux_arb_control_fld_lst[2], 1, 0}
};
                              ...
                              uint32_t *address_mapped, int *non_sbus)
{
    uint32_t address_map[][4] = {
        { 0x42c0000, 0x1FFF, BLKTYPE_EPIPE }, /* EGR_IP_TUNNEL_IPV6 */
    };
...
static int
bcm56990_b0_ser_ip_ep_sram_remap(int unit, bcmptm_ser_correct_info_t *spci)
{
    bcmdrd_sid_t mapping[][2] = {
        ...
        {MY_STATION_2_TCAM_ENTRY_ONLYm, MY_STATION_2_TCAMm},
