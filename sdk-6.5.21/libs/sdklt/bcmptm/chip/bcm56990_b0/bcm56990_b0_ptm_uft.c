...
#define UFT_56990_B0_EM_GRP_MAX       9
#define UFT_56990_B0_PHY_BANKS_MAX    27
...
static uft_grp_info_t grps_info[UFT_56990_B0_EM_GRP_MAX] = {
           {0},
           /* L2_HASH_GROUP */
           {.grp_id         = L2_HASH_GROUP,
            ...
            .lt_cnt         = 2,
            .lt_sids[0]     = L2_VFI_FDBt,
            .lt_sids[1]     = L2_VFI_FDB_CCt,
           },
           /* MPLS_HASH_GROUP */
           {.grp_id         = MPLS_HASH_GROUP,
            ...
            .lt_cnt         = 3,
            .lt_sids[0]     = TNL_MPLS_DECAP_1t,
            .lt_sids[1]     = TNL_MPLS_DECAP_TRUNK_1t,
            .lt_sids[2]     = VFI_ING_ADAPT_OVID_PORT_GRPt,
           },
           /* FPEM_HASH_GROUP */
           ...
           {.grp_id         = L3_TUNNEL_HASH_GROUP,
            ...
            .lt_sids[2]     = TNL_MPLS_DECAP_2t,
            .lt_sids[3]     = TNL_MPLS_DECAP_TRUNK_2t,
           },
           /* ALPM_LEVEL2_GROUP */
           ...
           /* EGR_ADAPT_GROUP */
           {.grp_id         = EGR_ADAPT_GROUP,
            .ovly_ptsid     = EGR_ADAPT_SINGLEm,
            .vector_type    = BCMPTM_RM_HASH_VEC_CRC32A_CRC32B,
            .fixed_cnt      = 2,
            .fixed_banks[0] = EGR_ADAPT_BANK0,
            .fixed_banks[1] = EGR_ADAPT_BANK1,
            .lt_cnt         = 1,
            .lt_sids[0]     = VFI_EGR_ADAPT_PORT_GRPt,
           },
           /* L2_UFT_GROUP */
           {.grp_id         = L2_UFT_GROUP,
            .ovly_ptsid     = L2_ENTRY_UFT_SINGLEm,
            .vector_type    = BCMPTM_RM_HASH_VEC_CRC32A_CRC32B,
            .fixed_cnt      = 0,
            .lt_cnt         = 2,
            .lt_sids[0]     = L2_VFI_FDBt,
...
static uft_bank_info_t banks_info[UFT_56990_B0_PHY_BANKS_MAX] = {
           {0},
           {.bank_id = L2_BANK0,
            .grp_cnt = 1,
           ...
           {.bank_id = EGR_ADAPT_BANK0,
            .grp_cnt = 1,
            .grps[0] = EGR_ADAPT_GROUP,
            .base_entry_width = 120,
            .base_buket_width = 4,
            .num_base_buckets = 2048,
            .num_base_entries = 8192,
           },
           {.bank_id = EGR_ADAPT_BANK1,
            .grp_cnt = 1,
            .grps[0] = EGR_ADAPT_GROUP,
            .base_entry_width = 120,
            .base_buket_width = 4,
...
static bcmptm_uft_bank_map_t grps_a_bmp_arr[UFT_56990_B0_EM_GRP_MAX];
...
/*! Initial value for UFT_SHARED_BANKS_CONTROL. */
static uft_hw_map_t egr_adapt_hash_ctrl = {
...
/*! Initial value for MPLS_ENTRY_KEY_ATTRIBUTESm. */
static uft_hw_map_t mpls_key_attr_1 = {
           .sid    = MPLS_ENTRY_KEY_ATTRIBUTESm,
           .index  = 8,
           .f_cnt  = 5,
           .f_ids  = { BUCKET_MODEf, KEY_WIDTHf, KEY_BASE_WIDTHf,
...
static uft_hw_map_t mpls_key_attr_2 = {
           .sid    = MPLS_ENTRY_KEY_ATTRIBUTESm,
           .index  = 3,
           .f_cnt  = 5,
           .f_ids  = { BUCKET_MODEf, KEY_WIDTHf, KEY_BASE_WIDTHf,
...
static uft_hw_map_t mpls_key_attr_3 = {
           .sid    = MPLS_ENTRY_KEY_ATTRIBUTESm,
           .index  = 4,
           .f_cnt  = 5,
           .f_ids  = { BUCKET_MODEf, KEY_WIDTHf, KEY_BASE_WIDTHf,
...
static uft_hw_map_t mpls_key_attr_4 = {
           .sid    = MPLS_ENTRY_KEY_ATTRIBUTESm,
           .index  = 5,
           .f_cnt  = 5,
           .f_ids  = { BUCKET_MODEf, KEY_WIDTHf, KEY_BASE_WIDTHf,
...
static uft_hw_map_t mpls_key_attr_5 = {
           .sid    = MPLS_ENTRY_KEY_ATTRIBUTESm,
           .index  = 6,
           .f_cnt  = 5,
           .f_ids  = { BUCKET_MODEf, KEY_WIDTHf, KEY_BASE_WIDTHf,
...
static uft_hw_map_t mpls_key_attr_6 = {
           .sid    = MPLS_ENTRY_KEY_ATTRIBUTESm,
           .index  = 7,
           .f_cnt  = 5,
           .f_ids  = { BUCKET_MODEf, KEY_WIDTHf, KEY_BASE_WIDTHf,
...
/*! Initial value for EGR_ADAPT_KEY_ATTRIBUTESm. */
static uft_hw_map_t egr_adapt_key_attr_0 = {
           .sid    = EGR_ADAPT_KEY_ATTRIBUTESm,
           .index  = 4,
           .f_cnt  = 5,
           .f_ids  = { BUCKET_MODEf, KEY_WIDTHf, KEY_BASE_WIDTHf,
                       DATA_BASE_WIDTHf, HASH_LSB_OFFSETf },
...
static uft_hw_map_t egr_adapt_key_attr_1 = {
           .sid    = EGR_ADAPT_KEY_ATTRIBUTESm,
           .index  = 2,
           .f_cnt  = 5,
           .f_ids  = { BUCKET_MODEf, KEY_WIDTHf, KEY_BASE_WIDTHf,
...
static uft_hw_map_t egr_adapt_key_attr_2 = {
           .sid    = EGR_ADAPT_KEY_ATTRIBUTESm,
           .index  = 3,
           .f_cnt  = 5,
           .f_ids  = { BUCKET_MODEf, KEY_WIDTHf, KEY_BASE_WIDTHf,
...
static uft_hw_map_t egr_adapt_key_attr_3 = {
           .sid    = EGR_ADAPT_KEY_ATTRIBUTESm,
           .index  = 5,
           .f_cnt  = 5,
           .f_ids  = { BUCKET_MODEf, KEY_WIDTHf, KEY_BASE_WIDTHf,
...
static uft_hw_map_t l3_tunnel_key_attr_3 = {
           .sid    = L3_TUNNEL_KEY_ATTRIBUTESm,
           .index  = 3,
           .f_cnt  = 5,
           .f_ids  = { BUCKET_MODEf, KEY_WIDTHf, KEY_BASE_WIDTHf,
...
static uft_hw_map_t l3_tunnel_key_attr_4 = {
           .sid    = L3_TUNNEL_KEY_ATTRIBUTESm,
           .index  = 4,
           .f_cnt  = 5,
           .f_ids  = { BUCKET_MODEf, KEY_WIDTHf, KEY_BASE_WIDTHf,
...
static uft_hw_map_t l3_tunnel_key_attr_5 = {
           .sid    = L3_TUNNEL_KEY_ATTRIBUTESm,
           .index  = 5,
           .f_cnt  = 5,
           .f_ids  = { BUCKET_MODEf, KEY_WIDTHf, KEY_BASE_WIDTHf,
...
static uft_hw_map_t l3_tunnel_key_attr_6 = {
           .sid    = L3_TUNNEL_KEY_ATTRIBUTESm,
           .index  = 6,
           .f_cnt  = 5,
           .f_ids  = { BUCKET_MODEf, KEY_WIDTHf, KEY_BASE_WIDTHf,
...
static int
dev_em_grp_hash_validate(int unit,
...

{
    ...
    if (SHR_BITGET(grp->fbmp, DEVICE_EM_GROUPt_ROBUSTf)) {
        ...
        regs->reg_map[cnt].f_ids[0] = ROBUST_HASH_ENf;
        regs->reg_map[cnt].f_data[0] = grp->robust;
...
static int
dev_em_grp_l2_uft_set(int unit,
                      uft_dev_em_grp_t *grp,
                      uft_dev_info_t *dev,
                      uft_regs_info_t *regs)
{
    ...
    uint32_t new_cfg = 0;
    uint32_t idx, f_cnt;
    bcmdrd_fid_t l2p_map_fids[4] = {
        LOGICAL_BANK_0_PHYSICAL_BANK_LOCATIONf,
        LOGICAL_BANK_1_PHYSICAL_BANK_LOCATIONf,
        LOGICAL_BANK_2_PHYSICAL_BANK_LOCATIONf,
        LOGICAL_BANK_3_PHYSICAL_BANK_LOCATIONf};
    uint32_t uft_mode_l2p_map[4] = {0x02, 0x03, 0x04, 0x05};
    uint32_t dedicated_l2p_map[4] = {0x00, 0x01, 0x00, 0x00};
    int uft_idx = 0;
    ...
    regs->reg_map[0].f_data[f_cnt] = grp->robust;
    f_cnt++;
    regs->reg_map[0].f_ids[f_cnt] = L2_ENTRY_MODEf;
    regs->reg_map[0].f_data[f_cnt] = ((bank_cnt != 0) ? 1: 0);
    f_cnt++;

    /*
     * Valid physical banks for L2_ENTRY are the L2 Dedicated Banks[1:0],
     * UFT Banks[5:2]. Max configuration is 0x3 or 0x3C, 0x3F is not supported.
     * When there are no UFT banks, set it to 0x3.
     */
    if (bank_cnt) {
        for (idx = 0; idx < bank_cnt; idx++) {
            regs->reg_map[0].f_ids[f_cnt] = l2p_map_fids[idx];
            uft_idx = grp->bank[idx] - UFT_BANK0;
            regs->reg_map[0].f_data[f_cnt] = uft_mode_l2p_map[uft_idx];
            new_cfg |= (1 << uft_mode_l2p_map[uft_idx]);
            f_cnt++;
        }
        for (idx = bank_cnt; idx < 4; idx++) {
            regs->reg_map[0].f_ids[f_cnt] = l2p_map_fids[idx];
            regs->reg_map[0].f_data[f_cnt] = 0;
            f_cnt++;
        }
    } else {
        for (idx = 0; idx < 4; idx++) {
            regs->reg_map[0].f_ids[f_cnt] = l2p_map_fids[idx];
            regs->reg_map[0].f_data[f_cnt] = dedicated_l2p_map[idx];
            f_cnt++;
        }
        new_cfg = 0x3;
    }
    regs->reg_map[0].sid = L2_ENTRY_HASH_CONTROLm;
    regs->reg_map[0].f_ids[f_cnt] = HASH_TABLE_BANK_CONFIGf;
    regs->reg_map[0].f_data[f_cnt] = new_cfg;
    f_cnt++;
...
uft_bank_attrs_init(int unit, uft_dev_info_t *dev)
{
    ...
    for (bank_id = BANK_INVALID + 1; bank_id < dev->max_banks; bank_id++) {
        ...
        case MPLS_BANK0:
            ...
            break;
        case MPLS_BANK1:
            dev->bank_offset[bank_id] = 11;
            break;
        case MPLS_BANK2:
            dev->bank_offset[bank_id] = 32;
            break;
        case MPLS_BANK3:
            dev->bank_offset[bank_id] = 43;
            break;
        case L3_TUNNEL_BANK0:
            dev->bank_offset[bank_id] = 0;
            break;
        case L3_TUNNEL_BANK1:
            dev->bank_offset[bank_id] = 10;
            break;
        case L3_TUNNEL_BANK2:
            dev->bank_offset[bank_id] = 32;
            break;
        case L3_TUNNEL_BANK3:
            dev->bank_offset[bank_id] = 42;
            break;
        case EGR_ADAPT_BANK0:
            dev->bank_offset[bank_id] = 0;
            break;
        case EGR_ADAPT_BANK1:
            dev->bank_offset[bank_id] = 32;
            break;
        case UFT_BANK0:
 ...
 */
static int
bcm56990_b0_regs_init(int unit,
                      uft_dev_info_t *dev,
                      uft_regs_info_t *regs)
{
    int cnt = 0;
    ...
    regs->reg_map[cnt++] = egr_adapt_hash_ctrl;
    regs->reg_map[cnt++] = l2_key_attr_0;
    regs->reg_map[cnt++] = l2_key_attr_1;
    regs->reg_map[cnt++] = mpls_key_attr_0;
    regs->reg_map[cnt++] = mpls_key_attr_1;
    regs->reg_map[cnt++] = mpls_key_attr_2;
    regs->reg_map[cnt++] = mpls_key_attr_3;
    regs->reg_map[cnt++] = mpls_key_attr_4;
    regs->reg_map[cnt++] = mpls_key_attr_5;
    regs->reg_map[cnt++] = mpls_key_attr_6;
    regs->reg_map[cnt++] = egr_adapt_key_attr_0;
    regs->reg_map[cnt++] = egr_adapt_key_attr_1;
    regs->reg_map[cnt++] = egr_adapt_key_attr_2;
    regs->reg_map[cnt++] = egr_adapt_key_attr_3;
    regs->reg_map[cnt++] = l3_tunnel_key_attr_0;
    regs->reg_map[cnt++] = l3_tunnel_key_attr_1;
    regs->reg_map[cnt++] = l3_tunnel_key_attr_2;
    regs->reg_map[cnt++] = l3_tunnel_key_attr_3;
    regs->reg_map[cnt++] = l3_tunnel_key_attr_4;
    regs->reg_map[cnt++] = l3_tunnel_key_attr_5;
    regs->reg_map[cnt++] = l3_tunnel_key_attr_6;
 ...
 */
static int
bcm56990_b0_device_info_init(int unit,
                             ...
                             uft_dev_info_t *dev)
{
    ...
    if (dev) {
        dev->max_grps = UFT_56990_B0_EM_GRP_MAX;
        dev->max_banks = UFT_56990_B0_PHY_BANKS_MAX;
...
static int
bcm56990_b0_uft_tbl_em_ctrl_validate(int unit,
...
static int
uft_em_group_num_banks_get(int unit, uint32_t group_id, uint32_t *num_banks)
{
    ...
    for (i = 0; i < output.count; i++) {
        if (output.field[i]->id == DEVICE_EM_GROUPt_NUM_BANKSf) {
            *num_banks = output.field[i]->data;
            SHR_EXIT();
        }
    }
...
static bool
l2_uft_mode_en(int unit)
{
    uint32_t num_banks = 0;

    (void) uft_em_group_num_banks_get(unit, L2_UFT_GROUP, &num_banks);
    if (num_banks) {
        return TRUE;
    } else {
        return FALSE;
...
static bool
alpm_level3_en(int unit)
{
    uint32_t num_banks = 0;

    (void) uft_em_group_num_banks_get(unit, ALPM_LEVEL3_GROUP, &num_banks);
    if (num_banks) {
        return TRUE;
    } else {
        return FALSE;
...
static int
bcm56990_b0_uft_dev_em_grp_validate(int unit,
                                    uft_dev_em_grp_t *grp,
                                    uft_dev_info_t *dev)
{
    int idx, b_cnt = 0;
    ...
    case FP_EM_HASH_GROUP:
        SHR_IF_ERR_VERBOSE_EXIT
            (dev_em_grp_hash_validate(unit, grp, dev));
        break;
    case L2_UFT_GROUP:
        /* Feedback from Arch, we only support 4 banks configuration. */
        if (!(grp->bank_cnt == 4 || grp->bank_cnt == 0)) {
            SHR_ERR_EXIT(SHR_E_PARAM);
        }
        if ((grp->bank_cnt != 0) && alpm_level3_en(unit)) {
    ...
    case ALPM_LEVEL3_GROUP:
        if ((grp->bank_cnt != 0) && l2_uft_mode_en(unit)) {
            SHR_ERR_EXIT(SHR_E_CONFIG);
        }
        break;
    default:
...
static int
bcm56990_b0_uft_dev_em_grp_set(int unit,
                               uft_dev_em_grp_t *grp,
                               uft_dev_info_t *dev,
                               uft_regs_info_t *regs)
{
    ...
    case L2_UFT_GROUP:
         SHR_IF_ERR_VERBOSE_EXIT
            (dev_em_grp_l2_uft_set(unit, grp, dev, regs));
        break;
    default:
        break;
    }
...
static int
bcm56990_b0_uft_dev_em_bank_validate(int unit, uft_dev_em_bank_t *bank)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56990_b0_uft_dev_em_bank_set(int unit,
...
int
bcm56990_b0_uft_driver_register(int unit, uft_driver_t *drv)
{
    SHR_FUNC_ENTER(unit);

    if (drv) {
        drv->regs_init            = bcm56990_b0_regs_init;
        drv->device_info_init     = bcm56990_b0_device_info_init;
        drv->tbl_em_ctrl_validate = bcm56990_b0_uft_tbl_em_ctrl_validate;
        drv->dev_em_grp_validate  = bcm56990_b0_uft_dev_em_grp_validate;
        drv->dev_em_grp_set       = bcm56990_b0_uft_dev_em_grp_set;
        drv->dev_em_bank_validate = bcm56990_b0_uft_dev_em_bank_validate;
        drv->dev_em_bank_set      = bcm56990_b0_uft_dev_em_bank_set;
    } else {
        SHR_ERR_EXIT(SHR_E_INIT);
    }
