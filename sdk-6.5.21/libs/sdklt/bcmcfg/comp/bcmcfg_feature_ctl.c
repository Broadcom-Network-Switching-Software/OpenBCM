...
static const bcmcfg_comp_node_t bcmcfg_feature_ctl_schema[] = {
    ...
    {
        .node = BCMCFG_COMP_SCALAR,
        .key = "enable_legacy_init",
        .next = BCMCFG_NO_IDX,
        .offset = offsetof(bcmcfg_feature_ctl_config_t, enable_legacy_init),
        .size = sizeof(((bcmcfg_feature_ctl_config_t *)0)->enable_legacy_init),
    }, /* enable_legacy_init 2 */
};
