...
#ifndef BCMCFG_TRM_RESOURCES_H
#define BCMCFG_TRM_RESOURCES_H

/*! \file bcmcfg_trm_resources.h
 *
 ...
 * \endcode
 */
typedef struct bcmcfg_trm_resources_config_s  {
...
} bcmcfg_trm_resources_config_t;


/*!
 * \brief Transaction manager resources default configuration getter.
 *
 * Get default configuration data for transaction manager resources.
 *
...
/*!
 * \brief Transaction manager resources configuration getter.
 *
 * Get configuration data for transaction manager resources.
 *
 * \param [in] config     Config data.
 *
 * \retval SHR_E_NONE  OK
...
/*!
 * \brief Transaction manager resources configuration setter.
 *
 * Set configuration data for transaction manager resources.
 *
 * \param [in] config     Config data.
 *
 * \retval SHR_E_NONE  OK
