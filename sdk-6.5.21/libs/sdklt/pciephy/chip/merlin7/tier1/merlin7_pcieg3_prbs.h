 ...
 * Note: The patt_length input to the function should be the value sent to the merlin7_pcieg3_config_shared_tx_pattern() function
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param enable Enable shared fixed pattern generator (1 = Enable; 0 = Disable)
 * @param patt_length length of the pattern used in merlin7_pcieg3_config_shared_tx_pattern()
...
extern const char* merlin7_pcieg3_e2s_prbs_mode_enum[8];
