...
/** @file merlin7_pcieg3_internal.h
...
typedef enum {
  ...
  DFE_TAPS_2_3_    = 6,
  LMS_SLICER_      = 8
} private_afe_override_slicer_sel_t;
...
/** Checks to see if the stored ucode_version in merlin7_pcieg3_info is matching with the current thread ucode
 * @param sa__ is an opaque state vector passed through to device access functions.
 ...
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *merlin7_pcieg3_info_ptr Info_table to be verified
 * @return Error code, if generated (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *arg is a merlin7_pcieg3_INTERNAL_event_log_dump_state_t pointer for holding state.
 ...
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *istate Current merlin7_pcieg3 core status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *istate Current merlin7_pcieg3 lane status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *pmd_lock Current merlin7_pcieg3 lane pmd_rx_lock status read back and populated by the API
 * @param *pmd_lock_chg Current merlin7_pcieg3 lane pmd_rx_lock_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *sig_det Current merlin7_pcieg3 lane signal_detect status read back and populated by the API
 * @param *sig_det_chg Current merlin7_pcieg3 lane signal_detect_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *pll_lock Current merlin7_pcieg3 lane pll_lock status read back and populated by the API
 * @param *pll_lock_chg Current merlin7_pcieg3 lane pll_lock_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * Define macro CUSTOM_REG_POLLING to replace the default implementation provided in merlin7_pcieg3_internal.c.
 *
 * @param sa__ is an opaque state vector passed through to device access functions.
...
static const int merlin7_pcieg3_endian_const = 1;
#define is_big_endian() ((*(char*)&merlin7_pcieg3_endian_const) == 0)
 ...
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *arg is a merlin7_pcieg3_INTERNAL_rdblk_callback_arg_t pointer for holding state.
...
/** Extract the refclk frequency in Hz, based on a merlin7_pcieg3_pll_refclk_enum value. */
err_code_t merlin7_pcieg3_INTERNAL_get_refclk_in_hz(srds_access_t *sa__, enum merlin7_pcieg3_pll_refclk_enum refclk, uint32_t *refclk_in_hz);
