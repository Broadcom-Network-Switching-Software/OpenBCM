/*! \file bcmltx_id_to_field_sel.c
 *
 * LT key and value pair to PT fields Transform Handler.
 *
                              ...
                              const bcmltd_transform_arg_t *arg)
{
    ...
    out->count = 1;
    id_to_field_sel = in_key->field[0]->data;

    out->field[0]->id = arg->rfield_list->field_array[id_to_field_sel].field_id;
    out->field[0]->idx = 0;
                                  ...
                                  const bcmltd_transform_arg_t *arg)
{
    ...
    out->field[0]->data = in_value->field[id_to_field_sel]->data;
    out->field[0]->idx = 0;
exit:
    SHR_FUNC_EXIT();
}
