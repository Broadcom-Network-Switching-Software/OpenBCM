 ...
 * L3_UC_HIERARCHICAL_NHOP fields.
 */
/*
                                   ...
                                   const bcmltd_transform_arg_t *arg)
{
    ...
    if ((out == NULL) || (arg == NULL) ||
        (arg->rfield_list == NULL) || (arg->comp_data == NULL)) {
        SHR_ERR_EXIT(SHR_E_PARAM);
    }
    ...
    for (idx = 0; idx < in->count; idx++) {
        ...
        if (arg->comp_data->sid == L3_UC_HIERARCHICAL_NHOPt) {
            switch (fid) {
                case L3_UC_HIERARCHICAL_NHOPt_ING_UNDERLAY_NHOP_VALIDf:
                    ul_nho_valid = fval;
                    break;
                case L3_UC_HIERARCHICAL_NHOPt_ING_UNDERLAY_NHOP_IDf:
                    ul_nho_val = fval;
                    break;
                case L3_UC_HIERARCHICAL_NHOPt_IS_TRUNKf:
                    is_trunk = fval;
                    break;
                case L3_UC_HIERARCHICAL_NHOPt_MODPORTf:
                    mod_port_val = fval;
                    break;
                case L3_UC_HIERARCHICAL_NHOPt_TRUNK_IDf:
                    trunk_id_val = fval;
                    break;
                default:
                    SHR_ERR_EXIT(SHR_E_PARAM);
            }
        } else if (arg->comp_data->sid == TNL_MPLS_ENCAP_HIERARCHICAL_NHOPt) {
            switch (fid) {
                case TNL_MPLS_ENCAP_HIERARCHICAL_NHOPt_ING_UNDERLAY_NHOP_VALIDf:
                    ul_nho_valid = fval;
                    break;
                case TNL_MPLS_ENCAP_HIERARCHICAL_NHOPt_ING_UNDERLAY_NHOP_IDf:
                    ul_nho_val = fval;
                    break;
                case TNL_MPLS_ENCAP_HIERARCHICAL_NHOPt_IS_TRUNKf:
                    is_trunk = fval;
                    break;
                case TNL_MPLS_ENCAP_HIERARCHICAL_NHOPt_MODPORTf:
                    mod_port_val = fval;
                    break;
                case TNL_MPLS_ENCAP_HIERARCHICAL_NHOPt_TRUNK_IDf:
                    trunk_id_val = fval;
                    break;
                default:
                    SHR_ERR_EXIT(SHR_E_PARAM);
            }
        } else if (arg->comp_data->sid == TNL_MPLS_TRANSIT_HIERARCHICAL_NHOPt) {
            switch (fid) {
                case TNL_MPLS_TRANSIT_HIERARCHICAL_NHOPt_ING_UNDERLAY_NHOP_VALIDf:
                    ul_nho_valid = fval;
                    break;
                case TNL_MPLS_TRANSIT_HIERARCHICAL_NHOPt_ING_UNDERLAY_NHOP_IDf:
                    ul_nho_val = fval;
                    break;
                case TNL_MPLS_TRANSIT_HIERARCHICAL_NHOPt_IS_TRUNKf:
                    is_trunk = fval;
                    break;
                case TNL_MPLS_TRANSIT_HIERARCHICAL_NHOPt_MODPORTf:
                    mod_port_val = fval;
                    break;
                case TNL_MPLS_TRANSIT_HIERARCHICAL_NHOPt_TRUNK_IDf:
                    trunk_id_val = fval;
                    break;
                default:
                    SHR_ERR_EXIT(SHR_E_PARAM);
            }
        } else if (arg->comp_data->sid == L2_TAG_ACTION_HIERARCHICAL_NHOPt) {
            switch (fid) {
                case L2_TAG_ACTION_HIERARCHICAL_NHOPt_ING_UNDERLAY_NHOP_VALIDf:
                    ul_nho_valid = fval;
                    break;
                case L2_TAG_ACTION_HIERARCHICAL_NHOPt_ING_UNDERLAY_NHOP_IDf:
                    ul_nho_val = fval;
                    break;
                case L2_TAG_ACTION_HIERARCHICAL_NHOPt_IS_TRUNKf:
                    is_trunk = fval;
                    break;
                case L2_TAG_ACTION_HIERARCHICAL_NHOPt_MODPORTf:
                    mod_port_val = fval;
                    break;
                case L2_TAG_ACTION_HIERARCHICAL_NHOPt_TRUNK_IDf:
                    trunk_id_val = fval;
                    break;
                default:
                    SHR_ERR_EXIT(SHR_E_PARAM);
            }
        } else if (arg->comp_data->sid == FP_ING_ACTION_HIERARCHICAL_NHOPt) {
            switch (fid) {
                case FP_ING_ACTION_HIERARCHICAL_NHOPt_ING_UNDERLAY_NHOP_VALIDf:
                    ul_nho_valid = fval;
                    break;
                case FP_ING_ACTION_HIERARCHICAL_NHOPt_ING_UNDERLAY_NHOP_IDf:
                    ul_nho_val = fval;
                    break;
                case FP_ING_ACTION_HIERARCHICAL_NHOPt_IS_TRUNKf:
                    is_trunk = fval;
                    break;
                case FP_ING_ACTION_HIERARCHICAL_NHOPt_MODPORTf:
                    mod_port_val = fval;
                    break;
                case FP_ING_ACTION_HIERARCHICAL_NHOPt_TRUNK_IDf:
                    trunk_id_val = fval;
                    break;
                default:
                    SHR_ERR_EXIT(SHR_E_PARAM);
