/*! \file bcmltx_port_policy_egr_cfi_as_cng.c
 *
 ...
 *
 * Element 'N' of the EGR_CFI_AS_CNG array corresponds to the field
 * arg->field[N](forward transform), arg->rfield[N](reverse transform).
 * EGR_CFI_AS_CNG index should be between 0 and arg->rfields - 1 (forward transform)
...
/*
 * \brief PORT_POLICY.EGR_CFI_AS_CNG array forward transform
 *
 * \param [in]  unit            Unit number.
 * \param [in]  in              PORT_POLICY.EGR_CFI_AS_CNG field array.
 * \param [out] out             EGR_VLAN_CONTROL_1.CFI_AS_CNG field.
 * \param [in]  arg             Handler arguments.
 *
 * Transform direction is logical to physical.
 *
 * The idx of PORT_POLICY.EGR_CFI_AS_CNG array is ID to VLAN_OUTER_TPID.
                                            ...
                                            const bcmltd_transform_arg_t *arg)
{
    ...
    LOG_VERBOSE(BSL_LOG_MODULE,
                (BSL_META_U(unit,
                            "\t bcmltx_port_policy_egr_cfi_as_cng_transform\n")));
...
/*
 * \brief PORT_POLICY.EGR_CFI_AS_CNG array reverse transform
 *
 * \param [in]  unit            Unit number.
 * \param [in]  in              EGR_VLAN_CONTROL_1/CFI_AS_CNG fields.
 * \param [out] out             PORT_POLICY.EGR_CFI_AS_CNG field array.
 * \param [in]  arg             Handler arguments.
 *
 * The idx of PORT_POLICY.EGR_CFI_AS_CNG array is ID to VLAN_OUTER_TPID.
 * This transform simply copies the input
                                                ...
                                                const bcmltd_transform_arg_t *arg)
{
    ...
    LOG_VERBOSE(BSL_LOG_MODULE,
                (BSL_META_U(unit,
                            "\t bcmltx_port_policy_egr_cfi_as_cng_rev_transform\n")));
