/*! \file bcmltx_vlan_assignment_vlan_range_vlan_id_max.c
 *
 * VLAN_ASSINGMENT_VLAN_RANGE.VLAN_ID_MAX Transform Handler
 *
 * This file contains field transform information for
 * VLAN_ASSINGMENT_VLAN_RANGE.VLAN_ID_MAX.
 *
 * Element 'N' of the VLAN_ID_MAX array corresponds to the field
...
#include <bcmltx/bcmvlan/bcmltx_vlan_assignment_vlan_range_vlan_id_max.h>

#define BSL_LOG_MODULE BSL_LS_BCMLTX_VLAN

/*
 * \brief VLAN_ASSINGMENT_VLAN_RANGE.VLAN_ID_MAX forward transform
 *
 * \param [in]  unit            Unit number.
 * \param [in]  in              VLAN_ID_MAX field array.
 * \param [out] out             ING_VLAN_RANGE/VLAN_MAX_x x=[0,7] fields.
 * \param [in]  arg             Handler arguments.
 *
 * Transform direction is logical to physical.
 *
 * In the field array VLAN_ID_MAX, the array idx of the
 * field is the index of min vlan id ranges. There are N output fields,
 * where N is the x in VLAN_MAX_x of ING_VLAN_RANGE.
                                                        ...
                                                        const bcmltd_transform_arg_t *arg)
{
    ...
    uint32_t pt_idx; /* The x in the physical fields VLAN_MAX_x. */
    int rv = SHR_E_NONE;
    ...
    LOG_VERBOSE(BSL_LOG_MODULE,
                (BSL_META_U(unit,
                            "\t bcmvlan_vlan_assignment_vlan_range_vlan_id_max_transform\n")));
...
/*
 * \brief VLAN_ASSINGMENT_VLAN_RANGE.VLAN_ID_MAX array reverse transform
 *
 * \param [in]  unit            Unit number.
 * \param [in]  in              ING_VLAN_RANGE.VLAN_MAX_x fields.
 * \param [out] out             VLAN_ASSINGMENT_VLAN_RANGE.VLAN_ID_MAX field array.
 * \param [in]  arg             Handler arguments.
 *
                                                            ...
                                                            const bcmltd_transform_arg_t *arg)
{
    ...
    LOG_VERBOSE(BSL_LOG_MODULE,
                (BSL_META_U(unit,
                            "\t bcmvlan_vlan_assignment_vlan_range_vlan_id_max_rev_transform\n")));
