/*! \file bcmltx_ctr_oper_state.h
 *
 * CTR operational state transform handler.
 */
/*
...
#ifndef BCMLTX_CTR_OPER_STATE_H
#define BCMLTX_CTR_OPER_STATE_H
