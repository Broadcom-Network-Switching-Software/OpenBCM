/*! \file bcmltx_port_vlan_xlate_ing_xlate_tbl_sel_second_lookup.h
 *
...
#ifndef BCMLTX_PORT_VLAN_XLATE_ING_XLATE_TBL_SEL_SECOND_LOOKUP_H
#define BCMLTX_PORT_VLAN_XLATE_ING_XLATE_TBL_SEL_SECOND_LOOKUP_H

#include <bcmltd/bcmltd_handler.h>

/*!
 * \brief PORT_VLAN_XLATE.ING_XLATE_TBL_SEL_SECOND_LOOKUP transform
 *
...
/*!
 * \brief PORT_VLAN_XLATE.ING_XLATE_TBL_SEL_SECOND_LOOKUP rev transform
 *
 * \param [in]  unit          Unit Number.
 * \param [in]  in            Input field values.
 * \param [out] out           Output field values.
...
#endif /* BCMLTX_PORT_VLAN_XLATE_ING_XLATE_TBL_SEL_SECOND_LOOKUP_H */
