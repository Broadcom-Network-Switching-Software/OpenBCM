...
/*
 * Total number of chunks in PMUX qualifier section
 */
#define BCMFP_KEYGEN_EXT_PMUX_NUM 20
...
typedef struct bcmfp_keygen_ext_sel_s {
    ...
    int8_t pmux_sel[BCMFP_KEYGEN_EXT_PMUX_NUM];
...
typedef struct bcmfp_keygen_ext_field_info_s {
    ...
    bcmfp_finfo_qual_info_t qual_info[BCMFP_KEYGEN_MAX_QUAL_PER_EXT];
