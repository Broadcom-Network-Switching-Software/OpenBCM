/*! \file bcm56780_a0_fp_profiles_copy.c
 *
...
int
bcm56780_a0_fp_profiles_copy(int unit, uint32_t trans_id, bcmfp_stage_t *stage)
{
    ...
    switch (stage_id) {
        ...
        case BCMFP_STAGE_ID_FLOW_TRACKER:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56780_a0_fp_em_profiles_copy(unit, trans_id, stage));
            break;
        default:
