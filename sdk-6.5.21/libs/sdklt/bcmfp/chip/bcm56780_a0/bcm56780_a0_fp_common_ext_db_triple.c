/*! \file bcm56780_a0_fp_common_ext_db_triple.c
 *
 * IFP/VFP/EFP triple wide multi hierarchy extractors
 * configuration DB initialization function for
 * Trident4-X9(56780_A0).
 */
/*
                                      ...
                                      bcmfp_stage_t *stage)
{
    ...
    for (idx = 0; idx < 5; idx++) {
        ...
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 0, 0, BCMFP_KEYGEN_EXT_SECTION_FKA, offset_one);
    ...
    for (idx = 0; idx < 5; idx++) {
        ...
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 1, 0, BCMFP_KEYGEN_EXT_SECTION_L1E16, 0);
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 0, 0, BCMFP_KEYGEN_EXT_SECTION_L2AS1, offset_one);
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 0, 1, BCMFP_KEYGEN_EXT_SECTION_L3AS2, offset_two);
        BCMFP_KEYGEN_EXT_CFG_INSERT(unit, ext_cfg_db, &ext_attrs);
    }
    ...
    for (idx = 0; idx < 22; idx++) {
        ...
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 0, 0, BCMFP_KEYGEN_EXT_SECTION_L2AS2, offset_one);
        BCMFP_KEYGEN_EXT_CFG_INSERT(unit, ext_cfg_db, &ext_attrs);
    }
    ...
    for (idx = 0; idx < 15; idx++) {
        ...
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 1, 0, BCMFP_KEYGEN_EXT_SECTION_L2AS1, 0);
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 0, 0, BCMFP_KEYGEN_EXT_SECTION_L3AS1, offset_one);
        BCMFP_KEYGEN_EXT_CFG_INSERT(unit, ext_cfg_db, &ext_attrs);
    }
    ...
    for (idx = 0; idx < 13; idx++) {
        ...
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 1, 0, BCMFP_KEYGEN_EXT_SECTION_L2AS2, 0);
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 0, 0, BCMFP_KEYGEN_EXT_SECTION_L3AS1, offset_one);
        BCMFP_KEYGEN_EXT_CFG_INSERT(unit, ext_cfg_db, &ext_attrs);
    }
    ...
    for (idx = 0; idx < 7; idx++) {
        ...
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 1, 0, BCMFP_KEYGEN_EXT_SECTION_L2AS2, 0);
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 0, 0, BCMFP_KEYGEN_EXT_SECTION_L3AS2, offset_one);
        BCMFP_KEYGEN_EXT_CFG_INSERT(unit, ext_cfg_db, &ext_attrs);
    }
    ...
    for (idx = 0; idx < 15; idx++) {
        ...
        BCMFP_KEYGEN_EXT_PLGE_ADD(unit, part, level, gran, ext_num + idx);
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 1, 0, BCMFP_KEYGEN_EXT_SECTION_L3AS1, 0);
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 0, 0, BCMFP_KEYGEN_EXT_SECTION_FKA, offset_one);
        BCMFP_KEYGEN_EXT_CFG_INSERT(unit, ext_cfg_db, &ext_attrs);
    }
    ...
    for (idx = 0; idx < 7; idx++) {
        ...
        BCMFP_KEYGEN_EXT_PLGE_ADD(unit, part, level, gran, ext_num + idx);
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 1, 0, BCMFP_KEYGEN_EXT_SECTION_L3AS2, 0);
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 0, 0, BCMFP_KEYGEN_EXT_SECTION_FKA, offset_one);
        BCMFP_KEYGEN_EXT_CFG_INSERT(unit, ext_cfg_db, &ext_attrs);
    }
    ...
    BCMFP_KEYGEN_EXT_SECTION_ADD
        (unit, 1, 0, BCMFP_KEYGEN_EXT_SECTION_FKA, 0);
    BCMFP_KEYGEN_EXT_SECTION_ADD
    ...
    for (idx = 0; idx < 5; idx++) {
        ...
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 1, 0, BCMFP_KEYGEN_EXT_SECTION_L1E16, 0);
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 0, 0, BCMFP_KEYGEN_EXT_SECTION_FKB, offset_one);
        BCMFP_KEYGEN_EXT_CFG_INSERT(unit, ext_cfg_db, &ext_attrs);
    }
    ext_num = 5;
    for (idx = 0; idx < 5; idx++) {
        ...
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 1, 0, BCMFP_KEYGEN_EXT_SECTION_L1E16, 0);
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 0, 0, BCMFP_KEYGEN_EXT_SECTION_L2BS1, offset_one);
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 0, 1, BCMFP_KEYGEN_EXT_SECTION_L3BS2, offset_two);
        BCMFP_KEYGEN_EXT_CFG_INSERT(unit, ext_cfg_db, &ext_attrs);
    }
    ...
    for (idx = 0; idx < 22; idx++) {
        ...
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 1, 0, BCMFP_KEYGEN_EXT_SECTION_L1E4, 0);
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 0, 0, BCMFP_KEYGEN_EXT_SECTION_L2BS2, offset_one);
        BCMFP_KEYGEN_EXT_CFG_INSERT(unit, ext_cfg_db, &ext_attrs);
    }
    /* #############Initialize Level-2 4-bit extractors############# */
    level = 2;
    ...
    for (idx = 0; idx < 15; idx++) {
        ...
        BCMFP_KEYGEN_EXT_ONEHOT_PLGE_ADD
            (unit, 0, part, 3, gran, (ext_num + idx));
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 1, 0, BCMFP_KEYGEN_EXT_SECTION_L2BS1, 0);
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 0, 0, BCMFP_KEYGEN_EXT_SECTION_L3BS1, offset_one);
        BCMFP_KEYGEN_EXT_CFG_INSERT(unit, ext_cfg_db, &ext_attrs);
    }
    /* ########Initialize PASS THRU Level-2 4-bit extractors######### */
    gran = 4;
    ...
    for (idx = 0; idx < 13; idx++) {
        ...
        BCMFP_KEYGEN_EXT_ONEHOT_PLGE_ADD
            (unit, 0, part, 3, gran, idx);
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 1, 0, BCMFP_KEYGEN_EXT_SECTION_L2BS2, 0);
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 0, 0, BCMFP_KEYGEN_EXT_SECTION_L3BS1, offset_one);
        BCMFP_KEYGEN_EXT_CFG_INSERT(unit, ext_cfg_db, &ext_attrs);
    }
    ...
    for (idx = 0; idx < 7; idx++) {
        ...
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 1, 0, BCMFP_KEYGEN_EXT_SECTION_L2BS2, 0);
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 0, 0, BCMFP_KEYGEN_EXT_SECTION_L3BS2, offset_one);
        BCMFP_KEYGEN_EXT_CFG_INSERT(unit, ext_cfg_db, &ext_attrs);
    }
    ...
    for (idx = 0; idx < 15; idx++) {
        ...
        BCMFP_KEYGEN_EXT_PLGE_ADD(unit, part, level, gran, ext_num + idx);
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 1, 0, BCMFP_KEYGEN_EXT_SECTION_L3BS1, 0);
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 0, 0, BCMFP_KEYGEN_EXT_SECTION_FKB, offset_one);
        BCMFP_KEYGEN_EXT_CFG_INSERT(unit, ext_cfg_db, &ext_attrs);
    }
    ...
    for (idx = 0; idx < 7; idx++) {
        ...
        BCMFP_KEYGEN_EXT_PLGE_ADD(unit, part, level, gran, ext_num + idx);
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 1, 0, BCMFP_KEYGEN_EXT_SECTION_L3BS2, 0);
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 0, 0, BCMFP_KEYGEN_EXT_SECTION_FKB, offset_one);
        BCMFP_KEYGEN_EXT_CFG_INSERT(unit, ext_cfg_db, &ext_attrs);
    }
    ...
    BCMFP_KEYGEN_EXT_PLGE_ADD(unit, part, level, gran, ext_num);
    BCMFP_KEYGEN_EXT_SECTION_ADD
        (unit, 1, 0, BCMFP_KEYGEN_EXT_SECTION_FKB, 0);
    BCMFP_KEYGEN_EXT_SECTION_ADD
        (unit, 0, 0, BCMFP_KEYGEN_EXT_SECTION_DISABLE, offset_one);
    BCMFP_KEYGEN_EXT_CFG_INSERT(unit, ext_cfg_db, &ext_attrs);
    ...
    for (idx = 0; idx < 5; idx++) {
        ...
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 1, 0, BCMFP_KEYGEN_EXT_SECTION_L1E16, 0);
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 0, 0, BCMFP_KEYGEN_EXT_SECTION_FKC, offset_one);
        BCMFP_KEYGEN_EXT_CFG_INSERT(unit, ext_cfg_db, &ext_attrs);
    }
    ext_num = 5;
    for (idx = 0; idx < 5; idx++) {
        ...
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 1, 0, BCMFP_KEYGEN_EXT_SECTION_L1E16, 0);
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 0, 0, BCMFP_KEYGEN_EXT_SECTION_L2CS1, offset_one);
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 0, 1, BCMFP_KEYGEN_EXT_SECTION_L3CS2, offset_two);
        BCMFP_KEYGEN_EXT_CFG_INSERT(unit, ext_cfg_db, &ext_attrs);
    }
    ...
    for (idx = 0; idx < 22; idx++) {
        ...
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 1, 0, BCMFP_KEYGEN_EXT_SECTION_L1E4, 0);
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 0, 0, BCMFP_KEYGEN_EXT_SECTION_L2CS2, offset_one);
        BCMFP_KEYGEN_EXT_CFG_INSERT(unit, ext_cfg_db, &ext_attrs);
    }
    /* #############Initialize Level-2 4-bit extractors############# */
    level = 2;
    ...
    for (idx = 0; idx < 15; idx++) {
        ...
        BCMFP_KEYGEN_EXT_ONEHOT_PLGE_ADD
            (unit, 0, part, 3, gran, (ext_num + idx));
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 1, 0, BCMFP_KEYGEN_EXT_SECTION_L2CS1, 0);
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 0, 0, BCMFP_KEYGEN_EXT_SECTION_L3CS1, offset_one);
        BCMFP_KEYGEN_EXT_CFG_INSERT(unit, ext_cfg_db, &ext_attrs);
    }
    /* ########Initialize PASS THRU Level-2 4-bit extractors######### */
    gran = 4;
    ...
    for (idx = 0; idx < 13; idx++) {
        ...
        BCMFP_KEYGEN_EXT_ONEHOT_PLGE_ADD
            (unit, 0, part, 3, gran, idx);
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 1, 0, BCMFP_KEYGEN_EXT_SECTION_L2CS2, 0);
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 0, 0, BCMFP_KEYGEN_EXT_SECTION_L3CS1, offset_one);
        BCMFP_KEYGEN_EXT_CFG_INSERT(unit, ext_cfg_db, &ext_attrs);
    }
    ...
    for (idx = 0; idx < 7; idx++) {
        ...
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 1, 0, BCMFP_KEYGEN_EXT_SECTION_L2CS2, 0);
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 0, 0, BCMFP_KEYGEN_EXT_SECTION_L3CS2, offset_one);
        BCMFP_KEYGEN_EXT_CFG_INSERT(unit, ext_cfg_db, &ext_attrs);
    }
    ...
    for (idx = 0; idx < 15; idx++) {
        ...
        BCMFP_KEYGEN_EXT_PLGE_ADD(unit, part, level, gran, ext_num + idx);
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 1, 0, BCMFP_KEYGEN_EXT_SECTION_L3CS1, 0);
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 0, 0, BCMFP_KEYGEN_EXT_SECTION_FKC, offset_one);
        BCMFP_KEYGEN_EXT_CFG_INSERT(unit, ext_cfg_db, &ext_attrs);
    }
    ...
    for (idx = 0; idx < 7; idx++) {
        ...
        BCMFP_KEYGEN_EXT_PLGE_ADD(unit, part, level, gran, ext_num + idx);
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 1, 0, BCMFP_KEYGEN_EXT_SECTION_L3CS2, 0);
        BCMFP_KEYGEN_EXT_SECTION_ADD
            (unit, 0, 0, BCMFP_KEYGEN_EXT_SECTION_FKC, offset_one);
        BCMFP_KEYGEN_EXT_CFG_INSERT(unit, ext_cfg_db, &ext_attrs);
    }
    ...
    BCMFP_KEYGEN_EXT_PLGE_ADD(unit, part, level, gran, ext_num);
    BCMFP_KEYGEN_EXT_SECTION_ADD
        (unit, 1, 0, BCMFP_KEYGEN_EXT_SECTION_FKC, 0);
    BCMFP_KEYGEN_EXT_SECTION_ADD
        (unit, 0, 0, BCMFP_KEYGEN_EXT_SECTION_DISABLE, offset_one);
    BCMFP_KEYGEN_EXT_CFG_INSERT(unit, ext_cfg_db, &ext_attrs);
exit:
