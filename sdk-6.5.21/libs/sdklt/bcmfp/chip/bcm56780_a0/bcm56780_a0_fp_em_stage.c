/*! \file bcm56780_a0_fp_em_stage.c
 *
                             ...
                             bcmfp_stage_t *stage)
{
    ...
    key_data_sz_info->presel_key_size_max = 80;
    ...
    hw_entry_info->presel_sid = IFTA90_E2T_00_LTS_TCAM_0m;
    ...
    key_data_sz_info->data_start_bit[BCMFP_GROUP_MODE_SINGLE][0] = 7;
    key_data_sz_info->data_end_bit[BCMFP_GROUP_MODE_SINGLE][0] = 119;
    ...
    key_data_sz_info->data_start_bit[BCMFP_GROUP_MODE_DBLINTER][0] = 7;
    key_data_sz_info->data_end_bit[BCMFP_GROUP_MODE_DBLINTER][0] = 119;
    key_data_sz_info->data_start_bit[BCMFP_GROUP_MODE_DBLINTER][1] = 123;
    key_data_sz_info->data_end_bit[BCMFP_GROUP_MODE_DBLINTER][1] = 239;
    ...
    key_data_sz_info->data_start_bit[BCMFP_GROUP_MODE_QUAD][0] = 7;
    key_data_sz_info->data_end_bit[BCMFP_GROUP_MODE_QUAD][0] = 119;
    key_data_sz_info->data_start_bit[BCMFP_GROUP_MODE_QUAD][1] = 123;
    key_data_sz_info->data_end_bit[BCMFP_GROUP_MODE_QUAD][1] = 239;
    key_data_sz_info->data_start_bit[BCMFP_GROUP_MODE_QUAD][2] = 243;
    key_data_sz_info->data_end_bit[BCMFP_GROUP_MODE_QUAD][2] = 359;
    key_data_sz_info->data_start_bit[BCMFP_GROUP_MODE_QUAD][3] = 363;
    key_data_sz_info->data_end_bit[BCMFP_GROUP_MODE_QUAD][3] = 479;
    ...
    stage->misc_info->pdd_index_size = 5;
    ...
    stage->pdd_hw_info->pdd_profile_sid_columns = 1;
    ...
    if (stage->stage_id == BCMFP_STAGE_ID_FLOW_TRACKER) {
        ...
        stage->sbr_hw_info->sbr_sid[1] = IFTA80_SBR_PROFILE_TABLE_1m;
        stage->sbr_hw_info->sbr_sid[2] = IFTA80_SBR_PROFILE_TABLE_2m;
    }
    /*
    ...
    /*
     * BOTP_MUX_DATA is a 6-bit field.
     * MSB (bit 5) indicates if the MUX is enabled.
     * Remaining 5 bits indicate the mux select value.
     ...
     */
    botp_bus_cont_id = pdd_info->info[0].phy_cont_id;
    if (botp_bus_cont_id >= 130) {
        /* Hit index container was a part of PDD section.
         * Adjust hit_index section offset. */
        botp_bus_cont_id -= 130;
    }
    ...
    if (stage->stage_id == BCMFP_STAGE_ID_FLOW_TRACKER) {
        ...
        stage->hit_context->hit_idx_profiles = 6;
        ...
        stage->hit_context->hit_idx_profile_tbls[2] = IFTA80_E2T_00_HIT_INDEX_PROFILEm;
        stage->hit_context->hit_idx_profile_tbls[3] = IFTA80_E2T_01_HIT_INDEX_PROFILEm;
        stage->hit_context->hit_idx_profile_tbls[4] = IFTA80_E2T_02_HIT_INDEX_PROFILEm;
        stage->hit_context->hit_idx_profile_tbls[5] = IFTA80_E2T_03_HIT_INDEX_PROFILEm;
    }

    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_fp_em_bank_info_set(unit, stage));
exit:
    /*
