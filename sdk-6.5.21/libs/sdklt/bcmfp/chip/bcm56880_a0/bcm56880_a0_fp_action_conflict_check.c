/*! \file bcm56880_a0_fp_action_conflict_check.c
 *
...
STATIC int
bcm56880_a0_fp_common_action_conflict_check(int unit,
...
int
bcm56880_a0_fp_action_conflict_check(int unit,
                                     bcmfp_stage_t *stage,
                                     bcmfp_action_t action1,
                                     bcmfp_action_t action2)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_fp_common_action_conflict_check(unit,
                                                     action1,
                                                     action2));
