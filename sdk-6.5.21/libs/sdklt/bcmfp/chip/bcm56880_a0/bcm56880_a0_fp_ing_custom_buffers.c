/*! \file bcm56880_a0_fp_ing_custom_buffers.c
 *
...
STATIC int
bcm56880_a0_ing_sbr_profile_install(int unit,
                                   uint32_t trans_id,
                                   bool default_entry,
                                   void *group_opinfo,
                                   bcmfp_stage_t *stage,
...
STATIC int
bcm56880_a0_ing_sbr_profile_uninstall(int unit,
                                     uint32_t trans_id,
                                     bool default_entry,
                                     void *group_opinfo,
                                     bcmfp_stage_t *stage)
                                   ...
                                   bcmfp_buffers_t *buffers)
{
    ...
    if (flags & BCMFP_GROUP_INSTALL_SBR_PROFILE) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56880_a0_ing_sbr_profile_install(unit,
                                                trans_id,
                                                FALSE,
                                                (void *)opinfo,
                                                stage,
                                     ...
                                     bcmfp_group_oper_info_t *opinfo)
{
    ...
    if (flags & BCMFP_GROUP_INSTALL_SBR_PROFILE) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56880_a0_ing_sbr_profile_uninstall(unit,
                                                  trans_id,
                                                  FALSE,
                                                  (void *)opinfo,
                                                  stage));
