/*! \file bcm56880_a0_fp_common_presel_ext_db.c
 *
                                      ...
                                      bcmfp_stage_t *stage)
{
    ...
    if (stage->stage_id == BCMFP_STAGE_ID_EGRESS) {
        BCMFP_KEYGEN_EXT_SECTION_SIZE_SET(unit, ext_cfg_db,
                         BCMFP_KEYGEN_EXT_SECTION_L1E8, 324);
    } else if (stage->stage_id == BCMFP_STAGE_ID_INGRESS) {
        BCMFP_KEYGEN_EXT_SECTION_SIZE_SET(unit, ext_cfg_db,
                         BCMFP_KEYGEN_EXT_SECTION_L1E8, 452);
    } else if (stage->stage_id == BCMFP_STAGE_ID_LOOKUP) {
        BCMFP_KEYGEN_EXT_SECTION_SIZE_SET(unit, ext_cfg_db,
                         BCMFP_KEYGEN_EXT_SECTION_L1E8, 292);
    }
exit:
    SHR_FUNC_EXIT();
}
