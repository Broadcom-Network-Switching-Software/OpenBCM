/*! \file bcm56880_a0_fp_device_attach.c
 *
 * BCMFP driver attach function for device bcm56880_a0.
 */
/*
 ...
 */
STATIC int
bcm56880_a0_fp_device_misc_init(int unit,
                                bcmfp_stage_t *stage)
{
    uint16_t idx = 0;
...
int
bcm56880_a0_fp_device_attach(int unit)
{
    ...
    if (stage != NULL) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56880_a0_fp_device_misc_init(unit, stage));
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56880_a0_fp_info_tbls_init(unit, stage));
    }
