                                      ...
                                      bcmfp_stage_t *stage)
{
    ...
    key_data_sz_info->key_size[BCMFP_GROUP_MODE_SINGLE] = 160;
    ...
    key_data_sz_info->key_size[BCMFP_GROUP_MODE_TRIPLE] = 480;
    ...
    BCMFP_ALLOC(stage->sbr_hw_info->priority_field_info,
                ...
                "bcmfpEgrStageSbrPriorityFieldHwInfo");
    ...
    BCMFP_ALLOC(stage->sbr_hw_info->priority_field_info[0].offset,
                sizeof(uint16_t),
                "bcmfpEgrStageSbrPriorityFieldFirstColumnOffset");
    BCMFP_ALLOC(stage->sbr_hw_info->priority_field_info[0].width,
                sizeof(uint16_t),
                "bcmfpEgrStageSbrPriorityFieldFirstColumnWidth");
    ...
    BCMFP_ALLOC(stage->sbr_hw_info->priority_field_info[1].offset,
                sizeof(uint16_t),
                "bcmfpEgrStageSbrPriorityFieldSecondColumnOffset");
    BCMFP_ALLOC(stage->sbr_hw_info->priority_field_info[1].width,
                sizeof(uint16_t),
                "bcmfpEgrStageSbrPriorityFieldSecondColumnWidth");
