/*! \file bcm56990_b0_fp_ing_action_db.c
 *
 *  IFP action configuration DB initialization function for Tomahawk-4 B0(56990_B0).
 */
/*
                                             ...
                                             bcmfp_stage_t *stage)
{
    ...
    if (BCMFP_STAGE_FLAGS_TEST(stage, BCMFP_STAGE_KEY_TYPE_PRESEL)) {
        SHR_IF_ERR_EXIT(
               bcmfp_bcm56990_b0_ingress_presel_action_cfg_db_init(unit,
                                                                   stage));
    }
