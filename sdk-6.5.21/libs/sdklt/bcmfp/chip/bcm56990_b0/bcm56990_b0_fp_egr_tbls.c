...
bcmfp_bcm56990_b0_egress_rule_qualifiers_map(void)
{
    ...
    fid = FP_EGR_RULE_TEMPLATEt_QUAL_OVERLAY_EGR_NHOP_CLASS_IDf;
    map_fid = FP_EGR_GRP_TEMPLATEt_QUAL_OVERLAY_EGR_NHOP_CLASS_IDf;
    rule_qualifiers_fid_info[fid].qualifier = map_fid;
    SHR_BITSET(rule_qualifiers_fid_info[fid].flags.w, BCMFP_QUALIFIER_FID_FLAGS_DATA);

    fid = FP_EGR_RULE_TEMPLATEt_QUAL_OVERLAY_EGR_NHOP_CLASS_ID_MASKf;
    map_fid = FP_EGR_GRP_TEMPLATEt_QUAL_OVERLAY_EGR_NHOP_CLASS_IDf;
    rule_qualifiers_fid_info[fid].qualifier = map_fid;
    SHR_BITSET(rule_qualifiers_fid_info[fid].flags.w, BCMFP_QUALIFIER_FID_FLAGS_MASK);
    ...
    fid = FP_EGR_RULE_TEMPLATEt_QUAL_OVERLAY_EGR_L3_IIF_CLASS_IDf;
    map_fid = FP_EGR_GRP_TEMPLATEt_QUAL_OVERLAY_EGR_L3_IIF_CLASS_IDf;
    rule_qualifiers_fid_info[fid].qualifier = map_fid;
    SHR_BITSET(rule_qualifiers_fid_info[fid].flags.w, BCMFP_QUALIFIER_FID_FLAGS_DATA);

    fid = FP_EGR_RULE_TEMPLATEt_QUAL_OVERLAY_EGR_L3_IIF_CLASS_ID_MASKf;
    map_fid = FP_EGR_GRP_TEMPLATEt_QUAL_OVERLAY_EGR_L3_IIF_CLASS_IDf;
    rule_qualifiers_fid_info[fid].qualifier = map_fid;
    SHR_BITSET(rule_qualifiers_fid_info[fid].flags.w, BCMFP_QUALIFIER_FID_FLAGS_MASK);
    ...
    fid = FP_EGR_RULE_TEMPLATEt_QUAL_EGR_DVPf;
    map_fid = FP_EGR_GRP_TEMPLATEt_QUAL_EGR_DVPf;
    rule_qualifiers_fid_info[fid].qualifier = map_fid;
    SHR_BITSET(rule_qualifiers_fid_info[fid].flags.w, BCMFP_QUALIFIER_FID_FLAGS_DATA);

    fid = FP_EGR_RULE_TEMPLATEt_QUAL_EGR_DVP_MASKf;
    map_fid = FP_EGR_GRP_TEMPLATEt_QUAL_EGR_DVPf;
    rule_qualifiers_fid_info[fid].qualifier = map_fid;
    SHR_BITSET(rule_qualifiers_fid_info[fid].flags.w, BCMFP_QUALIFIER_FID_FLAGS_MASK);

    fid = FP_EGR_RULE_TEMPLATEt_QUAL_EGR_DVP_GROUP_IDf;
    map_fid = FP_EGR_GRP_TEMPLATEt_QUAL_EGR_DVP_GROUP_IDf;
    rule_qualifiers_fid_info[fid].qualifier = map_fid;
    SHR_BITSET(rule_qualifiers_fid_info[fid].flags.w, BCMFP_QUALIFIER_FID_FLAGS_DATA);

    fid = FP_EGR_RULE_TEMPLATEt_QUAL_EGR_DVP_GROUP_ID_MASKf;
    map_fid = FP_EGR_GRP_TEMPLATEt_QUAL_EGR_DVP_GROUP_IDf;
    rule_qualifiers_fid_info[fid].qualifier = map_fid;
    SHR_BITSET(rule_qualifiers_fid_info[fid].flags.w, BCMFP_QUALIFIER_FID_FLAGS_MASK);
}
