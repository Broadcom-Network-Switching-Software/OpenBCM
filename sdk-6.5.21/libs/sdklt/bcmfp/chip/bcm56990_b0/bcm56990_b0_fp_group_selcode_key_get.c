/*! \file bcm56990_b0_fp_group_selcode_key_get.c
 *
...
int
bcm56990_b0_fp_group_selcode_key_get(int unit, bcmfp_stage_t *stage, bcmfp_group_t *fg)
{
    ...
    switch (stage_id) {
        case BCMFP_STAGE_ID_EGRESS:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmfp_bcm56990_b0_egress_group_selcode_key_get(unit, fg));
