/*! \file bcm56990_b0_fp_egr_qual_enum.c
 *
...
STATIC int
bcm56990_b0_fp_egr_qual_ifp_class_id_type_get(int unit,
                                              uint32_t data,
                                              uint32_t mask,
                                              int *class_id_type)
{
...
STATIC int
bcm56990_b0_fp_egr_qual_ifp_class_id_type_set(int unit,
                                              int class_id_type,
                                              uint32_t *data,
                                              uint32_t *mask)
{
...
STATIC int
bcm56990_b0_fp_egr_qual_loopback_set(int unit,
                                     int loopback,
                                     uint32_t *data,
                                     uint32_t *mask)
{
...
STATIC int
bcm56990_b0_fp_egr_qual_loopback_get(int unit,
                                     uint32_t data,
                                     uint32_t mask,
                                     int *loopback)
{
...
STATIC int
bcm56990_b0_fp_egr_qual_ipfrag_set(int unit,
                                   int frag_info,
                                   uint32_t *data,
                                   uint32_t *mask)
{
...
STATIC int
bcm56990_b0_fp_egr_qual_ipfrag_get(int unit,
                                   uint32_t data,
                                   uint32_t mask,
                                   int *frag_info)
{
...
STATIC int
bcm56990_b0_fp_egr_qual_fwd_type_set(int unit,
                                     int type,
                                     uint32_t *data,
                                     uint32_t *mask)
{
...
STATIC int
bcm56990_b0_fp_egr_qual_fwd_type_get(int unit,
                                     uint32_t data,
                                     uint32_t mask,
                                     int *type)
{
...
STATIC int
bcm56990_b0_fp_egr_main_qual_enum_set(int unit,
                                      ...
                                      uint32_t *mask)
{
    ...
    switch (qual) {
        ...
        case FP_EGR_GRP_TEMPLATEt_QUAL_FWD_TYPEf:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56990_b0_fp_egr_qual_fwd_type_set(unit,
                                                      value,
                                                      data,
                                                      mask));
            break;
        case FP_EGR_GRP_TEMPLATEt_QUAL_ING_CLASS_ID_TYPEf:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56990_b0_fp_egr_qual_ifp_class_id_type_set(unit,
                                                               value,
                                                               data,
                                                               mask));
            break;
        case FP_EGR_GRP_TEMPLATEt_QUAL_LOOPBACK_TYPEf:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56990_b0_fp_egr_qual_loopback_set(unit,
                                                      value,
                                                      data,
                                                      mask));
            break;
        case FP_EGR_GRP_TEMPLATEt_QUAL_IP_FRAGf:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56990_b0_fp_egr_qual_ipfrag_set(unit,
                                                    value,
                                                    data,
                                                    mask));
            break;
                                 ...
                                 uint32_t *mask)
{
    ...
    if (is_presel == FALSE) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56990_b0_fp_egr_main_qual_enum_set(unit,
                                                   qual,
                                                   value,
                                                   data,
                                                   mask));
...
STATIC int
bcm56990_b0_fp_egr_main_qual_enum_get(int unit,
                                      bcmfp_qualifier_t qual,
                                      uint32_t data,
                                      uint32_t mask,
                                      int *value)
{
    ...
    switch (qual) {
        ...
        case FP_EGR_GRP_TEMPLATEt_QUAL_FWD_TYPEf:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56990_b0_fp_egr_qual_fwd_type_get(unit,
                                                      data,
                                                      mask,
                                                      value));
            break;
        case FP_EGR_GRP_TEMPLATEt_QUAL_ING_CLASS_ID_TYPEf:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56990_b0_fp_egr_qual_ifp_class_id_type_get(unit,
                                                               data,
                                                               mask,
                                                               value));
            break;
         case FP_EGR_GRP_TEMPLATEt_QUAL_LOOPBACK_TYPEf:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56990_b0_fp_egr_qual_loopback_get(unit,
                                                      data,
                                                      mask,
                                                      value));
            break;
         case FP_EGR_GRP_TEMPLATEt_QUAL_IP_FRAGf:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56990_b0_fp_egr_qual_ipfrag_get(unit,
                                                    data,
                                                    mask,
                                                    value));
            break;
                                 ...
                                 int *value)
{
    ...
    if (is_presel == FALSE) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56990_b0_fp_egr_main_qual_enum_get(unit,
                                                   qual,
                                                   data,
                                                   mask,
                                                   value));
