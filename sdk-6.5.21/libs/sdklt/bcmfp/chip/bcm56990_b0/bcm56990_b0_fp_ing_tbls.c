...
bcmfp_tbl_qualifier_fid_info_t
bcm56990_b0_ingress_group_template_action_qualifiers_fid_info[FP_ING_GRP_TEMPLATE_ACTIONt_FIELD_COUNT];
...
static void bcmfp_bcm56990_b0_ingress_group_template_action_qualifiers_map(void);
...
bcmfp_tbl_group_t bcm56990_b0_ing_group_tbl = {
    ...
    .qual_svp_ports_fid = FP_ING_GRP_TEMPLATEt_QUAL_SVP_PORTS_BITMAPf,
...
bcmfp_tbl_group_template_action_t bcm56990_b0_ing_group_template_action_tbl = {
   ...
   .qualifiers_fid_info =
       bcm56990_b0_ingress_group_template_action_qualifiers_fid_info,
...
bcmfp_tbl_group_template_status_t bcm56990_b0_ing_group_template_status_tbl = {
...
bcmfp_tbl_rule_t bcm56990_b0_ing_rule_tbl = {
    ...
    .svp_ports_key_fid = FP_ING_RULE_TEMPLATEt_QUAL_SVP_PORTSf,
    .svp_ports_mask_fid = FP_ING_RULE_TEMPLATEt_QUAL_SVP_PORTS_MASKf,
...
static void
bcmfp_bcm56990_b0_ingress_group_template_action_qualifiers_map(void)
{
    uint32_t fid;
    uint32_t map_fid;
    bcmfp_tbl_qualifier_fid_info_t *group_qualifiers_fid_info = NULL;
    ...
    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_SRC_VP_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_SRC_VP_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;
    ...
    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_OVERLAY_DST_VP_BITMAPf;
    ...
    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_VFI_BITMAPf;
    ...
    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_SVP_PORTS_BITMAPf;
    ...
    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_INNER_L2_VLAN_OUTER_PRESENT_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_INNER_L2_VLAN_OUTER_PRESENT_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_INNER_L2_OPAQUE_TAG_PRESENT_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_INNER_L2_OPAQUE_TAG_PRESENT_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;
    ...
    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_INNER_L2_OPAQUE_TAG_BITMAPf;
    ...
    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_MYSTATIONTCAM_2_HIT_BITMAPf;
    ...
    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_INNER_L2_L3_ROUTABLE_PKT_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_INNER_L2_L3_ROUTABLE_PKT_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;
    ...
    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_INNER_L2_OUTER_TPID_BITMAPf;
...
bcmfp_bcm56990_b0_ingress_rule_qualifiers_map(void)
{
    ...
    fid = FP_ING_RULE_TEMPLATEt_QUAL_SRC_VPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_SRC_VP_BITMAPf;
    rule_qualifiers_fid_info[fid].qualifier = map_fid;
    SHR_BITSET(rule_qualifiers_fid_info[fid].flags.w, BCMFP_QUALIFIER_FID_FLAGS_DATA);

    fid = FP_ING_RULE_TEMPLATEt_QUAL_SRC_VP_MASKf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_SRC_VP_BITMAPf;
    rule_qualifiers_fid_info[fid].qualifier = map_fid;
    SHR_BITSET(rule_qualifiers_fid_info[fid].flags.w, BCMFP_QUALIFIER_FID_FLAGS_MASK);
    ...
    fid = FP_ING_RULE_TEMPLATEt_QUAL_INNER_L2_OPAQUE_TAG_PRESENTf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_INNER_L2_OPAQUE_TAG_PRESENT_BITMAPf;
    rule_qualifiers_fid_info[fid].qualifier = map_fid;
    SHR_BITSET(rule_qualifiers_fid_info[fid].flags.w, BCMFP_QUALIFIER_FID_FLAGS_DATA);

    fid = FP_ING_RULE_TEMPLATEt_QUAL_INNER_L2_OPAQUE_TAG_PRESENT_MASKf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_INNER_L2_OPAQUE_TAG_PRESENT_BITMAPf;
    rule_qualifiers_fid_info[fid].qualifier = map_fid;
    SHR_BITSET(rule_qualifiers_fid_info[fid].flags.w, BCMFP_QUALIFIER_FID_FLAGS_MASK);
    ...
    fid = FP_ING_RULE_TEMPLATEt_QUAL_INNER_L2_L3_ROUTABLE_PKTf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_INNER_L2_L3_ROUTABLE_PKT_BITMAPf;
    rule_qualifiers_fid_info[fid].qualifier = map_fid;
    SHR_BITSET(rule_qualifiers_fid_info[fid].flags.w, BCMFP_QUALIFIER_FID_FLAGS_DATA);

    fid = FP_ING_RULE_TEMPLATEt_QUAL_INNER_L2_L3_ROUTABLE_PKT_MASKf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_INNER_L2_L3_ROUTABLE_PKT_BITMAPf;
    rule_qualifiers_fid_info[fid].qualifier = map_fid;
    SHR_BITSET(rule_qualifiers_fid_info[fid].flags.w, BCMFP_QUALIFIER_FID_FLAGS_MASK);
...
bcmfp_bcm56990_b0_ingress_compression_remote_fid_map(void)
{
    ...
    bcm56990_b0_compress_ipv4_dst_remote_map[6].fid = FP_ING_RULE_TEMPLATEt_QUAL_IP_FLAGS_MFf;
    bcm56990_b0_compress_ipv4_dst_remote_map[6].offset = 0;
    bcm56990_b0_compress_ipv4_dst_remote_map[6].width = 1;

    bcm56990_b0_compress_ipv4_dst_remote_map[7].fid = FP_ING_RULE_TEMPLATEt_QUAL_IP_FLAGS_DFf;
    ...
    bcm56990_b0_compress_ipv4_src_remote_map[6].fid = FP_ING_RULE_TEMPLATEt_QUAL_IP_FLAGS_MFf;
    bcm56990_b0_compress_ipv4_src_remote_map[6].offset = 0;
    bcm56990_b0_compress_ipv4_src_remote_map[6].width = 1;

    bcm56990_b0_compress_ipv4_src_remote_map[7].fid = FP_ING_RULE_TEMPLATEt_QUAL_IP_FLAGS_DFf;
                                ...
                                bcmfp_stage_t *stage)
{
    ...
    stage->tbls.group_template_action_tbl =
        &bcm56990_b0_ing_group_template_action_tbl;
    stage->tbls.group_template_status_tbl =
        &bcm56990_b0_ing_group_template_status_tbl;
    ...
    (void)bcmfp_bcm56990_b0_ingress_group_template_action_qualifiers_map();
