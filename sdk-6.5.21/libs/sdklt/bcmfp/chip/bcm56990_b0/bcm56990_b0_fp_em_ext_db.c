/*! \file bcm56990_b0_fp_em_ext_db.c
 *
 * EM multi hierarchy extractors configuration DB
                                          ...
                                          bcmfp_stage_t *stage)
{
    ...
    BCMFP_ALLOC(ext_cfg_db,
                sizeof(bcmfp_keygen_ext_cfg_db_t), "bcmfpEmExtCfgDb");
    ...
    BCMFP_KEYGEN_EXT_CFG_ADD(unit, ext_cfg_db, part, level, gran, (ext_num + 4),
        BCMFP_KEYGEN_EXT_SECTION_L2S1, BCMFP_KEYGEN_EXT_SECTION_L3S1, 68, attrs);
    ...
    BCMFP_KEYGEN_EXT_CFG_ADD(unit, ext_cfg_db, part, level, gran, 0,
        BCMFP_KEYGEN_EXT_SECTION_L3S1, BCMFP_KEYGEN_EXT_SECTION_DISABLE, 0, attrs);
    ...
    SHR_BITSET(ext_attrs.w, BCMFP_KEYGEN_EXT_ATTR_NOT_WITH_PMUX_CLASS_ID_D);
    BCMFP_KEYGEN_EXT_CFG_ADD(unit, ext_cfg_db, part, level, gran, (ext_num + 4),
        BCMFP_KEYGEN_EXT_SECTION_L2BS1, BCMFP_KEYGEN_EXT_SECTION_L3BS1, 68, attrs);
    ...
    SHR_BITSET(ext_attrs.w, BCMFP_KEYGEN_EXT_ATTR_NOT_WITH_PMUX_CLASS_ID_D);
    BCMFP_KEYGEN_EXT_CFG_ADD(unit, ext_cfg_db, part, level, gran, (ext_num + 4),
        BCMFP_KEYGEN_EXT_SECTION_L2CS1, BCMFP_KEYGEN_EXT_SECTION_L3CS1, 68, attrs);
