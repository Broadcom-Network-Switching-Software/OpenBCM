/*! \file bcm56990_a0_fp_device_attach.c
 *
 * BCMFP driver attach function for device bcm56990_a0.
 */
/*
...
int
bcm56990_a0_fp_device_attach(int unit)
{
    ...
    if (stage != NULL) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56990_a0_fp_ingress_info_tbls_init(unit, stage));
    }
    ...
    if (stage != NULL) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56990_a0_fp_egress_info_tbls_init(unit, stage));
    }
    ...
    if (stage != NULL) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56990_a0_fp_lookup_info_tbls_init(unit, stage));
    }
    ...
    if (stage != NULL) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56990_a0_fp_em_info_tbls_init(unit, stage));
    }
