/*! \file bcm56990_a0_fp_egr_tbls.c
 *
 * API to initialize Egress FP stage logical tables and some FIDs
 * in each of those logical table for Tomahawk-4(56990_A0).
 */
/*
...
bcm56990_a0_egress_group_qualifiers_fid_info[FP_EGR_GRP_TEMPLATEt_FIELD_COUNT];

bcmfp_tbl_qualifier_fid_info_t
bcm56990_a0_egress_rule_qualifiers_fid_info[FP_EGR_RULE_TEMPLATEt_FIELD_COUNT];

bcmfp_tbl_action_fid_info_t
bcm56990_a0_egress_policy_actions_fid_info[FP_EGR_POLICY_TEMPLATEt_FIELD_COUNT];

static void bcmfp_bcm56990_a0_egress_group_qualifiers_map(void);
static void bcmfp_bcm56990_a0_egress_rule_qualifiers_map(void);
static void bcmfp_bcm56990_a0_egress_policy_actions_map(void);

bcmfp_tbl_group_t bcm56990_a0_egr_group_tbl = {
    ...
    .qualifiers_fid_info = bcm56990_a0_egress_group_qualifiers_fid_info,
    .enable_fid = FP_EGR_GRP_TEMPLATEt_ENABLEf,
    .auto_expand_fid = FP_EGR_GRP_TEMPLATEt_AUTO_EXPANDf,
    .ctr_prof_ids_count_fid = FP_EGR_GRP_TEMPLATEt_CTR_EGR_EFLEX_ACTION_COUNTf,
    .ctr_prof_ids_fid = FP_EGR_GRP_TEMPLATEt_CTR_EGR_EFLEX_ACTIONf,
    .fid_count = FP_EGR_GRP_TEMPLATEt_FIELD_COUNT,
};

bcmfp_tbl_group_info_t bcm56990_a0_egr_group_info_tbl = {
...
static void
bcmfp_bcm56990_a0_egress_group_qualifiers_map(void)
{
    uint32_t fid;
    bcmfp_tbl_qualifier_fid_info_t *group_qualifiers_fid_info = NULL;

    group_qualifiers_fid_info = bcm56990_a0_egress_group_qualifiers_fid_info;
    ...
    group_qualifiers_fid_info[fid].qualifier = 0;
    fid = FP_EGR_GRP_TEMPLATEt_CTR_EGR_EFLEX_ACTION_COUNTf;
    group_qualifiers_fid_info[fid].qualifier = 0;
    fid = FP_EGR_GRP_TEMPLATEt_CTR_EGR_EFLEX_ACTIONf;
    group_qualifiers_fid_info[fid].qualifier = 0;

}

static void
bcmfp_bcm56990_a0_egress_rule_qualifiers_map(void)
{
    uint32_t fid;
    uint32_t map_fid;
    bcmfp_tbl_qualifier_fid_info_t *rule_qualifiers_fid_info = NULL;

    rule_qualifiers_fid_info = bcm56990_a0_egress_rule_qualifiers_fid_info;
    ...
    fid = FP_EGR_RULE_TEMPLATEt_QUAL_BYTES_0_7_AFTER_L2HEADER_MASKf;
    map_fid = FP_EGR_GRP_TEMPLATEt_QUAL_BYTES_0_7_AFTER_L2HEADERf;
    rule_qualifiers_fid_info[fid].qualifier = map_fid;
    SHR_BITSET(rule_qualifiers_fid_info[fid].flags.w, BCMFP_QUALIFIER_FID_FLAGS_MASK);
    ...
    fid = FP_EGR_RULE_TEMPLATEt_QUAL_BYTES_8_15_AFTER_L2HEADER_MASKf;
    map_fid = FP_EGR_GRP_TEMPLATEt_QUAL_BYTES_8_15_AFTER_L2HEADERf;
    rule_qualifiers_fid_info[fid].qualifier = map_fid;
    SHR_BITSET(rule_qualifiers_fid_info[fid].flags.w, BCMFP_QUALIFIER_FID_FLAGS_MASK);
    ...
    fid = FP_EGR_RULE_TEMPLATEt_QUAL_BYTES_16_17_AFTER_L2HEADER_MASKf;
    map_fid = FP_EGR_GRP_TEMPLATEt_QUAL_BYTES_16_17_AFTER_L2HEADERf;
    rule_qualifiers_fid_info[fid].qualifier = map_fid;
    SHR_BITSET(rule_qualifiers_fid_info[fid].flags.w, BCMFP_QUALIFIER_FID_FLAGS_MASK);
}
...
static void
bcmfp_bcm56990_a0_egress_policy_actions_map(void)
{
    uint32_t fid;
    bcmfp_tbl_action_fid_info_t *policy_actions_fid_info = NULL;

    policy_actions_fid_info = bcm56990_a0_egress_policy_actions_fid_info;
                                   ...
                                   bcmfp_stage_t *stage)
{
    ...
    stage->tbls.group_tbl = &bcm56990_a0_egr_group_tbl;
    stage->tbls.group_info_tbl = &bcm56990_a0_egr_group_info_tbl;
    stage->tbls.rule_tbl = &bcm56990_a0_egr_rule_tbl;
    stage->tbls.policy_tbl = &bcm56990_a0_egr_policy_tbl;
    stage->tbls.entry_tbl = &bcm56990_a0_egr_entry_tbl;
    (void)bcmfp_bcm56990_a0_egress_group_qualifiers_map();
    (void)bcmfp_bcm56990_a0_egress_rule_qualifiers_map();
    (void)bcmfp_bcm56990_a0_egress_policy_actions_map();
exit:
    SHR_FUNC_EXIT();
}
