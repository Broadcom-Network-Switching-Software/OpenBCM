/*! \file bcm56990_a0_fp_egr_fixed_key.c
 *
 * API for fixed key entry/group attributes for Tomahawk-4(56990_A0)
 * device.
 */
/*
...
#define BCM56990_A0_KEY_MATCH_TYPE_IPV4_SINGLE            (1)
#define BCM56990_A0_KEY_MATCH_TYPE_IPV6_SINGLE            (2)
#define BCM56990_A0_KEY_MATCH_TYPE_IPV6_DOUBLE            (3)
#define BCM56990_A0_KEY_MATCH_TYPE_IPV4_L2_L3_DOUBLE      (4)
#define BCM56990_A0_KEY_MATCH_TYPE_L2_SINGLE              (5)
#define BCM56990_A0_KEY_MATCH_TYPE_IPV4_IPV6_DOUBLE       (6)
#define BCM56990_A0_KEY_MATCH_TYPE_HIGIG_DOUBLE           (9)
#define BCM56990_A0_KEY_MATCH_TYPE_LOOPBACK_DOUBLE        (10)
#define BCM56990_A0_KEY_MATCH_TYPE_L2_DOUBLE              (11)
                               ...
                               uint32_t **ekw)
{
    ...
    switch (slice_mode) {
        case BCMFP_GROUP_SLICE_MODE_L2_SINGLE_WIDE:
            switch (port_pkt_type) {
                case BCMFP_GROUP_TYPE_PORT_ANY_PACKET_ANY:
                    data = BCM56990_A0_KEY_MATCH_TYPE_L2_SINGLE;
                    break;
                default:
                    SHR_ERR_EXIT(SHR_E_PARAM);
            }
        ...
        case BCMFP_GROUP_SLICE_MODE_L3_SINGLE_WIDE:
            switch (port_pkt_type) {
                case BCMFP_GROUP_TYPE_PORT_ANY_PACKET_IPV4:
                    data = BCM56990_A0_KEY_MATCH_TYPE_IPV4_SINGLE;
                    break;
                case BCMFP_GROUP_TYPE_PORT_ANY_PACKET_IPV6:
                    data = BCM56990_A0_KEY_MATCH_TYPE_IPV6_SINGLE;
                    break;
                case BCMFP_GROUP_TYPE_PORT_ANY_PACKET_NONIP:
                    data = BCM56990_A0_KEY_MATCH_TYPE_L2_SINGLE;
                    break;
        ...
        case BCMFP_GROUP_SLICE_MODE_L3_DOUBLE_WIDE:
            switch (port_pkt_type) {
                case BCMFP_GROUP_TYPE_PORT_ANY_PACKET_IPV4:
                    data = BCM56990_A0_KEY_MATCH_TYPE_IPV4_L2_L3_DOUBLE;
                    break;
                case BCMFP_GROUP_TYPE_PORT_ANY_PACKET_IPV6:
                    data = BCM56990_A0_KEY_MATCH_TYPE_IPV6_DOUBLE;
                    break;
                case BCMFP_GROUP_TYPE_PORT_ANY_PACKET_NONIP:
                    data = BCM56990_A0_KEY_MATCH_TYPE_L2_DOUBLE;
                    break;
                default:
                    SHR_ERR_EXIT(SHR_E_PARAM);
            }
        ...
        case BCMFP_GROUP_SLICE_MODE_L3_ANY_DOUBLE_WIDE:
            switch (port_pkt_type) {
                case BCMFP_GROUP_TYPE_PORT_HIGIG_PACKET_ANY:
                    data = BCM56990_A0_KEY_MATCH_TYPE_HIGIG_DOUBLE;
                    break;
                case BCMFP_GROUP_TYPE_PORT_FRONT_PACKET_ANY:
                    data = BCM56990_A0_KEY_MATCH_TYPE_IPV4_L2_L3_DOUBLE;
                    break;
        ...
        case BCMFP_GROUP_SLICE_MODE_L3_ALT_DOUBLE_WIDE:
            switch (port_pkt_type) {
                case BCMFP_GROUP_TYPE_PORT_ANY_PACKET_IPV4:
                    ...
                    break;
                case BCMFP_GROUP_TYPE_PORT_ANY_PACKET_IPV6:
                    data = BCM56990_A0_KEY_MATCH_TYPE_IPV4_IPV6_DOUBLE;
                    break;
                case BCMFP_GROUP_TYPE_PORT_ANY_PACKET_NONIP:
                    data = BCM56990_A0_KEY_MATCH_TYPE_L2_DOUBLE;
                    break;
