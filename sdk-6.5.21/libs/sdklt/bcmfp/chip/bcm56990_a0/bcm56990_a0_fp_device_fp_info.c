...
static int bcmfp_bcm56990_a0_ingress_group_info_qualifiers_map(int);
static int bcmfp_bcm56990_a0_egress_group_info_qualifiers_map(int);
static int bcmfp_bcm56990_a0_lookup_group_info_qualifiers_map(int);
static int bcmfp_bcm56990_a0_em_group_info_qualifiers_map(int);
static int bcmfp_bcm56990_a0_em_group_info_actions_map(int);
static int bcmfp_bcm56990_a0_ingress_pse_info_qualifiers_map(int unit);
static int bcmfp_bcm56990_a0_em_pse_info_qualifiers_map(int unit);

bcmfp_tbl_offset_info_t bcm56990_a0_ingress_group_info_qualifiers_fid_info[FP_ING_GRP_TEMPLATEt_FIELD_COUNT];
bcmfp_tbl_offset_info_t bcm56990_a0_egress_group_info_qualifiers_fid_info[FP_EGR_GRP_TEMPLATEt_FIELD_COUNT];
bcmfp_tbl_offset_info_t bcm56990_a0_lookup_group_info_qualifiers_fid_info[FP_VLAN_GRP_TEMPLATEt_FIELD_COUNT];
bcmfp_tbl_offset_info_t bcm56990_a0_em_group_info_qualifiers_fid_info[FP_EM_GRP_TEMPLATEt_FIELD_COUNT];
bcmfp_tbl_offset_info_t bcm56990_a0_em_group_info_actions_fid_info[FP_EM_POLICY_TEMPLATEt_FIELD_COUNT];
bcmfp_tbl_offset_info_t bcm56990_a0_ingress_pse_info_qualifiers_fid_info[FP_ING_PRESEL_ENTRY_TEMPLATEt_FIELD_COUNT];
bcmfp_tbl_offset_info_t bcm56990_a0_em_pse_info_qualifiers_fid_info[FP_ING_PRESEL_ENTRY_TEMPLATEt_FIELD_COUNT];

bcmfp_tbl_presel_info_t bcm56990_a0_ingress_pse_info_tbl = {
    .sid = FP_ING_PRESEL_TEMPLATE_PARTITION_INFOt,
    .qual_fid_info = bcm56990_a0_ingress_pse_info_qualifiers_fid_info,
    .fid_count = FP_ING_PRESEL_TEMPLATE_PARTITION_INFOt_FIELD_COUNT,
};

bcmfp_tbl_presel_info_t bcm56990_a0_em_pse_info_tbl = {
    .sid = FP_EM_PRESEL_TEMPLATE_PARTITION_INFOt,
    .qual_fid_info = bcm56990_a0_em_pse_info_qualifiers_fid_info,
...
bcmfp_tbl_group_partition_info_t bcm56990_a0_egress_group_part_info_tbl = {
    ...
    .qual_fid_info = bcm56990_a0_egress_group_info_qualifiers_fid_info,
...
bcmfp_tbl_group_partition_info_t bcm56990_a0_lookup_group_part_info_tbl = {
    ...
    .qual_fid_info = bcm56990_a0_lookup_group_info_qualifiers_fid_info,
...
bcmfp_tbl_group_partition_info_t bcm56990_a0_em_group_part_info_tbl = {
    ...
    .qual_fid_info = bcm56990_a0_em_group_info_qualifiers_fid_info,
                                      ...
                                      bcmfp_stage_t *stage)
{
    ...
    stage->tbls.pse_info_tbl = &bcm56990_a0_ingress_pse_info_tbl;
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmfp_bcm56990_a0_ingress_group_info_qualifiers_map(unit));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmfp_bcm56990_a0_ingress_pse_info_qualifiers_map(unit));
exit:
    SHR_FUNC_EXIT();
                                      ...
                                      bcmfp_stage_t *stage)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmfp_bcm56990_a0_egress_group_info_qualifiers_map(unit));
                                      ...
                                      bcmfp_stage_t *stage)
{
    ...
    stage->tbls.pse_info_tbl = &bcm56990_a0_em_pse_info_tbl;
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmfp_bcm56990_a0_em_group_info_actions_map(unit));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmfp_bcm56990_a0_em_group_info_qualifiers_map(unit));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmfp_bcm56990_a0_em_pse_info_qualifiers_map(unit));
exit:
    SHR_FUNC_EXIT();
                                      ...
                                      bcmfp_stage_t *stage)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmfp_bcm56990_a0_lookup_group_info_qualifiers_map(unit));
...
static int
bcmfp_bcm56990_a0_ingress_group_info_qualifiers_map(int unit)
{
...
static int
bcmfp_bcm56990_a0_egress_group_info_qualifiers_map(int unit)
{
    bcmfp_tbl_offset_info_t *qual_fid_info;
    SHR_FUNC_ENTER(unit);
    qual_fid_info = bcm56990_a0_egress_group_info_qualifiers_fid_info;
    ...
    sal_memset(qual_fid_info, 0,
               sizeof(bcm56990_a0_egress_group_info_qualifiers_fid_info));
...
static int
bcmfp_bcm56990_a0_lookup_group_info_qualifiers_map(int unit)
{
    bcmfp_tbl_offset_info_t *qual_fid_info;
    SHR_FUNC_ENTER(unit);
    qual_fid_info = bcm56990_a0_lookup_group_info_qualifiers_fid_info;
    ...
    sal_memset(qual_fid_info, 0,
               sizeof(bcm56990_a0_lookup_group_info_qualifiers_fid_info));
...
static int
bcmfp_bcm56990_a0_em_group_info_qualifiers_map(int unit)
{
    bcmfp_tbl_offset_info_t *qual_fid_info;
    SHR_FUNC_ENTER(unit);
    qual_fid_info = bcm56990_a0_em_group_info_qualifiers_fid_info;
    ...
    sal_memset(qual_fid_info, 0,
               sizeof(bcm56990_a0_em_group_info_qualifiers_fid_info));
...
static int
bcmfp_bcm56990_a0_em_group_info_actions_map(int unit)
{
...
static int
bcmfp_bcm56990_a0_ingress_pse_info_qualifiers_map(int unit)
{
    bcmfp_tbl_offset_info_t *qual_fid_info;
    SHR_FUNC_ENTER(unit);
    qual_fid_info = bcm56990_a0_ingress_pse_info_qualifiers_fid_info;
    ...
    sal_memset(qual_fid_info, 0,
               sizeof(bcm56990_a0_ingress_pse_info_qualifiers_fid_info));
...
static int
bcmfp_bcm56990_a0_em_pse_info_qualifiers_map(int unit)
{
    bcmfp_tbl_offset_info_t *qual_fid_info;
    SHR_FUNC_ENTER(unit);
    qual_fid_info = bcm56990_a0_em_pse_info_qualifiers_fid_info;
    ...
    sal_memset(qual_fid_info, 0,
               sizeof(bcm56990_a0_em_pse_info_qualifiers_fid_info));
