                                          ...
                                          bcmfp_stage_t *stage)
{
    ...
    BCMFP_QUAL_CFG_INIT(unit);
    BCMFP_QUAL_CFG_OFFSET_ADD(0, BCMFP_EXT_SECTION_FPF3, EFP_KEY1, offset1 + 157, 1);
    fid = FP_EGR_GRP_TEMPLATEt_QUAL_OPAQUE_TAG_PRESENTf;
    BCMFP_QUAL_CFG_INSERT(unit, stage, fid, qual_flags);
    ...
    BCMFP_QUAL_CFG_INIT(unit);
    BCMFP_QUAL_CFG_OFFSET_ADD(0, BCMFP_EXT_SECTION_FPF3, EFP_KEY2, offset2 + 204, 1);
    fid = FP_EGR_GRP_TEMPLATEt_QUAL_OPAQUE_TAG_PRESENTf;
    BCMFP_QUAL_CFG_INSERT(unit, stage, fid, qual_flags);
    ...
    BCMFP_QUAL_CFG_INIT(unit);
    BCMFP_QUAL_CFG_OFFSET_ADD(0, BCMFP_EXT_SECTION_FPF3, EFP_KEY7, offset7 + 58, 8);
    fid = FP_EGR_GRP_TEMPLATEt_QUAL_LOOPBACK_PP_PORTf;
    BCMFP_QUAL_CFG_INSERT(unit, stage, fid, qual_flags);

    BCMFP_QUAL_CFG_INIT(unit);
    BCMFP_QUAL_CFG_OFFSET_ADD(0, BCMFP_EXT_SECTION_FPF3, EFP_KEY7, offset7 + 58, 4);
    fid = FP_EGR_GRP_TEMPLATEt_QUAL_LOOPBACK_TRAFFIC_CLASSf;
    BCMFP_QUAL_CFG_INSERT(unit, stage, fid, qual_flags);

    BCMFP_QUAL_CFG_INIT(unit);
    BCMFP_QUAL_CFG_OFFSET_ADD(0, BCMFP_EXT_SECTION_FPF3, EFP_KEY7, offset7 + 62, 2);
    fid = FP_EGR_GRP_TEMPLATEt_QUAL_LOOPBACK_COLORf;
    BCMFP_QUAL_CFG_INSERT(unit, stage, fid, qual_flags);

    BCMFP_QUAL_CFG_INIT(unit);
    BCMFP_QUAL_CFG_OFFSET_ADD(0, BCMFP_EXT_SECTION_FPF3, EFP_KEY7, offset7 + 148, 3);
    fid = FP_EGR_GRP_TEMPLATEt_QUAL_LOOPBACK_MASQUERADE_PKT_PROFILEf;
    BCMFP_QUAL_CFG_INSERT(unit, stage, fid, qual_flags);

    BCMFP_QUAL_CFG_INIT(unit);
    BCMFP_QUAL_CFG_OFFSET_ADD(0, BCMFP_EXT_SECTION_FPF3, EFP_KEY7, offset7 + 151, 1);
    fid = FP_EGR_GRP_TEMPLATEt_QUAL_VISIBILITY_PKTf;
    BCMFP_QUAL_CFG_INSERT(unit, stage, fid, qual_flags);

    BCMFP_QUAL_CFG_INIT(unit);
    BCMFP_QUAL_CFG_OFFSET_ADD(0, BCMFP_EXT_SECTION_FPF3, EFP_KEY7, offset7 + 152, 16);
    ...
    BCMFP_QUAL_CFG_INIT(unit);
    BCMFP_QUAL_CFG_OFFSET_ADD(0, BCMFP_EXT_SECTION_FPF3, EFP_KEY7, offset7 + 174, 4);
