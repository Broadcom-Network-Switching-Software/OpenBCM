/*! \file bcm56990_a0_fp_egr_stage.c
 *
 * API to initialize Egress FP stage attributes for
 * Tomahawk-4(56990_A0) device.
 */
/*
                                            ...
                                            bcmfp_stage_t *stage)
{
    ...
    BCMFP_STAGE_FLAGS_ADD(stage, BCMFP_STAGE_FLEX_CTR_PER_SLICE_SUPPORT);
    ...
    stage->misc_info->num_groups = 48;
    stage->misc_info->num_keygen_prof = 0;
    stage->misc_info->num_qos_prof = 0;
    stage->misc_info->max_counter_profiles_per_group = 4;
exit:
    SHR_FUNC_EXIT();
}
