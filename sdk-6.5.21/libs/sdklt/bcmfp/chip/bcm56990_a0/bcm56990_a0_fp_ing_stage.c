/*! \file bcm56990_a0_fp_ing_stage.c
 *
 * API to initialize stage attributes for Tomahawk-4(56990_A0) device.
 */
/*
                                             ...
                                             bool warm)
{
    ...
    BCMFP_STAGE_FLAGS_ADD(stage, BCMFP_STAGE_DISABLE_ISDW_IN_MODE_AUTO);
    ...
    hw_entry_info->valid_fid = VALIDf;
    hw_entry_info->max_non_conflicting_groups = 9;
    key_data_sz_info->key_size[BCMFP_GROUP_MODE_DBLINTRA] = 320;
