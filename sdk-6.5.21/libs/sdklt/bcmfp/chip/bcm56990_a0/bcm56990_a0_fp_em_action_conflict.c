/*! \file bcm56990_a0_fp_em_action_conflict.c
 *
 *  IFP action conflict check function for Tomahawk-4(56990_A0).
 */
/*
                                               ...
                                               bcmfp_action_t action)
{
    ...
    switch (action1) {
        ...
        case FP_EM_POLICY_TEMPLATEt_ACTION_DELAYED_DROP_ENABLEf:
            ...
            fid = FP_EM_POLICY_TEMPLATEt_ACTION_REDIRECT_TO_MODULEf;
            BCMFP_ACTIONS_CONFLICT(fid);
