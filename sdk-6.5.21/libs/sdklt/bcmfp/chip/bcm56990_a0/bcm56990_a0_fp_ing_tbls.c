/*! \file bcm56990_a0_fp_ing_tbls.c
 *
...
bcm56990_a0_ingress_group_qualifiers_fid_info[FP_ING_GRP_TEMPLATEt_FIELD_COUNT];

bcmfp_tbl_qualifier_fid_info_t
bcm56990_a0_ingress_rule_qualifiers_fid_info[FP_ING_RULE_TEMPLATEt_FIELD_COUNT];

bcmfp_tbl_qualifier_fid_info_t
bcm56990_a0_ingress_group_template_action_qualifiers_fid_info[FP_ING_GRP_TEMPLATE_ACTIONt_FIELD_COUNT];


bcmfp_tbl_action_fid_info_t
bcm56990_a0_ingress_policy_actions_fid_info[FP_ING_POLICY_TEMPLATEt_FIELD_COUNT];

bcmfp_tbl_qualifier_fid_info_t
bcm56990_a0_ingress_pse_qualifiers_fid_info
                          [FP_ING_PRESEL_ENTRY_TEMPLATEt_FIELD_COUNT];

bcmfp_tbl_fid_remote_info_t bcm56990_a0_compress_remote_sid_info[4];
bcmfp_tbl_fid_remote_maps_t bcm56990_a0_compress_ipv4_dst_remote_maps[9];
bcmfp_tbl_fid_remote_maps_t bcm56990_a0_compress_ipv4_src_remote_maps[9];
bcmfp_tbl_fid_remote_maps_t bcm56990_a0_compress_ipv6_dst_remote_maps[9];
bcmfp_tbl_fid_remote_maps_t bcm56990_a0_compress_ipv6_src_remote_maps[9];
bcmfp_tbl_fid_remote_map_t bcm56990_a0_compress_ipv4_dst_remote_map[10];
bcmfp_tbl_fid_remote_map_t bcm56990_a0_compress_ipv4_src_remote_map[10];
bcmfp_tbl_fid_remote_map_t bcm56990_a0_compress_ipv6_dst_remote_map[9];
bcmfp_tbl_fid_remote_map_t bcm56990_a0_compress_ipv6_src_remote_map[9];

static void bcmfp_bcm56990_a0_ingress_group_qualifiers_map(void);
static void bcmfp_bcm56990_a0_ingress_group_template_action_qualifiers_map(void);
static void bcmfp_bcm56990_a0_ingress_rule_qualifiers_map(void);
static void bcmfp_bcm56990_a0_ingress_policy_actions_map(void);
static void bcmfp_bcm56990_a0_ingress_pse_qualifiers_map(void);

bcmfp_tbl_group_t bcm56990_a0_ing_group_tbl = {
    ...
    .qualifiers_fid_info = bcm56990_a0_ingress_group_qualifiers_fid_info,
    ...
    .group_slice_type_fid = FP_ING_GRP_TEMPLATEt_GRP_SLICE_TYPEf,
    .fid_count = FP_ING_GRP_TEMPLATEt_FIELD_COUNT,
};

bcmfp_tbl_group_template_action_t bcm56990_a0_ing_group_template_action_tbl = {
   .sid = FP_ING_GRP_TEMPLATE_ACTIONt,
   .key_fid = FP_ING_GRP_TEMPLATE_ACTIONt_FP_ING_GRP_TEMPLATE_IDf,
   .fid_count = FP_ING_GRP_TEMPLATE_ACTIONt_FIELD_COUNT,
   .qualifiers_fid_info =
       bcm56990_a0_ingress_group_template_action_qualifiers_fid_info,
    .qual_inports_fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_INPORTS_BITMAPf,
    .qual_system_ports_fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_SYSTEM_PORTS_BITMAPf,
    .qual_device_ports_fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_DEVICE_PORTS_BITMAPf,
    .qual_svp_ports_fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_SVP_PORTS_BITMAPf,
};

bcmfp_tbl_group_template_status_t bcm56990_a0_ing_group_template_status_tbl = {
   .sid = FP_ING_GRP_TEMPLATE_STATUSt,
   .key_fid = FP_ING_GRP_TEMPLATE_STATUSt_FP_ING_GRP_TEMPLATE_IDf,
   .status_fid = FP_ING_GRP_TEMPLATE_STATUSt_STATUSf,
};

bcmfp_tbl_group_info_t bcm56990_a0_ing_group_info_tbl = {
   ...
   .fid_count = FP_ING_GRP_TEMPLATE_INFOt_FIELD_COUNT,
};

bcmfp_tbl_rule_t bcm56990_a0_ing_rule_tbl = {
    ...
    .qualifiers_fid_info = bcm56990_a0_ingress_rule_qualifiers_fid_info,
...
bcmfp_tbl_policy_t bcm56990_a0_ing_policy_tbl = {
    ...
    .actions_fid_info = bcm56990_a0_ingress_policy_actions_fid_info,
    .fid_count = FP_ING_POLICY_TEMPLATEt_FIELD_COUNT,
};

bcmfp_tbl_pse_t bcm56990_a0_ing_pse_tbl = {
    ...
    .qualifiers_fid_info = bcm56990_a0_ingress_pse_qualifiers_fid_info,
};

bcmfp_tbl_entry_t bcm56990_a0_ing_entry_tbl = {
    .sid = FP_ING_ENTRYt,
...
bcmfp_tbl_src_class_t bcm56990_a0_ing_src_class_tbl = {
...
bcmfp_tbl_range_check_group_t bcm56990_a0_ing_range_check_group_tbl = {
...
bcmfp_tbl_meter_t bcm56990_a0_ing_meter_tbl = {
...
static void
bcmfp_bcm56990_a0_ingress_group_qualifiers_map(void)
{
    uint32_t fid;
    bcmfp_tbl_qualifier_fid_info_t *group_qualifiers_fid_info = NULL;

    group_qualifiers_fid_info = bcm56990_a0_ingress_group_qualifiers_fid_info;
    ...
    group_qualifiers_fid_info[fid].qualifier = 0;
    fid = FP_ING_GRP_TEMPLATEt_GRP_SLICE_TYPEf;
    group_qualifiers_fid_info[fid].qualifier = 0;
...
static void
bcmfp_bcm56990_a0_ingress_group_template_action_qualifiers_map(void)
{
    uint32_t fid;
    uint32_t map_fid;
    bcmfp_tbl_qualifier_fid_info_t *group_qualifiers_fid_info = NULL;
    bcmfp_tbl_qualifier_fid_info_t
        *group_template_action_qualifiers_fid_info = NULL;

    group_template_action_qualifiers_fid_info =
        bcm56990_a0_ingress_group_template_action_qualifiers_fid_info;
    group_qualifiers_fid_info = bcm56990_a0_ingress_group_qualifiers_fid_info;

    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_OUTER_VLAN_ID_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_OUTER_VLAN_ID_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_OUTER_VLAN_PRI_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_OUTER_VLAN_PRI_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_OUTER_VLAN_CFI_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_OUTER_VLAN_CFI_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_SRC_MAC_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_SRC_MAC_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_DST_MAC_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_DST_MAC_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_SRC_IP4_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_SRC_IP4_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_DST_IP4_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_DST_IP4_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_SRC_IP6_BITMAPu_UPPERf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_SRC_IP6_BITMAPu_UPPERf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_SRC_IP6_BITMAPu_LOWERf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_SRC_IP6_BITMAPu_LOWERf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_DST_IP6_BITMAPu_UPPERf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_DST_IP6_BITMAPu_UPPERf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;

    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_DST_IP6_BITMAPu_LOWERf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_DST_IP6_BITMAPu_LOWERf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;



    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_ETHERTYPE_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_ETHERTYPE_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_L4SRC_PORT_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_L4SRC_PORT_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_ICMP_TYPE_CODE_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_ICMP_TYPE_CODE_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_L4DST_PORT_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_L4DST_PORT_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_MPLS_FWD_LABEL_ID_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_MPLS_FWD_LABEL_ID_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_MPLS_FWD_LABEL_TTL_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_MPLS_FWD_LABEL_TTL_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_MPLS_FWD_LABEL_EXP_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_MPLS_FWD_LABEL_EXP_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_MPLS_FWD_LABEL_BOS_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_MPLS_FWD_LABEL_BOS_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_RTAG7A_HASH_UPPER_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_RTAG7A_HASH_UPPER_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_RTAG7A_HASH_LOWER_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_RTAG7A_HASH_LOWER_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_RTAG7B_HASH_UPPER_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_RTAG7B_HASH_UPPER_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_RTAG7B_HASH_LOWER_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_RTAG7B_HASH_LOWER_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_MPLS_CTRL_WORD_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_MPLS_CTRL_WORD_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_IP6_FLOW_LABEL_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_IP6_FLOW_LABEL_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_TTL_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_TTL_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_TOS_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_TOS_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_IP_PROTOCOL_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_IP_PROTOCOL_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_TCP_FLAGS_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_TCP_FLAGS_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_IP_FIRST_EH_PROTO_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_IP_FIRST_EH_PROTO_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_IP_SECOND_EH_PROTO_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_IP_SECOND_EH_PROTO_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_IP_FIRST_EH_SUBCODE_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_IP_FIRST_EH_SUBCODE_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_IP_FLAGS_MF_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_IP_FLAGS_MF_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_IP_FLAGS_DF_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_IP_FLAGS_DF_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_IP_FRAG_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_IP_FRAG_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;

    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_DROP_PKT_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_DROP_PKT_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_DOSATTACK_PKT_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_DOSATTACK_PKT_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_L4_PKT_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_L4_PKT_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_NON_OR_FIRST_FRAGMENT_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_NON_OR_FIRST_FRAGMENT_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_ICMP_ERROR_PKT_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_ICMP_ERROR_PKT_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_L2_SRC_HIT_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_L2_SRC_HIT_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_COMPRESSED_L3_SRC_HIT_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_COMPRESSED_L3_SRC_HIT_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_COMPRESSED_L3_DST_HIT_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_COMPRESSED_L3_DST_HIT_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_L2_DST_HIT_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_L2_DST_HIT_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_L3_SRC_LPM_HIT_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_L3_SRC_LPM_HIT_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_L3_DST_LPM_HIT_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_L3_DST_LPM_HIT_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_L3_TNL_HIT_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_L3_TNL_HIT_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_L2CACHE_HIT_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_L2CACHE_HIT_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_MPLSENTRY_FIRSTLOOKUP_HIT_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_MPLSENTRY_FIRSTLOOKUP_HIT_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_MPLSENTRY_SECONDLOOKUP_HIT_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_MPLSENTRY_SECONDLOOKUP_HIT_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_MPLS_BOS_TERMINATED_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_MPLS_BOS_TERMINATED_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_PORT_SYSTEM_CLASS_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_PORT_SYSTEM_CLASS_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_L3_IIF_CLASS_ID_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_L3_IIF_CLASS_ID_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_VLAN_CLASS_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_VLAN_CLASS_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_FP_VLAN_CLASS0_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_FP_VLAN_CLASS0_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_FP_VLAN_CLASS1_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_FP_VLAN_CLASS1_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_FP_VLAN_PORT_GRP_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_FP_VLAN_PORT_GRP_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_FP_ING_GRP_SEL_CLASS_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_FP_ING_GRP_SEL_CLASS_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_UDF_CLASS_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_UDF_CLASS_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_L2_SRC_CLASS_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_L2_SRC_CLASS_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_L2_DST_CLASS_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_L2_DST_CLASS_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_L3_SRC_CLASS_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_L3_SRC_CLASS_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_L3_DST_CLASS_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_L3_DST_CLASS_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_EM_GROUP_CLASS_ID_0_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_EM_GROUP_CLASS_ID_0_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_FWD_VLAN_VALID_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_FWD_VLAN_VALID_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_SRC_PORT_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_SRC_PORT_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_SRC_TRUNK_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_SRC_TRUNK_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_DST_PORT_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_DST_PORT_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_DST_TRUNK_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_DST_TRUNK_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_NHOP_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_NHOP_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_OVERLAY_ECMP_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_OVERLAY_ECMP_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_L2_MC_GROUP_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_L2_MC_GROUP_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_FWD_VLAN_ID_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_FWD_VLAN_ID_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_VRF_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_VRF_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_VPN_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_VPN_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_L3_IIF_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_L3_IIF_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_INPORTS_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_INPORTS_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_INPORT_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_INPORT_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_SYSTEM_PORTS_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_SYSTEM_PORTS_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_DEVICE_PORTS_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_DEVICE_PORTS_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_INT_PRI_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_INT_PRI_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_COLOR_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_COLOR_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_VLAN_OUTER_PRESENT_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_VLAN_OUTER_PRESENT_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_OPAQUE_TAG_PRESENT_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_OPAQUE_TAG_PRESENT_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_BYTES_0_7_AFTER_L2HEADER_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_BYTES_0_7_AFTER_L2HEADER_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_BYTES_8_15_AFTER_L2HEADER_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_BYTES_8_15_AFTER_L2HEADER_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_BYTES_16_23_AFTER_L2HEADER_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_BYTES_16_23_AFTER_L2HEADER_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_BYTES_24_31_AFTER_L2HEADER_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_BYTES_24_31_AFTER_L2HEADER_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_INNER_DST_IP6_BITMAPu_UPPERf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_INNER_DST_IP6_BITMAPu_UPPERf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;

    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_INNER_DST_IP6_BITMAPu_LOWERf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_INNER_DST_IP6_BITMAPu_LOWERf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;



    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_IP_CHECKSUM_VALID_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_IP_CHECKSUM_VALID_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_BFD_DISCRIMINATOR_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_BFD_DISCRIMINATOR_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_PKT_LENGTH_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_PKT_LENGTH_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_OPAQUE_TAG_LOW_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_OPAQUE_TAG_LOW_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_OPAQUE_TAG_HIGH_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_OPAQUE_TAG_HIGH_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_RANGE_CHECKID_BMP_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_RANGE_CHECKID_BMP_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_RANGE_CHECK_GRP_ID_BMP_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_RANGE_CHECK_GRP_ID_BMP_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_MPLS_FWD_LABEL_ACTION_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_MPLS_FWD_LABEL_ACTION_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;

    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_TNL_TYPE_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_TNL_TYPE_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;

    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_LOOPBACK_TYPE_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_LOOPBACK_TYPE_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;

    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_LOOPBACK_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_LOOPBACK_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_PROTECTION_DATA_DROP_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_PROTECTION_DATA_DROP_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_L2_SRC_STATIC_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_L2_SRC_STATIC_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_L2STATION_MOVE_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_L2STATION_MOVE_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_INBAND_TELEMETRY_HDR_IN_TNL_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_INBAND_TELEMETRY_HDR_IN_TNL_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_PKT_RESOLUTION_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_PKT_RESOLUTION_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_EM_FIRST_LOOKUP_HITf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_EM_FIRST_LOOKUP_HITf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_EM_FIRST_LOOKUP_CLASS_ID_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_EM_FIRST_LOOKUP_CLASS_ID_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_IP_TYPE_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_IP_TYPE_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;

    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_L2_FORMAT_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_L2_FORMAT_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;

    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_MYSTATIONTCAM_HIT_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_MYSTATIONTCAM_HIT_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_L3_ROUTABLE_PKT_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_L3_ROUTABLE_PKT_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_INNER_TPID_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_INNER_TPID_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;

    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_OUTER_TPID_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_OUTER_TPID_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;

    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_FWD_TYPE_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_FWD_TYPE_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;

    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_ING_STP_STATE_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_ING_STP_STATE_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;

    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_UDF_CHUNKS_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_UDF_CHUNKS_BITMAPf;
    map_fid = group_qualifiers_fid_info[map_fid].qualifier;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_C_IP_PROTOCOL_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_C_IP_PROTOCOL_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_C_ETHERTYPE_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_C_ETHERTYPE_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_C_TTL0_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_C_TTL0_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_C_TTL1_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_C_TTL1_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_C_TOS0_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_C_TOS0_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_C_TOS1_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_C_TOS1_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_C_TCP_FLAGS0_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_C_TCP_FLAGS0_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_C_TCP_FLAGS1_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_C_TCP_FLAGS1_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_TNL_IP_TTL_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_TNL_IP_TTL_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_C_TNL_IP_TTL_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_C_TNL_IP_TTL_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_INBAND_TELEMETRY_FLAGS_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_INBAND_TELEMETRY_FLAGS_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_INBAND_TELEMETRY_MD_HDR_TYPE_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_INBAND_TELEMETRY_MD_HDR_TYPE_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_INBAND_TELEMETRY_HOP_LIMIT_CHECK_STATUS_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_INBAND_TELEMETRY_HOP_LIMIT_CHECK_STATUS_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_INBAND_TELEMETRY_MAX_LENGTH_CHECK_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_INBAND_TELEMETRY_MAX_LENGTH_CHECK_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_INBAND_TELEMETRY_HDR_TYPE_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_INBAND_TELEMETRY_HDR_TYPE_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_INBAND_TELEMETRY_UDP_CHECKSUM_ZERO_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_INBAND_TELEMETRY_UDP_CHECKSUM_ZERO_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_L3_MC_GROUP_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_L3_MC_GROUP_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_PRESEL_CLASS_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_PRESEL_CLASS_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_MPLS_SPECIAL_LABEL_RAL_DETECTED_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_MPLS_SPECIAL_LABEL_RAL_DETECTED_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_MPLS_SPECIAL_LABEL_GAL_DETECTED_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_MPLS_SPECIAL_LABEL_GAL_DETECTED_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_MPLS_SPECIAL_LABEL_CW_DETECTED_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_MPLS_SPECIAL_LABEL_CW_DETECTED_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_L3_L4_COMPRESSION_ID_A_0_15_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_L3_L4_COMPRESSION_ID_A_0_15_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_L3_L4_COMPRESSION_ID_B_0_15_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_L3_L4_COMPRESSION_ID_B_0_15_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_L3_L4_COMPRESSION_ID_A_31_16_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_L3_L4_COMPRESSION_ID_A_31_16_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_L3_L4_COMPRESSION_ID_B_31_16_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_L3_L4_COMPRESSION_ID_B_31_16_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_RH_FIRST_4_BYTES_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_RH_FIRST_4_BYTES_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_RH_NEXT_4_BYTES_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_RH_NEXT_4_BYTES_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_VXLAN_VNID_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_VXLAN_VNID_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_VXLAN_FLAGS_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_VXLAN_FLAGS_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_VXLAN_RSVD_24_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_VXLAN_RSVD_24_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;


    fid = FP_ING_GRP_TEMPLATE_ACTIONt_QUAL_VXLAN_RSVD_8_BITMAPf;
    map_fid = FP_ING_GRP_TEMPLATEt_QUAL_VXLAN_RSVD_8_BITMAPf;
    group_template_action_qualifiers_fid_info[fid].qualifier = map_fid;
}

static void
bcmfp_bcm56990_a0_ingress_rule_qualifiers_map(void)
{
    uint32_t fid;
    uint32_t map_fid;
    bcmfp_tbl_qualifier_fid_info_t *group_qualifiers_fid_info = NULL;
    ...
    rule_qualifiers_fid_info = bcm56990_a0_ingress_rule_qualifiers_fid_info;
    group_qualifiers_fid_info = bcm56990_a0_ingress_group_qualifiers_fid_info;
...
static void
bcmfp_bcm56990_a0_ingress_compression_remote_fid_map(void)
{
    /* L3 Compression DST IPV4 */
    bcm56990_a0_compress_ipv4_dst_remote_map[0].fid = FP_ING_RULE_TEMPLATEt_QUAL_DST_IP4f;
    bcm56990_a0_compress_ipv4_dst_remote_map[0].offset = 0;
    bcm56990_a0_compress_ipv4_dst_remote_map[0].width = 32;

    bcm56990_a0_compress_ipv4_dst_remote_maps[0].fid = L3_IPV4_COMP_DSTt_IPV4f;
    bcm56990_a0_compress_ipv4_dst_remote_maps[0].num_remote_map = 1;
    bcm56990_a0_compress_ipv4_dst_remote_maps[0].remote_map = &bcm56990_a0_compress_ipv4_dst_remote_map[0];

    bcm56990_a0_compress_ipv4_dst_remote_map[1].fid = FP_ING_RULE_TEMPLATEt_QUAL_DST_MACf;
    bcm56990_a0_compress_ipv4_dst_remote_map[1].offset = 0;
    bcm56990_a0_compress_ipv4_dst_remote_map[1].width = 48;

    bcm56990_a0_compress_ipv4_dst_remote_maps[1].fid = L3_IPV4_COMP_DSTt_MACf;
    bcm56990_a0_compress_ipv4_dst_remote_maps[1].num_remote_map = 1;
    bcm56990_a0_compress_ipv4_dst_remote_maps[1].remote_map = &bcm56990_a0_compress_ipv4_dst_remote_map[1];

    bcm56990_a0_compress_ipv4_dst_remote_map[2].fid = FP_ING_RULE_TEMPLATEt_QUAL_VRFf;
    bcm56990_a0_compress_ipv4_dst_remote_map[2].offset = 0;
    bcm56990_a0_compress_ipv4_dst_remote_map[2].width = 13;

    bcm56990_a0_compress_ipv4_dst_remote_maps[2].fid = L3_IPV4_COMP_DSTt_VRFf;
    bcm56990_a0_compress_ipv4_dst_remote_maps[2].num_remote_map = 1;
    bcm56990_a0_compress_ipv4_dst_remote_maps[2].remote_map = &bcm56990_a0_compress_ipv4_dst_remote_map[2];

    bcm56990_a0_compress_ipv4_dst_remote_map[3].fid = FP_ING_RULE_TEMPLATEt_QUAL_L4DST_PORTf;
    bcm56990_a0_compress_ipv4_dst_remote_map[3].offset = 0;
    bcm56990_a0_compress_ipv4_dst_remote_map[3].width = 16;

    bcm56990_a0_compress_ipv4_dst_remote_maps[3].fid = L3_IPV4_COMP_DSTt_L4_PORTf;
    bcm56990_a0_compress_ipv4_dst_remote_maps[3].num_remote_map = 1;
    bcm56990_a0_compress_ipv4_dst_remote_maps[3].remote_map = &bcm56990_a0_compress_ipv4_dst_remote_map[3];

    bcm56990_a0_compress_ipv4_dst_remote_map[4].fid = FP_ING_RULE_TEMPLATEt_QUAL_IP_PROTOCOLf;
    bcm56990_a0_compress_ipv4_dst_remote_map[4].offset = 0;
    bcm56990_a0_compress_ipv4_dst_remote_map[4].width = 8;

    bcm56990_a0_compress_ipv4_dst_remote_maps[4].fid = L3_IPV4_COMP_DSTt_IP_PROTOCOLf;
    bcm56990_a0_compress_ipv4_dst_remote_maps[4].num_remote_map = 1;
    bcm56990_a0_compress_ipv4_dst_remote_maps[4].remote_map = &bcm56990_a0_compress_ipv4_dst_remote_map[4];

    bcm56990_a0_compress_ipv4_dst_remote_map[5].fid = FP_ING_RULE_TEMPLATEt_QUAL_TCP_FLAGSf;
    bcm56990_a0_compress_ipv4_dst_remote_map[5].offset = 0;
    bcm56990_a0_compress_ipv4_dst_remote_map[5].width = 8;

    bcm56990_a0_compress_ipv4_dst_remote_maps[5].fid = L3_IPV4_COMP_DSTt_TCP_FLAGSf;
    bcm56990_a0_compress_ipv4_dst_remote_maps[5].num_remote_map = 1;
    bcm56990_a0_compress_ipv4_dst_remote_maps[5].remote_map = &bcm56990_a0_compress_ipv4_dst_remote_map[5];

    bcm56990_a0_compress_ipv4_dst_remote_map[6].fid = FP_ING_RULE_TEMPLATEt_QUAL_IP_FLAGS_MFf;
    bcm56990_a0_compress_ipv4_dst_remote_map[6].offset = 0;
    bcm56990_a0_compress_ipv4_dst_remote_map[6].width = 1;

    bcm56990_a0_compress_ipv4_dst_remote_map[7].fid = FP_ING_RULE_TEMPLATEt_QUAL_IP_FLAGS_DFf;
    bcm56990_a0_compress_ipv4_dst_remote_map[7].offset = 0;
    bcm56990_a0_compress_ipv4_dst_remote_map[7].width = 1;

    bcm56990_a0_compress_ipv4_dst_remote_maps[6].fid = L3_IPV4_COMP_DSTt_IP_FLAGSf;
    bcm56990_a0_compress_ipv4_dst_remote_maps[6].num_remote_map = 2;
    bcm56990_a0_compress_ipv4_dst_remote_maps[6].remote_map = &bcm56990_a0_compress_ipv4_dst_remote_map[6];

    bcm56990_a0_compress_ipv4_dst_remote_map[8].fid = FP_ING_RULE_TEMPLATEt_QUAL_L3_L4_COMPRESSION_ID_A_0_15f;
    bcm56990_a0_compress_ipv4_dst_remote_map[8].offset = 0;
    bcm56990_a0_compress_ipv4_dst_remote_map[8].width = 16;

    bcm56990_a0_compress_ipv4_dst_remote_maps[7].fid = L3_IPV4_COMP_DSTt_CLASS_IDf;
    bcm56990_a0_compress_ipv4_dst_remote_maps[7].num_remote_map = 1;
    bcm56990_a0_compress_ipv4_dst_remote_maps[7].remote_map = &bcm56990_a0_compress_ipv4_dst_remote_map[8];

    bcm56990_a0_compress_remote_sid_info[0].sid = L3_IPV4_COMP_DSTt;
    bcm56990_a0_compress_remote_sid_info[0].remote_maps = bcm56990_a0_compress_ipv4_dst_remote_maps;
    bcm56990_a0_compress_remote_sid_info[0].num_remote_maps = 8;

    /* L3 Compression SRC IPV4 */
    bcm56990_a0_compress_ipv4_src_remote_map[0].fid = FP_ING_RULE_TEMPLATEt_QUAL_SRC_IP4f;
    bcm56990_a0_compress_ipv4_src_remote_map[0].offset = 0;
    bcm56990_a0_compress_ipv4_src_remote_map[0].width = 32;

    bcm56990_a0_compress_ipv4_src_remote_maps[0].fid = L3_IPV4_COMP_SRCt_IPV4f;
    bcm56990_a0_compress_ipv4_src_remote_maps[0].num_remote_map = 1;
    bcm56990_a0_compress_ipv4_src_remote_maps[0].remote_map = &bcm56990_a0_compress_ipv4_src_remote_map[0];

    bcm56990_a0_compress_ipv4_src_remote_map[1].fid = FP_ING_RULE_TEMPLATEt_QUAL_SRC_MACf;
    bcm56990_a0_compress_ipv4_src_remote_map[1].offset = 0;
    bcm56990_a0_compress_ipv4_src_remote_map[1].width = 48;

    bcm56990_a0_compress_ipv4_src_remote_maps[1].fid = L3_IPV4_COMP_SRCt_MACf;
    bcm56990_a0_compress_ipv4_src_remote_maps[1].num_remote_map = 1;
    bcm56990_a0_compress_ipv4_src_remote_maps[1].remote_map = &bcm56990_a0_compress_ipv4_src_remote_map[1];

    bcm56990_a0_compress_ipv4_src_remote_map[2].fid = FP_ING_RULE_TEMPLATEt_QUAL_VRFf;
    bcm56990_a0_compress_ipv4_src_remote_map[2].offset = 0;
    bcm56990_a0_compress_ipv4_src_remote_map[2].width = 13;

    bcm56990_a0_compress_ipv4_src_remote_maps[2].fid = L3_IPV4_COMP_SRCt_VRFf;
    bcm56990_a0_compress_ipv4_src_remote_maps[2].num_remote_map = 1;
    bcm56990_a0_compress_ipv4_src_remote_maps[2].remote_map = &bcm56990_a0_compress_ipv4_src_remote_map[2];

    bcm56990_a0_compress_ipv4_src_remote_map[3].fid = FP_ING_RULE_TEMPLATEt_QUAL_L4SRC_PORTf;
    bcm56990_a0_compress_ipv4_src_remote_map[3].offset = 0;
    bcm56990_a0_compress_ipv4_src_remote_map[3].width = 16;

    bcm56990_a0_compress_ipv4_src_remote_maps[3].fid = L3_IPV4_COMP_SRCt_L4_PORTf;
    bcm56990_a0_compress_ipv4_src_remote_maps[3].num_remote_map = 1;
    bcm56990_a0_compress_ipv4_src_remote_maps[3].remote_map = &bcm56990_a0_compress_ipv4_src_remote_map[3];

    bcm56990_a0_compress_ipv4_src_remote_map[4].fid = FP_ING_RULE_TEMPLATEt_QUAL_IP_PROTOCOLf;
    bcm56990_a0_compress_ipv4_src_remote_map[4].offset = 0;
    bcm56990_a0_compress_ipv4_src_remote_map[4].width = 8;

    bcm56990_a0_compress_ipv4_src_remote_maps[4].fid = L3_IPV4_COMP_SRCt_IP_PROTOCOLf;
    bcm56990_a0_compress_ipv4_src_remote_maps[4].num_remote_map = 1;
    bcm56990_a0_compress_ipv4_src_remote_maps[4].remote_map = &bcm56990_a0_compress_ipv4_src_remote_map[4];

    bcm56990_a0_compress_ipv4_src_remote_map[5].fid = FP_ING_RULE_TEMPLATEt_QUAL_TCP_FLAGSf;
    bcm56990_a0_compress_ipv4_src_remote_map[5].offset = 0;
    bcm56990_a0_compress_ipv4_src_remote_map[5].width = 8;

    bcm56990_a0_compress_ipv4_src_remote_maps[5].fid = L3_IPV4_COMP_SRCt_TCP_FLAGSf;
    bcm56990_a0_compress_ipv4_src_remote_maps[5].num_remote_map = 1;
    bcm56990_a0_compress_ipv4_src_remote_maps[5].remote_map = &bcm56990_a0_compress_ipv4_src_remote_map[5];

    bcm56990_a0_compress_ipv4_src_remote_map[6].fid = FP_ING_RULE_TEMPLATEt_QUAL_IP_FLAGS_MFf;
    bcm56990_a0_compress_ipv4_src_remote_map[6].offset = 0;
    bcm56990_a0_compress_ipv4_src_remote_map[6].width = 1;

    bcm56990_a0_compress_ipv4_src_remote_map[7].fid = FP_ING_RULE_TEMPLATEt_QUAL_IP_FLAGS_DFf;
    bcm56990_a0_compress_ipv4_src_remote_map[7].offset = 0;
    bcm56990_a0_compress_ipv4_src_remote_map[7].width = 1;

    bcm56990_a0_compress_ipv4_src_remote_maps[6].fid = L3_IPV4_COMP_SRCt_IP_FLAGSf;
    bcm56990_a0_compress_ipv4_src_remote_maps[6].num_remote_map = 2;
    bcm56990_a0_compress_ipv4_src_remote_maps[6].remote_map = &bcm56990_a0_compress_ipv4_src_remote_map[6];

    bcm56990_a0_compress_ipv4_src_remote_map[8].fid = FP_ING_RULE_TEMPLATEt_QUAL_L3_L4_COMPRESSION_ID_B_0_15f;
    bcm56990_a0_compress_ipv4_src_remote_map[8].offset = 0;
    bcm56990_a0_compress_ipv4_src_remote_map[8].width = 16;

    bcm56990_a0_compress_ipv4_src_remote_maps[7].fid = L3_IPV4_COMP_SRCt_CLASS_IDf;
    bcm56990_a0_compress_ipv4_src_remote_maps[7].num_remote_map = 1;
    bcm56990_a0_compress_ipv4_src_remote_maps[7].remote_map = &bcm56990_a0_compress_ipv4_src_remote_map[8];

    bcm56990_a0_compress_remote_sid_info[1].sid = L3_IPV4_COMP_SRCt;
    bcm56990_a0_compress_remote_sid_info[1].remote_maps = bcm56990_a0_compress_ipv4_src_remote_maps;
    bcm56990_a0_compress_remote_sid_info[1].num_remote_maps = 8;

    /* L3 Compression DST IPV6 */
    bcm56990_a0_compress_ipv6_dst_remote_map[0].fid = FP_ING_RULE_TEMPLATEt_QUAL_DST_IP6u_LOWERf;
    bcm56990_a0_compress_ipv6_dst_remote_map[0].offset = 0;
    bcm56990_a0_compress_ipv6_dst_remote_map[0].width = 64;

    bcm56990_a0_compress_ipv6_dst_remote_maps[0].fid = L3_IPV6_COMP_DSTt_IPV6u_LOWERf;
    bcm56990_a0_compress_ipv6_dst_remote_maps[0].num_remote_map = 1;
    bcm56990_a0_compress_ipv6_dst_remote_maps[0].remote_map = &bcm56990_a0_compress_ipv6_dst_remote_map[0];

    bcm56990_a0_compress_ipv6_dst_remote_map[1].fid = FP_ING_RULE_TEMPLATEt_QUAL_DST_IP6u_UPPERf;
    bcm56990_a0_compress_ipv6_dst_remote_map[1].offset = 0;
    bcm56990_a0_compress_ipv6_dst_remote_map[1].width = 64;

    bcm56990_a0_compress_ipv6_dst_remote_maps[1].fid = L3_IPV6_COMP_DSTt_IPV6u_UPPERf;
    bcm56990_a0_compress_ipv6_dst_remote_maps[1].num_remote_map = 1;
    bcm56990_a0_compress_ipv6_dst_remote_maps[1].remote_map = &bcm56990_a0_compress_ipv6_dst_remote_map[1];

    bcm56990_a0_compress_ipv6_dst_remote_map[2].fid = FP_ING_RULE_TEMPLATEt_QUAL_VRFf;
    bcm56990_a0_compress_ipv6_dst_remote_map[2].offset = 0;
    bcm56990_a0_compress_ipv6_dst_remote_map[2].width = 13;

    bcm56990_a0_compress_ipv6_dst_remote_maps[2].fid = L3_IPV6_COMP_DSTt_VRFf;
    bcm56990_a0_compress_ipv6_dst_remote_maps[2].num_remote_map = 1;
    bcm56990_a0_compress_ipv6_dst_remote_maps[2].remote_map = &bcm56990_a0_compress_ipv6_dst_remote_map[2];

    bcm56990_a0_compress_ipv6_dst_remote_map[3].fid = FP_ING_RULE_TEMPLATEt_QUAL_L4DST_PORTf;
    bcm56990_a0_compress_ipv6_dst_remote_map[3].offset = 0;
    bcm56990_a0_compress_ipv6_dst_remote_map[3].width = 16;

    bcm56990_a0_compress_ipv6_dst_remote_maps[3].fid = L3_IPV6_COMP_DSTt_L4_PORTf;
    bcm56990_a0_compress_ipv6_dst_remote_maps[3].num_remote_map = 1;
    bcm56990_a0_compress_ipv6_dst_remote_maps[3].remote_map = &bcm56990_a0_compress_ipv6_dst_remote_map[3];

    bcm56990_a0_compress_ipv6_dst_remote_map[4].fid = FP_ING_RULE_TEMPLATEt_QUAL_IP_PROTOCOLf;
    bcm56990_a0_compress_ipv6_dst_remote_map[4].offset = 0;
    bcm56990_a0_compress_ipv6_dst_remote_map[4].width = 8;

    bcm56990_a0_compress_ipv6_dst_remote_maps[4].fid = L3_IPV6_COMP_DSTt_IP_PROTOCOLf;
    bcm56990_a0_compress_ipv6_dst_remote_maps[4].num_remote_map = 1;
    bcm56990_a0_compress_ipv6_dst_remote_maps[4].remote_map = &bcm56990_a0_compress_ipv6_dst_remote_map[4];

    bcm56990_a0_compress_ipv6_dst_remote_map[5].fid = FP_ING_RULE_TEMPLATEt_QUAL_TCP_FLAGSf;
    bcm56990_a0_compress_ipv6_dst_remote_map[5].offset = 0;
    bcm56990_a0_compress_ipv6_dst_remote_map[5].width = 8;

    bcm56990_a0_compress_ipv6_dst_remote_maps[5].fid = L3_IPV6_COMP_DSTt_TCP_FLAGSf;
    bcm56990_a0_compress_ipv6_dst_remote_maps[5].num_remote_map = 1;
    bcm56990_a0_compress_ipv6_dst_remote_maps[5].remote_map = &bcm56990_a0_compress_ipv6_dst_remote_map[5];

    bcm56990_a0_compress_ipv6_dst_remote_map[6].fid = FP_ING_RULE_TEMPLATEt_QUAL_L3_L4_COMPRESSION_ID_A_0_15f;
    bcm56990_a0_compress_ipv6_dst_remote_map[6].offset = 0;
    bcm56990_a0_compress_ipv6_dst_remote_map[6].width = 16;

    bcm56990_a0_compress_ipv6_dst_remote_maps[6].fid = L3_IPV6_COMP_DSTt_CLASS_IDf;
    bcm56990_a0_compress_ipv6_dst_remote_maps[6].num_remote_map = 1;
    bcm56990_a0_compress_ipv6_dst_remote_maps[6].remote_map = &bcm56990_a0_compress_ipv6_dst_remote_map[6];

    bcm56990_a0_compress_remote_sid_info[2].sid = L3_IPV6_COMP_DSTt;
    bcm56990_a0_compress_remote_sid_info[2].remote_maps = bcm56990_a0_compress_ipv6_dst_remote_maps;
    bcm56990_a0_compress_remote_sid_info[2].num_remote_maps = 7;

    /* L3 Compression SRC IPV6 */
    bcm56990_a0_compress_ipv6_src_remote_map[0].fid = FP_ING_RULE_TEMPLATEt_QUAL_SRC_IP6u_LOWERf;
    bcm56990_a0_compress_ipv6_src_remote_map[0].offset = 0;
    bcm56990_a0_compress_ipv6_src_remote_map[0].width = 64;

    bcm56990_a0_compress_ipv6_src_remote_maps[0].fid = L3_IPV6_COMP_SRCt_IPV6u_LOWERf;
    bcm56990_a0_compress_ipv6_src_remote_maps[0].num_remote_map = 1;
    bcm56990_a0_compress_ipv6_src_remote_maps[0].remote_map = &bcm56990_a0_compress_ipv6_src_remote_map[0];

    bcm56990_a0_compress_ipv6_src_remote_map[1].fid = FP_ING_RULE_TEMPLATEt_QUAL_SRC_IP6u_UPPERf;
    bcm56990_a0_compress_ipv6_src_remote_map[1].offset = 0;
    bcm56990_a0_compress_ipv6_src_remote_map[1].width = 64;

    bcm56990_a0_compress_ipv6_src_remote_maps[1].fid = L3_IPV6_COMP_SRCt_IPV6u_UPPERf;
    bcm56990_a0_compress_ipv6_src_remote_maps[1].num_remote_map = 1;
    bcm56990_a0_compress_ipv6_src_remote_maps[1].remote_map = &bcm56990_a0_compress_ipv6_src_remote_map[1];

    bcm56990_a0_compress_ipv6_src_remote_map[2].fid = FP_ING_RULE_TEMPLATEt_QUAL_VRFf;
    bcm56990_a0_compress_ipv6_src_remote_map[2].offset = 0;
    bcm56990_a0_compress_ipv6_src_remote_map[2].width = 13;

    bcm56990_a0_compress_ipv6_src_remote_maps[2].fid = L3_IPV6_COMP_SRCt_VRFf;
    bcm56990_a0_compress_ipv6_src_remote_maps[2].num_remote_map = 1;
    bcm56990_a0_compress_ipv6_src_remote_maps[2].remote_map = &bcm56990_a0_compress_ipv6_src_remote_map[2];

    bcm56990_a0_compress_ipv6_src_remote_map[3].fid = FP_ING_RULE_TEMPLATEt_QUAL_L4SRC_PORTf;
    bcm56990_a0_compress_ipv6_src_remote_map[3].offset = 0;
    bcm56990_a0_compress_ipv6_src_remote_map[3].width = 16;

    bcm56990_a0_compress_ipv6_src_remote_maps[3].fid = L3_IPV6_COMP_SRCt_L4_PORTf;
    bcm56990_a0_compress_ipv6_src_remote_maps[3].num_remote_map = 1;
    bcm56990_a0_compress_ipv6_src_remote_maps[3].remote_map = &bcm56990_a0_compress_ipv6_src_remote_map[3];

    bcm56990_a0_compress_ipv6_src_remote_map[4].fid = FP_ING_RULE_TEMPLATEt_QUAL_IP_PROTOCOLf;
    bcm56990_a0_compress_ipv6_src_remote_map[4].offset = 0;
    bcm56990_a0_compress_ipv6_src_remote_map[4].width = 8;

    bcm56990_a0_compress_ipv6_src_remote_maps[4].fid = L3_IPV6_COMP_SRCt_IP_PROTOCOLf;
    bcm56990_a0_compress_ipv6_src_remote_maps[4].num_remote_map = 1;
    bcm56990_a0_compress_ipv6_src_remote_maps[4].remote_map = &bcm56990_a0_compress_ipv6_src_remote_map[4];

    bcm56990_a0_compress_ipv6_src_remote_map[5].fid = FP_ING_RULE_TEMPLATEt_QUAL_TCP_FLAGSf;
    bcm56990_a0_compress_ipv6_src_remote_map[5].offset = 0;
    bcm56990_a0_compress_ipv6_src_remote_map[5].width = 8;

    bcm56990_a0_compress_ipv6_src_remote_maps[5].fid = L3_IPV6_COMP_SRCt_TCP_FLAGSf;
    bcm56990_a0_compress_ipv6_src_remote_maps[5].num_remote_map = 1;
    bcm56990_a0_compress_ipv6_src_remote_maps[5].remote_map = &bcm56990_a0_compress_ipv6_src_remote_map[5];

    bcm56990_a0_compress_ipv6_src_remote_map[6].fid = FP_ING_RULE_TEMPLATEt_QUAL_L3_L4_COMPRESSION_ID_B_0_15f;
    bcm56990_a0_compress_ipv6_src_remote_map[6].offset = 0;
    bcm56990_a0_compress_ipv6_src_remote_map[6].width = 16;

    bcm56990_a0_compress_ipv6_src_remote_maps[6].fid = L3_IPV6_COMP_SRCt_CLASS_IDf;
    bcm56990_a0_compress_ipv6_src_remote_maps[6].num_remote_map = 1;
    bcm56990_a0_compress_ipv6_src_remote_maps[6].remote_map = &bcm56990_a0_compress_ipv6_src_remote_map[6];

    bcm56990_a0_compress_remote_sid_info[3].sid = L3_IPV6_COMP_SRCt;
    bcm56990_a0_compress_remote_sid_info[3].remote_maps = bcm56990_a0_compress_ipv6_src_remote_maps;
    bcm56990_a0_compress_remote_sid_info[3].num_remote_maps = 7;
}

static void
bcmfp_bcm56990_a0_ingress_policy_actions_map(void)
{
    uint32_t fid;
    bcmfp_tbl_action_fid_info_t *policy_actions_fid_info = NULL;

    policy_actions_fid_info = bcm56990_a0_ingress_policy_actions_fid_info;
...
static void
bcmfp_bcm56990_a0_ingress_pse_qualifiers_map(void)
{
    uint32_t fid;
    uint32_t map_fid;
                                ...
                                bcmfp_stage_t *stage)
{
    ...
    stage->tbls.group_tbl = &bcm56990_a0_ing_group_tbl;
    stage->tbls.group_info_tbl = &bcm56990_a0_ing_group_info_tbl;
    stage->tbls.group_template_action_tbl =
        &bcm56990_a0_ing_group_template_action_tbl;
    stage->tbls.group_template_status_tbl =
        &bcm56990_a0_ing_group_template_status_tbl;
    stage->tbls.rule_tbl = &bcm56990_a0_ing_rule_tbl;
    stage->tbls.policy_tbl = &bcm56990_a0_ing_policy_tbl;
    stage->tbls.entry_tbl = &bcm56990_a0_ing_entry_tbl;
    stage->tbls.pse_tbl = &bcm56990_a0_ing_pse_tbl;
    stage->tbls.src_class_tbl = &bcm56990_a0_ing_src_class_tbl;
    stage->tbls.range_check_group_tbl = &bcm56990_a0_ing_range_check_group_tbl;
    stage->tbls.meter_tbl = &bcm56990_a0_ing_meter_tbl;
    stage->tbls.num_compress_fid_remote_info = 4;
    stage->tbls.compress_fid_remote_info = bcm56990_a0_compress_remote_sid_info;
    (void)bcmfp_bcm56990_a0_ingress_group_qualifiers_map();
    (void)bcmfp_bcm56990_a0_ingress_group_template_action_qualifiers_map();
    (void)bcmfp_bcm56990_a0_ingress_rule_qualifiers_map();
    (void)bcmfp_bcm56990_a0_ingress_policy_actions_map();
    (void)bcmfp_bcm56990_a0_ingress_pse_qualifiers_map();
    (void)bcmfp_bcm56990_a0_ingress_compression_remote_fid_map();
