/*! \file bcm56990_a0_fp_vlan_action_db.c
 *
 * VFP action configuration DB initialization function for Tomahawk-4(56990_A0).
 */
/*
                                          ...
                                          bcmfp_stage_t *stage)
{
    ...
    fid = FP_VLAN_POLICY_TEMPLATEt_ACTION_FP_VLAN_HASH_TABLE_A_IDf;
    BCMFP_ACTION_CFG_ADD_ONE(unit, stage, fid,
            0, 0, 53, 4, -1);

    fid = FP_VLAN_POLICY_TEMPLATEt_ACTION_FP_VLAN_HASH_TABLE_B_IDf;
    BCMFP_ACTION_CFG_ADD_ONE(unit, stage, fid,
            0, 0, 57, 4, -1);
