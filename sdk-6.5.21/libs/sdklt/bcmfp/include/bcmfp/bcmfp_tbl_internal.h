...
typedef struct bcmfp_tbl_compress_fid_info_s {
    ...
    /*! Indicates whether the mask_fid is maskable or not. */
    bool *maskable;
...
typedef struct bcmfp_tbl_group_s {
    ...
    /*! Field Identifier for SVP_PORTS qualifier. */
    uint32_t qual_svp_ports_fid;
    ...
    /*! Field Identifier for conflict qualifier set IDs array. */
    uint32_t conflict_qset_ids_fid;
    ...
    /*!
     * Field Identifier for number of counter profiles assigned
     * to the group.
     */
    uint32_t ctr_prof_ids_count_fid;

    /*! Field Identifier for counter profiles array. */
    uint32_t ctr_prof_ids_fid;
...
/*! Logical Table details(SID and some FIDs) for grp_template_status */
typedef struct bcmfp_tbl_group_template_status_s {
...
} bcmfp_tbl_group_template_status_t;

/*! Logical Table details(SID and some FIDs) for grp_template_action */
typedef struct bcmfp_tbl_group_template_action_s {
    ...
    /*!
     * Array to map qualifiers LT fields in group template action table to
...
} bcmfp_tbl_group_template_action_t;
...
typedef struct bcmfp_tbl_rule_s {
    ...
    /*! Field Identifier for SVP_PORTS qualifier. */
    uint32_t svp_ports_key_fid;

    /*! Field Identifier for SVP_PORTS qualifier. */
    uint32_t svp_ports_mask_fid;
...
#define BCMFP_ACTION_ARRAY_ELEMENTS_MAX 4

typedef struct bcmfp_tbl_action_fid_info_s {

    uint32_t action;

    uint32_t array_actions[BCMFP_ACTION_ARRAY_ELEMENTS_MAX];

    uint8_t array_actions_count;
...
typedef struct bcmfp_tbl_entry_s {
    ...
    /*! Field identifier for Flowtracker enable/disable. */
    uint32_t flowtracker_fid;
...
/*! Logical Table details(SID and some FIDs) for conflict qualifier set. */
typedef struct bcmfp_tbl_conflict_qset_s {
    ...
    /*!
     * Array to map qualifier LT fields in this table to
     * corresponding qualifier LT fields in group LT.
     */
    bcmfp_tbl_qualifier_fid_info_t *qualifiers_fid_info;
     ...
     */
    bcmfp_tbl_lrd_info_t lrd_info;
} bcmfp_tbl_conflict_qset_t;

/*! Logical Table details(SID and some FIDs) for conflict qualifier set. */
typedef struct bcmfp_tbl_group_action_s {
...
typedef struct bcmfp_tbl_compress_alpm_s {
    ...
    /*! Indicates whether the mask_fid is maskabl or not. */
    bool *maskable;
...
/*! Logical Table details(SID and some FIDs) for presel group info. */
typedef struct bcmfp_tbl_presel_info_s {
...
typedef struct bcmfp_tbl_compression_info_s {
    ...
    /*!
     * Field ID of field holding the info about one of the packet or
     * metadat field which can be used for packet length adjustment.
     */
    uint32_t ing_pkt_len_adj_0_fid;

    /*!
     * Field ID of field holding the info about one of the packet or
     * metadat field which can be used for packet length adjustment.
     */
    uint32_t ing_pkt_len_adj_1_fid;

    /*!
     * Field ID of field holding the info about one of the packet or
     * metadat field which can be used for classid remapping.
     */
    uint32_t remap_object_0_fid;

    /*!
     * Field ID of field holding the info about one of the packet or
     * metadat field which can be used for classid remapping.
     */
    uint32_t remap_object_1_fid;
...
typedef struct bcmfp_tbls_s {
    ...
    /*! Logical Table information for group template action */
    bcmfp_tbl_group_template_action_t *group_template_action_tbl;

    /*! Logical Table information for group template status */
    bcmfp_tbl_group_template_status_t *group_template_status_tbl;
    ...
    /*! Logical Table information for conflict QSET */
    bcmfp_tbl_conflict_qset_t *conflict_qset_tbl;
    ...
    /*! Logical Table information for group info. */
    bcmfp_tbl_presel_info_t *pse_info_tbl;

    /*! Logical Table information for group info. */
    bcmfp_tbl_presel_group_info_t *psg_info_tbl;

    /*! Logical Table information for group action. */
    bcmfp_tbl_group_action_t *group_action_tbl;
