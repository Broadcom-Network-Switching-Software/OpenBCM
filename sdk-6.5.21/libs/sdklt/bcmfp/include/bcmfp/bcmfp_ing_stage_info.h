...
#ifndef BCMFP_ING_STAGE_INFO_H
#define BCMFP_ING_STAGE_INFO_H

#include <bcmltd/bcmltd_handler.h>

/*!
 * \brief FP ingress stage information table validation.
 *
 ...
 */
extern int
bcmfp_ing_stage_info_validate(int unit,
 ...
 */
extern int
bcmfp_ing_stage_info_insert(int unit,
 ...
 */
extern int
bcmfp_ing_stage_info_update(int unit,
                          const bcmltd_op_arg_t *op_arg,
                          const bcmltd_fields_t *in,
                          bcmltd_fields_t *out,
                          const bcmltd_generic_arg_t *arg);
 ...
 */
extern int
bcmfp_ing_stage_info_delete(int unit,
                          const bcmltd_op_arg_t *op_arg,
                          const bcmltd_fields_t *in,
                          bcmltd_fields_t *out,
                          const bcmltd_generic_arg_t *arg);
 ...
 */
extern int
bcmfp_ing_stage_info_lookup(int unit,
                          const bcmltd_op_arg_t *op_arg,
                          const bcmltd_fields_t *in,
                          bcmltd_fields_t *out,
                          const bcmltd_generic_arg_t *arg);
 ...
 */
extern int
bcmfp_ing_stage_info_first(int unit,
                         const bcmltd_op_arg_t *op_arg,
                         const bcmltd_fields_t *in,
                         bcmltd_fields_t *out,
                         const bcmltd_generic_arg_t *arg);
 ...
 */
extern int
bcmfp_ing_stage_info_next(int unit,
                        const bcmltd_op_arg_t *op_arg,
                        const bcmltd_fields_t *in,
                        bcmltd_fields_t *out,
                        const bcmltd_generic_arg_t *arg);

#endif /* BCMFP_ING_STAGE_INFO_H */
