/*! \file bcm56780_a0_fp.h
 *
 * Trident4-X9(56780_A0) specific functions assigned to
...
#ifndef BCM56780_A0_FP_H
#define BCM56780_A0_FP_H

#include <bcmcth/bcmcth_meter_util.h>

#define BCM56780_A0_FP_EM_KEY_ONE_BASE_ENTRY    (0)
#define BCM56780_A0_FP_EM_KEY_TWO_BASE_ENTRY    (1)
#define BCM56780_A0_FP_EM_KEY_THREE_BASE_ENTRY  (2)
#define BCM56780_A0_FP_EM_KEY_FOUR_BASE_ENTRY   (3)

#define BCM56780_A0_FP_EM_DATA_ZERO_BASE_ENTRY  (0)
#define BCM56780_A0_FP_EM_DATA_ONE_BASE_ENTRY   (1)
#define BCM56780_A0_FP_EM_DATA_TWO_BASE_ENTRY   (2)
#define BCM56780_A0_FP_EM_DATA_THREE_BASE_ENTRY (3)

#define BCM56780_A0_FP_EM_KEY_TYPE_SBIT         (3)
#define BCM56780_A0_FP_EM_KEY_TYPE_WIDTH        (4)
 ...
 */
extern int
bcm56780_a0_fp_egr_device_consts_init(int unit,
                              bcmfp_stage_t *stage);
 ...
 */
extern int
bcm56780_a0_fp_em_device_consts_init(int unit,
                             bcmfp_stage_t *stage);
 ...
 */
extern int
bcm56780_a0_fp_common_ext_db_init(int unit,
                               bcmfp_stage_t *stage);
 ...
 */
extern int
bcm56780_a0_fp_common_ext_db_init_single(int unit,
                                      bcmfp_stage_t *stage);
/*!
 * \brief Build the extractor DB(databse) for main TCAM
 *  in a stage. This DB is used, along with qualifier and
 ...
 */
extern int
bcm56780_a0_fp_common_ext_db_init_dblinter(int unit,
                                        bcmfp_stage_t *stage);
/*!
 * \brief Build the extractor DB(databse) for main TCAM
 ...
 */
extern int
bcm56780_a0_fp_em_ext_db_init(int unit,
                              bcmfp_stage_t *stage);
 ...
 */
extern int
bcm56780_a0_fp_em_ext_db_init_single(int unit,
                                     bcmfp_stage_t *stage);
/*!
 * \brief Build the extractor DB(databse) for main TCAM
 *  in EM stage. This DB is used, along with qualifier and
 ...
 */
extern int
bcm56780_a0_fp_em_ext_db_init_dblinter(int unit,
                                       bcmfp_stage_t *stage);
/*!
 * \brief Build the extractor DB(databse) for main TCAM
 *  in EM stage. This DB is used, along with qualifier and
 ...
 */
extern int
bcm56780_a0_fp_em_ext_db_init_quad(int unit,
                                   bcmfp_stage_t *stage);
 ...
 */
extern int
bcm56780_a0_fp_common_ext_db_init_triple(int unit,
                                      bcmfp_stage_t *stage);
/*!
 ...
 */
extern int
bcm56780_a0_fp_common_action_db_init(int unit,
                                  bcmfp_stage_t *stage);
/*!
 ...
 */
extern int
bcm56780_a0_fp_common_qual_db_init(int unit,
                                bcmfp_stage_t *stage);
/*!
 * \brief Build the qualifier DB(databse) for main TCAM in
 ...
 */
extern int
bcm56780_a0_fp_common_presel_qual_db_init(int unit,
                                       bcmfp_stage_t *stage);
/*!
 ...
 */
extern int
bcm56780_a0_fp_common_presel_action_db_init(int unit,
                                         bcmfp_stage_t *stage);
/*!
 ...
 */
extern int
bcm56780_a0_fp_ing_presel_edw_get(int unit,
 ...
 */
extern int
bcm56780_a0_fp_egr_presel_edw_get(int unit,
                                  bcmfp_stage_id_t stage_id,
                                  bcmfp_group_id_t group_id,
                                  bcmfp_conflict_qset_id_t cqset_d,
                                  bcmfp_group_oper_info_t *opinfo,
 ...
 */
extern int
bcm56780_a0_fp_common_presel_group_info_get(int unit,
                        bcmfp_stage_id_t stage_id,
                        bcmfp_group_id_t group_id,
                        uint32_t **presel_group_info);

extern int
bcm56780_a0_fp_common_meter_actions_set(int unit,
                                        bcmfp_group_id_t group_id,
                                        bcmfp_pdd_id_t pdd_id,
                                        bcmfp_group_oper_info_t *opinfo,
 ...
 */
extern int
bcm56780_a0_fp_common_buffers_custom_set(int unit,
                               uint32_t trans_id,
                               uint32_t flags,
                               bcmfp_stage_t *stage,
                               bcmfp_group_oper_info_t *opinfo,
 ...
 */
extern int
bcm56780_a0_fp_ing_compression_init(int unit,
                                    bcmfp_stage_t *stage);
...
bcm56780_a0_fp_em_bank_lookup_id_get(int unit,
                                     ...
                                     uint8_t *lookup_id);
extern int
bcm56780_a0_fp_ing_profiles_install(int unit,
                                   uint32_t stage_id,
                                   uint32_t trans_id,
                                   uint32_t flags,
                                   bcmfp_group_id_t group_id,
                                   ...
                                   bcmfp_buffers_t *buffers);
extern int
bcm56780_a0_fp_ing_profiles_uninstall(int unit,
                                     uint32_t stage_id,
                                     uint32_t trans_id,
                                     uint32_t flags,
                                     bcmfp_group_id_t group_id,
...
bcm56780_a0_fp_vlan_profiles_uninstall(int unit,
                                     ...
                                     bcmfp_group_oper_info_t *opinfo);
extern int
bcm56780_a0_fp_egr_profiles_install(int unit,
                                   uint32_t stage_id,
                                   uint32_t trans_id,
                                   uint32_t flags,
                                   bcmfp_group_id_t group_id,
                                   ...
                                   bcmfp_buffers_t *buffers);
extern int
bcm56780_a0_fp_egr_profiles_uninstall(int unit,
                                     uint32_t stage_id,
                                     uint32_t trans_id,
                                     uint32_t flags,
                                     bcmfp_group_id_t group_id,
...
extern int
bcm56780_a0_fp_em_bank_info_set(int unit,
                                bcmfp_stage_t *stage);

extern int
bcm56780_a0_fp_em_bank_sids_get(int unit,
                               bcmdrd_sid_t bank_sid,
                               uint32_t *ptid);

extern int
bcm56780_a0_fp_em_sid_exists(int unit,
                             bcmdrd_sid_t *sid_arr,
                             uint32_t count,
                             bcmdrd_sid_t ptid);
extern int
bcm56780_a0_fp_em_lts_tcam_sids_get(int unit,
                                    bcmdrd_sid_t lts_tcam_sid,
                                    uint32_t *ptid);
extern int
bcm56780_a0_fp_fixed_qual_init(int unit,
                               bcmfp_stage_t *stage,
                               uint32_t fid);

#endif /* BCM56780_A0_FP_H */
