...
bcmfp_action_cont_info_first_search(int unit,
                                    ...
                                    const bcmltd_generic_arg_t *arg);
/*!
 * \brief Get FP Entry related info.
 *
 * \param [in] unit          Logical device id.
 * \param [in] op_arg        Operation arguments.
 * \param [in] stage         Stage info structure.
...
extern int
bcmfp_entry_info_lookup(int unit,
                        const bcmltd_op_arg_t *op_arg,
                        bcmfp_stage_t *stage,
                        const bcmltd_fields_t *in,
                        bcmltd_fields_t *out);
/*!
 * \brief Get next fp entry related info.
 *
 * \param [in] unit          Logical device id.
 * \param [in] op_arg        Operation arguments.
 * \param [in] tbl_id        Logical table id.
 ...
 */
extern int
bcmfp_entry_info_next_search(int unit,
                             const bcmltd_op_arg_t *op_arg,
                             bcmfp_stage_id_t stage_id,
                             const bcmltd_fields_t *in,
                             bcmltd_fields_t *out,
...
extern int
bcmfp_entry_info_first_search(int unit,
                              const bcmltd_op_arg_t *op_arg,
                              bcmfp_stage_id_t stage_id,
                              bcmltd_fields_t *out,
                              const bcmltd_generic_arg_t *arg);
...
/*!
 * \brief Get presel entry related info.
 *
 * \param [in] unit               Logical device id.
 * \param [in] trans_id           Transaction id.
 * \param [in] tbl_id             Logical table id.
 ...
 */
extern int
bcmfp_pse_info_update(int unit,
                        uint32_t trans_id,
                        bcmltd_sid_t tbl_id,
                        bcmfp_stage_t *stage,
                        const bcmltd_fields_t *in,
...
/*!
 * \brief Get first presel entry related info.
 *
 * \param [in] unit               Logical device id.
 * \param [in] trans_id           Transaction id.
 * \param [in] tbl_id             Logical table id.
...
extern int
bcmfp_pse_info_first_search(int unit,
                         uint32_t trans_id,
                         bcmfp_stage_id_t stage_id,
                         bcmltd_fields_t *out,
                         const bcmltd_generic_arg_t *arg);
/*!
 * \brief Get next presel entry related info.
 *
 * \param [in] unit               Logical device id.
 * \param [in] trans_id           Transaction id.
 * \param [in] tbl_id             Logical table id.
...
extern int
bcmfp_pse_info_next_search(int unit,
                        uint32_t trans_id,
                        bcmfp_stage_id_t stage_id,
                        const bcmltd_fields_t *in,
                        bcmltd_fields_t *out,
