 ...
 */
#define BCMFP_HA_GENERIC_TV_BLK_ELEMENT_COUNT (16 * 1024)
...
/*!
 * Number of HA elements in HA block of type CONFLICT_QSET_INFO.
 * Different HA block types are defined in bcmfp_ha_blk_type_t.
 */
#define BCMFP_HA_CONFLICT_QSET_INFO_BLK_ELEMENT_COUNT 32
...
typedef struct bcmfp_ha_struct_offset_s {
   ...
   /*! Offset to conflict qset ID to group ID map */
   uint32_t conflict_qset_group_map_offset;

   /*! Size of conflict qset ID to group ID map */
   uint32_t conflict_qset_group_map_size;
