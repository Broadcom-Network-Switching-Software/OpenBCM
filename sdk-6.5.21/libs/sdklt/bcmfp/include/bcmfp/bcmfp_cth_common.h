...
#include <bcmfp/bcmfp_cth_group_action.h>
...
/*!
 * CTR Response entry word size
 * CCI NORMALIZED CTR return to be 5 words
 */
#define BCMFP_CTR_RSP_ENTRY_WSIZE 5
...
typedef enum bcmfp_sid_type_s {
    ...
    /* FP_XXX_CONFLICT_QSET LT */
    BCMFP_SID_TYPE_CONFLICT_QSET,
    /* Invalid SID type */
