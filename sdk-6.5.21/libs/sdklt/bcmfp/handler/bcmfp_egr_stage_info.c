/*! \file bcmfp_egr_stage_info.c
 *
 * APIs for FP stage info template LTs custom handler.
 *
 * This file contains functions to insert, update,
 * delete, lookup or validate stage config provided
 * usegr stage template LTs.
 */
/*
...
#include <bcmfp/bcmfp_egr_stage_info.h>

#define BSL_LOG_MODULE BSL_LS_BCMFP_DEV

int
bcmfp_egr_stage_info_lookup(int unit,
...
int
bcmfp_egr_stage_info_insert(int unit,
                          const bcmltd_op_arg_t *op_arg,
                          const bcmltd_fields_t *in,
                          bcmltd_fields_t *out,
                          const bcmltd_generic_arg_t *arg)
...
int
bcmfp_egr_stage_info_update(int unit,
                          const bcmltd_op_arg_t *op_arg,
                          const bcmltd_fields_t *in,
                          bcmltd_fields_t *out,
                          const bcmltd_generic_arg_t *arg)
...
int
bcmfp_egr_stage_info_delete(int unit,
                          const bcmltd_op_arg_t *op_arg,
                          const bcmltd_fields_t *in,
                          bcmltd_fields_t *out,
                          const bcmltd_generic_arg_t *arg)
...
int
bcmfp_egr_stage_info_validate(int unit,
...
int
bcmfp_egr_stage_info_first(int unit,
                         const bcmltd_op_arg_t *op_arg,
                         const bcmltd_fields_t *in,
                         bcmltd_fields_t *out,
                         const bcmltd_generic_arg_t *arg)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmfp_stage_info_first_search(unit,
                                     op_arg,
...
int
bcmfp_egr_stage_info_next(int unit,
                        const bcmltd_op_arg_t *op_arg,
                        const bcmltd_fields_t *in,
                        bcmltd_fields_t *out,
                        const bcmltd_generic_arg_t *arg)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmfp_stage_info_next_search(unit,
                                    op_arg,
                                    BCMFP_STAGE_ID_EGRESS,
                                    in,
                                    out,
