/*! \file bcmfp_ing_entry_info.c
 *
 * APIs for FP_ING_ENTRY_INFO template LTs custom handler.
 *
...
#include <bcmfp/bcmfp_ing_entry_info.h>

#define BSL_LOG_MODULE BSL_LS_BCMFP_DEV

int
bcmfp_ing_entry_info_lookup(int unit,
...
int
bcmfp_ing_entry_info_insert(int unit,
                                  const bcmltd_op_arg_t *op_arg,
                                  const bcmltd_fields_t *in,
                                  bcmltd_fields_t *out,
                                  const bcmltd_generic_arg_t *arg)
...
int
bcmfp_ing_entry_info_validate(int unit,
...
int
bcmfp_ing_entry_info_delete(int unit,
                                  const bcmltd_op_arg_t *op_arg,
                                  const bcmltd_fields_t *in,
                                  bcmltd_fields_t *out,
                                  const bcmltd_generic_arg_t *arg)
...
int
bcmfp_ing_entry_info_update(int unit,
                                  const bcmltd_op_arg_t *op_arg,
                                  const bcmltd_fields_t *in,
                                  bcmltd_fields_t *out,
                                  const bcmltd_generic_arg_t *arg)
...
int
bcmfp_ing_entry_info_first(int unit,
                                 const bcmltd_op_arg_t *op_arg,
                                 const bcmltd_fields_t *in,
                                 bcmltd_fields_t *out,
                                 const bcmltd_generic_arg_t *arg)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmfp_entry_info_first_search(unit,
                                       op_arg,
...
int
bcmfp_ing_entry_info_next(int unit,
                                const bcmltd_op_arg_t *op_arg,
                                const bcmltd_fields_t *in,
                                bcmltd_fields_t *out,
                                const bcmltd_generic_arg_t *arg)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmfp_entry_info_next_search(unit,
                                      op_arg,
                                      BCMFP_STAGE_ID_INGRESS,
                                      in,
                                      out,
