/*! \file bcmfp_em_fp_action_cont_info.c
 *
 * APIs for FP_EM_FP_ACTION_CONT_INFO template LTs custom handler.
 *
...
#include <bcmfp/bcmfp_em_fp_action_cont_info.h>

#define BSL_LOG_MODULE BSL_LS_BCMFP_DEV

int
bcmfp_em_fp_action_cont_info_lookup(int unit,
...
int
bcmfp_em_fp_action_cont_info_insert(int unit,
                                  const bcmltd_op_arg_t *op_arg,
                                  const bcmltd_fields_t *in,
                                  bcmltd_fields_t *out,
                                  const bcmltd_generic_arg_t *arg)
...
int
bcmfp_em_fp_action_cont_info_validate(int unit,
...
int
bcmfp_em_fp_action_cont_info_delete(int unit,
                                 const bcmltd_op_arg_t *op_arg,
                                 const bcmltd_fields_t *in,
                                 bcmltd_fields_t *out,
                                 const bcmltd_generic_arg_t *arg)
...
int
bcmfp_em_fp_action_cont_info_update(int unit,
                                 const bcmltd_op_arg_t *op_arg,
                                 const bcmltd_fields_t *in,
                                 bcmltd_fields_t *out,
                                 const bcmltd_generic_arg_t *arg)
...
int
bcmfp_em_fp_action_cont_info_first(int unit,
                                const bcmltd_op_arg_t *op_arg,
                                const bcmltd_fields_t *in,
                                bcmltd_fields_t *out,
                                const bcmltd_generic_arg_t *arg)
...
int
bcmfp_em_fp_action_cont_info_next(int unit,
                               const bcmltd_op_arg_t *op_arg,
                               const bcmltd_fields_t *in,
                               bcmltd_fields_t *out,
                               const bcmltd_generic_arg_t *arg)
