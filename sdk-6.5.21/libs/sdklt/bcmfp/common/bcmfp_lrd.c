                    ...
                    bcmfp_stage_t *stage)
{
    ...
    if (stage->tbls.group_template_status_tbl != NULL) {
        tbl_id = stage->tbls.group_template_status_tbl->sid;
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmfp_get_number_of_fields_in_table(unit, tbl_id, &total_fields));
        stage->tbls.group_template_status_tbl->lrd_info.num_fid = total_fields;
    }
    ...
    if (stage->tbls.group_template_action_tbl != NULL) {
        ...
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmfp_get_number_of_fields_in_table(unit, tbl_id, &total_fields));
        stage->tbls.group_template_action_tbl->lrd_info.num_fid = total_fields;
    }
    ...
    if (stage->tbls.conflict_qset_tbl != NULL) {
        ...
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmfp_get_number_of_fields_in_table(unit, tbl_id, &total_fields));
        stage->tbls.conflict_qset_tbl->lrd_info.num_fid = total_fields;
        if (stage->tbls.conflict_qset_tbl->lrd_info.num_fid >
            stage->imm_buffers.num_data_fields) {
            stage->imm_buffers.num_data_fields =
