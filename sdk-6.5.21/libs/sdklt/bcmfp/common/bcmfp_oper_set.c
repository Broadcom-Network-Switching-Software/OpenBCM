                             ...
                             bcmfp_group_oper_info_t **opinfo)
{
    ...
    (*opinfo)->ext_ctrl_info.blk_offset =
                           BCMFP_HA_BLK_OFFSET_INVALID;
    (*opinfo)->conflict_qset_oper_info.blk_id =
                           BCMFP_HA_BLK_ID_INVALID;
    (*opinfo)->conflict_qset_oper_info.blk_offset =
                           BCMFP_HA_BLK_OFFSET_INVALID;
exit:
    SHR_FUNC_EXIT();
}
...
int
bcmfp_group_quals_offset_info_set(int unit, bcmfp_group_t *fg)
{
    uint8_t idx = 0;
...
bcmfp_group_oper_info_set(int unit, bcmfp_group_t *fg)
{
    ...
    if (!(group_oper_info->qset_error)) {
        ...
        for (part_id = 0; part_id < parts_count; part_id++) {
         ...
         /* Initialize the unused parts ext_codes */
        for (part_id = parts_count; part_id < BCMFP_ENTRY_PARTS_MAX;
                part_id++) {
            sal_memcpy(&(group_oper_info->ext_codes[part_id]),
                       &(fg->ext_codes[part_id]),
                       sizeof(bcmfp_ext_codes_t));
                             ...
                             bcmfp_group_id_t group_id)
{
    ...
    /* Clear the conflict QSET operational infos if any. */
    blk_id = group_oper_info->conflict_qset_oper_info.blk_id;
    blk_offset = group_oper_info->conflict_qset_oper_info.blk_offset;
    while (blk_id != BCMFP_HA_BLK_ID_INVALID &&
           blk_offset != BCMFP_HA_BLK_OFFSET_INVALID) {
         SHR_IF_ERR_EXIT
             (bcmfp_conflict_qset_oper_info_get(unit,
                                                ...
                                                blk_offset,
                                                &cqset_opinfo));
         next_blk_id = cqset_opinfo->next_conflict_qset_oper_info.blk_id;
         next_blk_offset =
             cqset_opinfo->next_conflict_qset_oper_info.blk_offset;
         SHR_IF_ERR_EXIT
             (bcmfp_conflict_qset_oper_info_release(unit,
                                                    stage_id,
                                                    blk_id,
                                                    blk_offset));
         blk_id = next_blk_id;
                                      ...
                                      bcmfp_ha_struct_offset_t *issu_offset)
{
    ...
    stage_oper_info->num_action_prof = issu_offset->num_action_prof;
                                      ...
                                      bcmfp_ha_struct_offset_t *issu_offset)
{
    ...
    stage_oper_info->conflict_qset_group_map_seg =
                     issu_offset->conflict_qset_group_map_offset;
    stage_oper_info->conflict_qset_group_map_size =
                     issu_offset->conflict_qset_group_map_size;
exit:
    SHR_FUNC_EXIT();
}
                              ...
                              bcmfp_ha_struct_offset_t *issu_offset)
{
    ...
    for (idx = 0; idx < stage_oper_info->num_groups; idx++) {
         ...
         group_oper_info[idx].ext_ctrl_info.blk_offset =
                              BCMFP_HA_BLK_OFFSET_INVALID;
         group_oper_info[idx].conflict_qset_oper_info.blk_id =
                              BCMFP_HA_BLK_ID_INVALID;
         group_oper_info[idx].conflict_qset_oper_info.blk_offset =
                              BCMFP_HA_BLK_OFFSET_INVALID;
    }
                                  ...
                                  bcmfp_ha_struct_offset_t *issu_offset)
{
    ...
    max_psg_id = issu_offset->num_presel_groups;
    ...
    for (idx = 0; idx < max_psg_id; idx++) {
        ...
        presel_group_oper_info[idx].ext_ctrl_info.blk_offset =
                                    BCMFP_HA_BLK_OFFSET_INVALID;
        presel_group_oper_info[idx].conflict_qset_oper_info.blk_id =
                                    BCMFP_HA_BLK_ID_INVALID;
        presel_group_oper_info[idx].conflict_qset_oper_info.blk_offset =
                                    BCMFP_HA_BLK_OFFSET_INVALID;
    }
                             ...
                             bool *update_required)
{
    ...
    *update_required = FALSE;
    ...
    if (stage_oper_info->num_groups != issu_offset->num_groups) {
        *update_required = TRUE;
    }
