...
bcm56990_a0_lta_bcmimm_ctr_egr_eflex_obj_quantization_cth_handler_arg = {
    .sid = CTR_EGR_EFLEX_OBJ_QUANTIZATIONt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56990_a0_lta_bcmimm_ctr_egr_eflex_obj_quantization_cth_handler_arg
};
