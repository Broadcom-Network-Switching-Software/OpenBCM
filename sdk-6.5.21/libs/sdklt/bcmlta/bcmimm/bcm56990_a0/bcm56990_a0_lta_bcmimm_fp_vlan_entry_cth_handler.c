...
/* Handler: bcm56990_a0_lta_bcmimm_fp_vlan_entry_cth_handler */
...
bcm56990_a0_lta_bcmimm_fp_vlan_entry_cth_handler_arg = {
    .sid = FP_VLAN_ENTRYt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56990_a0_lta_bcmimm_fp_vlan_entry_cth_handler_arg
};
