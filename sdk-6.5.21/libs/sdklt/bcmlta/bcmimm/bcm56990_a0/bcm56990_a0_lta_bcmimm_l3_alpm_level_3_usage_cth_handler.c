...
bcm56990_a0_lta_bcmimm_l3_alpm_level_3_usage_cth_handler_arg = {
    .sid = L3_ALPM_LEVEL_3_USAGEt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56990_a0_lta_bcmimm_l3_alpm_level_3_usage_cth_handler_arg
};
