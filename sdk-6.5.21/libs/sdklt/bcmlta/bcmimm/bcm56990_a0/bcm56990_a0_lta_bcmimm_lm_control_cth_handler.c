...
/* Handler: bcm56990_a0_lta_bcmimm_lm_control_cth_handler */
...
bcm56990_a0_lta_bcmimm_lm_control_cth_handler_arg = {
    .sid = LM_CONTROLt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
...
bcmimm_direct_table_entry_limit_handler = {
    ...
    .arg  = &bcm56990_a0_lta_bcmimm_lm_control_cth_handler_arg
};
