...
bcm56990_a0_lta_bcmimm_tm_pfc_deadlock_recovery_manual_state_cth_handler_arg = {
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56990_a0_lta_bcmimm_tm_pfc_deadlock_recovery_manual_state_cth_handler_arg
};
