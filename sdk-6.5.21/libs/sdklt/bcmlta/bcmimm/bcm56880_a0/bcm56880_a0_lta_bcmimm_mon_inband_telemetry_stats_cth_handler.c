...
bcm56880_a0_lta_bcmimm_mon_inband_telemetry_stats_cth_handler_arg = {
    .sid = MON_INBAND_TELEMETRY_STATSt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56880_a0_lta_bcmimm_mon_inband_telemetry_stats_cth_handler_arg
};
