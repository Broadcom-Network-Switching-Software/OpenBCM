...
/* Handler: bcm56880_a0_lta_bcmimm_tnl_mpls_exp_qos_selection_cth_handler */
...
bcm56880_a0_lta_bcmimm_tnl_mpls_exp_qos_selection_cth_handler_arg = {
    .sid = TNL_MPLS_EXP_QOS_SELECTIONt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56880_a0_lta_bcmimm_tnl_mpls_exp_qos_selection_cth_handler_arg
};
