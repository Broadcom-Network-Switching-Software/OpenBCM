...
/* Handler: bcm56880_a0_lta_bcmimm_port_mirror_cth_handler */
...
bcm56880_a0_lta_bcmimm_port_mirror_cth_handler_arg = {
    .sid = PORT_MIRRORt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56880_a0_lta_bcmimm_port_mirror_cth_handler_arg
};
