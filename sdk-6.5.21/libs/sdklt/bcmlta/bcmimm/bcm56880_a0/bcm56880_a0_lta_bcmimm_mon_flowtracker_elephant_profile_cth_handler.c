...
bcm56880_a0_lta_bcmimm_mon_flowtracker_elephant_profile_cth_handler_arg = {
    .sid = MON_FLOWTRACKER_ELEPHANT_PROFILEt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56880_a0_lta_bcmimm_mon_flowtracker_elephant_profile_cth_handler_arg
};
