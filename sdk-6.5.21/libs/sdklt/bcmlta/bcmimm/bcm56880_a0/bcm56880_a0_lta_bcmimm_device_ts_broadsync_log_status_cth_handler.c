...
bcm56880_a0_lta_bcmimm_device_ts_broadsync_log_status_cth_handler_arg = {
    .sid = DEVICE_TS_BROADSYNC_LOG_STATUSt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56880_a0_lta_bcmimm_device_ts_broadsync_log_status_cth_handler_arg
};
