...
bcm56880_a0_lta_bcmimm_fp_compression_range_check_group_cth_handler_arg = {
    .sid = FP_COMPRESSION_RANGE_CHECK_GROUPt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56880_a0_lta_bcmimm_fp_compression_range_check_group_cth_handler_arg
};
