...
bcm56880_a0_dna_4_7_11_lta_bcmimm_flex_state_egr_obj_quantization_cth_handler_arg = {
    .sid = BCM56880_A0_DNA_4_7_11_FLEX_STATE_EGR_OBJ_QUANTIZATIONt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56880_a0_dna_4_7_11_lta_bcmimm_flex_state_egr_obj_quantization_cth_handler_arg
};
