...
bcm56880_a0_dna_4_7_11_lta_bcmimm_ctr_ing_eflex_operand_profile_cth_handler_arg = {
    .sid = CTR_ING_EFLEX_OPERAND_PROFILEt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56880_a0_dna_4_7_11_lta_bcmimm_ctr_ing_eflex_operand_profile_cth_handler_arg
};
