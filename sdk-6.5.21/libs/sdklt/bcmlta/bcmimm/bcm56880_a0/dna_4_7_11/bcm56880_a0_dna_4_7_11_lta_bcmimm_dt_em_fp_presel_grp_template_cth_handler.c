...
bcm56880_a0_dna_4_7_11_lta_bcmimm_dt_em_fp_presel_grp_template_cth_handler_arg = {
    .sid = BCM56880_A0_DNA_4_7_11_DT_EM_FP_PRESEL_GRP_TEMPLATEt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56880_a0_dna_4_7_11_lta_bcmimm_dt_em_fp_presel_grp_template_cth_handler_arg
};
