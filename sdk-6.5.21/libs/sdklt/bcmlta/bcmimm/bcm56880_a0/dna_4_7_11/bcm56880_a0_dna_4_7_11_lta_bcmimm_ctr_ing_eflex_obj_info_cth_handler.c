...
bcm56880_a0_dna_4_7_11_lta_bcmimm_ctr_ing_eflex_obj_info_cth_handler_arg = {
    .sid = BCM56880_A0_DNA_4_7_11_CTR_ING_EFLEX_OBJ_INFOt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56880_a0_dna_4_7_11_lta_bcmimm_ctr_ing_eflex_obj_info_cth_handler_arg
};
