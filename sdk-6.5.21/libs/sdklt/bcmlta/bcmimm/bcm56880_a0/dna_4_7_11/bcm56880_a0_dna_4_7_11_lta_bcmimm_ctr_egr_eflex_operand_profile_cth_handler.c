...
bcm56880_a0_dna_4_7_11_lta_bcmimm_ctr_egr_eflex_operand_profile_cth_handler_arg = {
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56880_a0_dna_4_7_11_lta_bcmimm_ctr_egr_eflex_operand_profile_cth_handler_arg
};
