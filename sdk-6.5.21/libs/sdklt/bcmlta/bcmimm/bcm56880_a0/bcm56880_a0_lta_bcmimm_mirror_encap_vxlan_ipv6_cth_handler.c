...
bcm56880_a0_lta_bcmimm_mirror_encap_vxlan_ipv6_cth_handler_arg = {
    .sid = MIRROR_ENCAP_VXLAN_IPV6t,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56880_a0_lta_bcmimm_mirror_encap_vxlan_ipv6_cth_handler_arg
};
