...
/* Handler: bcm56780_a0_lta_bcmimm_tm_ebst_port_cth_handler */
...
bcm56780_a0_lta_bcmimm_tm_ebst_port_cth_handler_arg = {
    .sid = TM_EBST_PORTt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_lta_bcmimm_tm_ebst_port_cth_handler_arg
};
