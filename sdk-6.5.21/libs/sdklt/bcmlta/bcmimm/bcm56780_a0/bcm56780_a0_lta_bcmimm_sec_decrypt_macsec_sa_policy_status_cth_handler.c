...
bcm56780_a0_lta_bcmimm_sec_decrypt_macsec_sa_policy_status_cth_handler_arg = {
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_lta_bcmimm_sec_decrypt_macsec_sa_policy_status_cth_handler_arg
};
