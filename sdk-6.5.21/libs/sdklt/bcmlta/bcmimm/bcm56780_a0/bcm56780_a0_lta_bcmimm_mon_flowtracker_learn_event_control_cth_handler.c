...
bcm56780_a0_lta_bcmimm_mon_flowtracker_learn_event_control_cth_handler_arg = {
    .sid = MON_FLOWTRACKER_LEARN_EVENT_CONTROLt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_lta_bcmimm_mon_flowtracker_learn_event_control_cth_handler_arg
};
