...
bcm56780_a0_lta_bcmimm_flex_state_egr_group_action_profile_cth_handler_arg = {
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_lta_bcmimm_flex_state_egr_group_action_profile_cth_handler_arg
};
