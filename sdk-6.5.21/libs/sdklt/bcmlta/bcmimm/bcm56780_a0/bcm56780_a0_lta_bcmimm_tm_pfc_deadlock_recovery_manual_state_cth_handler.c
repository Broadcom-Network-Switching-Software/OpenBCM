...
bcm56780_a0_lta_bcmimm_tm_pfc_deadlock_recovery_manual_state_cth_handler_arg = {
    .sid = TM_PFC_DEADLOCK_RECOVERY_MANUAL_STATEt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_lta_bcmimm_tm_pfc_deadlock_recovery_manual_state_cth_handler_arg
};
