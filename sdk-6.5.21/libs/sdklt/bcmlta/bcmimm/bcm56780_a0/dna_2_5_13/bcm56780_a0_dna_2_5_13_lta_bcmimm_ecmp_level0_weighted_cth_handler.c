...
bcm56780_a0_dna_2_5_13_lta_bcmimm_ecmp_level0_weighted_cth_handler_arg = {
    .sid = BCM56780_A0_DNA_2_5_13_ECMP_LEVEL0_WEIGHTEDt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_dna_2_5_13_lta_bcmimm_ecmp_level0_weighted_cth_handler_arg
};
