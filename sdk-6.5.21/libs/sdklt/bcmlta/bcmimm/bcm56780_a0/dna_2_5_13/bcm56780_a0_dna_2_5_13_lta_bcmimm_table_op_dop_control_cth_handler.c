...
bcm56780_a0_dna_2_5_13_lta_bcmimm_table_op_dop_control_cth_handler_arg = {
    .sid = TABLE_OP_DOP_CONTROLt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_dna_2_5_13_lta_bcmimm_table_op_dop_control_cth_handler_arg
};
