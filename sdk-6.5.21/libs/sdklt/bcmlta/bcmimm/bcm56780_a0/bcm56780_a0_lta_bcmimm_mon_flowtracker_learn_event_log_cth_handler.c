...
bcm56780_a0_lta_bcmimm_mon_flowtracker_learn_event_log_cth_handler_arg = {
    .sid = MON_FLOWTRACKER_LEARN_EVENT_LOGt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_direct_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_lta_bcmimm_mon_flowtracker_learn_event_log_cth_handler_arg
};
