...
bcm56780_a0_lta_bcmimm_flex_state_ing_pool_info_cth_handler_arg = {
    .sid = FLEX_STATE_ING_POOL_INFOt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_lta_bcmimm_flex_state_ing_pool_info_cth_handler_arg
};
