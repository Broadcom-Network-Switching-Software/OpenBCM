...
bcm56780_a0_lta_bcmimm_sec_decrypt_macsec_sa_policy_cth_handler_arg = {
    .sid = SEC_DECRYPT_MACSEC_SA_POLICYt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_lta_bcmimm_sec_decrypt_macsec_sa_policy_cth_handler_arg
};
