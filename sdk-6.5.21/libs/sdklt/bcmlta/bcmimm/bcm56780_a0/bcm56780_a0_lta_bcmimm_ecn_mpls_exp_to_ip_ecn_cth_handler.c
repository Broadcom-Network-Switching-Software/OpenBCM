...
bcm56780_a0_lta_bcmimm_ecn_mpls_exp_to_ip_ecn_cth_handler_arg = {
    .sid = ECN_MPLS_EXP_TO_IP_ECNt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_lta_bcmimm_ecn_mpls_exp_to_ip_ecn_cth_handler_arg
};
