...
/* Handler: bcm56990_b0_lta_bcmimm_l3_protection_enable_cth_handler */
...
bcm56990_b0_lta_bcmimm_l3_protection_enable_cth_handler_arg = {
    .sid = L3_PROTECTION_ENABLEt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56990_b0_lta_bcmimm_l3_protection_enable_cth_handler_arg
};
