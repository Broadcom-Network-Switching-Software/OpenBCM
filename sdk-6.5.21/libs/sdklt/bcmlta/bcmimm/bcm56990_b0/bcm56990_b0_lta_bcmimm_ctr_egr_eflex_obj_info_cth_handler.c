...
bcm56990_b0_lta_bcmimm_ctr_egr_eflex_obj_info_cth_handler_arg = {
    .sid = CTR_EGR_EFLEX_OBJ_INFOt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56990_b0_lta_bcmimm_ctr_egr_eflex_obj_info_cth_handler_arg
};
