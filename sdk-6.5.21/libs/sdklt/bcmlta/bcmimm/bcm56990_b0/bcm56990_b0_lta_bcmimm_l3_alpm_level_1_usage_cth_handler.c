...
bcm56990_b0_lta_bcmimm_l3_alpm_level_1_usage_cth_handler_arg = {
    .sid = L3_ALPM_LEVEL_1_USAGEt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56990_b0_lta_bcmimm_l3_alpm_level_1_usage_cth_handler_arg
};
