...
/* Handler: bcm56990_b0_lta_bcmimm_pc_phy_prbs_control_cth_handler */
...
bcm56990_b0_lta_bcmimm_pc_phy_prbs_control_cth_handler_arg = {
    .sid = PC_PHY_PRBS_CONTROLt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56990_b0_lta_bcmimm_pc_phy_prbs_control_cth_handler_arg
};
