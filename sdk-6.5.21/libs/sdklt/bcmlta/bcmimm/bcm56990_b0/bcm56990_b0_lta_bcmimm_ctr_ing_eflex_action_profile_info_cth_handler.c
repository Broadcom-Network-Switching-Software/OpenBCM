...
bcm56990_b0_lta_bcmimm_ctr_ing_eflex_action_profile_info_cth_handler_arg = {
    .sid = CTR_ING_EFLEX_ACTION_PROFILE_INFOt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56990_b0_lta_bcmimm_ctr_ing_eflex_action_profile_info_cth_handler_arg
};
