...
bcm56990_b0_lta_bcmimm_ctr_egr_eflex_operand_profile_info_cth_handler_arg = {
    .sid = CTR_EGR_EFLEX_OPERAND_PROFILE_INFOt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56990_b0_lta_bcmimm_ctr_egr_eflex_operand_profile_info_cth_handler_arg
};
