...
bcm56990_b0_lta_bcmimm_fp_ing_grp_template_status_cth_handler_arg = {
    .sid = FP_ING_GRP_TEMPLATE_STATUSt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56990_b0_lta_bcmimm_fp_ing_grp_template_status_cth_handler_arg
};
