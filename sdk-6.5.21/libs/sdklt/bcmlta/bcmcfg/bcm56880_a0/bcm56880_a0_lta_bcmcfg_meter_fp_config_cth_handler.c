...
/* Handler: bcm56880_a0_lta_bcmcfg_meter_fp_config_cth_handler */
...
bcm56880_a0_lta_bcmcfg_meter_fp_config_cth_handler_arg = {
    .sid = METER_FP_CONFIGt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcm56880_a0_lta_bcmcfg_meter_fp_config_cth_handler = {
    ...
    .ha       = NULL,
    .arg      = &bcm56880_a0_lta_bcmcfg_meter_fp_config_cth_handler_arg
};
