...
/* Handler: bcm56880_a0_lta_bcmcfg_tm_thd_config_cth_handler */
...
bcm56880_a0_lta_bcmcfg_tm_thd_config_cth_handler_arg = {
    .sid = TM_THD_CONFIGt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
...
bcm56880_a0_lta_bcmcfg_tm_thd_config_cth_handler = {
    ...
    .ha       = NULL,
    .arg      = &bcm56880_a0_lta_bcmcfg_tm_thd_config_cth_handler_arg
};
