...
/* Handler: bcm56780_a0_lta_bcmcfg_sec_config_cth_handler */
...
bcm56780_a0_lta_bcmcfg_sec_config_cth_handler_arg = {
    .sid = SEC_CONFIGt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
...
bcm56780_a0_lta_bcmcfg_sec_config_cth_handler = {
    ...
    .ha       = NULL,
    .arg      = &bcm56780_a0_lta_bcmcfg_sec_config_cth_handler_arg
};
