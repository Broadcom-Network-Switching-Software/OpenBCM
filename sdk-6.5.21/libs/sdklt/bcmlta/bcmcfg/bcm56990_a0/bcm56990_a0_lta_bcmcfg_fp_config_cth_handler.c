...
/* Handler: bcm56990_a0_lta_bcmcfg_fp_config_cth_handler */
...
bcm56990_a0_lta_bcmcfg_fp_config_cth_handler_arg = {
    .sid = FP_CONFIGt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
...
bcm56990_a0_lta_bcmcfg_fp_config_cth_handler = {
    ...
    .ha       = NULL,
    .arg      = &bcm56990_a0_lta_bcmcfg_fp_config_cth_handler_arg
};
