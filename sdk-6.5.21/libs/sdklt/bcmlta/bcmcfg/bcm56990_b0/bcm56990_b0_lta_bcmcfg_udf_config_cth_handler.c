...
/* Handler: bcm56990_b0_lta_bcmcfg_udf_config_cth_handler */
...
bcm56990_b0_lta_bcmcfg_udf_config_cth_handler_arg = {
    .sid = UDF_CONFIGt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
...
bcm56990_b0_lta_bcmcfg_udf_config_cth_handler = {
    ...
    .ha       = NULL,
    .arg      = &bcm56990_b0_lta_bcmcfg_udf_config_cth_handler_arg
};
