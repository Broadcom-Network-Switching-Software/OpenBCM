...
/* Handler: bcm56990_b0_lta_bcmlm_lm_link_state_cth_handler */
...
bcm56990_b0_lta_bcmlm_lm_link_state_cth_handler_arg = {
    .sid = LM_LINK_STATEt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
...
bcm56990_b0_lta_bcmlm_lm_link_state_cth_handler = {
    ...
    .ha       = NULL,
    .arg      = &bcm56990_b0_lta_bcmlm_lm_link_state_cth_handler_arg
};
