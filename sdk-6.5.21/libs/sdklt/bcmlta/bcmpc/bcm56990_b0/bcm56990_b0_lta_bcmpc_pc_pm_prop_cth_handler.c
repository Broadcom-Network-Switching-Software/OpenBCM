...
bcm56990_b0_lta_bcmpc_pc_pm_prop_cth_handler_arg = {
    .sid = PC_PM_PROPt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
...
bcmpc_lth_pm_prop_table_entry_usage_handler = {
    .entry_inuse_get = bcmpc_lth_pm_prop_table_entry_inuse_get,
    .max_entries_set = bcmpc_lth_pm_prop_table_max_entries_set,
    .arg  = &bcm56990_b0_lta_bcmpc_pc_pm_prop_cth_handler_arg
};
...
bcm56990_b0_lta_bcmpc_pc_pm_prop_cth_handler = {
    ...
    .ha       = NULL,
    .entry_usage = &bcmpc_lth_pm_prop_table_entry_usage_handler,
    .arg      = &bcm56990_b0_lta_bcmpc_pc_pm_prop_cth_handler_arg
};
