...
/*!
 * \brief Allocate dynamic info resources.
 *
 * This function allocates dynamic info resources to the LT.
 *
 * \param [in] unit The unit associated with the LT.
 * \param [in] tbl The table information.
 * \param [in] dyn_info The dynamic information to be collected.
 *
 * \return SHR_E_NONE Success, error code otherwise.
 */
extern int bcmimm_tbl_dyn_info_alloc(int unit,
                                     table_info_t *tbl,
                                     bcmimm_table_dynamic_info_t *dyn_info);

/*!
 * \brief Free dynamic info resources.
 *
 * This function frees the dynamic info resources allocated by
 * \ref bcmimm_tbl_dyn_info_alloc().
 *
 * \param [in] dyn_info The dynamic information to be collected.
 *
 * \return None.
 */
extern void bcmimm_tbl_dyn_info_free(bcmimm_table_dynamic_info_t *dyn_info);
