...
/*!
 * \brief Get the logical port for a physical port.
 *
 * \param [in] unit Unit number.
 * \param [in] pport logical port.
 * \param [out] lport physical port.
 *
 * \retval SHR_E_NONE   Success
 * \retval SHR_E_NOT_FOUND  Port not found
 */
extern int
bcmsec_port_lport_get(int unit,
        bcmsec_pport_t pport,
        int *lport);
/*!
