                           ...
                           void *node_cookie)
{
    ...
    for (ptix = 0; ptix < pt_count; ptix++) {
        ...
        for (opix = 0; opix < pt_sbus_count; opix++) {
             ...
             * Perform the PTM write operation.
             *
             * For interactive LT PTM write, the stats and entry OP records are
             * recorded in the PTM call.
             */
            ...
            /* Record PT passthrough operation (not in PTM call) */
            if (lt_md->params->lt_flags & BCMLTM_LT_FLAGS_PASSTHRU) {
                SHR_IF_ERR_VERBOSE_EXIT
                          ...
                          void *node_cookie)
{
    ...
    for (ptix = 0; ptix < pt_count; ptix++) {
        ...
        for (opix = 0; opix < pt_sbus_count; opix++) {
             ...
             * Perform the PTM write operation.
             *
             * For interactive LT PTM read, the stats and entry OP records are
             * recorded in the PTM call.
             */
