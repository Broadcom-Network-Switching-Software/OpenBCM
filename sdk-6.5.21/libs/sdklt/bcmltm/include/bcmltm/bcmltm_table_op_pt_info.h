...
/*!
 * \brief TABLE_OP_PT_INFO mark completion of interactive path LT operation.
 *
 * This function marks completion of interative path LT operation. Since
 * TABLE_OP_PT_INFO always records PT updates related to the last LT operation,
 * any subsequent operation on the LT and the resulting PT updates will
 * overwrite the existing TABLE_OP_PT_INFO entry for the LT.
 *
 * \param [in] unit Logical device ID.
 * \param [in] ltid Logical Table enum for current operation.
 *
 ...
 */
extern void
bcmltm_pt_status_ireq_op_complete(int unit, bcmltd_sid_t ltid);
