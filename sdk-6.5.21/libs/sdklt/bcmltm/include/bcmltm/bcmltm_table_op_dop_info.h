/*! \file bcmltm_table_op_dop_info.h
 *
...
#ifndef BCMLTM_TABLE_OP_DOP_INFO_H
#define BCMLTM_TABLE_OP_DOP_INFO_H
...
/*!
 * \brief TABLE_OP_DOP_INFO logical table with PT status for keyed LT.
 *
 * This function updates the TABLE_OP_DOP_INFO table with
 * PT status of keyed LT operation.
 *
 * \param [in] unit Logical device ID.
 * \param [in] ltid Logical Table enum for keyed operation.
 * \param [in] pt_dyn_info Pointer to bcmbd_dop_dyn_info_t.
...
/*!
 * \brief TABLE_OP_DOP_INFO logical table with PT status for indexed LT.
 *
 * This function updates the TABLE_OP_DOP_INFO table with
...
/*!
 * \brief TABLE_OP_DOP_INFO logical table with PT status for interactive hash path.
 *
 * This function updates the TABLE_OP_DOP_INFO table with
 ...
 * \param [in] pt_dyn_hash_info Pointer to bcmbd_dop_dyn_hash_info_t.
 *
 * \return SHR_E_NONE success, error code otherwise.
 */
extern int
...
/*!
 * \brief TABLE_OP_DOP_INFO logical table with PT status for interactive path.
 *
 * This function updates the TABLE_OP_DOP_INFO table with
...
#endif /* BCMLTM_TABLE_OP_DOP_INFO_H */
