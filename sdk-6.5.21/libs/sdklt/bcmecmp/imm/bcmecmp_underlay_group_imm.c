            ...
            if (in_use_bk &&
                ...
                SHR_IF_ERR_EXIT
                    (bcmecmp_group_rh_realloc
                        (unit, ecmp_id, BCMECMP_GRP_TYPE_UNDERLAY,
                         BCMECMP_GRP_RH_ENTRIES_CNT(unit, ecmp_id),
                         true));
            }
...
/*!
 * \brief Underlay ECMP LT entry fields parse routine.
 *
 ...
 */
static int
bcmecmp_underlay_group_lt_entry_parse(int unit,
                                      bcmltd_sid_t sid,
                                      bcmecmp_lt_entry_t *lt_entry,
                                      bcmltd_fields_t *out)
{
    ...
    SHR_ALLOC(fid_list, table_sz, "bcmUnlayEcmpFldList");
...
/*!
 * \brief ECMP underlay group imm lookup callback.
 *
 * \param [in]  unit            Unit number.
 ...
 */
static int
bcmecmp_underlay_group_lookup(int unit,
                              bcmltd_sid_t sid,
                              const bcmltd_op_arg_t *op_arg,
                              void *context,
                              ...
                              bcmltd_fields_t *out)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmecmp_underlay_group_lt_entry_parse(unit, sid, lt_entry, out));
...
static bcmimm_lt_cb_t event_hdl = {
    ...
    .op_lookup = bcmecmp_underlay_group_lookup
};
