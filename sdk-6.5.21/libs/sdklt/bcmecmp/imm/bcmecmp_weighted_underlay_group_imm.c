...
/*!
 * \brief Weighted underlay ECMP LT entry fields parse routine.
 *
 ...
 */
static int
bcmecmp_weighted_underlay_group_lt_entry_parse(int unit,
                                               bcmltd_sid_t sid,
                                               bcmecmp_lt_entry_t *lt_entry,
                                               bcmltd_fields_t *out)
{
...
/*!
 * \brief ECMP weighted underlay group imm lookup callback.
 *
 * \param [in]  unit            Unit number.
 ...
 */
static int
bcmecmp_weighted_underlay_group_lookup(int unit,
                                       bcmltd_sid_t sid,
                                       const bcmltd_op_arg_t *op_arg,
                                       void *context,
                                       ...
                                       bcmltd_fields_t *out)
{
    ...
    if (in != NULL) {
        for (i = 0; i < in->count; i++) {
            SHR_IF_ERR_VERBOSE_EXIT
                (BCMECMP_FNCALL_EXEC(unit, grp_ul_lt_fields_fill)(unit,
                                                                  in->field[i],
                                                                  lt_entry));
        }
    }
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmecmp_weighted_underlay_group_lt_entry_parse
...
static bcmimm_lt_cb_t event_hdl = {
    ...
    .op_lookup = bcmecmp_weighted_underlay_group_lookup
};
