/*! \file bcmecmp_src_l3_group_1_info_imm.c
 *
 * Functions to operate on ECMP_SRC_l3_group_1_INFO table.
 */
/*
 ...
 */
static int
ecmp_src_l3_group_1_info_tbl(int unit,
                         bcmltd_sid_t sid,
...
static bcmimm_lt_cb_t ecmp_src_l3_group_1_info_tbl_g_callback = {

    /*! Validate function. */
    .validate = ecmp_src_l3_group_1_info_tbl,
    ...
    if (SHR_SUCCESS(rv) && map) {
        SHR_IF_ERR_EXIT
            (bcmimm_lt_event_reg(unit,
                                 table_id,
                                 &ecmp_src_l3_group_1_info_tbl_g_callback,
                                 NULL));
    }
