...
typedef struct bcmecmp_drv_var_ids_s {
    ...
    /* ECMP_SRC_L3_GROUP_0_INFO table LTID */
    const uint32_t ecmp_src_l3_group_0_info_id;

    /* ECMP_SRC_L3_GROUP_1_INFO table LTID */
    const uint32_t ecmp_src_l3_group_1_info_id;
