...
/*!
 * ECMP src l3 group 0 info LT IMM register function.
 */
extern int
bcmecmp_src_l3_group_0_info_imm_register(int unit, int table_id);
/*!
 * ECMP src l3 group 1 info LT IMM register function.
 */
extern int
bcmecmp_src_l3_group_1_info_imm_register(int unit, int table_id);
#endif /* BCMECMP_IMM_H */
