...
typedef struct bcmecmp_lt_entry_s {
    ...
    /*! RH underlay member ECMP or next-hop indicator field value. */
    uint8_t rh_u_ecmp_nhop[BCMECMP_NHOP_ARRAY_SIZE];

    /*! RH input underlay indicator fields count. */
    uint32_t rh_u_ecmp_nhop_count;
    ...
    /*! RH underlay ECMP group identifier field array elements. */
    bcmecmp_id_t rh_uecmp_id[BCMECMP_UNDERLAY_ECMP_ARRAY_SIZE];

    /*! RH input ECMP_UNDERLAY_IDs count. */
    uint32_t rh_uecmp_ids_count;
    ...
    /*! RH overlay next-hop indices field array elements. */
    bcmecmp_nhop_id_t rh_o_nhop_id[BCMECMP_NHOP_ARRAY_SIZE];

    /*! RH input overlay NHOP_IDs count. */
    uint32_t rh_o_nhop_ids_count;
