...
/*!
 * \brief Check if Requested space can be allocated from member pool resources.
 *
 ...
 */
int
bcmecmp_flex_check_member_pool_resource(int unit,
                                        const bcmecmp_grp_type_t gtype,
                                        uint32_t req_size);
