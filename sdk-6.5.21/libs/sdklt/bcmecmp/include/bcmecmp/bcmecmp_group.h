 ...
 *
 * \param [in] unit Unit number.
 * \param [in] ecmp_id ECMP ID.
 * \param [in] grp_type Group type.
 * \param [in] rh_entries_cnt new RH entries count to allocated.
 * \param [in] is_bake indicate to re-allocate bake rh memory.
 *
 * \return SHR_E_NONE No errors.
