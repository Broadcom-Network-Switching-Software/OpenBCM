/*! \file bcm56880_a0_ecmp.c
 *
 * This file implements BCM56880_A0 device specific ECMP functions.
 */
/*
 ...
 */
static void
bcm56880_a0_pt_op_info_t_init(bcmecmp_pt_op_info_t *pt_op_info)
{
 ...
 */
static int
bcm56880_a0_level0_weighted_group_lt_fields_fill(int unit,
 ...
 */
static int
bcm56880_a0_flex_member_dest_lt_fields_fill(int unit,
                                    const void *in_fld,
                                    void *ltentry)
{
    uint32_t fid;  /* Field identifier value. */
 ...
 */
static int
bcm56880_a0_level0_group_lt_fields_fill(int unit,
                                    const void *in_fld,
                                    void *ltentry)
{
    uint32_t fid;  /* Field identifier value. */
    ...
    if (lt_entry->glt_sid == ids->ecmp_wlevel0_ltid) {
        SHR_IF_ERR_EXIT(
            bcm56880_a0_level0_weighted_group_lt_fields_fill(unit, in_fld, ltentry));
        SHR_EXIT();
    }
 ...
 */
static int
bcm56880_a0_level1_weighted_group_lt_fields_fill(int unit,
 ...
 */
static int
bcm56880_a0_level1_group_lt_fields_fill(int unit,
                                    const void *in_fld,
                                    void *ltentry)
{
    uint32_t fid;  /* Field identifier value. */
    ...
    if (lt_entry->glt_sid == ids->ecmp_wlevel1_ltid) {
        SHR_IF_ERR_EXIT(
            bcm56880_a0_level1_weighted_group_lt_fields_fill(unit, in_fld, ltentry));
        SHR_EXIT();
    }
 ...
 */
static int
bcm56880_a0_ecmp_pt_write(int unit,
 ...
 */
static int
bcm56880_a0_ecmp_pt_read(int unit,
                         bcmecmp_pt_op_info_t *op_info,
                         uint32_t *buf)
{
 ...
 */
static int
bcm56880_a0_ecmp_sids_init(int unit,
                           bcmecmp_drv_var_t *drv_var)
{
    ...
    if (member0_info != NULL) {
        for (i = 0;
             i < member0_info->mbr_tbl_count;
             i++) {
            if (i == MEMBER0) {
                BCMECMP_TBL_DRD_SID
                (unit, member, BCMECMP_GRP_TYPE_LEVEL0)
                = member0_info->mbr_tbl[i];
                BCMECMP_TBL_DRD_SID
                (unit, member, BCMECMP_GRP_TYPE_LEVEL0_WEIGHTED)
                = member0_info->mbr_tbl[i];
            } else if (i == MEMBER1) {
                BCMECMP_TBL_DRD_SID
                (unit, member2, BCMECMP_GRP_TYPE_LEVEL0)
                = member0_info->mbr_tbl[i];
                BCMECMP_TBL_DRD_SID
                (unit, member2, BCMECMP_GRP_TYPE_LEVEL0_WEIGHTED)
                = member0_info->mbr_tbl[i];
            } else {
                SHR_ERR_EXIT(SHR_E_INTERNAL);
            }
    ...
    if (member1_info != NULL) {
        for (i = 0;
             i < member1_info->mbr_tbl_count;
             i++) {
            if (i == MEMBER0) {
                BCMECMP_TBL_DRD_SID
                (unit, member, BCMECMP_GRP_TYPE_LEVEL1)
                = member1_info->mbr_tbl[i];
                BCMECMP_TBL_DRD_SID
                (unit, member, BCMECMP_GRP_TYPE_LEVEL1_WEIGHTED)
                = member1_info->mbr_tbl[i];
            } else if (i == MEMBER1) {
                BCMECMP_TBL_DRD_SID
                (unit, member2, BCMECMP_GRP_TYPE_LEVEL1)
                = member1_info->mbr_tbl[i];
                BCMECMP_TBL_DRD_SID
                (unit, member2, BCMECMP_GRP_TYPE_LEVEL1_WEIGHTED)
                = member1_info->mbr_tbl[i];
            } else {
                SHR_ERR_EXIT(SHR_E_INTERNAL);
            }
 ...
 */
static int
bcm56880_a0_ecmp_olay_lt_flds_init(int unit,
 ...
 */
static int
bcm56880_a0_ecmp_member0_lt_flds_init(int unit,
 ...
 */
static int
bcm56880_a0_ecmp_member1_lt_flds_init(int unit,
                                   const bcmlrd_map_t *map)
{
    /* LT fields LTD ID. */
 ...
 */
static int
bcm56880_a0_ecmp_ulay_lt_flds_init(int unit,
                                   const bcmlrd_map_t *map,
 ...
 */
static int
bcm56880_a0_ecmp_fields_init(int unit,
                             bcmecmp_drv_var_t *drv_var)
{
    ...
    if (SHR_SUCCESS(rv)) {
         ...
         */
        SHR_IF_ERR_EXIT
            (bcm56880_a0_ecmp_olay_lt_flds_init(unit, map, wmap));
    ...
    if (SHR_SUCCESS(rv)) {
         ...
         */
        SHR_IF_ERR_EXIT
            (bcm56880_a0_ecmp_ulay_lt_flds_init(unit, map, wmap));
    }
    ...
    if (SHR_SUCCESS(rv)) {
        SHR_NULL_CHECK(map, SHR_E_INTERNAL);
        SHR_IF_ERR_EXIT
          (bcm56880_a0_ecmp_member0_lt_flds_init(unit, map));
    }
    ...
    if (SHR_SUCCESS(rv)) {
        SHR_NULL_CHECK(map, SHR_E_INTERNAL);
        SHR_IF_ERR_EXIT
          (bcm56880_a0_ecmp_member1_lt_flds_init(unit, map));
    }
...
static int
bcm56880_a0_ecmp_itbm_groups_cleanup(int unit, int gtype)
{
...
static int
bcm56880_a0_ecmp_itbm_lists_cleanup(int unit)
{
    ...
    list_hdl =
      BCMECMP_TBL_ITBM_LIST((BCMECMP_TBL_PTR(unit, group,
             BCMECMP_GRP_TYPE_LEVEL0)));
    if (list_hdl) {
        rv = shr_itbm_list_destroy(list_hdl, 0, 0);
        if (rv != SHR_E_NONE) {
            SHR_IF_ERR_EXIT(rv);
        }
    }
...
static int
bcm56880_a0_ecmp_member_dest_itbm_groups_cleanup(int unit, int level)
{
...
static int
bcm56880_a0_ecmp_itbm_lists_init(int unit,
                                const bcmecmp_drv_var_t *drv_var)
{
    ...
    if (member0_info != NULL) {
        ...
        params.max = BCMECMP_TBL_IDX_MAX
            (unit, member, BCMECMP_GRP_TYPE_LEVEL0) +
            BCMECMP_TBL_IDX_MAX
            (unit, member2, BCMECMP_GRP_TYPE_LEVEL0) + 1;
        params.first = BCMECMP_TBL_IDX_MIN
            (unit, member, BCMECMP_GRP_TYPE_LEVEL0);
        params.last = BCMECMP_TBL_IDX_MAX
            (unit, member, BCMECMP_GRP_TYPE_LEVEL0) +
    ...
    if (ids->ecmp_mlevel1_ltid != (uint32_t) BCMECMP_INVALID) {
        ...
        params.max = BCMECMP_TBL_IDX_MAX
            (unit, member, BCMECMP_GRP_TYPE_LEVEL1) +
            BCMECMP_TBL_IDX_MAX
            (unit, member2, BCMECMP_GRP_TYPE_LEVEL1) + 1;
        params.first = BCMECMP_TBL_IDX_MIN
            (unit, member, BCMECMP_GRP_TYPE_LEVEL1);
        params.last = BCMECMP_TBL_IDX_MAX
            (unit, member, BCMECMP_GRP_TYPE_LEVEL1) +
...
exit:
    if (SHR_FUNC_ERR()) {
        ...
        if (list_hdl) {
            BCMECMP_TBL_ITBM_LIST((BCMECMP_TBL_PTR(unit, group,
             BCMECMP_GRP_TYPE_LEVEL0))) = NULL;
            shr_itbm_list_destroy(list_hdl, 0, 0);
        }
 ...
 */
static int
bcm56880_a0_ecmp_hw_tbls_range_init(int unit,
                                    const bcmecmp_drv_var_t *drv_var)
{
    ...
    wsize = bcmdrd_pt_entry_wsize(unit,
                                  BCMECMP_TBL_DRD_SID
                                        (unit, member2,
                                         BCMECMP_GRP_TYPE_LEVEL0));
    BCMECMP_TBL_ENT_SIZE
        (unit, member2, BCMECMP_GRP_TYPE_LEVEL0) = wsize;
    if (wsize > BCMECMP_TBL_ENT_SIZE_MAX(unit)) {
        BCMECMP_TBL_ENT_SIZE_MAX(unit) = wsize;
    }
    wsize = bcmdrd_pt_entry_wsize(unit,
    ...
    memb_imin = bcmdrd_pt_index_min(unit,
                                    BCMECMP_TBL_DRD_SID(unit, member2,
                                        BCMECMP_GRP_TYPE_LEVEL0));
    memb_imax = bcmdrd_pt_index_max(unit,
                                    BCMECMP_TBL_DRD_SID(unit, member2,
                                        BCMECMP_GRP_TYPE_LEVEL0));
    ...
    BCMECMP_TBL_IDX_MAX_USED
        (unit, member2, BCMECMP_GRP_TYPE_LEVEL0) = memb_imin;

    BCMECMP_TBL_IDX_MIN
        (unit, member2, BCMECMP_GRP_TYPE_LEVEL0) = memb_imin;
    BCMECMP_TBL_IDX_MAX
        (unit, member2, BCMECMP_GRP_TYPE_LEVEL0) = memb_imax;
    ...
    BCMECMP_TBL_SIZE(unit, member2, BCMECMP_GRP_TYPE_LEVEL0) = tbl_sz;
    BCMECMP_TBL_SIZE(unit, member2, BCMECMP_GRP_TYPE_LEVEL0_WEIGHTED) = tbl_sz;
    ...
    BCMECMP_TBL_IDX_MIN
        (unit, member2, BCMECMP_GRP_TYPE_LEVEL1)
            = memb_imin;
    BCMECMP_TBL_IDX_MAX
        (unit, member2, BCMECMP_GRP_TYPE_LEVEL1) = memb_imax;

    BCMECMP_TBL_IDX_MIN
        (unit, member2, BCMECMP_GRP_TYPE_LEVEL1_WEIGHTED)
            = memb_imin;
    BCMECMP_TBL_IDX_MAX
        (unit, member2, BCMECMP_GRP_TYPE_LEVEL1_WEIGHTED) = memb_imax;
    ...
    BCMECMP_TBL_IDX_MAX_USED
        (unit, member2, BCMECMP_GRP_TYPE_LEVEL1) = memb_imin;
    ...
    BCMECMP_TBL_SIZE(unit, member2, BCMECMP_GRP_TYPE_LEVEL1) = tbl_sz;
    BCMECMP_TBL_SIZE(unit, member2, BCMECMP_GRP_TYPE_LEVEL1_WEIGHTED) = tbl_sz;
 ...
 */
static int
bcm56880_a0_ecmp_tables_init(int unit,
                             bcmecmp_drv_var_t *drv_var)
{
    ...
    SHR_IF_ERR_EXIT
        (bcm56880_a0_ecmp_sids_init(unit, drv_var));

    /* Initialize ECMP hardware tables size and index range info. */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_ecmp_hw_tbls_range_init(unit, drv_var));

    /* Initialize ECMP tables logical and physical field details. */
    SHR_IF_ERR_EXIT
        (bcm56880_a0_ecmp_fields_init(unit, drv_var));
 ...
 */
static int
bcm56880_a0_ecmp_db_init(int unit,
                         bool warm,
                         const bcmecmp_drv_var_t *drv_var)
{
    ...
    uint32_t blk_sig = 0x56880000; /* ECMP HA block signature. */
 ...
 */
static int
bcm56880_a0_ecmp_abort_db_init(int unit,
                               bool warm,
                               const bcmecmp_drv_var_t *drv_var)
{
    bcmecmp_tbl_prop_t *tbl_ptr = NULL; /* ECMP hardware table info ptr. */
 ...
 */
static int
bcm56880_a0_ecmp_entries_init(int unit,
                              bool warm,
                              const bcmecmp_drv_var_t *drv_var)
{
    SHR_FUNC_ENTER(unit);
     ...
     */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_ecmp_db_init(unit, warm, drv_var));

    /* Initialize atomic transaction related SW database. */
    if (BCMECMP_ATOMIC_TRANS(unit)) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56880_a0_ecmp_abort_db_init(unit, warm, drv_var));
    }
exit:
    SHR_FUNC_EXIT();
}

static int bcm56880_a0_ecmp_lt_entry_alloc(int unit)
{
    SHR_FUNC_ENTER(unit);
...
static void bcm56880_a0_ecmp_lt_entry_free(int unit)
{
    /* Free LT entry. */
 ...
 */
static int
bcm56880_a0_ecmp_info_init(int unit, bool warm)
{
    bcmecmp_drv_var_t *drv_var = bcmecmp_drv_var_get(unit);
    const bcmecmp_drv_var_ids_t *ids = NULL;
    ...
    SHR_IF_ERR_EXIT
        (bcm56880_a0_ecmp_tables_init(unit, drv_var));

    /* Allocate itbm list handlers for the ecmp groups. */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_ecmp_itbm_lists_init(unit, drv_var));
     ...
     */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_ecmp_entries_init(unit, warm, drv_var));

    /* Allocate LT entry. */
    SHR_IF_ERR_EXIT
        (bcm56880_a0_ecmp_lt_entry_alloc(unit));
exit:
    SHR_FUNC_EXIT();
}
 ...
 */
static int
bcm56880_a0_ecmp_olay_grps_flds_cleanup(int unit)
{
    bcmecmp_grp_drd_fields_t *ogdrd_fields = NULL;  /* Group tbl DRD info. */
 ...
 */
static int
bcm56880_a0_ecmp_ulay_grps_flds_cleanup(int unit)
{
    bcmecmp_grp_drd_fields_t *ugdrd_fields = NULL;  /* Group tbl DRD info. */
 ...
 */
static int
bcm56880_a0_ecmp_member0_grps_flds_cleanup(int unit)
{
 ...
 */
static int
bcm56880_a0_ecmp_member1_grps_flds_cleanup(int unit)
{
 ...
 */
static int
bcm56880_a0_ecmp_fields_cleanup(int unit, const bcmecmp_drv_var_ids_t *ids)
{
    ...
    if (ids->ecmp_level0_ltid != (uint32_t) BCMECMP_INVALID) {
        ...
        bcm56880_a0_ecmp_olay_grps_flds_cleanup(unit);
    }


    if (ids->ecmp_level1_ltid != (uint32_t) BCMECMP_INVALID) {
        /* Cleanup ECMP_LEVEL1 LT fields information. */
        bcm56880_a0_ecmp_ulay_grps_flds_cleanup(unit);
    }

        /* Cleanup ECMP_MEMBER0 LT fields information. */
    if (ids->ecmp_mlevel0_ltid != (uint32_t) BCMECMP_INVALID) {
        bcm56880_a0_ecmp_member0_grps_flds_cleanup(unit);
    }

    if (ids->ecmp_mlevel1_ltid != (uint32_t) BCMECMP_INVALID) {
        /* Cleanup ECMP_MEMBER1 LT fields information. */
        bcm56880_a0_ecmp_member1_grps_flds_cleanup(unit);
    }
 ...
 */
static int
bcm56880_a0_ecmp_db_clear(int unit)
{
 ...
 */
static int
bcm56880_a0_ecmp_hw_tbls_range_clear(int unit)
{
 ...
 */
static int
bcm56880_a0_ecmp_sids_clear(int unit)
{
    SHR_FUNC_ENTER(unit);
 ...
 */
static int
bcm56880_a0_ecmp_tables_clear(int unit, const bcmecmp_drv_var_ids_t *ids)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_ecmp_fields_cleanup(unit, ids));

    /* Clear ECMP hardware tables size and index range info. */
    SHR_IF_ERR_EXIT
        (bcm56880_a0_ecmp_hw_tbls_range_clear(unit));

    /* Clear ECMP tables DRD-SID and LTD-SID details. */
    SHR_IF_ERR_EXIT
        (bcm56880_a0_ecmp_sids_clear(unit));
 ...
 */
static int
bcm56880_a0_ecmp_abort_db_clear(int unit)
{
    bcmecmp_tbl_prop_t *tbl_ptr; /* Pointer to ECMP hardware table info. */
 ...
 */
static int
bcm56880_a0_ecmp_entries_cleanup(int unit, const bcmecmp_drv_var_ids_t *ids)
{
    SHR_FUNC_ENTER(unit);

    if (ids->ecmp_level0_ltid != (uint32_t) BCMECMP_INVALID) {
        SHR_IF_ERR_EXIT
            (bcm56880_a0_ecmp_itbm_groups_cleanup(
    ...
    if (ids->ecmp_mlevel0_ltid != (uint32_t) BCMECMP_INVALID) {
        SHR_IF_ERR_EXIT
            (bcm56880_a0_ecmp_member_dest_itbm_groups_cleanup(unit, 0));
    }

    if (ids->ecmp_mlevel1_ltid != (uint32_t) BCMECMP_INVALID) {
        SHR_IF_ERR_EXIT
            (bcm56880_a0_ecmp_member_dest_itbm_groups_cleanup(unit, 1));
    }

    SHR_IF_ERR_EXIT
        (bcm56880_a0_ecmp_db_clear(unit));

    /* Clear atomic transaction related SW database info. */
    if (BCMECMP_ATOMIC_TRANS(unit)) {
        SHR_IF_ERR_EXIT
            (bcm56880_a0_ecmp_abort_db_clear(unit));
    }
 ...
 */
static int
bcm56880_a0_ecmp_info_cleanup(int unit)
{
   bcmecmp_drv_var_t *drv_var = bcmecmp_drv_var_get(unit);
    const bcmecmp_drv_var_ids_t *ids = NULL;
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_ecmp_entries_cleanup(unit, ids));

    /* Clear ECMP tables information stored in SW. */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_ecmp_tables_clear(unit, ids));

    /* Clean the ITBM lists handlers. */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_ecmp_itbm_lists_cleanup(unit));

    /* Free LT entry. */
    bcm56880_a0_ecmp_lt_entry_free(unit);
 ...
 */
static int
bcm56880_a0_ecmp_mode_config(int unit)
{
 ...
 */
static int
bcm56880_a0_ecmp_grp_pio_del(int unit,
                             void *info)
{
    ...
    bcm56880_a0_pt_op_info_t_init(&op_info);
    op_info.drd_sid = BCMECMP_TBL_DRD_SID(unit, member, gtype);

    if (start_idx > (int)(BCMECMP_TBL_IDX_MAX(unit, member, gtype))) {
        op_info.drd_sid = BCMECMP_TBL_DRD_SID(unit, member2, gtype);
        start_idx -= BCMECMP_TBL_SIZE(unit, member, gtype);
    } else {
        op_info.drd_sid = BCMECMP_TBL_DRD_SID(unit, member, gtype);
    }
    ...
    for (arr_idx = 0; arr_idx < max_paths; arr_idx++, op_info.dyn_info.index++) {
        ...
        if ((op_info.drd_sid == BCMECMP_TBL_DRD_SID(unit, member, gtype)) &&
            (op_info.dyn_info.index > (int)(BCMECMP_TBL_IDX_MAX(unit, member, gtype)))) {
            op_info.drd_sid = BCMECMP_TBL_DRD_SID(unit, member2, gtype);
            op_info.dyn_info.index = 0;
        }
        /* Write entry to Post-IFP Member table. */
        SHR_IF_ERR_EXIT
            (bcm56880_a0_ecmp_pt_write(unit, &op_info, pt_entry_buff));
    }
 ...
 */
static int
bcm56880_a0_ecmp_grp_dma_ins(int unit,
                             void *info)
{
    bcmecmp_grp_type_t gtype = BCMECMP_GRP_TYPE_COUNT; /* ECMP Group type. */
    ...
    BCMECMP_ALLOC(pt_entry_buff,
                  BCMECMP_TBL_ENT_SIZE_MAX(unit) * sizeof(uint32_t),
                  "bcmecmpBcm56880GrpDmaInsPtEntBuf");

    dma_alloc_sz = (BCMECMP_TBL_ENT_SIZE
                        (unit, member, gtype) * sizeof(uint32_t) *
                         lt_ent->max_paths);
    BCMECMP_ALLOC(dma_buf, dma_alloc_sz, "bcmecmpBcm56880GrpDmaInsPtDmaBuf");
    ...
    if (mstart_idx > BCMECMP_TBL_IDX_MAX(unit, member, gtype)) {
        op_info.drd_sid = BCMECMP_TBL_DRD_SID(unit, member2, gtype);
        op_info.dyn_info.index = mstart_idx - (BCMECMP_TBL_IDX_MAX(unit, member, gtype) + 1);
    } else {
        op_info.drd_sid = BCMECMP_TBL_DRD_SID(unit, member, gtype);
        if (mstart_idx + (int)(lt_ent->max_paths) - 1 > \
                     (int)(BCMECMP_TBL_IDX_MAX(unit, member, gtype))) {
            op_info.ecount = BCMECMP_TBL_IDX_MAX(unit, member, gtype) - mstart_idx + 1;
            overlap_mem = 1;
        }
    }
    op_info.wsize = BCMECMP_TBL_ENT_SIZE(unit, member, gtype);
    ...
    SHR_IF_ERR_EXIT
        (bcm56880_a0_ecmp_pt_write(unit, &op_info, dma_buf));

    if (overlap_mem) {
        write_size = op_info.ecount * ent_size;
        op_info.drd_sid = BCMECMP_TBL_DRD_SID(unit, member2, gtype);
        op_info.dyn_info.index = 0;
        op_info.ecount = lt_ent->max_paths - op_info.ecount;
        SHR_IF_ERR_EXIT
            (bcm56880_a0_ecmp_pt_write(unit, &op_info, dma_buf + write_size));
    }
    ...
    if (lt_ent->num_paths != 0) {
        ...
        LOG_VERBOSE(BSL_LOG_MODULE,
                    (BSL_META_U(unit,
                                "inserted dma at %u %u overlap %u.\n"),
                     mstart_idx, lt_ent->mstart_idx, overlap_mem));
        /*
 ...
 */
static int
bcm56880_a0_ecmp_grp_pio_ins(int unit,
                             void *info)
{
    bcmecmp_grp_type_t gtype = BCMECMP_GRP_TYPE_COUNT; /* ECMP Group type. */
    bcmecmp_flex_lt_entry_t *lt_ent = NULL;    /* LT entry data pointer. */
    ...
    if (mstart_idx > BCMECMP_TBL_IDX_MAX(unit, member, gtype)) {
        op_info.drd_sid = BCMECMP_TBL_DRD_SID(unit, member2, gtype);
        mstart_idx -= BCMECMP_TBL_SIZE(unit, member, gtype);
    } else {
        op_info.drd_sid = BCMECMP_TBL_DRD_SID(unit, member, gtype);
    }
    op_info.dyn_info.index = (mstart_idx);
    ...
    for (arr_idx = 0; arr_idx < num_paths; arr_idx++, op_info.dyn_info.index++) {
        ...
        if ((op_info.drd_sid == BCMECMP_TBL_DRD_SID(unit, member, gtype)) &&
            (op_info.dyn_info.index > BCMECMP_TBL_IDX_MAX(unit, member, gtype))) {
            op_info.drd_sid = BCMECMP_TBL_DRD_SID(unit, member2, gtype);
            op_info.dyn_info.index = 0;
        }
        SHR_IF_ERR_EXIT
 ...
 */
static int
bcm56880_a0_ecmp_grp_ins(int unit,
                         void *info)
{
    ...
    if (BCMECMP_USE_DMA(unit)) {
        SHR_ERR_EXIT
            (bcm56880_a0_ecmp_grp_dma_ins(unit, info));
    } else {
        SHR_ERR_EXIT
            (bcm56880_a0_ecmp_grp_pio_ins(unit, info));
    }
...
static int
bcm56880_a0_ecmp_grp_dma_get(int unit,
                             void *info)
{
    bcmecmp_grp_type_t gtype = BCMECMP_GRP_TYPE_COUNT; /* ECMP Group type. */
    bcmecmp_flex_lt_entry_t *lt_ent = NULL;    /* LT entry data pointer. */
    ...
    BCMECMP_ALLOC(pt_entry_buff,
                  BCMECMP_TBL_ENT_SIZE_MAX(unit) * sizeof(uint32_t),
                  "bcmecmpBcm56880GrpDmaGetPtEntBuf");
    ...
    if (lt_ent->mstart_idx > BCMECMP_TBL_IDX_MAX(unit, member, gtype)) {
        op_info.drd_sid = BCMECMP_TBL_DRD_SID(unit, member2, gtype);
        op_info.dyn_info.index = lt_ent->mstart_idx - (BCMECMP_TBL_IDX_MAX(unit, member, gtype) + 1);
    } else if ((int)(lt_ent->mstart_idx + lt_ent->max_paths - 1) > BCMECMP_TBL_IDX_MAX(unit, member, gtype)) {
            op_info.ecount = BCMECMP_TBL_IDX_MAX(unit, member, gtype) - lt_ent->mstart_idx + 1;
            op_info.wsize = (BCMECMP_TBL_ENT_SIZE
                            (unit, member, gtype) * op_info.ecount);
            overlap_mem = 1;
    }
    SHR_IF_ERR_EXIT
        (bcm56880_a0_ecmp_pt_read(unit, &op_info, dma_buf));

    if (overlap_mem) {
        uint32_t size_read;
        size_read = op_info.wsize;
        op_info.drd_sid = BCMECMP_TBL_DRD_SID(unit, member2, gtype);
        op_info.ecount = lt_ent->max_paths - op_info.ecount;
        op_info.wsize = (BCMECMP_TBL_ENT_SIZE
                        (unit, member2, gtype) * op_info.ecount);
        op_info.dyn_info.index = 0;
        SHR_IF_ERR_EXIT
            (bcm56880_a0_ecmp_pt_read(unit, &op_info, dma_buf + size_read));
    }
 ...
 */
static int
bcm56880_a0_ecmp_grp_del(int unit,
                         void *info)
{
    SHR_FUNC_ENTER(unit);
    SHR_NULL_CHECK(info, SHR_E_PARAM);
    ...
    LOG_INFO(BSL_LOG_MODULE,
             (BSL_META_U(unit,
                         "bcm56880_a0_ecmp_grp_del.\n")));

    if (BCMECMP_USE_DMA(unit)) {
        SHR_ERR_EXIT
            (bcm56880_a0_ecmp_grp_pio_del(unit, info));
    } else {
        SHR_ERR_EXIT
            (bcm56880_a0_ecmp_grp_pio_del(unit, info));
    }
 ...
 */
static int
bcm56880_a0_ecmp_memb_dma_cpy(int unit,
                              const void *mdest,
                              const void *msrc)
{
    ...
    dma_alloc_sz = (BCMECMP_TBL_ENT_SIZE
                        (unit, member, gtype) * sizeof(uint32_t) *
                         sfrag->gsize);
    BCMECMP_ALLOC(dma_buf, dma_alloc_sz, "bcmecmp56880L3EcmpDmaCpy");
    ...
    if (sfrag->mstart_idx > BCMECMP_TBL_IDX_MAX(unit, member, gtype)) {
        op_info.drd_sid = BCMECMP_TBL_DRD_SID(unit, member2, gtype);
        op_info.dyn_info.index = sfrag->mstart_idx - (BCMECMP_TBL_IDX_MAX(unit, member, gtype) + 1);
    } else if ((int)(sfrag->mstart_idx + sfrag->gsize - 1) > BCMECMP_TBL_IDX_MAX(unit, member, gtype)) {
            op_info.ecount = BCMECMP_TBL_IDX_MAX(unit, member, gtype) - sfrag->mstart_idx + 1;
            op_info.wsize = (BCMECMP_TBL_ENT_SIZE
                            (unit, member, gtype) * op_info.ecount);
            overlap_mem = 1;
    }
    ...
    if (overlap_mem) {
        ...
        size_read = op_info.wsize;
        op_info.drd_sid = BCMECMP_TBL_DRD_SID(unit, member2, gtype);
        op_info.ecount = sfrag->gsize - op_info.ecount;
        op_info.wsize = (BCMECMP_TBL_ENT_SIZE
                        (unit, member2, gtype) * op_info.ecount);
        op_info.dyn_info.index = 0;
        SHR_IF_ERR_EXIT
    ...
    if (dfrag->mstart_idx > BCMECMP_TBL_IDX_MAX(unit, member, gtype)) {
        op_info.drd_sid = BCMECMP_TBL_DRD_SID(unit, member2, gtype);
        op_info.dyn_info.index = dfrag->mstart_idx - (BCMECMP_TBL_IDX_MAX(unit, member, gtype) + 1);
    } else if ((int)(dfrag->mstart_idx + dfrag->gsize - 1) > BCMECMP_TBL_IDX_MAX(unit, member, gtype)) {
            op_info.ecount = BCMECMP_TBL_IDX_MAX(unit, member, gtype) - dfrag->mstart_idx + 1;
            op_info.wsize = (BCMECMP_TBL_ENT_SIZE
                            (unit, member, gtype) * op_info.ecount);
            overlap_mem = 1;
    }
    ...
    if (overlap_mem) {
        uint32_t size_wr;
        op_info.drd_sid = BCMECMP_TBL_DRD_SID(unit, member2, gtype);
        size_wr = op_info.wsize;
        op_info.ecount = dfrag->gsize - op_info.ecount;
        op_info.wsize = (BCMECMP_TBL_ENT_SIZE
                        (unit, member, gtype) * op_info.ecount);
        op_info.dyn_info.index = 0;
        SHR_IF_ERR_EXIT
            (bcm56880_a0_ecmp_pt_write(unit, &op_info, dma_buf + size_wr));
    }
 ...
 */
static int
bcm56880_a0_ecmp_memb_pio_cpy(int unit,
                              const void *mdest,
                              const void *msrc)
{
    SHR_FUNC_ENTER(unit);
 ...
 */
static int
bcm56880_a0_ecmp_memb_cpy(int unit,
                          const void *mdest,
                          const void *msrc)
{
    SHR_FUNC_ENTER(unit);
    ...
    if (BCMECMP_USE_DMA(unit)) {
        SHR_ERR_EXIT
            (bcm56880_a0_ecmp_memb_dma_cpy(unit, mdest, msrc));
    } else {
        SHR_ERR_EXIT
            (bcm56880_a0_ecmp_memb_pio_cpy(unit, mdest, msrc));
    }
 ...
 */
static int
bcm56880_a0_ecmp_memb_dma_clr(int unit,
                              const void *mfrag)
{
    ...
    dma_alloc_sz = (BCMECMP_TBL_ENT_SIZE
                        (unit, member, gtype) * sizeof(uint32_t) *
                         mclr->gsize);
    BCMECMP_ALLOC(dma_buf, dma_alloc_sz, "bcmecmp56880L3EcmpDmaClr");
    ...
    if (mclr->mstart_idx > BCMECMP_TBL_IDX_MAX(unit, member, gtype)) {
        op_info.drd_sid = BCMECMP_TBL_DRD_SID(unit, member2, gtype);
        op_info.dyn_info.index = mclr->mstart_idx - (BCMECMP_TBL_IDX_MAX(unit, member, gtype) + 1);
    } else if ((int)(mclr->mstart_idx + mclr->gsize - 1) > BCMECMP_TBL_IDX_MAX(unit, member, gtype)) {
            op_info.ecount = BCMECMP_TBL_IDX_MAX(unit, member, gtype) - mclr->mstart_idx + 1;
            op_info.wsize = (BCMECMP_TBL_ENT_SIZE
                            (unit, member, gtype) * op_info.ecount);
            overlap_mem = 1;
    }
    ...
    if (overlap_mem) {
        ...
        op_info.drd_sid = BCMECMP_TBL_DRD_SID(unit, member2, gtype);
        size_wr = op_info.wsize;
        op_info.ecount = mclr->gsize - op_info.ecount;
        op_info.wsize = (BCMECMP_TBL_ENT_SIZE
                        (unit, member2, gtype) * op_info.ecount);
        op_info.dyn_info.index = 0;
        SHR_IF_ERR_EXIT
 ...
 */
static int
bcm56880_a0_ecmp_memb_clr(int unit,
                          const void *mfrag)
{
    SHR_FUNC_ENTER(unit);
    ...
    LOG_VERBOSE(BSL_LOG_MODULE,
                (BSL_META_U(unit,
                            "%s.\n"), __func__));
    SHR_ERR_EXIT
        (bcm56880_a0_ecmp_memb_dma_clr(unit, mfrag));
 ...
 */
static int
bcm56880_a0_ecmp_gmstart_updt(int unit,
                              const void *ginfo)
{
    ...
    sal_memset(pt_entry_buff, 0,
               BCMECMP_TBL_ENT_SIZE_MAX(unit) * sizeof(uint32_t));
    SHR_IF_ERR_EXIT
        (bcm56880_a0_ecmp_pt_read(unit, &op_info, pt_entry_buff));
    if (wali->gwsize == 0) {
...
static int
bcm56880_a0_grp_member_fields_count_get(int unit, void *lt_entry)
{
 ...
 */
int
bcm56880_a0_ecmp_attach(int unit)
{
    ...
    BCMECMP_FNCALL(unit, info_init) = &bcm56880_a0_ecmp_info_init;

    /* Setup device ECMP component clean-up function. */
    BCMECMP_FNCALL(unit, info_cleanup) = &bcm56880_a0_ecmp_info_cleanup;
    ...
    BCMECMP_FNCALL(unit, mode_config) = &bcm56880_a0_ecmp_mode_config;

    /* Initialize device ECMP group management function pointers. */
    BCMECMP_FNCALL(unit, grp_ins) = &bcm56880_a0_ecmp_grp_ins;
    BCMECMP_FNCALL(unit, grp_del) = &bcm56880_a0_ecmp_grp_del;
    BCMECMP_FNCALL(unit, grp_get) = &bcm56880_a0_ecmp_grp_dma_get;
    BCMECMP_FNCALL(unit, rh_grp_ins) = NULL;
    BCMECMP_FNCALL(unit, rh_grp_del) = NULL;
    BCMECMP_FNCALL(unit, rh_grp_get) = NULL;
    BCMECMP_FNCALL(unit, memb_cpy) = &bcm56880_a0_ecmp_memb_cpy;
    BCMECMP_FNCALL(unit, memb_clr) = &bcm56880_a0_ecmp_memb_clr;
    BCMECMP_FNCALL(unit, gmstart_updt) = &bcm56880_a0_ecmp_gmstart_updt;
    BCMECMP_FNCALL(unit, grp_ol_lt_fields_fill) =
                            &bcm56880_a0_level0_group_lt_fields_fill;
    BCMECMP_FNCALL(unit, grp_ul_lt_fields_fill) =
                            &bcm56880_a0_level1_group_lt_fields_fill;
    BCMECMP_FNCALL(unit, grp_member_dest_lt_fields_fill) =
                            &bcm56880_a0_flex_member_dest_lt_fields_fill;
    BCMECMP_FNCALL(unit, grp_member_fields_count_get) =
                            &bcm56880_a0_grp_member_fields_count_get;
 ...
 */
int
bcm56880_a0_ecmp_detach(int unit)
{
    SHR_FUNC_ENTER(unit);

    LOG_INFO(BSL_LOG_MODULE,
             (BSL_META_U(unit,
                         "bcm56880_a0_ecmp_detach.\n")));
