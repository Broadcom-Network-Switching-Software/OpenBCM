    ...
    bcmcth_mirror_encap_t *entry)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmpkt_flexhdr_field_id_get(variant, hid, member_name, &id));

    if (flexhdr_info[unit][i].set) {
        SHR_IF_ERR_EXIT
            (flexhdr_info[unit][i].set(variant, hid, entry->flexhdr,
            BCMPKT_FLEXHDR_PROFILE_NONE, id, fval));
    }
exit:
    ...
    bcmcth_mirror_encap_t *entry)
{
    ...
    switch (fid) {
        case MIRROR_ENCAP_BASICt_ENCAP_MODEf:
            ...
            break;
        case MIRROR_ENCAP_BASICt_TRUNCATEf:
            entry->truncate_en = fval;
            break;
        case MIRROR_ENCAP_BASICt_TRUNCATE_ACTIONf:
            entry->truncate_action = fval;
            break;
        case MIRROR_ENCAP_BASICt_MIRROR_TRUNCATE_LENGTH_IDf:
    ...
    bcmcth_mirror_encap_t *entry)
{
    ...
    switch (fid) {
        ...
        case MIRROR_ENCAP_RSPANt_DST_NIV_VIFf:
            ...
            break;
        case MIRROR_ENCAP_RSPANt_TRUNCATEf:
            entry->truncate_en = fval;
            break;
        case MIRROR_ENCAP_RSPANt_TRUNCATE_ACTIONf:
            entry->truncate_action = fval;
            break;
        case MIRROR_ENCAP_RSPANt_MIRROR_TRUNCATE_LENGTH_IDf:
            entry->truncate_ptr = fval;
            break;
        default:
            break;
    ...
    if (sid == MIRROR_ENCAP_ERSPANt) {
        switch (fid) {
            ...
            case MIRROR_ENCAP_ERSPANt_HIGIG3_BASE_HDRf:
                ...
                break;
            case MIRROR_ENCAP_ERSPANt_TRUNCATEf:
                entry->truncate_en = fval;
                break;
            case MIRROR_ENCAP_ERSPANt_TRUNCATE_ACTIONf:
                entry->truncate_action = fval;
                break;
            case MIRROR_ENCAP_ERSPANt_MIRROR_TRUNCATE_LENGTH_IDf:
                entry->truncate_ptr = fval;
                break;
            default:
                break;
        ...
        switch (fid) {
            ...
            case MIRROR_ENCAP_ERSPAN_IPV6t_HIGIG3_BASE_HDRf:
                entry->higig3_basehdr = fval;
                break;
            case MIRROR_ENCAP_ERSPAN_IPV6t_TRUNCATEf:
                entry->truncate_en = fval;
                break;
            case MIRROR_ENCAP_ERSPAN_IPV6t_TRUNCATE_ACTIONf:
                entry->truncate_action = fval;
                break;
            case MIRROR_ENCAP_ERSPAN_IPV6t_MIRROR_TRUNCATE_LENGTH_IDf:
                entry->truncate_ptr = fval;
                break;
            default:
                break;
    ...
    if (sid == MIRROR_ENCAP_SFLOW_SEQt) {
        switch (fid) {
            ...
            case MIRROR_ENCAP_SFLOW_SEQt_HIGIG3_BASE_HDRf:
                entry->higig3_basehdr = fval;
                break;
            case MIRROR_ENCAP_SFLOW_SEQt_TRUNCATEf:
                entry->truncate_en = fval;
                break;
            case MIRROR_ENCAP_SFLOW_SEQt_TRUNCATE_ACTIONf:
                entry->truncate_action = fval;
                break;
            case MIRROR_ENCAP_SFLOW_SEQt_MIRROR_TRUNCATE_LENGTH_IDf:
                entry->truncate_ptr = fval;
                break;
            default:
                break;
        ...
        switch (fid) {
            ...
            case MIRROR_ENCAP_SFLOW_SEQ_IPV6t_HIGIG3_BASE_HDRf:
                entry->higig3_basehdr = fval;
                break;
            case MIRROR_ENCAP_SFLOW_SEQ_IPV6t_TRUNCATEf:
                entry->truncate_en = fval;
                break;
            case MIRROR_ENCAP_SFLOW_SEQ_IPV6t_TRUNCATE_ACTIONf:
                entry->truncate_action = fval;
                break;
            case MIRROR_ENCAP_SFLOW_SEQ_IPV6t_MIRROR_TRUNCATE_LENGTH_IDf:
                entry->truncate_ptr = fval;
                break;
            default:
                break;
    ...
    if (sid == MIRROR_ENCAP_PSAMP_METADATAt) {
        switch (fid) {
            ...
            case MIRROR_ENCAP_PSAMP_METADATAt_HIGIG3_BASE_HDRf:
                entry->higig3_basehdr = fval;
                break;
            case MIRROR_ENCAP_PSAMP_METADATAt_TRUNCATEf:
                entry->truncate_en = fval;
                break;
            case MIRROR_ENCAP_PSAMP_METADATAt_TRUNCATE_ACTIONf:
                entry->truncate_action = fval;
                break;
            case MIRROR_ENCAP_PSAMP_METADATAt_MIRROR_TRUNCATE_LENGTH_IDf:
                entry->truncate_ptr = fval;
                break;
            default:
                break;
        ...
        switch (fid) {
            ...
            case MIRROR_ENCAP_PSAMP_METADATA_IPV6t_HIGIG3_BASE_HDRf:
                entry->higig3_basehdr = fval;
                break;
            case MIRROR_ENCAP_PSAMP_METADATA_IPV6t_TRUNCATEf:
                entry->truncate_en = fval;
                break;
            case MIRROR_ENCAP_PSAMP_METADATA_IPV6t_TRUNCATE_ACTIONf:
                entry->truncate_action = fval;
                break;
            case MIRROR_ENCAP_PSAMP_METADATA_IPV6t_MIRROR_TRUNCATE_LENGTH_IDf:
                entry->truncate_ptr = fval;
                break;
            default:
                break;
    ...
    if (sid == MIRROR_ENCAP_MIRROR_ON_DROPt) {
        switch (fid) {
            ...
            case MIRROR_ENCAP_MIRROR_ON_DROPt_MODEf:
                entry->mod_mode = fval;
                break;
            case MIRROR_ENCAP_MIRROR_ON_DROPt_TRUNCATEf:
                entry->truncate_en = fval;
                break;
            case MIRROR_ENCAP_MIRROR_ON_DROPt_TRUNCATE_ACTIONf:
                entry->truncate_action = fval;
                break;
            case MIRROR_ENCAP_MIRROR_ON_DROPt_MIRROR_TRUNCATE_LENGTH_IDf:
                entry->truncate_ptr = fval;
                break;
            default:
                break;
        ...
        switch (fid) {
            ...
            case MIRROR_ENCAP_MIRROR_ON_DROP_IPV6t_MODEf:
                entry->mod_mode = fval;
                break;
            case MIRROR_ENCAP_MIRROR_ON_DROP_IPV6t_TRUNCATEf:
                entry->truncate_en = fval;
                break;
            case MIRROR_ENCAP_MIRROR_ON_DROP_IPV6t_TRUNCATE_ACTIONf:
                entry->truncate_action = fval;
                break;
            case MIRROR_ENCAP_MIRROR_ON_DROP_IPV6t_MIRROR_TRUNCATE_LENGTH_IDf:
                entry->truncate_ptr = fval;
                break;
            default:
                break;
    ...
    if (sid == MIRROR_ENCAP_VXLANt) {
        switch (fid) {
            ...
            case MIRROR_ENCAP_VXLANt_VXLAN_VNIDf:
                entry->vni = fval;
                break;
            case MIRROR_ENCAP_VXLANt_TRUNCATEf:
                entry->truncate_en = fval;
                break;
            case MIRROR_ENCAP_VXLANt_TRUNCATE_ACTIONf:
                entry->truncate_action = fval;
                break;
            case MIRROR_ENCAP_VXLANt_MIRROR_TRUNCATE_LENGTH_IDf:
                entry->truncate_ptr = fval;
                break;
            default:
                break;
        ...
        switch (fid) {
            ...
            case MIRROR_ENCAP_VXLAN_IPV6t_VXLAN_VNIDf:
                entry->vni = fval;
                break;
            case MIRROR_ENCAP_VXLAN_IPV6t_TRUNCATEf:
                entry->truncate_en = fval;
                break;
            case MIRROR_ENCAP_VXLAN_IPV6t_TRUNCATE_ACTIONf:
                entry->truncate_action = fval;
                break;
            case MIRROR_ENCAP_VXLAN_IPV6t_MIRROR_TRUNCATE_LENGTH_IDf:
                entry->truncate_ptr = fval;
                break;
            default:
                break;
    ...
    bcmcth_mirror_encap_t *entry)
{
    ...
    switch (fid) {
        ...
        case MIRROR_ENCAP_IFA_1_PROBEt_MAX_LENGTHf:
            ...
            break;
        case MIRROR_ENCAP_IFA_1_PROBEt_TRUNCATEf:
            entry->truncate_en = fval;
            break;
        case MIRROR_ENCAP_IFA_1_PROBEt_TRUNCATE_ACTIONf:
            entry->truncate_action = fval;
            break;
        case MIRROR_ENCAP_IFA_1_PROBEt_MIRROR_TRUNCATE_LENGTH_IDf:
            entry->truncate_ptr = fval;
            break;
        default:
            break;
