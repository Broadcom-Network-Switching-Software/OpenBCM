...
static int
bcm56990_a0_cth_l2_intr_enable_set(int unit, bool enable, bool in_intr)
{
    bcmcth_l2_drv_t *drv;
...
bcm56990_a0_cth_l2_attach(int unit)
{
    ...
    drv->l2_intr_enable_set = bcm56990_a0_cth_l2_intr_enable_set;
    ...
    drv->entry_insert = bcm56990_a0_cth_l2_entry_insert;
    drv->entry_valid = bcm56990_a0_cth_l2_entry_valid;
