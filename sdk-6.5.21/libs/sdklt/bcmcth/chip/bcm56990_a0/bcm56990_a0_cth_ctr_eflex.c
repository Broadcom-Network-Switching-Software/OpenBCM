...
static int
bcm56990_a0_cth_ctr_eflex_trigger_active_reset(
    int unit,
    ...
    ctr_eflex_trigger_data_t *entry)
{
    ...
    if (!entry->trigger) {
        SHR_IF_ERR_EXIT
            (bcm56990_a0_cth_ctr_eflex_trigger_active_reset(unit, entry));
    }
...
static int
bcm56990_a0_cth_ctr_eflex_obj_info_get(
    int unit,
    bool ingress,
    uint32_t *num_obj,
    uint32_t *obj)
...
static bcmcth_ctr_eflex_drv_t bcm56990_a0_cth_ctr_eflex_drv = {
    ...
    .obj_info_get_fn = bcm56990_a0_cth_ctr_eflex_obj_info_get
};
