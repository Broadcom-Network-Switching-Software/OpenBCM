...
static int
bcm56990_a0_dlb_ecmp_nhi_member_set(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    int i;
...
static int
bcm56990_a0_dlb_ecmp_port_member_set(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    int i;
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t field_value = 0;
...
static int
bcm56990_a0_dlb_ecmp_alternate_nhi_member_set(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    int i;
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t field_value = 0;
...
static int
bcm56990_a0_dlb_ecmp_alternate_port_member_set(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    int i;
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t field_value = 0;
...
static int
bcm56990_a0_dlb_ecmp_port_bitmap_set(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    int i;
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t *buf_ptr = NULL;
...
static int
bcm56990_a0_flow_set_base_get(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
...
static int
bcm56990_a0_dlb_ecmp_flow_set_alloc(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    SHR_FUNC_ENTER(unit);

    if (lt_entry->flow_set_size != lt_entry->prev_flow_set_size) {
        SHR_IF_ERR_EXIT
            (bcm56990_a0_flow_set_base_get(unit, lt_entry));
    }
...
static int
bcm56990_a0_dlb_ecmp_flow_set_init(int unit, bcmcth_dlb_ecmp_t *lt_entry,
                                   bool flow_set_init)
{
    ...
    rv = bcm56990_a0_dlb_ecmp_flow_set_alloc(unit, lt_entry);
    if (rv != SHR_E_NONE) {
        if (cleared) {
...
static int
bcm56990_a0_dlb_ecmp_grp_ctrl_set(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t field_value = 0;
    uint32_t *buf_ptr = NULL;
...
static int
bcm56990_a0_dlb_ecmp_enable(int unit, bcmcth_dlb_ecmp_t *lt_entry, bool enable)
{
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t *buf_ptr = NULL;
...
static int
bcm56990_a0_dlb_ecmp_nhi_member_clr(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    int i;
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t *buf_ptr = NULL;
...
static int
bcm56990_a0_dlb_ecmp_port_member_clr(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    int i;
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t *buf_ptr = NULL;
...
static int
bcm56990_a0_dlb_ecmp_alternate_nhi_member_clr(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    int i;
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t *buf_ptr = NULL;
...
static int
bcm56990_a0_dlb_ecmp_alternate_port_member_clr(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    int i;
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t *buf_ptr = NULL;
...
static int
bcm56990_a0_dlb_ecmp_grp_ctrl_clr(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t *buf_ptr = NULL;
...
static int
bcm56990_a0_dlb_ecmp_port_bitmap_clr(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t *buf_ptr = NULL;
    DLB_ECMP_GROUP_MEMBERSHIPm_t group_membership_entry;
...
static int
bcm56990_a0_dlb_ecmp_flow_set_cleanup(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    int flow_set_base;
    int num_blocks;
...
static int
bcm56990_a0_dlb_ecmp_link_ctrl_set(int unit, bcmcth_dlb_ecmp_pctl_t *lt_entry)
{
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t *buf_ptr = NULL;
...
static int
bcm56990_a0_dlb_ecmp_link_ctrl_clr(int unit, bcmcth_dlb_ecmp_pctl_t *lt_entry)
{
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t *buf_ptr = NULL;
    DLB_ECMP_LINK_CONTROLm_t   link_ctrl_entry;
...
static int
bcm56990_a0_dlb_enable(int unit)
{
    uint32_t entry_sz = 0;
    uint32_t rsp_flags;
    ...
    req_ltid = DLB_CONTROLt;
    sid = ING_DII_AUX_ARB_CONTROLr;
    fid = DLB_HGT_256NS_REFRESH_ENABLEf;

    entry_sz = bcmdrd_pt_entry_wsize(unit, sid);
    entry_sz *= 4;
    SHR_ALLOC(read_buf, entry_sz, "bcmcthDLBEnable");
    ...
    enable = 1;
    bcmdrd_pt_field_set(unit, sid, (uint32_t *)read_buf, fid, &enable);
 ...
 */
static int
bcm56990_a0_cth_dlb_ecmp_grp_info_recover(
...
static int
bcm56990_a0_cth_dlb_ecmp_init(int unit,
                              bool warm,
                              bcmcth_dlb_ecmp_entry_info_t *entry_info)
{
    ...
    if (!warm) {
        SHR_IF_ERR_EXIT
            (bcm56990_a0_dlb_enable(unit));
    } else {
        SHR_IF_ERR_EXIT
            (bcm56990_a0_cth_dlb_ecmp_grp_info_recover(unit, entry_info));
    }
...
static int
bcm56990_a0_cth_dlb_ecmp_cleanup(int unit)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56990_a0_cth_dlb_grp_cnt_get(int unit, int *grp_cnt)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56990_a0_cth_dlb_ecmp_set(int unit,
                             ...
                             bool flow_set_init)
{
    ...
    SHR_IF_ERR_EXIT
        (bcm56990_a0_dlb_ecmp_flow_set_init(unit, lt_entry, flow_set_init));

    SHR_IF_ERR_EXIT
        (bcm56990_a0_dlb_ecmp_nhi_member_set(unit, lt_entry));

    SHR_IF_ERR_EXIT
        (bcm56990_a0_dlb_ecmp_port_member_set(unit, lt_entry));

    SHR_IF_ERR_EXIT
        (bcm56990_a0_dlb_ecmp_alternate_nhi_member_set(unit, lt_entry));

    SHR_IF_ERR_EXIT
        (bcm56990_a0_dlb_ecmp_alternate_port_member_set(unit, lt_entry));

    SHR_IF_ERR_EXIT
        (bcm56990_a0_dlb_ecmp_port_bitmap_set(unit, lt_entry));

    SHR_IF_ERR_EXIT
        (bcm56990_a0_dlb_ecmp_grp_ctrl_set(unit, lt_entry));

    SHR_IF_ERR_EXIT
        (bcm56990_a0_dlb_ecmp_enable(unit, lt_entry, true));
...
static int
bcm56990_a0_cth_dlb_ecmp_del(int unit,
                             bcmcth_dlb_ecmp_t *lt_entry)
{
    SHR_FUNC_ENTER(unit);
    ...
    SHR_IF_ERR_EXIT
        (bcm56990_a0_dlb_ecmp_enable(unit, lt_entry, false));

    SHR_IF_ERR_EXIT
        (bcm56990_a0_dlb_ecmp_nhi_member_clr(unit, lt_entry));

    SHR_IF_ERR_EXIT
        (bcm56990_a0_dlb_ecmp_port_member_clr(unit, lt_entry));

    SHR_IF_ERR_EXIT
        (bcm56990_a0_dlb_ecmp_alternate_nhi_member_clr(unit, lt_entry));

    SHR_IF_ERR_EXIT
        (bcm56990_a0_dlb_ecmp_alternate_port_member_clr(unit, lt_entry));

    SHR_IF_ERR_EXIT
        (bcm56990_a0_dlb_ecmp_port_bitmap_clr(unit, lt_entry));

    SHR_IF_ERR_EXIT
        (bcm56990_a0_dlb_ecmp_grp_ctrl_clr(unit, lt_entry));

    SHR_IF_ERR_EXIT
        (bcm56990_a0_dlb_ecmp_flow_set_cleanup(unit, lt_entry));
...
static int
bcm56990_a0_cth_dlb_ecmp_pctl_set(int unit,
                                  bcmcth_dlb_ecmp_pctl_t *lt_entry)
{
    ...
    SHR_IF_ERR_EXIT
        (bcm56990_a0_dlb_ecmp_link_ctrl_set(unit, lt_entry));
...
static int
bcm56990_a0_cth_dlb_ecmp_pctl_del(int unit,
                                  bcmcth_dlb_ecmp_pctl_t *lt_entry)
{
    SHR_FUNC_ENTER(unit);
    ...
    SHR_IF_ERR_EXIT
        (bcm56990_a0_dlb_ecmp_link_ctrl_clr(unit, lt_entry));
...
static int
bcm56990_a0_cth_dlb_ecmp_stats_set(int unit,
...
static int
bcm56990_a0_cth_dlb_ecmp_stats_get(int unit,
                                   bcmcth_dlb_ecmp_stats_t *lt_entry)
{
    DLB_ECMP_GROUP_STATS_INST0m_t dlb_ecmp_group_stats_buf;
    bcmdrd_sid_t dlb_ecmp_group_stats_sid[2] = {DLB_ECMP_GROUP_STATS_INST0m,
...
static bcmcth_dlb_drv_t bcm56990_a0_cth_dlb_drv = {
    .ecmp_init = bcm56990_a0_cth_dlb_ecmp_init,
    .ecmp_cleanup = bcm56990_a0_cth_dlb_ecmp_cleanup,
    .grp_cnt_get = bcm56990_a0_cth_dlb_grp_cnt_get,
    .ecmp_set = bcm56990_a0_cth_dlb_ecmp_set,
    .ecmp_del = bcm56990_a0_cth_dlb_ecmp_del,
    .ecmp_pctl_set = bcm56990_a0_cth_dlb_ecmp_pctl_set,
    .ecmp_pctl_del = bcm56990_a0_cth_dlb_ecmp_pctl_del,
    .ecmp_recover = bcm56990_a0_cth_dlb_ecmp_grp_info_recover,
    .ecmp_stats_set = bcm56990_a0_cth_dlb_ecmp_stats_set,
    .ecmp_stats_get = bcm56990_a0_cth_dlb_ecmp_stats_get,
};
...
bcmcth_dlb_drv_t *
bcm56990_a0_cth_dlb_drv_get(int unit)
{
    return &bcm56990_a0_cth_dlb_drv;
}
