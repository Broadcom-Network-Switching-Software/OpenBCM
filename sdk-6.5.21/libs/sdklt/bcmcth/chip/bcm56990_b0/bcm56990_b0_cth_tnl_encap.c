/*! \file bcm56990_b0_cth_tnl_encap.c
 *
 * This file defines the detach, attach routines of
 * TNL encap driver for bcm56990_b0.
 */
/*
...
#define BCM56990_B0_MAX_LABELS          (8)
#define BCM56990_B0_NUM_IPV4_TNL        (8192)
#define BCM56990_B0_NUM_IPV6_TNL        (4096)
#define BCM56990_B0_NUM_MPLS_TNL        (32768)
#define BCM56990_B0_IPV4_TNL_START_IDX  (1)
#define BCM56990_B0_IPV6_TNL_START_IDX  (2)
#define BCM56990_B0_MPLS_TNL_START_IDX  (2)
#define BCM56990_B0_TNL_NUM_KEY_FLDS    (1)
#define BCM56990_B0_TNL_NUM_DATA_FLDS   (100)
#define BCM56990_B0_IPV4_TNL_WIDTH      (1)
#define BCM56990_B0_IPV6_TNL_WIDTH      (2)
#define BCM56990_B0_MPLS_TNL_WIDTH      (2)

#define BCM56990_B0_EXP_MODE_FIXED      (0)
#define BCM56990_B0_EXP_MODE_MAP        (1)
#define BCM56990_B0_EXP_MODE_INNER      (2)

#define BCM56990_B0_DSCP_ACTION_FIXED   (0)
#define BCM56990_B0_DSCP_ACTION_PACKET  (1)
#define BCM56990_B0_DSCP_ACTION_MAP     (2)

uint32_t bcm56990_b0_tnl_mpls_entry_fid_arr[] = {
    MPLS_ENTRY_0f,
    MPLS_ENTRY_1f,
    MPLS_ENTRY_2f,
    MPLS_ENTRY_3f,
...
uint32_t bcm56990_b0_tnl_mpls_label_fid_arr[] = {
    MPLS_LABEL_0f,
    MPLS_LABEL_1f,
    MPLS_LABEL_2f,
    MPLS_LABEL_3f,
...
uint32_t bcm56990_b0_tnl_mpls_ttl_fid_arr[] = {
    MPLS_TTL_0f,
    MPLS_TTL_1f,
    MPLS_TTL_2f,
    MPLS_TTL_3f,
...
uint32_t bcm56990_b0_tnl_mpls_exp_sel_fid_arr[] = {
    MPLS_EXP_SELECT_0f,
    MPLS_EXP_SELECT_1f,
    MPLS_EXP_SELECT_2f,
    MPLS_EXP_SELECT_3f,
...
uint32_t bcm56990_b0_tnl_mpls_exp_ptr_fid_arr[] = {
...
uint32_t bcm56990_b0_tnl_mpls_exp_fid_arr[] = {
    MPLS_EXP_0f,
    MPLS_EXP_1f,
    MPLS_EXP_2f,
    MPLS_EXP_3f,
...
uint32_t bcm56990_b0_tnl_mpls_pri_fid_arr[] = {
    NEW_PRI_0f,
    NEW_PRI_1f,
    NEW_PRI_2f,
    NEW_PRI_3f,
...
uint32_t bcm56990_b0_tnl_mpls_cfi_fid_arr[] = {
    NEW_CFI_0f,
    NEW_CFI_1f,
    NEW_CFI_2f,
    NEW_CFI_3f,
...
uint32_t bcm56990_b0_tnl_encap_mpls_push_fid_arr[] = {
    MPLS_PUSH_ACTION_0f,
    MPLS_PUSH_ACTION_1f,
    MPLS_PUSH_ACTION_2f,
    MPLS_PUSH_ACTION_3f,
...
uint32_t bcm56990_b0_tnl_encap_mpls_int_cn_ptr_fid_arr[] = {
...
uint32_t bcm56990_b0_tnl_encap_mpls_int_cn_pri_fid_arr[] = {
...
uint32_t bcm56990_b0_tnl_encap_mpls_ip_ecn_ptr_fid_arr[] = {
...
uint32_t bcm56990_b0_tnl_encap_mpls_ip_ecn_pri_fid_arr[] = {
 ...
 */
static int
bcm56990_b0_tnl_ipv4_lt_fid_to_hw_fid(int unit,
                                      uint32_t lt_fid,
                                      ...
                                      uint32_t *hw_fid)
{
    ...
    case TNL_IPV4_ENCAPt_PHB_EGR_IP_INT_PRI_TO_DSCP_IDf:
        if (dscp_action != BCM56990_B0_DSCP_ACTION_MAP) {
            SHR_ERR_EXIT(SHR_E_PARAM);
        }
        *hw_fid = DSCP_MAPPING_PTRf;
        break;
    case TNL_IPV4_ENCAPt_DSCPf:
        if (dscp_action != BCM56990_B0_DSCP_ACTION_FIXED) {
            SHR_ERR_EXIT(SHR_E_PARAM);
        }
        *hw_fid = DSCPf;
        break;
 ...
 */
static int
bcm56990_b0_tnl_ipv6_lt_fid_to_hw_fid(int unit,
                                      uint32_t lt_fid,
                                      uint32_t dscp_action,
                                      bool *partial,
                                      uint32_t *hw_fid,
 ...
 */
static int
bcm56990_b0_tnl_mpls_lt_fid_to_hw_fid(int unit,
                                      uint32_t lt_fid,
                                      uint32_t sub_id,
                                      uint32_t lbl_idx,
                                      ...
                                      uint64_t *data)
{
    ...
    case TNL_MPLS_ENCAPt_LABELf:
        *hw_fid = bcm56990_b0_tnl_mpls_label_fid_arr[arr_idx];
        *data = entry->label[lbl_idx];
        break;
    case TNL_MPLS_ENCAPt_LABEL_TTLf:
        *hw_fid = bcm56990_b0_tnl_mpls_ttl_fid_arr[arr_idx];
        *data = entry->ttl[lbl_idx];
        break;
    case TNL_MPLS_ENCAPt_MPLS_TNL_EXP_MODEf:
        *hw_fid = bcm56990_b0_tnl_mpls_exp_sel_fid_arr[arr_idx];
        *data = entry->exp_mode[lbl_idx];
        break;
    case TNL_MPLS_ENCAPt_PHB_EGR_MPLS_IDf:
        if (entry->exp_mode[lbl_idx] == BCM56990_B0_EXP_MODE_FIXED) {
            SHR_ERR_EXIT(SHR_E_PARAM);
        }
        *hw_fid = bcm56990_b0_tnl_mpls_exp_ptr_fid_arr[arr_idx];
        *data = entry->phb_id[lbl_idx];
        break;
    case TNL_MPLS_ENCAPt_LABEL_EXPf:
        *hw_fid = bcm56990_b0_tnl_mpls_exp_fid_arr[arr_idx];
    ...
    case TNL_MPLS_ENCAPt_PRIf:
        ...
        *hw_fid = bcm56990_b0_tnl_mpls_pri_fid_arr[arr_idx];
 ...
 */
static int
bcm56990_b0_tnl_ipv4_encap_hw_entry_prepare(int unit,
                                            uint32_t hw_sid,
                                            ...
                                            uint8_t *entry_buf)
{
    ...
    uint64_t dscp_action = BCM56990_B0_DSCP_ACTION_FIXED;
    ...
    while (field) {
        ...
        rv = bcm56990_b0_tnl_ipv4_lt_fid_to_hw_fid(unit, fid, dscp_action, &hw_fid);
        if (rv != SHR_E_NONE) {
            /* Skip SW only fields. */
            field = field->next;
            continue;
 ...
 */
static int
bcm56990_b0_tnl_ipv6_encap_hw_entry_prepare(int unit,
                                            uint32_t hw_sid,
                                            const bcmltd_field_t *in_data,
                                            uint8_t *entry_buf)
{
    ...
    while (field) {
        ...
        /* Convert LT field into corresponding HW field. */
        rv = bcm56990_b0_tnl_ipv6_lt_fid_to_hw_fid(unit,
                                                   fid,
                                                   dscp_action,
                                                   &partial,
                                                   &hw_fid,
 ...
 */
static int
bcm56990_b0_tnl_mpls_encap_hw_entry_prepare(int unit,
                                            uint32_t hw_sid,
                                            uint32_t sub_id,
                                            tnl_mpls_encap_entry_t *entry,
                                            uint8_t *entry_buf)
{
    ...
    for (i = 0; i < count; i++) {
        ...
        for (lbl_idx = 0; lbl_idx < entry->max_labels; lbl_idx++) {
            /* Convert LT field into corresponding HW field. */
            rv = bcm56990_b0_tnl_mpls_lt_fid_to_hw_fid(unit,
                                                       fid,
                                                       sub_id,
                                                       lbl_idx,
                                                       entry,
    ...
    do {
        arr_idx = (sub_id + lbl_idx);
        hw_fid = bcm56990_b0_tnl_encap_mpls_push_fid_arr[arr_idx];
 ...
 */
static int
bcm56990_b0_tnl_mpls_encap_hw_entry_clear(int unit,
                                          uint32_t hw_sid,
                                          uint32_t sub_id,
                                          int max_labels,
                                          bool entry_remove,
                                          uint8_t *entry_buf)
{
    ...
    for (lbl_idx = 0; lbl_idx < max_labels; lbl_idx++) {
        arr_idx = (sub_id + lbl_idx);
        hw_fid = bcm56990_b0_tnl_mpls_entry_fid_arr[arr_idx];
        bcmdrd_pt_field_set(unit,
                            hw_sid,
                            (uint32_t *)entry_buf,
                            hw_fid,
 ...
 */
static int
bcm56990_b0_tnl_ipv4_encap_hw_entry_parse(int unit,
                                          uint32_t hw_sid,
                                          uint8_t *entry_buf,
 ...
 */
static int
bcm56990_b0_tnl_ipv6_encap_hw_entry_parse(int unit,
                                          uint32_t hw_sid,
                                          uint8_t *entry_buf,
                                          bcmltd_fields_t *data)
{
 ...
 */
static int
bcm56990_b0_tnl_mpls_encap_hw_entry_parse(int unit,
                                          uint32_t hw_sid,
                                          uint32_t sub_id,
                                          tnl_mpls_encap_entry_t *entry,
                                          uint8_t *entry_buf,
                                          bcmltd_fields_t *data)
{
    ...
    if (lbl_idx > BCM56990_B0_MAX_LABELS) {
...
/* Driver structure. */
bcmcth_tnl_encap_drv_t bcm56990_b0_tnl_encap_drv = {
    .num_ipv4_tnl = BCM56990_B0_NUM_IPV4_TNL,
    .num_ipv6_tnl = BCM56990_B0_NUM_IPV6_TNL,
    .num_mpls_tnl = BCM56990_B0_NUM_MPLS_TNL,
    .max_labels = BCM56990_B0_MAX_LABELS,
    .ipv4_tnl_width = BCM56990_B0_IPV4_TNL_WIDTH,
    .ipv6_tnl_width = BCM56990_B0_IPV6_TNL_WIDTH,
    .mpls_tnl_width = BCM56990_B0_MPLS_TNL_WIDTH,
    .ipv4_start_idx = BCM56990_B0_IPV4_TNL_START_IDX,
    .ipv6_start_idx = BCM56990_B0_IPV6_TNL_START_IDX,
    .mpls_start_idx = BCM56990_B0_MPLS_TNL_START_IDX,
    .num_key_flds = BCM56990_B0_TNL_NUM_KEY_FLDS,
    .num_data_flds = BCM56990_B0_TNL_NUM_DATA_FLDS,
    .ipv4_hw_sid = EGR_IP_TUNNELm,
    .ipv6_hw_sid = EGR_IP_TUNNEL_IPV6m,
    .mpls_hw_sid = EGR_IP_TUNNEL_MPLSm,
    .ipv4_lt_to_hw_map = bcm56990_b0_tnl_ipv4_encap_hw_entry_prepare,
    .ipv6_lt_to_hw_map = bcm56990_b0_tnl_ipv6_encap_hw_entry_prepare,
    .mpls_lt_to_hw_map = bcm56990_b0_tnl_mpls_encap_hw_entry_prepare,
    .mpls_hw_entry_clear = bcm56990_b0_tnl_mpls_encap_hw_entry_clear,
    .ipv4_hw_to_lt_map = bcm56990_b0_tnl_ipv4_encap_hw_entry_parse,
    .ipv6_hw_to_lt_map = bcm56990_b0_tnl_ipv6_encap_hw_entry_parse,
    .mpls_hw_to_lt_map = bcm56990_b0_tnl_mpls_encap_hw_entry_parse,
};

bcmcth_tnl_encap_drv_t *
bcm56990_b0_cth_tnl_encap_drv_get(int unit)
{
    return &bcm56990_b0_tnl_encap_drv;
}
