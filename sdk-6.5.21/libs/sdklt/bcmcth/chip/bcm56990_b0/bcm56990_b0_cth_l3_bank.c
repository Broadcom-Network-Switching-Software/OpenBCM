...
static bcmltd_sid_t bcm56990_b0_cth_l3_nhop_lt_sid[] = {
    L3_UC_HIERARCHICAL_NHOPt,
    L3_MC_HIERARCHICAL_NHOPt,
    TNL_MPLS_ENCAP_HIERARCHICAL_NHOPt,
    TNL_MPLS_TRANSIT_HIERARCHICAL_NHOPt,
    FP_ING_ACTION_HIERARCHICAL_NHOPt,
    L2_TAG_ACTION_HIERARCHICAL_NHOPt
};
