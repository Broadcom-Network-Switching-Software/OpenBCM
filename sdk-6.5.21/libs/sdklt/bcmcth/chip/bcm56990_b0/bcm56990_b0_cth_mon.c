...
static int
bcm56990_b0_mon_telemetry_attrs_info_get(
    int unit,
...
static int
bcm56990_b0_mon_telemetry_field_info_index_map(int unit, uint32_t fld_enum,
                                               uint32_t *fld_index)
{
...
static int
bcm56990_b0_mon_telemetry_field_info_get(
    int unit,
    bcmcth_mon_inband_telemetry_metadata_field_t *field_info)
{
    ...
    SHR_FUNC_ENTER(unit);
    SHR_IF_ERR_EXIT
        (bcm56990_b0_mon_telemetry_field_info_index_map(unit,
                                                        field_info->fld_enum,
                                                        &index));
...
static bcmcth_mon_drv_t bcm56990_b0_cth_mon_drv = {
   ...
   .telemetry_attrs_info = &bcm56990_b0_mon_telemetry_attrs_info_get,
   .telemetry_field_info = &bcm56990_b0_mon_telemetry_field_info_get,
};
