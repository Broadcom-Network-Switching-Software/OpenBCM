/*! \file bcm56990_b0_cth_ctr_eflex.c
 *
...
/*! Slim couters are organised coloumn wise. */
...
{
    {0, "VFP policy table slice 0"},
    {4, "IFP policy table slice 0"},
    {5, "IFP policy table slice 1"},
    {6, "IFP policy table slice 2"},
    {7, "IFP policy table slice 3"},
    {8, "IFP policy table slice 4"},
    {9, "IFP policy table slice 5"},
    {10, "IFP policy table slice 6"},
    {11, "IFP policy table slice 7"},
    {12, "IFP policy table slice 8"},
    {13, "Exact match policy table"},
    {14, "MPLS entry 1 object"},
    {15, "MPLS entry 2 object"},
    {17, "L3 tunnel"},
    {16, "Prefix length for flow count"},
    {63, "Port context for flow count"},
    {27, "Flow size lower byte for flow count"},
    {28, "Flow size upper byte for flow count"},
    {18, "ALPM source lookup"},
    {19, "ALPM destination lookup"},
    {20, "Lookup hit status"},
    {21, "Ingress port"},
    {22, "Egress port"},
    {23, "VFI"},
    {24, "L3 IIF"},
    {25, "VRF"},
    {26, "Class ID from port table"},
    {29, "ECMP group"},
    {30, "ECMP member"},
    {31, "Next hop or MC index"},
    {32, "RTAG7 hash 0 and instance 0"},
    {33, "RTAG7 hash 0 and instance 1"},
    {34, "RTAG7 hash 1 and instance 0"},
    {35, "RTAG7 hash 1 and instance 1"},
    {36, "Ingress timestamp 0-15 bits"},
    {37, "Ingress timestamp 16-31 bits"},
    {38, "Ingress timestamp 32-47 bits"},
    {39, "Packet length in IP header"},
    {40, "L4 flags"},
    {41, "UDF1 chunk 0"},
    {42, "UDF1 chunk 1"},
    {43, "UDF1 chunk 2"},
    ...
    {54, "UDF2 chunk 5"},
    {55, "UDF2 chunk 6"},
    {57, "Packet attribute offset 0"},
    {58, "Packet attribute offset 1"},
    {59, "Packet attribute offset 2"},
    {60, "Internal priority"},
    {60, "Internal congestion notification"},
    {60, "Event group vector"},
    {61, "Trunk group"},
    {61, "Trunk member"},
    {62, "Protocol field from IP header"},
    {48, "DVP"},
    {56, "SVP"},
    {1, "Overlay ECMP group"},
    {2, "Overlay ECMP member"},
    {3, "Overlay next hop"},
};

static obj_container_t egr_obj_fmt_tbl[] =
{
    {0, "Egress adapt table"},
    {1, "EFP policy table slice 0"},
    {2, "EFP policy table slice 1"},
    {3, "EFP policy table slice 2"},
    {4, "EFP policy table slice 3"},
    {5, "Ingress port"},
    {6, "Egress port"},
    {8, "VRF"},
    {9, "Underlay L3 outgoing interface"},
    {10, "L3 tunnel index"},
    {11, "Underlay next hop"},
    {12, "Metadata from egress NHOP table"},
    {13, "I2E class ID"},
    {13, "I2E class ID type"},
    {14, "Queue number"},
    {19, "Residency timestamp lower"},
    {20, "Residency timestamp upper"},
    {21, "Egress timestamp 0-15 bits"},
    {22, "Egress timestamp 16-31 bits"},
    {23, "Egress timestamp 32-47 bits"},
    {24, "Ingress timestamp 0-15 bits"},
    {25, "Ingress timestamp 16-31 bits"},
    {26, "Ingress timestamp 32-47 bits"},
    {27, "Entropy label 0-15 bits"},
    {28, "Entropy label 16-25 bits"},
    {29, "Egress mirror on drop event"},
    {29, "Internal congestion notification"},
    {29, "Internal priority"},
    {29, "Congestion color"},
    {30, "Packet attribute offset instance 0"},
    {31, "Packet attribute offset instance 1"},
    {32, "Packet attribute offset instance 2"},
    {33, "Combine egress port and queue number"},
    {41, "DVP"},
    {40, "SVP"},
    {42, "VFI"},
    {43, "Network group for SVP"},
    {43, "Network group for DVP"},
    {37, "Overlay next hop"},
    {38, "Overlay L3 outgoing interface"},
};
...
static bcmcth_ctr_eflex_device_info_t bcm56990_b0_device_info = {
...
static int
bcm56990_b0_cth_ctr_eflex_ctr_table_get(int unit,
                                        bool ingress,
...
static int
bcm56990_b0_cth_ctr_eflex_device_info_get(
    int unit,
    bcmcth_ctr_eflex_device_info_t **device_info)
{
    SHR_FUNC_ENTER(unit);

    *device_info = &bcm56990_b0_device_info;
...
static int
bcm56990_b0_cth_ctr_eflex_action_reg_set(int unit,
                                         bool enable,
...
static int
bcm56990_b0_cth_ctr_eflex_action_table_0_write(
    int unit,
    ctr_eflex_action_profile_data_t *entry)
{
    bcmbd_pt_dyn_info_t pt_dyn_info = {0};
    ...
    /* Request ltid */
    req_ltid = entry->ingress ? CTR_ING_EFLEX_ACTION_PROFILEt :
                                CTR_EGR_EFLEX_ACTION_PROFILEt;

    /* Entry buffer init */
    entry_wsz = bcmdrd_pt_entry_wsize(unit, sid);
    SHR_ALLOC(entry_buf, entry_wsz * 4, "bcmcthEflexCtrData");
    SHR_NULL_CHECK(entry_buf, SHR_E_MEMORY);
    sal_memset(entry_buf, 0, entry_wsz * 4);
...
static int
bcm56990_b0_cth_ctr_eflex_action_table_1_write(
    int unit,
    ctr_eflex_action_profile_data_t *entry)
{
    bcmbd_pt_dyn_info_t pt_dyn_info = {0};
...
static int
bcm56990_b0_cth_ctr_eflex_action_table_write(
    int unit,
    ctr_eflex_action_profile_data_t *entry)
{
    SHR_FUNC_ENTER(unit);
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56990_b0_cth_ctr_eflex_action_table_0_write(unit, entry));

    /* Write ACTION_TABLE_1 entry */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56990_b0_cth_ctr_eflex_action_table_1_write(unit, entry));
...
static int
bcm56990_b0_cth_ctr_eflex_op_profile_write(
    int unit,
...
static int
bcm56990_b0_cth_ctr_eflex_range_chk_write(
    int unit,
...
/*! Reset counter trigger active entry */
static int
bcm56990_b0_cth_ctr_eflex_trigger_active_reset(
    int unit,
    ctr_eflex_trigger_data_t *entry)
{
    bcmbd_pt_dyn_info_t pt_dyn_info = {0};
    bcmdrd_sid_t sid_inst[NUM_PIPE_INST] = {0};
    bcmdrd_sid_t sid = 0, req_ltid = 0, rsp_ltid = 0;
    uint32_t entry_buf[2] = {0};
    uint32_t active = 0;
    uint32_t inst_idx = 0;
    uint32_t rsp_flags = 0, pipe_idx;
    ...
    sid_inst[0] = entry->ingress ? FLEX_CTR_ING_COUNTER_TRIGGER_ACTIVE_INST0r :
                                   FLEX_CTR_EGR_COUNTER_TRIGGER_ACTIVE_INST0r;
    sid_inst[1] = entry->ingress ? FLEX_CTR_ING_COUNTER_TRIGGER_ACTIVE_INST1r :
                                   FLEX_CTR_EGR_COUNTER_TRIGGER_ACTIVE_INST1r;

    for (inst_idx = 0; inst_idx < NUM_PIPE_INST; inst_idx++) {
        sid = sid_inst[inst_idx];
        ...
        for (pipe_idx = entry->start_pipe_idx;
            ...
            SHR_IF_ERR_EXIT
                (bcmdrd_pt_field_get(unit, sid, entry_buf, ACTIVEf, &active));
            active &= ~(1 << entry->action_id);
            SHR_IF_ERR_EXIT
                (bcmdrd_pt_field_set(unit, sid, entry_buf, ACTIVEf, &active));
...
static int
bcm56990_b0_cth_ctr_eflex_trigger_write(
    int unit,
    ctr_eflex_trigger_data_t *entry)
{
    bcmbd_pt_dyn_info_t pt_dyn_info = {0};
    ...
    if (!entry->trigger) {
        SHR_IF_ERR_EXIT
            (bcm56990_b0_cth_ctr_eflex_trigger_active_reset(unit, entry));
    }
...
static int
bcm56990_b0_cth_ctr_eflex_trigger_read(
    int unit,
    ctr_eflex_trigger_data_t *entry)
{
    bcmbd_pt_dyn_info_t pt_dyn_info = {0};
...
/*! Get object id */
static int
bcm56990_b0_cth_ctr_eflex_object_id_get(int unit, int sel, uint64_t data)
{
...
/*! Get object index */
static int
bcm56990_b0_cth_ctr_eflex_object_idx_get(int unit, int sel, int data)
{
    int obj_sz;
    int val, rt;
...
static int
bcm56990_b0_cth_ctr_eflex_action_zone_get(int unit, int sel, uint32_t action)
{
...
static int
bcm56990_b0_cth_state_eflex_group_action_write(
    int unit,
    ctr_eflex_group_action_data_t *entry)
{
    ...
    num_insts = bcm56990_b0_device_info.num_pipe_instance;
...
static int
bcm56990_b0_cth_ctr_eflex_error_stats_write(
    int unit,
    ...
    for (pipe_idx = entry->start_pipe_idx;
        ...
        if (entry->upd_action_misconfig) {
            ...
            for (inst_idx = 0; inst_idx < num_insts; inst_idx++) {
                ...
                SHR_IF_ERR_EXIT
                    (bcmdrd_pt_field_set(unit, sid_inst[inst_idx],
                                         pt_entry_buff, COUNTf, data_ptr[inst_idx]));
                /* Write PT entry */
                SHR_IF_ERR_EXIT
                    (bcmptm_ireq_write(unit,
                                       0,
...
static int
bcm56990_b0_cth_ctr_eflex_error_stats_read(
    int unit,
    ctr_eflex_error_stats_data_t *entry)
{
    bcmbd_pt_dyn_info_t pt_dyn_info = {0};
...
static int
bcm56990_b0_cth_ctr_eflex_pipe_valid_check(int unit,
                                           bool ingress,
                                           uint32_t pipe,
                                           bool *valid)
{
 ...
 */
static int
bcm56990_b0_cth_ctr_eflex_update_control_get(
        int unit,
        bool ingress,
...
static int
bcm56990_b0_cth_ctr_eflex_obj_quant_write(int unit,
 ...
 */
static int
bcm56990_b0_cth_ctr_eflex_obj_quant_imm_reg(int unit, bool *imm_reg)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56990_b0_cth_ctr_eflex_obj_info_get(
    int unit,
    bool ingress,
    uint32_t *num_obj,
    uint32_t *obj)
...
static bcmcth_ctr_eflex_drv_t bcm56990_b0_cth_ctr_eflex_drv = {
    .device_info_get_fn = bcm56990_b0_cth_ctr_eflex_device_info_get,
    .ctr_table_get_fn   = bcm56990_b0_cth_ctr_eflex_ctr_table_get,
    .action_reg_set_fn  = bcm56990_b0_cth_ctr_eflex_action_reg_set,
    .action_table_write_fn = bcm56990_b0_cth_ctr_eflex_action_table_write,
    .op_profile_write_fn = bcm56990_b0_cth_ctr_eflex_op_profile_write,
    .range_chk_write_fn = bcm56990_b0_cth_ctr_eflex_range_chk_write,
    .trigger_write_fn = bcm56990_b0_cth_ctr_eflex_trigger_write,
    .trigger_read_fn = bcm56990_b0_cth_ctr_eflex_trigger_read,
    .object_id_get_fn = bcm56990_b0_cth_ctr_eflex_object_id_get,
    .object_idx_get_fn = bcm56990_b0_cth_ctr_eflex_object_idx_get,
    .action_zone_get_fn = bcm56990_b0_cth_ctr_eflex_action_zone_get,
    .group_action_write_fn = bcm56990_b0_cth_state_eflex_group_action_write,
    .error_stats_write_fn = bcm56990_b0_cth_ctr_eflex_error_stats_write,
    .error_stats_read_fn = bcm56990_b0_cth_ctr_eflex_error_stats_read,
    .pipe_valid_check_fn = bcm56990_b0_cth_ctr_eflex_pipe_valid_check,
    .update_control_get_fn = bcm56990_b0_cth_ctr_eflex_update_control_get,
    .obj_quant_write_fn = bcm56990_b0_cth_ctr_eflex_obj_quant_write,
    .obj_quant_imm_reg_fn = bcm56990_b0_cth_ctr_eflex_obj_quant_imm_reg,
    .obj_info_get_fn = bcm56990_b0_cth_ctr_eflex_obj_info_get
};
...
bcm56990_b0_cth_ctr_eflex_drv_get(int unit)
{
    return &bcm56990_b0_cth_ctr_eflex_drv;
}

bcmcth_state_eflex_drv_t *
bcm56990_b0_cth_state_eflex_drv_get(int unit)
{
    return NULL;
}
