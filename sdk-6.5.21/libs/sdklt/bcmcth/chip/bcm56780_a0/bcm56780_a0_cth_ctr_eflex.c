...
static const bcmdrd_sid_t ctr_trigger_state_mem[][64] = {

  {
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_0r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_1r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_2r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_3r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_4r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_5r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_6r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_7r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_8r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_9r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_10r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_11r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_12r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_13r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_14r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_15r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_16r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_17r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_18r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_19r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_20r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_21r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_22r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_23r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_24r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_25r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_26r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_27r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_28r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_29r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_30r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_31r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_32r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_33r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_34r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_35r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_36r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_37r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_38r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_39r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_40r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_41r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_42r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_43r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_44r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_45r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_46r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_47r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_48r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_49r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_50r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_51r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_52r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_53r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_54r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_55r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_56r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_57r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_58r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_59r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_60r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_61r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_62r,
        FLEX_CTR_EGR_COUNTER_TRIGGER_STATE_63r,
  },
  {
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_0r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_1r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_2r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_3r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_4r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_5r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_6r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_7r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_8r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_9r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_10r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_11r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_12r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_13r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_14r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_15r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_16r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_17r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_18r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_19r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_20r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_21r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_22r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_23r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_24r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_25r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_26r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_27r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_28r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_29r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_30r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_31r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_32r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_33r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_34r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_35r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_36r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_37r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_38r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_39r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_40r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_41r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_42r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_43r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_44r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_45r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_46r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_47r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_48r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_49r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_50r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_51r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_52r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_53r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_54r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_55r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_56r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_57r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_58r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_59r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_60r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_61r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_62r,
        FLEX_CTR_ING_COUNTER_TRIGGER_STATE_63r,

  },
};

static const bcmdrd_sid_t state_trigger_state_mem[][2][16] = {
     {
         {
            FLEX_CTR_ST_EGR0_COUNTER_TRIGGER_STATE_0r,
            FLEX_CTR_ST_EGR0_COUNTER_TRIGGER_STATE_1r,
            FLEX_CTR_ST_EGR0_COUNTER_TRIGGER_STATE_2r,
            FLEX_CTR_ST_EGR0_COUNTER_TRIGGER_STATE_3r,
            FLEX_CTR_ST_EGR0_COUNTER_TRIGGER_STATE_4r,
            FLEX_CTR_ST_EGR0_COUNTER_TRIGGER_STATE_5r,
            FLEX_CTR_ST_EGR0_COUNTER_TRIGGER_STATE_6r,
            FLEX_CTR_ST_EGR0_COUNTER_TRIGGER_STATE_7r,
            FLEX_CTR_ST_EGR0_COUNTER_TRIGGER_STATE_8r,
            FLEX_CTR_ST_EGR0_COUNTER_TRIGGER_STATE_9r,
            FLEX_CTR_ST_EGR0_COUNTER_TRIGGER_STATE_10r,
            FLEX_CTR_ST_EGR0_COUNTER_TRIGGER_STATE_11r,
            FLEX_CTR_ST_EGR0_COUNTER_TRIGGER_STATE_12r,
            FLEX_CTR_ST_EGR0_COUNTER_TRIGGER_STATE_13r,
            FLEX_CTR_ST_EGR0_COUNTER_TRIGGER_STATE_14r,
            FLEX_CTR_ST_EGR0_COUNTER_TRIGGER_STATE_15r,
         },
         {
            FLEX_CTR_ST_EGR1_COUNTER_TRIGGER_STATE_0r,
            FLEX_CTR_ST_EGR1_COUNTER_TRIGGER_STATE_1r,
            FLEX_CTR_ST_EGR1_COUNTER_TRIGGER_STATE_2r,
            FLEX_CTR_ST_EGR1_COUNTER_TRIGGER_STATE_3r,
            FLEX_CTR_ST_EGR1_COUNTER_TRIGGER_STATE_4r,
            FLEX_CTR_ST_EGR1_COUNTER_TRIGGER_STATE_5r,
            FLEX_CTR_ST_EGR1_COUNTER_TRIGGER_STATE_6r,
            FLEX_CTR_ST_EGR1_COUNTER_TRIGGER_STATE_7r,
            FLEX_CTR_ST_EGR1_COUNTER_TRIGGER_STATE_8r,
            FLEX_CTR_ST_EGR1_COUNTER_TRIGGER_STATE_9r,
            FLEX_CTR_ST_EGR1_COUNTER_TRIGGER_STATE_10r,
            FLEX_CTR_ST_EGR1_COUNTER_TRIGGER_STATE_11r,
            FLEX_CTR_ST_EGR1_COUNTER_TRIGGER_STATE_12r,
            FLEX_CTR_ST_EGR1_COUNTER_TRIGGER_STATE_13r,
            FLEX_CTR_ST_EGR1_COUNTER_TRIGGER_STATE_14r,
            FLEX_CTR_ST_EGR1_COUNTER_TRIGGER_STATE_15r,
          },
     },
     {
          {
            FLEX_CTR_ST_ING0_COUNTER_TRIGGER_STATE_0r,
            FLEX_CTR_ST_ING0_COUNTER_TRIGGER_STATE_1r,
            FLEX_CTR_ST_ING0_COUNTER_TRIGGER_STATE_2r,
            FLEX_CTR_ST_ING0_COUNTER_TRIGGER_STATE_3r,
            FLEX_CTR_ST_ING0_COUNTER_TRIGGER_STATE_4r,
            FLEX_CTR_ST_ING0_COUNTER_TRIGGER_STATE_5r,
            FLEX_CTR_ST_ING0_COUNTER_TRIGGER_STATE_6r,
            FLEX_CTR_ST_ING0_COUNTER_TRIGGER_STATE_7r,
            FLEX_CTR_ST_ING0_COUNTER_TRIGGER_STATE_8r,
            FLEX_CTR_ST_ING0_COUNTER_TRIGGER_STATE_9r,
            FLEX_CTR_ST_ING0_COUNTER_TRIGGER_STATE_10r,
            FLEX_CTR_ST_ING0_COUNTER_TRIGGER_STATE_11r,
            FLEX_CTR_ST_ING0_COUNTER_TRIGGER_STATE_12r,
            FLEX_CTR_ST_ING0_COUNTER_TRIGGER_STATE_13r,
            FLEX_CTR_ST_ING0_COUNTER_TRIGGER_STATE_14r,
            FLEX_CTR_ST_ING0_COUNTER_TRIGGER_STATE_15r,
         },
         {
            FLEX_CTR_ST_ING1_COUNTER_TRIGGER_STATE_0r,
            FLEX_CTR_ST_ING1_COUNTER_TRIGGER_STATE_1r,
            FLEX_CTR_ST_ING1_COUNTER_TRIGGER_STATE_2r,
            FLEX_CTR_ST_ING1_COUNTER_TRIGGER_STATE_3r,
            FLEX_CTR_ST_ING1_COUNTER_TRIGGER_STATE_4r,
            FLEX_CTR_ST_ING1_COUNTER_TRIGGER_STATE_5r,
            FLEX_CTR_ST_ING1_COUNTER_TRIGGER_STATE_6r,
            FLEX_CTR_ST_ING1_COUNTER_TRIGGER_STATE_7r,
            FLEX_CTR_ST_ING1_COUNTER_TRIGGER_STATE_8r,
            FLEX_CTR_ST_ING1_COUNTER_TRIGGER_STATE_9r,
            FLEX_CTR_ST_ING1_COUNTER_TRIGGER_STATE_10r,
            FLEX_CTR_ST_ING1_COUNTER_TRIGGER_STATE_11r,
            FLEX_CTR_ST_ING1_COUNTER_TRIGGER_STATE_12r,
            FLEX_CTR_ST_ING1_COUNTER_TRIGGER_STATE_13r,
            FLEX_CTR_ST_ING1_COUNTER_TRIGGER_STATE_14r,
            FLEX_CTR_ST_ING1_COUNTER_TRIGGER_STATE_15r,
         },
     }
};
    ...
    ctr_eflex_action_profile_data_t *entry)
{
    ...
    uint32_t count_on_mirror, normal_double =0;
    size_t wsize;
...
/*! clear trigger_state_entry */
static int
bcm56780_a0_cth_eflex_trigger_state_write_common(
    int unit,
    ...
    if (entry->comp == STATE_EFLEX) {
        inst = entry->ingress ? entry->inst : entry->egr_inst;
        sid = state_trigger_state_mem[entry->ingress][inst][entry->action_id];
    } else {
        sid =  ctr_trigger_state_mem[entry->ingress][entry->action_id];
    }
    ...
    for (pipe_idx = entry->start_pipe_idx;
        ...
        SHR_IF_ERR_EXIT
            (bcmptm_ireq_read(unit,
                              ...
                              &rsp_flags));
        SHR_IF_ERR_EXIT
            (bcmdrd_pt_field_set(unit, sid, entry_buf, START_TIMEf,
                                         &start_time));
    ...
    ctr_eflex_trigger_data_t *entry)
{
    ...
    sid = entry->ingress ? FLEX_CTR_ING_COUNTER_ACTION_TABLE_0m :
                           FLEX_CTR_EGR_COUNTER_ACTION_TABLE_0m;
    SHR_IF_ERR_EXIT
        (bcm56780_a0_cth_eflex_trigger_state_write_common(unit, entry));
    ...
    uint32_t *entry_idx)
{
    ...
    /* If narrow mode is enabled, get transformed bkt entry via lookup array */
    if (hitbit_lt_info->narrow_mode) {
        bkt_entry_map = hitbit_lt_info->bkt_entry_lkup[bkt_entry];

        if (bkt_entry_map == INVALID_BKT_ENTRY) {
            LOG_VERBOSE(BSL_LOG_MODULE,
                (BSL_META_U(unit,
                    "Invalid bucket entry %d provided\n"), bkt_entry));
            SHR_ERR_EXIT(SHR_E_PARAM);
        }
    }

    /* Calculate entry index */
    *entry_idx = (((((hit_context->tile_id << 2) |
                     hit_context->table_id) << 15) + bkt_num)
    ...
    *entry_idx += (hitbit_lt_info->base_idx[lkup_idx] *
    ...
    LOG_VERBOSE(BSL_LOG_MODULE, (BSL_META_U(unit,
        ...
        "offset %d shift factor %d, narrow %d, bkt num %d, "
        "bkt entry %d, bkt entry map %d, entry idx 0x%x\n"),
        ltid, hit_context->tile_id, hit_context->table_id, tbl_inst, lkup_idx,
        hitbit_lt_info->base_idx[lkup_idx],
        hitbit_lt_info->shift_factor, hitbit_lt_info->narrow_mode,
        bkt_num, bkt_entry, bkt_entry_map, *entry_idx));
