...
static int
bcm56780_a0_cth_oam_bfd_num_vlans_get(uint8_t vlan_tag_type, uint8_t *num_vlans)
{
    switch (vlan_tag_type) {
        case BCM56780_A0_LRD_VLAN_TAG_TYPE_T_T_UNTAGGED:
            *num_vlans = 0;
            break;

        case BCM56780_A0_LRD_VLAN_TAG_TYPE_T_T_SINGLE_TAGGED:
            *num_vlans = 1;
            break;

        case BCM56780_A0_LRD_VLAN_TAG_TYPE_T_T_DOUBLE_TAGGED:
            *num_vlans = 2;
            break;
...
static int
bcm56780_a0_cth_oam_bfd_rxpmd_flex_fids_get(int unit, int max_fids,
                                            int *num_fids, int *fids)
{
    ...
    /* bcm56780 requires 1 field to be extracted from Rx PMD flex data. */
    if (max_fids < 1) {
    ...
    *num_fids = 0;
    ...
    rv = bcmpkt_flexhdr_field_id_get(variant, hid, "I2E_CLASS_ID_15_0", &fids[0]);
    if (SHR_SUCCESS(rv)) {
        *num_fids = 1;
    }
...
static const char *
bcm56780_a0_cth_oam_bfd_match_id_string_get(int unit, mcs_bfd_match_id_fields_t match_id)
{
    switch (match_id) {
...
static int
bcm56780_a0_cth_oam_deinit(int unit)
{
    return SHR_E_NONE;
}

static int
bcm56780_a0_cth_oam_init(int unit, bool warm)
{
    return SHR_E_NONE;
}

/* BFD device specific parameters */
static bcmcth_oam_bfd_drv_t bcm56780_a0_cth_oam_bfd_drv = {
    .max_mpls_labels = MAX_MPLS_LABELS,
    .num_vlans_get = &bcm56780_a0_cth_oam_bfd_num_vlans_get,
    .rxpmd_flex_fids_get = &bcm56780_a0_cth_oam_bfd_rxpmd_flex_fids_get,
    .match_id_string_get = &bcm56780_a0_cth_oam_bfd_match_id_string_get,
    .max_endpoints = 2048,
    .max_auth_sp_keys = 2048,
    .max_auth_sha1_keys = 2048
};

/* bcm56780 OAM driver object. */
static bcmcth_oam_drv_t bcm56780_a0_cth_oam_drv = {
   .oam_init = &bcm56780_a0_cth_oam_init,
   .oam_deinit = &bcm56780_a0_cth_oam_deinit,
   .bfd_drv = &bcm56780_a0_cth_oam_bfd_drv
};
...
bcmcth_oam_drv_t *
bcm56780_a0_cth_oam_drv_get(int unit)
{
    return &bcm56780_a0_cth_oam_drv;
}
