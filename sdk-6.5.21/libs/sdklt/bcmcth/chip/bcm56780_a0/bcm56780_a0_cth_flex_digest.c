/*! \file bcm56780_a0_cth_flex_digest.c
 *
 * Flex Digest drivers for bcm56780 A0.
 */
/*
...
#include <bcmcth/chip/bcm56780_a0/bcm56780_a0_cth_flex_digest_db.h>
...
typedef struct {
    bcm56780_a0_cth_flex_digest_pkt_node_t *node;
    bcmltd_fid_t fid;
    int cnt;
} pkt_node_level_t;
...
/* the field mapping should be same for all 56780 type units */
static fd_dev_desc_t *fd_dev_desc[BCMDRD_CONFIG_MAX_UNITS] = {NULL};

bcm56780_a0_cth_flex_digest_fkey_fmap_get_f bcm56780_a0_cth_flex_digest_key_map_get[BCMDRD_CONFIG_MAX_UNITS];
bcm56780_a0_cth_flex_digest_fmap_get_f bcm56780_a0_cth_flex_digest_match_id_map_get[BCMDRD_CONFIG_MAX_UNITS];
bcmcth_flex_digest_variant_field_id_t *bcm56780_a0_cth_flex_digest_variant_field_id_desc[BCMDRD_CONFIG_MAX_UNITS];

/******************************************************************************
* Private functions
 */
static int bcm56780_a0_cth_fd_drv_init(int unit, bool warm)
{
    int rv;
    fd_dev_desc_t *desc;
    ...
    rv = (*bcm56780_a0_cth_flex_digest_key_map_get[unit])(unit,
                      &desc->flex_key_map.kmap,
                      &desc->flex_key_map.size);

    SHR_IF_ERR_EXIT(rv);
    rv = (*bcm56780_a0_cth_flex_digest_match_id_map_get[unit])(unit,
 ...
 */
static int bcm56780_a0_cth_fd_hentry_info_get(int unit,
    bcmltd_sid_t lsid,
    int *size,
    bcmcth_flex_digest_hentry_info_t *info)
{
    ...
    desc = bcm56780_a0_cth_flex_digest_variant_field_id_desc[unit];
...
static int fd_parser_graph_validate(int unit,
            bcm56780_a0_cth_flex_digest_pkt_node_t *top_node,
            bcm56780_a0_cth_flex_digest_pkt_node_t *m_node)
{
    int i;
...
static int bcm56780_a0_cth_fd_entry_validate(int unit,
    bcmltd_sid_t lsid,
    bcmcth_flex_digest_entry_info_t *info,
    bcmltd_field_t *in)
{
...
static int bcm56780_a0_cth_fd_drv_cleanup (int unit)
{
...
static int bcm56780_a0_cth_fd_entry_set(int unit,
    bcmltd_sid_t lsid,
    bcmcth_flex_digest_entry_info_t *info,
    bcmltd_field_t *in)
{
...
static int bcm56780_a0_cth_fd_derived_fields_get(int unit,
    bcmltd_sid_t lsid,
    int *size,
    uint32_t *buf)
{
...
static int bcm56780_a0_cth_fd_variant_id_get(int unit,
    bcmcth_flex_digest_variant_field_id_t **desc)
{
    *desc = bcm56780_a0_cth_flex_digest_variant_field_id_desc[unit];
    return SHR_E_NONE;
...
bcm56780_a0_cth_fd_drv = {
    /* Flex Digest driver */
    .drv_init        = bcm56780_a0_cth_fd_drv_init,
    .hentry_info_get = bcm56780_a0_cth_fd_hentry_info_get,
    .entry_set       = bcm56780_a0_cth_fd_entry_set,
    .entry_validate  = bcm56780_a0_cth_fd_entry_validate,
    .derived_fields_get  = bcm56780_a0_cth_fd_derived_fields_get,
    .variant_id_get  = bcm56780_a0_cth_fd_variant_id_get,
    .drv_cleanup     = bcm56780_a0_cth_fd_drv_cleanup,
};

/******************************************************************************
* Public functions
 */
bcmcth_flex_digest_drv_t * bcm56780_a0_cth_flex_digest_drv_common_get(int unit)
{
    return &bcm56780_a0_cth_fd_drv;
}
