...
#define BCM56880_A0_EM_FT_BASE_ENTRY_SIZE 120

#define BCM56880_A0_DT_EM_FT_GRP_MODE_SINGLE 1 /* SINGLE */
#define BCM56880_A0_DT_EM_FT_GRP_MODE_DOUBLE 3 /* DOUBLE */
#define BCM56880_A0_DT_EM_FT_GRP_MODE_QUAD   5 /* QUAD */
...
static int
bcm56880_a0_cth_mon_em_ft_grp_mode_to_num_base_entries(
            int unit,
            uint32_t mode_val,
            uint8_t *num_base_entries)
{
    SHR_FUNC_ENTER(unit);
    switch (mode_val) {
        case BCM56880_A0_DT_EM_FT_GRP_MODE_SINGLE:
            *num_base_entries = 1;
            break;
        case BCM56880_A0_DT_EM_FT_GRP_MODE_DOUBLE:
            *num_base_entries = 2;
            break;
        case BCM56880_A0_DT_EM_FT_GRP_MODE_QUAD:
            *num_base_entries = 4;
            break;
        default:
...
static int
bcm56880_a0_cth_mon_em_ft_grp_mode_to_pdd_info_ref_offset(
            int unit,
            uint32_t mode_val,
            uint32_t *pdd_info_ref_offset)
{
    ...
    SHR_FUNC_ENTER(unit);
    SHR_IF_ERR_EXIT(bcm56880_a0_cth_mon_em_ft_grp_mode_to_num_base_entries(
                    unit, mode_val, &num_base_entries));
    *pdd_info_ref_offset =
        (num_base_entries * BCM56880_A0_EM_FT_BASE_ENTRY_SIZE) -1;
exit:
    SHR_FUNC_EXIT();
}
...
static int
bcm56880_a0_cth_mon_flowtracker_hw_flex_ctr_action_idx_get(
                                        int unit,
                                        uint32_t ctr_ing_flex_action_profile_id,
...
static int
bcm56880_a0_cth_mon_flowtracker_hitbit_type_get_from_num_base_entries(
                                                ...
                                                uint16_t *start_offset)
{
    ...
    if (data_format ==
        ...
        *start_offset = 100 - 4/* 4 bits of SBR index */- total_width_in_bits;
         ...
         */
        *start_offset = 105 - total_width_in_bits;
    } else {
        /* Unexpected */
        SHR_ERR_EXIT(SHR_E_PARAM);
    }
...
static void
bcm56880_a0_cth_mon_flowtracker_grp_flex_policy_buf_action_val_set(
        uint8_t num_actions,
                                                    ...
                                                    int *uc_fids)
{
    ...
    *num_fids = 0;
    ...
    rv = bcmpkt_flexhdr_field_id_get(variant, hid,
                                     "I2E_CLASS_ID_15_0", &fids[*num_fids]);
    if (SHR_SUCCESS(rv)) {
...
static void
bcm56880_a0_cth_mon_flowtracker_ft_em_entry_read_mem_info(
        int unit,
        bcmltd_common_flowtracker_hw_learn_exact_match_idx_mode_t_t mode,
...
static int
bcm56880_a0_cth_mon_ft_em_entry_lkup(
                            int unit,
...
static bcmcth_mon_flowtracker_drv_t bcm56880_a0_flowtracker_drv =
{
    ...
    .ft_fifo_drv = NULL,
    .ft_intr_drv = NULL,
    .ft_em_entry_lkup = &bcm56880_a0_cth_mon_ft_em_entry_lkup,
    .ft_hw_flex_ctr_action_idx_get =
            &bcm56880_a0_cth_mon_flowtracker_hw_flex_ctr_action_idx_get,
    
    .max_sgl_wide_entries_per_pipe = /*(64 * 1024)*/0,
    .max_dbl_wide_entries_per_pipe = /*(32 * 1024)*/0,
    .max_qd_wide_entries_per_pipe = /*(16 * 1024)*/0
};
    ...
    if (SHR_SUCCESS(rv1) && map1) {
        ...
        if (!warm || SHR_E_NOT_FOUND ==
            ...
            SHR_IF_ERR_VERBOSE_EXIT
                 (bcmissu_struct_info_report(unit,
                                             BCMMGMT_MON_COMP_ID,
                                             BCMMON_DROP_SUB_COMP_ID,
                                             0,
                                             ha_req_size,
                                             1,
                                             BCMMON_DROP_STATE_T_ID));
        }
    }
