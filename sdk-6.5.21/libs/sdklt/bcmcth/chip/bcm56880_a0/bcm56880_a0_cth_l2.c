...
static bcm56880_cache_fld_t cache_flds[] = {
...
static int
bcm56880_a0_cth_l2_intr_enable_set(int unit, bool enable, bool in_intr)
{
    bcmcth_l2_drv_t *drv;
...
static int
bcm56880_a0_cth_l2_intr_handler_set(int unit, bcmcth_l2_drv_intr_handler_f cb)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56880_a0_cth_l2_entry_insert(int unit, uint32_t pipe, uint32_t index,
                                void *data)
{
...
static bool
bcm56880_a0_cth_l2_entry_valid(int unit, void *data)
{
    LEARN_CACHE_CACHEm_t *hw_entry;

    hw_entry = (LEARN_CACHE_CACHEm_t *)data;

    if (LEARN_CACHE_CACHEm_VALIDf_GET(*hw_entry) == 1) {
        return true;
    } else {
        return false;
    }
...
bcm56880_a0_cth_l2_attach(int unit)
{
    ...
    drv->l2_intr_enable_set = bcm56880_a0_cth_l2_intr_enable_set;
    ...
    drv->entry_insert = bcm56880_a0_cth_l2_entry_insert;
    drv->entry_valid = bcm56880_a0_cth_l2_entry_valid;
