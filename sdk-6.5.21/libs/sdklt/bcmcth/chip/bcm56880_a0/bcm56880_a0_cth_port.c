/*! \file bcm56880_a0_cth_port.c
 *
 * bcm56880 a0 PORT drivers.
 */
/*
 ...
 */
static int
bcm56880_a0_cth_port_mirror_update(
    int unit,
...
static int
bcm56880_a0_cth_port_mirror_set(
    int unit,
    const bcmltd_op_arg_t *op_arg,
    bcmltd_sid_t lt_id,
...
static int
bcm56880_a0_port_mirror_control_set(
    int unit,
    bcmltd_sid_t lt_id,
    const bcmltd_op_arg_t *op_arg,
    shr_port_t port,
...
static int
bcm56880_a0_port_emirror_control_set(
    int unit,
    bcmltd_sid_t lt_id,
    const bcmltd_op_arg_t *op_arg,
    shr_port_t iport,
...
static int
bcm56880_a0_system_port_table_index_get(int unit,
                                        const bcmltd_op_arg_t *op_arg,
                                        bcmltd_sid_t lt_id,
...
static int
bcm56880_a0_cth_port_system_dest_set(int unit, const bcmltd_op_arg_t *op_arg,
                                     bcmltd_sid_t lt_id,
                                     bool set,
                                     port_system_dest_entry_t *entry)
{
    ...
    SHR_IF_ERR_EXIT(
        bcm56880_a0_system_port_table_index_get(unit,
                                  op_arg,
                                  lt_id,
 ...
 */
static int
bcm56880_a0_cth_port_trunk_pctl_set(int unit,
                                    const bcmltd_op_arg_t *op_arg,
                                    bcmltd_sid_t lt_id,
...
static int
bcm56880_a0_cth_port_ingress_mirror_set(int unit,
                                        const bcmltd_op_arg_t *op_arg,
                                        bcmltd_sid_t lt_id,
                                        port_imirror_t *cfg,
                                        bool mirror_enable)
...
static int
bcm56880_a0_cth_port_egress_mirror_set(
    int unit,
    const bcmltd_op_arg_t *op_arg,
    bcmltd_sid_t lt_id,
    port_emirror_t *cfg,
    bool mirror_enable)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_port_emirror_control_set(unit,
                                              lt_id,
                                              op_arg,
                                              iport,
                                              eport,
    ...
    if (mirror_enable || update_imtp) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56880_a0_port_mirror_control_set(unit,
                                                 lt_id,
                                                 op_arg,
                                                 iport,
                                                 container,
...
static int
bcm56880_a0_cth_port_deinit(int unit)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56880_a0_cth_port_init(int unit, bool warm)
{
...
static int
bcm56880_a0_cth_port_system_source_get(int unit,
                                       int port,
                                       int *system_source)
{
...
static bcmcth_port_drv_t bcm56880_a0_cth_port_drv = {
   .port_init = bcm56880_a0_cth_port_init,
   .port_deinit = bcm56880_a0_cth_port_deinit,
   .port_system_dest_set = bcm56880_a0_cth_port_system_dest_set,
   .port_trunk_pctl_set = bcm56880_a0_cth_port_trunk_pctl_set,
   .port_mirror_set = &bcm56880_a0_cth_port_mirror_set,
   .port_egress_mirror_set = bcm56880_a0_cth_port_egress_mirror_set,
   .port_ingress_mirror_set = bcm56880_a0_cth_port_ingress_mirror_set,
   .port_system_source_get = bcm56880_a0_cth_port_system_source_get
};
 ...
 */
bcmcth_port_drv_t *
bcm56880_a0_cth_port_drv_get(int unit)
{
    return &bcm56880_a0_cth_port_drv;
}
