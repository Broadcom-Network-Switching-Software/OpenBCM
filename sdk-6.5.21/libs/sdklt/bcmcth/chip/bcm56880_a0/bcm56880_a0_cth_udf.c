...
static const bcmdrd_sid_t bus_scg_overwrite[IP0_BUS_SCG_MAX] = {
      ...
      PBLOCK_MISC_IP0_BUS_SCG6r,
      PBLOCK_MISC_IP0_BUS_SCG7r,
      PBLOCK_MISC_IP0_BUS_SCG8r,
      PBLOCK_MISC_IP0_BUS_SCG9r,
      PBLOCK_MISC_IP0_BUS_SCG10r,
      PBLOCK_MISC_IP0_BUS_SCG11r,
      ...
      PBLOCK_MISC_IP4_BUS_SCG0r,
      PBLOCK_MISC_IP4_BUS_SCG1r,
      PBLOCK_MISC_IP4_BUS_SCG2r,
      PBLOCK_MISC_IP4_BUS_SCG3r,
      PBLOCK_MISC_IP4_BUS_SCG4r,
      PBLOCK_MISC_IP4_BUS_SCG5r,
      PBLOCK_MISC_IP4_BUS_SCG6r,
      PBLOCK_MISC_IP4_BUS_SCG7r,
      PBLOCK_MISC_IP4_BUS_SCG8r,
      PBLOCK_MISC_IP4_BUS_SCG9r,
      PBLOCK_MISC_IP4_BUS_SCG10r,
      PBLOCK_MISC_IP4_BUS_SCG11r,
      PBLOCK_MISC_IP4_BUS_SCG12r,
      PBLOCK_MISC_IP4_BUS_SCG13r,
      ...
      PBLOCK_MISC_IP7_BUS_SCG8r,
      PBLOCK_MISC_IP7_BUS_SCG9r,
      ...
      PBLOCK_MISC_IP8_1_BUS_SCG10r,
      PBLOCK_MISC_IP9_0_BUS_SCG0r,
      PBLOCK_MISC_IP9_0_BUS_SCG1r,
      PBLOCK_MISC_IP9_0_BUS_SCG2r,
      PBLOCK_MISC_IP9_0_BUS_SCG3r,
      PBLOCK_MISC_IP9_0_BUS_SCG4r,
      PBLOCK_MISC_IP9_0_BUS_SCG5r,
      PBLOCK_MISC_IP9_0_BUS_SCG6r,
      PBLOCK_MISC_IP9_0_BUS_SCG7r,
      PBLOCK_MISC_IP9_0_BUS_SCG8r,
      PBLOCK_MISC_IP9_0_BUS_SCG9r,
      PBLOCK_MISC_IP9_0_BUS_SCG10r,
      PBLOCK_MISC_IP9_0_BUS_SCG11r,
      PBLOCK_MISC_IP9_0_BUS_SCG12r
};
...
*bcm56880_a0_udf_anchor_info_get(int unit, int hdr_fmt)
{
 ...
 */
static int
bcm56880_a0_bus_scg_register_clear(int unit,
                                   uint32_t trans_id,
                                   bcmltd_sid_t lt_sid)
{
 ...
 */
static bool
bcm56880_a0_udf_is_hfe_index_available(int unit,
                         ...
                         bcmltd_sid_t lt_sid)
{
    ...
    /* Index 0 is used for NON-TUNNEL case, hence no need
     * to overwrite default parser1 container programming.
     */
    for (index = 1; index < MAX_FIELD_MUX_PROFILE; index++) {
        pt_info.index = index;
 ...
 */
static int
bcm56880_a0_udf_policy_cmd_uninstall(int unit,
                                     uint32_t trans_id,
                                     bcmltd_sid_t lt_sid,
                                     bcmcth_udf_policy_info_t *lt_entry)
{
    ...
    udf_anchor_info = bcm56880_a0_udf_anchor_info_get(unit, lt_entry->packet_header);
 ...
 */
static int
bcm56880_a0_udf_policy_cmd_install(int unit,
                                   uint32_t trans_id,
                                   bcmltd_sid_t lt_sid,
                                   bcmcth_udf_policy_info_t *lt_entry,
    ...
    if (cfg_data->num_4b_cont) {
        ...
        for (cont_idx = 0; (cont_idx < UDF_4_BYTE_CONTAINER_MAX &&
            ...
            if ((container_list_4B[cont_idx]) &&
                ...
                if (!update) {
                    if (!hdr_fmt_hw_info->cont_used_4b[cont_idx]) {
    ...
    if (cfg_data->num_2b_cont) {
        ...
        for (cont_idx = 0; (cont_idx < UDF_2_BYTE_CONTAINER_MAX &&
            ...
            if ((container_list_2B[cont_idx]) &&
                ...
                if (!update) {
                    if (!hdr_fmt_hw_info->cont_used_2b[cont_idx]) {
    ...
    if (cfg_data->num_1b_cont) {
        ...
        for (cont_idx = 0; (cont_idx < UDF_1_BYTE_CONTAINER_MAX &&
            ...
            if ((container_list_1B[cont_idx]) &&
                ...
                if (!update) {
                    if (!hdr_fmt_hw_info->cont_used_1b[cont_idx]) {
 ...
 */
static int
bcm56880_a0_udf_policy_cmd_allocate(int unit,
                                    bcmcth_udf_policy_info_t *lt_entry,
                                    udf_obj_hdr_fmt_hw_cfg_t *cfg_data)
{
    ...
    for (stage = 0; stage < hdr_fmt_hw_info->num_stages; stage++) {
        ...
        for (hfe_cnt = 0; hfe_cnt < hdr_fmt_hw_info->hfe_index_count[stage]; hfe_cnt++) {
            ...
            for (cmd = 0; (cmd < cmd_max && num_cmds_remaining > 0); cmd++) {
                if (bcm56880_a0_udf_is_hfe_index_available
 ...
 */
static int
bcm56880_a0_cth_udf_policy_create(
    int unit,
    uint32_t trans_id,
    bcmltd_sid_t lt_sid,
    bcmcth_udf_policy_info_t *lt_entry,
    uint32_t update)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_udf_policy_cmd_allocate(unit,
                                             lt_entry,
                                             cfg_data));
    /* Install UDF entry */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_udf_policy_cmd_install(unit,
                                            trans_id,
                                            lt_sid,
                                            lt_entry,
                                            cfg_data,
                                            update));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_bus_scg_register_clear(unit,trans_id, lt_sid));
 ...
 */
static int
bcm56880_a0_cth_udf_policy_delete(
    int unit,
    uint32_t trans_id,
    bcmltd_sid_t lt_sid,
    bcmcth_udf_policy_info_t *lt_entry)
{
    ...
    /* Uninstall UDF entry */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_udf_policy_cmd_uninstall(unit,
                                              trans_id,
                                              lt_sid,
                                              lt_entry));
exit:
 ...
 */
static int
bcm56880_a0_cth_udf_deinit(int unit)
{
 ...
 */
static int
bcm56880_a0_cth_udf_policy_info_get(int unit, bool warm)
{
 ...
 */
static int
bcm56880_a0_udf_hdr_format_info_config(int unit, bool warm)
{
    uint16_t hdr_fmt;
    uint32_t index;
    ...
    for (hdr_fmt = 0; hdr_fmt < hdr_fmt_last_count; hdr_fmt++) {
        ...
        SHR_NULL_CHECK(hdr_fmt_hw_info, SHR_E_MEMORY);
        udf_anchor_info = bcm56880_a0_udf_anchor_info_get(unit, hdr_fmt);
        if (udf_anchor_info == NULL) {
            LOG_WARN(BSL_LOG_MODULE,
                     (BSL_META_U(unit,
                                 "UDF feature not initialized for configured variant!\n")));
 ...
 */
static int
bcm56880_a0_udf_hdr_format_init(int unit, bool warm)
{
 ...
 */
static int
bcm56880_a0_cth_udf_init(int unit,bool warm)
{
     ...
     */
    SHR_IF_ERR_EXIT(bcm56880_a0_udf_hdr_format_init(unit, warm));

    /*
     * Initialize udf header formats with offset and default values.
     */
    SHR_IF_ERR_EXIT(bcm56880_a0_udf_hdr_format_info_config(unit, warm));
 ...
 */
static int
bcm56880_a0_cth_udf_var_info_init(int unit,
                                  bool warm,
 ...
 */
static int
bcm56880_a0_cth_udf_var_info_deinit(int unit)
{
 ...
 */
static int
bcm56880_a0_cth_udf_field_mux_select_create(
    int unit,
    uint32_t trans_id,
    bcmltd_sid_t lt_sid,
 ...
 */
static int
bcm56880_a0_cth_udf_field_mux_select_delete(
    int unit,
    uint32_t trans_id,
    bcmltd_sid_t lt_sid,
    bcmcth_udf_field_mux_select_info_t *lt_entry)
...
static bcmcth_udf_drv_t bcm56880_a0_cth_udf_drv = {
   .drv_init = &bcm56880_a0_cth_udf_init,
   .drv_policy_create = &bcm56880_a0_cth_udf_policy_create,
   .drv_policy_delete = &bcm56880_a0_cth_udf_policy_delete,
   .drv_deinit = &bcm56880_a0_cth_udf_deinit,
   .drv_policy_info_get = &bcm56880_a0_cth_udf_policy_info_get,
   .var_info_init = &bcm56880_a0_cth_udf_var_info_init,
   .var_info_deinit = &bcm56880_a0_cth_udf_var_info_deinit,
   .drv_field_mux_select_create = &bcm56880_a0_cth_udf_field_mux_select_create,
   .drv_field_mux_select_update = &bcm56880_a0_cth_udf_field_mux_select_create,
   .drv_field_mux_select_delete = &bcm56880_a0_cth_udf_field_mux_select_delete,
};
...
bcmcth_udf_drv_t *
bcm56880_a0_cth_udf_drv_get(int unit)
{
    return &bcm56880_a0_cth_udf_drv;
}
