...
/*!
 * \brief Get DLB hardware table sid
 *
 * \param [in] unit Unit number.
 * \param [in] sid  Hardware sid.
 *
 *
 * \retval SHR_E_NONE No errors.
 * \retval SHR_E_FAIL if call fails.
 */
static int
bcm56880_a0_cth_dlb_sid_get(int unit,
                            bcmltd_sid_t *sid)
{
    *sid = DLB_LAG_PORT_STATEm;
...
static bcmcth_dlb_drv_t bcm56880_a0_cth_dlb_drv = {
    ...
    .sid_get              = bcm56880_a0_cth_dlb_sid_get
};
