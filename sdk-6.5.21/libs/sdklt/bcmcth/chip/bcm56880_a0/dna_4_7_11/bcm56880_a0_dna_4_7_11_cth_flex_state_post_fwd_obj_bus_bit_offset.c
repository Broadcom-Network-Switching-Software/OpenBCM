...
#include "bcm56880_a0_dna_4_7_11_cth_flex_state_post_fwd_obj_bus_bit_offset.h"

const bcmcth_ctr_eflex_obj_bit_offset_t *
bcm56880_a0_dna_4_7_11_flex_state_post_fwd_obj_bus_bit_offset_get(int index)
{
