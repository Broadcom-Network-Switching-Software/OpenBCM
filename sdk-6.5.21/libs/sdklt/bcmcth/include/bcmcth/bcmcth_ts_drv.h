...
/*! HA subcomponent ID for Broadsync Control. */
#define BCMTS_BS_CTRL_SUB_COMP_ID          (2)

/*! HA subcomponent ID for Broadsync Log Data. */
#define BCMTS_BS_LOG_DATA_SUB_COMP_ID      (3)
