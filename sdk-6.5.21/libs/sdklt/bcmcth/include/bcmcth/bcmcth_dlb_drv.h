...
/*! Invalid hardware SID. */
#define DLB_TRUNK_INVALID_SID 0xFFFFFFFF
...
/*!
 * \brief Get hardware table SID.
 *
 * \param [in] unit Unit number.
 * \param [in] sid Hardware table ID.
 *
 * \return SHR_E_NONE No errors.
 * \return SHR_E_PARAM Input parameter error.
 */
typedef int (*bcmcth_dlb_hw_table_sid_get_f)(int unit,
                                             bcmltd_sid_t *sid);
...
typedef struct bcmcth_dlb_drv_s {
    ...
    /*! Get hardware table SID for entry limit query. */
    bcmcth_dlb_hw_table_sid_get_f sid_get;
} bcmcth_dlb_drv_t;
...
/*!
 * \brief Get hardware table SID for entry limit query.
 *
 * \param [in] unit Unit number.
 * \param [in] sid  Hardware table sid.
 *
 * \return SHR_E_NONE No errors.
 * \return SHR_E_PARAM Input parameter error.
 */
