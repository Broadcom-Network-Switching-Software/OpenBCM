...
#ifndef BCMCTH_PHB_L2_ING_MAP_H
#define BCMCTH_PHB_L2_ING_MAP_H
 ...
 */
int
phb_ing_l2_tagged_to_int_pri_stage(int unit,
                      bcmltd_sid_t sid,
                      uint32_t trans_id,
