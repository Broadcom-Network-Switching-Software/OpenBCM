...
/*!
 * \brief Derive variant based information table data.
 *
 * \param [in] unit Unit number.
 *
 * \retval SHR_E_NONE No errors.
 ...
 */
typedef int (*bcmcth_mon_info_get_data_f)(int unit, bcmcth_info_table_t *data);

/*!
 * \brief Mon driver object
 *
 * Mon info driver is used to derive chip and variant information.
 */
typedef struct bcmcth_mon_info_drv_s {

    /*! Derive variant based table id. */
    bcmcth_mon_info_get_data_f          get_data;

} bcmcth_mon_info_drv_t;

/*! \cond  Externs for the required functions. */
#define BCMLRD_VARIANT_ENTRY(_bd,_bu,_va,_ve,_vu,_vv,_vo,_vd,_r0,_r1) \
extern bcmcth_mon_info_drv_t *_bd##_vu##_va##_cth_mon_redirect_profile_info_drv_get(int unit);
