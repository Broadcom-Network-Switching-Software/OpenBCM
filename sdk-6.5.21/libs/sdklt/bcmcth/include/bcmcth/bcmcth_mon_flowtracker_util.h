...
bcmcth_mon_flowtracker_control_out_fields_count(
    ...
    uint32_t *count);
/*!
 * \brief Utility function to get flowtracker export stats.
 *
 * \param [in] unit Unit number.
 * \param [out] msg Export msg
 *
 * \retval SHR_E_NONE No errors.
 * \retval !SHR_E_NONE Failure.
 */
...
/*!
 * \brief Utility function to get flowtracker learn stats.
 *
 * \param [in] unit Unit number.
 * \param [out] msg Learn msg
 *
 * \retval SHR_E_NONE No errors.
 * \retval !SHR_E_NONE Failure.
 */
...
/*!
 * \brief Utility function to get flowtracker age stats.
 *
 * \param [in] unit Unit number.
 * \param [out] msg Age msg
 *
 * \retval SHR_E_NONE No errors.
 * \retval !SHR_E_NONE Failure.
 */
