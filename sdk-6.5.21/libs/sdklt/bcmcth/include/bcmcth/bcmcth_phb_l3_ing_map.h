...
#ifndef BCMCTH_PHB_L3_ING_MAP_H
#define BCMCTH_PHB_L3_ING_MAP_H
...
int
phb_ing_ip_dscp_to_int_pri_remap_stage(int unit,
                      bcmltd_sid_t sid,
                      uint32_t trans_id,
