...
typedef int (*bcmpkt_generic_loopback_t_field_set_f)(
    bcmlrd_variant_t variant, uint32_t hid,
    uint32_t *generic_loopback_t, int profile,
...
typedef struct bcmcth_mirror_data_s {
    ...
    /*! IFA 1.0 header id. */
    int ifa_1_hdr_id_mirror_transport;

    /*! IFA 1.0 reserved index. */
    int ifa_1_reserved_index;

    /*! IFA 1.0 table SID. */
    bcmltd_sid_t ifa_1_ltid;
