...
/*! Tunnel VxLAN BFD endpoint specific information. */
typedef struct bcmcth_oam_bfd_endpoint_tnl_l2_vxlan_s {
    /*! Outer and inner IP type. */
    bcmltd_common_oam_bfd_tnl_l2_vxlan_endpoint_ip_encap_type_t_t ip_encap_type;

    /*! Underlay IPv4 encapsulation. */
    struct {
        /*! Source IPv4 address. */
        shr_ip_t src_ip;
    ...
    shr_vxlan_vnid_t  vxlan_vnid;

    /*! Overlay Ethernet header. */
    struct {
        /*! Destination MAC. */
        shr_mac_t dst_mac;
    ...
    /*! Rx lookup VLAN ID. */
    uint16_t rx_lookup_vlan_id;
} bcmcth_oam_bfd_endpoint_tnl_l2_vxlan_t;
...
typedef struct bcmcth_oam_bfd_endpoint_s {
    ...
    union {
        ...
        /*! Tunnel VxLAN endpoint information. */
        bcmcth_oam_bfd_endpoint_tnl_l2_vxlan_t tnl_vxlan;
    } type;
