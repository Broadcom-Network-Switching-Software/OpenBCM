...
bcmcth_ctr_eflex_pool_info_populate(int unit, bool ingress, eflex_comp_t comp)
{
    ...
    if (bcmcth_eflex_is_lt_supported(unit, pool_info_table_sid[comp][select])) {
...
bcmcth_ctr_eflex_imm_action_profile_info_register(int unit)
{
    ...
    /* Check if LT is supported for given device */
    if (bcmcth_eflex_is_lt_supported(unit, CTR_ING_FLEX_POOL_INFOt)) {
    ...
    /* Check if LT is supported for given device */
    if (bcmcth_eflex_is_lt_supported(unit, CTR_EGR_FLEX_POOL_INFOt)) {
...
bcmcth_state_eflex_imm_action_profile_info_register(int unit)
{
    ...
    /* Check if LT is supported for given device */
    if (bcmcth_eflex_is_lt_supported(unit, FLEX_STATE_ING_POOL_INFOt)) {
