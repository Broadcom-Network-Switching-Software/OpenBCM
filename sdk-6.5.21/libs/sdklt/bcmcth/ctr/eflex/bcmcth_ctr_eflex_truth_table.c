...
bcmcth_state_eflex_imm_truth_table_register(int unit)
{
    ...
    if (bcmcth_eflex_is_lt_supported(unit, FLEX_STATE_ING_TRUTH_TABLEt)) {
        ...
        state_eflex_lt_cb.op_stage =
            bcmcth_state_eflex_ing_truth_table_lt_stage_cb;
    ...
    if (bcmcth_eflex_is_lt_supported(unit, FLEX_STATE_EGR_TRUTH_TABLEt)) {
        /* Register CTR_EGR_EFLEX_TRUTH_TABLE handler */
        sal_memset(&state_eflex_lt_cb, 0, sizeof(bcmimm_lt_cb_t));
        state_eflex_lt_cb.op_stage =
            bcmcth_state_eflex_egr_truth_table_lt_stage_cb;
        state_eflex_lt_cb.ent_limit_get =
