...
bcmcth_ctr_eflex_imm_group_action_register(int unit)
{
    ...
    if (bcmcth_eflex_is_lt_supported(unit,
        ...
        ctr_eflex_lt_cb.op_stage =
            bcmcth_ctr_eflex_ing_group_action_lt_stage_cb;
        ctr_eflex_lt_cb.op_lookup =
            bcmcth_ctr_eflex_ing_group_action_lt_lookup_cb;
    ...
    if (bcmcth_eflex_is_lt_supported(unit,
        ...
        sal_memset(&ctr_eflex_lt_cb, 0, sizeof(bcmimm_lt_cb_t));
        ctr_eflex_lt_cb.op_stage =
            bcmcth_ctr_eflex_egr_group_action_lt_stage_cb;
        ctr_eflex_lt_cb.op_lookup =
            bcmcth_ctr_eflex_egr_group_action_lt_lookup_cb;
        ctr_eflex_lt_cb.ent_limit_get =
