...
bcmcth_ctr_eflex_imm_range_chk_register(int unit)
{
    ...
    if (bcmcth_eflex_is_lt_supported(unit, CTR_ING_EFLEX_RANGE_CHK_PROFILEt)) {
    ...
    /* Check if LT is supported for given device */
    if (bcmcth_eflex_is_lt_supported(unit, CTR_EGR_EFLEX_RANGE_CHK_PROFILEt)) {
...
bcmcth_state_eflex_imm_range_chk_register(int unit)
{
    ...
    /* Check if LT is supported for given device */
    if (bcmcth_eflex_is_lt_supported(unit, FLEX_STATE_ING_RANGE_CHK_PROFILEt)) {
        ...
        state_eflex_lt_cb.op_stage =
            bcmcth_state_eflex_ing_range_chk_lt_stage_cb;
    ...
    /* Check if LT is supported for given device */
    if (bcmcth_eflex_is_lt_supported(unit, FLEX_STATE_EGR_RANGE_CHK_PROFILEt)) {
        /* Register FLEX_STATE_EGR_RANGE_CHK_PROFILE handler */
        sal_memset(&state_eflex_lt_cb, 0, sizeof(bcmimm_lt_cb_t));
        state_eflex_lt_cb.op_stage =
            bcmcth_state_eflex_egr_range_chk_lt_stage_cb;
        state_eflex_lt_cb.ent_limit_get  =
