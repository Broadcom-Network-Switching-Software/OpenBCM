...
bcmcth_ctr_eflex_imm_error_stats_register(int unit)
{
    ...
    if (bcmcth_eflex_is_lt_supported(unit, CTR_ING_EFLEX_ERROR_STATSt)) {
    ...
    /* Check if LT is supported for given device */
    if (bcmcth_eflex_is_lt_supported(unit, CTR_EGR_EFLEX_ERROR_STATSt)) {
...
bcmcth_state_eflex_imm_error_stats_register(int unit)
{
    ...
    /* Check if LT is supported for given device */
    if (bcmcth_eflex_is_lt_supported(unit, FLEX_STATE_ING_ERROR_STATSt)) {
        /* Register FLEX_STATE_ING_ERROR_STATS handler */
        sal_memset(&state_eflex_lt_cb, 0, sizeof(bcmimm_lt_cb_t));
        state_eflex_lt_cb.stage =
            bcmcth_state_eflex_ing_error_stats_lt_stage_cb;
        state_eflex_lt_cb.lookup =
            bcmcth_state_eflex_ing_error_stats_lt_lookup_cb;
    ...
    /* Check if LT is supported for given device */
    if (bcmcth_eflex_is_lt_supported(unit, FLEX_STATE_EGR_ERROR_STATSt)) {
        /* Register FLEX_STATE_EGR_ERROR_STATS handler */
        sal_memset(&state_eflex_lt_cb, 0, sizeof(bcmimm_lt_cb_t));
        state_eflex_lt_cb.stage =
            bcmcth_state_eflex_egr_error_stats_lt_stage_cb;
        state_eflex_lt_cb.lookup =
            bcmcth_state_eflex_egr_error_stats_lt_lookup_cb;
        state_eflex_lt_cb.ent_limit_get =
