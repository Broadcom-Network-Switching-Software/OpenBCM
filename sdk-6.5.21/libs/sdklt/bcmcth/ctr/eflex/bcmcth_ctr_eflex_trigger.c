...
bcmcth_ctr_eflex_imm_trigger_register(int unit)
{
    ...
    if (bcmcth_eflex_is_lt_supported(unit, CTR_ING_EFLEX_TRIGGERt)) {
    ...
    /* Check if LT is supported for given device */
    if (bcmcth_eflex_is_lt_supported(unit, CTR_EGR_EFLEX_TRIGGERt)) {
...
bcmcth_state_eflex_imm_trigger_register(int unit)
{
    ...
    /* Check if LT is supported for given device */
    if (bcmcth_eflex_is_lt_supported(unit, FLEX_STATE_ING_TRIGGERt)) {
        /* Register FLEX_STATE_ING_TRIGGER handler */
        sal_memset(&state_eflex_lt_cb, 0, sizeof(bcmimm_lt_cb_t));
        state_eflex_lt_cb.op_stage =
            bcmcth_state_eflex_ing_trigger_lt_stage_cb;
        state_eflex_lt_cb.op_lookup =
            bcmcth_state_eflex_ing_trigger_lt_lookup_cb;
    ...
    /* Check if LT is supported for given device */
    if (bcmcth_eflex_is_lt_supported(unit, FLEX_STATE_EGR_TRIGGERt)) {
        /* Register FLEX_STATE_EGR_TRIGGER handler */
        sal_memset(&state_eflex_lt_cb, 0, sizeof(bcmimm_lt_cb_t));
        state_eflex_lt_cb.op_stage =
            bcmcth_state_eflex_egr_trigger_lt_stage_cb;
        state_eflex_lt_cb.op_lookup =
            bcmcth_state_eflex_egr_trigger_lt_lookup_cb;
        state_eflex_lt_cb.ent_limit_get =
