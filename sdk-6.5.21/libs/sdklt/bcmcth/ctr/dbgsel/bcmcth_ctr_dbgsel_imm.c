...
ctr_dbgsel_map_init(bcmltd_sid_t sid, ctr_dbgsel_trigger *fid2enum)
{
    if (sid == CTR_ING_DEBUG_SELECTt) {
        ...
        fid2enum[CTR_EGR_DEBUG_SELECTt_NONUC_PRUNE_DROPf]
                = CTR_EGR_DBG_SEL_NONUC_PRUNE_DROP;
        fid2enum[CTR_EGR_DEBUG_SELECTt_FP_DROPf]
                = CTR_EGR_DBG_SEL_FP_DROP;
        fid2enum[CTR_EGR_DEBUG_SELECTt_ADAPT_LOOKUP_MISSf]
                = CTR_EGR_DBG_SEL_ADAPT_LOOKUP_MISS;
        fid2enum[CTR_EGR_DEBUG_SELECTt_OVERLAY_UNDERLAY_RANGE_ERRORf]
                = CTR_EGR_DBG_SEL_OVERLAY_UNDERLAY_RANGE_ERROR;
        fid2enum[CTR_EGR_DEBUG_SELECTt_VP_PRUNE_DROPf]
                = CTR_EGR_DBG_SEL_VP_PRUNE_DROP;
        fid2enum[CTR_EGR_DEBUG_SELECTt_SVP_ES_DROPf]
                = CTR_EGR_DBG_SEL_SVP_ES_DROP;
        fid2enum[CTR_EGR_DEBUG_SELECTt_SPLIT_HORIZON_DROPf]
                = CTR_EGR_DBG_SEL_SPLIT_HORIZON_DROP;
    }
}
