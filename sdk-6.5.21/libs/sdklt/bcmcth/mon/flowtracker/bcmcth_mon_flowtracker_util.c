...
int
bcmcth_mon_ft_util_export_stats_get(int unit,
    ...
    tmp_rv = bcmcth_mon_ft_eapp_get_export_stats(unit, msg);

    return tmp_rv;
}

int
bcmcth_mon_ft_util_learn_stats_get(int unit,
    ...
    tmp_rv = bcmcth_mon_ft_eapp_get_learn_stats(unit, msg);

    return tmp_rv;
}

int
bcmcth_mon_ft_util_age_stats_get(int unit,
    ...
    tmp_rv = bcmcth_mon_ft_eapp_get_age_stats(unit, msg);
