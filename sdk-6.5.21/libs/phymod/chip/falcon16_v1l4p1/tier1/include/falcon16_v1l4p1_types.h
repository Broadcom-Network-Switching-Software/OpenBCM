...
/** @file falcon16_v1l4p1_types.h
 * Common types used by Serdes API functions
 */

#ifndef FALCON16_V1L4P1_API_TYPES_H
#define FALCON16_V1L4P1_API_TYPES_H

#include "falcon16_v1l4p1_ipconfig.h"
#include "falcon16_v1l4p1_usr_includes.h"

typedef struct falcon16_v1l4p1_triage_info_st {
   uint32_t     api_ver;
   uint32_t     ucode_ver;
   uint8_t      core;
   uint8_t      lane;
...
struct falcon16_v1l4p1_uc_lane_config_field_st {
...
struct falcon16_v1l4p1_uc_core_config_field_st {
  uint8_t  vco_rate          ;
...
/** Lane Config Struct */
struct  falcon16_v1l4p1_uc_lane_config_st {
  struct falcon16_v1l4p1_uc_lane_config_field_st field;
  uint16_t word;
};

/** Core Config Struct */
struct  falcon16_v1l4p1_uc_core_config_st {
  struct falcon16_v1l4p1_uc_core_config_field_st field;
  uint16_t word;
...
struct falcon16_v1l4p1_usr_ctrl_func_st {
...
struct falcon16_v1l4p1_usr_ctrl_dfe_func_st {
...
struct falcon16_v1l4p1_usr_ctrl_disable_functions_st {
  struct falcon16_v1l4p1_usr_ctrl_func_st field;
  uint16_t word;
};

/** Lane User Control Disable DFE Function Struct */
struct falcon16_v1l4p1_usr_ctrl_disable_dfe_functions_st {
  struct falcon16_v1l4p1_usr_ctrl_dfe_func_st field;
  uint8_t  byte;
};
struct ber_data_st {
    uint64_t num_errs;
...
struct falcon16_v1l4p1_detailed_lane_status_st {
...
#define SIZE_OF_EXTENDED_LANE_STATE 192 /* Change the size if falcon16_v1l4p1_detailed_lane_status_st size changes */

typedef struct { 
    uint8_t extended_lane_st_tmp[sizeof(struct falcon16_v1l4p1_detailed_lane_status_st)==SIZE_OF_EXTENDED_LANE_STATE ? 1: -1]; 
} falcon16_v1l4p1_detailed_lane_status_st_size_check;
