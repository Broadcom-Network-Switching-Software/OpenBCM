...
/** @file falcon16_v1l4p1_dependencies.h
 * Dependencies to be provided by IP User
 */

#ifndef FALCON16_V1L4P1_API_DEPENDENCIES_H
#define FALCON16_V1L4P1_API_DEPENDENCIES_H
 ...
 */
err_code_t falcon16_v1l4p1_pmd_rdt_reg(srds_access_t *sa__, uint16_t address, uint16_t *val);
 ...
 * If using Serdes MDIO controller to access the registers, implement this function using falcon16_v1l4p1_pmd_mdio_mwr_reg(..)
 *
 * If NOT using a Serdes MDIO controller or the Serdes PMI Masked write feature, please use the following code to
 * implement this function
 *
 *    falcon16_v1l4p1_pmd_wr_reg(addr, ((falcon16_v1l4p1_pmd_rd_reg(addr) & ~mask) | (mask & (val << lsb))));
 *
 * @param sa__ is an opaque state vector passed through to device access functions.
 ...
 */
#ifdef SRDS_API_ALL_FUNCTIONS_HAVE_ACCESS_STRUCT
err_code_t falcon16_v1l4p1_delay_ns(srds_access_t *sa__, uint16_t delay_ns);
#else
 ...
 */
#ifdef SRDS_API_ALL_FUNCTIONS_HAVE_ACCESS_STRUCT
err_code_t falcon16_v1l4p1_delay_us(srds_access_t *sa__, uint32_t delay_us);
#else
 ...
 */
#ifdef SRDS_API_ALL_FUNCTIONS_HAVE_ACCESS_STRUCT
err_code_t falcon16_v1l4p1_delay_ms(srds_access_t *sa__, uint32_t delay_ms);
#else
...
#define falcon16_v1l4p1_get_physical_lane falcon16_v1l4p1_get_lane
...
#define falcon16_v1l4p1_set_physical_lane falcon16_v1l4p1_set_lane



#if defined(SERDES_EXTERNAL_INFO_TABLE_EN)
/** Returns address of falcon16_v1l4p1 info table stored in upper level software.
 * @param sa__ is an opaque state vector passed through to device access functions.
 */
srds_info_t *falcon16_v1l4p1_get_info_table_address(srds_access_t *sa__);
#endif
