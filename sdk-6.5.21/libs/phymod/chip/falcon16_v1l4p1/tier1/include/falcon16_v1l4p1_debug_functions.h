...
/** @file falcon16_v1l4p1_debug_functions.h
 * Functions used internally and available in debug shell only
 */

#ifndef FALCON16_V1L4P1_DEBUG_FUNCTIONS_H
#define FALCON16_V1L4P1_DEBUG_FUNCTIONS_H
...
/** Reads current pmd lane status and populates the provided structure of type #falcon16_v1l4p1_detailed_lane_status_st.
 * @param sa__ is an opaque state vector passed through to device access functions.
...
/** Displays the lane status stored in the input struct of type #falcon16_v1l4p1_detailed_lane_status_st.
 * @param sa__ is an opaque state vector passed through to device access functions.
