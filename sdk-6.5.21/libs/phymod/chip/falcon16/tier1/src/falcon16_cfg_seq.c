...
#include "../include/falcon16_api_uc_vars_rdwr_defns.h"
...
err_code_t falcon16_tsc_cl93n72_frc_byte_set(srds_access_t *sa__, uint32_t data)
{
    err_code_t __err;
    __err=ERR_CODE_NONE;
...
err_code_t falcon16_tsc_cl93n72_frc_byte_get(srds_access_t *sa__, uint32_t *data)
{
    err_code_t __err;
    __err=ERR_CODE_NONE;
