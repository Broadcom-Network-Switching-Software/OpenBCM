...
/* Bit 3: force ER in AN, default is 0 */
#define BLACKHAWK_USR_MISC_CTRL_FORCE_ER      0x1 << 3
/* Bit 4: force NR in AN, default is 0 */
#define BLACKHAWK_USR_MISC_CTRL_FORCE_NR      0x1 << 4
...
err_code_t blackhawk_tsc_ext_loop_timing_tx(phymod_access_t *sa__, uint8_t enable);
...
err_code_t blackhawk_tsc_tx_pi_get(phymod_access_t *sa__, int16_t *integ2_reg, uint16_t *phase_sum_capture_resync_lh);
...
err_code_t blackhawk_rx_pmd_lock_status_get(phymod_access_t *sa__, uint32_t *pmd_rx_locked, uint32_t *pmd_lock_changed);
err_code_t blackhawk_tsc_usr_misc_ctrl_set(srds_access_t *sa__, uint32_t bitmask, uint8_t value);
err_code_t blackhawk_tsc_usr_misc_ctrl_get(srds_access_t *sa__, uint32_t bitmask, uint8_t *value);
