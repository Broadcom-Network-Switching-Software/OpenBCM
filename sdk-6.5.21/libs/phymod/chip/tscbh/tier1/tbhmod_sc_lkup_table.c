...
uint32_t* tscbh_spd_id_entry_26_get(void)
{
    return &spd_id_entry_26[0][0];
}

uint32_t* tscbh_spd_id_entry_25_get(void)
{
    return &spd_id_entry_25[0][0];
}


uint32_t* tscbh_spd_id_entry_20_get(void)
{
    return &spd_id_entry_20[0][0];
}

uint32_t* tscbh_spd_id_entry_26_gsh_get(void)
{
    return &spd_id_entry_26_gsh[0][0];
}

uint32_t* tscbh_spd_id_entry_25_gsh_get(void)
{
    return &spd_id_entry_25_gsh[0][0];
}


uint32_t* tscbh_spd_id_entry_20_gsh_get(void)
{
    return &spd_id_entry_20_gsh[0][0];
}

uint32_t* tscbh_am_table_entry_get(void)
{
    return &am_table_entry[0][0];
}

uint32_t* tscbh_gen2_am_table_entry_get(void)
{
    return &am_table_entry_gen2[0][0];
}


uint32_t* tscbh_um_table_entry_get(void)
{
    return &um_table_entry[0][0];
}

uint32_t* tscbh_speed_priority_mapping_table_get(void)
{
    return &speed_priority_mapping_table[0][0];
}


uint32_t* tscbh_spd_id_entry_100g_4lane_no_fec_25_get(void)
{
    return &spd_id_entry_100g_4lane_no_fec_25[0];
}

uint32_t* tscbh_spd_id_entry_100g_4lane_no_fec_26_get(void)
{
    return &spd_id_entry_100g_4lane_no_fec_26[0];
}
