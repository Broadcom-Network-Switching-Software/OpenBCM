...
err_code_t merlin16_configure_pll_refclk_div(srds_access_t *sa__,
    ...
    return merlin16_INTERNAL_configure_pll(sa__, refclk, div, 0, MERLIN16_PLL_OPTION_NONE);
}
...
err_code_t merlin16_configure_pll_div_vco(srds_access_t *sa__,
                                        enum merlin16_pll_div_enum div,
                                        uint32_t vco_freq_khz) {
    return merlin16_INTERNAL_configure_pll(sa__, MERLIN16_PLL_REFCLK_UNKNOWN, div, vco_freq_khz, MERLIN16_PLL_OPTION_NONE);
}
...
err_code_t merlin16_configure_pll_refclk_div_div2refclk(srds_access_t *sa__,
                                           enum merlin16_pll_refclk_enum refclk,
                                           enum merlin16_pll_div_enum div) {
   return merlin16_INTERNAL_configure_pll(sa__, refclk, div, 0, MERLIN16_PLL_OPTION_REFCLK_DIV2_EN);
}
...
err_code_t merlin16_configure_pll_div_vco_div2refclk(srds_access_t *sa__,
                                        enum merlin16_pll_div_enum div,
                                        uint32_t vco_freq_khz) {
    return merlin16_INTERNAL_configure_pll(sa__, MERLIN16_PLL_REFCLK_UNKNOWN, div, vco_freq_khz, MERLIN16_PLL_OPTION_REFCLK_DIV2_EN);
}
/* following routines divide refclk input by 2 to prevent fracn mode */
err_code_t merlin16_configure_pll_refclk_div_div4refclk(srds_access_t *sa__,
                                           enum merlin16_pll_refclk_enum refclk,
                                           enum merlin16_pll_div_enum div) {
   return merlin16_INTERNAL_configure_pll(sa__, refclk, div, 0, MERLIN16_PLL_OPTION_REFCLK_DIV4_EN);
}
...
err_code_t merlin16_configure_pll_div_vco_div4refclk(srds_access_t *sa__,
                                        enum merlin16_pll_div_enum div,
                                        uint32_t vco_freq_khz) {
    return merlin16_INTERNAL_configure_pll(sa__, MERLIN16_PLL_REFCLK_UNKNOWN, div, vco_freq_khz, MERLIN16_PLL_OPTION_REFCLK_DIV4_EN);
}
