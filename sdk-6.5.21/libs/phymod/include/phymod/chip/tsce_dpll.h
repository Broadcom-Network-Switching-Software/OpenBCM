...
int tsce_dpll_phy_hg2_codec_control_set(const phymod_phy_access_t* phy, phymod_phy_hg2_codec_t hg2_codec);
int tsce_dpll_phy_hg2_codec_control_get(const phymod_phy_access_t* phy, phymod_phy_hg2_codec_t* hg2_codec);
...
/*Set timesync adjust*/
int tsce_dpll_timesync_adjust_set(const phymod_phy_access_t* phy, uint32_t flags, phymod_timesync_compensation_mode_t ts_am_norm_mode);
...
/* Override tx_clk_vld to enable mac credit*/
int tsce_dpll_phy_bond_in_pwrdn_override(const phymod_phy_access_t* phy, uint32_t enable);

/* Set/Get synce clock config*/
int tsce_dpll_phy_synce_clk_ctrl_set(const phymod_phy_access_t* phy, phymod_synce_clk_ctrl_t cfg);
int tsce_dpll_phy_synce_clk_ctrl_get(const phymod_phy_access_t* phy, phymod_synce_clk_ctrl_t* cfg);
