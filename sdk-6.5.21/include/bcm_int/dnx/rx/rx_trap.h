...
*   * None
*/
shr_error_e dnx_rx_trap_lif_ingress_profile_hw_get(
    int unit,
...
*   * None
*/
shr_error_e dnx_rx_trap_lif_ingress_profile_hw_set(
    int unit,
    dbal_tables_e dbal_table,
    uint32 inlif_dbal_result_type,
    int in_lif,
...
*   * None
*/
shr_error_e dnx_rx_trap_lif_etpp_profile_lif_hw_get(
    int unit,
    dnx_algo_gpm_gport_hw_resources_t * lif_hw_resources_p,
    uint32 *lif_trap_profile_p,
    bcm_gport_t lif_gport);
...
*   * None
*/
shr_error_e dnx_rx_trap_lif_etpp_profile_lif_hw_set(
    int unit,
    dnx_algo_gpm_gport_hw_resources_t * lif_hw_resources_p,
    uint32 lif_trap_profile,
    bcm_gport_t lif_gport);
