...
{
    /*
     * Specifies TCAM cahce mode, see Enum definition for more info.
     */
 ...
 * {
 */
extern dnx_field_group_tcam_cache_t dnx_field_group_tcam_entry_cache[DNX_DATA_MAX_FIELD_GROUP_NOF_FGS];
/*
 * }
 */
