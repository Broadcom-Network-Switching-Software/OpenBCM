...
/**
* \brief -  Get the ECGM to SCH Global FC indications.
*
* \param [in] unit - chip unit id
* \param [in] core_id - core id
* \param [out] device - device FC indication: 1 = on, 0 = off.
* \param [out] erp - ERP port FC indication: 1 = on, 0 = off.
* \param [out] erp_tc - ERP port per TC FC indication: bitmap, 1 = on, 0 = off for each TC.
* \return
*   shr_error_e
*
* \see
*   * None
*/
shr_error_e dnx_ecgm_dbal_global_fc_indications_get(
    uint32 unit,
    uint32 core_id,
    uint8 *device,
    uint8 *erp,
...
/**
* \brief -  Get the ECGM to SCH Interface FC indications.
*
* \param [in] unit - chip unit id
* \param [in] core_id - core id
* \param [in] interface - Egress Interface
* \param [in] priority - ECGM priority.
* \param [out] fc_indication - FC indication: 1 = on, 0 = off.
* \return
*   shr_error_e
*
* \see
*   * None
*/
shr_error_e dnx_ecgm_dbal_per_interface_fc_indication_get(
    uint32 unit,
    uint32 core_id,
    uint32 interface,
    uint32 priority,
...
/**
* \brief -  Get the ECGM to SCH Q-pair FC indications.
*
* \param [in] unit - chip unit id
* \param [in] core_id - core id
* \param [in] qpair - Qpair
* \param [out] fc_indication - FC indication: 1 = on, 0 = off.
* \return
*   shr_error_e
*
...
*   * None
*/
shr_error_e dnx_ecgm_dbal_per_qpair_fc_indication_get(
    uint32 unit,
    uint32 core_id,
    uint32 qpair,
    uint8 *fc_indication);
