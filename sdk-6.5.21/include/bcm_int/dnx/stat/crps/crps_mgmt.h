...
/**
  ...
  */
#define A_TYPE_ENGINE_SIZE(_unit) \
    (dnx_data_crps.engine.engines_info_get(_unit, FIRST_A_ENGINE_ID)->nof_counters)

/**
  * \brief - number of counters in B-type engine
  */
#define B_TYPE_ENGINE_SIZE(_unit) \
    (dnx_data_crps.engine.engines_info_get(_unit, FIRST_B_ENGINE_ID(_unit))->nof_counters)

/**
  * \brief - number of counters in C-type engine
  */
#define C_TYPE_ENGINE_SIZE(_unit) \
    (dnx_data_crps.engine.engines_info_get(_unit, FIRST_C_ENGINE_ID(_unit))->nof_counters)
