...
/*
 * trap_etpp_lif_profile_allocation.h
 *
 *  Created on: Jan 3, 2018
 *      Author: dp889757
 */

#ifndef INCLUDE_BCM_INT_DNX_ALGO_RX_ETPP_TRAP_LIF_PROFILE_ALLOCATION_H_
#define INCLUDE_BCM_INT_DNX_ALGO_RX_ETPP_TRAP_LIF_PROFILE_ALLOCATION_H_
 ...
 *      shr_error_e
 */
shr_error_e dnx_algo_rx_trap_etpp_lif_profile_allocate(
    int unit,
    uint32 module_id,
...
#endif /* INCLUDE_BCM_INT_DNX_ALGO_RX_TRAP_ETPP_LIF_PROFILE_ALLOCATION_H_ */
