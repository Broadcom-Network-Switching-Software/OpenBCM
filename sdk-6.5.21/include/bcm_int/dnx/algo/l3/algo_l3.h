...
#define DNX_ALGO_L3_PHYSICAL_FEC_GET(unit,fec_id) (DNX_ALGO_L3_FEC_ID_TO_SUPER_FEC_ID(fec_id) * dnx_data_l3.fec.super_fec_size_get(unit) /  dnx_data_mdb.pdbs.pdb_info_get(unit,DBAL_PHYSICAL_TABLE_FEC_1)->row_width)
