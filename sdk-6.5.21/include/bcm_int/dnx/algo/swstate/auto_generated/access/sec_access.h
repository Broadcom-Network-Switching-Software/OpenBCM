...
typedef int (*dnx_sec_db_control_sec_power_down_info_is_powered_down_set_cb)(
    int unit, uint32 power_down_info_idx_0, uint32 power_down_info_idx_1, int is_powered_down);
...
/**
 * implemented by: dnx_sec_db_control_sec_is_forced_power_up_state_set
 */
typedef int (*dnx_sec_db_control_sec_is_forced_power_up_state_set_cb)(
    int unit, int is_forced_power_up_state);

/**
 * implemented by: dnx_sec_db_control_sec_is_forced_power_up_state_get
 */
typedef int (*dnx_sec_db_control_sec_is_forced_power_up_state_get_cb)(
    int unit, int *is_forced_power_up_state);
 ...
 */
typedef struct {
    dnx_sec_db_control_sec_is_forced_power_up_state_set_cb set;
    dnx_sec_db_control_sec_is_forced_power_up_state_get_cb get;
} dnx_sec_db_control_sec_is_forced_power_up_state_cbs;
...
typedef struct {
     ...
     */
    dnx_sec_db_control_sec_is_forced_power_up_state_cbs is_forced_power_up_state;
    /**
