...
int imb_feu_port_local_fault_enable_set(
    int unit,
    bcm_port_t port,
    int enable);
int imb_feu_port_local_fault_enable_get(
    int unit,
    bcm_port_t port,
    int *enable);

/*remote fault enable set/get*/
int imb_feu_port_remote_fault_enable_set(
    int unit,
    bcm_port_t port,
    int enable);
int imb_feu_port_remote_fault_enable_get(
    int unit,
    bcm_port_t port,
    int *enable);
