 ...
 */
typedef struct bcmi_ltsw_vlan_egr_xlate_cfg_s {
    ...
    int dot1p_map_id;
     ...
     /* Opaque-tag action for opaque-tagged packets. */
    bcm_vlan_action_t opaque_tag_present;

    /* Opaque-tag action for non-opaque-tagged packets. */
    bcm_vlan_action_t opaque_tag_not_present;
...
} bcmi_ltsw_vlan_egr_xlate_cfg_t;

/*!
 * \brief Callback function to handle an egress VLAN translation entry.
 */
typedef int (*bcmi_ltsw_vlan_egr_xlate_traverse_cb)(
    /* Unit Number.*/
    int unit,
 ...
 * \param [in]      cfg              Configurations for outer and inner tag.
 *
 * \retval SHR_E_NONE      No errors.
 * \retval !SHR_E_NONE     Failure.
 */
extern int
bcmi_ltsw_vlan_egr_xlate_add(int unit, int port_class,
                             bcm_vlan_t outer_vlan,
                             bcm_vlan_t inner_vlan,
                             bcmi_ltsw_vlan_egr_xlate_cfg_t *cfg);
 ...
 * \param [in]      outer_vlan       Packet outer VLAN ID.
 * \param [in]      inner_vlan       Packet inner VLAN ID.
 * \param [out]     cfg              Configurationsn for outer and inner tag.
 *
 * \retval SHR_E_NONE      No errors.
 * \retval !SHR_E_NONE     Failure.
 */
extern int
bcmi_ltsw_vlan_egr_xlate_get(int unit, int port_class,
                             bcm_vlan_t outer_vlan,
                             bcm_vlan_t inner_vlan,
                             bcmi_ltsw_vlan_egr_xlate_cfg_t *cfg);
 ...
 */
extern int
bcmi_ltsw_vlan_egr_xlate_delete(int unit, int port_class,
                                bcm_vlan_t outer_vlan,
                                bcm_vlan_t inner_vlan,
                                bcmi_ltsw_vlan_egr_xlate_cfg_t *cfg);
 ...
 */
extern int
bcmi_ltsw_vlan_egr_xlate_traverse(int unit,
 ...
 */
extern int
bcmi_ltsw_vlan_traverse(int unit, int ingress,
