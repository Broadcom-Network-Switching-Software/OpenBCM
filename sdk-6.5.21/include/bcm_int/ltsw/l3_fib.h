 ...
 * \brief L3 FIB info
 *
 * This data structure includes info of L3 FIB
 */
typedef struct bcmi_ltsw_l3_fib_info_s {
    /* Host v4 max. */
    uint32_t host_v4_max;

    /* Host v6 max. */
    uint32_t host_v6_max;

    /* Host v4 used. */
    uint32_t host_v4_used;

    /* Host v6 used. */
    uint32_t host_v6_used;
} bcmi_ltsw_l3_fib_info_t;
