...
/*!
 * \brief Set the redirection configuation for a trunk gport.
 *
 * \param [in] unit Unit Number.
 * \param [in] trunk_gport Trunk gport.
 * \param [in] redirect_config Redirection configuation.
 *
 * \retval SHR_E_NONE Success.
 * \retval SHR_E_INIT No Initialization.
 * \retval SHR_E_PARAM Invalid Parameter.
 ...
 */
extern int
bcmi_ltsw_trunk_redirect_config_set(
    int unit,
    bcm_gport_t trunk_gport,
    bcm_port_redirect_config_t *redirect_config);

/*!
 * \brief Get the redirection configuation for a trunk gport.
 *
 * \param [in] unit Unit Number.
 * \param [in] trunk_gport Trunk gport.
 * \param [out] redirect_config Redirection configuation.
 *
 * \retval SHR_E_NONE Success.
 * \retval SHR_E_INIT No Initialization.
 * \retval SHR_E_PARAM Invalid Parameter.
 ...
 */
extern int
bcmi_ltsw_trunk_redirect_config_get(
    int unit,
    bcm_gport_t trunk_gport,
    bcm_port_redirect_config_t *redirect_config);
