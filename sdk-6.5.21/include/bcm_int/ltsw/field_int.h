...
#define BCMINT_FIELD_EFP_KEYS  (15)
...
/*! Stage Flags */
#define BCMINT_FIELD_STAGE_COLOR_INDEPENDENT          (1 << 0)
...
#define BCMINT_FIELD_STAGE_FLEXSTAT_SINGLE_OBJ        (1 << 28)
#define BCMINT_FIELD_STAGE_ENTRY_COLOR_STAT_SUPPORT   (1 << 29)
#define BCMINT_FIELD_STAGE_HIT_INDEX_CTR_SUPPORT      (1 << 30)
#define BCMINT_FIELD_STAGE_SINGLE_LOOKUP_ONLY         (1 << 31)
...
#define BCMINT_FIELD_GROUP_AVOID_HW_INSTALL           (1 << 11)
#define BCMINT_FIELD_GROUP_FLEXCTR_VMAP_ENABLED       (1 << 12)
#define BCMINT_FIELD_GROUP_SHARED_POLICER_POOL        (1 << 13)
#define BCMINT_FIELD_GROUP_ENT_LEVEL_POLICER_POOL     (1 << 14)
#define BCMINT_FIELD_GROUP_DEFAULT_VSLICE_GRP_SET     (1 << 15)
...
/*! Entry Flags */
#define BCMINT_FIELD_ENTRY_COLOR_INDEPENDENT           (1 << 0)
...
#define BCMINT_FIELD_ENTRY_GPORT_TRUNK                 (1 << 31)
...
#define BCMINT_FIELD_ENTRY_ACTION_MCAST_COS                  (1 << 18)
#define BCMINT_FIELD_ENTRY_ACTION_RP_MCAST_COS               (1 << 19)
#define BCMINT_FIELD_ENTRY_ACTION_YP_MCAST_COS               (1 << 20)
#define BCMINT_FIELD_ENTRY_ACTION_UCAST_COS                  (1 << 21)
#define BCMINT_FIELD_ENTRY_ACTION_RP_UCAST_COS               (1 << 22)
#define BCMINT_FIELD_ENTRY_ACTION_YP_UCAST_COS               (1 << 23)
#define BCMINT_FIELD_ENTRY_ACTION_REDIRECT_IPMC_FLOW         (1 << 24)
#define BCMINT_FIELD_ENTRY_ACTION_VPN_VFI_SET                (1 << 25)
...
typedef struct bcmint_field_tbls_info_s {
    ...
    /* Group virtual slice FID */
    char *virtual_slice_grp_fid;
    /* Presel entry count */
    ...
    /* group template LTID oper Mode */
    char *grp_ltid_oper_mode_fid;
    ...
    /* Group info LT virtual slice count FID */
    char *group_info_virtual_slice_fid;
    /* compress config FID */
    char *compress_sid;
    /* compress config FID */
    ...
    /* Software flowtracker FID. */
    char *sw_flowtracker_fid;
    /* Flex Counter Action Count FID. */
    char *flexctr_action_count_fid;
    /* Flex Counter Action FID. */
    char *flexctr_action_fid;
    /* Action color independent FID. */
    char *action_color_independent_fid;
    /* Conflict table SID. */
    char *conflict_sid;
    /* Conflict table key FID. */
    char *conflict_key_fid;
...
typedef struct bcmint_field_color_action_tbls_info_s {
    ...
    /* Container ID used to reference each pool. */
    int  cont_id[BCM_FIELD_COLOR_ACTION_POOL_MAX];
...
typedef struct bcmint_field_stage_info_s {
    ...
    /*! Number of slices in a stage */
    uint8_t num_slices;

    /*! Number of entries in a slice */
    uint16_t slice_entry_count;

    /*! Physical to Virtual Slice mapping */
    int8_t *p2v_slice_mapping;

    /*! Color table full bitmap. */
    uint32_t color_pool_full_bmp[BCMINT_FIELD_MAX_PIPE];
...
typedef struct bcmint_field_compress_tbls_info_s {
    ...
    /* Direct Mapped L4SrcPort LT SID */
    char *direct_mapped_l4srcport_sid;

    /* Direct Mapped L4SrcPort LT Val */
    char *direct_val_l4srcport_fid;

    /* Direct Mapped L4SrcPort LT Mapped Val */
    char *direct_map_val_l4srcport_fid;

    /* Direct Mapped L4DstPort LT SID */
    char *direct_mapped_l4dstport_sid;

    /* Direct Mapped L4DstPort LT Val */
    char *direct_val_l4dstport_fid;

    /* Direct Mapped L4DstPort LT Mapped Val */
    char *direct_map_val_l4dstport_fid;
...
extern int
bcmint_field_presel_group_config_get(
    int unit,
    bcm_field_presel_group_config_t *group_config);
extern int
