...
/*!
 * \brief EGR_L3_TUNNEL_0 variant specific LT fields.
 */
typedef enum bcmint_flow_fld_egr_l3_tunnel_0_s {

    /*! Tunnel QoS remark control. */
    BCMINT_LTSW_FLOW_FLD_EGR_L3_TUNNEL_0_QOS_REMARK_CTRL = 0,

    /*! EGR_L3_TUNNEL_0 vairant specific LT field count. */
    BCMINT_LTSW_FLOW_FLD_EGR_L3_TUNNEL_0_FLD_CNT = 1

} bcmint_flow_fld_egr_l3_tunnel_0_t;

#define BCMINT_FLOW_FLD_EGR_L3_TUNNEL_0_STR \
{ \
    "QOS_REMARK_CTRL", \
    "FLD_CNT" \
}
...
typedef enum bcmint_flow_lt_id_s {
    ...
    /*! LT EGR_L3_TUNNEL_0. */
    BCMINT_LTSW_FLOW_LT_EGR_L3_TUNNEL_0 = 1,

    /*! FLOW variant specific LT count. */
    BCMINT_LTSW_FLOW_LT_CNT = 2
