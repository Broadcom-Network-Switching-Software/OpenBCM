...
typedef enum bcmi_ltsw_lb_hash_fields_select_s {
    ...
    /*! Hash 0 VXLAN L2 payload fields. */
    bcmiHash0FieldSelectTypeVxlanL2Payload = 9,

    /*! Hash 0 VXLAN L3 payload fields. */
    bcmiHash0FieldSelectTypeVxlanL3Payload = 10,

    /*! Hash 1 IPV4 fields. */
    bcmiHash1FieldSelectTypeIP = 11,

    /*! Hash 1 V4 TCP/UDP fields. */
    bcmiHash1FieldSelectTypeTcpUdp = 12,

    /*! Hash 1 V4 L4 source port and destination port fields. */
    bcmiHash1FieldSelectTypeL4Port = 13,

    /*! Hash 1 IPV6 fields. */
    bcmiHash1FieldSelectTypeIP6 = 14,

    /*! Hash 1 V6 TCP/UDP fields. */
    bcmiHash1FieldSelectTypeTcpUdpIp6 = 15,

    /*! Hash 1 V6 L4 source port and destination port fields. */
    bcmiHash1FieldSelectTypeL4PortIp6 = 16,

    /*! Hash 1 L2 fields. */
    bcmiHash1FieldSelectTypeL2 = 17,

    /*! Hash 1 L3 MPLS IP payload fields. */
    bcmiHash1FieldSelectTypeL3Mpls = 18,

    /*! Hash 1 MPLS transit fields. */
    bcmiHash1FieldSelectTypeMplsTransit = 19,

    /*! Hash 1 VXLAN L2 payload fields. */
    bcmiHash1FieldSelectTypeVxlanL2Payload = 20,

    /*! Hash 1 VXLAN L3 payload fields. */
    bcmiHash1FieldSelectTypeVxlanL3Payload = 21,
...
typedef enum bcmi_ltsw_lb_hash_bin_s {
    ...
    /*! Selections for CNTAG, RPID fields. */
    bcmiHashField0OverlayCntagRpidEnable = 7,

    /*! Selections for CNTAG, RPID fields. */
    bcmiHashField1OverlayCntagRpidEnable = 8,

    /* Selections for IPsec packets. */
    bcmiHashBinField0IPsec = 9,

    /* Selections for IPsec packets. */
    bcmiHashBinField1IPsec = 10,
...
/*!
 * \brief The hash tunnel fields select type.
 */
typedef enum bcmi_ltsw_lb_hash_tunnel_fields_select_s {

    /* Selections for VXLAN terminated packets. */
    bcmiHashTunnelField0VxlanTerm = 0,

    /* Selections for VXLAN terminated packets. */
    bcmiHashTunnelField1VxlanTerm = 1,


    /*! Hash tunnel fields select type count. */
    bcmiHashTunnelCount

} bcmi_ltsw_lb_hash_tunnel_fields_select_t;
...
/*!
 * \brief Set the hash tunnel fields selection.
 *
 * \param [in] unit Unit number.
 * \param [in] type The hash tunnel fields selection type.
 * \param [in] value The hash tunnel fields selection value.
 *
 * \retval SHR_E_NONE No errors.
 * \retval !SHR_E_NONE Failure.
 */
extern int
bcmi_ltsw_lb_hash_tunnel_fields_select_set(
    int unit,
    bcmi_ltsw_lb_hash_tunnel_fields_select_t type,
    int value);

/*!
 * \brief Get the hash tunnel fields selection.
 *
 * \param [in] unit Unit Number.
 * \param [in] type The hash tunnel fields selection type.
 * \param [out] value The hash tunnel fields selection value.
 *
 * \retval SHR_E_NONE No errors.
 * \retval !SHR_E_NONE Failure.
 */
extern int
bcmi_ltsw_lb_hash_tunnel_fields_select_get(
    int unit,
    bcmi_ltsw_lb_hash_tunnel_fields_select_t type,
    int *value);
