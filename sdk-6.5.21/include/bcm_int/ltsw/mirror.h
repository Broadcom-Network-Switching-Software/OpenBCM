...
/*! Ingress mirroring. */
#define BCMI_LTSW_MIRROR_INGRESS (1U << 0)

/*! Egress mirroring. */
#define BCMI_LTSW_MIRROR_EGRESS (1U << 1)

/*! Exact match mirroring. */
#define BCMI_LTSW_MIRROR_EM_FP (1U << 2)

/*! Flowtracker mirroring. */
#define BCMI_LTSW_MIRROR_EM_FT (1U << 3)

/*! Hardware learns and installs the entry without FP intervention. */
#define BCMI_LTSW_MIRROR_HW_LEARN_ENTRY (1U << 4)
