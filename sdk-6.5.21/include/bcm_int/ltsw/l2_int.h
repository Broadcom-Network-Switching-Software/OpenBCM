...
/*! L2 flexctr extended info for L2 hitbit. */
#define BCMINT_L2_SUB_COMP_ID_L2_FLEXCTR_EXT_INFO 6
...
/*! This flag indicates configure data to MY_STATION_2 tables. */
#define BCMINT_L2_STATION_2_TCAM 0x00000002
 ...
 */
typedef enum bcmint_l2_tbl_s {

    /*! L2 host table. */
    BCMINT_L2_HOST_TAB_ID = 0,

    /*! L2 my station table. */
    BCMINT_L2_MY_STATION_ID = 1,

    /*! L2 my station table. */
    BCMINT_L2_MY_STATION_TRUNK_ID = 2,

    /*! L2 my station table. */
    BCMINT_L2_MY_STATION_MODPORT_ID = 3,

    /*! L2 underlay my station table. */
    BCMINT_L2_UNDERLAY_MY_STATION_ID = 4,

    /*! L2 underlay my station table. */
    BCMINT_L2_UNDERLAY_MY_STATION_TRUNK_ID = 5,

    /*! L2 underlay my station table. */
    BCMINT_L2_UNDERLAY_MY_STATION_MODPORT_ID = 6,

    /*! L2 cache table. */
    BCMINT_L2_CACHE_ID = 7,

    /*! L2 dst block table. */
    BCMINT_L2_DST_BLOCK_ID = 8,

    /*! L2 learn cache table. */
    BCMINT_L2_LEARN_DATA_ID = 9,

    /*! L2 learn control table. */
    BCMINT_L2_LEARN_CTRL_ID = 10,

    /*! L2 opaque tag table. */
    BCMINT_L2_OPAQUE_TAG_ID = 11,

    /*! L2 learn override table. */
    BCMINT_L2_LEARN_OVERRIDE_ID = 12,

    /*! L2 payload opaque tag table. */
    BCMINT_L2_PAYLOAD_OPAQUE_TAG_ID = 13,

    /*! Number of L2 table. */
    BCMINT_L2_MAX_NUM = 14

} bcmint_l2_tbl_t;

#define BCMINT_L2_TBL_STR \
{ \
    "HOST_TAB_ID", \
    "MY_STATION_ID", \
    "MY_STATION_TRUNK_ID", \
...
/*!
 * \brief L2 control infomation.
 */
typedef struct bcmint_l2_ctrl_info_s {

    /*! Indicate the ECMP_MEMBER bit offset of MISC_CTRL_0 is valid. */
    bool misc_ctrl_0_ecmp_member_is_valid;

} bcmint_l2_ctrl_info_t;
