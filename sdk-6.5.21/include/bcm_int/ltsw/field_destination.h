 ...
 *
 * Field destination headfiles to declare internal APIs for ltsw devices.
 */
/*
...
#ifndef BCMI_LTSW_FIELD_DESTINATION_H
#define BCMI_LTSW_FIELD_DESTINATION_H
/*!
 * \brief Field destination init.
 *
 ...
 * \param [in] unit              Unit number.
 * \param [in] match             Match info.
 * \param [in] ctr_id            Statistic counter ID.
 *
 * \retval SHR_E_NONE            No errors.
 * \retval !SHR_E_NONE           Failure.
 */
...
/*!
 * \brief Get the counter ID of a flex counter attached to
 *        the given field destination entry.
 *
 * \param [in] unit              Unit number.
 * \param [in] match             Match info.
 * \param [out] ctr_id           Counter ID.
 *
 * \retval SHR_E_NONE            No errors.
 * \retval !SHR_E_NONE           Failure.
 */
...
#endif /* BCMI_LTSW_FIELD_DESTINATION_H */
