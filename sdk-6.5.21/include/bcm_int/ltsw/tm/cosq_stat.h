 ...
 * \param [in] cosq COS queue.
 * \param [in] sync_mode sync mode.
 * \param [out] pkt Feature value.
 * \param [out] byte Feature value.
 * \param [out] red_pkt Feature value.
 * \param [out] yellow_pkt Feature value.
 *
 * \retval SHR_E_NONE No errors.
 * \retval !SHR_E_NONE Failure.
 */
 ...
 * \param [in] gport GPORT ID.
 * \param [in] cosq COS queue.
 * \param [out] min Feature value.
 * \param [out] shared Feature value.
 * \param [out] total Feature value.
 *
 * \retval SHR_E_NONE No errors.
 * \retval !SHR_E_NONE Failure.
 */
 ...
 * \param [in] gport GPORT ID.
 * \param [in] cosq COS queue.
 * \param [in] uc_pkt Feature value.
 * \param [in] mc_pkt Feature value.
 *
 * \retval SHR_E_NONE No errors.
 * \retval !SHR_E_NONE Failure.
 */
 ...
 * \param [in] stat Feature.
 * \param [in] sync_mode sync mode.
 * \param [out] uc_red_pkt Feature value.
 * \param [out] uc_yellow_pkt Feature value.
 * \param [out] mc_red_pkt Feature value.
 * \param [out] mc_yellow_pkt Feature value.
 * \param [out] wred_red_pkt Feature value.
 * \param [out] wred_yellow_pkt Feature value.
 * \param [out] wred_pkt Feature value.
 *
 * \retval SHR_E_NONE No errors.
 * \retval !SHR_E_NONE Failure.
 */
...
tm_ltsw_cosq_stat_port_queue_color_drop_get(
    ...
    bcm_cos_queue_t cosq,
    uint64_t *uc_red_pkt,
    uint64_t *uc_yellow_pkt,
    uint64_t *mc_red_pkt,
    uint64_t *mc_yellow_pkt,
    uint64_t *wred_red_pkt,
    uint64_t *wred_yellow_pkt,
    uint64_t *wred_pkt,
    int sync);
 ...
 * \param [out] min Feature value.
 * \param [out] shared Feature value.
 * \param [out] headroom Feature value.
 *
 * \retval SHR_E_NONE No errors.
 * \retval !SHR_E_NONE Failure.
 */
