...
/*
 * Do not change these values as this can affect ISSU.
 * This number is used to calculate the preious structure size
 * during an ISSU upgrade.
 */
#define FP_HA_DYNAMIC_BLK_NUM_ELEMENTS(_u_, _p, _blk_type, _num_elem)         \
    {                                                                         \
        switch (_blk_type) {                                                  \
