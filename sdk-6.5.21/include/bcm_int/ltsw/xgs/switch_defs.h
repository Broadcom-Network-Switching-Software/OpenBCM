...
#define SC_FUNC_LIST \
    ...
    SC_FUNC(bcmSwitchHashUseFlowSelEcmpDynamic), \
    ...
    SC_FUNC(bcmSwitchHashIPSecSelect0), \
    SC_FUNC(bcmSwitchHashIPSecSelect1), \
    SC_FUNC(bcmSwitchHashL2VxlanField0), \
    SC_FUNC(bcmSwitchHashL2VxlanField1), \
    SC_FUNC(bcmSwitchHashL3VxlanField0), \
    SC_FUNC(bcmSwitchHashL3VxlanField1), \
    SC_FUNC(bcmSwitchHashVxlanPayloadSelect0), \
    SC_FUNC(bcmSwitchHashVxlanPayloadSelect1), \
    ...
    SC_FUNC(bcmSwitchIngParseL2TunnelTermRarp), \
    SC_FUNC(bcmSwitchIngParseL2TunnelTermArp), \
    SC_FUNC(bcmSwitchTimesyncUnknownVersionToCpu), \
    ...
    SC_FUNC(bcmSwitchFlowCountStatAttach), \
    SC_FUNC(bcmSwitchPcieHotSwapDisable), \
...
#define SC_VALUE_CONTROLS \
    ...
    {bcmSwitchFlowCountHashMask, \
        ...
        sc_bcmSwitchFlowCountHashMask_encode, sc_bcmSwitchFlowCountHashMask_decode}, \
    {bcmSwitchFlowCountPortContextHashShift, \
        FALSE, MON_FLOWCOUNT_CONTROLs, PORT_CONTEXT_SHIFTs, \
        NULL, NULL}, \
    {bcmSwitchFlowCountPortContextHashMask, \
        FALSE, MON_FLOWCOUNT_CONTROLs, PORT_CONTEXT_MASKs, \
        NULL, NULL}, \
...
#define SC_SYMBOL_CONTROLS \
    {bcmSwitchFlowCountPortContextSelect, \
        FALSE, MON_FLOWCOUNT_CONTROLs, PORT_CONTEXT_SELECTs, \
        port_context_select_map}, \
