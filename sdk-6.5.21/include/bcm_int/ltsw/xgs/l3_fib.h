 ...
 * \param [in] data_type ALPM data type.
 *
 * \retval SHR_E_NONE No errors.
 * \retval !SHR_E_NONE Failure.
 */
...
/*!
 * \brief Age on L3 host table, clear HIT bit of entry if set.
 *
 * \param [in] unit Unit number.
 * \param [in] age_out User supplied callback function.
 * \param [in] user_data  User provided cookie for callback.
...
/*!
 * \brief Get L3 FIB info.
 *
 * \param [in] unit Unit Number.
 * \param [out] fib L3 FIB info.
 *
 * \retval SHR_E_NONE No errors.
 * \retval !SHR_E_NONE Failure.
 */
...
/*!
 * \brief Dump L3 fib module sw information.
 *
 * \param [in] unit Unit Number.
 *
 * \retval SHR_E_NONE No errors.
...
/*!
 * \brief Attach flexctr action to the given L3 host entry.
 *
 * \param [in] unit Unit number.
 * \param [in] fib L3 host info.
 * \param [in] info Flex counter information.
 *
 * \retval SHR_E_NONE No errors.
 */
...
/*!
 * \brief Detach flexctr action of the given L3 host entry.
 *
 * \param [in] unit Unit number.
 * \param [in] fib L3 host info.
 *
 ...
 */
extern int
xgs_ltsw_l3_host_flexctr_detach(
    int unit,
    bcmi_ltsw_l3_fib_t *fib);

/*!
 * \brief Get flex counter information of the given L3 host entry.
 *
 * \param [in] unit Unit number.
 * \param [in] fib L3 host info.
 * \param [out] info Flex counter information.
...
/*!
 * \brief Set flex counter object value for the given L3 host entry.
 *
 * \param [in] unit Unit number.
 * \param [in] fib L3 host info.
 * \param [in] value The flex counter object value.
...
/*!
 * \brief Get flex counter object value for the given L3 host entry.
 *
 * \param [in] unit Unit Number.
 * \param [in] fib L3 host info.
 * \param [out] value The flex counter object value.
