 ...
 * \brief QOS LT id.
 */
typedef enum bcmint_qos_lt_id_s {

    /*! QoS PHB_EGR_L2_ADAPT_INT_PRI_TO_OTAG table. */
    BCMINT_LTSW_QOS_LT_PHB_EGR_L2_ADAPT_INT_PRI_TO_OTAG = 0

} bcmint_qos_lt_id_t;

#define BCMINT_QOS_LT_ID_STR \
{ \
    "PHB_EGR_L2_ADAPT_INT_PRI_TO_OTAG" \
}

/*!
 * \brief PHB_EGR_L2_ADAPT_INT_PRI_TO_OTAG LT fields.
 */
typedef enum bcmint_qos_field_phb_egr_l2_adapt_int_pri_to_otag_s {

    /*! ID. */
    BCMINT_LTSW_QOS_FLD_PHB_EGR_L2_ADAPT_INT_PRI_TO_OTAG_ID = 0,

    /*! INT_PRI. */
    BCMINT_LTSW_QOS_FLD_PHB_EGR_L2_ADAPT_INT_PRI_TO_OTAG_INT_PRI = 1,

    /*! CNG. */
    BCMINT_LTSW_QOS_FLD_PHB_EGR_L2_ADAPT_INT_PRI_TO_OTAG_CNG = 2,

    /*! PRI. */
    BCMINT_LTSW_QOS_FLD_PHB_EGR_L2_ADAPT_INT_PRI_TO_OTAG_PRI = 3,

    /*! CFI. */
    BCMINT_LTSW_QOS_FLD_PHB_EGR_L2_ADAPT_INT_PRI_TO_OTAG_CFI = 4

} bcmint_qos_field_phb_egr_l2_adapt_int_pri_to_otag_t;

#define BCMINT_QOS_FIELD_PHB_EGR_L2_ADAPT_INT_PRI_TO_OTAG_STR \
{ \
    "ID", \
    "INT_PRI", \
    "CNG", \
...
/*!
 * \brief QoS LT field description.
 */
typedef struct bcmint_qos_fld_s {
...
/*!
 * \brief QoS LT description.
 */
typedef struct bcmint_qos_lt_s {
 ...
 * \brief QoS LT description.
 */
typedef struct bcmint_qos_lt_db_s {

    /*! LT bitmap. */
    uint32_t lt_bmp;

    /*! LT array. */
    const bcmint_qos_lt_t *lts;
 ...
 * \param [in] lt_id QoS LT ID.
 * \param [out] lt_info QoS LT info.
 *
...
bcmint_qos_lt_get(
    int unit,
    bcmint_qos_lt_id_t lt_id,
    const bcmint_qos_lt_t **lt_info);
