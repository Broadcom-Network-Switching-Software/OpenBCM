...
/* ECMP load-balance mode. */
typedef enum xfs_ltsw_l3_ecmp_lb_mode_e {
    XFS_LTSW_L3_ECMP_LB_MODE_REGULAR = 0,
    XFS_LTSW_L3_ECMP_LB_MODE_RANDOM = 1,
    XFS_LTSW_L3_ECMP_LB_MODE_CNT
} xfs_ltsw_l3_ecmp_lb_mode_t;

/* Weighted ECMP group size enum definition. */
typedef enum xfs_ltsw_l3_ecmp_wgt_sz_e {
    XFS_LTSW_L3_ECMP_WGT_SZ_256 = 0,
    XFS_LTSW_L3_ECMP_WGT_SZ_512 = 1,
    XFS_LTSW_L3_ECMP_WGT_SZ_1K = 2,
    XFS_LTSW_L3_ECMP_WGT_SZ_2K = 3,
    XFS_LTSW_L3_ECMP_WGT_SZ_4K = 4,
    XFS_LTSW_L3_ECMP_WGT_SZ_8K = 5,
    XFS_LTSW_L3_ECMP_WGT_SZ_16K = 6,
    XFS_LTSW_L3_ECMP_WGT_SZ_CNT
} xfs_ltsw_l3_ecmp_wgt_sz_t;

/* Weighted ECMP group mode. */
typedef enum xfs_ltsw_l3_ecmp_wgt_mode_e {
    XFS_LTSW_L3_ECMP_MEMBER_REPLICATION = 0,
    XFS_LTSW_L3_ECMP_MEMBER_WEIGHTED = 1,
    XFS_LTSW_L3_ECMP_MEMBER_WEIGHT_MODE_CNT
} xfs_ltsw_l3_ecmp_wgt_mode_t;

/* ECMP field ID. */
typedef enum xfs_ltsw_l3_ecmp_fld_e {
    ...
    XFS_LTSW_L3_ECMP_TBL_FLD_CNT
} xfs_ltsw_l3_ecmp_fld_t;

/* Source ECMP field ID. */
typedef enum xfs_ltsw_l3_secmp_fld_e {
    ...
    XFS_LTSW_L3_SECMP_TBL_FLD_CNT
} xfs_ltsw_l3_secmp_fld_t;
