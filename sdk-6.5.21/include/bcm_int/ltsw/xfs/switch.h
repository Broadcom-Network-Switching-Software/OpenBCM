...
/*!
 * \brief Convert a drop event enum value to Logical Table symbol string.
 *
 * \param [in] unit Unit number.
...
/*!
 * \brief Convert a trace event enum value to Logical Table symbol string.
 *
 * \param [in] unit Unit number.
...
/*!
 * \brief Convert an EP Recirculate drop event enum value to Logical Table symbol string.
 *
 * \param [in] unit Unit number.
 * \param [in] drop_event Drop event enum value.
 * \param [out] symbol Logical Table symbol string.
...
bcmint_xfs_switch_ep_recirc_drop_event_to_symbol(int unit,
                                                 ...
                                                 const char **symbol);
/*!
 * \brief Convert an EP Recirculate Logical Table symbol string to drop event enum value.
 *
 * \param [in] unit Unit number.
 * \param [in] symbol Logical Table symbol string.
 * \param [out] drop_event Drop event enum value.
 *
 * \retval SHR_E_NONE Success.
 * \retval !SHR_E_NONE Failure.
 */
 ...
 */
extern int
bcmint_xfs_switch_ep_recirc_drop_event_to_drop_code(int unit,
                                                    bcm_pkt_drop_event_t drop_event,
                                                    int *drop_code);
