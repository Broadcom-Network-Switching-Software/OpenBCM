 ...
 */
extern int
xfs_ltsw_l3_host_ipv4_mc_flexctr_object_set(
    int unit,
	bcmi_ltsw_l3_fib_t *fib,
    uint32_t value);
 ...
 */
extern int
xfs_ltsw_l3_host_ipv4_mc_flexctr_object_get(
    int unit,
    bcmi_ltsw_l3_fib_t *fib,
    uint32_t *value);
 ...
 */
extern int
xfs_ltsw_l3_host_ipv6_mc_flexctr_object_set(
    int unit,
	bcmi_ltsw_l3_fib_t *fib,
    uint32_t value);
 ...
 */
extern int
xfs_ltsw_l3_host_ipv6_mc_flexctr_object_get(
    int unit,
    bcmi_ltsw_l3_fib_t *fib,
    uint32_t *value);
 ...
 */
extern int
xfs_ltsw_l3_route_ipv4_mc_flexctr_object_set(
    int unit,
	bcmi_ltsw_l3_fib_t *fib,
    uint32_t value);
 ...
 */
extern int
xfs_ltsw_l3_route_ipv4_mc_flexctr_object_get(
    int unit,
    bcmi_ltsw_l3_fib_t *fib,
    uint32_t *value);
 ...
 */
extern int
xfs_ltsw_l3_route_ipv6_mc_flexctr_object_set(
    int unit,
	bcmi_ltsw_l3_fib_t *fib,
    uint32_t value);
 ...
 */
extern int
xfs_ltsw_l3_route_ipv6_mc_flexctr_object_get(
    int unit,
    bcmi_ltsw_l3_fib_t *fib,
    uint32_t *value);
