...
/*! Ingress counter block sub component id. */
#define BCMINT_FLEXCTR_ING_BLOCK_SUB_COMP_ID (10)

/*! Egress counter block sub component id. */
#define BCMINT_FLEXCTR_EGR_BLOCK_SUB_COMP_ID (11)
