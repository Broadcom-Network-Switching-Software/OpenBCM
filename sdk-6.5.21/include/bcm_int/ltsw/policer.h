...
/*! Pool is shared between groups. */
#define BCMI_LTSW_POLICER_POOL_MODE_SHARED          (2)
/*! Pool is fixed pool (not auto-expanded) for the group. */
#define BCMI_LTSW_POLICER_POOL_MODE_FIXED           (4)
/*! Pool has been auto-expanded. */
#define BCMI_LTSW_POLICER_POOL_MODE_AUTO_EXPAND     (8)
...
/*! Global pool allocation modes. */
/*! Pool allocation done by HSDK internally. */
#define BCMI_LTSW_POLICER_ALLOC_MODE_DYNAMIC        (1 << 0)
/*! Pool allocation managed by user. */
#define BCMI_LTSW_POLICER_ALLOC_MODE_USER           (1 << 1)

/*! Stage flags. */
/*! Stage supports BCM_POLICER_WITH_SHARED_POOL_ID flag. */
#define BCMI_LTSW_POLICER_STAGE_SUPPORT_SHARED_POOL_ID  (1 << 0)
...
extern int
bcmi_ltsw_max_policer_entries_get(int unit,
                                  int stage,
                                  int *max_entries);
