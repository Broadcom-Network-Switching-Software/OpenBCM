...
/*!
 * \brief get the flow port with the creteria and match port.
 *
 * \param [in] unit Unit Number.
 * \param [in] criteria Flow match criteria.
 * \param [in] match_port Flow match port.
 * \param [in] vp_id Pointer of flow gport ID.
 *
 * \retval SHR_E_NONE No errors.
 * \retval SHR_E_UNAVAIL Feature unavailable.
 * \retval SHR_E_INIT Flow un-init.
 * \retval SHR_E_NOT_FOUND Entry not found.
 * \retval !SHR_E_NONE Other failure.
 */
extern int
