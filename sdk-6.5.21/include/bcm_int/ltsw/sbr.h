...
typedef enum bcmi_ltsw_sbr_profile_tbl_hdl_e {
    ...
    /*! L3_IPV4_ALPM_STRENGTH_PROFILE_MTOP. */
    BCMI_LTSW_SBR_PTH_L3_IPV4_ALPM_MTOP = 53,

    /*! L3_IPV6_ALPM_STRENGTH_PROFILE_MTOP. */
    BCMI_LTSW_SBR_PTH_L3_IPV6_ALPM_MTOP = 54,

    /*! L2_IPV4_MULTICAST_WIDE_STRENGTH_PROFILE. */
    BCMI_LTSW_SBR_PTH_L2_IPV4_MULTICAST_WIDE = 55,
...
{ \
    ...
    "BCMI_LTSW_SBR_PTH_L3_IPV4_ALPM_MTOP", \
    "BCMI_LTSW_SBR_PTH_L3_IPV6_ALPM_MTOP", \
...
typedef enum bcmi_ltsw_sbr_profile_ent_type_e {
    ...
    BCMI_LTSW_SBR_PET_NO_QOS_REMARK = 26,

    BCMI_LTSW_SBR_PET_ALPM_GL = 27,

    BCMI_LTSW_SBR_PET_ALPM_VRF = 28,

    BCMI_LTSW_SBR_PET_ALPM_GH = 29,
...
{ \
    ...
    "BCMI_LTSW_SBR_PET_NO_QOS_REMARK", \
    "BCMI_LTSW_SBR_PET_ALPM_GL", \
    "BCMI_LTSW_SBR_PET_ALPM_VRF", \
    "BCMI_LTSW_SBR_PET_ALPM_GH" \
}
