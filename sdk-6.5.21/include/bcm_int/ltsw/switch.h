 ...
 *
 * \param [in] unit Unit number.
 * \param [out] mirror_inst_id_array Mirror instance ids.
 *
 * \retval SHR_E_NONE Success.
 * \retval !SHR_E_NONE Failure.
 */
extern int
bcmi_ltsw_switch_ep_recirc_profile_mirror_instance_get_all(int unit,
 ...
 */
extern int
bcmi_ltsw_switch_ep_recirc_profile_num_get(int unit, int *num);
