...
/*!
 * \brief Initialize L2 control info.
 *
 * \param [in] unit Unit Number.
 * \param [out] l2_ctrl L2 control info.
 *
 * \retval SHR_E_NONE No errors.
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*l2_ctrl_info_init_f)(
    int unit,
...
typedef struct mbcm_ltsw_l2_drv_s {
    ...
    /*! Initialize L2 control info. */
    l2_ctrl_info_init_f l2_ctrl_info_init;
