...
*/
typedef int (*l3_host_age_f)(int unit, bcm_l3_host_traverse_cb age_out,
                             void *user_data);
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*l3_fib_sw_dump_f)(int unit);
 ...
 * \retval SHR_E_NONE No errors.
 */
typedef int (*l3_host_flexctr_attach_f)(
    int unit,
    bcmi_ltsw_l3_fib_t *fib,
    bcmi_ltsw_flexctr_counter_info_t *info);
 ...
 * \retval SHR_E_NONE No errors.
 */
typedef int (*l3_host_flexctr_detach_f)(
    int unit,
    bcmi_ltsw_l3_fib_t *fib);
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*l3_host_flexctr_info_get_f)(
    int unit,
    bcmi_ltsw_l3_fib_t *fib,
    bcmi_ltsw_flexctr_counter_info_t *info);
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*l3_host_flexctr_object_set_f)(
    int unit,
    bcmi_ltsw_l3_fib_t *fib,
    uint32_t value);
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*l3_host_flexctr_object_get_f)(
    int unit,
    bcmi_ltsw_l3_fib_t *fib,
    uint32_t *value);
...
typedef struct mbcm_ltsw_l3_fib_drv_s {
    ...
    /*! Set flex counter object value for the given IPv4 multicast entry. */
    l3_mc_flexctr_object_set_f l3_host_ipv4_mc_flexctr_object_set;

    /*! Get flex counter object value for the given IPv4 multicast entry. */
    l3_mc_flexctr_object_get_f l3_host_ipv4_mc_flexctr_object_get;
    ...
    /*! Set flex counter object value for the given IPv6 multicast entry. */
    l3_mc_flexctr_object_set_f l3_host_ipv6_mc_flexctr_object_set;

    /*! Get flex counter object value for the given IPv6 multicast entry. */
    l3_mc_flexctr_object_get_f l3_host_ipv6_mc_flexctr_object_get;
    ...
    /*! Set flex counter object value for the given IPv4 multicast entry. */
    l3_mc_flexctr_object_set_f l3_route_ipv4_mc_flexctr_object_set;

    /*! Get flex counter object value for the given IPv4 multicast entry. */
    l3_mc_flexctr_object_get_f l3_route_ipv4_mc_flexctr_object_get;
    ...
    /*! Set flex counter object value for the given IPv6 multicast entry. */
    l3_mc_flexctr_object_set_f l3_route_ipv6_mc_flexctr_object_set;

    /*! Get flex counter object value for the given IPv6 multicast entry. */
    l3_mc_flexctr_object_get_f l3_route_ipv6_mc_flexctr_object_get;
    ...
    /* L3 FIB info get. */
    l3_fib_info_get_f l3_fib_info_get;
    ...
    /*! Dump sw information. */
    l3_fib_sw_dump_f l3_fib_sw_dump;

    l3_host_flexctr_attach_f l3_host_flexctr_attach;

    /* Detach L3 host flex counter. */
    l3_host_flexctr_detach_f l3_host_flexctr_detach;

    /* Get L3 host flex counter info. */
    l3_host_flexctr_info_get_f l3_host_flexctr_info_get;

    /* Set L3 host flex counter object value. */
    l3_host_flexctr_object_set_f l3_host_flexctr_object_set;

    /* Get L3 host flex counter object value. */
    l3_host_flexctr_object_get_f l3_host_flexctr_object_get;
...
/*!
 * \brief Set flex counter object value for the given IPv4 multicast entry.
 *
 * \param [in] unit Unit number.
 * \param [in] fib L3 route info.
 * \param [in] value The flex counter object value.
 ...
 */
extern int
mbcm_ltsw_l3_host_ipv4_mc_flexctr_object_set(
    int unit,
	bcmi_ltsw_l3_fib_t *fib,
    uint32_t value);

/*!
 * \brief Get flex counter object value for the given IPv4 multicast entry.
 *
 * \param [in] unit Unit Number.
 * \param [in] fib L3 route info.
 * \param [out] value The flex counter object value.
 ...
 */
extern int
mbcm_ltsw_l3_host_ipv4_mc_flexctr_object_get(
    int unit,
    bcmi_ltsw_l3_fib_t *fib,
    uint32_t *value);
...
/*!
 * \brief Set flex counter object value for the given IPv6 multicast entry.
 *
 * \param [in] unit Unit number.
 * \param [in] fib L3 route info.
 * \param [in] value The flex counter object value.
 ...
 */
extern int
mbcm_ltsw_l3_host_ipv6_mc_flexctr_object_set(
    int unit,
	bcmi_ltsw_l3_fib_t *fib,
    uint32_t value);

/*!
 * \brief Get flex counter object value for the given IPv6 multicast entry.
 *
 * \param [in] unit Unit Number.
 * \param [in] fib L3 route info.
 * \param [out] value The flex counter object value.
 ...
 */
extern int
mbcm_ltsw_l3_host_ipv6_mc_flexctr_object_get(
    int unit,
    bcmi_ltsw_l3_fib_t *fib,
    uint32_t *value);
 ...
 */
extern int
mbcm_ltsw_l3_route_ipv4_mc_flexctr_object_set(
    int unit,
	bcmi_ltsw_l3_fib_t *fib,
    uint32_t value);
 ...
 */
extern int
mbcm_ltsw_l3_route_ipv4_mc_flexctr_object_get(
    int unit,
    bcmi_ltsw_l3_fib_t *fib,
    uint32_t *value);
 ...
 */
extern int
mbcm_ltsw_l3_route_ipv6_mc_flexctr_object_set(
    int unit,
	bcmi_ltsw_l3_fib_t *fib,
    uint32_t value);
 ...
 */
extern int
mbcm_ltsw_l3_route_ipv6_mc_flexctr_object_get(
    int unit,
    bcmi_ltsw_l3_fib_t *fib,
    uint32_t *value);
