...
/*!
 * \brief Get the flex counter object value associated to MPLS tunnel initiator on a given L3 interface.
 *
 * \param [in] unit Unit Number.
 * \param [in] intf The egress L3 interface.
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*mpls_tnl_initiator_flexctr_object_get_f)(
    int unit,
    bcm_if_t intf,
    uint32_t *value);
...
typedef struct mbcm_ltsw_mpls_drv_s {
    ...
    /*! Get the flex counter object value associated to MPLS tunnel initiator on a given L3 interface. */
    mpls_tnl_initiator_flexctr_object_get_f mpls_tnl_initiator_flexctr_object_get;
