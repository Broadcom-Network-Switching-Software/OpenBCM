 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*port_color_mode_set_f)(
    int unit,
    bcm_port_t port,
    int color_select);
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*port_color_mode_get_f)(
    int unit,
    bcm_port_t port,
    int *color_select);
...
typedef struct mbcm_ltsw_port_drv_s {
    ...
    /*! Choose color mode. */
    port_color_mode_set_f port_color_mode_set;

    /*! Get color mode. */
    port_color_mode_get_f port_color_mode_get;
