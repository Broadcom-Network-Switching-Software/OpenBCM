...
/*!
 * \brief Set the redirection configuration for a trunk ID.
 *
 * \param [in] unit Unit Number.
 * \param [in] src_tid Redirection source Trunk Identifier.
 * \param [in] src_info Redirection source Trunk Information.
 * \param [in] dst_tid redirection destination Trunk Identifier.
 * \param [in] dst_info Redirection detination Trunk Information.
 *
 * \retval SHR_E_NONE No errors.
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*trunk_redirect_config_set_f)(
    int unit,
    bcmint_trunk_id_t src_tid,
    bcmint_trunk_info_t *src_info,
    bcmint_trunk_id_t dst_tid,
    bcmint_trunk_info_t *dst_info);

/*!
 * \brief Get the redirection configuration for a trunk ID.
 *
 * \param [in] unit Unit Number.
 * \param [in] src_tid Redirection source Trunk Identifier.
 * \param [in] src_info Redirection source Trunk Information.
 * \param [out] dst_tid redirection destination Trunk Identifier.
 *
 * \retval SHR_E_NONE No errors.
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*trunk_redirect_config_get_f)(
    int unit,
    bcmint_trunk_id_t src_tid,
    bcmint_trunk_info_t *src_info,
    bcmint_trunk_id_t *dst_tid);
...
typedef struct mbcm_ltsw_trunk_drv_s {
    ...
    /*! Set the redirection configuration for a trunk ID. */
    trunk_redirect_config_set_f trunk_redirect_config_set;

    /*! Get the redirection configuration for a trunk ID. */
    trunk_redirect_config_get_f trunk_redirect_config_get;
 ...
 */
extern int
mbcm_ltsw_trunk_redirect_config_set(
    int unit,
    bcmint_trunk_id_t src_tid,
    bcmint_trunk_info_t *src_info,
    bcmint_trunk_id_t dst_tid,
 ...
 */
extern int
mbcm_ltsw_trunk_redirect_config_get(
    int unit,
    bcmint_trunk_id_t src_tid,
    bcmint_trunk_info_t *src_info,
    bcmint_trunk_id_t *dst_tid);
