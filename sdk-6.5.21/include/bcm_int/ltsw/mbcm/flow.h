 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*flow_match_trunk_member_delete_f)(
    int unit,
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*flow_port_encap_l3_ecmp_notify_f)(
    int unit,
...
/*!
 * \brief Detach counter entries from the given flow VPN with a given stat counter id.
 *
 * \param [in] unit Unit Number.
 * \param [in] vpn VPN Instance.
 * \param [in] stat_counter_id Stat counter ID.
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*flow_vpn_stat_detach_with_id_f)(
    int unit,
    bcm_vpn_t vpn,
    uint32_t stat_counter_id);
...
/*!
 * \brief Detach counter entries from the given flow port with a given stat counter id.
 *
 * \param [in] unit Unit Number.
 * \param [in] flow_port_id GPORT identifier.
 * \param [in] stat_counter_id Stat counter ID.
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*flow_port_stat_detach_with_id_f)(
    int unit,
    bcm_gport_t flow_port_id,
    uint32_t stat_counter_id);
...
/*!
 * \brief Get the flex counter object value associated to the flow tunnel initiator.
 *
 * \param [in] unit Unit Number.
 * \param [in] tunnel_id Flow tunnel initiator object ID.
 * \param [in] value The flex counter object value.
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*flow_tunnel_initiator_flexctr_object_get_f)(
    int unit,
    bcm_gport_t tunnel_id,
    uint32_t *value);
...
typedef struct mbcm_ltsw_flow_drv_s {
    ...
    /*! Synchronize flow match when deleting members in the match trunk port. */
    flow_match_trunk_member_delete_f flow_match_trunk_member_delete;
    ...
    /*! Notify the egress ECMP changes to update VP attributes. */
    flow_port_encap_l3_ecmp_notify_f flow_port_encap_l3_ecmp_notify;
    ...
    /*! Detach counter entries from the given flow VPN with a given stat counter id. */
    flow_vpn_stat_detach_with_id_f flow_vpn_stat_detach_with_id;
    ...
    /*! Detach counter entries from the given flow port with a given stat counter id. */
    flow_port_stat_detach_with_id_f flow_port_stat_detach_with_id;
    ...
    /*! Get the flex counter object value associated to the flow tunnel initiator. */
    flow_tunnel_initiator_flexctr_object_get_f flow_tunnel_initiator_flexctr_object_get;
 ...
 */
extern int
mbcm_ltsw_flow_vpn_stat_detach_with_id(
    int unit,
    bcm_vpn_t vpn,
    uint32_t stat_counter_id);
 ...
 */
extern int
mbcm_ltsw_flow_port_stat_detach_with_id(
    int unit,
    bcm_gport_t flow_port_id,
    uint32_t stat_counter_id);
 ...
 */
extern int
mbcm_ltsw_flow_tunnel_initiator_flexctr_object_get(
    int unit,
    bcm_gport_t tunnel_id,
    uint32_t *value);
