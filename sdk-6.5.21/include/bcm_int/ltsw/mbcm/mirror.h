...
/*!
 * \brief Set the specified statistic of mirror sample counter.
 *
 * \param [in] unit Unit Number.
 * \param [in] profile_id Sample profile id.
 * \param [in] type Statistic type.
 * \param [in] value Counter value.
 *
 * \retval SHR_E_NONE No errors.
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*mirror_sample_stat_set_f)(
    int unit,
    int profile_id,
...
/*!
 * \brief Get the specified statistic of mirror sample counter.
 *
 * \param [in] unit Unit Number.
 * \param [in] profile_id Sample profile id.
 * \param [in] type Statistic type.
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*mirror_sample_stat_get_f)(
    int unit,
    int profile_id,
    bcm_mirror_sample_stat_type_t type,
    uint64_t *value);
...
typedef struct mbcm_ltsw_mirror_drv_s {
    ...
    /*! Set the specified statistic of mirror sample counter. */
    mirror_sample_stat_set_f mirror_sample_stat_set;

    /*! Get the specified statistic of mirror sample counter. */
    mirror_sample_stat_get_f mirror_sample_stat_get;
