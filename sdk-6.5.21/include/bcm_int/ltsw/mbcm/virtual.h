 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*virtual_qos_port_map_set_f)(
    int unit,
    bcm_gport_t port,
    int ing_map,
    int egr_map);
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*virtual_qos_port_map_type_get_f)(
    int unit,
    bcm_gport_t port,
    uint32_t flags,
    int *map_id);
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*virtual_port_egress_adapt_key_sync_status_get_f)(
    int unit,
    int *sync_required);
...
typedef struct mbcm_ltsw_virtual_drv_s {
    ...
    /*! QoS maps */
    virtual_qos_port_map_set_f         virtual_qos_port_map_set;
    virtual_qos_port_map_type_get_f    virtual_qos_port_map_type_get;

    /*! Egress adapt */
    virtual_port_egress_adapt_key_sync_status_get_f    virtual_port_egress_adapt_key_sync_status_get;
 ...
 */
extern int
mbcm_virtual_qos_port_map_type_get(
    int unit,
    bcm_gport_t port,
    uint32_t flags,
    int *map_id);
 ...
 */
extern int
mbcm_virtual_port_egress_adapt_key_sync_status_get(
    int unit,
    int *sync_required);
