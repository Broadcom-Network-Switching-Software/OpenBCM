 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*lb_hash_tunnel_fields_select_set_f)(
    int unit,
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*lb_hash_tunnel_fields_select_get_f)(
    int unit,
    bcmi_ltsw_lb_hash_tunnel_fields_select_t type,
    int *value);
...
typedef struct mbcm_ltsw_lb_hash_drv_s {
    ...
    /*! Set the hash tunnel fields selection */
    lb_hash_tunnel_fields_select_set_f lb_hash_tunnel_fields_select_set;

    /*! Get the hash tunnel fields selection */
    lb_hash_tunnel_fields_select_get_f lb_hash_tunnel_fields_select_get;
