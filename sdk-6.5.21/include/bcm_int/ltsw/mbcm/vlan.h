...
/*!
 * \brief Configure an entry in egress VLAN xlate table.
 *
 * This function is used to configure an entry in egress VLAN xlate table.
 *
 * \param [in]      unit             Unit number.
 ...
 * \retval !SHR_E_NONE           Failure.
 */
typedef int (*vlan_egr_xlate_cfg_f) (int unit, int port_class,
                                     bcm_vlan_t outer_vlan,
                                     bcm_vlan_t inner_vlan,
 ...
 * \retval !SHR_E_NONE           Failure.
 */
typedef int (*vlan_egr_xlate_trv_f) (int unit,
 ...
 * \retval !SHR_E_NONE           Failure.
 */
typedef int (*vlan_traverse_f)(int unit, int ingress,
...
typedef struct mbcm_ltsw_vlan_drv_s {
    ...
    /*! Add an egress VLAN translation entry. */
    vlan_egr_xlate_cfg_f vlan_egr_xlate_add;

    /*! Get an egress VLAN translation entry. */
    vlan_egr_xlate_cfg_f vlan_egr_xlate_get;

    /*! Delete an egress VLAN translation entry. */
    vlan_egr_xlate_cfg_f vlan_egr_xlate_delete;

    /*! Traverse egress VLAN translation entries. */
    vlan_egr_xlate_trv_f vlan_egr_xlate_traverse;
 ...
 */
extern int
mbcm_ltsw_vlan_egr_xlate_add(int unit,
                             bcm_gport_t port,
                             bcm_vlan_t outer_vlan,
                             bcm_vlan_t inner_vlan,
                             bcmi_ltsw_vlan_egr_xlate_cfg_t *cfg);
 ...
 */
extern int
mbcm_ltsw_vlan_egr_xlate_get(int unit,
                             bcm_gport_t port,
                             bcm_vlan_t outer_vlan,
                             bcm_vlan_t inner_vlan,
                             bcmi_ltsw_vlan_egr_xlate_cfg_t *cfg);
 ...
 */
extern int
mbcm_ltsw_vlan_egr_xlate_delete(int unit,
                                bcm_gport_t port,
                                bcm_vlan_t outer_vlan,
                                bcm_vlan_t inner_vlan,
                                bcmi_ltsw_vlan_egr_xlate_cfg_t *cfg);
 ...
 */
extern int
mbcm_ltsw_vlan_egr_xlate_traverse(
                                 int unit,
                                 bcmi_ltsw_vlan_egr_xlate_traverse_cb cb,
                                 void *user_data);
 ...
 */
extern int
mbcm_ltsw_vlan_traverse(int unit, int ingress,
