...
/*!
 * \brief Get number of COSQ mapping entries.
 *
 * \param [in] unit Unit Number.
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*rx_cosq_mapping_size_get_f)(
    int unit,
    int *size);

/*!
 * \brief Get all supported reasons for CPU cosq mapping.
 *
 * \param [in] unit Unit Number.
 * \param [out] reasons cpu cosq "reasons" mapping bitmap
 *
 * \retval SHR_E_NONE No errors.
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*rx_cosq_mapping_reasons_get_f)(
    int unit,
...
typedef struct mbcm_ltsw_rx_drv_s {
    ...
    rx_cosq_mapping_size_get_f rx_cosq_mapping_size_get;

    /*! Get all supported reasons for CPU cosq mapping. */
    rx_cosq_mapping_reasons_get_f rx_cosq_mapping_reasons_get;
 ...
 */
extern int
mbcm_ltsw_rx_cosq_mapping_size_get(
    int unit,
    int *size);
 ...
 */
extern int
mbcm_ltsw_rx_cosq_mapping_reasons_get(
    int unit,
    bcm_rx_reasons_t *reasons);
