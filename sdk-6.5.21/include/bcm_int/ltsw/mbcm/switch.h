...
/*! Initialize EP Recirculate profiles. */
typedef int (*mbcm_ltsw_switch_ep_recirc_profile_init_f)(int unit);
...
/*! Get the drop event which has minimal drop code among the given drop events. */
typedef int (*mbcm_ltsw_switch_ep_recirc_drop_event_min_get_f)(
    int unit,
...
/* Get the mirror instance id applied on a EP recirculate profile entry. */
typedef int (*mbcm_ltsw_switch_ep_recirc_profile_mirror_instance_get_f)(
    int unit,
    int recirc_profile_id,
    int *mirror_instance_id);

/* Get all the mirror instance ids applied on EP recirculate profile entries. */
typedef int (*mbcm_ltsw_switch_ep_recirc_profile_mirror_instance_get_all_f)(
    int unit,
    int *mirror_inst_id_array);

/* Get the number of EP recirculate profile entries.*/
typedef int (*mbcm_ltsw_switch_ep_recirc_profile_num_get_f)(
    int unit,
    int *num);

/* Get the NPL drop code from a drop event enum. */
typedef int (*mbcm_ltsw_switch_ep_recirc_drop_event_to_drop_code_f)(
    int unit,
    bcm_pkt_drop_event_t drop_event,
    int *drop_code);
...
typedef struct mbcm_ltsw_sc_drv_s {
    ...
    /*! Initialize EP Recirculate profiles. */
    mbcm_ltsw_switch_ep_recirc_profile_init_f switch_ep_recirc_profile_init;
    ...
    /*! Get the drop event which has minimal drop code among the given drop events. */
    mbcm_ltsw_switch_ep_recirc_drop_event_min_get_f switch_ep_recirc_drop_event_min_get;
    ...
    /* Get all the mirror instance ids applied on EP recirculate profile entries. */
    mbcm_ltsw_switch_ep_recirc_profile_mirror_instance_get_all_f switch_ep_recirc_profile_mirror_instance_get_all;

    /* Get the number of EP recirculate profile entries.*/
    mbcm_ltsw_switch_ep_recirc_profile_num_get_f switch_ep_recirc_profile_num_get;

    /* Get the NPL drop code from a drop event enum. */
    mbcm_ltsw_switch_ep_recirc_drop_event_to_drop_code_f switch_ep_recirc_drop_event_to_drop_code;
} mbcm_ltsw_sc_drv_t;
...
/*!
 * \brief Initialize EP Recirculate profiles.
 *
 * \param [in] unit Unit number.
 *
 * \retval SHR_E_NONE Success.
 ...
 */
extern int
mbcm_ltsw_switch_ep_recirc_profile_init(int unit);
...
/*!
 * \brief Get the drop event which has minimal drop code among the given drop events.
 *
 * \param [in] unit Unit number.
 * \param [in] drop_event_array Array of drop events.
 * \param [in] array_size The size of the drop event array.
 * \param [out] min_drop_event The drop event which has minimal drop code.
 *
 * \retval SHR_E_NONE Success.
 * \retval !SHR_E_NONE Failure.
 */
int
mbcm_ltsw_switch_ep_recirc_drop_event_min_get(
    int unit,
    bcm_pkt_drop_event_t *drop_event_array,
    int array_size,
    bcm_pkt_drop_event_t *min_drop_event);
...
/*!
 * \brief Get the mirror instance id applied on a EP recirculate profile entry.
 *
 * \param [in] unit Unit number.
 * \param [in] recirc_profile_id EP Recirculate profile id.
...
/*!
 * \brief Get all the mirror instance ids applied on EP recirculate profile entries.
 *
 * \param [in] unit Unit number.
 * \param [out] mirror_inst_id_array Mirror instance id array.
 *
 * \retval SHR_E_NONE Success.
 * \retval !SHR_E_NONE Failure.
 */
extern int
mbcm_ltsw_switch_ep_recirc_profile_mirror_instance_get_all(
    int unit,
    int *mirror_inst_id_array);

/*!
 * \brief Get the number of EP recirculate profile entries.
 *
 * \param [in] unit Unit number.
 * \param [out] num EP recirculate profile number.
 *
 * \retval SHR_E_NONE Success.
 * \retval !SHR_E_NONE Failure.
 */
extern int
mbcm_ltsw_switch_ep_recirc_profile_num_get(int unit, int *num);

/*!
 * \brief Get the NPL drop code from a drop event enum.
 *
 * \param [in] unit Unit number.
 * \param [in] drop_event Drop event.
 * \param [out] drop_code Drop code.
 *
 * \retval SHR_E_NONE Success.
 * \retval !SHR_E_NONE Failure.
 */
extern int
mbcm_ltsw_switch_ep_recirc_drop_event_to_drop_code(
    int unit,
    bcm_pkt_drop_event_t drop_event,
    int *drop_code);
