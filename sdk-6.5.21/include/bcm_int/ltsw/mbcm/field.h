...
typedef int (*field_pbmp_mask_get)(
        int unit,
        int gp_pipe,
        bcmint_field_stage_info_t *stage_info,
        bcm_pbmp_t *in_pbmp_mask,
...
typedef int (*field_destination_drop_reason_to_code_f) (
        int unit,
        bcm_field_drop_reason_t reason,
        int *code);

typedef int (*field_destination_drop_code_to_reason_f) (
        int unit,
        int code,
        bcm_field_drop_reason_t *reason);
...
typedef int (*field_destination_lt_db_get_f) (
        int unit,
...
typedef int (*field_qualify_trunk_get_f)(
    int unit,
    bcm_field_entry_t entry,
    bcm_field_qualify_t qual,
    bool *is_trunk,
...
typedef int (*field_qualify_trunk_set_f)(
    int unit,
    bcm_field_entry_t entry,
    bcm_field_qualify_t qual,
    bcm_trunk_t data,
...
typedef int (*field_vslice_group_alloc_f)(
    int unit,
    bcmint_field_stage_info_t *stage_info,
    int pipe,
    int grp_prio,
...
typedef int (*field_vslice_group_dealloc_f)(
    int unit,
    bcmint_field_stage_info_t *stage_info,
    int pipe,
    int grp_priority);

typedef int (*field_stage_reinit_f)(
    int unit,
    bcmint_field_stage_info_t *stage_info,
    bool warm);

typedef int (*field_flexctr_action_update_f)(
    int unit,
    bcmint_field_stage_info_t *stage_info,
    int pipe);

typedef int (*field_stage_cleanup_f)(
    int unit,
    bcmint_field_stage_info_t *stage_info);
...
typedef struct mbcm_ltsw_field_drv_s {
    ...
    /* Field pbmp mask get. */
    field_pbmp_mask_get field_pbmp_mask_get;
    ...
    /* BCM drop reason to hardware drop code. */
    field_destination_drop_reason_to_code_f field_destination_drop_reason_to_code;

    /* Hardware drop code to drop reason. */
    field_destination_drop_code_to_reason_f field_destination_drop_code_to_reason;
    ...
    /*! get field destination lt database */
    field_destination_lt_db_get_f field_destination_lt_db_get;

    /*! stage cleanup */
    field_stage_cleanup_f field_stage_cleanup;

    /*! allocate vslice group */
    field_vslice_group_alloc_f field_vslice_group_alloc;

    /*! Deallocate vslice group */
    field_vslice_group_dealloc_f field_vslice_group_dealloc;

    /*! stage misc reinit */
    field_stage_reinit_f field_stage_reinit;

    /*! update field flexctr action update */
    field_flexctr_action_update_f field_flexctr_action_update;

    /*! Get Qualify values of Trunk */
    field_qualify_trunk_get_f field_qualify_SrcTrunk_get;

    /*! Set Qualify values of Mod ID and Port */
    field_qualify_trunk_set_f field_qualify_SrcTrunk_set;
 ...
 */
extern int
mbcm_ltsw_field_destination_drop_reason_to_code(
        int unit,
        bcm_field_drop_reason_t reason,
        int *code);
 ...
 */
extern int
mbcm_ltsw_field_destination_drop_code_to_reason(
        int unit,
        int code,
        bcm_field_drop_reason_t *reason);
...
extern int
mbcm_ltsw_field_destination_lt_db_get(
        int unit,
        bcmint_field_destination_lt_db_t *lt_db);
...
extern int
mbcm_ltsw_field_flexctr_action_update(
    int unit,
    bcmint_field_stage_info_t *stage_info,
    int pipe);
...
extern int
mbcm_ltsw_field_stage_reinit(
    int unit,
    bcmint_field_stage_info_t *stage_info,
    bool warm);

extern int
mbcm_ltsw_field_stage_cleanup(
    int unit,
    bcmint_field_stage_info_t *stage_info);

extern int
mbcm_ltsw_field_qualify_SrcTrunk_get(
    int unit,
    bcm_field_entry_t entry,
    bcm_field_qualify_t qual,
    bool *is_trunk,
...
extern int
mbcm_ltsw_field_qualify_SrcTrunk(
    int unit,
    bcm_field_entry_t entry,
    bcm_field_qualify_t qual,
    bcm_trunk_t data,
