 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*pfc_deadlock_recovery_exit_f)(
    int unit,
    bcm_port_t port,
    int pfc_priority);
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*pfc_deadlock_recovery_start_f)(
    int unit,
    bcm_port_t port,
    int pfc_priority);
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*pfc_dd_recovery_mode_get_f)(
    int unit,
    bcm_port_t port,
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*pfc_dd_recovery_mode_set_f)(
    int unit,
    bcm_port_t port,
    bcm_cosq_pfc_dd_recovery_mode_t recovery_mode);
...
typedef struct mbcm_ltsw_pfc_drv_s {
    ...
    pfc_deadlock_recovery_exit_f pfc_deadlock_recovery_exit;

    /*! Start pfc deadlock recovery. */
    pfc_deadlock_recovery_start_f pfc_deadlock_recovery_start;

    /*! To get PFC deadlock software recovery mode. */
    pfc_dd_recovery_mode_get_f pfc_dd_recovery_mode_get;

    /*! To set PFC deadlock software recovery mode. */
    pfc_dd_recovery_mode_set_f pfc_dd_recovery_mode_set;
