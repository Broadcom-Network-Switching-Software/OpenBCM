 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*time_timesync_config_profile_create_f)(
    int unit,
    bcm_time_timesync_config_profile_t *profile,
    int *profile_id);

/*!
 * \brief Destroy the timesync profile.
 *
 * \param [in] unit Unit Number.
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*time_timesync_config_profile_destroy_f)(
    int unit,
    int profile_id);

/*!
 * \brief Get the timesync profile entry with a given profile id.
 *
 * \param [in] unit Unit Number.
 * \param [in] profile_id Profile id.
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*time_timesync_config_profile_get_f)(
    int unit,
    int profile_id,
    bcm_time_timesync_config_profile_t *profile);
...
typedef struct mbcm_ltsw_time_drv_s {
    ...
    /*! Create a timesync profile. */
    time_timesync_config_profile_create_f time_timesync_config_profile_create;

    /*! Destroy the timesync profile. */
    time_timesync_config_profile_destroy_f time_timesync_config_profile_destroy;

    /*! Get the timesync profile entry with a given profile id. */
    time_timesync_config_profile_get_f time_timesync_config_profile_get;
 ...
 */
extern int
mbcm_ltsw_time_timesync_config_profile_create(
    int unit,
    bcm_time_timesync_config_profile_t *profile,
    int *profile_id);
 ...
 */
extern int
mbcm_ltsw_time_timesync_config_profile_destroy(
    int unit,
    int profile_id);
 ...
 */
extern int
mbcm_ltsw_time_timesync_config_profile_get(
    int unit,
    int profile_id,
    bcm_time_timesync_config_profile_t *profile);
