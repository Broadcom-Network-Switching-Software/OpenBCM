...
#ifndef BCMINT_LTSW_MBCM_DLB_H
#define BCMINT_LTSW_MBCM_DLB_H
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*dlb_capability_get_f)(
    int unit,
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*dlb_init_f)(int unit);
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*dlb_deinit_f)(int unit);
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*dlb_config_validate_f)(
    int unit,
    bcmi_ltsw_dlb_type_t dlb_type,
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*dlb_config_clear_f)(
    int unit,
    bcmi_ltsw_dlb_type_t dlb_type,
    bcmi_ltsw_dlb_id_t dlb_id);
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*dlb_monitor_validate_f)(
    int unit,
    bcmi_ltsw_dlb_type_t dlb_type,
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*dlb_monitor_clear_f)(
    int unit,
    bcmi_ltsw_dlb_type_t dlb_type,
    bcmi_ltsw_dlb_id_t dlb_id);
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*dlb_member_quality_map_profile_format_f)(
    int unit,
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*dlb_member_quality_map_profile2id_f)(
    int unit,
    bcmi_ltsw_dlb_type_t dlb_type,
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*dlb_member_quality_map_id2profile_f)(
    int unit,
    bcmi_ltsw_dlb_type_t dlb_type,
    int quality_map_profile_count,
    bcmint_dlb_quality_map_profile_t *quality_map_profile,
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*dlb_member_quality_map_set_f)(
    int unit,
    bcmi_ltsw_dlb_type_t dlb_type,
    int quality_map_id,
    int load_percent,
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*dlb_member_quality_map_clear_f)(
    int unit,
    bcmi_ltsw_dlb_type_t dlb_type,
    int quality_map_id);
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*dlb_member_pbmp_get_f)(
    int unit,
    bcm_pbmp_t *pbmp);
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*dlb_member_attribute_validate_f)(
    int unit,
    bcmi_ltsw_dlb_type_t dlb_type,
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*dlb_member_attribute_set_f)(
    int unit,
    bcm_port_t port,
    bcmi_ltsw_dlb_type_t dlb_type,
    int scaling_factor,
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*dlb_member_attribute_get_f)(
    int unit,
    bcm_port_t port,
    bcmi_ltsw_dlb_type_t dlb_type,
    int *scaling_factor,
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*dlb_member_attribute_clear_f)(
    int unit,
    bcm_port_t port,
    bcmi_ltsw_dlb_type_t dlb_type);
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*dlb_member_status_set_f)(
    int unit,
    bcm_port_t port,
    bcmi_ltsw_dlb_type_t dlb_type,
    int status);
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*dlb_member_status_get_f)(
    int unit,
    bcm_port_t port,
    bcmi_ltsw_dlb_type_t dlb_type,
    int *status);
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*dlb_ethertype_set_f)(
    int unit,
    uint32_t flags,
    int ethertype_count,
    int *ethertype_array);
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*dlb_ethertype_get_f)(
    int unit,
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*dlb_control_info_value_validate_f)(
    int unit,
    bcmi_ltsw_dlb_type_t dlb_type,
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*dlb_control_info_set_f)(
    int unit,
    bcmi_ltsw_dlb_type_t dlb_type,
    bcmint_dlb_ctrl_info_t **ctrl_info,
    bcmi_ltsw_dlb_control_type_t type,
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*dlb_control_info_get_f)(
    int unit,
    bcmi_ltsw_dlb_type_t dlb_type,
    bcmint_dlb_ctrl_info_t **ctrl_info,
    bcmi_ltsw_dlb_control_type_t type,
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*dlb_control_type_validate_f)(
    int unit,
    bcmi_ltsw_dlb_type_t dlb_type,
    bcmi_ltsw_dlb_control_type_t type);
 ...
 * \retval !SHR_E_NONE Failure.
 */
typedef int (*dlb_control_value_validate_f)(
    int unit,
    bcmi_ltsw_dlb_type_t dlb_type,
    bcmi_ltsw_dlb_control_type_t type,
    uint64_t value);
...
/*!
 * \brief Dlb driver structure.
 */
typedef struct mbcm_ltsw_dlb_drv_s {

    /*! Get chip-specific sub-features for DLB. */
    dlb_feature_get_f dlb_feature_get;

    /*! Get chip-specific sub-features for DLB. */
    dlb_capability_get_f dlb_capability_get;

    /*! Initialize the dlb module. */
    dlb_init_f dlb_init;

    /*! De-init the dlb module. */
    dlb_deinit_f dlb_deinit;

    /*! Initialize the dlb module. */
    dlb_type_init_f dlb_type_init;

    /*! De-init the dlb module. */
    dlb_type_deinit_f dlb_type_deinit;

    /*! Validate DLB configurations. */
    dlb_config_validate_f dlb_config_validate;

    /*! Set configurations of a DLB group. */
    dlb_config_set_f dlb_config_set;

    /*! Get configurations of a DLB group. */
    dlb_config_get_f dlb_config_get;

    /*! Clear configurations of a DLB group. */
    dlb_config_clear_f dlb_config_clear;

    /*! Validate DLB monitor configurations. */
    dlb_monitor_validate_f dlb_monitor_validate;

    /*! Set DLB monitor. */
    dlb_monitor_set_f dlb_monitor_set;

    /*! Get DLB monitor configurations. */
    dlb_monitor_get_f dlb_monitor_get;

    /*! Clear DLB monitor configurations. */
    dlb_monitor_clear_f dlb_monitor_clear;

    /*! Format DLB member quality map. */
    dlb_member_quality_map_profile_format_f dlb_member_quality_map_profile_format;

    /*! Traslate the qualify map profile to id. */
    dlb_member_quality_map_profile2id_f dlb_member_quality_map_profile2id;

    /*! Traslate the qualify map id to profile. */
    dlb_member_quality_map_id2profile_f dlb_member_quality_map_id2profile;

    /*! Set the DLB member quality map table. */
    dlb_member_quality_map_set_f dlb_member_quality_map_set;

    /*! Clear the qualify map table. */
    dlb_member_quality_map_clear_f dlb_member_quality_map_clear;

    /*! Get the DLB member port bitmap for warmboot. */
    dlb_member_pbmp_get_f dlb_member_pbmp_get;

    /*! Validate DLB member port attributes. */
    dlb_member_attribute_validate_f dlb_member_attribute_validate;

    /*! Set DLB member port attributes. */
    dlb_member_attribute_set_f dlb_member_attribute_set;

    /*! Get DLB member port attributes. */
    dlb_member_attribute_get_f dlb_member_attribute_get;

    /*! Clear DLB member port attributes. */
    dlb_member_attribute_clear_f dlb_member_attribute_clear;

    /*! Set DLB member status. */
    dlb_member_status_set_f dlb_member_status_set;

    /*! Get DLB member status. */
    dlb_member_status_get_f dlb_member_status_get;

    /*! Set DLB Eligibility Ethertype. */
    dlb_ethertype_set_f dlb_ethertype_set;

    /*! Get DLB Eligibility Ethertype. */
    dlb_ethertype_get_f dlb_ethertype_get;

    /*! Validate the DLB controlling information value according to information. */
    dlb_control_info_value_validate_f dlb_control_info_value_validate;

    /*! Set DLB controlling information with information. */
    dlb_control_info_set_f dlb_control_info_set;

    /*! Get DLB controlling information from information. */
    dlb_control_info_get_f dlb_control_info_get;

    /*! Validate the DLB controlling type. */
    dlb_control_type_validate_f dlb_control_type_validate;

    /*! Validate the DLB controlling information value. */
    dlb_control_value_validate_f dlb_control_value_validate;

    /*! Set DLB controlling information. */
    dlb_control_set_f dlb_control_set;

    /*! Get DLB controlling information. */
    dlb_control_get_f dlb_control_get;

    /*! Set statistics for a DLB group. */
    dlb_stat_set_f dlb_stat_set;

    /*! Get statistics for a DLB group. */
    dlb_stat_get_f dlb_stat_get;

} mbcm_ltsw_dlb_drv_t;

/*!
 * \brief Set the DLB driver of the device.
 *
 * \param [in] unit Unit Number.
 * \param [in] drv Dlb driver to set.
 *
 * \retval SHR_E_NONE No errors.
 * \retval !SHR_E_NONE Failure.
 */
