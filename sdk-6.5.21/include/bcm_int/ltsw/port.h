...
typedef enum bcmi_ltsw_port_tab_e {
    ...
    BCMI_PT_EGR_DSCP_PHB,
    BCMI_PT_PORT_CONTEXT,
    BCMI_PT_FP_EGR_DROP,
...
/*!
 * \brief Enumerator for PORT_ING_EGR_BLOCK_PROFILE_ID.
 */
typedef enum bcmi_ltsw_port_ing_egr_block_profile_id_e {
    BLOCK_PROFILE_BASE = 0,
    BLOCK_PROFILE_IFP,
    BLOCK_PROFILE_LAG_FAIL_LOOPBACK,
    BLOCK_PROFILE_CNT,
} bcmi_ltsw_port_ing_egr_block_profile_id_t;
...
#define BCMI_LTSW_DPORT_MAX     320
 ...
 */
#define BCMI_LTSW_DPORT_PBMP_ITER(_u,_pbm,_dport,_p) \
        for ((_dport) = 0, (_p) = -1; (_dport) < BCMI_LTSW_DPORT_MAX; (_dport)++) \
