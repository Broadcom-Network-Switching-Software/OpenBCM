...
#define BCM_FIELD_QUAL_LT_FIELD_MAP_MAX     32
...
/* We have 17 B4/B2/B1 chunk qualifiers each at moment.
 * This macro should be updated if new are introduced. */
#define BCMI_FIELD_UDF_CHUNK_QUALIFIER_NUM  17
...
typedef enum bcmi_field_action_e {
    ...
    bcmiFieldActionGpStatGroup,
    bcmiFieldActionYpStatGroup,
    bcmiFieldActionRpStatGroup,
    bcmiFieldActionGpFlexctrOpaque2,
    bcmiFieldActionYpFlexctrOpaque2,
    bcmiFieldActionRpFlexctrOpaque2,
    bcmiFieldActionGpFlexctrOpaque3,
    bcmiFieldActionYpFlexctrOpaque3,
    bcmiFieldActionRpFlexctrOpaque3,
...
typedef struct bcm_field_qual_map_info_s {
    ...
    /*! Macro qualifier flag corresponding to this map. */
    uint32_t        macro_value[BCM_FIELD_QUAL_LT_FIELD_MAP_MAX];
...
extern int
bcmi_field_hint_dump(int unit, int hint_id);
