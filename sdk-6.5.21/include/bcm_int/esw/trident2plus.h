...
#define BCMI_L3_INTF_BANKS_MAX(_u_)       ((SOC_IS_HELIX5(_u_) || SOC_IS_HURRICANE4(_u_)) ? \
                                          ((soc_feature(_u_, soc_feature_td3x1_reduced_l3intf)) ? 4 : 8) : 6)
...
#define BCMI_L3_NH_BANKS_MAX             (SOC_IS_HURRICANE4(_u_) ? ((soc_feature(_u_, soc_feature_td3x1_reduced_nhop)) ? 4 : 8) : 12)
...
#define BCMI_L3_ECMP_MAX_BANKS(_u_)      ((SOC_IS_HELIX5(_u_)) ? 4 : (SOC_IS_HURRICANE4(_u_) ? \
                                         ((soc_feature(_u_, soc_feature_td3x1_reduced_ecmp)) ? 2 : 4) : 8))
