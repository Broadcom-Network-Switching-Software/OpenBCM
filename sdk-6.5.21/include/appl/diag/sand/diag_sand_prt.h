...
#define PRT_COLUMN_WIDTH_INTEGER     11
...
#define PRT_COLUMN_ADD_FLEX_PL(mc_id, flag, ...)                                                                       \
                        _PRT_COLUMN_ADD(prt_ctr[mc_id], flag, 2*PRT_COLUMN_WIDTH, __VA_ARGS__)
#define PRT_COLUMN_ADD_FLEX_PL_WIDTH(mc_id, flag, column_width, ...)                                                            \
                        _PRT_COLUMN_ADD(prt_ctr[mc_id], flag, column_width, __VA_ARGS__)
