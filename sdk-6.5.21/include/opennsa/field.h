...
typedef enum bcm_field_qualify_e {
    ...
    bcmFieldQualifyIngressL2InterfaceVfi = 1255, /* Qualify on Vfi from Ingress L2
                                           interface. */
    bcmFieldQualifyCount = 1256         /* Always Last. Not a usable value. */
} bcm_field_qualify_t;
...
typedef enum bcm_field_AppType_e {
    ...
    bcmFieldAppTypeSrv6UsidEndpoint = 50, /* SSRv6 micro-SID Endpoint node. */
    bcmFieldAppTypeCount = 51           /* Always Last. Not a usable value. */
} bcm_field_AppType_t;
...
typedef enum bcm_field_LoopbackType_e {
    ...
    bcmFieldLoopbackTypeIfaVxLanDecapPayload = 21, /* VxLan tunnel termination with IFA
                                           Payload */
    bcmFieldLoopbackTypeCount = 22      /* Always Last. Not a usable value. */
...
typedef enum bcm_field_action_e {
    ...
    bcmFieldActionCount = 814           /* Always Last. Not a usable value. */
} bcm_field_action_t;
...
typedef enum bcm_field_l2_pkt_type_e {
    ...
    bcmFieldL2PktTypeLastCount = 8  /* Always Last. Not a usable value. */
...
typedef enum bcm_field_pkt_type_e {
    ...
    bcmFieldPktTypeLastCount = 129      /* Not in use - Last Count */
...
typedef enum bcm_field_layer_type_e {
    ...
    bcmFieldLayerTypeCount = 35         /* Always last. Not a usable value. */
...
typedef enum bcm_field_egress_flow_control_e {
    ...
    bcmFieldEgressFlowControlCount = 32 /* Always last. Not to be used. */
...
typedef enum bcm_field_ace_context_e {
    ...
    bcmFieldAceContextReflectorL2IntMc = 11, /* ACE context which is used for L2 MC
                                           internal reflector */
    bcmFieldAceContextCount = 12        /* Always last. Not a usable value. */
...
typedef enum bcm_field_mirror_encap_ctrl_type_e {
    ...
    bcmFieldMirrorEncapCtrlTypeEncapErspan1 = 3, /* With ERSPANv1 Encap. */
    ...
    bcmFieldMirrorEncapCtrlTypeEncapVxlan = 8, /* With VxLan Encap. */
