 ...
 * attaching device.
 */
extern int soc_cm_ha_mem_init(int dev,
                              soc_cm_ha_mem_pool_alloc_f pool_alloc,
                              soc_cm_ha_mem_pool_free_f pool_free,
                              void *pool_ctx,
                              void *pool_ptr,
                              int pool_size);
extern int soc_cm_ha_mem_cleanup(int dev);
extern int soc_cm_ha_mem_reset(int dev);
...
extern int soc_cm_config_str_delete(int dev, const char *name);
...
extern int soc_cm_config_port_str_delete(int dev, int port, const char *name);
