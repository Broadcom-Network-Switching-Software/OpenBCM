...
soc_error_t soc_fe3200_stat_get(int unit,bcm_port_t port,uint64 *value,int *counters,int arr_size);
soc_error_t soc_fe3200_stat_is_supported_type(int unit, bcm_port_t port, bcm_stat_val_t type);
