...
#  define DBAL_MAX_NUMBER_OF_RESULT_TYPES                       35
...
#define DBAL_NOF_ENTRY_ATTR_TYPE         (7)
...
typedef struct
{
    ...
    sal_thread_t worker_threads[DBAL_NOF_COLLECTION_POOLS];

    
    int nof_collect_operation_failures;
...
typedef struct
{
    ...
    dbal_collect_info_t collect_info;
