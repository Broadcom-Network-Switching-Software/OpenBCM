...
typedef struct dnx_state_snapshot_manager_d
{
    ...
    uint32 is_on_counter[DNX_ERR_RECOVERY_MAX_NOF_ACTIVE_TRANSACTION];
    uint32 entry_counter[DNX_ERR_RECOVERY_MAX_NOF_ACTIVE_TRANSACTION];
    uint32 is_suppressed_counter[DNX_ERR_RECOVERY_MAX_NOF_ACTIVE_TRANSACTION];
