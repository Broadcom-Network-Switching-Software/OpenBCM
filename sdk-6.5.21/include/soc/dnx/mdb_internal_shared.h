...
#define MDB_EM_TABLE_IS_EMP(mdb_physical_table) ((mdb_physical_table == MDB_PHYSICAL_TABLE_LEM) || (mdb_physical_table == MDB_PHYSICAL_TABLE_EXEM_3) || (mdb_physical_table == MDB_PHYSICAL_TABLE_EXEM_4))
...
#define MDB_INIT_IS_FEC_TABLE(mdb_physical_table) ((mdb_physical_table == MDB_PHYSICAL_TABLE_FEC_1)   \
                                                || (mdb_physical_table == MDB_PHYSICAL_TABLE_FEC_2)   \
                                                || (mdb_physical_table == MDB_PHYSICAL_TABLE_FEC_3)   \
                                                )
