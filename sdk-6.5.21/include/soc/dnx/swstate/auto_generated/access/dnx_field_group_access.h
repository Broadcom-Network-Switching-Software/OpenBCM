...
typedef int (*dnx_field_group_sw_fg_info_context_info_key_id_lsb_set_cb)(
    int unit, uint32 fg_info_idx_0, uint32 context_info_idx_0, uint32 lsb_idx_0, uint8 lsb);


typedef int (*dnx_field_group_sw_fg_info_context_info_key_id_lsb_get_cb)(
    int unit, uint32 fg_info_idx_0, uint32 context_info_idx_0, uint32 lsb_idx_0, uint8 *lsb);
...
typedef struct {
    dnx_field_group_sw_fg_info_context_info_key_id_lsb_set_cb set;
    dnx_field_group_sw_fg_info_context_info_key_id_lsb_get_cb get;
} dnx_field_group_sw_fg_info_context_info_key_id_lsb_cbs;
...
typedef struct {
    ...
    dnx_field_group_sw_fg_info_context_info_key_id_lsb_cbs lsb;
