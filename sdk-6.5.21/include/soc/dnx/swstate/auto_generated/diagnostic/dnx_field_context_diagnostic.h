...
typedef enum {
    ...
    DNX_FIELD_CONTEXT_SW_CONTEXT_INFO_CONTEXT_IPMF1_INFO_COMPARE_INFO_PAIR_1_KEY_INFO_KEY_ID_LSB_INFO,
    ...
    DNX_FIELD_CONTEXT_SW_CONTEXT_INFO_CONTEXT_IPMF1_INFO_COMPARE_INFO_PAIR_2_KEY_INFO_KEY_ID_LSB_INFO,
    ...
    DNX_FIELD_CONTEXT_SW_CONTEXT_INFO_CONTEXT_IPMF1_INFO_HASHING_INFO_KEY_INFO_KEY_ID_LSB_INFO,
...
int dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_key_info_key_id_lsb_dump(
    int unit, int context_info_idx_0, int key_info_idx_0, int lsb_idx_0, dnx_sw_state_dump_filters_t filters);
...
int dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_2_key_info_key_id_lsb_dump(
    int unit, int context_info_idx_0, int key_info_idx_0, int lsb_idx_0, dnx_sw_state_dump_filters_t filters);
...
int dnx_field_context_sw_context_info_context_ipmf1_info_hashing_info_key_info_key_id_lsb_dump(
    int unit, int context_info_idx_0, int lsb_idx_0, dnx_sw_state_dump_filters_t filters);
