...
typedef enum {
    ...
    DNX_FIELD_GROUP_SW_FG_INFO_CONTEXT_INFO_KEY_ID_LSB_INFO,
...
int dnx_field_group_sw_fg_info_context_info_key_id_lsb_dump(
    int unit, int fg_info_idx_0, int context_info_idx_0, int lsb_idx_0, dnx_sw_state_dump_filters_t filters);

int dnx_field_group_sw_fg_info_context_info_key_id_nof_bits_dump(
    int unit, int fg_info_idx_0, int context_info_idx_0, int nof_bits_idx_0, dnx_sw_state_dump_filters_t filters);
