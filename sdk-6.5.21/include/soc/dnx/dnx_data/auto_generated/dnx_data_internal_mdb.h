...
typedef enum
{
    ...
    dnx_data_mdb_em_table_mdb_34_info,
...
const dnx_data_mdb_em_mdb_34_info_t * dnx_data_mdb_em_mdb_34_info_get(
    int unit,
    int mdb_table);
...
shr_error_e dnx_data_mdb_em_mdb_34_info_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
const dnxc_data_table_info_t * dnx_data_mdb_em_mdb_34_info_info_get(
    int unit);
...
typedef enum
{
    ...
    dnx_data_mdb_direct_table_mdb_12_info,
...
const dnx_data_mdb_direct_mdb_12_info_t * dnx_data_mdb_direct_mdb_12_info_get(
    int unit,
    int mdb_table);
...
shr_error_e dnx_data_mdb_direct_mdb_12_info_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
const dnxc_data_table_info_t * dnx_data_mdb_direct_mdb_12_info_info_get(
    int unit);
