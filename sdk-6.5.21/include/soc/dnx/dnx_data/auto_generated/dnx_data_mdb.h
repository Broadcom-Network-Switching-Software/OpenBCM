...
typedef const dnx_data_mdb_em_mdb_34_info_t *(
    *dnx_data_mdb_em_mdb_34_info_get_f) (
    int unit,
    int mdb_table);
...
typedef struct
{
    ...
    dnx_data_mdb_em_mdb_34_info_get_f mdb_34_info_get;
    
    dnxc_data_table_info_get_f mdb_34_info_info_get;
...
{
    dbal_tables_e dbal_table;
} dnx_data_mdb_direct_mdb_12_info_t;
...
typedef const dnx_data_mdb_direct_mdb_12_info_t *(
    *dnx_data_mdb_direct_mdb_12_info_get_f) (
    int unit,
    int mdb_table);
...
typedef struct
{
    ...
    dnx_data_mdb_direct_mdb_12_info_get_f mdb_12_info_get;
