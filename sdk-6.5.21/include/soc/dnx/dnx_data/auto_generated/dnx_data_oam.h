...
typedef enum
{
    ...
    dnx_data_oam_general_oam_mpls_ccm_support,
...
typedef uint32(
    *dnx_data_oam_oamp_nof_rmep_write_complete_checks_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_oam_oamp_nof_rmep_write_complete_checks_get_f nof_rmep_write_complete_checks_get;
