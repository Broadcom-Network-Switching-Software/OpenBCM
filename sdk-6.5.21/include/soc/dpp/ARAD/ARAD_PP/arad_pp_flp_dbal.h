...
uint32 arad_pp_flp_dbal_pppoe_ipv4mc_program_tables_init(int unit, int prog_id);

uint32 arad_pp_flp_dbal_pppoe_ipv6mc_program_tables_init(int unit, int prog_id);
