/*! \file issu.h
 *
 * BCM common APIs for ISSU (a.k.a. In Service Software Upgrade).
 */
/*
...
#ifndef BCM_COMMON_ISSU_H
#define BCM_COMMON_ISSU_H

#include <sal/sal_types.h>
#include <soc/ltsw/ha.h>
#include <bcmissu/issu_api.h>

typedef struct soc_ltsw_issu_info_s {
    bool warm;
    soc_ltsw_ha_mod_id_t ha_comp_id;
    const char *libname;
    const char *libsum;
} soc_ltsw_issu_info_t;
 ...
 */
extern int
soc_ltsw_issu_struct_info_report(int unit,
 ...
 */
extern int
soc_ltsw_issu_struct_info_get(int unit,
                               bcmissu_struct_id_t id,
                               soc_ltsw_ha_mod_id_t comp_id,
                               soc_ltsw_ha_sub_id_t sub_id,
                               uint32_t *offset);
 ...
 */
extern int
soc_ltsw_issu_struct_info_clear(int unit,
                                 bcmissu_struct_id_t id,
                                 soc_ltsw_ha_mod_id_t comp_id,
                                 soc_ltsw_ha_sub_id_t sub_id);

#endif /* BCM_COMMON_ISSU_H */
