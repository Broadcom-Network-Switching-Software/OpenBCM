...
/*
 *  NOTE : This script will work on Cancun version B870.5.2.x onwards only(SDK-147014), else you may see invalid VNID in egress packet
 */

/*
 * Feature  : TD3(56870), Verifying ingress mirror packet to vxlan tunnel feature
 *
 ...
 *                        --------->|         TD3          |-------->
 *                   ingress packet |        56870         | tunnel header + Vxlan header + payload
 *                                  |                      |
 *                                  +----------------------+
 *
 * Summary:
...
bcm_port_t egress_port; //MTP port
