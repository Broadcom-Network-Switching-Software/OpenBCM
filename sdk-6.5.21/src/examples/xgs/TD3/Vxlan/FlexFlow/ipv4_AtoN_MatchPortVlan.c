...
/*
 * Feature  : TD3(56870) Vxlan Bridging , IPv4 access to network tunnel initiation Flow with port,vlan as a flow match criteria(BCM_FLOW_MATCH_CRITERIA_PORT_VLAN)
 *
 * Usage    : BCM.0> cint ipv4_AtoN_MatchPortVlan.c
 *
 * config   : config_td3_flex.bcm
 *
 * Log file : ipv4_AtoN_MatchPortVlan_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
