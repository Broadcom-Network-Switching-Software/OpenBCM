/*  Feature  : L2 default vlan flooding
 *
 *  Usage    : BCM.0> cint th4_hsdk_l2_default_vlan_flooding.c
 *
 *  config   : th4_hsdk_l2_config.yml
 *
 *  Log file : th4_hsdk_l2_default_vlan_flooding.log
 *  
 *  Test Topology :
 *
 *                   +----------------------------+
 ...
 *    ============================================
 *    Create a vlan with three ports
 * 
 ...
 *    ==========================================
 *
 *      (3.1) Send a UUC packet and make sure the packet is flooded to the other two ports
 *      (3.2) Send a UMC packet and make sure the packet is flooded to the other two ports
 *      (3.3) Send a BC packet and make sure the packet is flooded to the other two ports
 *
 *      Expected Result:
 *      ================
...
{
    char   str[512];
    int expected_rx_count, pass1, pass2, pass3;
    ...
    printf("\n----------------------------------------------------------- \n");
    printf("    RESULT OF UNKNOWN UNICAST PACKET FLOODING VERIFICATION  ");
    printf("\n----------------------------------------------------------- \n");
    ...
    printf("Verify multicast pkt from port %d forwarding to the other 2 ports\n", ingress_port);
    ...
    printf("\n----------------------------------------------------------- \n");
    printf("    RESULT OF MULTICAST PACKET FLOODING VERIFICATION  ");
    printf("\n----------------------------------------------------------- \n");
    ...
    printf("Verify broadcast pkt from port %d forwarding to the other 2 ports\n", ingress_port);
    ...
    printf("\n----------------------------------------------------------- \n");
    printf("    RESULT OF BROADCAST PACKET FLOODING VERIFICATION  ");
    printf("\n----------------------------------------------------------- \n");
