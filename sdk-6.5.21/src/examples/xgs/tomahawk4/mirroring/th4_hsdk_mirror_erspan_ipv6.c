/*
 * Feature  : Mirror packets destined for a egress port
 *            with ERSPAN IPv6 encapsulation.
 *
 * Usage    : BCM.0> cint th4_hsdk_mirror_erspan_ipv6.c
 *
 * config   : th4_hsdk_mirroring_config.yml
 *
 * Log file : th4_hsdk_mirror_erspan_ipv6_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
 ...
 *   egress_port1 to the mirror-to-port (mtp_port) with ERSPAN (Encapsulated
 *   Remote Switch Port Analyzer) IPv6 encapsulation.
 *
 ...
 *       0x81, 0x00, 0x00, 0x0A, 0x86, 0xdd, 0x60, 0x00, 0x00, 0x00, 0x00, 0x52,
 *       0x2f, 0x05, 0x01, 0x01, 0x01, 0x01, 0x35, 0x00, 0x70, 0x00, 0x00, 0x00,
 *       0x10, 0x09, 0x08, 0x07, 0x06, 0x05, 0x02, 0x02, 0x02, 0x02, 0x36, 0x00,
 *       0x70, 0x00, 0x00, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x00, 0x00,
 *       0x88, 0xbe, 0x00, 0x00, 0x00, 0x00, 0xfe, 0x02, 0x00, 0x00, 0x00, 0x00,
 *       0x00, 0x02, 0x81, 0x00, 0x00, 0x0c, 0x08, 0x00, 0x45, 0x00, 0x00, 0x3c,
 *       0x67, 0x62, 0x00, 0x00, 0xfe, 0x01, 0xbe, 0x76, 0x0a, 0x3a, 0x40, 0x01,
...
setup_mirror_erspan(int unit)
{
    ...
    rv = bcm_mirror_port_dest_add(unit, egress_port1,
                                  mirror_flags,
                                  mirror_dest_id);
    if(BCM_FAILURE(rv)) {
...
cleanup_mirror_erspan(int unit)
{
    ...
    mirror_flags |= BCM_MIRROR_PORT_EGRESS;
    rv = bcm_mirror_port_dest_delete(unit, egress_port1, mirror_flags,
                                     mirror_dest_id);
    if (BCM_FAILURE(rv)) {
...
unsigned char expected_egress_packet2[140] = {
        0x00, 0x00, 0x00, 0x01, 0x02, 0x33, 0x00, 0x00, 0x00, 0x01, 0x02, 0x44,
        0x81, 0x00, 0x00, 0x0a, 0x86, 0xdd, 0x60, 0x00, 0x00, 0x00, 0x00, 0x52,
        0x2f, 0x05, 0x01, 0x01, 0x01, 0x01, 0x35, 0x00, 0x70, 0x00, 0x00, 0x00,
        0x10, 0x09, 0x08, 0x07, 0x06, 0x05, 0x02, 0x02, 0x02, 0x02, 0x36, 0x00,
