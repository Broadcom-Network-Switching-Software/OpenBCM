/*
 * Feature  : Mirror packets ingressing on a port with ERSPAN
 *            IPv4 encapsulation.
 *
 * Usage    : BCM.0> cint th4_hsdk_mirror_erspan_ipv4.c
 *
 * config   : th4_hsdk_mirroring_config.yml
 *
 * Log file : th4_hsdk_mirror_erspan_ipv4_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
 ...
 *   Remote Switch Port Analyzer) IPv4 encapsulation.
 *
