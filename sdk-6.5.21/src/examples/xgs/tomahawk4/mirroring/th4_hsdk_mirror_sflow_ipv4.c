/*
 * Feature  : Mirror packets ingressing on a port with SFLOW
 *            IPv4 encapsulation.
 *
 * Usage    : BCM.0> cint th4_hsdk_mirror_sflow_ipv4.c
 *
 * config   : th4_hsdk_mirroring_config.yml
 *
 * Log file : th4_hsdk_mirror_sflow_ipv4_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
 ...
 *   ingress_port to the mirror-to-port (mtp_port) with SFLOW
 *   IPv4 encapsulation.
 *
 ...
 *
 *     The packet capture shows the egress packet transmitted on outgoing port
 *     (mtp_port) as per the mirror SFLOW setup.
 *
 *     Egress Packet 2:
...
unsigned char expected_egress_packet2[122] = {
        0x00, 0x00, 0x00, 0x01, 0x02, 0x33, 0x00, 0x00, 0x00, 0x01, 0x02, 0x44,
        0x81, 0x00, 0x00, 0x0a, 0x08, 0x00, 0x45, 0x00, 0x00, 0x68, 0x00, 0x00,
        0x00, 0x00, 0x05, 0x11, 0xaf, 0x80, 0x02, 0x02, 0x02, 0x02, 0x01, 0x01,
        0x01, 0x01, 0x12, 0x34, 0x43, 0x21, 0x00, 0x54, 0x00, 0x00, 0x00, 0x00,
