/*
 * Feature  : Mirror packets ingress on a port and verify the
 *            mirror flex sample stat.
 *
 * Usage    : BCM.0> cint th4_hsdk_mirror_flex_sample_stat.c
 *
 * config   : th4_hsdk_mirroring_config.yml
 *
 * Log file : th4_hsdk_mirror_flex_sample_stat_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
 ...
 *   ingress_port to the mirror-to-port (mtp_port) and verify the mirror flex
 *   sample stat.
 *
 ...
 *
 *     c) Configuration (Done in setup_mirror_ingress()):
 *   =========================================================
 ...
 *       c.3) Create and set mirror profile using type bcmMirrorSampleTypeFlex.
 *       c.4) Attach the created sample profile id to an IFP entry
 *       c.5) L2 learn mode is set up on ingress and egress ports.
 *
