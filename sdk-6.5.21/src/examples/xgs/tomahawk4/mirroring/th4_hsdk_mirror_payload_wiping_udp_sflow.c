/*
 * Feature  : Mirror packets ingressing on a port with SFLOW IPv4
 *            encapsulation and payload values get wiped from the
 *            end of the L3 payload UDP packet post configured offset.
 *
 * Usage    : BCM.0> cint th4_hsdk_mirror_payload_wiping_udp_sflow.c
 *
 * config   : th4_hsdk_mirroring_config.yml
 *
 * Log file : th4_hsdk_mirror_payload_wiping_udp_sflow_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
 ...
 *   ingress_port to the mirror-to-port (mtp_port) with SFLOW IPv4
 *   encapsulation and payload values get wiped from L3 payload UDP packet
 *   post configured offset.
 *
 ...
 *       0x81, 0x00, 0x00, 0x0a, 0x08, 0x00, 0x45, 0x00, 0x00, 0x88, 0x00, 0x00,
 *       0x00, 0x00, 0x05, 0x11, 0xaf, 0x60, 0x02, 0x02, 0x02, 0x02, 0x01, 0x01,
 *       0x01, 0x01, 0x12, 0x34, 0x43, 0x21, 0x00, 0x74, 0x00, 0x00, 0x00, 0x00,
 *       0x00, 0x00, 0x01, 0x00, 0x02, 0x00, 0x84, 0x80, 0x00, 0x00, 0x00, 0x00,
 *       0x00, 0x00, 0x00, 0x01, 0x00, 0x2a, 0x10, 0x77, 0x77, 0x00, 0x08, 0x00,
 *       0x45, 0x00, 0x00, 0x4a, 0x00, 0x00, 0x00, 0x00, 0x40, 0x11, 0x0d, 0xd6,
 *       0x10, 0x10, 0x10, 0x11, 0x0a, 0x3a, 0x42, 0x73, 0x55, 0x55, 0x66, 0x66,
...
/* Mirror ingress SFLOW configuration. */
bcm_error_t
setup_mirror_sflow(int unit)
{
    ...
    payload_zero_config_array[0].field_id = bcmMirrorPayloadZeroUdpPort0;
    payload_zero_config_array[0].protocol_port_value = 0x6666;
    payload_zero_config_array[0].protocol_port_offset = 2;
    ...
    printf("SFLOW mirror destination create\n");
    ...
    mirror_dest.initial_seq_number = 0xA;
    mirror_dest.flow_label = 0xDEA9;
...
test_setup(int unit)
{
    ...
    if (BCM_E_NONE != setup_mirror_sflow(unit)) {
        printf("setup_mirror_sflow() failed.\n");
        return -1;
    }
...
int test_cleanup(int unit)
{
    ...
    if (BCM_E_NONE != cleanup_mirror_sflow(unit)) {
        printf("cleanup_mirror_sflow() failed.\n");
        return -1;
    }
...
unsigned char expected_egress_packet1[100] = {
        0x00, 0x00, 0x00, 0x00, 0xfe, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02,
        0x81, 0x00, 0x00, 0x0c, 0x08, 0x00, 0x45, 0x00, 0x00, 0x4a, 0x00, 0x00,
        0x00, 0x00, 0x3f, 0x11, 0x0e, 0xd6, 0x10, 0x10, 0x10, 0x11, 0x0a, 0x3a,
        0x42, 0x73, 0x55, 0x55, 0x66, 0x66, 0x00, 0x36, 0xda, 0xe5, 0x00, 0x01,
        0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d,
        0x0e, 0x0f, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19,
        0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f, 0x20, 0x21, 0x22, 0x23, 0x24, 0x25,
        0x26, 0x27, 0x28, 0x29, 0x2a, 0x2b, 0x2c, 0x2d, 0x29, 0x19, 0x77, 0x37,
        0x4c, 0xa9, 0x48, 0x5e};
...
bcm_error_t testVerify(int unit)
{
    ...
    snprintf(str, 512, "tx %d pbm=%d data=0x000000000001002A1077770008004500004A0000000040110dd6101010110A3A4273555566660036DAe5000102030405060708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F202122232425262728292A2B2C2D291977374CA9485E; sleep quiet 3",count, ingress_port);
    bshell(unit, str);
 ...
 *  This function does the following
 *  a) Test setup
 *  b) Actual configuration (done in setup_mirror_sflow())
