/*
 * Feature  : Mirror packets ingressing on a port.
 *
 * Usage    : BCM.0> cint th4_hsdk_mirror_ingress.c
 *
 * config   : th4_hsdk_mirroring_config.yml
 *
 * Log file : th4_hsdk_mirror_ingress_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
 ...
 *   ingress_port to the mirror-to-port (mtp_port).
 *
