/*
 * Feature  : Mirror packets ingressing on a port with ERSPAN IPv4
 *            encapsulation and payload values get wiped from the
 *            end of the L2 payload packet post configured offset.
 *
 * Usage    : BCM.0> cint th4_hsdk_mirror_payload_wiping_l2_erspan.c
 *
 * config   : th4_hsdk_mirroring_config.yml
 *
 * Log file : th4_hsdk_mirror_payload_wiping_l2_erspan_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
 ...
 *   wiped from L2 payload packet post configured offset.
 *
 ...
 *            - field_id : bcmMirrorPayloadZeroL2Offset
...
setup_mirror_erspan(int unit)
{
    ...
    payload_zero_config_array[0].field_id = bcmMirrorPayloadZeroL2Offset;
    payload_zero_config_array[0].protocol_port_value =
                                    BCM_MIRROR_PAYLOAD_ZERO_INVALID_PROTO_PORT;
    payload_zero_config_array[0].protocol_port_offset = 1;
