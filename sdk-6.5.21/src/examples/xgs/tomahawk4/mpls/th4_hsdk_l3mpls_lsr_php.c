 ...
 *
 * Usage    : BCM.0> cint th4_hsdk_l3mpls_lsr_php.c
 *
 * config   : bcm56990-generic-l3mpls.config.yml
 *
 * Log file : th4_hsdk_l3mpls_lsr_php_log.txt
 *
 * Test Topology :
 *
 *                  +------------------------------+
 ...
 *     8847 000a a101 4500 003c 6762 0000 fe01
 *     be76 0a3a 4001 0a3a 4273 0000 550a 0001
...
bcm_error_t test_cleanup(int unit)
{
	...
	if (BCM_FAILURE(rv = clear_lsr_php(unit))){
        printf("clear_lsr_php() failed.\n");
        return rv;
	}
