/*  Feature  : L3 MPLS tunnel initiation ipecn to exp mapping trust tunnel
 *
 *  Usage    : BCM.0> cint th4_hsdk_l3mpls_init_ecn2exp_trust_tunnel.c
 *
 *  config   : bcm56990-generic-l3mpls.config.yml
 *
 *  Log file : th4_hsdk_l3mpls_init_ecn2exp_trust_tunnel_log.txt
 *
 * Test Topology :
 *
 *                  +------------------------------+
...
config_l3_mpls_init(int unit)
{
	...
	label_array[0].flags = BCM_MPLS_EGRESS_LABEL_TTL_SET | BCM_MPLS_EGRESS_LABEL_ECN_TO_EXP_MAP | BCM_MPLS_EGRESS_LABEL_EXP_SET | BCM_MPLS_EGRESS_LABEL_ECN_EXP_MAP_TRUST;
...
void test_verify(int unit)
{
    ...
    printf("\n----------------------------------------------------------------------------- \n");
    printf("    RESULT OF L3MPLS TUNNEL INITIATION ECN2EXP MAPPING TRUST TUNNEL VERIFICATION  ");
    printf("\n----------------------------------------------------------------------------- \n");
