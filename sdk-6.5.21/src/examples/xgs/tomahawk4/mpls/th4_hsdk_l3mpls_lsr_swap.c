 ...
 *
 *   2) Step2 - Configuration (Done in config_lsr_swap_1()):
 *   =========================================================
 ...
 *       8847 0022 2001 000a a140 4500 003c 6762
 *       0000 fe01 be76 0a3a 4001 0a3a 4273 0000
 *       550a 0001 0051 6162 6364 6566 6768 696a
 *       6b6c 6d6e 6f70 7172 7374 7576 7761 6263
 *       6465 6667 6869
...
config_lsr_swap_1(int unit)
{
    ...
    rv = create_egr_obj(unit, intf_id, nh_mac, egress_port, out_tunnel_label, &egr_obj);
    if (BCM_FAILURE(rv)) {
...
bcm_error_t test_cleanup(int unit)
{
	...
	if (BCM_FAILURE(rv = clear_lsr_swap_1(unit))){
        printf("clear_lsr_swap_1() failed.\n");
        return rv;
	}
 ...
 *  a) test setup
 *  b) actual configuration (Done in config_lsr_swap_1())
...
execute(void)
{
    ...
    print "~~~ #2) config_lsr_swap_1(): ** start **";
    if (BCM_FAILURE((rv = config_lsr_swap_1(unit)))) {
        printf("config_lsr_swap_1() failed.\n");
        return rv;
    }
    print "~~~ #2) config_lsr_swap_1(): ** end **";
