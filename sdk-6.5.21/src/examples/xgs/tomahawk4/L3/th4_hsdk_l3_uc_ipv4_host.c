 ...
 * Feature  : L3 routing
 *
 * Usage    : BCM.0> cint th4_hsdk_l3_uc_ipv4_host.c
 *
 * config   : th4_hsdk_l3_64x400.config.yml
 *
 * Log file : th4_hsdk_l3_uc_ipv4_host_log.txt
 *
 * Test Topology :
 *                      +--------------------+
 *                      |                    |
 ...
 *     c) Configure a basic IPv4 host. This adds the host in L3 ALPM table
...
test_verify(int unit)
{
    ...
    /* print counter value. */
    printf("Routed through host: %d packets / %d bytes\n", COMPILER_64_LO(counter_value.value[0]),
