 ...
 *            and IFP drop events.Mirror to multiple destinations with PSAMP encap.
 *
 * Usage    : BCM.0> cint th4_hsdk_mod_ipipe_multi_dest.c
 *
 * config   : th4_hsdk_mod_config.yml
 *
 * Log file : th4_hsdk_mod_ipipe_multi_dest_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
 ...
 *   ingress_port to multi dest with multi ip address group.
 *
 ...
 *     08 00 45 02 00 88 00 00 40 00 02 11 32 D4 02 10
 *     10 A0 02 30 30 B0 00 00 00 00 00 74 00 00 00 0A
 ...
 *     Egress Packet 2:
 *     00 11 12 13 14 15 00 01 02 03 04 05 81 00 00 05
 *     08 00 45 02 00 88 00 00 40 00 02 11 42 F4 02 10
 *     10 A0 02 20 20 A0 00 00 00 00 00 74 00 00 00 0A
...
setup_mirror_ingress(int unit)
{
    ...
    bcm_ip_t                          ip_addrs[2] = {0x022020a0, 0x023030b0};
...
unsigned char expected_egress_packet1[154] = {
        ...
        0x08, 0x00, 0x45, 0x02, 0x00, 0x88, 0x00, 0x00, 0x40, 0x00, 0x02, 0x11, 0x32, 0xD4, 0x02, 0x10,
        0x10, 0xA0, 0x02, 0x30, 0x30, 0xB0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x74, 0x00, 0x00, 0x00, 0x0A,
...
unsigned char expected_egress_packet2[154] = {
        0x00, 0x11, 0x12, 0x13, 0x14, 0x15, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x81, 0x00, 0x00, 0x05,
        0x08, 0x00, 0x45, 0x02, 0x00, 0x88, 0x00, 0x00, 0x40, 0x00, 0x02, 0x11, 0x42, 0xF4, 0x02, 0x10,
        0x10, 0xA0, 0x02, 0x20, 0x20, 0xA0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x74, 0x00, 0x00, 0x00, 0x0A,
