 ...
 *            and IFP drop events with ERSPAN encapsulation.
 *
 * Usage    : BCM.0> cint th4_hsdk_mod_ipipe_erspan.c
 *
 * config   : th4_hsdk_mod_config.yml
 *
 * Log file : th4_hsdk_mod_ipipe_erspan_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
 ...
 *     08 00 45 02 00 58 00 00 40 00 02 2F 44 16 02 10
 *     10 A0 11 10 10 A0 00 00 88 BE 00 00 00 00 00 22
...
unsigned char expected_egress_packet1[106] = {
        0x00, 0x11, 0x12, 0x13, 0x14, 0x15, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x81, 0x00, 0x00, 0x05,
        0x08, 0x00, 0x45, 0x02, 0x00, 0x58, 0x00, 0x00, 0x40, 0x00, 0x02, 0x2F, 0x44, 0x16, 0x02, 0x10,
        0x10, 0xA0, 0x11, 0x10, 0x10, 0xA0, 0x00, 0x00, 0x88, 0xBE, 0x00, 0x00, 0x00, 0x00, 0x00, 0x22,
