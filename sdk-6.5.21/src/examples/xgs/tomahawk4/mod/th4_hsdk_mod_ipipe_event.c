/*
 * Feature  : Mirror packets dropped in ingress pipeline for invalid vlan
 *            and IFP drop events.
 *
 * Usage    : BCM.0> cint th4_hsdk_mod_ipipe_event.c
 *
 * config   : th4_hsdk_mod_config.yml
 *
 * Log file : th4_hsdk_mod_ipipe_event_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
