...
// Settings for Firebolt6
opt_DoPayloadWiping = 0;    // Does not support payload wiping
opt_IsPortBlackHawk = 0;    // Does not have BH cores
opt_IsDevTomahawk3 = 0;     // TH3 registers are not valid for Firebolt6

// Print all the applied options
