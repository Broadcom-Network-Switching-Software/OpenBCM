 ...
 *
 * Usage    : BCM.0> cint vxlan_v4_vplag_acc_to_net_uc.c
 *
 * config   : config_fb6_flex.bcm
 *
 * Log file : vxlan_v4_vplag_acc_to_net_uc_log.txt
 *
 * Test Topology :
 *                                                                                     Underlay+NextHop
