 ...
 *
 * Usage    : BCM.0> cint vxlan_v4_acc_to_net_ecmp.c
 *
 * config   : BCM56275_A1-BRIDGE-FLEXFLOW.bcm
 *
 * Log file : vxlan_v4_acc_to_net_ecmp_log.txt
 *
 * Test Topology :
 *                                                                                       Underlay+NextHop
...
config_vxlan_ipv4_vtep(int unit)
{
    ...
    rtag7_cfg_t rtag7_cfg = {
        ...
        0,              /*Entropy enable. 0='Don't use Entropy as UDP Src Port';1='Use Entropy as UDP Src Port'*/
