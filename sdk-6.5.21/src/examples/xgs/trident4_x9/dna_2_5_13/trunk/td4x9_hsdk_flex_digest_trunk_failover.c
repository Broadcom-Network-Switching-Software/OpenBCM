...
/*
 * Feature  : Flex Digest configuration along with Trunk on td4x9
 *
 * Usage    : BCM.0> cint td4x9_hsdk_flex_digest_trunk_failover.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_trunk.config.yml
 *
 * Log file : td4x9_hsdk_flex_digest_trunk_failover_log.txt
 *
 * Test Topology :
 ...
 *                     |            FailoverEgressPort1+--------->
 *  Set-1:             |                   |
 *  DMAC=00::01        |            FailoverEgressPort1+--------->
 *  SMAC=00:XX         |                   |
 *  VLAN=2             |            FailoverEgressPort1+--------->
                       |                   |          TRUNK
 *                     |                   |         ID = 0
 *                     |                   |
 *                     |  BCM56780(td4.x9) |
 ...
 *        egress_port trunk ports and three as Failover Egress port
 *
...
configure_trunk_failoversetup(int unit, int port_count, bcm_port_t *port_arr, bcm_vlan_t vid)
{
    ...
    int i;
    int tid = 0;
    int failover_member_count = 3;
    bcm_gport_t failover_gport_array[3] = {0,};
...
verify(int unit)
{
    ...
    printf("Executing 'fail port to down'\n");
