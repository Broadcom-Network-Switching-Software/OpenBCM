...
/*
 * Feature  : Flex Digest configuration along with Trunk on td4x9 for non uc case
 *
 * Usage    : BCM.0> cint td4x9_hsdk_port_trunk_flex_digest_non_uc.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_trunk-mc.config.yml
 *
 * Log file : td4x9_hsdk_port_trunk_flex_digest_non_uc_log.txt
 *
 * Test Topology :
 *
 *                     +-------------------+
 ...
 *
 *  Ingress Packet:
 *  Increment source mac is sent on the ingress port and packet are forwarded based on LAG resolution.
