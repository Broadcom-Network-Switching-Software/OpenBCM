 ...
 * Usage    : BCM.0> cint td4x9_hsdk_l2_drop_unknown_mac.c
 *
 * config   : bcm56780_a0-generic-l2.config.yml
 *
 * Log file : td4x9_hsdk_l2_drop_unknown_mac_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |  egress_port_1
 ...
 *
 *   step: delete the l2 static entry to verify UNKNOWN_UCAST_DROP
 *   Ingress Packet: port 1
 *   [bcmPWN.0]Packet[1]: data[0000]: {000000000011} {000000000002} 8100 0014
 *   [bcmPWN.0]Packet[1]: data[0010]: 0806 0001 0800 0604 0001 0000 0000 0002
 *   [bcmPWN.0]Packet[1]: data[0020]: 0a0a 0a02 0000 0000 0000 1414 1402 0001
 *   [bcmPWN.0]Packet[1]: data[0030]: 0203 0405 0607 0809 0a0b 0c0d bc94 977f
 *
 *   No egress packets as unknown unicast packets are dropped
 */
...
setup_l2_multicast_group(int unit,bcm_vlan_t vlanId)
{
    ...
    /*drop any unknown unicast packet*/
