...
/*
 * Feature  : L2 switching for mc packets on trunk group using flexdigest
 *
 * Usage    : BCM.0> cint td4x9_hsdk_l2_mc_trunk_flexdigest.c
 *
 * config   : bcm56780_a0-generic-l2.config.yml
 *
 * Log file : td4x9_hsdk_l2_mc_trunk_flexdigest_log.txt
 *
 * Test Topology :
 ...
 * Summary:
 * ========
 * cint script to demonstrate L2 multicast forwarding on trunk ports.
 *
 ...
 *
 *   Ingress Packet:
 *   Send 10 multicast packets with increment source mac on ingress port:1, Src mac =0x02 to 0x0b  
 *   0000 0000 0011 0000 0000 0002 8100 0001
 ...
 *
 *   Egress Packet:
 *   the same 10 ingress packets be seen on egress trunk member ports 2 or 3 depending on the hash computation
 *   0000 0000 0011 0000 0000 0002 8100 0001
 *   0806 0001 0800 0604 0001 0000 0000 0002
 *   0a0a 0a02 0000 0000 0000 1414 1402 0001
 *   0203 0405 0607 0809 0a0b 0c0d bc94 977f
...
verify(int unit)
{
    ...
    bshell(unit, "clear c");
    printf("\nSending 10 multicast packets with increment source mac on ingress port:%d\n",ingress_port);
    snprintf(str, 512, "tx 10 pbm=%d DestMac=0x01005e000011 SourceMac=0x3214 SourceMacInc=1 vlan=20 len=80; sleep quiet 2", ingress_port);
    bshell(unit, str);
    print "show c";
    bshell(unit, "show c");
...
*/
  ...
  /* Configure static l2 mc entry for forwarding */
