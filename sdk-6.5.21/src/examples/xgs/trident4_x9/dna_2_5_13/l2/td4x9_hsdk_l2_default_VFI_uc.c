...
/*
 * Feature  : L2 switching for untagged packets by configuring default VFI
 *
 * Usage    : BCM.0> cint td4x9_hsdk_l2_default_VFI_uc.c
 *
 * config   : bcm56780_a0-generic-l2.config.yml
 *
 * Log file : td4x9_hsdk_l2_default_VFI_uc_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
