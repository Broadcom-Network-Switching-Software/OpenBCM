 ...
 *
 * Usage    : BCM.0> cint td4x9_hsdk_l2_mc.c
 *
 * config   : bcm56780_a0-generic-l2.config.yml
 *
 * Log file : td4x9_hsdk_l2_mc_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
...
verify(int unit)
{
    ...
    snprintf(str, 512, "tx 1 pbm=%d data=0x01005E0000110000000000058100001408004500002E0000000040FF79D20000000000000000000102030405060708090A0B0C0D0E0F101112131415161718194FC0F25E; sleep quiet 2", ingress_port);
    bshell(unit, str);
    print "show c";
    bshell(unit, "show c");
