...
/*
 * Feature  : VLAN/VFI flooding for unicast DLF packets on td4x9
 *
 * Usage    : BCM.0> cint td4x9_hsdk_l2_dlf_uc.c
 *
 * config   : bcm56780_a0-generic-l2.config.yml
 *
 * Log file : td4x9_hsdk_l2_dlf_uc_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
 ...
 * Summary:
 * ========
 * cint script to demonstrate flooding the unicast dlf packet on its vlan/vfi member ports.
 *
