...
/*
 * Feature  : verify vlan membership check
 *
 * Usage    : BCM.0> cint td4x9_hsdk_vlan_membership.c
 *
 * config   : bcm56780_a0-generic-l2.config.yml
 *
 * Log file : td4x9_hsdk_vlan_membership_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
 ...
 * Summary:
 * ========
 * cint script to demonstrate vlan membership check on td4x9
 *
