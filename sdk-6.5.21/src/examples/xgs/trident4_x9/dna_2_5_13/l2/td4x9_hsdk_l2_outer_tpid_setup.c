 ...
 *
 * Usage    : BCM.0> cint td4x9_hsdk_l2_outer_tpid_setup.c
 *
 * config   : bcm56780_a0-generic-l2.config.yml
 *
 * Log file : td4x9_hsdk_l2_outer_tpid_setup_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
...
verify(int unit)
{
    ...
    snprintf(str, 512, "tx 1 pbm=%d data=0x00000000001100000000000291000014080600010800060400010000000000020A0A0A0200000000000014141402000102030405060708090a0b0c0dbc94977f; sleep quiet 2", ingress_port);
    bshell(unit, str);
    print "show c";
    bshell(unit, "show c");
