...
/*
 * Feature  : Protocol packets handling
 *
 * Usage    : BCM.0> cint td4x9_hsdk_l2_protocol.c
 *
 * config   : bcm56780_a0-generic-l2.config.yml
 *
 * Log file : td4x9_hsdk_l2_protocol_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
...
verify(int unit)
{
    ...
    snprintf(str, 512, "tx 1 pbm=%d data=0x000000000D00000000000C0008004500002E0000000040015CBC1400000A0A00000A0800AFAE00000000000102030405060708090A0B0C0D0E0F1011AC32E22B; sleep quiet 2", ingress_port);
    bshell(unit, str);
    bshell(unit, "show c");
    printf("\nverify l2 learning:\n");
    bshell(unit, "l2 show");
