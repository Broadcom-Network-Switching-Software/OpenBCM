...
/*
 * Feature  : VLAN/VFI flooding for unicast DLF packets on td4x9 without creating an L2MC group explicitly(legacy chips behavior).
 *
 * Usage    : BCM.0> cint td4x9_hsdk_l2_default_vlan_flooding.c
 *
 * config   : bcm56780_a0-generic-default_vlan_flooding_config.yml
 *
 * Log file : td4x9_hsdk_l2_default_vlan_flooding_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
 ...
 *
 * In TD4, we need to set "vlan_flooding_l2mc_num_reserved(2048 is default)" config variable in yml file to keep with legacy behavior
