...
/*
 * Feature  : L2 switching for outer tagged packets by configuring mapped VFI
 *
 * Usage    : BCM.0> cint td4x9_hsdk_vlan_vfi_from_vlan_identity_mapping.c
 *
 * config   : bcm56780_a0-generic-vlan.config.yml
 *
 * Log file : td4x9_hsdk_vlan_vfi_from_vlan_identity_mapping_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
 ...
 * Summary:
 * ========
 * cint script to demonstrate L2 forwarding for outer tagged
 * packets on switch using identity mapped VFI configuration(ING_VFI_TABLE)
 *
