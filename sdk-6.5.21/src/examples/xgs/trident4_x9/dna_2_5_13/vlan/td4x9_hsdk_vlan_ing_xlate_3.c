...
/*
 * Feature  : VFI assignment for double tagged packets using
 *            ingress vlan translate table
 *
 * Usage    : BCM.0> cint td4x9_hsdk_vlan_ing_xlate_3.c
 *
 * config   : bcm56780_a0-generic-vlan.config.yml
 *
 * Log file : td4x9_hsdk_vlan_ing_xlate_3_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
 ...
 * Summary:
 * ========
 * cint script to demonstrate VFI assignment based on
 * ingress port+pkt outer vlan+pkt inner vlan
 *
