...
/*
 * Feature  : Default VFI assignment for ingress untagged packets
 *
 * Usage    : BCM.0> cint td4x9_hsdk_vlan_untag_ingress_pkt.c
 *
 * config   : bcm56780_a0-generic-vlan.config.yml
 *
 * Log file : td4x9_hsdk_vlan_untag_ingress_pkt_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
 ...
 * Summary:
 * ========
 * cint script to demonstrate default VFI and/or default pri/cfi
 * configuration for ingress untagged packets on switch
 *
 ...
 *
 *   Egress Packet:
 *   000000000011 000000000002 8100 3014   > dot1p=1 cfi=1
...
setup_vlan_switching(int unit)
{
    ...
    default_action.new_outer_cfi = 1;
