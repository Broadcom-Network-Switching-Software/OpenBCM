...
/*
 * Feature  : TPID assignment for egress packets
 *
 * Usage    : BCM.0> cint td4x9_hsdk_vlan_egr_tpid_config.c
 *
 * config   : bcm56780_a0-generic-vlan.config.yml
 *
 * Log file : td4x9_hsdk_vlan_egr_tpid_config_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
 ...
 * Summary:
 * ========
 * cint script to demonstrate TPID assignment for egress packets
 *
...
verify(int unit)
{
    ...
    bshell(unit, "l2 show");
    bshell(unit, "clear c");
    printf("\nSending dtag unicast packet to ingress port:%d\n",ingress_port);
