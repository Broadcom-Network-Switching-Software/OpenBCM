...
/*
 * Feature  : Drop Event, trigger several drop events in egress pipeline and check they are
 *            properly counted to related Drop Event counters.
 *
 * Usage    : BCM.0> cint td4x9_hsdk_dropevent_ep_counters.c
 *
 * Config   : bcm56780_a0-generic-48x100-8x400_event.config.yml
 *
 * Log file : td4x9_hsdk_dropevent_ep_counters_log.txt
 *
 * Test Topology :
 *
 *
 ...
 *        This does the necessary configurations to create EFP rule to drop
 *        packet with OutPort Qualifier for specific egress ports.
 *
 ...
 *           Counter 'bcmPktDropEventEgressEfpDrop' should be 0.
 ...
 *           Counter 'bcmPktDropEventEgressEfpDrop' should be 1.
 ...
 *           Counter 'bcmPktDropEventEgressStgBlockDrop' should be 1.
