...
/*
 * Feature  : Trace Event, mirror 'Ingress Pipeline: Station Move for Static L2 Source address' 
 *            packets to MTP (Mirror-to-Port).
 *
 * Usage    : BCM.0> cint td4x9_hsdk_traceevent_ip_mirror_to_mtp.c
 *
 * Config   : bcm56780_a0-generic-48x100-8x400_event.config.yml
 *
 * Log file : td4x9_hsdk_traceevent_ip_mirror_to_mtp_log.txt
 *
 * Test Topology :
 *
 *
