 ...
 *
 * Usage    : BCM.0> cint td4x9_hsdk_traceevent_ip_copy_to_cpu.c
 *
 * Config   : bcm56780_a0-generic-48x100-8x400_event.config.yml
 *
 * Log file : td4x9_hsdk_traceevent_ip_copy_to_cpu_log.txt
 *
 * Test Topology :
 *
 *
 ...
 *       Counter 'bcmPktTraceEventIngressL2SrcStaticMove' should be 1 
