 ...
 *
 *  Usage    : BCM.0> cint td4x9_hsdk_l3_ip_tunnel_ipgre_4in6.c
 *
 *  config   : bcm56780_a0-generic-48x100-8x400_l3.config.yml
 *
 *  Log file : td4x9_hsdk_l3_ip_tunnel_ipgre_4in6_log.txt
 *
 *  Test Topology :
 *
 *                   +------------------------------+
 ...
 *
 *      e) Configure tunnel initiator(type = bcmTunnelTypeGreAnyIn6)
 *         on network side L3 interface.
 *
 *      f) Configure tunnel terminator(type = bcmTunnelTypeGreAnyIn6)
...
bcm_error_t config_l3_tunnel_ipgre_4in6(int unit)
{
  ...
  tnl_init_info.type = bcmTunnelTypeGreAnyIn6; /* Choose GRE Ipv4-in-Ipv6 tunnel type */
  ...
  tnl_term_info.type      = bcmTunnelTypeGreAnyIn6; /* Choose GRE Ipv4-in-Ipv6 tunnel type */
