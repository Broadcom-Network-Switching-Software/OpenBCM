 ...
 *
 * Usage    : BCM.0> cint td4x9_hsdk_l3_ipuc_ipv4_host_L3DstMiscClassId.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_l3.config.yml
 *
 * Log file : td4x9_hsdk_l3_ipuc_ipv4_host_L3DstMiscClassId.txt
 *
 * Test Topology :
 *
 *                  +------------------------------+
...
ingress_port_setup(int unit, bcm_port_t port)
{
   ...
   /* Qualify host.l3a_opaque_ctrl_id configured in host entry */
    BCM_IF_ERROR_RETURN(bcm_field_qualify_L3DstMiscClassId(unit, entry, 3, 0x7));
