...
/*
 * Feature  : L3 IP Urpf Strict mode for ECMP
 *
 * Usage    : BCM.0> cint td4x9_hsdk_l3_ip_ecmp_urpf_strict_mode.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_l3.config.yml
 *
 * Log file : td4x9_hsdk_l3_ip_ecmp_urpf_strict_mode_log.txt
 *
 * Test Topology :
 *
 *                    +------------------------------+          DMAC 0xfe02
 ...
 * Summary:
 * ========
 *   This Cint example to show configuration of the IP Urpf Strict mode for ECMP
 *   BCM APIs.
 *
...
configure_ip_urpf_mode(int unit)
{
  ...
  l3_ingress.vrf       = vrf;
  l3_ingress.urpf_mode = bcmL3IngressUrpfStrict; /* IP URPF Strcit mode */
