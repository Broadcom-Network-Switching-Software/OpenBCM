...
/*
 * Feature  : L3 IPv4 Unicast Route pointing ECMP
 *
 * Usage    : BCM.0> cint td4x9_hsdk_l3_ip_ecmp_route.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_l3.config.yml
 *
 * Log file : td4x9_hsdk_l3_ip_ecmp_route_log.txt
 *
 * Test Topology :
 *
 *                   +------------------------------+
 ...
 * Summary:
 * ========
 *   This Cint example to show configuration of the IPv4 Route entry pointing ECMP scenario
 *   using BCM APIs.
 *
 ...
 *
 *      j) Add Route entry for DIP by pointing L3 egress ECMP object.
 *
...
/*
 * IP ECMP pointing Route configuration.
 */
