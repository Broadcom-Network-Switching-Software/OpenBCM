 ...
 *
 * Usage    : BCM.0> cint td4x9_hsdk_l3_ipmc_route_pfm.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_l3.config.yml
 *
 * Log file : td4x9_hsdk_l3_ipmc_route_pfm_log.txt
 *
 * Test Topology :
 *
 *                  +------------------------------+  egress_port1 cd1
 ...
 *
 *   TD4.X9 doesn't support PFM controls but we can do following configuration.
 *   IPMC miss will lead to the L2MC lookup on TD4.X9 by default.
 *
 *   PFM = 0 {BCM_VLAN_MCAST_FLOOD_ALL}
 ...
 *
 *   TD4.X9 doesn't support different PFM modes for L2MC and IPMC V4/V6.
 *
