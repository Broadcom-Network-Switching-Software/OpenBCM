 ...
 *
 * Usage    : BCM.0> cint td4x9_hsdk_l3_ip_host_frr.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_l3-frr.config.yml
 *
 * Log file : td4x9_hsdk_l3_ip_host_frr_log.txt
 *
 * Test Topology :
 *
 *                   +------------------------------+
...
int verify(int unit)
{
    ...
    snprintf(str, 512, "tx 1 pbm=%d data=0x00000000aaaa0000000022228100000c08004500002e0000000040ff9b140a0a0a0ac0a80a010000000000000000000000000000000000000000000000000000ab47b8cf; sleep quiet 2", ingress_port);
    bshell(unit, str);
    bshell(unit, "show c");
