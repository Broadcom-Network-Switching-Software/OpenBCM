...
/*
 * Feature  : L3 IP Urpf Loose mode
 *
 * Usage    : BCM.0> cint td4x9_hsdk_l3_ip_urpf_loose_mode.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_l3.config.yml
 *
 * Log file : td4x9_hsdk_l3_ip_urpf_loose_mode_log.txt
 *
 * Test Topology :
 *
 *                    +------------------------------+
 ...
 * Summary:
 * ========
 *   This Cint example to show configuration of the IP Urpf Loose mode
 *   BCM APIs.
 *
