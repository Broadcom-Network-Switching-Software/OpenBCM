...
/*
 * Feature  : Mirror-On-Drop, packets dropped in MMU are able to be mirrored to an MTP and encapsulated with an IPv4 PSAMP header.
 *
 * Usage    : BCM.0> cint td4x9_hsdk_mod_ipv4.c
 *
 * config   : BCM956780-56780_A0-mod-config.yml
 *
 * Log file : td4x9_hsdk_mod_ipv4_log.txt
 *
 * Test Topology :
 *
 *                                +----------------------+      
...
data[0050]: 0000 0014 0001 0009 0000 00ff 005e 0000
