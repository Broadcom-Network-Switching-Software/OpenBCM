 ...
 *
 * Usage    : BCM.0> cint td4x9_hsdk_qos_l3_dot1p_to_dscp_remark.c
 *
 * config   : bcm56780_a0-generic-qos.config.yml
 *
 * Log file : td4x9_hsdk_qos_l3_dot1p_to_dscp_remark_log.txt
 *
 * Test Topology :
 *
 *                  +------------------------------+
 ...
 *   [bcmPWN.0]Packet[2]: data[0010]: 0800 450c 002e 0000 0000 3fff 3e8a 1414
