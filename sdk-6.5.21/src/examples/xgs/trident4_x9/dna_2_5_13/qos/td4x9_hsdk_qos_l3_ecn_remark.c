...
/*
 * Feature  : ECN remarking for L3 Ipv4 packets
 *
 * Usage    : BCM.0> cint td4x9_hsdk_qos_l3_ecn_remark.c
 *
 * config   : bcm56780_a0-generic-qos.config.yml
 *
 * Log file : td4x9_hsdk_qos_l3_ecn_remark_log.txt
 *
 * Test Topology :
 *
 *                  +------------------------------+
 ...
 * Summary:
 * ========
 *  Cint example to show the qos configuration for L3 packets ECN remarking
 *
 ...
 *  0800 4503 002e 0000 0000 3fff 3e93 1414
 *  1414 0a0a 0a0a 0000 0000 0000 0000 0000
 *  0000 0000 0000 0000 0000 0000 0000 0000
 *  f3b4 2e69
 */
...
bcm_error_t
ecn_remark_config_set(int unit, int *in_map, int *eg_map)
{
...
configure_ipuc_forwarding(int unit)
{
    ...
    rv = ecn_remark_config_set(unit , &ing_map, &egr_map);
    if (BCM_FAILURE(rv)) {
