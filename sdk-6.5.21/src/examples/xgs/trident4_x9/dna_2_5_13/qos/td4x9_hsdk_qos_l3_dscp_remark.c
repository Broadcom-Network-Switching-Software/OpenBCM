...
/*
 * Feature  : DSCP remarking for L3 Ipv4 packets
 *
 * Usage    : BCM.0> cint td4x9_hsdk_qos_l3_dscp_remark.c
 *
 * config   : bcm56780_a0-generic-qos.config.yml
 *
 * Log file : td4x9_hsdk_qos_l3_dscp_remark_log.txt
 *
 * Test Topology :
 *
 *                  +------------------------------+
 ...
 * Summary:
 * ========
 *   Cint example to show the qos configuration for L3 packets DSCP remarking
 *
 ...
 *
 *   Egress Packet:
 *   [bcmPWN.0]Packet[2]: data[0000]: {000000000022} {000000000011} 8100 e00a
 *   [bcmPWN.0]Packet[2]: data[0010]: 0800 450e 002e 0000 0000 3fff 3e88 1414
 ...
 *   0800 450e 002e 0000 0000 3fff 3e88 1414
 *   1414 0a0a 0a0a 0000 0000 0000 0000 0000
 *   0000 0000 0000 0000 0000 0000 0000 0000
 *   f3b4 2e69
 */
...
verify(int unit)
{
    ...
    snprintf(str, 512, "tx 1 pbm=%d data=0x0000000000020000000000018100000508004502002e0000000040ff3d94141414140a0a0a0a0000000000000000000000000000000000000000000000000000f3b42e69; sleep quiet 2", ingress_port);
    bshell(unit, str);
    bshell(unit, "l3 host show");
    bshell(unit, "show c");
...
bcm_error_t
dscp_remark_config(int unit, unsigned int flags, unsigned int int_prio, uint8 dscp, bcm_color_t clr, int *map_id)
{
    int qMapId = 0;
    bcm_qos_map_t qMap;
    bcm_error_t rv = BCM_E_NONE;
...
configure_ipuc_forwarding(int unit)
{
    ...
    rv = dscp_remark_config(unit, flags, internal_prio, ing_pkt_dscp, bcmColorGreen, &ing_map);
    if (BCM_FAILURE(rv)) {
