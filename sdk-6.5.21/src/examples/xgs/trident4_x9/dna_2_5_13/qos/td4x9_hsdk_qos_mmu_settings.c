 ...
 *
 *  Usage    : BCM.0> cint td4x9_hsdk_qos_mmu_settings.c
 *
 *  config   : bcm56780_a0-generic-qos.config.yml
 *
 *  Log file : td4x9_hsdk_qos_mmu_settings_log.txt
 *
 *  Test Topology : None
 *
 *  Summary:
 ...
 */
  ...
  * TD4.X9 HSDK to set various MMU threholds. So threshold values used in the script are
  ...
  * into Cells. Cell Size for TD4.X9 is 254 bytes.
...
bcm_error_t mmu_thdo_settings(int unit)
{
  ...
  */
  /* Multicast Queues are from 8-11 for TD4.X9 as per default scheduler config */
