 ...
 *
 *  Usage : BCM.0> cint td4x9_hsdk_fp_range_checker.c YES [MultiRange=0/1] [InvertRange=1/2/3]
 ...
 *           E.g.  cint td4x9_hsdk_fp_range_checker.c YES 0 0      <<<<< One Range,  Non-Invert
 *           E.g.  cint td4x9_hsdk_fp_range_checker.c YES 1 0      <<<<< Two Ranges, Non-Invert
 *           E.g.  cint td4x9_hsdk_fp_range_checker.c YES 0 1      <<<<< One Range,  Inverted
 *           E.g.  cint td4x9_hsdk_fp_range_checker.c YES 1 1      <<<<< Two Ranges, Inverted
 *
 *  config   : BCM956780-56780_A0-fp-config.yml
 *
 *  Log file : td4x9_hsdk_fp_range_checker_log.txt
 *
 *  Test Topology :
 *
 *                   +------------------------------+
