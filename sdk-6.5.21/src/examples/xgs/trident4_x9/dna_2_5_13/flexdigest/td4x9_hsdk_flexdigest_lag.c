 ...
 *
 *  Usage    : BCM.0> cint td4x9_hsdk_flexdigest_lag.c
 *
 *  config   : bcm56780_a0-generic-48x100-8x400_flexdigest.config.yml
 *
 *  Log file : td4x9_hsdk_flexdigest_lag_log.txt
 *
 *  Test Topology :
 *      +-----------------+            +---------+
 *      |         ing-port|<-----------+         |
 ...
 *   for LAG application using BCM APIs.
 *
 ...
 *   =========================================================
 *     a) Configure a basic port, vlan, flexdigest and LAG/trunk functional
