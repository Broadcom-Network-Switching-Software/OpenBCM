 ...
 *
 * Usage    : BCM.0> cint td4x9_hsdk_ipv4_riot_AtoA_uc-l3route.c
 *
 * config   : BCM956780-56780_A0-Default-config.yml
 *
 * Log file : td4x9_hsdk_ipv4_riot_AtoA_uc-l3route_log.txt
 *
 * Test Topology :
 *
 *
 *        +----+                       +---------+                   +---+
 *        |PC1 | ---> Access VFI 1     |   DUT   |  Access VFI 2 --> |PC2|
 *        +----+                       +---------+                   +---+
...
*/
   ...
   /* for l3 route configure */

	if(defaultrountflag == 0)
	{
