 ...
 *
 * Usage    : BCM.0> cint td4x9_hsdk_ipv4_riot_AtoN_uc_HECMP_overlay.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_vxlan.config.yml
 *
 * Log file : td4x9_hsdk_ipv4_riot_AtoN_uc_HECMP_overlay_log.txt
 *
 *            ACCESS                             NETWORK
 *
 *                        +----------------+
 ...
 * SMAC=00::11:11:11      |     DUT        |    DMAC=00::02:02:03
...
verify(int unit)
{
    ...
    printf("\n----------------------------------------------\n");
    bshell(unit, "sleep quiet 2;show c s");
