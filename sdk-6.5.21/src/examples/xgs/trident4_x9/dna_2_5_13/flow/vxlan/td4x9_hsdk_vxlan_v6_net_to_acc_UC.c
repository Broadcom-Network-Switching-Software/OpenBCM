...
/*
 * Feature  : Vxlan Bridging ,  network to access tunnel termination (ipv6 tunnel) Flow with Sipv6 for SVP assignment & VNID to VFI mapping
 *
 * Usage    : BCM.0> cint td4x9_hsdk_vxlan_v6_net_to_acc_UC.c
 *
 * config   : BCM956780-56780_A0-Default-config.yml
 *
 * Log file : td4x9_hsdk_vxlan_v6_net_to_acc_UC_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
