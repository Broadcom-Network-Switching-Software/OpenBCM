 ...
 *
 * Usage    : BCM.0> cint td4x9_hsdk_vxlan_v4_NtoA_net_vp_sharing.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_vxlan.config.yml
 *
 * Log file : td4x9_hsdk_vxlan_v4_NtoA_net_vp_sharing_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
...
Input Hex (network):

...
verify(int unit)
{
    ...
    printf("\nSending known unicast packet to ingress_port network side:%d\n", ingress_port);
    snprintf(str, 1184, "tx 1 pbm=%d data=; sleep quiet 1", ingress_port);
    bshell(unit, str);
    bshell(unit, "sleep 2; show c");
    bshell(unit, "l2 show");
