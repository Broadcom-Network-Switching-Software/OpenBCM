 ...
 *
 * Usage    : BCM.0> cint td4x9_hsdk_vxlan_v4_net_to_acc_trunk_inner_l3.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_vxlan.config.yml
 *
 * Log file : td4x9_hsdk_vxlan_v4_net_to_acc_trunk_inner_l3_log.txt
 *
 * Test Topology :
 *
...
======
tx port=1 data=

tx port=1 data=

tx port=1 data=

tx port=1 data=

tx port=1 data=
...
verify(int unit)
{
    ...
    snprintf(pkt_data[0],512,"%s","");

    snprintf(pkt_data[1],512,"%s","");

    snprintf(pkt_data[2],512,"%s","");

    snprintf(pkt_data[3],512,"%s","");

    snprintf(pkt_data[4],512,"%s","");
...
//  bshell(unit, "hm ieee");
    ...
    printf("\n-----------------------------------------\n");
    bshell(unit, "sleep quiet 2;show counters Changed Same NZ");
    return;
}
...
config_vxlan_access(int unit, vxlan_cfg_t *vxlan_cfg, vxlan_acc_cfg_t *vxlan_acc, bcm_gport_t *acc_flow_port, bcm_flow_handle_t flow_handle)
{
    ...
    if(BCM_GPORT_IS_TRUNK(vxlan_acc->phy_Gport)) /*If gport is a trunk, execute all settings on each member port */
    {
        ...
        for(i=0; i<NO_OF_TRUNK_MEMBERS; i++)
        {
            ...
            BCM_IF_ERROR_RETURN(bcm_port_untagged_vlan_set(unit, egress_phy_gport[i], vxlan_acc->acc_vlan));
            /* Set default inner tpid per port */
            BCM_IF_ERROR_RETURN(bcm_port_inner_tpid_set(unit, egress_phy_gport[i], 0x9100));
            /* Set default outer tpid per port */
            BCM_IF_ERROR_RETURN(bcm_port_tpid_set(unit, egress_phy_gport[i], 0x8100));
            /* Set port learning */
            BCM_IF_ERROR_RETURN(bcm_port_learn_set(unit, egress_phy_gport[i], BCM_PORT_LEARN_ARL | BCM_PORT_LEARN_FWD));
            /* Port must be added to VPN to pass membership check */
            BCM_IF_ERROR_RETURN(bcm_vlan_gport_add(unit, vxlan_cfg->vxlan_vpn, egress_phy_gport[i], 0));
        }
    ...
    for(i=0; i<NO_OF_TRUNK_MEMBERS; i++)
    {
        BCM_IF_ERROR_RETURN(bcm_port_class_set(unit, egress_phy_gport[i], bcmPortClassIngress, acc_port_class));
    }
...
config_FlexDigest(int unit)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_flexdigest_action_add(unit, entry, bcmFlexDigestActionExtractBinSetBCmds0,  BCM_FLEXDIGEST_FIELD_INNER_IP_HDR_SIP_0_15, 0xffff));
    BCM_IF_ERROR_RETURN(bcm_flexdigest_action_add(unit, entry, bcmFlexDigestActionExtractBinSetBCmds1,  BCM_FLEXDIGEST_FIELD_INNER_IP_HDR_SIP_16_31, 0xffff));
    BCM_IF_ERROR_RETURN(bcm_flexdigest_action_add(unit, entry, bcmFlexDigestActionExtractBinSetBCmds2,  BCM_FLEXDIGEST_FIELD_INNER_IP_HDR_SIP_32_47, 0xffff));
    BCM_IF_ERROR_RETURN(bcm_flexdigest_action_add(unit, entry, bcmFlexDigestActionExtractBinSetBCmds3,  BCM_FLEXDIGEST_FIELD_INNER_IP_HDR_SIP_48_63, 0xffff));
    BCM_IF_ERROR_RETURN(bcm_flexdigest_action_add(unit, entry, bcmFlexDigestActionExtractBinSetBCmds4,  BCM_FLEXDIGEST_FIELD_INNER_IP_HDR_SIP_64_79, 0xffff));
    BCM_IF_ERROR_RETURN(bcm_flexdigest_action_add(unit, entry, bcmFlexDigestActionExtractBinSetBCmds5,  BCM_FLEXDIGEST_FIELD_INNER_IP_HDR_SIP_80_95, 0xffff));
    BCM_IF_ERROR_RETURN(bcm_flexdigest_action_add(unit, entry, bcmFlexDigestActionExtractBinSetBCmds6,  BCM_FLEXDIGEST_FIELD_INNER_IP_HDR_SIP_96_111, 0xffff));
    BCM_IF_ERROR_RETURN(bcm_flexdigest_action_add(unit, entry, bcmFlexDigestActionExtractBinSetBCmds7,  BCM_FLEXDIGEST_FIELD_INNER_IP_HDR_SIP_112_127, 0xffff));
    BCM_IF_ERROR_RETURN(bcm_flexdigest_action_add(unit, entry, bcmFlexDigestActionExtractBinSetBCmds8,  BCM_FLEXDIGEST_FIELD_INNER_IP_HDR_DIP_0_15, 0xffff));
    BCM_IF_ERROR_RETURN(bcm_flexdigest_action_add(unit, entry, bcmFlexDigestActionExtractBinSetBCmds9,  BCM_FLEXDIGEST_FIELD_INNER_IP_HDR_DIP_16_31, 0xffff));
    BCM_IF_ERROR_RETURN(bcm_flexdigest_action_add(unit, entry, bcmFlexDigestActionExtractBinSetBCmds10, BCM_FLEXDIGEST_FIELD_INNER_IP_HDR_DIP_32_47, 0xffff));
    BCM_IF_ERROR_RETURN(bcm_flexdigest_action_add(unit, entry, bcmFlexDigestActionExtractBinSetBCmds11, BCM_FLEXDIGEST_FIELD_INNER_IP_HDR_DIP_48_63, 0xffff));
    BCM_IF_ERROR_RETURN(bcm_flexdigest_action_add(unit, entry, bcmFlexDigestActionExtractBinSetBCmds12, BCM_FLEXDIGEST_FIELD_INNER_IP_HDR_DIP_64_79, 0xffff));
    BCM_IF_ERROR_RETURN(bcm_flexdigest_action_add(unit, entry, bcmFlexDigestActionExtractBinSetBCmds13, BCM_FLEXDIGEST_FIELD_INNER_IP_HDR_DIP_80_95, 0xffff));
    BCM_IF_ERROR_RETURN(bcm_flexdigest_action_add(unit, entry, bcmFlexDigestActionExtractBinSetBCmds14, BCM_FLEXDIGEST_FIELD_INNER_IP_HDR_DIP_96_111, 0xffff));
    BCM_IF_ERROR_RETURN(bcm_flexdigest_action_add(unit, entry, bcmFlexDigestActionExtractBinSetBCmds15, BCM_FLEXDIGEST_FIELD_INNER_IP_HDR_DIP_112_127, 0xffff));
    ...
    BCM_IF_ERROR_RETURN(bcm_switch_control_port_set(unit, ingress_port, bcmSwitchTrunkUnicastHashOffset, 48));
    BCM_IF_ERROR_RETURN(bcm_switch_control_port_set(unit, ingress_port, bcmSwitchTrunkNonUnicastHashOffset, 48));
