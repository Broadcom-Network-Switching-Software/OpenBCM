...
/*
 * Feature  : Vxlan Bridging, network-to-access IPv4 tunnel termination
 *
 * Usage    : BCM.0> cint td4x9_hsdk_vxlan_ipv4_NtoA_assign_access_VP_and_VPN_match_port_ovid.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_vxlan.config.yml
 *
 * Log file : td4x9_hsdk_vxlan_ipv4_NtoA_assign_access_VP_and_VPN_match_port_ovid_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
