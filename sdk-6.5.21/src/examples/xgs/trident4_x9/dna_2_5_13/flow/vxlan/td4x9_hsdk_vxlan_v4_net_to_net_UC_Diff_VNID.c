...
/*
 * Feature  : Vxlan Bridging ,  network to network tunnel termination and
 *                              initiate to different VNID
 *
 * Usage    : BCM.0> cint td4x9_hsdk_vxlan_v4_net_to_net_UC_Diff_VNID.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_vxlan.config.yml
 *
 * Log file : td4x9_hsdk_vxlan_v4_net_to_net_UC_Diff_VNID_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
