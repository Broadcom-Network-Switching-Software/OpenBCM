 ...
 *            add a new vlan tag to the payload while egressing on access port
 *
 * Usage    : BCM.0> cint td4x9_hsdk_vxlan_ipv4_NtoA_assign_access_VP_SDtag_Add.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_vxlan.config.yml
 *
 * Log file : td4x9_hsdk_vxlan_ipv4_NtoA_assign_access_VP_SDtag_Add_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
