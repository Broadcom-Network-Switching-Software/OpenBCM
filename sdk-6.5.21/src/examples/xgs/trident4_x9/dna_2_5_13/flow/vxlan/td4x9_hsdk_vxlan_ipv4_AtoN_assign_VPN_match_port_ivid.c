 ...
 *
 * Usage    : BCM.0> cint td4x9_hsdk_vxlan_ipv4_AtoN_assign_VPN_match_port_ivid.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_vxlan.config.yml
 *
 * Log file : td4x9_hsdk_vxlan_ipv4_AtoN_assign_VPN_match_port_ivid_log.txt
 *
 ...
 *
 *   VFI may be assigned using any of the following match criteria while initiating
 *   a tunnel.
 *
 *   Port Group + Outer VLAN i.e BCM_FLOW_MATCH_CRITERIA_PORT_GROUP_VLAN
 *   Port Group + Inner VLAN i.e BCM_FLOW_MATCH_CRITERIA_PORT_GROUP_INNER_VLAN
 *   Port Group + Outer VLAN + Inner VLAN i.e BCM_FLOW_MATCH_CRITERIA_PORT_GROUP_VLAN_STACKED
 *
...
Ingress Hex Packet:
tx port=1 data=0x00000000AAAA00000000BBBB9100000A0800450000500001000040117497010101010202020200350035003C32F674657374746573747465737474657374746573747465737474657374746573747465737474657374746573747465737474657374
                    ...
                    bcm_flow_handle_t flow_handle)
{
  ...
  match_info.inner_vlan     = 10; /*Inner VLAN 10*/
