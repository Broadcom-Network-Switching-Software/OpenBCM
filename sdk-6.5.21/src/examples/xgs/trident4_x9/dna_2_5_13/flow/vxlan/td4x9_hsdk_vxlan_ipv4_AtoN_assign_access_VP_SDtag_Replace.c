 ...
 *
 * Usage    : BCM.0> cint td4x9_hsdk_vxlan_ipv4_AtoN_assign_access_VP_SDtag_Replace.c
 *
 * config   : BCM956780-56780_A0-Default-config.yml
 *
 * Log file : td4x9_hsdk_vxlan_ipv4_AtoN_assign_access_VP_SDtag_Replace_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
