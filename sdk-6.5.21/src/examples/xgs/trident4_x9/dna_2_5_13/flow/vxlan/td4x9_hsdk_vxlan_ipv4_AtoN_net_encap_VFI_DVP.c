 ...
 *
 * Usage    : BCM.0> cint td4x9_hsdk_vxlan_ipv4_AtoN_net_encap_VFI_DVP.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_vxlan.config.yml
 *
 * Log file : td4x9_hsdk_vxlan_ipv4_AtoN_net_encap_VFI_DVP_log.txt
 *
...
verify(int unit)
{
  ...
  /* dump l2 table to see if SA learned L2_IIF*/
  bshell(unit, "l2 show");
                    ...
                    bcm_flow_handle_t flow_handle)
{
  ...
  printf("VPN assignment, port_group + outer_VID -> VPN \n");
  bcm_flow_match_config_t_init(&match_info);
