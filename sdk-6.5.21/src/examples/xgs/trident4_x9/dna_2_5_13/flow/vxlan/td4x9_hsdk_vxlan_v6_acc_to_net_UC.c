...
/*
 * Feature  : Vxlan Bridging ,  access to network tunnel initiation(ipv6 tunnel) Flow with port+vlan as a flow match criteria
 *
 * Usage    : BCM.0> cint td4x9_hsdk_vxlan_v6_acc_to_net_UC.c
 *
 * config   : BCM956780-56780_A0-Default-config.yml
 *
 * Log file : td4x9_hsdk_vxlan_v6_acc_to_net_UC_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
 ...
 * Summary:
 * ========
 * Cint example to demonstrate VxLAN Bridging configuration for V6 tunnel Initiation -
...
Ingress Hex Packet:
tx 1 pbm=1 data=0x00000000AAAA00000000BBBB8100001508004500005000010000
40117497010101010202020200350035003C32F6746573747465737474657374746573
74746573747465737474657374746573747465737474657374746573747465737474657374
...
data[0010]: 86dd 6000 0000 006e 113f 0101 0101 3500   
data[0020]: 7000 0000 1009 0807 0605 0202 0202 3600   
data[0030]: 7000 0000 0102 0304 0506 c000 12b5 006e   
data[0040]: 0000 0800 0000 0123 4500 0000 0000 aaaa   
data[0050]: 0000 0000 bbbb 0800 4500 0050 0001 0000   
data[0060]: 4011 7497 0101 0101 0202 0202 0035 0035   
data[0070]: 003c 32f6 7465 7374 7465 7374 7465 7374   
...
config_vxlan(int unit)
{
    ...
    BCM_IF_ERROR_RETURN(vxlan_port_create(unit, my_modid, egress_port[0], FLAGS_PROVIDER, &provider_port ));
    ...
    BCM_IF_ERROR_RETURN(vxlan_l2_add(unit, "00:00:00:00:aa:aa", vxlan_vpn, 
                           provider_port.vxlan_port[0].flow_port.flow_port_id));
