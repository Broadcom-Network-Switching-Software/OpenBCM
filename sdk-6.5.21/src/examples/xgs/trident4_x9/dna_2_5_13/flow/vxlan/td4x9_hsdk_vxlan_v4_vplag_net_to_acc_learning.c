 ...
 *
 * Usage    : BCM.0> cint td4x9_hsdk_vxlan_v4_vplag_net_to_acc_learning.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_vxlan-vplag.config.yml
 *
 * Log file : td4x9_hsdk_vxlan_v4_vplag_net_to_acc_learning_log.txt
 *
 * Test Topology :
 *                             NETWORK       +---------------------++       ACCESS
 *        Underlay+NextHop                  +                      |
 ...
 *        six ports, five ports are used as ingress_port and the other one as
 *        egress_port.
 *
...
======
tx port=1 data=

tx port=1 data=

tx port=1 data=

tx port=1 data=

tx port=1 data=
...
verify(int unit)
{
    ...
    snprintf(pkt_data[0],512,"%s","");

    snprintf(pkt_data[1],512,"%s","");

    snprintf(pkt_data[2],512,"%s","");

    snprintf(pkt_data[3],512,"%s","");

    snprintf(pkt_data[4],512,"%s","");
...
//  bshell(unit, "hm ieee");
    ...
    for(i=0; i<sizeof(pkt_data)/512; i++)
    {
        ...
        snprintf(str, 512, "tx 1 pbm=%d data=0x%s; sleep quiet 8", ingress_port[i],pkt_data[i]);
        bshell(unit, str);
...
config_FlexDigest(int unit)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_switch_control_port_set(unit, egress_port, bcmSwitchVpTrunkHashOffset, 48));
