 ...
 *            delete vlan tag in payload while egressing on access port
 *
 * Usage    : BCM.0> cint td4x9_hsdk_vxlan_ipv4_NtoA_assign_access_VP_SDtag_Delete.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_vxlan.config.yml
 *
 * Log file : td4x9_hsdk_vxlan_ipv4_NtoA_assign_access_VP_SDtag_Delete_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
 ...
 * Summary:
 * ========
 * Cint example to demonstrate deleting vlan tag in palyload while VXLAN tunnel termination happens,
 ...
 *       and vlan tag is deleted in payload
 */
/*
NETWORK-TO-ACCESS:-
...
============================
[bcmPWN.0]Packet[2]: data[0000]: {00000000bbbb} {00000000aaaa} 8100 0001 <<< VLAN ID is 1 because of loopback.
