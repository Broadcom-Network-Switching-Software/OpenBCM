...
/*
 * Feature  : Vxlan Riot, IPv4 access to network tunnel initiation flow, VNID is derived from VFI in network encap
 *
 * Usage    : BCM.0> cint td4x9_hsdk_ipv4_riot_AtoN_net_encap_VFI.c
 *
 * config   : BCM956780-56780_A0-Default-config.yml
 *
 * Log file : td4x9_hsdk_ipv4_riot_AtoN_net_encap_VFI_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
