 ...
 *
 * Usage    : BCM.0> cint td4x9_hsdk_ipv4_riot_AtoN_mc.c
 *
 * config   : BCM956780-56780_A0-Default-config.yml
 *
 * Log file : td4x9_hsdk_ipv4_riot_AtoN_mc_log.txt
 *
 * Test Topology :
*                                  +----------------------+ 	L3 routing ->
 ...
 *     c) Expected Result:
 *     ===================
 *       We can see the routed VXLAN tunnel packet on one port and switched
 *       VXLAN tunnel packet on other port.
