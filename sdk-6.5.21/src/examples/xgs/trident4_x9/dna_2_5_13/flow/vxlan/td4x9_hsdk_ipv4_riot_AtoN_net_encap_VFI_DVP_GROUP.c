 ...
 *            using BCM_FLOW_ENCAP_CRITERIA_VFI_DVP_GROUP as network encap criteria
 *
 * Usage    : BCM.0> cint td4x9_hsdk_ipv4_riot_AtoN_net_encap_VFI_DVP_GROUP.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_vxlan.config.yml
 *
 * Log file : td4x9_hsdk_ipv4_riot_AtoN_net_encap_VFI_DVP_GROUP_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
