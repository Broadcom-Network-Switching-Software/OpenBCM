...
/*
 * Feature  : Vxlan Bridging ,  access to  network known & unknown multicast Flow
 *  with port+vlan as a flow match criteria
 *
 * Usage    : BCM.0> cint td4x9_hsdk_vxlan_v6_acc_to_net_MC.c
 *
 * config   : BCM956780-56780_A0-Default-config.yml
 *
 * Log file : td4x9_hsdk_vxlan_v6_acc_to_net_MC_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
...
data[0030]: 0000 0000 0000 0101 0101 c000 12b5 006e 
data[0040]: 0000 0800 0000 0123 4500 0100 5e01 0101 
...
data[0000]: 0100 5e01 0101 0000 0000 1111 8100 0001
