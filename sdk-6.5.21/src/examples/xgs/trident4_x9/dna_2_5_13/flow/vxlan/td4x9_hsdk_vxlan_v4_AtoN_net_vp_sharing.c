 ...
 *
 * Usage    : BCM.0> cint td4x9_hsdk_vxlan_v4_AtoN_net_vp_sharing.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_vxlan.config.yml
 *
 * Log file : td4x9_hsdk_vxlan_v4_AtoN_net_vp_sharing_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
...
Packet[2]: data[0020]: 0a01 c0a8 0101 c000 12b5 006e 0000 0800
...
Packet[2]: data[0090]: 7465 7374



egress packet 2:
Packet[4]: data[0000]: {000000000002} {000000002222} 8100 0016
Packet[4]: data[0010]: 0800 4500 0082 0000 0000 3f11 a5b7 0a0a
Packet[4]: data[0020]: 0a01 c0a8 0101 c000 12b5 006e 0000 0800
