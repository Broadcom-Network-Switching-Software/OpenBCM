 ...
 *
 * Usage    : BCM.0> cint td4x9_hsdk_vxlan_ipv4_AtoN_assign_access_VP_and_VPN_match_port_ivid.c
 *
 * config   : BCM956780-56780_A0-Default-config.yml
 *
 * Log file : td4x9_hsdk_vxlan_ipv4_AtoN_assign_access_VP_and_VPN_match_port_ivid_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
 ...
 *
 *   This example uses Port Group + Inner VLAN to assign access-side source
                    ...
                    bcm_flow_handle_t flow_handle)
{
  ...
  printf("Access SVP & VPN assignment, port_group + inner_VID -> VPN + SVP\n");
