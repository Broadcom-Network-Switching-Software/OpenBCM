 ...
 *
 * Usage    : BCM.0> cint td4x9_hsdk_vxlan_ipv4_AtoN_assign_access_VP_and_VPN_match_port_ovid.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_vxlan.config.yml
 *
 * Log file : td4x9_hsdk_vxlan_ipv4_AtoN_assign_access_VP_and_VPN_match_port_ovid_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
 ...
 *
 *   On Trident4 series, on the access-side source virtual port and VFI
 *   may be assigned using any of the following match criteria while initiating
 *   a tunnel.
 *
 ...
 *
 *   This example uses Port Group + Outer VLAN to assign access-side source
 *   virtual port and VFI.
 *
 *
