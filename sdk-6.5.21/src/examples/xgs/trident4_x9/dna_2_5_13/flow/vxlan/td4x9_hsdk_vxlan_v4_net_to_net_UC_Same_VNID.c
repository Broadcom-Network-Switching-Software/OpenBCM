...
/*
 * Feature  : Vxlan Bridging ,  network to network tunnel termination and initiate to the same VNID
 *
 * Usage    : BCM.0> cint td4x9_hsdk_vxlan_v4_net_to_net_UC_Same_VNID.c
 *
 * config   : BCM956780-56780_A0-Default-config.yml
 *
 * Log file : td4x9_hsdk_vxlan_v4_net_to_net_UC_Same_VNID_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
