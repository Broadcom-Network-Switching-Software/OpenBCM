 ...
 *            add sd tag (100) in payload while egressing on network port
 *
 * Usage    : BCM.0> cint td4x9_hsdk_vxlan_ipv4_AtoN_SDtag_Add.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_vxlan.config.yml
 *
 * Log file : td4x9_hsdk_vxlan_ipv4_AtoN_SDtag_Add_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
