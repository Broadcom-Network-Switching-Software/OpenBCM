...
/*
 * Feature  : Vxlan Bridging , IPv4 network to access
 *            tunnel termination flow, replace SDTAG in the payload
 *            while egressing on access port
 *
 * Usage    : BCM.0> cint td4x9_hsdk_vxlan_ipv4_NtoA_assign_access_VP_SDtag_Replace.c
 *
 * config   : BCM956780-56780_A0-Default-config.yml
 *
 * Log file : td4x9_hsdk_vxlan_ipv4_NtoA_assign_access_VP_SDtag_Replace_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
 ...
 * Summary:
 * ========
 * Cint example to demonstrate replacing SDTAG in palyload while VXLAN tunnel termination happens,
...
============================
[bcmPWN.0]Packet[2]: data[0000]: {00000000bbbb} {00000000aaaa} 8100 0064 >>> VLAN is replaced with 100
