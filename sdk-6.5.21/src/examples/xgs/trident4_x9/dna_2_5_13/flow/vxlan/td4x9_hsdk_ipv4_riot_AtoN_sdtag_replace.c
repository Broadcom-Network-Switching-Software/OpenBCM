...
/*
 * Feature  : Vxlan Riot, IPv4 access to network tunnel initiation flow, replace SD_TAG in the payload
 *
 * Usage    : BCM.0> cint td4x9_hsdk_ipv4_riot_AtoN_sdtag_replace.c
 *
 * config   : BCM956780-56780_A0-Default-config.yml
 *
 * Log file : td4x9_hsdk_ipv4_riot_AtoN_sdtag_replace_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
 ...
 *     ===================
 *
 *       We can see the tunnel packet with SDTAG replaced in payload on the egress port
 *       with the IPv4 encapsulation and 'show c' to check the Tx/Rx packet stats/counters.
 */
                    ...
                    bcm_gport_t *acc_flow_port)
{
	 ...
	 */
	 ...
	 /* Default vlan action */
	 bcm_vlan_action_t ot_action = bcmVlanActionDelete;
