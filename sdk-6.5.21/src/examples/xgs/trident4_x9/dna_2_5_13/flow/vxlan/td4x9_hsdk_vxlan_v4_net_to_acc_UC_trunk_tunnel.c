 ...
 *
 * Usage    : BCM.0> cint td4x9_hsdk_vxlan_v4_net_to_acc_UC_trunk_tunnel.c
 *
 * config   : BCM956780-56780_A0-Default-config.yml
 *
 * Log file : td4x9_hsdk_vxlan_v4_net_to_acc_UC_trunk_tunnel_log.txt
 *
 * Test Topology :
 *
...
Decap-case: packet sent from (network) to (access)
  ...
  ###[ IP ]###
     ...
     dst= 10.10.10.1
  ###[ UDP ]###
     sport= 55553, 55555, 55556, 55557, 55563, 55571, 55572 <== 7 packets' only changing contents
     dport= 4789
  ###[ VXLAN ]###
     flags= Instance
     reserved1= 0
...
======
tx port=1 data=

tx port=1 data=

tx port=1 data=

tx port=1 data=

tx port=1 data=

tx port=1 data=

tx port=1 data=
...
Egress packet#1 to 7 (Same packet content on all trunk member ports)
...
flex_degest_setup(int unit, uint8 l2_iif_opaque_ctrl_id)
{
    ...
    BCM_IF_ERROR_RETURN
        (bcm_flexdigest_entry_create(unit, group, &entry));
    BCM_IF_ERROR_RETURN
        (bcm_flexdigest_entry_priority_set(unit, entry, 3));
...
vxlan_phy_port_s    provider_port, customer_port1, customer_port2,
                    customer_port3,customer_port4, customer_port5;
vxlan_phy_port_s    acc_trunk_port;
...
config_vxlan(int unit)
{
    ...
    BCM_IF_ERROR_RETURN(vxlan_port_create(unit, my_modid, egress_port[0], FLAGS_CUSTOMER, &customer_port1));
    BCM_IF_ERROR_RETURN(vxlan_port_create(unit, my_modid, egress_port[1], FLAGS_CUSTOMER, &customer_port2));
    BCM_IF_ERROR_RETURN(vxlan_port_create(unit, my_modid, egress_port[2], FLAGS_CUSTOMER, &customer_port3));
    BCM_IF_ERROR_RETURN(vxlan_port_create(unit, my_modid, egress_port[3], FLAGS_CUSTOMER, &customer_port4));
    BCM_IF_ERROR_RETURN(vxlan_port_create(unit, my_modid, egress_port[4], FLAGS_CUSTOMER, &customer_port5));
    ...
    acc_trunk_port.gport_id             = trunk_gport;
    acc_trunk_port.flags                = FLAGS_CUSTOMER;
    acc_trunk_port.vxlan_port[0].vid    = acc_vid;
    BCM_IF_ERROR_RETURN(vxlan_access_port_create(unit, vxlan_vpn, &acc_trunk_port));
    ...
    provider_port.vxlan_port[0].remote_ip  = net_remote_ip;
    ...
    provider_port.vxlan_port[0].local_ip   = net_local_ip;
    provider_port.vxlan_port[0].remote_ip  = net_remote_ip;
...
verify(int unit)
{
    ...
    snprintf(pkt_data[0],512,"%s","");

    snprintf(pkt_data[1],512,"%s","");

    snprintf(pkt_data[2],512,"%s","");

    snprintf(pkt_data[3],512,"%s","");

    snprintf(pkt_data[4],512,"%s","");

    snprintf(pkt_data[5],512,"%s","");

    snprintf(pkt_data[6],512,"%s","");
