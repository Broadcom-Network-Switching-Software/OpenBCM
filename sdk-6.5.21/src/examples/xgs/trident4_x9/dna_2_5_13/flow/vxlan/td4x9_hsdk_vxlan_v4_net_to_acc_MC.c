 ...
 *
 * Usage    : BCM.0> cint td4x9_hsdk_vxlan_v4_net_to_acc_MC.c
 *
 * config   : BCM956780-56780_A0-Default-config.yml
 *
 * Log file : td4x9_hsdk_vxlan_v4_net_to_acc_MC_log.txt
 *
 * Test Topology :
 *                                  +----------------------+ known_mc <-
 ...
 *
 *     b) Transmit the known multicast packet and broadast packets on network ports.
...

...
Input Hex (ce1: Network):
Broadcast case:

...
verify(int unit)
{
    ...
    snprintf(str, 1184, "tx 1 pbm=%d data=; sleep quiet 1", ingress_port[0]);
    bshell(unit, str);
    sal_sleep(2);
    bshell(unit, "show c");
    ...
    snprintf(str, 1184, "tx 1 pbm=%d data=; sleep quiet 1", ingress_port[1]);
    bshell(unit, str);
    sal_sleep(2);
    bshell(unit, "show c");
    /* dump l2 table to see if SA learned againt SVP */
