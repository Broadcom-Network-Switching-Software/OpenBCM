...
/*
 * Feature  : Vxlan Bridging, IPv4 access to network tunnel initiation Flow, add sd tag (100)
 *            in payload while egressing on network port. Also, attaching flex counters for VPN and Flow port
 *
 * Usage    : BCM.0> cint td4x9_hsdk_vxlan_ipv4_AtoN_Flex_Ctr.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_vxlan.config.yml
 *
 * Log file : td4x9_hsdk_vxlan_ipv4_AtoN_Flex_Ctr_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
