 ...
 *            replace the payload outer vlan tag while egressing on access port
 *
 * Usage    : BCM.0> cint td4x9_hsdk_vxlan_ipv4_NtoA_SDtag_Replace.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_vxlan.config.yml
 *
 * Log file : td4x9_hsdk_vxlan_ipv4_NtoA_SDtag_Replace_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
