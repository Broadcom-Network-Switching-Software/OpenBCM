 ...
 *
 * Usage    : BCM.0> cint td4x9_hsdk_vxlan_gbp_ipv4_NtoN_uc_transit.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_vxlan-gbp.config.yml
 *
 * Log file : td4x9_hsdk_vxlan_gbp_ipv4_NtoN_uc_transit_log.txt
 *
 * Test Topology :
 *
 ...
 *   ===========================================
 *     a) Check the configurations by 'vlan show', 'l2 show', 'l3 egress show', 'l3 route show' and traversing the vpn and vp's
 *
...
verify(int unit)
{
    ...
    snprintf(pkt_data,512,"%s","");
...
config_vxlan_overlay_network_route(int unit, vxlan_net_cfg_t *vxlan_net)
{
    ...
    rv = vxlan_create_egr_obj(unit, BCM_L3_FLOW_ONLY, net_intf_id_ol, vxlan_net->net_remote_mac,
                    egress_phy_gport, vxlan_net->net_vlan, &net_egr_id_ol);
    if (BCM_FAILURE(rv)) {
