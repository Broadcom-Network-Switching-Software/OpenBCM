...
/*
 * Feature  : Vxlan Bridging, access to network known multicast IPv4 tunnel initiation
 *            with Vxlan GBP-SID assignment for a l2 class-id
 *
 * Usage    : BCM.0> cint td4x9_hsdk_vxlan_gbp_ipv4_AtoN_uc_l2.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_vxlan-gbp.config.yml
 *
 * Log file : td4x9_hsdk_vxlan_gbp_ipv4_AtoN_uc_l2_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
