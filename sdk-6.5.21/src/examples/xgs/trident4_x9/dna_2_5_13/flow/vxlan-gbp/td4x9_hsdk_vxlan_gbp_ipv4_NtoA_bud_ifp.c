 ...
 *               VxLAN GBP-ID validation in 2nd pass derived through L2 entry succesful
 *
 *
 * Usage    : BCM.0> cint td4x9_hsdk_vxlan_gbp_ipv4_NtoA_bud_ifp.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_vxlan-gbp.config.yml
 *
 * Log file : td4x9_hsdk_vxlan_gbp_ipv4_NtoA_bud_ifp_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
 ...
 *             GBP-ID matching by IFP is successful and Decapsulated packet successfully egresses access port
 *
 ...
 *        - GBP match occurs, decapsulated packet should successfully egress out
 *
 *     c) Expected Result:
 *     ===================
...
Ingress Hex Packet:
tx 1 pbm=1 data=
...
verify(int unit)
{
    ...
    snprintf(str, 512, "tx 1 pbm=%d data=; sleep quiet 1", ingress_port);
