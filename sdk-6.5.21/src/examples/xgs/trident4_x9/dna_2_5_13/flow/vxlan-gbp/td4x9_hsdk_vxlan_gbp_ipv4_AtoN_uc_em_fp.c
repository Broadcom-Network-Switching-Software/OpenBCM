...
/*
 * Feature  : Vxlan Bridging, access to network unicast IPv4 tunnel initiation
 *            with Vxlan GBP-SID assignment in Exact Match(EM) FP entry
 *
 * Usage    : BCM.0> cint td4x9_hsdk_vxlan_gbp_ipv4_AtoN_uc_em_fp.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_vxlan-gbp-em.config.yml
 *
 * Log file : td4x9_hsdk_vxlan_gbp_ipv4_AtoN_uc_em_fp_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
