 ...
 *            for known-multicast Vxlan GBP-SID,DID verification based on MAC-DA+Vlan in EM entry
 *
 * Usage    : BCM.0> cint td4x9_hsdk_vxlan_gbp_ipv4_NtoA_mc_em_fp.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_vxlan-gbp-em.config.yml
 *
 * Log file : td4x9_hsdk_vxlan_gbp_ipv4_NtoA_mc_em_fp_log.txt
 *
 * Test Topology :
 *                                  +----------------------+ known_mc <-
...
Table CTR_ING_DROP_EVENT:
  lookup CTR_ING_DROP_EVENT_ID=EM_FT
    DROP_CNT=1
    CTR_ING_DROP_EVENT_ID=EM_FT
*/
 ...
 */
bcm_error_t
config_gbp_sid_verify(int unit, bcm_gport_t flow_port,bcm_mac_t dst_mac,bcm_vlan_t vlan)
{
    bcm_field_entry_t entry;
    bcm_field_group_config_t group_config;
    int gbp_sid = 0xfab;
...
verify(int unit)
{
    ...
    bshell(unit, "bsh -c 'lt CTR_ING_DROP_EVENT lookup CTR_ING_DROP_EVENT_ID=EM_FT'");
