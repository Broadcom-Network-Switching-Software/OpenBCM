 ...
 *            NO ES filter (EFP).
 *
 * Usage    : BCM.0> cint td4x9_hsdk_evpn_ipv4_NtoA_ES_NoFilter_BumBit_MC.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_evpn.config.yml
 *
 * Log file : td4x9_hsdk_evpn_ipv4_NtoA_ES_NoFilter_BumBit_MC_log.txt
 *
 * Test Topology :
 *
 *
 ...
 *     c) Expected Result:
 *     ===================
 *       We can see with BUM bit, the tunnel terminated known multicast
