 ...
 *            NO ES filter (EFP).
 *
 * Usage    : BCM.0> cint td4x9_hsdk_evpn_ipv4_NtoA_ES_NoFilter_BumBit_UMC.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_evpn.config.yml
 *
 * Log file : td4x9_hsdk_evpn_ipv4_NtoA_ES_NoFilter_BumBit_UMC_log.txt
 *
 * Test Topology :
 *
 *
 ...
 *     c) Expected Result:
 *     ===================
 *       We can see with BUM bit, the tunnel terminated unknown multicast
 *       packet from network port is multicast-ed to both access port 1
 *       (egr_acc_port_1) and access port 2 (egr_acc_port_2).
