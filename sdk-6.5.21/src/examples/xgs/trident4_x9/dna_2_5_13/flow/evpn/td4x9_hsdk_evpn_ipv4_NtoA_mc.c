 ...
 *            termination flow for known multicast.
 *
 * Usage    : BCM.0> cint td4x9_hsdk_evpn_ipv4_NtoA_mc.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_evpn.config.yml
 *
 * Log file : td4x9_hsdk_evpn_ipv4_NtoA_mc_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
