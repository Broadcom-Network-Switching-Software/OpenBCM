 ...
 *            initiation flow to verify source lookup failure (SLF).
 *
 * Usage    : BCM.0> cint td4x9_hsdk_evpn_ipv4_AtoN_SLF.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_evpn.config.yml
 *
 * Log file : td4x9_hsdk_evpn_ipv4_AtoN_SLF_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
 ...
 *       (BCM_PORT_LEARN_ARL), the packet is punted to CPU
 *       (BCM_PORT_LEARN_CPU) with reason CML_FLAGS and no packet
 *       on the egress port ( !BCM_PORT_LEARN_FWD )
