 ...
 *
 * Usage    : BCM.0> cint td4x9_hsdk_flexctr_vxlan_decap.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_flexctr.config.yml
 *
 * Log file : td4x9_hsdk_flexctr_vxlan_decap_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
 ...
 *   ===============================================
 *     a) Configure Flex counters with appropriate paremeters and attach the
 *        counter to the network flow port
 *
 *   3) Step3 - Verification (Done in testVerify()):
 *   ===========================================
 *     a) Transmit packet and Check the output of bcm_flexctr_stat_get 
 *     b) Expected Result:
 *     ===================
...
int vxlan_decap_stat_create(int unit)                 
{
    ...
    /* Configure FLex Counter to count on ING DVP Table using bcmFlexctrSourceVP */
