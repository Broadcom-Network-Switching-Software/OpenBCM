 ...
 *
 * Usage    : BCM.0> cint td4x9_hsdk_flexct_per_ing_port_per_vlan_pri.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_flexctr.config.yml
 *
 * Log file : td4x9_hsdk_flexct_per_ing_port_per_vlan_pri_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
 ...
 *   ===============================================
 *     a) Configure Flex counters with source being bcmFlexctrSourceIngPort and
 *           object being bcmFlexctrObjectIngIntPri
 *     b) Attach flex counter to port.
 *
...
int testVerify(int unit)
{
  ...
  printf ("stat_counter_id %d", stat_counter_id );
