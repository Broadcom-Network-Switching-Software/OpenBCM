 ...
 *
 * Usage    : BCM.0> cint td4x9_hsdk_flexctr_ifp.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_flexctr.config.yml
 *
 * Log file : td4x9_hsdk_flexctr_ifp_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
 ...
 *   ===============================================
 *     a) Create Field group with DMAC and InPort as part of QSET and
 ...
 *   ===========================================
 *     a) Transmit 5 packets with incremental dest mac
 *     b) Fetch flex counter associated with IFP rules using bcm_flexctr_stat_get()
 *
 *     c) Expected Result:
 *     ===================
 *     The output of bcm_flexctr_stat_get should match the number of transmitted
 *     packets. Counter associated with each IFP rule increments by 1.
 *     FlexCtr Get for entry fetching counter index 1 : 1 packets / 68 bytes
 *     FlexCtr Get for entry fetching counter index 2 : 1 packets / 68 bytes
 *     FlexCtr Get for entry fetching counter index 3 : 1 packets / 68 bytes
 *     FlexCtr Get for entry fetching counter index 4 : 1 packets / 68 bytes
 *     FlexCtr Get for entry fetching counter index 5 : 1 packets / 68 bytes
 */
...
int execute()
{
  ...
  printf("Completed test config successfully.\n");
