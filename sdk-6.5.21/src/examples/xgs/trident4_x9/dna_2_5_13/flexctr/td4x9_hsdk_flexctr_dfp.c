 ...
 *
 * Usage    : BCM.0> cint td4x9_hsdk_flexctr_dfp.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_flexctr.config.yml
 *
 * Log file : td4x9_hsdk_flexctr_dfp_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
 ...
 *   ===============================================
 *     a) Configure IFP and DFP rules 
 *     b) Configure Flex counters with appropriate paremeters and attach the
 ...
 *     packets
 *     Flex Counters collected on Dest FP Packets / Bytes : 0x0000000a / 0x000002a8
 */
