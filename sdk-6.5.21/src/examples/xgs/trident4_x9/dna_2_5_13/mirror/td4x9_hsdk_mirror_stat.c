...
/*
 * Feature  : Verifying ingress/egress mirror packet stats. 
 *
 * Usage    : BCM.0> cint td4x9_hsdk_mirror_stat.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_mirror.config.yml
 *
 * Log file : td4x9_hsdk_mirror_stat_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
 ...
 *     b) Configure L2 flow
 *
 *   2) Step2 - Configuration (Done in configure_port_mirror()):
 *   =========================================================
 *     a) Create a mirror (estination for MTP port
 *
 *     b) Configure ingress and egress mirror to that MTP.
 *
...
verify(int unit)
{
    ...
    snprintf(str, 512, "tx 1 pbm=%d data=0x00000000AAAA00000000BBBB810000150800450000500001000040117497010101010202020200350035003C32F674657374746573747465737474657374746573747465737474657374746573747465737474657374746573747465737474657374; sleep quiet 5", ingress_port);
    bshell(unit, str);
