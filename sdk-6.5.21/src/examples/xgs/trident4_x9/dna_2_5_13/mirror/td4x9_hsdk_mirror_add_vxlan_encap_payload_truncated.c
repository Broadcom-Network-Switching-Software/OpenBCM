...
/*
 * Feature  : Verifying ingress mirror packet to vxlan tunnel feature
 *
 * Usage    : BCM.0> cint td4x9_hsdk_mirror_add_vxlan_encap_payload_truncated.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_mirror.config.yml
 *
 * Log file : td4x9_hsdk_mirror_add_vxlan_encap_payload_truncated_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
 ...
 *               mirror source port |                      |
 *                        --------->|         DUT          |
 *                   ingress packet |                      |  Vxlan tunnel port(MTP port)
 *                                  |                      |-------->
