...
/*
 * Feature  : Verifying ingress/egress mirror packet by using IFP
 *
 * Usage    : BCM.0> cint td4x9_hsdk_mirror_use_ifp.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_mirror.config.yml
 *
 * Log file : td4x9_hsdk_mirror_use_ifp_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
 ...
 *
 *   2) Step2 - Configuration (configure_ifp_mirror()):
 *   ================================================
 *
 *     a) Configure IFP to do ingress and egress mirror
 *
