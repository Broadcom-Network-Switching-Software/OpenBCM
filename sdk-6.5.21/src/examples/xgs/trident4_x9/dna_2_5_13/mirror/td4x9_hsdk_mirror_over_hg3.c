...
/*
 * Feature  : Verifying ingress/egress mirror over HG3 port
 *
 * Usage    : BCM.0> cint td4x9_hsdk_mirror_over_hg3.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_mirror.config.yml
 *
 * Log file : td4x9_mirror_over_hg3_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
