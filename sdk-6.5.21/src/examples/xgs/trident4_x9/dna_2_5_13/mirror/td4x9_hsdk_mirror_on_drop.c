...
/*
 * Feature  : Verifying Mirror on Drop feature.
 *
 * Usage    : BCM.0> cint td4x9_hsdk_mirror_on_drop.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_mirror.config.yml
 *
 * Log file : td4x9_hsdk_mirror_on_drop_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
 ...
 *     b) Expected Result:
 *     ===================
 *       We can see one mirrored packet in PSAMP format.
