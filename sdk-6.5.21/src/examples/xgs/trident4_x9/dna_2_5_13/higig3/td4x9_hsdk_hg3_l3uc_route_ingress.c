 ...
 *
 * Usage    : BCM.0> cint td4x9_hsdk_hg3_l3uc_route_ingress.c
 *
 * config   : bcm56780_a0-generic-48x100-8x400_higig3.config.yml
 *
 * Log file : td4x9_hsdk_hg3_l3uc_route_ingress_log.txt
 *
 * Test Topology :
 *
 *                  +------------------------------+
 ...
 * ingress_port ce0 |                              |  egress_port hg0
 * +----------------+          DUT             HG3 +-----------------+
 ...
 *      d) Configure a basic IPv4 route/entry functional scenario. This adds the
