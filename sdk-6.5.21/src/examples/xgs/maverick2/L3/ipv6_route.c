...
/*
 * Feature  : L3 IPv6 route/ LPM entry
 *
 * Usage    : BCM.0> cint ipv6_route.c
 *
 * config   : l3_config.bcm
 *
 * Log file : ipv6_route_log.txt
 *
 * Test Topology :
 *
 *                  +------------------------------+
 ...
 *
 *   2) Step2 - Configuration (Done in config_l3_ipv6_route()):
 *   =========================================================
...
/* Adding subnet address to ip6route table */
int
add_route(int unit, bcm_ip6_t subnet_addr, bcm_ip6_t subnet_mask, bcm_if_t egr_if)
{
...
/* Configuration: L3 IPv6 route/ LPM related */
bcm_error_t
config_l3_ipv6_route(int unit)
{
    bcm_error_t rv;
    ...
    bcm_if_t egr_if;
    bcm_ip6_t subnet = {0x3F, 0xFE, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02};
 ...
 *  a) test setup
 *  b) actual configuration (Done in config_l3_ipv6_route())
...
execute(void)
{
    ...
    print "~~~ #2) config_l3_ipv6_route(): ** start **";
    if (BCM_FAILURE((rv = config_l3_ipv6_route(unit)))) {
        printf("config_l3_ipv6_route() failed.\n");
        return -1;
    }
    print "~~~ #2) config_l3_ipv6_route(): ** end **";
