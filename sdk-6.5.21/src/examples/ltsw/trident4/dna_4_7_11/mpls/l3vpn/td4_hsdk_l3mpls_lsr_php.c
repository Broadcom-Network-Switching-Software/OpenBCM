...
/*
 * Feature  : L3 MPLS LSR with PHP functionality(BCM_MPLS_SWITCH_ACTION_PHP)
 *
 * Usage    : BCM.0> cint td4_hsdk_l3mpls_lsr_php.c
 *
 * config   : bcm56880_a0-generic-32x400.mpls-config.yml
 *
 * Log file : td4_hsdk_l3mpls_lsr_php_log.txt
 *
 * Test Topology :
 *
 *                  +-------------------+
 ...
 * Summary:
 * ========
 *   This Cint example to show the configuration of L3 MPLS lsr with PHP
 *   functionality
 *
 ...
 *   8847 0030 1040 0030 2140 4500 0040 0000
 *   0000 40ff 9b0b 0a0a 0a01 c0a8 0a01 0001
 *   0203 0405 0607 0809 0a0b 0c0d 0e0f 1011
 *   1213 1415 1617 1819 1a1b 1c1d 1e1f 2021
 *   2223 2425 2627 2829 2a2b e312 8edb
 *
 *   Out Packet:
 *   -----------
 *   0000 0000 2222 0000 0000 1111 8100 0016
 *   8847 0030 2140 4500 0040 0000 0000 40ff
...
verify(int unit)
{
    ...
    snprintf(str, 512, "tx 1 pbm=%d data=0x0000000013030000000000AA8100000C88470030104000302140450000400000000040FF9B0B0A0A0A01C0A80A01000102030405060708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F202122232425262728292A2BE3128EDB; sleep quiet 3", ingress_port);
    bshell(unit, str);
    bshell(unit, "show c");
