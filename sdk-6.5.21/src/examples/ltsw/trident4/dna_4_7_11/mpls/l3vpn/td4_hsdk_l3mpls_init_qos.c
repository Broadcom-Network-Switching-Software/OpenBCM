...
/*
 * Feature  : L3 MPLS QOS mapping in tunnel initiation
 *
 * Usage    : BCM.0> cint td4_hsdk_l3mpls_init_qos.c
 *
 * config   : bcm56880_a0-generic-32x400.config.yml
 *
 * Log file : td4_hsdk_l3mpls_init_qos_log.txt
 *
 * Test Topology :
 *
 *                  +------------------------------+
 ...
 *   =========================================================
 *     a) Configure a basic L3 MPLS tunnel initiation with QOS functional
 ...
 *       MPLS Label. Also run the 'show c' to check the TX/RX packet
 *       stats/counters.
 */
