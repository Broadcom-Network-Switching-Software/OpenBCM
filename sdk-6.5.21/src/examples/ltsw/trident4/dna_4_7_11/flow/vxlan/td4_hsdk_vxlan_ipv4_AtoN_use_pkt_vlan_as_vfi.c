 ...
 *
 * Usage    : BCM.0> cint td4_hsdk_vxlan_ipv4_AtoN_use_pkt_vlan_as_vfi.c
 *
 * config   : bcm56880_a0-generic-32x400_use_pkt_vlan_as_vfi_config.yml
 *
 * Log file : td4_hsdk_vxlan_ipv4_AtoN_use_pkt_vlan_as_vfi_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
