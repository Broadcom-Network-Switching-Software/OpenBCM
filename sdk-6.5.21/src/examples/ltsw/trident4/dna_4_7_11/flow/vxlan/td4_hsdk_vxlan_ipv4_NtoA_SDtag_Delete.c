...
/*
 * Feature  : TD4(56880) Vxlan Bridging , IPv4 network to access tunnel termination flow, remove the outer vlan tag from payload while egressing on access port
 *
 * Usage    : BCM.0> cint TD4_HSDK_VxLAN_ipv4_NtoA_SDtag_Delete.c
 *
 * config   : bcm56880_a0-generic-32x400_vxlan.config.yml
 *
 * Log file : TD4_HSDK_VxLAN_ipv4_NtoA_SDtag_Delete_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
...
data[0010]: 0800 4500 0046 0001 0000 4000 74b2 0202 
data[0020]: 0202 0101 0101 5468 6973 2070 6163 6b65 
data[0030]: 7420 6973 2062 6569 6e67 2073 656e 7420 
data[0040]: 6279 2074 6573 7420 3120 6672 6f6d 2043 
data[0050]: 4c49 2074 6f20 424d 
*/
 ...
 *   Out Packet:
 *   -----------
 *  0000 0000 bbbb 0000 0000 aaaa 8100 0001
 *  0800 4500 0046 0001 0000 4000 74b2 0202 
 *  0202 0101 0101 5468 6973 2070 6163 6b65 
 *  7420 6973 2062 6569 6e67 2073 656e 7420 
 *  6279 2074 6573 7420 3120 6672 6f6d 2043 
 *  4c49 2074 6f20 424d 
 */
...
int config_vxlan_access(int unit, vxlan_cfg_t *vxlan_cfg, vxlan_acc_cfg_t *vxlan_acc, bcm_gport_t *acc_flow_port, bcm_flow_handle_t flow_handle)
{
    ...
    /*
     * After decap, the packet will be sent out and then loopbacked to access port
     * In this case, the untag packet have default vlan inserted if this packet is 
     * copied to CPU by IFP
     */
