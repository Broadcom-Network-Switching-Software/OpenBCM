...
/*
 * Feature  : Vxlan Riot, IPv4 access to network tunnel initiation flow, using BCM_FLOW_ENCAP_CRITERIA_VFI_DVP_GROUP as network encap criteria
 *
 * Usage    : BCM.0> cint TD4_HSDK_ipv4_riot_AtoN_net_encap_VFI_DVP_GROUP.c
 *
 * config   : bcm56880_a0-generic-32x400.config.yml
 *
 * Log file : TD4_HSDK_ipv4_riot_AtoN_net_encap_VFI_DVP_GROUP_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
 ...
 * 			   - VNID is derived from {VFI + DVP_GROUP}
 *
