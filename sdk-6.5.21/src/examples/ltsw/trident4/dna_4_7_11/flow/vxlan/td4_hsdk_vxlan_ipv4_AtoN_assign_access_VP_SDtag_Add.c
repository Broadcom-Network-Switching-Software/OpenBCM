...
/*
 * Feature  : TD4(56880) Vxlan Bridging , IPv4 access to network
 *            tunnel initiation Flow, add sd tag in payload while
 *            egressing on network port
 *
 * Usage    : BCM.0> cint td4_hsdk_vxlan_ipv4_AtoN_assign_access_VP_SDtag_Add.c
 *
 * config   : bcm56880_a0-generic-32x400.config.yml
 *
 * Log file : td4_hsdk_vxlan_ipv4_AtoN_assign_access_VP_SDtag_Add_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
 ...
 * Summary:
 * ========
 *   Cint example to demonstrate adding SDtag in payload for VXLAN IPv4 tunnel
...
[bcmPWN.0]Packet[2]: data[0010]: 0800 4500 006c 0000 0000 3f11 a5cd 0a0a
[bcmPWN.0]Packet[2]: data[0020]: 0a01 c0a8 0101 c000 12b5 0058 0000 0800
[bcmPWN.0]Packet[2]: data[0030]: 0000 0123 4500 0000 0000 aaaa 0000 0000
[bcmPWN.0]Packet[2]: data[0040]: bbbb 8100 0064 8100 0015 0800 4500 002e  <<< VLAN 100 tag is added
[bcmPWN.0]Packet[2]: data[0050]: 0000 0000 4011 74ba 0101 0101 0202 0202
[bcmPWN.0]Packet[2]: data[0060]: 0035 0036 001a b0f8 0001 0203 0405 0607
[bcmPWN.0]Packet[2]: data[0070]: 0809 0a0b 0c0d 0e0f 1011 33cf 192c
