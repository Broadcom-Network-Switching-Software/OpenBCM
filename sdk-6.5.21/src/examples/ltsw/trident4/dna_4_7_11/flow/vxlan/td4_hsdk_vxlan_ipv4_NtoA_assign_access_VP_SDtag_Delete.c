 ...
 *            tunnel termination flow, delete vlan tag in payload
 *            while egressing on access port
 *
 * Usage    : BCM.0> cint td4_hsdk_vxlan_ipv4_NtoA_assign_access_VP_SDtag_Delete.c
 *
 * config   : bcm56880_a0-generic-32x400_vxlan.config.yml
 *
 * Log file : td4_hsdk_vxlan_ipv4_NtoA_assign_access_VP_SDtag_Delete_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
