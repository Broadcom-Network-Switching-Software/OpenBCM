 ...
 *
 * Usage    : BCM.0> cint TD4_HSDK_ipv4_riot_AtoN_uc_VRF.c
 *
 * config   : bcm56880_a0-generic-32x400.config.yml
 *
 * Log file : TD4_HSDK_ipv4_riot_AtoN_uc_VRF_logs.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
...
ACCESS-TO-NETWORK:-
Encap-case: packet sent from ingress_port(access) to egress_port(network) through a VRF based routing entry (VRF: 10, DIP: 192.168.20.0/24)
