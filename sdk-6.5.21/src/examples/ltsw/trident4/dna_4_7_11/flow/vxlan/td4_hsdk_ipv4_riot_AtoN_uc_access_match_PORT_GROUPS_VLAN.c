...
/*
 * Feature  : Vxlan Riot, IPv4 access to network tunnel initiation flow, access match criteria is PORT_GROUPS_VLAN
 *
 * Usage    : BCM.0> cint TD4_HSDK_ipv4_riot_AtoN_uc_access_match_PORT_GROUPS_VLAN.c
 *
 * config   : bcm56880_a0-generic-32x400.config.yml
 *
 * Log file : TD4_HSDK_ipv4_riot_AtoN_uc_access_match_PORT_GROUPS_VLAN_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
 ...
 *			   - access match criteria is PORT_GROUPS_VLAN
