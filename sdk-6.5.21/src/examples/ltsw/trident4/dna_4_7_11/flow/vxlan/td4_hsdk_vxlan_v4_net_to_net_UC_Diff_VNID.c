...
/*
 * Feature  : TD4(56880) Vxlan Bridging ,  network to network tunnel termination and initiate to different VNID
 *
 * Usage    : BCM.0> cint TD4_HSDK_VXLAN_v4_net_to_net_UC_Diff_VNID.c
 *
 * config   : bcm56880_a0-generic-32x400.config.yml
 *
 * Log file : TD4_HSDK_VXLAN_v4_net_to_net_UC_Diff_VNID_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
 ...
 * Summary:
 * ========
 * Cint example to demonstrate VxLAN Bridging configuration for tunnel Termination and initiate to different VNID -
...
data[0030]: 0000 0678 9000 0000 0000 bbbb 0000 0000 
