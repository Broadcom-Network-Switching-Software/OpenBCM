 ...
 *            ES filter (EFP).
 *
 * Usage    : BCM.0> cint td4_hsdk_evpn_ipv4_NtoA_ES_Filter_BumBit_UC.c
 *
 * config   : bcm56880_a0-generic-32x400.config.yml
 *
 * Log file : td4_hsdk_evpn_ipv4_NtoA_ES_Filter_BumBit_UC_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
 ...
 *        enable EVPN, EFP ES filter, EVPN packet control, port learning, vlan,
 *        access port setting, network port, setting, tunnel setup interface
 *        and next hop.
 *
 ...
 *       (egr_acc_port_2) using EFP, the tunnel terminated unicast packet is
 *       flooded to access port 1 (egr_acc_port_1) only.
