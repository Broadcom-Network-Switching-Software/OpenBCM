 ...
 *            termination flow for unknown multicast traffic with NO BUM bit &
 *            NO ES filter (EFP).
 *
 * Usage    : BCM.0> cint td4_hsdk_evpn_ipv4_NtoA_ES_NoFilter_NoBumBit_UMC.c
 *
 * config   : bcm56880_a0-generic-32x400.config.yml
 *
 * Log file : td4_hsdk_evpn_ipv4_NtoA_ES_NoFilter_NoBumBit_UMC_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
 ...
 *
 *     b) Transmit the unknown multicast packet with NO BUM BIT. The contents of
 *        the packet are printed on screen.
 *
 *     c) Expected Result:
 *     ===================
 *       We can see with no BUM bit, the tunnel terminated unknown multicast
...
Ingress Hex Packet:
tx port=1 data=
...
verify(int unit)
{
	...
	snprintf(str, 512, "tx 1 pbm=%d data=; sleep quiet 1", ing_net_port_1);
	bshell(unit, str);
	bshell(unit, "show c");
