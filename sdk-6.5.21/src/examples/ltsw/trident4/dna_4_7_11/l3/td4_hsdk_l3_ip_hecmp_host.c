...
/*
 * Feature  : L3 IPv4 Unicast host pointing H-ECMP
 *
 * Usage    : BCM.0> cint td4_hsdk_l3_ip_hecmp_host.c
 *
 * config   : bcm56880_a0-generic-32x400.config.yml
 *
 * Log file : td4_hsdk_l3_ip_hecmp_host_log.txt
 *
 * Test Topology :
 *
 *                   +------------------------------+              Level-2 ECMP   +-----------------------+
 ...
 * Summary:
 * ========
 *   This Cint example to show configuration of the IPv4 host entry pointing H-ECMP scenario
 *   using BCM APIs.
 *
 ...
 *
 *      m) Add host entry for DIP by pointing Overlay ECMP object.
 *
...
/*
 * IP H-ECMP pointing host configuration.
 */
