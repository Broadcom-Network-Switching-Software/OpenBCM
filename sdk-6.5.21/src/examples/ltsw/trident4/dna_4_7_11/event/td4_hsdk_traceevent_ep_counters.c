...
/*
 * Feature  : Trace Event, trigger the specific trace event in egress pipeline and check it is properly counted to the related Trace Event counter.
 *
 * Usage    : BCM.0> cint TD4_HSDK_TraceEvent_ep_counters.c
 *
 * Config   : bcm56880_a0-generic-32x400_event.config.yml
 *
 * Log file : TD4_HSDK_TraceEvent_ep_counters_log.txt
 *
 * Test Topology :
 *
 *
