...
/*
 * Feature  : Drop Event, mirror 'Ingress Pipeline: Ingress Membership Check Failure' packets to MTP (Mirror-to-Port).
 *
 * Usage    : BCM.0> cint TD4_HSDK_DropEvent_ip_mirror_to_mtp.c
 *
 * Config   : bcm56880_a0-generic-32x400_event.config.yml
 *
 * Log file : TD4_HSDK_DropEvent_ip_mirror_to_mtp_log.txt
 *
 * Test Topology :
 *
 *
