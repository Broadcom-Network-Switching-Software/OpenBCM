 ...
 *
 * Usage    : BCM.0> cint td4_hsdk_l2_mc_trunk_flexdigest.c
 *
 * config   : bcm56880_a0-generic-l2.config.yml
 *
 * Log file : td4_hsdk_l2_mc_trunk_flexdigest_log.txt
 *
 * Test Topology :
...
verify(int unit)
{
    ...
    snprintf(str, 512, "tx 10 pbm=%d DestMac=0x01005e000011 SourceMac=0x3214 SourceMacInc=1 vlan=20 len=80; sleep quiet 1", ingress_port);
    bshell(unit, str);
    print "show c";
    bshell(unit, "show c");
