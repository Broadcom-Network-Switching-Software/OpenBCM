...
/*
 * Feature  : Qos mapping for L2 tagged packets
 *
 * Usage    : BCM.0> cint td4_hsdk_qos_l2_outer_tag.c
 *
 * config   : bcm56880_a0-generic-l2.config.yml
 *
 * Log file : td4_hsdk_qos_l2_outer_tag_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
 ...
 *           ---------->+                   +---------->
 *    vid=20,pri=2,cf=0 |                   |  vfi 20, prio=3,cfi=1
 ...
 * Summary:
 * ========
 * cint script to demonstrate dot1p, cfi remarking for L2 tagged packets.
 *
 ...
 *   Ingress Packet:
 *
 *  0000 0000 0011 0000 0000 0002 8100 4014
...
verify(int unit)
{
    ...
    snprintf(str, 512, "tx 1 pbm=%d data=0x00000000001100000000000281004014080600010800060400010000000000020A0A0A0200000000000014141402000102030405060708090a0b0c0dbc94977f; sleep quiet 1", ingress_port);
    bshell(unit, str);
    print "show c";
    bshell(unit, "show c");
...
setup_qos_remarking(int unit)
{
    ...
    bcm_vlan_action_set_t default_action;
    uint8 pkt_priority=2, pkt_cfi=0;
    uint8 int_pri=12;
    ...
    rv = qos_port_setup(unit, ingress_port, BCM_QOS_MAP_INGRESS | BCM_QOS_MAP_L2, int_pri, bcmColorGreen, pkt_priority, pkt_cfi);
    if (BCM_FAILURE(rv)) {
