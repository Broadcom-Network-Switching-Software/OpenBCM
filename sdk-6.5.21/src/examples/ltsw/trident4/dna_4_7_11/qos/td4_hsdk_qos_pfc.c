 ...
 *
 * Usage          : BCM.0>cint td4_hsdk_qos_pfc.c  
 *
 * Config         : bcm56880_a0-generic-32x400.config.yml
 *
 * Log file       : td4_hsdk_qos_pfc_log.txt
 *
 * Test Topology  :
 *  
 * DMAC=0x1            +------------+         DMAC=0x1
 ...
 *  Summary:
 *  ========
 *  This cint example demonstrates PFC feature on TD4
 *
 ...
 *         Port cd1 should not egress any packets as pfc pause frames are being
...
{
 uint32 limit_kbits_sec = 10000; /*Bandwidth limit on egress queue - 100 Mbps*/
 int enable = 1;
 int disable = 0;
 ...
 /* Map priority 2 to PG7 */
 int pri_to_pg_array[8] = {0, 1, 7, 3, 4, 5, 6, 7}; 
 int profile_id = 0;
