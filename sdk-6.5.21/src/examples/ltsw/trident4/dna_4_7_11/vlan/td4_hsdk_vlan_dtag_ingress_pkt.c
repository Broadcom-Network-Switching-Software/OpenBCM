...
/*
 * Feature  : VFI assignment for double tagged packets
 *
 * Usage    : BCM.0> cint td4_hsdk_vlan_dtag_ingress_pkt.c
 *
 * config   : bcm56880_a0-generic-vlan.config.yml
 *
 * Log file : td4_hsdk_vlan_dtag_ingress_pkt_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
 ...
 * Summary:
 * ========
 * cint script to demonstrate VFI assignment and tag detection for
