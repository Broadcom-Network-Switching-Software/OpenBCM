    ...
    int core_port)
{
    ...
    rv = bcm_port_class_set(unit, encap_tunnel_id, bcmPortClassForwardEgress, cint_vxlan_roo_basic_info.vxlan_network_group_id);
    ...
    int access_port)
{
    ...
    rv = l3__egress_only_fec__create(unit, egress_core_native_fec_id,
                                     cint_vxlan_roo_basic_info.core_native_eth_rif,
                                     egress_core_native_arp_id, gport, 0);
