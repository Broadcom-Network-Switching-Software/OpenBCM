...
int cint_field_group_const_example_ipt_gen(int unit, bcm_field_context_t context_id)
{
    ...
    rv = cint_field_group_const_main(unit, stage,context_id,bcmFieldActionIPTProfile, 2 , "IPT_prof_2");
    if(rv != BCM_E_NONE)
    {
    ...
    rv = cint_field_group_const_main(unit, stage,context_id,bcmFieldActionIPTCommand, 1 , "IPT_com_1");
    if(rv != BCM_E_NONE)
    {
...
int cint_field_group_const_example_UDH_gen(int unit, bcm_field_context_t context_id)
{
    ...
    rv = cint_field_group_const_main(unit, stage,context_id,bcmFieldActionUDHData2,0xABCDABCD , "UDH2_const");
    if(rv != BCM_E_NONE)
    {
