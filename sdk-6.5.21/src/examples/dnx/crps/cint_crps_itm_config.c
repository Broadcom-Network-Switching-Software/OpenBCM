    ...
    int *engine_id_arr)
{
    ...
    rv = bcm_stat_counter_database_eviction_set(unit, eviction_flags, &database, &eviction);
    if (rv != BCM_E_NONE)
    {
        printf("Error in bcm_stat_counter_database_eviction_set\n");
        return rv;
    }
    ...
    int *engine_id_arr)
{
    ...
    rv = bcm_stat_counter_database_eviction_get(unit, 0, &database, &eviction);
    if (rv != BCM_E_NONE)
    {
        printf("Error in bcm_stat_counter_database_eviction_get\n");
        return rv;
    }
