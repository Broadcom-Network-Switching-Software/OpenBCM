 ...
 */
int e2e_shared_shaper_setup(int unit, int local_port, int nof_elements_in_shared_shaper,
                            uint32 cir_rate_kbps, uint32 eir_rate_kbps,
                            bcm_cosq_scheduler_gport_shared_order_t shared_order)
{
    ...
    shared_scheduler_params.shared_order = shared_order;
