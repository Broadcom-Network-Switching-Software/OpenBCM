...
int validate_mac_fid_limit_interrupt(int unit,int is_up,int is_sim){
    ...
    if (rv != BCM_E_NONE){
        printf("%s(): Error, is_device_jericho2 at validate_mac_fid_limit_interrupt()\n");
        return rv;
    }
...
int mac_fid_limit_interrupt_clear(int unit){
    ...
    rv = is_device_jericho2(unit, &is_jr2);
    if (rv != BCM_E_NONE){
        printf("%s(): Error, is_device_jericho2 at mac_fid_limit_interrupt_clear()\n");
        return rv;
    }
...
int validate_mac_lel_fid_limit_interrupt(int unit,int is_up,int is_sim){
    ...
    rv = is_device_jericho2(unit, &is_jr2);
    if (rv != BCM_E_NONE){
        printf("%s(): Error, is_device_jericho2 at validate_mac_lel_fid_limit_interrupt()\n");
        return rv;
    }
...
int mac_lel_fid_limit_interrupt_clear(int unit){
    ...
    rv = is_device_jericho2(unit, &is_jr2);
    if (rv != BCM_E_NONE){
        printf("%s(): Error, is_device_jericho2 at mac_lel_fid_limit_interrupt_clear()\n");
        return rv;
    }
