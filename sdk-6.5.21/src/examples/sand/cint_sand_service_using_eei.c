 ...
 * cint ../../src/./examples/dnx/cint_sand_field_fec_id_align.c
 ...
 */
     ...
     int pweP)
 {
    ...
    rv = fec_id_alignment_field_add(unit, acP, BCM_L3_ITF_VAL_GET(pwe_term.egress_tunnel_if));
    if (rv != BCM_E_NONE)
    {
...
service_using_eei_in_fec_tunnel_info_update(int unit)
{
    ...
    mpls_encap_tunnel[0].tunnel_id = 40964;
