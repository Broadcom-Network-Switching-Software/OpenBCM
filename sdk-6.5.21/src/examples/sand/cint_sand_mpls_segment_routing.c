    ...
    int out_sys_port)
{
    ...
    /*
        * mpls tunnel
        */
    BCM_L3_ITF_SET(cint_mpls_sr_info.egr_mpls_tunnel_encap_id[0],BCM_L3_ITF_TYPE_LIF, 0x6004);
    BCM_L3_ITF_SET(cint_mpls_sr_info.egr_mpls_tunnel_encap_id[1],BCM_L3_ITF_TYPE_LIF, 0x8005);
    BCM_L3_ITF_SET(cint_mpls_sr_info.egr_mpls_tunnel_encap_id[2],BCM_L3_ITF_TYPE_LIF, 0x4006);
