...
bcm_device_member_get(c6_unit, 0, bcmDeviceMemberDNX, &is_dnx);
if (is_dnx) {
    ...
    C6_SCHED_MAX_BURST *= (credit_worth / 1024);
    C6_SCHED_MAX_BURST_MARGIN *= (credit_worth / 1024);
}
...
*/
    ...
    /* These APIs are not supported for DNX devices*/
    if (!is_dnx) {
        /*
