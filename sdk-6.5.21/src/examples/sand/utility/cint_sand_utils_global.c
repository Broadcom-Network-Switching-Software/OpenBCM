    ...
    int supported_device_id)
{
    ...
    DEVICE_LIST[3] = JERICHO;
    DEVICE_LIST[4] = QUMRAN_MX;
    DEVICE_LIST[5] = JERICHO_B0;
    DEVICE_LIST[6] = QUMRAN_MX_B0;
    DEVICE_LIST[7] = JERICHO_PLUS;
    DEVICE_LIST[8] = QUMRAN_AX;
    DEVICE_LIST[9] = QUMRAN_AX_B0;
    DEVICE_LIST[10] = QUMRAN_UX;
    DEVICE_LIST[11] = JERICHO2;
    DEVICE_LIST[12] = JERICHO2_B0;
    DEVICE_LIST[13] = JERICHO2C;
    DEVICE_LIST[14] = QUMRAN2A;
    DEVICE_LIST[15] = QUMRAN2A_B0;
    DEVICE_LIST[16] = QUMRAN2_UX;
