 ...
 * how to run:
 *
 * Note: the call for cint_field_vpls_gre_setup is not required in jericho (cint_field_vpls_gre_setup
 * required in arad devices for vpls over gre. For Jericho, this is implemented in hardware).
 ...
 cint ../../../../src/examples/dpp/cint_field_vpls_gre.c
 ...
 rv = cint_field_vpls_gre_setup(unit,1,1);
