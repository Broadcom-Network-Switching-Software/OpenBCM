 ...
 */
int cint_field_vpls_gre_main(/* in */ int unit,
...
/* Call cint_field_vpls_gre_main only for arad plus and below (not needed for jericho) */
int cint_field_vpls_gre_setup(/* in */ int unit,
                                 /* in */ int group_priority,
                                 /* in */ bcm_field_group_t group) {
    int rv = BCM_E_NONE;
    int yesno = 0;
    ...
    if (!is_device_or_above(unit,JERICHO)) {
        return cint_field_vpls_gre_main(unit,group_priority,group);
    }
