...
int system_mpls_port_p2p_example(int unit1, int port1, int unit2, int port2){
    ...
    uint32 v2 = 202;
    bcm_vlan_port_t vp1;
    bcm_gport_t gport1= is_device_or_above(unit1, JERICHO2) ? 0x4002 : 16384;
    uint32 pwe2 = 201;
    bcm_mpls_port_t mp2;
    bcm_gport_t gport2= is_device_or_above(unit2, JERICHO2) ? 0x4002 :16384;
...
int system_mpls_port_mp_example(int unit1, int port1, int second_port1, int unit2, int port2){
    ...
    bcm_gport_t second_gport1=is_device_or_above(unit1, JERICHO2) ? 0x6003 : 8196;
    ...
    rv = fec_id_alignment_field_add(unit1, local_second_port1, BCM_L3_ITF_VAL_GET(unit1_egress_intf2));
    if (rv != BCM_E_NONE)
    {
...
int system_protected_mpls_port_example(int unit1, int port1, int unit2, int port2,int port3,int is_mp){
    ...
    bcm_gport_t gport2_lif_a = is_device_or_above(unit2, JERICHO2) ? 0x4002 : 17000;
    bcm_mpls_port_t mp2_lif_b;
    bcm_gport_t gport2_lif_b = is_device_or_above(unit2, JERICHO2) ? 0x6003 : 17002;
    /* on unit1 */
    ...
    bcm_gport_t gport1_lif   = is_device_or_above(unit1, JERICHO2) ? 0x4004 : 17004;
