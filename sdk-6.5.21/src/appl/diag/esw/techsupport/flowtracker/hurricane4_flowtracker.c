...
char * techsupport_flowtracker_hurricane4_diag_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};

#ifndef BCM_SW_STATE_DUMP_DISABLE
/* "flowtracker" feature's software dump command list for specific device, currently NULL */
char * techsupport_flowtracker_hurricane4_sw_dump_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};
...
techsupport_reg_t techsupport_flowtracker_hurricane4_reg_list[] = {
 ...
 * for Hurricane4 device */
static soc_mem_t techsupport_flowtracker_hurricane4_memory_table_list[] = {
...
techsupport_data_t techsupport_flowtracker_hurricane4_data = {
    techsupport_flowtracker_diag_cmdlist,
    techsupport_flowtracker_hurricane4_reg_list,
    techsupport_flowtracker_hurricane4_memory_table_list,
    techsupport_flowtracker_hurricane4_diag_cmdlist
#ifndef BCM_SW_STATE_DUMP_DISABLE
    , techsupport_flowtracker_sw_dump_cmdlist,
    techsupport_flowtracker_hurricane4_sw_dump_cmdlist
#endif /* BCM_SW_STATE_DUMP_DISABLE */
};
#endif
