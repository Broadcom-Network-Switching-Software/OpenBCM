...
sh_sand_cmd_t sh_dnx_swstate_dnx_egr_db_total_esb_queues_allocated_cmds[] = {
    ...
    {"diagnostic_operation_counters", sh_dnx_swstate_dnx_egr_db_total_esb_queues_allocated_diagnostic_operation_counters_cmd, NULL, dnx_swstate_dnx_egr_db_total_esb_queues_allocated_diagnostic_operation_counters_options, &dnx_swstate_dnx_egr_db_total_esb_queues_allocated_diagnostic_operation_counters_man},
    {NULL}
};
...
shr_error_e sh_dnx_swstate_dnx_egr_db_total_esb_queues_allocated_diagnostic_operation_counters_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    dnx_sw_state_diagnostic_operation_counters_print(dnx_egr_db_info[unit], dnx_egr_db_layout_str, DNX_EGR_DB_INFO_NOF_ENTRIES, "DNX_EGR_DB~TOTAL_ESB_QUEUES_ALLOCATED~");
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
sh_sand_option_t dnx_swstate_dnx_egr_db_total_esb_queues_allocated_diagnostic_operation_counters_options[] = {
    {NULL}
};


sh_sand_man_t dnx_swstate_dnx_egr_db_total_esb_queues_allocated_diagnostic_operation_counters_man = {
    "swstate diagnostic_operation_counters",
    "print the diagnostic operation counters",
    "dnx_egr_db total_esb_queues_allocated diagnostic_operation_counters",
    "dnx_egr_db total_esb_queues_allocated diagnostic_operation_counters",
};
