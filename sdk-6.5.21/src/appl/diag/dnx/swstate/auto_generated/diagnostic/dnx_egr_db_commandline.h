...
shr_error_e sh_dnx_swstate_dnx_egr_db_total_esb_queues_allocated_diagnostic_operation_counters_cmd(int unit, args_t *args, sh_sand_control_t *sand_control);
extern sh_sand_option_t dnx_swstate_dnx_egr_db_total_esb_queues_allocated_diagnostic_operation_counters_options[];
extern sh_sand_man_t dnx_swstate_dnx_egr_db_total_esb_queues_allocated_diagnostic_operation_counters_man;
