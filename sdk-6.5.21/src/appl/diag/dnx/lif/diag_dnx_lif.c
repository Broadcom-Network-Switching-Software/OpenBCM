    ...
    if (dnx_data_lif.global_lif.global_lif_bta_max_val_get(unit))
    {
        if ((dir == (DNX_ALGO_LIF_INGRESS | DNX_ALGO_LIF_EGRESS)) || (dir == 0))
        {
            ...
            SHR_IF_ERR_EXIT(lif_mngr_db.global_lif_allocation.
                            symmetric_global_lif.advanced_algorithm_info_get(unit, NULL));
        }
        ...
        if ((dir == (DNX_ALGO_LIF_INGRESS)) || (dir == 0))
        {
            ...
            LOG_CLI((BSL_META_U(unit, "=======================\n")));
            SHR_IF_ERR_EXIT(lif_mngr_db.global_lif_allocation.
                            ingress_global_lif.advanced_algorithm_info_get(unit, NULL));
        }
        ...
        if ((dir == (DNX_ALGO_LIF_EGRESS)) || (dir == 0))
        {
            ...
            LOG_CLI((BSL_META_U(unit, "======================\n")));
            SHR_IF_ERR_EXIT(lif_mngr_db.global_lif_allocation.
                            egress_global_lif.advanced_algorithm_info_get(unit, NULL));
        }
    }
