...
sh_dnx_counter_convert_to_dnx_time_units(
    ...
    dnxcmn_time_unit_e * dnx_time_units)
{
    ...
    switch (time_units)
    {
        case DIAG_DNXC_TIME_UNIT_SEC:
            *dnx_time_units = DNXCMN_TIME_UNIT_SEC;
            break;
        case DIAG_DNXC_TIME_UNIT_MILISEC:
            *dnx_time_units = DNXCMN_TIME_UNIT_MILISEC;
            break;
        case DIAG_DNXC_TIME_UNIT_USEC:
            *dnx_time_units = DNXCMN_TIME_UNIT_USEC;
            break;
        case DIAG_DNXC_TIME_UNIT_NSEC:
            *dnx_time_units = DNXCMN_TIME_UNIT_NSEC;
            break;
        default:
            *dnx_time_units = DNXCMN_TIME_UNIT_INVALID;
            break;
    }
