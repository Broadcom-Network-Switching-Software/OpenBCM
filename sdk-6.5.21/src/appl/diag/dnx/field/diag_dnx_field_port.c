   ...
   /** Switch between all port types and get the relevant pclasses. */
    switch (port_type)
    {
        ...
        case PORT_TYPE_ING_TM:
        {
            ...
            port_type_pclass_arr_p[4] = bcmPortClassFieldExternalTrafficManagementPortCs;
            *nof_pclass_p = 5;
            break;
        }
        case PORT_TYPE_EGR_TM:
        {
            port_type_pclass_arr_p[0] = bcmPortClassFieldEgressTrafficManagementPort;
            *nof_pclass_p = 1;
            break;
        }
        default:
