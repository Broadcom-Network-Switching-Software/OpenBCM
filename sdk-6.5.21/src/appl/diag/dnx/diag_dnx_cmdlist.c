...
static sh_sand_cmd_t sh_dnx_commands[] = {
  /* Name                 | Leaf Action          | Junction Array Pointer         | Options for Leaf         | Usage */
    ...
    {"compare",             NULL,                  sh_dnx_err_rec_comparison_cmds,  NULL,        &sh_dnx_err_rec_comparison_jrnl_man   , NULL, NULL, CTEST_PRECOMMIT | SH_CMD_EXEC_DNX3},
    ...
    {"field",               NULL,                  Sh_dnx_field_cmds,               NULL,                      &Sh_dnx_field_man       , NULL, NULL, CTEST_POSTCOMMIT},
    ...
    {"flow",                NULL,                  sh_dnx_flow_cmds,                NULL,                      &sh_dnx_flow_man        , NULL, NULL, CTEST_POSTCOMMIT}, 
    ...
    {"layer3",              NULL,                  sh_dnx_l3_cmds,                  NULL,                      &sh_dnx_l3_man          , NULL, NULL, CTEST_POSTCOMMIT},
    ...
    {"mbist",               NULL,                  sh_sand_mbist_cmds,              NULL,                      &sh_sand_mbist_man      , NULL, NULL, CTEST_POSTCOMMIT | SH_CMD_NOT_RELEASE},
    {"mdb",                 NULL,                  sh_dnx_mdb_cmds,                 NULL,                      &sh_dnx_mdb_man         , NULL, NULL, CTEST_PRECOMMIT | SH_CMD_SKIP_MEMORY_CHECK},
    {"meter",               NULL,                  sh_dnx_meter_cmds,               NULL,                      &sh_dnx_meter_man       , NULL, NULL, CTEST_POSTCOMMIT},
    {"MTA",                 NULL,                  sh_dnxc_mta_cmds,                NULL,                      &sh_dnxc_mta_man        , NULL, NULL, CTEST_POSTCOMMIT | SH_CMD_NOT_RELEASE},
    ...
    {"packet",              NULL,                  sh_sand_packet_cmds,             NULL,                      &sh_sand_packet_man     , NULL, NULL, CTEST_PRECOMMIT | SH_CMD_SKIP_MEMORY_CHECK},
    ...
    {"signal",              NULL,                  sh_sand_signal_cmds,             NULL,                      &sh_sand_signal_man     , NULL, NULL, CTEST_PRECOMMIT|SH_CMD_NO_XML_VERIFY},
