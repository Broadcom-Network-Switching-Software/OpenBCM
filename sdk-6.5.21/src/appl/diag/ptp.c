...
/* ptp_parse_sysport_to_modport : Parse DNX sys_port_aggregate to find out
 * mod id, port id and trunk id
 */
...
#if defined(BCM_DNX_SUPPORT)
            port_info.multicast_l2[14] = (uint8)(vlantag >> 8) | (0x4 << 5);
#else
