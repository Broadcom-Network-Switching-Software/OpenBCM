...
char cmd_ltsw_l3_usage[] =
    ...
    "              [nsets=<val>] [UseApi=<bool>] [FORTE=<bool>]\n\t"
    ...
    "       - DataMode: 1 - Reduced, 2 - Full.\n\t"
    "       - UseApi: 1 - Use BCM API.\n\t"
    "       - FORTE: 1 - Use FORTE ALPM.\n\n\t"
...
char cmd_ltsw_port_usage[] =
    ...
    "[StatId (Stat ID created by command 'FlexCTR action add') <ID>] <attach|detach>\n\t"
...
char cmd_ltsw_flexport_usage[] =
    "Usage: FLEXport PM<id>[=<pm_mode>[:<port_numbers>]] [Traffic]\n"
#ifndef COMPILER_STRING_CONST_LIMIT
    "Parameters:\n"
    ...
    "  [Traffic]        - Perform traffic test on sepcific Port Macro(s)\n"
    "                     after they are flexed.\n"
    ...
    "Example: flexport pm0=2x200G pm1=4x100G traffic\n"
    "         Flex specific Port Macro(s) into a specific mode and perform traffic test.\n"
    "Example: flexport pm0 pm1 traffic\n"
    "         Flex specific Port Macro(s) into all allowed modes and perform traffic test.\n"
    "Example: flexport traffic\n"
    "         Flex all Port Macro(s) into all allowed modes and perform traffic test.\n";
#endif
    ;
...
char cmd_ltsw_flexctr_usage[] =
    ...
    "                           - Clear flexctr stat\n\t"
    "  flexctr object show [<object>=<VaL>]\n\t"
    "\n"
#endif
    ;
...
char cmd_ltsw_ipmc_usage[] =
    ...
    "  ipmc table add Src_IP=<ipaddr> Src_IPMaskLen=<ipaddr> Mc_IP=<grpaddr>\n\t"
    ...
    "  ipmc table del Src_IP=<ipaddr> Src_IPMaskLen=<ipaddr> Mc_IP=<macaddr>\n\t"
    "         VlanID=<vid>\n\t"
    ...
    "  ipmc ip6table add Src_IP=<ipaddr> Src_IPMaskLen=<ipaddr> Mc_IP=<grpaddr>\n\t"
    "         Mc_IPMaskLen=<grpaddr> VlanID=<vid>\n\t"
    "         Group=<val> [src_Port=<port>] [COS=<cosl>]\n\t"
    "         [NoCHECK=<bool>] [TS=<tsl>] [IngIntf=<val>]\n\t"
    "         [Valid=<bool>] [LookupClass=<val>] [VRF=<vrf>] [Hit=<bool>]\n\t"
    "        - Add an entry into ipmc table.\n\t"
    "  ipmc ip6table del Src_IP=<ipaddr> Src_IPMaskLen=<ipaddr> Mc_IP=<macaddr>\n\t"
    "         VlanID=<vid> [VRF=<vrf>]\n\t"
    "       - Destroy an entry in ipmc table\n\t"
    "  ipmc ip6table clear\n\t"
    "       - Delete all ipmc table.\n\t"
...
#else /* !COMPILER_STRING_CONST_LIMIT */
" Where <cmd> is:\n"
"\tshow [group|entry|presel|hint] [id] [brief]\n"
...
/*! Help for CLI flowtracker command. */
char cmd_ltsw_flowtracker_usage [] =
    "\n\thelp"
    "\n\tflowtracker sw show\n";
