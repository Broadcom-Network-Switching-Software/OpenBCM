 ...
 * Skip list for TR 1 included in the function for all devices.
 */
int
rval_test_skip_reg(int unit, soc_regaddrinfo_t *ainfo, reg_data_t *rd)
{
    ...
    if(SOC_IS_DNX(unit)) {
        ...
        switch(ainfo->reg) {
            ...
            case FDT_LB_DEBUG_FEATURESr:
            case FMAC_SBUS_BROADCAST_IDr:
            case FMAC_BROADCAST_IDSr:
            ...
            case CDB_SBUS_LAST_IN_CHAINr:
            case CDPM_SBUS_LAST_IN_CHAINr:
            ...
            case IPPB_REG_00C5r:
            case MSS_SBUS_LAST_IN_CHAINr:
            case OCB_SBUS_LAST_IN_CHAINr:
            case PEM_SBUS_LAST_IN_CHAINr:
            case FMAC_AUTO_DOC_NAME_37r:
            case FMAC_ECC_ERR_1B_MONITOR_MEM_MASKr:
            case FMAC_ECC_ERR_2B_MONITOR_MEM_MASKr:
            case FMAC_ECC_INTERRUPT_REGISTER_MASKr:
            case FMAC_FMAL_STATISTICS_OUTPUT_CONTROLr:
            case FMAC_GENERAL_CONFIGURATION_REGISTERr:
            case FMAC_INTERRUPT_MASK_REGISTERr:
            case FMAC_LINK_LEVEL_FLOW_CONTROL_ENABLE_REGISTERr:
            case FMAC_LINK_TOPO_MODE_REG_2r:
            case FMAC_REG_00C2r:
            case FMAC_RSF_DEBUGr:
               return 1; /* Skip these registers */
            default:
                break;
		}
