...
static void*
__cint_maddr__lif_mngr_global_lif_info_t(void* p, int mnum, cint_struct_type_t* parent)
{
    void* rv;
    ...
    switch(mnum)
    {
        case 0: rv = &(s->bta); break;
        case 1: rv = &(s->global_lif); break;
...
CINT_FWRAPPER_CREATE_RP5(int, int, 0, 0,
                         ...
                         int,int,unit,0,0,
                         unsigned int ,unsigned int,flags, 0,0,
                         lif_mngr_global_lif_info_t *, lif_mngr_global_lif_info_t, global_lif_info, 1,0,
