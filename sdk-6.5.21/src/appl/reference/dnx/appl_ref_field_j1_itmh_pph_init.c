...
static field_j1_itmh_pph_qual_info_t field_j1_itmh_pph_ipmf3_qual_info_array[J1_ITMH_PPH_NOF_IPMF3_QUALIFIERS] = {
    ...
    {NULL, bcmFieldQualifyContainer, 0,
     {bcmFieldInputTypeMetaData, 0, J1_ITMH_PPH_PARS_OFFSET_TYPE_SH_ADJUST_QUAL_OFFSET}},
...
static field_j1_itmh_pph_action_info_t field_j1_itmh_pph_ipmf3_action_info_array[J1_ITMH_PPH_NOF_IPMF3_ACTIONS] = {
    ...
    {"j1_itmh_pph_parsing_start_offset_a", 0,
     {0, bcmFieldActionParsingStartOffset, J1_ITMH_PPH_PARSING_START_OFFSET_ACTION_LENGTH, 0, 0, {0}}, FALSE},
    {"j1_itmh_pph_void_a_pars", 0, {0, bcmFieldActionVoid, 5, 27, 0, {0}}, FALSE},
    {"j1_itmh_pph_sys_h_a", 0,
     {0, bcmFieldActionSystemHeaderSizeAdjust, J1_ITMH_PPH_SYS_HDR_ADJUST_SIZE_ACTION_LENGTH, 6, 0, {0}}, FALSE},
    ...
    int unit)
{
    ...
    compare_info.second_key_info.qual_info[0].offset =
        field_j1_itmh_pph_cmp_key_qual_info_array[2].qual_attach_info.offset;
