...
/** IPMF2 FG2 Qualifiers info. */
static field_itmh_qual_info_t field_itmh_ipmf2_fg2_qual_info_array[ITMH_NOF_IPMF2_FG2_QUALIFIERS] = {
  /** qual_name  |  qual_id   |   qual_size     |  input_type    |    input_arg  |  qual_offset  */
    {"ase_inj_valid_bit", 0, ASE_INJ_QUAL_LENGTH, {bcmFieldInputTypeLayerAbsolute, 0, ASE_INJ_QUAL_OFFSET}},
    {"tsh_inj_qual", 0, TSH_INJ_QUAL_LENGTH, {bcmFieldInputTypeLayerAbsolute, 0, TSH_INJ_QUAL_OFFSET}}
};

/** IPMF2 FG3 Qualifiers info. */
static field_itmh_qual_info_t field_itmh_ipmf2_fg3_qual_info_array[ITMH_NOF_IPMF2_FG3_QUALIFIERS] = {
  /** qual_name  |  qual_id   |   qual_size     |  input_type    |    input_arg  |  qual_offset  */
    /** Offset in bytes measured from end of system_headers to the start of the 1588 frame [36:43] (8b) */
    {"ase_offset_1588", 0, ASE_1588_OFFSET_LENGTH,
        {bcmFieldInputTypeLayerAbsolute, 1, ASE_1588_OFFSET_OFFSET}},
    /** 1588v2 Encapsulation in ASE-1588v2 Header [32:32] (1b) */
    {"ts_encapsulation_1588", 0, TS_ENCAPSULATION_LENGTH ,
        {bcmFieldInputTypeLayerAbsolute, 1, TS_ENCAPSULATION_OFFSET}},
    /** 1588v2 Command in ASE-1588v2 Header [33:35] (3b) */
    {"ts_command_1588", 0, TS_COMMAND_LENGTH,
        {bcmFieldInputTypeLayerAbsolute, 1, TS_COMMAND_OFFSET}},
    /** Use Ingress time-stamp in the calculation of the 1588 correction [31:31] (1b) */
    {"use_ingress_time_stamp_1588", 0, USE_INGRESS_TIME_STAMP_LENGTH ,
        {bcmFieldInputTypeLayerAbsolute, 1, USE_INGRESS_TIME_STAMP_OFFSET}},
    {"ase_type_qual_1588", 0, 1, {bcmFieldInputTypeConst, 0x1, 0}},
    {"tsh_inj_q_1588", 0, TSH_INJ_QUAL_LENGTH,
        {bcmFieldInputTypeLayerAbsolute, 0, TSH_INJ_QUAL_OFFSET}},
    {"itmh_fwd_l_idx_1588", 0, J2_ITMH_FWD_LAYER_INDEX_QUAL_LENGTH, {bcmFieldInputTypeConst, 0x2, 0}},
};
...
/** {action_name}   |  action_id  |    { stage | action_type | size | prefix_size | prefix_value | name  } */
    {NULL, bcmFieldActionPphPresentSet, {0}, FALSE, {BCM_FIELD_ACTION_DONT_CARE, 1}},
    {NULL, bcmFieldActionPrioIntNew, {0}, FALSE, {BCM_FIELD_ACTION_DONT_CARE, 1}},
    /**
    ...
    {"snoop_data_act", 0, {0, bcmFieldActionSnoopRaw, SNOOP_DATA_ACTION_LENGTH,
        15, 0x0007F, {0}}, FALSE, {BCM_FIELD_ACTION_DONT_CARE, 1}},
    {"destination_act", 0, {0, bcmFieldActionForward, DST_ACTION_LENGTH,
        11, 0, {0}}, FALSE, {BCM_FIELD_ACTION_DONT_CARE, 1}},
    {NULL, bcmFieldActionDropPrecedenceRaw, {0}, FALSE, {BCM_FIELD_ACTION_DONT_CARE, 1}},
    {"ext_exist_act", 0, {0, bcmFieldActionVoid, EXT_EXIST_ACTION_LENGTH,
        31, 0, {0}}, FALSE, {BCM_FIELD_ACTION_DONT_CARE, 1}},
    {"out_lif_act", 0, {0, bcmFieldActionVoid, OUT_LIF_ACTION_LENGTH,
        10, 0, {0}}, FALSE, {BCM_FIELD_ACTION_DONT_CARE, 1}},
    ...
    {"mirror_command_act", 0, {0, bcmFieldActionVoid, MIRROR_ACTION_LENGTH,
        31, 0x00000000, {0}}, FALSE, {BCM_FIELD_ACTION_DONT_CARE, 1}},
    {"fwd_act_str_act", 0, {0, bcmFieldActionVoid, ITMH_FWD_STR_ACTION_LENGTH,
        28, 0x0, {0}}, FALSE, {BCM_FIELD_ACTION_DONT_CARE, 1}},
    {NULL, bcmFieldActionFabricHeaderSetRaw, {0}, TRUE, {BCM_FIELD_ACTION_DONT_CARE, 1}},
    {NULL, bcmFieldActionForwardingLayerIndex, {0}, FALSE, {FWD_LAYER_PRIO_ITMH, 1}},
};

static field_itmh_action_info_t field_itmh_ipmf2_fg2_action_info_array[ITMH_NOF_IPMF2_FG2_ACTIONS] = {
/** {action_name}   |  action_id  |    { stage | action_type | size | prefix_size | prefix_value | name  } */
    {"tsh_with_flow_id_valid_bit_act", 0, {0, bcmFieldActionLatencyFlowId, TSH_INJ_ACTION_LENGTH,
        23, 0, {0}}, TRUE, {BCM_FIELD_ACTION_DONT_CARE, 0}},
};

static field_itmh_action_info_t field_itmh_ipmf2_fg3_action_info_array[ITMH_NOF_IPMF2_FG3_ACTIONS] = {
/** {action_name}   |  action_id  |    { stage | action_type | size | prefix_size | prefix_value | name  } */
    {NULL, bcmFieldActionIEEE1588, {0}, FALSE, {BCM_FIELD_ACTION_DONT_CARE, 1}},
    {"tsh_with_flow_id_valid_bit_act_1588", 0, {0, bcmFieldActionLatencyFlowId, TSH_INJ_ACTION_LENGTH,
        23, 0, {0}}, FALSE, {BCM_FIELD_ACTION_DONT_CARE, 1}},
    {NULL, bcmFieldActionForwardingLayerIndex, {0}, FALSE, {FWD_LAYER_PRIO_1588, 1}},
};
...
static field_itmh_fg_info_t itmh_fg_info_array[ITMH_NOF_FG] = {
    ...
    /** IPMF2 field group info */
    {
        ...
        bcmFieldStageIngressPMF2,   /** Field stage */
        bcmFieldGroupTypeDirectExtraction,  /** Field group type */
        ITMH_NOF_IPMF2_FG2_QUALIFIERS,  /** Number of tested qualifiers */
        ITMH_NOF_IPMF2_FG2_ACTIONS, /** Number of tested actions */
        field_itmh_ipmf2_fg2_qual_info_array,   /** Qualifiers info */
        field_itmh_ipmf2_fg2_action_info_array, /** Actions info */
    ...
    /** IPMF2 field group info */
    {
        ...
        bcmFieldStageIngressPMF2,   /** Field stage */
        bcmFieldGroupTypeDirectExtraction,  /** Field group type */
        ITMH_NOF_IPMF2_FG3_QUALIFIERS,  /** Number of tested qualifiers */
        ITMH_NOF_IPMF2_FG3_ACTIONS, /** Number of tested actions */
        field_itmh_ipmf2_fg3_qual_info_array,   /** Qualifiers info */
        field_itmh_ipmf2_fg3_action_info_array, /** Actions info */
        NULL,  /** FEM actions info */
        FALSE, TRUE
    }
};
 ...
 * \param [in] itmh_context_id - ITMH Context id to be created.
 *
 * \return
 ...
 *
 * \param [in] unit - The unit number.
 * \param [in] context_id - ITMH 1588 Context id to be created.
 *
 * \return
 *   Error code (as per 'shr_error_e').
 * \see
    ...
    bcm_field_context_t context_id)
{
    ...
    bcm_field_context_info_t_init(&context_info);
    sal_strncpy_s((char *) (context_info.name), "ITMH_1588_TSH_IPMF1", sizeof(context_info.name));
    SHR_IF_ERR_EXIT(bcm_field_context_create
 ...
 * \param [in] itmh_context_id - ITMH Context id to be attached to.
 * \param [in] itmh_1588_context_id - ITMH 1588 Context id to be attached to.
 * \param [in] flow_id - Feature flow_id_ext_enable.
 *
 * \return
 *   Error code (as per 'shr_error_e').
 * \see
...
field_itmh_group_config(
    ...
    bcm_field_context_t itmh_context_id,
    bcm_field_context_t itmh_1588_context_id,
    int flow_id)
{
    ...
    for (action_index = 0; action_index < fg_info.nof_actions; action_index++)
    {
        ...
        attach_info.payload_info.action_info[action_index].priority =
            itmh_fg_info->itmh_action_info[action_index].action_attach_info.priority;
        attach_info.payload_info.action_info[action_index].valid_bit_polarity =
            itmh_fg_info->itmh_action_info[action_index].action_attach_info.valid_bit_polarity;
    }
    ...
    if (fg_info.stage == bcmFieldStageIngressPMF2 && itmh_fg_info->itmh_fem_action_info != NULL)
    {
    ...
    if (itmh_fg_info->itmh_context)
    {
        SHR_IF_ERR_EXIT(bcm_field_group_context_attach(unit, 0, itmh_fg_info->fg_id, itmh_context_id, &attach_info));
    }
    if (itmh_fg_info->itmh_1588_context && flow_id)
    {
        SHR_IF_ERR_EXIT(bcm_field_group_context_attach
                        (unit, 0, itmh_fg_info->fg_id, itmh_1588_context_id, &attach_info));
    }
exit:
    SHR_FUNC_EXIT;
}
    ...
    int unit)
{
    ...
    bcm_field_context_t itmh_1588_context_id = dnx_data_field.context.default_itmh_1588_tsh_context_get(unit);
    int flow_id = dnx_data_headers.feature.feature_get(unit, dnx_data_headers_feature_flow_id_ext_enable);

    SHR_FUNC_INIT_VARS(unit);

    SHR_IF_ERR_EXIT(field_itmh_context(unit, itmh_context_id));
    if (flow_id)
    {
        SHR_IF_ERR_EXIT(field_itmh_1588_context(unit, itmh_1588_context_id));
    }
    /**
    ...
    {
        /*
         * field group index 1 is relevant only when TSH_Ext isn't constructed with flow_id_ext
         */
        if (!flow_id && fg_index == 1)
        {
            continue;
        }
        SHR_IF_ERR_EXIT(field_itmh_group_config
                        (unit, &itmh_fg_info_array[fg_index], itmh_context_id, itmh_1588_context_id, flow_id));
    }
