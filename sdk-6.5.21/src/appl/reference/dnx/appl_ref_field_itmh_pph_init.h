...
#define ITMH_PPH_NOF_IPMF2_FG5_ACTIONS       5
...
#define ITMH_PPH_NOF_IPMF2_FG5_QUALIFIERS    2

#define ITMH_PPH_NOF_CMP0_FIRST_KEY_QUALIFIERS      2
#define ITMH_PPH_NOF_CMP0_SECOND_KEY_QUALIFIERS     1
#define ITMH_PPH_NOF_CMP1_FIRST_KEY_QUALIFIERS      2
#define ITMH_PPH_NOF_CMP1_SECOND_KEY_QUALIFIERS     1

#define ITMH_PPH_NOF_IPMF2_FEMS              3

#define ITMH_PPH_NOF_FG                      6

#define ITMH_PPH_NOF_CMP_KEY                 2
...
#define CMP0_SECOND_KEY_GEN_OFFSET     (SYS_HDR_ADJUST_SIZE_FWD_LAYER_INDEX_EGR_PRS_IDX_QUAL_LENGTH)
#define CMP1_SECOND_KEY_GEN_OFFSET     (SYS_HDR_ADJUST_SIZE_FWD_LAYER_INDEX_EGR_PRS_IDX_QUAL_LENGTH + FHEI_TRAP_TYPE_QUAL_LENGTH + FHEI_SIZE_QUAL_LENGTH)
