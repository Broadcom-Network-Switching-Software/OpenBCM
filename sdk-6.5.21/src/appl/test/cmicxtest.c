...
#define PACKET_DATA_BYTES 66
    ...
    sal_memset(descmem,      0, sizeof(descmem));
    sal_memset(hostmem0,     0, sizeof(hostmem0));
    sal_memset(hostmem1,     0, sizeof(hostmem1));
    sal_memset(packet_data2, 0, sizeof(packet_data2));
