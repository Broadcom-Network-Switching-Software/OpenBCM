    ...
    switch(level) {
        ...
        case SOC_HX5_NODE_LVL_L3:
            ...
            if(IS_CPU_PORT(unit, port)) {
                ...
                index +=  ((mmu_port - _BCM_HX5_NUM_ST_PORTS) * SOC_HX5_NUM_UCAST_QUEUE_PER_PORT);
            }
            if(mc == 1) {
                            ...
                            bcm_cosq_control_t type, int arg)
{
    ...
    if (!post_update &&
        ...
        SOC_IF_ERROR_RETURN(
            soc_hx5_mmu_config_shared_buf_recalc(unit, 2 /* egr */, -1,
                        ...
                        bcm_cosq_control_t type, int arg)
{
    ...
    switch (type) {
        ...
        case bcmCosqControlDropLimitAlpha:
            return _bcm_hx5_cosq_alpha_set(unit, gport, cosq,
                                (bcm_cosq_control_drop_limit_alpha_value_t)arg);
                        ...
                        bcm_cosq_control_t type, int *arg)
{
    ...
    switch (type) {
        ...
        case bcmCosqControlDropLimitAlpha:
            return _bcm_hx5_cosq_alpha_get(unit, gport, cosq,
                            (bcm_cosq_control_drop_limit_alpha_value_t *)arg);
        case bcmCosqControlIngressPortPGSharedDynamicEnable:
        case bcmCosqControlEgressUCSharedDynamicEnable:
        case bcmCosqControlEgressMCSharedDynamicEnable:
