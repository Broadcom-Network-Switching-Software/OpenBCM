...
mbcm_functions_t mbcm_tomahawk3_driver = {
    /*  L2 functions */
    bcm_th3_l2_init,
    bcm_th3_l2_term,
    bcm_th3_l2_addr_get,
...
typedef int bcm_esw_tomahawk3_mbcm_not_empty; /* Make ISO compilers happy. */
