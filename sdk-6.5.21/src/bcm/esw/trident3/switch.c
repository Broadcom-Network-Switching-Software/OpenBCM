...
bcm_switch_binding_t trident3_bindings[] =
{
   ...
   { bcmSwitchRemoteLearnTrust, 0,
    ...
    { bcmSwitchVxlanIPv6TunnelVlanTranslateEnable, 1,
        ...
        NULL, soc_feature_vxlan_tunnel_vlan_egress_translation},
    { bcmSwitchIFA2TruncationHdrLenUpdate, 1,
        ING_FLEX_CONFIGr, IFA_TRUNCATION_ENABLEf,
        NULL, soc_feature_ifa_truncated_pkt_hdr_len_update},
    { bcmSwitchIFA2OverLAG, 1,
        ING_FLEX_CONFIGr, IFA_OVER_LAG_ENABLEf,
        NULL, soc_feature_ifa_truncated_pkt_hdr_len_update},
#endif
#if defined(BCM_HELIX5_SUPPORT)
                                ...
                                int arg, int *found)
{
    ...
    *found = 0;
    /*
     * Trident3_bindings can only handle switch type that requires
