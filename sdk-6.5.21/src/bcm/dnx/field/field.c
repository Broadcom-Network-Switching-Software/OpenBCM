    ...
    bcm_field_entry_t * entry_handle)
{
    ...
    {
        /*
         * TCAM, TCAM DT, KBP and state table should have entry handle
         */
    ...
    bcm_field_group_cache_mode_t mode)
{
    ...
    if ((fg_type != DNX_FIELD_GROUP_TYPE_TCAM) && (fg_type != DNX_FIELD_GROUP_TYPE_KBP))
    {
    ...
    bcm_field_group_cache_mode_t mode)
{
    ...
    SHR_INVOKE_VERIFY_DNX(dnx_field_group_cache_verify(unit, flags, fg_id, mode));
