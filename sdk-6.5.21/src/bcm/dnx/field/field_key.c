    ...
    dnx_field_key_ffc_sharing_info_t context_ffc_sharing_info[DBAL_NOF_ENUM_FIELD_KEY_VALUES])
{
    ...
    {
        context_ffc_sharing_info[key_id_compare_pair_1_key_1.id[0]].offset_end = key_id_compare_pair_1_key_1.lsb[0];
        context_ffc_sharing_info[key_id_compare_pair_1_key_2.id[0]].offset_end = key_id_compare_pair_1_key_2.lsb[0];
    }
    if (context_compare_info.pair_2.mode != DNX_FIELD_CONTEXT_COMPARE_MODE_NONE)
    {
        context_ffc_sharing_info[key_id_compare_pair_2_key_1.id[0]].offset_end = key_id_compare_pair_2_key_1.lsb[0];
        context_ffc_sharing_info[key_id_compare_pair_2_key_2.id[0]].offset_end = key_id_compare_pair_2_key_2.lsb[0];
    }
    ...
    dnx_field_key_id_t *key_id_p)
{
         ...
         (key_in_info_p->key_template.key_qual_map[qual_index].qual_type != DNX_FIELD_QUAL_TYPE_INVALID); qual_index++)
    {
        ...
        was_split = FALSE;
        key_index = ((key_qual_map.lsb + key_id_p->lsb[0]) >= DNX_DATA_MAX_FIELD_COMMON_MAX_VAL_KBR_SIZE) ? 1 : 0;
        ...
        LOG_DEBUG_EX(BSL_LOG_MODULE, "qual name %s, field_stage %s, offset in key %d key_index %d\n",
                     ...
                     dnx_field_stage_text(unit, field_stage), (key_qual_map.lsb + key_id_p->lsb[0]), key_index);
        ...
        if (key_index == 0)
        {
            LOG_DEBUG_EX(BSL_LOG_MODULE,
                         ...
                         dnx_field_dnx_qual_text(unit, key_qual_map.qual_type),
                         key_qual_map.lsb, key_qual_map.size, (key_qual_map.lsb + key_id_p->lsb[0]));
        ...
        if (dnx_qual_info.input_type == DNX_FIELD_INPUT_TYPE_CONST)
        {
            ...
            SHR_IF_ERR_EXIT(dnx_field_key_const_quals_set
                            (unit, field_stage, context_id, &dnx_qual_info, &key_qual_map,
                             key_id_p->id[key_index], key_id_p->lsb[0]));
            if (was_split == TRUE)
            {
                ...
                SHR_IF_ERR_EXIT(dnx_field_key_const_quals_set
                                (unit, field_stage, context_id, &split_dnx_qual_info, &split_qual_map,
                                 key_id_p->id[next_key_index], key_id_p->lsb[0]));
            }
            continue;
        }
        SHR_IF_ERR_EXIT(dnx_field_key_ffc_set(unit, field_stage, context_id,
                                              ...
                                              key_id_p->lsb[0], FALSE, DNX_FIELD_FFC_ID_INVALID));
    ...
    dnx_field_key_id_t *key_id_p)
{
    ...
    LOG_DEBUG_EX(BSL_LOG_MODULE,
                 ...
                 'A' + (int) (key_id_p->id[0]), key_id_p->nof_bits[0], key_id_p->lsb[0], EMPTY);
    ...
    dnx_field_key_id_t *key_id_p)
{
    ...
    key_id_p->lsb[0] = dnx_data_field.tcam.key_size_single_get(unit) - key_id_p->nof_bits[0];
    ...
    dnx_field_key_qualifier_ffc_info_t * qualifier_ffc_info_p)
{
    ...
    key_index = ((key_qual_map_p->lsb + key_id_p->lsb[0]) >= DNX_DATA_MAX_FIELD_COMMON_MAX_VAL_KBR_SIZE) ? 1 : 0;
    ...
    if (key_index == 0)
    {
        LOG_DEBUG_EX(BSL_LOG_MODULE,
                     ...
                     dnx_field_dnx_qual_text(unit, key_qual_map_p->qual_type), key_qual_map_p->lsb,
                     key_qual_map_p->size, (key_qual_map_p->lsb + key_id_p->lsb[0]));

        SHR_IF_ERR_EXIT(dnx_field_key_quals_over_key_split(unit,
                                                           key_id_p->lsb[0], key_qual_map_p,
        ...
        if (qual_was_split == TRUE)
        {
            ...
            SHR_IF_ERR_EXIT(dnx_field_key_qual_ffc_get_internal(unit, field_stage, context_id,
                                                                ...
                                                                &second_qual_map, key_id_p->lsb[0],
    ...
    dnx_field_key_id_t *tcam_key_id_p)
{
    ...
    {
        compare_key_starting_offset = initial_key_id_p->lsb[key_idx];
    ...
    dnx_field_key_id_t *tcam_key_id_p)
{
         ...
         (initial_key_id_p->id[key_idx] != DNX_FIELD_KEY_ID_INVALID); key_idx++)
    {
        SHR_IF_ERR_EXIT(dnx_algo_field_key_ipmf1_initial_key_occupation_bmp_deallocate
                        (unit, context_id,
                         dnx_data_field.stage.stage_info_get(unit, DNX_FIELD_STAGE_IPMF1)->compare_key_size,
                         initial_key_id_p->id[key_idx], initial_key_id_p->lsb[key_idx]));
    }
    ...
    dnx_field_key_id_t *initial_key_id_2_p)
{
    ...
    {
        compare_key_starting_offset = initial_key_id_1_p->lsb[key_idx];
        SHR_IF_ERR_EXIT(dnx_algo_field_key_ipmf1_initial_key_occupation_bmp_allocate
                        (unit, context_id,
                         dnx_data_field.stage.stage_info_get(unit, DNX_FIELD_STAGE_IPMF1)->compare_key_size,
    ...
    {
        compare_key_starting_offset = initial_key_id_2_p->lsb[key_idx];
        SHR_IF_ERR_EXIT(dnx_algo_field_key_ipmf1_initial_key_occupation_bmp_allocate
                        (unit, context_id,
                         dnx_data_field.stage.stage_info_get(unit, DNX_FIELD_STAGE_IPMF1)->compare_key_size,
    ...
    dnx_field_key_id_t *initial_key_id_2_p)
{
         ...
         (initial_key_id_1_p->id[key_idx] != DNX_FIELD_KEY_ID_INVALID); key_idx++)
    {
        SHR_IF_ERR_EXIT(dnx_algo_field_key_ipmf1_initial_key_occupation_bmp_deallocate
                        (unit, context_id,
                         dnx_data_field.stage.stage_info_get(unit, DNX_FIELD_STAGE_IPMF1)->compare_key_size,
                         initial_key_id_1_p->id[key_idx], initial_key_id_1_p->lsb[key_idx]));
         ...
         (initial_key_id_2_p->id[key_idx] != DNX_FIELD_KEY_ID_INVALID); key_idx++)
    {
        ...
        SHR_IF_ERR_EXIT(dnx_algo_field_key_ipmf1_initial_key_occupation_bmp_deallocate
                        (unit, context_id,
                         dnx_data_field.stage.stage_info_get(unit, DNX_FIELD_STAGE_IPMF1)->compare_key_size,
                         initial_key_id_2_p->id[key_idx], initial_key_id_2_p->lsb[key_idx]));
    ...
    int unit)
{
    ...
    {
        ctx_used_by_opcode[context_id] = DBAL_ENUM_FVAL_KBP_FORWARD_APP_TYPES_INVALID;
    }
    ...
    DNX_FIELD_KBP_OPCODE_ITERATOR(opcode_id)
    {
        ...
        for (fwd_ctx_index = 0; fwd_ctx_index < nof_fwd_contexts; fwd_ctx_index++)
        {
            ...
            if (ctx_used_by_opcode[fwd_contexts[fwd_ctx_index]] != DBAL_ENUM_FVAL_KBP_FORWARD_APP_TYPES_INVALID)
            {
    ...
    for (context_id = 0; context_id < nof_ifwd2_contexts; context_id++)
    {
        ...
        if (ctx_used_by_opcode[context_id] == DBAL_ENUM_FVAL_KBP_FORWARD_APP_TYPES_INVALID)
        {
