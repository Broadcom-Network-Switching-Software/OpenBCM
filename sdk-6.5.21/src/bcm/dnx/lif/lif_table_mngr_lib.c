...
static const lif_table_manager_field_actions_default_t lif_table_manager_field_actions_default[] = {
    ...
    {DBAL_FIELD_GLOB_LIF_FOR_RCY,              SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    ...
    lif_table_mngr_outlif_info_t * lif_info)
{
    ...
    SHR_IF_ERR_EXIT(dnx_lif_table_mngr_store_valid_fields
                    (unit, FALSE, dbal_table_id, -1, entry_handle_id, result_type, *local_lif_id, !is_new_local_lif));
        ...
        && is_new_local_lif)
    {
        ...
        SHR_IF_ERR_EXIT(dnx_algo_lif_mapping_create
                        (unit, DNX_ALGO_LIF_EGRESS, lif_info->global_lif, &local_lif_mapping_info, TRUE));
    }
