    ...
    int unit)
{
     ...
     */
    l2_traverse_db[unit].l2_traverse_tid =
        shr_thread_start("bcmL2Flush", priority, dnx_l2_traverse_thread, INT_TO_PTR(unit));
    ...
    int unit)
{
    ...
    if (l2_traverse_db[unit].l2_traverse_tid != NULL)
    {
        ...
        SHR_IF_ERR_EXIT(shr_thread_stop(l2_traverse_db[unit].l2_traverse_tid, (5 * SECOND_USEC)));
        l2_traverse_db[unit].l2_traverse_tid = NULL;
    ...
    uint32 table_id)
{
    ...
    shr_thread_wake(l2_traverse_db[unit].l2_traverse_tid);
