...
dnx_sec_db_control_sec_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(dnx_sec_db_control_sec_power_down_info_dump(unit, -1, -1, filters));
    SHR_IF_ERR_EXIT(dnx_sec_db_control_sec_is_forced_power_up_state_dump(unit, filters));
 ...
 */
int
dnx_sec_db_control_sec_power_down_info_dump(int  unit,  int  power_down_info_idx_0,  int  power_down_info_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_sec_db_control_sec_power_down_info_is_powered_down_dump(unit, power_down_info_idx_0,power_down_info_idx_1, filters));
    DNXC_SW_STATE_FUNC_RETURN;
}
 ...
 */
int
dnx_sec_db_control_sec_power_down_info_is_powered_down_dump(int  unit,  int  power_down_info_idx_0,  int  power_down_info_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = power_down_info_idx_0, I0 = power_down_info_idx_0 + 1;
    int i1 = power_down_info_idx_1, I1 = power_down_info_idx_1 + 1, org_i1 = power_down_info_idx_1;
    char *s0 = "", *s1 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, SEC_MODULE_ID, ((dnx_sec_t*)sw_state_roots_array[unit][SEC_MODULE_ID])->control_sec.power_down_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, SEC_MODULE_ID, ((dnx_sec_t*)sw_state_roots_array[unit][SEC_MODULE_ID])->control_sec.power_down_info) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            /* coverity[overrun-local:FALSE] */
                DNX_SW_STATE_DUMP_PTR_NULL_CHECK(
                    unit,
                    ((dnx_sec_t*)sw_state_roots_array[unit][SEC_MODULE_ID])->control_sec.power_down_info[i0]);
            ...
            if (i1 == -1) {
                ...
                i1 = dnx_sw_state_dump_check_all_the_same(unit,
                    ((dnx_sec_t*)sw_state_roots_array[unit][SEC_MODULE_ID])->control_sec.power_down_info[i0]
                    , sizeof(*((dnx_sec_t*)sw_state_roots_array[unit][SEC_MODULE_ID])->control_sec.power_down_info[i0]), I1, &s1) ? I1 - 1 : 0;
            }

            if(i1 >= dnx_sw_state_get_nof_elements(unit, SEC_MODULE_ID, ((dnx_sec_t*)sw_state_roots_array[unit][SEC_MODULE_ID])->control_sec.power_down_info[i0]))
            {
                LOG_CLI((BSL_META("dnx_sec_db[]->((dnx_sec_t*)sw_state_roots_array[][SEC_MODULE_ID])->control_sec.power_down_info[][].is_powered_down: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, SEC_MODULE_ID, ((dnx_sec_t*)sw_state_roots_array[unit][SEC_MODULE_ID])->control_sec.power_down_info[i0]) == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                DNX_SW_STATE_PRINT_MONITOR(
                    unit,
                    "dnx_sec_db[%d]->","((dnx_sec_t*)sw_state_roots_array[%d][SEC_MODULE_ID])->","control_sec.power_down_info[%s%d][%s%d].is_powered_down: ", s0, i0, s1, i1);
                ...
                dnx_sw_state_print_int(
                    unit,
                    &((dnx_sec_t*)sw_state_roots_array[unit][SEC_MODULE_ID])->control_sec.power_down_info[i0][i1].is_powered_down);
 ...
 */
int
dnx_sec_db_control_sec_is_forced_power_up_state_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "sec control_sec is_forced_power_up_state") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate sec control_sec is_forced_power_up_state\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_sec_db/control_sec/is_forced_power_up_state.txt",
            "dnx_sec_db[%d]->","((dnx_sec_t*)sw_state_roots_array[%d][SEC_MODULE_ID])->","control_sec.is_forced_power_up_state: ");
...
dnx_sec_db_control_sec_port_state_info_is_macsec_enabled_dump(int  unit,  int  port_state_info_idx_0,  int  port_state_info_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, SEC_MODULE_ID, ((dnx_sec_t*)sw_state_roots_array[unit][SEC_MODULE_ID])->control_sec.port_state_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, SEC_MODULE_ID, ((dnx_sec_t*)sw_state_roots_array[unit][SEC_MODULE_ID])->control_sec.port_state_info) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, SEC_MODULE_ID, ((dnx_sec_t*)sw_state_roots_array[unit][SEC_MODULE_ID])->control_sec.port_state_info[i0]))
            {
                LOG_CLI((BSL_META("dnx_sec_db[]->((dnx_sec_t*)sw_state_roots_array[][SEC_MODULE_ID])->control_sec.port_state_info[][].is_macsec_enabled: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, SEC_MODULE_ID, ((dnx_sec_t*)sw_state_roots_array[unit][SEC_MODULE_ID])->control_sec.port_state_info[i0]) == 0)
            {
                SHR_EXIT();
            }
...
const char* dnx_sec_db_layout_str[DNX_SEC_DB_INFO_NOF_ENTRIES] = {
    ...
    "DNX_SEC_DB~CONTROL_SEC~IS_FORCED_POWER_UP_STATE~",
