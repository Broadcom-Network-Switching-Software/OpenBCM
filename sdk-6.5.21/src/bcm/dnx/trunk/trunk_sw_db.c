    ...
    int *member_index)
{
    ...
    else
    {
        ...
        SHR_IF_ERR_EXIT(algo_trunk_db.pools.groups.
                        spa_id_manager.allocate_single(unit, pool, group, 0, NULL, &member_info->spa_member_id));
    }
    ...
    int is_last_replication)
{
    ...
    {
        SHR_IF_ERR_EXIT(algo_trunk_db.pools.groups.
                        tm_index_manager.free_single(unit, pool, group, removed_member_info.index));
    }
    ...
    if (is_last_replication)
    {
        ...
        SHR_IF_ERR_EXIT(algo_trunk_db.pools.groups.
                        spa_id_manager.free_single(unit, pool, group, removed_member_info.spa_member_id));
    }
    ...
    int member)
{
    ...
    SHR_IF_ERR_EXIT(algo_trunk_db.pools.groups.
                    tm_index_manager.free_single(unit, pool, group, disabled_member_tm_index));
exit:
    SHR_FUNC_EXIT;
}
