    ...
    uint32 *nof_contexts)
{
    ...
    uint32 fwd_ctx_hw_id[DNX_DATA_MAX_FIELD_KBP_MAX_FWD_CONTEXT_NUM_FOR_ONE_APPTYPE] = { 0 };
    int ctx_index = 0;
    int nof_ctxs = 0;
...
shr_error_e kbp_mngr_db_create_internal(int unit, dbal_tables_e table_id, uint8 clone_id, uint8 counters_enable, uint32 initial_capacity, int algo_mode, uint8 *db_id){DNX_KBP_DUMMY_PROTOTYPE_ERR_MSG("kbp_mngr_db_create_internal")}
shr_error_e kbp_mngr_init_internal(int unit){DNX_KBP_DUMMY_PROTOTYPE_ERR_MSG("kbp_mngr_init_internal")}
shr_error_e kbp_mngr_sync_internal(int unit){DNX_KBP_DUMMY_PROTOTYPE_ERR_MSG("kbp_mngr_sync_internal")}
shr_error_e kbp_mngr_wb_init_internal(int unit){DNX_KBP_DUMMY_PROTOTYPE_ERR_MSG("kbp_mngr_wb_init_internal")}
shr_error_e kbp_mngr_db_key_segment_set(int unit, uint32 db_id, int index, uint32 *segment_type, uint32 *segment_size, char segment_name[DNX_KBP_KEY_SEGMENT_NAME_SIZE_IN_BYTES]){DNX_KBP_DUMMY_PROTOTYPE_ERR_MSG("kbp_mngr_db_key_segment_set")}
shr_error_e kbp_mngr_db_key_segment_get(int unit, uint32 db_id, int index, uint32 *segment_type, uint32 *segment_size, char segment_name[DNX_KBP_KEY_SEGMENT_NAME_SIZE_IN_BYTES]){DNX_KBP_DUMMY_PROTOTYPE_ERR_MSG("kbp_mngr_db_key_segment_get")}
shr_error_e kbp_mngr_master_key_segment_set(int unit, uint32 opcode_id, int index, uint32 *segment_type, uint32 *segment_size, char segment_name[DNX_KBP_KEY_SEGMENT_NAME_SIZE_IN_BYTES], uint32 *overlay_offset){DNX_KBP_DUMMY_PROTOTYPE_ERR_MSG("kbp_mngr_master_key_segment_set")}
shr_error_e kbp_mngr_master_key_segment_get(int unit, uint32 opcode_id, int index, uint32 *segment_type, uint32 *segment_size, char segment_name[DNX_KBP_KEY_SEGMENT_NAME_SIZE_IN_BYTES], uint32 *overlay_offset){DNX_KBP_DUMMY_PROTOTYPE_ERR_MSG("kbp_mngr_master_key_segment_get")}
shr_error_e kbp_mngr_context_to_opcode_set(int unit, uint8 fwd_context, uint8 acl_context,uint8 opcode_id){DNX_KBP_DUMMY_PROTOTYPE_ERR_MSG("kbp_mngr_context_to_opcode_set")}
/* *INDENT-ON* */
