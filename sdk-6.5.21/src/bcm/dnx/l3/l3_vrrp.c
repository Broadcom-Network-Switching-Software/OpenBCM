...
/*
 * Returns the number of iterations based on EXEM1/EXEM3 capacity.
 */
#define DNX_L3_VRRP_NOF_ITER_GET(capacity_exem3) (capacity_exem3 == 1 ? 2 : 1)

/*
 * Returns the start of iteration value based on EXEM1/EXEM3 capacity.
 */
...
dnx_l3_vrrp_init(
    int unit)
{
    int capacity_sexem_1, capacity_sexem_3;
