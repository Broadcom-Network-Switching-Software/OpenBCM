...

    {
            ...
            (endpoint_info->id >= dnx_data_oam.oamp.oamp_mep_full_entry_threshold_get(unit)))
        {
            ...
            if ((entry_bank >= extra_data_header_bank)
                && (entry_bank < extra_data_header_bank + nof_extra_data_entries))
            {
                SHR_ERR_EXIT(_SHR_E_PARAM,
    ...
    if (_SHR_IS_FLAG_SET(hw_update_data->bfd_sw_state_flags, DBAL_DEFINE_BFD_ENDPOINT_SW_STATE_FLAGS_FROM_OAMP))
    {
...

        {
            ...
            SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_modify_data_in_templates(unit, endpoint_info, existing_endpoint_info,
                                                                     mep_oamp_v1_entry_values, rmep_entry_values,
                                                                     oamp_v1_hw_delete_data,
                                                                     mep_oamp_v1_hw_write_data, rmep_hw_write_data));
...
/** Second section: writing to hardware tables   */
    ...
    SHR_IF_ERR_EXIT(dnx_bfd_endpoint_db_write_to_hw(unit, hw_update_data, NULL));
    ...
    if (_SHR_IS_FLAG_SET(hw_update_data->bfd_sw_state_flags, DBAL_DEFINE_BFD_ENDPOINT_SW_STATE_FLAGS_FROM_OAMP))
    {
        {
#ifdef BCM_DNX2_SUPPORT
            SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_endpoint_db_write_to_hw
                            (unit, mep_oamp_v1_hw_write_data, rmep_hw_write_data));

            SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_endpoint_db_delete_from_hw
                            (unit, mep_oamp_v1_entry_values, rmep_entry_values, oamp_v1_hw_delete_data,
    ...
    bfd_temp_endpoint_data_t * hw_write_data)
{
    ...
    /** Save the resulting endpoint to the databases   */
    SHR_IF_ERR_EXIT(dnx_bfd_endpoint_db_write_to_hw(unit, hw_write_data, NULL));
...
/* { */
            ...
            SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_write_data_to_templates
                            (unit, endpoint_info, mep_oamp_v1_hw_write_data, rmep_hw_write_data));
...
/** Second section: writing to hardware tables   */
    ...
    SHR_IF_ERR_EXIT(dnx_bfd_endpoint_db_write_to_hw(unit, hw_write_data, endpoint_info));
...
/* { */
            ...
            SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_read_data_from_templates
                            (unit, endpoint_info, mep_oamp_v1_sw_read_data, rmep_sw_read_data));
/* } */
#endif
        }
    ...
    if (_SHR_IS_FLAG_SET(hw_delete_data->bfd_sw_state_flags, DBAL_DEFINE_BFD_ENDPOINT_SW_STATE_FLAGS_FROM_OAMP))
    {
...

        {
            ...
            SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_delete_data_from_templates
                            (unit, endpoint, mep_oamp_v1_entry_values, rmep_entry_values, oamp_v1_hw_delete_data,
    ...
    if (_SHR_IS_FLAG_SET(hw_delete_data->bfd_sw_state_flags, DBAL_DEFINE_BFD_ENDPOINT_SW_STATE_FLAGS_FROM_OAMP))
    {

        {
            ...
            SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_endpoint_db_delete_from_hw
                            (unit, mep_oamp_v1_entry_values, rmep_entry_values, oamp_v1_hw_delete_data,
                             punt_good_hw_write_data));
            oam_type = mep_oamp_v1_entry_values->mep_type;
#endif
        }
        ...
        SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_endpoint_db_get_const_for_oamp_rmep_index_db
                        (unit, oam_type, &rmep_index_const));
