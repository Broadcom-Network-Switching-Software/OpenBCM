    ...
    void *cookie)
{
    ...
    {
        adapter_pkt_data_p = sal_alloc(packet_size, "adapter_pkt_data_p");
        sal_memset(adapter_pkt_data_p, 0, packet_size);
    ...
    if (adapter_pkt_data_p != NULL)
    {
        sal_free(adapter_pkt_data_p);
    }
