    ...
    bcm_core_t * core)
{
    ...
    /** for channelized port, PTC is taken from channel 0's */
...
static shr_error_e
dnx_port_pp_ptc_routing_enable_profile_vtt1_set(
    int unit,
    bcm_port_t port,
    dnx_port_pp_ingress_port_ptc_info_t * ingress_ptc_info)
{
    ...
    BCM_PBMP_ITER(gport_info.local_port_bmp, local_port)
    {
        ...
        dbal_entry_key_field16_set(unit, entry_handle_id, DBAL_FIELD_PTC, ptc);
        /** Value fields */
        dbal_entry_value_field8_set(unit, entry_handle_id, DBAL_FIELD_PTC_ROUTING_ENABLE_PROFILE_VTT1, INST_SINGLE,
...
static shr_error_e
dnx_port_pp_recycle_app_type_to_vtt1_ptc_routing_enable_profile(
    int unit,
    int recycle_app_type,
    dbal_enum_value_field_ptc_routing_enable_profile_vtt1_e * vtt1_ptc_routing_enable_profile)
{
    ...
    switch (recycle_app_type)
    {
        case bcmPortControlRecycleAppBridgeFallback:
        {
             ...
             */
            *vtt1_ptc_routing_enable_profile = DBAL_ENUM_FVAL_PTC_ROUTING_ENABLE_PROFILE_VTT1_NEVERTERMINATE;
            break;
        }
        default:
        {
    ...
    int recycle_app_type)
{
    ...
    switch (recycle_app_type)
    {
        case bcmPortControlRecycleAppBridgeFallback:
        {
            SHR_IF_ERR_EXIT(dnx_port_pp_recycle_app_type_to_vtt1_ptc_routing_enable_profile
                            (unit, recycle_app_type, &(ingress_ptc_info.vtt1_ptc_routing_enable_profile)));
            SHR_IF_ERR_EXIT(dnx_port_pp_ptc_routing_enable_profile_vtt1_set(unit, port, &ingress_ptc_info));
            break;
        }
        default:
        {
