    ...
    bcm_port_resource_t * resource)
{
    ...
    {
        SHR_IF_ERR_EXIT(dnx_algo_port_logicals_get
                        (unit, _SHR_CORE_ALL, DNX_ALGO_PORT_LOGICALS_TYPE_RCY, DNX_ALGO_PORT_LOGICALS_F_MASTER_ONLY,
                         &all_rcy_master_ports));
        BCM_PBMP_ITER(all_rcy_master_ports, rcy_port_i)
        {
    ...
    int *data_rate)
{
    ...
    /** verify parameters */
    SHR_INVOKE_VERIFY_DNX(dnx_port_data_rate_verify(unit, port, data_rate));
