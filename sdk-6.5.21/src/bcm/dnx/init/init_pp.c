    ...
    int unit)
{
    ...
    int entry;
    uint32 ipv4_uc_protocol_val;
    uint32 ipv4_mc_protocol_val;
    uint32 ipv6_uc_protocol_val;
    uint32 ipv6_mc_protocol_val;
    uint32 ipv4_uc_r0_fwd_code_val;
    uint32 ipv4_uc_r1_fwd_code_val;
    uint32 ipv4_mc_r0_fwd_code_val;
    uint32 ipv4_mc_r1_fwd_code_val;
    uint32 ipv6_uc_r0_fwd_code_val;
    uint32 ipv6_uc_r1_fwd_code_val;
    uint32 ipv6_mc_r0_fwd_code_val;
    uint32 ipv6_mc_r1_fwd_code_val;

    SHR_FUNC_INIT_VARS(unit);

    SHR_IF_ERR_EXIT(dbal_fields_enum_hw_value_get
                    (unit, DBAL_FIELD_CURRENT_PROTOCOL_TYPE,
                     DBAL_ENUM_FVAL_CURRENT_PROTOCOL_TYPE_IPV4_UC, &ipv4_uc_protocol_val));
    SHR_IF_ERR_EXIT(dbal_fields_enum_hw_value_get
                    (unit, DBAL_FIELD_CURRENT_PROTOCOL_TYPE,
                     DBAL_ENUM_FVAL_CURRENT_PROTOCOL_TYPE_IPV4_MC, &ipv4_mc_protocol_val));
    SHR_IF_ERR_EXIT(dbal_fields_enum_hw_value_get
                    (unit, DBAL_FIELD_CURRENT_PROTOCOL_TYPE,
                     DBAL_ENUM_FVAL_CURRENT_PROTOCOL_TYPE_IPV6_UC, &ipv6_uc_protocol_val));
    SHR_IF_ERR_EXIT(dbal_fields_enum_hw_value_get
                    (unit, DBAL_FIELD_CURRENT_PROTOCOL_TYPE,
                     DBAL_ENUM_FVAL_CURRENT_PROTOCOL_TYPE_IPV6_MC, &ipv6_mc_protocol_val));

    SHR_IF_ERR_EXIT(dbal_fields_enum_hw_value_get
                    (unit, DBAL_FIELD_EGRESS_FWD_CODE,
                     DBAL_ENUM_FVAL_EGRESS_FWD_CODE_IPV4_UC_R0, &ipv4_uc_r0_fwd_code_val));
    SHR_IF_ERR_EXIT(dbal_fields_enum_hw_value_get
                    (unit, DBAL_FIELD_EGRESS_FWD_CODE,
                     DBAL_ENUM_FVAL_EGRESS_FWD_CODE_IPV4_UC_R1, &ipv4_uc_r1_fwd_code_val));
    SHR_IF_ERR_EXIT(dbal_fields_enum_hw_value_get
                    (unit, DBAL_FIELD_EGRESS_FWD_CODE,
                     DBAL_ENUM_FVAL_EGRESS_FWD_CODE_IPV4_MC_R0, &ipv4_mc_r0_fwd_code_val));
    SHR_IF_ERR_EXIT(dbal_fields_enum_hw_value_get
                    (unit, DBAL_FIELD_EGRESS_FWD_CODE,
                     DBAL_ENUM_FVAL_EGRESS_FWD_CODE_IPV4_MC_R1, &ipv4_mc_r1_fwd_code_val));

    SHR_IF_ERR_EXIT(dbal_fields_enum_hw_value_get
                    (unit, DBAL_FIELD_EGRESS_FWD_CODE,
                     DBAL_ENUM_FVAL_EGRESS_FWD_CODE_IPV6_UC_R0, &ipv6_uc_r0_fwd_code_val));
    SHR_IF_ERR_EXIT(dbal_fields_enum_hw_value_get
                    (unit, DBAL_FIELD_EGRESS_FWD_CODE,
                     DBAL_ENUM_FVAL_EGRESS_FWD_CODE_IPV6_UC_R1, &ipv6_uc_r1_fwd_code_val));
    SHR_IF_ERR_EXIT(dbal_fields_enum_hw_value_get
                    (unit, DBAL_FIELD_EGRESS_FWD_CODE,
                     DBAL_ENUM_FVAL_EGRESS_FWD_CODE_IPV6_MC_R0, &ipv6_mc_r0_fwd_code_val));
    SHR_IF_ERR_EXIT(dbal_fields_enum_hw_value_get
                    (unit, DBAL_FIELD_EGRESS_FWD_CODE,
                     DBAL_ENUM_FVAL_EGRESS_FWD_CODE_IPV6_MC_R1, &ipv6_mc_r1_fwd_code_val));

    if (((ipv4_uc_protocol_val >> 1) != (ipv6_uc_protocol_val >> 1)) ||
        ((ipv4_uc_protocol_val | ((ipv4_uc_r0_fwd_code_val & 0x1) << 3)) != ipv4_uc_protocol_val) ||
        ((ipv4_uc_protocol_val | ((ipv4_mc_r0_fwd_code_val & 0x1) << 3)) != ipv4_mc_protocol_val) ||
        ((ipv6_uc_protocol_val | ((ipv6_uc_r0_fwd_code_val & 0x1) << 3)) != ipv6_uc_protocol_val) ||
        ((ipv6_uc_protocol_val | ((ipv6_mc_r0_fwd_code_val & 0x1) << 3)) != ipv6_mc_protocol_val) ||
        ((ipv4_uc_r0_fwd_code_val & 0x1) != (ipv4_uc_r1_fwd_code_val & 0x1)) ||
        ((ipv4_mc_r0_fwd_code_val & 0x1) != (ipv4_mc_r1_fwd_code_val & 0x1)) ||
        ((ipv6_uc_r0_fwd_code_val & 0x1) != (ipv6_uc_r1_fwd_code_val & 0x1)) ||
        ((ipv6_mc_r0_fwd_code_val & 0x1) != (ipv6_mc_r1_fwd_code_val & 0x1)))
    {
        SHR_ERR_EXIT(_SHR_E_INTERNAL,
                     "Defined CURRENT_PROTOCOL_TYPE/EGRESS_FWD_CODE does not meet the required criteria\n");
    }
    ...
    int unit)
{
    ...
    if (dnx_data_l2.general.feature_get(unit, dnx_data_l2_general_ivl_feature_support) == 1)
    {
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_FWD2_CONTEXT_ID,
