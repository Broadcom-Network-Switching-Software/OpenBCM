    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(soc_sand_control_dynamic_mem_writes(unit, SOC_IS_Q2A(unit) ? q2a_dynamic_mem_enable_regs : (SOC_IS_J2C(unit) ? j2c_dynamic_mem_enable_regs : (SOC_IS_J2P(unit) ? j2p_dynamic_mem_enable_regs : jr2_dynamic_mem_enable_regs)), 1));  /* enable
                                                                                                                                                                                                                                                         * *
                                                                                                                                                                                                                                                         * dynamic
                                                                                                                                                                                                                                                         * * *
                                                                                                                                                                                                                                                         * memory * 
