    ...
    dnx_bfd_oamp_v1_endpoint_t * entry_values)
{
        ...
        || endpoint_info->type == bcmBFDTunnelTypeMplsTpCcCv)
    {
        ...
        else if (endpoint_info->type == bcmBFDTunnelTypeMpls || endpoint_info->type == bcmBFDTunnelTypeMplsTpCcCv)
        {
            entry_values->src_ip_profile = mep_hw_write_data->ipv4_src_addr_index;
        }
    }
    ...
    uint8 new_profile)
{
    ...
    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_get(unit, endpoint, oamp_mep_db_entry));
    oamp_mep_db_entry->mep_profile = new_profile;
    UTILEX_SET_BIT(oamp_mep_db_entry->flags, TRUE, OAMP_MEP_UPDATE);
    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_add(unit, endpoint, oamp_mep_db_entry));
 ...
 */
static shr_error_e
dnx_bfd_oamp_v1_delete_oamp_cluster_mep_profiles(
    int unit,
    bcm_bfd_endpoint_t endpoint,
    ...
    int is_single_hop_with_random_dip)
{
    ...
    if (tx_rate_data.cluster_profile != 0xFF)
    {
        SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_delete_oamp_cluster_mep_profiles
 ...
 */
static shr_error_e
dnx_bfd_oamp_v1_local_min_echo_sw_update(
    int unit,
    const bcm_bfd_endpoint_info_t * endpoint_info,
    dnx_bfd_oamp_v1_temp_mep_db_data_t * mep_hw_write_data)
{
 ...
 */
static shr_error_e
dnx_bfd_oamp_v1_itmh_priority_profile_sw_update(
    int unit,
    const bcm_bfd_endpoint_info_t * endpoint_info,
    dnx_bfd_oamp_v1_temp_mep_db_data_t * mep_hw_write_data)
{
    ...
    uint8 current_profile)
{
    ...
    uint8 write_hw, first_reference = FALSE, is_bfd_without_mpls_lm_dm = 0;
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FUNC_INIT_VARS(unit);
 ...
 */
static shr_error_e
dnx_bfd_oamp_v1_local_min_echo_sw_read(
    int unit,
    bcm_bfd_endpoint_info_t * endpoint_info,
 ...
 */
static shr_error_e
dnx_bfd_oamp_v1_punt_profile_sw_read(
    int unit,
    bcm_bfd_endpoint_info_t * endpoint_info,
 ...
 */
static shr_error_e
dnx_bfd_oamp_v1_itmh_priority_profile_sw_read(
    int unit,
    bcm_bfd_endpoint_info_t * endpoint_info,
    const dnx_bfd_oamp_v1_temp_mep_db_data_t * mep_sw_read_data)
{
 ...
 */
static shr_error_e
dnx_bfd_oamp_v1_punt_profile_sw_update(
    int unit,
    const bcm_bfd_endpoint_info_t * endpoint_info,
    ...
    bfd_temp_oamp_rmep_db_data_t * rmep_hw_write_data)
{
    ...
    SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_itmh_priority_profile_sw_update(unit, endpoint_info, mep_hw_write_data));
    ...
    SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_tx_rate_profile_sw_update(unit, endpoint_info, mep_hw_write_data, 0xFF));
    ...
    SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_local_min_echo_sw_update(unit, endpoint_info, mep_hw_write_data));

    /** End of BFD PDU relevant templates */

    /** Punt profile - used for reception only */
    SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_punt_profile_sw_update(unit, endpoint_info, rmep_hw_write_data));
     ...
     */
    SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_mep_profile_sw_update(unit, endpoint_info, mep_hw_write_data));
    ...
    bfd_temp_oamp_rmep_db_data_t * rmep_hw_write_data)
{
    ...
    if (new_endpoint_info->int_pri != existing_endpoint_info->int_pri)
    {
        ...
        SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_itmh_priority_profile_sw_update(unit, new_endpoint_info, mep_hw_write_data));
         ...
         BCM_OAMP_SW_ENTRY_INFO_PERIOD_TO_MEP_DB_SCAN_RATE(existing_endpoint_info->bfd_period)))
    {
        ...
        SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_tx_rate_profile_sw_update(unit, new_endpoint_info,
                                                                  mep_hw_write_data,
        ...
        || (existing_endpoint_info->flags2 != new_endpoint_info->flags2))
    {
         ...
         */
        SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_mep_profile_sw_update(unit, new_endpoint_info, mep_hw_write_data));
        ...
        ((new_endpoint_info->flags & PUNT_PROFILE_FLAGS) != (existing_endpoint_info->flags & PUNT_PROFILE_FLAGS)))
    {
        ...
        SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_punt_profile_sw_update(unit, new_endpoint_info, rmep_hw_write_data));
    ...
    const bfd_temp_oamp_rmep_db_data_t * rmep_sw_read_data)
{
    ...
    SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_itmh_priority_profile_sw_read(unit, endpoint_info, mep_sw_read_data));
    ...
    SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_punt_profile_sw_read(unit, endpoint_info, rmep_sw_read_data));
    ...
    SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_local_min_echo_sw_read(unit, endpoint_info, mep_sw_read_data));
    ...
    int is_single_hop_with_random_dip)
{
    ...
    if (tx_rate_data.cluster_profile != 0xFF)
    {
        SHR_IF_ERR_EXIT(dnx_bfd_oamp_v1_delete_cluster_mep_profiles(unit, endpoint, tx_rate_data.cluster_profile,
 ...
 */
    ...
    if (_SHR_IS_FLAG_SET(entry_values->flags, DNX_OAMP_BFD_MEP_Q_ENTRY) == 1)
    {
        ...
        if (_SHR_IS_FLAG_SET(entry_values->flags, DNX_OAMP_BFD_IPV6))
        {
            ...
            dnx_bfd_oamp_v1_udp_over_ipv6_external_data(unit, endpoint_info->id, endpoint_info, ipv6_extra_data_header);
            ...
            dnx_oamp_v1_mdb_extra_data_set(unit, endpoint_info->id, 0 /* not offloaded */ , 1 /* 1/4 entry */ ,
                                           calculated_crc,
                                           (1 << DNX_BFD_OAMP_V1_EXTRA_DATA_HEADER_OPCODES_TO_PREPEND_NOF_BITS) - 1,
                                           DNX_BFD_IPV6_HEADER_SIZE * UTILEX_NOF_BITS_IN_BYTE,
