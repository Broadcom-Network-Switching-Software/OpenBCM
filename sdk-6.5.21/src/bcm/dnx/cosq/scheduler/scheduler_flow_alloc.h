 ...
 * \param [in] shared_order - shared shaper flow order (relevant only for shared shaper flow types)
 ...
 */
shr_error_e dnx_scheduler_flow_shared_order_from_flow_type_get(
    int unit,
    int core,
    dnx_sch_alloc_flow_type_e flow_type,
    int flow_id,
