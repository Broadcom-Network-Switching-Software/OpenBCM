...
* \param [in] unit - chip unit id
* \param [in] core_id - core id
* \param [in] out_tm_port - otm port number 0-255
...
*   * None
*/
shr_error_e dnx_ecgm_dbal_out_tm_port_to_port_profile_set(
    uint32 unit,
    uint32 core_id,
    uint32 out_tm_port,
    uint32 base_q_pair,
...
*   * None
*/
shr_error_e dnx_ecgm_dbal_out_tm_port_to_port_profile_get(
    uint32 unit,
    uint32 core_id,
    uint32 out_tm_port,
    uint32 *port_profile);
