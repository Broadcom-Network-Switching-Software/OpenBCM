    ...
    bcm_stat_eviction_t * eviction)
{
    ...
    DNX_ERR_RECOVERY_START(unit);
    /** Verify parameters */
    SHR_INVOKE_VERIFY_DNX(dnx_crps_mgmt_counter_database_eviction_set_verify(unit, flags, database, eviction));
    ...
    bcm_stat_eviction_t * eviction)
{
    ...
    DNX_ERR_RECOVERY_START(unit);
    /** Verify parameters */
    SHR_INVOKE_VERIFY_DNX(dnx_crps_mgmt_counter_database_eviction_get_verify(unit, flags, database, eviction));
