    ...
    const bcmint_field_destination_lt_t **lt_info)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_field_destination_lt_db_get(unit, &lt_db));
    ...
    int *code)
{
    ...
    SHR_NULL_CHECK(code, SHR_E_PARAM);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_field_destination_drop_reason_to_code(unit, reason, code));
    ...
    bcm_field_drop_reason_t *reason)
{
    ...
    SHR_NULL_CHECK(reason, SHR_E_PARAM);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_field_destination_drop_code_to_reason(unit, code, reason));
