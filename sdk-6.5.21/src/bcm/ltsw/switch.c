...
/*******************************************************************************
 * Module Internal HSDK functions
 */
/*!
 * \brief Get the switch module initialization status.
 *
 ...
 */
int
bcmint_ltsw_switch_init_status_get(
    int unit,
    bool *inited)
{
    ...
    int mirror_instance_id)
{
    ...
    if (!ltsw_feature(unit, LTSW_FT_EP_RECIRC)) {
 ...
 */
int
bcmi_ltsw_switch_ep_recirc_profile_mirror_instance_get_all(
    int unit,
 ...
 */
int
bcmi_ltsw_switch_ep_recirc_profile_num_get(
    int unit,
    int *num)
{
    SHR_FUNC_ENTER(unit);
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_switch_ep_recirc_profile_num_get(unit, num));
    ...
    int *recirc_profile_id)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_switch_ep_recirc_profile_create(unit,
                                                   recirc_profile,
                                                   recirc_profile_id));
    ...
    int recirc_profile_id)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_switch_ep_recirc_profile_destroy(unit, recirc_profile_id));
    ...
    int *count)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_switch_ep_recirc_profile_get_all(unit,
    ...
    bcm_switch_ep_recirc_profile_t *recirc_profile)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_switch_ep_recirc_profile_get(unit,
                                                recirc_profile_id,
                                                recirc_profile));
    ...
    bcm_switch_ep_recirc_drop_event_control_t *drop_event_ctrl)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_switch_ep_recirc_drop_event_control_set(unit,
                                                           drop_event_ctrl));
    ...
    bcm_switch_ep_recirc_drop_event_control_t *drop_event_ctrl)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_switch_ep_recirc_drop_event_control_get(unit,
                                                           drop_event_ctrl));
...
/*!
 * \brief Get the drop event which has minimal drop code among the given drop
 *        events.
 *
 * \param [in] unit Unit number.
 ...
 */
int
bcm_ltsw_switch_ep_recirc_drop_event_min_get(
    int unit,
    ...
    bcm_pkt_drop_event_t *min_drop_event)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_switch_ep_recirc_drop_event_min_get(unit,
                                                       drop_event_array,
                                                       array_size,
                                                       min_drop_event));
    ...
    bcm_switch_ep_recirc_trace_event_control_t *trace_event_ctrl)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_switch_ep_recirc_trace_event_control_set(unit,
                                                            trace_event_ctrl));
    ...
    bcm_switch_ep_recirc_trace_event_control_t *trace_event_ctrl)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_switch_ep_recirc_trace_event_control_get(unit,
                                                            trace_event_ctrl));
    ...
    int enable)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_switch_ep_recirc_trace_event_enable_set(unit,
                                                           trace_event,
                                                           enable));
    ...
    int *count)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_switch_ep_recirc_trace_event_enable_get_all(unit,
                                                               trace_event_array,
                                                               count));
    ...
    int *enable)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_switch_ep_recirc_trace_event_enable_get(unit,
                                                           trace_event,
                                                           enable));
...
/*!
 * \brief Get the recommended operational value.
 *
 * \param [in] unit Unit number.
 * \param [in] flag Option flag.
 * \param [out] rov The recommended operational value.
 *
 * \retval SHR_E_NONE Success.
 * \retval !SHR_E_NONE Failure.
 */
int
bcm_ltsw_switch_rov_get(int unit, uint32_t flag, uint32_t *rov)
{
    int dunit = bcmi_ltsw_dev_dunit(unit);

    SHR_FUNC_ENTER(unit);

    SHR_NULL_CHECK(rov, SHR_E_PARAM);

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmbd_dev_param_get(dunit, BCMBD_DEV_PRM_AVS_VOLTAGE, rov));
exit:
    SHR_FUNC_EXIT();
}
