/*! \file bcm56880_a0_dna_4_7_11_flexstate.c
 *
 * BCM56880_A0 DNA_4_7_11 FLEXSTATE Driver.
 */
/*
 ...
 */
static bcmint_flexstate_source_info_t bcm56880_a0_dna_4_7_11_ltsw_flexstate_source_db[] = {
    {
    ...
    {
        bcmiFlexstateSourceTxByteState,
        BCMI_LTSW_FLEXSTATE_STAGE_EGR,
        PORTs,
        BCMINT_FLEXSTATE_EGR_TX_BYTE_STATE_TBL_BIT,
    },
    /* Always last one. */
    {
 ...
 */
static bcmint_flexstate_object_info_t bcm56880_a0_dna_4_7_11_ltsw_flexstate_object_db[] = {
    /* CTR_EFLEX_OBJ_SRC_T */
    {
    ...
    /* bcm56880_a0_dna_4_7_11_FLEX_STATE_POST_LKUP_OBJ_BUS_T */
    {
    ...
    /* bcm56880_a0_dna_4_7_11_FLEX_STATE_EGR_OBJ_BUS_T */
    {
...
static int
bcm56880_a0_dna_4_7_11_ltsw_flexstate_source_info_get(
    int unit,
    int source,
    bcmint_flexstate_source_info_t **source_info)
{
    ...
    count = COUNTOF(bcm56880_a0_dna_4_7_11_ltsw_flexstate_source_db);
    source_db = bcm56880_a0_dna_4_7_11_ltsw_flexstate_source_db;

    if ((source < 0 || source >= bcmFlexstateSourceCount) &&
        (source < bcmiFlexstateSourceStart || source >= bcmiFlexstateSourceEnd)) {
...
static int
bcm56880_a0_dna_4_7_11_ltsw_flexstate_object_info_get(
    int unit,
    int object,
    bcmint_flexstate_object_info_t **object_info)
{
    ...
    count = COUNTOF(bcm56880_a0_dna_4_7_11_ltsw_flexstate_object_db);
    object_db = bcm56880_a0_dna_4_7_11_ltsw_flexstate_object_db;
...
/*!
 * \brief Flexstate driver function variable for bcm56880_a0_dna_4_7_11 device.
 */
static mbcm_ltsw_flexstate_drv_t bcm56880_a0_dna_4_7_11_ltsw_flexstate_drv = {
    .flexstate_source_info_get = bcm56880_a0_dna_4_7_11_ltsw_flexstate_source_info_get,
    .flexstate_object_info_get = bcm56880_a0_dna_4_7_11_ltsw_flexstate_object_info_get
};
...
int
bcm56880_a0_dna_4_7_11_ltsw_flexstate_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_flexstate_drv_set(unit, &bcm56880_a0_dna_4_7_11_ltsw_flexstate_drv));
