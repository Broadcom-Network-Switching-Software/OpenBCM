/*! \file bcm56880_a0_dna_4_7_11_field.c
 *
 * BCM56880_A0 DNA_4_7_11 FIELD driver.
 */
/*
...
#include <bcm_int/ltsw/chip/bcm56880_a0/dna_4_7_11/bcm56880_a0_dna_4_7_11_field_lt_map.h>
...
static
bcmint_field_compress_tbls_info_t bcm56880_a0_compress_tbls_info = {
...
static
bcmint_field_tbls_info_t bcm56880_a0_ifp_tbls_info = {
    ...
    .conflict_sid = "DT_IFP_CONFLICT_QUALIFIER_SET",
    .conflict_key_fid = "DT_IFP_CONFLICT_QUALIFIER_SET_ID",
};

static
bcmint_field_color_action_tbls_info_t bcm56880_a0_ifp_color_action_tbls_info = {
    .num_pools = 4,
...
static
bcmint_field_tbls_info_t bcm56880_a0_em_tbls_info = {
    ...
    .presel_entry_prio_fid = "ENTRY_PRIORITY",
    .meter_info_sid = NULL,
    .sw_flowtracker_fid = "FLOWTRACKER",
};

static
bcmint_field_tbls_info_t bcm56880_a0_ft_tbls_info = {
...
static
bcmint_field_tbls_info_t bcm56880_a0_vfp_tbls_info = {
...
static
bcmint_field_tbls_info_t bcm56880_a0_efp_tbls_info = {
...
static
bcmint_field_color_action_tbls_info_t bcm56880_a0_efp_color_action_tbls_info = {
    .num_pools = 1,
 ...
 */
static int
bcm56880_a0_dna_4_7_11_ltsw_field_stage_db_init(int unit,
                                         bcmint_field_stage_info_t *stage_info)
{
    ...
    if (stage_info->stage_id == bcmiFieldStageIngress) {
        ...
        stage_info->tbls_info = &bcm56880_a0_ifp_tbls_info;
        stage_info->color_action_tbls_info = &bcm56880_a0_ifp_color_action_tbls_info;

        /* Initialise qual db counts */
        stage_info->qual_db_count = (sizeof(bcm56880_a0_dna_4_7_11_ifp_qual_data)) /
                                            (sizeof(bcm_field_qual_map_t));
        stage_info->presel_qual_db_count =
                                   (sizeof(bcm56880_a0_dna_4_7_11_ifp_presel_qual_data)) /
                                   (sizeof(bcm_field_qual_map_t));
        stage_info->action_db_count = (sizeof(bcm56880_a0_dna_4_7_11_ifp_action_data)) /
                                            (sizeof(bcm_field_action_map_t));

        /* Initialise lt map db */
        stage_info->qual_lt_map_db = bcm56880_a0_dna_4_7_11_ifp_qual_data;
        stage_info->presel_qual_lt_map_db = bcm56880_a0_dna_4_7_11_ifp_presel_qual_data;
        stage_info->action_lt_map_db = bcm56880_a0_dna_4_7_11_ifp_action_data;
        ...
        /* Initialise lt table info */
        stage_info->tbls_info = &bcm56880_a0_em_tbls_info;
        rv = bcmlt_table_desc_get(unit,
                         bcm56880_a0_em_tbls_info.group_sid, &tbl_desc);
        if (SHR_FAILURE(rv)) {
            SHR_EXIT();
        }
        ...
        stage_info->presel_qual_db_count =
                                   (sizeof(bcm56880_a0_dna_4_7_11_ifp_presel_qual_data)) /
                                   (sizeof(bcm_field_qual_map_t));
        stage_info->action_db_count = (sizeof(bcm56880_a0_dna_4_7_11_em_action_data)) /
                                            (sizeof(bcm_field_action_map_t));
        ...
        /*stage_info->action_lt_map_db = bcm56880_a0_ifp_action_data;*/
        stage_info->action_lt_map_db = bcm56880_a0_dna_4_7_11_em_action_data;
    } else if (stage_info->stage_id == bcmiFieldStageFlowTracker) {
        /* Initialise lt table info */
        stage_info->tbls_info = &bcm56880_a0_ft_tbls_info;
        rv = bcmlt_table_desc_get(unit,
                         bcm56880_a0_ft_tbls_info.group_sid, &tbl_desc);
        if (SHR_FAILURE(rv)) {
            SHR_EXIT();
        }
        ...
        /* Initialise lt table info */
        stage_info->tbls_info = &bcm56880_a0_efp_tbls_info;
        stage_info->color_action_tbls_info = &bcm56880_a0_efp_color_action_tbls_info;

        /* Initialise qual db counts */
        stage_info->qual_db_count = (sizeof(bcm56880_a0_dna_4_7_11_efp_qual_data)) /
                                            (sizeof(bcm_field_qual_map_t));
        stage_info->presel_qual_db_count =
                                   (sizeof(bcm56880_a0_dna_4_7_11_efp_presel_qual_data)) /
                                                 (sizeof(bcm_field_qual_map_t));
        stage_info->action_db_count = (sizeof(bcm56880_a0_dna_4_7_11_efp_action_data)) /
                                            (sizeof(bcm_field_action_map_t));

        /* Initialise lt map db */
        stage_info->qual_lt_map_db = bcm56880_a0_dna_4_7_11_efp_qual_data;

        stage_info->presel_qual_lt_map_db = bcm56880_a0_dna_4_7_11_efp_presel_qual_data;

        stage_info->action_lt_map_db = bcm56880_a0_dna_4_7_11_efp_action_data;

    } else if (stage_info->stage_id == bcmiFieldStageVlan) {
        /* Initialise lt table info */
        stage_info->tbls_info = &bcm56880_a0_vfp_tbls_info;
        rv = bcmlt_table_desc_get(unit,
                         bcm56880_a0_vfp_tbls_info.group_sid, &tbl_desc);
        if (SHR_FAILURE(rv)) {
            SHR_EXIT();
        }

        /* Initialise qual db counts */
        stage_info->qual_db_count = (sizeof(bcm56880_a0_dna_4_7_11_vfp_qual_data)) /
                                            (sizeof(bcm_field_qual_map_t));
        stage_info->presel_qual_db_count =
                                    (sizeof(bcm56880_a0_dna_4_7_11_vfp_presel_qual_data)) /
                                            (sizeof(bcm_field_qual_map_t));
        stage_info->action_db_count = (sizeof(bcm56880_a0_dna_4_7_11_vfp_action_data)) /
                                               (sizeof(bcm_field_action_map_t));

        /* Initialise lt map db */
        stage_info->qual_lt_map_db = bcm56880_a0_dna_4_7_11_vfp_qual_data;

        stage_info->presel_qual_lt_map_db = bcm56880_a0_dna_4_7_11_vfp_presel_qual_data;

        stage_info->action_lt_map_db = bcm56880_a0_dna_4_7_11_vfp_action_data;
    } else {
        /* Do nothing */
    }
...
static int
bcm56880_a0_dna_4_7_11_ltsw_field_control_lt_info_init(
        int unit,
        bcmint_field_control_info_t *control_info)
{
    ...
    control_info->comp_tbls_info = &bcm56880_a0_compress_tbls_info;
...
static int
bcm56880_a0_dna_4_7_11_ltsw_field_manual_enum_to_lt_enum_value_get(
        int unit,
        ...
        bcm_qual_field_t *qual_info)
{
    ...
    if (((qual == bcmFieldQualifyFirstDropReason) ||
    ...
    } else if (((qual == bcmFieldQualifyFirstDropReason) ||
                (qual == bcmFieldQualifyDropReason) ||
                (qual == bcmFieldQualifyRecircleHdrFirstDropReason) ||
                (qual == bcmFieldQualifyRecircleHdrDropReason)) &&
...
static int
bcm56880_a0_dna_4_7_11_ltsw_field_manual_lt_enum_value_to_enum_get(
        int unit,
        bcm_field_entry_t entry,
        bcm_field_qualify_t qual,
        bcm_qual_field_t *qual_info,
...
/*!
 * \brief field driver function variable for bcm56880_a0 DNA_4_7_11 device.
 */
static mbcm_ltsw_field_drv_t bcm56880_a0_dna_4_7_11_ltsw_field_drv = {
    .field_stage_db_init = bcm56880_a0_dna_4_7_11_ltsw_field_stage_db_init,
    .field_control_lt_info_init =
                    bcm56880_a0_dna_4_7_11_ltsw_field_control_lt_info_init,
    .field_auto_enum_to_lt_enum_value_get =
           bcm56880_a0_dna_4_7_11_ltsw_field_auto_enum_to_lt_enum_value_get,
    .field_auto_lt_enum_value_to_enum_get =
            bcm56880_a0_dna_4_7_11_ltsw_field_auto_lt_enum_value_to_enum_get,
...
int
bcm56880_a0_dna_4_7_11_ltsw_field_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_field_drv_set(unit, &bcm56880_a0_dna_4_7_11_ltsw_field_drv));
