/*! \file bcm56880_a0_dna_4_7_11_gene_lib.c
 *
 * Broadcom BCM56880_a0 DNA_4_7_11 Generic Extensible NPL Encapsulation.
 */
/*
...
static bcmgene_field_desc_t bcmgene_flexdigest_lkup_fld[] = {
    ...
    },
    {
        .flags = 0,
        .blk = 1,
        .offset = bcmFlexDigestMatchOuterL3L4HdrIfaMetadata,
        .width = 0,
        .depth = 0,
        .field = INGRESS_PKT_OUTER_L3_L4_HDR_IFA_METADATAs,
        .converter = NULL,
    },
    {
        .flags = 0,
...
static bcmgene_field_desc_t bcmgene_l3_aacl_fld[] = {
    {
        .flags = 0,
        .blk = 0,
        .offset = 0,
...
static bcmgene_field_desc_t bcmgene_l3_aacl_ipv4_key[] = {
    {
        .flags = 0,
        .blk = 0,
        .offset = 0,
...
static bcmgene_field_desc_t bcmgene_l3_aacl_ipv6_key[] = {
    {
        .flags = 0,
        .blk = 0,
        .offset = 0,
...
static bcmgene_table_desc_t bcmgene_l3_aacl[] = {
    {
        .sub_f = BCMGENE_L3_AACL_SUB_F_IPv4_SRC,
        .flags = 0,
        .table = L3_IPV4_COMP_SRCs,
        .idx_min = 0,
        .idx_max = 0,
        .keys = COUNTOF(bcmgene_l3_aacl_ipv4_key),
        .key = bcmgene_l3_aacl_ipv4_key,
        .flds = COUNTOF(bcmgene_l3_aacl_fld),
        .fld = bcmgene_l3_aacl_fld,
    },
    {
        .sub_f = BCMGENE_L3_AACL_SUB_F_IPv4_DST,
        .flags = 0,
        .table = L3_IPV4_COMP_DSTs,
        .idx_min = 0,
        .idx_max = 0,
        .keys = COUNTOF(bcmgene_l3_aacl_ipv4_key),
        .key = bcmgene_l3_aacl_ipv4_key,
    ...
    },
    {
        ...
        .flags = 0,
        .table = L3_IPV6_COMP_SRCs,
        .idx_min = 0,
        .idx_max = 0,
        .keys = COUNTOF(bcmgene_l3_aacl_ipv6_key),
        .key = bcmgene_l3_aacl_ipv6_key,
        .flds = COUNTOF(bcmgene_l3_aacl_fld),
        .fld = bcmgene_l3_aacl_fld,
    },
    {
...
static bcmgene_field_desc_t bcmgene_l3_aacl_validate_ipv4_src_fld[] = {
    {
        .flags = 0,
        .blk = 0,
        .offset = 0,
        .width = 0,
        .depth = 0,
        .field = FP_ING_COMP_SRC_IP4_ONLYs,
        .converter = NULL,
    },
};

static bcmgene_field_desc_t bcmgene_l3_aacl_validate_ipv4_dst_fld[] = {
    {
        .flags = 0,
        .blk = 0,
        .offset = 0,
        .width = 0,
        .depth = 0,
        .field = FP_ING_COMP_DST_IP4_ONLYs,
        .converter = NULL,
    },
};

static bcmgene_field_desc_t bcmgene_l3_aacl_validate_ipv6_src_fld[] = {
    {
        .flags = 0,
        .blk = 0,
        .offset = 0,
        .width = 0,
        .depth = 0,
        .field = FP_ING_COMP_SRC_IP6_ONLYs,
        .converter = NULL,
    },
};

static bcmgene_field_desc_t bcmgene_l3_aacl_validate_ipv6_dst_fld[] = {
    {
        .flags = 0,
        .blk = 0,
        .offset = 0,
        .width = 0,
        .depth = 0,
        .field = FP_ING_COMP_DST_IP6_ONLYs,
        .converter = NULL,
    },
};

static bcmgene_table_desc_t bcmgene_l3_aacl_validate[] = {
    {
        .sub_f = BCMGENE_L3_AACL_SUB_F_IPv4_SRC,
        .flags = 0,
        .table = FP_CONFIGs,
        ...
        .keys = 0,
        .key = NULL,
        .flds = COUNTOF(bcmgene_l3_aacl_validate_ipv4_src_fld),
        .fld = bcmgene_l3_aacl_validate_ipv4_src_fld,
    },
    {
        .sub_f = BCMGENE_L3_AACL_SUB_F_IPv4_DST,
        .flags = 0,
        ...
        .keys = 0,
        .key = NULL,
        .flds = COUNTOF(bcmgene_l3_aacl_validate_ipv4_dst_fld),
        .fld = bcmgene_l3_aacl_validate_ipv4_dst_fld,
    },
    {
        .sub_f = BCMGENE_L3_AACL_SUB_F_IPv6_SRC,
        .flags = 0,
        ...
        .keys = 0,
        .key = NULL,
        .flds = COUNTOF(bcmgene_l3_aacl_validate_ipv6_src_fld),
        .fld = bcmgene_l3_aacl_validate_ipv6_src_fld,
    },
    {
        .sub_f = BCMGENE_L3_AACL_SUB_F_IPv6_DST,
        .flags = 0,
        ...
        .keys = 0,
        .key = NULL,
        .flds = COUNTOF(bcmgene_l3_aacl_validate_ipv6_dst_fld),
        .fld = bcmgene_l3_aacl_validate_ipv6_dst_fld,
    },
};

static bcmgene_func_desc_t bcmgene_func_l3_aacl[] = {
    {
        .func = BCMGENE_L3_AACL_F_COMPRESSION,
        .tbls = COUNTOF(bcmgene_l3_aacl),
        .tbl = bcmgene_l3_aacl,
    },
    {
        .func = BCMGENE_L3_AACL_F_COMPRESSION_VALIDATE,
        .tbls = COUNTOF(bcmgene_l3_aacl_validate),
        .tbl = bcmgene_l3_aacl_validate,
    },
};
...
static bcmgene_desc_t bcmgene[] = {
    ...
    {
        .name = "AACL",
        .feature = LTSW_FT_L3_AACL,
        .funcs = COUNTOF(bcmgene_func_l3_aacl),
        .func = bcmgene_func_l3_aacl,
    },
};

static bcmgene_db_t bcmgene_db = {
    .ver = "BCM56880_A0_DNA_4_7_11",
...
bcmgene_db_t *
bcm56880_a0_dna_4_7_11_gene_db_get(void)
{
    return &bcmgene_db;
}
