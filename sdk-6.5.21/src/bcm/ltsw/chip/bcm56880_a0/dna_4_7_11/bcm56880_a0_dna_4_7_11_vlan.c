/*! \file bcm56880_a0_dna_4_7_11_vlan.c
 *
 * BCM56880_A0 DNA_4_7_11 VLAN driver.
 */
/*
...
/*!
 * \brief The offset of bitmap field for TAG_ACTION.
 */
#define TAG_ACTION_BMP_OFFSET_OTAG        0
#define TAG_ACTION_BMP_OFFSET_ITAG        1
#define TAG_ACTION_BMP_OFFSET_ODOT1P      2
#define TAG_ACTION_BMP_OFFSET_OTAG_STATUS 3
...
/*!
 * \brief Set bitmap field of tag_action
 *
 * \param [in] unit Unit Number.
 * \param [in] val  Field Value
 * \param [out]bmp  LT Bitmap value
 */
static int
tag_action_bmp_set(int unit, uint64_t val, uint64_t *bmp)
{
    uint64_t supported_val;

    SHR_FUNC_ENTER(unit);

    SHR_NULL_CHECK(bmp, SHR_E_PARAM);

    supported_val = BCMINT_VLAN_TAG_ACTION_OTAG_ADD |
                    BCMINT_VLAN_TAG_ACTION_ITAG_ADD |
                    BCMINT_VLAN_TAG_ACTION_ODOT1P_PRESERVE |
                    BCMINT_VLAN_TAG_ACTION_OTAG_STATUS_PRESERVE;
    if (val & ~supported_val) {
        SHR_ERR_EXIT(SHR_E_PARAM);
    }

    if (val & BCMINT_VLAN_TAG_ACTION_OTAG_ADD) {
        *bmp |= (1ULL << TAG_ACTION_BMP_OFFSET_OTAG);
    }

    if (val & BCMINT_VLAN_TAG_ACTION_ITAG_ADD) {
        *bmp |= (1ULL << TAG_ACTION_BMP_OFFSET_ITAG);
    }

    if (val & BCMINT_VLAN_TAG_ACTION_ODOT1P_PRESERVE) {
        *bmp |= (1ULL << TAG_ACTION_BMP_OFFSET_ODOT1P);
    }

    if (val & BCMINT_VLAN_TAG_ACTION_OTAG_STATUS_PRESERVE) {
        *bmp |= (1ULL << TAG_ACTION_BMP_OFFSET_OTAG_STATUS);
    }
...
/*!
 * \brief Get bitmap field of tag_action
 *
 * \param [in] unit Unit Number.
 * \param [in] bmp  LT Bitmap value
 * \param [out]val  Field Value
 */
static int
tag_action_bmp_get(int unit, uint64_t bmp, uint64_t *val)
{
    ...
    if (bmp & (1ULL << TAG_ACTION_BMP_OFFSET_OTAG)) {
        *val |= BCMINT_VLAN_TAG_ACTION_OTAG_ADD;
    }

    if (bmp & (1ULL << TAG_ACTION_BMP_OFFSET_ITAG)) {
        *val |= BCMINT_VLAN_TAG_ACTION_ITAG_ADD;
    }

    if (bmp & (1ULL << TAG_ACTION_BMP_OFFSET_ODOT1P)) {
        *val |= BCMINT_VLAN_TAG_ACTION_ODOT1P_PRESERVE;
    }

    if (bmp & (1ULL << TAG_ACTION_BMP_OFFSET_OTAG_STATUS)) {
        *val |= BCMINT_VLAN_TAG_ACTION_OTAG_STATUS_PRESERVE;
    }
...
ing_xlate_entry_flds[BCMINT_LTSW_VLAN_FLD_ING_XLATE_FLD_CNT] = {
    ...
    [BCMINT_LTSW_VLAN_FLD_ING_XLATE_FLEX_CTR_ACTION] = {
        FLEX_CTR_ACTIONs,
        NULL,
        NULL
    },
    [BCMINT_LTSW_VLAN_FLD_ING_XLATE_OPQ_OBJ_0] = {
        OPAQUE_OBJ0s,
        NULL,
        NULL
    }
...
egr_xlate_entry_flds[BCMINT_LTSW_VLAN_FLD_EGR_XLATE_FLD_CNT] = {
    ...
    [BCMINT_LTSW_VLAN_FLD_EGR_XLATE_FLEX_CTR_ACTION] = {
        FLEX_CTR_ACTIONs,
        NULL,
        NULL
    },
    [BCMINT_LTSW_VLAN_FLD_EGR_XLATE_FLEX_CTR_INDEX] = {
        FLEX_CTR_INDEXs,
        NULL,
        NULL
    }
...
ing_vfi_entry_flds[BCMINT_LTSW_VLAN_FLD_ING_VFI_FLD_CNT] = {
    ...
    [BCMINT_LTSW_VLAN_FLD_ING_VFI_DESTINATION_TYPE] = {
        DESTINATION_TYPEs,
        (void *)dest_type_symbol_to_scalar,
        (void *)dest_type_scalar_to_symbol
    },
    ...
    [BCMINT_LTSW_VLAN_FLD_ING_VFI_SRC_PVLAN_PORT_TYPE] = {
        ...
        (void *)pvlan_port_type_symbol_to_scalar,
        (void *)pvlan_port_type_scalar_to_symbol
    },
    ...
    [BCMINT_LTSW_VLAN_FLD_ING_VFI_L2MC_MISS_ACTION] = {
        L2MC_MISS_ACTIONs,
        (void *)l2_miss_action_symbol_to_scalar,
        (void *)l2_miss_action_scalar_to_symbol
    },
...
egr_vfi_entry_flds[BCMINT_LTSW_VLAN_FLD_EGR_VFI_FLD_CNT] = {
    ...
    [BCMINT_LTSW_VLAN_FLD_EGR_VFI_TAG_ACTION] = {
        TAG_ACTIONs,
        (void *)tag_action_bmp_get,
        (void *)tag_action_bmp_set
    },
    ...
    [BCMINT_LTSW_VLAN_FLD_EGR_VFI_VIEW_T] = {
        VIEW_Ts,
        (void *)egr_vfi_view_symbol_to_scalar,
        (void *)egr_vfi_view_scalar_to_symbol
    },
...
bcm56880_a0_dna_4_7_11_vlan_lt[] = {
    ...
    [BCMINT_LTSW_VLAN_EGR_VLAN_TRANSLATION_DW_PIPE_CONFIG] = {
        .name = EGR_VLAN_TRANSLATION_DW_PIPE_CONFIGs,
        .fld_bmp =
            (1 << BCMINT_LTSW_VLAN_FLD_VLAN_XLATE_TABLE_PIPE_CONFIG_PIPEUNIQUE),
        .flds = vlan_xlate_pipe_config_flds
    }
...
static int
bcm56880_a0_dna_4_7_11_vlan_lt_db_get(int unit,
                                     bcmint_vlan_lt_db_t *lt_db)
{
    ...
    lt_db->lt_bmp = (1 << BCMINT_LTSW_VLAN_ING_VLAN_XLATE_1_TABLE)  |
                    ...
                    (1 << BCMINT_LTSW_VLAN_EGR_VLAN_TRANSLATION_DW) |
                    ...
                    (1 << BCMINT_LTSW_VLAN_EGR_VLAN_TRANSLATION_DW_PIPE_CONFIG);
    lt_db->lts = bcm56880_a0_dna_4_7_11_vlan_lt;
...
int
bcm56880_a0_dna_4_7_11_vlan_xlate_table_share(int unit,
                                             ...
                                             int *share)
{
    ...
    *share = 0;
    ...
    /* Below tables share same pt resources. */
    switch (lt_id) {
...
static mbcm_ltsw_vlan_drv_t bcm56880_a0_dna_4_7_11_ltsw_vlan_drv = {
    /* VLAN LT database */
    .vlan_lt_db_get = bcm56880_a0_dna_4_7_11_vlan_lt_db_get,

    /* VLAN xlate table share same pt resource. */
    .vlan_xlate_table_share = bcm56880_a0_dna_4_7_11_vlan_xlate_table_share
};
 ...
 */
int
bcm56880_a0_dna_4_7_11_ltsw_vlan_drv_attach(int unit)
{
    return mbcm_ltsw_vlan_drv_set(unit,
                                  &bcm56880_a0_dna_4_7_11_ltsw_vlan_drv);
}
