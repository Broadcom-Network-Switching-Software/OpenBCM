...
static int
bcm56880_a0_ltsw_cosq_init(int unit)
{
    static tm_ltsw_cosq_chip_driver_t bcm56880_a0_cosq_drv_cb = {
    ...
    SHR_IF_ERR_EXIT
        (tm_ltsw_cosq_chip_driver_register(unit, &bcm56880_a0_cosq_drv_cb));
...
static int
bcm56880_a0_ltsw_cosq_detach(int unit)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56880_a0_ltsw_cosq_gport_port_resolve(
    int unit,
    bcm_gport_t gport,
    bcm_gport_t *port,
    int *id)
...
static int
bcm56880_a0_ltsw_cosq_port_itm_validate(
    int unit,
    int port,
    int *itm)
{
...
static int
bcm56880_a0_ltsw_cosq_sw_dump(int unit)
{
    int ii;
...
static int
bcm56880_a0_ltsw_cosq_bucket_set(
    int unit,
    bcm_gport_t gport,
...
static int
bcm56880_a0_ltsw_cosq_bucket_get(
    int unit,
    bcm_gport_t gport,
    bcm_cos_queue_t cosq,
    uint32_t *min_quantum,
...
static int
bcm56880_a0_ltsw_cosq_port_detach(
    int unit,
    bcm_port_t port)
{
    cosq_port_info_t *port_info;
...
static int
bcm56880_a0_ltsw_cosq_port_attach(
    int unit,
    bcm_port_t port)
{
    cosq_port_info_t *port_info;
...
static int
bcm56880_a0_ltsw_cosq_mc_cos_mirror_set(
    int unit,
    int enable)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56880_a0_ltsw_cosq_mc_cos_mirror_get(
    int unit,
    int *enable)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56880_a0_ltsw_cosq_sched_node_child_get(
    int unit,
...
static int
bcm56880_a0_ltsw_cosq_gport_get(
    int unit,
    bcm_gport_t gport,
    bcm_gport_t *port,
    int *numq,
...
static int
bcm56880_a0_ltsw_cosq_gport_child_get(
    int unit,
...
static int
bcm56880_a0_ltsw_cosq_gport_attach(
    int unit,
...
static int
bcm56880_a0_ltsw_cosq_gport_detach(
    int unit,
    bcm_gport_t input_gport,
    bcm_gport_t parent_gport,
    bcm_cos_queue_t cosq)
...
static int
bcm56880_a0_ltsw_cosq_gport_attach_get(
    int unit,
    bcm_gport_t sched_gport,
    bcm_gport_t *input_gport,
    bcm_cos_queue_t *cosq)
...
static int
bcm56880_a0_ltsw_cosq_gport_traverse(
    int unit,
...
static int
bcm56880_a0_ltsw_cosq_sched_weight_max_get(
    int unit,
    int mode,
    int *weight_max)
{
...
static int
bcm56880_a0_ltsw_cosq_schedq_mapping_set(
    int unit,
    int profile_index,
    int size,
...
static int
bcm56880_a0_ltsw_cosq_schedq_mapping_get(
    int unit,
    int profile_index,
    int array_max,
    bcm_cosq_mapping_t *cosq_mapping_arr,
...
static int
bcm56880_a0_ltsw_cosq_port_scheduler_profile_set(
    int unit,
    bcm_port_t port,
    int profile_id)
{
...
static int
bcm56880_a0_ltsw_cosq_port_scheduler_profile_get(
    int unit,
    bcm_port_t port,
    int *profile_id)
{
...
static int
bcm56880_a0_ltsw_cosq_sched_set(
    int unit,
    bcm_port_t gport,
    bcm_cos_queue_t cosq,
    int mode,
...
static int
bcm56880_a0_ltsw_cosq_sched_get(
    int unit,
    bcm_port_t gport,
    bcm_cos_queue_t cosq,
    int *mode,
...
static int
bcm56880_a0_ltsw_cosq_cosq_profile_max_num_get(
    int unit,
...
static int
bcm56880_a0_ltsw_cosq_port_sched_config_set(
    int unit,
    bcm_pbmp_t pbm,
    int mode,
    int weight_arr_size,
...
static int
bcm56880_a0_ltsw_cosq_port_sched_config_get(
    int unit,
    bcm_pbmp_t pbm,
    int weight_arr_size,
    int *weights,
...
static int
bcm56880_a0_ltsw_cosq_discard_set(
    int unit,
    uint32_t flags)
{
    bcm_pbmp_t pbmp;
...
static int
bcm56880_a0_ltsw_cosq_discard_get(
    int unit,
    uint32_t *flags)
{
    bcm_pbmp_t pbmp;
...
static int
bcm56880_a0_ltsw_cosq_gport_discard_set(
    int unit,
    bcm_gport_t gport,
    bcm_cos_queue_t cosq,
...
static int
bcm56880_a0_ltsw_cosq_gport_discard_get(
    int unit,
    bcm_gport_t gport,
    bcm_cos_queue_t cosq,
    bcm_cosq_gport_discard_t *discard)
...
static int
bcm56880_a0_ltsw_cosq_discard_profile_create(
    int unit,
    int *profile_id)
{
    int i;
...
static int
bcm56880_a0_ltsw_cosq_discard_profile_destroy(
    int unit,
    int profile_id)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56880_a0_ltsw_cosq_discard_profile_update(
    int unit,
    int profile_id,
...
static int
bcm56880_a0_ltsw_cosq_discard_profile_get(
    int unit,
    int profile_id,
    int max,
...
static int
bcm56880_a0_ltsw_cosq_cos_mapping_set(
    int unit,
    bcm_port_t local_port,
    bcm_cos_t priority,
    uint32_t flags,
...
static int
bcm56880_a0_ltsw_cosq_cos_mapping_get(
    int unit,
    bcm_port_t local_port,
    bcm_cos_t priority,
    uint32_t flags,
...
static int
bcm56880_a0_ltsw_cosq_shaper_config_get(
    int unit,
    int *refresh_time,
    int *itu_mode,
    int *shaper)
...
static int
bcm56880_a0_ltsw_cosq_field_classifier_id_create(
    int unit,
    int *classifier_id)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56880_a0_ltsw_cosq_field_classifier_id_destroy(
    int unit,
    int classifier_id)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56880_a0_ltsw_cosq_field_classifier_map_set(
    int unit,
    int classifier_id,
    int count,
    bcm_cos_t *priority_array,
...
static int
bcm56880_a0_ltsw_cosq_field_classifier_map_get(
    int unit,
    int classifier_id,
    int array_max,
    bcm_cos_t *priority_array,
...
static int
bcm56880_a0_ltsw_cosq_field_classifier_map_clear(
    int unit,
    int classifier_id)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56880_a0_ltsw_cosq_field_hi_classifier_id_create(
    int unit,
    int *classifier_id)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56880_a0_ltsw_cosq_field_hi_classifier_id_destroy(
    int unit,
    int classifier_id)
{
    return SHR_E_NONE;
...
static int
bcm56880_a0_ltsw_cosq_field_hi_classifier_map_set(
    int unit,
    int classifier_id,
    int count,
    bcm_cos_t *priority_array,
...
static int
bcm56880_a0_ltsw_cosq_field_hi_classifier_map_get(
    int unit,
    int classifier_id,
    int array_max,
    bcm_cos_t *priority_array,
...
static int
bcm56880_a0_ltsw_cosq_field_hi_classifier_map_clear(
    int unit,
    int classifier_id)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56880_a0_ltsw_cosq_num_queue_get(
    int unit,
    int *num_ucq,
    int *num_mcq)
{
    ...
    if (COSQ_INIT(unit)) {
        ...
        rv = cosq_device_info_init(unit, &info);
        if (SHR_FAILURE(rv)) {
            return rv;
        }
        if (num_ucq != NULL) {
...
static int
bcm56880_a0_ltsw_cosq_port_map_info_get(
    int unit,
    bcm_port_t port,
...
static int
bcm56880_a0_ltsw_cosq_device_info_get(
    int unit,
    bcmi_ltsw_cosq_device_info_t *info)
{
    if (COSQ_INIT(unit)) {
        ...
        return cosq_device_info_init(unit, info);
    }
...
static int
bcm56880_a0_ltsw_cosq_port_ct_mode_set(
    int unit,
    bcm_port_t port,
    int enable)
{
...
static int
bcm56880_a0_ltsw_cosq_port_ct_mode_get(
    int unit,
    bcm_port_t port,
    int *enable)
{
...
static int
bcm56880_a0_ltsw_cosq_port_asf_config_dump(
    int unit,
    bcm_port_t port,
    int port_speed)
{
...
static int
bcm56880_a0_ltsw_cosq_port_asf_config_show(
    int unit,
    bcm_port_t port,
    int port_speed)
{
...
static int
bcm56880_a0_ltsw_cosq_rx_queue_channel_get(
    int unit,
...
static int
bcm56880_a0_ltsw_cosq_rx_queue_channel_set(
    int unit,
    bcm_cos_queue_t queue_id,
    bcm_rx_chan_t chan_id,
    bool enable)
...
static int
bcm56880_a0_ltsw_cosq_rx_queue_channel_set_test(
    int unit,
    bcm_cos_queue_t queue_id,
    bcm_rx_chan_t chan_id)
{
...
static int
bcm56880_a0_ltsw_cosq_gport_traverse_by_port(
    int unit,
    bcm_gport_t port,
    bcm_cosq_gport_traverse_cb cb,
    void *user_data)
...
/*!
 * \brief Cosq driver function variable for bcm56880_a0 device.
 */
static mbcm_ltsw_cosq_drv_t bcm56880_a0_ltsw_cosq_drv = {
    .cosq_init = bcm56880_a0_ltsw_cosq_init,
    .cosq_detach = bcm56880_a0_ltsw_cosq_detach,
    .cosq_gport_port_resolve = bcm56880_a0_ltsw_cosq_gport_port_resolve,
    .cosq_port_itm_validate = bcm56880_a0_ltsw_cosq_port_itm_validate,
    .cosq_sw_dump = bcm56880_a0_ltsw_cosq_sw_dump,
    .cosq_bucket_set = bcm56880_a0_ltsw_cosq_bucket_set,
    .cosq_bucket_get = bcm56880_a0_ltsw_cosq_bucket_get,
    .cosq_port_detach = bcm56880_a0_ltsw_cosq_port_detach,
    .cosq_port_attach = bcm56880_a0_ltsw_cosq_port_attach,
    .cosq_mc_cos_mirror_set = bcm56880_a0_ltsw_cosq_mc_cos_mirror_set,
    .cosq_mc_cos_mirror_get = bcm56880_a0_ltsw_cosq_mc_cos_mirror_get,
    .cosq_sched_node_child_get = bcm56880_a0_ltsw_cosq_sched_node_child_get,
    .cosq_gport_get = bcm56880_a0_ltsw_cosq_gport_get,
    .cosq_gport_child_get = bcm56880_a0_ltsw_cosq_gport_child_get,
    .cosq_gport_attach = bcm56880_a0_ltsw_cosq_gport_attach,
    .cosq_gport_detach = bcm56880_a0_ltsw_cosq_gport_detach,
    .cosq_gport_attach_get = bcm56880_a0_ltsw_cosq_gport_attach_get,
    .cosq_gport_traverse = bcm56880_a0_ltsw_cosq_gport_traverse,
    .cosq_sched_weight_max_get = bcm56880_a0_ltsw_cosq_sched_weight_max_get,
    .cosq_schedq_mapping_set = bcm56880_a0_ltsw_cosq_schedq_mapping_set,
    .cosq_schedq_mapping_get = bcm56880_a0_ltsw_cosq_schedq_mapping_get,
    .cosq_port_scheduler_profile_set = bcm56880_a0_ltsw_cosq_port_scheduler_profile_set,
    .cosq_port_scheduler_profile_get = bcm56880_a0_ltsw_cosq_port_scheduler_profile_get,
    .cosq_sched_set = bcm56880_a0_ltsw_cosq_sched_set,
    .cosq_sched_get = bcm56880_a0_ltsw_cosq_sched_get,
    .cosq_cosq_profile_max_num_get = bcm56880_a0_ltsw_cosq_cosq_profile_max_num_get,
    .cosq_port_sched_config_set = bcm56880_a0_ltsw_cosq_port_sched_config_set,
    .cosq_port_sched_config_get = bcm56880_a0_ltsw_cosq_port_sched_config_get,
    .cosq_discard_set = bcm56880_a0_ltsw_cosq_discard_set,
    .cosq_discard_get = bcm56880_a0_ltsw_cosq_discard_get,
    .cosq_gport_discard_set = bcm56880_a0_ltsw_cosq_gport_discard_set,
    .cosq_gport_discard_get = bcm56880_a0_ltsw_cosq_gport_discard_get,
    .cosq_discard_profile_create = bcm56880_a0_ltsw_cosq_discard_profile_create,
    .cosq_discard_profile_destroy = bcm56880_a0_ltsw_cosq_discard_profile_destroy,
    .cosq_discard_profile_update = bcm56880_a0_ltsw_cosq_discard_profile_update,
    .cosq_discard_profile_get = bcm56880_a0_ltsw_cosq_discard_profile_get,
    .cosq_cos_mapping_set = bcm56880_a0_ltsw_cosq_cos_mapping_set,
    .cosq_cos_mapping_get = bcm56880_a0_ltsw_cosq_cos_mapping_get,
    .cosq_shaper_config_get = bcm56880_a0_ltsw_cosq_shaper_config_get,
    .cosq_field_classifier_id_create = bcm56880_a0_ltsw_cosq_field_classifier_id_create,
    .cosq_field_classifier_id_destroy = bcm56880_a0_ltsw_cosq_field_classifier_id_destroy,
    .cosq_field_classifier_map_set = bcm56880_a0_ltsw_cosq_field_classifier_map_set,
    .cosq_field_classifier_map_get = bcm56880_a0_ltsw_cosq_field_classifier_map_get,
    .cosq_field_classifier_map_clear = bcm56880_a0_ltsw_cosq_field_classifier_map_clear,
    .cosq_field_hi_classifier_id_create = bcm56880_a0_ltsw_cosq_field_hi_classifier_id_create,
    .cosq_field_hi_classifier_id_destroy = bcm56880_a0_ltsw_cosq_field_hi_classifier_id_destroy,
    .cosq_field_hi_classifier_map_set = bcm56880_a0_ltsw_cosq_field_hi_classifier_map_set,
    .cosq_field_hi_classifier_map_get = bcm56880_a0_ltsw_cosq_field_hi_classifier_map_get,
    .cosq_field_hi_classifier_map_clear = bcm56880_a0_ltsw_cosq_field_hi_classifier_map_clear,
    .cosq_num_queue_get = bcm56880_a0_ltsw_cosq_num_queue_get,
    .cosq_port_map_info_get = bcm56880_a0_ltsw_cosq_port_map_info_get,
    .cosq_device_info_get = bcm56880_a0_ltsw_cosq_device_info_get,
    .cosq_port_ct_mode_set = bcm56880_a0_ltsw_cosq_port_ct_mode_set,
    .cosq_port_ct_mode_get = bcm56880_a0_ltsw_cosq_port_ct_mode_get,
    .cosq_port_asf_config_dump = bcm56880_a0_ltsw_cosq_port_asf_config_dump,
    .cosq_port_asf_config_show = bcm56880_a0_ltsw_cosq_port_asf_config_show,
    .cosq_rx_queue_channel_get = bcm56880_a0_ltsw_cosq_rx_queue_channel_get,
    .cosq_rx_queue_channel_set = bcm56880_a0_ltsw_cosq_rx_queue_channel_set,
    .cosq_rx_queue_channel_set_test = bcm56880_a0_ltsw_cosq_rx_queue_channel_set_test,
    .cosq_gport_traverse_by_port = bcm56880_a0_ltsw_cosq_gport_traverse_by_port
};
...
int
bcm56880_a0_ltsw_cosq_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_cosq_drv_set(unit, &bcm56880_a0_ltsw_cosq_drv));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_ltsw_variant_drv_attach(unit, BCM56880_A0_LTSW_VARIANT_COSQ));
