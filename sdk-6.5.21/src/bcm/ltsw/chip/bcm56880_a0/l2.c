    ...
    void *info)
{
    ...
    flexctr_info = (bcmint_l2_flexctr_info_t *)info;
    ...
    counter_id = flexctr_info->dst_grp_id;
    if (counter_id != BCMI_LTSW_FLEXCTR_ACTION_INVALID) {
        ...
        flexctr_info->dst_grp_id = BCMI_LTSW_FLEXCTR_ACTION_INVALID;
    }

    counter_id = flexctr_info->src_grp_id;
    if (counter_id != BCMI_LTSW_FLEXCTR_ACTION_INVALID) {
        (void)bcm_ltsw_flexctr_group_action_destroy(unit, counter_id);
        flexctr_info->src_grp_id = BCMI_LTSW_FLEXCTR_ACTION_INVALID;
    }
    ...
    if (counter_id != BCMI_LTSW_FLEXCTR_ACTION_INVALID) {
        ...
        flexctr_info->uft_dst_id = BCMI_LTSW_FLEXCTR_ACTION_INVALID;
    }

    counter_id = flexctr_info->uft_src_id;
    if (counter_id != BCMI_LTSW_FLEXCTR_ACTION_INVALID) {
        (void)bcm_ltsw_flexctr_action_destroy(unit, counter_id);
        flexctr_info->uft_src_id = BCMI_LTSW_FLEXCTR_ACTION_INVALID;
    }
...
static int
bcm56880_a0_ltsw_l2_ctrl_info_init(
    int unit,
    bcmint_l2_ctrl_info_t *l2_ctrl)
{
     ...
     */
    l2_ctrl->misc_ctrl_0_ecmp_member_is_valid = false;
...
static mbcm_ltsw_l2_drv_t bcm56880_a0_ltsw_l2_drv = {
    ...
    .l2_ctrl_info_init = bcm56880_a0_ltsw_l2_ctrl_info_init
};
