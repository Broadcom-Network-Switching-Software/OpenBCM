...
static int
bcm56880_a0_ltsw_cosq_thd_init(int unit)
{
    int idx;
    uint32_t ha_alloc_size, ha_req_size;
    int warm = bcmi_warmboot_get(unit);

    static tm_ltsw_cosq_thd_chip_driver_t bcm56880_a0_cosq_thd_drv_cb = {
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (tm_ltsw_cosq_thd_chip_driver_register(unit, &bcm56880_a0_cosq_thd_drv_cb));
...
static int
bcm56880_a0_ltsw_cosq_thd_detach(int unit)
{
    return SHR_E_NONE;
}

static int
bcm56880_a0_ltsw_cosq_thd_dynamic_get(
    int unit,
...
static int
bcm56880_a0_ltsw_cosq_thd_port_guarantee_reset(
    int unit,
    bcm_port_t port)
{
    int idx, numq;
...
static int
bcm56880_a0_ltsw_cosq_thd_control_set(
    int unit,
    bcm_gport_t gport,
    bcm_cos_queue_t cosq,
...
static int
bcm56880_a0_ltsw_cosq_thd_control_get(
    int unit,
    bcm_gport_t gport,
    bcm_cos_queue_t cosq,
    bcm_cosq_buffer_id_t buffer,
...
static int
bcm56880_a0_ltsw_cosq_thd_port_uc_spid_get(
    int unit,
    bcm_port_t port,
    int queue,
    int *spid,
...
static int
bcm56880_a0_ltsw_cosq_thd_shared_limit_get(
    int unit,
    int itm,
    int spid,
    int *shared_limit)
...
static int
bcm56880_a0_ltsw_cosq_thd_port_inppri_profile_set(
    int unit,
    bcm_port_t port,
    int profile_id)
{
...
static int
bcm56880_a0_ltsw_cosq_thd_port_inppri_profile_get(
    int unit,
    bcm_port_t port,
    int *profile_id)
{
...
static int
bcm56880_a0_ltsw_cosq_thd_port_pg_profile_set(
    int unit,
    bcm_port_t port,
    int profile_id)
{
...
static int
bcm56880_a0_ltsw_cosq_thd_port_pg_profile_get(
    int unit,
    bcm_port_t port,
    int *profile_id)
{
...
static int
bcm56880_a0_ltsw_cosq_thd_service_pool_set(
    int unit,
...
static int
bcm56880_a0_ltsw_cosq_thd_service_pool_get(
    int unit,
    bcm_service_pool_id_t id,
    bcm_cosq_service_pool_t *cosq_service_pool)
{
...
static int
bcm56880_a0_ltsw_cosq_thd_service_pool_override_set(
    int unit,
...
static int
bcm56880_a0_ltsw_cosq_thd_service_pool_override_get(
    int unit,
    bcm_cosq_service_pool_override_type_t type,
    bcm_service_pool_id_t *service_pool,
    int *enable)
...
static int
bcm56880_a0_ltsw_cosq_thd_priority_group_mapping_profile_set(
    int unit,
    int profile_index,
...
static int
bcm56880_a0_ltsw_cosq_thd_priority_group_mapping_profile_get(
    int unit,
    int profile_index,
    bcm_cosq_priority_group_mapping_profile_type_t type,
    int array_max,
...
static int
bcm56880_a0_ltsw_cosq_thd_port_priority_group_property_set(
    int unit,
    bcm_port_t port,
...
static int
bcm56880_a0_ltsw_cosq_thd_port_priority_group_property_get(
    int unit,
    bcm_port_t port,
    int priority_group_id,
    bcm_cosq_port_prigroup_control_t type,
...
static int
bcm56880_a0_ltsw_cosq_thd_buffer_id_multi_get(
    int unit,
    bcm_gport_t gport,
    bcm_cos_queue_t cosq,
...
static int
bcm56880_a0_ltsw_cosq_thd_cpu_cosq_enable_set(
    int unit,
    bcm_cos_queue_t cosq,
    int enable)
{
...
static int
bcm56880_a0_ltsw_cosq_thd_cpu_cosq_enable_get(
    int unit,
    bcm_cos_queue_t cosq,
    int *enable)
{
...
static int
bcm56880_a0_ltsw_cosq_thd_byte_to_cell(
    int unit,
    uint32_t bytes,
    int *cells)
{
...
static int
bcm56880_a0_ltsw_cosq_thd_cell_to_byte(
    int unit,
    uint32_t cells,
    int *bytes)
{
...
/*!
 * \brief Cosq_thd driver function variable for bcm56880_a0 device.
 */
static mbcm_ltsw_cosq_thd_drv_t bcm56880_a0_ltsw_cosq_thd_drv = {
    .cosq_thd_init = bcm56880_a0_ltsw_cosq_thd_init,
    .cosq_thd_detach = bcm56880_a0_ltsw_cosq_thd_detach,
    .cosq_thd_dynamic_get = bcm56880_a0_ltsw_cosq_thd_dynamic_get,
    .cosq_thd_port_guarantee_reset = bcm56880_a0_ltsw_cosq_thd_port_guarantee_reset,
    .cosq_thd_control_set = bcm56880_a0_ltsw_cosq_thd_control_set,
    .cosq_thd_control_get = bcm56880_a0_ltsw_cosq_thd_control_get,
    .cosq_thd_port_uc_spid_get = bcm56880_a0_ltsw_cosq_thd_port_uc_spid_get,
    .cosq_thd_shared_limit_get = bcm56880_a0_ltsw_cosq_thd_shared_limit_get,
    .cosq_thd_port_inppri_profile_set = bcm56880_a0_ltsw_cosq_thd_port_inppri_profile_set,
    .cosq_thd_port_inppri_profile_get = bcm56880_a0_ltsw_cosq_thd_port_inppri_profile_get,
    .cosq_thd_port_pg_profile_set = bcm56880_a0_ltsw_cosq_thd_port_pg_profile_set,
    .cosq_thd_port_pg_profile_get = bcm56880_a0_ltsw_cosq_thd_port_pg_profile_get,
    .cosq_thd_service_pool_set = bcm56880_a0_ltsw_cosq_thd_service_pool_set,
    .cosq_thd_service_pool_get = bcm56880_a0_ltsw_cosq_thd_service_pool_get,
    .cosq_thd_service_pool_override_set = bcm56880_a0_ltsw_cosq_thd_service_pool_override_set,
    .cosq_thd_service_pool_override_get = bcm56880_a0_ltsw_cosq_thd_service_pool_override_get,
    .cosq_thd_priority_group_mapping_profile_set = bcm56880_a0_ltsw_cosq_thd_priority_group_mapping_profile_set,
    .cosq_thd_priority_group_mapping_profile_get = bcm56880_a0_ltsw_cosq_thd_priority_group_mapping_profile_get,
    .cosq_thd_port_priority_group_property_set = bcm56880_a0_ltsw_cosq_thd_port_priority_group_property_set,
    .cosq_thd_port_priority_group_property_get = bcm56880_a0_ltsw_cosq_thd_port_priority_group_property_get,
    .cosq_thd_buffer_id_multi_get = bcm56880_a0_ltsw_cosq_thd_buffer_id_multi_get,
    .cosq_thd_cpu_cosq_enable_set = bcm56880_a0_ltsw_cosq_thd_cpu_cosq_enable_set,
    .cosq_thd_cpu_cosq_enable_get = bcm56880_a0_ltsw_cosq_thd_cpu_cosq_enable_get,
    .cosq_thd_byte_to_cell = bcm56880_a0_ltsw_cosq_thd_byte_to_cell,
    .cosq_thd_cell_to_byte = bcm56880_a0_ltsw_cosq_thd_cell_to_byte,
};
...
int
bcm56880_a0_ltsw_cosq_thd_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_cosq_thd_drv_set(unit, &bcm56880_a0_ltsw_cosq_thd_drv));
