    ...
    uint32_t *max_flows_per_pipe)
{
    ...
    /*
     * NOTE: HW learning currently is with EAPP. So double wide entries
     * are used when calculating the max scale.
     * There are 32K single wide entries per IFTA80_E2T tile.
     */
    *max_flows_per_pipe = (num_base_entries_count * 2);
    ...
    uint32_t *group_action_hw_idx)
{
    ...
    group_action.source = bcmFlexctrSourceExactMatchFlowtracker;
...
static int
bcm56880_a0_ltsw_flowtracker_num_em_groups_get(
    int unit,
...
static int
bcm56880_a0_ltsw_flowtracker_base_entry_info_get(
    int unit,
...
static int
bcm56880_a0_ltsw_flowtracker_ft_learn_fail_count_supported(
    int unit,
    bool *is_supported)
{
    *is_supported = false;
...
static int
bcm56880_a0_ltsw_flowtracker_flex_ctr_pkt_byte_reserve_wo_eapp(
    int unit,
    int max_flows,
    uint32_t *flex_ctr_stat_id,
    uint32_t *flex_ctr_lt_id)
...
static int
bcm56880_a0_ltsw_flowtracker_hit_index_compaction_ctrl_set(int unit)
{
    return SHR_E_UNAVAIL;
}

static int
bcm56880_a0_ltsw_flowtracker_hit_index_compaction_ctrl_delete(int unit)
{
    return SHR_E_UNAVAIL;
}

static int
bcm56880_a0_ltsw_flowtracker_flow_limit_config_supported(
    int unit,
    bcm_flowtracker_group_t id)
{
    return SHR_E_NONE;
...
static int
bcm56880_a0_ltsw_flowtracker_with_exact_match_supported(
    int unit,
    bool *is_supported)
{
    *is_supported = true;
...
static int
bcm56880_a0_ltsw_flowtracker_per_pipe_em_mode_validate(
    int unit,
    int num_pipe,
...
static mbcm_ltsw_flowtracker_drv_t bcm56880_a0_ltsw_flowtracker_drv = {
    ...
    .flowtracker_num_em_groups_get = bcm56880_a0_ltsw_flowtracker_num_em_groups_get,
    .flowtracker_base_entry_info_get = bcm56880_a0_ltsw_flowtracker_base_entry_info_get,
    .flowtracker_ft_learn_fail_count_supported = bcm56880_a0_ltsw_flowtracker_ft_learn_fail_count_supported,
    .flowtracker_flex_ctr_pkt_byte_reserve_wo_eapp = bcm56880_a0_ltsw_flowtracker_flex_ctr_pkt_byte_reserve_wo_eapp,
    .flowtracker_hit_index_compaction_ctrl_set = bcm56880_a0_ltsw_flowtracker_hit_index_compaction_ctrl_set,
    .flowtracker_hit_index_compaction_ctrl_delete = bcm56880_a0_ltsw_flowtracker_hit_index_compaction_ctrl_delete,
    .flowtracker_flow_limit_config_supported = bcm56880_a0_ltsw_flowtracker_flow_limit_config_supported,
    .flowtracker_with_exact_match_supported = bcm56880_a0_ltsw_flowtracker_with_exact_match_supported,
    .flowtracker_per_pipe_em_mode_validate = bcm56880_a0_ltsw_flowtracker_per_pipe_em_mode_validate
};
