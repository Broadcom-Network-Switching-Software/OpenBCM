/*! \file bcm56780_a0_dna_2_5_13_switch.c
 *
 * BCM56780_A0 DNA_2_5_13 Switch Driver.
 */
/*
...
#define INVALID_DROP_CODE -1

/*!
 * \brief Drop event enum to NPL drop code mapping table.
 *
 * This table helps to set threshold_event for EP Recirculate, and only EP drop
 * events are valid. Map unsupported events to INVALID_DROP_CODE.
 */
static const int
ep_recirc_drop_event_to_drop_code_map[bcmPktDropEventCount] = {
    [bcmPktDropEventIngressNoDrop] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressAllDrops] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressCmlFlagsDrop] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressL2SrcStaticMove] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressL2SrcDiscard] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressMacsaMulticast] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressOuterTpidCheckFailed] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressIncomingPvlanCheckFailed] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressPktIntegrityCheckFailed] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressProtocolPktDrop] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressMembershipCheckFailed] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressSpanningTreeCheckFailed] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressL2DstLookupMiss] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressL2DstDiscard] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressL3DstLookupMiss] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressL3DstDiscard] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressL3HdrError] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressL3TtlError] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressIpmcL3IifOrRpaIdCheckFailed] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressTunnelTtlCheckFailed] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressTunnelShimHdrError] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressTunnelObjectValidationFailed] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressTunnelAdaptDrop] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressPvlanDrop] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressVfp] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressIfp] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressIfpMeter] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressDstFp] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressMplsProtectionDrop] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressMplsLabelActionInvalid] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressMplsTermPolicySelectTableDrop] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressMplsReservedLabelExposed] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressMplsTtlError] = INVALID_DROP_CODE,
    [bcmPktDropEventEgressNoDrop] = 0,
    [bcmPktDropEventEgressAllDrops] = INVALID_DROP_CODE,
    [bcmPktDropEventEgressL2OifDrop] = 128,
    [bcmPktDropEventEgressMembershipDrop] = 129,
    [bcmPktDropEventEgressDvpMembershipDrop] = 130,
    [bcmPktDropEventEgressTtlDrop] = 131,
    [bcmPktDropEventEgressL3SameIntfDrop] = 132,
    [bcmPktDropEventEgressL2SamePortDrop] = 133,
    [bcmPktDropEventEgressSplitHorizonDrop] = 134,
    [bcmPktDropEventEgressStgDisableDrop] = 135,
    [bcmPktDropEventEgressStgBlockDrop] = 136,
    [bcmPktDropEventEgressEfpDrop] = 137,
    [bcmPktDropEventEgressEgrMeterDrop] = 138,
    [bcmPktDropEventIngressEmFt] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressIvxlt] = INVALID_DROP_CODE,
    [bcmPktDropEventEgressEgrMtuDrop] = 139,
    [bcmPktDropEventEgressEgrVxltDrop] = 140,
    [bcmPktDropEventIngressUrpfCheckFailed] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressSrcPortKnockoutDrop] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressLagFailoverPortDown] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressSplitHorizonCheckFailed] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressDstLinkDown] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressBlockMaskDrop] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressL3MtuCheckFailed] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressSeqNumCheckFailed] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressL3IifEqL3Oif] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressStormControlDrop] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressEgrMembershipCheckFailed] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressEgrSpanningTreeCheckFailed] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressDstPbmZero] = INVALID_DROP_CODE,
    [bcmPktDropEventEgressEgrCellTooLarge] = 141,
    [bcmPktDropEventEgressEgrCellTooSmall] = 142,
    [bcmPktDropEventEgressQosRemarkingDrop] = 143,
    [bcmPktDropEventEgressSvpEqualDvpDrop] = 144,
    [bcmPktDropEventEgressInvalid1588Pkt] = 145,
    [bcmPktDropEventIngressMplsEcnError] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressMplsCtrlPktDrop] = INVALID_DROP_CODE,
    [bcmPktDropEventEgressFlexEditorDrop] = 146,
    [bcmPktDropEventIngressEpRecircDrop] = INVALID_DROP_CODE,
    [bcmPktDropEventIngressForteIpv4GatewayTable] = INVALID_DROP_CODE,
    [bcmPktDropEventEgressEpRecircDrop] = 147,
    [bcmPktDropEventEgressIfaMdDeleteDrop] = 148
};
 ...
 */
static int
bcm56780_a0_dna_2_5_13_ltsw_switch_db_get(int unit, bcmint_switch_db_t *switch_db)
{
    SHR_FUNC_ENTER(unit);
 ...
 */
static int
bcm56780_a0_dna_2_5_13_ltsw_switch_mon_trace_event_init(int unit)
{
    int i;
    bcmi_lt_entry_t lt_entry;
 ...
 */
static int
bcm56780_a0_dna_2_5_13_ltsw_switch_protocol_init(int unit)
{
    int profile_index;
...
static int
bcm56780_a0_dna_2_5_13_ltsw_switch_protocol_handle(int unit,
                                                   ...
                                                   int *priority)
{
    ...
    bcmi_lt_field_t protocol_field[] =
    {
        ...
        /*50*/ {FIXED_HVE_RESULT_SET_4s, BCMI_LT_FIELD_F_SET, 0, {0}},
        /*51*/ {FIXED_HVE_RESULT_SET_4_MASKs, BCMI_LT_FIELD_F_SET, 0, {0}},
    };
    uint64_t mac = 0, mac_mask = 0;
    int dunit = bcmi_ltsw_dev_dunit(unit);
    bcmlt_entry_handle_t eh = BCMLT_INVALID_HDL;
    ...
    protocol_field[50].u.val = match->fixed_hve_result_set_4 &
                               match->fixed_hve_result_set_4_mask;
    protocol_field[51].u.val = match->fixed_hve_result_set_4_mask;
 ...
 */
static int
bcm56780_a0_dna_2_5_13_ltsw_switch_pkt_integrity_check_init(int unit)
{
    bcmi_lt_entry_t lt_entry;
...
static int
bcm56780_a0_dna_2_5_13_ltsw_switch_pkt_integrity_handle(int unit,
                                                        bcmlt_opcode_t opcode,
...
static int
bcm56780_a0_dna_2_5_13_ltsw_switch_protocol_traverse(int unit,
...
static int
bcm56780_a0_dna_2_5_13_ltsw_switch_protocol_delete_all(int unit)
{
    bcmlt_entry_handle_t eh = BCMLT_INVALID_HDL;
    int rv, dunit;
    bool is_reserved = false;
...
static int
bcm56780_a0_dna_2_5_13_ltsw_switch_ep_recirc_drop_event_to_drop_code(
    int unit,
    bcm_pkt_drop_event_t drop_event,
    int *drop_code)
{
    SHR_FUNC_ENTER(unit);
    SHR_NULL_CHECK(drop_code, SHR_E_PARAM);

    if (drop_event < 0 || drop_event >= bcmPktDropEventCount) {
        SHR_ERR_EXIT(SHR_E_PARAM);
    }

    *drop_code = ep_recirc_drop_event_to_drop_code_map[drop_event];
    if (*drop_code == INVALID_DROP_CODE) {
...
/*!
 * \brief Switch driver function variable for bcm56780_a0 DNA_2_5_13 device.
 */
static mbcm_ltsw_sc_drv_t bcm56780_a0_dna_2_5_13_ltsw_sc_drv = {
    .switch_db_get = bcm56780_a0_dna_2_5_13_ltsw_switch_db_get,
    .switch_mon_trace_event_init = bcm56780_a0_dna_2_5_13_ltsw_switch_mon_trace_event_init,
    .switch_protocol_init = bcm56780_a0_dna_2_5_13_ltsw_switch_protocol_init,
    .switch_protocol_handle = bcm56780_a0_dna_2_5_13_ltsw_switch_protocol_handle,
    .switch_pkt_integrity_check_init = bcm56780_a0_dna_2_5_13_ltsw_switch_pkt_integrity_check_init,
    .switch_pkt_integrity_handle = bcm56780_a0_dna_2_5_13_ltsw_switch_pkt_integrity_handle,
    .spc_trav = bcm56780_a0_dna_2_5_13_ltsw_switch_protocol_traverse,
    .spc_del_all = bcm56780_a0_dna_2_5_13_ltsw_switch_protocol_delete_all,
    .switch_ep_recirc_drop_event_to_drop_code = bcm56780_a0_dna_2_5_13_ltsw_switch_ep_recirc_drop_event_to_drop_code
};
...
int
bcm56780_a0_dna_2_5_13_ltsw_switch_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_sc_drv_set(unit, &bcm56780_a0_dna_2_5_13_ltsw_sc_drv));
