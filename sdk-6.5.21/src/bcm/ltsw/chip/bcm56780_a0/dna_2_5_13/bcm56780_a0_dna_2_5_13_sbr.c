/*! \file bcm56780_a0_dna_2_5_13_sbr.c
 *
 * Management of strength profile table and strength field for strength
 * based-resolution (SBR) in BCM56780_A0 DNA_2_5_13.
 */
/*
...
static const
bcmint_sbr_profile_fld_t l3_ipv4_alpm_strength_profile_flds_1[] = {
    {
        .name = L3_DST_DESTINATION_STRENGTHs,
        .val  = 3
    },
...
static const
bcmint_sbr_profile_fld_t l3_ipv4_alpm_strength_profile_flds_2[] = {
    {
        .name = L3_DST_DESTINATION_STRENGTHs,
        .val  = 2
    },
...
/* Fields for L3_IPV4_ALPM_STRENGTH_PROFILE_MTOP. */
static const
bcmint_sbr_profile_fld_t l3_ipv4_alpm_strength_profile_mtop_flds_0[] = {
    {
        .name = L3_DST_DESTINATION_STRENGTHs,
        .val  = 4
    },
...
static const
bcmint_sbr_profile_fld_t l3_ipv4_alpm_strength_profile_mtop_flds_1[] = {
    {
        .name = L3_DST_DESTINATION_STRENGTHs,
        .val  = 3
    },
...
static const
bcmint_sbr_profile_fld_t l3_ipv4_alpm_strength_profile_mtop_flds_2[] = {
    {
        .name = L3_DST_DESTINATION_STRENGTHs,
        .val  = 2
    },
...
static const
bcmint_sbr_profile_fld_t l3_ipv6_alpm_strength_profile_flds_1[] = {
    {
        .name = L3_DST_DESTINATION_STRENGTHs,
        .val  = 3
    },
...
static const
bcmint_sbr_profile_fld_t l3_ipv6_alpm_strength_profile_flds_2[] = {
    {
        .name = L3_DST_DESTINATION_STRENGTHs,
        .val  = 2
    },
...
/* Fields for L3_IPV6_ALPM_STRENGTH_PROFILE_MTOP. */
static const
bcmint_sbr_profile_fld_t l3_ipv6_alpm_strength_profile_mtop_flds_0[] = {
    {
        .name = L3_DST_DESTINATION_STRENGTHs,
        .val  = 4
    },
...
static const
bcmint_sbr_profile_fld_t l3_ipv6_alpm_strength_profile_mtop_flds_1[] = {
    {
        .name = L3_DST_DESTINATION_STRENGTHs,
        .val  = 3
    },
...
static const
bcmint_sbr_profile_fld_t l3_ipv6_alpm_strength_profile_mtop_flds_2[] = {
    {
        .name = L3_DST_DESTINATION_STRENGTHs,
        .val  = 2
    },
...
bcmint_sbr_profile_ent_t l2_ipv6_multicast_strength_profile_ent[] = {
    {
        ...
        .shr_hdl  = BCMI_LTSW_SBR_PTH_L2_IPV4_MULTICAST
    }
};
...
bcmint_sbr_profile_ent_t l3_ipv4_alpm_strength_profile_ent[] = {
    ...
    },
    {
        ...
        .key_name = L3_IPV4_ALPM_STRENGTH_PROFILE_INDEXs,
        .fld_info = l3_ipv4_alpm_strength_profile_flds_1,
        .fld_num  = 8
    },
    {
        .index    = 0,
        ...
        .key_name = L3_IPV4_ALPM_STRENGTH_PROFILE_INDEXs,
        .fld_info = l3_ipv4_alpm_strength_profile_flds_2,
        .fld_num  = 8
    }
};

/* Entry for L3_IPV4_ALPM_STRENGTH_PROFILE_MTOP. */
static
bcmint_sbr_profile_ent_t l3_ipv4_alpm_strength_profile_mtop_ent[] = {
    {
        .index    = 0,
        .ent_type = BCMI_LTSW_SBR_PET_ALPM_GH,
        .key_name = L3_IPV4_ALPM_STRENGTH_PROFILE_MTOP_INDEXs,
        .fld_info = l3_ipv4_alpm_strength_profile_mtop_flds_0,
        .fld_num  = 8
    },
    {
        .index    = 0,
        .ent_type = BCMI_LTSW_SBR_PET_ALPM_VRF,
        .key_name = L3_IPV4_ALPM_STRENGTH_PROFILE_MTOP_INDEXs,
        .fld_info = l3_ipv4_alpm_strength_profile_mtop_flds_1,
        .fld_num  = 8
    },
    {
        .index    = 0,
        .ent_type = BCMI_LTSW_SBR_PET_ALPM_GL,
        .key_name = L3_IPV4_ALPM_STRENGTH_PROFILE_MTOP_INDEXs,
        .fld_info = l3_ipv4_alpm_strength_profile_mtop_flds_2,
        .fld_num  = 8
    }
};
...
bcmint_sbr_profile_ent_t l3_ipv6_alpm_strength_profile_ent[] = {
    ...
    },
    {
        ...
        .ent_type = BCMI_LTSW_SBR_PET_ALPM_VRF,
        .key_name = L3_IPV6_ALPM_STRENGTH_PROFILE_INDEXs,
        .fld_info = l3_ipv6_alpm_strength_profile_flds_1,
        .fld_num  = 8,
        .shr_ent  = &l3_ipv4_alpm_strength_profile_ent[0],
        .shr_hdl  = BCMI_LTSW_SBR_PTH_L3_IPV4_ALPM
    },
    {
        ...
        .ent_type = BCMI_LTSW_SBR_PET_ALPM_GL,
        .key_name = L3_IPV6_ALPM_STRENGTH_PROFILE_INDEXs,
        .fld_info = l3_ipv6_alpm_strength_profile_flds_2,
        .fld_num  = 8,
        .shr_ent  = &l3_ipv4_alpm_strength_profile_ent[0],
        .shr_hdl  = BCMI_LTSW_SBR_PTH_L3_IPV4_ALPM
    }
...
/* Entry for L3_IPV6_ALPM_STRENGTH_PROFILE_MTOP. */
static
bcmint_sbr_profile_ent_t l3_ipv6_alpm_strength_profile_mtop_ent[] = {
    {
        .index    = 0,
        .ent_type = BCMI_LTSW_SBR_PET_ALPM_GH,
        .key_name = L3_IPV6_ALPM_STRENGTH_PROFILE_MTOP_INDEXs,
        .fld_info = l3_ipv6_alpm_strength_profile_mtop_flds_0,
        .fld_num  = 8,
        .shr_ent  = &l3_ipv4_alpm_strength_profile_mtop_ent[0],
        .shr_hdl  = BCMI_LTSW_SBR_PTH_L3_IPV4_ALPM_MTOP
    },
    {
        .index    = 0,
        .ent_type = BCMI_LTSW_SBR_PET_ALPM_VRF,
        .key_name = L3_IPV6_ALPM_STRENGTH_PROFILE_MTOP_INDEXs,
        .fld_info = l3_ipv6_alpm_strength_profile_mtop_flds_1,
        .fld_num  = 8,
        .shr_ent  = &l3_ipv4_alpm_strength_profile_mtop_ent[0],
        .shr_hdl  = BCMI_LTSW_SBR_PTH_L3_IPV4_ALPM_MTOP
    },
    {
        ...
        .ent_type = BCMI_LTSW_SBR_PET_ALPM_GL,
        .key_name = L3_IPV6_ALPM_STRENGTH_PROFILE_MTOP_INDEXs,
        .fld_info = l3_ipv6_alpm_strength_profile_mtop_flds_2,
        .fld_num  = 8,
        .shr_ent  = &l3_ipv4_alpm_strength_profile_mtop_ent[0],
        .shr_hdl  = BCMI_LTSW_SBR_PTH_L3_IPV4_ALPM_MTOP
    }
...
bcmint_sbr_profile_tbl_t sbr_profile_tbl_db[BCMI_LTSW_SBR_PTH_COUNT] = {
    ...
    [BCMI_LTSW_SBR_PTH_L3_IPV4_ALPM_MTOP] = {
        .name      = L3_IPV4_ALPM_STRENGTH_PROFILE_MTOPs,
        .ent_info  = l3_ipv4_alpm_strength_profile_mtop_ent,
        .ent_num   = 3
    },
    ...
    [BCMI_LTSW_SBR_PTH_L3_IPV6_ALPM_MTOP] = {
        .name      = L3_IPV6_ALPM_STRENGTH_PROFILE_MTOPs,
        .ent_info  = l3_ipv6_alpm_strength_profile_mtop_ent,
        .ent_num   = 3
    },
 ...
 */
static int
bcm56780_a0_dna_2_5_13_ltsw_sbr_db_get(int unit, bcmint_sbr_db_t *sbr_db)
{
    SHR_FUNC_ENTER(unit);
    ...
    if (ltsw_feature(unit, LTSW_FT_MTOP)) {
        SHR_BITSET
            (sbr_db->profile_tbl_bmp, BCMI_LTSW_SBR_PTH_L3_IPV4_ALPM_MTOP);
        SHR_BITSET
            (sbr_db->profile_tbl_bmp, BCMI_LTSW_SBR_PTH_L3_IPV6_ALPM_MTOP);
    }
...
/*!
 * \brief SBR driver function variable for bcm56780_a0 DNA_2_5_13 device.
 */
static mbcm_ltsw_sbr_drv_t bcm56780_a0_dna_2_5_13_ltsw_sbr_drv = {
    .sbr_db_get = bcm56780_a0_dna_2_5_13_ltsw_sbr_db_get
};
...
int
bcm56780_a0_dna_2_5_13_ltsw_sbr_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_sbr_drv_set(unit, &bcm56780_a0_dna_2_5_13_ltsw_sbr_drv));
