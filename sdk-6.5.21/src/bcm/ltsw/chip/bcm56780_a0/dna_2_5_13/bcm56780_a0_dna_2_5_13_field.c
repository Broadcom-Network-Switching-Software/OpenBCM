/*! \file bcm56780_a0_dna_2_5_13_field.c
 *
 * BCM56780_A0 dna_2_5_13 FIELD driver.
 */
/*
...
#include <bcm_int/ltsw/chip/bcm56780_a0/dna_2_5_13/bcm56780_a0_dna_2_5_13_field_lt_map.h>
...
bcmint_field_compress_tbls_info_t bcm56780_a0_compress_tbls_info = {
    ...
    .direct_mapped_l4srcport_sid = "FP_COMPRESSION_CLASSID_REMAP_0",
    .direct_val_l4srcport_fid = "FP_COMPRESSION_CLASSID_REMAP_0_ID",
    .direct_map_val_l4srcport_fid = "REMAPPED_VALUE",
    .direct_mapped_l4dstport_sid = "FP_COMPRESSION_CLASSID_REMAP_1",
    .direct_val_l4dstport_fid = "FP_COMPRESSION_CLASSID_REMAP_1_ID",
    .direct_map_val_l4dstport_fid = "REMAPPED_VALUE",
    .pipe_fid = "PIPE",
 ...
 */
static int
bcm56780_a0_dna_2_5_13_ltsw_field_stage_db_init(int unit,
                                         bcmint_field_stage_info_t *stage_info)
{
    ...
    if (stage_info->stage_id == bcmiFieldStageIngress) {
        ...
        stage_info->qual_db_count = (sizeof(bcm56780_a0_dna_2_5_13_ifp_qual_data)) /
                                            (sizeof(bcm_field_qual_map_t));
        stage_info->presel_qual_db_count =
                                   (sizeof(bcm56780_a0_dna_2_5_13_ifp_presel_qual_data)) /
                                   (sizeof(bcm_field_qual_map_t));
        stage_info->action_db_count = (sizeof(bcm56780_a0_dna_2_5_13_ifp_action_data)) /
                                            (sizeof(bcm_field_action_map_t));

        /* Initialise lt map db */
        stage_info->qual_lt_map_db = bcm56780_a0_dna_2_5_13_ifp_qual_data;
        stage_info->presel_qual_lt_map_db = bcm56780_a0_dna_2_5_13_ifp_presel_qual_data;
        stage_info->action_lt_map_db = bcm56780_a0_dna_2_5_13_ifp_action_data;
        ...
        stage_info->presel_qual_db_count =
                                   (sizeof(bcm56780_a0_dna_2_5_13_ifp_presel_qual_data)) /
                                   (sizeof(bcm_field_qual_map_t));
        stage_info->action_db_count = (sizeof(bcm56780_a0_dna_2_5_13_em_action_data)) /
                                            (sizeof(bcm_field_action_map_t));
        ...
        stage_info->action_lt_map_db = bcm56780_a0_dna_2_5_13_em_action_data;
        ...
        /* Initialise qual db counts */
        stage_info->qual_db_count = (sizeof(bcm56780_a0_dna_2_5_13_efp_qual_data)) /
                                            (sizeof(bcm_field_qual_map_t));
        stage_info->presel_qual_db_count =
                                   (sizeof(bcm56780_a0_dna_2_5_13_efp_presel_qual_data)) /
                                                 (sizeof(bcm_field_qual_map_t));
        stage_info->action_db_count = (sizeof(bcm56780_a0_dna_2_5_13_efp_action_data)) /
                                            (sizeof(bcm_field_action_map_t));

        /* Initialise lt map db */
        stage_info->qual_lt_map_db = bcm56780_a0_dna_2_5_13_efp_qual_data;

        stage_info->presel_qual_lt_map_db = bcm56780_a0_dna_2_5_13_efp_presel_qual_data;

        stage_info->action_lt_map_db = bcm56780_a0_dna_2_5_13_efp_action_data;
        ...
        /* Initialise qual db counts */
        stage_info->qual_db_count = (sizeof(bcm56780_a0_dna_2_5_13_vfp_qual_data)) /
                                            (sizeof(bcm_field_qual_map_t));
        stage_info->presel_qual_db_count =
                                    (sizeof(bcm56780_a0_dna_2_5_13_vfp_presel_qual_data)) /
                                            (sizeof(bcm_field_qual_map_t));
        stage_info->action_db_count = (sizeof(bcm56780_a0_dna_2_5_13_vfp_action_data)) /
                                               (sizeof(bcm_field_action_map_t));

        /* Initialise lt map db */
        stage_info->qual_lt_map_db = bcm56780_a0_dna_2_5_13_vfp_qual_data;

        stage_info->presel_qual_lt_map_db = bcm56780_a0_dna_2_5_13_vfp_presel_qual_data;

        stage_info->action_lt_map_db = bcm56780_a0_dna_2_5_13_vfp_action_data;
    } else {
        /* Do nothing */
    }
...
static int
bcm56780_a0_dna_2_5_13_ltsw_field_control_lt_info_init(
        int unit,
...
static int
bcm56780_a0_dna_2_5_13_ltsw_field_manual_enum_to_lt_enum_value_get(
        int unit,
        ...
        bcm_qual_field_t *qual_info)
{
    ...
    uint8 recircle_hdr_drop_reason = 0;
    ...
    if ((((qual == bcmFieldQualifyFirstDropReason) ||
        ...
        (((qual == bcmFieldQualifyFirstDropReasonIngressCopy) ||
          (qual == bcmFieldQualifyDropReasonIngressCopy)) &&
        ...
        switch (qual_enum) {
            ...
            case bcmFieldDropReasonIngRecircleHdrDrop:
                ...
                qual_info->enum_mask = 255;
                break;
            case bcmFieldDropReasonForteIpv4Gateway:
                qual_info->enum_value = 43;
                qual_info->enum_mask = 255;
                break;
            default:
                if (((qual == bcmFieldQualifyRecircleHdrFirstDropReason) ||
                     (qual == bcmFieldQualifyRecircleHdrDropReason)) &&
                    ((stage_info->stage_id == bcmiFieldStageIngress) ||
                     (stage_info->stage_id == bcmiFieldStageVlan))) {
                    recircle_hdr_drop_reason = 1;
                } else {
    ...
    if ((((qual == bcmFieldQualifyFirstDropReason) ||
        ...
        switch (qual_enum) {
            ...
            case bcmFieldDropReasonIfaMdDeleteDrop:
                ...
                qual_info->enum_mask = 255;
                break;
            case bcmFieldDropReasonIngLimit:
                qual_info->enum_value = 1;
                qual_info->enum_mask = 255;
                break;
            case bcmFieldDropReasonSharedPoolLimit:
                qual_info->enum_value = 2;
                qual_info->enum_mask = 255;
                break;
            case bcmFieldDropReasonEgrPortServicePoolSharedLimit:
                qual_info->enum_value = 3;
                qual_info->enum_mask = 255;
                break;
            case bcmFieldDropReasonEgrQueueSharedLimit:
...
static int
bcm56780_a0_dna_2_5_13_ltsw_field_manual_lt_enum_value_to_enum_get(
        int unit,
        bcm_field_entry_t entry,
        bcm_field_qualify_t qual,
        bcm_qual_field_t *qual_info,
        ...
        switch (qual_info->enum_value) {
            ...
            case 42:
                *qual_enum = bcmFieldDropReasonIngRecircleHdrDrop;
                break;
            case 43:
                *qual_enum = bcmFieldDropReasonForteIpv4Gateway;
                break;
            default:
                if (((qual == bcmFieldQualifyRecircleHdrFirstDropReason) ||
                     (qual == bcmFieldQualifyRecircleHdrDropReason)) &&
        ...
        switch (qual_info->enum_value) {
            ...
            case 148:
                *qual_enum = bcmFieldDropReasonIfaMdDeleteDrop;
                break;
            case 1:
                *qual_enum = bcmFieldDropReasonIngLimit;
                break;
            case 2:
                *qual_enum = bcmFieldDropReasonSharedPoolLimit;
                break;
            case 3:
                *qual_enum = bcmFieldDropReasonEgrPortServicePoolSharedLimit;
                break;
            case 4:
                *qual_enum = bcmFieldDropReasonEgrQueueSharedLimit;
                break;
            case 5:
...
/*!
 * \brief field driver function variable for bcm56780_a0 dna_2_5_13 device.
 */
static mbcm_ltsw_field_drv_t bcm56780_a0_dna_2_5_13_ltsw_field_drv = {
    .field_stage_db_init = bcm56780_a0_dna_2_5_13_ltsw_field_stage_db_init,
    .field_control_lt_info_init =
                    bcm56780_a0_dna_2_5_13_ltsw_field_control_lt_info_init,
    .field_auto_enum_to_lt_enum_value_get =
          bcm56780_a0_dna_2_5_13_ltsw_field_auto_enum_to_lt_enum_value_get,
    .field_auto_lt_enum_value_to_enum_get =
          bcm56780_a0_dna_2_5_13_ltsw_field_auto_lt_enum_value_to_enum_get,
...
int
bcm56780_a0_dna_2_5_13_ltsw_field_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_field_drv_set(unit, &bcm56780_a0_dna_2_5_13_ltsw_field_drv));
