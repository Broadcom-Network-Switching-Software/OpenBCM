/*! \file bcm56780_a0_dna_2_5_13_port.c
 *
 * BCM56780_A0 DNA_2_5_13 PORT driver.
 */
/*
...
static const char* ing_egr_block_profile_id_list[] = {
    [BLOCK_PROFILE_BASE]                = PORT_BASE_VIEWs,
    [BLOCK_PROFILE_IFP]                 = PORT_IFP_VIEWs,
    [BLOCK_PROFILE_LAG_FAIL_LOOPBACK]   = PORT_LAG_FAIL_LOOPBACK_VIEWs,
};
static const ltsw_port_tab_sym_list_t ing_egr_block_profile_id_map = {
    .len    = BLOCK_PROFILE_CNT,
    .syms   = ing_egr_block_profile_id_list,
};
...
static const ltsw_port_tab_lt_info_t ing_l2_iif_table               = {ING_L2_IIF_TABLEs, L2_IIFs, bcmi_ltsw_id_port_to_l2_if};
static const ltsw_port_tab_lt_info_t ing_l2_iif_attributes_table    = {ING_L2_IIF_ATTRIBUTES_TABLEs, L2_IIFs, bcmi_ltsw_id_port_to_l2_if};
static const ltsw_port_tab_lt_info_t egr_l2_oif                     = {EGR_L2_OIFs, L2_OIFs, bcmi_ltsw_id_port_to_l2_if};
static const ltsw_port_tab_lt_info_t l2_eif_system_destination      = {L2_EIF_SYSTEM_DESTINATIONs, L2_EIF_IDs, bcmi_ltsw_id_port_to_l2_if};
...
static const ltsw_port_tab_lt_info_t port_ing_egr_block_profile     = {PORT_ING_EGR_BLOCK_PROFILEs, PORT_ING_EGR_BLOCK_PROFILE_IDs, NULL, &ing_egr_block_profile_id_map};
static const ltsw_port_tab_lt_info_t port_gih_cpu                   = {PORT_GIH_CPUs};
...
static const ltsw_port_tab_info_t port_tab_map[BCMI_PT_CNT] = {
    ...
    [BCMI_PT_ING_SYS_DEST_NHOP_2]   = {&ing_system_destination_table, NHOP_INDEX_2s},
    ...
    [BCMI_PT_ING_OPAQUE_CTRL_ID_2]  = {&ing_l2_iif_table, FLEX_DIGEST_CTRL_ID_As, SYNC_TO_TRUNK},
    [BCMI_PT_ING_OPAQUE_CTRL_ID_3]  = {&ing_l2_iif_table, FLEX_DIGEST_CTRL_ID_Bs, SYNC_TO_TRUNK},
    ...
    [BCMI_PT_HG3_BRIDGE]             = {&ing_l2_iif_attributes_table, HG3_SRC_PORT_KNOCKOUT_DISABLEs, SYNC_TO_TRUNK},
    ...
    [BCMI_PT_GIH_CPU_PORT_TYPE]     = {&port_gih_cpu, PORT_TYPEs, FLD_IS_ENUM, &ing_port_type_map},
    [BCMI_PT_GIH_CPU_PARSER_TYPE]   = {&port_gih_cpu, PORT_PARSERs, FLD_IS_ENUM, &port_parser_type_map},
    [BCMI_PT_GIH_CPU_SYS_PORT]      = {&port_gih_cpu, ING_SYSTEM_PORT_TABLE_IDs},
};
 ...
 */
static int
bcm56780_a0_dna_2_5_13_ltsw_port_db_init(int unit)
{
    SHR_FUNC_ENTER(unit);
...
/*!
 * \brief port driver function variable for bcm56780_a0 DNA_2_5_13 device.
 */
static mbcm_ltsw_port_drv_t bcm56780_a0_dna_2_5_13_ltsw_port_drv = {
    .port_db_init   = bcm56780_a0_dna_2_5_13_ltsw_port_db_init,
};
...
int
bcm56780_a0_dna_2_5_13_ltsw_port_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_port_drv_set(unit, &bcm56780_a0_dna_2_5_13_ltsw_port_drv));
