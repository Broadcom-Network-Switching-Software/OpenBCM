/*! \file bcm56780_a0_dna_2_5_13_qos.c
 *
 * BCM56780_A0 DNA_2_5_13 QoS driver.
 */
/*
...
typedef enum qos_ing_policy_id_e {
    ...
    FLEX_QOS_QOS_MPLS_EXP_L3_TUNNEL_ECN_INDEX           = 2,
    FLEX_QOS_QOS_MPLS_EXP_L2_TUNNEL_ECN_INDEX           = 3,
    FLEX_QOS_QOS_MPLS_EXP_MPLS_ECN_INDEX                = 4,
    FLEX_QOS_QOS_DISABLE_ECN_DISABLE_1_INDEX            = 5,
    FLEX_QOS_QOS_L3_IIF_DSCP_L3_TUNNEL_ECN_INDEX        = 6,
    FLEX_QOS_QOS_L3_IIF_DSCP_L2_TUNNEL_ECN_INDEX        = 7,
    FLEX_QOS_QOS_L3_IIF_DSCP_MPLS_ECN_INDEX             = 8,
    FLEX_QOS_QOS_L3_IIF_DSCP_NON_TUNNEL_ECN_INDEX       = 9,
    FLEX_QOS_QOS_SVP_DSCP_L3_TUNNEL_ECN_INDEX           = 10,
    FLEX_QOS_QOS_SVP_DSCP_L2_TUNNEL_ECN_INDEX           = 11,
    FLEX_QOS_QOS_SVP_DSCP_MPLS_ECN_INDEX                = 12,
    FLEX_QOS_QOS_SVP_DSCP_NON_TUNNEL_ECN_INDEX          = 13,
    FLEX_QOS_QOS_SVP_IDOT1P_CFI_L3_TUNNEL_ECN_INDEX     = 14,
    FLEX_QOS_QOS_SVP_IDOT1P_CFI_L2_TUNNEL_ECN_INDEX     = 15,
    FLEX_QOS_QOS_SVP_IDOT1P_CFI_MPLS_ECN_INDEX          = 16,
    FLEX_QOS_QOS_SVP_IDOT1P_CFI_NON_TUNNEL_ECN_INDEX    = 17,
    FLEX_QOS_QOS_SVP_IDOT1P_CFI_ECN_DISABLE_INDEX       = 18,
    FLEX_QOS_QOS_SVP_ODOT1P_CFI_L3_TUNNEL_ECN_INDEX     = 19,
    FLEX_QOS_QOS_SVP_ODOT1P_CFI_L2_TUNNEL_ECN_INDEX     = 20,
    FLEX_QOS_QOS_SVP_ODOT1P_CFI_MPLS_ECN_INDEX          = 21,
    FLEX_QOS_QOS_SVP_ODOT1P_CFI_NON_TUNNEL_ECN_INDEX    = 22,
    FLEX_QOS_QOS_SVP_ODOT1P_CFI_ECN_DISABLE_INDEX       = 23,
    FLEX_QOS_QOS_L2_IIF_DSCP_L3_TUNNEL_ECN_INDEX        = 24,
    FLEX_QOS_QOS_L2_IIF_DSCP_L2_TUNNEL_ECN_INDEX        = 25,
    FLEX_QOS_QOS_L2_IIF_DSCP_MPLS_ECN_INDEX             = 26,
    FLEX_QOS_QOS_L2_IIF_DSCP_NON_TUNNEL_ECN_INDEX       = 27,
    FLEX_QOS_QOS_L2_IIF_IDOT1P_CFI_L3_TUNNEL_ECN_INDEX  = 28,
    FLEX_QOS_QOS_L2_IIF_IDOT1P_CFI_L2_TUNNEL_ECN_INDEX  = 29,
    FLEX_QOS_QOS_L2_IIF_IDOT1P_CFI_MPLS_ECN_INDEX       = 30,
    FLEX_QOS_QOS_L2_IIF_IDOT1P_CFI_NON_TUNNEL_ECN_INDEX = 31,
    FLEX_QOS_QOS_L2_IIF_IDOT1P_CFI_ECN_DISABLE_INDEX    = 32,
    FLEX_QOS_QOS_L2_IIF_ODOT1P_CFI_L3_TUNNEL_ECN_INDEX  = 33,
    FLEX_QOS_QOS_L2_IIF_ODOT1P_CFI_L2_TUNNEL_ECN_INDEX  = 34,
    FLEX_QOS_QOS_L2_IIF_ODOT1P_CFI_MPLS_ECN_INDEX       = 35,
 ...
 */
static int
bcm56780_a0_dna_2_5_13_ltsw_qos_ctrl_info_init(int unit,
...
/*!
 * \brief QoS driver function variable for bcm56780_a0 DNA_2_5_13 device.
 */
static mbcm_ltsw_qos_drv_t bcm56780_a0_dna_2_5_13_ltsw_qos_drv = {
    .qos_ctrl_info_init = bcm56780_a0_dna_2_5_13_ltsw_qos_ctrl_info_init
};
...
int
bcm56780_a0_dna_2_5_13_ltsw_qos_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_qos_drv_set(unit, &bcm56780_a0_dna_2_5_13_ltsw_qos_drv));
