    ...
    bcmint_mirror_ctrl_info_t *mirror_ctrl)
{
    ...
    * Mirror container:
    * 0--egress port, sampler, ingress vp, ingress port, EP Recirculate, EM_FP, EM_FT
    ...
    */
    mirror_ctrl->mc_st_flags[0] = BCMINT_MIRROR_ST_F_PORT_EGR |
                                  ...
                                  BCMINT_MIRROR_ST_F_EM_FP_ING |
                                  BCMINT_MIRROR_ST_F_EM_FP_EGR |
                                  BCMINT_MIRROR_ST_F_EM_FT_ING |
                                  BCMINT_MIRROR_ST_F_EM_FT_EGR |
                                  BCMINT_MIRROR_ST_F_EM_FP_ING_HW |
                                  BCMINT_MIRROR_ST_F_EM_FP_EGR_HW |
                                  BCMINT_MIRROR_ST_F_EM_FT_ING_HW |
                                  BCMINT_MIRROR_ST_F_EM_FT_EGR_HW;
    ...
    bcm_mirror_destination_t *mirror_dest)
{
    ...
    /* TRUE_EGRESS flag should be used along with MOD_TUNNEL_PSAMP flag. */
    ...
    /* It can be uc queue for MMU Mirror-on-drop. */
