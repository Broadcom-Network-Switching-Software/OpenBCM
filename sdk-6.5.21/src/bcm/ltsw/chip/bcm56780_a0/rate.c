    ...
    bcmint_rate_info_t *rate_info)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (xfs_ltsw_rate_meter_set(unit, -1, sc_id, rate_info));

    /* Get enable status of the storm ctrl id. */
    SHR_IF_ERR_VERBOSE_EXIT
        (xfs_ltsw_rate_status(unit, -1, sc_id, &tmp_hw_info));
...
bcm56780_a0_ltsw_rate_get(
    ...
    bcmint_rate_info_t *rate_info)
{
    uint32_t sc_id = RATE_SC_METER_ID_DEFAULT;
    SHR_FUNC_ENTER(unit);
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (xfs_ltsw_rate_meter_get(unit, -1, sc_id, rate_info));
