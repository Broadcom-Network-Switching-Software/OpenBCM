...
static int
bcm56780_a0_ltsw_trunk_redirect_config_set(
    int unit,
    ...
    bcmint_trunk_info_t *dst_info)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (xfs_ltsw_trunk_redirect_config_set(unit, src_tid, src_info, dst_tid, dst_info));
...
static int
bcm56780_a0_ltsw_trunk_redirect_config_get(
    int unit,
    bcmint_trunk_id_t src_tid,
    bcmint_trunk_info_t *src_info,
    bcmint_trunk_id_t *dst_tid)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (xfs_ltsw_trunk_redirect_config_get(unit, src_tid, src_info, dst_tid));
...
static mbcm_ltsw_trunk_drv_t bcm56780_a0_ltsw_trunk_drv = {
    ...
    .trunk_redirect_config_set = bcm56780_a0_ltsw_trunk_redirect_config_set,
    .trunk_redirect_config_get = bcm56780_a0_ltsw_trunk_redirect_config_get
};
