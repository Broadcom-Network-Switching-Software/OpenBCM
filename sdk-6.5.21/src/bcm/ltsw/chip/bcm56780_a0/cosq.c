...
/* IFP HI VIEW STRENGTH */
#define PORT_UC_COS_STRENGTH4   4
#define PORT_MC_COS_STRENGTH4   4
#define PORT_RQE_COS_STRENGTH4  4
#define PORT_CPU_COS_STRENGTH4  1

#define CPU_RQE_COS_STRENGTH4   2
#define CPU_COS_STRENGTH4       2

#define IFP_UC_COS_STRENGTH4    1
#define IFP_MC_COS_STRENGTH4    1
#define IFP_RQE_COS_STRENGTH4   1
#define IFP_CPU_COS_STRENGTH4   4

#define DEST_UC_COS_STRENGTH4   3
#define DEST_MC_COS_STRENGTH4   3
#define DEST_RQE_COS_STRENGTH4  3
#define DEST_CPU_COS_STRENGTH4  3
...
cosq_wred_need_profile(uint32_t flags)
{
    if (flags & (BCM_COSQ_DISCARD_COLOR_ALL |
                 ...
                 BCM_COSQ_DISCARD_INSTANT_ECT_MARKED)) {
        return TRUE;
    } else {
        return FALSE;
    }
...
cosq_strength_profile_init(int unit)
{
    ...
    profile.strength_profile_id = TM_IFP_HI_VIEW_PROFILE_ID;
    profile.uc_cos_strength = PORT_UC_COS_STRENGTH4;
    profile.mc_cos_strength = PORT_MC_COS_STRENGTH4;
    profile.rqe_cos_strength = PORT_RQE_COS_STRENGTH4;
    profile.cpu_cos_strength = PORT_CPU_COS_STRENGTH4;
    SHR_IF_ERR_EXIT
        (tm_ltsw_port_cosq_strength_profile_init(unit, &profile));

    profile.strength_profile_id = TM_IFP_HI_VIEW_PROFILE_ID;
    profile.uc_cos_strength = IFP_UC_COS_STRENGTH4;
    profile.mc_cos_strength = IFP_MC_COS_STRENGTH4;
    profile.rqe_cos_strength = IFP_RQE_COS_STRENGTH4;
    profile.cpu_cos_strength = IFP_CPU_COS_STRENGTH4;
    SHR_IF_ERR_EXIT
        (tm_ltsw_ifp_cosq_strength_profile_init(unit, &profile));

    profile.strength_profile_id = TM_IFP_HI_VIEW_PROFILE_ID;
    profile.uc_cos_strength = DEST_UC_COS_STRENGTH4;
    profile.mc_cos_strength = DEST_MC_COS_STRENGTH4;
    profile.rqe_cos_strength = DEST_RQE_COS_STRENGTH4;
    profile.cpu_cos_strength = DEST_CPU_COS_STRENGTH4;
    SHR_IF_ERR_EXIT
        (tm_ltsw_destination_cosq_strength_profile_init(unit, &profile));

    profile.strength_profile_id = TM_IFP_HI_VIEW_PROFILE_ID;
    profile.rqe_cos_strength = CPU_RQE_COS_STRENGTH4;
    profile.cpu_cos_strength = CPU_COS_STRENGTH4;
    SHR_IF_ERR_EXIT
        (tm_ltsw_cpu_cosq_strength_profile_init(unit, &profile));
    ...
    uint32_t *flags)
{
    ...
    if (*flags & ~(BCM_COSQ_DISCARD_DEVICE |
                  ...
                  BCM_COSQ_DISCARD_ENABLE |
                  BCM_COSQ_DISCARD_MARK_CONGESTION |
                  BCM_COSQ_DISCARD_INSTANT_QUEUE_SIZE )) {
        SHR_IF_ERR_VERBOSE_EXIT(SHR_E_PARAM);
    }
