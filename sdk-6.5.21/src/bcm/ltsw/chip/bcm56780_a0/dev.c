...
ltsw_dev_config_get(int unit, int *core_frequency)
{
    ...
    if (sal_strcasecmp(sym_val, CLK_950MHZs) == 0) {
        /* Clock frequency 950Mhz. */
        *core_frequency = 950;
    } else if (sal_strcasecmp(sym_val, CLK_850MHZs) == 0) {
        ...
        *core_frequency = 1175;
    } else if (sal_strcasecmp(sym_val, CLK_1250MHZs) == 0) {
...
static int
bcm56780_a0_ltsw_dev_info_init(
    int unit,
    bcmint_dev_info_t *dev_info)
{
    int max_modid;
    int core_frequency = 0;
    bcmi_ltsw_cosq_device_info_t tm_dev_info;
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_ltsw_cosq_device_info_get(unit, &tm_dev_info));
    ...
    dev_info->port_addr_max = 127;
    dev_info->modid_max = max_modid;
    dev_info->modid_count = 1;
    dev_info->modport_max = dev_info->modid_count == 255;
    dev_info->modport_max_first = dev_info->modid_count == -1;
    dev_info->family = BCM_FAMILY_TRIDENT;
    dev_info->core_frequency = core_frequency;
    dev_info->packet_buffer_num = tm_dev_info.num_itm;
...
static int
bcm56780_a0_ltsw_dev_logic_port_pp_pipe(
    int unit,
    bcm_port_t port,
    int *pipe)
{
...
static int
bcm56780_a0_ltsw_dev_logic_port_pp_pipe_port(
    int unit,
    bcm_port_t port,
    int *pp_port)
{
...
static int
bcm56780_a0_ltsw_dev_pp_pipe_port_logic_port(
    int unit,
    int pipe,
    int pp_port,
    bcm_port_t *port)
...
static int
bcm56780_a0_ltsw_dev_pp_pipe_logic_pbmp(
    int unit,
    int pipe,
    bcm_pbmp_t *pbmp)
{
...
/*!
 * \brief Dev driver function variable for bcm56780_a0 device.
 */
static mbcm_ltsw_dev_drv_t bcm56780_a0_ltsw_dev_drv = {
    .dev_info_init = bcm56780_a0_ltsw_dev_info_init,
    .dev_logic_port_pp_pipe = bcm56780_a0_ltsw_dev_logic_port_pp_pipe,
    .dev_logic_port_pp_pipe_port = bcm56780_a0_ltsw_dev_logic_port_pp_pipe_port,
    .dev_pp_pipe_port_logic_port = bcm56780_a0_ltsw_dev_pp_pipe_port_logic_port,
    .dev_pp_pipe_logic_pbmp = bcm56780_a0_ltsw_dev_pp_pipe_logic_pbmp
};
...
int
bcm56780_a0_ltsw_dev_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_dev_drv_set(unit, &bcm56780_a0_ltsw_dev_drv));
