...
static int
bcm56780_a0_ltsw_cosq_stat_get(
    int unit,
    bcm_gport_t gport,
...
static int
bcm56780_a0_ltsw_cosq_stat_set(
    int unit,
    bcm_gport_t gport,
    bcm_cos_queue_t cosq,
    bcm_cosq_stat_t stat,
...
static int
bcm56780_a0_ltsw_cosq_stat_clear(
    int unit,
    int port)
{
    int num_ucq, num_mcq;
...
static int
bcm56780_a0_ltsw_cosq_stat_sync_multi_get(
    int unit,
    bcm_gport_t gport,
    bcm_cos_queue_t cosq,
    int nstat,
    ...
    uint64_t *value_arr)
{
    ...
    for (stix = 0; stix < nstat; stix++) {
        rv = bcm_ltsw_cosq_stat_sync_get(unit, gport, cosq, stat_arr[stix], &(value_arr[stix]));
        if (SHR_FAILURE(rv)) {
            return rv;
        }
    }
...
static int
bcm56780_a0_ltsw_cosq_stat_init(int unit)
{
...
static int
bcm56780_a0_ltsw_cosq_stat_detach(int unit)
{
    int warm = bcmi_warmboot_get(unit);
...
/*!
 * \brief Cosq_stat driver function variable for bcm56780_a0 device.
 */
static mbcm_ltsw_cosq_stat_drv_t bcm56780_a0_ltsw_cosq_stat_drv = {
    .cosq_stat_get = bcm56780_a0_ltsw_cosq_stat_get,
    .cosq_stat_set = bcm56780_a0_ltsw_cosq_stat_set,
    .cosq_stat_clear = bcm56780_a0_ltsw_cosq_stat_clear,
    .cosq_stat_sync_multi_get = bcm56780_a0_ltsw_cosq_stat_sync_multi_get,
    .cosq_stat_init = bcm56780_a0_ltsw_cosq_stat_init,
    .cosq_stat_detach = bcm56780_a0_ltsw_cosq_stat_detach
};
...
int
bcm56780_a0_ltsw_cosq_stat_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_cosq_stat_drv_set(unit, &bcm56780_a0_ltsw_cosq_stat_drv));
