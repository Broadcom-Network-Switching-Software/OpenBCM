...
static bcmgene_desc_t *bcm56780_a0_flexdigest_gene[BCM_MAX_NUM_UNITS];

static uint16_t *bcm56780_a0_fd_action_mask_profile[BCM_MAX_NUM_UNITS];
...
fd_lkup_action_mask_profile_id_alloc(
    ...
    int *mask_profile_id)
{
    uint16_t *mask_profile_table = bcm56780_a0_fd_action_mask_profile[unit];
    bcmi_ltsw_profile_hdl_t ph = BCMI_LTSW_PROFILE_FLEXDIGEST_LKUP_POLICY_MASK;
    bcmgene_desc_t *gene = bcm56780_a0_flexdigest_gene[unit];
    ...
    if (!profile_exists) {
        ...
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56780_a0_gene_fill_key(&hndl, 0, profile_index));
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56780_a0_gene_fill_field(&hndl, 0, 0, mask));
        SHR_IF_ERR_VERBOSE_EXIT
    ...
    int mask_profile_id)
{
    ...
    if (SHR_SUCCESS(rv)) {
        ...
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56780_a0_gene_handle_create(&hndl));
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56780_a0_gene_fill_key(&hndl, 0, mask_profile_id));
        SHR_IF_ERR_VERBOSE_EXIT
...
fd_lkup_action_mask_profile_init(int unit, int warm)
{
    ...
    bcm56780_a0_fd_action_mask_profile[unit] = mask_profile_table;
    ...
    void *user_data)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_lookup_key(hndl, 0, &value));
    mask_profile_id = value;

    blk = 0;
    offset = 0;
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_lookup_field(hndl, blk, offset, &value));
    ...
    void *user_data)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_lookup_field_array(hndl, blk, offset,
                                             0, NULL, 0, &depth));
...
fd_lkup_action_mask_profile_wb_recover(int unit)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_targeting(unit, gene,
                                    ...
                                    &hndl));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_fill_callback(&hndl,
            fd_lkup_action_mask_profile_wb_recover_profile_cb));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_traverse(&hndl, mask_profile_table));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_fill_callback(&hndl, NULL));
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_fill_callback(&hndl,
            fd_lkup_action_mask_profile_wb_recover_profile_ref_count_cb));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_traverse(&hndl, NULL));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_fill_callback(&hndl, NULL));
...
fd_lkup_action_mask_profile_deinit(int unit)
{
    ...
    SHR_FREE(bcm56780_a0_fd_action_mask_profile[unit]);
    ...
    uint16_t param1)
{
    ...
    case bcmFlexDigestActionExtractBinSetACmds15:
        ...
        offset = action_base;
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56780_a0_gene_validate_field_array(&hndl,
    ...
    case bcmFlexDigestActionExtractBinSetCCmds15:
        ...
        offset = action_base;
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56780_a0_gene_validate_tag(&hndl, blk, offset));
        if (param0 & ~1u) {
            SHR_ERR_EXIT(SHR_E_PARAM);
        }
        if (param1 & ~1u) {
...
fd_init_clear_hw(int unit)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_clear(unit, gene));
...
/*!
 * \brief Create a reserved catch-all entry as default.
 *
 * \param [in] unit Unit number.
 *
 * \retval SHR_E_NONE Success.
 ...
 */
static int
fd_init_create_reserved_entry(int unit)
{
    bcmgene_desc_t *gene = bcm56780_a0_flexdigest_gene[unit];
    bcmgene_handle_t hndl;
    ...
    /* Entry index is zero */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_fill_key(&hndl, 0, 0));
    /* Group prioriy is zero */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_fill_key(&hndl, 1, 0));
    /* Entry prioriy is zero */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_fill_field(&hndl, 0, 0, 0));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_fill_opcode(&hndl, BCMLT_OPCODE_INSERT));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_commit(&hndl));
    ...
    int arg)
{
    ...
    COMPILER_64_SET(arg_tmp, 0, arg);

    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_targeting(unit, gene,
                                    BCMGENE_FLEXDIGEST_F_GLOBAL,
                                    BCMGENE_FLEXDIGEST_SUB_F_GLOBAL_VERSATILE_HASH_SEED,
                                    &hndl));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_validate_tag(&hndl, 0, type));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_handle_create(&hndl));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_fill_field(&hndl, 0, type, arg_tmp));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_edit(&hndl));
    ...
    int *arg)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_lookup_field(&hndl, 0, type, &arg_tmp));

    COMPILER_64_TO_32_LO(*arg, arg_tmp);
...
/*!
 * \brief Initialize device-wide flex digest control values.
 *
 * \param [in] unit Unit number.
 *
 * \retval SHR_E_NONE Success.
 ...
 */
static int
fd_global_control_init(int unit, int warm)
{
    SHR_FUNC_ENTER(unit);
    ...
    if (!warm) {
        SHR_IF_ERR_VERBOSE_EXIT
            (fd_global_control_set(
                 unit,
                 bcmFlexDigestControlHashVersatileRandomSeedBinA,
                 0));
        SHR_IF_ERR_VERBOSE_EXIT
            (fd_global_control_set(
                 unit,
                 bcmFlexDigestControlHashVersatileRandomSeedBinB,
                 0));
        SHR_IF_ERR_VERBOSE_EXIT
            (fd_global_control_set(
                 unit,
                 bcmFlexDigestControlHashVersatileRandomSeedBinC,
                 0));
    }
...
static int
bcm56780_a0_ltsw_flexdigest_db_init(
    int unit,
    int warm)
{
    ...
    gene = bcm56780_a0_gene_extractor(unit, "FlexDigest");

    if (!gene) {
        SHR_VERBOSE_EXIT(SHR_E_UNAVAIL);
    }

    bcm56780_a0_flexdigest_gene[unit] = gene;
...
static int
bcm56780_a0_ltsw_flexdigest_db_deinit(int unit)
{
    SHR_FUNC_ENTER(unit);
    ...
    if (bcm56780_a0_flexdigest_gene[unit]) {
        bcm56780_a0_flexdigest_gene[unit] = NULL;
    }
    SHR_EXIT();
...
static int
bcm56780_a0_ltsw_flexdigest_init(
    int unit,
    int warm)
{
    SHR_FUNC_ENTER(unit);
    ...
    if (!warm) {
        ...
        SHR_IF_ERR_VERBOSE_EXIT
            (fd_init_create_reserved_entry(unit));
    }
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (fd_global_control_init(unit, warm));
...
static int
bcm56780_a0_ltsw_flexdigest_deinit(int unit)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56780_a0_ltsw_flexdigest_feature_get(
    int unit,
    ...
    uint32_t *features)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_sub_feature_get(unit, gene, functionality, features));
...
static int
bcm56780_a0_ltsw_flexdigest_info_get(
    int unit,
...
static int
bcm56780_a0_ltsw_flexdigest_validate_lkup_match(
    int unit,
    bcm_flexdigest_match_t match)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_targeting(unit, gene,
                                    ...
                                    &hndl));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_validate_tag(&hndl, 1, match));
...
static int
bcm56780_a0_ltsw_flexdigest_validate_lkup_match_conflict(
    int unit,
...
static int
bcm56780_a0_ltsw_flexdigest_validate_lkup_action(
    int unit,
    bcm_flexdigest_action_t action)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56780_a0_ltsw_flexdigest_validate_lkup_action_params(
    int unit,
    bcm_flexdigest_action_t action,
    uint16_t param0,
    uint16_t param1)
...
static int
bcm56780_a0_ltsw_flexdigest_validate_lkup_qualifier(
    int unit,
...
static int
bcm56780_a0_ltsw_flexdigest_validate_lkup_group_qset(
    int unit,
    bcm_flexdigest_qset_t qset)
{
    ...
    for (i = 0; i < bcmFlexDigestQualifyCount; i++) {
        if (BCM_FLEXDIGEST_QSET_TEST(qset, i)) {
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56780_a0_gene_validate_tag(&hndl, 0, i));
        }
    }
...
static int
bcm56780_a0_ltsw_flexdigest_validate_hash_profile(
    int unit,
    int hash_profile_id,
    ...
    int value)
{
    ...
    case bcmFlexDigestHashProfileControlBinC1FunctionSelection:
        if (value < 0 ||
            value > BCM_FLEXDIGEST_HASH_FUNCTION_VERSATILE_HASH_1) {
            SHR_ERR_EXIT(SHR_E_PARAM);
        }
        break;
    default:
...
static int
bcm56780_a0_ltsw_flexdigest_norm_seed_profile_create(
    int unit,
    int seed_profile_id)
{
    bcmgene_desc_t *gene = bcm56780_a0_flexdigest_gene[unit];
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_handle_create(&hndl));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_fill_key(&hndl, 0, seed_profile_id));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_fill_opcode(&hndl, BCMLT_OPCODE_INSERT));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_commit(&hndl));
...
static int
bcm56780_a0_ltsw_flexdigest_norm_seed_profile_destroy(
    int unit,
    int seed_profile_id)
{
    bcmgene_desc_t *gene = bcm56780_a0_flexdigest_gene[unit];
...
static int
bcm56780_a0_ltsw_flexdigest_norm_seed_profile_set(
    int unit,
    int seed_profile_id,
    ...
    int value)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_fill_key(&hndl, 0, seed_profile_id));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_fill_field(&hndl, 0, type, value & 0xffffffff));
    SHR_IF_ERR_VERBOSE_EXIT
...
static int
bcm56780_a0_ltsw_flexdigest_norm_seed_profile_get(
    int unit,
    int seed_profile_id,
    bcm_flexdigest_norm_seed_control_t type,
    int *value)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_lookup(&hndl));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_lookup_field(&hndl, 0, type, &value_tmp));
...
static int
bcm56780_a0_ltsw_flexdigest_norm_seed_profile_configured(
    int unit,
    int seed_profile_id)
{
    bcmgene_desc_t *gene = bcm56780_a0_flexdigest_gene[unit];
...
static int
bcm56780_a0_ltsw_flexdigest_norm_profile_create(
    int unit,
    int norm_profile_id)
{
    bcmgene_desc_t *gene = bcm56780_a0_flexdigest_gene[unit];
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_handle_create(&hndl));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_fill_key(&hndl, 0, norm_profile_id));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_fill_opcode(&hndl, BCMLT_OPCODE_INSERT));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_commit(&hndl));
...
static int
bcm56780_a0_ltsw_flexdigest_norm_profile_destroy(
    int unit,
    int norm_profile_id)
{
    bcmgene_desc_t *gene = bcm56780_a0_flexdigest_gene[unit];
...
static int
bcm56780_a0_ltsw_flexdigest_norm_profile_set(
    int unit,
    int norm_profile_id,
    ...
    int value)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_fill_key(&hndl, 0, norm_profile_id));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_fill_field(&hndl, 0, type, value));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_fill_opcode(&hndl, BCMLT_OPCODE_UPDATE));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_commit(&hndl));
...
static int
bcm56780_a0_ltsw_flexdigest_norm_profile_get(
    int unit,
    int norm_profile_id,
    bcm_flexdigest_norm_profile_control_t type,
    int *value)
...
static int
bcm56780_a0_ltsw_flexdigest_norm_profile_configured(
    int unit,
    int norm_profile_id)
{
    bcmgene_desc_t *gene = bcm56780_a0_flexdigest_gene[unit];
...
static int
bcm56780_a0_ltsw_flexdigest_lkup_entry_allocate(
    int unit,
    bcmint_flexdigest_entry_info_t *einfo)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_handle_create(hndl));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_fill_key(hndl, 0, einfo->id));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_fill_key(hndl, 1, einfo->group_prio));
...
static int
bcm56780_a0_ltsw_flexdigest_lkup_entry_free(
    int unit,
    bcmint_flexdigest_entry_info_t *einfo)
{
    bcmgene_handle_t *hndl = NULL;
    ...
    if (hndl) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56780_a0_gene_handle_destroy(hndl));
        SHR_FREE(hndl);
        einfo->handle = NULL;
    }
...
static int
bcm56780_a0_ltsw_flexdigest_lkup_entry_pri_set(
    int unit,
    bcmint_flexdigest_entry_info_t *einfo,
    int prio)
{
    ...
    value = prio;
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_fill_field(hndl, 0, 0, value));
...
exit:
    if (SHR_FUNC_ERR()) {
        (void)bcm56780_a0_ltsw_flexdigest_lkup_entry_free(unit, einfo);
    }
    SHR_FUNC_EXIT();
}

static int
bcm56780_a0_ltsw_flexdigest_lkup_entry_match_add(
    int unit,
    bcmint_flexdigest_entry_info_t *einfo,
    bcm_flexdigest_match_t match)
{
    ...
    value = 1;
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_fill_field(hndl, 1, match, value));
    LOG_DEBUG(BSL_LOG_MODULE,
            (BSL_META_U(unit,
...
static int
bcm56780_a0_ltsw_flexdigest_lkup_entry_qualifier_add(
    int unit,
    bcmint_flexdigest_entry_info_t *einfo,
    bcm_flexdigest_qualify_t qualifier,
    uint16_t data,
    uint16_t mask)
{
    ...
    value = data;
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_fill_field(hndl, 2, offset, value));
    LOG_DEBUG(BSL_LOG_MODULE,
            (BSL_META_U(unit,
    ...
    value = mask;
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_fill_field(hndl, blk, offset, value));
    LOG_DEBUG(BSL_LOG_MODULE,
            (BSL_META_U(unit,
                        "FD(unit %d) Qualifier [%"PRId32",%"PRId32"] "
                        "add mask: %"PRIu64"\n"),
...
static int
bcm56780_a0_ltsw_flexdigest_lkup_entry_action_add(
    int unit,
    bcmint_flexdigest_entry_info_t *einfo,
    bcm_flexdigest_action_t action,
    uint16_t param0,
    uint16_t param1)
{
    ...
    case bcmFlexDigestActionExtractBinSetACmds15:
        ...
        value = param0;
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56780_a0_gene_fill_field_array(hndl, blk, offset,
                                               idx, &value, 1));
        LOG_DEBUG(BSL_LOG_MODULE,
                (BSL_META_U(unit,
    ...
    case bcmFlexDigestActionExtractBinSetCCmds15:
        ...
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56780_a0_gene_fill_callback(hndl, fd_lkup_action_add_cb));

        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56780_a0_gene_fill_flags(hndl, BCMGENE_F_HANDLE_CALLBACK));

        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56780_a0_gene_fill_field(hndl, blk, offset, value));

        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56780_a0_gene_fill_flags(hndl, 0));
...
static int
bcm56780_a0_ltsw_flexdigest_lkup_entry_mask_profile_restore(
    int unit,
    bcmint_flexdigest_entry_info_t *einfo)
{
    bcmgene_handle_t *hndl = NULL;
...
static int
bcm56780_a0_ltsw_flexdigest_lkup_entry_insert(
    int unit,
    bcmint_flexdigest_entry_info_t *einfo)
{
    bcmgene_handle_t *hndl = NULL;
...
static int
bcm56780_a0_ltsw_flexdigest_lkup_entry_update(
    int unit,
    bcmint_flexdigest_entry_info_t *einfo)
{
    bcmgene_handle_t *hndl = NULL;
...
static int
bcm56780_a0_ltsw_flexdigest_lkup_entry_lookup(
    int unit,
    bcmint_flexdigest_entry_info_t *einfo)
{
    bcmgene_handle_t *hndl = NULL;
...
static int
bcm56780_a0_ltsw_flexdigest_lkup_entry_delete(
    int unit,
    bcmint_flexdigest_entry_info_t *einfo)
{
    bcmgene_handle_t *hndl = NULL;
...
static int
bcm56780_a0_ltsw_flexdigest_lkup_entry_unset(
    int unit,
    bcmint_flexdigest_entry_info_t *einfo)
{
    bcmgene_handle_t *hndl = NULL;
...
static int
bcm56780_a0_ltsw_flexdigest_lkup_group_update_presel(
    int unit,
    bcm_flexdigest_qset_t qset)
{
    bcmgene_desc_t *gene = bcm56780_a0_flexdigest_gene[unit];
    ...
    for (i = 0; i < bcmFlexDigestQualifyCount; i++) {
        if (BCM_FLEXDIGEST_QSET_TEST(qset, i)) {
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56780_a0_gene_fill_field(&hndl, 0, i, 1));
        } else {
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56780_a0_gene_fill_flags(&hndl, BCMGENE_F_HANDLE_GRACEFUL));
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56780_a0_gene_fill_field(&hndl, 0, i, 0));
        }
    }
...
static int
bcm56780_a0_ltsw_flexdigest_hash_profile_create(
    int unit,
    int hash_profile_id)
{
    bcmgene_desc_t *gene = bcm56780_a0_flexdigest_gene[unit];
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_handle_create(&hndl));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_fill_key(&hndl, 0, hash_profile_id));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_fill_opcode(&hndl, BCMLT_OPCODE_INSERT));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_commit(&hndl));
...
static int
bcm56780_a0_ltsw_flexdigest_hash_profile_destroy(
    int unit,
    int hash_profile_id)
{
    bcmgene_desc_t *gene = bcm56780_a0_flexdigest_gene[unit];
...
static int
bcm56780_a0_ltsw_flexdigest_hash_profile_set(
    int unit,
    int hash_profile_id,
    bcm_flexdigest_hash_profile_control_t type,
    int value)
...
static int
bcm56780_a0_ltsw_flexdigest_hash_profile_get(
    int unit,
    int hash_profile_id,
    bcm_flexdigest_hash_profile_control_t type,
    int *value)
...
static int
bcm56780_a0_ltsw_flexdigest_hash_profile_configured(
    int unit,
    int hash_profile_id)
{
    bcmgene_desc_t *gene = bcm56780_a0_flexdigest_gene[unit];
...
static int
bcm56780_a0_ltsw_flexdigest_hash_salt_set(
    int unit,
    ...
    uint16_t *salt_array)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_handle_create(&hndl));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_fill_field_array(&hndl, 0, bin_set,
                                           0, value, array_size));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_edit(&hndl));
...
static int
bcm56780_a0_ltsw_flexdigest_hash_salt_get(
    int unit,
    bcm_flexdigest_hash_bin_set_t bin_set,
    int array_size,
    uint16_t *salt_array,
    int *count)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_lookup(&hndl));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_gene_lookup_field_array(&hndl, 0, bin_set,
                                             0, value, array_size,
                                             &depth));
    for (i = 0; i < array_size; i++) {
...
static int
bcm56780_a0_ltsw_flexdigest_control_set(
    int unit,
    bcm_flexdigest_control_t type,
    int arg)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (fd_global_control_set(unit, type, arg));
...
static int
bcm56780_a0_ltsw_flexdigest_control_get(
    int unit,
    bcm_flexdigest_control_t type,
    int *arg)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (fd_global_control_get(unit, type, arg));
...
/*!
 * \brief Flexdigest driver function variable for bcm56780_a0 device.
 */
static mbcm_ltsw_flexdigest_drv_t bcm56780_a0_ltsw_flexdigest_drv = {
    .flexdigest_db_init = bcm56780_a0_ltsw_flexdigest_db_init,
    .flexdigest_db_deinit = bcm56780_a0_ltsw_flexdigest_db_deinit,
    .flexdigest_init = bcm56780_a0_ltsw_flexdigest_init,
    .flexdigest_deinit = bcm56780_a0_ltsw_flexdigest_deinit,
    .flexdigest_feature_get = bcm56780_a0_ltsw_flexdigest_feature_get,
    .flexdigest_info_get = bcm56780_a0_ltsw_flexdigest_info_get,
    .flexdigest_validate_lkup_match = bcm56780_a0_ltsw_flexdigest_validate_lkup_match,
    .flexdigest_validate_lkup_match_conflict = bcm56780_a0_ltsw_flexdigest_validate_lkup_match_conflict,
    .flexdigest_validate_lkup_action = bcm56780_a0_ltsw_flexdigest_validate_lkup_action,
    .flexdigest_validate_lkup_action_params = bcm56780_a0_ltsw_flexdigest_validate_lkup_action_params,
    .flexdigest_validate_lkup_qualifier = bcm56780_a0_ltsw_flexdigest_validate_lkup_qualifier,
    .flexdigest_validate_lkup_group_qset = bcm56780_a0_ltsw_flexdigest_validate_lkup_group_qset,
    .flexdigest_validate_hash_profile = bcm56780_a0_ltsw_flexdigest_validate_hash_profile,
    .flexdigest_norm_seed_profile_create = bcm56780_a0_ltsw_flexdigest_norm_seed_profile_create,
    .flexdigest_norm_seed_profile_destroy = bcm56780_a0_ltsw_flexdigest_norm_seed_profile_destroy,
    .flexdigest_norm_seed_profile_set = bcm56780_a0_ltsw_flexdigest_norm_seed_profile_set,
    .flexdigest_norm_seed_profile_get = bcm56780_a0_ltsw_flexdigest_norm_seed_profile_get,
    .flexdigest_norm_seed_profile_configured = bcm56780_a0_ltsw_flexdigest_norm_seed_profile_configured,
    .flexdigest_norm_profile_create = bcm56780_a0_ltsw_flexdigest_norm_profile_create,
    .flexdigest_norm_profile_destroy = bcm56780_a0_ltsw_flexdigest_norm_profile_destroy,
    .flexdigest_norm_profile_set = bcm56780_a0_ltsw_flexdigest_norm_profile_set,
    .flexdigest_norm_profile_get = bcm56780_a0_ltsw_flexdigest_norm_profile_get,
    .flexdigest_norm_profile_configured = bcm56780_a0_ltsw_flexdigest_norm_profile_configured,
    .flexdigest_lkup_entry_allocate = bcm56780_a0_ltsw_flexdigest_lkup_entry_allocate,
    .flexdigest_lkup_entry_free = bcm56780_a0_ltsw_flexdigest_lkup_entry_free,
    .flexdigest_lkup_entry_pri_set = bcm56780_a0_ltsw_flexdigest_lkup_entry_pri_set,
    .flexdigest_lkup_entry_match_add = bcm56780_a0_ltsw_flexdigest_lkup_entry_match_add,
    .flexdigest_lkup_entry_qualifier_add = bcm56780_a0_ltsw_flexdigest_lkup_entry_qualifier_add,
    .flexdigest_lkup_entry_action_add = bcm56780_a0_ltsw_flexdigest_lkup_entry_action_add,
    .flexdigest_lkup_entry_mask_profile_restore = bcm56780_a0_ltsw_flexdigest_lkup_entry_mask_profile_restore,
    .flexdigest_lkup_entry_insert = bcm56780_a0_ltsw_flexdigest_lkup_entry_insert,
    .flexdigest_lkup_entry_update = bcm56780_a0_ltsw_flexdigest_lkup_entry_update,
    .flexdigest_lkup_entry_lookup = bcm56780_a0_ltsw_flexdigest_lkup_entry_lookup,
    .flexdigest_lkup_entry_delete = bcm56780_a0_ltsw_flexdigest_lkup_entry_delete,
    .flexdigest_lkup_entry_unset = bcm56780_a0_ltsw_flexdigest_lkup_entry_unset,
    .flexdigest_lkup_group_update_presel = bcm56780_a0_ltsw_flexdigest_lkup_group_update_presel,
    .flexdigest_hash_profile_create = bcm56780_a0_ltsw_flexdigest_hash_profile_create,
    .flexdigest_hash_profile_destroy = bcm56780_a0_ltsw_flexdigest_hash_profile_destroy,
    .flexdigest_hash_profile_set = bcm56780_a0_ltsw_flexdigest_hash_profile_set,
    .flexdigest_hash_profile_get = bcm56780_a0_ltsw_flexdigest_hash_profile_get,
    .flexdigest_hash_profile_configured = bcm56780_a0_ltsw_flexdigest_hash_profile_configured,
    .flexdigest_hash_salt_set = bcm56780_a0_ltsw_flexdigest_hash_salt_set,
    .flexdigest_hash_salt_get = bcm56780_a0_ltsw_flexdigest_hash_salt_get,
    .flexdigest_control_set = bcm56780_a0_ltsw_flexdigest_control_set,
    .flexdigest_control_get = bcm56780_a0_ltsw_flexdigest_control_get
};
...
int
bcm56780_a0_ltsw_flexdigest_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_flexdigest_drv_set(unit, &bcm56780_a0_ltsw_flexdigest_drv));
