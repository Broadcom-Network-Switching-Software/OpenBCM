...
static bcmgene_desc_t *bcm56780_a0_l3_aacl_gene[BCM_MAX_NUM_UNITS];
...
l3_aacl_db_init(int unit)
{
    ...
    gene = bcm56780_a0_gene_extractor(unit, "AACL");

    if (!gene) {
        SHR_VERBOSE_EXIT(SHR_E_UNAVAIL);
    }

    bcm56780_a0_l3_aacl_gene[unit] = gene;
...
l3_aacl_db_deinit(int unit)
{
    ...
    if (bcm56780_a0_l3_aacl_gene[unit]) {
        bcm56780_a0_l3_aacl_gene[unit] = NULL;
    }
    SHR_EXIT();
...
{
    bcmgene_desc_t *gene = bcm56780_a0_l3_aacl_gene[unit];
...
l3_aacl_validate(int unit, bcm_l3_aacl_t *aacl)
{
    ...
    SHR_IF_ERR_EXIT
        (bcm56780_a0_gene_lookup_field(&hndl, 0, 0, &value));
    ...
    bcm_l3_aacl_t *aacl)
{
    ...
    if (aacl->flags & BCM_L3_AACL_FLAGS_IP6) {
        if (!bcmi_ltsw_property_get(unit, BCMI_CPN_IPV6_LPM_128B_ENABLE, 1) &&
            ...
            SHR_IF_ERR_EXIT
                (bcm56780_a0_gene_error_return(hndl, SHR_E_RESOURCE));
        }
        if (bcm_ip6_mask_length(aacl->ip6_mask) == 0 &&
            sal_memcmp(aacl->ip6, ip6_zero, BCM_IP6_ADDRLEN) != 0) {
            SHR_IF_ERR_EXIT
                (bcm56780_a0_gene_error_return(hndl, SHR_E_PARAM));
        }
        ...
        SHR_IF_ERR_EXIT
            (bcm56780_a0_gene_fill_key(hndl, index++, value));
        value = ip6_mask[0];
        SHR_IF_ERR_EXIT
            (bcm56780_a0_gene_fill_key(hndl, index++, value));
    ...
    void *user_data)
{
    ...
    if (ud->trav_fn) {
        ...
        if (flags & BCM_L3_AACL_FLAGS_IP6) {
            SHR_IF_ERR_EXIT
                (bcm56780_a0_gene_lookup_key(hndl, index++, &ip6[0]));
            SHR_IF_ERR_EXIT
                (bcm56780_a0_gene_lookup_key(hndl, index++, &ip6_mask[0]));
            SHR_IF_ERR_EXIT
                (bcm56780_a0_gene_lookup_key(hndl, index++, &ip6[1]));
            SHR_IF_ERR_EXIT
                (bcm56780_a0_gene_lookup_key(hndl, index++, &ip6_mask[1]));
            bcmi_ltsw_util_uint64_to_ip6(&(aacl.ip6), ip6);
            bcmi_ltsw_util_uint64_to_ip6(&(aacl.ip6_mask), ip6_mask);
        } else {
            SHR_IF_ERR_EXIT
                (bcm56780_a0_gene_lookup_key(hndl, index++, &value));
    ...
    void *user_data)
{
    ...
    SHR_IF_ERR_EXIT
        (bcm56780_a0_gene_fill_callback(hndl, l3_aacl_traverse_cb));
    SHR_IF_ERR_EXIT
        (bcm56780_a0_gene_traverse(hndl, user_data));
...
static int
bcm56780_a0_ltsw_l3_aacl_init(int unit)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56780_a0_ltsw_l3_aacl_deinit(int unit)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56780_a0_ltsw_l3_aacl_validate(
    int unit,
    bcm_l3_aacl_t *aacl,
    bool strict)
{
    ...
    bcm_l3_aacl_t *aacl)
{
    ...
    SHR_IF_ERR_EXIT
        (bcm56780_a0_gene_fill_field(&hndl, 0, 0, aacl->class_id));
    ...
    SHR_IF_ERR_EXIT
        (bcm56780_a0_gene_fill_opcode(&hndl, opcode));
    SHR_IF_ERR_EXIT
...
static int
bcm56780_a0_ltsw_l3_aacl_delete(
    int unit,
    bcm_l3_aacl_t *aacl)
{
    bcmgene_desc_t *gene = bcm56780_a0_l3_aacl_gene[unit];
...
static int
bcm56780_a0_ltsw_l3_aacl_delete_all(
    int unit,
    bcm_l3_aacl_t *aacl)
{
    bcmgene_desc_t *gene = bcm56780_a0_l3_aacl_gene[unit];
    ...
    if (aacl == NULL) {
        ...
        SHR_IF_ERR_EXIT
            (bcm56780_a0_gene_targeting(unit, gene,
                                        ...
                                        &hndl));
        SHR_IF_ERR_EXIT
            (bcm56780_a0_gene_clear_handle(&hndl));
    }
...
static int
bcm56780_a0_ltsw_l3_aacl_traverse(
    int unit,
    bcm_l3_aacl_traverse_cb trav_fn,
    void *user_data)
{
    ...
    SHR_IF_ERR_EXIT
        (bcm56780_a0_gene_func_traverse(unit, gene,
...
static int
bcm56780_a0_ltsw_l3_aacl_matched_traverse(
    int unit,
    uint32_t flags,
    bcm_l3_aacl_traverse_cb trav_fn,
    void *user_data)
...
static mbcm_ltsw_l3_aacl_drv_t bcm56780_a0_ltsw_l3_aacl_drv = {
    .l3_aacl_init = bcm56780_a0_ltsw_l3_aacl_init,
    .l3_aacl_deinit = bcm56780_a0_ltsw_l3_aacl_deinit,
    .l3_aacl_validate = bcm56780_a0_ltsw_l3_aacl_validate,
    .l3_aacl_add = bcm56780_a0_ltsw_l3_aacl_add,
    .l3_aacl_delete = bcm56780_a0_ltsw_l3_aacl_delete,
    .l3_aacl_delete_all = bcm56780_a0_ltsw_l3_aacl_delete_all,
    .l3_aacl_find = bcm56780_a0_ltsw_l3_aacl_find,
    .l3_aacl_traverse = bcm56780_a0_ltsw_l3_aacl_traverse,
    .l3_aacl_matched_traverse = bcm56780_a0_ltsw_l3_aacl_matched_traverse
};
