...
/*!
 * \brief VLAN driver function variable for bcm56780_a0 device.
 */
static mbcm_ltsw_vlan_drv_t bcm56780_a0_ltsw_vlan_drv = {
    /* vlan init. */
    ...
    /*! Traverse vlan table. */
    .vlan_traverse = xfs_ltsw_vlan_traverse,
...
int
bcm56780_a0_ltsw_vlan_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_vlan_drv_set(unit, &bcm56780_a0_ltsw_vlan_drv));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_ltsw_variant_drv_attach(unit, BCM56780_A0_LTSW_VARIANT_VLAN));
exit:
    SHR_FUNC_EXIT();
}
