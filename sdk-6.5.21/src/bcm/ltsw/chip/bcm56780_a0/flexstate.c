 ...
 */
static bcmint_flexstate_enum_map_t bcm56780_a0_ltsw_flexstate_action_mode_enum[] = {
    { NORMALs, bcmFlexstateCounterModeNormal },
    { WIDEs, bcmFlexstateCounterModeWide },
    { NORMAL_DOUBLEs, bcmFlexstateCounterModeHalf },
};

/*!
 * \brief Flex state action source enumeration mapping.
 */
static bcmint_flexstate_enum_map_t bcm56780_a0_ltsw_flexstate_action_source_enum[] = {
    { NOOPs, bcmFlexstateValueSelectCounterValue },
    { USE_PAIRED_COUNTERs, bcmFlexstateValueSelectPairedCounter },
    { USE_PKTLENs, bcmFlexstateValueSelectPacketLength },
};

/*!
 * \brief Flex state action scale enumeration mapping.
 */
static bcmint_flexstate_enum_map_t bcm56780_a0_ltsw_flexstate_action_scale_enum[] = {
    ...
    { SCALE_134_MSECs, bcmFlexstateTriggerInterval100ms },
    { SCALE_1_SECs, bcmFlexstateTriggerInterval1s },
    { SCALE_8_SECs, bcmFlexstateTriggerInterval10s },
};

/*!
 * \brief Flex state quantization object enumeration mapping.
 */
static bcmint_flexstate_enum_map_t bcm56780_a0_ltsw_flexstate_quant_object_enum[] = {
    { USE_RANGE_CHK_1s, 0x0 },
    { USE_RANGE_CHK_2s, 0x1 },
    { USE_RANGE_CHK_3s, 0x2 },
    { USE_RANGE_CHK_4s, 0x3 },
    { USE_OBJ_5s, 0x4 },        /* Global object (cannot be quantized). */
    { USE_OBJ_6s, 0x5 },        /* Global object (cannot be quantized). */
};

/*!
 * \brief Flex state value update compare enumeration mapping.
 */
static bcmint_flexstate_enum_map_t bcm56780_a0_ltsw_flexstate_update_comp_enum[] = {
    ...
    { ANDs, bcmFlexstateUpdateCompareCheckAllBits },
    { CHECK_BITs, bcmFlexstateUpdateCompareCheckOneBit },
    { CHECK_ORs, bcmFlexstateUpdateCompareCheckAnyBits },
};

/*!
 * \brief Flex state value update mode enumeration mapping.
 */
static bcmint_flexstate_enum_map_t bcm56780_a0_ltsw_flexstate_update_mode_enum[] = {
    ...
    { CLRBITs, bcmFlexstateValueOperationTypeClearBit },
    { XORBITs, bcmFlexstateValueOperationTypeXorBit },
};

/*!
 * \brief Flex state value update source enumeration mapping.
 */
static bcmint_flexstate_enum_map_t bcm56780_a0_ltsw_flexstate_update_source_enum[] = {
    { NOOPs, bcmFlexstateUpdateSourceUpdatedCompareResult },
    { OLD_VALUEs, bcmFlexstateUpdateSourceOldValue },
    { CVALUEs, bcmFlexstateUpdateSourceComputedCompareValue },
    { CVALUE_COMPAREs, bcmFlexstateUpdateSourceComputedCompareResult },
};
...
static int
bcm56780_a0_ltsw_flexstate_action_mode_validate(
    int unit,
    int val)
{
    ...
    count = COUNTOF(bcm56780_a0_ltsw_flexstate_action_mode_enum);
    action_mode_db = bcm56780_a0_ltsw_flexstate_action_mode_enum;
...
static int
bcm56780_a0_ltsw_flexstate_action_mode_enum_map_get(
    int unit,
    ...
    uint32_t *count)
{
    ...
    *map = bcm56780_a0_ltsw_flexstate_action_mode_enum;
    *count = COUNTOF(bcm56780_a0_ltsw_flexstate_action_mode_enum);
...
static int
bcm56780_a0_ltsw_flexstate_action_source_validate(
    int unit,
    int val)
{
    ...
    count = COUNTOF(bcm56780_a0_ltsw_flexstate_action_source_enum);
    action_source_db = bcm56780_a0_ltsw_flexstate_action_source_enum;
...
static int
bcm56780_a0_ltsw_flexstate_action_source_enum_map_get(
    int unit,
    const bcmint_flexstate_enum_map_t **map,
    uint32_t *count)
{
    ...
    *map = bcm56780_a0_ltsw_flexstate_action_source_enum;
    *count = COUNTOF(bcm56780_a0_ltsw_flexstate_action_source_enum);
...
static int
bcm56780_a0_ltsw_flexstate_trigger_interval_validate(
    int unit,
    int val)
{
    ...
    count = COUNTOF(bcm56780_a0_ltsw_flexstate_action_scale_enum);
    interval_db = bcm56780_a0_ltsw_flexstate_action_scale_enum;
...
static int
bcm56780_a0_ltsw_flexstate_action_scale_enum_map_get(
    int unit,
    const bcmint_flexstate_enum_map_t **map,
    uint32_t *count)
{
    ...
    *map = bcm56780_a0_ltsw_flexstate_action_scale_enum;
    *count = COUNTOF(bcm56780_a0_ltsw_flexstate_action_scale_enum);
    return SHR_E_NONE;
}

static int
bcm56780_a0_ltsw_flexstate_quant_object_enum_map_get(
    int unit,
    const bcmint_flexstate_enum_map_t **map,
    uint32_t *count)
{
    ...
    *map = bcm56780_a0_ltsw_flexstate_quant_object_enum;
    *count = COUNTOF(bcm56780_a0_ltsw_flexstate_quant_object_enum);

    return SHR_E_NONE;
}

static int
bcm56780_a0_ltsw_flexstate_update_comp_validate(
    int unit,
    int val)
{
    ...
    count = COUNTOF(bcm56780_a0_ltsw_flexstate_update_comp_enum);
    update_comp_db = bcm56780_a0_ltsw_flexstate_update_comp_enum;
...
static int
bcm56780_a0_ltsw_flexstate_update_comp_enum_map_get(
    int unit,
    const bcmint_flexstate_enum_map_t **map,
    uint32_t *count)
{
    ...
    *map = bcm56780_a0_ltsw_flexstate_update_comp_enum;
    *count = COUNTOF(bcm56780_a0_ltsw_flexstate_update_comp_enum);
...
static int
bcm56780_a0_ltsw_flexstate_update_mode_validate(
    int unit,
    int val)
{
    ...
    count = COUNTOF(bcm56780_a0_ltsw_flexstate_update_mode_enum);
    update_mode_db = bcm56780_a0_ltsw_flexstate_update_mode_enum;
...
static int
bcm56780_a0_ltsw_flexstate_update_mode_enum_map_get(
    int unit,
    const bcmint_flexstate_enum_map_t **map,
    uint32_t *count)
{
    ...
    *map = bcm56780_a0_ltsw_flexstate_update_mode_enum;
    *count = COUNTOF(bcm56780_a0_ltsw_flexstate_update_mode_enum);
...
static int
bcm56780_a0_ltsw_flexstate_update_source_validate(
    int unit,
    int val)
{
    bcmint_flexstate_enum_map_t *update_source_db, *em;
    size_t i, count;

    count = COUNTOF(bcm56780_a0_ltsw_flexstate_update_source_enum);
    update_source_db = bcm56780_a0_ltsw_flexstate_update_source_enum;

    if (val < bcmFlexstateUpdateSourceUpdatedCompareResult ||
        val >= bcmFlexstateUpdateSourceCount) {
        LOG_ERROR(BSL_LOG_MODULE,
                  (BSL_META_U(unit, "Invalid value update source %d\n"), val));
        return SHR_E_PARAM;
    }

    for (i = 0; i < count; i++) {
        em = &(update_source_db[i]);
        if (val == em->val) {
            break;
        }
    }
    ...
    if (i >= count) {
        LOG_INFO(BSL_LOG_MODULE,
                 (BSL_META_U(unit, "Flex state value update source %d "
                                   "not found\n"), val));
...
static int
bcm56780_a0_ltsw_flexstate_update_source_enum_map_get(
    int unit,
    const bcmint_flexstate_enum_map_t **map,
    uint32_t *count)
{
    ...
    *map = bcm56780_a0_ltsw_flexstate_update_source_enum;
    *count = COUNTOF(bcm56780_a0_ltsw_flexstate_update_source_enum);
...
static mbcm_ltsw_flexstate_drv_t bcm56780_a0_ltsw_flexstate_drv = {
    ...
    .flexstate_action_mode_validate = bcm56780_a0_ltsw_flexstate_action_mode_validate,
    .flexstate_action_mode_enum_map_get = bcm56780_a0_ltsw_flexstate_action_mode_enum_map_get,
    .flexstate_action_source_validate = bcm56780_a0_ltsw_flexstate_action_source_validate,
    .flexstate_action_source_enum_map_get = bcm56780_a0_ltsw_flexstate_action_source_enum_map_get,
    .flexstate_trigger_interval_validate = bcm56780_a0_ltsw_flexstate_trigger_interval_validate,
    .flexstate_action_scale_enum_map_get = bcm56780_a0_ltsw_flexstate_action_scale_enum_map_get,
    .flexstate_quant_object_enum_map_get = bcm56780_a0_ltsw_flexstate_quant_object_enum_map_get,
    .flexstate_update_comp_validate = bcm56780_a0_ltsw_flexstate_update_comp_validate,
    .flexstate_update_comp_enum_map_get = bcm56780_a0_ltsw_flexstate_update_comp_enum_map_get,
    .flexstate_update_mode_validate = bcm56780_a0_ltsw_flexstate_update_mode_validate,
    .flexstate_update_mode_enum_map_get = bcm56780_a0_ltsw_flexstate_update_mode_enum_map_get,
    .flexstate_update_source_validate = bcm56780_a0_ltsw_flexstate_update_source_validate,
    .flexstate_update_source_enum_map_get = bcm56780_a0_ltsw_flexstate_update_source_enum_map_get
};
