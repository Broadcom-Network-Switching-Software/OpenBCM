...
/*
 * Function:
 *      bcm56780_time_synce_clock_source_freq_cal
 * Purpose:
 ...
 */
static int
bcm56780_time_synce_div_to_freq(
    int unit,
 ...
 */
static int
bcm56780_time_synce_freq_to_div(
    int unit,
    bcm_time_synce_clock_source_config_t *clk_src_cfg,
...
static int
bcm56780_a0_ltsw_time_init(int unit)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56780_a0_ltsw_time_deinit(int unit)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56780_a0_ltsw_time_synce_clock_set(
    int unit,
...
static int
bcm56780_a0_ltsw_time_synce_clock_get(
    int unit,
    bcm_time_synce_clock_src_type_t clk_src,
    bcm_time_synce_divisor_setting_t *divisor)
{
...
static int
bcm56780_a0_ltsw_time_synce_clock_source_control_set(
    int unit,
...
static int
bcm56780_a0_ltsw_time_synce_clock_source_control_get(
    int unit,
    bcm_time_synce_clock_source_config_t *clk_src_config,
    bcm_time_synce_clock_source_control_t control,
    int *value)
...
static int
bcm56780_a0_ltsw_time_port_timesync_config_set(
    int unit,
    bcm_port_t port,
    int config_count,
...
static int
bcm56780_a0_ltsw_time_port_timesync_config_get(
    int unit,
    bcm_port_t port,
    int config_count,
    bcm_port_timesync_config_t *config_array,
...
static int
bcm56780_a0_ltsw_time_switch_control_set(
    int unit,
...
static int
bcm56780_a0_ltsw_time_switch_control_get(
    int unit,
    bcm_switch_control_t type,
    int *arg)
{
...
static int
bcm56780_a0_ltsw_time_switch_control_port_set(
    int unit,
    bcm_port_t port,
    bcm_switch_control_t type,
    int arg)
...
static int
bcm56780_a0_ltsw_time_switch_control_port_get(
    int unit,
    bcm_port_t port,
    bcm_switch_control_t type,
    int *arg)
...
static int
bcm56780_a0_ltsw_time_timesync_config_profile_create(
    int unit,
    ...
    int *profile_id)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (xfs_ltsw_time_timesync_config_profile_create(unit, profile, profile_id));
...
static int
bcm56780_a0_ltsw_time_timesync_config_profile_destroy(
    int unit,
    int profile_id)
{
    SHR_FUNC_ENTER(unit);
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (xfs_ltsw_time_timesync_config_profile_destroy(unit, profile_id));
...
static int
bcm56780_a0_ltsw_time_timesync_config_profile_get(
    int unit,
    int profile_id,
    bcm_time_timesync_config_profile_t *profile)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (xfs_ltsw_time_timesync_config_profile_get(unit, profile_id, profile));
...
/*!
 * \brief Time driver function variable for bcm56780_a0 device.
 */
static mbcm_ltsw_time_drv_t bcm56780_a0_ltsw_time_drv = {
    .time_init = bcm56780_a0_ltsw_time_init,
    .time_deinit = bcm56780_a0_ltsw_time_deinit,
    .time_synce_clock_set = bcm56780_a0_ltsw_time_synce_clock_set,
    .time_synce_clock_get = bcm56780_a0_ltsw_time_synce_clock_get,
    .time_synce_clock_source_control_set = bcm56780_a0_ltsw_time_synce_clock_source_control_set,
    .time_synce_clock_source_control_get = bcm56780_a0_ltsw_time_synce_clock_source_control_get,
    .time_tod_set = bcm56780_a0_ltsw_time_tod_set,
    .time_tod_get = bcm56780_a0_ltsw_time_tod_get,
    .time_port_timesync_config_set = bcm56780_a0_ltsw_time_port_timesync_config_set,
    .time_port_timesync_config_get = bcm56780_a0_ltsw_time_port_timesync_config_get,
    .time_switch_control_set = bcm56780_a0_ltsw_time_switch_control_set,
    .time_switch_control_get = bcm56780_a0_ltsw_time_switch_control_get,
    .time_switch_control_port_set = bcm56780_a0_ltsw_time_switch_control_port_set,
    .time_switch_control_port_get = bcm56780_a0_ltsw_time_switch_control_port_get,
    .time_timesync_config_profile_create = bcm56780_a0_ltsw_time_timesync_config_profile_create,
    .time_timesync_config_profile_destroy = bcm56780_a0_ltsw_time_timesync_config_profile_destroy,
    .time_timesync_config_profile_get = bcm56780_a0_ltsw_time_timesync_config_profile_get
};
...
int
bcm56780_a0_ltsw_time_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_time_drv_set(unit, &bcm56780_a0_ltsw_time_drv));
