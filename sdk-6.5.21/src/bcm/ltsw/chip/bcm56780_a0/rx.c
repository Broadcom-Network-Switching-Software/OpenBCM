...
static int
bcm56780_a0_ltsw_rx_cosq_mapping_extended_add(
    int unit,
    uint32 options,
...
static int
bcm56780_a0_ltsw_rx_cosq_mapping_extended_delete(
    int unit,
    bcm_rx_cosq_mapping_t *rx_cosq_mapping)
{
    rx_cosq_cpu_map_t mapping;
...
static int
bcm56780_a0_ltsw_rx_cosq_mapping_extended_delete_all(int unit)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56780_a0_ltsw_rx_cosq_mapping_extended_get(
    int unit,
    bcm_rx_cosq_mapping_t *rx_cosq_mapping)
{
    rx_cosq_cpu_map_t mapping;
...
static int
bcm56780_a0_ltsw_rx_queue_channel_get(
    int unit,
...
static int
bcm56780_a0_ltsw_rx_queue_channel_set(
    int unit,
    bcm_cos_queue_t queue_id,
    bcm_rx_chan_t chan_id)
{
...
static int
bcm56780_a0_ltsw_rx_cosq_mapping_size_get(
    int unit,
    int *size)
{
...
static int
bcm56780_a0_ltsw_rx_init(int unit)
{
...
static int
bcm56780_a0_ltsw_rx_detach(int unit)
{
...
/*!
 * \brief Rx driver function variable for bcm56780_a0 device.
 */
static mbcm_ltsw_rx_drv_t bcm56780_a0_ltsw_rx_drv = {
    .rx_cosq_mapping_extended_add = bcm56780_a0_ltsw_rx_cosq_mapping_extended_add,
    .rx_cosq_mapping_extended_delete = bcm56780_a0_ltsw_rx_cosq_mapping_extended_delete,
    .rx_cosq_mapping_extended_delete_all = bcm56780_a0_ltsw_rx_cosq_mapping_extended_delete_all,
    .rx_cosq_mapping_extended_get = bcm56780_a0_ltsw_rx_cosq_mapping_extended_get,
    .rx_queue_channel_get = bcm56780_a0_ltsw_rx_queue_channel_get,
    .rx_queue_channel_set = bcm56780_a0_ltsw_rx_queue_channel_set,
    .rx_cosq_mapping_size_get = bcm56780_a0_ltsw_rx_cosq_mapping_size_get,
    .rx_init = bcm56780_a0_ltsw_rx_init,
    .rx_detach = bcm56780_a0_ltsw_rx_detach,
};
...
int
bcm56780_a0_ltsw_rx_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_rx_drv_set(unit, &bcm56780_a0_ltsw_rx_drv));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_ltsw_variant_drv_attach(unit, BCM56780_A0_LTSW_VARIANT_RX));
