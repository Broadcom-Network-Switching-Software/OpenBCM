...
/* COSQ init. */
#define COSQ_INIT(unit) \
            (cosq_ctrl[unit].inited)

static bcmi_ltsw_cosq_device_info_t cosq_device_info[BCM_MAX_NUM_UNITS] = {{ 0 }};
 ...
 */
static int
cosq_cos_map_profile_fill(int unit, bcm_gport_t gport, bcm_cos_queue_t cosq,
                          uint32_t flags, tm_ltsw_cosq_cos_map_profile_t *profile)
{
    ...
    switch (flags) {
        ...
        case BCM_COSQ_GPORT_ELEPHANT_UCAST_QUEUE_GROUP:
            ...
            hw_cosq %= num_ucq;
            profile->uc_elephant_cos = hw_cosq;
            break;
        ...
        case (BCM_COSQ_GPORT_UCAST_QUEUE_GROUP |
            ...
            profile->mc_cos = MIN(hw_cosq, num_mcq ? num_mcq - 1 : -1);
                     ...
                     uint32_t flags, bcm_gport_t gport, bcm_cos_queue_t cosq)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (cosq_cos_map_profile_fill(unit, gport, cosq, flags,
 ...
 * \retval !SHR_E_NONE        Failure.
 *
 * \note Only supported array_max = 48
 *       When count = 48
 *       Prio Array Index Map
 *            Array Index [15-0]  : Maps Prio[15-0] to UC cos[15-0]
 *            Array Index [31-16] : Maps Prio[15-0] to MC cos[15-0]
    ...
    bcmi_ltsw_cosq_device_info_t *info)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (tm_ltsw_cosq_device_info_get(unit, info));

    info->num_sched_profile = MAX_NUM_SCHED_PROFILE;
    info->num_int_pri = COSQ_NUM_INT_PRI;
    info->num_rqe_queue = MMU_RQE_QUEUE_NUM;
    info->num_sched_node = NUM_SCHEDULER_PER_PORT;

    SHR_IF_ERR_VERBOSE_EXIT
        (tm_ltsw_cosq_mcq_mode_get(unit, &mc_q_mode));

    info->num_ucq = (mc_q_mode == 0) ? 12 : (mc_q_mode == 1) ? 10 :
                                     (mc_q_mode == 2) ? 8  : (mc_q_mode == 3) ? 6 : 8;

    info->num_mcq = (mc_q_mode == 0) ? 0 : (mc_q_mode == 1) ? 2 :
...
static int
bcm56990_a0_ltsw_cosq_init(int unit)
{
    static tm_ltsw_cosq_chip_driver_t bcm56990_a0_cosq_drv_cb = {
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (tm_ltsw_cosq_chip_driver_register(unit, &bcm56990_a0_cosq_drv_cb));
    SHR_IF_ERR_EXIT
        (cosq_device_info_init(unit, &cosq_device_info[unit]));
...
static int
bcm56990_a0_ltsw_cosq_detach(int unit)
{
    SHR_FUNC_ENTER(unit);

    COSQ_INIT(unit) = FALSE;
...
static int
bcm56990_a0_ltsw_cosq_gport_port_resolve(
    int unit,
    bcm_gport_t gport,
    bcm_gport_t *port,
    int *id)
{
    ...
    if (BCM_GPORT_IS_UCAST_QUEUE_GROUP(gport)) {
        ...
        port_out = BCM_GPORT_SCHEDULER_GET(gport) & 0xffff;
...
static int
bcm56990_a0_ltsw_cosq_port_itm_validate(
    int unit,
    int port,
    int *itm)
{
    ...
    if ((*itm >= 2) || ((*itm < 0) && (*itm != BCM_COSQ_BUFFER_ID_INVALID))) {
        SHR_ERR_EXIT(SHR_E_PARAM);
    }

    pipe = port / PORT_NUM_PER_PIPE;

    if (*itm == 0) {
        /* Check if pipe lies in pipes of ITM 0(pipe 0~3, 12~15) */
        if (((1 << pipe) & 0xF00F) != 0) {
            SHR_EXIT();
        } else {
            SHR_ERR_EXIT(SHR_E_PARAM);
        ...
        /* Check if pipe lies in pipes of ITM 1(pipe 4~11) */
        if (((1 << pipe) & 0xFF0) != 0) {
            SHR_EXIT();
        } else {
            SHR_ERR_EXIT(SHR_E_PARAM);
        }
    } else if (*itm == BCM_COSQ_BUFFER_ID_INVALID) {
        if (((1 << pipe) & 0xF00F) != 0) {
            *itm = 0;
        } else if (((1 << pipe) & 0xFF0) != 0) {
            *itm = 1;
        } else {
            SHR_ERR_EXIT(SHR_E_PARAM);
        }
...
static int
bcm56990_a0_ltsw_cosq_sw_dump(int unit)
{
    int ii;
...
static int
bcm56990_a0_ltsw_cosq_bucket_set(
    int unit,
    bcm_gport_t gport,
...
static int
bcm56990_a0_ltsw_cosq_bucket_get(
    int unit,
    bcm_gport_t gport,
    bcm_cos_queue_t cosq,
    uint32_t *min_quantum,
...
static int
bcm56990_a0_ltsw_cosq_port_detach(
    int unit,
    bcm_port_t port)
{
    cosq_port_info_t *port_info;
...
static int
bcm56990_a0_ltsw_cosq_port_attach(
    int unit,
    bcm_port_t port)
{
    cosq_port_info_t *port_info;
...
static int
bcm56990_a0_ltsw_cosq_sched_node_child_get(
    int unit,
...
static int
bcm56990_a0_ltsw_cosq_gport_get(
    int unit,
    bcm_gport_t gport,
    bcm_gport_t *port,
    int *numq,
...
static int
bcm56990_a0_ltsw_cosq_gport_child_get(
    int unit,
...
static int
bcm56990_a0_ltsw_cosq_gport_attach(
    int unit,
...
static int
bcm56990_a0_ltsw_cosq_gport_detach(
    int unit,
    bcm_gport_t input_gport,
    bcm_gport_t parent_gport,
    bcm_cos_queue_t cosq)
...
static int
bcm56990_a0_ltsw_cosq_gport_attach_get(
    int unit,
    bcm_gport_t sched_gport,
    bcm_gport_t *input_gport,
    bcm_cos_queue_t *cosq)
...
static int
bcm56990_a0_ltsw_cosq_gport_traverse(
    int unit,
...
static int
bcm56990_a0_ltsw_cosq_sched_weight_max_get(
    int unit,
    int mode,
    int *weight_max)
{
...
static int
bcm56990_a0_ltsw_cosq_schedq_mapping_set(
    int unit,
    int profile_index,
    int size,
...
static int
bcm56990_a0_ltsw_cosq_schedq_mapping_get(
    int unit,
    int profile_index,
    int array_max,
    bcm_cosq_mapping_t *cosq_mapping_arr,
...
static int
bcm56990_a0_ltsw_cosq_port_scheduler_profile_set(
    int unit,
    bcm_port_t port,
    int profile_id)
{
...
static int
bcm56990_a0_ltsw_cosq_port_scheduler_profile_get(
    int unit,
    bcm_port_t port,
    int *profile_id)
{
...
static int
bcm56990_a0_ltsw_cosq_sched_set(
    int unit,
    bcm_port_t gport,
    bcm_cos_queue_t cosq,
    int mode,
...
static int
bcm56990_a0_ltsw_cosq_sched_get(
    int unit,
    bcm_port_t gport,
    bcm_cos_queue_t cosq,
    int *mode,
...
static int
bcm56990_a0_ltsw_cosq_cosq_profile_max_num_get(
    int unit,
...
static int
bcm56990_a0_ltsw_cosq_port_sched_config_set(
    int unit,
    bcm_pbmp_t pbm,
    int mode,
    int weight_arr_size,
...
static int
bcm56990_a0_ltsw_cosq_port_sched_config_get(
    int unit,
    bcm_pbmp_t pbm,
    int weight_arr_size,
    int *weights,
...
static int
bcm56990_a0_ltsw_cosq_discard_set(
    int unit,
    uint32_t flags)
{
    bcm_pbmp_t pbmp;
...
static int
bcm56990_a0_ltsw_cosq_discard_get(
    int unit,
    uint32_t *flags)
{
    bcm_pbmp_t pbmp;
...
static int
bcm56990_a0_ltsw_cosq_gport_discard_set(
    int unit,
    bcm_gport_t gport,
    bcm_cos_queue_t cosq,
    bcm_cosq_gport_discard_t *discard)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (tm_ltsw_cosq_wred_drop_default_threshold_get(unit, NULL, &cell_field_max));
...
static int
bcm56990_a0_ltsw_cosq_gport_discard_get(
    int unit,
    bcm_gport_t gport,
    bcm_cos_queue_t cosq,
    bcm_cosq_gport_discard_t *discard)
...
static int
bcm56990_a0_ltsw_cosq_discard_profile_create(
    int unit,
    int *profile_id)
{
    int i;
...
static int
bcm56990_a0_ltsw_cosq_discard_profile_destroy(
    int unit,
    int profile_id)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56990_a0_ltsw_cosq_discard_profile_update(
    int unit,
    int profile_id,
...
static int
bcm56990_a0_ltsw_cosq_discard_profile_get(
    int unit,
    int profile_id,
    int max,
...
static int
bcm56990_a0_ltsw_cosq_cos_mapping_set(
    int unit,
    bcm_port_t local_port,
    bcm_cos_t priority,
    uint32_t flags,
...
static int
bcm56990_a0_ltsw_cosq_cos_mapping_get(
    int unit,
    bcm_port_t local_port,
    bcm_cos_t priority,
    uint32_t flags,
...
static int
bcm56990_a0_ltsw_cosq_shaper_config_get(
    int unit,
    int *refresh_time,
    int *itu_mode,
    int *shaper)
...
static int
bcm56990_a0_ltsw_cosq_field_classifier_id_create(
    int unit,
    int *classifier_id)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56990_a0_ltsw_cosq_field_classifier_id_destroy(
    int unit,
    int classifier_id)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56990_a0_ltsw_cosq_field_classifier_map_set(
    int unit,
    int classifier_id,
    int count,
    bcm_cos_t *priority_array,
...
static int
bcm56990_a0_ltsw_cosq_field_classifier_map_get(
    int unit,
    int classifier_id,
    int array_max,
    bcm_cos_t *priority_array,
...
static int
bcm56990_a0_ltsw_cosq_field_classifier_map_clear(
    int unit,
    int classifier_id)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56990_a0_ltsw_cosq_num_queue_get(
    int unit,
    int *num_ucq,
    int *num_mcq)
{
    bcmi_ltsw_cosq_device_info_t info = {0};

    SHR_FUNC_ENTER(unit);

    if (COSQ_INIT(unit)) {
        if (num_ucq != NULL) {
            *num_ucq = cosq_device_info[unit].num_ucq;
        }

        if (num_mcq != NULL) {
            *num_mcq = cosq_device_info[unit].num_mcq;
        }
    } else {
        SHR_IF_ERR_VERBOSE_EXIT
            (cosq_device_info_init(unit, &info));
        if (num_ucq != NULL) {
            *num_ucq = info.num_ucq;
        }

        if (num_mcq != NULL) {
            *num_mcq = info.num_mcq;
        }
    }
...
static int
bcm56990_a0_ltsw_cosq_port_map_info_get(
    int unit,
    bcm_port_t port,
...
static int
bcm56990_a0_ltsw_cosq_device_info_get(
    int unit,
    bcmi_ltsw_cosq_device_info_t *info)
{
    SHR_FUNC_ENTER(unit);
    ...
    if (COSQ_INIT(unit)) {
        sal_memcpy(info, &cosq_device_info[unit], sizeof(bcmi_ltsw_cosq_device_info_t));
    } else {
        SHR_IF_ERR_VERBOSE_EXIT
            (cosq_device_info_init(unit, info));
    }
...
static int
bcm56990_a0_ltsw_cosq_port_ct_mode_set(
    int unit,
    bcm_port_t port,
    int enable)
{
...
static int
bcm56990_a0_ltsw_cosq_port_ct_mode_get(
    int unit,
    bcm_port_t port,
    int *enable)
{
...
static int
bcm56990_a0_ltsw_cosq_port_asf_config_dump(
    int unit,
    bcm_port_t port,
    int port_speed)
{
...
static int
bcm56990_a0_ltsw_cosq_port_asf_config_show(
    int unit,
    bcm_port_t port,
    int port_speed)
{
...
static int
bcm56990_a0_ltsw_cosq_rx_queue_channel_get(
    int unit,
...
static int
bcm56990_a0_ltsw_cosq_rx_queue_channel_set(
    int unit,
    bcm_cos_queue_t queue_id,
    bcm_rx_chan_t chan_id,
    bool enable)
...
static int
bcm56990_a0_ltsw_cosq_rx_queue_channel_set_test(
    int unit,
    bcm_cos_queue_t queue_id,
    bcm_rx_chan_t chan_id)
{
...
static int
bcm56990_a0_ltsw_cosq_gport_traverse_by_port(
    int unit,
    bcm_gport_t port,
    bcm_cosq_gport_traverse_cb cb,
    void *user_data)
...
/*!
 * \brief Cosq driver function variable for bcm56990_a0 device.
 */
static mbcm_ltsw_cosq_drv_t bcm56990_a0_ltsw_cosq_drv = {
    .cosq_init = bcm56990_a0_ltsw_cosq_init,
    .cosq_detach = bcm56990_a0_ltsw_cosq_detach,
    .cosq_gport_port_resolve = bcm56990_a0_ltsw_cosq_gport_port_resolve,
    .cosq_port_itm_validate = bcm56990_a0_ltsw_cosq_port_itm_validate,
    .cosq_sw_dump = bcm56990_a0_ltsw_cosq_sw_dump,
    .cosq_bucket_set = bcm56990_a0_ltsw_cosq_bucket_set,
    .cosq_bucket_get = bcm56990_a0_ltsw_cosq_bucket_get,
    .cosq_port_detach = bcm56990_a0_ltsw_cosq_port_detach,
    .cosq_port_attach = bcm56990_a0_ltsw_cosq_port_attach,
    .cosq_sched_node_child_get = bcm56990_a0_ltsw_cosq_sched_node_child_get,
    .cosq_gport_get = bcm56990_a0_ltsw_cosq_gport_get,
    .cosq_gport_child_get = bcm56990_a0_ltsw_cosq_gport_child_get,
    .cosq_gport_attach = bcm56990_a0_ltsw_cosq_gport_attach,
    .cosq_gport_detach = bcm56990_a0_ltsw_cosq_gport_detach,
    .cosq_gport_attach_get = bcm56990_a0_ltsw_cosq_gport_attach_get,
    .cosq_gport_traverse = bcm56990_a0_ltsw_cosq_gport_traverse,
    .cosq_sched_weight_max_get = bcm56990_a0_ltsw_cosq_sched_weight_max_get,
    .cosq_schedq_mapping_set = bcm56990_a0_ltsw_cosq_schedq_mapping_set,
    .cosq_schedq_mapping_get = bcm56990_a0_ltsw_cosq_schedq_mapping_get,
    .cosq_port_scheduler_profile_set = bcm56990_a0_ltsw_cosq_port_scheduler_profile_set,
    .cosq_port_scheduler_profile_get = bcm56990_a0_ltsw_cosq_port_scheduler_profile_get,
    .cosq_sched_set = bcm56990_a0_ltsw_cosq_sched_set,
    .cosq_sched_get = bcm56990_a0_ltsw_cosq_sched_get,
    .cosq_cosq_profile_max_num_get = bcm56990_a0_ltsw_cosq_cosq_profile_max_num_get,
    .cosq_port_sched_config_set = bcm56990_a0_ltsw_cosq_port_sched_config_set,
    .cosq_port_sched_config_get = bcm56990_a0_ltsw_cosq_port_sched_config_get,
    .cosq_discard_set = bcm56990_a0_ltsw_cosq_discard_set,
    .cosq_discard_get = bcm56990_a0_ltsw_cosq_discard_get,
    .cosq_gport_discard_set = bcm56990_a0_ltsw_cosq_gport_discard_set,
    .cosq_gport_discard_get = bcm56990_a0_ltsw_cosq_gport_discard_get,
    .cosq_discard_profile_create = bcm56990_a0_ltsw_cosq_discard_profile_create,
    .cosq_discard_profile_destroy = bcm56990_a0_ltsw_cosq_discard_profile_destroy,
    .cosq_discard_profile_update = bcm56990_a0_ltsw_cosq_discard_profile_update,
    .cosq_discard_profile_get = bcm56990_a0_ltsw_cosq_discard_profile_get,
    .cosq_cos_mapping_set = bcm56990_a0_ltsw_cosq_cos_mapping_set,
    .cosq_cos_mapping_get = bcm56990_a0_ltsw_cosq_cos_mapping_get,
    .cosq_shaper_config_get = bcm56990_a0_ltsw_cosq_shaper_config_get,
    .cosq_field_classifier_id_create = bcm56990_a0_ltsw_cosq_field_classifier_id_create,
    .cosq_field_classifier_id_destroy = bcm56990_a0_ltsw_cosq_field_classifier_id_destroy,
    .cosq_field_classifier_map_set = bcm56990_a0_ltsw_cosq_field_classifier_map_set,
    .cosq_field_classifier_map_get = bcm56990_a0_ltsw_cosq_field_classifier_map_get,
    .cosq_field_classifier_map_clear = bcm56990_a0_ltsw_cosq_field_classifier_map_clear,
    .cosq_num_queue_get = bcm56990_a0_ltsw_cosq_num_queue_get,
    .cosq_port_map_info_get = bcm56990_a0_ltsw_cosq_port_map_info_get,
    .cosq_device_info_get = bcm56990_a0_ltsw_cosq_device_info_get,
    .cosq_port_ct_mode_set = bcm56990_a0_ltsw_cosq_port_ct_mode_set,
    .cosq_port_ct_mode_get = bcm56990_a0_ltsw_cosq_port_ct_mode_get,
    .cosq_port_asf_config_dump = bcm56990_a0_ltsw_cosq_port_asf_config_dump,
    .cosq_port_asf_config_show = bcm56990_a0_ltsw_cosq_port_asf_config_show,
    .cosq_rx_queue_channel_get = bcm56990_a0_ltsw_cosq_rx_queue_channel_get,
    .cosq_rx_queue_channel_set = bcm56990_a0_ltsw_cosq_rx_queue_channel_set,
    .cosq_rx_queue_channel_set_test = bcm56990_a0_ltsw_cosq_rx_queue_channel_set_test,
    .cosq_gport_traverse_by_port = bcm56990_a0_ltsw_cosq_gport_traverse_by_port
};
...
int
bcm56990_a0_ltsw_cosq_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_cosq_drv_set(unit, &bcm56990_a0_ltsw_cosq_drv));
...
int _vn##_ltsw_cosq_drv_attach(int unit) \
{ \
    SHR_FUNC_ENTER(unit); \
    SHR_IF_ERR_VERBOSE_EXIT \
        (mbcm_ltsw_cosq_drv_set(unit, &bcm56990_a0_ltsw_cosq_drv)); \
