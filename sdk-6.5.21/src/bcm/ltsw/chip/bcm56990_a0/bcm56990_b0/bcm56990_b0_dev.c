/*! \file bcm56990_b0_dev.c
 *
 * BCM56990_B0 DEV subordinate driver.
 */
/*
...
ltsw_dev_config_get(int unit, int *core_frequency)
{
    ...
    if (sal_strcasecmp(sym_val, CLK_1325MHZs) == 0) {
        ...
        *core_frequency = 1325;
    } else if (sal_strcasecmp(sym_val, CLK_1125MHZs) == 0) {
        ...
        *core_frequency = 950;
    } else if (sal_strcasecmp(sym_val, CLK_675MHZs) == 0) {
...
static int
bcm56990_b0_ltsw_dev_info_init(int unit, bcmint_dev_info_t *dev_info)
{
...
/*!
 * \brief Dev sub driver functions for bcm56990_b0 device.
 */
static mbcm_ltsw_dev_drv_t bcm56990_b0_dev_sub_drv = {
    .dev_info_init = bcm56990_b0_ltsw_dev_info_init,
};
...
int
bcm56990_b0_dev_sub_drv_attach(int unit, void *hdl)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_dev_drv_set(unit, &bcm56990_b0_dev_sub_drv));
