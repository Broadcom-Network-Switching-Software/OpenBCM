/*! \file bcm56990_b0_l2.c
 *
 * BCM56990_B0 L2 subordinate driver.
 */
/*
...
/*!
 * \brief L2 driver function variable for bcm56990_b0 device.
 */
static const
bcmint_l2_map_info_t bcm56990_b0_l2_lt_tbls_info[BCMINT_L2_MAX_NUM] = {
    {
        BCMINT_L2_HOST_TAB_ID, L2_VFI_FDBt,
        L2_VFI_FDBs, L2_VFI_FDBt_FIELD_COUNT,
        l2_host_tab_map, COUNTOF(l2_host_tab_map)
    },
    {
        BCMINT_L2_MY_STATION_ID, L2_VFI_MY_STATIONt,
        L2_VFI_MY_STATIONs, L2_VFI_MY_STATIONt_FIELD_COUNT,
        l2_my_station_map, COUNTOF(l2_my_station_map)
    },
    {
        BCMINT_L2_MY_STATION_MODPORT_ID, L2_VFI_MY_STATION_MODPORTt,
    ...
    {
        BCMINT_L2_MY_STATION_TRUNK_ID, L2_VFI_MY_STATION_TRUNKt,
    ...
    {
        BCMINT_L2_UNDERLAY_MY_STATION_MODPORT_ID, L2_VFI_UNDERLAY_MY_STATION_MODPORTt,
    ...
    {
        BCMINT_L2_UNDERLAY_MY_STATION_TRUNK_ID, L2_VFI_UNDERLAY_MY_STATION_TRUNKt,
 ...
 */
int
bcm56990_b0_l2_sub_drv_attach(int unit, void *hdl)
{
    return xgs_ltsw_l2_lt_map_register(unit, bcm56990_b0_l2_lt_tbls_info);
}
