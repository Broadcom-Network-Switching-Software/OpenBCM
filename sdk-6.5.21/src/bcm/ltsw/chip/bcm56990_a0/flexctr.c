...
/*!
 * \brief Flex counter quantization object enumeration mapping.
 */
static bcmint_flexctr_enum_map_t bcm56990_a0_ltsw_flexctr_quant_object_enum[] = {
...
static int
bcm56990_a0_ltsw_flexctr_flow_count_set(
    int unit,
    int val)
{
    ...
    int old_stat_counter_id = BCMI_LTSW_FLEXCTR_ACTION_INVALID;

    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_EXIT_EXCEPT_IF
        (bcmi_ltsw_flexctr_flow_count_get(unit, &old_stat_counter_id),
         SHR_E_NOT_FOUND);
    if (old_stat_counter_id == val) {
        SHR_EXIT();
    }
    ...
    if (val != BCMI_LTSW_FLEXCTR_ACTION_INVALID) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmi_ltsw_flexctr_counter_id_info_get(unit, val,
                                                   &counter_info));
        if (counter_info.source != bcmFlexctrSourceFlowCount) {
    ...
    /*Update flexctr sw info.*/
    if (val != BCMI_LTSW_FLEXCTR_ACTION_INVALID) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmi_ltsw_flexctr_attach_counter_id_status_update(unit, val));
    }
    if (old_stat_counter_id != BCMI_LTSW_FLEXCTR_ACTION_INVALID) {
        SHR_IF_ERR_VERBOSE_EXIT
...
static int
bcm56990_a0_ltsw_flexctr_flow_count_get(
    int unit,
    int *val)
{
    uint32_t arg = 0;
    ...
    if (fields[0].u.val == 0) {
        ...
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmi_ltsw_flexctr_counter_id_get(unit, &ci, &arg));
    }
    *val = arg;
...
static int
bcm56990_a0_ltsw_flexctr_quant_object_enum_map_get(
    int unit,
    const bcmint_flexctr_enum_map_t **map,
    uint32_t *count)
{
    ...
    *map = bcm56990_a0_ltsw_flexctr_quant_object_enum;
    *count = COUNTOF(bcm56990_a0_ltsw_flexctr_quant_object_enum);
...
static mbcm_ltsw_flexctr_drv_t bcm56990_a0_ltsw_flexctr_drv = {
    ...
    .flexctr_flow_count_set = bcm56990_a0_ltsw_flexctr_flow_count_set,
    .flexctr_flow_count_get = bcm56990_a0_ltsw_flexctr_flow_count_get,
    ...
    .flexctr_quant_object_enum_map_get = bcm56990_a0_ltsw_flexctr_quant_object_enum_map_get
};
