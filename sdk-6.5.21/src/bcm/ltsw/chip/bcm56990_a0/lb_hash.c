...
static int
bcm56990_a0_ltsw_lb_hash_tunnel_fields_select_set(
    int unit,
    ...
    int value)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (xgs_ltsw_lb_hash_tunnel_fields_select_set(unit, type, value));
...
static int
bcm56990_a0_ltsw_lb_hash_tunnel_fields_select_get(
    int unit,
    bcmi_ltsw_lb_hash_tunnel_fields_select_t type,
    int *value)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (xgs_ltsw_lb_hash_tunnel_fields_select_get(unit, type, value));
...
static mbcm_ltsw_lb_hash_drv_t bcm56990_a0_ltsw_lb_hash_drv = {
    ...
    .lb_hash_tunnel_fields_select_set = bcm56990_a0_ltsw_lb_hash_tunnel_fields_select_set,
    .lb_hash_tunnel_fields_select_get = bcm56990_a0_ltsw_lb_hash_tunnel_fields_select_get,
};
