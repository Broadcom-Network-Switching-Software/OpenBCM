...
static int
bcm56990_a0_ltsw_obm_port_max_usage_mode_get(
    int unit,
    bcm_port_t port,
...
static int
bcm56990_a0_ltsw_obm_port_max_usage_mode_set(
    int unit,
    bcm_port_t port,
    bcm_obm_max_watermark_mode_t obm_wm_mode)
{
...
static int
bcm56990_a0_ltsw_obm_port_pri_traffic_class_mapping_get(
    int unit,
    bcm_port_t port,
...
static int
bcm56990_a0_ltsw_obm_port_pri_traffic_class_mapping_set(
    int unit,
    bcm_port_t port,
    bcm_obm_lookup_priority_type_t piority_type,
    int priority,
...
static int
bcm56990_a0_ltsw_obm_port_control_get(
    int unit,
    bcm_port_t port,
...
static int
bcm56990_a0_ltsw_obm_port_control_set(
    int unit,
    bcm_port_t port,
    bcmi_ltsw_obm_port_control_t type,
    int arg)
...
static int
bcm56990_a0_ltsw_obm_pm_port_control_get(
    int unit,
    int pm_id,
    bcmi_ltsw_obm_port_control_t type,
    int *arg)
...
static int
bcm56990_a0_ltsw_obm_pm_port_control_set(
    int unit,
    int pm_id,
    bcmi_ltsw_obm_port_control_t type,
    int arg)
{
    int from_pm, to_pm, pm, obm_pm_num;

    SHR_FUNC_ENTER(unit);

    obm_pm_num = bcmi_ltsw_dev_obm_pm_num(unit);

    if (pm_id == -1) {
        from_pm = 1;
        to_pm = obm_pm_num;
    } else if ((pm_id >= 1) && (pm_id <= obm_pm_num)) {
        from_pm = to_pm = pm_id;
    } else {
        SHR_IF_ERR_VERBOSE_EXIT(SHR_E_PARAM);
    }
...
static int
bcm56990_a0_ltsw_obm_classifier_mapping_multi_get(
    int unit,
    bcm_gport_t gport,
    bcm_switch_obm_classifier_type_t switch_obm_classifier_type,
    int array_max,
...
static int
bcm56990_a0_ltsw_obm_classifier_mapping_multi_set(
    int unit,
    bcm_gport_t gport,
    bcm_switch_obm_classifier_type_t switch_obm_classifier_type,
    int array_count,
...
static int
bcm56990_a0_ltsw_obm_traffic_class_pfc_priority_mapping_get(
    int unit,
    bcm_port_t port,
...
static int
bcm56990_a0_ltsw_obm_traffic_class_pfc_priority_mapping_set(
    int unit,
    bcm_port_t port,
    bcm_obm_traffic_class_t obm_traffic_class,
    int max_pri_count,
...
static int
bcm56990_a0_ltsw_obm_init(int unit)
{
    static tm_ltsw_obm_chip_driver_t bcm56990_a0_obm_drv_cb = {
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (tm_ltsw_obm_chip_driver_register(unit, &bcm56990_a0_obm_drv_cb));
...
static int
bcm56990_a0_ltsw_obm_detach(int unit)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56990_a0_ltsw_obm_port_fc_enable_set(
    int unit,
    int lport,
    int fc_type)
{
...
/*!
 * \brief Obm driver function variable for bcm56990_a0 device.
 */
static mbcm_ltsw_obm_drv_t bcm56990_a0_ltsw_obm_drv = {
    .obm_port_max_usage_mode_get = bcm56990_a0_ltsw_obm_port_max_usage_mode_get,
    .obm_port_max_usage_mode_set = bcm56990_a0_ltsw_obm_port_max_usage_mode_set,
    .obm_port_pri_traffic_class_mapping_get = bcm56990_a0_ltsw_obm_port_pri_traffic_class_mapping_get,
    .obm_port_pri_traffic_class_mapping_set = bcm56990_a0_ltsw_obm_port_pri_traffic_class_mapping_set,
    .obm_port_control_get = bcm56990_a0_ltsw_obm_port_control_get,
    .obm_port_control_set = bcm56990_a0_ltsw_obm_port_control_set,
    .obm_pm_port_control_get = bcm56990_a0_ltsw_obm_pm_port_control_get,
    .obm_pm_port_control_set = bcm56990_a0_ltsw_obm_pm_port_control_set,
    .obm_classifier_mapping_multi_get = bcm56990_a0_ltsw_obm_classifier_mapping_multi_get,
    .obm_classifier_mapping_multi_set = bcm56990_a0_ltsw_obm_classifier_mapping_multi_set,
    .obm_traffic_class_pfc_priority_mapping_get = bcm56990_a0_ltsw_obm_traffic_class_pfc_priority_mapping_get,
    .obm_traffic_class_pfc_priority_mapping_set = bcm56990_a0_ltsw_obm_traffic_class_pfc_priority_mapping_set,
    .obm_init = bcm56990_a0_ltsw_obm_init,
    .obm_detach = bcm56990_a0_ltsw_obm_detach,
    .obm_port_fc_enable_set = bcm56990_a0_ltsw_obm_port_fc_enable_set
};
...
int
bcm56990_a0_ltsw_obm_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_obm_drv_set(unit, &bcm56990_a0_ltsw_obm_drv));
...
int _vn##_ltsw_obm_drv_attach(int unit) \
{ \
    SHR_FUNC_ENTER(unit); \
    SHR_IF_ERR_VERBOSE_EXIT \
        (mbcm_ltsw_obm_drv_set(unit, &bcm56990_a0_ltsw_obm_drv)); \
