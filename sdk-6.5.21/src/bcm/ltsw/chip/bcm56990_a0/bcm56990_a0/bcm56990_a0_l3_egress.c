...
bcmint_ltsw_l3_egress_fld_t l3_ecmp_flds[BCMINT_XGS_L3_ECMP_TBL_FLD_CNT] = {
    ...
    [BCMINT_XGS_L3_ECMP_TBL_CTR_EFLEX_ACTION_ID] = {
        ...
        ECMPt_ECMP_CTR_ING_EFLEX_ACTION_IDf,
        false,
        false,
        0,
        NULL,
