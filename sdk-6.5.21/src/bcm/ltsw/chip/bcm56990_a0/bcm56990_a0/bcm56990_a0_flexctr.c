...
#define FLEXCTR_SOURCE_ING_MON_FLOWCOUNT_CONTROL_TBL_BIT (9)
...
static int
bcm56990_a0_ltsw_flexctr_object_overlay_multi_get(int unit,
    ...
    int *count)
{
    ...
    size = COUNTOF(bcm56990_a0_ltsw_flexctr_object_db);
    object_db = bcm56990_a0_ltsw_flexctr_object_db;
...
static mbcm_ltsw_flexctr_drv_t bcm56990_a0_flexctr_sub_drv = {
    ...
    .flexctr_object_overlay_multi_get = bcm56990_a0_ltsw_flexctr_object_overlay_multi_get,
};
