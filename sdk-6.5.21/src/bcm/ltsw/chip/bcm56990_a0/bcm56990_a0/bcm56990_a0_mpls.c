/*! \file bcm56990_a0_mpls.c
 *
 * BCM56990_A0 mpls subordinate driver.
 */
/*
...
mpls_lt[] = {
    ...
    [BCMINT_LTSW_MPLS_LT_DECAP_TRUNK_1] = {
        .name = TNL_MPLS_DECAP_TRUNK_1s,
        .fld_bmp =
    ...
    [BCMINT_LTSW_MPLS_LT_DECAP_TRUNK_2] = {
        .name = TNL_MPLS_DECAP_TRUNK_2s,
        .fld_bmp =
            (1 << BCMINT_LTSW_MPLS_FLD_DECAP_LABEL) |
            (1 << BCMINT_LTSW_MPLS_FLD_DECAP_SOURCE) |
            (1 << BCMINT_LTSW_MPLS_FLD_DECAP_BOS_ACTIONS) |
    ...
    [BCMINT_LTSW_MPLS_LT_DECAP_1] = {
        .name = TNL_MPLS_DECAP_1s,
        .fld_bmp =
            (1 << BCMINT_LTSW_MPLS_FLD_DECAP_LABEL) |
            (1 << BCMINT_LTSW_MPLS_FLD_DECAP_SOURCE) |
            (1 << BCMINT_LTSW_MPLS_FLD_DECAP_BOS_ACTIONS) |
    ...
    [BCMINT_LTSW_MPLS_LT_DECAP_2] = {
        .name = TNL_MPLS_DECAP_2s,
        .fld_bmp =
            (1 << BCMINT_LTSW_MPLS_FLD_DECAP_LABEL) |
            (1 << BCMINT_LTSW_MPLS_FLD_DECAP_SOURCE) |
            (1 << BCMINT_LTSW_MPLS_FLD_DECAP_BOS_ACTIONS) |
...
static int
bcm56990_a0_ltsw_mpls_lt_db_get(
    int unit,
    bcmint_mpls_lt_db_t *lt_db)
{
    ...
    lt_db->lt_bmp = (1 << BCMINT_LTSW_MPLS_LT_EFLEX_ACTION) |
                    (1 << BCMINT_LTSW_MPLS_LT_DECAP_TRUNK_1) |
                    (1 << BCMINT_LTSW_MPLS_LT_DECAP_1) |
                    (1 << BCMINT_LTSW_MPLS_LT_DECAP_TRUNK_2) |
                    (1 << BCMINT_LTSW_MPLS_LT_DECAP_2);
...
/*!
 * \brief Mpls sub driver functions for bcm56990_a0.
 */
static mbcm_ltsw_mpls_drv_t bcm56990_a0_mpls_sub_drv = {
    .mpls_lt_db_get = bcm56990_a0_ltsw_mpls_lt_db_get,
};
 ...
 */
int
bcm56990_a0_mpls_sub_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_mpls_drv_set(unit, &bcm56990_a0_mpls_sub_drv));
