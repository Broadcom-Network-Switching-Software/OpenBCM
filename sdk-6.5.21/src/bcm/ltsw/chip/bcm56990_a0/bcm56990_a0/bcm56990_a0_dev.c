/*! \file bcm56990_a0_dev.c
 *
 * BCM56990_A0 DEV subordinate driver.
 */
/*
...
static int
bcm56990_a0_ltsw_dev_info_init(int unit, bcmint_dev_info_t *dev_info)
{
...
/*!
 * \brief Dev sub driver functions for bcm56990_a0.
 */
static mbcm_ltsw_dev_drv_t bcm56990_a0_dev_sub_drv = {
    .dev_info_init = bcm56990_a0_ltsw_dev_info_init,
};
...
int
bcm56990_a0_dev_sub_drv_attach(int unit, void *hdl)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_dev_drv_set(unit, &bcm56990_a0_dev_sub_drv));
