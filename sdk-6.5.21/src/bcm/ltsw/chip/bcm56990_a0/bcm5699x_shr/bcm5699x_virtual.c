...
static int
bcm5699x_ltsw_virtual_port_egress_adapt_key_sync_status_get(int unit, int *sync_required)
{
    SHR_FUNC_ENTER(unit);
...
bcm5699x_virtual_sub_drv_attach(int unit, void *hdl)
{
    ...
    ((mbcm_ltsw_virtual_drv_t *)hdl)->virtual_qos_port_map_set = xgs_ltsw_virtual_qos_port_map_set;
    ((mbcm_ltsw_virtual_drv_t *)hdl)->virtual_qos_port_map_type_get = xgs_ltsw_virtual_qos_port_map_type_get;
    ((mbcm_ltsw_virtual_drv_t *)hdl)->virtual_port_egress_adapt_key_sync_status_get = bcm5699x_ltsw_virtual_port_egress_adapt_key_sync_status_get;
