/*! \file bcm5699x_stat.c
 *
 * BCM5699x Stat subordinate driver.
 */
/*
 ...
 */
static bcmint_stat_ctr_map_info_t bcm5699x_ltsw_stat_ctr_map_tab[] = {
    /*
     * RFC 1213 MIBs
     *
 ...
 */
     ...
     * snmpBcmCustomReceive9 = 281
     * snmpBcmCustomReceive10 = 282
     * snmpBcmCustomReceive11 = 283
     * snmpBcmCustomReceive12 = 284
     * snmpBcmCustomReceive13 = 285
     * snmpBcmCustomReceive14 = 286
     * snmpBcmCustomReceive15 = 287
 ...
 */
    ...
    /* snmpBcmCustomReceive9 = 281 */
    {snmpBcmCustomReceive9, CTR_ING_DEBUGs, DEBUG_9s, FALSE},
    /* snmpBcmCustomReceive10 = 282 */
    {snmpBcmCustomReceive10, CTR_ING_DEBUGs, DEBUG_10s, FALSE},
    /* snmpBcmCustomReceive11 = 283 */
    {snmpBcmCustomReceive11, CTR_ING_DEBUGs, DEBUG_11s, FALSE},
    /* snmpBcmCustomReceive12 = 284 */
    {snmpBcmCustomReceive12, CTR_ING_DEBUGs, DEBUG_12s, FALSE},
    /* snmpBcmCustomReceive13 = 285 */
    {snmpBcmCustomReceive13, CTR_ING_DEBUGs, DEBUG_13s, FALSE},
    /* snmpBcmCustomReceive14 = 286 */
    {snmpBcmCustomReceive14, CTR_ING_DEBUGs, DEBUG_14s, FALSE},
    /* snmpBcmCustomReceive15 = 287 */
    {snmpBcmCustomReceive15, CTR_ING_DEBUGs, DEBUG_15s, FALSE},
    /* snmpBcmRxTunnelDecapEcnPkts = 288 */
    {snmpBcmRxTunnelDecapEcnPkts, CTR_ECNs, RX_TNL_DECAP_ECN_PKTs, FALSE},
    /* snmpBcmTxEcnErrors = 239 */
    {snmpBcmTxEcnErrors, CTR_ECNs, TX_ECN_PKTs, FALSE},
};

/*!
 * \brief Chip specific stat debug counter mapping table.
 */
static bcmint_stat_map_info_t bcm5699x_ltsw_stat_dbg_map_tab[] = {
    ...
    {bcmDbgCntTxNonUnicastPruneDrop, CTR_EGR_DEBUG_SELECTs, NONUC_PRUNE_DROPs},
    {bcmDbgCntTxSvpRemoveDrop, CTR_EGR_DEBUG_SELECTs, VP_PRUNE_DROPs},
    /* bcmDbgCntTxVplagPruneDrop = 170 */
    {bcmDbgCntTxSplitHorizonDrop, CTR_EGR_DEBUG_SELECTs, SPLIT_HORIZON_DROPs},
    /* bcmDbgCntTxMmuPurgeDrop = 172 */
    /* bcmDbgCntTxStgDisableDrop = 173 */
    /* bcmDbgCntTxEgressPortDrop = 174 */
    {bcmDbgCntTxEgressFilterDrop, CTR_EGR_DEBUG_SELECTs, FP_DROPs},
    ...
    {bcmDbgCntRxVfiAdaptLookupMiss, CTR_ING_DEBUG_SELECTs, VFI_ING_ADAPT_LOOKUP_MISS_DROPs},
    {bcmDbgCntRxNextHopOrL3EifRangeError, CTR_ING_DEBUG_SELECTs, OVERLAY_UNDERLAY_NHOP_EIF_RANGE_ERROR_DROPs},
    {bcmDbgCntRxVxlanDecapSrcIpLookupMiss, CTR_ING_DEBUG_SELECTs, TNL_VXLAN_DECAP_SRC_IP_LOOKUP_MISS_DROPs},
    {bcmDbgCntTxAdaptLookupMiss, CTR_EGR_DEBUG_SELECTs, ADAPT_LOOKUP_MISSs},
    {bcmDbgCntTxSvpEsDrop, CTR_EGR_DEBUG_SELECTs, SVP_ES_DROPs},
    {bcmDbgCntTxL3EgressOrIntfRangeError, CTR_EGR_DEBUG_SELECTs, OVERLAY_UNDERLAY_RANGE_ERRORs},
};
...
static bcmint_stat_dev_info_t bcm5699x_stat_devinfo = {
    bcm5699x_ltsw_stat_ctr_map_tab,
    COUNTOF(bcm5699x_ltsw_stat_ctr_map_tab),
    bcm5699x_ltsw_stat_dbg_map_tab,
    COUNTOF(bcm5699x_ltsw_stat_dbg_map_tab)
};


static int
bcm5699x_ltsw_stat_dev_info_get(int unit,
                                const bcmint_stat_dev_info_t **devinfo)
{
    *devinfo = &bcm5699x_stat_devinfo;

    return SHR_E_NONE;
}

/*!
 * \brief Stat sub driver functions for bcm5699x.
 */
static mbcm_ltsw_stat_drv_t bcm5699x_stat_sub_drv = {
    .stat_dev_info_get = bcm5699x_ltsw_stat_dev_info_get,
};
...
int
bcm5699x_stat_sub_drv_attach(int unit, void *hdl)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_stat_drv_set(unit, &bcm5699x_stat_sub_drv));
