...
static const shr_enum_map_t bcm5699x_move_depth_map[] = {
    ...
    { (char *)TNL_MPLS_DECAP_1s, bcmSwitchHashMultiMoveDepthMpls },
    { (char *)TNL_MPLS_DECAP_2s, bcmSwitchHashMultiMoveDepthMpls },
    { (char *)TNL_MPLS_DECAP_TRUNK_1s, bcmSwitchHashMultiMoveDepthMpls },
    { (char *)TNL_MPLS_DECAP_TRUNK_2s, bcmSwitchHashMultiMoveDepthMpls },
};
...
static const bcmint_uft_table_map_t bcm5699x_table_map[] = {
    ...
    { (char *)TNL_MPLS_DECAP_1s, -1, bcmHashTableMPLS },
    { (char *)TNL_MPLS_DECAP_2s, -1, bcmHashTableMPLS },
