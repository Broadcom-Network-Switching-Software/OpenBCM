...
/* Total maximum number of ECMP paths supported by the device per ECMP group. */
#define ECMP_LEVEL_MAX_PATHS_COUNT  128

/*! Defines maximum number of ECMP paths supported by a weighted ECMP group. */
#define ECMP_LEVEL_WGT_MAX_PATHS_COUNT 4096
...
static const bcmint_ltsw_l3_egress_tbl_t l3_egress_tbls[] = {
    [BCMINT_LTSW_L3_EGRESS_TBL_UC] = {
        .name = L3_UC_HIERARCHICAL_NHOPs,
        .fld_cnt = L3_UC_HIERARCHICAL_NHOPt_FIELD_COUNT,
    ...
    [BCMINT_LTSW_L3_EGRESS_TBL_MC] = {
        .name = L3_MC_HIERARCHICAL_NHOPs,
        .fld_cnt = L3_MC_HIERARCHICAL_NHOPt_FIELD_COUNT,
        .fld_bmp = (1LL << BCMINT_XGS_L3_EGRESS_TBL_NHOP_ID) |
    ...
    [BCMINT_LTSW_L3_EGRESS_TBL_MPLS_TRNSIT] = {
        .name = TNL_MPLS_TRANSIT_HIERARCHICAL_NHOPs,
        .fld_cnt = TNL_MPLS_TRANSIT_HIERARCHICAL_NHOPt_FIELD_COUNT,
        .fld_bmp = (1LL << BCMINT_XGS_L3_EGRESS_TBL_NHOP_ID) |
                   (1LL << BCMINT_XGS_L3_EGRESS_TBL_MODPORT) |
                   (1LL << BCMINT_XGS_L3_EGRESS_TBL_TRUNK_ID) |
                   (1LL << BCMINT_XGS_L3_EGRESS_TBL_IS_TRUNK) |
    ...
    [BCMINT_LTSW_L3_EGRESS_TBL_MPLS_ENCAP] = {
        .name = TNL_MPLS_ENCAP_HIERARCHICAL_NHOPs,
        .fld_cnt = TNL_MPLS_ENCAP_HIERARCHICAL_NHOPt_FIELD_COUNT,
        .fld_bmp = (1LL << BCMINT_XGS_L3_EGRESS_TBL_NHOP_ID) |
                   (1LL << BCMINT_XGS_L3_EGRESS_TBL_MODPORT) |
                   (1LL << BCMINT_XGS_L3_EGRESS_TBL_TRUNK_ID) |
                   (1LL << BCMINT_XGS_L3_EGRESS_TBL_IS_TRUNK) |
    ...
    [BCMINT_LTSW_L3_EGRESS_TBL_IFP_ACTION] = {
        .name = FP_ING_ACTION_HIERARCHICAL_NHOPs,
        .fld_cnt = FP_ING_ACTION_HIERARCHICAL_NHOPt_FIELD_COUNT,
        .fld_bmp = (1LL << BCMINT_XGS_L3_EGRESS_TBL_NHOP_ID) |
                   (1LL << BCMINT_XGS_L3_EGRESS_TBL_VLAN_ID) |
                   (1LL << BCMINT_XGS_L3_EGRESS_TBL_MODPORT) |
                   (1LL << BCMINT_XGS_L3_EGRESS_TBL_TRUNK_ID) |
    ...
    [BCMINT_LTSW_L3_EGRESS_TBL_L2_TAG] = {
        .name = L2_TAG_ACTION_HIERARCHICAL_NHOPs,
        .fld_cnt = L2_TAG_ACTION_HIERARCHICAL_NHOPt_FIELD_COUNT,
        .fld_bmp = (1LL << BCMINT_XGS_L3_EGRESS_TBL_NHOP_ID) |
                   (1LL << BCMINT_XGS_L3_EGRESS_TBL_VLAN_ID) |
                   (1LL << BCMINT_XGS_L3_EGRESS_TBL_MODPORT) |
                   (1LL << BCMINT_XGS_L3_EGRESS_TBL_TRUNK_ID) |
...
bcmint_ltsw_l3_egress_fld_t l3_ecmp_ul_flds[BCMINT_XGS_L3_ECMP_TBL_FLD_CNT] = {
    ...
    [BCMINT_XGS_L3_ECMP_TBL_RH_RANDOM_SEED] = {
        RH_RANDOM_SEEDs,
        ECMP_UNDERLAYt_RH_RANDOM_SEEDf,
        false,
        false,
        0,
        NULL,
    ...
    [BCMINT_XGS_L3_ECMP_TBL_CTR_EFLEX_OBJECT] = {
        CTR_ING_EFLEX_OBJECTs,
        ECMP_UNDERLAYt_CTR_ING_EFLEX_OBJECTf,
        false,
        false,
        0,
        NULL,
    ...
    [BCMINT_XGS_L3_ECMP_TBL_CTR_EFLEX_ACTION_ID] = {
...
bcmint_ltsw_l3_egress_fld_t l3_ecmp_weighted_ul_flds[BCMINT_XGS_L3_ECMP_TBL_FLD_CNT] = {
    [BCMINT_XGS_L3_ECMP_TBL_ECMP_ID] = {
        ECMP_IDs,
        ECMP_WEIGHTED_UNDERLAYt_ECMP_IDf,
        true,
        false,
        0,
        NULL,
    ...
    [BCMINT_XGS_L3_ECMP_TBL_WEIGHTED_SIZE] = {
        WEIGHTED_SIZEs,
        ECMP_WEIGHTED_UNDERLAYt_WEIGHTED_SIZEf,
        false,
        true,
        0,
    ...
    [BCMINT_XGS_L3_ECMP_TBL_NUM_PATHS] = {
        NUM_PATHSs,
        ECMP_WEIGHTED_UNDERLAYt_NUM_PATHSf,
        false,
        false,
        0,
        NULL,
    ...
    [BCMINT_XGS_L3_ECMP_TBL_NHOP_ID] = {
        NHOP_IDs,
        ECMP_WEIGHTED_UNDERLAYt_NHOP_IDf,
        false,
        false,
        ECMP_LEVEL_WGT_MAX_PATHS_COUNT,
        NULL,
        NULL
    },
    [BCMINT_XGS_L3_ECMP_TBL_WEIGHT] = {
        WEIGHTs,
        ECMP_WEIGHTED_UNDERLAYt_WEIGHTf,
        false,
        false,
        ECMP_LEVEL_WGT_MAX_PATHS_COUNT,
        NULL,
    ...
    [BCMINT_XGS_L3_ECMP_TBL_WEIGHTED_MODE] = {
        WEIGHTED_MODEs,
        ECMP_WEIGHTED_UNDERLAYt_WEIGHTED_MODEf,
        false,
        true,
        0,
...
bcmint_ltsw_l3_egress_fld_t l3_ecmp_ol_flds[BCMINT_XGS_L3_ECMP_TBL_FLD_CNT] = {
    ...
    [BCMINT_XGS_L3_ECMP_TBL_ECMP_UNDERLAY_ID] = {
        ECMP_UNDERLAY_IDs,
        ECMP_OVERLAYt_ECMP_UNDERLAY_IDf,
        false,
        false,
        128,
        NULL,
    ...
    [BCMINT_XGS_L3_ECMP_TBL_RH_ECMP_UNDERLAY_ID] = {
        ...
        ECMP_OVERLAYt_RH_ECMP_UNDERLAY_IDf,
        false,
        false,
        1024,
        NULL,
    ...
    [BCMINT_XGS_L3_ECMP_TBL_ECMP_NHOP_UNDERLAY] = {
        ECMP_NHOP_UNDERLAYs,
        ECMP_OVERLAYt_ECMP_NHOP_UNDERLAYf,
        false,
        false,
        128,
        NULL,
    ...
    [BCMINT_XGS_L3_ECMP_TBL_OVERLAY_NHOP_ID] = {
        OVERLAY_NHOP_IDs,
        ECMP_OVERLAYt_OVERLAY_NHOP_IDf,
        false,
        false,
        128,
        NULL,
    ...
    [BCMINT_XGS_L3_ECMP_TBL_UNDERLAY_NHOP_ID] = {
        UNDERLAY_NHOP_IDs,
        ECMP_OVERLAYt_UNDERLAY_NHOP_IDf,
        false,
        false,
        128,
        NULL,
    ...
    [BCMINT_XGS_L3_ECMP_TBL_RH_ECMP_NHOP_UNDERLAY] = {
        ...
        ECMP_OVERLAYt_RH_ECMP_NHOP_UNDERLAYf,
        false,
        false,
        1024,
        NULL,
    ...
    [BCMINT_XGS_L3_ECMP_TBL_RH_OVERLAY_NHOP_ID] = {
        RH_OVERLAY_NHOP_IDs,
        ECMP_OVERLAYt_RH_OVERLAY_NHOP_IDf,
        false,
        false,
        1024,
        NULL,
    ...
    [BCMINT_XGS_L3_ECMP_TBL_RH_UNDERLAY_NHOP_ID] = {
        ...
        ECMP_OVERLAYt_RH_UNDERLAY_NHOP_IDf,
        false,
        false,
        1024,
        NULL,
    ...
    [BCMINT_XGS_L3_ECMP_TBL_CTR_EFLEX_OBJECT] = {
        CTR_ING_EFLEX_OBJECTs,
        ECMP_OVERLAYt_CTR_ING_EFLEX_OBJECTf,
        false,
        false,
        0,
        NULL,
...
bcmint_ltsw_l3_egress_fld_t l3_ecmp_weighted_ol_flds[BCMINT_XGS_L3_ECMP_TBL_FLD_CNT] = {
    [BCMINT_XGS_L3_ECMP_TBL_ECMP_ID] = {
        ECMP_IDs,
        ECMP_WEIGHTED_OVERLAYt_ECMP_IDf,
        true,
        false,
        0,
        NULL,
    ...
    [BCMINT_XGS_L3_ECMP_TBL_NUM_PATHS] = {
        NUM_PATHSs,
        ECMP_WEIGHTED_OVERLAYt_NUM_PATHSf,
        false,
        false,
        0,
        NULL,
    ...
    [BCMINT_XGS_L3_ECMP_TBL_OVERLAY_NHOP_ID] = {
        OVERLAY_NHOP_IDs,
        ECMP_WEIGHTED_OVERLAYt_OVERLAY_NHOP_IDf,
        false,
        false,
        128,
        NULL,
    ...
    [BCMINT_XGS_L3_ECMP_TBL_ECMP_NHOP_UNDERLAY] = {
        ECMP_NHOP_UNDERLAYs,
        ECMP_WEIGHTED_OVERLAYt_ECMP_NHOP_UNDERLAYf,
        false,
        false,
        128,
        NULL,
    ...
    [BCMINT_XGS_L3_ECMP_TBL_UNDERLAY_NHOP_ID] = {
        UNDERLAY_NHOP_IDs,
        ECMP_WEIGHTED_OVERLAYt_UNDERLAY_NHOP_IDf,
        false,
        false,
        128,
        NULL,
    ...
    [BCMINT_XGS_L3_ECMP_TBL_ECMP_UNDERLAY_ID] = {
        ECMP_UNDERLAY_IDs,
        ECMP_WEIGHTED_OVERLAYt_ECMP_UNDERLAY_IDf,
        false,
        false,
        128,
        NULL,
    ...
    [BCMINT_XGS_L3_ECMP_TBL_WEIGHT] = {
        WEIGHTs,
        ECMP_WEIGHTED_OVERLAYt_WEIGHTf,
        false,
        false,
        128,
        NULL,
...
static const bcmint_ltsw_l3_egress_tbl_t l3_ecmp_tbls[BCMINT_LTSW_L3_ECMP_TBL_CNT] = {
    [BCMINT_LTSW_L3_ECMP_TBL_UL] = {
        ...
        .fld_bmp = (1LL << BCMINT_XGS_L3_ECMP_TBL_ECMP_ID) |
                   ...
                   (1LL << BCMINT_XGS_L3_ECMP_TBL_CTR_EFLEX_OBJECT) |
                   (1LL << BCMINT_XGS_L3_ECMP_TBL_CTR_EFLEX_ACTION_ID),
        .flds = l3_ecmp_ul_flds
    },
    [BCMINT_LTSW_L3_ECMP_TBL_WEIGHTED_UL] = {
        .name = ECMP_WEIGHTED_UNDERLAYs,
        .tbl_id = ECMP_WEIGHTED_UNDERLAYt,
