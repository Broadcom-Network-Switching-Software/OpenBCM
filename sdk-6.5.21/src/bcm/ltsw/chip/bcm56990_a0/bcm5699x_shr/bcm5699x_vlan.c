...
bcm5699x_vlan_sub_drv_attach(int unit, void *hdl)
{
    ...
    ((mbcm_ltsw_vlan_drv_t *)hdl)->vlan_egr_xlate_add = xgs_ltsw_vfi_egr_xlate_add;
    ((mbcm_ltsw_vlan_drv_t *)hdl)->vlan_egr_xlate_get = xgs_ltsw_vfi_egr_xlate_get;
    ((mbcm_ltsw_vlan_drv_t *)hdl)->vlan_egr_xlate_delete = xgs_ltsw_vfi_egr_xlate_delete;
    ((mbcm_ltsw_vlan_drv_t *)hdl)->vlan_egr_xlate_traverse = xgs_ltsw_vfi_egr_xlate_traverse;
    ...
    ((mbcm_ltsw_vlan_drv_t *)hdl)->vlan_ing_xlate_flexctr_attach = xgs_ltsw_vfi_ing_xlate_flexctr_attach;
    ((mbcm_ltsw_vlan_drv_t *)hdl)->vlan_ing_xlate_flexctr_detach = xgs_ltsw_vfi_ing_xlate_flexctr_detach;
    ((mbcm_ltsw_vlan_drv_t *)hdl)->vlan_ing_xlate_flexctr_get = xgs_ltsw_vfi_ing_xlate_flexctr_get;
    ((mbcm_ltsw_vlan_drv_t *)hdl)->vlan_egr_xlate_flexctr_attach = xgs_ltsw_vfi_egr_xlate_flexctr_attach;
    ((mbcm_ltsw_vlan_drv_t *)hdl)->vlan_egr_xlate_flexctr_detach = xgs_ltsw_vfi_egr_xlate_flexctr_detach;
    ((mbcm_ltsw_vlan_drv_t *)hdl)->vlan_egr_xlate_flexctr_get = xgs_ltsw_vfi_egr_xlate_flexctr_get;
