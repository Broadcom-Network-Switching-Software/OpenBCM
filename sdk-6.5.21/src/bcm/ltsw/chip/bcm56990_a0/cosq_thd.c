 ...
 */
static cosq_thd_lt_convert_t cosq_int_to_adt_pri_group[] =
{
    {BCM_COSQ_ADT_PRI_GROUP_MIDDLE,   MID_PRI_GROUPs},
    {BCM_COSQ_ADT_PRI_GROUP_LOW,      LOW_PRI_GROUPs},
    {BCM_COSQ_ADT_PRI_GROUP_HIGH,     HIGH_PRI_GROUPs},
};
 ...
 */
static const char*
cosq_thd_int_to_adt_pri_group(int adt_pri_group)
{
    int nfields;

    nfields = sizeof(cosq_int_to_adt_pri_group) / sizeof(cosq_int_to_adt_pri_group[0]);

    return cosq_thd_int_to_char(adt_pri_group, cosq_int_to_adt_pri_group, nfields);
}
 ...
 */
static int
cosq_thd_adt_pri_group_to_int(const char *adt_pri_group)
{
    int nfields;

    nfields = sizeof(cosq_int_to_adt_pri_group) / sizeof(cosq_int_to_adt_pri_group[0]);

    return cosq_thd_char_to_int(adt_pri_group, cosq_int_to_adt_pri_group, nfields);
}
...
static int
bcm56990_a0_ltsw_cosq_thd_init(int unit)
{
    int idx;
    uint32_t ha_alloc_size, ha_req_size;
    int warm = bcmi_warmboot_get(unit);

    static tm_ltsw_cosq_thd_chip_driver_t bcm56990_a0_cosq_thd_drv_cb = {
        ...
        .cosq_thd_int_to_adt_pri_group = cosq_thd_int_to_adt_pri_group,
        .cosq_thd_adt_pri_group_to_int = cosq_thd_adt_pri_group_to_int,
    };

    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (tm_ltsw_cosq_thd_chip_driver_register(unit, &bcm56990_a0_cosq_thd_drv_cb));
...
static int
bcm56990_a0_ltsw_cosq_thd_detach(int unit)
{
    int warm = bcmi_warmboot_get(unit);
    ...
    if (!warm) {
        SHR_IF_ERR_VERBOSE_EXIT
            (tm_ltsw_cosq_thd_adt_low_pri_mon_pool_clear(unit));

        SHR_IF_ERR_VERBOSE_EXIT
            (tm_ltsw_cosq_thd_egr_service_pool_adt_clear(unit));
    }
...
static int
bcm56990_a0_ltsw_cosq_thd_dynamic_get(
    int unit,
    ...
    bcm_cosq_dynamic_setting_type_t *dynamic)
{
    switch (type) {
        ...
        case bcmCosqControlAdtPriGroup:
        ...
        case bcmCosqControlAdtLowPriMonitorPool:
...
static int
bcm56990_a0_ltsw_cosq_thd_port_guarantee_reset(
    int unit,
    bcm_port_t port)
{
    int idx, numq;
...
static int
bcm56990_a0_ltsw_cosq_thd_control_set(
    int unit,
    bcm_gport_t gport,
    bcm_cos_queue_t cosq,
    ...
    int arg)
{
    ...
    switch (type) {
        ...
        case bcmCosqControlEgressPoolAdtHighPriAlpha:
            SHR_IF_ERR_VERBOSE_EXIT
               (tm_ltsw_cosq_thd_egr_pool_set(unit, gport, cosq, buffer, type,
        ...
        case bcmCosqControlAdtPriGroup:
            SHR_IF_ERR_VERBOSE_EXIT
               (tm_ltsw_cosq_thd_adt_pri_group_set(unit, gport, cosq, arg));
            break;
        case bcmCosqControlAdtLowPriMonitorPool:
            if (arg < 0 || (arg >= device_info.num_service_pool)) {
                SHR_IF_ERR_VERBOSE_EXIT(SHR_E_PARAM);
            ...
            SHR_IF_ERR_VERBOSE_EXIT
               (tm_ltsw_cosq_thd_adt_low_pri_mon_pool_set(unit, gport, cosq,
                                                          buffer, type, arg));
            break;
        default:
...
static int
bcm56990_a0_ltsw_cosq_thd_control_get(
    int unit,
    bcm_gport_t gport,
    bcm_cos_queue_t cosq,
    bcm_cosq_buffer_id_t buffer,
    ...
    int *arg)
{
    ...
    switch (type) {
        ...
        case bcmCosqControlEgressPoolAdtHighPriAlpha:
            SHR_IF_ERR_VERBOSE_EXIT
               (tm_ltsw_cosq_thd_egr_pool_get(unit, gport, cosq, buffer, type,
                                              arg));
            break;
        case bcmCosqControlEgressPortPoolYellowLimitBytes:
        case bcmCosqControlEgressPortPoolRedLimitBytes:
        ...
        case bcmCosqControlAdtPriGroup:
            SHR_IF_ERR_VERBOSE_EXIT
               (tm_ltsw_cosq_thd_adt_pri_group_get(unit, gport, cosq, arg));
            break;
        case bcmCosqControlAdtLowPriMonitorPool:
            SHR_IF_ERR_VERBOSE_EXIT
               (tm_ltsw_cosq_thd_adt_low_pri_mon_pool_get(unit, gport, cosq,
                                                          buffer, type, arg));
            break;
        default:
            SHR_IF_ERR_VERBOSE_EXIT(SHR_E_UNAVAIL);
...
static int
bcm56990_a0_ltsw_cosq_thd_port_uc_spid_get(
    int unit,
    bcm_port_t port,
    int queue,
    int *spid,
...
static int
bcm56990_a0_ltsw_cosq_thd_shared_limit_get(
    int unit,
    int itm,
    int spid,
    int *shared_limit)
...
static int
bcm56990_a0_ltsw_cosq_thd_port_inppri_profile_set(
    int unit,
    bcm_port_t port,
    int profile_id)
{
...
static int
bcm56990_a0_ltsw_cosq_thd_port_inppri_profile_get(
    int unit,
    bcm_port_t port,
    int *profile_id)
{
...
static int
bcm56990_a0_ltsw_cosq_thd_port_pg_profile_set(
    int unit,
    bcm_port_t port,
    int profile_id)
{
...
static int
bcm56990_a0_ltsw_cosq_thd_port_pg_profile_get(
    int unit,
    bcm_port_t port,
    int *profile_id)
{
...
static int
bcm56990_a0_ltsw_cosq_thd_service_pool_set(
    int unit,
...
static int
bcm56990_a0_ltsw_cosq_thd_service_pool_get(
    int unit,
    bcm_service_pool_id_t id,
    bcm_cosq_service_pool_t *cosq_service_pool)
{
...
static int
bcm56990_a0_ltsw_cosq_thd_service_pool_override_set(
    int unit,
...
static int
bcm56990_a0_ltsw_cosq_thd_service_pool_override_get(
    int unit,
    bcm_cosq_service_pool_override_type_t type,
    bcm_service_pool_id_t *service_pool,
    int *enable)
...
static int
bcm56990_a0_ltsw_cosq_thd_priority_group_mapping_profile_set(
    int unit,
    int profile_index,
...
static int
bcm56990_a0_ltsw_cosq_thd_priority_group_mapping_profile_get(
    int unit,
    int profile_index,
    bcm_cosq_priority_group_mapping_profile_type_t type,
    int array_max,
...
static int
bcm56990_a0_ltsw_cosq_thd_port_priority_group_property_set(
    int unit,
    bcm_port_t port,
...
static int
bcm56990_a0_ltsw_cosq_thd_port_priority_group_property_get(
    int unit,
    bcm_port_t port,
    int priority_group_id,
    bcm_cosq_port_prigroup_control_t type,
...
static int
bcm56990_a0_ltsw_cosq_thd_buffer_id_multi_get(
    int unit,
    bcm_gport_t gport,
    bcm_cos_queue_t cosq,
    ...
    int *array_count)
{
    ...
    /*
     * pipes 0-3,12-15 on itm 0
     * pipes 4-11 on itm 1
     */
    if (0xF00F & (1 << pipe)) {
        itm = 0;
        itm_map |= (1 << itm);
    } else if (0xFF0 & (1 << pipe)) {
        itm = 1;
        itm_map |= (1 << itm);
    } else {
...
static int
bcm56990_a0_ltsw_cosq_thd_cpu_cosq_enable_set(
    int unit,
    bcm_cos_queue_t cosq,
    int enable)
{
...
static int
bcm56990_a0_ltsw_cosq_thd_cpu_cosq_enable_get(
    int unit,
    bcm_cos_queue_t cosq,
    int *enable)
{
...
static int
bcm56990_a0_ltsw_cosq_thd_alpha_bcm_to_lt_convert(
    int unit,
    int arg,
    const char **alpha)
{
    const char *temp_alpha;

    SHR_FUNC_ENTER(unit);

    temp_alpha = cosq_thd_int_to_alpha(arg);
    *alpha = temp_alpha;
...
static int
bcm56990_a0_ltsw_cosq_thd_alpha_lt_to_bcm_convert(
    int unit,
    const char *alpha,
    int *arg)
{
    ...
    *arg = cosq_thd_alpha_to_int(alpha);

    SHR_FUNC_EXIT();
}

static int
bcm56990_a0_ltsw_cosq_thd_byte_to_cell(
    int unit,
    uint32_t bytes,
    int *cells)
{
...
static int
bcm56990_a0_ltsw_cosq_thd_cell_to_byte(
    int unit,
    uint32_t cells,
    int *bytes)
{
...
static int
bcm56990_a0_ltsw_cosq_thd_hdrm_pool_limit_set(
    int unit,
    int hdrm_pool,
    ...
    bcm_cosq_pkt_size_dist_t *pkt_dist_array)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (tm_ltsw_cosq_thd_hdrm_pool_limit_set(unit, hdrm_pool,
                                              num_lossless_class,
...
static int
bcm56990_a0_ltsw_cosq_thd_port_prigrp_hdrm_set(
    int unit,
    bcm_port_t port,
    uint32_t pri_bmp,
    int cable_len,
    ...
    bcm_cosq_pkt_size_dist_t *pkt_dist_array)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (tm_ltsw_cosq_thd_port_prigrp_hdrm_set(unit, port, pri_bmp,cable_len,
                                               arr_size, pkt_dist_array));
...
/*!
 * \brief Cosq_thd driver function variable for bcm56990_a0 device.
 */
static mbcm_ltsw_cosq_thd_drv_t bcm56990_a0_ltsw_cosq_thd_drv = {
    .cosq_thd_init = bcm56990_a0_ltsw_cosq_thd_init,
    .cosq_thd_detach = bcm56990_a0_ltsw_cosq_thd_detach,
    .cosq_thd_dynamic_get = bcm56990_a0_ltsw_cosq_thd_dynamic_get,
    .cosq_thd_port_guarantee_reset = bcm56990_a0_ltsw_cosq_thd_port_guarantee_reset,
    .cosq_thd_control_set = bcm56990_a0_ltsw_cosq_thd_control_set,
    .cosq_thd_control_get = bcm56990_a0_ltsw_cosq_thd_control_get,
    .cosq_thd_port_uc_spid_get = bcm56990_a0_ltsw_cosq_thd_port_uc_spid_get,
    .cosq_thd_shared_limit_get = bcm56990_a0_ltsw_cosq_thd_shared_limit_get,
    .cosq_thd_port_inppri_profile_set = bcm56990_a0_ltsw_cosq_thd_port_inppri_profile_set,
    .cosq_thd_port_inppri_profile_get = bcm56990_a0_ltsw_cosq_thd_port_inppri_profile_get,
    .cosq_thd_port_pg_profile_set = bcm56990_a0_ltsw_cosq_thd_port_pg_profile_set,
    .cosq_thd_port_pg_profile_get = bcm56990_a0_ltsw_cosq_thd_port_pg_profile_get,
    .cosq_thd_service_pool_set = bcm56990_a0_ltsw_cosq_thd_service_pool_set,
    .cosq_thd_service_pool_get = bcm56990_a0_ltsw_cosq_thd_service_pool_get,
    .cosq_thd_service_pool_override_set = bcm56990_a0_ltsw_cosq_thd_service_pool_override_set,
    .cosq_thd_service_pool_override_get = bcm56990_a0_ltsw_cosq_thd_service_pool_override_get,
    .cosq_thd_priority_group_mapping_profile_set = bcm56990_a0_ltsw_cosq_thd_priority_group_mapping_profile_set,
    .cosq_thd_priority_group_mapping_profile_get = bcm56990_a0_ltsw_cosq_thd_priority_group_mapping_profile_get,
    .cosq_thd_port_priority_group_property_set = bcm56990_a0_ltsw_cosq_thd_port_priority_group_property_set,
    .cosq_thd_port_priority_group_property_get = bcm56990_a0_ltsw_cosq_thd_port_priority_group_property_get,
    .cosq_thd_buffer_id_multi_get = bcm56990_a0_ltsw_cosq_thd_buffer_id_multi_get,
    .cosq_thd_cpu_cosq_enable_set = bcm56990_a0_ltsw_cosq_thd_cpu_cosq_enable_set,
    .cosq_thd_cpu_cosq_enable_get = bcm56990_a0_ltsw_cosq_thd_cpu_cosq_enable_get,
    .cosq_thd_alpha_bcm_to_lt_convert = bcm56990_a0_ltsw_cosq_thd_alpha_bcm_to_lt_convert,
    .cosq_thd_alpha_lt_to_bcm_convert = bcm56990_a0_ltsw_cosq_thd_alpha_lt_to_bcm_convert,
    .cosq_thd_byte_to_cell = bcm56990_a0_ltsw_cosq_thd_byte_to_cell,
    .cosq_thd_cell_to_byte = bcm56990_a0_ltsw_cosq_thd_cell_to_byte,
    .cosq_thd_hdrm_pool_limit_set = bcm56990_a0_ltsw_cosq_thd_hdrm_pool_limit_set,
    .cosq_thd_port_prigrp_hdrm_set = bcm56990_a0_ltsw_cosq_thd_port_prigrp_hdrm_set
};
...
int
bcm56990_a0_ltsw_cosq_thd_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_cosq_thd_drv_set(unit, &bcm56990_a0_ltsw_cosq_thd_drv));
...
int _vn##_ltsw_cosq_thd_drv_attach(int unit) \
{ \
    SHR_FUNC_ENTER(unit); \
    SHR_IF_ERR_VERBOSE_EXIT \
        (mbcm_ltsw_cosq_thd_drv_set(unit, &bcm56990_a0_ltsw_cosq_thd_drv)); \
