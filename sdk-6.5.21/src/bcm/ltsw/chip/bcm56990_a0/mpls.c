...
static int
bcm56990_a0_ltsw_mpls_tnl_initiator_flexctr_object_get(
    int unit,
    bcm_if_t intf,
    uint32_t *value)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (xgs_ltsw_mpls_tnl_initiator_flexctr_object_get(unit, intf, value));
...
static mbcm_ltsw_mpls_drv_t bcm56990_a0_ltsw_mpls_drv = {
    ...
    .mpls_tnl_initiator_flexctr_object_get = bcm56990_a0_ltsw_mpls_tnl_initiator_flexctr_object_get,
