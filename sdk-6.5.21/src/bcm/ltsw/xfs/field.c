...
#define BCMI_TD4_PBM_FIELDS_PER_PIPE (3)
        ...
        bcmint_field_stage_info_t *stage_info)
{
    ...
    for (iter = 0; iter < lt_map_ref->num_maps; iter++) {
        if(0 == strcmp((lt_map_ref->map[iter]).lt_field_name,
            ...
            (lt_map_ref->map[iter]).value = bcmFieldSysHdrNone;
        } else {
            SHR_ERR_EXIT(SHR_E_INTERNAL);
        }
    }
...
/*!
 * \brief Clear IFP meter action configuration.
 *
 * \param [in] unit Unit Number.
 *
 * \retval SHR_E_NONE No errors.
 ...
 */
static int
ltsw_xfs_ifp_policer_action_clear(int unit)
{
    SHR_FUNC_ENTER(unit);

    /* Clear Meter action PDD table. */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_lt_clear(unit, DT_IFP_METER_ACTION_PDD_TEMPLATEs));

    /* Clear Meter action SBR table. */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_lt_clear(unit, DT_IFP_METER_ACTION_SBR_TEMPLATEs));

    /* Clear Meter action tables. */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_lt_clear(unit, DT_IFP_METER_ACTION_ACTION_TEMPLATE_0s));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_lt_clear(unit, DT_IFP_METER_ACTION_ACTION_TEMPLATE_1s));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_lt_clear(unit, DT_IFP_METER_ACTION_ACTION_TEMPLATE_2s));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_lt_clear(unit, DT_IFP_METER_ACTION_ACTION_TEMPLATE_3s));
...
/*!
 * \brief Clear EFP meter action configuration.
 *
 * \param [in] unit Unit Number.
 *
 * \retval SHR_E_NONE No errors.
 ...
 */
static int
ltsw_xfs_efp_policer_action_clear(int unit)
{
    SHR_FUNC_ENTER(unit);

    /* Clear Meter action PDD table. */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_lt_clear(unit, DT_EFP_METER_ACTION_PDD_TEMPLATEs));

    /* Clear Meter action SBR table. */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_lt_clear(unit, DT_EFP_METER_ACTION_SBR_TEMPLATEs));

    /* Clear Meter action tables. */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_lt_clear(unit, DT_EFP_METER_ACTION_ACTION_TEMPLATE_0s));
...
xfs_ltsw_ifp_clear(int unit)
{
    ...
    /* Clear field colored action configuration. */
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xfs_ifp_policer_action_clear(unit));
exit:
    SHR_FUNC_EXIT();
}
...
xfs_ltsw_efp_clear(int unit)
{
    ...
    /* Clear field colored action configuration. */
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xfs_efp_policer_action_clear(unit));
exit:
    SHR_FUNC_EXIT();
}
    ...
    uint8_t *mask)
{
    ...
    if ((stage_info->stage_id == bcmiFieldStageVlan) &&
        (BCMI_FIELD_QSET_TEST(qset, bcmiFieldQualifyUdfExtInner))) {
    ...
    for (cbmap_ct = 0; cbmap_ct < 3; cbmap_ct++) {
        for (c = 0; c < BCMINT_UDF_MAX_CHUNKS(unit); c++) {
            ...
            for (bytes = shift_val-1; bytes >= 0; bytes--) {
                ...
                data64 |= (uint64_t)(((uint64_t)data[byte_to_copy]) << ((bytes) * 8));
                mask64 |= (uint64_t)(((uint64_t)mask[byte_to_copy]) << ((bytes) * 8));
                byte_to_copy++;
                len--;
            }
    ...
    char **cont_name)
{
    ...
    if (stage_info->stage_id == bcmiFieldStageIngress) {
        ...
        switch (mirror_cont) {
            case bcmiMirrorCon0:
                *cont_name = "ING_CMD_BUS_L2_IIF_SVP_MIRROR_INDEX_0";
                break;
            default:
                *cont_name = NULL;
                SHR_ERR_EXIT(SHR_E_NOT_FOUND);
        ...
        bcm_port_t *port)
{
    ...
    if (BCM_GPORT_IS_MODPORT(gport)) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmi_ltsw_id_port_to_l2_if(unit, gport, port));
    } else {
        SHR_IF_ERR_VERBOSE_EXIT
    ...
    switch (action) {
        ...
        case bcmFieldActionRpStatGroup:
            *action_value = params->param0;
            break;
        case bcmFieldActionSrcNetworkGroup:
            *action_value = ((uint64_t)1 << params->param0);
            break;
...
{
    int l_port = 0, shift = 0;
    int port_pipe = 0, l_port_index = 0;
    uint16_t *pbmp_ptr = NULL;
        ...
        bcm_policer_t policer_id)
{
    ...
    if (entry_oper->color_pool_id != -1) {
        pool_id = entry_oper->color_pool_id;
    } else {
        ...
        uint32_t *entry_idx)
{
    ...
    if (0 == strcmp(table_name, "IFTA80_E2T_00_B0_DOUBLEm")) {
        *table_id = 6;
    } else if (0 == strcmp(table_name, "IFTA80_E2T_00_B0_QUADm")) {
        *table_id = 6;
        *entry_idx = (*entry_idx * 2);
    } else if (0 == strcmp(table_name, "IFTA80_E2T_00_B1_DOUBLEm")) {
        *table_id = 7;
    } else if (0 == strcmp(table_name, "IFTA80_E2T_00_B1_QUADm")) {
        *table_id = 7;
        *entry_idx = (*entry_idx * 2);
    } else if (0 == strcmp(table_name, "IFTA80_E2T_01_B0_DOUBLEm")) {
        *table_id = 8;
    } else if (0 == strcmp(table_name, "IFTA80_E2T_01_B0_QUADm")) {
        *table_id = 8;
        *entry_idx = (*entry_idx * 2);
    } else if (0 == strcmp(table_name, "IFTA80_E2T_01_B1_DOUBLEm")) {
        *table_id = 9;
    } else if (0 == strcmp(table_name, "IFTA80_E2T_01_B1_QUADm")) {
        *table_id = 9;
        *entry_idx = (*entry_idx * 2);
    } else if (0 == strcmp(table_name, "IFTA80_E2T_02_B0_DOUBLEm")) {
        *table_id = 10;
    } else if (0 == strcmp(table_name, "IFTA80_E2T_02_B0_QUADm")) {
        *table_id = 10;
        *entry_idx = (*entry_idx * 2);
    } else if (0 == strcmp(table_name, "IFTA80_E2T_02_B1_DOUBLEm")) {
        *table_id = 11;
    } else if (0 == strcmp(table_name, "IFTA80_E2T_02_B1_QUADm")) {
        *table_id = 11;
        *entry_idx = (*entry_idx * 2);
    } else if (0 == strcmp(table_name, "IFTA80_E2T_03_B0_DOUBLEm")) {
        *table_id = 12;
    } else if (0 == strcmp(table_name, "IFTA80_E2T_03_B0_QUADm")) {
        *table_id = 12;
        *entry_idx = (*entry_idx * 2);
    } else if (0 == strcmp(table_name, "IFTA80_E2T_03_B1_DOUBLEm")) {
        *table_id = 13;
    } else if (0 == strcmp(table_name, "IFTA80_E2T_03_B1_QUADm")) {
        *table_id = 13;
        *entry_idx = (*entry_idx * 2);
    } else if (0 == strcmp(table_name, "IFTA90_E2T_00_B0_DOUBLEm")) {
        *table_id = 0;
    ...
    bcm_gport_t mirror_gport)
{
    ...
    /* Add EM_FP to flags if stage in Exact Match */
    if (stage_info->stage_id == bcmiFieldStageExactMatch) {
        flags |= BCMI_LTSW_MIRROR_EM_FP;
    }
