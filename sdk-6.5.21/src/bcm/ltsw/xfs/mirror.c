...
/*! FP mirroring. */
#define MIRROR_CONTAINER_NUM_FP 4

/*! Exact match mirroring. */
#define MIRROR_CONTAINER_NUM_EM_FP 1

/*! Flowtracker mirroring. */
#define MIRROR_CONTAINER_NUM_EM_FT 1
...
/*! The minimum container id for Exact match mirroring. */
#define MIRROR_CONTAINER_FM_FP_MIN 0

/*! The minimum container id for Flowtracker mirroring. */
#define MIRROR_CONTAINER_FM_FT_MIN 0
...
/*
 * Data structure to store truncate profile information.
 */
typedef struct mirror_truncate_profile_id_s {
...
typedef struct mirror_truncate_info_s {
    ...
    /* Truncate length profile base index. */
    int length_prf_base_idx;

    /* Truncate length profile id used bitmap. */
    SHR_BITDCL *length_prf_bmp;

    /* Truncate info for non-encap mirroring. */
    mirror_truncate_profile_id_t *non_encap;
...
/* Mirror truncate length profile base index. */
#define MIRROR_TRUNCATE_LENGTH_PRF_BASE_IDX(unit) \
    (mirror_truncate_info[unit].length_prf_base_idx)

/* Mirror truncate length profile ID of non-encap mirroring. */
#define MIRROR_TRUNCATE_LENGTH_PRF_ID_NON_ENCAP(unit) \
    (mirror_truncate_info[unit].non_encap->prf_id)

/* Ref count of mirror truncate length profile ID of non-encap mirroring. */
#define MIRROR_TRUNCATE_LENGTH_PRF_ID_NON_ENCAP_REF_CNT(unit) \
    (mirror_truncate_info[unit].non_encap->ref_cnt)
                             ...
                             mirror_encap_profile_entry_t *entry)
{
    ...
    bcmi_lt_field_t field[] =
    {
        ...
        /*3*/ {TPIDs, 0, 0, {0}},
        /*4*/ {VNTAGs, 0, 0, {0}},
        /*5*/ {SRC_NIV_VIFs, 0, 0, {0}},
        /*6*/ {DST_NIV_VIFs, 0, 0, {0}},
        /*7*/ {PRIs, 0, 0, {0}},
        /*8*/ {CFIs, 0, 0, {0}},
        /*9*/ {TRUNCATEs, 0, 0, {0}},
        /*10*/ {TRUNCATE_ACTIONs, BCMI_LT_FIELD_F_SYMBOL, 0, {0}},
        /*11*/ {MIRROR_TRUNCATE_LENGTH_IDs, 0, 0, {0}},
    };
    ...
    field[9].u.val = entry->truncate;
    if (entry->truncate_mode == bcmMirrorTruncateDefault) {
        field[10].u.sym_val = TRUNCATEs;
    } else if (entry->truncate_mode == bcmMirrorTruncateAdjustment) {
        field[10].u.sym_val = TRUNCATE_ADJUSTs;
    }
    field[11].u.val =
        entry->truncate_profile_id + MIRROR_TRUNCATE_LENGTH_PRF_BASE_IDX(unit);
                             ...
                             mirror_encap_profile_entry_t *entry)
{
    ...
    entry->truncate = field[9].u.val;
    entry->truncate_mode = bcmMirrorTruncateDefault;
    if (entry->truncate) {
        if ((field[10].flags & BCMI_LT_FIELD_F_GET) &&
            (sal_strcmp(field[10].u.sym_val, TRUNCATE_ADJUSTs) == 0)) {
            entry->truncate_mode = bcmMirrorTruncateAdjustment;
        }
        entry->truncate_profile_id =
            field[11].u.val - MIRROR_TRUNCATE_LENGTH_PRF_BASE_IDX(unit);
    }
                              ...
                              mirror_encap_profile_entry_t *entry)
{
    ...
    bcmi_lt_field_t field[] =
    {
        ...
        /*10*/ {ETHERTYPEs, 0, 0, {0}},
        /*11*/ {OUTER_VLANs, 0, 0, {0}},
        /*12*/ {VLAN_IDs, 0, 0, {0}},
        /*13*/ {TPIDs, 0, 0, {0}},
        /*14*/ {GRE_HEADERs, 0, 0, {0}},
        /*15*/ {SESSION_IDs, 0, 0, {0}},
        /*16*/ {SWITCH_IDs, 0, 0, {0}},
        /*17*/ {SEQs, 0, 0, {0}},
        /*18*/ {HIGIG3s, 0, 0, {0}},
        /*19*/ {HIGIG3_ETHERTYPEs, 0, 0, {0}},
        /*20*/ {HIGIG3_BASE_HDRs, 0, 0, {0}},
        /*21*/ {ERSPAN3_SUB_HDR_HW_IDs, 0, 0, {0}},
        /*22*/ {ERSPAN3_SUB_HDR_TS_GRAs, 0, 0, {0}},
        /*23*/ {ERSPAN3_SUB_HDR_OPT_SUB_HDRs, 0, 0, {0}},
        /*24*/ {PRIs, 0, 0, {0}},
        /*25*/ {CFIs, 0, 0, {0}},
        /*26*/ {TRUNCATEs, 0, 0, {0}},
        /*27*/ {TRUNCATE_ACTIONs, BCMI_LT_FIELD_F_SYMBOL, 0, {0}},
        /*28*/ {MIRROR_TRUNCATE_LENGTH_IDs, 0, 0, {0}},
    };
    bcmlt_field_def_t fld_def;
    int rv, i;
    ...
    field[26].u.val = entry->truncate;
    if (entry->truncate_mode == bcmMirrorTruncateDefault) {
        field[27].u.sym_val = TRUNCATEs;
    } else if (entry->truncate_mode == bcmMirrorTruncateAdjustment) {
        field[27].u.sym_val = TRUNCATE_ADJUSTs;
    }
    field[28].u.val =
        entry->truncate_profile_id + MIRROR_TRUNCATE_LENGTH_PRF_BASE_IDX(unit);
                              ...
                              mirror_encap_profile_entry_t *entry)
{
    ...
    entry->truncate = field[26].u.val;
    entry->truncate_mode = bcmMirrorTruncateDefault;
    if (entry->truncate) {
        if ((field[27].flags & BCMI_LT_FIELD_F_GET) &&
            (sal_strcmp(field[27].u.sym_val, TRUNCATE_ADJUSTs) == 0)) {
            entry->truncate_mode = bcmMirrorTruncateAdjustment;
        }
        entry->truncate_profile_id =
            field[28].u.val - MIRROR_TRUNCATE_LENGTH_PRF_BASE_IDX(unit);
    }
                                   ...
                                   mirror_encap_profile_entry_t *entry)
{
    ...
    bcmi_lt_field_t field[] =
    {
        ...
        /*14*/ {VLAN_IDs, 0, 0, {0}},
        /*15*/ {TPIDs, 0, 0, {0}},
        /*16*/ {GRE_HEADERs, 0, 0, {0}},
        /*17*/ {SESSION_IDs, 0, 0, {0}},
        /*18*/ {SWITCH_IDs, 0, 0, {0}},
        /*19*/ {SEQs, 0, 0, {0}},
        /*20*/ {HIGIG3s, 0, 0, {0}},
        /*21*/ {HIGIG3_ETHERTYPEs, 0, 0, {0}},
        /*22*/ {HIGIG3_BASE_HDRs, 0, 0, {0}},
        /*23*/ {ERSPAN3_SUB_HDR_HW_IDs, 0, 0, {0}},
        /*24*/ {ERSPAN3_SUB_HDR_TS_GRAs, 0, 0, {0}},
        /*25*/ {ERSPAN3_SUB_HDR_OPT_SUB_HDRs, 0, 0, {0}},
        /*26*/ {PRIs, 0, 0, {0}},
        /*27*/ {CFIs, 0, 0, {0}},
        /*28*/ {TRUNCATEs, 0, 0, {0}},
        /*29*/ {TRUNCATE_ACTIONs, BCMI_LT_FIELD_F_SYMBOL, 0, {0}},
        /*30*/ {MIRROR_TRUNCATE_LENGTH_IDs, 0, 0, {0}},
    };
    bcmlt_field_def_t fld_def;
    int rv, i;
    ...
    field[28].u.val = entry->truncate;
    if (entry->truncate_mode == bcmMirrorTruncateDefault) {
        field[29].u.sym_val = TRUNCATEs;
    } else if (entry->truncate_mode == bcmMirrorTruncateAdjustment) {
        field[29].u.sym_val = TRUNCATE_ADJUSTs;
    }
    field[30].u.val =
        entry->truncate_profile_id + MIRROR_TRUNCATE_LENGTH_PRF_BASE_IDX(unit);
                                   ...
                                   mirror_encap_profile_entry_t *entry)
{
    ...
    entry->truncate = field[28].u.val;
    entry->truncate_mode = bcmMirrorTruncateDefault;
    if (entry->truncate) {
        if ((field[29].flags & BCMI_LT_FIELD_F_GET) &&
            (sal_strcmp(field[29].u.sym_val, TRUNCATE_ADJUSTs) == 0)) {
            entry->truncate_mode = bcmMirrorTruncateAdjustment;
        }
        entry->truncate_profile_id =
            field[30].u.val - MIRROR_TRUNCATE_LENGTH_PRF_BASE_IDX(unit);
    }
                             ...
                             mirror_encap_profile_entry_t *entry)
{
    ...
    bcmi_lt_field_t field[] =
    {
        ...
        /*19*/ {METADATAs, 0, 0, {0}},
        /*20*/ {IPFIX_VERSIONs, 0, 0, {0}},
        /*21*/ {PSAMP_EPOCHs, 0, 0, {0}},
        /*22*/ {VARIABLE_FLAGs, 0, 0, {0}},
        /*23*/ {HIGIG3s, 0, 0, {0}},
        /*24*/ {HIGIG3_ETHERTYPEs, 0, 0, {0}},
        /*25*/ {HIGIG3_BASE_HDRs, 0, 0, {0}},
        /*26*/ {PRIs, 0, 0, {0}},
        /*27*/ {CFIs, 0, 0, {0}},
        /*28*/ {TRUNCATEs, 0, 0, {0}},
        /*29*/ {TRUNCATE_ACTIONs, BCMI_LT_FIELD_F_SYMBOL, 0, {0}},
                             ...
                             mirror_encap_profile_entry_t *entry)
{
    ...
    bcmi_lt_field_t field[] =
    {
        ...
        /*16*/ {OBSERVATION_DOMAINs, 0, 0, {0}},
        /*17*/ {TEMPLATE_IDENTIFIERs, 0, 0, {0}},
        /*18*/ {METADATA_TYPEs, BCMI_LT_FIELD_F_SYMBOL, 0, {0}},
        /*19*/ {METADATAs, 0, 0, {0}},
        /*20*/ {IPFIX_VERSIONs, 0, 0, {0}},
        /*21*/ {PSAMP_EPOCHs, 0, 0, {0}},
        /*22*/ {VARIABLE_FLAGs, 0, 0, {0}},
                                  ...
                                  mirror_encap_profile_entry_t *entry)
{
    ...
    bcmi_lt_field_t field[] =
    {
        ...
        /*21*/ {METADATAs, 0, 0, {0}},
        /*22*/ {IPFIX_VERSIONs, 0, 0, {0}},
        /*23*/ {PSAMP_EPOCHs, 0, 0, {0}},
        /*24*/ {VARIABLE_FLAGs, 0, 0, {0}},
        /*25*/ {HIGIG3s, 0, 0, {0}},
        /*26*/ {HIGIG3_ETHERTYPEs, 0, 0, {0}},
        /*27*/ {HIGIG3_BASE_HDRs, 0, 0, {0}},
        /*28*/ {PRIs, 0, 0, {0}},
        /*29*/ {CFIs, 0, 0, {0}},
        /*30*/ {TRUNCATEs, 0, 0, {0}},
        /*31*/ {TRUNCATE_ACTIONs, BCMI_LT_FIELD_F_SYMBOL, 0, {0}},
        /*32*/ {MIRROR_TRUNCATE_LENGTH_IDs, 0, 0, {0}},
    };
    bcmlt_field_def_t fld_def;
    int rv, i;
    ...
    field[30].u.val = entry->truncate;
    if (entry->truncate_mode == bcmMirrorTruncateDefault) {
        field[31].u.sym_val = TRUNCATEs;
    } else if (entry->truncate_mode == bcmMirrorTruncateAdjustment) {
        field[31].u.sym_val = TRUNCATE_ADJUSTs;
    }
    field[32].u.val =
        entry->truncate_profile_id + MIRROR_TRUNCATE_LENGTH_PRF_BASE_IDX(unit);
                                  ...
                                  mirror_encap_profile_entry_t *entry)
{
    ...
    bcmi_lt_field_t field[] =
    {
        ...
        /*18*/ {OBSERVATION_DOMAINs, 0, 0, {0}},
        /*19*/ {TEMPLATE_IDENTIFIERs, 0, 0, {0}},
        /*20*/ {METADATA_TYPEs, BCMI_LT_FIELD_F_SYMBOL, 0, {0}},
        /*21*/ {METADATAs, 0, 0, {0}},
        /*22*/ {IPFIX_VERSIONs, 0, 0, {0}},
        /*23*/ {PSAMP_EPOCHs, 0, 0, {0}},
        /*24*/ {VARIABLE_FLAGs, 0, 0, {0}},
    ...
    entry->truncate = field[30].u.val;
    entry->truncate_mode = bcmMirrorTruncateDefault;
    if (entry->truncate) {
        if ((field[31].flags & BCMI_LT_FIELD_F_GET) &&
            (sal_strcmp(field[31].u.sym_val, TRUNCATE_ADJUSTs) == 0)) {
            entry->truncate_mode = bcmMirrorTruncateAdjustment;
        }
        entry->truncate_profile_id =
            field[32].u.val - MIRROR_TRUNCATE_LENGTH_PRF_BASE_IDX(unit);
    }
                             ...
                             mirror_encap_profile_entry_t *entry)
{
    ...
    bcmi_lt_field_t field[] =
    {
        ...
        /*22*/ {CFIs, 0, 0, {0}},
        /*23*/ {TRUNCATEs, 0, 0, {0}},
        /*24*/ {TRUNCATE_ACTIONs, BCMI_LT_FIELD_F_SYMBOL, 0, {0}},
        /*25*/ {MIRROR_TRUNCATE_LENGTH_IDs, 0, 0, {0}},
    };
    bcmlt_field_def_t fld_def;
    int rv, i;
    ...
    field[23].u.val = entry->truncate;
    if (entry->truncate_mode == bcmMirrorTruncateDefault) {
        field[24].u.sym_val = TRUNCATEs;
    } else if (entry->truncate_mode == bcmMirrorTruncateAdjustment) {
        field[24].u.sym_val = TRUNCATE_ADJUSTs;
    }
    field[25].u.val =
        entry->truncate_profile_id + MIRROR_TRUNCATE_LENGTH_PRF_BASE_IDX(unit);
                             ...
                             mirror_encap_profile_entry_t *entry)
{
    ...
    bcmi_lt_field_t field[] =
    {
        ...
        /*14*/ {VLAN_IDs, 0, 0, {0}},
        /*15*/ {TPIDs, 0, 0, {0}},
        /*16*/ {METADATA_TYPEs, BCMI_LT_FIELD_F_SYMBOL, 0, {0}},
        /*17*/ {METADATAs, 0, 0, {0}},
        /*18*/ {HIGIG3s, 0, 0, {0}},
        /*19*/ {HIGIG3_ETHERTYPEs, 0, 0, {0}},
        /*20*/ {HIGIG3_BASE_HDRs, 0, 0, {0}},
    ...
    entry->truncate = field[23].u.val;
    entry->truncate_mode = bcmMirrorTruncateDefault;
    if (entry->truncate) {
        if ((field[24].flags & BCMI_LT_FIELD_F_GET) &&
            (sal_strcmp(field[24].u.sym_val, TRUNCATE_ADJUSTs) == 0)) {
            entry->truncate_mode = bcmMirrorTruncateAdjustment;
        }
        entry->truncate_profile_id =
            field[25].u.val - MIRROR_TRUNCATE_LENGTH_PRF_BASE_IDX(unit);
    }
                                  ...
                                  mirror_encap_profile_entry_t *entry)
{
    ...
    bcmi_lt_field_t field[] =
    {
        ...
        /*24*/ {CFIs, 0, 0, {0}},
        /*25*/ {TRUNCATEs, 0, 0, {0}},
        /*26*/ {TRUNCATE_ACTIONs, BCMI_LT_FIELD_F_SYMBOL, 0, {0}},
        /*27*/ {MIRROR_TRUNCATE_LENGTH_IDs, 0, 0, {0}},
    };
    bcmlt_field_def_t fld_def;
    int rv, i;
    ...
    field[25].u.val = entry->truncate;
    if (entry->truncate_mode == bcmMirrorTruncateDefault) {
        field[26].u.sym_val = TRUNCATEs;
    } else if (entry->truncate_mode == bcmMirrorTruncateAdjustment) {
        field[26].u.sym_val = TRUNCATE_ADJUSTs;
    }
    field[27].u.val =
        entry->truncate_profile_id + MIRROR_TRUNCATE_LENGTH_PRF_BASE_IDX(unit);
                                  ...
                                  mirror_encap_profile_entry_t *entry)
{
    ...
    entry->truncate = field[25].u.val;
    entry->truncate_mode = bcmMirrorTruncateDefault;
    if (entry->truncate) {
        if ((field[26].flags & BCMI_LT_FIELD_F_GET) &&
            (sal_strcmp(field[26].u.sym_val, TRUNCATE_ADJUSTs) == 0)) {
            entry->truncate_mode = bcmMirrorTruncateAdjustment;
        }
        entry->truncate_profile_id =
            field[27].u.val - MIRROR_TRUNCATE_LENGTH_PRF_BASE_IDX(unit);
    }
                                      ...
                                      mirror_encap_profile_entry_t *entry)
{
    ...
    bcmi_lt_field_t field[] =
    {
        ...
        /*26*/ {PRIs, 0, 0, {0}},
        /*27*/ {CFIs, 0, 0, {0}},
        /*28*/ {MODEs, BCMI_LT_FIELD_F_SYMBOL, 0, {0}},
        /*29*/ {TRUNCATEs, 0, 0, {0}},
        /*30*/ {TRUNCATE_ACTIONs, BCMI_LT_FIELD_F_SYMBOL, 0, {0}},
        /*31*/ {MIRROR_TRUNCATE_LENGTH_IDs, 0, 0, {0}},
    };
    bcmlt_field_def_t fld_def;
    int rv, i;
    ...
    field[29].u.val = entry->truncate;
    if (entry->truncate_mode == bcmMirrorTruncateDefault) {
        field[30].u.sym_val = TRUNCATEs;
    } else if (entry->truncate_mode == bcmMirrorTruncateAdjustment) {
        field[30].u.sym_val = TRUNCATE_ADJUSTs;
    }
    field[31].u.val =
        entry->truncate_profile_id + MIRROR_TRUNCATE_LENGTH_PRF_BASE_IDX(unit);
                                      ...
                                      mirror_encap_profile_entry_t *entry)
{
    ...
    bcmi_lt_field_t field[] =
    {
        ...
        /*23*/ {HIGIG3_ETHERTYPEs, 0, 0, {0}},
        /*24*/ {HIGIG3_BASE_HDRs, 0, 0, {0}},
        /*25*/ {METADATA_TYPEs, BCMI_LT_FIELD_F_SYMBOL, 0, {0}},
        /*26*/ {PRIs, 0, 0, {0}},
        /*27*/ {CFIs, 0, 0, {0}},
        /*28*/ {MODEs, BCMI_LT_FIELD_F_SYMBOL, 0, {0}},
        /*29*/ {TRUNCATEs, 0, 0, {0}},
    ...
    entry->truncate = field[29].u.val;
    entry->truncate_mode = bcmMirrorTruncateDefault;
    if (entry->truncate) {
        if ((field[30].flags & BCMI_LT_FIELD_F_GET) &&
            (sal_strcmp(field[30].u.sym_val, TRUNCATE_ADJUSTs) == 0)) {
            entry->truncate_mode = bcmMirrorTruncateAdjustment;
        }
        entry->truncate_profile_id =
            field[31].u.val - MIRROR_TRUNCATE_LENGTH_PRF_BASE_IDX(unit);
    }
                                           ...
                                           mirror_encap_profile_entry_t *entry)
{
    ...
    bcmi_lt_field_t field[] =
    {
        ...
        /*28*/ {PRIs, 0, 0, {0}},
        /*29*/ {CFIs, 0, 0, {0}},
        /*30*/ {MODEs, BCMI_LT_FIELD_F_SYMBOL, 0, {0}},
        /*31*/ {TRUNCATEs, 0, 0, {0}},
        /*32*/ {TRUNCATE_ACTIONs, BCMI_LT_FIELD_F_SYMBOL, 0, {0}},
        /*33*/ {MIRROR_TRUNCATE_LENGTH_IDs, 0, 0, {0}},
    };
    bcmlt_field_def_t fld_def;
    int rv, i;
    ...
    field[31].u.val = entry->truncate;
    if (entry->truncate_mode == bcmMirrorTruncateDefault) {
        field[32].u.sym_val = TRUNCATEs;
    } else if (entry->truncate_mode == bcmMirrorTruncateAdjustment) {
        field[32].u.sym_val = TRUNCATE_ADJUSTs;
    }
    field[33].u.val =
        entry->truncate_profile_id + MIRROR_TRUNCATE_LENGTH_PRF_BASE_IDX(unit);
                                           ...
                                           mirror_encap_profile_entry_t *entry)
{
    ...
    bcmi_lt_field_t field[] =
    {
        ...
        /*25*/ {HIGIG3_ETHERTYPEs, 0, 0, {0}},
        /*26*/ {HIGIG3_BASE_HDRs, 0, 0, {0}},
        /*27*/ {METADATA_TYPEs, BCMI_LT_FIELD_F_SYMBOL, 0, {0}},
        /*28*/ {PRIs, 0, 0, {0}},
        /*29*/ {CFIs, 0, 0, {0}},
        /*30*/ {MODEs, BCMI_LT_FIELD_F_SYMBOL, 0, {0}},
        /*31*/ {TRUNCATEs, 0, 0, {0}},
    ...
    entry->truncate = field[31].u.val;
    entry->truncate_mode = bcmMirrorTruncateDefault;
    if (entry->truncate) {
        if ((field[32].flags & BCMI_LT_FIELD_F_GET) &&
            (sal_strcmp(field[32].u.sym_val, TRUNCATE_ADJUSTs) == 0)) {
            entry->truncate_mode = bcmMirrorTruncateAdjustment;
        }
        entry->truncate_profile_id =
            field[33].u.val - MIRROR_TRUNCATE_LENGTH_PRF_BASE_IDX(unit);
    }
                             ...
                             mirror_encap_profile_entry_t *entry)
{
    ...
    for (i = 1; i < lt_entry.nfields; i++) {
        if (i == 17) {
            /* VXLAN_VNIDs is determine by entry->encap.vxlan.vxlan_type */
            continue;
        }
        rv = bcmi_lt_field_def_get(unit,
                                   MIRROR_ENCAP_VXLANs,
                             ...
                             mirror_encap_profile_entry_t *entry)
{
    ...
    bcmi_lt_field_t field[] =
    {
        ...
        /*14*/ {VLAN_IDs, 0, 0, {0}},
        /*15*/ {TPIDs, 0, 0, {0}},
        /*16*/ {VXLAN_TYPEs, BCMI_LT_FIELD_F_SYMBOL, 0, {0}},
        /*17*/ {VXLAN_VNIDs, 0, 0, {0}},
        /*18*/ {HIGIG3s, 0, 0, {0}},
        /*19*/ {HIGIG3_ETHERTYPEs, 0, 0, {0}},
        /*20*/ {HIGIG3_BASE_HDRs, 0, 0, {0}},
                                  ...
                                  mirror_encap_profile_entry_t *entry)
{
    ...
    bcmi_lt_field_t field[] =
    {
        ...
        /*16*/ {VLAN_IDs, 0, 0, {0}},
        /*17*/ {TPIDs, 0, 0, {0}},
        /*18*/ {VXLAN_TYPEs, BCMI_LT_FIELD_F_SYMBOL, 0, {0}},
        /*19*/ {VXLAN_VNIDs, 0, 0, {0}},
        /*20*/ {HIGIG3s, 0, 0, {0}},
        /*21*/ {HIGIG3_ETHERTYPEs, 0, 0, {0}},
        /*22*/ {HIGIG3_BASE_HDRs, 0, 0, {0}},
                             ...
                             mirror_encap_profile_entry_t *entry)
{
    ...
    {
        /*0*/ {MIRROR_ENCAP_IDs, BCMI_LT_FIELD_F_SET, 0, {0}},
        /*1*/ {ENCAP_MODEs, BCMI_LT_FIELD_F_SYMBOL, 0, {0}},
        /*2*/ {TRUNCATEs, 0, 0, {0}},
        /*3*/ {TRUNCATE_ACTIONs, BCMI_LT_FIELD_F_SYMBOL, 0, {0}},
    ...
    if (!entry->lb_ena && !entry->truncate) {
        SHR_EXIT();
    }
    ...
    for (i = 1; i < lt_entry.nfields; i++) {
        ...
        if (SHR_SUCCESS(rv)) {
            if (i == 2 || i == 3 || i == 4) {
                /* Only enable when truncation is enabled. */
                if (entry->truncate) {
                    field[i].flags |= BCMI_LT_FIELD_F_SET;
                }
            } else {
    ...
    if (entry->lb_ena) {
        ...
        field[1].u.sym_val = ENCAP_NONEs;
    }
    if (entry->truncate) {
        field[2].u.val = entry->truncate;
        if (entry->truncate_mode == bcmMirrorTruncateDefault) {
            field[3].u.sym_val = TRUNCATEs;
        } else if (entry->truncate_mode == bcmMirrorTruncateAdjustment) {
            field[3].u.sym_val = TRUNCATE_ADJUSTs;
        }
        field[4].u.val =
            entry->truncate_profile_id + MIRROR_TRUNCATE_LENGTH_PRF_BASE_IDX(unit);
    }
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_lt_entry_set(unit, MIRROR_ENCAP_BASICs, &lt_entry, NULL));
                             ...
                             mirror_encap_profile_entry_t *entry)
{
    ...
    if (sal_strcmp(field[1].u.sym_val, ENCAP_NONEs) == 0) {
        entry->lb_ena = false;
    } else if (sal_strcmp(field[1].u.sym_val, NO_ENCAP_LOOPBACKs) == 0) {
        entry->lb_ena = true;
        entry->lb_header.loopback_header_type = bcmMirrorLoopbackHeaderGeneric;
    } else if (sal_strcmp(field[1].u.sym_val, ENCAP_IFA_LOOPBACKs) == 0) {
        entry->lb_ena = true;
        entry->lb_header.loopback_header_type = bcmMirrorLoopbackHeaderIfa;
    }
    entry->truncate = field[2].u.val;
    entry->truncate_mode = bcmMirrorTruncateDefault;
    if (entry->truncate) {
        if ((field[3].flags & BCMI_LT_FIELD_F_GET) &&
            (sal_strcmp(field[3].u.sym_val, TRUNCATE_ADJUSTs) == 0)) {
            entry->truncate_mode = bcmMirrorTruncateAdjustment;
        }
        entry->truncate_profile_id =
            field[4].u.val - MIRROR_TRUNCATE_LENGTH_PRF_BASE_IDX(unit);
    }
    ...
    mirror_encap_profile_entry_t *entry)
{
    ...
    /*
     * PROCESSING_CTRL_0 must be set as 0x5
     * (loopback_hdr_dst_valid[2:2] + loopback_hdr_qos_valid[0:0]).
     */
    entry->lb_header.processing_ctrl_0 = 0x5;
    ...
    mirror_encap_profile_entry_t *entry)
{
    ...
    {
        /*0*/ {MIRROR_ENCAP_IDs, BCMI_LT_FIELD_F_SET, 0, {0}},
        /*1*/ {PROBE_MARKER_1s, 0, 0, {0}},
        /*2*/ {PROBE_MARKER_2s, 0, 0, {0}},
        /*3*/ {VERSIONs, 0, 0, {0}},
        /*4*/ {MSG_TYPEs, 0, 0, {0}},
        /*5*/ {REQUEST_VECTORs, 0, 0, {0}},
        /*6*/ {ACTION_VECTORs, 0, 0, {0}},
        /*7*/ {HOP_LIMITs, 0, 0, {0}},
        /*8*/ {MAX_LENGTHs, 0, 0, {0}},
        /*9*/ {TRUNCATEs, 0, 0, {0}},
        /*10*/ {TRUNCATE_ACTIONs, BCMI_LT_FIELD_F_SYMBOL, 0, {0}},
                       ...
                       mirror_encap_profile_entry_t *entry)
{
    ...
    bcmi_lt_field_t instance_field[] =
    {
        ...
        /*2*/ {SYSTEM_PORT_TABLE_IDs, BCMI_LT_FIELD_F_SET, 0, {0}},
    };
    ...
    instance_field[2].u.val = entry->sys_port;
                       ...
                       mirror_encap_profile_entry_t *entry)
{
    ...
    bcmi_lt_field_t instance_field[] =
    {
        ...
        /*2*/ {SYSTEM_PORT_TABLE_IDs, BCMI_LT_FIELD_F_GET, 0, {0}},
    };
    ...
    entry->sys_port = instance_field[2].u.val;
                                 ...
                                 mirror_encap_lb_header_t *lb_header)
{
    ...
    /* second_pass_dst_port */
    if (mirror_dest->loopback_header_type == bcmMirrorLoopbackHeaderIfa) {
...
/*!
 * \brief Destroy mirror encap loopback header.
 *
 * \param [in] unit Unit Number.
 * \param [in] mirror_dest Mirror destination structure.
 *
 ...
 */
static int
mirror_encap_lb_header_destroy(
    int unit,
    bcm_mirror_destination_t *mirror_dest)
{
    SHR_FUNC_ENTER(unit);
    ...
    if ((mirror_dest->flags2 & BCM_MIRROR_DEST_FLAGS2_INT_PROBE) &&
        ...
        xfs_mirror_db[unit]->ifa_1_probe_encap_npl_lb_header) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmi_ltsw_stk_ifa_system_source_destroy(unit));
    }
                               ...
                               bcm_mirror_destination_t *mirror_dest)
{
    ...
    if ((mirror_dest->flags2 & BCM_MIRROR_DEST_FLAGS2_INT_PROBE) &&
        xfs_mirror_db[unit] &&
        xfs_mirror_db[unit]->ifa_1_probe_encap_npl_lb_header) {
        /* INT Probe doesn't configure second_pass_src_port, do nothing. */
    } else {
                                ...
                                int *index)
{
    ...
    if (type == ENCAP_MIRROR_ON_DROP) {
        ...
        entry.encap.mirror_on_drop.switch_id = mirror_dest->switch_id;
        ...
        entry.encap.mirror_on_drop_ipv6.switch_id = mirror_dest->switch_id;
                                ...
                                bcm_mirror_destination_t *mirror_dest)
{
    ...
    mirror_dest->switch_id = entry.encap.mirror_on_drop.switch_id;
    if (entry.encap.mirror_on_drop.seq_ena) {
        mirror_dest->flags |= BCM_MIRROR_DEST_TUNNEL_WITH_SEQ;
                                     ...
                                     bcm_mirror_destination_t *mirror_dest)
{
    ...
    mirror_dest->switch_id = entry.encap.mirror_on_drop_ipv6.switch_id;
    if (entry.encap.mirror_on_drop_ipv6.seq_ena) {
        mirror_dest->flags |= BCM_MIRROR_DEST_TUNNEL_WITH_SEQ;
        mirror_dest->initial_seq_number =
            entry.encap.mirror_on_drop_ipv6.seq_num;
    ...
    int index)
{
    ...
    /* Destroy LB header that has been created. */
    SHR_IF_ERR_VERBOSE_EXIT
        (mirror_encap_lb_header_destroy(unit, mirror_dest));
                 ...
                 bcm_mirror_destination_t *mirror_dest, int *index)
{
    ...
    if (!MIRROR_DEST_IS_TUNNEL(mirror_dest)) {
        bool update_ref_cnt = FALSE, update_prf_id = FALSE;
        sal_memset(&entry, 0, sizeof(mirror_encap_profile_entry_t));
        ...
        /* All non-encap mirroring must share one truncate profile ID. */
        if (entry.truncate &&
            xfs_mirror_db[unit] &&
            xfs_mirror_db[unit]->all_non_encap_one_truncate_prf) {
            update_ref_cnt = TRUE;

            /* Check if the profile ID is the same as existing one. */
            if (MIRROR_TRUNCATE_LENGTH_PRF_ID_NON_ENCAP_REF_CNT(unit) == 0) {
                update_prf_id = TRUE;
            } else if (MIRROR_TRUNCATE_LENGTH_PRF_ID_NON_ENCAP(unit) !=
                       mirror_dest->encap_truncate_profile_id) {
                LOG_ERROR(BSL_LOG_MODULE,
                          (BSL_META_U(unit,
                                      "All non-encap mirroring must share the "
                                      "same truncation profile ID.\n"
                                      "non_encap_prf_id(%d) has been "
                                      "created before.\n"),
                           MIRROR_TRUNCATE_LENGTH_PRF_ID_NON_ENCAP(unit)));
                SHR_ERR_EXIT(SHR_E_RESOURCE);
            }
        }
        entry.truncate_profile_id = mirror_dest->encap_truncate_profile_id;
        ...
        /* Update reference count and truncate profile ID of non-encap mirroring. */
        if (update_ref_cnt) {
            if (update_prf_id) {
                MIRROR_TRUNCATE_LENGTH_PRF_ID_NON_ENCAP(unit) =
                    entry.truncate_profile_id;
            }
            MIRROR_TRUNCATE_LENGTH_PRF_ID_NON_ENCAP_REF_CNT(unit)++;
        }
        SHR_EXIT();
    }
...
mirror_encap_delete(int unit, bcm_mirror_destination_t *mirror_dest, int index)
{
    ...
    if (!MIRROR_DEST_IS_TUNNEL(mirror_dest)) {
        ...
        if (xfs_mirror_db[unit] &&
            ...
            sal_memset(&entry, 0, sizeof(mirror_encap_profile_entry_t));
            SHR_IF_ERR_VERBOSE_EXIT
                (mirror_encap_profile_entry_get(unit, ENCAP_NONE, index, &entry));
            if (entry.truncate) {
                update_ref_cnt = TRUE;
            }
        }
                           ...
                           const char **key_value)
{
    ...
    rv = bcmi_ltsw_switch_trace_event_to_symbol(unit,
                                                trace_event,
                                                table_name,
                                                key_value);
    if (rv == SHR_E_NOT_FOUND) {
...
{
    bool m_enable = false;
    int i, ena = 0, mirror_index = 0, istart = 0, iend = 0;
    ...
    if (source_type == BCMINT_MIRROR_ST_F_EM_FT_ING_HW ||
        source_type == BCMINT_MIRROR_ST_F_EM_FT_EGR_HW ||
        source_type == BCMINT_MIRROR_ST_F_EM_FP_ING_HW ||
        source_type == BCMINT_MIRROR_ST_F_EM_FP_EGR_HW) {
        /*
         * There is no entry id for flowtracker, we need to use
         * flowtracker group as the entry id.
         */
        rv = bcmi_ltsw_flowtracker_mirror_index_get
            (unit, (bcm_flowtracker_group_t)entry_id, &mirror_index);
        if (rv == SHR_E_NOT_FOUND) {
            *enable = 0;
        } else if (SHR_FAILURE(rv)) {
            *enable = 0;
            ...
            /* Only support one mirror index for now. */
            i = 0;

            /* non-zero mirror_index means it's a configured mirror index. */
            if (mirror_index) {
                ena |= 1 << i;
            } else {
                ena = 0;
    ...
    if (source_type == BCMINT_MIRROR_ST_F_FP_ING ||
        source_type == BCMINT_MIRROR_ST_F_EM_FP_ING ||
        source_type == BCMINT_MIRROR_ST_F_EM_FT_ING) {
        action = bcmFieldActionMirrorIngress;
    } else if (source_type == BCMINT_MIRROR_ST_F_FP_EGR ||
               source_type == BCMINT_MIRROR_ST_F_EM_FP_EGR ||
               source_type == BCMINT_MIRROR_ST_F_EM_FT_EGR) {
    ...
    if (source_type == BCMINT_MIRROR_ST_F_FP_ING ||
        source_type == BCMINT_MIRROR_ST_F_FP_EGR) {
        istart = MIRROR_CONTAINER_FP_MIN;
        iend = MIRROR_CONTAINER_FP_MIN + MIRROR_CONTAINER_NUM_FP;
    } else if (source_type == BCMINT_MIRROR_ST_F_EM_FP_ING ||
               source_type == BCMINT_MIRROR_ST_F_EM_FP_EGR) {
        istart = MIRROR_CONTAINER_FM_FP_MIN;
        iend = MIRROR_CONTAINER_FM_FP_MIN + MIRROR_CONTAINER_NUM_EM_FP;
    } else if (source_type == BCMINT_MIRROR_ST_F_EM_FT_ING ||
               source_type == BCMINT_MIRROR_ST_F_EM_FT_EGR) {
        istart = MIRROR_CONTAINER_FM_FT_MIN;
        iend = MIRROR_CONTAINER_FM_FT_MIN + MIRROR_CONTAINER_NUM_EM_FT;
    }
                          ...
                          uint32_t stat_counter_id)
{
    ...
    if (source == bcmFlexctrSourceIngSamplePool ||
        source == bcmFlexctrSourceFlexSamplePool) {
    ...
    bcm_mirror_truncate_length_profile_t *profile)
{
    ...
    field[0].u.val = id + MIRROR_TRUNCATE_LENGTH_PRF_BASE_IDX(unit);
    ...
    bcm_mirror_truncate_length_profile_t *profile)
{
    ...
    if ((field[4].flags & BCMI_LT_FIELD_F_GET) &&
        ...
        if (field[2].u.sym_val) {
            ...
            } else if (sal_strcmp(field[2].u.sym_val, TRUNCATE_ADJUSTs) == 0) {
...
xfs_ltsw_mirror_init(int unit)
{
    ...
    mirror_truncate_info[unit].length_prf_base_idx = idx_min;
    ...
    /* HA for truncate length profile info of non-encap mirroring. */
    size = sizeof(mirror_truncate_profile_id_t);
    ptr1 = bcmi_ltsw_ha_mem_alloc(unit,
              BCMI_HA_COMP_ID_MIRROR,
              BCMINT_MIRROR_SUB_COMP_ID_MIRROR_TRUNCATE_LENGTH_NON_ENCAP_PRF,
              "bcmMirrorTruncateLengthNonEncapPrf",
              &size);
    mirror_truncate_info[unit].non_encap = ptr1;
    if (!warm) {
        sal_memset(ptr1, 0, size);
    }
    ...
    int *instance_id)
{
    ...
    switch (source->type) {
        ...
        case BCMINT_MIRROR_ST_F_EM_FP_ING:
        case BCMINT_MIRROR_ST_F_EM_FP_EGR:
        case BCMINT_MIRROR_ST_F_EM_FT_ING:
        case BCMINT_MIRROR_ST_F_EM_FT_EGR:
        case BCMINT_MIRROR_ST_F_EM_FP_ING_HW:
        case BCMINT_MIRROR_ST_F_EM_FP_EGR_HW:
        case BCMINT_MIRROR_ST_F_EM_FT_ING_HW:
        case BCMINT_MIRROR_ST_F_EM_FT_EGR_HW:
            SHR_IF_ERR_VERBOSE_EXIT
