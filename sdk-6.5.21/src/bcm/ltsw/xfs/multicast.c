    ...
    int *l3_mem_arr)
{
    ...
    SHR_ALLOC(data, sz, "bcmLtswXfsTmMcData");
    ...
    int encap_id_cnt)
{
    ...
    int  r_cnt = 0;
    uint32_t eid_max = xfs_mc_info->eid_max;
    ...
    if (encap_id_cnt == 0) {
        ...
        if (rh_cnt > 1) {
             ...
             * SDKLT rejects to set rh_base as 0, use original rh_base.
             */
            SHR_IF_ERR_VERBOSE_EXIT
...
lt_l2_mc_group_compare(int unit, int index, void *entry, int *result)
{
    ...
    for (i = 0; i < port_cnt; i++) {
        ...
        /* port_arr is always modport, so port is a valid port here. */
    ...
    bcmint_multicast_pub_info_t *mc_pub)
{
    ...
    l2mc_vlan_flood_num =
        bcmi_ltsw_property_get(unit,
                               ...
                               num_prof);
    if (l2mc_vlan_flood_num > l2mc_max) {
