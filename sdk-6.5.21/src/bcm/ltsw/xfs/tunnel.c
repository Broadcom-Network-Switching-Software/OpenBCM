...
typedef struct xfs_ltsw_tnl_lt_db_s {
    ...
    /*! Tunnel initiator table min index */
    uint64_t tunnel_init_min;

    /*! Tunnel initiator table max index */
    uint64_t tunnel_init_max;

    /*! Sequence number table min index */
    uint64_t seq_min;

    /*! Sequence number table max index */
    uint64_t seq_max;

    /*! Sequence number profile table min index */
    uint64_t seqp_min;

    /*! Sequence number profile table max index */
    uint64_t seqp_max;

} xfs_ltsw_tnl_lt_db_t;
static xfs_ltsw_tnl_lt_db_t xfs_ltsw_tnl_lt_db[BCM_MAX_NUM_UNITS];
#define XFS_TNL_INFO_V4_TNL_TERM_CAP(unit) \
            xfs_ltsw_tnl_lt_db[unit].ipv4_tunnel_term_cap
#define XFS_TNL_INFO_V6_TNL_TERM_CAP(unit) \
            xfs_ltsw_tnl_lt_db[unit].ipv6_tunnel_term_cap
#define XFS_TNL_INFO_TNL_INIT_CAP(unit) \
            xfs_ltsw_tnl_lt_db[unit].tunnel_init_cap
...
ltsw_xfs_tunnel_init_get(int unit, int index, void *entry)
{
    ...
    bcmlt_entry_handle_t entry_hdl0 = BCMLT_INVALID_HDL;
    bcmlt_entry_handle_t entry_hdl1 = BCMLT_INVALID_HDL;
    bcmint_tunnel_tbl_id_t tbl_id;
    const bcmint_tunnel_tbl_t *tbl_info_0 = NULL;
    const bcmint_tunnel_tbl_t *tbl_info_1 = NULL;
    const bcmint_tunnel_fld_t *tbl_flds_0 = NULL;
    const bcmint_tunnel_fld_t *tbl_flds_1 = NULL;
    bcmint_tunnel_fld_egr_l3_tunnel_0_t fld_id_0;
    bcmint_tunnel_fld_egr_l3_tunnel_1_t fld_id_1;
    ...
    if ((index < xfs_ltsw_tnl_lt_db[unit].tunnel_init_min) ||
        (index > xfs_ltsw_tnl_lt_db[unit].tunnel_init_max)) {
        SHR_ERR_EXIT(SHR_E_PARAM);
    }
    ...
    tbl_id = BCMINT_LTSW_TNL_TBL_EGR_L3_TUNNEL_0;
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmint_tunnel_tbl_get(unit, tbl_id, &tbl_info_0));
    tbl_flds_0 = tbl_info_0->flds;

    tbl_id = BCMINT_LTSW_TNL_TBL_EGR_L3_TUNNEL_1;
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmint_tunnel_tbl_get(unit, tbl_id, &tbl_info_1));
    tbl_flds_1 = tbl_info_1->flds;

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_allocate_by_id(dunit, tbl_info_0->tbl_id,
                                    tbl_info_0->fld_cnt, &entry_hdl0));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_allocate_by_id(dunit, tbl_info_1->tbl_id,
                                    tbl_info_1->fld_cnt, &entry_hdl1));

    fld_id_0 = BCMINT_LTSW_TNL_FLD_EGR_L3_TNL_0_EGR_L3_TUNNEL_IDX_0;
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_add_by_id(entry_hdl0,
                                     tbl_flds_0[fld_id_0].fld_id, index));

    fld_id_1 = BCMINT_LTSW_TNL_FLD_EGR_L3_TNL_1_EGR_L3_TUNNEL_IDX_0;
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_add_by_id(entry_hdl1,
                                     tbl_flds_1[fld_id_1].fld_id, index));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_lt_entry_commit(unit, entry_hdl0, BCMLT_OPCODE_LOOKUP,
    ...
    SHR_IF_ERR_VERBOSE_EXIT
     ...
     fld_id_0 = BCMINT_LTSW_TNL_FLD_EGR_L3_TNL_0_EDIT_CTRL_ID;
     if (tbl_info_0->fld_bmp & (1ULL << fld_id_0)) {
         SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_get_by_id(entry_hdl0,
                                         tbl_flds_0[fld_id_0].fld_id,
                                         &edit_ctrl_id));
    ...
    fld_id_0 = BCMINT_LTSW_TNL_FLD_EGR_L3_TNL_0_IPV6_SRC_ADDR;
    if (tbl_info_0->fld_bmp & (1ULL << fld_id_0)) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_array_get_by_id(entry_hdl0,
                                               tbl_flds_0[fld_id_0].fld_id, 0,
                                               val, 2, &r_elem_cnt));
        if (ip6) {
    ...
    fld_id_0 = BCMINT_LTSW_TNL_FLD_EGR_L3_TNL_0_TOS_OR_EXP_REMARK_BASE_PTR;
    if (tbl_info_0->fld_bmp & (1ULL << fld_id_0)) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_get_by_id(entry_hdl0,
                                         tbl_flds_0[fld_id_0].fld_id,
    ...
    fld_id_0 = BCMINT_LTSW_TNL_FLD_EGR_L3_TNL_0_IPV6_FLOW_LABEL_SEL;
    if (tbl_info_0->fld_bmp & (1ULL << fld_id_0)) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_get_by_id(entry_hdl0,
                                         tbl_flds_0[fld_id_0].fld_id,
    ...
    fld_id_0 = BCMINT_LTSW_TNL_FLD_EGR_L3_TNL_0_TTL_VALUE;
    if (tbl_info_0->fld_bmp & (1ULL << fld_id_0)) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_get_by_id(entry_hdl0,
                                         tbl_flds_0[fld_id_0].fld_id,
    ...
    fld_id_0 = BCMINT_LTSW_TNL_FLD_EGR_L3_TNL_0_IP_HDR_DF_CTRL;
    if (tbl_info_0->fld_bmp & (1ULL << fld_id_0)) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_get_by_id(entry_hdl0,
                                         tbl_flds_0[fld_id_0].fld_id,
    ...
    fld_id_1 = BCMINT_LTSW_TNL_FLD_EGR_L3_TNL_1_IPV6_DST_ADDR_LO;
    if (tbl_info_1->fld_bmp & (1ULL << fld_id_1)) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_get_by_id(entry_hdl1,
                                         tbl_flds_1[fld_id_1].fld_id,
                                         &val[1]));
    }
    if (ip6) {
        bcmi_ltsw_util_uint64_to_ip6_half(&(tnl_init_info->dip6), &val[1], 1);
        val[0] = 0;
        fld_id_1 = BCMINT_LTSW_TNL_FLD_EGR_L3_TNL_1_IPV6_DST_ADDR_HI_0;
        if (tbl_info_1->fld_bmp & (1ULL << fld_id_1)) {
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_get_by_id(entry_hdl1,
                                             tbl_flds_1[fld_id_1].fld_id,
        ...
        ip_addr = 0;
        fld_id_1 = BCMINT_LTSW_TNL_FLD_EGR_L3_TNL_1_IPV6_DST_ADDR_HI_1;
        if (tbl_info_1->fld_bmp & (1ULL << fld_id_1)) {
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_get_by_id(entry_hdl1,
                                             tbl_flds_1[fld_id_1].fld_id,
    ...
    fld_id_1 = BCMINT_LTSW_TNL_FLD_EGR_L3_TNL_1_SEQ_NUM_COUNTER_IDX;
    if (tbl_info_1->fld_bmp & (1ULL << fld_id_1)) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_get_by_id(entry_hdl1,
                                         tbl_flds_1[fld_id_1].fld_id,
    ...
    fld_id_1 = BCMINT_LTSW_TNL_FLD_EGR_L3_TNL_1_TUNNEL_WORD_0;
    if (tbl_info_1->fld_bmp & (1ULL << fld_id_1)) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_get_by_id(entry_hdl1,
                                         tbl_flds_1[fld_id_1].fld_id,
        ...
        tnl_init_info->dscp =
            (val[0] >> XFS_EGR_TNL_INIT_TNL_HDR_DSCP_OFFSET) & 0x3F;
        tnl_init_info->ecn =
            (val[0] >> XFS_EGR_TNL_INIT_TNL_HDR_ECN_OFFSET) & 0x3;
    }

exit:
    if (entry_hdl0 != BCMLT_INVALID_HDL) {
        (void)bcmlt_entry_free(entry_hdl0);
        entry_hdl0 = BCMLT_INVALID_HDL;
    }
...
ltsw_xfs_tunnel_init_insert(int unit, uint32_t flags, int index, void *entry)
{
    ...
    if (tbl_info_0->fld_bmp & (1ULL << fld_id_0)) {
        SHR_IF_ERR_VERBOSE_EXIT
            (xfs_tnl_init_edit_ctrl_id_encode(unit, tnl_init_info->type,
                                              &edit_ctrl_id));
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_add_by_id(entry_hdl0,
                                         tbl_flds_0[fld_id_0].fld_id,
    ...
    if (tbl_info_0->fld_bmp & (1ULL << fld_id_0)) {
        ...
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_array_add_by_id(entry_hdl0,
                                               tbl_flds_0[fld_id_0].fld_id, 0,
                                               val, 2));
    }
    ...
    fld_id_0 = BCMINT_LTSW_TNL_FLD_EGR_L3_TNL_0_TTL_OR_MPLS_CTRL;
    if (tbl_info_0->fld_bmp & (1ULL << fld_id_0)) {
        if (tnl_init_info->ttl == 0) {
            /* Use payload TTL. */
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_add_by_id(entry_hdl0,
                                             tbl_flds_0[fld_id_0].fld_id, 1));
        } else {
            /* Use configured TTL. */
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_add_by_id(entry_hdl0,
    ...
    if (tbl_info_0->fld_bmp & (1ULL << fld_id_0)) {
        ...
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_add_by_id(entry_hdl0,
                                         tbl_flds_0[fld_id_0].fld_id, val[0]));
    }

    fld_id_0 = BCMINT_LTSW_TNL_FLD_EGR_L3_TNL_0_TUNNEL_WORD_1;
    if (tbl_info_0->fld_bmp & (1ULL << fld_id_0)) {
        val[0] = 0;
    ...
    fld_id_0 = BCMINT_LTSW_TNL_FLD_EGR_L3_TNL_0_STRENGTH_PRFL_IDX;
    if (tbl_info_0->fld_bmp & (1ULL << fld_id_0)) {
    ...
    if (tbl_info_1->fld_bmp & (1ULL << fld_id_1)) {
        ...
        if (ip6) {
            bcmi_ltsw_util_ip6_half_to_uint64(&val[0],
                                              &(tnl_init_info->dip6), 0);
            bcmi_ltsw_util_ip6_half_to_uint64(&val[1],
                                              &(tnl_init_info->dip6), 1);
        } else {
            /* IPv4 */
        ...
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_add_by_id(entry_hdl1,
                                         tbl_flds_1[fld_id_1].fld_id, val[1]));
    }
    ...
    fld_id_1 = BCMINT_LTSW_TNL_FLD_EGR_L3_TNL_1_SEQ_NUM_PROFILE_IDX;
    if (tbl_info_1->fld_bmp & (1ULL << fld_id_1)) {
    ...
    if (tbl_info_1->fld_bmp & (1ULL << fld_id_1)) {
        ...
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_add_by_id(entry_hdl1,
                                         tbl_flds_1[fld_id_1].fld_id, val[0]));
    }

    fld_id_1 = BCMINT_LTSW_TNL_FLD_EGR_L3_TNL_1_STRENGTH_PRFL_IDX;
    if (tbl_info_1->fld_bmp & (1ULL << fld_id_1)) {
    ...
    /* Operation commit. */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_lt_entry_set_commit(unit, entry_hdl0, BCMLT_PRIORITY_NORMAL));
    SHR_IF_ERR_VERBOSE_EXIT
...
ltsw_xfs_tunnel_init_del(int unit, int index)
{
    ...
    if (tbl_info_1->fld_bmp & (1ULL << fld_id_1)) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_get_by_id(entry_hdl1,
                                         tbl_flds_1[fld_id_1].fld_id, &data));
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_lt_entry_commit(unit, entry_hdl0,
 ...
 *
 * \param [in] unit Unit number.
 * \param [in] tbl_info Tunnel table info.
 ...
 */
static int
ltsw_xfs_tunnel_term_entry_init(int unit, const bcmint_tunnel_tbl_t *tbl_info,
                                ...
                                bool key, bool data)
{
    ...
    if (data) {
        ...
        /* Be compatible with legacy releases which use XFS_TNL_DFL_PRIORITY. */
        tmp_val = XFS_TNL_DFL_PRIORITY + tnl_term_info->priority;
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_add(entry_hdl, ENTRY_PRIORITYs, tmp_val));
 ...
 *
 * \param [in] unit Unit number.
 * \param [in] tbl_info Lt table info.
 ...
 */
static int
ltsw_xfs_tunnel_term_entry_parse(int unit, const bcmint_tunnel_tbl_t *tbl_info,
                                 bcm_tunnel_terminator_t *tnl_term_info,
                                 ...
                                 bool key_parse, bool data_parse)
{
    ...
    uint64_t tmp_val;
    uint32_t elem_cnt;
    const bcmint_tunnel_fld_t *tbl_flds = NULL;
    uint32 fld_id;
    ...
    tbl_flds = tbl_info->flds;

    if (key_parse) {
        if (ip6) {
            /* IPv6 */
            fld_id = BCMINT_LTSW_TNL_FLD_L3_IPV6_TUNNEL_TABLE_IP_HDR_SIP;
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_array_get_by_id(entry_hdl,
                                                   tbl_flds[fld_id].fld_id, 0,
                                                   sip_data, 2, &elem_cnt));

            fld_id = BCMINT_LTSW_TNL_FLD_L3_IPV6_TUNNEL_TABLE_IP_HDR_SIP_MASK;
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_array_get_by_id(entry_hdl,
                                                   tbl_flds[fld_id].fld_id, 0,
                                                   sip_mask, 2, &elem_cnt));

            fld_id = BCMINT_LTSW_TNL_FLD_L3_IPV6_TUNNEL_TABLE_IP_HDR_DIP;
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_array_get_by_id(entry_hdl,
                                                   tbl_flds[fld_id].fld_id, 0,
                                                   dip_data, 2, &elem_cnt));

            fld_id = BCMINT_LTSW_TNL_FLD_L3_IPV6_TUNNEL_TABLE_IP_HDR_DIP_MASK;
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_array_get_by_id(entry_hdl,
                                                   tbl_flds[fld_id].fld_id, 0,
                                                   dip_mask, 2, &elem_cnt));
            ...
            /* IPv4 */
            fld_id = BCMINT_LTSW_TNL_FLD_L3_IPV4_TUNNEL_TABLE_IP_HDR_SIP;
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_get_by_id(entry_hdl,
                                             tbl_flds[fld_id].fld_id,
                                             &sip_data[1]));

            fld_id = BCMINT_LTSW_TNL_FLD_L3_IPV4_TUNNEL_TABLE_IP_HDR_SIP_MASK;
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_get_by_id(entry_hdl,
                                             tbl_flds[fld_id].fld_id,
                                             &sip_mask[1]));
            fld_id = BCMINT_LTSW_TNL_FLD_L3_IPV4_TUNNEL_TABLE_IP_HDR_DIP;
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_get_by_id(entry_hdl,
                                             tbl_flds[fld_id].fld_id,
                                             &dip_data[1]));

            fld_id = BCMINT_LTSW_TNL_FLD_L3_IPV4_TUNNEL_TABLE_IP_HDR_DIP_MASK;
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_get_by_id(entry_hdl,
                                             tbl_flds[fld_id].fld_id,
                                             &dip_mask[1]));
        ...
        if (ip6) {
            fld_id = BCMINT_LTSW_TNL_FLD_L3_IPV6_TUNNEL_TABLE_IP_HDR_PROTOCOL;
        } else {
            fld_id = BCMINT_LTSW_TNL_FLD_L3_IPV4_TUNNEL_TABLE_IP_HDR_PROTOCOL;
        }
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_get_by_id(entry_hdl,
                                         tbl_flds[fld_id].fld_id, &tmp_val));
        ...
        if (ip6) {
            fld_id = BCMINT_LTSW_TNL_FLD_L3_IPV6_TUNNEL_TABLE_L4_SRC_PORT;
        } else {
            fld_id = BCMINT_LTSW_TNL_FLD_L3_IPV4_TUNNEL_TABLE_L4_SRC_PORT;
        }
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_get_by_id(entry_hdl,
                                         tbl_flds[fld_id].fld_id, &tmp_val));
        ...
        if (ip6) {
            fld_id = BCMINT_LTSW_TNL_FLD_L3_IPV6_TUNNEL_TABLE_L4_SRC_PORT_MASK;
        } else {
            fld_id = BCMINT_LTSW_TNL_FLD_L3_IPV4_TUNNEL_TABLE_L4_SRC_PORT_MASK;
        }
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_get_by_id(entry_hdl,
                                         tbl_flds[fld_id].fld_id, &tmp_val));
        ...
        if (ip6) {
            fld_id = BCMINT_LTSW_TNL_FLD_L3_IPV6_TUNNEL_TABLE_L4_DST_PORT;
        } else {
            fld_id = BCMINT_LTSW_TNL_FLD_L3_IPV4_TUNNEL_TABLE_L4_DST_PORT;
        }
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_get_by_id(entry_hdl,
                                         tbl_flds[fld_id].fld_id, &tmp_val));
        ...
        if (ip6) {
            fld_id = BCMINT_LTSW_TNL_FLD_L3_IPV6_TUNNEL_TABLE_L4_DST_PORT_MASK;
        } else {
            fld_id = BCMINT_LTSW_TNL_FLD_L3_IPV4_TUNNEL_TABLE_L4_DST_PORT_MASK;
        }
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_get_by_id(entry_hdl,
                                         tbl_flds[fld_id].fld_id, &tmp_val));
    ...
    if (data_parse) {
        if (ip6) {
            fld_id = BCMINT_LTSW_TNL_FLD_L3_IPV6_TUNNEL_TABLE_ENTRY_PRIORITY;
        } else {
            fld_id = BCMINT_LTSW_TNL_FLD_L3_IPV4_TUNNEL_TABLE_ENTRY_PRIORITY;
        }
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_get_by_id(entry_hdl,
                                         tbl_flds[fld_id].fld_id, &tmp_val));
        tnl_term_info->priority = tmp_val - XFS_TNL_DFL_PRIORITY;

        if (ip6) {
            fld_id = BCMINT_LTSW_TNL_FLD_L3_IPV6_TUNNEL_TABLE_L3_IIF;
        } else {
            fld_id = BCMINT_LTSW_TNL_FLD_L3_IPV4_TUNNEL_TABLE_L3_IIF;
        }
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_get_by_id(entry_hdl,
                                         tbl_flds[fld_id].fld_id, &tmp_val));
    ...
    int unit)
{
    ...
    if (XFS_TNL_INFO_TNL_INIT_CAP(unit)) {
        ...
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_allocate_by_id(dunit, tbl_info_1->tbl_id,
                                        tbl_info_1->fld_cnt, &entry_hdl));
        /* SBR profile for tunnel initiator 0 should be NULL. */
        fld_id_1 = BCMINT_LTSW_TNL_FLD_EGR_L3_TNL_1_EGR_L3_TUNNEL_IDX_0;
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_add_by_id(entry_hdl,
                                         tbl_flds_1[fld_id_1].fld_id, 0));
        fld_id_1 = BCMINT_LTSW_TNL_FLD_EGR_L3_TNL_1_STRENGTH_PRFL_IDX;
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_add_by_id(entry_hdl,
                                         tbl_flds_1[fld_id_1].fld_id,
    ...
    int unit)
{
    ...
    bcm_tunnel_terminator_t tnl_term_info;
    bcmint_tunnel_tbl_id_t tbl_id;
    const bcmint_tunnel_tbl_t *tbl_info = NULL;
    const bcmint_tunnel_fld_t *tbl_flds = NULL;
    uint32 fld_id;
    ...
    if (XFS_TNL_INFO_V4_TNL_TERM_CAP(unit)) {
        tbl_id = BCMINT_LTSW_TNL_TBL_L3_IPV4_TUNNEL_TABLE;
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmint_tunnel_tbl_get(unit, tbl_id, &tbl_info));
        tbl_flds = tbl_info->flds;
        ...
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_allocate_by_id(dunit, tbl_info->tbl_id,
                                        tbl_info->fld_cnt, &entry_hdl));
        SHR_IF_ERR_VERBOSE_EXIT
            (ltsw_xfs_tunnel_term_entry_init(unit, tbl_info,
                                             &tnl_term_info, entry_hdl,
                                             TRUE, FALSE));
        fld_id = BCMINT_LTSW_TNL_FLD_L3_IPV4_TUNNEL_TABLE_ENTRY_PRIORITY;
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_add_by_id(entry_hdl,
    ...
    if (XFS_TNL_INFO_V6_TNL_TERM_CAP(unit)) {
        tbl_id = BCMINT_LTSW_TNL_TBL_L3_IPV6_TUNNEL_TABLE;
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmint_tunnel_tbl_get(unit, tbl_id, &tbl_info));
        tbl_flds = tbl_info->flds;
        bcm_tunnel_terminator_t_init(&tnl_term_info);
                                   ...
                                   bool key, bool data)
{
    ...
    if (key) {
        if (tnl_type.tnl_outer_hdr_ipv6) {
            ...
            fld_id = BCMINT_LTSW_TNL_FLD_L3_IPV6_TUNNEL_EM_TABLE_IP_HDR_SIP;
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_array_add_by_id(entry_hdl,
                                                   tbl_flds[fld_id].fld_id, 0,
                                                   sip_data, 2));

            fld_id = BCMINT_LTSW_TNL_FLD_L3_IPV6_TUNNEL_EM_TABLE_IP_HDR_DIP;
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_array_add_by_id(entry_hdl,
                                                   tbl_flds[fld_id].fld_id, 0,
                                                   dip_data, 2));
            ...
            fld_id = BCMINT_LTSW_TNL_FLD_L3_IPV4_TUNNEL_EM_TABLE_IP_HDR_SIP;
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_add_by_id(entry_hdl,
                                             tbl_flds[fld_id].fld_id,
                                             sip_data[1]));

            fld_id = BCMINT_LTSW_TNL_FLD_L3_IPV4_TUNNEL_EM_TABLE_IP_HDR_DIP;
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_add_by_id(entry_hdl,
                                             tbl_flds[fld_id].fld_id,
                                             dip_data[1]));
    ...
    if (data) {
        if (tnl_type.tnl_outer_hdr_ipv6) {
            fld_id = BCMINT_LTSW_TNL_FLD_L3_IPV6_TUNNEL_EM_TABLE_ENTRY_VALID;
        } else {
            fld_id = BCMINT_LTSW_TNL_FLD_L3_IPV4_TUNNEL_EM_TABLE_ENTRY_VALID;
        }
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_add_by_id(entry_hdl,
                                         tbl_flds[fld_id].fld_id, 1));

        if (tnl_type.tnl_outer_hdr_ipv6) {
            fld_id = BCMINT_LTSW_TNL_FLD_L3_IPV6_TUNNEL_EM_TABLE_L3_IIF;
        } else {
            fld_id = BCMINT_LTSW_TNL_FLD_L3_IPV4_TUNNEL_EM_TABLE_L3_IIF;
        }
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_add_by_id(entry_hdl, tbl_flds[fld_id].fld_id,
                                         tnl_term_info->vlan));
        ...
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmi_ltsw_sbr_fld_value_get(unit, th, fld_type, &stren));
        if (tnl_type.tnl_outer_hdr_ipv6) {
            fld_id = BCMINT_LTSW_TNL_FLD_L3_IPV6_TUNNEL_EM_TABLE_L3_IIF_STRENGTH;
        } else {
            fld_id = BCMINT_LTSW_TNL_FLD_L3_IPV4_TUNNEL_EM_TABLE_L3_IIF_STRENGTH;
        }
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_add_by_id(entry_hdl,
                                         tbl_flds[fld_id].fld_id,
...
int xfs_tunnel_encap_seq_num_init(int unit)
{
    ...
    idx_min = xfs_ltsw_tnl_lt_db[unit].seq_min;
    idx_max = xfs_ltsw_tnl_lt_db[unit].seq_max;
...
int
xfs_ltsw_tunnel_init_lt_db(int unit)
{
    uint32_t cap;
    uint64_t idx_min, idx_max;
    ...
    xfs_ltsw_tnl_lt_db[unit].ipv4_tunnel_term_cap = cap;

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_lt_capacity_get(unit, L3_IPV6_TUNNEL_TABLEs, &cap));
    xfs_ltsw_tnl_lt_db[unit].ipv6_tunnel_term_cap = cap;

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_lt_capacity_get(unit, EGR_L3_TUNNEL_0s, &cap));
    xfs_ltsw_tnl_lt_db[unit].tunnel_init_cap = cap;

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_lt_field_value_range_get(unit, EGR_L3_TUNNEL_0s,
                                       EGR_L3_TUNNEL_IDX_0s,
                                       &idx_min, &idx_max));
    xfs_ltsw_tnl_lt_db[unit].tunnel_init_min = idx_min;
    xfs_ltsw_tnl_lt_db[unit].tunnel_init_max = idx_max;

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_lt_field_value_range_get(unit, TNL_ENCAP_SEQUENCE_NUMBERs,
                                       TNL_ENCAP_SEQUENCE_NUMBER_IDs,
                                       &idx_min, &idx_max));
    xfs_ltsw_tnl_lt_db[unit].seq_min = idx_min;
    xfs_ltsw_tnl_lt_db[unit].seq_max = idx_max;

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_lt_field_value_range_get(unit, TNL_ENCAP_SEQUENCE_PROFILEs,
                                       TNL_ENCAP_SEQUENCE_PROFILE_IDs,
                                       &idx_min, &idx_max));
    xfs_ltsw_tnl_lt_db[unit].seqp_min = idx_min;
    xfs_ltsw_tnl_lt_db[unit].seqp_max = idx_max;
...
xfs_ltsw_tunnel_init(int unit)
{
    ...
    if (XFS_TNL_INFO_TNL_INIT_CAP(unit)) {
        idx_min = xfs_ltsw_tnl_lt_db[unit].tunnel_init_min;
        idx_max = xfs_ltsw_tnl_lt_db[unit].tunnel_init_max;
        ...
        if (warmboot) {
            /* No tunnel configured on index 0. */
            for (idx = idx_min ? idx_min : 1; idx <= idx_max; idx++) {
    ...
    void *user_data)
{
    ...
    for (idx = xfs_ltsw_tnl_lt_db[unit].tunnel_init_min;
         idx <= xfs_ltsw_tnl_lt_db[unit].tunnel_init_max;
         idx++) {
    ...
    bcm_tunnel_terminator_t *tnl_term_info)
{
    ...
    if (tnl_term_info->flags & BCM_TUNNEL_TERM_EM) {
        /* EM tables. */
        if (ip6) {
            tbl_id = BCMINT_LTSW_TNL_TBL_L3_IPV6_TUNNEL_EM_TABLE;
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmint_tunnel_tbl_get(unit, tbl_id, &tbl_info));
            ...
            tbl_id = BCMINT_LTSW_TNL_TBL_L3_IPV4_TUNNEL_EM_TABLE;
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmint_tunnel_tbl_get(unit, tbl_id, &tbl_info));
        ...
        SHR_IF_ERR_VERBOSE_EXIT
            (ltsw_xfs_tunnel_term_em_entry_init(unit, tbl_info,
                                                tnl_term_info, entry_hdl,
                                                TRUE, TRUE));
    } else {
        if (ip6) {
        ...
        SHR_IF_ERR_VERBOSE_EXIT
            (ltsw_xfs_tunnel_term_entry_init(unit, tbl_info, tnl_term_info,
                                             entry_hdl, TRUE, TRUE));
    }
    ...
    bcm_tunnel_terminator_t *tnl_term_info)
{
    ...
    if (tnl_term_info->flags & BCM_TUNNEL_TERM_EM) {
        SHR_IF_ERR_VERBOSE_EXIT
            (ltsw_xfs_tunnel_term_em_entry_parse(unit, tbl_info,
                                                 tnl_term_info, entry_hdl,
                                                 ip6, FALSE, TRUE));
    } else {
        SHR_IF_ERR_VERBOSE_EXIT
            (ltsw_xfs_tunnel_term_entry_parse(unit, tbl_info,
                                              tnl_term_info, entry_hdl,
                                              ip6, FALSE, TRUE));
    }
...
xfs_ltsw_tunnel_encap_seq_profile_init(int unit)
{
    ...
    ent_idx_min = (int)xfs_ltsw_tnl_lt_db[unit].seqp_min;
    ent_idx_max = (int)xfs_ltsw_tnl_lt_db[unit].seqp_max;
    SHR_IF_ERR_VERBOSE_EXIT
    ...
    int index)
{
    ...
    if ((index < xfs_ltsw_tnl_lt_db[unit].seqp_min) ||
        (index > xfs_ltsw_tnl_lt_db[unit].seqp_max)) {
        SHR_ERR_EXIT(SHR_E_PARAM);
    }
