...
vlan_l3_intf_update(int unit, ltsw_vlan_egr_entry_t *entry)
{
    ...
    if (entry->fld_bmp & EV_FLD_TAG_ACTION) {
        ...
        l3_notify_info.tag_action =
            (entry->tag_action & BCMINT_VLAN_TAG_ACTION_OTAG_ADD) ? 0x1: 0x0;
    }
                                ...
                                ltsw_vlan_ing_entry_t *entry)
{
    ...
    bcmint_vlan_symbol_set_f scalar_to_symbol_cb;
    ...
    if (entry->fld_bmp & IV_FLD_DESTINATION) {
        ...
        scalar_to_symbol_cb =
            (bcmint_vlan_symbol_set_f)(flds[fid].set_transform);
        SHR_IF_ERR_VERBOSE_EXIT
            (scalar_to_symbol_cb(unit, entry->dest_type, &str_value));
        SHR_IF_ERR_VERBOSE_EXIT
    ...
    if (entry->fld_bmp & IV_FLD_PVLAN_PORT_TYPE) {
        ...
        scalar_to_symbol_cb =
            (bcmint_vlan_symbol_set_f)(flds[fid].set_transform);
        SHR_IF_ERR_VERBOSE_EXIT
            (scalar_to_symbol_cb(unit, entry->pvlan_port_type, &str_value));
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_symbol_add(ent_hdl, fld_name, str_value));
    }
    ...
    if (entry->fld_bmp & IV_FLD_L2MC_MISS_ACTION) {
        ...
        scalar_to_symbol_cb =
            (bcmint_vlan_symbol_set_f)(flds[fid].set_transform);
        SHR_IF_ERR_VERBOSE_EXIT
            (scalar_to_symbol_cb(unit, entry->l2mc_miss_action, &str_value));
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_symbol_add(ent_hdl, fld_name, str_value));
    }
    ...
    if (entry->fld_bmp & IV_FLD_L2UC_MISS_ACTION) {
        ...
        scalar_to_symbol_cb =
            (bcmint_vlan_symbol_set_f)(flds[fid].set_transform);
        SHR_IF_ERR_VERBOSE_EXIT
            (scalar_to_symbol_cb(unit, entry->l2uc_miss_action, &str_value));
        SHR_IF_ERR_VERBOSE_EXIT
             (bcmlt_entry_field_symbol_add(ent_hdl, fld_name, str_value));
    }
                          ...
                          ltsw_vlan_ing_entry_t *entry)
{
    ...
    const bcmint_vlan_fld_t *flds;
    int fid;
    bcmint_vlan_symbol_get_f symbol_to_scalar_cb;
    ...
    if (entry->fld_bmp & IV_FLD_DESTINATION) {
        ...
        symbol_to_scalar_cb =
            (bcmint_vlan_symbol_get_f)(flds[fid].get_transform);
        SHR_IF_ERR_VERBOSE_EXIT
            (symbol_to_scalar_cb(unit, value, &entry->dest_type));
    }
    ...
    if (entry->fld_bmp & IV_FLD_PVLAN_PORT_TYPE) {
        ...
        symbol_to_scalar_cb =
            (bcmint_vlan_symbol_get_f)(flds[fid].get_transform);
        SHR_IF_ERR_VERBOSE_EXIT
            (symbol_to_scalar_cb(unit, value, &entry->pvlan_port_type));
    }
    ...
    if (entry->fld_bmp & IV_FLD_L2MC_MISS_ACTION) {
        ...
        symbol_to_scalar_cb =
            (bcmint_vlan_symbol_get_f)(flds[fid].get_transform);
        SHR_IF_ERR_VERBOSE_EXIT
            (symbol_to_scalar_cb(unit, value, &entry->l2mc_miss_action));
    }
    ...
    if (entry->fld_bmp & IV_FLD_L2UC_MISS_ACTION) {
        ...
        symbol_to_scalar_cb =
            (bcmint_vlan_symbol_get_f)(flds[fid].get_transform);
        SHR_IF_ERR_VERBOSE_EXIT
            (symbol_to_scalar_cb(unit, value, &entry->l2uc_miss_action));
    }
                          ...
                          ltsw_vlan_egr_entry_t *entry)
{
    ...
    int fid;
    const char *str_value;
    uint64_t bmp_value = 0;
    bcmint_vlan_symbol_set_f scalar_to_symbol_cb;
    bcmint_vlan_bmp_set_f bmp_set_cb;
    ...
    if (entry->fld_bmp & EV_FLD_TAG_ACTION) {
        fid = BCMINT_LTSW_VLAN_FLD_EGR_VFI_TAG_ACTION;
        fld_name = flds[fid].name;
        bmp_set_cb = (bcmint_vlan_bmp_set_f)(flds[fid].set_transform);
        SHR_IF_ERR_VERBOSE_EXIT
            (bmp_set_cb(unit, entry->tag_action, &bmp_value));
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_add(ent_hdl, fld_name, bmp_value));
    }
    ...
    if (entry->fld_bmp & EV_FLD_VIEW) {
        ...
        scalar_to_symbol_cb =
            (bcmint_vlan_symbol_set_f)(flds[fid].set_transform);
        SHR_IF_ERR_VERBOSE_EXIT
            (scalar_to_symbol_cb(unit, entry->view, &str_value));
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_symbol_add(ent_hdl, fld_name, str_value));
    }
                          ...
                          ltsw_vlan_egr_entry_t *entry)
{
    ...
    int fid;
    bcmint_vlan_symbol_get_f symbol_to_scalar_cb;
    bcmint_vlan_bmp_get_f bmp_get_cb;
    uint64_t bmp_value = 0;
    ...
    if (entry->fld_bmp & EV_FLD_TAG_ACTION) {
        ...
        fld_name = flds[fid].name;
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_get(ent_hdl, fld_name, &bmp_value));
        bmp_get_cb = (bcmint_vlan_bmp_get_f)(flds[fid].get_transform);
        SHR_IF_ERR_VERBOSE_EXIT
            (bmp_get_cb(unit, bmp_value, &entry->tag_action));
    }
    ...
    symbol_to_scalar_cb =
        (bcmint_vlan_symbol_get_f)(flds[fid].get_transform);
    SHR_IF_ERR_VERBOSE_EXIT
        (symbol_to_scalar_cb(unit, value, &view));
...
vlan_ing_block_mask_validate(int unit, bcm_vlan_block_t *block)
{
    ...
    BCM_PBMP_CLEAR(pbm_1);
    BCM_PBMP_CLEAR(pbm_2);
...
vlan_egr_default_entry_add(int unit, bcm_vlan_data_t *vd)
{
    ...
    entry.tag_action = BCMINT_VLAN_TAG_ACTION_OTAG_ADD;
    /* And preserve pkt's odot1p by default. Egr port takes final control. */
    entry.tag_action |= BCMINT_VLAN_TAG_ACTION_ODOT1P_PRESERVE;
                              ...
                              void *user_data)
{
    ...
    for (i = 0; i < COUNTOF(key_type); i++) {
        ...
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmi_lt_entry_inuse_cnt_get(unit, lt_info->name, &inuse_cnt));
        if (!inuse_cnt) {
            continue;
        }
                           ...
                           bcm_vlan_control_vlan_t *control)
{
    ...
    if (valid_fields & BCM_VLAN_CONTROL_VLAN_EGRESS_ACTION_MASK) {
        ...
        control->egress_action.inner_tag =
            (entry.tag_action & BCMINT_VLAN_TAG_ACTION_ITAG_ADD) ?
            bcmVlanActionAdd : bcmVlanActionNone;

        if (entry.tag_action & BCMINT_VLAN_TAG_ACTION_OTAG_STATUS_PRESERVE) {
            control->egress_action.flags |=
                BCM_VLAN_ACTION_SET_PAYLOAD_OUTER_TAG_STATUS_PRESERVE;
        }
    }
                           ...
                           bcm_vlan_control_vlan_t *control)
{
    ...
    if (valid_fields & BCM_VLAN_CONTROL_VLAN_OUTER_TPID_MASK) {
        ...
        if (!pre_config_first) {
            /* only old_control.outer_tpid is needed here. */
                           ...
                           bcm_vlan_control_vlan_t *control)
{
    ...
    if (valid_fields & BCM_VLAN_CONTROL_VLAN_EGRESS_ACTION_MASK) {
        ...
        if (control->egress_action.outer_tag == bcmVlanActionAdd) {
            entry.tag_action |= BCMINT_VLAN_TAG_ACTION_OTAG_ADD;
        }
        ...
        if ((!pre_config_first &&(EGR_VFI_VIEW_DEFAULT == entry_view))
            ...
            if (control->egress_action.inner_tag == bcmVlanActionAdd) {
                entry.tag_action |= BCMINT_VLAN_TAG_ACTION_ITAG_ADD;
            }
        }
        ...
        if (control->egress_action.flags &
            BCM_VLAN_ACTION_SET_PAYLOAD_OUTER_TAG_STATUS_PRESERVE) {
            entry.tag_action |= BCMINT_VLAN_TAG_ACTION_OTAG_STATUS_PRESERVE;
        }
    }
                      ...
                      int arg)
{
    ...
    if (bcmi_ltsw_virtual_vp_is_vfi_type(unit, port)) {
         ...
         */
        if (type != bcmVlanPortTranslateEgressKey) {
            arg = (arg ? 1 : 0);
        }
        switch (type) {
                                 ...
                                 bcmlt_entry_handle_t ent_hdl)
{
    ...
    if (tid == XLATE_TABLE_EGR_DW) {
        act_id = (int)BCMINT_LTSW_VLAN_FLD_EGR_XLATE_FLEX_CTR_ACTION;
        obj_id = (int)BCMINT_LTSW_VLAN_FLD_EGR_XLATE_FLEX_CTR_INDEX;
        stage = BCMI_LTSW_FLEXCTR_STAGE_EGR_CTR;
    } else {
        act_id = (int)BCMINT_LTSW_VLAN_FLD_ING_XLATE_FLEX_CTR_ACTION;
        obj_id = (int)BCMINT_LTSW_VLAN_FLD_ING_XLATE_OPQ_OBJ_0;
    ...
    for (i = 0; i < vt_cfg_count; i++) {
        ...
        if ((array_size > 0) && (array_size > local_count)) {
            ...
            if (vt_cfgs[i].fld_bmp & BCMI_LTSW_VLAN_ING_XLATE_FLD_PIPE) {
                if (bcmi_ltsw_flexctr_action_is_single_pipe(
                        unit, BCMI_LTSW_FLEXCTR_STAGE_ING_CTR,
                        vt_cfgs[i].flex_ctr_action) > 0) {
                    /* bcmiFlexctrModePipeUnique. */
                    counter_info.pipe = vt_cfgs[i].pipe;
                } else {
                    /*
                     * bcmiFlexctrModeGlobal or
                     * bcmiFlexctrModePipeUnique + Global flex counter action.
                     */
                    counter_info.pipe = 0;
                }
            }
 ...
 */
int
xfs_ltsw_vlan_traverse(int unit, int ingress,
                       bcmi_ltsw_vlan_traverse_cb cb, void *user_data)
{
    ...
    while ((rv = bcmi_lt_entry_commit(unit, ent_hdl,
        ...
        if (ingress) {
            ...
            ing_entry.fld_bmp = IV_FLD_STREN_PROF_IDX |
                                IV_FLD_STG;
            SHR_IF_ERR_VERBOSE_EXIT
                (vlan_ing_entry_fields_get(unit, ent_hdl, &ing_entry));

            vfi = (uint32_t)ing_entry.vfi;
            sten_idx = (uint32_t)ing_entry.stren_prof_idx;
            info.stg = (bcm_stg_t)ing_entry.stg;
        } else {
            sal_memset(&egr_entry, 0, sizeof(ltsw_vlan_egr_entry_t));
            egr_entry.fld_bmp = EV_FLD_STG |
                                EV_FLD_STRENGTH_PRFL_IDX;
            SHR_IF_ERR_VERBOSE_EXIT
                (vlan_egr_entry_fields_get(unit, ent_hdl, &egr_entry));

            vfi = (uint32_t)egr_entry.vfi;
            sten_idx = (uint32_t)egr_entry.strength_prfl_idx;
            info.stg = (bcm_stg_t)egr_entry.stg;
        }

        if (vfi > BCM_VLAN_MAX) {
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmi_ltsw_virtual_vpnid_get(unit, vfi, &(info.vid)));
        } else {
            /* vlan 0 is reserved. */
            if (vfi == BCM_VLAN_NONE) {
                continue;
            }
                                   ...
                                   bcm_vlan_action_set_t *action)
{
    ...
    if (action->opaque_ctrl_id){
        if (action->opaque_ctrl_id > BCMI_LTSW_VLAN_XLATE_OPAQUE_MAX) {
            SHR_ERR_EXIT(SHR_E_PARAM);
        }
