...
xfs_ltsw_stat_counter_control_init(int unit)
{
    ...
    /* Ingress PFC counters. */
    ltsw_ctr_ctrl->ing_pfc_base_index = total_entries;
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_table_field_defs_get(dunit, CTR_ING_PFCs, 0, NULL, &num_fields));
    ltsw_ctr_ctrl->ing_pfc_entries_perport = num_fields;
    total_entries += num_fields * num_ports;
