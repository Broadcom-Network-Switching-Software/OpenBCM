...
/*!
 * bcm_switch_ep_recirc_drop_event_control_t.threshold_event
 * index mapping table
 */
static int ep_recirc_drop_idx[BCM_MAX_NUM_UNITS][bcmPktDropEventCount];
...
static int
sc_bcmSwitchEgressRawResidenceTimeDelta_set(int unit, int arg)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_ltsw_time_switch_control_set(unit,
                                           bcmSwitchEgressRawResidenceTimeDelta,
                                           arg));
...
static int
sc_bcmSwitchEgressRawResidenceTimeDelta_get(int unit, int *arg)
{
    SHR_FUNC_ENTER(unit);
    SHR_NULL_CHECK(arg, SHR_E_PARAM);
...
static int
sc_bcmSwitchEgressRawResidenceTimeRightShift_set(int unit, int arg)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_ltsw_time_switch_control_set(unit,
                                           bcmSwitchEgressRawResidenceTimeRightShift,
                                           arg));
...
static int
sc_bcmSwitchEgressRawResidenceTimeRightShift_get(int unit, int *arg)
{
    SHR_FUNC_ENTER(unit);
    SHR_NULL_CHECK(arg, SHR_E_PARAM);
...
{
    int i;
    static bool inited[BCM_MAX_NUM_UNITS] = { false };
...
int
bcmint_xfs_switch_ep_recirc_symbol_to_drop_event(
    int unit,
    const char *symbol,
    bcm_pkt_drop_event_t *drop_event)
{
...
int
bcmint_xfs_switch_ep_recirc_drop_event_to_drop_code(
    int unit,
    bcm_pkt_drop_event_t drop_event,
    int *drop_code)
{
    ...
    SHR_IF_ERR_EXIT
        (mbcm_ltsw_switch_ep_recirc_drop_event_to_drop_code(unit,
                                                            drop_event,
                                                            drop_code));
...
bcmint_xfs_switch_init(int unit)
{
    ...
    if (!warm) {
        ...
        /* Init MON_REDIRECT_PROFILE table. */
        if (ltsw_feature(unit, LTSW_FT_EP_RECIRC)) {
            SHR_IF_ERR_EXIT
                (mbcm_ltsw_switch_ep_recirc_profile_init(unit));
        }
    }
...
bcmint_xfs_switch_detach(int unit)
{
    ...
    if (ltsw_feature(unit, LTSW_FT_EP_RECIRC)) {
        SHR_IF_ERR_EXIT
            (bcmi_lt_clear(unit, MON_REDIRECT_PROFILEs));
    }
