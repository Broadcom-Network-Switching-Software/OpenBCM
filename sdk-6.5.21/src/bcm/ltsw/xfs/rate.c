    ...
    bcmint_rate_hw_info_t *hw_info)
{
    ...
    if (meter_ing_pipeunique) {
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(entry, PIPEs, (pipe < 0) ? 0 : pipe));
    }
    ...
    bcmint_rate_info_t *rate_info)
{
    ...
    for (i = 0; i < pipe_num; i++) {
        ...
        if (meter_ing_pipeunique) {
            SHR_IF_ERR_EXIT
                (bcmlt_entry_field_add(entry, PIPEs, pipe_start + i));
        }
    ...
    bcmint_rate_hw_info_t *hw_info)
{
    SHR_FUNC_ENTER(unit);
    SHR_IF_ERR_EXIT
        (ltsw_xfs_rate_status(unit, pipe, sc_id, hw_info));
exit:
    SHR_FUNC_EXIT();
}
    ...
    bcmint_rate_info_t *rate_info)
{
    SHR_FUNC_ENTER(unit);
    SHR_IF_ERR_EXIT
        (ltsw_xfs_rate_meter_set(unit, pipe, sc_id, rate_info));
exit:
    SHR_FUNC_EXIT();
}
    ...
    bcmint_rate_info_t *rate_info)
{
    SHR_FUNC_ENTER(unit);
    SHR_IF_ERR_EXIT
        (ltsw_xfs_rate_meter_get(unit, pipe, sc_id, rate_info));
exit:
    SHR_FUNC_EXIT();
}
...
{
    SHR_FUNC_ENTER(unit);
    SHR_NULL_CHECK(unique, SHR_E_PARAM);

    *unique = meter_ing_pipeunique;
