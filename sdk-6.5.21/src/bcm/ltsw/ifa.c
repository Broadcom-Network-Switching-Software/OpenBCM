                             ...
                             bcm_ifa_config_info_t *config_data)
{
    ...
    SHR_NULL_CHECK(config_data, SHR_E_PARAM);
...
bcm_ltsw_ifa_config_info_get(int unit, bcm_ifa_config_info_t *config_info)
{
    ...
    SHR_NULL_CHECK(config_info, SHR_E_PARAM);
...
bcm_ltsw_ifa_stat_info_set(int unit, bcm_ifa_stat_info_t *stat_data)
{
    ...
    SHR_NULL_CHECK(stat_data, SHR_E_PARAM);
                                    ...
                                    bcm_ifa_export_element_info_t *list_of_export_elements)
{
    ...
    SHR_NULL_CHECK(list_of_export_elements, SHR_E_PARAM);
...
/*!
 * \brief Set a ifa collector with given collector info.
 *
 * \param [in] unit Unit Number.
    ...
    bcm_ifa_collector_info_t *collector_info)
{
    ...
    SHR_IF_ERR_EXIT
        (mbcm_ltsw_ifa_collector_set(unit, options, collector_info));
    ...
    bcm_ifa_collector_info_t *collector_info)
{
    ...
    SHR_IF_ERR_EXIT
        (mbcm_ltsw_ifa_collector_get(unit, collector_info));
