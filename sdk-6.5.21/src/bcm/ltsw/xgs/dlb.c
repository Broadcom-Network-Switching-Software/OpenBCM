 ...
 */
static int
ltsw_xgs_dlb_assignment_mode_encode(
    int unit,
    int assignment_mode,
 ...
 */
static int
ltsw_xgs_dlb_assignment_mode_decode(
    int unit,
    const char *assignment_mode_symbol,
    int *assignment_mode)
{
 ...
 */
static int
ltsw_xgs_dlb_scaling_factor_encode(
    int unit,
    int scaling_factor,
 ...
 */
static int
ltsw_xgs_dlb_scaling_factor_decode(
    int unit,
    const char *scaling_factor_symbol,
    int *scaling_factor)
{
 ...
 */
static int
ltsw_xgs_dlb_clear_ecmp(int unit)
{
    SHR_FUNC_ENTER(unit);
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_lt_clear(unit, DLB_ECMP_ETHERTYPEs));
exit:
    SHR_FUNC_EXIT();
}
 ...
 */
static int
ltsw_xgs_dlb_hw_deinit(int unit)
{
    SHR_FUNC_ENTER(unit);
    ...
    bcmi_ltsw_dlb_config_t *dlb_config)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_assignment_mode_encode(unit, dlb_config->assignment_mode,
                                             &symbol));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_symbol_add(lte_hdl, ASSIGNMENT_MODEs, symbol));

    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_flow_size_encode(unit, dlb_config->flowset_size,
                                       &symbol));
    SHR_IF_ERR_VERBOSE_EXIT
    ...
    bcmi_ltsw_dlb_config_t *dlb_config)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_assignment_mode_decode(unit, symbol,
                                             &dlb_config->assignment_mode));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_symbol_get(lte_hdl, FLOW_SET_SIZEs, &symbol));

    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_flow_size_decode(unit, symbol,
    ...
    bcmi_ltsw_dlb_monitor_t *monitor)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_add(lte_hdl, COPY_TO_CPUs, copy_to_cpu));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_add(lte_hdl, MIRRORs, mirror));
    ...
    if (monitor->sample_rate > 0) {
        ...
        sample_threshold =
            max_sample_threshold / monitor->sample_rate;
    ...
    bcmi_ltsw_dlb_monitor_t *monitor)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_get(lte_hdl, COPY_TO_CPUs, &copy_to_cpu));

        SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_get(lte_hdl, MIRRORs, &mirror));

    if (copy_to_cpu && mirror) {
        monitor->action = BCMI_LTSW_DLB_MON_COPY_TO_CPU_AND_MIRROR;
    } else if (copy_to_cpu && !mirror) {
        monitor->action = BCMI_LTSW_DLB_MON_COPY_TO_CPU;
    } else if (!copy_to_cpu && mirror) {
        monitor->action = BCMI_LTSW_DLB_MON_MIRROR;
    } else {
        monitor->action = BCMI_LTSW_DLB_MON_ACTION_NONE;
    }

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_get(lte_hdl, SAMPLE_THRESHOLDs, &value));
    sample_threshold = value;
    ...
    sample_threshold = ~sample_threshold & field_max;
    max_sample_threshold = field_max + 1;

    if (sample_threshold == 0) {
        monitor->sample_rate = max_sample_threshold;
    } else {
        monitor->sample_rate = max_sample_threshold / sample_threshold;
    }
    ...
    bcmi_ltsw_dlb_id_t dlb_id)
{
    ...
    if (bcmi_ltsw_property_get(unit, BCMI_CPN_DLB_FLOW_MONITOR_EN, 0) && !dlb_id) {
        SHR_EXIT();
    }
 ...
 */
static int
ltsw_xgs_dlb_member_quality_set(
    int unit,
    bcmi_ltsw_dlb_type_t dlb_type,
    int quality_map_id,
 ...
 */
static int
ltsw_xgs_dlb_member_quality_clear(
    int unit,
    bcmi_ltsw_dlb_type_t dlb_type,
    int quality_map_id,
    int quantized_avg_port_loading,
 ...
 */
static int
ltsw_xgs_dlb_member_quality_map_set(
    int unit,
    bcmi_ltsw_dlb_type_t dlb_type,
    int quality_map_id,
    int load_percent,
    ...
    for (quantized_avg_port_loading = 0;
        ...
        for (quantized_avg_qsize = 0;
            ...
            for (quantized_avg_port_qsize = 0;
                ...
                quality /= 100;
                SHR_IF_ERR_VERBOSE_EXIT
                    (ltsw_xgs_dlb_member_quality_set(unit, dlb_type,
                                                     quality_map_id,
                                                     quantized_avg_port_loading,
                                                     quantized_avg_qsize,
                                                     quantized_avg_port_qsize,
 ...
 */
static int
ltsw_xgs_dlb_member_quality_map_clear(
    int unit,
    bcmi_ltsw_dlb_type_t dlb_type,
    int quality_map_id)
{
    ...
    for (quantized_avg_port_loading = 0;
        ...
        for (quantized_avg_qsize = 0;
            ...
            for (quantized_avg_port_qsize = 0;
                 ...
                 quantized_avg_port_qsize++) {
                SHR_IF_ERR_VERBOSE_EXIT
                    (ltsw_xgs_dlb_member_quality_clear(unit, dlb_type,
                                                       quality_map_id,
                                                       quantized_avg_port_loading,
                                                       quantized_avg_qsize,
                                                       quantized_avg_port_qsize));
 ...
 */
static int
ltsw_xgs_dlb_member_attribute_validate(
    int unit,
    bcmi_ltsw_dlb_type_t dlb_type,
    bcmi_ltsw_dlb_member_attribute_t *attribute)
{
    ...
    if (attribute->scaling_factor != BCMI_LTSW_DLB_SCALING_FACTOR_INVALID) {
        SHR_IF_ERR_VERBOSE_EXIT
            (ltsw_xgs_dlb_scaling_factor_encode(unit, attribute->scaling_factor,
                                                NULL));
    }
 ...
 */
static int
ltsw_xgs_dlb_member_attribute_set(
    int unit,
    bcm_port_t port,
    bcmi_ltsw_dlb_type_t dlb_type,
    int scaling_factor,
    int quality_map_id)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_scaling_factor_encode(unit, scaling_factor, &symbol));
 ...
 */
static int
ltsw_xgs_dlb_member_attribute_get(
    int unit,
    bcm_port_t port,
    bcmi_ltsw_dlb_type_t dlb_type,
    int *scaling_factor,
    ...
    if (scaling_factor) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_symbol_get(lte_hdl,
                                          PORT_LOAD_SCALING_FACTORs, &symbol));
        SHR_IF_ERR_VERBOSE_EXIT
            (ltsw_xgs_dlb_scaling_factor_decode(unit, symbol, scaling_factor));
    }
...
static int
ltsw_xgs_dlb_member_attribute_clear(
    int unit,
    bcm_port_t port,
    bcmi_ltsw_dlb_type_t dlb_type)
{
 ...
 */
static int
ltsw_xgs_dlb_member_status_set(
    int unit,
    bcm_port_t port,
    bcmi_ltsw_dlb_type_t dlb_type,
    int status)
 ...
 */
static int
ltsw_xgs_dlb_member_status_get_hw(
    int unit,
    bcm_port_t port,
    bcmi_ltsw_dlb_type_t dlb_type,
    int *status)
 ...
 */
static int
ltsw_xgs_dlb_member_status_get(
    int unit,
    bcm_port_t port,
    bcmi_ltsw_dlb_type_t dlb_type,
    int *status)
{
    ...
    if (override) {
        ...
        SHR_IF_ERR_VERBOSE_EXIT
            (ltsw_xgs_dlb_member_status_get_hw(unit, port, dlb_type, status));
    }
 ...
 */
static int
ltsw_xgs_dlb_ethertype_set(int unit, uint32_t flags, int ethertype_count,
                           int *ethertype_array)
{
    bcmlt_entry_handle_t lte_hdl = BCMLT_INVALID_HDL;
    uint64_t min, max;
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_lt_field_value_range_get(unit, DLB_ECMP_ETHERTYPEs,
                                       DLB_ECMP_ETHERTYPE_IDs,
                                       &min, &max));

    max_count = (int)(max - min + 1);

    if (ethertype_count > max_count) {
        SHR_IF_ERR_VERBOSE_EXIT(SHR_E_PARAM);
    }

    SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_allocate(dunit, DLB_CONTROLs, &lte_hdl));

    eligibility = flags & BCM_L3_ECMP_DYNAMIC_ETHERTYPE_ELIGIBLE ? 1 : 0;

    SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_add(lte_hdl, ETHERTYPE_ELIGIBILITYs, eligibility));
    ...
    for (i = 0; i < ethertype_count; i++) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_allocate(dunit, DLB_ECMP_ETHERTYPEs, &lte_hdl));

        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_add(lte_hdl, DLB_ECMP_ETHERTYPE_IDs, i));

        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_add(lte_hdl, ETHERTYPEs,
                                   (uint64_t)(ethertype_array[i])));
    ...
    for (j = i; j < max; j++) {
        ...
        (void)bcmlt_entry_commit(lte_hdl, BCMLT_OPCODE_DELETE,
                                 BCMLT_PRIORITY_NORMAL),
 ...
 */
static int
ltsw_xgs_dlb_ethertype_get(int unit, int ethertype_max,
                           uint32_t *flags, int *ethertype_array, int *ethertype_count)
{
    bcmlt_entry_handle_t lte_hdl = BCMLT_INVALID_HDL;
    uint64_t value, min, max;
    int dunit;
    uint64_t i;
    int rv;
    int max_count;
    ...
    if (rv == SHR_E_NONE) {
        ...
        SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_get(lte_hdl, ETHERTYPE_ELIGIBILITYs, &eligibility));
    }

    *flags = eligibility ? BCM_L3_ECMP_DYNAMIC_ETHERTYPE_ELIGIBLE : 0;

    (void)bcmlt_entry_free(lte_hdl);
    lte_hdl = BCMLT_INVALID_HDL;

    for (i = 0; i < ethertype_max; i++) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_allocate(dunit, DLB_ECMP_ETHERTYPEs, &lte_hdl));
        ...
        if (rv == SHR_E_NONE) {
            ...
            SHR_IF_ERR_VERBOSE_EXIT
                    (bcmlt_entry_field_get(lte_hdl, ETHERTYPEs, &value));

            *ethertype_count = i + 1;
            ethertype_array[i] = (int)value;
        }
 ...
 */
static int
ltsw_xgs_dlb_quantization_threshold_table_set(
    int unit,
    bcmi_ltsw_dlb_type_t dlb_type,
    ...
    bcmi_ltsw_dlb_control_type_t type)
{
    ...
    switch (type) {
        ...
        case bcmiDlbControlTypeEgressBytesMaxThreshold:
            ...
            increment = (max - min) / (int)quantization_threshold_id_max;
    ...
    for (qthd_id  = (int)quantization_threshold_id_min;
         qthd_id <= (int)quantization_threshold_id_max; qthd_id++) {
        value = qthd_id;
        SHR_IF_ERR_VERBOSE_EXIT
 ...
 */
static int
ltsw_xgs_dlb_control_table_set(
    int unit,
    bcmi_ltsw_dlb_type_t dlb_type,
    bcmi_ltsw_dlb_control_type_t type,
    uint64_t data)
 ...
 */
static int
ltsw_xgs_dlb_control_table_get(
    int unit,
    bcmi_ltsw_dlb_type_t dlb_type,
    bcmi_ltsw_dlb_control_type_t type,
    uint64_t *data)
 ...
 */
static int
ltsw_xgs_dlb_type_control_table_set(
    int unit,
    bcmi_ltsw_dlb_type_t dlb_type,
    bcmi_ltsw_dlb_control_type_t type,
    uint64_t data)
 ...
 */
static int
ltsw_xgs_dlb_type_control_table_get(
    int unit,
    bcmi_ltsw_dlb_type_t dlb_type,
    bcmi_ltsw_dlb_control_type_t type,
    uint64_t *data)
 ...
 */
static int
ltsw_xgs_dlb_control_info_value_validate(
    int unit,
    bcmi_ltsw_dlb_type_t dlb_type,
    bcmint_dlb_ctrl_info_t **ctrl_info,
    bcmi_ltsw_dlb_control_type_t type,
    uint64_t value)
{
    bcmint_dlb_ctrl_info_t *cinfo = ctrl_info[bcmi_dlb_type_ecmp];
    uint64_t min, max;
    const char *lt_name = DLB_QUANTIZATION_THRESHOLDs;
 ...
 */
static int
ltsw_xgs_dlb_control_info_check(
    int unit,
    bcmi_ltsw_dlb_type_t dlb_type,
    bcmint_dlb_ctrl_info_t *ctrl_info,
    bcmi_ltsw_dlb_control_type_t type,
 ...
 */
static int
ltsw_xgs_dlb_control_info_save(
    int unit,
    bcmint_dlb_ctrl_info_t *ctrl_info,
    bcmi_ltsw_dlb_control_type_t type,
    uint64_t value)
...
ltsw_xgs_dlb_control_info_set(
    ...
    uint64_t value)
{
    bcmint_dlb_ctrl_info_t cinfo, *ci = ctrl_info[bcmi_dlb_type_ecmp];
    int rv;
    ...
    rv = ltsw_xgs_dlb_control_info_check(unit, dlb_type, ci, type, value);
    if (rv != SHR_E_NONE) {
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_control_info_save(unit, &cinfo, type, value));

    switch (type) {
        case bcmiDlbControlTypeSampleRate:
            SHR_IF_ERR_VERBOSE_EXIT
                (ltsw_xgs_dlb_control_table_set(unit, dlb_type, type, value));

            SHR_IF_ERR_VERBOSE_EXIT
                (ltsw_xgs_dlb_quantization_threshold_table_set(unit, dlb_type,
                                                               &cinfo, type));
            break;
        case bcmiDlbControlTypeEgressBytesMinThreshold:
        case bcmiDlbControlTypeEgressBytesMaxThreshold:
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_control_info_save(unit, ci, type, value));
 ...
 */
static int
ltsw_xgs_dlb_control_type_validate(
    int unit,
    bcmi_ltsw_dlb_type_t dlb_type,
    bcmi_ltsw_dlb_control_type_t type)
{
 ...
 */
static int
ltsw_xgs_dlb_control_value_validate(
    int unit,
    bcmi_ltsw_dlb_type_t dlb_type,
    bcmi_ltsw_dlb_control_type_t type,
    uint64_t value)
    ...
    uint64_t value)
{
    ...
    switch (type) {
        ...
        case bcmiDlbControlTypeBaseEcmpId:
            SHR_IF_ERR_VERBOSE_EXIT
                (ltsw_xgs_dlb_type_control_table_set(unit, dlb_type,
                                                     type, value));
            break;
        default:
            SHR_ERR_EXIT(SHR_E_PARAM);
    ...
    uint64_t *value)
{
    ...
    switch (type) {
        ...
        case bcmiDlbControlTypePhysicalQueuedBytesDecreaseReset:
            SHR_IF_ERR_VERBOSE_EXIT
                (ltsw_xgs_dlb_control_table_get(unit, dlb_type, type, value));
            break;
        case bcmiDlbControlTypeRandomSeed:
        case bcmiDlbControlTypeMonitorIngressFieldRandomSeed:
        case bcmiDlbControlTypeMonitorIngressRandomSeed:
        case bcmiDlbControlTypeBaseEcmpId:
            SHR_IF_ERR_VERBOSE_EXIT
                (ltsw_xgs_dlb_type_control_table_get(unit, dlb_type,
                                                     type, value));
            break;
        default:
            SHR_ERR_EXIT(SHR_E_PARAM);
    ...
    bcmi_ltsw_dlb_config_t *dlb_config)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_config_validate(unit, dlb_type, dlb_config));
    ...
    bcmi_ltsw_dlb_config_t *dlb_config)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_config_set(unit, dlb_type, dlb_id, dlb_config));
    ...
    bcmi_ltsw_dlb_config_t *dlb_config)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_config_get(unit, dlb_type, dlb_id, dlb_config));
    ...
    bcmi_ltsw_dlb_id_t dlb_id)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_config_clear(unit, dlb_type, dlb_id));

    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_stat_clear(unit, dlb_type, dlb_id));

    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_monitor_clear(unit, dlb_type, dlb_id));
    ...
    bcmi_ltsw_dlb_monitor_t *monitor)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_monitor_set(unit, dlb_type, dlb_id, monitor));
    ...
    bcmi_ltsw_dlb_monitor_t *monitor)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_monitor_get(unit, dlb_type, dlb_id, monitor));
    ...
    int qsize_percent)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_member_quality_map_set(unit, dlb_type, quality_map_id,
    ...
    int quality_map_id)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_member_quality_map_clear(unit, dlb_type, quality_map_id));
    ...
    bcm_pbmp_t *pbmp)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_member_pbmp_get(unit, pbmp));
    ...
    bcmi_ltsw_dlb_member_attribute_t *attribute)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_member_attribute_validate(unit, dlb_type, attribute));
    ...
    int quality_map_id)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_member_attribute_set(unit, port, dlb_type,
    ...
    int *quality_map_id)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_member_attribute_get(unit, port, dlb_type,
                                           scaling_factor, quality_map_id));
    ...
    bcmi_ltsw_dlb_type_t dlb_type)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_member_attribute_clear(unit, port, dlb_type));
    ...
    int status)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_member_status_set(unit, port, dlb_type, status));
    ...
    int *status)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_member_status_get(unit, port, dlb_type, status));
    ...
    int *ethertype_array)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_ethertype_set(unit, flags, ethertype_count, ethertype_array));
    ...
    int *ethertype_count)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_ethertype_get(unit, ethertype_count_max, flags,
    ...
    uint64_t value)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_control_info_value_validate(unit, dlb_type,
    ...
    uint64_t value)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_control_info_set(unit, dlb_type, ctrl_info, type, value));
    ...
    uint64_t *value)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_control_info_get(unit, dlb_type, ctrl_info, type, value));
    ...
    bcmi_ltsw_dlb_control_type_t type)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_control_type_validate(unit, dlb_type, type));
    ...
    uint64_t value)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_control_value_validate(unit, dlb_type, type, value));
    ...
    uint64_t value)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_control_set(unit, dlb_type, type, value));
    ...
    uint64_t *value)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_control_get(unit, dlb_type, type, value));
    ...
    bcmi_ltsw_dlb_stat_t *stat)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_stat_set(unit, dlb_type, dlb_id, stat));
    ...
    bcmi_ltsw_dlb_stat_t *stat)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_xgs_dlb_stat_get(unit, dlb_type, dlb_id, sync_mode, stat));
