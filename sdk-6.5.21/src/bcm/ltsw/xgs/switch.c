 ...
 */
static sc_symbol_map_t port_context_select_map[] = {
    {USE_INGRESS_PORTs, bcmSwitchFlowCountPortContextIngress},
    {USE_EGRESS_PORTs, bcmSwitchFlowCountPortContextEgress},
    {NULL, 0}
};
...
static int
sc_bcmSwitchHashUseFlowSelEcmpDynamic_set(int unit, int arg)
{
    uint32_t val = (unsigned int)arg;
...
static int
sc_bcmSwitchHashUseFlowSelEcmpDynamic_get(int unit, int *arg)
{
    uint32_t val;
...
sc_bcmSwitchHashField0OverlayCntagRpidEnable_set(int unit, int arg)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_ltsw_lb_hash_bins_set(unit,
                                    bcmiHashField0OverlayCntagRpidEnable,
                                    arg));
...
sc_bcmSwitchHashField1OverlayCntagRpidEnable_set(int unit, int arg)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_ltsw_lb_hash_bins_set(unit,
                                    bcmiHashField1OverlayCntagRpidEnable,
                                    arg));
...
static int
sc_bcmSwitchHashIPSecSelect0_set(int unit, int arg)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_ltsw_lb_hash_bins_set(unit,
                                    bcmiHashBinField0IPsec,
                                    arg));
...
static int
sc_bcmSwitchHashIPSecSelect0_get(int unit, int *arg)
{
    SHR_FUNC_ENTER(unit);
...
static int
sc_bcmSwitchHashIPSecSelect1_set(int unit, int arg)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_ltsw_lb_hash_bins_set(unit,
                                    bcmiHashBinField1IPsec,
                                    arg));
...
static int
sc_bcmSwitchHashIPSecSelect1_get(int unit, int *arg)
{
    SHR_FUNC_ENTER(unit);
...
static int
sc_bcmSwitchHashL2VxlanField0_set(int unit, int arg)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_ltsw_lb_hash_fields_select_set(unit,
                                             bcmiHash0FieldSelectTypeVxlanL2Payload,
                                             arg));
...
static int
sc_bcmSwitchHashL2VxlanField0_get(int unit, int *arg)
{
    SHR_FUNC_ENTER(unit);
...
static int
sc_bcmSwitchHashL2VxlanField1_set(int unit, int arg)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_ltsw_lb_hash_fields_select_set(unit,
                                             bcmiHash1FieldSelectTypeVxlanL2Payload,
                                             arg));
...
static int
sc_bcmSwitchHashL2VxlanField1_get(int unit, int *arg)
{
    SHR_FUNC_ENTER(unit);
...
static int
sc_bcmSwitchHashL3VxlanField0_set(int unit, int arg)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_ltsw_lb_hash_fields_select_set(unit,
                                             bcmiHash0FieldSelectTypeVxlanL3Payload,
                                             arg));
...
static int
sc_bcmSwitchHashL3VxlanField0_get(int unit, int *arg)
{
    SHR_FUNC_ENTER(unit);
...
static int
sc_bcmSwitchHashL3VxlanField1_set(int unit, int arg)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_ltsw_lb_hash_fields_select_set(unit,
                                             bcmiHash1FieldSelectTypeVxlanL3Payload,
                                             arg));
...
static int
sc_bcmSwitchHashL3VxlanField1_get(int unit, int *arg)
{
    SHR_FUNC_ENTER(unit);
...
static int
sc_bcmSwitchHashVxlanPayloadSelect0_set(int unit, int arg)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_ltsw_lb_hash_tunnel_fields_select_set(unit,
                                            bcmiHashTunnelField0VxlanTerm,
                                            arg));
...
static int
sc_bcmSwitchHashVxlanPayloadSelect0_get(int unit, int *arg)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_ltsw_lb_hash_tunnel_fields_select_get(unit,
                                            bcmiHashTunnelField0VxlanTerm,
                                            arg));
...
static int
sc_bcmSwitchHashVxlanPayloadSelect1_set(int unit, int arg)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_ltsw_lb_hash_tunnel_fields_select_set(unit,
                                            bcmiHashTunnelField1VxlanTerm,
                                            arg));
...
static int
sc_bcmSwitchHashVxlanPayloadSelect1_get(int unit, int *arg)
{
    SHR_FUNC_ENTER(unit);
...
static int
sc_bcmSwitchIngParseL2TunnelTermRarp_set(int unit, int arg)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_ltsw_flow_switch_control_set(unit,
                                           bcmSwitchIngParseL2TunnelTermRarp,
                                           arg));
exit:
    SHR_FUNC_EXIT();
}
...
static int
sc_bcmSwitchIngParseL2TunnelTermRarp_get(int unit, int *arg)
{
    SHR_FUNC_ENTER(unit);
...
static int
sc_bcmSwitchIngParseL2TunnelTermArp_set(int unit, int arg)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_ltsw_flow_switch_control_set(unit,
                                           bcmSwitchIngParseL2TunnelTermArp,
                                           arg));
exit:
    SHR_FUNC_EXIT();
}
...
static int
sc_bcmSwitchIngParseL2TunnelTermArp_get(int unit, int *arg)
{
    SHR_FUNC_ENTER(unit);
...
static int
sc_bcmSwitchTimesyncUnknownVersionToCpu_set(int unit, int arg)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_ltsw_time_switch_control_set(unit,
                                           bcmSwitchTimesyncUnknownVersionToCpu,
                                           arg));
...
static int
sc_bcmSwitchTimesyncUnknownVersionToCpu_get(int unit, int *arg)
{
    SHR_FUNC_ENTER(unit);
    SHR_NULL_CHECK(arg, SHR_E_PARAM);
...
static int
sc_bcmSwitchFlowCountStatAttach_set(int unit, int arg)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_ltsw_flexctr_flow_count_set(unit, arg));
...
static int
sc_bcmSwitchFlowCountStatAttach_get(int unit, int *arg)
{
    SHR_FUNC_ENTER(unit);
    SHR_NULL_CHECK(arg, SHR_E_PARAM);

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_ltsw_flexctr_flow_count_get(unit, arg));
...
static int
sc_bcmSwitchPcieHotSwapDisable_set(int unit, int arg)
{
    bool enable = arg ? 0 : 1;

    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT(bcmbd_hotswap_enable_set(unit, enable));
...
static int
sc_bcmSwitchPcieHotSwapDisable_get(int unit, int *arg)
{
    bool val;

    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT(bcmbd_hotswap_enable_get(unit, &val));
...
static int
scp_bcmSwitchColorSelect_set(int unit, int port, int arg)
{
    SHR_FUNC_ENTER(unit);

    SHR_ERR_EXIT
        (bcmi_ltsw_port_color_mode_set(unit, port, arg));
...
static int
scp_bcmSwitchColorSelect_get(int unit, int port, int *arg)
{
    SHR_FUNC_ENTER(unit);

    SHR_ERR_EXIT
        (bcmi_ltsw_port_color_mode_get(unit, port, arg));
...
static int
sc_bcmSwitchFlowCountHashMask_encode
                             (int unit, int port, int arg, uint64_t *val)
{
    /*Set higher 32 bits to 1. */
    COMPILER_64_SET(*val, 0xffffffff, arg);
    return SHR_E_NONE;
}

static int
sc_bcmSwitchFlowCountHashMask_decode
                         (int unit, int port, uint64_t val, int *arg)
{
    /*return lower 32 bits.*/
    *arg = COMPILER_64_LO(val);
    return SHR_E_NONE;
}
...
static bool sc_inited[BCM_MAX_NUM_UNITS] = { false };
...
sc_info_init(int unit)
{
    ...
    ha_alloc_ptr = soc_ltsw_ha_mem_alloc(unit,
                                         BCMI_HA_COMP_ID_SWITCH,
                                         HA_SC_SOFTWARE_SUB_COMP_ID,
                                         "bcmSwitchSW",
                                           &ha_alloc_size);
    SHR_NULL_CHECK(ha_alloc_ptr, SHR_E_MEMORY);

    if (!warm) {
        if (ha_alloc_size < ha_req_size) {
            ha_alloc_ptr = soc_ltsw_ha_mem_realloc(unit, ha_alloc_ptr,
                                                   ha_req_size);
            SHR_NULL_CHECK(ha_alloc_ptr, SHR_E_MEMORY);
        }

        sc->sc_value_map = ha_alloc_ptr;
        for (i = 0; i < ha_array_size; i++) {
            sal_memcpy((sc->sc_value_map + i), (sc_value_maps + i),
                       ha_instance_size);
        }
        ...
        if (ha_alloc_size < ha_req_size) {
            /* During ISSU upgrade, new members may be added into sc_value_maps. */
            ha_alloc_ptr = soc_ltsw_ha_mem_realloc(unit, ha_alloc_ptr, ha_req_size);
            SHR_NULL_CHECK(ha_alloc_ptr, SHR_E_MEMORY);
            sc->sc_value_map = ha_alloc_ptr;

            /* Init the new array members. */
            for (i = ha_alloc_size / ha_instance_size; i < ha_array_size; i++) {
                sal_memcpy((sc->sc_value_map + i), (sc_value_maps + i), ha_instance_size);
            }
...
{
    sc_inited[unit] = false;
    sc_info[unit].inited = false;
    return SHR_E_NONE;
}
