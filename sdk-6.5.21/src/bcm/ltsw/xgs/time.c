    ...
    int arg)
{
    ...
    switch (type) {
        case bcmSwitchTimesyncEgressTimestampingMode:
            fld_name = TIMESTAMPING_MODEs;
            break;
        case bcmSwitchTimesyncEgressVersion:
        case bcmSwitchTimesyncIngressVersion:
            fld_name = IEEE1588_VERSIONs;
            break;
        case bcmSwitchNtpL4DestPort:
            fld_name = PARSE_NTP_DST_L4_UDP_PORTs;
            break;
        case bcmSwitchTimesyncUnknownVersionToCpu:
            fld_name = IEEE1588_VERSION_UNKNOWN_TO_CPUs;
            break;
    ...
    SHR_IF_ERR_EXIT
        (lt_device_ts_control_field_set(unit, fld_name, arg));
    ...
    int *arg)
{
    ...
    SHR_IF_ERR_EXIT
        (lt_device_ts_control_field_get(unit, fld_name, arg));
