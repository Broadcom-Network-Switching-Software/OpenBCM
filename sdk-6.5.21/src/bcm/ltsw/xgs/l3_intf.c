                   ...
                   l3_intf_cfg_t *cfg, bcmint_ltsw_l3_egr_intf_t *intf_info)
{
    ...
    if (fv[XGS_LTSW_L3_INTF_TBL_EGR_TNL_TYPE] ==
        BCMINT_LTSW_L3_INTF_TNL_TYPE_MPLS) {
        intf_info->tunnel_idx =
            (int)fv[XGS_LTSW_L3_INTF_TBL_EGR_TNL_MPLS_ENCAP_INDEX];
    } else if (fv[XGS_LTSW_L3_INTF_TBL_EGR_TNL_TYPE] ==
               BCMINT_LTSW_L3_INTF_TNL_TYPE_IPV4) {
        intf_info->tunnel_idx =
            (int)fv[XGS_LTSW_L3_INTF_TBL_EGR_TNL_IPV4_ENCAP_INDEX];
    } else if (fv[XGS_LTSW_L3_INTF_TBL_EGR_TNL_TYPE] ==
               BCMINT_LTSW_L3_INTF_TNL_TYPE_IPV6) {
        intf_info->tunnel_idx =
            (int)fv[XGS_LTSW_L3_INTF_TBL_EGR_TNL_IPV6_ENCAP_INDEX];
    } else {
        intf_info->tunnel_idx = 0;
    }
...
xgs_ltsw_l3_intf_init(int unit)
{
    ...
    /* Reserve entry 0 as default profle. */
