...
uint32_t vxlan_l2_payload_fields[] = {
    BCM_HASH_FIELD_SRCMOD,
    BCM_HASH_FIELD_SRCPORT,
    BCM_HASH_FIELD_VLAN,
    BCM_HASH_FIELD_ETHER_TYPE,
...
static const char *vxlan_l2_payload_hash0_fields_str[] = {
    HASH0_SRC_MODIDs,
    HASH0_SRC_PORTs,
    HASH0_VIDs,
    HASH0_ETH_TYPEs,
...
static const char *vxlan_l2_payload_hash1_fields_str[] = {
    HASH1_SRC_MODIDs,
    HASH1_SRC_PORTs,
    HASH1_VIDs,
    HASH1_ETH_TYPEs,
...
uint32_t vxlan_l3_payload_fields[] = {
    BCM_HASH_FIELD_FLOWLABEL_LO,
    BCM_HASH_FIELD_FLOWLABEL_HI,
    BCM_HASH_FIELD_SRCMOD,
    BCM_HASH_FIELD_SRCPORT,
...
static const char *vxlan_l3_payload_hash0_fields_str[] = {
    HASH0_FLOW_ID_LOs,
    HASH0_FLOW_ID_HIs,
    HASH0_SRC_MODIDs,
    HASH0_SRC_PORTs,
...
static const char *vxlan_l3_payload_hash1_fields_str[] = {
    HASH1_FLOW_ID_LOs,
    HASH1_FLOW_ID_HIs,
    HASH1_SRC_MODIDs,
    HASH1_SRC_PORTs,
...
static const char *field_selection_lt_str[bcmiFieldSelectTypeCount] = {
    ...
    LB_HASH_VXLAN_L2_PAYLOAD_FIELDS_SELECTIONs,
    LB_HASH_VXLAN_L3_PAYLOAD_FIELDS_SELECTIONs,
    LB_HASH_IPV4_FIELDS_SELECTIONs,
    LB_HASH_IPV4_TCP_UDP_FIELDS_SELECTIONs,
    LB_HASH_IPV4_TCP_UDP_PORTS_EQUAL_FIELDS_SELECTIONs,
    LB_HASH_IPV6_FIELDS_SELECTIONs,
    ...
    switch (type) {
        ...
        case bcmiHash1FieldSelectTypeMplsTransit:
            ...
            flags = mpls_use_stack ?
                    mpls_transit_use_statck_fields : mpls_transit_fields;
            break;
        case bcmiHash0FieldSelectTypeVxlanL2Payload:
            field_name = vxlan_l2_payload_hash0_fields_str;
            size = sizeof(vxlan_l2_payload_fields)/sizeof(uint32_t);
            flags = vxlan_l2_payload_fields;
            break;
        case bcmiHash1FieldSelectTypeVxlanL2Payload:
            field_name = vxlan_l2_payload_hash1_fields_str;
            size = sizeof(vxlan_l2_payload_fields)/sizeof(uint32_t);
            flags = vxlan_l2_payload_fields;
            break;
        case bcmiHash0FieldSelectTypeVxlanL3Payload:
            field_name = vxlan_l3_payload_hash0_fields_str;
            size = sizeof(vxlan_l3_payload_fields)/sizeof(uint32_t);
            flags = vxlan_l3_payload_fields;
            break;
        case bcmiHash1FieldSelectTypeVxlanL3Payload:
            field_name = vxlan_l3_payload_hash1_fields_str;
            size = sizeof(vxlan_l3_payload_fields)/sizeof(uint32_t);
            flags = vxlan_l3_payload_fields;
            break;
        default:
    ...
    switch (control) {
        ...
        case bcmiHashBinGtpTeidEnable1:
            ...
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_add(eh, field_name, field_value));
            break;
        case bcmiHashField0OverlayCntagRpidEnable:
            field_value = value;
            field_name = HASH0_BIN12_SEED_OVERLAY_ENs;
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_add(eh, field_name, field_value));
            break;
        case bcmiHashField1OverlayCntagRpidEnable:
            field_value = value;
            field_name = HASH1_BIN12_SEED_OVERLAY_ENs;
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_add(eh, field_name, field_value));
            break;
        case bcmiHashBinField0IPsec:
            switch (value) {
                case BCM_HASH_IPSEC_SELECT_OUTER_L4_PORT:
                    field_str = USE_L4_PORTs;
                    break;
                case BCM_HASH_IPSEC_SELECT_SPI:
                    field_str = USE_SPIs;
                    break;
                default:
                    SHR_IF_ERR_VERBOSE_EXIT(SHR_E_PARAM);
            }
            field_name = HASH0_BIN5_6_IPSEC_SELECTs;
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_symbol_add(eh, field_name, field_str));
            break;
        case bcmiHashBinField1IPsec:
            switch (value) {
                case BCM_HASH_IPSEC_SELECT_OUTER_L4_PORT:
                    field_str = USE_L4_PORTs;
                    break;
            ...
            field_name = HASH1_BIN5_6_IPSEC_SELECTs;
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_symbol_add(eh, field_name, field_str));
            break;
        default:
    ...
    int *value)
{
    ...
    switch (control) {
        ...
        case bcmiHashBinField0IPsec:
            ...
            if (sal_strcasecmp(field_str, USE_L4_PORTs) == 0) {
                *value = BCM_HASH_IPSEC_SELECT_OUTER_L4_PORT;
            } else if (sal_strcasecmp(field_str, USE_SPIs) == 0) {
                *value = BCM_HASH_IPSEC_SELECT_SPI;
            }
            break;
        case bcmiHashBinField1IPsec:
            field_name = HASH1_BIN5_6_IPSEC_SELECTs;
    ...
    int value)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_allocate(dunit, LB_HASH_TUNNEL_FIELDS_SELECTIONs, &eh));

    switch (type) {
        case bcmiHashTunnelField0VxlanTerm:
            switch (value) {
                case BCM_HASH_SELECT_INNER_L2:
                    field_str = INNER_L2s;
                    break;
                case BCM_HASH_SELECT_INNER_L3:
                    field_str = INNER_L3s;
                    break;
                default:
                    SHR_IF_ERR_VERBOSE_EXIT(SHR_E_PARAM);
            }
            field_name = HASH0_VXLAN_TERMs;
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_symbol_add(eh, field_name, field_str));
            break;
        case bcmiHashTunnelField1VxlanTerm:
            switch (value) {
                case BCM_HASH_SELECT_INNER_L2:
                    field_str = INNER_L2s;
                    break;
    ...
    int *value)
{
    ...
    switch (type) {
        case bcmiHashTunnelField0VxlanTerm:
            ...
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_symbol_get(eh, field_name, &field_str));
            if (sal_strcasecmp(field_str, INNER_L2s) == 0) {
                *value = BCM_HASH_SELECT_INNER_L2;
            } else if (sal_strcasecmp(field_str, INNER_L3s) == 0) {
                *value = BCM_HASH_SELECT_INNER_L3;
            }
            break;
        case bcmiHashTunnelField1VxlanTerm:
            field_name = HASH1_VXLAN_TERMs;
