        ...
        for (i = 0; i < INT_MAX_METADATA_PROFILE_NUM; i++) {
            for (j = 0; j < bcmintIntMdFieldEntryCount; j++) {
                if (int_info->metadata_field_bmp[i][j]) {
                    ...
                    int_info->metadata_field_bmp[i][j] = NULL;
                }
            }
        }
    }
