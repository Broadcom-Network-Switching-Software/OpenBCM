...
/*! Flags for all VLAN profile related control flags in flags2. */
#define LTSW_XGS_VLAN_CONTROL_VLAN_PROFILE_CTRL_FLAGS2      \
    (BCM_VLAN_FLAGS2_MEMBER_INGRESS_DISABLE)
...
static int
vlan_egr_xlate_entry_flexctr_info_fields_get(int unit,
                                             bcmlt_entry_handle_t ent_hdl,
                                             bcmi_ltsw_vlan_egr_xlate_cfg_t *cfg);
...
vlan_ing_member_ports_profile_init(int unit)
{
    ...
    /* Reserve profile 0 - empty member ports. */
    sal_memset(&profile, 0, sizeof(ltsw_vlan_ing_member_ports_profile_t));
...
vlan_default_entry_add(int unit)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_add(entry_hdl, EGR_VFI_MEMBERSHIP_CHECKs, 1));

    /* Use port group ID as default value */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_symbol_add(entry_hdl, EGR_ADAPT_PORT_GRP_MODEs,
                                      PORT_GRP_IDs));
       ...
       switch (type) {
        ...
        switch (type) {
            ...
            case bcmVlanTranslateIngressMissDrop:
                ...
                SHR_IF_ERR_VERBOSE_EXIT
                    (bcmi_ltsw_port_tab_set(unit, port_out,
                                            BCMI_PT_VFI_ING_ADAPT_LOOKUP_MISS_DROP,
                                            arg));
                SHR_EXIT();
            default:
                SHR_IF_ERR_VERBOSE_EXIT(SHR_E_UNAVAIL);
...
vlan_vfi_resolve(int unit, bcm_vlan_t vlan_vfi, uint32_t *vfi)
{
    ...
    if (!bcmi_ltsw_virtual_vlan_vpn_valid(unit, vlan_vfi)) {
        SHR_IF_ERR_VERBOSE_EXIT(SHR_E_PARAM);
    }
                                ...
                                bcmi_ltsw_vlan_ing_xlate_cfg_t *cfg)
{
    ...
    if (cfg->fld_bmp & BCMI_LTSW_VLAN_ING_XLATE_FLD_OPQ_OBJ_0) {
        fld_name = CTR_ING_EFLEX_OBJECTs;
        SHR_IF_ERR_VERBOSE_EXIT
                              ...
                              void *user_data)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_lt_entry_inuse_cnt_get(unit, table_name, &count));
    /* No entry, exit. */
    if (count == 0) {
        SHR_EXIT();
    }
    ...
    while (rv == SHR_E_NONE) {
        ...
        rv2 = cb(unit, key_type, port,
                outer_vlan, inner_vlan, &cfg, user_data);
        if (SHR_FAILURE(rv2) && bcmi_ltsw_dev_cb_err_abort(unit)) {
            SHR_IF_ERR_VERBOSE_EXIT(rv2);
        }
    }
...
static const char*
vlan_egr_xlate_vlan_tag_present_action_encode(bcmi_ltsw_vlan_egr_xlate_cfg_t *cfg)
{
...
static const char*
vlan_egr_xlate_opaque_tag_present_action_encode(bcmi_ltsw_vlan_egr_xlate_cfg_t *cfg)
{
    if (cfg->opaque_tag_present == bcmVlanActionReplace) {
        return REPLACEs;
    }

    if (cfg->opaque_tag_present == bcmVlanActionDelete) {
        return DELETEs;
    }
...
static int
vlan_egr_xlate_opaque_tag_present_action_decode(int unit,
                                                const char *action_str,
                                                bcmi_ltsw_vlan_egr_xlate_cfg_t *cfg)
{
    SHR_FUNC_ENTER(unit);
    ...
    cfg->opaque_tag_present = bcmVlanActionNone;

    if (sal_strcmp(action_str, REPLACEs) == 0) {
        cfg->opaque_tag_present = bcmVlanActionReplace;
    } else if (sal_strcmp(action_str, DELETEs) == 0) {
        cfg->opaque_tag_present = bcmVlanActionDelete;
    } else if (sal_strcmp(action_str, NO_ACTIONs) != 0) {
        SHR_ERR_EXIT(SHR_E_PARAM);
    }
                            ...
                            bcmi_ltsw_vlan_egr_xlate_cfg_t *cfg)
{
    ...
    if (cfg) {
        ...
        if ((cfg->opaque_tag_present != bcmVlanActionNone) &&
            (cfg->opaque_tag_present != bcmVlanActionReplace) &&
            (cfg->opaque_tag_present != bcmVlanActionDelete)) {
            SHR_IF_ERR_VERBOSE_EXIT(SHR_E_PARAM);
        }

        if ((cfg->opaque_tag_not_present != bcmVlanActionNone) &&
            (cfg->opaque_tag_not_present != bcmVlanActionAdd)) {
            SHR_IF_ERR_VERBOSE_EXIT(SHR_E_PARAM);
        }
 ...
 * \param [in] outer_vlan        Outer VLAN ID.
 * \param [in] inner_vlan        Inner VLAN ID.
 * \param [in] vxlan_decap       VxLAN decap.
 * \param [out] ent_hdl          LT entry container.
 *
 * \retval SHR_E_NONE            No errors.
 * \retval !SHR_E_NONE           Failure.
                             ...
                             bcmlt_entry_handle_t *ent_hdl)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_add(*ent_hdl, fld_name, vxlan_decap));
 ...
 * \param [out] outer_vlan       Outer VLAN ID.
 * \param [out] inner_vlan       Inner VLAN ID.
 * \param [out] vxlan_decap      VxLAN decap.
 *
 * \retval SHR_E_NONE            No errors.
 * \retval !SHR_E_NONE           Failure.
 */
                                ...
                                bcmi_ltsw_vlan_egr_xlate_cfg_t *cfg)
{
    ...
    /* Set opaque tag action when opaque tag present. */
    fld_name = L2_OPAQUE_TAG_PRESENT_ACTIONs;
    action_str = vlan_egr_xlate_opaque_tag_present_action_encode(cfg);
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_symbol_add(ent_hdl, fld_name, action_str));

    /* Set opaque tag action when opaque tag not present. */
    fld_name = L2_OPAQUE_TAG_NOT_PRESENT_ACTIONs;
    if (cfg->opaque_tag_not_present == bcmVlanActionAdd) {
        action_str = ADDs;
    } else {
        action_str = NO_ACTIONs;
    }
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_add(ent_hdl, fld_name, action));
    if (action) {
        fld_name = PHB_EGR_L2_ADAPT_INT_PRI_TO_OTAG_IDs;
        SHR_IF_ERR_VERBOSE_EXIT
    ...
    fld_name = PORT_DVP_IDs;
    vp = BCM_GPORT_FLOW_PORT_ID_GET(cfg->gport);
    rv = bcmi_ltsw_virtual_vp_used_get(unit, vp, BCMI_LTSW_VP_TYPE_FLOW);
    if (!rv) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_add(ent_hdl, fld_name, vp));
    }

    fld_name = DVP_GRPs;
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_add(ent_hdl, fld_name, cfg->gport_group));
                                ...
                                bcmi_ltsw_vlan_egr_xlate_cfg_t *cfg)
{
    ...
    /* Get outer opaque tag action when opaque tag present. */
    fld_name = L2_OPAQUE_TAG_PRESENT_ACTIONs;
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_symbol_get(ent_hdl, fld_name, &action_str));
    SHR_IF_ERR_VERBOSE_EXIT
        (vlan_egr_xlate_opaque_tag_present_action_decode(unit, action_str, cfg));

    /* Get opaque tag action when opaque tag not present. */
    fld_name = L2_OPAQUE_TAG_NOT_PRESENT_ACTIONs;
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_symbol_get(ent_hdl, fld_name, &action_str));
    if (sal_strcmp(action_str, ADDs) == 0) {
        cfg->opaque_tag_not_present = bcmVlanActionAdd;
    }
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_get(ent_hdl, fld_name, &value));
    rv = bcmi_ltsw_virtual_vp_used_get(unit, (int)value, BCMI_LTSW_VP_TYPE_FLOW);
    if (!rv) {
        BCM_GPORT_FLOW_PORT_ID_SET(cfg->gport, (int)value);
    }

    fld_name = DVP_GRPs;
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_get(ent_hdl, fld_name, &value));
    cfg->gport_group = (uint32)value;
...

{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (vlan_egr_xlate_entry_key_set(unit, port, outer_vlan, inner_vlan,
                                      cfg->vxlan_decap, &ent_hdl));
...
vlan_egr_xlate_entry_traverse(int unit,
                              bcmi_ltsw_vlan_egr_xlate_traverse_cb cb,
                              void *user_data)
{
    bcmlt_entry_handle_t ent_hdl = BCMLT_INVALID_HDL;
    const char *table_name = VFI_EGR_ADAPT_PORT_GRPs;
    ...
    while (rv == SHR_E_NONE) {
        sal_memset(&cfg, 0, sizeof(bcmi_ltsw_vlan_egr_xlate_cfg_t));

        SHR_IF_ERR_VERBOSE_EXIT
            (vlan_egr_xlate_entry_key_get(unit, ent_hdl, &port, &outer_vlan,
                                          &inner_vlan, &cfg.vxlan_decap));
        SHR_IF_ERR_VERBOSE_EXIT
            (vlan_egr_xlate_entry_fields_get(unit, ent_hdl, &cfg));
        ...
        rv2 = cb(unit, port, outer_vlan, inner_vlan, &cfg, user_data);
        if (SHR_FAILURE(rv2) && bcmi_ltsw_dev_cb_err_abort(unit)) {
            SHR_IF_ERR_VERBOSE_EXIT(rv2);
        }
    }
                                  ...
                                  void *user_data)
{
    ...
    /* Not deal with entries allocated by flex flow module. */
    if (cfg->vxlan_decap) {
        SHR_EXIT();
    }
...
/*!
 * \brief Recover SW states from the VFI_EGR_ADAPT_PORT_GRP table.
 *
 * This function is used to recover SW states from the VFI_EGR_ADAPT_PORT_GRP table.
 *
 * \param [in]  unit                 Unit Number.
 *
 * \retval SHR_E_NONE                No errors.
 ...
 */
static int
vlan_egr_xlate_table_recover(int unit)
{
    bcmlt_entry_handle_t ent_hdl = BCMLT_INVALID_HDL;
    int rv = SHR_E_NONE;
    int dunit = 0;
    ...
    dunit = bcmi_ltsw_dev_dunit(unit);
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_allocate(dunit, VFI_EGR_ADAPT_PORT_GRPs, &ent_hdl));
...
vlan_reinit(int unit)
{
    ...
    /* Recover SW states from the VFI_EGR_ADAPT_PORT_GRP table. */
    SHR_IF_ERR_VERBOSE_EXIT
        (vlan_egr_xlate_table_recover(unit));
                              ...
                              bcm_vlan_flexctr_config_t *config)
{
    ...
    rv = vlan_ing_xlate_entry_update(unit, key_type, port,
                                  outer_vlan, inner_vlan,
                                  &vt_cfg, 0);
                           ...
                           int *count)
{
    ...
    if (array_size > 0) {
        ...
        counter_info.action_index = vt_cfg.flex_ctr_action;
        ...
        config_array[local_count].object_value = vt_cfg.opaque_obj0;
    }
...
vlan_ing_xlate_flexctr_detach_all(int unit,
                                  ...
                                  bcm_vlan_t inner_vlan)
{
    bcm_vlan_flexctr_config_t flexctr_config;
    int array_size = 1;
    int count = 0;
    bcmi_ltsw_vlan_ing_xlate_cfg_t vt_cfg;
    ...
    sal_memset(&flexctr_config, 0, sizeof(bcm_vlan_flexctr_config_t));
    SHR_IF_ERR_VERBOSE_EXIT
        (vlan_ing_xlate_flexctr_get(unit, key_type, port,
                                    outer_vlan, inner_vlan,
                                    array_size, &flexctr_config,
                                    &count));
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_ltsw_flexctr_detach_counter_id_status_update(
            unit, flexctr_config.stat_counter_id));
...
/*!
 * \brief Set the flexctr fields of egress VLAN translation entry.
 *
 * This function is used to set the flexctr fields of egress VLAN translation entry.
 *
 * \param [in] unit              Unit number.
 * \param [in] ent_hdl           LT entry container.
 * \param [in] cfg               Egress xlate flexctr configuration.
 *
 * \retval SHR_E_NONE            No errors.
 * \retval !SHR_E_NONE           Failure.
 */
static int
vlan_egr_xlate_entry_flexctr_info_fields_set(int unit,
                                             bcmlt_entry_handle_t ent_hdl,
                                             bcmi_ltsw_vlan_egr_xlate_cfg_t *cfg)
{
    const char *fld_name;
    ...
    fld_name = CTR_EGR_EFLEX_OBJECTs;
    SHR_IF_ERR_VERBOSE_EXIT
...
/*!
 * \brief Get the flexctr fields of egress VLAN translation entry.
 *
 * This function is used to get the flexctr fields of egress VLAN translation entry.
 *
 * \param [in] unit              Unit number.
 * \param [in] ent_hdl           LT entry container.
 * \param [out] cfg              Egress xlate flexctr configuration.
 *
 * \retval SHR_E_NONE            No errors.
 * \retval !SHR_E_NONE           Failure.
 */
...
/*!
 * \brief Get egress VLAN translation flexctr info from entry.
 *
 * This function is used to get egress VLAN translation flexctr info from entry.
 *
 * \param [in] unit              Unit number.
 * \param [in] port              Port group ID.
 * \param [in] outer_vlan        Outer VLAN ID.
 ...
 */
static int
vlan_egr_xlate_entry_flexctr_info_get(int unit,
                                      bcm_gport_t port,
                                      bcm_vlan_t outer_vlan,
                                      bcm_vlan_t inner_vlan,
                                      bcmi_ltsw_vlan_egr_xlate_cfg_t *cfg)
{
    ...
    /* Get the flexctr fields of egress vxlate entry. */
    SHR_IF_ERR_VERBOSE_EXIT
        (vlan_egr_xlate_entry_flexctr_info_fields_get(unit, ent_hdl, cfg));
...
/*!
 * \brief Set egress VLAN translation flexctr info to entry.
 *
 * This function is used to set egress VLAN translation flexctr info to entry.
 *
 * \param [in] unit              Unit number.
 * \param [in] port              Port ID.
 * \param [in] outer_vlan        Outer VLAN ID.
 ...
 */
static int
vlan_egr_xlate_entry_flexctr_info_set(int unit,
                                      bcm_gport_t port,
                                      bcm_vlan_t outer_vlan,
                                      bcm_vlan_t inner_vlan,
                                      bcmi_ltsw_vlan_egr_xlate_cfg_t *cfg)
{
    ...
    /* Set the flexctr fields of egress vxlate entry. */
    SHR_IF_ERR_VERBOSE_EXIT
        (vlan_egr_xlate_entry_flexctr_info_fields_set(unit, ent_hdl, cfg));
...
{
    bcmi_ltsw_flexctr_counter_info_t counter_info;
    bcmi_ltsw_vlan_egr_xlate_cfg_t vt_cfg;
    int update_object_only = 0;
    int rv = 0;
    ...
    sal_memset(&vt_cfg, 0, sizeof(bcmi_ltsw_vlan_egr_xlate_cfg_t));

    SHR_IF_ERR_VERBOSE_EXIT
         (vlan_egr_xlate_entry_flexctr_info_get(unit, port,
                                                outer_vlan, inner_vlan,
                                                &vt_cfg));
    ...
    /* Set flexctr information. */
    rv = vlan_egr_xlate_entry_flexctr_info_set(unit, port,
                                               outer_vlan, inner_vlan,
                                               &vt_cfg);
    if (SHR_FAILURE(rv)) {
        if (!update_object_only) {
    ...
    if (array_size > 0) {
        ...
        SHR_IF_ERR_VERBOSE_EXIT
           (bcmi_ltsw_flexctr_counter_id_get(
               unit, &counter_info,
               &(config_array[local_count].stat_counter_id)));
        config_array[local_count].object_value = vt_cfg.flex_ctr_index;
    }
                              ...
                              bcm_vlan_flexctr_config_t *config)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (vlan_egr_xlate_entry_flexctr_info_set(unit, port,
                                               outer_vlan, inner_vlan,
                                               &vt_cfg));
                              ...
                              bcm_vlan_control_vlan_t *control)
{
    ...
    const char *port_grp_mode;
    int vp_replication = 0;
    uint32_t group_id = 0;
    ...
    vpt.flags2 = control->flags2 &
                LTSW_XGS_VLAN_CONTROL_VLAN_PROFILE_CTRL_FLAGS2;
    if (valid_fields & BCM_VLAN_CONTROL_VLAN_OUTER_TPID_MASK) {
    ...
    if (valid_fields & BCM_VLAN_CONTROL_VLAN_BROADCAST_GROUP_MASK) {
        /* In case the value is not BCM_MULTICAST_INVALID */
        if (control->broadcast_group) {
            group_id = _BCM_MULTICAST_ID_GET(control->broadcast_group);
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_add(eh, L3_BC_GRP_IDs, group_id));
            if (vp_replication == 0) {
                vp_replication = 1;
            }
        }
    ...
    if (valid_fields & BCM_VLAN_CONTROL_VLAN_UNKNOWN_MULTICAST_GROUP_MASK) {
        ...
        if (control->unknown_multicast_group) {
            group_id = _BCM_MULTICAST_ID_GET(control->unknown_multicast_group);
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_add(eh, L3_UNKOWN_MC_GRP_IDs, group_id));
            if (vp_replication == 0) {
                vp_replication = 1;
            }
        }
    ...
    if (valid_fields & BCM_VLAN_CONTROL_VLAN_UNKNOWN_UNICAST_GROUP_MASK) {
        ...
        if (control->unknown_unicast_group) {
            group_id = _BCM_MULTICAST_ID_GET(control->unknown_unicast_group);
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_add(eh, L3_UNKOWN_UC_GRP_IDs, group_id));
            if (vp_replication == 0) {
                vp_replication = 1;
            }
        }
    ...
    /* Enable VP_REPLICATION in case any group ID is valid */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_add(eh, VP_REPLICATIONs, vp_replication));
    ...
    /* Port group mode for egress adaptation */
    if (control->egress_translate_key == bcmVlanTranslateEgressKeyVpn) {
        port_grp_mode = ALL_ONESs;
    } else {
        /* Use port group ID as default value */
        port_grp_mode = PORT_GRP_IDs;
    }
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_symbol_add(eh, EGR_ADAPT_PORT_GRP_MODEs,
                                      port_grp_mode));
                              ...
                              bcm_vlan_control_vlan_t *control)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_get(eh, VP_REPLICATIONs, &data));
    vp_replication = (int)data;

    if (valid_fields & BCM_VLAN_CONTROL_VLAN_BROADCAST_GROUP_MASK) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_get(eh, L3_BC_GRP_IDs, &data));
        group_id = (uint32_t)data;
        if ((vp_replication == 0) || (group_id == 0)) {
            control->broadcast_group = BCM_MULTICAST_INVALID;
        } else {
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmi_ltsw_multicast_l3_grp_id_get(unit, group_id,
    ...
    if (valid_fields & BCM_VLAN_CONTROL_VLAN_UNKNOWN_MULTICAST_GROUP_MASK) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_get(eh, L3_UNKOWN_MC_GRP_IDs, &data));
        group_id = (uint32_t)data;
        if ((vp_replication == 0) || (group_id == 0)) {
            control->unknown_multicast_group = BCM_MULTICAST_INVALID;
        } else {
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmi_ltsw_multicast_l3_grp_id_get
                    (unit, group_id, &control->unknown_multicast_group));
        }
    }

    if (valid_fields & BCM_VLAN_CONTROL_VLAN_UNKNOWN_UNICAST_GROUP_MASK) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_get(eh, L3_UNKOWN_UC_GRP_IDs, &data));
        group_id = (uint32_t)data;
        if ((vp_replication == 0) || (group_id == 0)) {
            control->unknown_unicast_group = BCM_MULTICAST_INVALID;
        } else {
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmi_ltsw_multicast_l3_grp_id_get
                    (unit, group_id, &control->unknown_unicast_group));
        }
    }
    ...
    /* Port group mode for egress adaptation */
    SHR_IF_ERR_VERBOSE_EXIT
      (bcmlt_entry_field_symbol_get(eh, EGR_ADAPT_PORT_GRP_MODEs,
                                    &port_grp_mode));
    if (sal_strcmp(port_grp_mode, ALL_ONESs) == 0) {
        control->egress_translate_key = bcmVlanTranslateEgressKeyVpn;
    } else {
        control->egress_translate_key = bcmVlanTranslateEgressKeyVpnPortGroup;
    }
                                    ...
                                    void *user_data)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_lt_entry_inuse_cnt_get(unit, L2_VFI_FDB_CCs, &count));
    /* No entry, exit. */
    if (count == 0) {
        SHR_EXIT();
    }
    ...
    while (rv == SHR_E_NONE) {
        ...
        rv2 = cb(unit, vid, BCM_VLAN_INVALID, gport_1, gport_2, user_data);
        if (SHR_FAILURE(rv2) && bcmi_ltsw_dev_cb_err_abort(unit)) {
            SHR_IF_ERR_VERBOSE_EXIT(rv2);
        }
    }
                            ...
                            int index)
{
    ...
    switch (profile_hdl) {
        ...
        case BCMI_LTSW_PROFILE_VLAN_ING_EGR_MEMBER_PORTS_PROFILE:
            ...
            break;
        case BCMI_LTSW_PROFILE_VLAN:
            SHR_IF_ERR_VERBOSE_EXIT
                (vlan_profile_entry_delete(unit, index));
            break;
        default:
            SHR_IF_ERR_VERBOSE_EXIT(SHR_E_PARAM);
    }
                                  ...
                                  bcm_vlan_action_set_t *action)
{
    ...
    cfg.opaque_tag_present = action->opaque_tag_present;
    cfg.opaque_tag_not_present = action->opaque_tag_not_present;

    /* Set DVP and DVP group. */
    cfg.gport = action->gport;
    cfg.gport_group = action->gport_group;
    ...
    /* VxLAN decap always 0 for entries used for VLAN xlate. */
    cfg.vxlan_decap = 0;
                                  ...
                                  bcm_vlan_action_set_t *action)
{
    ...
    action->ut_outer = cfg.ut_outer;
    action->outer_tpid_action = cfg.outer_tpid_action;
    action->opaque_tag_present = cfg.opaque_tag_present;
    action->opaque_tag_not_present = cfg.opaque_tag_not_present;

    /* Get DVP and DVP group. */
    action->gport = cfg.gport;
    action->gport_group = cfg.gport_group;
 ...
 * \param [in] outer_vlan        Outer VLAN ID.
 * \param [in] inner_vlan        Inner VLAN ID.
 * \param [in] cfg               VLAN Actions.
 *
 * \retval SHR_E_NONE            No errors.
 * \retval !SHR_E_NONE           Failure.
 */
int
xgs_ltsw_vfi_egr_xlate_add(int unit,
                           bcm_gport_t port,
                           bcm_vlan_t outer_vlan,
                           bcm_vlan_t inner_vlan,
                           bcmi_ltsw_vlan_egr_xlate_cfg_t *cfg)
 ...
 */
int
xgs_ltsw_vfi_egr_xlate_get(int unit,
                           bcm_gport_t port,
                           bcm_vlan_t outer_vlan,
                           bcm_vlan_t inner_vlan,
                           bcmi_ltsw_vlan_egr_xlate_cfg_t *cfg)
{
    /* vxlan_decap is part of key and should be keeped. */
    uint8_t vxlan_decap = cfg->vxlan_decap;
 ...
 */
int
xgs_ltsw_vfi_egr_xlate_delete(int unit,
                              bcm_gport_t port,
                              bcm_vlan_t outer_vlan,
                              bcm_vlan_t inner_vlan,
                              bcmi_ltsw_vlan_egr_xlate_cfg_t *cfg)
 ...
 */
int
xgs_ltsw_vfi_egr_xlate_traverse(int unit,
                                bcmi_ltsw_vlan_egr_xlate_traverse_cb cb,
                                void *user_data)
{
    SHR_FUNC_ENTER(unit);
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (vlan_egr_xlate_entry_traverse(unit, cb, user_data));
exit:
    SHR_FUNC_EXIT();
}

int
xgs_ltsw_vfi_traverse(int unit, int ingress,
                      bcmi_ltsw_vlan_traverse_cb cb, void *user_data)
{
    ...
    while ((rv = bcmi_lt_entry_commit(unit, eh,
        ...
        SHR_IF_ERR_VERBOSE_EXIT
            (cb(unit, ingress, &info, user_data));
    }
 ...
 */
int
xgs_ltsw_vfi_ing_xlate_flexctr_attach(int unit,
                                      bcm_vlan_translate_key_t key_type,
                                      bcm_gport_t port,
                                      bcm_vlan_t outer_vlan,
                                      bcm_vlan_t inner_vlan,
 ...
 */
int
xgs_ltsw_vfi_ing_xlate_flexctr_detach(int unit,
                                      bcm_vlan_translate_key_t key_type,
                                      bcm_gport_t port,
                                      bcm_vlan_t outer_vlan,
                                      bcm_vlan_t inner_vlan,
 ...
 */
int
xgs_ltsw_vfi_ing_xlate_flexctr_get(int unit,
                                   bcm_vlan_translate_key_t key_type,
                                   bcm_gport_t port,
                                   bcm_vlan_t outer_vlan,
                                   bcm_vlan_t inner_vlan,
 ...
 */
int
xgs_ltsw_vfi_egr_xlate_flexctr_attach(int unit,
                                      bcm_gport_t port,
                                      bcm_vlan_t outer_vlan,
                                      bcm_vlan_t inner_vlan,
                                      bcm_vlan_flexctr_config_t *config)
 ...
 */
int
xgs_ltsw_vfi_egr_xlate_flexctr_detach(int unit,
                                      bcm_gport_t port,
                                      bcm_vlan_t outer_vlan,
                                      bcm_vlan_t inner_vlan,
                                      bcm_vlan_flexctr_config_t *config)
 ...
 */
int
xgs_ltsw_vfi_egr_xlate_flexctr_get(int unit,
                                   bcm_gport_t port,
                                   bcm_vlan_t outer_vlan,
                                   bcm_vlan_t inner_vlan,
                                   int array_size,
