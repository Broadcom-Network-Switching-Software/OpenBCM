...
#define XGS_TNL_DEFAULT_TERM_MASK    0
#define XGS_TNL_DEFAULT_TERM_EM      1
...
typedef struct xgs_ltsw_tunnel_info_s {
    ...
    /* IP tunnel default termination by exact match or by mask. */
    int tunnel_default_term;
...
#define TUNNEL_DEFAULT_TERM(_u) \
    xgs_ltsw_tunnel_info[_u].tunnel_default_term
                       ...
                       bool key, bool data)
{
    ...
    if (key) {
        if (tnl_type.tnl_outer_hdr_ipv6) {
            ...
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_add(entry_hdl, SRC_IPV6_UPPER_MASKs,
                                       sip_mask));
            bcmi_ltsw_util_ip6_half_to_uint64
                (&sip_mask, &(tnl_term_info->sip6_mask), 1);
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_add(entry_hdl, SRC_IPV6_LOWER_MASKs,
                                       sip_mask));
            ...
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_add(entry_hdl, DST_IPV6_UPPER_MASKs,
                                       dip_mask));
            bcmi_ltsw_util_ip6_half_to_uint64
                (&dip_mask, &(tnl_term_info->dip6_mask), 1);
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_add(entry_hdl, DST_IPV6_LOWER_MASKs,
                                       dip_mask));
        } else {
            /* IPv4 */
                        ...
                        bool key_parse, bool data_parse)
{
    ...
    if (key_parse) {
        if (ip6) {
            ...
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_get(entry_hdl, SRC_IPV6_UPPER_MASKs,
                                       &sip_mask));
            bcmi_ltsw_util_uint64_to_ip6_half
                (&(tnl_term_info->sip6_mask), &sip_mask, 0);

            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_get(entry_hdl, SRC_IPV6_LOWER_MASKs,
                                       &sip_mask));
            bcmi_ltsw_util_uint64_to_ip6_half
            ...
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_get(entry_hdl, DST_IPV6_UPPER_MASKs,
                                       &dip_mask));
            bcmi_ltsw_util_uint64_to_ip6_half
                (&(tnl_term_info->dip6_mask), &dip_mask, 0);

            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_get(entry_hdl, DST_IPV6_LOWER_MASKs,
                                       &dip_mask));
            bcmi_ltsw_util_uint64_to_ip6_half
            ...
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_get(entry_hdl, DST_IPV4_MASKs, &dip_mask));
            tnl_term_info->dip_mask = (bcm_ip_t)dip_mask;
        }
    ...
    if (data_parse) {
        ...
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_get(entry_hdl, ENTRY_PRIORITYs, &tmp_val));
        tnl_term_info->priority = tmp_val;
    ...
    if (TUNNEL_DEFAULT_TERM(unit) == XGS_TNL_DEFAULT_TERM_EM) {
        tnl_term_info->flags |= BCM_TUNNEL_TERM_MASK;
    }
                           ...
                           bool key_parse, bool data_parse)
{
    ...
    if (TUNNEL_DEFAULT_TERM(unit) == XGS_TNL_DEFAULT_TERM_MASK) {
...
int
xgs_ltsw_tunnel_init_lt_db(int unit)
{
    return SHR_E_NONE;
}
...
xgs_ltsw_tunnel_init(int unit)
{
    ...
    if (warmboot) {
        ...
        while ((rv = bcmi_lt_entry_commit(unit, entry_hdl, BCMLT_OPCODE_TRAVERSE,
            ...
            rv = tunnel_init_recover(unit, idx, 0);
            if (SHR_FAILURE(rv)) {
                if (rv != SHR_E_NOT_FOUND) {
                    SHR_IF_ERR_VERBOSE_EXIT(rv);
                }
        ...
        while ((rv = bcmi_lt_entry_commit(unit, entry_hdl, BCMLT_OPCODE_TRAVERSE,
            ...
            rv = tunnel_init_recover(unit, idx, 1);
            if (SHR_FAILURE(rv)) {
                if (rv != SHR_E_NOT_FOUND) {
                    SHR_IF_ERR_VERBOSE_EXIT(rv);
                }
    ...
    /* Get IP tunnel default termination by exact match or by mask from config. */
    TUNNEL_DEFAULT_TERM(unit) =
        bcmi_ltsw_property_get(unit, BCMI_CPN_IP_TUNNEL_DEFAULT_TERM, 0);
...
int
xgs_ltsw_tunnel_initiator_flexctr_object_get(
    int unit,
    bcm_if_t intf,
    uint32_t *value)
{
    ...
    bcm_tunnel_terminator_t *tnl_term_info)
{
    ...
    if (((TUNNEL_DEFAULT_TERM(unit) == XGS_TNL_DEFAULT_TERM_MASK) &&
          (tnl_term_info->flags & BCM_TUNNEL_TERM_EM)) ||
         ((TUNNEL_DEFAULT_TERM(unit) == XGS_TNL_DEFAULT_TERM_EM) &&
          (!(tnl_term_info->flags & BCM_TUNNEL_TERM_MASK)))) {
        /* EM tables. */
        if (ip6) {
            SHR_IF_ERR_VERBOSE_EXIT
