...
xgs_ltsw_virtual_vfi_cleanup(int unit, int vfi)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_get(entry_hdl, VFI_PROFILE_IDs,
                               &get_val));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_ltsw_vlan_profile_delete(unit, BCMI_LTSW_PROFILE_VLAN,
                                       (int)get_val));
...
int
xgs_ltsw_virtual_qos_port_map_set(
    int unit,
    bcm_gport_t port,
    int ing_map,
    int egr_map)
{
    ...
    if (ing_map != -1) {
        ...
        if (ing_map == 0) {
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_add(entry_hd_svp, PHB_ING_L2_IDs, 0));
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_add(entry_hd_svp,
                                       TRUST_PHB_ING_DSCP_V6s, 0));
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_add(entry_hd_svp,
                                       TRUST_PHB_ING_DSCP_V4s, 0));
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_add(entry_hd_svp,
                                       PHB_ING_IP_DSCP_TO_INT_PRI_REMAP_IDs, 0));
        } else {
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmi_ltsw_qos_map_id_resolve(unit, ing_map, &qos_type,
                                              &qos_base_ptr));
            if (qos_type == bcmiQosMapTypeL2Ingress) {
                SHR_IF_ERR_VERBOSE_EXIT
                    (bcmlt_entry_field_add(entry_hd_svp, PHB_ING_L2_IDs,
                                           qos_base_ptr));
            } else if (qos_type == bcmiQosMapTypeL3Ingress) {
                SHR_IF_ERR_VERBOSE_EXIT
                    (bcmlt_entry_field_add(entry_hd_svp,
                                           TRUST_PHB_ING_DSCP_V6s, 1));
                SHR_IF_ERR_VERBOSE_EXIT
                    (bcmlt_entry_field_add(entry_hd_svp,
                                           TRUST_PHB_ING_DSCP_V4s, 1));
                SHR_IF_ERR_VERBOSE_EXIT
                    (bcmlt_entry_field_add(entry_hd_svp,
                                           PHB_ING_IP_DSCP_TO_INT_PRI_REMAP_IDs,
                                           qos_base_ptr));
...
exit:
    if (BCMLT_INVALID_HDL != entry_hd_svp) {
        (void) bcmlt_entry_free(entry_hd_svp);
        entry_hd_svp = BCMLT_INVALID_HDL;
    }
...
int
xgs_ltsw_virtual_qos_port_map_type_get(
    int unit,
    bcm_gport_t port,
    uint32_t flags,
    int *map_id)
