...
typedef struct cosq_wred_drop_curve_profile_s {
    ...
    /* instant ecn marking green minimum threshold. */
    uint32_t                     instant_ecn_green_drop_min_thd_cells;

    /* instant ecn marking green maximum threshold. */
    uint32_t                     instant_ecn_green_drop_max_thd_cells;

    /* instant ecn marking green drop percentage. */
    cosq_wred_drop_percentage_t  instant_ecn_green_drop_percentage;

    /* instant ecn marking yellow minimum threshold. */
    uint32_t                     instant_ecn_yellow_drop_min_thd_cells;

    /* instant ecn marking yellow maximum threshold. */
    uint32_t                     instant_ecn_yellow_drop_max_thd_cells;

    /* instant ecn marking yellow drop percentage. */
    cosq_wred_drop_percentage_t  instant_ecn_yellow_drop_percentage;

    /* instant ecn marking red minimum threshold. */
    uint32_t                     instant_ecn_red_drop_min_thd_cells;

    /* instant ecn marking red maximum threshold. */
    uint32_t                     instant_ecn_red_drop_max_thd_cells;

    /* instant ecn marking red drop percentage. */
    cosq_wred_drop_percentage_t  instant_ecn_red_drop_percentage;
...
cosq_tm_wred_uc_queue_set(int unit, bcm_port_t lport, int queue_id,
                          ...
                          bool ecn, int ecn_mode, int time_profile_idx,
                          ...
                          int drop_curve_profile_idx)
{
    ...
    if (SHR_SUCCESS(bcmi_lt_field_validate(unit, TM_WRED_UC_Qs, ECN_MODEs))) {
        fields[10].flags = BCMI_LT_FIELD_F_SET|BCMI_LT_FIELD_F_SYMBOL;
        fields[10].u.sym_val = (ecn_mode ? INSTANT_Q_SIZEs : AVG_Q_SIZEs);
    }
                          ...
                          int *drop_curve_profile_idx)
{
    ...
    *ecn_mode = 0;
    ...
    if (SHR_SUCCESS(bcmi_lt_field_validate(unit, TM_WRED_UC_Qs, ECN_MODEs))) {
        fields[10].flags = BCMI_LT_FIELD_F_GET|BCMI_LT_FIELD_F_SYMBOL;
    }
    ...
    *drop_curve_profile_idx  = fields[9].u.val;
    if (SHR_SUCCESS(bcmi_lt_field_validate(unit, TM_WRED_UC_Qs, ECN_MODEs))) {
        if (fields[10].u.sym_val &&
            sal_strcmp(fields[10].u.sym_val, INSTANT_Q_SIZEs) == 0) {
            *ecn_mode = 1;
        }
    }
exit:
                                       ...
                                       int *profile_idx)
{
    ...
    cosq_wred_drop_curve_field_t fields[] =
    {
        ...
        /*9 */ {INSTANT_ECN_GREEN_DROP_MIN_THD_CELLSs,
                INSTANT_ECN_GREEN_DROP_MAX_THD_CELLSs,
                INSTANT_ECN_GREEN_DROP_PERCENTAGEs},
        /*10*/ {INSTANT_ECN_YELLOW_DROP_MIN_THD_CELLSs,
                INSTANT_ECN_YELLOW_DROP_MAX_THD_CELLSs,
                INSTANT_ECN_YELLOW_DROP_PERCENTAGEs},
        /*11*/ {INSTANT_ECN_RED_DROP_MIN_THD_CELLSs,
                INSTANT_ECN_RED_DROP_MAX_THD_CELLSs,
                INSTANT_ECN_RED_DROP_PERCENTAGEs},
    };
    ...
    if (SHR_SUCCESS(bcmi_lt_field_validate(unit, TM_WRED_UC_Qs, ECN_MODEs))) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_add(entry_hdl, fields[9].min_name,
                                   profile->instant_ecn_green_drop_min_thd_cells));

        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_add(entry_hdl, fields[9].max_name,
                                   profile->instant_ecn_green_drop_max_thd_cells));

        rate = drv->cosq_wred_percent_to_drop_prob(
                profile->instant_ecn_green_drop_percentage);

        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_symbol_add(entry_hdl, fields[9].rate_name, rate));

        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_add(entry_hdl, fields[10].min_name,
                                   profile->instant_ecn_yellow_drop_min_thd_cells));

        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_add(entry_hdl, fields[10].max_name,
                                   profile->instant_ecn_yellow_drop_max_thd_cells));

        rate = drv->cosq_wred_percent_to_drop_prob(
                profile->instant_ecn_yellow_drop_percentage);

        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_symbol_add(entry_hdl, fields[10].rate_name, rate));

        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_add(entry_hdl, fields[11].min_name,
                                   profile->instant_ecn_red_drop_min_thd_cells));

        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_add(entry_hdl, fields[11].max_name,
                                   profile->instant_ecn_red_drop_max_thd_cells));

        rate = drv->cosq_wred_percent_to_drop_prob(
                profile->instant_ecn_red_drop_percentage);

        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_symbol_add(entry_hdl, fields[11].rate_name, rate));
    }
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_lt_entry_commit(unit, entry_hdl,
                              BCMLT_OPCODE_INSERT,
                                       ...
                                       cosq_wred_drop_curve_profile_t *profile)
{
    ...
    if (SHR_SUCCESS(bcmi_lt_field_validate(unit, TM_WRED_UC_Qs, ECN_MODEs))) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_get(entry_hdl, fields[9].min_name,
                                   &(value.val)));

        profile->instant_ecn_green_drop_min_thd_cells = value.val;

        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_get(entry_hdl, fields[9].max_name,
                                   &(value.val)));

        profile->instant_ecn_green_drop_max_thd_cells = value.val;

        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_symbol_get(entry_hdl, fields[9].rate_name,
                                          &(value.sym_val)));
        ...
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_get(entry_hdl, fields[10].min_name,
                                   &(value.val)));

        profile->instant_ecn_yellow_drop_min_thd_cells = value.val;

        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_get(entry_hdl, fields[10].max_name,
                                   &(value.val)));

        profile->instant_ecn_yellow_drop_max_thd_cells = value.val;

        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_symbol_get(entry_hdl, fields[10].rate_name,
                                          &(value.sym_val)));
        ...
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_get(entry_hdl, fields[11].min_name,
                                   &(value.val)));

        profile->instant_ecn_red_drop_min_thd_cells = value.val;

        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_get(entry_hdl, fields[11].max_name,
                                   &(value.val)));

        profile->instant_ecn_red_drop_max_thd_cells = value.val;

        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_symbol_get(entry_hdl, fields[11].rate_name,
                                          &(value.sym_val)));
                                  ...
                                  cosq_wred_drop_curve_profile_t *profile)
{
    ...
    if (wred_flags & BCM_COSQ_DISCARD_INSTANT_ECT_MARKED) {
        if (wred_flags & BCM_COSQ_DISCARD_COLOR_GREEN) {
            profile->instant_ecn_green_drop_min_thd_cells = min_thresh;
            profile->instant_ecn_green_drop_max_thd_cells = max_thresh;
            drop_prob = drv->cosq_wred_percent_to_drop_prob(rate);
            new_rate = drv->cosq_wred_drop_prob_to_percent(drop_prob);
            profile->instant_ecn_green_drop_percentage = new_rate;
        }
        if (wred_flags & BCM_COSQ_DISCARD_COLOR_YELLOW) {
            profile->instant_ecn_yellow_drop_min_thd_cells = min_thresh;
            profile->instant_ecn_yellow_drop_max_thd_cells = max_thresh;
            drop_prob = drv->cosq_wred_percent_to_drop_prob(rate);
            new_rate = drv->cosq_wred_drop_prob_to_percent(drop_prob);
            profile->instant_ecn_yellow_drop_percentage = new_rate;
        }
        if (wred_flags & BCM_COSQ_DISCARD_COLOR_RED) {
            profile->instant_ecn_red_drop_min_thd_cells = min_thresh;
            profile->instant_ecn_red_drop_max_thd_cells = max_thresh;
            drop_prob = drv->cosq_wred_percent_to_drop_prob(rate);
            new_rate = drv->cosq_wred_drop_prob_to_percent(drop_prob);
            profile->instant_ecn_red_drop_percentage = new_rate;
        }
    }
                                 ...
                                 tm_ltsw_cosq_wred_config_t *wred_config)
{
    ...
    } else if (wred_config->flags & BCM_COSQ_DISCARD_INSTANT_ECT_MARKED) {
        if (wred_config->flags & BCM_COSQ_DISCARD_COLOR_YELLOW) {
            min_thresh = profile.instant_ecn_yellow_drop_min_thd_cells;
            max_thresh = profile.instant_ecn_yellow_drop_max_thd_cells;
            rate       = profile.instant_ecn_yellow_drop_percentage;
        } else if (wred_config->flags & BCM_COSQ_DISCARD_COLOR_RED) {
            min_thresh = profile.instant_ecn_red_drop_min_thd_cells;
            max_thresh = profile.instant_ecn_red_drop_max_thd_cells;
            rate       = profile.instant_ecn_red_drop_percentage;
        } else {
            /* By default we will assume
               BCM_COSQ_DISCARD_COLOR_GREEN */
            min_thresh = profile.instant_ecn_green_drop_min_thd_cells;
            max_thresh = profile.instant_ecn_green_drop_max_thd_cells;
            rate       = profile.instant_ecn_green_drop_percentage;
        }
    } else {
        if (wred_config->flags & BCM_COSQ_DISCARD_COLOR_YELLOW) {
...
cosq_wred_drop_curve_default_profile_add(int unit)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (tm_ltsw_cosq_wred_drop_default_threshold_get(unit, &min_thresh, &max_thresh));

    wred_config.min_thresh = max_thresh;
    ...
    if (SHR_SUCCESS(bcmi_lt_field_validate(unit, TM_WRED_UC_Qs, ECN_MODEs))) {
        wred_config.flags |= BCM_COSQ_DISCARD_INSTANT_ECT_MARKED;
    }
...
cosq_wred_config_fill(int unit, tm_ltsw_cosq_wred_config_t *wred_config,
                      ...
                      int ecn_mode, uint32_t profile_index, uint32_t time_profile_idx,
                      uint32_t mark_ecn_profile_idx, uint32_t drop_ecn_profile_idx)
{
    ...
    if (ecn_mode) {
        wred_config->flags |= BCM_COSQ_DISCARD_INSTANT_QUEUE_SIZE;
    }
                           ...
                           tm_ltsw_cosq_wred_config_t *wred_config)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (cosq_wred_config_fill(unit, wred_config, current_q_size, gain, wred, 0,
                               0, profile_index, time_profile_idx, 0, 0));
                       ...
                       tm_ltsw_cosq_wred_config_t wred_config)
{
    ...
    for (queue = from_cosq; queue <= to_cosq; queue++ ) {
        ...
        if (!wred_config.ignore_enable_flags) {
            ...
            ecn_mode = wred_config.flags &
                             BCM_COSQ_DISCARD_INSTANT_QUEUE_SIZE ? 1 : 0;
        }
        ...
        if (wred_config.need_profile) {
            SHR_IF_ERR_CONT
                (cosq_tm_wred_uc_queue_set(unit, port, queue, wred_config.gain,
                                           current_q_size, wred, ecn, ecn_mode,
            ...
            LOG_INFO(BSL_LOG_MODULE,
                (BSL_META_U(unit, "Port:%d cosq:%d old_profile_index = %d profile_index = %d\n"),
                            port, queue, old_profile_index, profile_index));
                       ...
                       tm_ltsw_cosq_wred_config_t *wred_config)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (cosq_tm_wred_uc_queue_get(unit, port, queue, &gain, &current_q_size,
                                   &wred, &ecn, &ecn_mode, &time_profile_idx,
                                   &mark_ecn_profile_idx,
                                   &drop_ecn_profile_idx, &profile_index));

    SHR_IF_ERR_VERBOSE_EXIT
        (cosq_wred_config_fill(unit, wred_config, current_q_size,
                               gain, wred, ecn, ecn_mode,
...
cosq_hierarchy_init(int unit)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_ltsw_port_bitmap(unit, BCMI_LTSW_PORT_TYPE_RDB, &rdb_pbmp));
    BCM_PBMP_REMOVE(pbmp, rdb_pbmp);
...
int
tm_ltsw_cosq_wred_drop_default_threshold_get(
    int unit,
    int *min_thresh,
    int *max_thresh)
{
