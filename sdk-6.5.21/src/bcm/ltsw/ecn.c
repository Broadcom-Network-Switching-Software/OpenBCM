 ...
 *
 * \param [in] unit Unit number.
 * \param [in/out] profile  Profile structure.
 *
 * \retval SHR_E_NONE No errors.
 * \retval !SHR_E_NONE Failure.
 */
int bcm_ltsw_ecn_map_profile_set(
    int unit,
    bcm_ecn_map_profile_t *profile)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_ecn_map_profile_set(unit, profile));
 ...
 * \retval !SHR_E_NONE Failure.
 */
int bcm_ltsw_ecn_map_profile_get(
    int unit,
    bcm_ecn_map_profile_t *profile)
{
    int ecn_lock = 0;
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_ecn_map_profile_get(unit, profile));
