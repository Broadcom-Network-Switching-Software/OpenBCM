...
#define PC_TX_FIR_PRE3               (1 << 22)
#define PC_TX_FIR_PRE3_AUTO          (1 << 23)

#define PC_TX_FIR_AUTO  (PC_TX_FIR_PRE_AUTO|PC_TX_FIR_PRE2_AUTO|PC_TX_FIR_MAIN_AUTO|PC_TX_FIR_POST_AUTO|    \
                        PC_TX_FIR_POST2_AUTO|PC_TX_FIR_POST3_AUTO|PC_TX_FIR_RPARA_AUTO|PC_TX_FIR_AMP_AUTO|  \
                        PC_TX_FIR_DRV_MODE_AUTO|PC_TX_FIR_TAP_MODE_AUTO|PC_TX_FIR_SIG_MODE_AUTO|PC_TX_FIR_PRE3_AUTO)
...
typedef struct pc_tx_taps_data_s {
    ...
    uint64_t tx_pre3_auto;
    uint64_t tx_pre3;
    uint64_t tx_pre3_sign;
...
#define PC_AUTONEG_FEC_OVERRIDE_AUTO                (1ULL << 32)
#define PC_AUTONEG_FEC_OVERRIDE                     (1ULL << 33)
...
typedef struct pc_phy_control_data_s {
    ...
    uint64_t an_fec_override_auto;
    uint64_t an_fec_override;
...
typedef struct pc_port_diag_stats_data_s {
    ...
    uint64_t fec_correct_blks;
    uint64_t fec_uncorrect_blks;
...
/* PRBS macros */
#define LTSW_PHY_PRBS_LOCK_LOSS                         -1
#define LTSW_PHY_PRBS_LOCK_LOST_LATCH                   -2

/* PC_PHY_PRBS_CONTROL table field. */
#define PC_PHY_PRBS_CONTROL_GENERATOR_ENABLE            (1 << 1)
#define PC_PHY_PRBS_CONTROL_CHECKER_ENABLE              (1 << 2)
#define PC_PHY_PRBS_CONTROL_POLY_MODE                   (1 << 3)
#define PC_PHY_PRBS_CONTROL_INVERT_DATA_TX              (1 << 4)
#define PC_PHY_PRBS_CONTROL_INVERT_DATA_RX              (1 << 5)

typedef struct pc_phy_prbs_control_data_s {
    uint64_t generator_enable;
    uint64_t checker_enable;
    uint64_t invert_data_tx;
    uint64_t invert_data_rx;
    const char * poly_mode;
} pc_phy_prbs_control_data_t;

typedef struct pc_phy_prbs_control_field_s {
    uint64_t lport;
    uint64_t lane_idx;
    uint64_t field_bmp;
    pc_phy_prbs_control_data_t* phy_prbs_ctrl_data;
} pc_phy_prbs_control_field_t;

/* PC_PHY_PRBS_STATUS table field. */
typedef struct pc_phy_prbs_status_data_s {
    uint64_t lock_live;
    uint64_t lock_loss;
...
typedef struct pc_phy_prbs_status_field_s {
    uint64_t lport;
    uint64_t lane_idx;
    uint64_t field_bmp;
    pc_phy_prbs_status_data_t* phy_prbs_status_data;
} pc_phy_prbs_status_field_t;

/* PC_PORT_DIAG_CONTROL table field. */
#define PC_PORT_DIAG_CONTROL_ERROR_MASK_63_0            (1 << 1)
#define PC_PORT_DIAG_CONTROL_ERROR_MASK_127_64          (1 << 2)
#define PC_PORT_DIAG_CONTROL_ERROR_CONTROL_MAP          (1 << 3)

typedef struct pc_port_diag_control_data_s {
    uint64_t error_mask_63_0;
    uint64_t error_mask_127_64;
    uint64_t error_control_map;
} pc_port_diag_control_data_t;

typedef struct pc_port_diag_control_field_s {
    uint64_t lport;
    uint64_t field_bmp;
    pc_port_diag_control_data_t* port_diag_control_data;
} pc_port_diag_control_field_t;
...
static shr_enum_map_t prbs_poly_mode_map[] = {
    {(char *)PC_PRBS_POLY_7s,   BCM_PORT_PRBS_POLYNOMIAL_X7_X6_1},
    {(char *)PC_PRBS_POLY_9s,   BCM_PORT_PRBS_POLYNOMIAL_X9_X5_1},
    {(char *)PC_PRBS_POLY_10s,  BCM_PORT_PRBS_POLYNOMIAL_X10_X7_1},
    {(char *)PC_PRBS_POLY_11s,  BCM_PORT_PRBS_POLYNOMIAL_X11_X9_1},
    {(char *)PC_PRBS_POLY_13s,  BCM_PORT_PRBS_POLYNOMIAL_X13_X12_X2_1},
    {(char *)PC_PRBS_POLY_15s,  BCM_PORT_PRBS_POLYNOMIAL_X15_X14_1},
    {(char *)PC_PRBS_POLY_20s,  BCM_PORT_PRBS_POLYNOMIAL_X20_X3_1},
    {(char *)PC_PRBS_POLY_23s,  BCM_PORT_PRBS_POLYNOMIAL_X23_X18_1},
    {(char *)PC_PRBS_POLY_31s,  BCM_PORT_PRBS_POLYNOMIAL_X31_X28_1},
    {(char *)PC_PRBS_POLY_49s,  BCM_PORT_PRBS_POLYNOMIAL_X49_X40_1},
    {(char *)PC_PRBS_POLY_58s,  BCM_PORT_PRBS_POLYNOMIAL_X58_X31_1},
};
                                    ...
                                    bcmlt_entry_handle_t eh, void *port_diag_stats_field)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
     ...
     SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_get(eh, FEC_CORRECTED_BLOCKSs, &port_diag_stats_data->fec_correct_blks));

     SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_get(eh, FEC_UNCORRECTED_BLOCKSs, &port_diag_stats_data->fec_uncorrect_blks));
                                    ...
                                    bcmlt_entry_handle_t eh, void *pc_phy_ctrl_field)
{
    ...
    if (field->field_bmp & PC_AUTONEG_FEC_OVERRIDE_AUTO) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_add(eh, AUTONEG_FEC_OVERRIDE_AUTOs, phy_ctrl_data->an_fec_override_auto));
    }

    if (field->field_bmp & PC_AUTONEG_FEC_OVERRIDE) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_add(eh, AUTONEG_FEC_OVERRIDEs, phy_ctrl_data->an_fec_override));
    }
                                    ...
                                    bcmlt_entry_handle_t eh, void *tx_taps_field)
{
    ...
    if (SHR_SUCCESS(bcmi_lt_field_validate(unit, PC_TX_TAPSs, TX_PRE3_AUTOs))) {
        if (field->field_bmp & PC_TX_FIR_PRE3_AUTO) {
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_add(eh, TX_PRE3_AUTOs, tx_taps->tx_pre3_auto));
        }
    }

    if (SHR_SUCCESS(bcmi_lt_field_validate(unit, PC_TX_TAPSs, TX_PRE3s))) {
        if (field->field_bmp & PC_TX_FIR_PRE3) {
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_add(eh, TX_PRE3s, tx_taps->tx_pre3));

            SHR_IF_ERR_VERBOSE_EXIT
                (bcmlt_entry_field_add(eh, TX_PRE3_SIGNs, tx_taps->tx_pre3_sign));
        }
    }
                                   ...
                                   void *status_field)
{
    ...
    if (SHR_SUCCESS(bcmi_lt_field_validate(unit, PC_TX_TAPS_STATUSs, TX_PRE3s))) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_get(eh, TX_PRE3s, &status_data->tx_pre3));
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_get(eh, TX_PRE3_SIGNs, &status_data->tx_pre3_sign));
    }
    SHR_IF_ERR_VERBOSE_EXIT
                                   ...
                                   void *status_field)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_get(eh, AUTONEG_FEC_OVERRIDEs, &status_data->an_fec_override));
    ...
    for (i = 0, pf = fields, tbl = NULL; i < fields_cnt; i ++, pf ++) {
        ...
        if (tbl != pf->info->table->name) {
            ...
            if (pf->info->table->key) {
                if (pf->info->table->list) {
                    s = ltsw_port_tab_etos(pf->info->table->list, pf->index);
                    SHR_NULL_CHECK(s, SHR_E_FAIL);
                    SHR_IF_ERR_VERBOSE_EXIT
                        (bcmlt_entry_field_symbol_add
                            (eh, pf->info->table->key, s));
                } else {
                    SHR_IF_ERR_VERBOSE_EXIT
                        (bcmlt_entry_field_add
                            (eh, pf->info->table->key, pf->index));
                }
            }
...
ltsw_port_name_update(int unit)
{
    ...
    i = 0;
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_ltsw_port_bitmap(unit, BCMI_LTSW_PORT_TYPE_CPU, &pbmp));
    BCMI_LTSW_DPORT_PBMP_ITER(unit, pbmp, dport, port) {
    ...
    i = 0;
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_ltsw_port_bitmap(unit, BCMI_LTSW_PORT_TYPE_GE, &pbmp));
    BCMI_LTSW_DPORT_PBMP_ITER(unit, pbmp, dport, port) {
        sal_snprintf(PORT(unit, port).port_name, BCMI_LTSW_PORT_NAME_MAX,
                     "ge%d", i++);
    }
    ...
    i = 0;
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_ltsw_port_bitmap(unit, BCMI_LTSW_PORT_TYPE_XE, &pbmp));
    BCMI_LTSW_DPORT_PBMP_ITER(unit, pbmp, dport, port) {
        sal_snprintf(PORT(unit, port).port_name, BCMI_LTSW_PORT_NAME_MAX,
                     "xe%d", i++);
    }
    ...
    i = 0;
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_ltsw_port_bitmap(unit, BCMI_LTSW_PORT_TYPE_CE, &pbmp));
    BCMI_LTSW_DPORT_PBMP_ITER(unit, pbmp, dport, port) {
        sal_snprintf(PORT(unit, port).port_name, BCMI_LTSW_PORT_NAME_MAX,
                     "ce%d", i++);
    }
    ...
    i = 0;
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_ltsw_port_bitmap(unit, BCMI_LTSW_PORT_TYPE_CDE, &pbmp));
    BCMI_LTSW_DPORT_PBMP_ITER(unit, pbmp, dport, port) {
        sal_snprintf(PORT(unit, port).port_name, BCMI_LTSW_PORT_NAME_MAX,
                     "cd%d", i++);
    }
    ...
    i = 0;
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_ltsw_port_bitmap(unit, BCMI_LTSW_PORT_TYPE_HG, &pbmp));
    BCMI_LTSW_DPORT_PBMP_ITER(unit, pbmp, dport, port) {
        sal_snprintf(PORT(unit, port).port_name, BCMI_LTSW_PORT_NAME_MAX,
                     "hg%d", i++);
    }
...
{
    int port_num_max = 0, phy_port_num_max = 0, alloc_size, i, rv;
    ...
    if (warm) {
        rv = bcmi_ltsw_issu_struct_info_get
                (unit, BCMINT_PORT_HA_INFO_T_ID, BCMI_HA_COMP_ID_PORT,
                 BCMINT_PORT_SUB_COMP_ID_HA, &offset);
        if (rv == SHR_E_NOT_FOUND) {
            SHR_IF_ERR_EXIT
                (bcmi_ltsw_issu_struct_info_report
                    (unit, BCMI_HA_COMP_ID_PORT,
                     BCMINT_PORT_SUB_COMP_ID_HA,
...
/*!
 * \brief Set ieee reduced ipg enable on a port.
 *
 * \param [in] unit Unit number.
 * \param [in] port Port number.
 * \param [in] enable IEEE reduced IPG enable.
 *
 * \return SHR_E_NONE on success and error code otherwise.
 */
static int
ltsw_port_ieee_reduced_ipg_enable_set(int unit, bcm_port_t port, uint32_t enable)
{
    pc_port_data_t port_data;
    pc_mac_control_data_t mac_control_data;
    ...
    port_data.encap = enable ? PC_ENCAP_IEEE_REDUCED_IPGs : PC_ENCAP_IEEEs;
    SHR_IF_ERR_VERBOSE_EXIT
...
/*!
 * \brief Get IEEE reduced ipg  mode enable on a port.
 *
 * \param [in] unit Unit number.
 * \param [in] port Port number.
 * \param [out] enable IEEE reduced ipg enable.
 *
 * \return SHR_E_NONE on success and error code otherwise.
 */
static int
ltsw_port_ieee_reduced_ipg_enable_get(int unit, bcm_port_t port, uint32_t *enable)
{
    pc_port_data_t port_data;
    ...
    *enable = sal_strcmp(port_data.encap, PC_ENCAP_IEEE_REDUCED_IPGs) ? 0 : 1;
...
static int
ltsw_tx_taps_auto_set(int unit, int port, int lane_idx)
{
    pc_tx_taps_data_t tx_fir;

    SHR_FUNC_ENTER(unit);

    tx_fir.tx_amp_auto = 1;
    tx_fir.tx_drv_mode_auto = 1;
    tx_fir.tx_main_auto = 1;
    tx_fir.tx_post_auto = 1;
    tx_fir.tx_post2_atuo = 1;
    tx_fir.tx_post3_auto = 1;
    tx_fir.tx_pre_auto = 1;
    tx_fir.tx_pre2_auto = 1;
    tx_fir.tx_pre3_auto = 1;
    tx_fir.tx_rpara_auto = 1;
    tx_fir.tx_sig_mode_auto = 1;
    tx_fir.tx_tap_mode_auto = 1;

    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_pc_tx_taps_set(unit, port, lane_idx, &tx_fir, PC_TX_FIR_AUTO));
...
ltsw_flexport_pc_del(int unit, ltsw_flexport_resource_t *resource)
{
    ...
    for (i = 0, po = resource->operation; i < num_op; i ++, po ++) {
        ...
        /* Disable Link_training to disable tx_precoder */
        if (op & (FLEXPORT_OP_DEL | FLEXPORT_OP_REMAP | FLEXPORT_OP_LANES |
                  FLEXPORT_OP_PC_RESET)) {
            SHR_IF_ERR_VERBOSE_EXIT
                (ltsw_pc_port_status_get(unit, lport, &port_status_data));
            if (port_status_data.link_training) {
...
ltsw_flexport_pc_add(int unit, ltsw_flexport_resource_t *resource)
{
    ...
    for (i = 0, po = resource->operation; i < num_op; i ++, po ++) {
        ...
        if (op & (FLEXPORT_OP_ADD | FLEXPORT_OP_REMAP | FLEXPORT_OP_LANES |
                  FLEXPORT_OP_PC_RESET)) {
            /* Set tx taps to the default */
            for (idx = 0; idx < lanes; idx++) {
                SHR_IF_ERR_VERBOSE_EXIT
                    (ltsw_tx_taps_auto_set(unit, lport, idx));
            }
...
/*!
 * \brief Callback function to set fields of PC_PHY_PRBS_CONTROL entry.
 *
 * \param [in] unit Unit number.
 * \param [in] lt_name PC_PHY_PRBS_CONTROL table name.
 * \param [in] eh Entry handle.
 * \param [in] pc_phy_prbs_control field.
 *
 * \return SHR_E_NONE on success and error code otherwise.
 */
static int
ltsw_pc_phy_prbs_control_field_entry_set(int unit, const char *lt_name,
                                    bcmlt_entry_handle_t eh, void *pc_phy_prbs_ctrl_field)
{
    pc_phy_prbs_control_field_t *field = (pc_phy_prbs_control_field_t *)pc_phy_prbs_ctrl_field;
    pc_phy_prbs_control_data_t *phy_prbs_ctrl_data = (pc_phy_prbs_control_data_t*)field->phy_prbs_ctrl_data;
    ...
    if (phy_prbs_ctrl_data == NULL) {
        SHR_EXIT();
    }

    if (field->field_bmp & PC_PHY_PRBS_CONTROL_GENERATOR_ENABLE) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_add(eh, PRBS_GENERATOR_ENABLEs, phy_prbs_ctrl_data->generator_enable));
    }

    if (field->field_bmp & PC_PHY_PRBS_CONTROL_CHECKER_ENABLE) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_add(eh, PRBS_CHECKER_ENABLEs, phy_prbs_ctrl_data->checker_enable));
    }

    if (field->field_bmp & PC_PHY_PRBS_CONTROL_POLY_MODE) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_symbol_add(eh, POLY_MODEs, phy_prbs_ctrl_data->poly_mode));
    }

    if (field->field_bmp & PC_PHY_PRBS_CONTROL_INVERT_DATA_TX) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_add(eh, INVERT_DATA_TXs, phy_prbs_ctrl_data->invert_data_tx));
    }

    if (field->field_bmp & PC_PHY_PRBS_CONTROL_INVERT_DATA_RX) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_add(eh, INVERT_DATA_RXs, phy_prbs_ctrl_data->invert_data_rx));
    }
...
static int
ltsw_pc_phy_prbs_control_set(int unit, int port, uint32 lane_idx, pc_phy_prbs_control_data_t *prbs_data, uint64_t set_field_bmp)
{
    pc_phy_prbs_control_field_t field;
    int rv = 0;

    SHR_FUNC_ENTER(unit);
    sal_memset(&field, 0, sizeof(pc_phy_prbs_control_field_t));

    field.lport = port;
    field.lane_idx = lane_idx;
    field.field_bmp = set_field_bmp;
    field.phy_prbs_ctrl_data= prbs_data;

    rv = bcmi_lt_entry_lookup(unit, PC_PHY_PRBS_CONTROLs, &field,
                              ltsw_pc_phy_prbs_control_field_entry_set);

    if (SHR_E_NOT_FOUND == rv) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmi_lt_entry_insert(unit, PC_PHY_PRBS_CONTROLs, &field,
                                  ltsw_pc_phy_prbs_control_field_entry_set));
    } else {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmi_lt_entry_update(unit, PC_PHY_PRBS_CONTROLs, &field,
                                  ltsw_pc_phy_prbs_control_field_entry_set));
    }
...
static int
bcmint_ltsw_port_phy_control_type_prbs_set(int unit, bcm_port_t port, int lane_index, bcm_port_phy_control_t type, uint32_t value)
{
    uint32 num_lane = 0;
    int lane = 0;
    uint64_t field_bmp = 0;
    pc_phy_prbs_control_data_t prbs_data;

    SHR_FUNC_ENTER(unit);
    sal_memset(&prbs_data, 0, sizeof(pc_phy_prbs_control_data_t));
    ...
    switch (type) {
        case BCM_PORT_PHY_CONTROL_PRBS_POLYNOMIAL:
            prbs_data.poly_mode = id2name(prbs_poly_mode_map, COUNTOF(prbs_poly_mode_map),
                                  value);
            SHR_NULL_CHECK(prbs_data.poly_mode, SHR_E_PARAM);
            field_bmp = PC_PHY_PRBS_CONTROL_POLY_MODE;
            break;
        case BCM_PORT_PHY_CONTROL_PRBS_TX_INVERT_DATA:
        case BCM_PORT_PHY_CONTROL_PRBS_DECOUPLED_TX_INVERT_DATA:
            prbs_data.invert_data_tx = value ? 1 : 0;
            field_bmp = PC_PHY_PRBS_CONTROL_INVERT_DATA_TX;
            break;
        case BCM_PORT_PHY_CONTROL_PRBS_TX_ENABLE:
        case BCM_PORT_PHY_CONTROL_PRBS_DECOUPLED_TX_ENABLE:
            prbs_data.generator_enable = value ? 1 : 0;
            field_bmp = PC_PHY_PRBS_CONTROL_GENERATOR_ENABLE;
            break;
        case BCM_PORT_PHY_CONTROL_PRBS_RX_INVERT_DATA:
        case BCM_PORT_PHY_CONTROL_PRBS_DECOUPLED_RX_INVERT_DATA:
            prbs_data.invert_data_rx = value ? 1 : 0;
            field_bmp = PC_PHY_PRBS_CONTROL_INVERT_DATA_RX;
            break;
        case BCM_PORT_PHY_CONTROL_PRBS_RX_ENABLE:
        case BCM_PORT_PHY_CONTROL_PRBS_DECOUPLED_RX_ENABLE:
            prbs_data.checker_enable = value ? 1 : 0;
            field_bmp = PC_PHY_PRBS_CONTROL_CHECKER_ENABLE;
            break;
        default:
            SHR_ERR_EXIT(SHR_E_UNAVAIL);
    }
    ...
    if (lane_index < 0) {
        for (lane = 0; lane < num_lane; lane++) {
             SHR_IF_ERR_VERBOSE_EXIT
                (ltsw_pc_phy_prbs_control_set(unit, port, lane, &prbs_data, field_bmp));
        }
    /* gport */
    } else {
        if (lane_index < num_lane) {
            SHR_IF_ERR_VERBOSE_EXIT
               (ltsw_pc_phy_prbs_control_set(unit, port, lane_index, &prbs_data, field_bmp));
        } else {
            SHR_IF_ERR_VERBOSE_EXIT(SHR_E_PARAM);
        }
    }
...
/*!
 * \brief Callback function to get fields of PC_PHY_PRBS_CONTROL entry.
 *
 * \param [in] unit Unit number.
 * \param [in] lt_name PC_PHY_PRBS_CONTROL table name.
 * \param [in] eh Entry handle.
 * \param [in] status_field PC_PHY_PRBS_CONTROL field.
 *
 * \return SHR_E_NONE on success and error code otherwise.
 */
static int
ltsw_pc_phy_prbs_control_field_entry_get(int unit, const char *lt_name, bcmlt_entry_handle_t eh,
                                                void *status_field)
{
    pc_phy_prbs_control_field_t *field = (pc_phy_prbs_control_field_t *)status_field;
    pc_phy_prbs_control_data_t *status_data = field->phy_prbs_ctrl_data;

    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_get(eh, PRBS_GENERATOR_ENABLEs, &status_data->generator_enable));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_get(eh, PRBS_CHECKER_ENABLEs, &status_data->checker_enable));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_symbol_get(eh, POLY_MODEs, &status_data->poly_mode));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_get(eh, INVERT_DATA_TXs, &status_data->invert_data_tx));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_get(eh, INVERT_DATA_RXs, &status_data->invert_data_rx));
...
static int
ltsw_pc_phy_prbs_control_get(int unit, int port, int lane,
                              pc_phy_prbs_control_data_t *prbs_data)
{
    pc_phy_prbs_control_field_t field;
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_lt_entry_get(unit, PC_PHY_PRBS_CONTROLs, &field,
                           ltsw_pc_phy_prbs_control_field_entry_set,
                           ltsw_pc_phy_prbs_control_field_entry_get));
...
static int
bcmint_ltsw_port_phy_control_type_prbs_get(int unit, bcm_port_t port, int lane_index, bcm_port_phy_control_t type, uint32_t *value)
{
    uint32_t field_value = 0;
    uint32_t num_lane = 0;
    int lane = 0, temp_value = 0;
    pc_phy_prbs_control_data_t prbs_data;
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_pc_phy_prbs_control_get(unit, port, lane, &prbs_data));

    switch (type) {
        case BCM_PORT_PHY_CONTROL_PRBS_POLYNOMIAL:
            temp_value = name2id(prbs_poly_mode_map, COUNTOF(prbs_poly_mode_map), prbs_data.poly_mode);
            if (temp_value >= 0) {
                field_value = (uint32_t)temp_value;
            } else {
                SHR_ERR_EXIT(SHR_E_PARAM);
            }
            break;
        case BCM_PORT_PHY_CONTROL_PRBS_TX_INVERT_DATA:
        case BCM_PORT_PHY_CONTROL_PRBS_DECOUPLED_TX_INVERT_DATA:
            field_value = prbs_data.invert_data_tx;
            break;
        case BCM_PORT_PHY_CONTROL_PRBS_TX_ENABLE:
        case BCM_PORT_PHY_CONTROL_PRBS_DECOUPLED_TX_ENABLE:
            field_value = prbs_data.generator_enable;
            break;
        case BCM_PORT_PHY_CONTROL_PRBS_RX_INVERT_DATA:
        case BCM_PORT_PHY_CONTROL_PRBS_DECOUPLED_RX_INVERT_DATA:
            field_value = prbs_data.invert_data_rx;
            break;
        case BCM_PORT_PHY_CONTROL_PRBS_RX_ENABLE:
        case BCM_PORT_PHY_CONTROL_PRBS_DECOUPLED_RX_ENABLE:
            field_value = prbs_data.checker_enable;
            break;
        default:
            SHR_ERR_EXIT(SHR_E_UNAVAIL);
    }
...
/*!
 * \brief Callback function to set fields of PC_PHY_PRBS_STATUS entry.
 *
 * \param [in] unit Unit number.
 * \param [in] lt_name PC_PHY_PRBS_STATUS table name.
 * \param [in] eh Entry handle.
 * \param [in] status_field PC_PHY_PRBS_STATUS field.
 *
 * \return SHR_E_NONE on success and error code otherwise.
 */
static int
ltsw_pc_phy_prbs_status_field_entry_set(int unit, const char *lt_name, bcmlt_entry_handle_t eh,
                                        void *status_field)
{
    pc_phy_prbs_status_field_t *field = (pc_phy_prbs_status_field_t *)status_field;
...
/*!
 * \brief Callback function to get fields of PC_PHY_PRBS_STATUS entry.
 *
 * \param [in] unit Unit number.
 * \param [in] lt_name PC_PHY_PRBS_STATUS table name.
 * \param [in] eh Entry handle.
 ...
 */
static int
ltsw_pc_phy_prbs_status_field_entry_get(int unit, const char *lt_name, bcmlt_entry_handle_t eh,
                                        void *status_field)
{
    pc_phy_prbs_status_field_t *field = (pc_phy_prbs_status_field_t *)status_field;
    pc_phy_prbs_status_data_t *status_data = field->phy_prbs_status_data;

    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_get(eh, PRBS_LOCK_LIVEs, &status_data->lock_live));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_get(eh, PRBS_LOCK_LOSSs, &status_data->lock_loss));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_get(eh, PRBS_ERROR_COUNTs, &status_data->error_count));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_get(eh, FAST_BERs, &status_data->fast_ber));
...
static int
ltsw_pc_phy_prbs_status_get(int unit, int port, int lane,
                            pc_phy_prbs_status_data_t *prbs_data)
{
    pc_phy_prbs_status_field_t field;

    SHR_FUNC_ENTER(unit);
    sal_memset(&field, 0, sizeof(pc_phy_prbs_status_field_t));

    field.lport = port;
    field.lane_idx = lane;
    field.phy_prbs_status_data = prbs_data;

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_lt_entry_get(unit, PC_PHY_PRBS_STATUSs, &field,
                           ltsw_pc_phy_prbs_status_field_entry_set,
                           ltsw_pc_phy_prbs_status_field_entry_get));
...
static int
bcmint_ltsw_port_phy_control_prbs_rx_status_get(int unit, bcm_port_t port, int lane_index, uint32_t *value)
{
    uint32_t num_lane = 0;
    int lane = 0, prbs_lock_live = 1, prbs_lock_loss = 0;
    uint64_t error_count = 0;
    pc_phy_prbs_status_data_t prbs_status_data;

    SHR_FUNC_ENTER(unit);
    sal_memset(&prbs_status_data, 0, sizeof(pc_phy_prbs_status_data_t));
    ...
    if (lane_index < 0) {
        for (lane = 0; lane < num_lane; lane++) {
             SHR_IF_ERR_VERBOSE_EXIT
                 (ltsw_pc_phy_prbs_status_get(unit, port, lane, &prbs_status_data));
                  prbs_lock_live &= prbs_status_data.lock_live ? 1 : 0;
                  prbs_lock_loss |= prbs_status_data.lock_loss ? 1 : 0;
                  error_count += prbs_status_data.error_count;
        }
    /* gport */
    } else {
        if (lane_index < num_lane) {
            SHR_IF_ERR_VERBOSE_EXIT
                (ltsw_pc_phy_prbs_status_get(unit, port, lane_index, &prbs_status_data));
                  prbs_lock_live = prbs_status_data.lock_live ? 1 : 0;
                  prbs_lock_loss = prbs_status_data.lock_loss ? 1 : 0;
                  error_count += prbs_status_data.error_count;
        } else {
    ...
    if (0 == prbs_lock_live) {
        *value = LTSW_PHY_PRBS_LOCK_LOSS;
    } else if (prbs_lock_loss) {
        *value = LTSW_PHY_PRBS_LOCK_LOST_LATCH;
    } else {
        *value = error_count;
    }
 ...
 */
static int
bcmint_ltsw_port_tab_multi_fields_set(int unit, bcm_port_t port,
 ...
 */
static int
bcmint_ltsw_port_tab_multi_fields_get(int unit, bcm_port_t port,
                                      ltsw_port_tab_field_t *fields,
                                      int fields_cnt)
{
    uint32_t op;
...
/*!
 * \brief Set single PORT/LPORT field without lock.
 *
 * Helper funtion for port init and port control APIs.
 *
 * \param [in] unit Unit number.
 ...
 */
int
bcmint_ltsw_port_tab_set(int unit, bcm_port_t port,
                         bcmi_ltsw_port_tab_t type, int data)
{
    ...
    return bcmint_ltsw_port_tab_multi_fields_set(unit, port, &port_tab_field, 1);
}

/*!
 * \brief Get single PORT/LPORT field without lock.
 *
 ...
 */
int
bcmint_ltsw_port_tab_get(int unit, bcm_port_t port,
                         bcmi_ltsw_port_tab_t type, int *data)
{
    ltsw_port_tab_field_t port_tab_field;
    ...
    rv = bcmint_ltsw_port_tab_multi_fields_get(unit, port, &port_tab_field, 1);
...
/*!
 * \brief Set multiple PORT/LPORT field without lock.
 *
 * \param [in] unit Unit number.
 * \param [in] port Port number.
...
bcmint_ltsw_port_tab_multi_set(int unit, bcm_port_t port,
                               bcmi_ltsw_port_tab_t *type, uint32_t *data,
                               int cnt)
{
    int i, size;
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmint_ltsw_port_tab_multi_fields_set(unit, port, port_tab_fields, cnt));
...
/*!
 * \brief Get multiple PORT/LPORT field without lock.
 *
 * \param [in] unit Unit number.
 * \param [in] port Port number.
 * \param [in] type Enumerators of port tab types.
                               ...
                               int cnt)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmint_ltsw_port_tab_multi_fields_get(unit, port, port_tab_fields, cnt));
...
/*!
 * \brief Set single PORT/LPORT array field without lock.
 *
 * Helper funtion for port init and port control APIs.
 *
 * \param [in] unit Unit number.
 ...
 */
int
bcmint_ltsw_port_tab_array_set(int unit, bcm_port_t port,
                               bcmi_ltsw_port_tab_t type,
                               uint64_t *data, int start_index, int size)
{
    ltsw_port_tab_field_t port_tab_field;

    sal_memset(&port_tab_field, 0x0, sizeof(port_tab_field));
    port_tab_field.type = type;
    port_tab_field.data.a.idx = start_index;
...
/*!
 * \brief Get single PORT/LPORT array field without lock.
 *
 * Helper funtion for port control APIs.
 *
 * \param [in] unit Unit number.
 ...
 */
int
bcmint_ltsw_port_tab_array_get(int unit, bcm_port_t port,
                               bcmi_ltsw_port_tab_t type,
                               uint64_t *data, int start_index, int size)
{
    ltsw_port_tab_field_t port_tab_field;
    ...
    return bcmint_ltsw_port_tab_multi_fields_get(unit, port, &port_tab_field, 1);
}

/*!
 * \brief Set the identified bit of PORT/LPORT field without lock.
 *
 * \param [in] unit Unit number.
 * \param [in] port Port number.
 * \param [in] type Enumerator of port tab type.
 ...
 */
int
bcmint_ltsw_port_tab_bit_set(int unit, bcm_port_t port,
                             bcmi_ltsw_port_tab_t type, int bit, int data)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmint_ltsw_port_tab_multi_fields_get(unit, port, &port_tab_field, 1));

    port_tab_field.data.n = (port_tab_field.data.n & ~(1 << bit))
                          | ((data & 1) << bit);

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmint_ltsw_port_tab_multi_fields_set(unit, port, &port_tab_field, 1));
...
/*!
 * \brief Get the identified bit of PORT/LPORT field without lock.
 *
 * \param [in] unit Unit number.
 * \param [in] port Port number.
 * \param [in] type Enumerator of port tab type.
 ...
 */
int
bcmint_ltsw_port_tab_bit_get(int unit, bcm_port_t port,
                             bcmi_ltsw_port_tab_t type, int bit, int *data)
{
    ltsw_port_tab_field_t port_tab_field;
    int rv = SHR_E_UNAVAIL;
 ...
 */
int
bcmint_ltsw_port_tab_raw_set(int unit, int index,
                             bcmi_ltsw_port_tab_t type, int data)
{
    ltsw_port_tab_field_t port_tab_field;
    ...
    return bcmint_ltsw_port_tab_multi_fields_set(unit, index, &port_tab_field, 1);
}
 ...
 */
int
bcmint_ltsw_port_tab_raw_get(int unit, int index,
                             bcmi_ltsw_port_tab_t type, int *data)
{
    ltsw_port_tab_field_t port_tab_field;
    int rv = SHR_E_UNAVAIL;
    ...
    rv = bcmint_ltsw_port_tab_multi_fields_get(unit, index, &port_tab_field, 1);
 ...
 * \param [in] unit Unit number.
 * \param [in] index Table index
 * \param [in] index_array Table index array
 * \param [in] type Enumerators of port tab types.
 * \param [in] data Values to be set.
 * \param [in] cnt Number of port tab types.
 *
 ...
 */
int
bcmint_ltsw_port_tab_raw_multi_set(int unit, int index,  int *index_array,
                                   bcmi_ltsw_port_tab_t *type, int *data,
                                   int cnt)
{
    int i, size;
    ...
    for (i = 0; i < cnt; i ++) {
        ...
        if (index_array == NULL) {
            ...
            port_tab_fields[i].index = index_array[i];
        }
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmint_ltsw_port_tab_multi_fields_set(unit, index, port_tab_fields, cnt));
 ...
 */
int
bcmint_ltsw_port_tab_raw_multi_get(int unit, int index, int *index_array,
                                   bcmi_ltsw_port_tab_t *type, int *data,
                                   int cnt)
{
    int i, size;
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmint_ltsw_port_tab_multi_fields_get(unit, index, port_tab_fields, cnt));
 ...
 */
int
bcmint_ltsw_port_tab_raw_array_set(int unit, int index,
                                   bcmi_ltsw_port_tab_t type,
 ...
 */
int
bcmint_ltsw_port_tab_raw_array_get(int unit, int index,
                                   bcmi_ltsw_port_tab_t type,
                                   uint64_t *data, int size)
{
    ltsw_port_tab_field_t port_tab_field;
...
bcmint_ltsw_port_phy_tx_get(int unit, bcm_port_t port, int lane_idx, bcm_port_phy_tx_t *tx)
{
    ...
    sal_memset(&tx_taps_status, 0, sizeof(pc_tx_taps_data_t));
    ...
    if (tx_taps_status.tx_pre3_sign) {
        tx->pre3 = 0 - tx_taps_status.tx_pre3;
    } else {
        tx->pre3 = tx_taps_status.tx_pre3;
    }
...
bcmint_ltsw_port_phy_tx_set(int unit, bcm_port_t port, int lane_idx, bcm_port_phy_tx_t *tx)
{
    ...
    tx_fir.tx_pre3 = LTSW_PORT_ABS(tx->pre3);
    tx_fir.tx_pre3_sign = 0;
    if (tx->pre3 < 0) {
        tx_fir.tx_pre3_sign = 1;
    }
    tx_fir.tx_pre3_auto = 0;
    field_pbm = PC_TX_FIR_PRE3|PC_TX_FIR_PRE3_AUTO;
                                          ...
                                          ltsw_flexport_resource_t *resource)
{
    ...
    for (i = 0, po = resource->operation; i < num_op; i ++, po ++) {
        ...
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmint_ltsw_port_enable_get(unit, po->lport, &en));
        if (en) {
            LOG_ERROR(BSL_LS_BCM_PORT,
...
int
bcmint_ltsw_port_reduced_ipg_set(int unit, bcm_port_t port, uint32_t enable)
{
    int encap_mode, en;
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_port_encap_get(unit, port, &encap_mode));

    if (encap_mode == BCM_PORT_ENCAP_IEEE) {
        SHR_IF_ERR_VERBOSE_EXIT
        ...
        SHR_IF_ERR_VERBOSE_EXIT
            (ltsw_port_ieee_reduced_ipg_enable_set(unit, port, enable));
        ...
        LOG_ERROR(BSL_LS_BCM_PORT, (BSL_META_U(unit, "Port: %d is NOT in IEEE encap!\n"), port));
...
int
bcmint_ltsw_port_reduced_ipg_get(int unit, bcm_port_t port, uint32_t *enable)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_port_ieee_reduced_ipg_enable_get(unit, port, enable));
                           ...
                           bcm_gport_t port, bcm_port_resource_t *resource)
{
    ...
    pc_tx_taps_data_t tx_taps_status;
    bcm_port_phy_signalling_mode_t sig_mode;
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_pc_tx_taps_status_get(unit, port, 0, &tx_taps_status));
    sig_mode = name2id(phy_sig_mode_map, COUNTOF(phy_sig_mode_map), tx_taps_status.tx_sig_mode);
    if (sig_mode == -1) {
        SHR_ERR_EXIT(SHR_E_PARAM);
    }

    if (sig_mode == bcmPortPhySignallingModeNRZ) {
        BCM_PORT_RESOURCE_PHY_LANE_CONFIG_FORCE_PAM4_CLEAR(resource->phy_lane_config);
        BCM_PORT_RESOURCE_PHY_LANE_CONFIG_FORCE_NRZ_SET(resource->phy_lane_config);
    } else {
        BCM_PORT_RESOURCE_PHY_LANE_CONFIG_FORCE_PAM4_SET(resource->phy_lane_config);
        BCM_PORT_RESOURCE_PHY_LANE_CONFIG_FORCE_NRZ_CLEAR(resource->phy_lane_config);
    }
...
{
    pc_port_data_t port_data;
    pc_port_status_data_t port_status;
    int link, lpbk_mode;
    ...
    if (enable) {
        SHR_IF_ERR_VERBOSE_EXIT
            (ltsw_pc_port_status_get(unit, port, &port_status));

        if (port_status.mac_disabled || port_status.phy_disabled) {
            LOG_ERROR(BSL_LS_BCM_PORT,
                      (BSL_META_U(unit, "port %d is not enable \n"),
                       port));
            SHR_ERR_EXIT(SHR_E_CONFIG);
        }

        if (port_status.fec_mode) {
            fec = name2id(fec_mode_map, COUNTOF(fec_mode_map), port_status.fec_mode);
        }
        if (fec == bcmPortPhyFecRs272 || fec == bcmPortPhyFecRs272_2xN) {
            LOG_ERROR(BSL_LS_BCM_PORT,
                (BSL_META_U(unit, "port %d can NOT be set RLM, because RLM is not supported with the RS272 FEC\n"), port));
                 SHR_ERR_EXIT(SHR_E_CONFIG);
        }

        if (port_status.autoneg) {
            LOG_ERROR(BSL_LS_BCM_PORT,
                      (BSL_META_U(unit, "port %d autoneg is on \n"), port));
            SHR_ERR_EXIT(SHR_E_CONFIG);
        }

        if (port_status.loopback) {
            lpbk_mode = name2id(lpbk_mode_map, COUNTOF(lpbk_mode_map), port_status.loopback);
            if (lpbk_mode != BCM_PORT_LOOPBACK_NONE) {
                LOG_WARN(BSL_LS_BCM_PORT,
                         (BSL_META_U(unit,"Warning::loopback is enabled on port %d \n"),
                         port));
            }
        }

        if (port_status.link_training) {
            LOG_ERROR(BSL_LS_BCM_PORT,
                      (BSL_META_U(unit, "link training is enabled on port %d \n"), port));
            SHR_ERR_EXIT(SHR_E_CONFIG);
        }
        ...
        if (!link) {
            LOG_ERROR(BSL_LS_BCM_PORT,
                      (BSL_META_U(unit, "port %d is not up \n"),
                       port));
            SHR_ERR_EXIT(SHR_E_CONFIG);
        }
...
/*!
 * \brief Set single PORT/LPORT field with lock.
 *
 * Helper funtion for port init and port control APIs.
 *
 * \param [in] unit Unit number.
                       ...
                       bcmi_ltsw_port_tab_t type, int data)
{
    ...
    PORT_LOCK(unit);
    rv = bcmint_ltsw_port_tab_set(unit, port, type, data);
    PORT_UNLOCK(unit);
...
/*!
 * \brief Get single PORT/LPORT field with lock.
 *
 * Helper funtion for port control APIs.
 *
 * \param [in] unit Unit number.
                       ...
                       bcmi_ltsw_port_tab_t type, int *data)
{
    ...
    PORT_LOCK(unit);
    rv = bcmint_ltsw_port_tab_get(unit, port, type, data);
    PORT_UNLOCK(unit);
...
/*!
 * \brief Set multiple PORT/LPORT field with lock.
 *
 * \param [in] unit Unit number.
 * \param [in] port Port number.
 * \param [in] type Enumerators of port tab types.
                             ...
                             int cnt)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmint_ltsw_port_tab_multi_set(unit, port, type, data, cnt));
...
/*!
 * \brief Get multiple PORT/LPORT field with lock.
 *
 * \param [in] unit Unit number.
 * \param [in] port Port number.
 * \param [in] type Enumerators of port tab types.
                             ...
                             int cnt)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmint_ltsw_port_tab_multi_get(unit, port, type, data, cnt));
...
/*!
 * \brief Set single PORT/LPORT array field with lock.
 *
 * Helper funtion for port init and port control APIs.
 *
 * \param [in] unit Unit number.
                             ...
                             uint64_t *data, int size)
{
    ...
    PORT_LOCK(unit);
    rv = bcmint_ltsw_port_tab_array_set(unit, port, type, data, 0, size);
    PORT_UNLOCK(unit);
...
/*!
 * \brief Get single PORT/LPORT array field with lock.
 *
 * Helper funtion for port control APIs.
 *
 * \param [in] unit Unit number.
                             ...
                             uint64_t *data, int size)
{
    ...
    PORT_LOCK(unit);
    rv = bcmint_ltsw_port_tab_array_get(unit, port, type, data, 0, size);
    PORT_UNLOCK(unit);
...
/*!
 * \brief Set the identified bit of PORT/LPORT field with lock.
 *
 * \param [in] unit Unit number.
 * \param [in] port Port number.
 * \param [in] type Enumerator of port tab type.
                           ...
                           bcmi_ltsw_port_tab_t type, int bit, int data)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmint_ltsw_port_tab_bit_set(unit, port, type, bit, data));
...
/*!
 * \brief Get the identified bit of PORT/LPORT field with lock.
 *
 * \param [in] unit Unit number.
 * \param [in] port Port number.
 * \param [in] type Enumerator of port tab type.
                           ...
                           bcmi_ltsw_port_tab_t type, int bit, int *data)
{
    ...
    PORT_LOCK(unit);
    rv = bcmint_ltsw_port_tab_bit_get(unit, port, type, bit, data);
    PORT_UNLOCK(unit);
                           ...
                           bcmi_ltsw_port_tab_t type, int data)
{
    ...
    PORT_LOCK(unit);
    rv = bcmint_ltsw_port_tab_raw_set(unit, index, type, data);
    PORT_UNLOCK(unit);
                           ...
                           bcmi_ltsw_port_tab_t type, int *data)
{
    ...
    PORT_LOCK(unit);
    rv = bcmint_ltsw_port_tab_raw_get(unit, index, type, data);
    PORT_UNLOCK(unit);
                                 ...
                                 int cnt)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmint_ltsw_port_tab_raw_multi_set(unit, index, NULL,
                                            type, data, cnt));
                                 ...
                                 int cnt)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmint_ltsw_port_tab_raw_multi_get(unit, index, NULL,
                                            type, data, cnt));
                                 ...
                                 uint64_t *data, int size)
{
    ...
    PORT_LOCK(unit);
    rv = bcmint_ltsw_port_tab_raw_array_set(unit, index, type, data, size);
    PORT_UNLOCK(unit);
                                 ...
                                 uint64_t *data, int size)
{
    ...
    PORT_LOCK(unit);
    rv = bcmint_ltsw_port_tab_raw_array_get(unit, index, type, data, size);
    PORT_UNLOCK(unit);
...
/*!
 * \brief Choose color mode for a port.
 *
 * \param [in] unit Unit Number.
 * \param [in] port Port Number.
 * \param [in] color_select Color mode for a port.
 *
 * \retval SHR_E_NONE No errors.
 * \retval !SHR_E_NONE Failure.
 */
int
bcmi_ltsw_port_color_mode_set(int unit, bcm_port_t port, int color_select)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_port_color_mode_set(unit, port, color_select));
...
/*!
 * \brief Get color mode for a port.
 *
 * \param [in] unit Unit Number.
 * \param [in] port Port Number.
 * \param [out] color_select Color mode for a port.
 *
 * \retval SHR_E_NONE No errors.
 * \retval !SHR_E_NONE Failure.
 */
int
bcmi_ltsw_port_color_mode_get(int unit, bcm_port_t port, int *color_select)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_port_color_mode_get(unit, port, color_select));
...
bcm_ltsw_port_l2_interface_id_get(int unit, bcm_gport_t port, int *interface_id)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_ltsw_id_port_to_l2_if(unit, port, interface_id));
...
bcm_ltsw_port_l2_interface_gport_get(int unit, int interface_id, bcm_gport_t *port)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_ltsw_id_l2_if_to_port(unit, interface_id, port));
...
bcm_ltsw_port_buffer_pbmp_get(int unit, int buffer_id, bcm_pbmp_t *pbmp)
{
    ...
    if (buffer_id >= info.num_buffers || buffer_id < 0) {
        SHR_IF_ERR_VERBOSE_EXIT(SHR_E_PARAM);
    }
    BCM_PBMP_CLEAR(*pbmp);
...
int
bcmint_ltsw_port_phy_control_rx_get(int unit, bcm_port_t port, int lane_index, bcm_port_phy_control_t type, uint32_t *value)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_pc_phy_status_get(unit, port, lane, &phy_status));
...
int
bcmint_ltsw_port_signal_detect_get(int unit, bcm_port_t port, int lane_index, uint32_t *value)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_pc_phy_status_get(unit, port, lane, &phy_status_data));
...
int
bcmint_ltsw_port_phy_squelch_get(int unit, bcm_port_t port, int lane_index, bcm_port_phy_control_t type, uint32_t *value)
{
    pc_phy_control_data_t phy_status;
    int lane;
    uint32_t num_lane;
...
int
bcmint_ltsw_port_phy_tx_pi_override_get(int unit, bcm_port_t port, int lane_index, uint32_t *value)
{
    pc_phy_control_data_t phy_status;
    int lane;
    uint32_t num_lane;
...
int
bcmint_ltsw_port_tx_pam4_preocder_enable_get(int unit, bcm_port_t port, int lane_index, uint32_t *value)
{
    pc_phy_control_data_t phy_status;
    int lane;
    uint32_t num_lane;
...
int
bcmint_ltsw_port_phy_pmd_debug_lane_event_log_level_get(int unit, bcm_port_t port, int lane_index, uint32_t *value)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_pc_phy_control_get(unit, port, lane, &control_data));
...
int
bcmint_ltsw_port_phy_autoneg_fec_override_get(int unit, bcm_port_t port, uint32_t *value)
{
    pc_phy_control_data_t control_data;
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_pc_phy_status_get(unit, port, 0, &control_data));

    *value = control_data.an_fec_override;
...
int
bcmint_ltsw_port_fec_corrected_block_get(int unit, bcm_port_t port, uint32_t *value)
{
    int rv;
    pc_port_diag_stats_data_t diag_stats_data;
    ...
    rv = ltsw_pc_port_diag_stats_get(unit, port, &diag_stats_data);
    if (SHR_FAILURE(rv) && rv == SHR_E_NOT_FOUND) {
       SHR_ERR_EXIT(SHR_E_UNAVAIL);
    }

    *value = diag_stats_data.fec_correct_blks;
...
int
bcmint_ltsw_port_fec_uncorrected_block_get(int unit, bcm_port_t port, uint32_t *value)
{
    int rv;
    pc_port_diag_stats_data_t diag_stats_data;
    ...
    *value = diag_stats_data.fec_uncorrect_blks;
...
int
bcmint_ltsw_port_fec_symbol_error_get(int unit, bcm_port_t port, uint32_t *value)
{
    pc_port_diag_stats_data_t diag_stats_data;
                             ...
                             bcm_port_phy_control_t type, uint32_t *value)
{
    ...
    switch (type) {
        ...
        case BCM_PORT_PHY_CONTROL_RX_SIGNAL_DETECT:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmint_ltsw_port_signal_detect_get(unit, port, phy_lane, value));
            break;
        ...
        case BCM_PORT_PHY_CONTROL_RX_LANE_SQUELCH:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmint_ltsw_port_phy_squelch_get(unit, port, phy_lane, type, value));
            break;
        ...
        case BCM_PORT_PHY_CONTROL_TX_PPM_ADJUST:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmint_ltsw_port_phy_tx_pi_override_get(unit, port, phy_lane, value));
            break;
        ...
        case BCM_PORT_PHY_CONTROL_TX_PAM4_PRECODER_ENABLE:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmint_ltsw_port_tx_pam4_preocder_enable_get(unit, port, phy_lane, value));
            break;
        ...
        case BCM_PORT_PHY_CONTROL_PMD_DIAG_DEBUG_LANE_EVENT_LOG_LEVEL:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmint_ltsw_port_phy_pmd_debug_lane_event_log_level_get(unit, port, phy_lane, value));
            break;
        ...
        case BCM_PORT_PHY_CONTROL_FEC_SYMBOL_ERROR_COUNT:
            ...
            break;
        case BCM_PORT_PHY_CONTROL_FEC_CORRECTED_BLOCK_COUNT:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmint_ltsw_port_fec_corrected_block_get(unit, port, value));
            break;
        case BCM_PORT_PHY_CONTROL_FEC_UNCORRECTED_BLOCK_COUNT:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmint_ltsw_port_fec_uncorrected_block_get(unit, port, value));
            break;
        case BCM_PORT_PHY_CONTROL_AUTONEG_FEC_OVERRIDE:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmint_ltsw_port_phy_autoneg_fec_override_get(unit, port, value));
            break;
        /* PRBS */
        case BCM_PORT_PHY_CONTROL_PRBS_POLYNOMIAL:
        case BCM_PORT_PHY_CONTROL_PRBS_TX_INVERT_DATA:
        ...
        case BCM_PORT_PHY_CONTROL_PRBS_RX_ENABLE:
        case BCM_PORT_PHY_CONTROL_PRBS_DECOUPLED_RX_ENABLE:
        case BCM_PORT_PHY_CONTROL_PRBS_DECOUPLED_TX_POLYNOMIAL:
        case BCM_PORT_PHY_CONTROL_PRBS_DECOUPLED_RX_POLYNOMIAL:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmint_ltsw_port_phy_control_type_prbs_get(unit, port, phy_lane, type, value));
            break;
        case BCM_PORT_PHY_CONTROL_PRBS_RX_STATUS:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmint_ltsw_port_phy_control_prbs_rx_status_get(unit, port, phy_lane, value));
            break;
        case BCM_PORT_PHY_CONTROL_CODEC_MODE_REDUCED_IPG:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmint_ltsw_port_reduced_ipg_get(unit, port, value));
            break;
        default:
            SHR_ERR_EXIT(SHR_E_UNAVAIL);
            break;
...
int
bcmint_ltsw_port_phy_squelch_set(int unit, bcm_port_t port, int lane_index, bcm_port_phy_control_t type, uint32_t value)
{
    pc_phy_control_data_t control_data;
    uint32 num_lane, phy_ctrl_field_bmp;
    int lane;
    ...
    if (lane_index < 0) {
        ...
        if (lane_index < num_lane) {
            SHR_IF_ERR_VERBOSE_EXIT(
                ltsw_pc_phy_control_set(unit, port, lane_index, &control_data, phy_ctrl_field_bmp));
        } else {
            SHR_IF_ERR_VERBOSE_EXIT(SHR_E_PARAM);
        }
    }
...
int
bcmint_ltsw_port_phy_tx_pi_override_set(int unit, bcm_port_t port, int lane_index, uint32_t value)
{
    pc_phy_control_data_t control_data;
    uint32 num_lane;
    int lane;
...
int
bcmint_ltsw_port_phy_pmd_debug_lane_event_log_level_set(int unit, bcm_port_t port, int lane_index, uint32_t value)
{
    pc_phy_control_data_t control_data;
    uint32 num_lane;
    int lane;
...
int
bcmint_ltsw_port_phy_autoneg_fec_override_set(int unit, bcm_port_t port, uint32_t value)
{
    pc_phy_control_data_t control_data;
    uint32 num_lane;
    int lane;
    ...
    phy_ctrl_field_bmp = PC_AUTONEG_FEC_OVERRIDE | PC_AUTONEG_FEC_OVERRIDE_AUTO;

    if (value) {
        /* FEC is disabled in AutoNeg mode */
        control_data.an_fec_override = 1;
    } else {
        control_data.an_fec_override = 0;
    }

    control_data.an_fec_override_auto = 0;
...
int
bcmint_ltsw_port_tx_pam4_preocder_enable_set(int unit, bcm_port_t port, int lane_index, uint32_t value)
{
    pc_phy_control_data_t control_data;
    ...
    if (lane_index < 0) {
        ...
        if (lane_index < num_lane) {
            SHR_IF_ERR_VERBOSE_EXIT(
                ltsw_pc_phy_control_set(unit, port, lane_index, &control_data, PC_PAM4_TX_PRECODER|PC_PAM4_TX_PRECODER_AUTO));
        } else {
            SHR_IF_ERR_VERBOSE_EXIT(SHR_E_PARAM);
        }
    }
                             ...
                             bcm_port_phy_control_t type, uint32_t value)
{
    ...
    switch (type) {
        ...
        case BCM_PORT_PHY_CONTROL_RX_LANE_SQUELCH:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmint_ltsw_port_phy_squelch_set(unit, port, phy_lane, type, value));
            break;
        case BCM_PORT_PHY_CONTROL_PHASE_INTERP:
        case BCM_PORT_PHY_CONTROL_TX_PPM_ADJUST:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmint_ltsw_port_phy_tx_pi_override_set(unit, port, phy_lane, value));
            break;
        case BCM_PORT_PHY_CONTROL_TX_POLARITY:
            SHR_IF_ERR_VERBOSE_EXIT
        ...
        case BCM_PORT_PHY_CONTROL_TX_PAM4_PRECODER_ENABLE:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmint_ltsw_port_tx_pam4_preocder_enable_set(unit, port, phy_lane, value));
            break;
        case BCM_PORT_PHY_CONTROL_LP_TX_PRECODER_ENABLE:
            SHR_IF_ERR_VERBOSE_EXIT
        ...
        case BCM_PORT_PHY_CONTROL_PMD_DIAG_DEBUG_LANE_EVENT_LOG_LEVEL:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmint_ltsw_port_phy_pmd_debug_lane_event_log_level_set(unit, port, phy_lane, value));
            break;
        case BCM_PORT_PHY_CONTROL_AUTONEG_FEC_OVERRIDE:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmint_ltsw_port_phy_autoneg_fec_override_set(unit, port, value));
            break;
        /* PRBS */
        case BCM_PORT_PHY_CONTROL_PRBS_POLYNOMIAL:
        case BCM_PORT_PHY_CONTROL_PRBS_TX_INVERT_DATA:
        ...
        case BCM_PORT_PHY_CONTROL_PRBS_DECOUPLED_RX_POLYNOMIAL:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmint_ltsw_port_phy_control_type_prbs_set(unit, port, phy_lane, type, value));
            break;
        case BCM_PORT_PHY_CONTROL_CODEC_MODE_REDUCED_IPG:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmint_ltsw_port_reduced_ipg_set(unit, port, value));
            break;
        default:
            SHR_ERR_EXIT(SHR_E_UNAVAIL);
            break;
    ...
    bcm_port_redirect_config_t *redirect_config)
{
    ...
    SHR_NULL_CHECK(redirect_config, SHR_E_PARAM);
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_ltsw_trunk_redirect_config_get(unit, gport, redirect_config));
exit:
    SHR_FUNC_EXIT();
}
    ...
    bcm_port_redirect_config_t *redirect_config)
{
    ...
    if (!(redirect_config->flags & BCM_PORT_REDIRECT_DESTINATION_TRUNK)) {
        SHR_IF_ERR_VERBOSE_EXIT(SHR_E_PARAM);
    }
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_ltsw_trunk_redirect_config_set(unit, gport, redirect_config));
...
/*!
 * \brief Callback function to set fields of PC_PORT_DIAG_CONTROL entry.
 *
 * \param [in] unit Unit number.
 * \param [in] lt_name PC_PORT_DIAG_CONTROL table name.
 * \param [in] eh Entry handle.
 * \param [in] port_field PC_PORT_DIAG_CONTROL field.
 *
 * \return SHR_E_NONE on success and error code otherwise.
 */
static int
ltsw_pc_port_diag_control_field_entry_set(int unit, const char *lt_name, bcmlt_entry_handle_t eh,
                                          void *port_field)
{
    pc_port_diag_control_field_t *field = (pc_port_diag_control_field_t *)port_field;
    pc_port_diag_control_data_t *lport_data = field->port_diag_control_data;
    ...
    if (field->field_bmp & PC_PORT_DIAG_CONTROL_ERROR_CONTROL_MAP) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_add(eh, ERROR_CONTROL_MAPs, lport_data->error_control_map));
    }

    if (field->field_bmp & PC_PORT_DIAG_CONTROL_ERROR_MASK_63_0) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_add(eh, ERROR_MASK_63_0s, lport_data->error_mask_63_0));
    }

    if (field->field_bmp & PC_PORT_DIAG_CONTROL_ERROR_MASK_127_64) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmlt_entry_field_add(eh, ERROR_MASK_127_64s, lport_data->error_mask_127_64));
    }
...
/*!
 * \brief Callback function to get fields of PC_PORT_DIAG_CONTROL entry.
 *
 * \param [in] unit Unit number.
 * \param [in] lt_name PC_PORT_DIAG_CONTROL table name.
 * \param [in] eh Entry handle.
 ...
 */
static int
ltsw_pc_port_diag_control_field_entry_get(int unit, const char *lt_name, bcmlt_entry_handle_t eh,
                                          void *port_field)
{
    pc_port_diag_control_field_t *field = (pc_port_diag_control_field_t *)port_field;
    pc_port_diag_control_data_t *lport_data = field->port_diag_control_data;
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_get(eh, ERROR_CONTROL_MAPs, &lport_data->error_control_map));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_get(eh, ERROR_MASK_63_0s, &lport_data->error_mask_63_0));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlt_entry_field_get(eh, ERROR_MASK_127_64s, &lport_data->error_mask_127_64));
...
static int
ltsw_pc_port_diag_control_set(int unit, int port,
                              pc_port_diag_control_data_t *lport_data,
                              uint32_t set_field_bmp)
{
    pc_port_diag_control_field_t field;
    int rv = 0;
    ...
    field.lport = port;
    field.field_bmp = set_field_bmp;
    field.port_diag_control_data = lport_data;

    rv = bcmi_lt_entry_lookup(unit, PC_PORT_DIAG_CONTROLs, &field,
                              ltsw_pc_port_diag_control_field_entry_set);

    if (SHR_E_NOT_FOUND == rv) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmi_lt_entry_insert(unit, PC_PORT_DIAG_CONTROLs, &field,
                                  ltsw_pc_port_diag_control_field_entry_set));
    } else {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmi_lt_entry_update(unit, PC_PORT_DIAG_CONTROLs, &field,
                                  ltsw_pc_port_diag_control_field_entry_set));
    }
...
static int
ltsw_pc_port_diag_control_get(int unit, int port, pc_port_diag_control_data_t *lport_data)
{
    pc_port_diag_control_field_t field;
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_lt_entry_get(unit, PC_PORT_DIAG_CONTROLs, &field,
                           ltsw_pc_port_diag_control_field_entry_set,
                           ltsw_pc_port_diag_control_field_entry_get));
...
int
bcmint_ltsw_port_phy_fec_error_inject_set(int unit, bcm_port_t port,
                                          ...
                                          bcm_port_phy_fec_error_mask_t bit_error_mask)
{
    ...
    port_diag_control_data.error_control_map = error_control_map;

    temp_data = bit_error_mask.error_mask_bit_63_32 & 0xffffffff;
    port_diag_control_data.error_mask_63_0 = temp_data << 32 | bit_error_mask.error_mask_bit_31_0;
    port_diag_control_data.error_mask_127_64 = bit_error_mask.error_mask_bit_79_64;

    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_pc_port_diag_control_set(unit, port, &port_diag_control_data,
                                       PC_PORT_DIAG_CONTROL_ERROR_MASK_63_0 |
                                       PC_PORT_DIAG_CONTROL_ERROR_MASK_127_64 |
                                       PC_PORT_DIAG_CONTROL_ERROR_CONTROL_MAP));
...
int
bcmint_ltsw_port_phy_fec_error_inject_get(int unit, bcm_port_t port,
                                          ...
                                          bcm_port_phy_fec_error_mask_t *bit_error_mask)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (ltsw_pc_port_diag_control_get(unit, port, &port_diag_control_data));

    *error_control_map = port_diag_control_data.error_control_map;
    bit_error_mask->error_mask_bit_31_0 = port_diag_control_data.error_mask_63_0 & 0xffffffff;
    bit_error_mask->error_mask_bit_63_32 = (port_diag_control_data.error_mask_63_0 >> 32) & 0xffffffff;
    bit_error_mask->error_mask_bit_79_64 = port_diag_control_data.error_mask_127_64  & 0xffffffff;
...
/*!
 * \brief Set one-time fec error injection.
 *
 * \param [in] unit Unit number.
 * \param [in] port Port number.
 * \param [in] error_control_map lane_map or 80-bit_block_map to enable error gen mask.
 * \param [in] bit_error_mask  error mask used to generate bit errors.
 *
 * \return SHR_E_NONE on success and error code otherwise.
 */
int
bcm_ltsw_port_phy_fec_error_inject_set(int unit, bcm_port_t port,
                                       uint16_t error_control_map,
                                       bcm_port_phy_fec_error_mask_t bit_error_mask)
{
    SHR_FUNC_ENTER(unit);
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmint_ltsw_port_phy_fec_error_inject_set(unit, port, error_control_map, bit_error_mask));
...
/*!
 * \brief Get one-time fec error injection configuration.
 *
 * \param [in] unit Unit number.
 * \param [in] port Port number.
 * \param [in] error_control_map lane_map or 80-bit_block_map to enable error gen mask.
 ...
 */
int
bcm_ltsw_port_phy_fec_error_inject_get(int unit, bcm_port_t port,
                                       uint16 *error_control_map,
                                       bcm_port_phy_fec_error_mask_t *bit_error_mask)
{
    SHR_FUNC_ENTER(unit);
    ...
    SHR_NULL_CHECK(error_control_map, SHR_E_PARAM);
    SHR_NULL_CHECK(bit_error_mask, SHR_E_PARAM);
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmint_ltsw_port_phy_fec_error_inject_get(unit, port, error_control_map, bit_error_mask));
