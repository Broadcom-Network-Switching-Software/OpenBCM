...
/*!
 * \brief Exit pfc deadlock recovery.
 *
 * \param [in] unit           Unit Number.
    ...
    bcm_cos_t cosq)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_pfc_deadlock_recovery_exit(unit, port, cosq));
...
/*!
 * \brief Start pfc deadlock recovery.
 *
 * \param [in] unit           Unit Number.
 * \param [in] port           port number.
 * \param [in] pfc_priority   pfc priority.
    ...
    bcm_cos_t cosq)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_pfc_deadlock_recovery_start(unit, port, cosq));
...
/*!
 * \brief To get PFC deadlock software recovery mode.
 *
 * \param [in] unit           Unit Number.
 * \param [in] port           Port ID.
 * \param [out] recovery_mode  recovery mode.
 *
 * \retval SHR_E_NONE No errors.
 * \retval !SHR_E_NONE Failure.
 */
    ...
    bcm_cosq_pfc_dd_recovery_mode_t *recovery_mode)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_pfc_dd_recovery_mode_get(unit, port, recovery_mode));
...
/*!
 * \brief To set PFC deadlock software recovery mode.
 *
 * \param [in] unit           Unit Number.
 * \param [in] port           Port ID.
 * \param [in] recovery_mode  recovery mode.
 *
 * \retval SHR_E_NONE No errors.
 * \retval !SHR_E_NONE Failure.
 */
    ...
    bcm_cosq_pfc_dd_recovery_mode_t recovery_mode)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_pfc_dd_recovery_mode_set(unit, port, recovery_mode));
