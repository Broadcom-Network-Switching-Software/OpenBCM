...
/*!
 * \brief Get the flex counter object value associated to MPLS tunnel
 *        initiator on a given L3 interface.
 *
 * \param [in] unit Unit Number.
 ...
 */
static int
mpls_tunnel_initiator_flexctr_object_get(
    int unit,
    bcm_if_t intf,
    uint32_t *value)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_mpls_tnl_initiator_flexctr_object_get(unit, intf, value));
 ...
 */
int
bcm_ltsw_mpls_tunnel_initiator_flexctr_object_get(
    int unit,
    bcm_if_t intf,
    uint32_t *value)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mpls_tunnel_initiator_flexctr_object_get(unit, intf, value));
