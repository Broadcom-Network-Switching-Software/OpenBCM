    ...
    int val)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_flexctr_drv[unit].flexctr_flow_count_set(unit, val));
    ...
    int *val)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_flexctr_drv[unit].flexctr_flow_count_get(unit, val));
    ...
    uint32_t *count)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_flexctr_drv[unit].flexctr_quant_object_enum_map_get(unit, map, count));
