    ...
    int egr_map)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_virtual_drv[unit].virtual_qos_port_map_set(unit, port,
                                                              ing_map,
                                                              egr_map));
    ...
    int *map_id)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_virtual_drv[unit].virtual_qos_port_map_type_get(unit, port,
                                                                   flags,
                                                                   map_id));
    ...
    int *sync_required)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_virtual_drv[unit].
            virtual_port_egress_adapt_key_sync_status_get(unit, sync_required));
