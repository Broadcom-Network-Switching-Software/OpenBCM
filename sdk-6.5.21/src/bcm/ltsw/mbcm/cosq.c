...
mbcm_ltsw_cosq_gport_port_resolve(
    ...
    int *id)
{
    return mbcm_ltsw_cosq_drv[unit].cosq_gport_port_resolve(unit, gport, port, id);
}
...
mbcm_ltsw_cosq_gport_get(
    ...
    uint32_t *flags)
{
    return mbcm_ltsw_cosq_drv[unit].cosq_gport_get(unit, gport, port, numq, flags);
}
...
mbcm_ltsw_cosq_num_queue_get(
    ...
    int *num_mcq)
{
    return mbcm_ltsw_cosq_drv[unit].cosq_num_queue_get(unit, num_ucq, num_mcq);
}
...
{
    return mbcm_ltsw_cosq_drv[unit].cosq_port_map_info_get(unit, port, info);
}
...
{
    return mbcm_ltsw_cosq_drv[unit].cosq_device_info_get(unit, info);
}
