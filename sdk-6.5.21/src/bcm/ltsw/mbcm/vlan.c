                             ...
                             bcmi_ltsw_vlan_egr_xlate_cfg_t *cfg)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_vlan_drv[unit].vlan_egr_xlate_add(unit, port,
                                                     outer_vlan,
                                                     inner_vlan,
                                                     cfg));
                             ...
                             bcmi_ltsw_vlan_egr_xlate_cfg_t *cfg)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_vlan_drv[unit].vlan_egr_xlate_get(unit, port,
                                                     outer_vlan,
                                                     inner_vlan,
                                                     cfg));
                                ...
                                bcmi_ltsw_vlan_egr_xlate_cfg_t *cfg)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_vlan_drv[unit].vlan_egr_xlate_delete(unit, port,
                                                        outer_vlan,
                                                        inner_vlan,
                                                        cfg));
    ...
    void *user_data)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_vlan_drv[unit].vlan_egr_xlate_traverse(unit, cb,
                                                          user_data));
                        ...
                        bcmi_ltsw_vlan_traverse_cb cb, void *user_data)
{
    SHR_FUNC_ENTER(unit);
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_vlan_drv[unit].vlan_traverse(unit, ingress, cb, user_data));
