...
mbcm_ltsw_switch_ep_recirc_profile_init(int unit)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (sc_drv[unit].switch_ep_recirc_profile_init(unit));
    ...
    bcm_pkt_drop_event_t *min_drop_event)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (sc_drv[unit].switch_ep_recirc_drop_event_min_get(unit,
                                                          drop_event_array,
                                                          array_size,
                                                          min_drop_event));
    ...
    int *mirror_inst_id_array)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (sc_drv[unit].switch_ep_recirc_profile_mirror_instance_get_all(
             unit,
...
int
mbcm_ltsw_switch_ep_recirc_profile_num_get(
    int unit,
    int *num)
{
    SHR_FUNC_ENTER(unit);
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (sc_drv[unit].switch_ep_recirc_profile_num_get(unit, num));
    ...
    int *drop_code)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (sc_drv[unit].switch_ep_recirc_drop_event_to_drop_code(unit,
                                                               drop_event,
                                                               drop_code));
