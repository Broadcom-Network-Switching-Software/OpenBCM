        ...
        uint8 *out_pbmp_idx_mask)
{
      ...
      SHR_IF_ERR_EXIT
          (mbcm_ltsw_field_drv[unit].field_pbmp_mask_get(unit,
                                                         pipe,
                                                         stage_info,
                                                         in_pbmp_mask,
                                                         out_pbmp_idx_mask));
    ...
    int *code)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_field_drv[unit].field_destination_drop_reason_to_code(unit,
                                                                         reason,
                                                                         code));
exit:
    SHR_FUNC_EXIT();
    ...
    bcm_field_drop_reason_t *reason)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_field_drv[unit].field_destination_drop_code_to_reason(unit,
                                                                         code,
                                                                         reason));
exit:
    SHR_FUNC_EXIT();
    ...
    bcmint_field_destination_lt_db_t *lt_db)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_field_drv[unit].field_destination_lt_db_get(unit, lt_db));
    ...
    int pipe)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_field_drv[unit].field_flexctr_action_update(
    ...
    bcm_trunk_t mask)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_field_drv[unit].field_qualify_SrcTrunk_set(unit,
                                                           entry,
                                                           qual,
                                                           data,
                                                           mask));
    ...
    bcm_trunk_t *mask)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_field_drv[unit].field_qualify_SrcTrunk_get(unit,
                                                           entry,
                                                           qual,
                                                           is_trunk,
                                                           data,
    ...
    int *free_index)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_field_drv[unit].field_vslice_group_alloc(
                      unit, stage_info, pipe, grp_prio,
                      action_res_id, free_index));
    ...
    int grp_priority)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_field_drv[unit].field_vslice_group_dealloc(
                      unit, stage_info, pipe, grp_priority));
    ...
    bool warm)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_field_drv[unit].field_stage_reinit(
                      unit, stage_info, warm));
    ...
    bcmint_field_stage_info_t *stage_info)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_field_drv[unit].field_stage_cleanup(
                      unit, stage_info));
