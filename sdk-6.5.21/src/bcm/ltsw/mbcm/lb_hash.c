...
int
mbcm_ltsw_lb_hash_tunnel_fields_select_set(
    int unit,
    ...
    int value)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_lb_hash_drv[unit].lb_hash_tunnel_fields_select_set(unit, type, value));
...
int
mbcm_ltsw_lb_hash_tunnel_fields_select_get(
    int unit,
    bcmi_ltsw_lb_hash_tunnel_fields_select_t type,
    int *value)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_lb_hash_drv[unit].lb_hash_tunnel_fields_select_get(unit, type, value));
