    ...
    bcmint_trunk_info_t *dst_info)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_trunk_drv[unit].trunk_redirect_config_set(unit, src_tid, src_info, dst_tid, dst_info));
    ...
    bcmint_trunk_id_t *dst_tid)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_trunk_drv[unit].trunk_redirect_config_get(unit, src_tid, src_info, dst_tid));
