    ...
    int *profile_id)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_time_drv[unit].time_timesync_config_profile_create(unit, profile, profile_id));
    ...
    int profile_id)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_time_drv[unit].time_timesync_config_profile_destroy(unit, profile_id));
    ...
    bcm_time_timesync_config_profile_t *profile)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_time_drv[unit].time_timesync_config_profile_get(unit, profile_id, profile));
