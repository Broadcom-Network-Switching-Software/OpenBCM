...
int
bcmint_field_presel_group_config_get(int unit,
        bcm_field_presel_group_config_t *group_config)
{
    int presel_gid = 0;
    bcm_field_presel_group_t presel_grp = 0;
    ...
    presel_grp = group_config->presel_group;
...
bcmint_field_presel_group_destroy(int unit,
                                  bcm_field_presel_group_t presel_grp)
{
    int group_id = 0;
    int presel_gid = 0;
    ...
    bcmi_field_ha_presel_oper_t **presel_oper)
{
    ...
    /* Mask the stage bits from given group ID */
    presel_entry_id = (presel_config->presel_id & BCM_FIELD_ID_MASK);
    ...
    FP_HA_GROUP_OPER_QSET_ARR_SET(unit, oper, presel_config->group_conflict_qset);
                                    ...
                                    bcm_field_presel_t presel_id)
{
    ...
    presel_config.presel_id = act_presel_id;
    SHR_IF_ERR_VERBOSE_EXIT
        ...
        bcm_field_src_class_t *mask)
{
    ...
    bcm_field_src_class_mode_t mode;
    bcm_qual_field_t qual_info;
    uint32_t hw_data = 0, hw_mask = 0;
    uint32_t *hw_data_p = &hw_data;
    uint32_t *hw_mask_p = &hw_mask;
    ...
    qual_info.qual_data = (void *) &hw_data_p;
    qual_info.qual_mask = (void *) &hw_mask_p;
    ...
    bcm_field_entry_t entry, int prio)
{
    ...
    if (stage_info->tbls_info->presel_entry_prio_fid == NULL) {
        SHR_IF_ERR_VERBOSE_EXIT(SHR_E_UNAVAIL);
    }
