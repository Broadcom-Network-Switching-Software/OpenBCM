...
#define MIRROR_DEST_ID_INVALID  -1      /* Invalid destination id. */
...
/* Check whether the device supports ingress sample profile. */
#define MIRROR_SAMPLE_ING_PRF_SUPPORT_CHECK(unit) \
        do { \
            if (MIRROR_CTRL(unit)->sample_prf_info.ing_sample_prf_unsupported) { \
                SHR_ERR_EXIT(SHR_E_UNAVAIL); \
            } \
        } while (0)
...
#define MIRROR_SOURCE_IS_EGR_TYPE(type) \
    ((type == BCMINT_MIRROR_ST_F_PORT_EGR || \
      type == BCMINT_MIRROR_ST_F_FP_EGR || \
      type == BCMINT_MIRROR_ST_F_EM_FP_EGR || \
      type == BCMINT_MIRROR_ST_F_EM_FT_EGR || \
      type == BCMINT_MIRROR_ST_F_EM_FP_EGR_HW || \
      type == BCMINT_MIRROR_ST_F_EM_FT_EGR_HW) ? true : false)
...
/* Ingress trace event list. */
STATIC const bcm_pkt_trace_event_t
mirror_ingress_trace_events[] =
{
    ...
    bcmPktTraceEventIngressIpmcL3IifOrRpaIdCheckFailed,
    bcmPktTraceEventIngressLearnCacheFull,
    bcmPktTraceEventIngressVfp,
    bcmPktTraceEventIngressIfp,
    bcmPktTraceEventIngressIfpMeter,
    bcmPktTraceEventIngressDstFp,
    bcmPktTraceEventIngressL2SrcDiscard,
    bcmPktTraceEventIngressMacsaMulticast,
    bcmPktTraceEventIngressMembershipCheckFailed,
    bcmPktTraceEventIngressSpanningTreeCheckFailed,
    bcmPktTraceEventIngressSvp,
    bcmPktTraceEventIngressEmFt,
    bcmPktTraceEventIngressIvxlt,
    bcmPktTraceEventIngressTraceDoNotMirror,
    bcmPktTraceEventIngressTraceDoNotCopyToCpu,
    bcmPktTraceEventIngressTraceDop,
    bcmPktTraceEventIngressUrpfCheckFailed,
    bcmPktTraceEventIngressL3IifEqL3Oif,
    bcmPktTraceEventIngressDlbEcmpMonitorEnOrMemberReassined,
    bcmPktTraceEventIngressDlbLagMonitorEnOrMemberReassined,
    bcmPktTraceEventIngressMatchedRuleBit0,
    bcmPktTraceEventIngressMatchedRuleBit1,
    bcmPktTraceEventIngressMatchedRuleBit2,
    bcmPktTraceEventIngressMatchedRuleBit3,
    bcmPktTraceEventIngressMatchedRuleBit4,
    bcmPktTraceEventIngressMatchedRuleBit5,
    bcmPktTraceEventIngressMatchedRuleBit6,
    bcmPktTraceEventIngressMatchedRuleBit7,
    bcmPktTraceEventIngressMirrorSamplerSampled,
    bcmPktTraceEventIngressMirrorSamplerEgrSampled,
    bcmPktTraceEventIngressSerDrop,
    bcmPktTraceEventIngressMplsCtrlPktToCpu,
    bcmPktTraceEventIngressDlbEcmpPktSampled,
    bcmPktTraceEventIngressDlbLagPktSampled,
};

/* Ingress drop event list. */
STATIC const bcm_pkt_drop_event_t
mirror_ingress_drop_events[] =
{
    bcmPktDropEventIngressAllDrops,
    bcmPktDropEventIngressCmlFlagsDrop,
    bcmPktDropEventIngressL2SrcStaticMove,
    bcmPktDropEventIngressL2SrcDiscard,
    bcmPktDropEventIngressMacsaMulticast,
    bcmPktDropEventIngressOuterTpidCheckFailed,
    bcmPktDropEventIngressIncomingPvlanCheckFailed,
    bcmPktDropEventIngressPktIntegrityCheckFailed,
    bcmPktDropEventIngressProtocolPktDrop,
    bcmPktDropEventIngressMembershipCheckFailed,
    bcmPktDropEventIngressSpanningTreeCheckFailed,
    bcmPktDropEventIngressL2DstLookupMiss,
    bcmPktDropEventIngressL2DstDiscard,
    bcmPktDropEventIngressL3DstLookupMiss,
    bcmPktDropEventIngressL3DstDiscard,
    bcmPktDropEventIngressL3HdrError,
    bcmPktDropEventIngressL3TtlError,
    bcmPktDropEventIngressIpmcL3IifOrRpaIdCheckFailed,
    bcmPktDropEventIngressTunnelTtlCheckFailed,
    bcmPktDropEventIngressTunnelShimHdrError,
    bcmPktDropEventIngressTunnelObjectValidationFailed,
    bcmPktDropEventIngressTunnelAdaptDrop,
    bcmPktDropEventIngressPvlanDrop,
    bcmPktDropEventIngressVfp,
    bcmPktDropEventIngressIfp,
    bcmPktDropEventIngressIfpMeter,
    bcmPktDropEventIngressDstFp,
    bcmPktDropEventIngressMplsProtectionDrop,
    bcmPktDropEventIngressMplsLabelActionInvalid,
    bcmPktDropEventIngressMplsTermPolicySelectTableDrop,
    bcmPktDropEventIngressMplsReservedLabelExposed,
    bcmPktDropEventIngressMplsTtlError,
    bcmPktDropEventIngressEmFt,
    bcmPktDropEventIngressIvxlt,
    bcmPktDropEventIngressUrpfCheckFailed,
    bcmPktDropEventIngressSrcPortKnockoutDrop,
    bcmPktDropEventIngressLagFailoverPortDown,
    bcmPktDropEventIngressSplitHorizonCheckFailed,
    bcmPktDropEventIngressDstLinkDown,
    bcmPktDropEventIngressBlockMaskDrop,
    bcmPktDropEventIngressL3MtuCheckFailed,
    bcmPktDropEventIngressSeqNumCheckFailed,
    bcmPktDropEventIngressL3IifEqL3Oif,
    bcmPktDropEventIngressStormControlDrop,
    bcmPktDropEventIngressEgrMembershipCheckFailed,
    bcmPktDropEventIngressEgrSpanningTreeCheckFailed,
    bcmPktDropEventIngressDstPbmZero,
    bcmPktDropEventIngressMplsEcnError,
    bcmPktDropEventIngressMplsCtrlPktDrop,
    bcmPktDropEventIngressEpRecircDrop,
};
...
mirror_dest_gport_validate(int unit, bcm_gport_t gport)
{
    ...
    /* Currently, all ltsw devices don't support mirror on trunk. */
                             ...
                             int *dest_id)
{
    ...
    if (cosq_mod) {
        ...
        /* Get the instance id applied on the EP Recirculate profile entry. */
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmi_ltsw_switch_ep_recirc_profile_mirror_instance_get
                (unit, source->ep_recirc_profile_id, &inst_id));

        /* Map instance id to dest_id. */
        if (inst_id == 0) {
            dest_id[0] = MIRROR_DEST_ID_INVALID;
        } else {
            dest_id[0] = MIRROR_SESSION(unit, inst_id)->mirror_dest_id;
        }
    } else {
        SHR_IF_ERR_VERBOSE_EXIT
...
/*!
 * \brief Mirror is egress mirroring type or not.
 *
 * \param [in] unit Unit number.
 * \param [in] type Mirror source type.
 * \param [in] dest_id Mirror destination id.
 * \param [out] egr Egress mirroring or not.
 *
 * \retval SHR_E_NONE on success and error code otherwise.
 */
static int
mirror_egr_get(int unit, uint32_t type, int dest_id, bool *egr)
{
    ...
    if (mirror_dest->flags2 & BCM_MIRROR_DEST_FLAGS2_INT_PROBE) {
        ...
        *egr = MIRROR_SOURCE_IS_EGR_TYPE(type);
    }
                            ...
                            int *dest, int dest_id, int *status)
{
    ...
    bcmint_mirror_source_t source_tmp;
    int rv, count = 0, session_id = 0, ifp_share_ena = 0;
    SHR_FUNC_ENTER(unit);

    source_tmp = *source;
    SHR_IF_ERR_VERBOSE_EXIT
        (mirror_egr_get(unit, source->type, dest_id, &egr));

    if (MIRROR_SESSION_MODEL(unit) == bcmintMirrorSessionModelExclusive) {

        /*
         * EP Recirculate profile is a special mirror source.
         * A normal mirror source supports N containers,
         * container_i can only use session_array_i,
         * and a session array has MIRROR_INSTANCE_NUM instances.
         * But a container can only specify one of the instances to be used.
         *
         * For EP Recirculate profile, the mirror session array is fixed to
         * session_array_0, and an EP Recirculate profile directly specifies
         * the instance to be used, so up to MIRROR_INSTANCE_NUM destinations
         * are supported, and a same destination can be applied on multiple
         * EP Recirculate profiles.
         */
        if (source->type == BCMINT_MIRROR_ST_F_EP_RECIRC) {
            for (i = 0; i < MIRROR_CONTAINER_NUM(unit); i++) {
                ...
                /* Container is occupied by other source. */
        ...
        ifp_share_ena = bcmi_ltsw_property_get(
                          unit,
                          BCMI_CPN_INGRESS_FIELD_SHARED_MIRROR_CONTAINER_ENABLE,
                          0);
            ...
            if (MIRROR_CONTAINER_REF_COUNT(unit, i) &&
                ...
                if (source->type != MIRROR_CONTAINER(unit, i)->source) {
                    ...
                    if (source->type == BCMINT_MIRROR_ST_F_FP_ING ||
                        ...
                        source->type == BCMINT_MIRROR_ST_F_EM_FP_ING ||
                        source->type == BCMINT_MIRROR_ST_F_EM_FP_EGR ||
                        source->type == BCMINT_MIRROR_ST_F_EM_FT_ING ||
                        source->type == BCMINT_MIRROR_ST_F_EM_FT_EGR ||
                        source->type == BCMINT_MIRROR_ST_F_EM_FP_ING_HW ||
                        source->type == BCMINT_MIRROR_ST_F_EM_FP_EGR_HW ||
                        source->type == BCMINT_MIRROR_ST_F_EM_FT_ING_HW ||
                        source->type == BCMINT_MIRROR_ST_F_EM_FT_EGR_HW) {
                    ...
                    if (((BCMINT_MIRROR_ST_F_VP_ING |
                        ...
                        (((BCMINT_MIRROR_ST_F_FP_ING |
                           BCMINT_MIRROR_ST_F_FP_EGR) & source->type) &&
                          ifp_share_ena)) {
                          /* Allow to share container. */
                    } else {
                        status[i] = MIRROR_OCCUPIED;
                        continue;
                    }
                        ...
                        int *session_id)
{
    ...
    bool egr = false, found = false, reverse_traverse = false;
     ...
     */
    reverse_traverse = egr;

    start = reverse_traverse ? MIRROR_SESSION_ARRAY_NUM(unit) - 1 : 0;
    end = reverse_traverse ? -1 : MIRROR_SESSION_ARRAY_NUM(unit);
    inc = reverse_traverse ? -1 : 1;
                         ...
                         int *session_id)
{
    ...
    /*
     * For EP Recirculate, mirror session is fixed to mirror_session_0.
     * Each profile can hold one mirror instance.
     */
    if (source->type == BCMINT_MIRROR_ST_F_EP_RECIRC) {
        if (dest[0] == dest_id) {
                      ...
                      int encap_id, int *session_id, bool *alloc)
{
    ...
    session.encap_ena = (encap_id != -1) ? true : false;
    session.encap_id = (encap_id == -1) ? 0 : encap_id;
...
mirror_dest_mod_recover(int unit)
{
    ...
    /*
     * The mirror_dest may already been created while doing traverse of
     * mirror session in mirror_dest_recover().
     */
...
mirror_dest_recover(int unit)
{
    int i, dest_id = -1, encap_id = -1, my_modid = 0;
    bcm_mirror_destination_t *mirror_dest = NULL;
    bcmint_mirror_session_entry_t session;
    bcm_gport_t gport;
    int ref_cnt = 0;
    ...
    for (i = 0; i < MIRROR_SESSION_NUM(unit); i++) {
        ...
        /* Skip if it is cosq_mod. */
        if (MIRROR_SESSION(unit, i)->cosq_mod) {
            continue;
        }
...
{
    int session_id_tmp = -1, container_id_tmp = -1, session_id_old = -1;
    bcm_mirror_destination_t *mirror_dest = NULL;
    int encap_index = -1;
     ...
     * For field source:
     *
     * 1. bcmintMirrorSessionModelExclusive:
     *    field module programs mirror index itself.
     *
     * 2. bcmintMirrorSessionModelShared:
     *    field module programs mirror index itself but still need to
     *    enable container.
     */
    if (source->type == BCMINT_MIRROR_ST_F_FP_ING ||
        source->type == BCMINT_MIRROR_ST_F_FP_EGR ||
        ...
        /*
         * Check whether there is already a mirror instanced attached to
         * the EP Recirculate profile.
         */
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmi_ltsw_switch_ep_recirc_profile_mirror_instance_get
                (unit, source->ep_recirc_profile_id, &session_id_old));

        if (session_id_old == 0) {
            /*
             * No mirror instance attached yet, update the profile.
        ...
        } else if (session_id_old == session_id_tmp) {
            if (!(mirror_dest->flags & BCM_MIRROR_DEST_REPLACE)) {
                SHR_ERR_EXIT(SHR_E_EXISTS);
            }
        } else {
...
{
    int session_id = -1, container_id = -1;
    int encap_index = -1;
    bcm_mirror_destination_t *mirror_dest = NULL;
    int size, *dest = NULL;
    ...
    if (source->type == BCMINT_MIRROR_ST_F_EP_RECIRC) {
        /* The dest_id does not match. */
        if (dest[0] != dest_id) {
            LOG_VERBOSE(BSL_LOG_MODULE,
                    (BSL_META_U(unit, "Dest id does not match, expect=%d,"
                                      " assign=%d\n"),
                                      dest[0], dest_id));
            SHR_ERR_EXIT(SHR_E_PARAM);
        }
        /* Clear the instacne id in EP Recirculate profile. */
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmi_ltsw_switch_ep_recirc_profile_mirror_instance_set
                (unit, source->ep_recirc_profile_id, 0));
...
{
    int dest_id = -1, rv;
    uint32_t flags_tmp = 0, i, succ_cnt = 0;
    ...
    if (source->type == bcmMirrorSourceTypePktTraceEvent) {
        if (source->flags & BCM_MIRROR_SOURCE_INGRESS_EVENT_ALL) {
            for (i = 0;
                 i < sizeof(mirror_ingress_trace_events) / sizeof(bcm_pkt_trace_event_t);
                 i++) {
                rv = mirror_dest_trace_event_attach
                        (unit, mirror_ingress_trace_events[i], dest_id);
                if (BCM_SUCCESS(rv)) {
                    succ_cnt++;
                }
            }
            if (succ_cnt == 0) {
                /* Loop all and cannot attach a successful one. */
        ...
        if (source->flags & BCM_MIRROR_SOURCE_INGRESS_EVENT_ALL) {
            for (i = 0;
                 i < sizeof(mirror_ingress_drop_events) / sizeof(bcm_pkt_drop_event_t);
                 i++) {
                rv = mirror_dest_drop_event_attach
                        (unit, mirror_ingress_drop_events[i], dest_id);
                if (BCM_SUCCESS(rv)) {
                    succ_cnt++;
                }
            }
    ...
    if (source->type == bcmMirrorSourceTypePktTraceEvent) {
        if (source->flags & BCM_MIRROR_SOURCE_INGRESS_EVENT_ALL) {
            for (i = 0;
                 i < sizeof(mirror_ingress_trace_events) / sizeof(bcm_pkt_trace_event_t);
                 i++) {
                rv = mirror_dest_trace_event_detach
                        (unit, mirror_ingress_trace_events[i], dest_id);
                if (BCM_SUCCESS(rv)) {
                    succ_cnt++;
                }
            ...
            if (succ_cnt == 0) {
                /* Loop all and cannot detach a successful one. */
                return BCM_E_UNAVAIL;
            }
        } else {
            SHR_IF_ERR_VERBOSE_EXIT
        ...
        if (source->flags & BCM_MIRROR_SOURCE_INGRESS_EVENT_ALL) {
            for (i = 0;
                 i < sizeof(mirror_ingress_drop_events) / sizeof(bcm_pkt_drop_event_t);
                 i++) {
                rv = mirror_dest_drop_event_detach
                        (unit, mirror_ingress_drop_events[i], dest_id);
                if (BCM_SUCCESS(rv)) {
                    succ_cnt++;
                }
    ...
    if (source->type == bcmMirrorSourceTypePktTraceEvent) {
        if (source->flags & BCM_MIRROR_SOURCE_INGRESS_EVENT_ALL) {
            for (i = 0;
                 i < sizeof(mirror_ingress_trace_events) / sizeof(bcm_pkt_trace_event_t);
                 i++) {
                rv = mirror_dest_trace_event_get
                        (unit, mirror_ingress_trace_events[i],
                         mirror_dest_size,
                         mirror_dest,
                         mirror_dest_count);
                if (BCM_SUCCESS(rv)) {
        ...
        if (source->flags & BCM_MIRROR_SOURCE_INGRESS_EVENT_ALL) {
            for (i = 0;
                 i < sizeof(mirror_ingress_drop_events) / sizeof(bcm_pkt_drop_event_t);
                 i++) {
                rv = mirror_dest_drop_event_get
                        (unit, mirror_ingress_drop_events[i],
                         mirror_dest_size,
                         mirror_dest,
                         mirror_dest_count);
                if (BCM_SUCCESS(rv)) {
...
mirror_source_params_validate(int unit, bcm_mirror_source_t *source)
{
    ...
    if (source->type >= bcmMirrorSourceTypeCount) {
        ...
        if (source->type == bcmMirrorSourceTypeEpRecirc) {
            if (!ltsw_feature(unit, LTSW_FT_EP_RECIRC)) {
                SHR_ERR_EXIT(SHR_E_UNAVAIL);
            }
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmi_ltsw_switch_ep_recirc_profile_num_get(unit,
                                                            &ep_recirc_prof_num));
            if (source->ep_recirc_profile_id >= ep_recirc_prof_num ||
                source->ep_recirc_profile_id == 0) {
                SHR_ERR_EXIT(SHR_E_PARAM);
            }
        }
    }
                      ...
                      bcmi_ltsw_mirror_info_t *info)
{
    ...
    if (flags & BCMI_LTSW_MIRROR_INGRESS) {
        if (flags & BCMI_LTSW_MIRROR_EM_FP) {
            source.type = (flags & BCMI_LTSW_MIRROR_HW_LEARN_ENTRY) ?
                BCMINT_MIRROR_ST_F_EM_FP_ING_HW : BCMINT_MIRROR_ST_F_EM_FP_ING;
        } else if (flags & BCMI_LTSW_MIRROR_EM_FT) {
            source.type = (flags & BCMI_LTSW_MIRROR_HW_LEARN_ENTRY) ?
                BCMINT_MIRROR_ST_F_EM_FT_ING_HW : BCMINT_MIRROR_ST_F_EM_FT_ING;
        } else{
            source.type = BCMINT_MIRROR_ST_F_FP_ING;
        }
        ...
        if (flags & BCMI_LTSW_MIRROR_EM_FP) {
            source.type = (flags & BCMI_LTSW_MIRROR_HW_LEARN_ENTRY) ?
                BCMINT_MIRROR_ST_F_EM_FP_EGR_HW : BCMINT_MIRROR_ST_F_EM_FP_EGR;
        } else if (flags & BCMI_LTSW_MIRROR_EM_FT) {
            source.type = (flags & BCMI_LTSW_MIRROR_HW_LEARN_ENTRY) ?
                BCMINT_MIRROR_ST_F_EM_FT_EGR_HW : BCMINT_MIRROR_ST_F_EM_FT_EGR;
        } else {
            source.type = BCMINT_MIRROR_ST_F_FP_EGR;
        }
    } else {
...
static int
mirror_encap_info_get(
    int unit,
    bcm_mirror_encap_instance_t *inst,
    bcm_mirror_encap_info_t *info)
{
    ...
    SHR_NULL_CHECK(inst, SHR_E_PARAM);
    SHR_NULL_CHECK(info, SHR_E_PARAM);

    dest_id = BCM_GPORT_MIRROR_GET(inst->mirror_dest_id);
    MIRROR_DEST_ID_CHECK(unit, dest_id);

    if ((inst->flags & BCM_MIRROR_ENCAP_INSTANCE_INGRESS) &&
        (inst->flags & BCM_MIRROR_ENCAP_INSTANCE_EGRESS)) {
        SHR_ERR_EXIT(SHR_E_PARAM);
    }

    egr = (inst->flags & BCM_MIRROR_ENCAP_INSTANCE_EGRESS) ? TRUE : FALSE;
    ...
    for (i = 0; i < MIRROR_SESSION_NUM(unit); i++) {
        ...
        if ((MIRROR_SESSION(unit, i)->mirror_dest_id == dest_id) &&
            (MIRROR_SESSION(unit, i)->egr == egr)) {
            info->encap_id = MIRROR_SESSION(unit, i)->encap_id;
            SHR_EXIT();
        }
    }
    SHR_ERR_EXIT(SHR_E_NOT_FOUND);
                                      ...
                                      int *profile_id)
{
    ...
    if (sample_type == bcmintMirrorSampleIngress) {
        MIRROR_SAMPLE_ING_PRF_SUPPORT_CHECK(unit);
    }
...
int
bcm_ltsw_mirror_sample_stat_set(int unit,
                                int profile_id,
                                ...
                                uint64 value)
{
    ...
    MIRROR_INIT_CHECK(unit);
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_mirror_sample_stat_set(unit, profile_id,
                                          type, value));
...
int
bcm_ltsw_mirror_sample_stat_get(int unit,
                                int profile_id,
                                bcm_mirror_sample_stat_type_t type,
                                uint64 *value)
{
    ...
    MIRROR_INIT_CHECK(unit);
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_mirror_sample_stat_get(unit, profile_id,
                                          type, value));
...
int
bcm_ltsw_mirror_encap_info_get(
    int unit,
    bcm_mirror_encap_instance_t *inst,
    bcm_mirror_encap_info_t *info)
{
    ...
    SHR_IF_ERR_CONT
        (mirror_encap_info_get(unit, inst, info));
