...
bcm_ltsw_l3_info(int unit, bcm_l3_info_t *l3info)
{
    ...
    if (!ltsw_feature(unit, LTSW_FT_ROUTE_SIMULATE_HOST)) {
        ...
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmi_ltsw_l3_fib_info_get(unit, &info));

        l3info->l3info_max_host = info.host_v4_max;
        l3info->l3info_max_l3 = l3info->l3info_max_host;
        l3info->l3info_used_host = info.host_v4_used  + info.host_v6_used * 2;
        l3info->l3info_used_l3 = l3info->l3info_used_host;
        l3info->l3info_used_host_ip4 = info.host_v4_used;
        l3info->l3info_used_host_ip6 = 2 * info.host_v6_used;
    }
