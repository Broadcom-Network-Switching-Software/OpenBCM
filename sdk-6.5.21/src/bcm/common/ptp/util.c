    ...
    bcm_ptp_clock_port_address_t *port_addr)
{
    ...
    sal_memset(port_addr->address, 0, BCM_PTP_MAX_NETW_ADDR_SIZE);
    ...
    case bcmPTPUDPIPv6:
        sal_memcpy(port_addr->address, peer_addr->ipv6_addr, PTP_IPV6_ADDR_SIZE_BYTES);
        break;
     ...
     bcm_ptp_clock_peer_address_t *peer_addr)
{
    ...
    case bcmPTPUDPIPv6:
        sal_memcpy(peer_addr->ipv6_addr, port_addr->address, PTP_IPV6_ADDR_SIZE_BYTES);
        break;
