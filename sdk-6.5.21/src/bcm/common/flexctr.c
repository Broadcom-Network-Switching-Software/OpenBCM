...
/*!
 * \brief Flex counter block data structure initialization function.
 *
 * This function is used to initialize a block data structure.
 *
 * \param [in/out] block Flex counter block data structure.
 */
void
bcm_flexctr_block_t_init(bcm_flexctr_block_t *block)
{
    if (block != NULL) {
...
/*!
 * \brief Flex counter pool info structure initialization function.
 *
 * This function is used to initialize a pool info structure.
 *
 * \param [in/out] pool_info Flexctr pool info structure.
 */
void
bcm_flexctr_pool_info_t_init(bcm_flexctr_pool_info_t *pool_info)
{
    if (pool_info != NULL) {
...
/*!
* \brief Flex counter object information data structure initialization function.
*
* This function is used to initialize flex counter object information data structure.
*
* \param [in/out] flex counter object information data structure.
*/
void
bcm_flexctr_object_info_t_init(bcm_flexctr_object_info_t *obj_info)
{
    if (obj_info != NULL) {
        sal_memset(obj_info, 0, sizeof(bcm_flexctr_object_info_t));
    }
}
