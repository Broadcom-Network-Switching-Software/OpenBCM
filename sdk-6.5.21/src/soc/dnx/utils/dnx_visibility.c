...
static const dnx_visibility_block_map_t dnx_visibility_block_map[DBAL_NOF_ENUM_PP_ASIC_BLOCK_VALUES] = {
    ...
    [DBAL_ENUM_FVAL_PP_ASIC_BLOCK_IPPA] = {"IPPA", DBAL_TABLE_IPPA_SIGNAL_MEMORY, DBAL_FIELD_IPPA_SAMPLE_VALIDS,
                                           BCM_INSTRU_CONTROL_FLAG_DIRECTION_INGRESS},
    [DBAL_ENUM_FVAL_PP_ASIC_BLOCK_IPPB] = {"IPPB", DBAL_TABLE_IPPB_SIGNAL_MEMORY, DBAL_FIELD_IPPB_SAMPLE_VALIDS,
                                           BCM_INSTRU_CONTROL_FLAG_DIRECTION_INGRESS},
    [DBAL_ENUM_FVAL_PP_ASIC_BLOCK_IPPC] = {"IPPC", DBAL_TABLE_IPPC_SIGNAL_MEMORY, DBAL_FIELD_IPPC_SAMPLE_VALIDS,
                                           BCM_INSTRU_CONTROL_FLAG_DIRECTION_INGRESS},
    [DBAL_ENUM_FVAL_PP_ASIC_BLOCK_IPPD] = {"IPPD", DBAL_TABLE_IPPD_SIGNAL_MEMORY, DBAL_FIELD_IPPD_SAMPLE_VALIDS,
                                           BCM_INSTRU_CONTROL_FLAG_DIRECTION_INGRESS},
    [DBAL_ENUM_FVAL_PP_ASIC_BLOCK_IPPE] = {"IPPE", DBAL_TABLE_IPPE_SIGNAL_MEMORY, DBAL_FIELD_IPPE_SAMPLE_VALIDS,
                                           BCM_INSTRU_CONTROL_FLAG_DIRECTION_INGRESS},
    [DBAL_ENUM_FVAL_PP_ASIC_BLOCK_IPPF] = {"IPPF", DBAL_TABLE_IPPF_SIGNAL_MEMORY, DBAL_FIELD_IPPF_SAMPLE_VALIDS,
                                           BCM_INSTRU_CONTROL_FLAG_DIRECTION_INGRESS},
    [DBAL_ENUM_FVAL_PP_ASIC_BLOCK_ERPP] = {"ERPP", DBAL_TABLE_ERPP_SIGNAL_MEMORY, DBAL_FIELD_ERPP_SAMPLE_VALIDS,
                                           BCM_INSTRU_CONTROL_FLAG_DIRECTION_EGRESS},
    [DBAL_ENUM_FVAL_PP_ASIC_BLOCK_ETPPA] = {"ETPPA", DBAL_TABLE_ETPPA_SIGNAL_MEMORY, DBAL_FIELD_ETPPA_SAMPLE_VALIDS,
                                            BCM_INSTRU_CONTROL_FLAG_DIRECTION_EGRESS},
    [DBAL_ENUM_FVAL_PP_ASIC_BLOCK_ETPPB] = {"ETPPB", DBAL_TABLE_ETPPB_SIGNAL_MEMORY, DBAL_FIELD_ETPPB_SAMPLE_VALIDS,
                                            BCM_INSTRU_CONTROL_FLAG_DIRECTION_EGRESS},
    [DBAL_ENUM_FVAL_PP_ASIC_BLOCK_ETPPC] = {"ETPPC", DBAL_TABLE_ETPPC_SIGNAL_MEMORY, DBAL_FIELD_ETPPC_SAMPLE_VALIDS,
                                            BCM_INSTRU_CONTROL_FLAG_DIRECTION_EGRESS},
};
