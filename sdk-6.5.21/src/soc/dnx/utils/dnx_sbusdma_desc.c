...
STATIC sal_sem_t dnx_sbusdma_desc_timeout_sem[SOC_MAX_NUM_DEVICES];
...
STATIC sal_thread_t dnx_sbusdma_desc_timeout_tid[SOC_MAX_NUM_DEVICES];
STATIC uint8 dnx_sbusdma_desc_timeout_terminate[SOC_MAX_NUM_DEVICES];
    ...
    void *entry_data)
{
    ...
    if ((dnx_sbusdma_desc_timeout_enabled[unit] == TRUE) && (dnx_sbusdma_desc_timeout_sem[unit] != 0) && give_sem)
    {
