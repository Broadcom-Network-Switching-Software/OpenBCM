    ...
    int unit)
{
    ...
    return ((SAL_BOOT_PLISIM && g_kbp_compiled && (is_std_1) && (rv == 0))
            || (!SAL_BOOT_PLISIM && g_kbp_compiled
...
dnx_kbp_valid_key_width(
    ...
    uint32 *valid_width)
{
DNX_KBP_DUMMY_PROTOTYPE_ERR_MSG("dnx_kbp_valid_key_width")}
shr_error_e
dnx_kbp_valid_result_width(
    int unit,
    uint32 width,
    uint32 *valid_width)
{
DNX_KBP_DUMMY_PROTOTYPE_ERR_MSG("dnx_kbp_valid_result_width")}
shr_error_e
dnx_kbp_caching_enabled_get(
    int unit,
    int is_acl,
    int *enabled)
{
DNX_KBP_DUMMY_PROTOTYPE_ERR_MSG("dnx_kbp_caching_enabled_get")}
shr_error_e
dnx_kbp_caching_enabled_set(
    int unit,
    int is_acl,
    int enable)
{
DNX_KBP_DUMMY_PROTOTYPE_ERR_MSG("dnx_kbp_caching_enabled_set")}
