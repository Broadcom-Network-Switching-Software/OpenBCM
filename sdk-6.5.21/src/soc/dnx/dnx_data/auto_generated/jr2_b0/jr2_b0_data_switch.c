...
static shr_error_e
jr2_b0_dnx_data_switch_feature_excluded_header_bits_from_hash_set(
    int unit)
{
...
static shr_error_e
jr2_b0_dnx_data_switch_feature_silent_dummy_lif_lookup_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_switch;
    ...
    int unit)
{
    ...
    feature->set = jr2_b0_dnx_data_switch_feature_excluded_header_bits_from_hash_set;
    data_index = dnx_data_switch_feature_silent_dummy_lif_lookup;
    feature = &submodule->features[data_index];
    feature->set = jr2_b0_dnx_data_switch_feature_silent_dummy_lif_lookup_set;
