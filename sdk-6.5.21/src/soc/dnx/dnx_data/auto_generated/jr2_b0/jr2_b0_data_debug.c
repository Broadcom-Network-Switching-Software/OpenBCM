...
static shr_error_e
jr2_b0_dnx_data_debug_mem_params_set(
    int unit)
{
    int block_index;
...
static shr_error_e
jr2_b0_dnx_data_debug_feature_pem_vt_init_fix_set(
    int unit)
{
...
static shr_error_e
jr2_b0_dnx_data_debug_feature_fwd_action_signals_from_lbp_valid_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_debug;
...
static shr_error_e
jr2_b0_dnx_data_debug_general_lbp_debug_signals_register_based_set(
    int unit)
{
    ...
    int unit)
{
    ...
    table->set = jr2_b0_dnx_data_debug_mem_params_set;
    ...
    feature->set = jr2_b0_dnx_data_debug_feature_pem_vt_init_fix_set;
    data_index = dnx_data_debug_feature_fwd_action_signals_from_lbp_valid;
    feature = &submodule->features[data_index];
    feature->set = jr2_b0_dnx_data_debug_feature_fwd_action_signals_from_lbp_valid_set;
    ...
    define->set = jr2_b0_dnx_data_debug_general_lbp_debug_signals_register_based_set;
