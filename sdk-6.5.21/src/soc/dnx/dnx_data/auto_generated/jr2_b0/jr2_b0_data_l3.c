...
static shr_error_e
jr2_b0_dnx_data_l3_source_address_custom_sa_use_dual_homing_set(
    int unit)
{
...
static shr_error_e
jr2_b0_dnx_data_l3_feature_fec_hit_bit_set(
    int unit)
{
...
static shr_error_e
jr2_b0_dnx_data_l3_feature_nat_on_a_stick_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l3;
...
static shr_error_e
jr2_b0_dnx_data_l3_feature_ingress_frag_not_first_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l3;
    ...
    int unit)
{
    ...
    define->set = jr2_b0_dnx_data_l3_source_address_custom_sa_use_dual_homing_set;
    ...
    feature->set = jr2_b0_dnx_data_l3_feature_fec_hit_bit_set;
    data_index = dnx_data_l3_feature_nat_on_a_stick;
    feature = &submodule->features[data_index];
    feature->set = jr2_b0_dnx_data_l3_feature_nat_on_a_stick_set;
    data_index = dnx_data_l3_feature_ingress_frag_not_first;
    feature = &submodule->features[data_index];
    feature->set = jr2_b0_dnx_data_l3_feature_ingress_frag_not_first_set;
