...
static shr_error_e
jr2_a0_dnx_data_instru_ifa_is_intermediate_node_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_instru;
    int submodule_index = dnx_data_instru_submodule_ifa;
    int feature_index = dnx_data_instru_ifa_is_intermediate_node_supported;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_instru_ifa_is_intermediate_node_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_instru_ifa_is_intermediate_node_supported_set;
