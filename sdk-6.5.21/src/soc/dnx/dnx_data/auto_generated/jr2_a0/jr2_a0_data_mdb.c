    ...
    int unit)
{
    ...
    if (MDB_PHYSICAL_TABLE_ISEM_1 < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_ISEM_1, 0);
    ...
    if (MDB_PHYSICAL_TABLE_INLIF_1 < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_INLIF_1, 0);
        SHR_RANGE_VERIFY(12, 0, DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS, _SHR_E_INTERNAL, "out of bound access to array")
    ...
    if (MDB_PHYSICAL_TABLE_IVSI < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_IVSI, 0);
        SHR_RANGE_VERIFY(12, 0, DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS, _SHR_E_INTERNAL, "out of bound access to array")
        data->table_way_to_macro_mapping[0] = 1;
    ...
    if (MDB_PHYSICAL_TABLE_ISEM_2 < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_ISEM_2, 0);
        SHR_RANGE_VERIFY(12, 0, DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS, _SHR_E_INTERNAL, "out of bound access to array")
        data->table_way_to_macro_mapping[0] = 5;
        data->table_way_to_macro_mapping[1] = 6;
    ...
    if (MDB_PHYSICAL_TABLE_INLIF_2 < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_INLIF_2, 0);
        SHR_RANGE_VERIFY(12, 0, DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS, _SHR_E_INTERNAL, "out of bound access to array")
    ...
    if (MDB_PHYSICAL_TABLE_ISEM_3 < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_ISEM_3, 0);
        SHR_RANGE_VERIFY(12, 0, DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS, _SHR_E_INTERNAL, "out of bound access to array")
    ...
    if (MDB_PHYSICAL_TABLE_INLIF_3 < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_INLIF_3, 0);
        SHR_RANGE_VERIFY(12, 0, DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS, _SHR_E_INTERNAL, "out of bound access to array")
    ...
    if (MDB_PHYSICAL_TABLE_LEM < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_LEM, 0);
        SHR_RANGE_VERIFY(12, 0, DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS, _SHR_E_INTERNAL, "out of bound access to array")
    ...
    if (MDB_PHYSICAL_TABLE_ADS_1 < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_ADS_1, 0);
        SHR_RANGE_VERIFY(12, 0, DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS, _SHR_E_INTERNAL, "out of bound access to array")
        data->table_way_to_macro_mapping[0] = 6;
    ...
    if (MDB_PHYSICAL_TABLE_ADS_2 < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_ADS_2, 0);
        SHR_RANGE_VERIFY(12, 0, DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS, _SHR_E_INTERNAL, "out of bound access to array")
    ...
    if (MDB_PHYSICAL_TABLE_BIG_KAPS_BB_1 < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_BIG_KAPS_BB_1, 0);
        SHR_RANGE_VERIFY(12, 0, DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS, _SHR_E_INTERNAL, "out of bound access to array")
        data->table_way_to_macro_mapping[0] = 1;
        data->table_way_to_macro_mapping[1] = 2;
        data->table_way_to_macro_mapping[2] = 3;
    ...
    if (MDB_PHYSICAL_TABLE_BIG_KAPS_BB_2 < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_BIG_KAPS_BB_2, 0);
        SHR_RANGE_VERIFY(12, 0, DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS, _SHR_E_INTERNAL, "out of bound access to array")
    ...
    if (MDB_PHYSICAL_TABLE_IOEM_0 < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_IOEM_0, 0);
        SHR_RANGE_VERIFY(12, 0, DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS, _SHR_E_INTERNAL, "out of bound access to array")
    ...
    if (MDB_PHYSICAL_TABLE_IOEM_1 < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_IOEM_1, 0);
        SHR_RANGE_VERIFY(12, 0, DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS, _SHR_E_INTERNAL, "out of bound access to array")
    ...
    if (MDB_PHYSICAL_TABLE_MAP < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_MAP, 0);
        SHR_RANGE_VERIFY(12, 0, DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS, _SHR_E_INTERNAL, "out of bound access to array")
    ...
    if (MDB_PHYSICAL_TABLE_FEC_1 < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_FEC_1, 0);
        SHR_RANGE_VERIFY(12, 0, DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS, _SHR_E_INTERNAL, "out of bound access to array")
        data->table_way_to_macro_mapping[0] = 0;
        data->table_way_to_macro_mapping[1] = 10;
    ...
    if (MDB_PHYSICAL_TABLE_FEC_2 < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_FEC_2, 0);
        SHR_RANGE_VERIFY(12, 0, DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS, _SHR_E_INTERNAL, "out of bound access to array")
    ...
    if (MDB_PHYSICAL_TABLE_FEC_3 < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_FEC_3, 0);
        SHR_RANGE_VERIFY(12, 0, DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS, _SHR_E_INTERNAL, "out of bound access to array")
        data->table_way_to_macro_mapping[0] = 3;
        data->table_way_to_macro_mapping[1] = 5;
    ...
    if (MDB_PHYSICAL_TABLE_MC_ID < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_MC_ID, 0);
        SHR_RANGE_VERIFY(12, 0, DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS, _SHR_E_INTERNAL, "out of bound access to array")
        data->table_way_to_macro_mapping[0] = 4;
        data->table_way_to_macro_mapping[1] = 7;
        data->table_way_to_macro_mapping[2] = 14;
    ...
    if (MDB_PHYSICAL_TABLE_GLEM_0 < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_GLEM_0, 0);
        SHR_RANGE_VERIFY(12, 0, DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS, _SHR_E_INTERNAL, "out of bound access to array")
        data->table_way_to_macro_mapping[0] = 5;
        data->table_way_to_macro_mapping[1] = 7;
    ...
    if (MDB_PHYSICAL_TABLE_GLEM_1 < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_GLEM_1, 0);
        SHR_RANGE_VERIFY(12, 0, DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS, _SHR_E_INTERNAL, "out of bound access to array")
        data->table_way_to_macro_mapping[0] = 0;
    ...
    if (MDB_PHYSICAL_TABLE_EEDB_1_2_DATA < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EEDB_1_2_DATA, 0);
        SHR_RANGE_VERIFY(12, 0, DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS, _SHR_E_INTERNAL, "out of bound access to array")
        data->table_way_to_macro_mapping[0] = 6;
        data->table_way_to_macro_mapping[1] = 14;
        data->table_way_to_macro_mapping[2] = 16;
    ...
    if (MDB_PHYSICAL_TABLE_EEDB_3_4_DATA < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EEDB_3_4_DATA, 0);
        SHR_RANGE_VERIFY(12, 0, DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS, _SHR_E_INTERNAL, "out of bound access to array")
        data->table_way_to_macro_mapping[0] = 5;
    ...
    if (MDB_PHYSICAL_TABLE_EEDB_5_6_DATA < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EEDB_5_6_DATA, 0);
        SHR_RANGE_VERIFY(12, 0, DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS, _SHR_E_INTERNAL, "out of bound access to array")
        data->table_way_to_macro_mapping[0] = 1;
        data->table_way_to_macro_mapping[1] = 20;
        data->table_way_to_macro_mapping[2] = 20;
    ...
    if (MDB_PHYSICAL_TABLE_EEDB_7_8_DATA < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EEDB_7_8_DATA, 0);
        SHR_RANGE_VERIFY(12, 0, DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS, _SHR_E_INTERNAL, "out of bound access to array")
        data->table_way_to_macro_mapping[0] = 0;
        data->table_way_to_macro_mapping[1] = 1;
    ...
    if (MDB_PHYSICAL_TABLE_EOEM_0 < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EOEM_0, 0);
        SHR_RANGE_VERIFY(12, 0, DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS, _SHR_E_INTERNAL, "out of bound access to array")
        data->table_way_to_macro_mapping[0] = 7;
        data->table_way_to_macro_mapping[1] = 17;
    ...
    if (MDB_PHYSICAL_TABLE_EOEM_1 < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EOEM_1, 0);
        SHR_RANGE_VERIFY(12, 0, DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS, _SHR_E_INTERNAL, "out of bound access to array")
        data->table_way_to_macro_mapping[0] = 11;
        data->table_way_to_macro_mapping[1] = 13;
        data->table_way_to_macro_mapping[2] = 18;
    ...
    if (MDB_PHYSICAL_TABLE_ESEM < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_ESEM, 0);
        SHR_RANGE_VERIFY(12, 0, DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS, _SHR_E_INTERNAL, "out of bound access to array")
        data->table_way_to_macro_mapping[0] = 0;
        data->table_way_to_macro_mapping[1] = 6;
        data->table_way_to_macro_mapping[2] = 11;
    ...
    if (MDB_PHYSICAL_TABLE_EVSI < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EVSI, 0);
        SHR_RANGE_VERIFY(12, 0, DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS, _SHR_E_INTERNAL, "out of bound access to array")
        data->table_way_to_macro_mapping[0] = 7;
    ...
    if (MDB_PHYSICAL_TABLE_EXEM_1 < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EXEM_1, 0);
        SHR_RANGE_VERIFY(12, 0, DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS, _SHR_E_INTERNAL, "out of bound access to array")
        data->table_way_to_macro_mapping[0] = 2;
    ...
    if (MDB_PHYSICAL_TABLE_EXEM_2 < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EXEM_2, 0);
        SHR_RANGE_VERIFY(12, 0, DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS, _SHR_E_INTERNAL, "out of bound access to array")
    ...
    if (MDB_PHYSICAL_TABLE_EXEM_3 < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EXEM_3, 0);
        SHR_RANGE_VERIFY(12, 0, DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS, _SHR_E_INTERNAL, "out of bound access to array")
        data->table_way_to_macro_mapping[0] = 2;
        data->table_way_to_macro_mapping[1] = 3;
        data->table_way_to_macro_mapping[2] = 20;
    ...
    if (MDB_PHYSICAL_TABLE_EXEM_4 < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EXEM_4, 0);
        SHR_RANGE_VERIFY(12, 0, DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS, _SHR_E_INTERNAL, "out of bound access to array")
        data->table_way_to_macro_mapping[0] = 1;
        data->table_way_to_macro_mapping[1] = 10;
        data->table_way_to_macro_mapping[2] = 20;
    ...
    if (MDB_PHYSICAL_TABLE_RMEP < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_table_way_to_macro_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_RMEP, 0);
        SHR_RANGE_VERIFY(12, 0, DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS, _SHR_E_INTERNAL, "out of bound access to array")
        data->table_way_to_macro_mapping[0] = 0;
    ...
    int unit)
{
    ...
    table->values[2].default_val = "DEFAULT_NAME";
    table->values[3].default_val = "0";
    table->values[4].default_val = "DBAL_NOF_ENUM_DIRECT_PAYLOAD_SIZES_VALUES";
    ...
    if (MDB_PHYSICAL_TABLE_ISEM_1 < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_ISEM_1, 0);
    ...
    if (MDB_PHYSICAL_TABLE_INLIF_1 < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_INLIF_1, 0);
    ...
    if (MDB_PHYSICAL_TABLE_IVSI < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_IVSI, 0);
    ...
    if (MDB_PHYSICAL_TABLE_ISEM_2 < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_ISEM_2, 0);
    ...
    if (MDB_PHYSICAL_TABLE_INLIF_2 < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_INLIF_2, 0);
    ...
    if (MDB_PHYSICAL_TABLE_ISEM_3 < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_ISEM_3, 0);
    ...
    if (MDB_PHYSICAL_TABLE_INLIF_3 < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_INLIF_3, 0);
    ...
    if (MDB_PHYSICAL_TABLE_LEM < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_LEM, 0);
    ...
    if (MDB_PHYSICAL_TABLE_ADS_1 < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_ADS_1, 0);
    ...
    if (MDB_PHYSICAL_TABLE_ADS_2 < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_ADS_2, 0);
    ...
    if (MDB_PHYSICAL_TABLE_BIG_KAPS_BB_1 < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_BIG_KAPS_BB_1, 0);
        data->physical_to_logical = DBAL_PHYSICAL_TABLE_KAPS_1;
    ...
    if (MDB_PHYSICAL_TABLE_BIG_KAPS_BB_2 < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_BIG_KAPS_BB_2, 0);
        data->physical_to_logical = DBAL_PHYSICAL_TABLE_KAPS_2;
        data->db_type = DBAL_ENUM_FVAL_MDB_DB_TYPE_KAPS;
    ...
    if (MDB_PHYSICAL_TABLE_IOEM_0 < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_IOEM_0, 0);
    ...
    if (MDB_PHYSICAL_TABLE_IOEM_1 < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_IOEM_1, 0);
    ...
    if (MDB_PHYSICAL_TABLE_MAP < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_MAP, 0);
    ...
    if (MDB_PHYSICAL_TABLE_FEC_1 < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_FEC_1, 0);
    ...
    if (MDB_PHYSICAL_TABLE_FEC_2 < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_FEC_2, 0);
    ...
    if (MDB_PHYSICAL_TABLE_FEC_3 < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_FEC_3, 0);
    ...
    if (MDB_PHYSICAL_TABLE_MC_ID < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_MC_ID, 0);
    ...
    if (MDB_PHYSICAL_TABLE_GLEM_0 < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_GLEM_0, 0);
    ...
    if (MDB_PHYSICAL_TABLE_GLEM_1 < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_GLEM_1, 0);
    ...
    if (MDB_PHYSICAL_TABLE_EEDB_1_LL < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EEDB_1_LL, 0);
    ...
    if (MDB_PHYSICAL_TABLE_EEDB_1_DATA < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EEDB_1_DATA, 0);
        data->physical_to_logical = DBAL_PHYSICAL_TABLE_EEDB_1;
        data->db_type = DBAL_ENUM_FVAL_MDB_DB_TYPE_EEDB;
    ...
    if (MDB_PHYSICAL_TABLE_EEDB_2_LL < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EEDB_2_LL, 0);
    ...
    if (MDB_PHYSICAL_TABLE_EEDB_2_DATA < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EEDB_2_DATA, 0);
        data->physical_to_logical = DBAL_PHYSICAL_TABLE_EEDB_2;
        data->db_type = DBAL_ENUM_FVAL_MDB_DB_TYPE_EEDB;
    ...
    if (MDB_PHYSICAL_TABLE_EEDB_1_2_DATA < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EEDB_1_2_DATA, 0);
        data->physical_to_logical = DBAL_PHYSICAL_TABLE_EEDB_1;
        data->db_type = DBAL_ENUM_FVAL_MDB_DB_TYPE_EEDB;
    ...
    if (MDB_PHYSICAL_TABLE_EEDB_3_LL < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EEDB_3_LL, 0);
    ...
    if (MDB_PHYSICAL_TABLE_EEDB_3_DATA < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EEDB_3_DATA, 0);
        data->physical_to_logical = DBAL_PHYSICAL_TABLE_EEDB_3;
        data->db_type = DBAL_ENUM_FVAL_MDB_DB_TYPE_EEDB;
    ...
    if (MDB_PHYSICAL_TABLE_EEDB_4_LL < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EEDB_4_LL, 0);
    ...
    if (MDB_PHYSICAL_TABLE_EEDB_4_DATA < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EEDB_4_DATA, 0);
        data->physical_to_logical = DBAL_PHYSICAL_TABLE_EEDB_4;
        data->db_type = DBAL_ENUM_FVAL_MDB_DB_TYPE_EEDB;
    ...
    if (MDB_PHYSICAL_TABLE_EEDB_3_4_DATA < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EEDB_3_4_DATA, 0);
        data->physical_to_logical = DBAL_PHYSICAL_TABLE_EEDB_3;
        data->db_type = DBAL_ENUM_FVAL_MDB_DB_TYPE_EEDB;
    ...
    if (MDB_PHYSICAL_TABLE_EEDB_5_LL < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EEDB_5_LL, 0);
    ...
    if (MDB_PHYSICAL_TABLE_EEDB_5_DATA < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EEDB_5_DATA, 0);
        data->physical_to_logical = DBAL_PHYSICAL_TABLE_EEDB_5;
        data->db_type = DBAL_ENUM_FVAL_MDB_DB_TYPE_EEDB;
    ...
    if (MDB_PHYSICAL_TABLE_EEDB_6_LL < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EEDB_6_LL, 0);
    ...
    if (MDB_PHYSICAL_TABLE_EEDB_6_DATA < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EEDB_6_DATA, 0);
        data->physical_to_logical = DBAL_PHYSICAL_TABLE_EEDB_6;
        data->db_type = DBAL_ENUM_FVAL_MDB_DB_TYPE_EEDB;
    ...
    if (MDB_PHYSICAL_TABLE_EEDB_5_6_DATA < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EEDB_5_6_DATA, 0);
        data->physical_to_logical = DBAL_PHYSICAL_TABLE_EEDB_5;
        data->db_type = DBAL_ENUM_FVAL_MDB_DB_TYPE_EEDB;
    ...
    if (MDB_PHYSICAL_TABLE_EEDB_7_LL < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EEDB_7_LL, 0);
    ...
    if (MDB_PHYSICAL_TABLE_EEDB_7_DATA < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EEDB_7_DATA, 0);
        data->physical_to_logical = DBAL_PHYSICAL_TABLE_EEDB_7;
        data->db_type = DBAL_ENUM_FVAL_MDB_DB_TYPE_EEDB;
    ...
    if (MDB_PHYSICAL_TABLE_EEDB_8_LL < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EEDB_8_LL, 0);
    ...
    if (MDB_PHYSICAL_TABLE_EEDB_8_DATA < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EEDB_8_DATA, 0);
        data->physical_to_logical = DBAL_PHYSICAL_TABLE_EEDB_8;
        data->db_type = DBAL_ENUM_FVAL_MDB_DB_TYPE_EEDB;
    ...
    if (MDB_PHYSICAL_TABLE_EEDB_7_8_DATA < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EEDB_7_8_DATA, 0);
        data->physical_to_logical = DBAL_PHYSICAL_TABLE_EEDB_7;
        data->db_type = DBAL_ENUM_FVAL_MDB_DB_TYPE_EEDB;
    ...
    if (MDB_PHYSICAL_TABLE_EOEM_0 < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EOEM_0, 0);
    ...
    if (MDB_PHYSICAL_TABLE_EOEM_1 < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EOEM_1, 0);
    ...
    if (MDB_PHYSICAL_TABLE_ESEM < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_ESEM, 0);
    ...
    if (MDB_PHYSICAL_TABLE_EVSI < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EVSI, 0);
    ...
    if (MDB_PHYSICAL_TABLE_EXEM_1 < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EXEM_1, 0);
    ...
    if (MDB_PHYSICAL_TABLE_EXEM_2 < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EXEM_2, 0);
    ...
    if (MDB_PHYSICAL_TABLE_EXEM_3 < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EXEM_3, 0);
    ...
    if (MDB_PHYSICAL_TABLE_EXEM_4 < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_EXEM_4, 0);
    ...
    if (MDB_PHYSICAL_TABLE_RMEP < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_pdbs_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_RMEP, 0);
    ...
    int unit)
{
    ...
    table->values[2].default_val = "DEFAULT_NAME";
    table->values[3].default_val = "DBAL_CORE_MODE_SBC";
    table->values[4].default_val = "0";
    table->values[5].default_val = "0";
    table->values[6].default_val = "0";
    ...
    int unit)
{
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_mdb_em_em_interrupt_field_t, (1 * (table->keys[0].size) + 1  ), "data of dnx_data_mdb_em_table_em_interrupt_field");
    ...
    int unit)
{
    ...
    table->keys[1].size = 12;
    table->info_get.key_size[1] = 12;
    ...
    int unit)
{
    ...
    if (DBAL_PHYSICAL_TABLE_LEM < table->keys[0].size)
    {
        data = (dnx_data_mdb_em_mdb_emp_tables_info_t *) dnxc_data_mgmt_table_data_get(unit, table, DBAL_PHYSICAL_TABLE_LEM, 0);
    ...
    if (DBAL_PHYSICAL_TABLE_SEXEM_3 < table->keys[0].size)
    {
        data = (dnx_data_mdb_em_mdb_emp_tables_info_t *) dnxc_data_mgmt_table_data_get(unit, table, DBAL_PHYSICAL_TABLE_SEXEM_3, 0);
    ...
    if (DBAL_PHYSICAL_TABLE_LEXEM < table->keys[0].size)
    {
        data = (dnx_data_mdb_em_mdb_emp_tables_info_t *) dnxc_data_mgmt_table_data_get(unit, table, DBAL_PHYSICAL_TABLE_LEXEM, 0);
...
static shr_error_e
jr2_a0_dnx_data_mdb_direct_mdb_12_info_set(
    int unit)
{
    int mdb_table_index;
    dnx_data_mdb_direct_mdb_12_info_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnx_data_module_mdb;
    int submodule_index = dnx_data_mdb_submodule_direct;
    int table_index = dnx_data_mdb_direct_table_mdb_12_info;
    SHR_FUNC_INIT_VARS(unit);
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_mdb_direct_mdb_12_info_t, (1 * (table->keys[0].size) + 1  ), "data of dnx_data_mdb_direct_table_mdb_12_info");

    
    default_data = (dnx_data_mdb_direct_mdb_12_info_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    default_data->dbal_table = 0;
    
    for (mdb_table_index = 0; mdb_table_index < table->keys[0].size; mdb_table_index++)
    {
        data = (dnx_data_mdb_direct_mdb_12_info_t *) dnxc_data_mgmt_table_data_get(unit, table, mdb_table_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
    
    if (MDB_PHYSICAL_TABLE_FEC_1 < table->keys[0].size)
    {
        data = (dnx_data_mdb_direct_mdb_12_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_FEC_1, 0);
        data->dbal_table = DBAL_TABLE_MDB_12_FEC_1;
    }
    if (MDB_PHYSICAL_TABLE_FEC_2 < table->keys[0].size)
    {
        data = (dnx_data_mdb_direct_mdb_12_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_FEC_2, 0);
        data->dbal_table = DBAL_TABLE_MDB_12_FEC_2;
    }
    if (MDB_PHYSICAL_TABLE_FEC_3 < table->keys[0].size)
    {
        data = (dnx_data_mdb_direct_mdb_12_info_t *) dnxc_data_mgmt_table_data_get(unit, table, MDB_PHYSICAL_TABLE_FEC_3, 0);
    ...
    int unit)
{
    ...
    if (MDB_PHYSICAL_TABLE_BIG_KAPS_BB_1 < table->keys[0].size)
    {
        ...
        data->dbal_table = DBAL_TABLE_MDB_26_BIG_KAPS_BB_1;
        data->mdb_item_0_field_size = 11;
        data->mdb_item_1_field_size = 11;
    }
    if (MDB_PHYSICAL_TABLE_BIG_KAPS_BB_2 < table->keys[0].size)
    {
        ...
        data->dbal_table = DBAL_TABLE_MDB_26_BIG_KAPS_BB_2;
        data->mdb_item_0_field_size = 6;
        data->mdb_item_1_field_size = 6;
    }
    if (MDB_PHYSICAL_TABLE_IOEM_0 < table->keys[0].size)
    ...
    int unit)
{
    ...
    data_index = dnx_data_mdb_direct_table_mdb_12_info;
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_mdb_direct_mdb_12_info_set;
