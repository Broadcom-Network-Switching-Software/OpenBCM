...
static shr_error_e
j2p_a0_dnx_data_crps_engine_slim_counters_is_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_crps;
    ...
    int unit)
{
    ...
    table->values[8].default_val = "2";
    table->values[9].default_val = "91";
    table->values[10].default_val = "1";
    table->values[11].default_val = "90";
    table->values[12].default_val = "6";
    table->values[13].default_val = "84";
    table->values[14].default_val = "16";
    ...
    int unit)
{
    ...
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_crps_engine_slim_counters_is_supported_set;
