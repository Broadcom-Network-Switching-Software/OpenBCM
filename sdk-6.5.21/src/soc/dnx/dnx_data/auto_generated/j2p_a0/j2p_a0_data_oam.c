...
static shr_error_e
j2p_a0_dnx_data_oam_general_oam_mpls_ccm_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_oam;
    int submodule_index = dnx_data_oam_submodule_general;
    int feature_index = dnx_data_oam_general_oam_mpls_ccm_support;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_oam_general_oam_mpls_ccm_support;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_oam_general_oam_mpls_ccm_support_set;
