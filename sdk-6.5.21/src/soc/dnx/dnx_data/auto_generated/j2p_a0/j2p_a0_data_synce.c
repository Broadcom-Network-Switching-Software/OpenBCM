...
static shr_error_e
j2p_a0_dnx_data_synce_general_measure_rate_on_down_port_is_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_synce;
    ...
    int unit)
{
    ...
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_synce_general_measure_rate_on_down_port_is_supported_set;
