...
static shr_error_e
j2p_a0_dnx_data_field_base_epmf_fes_key_select_for_zero_bit_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
...
static shr_error_e
j2p_a0_dnx_data_field_base_epmf_fes_shift_for_zero_bit_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
...
static shr_error_e
j2p_a0_dnx_data_field_qual_kbp_extra_offset_after_layer_record_offset_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    ...
    int unit)
{
    ...
    if (DNX_FIELD_STAGE_EXTERNAL < table->keys[0].size && DNX_FIELD_IFWD2_QUAL_AC_IN_LIF_WIDE_DATA < table->keys[1].size)
    {
        ...
        data->offset = 1440+dnx_data_field.general_data_qualifiers.ac_in_lif_wide_data_start_bit_get(unit);
    }
    if (DNX_FIELD_STAGE_EXTERNAL < table->keys[0].size && DNX_FIELD_IFWD2_QUAL_AC_IN_LIF_WIDE_DATA_EXTENDED < table->keys[1].size)
    {
        ...
        data->offset = 1440+dnx_data_field.general_data_qualifiers.ac_in_lif_wide_data_extended_start_bit_get(unit);
    }
    if (DNX_FIELD_STAGE_EXTERNAL < table->keys[0].size && DNX_FIELD_IFWD2_QUAL_MACT_ENTRY_GROUPING < table->keys[1].size)
    {
        ...
        data->offset = 1440+dnx_data_field.general_data_qualifiers.mact_entry_grouping_start_bit_get(unit);
    }
    if (DNX_FIELD_STAGE_EXTERNAL < table->keys[0].size && DNX_FIELD_IFWD2_QUAL_VW_VIP_VALID < table->keys[1].size)
    {
        ...
        data->offset = 1440+dnx_data_field.general_data_qualifiers.vw_vip_valid_start_bit_get(unit);
    }
    if (DNX_FIELD_STAGE_EXTERNAL < table->keys[0].size && DNX_FIELD_IFWD2_QUAL_VW_VIP_ID < table->keys[1].size)
    {
        ...
        data->offset = 1440+dnx_data_field.general_data_qualifiers.vw_vip_id_start_bit_get(unit);
    }
    if (DNX_FIELD_STAGE_EXTERNAL < table->keys[0].size && DNX_FIELD_IFWD2_QUAL_VW_MEMBER_REFERENCE < table->keys[1].size)
    {
        ...
        data->offset = 1440+dnx_data_field.general_data_qualifiers.vw_member_reference_start_bit_get(unit);
    }
    if (DNX_FIELD_STAGE_EXTERNAL < table->keys[0].size && DNX_FIELD_IFWD2_QUAL_VW_PCC_HIT < table->keys[1].size)
    {
        ...
        data->offset = 1440+dnx_data_field.general_data_qualifiers.vw_pcc_hit_start_bit_get(unit);
    }
    ...
    if (DNX_FIELD_STAGE_IPMF1 < table->keys[0].size && DNX_FIELD_IPMF1_QUAL_AC_IN_LIF_WIDE_DATA < table->keys[1].size)
    {
        ...
        data->offset = 2915+dnx_data_field.general_data_qualifiers.ac_in_lif_wide_data_start_bit_get(unit);
    }
    if (DNX_FIELD_STAGE_IPMF1 < table->keys[0].size && DNX_FIELD_IPMF1_QUAL_NATIVE_AC_IN_LIF_WIDE_DATA < table->keys[1].size)
    {
        ...
        data->offset = 2915+dnx_data_field.general_data_qualifiers.native_ac_in_lif_wide_data_start_bit_get(unit);
    }
    if (DNX_FIELD_STAGE_IPMF1 < table->keys[0].size && DNX_FIELD_IPMF1_QUAL_AC_IN_LIF_WIDE_DATA_EXTENDED < table->keys[1].size)
    {
        ...
        data->offset = 2915+dnx_data_field.general_data_qualifiers.ac_in_lif_wide_data_extended_start_bit_get(unit);
    }
    if (DNX_FIELD_STAGE_IPMF1 < table->keys[0].size && DNX_FIELD_IPMF1_QUAL_PWE_IN_LIF_WIDE_DATA < table->keys[1].size)
    {
        ...
        data->offset = 2915+dnx_data_field.general_data_qualifiers.pwe_in_lif_wide_data_start_bit_get(unit);
    }
    if (DNX_FIELD_STAGE_IPMF1 < table->keys[0].size && DNX_FIELD_IPMF1_QUAL_MACT_ENTRY_GROUPING < table->keys[1].size)
    {
        ...
        data->offset = 2915+dnx_data_field.general_data_qualifiers.mact_entry_grouping_start_bit_get(unit);
    }
    ...
    if (DNX_FIELD_STAGE_IPMF1 < table->keys[0].size && DNX_FIELD_IPMF1_QUAL_VW_VIP_VALID < table->keys[1].size)
    {
        ...
        data->offset = 2915+dnx_data_field.general_data_qualifiers.vw_vip_valid_start_bit_get(unit);
    }
    if (DNX_FIELD_STAGE_IPMF1 < table->keys[0].size && DNX_FIELD_IPMF1_QUAL_VW_VIP_ID < table->keys[1].size)
    {
        ...
        data->offset = 2915+dnx_data_field.general_data_qualifiers.vw_vip_id_start_bit_get(unit);
    }
    if (DNX_FIELD_STAGE_IPMF1 < table->keys[0].size && DNX_FIELD_IPMF1_QUAL_VW_MEMBER_REFERENCE < table->keys[1].size)
    {
        ...
        data->offset = 2915+dnx_data_field.general_data_qualifiers.vw_member_reference_start_bit_get(unit);
    }
    if (DNX_FIELD_STAGE_IPMF1 < table->keys[0].size && DNX_FIELD_IPMF1_QUAL_VW_PCC_HIT < table->keys[1].size)
    {
        ...
        data->offset = 2915+dnx_data_field.general_data_qualifiers.vw_pcc_hit_start_bit_get(unit);
    }
...
static shr_error_e
j2p_a0_dnx_data_field_features_epmf_outlif_profile_map_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_field_base_epmf_fes_key_select_for_zero_bit_set;
    data_index = dnx_data_field_base_epmf_define_fes_shift_for_zero_bit;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_field_base_epmf_fes_shift_for_zero_bit_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_field_qual_kbp_extra_offset_after_layer_record_offset_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_field_features_epmf_outlif_profile_map_set;
