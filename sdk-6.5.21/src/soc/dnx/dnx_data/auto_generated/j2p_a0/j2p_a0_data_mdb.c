    ...
    int unit)
{
    ...
    if (0 < table->keys[0].size)
    {
        ...
        data->interfaces[2] = MDB_PHYSICAL_TABLE_FEC_1;
        data->interfaces[3] = MDB_PHYSICAL_TABLE_FEC_2;
        data->interfaces[4] = MDB_PHYSICAL_TABLE_EXEM_4;
        ...
        data->interfaces[9] = MDB_NOF_PHYSICAL_TABLES;
    }
    if (1 < table->keys[0].size)
    {
        data = (dnx_data_mdb_dh_macro_interface_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 1, 0);
        SHR_RANGE_VERIFY(10, 0, DNX_DATA_MAX_MDB_DH_MAX_NOF_CLUSTER_INTERFACES, _SHR_E_INTERNAL, "out of bound access to array")
        data->interfaces[0] = MDB_PHYSICAL_TABLE_IVSI;
        data->interfaces[1] = MDB_PHYSICAL_TABLE_INLIF_3;
        data->interfaces[2] = MDB_PHYSICAL_TABLE_LEM;
        data->interfaces[3] = MDB_PHYSICAL_TABLE_BIG_KAPS_BB_2;
        data->interfaces[4] = MDB_PHYSICAL_TABLE_FEC_1;
        data->interfaces[5] = MDB_PHYSICAL_TABLE_FEC_2;
        data->interfaces[6] = MDB_NOF_PHYSICAL_TABLES;
        data->interfaces[7] = MDB_NOF_PHYSICAL_TABLES;
        data->interfaces[8] = MDB_NOF_PHYSICAL_TABLES;
        data->interfaces[9] = MDB_NOF_PHYSICAL_TABLES;
    ...
    if (2 < table->keys[0].size)
    {
        ...
        data->interfaces[2] = MDB_PHYSICAL_TABLE_FEC_2;
        data->interfaces[3] = MDB_PHYSICAL_TABLE_FEC_3;
        data->interfaces[4] = MDB_NOF_PHYSICAL_TABLES;
        data->interfaces[5] = MDB_NOF_PHYSICAL_TABLES;
        data->interfaces[6] = MDB_NOF_PHYSICAL_TABLES;
        data->interfaces[7] = MDB_NOF_PHYSICAL_TABLES;
        data->interfaces[8] = MDB_NOF_PHYSICAL_TABLES;
    ...
    if (3 < table->keys[0].size)
    {
        ...
        data->interfaces[2] = MDB_PHYSICAL_TABLE_EEDB_1_2_DATA;
    ...
    if (4 < table->keys[0].size)
    {
        ...
        SHR_RANGE_VERIFY(10, 0, DNX_DATA_MAX_MDB_DH_MAX_NOF_CLUSTER_INTERFACES, _SHR_E_INTERNAL, "out of bound access to array")
        data->interfaces[0] = MDB_PHYSICAL_TABLE_INLIF_1;
        data->interfaces[1] = MDB_PHYSICAL_TABLE_INLIF_2;
        data->interfaces[2] = MDB_PHYSICAL_TABLE_LEM;
    ...
    if (5 < table->keys[0].size)
    {
        ...
        data->interfaces[2] = MDB_PHYSICAL_TABLE_ADS_2;
        data->interfaces[3] = MDB_PHYSICAL_TABLE_EEDB_3_4_DATA;
    ...
    if (6 < table->keys[0].size)
    {
        ...
        SHR_RANGE_VERIFY(10, 0, DNX_DATA_MAX_MDB_DH_MAX_NOF_CLUSTER_INTERFACES, _SHR_E_INTERNAL, "out of bound access to array")
        data->interfaces[0] = MDB_PHYSICAL_TABLE_LEM;
        data->interfaces[1] = MDB_PHYSICAL_TABLE_MAP;
        data->interfaces[2] = MDB_PHYSICAL_TABLE_FEC_1;
        data->interfaces[3] = MDB_PHYSICAL_TABLE_EEDB_1_2_DATA;
        data->interfaces[4] = MDB_PHYSICAL_TABLE_EXEM_1;
        data->interfaces[5] = MDB_PHYSICAL_TABLE_EXEM_2;
        data->interfaces[6] = MDB_PHYSICAL_TABLE_EXEM_3;
        data->interfaces[7] = MDB_NOF_PHYSICAL_TABLES;
        data->interfaces[8] = MDB_NOF_PHYSICAL_TABLES;
        data->interfaces[9] = MDB_NOF_PHYSICAL_TABLES;
    }
    if (7 < table->keys[0].size)
    {
        ...
        data->interfaces[1] = MDB_PHYSICAL_TABLE_LEM;
        data->interfaces[2] = MDB_PHYSICAL_TABLE_ADS_1;
        data->interfaces[3] = MDB_PHYSICAL_TABLE_BIG_KAPS_BB_1;
        data->interfaces[4] = MDB_PHYSICAL_TABLE_FEC_1;
    ...
    if (8 < table->keys[0].size)
    {
        ...
        data->interfaces[3] = MDB_PHYSICAL_TABLE_EEDB_1_2_DATA;
        data->interfaces[4] = MDB_PHYSICAL_TABLE_EEDB_3_4_DATA;
    ...
    if (11 < table->keys[0].size)
    {
        ...
        data->interfaces[1] = MDB_PHYSICAL_TABLE_BIG_KAPS_BB_1;
        data->interfaces[2] = MDB_PHYSICAL_TABLE_FEC_1;
        data->interfaces[3] = MDB_PHYSICAL_TABLE_EVSI;
        data->interfaces[4] = MDB_PHYSICAL_TABLE_EXEM_1;
        data->interfaces[5] = MDB_PHYSICAL_TABLE_EXEM_2;
        data->interfaces[6] = MDB_PHYSICAL_TABLE_EXEM_3;
        data->interfaces[7] = MDB_NOF_PHYSICAL_TABLES;
    ...
    if (12 < table->keys[0].size)
    {
        ...
        data->interfaces[4] = MDB_PHYSICAL_TABLE_MAP;
        data->interfaces[5] = MDB_PHYSICAL_TABLE_MC_ID;
        data->interfaces[6] = MDB_PHYSICAL_TABLE_EEDB_5_6_DATA;
        data->interfaces[7] = MDB_PHYSICAL_TABLE_EXEM_4;
        data->interfaces[8] = MDB_PHYSICAL_TABLE_RMEP;
        data->interfaces[9] = MDB_NOF_PHYSICAL_TABLES;
    }
    ...
    if (14 < table->keys[0].size)
    {
        ...
        data->interfaces[2] = MDB_PHYSICAL_TABLE_ADS_1;
        data->interfaces[3] = MDB_PHYSICAL_TABLE_BIG_KAPS_BB_1;
        data->interfaces[4] = MDB_PHYSICAL_TABLE_BIG_KAPS_BB_2;
        data->interfaces[5] = MDB_PHYSICAL_TABLE_EEDB_1_2_DATA;
        data->interfaces[6] = MDB_PHYSICAL_TABLE_EEDB_5_6_DATA;
        data->interfaces[7] = MDB_NOF_PHYSICAL_TABLES;
        data->interfaces[8] = MDB_NOF_PHYSICAL_TABLES;
        data->interfaces[9] = MDB_NOF_PHYSICAL_TABLES;
    ...
    if (15 < table->keys[0].size)
    {
        ...
        SHR_RANGE_VERIFY(10, 0, DNX_DATA_MAX_MDB_DH_MAX_NOF_CLUSTER_INTERFACES, _SHR_E_INTERNAL, "out of bound access to array")
        data->interfaces[0] = MDB_PHYSICAL_TABLE_BIG_KAPS_BB_1;
        data->interfaces[1] = MDB_PHYSICAL_TABLE_BIG_KAPS_BB_2;
        data->interfaces[2] = MDB_PHYSICAL_TABLE_FEC_2;
        data->interfaces[3] = MDB_PHYSICAL_TABLE_EEDB_1_2_DATA;
        data->interfaces[4] = MDB_PHYSICAL_TABLE_EEDB_5_6_DATA;
        data->interfaces[5] = MDB_PHYSICAL_TABLE_EOEM_0;
        data->interfaces[6] = MDB_PHYSICAL_TABLE_EOEM_1;
        data->interfaces[7] = MDB_PHYSICAL_TABLE_EXEM_3;
        data->interfaces[8] = MDB_NOF_PHYSICAL_TABLES;
        data->interfaces[9] = MDB_NOF_PHYSICAL_TABLES;
    }
    if (16 < table->keys[0].size)
    {
        ...
        data->interfaces[1] = MDB_PHYSICAL_TABLE_MAP;
        data->interfaces[2] = MDB_PHYSICAL_TABLE_GLEM_0;
        data->interfaces[3] = MDB_PHYSICAL_TABLE_GLEM_0;
        ...
        data->interfaces[7] = MDB_PHYSICAL_TABLE_EEDB_7_8_DATA;
        data->interfaces[8] = MDB_PHYSICAL_TABLE_EVSI;
        data->interfaces[9] = MDB_PHYSICAL_TABLE_RMEP;
    }
    if (17 < table->keys[0].size)
    {
        ...
        data->interfaces[2] = MDB_PHYSICAL_TABLE_IVSI;
        data->interfaces[3] = MDB_PHYSICAL_TABLE_INLIF_2;
        data->interfaces[4] = MDB_PHYSICAL_TABLE_BIG_KAPS_BB_2;
        data->interfaces[5] = MDB_PHYSICAL_TABLE_GLEM_0;
        data->interfaces[6] = MDB_PHYSICAL_TABLE_GLEM_1;
        data->interfaces[7] = MDB_PHYSICAL_TABLE_EEDB_3_4_DATA;
        data->interfaces[8] = MDB_PHYSICAL_TABLE_EOEM_0;
        data->interfaces[9] = MDB_PHYSICAL_TABLE_EOEM_1;
    }
    if (18 < table->keys[0].size)
    {
        ...
        data->interfaces[2] = MDB_PHYSICAL_TABLE_INLIF_2;
        data->interfaces[3] = MDB_PHYSICAL_TABLE_INLIF_3;
        data->interfaces[4] = MDB_PHYSICAL_TABLE_BIG_KAPS_BB_1;
        data->interfaces[5] = MDB_PHYSICAL_TABLE_EEDB_5_6_DATA;
...
static shr_error_e
j2p_a0_dnx_data_mdb_em_mdb_34_info_set(
    int unit)
{
    int mdb_table_index;
    ...
    int unit)
{
    ...
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_mdb_em_mdb_34_info_set;
