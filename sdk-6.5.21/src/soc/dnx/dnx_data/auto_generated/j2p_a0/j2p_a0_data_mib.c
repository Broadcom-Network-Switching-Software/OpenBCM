    ...
    int unit)
{
    ...
    if (dnx_mib_counter_rx_fec_1_symbol_error_per_frame < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_set_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_fec_1_symbol_error_per_frame, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC);
        data->get_cb = dnx_mib_fmac_counter_get;
        data->clear_cb = dnx_mib_fmac_counter_clear;
    }
    if (dnx_mib_counter_rx_fec_2_symbol_error_per_frame < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_set_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_fec_2_symbol_error_per_frame, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC);
        data->get_cb = dnx_mib_fmac_counter_get;
        data->clear_cb = dnx_mib_fmac_counter_clear;
    }
    if (dnx_mib_counter_rx_fec_3_symbol_error_per_frame < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_set_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_fec_3_symbol_error_per_frame, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC);
        data->get_cb = dnx_mib_fmac_counter_get;
        data->clear_cb = dnx_mib_fmac_counter_clear;
    }
    if (dnx_mib_counter_rx_fec_4_symbol_error_per_frame < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_set_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_fec_4_symbol_error_per_frame, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC);
        data->get_cb = dnx_mib_fmac_counter_get;
        data->clear_cb = dnx_mib_fmac_counter_clear;
    }
    if (dnx_mib_counter_rx_fec_5_symbol_error_per_frame < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_set_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_fec_5_symbol_error_per_frame, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC);
        data->get_cb = dnx_mib_fmac_counter_get;
        data->clear_cb = dnx_mib_fmac_counter_clear;
    }
    if (dnx_mib_counter_rx_fec_6_symbol_error_per_frame < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_set_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_fec_6_symbol_error_per_frame, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC);
        data->get_cb = dnx_mib_fmac_counter_get;
        data->clear_cb = dnx_mib_fmac_counter_clear;
    }
    if (dnx_mib_counter_rx_fec_7_symbol_error_per_frame < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_set_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_fec_7_symbol_error_per_frame, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC);
        data->get_cb = dnx_mib_fmac_counter_get;
        data->clear_cb = dnx_mib_fmac_counter_clear;
    }
    if (dnx_mib_counter_rx_fec_8_symbol_error_per_frame < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_set_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_fec_8_symbol_error_per_frame, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC);
        data->get_cb = dnx_mib_fmac_counter_get;
        data->clear_cb = dnx_mib_fmac_counter_clear;
    }
    if (dnx_mib_counter_rx_fec_9_symbol_error_per_frame < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_set_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_fec_9_symbol_error_per_frame, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC);
        data->get_cb = dnx_mib_fmac_counter_get;
        data->clear_cb = dnx_mib_fmac_counter_clear;
    }
    if (dnx_mib_counter_rx_fec_10_symbol_error_per_frame < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_set_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_fec_10_symbol_error_per_frame, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC);
        data->get_cb = dnx_mib_fmac_counter_get;
        data->clear_cb = dnx_mib_fmac_counter_clear;
    }
    if (dnx_mib_counter_rx_fec_11_symbol_error_per_frame < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_set_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_fec_11_symbol_error_per_frame, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC);
        data->get_cb = dnx_mib_fmac_counter_get;
        data->clear_cb = dnx_mib_fmac_counter_clear;
    }
    if (dnx_mib_counter_rx_fec_12_symbol_error_per_frame < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_set_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_fec_12_symbol_error_per_frame, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC);
        data->get_cb = dnx_mib_fmac_counter_get;
        data->clear_cb = dnx_mib_fmac_counter_clear;
    }
    if (dnx_mib_counter_rx_fec_13_symbol_error_per_frame < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_set_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_fec_13_symbol_error_per_frame, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC);
        data->get_cb = dnx_mib_fmac_counter_get;
        data->clear_cb = dnx_mib_fmac_counter_clear;
    }
    if (dnx_mib_counter_rx_fec_14_symbol_error_per_frame < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_set_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_fec_14_symbol_error_per_frame, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC);
        data->get_cb = dnx_mib_fmac_counter_get;
        data->clear_cb = dnx_mib_fmac_counter_clear;
    }
    if (dnx_mib_counter_rx_fec_15_symbol_error_per_frame < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_set_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_fec_15_symbol_error_per_frame, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC);
        data->get_cb = dnx_mib_fmac_counter_get;
        data->clear_cb = dnx_mib_fmac_counter_clear;
    }
    if (dnx_mib_counter_rx_fec_uncorrrectable_errors_per_frame < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_set_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_fec_uncorrrectable_errors_per_frame, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC);
        data->get_cb = dnx_mib_fmac_counter_get;
        data->clear_cb = dnx_mib_fmac_counter_clear;
    }
