    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_mdb_dh_table_macro_interface_mapping].values[0].type = "mdb_physical_table_e[DNX_DATA_MAX_MDB_DH_MAX_NOF_CLUSTER_INTERFACES]";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdbs_info].nof_values = 6;
    ...
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdbs_info].values[0].name = "physical_to_logical";
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdbs_info].values[0].type = "dbal_physical_tables_e";
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdbs_info].values[0].doc = "";
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdbs_info].values[0].offset = UTILEX_OFFSETOF(dnx_data_mdb_pdbs_pdbs_info_t, physical_to_logical);
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdbs_info].values[1].name = "db_type";
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdbs_info].values[1].type = "dbal_enum_value_field_mdb_db_type_e";
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdbs_info].values[1].doc = "";
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdbs_info].values[1].offset = UTILEX_OFFSETOF(dnx_data_mdb_pdbs_pdbs_info_t, db_type);
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdbs_info].values[2].name = "name";
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdbs_info].values[2].type = "char *";
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdbs_info].values[2].doc = "";
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdbs_info].values[2].offset = UTILEX_OFFSETOF(dnx_data_mdb_pdbs_pdbs_info_t, name);
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdbs_info].values[3].name = "row_width";
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdbs_info].values[3].type = "uint32";
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdbs_info].values[3].doc = "";
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdbs_info].values[3].offset = UTILEX_OFFSETOF(dnx_data_mdb_pdbs_pdbs_info_t, row_width);
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdbs_info].values[4].name = "direct_payload_type";
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdbs_info].values[4].type = "dbal_enum_value_field_direct_payload_sizes_e";
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdbs_info].values[4].doc = "";
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdbs_info].values[4].offset = UTILEX_OFFSETOF(dnx_data_mdb_pdbs_pdbs_info_t, direct_payload_type);
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdbs_info].values[5].name = "direct_max_payload_type";
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdbs_info].values[5].type = "dbal_enum_value_field_direct_payload_sizes_e";
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdbs_info].values[5].doc = "";
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdbs_info].values[5].offset = UTILEX_OFFSETOF(dnx_data_mdb_pdbs_pdbs_info_t, direct_max_payload_type);
    ...
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdb_info].nof_values = 7;
    ...
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdb_info].values[0].type = "mdb_physical_table_e";
    ...
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdb_info].values[2].name = "name";
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdb_info].values[2].type = "char *";
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdb_info].values[2].doc = "";
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdb_info].values[2].offset = UTILEX_OFFSETOF(dnx_data_mdb_pdbs_pdb_info_t, name);
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdb_info].values[3].name = "core_mode";
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdb_info].values[3].type = "dbal_core_mode_e";
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdb_info].values[3].doc = "";
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdb_info].values[3].offset = UTILEX_OFFSETOF(dnx_data_mdb_pdbs_pdb_info_t, core_mode);
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdb_info].values[4].name = "row_width";
    ...
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdb_info].values[4].offset = UTILEX_OFFSETOF(dnx_data_mdb_pdbs_pdb_info_t, row_width);
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdb_info].values[5].name = "max_key_size";
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdb_info].values[5].type = "uint32";
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdb_info].values[5].doc = "";
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdb_info].values[5].offset = UTILEX_OFFSETOF(dnx_data_mdb_pdbs_pdb_info_t, max_key_size);
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdb_info].values[6].name = "max_payload_size";
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdb_info].values[6].type = "uint32";
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdb_info].values[6].doc = "";
    submodule_data->tables[dnx_data_mdb_pdbs_table_pdb_info].values[6].offset = UTILEX_OFFSETOF(dnx_data_mdb_pdbs_pdb_info_t, max_payload_size);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_mdb_em_table_mdb_em_tables_info].nof_values = 3;
    ...
    submodule_data->tables[dnx_data_mdb_em_table_mdb_em_tables_info].values[0].name = "mdb_13_table";
    ...
    submodule_data->tables[dnx_data_mdb_em_table_mdb_em_tables_info].values[0].offset = UTILEX_OFFSETOF(dnx_data_mdb_em_mdb_em_tables_info_t, mdb_13_table);
    submodule_data->tables[dnx_data_mdb_em_table_mdb_em_tables_info].values[1].name = "mdb_14_table";
    ...
    submodule_data->tables[dnx_data_mdb_em_table_mdb_em_tables_info].values[1].offset = UTILEX_OFFSETOF(dnx_data_mdb_em_mdb_em_tables_info_t, mdb_14_table);
    ...
    submodule_data->tables[dnx_data_mdb_em_table_mdb_emp_tables_info].nof_values = 3;
    ...
    submodule_data->tables[dnx_data_mdb_em_table_mdb_emp_tables_info].values[0].name = "mdb_18_table";
    ...
    submodule_data->tables[dnx_data_mdb_em_table_mdb_emp_tables_info].values[0].offset = UTILEX_OFFSETOF(dnx_data_mdb_em_mdb_emp_tables_info_t, mdb_18_table);
    submodule_data->tables[dnx_data_mdb_em_table_mdb_emp_tables_info].values[1].name = "mdb_33_table";
    ...
    submodule_data->tables[dnx_data_mdb_em_table_mdb_emp_tables_info].values[1].offset = UTILEX_OFFSETOF(dnx_data_mdb_em_mdb_emp_tables_info_t, mdb_33_table);
    submodule_data->tables[dnx_data_mdb_em_table_mdb_emp_tables_info].values[2].name = "mdb_46_table";
    submodule_data->tables[dnx_data_mdb_em_table_mdb_emp_tables_info].values[2].type = "dbal_tables_e";
    submodule_data->tables[dnx_data_mdb_em_table_mdb_emp_tables_info].values[2].doc = "";
    submodule_data->tables[dnx_data_mdb_em_table_mdb_emp_tables_info].values[2].offset = UTILEX_OFFSETOF(dnx_data_mdb_em_mdb_emp_tables_info_t, mdb_46_table);
    ...
    submodule_data->tables[dnx_data_mdb_em_table_mdb_34_info].name = "mdb_34_info";
    submodule_data->tables[dnx_data_mdb_em_table_mdb_34_info].doc = "";
    submodule_data->tables[dnx_data_mdb_em_table_mdb_34_info].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_mdb_em_table_mdb_34_info].size_of_values = sizeof(dnx_data_mdb_em_mdb_34_info_t);
    submodule_data->tables[dnx_data_mdb_em_table_mdb_34_info].entry_get = dnx_data_mdb_em_mdb_34_info_entry_str_get;

    
    submodule_data->tables[dnx_data_mdb_em_table_mdb_34_info].nof_keys = 1;
    submodule_data->tables[dnx_data_mdb_em_table_mdb_34_info].keys[0].name = "mdb_table";
    submodule_data->tables[dnx_data_mdb_em_table_mdb_34_info].keys[0].doc = "";

    
    submodule_data->tables[dnx_data_mdb_em_table_mdb_34_info].nof_values = 1;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_mdb_em_table_mdb_34_info].values, dnxc_data_value_t, submodule_data->tables[dnx_data_mdb_em_table_mdb_34_info].nof_values, "_dnx_data_mdb_em_table_mdb_34_info table values");
    submodule_data->tables[dnx_data_mdb_em_table_mdb_34_info].values[0].name = "dbal_table";
    submodule_data->tables[dnx_data_mdb_em_table_mdb_34_info].values[0].type = "dbal_tables_e";
    submodule_data->tables[dnx_data_mdb_em_table_mdb_34_info].values[0].doc = "";
    submodule_data->tables[dnx_data_mdb_em_table_mdb_34_info].values[0].offset = UTILEX_OFFSETOF(dnx_data_mdb_em_mdb_34_info_t, dbal_table);
...
const dnx_data_mdb_em_mdb_34_info_t *
dnx_data_mdb_em_mdb_34_info_get(
    int unit,
    int mdb_table)
{
    char *data;
    ...
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_mdb, dnx_data_mdb_submodule_em, dnx_data_mdb_em_table_mdb_34_info);
    
    data = dnxc_data_mgmt_table_data_get(unit, table, mdb_table, 0);
    return (const dnx_data_mdb_em_mdb_34_info_t *) data;
...
shr_error_e
dnx_data_mdb_em_mdb_34_info_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_mdb_em_mdb_34_info_t *data;
    SHR_FUNC_INIT_VARS(unit);

    
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_mdb, dnx_data_mdb_submodule_em, dnx_data_mdb_em_table_mdb_34_info);
    data = (const dnx_data_mdb_em_mdb_34_info_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->dbal_table);
...
const dnxc_data_table_info_t *
dnx_data_mdb_em_mdb_34_info_info_get(
    int unit)
{

    
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_mdb, dnx_data_mdb_submodule_em, dnx_data_mdb_em_table_mdb_34_info);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_mdb_direct_table_mdb_12_info].name = "mdb_12_info";
    submodule_data->tables[dnx_data_mdb_direct_table_mdb_12_info].doc = "";
    submodule_data->tables[dnx_data_mdb_direct_table_mdb_12_info].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_mdb_direct_table_mdb_12_info].size_of_values = sizeof(dnx_data_mdb_direct_mdb_12_info_t);
    submodule_data->tables[dnx_data_mdb_direct_table_mdb_12_info].entry_get = dnx_data_mdb_direct_mdb_12_info_entry_str_get;

    
    submodule_data->tables[dnx_data_mdb_direct_table_mdb_12_info].nof_keys = 1;
    submodule_data->tables[dnx_data_mdb_direct_table_mdb_12_info].keys[0].name = "mdb_table";
    submodule_data->tables[dnx_data_mdb_direct_table_mdb_12_info].keys[0].doc = "";

    
    submodule_data->tables[dnx_data_mdb_direct_table_mdb_12_info].nof_values = 1;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_mdb_direct_table_mdb_12_info].values, dnxc_data_value_t, submodule_data->tables[dnx_data_mdb_direct_table_mdb_12_info].nof_values, "_dnx_data_mdb_direct_table_mdb_12_info table values");
    submodule_data->tables[dnx_data_mdb_direct_table_mdb_12_info].values[0].name = "dbal_table";
    submodule_data->tables[dnx_data_mdb_direct_table_mdb_12_info].values[0].type = "dbal_tables_e";
    submodule_data->tables[dnx_data_mdb_direct_table_mdb_12_info].values[0].doc = "";
    submodule_data->tables[dnx_data_mdb_direct_table_mdb_12_info].values[0].offset = UTILEX_OFFSETOF(dnx_data_mdb_direct_mdb_12_info_t, dbal_table);
...
const dnx_data_mdb_direct_mdb_12_info_t *
dnx_data_mdb_direct_mdb_12_info_get(
    int unit,
    int mdb_table)
{
    char *data;
    ...
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_mdb, dnx_data_mdb_submodule_direct, dnx_data_mdb_direct_table_mdb_12_info);
    
    data = dnxc_data_mgmt_table_data_get(unit, table, mdb_table, 0);
    return (const dnx_data_mdb_direct_mdb_12_info_t *) data;
...
shr_error_e
dnx_data_mdb_direct_mdb_12_info_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_mdb_direct_mdb_12_info_t *data;
    SHR_FUNC_INIT_VARS(unit);

    
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_mdb, dnx_data_mdb_submodule_direct, dnx_data_mdb_direct_table_mdb_12_info);
    data = (const dnx_data_mdb_direct_mdb_12_info_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->dbal_table);
...
const dnxc_data_table_info_t *
dnx_data_mdb_direct_mdb_12_info_info_get(
    int unit)
{

    
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_mdb, dnx_data_mdb_submodule_direct, dnx_data_mdb_direct_table_mdb_12_info);
