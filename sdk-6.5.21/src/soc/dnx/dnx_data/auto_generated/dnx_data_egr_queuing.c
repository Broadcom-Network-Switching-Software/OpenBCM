    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_egr_queuing_params_define_fqp_dbf_additional_latency].name = "fqp_dbf_additional_latency";
    submodule_data->defines[dnx_data_egr_queuing_params_define_fqp_dbf_additional_latency].doc = "Value to configure the transmit scheduler (FQP scheduler) additional latency for halting Data Buffers pipe to be longer than MCDB.";
    
    submodule_data->defines[dnx_data_egr_queuing_params_define_fqp_dbf_additional_latency].flags |= DNXC_DATA_F_DEFINE;
...
dnx_data_egr_queuing_params_fqp_dbf_additional_latency_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_egr_queuing, dnx_data_egr_queuing_submodule_params, dnx_data_egr_queuing_params_define_fqp_dbf_additional_latency);
}
