    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_device_general_otmh_supported].name = "otmh_supported";
    submodule_data->features[dnx_data_device_general_otmh_supported].doc = "Marks presence of OTMH functionality";
    submodule_data->features[dnx_data_device_general_otmh_supported].flags |= DNXC_DATA_F_FEATURE;
