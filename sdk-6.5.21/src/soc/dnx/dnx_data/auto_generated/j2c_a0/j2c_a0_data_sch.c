...
static shr_error_e
j2c_a0_dnx_data_sch_general_port_priority_propagation_version_set(
    int unit)
{
...
static shr_error_e
j2c_a0_dnx_data_sch_se_quartet_offset_to_cl_num_set(
    int unit)
{
    ...
    int unit)
{
    ...
    define->set = j2c_a0_dnx_data_sch_general_port_priority_propagation_version_set;
    ...
    table->set = j2c_a0_dnx_data_sch_se_quartet_offset_to_cl_num_set;
