...
static shr_error_e
q2a_b0_dnx_data_aod_sizes_AOD_count_set(
    int unit)
{
...
static shr_error_e
q2a_b0_dnx_data_aod_sizes_AOD_sizes_set(
    int unit)
{
    int index_index;
    ...
    int unit)
{
    ...
    define->set = q2a_b0_dnx_data_aod_sizes_AOD_count_set;
    ...
    table->set = q2a_b0_dnx_data_aod_sizes_AOD_sizes_set;
