...
static shr_error_e
q2a_b1_dnx_data_l2_feature_opportunistic_learning_always_transplant_set(
    int unit)
{
    ...
    int unit)
{
    ...
    feature->set = q2a_b1_dnx_data_l2_feature_opportunistic_learning_always_transplant_set;
