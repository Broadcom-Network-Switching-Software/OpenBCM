    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_headers_ftmh_define_ase_oam_type_offset].doc = "ASE OAM Type offset in ASE header header";
    ...
    submodule_data->defines[dnx_data_headers_ftmh_define_ase_oam_offset_offset].doc = "ASE OAM Offset offset in ASE header header";
    ...
    submodule_data->defines[dnx_data_headers_ftmh_define_ase_oam_ts_data_offset].doc = "ASE OAM TS_Data(lower 32 bits) offset in ASE header header";
    ...
    submodule_data->defines[dnx_data_headers_ftmh_define_ase_oam_ts_data_upper_offset].doc = "ASE OAM TS_Data(upper 2 bits) offset in ASE header header";
    ...
    submodule_data->defines[dnx_data_headers_ftmh_define_ase_oam_mep_type_offset].doc = "ASE OAM MEP_Type offset in ASE header header";
    ...
    submodule_data->defines[dnx_data_headers_ftmh_define_ase_oam_sub_type_offset].doc = "ASE OAM Sub_Type offset in ASE header header";
    ...
    submodule_data->defines[dnx_data_headers_ftmh_define_ase_oam_type_bits].doc = "ASE OAM Type bits in ASE header header";
    ...
    submodule_data->defines[dnx_data_headers_ftmh_define_ase_oam_offset_bits].doc = "ASE OAM Offset bits in ASE header header";
    ...
    submodule_data->defines[dnx_data_headers_ftmh_define_ase_oam_ts_data_bits].doc = "ASE OAM TS_Data(lower 32 bits) bits in ASE header header";
    ...
    submodule_data->defines[dnx_data_headers_ftmh_define_ase_oam_ts_data_upper_bits].doc = "ASE OAM TS_Data(upper 2 bits) bits in ASE header header";
    ...
    submodule_data->defines[dnx_data_headers_ftmh_define_ase_oam_mep_type_bits].doc = "ASE OAM MEP_Type bits in ASE header header";
    ...
    submodule_data->defines[dnx_data_headers_ftmh_define_ase_oam_sub_type_bits].doc = "ASE OAM Sub_Type bits in ASE header header";
    ...
    submodule_data->defines[dnx_data_headers_ftmh_define_ase_type_offset].doc = "ASE Type offset in ASE header header";
    ...
    submodule_data->defines[dnx_data_headers_ftmh_define_ase_1588_offset_offset].doc = "ASE 1588 offset offset in ASE header header";
    ...
    submodule_data->defines[dnx_data_headers_ftmh_define_ase_1588_tp_command_offset].doc = "ASE 1588 TP_Command offset in ASE header header";
    ...
    submodule_data->defines[dnx_data_headers_ftmh_define_ase_1588_ts_encapsulation_offset].doc = "ASE 1588 TS_Encapsulation offset in ASE header header";
    ...
    submodule_data->defines[dnx_data_headers_ftmh_define_ase_type_bits].doc = "ASE Type bits in ASE header header";
    ...
    submodule_data->defines[dnx_data_headers_ftmh_define_ase_1588_offset_bits].doc = "ASE 1588 offset bits in ASE header header";
    ...
    submodule_data->defines[dnx_data_headers_ftmh_define_ase_1588_tp_command_bits].doc = "ASE 1588 TP_Command bits in ASE header header";
    ...
    submodule_data->defines[dnx_data_headers_ftmh_define_ase_1588_ts_encapsulation_bits].doc = "ASE 1588 TS_Encapsulation bits in ASE header header";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_headers_tsh_define_time_stamp_offset].doc = "TSH Time_Stamp offset in ASE header header";
    ...
    submodule_data->defines[dnx_data_headers_tsh_define_time_stamp_bits].doc = "TSH Time_Stamp bits in ASE header header";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_headers_otsh_legacy_define_latency_flow_id_offset].doc = "latency-flow-id offset in legacy OTSH";
    ...
    submodule_data->defines[dnx_data_headers_otsh_legacy_define_latency_flow_id_bits].doc = "latency-flow-id bits in legacy OTSH";
    ...
    submodule_data->defines[dnx_data_headers_otsh_legacy_define_latency_time_stamp_offset].doc = "latency-time-stamp offset in legacy OTSH";
    ...
    submodule_data->defines[dnx_data_headers_otsh_legacy_define_latency_time_stamp_bits].doc = "latency-time-stamp bits in legacy OTSH";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_headers_system_headers_define_jr_mode_pph_learn_extension_disable].doc = "global PPH learn extention mode";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_headers_feature_flow_id_ext_enable].doc = "If set, Flow_ID_Ext should be created when TSH is injected";
    ...
    submodule_data->defines[dnx_data_headers_feature_define_fhei_mpls_swap_remark_size].doc = "Size of remark_profile (and ttl model,encap qos model in q2a and above) mapped from mpls swap command";
