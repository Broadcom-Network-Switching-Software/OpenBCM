    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_oam_general_oam_mpls_ccm_support].name = "oam_mpls_ccm_support";
    submodule_data->features[dnx_data_oam_general_oam_mpls_ccm_support].doc = "Indicate if OAM MPLS CCM is supported";
    submodule_data->features[dnx_data_oam_general_oam_mpls_ccm_support].flags |= DNXC_DATA_F_FEATURE;
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_oam_oamp_define_nof_rmep_write_complete_checks].name = "nof_rmep_write_complete_checks";
    submodule_data->defines[dnx_data_oam_oamp_define_nof_rmep_write_complete_checks].doc = "Max number of time to checks RMEP write is done.  Checked every 100 usecs";
    
    submodule_data->defines[dnx_data_oam_oamp_define_nof_rmep_write_complete_checks].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_oam_oamp_nof_rmep_write_complete_checks_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_oam, dnx_data_oam_submodule_oamp, dnx_data_oam_oamp_define_nof_rmep_write_complete_checks);
}
