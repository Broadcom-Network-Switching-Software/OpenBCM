    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_instru_ifa_is_intermediate_node_supported].name = "is_intermediate_node_supported";
    submodule_data->features[dnx_data_instru_ifa_is_intermediate_node_supported].doc = "IFA intermediate_node is supported indication";
    submodule_data->features[dnx_data_instru_ifa_is_intermediate_node_supported].flags |= DNXC_DATA_F_FEATURE;
