    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_fabric_links_load_balancing_context_0_reserved_for_cpu_cells].name = "load_balancing_context_0_reserved_for_cpu_cells";
    submodule_data->features[dnx_data_fabric_links_load_balancing_context_0_reserved_for_cpu_cells].doc = "Indicates if context 0 is reserved for CPU cells.";
    submodule_data->features[dnx_data_fabric_links_load_balancing_context_0_reserved_for_cpu_cells].flags |= DNXC_DATA_F_FEATURE;
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_fabric_cgm_is_adaptive_shaper_watermarks_limited].doc = "Do watermarks only support ranges 100.1% to 200%";
