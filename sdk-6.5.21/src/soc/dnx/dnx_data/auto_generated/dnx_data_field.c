    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_field_context_define_default_itmh_pph_ipmf2_context].name = "default_itmh_pph_ipmf2_context";
    submodule_data->defines[dnx_data_field_context_define_default_itmh_pph_ipmf2_context].doc = "IPMF2 Context Id for ITMH_PPH Packets";
    
    submodule_data->defines[dnx_data_field_context_define_default_itmh_pph_ipmf2_context].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_field_context_default_itmh_pph_ipmf2_context_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_context, dnx_data_field_context_define_default_itmh_pph_ipmf2_context);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_field_preselector_define_default_itmh_pph_presel_id_ipmf2].name = "default_itmh_pph_presel_id_ipmf2";
    submodule_data->defines[dnx_data_field_preselector_define_default_itmh_pph_presel_id_ipmf2].doc = "Default Presel Id in iPMF2 for ITMHoPPH injected Packets";
    
    submodule_data->defines[dnx_data_field_preselector_define_default_itmh_pph_presel_id_ipmf2].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->defines[dnx_data_field_preselector_define_default_itmh_1588_tsh_presel_id_ipmf1].doc = "Default Presel Id in iPMF1 for ITMHoASE-1588v2oTSH injected Packets";
    ...
    submodule_data->defines[dnx_data_field_preselector_define_srv6_beyond_minus_fwd_layer_presel_id_ipmf1].name = "srv6_beyond_minus_fwd_layer_presel_id_ipmf1";
    submodule_data->defines[dnx_data_field_preselector_define_srv6_beyond_minus_fwd_layer_presel_id_ipmf1].doc = "Default Presel in iPMF1 Id for srv6 beyond_minus_fwd_layer";
    
    submodule_data->defines[dnx_data_field_preselector_define_srv6_beyond_minus_fwd_layer_presel_id_ipmf1].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_field_preselector_define_srv6_beyond_minus_2_with_mpls_fwd_layer_presel_id_ipmf1].name = "srv6_beyond_minus_2_with_mpls_fwd_layer_presel_id_ipmf1";
    submodule_data->defines[dnx_data_field_preselector_define_srv6_beyond_minus_2_with_mpls_fwd_layer_presel_id_ipmf1].doc = "Default Presel in iPMF1 Id for srv6 beyond_minus_2_with_mpls_fwd_layer";
    
    submodule_data->defines[dnx_data_field_preselector_define_srv6_beyond_minus_2_with_mpls_fwd_layer_presel_id_ipmf1].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->defines[dnx_data_field_preselector_define_srv6_classic_endpoint_presel_id_ipmf1].name = "srv6_classic_endpoint_presel_id_ipmf1";
    submodule_data->defines[dnx_data_field_preselector_define_srv6_classic_endpoint_presel_id_ipmf1].doc = "Default Presel in iPMF1 Id for classic_endpoint";
    
    submodule_data->defines[dnx_data_field_preselector_define_srv6_classic_endpoint_presel_id_ipmf1].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->defines[dnx_data_field_preselector_define_srv6_egress_usp_presel_id_ipmf1].doc = "Default Presel in iPMF1 Id for egress_usp";
    ...
    submodule_data->defines[dnx_data_field_preselector_define_srv6_classic_endpoint_presel_id_ipmf3].name = "srv6_classic_endpoint_presel_id_ipmf3";
    submodule_data->defines[dnx_data_field_preselector_define_srv6_classic_endpoint_presel_id_ipmf3].doc = "Default Presel in iPMF3 Id for classic_endpoint";
    
    submodule_data->defines[dnx_data_field_preselector_define_srv6_classic_endpoint_presel_id_ipmf3].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->defines[dnx_data_field_preselector_define_srv6_endpoint_psp_bta_presel_id_epmf].doc = "Default Presel in iPMF3 Id for endpoint_psp_bta";
...
uint32
dnx_data_field_preselector_default_itmh_pph_presel_id_ipmf2_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_preselector, dnx_data_field_preselector_define_default_itmh_pph_presel_id_ipmf2);
}
...
uint32
dnx_data_field_preselector_srv6_beyond_minus_fwd_layer_presel_id_ipmf1_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_preselector, dnx_data_field_preselector_define_srv6_beyond_minus_fwd_layer_presel_id_ipmf1);
}

uint32
dnx_data_field_preselector_srv6_beyond_minus_2_with_mpls_fwd_layer_presel_id_ipmf1_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_preselector, dnx_data_field_preselector_define_srv6_beyond_minus_2_with_mpls_fwd_layer_presel_id_ipmf1);
}
...
uint32
dnx_data_field_preselector_srv6_classic_endpoint_presel_id_ipmf1_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_preselector, dnx_data_field_preselector_define_srv6_classic_endpoint_presel_id_ipmf1);
}
...
uint32
dnx_data_field_preselector_srv6_classic_endpoint_presel_id_ipmf3_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_preselector, dnx_data_field_preselector_define_srv6_classic_endpoint_presel_id_ipmf3);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_field_map_define_pmf_map_stage].name = "pmf_map_stage";
    submodule_data->defines[dnx_data_field_map_define_pmf_map_stage].doc = "Determines using SOC property if we use MAP in iPMF1/iPMF2 or iPMF3.";
    
    submodule_data->defines[dnx_data_field_map_define_pmf_map_stage].flags |= DNXC_DATA_F_NUMERIC;
...
uint32
dnx_data_field_map_pmf_map_stage_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_map, dnx_data_field_map_define_pmf_map_stage);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_field_general_data_qualifiers_define_ac_in_lif_wide_data_start_bit].name = "ac_in_lif_wide_data_start_bit";
    submodule_data->defines[dnx_data_field_general_data_qualifiers_define_ac_in_lif_wide_data_start_bit].doc = "First bit on general_data for DBAL_FIELD_AC_IN_LIF_WIDE_DATA";
    
    submodule_data->defines[dnx_data_field_general_data_qualifiers_define_ac_in_lif_wide_data_start_bit].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->defines[dnx_data_field_general_data_qualifiers_define_pwe_in_lif_wide_data_start_bit].name = "pwe_in_lif_wide_data_start_bit";
    submodule_data->defines[dnx_data_field_general_data_qualifiers_define_pwe_in_lif_wide_data_start_bit].doc = "First bit on general_data for DBAL_FIELD_PWE_IN_LIF_WIDE_DATA";
    
    submodule_data->defines[dnx_data_field_general_data_qualifiers_define_pwe_in_lif_wide_data_start_bit].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->defines[dnx_data_field_general_data_qualifiers_define_native_ac_in_lif_wide_data_start_bit].name = "native_ac_in_lif_wide_data_start_bit";
    submodule_data->defines[dnx_data_field_general_data_qualifiers_define_native_ac_in_lif_wide_data_start_bit].doc = "First bit on general_data for DBAL_FIELD_NATIVE_AC_IN_LIF_WIDE_DATA";
    
    submodule_data->defines[dnx_data_field_general_data_qualifiers_define_native_ac_in_lif_wide_data_start_bit].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->defines[dnx_data_field_general_data_qualifiers_define_ac_in_lif_wide_data_extended_start_bit].name = "ac_in_lif_wide_data_extended_start_bit";
    submodule_data->defines[dnx_data_field_general_data_qualifiers_define_ac_in_lif_wide_data_extended_start_bit].doc = "First bit on general_data for DBAL_FIELD_AC_IN_LIF_WIDE_DATA_EXTENDED";
    
    submodule_data->defines[dnx_data_field_general_data_qualifiers_define_ac_in_lif_wide_data_extended_start_bit].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->defines[dnx_data_field_general_data_qualifiers_define_mact_entry_grouping_start_bit].name = "mact_entry_grouping_start_bit";
    submodule_data->defines[dnx_data_field_general_data_qualifiers_define_mact_entry_grouping_start_bit].doc = "First bit on general_data for DBAL_FIELD_MACT_ENTRY_GROUPING";
    
    submodule_data->defines[dnx_data_field_general_data_qualifiers_define_mact_entry_grouping_start_bit].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->defines[dnx_data_field_general_data_qualifiers_define_vw_vip_valid_start_bit].name = "vw_vip_valid_start_bit";
    submodule_data->defines[dnx_data_field_general_data_qualifiers_define_vw_vip_valid_start_bit].doc = "First bit on general_data for DBAL_FIELD_VW_VIP_VALID";
    
    submodule_data->defines[dnx_data_field_general_data_qualifiers_define_vw_vip_valid_start_bit].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->defines[dnx_data_field_general_data_qualifiers_define_vw_vip_id_start_bit].name = "vw_vip_id_start_bit";
    submodule_data->defines[dnx_data_field_general_data_qualifiers_define_vw_vip_id_start_bit].doc = "First bit on general_data for DBAL_FIELD_VW_VIP_ID";
    
    submodule_data->defines[dnx_data_field_general_data_qualifiers_define_vw_vip_id_start_bit].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->defines[dnx_data_field_general_data_qualifiers_define_vw_member_reference_start_bit].name = "vw_member_reference_start_bit";
    submodule_data->defines[dnx_data_field_general_data_qualifiers_define_vw_member_reference_start_bit].doc = "First bit on general_data for DBAL_FIELD_VW_MEMBER_REFERENCE";
    
    submodule_data->defines[dnx_data_field_general_data_qualifiers_define_vw_member_reference_start_bit].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->defines[dnx_data_field_general_data_qualifiers_define_vw_pcc_hit_start_bit].name = "vw_pcc_hit_start_bit";
    submodule_data->defines[dnx_data_field_general_data_qualifiers_define_vw_pcc_hit_start_bit].doc = "First bit on general_data for DBAL_FIELD_VW_PCC_HIT";
    
    submodule_data->defines[dnx_data_field_general_data_qualifiers_define_vw_pcc_hit_start_bit].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_field_general_data_qualifiers_ac_in_lif_wide_data_start_bit_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_general_data_qualifiers, dnx_data_field_general_data_qualifiers_define_ac_in_lif_wide_data_start_bit);
}
...
uint32
dnx_data_field_general_data_qualifiers_pwe_in_lif_wide_data_start_bit_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_general_data_qualifiers, dnx_data_field_general_data_qualifiers_define_pwe_in_lif_wide_data_start_bit);
}
...
uint32
dnx_data_field_general_data_qualifiers_native_ac_in_lif_wide_data_start_bit_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_general_data_qualifiers, dnx_data_field_general_data_qualifiers_define_native_ac_in_lif_wide_data_start_bit);
}
...
uint32
dnx_data_field_general_data_qualifiers_ac_in_lif_wide_data_extended_start_bit_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_general_data_qualifiers, dnx_data_field_general_data_qualifiers_define_ac_in_lif_wide_data_extended_start_bit);
}
...
uint32
dnx_data_field_general_data_qualifiers_mact_entry_grouping_start_bit_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_general_data_qualifiers, dnx_data_field_general_data_qualifiers_define_mact_entry_grouping_start_bit);
}
...
uint32
dnx_data_field_general_data_qualifiers_vw_vip_valid_start_bit_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_general_data_qualifiers, dnx_data_field_general_data_qualifiers_define_vw_vip_valid_start_bit);
}
...
uint32
dnx_data_field_general_data_qualifiers_vw_vip_id_start_bit_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_general_data_qualifiers, dnx_data_field_general_data_qualifiers_define_vw_vip_id_start_bit);
}
...
uint32
dnx_data_field_general_data_qualifiers_vw_member_reference_start_bit_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_general_data_qualifiers, dnx_data_field_general_data_qualifiers_define_vw_member_reference_start_bit);
}
...
uint32
dnx_data_field_general_data_qualifiers_vw_pcc_hit_start_bit_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_general_data_qualifiers, dnx_data_field_general_data_qualifiers_define_vw_pcc_hit_start_bit);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_field_features_define_epmf_outlif_profile_map].doc = "Indicates whether ePMF CS outlif profile map table should be init";
