...
static shr_error_e
q2a_a0_dnx_data_aod_sizes_AOD_count_set(
    int unit)
{
...
static shr_error_e
q2a_a0_dnx_data_aod_sizes_AOD_sizes_set(
    int unit)
{
    int index_index;
    ...
    {
        data = (dnx_data_aod_sizes_AOD_sizes_t *) dnxc_data_mgmt_table_data_get(unit, table, 340, 0);
        data->value = 0;
    }
    if (341 < table->keys[0].size)
    {
        data = (dnx_data_aod_sizes_AOD_sizes_t *) dnxc_data_mgmt_table_data_get(unit, table, 341, 0);
        data->value = 1;
    }
    if (342 < table->keys[0].size)
    {
        data = (dnx_data_aod_sizes_AOD_sizes_t *) dnxc_data_mgmt_table_data_get(unit, table, 342, 0);
        data->value = 61;
    }
    ...
    {
        data = (dnx_data_aod_sizes_AOD_sizes_t *) dnxc_data_mgmt_table_data_get(unit, table, 345, 0);
        data->value = 2;
    }
    if (346 < table->keys[0].size)
    {
        data = (dnx_data_aod_sizes_AOD_sizes_t *) dnxc_data_mgmt_table_data_get(unit, table, 346, 0);
        data->value = 2;
    }
    if (347 < table->keys[0].size)
    {
        data = (dnx_data_aod_sizes_AOD_sizes_t *) dnxc_data_mgmt_table_data_get(unit, table, 347, 0);
        data->value = 2;
    }
    ...
    {
        data = (dnx_data_aod_sizes_AOD_sizes_t *) dnxc_data_mgmt_table_data_get(unit, table, 352, 0);
        data->value = 1;
    }
    if (353 < table->keys[0].size)
    {
        data = (dnx_data_aod_sizes_AOD_sizes_t *) dnxc_data_mgmt_table_data_get(unit, table, 353, 0);
        data->value = 1;
    }
    if (354 < table->keys[0].size)
    {
        data = (dnx_data_aod_sizes_AOD_sizes_t *) dnxc_data_mgmt_table_data_get(unit, table, 354, 0);
        data->value = 1;
    }
    ...
    int unit)
{
    ...
    define->set = q2a_a0_dnx_data_aod_sizes_AOD_count_set;
    ...
    table->set = q2a_a0_dnx_data_aod_sizes_AOD_sizes_set;
