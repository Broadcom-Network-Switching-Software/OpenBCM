...
CONST dbal_action_info_t dbal_actions_info[DBAL_NOF_ACTIONS] = {
    ...
    {"COMMIT", PRE_ACCESS_PRINTS_ENABLED,
     ALL_KEY_FIELDS_MUST_EXIST | RESULT_FIELD_MUST_BE_SET | VALIDATE_ALLOCATOR_FIELD,
     COMMON_LEGAL_FLAGS | DBAL_COMMIT_OVERRIDE_DEFAULT | DBAL_COMMIT_OVERRUN | DBAL_COMMIT_HW_ONLY}
    ,

    {"COMMIT UPDATE", PRE_ACCESS_PRINTS_ENABLED,
     ALL_KEY_FIELDS_MUST_EXIST | RESULT_FIELD_MUST_BE_SET | VALIDATE_ALLOCATOR_FIELD,
     COMMON_LEGAL_FLAGS | DBAL_COMMIT_UPDATE | DBAL_COMMIT_OVERRIDE_DEFAULT | DBAL_COMMIT_HW_ONLY}
    ,

    {"COMMIT FORCE", PRE_ACCESS_PRINTS_ENABLED,
     ALL_KEY_FIELDS_MUST_EXIST | RESULT_FIELD_MUST_BE_SET | VALIDATE_ALLOCATOR_FIELD,
     COMMON_LEGAL_FLAGS | DBAL_COMMIT_FORCE | DBAL_COMMIT_OVERRIDE_DEFAULT | DBAL_COMMIT_HW_ONLY}
    ,

    {"COMMIT RANGE", PRE_ACCESS_PRINTS_ENABLED,
     ALL_KEY_FIELDS_MUST_EXIST | RESULT_FIELD_MUST_BE_SET | VALIDATE_ALLOCATOR_FIELD,
     COMMON_LEGAL_FLAGS | DBAL_COMMIT_OVERRUN}
    ,

    {"GET", POST_ACCESS_PRINTS_ENABLED,
     ALL_KEY_FIELDS_MUST_EXIST | RESULT_FIELD_MUST_BE_SET | VALIDATE_ALLOCATOR_FIELD |
     CORE_ID_MUST_BE_SET_TO_ONE_CORE_ONLY, COMMON_LEGAL_FLAGS | DBAL_COMMIT_VALIDATE_OTHER_CORE | DBAL_COMMIT_HW_ONLY}
    ,

    {"GET ALL FIELDS", POST_ACCESS_PRINTS_ENABLED,
     ALL_KEY_FIELDS_MUST_EXIST | VALIDATE_ALLOCATOR_FIELD | CORE_ID_MUST_BE_SET_TO_ONE_CORE_ONLY,
     COMMON_LEGAL_FLAGS | DBAL_GET_ALL_FIELDS | DBAL_COMMIT_HW_ONLY}
    ,

    {"GET ACCESS ID BY KEY", POST_ACCESS_PRINTS_ENABLED,
     ALL_KEY_FIELDS_MUST_EXIST | VALIDATE_ALLOCATOR_FIELD | CORE_ID_MUST_BE_SET_TO_ONE_CORE_ONLY, COMMON_LEGAL_FLAGS}
    ,

    {"ITERATOR GET", POST_ACCESS_PRINTS_ENABLED, ALL_KEY_FIELDS_MUST_EXIST | VALIDATE_ALLOCATOR_FIELD,
     COMMON_LEGAL_FLAGS}
    ,
...
static shr_error_e dbal_actions_access_commit_consecutive_range(
    int unit,
    dbal_entry_handle_t * entry_handle,
    int num_of_entries);

static shr_error_e dbal_actions_access_clear_consecutive_range(
    int unit,
    dbal_entry_handle_t * entry_handle,
    int num_of_entries);
