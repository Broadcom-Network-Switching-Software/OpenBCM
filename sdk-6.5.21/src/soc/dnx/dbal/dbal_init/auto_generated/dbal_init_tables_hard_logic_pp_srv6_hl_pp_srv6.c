...
dbal_logical_table_t * table_info)
{
    ...
    
    {
        ...
        
        {
            ...
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_mandatory_values(unit, DBAL_FIELD_SRV6_EXTENSION_HEADER_TYPE , DBAL_FIELD_TYPE_DEF_IPV6_EXTENSION_HEADER_TYPE , dbal_db_field));
