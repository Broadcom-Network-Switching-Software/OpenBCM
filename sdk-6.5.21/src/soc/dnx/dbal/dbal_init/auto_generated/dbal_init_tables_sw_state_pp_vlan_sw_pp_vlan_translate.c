...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_IVEC_ACTION_ID_SW_INFO , is_valid , "IVEC_ACTION_ID_SW_INFO" , DBAL_ACCESS_METHOD_SW_STATE ));
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_EVEC_FRWRD_STAGE_ACTION_ID_INFO_SW , is_valid , "EVEC_FRWRD_STAGE_ACTION_ID_INFO_SW" , DBAL_ACCESS_METHOD_SW_STATE ));
    ...
    
    {
        ...
        dbal_table_field_info_t * dbal_db_field;
        table_db_field_params_struct_t db_field;
        SHR_ALLOC_SET_ZERO(table_entry->keys_info, 1 * sizeof(dbal_table_field_info_t), "key fields info allocation", "%s%s%s\r\n", "EVEC_FRWRD_STAGE_ACTION_ID_INFO_SW" , EMPTY, EMPTY);
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_TAG_STRUCT_INGRESS_HW_ID_TO_SW_ID , is_valid , "TAG_STRUCT_INGRESS_HW_ID_TO_SW_ID" , DBAL_ACCESS_METHOD_SW_STATE ));
    ...
    
    {
        ...
        dbal_table_field_info_t * dbal_db_field;
        table_db_field_params_struct_t db_field;
        SHR_ALLOC_SET_ZERO(table_entry->keys_info, 1 * sizeof(dbal_table_field_info_t), "key fields info allocation", "%s%s%s\r\n", "TAG_STRUCT_INGRESS_HW_ID_TO_SW_ID" , EMPTY, EMPTY);
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_TAG_STRUCT_EGRESS_HW_ID_TO_SW_ID , is_valid , "TAG_STRUCT_EGRESS_HW_ID_TO_SW_ID" , DBAL_ACCESS_METHOD_SW_STATE ));
    ...
    
    {
        ...
        dbal_table_field_info_t * dbal_db_field;
        table_db_field_params_struct_t db_field;
        SHR_ALLOC_SET_ZERO(table_entry->keys_info, 1 * sizeof(dbal_table_field_info_t), "key fields info allocation", "%s%s%s\r\n", "TAG_STRUCT_EGRESS_HW_ID_TO_SW_ID" , EMPTY, EMPTY);
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_TAG_STRUCT_INGRESS_SW_ID_TO_HW_ID , is_valid , "TAG_STRUCT_INGRESS_SW_ID_TO_HW_ID" , DBAL_ACCESS_METHOD_SW_STATE ));
    ...
    
    {
        ...
        dbal_table_field_info_t * dbal_db_field;
        table_db_field_params_struct_t db_field;
        SHR_ALLOC_SET_ZERO(table_entry->keys_info, 1 * sizeof(dbal_table_field_info_t), "key fields info allocation", "%s%s%s\r\n", "TAG_STRUCT_INGRESS_SW_ID_TO_HW_ID" , EMPTY, EMPTY);
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_TAG_STRUCT_EGRESS_SW_ID_TO_HW_ID , is_valid , "TAG_STRUCT_EGRESS_SW_ID_TO_HW_ID" , DBAL_ACCESS_METHOD_SW_STATE ));
    ...
    
    {
        ...
        dbal_table_field_info_t * dbal_db_field;
        table_db_field_params_struct_t db_field;
        SHR_ALLOC_SET_ZERO(table_entry->keys_info, 1 * sizeof(dbal_table_field_info_t), "key fields info allocation", "%s%s%s\r\n", "TAG_STRUCT_EGRESS_SW_ID_TO_HW_ID" , EMPTY, EMPTY);
