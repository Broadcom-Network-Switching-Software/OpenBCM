...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    cur_field_types_info->nof_struct_fields = 160;
    ...
    cur_field_types_info->struct_field_info[140].struct_field_id = DBAL_FIELD_PMF_IN_LIF_PROFILE;
    cur_field_types_info->struct_field_info[141].struct_field_id = DBAL_FIELD_PMF_ETH_RIF_PROFILE;
    cur_field_types_info->struct_field_info[141].length = dnx_data_field.profile_bits.nof_ing_eth_rif_get(unit);
    cur_field_types_info->struct_field_info[142].struct_field_id = DBAL_FIELD_UNKNOWN_ADDRESS;
    cur_field_types_info->struct_field_info[142].length = 1;
    cur_field_types_info->struct_field_info[143].struct_field_id = DBAL_FIELD_LEARN_SRC_MAC;
    cur_field_types_info->struct_field_info[144].struct_field_id = DBAL_FIELD_LEARN_VLAN;
    cur_field_types_info->struct_field_info[145].struct_field_id = DBAL_FIELD_LEARN_VSI;
    cur_field_types_info->struct_field_info[145].length = 18;
    cur_field_types_info->struct_field_info[146].struct_field_id = DBAL_FIELD_LEARN_DATA;
    cur_field_types_info->struct_field_info[146].length = 64;
    cur_field_types_info->struct_field_info[147].struct_field_id = DBAL_FIELD_LEARN_STATION_MOVE;
    cur_field_types_info->struct_field_info[148].struct_field_id = DBAL_FIELD_LEARN_MATCH;
    cur_field_types_info->struct_field_info[149].struct_field_id = DBAL_FIELD_LEARN_FOUND;
    cur_field_types_info->struct_field_info[150].struct_field_id = DBAL_FIELD_LEARN_EXPECTED_WON;
    cur_field_types_info->struct_field_info[151].struct_field_id = DBAL_FIELD_VRF_VALUE;
    cur_field_types_info->struct_field_info[152].struct_field_id = DBAL_FIELD_PP_PORT;
    cur_field_types_info->struct_field_info[153].struct_field_id = DBAL_FIELD_CORE;
    cur_field_types_info->struct_field_info[154].struct_field_id = DBAL_FIELD_VW_VIP_VALID;
    cur_field_types_info->struct_field_info[155].struct_field_id = DBAL_FIELD_VW_VIP_ID;
    cur_field_types_info->struct_field_info[156].struct_field_id = DBAL_FIELD_VW_MEMBER_REFERENCE;
    cur_field_types_info->struct_field_info[157].struct_field_id = DBAL_FIELD_VW_PCC_HIT;
    cur_field_types_info->struct_field_info[158].struct_field_id = DBAL_FIELD_AC_IN_LIF_WIDE_DATA_EXTENDED;
    cur_field_types_info->struct_field_info[159].struct_field_id = DBAL_FIELD_MACT_ENTRY_GROUPING;
    cur_field_types_info->struct_field_info[159].length = dnx_data_field.general_data_qualifiers.mact_entry_grouping_nof_bits_get(unit);
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    cur_field_types_info->struct_field_info[113].length = dnx_data_field.profile_bits.nof_ing_eth_rif_get(unit);
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    cur_field_types_info->struct_field_info[124].length = dnx_data_field.profile_bits.nof_ing_eth_rif_get(unit);
    ...
    cur_field_types_info->struct_field_info[133].length = dnx_data_field.general_data_qualifiers.mact_entry_grouping_nof_bits_get(unit);
