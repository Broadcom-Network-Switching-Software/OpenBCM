...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_BDB_ERRORS_COUNTER , is_valid , "BDB_ERRORS_COUNTER" , DBAL_ACCESS_METHOD_SW_STATE ));
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_DELETED_BDB_COUNTER , is_valid , "DELETED_BDB_COUNTER" , DBAL_ACCESS_METHOD_SW_STATE ));
