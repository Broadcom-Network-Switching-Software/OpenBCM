...
dbal_logical_table_t * table_info)
{
    ...
    
    {
        ...
        field_index = 0;
        DBAL_DB_INIT_TABLE_NOF_RESULT_FIELDS_SET(table_entry, (table_entry->multi_res_info[result_type_counter]), 1 + (((dnx_data_mdb_app_db.fields.numeric_mdb_field___1___valid_get(unit))>0)?1:0));
        DBAL_DB_INIT_TABLE_INTERFACE_RESULT_FIELDS_ALLOC(table_entry, table_entry->multi_res_info[result_type_counter]);
        
        if (dnx_data_mdb_app_db.fields.numeric_mdb_field___1___valid_get(unit) != 0)
        {
            dbal_db_field = &table_entry->multi_res_info[result_type_counter].results_info[field_index];
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_mandatory_values(unit, DBAL_FIELD_RESULT_TYPE , DBAL_FIELD_TYPE_DEF_RESULT_TYPE , dbal_db_field));
            dbal_db_init_table_field_params_init(&db_field);
            db_field.valid = dnx_data_mdb_app_db.fields.numeric_mdb_field___1___valid_get(unit);
        ...
        field_index = 0;
        DBAL_DB_INIT_TABLE_NOF_RESULT_FIELDS_SET(table_entry, (table_entry->multi_res_info[result_type_counter]), 1 + (((dnx_data_mdb_app_db.fields.numeric_mdb_field___5___valid_get(unit))>0)?1:0));
        DBAL_DB_INIT_TABLE_INTERFACE_RESULT_FIELDS_ALLOC(table_entry, table_entry->multi_res_info[result_type_counter]);
        ...
        }
        {
            ...
            dbal_db_init_table_field_params_init(&db_field);
            db_field.size = 1;
            dbal_db_init_table_set_field_arr_prefix(unit, &db_field, dnx_data_arr.prefix.ETPP_ETPS_FORMATS___prefix_4_get(unit) , 8 );
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_optional_or_default_values(unit, table_entry, dbal_db_field, &db_field, FALSE));
            field_index += dbal_db_field->nof_instances;
        }
            ...
            
            {
                ...
                
                {
                    ...
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HW_ENTITY_GROUP_EMPTY , regMemHwEntityId , fieldHwEntityId , INVALIDm ));
                    {
                        ...
                        if (dnx_data_mdb_app_db.fields.numeric_mdb_field___0___valid_get(unit))
                        {
                            
                            result_size__result_type += dnx_data_mdb_app_db.fields.numeric_mdb_field___0_get(unit);
                        }
            ...
            
            {
                ...
                
                {
                    ...
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HW_ENTITY_GROUP_EMPTY , regMemHwEntityId , fieldHwEntityId , INVALIDm ));
                    {
                        ...
                        uint32 result_size__result_type = 0;
                        if (dnx_data_mdb_app_db.fields.numeric_mdb_field___1___valid_get(unit))
                        {
                            
                            result_size__result_type += dnx_data_mdb_app_db.fields.numeric_mdb_field___1_get(unit);
                        }
                        access_params->data_offset.formula_int = 60-result_size__result_type; 
                    }
                }
            ...
            
            {
                ...
                
                {
                    ...
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HW_ENTITY_GROUP_EMPTY , regMemHwEntityId , fieldHwEntityId , INVALIDm ));
                    {
                        ...
                        uint32 result_size__result_type = 0;
                        if (dnx_data_mdb_app_db.fields.numeric_mdb_field___5___valid_get(unit))
                        {
                            
                            result_size__result_type += dnx_data_mdb_app_db.fields.numeric_mdb_field___5_get(unit);
                        }
                        access_params->data_offset.formula_int = 60-result_size__result_type; 
                    }
                }
...
dbal_logical_table_t * table_info)
{
    ...
    
    {
        ...
        field_index = 0;
        DBAL_DB_INIT_TABLE_NOF_RESULT_FIELDS_SET(table_entry, (table_entry->multi_res_info[result_type_counter]), 13 + (((dnx_data_mdb_app_db.fields.numeric_mdb_field___2___valid_get(unit))>0)?1:0));
        DBAL_DB_INIT_TABLE_INTERFACE_RESULT_FIELDS_ALLOC(table_entry, table_entry->multi_res_info[result_type_counter]);
        ...
        }
        {
            ...
            dbal_db_init_table_field_params_init(&db_field);
            db_field.size = 1;
            dbal_db_init_table_set_field_arr_prefix(unit, &db_field, dnx_data_arr.prefix.ETPP_ETPS_FORMATS___prefix_14_get(unit) , 8 );
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_optional_or_default_values(unit, table_entry, dbal_db_field, &db_field, FALSE));
            field_index += dbal_db_field->nof_instances;
        }
        {
        ...
        }
        {
            ...
            dbal_db_init_table_field_params_init(&db_field);
            db_field.size = 3;
            dbal_db_init_table_set_field_arr_prefix(unit, &db_field, dnx_data_arr.prefix.ETPP_ETPS_FORMATS___prefix_5_get(unit) , 8 );
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_optional_or_default_values(unit, table_entry, dbal_db_field, &db_field, FALSE));
            field_index += dbal_db_field->nof_instances;
        }
        {
