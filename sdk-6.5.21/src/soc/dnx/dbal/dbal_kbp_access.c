    ...
    dbal_entry_handle_t * entry_handle)
{
    kbp_ad_db_t_p ad_db_p = NULL;
    kbp_db_handles_t *kbp_handles = NULL;
    int is_global_cache_enabled = FALSE;
    int is_db_cache_enabled = FALSE;
    ...
    SHR_IF_ERR_EXIT(dnx_kbp_caching_enabled_get(unit, FALSE, &is_global_cache_enabled));
    SHR_IF_ERR_EXIT(KBP_ACCESS.db_handles_info.caching_enabled.get(unit, entry_handle->table->app_id,
                                                                   &is_db_cache_enabled));
    if (is_global_cache_enabled || is_db_cache_enabled)
    {
    ...
    uint32 *payload_size)
{
    ...
    if (entry_info.active == 0)
    {
        ...
        if (entry_handle->attribute_info[DBAL_ENTRY_ATTR_RES_CACHED] != NULL)
        {
            ...
            *(entry_handle->attribute_info[DBAL_ENTRY_ATTR_RES_CACHED]) = TRUE;
        }
        else
        {
    ...
    else
    {
        ...
        if (entry_handle->attribute_info[DBAL_ENTRY_ATTR_RES_CACHED] != NULL)
        {
            ...
            *(entry_handle->attribute_info[DBAL_ENTRY_ATTR_RES_CACHED]) = FALSE;
        }
    }
    ...
    dbal_entry_handle_t * entry_handle)
{
    ...
    if (add_entry)
    {
        ...
        SHR_IF_ERR_EXIT(dnx_kbp_caching_enabled_get
                        (unit, !DBAL_ACTIONS_IS_TCAM_BY_KEY(entry_handle->table), &is_global_cache_enabled));
        SHR_IF_ERR_EXIT(KBP_ACCESS.db_handles_info.caching_enabled.get(unit, entry_handle->table->app_id,
                                                                       &is_db_cache_enabled));
