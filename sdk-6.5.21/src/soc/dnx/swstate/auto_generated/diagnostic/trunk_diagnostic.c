...
trunk_db_psc_general_info_profile_info_psc_profile_type_dump(int  unit,  int  profile_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, TRUNK_MODULE_ID, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->psc_general_info.profile_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, TRUNK_MODULE_ID, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->psc_general_info.profile_info) == 0)
        {
            SHR_EXIT();
        }
