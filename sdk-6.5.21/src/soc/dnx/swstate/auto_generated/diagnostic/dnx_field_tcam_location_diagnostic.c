...
dnx_field_tcam_location_sw_priorities_range_dump(int  unit,  int  priorities_range_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_FIELD_TCAM_LOCATION_MODULE_ID, ((dnx_field_tcam_location_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_LOCATION_MODULE_ID])->priorities_range))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_FIELD_TCAM_LOCATION_MODULE_ID, ((dnx_field_tcam_location_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_LOCATION_MODULE_ID])->priorities_range) == 0)
        {
            SHR_EXIT();
        }
...
dnx_field_tcam_location_sw_tcam_handlers_info_prio_list_first_iter_dump(int  unit,  int  tcam_handlers_info_idx_0,  int  prio_list_first_iter_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_FIELD_TCAM_LOCATION_MODULE_ID, ((dnx_field_tcam_location_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_LOCATION_MODULE_ID])->tcam_handlers_info[i0].prio_list_first_iter))
            {
                LOG_CLI((BSL_META("dnx_field_tcam_location_sw[]->((dnx_field_tcam_location_sw_t*)sw_state_roots_array[][DNX_FIELD_TCAM_LOCATION_MODULE_ID])->tcam_handlers_info[].prio_list_first_iter[]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_FIELD_TCAM_LOCATION_MODULE_ID, ((dnx_field_tcam_location_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_LOCATION_MODULE_ID])->tcam_handlers_info[i0].prio_list_first_iter) == 0)
            {
                SHR_EXIT();
            }
...
dnx_field_tcam_location_sw_tcam_handlers_info_prio_list_last_iter_dump(int  unit,  int  tcam_handlers_info_idx_0,  int  prio_list_last_iter_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_FIELD_TCAM_LOCATION_MODULE_ID, ((dnx_field_tcam_location_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_LOCATION_MODULE_ID])->tcam_handlers_info[i0].prio_list_last_iter))
            {
                LOG_CLI((BSL_META("dnx_field_tcam_location_sw[]->((dnx_field_tcam_location_sw_t*)sw_state_roots_array[][DNX_FIELD_TCAM_LOCATION_MODULE_ID])->tcam_handlers_info[].prio_list_last_iter[]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_FIELD_TCAM_LOCATION_MODULE_ID, ((dnx_field_tcam_location_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_LOCATION_MODULE_ID])->tcam_handlers_info[i0].prio_list_last_iter) == 0)
            {
                SHR_EXIT();
            }
