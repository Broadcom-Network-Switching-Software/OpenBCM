...
int
dnx_field_group_sw_fg_info_context_info_key_id_lsb_set(int unit, uint32 fg_info_idx_0, uint32 context_info_idx_0, uint32 lsb_idx_0, uint8 lsb)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_SET(
        unit,
        DNX_FIELD_GROUP_MODULE_ID,
        ((dnx_field_group_sw_t*)sw_state_roots_array[unit][DNX_FIELD_GROUP_MODULE_ID])->fg_info[fg_info_idx_0].context_info[context_info_idx_0].key_id.lsb[lsb_idx_0],
        lsb,
        uint8,
        0,
        "dnx_field_group_sw_fg_info_context_info_key_id_lsb_set");
    ...
    DNX_SW_STATE_LOG(
        ...
        DNX_FIELD_GROUP_MODULE_ID,
        &lsb,
        "dnx_field_group_sw[%d]->fg_info[%d].context_info[%d].key_id.lsb[%d]",
        unit, fg_info_idx_0, context_info_idx_0, lsb_idx_0);
...
int
dnx_field_group_sw_fg_info_context_info_key_id_lsb_get(int unit, uint32 fg_info_idx_0, uint32 context_info_idx_0, uint32 lsb_idx_0, uint8 *lsb)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    *lsb = ((dnx_field_group_sw_t*)sw_state_roots_array[unit][DNX_FIELD_GROUP_MODULE_ID])->fg_info[fg_info_idx_0].context_info[context_info_idx_0].key_id.lsb[lsb_idx_0];
    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_GET_LOGGING,
        BSL_LS_SWSTATEDNX_GET,
		...
		,
			...
			,
				...
				,
					...
					dnx_field_group_sw_fg_info_context_info_key_id_lsb_set,
					dnx_field_group_sw_fg_info_context_info_key_id_lsb_get}
				,
					{
