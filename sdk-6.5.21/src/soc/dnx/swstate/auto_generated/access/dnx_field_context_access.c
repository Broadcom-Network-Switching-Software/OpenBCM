...
int
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_key_info_key_id_lsb_set(int unit, uint32 context_info_idx_0, uint32 key_info_idx_0, uint32 lsb_idx_0, uint8 lsb)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_SET(
        unit,
        DNX_FIELD_CONTEXT_MODULE_ID,
        ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[context_info_idx_0].context_ipmf1_info.compare_info.pair_1.key_info[key_info_idx_0].key_id.lsb[lsb_idx_0],
        lsb,
        uint8,
        0,
        "dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_key_info_key_id_lsb_set");
    ...
    DNX_SW_STATE_LOG(
        ...
        DNX_FIELD_CONTEXT_MODULE_ID,
        &lsb,
        "dnx_field_context_sw[%d]->context_info[%d].context_ipmf1_info.compare_info.pair_1.key_info[%d].key_id.lsb[%d]",
        unit, context_info_idx_0, key_info_idx_0, lsb_idx_0);
...
int
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_key_info_key_id_lsb_get(int unit, uint32 context_info_idx_0, uint32 key_info_idx_0, uint32 lsb_idx_0, uint8 *lsb)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    *lsb = ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[context_info_idx_0].context_ipmf1_info.compare_info.pair_1.key_info[key_info_idx_0].key_id.lsb[lsb_idx_0];
    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_GET_LOGGING,
        BSL_LS_SWSTATEDNX_GET,
...
int
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_2_key_info_key_id_lsb_set(int unit, uint32 context_info_idx_0, uint32 key_info_idx_0, uint32 lsb_idx_0, uint8 lsb)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_SET(
        unit,
        DNX_FIELD_CONTEXT_MODULE_ID,
        ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[context_info_idx_0].context_ipmf1_info.compare_info.pair_2.key_info[key_info_idx_0].key_id.lsb[lsb_idx_0],
        lsb,
        uint8,
        0,
        "dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_2_key_info_key_id_lsb_set");
    ...
    DNX_SW_STATE_LOG(
        ...
        DNX_FIELD_CONTEXT_MODULE_ID,
        &lsb,
        "dnx_field_context_sw[%d]->context_info[%d].context_ipmf1_info.compare_info.pair_2.key_info[%d].key_id.lsb[%d]",
        unit, context_info_idx_0, key_info_idx_0, lsb_idx_0);
...
int
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_2_key_info_key_id_lsb_get(int unit, uint32 context_info_idx_0, uint32 key_info_idx_0, uint32 lsb_idx_0, uint8 *lsb)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    *lsb = ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[context_info_idx_0].context_ipmf1_info.compare_info.pair_2.key_info[key_info_idx_0].key_id.lsb[lsb_idx_0];
    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_GET_LOGGING,
        BSL_LS_SWSTATEDNX_GET,
...
int
dnx_field_context_sw_context_info_context_ipmf1_info_hashing_info_key_info_key_id_lsb_set(int unit, uint32 context_info_idx_0, uint32 lsb_idx_0, uint8 lsb)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_SET(
        unit,
        DNX_FIELD_CONTEXT_MODULE_ID,
        ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[context_info_idx_0].context_ipmf1_info.hashing_info.key_info.key_id.lsb[lsb_idx_0],
        lsb,
        uint8,
        0,
        "dnx_field_context_sw_context_info_context_ipmf1_info_hashing_info_key_info_key_id_lsb_set");
    ...
    DNX_SW_STATE_LOG(
        ...
        DNX_FIELD_CONTEXT_MODULE_ID,
        &lsb,
        "dnx_field_context_sw[%d]->context_info[%d].context_ipmf1_info.hashing_info.key_info.key_id.lsb[%d]",
        unit, context_info_idx_0, lsb_idx_0);
...
int
dnx_field_context_sw_context_info_context_ipmf1_info_hashing_info_key_info_key_id_lsb_get(int unit, uint32 context_info_idx_0, uint32 lsb_idx_0, uint8 *lsb)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    *lsb = ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[context_info_idx_0].context_ipmf1_info.hashing_info.key_info.key_id.lsb[lsb_idx_0];
    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_GET_LOGGING,
        BSL_LS_SWSTATEDNX_GET,
					...
					,
						...
						,
							...
							,
								...
								dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_key_info_key_id_lsb_set,
								dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_key_info_key_id_lsb_get}
							,
								{
					...
					,
						...
						,
							...
							,
								...
								dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_2_key_info_key_id_lsb_set,
								dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_2_key_info_key_id_lsb_get}
							,
								{
				...
				,
					...
					,
						...
						,
							...
							dnx_field_context_sw_context_info_context_ipmf1_info_hashing_info_key_info_key_id_lsb_set,
							dnx_field_context_sw_context_info_context_ipmf1_info_hashing_info_key_info_key_id_lsb_get}
						,
							{
