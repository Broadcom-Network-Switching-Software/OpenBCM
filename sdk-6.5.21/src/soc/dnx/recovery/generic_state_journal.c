    ...
    dbal_tables_e table_id)
{
    ...
    SHR_IF_ERR_EXIT(dnx_generic_state_journal_log_dbal_table_create_internal(unit, er_thread_id, table_id));
    ...
    uint8 only_head_clear)
{
    ...
    SHR_IF_ERR_EXIT(dnx_rollback_journal_clear
                    (unit, er_thread_id, only_head_clear, DNX_GENERIC_STATE_ROLLBACK_JOURNAL_HANDLE));
    ...
    uint8 only_head_clear)
{
    ...
    SHR_IF_ERR_EXIT(dnx_generic_state_journal_clear_internal(unit, er_thread_id, only_head_clear));
    ...
    dnx_rollback_journal_cbs_t rollback_journal_cbs)
{
    ...
    for (idx = 0; idx < DNX_ERR_RECOVERY_MAX_NOF_ACTIVE_TRANSACTION; idx++)
    {
        ...
        SHR_IF_ERR_EXIT(dnx_rollback_journal_new
                        (unit, idx, FALSE, DNX_ROLLBACK_JOURNAL_TYPE_ROLLBACK, DNX_ROLLBACK_JOURNAL_SUBTYPE_SWSTATE,
    ...
    uint8 only_head_rollback)
{
    ...
    SHR_IF_ERR_EXIT(dnx_generic_state_journal_roll_back_internal(unit, er_thread_id, only_head_rollback));
