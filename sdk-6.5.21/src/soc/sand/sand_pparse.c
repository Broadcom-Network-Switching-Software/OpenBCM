    ...
    uint32 *enabled)
{
    ...
    *enabled = 0;
    ...
    SHR_IF_ERR_EXIT(dnx_switch_header_type_in_get(unit, gport, &switch_header_type));
    ...
    uint32 *enabled)
{
    ...
    dbal_enum_value_field_layer_types_e layer_protocol_after_mpls;
    ...
    *enabled = FALSE;
    ...
    else
    {
        ...
        layer_protocol_after_mpls = sig_proto_p->value[0];
        ...
        else if ((layer_protocol_after_mpls == DBAL_ENUM_FVAL_LAYER_TYPES_BIER_TI) |
                 (layer_protocol_after_mpls == DBAL_ENUM_FVAL_LAYER_TYPES_BIER_MPLS))
        {
