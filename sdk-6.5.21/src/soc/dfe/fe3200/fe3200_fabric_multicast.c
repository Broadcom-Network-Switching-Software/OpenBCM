...
#define _SOC_FE3200_FABRIC_MULTICAST_MAX_MC_MODULES (144)

soc_error_t 
soc_fe3200_fabric_multicast_read_info(int unit, soc_multicast_t group, int *mc_table_index, int *mc_table_entry, int *is_first_half)
{
...
STATIC soc_error_t
soc_fe3200_fabric_multicast_multi_read_range(int unit, soc_multicast_t group_min, soc_multicast_t group_max, uint32 *entry_array)
{
    int rv;
    uint32 *cur_entry_array, *entry;
    int entry_index,info_index,  entry_words;
    int read_index_min, read_index_max;
    uint32 data[_SHR_BITDCLSIZE(_SOC_FE3200_FABRIC_MULTICAST_MAX_MC_MODULES)];
         ...
         info_index++)
    {
        if (group_min < info[info_index].group_max && group_max > info[info_index].group_min) 
        {
            ...
            read_index_max = (group_max < info[info_index].group_max) ? (group_max - info[info_index].group_min) : _SOC_FE3200_FABRIC_MULTICAST_TABLE_SIZE - 1;
...
int 
soc_fe3200_fabric_multicast_multi_set(
    int unit, 
    uint32 flags, 
    uint32 ngroups, 
    ...
    bcm_fabric_module_vector_t *dest_array) 
{
    ...
    if (!flags || (flags & _SHR_FABRIC_MULTICAST_SET_ONLY))
    {
        ...
        {
            rv = soc_fe3200_fabric_multicast_multi_read_range(unit, index_min, index_max, entry_array);
            SOCDNX_IF_ERR_EXIT(rv);
        }
...
int 
soc_fe3200_fabric_multicast_multi_get(
    int unit, 
    uint32 flags, 
    uint32 ngroups, 
    soc_multicast_t *groups, 
...
soc_error_t 
soc_fe3200_fabric_multicast_priority_range_validate(int unit, bcm_fabric_control_t type, int arg)
{
    uint32 max_id ;
    SOCDNX_INIT_FUNC_DEFS; 
...
soc_error_t 
soc_fe3200_fabric_multicast_priority_range_set(int unit, bcm_fabric_control_t type, int arg)
{
    uint32 reg_val = 0;
    SOCDNX_INIT_FUNC_DEFS; 
...
soc_error_t 
soc_fe3200_fabric_multicast_priority_range_get(int unit, bcm_fabric_control_t type, int* arg)
{
    uint32 reg_val = 0;
    SOCDNX_INIT_FUNC_DEFS;
...
soc_error_t 
soc_fe3200_fabric_multicast_low_priority_drop_enable_set(int unit, int arg)
{
    uint32 reg_val;
    SOCDNX_INIT_FUNC_DEFS; 
...
soc_error_t 
soc_fe3200_fabric_multicast_low_priority_drop_enable_get(int unit, int* arg)
{
    uint32 reg_val;
    SOCDNX_INIT_FUNC_DEFS; 
...
soc_error_t 
soc_fe3200_fabric_multicast_low_prio_threshold_validate(int unit, bcm_fabric_control_t type, int arg)
{
    uint64  val64;
    SOCDNX_INIT_FUNC_DEFS; 
...
soc_error_t 
soc_fe3200_fabric_multicast_low_prio_threshold_set(int unit, bcm_fabric_control_t type, int arg)
{
...
soc_error_t 
soc_fe3200_fabric_multicast_low_prio_threshold_get(int unit, bcm_fabric_control_t type, int* arg)
{
    uint64 reg_val;
    SOCDNX_INIT_FUNC_DEFS; 
...
soc_error_t 
soc_fe3200_fabric_multicast_low_prio_drop_select_priority_set(int unit, soc_dfe_fabric_priority_t prio)
{
...
soc_error_t 
soc_fe3200_fabric_multicast_low_prio_drop_select_priority_get(int unit, soc_dfe_fabric_priority_t* prio)
{
    uint32 reg_val, low_prio_select;
    SOCDNX_INIT_FUNC_DEFS; 
