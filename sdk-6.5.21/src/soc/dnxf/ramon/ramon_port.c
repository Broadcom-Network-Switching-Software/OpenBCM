...
soc_ramon_port_sync_e_link_set(int unit, int is_master, int port)
{
    ...
    if (is_master)
    {
        ...
        soc_reg64_field_set(unit, FSRD_SYNC_E_SELECTr, &reg_val2, MASTER_CLK_SELf,  port % dnxf_data_device.blocks.nof_links_in_fsrd_get(unit));
    ...
    else
    {
        ...
        soc_reg64_field_set(unit, FSRD_SYNC_E_SELECTr, &reg_val2, SLAVE_CLK_SELf,  port % dnxf_data_device.blocks.nof_links_in_fsrd_get(unit));
    }
