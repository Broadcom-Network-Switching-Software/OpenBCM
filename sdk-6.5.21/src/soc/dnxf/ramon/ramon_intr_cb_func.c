...
void ramon_interrupt_cb_init(int unit)
{
    ...
    dnxc_intr_add_handler_ext(unit, RAMON_INT_MESH_TOPOLOGY_SYNC_LOSS, 0, 0, ramon_none, ramon_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, RAMON_INT_MESH_TOPOLOGY_SYNC_TIME_OUT, 0, 0, ramon_none, ramon_none, "Check Configuration");
