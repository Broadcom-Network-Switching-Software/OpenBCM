...
shr_error_e
soc_ramon_fabric_link_retimer_cdr_lock_poll_check(int unit,  soc_port_t link_a, soc_port_t link_b)
{
...
static shr_error_e
soc_ramon_fabric_links_link_status_lock_poll(int unit, soc_port_t link, int min_nof_polls, int usec_timeout, int* rx_locked)
{
    soc_timeout_t to;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
soc_ramon_fabric_links_retimer_link_status_poll_check(int unit, soc_port_t link_a, soc_port_t link_b)
{
    int min_nof_polls, usec_timeout, rx_locked;
    SHR_FUNC_INIT_VARS(unit);
    ...
    SHR_IF_ERR_EXIT(soc_ramon_fabric_links_link_status_lock_poll(unit, link_a, min_nof_polls, usec_timeout, &rx_locked));
    if (!rx_locked)
    {
    ...
    if (link_b != link_a)
    {
        SHR_IF_ERR_EXIT(soc_ramon_fabric_links_link_status_lock_poll(unit, link_b, min_nof_polls, usec_timeout, &rx_locked));
        if (!rx_locked)
        {
            SHR_ERR_EXIT(_SHR_E_TIMEOUT, "Link %d: timeout - Rx FEC is not locked\n", link_b);
        }
