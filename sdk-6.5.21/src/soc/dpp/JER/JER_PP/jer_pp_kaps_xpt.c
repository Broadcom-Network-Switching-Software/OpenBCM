...
STATIC kaps_status jer_pp_kaps_search(void *xpt, 
                                     uint8_t *key, 
...
kaps_status jer_pp_kaps_write_command_arm(void *xpt,
                                            uint8 blk_id,
                                            uint32 cmd,
                                            uint32 func,
                                            uint32 offset,
...
kaps_status jer_pp_kaps_write_command(void *xpt,  
                                            uint8 blk_id, 
                                            uint32 cmd,
                                            uint32 func,
                                            uint32 offset,
...
kaps_status jer_pp_kaps_read_command(void *xpt,  
                                           uint32 blk_id, 
                                           uint32 cmd,
                                           uint32 func,
                                           uint32 offset,
...
kaps_status jer_pp_xpt_extended_command(void *xpt,  
                                       uint32 blk_id, 
                                       uint32 cmd,
                                       uint32 func,
                                       uint32 offset)
...
STATIC kaps_status jer_pp_kaps_command(void *xpt,
                                      enum kaps_cmd cmd,
                                      enum kaps_func func,
                                      uint32_t blk_nr,
                                      uint32_t row_nr,
...
uint32 jer_pp_xpt_init(int unit, void **xpt)
{
    ...
    *xpt = soc_sand_os_malloc(sizeof(JER_KAPS_XPT), "kaps_xpt");
    ...
    xpt_p->jer_kaps_xpt.device_type = KAPS_DEVICE_KAPS;
