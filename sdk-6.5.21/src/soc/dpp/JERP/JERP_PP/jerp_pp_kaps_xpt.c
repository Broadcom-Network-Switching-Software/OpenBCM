...
kaps_status jerp_kaps_xpt_translate_blk(int unit, uint32 blk_nr, uint32 row_nr, uint32 *blk_hw_nr, uint32 *row_hw_nr) {
...
kaps_status jerp_kaps_xpt_hb_dump_reply(int unit, uint32 start_hw_blk_num, uint32 end_hw_blk_num, 
...
kaps_status jerp_kaps_xpt_hb_copy_write(int unit, uint32 src_hw_blk_num, uint32 dest_hw_blk_num, uint32 src_hw_row_num, uint32 dest_hw_row_num,
