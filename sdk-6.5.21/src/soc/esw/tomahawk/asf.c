...
typedef struct _soc_th_asf_ctrl_256_s {
    uint8                         init;
...
/* Legacy ASF Warmboot */
typedef struct _soc_th_asf_wb_256_s {
    int unit;
    _soc_th_asf_ctrl_256_t asf_256_ctrl;
} _soc_th_asf_wb_256_t;
#endif
    ...
    uint16            scache_ver)
{
    ...
    *mem_sz = 0;
    ...
    if (scache_ver <= BCM_WB_VERSION_1_13 ) {
        ...
        *mem_sz += sizeof(_soc_th_asf_wb_256_t);
    } else {
        ...
        *mem_sz += sizeof(int);     /* _soc_th_asf_wb_t.unit */
        *mem_sz += sizeof(uint8);   /* _soc_th_asf_wb_t.asf_ctrl.init */
        *mem_sz += pbmp_size_bytes; /* _soc_th_asf_wb_t.asf_ctrl.asf_ports */
        *mem_sz += pbmp_size_bytes; /* _soc_th_asf_wb_t.asf_ctrl.pause_restore */
        *mem_sz += pbmp_size_bytes; /* _soc_th_asf_wb_t.asf_ctrl.asf_ss */
        *mem_sz += pbmp_size_bytes; /* _soc_th_asf_wb_t.asf_ctrl.asf_sf */
        *mem_sz += pbmp_size_bytes; /* _soc_th_asf_wb_t.asf_ctrl.asf_fs */
                                    /* _soc_th_asf_wb_t.asf_mem_profile */
        *mem_sz += sizeof(soc_th_asf_mem_profile_e);
        *mem_sz += sizeof(int);     /* _soc_th_asf_wb_t.latency */
    }
    ...
    IN_OUT uint8* const wb_data)
{
    ...
    scache += sizeof(int);
    sal_memcpy(scache, &_soc_th_asf_ctrl[unit]->init,
                    sizeof(_soc_th_asf_ctrl[unit]->init));
    scache += sizeof(_soc_th_asf_ctrl[unit]->init);
    sal_memcpy(scache, &_soc_th_asf_ctrl[unit]->asf_ports,
                    sizeof(_soc_th_asf_ctrl[unit]->asf_ports));
    scache += sizeof(_soc_th_asf_ctrl[unit]->asf_ports);
    sal_memcpy(scache, &_soc_th_asf_ctrl[unit]->pause_restore,
                    sizeof(_soc_th_asf_ctrl[unit]->pause_restore));
    scache += sizeof(_soc_th_asf_ctrl[unit]->pause_restore);
    sal_memcpy(scache, &_soc_th_asf_ctrl[unit]->asf_ss,
                    sizeof(_soc_th_asf_ctrl[unit]->asf_ss));
    scache += sizeof(_soc_th_asf_ctrl[unit]->asf_ss);
    sal_memcpy(scache, &_soc_th_asf_ctrl[unit]->asf_sf,
                    sizeof(_soc_th_asf_ctrl[unit]->asf_sf));
    scache += sizeof(_soc_th_asf_ctrl[unit]->asf_sf);
    sal_memcpy(scache, &_soc_th_asf_ctrl[unit]->asf_fs,
                    sizeof(_soc_th_asf_ctrl[unit]->asf_fs));
    scache += sizeof(_soc_th_asf_ctrl[unit]->asf_fs);
    sal_memcpy(scache, &_soc_th_asf_ctrl[unit]->asf_mem_profile,
                    sizeof(_soc_th_asf_ctrl[unit]->asf_mem_profile));
    scache += sizeof(_soc_th_asf_ctrl[unit]->asf_mem_profile);
    sal_memcpy(scache, &_soc_th_asf_ctrl[unit]->latency,
                    sizeof(_soc_th_asf_ctrl[unit]->latency));
    ...
    uint16       scache_ver)
{
    ...
    if (scache_ver <= BCM_WB_VERSION_1_13 ) {
        ...
        _soc_th_asf_wb_256_t *asf_wb_256 = (_soc_th_asf_wb_256_t *)wb_data;
        ...
        if (recovered_unit == unit) {
            ...
            scache += sizeof(_soc_th_asf_ctrl[unit]->asf_mem_profile);
            sal_memcpy(&(_soc_th_asf_ctrl[unit]->latency),
                       scache, sizeof(_soc_th_asf_ctrl[unit]->latency));
        }
    }
