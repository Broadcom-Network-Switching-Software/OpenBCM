...
soc_avs_voltage_set(int unit, uint32 voltage)
{
    ...
    int voltage_min = SOC_AVS_MIN_VOLTAGE;
    int voltage_max = SOC_AVS_MAX_VOLTAGE;

    if (SOC_AVS_FUNCTIONS(unit)->openloop_min_max_voltage_get != NULL) {
        SOC_AVS_FUNCTIONS(unit)->openloop_min_max_voltage_get(unit,
