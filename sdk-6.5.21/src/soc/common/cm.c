...
/* } */
    ...
    {   /* Trident4 */
        BCM56889_DEVICE_ID, BCM56889_A0_REV_ID,
        "BCM56889_A0",
        BCM56880_DEVICE_ID, BCM56880_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE | SOC_LTSW_DRV_TYPE)
    },
    {   /* Trident4 */
        BCM56889_DEVICE_ID, BCM56889_B0_REV_ID,
        "BCM56889_B0",
        BCM56880_DEVICE_ID, BCM56880_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE | SOC_LTSW_DRV_TYPE)
    },
 ...
 *      to_ver   - The version of the current software.
 *
...
soc_cm_issu_upgrade_start(const char *from_ver, const char *to_ver)
{
    ...
    return soc_ltsw_issu_upgrade_start(from_ver, to_ver);
#else
    return SOC_E_UNAVAIL;
#endif
}
