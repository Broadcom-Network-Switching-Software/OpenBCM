...
int sw_state_dpp_bcm_linkbonding_dump(int unit){
    SW_STATE_INIT_FUNC_DEFS;
    {
        ...
        for (; j0 < J0; j0++) {
            ...
            sw_state_diagnostic[unit].dpp.bcm.linkbonding.lbg_speed.dump(unit, j0);
        }
...
#if defined(BCM_PETRA_SUPPORT)
/* AUTO-GENERATED - DO NOT MODIFY */
int sw_state_dpp_bcm_linkbonding_lbg_speed_dump(int unit, int linkbonding_idx_0){
    SW_STATE_INIT_FUNC_DEFS;
    {
        int i0;
        i0 = shr_sw_state_dump_check_all_the_same(unit, sw_state[unit]->dpp.bcm.linkbonding->lbg_speed
            , sizeof(*sw_state[unit]->dpp.bcm.linkbonding->lbg_speed), SOC_TMC_LB_NOF_LBG_WITH_CONTROL) ? SOC_TMC_LB_NOF_LBG_WITH_CONTROL - 1 : 0;
        for (; i0 < SOC_TMC_LB_NOF_LBG_WITH_CONTROL; i0++) {
            shr_sw_state_dump_update_current_idx(unit, i0);
            SW_STATE_PRINT_OPAQUE(unit, sw_state[unit]->dpp.bcm.linkbonding->lbg_speed[i0],
                "sw_state[%d]->dpp.bcm.linkbonding->lbg_speed[%d]: ", unit, i0);
        }
        shr_sw_state_dump_end_of_stride(unit);
    }
    SW_STATE_FUNC_RETURN;
...
#ifdef BCM_PETRA_SUPPORT
#if defined(BCM_PETRA_SUPPORT)
    sw_state_diagnostic[unit].dpp.bcm.linkbonding.lbg_speed.dump = sw_state_dpp_bcm_linkbonding_lbg_speed_dump;
#endif /* defined(BCM_PETRA_SUPPORT)*/ 
#endif /* BCM_PETRA_SUPPORT*/ 
    return _SHR_E_NONE;
}
