...
{
    int rv = BCM_E_NONE;
    bcm_compat6525_vlan_port_t *new_vlan_port = NULL;

    if (vlan_port != NULL) {
        new_vlan_port = (bcm_compat6525_vlan_port_t *)
                     sal_alloc(sizeof(bcm_compat6525_vlan_port_t),
                     "New vlan_port");
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6525_vlan_port_create(unit, new_vlan_port);
    ...
    bcm_compat6517_vlan_port_t *vlan_port)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6525_vlan_port_find(unit, new_vlan_port);
