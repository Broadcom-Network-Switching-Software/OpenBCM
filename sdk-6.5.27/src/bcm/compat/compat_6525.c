...
{
    int rv = BCM_E_NONE;
    bcm_compat6526_vlan_port_t *new_vlan_port = NULL;

    if (vlan_port != NULL) {
        new_vlan_port = (bcm_compat6526_vlan_port_t *)
                     sal_alloc(sizeof(bcm_compat6526_vlan_port_t),
                     "New vlan_port");
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6526_vlan_port_create(unit, new_vlan_port);
    ...
    bcm_compat6525_vlan_port_t *vlan_port)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6526_vlan_port_find(unit, new_vlan_port);
...
{
    int rv = BCM_E_NONE;
    bcm_compat6526_mirror_header_info_t *new_mirror_header_info = NULL;

    if (mirror_header_info != NULL) {
        new_mirror_header_info = (bcm_compat6526_mirror_header_info_t *)
                     sal_alloc(sizeof(bcm_compat6526_mirror_header_info_t),
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6526_mirror_header_info_set(unit, flags, mirror_dest_id, new_mirror_header_info);
    ...
    bcm_compat6525_mirror_header_info_t *mirror_header_info)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6526_mirror_header_info_get(unit, mirror_dest_id, flags, new_mirror_header_info);
