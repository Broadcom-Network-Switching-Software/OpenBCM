...
{
    int rv = BCM_E_NONE;
    bcm_compat6524_mirror_header_info_t *new_mirror_header_info = NULL;

    if (mirror_header_info != NULL) {
        new_mirror_header_info = (bcm_compat6524_mirror_header_info_t *)
                     sal_alloc(sizeof(bcm_compat6524_mirror_header_info_t),
    ...
    rv = bcm_compat6524_mirror_header_info_set(unit, flags, mirror_dest_id, new_mirror_header_info);
    ...
    bcm_compat6522_mirror_header_info_t *mirror_header_info)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6524_mirror_header_info_get(unit, mirror_dest_id, flags, new_mirror_header_info);
    ...
    uint32 value)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6523_flow_match_flexctr_object_set(unit, new_info, value);
    if (new_info != NULL) {
        /* Transform the entry from the new format to old one */
        _bcm_compat6522out_flow_match_config_t(new_info, info);
        sal_free(new_info);
    ...
    uint32 *value)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6523_flow_match_flexctr_object_get(unit, new_info, value);
    if (new_info != NULL) {
        /* Transform the entry from the new format to old one */
        _bcm_compat6522out_flow_match_config_t(new_info, info);
        sal_free(new_info);
    ...
    uint32 stat_counter_id)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6523_flow_match_stat_attach(unit, new_info, num_of_fields, field, stat_counter_id);
    if (new_info != NULL) {
        /* Transform the entry from the new format to old one */
        _bcm_compat6522out_flow_match_config_t(new_info, info);
        sal_free(new_info);
    ...
    bcm_flow_logical_field_t *field)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6523_flow_match_stat_detach(unit, new_info, num_of_fields, field);
    if (new_info != NULL) {
        /* Transform the entry from the new format to old one */
        _bcm_compat6522out_flow_match_config_t(new_info, info);
        sal_free(new_info);
    ...
    uint32 *stat_counter_id)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6523_flow_match_stat_id_get(unit, new_info, num_of_fields, field, stat_counter_id);
    if (new_info != NULL) {
        /* Transform the entry from the new format to old one */
        _bcm_compat6522out_flow_match_config_t(new_info, info);
        sal_free(new_info);
...
_bcm_compat6522in_vlan_translate_egress_key_config_t(
    ...
    bcm_compat6525_vlan_translate_egress_key_config_t *to)
{
...
{
    int rv = BCM_E_NONE;
    bcm_compat6525_vlan_translate_egress_key_config_t *new_key_config = NULL;

    if (key_config != NULL) {
        new_key_config = (bcm_compat6525_vlan_translate_egress_key_config_t *)
                     sal_alloc(sizeof(bcm_compat6525_vlan_translate_egress_key_config_t),
                     "New key_config");
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6525_vlan_translate_egress_action_extended_add(unit, new_key_config, action);
    ...
    bcm_compat6522_vlan_translate_egress_key_config_t *key_config)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6525_vlan_translate_egress_action_extended_delete(unit, new_key_config);
    ...
    bcm_vlan_translate_egress_action_set_t *action)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6525_vlan_translate_egress_action_extended_get(unit, new_key_config, action);
    ...
    bcm_vlan_flexctr_config_t *config)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6525_vlan_translate_egress_flexctr_extended_attach(unit, new_key_config, config);
    ...
    bcm_vlan_flexctr_config_t *config)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6525_vlan_translate_egress_flexctr_extended_detach(unit, new_key_config, config);
    ...
    bcm_compat6522_vlan_translate_egress_key_config_t *key_config)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6525_vlan_translate_egress_flexctr_extended_detach_all(unit, new_key_config);
    ...
    int *count)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6525_vlan_translate_egress_flexctr_extended_get(unit, new_key_config, array_size, config_array, count);
 ...
 *            */
STATIC void
_bcm_compat6522out_port_resource_t(
    bcm_port_resource_t *from,
    bcm_compat6522_port_resource_t *to)
{
    to->flags = from->flags;
    to->port = from->port;
    to->physical_port = from->physical_port;
    ...
    bcm_compat6522_port_resource_t *match_array)
{
    ...
    if (new_match_array != NULL) {
        /* Transform the entry from the new format to old one */
        _bcm_compat6522out_port_resource_t(new_match_array, match_array);
