...
{
    int rv = BCM_E_NONE;
    bcm_compat6526_flexstate_quantization_t *new_quantization = NULL;

    if (quantization != NULL) {
        new_quantization = (bcm_compat6526_flexstate_quantization_t *)
                           sal_alloc(sizeof(bcm_compat6526_flexstate_quantization_t),
                           "New quantization");
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6526_flexstate_quantization_create(unit, options, new_quantization,
                                           quant_id);
    ...
    bcm_compat6520_flexstate_quantization_t *quantization)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6526_flexstate_quantization_get(unit, quant_id, new_quantization);
