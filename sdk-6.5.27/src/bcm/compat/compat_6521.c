...
{
    int rv = BCM_E_NONE;
    bcm_compat6526_switch_reflector_data_t *new_data = NULL;

    if (data != NULL) {
        new_data = (bcm_compat6526_switch_reflector_data_t *)
                     sal_alloc(sizeof(bcm_compat6526_switch_reflector_data_t),
                     "New data");
        if (new_data == NULL) {
            return BCM_E_MEMORY;
        }
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6526_switch_reflector_create(unit, flags, encap_id, new_data);
    ...
    bcm_compat6521_switch_reflector_data_t *data)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6526_switch_reflector_get(unit, flags, encap_id, new_data);
