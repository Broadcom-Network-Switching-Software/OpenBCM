...
static const unsigned int is_upper[] = {
        0x00000000, 
        0x00000000, 
        0x07fffffe, 
        0x00000000, 
...
static const unsigned int is_lower[] = {
        0x00000000, 
        0x00000000, 
        0x00000000, 
        0x07fffffe, 
...
static const unsigned int is_printable[] = {
        0x00000000,
        0xffffffff,
        0xffffffff,
        0x7fffffff,
...
static int re_tolower(int c)
{
    ...
    return (is_upper[c/32] & (1 << (c%32))) ? c + 32 : c;
}
...
static int re_toupper(int c)
{
    ...
    return (is_lower[c/32] & (1 << (c%32))) ? c - 32 : c;
}
