...
#define BCM_WB_VERSION_2_2                SOC_SCACHE_VERSION(2, 2)
#define BCM_WB_DEFAULT_VERSION            BCM_WB_VERSION_2_2
...
_bcm_flow_wb_recover(int unit)
{
    ...
    if (flow_scache_ptr != NULL) {
        ...
        if (recovered_ver >= BCM_WB_VERSION_2_2) {
            sz =  sizeof(uint32);
            /* recover additional gbp_ref_cnt */
            sal_memcpy(&flow_info->gbp_ref_cnt, flow_scache_ptr, sz);
            flow_scache_ptr += sz;
        } else {
...
_bcm_flow_wb_alloc(int unit)
{
    ...
    /* gbp_ref_cnt from BCM_WB_VERSION_2_2 */
...
_bcm_esw_flow_sync(int unit)
{
    ...
    sz = sizeof(uint32);
    /* Save additional gbp_ref_cnt */
    sal_memcpy(flow_scache_ptr,&flow_info->gbp_ref_cnt, sz);
    flow_scache_ptr += sz;
...
_bcm_flow_srv6_init(int unit)
{
    ...
    if (soc_property_get(unit, spn_L3_SRV6_ENABLE, 0)) {
        ...
        SOC_IF_ERROR_RETURN(soc_flow_db_flow_option_id_get(unit,
                      flow_info->flow_srv6,
                      "ADAPT_2_LOOKUP_DIP_ASSIGN_VFI_L3_IIF_AND_TUNNEL_TERM",
                       &flow_info->option_term_adapt2_vfi));
        SOC_IF_ERROR_RETURN(soc_flow_db_flow_option_id_get(unit,
                      flow_info->flow_srv6,
