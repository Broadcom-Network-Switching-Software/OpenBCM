                                    ...
                                    bcm_switch_pkt_trace_info_t *pkt_trace_info)
{
    ...
    const drop_reason_map_t drop_reason_map[] = {
        ...
        { PVLAN_VID_MISMATCHf,      0 /* VLAN_DROP_VECTORfmt */,
            (uint8)bcmSwitchPktTraceDropReasonPVlanVidMismatch          },
        ...
        { NEXT_HOP_DROPf,           1 /* RSEL_DROP_VECTORfmt */,
            (uint8)bcmSwitchPktTraceDropReasonL3NextHopDrop             },
        { ECMP_RESOLUTION_ERRORf,   1 /* RSEL_DROP_VECTORfmt */,
            (uint8)bcmSwitchPktTraceDropReasonEcmpResolutionError       },
        { PROTECTION_DATA_DROPf,    1 /* RSEL_DROP_VECTORfmt */,
            (uint8)bcmSwitchPktTraceDropReasonProtectionData            },
        { FP_CHANGE_L2_FIELDS_NO_REDIRECT_DROPf, 1 /* RSEL_DROP_VECTORfmt */,
            (uint8)bcmSwitchPktTraceDropReasonFPChgL2FldsNoRedirect     },
        ...
        { L3_TTL_ERRORf,            2 /* PKT_PROC_DROP_VECTORfmt */,
            (uint8)bcmSwitchPktTraceDropReasonL3TtlError                },
        { L3_DST_LOOKUP_MISSf,      2 /* PKT_PROC_DROP_VECTORfmt */,
            (uint8)bcmSwitchPktTraceDropReasonL3DstLookupMiss           },
        { L3_HDR_ERRORf,            2 /* PKT_PROC_DROP_VECTORfmt */,
            (uint8)bcmSwitchPktTraceDropReasonL3HdrError                },
        { CFI_OR_L3DISABLEf,        2 /* PKT_PROC_DROP_VECTORfmt */,
            (uint8)bcmSwitchPktTraceDropReasonCFIorL3Disable            },
        { BFD_TERMINATED_DROPf,     2 /* PKT_PROC_DROP_VECTORfmt */,
            (uint8)bcmSwitchPktTraceDropReasonBfdTermination            },
        { MPLS_STAGEf,              2 /* PKT_PROC_DROP_VECTORfmt */,
            (uint8)bcmSwitchPktTraceDropReasonMplsBfdError              },
        ...
        { BLOCK_MASK_DROPf,         5 /* PRE_COUNTER_UPDATE_VECTORfmt */,
            (uint8)bcmSwitchPktTraceDropReasonBlockMask                 },
        { SRC_PORT_KNOCKOUT_DROPf,  5 /* PRE_COUNTER_UPDATE_VECTORfmt */,
            (uint8)bcmSwitchPktTraceDropReasonSrcPortKnockout           },
        { MTU_CHECK_FAILf,          5 /* PRE_COUNTER_UPDATE_VECTORfmt */,
            (uint8)bcmSwitchPktTraceDropReasonMtuCheckFail              }
    };
                                  ...
                                  bcm_switch_pkt_trace_info_t *pkt_trace_info)
{
    ...
    fwd_dst_type =
        soc_format_field32_get(unit, INSTR_BUFFER_ISW_DW0fmt,
                                isw_raw_data, FWD_DESTINATION_TYPEf);

    fwd_dst_field =
        soc_format_field32_get(unit, INSTR_BUFFER_ISW_DW0fmt,
                                isw_raw_data, FWD_DESTINATION_FIELDf);
    ...
    switch (fwd_dst_type) {
        ...
        case TH_FWD_DEST_TYPE_NH:
            ...
            pkt_trace_info->pkt_trace_fwd_dst_info.egress_intf =
                         fwd_dst_field + BCM_XGS3_EGRESS_IDX_MIN(unit);
            break;
        ...
        case TH_FWD_DEST_TYPE_DGLP:
            ...
            BCM_GPORT_MODPORT_SET(pkt_trace_info->pkt_trace_fwd_dst_info.port,
                                  modid, port);
            break;
    }
    ...
    pkt_trace_info->pkt_trace_fwd_dst_info.fwd_vlan =
                           soc_format_field32_get(unit, INSTR_BUFFER_ISW_DW4fmt,
                                                  isw_raw_data+8, FWD_VLANf);
#ifdef INCLUDE_L3
    ...
    if (ecmp_rsl_done2) {
        ...
        if ((soc_feature(unit, soc_feature_l3_ecmp_hier_tbl)) &&
            ...
            pkt_trace_info->pkt_trace_hash_info.ecmp_2_group +=
                               BCM_TH3_UNDERLAY_ONLY_OFFSET(unit);
        }
    }
#endif
