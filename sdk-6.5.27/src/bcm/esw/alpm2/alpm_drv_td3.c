...
#define TD3_X4_AX_ALPM_BKT_BITS    12
...
/* TD3 default route usage result obtained from test DB:
 * grp, route, {usage[]}, hlfbnk, acb_cnt, 128b, rsvd, full, {cnt_total[]} */
static alpm_default_usage_t th_def_usage_combined[] = {
    /* Combined-128, full-banks, w/o-reserved */
    {bcmL3RouteGroupPrivateV4, 360388, { 75, 100, 0}, 0, 1, 1, 0, 1, { 8192, 65536, 0}},
    {bcmL3RouteGroupGlobalV4,  360388, { 75, 100, 0}, 0, 1, 1, 0, 1, { 8192, 65536, 0}},
    {bcmL3RouteGroupPrivateV6, 131040, {100, 100, 0}, 0, 1, 1, 0, 1, { 4096, 65536, 0}},
    {bcmL3RouteGroupGlobalV6,  131040, {100, 100, 0}, 0, 1, 1, 0, 1, { 4096, 65536, 0}},
    /* Combined-128, full-banks, w/ -reserved */
    {bcmL3RouteGroupPrivateV4, 180164, { 38, 100, 0}, 0, 1, 1, 1, 1, { 8192, 32768, 0}},
    {bcmL3RouteGroupGlobalV4,  180164, { 38, 100, 0}, 0, 1, 1, 1, 1, { 8192, 32768, 0}},
    {bcmL3RouteGroupPrivateV6,  65536, { 50, 100, 0}, 0, 1, 1, 1, 1, { 4096, 32768, 0}},
    {bcmL3RouteGroupGlobalV6,   65536, { 50, 100, 0}, 0, 1, 1, 1, 1, { 4096, 32768, 0}},

    /* Combined-128, half-banks, w/o-reserved */
    {bcmL3RouteGroupPrivateV4, 163824, { 50, 100, 0}, 1, 1, 1, 0, 1, { 8192, 32768, 0}},
    {bcmL3RouteGroupGlobalV4,  163824, { 50, 100, 0}, 1, 1, 1, 0, 1, { 8192, 32768, 0}},
    {bcmL3RouteGroupPrivateV6,  65519, {100, 100, 0}, 1, 1, 1, 0, 1, { 4096, 32768, 0}},
    {bcmL3RouteGroupGlobalV6,   65519, {100, 100, 0}, 1, 1, 1, 0, 1, { 4096, 32768, 0}},
    /* Combined-128, half-banks, w/ -reserved */
    {bcmL3RouteGroupPrivateV4,  81904, { 25, 100, 0}, 1, 1, 1, 1, 1, { 8192, 16384, 0}},
    {bcmL3RouteGroupGlobalV4,   81904, { 25, 100, 0}, 1, 1, 1, 1, 1, { 8192, 16384, 0}},
    {bcmL3RouteGroupPrivateV6,  32767, { 50, 100, 0}, 1, 1, 1, 1, 1, { 4096, 16384, 0}},
    {bcmL3RouteGroupGlobalV6,   32767, { 50, 100, 0}, 1, 1, 1, 1, 1, { 4096, 16384, 0}},

    /* combined-64 , full-banks, w/o-reserved */
    {bcmL3RouteGroupPrivateV4, 360388, { 38, 100, 0}, 0, 1, 0, 0, 1, {16384, 65536, 0}},
    {bcmL3RouteGroupGlobalV4,  360388, { 38, 100, 0}, 0, 1, 0, 0, 1, {16384, 65536, 0}},
    {bcmL3RouteGroupPrivateV6, 262076, { 25, 100, 0}, 0, 1, 0, 0, 1, {16384, 65536, 0}},
    {bcmL3RouteGroupGlobalV6,  262076, { 25, 100, 0}, 0, 1, 0, 0, 1, {16384, 65536, 0}},
    /* combined-64 , half-banks, w/o-reserved */
    {bcmL3RouteGroupPrivateV4, 163824, { 25, 100, 0}, 1, 1, 0, 0, 1, {16384, 32768, 0}},
    {bcmL3RouteGroupGlobalV4,  163824, { 25, 100, 0}, 1, 1, 0, 0, 1, {16384, 32768, 0}},
    {bcmL3RouteGroupPrivateV6, 131040, { 25, 100, 0}, 1, 1, 0, 0, 1, {16384, 32768, 0}},
    {bcmL3RouteGroupGlobalV6,  131040, { 25, 100, 0}, 1, 1, 0, 0, 1, {16384, 32768, 0}},
};

static alpm_default_usage_t th_def_usage_parallel[] = {
    /* parallel-128, full-banks, w/o-reserved */
    {bcmL3RouteGroupPrivateV4, 262076, {100,  75, 0}, 0, 1, 1, 0, 1, { 4096, 65536, 0}},
    {bcmL3RouteGroupGlobalV4,  262076, {100,  75, 0}, 0, 1, 1, 0, 1, { 4096, 65536, 0}},
    {bcmL3RouteGroupPrivateV6,  32766, {100,  25, 0}, 0, 1, 1, 0, 1, { 2048, 65536, 0}},
    {bcmL3RouteGroupGlobalV6,   32766, {100,  25, 0}, 0, 1, 1, 0, 1, { 2048, 65536, 0}},
    /* parallel-128, full-banks, w/ -reserved */
    {bcmL3RouteGroupPrivateV4, 163800, {100, 100, 0}, 0, 1, 1, 1, 1, { 4096, 32768, 0}},
    {bcmL3RouteGroupGlobalV4,  163800, {100, 100, 0}, 0, 1, 1, 1, 1, { 4096, 32768, 0}},
    {bcmL3RouteGroupPrivateV6,  32766, {100,  50, 0}, 0, 1, 1, 1, 1, { 2048, 32768, 0}},
    {bcmL3RouteGroupGlobalV6,   32766, {100,  50, 0}, 0, 1, 1, 1, 1, { 2048, 32768, 0}},

    /* parallel-128, half-banks, w/o-reserved */
    {bcmL3RouteGroupPrivateV4, 131044, {100,  75, 0}, 1, 1, 1, 0, 1, { 4096, 32768, 0}},
    {bcmL3RouteGroupGlobalV4,  131044, {100,  75, 0}, 1, 1, 1, 0, 1, { 4096, 32768, 0}},
    {bcmL3RouteGroupPrivateV6,  16382, {100,  25, 0}, 1, 1, 1, 0, 1, { 2048, 32768, 0}},
    {bcmL3RouteGroupGlobalV6,   16382, {100,  25, 0}, 1, 1, 1, 0, 1, { 2048, 32768, 0}},
    /* parallel-128, half-banks, w/ -reserved */
    {bcmL3RouteGroupPrivateV4,  81895, {100, 100, 0}, 1, 1, 1, 1, 1, { 4096, 16384, 0}},
    {bcmL3RouteGroupGlobalV4,   81895, {100, 100, 0}, 1, 1, 1, 1, 1, { 4096, 16384, 0}},
    {bcmL3RouteGroupPrivateV6,  16382, {100,  50, 0}, 1, 1, 1, 1, 1, { 2048, 16384, 0}},
    {bcmL3RouteGroupGlobalV6,   16382, {100,  50, 0}, 1, 1, 1, 1, 1, { 2048, 16384, 0}},

    /* parallel-64 , full-banks, w/o-reserved */
    {bcmL3RouteGroupPrivateV4, 327640, {100, 100, 0}, 0, 1, 0, 0, 1, { 8192, 65536, 0}},
    {bcmL3RouteGroupGlobalV4,  327640, {100, 100, 0}, 0, 1, 0, 0, 1, { 8192, 65536, 0}},
    {bcmL3RouteGroupPrivateV6, 262112, {100, 100, 0}, 0, 1, 0, 0, 1, { 8192, 65536, 0}},
    {bcmL3RouteGroupGlobalV6,  262112, {100, 100, 0}, 0, 1, 0, 0, 1, { 8192, 65536, 0}},
    /* parallel-64 , half-banks, w/o-reserved */
    {bcmL3RouteGroupPrivateV4, 163825, {100, 100, 0}, 1, 1, 0, 0, 1, { 8192, 32768, 0}},
    {bcmL3RouteGroupGlobalV4,  163825, {100, 100, 0}, 1, 1, 0, 0, 1, { 8192, 32768, 0}},
    {bcmL3RouteGroupPrivateV6, 131054, {100, 100, 0}, 1, 1, 0, 0, 1, { 8192, 32768, 0}},
    {bcmL3RouteGroupGlobalV6,  131054, {100, 100, 0}, 1, 1, 0, 0, 1, { 8192, 32768, 0}},
};

static alpm_default_usage_t th_def_usage_mixed[] = {
    /* alpmTcam-128, full-banks, w/o-reserved */
    {bcmL3RouteGroupPrivateV4, 327552, {100,  88, 0}, 0, 1, 1, 0, 1, { 4096, 65536, 0}},
    {bcmL3RouteGroupGlobalV4,    8191, {100,   0, 0}, 0, 1, 1, 0, 1, { 4096, 65536, 0}},
    {bcmL3RouteGroupPrivateV6,  65536, {100,  50, 0}, 0, 1, 1, 0, 1, { 2048, 65536, 0}},
    {bcmL3RouteGroupGlobalV6,    2048, {100,   0, 0}, 0, 1, 1, 0, 1, { 2048, 65536, 0}},
    /* alpmTcam-128, full-banks, w/ -reserved */
    {bcmL3RouteGroupPrivateV4, 180164, { 75, 100, 0}, 0, 1, 1, 1, 1, { 4096, 32768, 0}},
    {bcmL3RouteGroupGlobalV4,    8191, {100,   0, 0}, 0, 1, 1, 1, 1, { 4096, 32768, 0}},
    {bcmL3RouteGroupPrivateV6,  65536, {100, 100, 0}, 0, 1, 1, 1, 1, { 2048, 32768, 0}},
    {bcmL3RouteGroupGlobalV6,    2048, {100,   0, 0}, 0, 1, 1, 1, 1, { 2048, 32768, 0}},

    /* alpmTcam-128, half-banks, w/o-reserved */
    {bcmL3RouteGroupPrivateV4, 163800, {100, 100, 0}, 1, 1, 1, 0, 1, { 4096, 32768, 0}},
    {bcmL3RouteGroupGlobalV4,    8191, {100,   0, 0}, 1, 1, 1, 0, 1, { 4096, 32768, 0}},
    {bcmL3RouteGroupPrivateV6,  32766, {100,  50, 0}, 1, 1, 1, 0, 1, { 2048, 32768, 0}},
    {bcmL3RouteGroupGlobalV6,    2048, {100,   0, 0}, 1, 1, 1, 0, 1, { 2048, 32768, 0}},
    /* alpmTcam-128, half-banks, w/ -reserved */
    {bcmL3RouteGroupPrivateV4,  81904, { 50, 100, 0}, 1, 1, 1, 1, 1, { 4096, 16384, 0}},
    {bcmL3RouteGroupGlobalV4,    8191, {100,   0, 0}, 1, 1, 1, 1, 1, { 4096, 16384, 0}},
    {bcmL3RouteGroupPrivateV6,  32766, {100, 100, 0}, 1, 1, 1, 1, 1, { 2048, 16384, 0}},
    {bcmL3RouteGroupGlobalV6,    2048, {100,   0, 0}, 1, 1, 1, 1, 1, { 2048, 16384, 0}},

    /* alpmTcam-64 , full-banks, w/o-reserved */
    {bcmL3RouteGroupPrivateV4, 360388, { 75, 100, 0}, 0, 1, 0, 0, 1, { 8192, 65536, 0}},
    {bcmL3RouteGroupGlobalV4,   16383, {100,   0, 0}, 0, 1, 0, 0, 1, { 8192, 65536, 0}},
    {bcmL3RouteGroupPrivateV6, 262076, { 50, 100, 0}, 0, 1, 0, 0, 1, { 8192, 65536, 0}},
    {bcmL3RouteGroupGlobalV6,    8192, {100,   0, 0}, 0, 1, 0, 0, 1, { 8192, 65536, 0}},
    /* alpmTcam-64 , half-banks, w/o-reserved */
    {bcmL3RouteGroupPrivateV4, 163824, { 50, 100, 0}, 1, 1, 0, 0, 1, { 8192, 32768, 0}},
    {bcmL3RouteGroupGlobalV4,   16383, {100,   0, 0}, 1, 1, 0, 0, 1, { 8192, 32768, 0}},
    {bcmL3RouteGroupPrivateV6, 131040, { 50, 100, 0}, 1, 1, 0, 0, 1, { 8192, 32768, 0}},
    {bcmL3RouteGroupGlobalV6,    8192, {100,   0, 0}, 1, 1, 0, 0, 1, { 8192, 32768, 0}},
};

static alpm_default_usage_t *th_def_usage[] = {
    th_def_usage_combined,
    th_def_usage_parallel,
    th_def_usage_mixed
};
static int th_def_usage_tblsize[] = {
    COUNTOF(th_def_usage_combined),
    COUNTOF(th_def_usage_parallel),
    COUNTOF(th_def_usage_mixed)
};
...
th_alpm_cfg_adjust(int u, _alpm_cb_t *acb)
{
    ...
    if (soc_feature(u, soc_feature_td3x4_ax_uft_shared_8_banks_16k)) {
        /* Buckets in each bank reduced by half */
        /* Adjust _alpm_cb_t */
        ACB_BKT_BITS(acb) -= 1;
...
th_mem_urpf_pvt_bkt_ptr_set(int u, soc_mem_t mem, void *entry)
{
    ...
    urpf_offset = (soc_feature(u, soc_feature_alpm_addr_xlate) ||
                   soc_feature(u, soc_feature_td3x4_ax_uft_shared_8_banks_16k))
                       ? 2048 : 4096;
...
th_alpm_cfg_init(int u)
{
    ...
    if (ALPM_ACL_EN(u)) {
        if (ALPM_TCAM_ZONED(u, APP0) != 0) {
            ALPM_ERR(("th_alpm_cfg_init: ALPM_TCAM_ZONED(u, APP0)=%d\n",
                       ALPM_TCAM_ZONED(u, APP0)));
        }
        if (SOC_URPF_STATUS_GET(u)) {
...
th_alpm_ctrl_init(int u)
{
    ...
    if (ALPM_MEM_ENT_MAX * sizeof(uint32)
           < sizeof(defip_pair_128_entry_t)) {
        ALPM_ERR(("th_alpm_ctrl_init: unexpected ALPM_MEM_ENT_MAX=%d\n",
                  ALPM_MEM_ENT_MAX));
    }
    ...
    acb_cnt = th_alpm_cb_cnt(u);
    if ((acb_cnt * ALPM_PKM_CNT) >= 20) {
        ALPM_ERR(("th_alpm_ctrl_init: acb_cnt*ALPM_PKM_CNT=%d\n",
                   (acb_cnt * ALPM_PKM_CNT)));
    }
...
#define _CHK_IF_CLEAR_MEM(mem)                  \
        do {                                        \
            ...
            def_mode = soc_feature(u, soc_feature_alpm_flex_stat) ? 1 : 0;
            ...
            ALPM_BKT_SHARE_START(u, ALPM_IPT_V4) = ACB_BKT_CNT(acb) *
                soc_property_get(u, spn_ALPM_BKT_SHARE_START_IPV4, 50) / 100;
            ALPM_BKT_SHARE_START(u, ALPM_IPT_V6) = ACB_BKT_CNT(acb) *
                soc_property_get(u, spn_ALPM_BKT_SHARE_START_IPV6, 50) / 100;
        }
                  ...
                  uint32 src_idx, uint32 dst_idx)
{
    ...
    /* Copy entry */
    if (sb_fmt != db_fmt) {
        ALPM_ERR(("th_alpm_ent_copy: sb_fmt=%d, db_fmt=%d\n", sb_fmt, db_fmt));
    } else {
...
th_tcam_entry_view_get(int u, _alpm_bkt_info_t *bkt_info)
{
    ...
    if (i >= ALPM_BPB_MAX) {
        ALPM_ERR(("th_tcam_entry_view_get: i=%d, ALPM_BPB_MAX=%d\n",
                  i, ALPM_BPB_MAX));
    }
...
#define HX5_ALPM_4_BANK_MODE_BANK_BITS 2
    ...
    if (soc_feature(u, soc_feature_td3x4_ax_uft_shared_8_banks_16k)) {
        phy_idx =
            (ent << (ACB_BNK_BITS(acb) + TD3_X4_AX_ALPM_BKT_BITS)) | phy_idx;
    } else {
...
/* Get TCAM cached hitbit status from pvt_node's tcam_idx (from hw) */
int
th_tcam_hit_get(int u, _alpm_pvt_node_t *pvt_node, int app, int pkm, int tcam_idx)
{
    int         rv = BCM_E_NONE;
    int         idx, sub_idx;
    ...
    ALPM_IER(th_mem_read(u, acb, acb->pvt_tbl[pkm], idx, e, TRUE));
    rv = soc_mem_field32_get(u, mem, e, hit_fld[sub_idx]);
    return rv;
}
...
th_alpm_hit_init(int u)
{
    ...
    for (i = 0; i < ACB_CNT(u); i++) {
        ...
        if (soc_mem_entry_words(u, mem) != 1) {
            ALPM_ERR(("th_alpm_hit_init: soc_mem_entry_words(u, %d)=%d\n",
                       mem, soc_mem_entry_words(u, mem)));
        }
...
STATIC int
th_alpm_def_usage_get(int u, int grp, int *def_route, int *def_lvl, int *def_usage, int *cur_cnt_total)
{
    ...
    int tblsize = th_def_usage_tblsize[mode];

    acb = ACB_BTM(u, app);
    hlfbnk = (uint8) (ACB_HLF_BNK_MD(acb) && ALPM_HLF_BNKS(u));

    for (i = 0; i < tblsize; i++) {
        def = &th_def_usage[mode][i];

        if (def->hlfbnk == hlfbnk &&
    ...
    if (i < tblsize) { /* found matched one */
        int adjusted = 0;
        int delta = 0;
        int limit_usage = alpm_bnk_limit_usage(u, grp, BCM_L3_ALPM_LEVELS - 2);
        int cur_usage[BCM_L3_ALPM_LEVELS];

        /* initialize current usage with default usage */
        for (lvl = 0; lvl < BCM_L3_ALPM_LEVELS - 1; lvl++) {
        ...
        for (lvl = 1; lvl < 2; lvl++) {
            ...
            delta = (lvl == BCM_L3_ALPM_LEVELS - 2 ? 1 : 0);
        ...
        if ((max_lvl == BCM_L3_ALPM_LEVELS - 2) &&
...
alpm_functions_t th_alpm_driver = {
    .alpm_ctrl_init         = th_alpm_ctrl_init,
    .alpm_ctrl_deinit       = th_alpm_ctrl_deinit,
    .alpm_ctrl_cleanup      = NULL, /* th_alpm_ctrl_cleanup, -> UNAVAIL */
    .alpm_bkt_bnk_copy      = th_alpm_bkt_bnk_copy,
    .alpm_bkt_bnk_clear     = th_alpm_bkt_bnk_clear,
    .alpm_bkt_pfx_copy      = th_alpm_bkt_pfx_copy,
    .alpm_bkt_pfx_clean     = th_alpm_bkt_pfx_clean,
    .alpm_bkt_pfx_shrink    = th_alpm_bkt_pfx_shrink,
    .alpm_bkt_ent_write     = th_alpm_bkt_bnk_write,
    .alpm_bkt_def_fmt_get   = th_alpm_bkt_def_fmt_get,
    .alpm_bkt_fmt_type_get  = th_alpm_bkt_fmt_type_get,

    .alpm_ent_ent_get       = th_alpm_ent_ent_get,
    .alpm_ent_pfx_len_get   = th_alpm_ent_pfx_len_get,
    .alpm_ent_selective_get = th_alpm_ent_selective_get,

    /* TCAM */
    .tcam_table_sz          = th_tcam_table_sz,
    .tcam_hw_cleanup        = NULL, /* th_tcam_hw_cleanup, -> UNAVAIL */
    .tcam_entry_x_to_y      = th_tcam_entry_x_to_y,
    .tcam_entry_from_cfg    = th_tcam_entry_from_cfg,
    .tcam_entry_to_cfg      = th_tcam_entry_to_cfg,
    .tcam_entry_valid       = th_tcam_entry_valid,
    .tcam_entry_valid_set   = th_tcam_entry_valid_set,
    .tcam_entry_vrf_id_get  = th_tcam_entry_vrf_id_get,
    .tcam_entry_key_type_get= th_tcam_entry_key_type_get,
    .tcam_entry_pfx_len_get = th_tcam_entry_pfx_len_get,
    .tcam_entry_to_key      = th_tcam_entry_to_key,

    .tcam_entry_mode_get    = th_tcam_entry_mode_get,
    .tcam_entry_adata_get   = th_tcam_entry_adata_get,
    .tcam_entry_bdata_get   = th_tcam_entry_bdata_get,

    /* TCAM/ALPM */
    .mem_entry_read         = th_mem_read,
    .mem_entry_write        = th_mem_write,

    /* HITBIT */
    .alpm_hit_init          = th_alpm_hit_init,
    .alpm_hit_deinit        = th_alpm_hit_deinit,
    .alpm_hit_cleanup       = NULL, /* th_alpm_hit_cleanup -> UNAVAIL */
    .alpm_bkt_hit_get       = th_alpm_bkt_hit_get,
    .alpm_bkt_hit_set       = th_alpm_bkt_hit_set,
    .alpm_bkt_hit_write     = th_alpm_bkt_hit_write,
    .alpm_hit_move_update   = th_alpm_hit_move_update,
    .alpm_hit_cache_sync    = th_alpm_hit_cache_sync,
    .alpm_hit_hw_write      = th_alpm_hit_hw_write,
    .tcam_entry_hit_get     = th_tcam_ent_hit_get,
    .tcam_hit_get           = th_tcam_hit_get,
    .tcam_hit_write         = NULL, /* th_tcam_hit_write -> UNAVAIL */

    /* dump table */
    .alpm_table_dump        = th_alpm_table_dump,
    .alpm_cap_get           = th_alpm_cap_get,
    .alpm_def_usage_get     = th_alpm_def_usage_get,

    /* data op: save/restore */
    .alpm_data_op           = NULL,

    /* index mapping */
    .mem_ent_phy_idx_get    = th_mem_phy_index_get,
};
