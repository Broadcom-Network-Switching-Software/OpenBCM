...
bcmi_ft_agg_class_source_type_map_t bcmi_ftv3_agg_class_st_map[] =  {
    ...
    { BCMI_FT_AGG_CLASS_ST_INVALID, BCMI_FT_AGG_CLASS_ST_INVALID}, /* Added for ltsw device - bcmFlowtrackerClassSourceTypeIngressInterface */
    { BCMI_FT_AGG_CLASS_ST_INVALID, BCMI_FT_AGG_CLASS_ST_INVALID}, /* Added for ltsw device - bcmFlowtrackerClassSourceTypeL4SrcPort */
    { BCMI_FT_AGG_CLASS_ST_INVALID, BCMI_FT_AGG_CLASS_ST_INVALID}, /* Added for ltsw device - bcmFlowtrackerClassSourceTypeL4DstPort */
    { BCMI_FT_AGG_CLASS_ST_INVALID, BCMI_FT_AGG_CLASS_ST_INVALID}, /* Added for ltsw device - bcmFlowtrackerClassSourceTypeEgress */
    { BCMI_FT_AGG_CLASS_ST_INVALID, BCMI_FT_AGG_CLASS_ST_INVALID}, /* Added for ltsw device - bcmFlowtrackerClassSourceTypeOverlayEgress */
