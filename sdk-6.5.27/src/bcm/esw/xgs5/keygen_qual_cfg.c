                             ...
                             bcmi_keygen_md_t *keygen_md)
{
    ...
    bcmi_keygen_qual_cfg_info_t **qual_cfg_info = NULL;
    bcm_field_qualify_t pmux_qual = 0;
    bcmi_keygen_acl_attr_t attr = 0;
    ...
    for (idx = 0; idx < keygen_cfg->ext_ctrl_sel_info_count; idx++) {
        ...
        for (idx1 = 0; idx1 < keygen_cfg->prev_qual_info_count; idx1++) {
            pmux_qual = keygen_cfg->prev_qual_info_arr[idx1].qual_id;
            qual_cfg = qual_cfg_info[pmux_qual]->qual_cfg_arr;
            qual_flags = &(qual_cfg->qual_flags);
            if (!SHR_BITGET(qual_flags->w,
                            BCMI_KEYGEN_QUAL_FLAGS_PMUX)) {
                continue;
            }

            for (idx2 = 0; idx2 < qual_cfg->num_chunks; idx2++) {
            if (qual_cfg->e_params[idx2].section ==
                BCMI_KEYGEN_EXT_SECTION_IPBM) {
                continue;
            }
            if (qual_cfg->e_params[idx2].sec_val !=
                keygen_cfg->ext_ctrl_sel_info[idx].ctrl_sel_val) {
                continue;
            }
            switch (qual_cfg->e_params[idx2].section) {
                case BCMI_KEYGEN_EXT_SECTION_DROP:
                    attr = BCMI_KEYGEN_ACL_ATTR_PMUX_DROP;
                    SHR_BITSET(keygen_md->acl_attrs[part].w, attr);
                    break;
                case BCMI_KEYGEN_EXT_SECTION_NAT_NEEDED:
                    attr = BCMI_KEYGEN_ACL_ATTR_PMUX_NAT_NEEDED;
                    SHR_BITSET(keygen_md->acl_attrs[part].w, attr);
                    break;
                case BCMI_KEYGEN_EXT_SECTION_NAT_DST_REALMID:
                    attr = BCMI_KEYGEN_ACL_ATTR_PMUX_NAT_DST_REALM_ID;
                    SHR_BITSET(keygen_md->acl_attrs[part].w, attr);
                    break;
                case BCMI_KEYGEN_EXT_SECTION_EM_FIRST_LOOKUP_HIT:
                    attr = BCMI_KEYGEN_ACL_ATTR_PMUX_EM_FIRST_LOOKUP_HIT;
                    SHR_BITSET(keygen_md->acl_attrs[part].w, attr);
                    break;
                case BCMI_KEYGEN_EXT_SECTION_EM_SECOND_LOOKUP_HIT:
                    attr = BCMI_KEYGEN_ACL_ATTR_PMUX_EM_SECOND_LOOKUP_HIT;
                    SHR_BITSET(keygen_md->acl_attrs[part].w, attr);
                    break;
                case BCMI_KEYGEN_EXT_SECTION_SRC_DST_CONTAINERS_MSB:
                    if (keygen_cfg->mode == BCMI_KEYGEN_MODE_SINGLE) {
                        attr = BCMI_KEYGEN_ACL_ATTR_PMUX_SRC_DST_CONT_MSB_HM;
                        SHR_BITSET(keygen_md->acl_attrs[part].w, attr);
                    } else {
                        attr = BCMI_KEYGEN_ACL_ATTR_PMUX_SRC_DST_CONT_MSB;
                        SHR_BITSET(keygen_md->acl_attrs[part].w, attr);
                    }
                    break;
                case BCMI_KEYGEN_EXT_SECTION_SRC_DST_CONTAINER_0:
                    if (keygen_cfg->mode == BCMI_KEYGEN_MODE_SINGLE) {
                        attr = BCMI_KEYGEN_ACL_ATTR_PMUX_SRC_DST_CONT_0_HM;
                        SHR_BITSET(keygen_md->acl_attrs[part].w, attr);
                    } else {
                        attr = BCMI_KEYGEN_ACL_ATTR_PMUX_SRC_DST_CONT_0;
                        SHR_BITSET(keygen_md->acl_attrs[part].w, attr);
                    }
                    break;
                case BCMI_KEYGEN_EXT_SECTION_SRC_DST_CONTAINER_1:
                    if (keygen_cfg->mode == BCMI_KEYGEN_MODE_SINGLE) {
                        attr = BCMI_KEYGEN_ACL_ATTR_PMUX_SRC_DST_CONT_1_HM;
                        SHR_BITSET(keygen_md->acl_attrs[part].w, attr);
                    } else {
                        attr = BCMI_KEYGEN_ACL_ATTR_PMUX_SRC_DST_CONT_1;
                        SHR_BITSET(keygen_md->acl_attrs[part].w, attr);
                    }
                    break;
                case BCMI_KEYGEN_EXT_SECTION_EM_FIRST_LOOKUP_CLASSID_BITS_0_3:
                    attr = BCMI_KEYGEN_ACL_ATTR_PMUX_EM_FIRST_LOOKUP_CLASSID_BITS_0_3;
                    SHR_BITSET(keygen_md->acl_attrs[part].w, attr);
                    break;
                case BCMI_KEYGEN_EXT_SECTION_EM_FIRST_LOOKUP_CLASSID_BITS_4_7:
                    attr = BCMI_KEYGEN_ACL_ATTR_PMUX_EM_FIRST_LOOKUP_CLASSID_BITS_4_7;
                    SHR_BITSET(keygen_md->acl_attrs[part].w, attr);
                    break;
                case BCMI_KEYGEN_EXT_SECTION_EM_FIRST_LOOKUP_CLASSID_BITS_8_11:
                    attr = BCMI_KEYGEN_ACL_ATTR_PMUX_EM_FIRST_LOOKUP_CLASSID_BITS_8_11;
                    SHR_BITSET(keygen_md->acl_attrs[part].w, attr);
                    break;
                case BCMI_KEYGEN_EXT_SECTION_EM_SECOND_LOOKUP_CLASSID_BITS_0_3:
                    attr = BCMI_KEYGEN_ACL_ATTR_PMUX_EM_SECOND_LOOKUP_CLASSID_BITS_0_3;
                    SHR_BITSET(keygen_md->acl_attrs[part].w, attr);
                    break;
                case BCMI_KEYGEN_EXT_SECTION_EM_SECOND_LOOKUP_CLASSID_BITS_4_7:
                    attr = BCMI_KEYGEN_ACL_ATTR_PMUX_EM_SECOND_LOOKUP_CLASSID_BITS_4_7;
                    SHR_BITSET(keygen_md->acl_attrs[part].w, attr);
                    break;
                case BCMI_KEYGEN_EXT_SECTION_EM_SECOND_LOOKUP_CLASSID_BITS_8_11:
                    attr = BCMI_KEYGEN_ACL_ATTR_PMUX_EM_SECOND_LOOKUP_CLASSID_BITS_8_11;
                    SHR_BITSET(keygen_md->acl_attrs[part].w, attr);
                    break;
                case BCMI_KEYGEN_EXT_SECTION_DST_CONTAINER_A:
                    attr = BCMI_KEYGEN_ACL_ATTR_PMUX_DST_CONTAINER_A;
                    SHR_BITSET(keygen_md->acl_attrs[part].w, attr);
                    break;
                ...
                case BCMI_KEYGEN_EXT_SECTION_LOOKUP_STATUS_VECTOR_BITS_0_3:
                    attr = BCMI_KEYGEN_ACL_ATTR_PMUX_LOOKUP_STATUS_VECTOR_BITS_0_3;
                    SHR_BITSET(keygen_md->acl_attrs[part].w, attr);
                    break;
                case BCMI_KEYGEN_EXT_SECTION_LOOKUP_STATUS_VECTOR_BITS_4_7:
                    attr = BCMI_KEYGEN_ACL_ATTR_PMUX_LOOKUP_STATUS_VECTOR_BITS_4_7;
                    SHR_BITSET(keygen_md->acl_attrs[part].w, attr);
                    break;
                case BCMI_KEYGEN_EXT_SECTION_PKT_RESOLUTION:
                    attr = BCMI_KEYGEN_ACL_ATTR_PMUX_PKT_RESOLUTION;
                    SHR_BITSET(keygen_md->acl_attrs[part].w, attr);
                    break;
                case BCMI_KEYGEN_EXT_SECTION_CLASS_ID_C:
                    attr = BCMI_KEYGEN_ACL_ATTR_PMUX_CLASS_ID_C;
                    SHR_BITSET(keygen_md->acl_attrs[part].w, attr);
                    break;
                case BCMI_KEYGEN_EXT_SECTION_CLASS_ID_D:
                    attr = BCMI_KEYGEN_ACL_ATTR_PMUX_CLASS_ID_D;
                    SHR_BITSET(keygen_md->acl_attrs[part].w, attr);
                    break;
                case BCMI_KEYGEN_EXT_SECTION_INT_PRI:
                    attr = BCMI_KEYGEN_ACL_ATTR_PMUX_INT_PRI;
                    SHR_BITSET(keygen_md->acl_attrs[part].w, attr);
                    break;
                case BCMI_KEYGEN_EXT_SECTION_IFP_DROP_VECTOR:
                    attr = BCMI_KEYGEN_ACL_ATTR_PMUX_IFP_DROP_VECTOR;
                    SHR_BITSET(keygen_md->acl_attrs[part].w, attr);
                    break;
                case BCMI_KEYGEN_EXT_SECTION_MH_OPCODE:
                    attr = BCMI_KEYGEN_ACL_ATTR_PMUX_MH_OPCODE;
                    SHR_BITSET(keygen_md->acl_attrs[part].w, attr);
                    break;
                case BCMI_KEYGEN_EXT_SECTION_LTID:
                    attr = BCMI_KEYGEN_ACL_ATTR_PMUX_LTID;
                    SHR_BITSET(keygen_md->acl_attrs[part].w, attr);
                    break;
                default:
