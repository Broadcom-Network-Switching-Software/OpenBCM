                               ...
                               bfd_sdk_msg_ctrl_sess_set_t *msg)
{
    ...
    if(BFD_UC_FEATURE_CHECK(BFD_FEATURE_L3IIF_VRF)) {
        _SHR_PACK_U16(buf, msg->vrf_id);
    }
   return buf;
}
                                 ...
                                 bfd_sdk_msg_ctrl_sess_get_t *msg)
{
    ...
    if(BFD_UC_FEATURE_CHECK(BFD_FEATURE_L3IIF_VRF)) {
        _SHR_UNPACK_U16(buf, msg->vrf_id);
    }
                                         ...
                                         bfd_sdk_msg_ctrl_discard_stat_get_t *msg)
{
    ...
    if(BFD_UC_FEATURE_CHECK(BFD_FEATURE_RX_DEBUG_CTRS_ENHANCED)) {
        _SHR_UNPACK_U32(buf, msg->bfd_mpls_fm_len_err);
        _SHR_UNPACK_U32(buf, msg->bfd_mpls_fm_type_err);
        _SHR_UNPACK_U32(buf, msg->bfd_echo_ipv4_mismatch);
        _SHR_UNPACK_U32(buf, msg->bfd_echo_ipv6_mismatch);
        _SHR_UNPACK_U32(buf, msg->bfd_ip_hdr_ver_err);
        _SHR_UNPACK_U32(buf, msg->bfd_mpls_no_label);
        _SHR_UNPACK_U32(buf, msg->bfd_gal_additional_label_miss);
        _SHR_UNPACK_U32(buf, msg->bfd_unknown_ach_type);
        _SHR_UNPACK_U32(buf, msg->bfd_vxlan_i_flag_err);
        _SHR_UNPACK_U32(buf, msg->bfd_ip_ttl_err);
        _SHR_UNPACK_U32(buf, msg->bfd_unsupported_echo_encap_err);
        _SHR_UNPACK_U32(buf, msg->bfd_unsupported_ethertype_err);
        _SHR_UNPACK_U32(buf, msg->bfd_ether_type_len_err);
        _SHR_UNPACK_U32(buf, msg->bfd_offset_err);
        _SHR_UNPACK_U32(buf, msg->bfd_malformed_pkt_err);
        _SHR_UNPACK_U32(buf, msg->bfd_malformed_ipv4_pkt_err);
        _SHR_UNPACK_U32(buf, msg->bfd_malformed_ipv6_pkt_err);
        _SHR_UNPACK_U32(buf, msg->bfd_malformed_mpls_pkt_err);
        _SHR_UNPACK_U32(buf, msg->bfd_sess_id_config_err);
        _SHR_UNPACK_U32(buf, msg->bfd_session_not_enabled);
        _SHR_UNPACK_U32(buf, msg->bfd_your_disc_zero);
        _SHR_UNPACK_U32(buf, msg->bfd_your_disc_mismatch);
        _SHR_UNPACK_U32(buf, msg->bfd_my_disc_mismatch);
        _SHR_UNPACK_U32(buf, msg->bfd_pkts_discarded_admin_down);
        _SHR_UNPACK_U32(buf, msg->bfd_echo_your_disc_zero);
        _SHR_UNPACK_U32(buf, msg->bfd_echo_your_disc_err);
        _SHR_UNPACK_U32(buf, msg->bfd_mpls_fm_sess_mismatch);
        _SHR_UNPACK_U32(buf, msg->bfd_non_cc_cv_err);
    }
...
uint8 *
bfd_sdk_msg_ctrl_l3iif_vrf_map_pack(uint8 *buf, bfd_sdk_msg_ctrl_l3iif_vrf_map_t *msg) {
    _SHR_PACK_U32(buf, msg->l3_iif);
    _SHR_PACK_U32(buf, msg->vrf_id);
...
bfd_sdk_msg_match_id_map_pack(uint8 *buf,
    ...
    if (!BFD_UC_FEATURE_CHECK(BFD_FEATURE_VXLAN)) {
        msg->match_id_types -= 3;
    }
