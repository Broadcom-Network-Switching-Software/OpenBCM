...
#define LARGE_SCALE_NAT_MC_ARG2REG(arg) \
    ((arg)==BCM_L3MC_NAT_NONE ? 0 : \
     ...
     (arg)==BCM_L3MC_DNAPT_SNAPT_WITH_MACDA_UPDATE ? 6 : \
     (arg)==BCM_L3MC_DNAPT_SNAT ? 7 : \
     (arg)==BCM_L3MC_DNAPT_SNAT_WITH_MACDA_UPDATE ? 7 : -1)
...
#define LARGE_SCALE_NAT_MC_REG2ARG(val, da) \
    ((val)==1 && !(da) ? BCM_L3MC_DNAT : \
     ...
     (val)==6 &&  (da) ? BCM_L3MC_DNAPT_SNAPT_WITH_MACDA_UPDATE : \
     (val)==7 && !(da) ? BCM_L3MC_DNAPT_SNAT : \
     (val)==7 &&  (da) ? BCM_L3MC_DNAPT_SNAT_WITH_MACDA_UPDATE : 0)
...
#define LARGE_SCALE_NAT_DA_UPDATE(arg) \
    ((arg)==BCM_L3MC_DNAT_WITH_MACDA_UPDATE || \
     ...
     (arg)==BCM_L3MC_DNAPT_SNAT_WITH_MACDA_UPDATE)
...
bcm_switch_binding_t trident3_bindings[] =
{
   ...
   { bcmSwitchRemoteLearnTrust, 0,
    ...
    { bcmSwitchHashSctpL4Port, 1,
        ING_SCTP_CONTROLr, PARSE_SCTPf, NULL, 0},
    { bcmSwitchSrv6PayloadTpid, 1,
        SRV6_CONTROLr, PYLD_L2_OTPIDf,
        NULL, soc_feature_srv6_enable},
    { bcmSwitchSrv6Adapt1MatchPayloadOvidEnable, 1,
        TUNNEL_ADAPT_1_SRV6_CTRLr, PAYLOAD_OVID_ENABLEf,
        NULL, soc_feature_srv6_enable},
    { bcmSwitchSrv6Adapt2MatchPayloadOvidEnable, 1,
        TUNNEL_ADAPT_2_SRV6_CTRLr, PAYLOAD_OVID_ENABLEf,
        NULL, soc_feature_srv6_enable},
    { bcmSwitchSrv6Adapt1SrhAction, 1,
        TUNNEL_ADAPT_1_SRV6_CTRLr, SRH_FUNCTION_SELECTf,
        NULL, soc_feature_srv6_enable},
    { bcmSwitchSrv6Adapt2SrhAction, 1,
        TUNNEL_ADAPT_2_SRV6_CTRLr, SRH_FUNCTION_SELECTf,
        NULL, soc_feature_srv6_enable},
    { bcmSwitchSrv6Adapt4SrhAction, 1,
        TUNNEL_ADAPT_4_SRV6_CTRLr, SRH_FUNCTION_SELECTf,
        NULL, soc_feature_srv6_enable},
    { bcmSwitchSrv6Adapt1NonSrhAction, 1,
        TUNNEL_ADAPT_1_SRV6_CTRLr, FUNCTION_SELECTf,
        NULL, soc_feature_srv6_enable},
    { bcmSwitchSrv6Adapt2NonSrhAction, 1,
        TUNNEL_ADAPT_2_SRV6_CTRLr, FUNCTION_SELECTf,
        NULL, soc_feature_srv6_enable},
    { bcmSwitchSrv6Adapt4NonSrhAction, 1,
        TUNNEL_ADAPT_4_SRV6_CTRLr, FUNCTION_SELECTf,
        NULL, soc_feature_srv6_enable},
    { bcmSwitchSrv6Adapt1DipPrefix1Len, 1,
        TUNNEL_ADAPT_1_SRV6_CTRLr, DIP_PREFIX1_LENGTHf,
        NULL, soc_feature_srv6_enable},
    { bcmSwitchSrv6Adapt2DipPrefix1Len, 1,
        TUNNEL_ADAPT_2_SRV6_CTRLr, DIP_PREFIX1_LENGTHf,
        NULL, soc_feature_srv6_enable},
    { bcmSwitchSrv6Adapt4DipPrefix1Len, 1,
        TUNNEL_ADAPT_4_SRV6_CTRLr, DIP_PREFIX1_LENGTHf,
        NULL, soc_feature_srv6_enable},
    { bcmSwitchSrv6Adapt2DipPrefix2Len, 1,
        TUNNEL_ADAPT_2_SRV6_CTRLr, DIP_PREFIX2_LENGTHf,
        NULL, soc_feature_srv6_enable},
    { bcmSwitchSrv6Adapt4DipPrefix2Len, 1,
        TUNNEL_ADAPT_4_SRV6_CTRLr, DIP_PREFIX2_LENGTHf,
        NULL, soc_feature_srv6_enable},
    { bcmSwitchSrv6Adapt1MatchNextHeaderEnable, 1,
        TUNNEL_ADAPT_1_SRV6_CTRLr, NEXT_HEADER_ENABLEf,
        NULL, soc_feature_srv6_enable},
    { bcmSwitchSrv6Adapt2MatchNextHeaderEnable, 1,
        TUNNEL_ADAPT_2_SRV6_CTRLr, NEXT_HEADER_ENABLEf,
        NULL, soc_feature_srv6_enable},
    { bcmSwitchSrv6Adapt4MatchNextHeaderEnable, 1,
        TUNNEL_ADAPT_4_SRV6_CTRLr, NEXT_HEADER_ENABLEf,
        NULL, soc_feature_srv6_enable},
    { bcmSwitchSrv6SidMode, 1,
        SRV6_CSID_MODEr, MODEf,
        NULL, soc_feature_srv6_enable},
    { bcmSwitchSrv6UsidPrefix1, 1,
        SRV6_USID_CONFIGr, PREFIX_1_SIZEf,
        NULL, soc_feature_srv6_enable},
    { bcmSwitchSrv6UsidPrefix2, 1,
        SRV6_USID_CONFIGr, PREFIX_2_SIZEf,
        NULL, soc_feature_srv6_enable},
    { bcmSwitchSrv6GsidPrefix1, 1,
        SRV6_GSID_CONFIGr, PREFIX_1_SIZEf,
        NULL, soc_feature_srv6_enable},
    { bcmSwitchSrv6GsidPrefix2, 1,
        SRV6_GSID_CONFIGr, PREFIX_2_SIZEf,
        NULL, soc_feature_srv6_enable},
    { bcmSwitchSrv6FunctionSelect1, 1,
        EGR_SRV6_CONFIGr, FUNCTION_OFFSET1_AND_SIZE1f,
        NULL, soc_feature_srv6_enable},
    { bcmSwitchSrv6FunctionSelect2, 1,
        EGR_SRV6_CONFIGr, FUNCTION_OFFSET2_AND_SIZE2f,
        NULL, soc_feature_srv6_enable},
    { bcmSwitchSrv6EsiFilterEnable, 1,
        EGR_SRV6_CONFIGr, ESI_FILTER_ENABLEf,
        NULL, soc_feature_srv6_enable},
    { bcmSwitchSrv6EsiInsertEnable, 1,
        EGR_SRV6_CONFIGr, ESI_INSERT_ENABLEf,
        NULL, soc_feature_srv6_enable},
    { bcmSwitchSrv6EsiOffsetSelect, 1,
        EGR_SRV6_CONFIGr, ESI_OFFSETf,
        NULL, soc_feature_srv6_enable},
    { bcmSwitchSrv6RwUpperBitsDuringSwap, 1,
        EGR_SRV6_CONFIGr, RW_UPPER_96_BITS_DURING_128_BITS_SWAPf,
        NULL, soc_feature_srv6_enable},
    { bcmSwitchSrv6IngLookupSipAssignSvp, 1,
        ING_SRV6_CONFIGr, LOOKUP_SIP_ASSIGN_SVPf,
        NULL, soc_feature_srv6_enable},
...
/*
 * Check parameter range for SRv6 related switch controls
 */
static int
_bcm_td3_switch_control_srv6_para_check(int unit,
                                       bcm_switch_control_t type,
                                       int arg)
{
    if (!soc_feature(unit, soc_feature_srv6_enable)) {
        /*
         * If SRv6 feature is not enabled, return E_NONE
         * to move logic through. Feature unavailable
         * check will be done at binding steps.
         */
        return BCM_E_NONE;
    }

    switch(type) {
        /* Support to BCM_TD3_SRV6_ADAPT_MAX_MODE */
        case bcmSwitchSrv6Adapt1SrhAction:
        case bcmSwitchSrv6Adapt2SrhAction:
        case bcmSwitchSrv6Adapt4SrhAction:
        case bcmSwitchSrv6Adapt1NonSrhAction:
        case bcmSwitchSrv6Adapt2NonSrhAction:
        case bcmSwitchSrv6Adapt4NonSrhAction:
             if (arg > BCM_TD3_SRV6_ADAPT_MAX_MODE) {
                 return BCM_E_PARAM;
             }
             break;

        /* Takes one bit input */
        case bcmSwitchSrv6Adapt1MatchPayloadOvidEnable:
        case bcmSwitchSrv6Adapt2MatchPayloadOvidEnable:
        case bcmSwitchSrv6Adapt1MatchNextHeaderEnable:
        case bcmSwitchSrv6Adapt2MatchNextHeaderEnable:
        case bcmSwitchSrv6Adapt4MatchNextHeaderEnable:
        case bcmSwitchSrv6EsiFilterEnable:
        case bcmSwitchSrv6EsiInsertEnable:
        case bcmSwitchSrv6EsiOffsetSelect:
        case bcmSwitchSrv6RwUpperBitsDuringSwap:
        case bcmSwitchSrv6IngLookupSipAssignSvp:
             if (arg >  BCM_TD3_SRV6_ACTION_ENABLE) {
                 return BCM_E_PARAM;
             }
             break;

        /* Supports to value 2
         * #define BCM_SWITCH_SRV6_CSID_MODE_GSID  2
         */
        case bcmSwitchSrv6SidMode:
             if (arg >  BCM_SWITCH_SRV6_CSID_MODE_GSID) {
                 return BCM_E_PARAM;
             }
             break;

        /* Supports to value 2.
         * #define BCM_SWITCH_SRV6_FUNCTION_OFFSET_64_SIZE_32BIT 2
         */
        case bcmSwitchSrv6FunctionSelect1:
        case bcmSwitchSrv6FunctionSelect2:
             if (arg >  BCM_SWITCH_SRV6_FUNCTION_OFFSET_64_SIZE_32BIT) {
                 return BCM_E_PARAM;
             }
             break;

        /*
         * USID supports to value 3
         * #define BCM_SWITCH_SRV6_USID_PREFIX_48BIT   3
         */
        case bcmSwitchSrv6UsidPrefix1:
        case bcmSwitchSrv6UsidPrefix2:
             if (arg >  BCM_SWITCH_SRV6_USID_PREFIX_48BIT) {
                 return BCM_E_PARAM;
             }
             break;

        /*
         * GSID supports to value 5
         * #define BCM_SWITCH_SRV6_GSID_PREFIX_64BIT   4
         */
        case bcmSwitchSrv6GsidPrefix1:
        case bcmSwitchSrv6GsidPrefix2:
             if (arg >  BCM_SWITCH_SRV6_GSID_PREFIX_64BIT) {
                 return BCM_E_PARAM;
             }
             break;
        ...
        /*
         * Supports up to 16.
         * #define BCM_SWITCH_SRV6_DIP_PREFIX_96BIT    16
         */
        case bcmSwitchSrv6Adapt1DipPrefix1Len:
        case bcmSwitchSrv6Adapt2DipPrefix1Len:
        case bcmSwitchSrv6Adapt4DipPrefix1Len:
        case bcmSwitchSrv6Adapt2DipPrefix2Len:
        case bcmSwitchSrv6Adapt4DipPrefix2Len:
             if (arg >  BCM_SWITCH_SRV6_DIP_PREFIX_96BIT) {
                 return BCM_E_PARAM;
             }
        default:
            break;
                                ...
                                int arg, int *found)
{
    ...
    *found = 0;
    ...
    /* Check SRv6 related parameter range */
    rv = _bcm_td3_switch_control_srv6_para_check(unit, type, arg);
    if (rv != BCM_E_NONE) {
       return rv;
    }
    ...
    for (i = 0; i < COUNTOF(trident3_bindings); i++) {
        ...
        if ((b->type == type) && (b->chip == 1)) {
            ...
            /* Both MODEf and MODE1f need to be programmed the same
             * for SRV6_CSID_MODE.
             */
            if (type == bcmSwitchSrv6SidMode) {
                soc_reg64_field32_set(unit, b->reg, &val64, MODE1f,
                                ((uint32)fval > max) ? max : (uint32)fval);
            }
...
/*
 * Function:
 *      _bcm_td3_vxlan_gbp_flex_controls_set
 * Purpose:
 *      Set relevant controls for VXLAN GPB flex flow.
 * Parameters:
 *      unit - SOC unit number.
 *      type - Switch control type.
 *      arg  - Field value to set.
 * Returns:
 *      BCM_E_XXX.
 */
int
_bcm_td3_vxlan_gbp_flex_controls_set(int unit,
                                     bcm_switch_control_t type,
                                     int arg)
{
    switch(type) {
        case bcmSwitchVxlanGbpFlexEnable:
             if (arg < 0 || arg > 1) {
                 return BCM_E_PARAM;
             }
             SOC_IF_ERROR_RETURN
             (soc_reg_field32_modify(unit, ING_FLEX_CONFIGr,
                                    REG_PORT_ANY, FLEX_VXLAN_GBP_ENABLEf,
                                    arg));
             break;
        case bcmSwitchVxlanGbpFlags:
             if (arg < 0 || arg > 0xFFFF) {
                return BCM_E_PARAM;
             }
             SOC_IF_ERROR_RETURN
             (soc_reg_field32_modify(unit, EGR_VXLAN_GBP_CONTROLr,
                                    REG_PORT_ANY, VXLAN_FLAGSf,
                                    arg));
             break;
        default:
            break;
...
/*
 * Function:
 *      _bcm_td3_vxlan_gbp_flex_controls_get
 * Purpose:
 *      Get relevant controls for VXLAN GPB flex flow.
 * Parameters:
 *      unit - SOC unit number.
 *      type - Switch control type.
 *      arg  - Field value to get.
 * Returns:
 *      BCM_E_XXX.
 */
int
_bcm_td3_vxlan_gbp_flex_controls_get(int unit,
                                     bcm_switch_control_t type,
                                     int *arg)
{
    uint32 reg = 0;
    switch(type) {
        case bcmSwitchVxlanGbpFlexEnable:
             SOC_IF_ERROR_RETURN(READ_ING_FLEX_CONFIGr(unit, &reg));
             *arg = soc_reg_field_get(unit, ING_FLEX_CONFIGr,
                        reg, FLEX_VXLAN_GBP_ENABLEf);
             break;
        case bcmSwitchVxlanGbpFlags:
             SOC_IF_ERROR_RETURN(READ_EGR_VXLAN_GBP_CONTROLr(unit, &reg));
             *arg = soc_reg_field_get(unit, EGR_VXLAN_GBP_CONTROLr,
                        reg, VXLAN_FLAGSf);
             break;
        default:
            break;
