 ...
 *      bcm_esw_ptp_clock_port_delay_asymmetry_get
 *      bcm_esw_ptp_clock_port_delay_asymmetry_set
...
_bcm_esw_ptp_hw_clear(int unit)
{
    ...
    if (!SOC_IS_TRIDENT2PLUS(unit) && !SOC_IS_TRIDENT2(unit) &&
        ...
        !(SOC_IS_FIRELIGHT(unit)) && !(SOC_IS_MONTEREY(unit))) {
 ...
 *      clock_num - PTP clock number
 *      clock_port - PTP clock port number
 *      *delay_asymmetry_ns - PTP clock port delay asymmetry (ns)
 * Returns:
 *      int
 * Notes:
 */
    ...
    int *delay_asymmetry_ns)
{
    ...
    rc = bcm_common_ptp_clock_port_delay_asymmetry_get(unit, ptp_id, clock_num, clock_port, delay_asymmetry_ns);
    ...
    int delay_asymmetry_ns)
{
    ...
    rc = bcm_common_ptp_clock_port_delay_asymmetry_set(unit, ptp_id, clock_num, clock_port, delay_asymmetry_ns);
...
/* APTS : This API is used to set APTS input source pins configurations */
int bcm_esw_ptp_clock_apts_input_source_set(
    int unit,
    bcm_ptp_stack_id_t ptp_id,
    int clock_num,
    ...
    bcm_ptp_clock_apts_input_source_config_t *input_source_config)
{
    ...
    rv = bcm_common_ptp_clock_apts_input_source_set(unit, ptp_id, clock_num, apts_source, input_source_config);

    return rv;
}

/* APTS : This API is used to get APTS input source pins configurations */
int bcm_esw_ptp_clock_apts_input_source_get(
    int unit,
    bcm_ptp_stack_id_t ptp_id,
    int clock_num,
    bcm_ptp_clock_apts_source_t apts_source,
    bcm_ptp_clock_apts_input_source_config_t *input_source_config)
{
    ...
    rv = bcm_common_ptp_clock_apts_input_source_get(unit, ptp_id, clock_num, apts_source, input_source_config);
...
/*
 * Function:
 *      bcm_esw_ptp_servo_performance_get
 * Purpose:
    ...
    bcm_ptp_servo_performance_t *perf)
{
    ...
    rv = bcm_common_ptp_servo_performance_get(unit, ptp_id, clock_num, perf);
...
/*
 * Function:
 *      bcm_esw_ptp_ntp_tod_offset_set
 * Purpose:
 *      Set PTP and NTP ToD offset
 * Parameters:
 *      unit      - (IN)  Unit number.
 *      ptp_id    - (IN)  PTP stack ID.
 *      clock_num - (IN)  PTP clock number.
 *      ptp_tod_offset - (IN) PTP ToD offset
 *      ntp_tod_offset - (IN) NTP ToD offset
 * Returns:
 *      BCM_E_XXX - Function status.
 * Notes:
 */
    ...
    bcm_ptp_time_spec_t *ntp_tod_offset)
{
    ...
    rv = bcm_common_ptp_ntp_tod_offset_set(unit, ptp_id, clock_num, flags,
                    ptp_tod_offset, ntp_tod_offset);
...
/*
 * Function:
 *      bcm_esw_ptp_ntp_tod_offset_get
 * Purpose:
 *      Get PTP and NTP ToD offset
 * Parameters:
 *      unit      - (IN)  Unit number.
 *      ptp_id    - (IN)  PTP stack ID.
 *      clock_num - (IN)  PTP clock number.
 *      ptp_tod_offset - (OUT) PTP ToD offset
 *      ntp_tod_offset - (OUT) NTP ToD offset
 * Returns:
 *      BCM_E_XXX - Function status.
 * Notes:
 */
    ...
    bcm_ptp_time_spec_t *ntp_tod_offset)
{
    ...
    rv = bcm_common_ptp_ntp_tod_offset_get(unit, ptp_id, clock_num, flags,
                    ptp_tod_offset, ntp_tod_offset);
