...
#if defined(INCLUDE_CCM) || defined(INCLUDE_BHH) || defined(INCLUDE_MPLS_LM_DM) || defined(INCLUDE_CCM_SLM)
...
#define _ETH_OAM_GROUP_ID_RANGE(_oc_, _id_)      \
    (((_id_) >= 0) && ((_id_) < ((_oc_)->eth_oam_group_count)))

#define _ETH_OAM_EP_ID_RANGE(_oc_, _id_)      \
    (((_id_) >= 0) && ((_id_) < ((_oc_)->eth_oam_ep_count)))
...
#endif /* INCLUDE_CCM || INCLUDE_BHH || INCLUDE_MPLS_LM_DM || INCLUDE_CCM_SLM */


/*******************************************************************************/
/* PM routines for BHH, MPLS LM/DM and ETH-OAM app start                       */
/*******************************************************************************/
#if defined(INCLUDE_BHH) || defined(INCLUDE_MPLS_LM_DM)
/*
 * Function:
...
int
_bcm_fp_oam_pm_raw_data_read_done(int unit,
 ...
 * Purpose:
 *     Register a callback for handling OAM PM events for BHH & MPLS LM/DM
 * Parameters:
 *     unit        - (IN) BCM device number
 ...
 */
int
_bcm_fp_oam_pm_event_register(int unit, bcm_oam_event_types_t event_types,
 ...
 * Purpose:
 *     Remove a registered event from the event handler list for
 *     BHH & MPLS LM/DM.
 * Parameters:
 *     unit        - (IN) BCM device number
 *     event_types - (IN) The set of OAM PM events for which the specified
 ...
 */
int
_bcm_fp_oam_pm_event_unregister(int unit, bcm_oam_event_types_t event_types,
...
#if defined(INCLUDE_BHH) || defined(INCLUDE_MPLS_LM_DM) || defined(INCLUDE_CCM_SLM)
/*
 * Function:
 *     bcm_fp_oam_pm_event_register
 * Purpose:
                             ...
                             bcm_oam_pm_event_cb cb, void *user_data)
{
...
#if defined(INCLUDE_BHH) || defined(INCLUDE_MPLS_LM_DM)
    if (_BCM_FP_OAM_EVENT_TYPE_PM_EVENT(event_types)) {
        rv = _bcm_fp_oam_pm_event_register(unit, event_types, cb, user_data);
        if (rv != BCM_E_NONE) {
            _BCM_OAM_UNLOCK(oc);
            return rv;
        }
    ...
    if (SHR_BITGET(event_types.w, bcmOAMEventEthLmDmRawData)) {
        if (oc->eth_oam_init) {
            rv = _bcm_mo_eth_oam_pm_event_register(unit, event_types,
                                                   cb, user_data);
            if (rv != BCM_E_NONE) {
                _BCM_OAM_UNLOCK(oc);
                return rv;
                               ...
                               bcm_oam_pm_event_cb cb)
{
...
#if defined(INCLUDE_BHH) || defined(INCLUDE_MPLS_LM_DM)
    if (_BCM_FP_OAM_EVENT_TYPE_PM_EVENT(event_types)) {
        rv = _bcm_fp_oam_pm_event_unregister(unit, event_types, cb);
        if (rv != BCM_E_NONE) {
            _BCM_OAM_UNLOCK(oc);
            return rv;
        }
    ...
    if (SHR_BITGET(event_types.w, bcmOAMEventEthLmDmRawData)) {
        if (oc->eth_oam_init) {
            rv = _bcm_mo_eth_oam_pm_event_unregister(unit, event_types, cb);
            if (rv != BCM_E_NONE) {
                _BCM_OAM_UNLOCK(oc);
                return rv;
            }
...
/*
 * Function:
 *     bcm_fp_oam_pm_raw_data_read_done
 * Purpose:
                                 ...
                                 uint32 read_index)
{
...
#if defined(INCLUDE_BHH) || defined(INCLUDE_MPLS_LM_DM)
    if (_BCM_FP_OAM_EVENT_TYPE_PM_EVENT(event_types)) {
        rv = _bcm_fp_oam_pm_raw_data_read_done(unit, event_types, read_index);
        if (rv != BCM_E_NONE) {
            _BCM_OAM_UNLOCK(oc);
            return rv;
        }
    ...
    if (SHR_BITGET(event_types.w, bcmOAMEventEthLmDmRawData)) {
        if (oc->eth_oam_init) {
            rv = _bcm_mo_eth_oam_pm_raw_data_read_done(unit, event_types,
                                                       read_index);
            if (rv != BCM_E_NONE) {
                _BCM_OAM_UNLOCK(oc);
                return rv;
...
#endif /* INCLUDE_BHH || INCLUDE_MPLS_LM_DM || INCLUDE_CCM_SLM */

/*******************************************************************************/
/* PM routines for BHH, MPLS LM/DM & ETH-OAM app end                           */
/*******************************************************************************/
...
int _bcm_fp_oam_ccm_trunk_ports_update_trunk_id(int unit, bcm_trunk_t trunk_id);
...
bcm_fp_oam_ccm_endpoint_create(int unit, bcm_oam_endpoint_info_t *endpoint_info)
{
    ...
    if (!(endpoint_info->flags & BCM_OAM_ENDPOINT_REPLACE)) {
        ...
        if (trunk_id != BCM_TRUNK_INVALID) {
            rv = _bcm_fp_oam_ccm_trunk_ports_update_trunk_id(unit, trunk_id);
            if (BCM_FAILURE(rv)) {
...
/*
 * Function:
 *     _bcm_fp_oam_ccm_port_trunk_update_msg_send
 * Purpose:
 ...
 */
static int
_bcm_fp_oam_ccm_port_trunk_update_msg_send(int unit, uint16 num_ports,
...
/*
 * Function:
 *     _bcm_fp_oam_ccm_port_trunk_map_get
 * Purpose:
 ...
 */
static int
_bcm_fp_oam_ccm_port_trunk_map_get(int unit, uint16 *num_ports,
                                   uint16 trunk_id, uint16 *list_of_ports)
{
...
int
_bcm_fp_oam_ccm_trunk_ports_update(int unit, bcm_gport_t trunk_gport,
                                   ...
                                   uint8 delete)
{
    ...
    if (delete) {
        rv = _bcm_fp_oam_ccm_port_trunk_update_msg_send(
...
int _bcm_fp_oam_ccm_trunk_ports_update_trunk_id(int unit, bcm_trunk_t trunk_id)
{
    ...
    rv = _bcm_fp_oam_ccm_port_trunk_update_msg_send(unit, local_member_count,
...
int
_bcm_fp_oam_ccm_trunk_ports_get (int unit, bcm_gport_t trunk_gport,
                                 int max_ports, bcm_gport_t *port_arr,
                                 int *port_count)
{
    ...
    rv = _bcm_fp_oam_ccm_port_trunk_map_get(
...
#if defined(INCLUDE_CCM_SLM)
    if (oc->eth_oam_init) {
        rv = _bcm_mo_eth_oam_event_register(unit, event_types, cb, user_data);
        if (rv != BCM_E_NONE) {
            _BCM_OAM_UNLOCK(oc);
            return rv;
        }
...
#if defined(INCLUDE_CCM_SLM)
    if (oc->eth_oam_init) {
        rv = _bcm_mo_eth_oam_event_unregister(unit, event_types, cb);
        if (rv != BCM_E_NONE) {
            _BCM_OAM_UNLOCK(oc);
            return rv;
        }
...
#if defined(INCLUDE_CCM_SLM)
    if (soc_feature(unit, soc_feature_uc_ccm_slm)) {
        /*
         * Get endpoint firmware table index count values and initialize device
         * OAM control structure members variables.
         * CCM & CCM_SLM are mutually exclusive, so the endpoint and group ID
         * space are the same.
         */
        oc->eth_oam_group_count = soc_property_get(unit,
                                                   spn_ETH_OAM_MAX_GROUPS,
                                                   128);

        oc->eth_oam_ep_count = oc->eth_oam_group_count +
                               soc_property_get(unit, spn_ETH_OAM_MAX_RMEPS, 256);
    }
#endif /* INCLUDE_CCM */
...
bcm_fp_oam_endpoint_create(int unit, bcm_oam_endpoint_info_t *endpoint_info)
{
    ...
    if (soc_feature(unit, soc_feature_uc_ccm_slm)) {
        if (endpoint_info->type  == bcmOAMEndpointTypeEthernet) {
            rv = _bcm_mo_eth_oam_endpoint_create(unit, endpoint_info);
        }
    }
#endif /* INCLUDE_CCM_SLM */
...
#if defined (INCLUDE_CCM_SLM)
    if (soc_feature(unit, soc_feature_uc_ccm_slm)) {
        if (_ETH_OAM_EP_ID_RANGE(oc, endpoint)) {
            rv = _bcm_mo_eth_oam_endpoint_get(unit, endpoint, endpoint_info);
        }
    }
#endif /* INCLUDE_CCM_SLM */
...
bcm_fp_oam_endpoint_destroy(int unit, bcm_oam_endpoint_t endpoint)
{
    ...
    if (soc_feature(unit, soc_feature_uc_ccm_slm)) {
        if (_ETH_OAM_EP_ID_RANGE(oc, endpoint)) {
            rv = _bcm_mo_eth_oam_endpoint_destroy(unit, endpoint);
        }
    }
#endif /* INCLUDE_CCM_SLM */
...
#if defined (INCLUDE_CCM_SLM)
    if (soc_feature(unit, soc_feature_uc_ccm_slm)) {
        if (_ETH_OAM_GROUP_ID_RANGE(oc, group)) {
            rv = _bcm_mo_eth_oam_endpoint_destroy_all(unit, group);
        }
    }
#endif /* INCLUDE_CCM_SLM */
...
{    int rv = BCM_E_PARAM; /* Operation return status */
    ...
    if (soc_feature(unit, soc_feature_uc_ccm_slm)) {
        if (_ETH_OAM_GROUP_ID_RANGE(oc, group)) {
            rv = _bcm_mo_eth_oam_endpoint_traverse(unit, group, cb, user_data);
        }
    }
#endif /* INCLUDE_CCM_SLM */
...
#if defined (INCLUDE_CCM_SLM)
    if (soc_feature(unit, soc_feature_uc_ccm_slm)) {
        if (!(group_info->flags  & BCM_OAM_GROUP_TYPE_BHH)) {
            rv = _bcm_mo_eth_oam_group_create(unit, group_info);
        }
    }
#endif /* INCLUDE_CCM_SLM */
                         ...
                         bcm_oam_group_info_t *group_info)
{
    ...
    if (soc_feature(unit, soc_feature_uc_ccm_slm)) {
        if (_ETH_OAM_GROUP_ID_RANGE(oc, group)) {
            rv = _bcm_mo_eth_oam_group_get(unit, group, group_info);
        }
    }
#endif /* INCLUDE_CCM_SLM */
...
bcm_fp_oam_group_destroy(int unit, bcm_oam_group_t group)
{
    ...
    if (soc_feature(unit, soc_feature_uc_ccm_slm)) {
        if (_ETH_OAM_GROUP_ID_RANGE(oc, group)) {
            rv = _bcm_mo_eth_oam_group_destroy(unit, group);
        }
    }
#endif /* INCLUDE_CCM_SLM */
...
#if defined (INCLUDE_CCM_SLM)
    if (soc_feature(unit, soc_feature_uc_ccm_slm)) {
        rv = _bcm_mo_eth_oam_group_destroy_all(unit);
        if (rv != BCM_E_NONE) {
            _BCM_OAM_UNLOCK(oc);
            return rv;
        }
...
#if defined (INCLUDE_CCM_SLM)
    if (soc_feature(unit, soc_feature_uc_ccm_slm)) {
        rv = _bcm_mo_eth_oam_group_traverse(unit, cb, user_data);
        if (rv != BCM_E_NONE) {
            _BCM_OAM_UNLOCK(oc);
            return rv;
        }
...
#if defined (INCLUDE_CCM_SLM)
    if(soc_feature(unit, soc_feature_uc_ccm_slm)) {
        if(_ETH_OAM_EP_ID_RANGE(oc, loss_p->id)) {
            rv = _bcm_mo_eth_oam_loss_add(unit, loss_p);
        }
    }
#endif /* INCLUDE_CCM_SLM */

    _BCM_OAM_UNLOCK(oc);
#endif /* INCLUDE_BHH || INCLUDE_MPLS_LM_DM || INCLUDE_CCM_SLN */
    return rv;
}
...
bcm_fp_oam_loss_get(int unit, bcm_oam_loss_t *loss_p)
{
    ...
    if(soc_feature(unit, soc_feature_uc_ccm_slm)) {
        if(_ETH_OAM_EP_ID_RANGE(oc, loss_p->id)) {
            rv = _bcm_mo_eth_oam_loss_get(unit, loss_p);
        }
    }
#endif /* INCLUDE_CCM_SLM */
...
bcm_fp_oam_loss_delete(int unit, bcm_oam_loss_t *loss_p)
{
    ...
    if(soc_feature(unit, soc_feature_uc_ccm_slm)) {
        if(_ETH_OAM_EP_ID_RANGE(oc, loss_p->id)) {
            rv = _bcm_mo_eth_oam_loss_delete(unit, loss_p);
        }
    }
#endif /* INCLUDE_CCM_SLM */
...
#if defined(INCLUDE_MPLS_LM_DM)
    if (soc_feature(unit, soc_feature_mpls_lm_dm)) {
        rv = _bcm_fp_oam_mpls_lm_dm_sync(unit);
        if (rv != BCM_E_NONE) {
            _BCM_OAM_UNLOCK(oc);
            return rv;
        }
...
#if defined(INCLUDE_CCM_SLM)
    if (soc_feature(unit, soc_feature_uc_ccm_slm)) {
        rv = _bcm_mo_oam_eth_oam_sync(unit);
        if (rv != BCM_E_NONE) {
            _BCM_OAM_UNLOCK(oc);
            return rv;
        }
...
#if defined (INCLUDE_CCM) || defined (INCLUDE_BHH) || defined(INCLUDE_MPLS_LM_DM) || defined(INCLUDE_CCM_SLM)
    if(soc_feature(unit, soc_feature_uc_ccm)     ||
       soc_feature(unit, soc_feature_uc_ccm_slm) ||
...
#if defined(INCLUDE_CCM_SLM)
    if (soc_feature(unit, soc_feature_uc_ccm_slm)) {
        BCM_IF_ERROR_RETURN(_bcm_mo_eth_oam_init(unit, &(oc->eth_oam_init)));
    }
                            ...
                            int max_ports, bcm_gport_t *port_arr)
{
    _bcm_fp_oam_control_t *oc  = NULL;
    int rv = BCM_E_UNAVAIL;
#if defined(INCLUDE_CCM) || defined(INCLUDE_CCM_SLM)
    int rv1 = BCM_E_NONE;
#endif /* INCLUDE_CCM || INCLUDE_CCM_SLM */

    BCM_IF_ERROR_RETURN(_bcm_fp_oam_control_get(unit, &oc));
    _BCM_OAM_LOCK(oc);

#if defined(INCLUDE_CCM)
    rv1 = _bcm_fp_oam_ccm_trunk_ports_update(unit, trunk_gport, max_ports, port_arr, 0);
    if (rv1 != BCM_E_NONE) {
        _BCM_OAM_UNLOCK(oc);
        return rv1;
    }
...
#if defined(INCLUDE_CCM_SLM)
    if (oc->eth_oam_init) {
        rv1 = _bcm_mo_eth_oam_trunk_ports_add(unit, trunk_gport, max_ports, port_arr);
        if (rv1 != BCM_E_NONE) {
            _BCM_OAM_UNLOCK(oc);
            return rv1;
        }
...
#if defined(INCLUDE_CCM)
    rv1 = _bcm_fp_oam_ccm_trunk_ports_update(unit, trunk_gport, max_ports, port_arr, 1);
    if (rv1 != BCM_E_NONE) {
        _BCM_OAM_UNLOCK(oc);
        return rv1;
    }
...
#if defined(INCLUDE_CCM_SLM)
    if (oc->eth_oam_init) {
        rv1 = _bcm_mo_eth_oam_trunk_ports_delete(unit, trunk_gport, max_ports, port_arr);
        if (rv1 != BCM_E_NONE) {
            _BCM_OAM_UNLOCK(oc);
            return rv1;
        }
...
#if defined(INCLUDE_CCM)
    rv1 = _bcm_fp_oam_ccm_trunk_ports_get(unit, trunk_gport, max_ports,
                                           port_arr, port_count);
    if (rv1 != BCM_E_NONE) {
        _BCM_OAM_UNLOCK(oc);
        return rv1;
...
#if defined(INCLUDE_CCM_SLM)
    if ((rv == BCM_E_UNAVAIL) && (oc->eth_oam_init)) {
        rv1 = _bcm_mo_eth_oam_trunk_ports_get(unit, trunk_gport, max_ports, port_arr, port_count);
        if (rv1 != BCM_E_NONE) {
            _BCM_OAM_UNLOCK(oc);
            return rv1;
        }
