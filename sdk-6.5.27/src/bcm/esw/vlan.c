...
#ifdef  BCM_VLAN_NO_DEFAULT_CPRI
        BCM_PBMP_REMOVE(vd.port_bitmap, PBMP_ROE_ALL(unit));
        BCM_PBMP_REMOVE(vd.ut_port_bitmap, PBMP_ROE_ALL(unit));
#endif  /* BCM_VLAN_NO_DEFAULT_CPRI */
