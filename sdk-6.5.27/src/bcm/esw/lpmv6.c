    ...
    if (soc_feature(unit, soc_feature_separate_key_for_ipmc_route) && ipmc) {
        ...
        if (SOC_IS_FIREBOLT6(unit)) {
            ...
            soc_mem_field_set(unit, L3_DEFIP_PAIR_128m, entry, IPMC_V6_ADDR_127_88_MASKf, ip6_word);
                    ...
                    _BCM_FLOW_SRV6_ENABLED(unit)) {
        uint32 ip6_word[2] = {0,0};

        /* set lower 44 bits */
        ip6_word[1] = (((ip6[10] & 0xf) << 8) | (ip6[11] << 0));
        ip6_word[0] = ((ip6[12] << 24) | (ip6[13] << 16) | (ip6[14] << 8) | (ip6[15] << 0));
        soc_mem_field_set(unit, L3_DEFIP_PAIR_128m, entry, SRV6_V6_ADDR_43_0_MASKf, ip6_word);
        /* set middle 44 bits */
        ip6_word[1] = ((ip6[5] << 4) | (ip6[6] >> 4));
        ip6_word[0] = (((ip6[6] & 0xf) << 28) | (ip6[7] << 20) | (ip6[8] << 12) |
                           (ip6[9] << 4) | (ip6[10] >> 4));
        soc_mem_field_set(unit, L3_DEFIP_PAIR_128m, entry, SRV6_V6_ADDR_87_44_MASKf, ip6_word);
        /* set upper 40 bits */
        ip6_word[1] = ip6[0];
        ip6_word[0] = ((ip6[1] << 24) | (ip6[2] << 16) | (ip6[3] << 8) | (ip6[4] << 0));
        soc_mem_field_set(unit, L3_DEFIP_PAIR_128m, entry, SRV6_V6_ADDR_127_88_MASKf, ip6_word);
    ...
    if (soc_feature(unit, soc_feature_separate_key_for_ipmc_route) &&
        ...
        if (SOC_IS_FIREBOLT6(unit)) {
            ...
            ip6_field[0] = (((ip6_word[1] & 0xff) << 24) | (ip6_word[0] >> 8));
               ...
               _BCM_FLOW_SRV6_ENABLED(unit) &&
               soc_mem_field32_get(unit, L3_DEFIP_PAIR_128m, entry,
                KEY_TYPE0_LWRf) == BCMI_LPM_SEPARATE_IPSRV6_KEY_TYPE) {
        uint32 ip6_word[2] = {0, 0};

        /* get lower 44 bits */
        soc_mem_field_get(unit, L3_DEFIP_PAIR_128m, entry, SRV6_V6_ADDR_43_0_MASKf, ip6_word);
        ip6_field[3] = ip6_word[0];
        ip6_field[2] = ip6_word[1] & 0xfff;
        /* get middle 44 bits */
        soc_mem_field_get(unit, L3_DEFIP_PAIR_128m, entry, SRV6_V6_ADDR_87_44_MASKf, ip6_word);
        ip6_field[2] |= ((ip6_word[0] & 0xfffff) << 12);
        ip6_field[1] = ip6_word[0] >> 20;
        ip6_field[1] |= ((ip6_word[1] & 0xfff) << 12);
        /* get upper 40 bits */
        soc_mem_field_get(unit, L3_DEFIP_PAIR_128m, entry, SRV6_V6_ADDR_127_88_MASKf, ip6_word);
        ip6_field[1] |= (ip6_word[0] & 0xff) << 24;
        ip6_field[0] = (((ip6_word[1] & 0xff) << 24) | (ip6_word[0] >> 8));
    } else
#endif
                                ...
                                const ip6_addr_t ip6, int ipmc)
{
    ...
    if (soc_feature(unit, soc_feature_separate_key_for_ipmc_route) && ipmc) {
        ...
        ip6_word[1] = (((ip6[10] & 0xf) << 8) | (ip6[11] << 0));
        ip6_word[0] = ((ip6[12] << 24) | (ip6[13] << 16) | (ip6[14] << 8) | (ip6[15] << 0));
        soc_mem_field_set(unit, L3_DEFIP_PAIR_128m, entry, SRV6_V6_ADDR_43_0f, ip6_word);
        /* set middle 44 bits */
        ip6_word[1] = ((ip6[5] << 4) | (ip6[6] >> 4));
        ip6_word[0] = (((ip6[6] & 0xf) << 28) | (ip6[7] << 20) | (ip6[8] << 12) |
                           (ip6[9] << 4) | (ip6[10] >> 4));
        soc_mem_field_set(unit, L3_DEFIP_PAIR_128m, entry, SRV6_V6_ADDR_87_44f, ip6_word);
        /* set upper 40 bits */
        ip6_word[1] = ip6[0];
        ip6_word[0] = ((ip6[1] << 24) | (ip6[2] << 16) | (ip6[3] << 8) | (ip6[4] << 0));
        soc_mem_field_set(unit, L3_DEFIP_PAIR_128m, entry, SRV6_V6_ADDR_127_88f, ip6_word);
                                ...
                                ip6_addr_t ip6)
{
    ...
    if (soc_feature(unit, soc_feature_separate_key_for_ipmc_route) &&
        ...
        /* get lower 44 bits */
        soc_mem_field_get(unit, L3_DEFIP_PAIR_128m, entry, SRV6_V6_ADDR_43_0f, ip6_word);
        ip6_field[3] = ip6_word[0];
        ip6_field[2] = ip6_word[1] & 0xfff;
        /* get middle 44 bits */
        soc_mem_field_get(unit, L3_DEFIP_PAIR_128m, entry, SRV6_V6_ADDR_87_44f, ip6_word);
        ip6_field[2] |= ((ip6_word[0] & 0xfffff) << 12);
        ip6_field[1] = ip6_word[0] >> 20;
        ip6_field[1] |= ((ip6_word[1] & 0xfff) << 12);
        /* get upper 40 bits */
        soc_mem_field_get(unit, L3_DEFIP_PAIR_128m, entry, SRV6_V6_ADDR_127_88f, ip6_word);
        ip6_field[1] |= (ip6_word[0] & 0xff) << 24;
        ip6_field[0] = (((ip6_word[1] & 0xff) << 24) | (ip6_word[0] >> 8));
    } else
#endif
    ...
    if (SOC_MEM_IS_VALID(unit, L3_DEFIP_PAIR_128m)) {
        ...
        if (soc_feature(unit, soc_feature_separate_key_for_ipmc_route) &&
           ...
           if (SOC_IS_FIREBOLT6(unit)) {
               ...
               _BCM_FLOW_SRV6_ENABLED(unit) &&
               soc_mem_field32_get(unit, L3_DEFIP_PAIR_128m, hw_entry,
                     KEY_TYPE0_LWRf) == BCMI_LPM_SEPARATE_IPSRV6_KEY_TYPE) {
            uint32 key_mask;

            key_mask = soc_mem_field32_get(unit, L3_DEFIP_PAIR_128m, hw_entry,
                                SRV6_V6_VRF_ID_3_0_MASKf);
            key_mask |= (soc_mem_field32_get(unit, L3_DEFIP_PAIR_128m,
                                hw_entry, SRV6_V6_VRF_ID_11_4_MASKf) << 4);
            if (!key_mask) {
                lpm_cfg->defip_vrf = BCM_L3_VRF_OVERRIDE;
            } else {
                lpm_cfg->defip_vrf = soc_mem_field32_get(unit,
                   L3_DEFIP_PAIR_128m, hw_entry, SRV6_V6_VRF_ID_3_0f);
                lpm_cfg->defip_vrf |= (soc_mem_field32_get(unit,
                   L3_DEFIP_PAIR_128m, hw_entry, SRV6_V6_VRF_ID_11_4f) << 4);
           }
        }
        else
#endif
...
STATIC void
_bcm_td3_lpm_pair128_ipsrv6_ent_init(int unit, _bcm_defip_cfg_t *lpm_cfg, uint32 *lpm_entry)
{
    soc_mem_field32_set(unit, L3_DEFIP_PAIR_128m, lpm_entry, KEY_TYPE0_LWRf,
                        BCMI_LPM_SEPARATE_IPSRV6_KEY_TYPE);
    soc_mem_field32_set(unit, L3_DEFIP_PAIR_128m, lpm_entry, KEY_TYPE1_LWRf,
                        BCMI_LPM_SEPARATE_IPSRV6_KEY_TYPE);
    soc_mem_field32_set(unit, L3_DEFIP_PAIR_128m, lpm_entry, KEY_TYPE0_UPRf,
                        BCMI_LPM_SEPARATE_IPSRV6_KEY_TYPE);
    soc_mem_field32_set(unit, L3_DEFIP_PAIR_128m, lpm_entry, KEY_TYPE1_UPRf,
                        BCMI_LPM_SEPARATE_IPSRV6_KEY_TYPE);
    soc_mem_field32_set(unit, L3_DEFIP_PAIR_128m, lpm_entry,
                        KEY_TYPE_MASK0_LWRf, 0xf);
    soc_mem_field32_set(unit, L3_DEFIP_PAIR_128m, lpm_entry,
                        KEY_TYPE_MASK1_LWRf, 0xf);
    soc_mem_field32_set(unit, L3_DEFIP_PAIR_128m, lpm_entry,
                        KEY_TYPE_MASK0_UPRf, 0xf);
    soc_mem_field32_set(unit, L3_DEFIP_PAIR_128m, lpm_entry,
                        KEY_TYPE_MASK1_UPRf, 0xf);
    soc_mem_field32_set(unit, L3_DEFIP_PAIR_128m, lpm_entry,
                        KEY_MODE1_UPRf, 0x3);
    soc_mem_field32_set(unit, L3_DEFIP_PAIR_128m, lpm_entry,
                        KEY_MODE0_UPRf, 0x3);
    ...
    soc_mem_field32_set(unit, L3_DEFIP_PAIR_128m, lpm_entry,
                        KEY_MODE0_LWRf, 0x3);
    soc_mem_field32_set(unit, L3_DEFIP_PAIR_128m, lpm_entry,
                        KEY_MODE_MASK1_UPRf, 0x3);
    soc_mem_field32_set(unit, L3_DEFIP_PAIR_128m, lpm_entry,
                        KEY_MODE_MASK0_UPRf, 0x3);
    soc_mem_field32_set(unit, L3_DEFIP_PAIR_128m, lpm_entry,
                        KEY_MODE_MASK1_LWRf, 0x3);
    soc_mem_field32_set(unit, L3_DEFIP_PAIR_128m, lpm_entry,
                        KEY_MODE_MASK0_LWRf, 0x3);
    if ((BCM_L3_VRF_OVERRIDE != lpm_cfg->defip_vrf) &&
        (BCM_L3_VRF_GLOBAL != lpm_cfg->defip_vrf)) {
        soc_mem_field32_set(unit, L3_DEFIP_PAIR_128m, lpm_entry,
                        SRV6_V6_VRF_ID_11_4f, (lpm_cfg->defip_vrf >> 4));
        soc_mem_field32_set(unit, L3_DEFIP_PAIR_128m, lpm_entry,
                        SRV6_V6_VRF_ID_3_0f, (lpm_cfg->defip_vrf & 0xf));
        soc_mem_field32_set(unit, L3_DEFIP_PAIR_128m, lpm_entry,
                        SRV6_V6_VRF_ID_11_4_MASKf, 0xff);
        soc_mem_field32_set(unit, L3_DEFIP_PAIR_128m, lpm_entry,
                        SRV6_V6_VRF_ID_3_0_MASKf, 0xf);
        soc_mem_field32_set(unit, L3_DEFIP_PAIR_128m, lpm_entry,
                        GLOBAL_ROUTEf, 0);
    } else { /* Override or GLO */
        soc_mem_field32_set(unit, L3_DEFIP_PAIR_128m, lpm_entry,
                        SRV6_V6_VRF_ID_11_4f, 0);
        soc_mem_field32_set(unit, L3_DEFIP_PAIR_128m, lpm_entry,
                        SRV6_V6_VRF_ID_3_0f, 0);
        soc_mem_field32_set(unit, L3_DEFIP_PAIR_128m, lpm_entry,
                        SRV6_V6_VRF_ID_11_4_MASKf, 0);
        soc_mem_field32_set(unit, L3_DEFIP_PAIR_128m, lpm_entry,
                        SRV6_V6_VRF_ID_3_0_MASKf, 0);
    }
}
#endif
                              ...
                              int nh_ecmp_idx) 
{
    ...
    uint32  entry_hit[SOC_MAX_MEM_FIELD_WORDS];
#endif
...
#if defined(BCM_TRIDENT3_SUPPORT)
        if (soc_feature(unit, soc_feature_flex_flow) &&
            _BCM_FLOW_SRV6_ENABLED(unit) && !vrf_done) {
            _bcm_td3_lpm_pair128_ipsrv6_ent_init(unit, lpm_cfg, hw_entry);
...
_bcm_l3_defip_deinit(int unit)
{
    ...
    if (soc_property_get(unit, spn_L3_ALPM_ENABLE, 0)) {
        if (soc_feature(unit, soc_feature_alpm)) {
            if (SOC_IS_TRIDENT2(unit) || SOC_IS_TRIDENT2PLUS(unit)) {
                (void) _bcm_td2_alpm_trace_deinit(unit);
            }
#if defined(BCM_TOMAHAWK_SUPPORT)
            else if (soc_feature(unit, soc_feature_alpm2)) {
                if (bcm_esw_alpm_inited(unit)) {
                    (void) bcm_esw_alpm_deinit(unit);
                }
            }
#endif
#if defined(BCM_TOMAHAWK_SUPPORT) || defined(BCM_APACHE_SUPPORT) || defined(BCM_TRIDENT3_SUPPORT)
