...
STATIC int _bcm_mo_eth_oam_init_status_scache_alloc(int unit, int create);
STATIC int _bcm_mo_eth_oam_wb_init_status_recover(int unit, int *init);
STATIC int _bcm_mo_eth_oam_cfg_scache_alloc(int unit, int create);
STATIC int _bcm_mo_eth_oam_wb_cfg_recover(int unit);
