...
/*
 * Function: _bcm_fb6_cosq_egr_queue_color_limit_mode_set
 * Purpose: Set color limit mode per queue to static (0) or
 *          dynamic (1)
*/

STATIC int
_bcm_fb6_cosq_egr_queue_color_limit_mode_set(int unit, bcm_gport_t gport,
                                             bcm_cos_queue_t cosq,
                                             bcm_cosq_control_t type,
                                             int arg)
{
...
/*
 * Function: _bcm_fb6_cosq_egr_queue_color_limit_set
...
STATIC int
_bcm_fb6_cosq_egr_queue_color_limit_set(int unit, bcm_gport_t gport,
                                        bcm_cos_queue_t cosq,
                                        bcm_cosq_control_t type,
                                        int arg)
{
...
/*
 * Function: _bcm_fb6_cosq_egr_queue_color_limit_mode_get
 * Purpose: Get color limit mode per queue.
 * Returns: 0 (static) or 1 (dynamic)
*/
STATIC int
_bcm_fb6_cosq_egr_queue_color_limit_mode_get(int unit, bcm_gport_t gport,
                                             bcm_cos_queue_t cosq,
                                             bcm_cosq_control_t type,
                                             int* arg)
{
...
/*
 * Function: _bcm_fb6_cosq_egr_queue_color_limit_get
...
STATIC int
_bcm_fb6_cosq_egr_queue_color_limit_get(int unit, bcm_gport_t gport,
                                        bcm_cos_queue_t cosq,
                                        bcm_cosq_control_t type,
                                        int* arg)
{
        ...
        bcm_cosq_control_t type, int arg)
{
    ...
    switch (type) {
        ...
        case bcmCosqControlEgressMCQueueColorLimitDynamicEnable:
            return _bcm_fb6_cosq_egr_queue_color_limit_mode_set(unit, gport, cosq,
                                                              type, arg);
        ...
        case bcmCosqControlEgressMCQueueYellowLimit:
            return _bcm_fb6_cosq_egr_queue_color_limit_set(unit, gport, cosq,
                                                         type, arg);
        default:
            break;
    }
        ...
        bcm_cosq_control_t type, int *arg)
{
    ...
    switch (type) {
        ...
        case bcmCosqControlEgressUCQueueColorLimitDynamicEnable:
        case bcmCosqControlEgressMCQueueColorLimitDynamicEnable:
            return _bcm_fb6_cosq_egr_queue_color_limit_mode_get(unit, gport, cosq,
                                                       type, arg);
        case bcmCosqControlEgressUCQueueYellowLimit:
        case bcmCosqControlEgressMCQueueYellowLimit:
            return _bcm_fb6_cosq_egr_queue_color_limit_get(unit, gport, cosq, type,
                                                       arg);
                        ...
                        uint32 *flags)
{
    ...
    if (node) {
        ...
        if (IS_CPU_PORT(unit, local_port)) {
            index = si->port_cosq_base[local_port];
            config_mem = SOC_MEM_UNIQUE_ACC(unit, MMU_MTRO_L1_MEMm)[pipe];
        } else {
                        ...
                        uint32 flags)
{
    ...
    if (IS_CPU_PORT(unit, local_port) && (refresh_rate_max == 0 && bucketsize_max > 0)) {
            soc_mem_field32_set(unit, config_mem, &entry, MAX_REFRESHf, 1);
    } else {
    ...
    if (IS_CPU_PORT(unit, local_port) && (refresh_rate_min == 0 && bucketsize_min > 0)) {
            soc_mem_field32_set(unit, config_mem, &entry, MIN_REFRESHf, 1);
    } else {
