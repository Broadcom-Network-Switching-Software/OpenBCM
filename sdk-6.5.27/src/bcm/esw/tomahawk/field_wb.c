...
#define _FP_IS_EM_WB_ACTION(_x_) (((_x_) == bcmFieldActionAssignOpaqueObject1)   \
                                ...
                                ||((_x_) == bcmFieldActionLoopbackCustomSubtype) \
...
char *elem_name[] = {
    ...
    "_bcmFieldInternalExtl2e4Sel",
    "_bcmFieldInternalExtl2e2Sel",
    "_bcmFieldInternalExtl2e1Sel",
    "_bcmFieldInternalExtDestContASel",
    "_bcmFieldInternalExtDestContBSel",
    "_bcmFieldInternalExtUdfSel",
    "_bcmFieldInternalExtIpbmSourceSel",
    "_bcmFieldInternalEMActionPbmLoopbackCustomSubtype",
...
static _field_type_map_t static_type_map[] = {
    ...
    {_bcmFieldInternalGroupDropMaskProfileAction,   4, _FP_WB_TLV_NO_TYPE
                                               | _FP_WB_TLV_LEN_PRESENT},
    { _bcmFieldInternalExtl2e4Sel,          1,  _FP_WB_TLV_NO_TYPE
                                                | _FP_WB_TLV_LEN_PRESENT},
    { _bcmFieldInternalExtl2e2Sel,          1,  _FP_WB_TLV_NO_TYPE
                                                | _FP_WB_TLV_LEN_PRESENT},
    { _bcmFieldInternalExtl2e1Sel,          2,  _FP_WB_TLV_NO_TYPE
                                                | _FP_WB_TLV_LEN_PRESENT},
    { _bcmFieldInternalExtDestContASel,     1,  _FP_WB_TLV_NO_TYPE},
    { _bcmFieldInternalExtDestContBSel,     1,  _FP_WB_TLV_NO_TYPE},
    { _bcmFieldInternalExtUdfSel,           1,  _FP_WB_TLV_NO_TYPE},
    { _bcmFieldInternalExtIpbmSourceSel,    1,  _FP_WB_TLV_NO_TYPE},
    { _bcmFieldInternalEMActionPbmLoopbackCustomSubtype,  4,  _FP_WB_TLV_LEN_PRESENT},
};
...
{                                                             \
    int _rv_;                                                 \
    _rv_ = (_field_tlv_validate_and_write(unit,tlv,ptr,pos)); \
    if (BCM_FAILURE(_rv_)) {                                  \
        sal_free(tlv);                                        \
        tlv = NULL;                                           \
                      ...
                      _field_ext_sel_t *ext_sel, int count)
{
    ...
    int type_ext_sel[40] = {   /* types in _field_ext_sel_t */
    ...
    (int) (_bcmFieldInternalExtAltTtlFnSel
           | (_bcmFieldInternalVariable << _FP_WB_TLV_BASIC_TYPE_SHIFT)),
    (int) (_bcmFieldInternalExtl2e4Sel
           | (_bcmFieldInternalArray << _FP_WB_TLV_BASIC_TYPE_SHIFT)),
    (int) (_bcmFieldInternalExtl2e2Sel
           | (_bcmFieldInternalArray << _FP_WB_TLV_BASIC_TYPE_SHIFT)),
    (int) (_bcmFieldInternalExtl2e1Sel
           | (_bcmFieldInternalArray << _FP_WB_TLV_BASIC_TYPE_SHIFT)),
    (int) (_bcmFieldInternalExtDestContASel
           | (_bcmFieldInternalVariable << _FP_WB_TLV_BASIC_TYPE_SHIFT)),
    (int) (_bcmFieldInternalExtDestContBSel
           | (_bcmFieldInternalVariable << _FP_WB_TLV_BASIC_TYPE_SHIFT)),
    (int) (_bcmFieldInternalExtUdfSel
           | (_bcmFieldInternalVariable << _FP_WB_TLV_BASIC_TYPE_SHIFT)),
    (int) (_bcmFieldInternalExtIpbmSourceSel
           | (_bcmFieldInternalVariable << _FP_WB_TLV_BASIC_TYPE_SHIFT)),
     ...
     * of elements in the current datastructure.
     */
    if (fc->wb_current_version < BCM_FIELD_WB_VERSION_1_34) {
    ...
    for (i = 0; i < count; i++) {
        ...
        if (fc->wb_current_version >= BCM_FIELD_WB_VERSION_1_34) {
            TLV_CREATE(_bcmFieldInternalExtl2e4Sel,
                                       _bcmFieldInternalArray, 16, &tlv);
            tlv->value = ext_sel_temp->l2_e4_sel;
            TLV_WRITE(unit,tlv,ptr,pos);

            TLV_CREATE(_bcmFieldInternalExtl2e2Sel,
                                       _bcmFieldInternalArray, 8, &tlv);
            tlv->value = ext_sel_temp->l2_e2_sel;
            TLV_WRITE(unit,tlv,ptr,pos);

            TLV_CREATE(_bcmFieldInternalExtl2e1Sel,
                                       _bcmFieldInternalArray, 6, &tlv);
             tlv->value = ext_sel_temp->l2_e1_sel;
             TLV_WRITE(unit,tlv,ptr,pos);

            TLV_CREATE(_bcmFieldInternalExtDestContASel,
                                       _bcmFieldInternalVariable, 1, &tlv);
            tlv->value = &ext_sel_temp->dst_cont_a_sel;
            TLV_WRITE(unit,tlv,ptr,pos);

            TLV_CREATE(_bcmFieldInternalExtDestContBSel,
                                       _bcmFieldInternalVariable, 1, &tlv);
            tlv->value = &ext_sel_temp->dst_cont_b_sel;
            TLV_WRITE(unit,tlv,ptr,pos);

            TLV_CREATE(_bcmFieldInternalExtUdfSel,
                                       _bcmFieldInternalVariable, 1, &tlv);
            tlv->value = &ext_sel_temp->udf_sel;
            TLV_WRITE(unit,tlv,ptr,pos);

            TLV_CREATE(_bcmFieldInternalExtIpbmSourceSel,
                                       _bcmFieldInternalVariable, 1, &tlv);
            tlv->value = &ext_sel_temp->ipbm_source;
            TLV_WRITE(unit,tlv,ptr,pos);
        }
...
_field_data_control_sync(int unit, _field_stage_t *stage_fc)
{
    ...
    while (temp != NULL)
    {
        rv = (_field_datacontroldataqualifier_sync(unit,temp));
        if (BCM_FAILURE(rv)) {
            sal_free(tlv);
            return rv;
        }
   ...
   int type_ltconf[10] = {          /* Types for _field_ltinfo_t structure */
    ...
    for (i = 0; i < num_pipes;i++) {
        ...
        for (j = 0; j < _FP_MAX_NUM_LT;j++) {
            rv = _field_ltinfo_sync(unit, fc->lt_info[i][j]);
            if (BCM_FAILURE(rv)) {
                 goto cleanup;
            }
        }
    ...
    if(!soc_feature(unit, soc_feature_td3_style_fp)) {
        rv = (_field_data_control_sync(unit, stage_fc));
        if (BCM_FAILURE(rv)) {
             goto cleanup;
        }
    }
...
_field_slice_sync(int unit, _field_slice_t *slice)
{
    ...
    rv = (_field_extractor_sync(unit, slice->ext_sel,
                                _FP_MAX_NUM_LT));
    if (BCM_FAILURE(rv)) {
        sal_free(tlv);
        return rv;
    ...
    for (count = 0;
        ...
        switch (f_ent_bmp[count].action) {
            ...
            case bcmFieldActionAssignOpaqueObject3:
                ...
                break;
            case bcmFieldActionLoopbackCustomSubtype:
                wb_act_elem = _bcmFieldInternalEMActionPbmLoopbackCustomSubtype;
                break;
...
_field_entry_info_sync(int unit, _field_entry_t *f_ent, int parts_count)
{
    ...
    if (f_ent->actions != NULL) {
        rv = (_field_actions_sync(unit, f_ent->actions));
        if (BCM_FAILURE(rv)) {
            goto cleanup;
        }
    }

    rv = _field_statistic_sync(unit, fc, (f_ent->statistic));
    if (BCM_FAILURE(rv)) {
        goto cleanup;
    }
    ...
    if (0) {
        ...
        rv = _field_entry_info_sync(unit, f_ent->ent_copy, parts_count);
        if (BCM_FAILURE(rv)) {
            goto cleanup;
        }
    }
...
_field_group_sync(int unit, _field_group_t *fg)
{
    ...
    for (partidx = 0; partidx < parts_count; partidx++) {
        rv = ( _field_group_qualifier_sync(unit,
...
_field_wb_size_calc(int unit, uint32* total_size, _field_control_t  *fc)
{
     ...
     */
    /* basic_size_slice represents the size requried for a slice sync.
     * Refer to _field_slice_sunc function for details.
     * 
     */
    basic_size_slice = 46;
    /* basic_size_stage represents size required per stage.
     * Refer to function basic_size_stage for details
     * for 64, refer to function _field_ltinfo_sync
     */
    basic_size_stage = 596 + 64;       /* added 64 for presel */
    /* basic_size_ltslice represents size required for lt sclice.
     * Refer to function _field_lt_slice_sync for details
     */
    basic_size_ltslice = 32;
    /* basic_size_group represents size required for group sync.
     * Refer to function _field_group_sync for details
     */
    basic_size_group = 108;
    /* basic_size_group represents size required for an entry info.
     * refer to _field_entry_info_sync for details
     * 12 represents the size allocated for TLVs synced in _field_entry_info
     */
    basic_size_entry = 47 + 48 + 12 + (20 * 12);
    /* basic_size_ltentry represents size required for Lt entry.
     * Refer to _field_lt_entry_info_sync for details.
     */                                   /* 20 actions needs software cache */
    basic_size_ltentry = 28;
    /* refer to function _field_hash_sync */
    basic_size_datafc = 799756;
    /*basic_size_fc is derived from size required by field control sync
     * refer to function _field_control_sync for details
     */
    basic_size_fc = 21 + 264 + (_FP_MAX_NUM_PIPES *_FIELD_MAX_METER_POOLS);
                    /* added 264 for presel, ifp_meter_in_use */
    basic_size_presel = 36;
    /* 150 is derived from size required for extractors.
     * please refer to _field_extractor_sync for details
     * (BCM_PBMP_PORT_MAX/BITS_PER_BYTE) is to sync the slice portbmp
     */
    size_slice = basic_size_slice + (_FP_ENTRY_COUNT * 4)
                 + ((_FP_ENTRY_COUNT * 5)/BITS_PER_BYTE)
                 + (BCM_PBMP_PORT_MAX/BITS_PER_BYTE) + (150 * _FP_MAX_NUM_LT) ;
    ...
    /* (_FP_ENTRY_COUNT * 4) represents end of structure TLV for all entries */
    size_ltslice = basic_size_ltslice + (_FP_ENTRY_COUNT * 4);
    /* 150 is derived from size required for extractors.
     * please refer to function _field_extractor_sync for details
     */
    size_group = basic_size_group + ((BCM_FIELD_QUALIFY_MAX/BITS_PER_BYTE)
                 ...
                 + (4 *_FIELD_MAX_COUNTER_POOLS) + (150 * _FP_MAX_ENTRY_WIDTH)
                 + (_FP_ENTRY_COUNT * 4) + (_FP_SLICE_COUNT * 80) ;
    /* (5 * _FP_POLICER_LEVEL_COUNT) represents the size allocated 
     * for policer info. or details refer to 
     * policer data sync in _field_entry_info_sync function
     * ((BCM_PBMP_PORT_MAX/BITS_PER_BYTE) * 2) represents
     * f_ent->pbmp.data.pbits and f_ent->pbmp.mask.pbits
     */
    size_entry = (basic_size_entry + ((BCM_PBMP_PORT_MAX/BITS_PER_BYTE) * 2)
                  + (5 * _FP_POLICER_LEVEL_COUNT));

    size_ltentry = basic_size_ltentry;
    /* for (_FP_DATA_ETHERTYPE_MAX * 16), refer to function
     * _field_datacontrolethertype_sync
     * for (_FP_DATA_IP_PROTOCOL_MAX * 21), refer to funtion
     * _field_datacontrolprot_sync
     */
    size_datafc = basic_size_datafc + (_FP_DATA_ETHERTYPE_MAX * 16)
                  + (_FP_DATA_IP_PROTOCOL_MAX * 21);
    /* for (10 * BCM_FIELD_USER_NUM_UDFS), refer to function
    * _field_udf_sync
    */
    ...
    *total_size = size_fc + size_datafc + size_stage + (_FP_SLICE_COUNT
     ...
     /* additional scache size added for improvements done to syns and recovery
        ...
        if ((stable_size > 0) && !SOC_WARM_BOOT_SCACHE_IS_LIMITED(unit)) {
             ...
             if (scache_size == 0) {
                  ...
                  */
                   ...
                   */
                  scache_size += (2*4);
                  /* This is to increment to sync stat_types for EFP
                   * (assuming EFP has 2K max entries)
                   */
                  scache_size += ((sizeof(uint32))* 1024 * 2);
             }
                            ...
                            _field_group_t *new_fg, int total_qual_count)
{
    ...
    soc_mem_t fp_presel_mem = IFP_LOGICAL_TABLE_SELECT_TCAM_ONLYm; /* Presel TCAM memeory */
...
_field_hint_recover(int unit, _field_tlv_t *tlv)
{
    ...
    for (i = 0; i < num_instances; i++) {
    /* f_ht has to be NULL prior to next alloc else it will memset the already allocated mem */
    f_ht = NULL;
 ...
 * Parameters:
 *     unit             (IN) BCM device number.
 *     partial          (IN) only partial keygen is read(used for Wb)
 *     stage_fc         (IN) field control stage
 *     fg               (IN) field group.
 *     part             (IN) part no to recover data for
 *     mem              (IN) profile memory
...
STATIC int
_field_th_keygen_profile1_entry_pack_get(int unit, int partial,
                               _field_stage_t *stage_fc,
                               _field_group_t *fg, int part, soc_mem_t mem,
 ...
 */
int
_field_th_keygen_em_profile_entry_pack_get(int unit, int partial,
                        _field_stage_t *stage_fc,
                        _field_group_t *fg, int part, soc_mem_t mem,
                                                ...
                                                uint32 key_gen_prof_idx)
{
    ...
    if (stage_fc->stage_id == _BCM_FIELD_STAGE_INGRESS) {
        ...
        if (SOC_SUCCESS(rv)) {
            ...
            rv = _field_th_keygen_profile1_entry_pack_get(unit, partial,stage_fc, fg,
                    part_index, mem[0], ifp_prof1_entry);
            if (SOC_SUCCESS(rv) && !(partial)) {
        ...
        if (SOC_SUCCESS(rv)) {
            ...
            rv = _field_th_keygen_em_profile_entry_pack_get(unit, partial,
        ...
        while  ((tlv2.type != _bcmFieldInternalEndStructExtractor)
            ...
            switch (tlv2.type) {
                ...
                case _bcmFieldInternalExtAltTtlFnSel:
                     ...
                     break;
                case _bcmFieldInternalExtl2e4Sel:
                    sal_memcpy(ext_sel->l2_e4_sel, tlv2.value, tlv2.length);
                     break;
                case _bcmFieldInternalExtl2e2Sel:
                     sal_memcpy(ext_sel->l2_e2_sel, tlv2.value, tlv2.length);
                     break;
                case _bcmFieldInternalExtl2e1Sel:
                     sal_memcpy(ext_sel->l2_e1_sel, tlv2.value, tlv2.length);
                     break;
                case _bcmFieldInternalExtDestContASel:
                     ext_sel->dst_cont_a_sel = *(int8 *)tlv2.value;
                     break;
                case _bcmFieldInternalExtDestContBSel:
                     ext_sel->dst_cont_b_sel = *(int8 *)tlv2.value;
                     break;
                case _bcmFieldInternalExtUdfSel:
                     ext_sel->udf_sel = *(int8 *)tlv2.value;
                     break;
                case _bcmFieldInternalExtIpbmSourceSel:
                     ext_sel->ipbm_source = *(int8 *)tlv2.value;
                     break;
    ...
    while (tlv.type != _bcmFieldInternalEndStructEntry) {
        ...
        switch (tlv.type)
        {
            ...
            case _bcmFieldInternalEntryPbmpFullData:
                 pbmp_max_words = ((tlv.length < _SHR_PBMP_WORD_MAX) ?
                                   tlv.length : _SHR_PBMP_WORD_MAX);
...
_field_entry_recover(int unit, _field_group_t *new_fg)
{
    ...
    soc_mem_t lt_policy_mem = IFP_LOGICAL_TABLE_SELECT_DATA_ONLYm;/* LT Policy memory */
    soc_mem_t fp_policy_mem_wide = IFP_POLICY_TABLE_WIDEm; /* IFP Policy memory wide */
    soc_mem_t fp_policy_mem = IFP_POLICY_TABLEm; /* IFP Policy memeory */
    soc_mem_t fp_action_profile_mem = IFP_POLICY_ACTION_PROFILEm;/* IFP action profile memeory */
                 ...
                 for (i = 0; i < entry_count; i++) {
                    ...
                    if ((!soc_feature(unit, soc_feature_ifp_action_profiling)) ||
                        ...
                        if ((BCM_SUCCESS(rv)) && (f_st->flex_mode != 0)) {
                            ...
                            if (f_ent->group->stage_id ==
                                 _BCM_FIELD_STAGE_INGRESS) {
                                rv = _bcm_esw_stat_flex_check_ingress_table_entry(
                                         unit, f_ent->group->instance,
                                         f_ent->group->stage_id,
                                         offset_mode, pool_num, base_index);
                                 BCM_IF_ERROR_CLEANUP(rv);
                            }
                        }
                    }
                    ...
                    if (f_ent->flags & _FP_ENTRY_INSTALLED) {
                       /* Actions recover for entry for non TD3 devices*/
                        ...
                        if (wb_entry.act_bmp.w != NULL) {
                           _FP_ACTION_BMP_FREE(wb_entry.act_bmp);
                        }
                        if (NULL != wb_entry.val_array0) {
                            sal_free(wb_entry.val_array0);
                        }
                        wb_entry.val_array = NULL;
                        wb_entry.hw_idx_array = NULL;
                        wb_entry.act_bmp.w  = NULL;
...
_field_group_recover(int unit, _field_group_t *fg, int *total_qual_count)
{
    ...
    *total_qual_count = -1;
    ...
    pbmp_port_max = soc_scache_dictionary_entry_get(unit,
            ...
            SOC_PBMP_PORT_MAX);
    /* we are syncing 64 bytes max (ie 512 max ports data)*/
    pbmp_port_max = (pbmp_port_max < 512) ? (pbmp_port_max) : 512;
    pbmp_max_words =  (pbmp_port_max + 32 -1) / 32;
    pbmp_max_words_to_copy = (pbmp_max_words <=_SHR_PBMP_WORD_MAX) ? \
    ...
    for (action_idx = 0; action_idx < (sizeof(action_arr)/sizeof(int)); action_idx++) {
        ...
        switch (action_arr[action_idx]) {
                ...
                if (!(soc_feature(unit, soc_feature_fp_no_dvp_support))) {
                      ...
                      if ((a_offset.value[2] == 1) && (a_offset.value[1] == 6)) {
                        ...
                        if (_bcm_vp_used_get(unit, vp, _bcmVpTypeMpls)) {
                            ...
                            BCM_GPORT_VLAN_PORT_ID_SET(param[1], vp);
            ...
            case bcmFieldActionEgressMask:
                if (a_offset.value[1] == 4) {
                    hw_index = a_offset.value[0];
                    BCM_IF_ERROR_CLEANUP(soc_mem_read(unit,
                                         ...
                                         _field_action_bmp_t *act_bmp)
{
    ...
    int rv = BCM_E_NONE;
    bcm_field_action_t action_arr[] = {
                                        (bcm_field_action_t)_bcmFieldActionExtractionCtrlId,
    ...
    for (action_idx = 0; action_idx < (sizeof(action_arr)/sizeof(int)); action_idx++) {
        ...
        if (0 == valid) {
           ...
           if (act_val == ext_ctrl_id) {
              action = bcmFieldActionEgressFlowControlEnable;
              param0 = bcmFieldEgressFlowControlSRv6RetainSgtAppId;
              valid = 1;
           }
        }
        ...
        if (0 == valid) {
           rv1 = soc_cancun_ceh_obj_field_get(unit, "EXTRACTION_CTRL_ID",
                                              "RETAIN_SGT_APPID_FOR_NON_CANONICAL_ENCAP",
                                              &ceh_info1);
           rv2 = soc_cancun_ceh_obj_field_get(unit, "EXTRACTION_CTRL_ID",
                                              "RETAIN_SGT_APPID_FOR_NON_CANONICAL_ENCAP_MASK",
                                              &ceh_info2);
           ...
           if (act_val == ext_ctrl_id) {
              action = bcmFieldActionEgressFlowControlEnable;
              param0 = bcmFieldEgressFlowControlSRv6RetainSgtAppIdForNonCanonicalEncap;
              valid = 1;
           }
        }
        ...
        if (0 == valid) {
           rv1 = soc_cancun_ceh_obj_field_get(unit, "EXTRACTION_CTRL_ID",
                                              "SRV6_EVPN_ESI_FILTER",
                                              &ceh_info1);
           rv2 = soc_cancun_ceh_obj_field_get(unit, "EXTRACTION_CTRL_ID",
                                              "SRV6_EVPN_ESI_FILTER_MASK",
                                              &ceh_info2);
           ...
           if (act_val == ext_ctrl_id) {
              action = bcmFieldActionEgressFlowControlEnable;
              param0 = bcmFieldEgressFlowControlSRv6EvpnEsiFilter;
              valid = 1;
           }
        }
        ...
        if (0 == valid) {
           rv1 = soc_cancun_ceh_obj_field_get(unit, "EXTRACTION_CTRL_ID",
                                              "ASSIGN_GBP_SID_FROM_VXLAN_GBP_HDR",
                                              &ceh_info1);
           rv2 = soc_cancun_ceh_obj_field_get(unit, "EXTRACTION_CTRL_ID",
                                              "ASSIGN_GBP_SID_FROM_VXLAN_GBP_HDR_MASK",
                                              &ceh_info2);
           ...
           if (act_val == ext_ctrl_id) {
              action = bcmFieldActionEgressFlowControlEnable;
              param0 = bcmFieldEgressFlowControlVxlanGbpFlexClassifierAdd;
              valid = 1;
           }
        }
        ...
        if (0 == valid) {
           rv1 = soc_cancun_ceh_obj_field_get(unit, "EXTRACTION_CTRL_ID",
                                              "EXTRACT_GBP_SID_FROM_GBP_TAG",
                                              &ceh_info1);
           rv2 = soc_cancun_ceh_obj_field_get(unit, "EXTRACTION_CTRL_ID",
                                              "EXTRACT_GBP_SID_FROM_GBP_TAG_MASK",
                                              &ceh_info2);
           ...
           if (act_val == ext_ctrl_id) {
              action = bcmFieldActionEgressFlowControlEnable;
              param0 = bcmFieldEgressFlowControlHiGigGbpSrcIdInherit;
              valid = 1;
           }
        }
        ...
        if (0 == valid) {
           rv1 = soc_cancun_ceh_obj_field_get(unit, "EXTRACTION_CTRL_ID",
                                              "DO_NOT_APPLY_GBP_POLICY_LOOKUP",
                                              &ceh_info1);
           rv2 = soc_cancun_ceh_obj_field_get(unit, "EXTRACTION_CTRL_ID",
                                              "DO_NOT_APPLY_GBP_POLICY_LOOKUP_MASK",
                                              &ceh_info2);
           ...
           if (act_val == ext_ctrl_id) {
              action = bcmFieldActionEgressFlowControlEnable;
              param0 = bcmFieldEgressFlowControlVxlanGbpFlexPolicyDoNotApply;
              valid = 1;
           }
        }
                                         ...
                                         _field_action_bmp_t *act_bmp)
{
    ...
    bcm_field_action_t action_arr[] = {
                                        ...
                                        (bcm_field_action_t)_bcmFieldActionEditCtrlId,
                                      };
    ...
    for (action_idx = 0; action_idx < (sizeof(action_arr)/sizeof(int)); action_idx++) {
        ...
        if (0 == valid) {
           ...
           if (act_val == edit_ctrl_id) {
              action = bcmFieldActionEgressFlowEncapEnable;
              param0 = bcmFieldEgressFlowEncapSRv6RetainSgtAppId;
              valid = 1;
           }
        }
        ...
        if (0 == valid) {
           rv1 = soc_cancun_ceh_obj_field_get(unit, "EDIT_CTRL_ID",
                                              "VXLAN_GBP_POLICY_LOOKUP_DONE",
                                              &ceh_info1);
           rv2 = soc_cancun_ceh_obj_field_get(unit, "EDIT_CTRL_ID",
                                              "VXLAN_GBP_POLICY_LOOKUP_DONE_MASK",
                                              &ceh_info2);
           ...
           if (act_val == edit_ctrl_id) {
              action = bcmFieldActionEgressFlowEncapEnable;
              param0 = bcmFieldEgressFlowEncapVxlanGbpFlexPolicyApplied;
              valid = 1;
           }
        }
                              ...
                              _field_action_bmp_t *act_bmp)
{
    ...
    bcm_field_action_t action_arr[] = {
                                        ...
                                        bcmFieldActionLoopbackCustomSubtype,
...
_field_em_group_entries_recover(int unit, _field_group_t *fg)
{
    ...
    soc_mem_t mem = EXACT_MATCH_2m; /* Memory Identifier.*/
    soc_mem_t def_policy_mem = EXACT_MATCH_DEFAULT_POLICYm;
    _field_stage_t *stage_fc = NULL;
    uint32 tbuf[SOC_MAX_MEM_FIELD_WORDS] = {0};
                                     /* Temp Buffer One.          */
                                    ...
                                    _field_stage_t *stage_fc)
{
    ...
    while (tlv.type != _bcmFieldInternalEndStageEM) {
        ...
        case _bcmFieldInternalSlice:
         ...
         case _bcmFieldInternalGroupCount:
             ...
             for (group_id =0 ;group_id < group_count; group_id ++) {
                 ...
                 BCM_IF_ERROR_CLEANUP(rv);
                 /*
                  * lt_ref_count is added in 6_5_17 release. But, when warmboot
                  * recovery is happening from version less than 6_5_17
                  * (BCM_FIELD_WB_VERSION_1_29), then lt_ref_count should be
                  * incremented for groups instance and lt_id.
                  */
                 if (fc->wb_recovered_version < BCM_FIELD_WB_VERSION_1_29) {
                     fc->lt_info[curr_fg->instance] \
                             [curr_fg->lt_id]->lt_ref_count++;
                 }
        ...
        case _bcmFieldInternalEMActionPbmOpaqueObject3:
             ...
             BCM_IF_ERROR_CLEANUP(rv);
             break;
        case _bcmFieldInternalEMActionPbmLoopbackCustomSubtype:
             rv = _field_em_actions_tlv_retrieve(unit, fc, &tlv, bcmFieldActionLoopbackCustomSubtype);
             BCM_IF_ERROR_CLEANUP(rv);
             break;
...
#if defined(BCM_TOMAHAWK3_SUPPORT)
    if (((fc->wb_recovered_version) < BCM_FIELD_WB_VERSION_1_35) &&
        (SOC_IS_TOMAHAWK3(unit))) {
        if (SOC_SUCCESS(rv)) {
            rv = _field_recover_th3_missing_extractor_codes(unit);
            BCM_IF_ERROR_CLEANUP(rv);
        }
    }
#endif
                             ...
                             _field_stage_t *stage_fc)
{
    ...
    if (group_count > 0) {
        ...
        TLV_CREATE(_bcmFieldInternalGroupCount,
                _bcmFieldInternalVariable, 0, &tlv);
        tlv->value = &group_count;
        rv = _field_tlv_validate_and_write(unit, tlv, scache_ptr, pos);
        BCM_IF_ERROR_CLEANUP(rv);
...
int _field_recover_th_missing_extractor_codes(int unit) {
    _field_control_t  *fc;         /* Field control structure.*/
    _field_group_t    *fg;         /* Group information */
    _field_stage_t    *stage_fc;   /*stage fieldcontrol */
    int parts_cnt;                 /*part counts of group */
        ...
        if ((fg->stage_id == _BCM_FIELD_STAGE_INGRESS) ||
            ...
            if ( (fg->lt_entry_arr != NULL ) &&
                ...
                for (i= 0; i<parts_cnt; i++) {
                    ...
                    rv =
                    _bcm_field_th_group_update_ext_codes_from_keygen_profiles(
                         unit, 1, fg, i, fg->ext_codes[i].keygen_index);
                    if (BCM_FAILURE(rv)) {
                        return rv;
                    }
                }
            ...
            for (part = 0; part < part_count; part++) {
                for (idx = 0; idx < 2; idx++) {
                    fg->ext_codes[part].l3_e1_sel[idx] = -1;
                }
            }
