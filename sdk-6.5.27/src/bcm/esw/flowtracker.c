    ...
    int arg)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_esw_flowtracker_lock(unit));
        ...
        if ((soc_feature(unit, soc_feature_uc_flowtracker_learn) &&
                    soc_feature(unit, soc_feature_uc_flowtracker_export)) ||
                soc_feature(unit, soc_feature_mv2_style_flowtracker)) {
            result = _bcm_th_ft_flow_group_control_set(unit, id, type, arg);
        } else
#endif
#if defined(BCM_FLOWTRACKER_SUPPORT)
        if (soc_feature(unit, soc_feature_flex_flowtracker_ver_1)) {
    ...
    int *arg)
{
    ...
    if ((soc_feature(unit, soc_feature_uc_flowtracker_learn) &&
         soc_feature(unit, soc_feature_uc_flowtracker_export)) ||
         soc_feature(unit, soc_feature_mv2_style_flowtracker)) {
        result = _bcm_th_ft_flow_group_control_get(unit, id, type, arg);
    } else
#endif
#if defined(BCM_FLOWTRACKER_SUPPORT)
        if (soc_feature(unit, soc_feature_flex_flowtracker_ver_1)) {
    ...
    bcm_flowtracker_state_transition_policy_t *policy)
{
    ...
    if ((soc_feature(unit, soc_feature_flex_flowtracker_ver_1)) &&
        ...
        result = bcmi_ft_state_transition_add(unit, key, policy);
    ...
    bcm_flowtracker_state_transition_key_t *key)
{
    ...
    if ((soc_feature(unit, soc_feature_flex_flowtracker_ver_1)) &&
        ...
        result = bcmi_ft_state_transition_delete(unit, key);
    ...
    int *actual_entries)
{
    ...
    if ((soc_feature(unit, soc_feature_flex_flowtracker_ver_1)) &&
        ...
        result = bcmi_ft_state_transition_get_all(unit, max_entries,
                key_list, policy_list, actual_entries);
    ...
    bcm_flowtracker_state_transition_policy_t *policy)
{
    ...
    if ((soc_feature(unit, soc_feature_flex_flowtracker_ver_1)) &&
        ...
        result = bcmi_ft_state_transition_get(unit, key, policy);
...
/*
 * Function:
 *  bcm_esw_flowtracker_state_transition_check_add
 * Purpose:
    ...
    bcm_flowtracker_check_t check_id)
{
    ...
    if ((soc_feature(unit, soc_feature_flex_flowtracker_ver_3)) &&
        ...
        result = bcmi_ftv3_state_transition_check_add(unit, key, check_id);
...
/*
 * Function:
 *  bcm_esw_flowtracker_state_transition_check_delete
 * Purpose:
    ...
    bcm_flowtracker_check_t check_id)
{
    ...
    if ((soc_feature(unit, soc_feature_flex_flowtracker_ver_3)) &&
        ...
        result = bcmi_ftv3_state_transition_check_delete(unit, key, check_id);
...
/*
 * Function:
 *  bcm_esw_flowtracker_state_transition_check_get_all
 * Purpose:
    ...
    int *actual_checks)
{
    ...
    if ((soc_feature(unit, soc_feature_flex_flowtracker_ver_3)) &&
        ...
        result = bcmi_ftv3_state_transition_check_get_all(unit,
                key, max_checks, check_id_list, actual_checks);
