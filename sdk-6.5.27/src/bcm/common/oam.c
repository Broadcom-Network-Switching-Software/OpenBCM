    ...
    bcm_oam_endpoint_action_t *action_ptr)
{
 ...
 /*
 * Function:
 *      bcm_oam_primary_vlan_info_t_init
 * Purpose:
 *      Initialize an OAM primary vlan info structure
 * Parameters:
 *      primary_vlan_info - (OUT) Pointer to OAM primary vlan info structure to be initialized
 * Returns:
 *      BCM_E_XXX
 * Notes:
 */
...
{
    sal_memset(primary_vlan_info, 0, sizeof(bcm_oam_primary_vlan_info_t));
}
