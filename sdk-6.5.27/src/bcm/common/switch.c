...
/*
 * Function:
 *     bcm_switch_pcie_firmware_info_t_init
 * Description:
 *     Initialize ther bcm_switch_pcie_firmware_info_t strucutre
 * Parameters:
 *     info - pointer to the bcm_switch_pcie_firmware_info_t strucutre
 * Return: none
 */
void
bcm_switch_pcie_firmware_info_t_init(bcm_switch_pcie_firmware_info_t *info)
{
    sal_memset(info, 0, sizeof(bcm_switch_pcie_firmware_info_t));
}
...
/*
 * Function:
 *     bcm_switch_gtp_terminator_t_init
 * Description:
 *     Initialize an switch packet parameter strucutre
 * Parameters:
 *     config - pointer to switch packet parameter strucutre
 * Return: none
 */
void
bcm_switch_gtp_terminator_t_init(bcm_switch_gtp_terminator_t *config)
{
    sal_memset(config, 0, sizeof(bcm_switch_gtp_terminator_t));
}
...
/*
 * Function:
 *     bcm_switch_pt_info_t_init
 * Description:
 *     Initialize a bcm_switch_pt_info_t structure.
 * Parameters:
 *     pt_info - pointer to PT information structure
 * Return: none
 */
void
bcm_switch_pt_info_t_init(bcm_switch_pt_info_t *pt_info)
{
    if (pt_info != NULL) {
        sal_memset(pt_info, 0, sizeof(bcm_switch_pt_info_t));
    }
}

/*
 * Function:
 *     bcm_switch_lt_info_t_init
 * Description:
 *     Initialize a bcm_switch_lt_info_t structure.
 * Parameters:
 *     lt_info - pointer to LT information structure
 * Return: none
 */
void
bcm_switch_lt_info_t_init(bcm_switch_lt_info_t *lt_info)
{
    if (lt_info != NULL) {
        sal_memset(lt_info, 0, sizeof(bcm_switch_lt_info_t));
    }
}
...
/*
 * Function:
 *      bcm_switch_stat_event_mon_t_init
 * Purpose:
 *      Initialize a bcm_switch_stat_event_mon_t structure.
 * Parameters:
 *      monitor - Pointer to a switch stat event monitor structure.
 * Return: none
 */
void
bcm_switch_stat_event_mon_t_init(bcm_switch_stat_event_mon_t *monitor)
{
    if (monitor != NULL) {
        sal_memset(monitor, 0, sizeof(*monitor));
        monitor->stat_event = -1;
    }
}
    ...
    bcm_switch_ep_recirc_drop_event_control_t *drop_event_ctrl)
{
    if (drop_event_ctrl != NULL) {
        ...
        drop_event_ctrl->threshold_event = bcmPktDropEventEgressNoDrop;
    }
}
...
/*!
 * \brief Initialize the bcm_switch_ep_recirc_second_pass_profile_t struct.
 *
 * \param [in/out] profile EPRC second pass profile
 *
 * \retval SHR_E_NONE No errors.
 * \retval !SHR_E_NONE Failure.
 */
void
bcm_switch_ep_recirc_second_pass_profile_t_init(
    bcm_switch_ep_recirc_second_pass_profile_t *profile)
{
    if (profile != NULL) {
...
/*!
 * \brief Initialize the bcm_switch_ep_recirc_profile_control_t struct.
 *
 * \param [in/out] control EPRC profile control
 *
 * \retval SHR_E_NONE No errors.
 * \retval !SHR_E_NONE Failure.
 */
void
bcm_switch_ep_recirc_profile_control_t_init(
    bcm_switch_ep_recirc_profile_control_t *control)
{
    if (control != NULL) {
...
/*!
 * \brief Initialize the bcm_switch_drop_event_override_t struct.
 *
 * \param [in/out] control EPRC profile control
 *
 * \retval SHR_E_NONE No errors.
 ...
 */
void
bcm_switch_drop_event_override_t_init(
    bcm_switch_drop_event_override_t *override)
{
    if (override != NULL) {
        sal_memset(override, 0, sizeof(*override));
    }
}

/*!
 * \brief Initialize bcm_switch_dcn_routing_plane_map_t.
 *
 * \param [in/out] map DCN routing plane map
 *
 * \retval SHR_E_NONE No errors.
 * \retval !SHR_E_NONE Failure.
 */
void
bcm_switch_dcn_routing_plane_map_t_init(
    bcm_switch_dcn_routing_plane_map_t *map)
{
    if (map != NULL) {
