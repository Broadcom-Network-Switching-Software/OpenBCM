...
/*
 * Function:
 *     bcm_l3_alpm_resource_t_init 
 * Purpose:
 *      Initialize a bcm_l3_alpm_resource_t structure
 * Parameters:
 *      resource - pointer to the bcm_l3_alpm_resource_t structure
 * Returns:
 *      NONE
 */

void
bcm_l3_alpm_resource_t_init(bcm_l3_alpm_resource_t *resource)
{
    if (NULL != resource) {
...
/*
 * Function:
 *      bcm_l3_ecmp_dlb_port_quality_t_init
 * Purpose:
 *      Initializes the DLB-ECMP group port information structure to default values.
 * Parameters:
 *      info - pointer to the L3 egress object struct.
 * Returns:
 *      NONE
 */
void
bcm_l3_ecmp_dlb_port_quality_t_init(bcm_l3_ecmp_dlb_port_quality_t *port_quality)
{
    if (NULL != port_quality) {
        sal_memset(port_quality, 0, sizeof (*port_quality));
        port_quality->port = BCM_PORT_INVALID;
        port_quality->buffer_id = BCM_COSQ_BUFFER_ID_INVALID;
    }
    return;
}
