...
void
bcm_time_tx_timestamp_profile_t_init(
    bcm_time_tx_timestamp_profile_t *tod)
{
    sal_memset(tod, 0, sizeof(bcm_time_tx_timestamp_profile_t));
}

void
bcm_time_rx_timestamp_profile_t_init(
    bcm_time_rx_timestamp_profile_t *tod)
{
    sal_memset(tod, 0, sizeof(bcm_time_rx_timestamp_profile_t));
}
