...
/*
 * Function:
 *      bcm_vlan_svtag_config_t_init
 * Purpose:
 *      Initialize a bcm_vlan_svtag_config_t structure.
 * Parameters:
 *      svtag - pointer to data parameter structure
 * Returns:
 *      NONE
 */
void
...
{
    if (svtag != NULL) {
        sal_memset(svtag, 0, sizeof(bcm_vlan_svtag_config_t));
    }
...
/*
 * Function:
 *      bcm_vlan_cross_connect_info_t_init
 * Purpose:
 *      Initialize a bcm_vlan_cross_connect_info_t structure.
 * Parameters:
 *      info - pointer to data parameter structure
 * Returns:
 *      NONE
 */
void
bcm_vlan_cross_connect_info_t_init(bcm_vlan_cross_connect_info_t *info)
{
    if (info != NULL) {
        sal_memset(info, 0, sizeof(bcm_vlan_cross_connect_info_t));
    }
    return;
}
