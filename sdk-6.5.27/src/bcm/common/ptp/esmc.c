...
extern int _bcm_common_synce_phy_port_get_lane(int unit, int port, int rx_lane, int *adjusted_lane, int *adjusted_phy_port);
    ...
    uint8 *esmc_pdu)
{
    ...
    if (SOC_IS_MONTEREY(unit)) {
        _bcm_common_synce_phy_port_get_lane(0, ingress_port, 1, NULL, &ingress_port);
    }
#endif
