...
/*
 * Function:
 *      bcm_port_ber_proj_params_t_init
 * Purpose:
 *      Initialize a BER Projection input parameter structure.
 * Parameters:
 *      config - Pointer to bcm_port_ber_proj_params_t_init data structure to
 *                 be initialized.
 * Returns:
 *      None
 */
void
bcm_port_ber_proj_params_t_init(bcm_port_ber_proj_params_t *config)
{
    if (config != NULL) {
        sal_memset(config, 0, sizeof (*config));
    }
...
/*
 * Function:
 *      bcm_port_encrypted_pfc_tx_config_t_init
 * Purpose:
 *      Initialize an Encrypted PFC Port config  structure
 * Parameters:
 *      config - (OUT) Pointer to Encrypted PFC port config  structure to be initialized
 * Returns:
 *      BCM_E_XXX
 * Notes:
 */
...
{
	if (config != NULL) {
		sal_memset(config, 0, sizeof(bcm_port_encrypted_pfc_tx_config_t));
	}
	return;
}
...
/*
 * Function:
 *      bcm_port_encrypted_pfc_tx_init_config_t_init
 * Purpose:
 *      Initialize an Encrypted PFC config  structure
 * Parameters:
 *      config - (OUT) Pointer to Encrypted PFC init config  structure to be initialized
 * Returns:
 *      BCM_E_XXX
 * Notes:
 */
...
{
	if (config != NULL) {
		sal_memset(config, 0, sizeof(bcm_port_encrypted_pfc_tx_init_config_t));
	}
	return;
}
