...
void bcm_flowtracker_elephant_flow_t_init(bcm_flowtracker_elephant_flow_t *flow)
{
    sal_memset(flow, 0, sizeof(bcm_flowtracker_elephant_flow_t));
}
...
/* Initialize a flowtracker eviction rate information structure. */
void bcm_flowtracker_eviction_rate_info_t_init(
            bcm_flowtracker_eviction_rate_info_t *info)
{
    sal_memset(info, 0, sizeof(bcm_flowtracker_eviction_rate_info_t));
}
