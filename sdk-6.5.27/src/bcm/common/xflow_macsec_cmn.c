...
{
        (void)xflow_macsec_port_info_t_init(port_info);
...
{
        (void)xflow_macsec_secure_chan_info_t_init(chan_info);
}
...
{
        (void)xflow_macsec_secure_assoc_info_t_init(assoc_info);
}
...
{
        (void)xflow_macsec_policy_info_t_init(policy_info);
}
...
{
        (void)xflow_macsec_flow_info_t_init(flow_info);
}
...
{
        (void)xflow_macsec_ipsec_secure_assoc_info_t_init(assoc_info);
}
...
{
        (void)xflow_macsec_ipsec_secure_chan_info_t_init(chan_info);
}
        ...
        bcm_xflow_macsec_port_info_t *port_info)
{
    ...
    if (soc_feature(unit, soc_feature_xflow_macsec_svtag)) {
        ...
        /* To serialize ING_DEVICE_PORTm access and
         * avoid DEAD_LOCKS with link scan thread.
         */
        PORT_LOCK(unit);
        XFLOW_MACSEC_LOCK(unit);
...
/*
 * Function:
 *      bcm_common_xflow_macsec_svtag_map_set
 * Purpose:
 *     Set mapping of global SC index to local SC index.
 */
int
bcm_common_xflow_macsec_svtag_map_set(
    int unit,
...
/*
 * Function:
 *      bcm_common_xflow_macsec_svtag_map_get
 * Purpose:
 *     Get mapping of global SC index to local SC index.
 */
int
bcm_common_xflow_macsec_svtag_map_get(
    int unit,
