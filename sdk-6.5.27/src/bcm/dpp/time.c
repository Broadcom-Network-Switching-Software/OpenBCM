        ...
        bcm_time_tod_t *tod)
{
    ...
    uint32 freq_step = 0;
    uint64 frac_sec;
    uint32 ntp_freq_control = 0x44b82fa1;
    uint32 ptp_freq_control = 0x10000000;
    ...
    if (stages & BCM_TIME_STAGE_LIVE_WIRE_PTP) {
        ...
        SOCDNX_IF_ERR_EXIT(soc_reg_above_64_field32_modify(unit,
                    ECI_GP_CONTROL_7r, REG_PORT_ANY, 0, TOD_IEEE_1588_EVENT_MUX_CONTROLf, 0));
        SOCDNX_IF_ERR_EXIT(soc_reg_above_64_field32_modify(unit,
                    ECI_GP_CONTROL_8r, REG_PORT_ANY, 0, TOD_IEEE_1588_COUNT_ENABLEf,  0));
        SOCDNX_IF_ERR_EXIT(soc_reg_above_64_field32_modify(unit,
                    ECI_GP_CONTROL_8r, REG_PORT_ANY, 0, TOD_IEEE_1588_LOAD_ENABLEf,  0));
        SOCDNX_IF_ERR_EXIT(soc_reg_above_64_field32_modify(unit,
        ...
        SOCDNX_IF_ERR_EXIT(soc_reg_above_64_field32_modify(unit,
                    ECI_GP_CONTROL_7r, REG_PORT_ANY, 0, TOD_IEEE_1588_TIME_FREQ_CONTROLf, ptp_freq_control));
        ...
        /* write 0 to control register */
        SOCDNX_IF_ERR_EXIT(soc_reg_above_64_field32_modify(unit,
                    ECI_GP_CONTROL_6r, REG_PORT_ANY, 0, TOD_NTP_EVENT_MUX_CONTROLf,  0));
        SOCDNX_IF_ERR_EXIT(soc_reg_above_64_field32_modify(unit,
                    ECI_GP_CONTROL_8r, REG_PORT_ANY, 0, TOD_NTP_COUNT_ENABLEf,  0));
        SOCDNX_IF_ERR_EXIT(soc_reg_above_64_field32_modify(unit,
                    ECI_GP_CONTROL_8r, REG_PORT_ANY, 0, TOD_NTP_LOAD_ENABLEf,  0));
        SOCDNX_IF_ERR_EXIT(soc_reg_above_64_field32_modify(unit,
        ...
        COMPILER_64_UMUL_32(frac_sec, ntp_freq_control);
        freq_step = (ptp_freq_control >> 26) & 0x3f;
        ...
        SOCDNX_IF_ERR_EXIT(soc_reg_above_64_field32_modify(unit,
                    ECI_GP_CONTROL_6r, REG_PORT_ANY, 0, TOD_NTP_TIME_FREQ_CONTROLf, 0x44B82FA1));
        ...
        bcm_time_tod_t *tod)
{
    ...
    if (stages & BCM_TIME_STAGE_LIVE_WIRE_PTP) {
        SOCDNX_IF_ERR_EXIT(soc_reg_above_64_field64_read(unit,
                    IHB_TOD_LAST_VALUEr, REG_PORT_ANY, 0, TOD_1588_LAST_VALUEf, &field64));
         ...
         */
        SOCDNX_IF_ERR_EXIT(soc_reg_above_64_field64_read(unit,
                    IHB_TOD_LAST_VALUEr, REG_PORT_ANY, 0, TOD_NTP_LAST_VALUEf, &field64));
