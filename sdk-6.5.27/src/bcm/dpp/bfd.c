    ...
    if (endpoint_info_lcl->flags & BCM_BFD_ENDPOINT_UPDATE) {
        ...
        if (is_default) {
            ...
            if (endpoint_info_lcl->flags & BCM_BFD_ENDPOINT_WITH_ID) {
                ...
                if (*is_endpoint_acc_to_oamp && !_BCM_BFD_ENDPOINT_IS_SBFD_REFLECTOR(unit, endpoint_info_lcl)) {
...
int _bcm_bfd_endpoint_replace_validity_checks(int unit, bcm_bfd_endpoint_info_t *endpoint_info_lcl,
    ...
    if (((endpoint_info_lcl->flags & BCM_BFD_ENDPOINT_IN_HW) || _BCM_BFD_IS_CLASSIFICATION_DONE_USING_YOUR_DISC(endpoint_info_lcl->type))
         && !_BCM_BFD_ENDPOINT_IS_SBFD_REFLECTOR(unit, endpoint_info_lcl)) { /* check discriminator */
...
int bcm_petra_bfd_endpoint_create(int unit, bcm_bfd_endpoint_info_t *endpoint_info)
{
    ...
    if (endpoint_info_lcl->flags & BCM_BFD_ENDPOINT_UPDATE) {
        ...
        if (is_default) {
            ...
            if(!((endpoint_info_lcl->local_discr == 0) && SOC_IS_JERICHO_PLUS(unit)) && !_BCM_BFD_ENDPOINT_IS_SBFD_REFLECTOR(unit, endpoint_info_lcl)) {
                /* sbfd reflector doesn't need to check range*/
           ...
           if ((is_endpoint_acc_to_oamp ||(_BCM_BFD_IS_CLASSIFICATION_DONE_USING_YOUR_DISC(endpoint_info_lcl->type)))
               && !_BCM_BFD_ENDPOINT_IS_SBFD_REFLECTOR(unit, endpoint_info_lcl)) {
...
int bcm_petra_bfd_endpoint_destroy(int unit, bcm_bfd_endpoint_t endpoint) {
    ...
    if ((is_endpoint_acc_to_oamp || ((classifier_mep_entry.mep_type == SOC_PPC_OAM_MEP_TYPE_BFD_O_IPV4_M_HOP)|| (classifier_mep_entry.mep_type == SOC_PPC_OAM_MEP_TYPE_BFD_O_IPV4_1_HOP)))
        && (!(classifier_mep_entry.flags & SOC_PPC_OAM_CLASSIFIER_MEP_ENTRY_FLAG_BFD_SEAMLESS_BFD_REFLECOTR))) {
