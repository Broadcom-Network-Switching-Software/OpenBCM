...
static const dnx_rx_trap_map_type_t dnx_rx_trap_type_map[bcmRxTrapCount] = {
    ...
    [bcmRxTrapPortNotVlanMember]                        = {1,DBAL_ENUM_FVAL_INGRESS_TRAP_ID_VTT_PORT_NOT_VLAN_MEMBER,
                                                           DNX_RX_TRAP_BLOCK_INGRESS,DNX_RX_TRAP_CLASS_PREDEFINED,
                                                           "PortNotVlanMember"},
    [bcmRxTrapMyBmacUnknownISid]                        = {0,DBAL_ENUM_FVAL_INGRESS_TRAP_ID_VTT_MY_B_DA_UNKNOWN_I_SID,
                                                           DNX_RX_TRAP_BLOCK_INGRESS,DNX_RX_TRAP_CLASS_PREDEFINED,
                                                           "MyBmacUnknownISid"},
    ...
    [bcmRxTrapFwdDomainAssignmentModeTrap]              = {0,DBAL_ENUM_FVAL_INGRESS_TRAP_ID_VTT_FWD_DOMAIN_ASSIGN_MODE,
                                                           DNX_RX_TRAP_BLOCK_INGRESS,DNX_RX_TRAP_CLASS_PREDEFINED,
    ...
    [bcmRxTrapUcLooseRpfFail]                           = {1,DBAL_ENUM_FVAL_INGRESS_TRAP_ID_FLP_UC_LOOSE_RPF_FAIL,
                                                           DNX_RX_TRAP_BLOCK_INGRESS,DNX_RX_TRAP_CLASS_PREDEFINED,
                                                           "UcLooseRpfFail"},
    [bcmRxTrapFcoeSrcIdMismatchSa]                      = {0,DBAL_ENUM_FVAL_INGRESS_TRAP_ID_FLP_FABRIC_PROVIDED_SECURITY,
                                                           DNX_RX_TRAP_BLOCK_INGRESS,DNX_RX_TRAP_CLASS_PREDEFINED,
                                                           "FcoeSrcIdMismatchSa"},
    ...
    [bcmRxTrapSrv6Usp]                               = {1,DBAL_ENUM_FVAL_INGRESS_TRAP_ID_PMF_SRV6_USP,
                                                           DNX_RX_TRAP_BLOCK_INGRESS,DNX_RX_TRAP_CLASS_PREDEFINED,
                                                           "SRv6Usp",0,FALSE},
    [bcmRxTrapMplsSpeculativeParseFail]              = {1,DBAL_ENUM_FVAL_INGRESS_TRAP_ID_VTT_MPLS_SPEC_PARSE_FAIL,
                                                           DNX_RX_TRAP_BLOCK_INGRESS,DNX_RX_TRAP_CLASS_PREDEFINED,
                                                           "MplsSpeculativeParseFail",0,TRUE},
    [bcmRxTrapItmhError]                             = {1,DBAL_ENUM_FVAL_INGRESS_TRAP_ID_ITMH_ERROR,
                                                        DNX_RX_TRAP_BLOCK_INGRESS,DNX_RX_TRAP_CLASS_PREDEFINED,
                                                        "ItmhError",0,TRUE},
    /**Erpp User Define Trap */
    [bcmRxTrapEgUserDefine]                             = {1,0,
                                                           DNX_RX_TRAP_BLOCK_ERPP, DNX_RX_TRAP_CLASS_USER_DEFINED,
                                                           "EgUserDefine",0,TRUE},
    /**ETPP User Define Trap */
    [bcmRxTrapEgTxUserDefine]                           = {1,0,
                                                           DNX_RX_TRAP_BLOCK_ETPP, DNX_RX_TRAP_CLASS_USER_DEFINED,
                                                           "EgTxUserDefine",0,TRUE},
    /**ETPP User Define Trap */
    [bcmRxTrapEgTxVisibility]                           = {1,0,
                                                           DNX_RX_TRAP_BLOCK_ETPP, DNX_RX_TRAP_CLASS_USER_DEFINED,
...
static const dnx_rx_trap_map_ingress_ud_t dnx_rx_trap_map_ingress_ud[] = {
...
static const dbal_enum_value_field_ingress_trap_id_e dnx_rx_trap_map_ingress_ud_alloc[] = {
...
static const char * dnx_rx_trap_type_description[bcmRxTrapCount] = {
    ...
    [bcmRxTrapMplsSpeculativeParseFail]             = "MPLS speculative parsing failure",
    [bcmRxTrapItmhError]                            = "Trap for cases of ITMH Error.",
...
{
    int size_of_ud_array = (sizeof(dnx_rx_trap_map_ingress_ud) / sizeof(dnx_rx_trap_map_ingress_ud_t));
    ...
    dnx_rx_trap_map_ingress_ud_t * ingress_ud_info_p)
{
    ...
    {
        /*
         * In case DBAL_TRAP_ID is bigger then maximum UD, then its not UD!
         */
        ingress_ud_info_p->valid = FALSE;
    }
    ...
    int *trap_id_p)
{
    ...
    if (alloc_index < dnx_data_trap.ingress.nof_user_defined_traps_get(unit))
    {
 ...
 */
shr_error_e
dnx_rx_trap_etpp_fwd_act_profile_map_to_oam_trap_type(
    int unit,
...
{
    SHR_FUNC_INIT_VARS(unit);
    SHR_NULL_CHECK(oam_trap_type_p, _SHR_E_PARAM, "oam_trap_type_p");
        ...
        case DBAL_ENUM_FVAL_OAM_SUB_TYPE_CCM:
            switch (fwd_act_profile)
            {
                case DNX_RX_TRAP_ETPP_FWD_ACT_PROFILE_USER_TRAP_2:
                    *oam_trap_type_p = DNX_RX_TRAP_ETPP_OAM_UP_MEP_OAMP;
                    break;
                case DNX_RX_TRAP_ETPP_FWD_ACT_PROFILE_USER_TRAP_3:
                    *oam_trap_type_p = DNX_RX_TRAP_ETPP_OAM_UP_MEP_DEST1;
                    break;
                case DNX_RX_TRAP_ETPP_FWD_ACT_PROFILE_USER_TRAP_4:
                    *oam_trap_type_p = DNX_RX_TRAP_ETPP_OAM_UP_MEP_DEST2;
                    break;
                default:
                    *oam_trap_type_p = DNX_RX_TRAP_ETPP_OAM_NOF_TRAPS;
            }
            break;
        case DBAL_ENUM_FVAL_OAM_SUB_TYPE_LOOPBACK:
            *oam_trap_type_p = DNX_RX_TRAP_ETPP_OAM_REFLECTOR;
            break;
        default:
            *oam_trap_type_p = DNX_RX_TRAP_ETPP_OAM_NOF_TRAPS;
    }
