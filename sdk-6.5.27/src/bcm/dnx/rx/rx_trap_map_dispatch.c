...
shr_error_e
dnx_rx_trap_etpp_fwd_act_profile_map_to_oam_trap_type_dispatch(
    int unit,
    ...
    dnx_rx_trap_etpp_oam_types_e * oam_trap_type_p)
{
    ...
    {
        SHR_IF_ERR_EXIT(dnx_rx_trap_etpp_fwd_act_profile_map_to_oam_trap_type
                        (unit, oam_sub_type, fwd_act_profile, oam_trap_type_p));
    }
