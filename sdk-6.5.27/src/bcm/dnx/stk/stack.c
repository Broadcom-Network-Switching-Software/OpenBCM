...
/**
 * \brief - Exclude specific module-ids from the all-reachable vector.
 * 
 * \param [in] unit - Unit
 * \param [in] flags - Not used 
 * \param [in] module - The FAP-ID to exclude from all-reachable vector.
 * \param [in] control - Use bcmStkModuleAllReachableIgnore
 * \param [in] arg - 1 - exclude
 *                   0 - include
 * \return int 
 */
int
