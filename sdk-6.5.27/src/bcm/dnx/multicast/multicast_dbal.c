 ...
 */
shr_error_e
dnx_multicast_v1_group_open_hw_get(
    int unit,
 ...
 */
shr_error_e
dnx_multicast_v1_group_open_hw_set(
    int unit,
    bcm_multicast_t group,
    uint32 flags,
    uint32 is_open)
{
    ...
    else
    {
        ...
        {
            {
                dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_INGRESS_GROUP_IS_OPEN, INST_SINGLE,
                                             is_open);
            }
        }
        if (DNX_MULTICAST_IS_EGRESS(flags))
