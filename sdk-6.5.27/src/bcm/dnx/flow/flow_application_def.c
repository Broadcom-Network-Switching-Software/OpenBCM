...
extern const dnx_flow_app_config_t dnx_flow_app_vni_term_match;
extern const dnx_flow_app_config_t dnx_flow_app_vni_terminator;
...
const dnx_flow_app_config_t *dnx_flow_objects[] = {
    ...
    &dnx_flow_app_vni_term_match,
    &dnx_flow_app_vni_terminator
};
...
extern dnx_flow_common_field_desc_t
    ...
    dnx_flow_common_field_oam_enable,
