    ...
    int *profile_id)
{
    ...
    SHR_IF_ERR_EXIT(algo_l3_db.source_address_table_allocation.source_address_table.exchange
                    (unit, 0, 1, &source_address_entry, SOURCE_ADDRESS_TABLE_DEFAULT_PROFILE, NULL, profile_id,
    ...
    uint8 *is_last_profile_ref)
{
    ...
    SHR_IF_ERR_EXIT(algo_l3_db.source_address_table_allocation.source_address_table.exchange
                    (unit, 0, 1, &source_address_entry, old_profile, NULL,
    ...
    uint32 profile_id)
{
    ...
    SHR_IF_ERR_EXIT(algo_l3_db.source_address_table_allocation.source_address_table.exchange
                    (unit, 0, 1, &source_address_entry, profile_id, NULL, &new_profile, &first_ref, &remove_profile));
