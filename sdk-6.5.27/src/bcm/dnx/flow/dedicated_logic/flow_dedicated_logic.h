...
shr_error_e dnx_flow_dl_inlif_profile_create(
    int unit,
    dnx_flow_app_config_t * flow_app_info,
    uint32 entry_handle_id,
...
shr_error_e dnx_flow_dl_inlif_profile_get(
    int unit,
    uint32 entry_handle_id,
    dnx_flow_app_config_t * flow_app_info,
    bcm_gport_t lif_gport,
...
shr_error_e dnx_flow_dl_inlif_profile_replace(
    int unit,
    dnx_flow_app_config_t * flow_app_info,
...
shr_error_e dnx_flow_dl_inlif_profile_destroy(
    int unit,
    uint32 entry_handle_id,
    bcm_gport_t lif_gport,
    dnx_algo_gpm_gport_hw_resources_t * gport_hw_resources);
