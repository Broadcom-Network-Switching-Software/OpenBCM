    ...
    int unit)
{
    ...
    {
        uint32 context_drop_lsb[TDM_CONTEXT_DROP_REG_SIZE_WORDS];

        sal_memset(context_drop_lsb, 0, sizeof(context_drop_lsb));
        context_drop_lsb[0] = 1;

        SHR_IF_ERR_EXIT(dnx_dbal_gen_set(unit, DBAL_TABLE_TDM_CONTEXT_DROP, 0, 1,
                                         GEN_DBAL_ARR32, DBAL_FIELD_CONTEXT_DROP_LSB, INST_SINGLE, context_drop_lsb,
                                         GEN_DBAL_FIELD_LAST_MARK));
    }
