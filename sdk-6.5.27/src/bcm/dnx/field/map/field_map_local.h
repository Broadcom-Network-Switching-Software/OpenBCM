...
shr_error_e dnx_field_convert_stat_lm_entry(
    int unit,
    uint32 flags,
    int core,
    uint32 *bcm_data,
...
shr_error_e dnx_field_convert_prt_qualifier(
    int unit,
    uint32 flags,
    int core,
    uint32 *bcm_data,
...
shr_error_e dnx_field_convert_exem_learn_payload0(
    int unit,
    uint32 flags,
    int core,
    uint32 *bcm_data,
...
shr_error_e dnx_field_convert_exem_learn_payload1(
    int unit,
    uint32 flags,
    int core,
    uint32 *bcm_data,
...
shr_error_e dnx_field_convert_exem_learn_fg_app_db_id(
    int unit,
    uint32 flags,
    int core,
    uint32 *bcm_data,
...
shr_error_e dnx_field_convert_oam_ts_data(
    int unit,
    uint32 flags,
    int core,
    uint32 *bcm_data,
