    ...
    bcm_ppp_terminator_t * info)
{
    ...
    /** Verify that PPP type is supported */
    SHR_INVOKE_VERIFY_DNXC(dnx_ppp_terminator_type_verify(unit, info->type));
    ...
    int *propagation_prof)
{
    ...
    if (dbal_field[0] == DBAL_ENUM_FVAL_VTT_LIF_SERVICE_TYPE_P2P)
    {
    ...
    bcm_ppp_terminator_t * info)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_ppp_terminator_create_verify(unit, info));
    ...
    bcm_ppp_terminator_t * info)
{
    ...
    /** Verification of input parameters */
    SHR_INVOKE_VERIFY_DNXC(dnx_ppp_terminator_get_verify(unit, info));
    ...
    bcm_ppp_terminator_t * info)
{
    ...
    /** Verification of input parameters */
    SHR_INVOKE_VERIFY_DNXC(dnx_ppp_terminator_delete_verify(unit, info));
    ...
    void *user_data)
{
    ...
    /** Verification of input parameters */
    SHR_INVOKE_VERIFY_DNXC(dnx_ppp_terminator_traverse_verify(unit, additional_info, cb, user_data));
    ...
    bcm_ppp_term_spoofing_check_t * info)
{
    ...
    /** Verification of input parameters */
    SHR_INVOKE_VERIFY_DNXC(dnx_ppp_term_spoofing_check_add_verify(unit, info));
    ...
    /** Set key fields */
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_GLOBAL_IN_LIF_0, global_lif_1);
    ...
    bcm_ppp_term_spoofing_check_t * info)
{
    ...
    /** Verification of input parameters */
    SHR_INVOKE_VERIFY_DNXC(dnx_ppp_term_spoofing_check_delete_verify(unit, info));
    ...
    void *user_data)
{
    ...
    /** Verification of input parameters */
    SHR_INVOKE_VERIFY_DNXC(dnx_ppp_term_spoofing_check_traverse_verify(unit, additional_info, cb, user_data));
    ...
    while (!is_end)
    {
        /** In_LIFs[0] PPPoE LIF */
        SHR_IF_ERR_EXIT(dbal_entry_handle_key_field_arr32_get
                        (unit, entry_handle_id, DBAL_FIELD_GLOBAL_IN_LIF_0, &global_inlif_1));
