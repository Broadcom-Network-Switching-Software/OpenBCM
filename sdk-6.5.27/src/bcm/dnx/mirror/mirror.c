    ...
    bcm_mirror_header_info_t * mirror_header_info)
{
    ...
    if ((mirror_header_info->udh[0].size > dnx_data_headers.system_headers.max_udh0_block_size_get(unit))
        || (mirror_header_info->udh[1].size > dnx_data_headers.system_headers.max_udh1_block_size_get(unit))
        || (mirror_header_info->udh[2].size > dnx_data_headers.system_headers.max_udh2_block_size_get(unit))
        || (mirror_header_info->udh[3].size > dnx_data_headers.system_headers.max_udh3_block_size_get(unit)))
    {
