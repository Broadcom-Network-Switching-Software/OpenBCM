...
#define PREFIX_TRUNK_MEMBER   DBAL_ENUM_FVAL_OAM_KEY_PREFIX_TRUNK_MEMBER
...
static const oam_key_select_ingress_table_entry_t oam_key_select_ingress_map[] = {
    ...
    {1, 1, 1, ING_OAM_LIF, ING_OAM_LIF_2, ING_OAM_LIF_3, PREFIX_TRUNK_MEMBER, PREFIX_TRUNK_MEMBER, PREFIX_TRUNK_MEMBER, 1},
};
...
static const oam_key_select_egress_table_entry_t oam_key_select_egress_map[] = {
    ...
    {2, 0, 0, 0, EG_OAM_LIF_1, EG_OAM_LIF_2, EG_OAM_LIF_NULL, PREFIX_HIGH, PREFIX_HIGH, PREFIX_HIGH, 1},
    {2, 0, 0, 1, EG_OAM_LIF_1, EG_OAM_LIF_2, EG_OAM_LIF_NULL, PREFIX_HIGH, PREFIX_HIGH, PREFIX_HIGH, 1},
    ...
    uint32 *key_base_3)
{
    ...
    if (oam_hlm_support == 1)
    {
        ...
        dbal_value_field32_request(unit, entry_handle_id, DBAL_FIELD_OAM_ING_KEY_BASE_SELECT_2, INST_SINGLE,
                                   key_base_2);
        dbal_value_field32_request(unit, entry_handle_id, DBAL_FIELD_OAM_ING_KEY_BASE_SELECT_3, INST_SINGLE,
                                   key_base_3);
    }
