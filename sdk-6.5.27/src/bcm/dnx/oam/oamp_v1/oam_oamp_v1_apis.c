...
/*
 * Argument verification that is the same for dnx_oam_oamp_v1_mep_db_get and dnx_oam_oamp_v1_mep_db_add
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_verify(
    int unit,
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_eth_oam_add(
    int unit,
    ...
    const dnx_oam_oamp_mep_db_args_t * entry_values)
{
    ...
    else
    {
        ...
        if (UTILEX_GET_BIT(entry_values->flags, OAMP_MEP_EGRESS_INJECTION))
        {
            ...
            /*
             * Set address factor to indicate the different address in OAMP generic memory
             * which is used to store ingress VLAN edit command ID to delete 0/1/2 VLAN
             * tag(s) for Down MEP Egress inject
             * Currently for Jericho2 mode only
             */
            if (system_headers_mode == DBAL_ENUM_FVAL_SYSTEM_HEADERS_MODE_JERICHO2_MODE)
            {
                dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_IVEC_ADDRESS_FACTOR, INST_SINGLE,
                                             entry_values->exclusive.oam_only.ivec_address_factor);
            }
        }
    }
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_mplstp_oam_add(
    int unit,
    const uint32 entry_id,
    const dnx_oam_oamp_mep_db_args_t * entry_values)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_pwe_oam_add(
    int unit,
    const uint32 entry_id,
    const dnx_oam_oamp_mep_db_args_t * entry_values)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_bfd_one_hop_add(
    int unit,
    const uint32 entry_id,
    const dnx_oam_oamp_mep_db_args_t * entry_values)
{
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_LOCAL_DISCR_LSB, INST_SINGLE,
                                 entry_values->exclusive.bfd_only.local_discr_lsb);
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_bfd_multi_hop_add(
    int unit,
    const uint32 entry_id,
    const dnx_oam_oamp_mep_db_args_t * entry_values)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_bfd_mpls_add(
    int unit,
    const uint32 entry_id,
    const dnx_oam_oamp_mep_db_args_t * entry_values)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_bfd_pwe_add(
    int unit,
    const uint32 entry_id,
    const dnx_oam_oamp_mep_db_args_t * entry_values)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_rfc_6374_add(
    int unit,
    const uint32 entry_id,
    const dnx_oam_oamp_mep_db_args_t * entry_values)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_lm_db_add(
    int unit,
    const uint32 entry_id,
    const dnx_oam_oamp_mep_db_args_t * entry_values)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_lm_stat_add(
    int unit,
    const uint32 entry_id,
    const dnx_oam_oamp_mep_db_args_t * entry_values)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_dm_stat_one_way_add(
    int unit,
    const uint32 entry_id,
    const dnx_oam_oamp_mep_db_args_t * entry_values)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_dm_stat_two_way_add(
    int unit,
    const uint32 entry_id,
    const dnx_oam_oamp_mep_db_args_t * entry_values)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_extra_data_header_add(
    int unit,
    const uint32 entry_id,
    const dnx_oam_oamp_mep_db_args_t * entry_values)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_extra_data_payload_add(
    int unit,
    const uint32 entry_id,
    const dnx_oam_oamp_mep_db_args_t * entry_values)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_lm_dm_offloaded_part_1_add(
    int unit,
    const uint32 entry_id,
    const dnx_oam_oamp_mep_db_args_t * entry_values)
{
    ...
    flag = UTILEX_GET_BIT(entry_values->flags, OAMP_MEP_RDI_FROM_PACKET);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_RDI_FROM_PACKET, INST_SINGLE, flag);
    if (UTILEX_GET_BIT(entry_values->flags, OAMP_MEP_MEASURE_NEXT_RECEIVED_SLR))
    {
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_lm_dm_offloaded_part_2_add(
    int unit,
    const uint32 entry_id,
    const dnx_oam_oamp_mep_db_args_t * entry_values)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_oam_q_entry_add(
    int unit,
    const uint32 entry_id,
    const dnx_oam_oamp_mep_db_args_t * entry_values)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_bfd_q_entry_add(
    int unit,
    const uint32 entry_id,
    const dnx_oam_oamp_mep_db_args_t * entry_values)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_entry_add(
    int unit,
    const uint32 oamp_entry_id,
    const dnx_oam_oamp_mep_db_args_t * entry_values)
{
    ...
    /** Verify parameters */
    SHR_INVOKE_VERIFY_DNXC(dnx_oam_oamp_v1_mep_db_verify(unit, oamp_entry_id));
    ...
    if (UTILEX_GET_BIT(entry_values->flags, OAMP_MEP_LM_DM_OFFLOADED))
    {
        ...
        {
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_lm_dm_offloaded_part_2_add(unit, oamp_entry_id, entry_values));
        }
        else
        {
            ...
            switch (entry_values->mep_type)
            {
                ...
                case DBAL_ENUM_FVAL_OAMP_MEP_TYPE_Y1731_MPLSTP:
                case DBAL_ENUM_FVAL_OAMP_MEP_TYPE_Y1731_PWE:
                    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_lm_dm_offloaded_part_1_add
                                    (unit, oamp_entry_id, entry_values));
                    break;
    ...
    else
    {
        ...
        if (UTILEX_GET_BIT(entry_values->flags, OAMP_MEP_Q_ENTRY))
        {
            ...
            switch (entry_values->mep_type)
            {
                ...
                case DBAL_ENUM_FVAL_OAMP_MEP_TYPE_Y1731_MPLSTP:
                case DBAL_ENUM_FVAL_OAMP_MEP_TYPE_Y1731_PWE:
                    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_oam_q_entry_add(unit, oamp_entry_id, entry_values));
                    break;
                ...
                case DBAL_ENUM_FVAL_OAMP_MEP_TYPE_BFD_MPLS:
                case DBAL_ENUM_FVAL_OAMP_MEP_TYPE_BFD_PWE:
                    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_bfd_q_entry_add(unit, oamp_entry_id, entry_values));
                    break;
        ...
        else
        {
            ...
            {
                case DBAL_ENUM_FVAL_OAMP_MEP_TYPE_ETH_OAM:
                    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_eth_oam_add(unit, oamp_entry_id, entry_values));
                    break;

                case DBAL_ENUM_FVAL_OAMP_MEP_TYPE_Y1731_MPLSTP:
                    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_mplstp_oam_add(unit, oamp_entry_id, entry_values));
                    break;

                case DBAL_ENUM_FVAL_OAMP_MEP_TYPE_Y1731_PWE:
                    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_pwe_oam_add(unit, oamp_entry_id, entry_values));
                    break;

                case DBAL_ENUM_FVAL_OAMP_MEP_TYPE_BFD_IPV4_1HOP:
                    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_bfd_one_hop_add(unit, oamp_entry_id, entry_values));
                    break;

                case DBAL_ENUM_FVAL_OAMP_MEP_TYPE_BFD_IPV4_MHOP:
                    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_bfd_multi_hop_add(unit, oamp_entry_id, entry_values));
                    break;

                case DBAL_ENUM_FVAL_OAMP_MEP_TYPE_BFD_MPLS:
                    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_bfd_mpls_add(unit, oamp_entry_id, entry_values));
                    break;

                case DBAL_ENUM_FVAL_OAMP_MEP_TYPE_BFD_PWE:
                    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_bfd_pwe_add(unit, oamp_entry_id, entry_values));
                    break;
                case DBAL_ENUM_FVAL_OAMP_MEP_TYPE_RFC_6374:
                    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_rfc_6374_add(unit, oamp_entry_id, entry_values));
                    break;

                case DBAL_ENUM_FVAL_OAMP_MEP_TYPE_LM_DB:
                    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_lm_db_add(unit, oamp_entry_id, entry_values));
                    break;

                case DBAL_ENUM_FVAL_OAMP_MEP_TYPE_LM_STAT:
                    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_lm_stat_add(unit, oamp_entry_id, entry_values));
                    break;

                case DBAL_ENUM_FVAL_OAMP_MEP_TYPE_DM_STAT:
                    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_dm_stat_two_way_add(unit, oamp_entry_id, entry_values));
                    break;

                case DBAL_ENUM_FVAL_OAMP_MEP_TYPE_EXT_DATA_HDR:
                    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_extra_data_header_add(unit, oamp_entry_id, entry_values));
                    break;

                case DBAL_ENUM_FVAL_OAMP_MEP_TYPE_EXT_DATA_PLD:
                    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_extra_data_payload_add(unit, oamp_entry_id, entry_values));
                    break;

                case DBAL_ENUM_FVAL_OAMP_MEP_TYPE_DM_STAT_ONE_WAY:
                    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_dm_stat_one_way_add(unit, oamp_entry_id, entry_values));
                    break;
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_eth_oam_get(
    int unit,
    const uint32 entry_id,
    ...
    uint32 entry_handle_id)
{
    ...
    else
    {
        ...
        if (UTILEX_GET_BIT(entry_values->flags, OAMP_MEP_EGRESS_INJECTION))
        {
            ...
            /*
             * Get address factor to indicate the different address in OAMP generic memory
             * which is used to store ingress VLAN edit command ID to delete 0/1/2 VLAN
             * tag(s) for Down MEP Egress inject
             * Currently for Jericho2 mode only
             */
            ...
            {
                SHR_IF_ERR_EXIT(dbal_entry_handle_value_field32_get
                                (unit, entry_handle_id, DBAL_FIELD_IVEC_ADDRESS_FACTOR, INST_SINGLE, &value));
                entry_values->exclusive.oam_only.ivec_address_factor = value;
            }
        }
    }
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_mplstp_oam_get(
    int unit,
    const uint32 entry_id,
    dnx_oam_oamp_mep_db_args_t * entry_values,
    uint32 entry_handle_id)
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_pwe_oam_get(
    int unit,
    const uint32 entry_id,
    dnx_oam_oamp_mep_db_args_t * entry_values,
    uint32 entry_handle_id)
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_bfd_one_hop_get(
    int unit,
    const uint32 entry_id,
    dnx_oam_oamp_mep_db_args_t * entry_values,
    uint32 entry_handle_id)
{
    ...
    SHR_IF_ERR_EXIT(dbal_entry_handle_value_field32_get
                    (unit, entry_handle_id, DBAL_FIELD_LOCAL_DISCR_LSB, INST_SINGLE, &value));
    entry_values->exclusive.bfd_only.local_discr_lsb = value;
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_bfd_multi_hop_get(
    int unit,
    const uint32 entry_id,
    dnx_oam_oamp_mep_db_args_t * entry_values,
    uint32 entry_handle_id)
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_bfd_mpls_get(
    int unit,
    const uint32 entry_id,
    dnx_oam_oamp_mep_db_args_t * entry_values,
    uint32 entry_handle_id)
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_bfd_pwe_get(
    int unit,
    const uint32 entry_id,
    dnx_oam_oamp_mep_db_args_t * entry_values,
    uint32 entry_handle_id)
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_rfc_6374_get(
    int unit,
    const uint32 entry_id,
    dnx_oam_oamp_mep_db_args_t * entry_values,
    uint32 entry_handle_id)
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_lm_db_get(
    int unit,
    const uint32 entry_id,
    dnx_oam_oamp_mep_db_args_t * entry_values,
    uint32 entry_handle_id)
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_lm_stat_get(
    int unit,
    const uint32 entry_id,
    dnx_oam_oamp_mep_db_args_t * entry_values,
    uint32 entry_handle_id)
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_dm_stat_one_way_get(
    int unit,
    const uint32 entry_id,
    dnx_oam_oamp_mep_db_args_t * entry_values,
    uint32 entry_handle_id)
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_dm_stat_two_way_get(
    int unit,
    const uint32 entry_id,
    dnx_oam_oamp_mep_db_args_t * entry_values,
    uint32 entry_handle_id)
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_extra_data_header_get(
    int unit,
    const uint32 entry_id,
    dnx_oam_oamp_mep_db_args_t * entry_values,
    uint32 entry_handle_id)
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_extra_data_payload_get(
    int unit,
    const uint32 entry_id,
    dnx_oam_oamp_mep_db_args_t * entry_values,
    uint32 entry_handle_id)
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_lm_dm_offloaded_part_1_get(
    int unit,
    const uint32 entry_id,
    dnx_oam_oamp_mep_db_args_t * entry_values,
    uint32 entry_handle_id)
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_lm_dm_offloaded_part_2_get(
    int unit,
    const uint32 entry_id,
    dnx_oam_oamp_mep_db_args_t * entry_values,
    uint32 entry_handle_id)
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_oam_q_entry_get(
    int unit,
    const uint32 entry_id,
    dnx_oam_oamp_mep_db_args_t * entry_values,
    uint32 entry_handle_id)
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mep_db_bfd_q_entry_get(
    int unit,
    const uint32 entry_id,
    dnx_oam_oamp_mep_db_args_t * entry_values,
    uint32 entry_handle_id)
 ...
 */
shr_error_e
dnx_oam_oamp_v1_mep_db_get(
    int unit,
    const uint32 entry_id,
    dnx_oam_oamp_mep_db_args_t * entry_values)
{
    uint32 entry_handle_id;
    dbal_result_type_t resulting_format;
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FUNC_INIT_VARS(unit);

    /** Verify parameters */
    SHR_INVOKE_VERIFY_DNXC(dnx_oam_oamp_v1_mep_db_verify(unit, entry_id));
    SHR_NULL_CHECK(entry_values, _SHR_E_PARAM, "entry_values");
    ...
    switch (resulting_format)
    {
        ...
        case DBAL_RESULT_TYPE_OAMP_MEP_DB_ETH_OAM_UP_MEP_SERVER:
            ...
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_eth_oam_get(unit, entry_id, entry_values, entry_handle_id));
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_DB_Y1731_MPLSTP:
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_mplstp_oam_get(unit, entry_id, entry_values, entry_handle_id));
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_DB_Y1731_PWE:
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_pwe_oam_get(unit, entry_id, entry_values, entry_handle_id));
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_DB_BFD_IPV4_ONE_HOP:
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_bfd_one_hop_get(unit, entry_id, entry_values, entry_handle_id));
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_DB_BFD_IPV4_MULTI_HOP:
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_bfd_multi_hop_get(unit, entry_id, entry_values, entry_handle_id));
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_DB_BFD_MPLS:
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_bfd_mpls_get(unit, entry_id, entry_values, entry_handle_id));
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_DB_BFD_PWE:
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_bfd_pwe_get(unit, entry_id, entry_values, entry_handle_id));
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_DB_RFC_6374:
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_rfc_6374_get(unit, entry_id, entry_values, entry_handle_id));
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_DB_LM_DB:
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_lm_db_get(unit, entry_id, entry_values, entry_handle_id));
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_DB_LM_STAT:
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_lm_stat_get(unit, entry_id, entry_values, entry_handle_id));
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_DB_DM_STAT_TWO_WAY:
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_dm_stat_two_way_get(unit, entry_id, entry_values, entry_handle_id));
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_DB_EXTRA_DATA_HEADER:
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_extra_data_header_get
                            (unit, entry_id, entry_values, entry_handle_id));
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_DB_EXTRA_DATA_PAYLOAD:
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_extra_data_payload_get
                            (unit, entry_id, entry_values, entry_handle_id));
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_DB_DM_STAT_ONE_WAY:
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_dm_stat_one_way_get(unit, entry_id, entry_values, entry_handle_id));
            break;
        ...
        case DBAL_RESULT_TYPE_OAMP_MEP_DB_LM_DM_OFFLOADED_PART_1:
            ...
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_lm_dm_offloaded_part_1_get
                            (unit, entry_id, entry_values, entry_handle_id));
            break;
        ...
        case DBAL_RESULT_TYPE_OAMP_MEP_DB_LM_DM_OFFLOADED_PART_2:
            ...
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_lm_dm_offloaded_part_2_get
                            (unit, entry_id, entry_values, entry_handle_id));
            break;
        ...
        case DBAL_RESULT_TYPE_OAMP_MEP_DB_Q_ENTRY_OAM_FORMAT_UP_MEP:
            ...
            UTILEX_SET_BIT(entry_values->flags,
                           ...
                           OAMP_MEP_IS_UPMEP);
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_oam_q_entry_get(unit, entry_id, entry_values, entry_handle_id));
            break;
        ...
        case DBAL_RESULT_TYPE_OAMP_MEP_DB_Q_ENTRY_BFD_FORMAT:
            ...
            UTILEX_SET_BIT(entry_values->flags, TRUE, OAMP_MEP_Q_ENTRY);
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_bfd_q_entry_get(unit, entry_id, entry_values, entry_handle_id));
            break;
    ...
    const uint32 entry_id)
{
    ...
    /** Deallocate entry */
    SHR_IF_ERR_EXIT(dnx_algo_oamp_v1_mep_entry_dealloc(unit, entry_id));
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mdb_lm_dm_eth_ccm_part_1_add(
    int unit,
    const uint32 oamp_entry_id,
    const dnx_oam_oamp_mep_db_args_t * entry_values)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mdb_lm_dm_eth_ccm_part_2_add(
    int unit,
    const uint32 oamp_entry_id,
    const dnx_oam_oamp_mep_db_args_t * entry_values)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mdb_lm_dm_mplstp_pwe_part_1_add(
    int unit,
    const uint32 oamp_entry_id,
    const dnx_oam_oamp_mep_db_args_t * entry_values)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mdb_lm_dm_mplstp_pwe_part_2_add(
    int unit,
    const uint32 oamp_entry_id,
    const dnx_oam_oamp_mep_db_args_t * entry_values)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mdb_eth_ccm_q_entry_add(
    int unit,
    const uint32 oamp_entry_id,
    const dnx_oam_oamp_mep_db_args_t * entry_values)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mdb_mplstp_pwe_q_entry_add(
    int unit,
    const uint32 oamp_entry_id,
    const dnx_oam_oamp_mep_db_args_t * entry_values)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mdb_bfd_one_hop_q_entry_add(
    int unit,
    const uint32 oamp_entry_id,
    const dnx_oam_oamp_mep_db_args_t * entry_values)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mdb_bfd_multi_hop_q_entry_add(
    int unit,
    const uint32 oamp_entry_id,
    const dnx_oam_oamp_mep_db_args_t * entry_values)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mdb_bfd_mpls_q_entry_add(
    int unit,
    const uint32 oamp_entry_id,
    const dnx_oam_oamp_mep_db_args_t * entry_values)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mdb_bfd_pwe_q_entry_add(
    int unit,
    const uint32 oamp_entry_id,
    const dnx_oam_oamp_mep_db_args_t * entry_values)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mdb_extra_data_header_add(
    int unit,
    const uint32 entry_id,
    const dnx_oam_oamp_mep_db_args_t * entry_values)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mdb_extra_data_payload_add(
    int unit,
    const uint32 entry_id,
    const dnx_oam_oamp_mep_db_args_t * entry_values)
{
    ...
    const dnx_oam_oamp_mep_db_args_t * entry_values)
{
    ...
    if (UTILEX_GET_BIT(entry_values->flags, OAMP_MEP_LM_DM_OFFLOADED))
    {
        ...
        switch (entry_values->mep_type)
        {
            case DBAL_ENUM_FVAL_OAMP_MEP_TYPE_ETH_OAM:
                ...
                if (UTILEX_GET_BIT(entry_values->flags, OAMP_MEP_Q_ENTRY))
                {
                    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mdb_lm_dm_eth_ccm_part_2_add(unit, oamp_entry_id, entry_values));
                }
                else
                {
                    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mdb_lm_dm_eth_ccm_part_1_add(unit, oamp_entry_id, entry_values));
                }
                break;
            ...
            case DBAL_ENUM_FVAL_OAMP_MEP_TYPE_Y1731_PWE:
                ...
                if (UTILEX_GET_BIT(entry_values->flags, OAMP_MEP_Q_ENTRY))
                {
                    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mdb_lm_dm_mplstp_pwe_part_2_add(unit, oamp_entry_id, entry_values));
                }
                else
                {
                    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mdb_lm_dm_mplstp_pwe_part_1_add(unit, oamp_entry_id, entry_values));
                }
                break;
            ...
            case DBAL_ENUM_FVAL_OAMP_MEP_TYPE_EXT_DATA_HDR:
                SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mdb_extra_data_header_add(unit, oamp_entry_id, entry_values));
                break;

            case DBAL_ENUM_FVAL_OAMP_MEP_TYPE_EXT_DATA_PLD:
                SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mdb_extra_data_payload_add(unit, oamp_entry_id, entry_values));
                break;
    ...
    else
    {
        ...
        if (UTILEX_GET_BIT(entry_values->flags, OAMP_MEP_Q_ENTRY))
        {
            ...
            {
                case DBAL_ENUM_FVAL_OAMP_MEP_TYPE_ETH_OAM:
                    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mdb_eth_ccm_q_entry_add(unit, oamp_entry_id, entry_values));
                    break;

                case DBAL_ENUM_FVAL_OAMP_MEP_TYPE_Y1731_MPLSTP:
                case DBAL_ENUM_FVAL_OAMP_MEP_TYPE_Y1731_PWE:
                    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mdb_mplstp_pwe_q_entry_add(unit, oamp_entry_id, entry_values));
                    break;

                case DBAL_ENUM_FVAL_OAMP_MEP_TYPE_BFD_IPV4_1HOP:
                    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mdb_bfd_one_hop_q_entry_add(unit, oamp_entry_id, entry_values));
                    break;

                case DBAL_ENUM_FVAL_OAMP_MEP_TYPE_BFD_IPV4_MHOP:
                    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mdb_bfd_multi_hop_q_entry_add(unit, oamp_entry_id, entry_values));
                    break;

                case DBAL_ENUM_FVAL_OAMP_MEP_TYPE_BFD_MPLS:
                    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mdb_bfd_mpls_q_entry_add(unit, oamp_entry_id, entry_values));
                    break;

                case DBAL_ENUM_FVAL_OAMP_MEP_TYPE_BFD_PWE:
                    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mdb_bfd_pwe_q_entry_add(unit, oamp_entry_id, entry_values));
                    break;
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mdb_lm_dm_eth_ccm_part_1_get(
    int unit,
    dnx_oam_oamp_mep_db_args_t * entry_values,
    uint32 entry_handle_id)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mdb_lm_dm_eth_ccm_part_2_get(
    int unit,
    dnx_oam_oamp_mep_db_args_t * entry_values,
    uint32 entry_handle_id)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mdb_lm_dm_mplstp_pwe_part_1_get(
    int unit,
    dnx_oam_oamp_mep_db_args_t * entry_values,
    uint32 entry_handle_id)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mdb_lm_dm_mplstp_pwe_part_2_get(
    int unit,
    dnx_oam_oamp_mep_db_args_t * entry_values,
    uint32 entry_handle_id)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mdb_eth_ccm_q_entry_get(
    int unit,
    dnx_oam_oamp_mep_db_args_t * entry_values,
    uint32 entry_handle_id)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mdb_mplstp_pwe_q_entry_get(
    int unit,
    dnx_oam_oamp_mep_db_args_t * entry_values,
    uint32 entry_handle_id)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mdb_bfd_one_hop_q_entry_get(
    int unit,
    dnx_oam_oamp_mep_db_args_t * entry_values,
    uint32 entry_handle_id)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mdb_bfd_multi_hop_q_entry_get(
    int unit,
    dnx_oam_oamp_mep_db_args_t * entry_values,
    uint32 entry_handle_id)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mdb_bfd_mpls_q_entry_get(
    int unit,
    dnx_oam_oamp_mep_db_args_t * entry_values,
    uint32 entry_handle_id)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mdb_bfd_pwe_q_entry_get(
    int unit,
    dnx_oam_oamp_mep_db_args_t * entry_values,
    uint32 entry_handle_id)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mdb_extra_data_header_get(
    int unit,
    dnx_oam_oamp_mep_db_args_t * entry_values,
    uint32 entry_handle_id)
{
 ...
 */
static shr_error_e
dnx_oam_oamp_v1_mdb_extra_data_payload_get(
    int unit,
    dnx_oam_oamp_mep_db_args_t * entry_values,
    uint32 entry_handle_id)
{
    ...
    dnx_oam_oamp_mep_db_args_t * entry_values)
{
    ...
    switch (resulting_format)
    {
        ...
        case DBAL_RESULT_TYPE_OAMP_MEP_STATIC_DATA_DB_MEP_DB_CCM_ETH_LM_DM_OFFLOAD_MDB_FORMAT_PART_1_UPMEP:
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mdb_lm_dm_eth_ccm_part_1_get(unit, entry_values, entry_handle_id));
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_STATIC_DATA_DB_MEP_DB_CCM_ETH_LM_DM_OFFLOAD_MDB_FORMAT_PART_2:
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mdb_lm_dm_eth_ccm_part_2_get(unit, entry_values, entry_handle_id));
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_STATIC_DATA_DB_MEP_DB_MPLSTP_PWE_LM_DM_OFFLOAD_MDB_FORMAT_PART_1:
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mdb_lm_dm_mplstp_pwe_part_1_get(unit, entry_values, entry_handle_id));
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_STATIC_DATA_DB_MEP_DB_MPLSTP_PWE_LM_DM_OFFLOAD_MDB_FORMAT_PART_2:
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mdb_lm_dm_mplstp_pwe_part_2_get(unit, entry_values, entry_handle_id));
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_STATIC_DATA_DB_MEP_DB_CCM_ETH_SHORT_STATIC_MDB_FORMAT:
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mdb_eth_ccm_q_entry_get(unit, entry_values, entry_handle_id));
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_STATIC_DATA_DB_MEP_DB_MPLSTP_PWE_SHORT_STATIC_MDB_FORMAT:
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mdb_mplstp_pwe_q_entry_get(unit, entry_values, entry_handle_id));
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_STATIC_DATA_DB_MEP_DB_BFD_IPV4_1_HOP_SHORT_STATIC_MDB_FORMAT:
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mdb_bfd_one_hop_q_entry_get(unit, entry_values, entry_handle_id));
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_STATIC_DATA_DB_MEP_DB_BFD_IPV4_M_HOP_SHORT_STATIC_MDB_FORMAT:
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mdb_bfd_multi_hop_q_entry_get(unit, entry_values, entry_handle_id));
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_STATIC_DATA_DB_MEP_DB_BFD_ON_MPLS_SHORT_STATIC_MDB_FORMAT:
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mdb_bfd_mpls_q_entry_get(unit, entry_values, entry_handle_id));
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_STATIC_DATA_DB_MEP_DB_BFD_ON_PWE_SHORT_STATIC_MDB_FORMAT:
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mdb_bfd_pwe_q_entry_get(unit, entry_values, entry_handle_id));
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_STATIC_DATA_DB_MEP_DB_EXTRA_DATA_IN_MDB_HEADER:
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mdb_extra_data_header_get(unit, entry_values, entry_handle_id));
            break;

        case DBAL_RESULT_TYPE_OAMP_MEP_STATIC_DATA_DB_MEP_DB_EXTRA_DATA_IN_MDB_PAYLOAD:
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mdb_extra_data_payload_get(unit, entry_values, entry_handle_id));
            break;
    ...
    const dnx_oam_oamp_mep_db_args_t * entry_values)
{
    ...
    if (!UTILEX_GET_BIT(entry_values->flags, OAMP_MEP_UPDATE))
    {
        ...
        SHR_IF_ERR_EXIT(dnx_algo_oamp_v1_mep_entry_alloc(unit, (int *) &oamp_entry_id));
    }
    ...
    do
    {
        SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_entry_add(unit, oamp_entry_id, entry_values));
        ...
        SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_get(unit, oamp_entry_id, read_entry_values));
        ...
        /**PWE type bfd doesn't use port profile, but it'll be overwrote by injected_core(8th bit)*/
        if ((entry_values->mep_type == DBAL_ENUM_FVAL_OAMP_MEP_TYPE_BFD_PWE)
            && (read_entry_values->injected_core_id != 0))
        {
            read_entry_values->unified_port_access.port_profile = 0;
        }
        ...
        /** VSI and ivec_address_factor are relevant for Down-MEP egress injection only */
        if (!UTILEX_GET_BIT(entry_values->flags, OAMP_MEP_EGRESS_INJECTION))
        {
            read_entry_values->exclusive.oam_only.vsi = entry_values->exclusive.oam_only.vsi;
            read_entry_values->exclusive.oam_only.ivec_address_factor =
                entry_values->exclusive.oam_only.ivec_address_factor;
        }
