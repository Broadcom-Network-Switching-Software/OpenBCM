...
#include <include/bcm_int/dnx/auto_generated/dnx_oam_dispatch.h>
...
typedef enum
{
    DNX_OAM_OAMP_GENERIC_MEMORY_ENTITY_DM_JUMBO_TLV,
    DNX_OAM_OAMP_GENERIC_MEMORY_ENTITY_DOWN_MEP_INJ,

    DNX_OAM_OAMP_GENERIC_MEMORY_ENTITY_NOF
} dnx_oam_oamp_generic_memory_entity_id_e;

typedef struct
{

    dnx_oam_oamp_generic_memory_entity_id_e entity_id;

    int nof_entries;

    int entry_index;

} dnx_oam_oamp_generic_memory_entity_t;
    ...
    uint16 calculated_crc)
{
    ...
    SHR_ALLOC_SET_ZERO_ERR_EXIT(extra_header_data, DNX_OAM_OAMP_EXTRA_DATA_MAX_SIZE,
...
static shr_error_e
dnx_oam_oamp_v1_system_port_profile_sw_update(
    int unit,
    ...
    oam_oamp_profile_hw_data_t * mep_hw_write_data)
{
    ...
    SHR_ALLOC_SET_ZERO_ERR_EXIT(tx_gport_data, sizeof(dnx_algo_gpm_gport_phy_info_t),
...
static shr_error_e
dnx_oam_oamp_v1_init_mep_db_cfg(
    int unit)
{
...
static shr_error_e
dnx_oam_oamp_v1_init_trap_map_cfg(
    int unit)
{
    uint32 entry_handle_id;
...
static shr_error_e
dnx_oamp_v1_bfd_pwe_channel_value_get_verify(
    int unit,
    uint32 index,
    uint32 *value)
{
...
shr_error_e
dnx_oamp_v1_bfd_pwe_channel_value_get(
    int unit,
    uint32 index,
    uint32 *value)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_oamp_v1_bfd_pwe_channel_value_get_verify(unit, index, value));
...
static shr_error_e
dnx_oamp_v1_y1731_mpls_tp_channel_value_get_verify(
    int unit,
    uint32 *value)
{
    SHR_FUNC_INIT_VARS(unit);
...
shr_error_e
dnx_oamp_v1_y1731_mpls_tp_channel_value_get(
    int unit,
    uint32 *value)
{
    uint32 entry_handle_id;
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_oamp_v1_y1731_mpls_tp_channel_value_get_verify(unit, value));
...
static shr_error_e
dnx_oamp_v1_y1731_pwe_channel_value_get_verify(
    int unit,
    uint32 *value)
{
    SHR_FUNC_INIT_VARS(unit);
...
shr_error_e
dnx_oamp_v1_y1731_pwe_channel_value_get(
    int unit,
    uint32 *value)
{
    uint32 entry_handle_id;
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_oamp_v1_y1731_pwe_channel_value_get_verify(unit, value));
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_OAMP_INIT_Y1731_GENERAL_CFG, &entry_handle_id));
...
shr_error_e
dnx_oamp_v1_y1731_mpls_tp_channel_value_set(
    int unit,
    uint32 value)
{
    uint32 entry_handle_id;
...
shr_error_e
dnx_oamp_v1_y1731_pwe_channel_value_set(
    int unit,
    uint32 value)
{
    uint32 entry_handle_id;
...
static shr_error_e
dnx_oamp_v1_bfd_pwe_channel_value_delete_verify(
    int unit,
    uint32 index)
{
    SHR_FUNC_INIT_VARS(unit);
...
shr_error_e
dnx_oamp_v1_bfd_pwe_channel_value_delete(
    int unit,
    uint32 index,
    uint32 value)
{
    uint32 entry_handle_id;
    uint32 ach_header = 0;
    uint32 value_in_ach_header, value_channel_type;

    SHR_FUNC_INIT_VARS(unit);
    DBAL_FUNC_INIT_VARS(unit);

    SHR_INVOKE_VERIFY_DNXC(dnx_oamp_v1_bfd_pwe_channel_value_delete_verify(unit, index));

    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_OAMP_INIT_BFD_CFG, &entry_handle_id));
    dbal_value_field32_request(unit, entry_handle_id, DBAL_FIELD_G_ACH_HEADER, index, &ach_header);
    dbal_value_field32_request(unit, entry_handle_id, DBAL_FIELD_GACH_CHAN_TYPE, INST_SINGLE, &value_channel_type);
    SHR_IF_ERR_EXIT(dbal_entry_get(unit, entry_handle_id, DBAL_COMMIT));

    SHR_IF_ERR_EXIT(dnx_oam_mpls_tp_bfd_channel_value_get_from_ach_header(unit, &ach_header, &value_in_ach_header));

    if ((value != value_in_ach_header) ||
        ((value != value_channel_type) && (dnx_data_bfd.general.oamp_bfd_cw_valid_dis_supp_get(unit) == 0)))
    {
    ...
    if (index == 0)
    {
        ...
        value_in_ach_header = BFD_PWE_DEFAULT_CHANNEL;
        value_channel_type = BFD_MPLS_TP_CC_GACH_DEFAULT_CHANNEL;
    }
    else if (index == 1)
    {

        value_in_ach_header = BFD_MPLS_TP_CC_GACH_DEFAULT_CHANNEL;
        value_channel_type = BFD_PWE_DEFAULT_CHANNEL;
    }

    SHR_IF_ERR_EXIT(dnx_oam_mpls_tp_bfd_ach_header_form(unit, &value_in_ach_header, &ach_header));
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_GACH_CHAN_TYPE, INST_SINGLE, value_channel_type);
...
static shr_error_e
dnx_oamp_v1_bfd_pwe_channel_value_set_verify(
    int unit,
    uint32 index)
{
    SHR_FUNC_INIT_VARS(unit);
...
shr_error_e
dnx_oamp_v1_bfd_pwe_channel_value_set(
    int unit,
    uint32 index,
    uint32 value)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_oamp_v1_bfd_pwe_channel_value_set_verify(unit, index));
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_GACH_CHAN_TYPE, INST_SINGLE, value);
...
static shr_error_e
dnx_oam_oamp_v1_init_response_table(
    int unit)
{
    uint8 index = 0;
    SHR_FUNC_INIT_VARS(unit);
    ...
    uint8 keep_mep_profile)
{
    ...
    if (!keep_mep_profile)
    {
        ...
        SHR_IF_ERR_EXIT(algo_oam_db.
                        oam_mep_profile.free_single(unit, (int) mep_db_entry->mep_profile, &last_reference));
    ...
    uint32 header_entry_index)
{
    ...
    for (i = 0; i < extra_data_len; i++)
    {
        ...
        SHR_IF_ERR_EXIT(dnx_algo_oamp_v1_mep_id_dealloc(unit, current_entry));
    ...
    dnx_oam_oamp_ccm_endpoint_t * entry_values)
{
    ...
    SHR_ALLOC_SET_ZERO_ERR_EXIT(oamp_params, sizeof(dnx_oam_oamp_mep_db_args_t),
                                "Param struct for creating single entries", "%s%s%s\r\n", EMPTY, EMPTY, EMPTY);
    SHR_ALLOC_SET_ZERO_ERR_EXIT(oamp_params_rfc_6374, sizeof(dnx_oam_oamp_mep_db_args_t),
                                "Param struct for rfc_6347 entry", "%s%s%s\r\n", EMPTY, EMPTY, EMPTY);
    ...
    if (oamp_params->mep_type == DBAL_ENUM_FVAL_OAMP_MEP_TYPE_ETH_OAM)
    {
        ...
        if (UTILEX_GET_BIT(oamp_params->flags, OAMP_MEP_MC_UC_SEL))
        {
            entry_values->flags |= DNX_OAMP_OAM_CCM_MEP_MC_UC_SEL;
        }
    }
    ...
    if (is_down_mep_egress_injection)
    {
        ...
        entry_values->ivec_address_factor = oamp_params->exclusive.oam_only.ivec_address_factor;
        entry_values->fec_id_or_glob_out_lif.glob_out_lif = oamp_params->fec_id_or_glob_out_lif;
    }
    ...
    else
    {
        ...
        entry_values->da_lsb_profile = oamp_params->exclusive.oam_only.oam_lmm_da_profile;
    }
    ...
    uint8 slm_enabled)
{
    ...
    sal_memset(&itmh_priority, 0, sizeof(dnx_oam_itmh_priority_t));
    ...
    if (!DNX_OAM_DISSECT_IS_ENDPOINT_UPMEP(endpoint_info))
    {
        ...
        SHR_IF_ERR_EXIT(algo_oam_db.oamp_itmh_pph_priority_profile.allocate_single
        ...
        if (mep_db_entry->mep_type == DBAL_ENUM_FVAL_OAMP_MEP_TYPE_ETH_OAM)
        {
            ...
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_system_port_profile_sw_update
                            (unit, endpoint_info, mep_hw_profiles_write_data));
    ...
    else
    {
        ...
        if (IS_OAM_SERVER(endpoint_info))
        {
            ...
            if (endpoint_info->tx_gport != BCM_GPORT_INVALID)
            {
                ...
                {
                    SHR_IF_ERR_EXIT(dbal_fields_field_type_parent_field32_value_set
                                    (unit, DBAL_FIELD_TYPE_DEF_DESTINATION_JR1,
                                     DBAL_FIELD_PORT_ID, &sys_port, &mep_db_entry->server_destination));
                }
                else
                {
                    SHR_IF_ERR_EXIT(dbal_fields_field_type_parent_field32_value_set
                                    (unit, DBAL_FIELD_TYPE_DEF_DESTINATION,
                                     DBAL_FIELD_PORT_ID, &sys_port, &mep_db_entry->server_destination));
                }
            }
        }
        else if (!DNX_OAM_LIF_IS_OAM_PRIMARY_VLAN_PORT(endpoint_info->gport))
        {
    ...
    uint8 is_1dm_enabled)
{
    ...
    uint32 mep_pe_profile;
    uint32 up_mep_tod_recyle_port_core0 = 0;
    uint32 up_mep_tod_recyle_port_core1 = 0;
    int is_valid_recyle_port = 0;
    dnx_oam_oamp_mep_db_args_t *group_entry_info = NULL;

    SHR_FUNC_INIT_VARS(unit);

    SHR_ALLOC_SET_ZERO_ERR_EXIT(group_entry_info, sizeof(dnx_oam_oamp_mep_db_args_t),
    ...
    if (!DNX_OAM_IS_ENDPOINT_RFC6374(endpoint_info))
    {
        ...
        if (dnx_data_oam.feature.feature_get(unit, dnx_data_oam_feature_up_mep_tod_recycle_enable))
        {
            ...
            SHR_IF_ERR_EXIT(dnx_up_mep_dm_recycle_port_get(unit, 0, &up_mep_tod_recyle_port_core0));
            SHR_IF_ERR_EXIT(dnx_up_mep_dm_recycle_port_get(unit, 1, &up_mep_tod_recyle_port_core1));

            if ((up_mep_tod_recyle_port_core0 != 0) && (up_mep_tod_recyle_port_core1 != 0))
            {
                is_valid_recyle_port = 1;
            }
        }
...
static shr_error_e
dnx_oam_oamp_v1_ccm_endpoint_eth_oam_dmac_profiles_free(
    int unit,
    uint8 da_msb_profile,
    uint8 da_lsb_profile,
    uint8 hw_write)
{
    uint8 last_reference;
    ...
    SHR_IF_ERR_EXIT(algo_oam_db.oam_da_mac_lsb_profile_template.free_single
                    (unit, (int) da_lsb_profile, &last_reference));
    if (last_reference && hw_write)
    {
        SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mac_da_lsb_profile_set(unit, da_lsb_profile, mac_zero));
    }

    SHR_IF_ERR_EXIT(algo_oam_db.oam_da_mac_msb_profile_template.free_single
                    (unit, (int) da_msb_profile, &last_reference));

    if (last_reference && hw_write)
    {
        SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mac_da_msb_profile_set(unit, da_msb_profile, mac_zero));
    }
exit:
    SHR_FUNC_EXIT;
}
    ...
    dnx_oam_mep_profile_t * mep_profile)
{
    ...
    uint32 flags = DNX_OAMP_OAM_CCM_MEP_UPDATE;
    SHR_FUNC_INIT_VARS(unit);
    ...
    *is_dual_ended_lm = mep_profile->piggy_back_lm;
    ...
    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_ccm_endpoint_mep_db_profiles_free
                    (unit, mep_db_entry, mep_hw_profiles_delete_data, 0));

    if (mep_db_entry->mep_type == DBAL_ENUM_FVAL_OAMP_MEP_TYPE_ETH_OAM)
    {

        if (_SHR_IS_FLAG_SET(mep_db_entry->flags, DNX_OAMP_OAM_CCM_MEP_MC_UC_SEL))
        {
            flags |= DNX_OAMP_OAM_CCM_MEP_MC_UC_SEL;
        }
    }
    mep_db_entry->flags = flags;
    ...
    const bcm_oam_endpoint_info_t * endpoint_info)
{
    ...
    SHR_ALLOC_SET_ZERO_ERR_EXIT(dm_mep_db_entry, sizeof(dnx_oam_oamp_endpoint_dm_params_t),
    ...
    SHR_ALLOC_SET_ZERO_ERR_EXIT(loss_params, sizeof(dnx_oam_oamp_endpoint_lm_params_t),
    ...
    uint8 *is_bfd_alloc)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    SHR_IF_ERR_EXIT(dnx_algo_oamp_v1_mep_id_is_allocated(unit, endpoint_info->id, is_bfd_alloc));
    if (*is_bfd_alloc)
    {
        SHR_ALLOC_SET_ZERO_ERR_EXIT(bfd_endpoint_info, sizeof(bcm_bfd_endpoint_info_t),
        ...
        if (endpoint_info->type == bcmOAMEndpointTypeMplsLmDmLsp && bfd_endpoint_info->type != bcmBFDTunnelTypePweGal)
        {
            SHR_ERR_EXIT(_SHR_E_PARAM,
        ...
        if ((endpoint_info->type == bcmOAMEndpointTypeMplsLmDmSection
        ...
        if (endpoint_info->intf_id != bfd_endpoint_info->egress_if)
        {
            SHR_ERR_EXIT(_SHR_E_PARAM,
...
shr_error_e
dnx_oamp_v1_local_accelerated_endpoint_fill_id(
    int unit,
    bcm_oam_endpoint_info_t * endpoint_info,
    ...
    int is_48B_maid)
{
    ...
    SHR_IF_ERR_EXIT(dnx_algo_oamp_v1_mep_id_alloc(unit, flags, &memory_type, (uint32 *) (&endpoint_info->id)));
    ...
    uint8 *is_bfd_alloc)
{
    ...
    else
    {
        ...
        if (!(*is_bfd_alloc))
        {
            ...
            SHR_IF_ERR_EXIT(dnx_oamp_v1_local_accelerated_endpoint_fill_id
    ...
    const uint8 is_mpls_lm_dm_without_bfd_endpoint)
{
    ...
    SHR_ALLOC_SET_ZERO_ERR_EXIT(group_info, sizeof(bcm_oam_group_info_t),
    ...
    if (DNX_OAM_DISSECT_IS_ENDPOINT_ACCELERATED(endpoint_info))
    {
        ...
        if (DNX_OAM_IS_ENDPOINT_RFC6374(endpoint_info))
        {
            ...
            SHR_IF_ERR_EXIT(dnx_algo_oamp_v1_mep_id_dealloc
                            (unit, MEP_DB_ENTRY_TO_OAM_ID(mep_db_entry->flex_lm_dm_entry)));
        }
    ...
    const uint8 is_mpls_lm_dm_without_bfd_endpoint)
{
    ...
    if (!DNX_OAM_IS_ENDPOINT_RFC6374(endpoint_info) || is_mpls_lm_dm_without_bfd_endpoint)
    {
        ...
        SHR_IF_ERR_EXIT(dnx_algo_oamp_v1_mep_id_dealloc(unit, endpoint_info->id));
    }
    ...
    uint8 is_egress_inj)
{
    ...
    if (!is_jr2_mode)
    {
        udh_size_jr1 = BITS2BYTES(dnx_data_field.udh.field_class_id_size_0_get(unit));
        udh_size_jr1 += BITS2BYTES(dnx_data_field.udh.field_class_id_size_1_get(unit));
        udh_size_jr1 += BITS2BYTES(dnx_data_field.udh.field_class_id_size_2_get(unit));
        udh_size_jr1 += BITS2BYTES(dnx_data_field.udh.field_class_id_size_3_get(unit));
    ...
    uint8 is_update)
{
    ...
    SHR_ALLOC_ERR_EXIT(oamp_params, sizeof(dnx_oam_oamp_mep_db_args_t), "Param struct for creating single entries",
                       "%s%s%s\r\n", EMPTY, EMPTY, EMPTY);
    ...
    uint8 *data)
{
    ...
    SHR_ALLOC_SET_ZERO_ERR_EXIT(oamp_params, sizeof(dnx_oam_oamp_mep_db_args_t), "Parameter structure for single entry",
                                "%s%s%s\r\n", EMPTY, EMPTY, EMPTY);
    ...
    dnx_oamp_ccm_endpoint_extra_data_t * extra_data)
{
    ...
    SHR_ALLOC_SET_ZERO_ERR_EXIT(extra_header_data, DNX_OAM_OAMP_EXTRA_DATA_MAX_SIZE,
                                "data allocated for extra header", "%s%s%s\r\n", EMPTY, EMPTY, EMPTY);
    SHR_ALLOC_SET_ZERO_ERR_EXIT(data_for_crc_calculation, DNX_OAM_OAMP_EXTRA_DATA_MAX_SIZE,
                                "data allocated for extra header", "%s%s%s\r\n", EMPTY, EMPTY, EMPTY);
    ...
    else
    {
        ...
        else
        {
            ...
            for (i = 0; i < extra_data->length; i++)
            {
                ...
                SHR_IF_ERR_EXIT(dnx_algo_oamp_v1_mep_id_dealloc(unit, entry_idx));
            }
        }
    }
    ...
    dnx_oamp_ccm_endpoint_extra_data_t * extra_data)
{
    ...
    SHR_ALLOC_SET_ZERO_ERR_EXIT(extra_header_data, OAM_OAMP_EXTRA_DATA_MAX_SIZE,
                                "data allocated for extra header", "%s%s%s\r\n", EMPTY, EMPTY, EMPTY);
    ...
    uint8 is_bfd_exist)
{
    ...
    SHR_NULL_CHECK(entry_values, _SHR_E_PARAM, "entry_values");
    SHR_ALLOC_SET_ZERO_ERR_EXIT(oamp_bfd_pwe_params, sizeof(dnx_oam_oamp_mep_db_args_t),
                                "Param struct for creating single entries", "%s%s%s\r\n", EMPTY, EMPTY, EMPTY);

    SHR_ALLOC_SET_ZERO_ERR_EXIT(oamp_rfc_6374_params, sizeof(dnx_oam_oamp_mep_db_args_t),
                                "Param struct for creating single entries", "%s%s%s\r\n", EMPTY, EMPTY, EMPTY);
...
shr_error_e
dnx_oam_oamp_v1_init_cpu_port_configuration(
    int unit)
{
    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(dnx_oamp_v1_bfd_pwe_channel_value_set(unit, 0, BFD_PWE_DEFAULT_CHANNEL));
    SHR_IF_ERR_EXIT(dnx_oamp_v1_bfd_pwe_channel_value_set(unit, 1, BFD_MPLS_TP_CC_GACH_DEFAULT_CHANNEL));
...
static shr_error_e
dnx_oam_oamp_v1_init_general_configuration(
    int unit)
{
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_MIN_PKT_SIZE, INST_SINGLE, 0x2C);
    ...
    int unit)
{
    ...
    uint8 tcam_index = 1;
    uint8 *mask = NULL;
    int crc_mask_index_for_maid_48 = 0;
    dnx_oam_oamp_flex_crc_tcam_t *flex_tcam_entry = NULL;
    dnx_oam_oamp_flex_crc_pdu_mask_t *flex_crc_mask = NULL;

    SHR_FUNC_INIT_VARS(unit);

    SHR_ALLOC_SET_ZERO_ERR_EXIT(flex_tcam_entry, sizeof(dnx_oam_oamp_flex_crc_tcam_t),
                                "Param struct for flexible crc tcam", "%s%s%s\r\n", EMPTY, EMPTY, EMPTY);

    SHR_ALLOC_SET_ZERO_ERR_EXIT(flex_crc_mask, sizeof(dnx_oam_oamp_flex_crc_pdu_mask_t),
                                "Param struct for flexible crc mask", "%s%s%s\r\n", EMPTY, EMPTY, EMPTY);

    SHR_ALLOC_SET_ZERO_ERR_EXIT(mask, BITS2BYTES(DNX_OAM_OAMP_CRC_BYTE), "Size of CRC per Bytes field",
                                "%s%s%s\r\n", EMPTY, EMPTY, EMPTY);
    ...
    flex_tcam_entry->crc_mask_index = crc_mask_index_for_maid_48;
    ...
    SHR_IF_ERR_EXIT(dnx_oamp_pe_mep_pe_profile_sw_get
                    (unit, DBAL_ENUM_FVAL_MEP_PE_PROFILE_SW_SEAMLESS_BFD_IPV6, &mep_pe_profile));
    flex_tcam_entry->oamp_mep_pe_profile = mep_pe_profile;
    flex_tcam_entry->oamp_mep_pe_profile_mask = 0x0;
    ...
    SHR_IF_ERR_EXIT(dnx_oamp_pe_mep_pe_profile_sw_get
                    (unit, DBAL_ENUM_FVAL_MEP_PE_PROFILE_SW_ADDITIONAL_GAL_SPECIAL_LABEL_MAID48, &mep_pe_profile));
    flex_tcam_entry->oamp_mep_pe_profile = mep_pe_profile;
    flex_tcam_entry->oamp_mep_pe_profile_mask = 0x0;
    tcam_index++;
    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_flexible_crc_tcam_set(unit, tcam_index, flex_tcam_entry));
    ...
    SHR_IF_ERR_EXIT(dnx_oamp_pe_mep_pe_profile_sw_get
                    (unit, DBAL_ENUM_FVAL_MEP_PE_PROFILE_SW_DOWN_MEP_INJ_SELF_CONTAINED_MAID_48, &mep_pe_profile));
    flex_tcam_entry->oamp_mep_pe_profile = mep_pe_profile;
    flex_tcam_entry->oamp_mep_pe_profile_mask = 0x0;
    tcam_index++;
    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_flexible_crc_tcam_set(unit, tcam_index, flex_tcam_entry));
    ...
    SHR_IF_ERR_EXIT(dnx_oamp_pe_mep_pe_profile_sw_get
                    (unit, DBAL_ENUM_FVAL_MEP_PE_PROFILE_SW_ADDITIONAL_GAL_SPECIAL_LABEL_1DM_MAID48, &mep_pe_profile));
    flex_tcam_entry->oamp_mep_pe_profile = mep_pe_profile;
    flex_tcam_entry->oamp_mep_pe_profile_mask = 0x0;
    tcam_index++;
    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_flexible_crc_tcam_set(unit, tcam_index, flex_tcam_entry));
    ...
    uint16 *crc_2)
{
    ...
    SHR_ALLOC_SET_ZERO_ERR_EXIT(tmp_data, DNX_OAM_MEP_DB_NOF_BITS_IN_HEADER_ENTRY / UTILEX_NOF_BITS_IN_BYTE,
    ...
    uint8 *is_leader_type_match)
{
    ...
    *sub_index = (oam_id % nof_mep_db_short_entries);
    if (*sub_index != 0)
    {
        ...
        SHR_ALLOC_SET_ZERO_ERR_EXIT(leader_info, sizeof(dnx_oam_oamp_mep_db_args_t),
                                    "Short entry read for MEP-type comparison", "%s%s%s\r\n", EMPTY, EMPTY, EMPTY);

        leader_endpoint_id = oam_id - *sub_index;
        SHR_IF_ERR_EXIT(dnx_algo_oamp_v1_mep_id_is_allocated(unit, leader_endpoint_id, is_leader_alloc));
    ...
    uint8 is_update)
{
    ...
    if (!is_update)
    {
        ...
        SHR_IF_ERR_EXIT(dnx_algo_oamp_v1_mep_id_alloc(unit, DNX_ALGO_RES_ALLOCATE_WITH_ID, &memory_type, &entry_id));
    }
    ...
    for (i = 1; i != oamp_params->exclusive.extra_data.extra_data_len; ++i)
    {
        ...
        if (!is_update)
        {
            ...
            SHR_IF_ERR_EXIT(dnx_algo_oamp_v1_mep_id_alloc
                            (unit, DNX_ALGO_RES_ALLOCATE_WITH_ID, &memory_type, &entry_id));
        }
        bits_left =
    ...
    const uint8 *group_name)
{
    ...
    SHR_ALLOC_SET_ZERO_ERR_EXIT(possible_leader_info, sizeof(dnx_oam_oamp_mep_db_args_t),
         ...
         ((possible_leader_found == TRUE) && (appropriate_entry_not_found == TRUE)); leader_index++)
    {
        ...
        SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_get_next_icc_entry(unit, &possible_leader_id, &possible_leader_found));
        ...
        if (possible_leader_found == TRUE)
        {
            ...
            if (possible_leader_info->mep_type == req_mep_type)
            {
                ...
                for (index = 1; index < nof_sub_entries; index++)
                {
                    ...
                    SHR_IF_ERR_EXIT(dnx_algo_oamp_v1_mep_id_is_allocated
    ...
    if (appropriate_entry_not_found == TRUE)
    {
        ...
        SHR_IF_ERR_EXIT(dnx_algo_oamp_v1_mep_id_get_free_icc_id
                        (unit, &possible_appropriate_entry_id, &appropriate_entry_not_found));
        if (appropriate_entry_not_found == TRUE)
        {
    ...
    SHR_IF_ERR_EXIT(dnx_oamp_v1_local_accelerated_endpoint_fill_id(unit, endpoint_info, group_name, 0));
    endpoint_info->flags &= ~BCM_OAM_ENDPOINT_WITH_ID;
    ...
    switch (opcode)
    {
        case OAMP_MEP_TX_OPCODE_CCM_BFD:
            ...
            SHR_IF_ERR_EXIT(algo_bfd_db.
                            bfd_oamp_v1_tx_rate.profile_data_get(unit, oamp_params->exclusive.bfd_only.bfd_tx_rate,
                                                                 &dummy, &tx_rate_data));
    ...
    dnx_oam_mep_profile_t * mep_profile_data)
{
    ...
    my_scan_rate = BCM_OAMP_SW_ENTRY_INFO_PERIOD_TO_MEP_DB_SCAN_RATE(unit, tx_rate);
...
static shr_error_e
dnx_oam_oamp_eth_oam_mep_mac_da_lsb_profile_alloc(
    int unit,
    ...
    uint8 exchange,
    dnx_oam_oamp_ccm_endpoint_t * mep_db_entry,
    oam_oamp_profile_hw_data_t * hw_write_data)
{
    int oamp_da_lsb_prof = 0;
    uint8 write_hw = 0;
    uint8 delete_old_prof = 0;
    uint8 last_reference;
    ...
    if (exchange)
    {
        ...
        {
            if (BCM_MAC_IS_ZERO(old_oamp_mac_da_lsb) && !BCM_MAC_IS_ZERO(oamp_mac_da_lsb))
            {
                SHR_IF_ERR_EXIT(algo_oam_db.oam_da_mac_lsb_profile_template.allocate_single(unit, 0,
                                                                                            oamp_mac_da_lsb, NULL,
                                                                                            &(oamp_da_lsb_prof),
                                                                                            &write_hw));
            }
            else if (!BCM_MAC_IS_ZERO(old_oamp_mac_da_lsb) && BCM_MAC_IS_ZERO(oamp_mac_da_lsb))
            {
                SHR_IF_ERR_EXIT(algo_oam_db.oam_da_mac_lsb_profile_template.free_single
                                (unit, (int) old_oamp_da_lsb_prof, &last_reference));
            }
            else
            {

                SHR_IF_ERR_EXIT(algo_oam_db.oam_da_mac_lsb_profile_template.exchange(unit, 0, 1, oamp_mac_da_lsb,
                                                                                     old_oamp_da_lsb_prof, NULL,
    ...
    {
        SHR_IF_ERR_EXIT(algo_oam_db.oam_da_mac_lsb_profile_template.allocate_single(unit, 0, oamp_mac_da_lsb,
                                                                                    NULL,
                                                                                    &(oamp_da_lsb_prof), &write_hw));
    }

    mep_db_entry->da_lsb_profile = oamp_da_lsb_prof;
    if (write_hw)
    {
        hw_write_data->da_mac[3] = oamp_mac_da_lsb[3];
        hw_write_data->da_mac[4] = oamp_mac_da_lsb[4];
        hw_write_data->da_mac[5] = oamp_mac_da_lsb[5];
        hw_write_data->da_mac_lsb_profile = oamp_da_lsb_prof;
        hw_write_data->flags |= DNX_OAM_OAMP_PROFILE_DA_MAC_LSB_FLAG;
    }
...
static shr_error_e
dnx_oam_oamp_eth_oam_mep_mac_da_msb_profile_alloc(
    int unit,
    ...
    oam_oamp_profile_hw_data_t * hw_write_data)
{
    ...
    if (exchange)
    {
        ...
        {
            if (BCM_MAC_IS_ZERO(old_oamp_mac_da_msb) && !BCM_MAC_IS_ZERO(oamp_mac_da_msb))
            {
                SHR_IF_ERR_EXIT(algo_oam_db.oam_da_mac_msb_profile_template.allocate_single(unit, 0,
                                                                                            oamp_mac_da_msb, NULL,
                                                                                            &(oamp_da_msb_prof),
                                                                                            &write_hw));
            }
            else if (!BCM_MAC_IS_ZERO(old_oamp_mac_da_msb) && BCM_MAC_IS_ZERO(oamp_mac_da_msb))
            {
                SHR_IF_ERR_EXIT(algo_oam_db.oam_da_mac_msb_profile_template.free_single
                                (unit, (int) old_oamp_da_msb_prof, &last_reference));
            }
            else
            {

                SHR_IF_ERR_EXIT(algo_oam_db.oam_da_mac_msb_profile_template.exchange(unit, 0, 1, oamp_mac_da_msb,
                                                                                     old_oamp_da_msb_prof, NULL,
    ...
    {
        SHR_IF_ERR_EXIT(algo_oam_db.oam_da_mac_msb_profile_template.allocate_single(unit, 0, oamp_mac_da_msb,
                                                                                    NULL,
                                                                                    &(oamp_da_msb_prof), &write_hw));
    }

    mep_profile->oamp_mac_da_oui_prof = oamp_da_msb_prof;
    if (write_hw)
    {
        hw_write_data->da_mac[0] = oamp_mac_da_msb[0];
        hw_write_data->da_mac[1] = oamp_mac_da_msb[1];
        hw_write_data->da_mac[2] = oamp_mac_da_msb[2];
        hw_write_data->flags |= DNX_OAM_OAMP_PROFILE_DA_MAC_MSB_FLAG;
    }
...
static shr_error_e
dnx_oam_oamp_ccm_endpoint_eth_oam_dmac_select(
    int unit,
    const bcm_oam_endpoint_info_t * endpoint_info,
    dnx_oam_oamp_ccm_endpoint_t * mep_db_entry,
    dnx_oam_mep_profile_t * mep_profile,
    oam_oamp_profile_hw_data_t * mep_hw_profiles_write_data)
{
    bcm_mac_t da_mac_lsb;
    bcm_mac_t da_mac_msb;
    bcm_mac_t da_mac_new;
    uint8 old_da_lsb_profile = 0;
    uint8 old_da_msb_profile = 0;
    uint8 exchange = 0;

    SHR_FUNC_INIT_VARS(unit);

    sal_memset(da_mac_lsb, 0, sizeof(DNX_OAM_MAC_SIZE));
    sal_memset(da_mac_msb, 0, sizeof(DNX_OAM_MAC_SIZE));
    sal_memset(da_mac_new, 0, sizeof(DNX_OAM_MAC_SIZE));
    ...
    if (_SHR_IS_FLAG_SET(endpoint_info->flags, BCM_OAM_ENDPOINT_REPLACE))
    {
        ...
        if (!(_SHR_IS_FLAG_SET(mep_db_entry->flags, DNX_OAMP_OAM_CCM_MEP_MC_UC_SEL)))
        {
            old_da_lsb_profile = mep_db_entry->da_lsb_profile;
            old_da_msb_profile = mep_profile->oamp_mac_da_oui_prof;
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mac_da_lsb_profile_get(unit, old_da_lsb_profile, da_mac_lsb));
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mac_da_msb_profile_get(unit, old_da_msb_profile, da_mac_msb));
            exchange = 1;
        }
    }
    ...
    {
        mep_db_entry->flags |= DNX_OAMP_OAM_CCM_MEP_ETH_UC_DA;
    }

    GET_MSB_FROM_MAC_ADDR(endpoint_info->dst_mac_address, da_mac_new);
    SHR_IF_ERR_EXIT(dnx_oam_oamp_eth_oam_mep_mac_da_msb_profile_alloc(unit, da_mac_new, da_mac_msb, old_da_msb_profile,
                                                                      exchange, mep_profile,
                                                                      mep_hw_profiles_write_data));

    GET_LSB_FROM_MAC_ADDR(endpoint_info->dst_mac_address, da_mac_new);
    SHR_IF_ERR_EXIT(dnx_oam_oamp_eth_oam_mep_mac_da_lsb_profile_alloc(unit, da_mac_new, da_mac_lsb, old_da_lsb_profile,
                                                                      exchange, mep_db_entry,
                                                                      mep_hw_profiles_write_data));
    ...
    oam_oamp_profile_hw_data_t * mep_hw_profiles_delete_data)
{
    ...
    if (DNX_OAM_IS_ENDPOINT_RFC6374(endpoint_info) && !is_mpls_lm_dm_without_bfd_endpoint)
    {
        ...
        SHR_ALLOC_SET_ZERO_ERR_EXIT(bfd_entry_values, sizeof(dnx_bfd_oamp_v1_endpoint_t),
    ...
    else if (endpoint_info->type == bcmOAMEndpointTypeEthernet)
    {
        ...
        SHR_IF_ERR_EXIT(dnx_oam_oamp_ccm_endpoint_eth_oam_dmac_select
                        (unit, endpoint_info, mep_db_entry, &mep_profile, mep_hw_profiles_write_data));
    }
    ...
    if (DNX_OAM_IS_ENDPOINT_RFC6374(endpoint_info))
    {
        ...
        {
            SHR_NULL_CHECK(bfd_entry_values, _SHR_E_INTERNAL, "bfd_entry_values");
    ...
    uint32 gal)
{
    ...
    if (cur_additional_gal != MPLS_LABEL_GAL)
    {
        ...
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_MPLS_SPECIAL_LABEL_NIBBLE, cur_additional_gal);
    ...
    if (gal != MPLS_LABEL_GAL)
    {
        ...
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_MPLS_SPECIAL_LABEL_NIBBLE, gal);
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_BOS, 0);
    ...
    else
    {
        ...
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_MPLS_SPECIAL_LABEL_NIBBLE, MPLS_LABEL_GAL);
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_BOS, 0);
        dbal_value_field32_request(unit, entry_handle_id, DBAL_FIELD_MPLS_SPECIAL_LABEL_PROFILE, INST_SINGLE,
                                   &normal_label_profile);
        ...
        SHR_IF_ERR_EXIT(dnx_oam_sw_db_additional_gal_special_label_set(unit, MPLS_LABEL_GAL, normal_label_profile));
    }
    ...
    uint32 gal)
{
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_CFG_OAM_ALERT_AS_GAL, INST_SINGLE, (gal == 14));
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
...
shr_error_e
dnx_oam_oamp_v1_additional_gal_special_label_get(
    int unit,
    int *gal)
{
    ...
    SHR_IF_ERR_EXIT(dnx_oam_sw_db_additional_gal_special_label_get(unit, (uint32 *) gal, &label_profile));
...
shr_error_e
dnx_oam_oamp_v1_down_egress_inject_delete_one_vlan_ive_command_set(
    int unit,
    uint32 ive_cmd)
{
    uint32 entry_handle_id;
    ...
    index = DNX_OAMP_PE_DELETE_ONE_VLAN_TAG_IVEC_ADDRESS;

    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_GEN_MEM_INDEX, index);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_PE_GEN_DATA, INST_SINGLE, 0x3f & ive_cmd);
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
...
shr_error_e
dnx_oam_oamp_v1_down_egress_inject_delete_one_vlan_ive_command_get(
    int unit,
    uint32 *ive_cmd)
{
    uint32 entry_handle_id;
    ...
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_GEN_MEM_INDEX, index);
    dbal_value_field32_request(unit, entry_handle_id, DBAL_FIELD_PE_GEN_DATA, INST_SINGLE, ive_cmd);
    SHR_IF_ERR_EXIT(dbal_entry_get(unit, entry_handle_id, DBAL_COMMIT));
...
shr_error_e
dnx_oam_oamp_v1_down_egress_inject_delete_two_vlan_ive_command_set(
    int unit,
    uint32 ive_cmd)
{
    uint32 entry_handle_id;
    ...
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_OAMP_PE_GEN_MEM_DATA, &entry_handle_id));
    index = DNX_OAMP_PE_DELETE_TWO_VLAN_TAGS_IVEC_ADDRESS;
...
shr_error_e
dnx_oam_oamp_v1_down_egress_inject_delete_two_vlan_ive_command_get(
    int unit,
    uint32 *ive_cmd)
{
    uint32 entry_handle_id;
...
shr_error_e
dnx_oam_oamp_v1_egress_inject_tx_pph_network_qos_set(
    int unit,
    uint32 network_qos)
{
    uint32 entry_handle_id;
    ...
    prog_enum = DBAL_ENUM_FVAL_OAMP_PE_PROGRAM_ENUM_DOWN_MEP_INJ_SELF_CONTAINED;
    SHR_IF_ERR_EXIT(dnx_oamp_pe_program_sw_enum2hw_get(unit, prog_enum, &prog_hw_index));
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_OAMP_PE_PROGRAMS_PROPERTIES, &entry_handle_id));
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_OAMP_PE_PROGRAM_INDEX, prog_hw_index);
    dbal_value_field32_request(unit, entry_handle_id, DBAL_FIELD_CONST_VALUE, INST_SINGLE, &const_value);
    SHR_IF_ERR_EXIT(dbal_entry_get(unit, entry_handle_id, DBAL_COMMIT));

    const_value &= ~(0xff << 8);
    const_value |= ((network_qos & 0xff) << 8);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_CONST_VALUE, INST_SINGLE, const_value);
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));

    prog_enum = DBAL_ENUM_FVAL_OAMP_PE_PROGRAM_ENUM_DOWN_MEP_INJ_SELF_CONTAINED_MAID_48;
    SHR_IF_ERR_EXIT(dnx_oamp_pe_program_sw_enum2hw_get(unit, prog_enum, &prog_hw_index));
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_OAMP_PE_PROGRAMS_PROPERTIES, &entry_handle_id));
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_OAMP_PE_PROGRAM_INDEX, prog_hw_index);
    dbal_value_field32_request(unit, entry_handle_id, DBAL_FIELD_CONST_VALUE, INST_SINGLE, &const_value);
    ...
    uint8 *lm_stat_exists)
{
    ...
    SHR_NULL_CHECK(entry_values, _SHR_E_PARAM, "entry_values");
    SHR_ALLOC_SET_ZERO_ERR_EXIT(oamp_params, sizeof(dnx_oam_oamp_mep_db_args_t),
                                "Param struct for reading single entries", "%s%s%s\r\n", EMPTY, EMPTY, EMPTY);
    ...
    uint8 is_mpls_lm_dm_entry_exists)
{
    ...
    SHR_ALLOC_ERR_EXIT(oamp_params, sizeof(dnx_oam_oamp_mep_db_args_t), "Param struct for reading single entries",
                       "%s%s%s\r\n", EMPTY, EMPTY, EMPTY);
    ...
    const bcm_oam_group_info_t * group_info)
{
    ...
    SHR_ALLOC_SET_ZERO_ERR_EXIT(dm_mep_db_entry, sizeof(dnx_oam_oamp_endpoint_dm_params_t),
                                "Structure for DM MEP DB entry", "%s%s%s\r\n", EMPTY, EMPTY, EMPTY);
    SHR_ALLOC_SET_ZERO_ERR_EXIT(lm_mep_db_entry, sizeof(dnx_oam_oamp_endpoint_lm_params_t),
                                "Structure for LM MEP DB entry", "%s%s%s\r\n", EMPTY, EMPTY, EMPTY);
...
static shr_error_e
dnx_oam_oamp_v1_generic_memory_allocation(
    int unit)
{
    /* *INDENT-OFF* */
    dnx_oam_oamp_generic_memory_entity_t entity_config[DNX_OAM_OAMP_GENERIC_MEMORY_ENTITY_NOF] = {
        
        {DNX_OAM_OAMP_GENERIC_MEMORY_ENTITY_DM_JUMBO_TLV,   DNX_OAM_OAMP_GENERIC_MEMORY_ENTITY_DM_JUMBO_TLV_NOF_ENTRIES,   DNX_OAM_OAMP_GENERIC_MEMORY_ENTITY_DM_JUMBO_TLV_ENTRY_INDEX},
        {DNX_OAM_OAMP_GENERIC_MEMORY_ENTITY_DOWN_MEP_INJ,   DNX_OAM_OAMP_GENERIC_MEMORY_ENTITY_DOWN_MEP_INJ_NOF_ENTRIES,   DNX_OAM_OAMP_GENERIC_MEMORY_ENTITY_DOWN_MEP_INJ_ENTRY_INDEX},
    };
    ...
    for (ii = 0; ii < DNX_OAM_OAMP_GENERIC_MEMORY_ENTITY_NOF; ii++)
    {
        SHR_IF_ERR_EXIT(dnx_algo_oamp_v1_generic_memory_alloc
                        (unit, DNX_ALGO_RES_ALLOCATE_WITH_ID,
                         entity_config[ii].nof_entries, &entity_config[ii].entry_index));
    }
...
static shr_error_e
dnx_oam_oamp_v1_ccm_endpoint_eth_oam_dmac_get(
    int unit,
    uint8 da_msb_profile,
    uint8 da_lsb_profile,
    bcm_oam_endpoint_info_t * endpoint_info)
{
    bcm_mac_t da_mac_addr_lsb = { 0 };
    bcm_mac_t da_mac_addr_msb = { 0 };

    SHR_FUNC_INIT_VARS(unit);
    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mac_da_msb_profile_get(unit, da_msb_profile, da_mac_addr_msb));
    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mac_da_lsb_profile_get(unit, da_lsb_profile, da_mac_addr_lsb));
    GET_MAC_FROM_MSB_LSB(da_mac_addr_msb, da_mac_addr_lsb, endpoint_info->dst_mac_address);
exit:
    SHR_FUNC_EXIT;
}

shr_error_e
dnx_oam_oamp_v1_ccm_endpoint_eth_oam_get(
    int unit,
    const dnx_oam_oamp_ccm_endpoint_t * mep_db_entry,
    bcm_oam_endpoint_info_t * endpoint_info)
{
    bcm_mac_t sa_mac_addr_msb = { 0 };
    uint8 nof_vlan_tags = 0, sa_gen_msb_profile = 0;
    ...
    nof_vlan_tags = mep_db_entry->nof_vlan_tags;
    sa_gen_msb_profile = mep_db_entry->sa_gen_msb_profile;
    ...
    SHR_IF_ERR_EXIT(dnx_oam_oamp_sa_mac_msb_profile_get(unit, sa_gen_msb_profile, sa_mac_addr_msb));
...
shr_error_e
dnx_oam_oamp_v1_local_acc_endpoint_get(
    int unit,
    bcm_oam_endpoint_info_t * endpoint_info)
{
    dnx_oam_itmh_priority_t itmh_priority;
    int counter;
    uint32 dest_val = 0, flags, dest_sys_port_agr = 0;
    int is_max_ccm_cnt = 0;
    uint8 tc_dp_profile = 0, is_eth = 0, is_upmep = 0, is_fec = 0;
    ...
    system_headers_mode = dnx_data_headers.system_headers.system_headers_mode_get(unit);
    SHR_ALLOC_ERR_EXIT(mep_db_entry, sizeof(dnx_oam_oamp_ccm_endpoint_t),
    ...
    flags = mep_db_entry->flags;
    is_upmep = _SHR_IS_FLAG_SET(flags, DNX_OAMP_OAM_CCM_MEP_IS_UPMEP);
    is_eth = (mep_db_entry->mep_type == DBAL_ENUM_FVAL_OAMP_MEP_TYPE_ETH_OAM);
    is_fec = _SHR_IS_FLAG_SET(flags, DNX_OAMP_OAM_CCM_MEP_DESTINATION_IS_FEC);
    tc_dp_profile = mep_db_entry->itmh_tc_dp_profile;
    dest_val =
        (is_fec ? mep_db_entry->fec_id_or_glob_out_lif.fec_id : mep_db_entry->fec_id_or_glob_out_lif.glob_out_lif);
    dest_sys_port_agr = mep_db_entry->dest_sys_port_agr;
    endpoint_info->endpoint_memory_type =
        ((_SHR_IS_FLAG_SET(mep_db_entry->flags, DNX_OAMP_OAM_CCM_MEP_LM_DM_OFFLOADED)) ?
         bcmOamEndpointMemoryTypeLmDmOffloadedEntry
         : (((_SHR_IS_FLAG_SET(mep_db_entry->flags, DNX_OAMP_OAM_CCM_MEP_Q_ENTRY)) ?
             bcmOamEndpointMemoryTypeShortEntry : bcmOamEndpointMemoryTypeSelfContained)));
    if (DNX_OAM_IS_ENDPOINT_RFC6374(endpoint_info))
    {
    ...
    if (!is_upmep)
    {
        SHR_IF_ERR_EXIT(algo_oam_db.oamp_itmh_pph_priority_profile.profile_data_get
                        (unit, tc_dp_profile, &counter, &itmh_priority));
        ...
        if (!is_eth)
        {
            if (is_fec)
            {
                BCM_L3_ITF_SET(endpoint_info->intf_id, BCM_L3_ITF_TYPE_FEC, dest_val);
                endpoint_info->tx_gport = BCM_GPORT_INVALID;
            }
            else
            {
                BCM_L3_ITF_SET(endpoint_info->intf_id, BCM_L3_ITF_TYPE_LIF, dest_val);
                BCM_GPORT_SYSTEM_PORT_ID_SET(endpoint_info->tx_gport, dest_sys_port_agr);
            }
        }
        else
        {
    ...
    else
    {
        ...
        if (mep_db_entry->server_destination != 0)
        {
            if (system_headers_mode == DBAL_ENUM_FVAL_SYSTEM_HEADERS_MODE_JERICHO_MODE)
            {
                SHR_IF_ERR_EXIT(dbal_fields_field_type_uint32_sub_field_info_get
                                (unit, DBAL_FIELD_TYPE_DEF_DESTINATION_JR1, mep_db_entry->server_destination,
    ...
    if (is_eth)
    {
        SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_ccm_endpoint_eth_oam_get(unit, mep_db_entry, endpoint_info));

        
        if (!_SHR_IS_FLAG_SET(mep_db_entry->flags, DNX_OAMP_OAM_CCM_MEP_MC_UC_SEL))
        {
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_ccm_endpoint_eth_oam_dmac_get(unit,
                                                                          mep_profile.oamp_mac_da_oui_prof,
                                                                          mep_db_entry->da_lsb_profile, endpoint_info));
        }
    }
    else
    {
...
shr_error_e
dnx_oam_oamp_v1_local_acc_endpoint_destroy(
    int unit,
    const bcm_oam_endpoint_info_t * endpoint_info,
    const oam_lif_resolution_t * lif_resolution,
    oam_oamp_profile_hw_data_t * mep_hw_profiles_write_data,
    uint8 extra_data_length)
{
    ...
    if ((DNX_OAM_DISSECT_IS_ENDPOINT_ACCELERATED(endpoint_info))
        && (endpoint_info->endpoint_memory_type != bcmOamEndpointMemoryTypeShortEntry))
    {
        SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_endpoint_delete_associated_loss_entries(unit, endpoint_info));
    }
    ...
    if (DNX_OAM_DISSECT_IS_ENDPOINT_ACCELERATED(endpoint_info))
    {
        ...
        if ((endpoint_info->type == bcmOAMEndpointTypeEthernet) && !BCM_MAC_IS_ZERO(endpoint_info->dst_mac_address))
        {
            sal_memset(&mep_profile, 0, sizeof(dnx_oam_mep_profile_t));
            SHR_IF_ERR_EXIT(algo_oam_db.oam_mep_profile.profile_data_get
                            (unit, mep_db_entry->mep_profile, &counter, &mep_profile));
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_ccm_endpoint_eth_oam_dmac_profiles_free
                            (unit, mep_profile.oamp_mac_da_oui_prof, mep_db_entry->da_lsb_profile, 1));
        }
        
        SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_ccm_endpoint_mep_db_profiles_free
                        (unit, mep_db_entry, mep_hw_profiles_write_data, keep_mep_profile));
    }

    
    if (DNX_OAM_DISSECT_IS_EXTRA_DATA_PER_ENDPOINT(endpoint_info) && !DNX_OAM_IS_ENDPOINT_RFC6374(endpoint_info))
    {
        mep_db_extra_data_length = extra_data_length;
    }

    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_endpoint_remove_from_mep_db
                    (unit, endpoint_info, mep_db_entry, mep_db_extra_data_length, is_mpls_lm_dm_without_bfd_endpoint));

    SHR_IF_ERR_EXIT(dnx_oam_accelerated_endpoint_destroy_delete_profiles
                    (unit, endpoint_info, mep_hw_profiles_write_data));
    ...
    if (!IS_OAM_CLIENT(endpoint_info))
    {
        ...
        if (!DNX_OAM_GROUP_MAID_IS_EXTRA_DATA(group_info->flags))
        {
            SHR_IF_ERR_EXIT(dnx_oam_handle_acceleraed_endpoint_group_config
                            (unit, group_info->name, endpoint_info->id, 0));
        }
    }

    SHR_IF_ERR_EXIT(dnx_oam_accelerated_endpoint_destroy_delete_acc_mep_db_entry
                    (unit, endpoint_info, lif_resolution, is_mpls_lm_dm_without_bfd_endpoint));

    if (!IS_OAM_CLIENT(endpoint_info))
    {
        SHR_IF_ERR_EXIT(dnx_oam_accelerated_endpoint_destroy_mep_id_dealloc_v1
                        (unit, endpoint_info, is_mpls_lm_dm_without_bfd_endpoint));
    }
...
static shr_error_e
dnx_oam_oamp_v1_init_rx_trap_codes(
    int unit)
{
    dnx_oam_oamp_trap_tcam_entry_t tcam_data;
    int index = 0;
    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_init_rmep_cfg(unit));

    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_init_y1731_cfg(unit));

    
    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_init_rx_trap_codes(unit));

    
    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_init_mep_db_cfg(unit));

    
    lm_dm_per_priority_enable = dnx_data_oam.property.lm_dm_per_priority_enable_get(unit);
    if (lm_dm_per_priority_enable)
    {
        SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_init_trap_map_cfg(unit));
    }

    
    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_init_response_table(unit));

    
    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_init_general_configuration(unit));
...
void
dnx_oam_oamp_v1_period_to_lifetime(
    int unit,
    uint32 period_us,
    uint32 *lifetime,
...
void
dnx_oam_oamp_v1_lifetime_to_period(
    int unit,
    uint32 lifetime,
    uint32 lifetime_units,
    uint32 *period_us)
...
shr_error_e
dnx_port_oamp_v1_ptch_header_init(
    int unit,
    uint32 pp_port)
{
    uint32 entry_handle_id;
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_PTCH_PP_SSP, INST_SINGLE, pp_port);
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
