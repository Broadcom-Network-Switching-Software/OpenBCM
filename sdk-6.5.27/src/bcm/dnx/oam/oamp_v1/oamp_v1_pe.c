    ...
    int *first_instruction)
{
    ...
    if (*first_instruction == DNX_OAMP_PE_NOT_SET)
    {
        *first_instruction = *next_instruction_index;
        ...
        INSTR_LABEL(CE1_COPY(FDBK_FIFO, DEFAULT, INST_CONST, VLD_B, FEM), CE2_NOP, ALU_NOP, CMN(READ, READ, 12, ALWAYS_NEVER, LOP_CST), DNX_OAMP_PE_INST_LABEL_MAID_48_0B);
    ...
    oamp_pe_func_config_t * func_config)
{
    ...
    if (saved_prog_index == DNX_OAMP_PE_NOT_SET)
    {
        ...
        INSTR(CE1_COPY(IN_FIFO, BFD_FAI_12, NONE, VLD_B, FEM), CE2_NOP, ALU_NOP, CMN(READ, NONE, 0,  ALWAYS_NEVER, NXT_JMP));
        ...
        INSTR(CE1_NOP, CE2_COPY(IN_FIFO, RSHIFT_5_BITS_For_BITS_24_To_31, INST_CONST, 2B), ALU_SET(FEM, TMP_REG1), CMN(NONE, NONE, 0x20, NEVER_NEVER, NXT_JMP));

        
        INSTR(CE1_NOP, CE2_COPY(IN_FIFO, DEFAULT, INST_CONST, 4B), ALU_NOP, CMN(READ, WRITE, 0, NEVER_NEVER, NXT_JMP));

        
        INSTR(CE1_NOP, CE2_COPY(IN_FIFO, DEFAULT, INST_CONST, 2B), ALU_SET(FEM, TMP_REG2), CMN(NONE, NONE, 0x22, NEVER_NEVER, NXT_JMP));
        INSTR(CE1_NOP, CE2_NOP, ALU_SET(INST_VAR_MSB, TMP_REG3), CMN(NONE, NONE, 0xF8, NEVER_NEVER, NXT_JMP));

        
        INSTR(CE1_NOP, CE2_NOP, ALU_NOP, CMN_NOP);

        
        INSTR(CE1_NOP, CE2_COPY(TMP_REG2, LSHIFT_3_BITS_For_BITS_16_To_23, INST_CONST, 2B), ALU_SET(FEM, TMP_REG2), CMN(NONE, NONE, 0x20, NEVER_NEVER, NXT_JMP));

        
        INSTR(CE1_NOP, CE2_COPY(FDBK_FIFO, DEFAULT, INST_CONST, 2B), ALU_SET(FEM, TMP_REG4), CMN(NONE, NONE, 0x12, NEVER_NEVER, NXT_JMP));

        
        INSTR(CE1_COPY(FDBK_FIFO, DEFAULT, INST_CONST, INST_CONST, FEM), CE2_NOP, ALU_NOP, CMN(NONE, NONE, 0x1, ALWAYS_NEVER, NXT_JMP));

        
        INSTR(CE1_NOP, CE2_NOP, ALU_NOP, CMN_NOP);

        
        INSTR(CE1_NOP, CE2_NOP, ALU_AND(TMP_REG3, TMP_REG4, ALU_OUT, ALWAYS, ALWAYS, TMP_REG3), CMN(NONE, NONE, 0x0, NEVER_NEVER, LOP_NXT));
        ...
        INSTR(CE1_NOP, CE2_NOP, ALU_OR(TMP_REG3, TMP_REG1, ALU_OUT, ALWAYS, ALWAYS, TMP_REG1), CMN(NONE, NONE, 0xf8, NEVER_NEVER, LOP_NXT));

        INSTR(CE1_NOP, CE2_NOP, ALU_SET(INST_VAR, TMP_REG3), CMN(NONE, NONE, 0x07, NEVER_NEVER, NXT_JMP));

        
        INSTR(CE1_COPY(TMP_REG1, DEFAULT, NONE, INST_CONST, FEM), CE2_NOP, ALU_NOP, CMN(NONE, NONE, 0x1, ALWAYS_NEVER, NXT_JMP));

        
        INSTR(CE1_NOP, CE2_COPY(TMP_REG1, LSHIFT_8_BITS_For_BITS_16_To_23, INST_CONST, 2B), ALU_SET(FEM, TMP_REG1), CMN(NONE, NONE, 0x20, NEVER_NEVER, NXT_JMP));
        INSTR(CE1_NOP, CE2_NOP, ALU_AND(TMP_REG3, TMP_REG4, ALU_OUT, ALWAYS, ALWAYS, TMP_REG3), CMN(NONE, NONE, 0x0, NEVER_NEVER, LOP_NXT));

        INSTR(CE1_NOP, CE2_NOP, ALU_NOP, CMN_NOP);

        INSTR(CE1_NOP, CE2_NOP, ALU_NOP, CMN_NOP);
        INSTR(CE1_NOP, CE2_NOP, ALU_OR(TMP_REG3, TMP_REG2, ALU_OUT, ALWAYS, ALWAYS, TMP_REG2), CMN(NONE, NONE, 0xf8, NEVER_NEVER, LOP_NXT));

        INSTR(CE1_NOP, CE2_NOP, ALU_NOP, CMN_NOP);

        INSTR(CE1_NOP, CE2_NOP, ALU_NOP, CMN_NOP);

        INSTR(CE1_NOP, CE2_NOP, ALU_OR(TMP_REG1, TMP_REG2, ALU_OUT, ALWAYS, ALWAYS, TMP_REG2), CMN(NONE, NONE, 0xf8, NEVER_NEVER, LOP_NXT));
        ...
        INSTR(CE1_COPY(TMP_REG2, DEFAULT, NONE, VLD_B, FEM), CE2_NOP, ALU_NOP, CMN(NONE, NONE, 0x0, ALWAYS_NEVER, NXT_JMP));

        
        INSTR(CE1_COPY(FDBK_FIFO, DEFAULT, INST_CONST, INST_CONST, FEM), CE2_NOP, ALU_NOP, CMN(NONE, READ, 0x4, ALWAYS_NEVER, NXT_JMP));

        
        INSTR(CE1_COPY(FDBK_FIFO, DEFAULT, INST_CONST, INST_CONST, FEM), CE2_NOP, ALU_NOP, CMN(NONE, NONE, 0x4, ALWAYS_NEVER, NXT_JMP));
    ...
    int *first_instruction)
{
    ...
    if (*first_instruction == DNX_OAMP_PE_NOT_SET)
    {
        *first_instruction = *next_instruction_index;
        ...
        INSTR_LABEL(CE1_NOP, CE2_NOP, ALU_SUB(PKT_LNTH, INST_VAR, ALU_OUT, ALWAYS, NEVER, TMP_REG1), CMN(NONE, NONE, 12, NEVER_NEVER, NXT_JMP), DNX_OAMP_PE_INST_LABEL_GAL_UPDATE_JUMBO_TLV_BRANCH);
    ...
    int *first_instruction)
{
    ...
    if (*first_instruction == DNX_OAMP_PE_NOT_SET)
    {
        *first_instruction = *next_instruction_index;
        ...
        INSTR_LABEL(CE1_NOP, CE2_NOP, ALU_SUB(PKT_LNTH, INST_VAR, ALU_OUT, ALWAYS, NEVER, TMP_REG1), CMN(NONE, NONE, 12, NEVER_NEVER, NXT_JMP), DNX_OAMP_PE_INST_LABEL_GAL_UPDATE_JUMBO_TLV_RSP_BRANCH);
...
shr_error_e
dnx_up_mep_dm_recycle_port_set(
    int unit, uint8 core_id, uint32 port)
{
    bcm_port_t recyle_port = 0;
    uint32 entry_handle_id;
    uint32 tod_prg_1st_instr;
    int itmh_dest_idx_core0;
    int itmh_dest_idx_core1;
    uint32 itmh_lsb_4b = 0;
    uint8 itmh_1b_core = 0;
    uint8 itmh_2b_core = 0;
    uint8 itmh_3b_core = 0;
    ...
    prog_enum = DBAL_ENUM_FVAL_OAMP_PE_PROGRAM_ENUM_UP_MEP_DM_TOD_RSP;
    ...
    dbal_value_field32_request(unit, entry_handle_id, DBAL_FIELD_PROGRAM_ADRESS, INST_SINGLE, &tod_prg_1st_instr);
    SHR_IF_ERR_EXIT(dbal_entry_get(unit, entry_handle_id, DBAL_COMMIT));

    
    itmh_dest_idx_core0 = tod_prg_1st_instr + 6;
    itmh_dest_idx_core1 = tod_prg_1st_instr + 14;

    
    if((core_id == 0) || (core_id == 1))
    {
        itmh_lsb_4b = (0x180000|(recyle_port <<1))<<8;
        itmh_1b_core = (itmh_lsb_4b&0xff000000) >> 24;
        itmh_2b_core = (itmh_lsb_4b&0xff0000) >> 16;
        itmh_3b_core = (itmh_lsb_4b&0xff00)>>8;
        SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_OAMP_PE_INSTRUCTIONS, &entry_handle_id));
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_OAMP_PE_INSTRUCT_INDEX, (core_id ? itmh_dest_idx_core1 : itmh_dest_idx_core0));
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_INST_CONST, INST_SINGLE,itmh_1b_core);
        SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));

        SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_OAMP_PE_INSTRUCTIONS, &entry_handle_id));
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_OAMP_PE_INSTRUCT_INDEX, ((core_id ? itmh_dest_idx_core1 : itmh_dest_idx_core0)+1));
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_INST_CONST, INST_SINGLE,itmh_2b_core);
        SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));

        SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_OAMP_PE_INSTRUCTIONS, &entry_handle_id));
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_OAMP_PE_INSTRUCT_INDEX, ((core_id ? itmh_dest_idx_core1 : itmh_dest_idx_core0)+2));
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_INST_CONST, INST_SINGLE,itmh_3b_core);
        SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
    }

    
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_OAM_UP_MEP_DM_RECYCLE_PORT_SW, &entry_handle_id));
    dbal_entry_value_field32_set(unit, entry_handle_id, (core_id ? DBAL_FIELD_RECYCLE_PORT_CORE_1 : DBAL_FIELD_RECYCLE_PORT_CORE_0),INST_SINGLE, recyle_port);
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
...
shr_error_e
dnx_up_mep_dm_recycle_port_get(
    int unit, uint8 core_id, uint32* port)
{
    uint32 recyle_port = 0;
    uint32 entry_handle_id;
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FUNC_INIT_VARS(unit);
    ...
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_OAM_UP_MEP_DM_RECYCLE_PORT_SW, &entry_handle_id));
    dbal_value_field32_request(unit, entry_handle_id, (core_id ? DBAL_FIELD_RECYCLE_PORT_CORE_1 : DBAL_FIELD_RECYCLE_PORT_CORE_0),INST_SINGLE, &recyle_port);
    SHR_IF_ERR_EXIT(dbal_entry_get(unit, entry_handle_id, DBAL_COMMIT));
    ...
    int *first_instruction)
{
    ...
    if (*first_instruction == DNX_OAMP_PE_NOT_SET)
    {
        *first_instruction = *next_instruction_index;
        ...
        INSTR_LABEL(CE1_NOP, CE2_NOP, ALU_NOP, CMN_NOP, DNX_OAMP_PE_INST_LABEL_UP_MEP_DM_TOD_CORE_1);
        INSTR(CE1_COPY(INST_VAR, DEFAULT, NONE, VLD_B, FEM), CE2_NOP, ALU_NOP, CMN(NONE, NONE, itmh_1b_core[1], ALWAYS_NEVER, NXT_JMP));
    ...
    oamp_pe_func_config_t * func_config)
{
    ...
    if (saved_prog_index == DNX_OAMP_PE_NOT_SET)
    {
        ...
        INSTR(CE1_NOP, CE2_COPY(IN_FIFO, LSHIFT_3_BITS_For_BITS_20_To_27, INST_CONST, 2B), ALU_SET(FEM, TMP_REG1), CMN(NONE, NONE, 0x20, NEVER_NEVER, NXT_JMP));
        ...
        INSTR(CE1_NOP, CE2_COPY(IN_FIFO, DEFAULT, INST_CONST, 4B), ALU_NOP, CMN(READ, WRITE, 9, NEVER_NEVER, LOP_CST));
        ...
        INSTR(CE1_NOP, CE2_COPY(IN_FIFO, DEFAULT, INST_CONST, 2B), ALU_SET(FEM, TMP_REG4), CMN(NONE, NONE, 0x12, NEVER_NEVER, NXT_JMP));

        INSTR(CE1_NOP, CE2_NOP, ALU_NOP, CMN_NOP);

        
        INSTR(CE1_COPY(IN_FIFO, DEFAULT, INST_CONST, INST_CONST, FEM), CE2_NOP, ALU_NOP, CMN(NONE, NONE, 0x1, ALWAYS_NEVER, NXT_JMP));

        INSTR(CE1_NOP, CE2_NOP, ALU_AND(TMP_REG3, TMP_REG4, ALU_OUT, ALWAYS, ALWAYS, TMP_REG3), CMN(NONE, NONE, 0x0, NEVER_NEVER, LOP_NXT));

        INSTR(CE1_NOP, CE2_NOP, ALU_NOP, CMN_NOP);

        INSTR(CE1_NOP, CE2_COPY(IN_FIFO, DEFAULT, INST_CONST, 2B), ALU_SET(FEM, TMP_REG4), CMN(NONE, NONE, 0x22, NEVER_NEVER, NXT_JMP));
        ...
        INSTR(CE1_COPY(TMP_REG2, DEFAULT, NONE, VLD_B, FEM), CE2_NOP, ALU_NOP, CMN(READ, NONE, 0x0, ALWAYS_NEVER, NXT_JMP));
...
{
    int first_instr;
    int udh_header_size = 0, byte_adjust = 0;
    uint32 saved_prog_index;
    ...
    if (saved_prog_index == DNX_OAMP_PE_NOT_SET)
    {
        ...
        if(oamp_tx_format == jr1_format)
        {
            ...
            INSTR(CE1_NOP, CE2_NOP, ALU_SUB(PDU_OFFS, INST_VAR, ALU_OUT, ALWAYS, ALWAYS, TMP_REG2), CMN(NONE, NONE, byte_adjust, NEVER_NEVER, LOP_NXT));
                    
                    INSTR(CE1_NOP, CE2_NOP, ALU_NOP, CMN_NOP);
                    INSTR(CE1_NOP, CE2_NOP, ALU_NOP, CMN_NOP);

            
            INSTR(CE1_COPY(IN_FIFO, DEFAULT, INST_CONST, VLD_B, FEM), CE2_NOP, ALU_SUB(TMP_REG2, BYTES_RD, NONE, NEVER, NPOS, TMP_REG2), CMN(READ, NONE, 0, ALWAYS_NEVER, LOP_NXT));
    ...
    oamp_pe_func_config_t * func_config)
{
    ...
    if (saved_prog_index == DNX_OAMP_PE_NOT_SET)
    {
        ...
        /* *INDENT-OFF* */
       INSTR(CE1_NOP, CE2_NOP, ALU_AND(PRG_VAR, NS_8, INST_VAR, ALWAYS, ZERO, TMP_REG4),CMN(NONE, NONE, inst_labels[DNX_OAMP_PE_INST_LABEL_DEFAULT], NEVER_NEVER, NXT_JMP));
                
                INSTR(CE1_NOP, CE2_NOP, ALU_NOP, CMN_NOP);
                INSTR(CE1_NOP, CE2_NOP, ALU_NOP, CMN_NOP);

        
        INSTR(CE1_NOP, CE2_NOP, ALU_ADD(PDU_OFFS, INST_VAR, ALU_OUT, ALWAYS, ALWAYS, TMP_REG3), CMN(NONE, NONE, 68, NEVER_NEVER, LOP_NXT));
        ...
        INSTR(CE1_NOP, CE2_NOP, ALU_SUB(TMP_REG2, TMP_REG4, INST_VAR, ALWAYS, ZERO, TMP_REG1), CMN(NONE, NONE, inst_labels[DNX_OAMP_PE_INST_LABEL_SIGNAL_DETECT_1B], NEVER_NEVER, NXT_JMP));
        
        INSTR(CE1_NOP, CE2_NOP, ALU_SUB(TMP_REG2, TMP_REG4, INST_VAR, ALWAYS, ZERO, TMP_REG1), CMN(NONE, NONE, inst_labels[DNX_OAMP_PE_INST_LABEL_SIGNAL_DETECT_2B], NEVER_NEVER, NXT_JMP));
        
        INSTR(CE1_NOP, CE2_NOP, ALU_SUB(TMP_REG2, TMP_REG4, INST_VAR, ALWAYS, ZERO, TMP_REG1), CMN(NONE, NONE, inst_labels[DNX_OAMP_PE_INST_LABEL_SIGNAL_DETECT_3B], NEVER_NEVER, NXT_JMP));
        ...
        INSTR(CE1_NOP, CE2_NOP, ALU_NOP, CMN_NOP);
            ...
            INSTR(CE1_NOP, CE2_COPY(IN_FIFO, DEFAULT, INST_CONST, 2B), ALU_SET(FEM, TMP_REG1), CMN(NONE, NONE, 0x12, NEVER_NEVER, NXT_JMP));
            
            INSTR(CE1_COPY(IN_FIFO, DEFAULT, INST_CONST, INST_CONST, FEM), CE2_NOP, ALU_NOP, CMN(NONE, NONE, 0x1, ALWAYS_NEVER, NXT_JMP));
            INSTR(CE1_NOP, CE2_NOP, ALU_NOP, CMN_NOP);
            
            INSTR(CE1_NOP, CE2_NOP, ALU_OR(TMP_REG1, INST_VAR, ALU_OUT, ALWAYS, ALWAYS, TMP_REG1), CMN(NONE, NONE, 0x40, NEVER_NEVER, LOP_NXT));
            INSTR(CE1_NOP, CE2_NOP, ALU_NOP, CMN_NOP);
            INSTR(CE1_NOP, CE2_NOP, ALU_NOP, CMN_NOP);
            
            INSTR(CE1_COPY(TMP_REG1, DEFAULT, INST_CONST, INST_CONST, FEM), CE2_NOP, ALU_NOP, CMN(NONE, NONE, 0x2, ALWAYS_NEVER, NXT_JMP));
            ...
            INSTR_LABEL(CE1_NOP, CE2_COPY(IN_FIFO, DEFAULT, INST_CONST, 2B), ALU_SET(FEM, TMP_REG1), CMN(NONE, NONE, 0x22, NEVER_NEVER, NXT_JMP), DNX_OAMP_PE_INST_LABEL_SIGNAL_DETECT_1B);
            ...
            INSTR(CE1_COPY(TMP_REG1, DEFAULT, INST_CONST, INST_CONST, FEM), CE2_NOP, ALU_NOP, CMN(READ, NONE, 0x2, ALWAYS_NEVER, NXT_JMP));
            ...
            INSTR_LABEL(CE1_COPY(IN_FIFO, DEFAULT, NONE, VLD_B, FEM), CE2_NOP, ALU_NOP, CMN(READ, NONE, 0, ALWAYS_NEVER, NXT_JMP), DNX_OAMP_PE_INST_LABEL_SIGNAL_DETECT_2B);
            
            INSTR(CE1_NOP, CE2_COPY(IN_FIFO, DEFAULT, INST_CONST, 2B), ALU_SET(FEM, TMP_REG1), CMN(NONE, NONE, 0x2, NEVER_NEVER, NXT_JMP));
            
            INSTR(CE1_NOP, CE2_NOP, ALU_SET(INST_VAR_MSB, TMP_REG3), CMN(NONE, NONE, 0x40, NEVER_NEVER, NXT_JMP));
            INSTR(CE1_NOP, CE2_NOP, ALU_NOP, CMN_NOP);
            INSTR(CE1_NOP, CE2_NOP, ALU_NOP, CMN_NOP);
            INSTR(CE1_NOP, CE2_NOP, ALU_OR(TMP_REG3, TMP_REG1, ALU_OUT, ALWAYS, ALWAYS, TMP_REG1), CMN(NONE, NONE, 0x0, NEVER_NEVER, LOP_NXT));
            INSTR(CE1_NOP, CE2_NOP, ALU_NOP, CMN_NOP);
            INSTR(CE1_NOP, CE2_NOP, ALU_NOP, CMN_NOP);
            
            INSTR(CE1_COPY(TMP_REG1, DEFAULT, INST_CONST, INST_CONST, FEM), CE2_NOP, ALU_NOP, CMN(NONE, NONE, 0x1, ALWAYS_NEVER, NXT_JMP));
            ...
            INSTR_LABEL(CE1_COPY(IN_FIFO, DEFAULT, NONE, VLD_B, FEM), CE2_NOP, ALU_NOP, CMN(READ, NONE, 0, ALWAYS_NEVER, NXT_JMP), DNX_OAMP_PE_INST_LABEL_SIGNAL_DETECT_3B);
    ...
    oamp_pe_func_config_t * func_config)
{
    ...
    if (saved_prog_index == DNX_OAMP_PE_NOT_SET)
    {
        ...
        INSTR(CE1_NOP, CE2_NOP, ALU_SUB(TMP_REG2, TMP_REG4, INST_VAR, ALWAYS, ZERO, TMP_REG1), CMN(NONE, NONE, inst_labels[DNX_OAMP_PE_INST_LABEL_SIGNAL_DETECT_48MAID_1B], NEVER_NEVER, NXT_JMP));
        
        INSTR(CE1_NOP, CE2_NOP, ALU_SUB(TMP_REG2, TMP_REG4, INST_VAR, ALWAYS, ZERO, TMP_REG1), CMN(NONE, NONE, inst_labels[DNX_OAMP_PE_INST_LABEL_SIGNAL_DETECT_48MAID_2B], NEVER_NEVER, NXT_JMP));
        
        INSTR(CE1_NOP, CE2_NOP, ALU_SUB(TMP_REG2, TMP_REG4, INST_VAR, ALWAYS, ZERO, TMP_REG1), CMN(NONE, NONE, inst_labels[DNX_OAMP_PE_INST_LABEL_SIGNAL_DETECT_48MAID_3B], NEVER_NEVER, NXT_JMP));
        ...
        INSTR(CE1_NOP, CE2_NOP, ALU_NOP, CMN_NOP);
            ...
            INSTR(CE1_NOP, CE2_NOP, ALU_SUB(NONE, NONE, INST_VAR, ALWAYS, ALWAYS, TMP_REG4), CMN(NONE, NONE, inst_labels[DNX_OAMP_PE_INST_LABEL_MAID_48_2B], NEVER_NEVER, NXT_JMP));
            ...
            INSTR_LABEL(CE1_NOP, CE2_COPY(IN_FIFO, DEFAULT, INST_CONST, 2B), ALU_SET(FEM, TMP_REG1), CMN(NONE, NONE, 0x22, NEVER_NEVER, NXT_JMP), DNX_OAMP_PE_INST_LABEL_SIGNAL_DETECT_48MAID_1B);
            ...
            INSTR(CE1_NOP, CE2_NOP, ALU_SUB(NONE, NONE, INST_VAR, ALWAYS, ALWAYS, TMP_REG4), CMN(NONE, NONE, inst_labels[DNX_OAMP_PE_INST_LABEL_MAID_48_3B], NEVER_NEVER, NXT_JMP));
            ...
            INSTR_LABEL(CE1_COPY(IN_FIFO, DEFAULT, NONE, VLD_B, FEM), CE2_NOP, ALU_NOP, CMN(READ, NONE, 0, ALWAYS_NEVER, NXT_JMP), DNX_OAMP_PE_INST_LABEL_SIGNAL_DETECT_48MAID_2B);
            ...
            INSTR(CE1_NOP, CE2_NOP, ALU_SUB(NONE, NONE, INST_VAR, ALWAYS, ALWAYS, TMP_REG4), CMN(NONE, NONE, inst_labels[DNX_OAMP_PE_INST_LABEL_MAID_48_0B], NEVER_NEVER, NXT_JMP));
            ...
            INSTR_LABEL(CE1_COPY(IN_FIFO, DEFAULT, NONE, VLD_B, FEM), CE2_NOP, ALU_NOP, CMN(READ, NONE, 0, ALWAYS_NEVER, NXT_JMP), DNX_OAMP_PE_INST_LABEL_SIGNAL_DETECT_48MAID_3B);
    ...
    oamp_pe_func_config_t * func_config)
{
    ...
    if (saved_prog_index == DNX_OAMP_PE_NOT_SET)
    {
        ...
        INSTR(CE1_NOP, CE2_NOP, ALU_SET(INST_VAR_MSB, TMP_REG4), CMN(NONE, NONE, 5, NEVER_NEVER, NXT_JMP));
        ...
        INSTR(CE1_NOP, CE2_NOP, ALU_SUB(TMP_REG3, TMP_REG4, INST_VAR, ALWAYS, ZERO, TMP_REG3), CMN(NONE, NONE, inst_labels[DNX_OAMP_PE_INST_LABEL_SBFD_IPV4_DEFAULT_FAI], NEVER_NEVER, NXT_JMP));
        ...
        INSTR(CE1_NOP, CE2_NOP, ALU_SUB(TMP_REG3, TMP_REG3, INST_VAR, ALWAYS, ZERO, TMP_REG3), CMN(NONE, NONE, inst_labels[DNX_OAMP_PE_INST_LABEL_SBFD_IPV4_BEFORE_UDP], NEVER_NEVER, NXT_JMP));

        INSTR(CE1_NOP, CE2_NOP, ALU_NOP, CMN_NOP);
        INSTR(CE1_NOP, CE2_NOP, ALU_NOP, CMN_NOP);

        
        INSTR_LABEL(CE1_COPY(IN_FIFO, DEFAULT, NONE, VLD_B, FEM), CE2_NOP, ALU_NOP, CMN(READ, NONE, 4, ALWAYS_NEVER, LOP_CST), DNX_OAMP_PE_INST_LABEL_SBFD_IPV4_DEFAULT_FAI);
        ...
        INSTR_LABEL(CE1_COPY(IN_FIFO, DEFAULT, INST_CONST, VLD_B, FEM), CE2_NOP, ALU_SUB(TMP_REG1, BYTES_RD, NONE, NEVER, NPOS, TMP_REG1), CMN(READ, NONE, 0, ALWAYS_NEVER, LOP_NXT), DNX_OAMP_PE_INST_LABEL_SBFD_IPV4_BEFORE_UDP);
    ...
    dnx_oamp_pe_fem_config_s fem_actions[DNX_OAMP_PE_FEM_LAST])
{
    ...
    dnx_oamp_pe_fem_config_s fem_actions_local[DNX_OAMP_PE_FEM_LAST] = {
        ...
        {DNX_OAMP_PE_FEM_LSHIFT_3_BITS_For_BITS_16_To_23,   {{CNST, 0},  {CNST, 0},  {CNST, 0},  {OFST, 16},  {OFST, 17},  {OFST, 18}, {OFST, 19}, {OFST, 20}, {OFST, 21}, {OFST, 22}, {OFST, 23}, {CNST, 0},  {CNST, 0},  {CNST, 0},  {CNST, 0},  {CNST, 0}},    1,    DNX_OAMP_PE_NOT_SET},
        {DNX_OAMP_PE_FEM_LSHIFT_3_BITS_For_BITS_20_To_27,   {{CNST, 0},  {CNST, 0},  {CNST, 0},  {OFST, 20},  {OFST, 21},  {OFST, 22}, {OFST, 23}, {OFST, 24}, {OFST, 25}, {OFST, 26}, {OFST, 27}, {CNST, 0},  {CNST, 0},  {CNST, 0},  {CNST, 0},  {CNST, 0}},    1,    DNX_OAMP_PE_NOT_SET},
        {DNX_OAMP_PE_FEM_RSHIFT_5_BITS_For_BITS_24_To_31,   {{CNST, 0},  {CNST, 0},  {CNST, 0},  {OFST, 24},  {OFST, 25},  {OFST, 26}, {OFST, 27}, {OFST, 28}, {OFST, 29}, {OFST, 30}, {OFST, 31}, {CNST, 0},  {CNST, 0},  {CNST, 0},  {CNST, 0},  {CNST, 0}},    1,    DNX_OAMP_PE_NOT_SET},
        {DNX_OAMP_PE_FEM_LSHIFT_8_BITS_For_BITS_16_To_23,   {{CNST, 0},  {CNST, 0},  {CNST, 0},  {CNST, 0},  {CNST, 0},  {CNST, 0}, {CNST, 0},  {CNST, 0}, {OFST, 16},  {OFST, 17},  {OFST, 18}, {OFST, 19}, {OFST, 20}, {OFST, 21}, {OFST, 22}, {OFST, 23}},    1,    DNX_OAMP_PE_NOT_SET},
        {DNX_OAMP_PE_FEM_BFD_FAI_12,                        {{OFST, 0},  {OFST, 1},  {OFST, 2},  {OFST, 3},  {OFST, 4},  {OFST, 5},  {CNST, 0},  {CNST, 0},  {CNST, 1},  {CNST, 1},  {OFST, 10}, {OFST, 11}, {OFST, 12}, {OFST, 13}, {OFST, 14}, {OFST, 15}},   1,    DNX_OAMP_PE_NOT_SET},
    };
...
dnx_oamp_mep_pe_profile_s mep_pe_profiles_local[DBAL_NOF_ENUM_MEP_PE_PROFILE_SW_VALUES] = {
    ...
    {DBAL_ENUM_FVAL_MEP_PE_PROFILE_SW_SEAMLESS_BFD_IPV6_NO_CRC,                         49,             0,              50,              0,             0,          1,   36},
};
    ...
    oamp_pe_tcam_config_s tcam_config[DBAL_NOF_ENUM_OAMP_PE_PROG_TCAM_ENUM_VALUES])
{
    ...
    oamp_pe_tcam_config_s tcam_config_local[DBAL_NOF_ENUM_OAMP_PE_PROG_TCAM_ENUM_VALUES] = {
        ...
        {DBAL_ENUM_FVAL_OAMP_PE_PROG_TCAM_ENUM_BFD_IPV4_SH,                                          oamp_pe_bfd_ipv4_program,                            1,    DBAL_ENUM_FVAL_OAMP_PE_PROGRAM_ENUM_BFD_IPV4,                                      0,                                       OAMP_PE_TCAM_KEY_MEP_GENERATED, 0x0,          {{{DBAL_ENUM_FVAL_OAMP_MEP_TYPE_BFD_IPV4_1HOP}, {0x0}, {0}, {0x7F}, {DBAL_ENUM_FVAL_MEP_PE_PROFILE_SW_BFD_DEFAULT},                                      {0x0},  {DBAL_ENUM_FVAL_MSG_TYPE_OTHER},            {0x0}}},DNX_OAMP_PE_NOT_SET},
        {DBAL_ENUM_FVAL_OAMP_PE_PROG_TCAM_ENUM_BFD_IPV4_MH,                                          oamp_pe_bfd_ipv4_program,                            1,    DBAL_ENUM_FVAL_OAMP_PE_PROGRAM_ENUM_BFD_IPV4,                                      0,                                       OAMP_PE_TCAM_KEY_MEP_GENERATED, 0x0,          {{{DBAL_ENUM_FVAL_OAMP_MEP_TYPE_BFD_IPV4_MHOP}, {0x0}, {0}, {0x7F}, {DBAL_ENUM_FVAL_MEP_PE_PROFILE_SW_BFD_DEFAULT},                                      {0x0},  {DBAL_ENUM_FVAL_MSG_TYPE_OTHER},            {0x0}}},DNX_OAMP_PE_NOT_SET},
        ...
        {DBAL_ENUM_FVAL_OAMP_PE_PROG_TCAM_ENUM_SEAMLESS_BFD_IPV6_NO_CRC,                             oamp_pe_bfd_ipv6_program,                            1,    DBAL_ENUM_FVAL_OAMP_PE_PROGRAM_ENUM_SEAMLESS_BFD_IPV6_NO_CRC,                      DNX_OAMP_PE_BFD_ECHO_UDP_DPORT_PROG_VAR, OAMP_PE_TCAM_KEY_MEP_GENERATED, 0x0,          {{{DBAL_ENUM_FVAL_OAMP_MEP_TYPE_BFD_IPV4_MHOP}, {0xF}, {0}, {0x7F}, {DBAL_ENUM_FVAL_MEP_PE_PROFILE_SW_SEAMLESS_BFD_IPV6_NO_CRC},                         {0x0},  {DBAL_ENUM_FVAL_MSG_TYPE_OTHER},            {0x0}}},DNX_OAMP_PE_NOT_SET},
