...
/** Entity DM Jumbo TLV uses 0xc00 entries started form index 0 */
#define DNX_OAM_OAMP_GENERIC_MEMORY_ENTITY_DM_JUMBO_TLV_ENTRY_INDEX (0)
#define DNX_OAM_OAMP_GENERIC_MEMORY_ENTITY_DM_JUMBO_TLV_NOF_ENTRIES (0xC00)

/** Entity DOWN MEP INJ uses 2 entries started form index 0xC00 */
#define DNX_OAM_OAMP_GENERIC_MEMORY_ENTITY_DOWN_MEP_INJ_ENTRY_INDEX \
    (DNX_OAM_OAMP_GENERIC_MEMORY_ENTITY_DM_JUMBO_TLV_NOF_ENTRIES)
#define DNX_OAM_OAMP_GENERIC_MEMORY_ENTITY_DOWN_MEP_INJ_NOF_ENTRIES (2)
 ...
 *  * None
 */
shr_error_e dnx_oamp_v1_bfd_pwe_channel_value_get(
    int unit,
    uint32 index,
    uint32 *value);
 ...
 *  * None
 */
shr_error_e dnx_oamp_v1_y1731_mpls_tp_channel_value_get(
    int unit,
    uint32 *value);
 ...
 *  * None
 */
shr_error_e dnx_oamp_v1_y1731_pwe_channel_value_get(
    int unit,
    uint32 *value);
 ...
 *  * None
 */
shr_error_e dnx_oamp_v1_y1731_pwe_channel_value_set(
    int unit,
    uint32 value);
 ...
 *  * None
 */
shr_error_e dnx_oamp_v1_bfd_pwe_channel_value_set(
    int unit,
    uint32 index,
    uint32 value);
/*
 ...
 *  * None
 */
shr_error_e dnx_oamp_v1_y1731_mpls_tp_channel_value_set(
    int unit,
    uint32 value);

/*
 * \brief
 * The function delete the channel value defined at a specified index
 * for BFD PWE
 * \param [in] unit -
 *   Relevant unit.
 * \param [in] index -
...
shr_error_e dnx_oamp_v1_bfd_pwe_channel_value_delete(
    int unit,
    uint32 index,
    uint32 value);
 ...
 *   * None
 */
shr_error_e dnx_oamp_v1_local_accelerated_endpoint_fill_id(
    int unit,
...
* \param [in] keep_mep_profile - decide keep mep profile or not
* \retval
...
/**
 * \brief - This function sets entry to DBAL_TABLE_OAMP_INIT_CPU_PORT_CFG.
 *
 * \param [in] unit - Number of hardware unit used
 * \param [in] dp - ITMH forward dp.
 * \param [in] tc - ITMH forward traffic class.
 *
 * \return
 *   shr_error_e
 *   \retval _SHR_E_EXIST - entry exist
...
shr_error_e dnx_oam_cpu_port_dp_tc_set(
    int unit,
    uint32 dp,
    uint32 tc);

/**
 * \brief - This function gets entry to DBAL_TABLE_OAMP_INIT_CPU_PORT_CFG.
 *
 * \param [in] unit - Number of hardware unit used
 * \param [in] dp - ITMH forward dp.
 * \param [in] tc - ITMH forward traffic class.
...
shr_error_e dnx_oam_cpu_port_dp_tc_get(
    int unit,
    uint32 *dp,
    uint32 *tc);

/**
 * \brief - Initialization for V1 OAMP
 ...
 *   * None
 */
shr_error_e dnx_oam_oamp_v1_init(
    int unit);
 ...
 *   * None
 */
shr_error_e dnx_oam_oamp_v1_init_cpu_port_configuration(
    int unit);
...
/**
 * \brief - Get the additional GAL special label for MPLS-TP OAM.
 *
 * \param [in] unit - Relevant unit
 * \param [in] gal - to store the additional GAL.
 *
 * \return
 *   shr_error_e
 *
 ...
 *   * None
 */
shr_error_e dnx_oam_oamp_v1_additional_gal_special_label_get(
    int unit,
    int *gal);

/**
 * \brief
 *   Set delete one VLAN IVE command into generic memory
 *   which is used to edit FHEI for down MEP injected
 *   packets by the related OAMP-PE programs.
 *
 * \param [in] unit - Number of hardware unit used.
 * \param [in] ive_cmd - Ingress VLAN edit command.
 *
 * \return
 *   \retval Zero if no error was detected
 ...
 * \see
 */
shr_error_e dnx_oam_oamp_v1_down_egress_inject_delete_one_vlan_ive_command_set(
    int unit,
    uint32 ive_cmd);

/**
 * \brief
 *   Get delete one VLAN IVE command from generic memory
 *   which is used to edit FHEI for down MEP injected
 *   packets by the related OAMP-PE programs.
 *
 * \param [in] unit - Number of hardware unit used.
 ...
 * \see
 */
shr_error_e dnx_oam_oamp_v1_down_egress_inject_delete_one_vlan_ive_command_get(
    int unit,
    uint32 *ive_cmd);
 ...
 * \see
 */
shr_error_e dnx_oam_oamp_v1_down_egress_inject_delete_two_vlan_ive_command_set(
    int unit,
    uint32 ive_cmd);

/**
 * \brief
 *   Get delete two VLAN IVE command from generic memory
 *   which is used to edit FHEI for down MEP injected
 *   packets by the related OAMP-PE programs.
 *
 * \param [in] unit - Number of hardware unit used.
 ...
 * \see
 */
shr_error_e dnx_oam_oamp_v1_down_egress_inject_delete_two_vlan_ive_command_get(
    int unit,
    uint32 *ive_cmd);

/**
 * \brief - This function sets network QoS in PPH into
 *          program variable for Down MEP Egress Inject.
 *
 * \param [in] unit - Number of hardware unit used.
 ...
 *   * None
 */
shr_error_e dnx_oam_oamp_v1_egress_inject_tx_pph_network_qos_set(
    int unit,
    uint32 network_qos);
 ...
 *
 * \param [in] unit - Number of hardware unit used.
 * \param [in] mep_db_entry - pointer to mep_db entry data
 * \param [out] endpoint_info - return filled endpoint info for accelerated endpoints according mep_db
 *  Updated fields are:
 ...
 *   * None
 */
shr_error_e dnx_oam_oamp_v1_ccm_endpoint_eth_oam_get(
    int unit,
    const dnx_oam_oamp_ccm_endpoint_t * mep_db_entry,
    bcm_oam_endpoint_info_t * endpoint_info);
...
*   * \ref bcm_dnx_oam_endpoint_destroy_all
*/
shr_error_e dnx_oam_oamp_v1_local_acc_endpoint_get(
    int unit,
    bcm_oam_endpoint_info_t * endpoint_info);

/**
* \brief
*  Check if the LM is piggyback(dual-ended) lm.
* \param [in] unit  -
*  Relevant unit.
* \param [in] endpoint_id  -
*  endpoint id.
* \param [out] is_piggyback -
*  1 if it is piggyback lm
* \retval
*   shr_error - Error indication
* \remark
*   * None
...
*   * None
*/
shr_error_e dnx_oam_oamp_is_piggyback_lm_get(
    int unit,
    uint32 endpoint_id,
    uint32 *is_piggyback);
...
/**
* \brief
*  Destroy the endpoint's OAMP accelerated entries.
* \param [in] unit  -
*  Relevant unit.
* \param [in] endpoint_info  -
*  Pointer to a structure, that holds the endpoint's
*  parameters
* \param [in] lif_resolution - Structure of lif resolution
* \param [in,out] mep_hw_profiles_write_data - struct for profiles that should be deleted in hw
* \param [in] extra_data_length - number of extra data entries used with endpoint
* \retval
*   shr_error - Error indication
* \remark
*   * None
...
*
* \param [in] unit - Relevant unit.
* \param [in] lifetime  - indicate single cycle of mep/rmep db
* \param [in] lifetime_units  - indicate single cycle of mep/rmep db * 100
* \param [in] period_us  - Period will be in microseconds
*
* \retval
*   shr_error - Error indication
* \remark
...
* \see
 */
void dnx_oam_oamp_v1_lifetime_to_period(
    int unit,
    uint32 lifetime,
...
* \see
 */
void dnx_oam_oamp_v1_period_to_lifetime(
    int unit,
    uint32 period_us,
    uint32 *lifetime,
    uint32 *lifetime_units);
...
/**
 * \brief - Initialize ptch header configurations
 *          for OAMP.
 *
 * \param [in] unit - Number of hardware unit used.
 * \param [in] pp_port - pp port value of oamp port.
 *
 * \return
 *   shr_error_e
 *
 ...
 *   * None
 */
shr_error_e dnx_port_oamp_v1_ptch_header_init(
    int unit,
    uint32 pp_port);
