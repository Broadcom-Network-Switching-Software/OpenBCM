    ...
    *valid_event_exist = 0;
    ...
    for (instance = 0; instance < max_format_events; instance++)
    {
        ...
        SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_decode
                        (unit, DBAL_FIELD_TYPE_DEF_JR2_OAMP_EVENT_FORMAT, DBAL_FIELD_RESERVED_1, &(reserved_1),
                         event_data));
        ...
        SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_decode(unit, DBAL_FIELD_TYPE_DEF_JR2_OAMP_EVENT_FORMAT,
        ...
        SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_decode(unit, DBAL_FIELD_TYPE_DEF_JR2_OAMP_EVENT_FORMAT,
                                                                   ...
                                                                   event_data));
        SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_decode
                        (unit, DBAL_FIELD_TYPE_DEF_JR2_OAMP_EVENT_FORMAT, DBAL_FIELD_RMEP_STATE, &(rmep_state),
                         event_data));
        SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_decode
                        (unit, DBAL_FIELD_TYPE_DEF_JR2_OAMP_EVENT_FORMAT, DBAL_FIELD_RESERVED_2, &(reserved_2),
                         event_data));
