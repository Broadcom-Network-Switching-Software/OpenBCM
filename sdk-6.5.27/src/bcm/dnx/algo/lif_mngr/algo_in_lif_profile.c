    ...
    const void *data)
{
    ...
    {
        SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT32, "IPv4 rpf mode", template_data->rpf_mode_ipv4,
                                       NULL, "0x%08x");
        SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT32, "IPv6 rpf mode", template_data->rpf_mode_ipv6,
                                       NULL, "0x%08x");
    }
    else
    {
        /** If separate RPF configuration is not supported, IPv4 and IPv6 urpf modes are the same, print one. */
        SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT32, "rpf mode", template_data->rpf_mode_ipv4,
                                       NULL, "0x%08x");
    }
    ...
    int unit)
{
    ...
    default_template_data.rpf_mode_ipv4 = DEFAULT_RPF_MODE;
    default_template_data.rpf_mode_ipv6 = DEFAULT_RPF_MODE;
