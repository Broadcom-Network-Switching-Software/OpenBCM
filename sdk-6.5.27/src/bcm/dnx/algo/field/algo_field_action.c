    ...
    int unit)
{
    ...
    if (DNX_FIELD_ACTION_PRIORITY_INVALID & (1U << BCM_FIELD_ACTION_VALID_OFFSET))
    {
        SHR_ERR_EXIT(_SHR_E_INTERNAL,
                     "DNX_FIELD_ACTION_PRIORITY_INVALID (0x%x) has "
                     "the bit BCM_FIELD_ACTION_VALID_OFFSET (0x%x) set.\r\n",
                     DNX_FIELD_ACTION_PRIORITY_INVALID, (1U << BCM_FIELD_ACTION_VALID_OFFSET));
    }
    if (BCM_FIELD_ACTION_INVALIDATE & (1U << BCM_FIELD_ACTION_VALID_OFFSET))
    {
        SHR_ERR_EXIT(_SHR_E_INTERNAL,
                     "BCM_FIELD_ACTION_INVALIDATE (0x%x) has "
                     "the bit BCM_FIELD_ACTION_VALID_OFFSET (0x%x) set.\r\n",
                     BCM_FIELD_ACTION_INVALIDATE, (1U << BCM_FIELD_ACTION_VALID_OFFSET));
    }
