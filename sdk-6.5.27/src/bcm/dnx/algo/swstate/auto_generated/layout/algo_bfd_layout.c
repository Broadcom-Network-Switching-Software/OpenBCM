...
algo_bfd_init_layout_structure(int unit)
{
    ...
    layout_array_algo_bfd[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_algo_bfd[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_ALGO_BFD_DB__LAST)-1;
    ...
    layout_array_algo_bfd[idx].print_cb = &dnx_bfd_mep_action_profile_print_cb;
    ...
    layout_array_algo_bfd[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_bfd[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_bfd[idx].print_cb = &dnx_bfd_oamp_v1_tos_ttl_profile_print_cb;
    ...
    layout_array_algo_bfd[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_bfd[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_bfd[idx].print_cb = &dnx_bfd_your_discr_range_profile_print_cb;
    ...
    layout_array_algo_bfd[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_bfd[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_bfd[idx].print_cb = &dnx_bfd_oamp_v1_tx_rate_profile_print_cb;
    ...
    layout_array_algo_bfd[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_bfd[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_bfd[idx].print_cb = &dnx_bfd_oamp_v1_req_int_profile_print_cb;
    ...
    layout_array_algo_bfd[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_bfd[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_bfd[idx].print_cb = &dnx_bfd_oamp_v1_discr_range_start_profile_print_cb;
    ...
    layout_array_algo_bfd[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_bfd[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_bfd[idx].print_cb = &dnx_bfd_oamp_v1_ipv4_src_addr_profile_print_cb;
    ...
    layout_array_algo_bfd[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_bfd[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_bfd[idx].print_cb = &dnx_bfd_oamp_v1_udp_src_port_profile_print_cb;
    ...
    layout_array_algo_bfd[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_bfd[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_bfd[idx].print_cb = &dnx_bfd_oamp_v1_mpls_src_port_profile_print_cb;
    ...
    layout_array_algo_bfd[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_bfd[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_bfd[idx].print_cb = &dnx_bfd_oamp_bfd_local_min_echo_print_cb;
    ...
    layout_array_algo_bfd[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_bfd[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_bfd[idx].print_cb = &dnx_bfd_oamp_v1_tx_period_cluster_print_cb;
    ...
    layout_array_algo_bfd[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_bfd[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_bfd[idx].print_cb = &dnx_bfd_oamp_v1_single_hop_tos_profile_print_cb;
    ...
    layout_array_algo_bfd[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_bfd[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_bfd[idx].print_cb = &dnx_bfd_seamless_udp_src_port_profile_print_cb;
    ...
    layout_array_algo_bfd[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_bfd[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_bfd[idx].print_cb = &dnx_bfd_server_trap_codes_print_cb;
    ...
    layout_array_algo_bfd[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_bfd[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_bfd[idx].print_cb = &dnx_bfd_dip_profile_print_cb;
    ...
    layout_array_algo_bfd[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_bfd[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_bfd[idx].print_cb = &dnx_bfd_server_device_index_print_cb;
