...
dnx_algo_flexe_general_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_algo_flexe_general[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_algo_flexe_general[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_FLEXE_GENERAL_DB__FIRST);
    layout_array_dnx_algo_flexe_general[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_FLEXE_GENERAL_DB__LAST)-1;
    ...
    layout_array_dnx_algo_flexe_general[idx].array_indexes[0].num_elements = DNX_ALGO_FLEXE_NOF_LINK_LIST_FIFOS;
    layout_array_dnx_algo_flexe_general[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_algo_flexe_general[idx].array_indexes[1].num_elements = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_algo_flexe_general[idx].array_indexes[0].num_elements = dnx_data_nif.flexe.nof_groups_get(unit);
    layout_array_dnx_algo_flexe_general[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    layout_array_dnx_algo_flexe_general[idx].parent  = 0;
    layout_array_dnx_algo_flexe_general[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_FLEXE_GENERAL_DB__GROUP_INFO__FIRST);
    layout_array_dnx_algo_flexe_general[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_FLEXE_GENERAL_DB__GROUP_INFO__LAST)-1;
    ...
    layout_array_dnx_algo_flexe_general[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    layout_array_dnx_algo_flexe_general[idx].parent  = 0;
    layout_array_dnx_algo_flexe_general[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_FLEXE_GENERAL_DB__DEMUX_SLOT_INFO__FIRST);
    layout_array_dnx_algo_flexe_general[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_FLEXE_GENERAL_DB__DEMUX_SLOT_INFO__LAST)-1;
    ...
    layout_array_dnx_algo_flexe_general[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    layout_array_dnx_algo_flexe_general[idx].parent  = 0;
    layout_array_dnx_algo_flexe_general[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_FLEXE_GENERAL_DB__MUX_SLOT_INFO__FIRST);
    layout_array_dnx_algo_flexe_general[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_FLEXE_GENERAL_DB__MUX_SLOT_INFO__LAST)-1;
    ...
    layout_array_dnx_algo_flexe_general[idx].parent  = 0;
    layout_array_dnx_algo_flexe_general[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_FLEXE_GENERAL_DB__RESOURCE_ALLOC__FIRST);
    layout_array_dnx_algo_flexe_general[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_FLEXE_GENERAL_DB__RESOURCE_ALLOC__LAST)-1;
    ...
    layout_array_dnx_algo_flexe_general[idx].array_indexes[0].num_elements = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_general[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC;
    layout_array_dnx_algo_flexe_general[idx].parent  = 0;
    layout_array_dnx_algo_flexe_general[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_FLEXE_GENERAL_DB__MGMT_CHANNEL_INFO__FIRST);
    layout_array_dnx_algo_flexe_general[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_FLEXE_GENERAL_DB__MGMT_CHANNEL_INFO__LAST)-1;
    layout_array_dnx_algo_flexe_general[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
    ...
    idx = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_FLEXE_GENERAL_DB__GROUP_INFO__DEMUX_GHAO_ACTION);
    layout_array_dnx_algo_flexe_general[idx].name = "dnx_algo_flexe_general_db__group_info__demux_ghao_action";
    layout_array_dnx_algo_flexe_general[idx].type = "bcm_port_flexe_group_ghao_action_t";
    layout_array_dnx_algo_flexe_general[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_general[idx].size_of = sizeof(bcm_port_flexe_group_ghao_action_t);
    layout_array_dnx_algo_flexe_general[idx].parent  = 2;
    layout_array_dnx_algo_flexe_general[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_general[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;

    idx = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_FLEXE_GENERAL_DB__GROUP_INFO__MUX_GHAO_ACTION);
    layout_array_dnx_algo_flexe_general[idx].name = "dnx_algo_flexe_general_db__group_info__mux_ghao_action";
    layout_array_dnx_algo_flexe_general[idx].type = "bcm_port_flexe_group_ghao_action_t";
    layout_array_dnx_algo_flexe_general[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_general[idx].size_of = sizeof(bcm_port_flexe_group_ghao_action_t);
    layout_array_dnx_algo_flexe_general[idx].parent  = 2;
    ...
    idx = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_FLEXE_GENERAL_DB__GROUP_INFO__DEMUX_ACTIVE_CAL);
    layout_array_dnx_algo_flexe_general[idx].name = "dnx_algo_flexe_general_db__group_info__demux_active_cal";
    layout_array_dnx_algo_flexe_general[idx].type = "bcm_port_flexe_group_cal_t";
    layout_array_dnx_algo_flexe_general[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_general[idx].size_of = sizeof(bcm_port_flexe_group_cal_t);
    layout_array_dnx_algo_flexe_general[idx].parent  = 2;
    layout_array_dnx_algo_flexe_general[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_general[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_algo_flexe_general[idx].array_indexes[0].num_elements = bcmPortFlexeGroupCalCount;
    layout_array_dnx_algo_flexe_general[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_algo_flexe_general[idx].array_indexes[1].num_elements = dnx_data_nif.flexe.max_nof_slots_get(unit);
