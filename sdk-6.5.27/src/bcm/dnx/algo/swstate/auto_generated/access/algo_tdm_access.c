...
algo_tdm_db_init(int unit)
{
    ...
    DNX_SW_STATE_DIAG_INFO_POST(
        ...
        DNX_SW_STATE_DIAG_ALLOC,
        ((algo_tdm_sw_state_t*)sw_state_roots_array[unit][ALGO_TDM_MODULE_ID]),
        sw_state_layout_array[unit][ALGO_TDM_MODULE_ID]);
 ...
 */
int
algo_tdm_db_link_mask_exchange(int unit, uint32 flags, int nof_references, const dnx_tdm_link_mask_t *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
