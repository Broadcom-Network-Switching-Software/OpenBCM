...
dnx_phantom_queues_db_is_init(int unit, uint8 *is_init)
{
    ...
    VERIFY_FUNCTION_CALL_ALLOWED(
        unit,
        DNX_SW_STATE_DNX_PHANTOM_QUEUES_DB,
...
dnx_phantom_queues_db_init(int unit)
{
    ...
    DNX_SW_STATE_MODULE_INIT(
        ...
        phantom_queues_init_layout_structure);
    ...
    DNX_SW_STATE_DIAG_INFO_POST(
        ...
        DNX_SW_STATE_DIAG_ALLOC,
        ((dnx_phantom_queues_db_t*)sw_state_roots_array[unit][PHANTOM_QUEUES_MODULE_ID]),
        sw_state_layout_array[unit][PHANTOM_QUEUES_MODULE_ID]);
 ...
 */
int
dnx_phantom_queues_db_phantom_queues_exchange(int unit, uint32 phantom_queues_idx_0, uint32 flags, int nof_references, const uint32 *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
