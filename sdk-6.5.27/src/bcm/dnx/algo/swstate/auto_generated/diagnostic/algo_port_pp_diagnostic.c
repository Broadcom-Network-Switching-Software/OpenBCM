...
/*
 *
 * dump function for the variable ipvx_o_mpls_parsing_enable_profile
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
algo_port_pp_db_ipvx_o_mpls_parsing_enable_profile_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "algo_port_pp ipvx_o_mpls_parsing_enable_profile") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate algo_port_pp ipvx_o_mpls_parsing_enable_profile\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "algo_port_pp_db/ipvx_o_mpls_parsing_enable_profile.txt",
            "algo_port_pp_db[%d]->","((algo_port_pp_sw_state_t*)sw_state_roots_array[%d][ALGO_PORT_PP_MODULE_ID])->","ipvx_o_mpls_parsing_enable_profile: ");
        ...
        DNX_ALGO_TEMP_MNGR_PRINT(
            unit,
            ALGO_PORT_PP_MODULE_ID,
            &((algo_port_pp_sw_state_t*)sw_state_roots_array[unit][ALGO_PORT_PP_MODULE_ID])->ipvx_o_mpls_parsing_enable_profile,
            dnx_algo_port_ipvx_o_mpls_parsing_print_cb);
...
algo_port_pp_db_force_forward_mngr_dump(int  unit,  int  mngr_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_ALGO_PORT_PP_DB__FORCE_FORWARD__MNGR, ((algo_port_pp_sw_state_t*)sw_state_roots_array[unit][ALGO_PORT_PP_MODULE_ID])->force_forward.mngr))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_ALGO_PORT_PP_DB__FORCE_FORWARD__MNGR, ((algo_port_pp_sw_state_t*)sw_state_roots_array[unit][ALGO_PORT_PP_MODULE_ID])->force_forward.mngr) == 0)
        {
            SHR_EXIT();
        }
...
algo_port_pp_db_force_forward_trap_id_dump(int  unit,  int  trap_id_idx_0,  int  trap_id_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_ALGO_PORT_PP_DB__FORCE_FORWARD__TRAP_ID, ((algo_port_pp_sw_state_t*)sw_state_roots_array[unit][ALGO_PORT_PP_MODULE_ID])->force_forward.trap_id))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_ALGO_PORT_PP_DB__FORCE_FORWARD__TRAP_ID, ((algo_port_pp_sw_state_t*)sw_state_roots_array[unit][ALGO_PORT_PP_MODULE_ID])->force_forward.trap_id) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_ALGO_PORT_PP_DB__FORCE_FORWARD__TRAP_ID, ((algo_port_pp_sw_state_t*)sw_state_roots_array[unit][ALGO_PORT_PP_MODULE_ID])->force_forward.trap_id[i0]))
            {
                LOG_CLI((BSL_META("algo_port_pp_db[]->((algo_port_pp_sw_state_t*)sw_state_roots_array[][ALGO_PORT_PP_MODULE_ID])->force_forward.trap_id[][]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_ALGO_PORT_PP_DB__FORCE_FORWARD__TRAP_ID, ((algo_port_pp_sw_state_t*)sw_state_roots_array[unit][ALGO_PORT_PP_MODULE_ID])->force_forward.trap_id[i0]) == 0)
            {
                SHR_EXIT();
            }
...
algo_port_pp_db_esem_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(algo_port_pp_db_esem_predefine_esem_cmds_dump(unit, -1, filters));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
/*
 *
 * dump function for the variable predefine_esem_cmds
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
algo_port_pp_db_esem_predefine_esem_cmds_dump(int  unit,  int  predefine_esem_cmds_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = predefine_esem_cmds_idx_0, I0 = predefine_esem_cmds_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "algo_port_pp esem predefine_esem_cmds") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate algo_port_pp esem predefine_esem_cmds\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "algo_port_pp_db/esem/predefine_esem_cmds.txt",
            "algo_port_pp_db[%d]->","((algo_port_pp_sw_state_t*)sw_state_roots_array[%d][ALGO_PORT_PP_MODULE_ID])->","esem.predefine_esem_cmds[]: ");
        ...
        if (i0 == -1) {
            I0 = DNX_DATA_MAX_ESEM_ACCESS_CMD_NOF_CMDS;
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ((algo_port_pp_sw_state_t*)sw_state_roots_array[unit][ALGO_PORT_PP_MODULE_ID])->esem.predefine_esem_cmds
                , sizeof(*((algo_port_pp_sw_state_t*)sw_state_roots_array[unit][ALGO_PORT_PP_MODULE_ID])->esem.predefine_esem_cmds), I0, &s0) ? I0 - 1 : 0;
        }

        if(i0 >= DNX_DATA_MAX_ESEM_ACCESS_CMD_NOF_CMDS)
        {
            LOG_CLI((BSL_META("algo_port_pp_db[]->((algo_port_pp_sw_state_t*)sw_state_roots_array[][ALGO_PORT_PP_MODULE_ID])->esem.predefine_esem_cmds[]: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(DNX_DATA_MAX_ESEM_ACCESS_CMD_NOF_CMDS == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "algo_port_pp_db[%d]->","((algo_port_pp_sw_state_t*)sw_state_roots_array[%d][ALGO_PORT_PP_MODULE_ID])->","esem.predefine_esem_cmds[%s%d]: ", s0, i0);
            ...
            dnx_sw_state_print_uint8(
                unit,
                &((algo_port_pp_sw_state_t*)sw_state_roots_array[unit][ALGO_PORT_PP_MODULE_ID])->esem.predefine_esem_cmds[i0]);
...
algo_port_pp_db_recycle_app_type_dump(int  unit,  int  recycle_app_idx_0,  int  recycle_app_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_ALGO_PORT_PP_DB__RECYCLE_APP__TYPE, ((algo_port_pp_sw_state_t*)sw_state_roots_array[unit][ALGO_PORT_PP_MODULE_ID])->recycle_app[i0]))
            {
                LOG_CLI((BSL_META("algo_port_pp_db[]->((algo_port_pp_sw_state_t*)sw_state_roots_array[][ALGO_PORT_PP_MODULE_ID])->recycle_app[][].type: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_ALGO_PORT_PP_DB__RECYCLE_APP__TYPE, ((algo_port_pp_sw_state_t*)sw_state_roots_array[unit][ALGO_PORT_PP_MODULE_ID])->recycle_app[i0]) == 0)
            {
                SHR_EXIT();
            }
...
const char* algo_port_pp_db_layout_str[ALGO_PORT_PP_DB_INFO_NOF_ENTRIES] = {
    ...
    "ALGO_PORT_PP_DB~IPVX_O_MPLS_PARSING_ENABLE_PROFILE~",
    ...
    "ALGO_PORT_PP_DB~ESEM~PREDEFINE_ESEM_CMDS~",
