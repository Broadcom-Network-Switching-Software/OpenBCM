...
/*
 *
 * dump function for the variable oam_primary_vlan_oam_lif
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
algo_oam_db_oam_primary_vlan_oam_lif_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "algo_oam oam_primary_vlan_oam_lif") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate algo_oam oam_primary_vlan_oam_lif\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "algo_oam_db/oam_primary_vlan_oam_lif.txt",
            "algo_oam_db[%d]->","((algo_oam_sw_state_t*)sw_state_roots_array[%d][ALGO_OAM_MODULE_ID])->","oam_primary_vlan_oam_lif: ");
...
const char* algo_oam_db_layout_str[ALGO_OAM_DB_INFO_NOF_ENTRIES] = {
    ...
    "ALGO_OAM_DB~OAM_PRIMARY_VLAN_OAM_LIF~",
};
