...
/*
 *
 * dump function for the variable in_lif_lb_profile_disablers_flags
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
algo_lif_profile_db_in_lif_lb_profile_disablers_flags_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "algo_lif_profile in_lif_lb_profile_disablers_flags") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate algo_lif_profile in_lif_lb_profile_disablers_flags\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "algo_lif_profile_db/in_lif_lb_profile_disablers_flags.txt",
            "algo_lif_profile_db[%d]->","((algo_lif_profile_sw_state_t*)sw_state_roots_array[%d][ALGO_LIF_PROFILE_MODULE_ID])->","in_lif_lb_profile_disablers_flags: ");
...
const char* algo_lif_profile_db_layout_str[ALGO_LIF_PROFILE_DB_INFO_NOF_ENTRIES] = {
    ...
    "ALGO_LIF_PROFILE_DB~IN_LIF_LB_PROFILE_DISABLERS_FLAGS~",
