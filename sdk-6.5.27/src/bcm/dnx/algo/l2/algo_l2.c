    ...
    const void *data)
{
    ...
    SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT32, "Delete",
                                   event_forwarding_profile_info->delete_distribution, "Delete event distribution",
                                   NULL);
    SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT32, "Learn",
                                   event_forwarding_profile_info->learn_distribution, "Learn event distribution", NULL);
    SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT32, "Refresh",
                                   event_forwarding_profile_info->refresh_distribution, "Refresh event distribution",
                                   NULL);
