    ...
    dnx_algo_res_create_data_t * data)
{
     ...
     */
    DNX_SW_STATE_MEMCPY(unit, node_id, algo_res->flags, &(data->flags), algo_res->flags, 0, "Resource flags.");
    DNX_SW_STATE_MEMCPY(unit, node_id, algo_res->first_element, &(data->first_element), algo_res->first_element,
                        0, "Resource first_element.");
    DNX_SW_STATE_MEMCPY(unit, node_id, algo_res->nof_elements, &(data->nof_elements), algo_res->nof_elements, 0,
                        "Resource nof_elements.");
    DNX_SW_STATE_MEMCPY(unit, node_id, algo_res->advanced_algorithm, &(data->advanced_algorithm),
                        algo_res->advanced_algorithm, 0, "Resource advanced_algorithm.");

    sw_state_string_strncpy
        (unit, node_id, algo_res->name, sizeof(char) * (DNX_ALGO_RES_MNGR_MAX_NAME_LENGTH - 1), data->name);
    ...
    uint32 alloc_flags)
{
    ...
    DNX_SW_STATE_ALLOC(unit, node_id, *algo_res, **algo_res, 1, 0, "*algo_res")
        /*
         * 1.1 Call the create function.
         */
        SHR_IF_ERR_EXIT(Resource_callbacks_map[data->advanced_algorithm].create_cb
                        (unit, node_id, &((*algo_res)->res_tag_bitmap), data, extra_arguments, alloc_flags));

    /*
     * 1.2 Register the resource data.
     */
    SHR_IF_ERR_EXIT(dnx_algo_res_create_register_data(unit, node_id, (*algo_res), data));
    ...
    int element)
{
    ...
    {
        SHR_ERR_EXIT(_SHR_E_PARAM,
                     "resource %s Element is too low. Element is %d and minimum is %d ", algo_res->name, element,
    ...
    {
        SHR_ERR_EXIT(_SHR_E_PARAM,
                     "resource %s Element is too high. Element is %d and maximum is %d ", algo_res->name, element,
                     (algo_res->first_element + algo_res->nof_elements - 1));
    }
    ...
    int *element)
{
    ...
    SHR_SET_CURRENT_ERR(dnx_algo_res_allocate_several(unit, node_id, algo_res, flags, 1, extra_arguments, element));
    ...
    uint8 *is_allocated)
{
    ...
    SHR_IF_ERR_EXIT(Resource_callbacks_map[algo_res->advanced_algorithm].is_allocated_cb
                    (unit, node_id, algo_res->res_tag_bitmap, element, is_allocated));
    ...
    void *extra_arguments)
{
    ...
    SHR_IF_ERR_EXIT(dnx_algo_res_free_several(unit, node_id, algo_res, 1, element, extra_arguments));
    ...
    int *nof_free_elements)
{
    ...
    SHR_IF_ERR_EXIT(Resource_callbacks_map[algo_res->advanced_algorithm].nof_free_elements_get_cb
                    (unit, node_id, algo_res->res_tag_bitmap, nof_free_elements));
    ...
    dnx_algo_res_t algo_res)
{
    ...
    if (Resource_callbacks_map[algo_res->advanced_algorithm].clear_cb != NULL)
    {
        SHR_IF_ERR_EXIT(Resource_callbacks_map[algo_res->advanced_algorithm].clear_cb
                        (unit, node_id, algo_res->res_tag_bitmap));
    }
    else
    {
        ...
        {
            SHR_IF_ERR_EXIT(dnx_algo_res_is_allocated(unit, node_id, algo_res, current_element, &is_allocated));
    ...
    int *element)
{
    ...
    if (Resource_callbacks_map[algo_res->advanced_algorithm].get_next_cb != NULL)
    {
        SHR_IF_ERR_EXIT(Resource_callbacks_map[algo_res->advanced_algorithm].get_next_cb
                        (unit, node_id, algo_res->res_tag_bitmap, element));
    }
    else
    {
    ...
    int *element)
{
    ...
    if (Resource_callbacks_map[algo_res->advanced_algorithm].allocate_cb != NULL && nof_elements == 1)
    {
        rv = Resource_callbacks_map[algo_res->advanced_algorithm].allocate_cb(unit, node_id,
                                                                              algo_res->res_tag_bitmap,
                                                                              flags, extra_arguments, element);
    }
    else
    {
        rv = Resource_callbacks_map[algo_res->advanced_algorithm].allocate_several_cb(unit, node_id,
    ...
    if ((_SHR_IS_FLAG_SET(flags, DNX_ALGO_RES_ALLOCATE_SIMULATION)
         || _SHR_IS_FLAG_SET(flags, DNX_ALGO_RES_ALLOCATE_SILENTLY)) && (rv != _SHR_E_NONE))
    {
    ...
    void *extra_arguments)
{
    ...
    {
        rv = Resource_callbacks_map[algo_res->advanced_algorithm].free_cb(unit, node_id, algo_res->res_tag_bitmap,
                                                                          element, extra_arguments);
    }
    else
    {
        rv = Resource_callbacks_map[algo_res->advanced_algorithm].free_several_cb(unit, node_id,
                                                                                  algo_res->res_tag_bitmap,
    ...
    dnx_algo_res_t * algo_res)
{
    ...
    SHR_IF_ERR_EXIT(dnx_algo_res_dump_info_get(unit, node_id, (*algo_res), &data));
    ...
    if (Resource_callbacks_map[data.create_data.advanced_algorithm].print_cb != NULL)
    {
        SHR_IF_ERR_EXIT(Resource_callbacks_map[data.create_data.advanced_algorithm].print_cb
                        (unit, node_id, &((*algo_res)->res_tag_bitmap), &data));
    }
    ...
    else
    {
        ...
        if (data.nof_used_elements)
        {
            ...
            while (1)
            {
                SHR_IF_ERR_EXIT(dnx_algo_res_get_next(unit, node_id, (*algo_res), &entry_id));
    ...
    int *nof_allocated_elements)
{
    ...
    if (Resource_callbacks_map[algo_res->advanced_algorithm].nof_allocated_elements_in_range_get_cb != NULL)
    {
        SHR_IF_ERR_EXIT(Resource_callbacks_map[algo_res->advanced_algorithm].nof_allocated_elements_in_range_get_cb
                        (unit, node_id, algo_res->res_tag_bitmap, range_start, nof_elements_in_range,
...
shr_error_e
dnx_algo_res_data_per_entry_set(
    int unit,
    uint32 node_id,
    dnx_algo_res_t algo_res,
    int element,
    void *data)
{
    ...
    {
        LOG_VERBOSE(BSL_LS_BCMDNX_RESMNGR,
                    (BSL_META("\n dnx_algo_res_data_per_entry_set(unit:%d, name:%s, element:%d)\n"), unit,
                     algo_res->name, element));
    }

    if (Resource_callbacks_map[algo_res->advanced_algorithm].data_per_entry_set != NULL)
    {
        SHR_IF_ERR_EXIT(Resource_callbacks_map[algo_res->advanced_algorithm].data_per_entry_set(unit,
                                                                                                node_id,
                                                                                                algo_res->res_tag_bitmap,
                                                                                                element, data));
    }
    ...
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "data_per_entry_set callback is NULL.");
    }
...
exit:
    ...
    {
        LOG_VERBOSE(BSL_LS_BCMDNX_RESMNGR,
                    (BSL_META("\n data_per_entry_set(name:%s, eelement:%d"), algo_res->name, element));
        LOG_VERBOSE(BSL_LS_BCMDNX_RESMNGR, (BSL_META(") Result:%d\n"), SHR_GET_CURRENT_ERR()));
    }
    SHR_FUNC_EXIT;
}
...
shr_error_e
dnx_algo_res_data_per_entry_get(
    int unit,
    uint32 node_id,
    dnx_algo_res_t algo_res,
    int element,
    void *data)
{
    ...
    {
        LOG_VERBOSE(BSL_LS_BCMDNX_RESMNGR,
                    (BSL_META("\n dnx_algo_res_data_per_entry_get(unit:%d, name:%s, element:%d)\n"), unit,
                     algo_res->name, element));
    }

    if (Resource_callbacks_map[algo_res->advanced_algorithm].data_per_entry_get != NULL)
    {
        SHR_IF_ERR_EXIT(Resource_callbacks_map[algo_res->advanced_algorithm].data_per_entry_get(unit,
                                                                                                node_id,
                                                                                                algo_res->res_tag_bitmap,
                                                                                                element, data));
    }
    ...
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "data_per_entry_get callback is NULL.");
    }
...
exit:
    ...
    {
        LOG_VERBOSE(BSL_LS_BCMDNX_RESMNGR,
                    (BSL_META("\n data_per_entry_get(name:%s, element:%d"), algo_res->name, element));
        LOG_VERBOSE(BSL_LS_BCMDNX_RESMNGR, (BSL_META(") Result:%d\n"), SHR_GET_CURRENT_ERR()));
    }
    SHR_FUNC_EXIT;
}
