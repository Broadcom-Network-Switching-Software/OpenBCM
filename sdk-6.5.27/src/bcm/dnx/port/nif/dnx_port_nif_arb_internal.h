...
/**
 * \brief - Enable stif for given instance id
 *
 */
shr_error_e dnx_port_arb_stif_enable_set(
    int unit,
    int stif_port_id,
    int enable);

/**
 * \brief - Configure stif port's offset for given instance id
 *
 */
shr_error_e dnx_port_arb_stif_port_set(
    int unit,
    int stif_port_id,
    int enable);

/**
 * \brief - Configure stif port reset for given instance id
 *
 */
shr_error_e dnx_port_arb_stif_reset_set(
    int unit,
    int stif_port_id,
    int in_reset);
