...
shr_error_e dnx_port_ofr_quantum_counter_reset_set(
    int unit,
    bcm_port_t port,
    bcm_port_nif_scheduler_t priority,
    int in_reset);

shr_error_e dnx_port_ofr_quantum_load_enable_set(
    int unit,
    bcm_port_t port,
    bcm_port_nif_scheduler_t priority,
    int enable);

shr_error_e dnx_port_ofr_deficit_rr_config_reset_set(
    int unit,
    bcm_port_t port,
    bcm_port_nif_scheduler_t priority,
    int in_reset);
 ...
 * \param [in] unit - chip unit id.
 * \param [in] port - logical port.
 * \param [in] priority_config - priority config.
 * \param [out] is_over_high - Is TDM over high RMC (otherwise LOW).
 *
 */
shr_error_e dnx_port_ofr_tdm_is_over_high_internal_get(
    int unit,
    bcm_port_t port,
    const bcm_port_prio_config_t * priority_config,
    int *is_over_high);
