...
#define DNX_PORT_FRAMER_MGMT_UNSUPPORTED_ATTRS  DNX_PORT_FLEXE_PHY_UNSUPPORTED_ATTRS

#define DNX_PORT_OTN_PHY_UNSUPPORTED_ATTRS      (DNX_PORT_NIF_UNSUPPORTED_COMMON_ATTRS |  \
                                                 BCM_PORT_ATTR_LEARN_MASK              |  \
                                                 BCM_PORT_ATTR_VLANFILTER_MASK         |  \
                                                 BCM_PORT_ATTR_UNTAG_VLAN_MASK         |  \
                                                 BCM_PORT_ATTR_PAUSE_TX_MASK           |  \
...
#define DNX_PORT_FEEDBACK_UNSUPPORTED_ATTRS     (DNX_PORT_NIF_UNSUPPORTED_COMMON_ATTRS |  \
                                                 BCM_PORT_ATTR_LEARN_MASK              |  \
                                                 BCM_PORT_ATTR_VLANFILTER_MASK         |  \
                                                 BCM_PORT_ATTR_UNTAG_VLAN_MASK         |  \
                                                 BCM_PORT_ATTR_PAUSE_TX_MASK           |  \
    ...
    uint32 *mask2)
{
    ...
    *mask2 &= ~DNX_PORT_UNSUPPORTED_COMMON_ATTRS2;
    ...
    else if (DNX_ALGO_PORT_TYPE_IS_FLEXE_PHY(unit, port_info, TRUE))
    {
        *mask &= ~DNX_PORT_FLEXE_PHY_UNSUPPORTED_ATTRS;
    }
    else if (DNX_ALGO_PORT_TYPE_IS_OTN_PHY(unit, port_info))
    {
        *mask &= ~DNX_PORT_OTN_PHY_UNSUPPORTED_ATTRS;
    }
    else if (DNX_ALGO_PORT_TYPE_IS_FRAMER_MGMT(unit, port_info))
    {
        *mask &= ~DNX_PORT_FRAMER_MGMT_UNSUPPORTED_ATTRS;
    }
    else if (DNX_ALGO_PORT_TYPE_IS_NIF_ETH_FEEDBACK(unit, port_info))
    {
        *mask &= ~DNX_PORT_FEEDBACK_UNSUPPORTED_ATTRS;
    }
    else
    {
