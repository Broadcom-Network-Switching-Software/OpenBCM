    ...
    int speed)
{
    ...
    {
        __rv__ =
            __flexe_core__dispatch__[__type__]->f_flexe_core_mac_client_add(unit, client_channel, mgmt_channel, flags,
                                                                            speed);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    ...
    int speed)
{
    ...
    {
        __rv__ =
            __flexe_core__dispatch__[__type__]->f_flexe_core_mac_client_delete(unit, client_channel, mgmt_channel,
                                                                               flags, speed);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
...
int
flexe_core_rateadpt_bus_type_t_validate(
    int unit,
    flexe_core_rateadpt_bus_type_t flexe_core_rateadpt_bus_type)
{
    SHR_FUNC_INIT_VARS(unit);
    if (flexe_core_rateadpt_bus_type >= flexe_core_rateadpt_Count)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "Parameter is out of range");
    }
    ...
    flexe_core_rate_adpt_info_t * rate_adpt_info)
{
    ...
    if (rate_adpt_info == NULL)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "rate_adpt_info NULL parameter");
    }
    if (_SHR_E_NONE != flexe_core_rate_adpt_info_t_init(unit, rate_adpt_info))
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "rate_adpt_info initialization failed");
    }
    ...
    if (NULL != __flexe_core__dispatch__[__type__]->f_flexe_core_rateadpt_get)
    {
        __rv__ = __flexe_core__dispatch__[__type__]->f_flexe_core_rateadpt_get(unit, client_channel, rate_adpt_info);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "flexe_core_rateadpt_get isn't implemented for driver type");
    }
    ...
    flexe_core_busa_channel_map_info_t * flexe_core_busa_channel_map_info)
{
    ...
    flexe_core_busa_channel_map_info->is_transparent = 0;
    flexe_core_busa_channel_map_info->is_fec = 0;
    ...
    int speed)
{
    ...
    if (NULL != __flexe_core__dispatch__[__type__]->f_flexe_core_mac_client_ghao_config_set)
    {
        __rv__ =
            __flexe_core__dispatch__[__type__]->f_flexe_core_mac_client_ghao_config_set(unit, client_channel, speed);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "flexe_core_mac_client_ghao_config_set isn't implemented for driver type");
    }
    ...
    int speed)
{
    ...
    if (NULL != __flexe_core__dispatch__[__type__]->f_flexe_core_sar_client_ghao_config_set)
    {
        __rv__ =
            __flexe_core__dispatch__[__type__]->f_flexe_core_sar_client_ghao_config_set(unit, client_channel, flags,
                                                                                        speed);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "flexe_core_sar_client_ghao_config_set isn't implemented for driver type");
    }
    ...
    int flexe_cal)
{
    ...
    if (NULL != __flexe_core__dispatch__[__type__]->f_flexe_core_schedule_calendar_switch)
    {
        __rv__ =
            __flexe_core__dispatch__[__type__]->f_flexe_core_schedule_calendar_switch(unit, group_index, flags,
                                                                                      flexe_cal);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "flexe_core_schedule_calendar_switch isn't implemented for driver type");
    }
    ...
    int speed)
{
    ...
    if (NULL != __flexe_core__dispatch__[__type__]->f_flexe_core_flexe_client_ghao_cal_switch)
    {
        __rv__ =
            __flexe_core__dispatch__[__type__]->f_flexe_core_flexe_client_ghao_cal_switch(unit, group_index, cal_id,
                                                                                          client_channel, flags, speed);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "flexe_core_flexe_client_ghao_cal_switch isn't implemented for driver type");
    }
    ...
    int speed)
{
    ...
    if (NULL != __flexe_core__dispatch__[__type__]->f_flexe_core_flexe_client_ghao_complete)
    {
        __rv__ =
            __flexe_core__dispatch__[__type__]->f_flexe_core_flexe_client_ghao_complete(unit, group_index,
                                                                                        client_channel, flags, speed);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "flexe_core_flexe_client_ghao_complete isn't implemented for driver type");
    }
    ...
    uint32 flags)
{
    ...
    if (NULL != __flexe_core__dispatch__[__type__]->f_flexe_core_flexe_client_ghao_stop)
    {
        __rv__ =
            __flexe_core__dispatch__[__type__]->f_flexe_core_flexe_client_ghao_stop(unit, group_index, cal_id, flags);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "flexe_core_flexe_client_ghao_stop isn't implemented for driver type");
    }
...
int
flexe_core_l1_eth_1588_info_t_validate(
    int unit,
    const flexe_core_l1_eth_1588_info_t * flexe_core_l1_eth_1588_info)
{
    SHR_FUNC_INIT_VARS(unit);
    if (flexe_core_l1_eth_1588_info == NULL)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "NULL parameter");
    }
...
int
flexe_core_l1_eth_1588_info_t_init(
    int unit,
    flexe_core_l1_eth_1588_info_t * flexe_core_l1_eth_1588_info)
{
    ...
    if (flexe_core_l1_eth_1588_info == NULL)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "flexe_core_l1_eth_1588_info NULL parameter");
    }
    sal_memset(flexe_core_l1_eth_1588_info, 0, sizeof(flexe_core_l1_eth_1588_info_t));
    flexe_core_l1_eth_1588_info->eth_channel = 0;
    flexe_core_l1_eth_1588_info->ptp_port = 0;
    flexe_core_l1_eth_1588_info->mac1_channel = 0;
    flexe_core_l1_eth_1588_info->mac2_channel = 0;
    flexe_core_l1_eth_1588_info->speed = 0;
    ...
    int enable)
{
    ...
    if (_SHR_E_NONE != flexe_core_l1_eth_1588_info_t_validate(unit, eth_1588_info))
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "eth_1588_info validation failed");
    }
    ...
    if (NULL != __flexe_core__dispatch__[__type__]->f_flexe_core_l1_eth_1588_enable_set)
    {
        __rv__ =
            __flexe_core__dispatch__[__type__]->f_flexe_core_l1_eth_1588_enable_set(unit, flags, eth_1588_info, enable);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "flexe_core_l1_eth_1588_enable_set isn't implemented for driver type");
    }
...
int
flexe_core_mac_stat_counter_type_t_validate(
    int unit,
    flexe_core_mac_stat_counter_type_t flexe_core_mac_stat_counter_type)
{
    SHR_FUNC_INIT_VARS(unit);
    if (flexe_core_mac_stat_counter_type >= flexe_core_mac_Count)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "Parameter is out of range");
    }
    ...
    int enable)
{
    ...
    if (NULL != __flexe_core__dispatch__[__type__]->f_flexe_core_stat_channel_config_set)
    {
        __rv__ =
            __flexe_core__dispatch__[__type__]->f_flexe_core_stat_channel_config_set(unit, client_channel, stat_channel,
                                                                                     enable);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "flexe_core_stat_channel_config_set isn't implemented for driver type");
    }
    ...
    uint64 *counter_val)
{
    ...
    if (NULL != __flexe_core__dispatch__[__type__]->f_flexe_core_stat_mac_counter_get)
    {
        __rv__ = __flexe_core__dispatch__[__type__]->f_flexe_core_stat_mac_counter_get(unit, stat_channel, counter_val);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "flexe_core_stat_mac_counter_get isn't implemented for driver type");
    }
    ...
    uint32 flags)
{
    ...
    if (NULL != __flexe_core__dispatch__[__type__]->f_flexe_core_oam_timeslot_delete)
    {
        __rv__ = __flexe_core__dispatch__[__type__]->f_flexe_core_oam_timeslot_delete(unit, client_channel, flags);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "flexe_core_oam_timeslot_delete isn't implemented for driver type");
    }
    ...
    int speed)
{
    ...
    if (NULL != __flexe_core__dispatch__[__type__]->f_flexe_core_oam_timeslot_add)
    {
        __rv__ = __flexe_core__dispatch__[__type__]->f_flexe_core_oam_timeslot_add(unit, client_channel, flags, speed);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "flexe_core_oam_timeslot_add isn't implemented for driver type");
    }
    ...
    uint32 *value)
{
    ...
    if (NULL != __flexe_core__dispatch__[__type__]->f_flexe_core_register_get)
    {
        __rv__ =
            __flexe_core__dispatch__[__type__]->f_flexe_core_register_get(unit, module_id, reg_id, field_id, value);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "flexe_core_register_get isn't implemented for driver type");
    }
    ...
    uint32 *value)
{
    ...
    if (NULL != __flexe_core__dispatch__[__type__]->f_flexe_core_memory_get)
    {
        __rv__ =
            __flexe_core__dispatch__[__type__]->f_flexe_core_memory_get(unit, module_id, reg_id, field_id, index,
                                                                        value);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "flexe_core_memory_get isn't implemented for driver type");
    }
    ...
    int in_reset)
{
    ...
    if (NULL != __flexe_core__dispatch__[__type__]->f_flexe_core_soft_reset)
    {
        __rv__ = __flexe_core__dispatch__[__type__]->f_flexe_core_soft_reset(unit, in_reset);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "flexe_core_soft_reset isn't implemented for driver type");
    }
