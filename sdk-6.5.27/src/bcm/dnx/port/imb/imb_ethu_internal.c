    ...
    uint32 threshold)
{
    ...
    if (dnx_data_fc.general.feature_get(unit, dnx_data_fc_general_only_nif_rmc_for_fc))
    {
    }
    else
    {
    ...
    uint32 *pm_credits)
{
     ...
     */
    if (imbDispatchTypeImb_cdu == ethu_info.imb_type)
    {
    ...
    else if (imbDispatchTypeImb_clu == ethu_info.imb_type)
    {
    ...
    int reset_pfc)
{
    ...
    if (reset_traffic)
    {
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_RESET_CNTS_TRAFFIC, INST_SINGLE,
                                     DBAL_ENUM_FVAL_NIF_RESET_REVERSE_LOGIC_IN_RESET);
    }
    if (reset_pfc)
    {
...
*/
int
imb_ethu_internal_instru_counters_reset_set(
    int unit,
    bcm_core_t core,
    int ethu_in_core,
    uint8 reset)
{
    ...
    dbal_entry_value_field8_set(unit, entry_handle_id, DBAL_FIELD_INSTRU_RESET, INST_SINGLE, ((reset == TRUE) ? 0 : 1));
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
...
*/
int
imb_ethu_internal_instru_counters_reset_get(
    int unit,
    bcm_core_t core,
    int ethu_in_core,
    uint8 *reset)
{
    ...
    dbal_value_field8_request(unit, entry_handle_id, DBAL_FIELD_INSTRU_RESET, INST_SINGLE, &val);
    SHR_IF_ERR_EXIT(dbal_entry_get(unit, entry_handle_id, DBAL_COMMIT));
