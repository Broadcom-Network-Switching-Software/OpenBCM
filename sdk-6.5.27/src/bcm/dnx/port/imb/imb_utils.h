 ...
 *   * None
 */
int imb_clu_mgu_port_autoneg_ability_verify(
    int unit,
    bcm_port_t port,
    int num_ability,
...
/**
 * \brief - Wrapper of portmod_preemption_control_set to support Error Recovery
 * 
 * \param [in]  unit            - unit id
 * \param [in]  port            - logical port
 * \param [in]  portmod_type    - preemption parameter of type portmod_preemption_control_t
 ...
 *   * None
 */
int imb_er_portmod_preemption_control_set(
    int unit,
    bcm_port_t port,
