    ...
    int nof_rmcs)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_port_rx_rmc_priority_config_set)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_port_rx_rmc_priority_config_set(unit, port, rmc_arr, nof_rmcs);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_port_rx_rmc_priority_config_set isn't implemented for driver type");
    }
    ...
    bcm_port_t port)
{
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_port_pm_lock_status_change_event)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_port_pm_lock_status_change_event(unit, port);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_port_pm_lock_status_change_event isn't implemented for driver type");
    }
    ...
    int speed)
{
    ...
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_flexe_core_port_config_set(unit, port, flags, instance_id, speed);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
    ...
    const bcm_port_flr_link_config_t * config)
{
    ...
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_port_flr_link_config_set(unit, port, lane_id, config);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
    ...
    int *in_reset)
{
    ...
    if (in_reset == NULL)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "in_reset NULL parameter");
    }
    /*
     * Dispatch 
     */
    ...
    if (NULL != __imb__dispatch__[__type__]->f_imb_pm_reset_get)
    {
        __rv__ = __imb__dispatch__[__type__]->f_imb_pm_reset_get(unit, ethu_id, in_reset);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "imb_pm_reset_get isn't implemented for driver type");
    }
