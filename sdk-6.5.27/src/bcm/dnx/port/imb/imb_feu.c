...
/**
 * \brief - Configure FEU calendar for RMC and TMC
 *
 */
static shr_error_e
imb_feu_calendar_config(
    int unit,
    ...
    uint32 *calendar)
{
    ...
    SHR_IF_ERR_EXIT(imb_framer_internal_shadow_calendar_config(unit, cal_type, cal_len, calendar, &cal_to_config));
    SHR_IF_ERR_EXIT(imb_framer_internal_calendar_switch(unit, cal_type, cal_to_config));
exit:
    SHR_FUNC_EXIT;
}
/**
    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(imb_feu_calendar_config(unit, IMB_FEU_TMC_CALENDAR, nof_clients, calendar));
exit:
    SHR_FUNC_EXIT;
}
/**
    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(imb_feu_calendar_config(unit, IMB_FEU_RMC_CALENDAR, cal_len, calendar));

    if (dnx_data_nif.mac_client.feature_get(unit, dnx_data_nif_mac_client_rmc_cal_per_priority))
    {
        SHR_IF_ERR_EXIT(dnx_algo_flexe_general_cal_build(unit, slots_per_hi_or_esb_rmc, nof_rmcs, cal_len, calendar));
        SHR_IF_ERR_EXIT(imb_feu_calendar_config(unit, IMB_FEU_HI_OR_ESB_RMC_CALENDAR, cal_len, calendar));
    }
exit:
    SHR_FUNC_EXIT;
}
