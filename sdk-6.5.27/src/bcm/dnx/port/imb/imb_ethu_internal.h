 ...
 *
 * \param [in] unit - chip unit id
 * \param [in] ethu_info - ptr to ethu info struct
...
int imb_ethu_internal_port_rx_priority_to_rmc_map(
    int unit,
    bcm_port_t port,
    const dnx_algo_port_rmc_info_t * rmc,
    int is_map_valid);
 ...
 * \param [in] rmc_prio - Rx Fifo priority
...
/**
 * \brief - Set the LLFC/PFC Quad MAC Lane FIFO (QMLF) thresholds profile per RMC + Priority.
 *
 * \param [in] unit - Unit ID
 * \param [in] rmc_prio - RMC Priority
 * \param [in] rmc - Rx Fifo for which to set the value
 ...
 *   * None
 */
int imb_ethu_internal_port_fc_rx_qmlf_rmc_to_profile_set(
    int unit,
    int rmc_prio,
    int rmc,
    int profile);
...
/**
 * \brief - Get the LLFC/PFC Quad MAC Lane FIFO (QMLF) thresholds profile per RMC + Priority.
 *
 * \param [in] unit - Unit ID
 * \param [in] rmc_prio - RMC Priority
 * \param [in] rmc - Rx Fifo for which to set the value
 ...
 *   * None
 */
int imb_ethu_internal_port_fc_rx_qmlf_rmc_to_profile_get(
    int unit,
    int rmc_prio,
    int rmc,
    int *profile);
...
/**
 * \brief - Set the LLFC/PFC Quad MAC Lane FIFO (QMLF) thresholds values per profile.
 *
 * \param [in] unit - Unit ID
 * \param [in]  profile - profile
 * \param [in] profile_value - threshold value
 * \return
 *   int
 *
 * \remarks
 ...
 *   * None
 */
int imb_ethu_internal_port_fc_rx_qmlf_profile_value_set(
    int unit,
    uint32 profile,
    dnx_rmc_thresholds_t profile_value);

/**
 * \brief - Get the LLFC/PFC Quad MAC Lane FIFO (QMLF) thresholds values per profile.
 *
 * \param [in] unit - Unit ID
 * \param [in]  profile - profile
 * \param [out] profile_value - threshold value
 * \return
 *   int
 *
 * \remarks
 ...
 *   * None
 */
int imb_ethu_internal_port_fc_rx_qmlf_profile_value_get(
    int unit,
    uint32 profile,
    dnx_rmc_thresholds_t * profile_value);
 ...
 *   * None
 */
int imb_ethu_rx_fifo_drop_hw_get(
    int unit,
    bcm_port_t port,
    uint32 rmc,
    uint64 *count);
...
/**
 * \brief - Reset the port credit in the ETHU to the configured value.
 *
 * \param [in] unit - chip unit id.
 * \param [in] logical_port - logical port
 * \param [in] in_reset - in/out reset
 *
 * \return
 *   int - see _SHR_E_ *
 *
 ...
 *   * None
 */
shr_error_e imb_ethu_port_tx_lane_ctrl_credit_reset(
    int unit,
 ...
 *
 * \param [in] unit - chip unit id
 * \param [in] ethu_info - ETHU info
 * \param [in] prd_profile - prd port profile.
 *                           For CDU/NBU units this is the lane in ethu.
 ...
 *
 * \param [in] unit - chip unit id
 * \param [in] ethu_info - ETHU port info struct
 * \param [in] prd_profile - prd port profile.
 *                           For CDU units this is the lane in ethu.
 *                           For CLU units this is the port prd profile, according to mapping done by user.
...
*   * None
*/
int imb_ethu_internal_instru_counters_reset_set(
    int unit,
    bcm_core_t core,
    int ethu_in_core,
    uint8 reset);
...
*   * None
*/
int imb_ethu_internal_instru_counters_reset_get(
    int unit,
    bcm_core_t core,
    int ethu_in_core,
    uint8 *reset);
 ...
 *   * None
 */
int imb_ethu_prd_port_last_packet_priority_tdm_hw_get(
    int unit,
    dnx_algo_port_ethu_access_info_t ethu_info,
    uint32 *priority,
    uint32 *tdm,
