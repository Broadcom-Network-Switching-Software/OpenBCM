...
/**
* \brief - complete reset of RX HRF
* see .h file
*/
static int
imb_ilu_hrf_rx_segmentation_complete_reset(
    int unit,
    bcm_port_t port,
    uint8 in_reset)
{
...
*/
static int
imb_ilu_hrf_rx_segmentation_per_hrf_type_reset(
    int unit,
    bcm_port_t port,
    uint8 in_reset)
{
...
*/
static int
imb_ilu_hrf_rx_segmentation_per_port_reset(
    int unit,
    bcm_port_t port,
    uint8 in_reset)
{
    ...
    /*
     * re-allocate DBAL table handle
     */
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_NIF_ILU_SEGMENTATION_HRF_PORT_RESET, &entry_handle_id));
    /*
     * set key fields
     */
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_ILKN_CORE_ID, ilkn_access_info.ilkn_core);
     ...
     * set value fields
     */
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_SEGMENTATION_HRF_PORT_RESET, INST_SINGLE,
                                 in_reset ? DBAL_ENUM_FVAL_NIF_RESET_REVERSE_LOGIC_IN_RESET :
                                 DBAL_ENUM_FVAL_NIF_RESET_REVERSE_LOGIC_OUT_OF_RESET);
    /*
     * commit the value
    ...
    uint8 in_reset)
{
    ...
    if (in_reset)
    {
        if (is_complete)
        {
            SHR_IF_ERR_EXIT(imb_ilu_hrf_rx_segmentation_complete_reset(unit, port, in_reset));
        }
        if (dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_per_port_segmentation_hrf_reset))
        {
            SHR_IF_ERR_EXIT(imb_ilu_hrf_rx_segmentation_per_port_reset(unit, port, in_reset));
        }
        SHR_IF_ERR_EXIT(imb_ilu_hrf_rx_segmentation_per_hrf_type_reset(unit, port, in_reset));
