    ...
    else if (failover_type == BCM_FAILOVER_TYPE_INGRESS_MC)
    {
        ...
        else
        {
            SHR_ERR_EXIT(_SHR_E_PARAM,
                         "Ingress MC-Pruning failover_id isn't supported on this device, use Egress Protection\n");
        }
    }
    else
    {
        ...
        {
            SHR_ERR_EXIT(_SHR_E_PARAM,
                         "Egress Protection failover_id isn't supported on this device, use Ingress MC-Pruning\n");
        }
    }
    ...
    bcm_failover_t * failover_id)
{
    ...
    supported_flags =
        BCM_FAILOVER_INGRESS | BCM_FAILOVER_FEC | BCM_FAILOVER_FEC_2ND_HIERARCHY |
    ...
    supported_flags |=
        ...
        BCM_FAILOVER_ENCAP : BCM_FAILOVER_INGRESS_MC;
