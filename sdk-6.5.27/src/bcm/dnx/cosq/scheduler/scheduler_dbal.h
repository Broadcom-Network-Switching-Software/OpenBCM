...
{
    /*
     * result type for sch_flow_credit_src_cos table 
     */
    dbal_result_type_t type;
    uint32 simple_cos;
    uint32 cl_weight;
...
/**
 * \brief configure LAG port 
 */
shr_error_e dnx_sch_dbal_lag_port_config_set(
    int unit,
    int core_id,
    int pp_dsp,
    int member,
...
/**
 * \brief clear the configuration of LAG port
 */
shr_error_e dnx_sch_dbal_lag_port_config_clear(
    int unit,
    int core_id,
    int pp_dsp);
/**
 ...
 */
shr_error_e dnx_sch_dbal_dummy_pp_dsp_set(
    int unit,
    int pp_dsp);
...
/**
 * \brief -  Enable \ disable EGQ flow control
 */
shr_error_e dnx_sch_fc_enablers_set(
    int unit,
    int core_id,
    int egq_device_fc,
    int egq_erp_fc,
...
/*
 * \brief - configure the CL,FQ flow order of an SE group
 */
shr_error_e dnx_sch_flow_quartet_order_set(
    int unit,
    int core_id,
    uint32 se_group,
 ...
 */
shr_error_e dnx_sch_dbal_virtual_flow_enable_set(
    int unit,
    int enable);
 ...
 */
shr_error_e dnx_sch_dbal_virtual_flow_enable_get(
    int unit,
    int *enable);
 ...
 */
shr_error_e dnx_sch_dbal_manual_fsm_generate(
    int unit,
    int core_id,
    int flow_id,
...
/**
 *\brief - Configure SCH power down
 */
shr_error_e dnx_sch_power_down_set(
    int unit,
    int power_down);

/**
 * \brief - Set low rate flow range configuration.
 *
 * \param [in] unit - unit ID
 * \param [in] core_id - core
 * \param [in] range_id - range to configure
 * \param [in] flow_min - start range value
 * \param [in] flow_max - end range value
 * \param [in] pattern - range bitmap pattern
 *
 * \return
 *   see shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_sch_dbal_low_rate_flow_range_set(
    int unit,
    int core_id,
    int range_id,
    int flow_min,
...
/**
 * \brief - Get low rate flow range configuration.
 *
 * \param [in] unit - unit ID
 * \param [in] core_id - core
 * \param [in] range_id - range to configure
 * \param [out] flow_min - start range value
 * \param [out] flow_max - end range value
 * \param [out] pattern - range bitmap pattern
 *
 * \return
 *   see shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_sch_dbal_low_rate_flow_range_get(
    int unit,
    int core_id,
    int range_id,
    int *flow_min,
