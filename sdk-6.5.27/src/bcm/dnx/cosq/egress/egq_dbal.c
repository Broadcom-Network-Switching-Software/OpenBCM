 ...
 */
shr_error_e
dnx_egq_dbal_egq_preemption_set(
    int unit,
    int egq_if,
    int core_id,
    uint32 enable)
{
    ...
    /** Setting value fields */
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_INTRLV_NOT_PKT_BOUND, INST_SINGLE, enable);
    /** Preforming the action */
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
...
/** see .h file */
shr_error_e
dnx_egq_dbal_use_single_txi_set(
    int unit,
    int egq_if,
    int core_id,
    uint32 enable)
{
    ...
    /** Taking a handle */
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_EGQ_TWO_TXI_IF_CONFIG, &entry_handle_id));
    /** Setting key fields */
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_EGQ_IF_WO_FLEXE, egq_if);
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CORE_ID, core_id);

    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_USE_SINGLE_TXI, INST_SINGLE, enable);
    /** Performing the action */
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
exit:
    DBAL_FUNC_FREE_VARS;
