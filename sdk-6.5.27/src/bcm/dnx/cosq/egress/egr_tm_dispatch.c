...
/** see header file */
shr_error_e
dnx_egr_tm_cosq_control_port_local_set(
    int unit,
    bcm_gport_t gport,
    ...
    int arg)
{
    ...
    switch (type)
    {
        case bcmCosqControlEgressAqmFlowId:
        {
            ...
            SHR_IF_ERR_EXIT(dnx_cosq_aqm_flow_profile_mapping_set(unit, gport, cosq, type, arg));
            break;
        }
        ...
        case bcmCosqControlEgressShaperEnable:
        {
            ...
            {
                SHR_IF_ERR_EXIT(dnx_cosq_egq_control_egress_port_scheduler_set(unit, gport, cosq, type, arg));
            }
            break;
        }
        default:
...
/** see header file */
shr_error_e
dnx_egr_tm_cosq_control_port_local_get(
    int unit,
    bcm_gport_t gport,
    bcm_cos_queue_t cosq,
    bcm_cosq_control_t type,
    int *arg)
{
    ...
    switch (type)
    {
        ...
        {
            /** case bcmCosqControlLatencyEgressAqmFlowId: */
            SHR_IF_ERR_EXIT(dnx_cosq_aqm_flow_profile_mapping_get(unit, gport, cosq, type, (uint32 *) arg));
            break;
        }
        case bcmCosqControlPacketLengthAdjust:
        case bcmCosqControlShaperPacketMode:
        ...
        case bcmCosqControlEgressShaperEnable:
        {
            ...
            {
                SHR_IF_ERR_EXIT(dnx_cosq_egq_control_egress_port_scheduler_get(unit, gport, cosq, type, arg));;
            }
            break;
        }
        default:
...
/** see header file */
shr_error_e
dnx_egr_tm_cosq_control_port_local_interface_set(
    int unit,
    bcm_gport_t gport,
    bcm_cos_queue_t cosq,
    bcm_cosq_control_t type,
    int arg)
{
    ...
    switch (type)
    {
        ...
        {
            {
                SHR_IF_ERR_EXIT(dnx_cosq_egq_control_egress_interface_set(unit, gport, cosq, type, arg));
            }
            break;
        }
        default:
...
/** see header file */
shr_error_e
dnx_egr_tm_cosq_control_port_local_interface_get(
    int unit,
    bcm_gport_t gport,
    bcm_cos_queue_t cosq,
    bcm_cosq_control_t type,
    int *arg)
{
    ...
    switch (type)
    {
        ...
        {
            {
                SHR_IF_ERR_EXIT(dnx_cosq_egq_control_egress_interface_get(unit, gport, cosq, type, arg));
            }
            break;
        }
        default:
...
/** see header file */
shr_error_e
dnx_egr_tm_cosq_control_port_tcg_set(
    int unit,
    bcm_gport_t gport,
    bcm_cos_queue_t cosq,
    bcm_cosq_control_t type,
    int arg)
{
    SHR_FUNC_INIT_VARS(unit);
    {
        SHR_IF_ERR_EXIT(dnx_cosq_egq_control_egress_port_tcg_set(unit, gport, cosq, type, arg));
    }
...
/** see header file */
shr_error_e
dnx_egr_tm_cosq_control_port_tcg_get(
    int unit,
    bcm_gport_t gport,
    bcm_cos_queue_t cosq,
    bcm_cosq_control_t type,
    int *arg)
{
    SHR_FUNC_INIT_VARS(unit);
    {
        SHR_IF_ERR_EXIT(dnx_cosq_egq_control_egress_port_tcg_get(unit, gport, cosq, type, arg));
    }
...
/** see header file */
shr_error_e
dnx_egr_tm_cosq_control_port_rcy_set(
    int unit,
    bcm_gport_t gport,
    bcm_cos_queue_t cosq,
    bcm_cosq_control_t type,
    ...
    int arg)
{
    ...
    switch (type)
    {
        case bcmCosqControlBandwidthBurstMax:
        {
            ...
            {
                SHR_IF_ERR_EXIT(dnx_egr_recycle_burst_set(unit, BCM_COSQ_GPORT_CORE_GET(gport), is_mirror, arg));
            }
            break;
        }
        default:
...
/** see header file */
shr_error_e
dnx_egr_tm_cosq_control_port_rcy_get(
    int unit,
    bcm_gport_t gport,
    bcm_cos_queue_t cosq,
    bcm_cosq_control_t type,
    ...
    int *arg)
{
    ...
    switch (type)
    {
        case bcmCosqControlBandwidthBurstMax:
        {
            ...
            {
                SHR_IF_ERR_EXIT(dnx_egr_recycle_burst_get
                                (unit, BCM_COSQ_GPORT_CORE_GET(gport), is_mirror, (uint32 *) arg));
            }
            break;
        }
        default:
    ...
    int weight)
{
    ...
    {
        SHR_ERR_EXIT(_SHR_E_UNAVAIL, "This Functionality is not supported for this device.");
    }
    ...
    bcm_cosq_queue_offset_t * offset_array)
{
    ...
    {
        SHR_IF_ERR_EXIT(dnx_cosq_egq_gport_egress_queue_map_set(unit, gport, count, key_array, offset_array));
    }
    ...
    bcm_cosq_queue_offset_t * offset_array)
{
    ...
    {
        SHR_IF_ERR_EXIT(dnx_cosq_egq_gport_egress_map_get(unit, gport, count, key_array, offset_array));
    }
...
/** see header file */
shr_error_e
dnx_egr_tm_cir_shaper_bandwidth_set(
    int unit,
    bcm_gport_t gport,
    bcm_cos_queue_t cosq,
    uint32 kbits_sec_min,
    ...
    uint32 flags)
{
    SHR_FUNC_INIT_VARS(unit);
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "Gport type not supported in this device");
    }
...
/** see header file */
shr_error_e
dnx_egr_tm_cir_shaper_bandwidth_get(
    int unit,
    bcm_gport_t gport,
    bcm_cos_queue_t cosq,
    uint32 *kbits_sec_min,
...
/** see header file */
shr_error_e
dnx_egr_tm_recycle_shaper_bandwidth_set(
    int unit,
    bcm_gport_t gport,
    uint32 is_mirror,
    uint32 kbits_sec_max,
    uint32 flags)
{
    ...
    {
        SHR_IF_ERR_EXIT(dnx_egr_queuing_recycle_bandwidth_set
                        (unit, BCM_COSQ_GPORT_CORE_GET(gport), is_mirror, kbits_sec_max));
    }
...
/** see header file */
shr_error_e
dnx_egr_tm_recycle_shaper_bandwidth_get(
    int unit,
    bcm_gport_t gport,
    uint32 is_mirror,
    uint32 *kbits_sec_max,
    uint32 *flags)
{
    ...
    {
        SHR_IF_ERR_EXIT(dnx_egr_queuing_recycle_bandwidth_get
                        (unit, BCM_COSQ_GPORT_CORE_GET(gport), is_mirror, kbits_sec_max));
    }
