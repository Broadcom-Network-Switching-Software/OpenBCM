    ...
    dnx_ingress_congestion_wred_hw_params_t * wred_hw_params)
{
    ...
    wred_hw_params->c1 = UTILEX_MIN(wred_hw_params->c1, max_val_c1);
    ...
    if (dnx_data_ingr_congestion.info.feature_get(unit, dnx_data_ingr_congestion_info_wred_c1_high_precision_supported))
    {
        ...
        else
        {
            ...
            wred_hw_params->c12 = UTILEX_MIN(wred_hw_params->c12, max_val_c1);
            ...
            else
            {
                ...
                wred_hw_params->c13 = UTILEX_MIN(wred_hw_params->c13, max_val_c1);
            }
        }
    }
