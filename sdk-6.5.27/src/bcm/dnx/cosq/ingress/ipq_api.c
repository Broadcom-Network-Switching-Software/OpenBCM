...
static shr_error_e
dnx_cosq_gport_ipq_queue_offset_mapping_set_verify(
    int unit,
    uint32 flags,
    bcm_gport_t gport,
    int count,
 ...
 */
shr_error_e
dnx_ipq_cosq_gport_queue_offset_mapping_set(
    int unit,
    uint32 flags,
    bcm_gport_t gport,
    int count,
    ...
    bcm_cosq_queue_offset_t * offset_array)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_gport_ipq_queue_offset_mapping_set_verify(unit, flags, gport, count,
 ...
 */
static shr_error_e
dnx_cosq_gport_ipq_queue_offset_mapping_get_verify(
    int unit,
    uint32 flags,
    bcm_gport_t gport,
    int count,
 ...
 */
shr_error_e
dnx_ipq_cosq_gport_queue_offset_mapping_get(
    int unit,
    uint32 flags,
    bcm_gport_t gport,
    int count,
    ...
    bcm_cosq_queue_offset_t * offset_array)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_gport_ipq_queue_offset_mapping_get_verify(unit, flags, gport, count,
                                                                              key_array, offset_array));
