    ...
    bcm_port_t port)
{
    ...
    if (!(((DNX_ALGO_PORT_TYPE_IS_NIF(unit, port_info, DNX_ALGO_PORT_TYPE_INCLUDE(L1, FLEXE, STIF)) &&
            (DNX_ALGO_PORT_TYPE_IS_ING_TM(unit, port_info) || (tdm_mode == DNX_ALGO_PORT_TDM_MODE_BYPASS)))
