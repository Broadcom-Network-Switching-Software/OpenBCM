...
/**
 * \brief - in case BCM_TRUNK_MEMBER_WITH_ID was provided,
 * verify validity of member_id :
 *      - it is used only with relevant PSCs
 *      - it is not allocated.
 *      - it is within valid range.
 *
 * \param [in] unit - unit number
 * \param [in] member - member provided by user
 * \param [in] psc - psc used by trunk
 ...
 *   * None
 */
shr_error_e dnx_trunk_member_with_id_verify(
    int unit,
 ...
 *   * None
 */
shr_error_e dnx_trunk_member_spa_with_id_verify(
    int unit,
    bcm_trunk_member_t * member,
    int pool,
    int group);
...
/**
 * \brief - Verify that the provided backup member can be fitted into the trunk.
 *
 * \param [in] unit - unit number
 * \param [in] trunk_id - trunk_id
 * \param [in] backup_member - backup member, but represented as a regular member for the sake of internal verification reusability
 *
 * \return
 *   shr_error_e
 *
 ...
 *   * None
 */
shr_error_e dnx_trunk_backup_member_verify(
    int unit,
    bcm_trunk_t trunk_id,
