    ...
    int unit)
{
    ...
    for (link = 0; link < nof_links; ++link)
    {
        ...
        if (BCM_PBMP_MEMBER(supported_fmacs, fmac))
        {
...
/**
 * \brief - Set various Fabric CGM thresholds.
 * 
 * \param [in] unit - Unit
 * \param [in] flags - Not used
 * \param [in] control_type - control_type
 * \param [in] control_id - control type index
 * \param [in] value - value to set for this control
 * \return int 
 */
int
...
/**
 * \brief - Get various Fabric CGM thresholds.
 * 
 * \param [in] unit - Unit
 * \param [in] flags - Not used
 * \param [in] control_type - control_type
 * \param [in] control_id - control type index
 * \param [out] value - value to get for this control
 * \return int 
 */
int
