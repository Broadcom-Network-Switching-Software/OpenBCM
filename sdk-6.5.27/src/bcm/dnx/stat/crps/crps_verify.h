...
/**
* \brief  
*   verification on API bcm_dnx_stat_counter_database_eviction_set parameters
* \par DIRECT INPUT:
*   \param [in] unit    -  Unit-ID
*   \param [in] flags   -
*   \param [in] database  -  this is the key -defined by database_id and core.
...
*   * None
*/
shr_error_e dnx_crps_mgmt_counter_database_eviction_set_verify(
    int unit,
    uint32 flags,
    bcm_stat_counter_database_t * database,
...
/**
* \brief
*   verification on API bcm_dnx_stat_counter_database_eviction_get parameters
* \par DIRECT INPUT:
*   \param [in] unit    -  Unit-ID
*   \param [in] flags   -
*   \param [in] database  -  this is the key -defined by database_id and core.
...
*   * None
*/
shr_error_e dnx_crps_mgmt_counter_database_eviction_get_verify(
    int unit,
    uint32 flags,
    bcm_stat_counter_database_t * database,
    bcm_stat_eviction_t * eviction);
