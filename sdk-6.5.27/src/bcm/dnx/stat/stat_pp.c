    ...
    bcm_stat_pp_metadata_info_t * metadata_info)
{
...

    {
        SHR_IF_ERR_EXIT(dnx_stat_pp_egress_fwd_code_to_dbal_convert(unit,
                                                                    ...
                                                                    metadata_info->address_type_flags,
                                                                    dbal_fwd_codes_a, &size));
    }
         ...
         (gport_hw_resources.outlif_dbal_result_type != DBAL_RESULT_TYPE_EEDB_MPLS_TUNNEL_ETPS_MPLS_PHP_STAT)))
    {
        ...
        else
        {
            ...
            SHR_IF_ERR_EXIT(dnx_lif_mngr_outlif_sw_info_get
                            (unit, gport_hw_resources.local_out_lif, &dbal_table_id, NULL, NULL, NULL, NULL,
                             &is_count_profile));

            is_counting_profile = is_count_profile;
        }
    ...
    int unit)
{
    ...
    /**egress metadata mapping select from fwd layer by default*/
    SHR_IF_ERR_EXIT(dnx_stat_pp_egress_l2_fwd_plus_one_metadata_enable_set(unit, 0));
