...
int
bcm_dnx_stat_counter_database_mapping_set(
    int unit,
    uint32 flags,
...
int
bcm_dnx_stat_counter_database_mapping_get(
    int unit,
    uint32 flags,
    bcm_stat_counter_database_t * database,
    bcm_stat_database_mapping_t * map_config)
...
int
bcm_dnx_stat_counter_generic_control_set(
    int unit,
    uint32 flags,
    int Key,
...
int
bcm_dnx_stat_counter_generic_control_get(
    int unit,
    uint32 flags,
    int Key,
    bcm_stat_counter_generic_control_t control,
