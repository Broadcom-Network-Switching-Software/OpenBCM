    ...
    int sflow_encap_id)
{
    ...
    if (dnx_data_instru.sflow.feature_get(unit, dnx_data_instru_sflow_hard_logic_supported))
    {
        ...
        if ((hw_res.outlif_dbal_table_id != DBAL_TABLE_EEDB_SFLOW)
            ...
            || ((hw_res.logical_phase != DNX_ALGO_LOCAL_OUTLIF_LOGICAL_PHASE_1) &&
                (hw_res.logical_phase != DNX_ALGO_LOCAL_OUTLIF_LOGICAL_PHASE_4)))
        {
    ...
    bcm_instru_sflow_encap_info_t * sflow_encap_info)
{
    ...
    if (sflow_encap_info->flags & (~(supported_flags)))
    {
        SHR_ERR_EXIT(_SHR_E_PARAM,
                     "Error! Unsupported flag: flags = 0x%08x. supported_flags = 0x%08x\n",
                     sflow_encap_info->flags, supported_flags);
    }
    ...
    if (_SHR_IS_FLAG_SET(sflow_encap_info->flags, BCM_INSTRU_SFLOW_ENCAP_EXTENDED_INITIATOR))
    {
        uint32 ext_init_supported_flags = BCM_INSTRU_SFLOW_ENCAP_WITH_ID | BCM_INSTRU_SFLOW_ENCAP_REPLACE |
            BCM_INSTRU_SFLOW_ENCAP_EXTENDED_INITIATOR;

        if (sflow_encap_info->flags & (~(ext_init_supported_flags)))
        {
            SHR_ERR_EXIT(_SHR_E_PARAM,
                         "Error! Unsupported flag: flags = 0x%08x. Supported flags for EXTENDED_INITIATOR = 0x%08x \n",
                         sflow_encap_info->flags, ext_init_supported_flags);
        }
...
static shr_error_e
dnx_instru_sflow_encap_traverse_verify(
    int unit,
    ...
    bcm_instru_sflow_sample_interface_info_t * sample_interface_info)
{
    ...
    else
    {
        ...
        if (dnx_data_instru.sflow.feature_get(unit, dnx_data_instru_sflow_hard_logic_supported))
        {
            ...
            {
                SHR_ERR_EXIT(_SHR_E_PARAM,
                             "Error! Unsupported output port = 0x%08x! is not a system port! flags = 0x%08x.\n",
                             sample_interface_info->port, sample_interface_info->flags);
            }
        }
        else
...
static shr_error_e
dnx_instru_sflow_encap_extended_dst_traverse_verify(
    int unit,
    ...
    bcm_instru_sflow_encap_extended_src_info_t * sflow_encap_ext_src_info)
{
    ...
    if (!dnx_data_instru.sflow.feature_get(unit, dnx_data_instru_sflow_hard_logic_supported))
    {
        if (sflow_encap_ext_src_info->sflow_encap_extended_id != 0)
        {
            SHR_ERR_EXIT(_SHR_E_PARAM,
                         "Error! sflow_encap_extended_id = 0x%08x is only relevant for sFlow hard-logic! Please set it to 0!\n",
                         sflow_encap_ext_src_info->sflow_encap_extended_id);
        }
    }
...
static shr_error_e
dnx_instru_sflow_encap_extended_src_traverse_verify(
    int unit,
    ...
    int *delete_old_destination_profile)
{
    ...
    *delete_old_destination_profile = FALSE;
    ...
    if (_SHR_IS_FLAG_SET(sflow_encap_info->flags, BCM_INSTRU_SFLOW_ENCAP_REPLACE))
    {
        ...
        SHR_IF_ERR_EXIT(instru.sflow_info.sflow_destination_profile.exchange(unit, 0, 1, &destination,
...
static shr_error_e
dnx_instru_sflow_encap_data_get(
    int unit,
    int local_lif,
    uint32 result_type,
    bcm_instru_sflow_encap_info_t * sflow_encap_info)
    ...
    bcm_instru_sflow_encap_info_t * sflow_encap_info)
{
    ...
    SHR_IF_ERR_EXIT(dnx_instru_sflow_encap_data_get(unit, local_lif, result_type, sflow_encap_info));
...
static shr_error_e
dnx_instru_sflow_encap_traverse(
    int unit,
    bcm_instru_sflow_encap_traverse_cb cb,
    void *user_data)
{
    ...
    while (!is_end)
    {
        ...
        SHR_IF_ERR_EXIT(dnx_instru_sflow_encap_data_get(unit, local_out_lif, result_type, &sflow_encap_info));
    ...
    bcm_instru_sflow_encap_info_t * sflow_encap_info)
{
    ...
    SHR_IF_ERR_EXIT(dnx_instru_sflow_encap_create(unit, sflow_encap_info));
    ...
    bcm_instru_sflow_encap_info_t * sflow_encap_info)
{
    ...
    SHR_IF_ERR_EXIT(dnx_instru_sflow_encap_delete(unit, sflow_encap_info));
    ...
    bcm_instru_sflow_encap_info_t * sflow_encap_info)
{
    ...
    SHR_IF_ERR_EXIT(dnx_instru_sflow_encap_get(unit, sflow_encap_info));
    ...
    void *user_data)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_instru_sflow_encap_traverse_verify(unit, cb, user_data));

    SHR_IF_ERR_EXIT(dnx_instru_sflow_encap_traverse(unit, cb, user_data));
...
static int
dnx_instru_sflow_encap_extended_dst_entry_create(
    int unit,
    bcm_instru_sflow_encap_extended_dst_info_t * sflow_encap_ext_dst_info)
{
...
static int
dnx_instru_sflow_encap_extended_dst_entry_replace(
    int unit,
    bcm_instru_sflow_encap_extended_dst_info_t * sflow_encap_ext_dst_info)
{
    int current_local_outlif, next_local_outlif;
    ...
    bcm_instru_sflow_encap_extended_dst_info_t * sflow_encap_ext_dst_info)
{
    ...
    if (_SHR_IS_FLAG_SET(sflow_encap_ext_dst_info->flags, BCM_INSTRU_SFLOW_ENCAP_REPLACE))
    {
        SHR_IF_ERR_EXIT(dnx_instru_sflow_encap_extended_dst_entry_replace(unit, sflow_encap_ext_dst_info));
    }
    else
    {
        SHR_IF_ERR_EXIT(dnx_instru_sflow_encap_extended_dst_entry_create(unit, sflow_encap_ext_dst_info));
    }
...
static int
dnx_instru_sflow_encap_extended_dst_delete(
    int unit,
    bcm_instru_sflow_encap_extended_dst_info_t * sflow_encap_ext_dst_info)
{
    int current_local_outlif, next_local_outlif;
...
static int
dnx_instru_sflow_encap_extended_dst_get(
    int unit,
    bcm_instru_sflow_encap_extended_dst_info_t * sflow_encap_ext_dst_info)
{
    int current_local_outlif, next_local_outlif;
...
static int
dnx_instru_sflow_encap_extended_dst_traverse(
    int unit,
    bcm_instru_sflow_encap_extended_dst_cb cb,
    void *user_data)
{
    ...
    bcm_instru_sflow_encap_extended_dst_info_t * sflow_encap_ext_dst_info)
{
    ...
    SHR_IF_ERR_EXIT(dnx_instru_sflow_encap_extended_dst_delete(unit, sflow_encap_ext_dst_info));
    ...
    bcm_instru_sflow_encap_extended_dst_info_t * sflow_encap_ext_dst_info)
{
    ...
    SHR_IF_ERR_EXIT(dnx_instru_sflow_encap_extended_dst_get(unit, sflow_encap_ext_dst_info));
    ...
    void *user_data)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_instru_sflow_encap_extended_dst_traverse_verify(unit, cb, user_data));

    SHR_IF_ERR_EXIT(dnx_instru_sflow_encap_extended_dst_traverse(unit, cb, user_data));
...
static int
dnx_instru_sflow_encap_extended_src_create(
    int unit,
    bcm_instru_sflow_encap_extended_src_info_t * sflow_encap_ext_src_info)
{
    int local_outlif;
...
static int
dnx_instru_sflow_encap_extended_src_delete(
    int unit,
    bcm_instru_sflow_encap_extended_src_info_t * sflow_encap_ext_src_info)
{
    int current_local_outlif;
...
static int
dnx_instru_sflow_encap_extended_src_get(
    int unit,
    bcm_instru_sflow_encap_extended_src_info_t * sflow_encap_ext_src_info)
{
    int current_local_outlif;
...
static int
dnx_instru_sflow_encap_extended_src_traverse(
    int unit,
    bcm_instru_sflow_encap_extended_src_cb cb,
    void *user_data)
{
    ...
    bcm_instru_sflow_encap_extended_src_info_t * sflow_encap_ext_src_info)
{
    ...
    SHR_IF_ERR_EXIT(dnx_instru_sflow_encap_extended_src_create(unit, sflow_encap_ext_src_info));
    ...
    bcm_instru_sflow_encap_extended_src_info_t * sflow_encap_ext_src_info)
{
    ...
    SHR_IF_ERR_EXIT(dnx_instru_sflow_encap_extended_src_delete(unit, sflow_encap_ext_src_info));
    ...
    bcm_instru_sflow_encap_extended_src_info_t * sflow_encap_ext_src_info)
{
    ...
    SHR_IF_ERR_EXIT(dnx_instru_sflow_encap_extended_src_get(unit, sflow_encap_ext_src_info));
    ...
    void *user_data)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_instru_sflow_encap_extended_src_traverse_verify(unit, cb, user_data));

    SHR_IF_ERR_EXIT(dnx_instru_sflow_encap_extended_src_traverse(unit, cb, user_data));
...
static shr_error_e
dnx_instru_sflow_sample_interface_add(
    int unit,
    bcm_instru_sflow_sample_interface_info_t * sample_interface_info)
{
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
dnx_instru_sflow_sample_interface_remove(
    int unit,
    bcm_instru_sflow_sample_interface_info_t * sample_interface_info)
{
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
dnx_instru_sflow_sample_interface_get(
    int unit,
    bcm_instru_sflow_sample_interface_info_t * sample_interface_info)
{
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
dnx_instru_sflow_sample_interface_traverse(
    int unit,
    bcm_instru_sflow_sample_interface_traverse_info_t * sample_interface_traverse_info,
    bcm_instru_sflow_sample_traverse_cb cb,
    void *user_data)
    ...
    bcm_instru_sflow_sample_interface_info_t * sample_interface_info)
{
    ...
    SHR_IF_ERR_EXIT(dnx_instru_sflow_sample_interface_add(unit, sample_interface_info));
    ...
    bcm_instru_sflow_sample_interface_info_t * sample_interface_info)
{
    ...
    SHR_IF_ERR_EXIT(dnx_instru_sflow_sample_interface_remove(unit, sample_interface_info));
    ...
    bcm_instru_sflow_sample_interface_info_t * sample_interface_info)
{
    ...
    SHR_IF_ERR_EXIT(dnx_instru_sflow_sample_interface_get(unit, sample_interface_info));
    ...
    void *user_data)
{
    ...
    SHR_IF_ERR_EXIT(dnx_instru_sflow_sample_interface_traverse(unit, sample_interface_traverse_info, cb, user_data));
