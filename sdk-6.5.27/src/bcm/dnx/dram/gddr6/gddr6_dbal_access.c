    ...
    int channel)
{
    ...
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_DRAM_INDEX, dram_index);
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CHANNEL, channel);
    SHR_IF_ERR_EXIT(dnxcmn_polling(unit, 10000000, 1000000, entry_handle_id, DBAL_FIELD_BIST_GO, 0));
    ...
    switch (mr_index)
    {
        case 0:
        {
            ...
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_0, DBAL_FIELD_WRITE_LATENCY, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = (dnx_data_dram.general_info.read_latency_get(unit) - 5) % 0x10;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_0, DBAL_FIELD_READ_LATENCY, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_0, DBAL_FIELD_TM, &field_in_struct_val, &field_val));
            field_in_struct_val = (dnx_data_dram.gddr6.write_recovery_get(unit) - 4) % 0x10;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_0, DBAL_FIELD_WRITE_RECOVERY, &field_in_struct_val,
                             &field_val));
            break;
        }
        ...
        case 1:
        {
            ...
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_1, DBAL_FIELD_DRIVER_STRENGTH, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = 1;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_1, DBAL_FIELD_DATA_TERMINATION, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_1, DBAL_FIELD_PLL_RANGE, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_1, DBAL_FIELD_CAL_UPD, &field_in_struct_val,
                             &field_val));
            ...
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_1, DBAL_FIELD_PLL_DLL, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = !dnx_data_dram.general_info.dbi_read_get(unit);
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_1, DBAL_FIELD_RDBI, &field_in_struct_val, &field_val));
            field_in_struct_val = !dnx_data_dram.general_info.dbi_write_get(unit);
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_1, DBAL_FIELD_WDBI, &field_in_struct_val, &field_val));
            field_in_struct_val = !dnx_data_dram.gddr6.cabi_get(unit);
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_1, DBAL_FIELD_CABI, &field_in_struct_val, &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_1, DBAL_FIELD_PLL_RESET, &field_in_struct_val,
                             &field_val));
            break;
        }
        ...
        case 2:
        {
            ...
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_2, DBAL_FIELD_OCD_PULLDOWN_DO, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_2, DBAL_FIELD_OCD_PULLUP_DO, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_2, DBAL_FIELD_SELF_REFRESH, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_2, DBAL_FIELD_EDC_MODE, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_2, DBAL_FIELD_RDQS, &field_in_struct_val, &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_2, DBAL_FIELD_CADT_SRF, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_2, DBAL_FIELD_EDC_HR, &field_in_struct_val,
                             &field_val));
            break;
        }
        ...
        case 3:
        {
            ...
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_3, DBAL_FIELD_DA_WCK_TERMINATION_OFF,
                             &field_in_struct_val, &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_3, DBAL_FIELD_CA_TERMINATION_OFF, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_3, DBAL_FIELD_DRAM_INFO, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_3, DBAL_FIELD_WR_SCALING, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_3, DBAL_FIELD_BANK_GROUP, &field_in_struct_val,
                             &field_val));
            break;
        }
        ...
        case 4:
        {
            ...
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_4, DBAL_FIELD_EDC_HOLD_PATTERN, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = (dnx_data_dram.general_info.crc_write_latency_get(unit) + 1) % 8;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_4, DBAL_FIELD_CRCWL, &field_in_struct_val, &field_val));
            field_in_struct_val = dnx_data_dram.general_info.crc_read_latency_get(unit) % 4;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_4, DBAL_FIELD_CRCRL, &field_in_struct_val, &field_val));
            field_in_struct_val = !dnx_data_dram.general_info.crc_read_get(unit);
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_4, DBAL_FIELD_RD_CRC, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = !dnx_data_dram.general_info.crc_write_get(unit);
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_4, DBAL_FIELD_WR_CRC, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_4, DBAL_FIELD_EDC_INV, &field_in_struct_val,
                             &field_val));
            break;
        }
        ...
        case 5:
        {
            ...
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_5, DBAL_FIELD_LP1, &field_in_struct_val, &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_5, DBAL_FIELD_LP2, &field_in_struct_val, &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_5, DBAL_FIELD_LP3, &field_in_struct_val, &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_5, DBAL_FIELD_PLL_BAND_WIDTH, &field_in_struct_val,
                             &field_val));
            if (dram_vendor_info.gddr6_info.manufacturer_vendor_code == SHMOO_G6PHY16_VENDOR_MICRON)
            {
            ...
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_5, DBAL_FIELD_RAS, &field_in_struct_val, &field_val));
            break;
        }
        ...
        case 6:
        {
            ...
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_6, DBAL_FIELD_VREFD_LEVEL, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_6, DBAL_FIELD_PIN_SA, &field_in_struct_val,
                             &field_val));
            break;
        }
        ...
        case 7:
        {
            ...
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_7, DBAL_FIELD_WCK_AP, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_7, DBAL_FIELD_HIBERNATE, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_7, DBAL_FIELD_PLL_DELC, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_7, DBAL_FIELD_LF_MODE, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_7, DBAL_FIELD_AUTO_SYNC, &field_in_struct_val,
                             &field_val));

            field_in_struct_val =
                (dram_vendor_info.gddr6_info.manufacturer_vendor_code == SHMOO_G6PHY16_VENDOR_SAMSUNG) ? 1 : 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_7, DBAL_FIELD_DQ_PREA, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_7, DBAL_FIELD_HALF_VREFC, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_7, DBAL_FIELD_HALF_VREFD, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_7, DBAL_FIELD_VDD_RANGE, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_7, DBAL_FIELD_DCC, &field_in_struct_val, &field_val));
            break;
        }
        ...
        case 8:
        {
            ...
            field_in_struct_val = 1;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_8, DBAL_FIELD_CAL_TERM, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = 1;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_8, DBAL_FIELD_CAH_TERM, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_8, DBAL_FIELD_CA_TO, &field_in_struct_val, &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_8, DBAL_FIELD_EDC_HIZ, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_8, DBAL_FIELD_CK_AC, &field_in_struct_val, &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_8, DBAL_FIELD_REFPB, &field_in_struct_val, &field_val));
            field_in_struct_val = (dnx_data_dram.general_info.read_latency_get(unit) - 5) / 0x10;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_8, DBAL_FIELD_RLEHF, &field_in_struct_val, &field_val));
            field_in_struct_val = (dnx_data_dram.gddr6.write_recovery_get(unit) - 4) / 0x10;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_8, DBAL_FIELD_WREHF, &field_in_struct_val, &field_val));
            field_in_struct_val = dnx_data_dram.gddr6.ck_termination_mr_conf_val_get(unit);
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_8, DBAL_FIELD_CK_TERM, &field_in_struct_val,
                             &field_val));
            break;
        }
        ...
        case 9:
        {
            ...
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_9, DBAL_FIELD_DFE, &field_in_struct_val, &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_9, DBAL_FIELD_RFU, &field_in_struct_val, &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_9, DBAL_FIELD_PIN_SUB_ADDR, &field_in_struct_val,
                             &field_val));
            break;
        }
        ...
        case 10:
        {
            ...
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_10, DBAL_FIELD_VREFC_OFF, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_10, DBAL_FIELD_WCK_INV_BYTE_0, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_10, DBAL_FIELD_WCK_INV_BYTE_1, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_10, DBAL_FIELD_WCK2CK, &field_in_struct_val,
                             &field_val));
            if ((dram_vendor_info.gddr6_info.manufacturer_vendor_code == SHMOO_G6PHY16_VENDOR_MICRON)
                && (dnx_data_dram.general_info.frequency_get(unit) > 875))
            {
            ...
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_10, DBAL_FIELD_WCK_RATIO, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = 1;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_10, DBAL_FIELD_WCK_TERM, &field_in_struct_val,
                             &field_val));
            break;
        }
        ...
        case 11:
        {
            ...
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_11, DBAL_FIELD_PASR_2_BANK_MASK, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_11, DBAL_FIELD_PASR_ROW_SEGMENG_MASK,
                             &field_in_struct_val, &field_val));
            break;
        }
        ...
        case 12:
        {
            ...
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_12, DBAL_FIELD_VDDQ_OFF, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_12, DBAL_FIELD_P2BR_ADDR, &field_in_struct_val,
                             &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_12, DBAL_FIELD_PRBS, &field_in_struct_val, &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_12, DBAL_FIELD_RFU, &field_in_struct_val, &field_val));
            break;
        }
        ...
        case 13:
        {
            ...
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_13, DBAL_FIELD_RESERVED, &field_in_struct_val,
                             &field_val));
            break;
        }
        ...
        case 14:
        {
            ...
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_14, DBAL_FIELD_RESERVED, &field_in_struct_val,
                             &field_val));
            break;
        }
        ...
        case 15:
        {
            ...
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_15, DBAL_FIELD_MREA, &field_in_struct_val, &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_15, DBAL_FIELD_MREB, &field_in_struct_val, &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_15, DBAL_FIELD_CADT, &field_in_struct_val, &field_val));
            field_in_struct_val = 0;
            SHR_IF_ERR_EXIT(dbal_fields_field_type_struct_field_encode
                            (unit, DBAL_FIELD_TYPE_DEF_GDDR6_MR_15, DBAL_FIELD_RESERVED, &field_in_struct_val,
                             &field_val));
            break;
        }
