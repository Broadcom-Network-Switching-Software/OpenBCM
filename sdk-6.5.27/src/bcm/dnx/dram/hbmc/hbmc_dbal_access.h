...
shr_error_e dnx_hbmc_dbal_access_parity_errors_get(
    int unit,
    int hbm_index,
    int channel,
    hbmc_parity_err_cnt_t * error_counters);

shr_error_e dnx_hbmc_dbal_access_ecc_errors_get(
    int unit,
    int hbm_index,
    int channel,
...
shr_error_e dnx_hbmc_dbal_access_phy_reset_set(
    int unit,
    int hbm_index,
    uint32 value);
...
shr_error_e dnx_hbmc_dbal_access_ecc_enable_get(
    int unit,
    int hbm_index,
    int channel,
    uint32 *is_enabled);
...
shr_error_e dnx_hbmc_dbal_access_mr_get_all(
    int unit,
    uint32 dram_bitmap[],
    dnx_hbmc_mrs_values_t * mr_values_p);

shr_error_e dnx_hbmc_dbal_access_mr_set_all(
    int unit,
    uint32 dram_bitmap[],
    dnx_hbmc_mrs_values_t * mr_values_p);
...
shr_error_e dnx_hbmc_dbal_access_sbus_master_execute_delay_set(
    int unit,
    int hbm_index,
    uint32 delay);

shr_error_e dnx_hbmc_dbal_access_power_down_enable_set(
    int unit,
    uint32 enable);
