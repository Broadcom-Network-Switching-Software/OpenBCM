...
shr_error_e
dnx_hbmc_dbal_access_ecc_errors_get(
    int unit,
    int hbm_index,
    int channel,
    hbmc_ecc_err_cnt_t * error_counters)
{
    ...
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_HBC_ECC_ERR_COUNTERS, &entry_handle_id));
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_HBMC_INDEX, hbm_index);
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CHANNEL, channel);
    dbal_value_field_arr32_request(unit, entry_handle_id, DBAL_FIELD_CORRECTED_ERR_COUNT_LOWER_CHANNEL, INST_SINGLE,
                                   error_counters->corrected_err_cnt_lower_channel);
    dbal_value_field_arr32_request(unit, entry_handle_id, DBAL_FIELD_CORRECTED_ERR_COUNT_UPPER_CHANNEL, INST_SINGLE,
                                   error_counters->corrected_err_cnt_upper_channel);
    dbal_value_field_arr32_request(unit, entry_handle_id, DBAL_FIELD_DETECTED_ERR_COUNT_LOWER_CHANNEL, INST_SINGLE,
                                   error_counters->detected_err_cnt_lower_channel);
    dbal_value_field_arr32_request(unit, entry_handle_id, DBAL_FIELD_DETECTED_ERR_COUNT_UPPER_CHANNEL, INST_SINGLE,
                                   error_counters->detected_err_cnt_upper_channel);
    SHR_IF_ERR_EXIT(dbal_entry_get(unit, entry_handle_id, DBAL_COMMIT));
...
shr_error_e
dnx_hbmc_dbal_access_ecc_enable_get(
    int unit,
    int hbm_index,
    int channel,
    uint32 *is_enabled)
{
    ...
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_HBMC_INDEX, hbm_index);
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CHANNEL, channel);
    dbal_value_field32_request(unit, entry_handle_id, DBAL_FIELD_HBM_ECC, INST_SINGLE, is_enabled);
    SHR_IF_ERR_EXIT(dbal_entry_get(unit, entry_handle_id, DBAL_COMMIT));
    ...
    uint32 entry_handle_id)
{
    ...
    {
        uint32 default_val = dnx_data_dram.general_info.mr_defaults_get(unit, mr_index)->value;

        dbal_entry_value_field32_set(unit, entry_handle_id, dnx_hbmc_mr_index_to_dbal_field(mr_index), INST_SINGLE,
                                     default_val);
    }

    field_val[0] = dnx_data_dram.general_info.mr_defaults_get(unit, 0)->value;
    ...
    field_val[0] = dnx_data_dram.general_info.mr_defaults_get(unit, 2)->value;
    ...
    field_val[0] = dnx_data_dram.general_info.mr_defaults_get(unit, 3)->value;
    ...
    field_val[0] = dnx_data_dram.general_info.mr_defaults_get(unit, 4)->value;
    ...
    field_val[0] = dnx_data_dram.general_info.mr_defaults_get(unit, 6)->value;
...
shr_error_e
dnx_hbmc_dbal_access_sbus_master_execute_delay_set(
    int unit,
    int hbm_index,
    uint32 delay)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FUNC_INIT_VARS(unit);
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_HBMC_PHY_SBUS_MASTER_MANUAL_ACCESS, &entry_handle_id));

    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_HBMC_INDEX, hbm_index);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_HBMC_PHY_SBUS_EXECUTE_DELAY, INST_SINGLE, delay);
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
...
shr_error_e
dnx_hbmc_dbal_access_power_down_enable_set(
    int unit,
    uint32 enable)
{
    uint32 entry_handle_id;
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FUNC_INIT_VARS(unit);
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_HBM_BLOCKS_POWER_DOWN, &entry_handle_id));
