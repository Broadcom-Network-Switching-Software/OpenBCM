    ...
    dnx_vlan_range_info_t * vlan_range)
{
    ...
    if (is_outer)
    {
        ...
        SHR_IF_ERR_EXIT(vlan_db.vlan_range_outer_profile.exchange(unit, 0, 1, &template,
    ...
    else
    {
        ...
        SHR_IF_ERR_EXIT(dnx_vlan_range_template_update(unit, vlan_range, &template));
        SHR_IF_ERR_EXIT(vlan_db.vlan_range_inner_profile.exchange(unit, 0, 1, &template,
                                                                  old_vlan_range_profile, NULL, &new_vlan_range_profile,
                                                                  &is_first, &is_last));
    }
    /*
    ...
    bcm_vlan_action_set_t * action)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_vlan_translate_action_range_add_verify
    ...
    bcm_vlan_t inner_vlan_high)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DNX_ERR_RECOVERY_NOT_NEEDED(unit);
    SHR_INVOKE_VERIFY_DNXC(dnx_vlan_translate_action_range_delete_verify
    ...
    bcm_vlan_action_set_t * action)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_vlan_translate_action_range_get_verify
