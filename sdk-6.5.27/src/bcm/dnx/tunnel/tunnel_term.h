...
#define DNX_TUNNEL_TERM_IS_IPV4_FOR_NAT(_info) (_info->flags & BCM_TUNNEL_TERM_TUNNEL_DST_NAT)
#define DNX_TUNNEL_TERM_IS_IPV4_TCAM(_info) (!DNX_TUNNEL_TERM_IS_IPV4_P2P(_info) && !DNX_TUNNEL_TERM_IS_IPV4_MP(_info) && !DNX_TUNNEL_TERM_IS_IPV4_FOR_NAT(_info))
...
shr_error_e dnx_tunnel_ipvx_over_mpls_parsing_predefined_entries_add(
    int unit);

shr_error_e dnx_tunnel_ipvx_over_mpls_parsing_clear(
    int unit);
