...
typedef enum
{
    ...
    INGRESS_QOS_MAP_TYPE_RCH_SRV6_USP_PSP,      /* QOS mapping according to SRV6 RCH */
    INGRESS_QOS_MAP_TYPE_GTP,
    INGRESS_QOS_MAP_TYPE_BIER,  /* QOS mapping according to BIER */
...
const dbal_enum_value_field_ingress_qos_map_index_e dnx_map_type_to_index[INGRESS_QOS_MAP_TYPE_VALUE_NOF] = {
    ...
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_INDEX_L2_SECOND_TAG,   /**INGRESS_QOS_MAP_TYPE_ETH_DOUBLE_TAG_USE_INNER          */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_INDEX_L2_FIRST_TAG,   /**INGRESS_QOS_MAP_TYPE_ETH_DOUBLE_TAG_USE_OUTER          */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_INDEX_L2_FIRST_TAG,   /**INGRESS_QOS_MAP_TYPE_ETH_ONE_TAG         */
    ...
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_INDEX_L2_FIRST_TAG,   /**INGRESS_QOS_MAP_TYPE_PWE_TAGGED_OUTER_TAG      */
    ...
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_INDEX_RCH,          /**INGRESS_QOS_MAP_TYPE_RCH_SRV6_USP_PSP        */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_INDEX_GTP,          /**INGRESS_QOS_MAP_TYPE_GTP              */
    DBAL_ENUM_FVAL_INGRESS_QOS_MAP_INDEX_MPLS,         /**INGRESS_QOS_MAP_TYPE_BIER             */
...
typedef enum
{
    ...
    QOS_FFC_0_PHB_RCH_SRV6_USP_PSP_VAL,
    QOS_FFC_1_PHB_RCH_SRV6_USP_PSP_VAL,
    QOS_FFC_0_REM_RCH_SRV6_USP_PSP_VAL,
    QOS_FFC_1_REM_RCH_SRV6_USP_PSP_VAL,
    QOS_FFC_0_GTP_QFI_VAL,
    QOS_FFC_1_GTP_QFI_VAL,
    QOS_FFC_0_PHB_S121_RCH_VAL,
    QOS_FFC_1_PHB_S121_RCH_VAL,
    QOS_FFC_0_REM_S121_RCH_VAL,
    QOS_FFC_1_REM_S121_RCH_VAL,
    QOS_FFC_0_TTL_S121_RCH_VAL,
    QOS_FFC_1_TTL_S121_RCH_VAL,
...
typedef enum
{
    QOS_FWD_TYPE_DEFAULT = 0,
    QOS_FWD_TYPE_IPV4,
    QOS_FWD_TYPE_IPV6,
    QOS_FWD_TYPE_MPLS,
    QOS_FWD_TYPE_VALUE_NOF
} qos_fwd_type_value_e;

CONST qos_ffc_t fwd_ttl_ffc_table[QOS_FFC_TYPE_VALUE_NOF] = {
    /**********************************************************************/
    /**  opcode  *  index  *  field_offset  *  field_size  *  key_offset  */
    /**********************************************************************/
        /** QOS_FWD_TYPE_DEFAULT*/
    {0, 0, 0, 0, 0},
        /** QOS_FWD_TYPE_IPV4*/
    {0, 0, (144 * 8 - 72), 7, 0},
        /** QOS_FWD_TYPE_IPV6*/
...
#define FWD_TTL_FFC_VALUE(ffc_entry) \
    ((ffc_entry.opcode << 19) | (ffc_entry.index << 16) | (ffc_entry.field_offset << 6) \
    | (ffc_entry.field_size << 3) | (ffc_entry.key_offset))
...
/**
 * \brief GTP-U qualifier
 *  For GTP layer qualifier, only do QOS when packet has extension header, 
 *  the first extension header must be  'PDU Session Container', which includes QFI
 */
#define QOS_GTPU_QUAL         0x3b9 /** look at extension header exit, and first extension header parsing OK */
#define QOS_GTPU_QUAL_MASK    0x3b9 /** look at extension header exit, and first extension header parsing OK */
...
{/********************************************************************************************************************************
  ...
  */
  ...
  {/** INGRESS_QOS_MAP_TYPE =  INGRESS_QOS_MAP_TYPE_RCH_SRV6_USP_PSP */
   15,
   DBAL_ENUM_FVAL_LAYER_TYPES_SRV6_RCH_USP_PSP_AND_PSP_EXT , DBAL_ENUM_FVAL_LAYER_TYPES_INITIALIZATION, QOS_NO_QUAL, QOS_NO_QUAL         , DBAL_ENUM_FVAL_QOS_CS_PROFILE_DEFAULT ,
   QOS_LAYER_TYPE_MASK           , QOS_NO_LAYER_TYPE_MASK           , QOS_NO_QUAL_MASK   , QOS_NO_QUAL_MASK    , QOS_NO_CS_PROFILE_MASK   ,
   {QOS_FFC_0_PHB_RCH_SRV6_USP_PSP_VAL        , QOS_FFC_1_PHB_RCH_SRV6_USP_PSP_VAL}       , DBAL_ENUM_FVAL_QOS_RESOLUTION_MODE_MAPPED    , QOS_INT_MAP_KEY_SIZE, TRUE},
  {/** INGRESS_QOS_MAP_TYPE =  INGRESS_QOS_MAP_TYPE_GTP */
   16,
   DBAL_ENUM_FVAL_LAYER_TYPES_GTP , DBAL_ENUM_FVAL_LAYER_TYPES_INITIALIZATION, QOS_GTPU_QUAL, QOS_NO_QUAL         , DBAL_ENUM_FVAL_QOS_CS_PROFILE_DEFAULT ,
   QOS_LAYER_TYPE_MASK           , QOS_NO_LAYER_TYPE_MASK           , QOS_GTPU_QUAL_MASK   , QOS_NO_QUAL_MASK    , QOS_NO_CS_PROFILE_MASK   ,
   {QOS_FFC_0_GTP_QFI_VAL        , QOS_FFC_1_GTP_QFI_VAL}       , DBAL_ENUM_FVAL_QOS_RESOLUTION_MODE_MAPPED    , QOS_INT_MAP_KEY_SIZE, TRUE},

  {/** INGRESS_QOS_MAP_TYPE =  INGRESS_QOS_MAP_TYPE_BIER */
   17,
   DBAL_ENUM_FVAL_LAYER_TYPES_BIER_NON_MPLS, DBAL_ENUM_FVAL_LAYER_TYPES_INITIALIZATION, QOS_NO_QUAL         , QOS_NO_QUAL         , DBAL_ENUM_FVAL_QOS_CS_PROFILE_DEFAULT,
   QOS_LAYER_TYPE_MASK           , QOS_NO_LAYER_TYPE_MASK           , QOS_NO_QUAL_MASK    , QOS_NO_QUAL_MASK    , QOS_NO_CS_PROFILE_MASK   ,
   {QOS_FFC_0_MPLS_EXP_VAL        , QOS_FFC_1_MPLS_EXP_VAL}          , DBAL_ENUM_FVAL_QOS_RESOLUTION_MODE_MAPPED    , QOS_INT_MAP_KEY_SIZE, TRUE},
  ...
  */
  ...
  {/** INGRESS_QOS_MAP_TYPE =  INGRESS_QOS_MAP_TYPE_RCH_SRV6_USP_PSP */
   15,
    DBAL_ENUM_FVAL_LAYER_TYPES_SRV6_RCH_USP_PSP_AND_PSP_EXT , DBAL_ENUM_FVAL_LAYER_TYPES_INITIALIZATION, QOS_NO_QUAL, QOS_NO_QUAL         , DBAL_ENUM_FVAL_QOS_CS_PROFILE_DEFAULT    ,
    QOS_LAYER_TYPE_MASK           , QOS_NO_LAYER_TYPE_MASK           , QOS_NO_QUAL_MASK   , QOS_NO_QUAL_MASK    , QOS_NO_CS_PROFILE_MASK   ,
    {QOS_FFC_0_REM_RCH_SRV6_USP_PSP_VAL        , QOS_FFC_1_REM_RCH_SRV6_USP_PSP_VAL}       , DBAL_ENUM_FVAL_QOS_RESOLUTION_MODE_MAPPED    , QOS_INT_MAP_KEY_SIZE, TRUE},
...
{/********************************************************************************************************************************
  ...
  */
  ...
  {/** INGRESS_QOS_MAP_TYPE =  INGRESS_QOS_MAP_TYPE_BIER */
   5,
   DBAL_ENUM_FVAL_LAYER_TYPES_BIER_NON_MPLS, DBAL_ENUM_FVAL_LAYER_TYPES_INITIALIZATION, QOS_NO_QUAL  , QOS_NO_QUAL       , QOS_UNUSED_FIELD,
   QOS_LAYER_TYPE_MASK           , QOS_NO_QUAL_MASK                 , QOS_NO_QUAL_MASK    , QOS_NO_QUAL_MASK  , QOS_UNUSED_FIELD,
  {QOS_FFC_0_MPLS_TTL_VAL        , QOS_FFC_1_MPLS_TTL_VAL }         , QOS_UNUSED_FIELD    , QOS_UNUSED_FIELD  , TRUE},
    ...
    uint8 *map_key)
{
    ...
    switch (map_index)
    {
        ...
        case DBAL_ENUM_FVAL_INGRESS_QOS_MAP_INDEX_GTP:
            *map_key = map_entry->dscp;
            break;
...
/**
 * \brief
 * Update the QoS context selection table data for RCH.
 *    \param [in] unit - Relevant unit.
 *    \param [in] app_type - QOS ingress appliation type, PHB/REMARK/TTL.
 *    \param [out] qos_cs_table_data - ptr to cs table init data
 * \return
 *   \retval Negative in case of an error.
 *   \retval Zero in case of NO ERROR
 */
static shr_error_e
dnx_qos_ingress_cs_data_rch_ffc_update(
    int unit,
    dbal_enum_value_field_qos_ingress_app_type_e app_type,
    qos_context_selection_table_t * qos_cs_table_data)
{
    SHR_FUNC_INIT_VARS(unit);
    ...
    switch (app_type)
    {
        case DBAL_ENUM_FVAL_QOS_INGRESS_APP_TYPE_PHB:
        {
            qos_cs_table_data[INGRESS_QOS_MAP_TYPE_RCH].qos_ffc[0] = QOS_FFC_0_PHB_S121_RCH_VAL;
            qos_cs_table_data[INGRESS_QOS_MAP_TYPE_RCH].qos_ffc[1] = QOS_FFC_1_PHB_S121_RCH_VAL;
            break;
        }
        case DBAL_ENUM_FVAL_QOS_INGRESS_APP_TYPE_REMARK:
        {
            qos_cs_table_data[INGRESS_QOS_MAP_TYPE_RCH].qos_ffc[0] = QOS_FFC_0_REM_S121_RCH_VAL;
            qos_cs_table_data[INGRESS_QOS_MAP_TYPE_RCH].qos_ffc[1] = QOS_FFC_1_REM_S121_RCH_VAL;
            break;
        }
        case DBAL_ENUM_FVAL_QOS_INGRESS_APP_TYPE_TTL:
        {
            qos_cs_table_data[INGRESS_QOS_MAP_TYPE_RCH].qos_ffc[0] = QOS_FFC_0_TTL_S121_RCH_VAL;
            qos_cs_table_data[INGRESS_QOS_MAP_TYPE_RCH].qos_ffc[1] = QOS_FFC_1_TTL_S121_RCH_VAL;
            break;
        }
        default:
        {
            SHR_ERR_EXIT(_SHR_E_INTERNAL, "app type [%d] is not supported", app_type);
        }
    }
exit:
    SHR_FUNC_EXIT;
    ...
    int unit)
{
    ...
    /*
     * ECN profile/opcode 0 is used for ECN un-eligible.
     * ECN profile/opcode 1 is used for ECN eligible
     */
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_QOS_INGRESS_ECN_PROFILE_TO_INTERNAL_MAP_ID, &entry_handle_id));
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_ECN_QOS_PROFILE, DNX_QOS_ECN_MAPPING_PROFILE_ELIGIBLE);
    ...
    for (map_key = 0; map_key <= dnx_data_qos.qos.packet_max_dscp_get(unit); map_key++)
    {
        ...
        if (dnx_data_qos.qos.feature_get(unit, dnx_data_qos_qos_ecn_L4S))
        {
            ...
            /** IP-ECN == 01, classifies to the L4S queue */
            ecn_L4S = (ecn_value & DNX_QOS_ECN_ECT_1) && ((ecn_value & DNX_QOS_ECN_ECT_0) == 0);
            if (ecn_L4S)
            {
    ...
    int unit)
{
    ...
    qos_context_selection_table_t qos_ttl_cs_table_data[INGRESS_QOS_MAP_TYPE_VALUE_NOF + 1];
    ...
    sal_memcpy(qos_ttl_cs_table_data, qos_ttl_cs_table_init, sizeof(qos_ttl_cs_table_init));
    ...
    {
        dnx_qos_ingress_cs_data_rch_ffc_update(unit, DBAL_ENUM_FVAL_QOS_INGRESS_APP_TYPE_PHB, qos_phb_cs_table_data);
        dnx_qos_ingress_cs_data_rch_ffc_update(unit, DBAL_ENUM_FVAL_QOS_INGRESS_APP_TYPE_REMARK,
                                               qos_remark_cs_table_data);
        dnx_qos_ingress_cs_data_rch_ffc_update(unit, DBAL_ENUM_FVAL_QOS_INGRESS_APP_TYPE_TTL, qos_ttl_cs_table_data);
    }
    ...
    SHR_IF_ERR_EXIT(dnx_qos_tables_ingress_type_init
                    (unit, entry_handle_id, DBAL_ENUM_FVAL_QOS_INGRESS_APP_TYPE_TTL, &qos_ttl_cs_table_data[0]));
    ...
    dbal_enum_value_field_ingress_qos_map_index_e * map_index)
{
    ...
    if (flags & BCM_QOS_MAP_L2)
    {
        ...
        {
            *map_index = DBAL_ENUM_FVAL_INGRESS_QOS_MAP_INDEX_L2_SECOND_TAG;
        }
        else    /* BCM_QOS_MAP_L2_OUTER_TAG */
        {
            *map_index = DBAL_ENUM_FVAL_INGRESS_QOS_MAP_INDEX_L2_FIRST_TAG;
        }
    }
    ...
    else if (flags & BCM_QOS_MAP_GTP)
    {
        *map_index = DBAL_ENUM_FVAL_INGRESS_QOS_MAP_INDEX_GTP;
    }
    else
    {
    ...
    bcm_qos_map_t * map_entry)
{
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_INNER_PCP, INST_SINGLE, map_entry->inner_pkt_pri);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_INNER_DEI, INST_SINGLE, map_entry->inner_pkt_cfi);
    ...
    int *num_entries)
{
    ...
    {
        *num_entries = DNX_QOS_DSCP_MAX_VALUE + 1;
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, " [%x]: layer flags was not set yet\n", flags);
    ...
    int *array_count)
{
    ...
    while (!is_end)
    {
        ...
        SHR_IF_ERR_EXIT(dbal_entry_handle_value_field_arr32_get
                        (unit, entry_handle_id, DBAL_FIELD_INNER_PCP, INST_SINGLE, &inner_pcp));
        SHR_IF_ERR_EXIT(dbal_entry_handle_value_field_arr32_get
                        (unit, entry_handle_id, DBAL_FIELD_INNER_DEI, INST_SINGLE, &inner_dei));

        map->int_pri = tc;
        SHR_IF_ERR_EXIT(dnx_qos_color_decode(unit, dp, &map->color));
        map->pkt_pri = out_pcp;
        map->pkt_cfi = out_dei;
        map->inner_pkt_pri = inner_pcp;
        map->inner_pkt_cfi = inner_dei;
    ...
    int *array_count)
{
    ...
    if (((flags & BCM_QOS_MAP_L2) && (flags & BCM_QOS_MAP_L2_UNTAGGED)) || (flags & BCM_QOS_MAP_PORT))
    {
        ...
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_QOS_PROFILE, profile_index);
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_INGRESS_QOS_MAP_INDEX, map_index);
        {
            dbal_value_field32_request(unit, entry_handle_id, DBAL_FIELD_QOS_INT_MAP_ID, INST_SINGLE, &opcode);
        }
...
/**
 * \brief
 *    to set the ingress map profile to flow lif
 */
static shr_error_e
dnx_qos_ingress_flow_lif_map_set(
    int unit,
    bcm_gport_t gport,
    int ing_map)
{
    ...
    {
        terminator_info.qos_map_id = ing_map;
    ...
    else if (DNX_QOS_MAP_IS_VLAN_PCP(ing_map))
    {
        ...
        special_fields.special_fields[0].field_id = FLOW_S_F_VLAN_EDIT_PCP_DEI_PROFILE;
        special_fields.special_fields[0].shr_var_uint32 = ing_map;
    }
    else
    {
...
/**
 * \brief
 *    to get the ingress map profile from flow lif
 */
static shr_error_e
dnx_qos_ingress_flow_lif_map_get(
    int unit,
    bcm_gport_t gport,
    int *ing_map,
    uint32 flags)
{
    ...
    if (flags & BCM_QOS_MAP_L2_VLAN_PCP)
    {
        ...
        for (field_index = 0; field_index < special_fields.actual_nof_special_fields; field_index++)
        {
            if (special_fields.special_fields[field_index].field_id == FLOW_S_F_VLAN_EDIT_PCP_DEI_PROFILE)
            {
                *ing_map = special_fields.special_fields[0].shr_var_uint32;
            }
        }
    }
    else
    {
        ...
        {
            *ing_map = terminator_info.qos_map_id;
        }
    }
    ...
    int ing_map)
{
    ...
    else
    {
        ...
        if (dnx_data_flow.general.feature_get(unit, dnx_data_flow_general_is_flow_enabled_for_legacy_applications))
        {
            SHR_IF_ERR_EXIT(dnx_qos_ingress_flow_lif_map_set(unit, port, ing_map));
            SHR_EXIT();
        }
    ...
    uint32 flags)
{
    ...
    *ing_map = BCM_DNX_QOS_MAP_INVALID_ID;
    ...
    else
    {
        if (dnx_data_flow.general.feature_get(unit, dnx_data_flow_general_is_flow_enabled_for_legacy_applications))
        {
            SHR_IF_ERR_EXIT(dnx_qos_ingress_flow_lif_map_get(unit, port, ing_map, flags));
            SHR_EXIT();
        }
    ...
    uint8 *is_last)
{
    ...
    *is_last = FALSE;
    ...
    SHR_IF_ERR_EXIT(algo_qos_db.qos_ingress_propagation_profile.exchange
                    (unit, 0, 1, &propagation_profile_type, old_propagation_profile,
    ...
    uint8 *last_reference)
{
    ...
    *last_reference = FALSE;
    ...
    SHR_IF_ERR_EXIT(algo_qos_db.qos_ingress_propagation_profile.exchange
                    (unit, 0, 1, &propagation_profile_type, propagation_profile,
    ...
    int arg)
{
    ...
    switch (type)
    {
        ...
        case bcmQosControlMplsIngressSwapRemarkProfile:
        {
            ...
            dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_FHEI_SWAP_REMARK_PROFILE,
        ...
        case bcmQosControlMplsIngressSwapTtlModel:
        {
            ...
            if (dnx_data_headers.feature.feature_get(unit, dnx_data_headers_feature_fhei_mpls_cmd_from_eei))
            {
                uint32 remark_profile;
                uint32 profile_min;
                uint32 profile_max;

                /**map all mpls swap command to same ttl model*/
                SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC
                                (unit, DBAL_TABLE_EGRESS_MPLS_FHEI_TO_EES_RESOLUTION, &entry_handle_id));
                SHR_IF_ERR_EXIT(dbal_fields_enum_hw_value_get
                                (unit, DBAL_FIELD_SWAP_QOS_PROFILE, DBAL_ENUM_FVAL_SWAP_QOS_PROFILE_DEFAULT,
                                 &profile_min));
                SHR_IF_ERR_EXIT(dbal_fields_enum_hw_value_get
                                (unit, DBAL_FIELD_SWAP_QOS_PROFILE, DBAL_ENUM_FVAL_SWAP_QOS_PROFILE_MAX, &profile_max));
                for (remark_profile = profile_min; remark_profile <= profile_max; remark_profile++)
                {
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_FHEI_SWAP_TTL_MODEL, remark_profile,
                                                 ttl_mode);
                }
                SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
            }
    ...
    switch (type)
    {
        ...
        case bcmQosControlMplsIngressSwapRemarkProfile:
        {
            *arg = BCM_DNX_QOS_MAP_INVALID_ID;
            ...
            dbal_value_field32_request(unit, entry_handle_id, DBAL_FIELD_FHEI_SWAP_REMARK_PROFILE,
                                       DNX_EEI_IDENTIFIER_SWAP, &profile_index);
        ...
        case bcmQosControlMplsIngressSwapTtlModel:
        {
            ...
            if (dnx_data_headers.feature.feature_get(unit, dnx_data_headers_feature_fhei_mpls_cmd_from_eei))
            {
                uint32 profile_default;

                /**all mpls swap remark profile use same ttl model*/
                SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC
                                (unit, DBAL_TABLE_EGRESS_MPLS_FHEI_TO_EES_RESOLUTION, &entry_handle_id));
                SHR_IF_ERR_EXIT(dbal_fields_enum_hw_value_get
                                (unit, DBAL_FIELD_SWAP_QOS_PROFILE, DBAL_ENUM_FVAL_SWAP_QOS_PROFILE_DEFAULT,
                                 &profile_default));
                dbal_value_field32_request(unit, entry_handle_id, DBAL_FIELD_FHEI_SWAP_TTL_MODEL, profile_default,
                                           &ttl_mode);
                SHR_IF_ERR_EXIT(dbal_entry_get(unit, entry_handle_id, DBAL_COMMIT));
            }
            else
    ...
    int *prop_strength)
{
    ...
    switch (qos_propag_model)
    {
        case bcmQosIngressModelInvalid:
        {
...
/**
 * \brief
 *  Set special label qos attribute.
 *
 * \see
 *   qos_internal.h
 */
shr_error_e
dnx_qos_ingress_control_special_label_qos_attributes_set(
    int unit,
    uint32 flags,
    bcm_qos_control_type_t type,
    int arg)
{
    ...
    switch (type)
    {
        ...
        case bcmQosControlMplsExplicitNullIngressTtlModel:
        {
            ...
            {
                special_label_profile = DBAL_ENUM_FVAL_VTT_MPLS_SPECIAL_LABEL_PROFILE_IPV6_EXPLICIT_NULL;
            }
            else
            {
                special_label_profile = DBAL_ENUM_FVAL_VTT_MPLS_SPECIAL_LABEL_PROFILE_IPV4_EXPLICIT_NULL;
            }
            /*
             * EN label default qos model is uniform
             */
            if (qos_model == bcmQosIngressModelInvalid)
            {
                qos_model = bcmQosIngressModelUniform;
            }
            break;
        }
        case bcmQosControlMplsELIIngressQosProfile:
        case bcmQosControlMplsELIIngressPhbModel:
        case bcmQosControlMplsELIIngressRemarkModel:
        case bcmQosControlMplsELIIngressTtlModel:
        {
            special_label_profile = DBAL_ENUM_FVAL_VTT_MPLS_SPECIAL_LABEL_PROFILE_ELI;
            break;
        }
        default:
        {
    ...
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_VTT_MPLS_SPECIAL_LABEL_PROFILE, special_label_profile);
...
/**
 * \brief
 *  get special label qos attribute.
 *
 * \see
 *    qos_internal.h
 */
shr_error_e
dnx_qos_ingress_control_special_label_qos_attributes_get(
    int unit,
    uint32 flags,
    bcm_qos_control_type_t type,
    int *arg)
