...
/**
 * Initialize etpp_out_lif_template_data
 */
void
etpp_out_lif_template_data_t_init(
    int unit,
    etpp_out_lif_template_data_t * etpp_out_lif_template_data)
{
    etpp_out_lif_template_data->out_lif_orientation = DNX_OUT_LIF_PROFILE_DEFAULT_ORIENTATION;
    etpp_out_lif_template_data->etpp_split_horizon_enable = DNX_OUT_LIF_PROFILE_SPLIT_HORIZON_ENABLE;
    etpp_out_lif_template_data->oam_lif_profile = DNX_OUT_LIF_PROFILE_OAM_PROFILE;
    etpp_out_lif_template_data->keep_internal_default_profile = 0;
}
    ...
    uint8 *is_last)
{
     ...
     */
    etpp_out_lif_template_data_t_init(unit, &etpp_out_lif_profile_template_data);
    etpp_out_lif_template_data_t_init(unit, &etpp_out_lif_profile_default_template_data);
        ...
        || (dbal_table_id == DBAL_TABLE_EEDB_IPV6_TUNNEL))
    {
        ...
        tag_info.resource_alloc_info.tags[0] = DNX_ALGO_OUT_LIF_TAG_IP_TUNNEL_PROFILE;
    ...
    /** If the table is EGRESS_PP_PORT */
    else if (dbal_table_id == DBAL_TABLE_EGRESS_PP_PORT)
    {
        if ((etpp_out_lif_profile_info->oam_lif_profile != DNX_OUT_LIF_PROFILE_OAM_PROFILE) ||
            (etpp_out_lif_profile_info->etpp_split_horizon_enable == DNX_OUT_LIF_PROFILE_SPLIT_HORIZON_DISABLE))
        {
        ...
        /** use tag DNX_ALGO_OUT_LIF_TAG_PORT_PROFILE  (profiles in range of 44 to 51) */
        tag_info.resource_alloc_info.tags[0] = DNX_ALGO_OUT_LIF_TAG_PORT_PROFILE;
        if (use_default_tag == FALSE)
        {
            etpp_out_lif_profile_template_data.out_lif_orientation = etpp_out_lif_profile_info->out_lif_orientation;
            etpp_out_lif_profile_template_data.keep_internal_default_profile =
                DNX_OUT_LIF_PROFILE_KEEP_DEFAULT_PORT_PROFILE;
        }
        else
        {
            *new_etpp_out_lif_profile = DNX_OUT_LIF_PROFILE_DEFAULT_PORT_PROFILE;
            etpp_out_lif_profile_default_template_data.keep_internal_default_profile =
                DNX_OUT_LIF_PROFILE_KEEP_DEFAULT_PORT_PROFILE;
        }
    }
    ...
    else if (dbal_table_id == DBAL_TABLE_EEDB_MPLS_TUNNEL)
    {
        ...
        /** use tag DNX_ALGO_OUT_LIF_TAG_MPLS_PROFILE (profiles in range of 28 to 31) */
        tag_info.resource_alloc_info.tags[0] = DNX_ALGO_OUT_LIF_TAG_MPLS_PROFILE;
        if (use_default_tag == FALSE)
        {
            etpp_out_lif_profile_template_data.oam_lif_profile = etpp_out_lif_profile_info->oam_lif_profile;
            etpp_out_lif_profile_template_data.keep_internal_default_profile =
                DNX_OUT_LIF_PROFILE_KEEP_DEFAULT_MPLS_PROFILE;
        }
        else
        {
            *new_etpp_out_lif_profile = DNX_OUT_LIF_PROFILE_DEFAULT_MPLS_PROFILE;
            etpp_out_lif_profile_default_template_data.keep_internal_default_profile =
                DNX_OUT_LIF_PROFILE_KEEP_DEFAULT_MPLS_PROFILE;
        }
    }
    ...
    {
        /** use tag DNX_ALGO_OUT_LIF_TAG_GENERAL_PROFILE (profiles in range of 0 to 27) */
        tag_info.resource_alloc_info.tags[0] = DNX_ALGO_OUT_LIF_TAG_GENERAL_PROFILE;
        if (use_default_tag == FALSE)
        {
    ...
    if (use_default_tag == TRUE)
    {
        ...
        SHR_IF_ERR_EXIT(algo_lif_profile_db.etpp_out_lif_profile.exchange
                        (unit, DNX_ALGO_TEMPLATE_ALLOCATE_WITH_ID, 1, &etpp_out_lif_profile_default_template_data,
    ...
    else
    {
        ...
        SHR_IF_ERR_EXIT(algo_lif_profile_db.etpp_out_lif_profile.exchange
                        (unit, 0, 1, &etpp_out_lif_profile_template_data, old_etpp_out_lif_profile,
 ...
 */
shr_error_e
dnx_etpp_out_lif_profile_hw_clear(
    int unit,
    int etpp_out_lif_profile)
{
    ...
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_OUT_LIF_PROFILE, etpp_out_lif_profile);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_OUT_LIF_ORIENTATION, INST_SINGLE,
                                 DNX_OUT_LIF_PROFILE_DEFAULT_ORIENTATION);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_SPLIT_HORIZON_ENABLE, INST_SINGLE,
                                 DNX_OUT_LIF_PROFILE_SPLIT_HORIZON_ENABLE);
    ...
    int *new_erpp_out_lif_profile)
{
    ...
    SHR_IF_ERR_EXIT(algo_lif_profile_db.erpp_out_lif_profile.exchange
                    (unit, 0, 1, &erpp_out_lif_profile_template_data, old_erpp_out_lif_profile,
    ...
    etpp_out_lif_profile_info_t * etpp_out_lif_profile_info)
{
    ...
    etpp_out_lif_profile_info->etpp_split_horizon_enable = DNX_OUT_LIF_PROFILE_SPLIT_HORIZON_ENABLE;
