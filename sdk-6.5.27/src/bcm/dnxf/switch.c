...
/**
 * \brief - Get the device temperature sensor data
 * 
 * \param [in] unit - Unit
 * \param [in] temperature_max - Maximum temperature in all sensors
 * \param [in] temperature_array - Array of temperature monitor readings
 * \param [in] temperature_count - Number of temperature monitors read
 * \return shr_error_e 
 */
int
