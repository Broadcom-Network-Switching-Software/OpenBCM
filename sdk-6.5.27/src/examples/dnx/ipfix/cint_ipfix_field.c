...
int cint_ipfix_field_main(int unit, bcm_field_context_t context_id)
{
    ...
    */
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit,0,&action_info,&cint_field_IPFIX_rx_act_container_1b), "");
    ...
    * Set the range.
    */
    BCM_IF_ERROR_RETURN_MSG(bcm_field_range_set(unit, 0, bcmFieldStageIngressPMF1, cint_ipfix_field_range_id, &range_info), "");
    bcm_field_qualifier_info_create_t_init(&qual_info);
    qual_info.size = 5;
    dest_char = &(qual_info.name[0]);
    sal_strncpy_s(dest_char, "Fwd_plus_1_layer_t", sizeof(qual_info.name));
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit,0,qual_info, &cint_ipfix_field_qual_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_info_get(unit, bcmFieldQualifyLayerRecordType, bcmFieldStageIngressPMF1, &qual_info_get), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, BCM_FIELD_FLAG_MSB_RESULT_ALIGN, &fg_info, &cint_ipfix_field_fg_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_create(unit, 0, fg_info.stage, &context_info, &cint_field_IPFIX_rx_iPMF1), "");

    if(device_type_v2 == 1)
    {
        /* Add flow_id in field */
        BCM_IF_ERROR_RETURN_MSG(appl_dnx_field_flow_id_init(unit,cint_field_IPFIX_rx_iPMF1), "");
    }
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, cint_ipfix_field_fg_id, cint_field_IPFIX_rx_iPMF1, &attach_info), "");
    ...
    if(device_type_v2 == 0)
    {
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit,0,&qual_info,&cint_field_Valid_bit_src_port), "");

        bcm_field_qualifier_info_create_t_init(&qual_info);
        qual_info.size=1;
        dest_char = &(qual_info.name[0]);
        sal_strncpy_s(dest_char, "ipfix_Valid_bit_dest_port", sizeof(qual_info.name));
        BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit,0,&qual_info,&cint_field_Valid_bit_dest_port), "");

        bcm_field_qualifier_info_create_t_init(&qual_info);
        qual_info.size=1;
        dest_char = &(qual_info.name[0]);
        sal_strncpy_s(dest_char, "ipfix_Valid_bit_udh_base_type", sizeof(qual_info.name));
        BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit,0,&qual_info,&cint_field_Valid_bit_udh_base_type), "");

        bcm_field_qualifier_info_create_t_init(&qual_info);
        qual_info.size=8;
        dest_char = &(qual_info.name[0]);
        sal_strncpy_s(dest_char, "ipfix_udh_base", sizeof(qual_info.name));
        BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit,0,&qual_info,&cint_field_udh_base), "");

        BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_info_get(unit,bcmFieldQualifySrcPort,bcmFieldStageIngressPMF3,qualifier_info_get), "");
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &cint_src_port_action_id), "");

        BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_info_get(unit,bcmFieldQualifyDstPort,bcmFieldStageIngressPMF3,qualifier_info_get), "");
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &cint_dest_port_action_id), "");
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &cint_field_IPFIX_fg_id_ipmf3), "");
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_field_context_create(unit, 0, bcmFieldStageIngressPMF3, &context_info, &cint_field_IPFIX_context_id_ipmf3), "");

        BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_info_get(unit,bcmFieldQualifyContainer,bcmFieldStageIngressPMF3,qualifier_info_get), "");
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, cint_field_IPFIX_fg_id_ipmf3, cint_field_IPFIX_context_id_ipmf3, &attach_info), "");
                                                ...
                                                bcm_field_entry_t *entry_handle)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, cint_ipfix_field_fg_id, &ent_info, entry_handle), "");
...
cint_ipfix_field_export_quals_set(int unit, int eventor_port, int context_id)
{
   ...
   BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &cint_ipfix_field_utils_sn_qualifier_id), "");
   ...
   BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, BCM_FIELD_FLAG_MSB_RESULT_ALIGN, &field_group_info, &cint_ipfix_tx_field_fg_id), "");
   ...
   BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, cint_ipfix_tx_field_fg_id, cint_field_IPFIX_rx_iPMF1, &attach_info), "");
...
cint_ipfix_field_export_entry_add(int unit, int eventor_port)
{
   ...
   */
   ...
   BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, cint_ipfix_tx_field_fg_id, &ent_info, &cint_ipfix_field_utils_entry_id), "");
...
cint_ipfix_field_export_packet(int unit, int eventor_port, int ipfix_out_port, int context_id)
{
   ...
   BCM_IF_ERROR_RETURN_MSG(cint_ipfix_field_export_quals_set(unit, eventor_port, context_id), "");
   
   /** Add IPFIX SN entry */
   BCM_IF_ERROR_RETURN_MSG(cint_ipfix_field_export_entry_add(unit, eventor_port), "");
   return BCM_E_NONE; 
}
					...
					int is_replace)
{
    ...
    *mirror_dest_id = mirror_dest.mirror_dest_id;
    ...
    if(device_type_v2 == 1)
    {
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_mirror_header_info_set(unit,mirror_header_flags,*mirror_dest_id,mirror_header_info), "");
...
cint_ipfix_field_egress_group(int unit)
{
    ...
    */
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_ace_entry_add(unit, 0, ace_format_id, &ace_entry_info, &cint_field_IPFIX_egress_ace_entry_handle), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, BCM_FIELD_FLAG_MSB_RESULT_ALIGN, &fg_info, &cint_field_IPFIX_egress_fg_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_create(unit, 0, fg_info.stage, &context_info, &cint_field_IPFIX_egress_context_id_ipv4), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, cint_field_IPFIX_egress_fg_id, cint_field_IPFIX_egress_context_id_ipv4, &attach_info), "");
...
int cint_ipfix_field_egress_entry_add(int unit, bcm_field_entry_t *entry_handle)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, cint_field_IPFIX_egress_fg_id, &ent_info, entry_handle), "");
...
cint_ipfix_field_egress(int unit, bcm_instru_ipfix_encap_info_t *ipfix_encap_info)
{
    ...
    /* Configure field */
    BCM_IF_ERROR_RETURN_MSG(cint_ipfix_field_egress_group(unit), "");

    /* Set ePMF to trap IPFIX Rx packet */
    BCM_IF_ERROR_RETURN_MSG(cint_ipfix_field_egress_entry_add(unit,&entry_handle), "");
