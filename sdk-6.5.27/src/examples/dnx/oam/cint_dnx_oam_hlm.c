    ...
    int port2)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(set_counter_resource(unit, port1, dnx_oam_hlm_info.lm_counter_if[0], 1, &dnx_oam_hlm_info.lm_counter_base_ids[0]), "");
    BCM_IF_ERROR_RETURN_MSG(set_counter_resource(unit, port1, dnx_oam_hlm_info.lm_counter_if[1], 1, &dnx_oam_hlm_info.lm_counter_base_ids[2]), "");
    BCM_IF_ERROR_RETURN_MSG(set_counter_resource(unit, port2, dnx_oam_hlm_info.lm_counter_if[0], 1, &dnx_oam_hlm_info.lm_counter_base_ids[1]), "");
    BCM_IF_ERROR_RETURN_MSG(set_counter_resource(unit, port2, dnx_oam_hlm_info.lm_counter_if[1], 1, &dnx_oam_hlm_info.lm_counter_base_ids[3]), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_oam_profile_id_get_by_type(unit, ingress_acc_profile, bcmOAMProfileIngressAcceleratedEndpoint, &flags, &ingress_acc_profile), "(ingress)");

    BCM_IF_ERROR_RETURN_MSG(bcm_oam_profile_id_get_by_type(unit, egress_acc_profile, bcmOAMProfileEgressAcceleratedEndpoint, &flags, &egress_acc_profile), "(egress)");

    BCM_IF_ERROR_RETURN_MSG(bcm_oam_lif_profile_set(unit, 0, vp1.vlan_port_id, ingress_profile, egress_profile), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_oam_lif_profile_set(unit, 0, vp2.vlan_port_id, ingress_profile, egress_profile), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_oam_endpoint_create(unit, &mep_1), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_oam_endpoint_create(unit, &mep_3), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_oam_endpoint_create(unit, &mep_4), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_oam_endpoint_create(unit, &mep_6), "");
