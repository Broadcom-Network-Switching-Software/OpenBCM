 ...
 * 
 ...
 Copyright 2007-2022 Broadcom Inc. All rights reserved. File: cint_oam_statistics.c Purpose: basic examples for OAM statistics. 
 */
/*
  ...
  int engine_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_stat_counter_eviction_get(unit, flags, &engine, &eviction), "");
    ...
    {
        BCM_IF_ERROR_RETURN_MSG(bcm_stat_counter_engine_control_set(unit, flags, &engine, bcmStatCounterSequentialSamplingInterval, 10), "");
    }
    ...
    int enable_eviction)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_oam_control_set(unit,bcmOamControlOampStatsShift,arg), "bcmOamControlOampStatsShift");

    key.index = OAM_CCM_BFD_OPCODE;
    COMPILER_64_SET(arg,0,OAM_STAT_COUNT_ENABLE);


    BCM_IF_ERROR_RETURN_MSG(cint_oam_oamp_statistics_enable_disable_opcode_count(unit, bcmOamOpcodeLMM, tx_rx, 1), "bcmOamControlOampStatsShift");
    ...
    */
    ...
    BCM_IF_ERROR_RETURN_MSG(crps_oam_database_set(unit, core_id, oam_source, oamp_command_id, nof_requred_engines, engine_array_16k, counter_base, database_id, &total_nof_counters_get), "");
    BCM_IF_ERROR_RETURN_MSG(cint_oam_oamp_statistics_eviction_speed_adjust(unit, core_id, engine_array_16k[0]), "");
    ...
    if ((tx_rx == OAM_STAT_COUNT_TX) || (tx_rx == OAM_STAT_COUNT_PER_DIRECTION))
    {
        ...
        */
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_oam_control_indexed_set(unit,key,arg), "bcmOamControlOampStatsTxOpcode");
    }
    ...
    */
    ...
    BCM_IF_ERROR_RETURN_MSG(crps_oam_database_set(unit, core_id, oam_source, oamp_command_id, nof_requred_engines, engine_array_16k, counter_base, database_id + 1, &total_nof_counters_get), "");
    BCM_IF_ERROR_RETURN_MSG(cint_oam_oamp_statistics_eviction_speed_adjust(unit, core_id, engine_array_16k[0]), "");
    /* Set it back to 0*/
    ...
    if ((tx_rx == OAM_STAT_COUNT_RX) || (tx_rx == OAM_STAT_COUNT_PER_DIRECTION))
    {
        ...
        */
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_oam_control_indexed_set(unit,key,arg), "bcmOamControlOampStatsRxOpcode");
    }
    ...
    int *counter_id)
{
    ...
    /** Configure the RX and TX shift, based on needed counters */
    BCM_IF_ERROR_RETURN_MSG(bcm_oam_control_get(unit,bcmOamControlOampStatsShift,&arg), "bcmOamControlOampStatsShift");
    ...
    int *counter_value)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_oam_oamp_statistics_calc_cnt_index(unit,opcode_flags,mep_id,opcode,is_rx_side,&counter_id), "");

    /** Read the counter value */
    BCM_IF_ERROR_RETURN_MSG(cint_oam_oamp_statistics_read_counter(unit,flags,core_id,database_id,counter_id,counter_value), "");
    ...
    int engine_id)
{
    ...
    */
    ...
    BCM_IF_ERROR_RETURN_MSG(crps_oam_database_set(unit, core_id, oam_source, oamp_command_id, nof_requred_engines, engine_array, counter_base, database_id, &total_nof_counters_get), "");
