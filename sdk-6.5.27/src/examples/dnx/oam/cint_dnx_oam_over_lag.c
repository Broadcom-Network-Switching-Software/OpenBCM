    ...
    int unit)
{
    ...
    /* 1. Create a lag (trunk). */
    BCM_IF_ERROR_RETURN_MSG(dnx_oam_over_lag_trunk_create(unit), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(dnx_oam_over_lag_members_add(unit), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(l2_pp_lag_property_set(unit, dnx_oam_over_lag_1.trunk_gport), "");

    /* 4. Create an ethernet port (vlan-port) over the lag */
    BCM_IF_ERROR_RETURN_MSG(dnx_oam_over_lag_vlan_port_create(unit, 1), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(dnx_oam_over_lag_cross_connect_add(unit), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_oam_group_create(unit, &oam_group_info), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(dnx_oam_over_lag_endpoint_create(unit), "");
    ...
    int unit)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(bcm_oam_group_destroy(unit, dnx_oam_over_lag_1.oam_group_id), "");

    /* 3.5 If the second vlan port exists, clean it and the cross connect up. */
    if (dnx_oam_over_lag_1.second_vlan_gport) {
        BCM_IF_ERROR_RETURN_MSG(dnx_oam_over_lag_cross_connect_destroy(unit), "");
    }

    /* 3. Destroy the ethernet port (vlan-port) over the lag.*/
    BCM_IF_ERROR_RETURN_MSG(bcm_vlan_port_destroy(unit, dnx_oam_over_lag_1.trunk_vlan_gport), "");

    /* 2. Remove ports from lag. */
    BCM_IF_ERROR_RETURN_MSG(bcm_trunk_member_delete_all(unit, dnx_oam_over_lag_1.trunk_id), "");

    /* 1. Destroy lag. */
    BCM_IF_ERROR_RETURN_MSG(bcm_trunk_destroy(unit, dnx_oam_over_lag_1.trunk_id), "");
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_switch_control_indexed_port_set(unit, dnx_oam_over_lag_1.trunk_gport, key, value), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_trunk_set(unit, dnx_oam_over_lag_1.trunk_id, &trunk_info, 3, member_array), "");
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(set_counter_resource(unit, dnx_oam_over_lag_1.trunk_ports[0], counter_if_0, 1, &dnx_oam_over_lag_1.lm_counter_base_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_oam_lif_profile_set(unit, 0, dnx_oam_over_lag_1.trunk_vlan_gport, ingress_profile, egress_profile), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_oam_lif_profile_set(unit, 0,  dnx_oam_over_lag_1.second_vlan_gport, ingress_profile, egress_profile), "");
    ...
    */
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_oam_endpoint_create(unit, &mep), "");
    ...
    */
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_oam_endpoint_create(unit, &rmep), "");
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(dnx_oam_over_lag_vlan_port_create(unit, 0), "");
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_vlan_port_destroy(unit, dnx_oam_over_lag_1.second_vlan_gport), "");
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_trunk_create(unit, trunk_flags, &dnx_oam_over_lag_1.trunk_id), "");
