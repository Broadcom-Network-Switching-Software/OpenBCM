...
l.c 
l.c Copyright 2007-2022 Broadcom Inc. All rights reserved.File: cint_oam_mpls_transit_signal.c 
 *
...
{   
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &user_qual_id2), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &user_qual_id3), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &qual_header_fg_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_create(unit, 0, bcmFieldStageEgress, &context_info, &qual_header_context_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, qual_header_fg_id, qual_header_context_id, &attach_info), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, qual_header_fg_id, &ent_info, &(qual_header_entry_id[0])), "");
...
int cint_oam_mpls_send_signal_in_p_node(int unit,int in_port, int out_port, int nof_labels, int channel_type)
{
    ...
    /** Create ePMF */
    BCM_IF_ERROR_RETURN_MSG(cint_field_user_qual_mpls_tp_oam_main(unit,in_port,nof_labels,channel_type), "");
    /** Create LSR */
    BCM_IF_ERROR_RETURN_MSG(mpls_operations_without_eedb_main(unit,in_port,out_port,1), "");
    return BCM_E_NONE;
}
