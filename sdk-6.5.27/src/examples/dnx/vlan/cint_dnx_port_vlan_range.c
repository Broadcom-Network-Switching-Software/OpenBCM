 ...
 * Test Scenario - start
  ...
  cint ../../../../src/examples/dnx/vlan/cint_dnx_port_vlan_range.c
  cint
...
int vlan_range_action_add(int unit, int service_index, int port_index)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_vlan_translate_action_range_add(unit, port, outer_vlan_low, outer_vlan_high, inner_vlan_low, inner_vlan_high, &action), "");
...
int vlan_range_action_get(int unit, int service_index, int port_index)
{
    ...
    bcm_vlan_action_set_t_init(&action);
    BCM_IF_ERROR_RETURN_MSG(bcm_vlan_translate_action_range_get(unit, port, outer_vlan_low, outer_vlan_high, inner_vlan_low, inner_vlan_high, &action), "");
...
int vlan_range_action_delete(int unit, int service_index, int port_index)
{
    ...
    inner_vlan_low = vlan_range_service_info[service_index].port_info[port_index].cvlan_low;
    inner_vlan_high= vlan_range_service_info[service_index].port_info[port_index].cvlan_high;
    BCM_IF_ERROR_RETURN_MSG(bcm_vlan_translate_action_range_delete(unit, port, outer_vlan_low, outer_vlan_high, inner_vlan_low, inner_vlan_high), "");
...
int vlan_range_action_delete_all(int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_vlan_translate_action_range_delete_all(unit), "");
...
int vlan_range_1_1_service(int unit)
{
    ...
    for (service_index = 0; service_index < num_of_vlan_range_service; service_index++)
    {
        for (port_index = 0; port_index < 2; port_index++)
        {
            ...
            BCM_IF_ERROR_RETURN_MSG(vlan_range_action_add(unit, service_index, port_index), "");

            /* Create LIF */
            BCM_IF_ERROR_RETURN_MSG(vlan_range_lif_create(unit, service_index, port_index), "");
        }
...
int vlan_range_1_1_service_cleanup(int unit)
{
    ...
    for (service_index = 0; service_index < num_of_vlan_range_service; service_index++)
    {
        ...
        for (port_index = 0; port_index < 2; port_index++)
        {
            ...
            BCM_IF_ERROR_RETURN_MSG(vlan_range_action_delete(unit, service_index, port_index), "");

            /* Delete PON LIF */
            BCM_IF_ERROR_RETURN_MSG(bcm_vlan_port_destroy(unit, vlan_range_service_info[service_index].port_info[port_index].lif_gport), "");
        }
    }
...
int vlan_range_run_with_default()
{
    int unit = 0;
    int port_1 = 1;
    int port_2 = 3;

    BCM_IF_ERROR_RETURN_MSG(vlan_range_init(unit, port_1, port_2), "");
    BCM_IF_ERROR_RETURN_MSG(vlan_range_1_1_service(unit), "");
    return BCM_E_NONE;
}
