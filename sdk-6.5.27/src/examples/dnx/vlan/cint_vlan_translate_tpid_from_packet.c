 ...
 * Test Scenario - start
  ...
  cint                                                                                                                                             
  int unit = 0;                                                                                                                                    
  vlan_translate_tpid_from_packet_with_ports__main_config__start_run(int unit,  int in_port1, int in_port2, int in_port3, int out_port1, int out_port2, int out_port3)                                                                                                                                               
    ...
    vlan_translate_tpid_from_packet_s * param)
{
    ...
    */
    ...
    {
        snprintf(error_msg, sizeof(error_msg), "(tag_format_class_id = %d)", g_vlan_translate_tpid_from_packet.tag_format[i]);
        BCM_IF_ERROR_RETURN_MSG(bcm_port_tpid_class_create(unit, BCM_PORT_TPID_CLASS_WITH_ID, bcmTagStructTypeSCTag, &g_vlan_translate_tpid_from_packet.tag_format[i]), error_msg);
    ...
    int oPort3)
{
    ...
    vlan_translate_tpid_from_packet_struct_get(&param);
    ...
    vlan_translate_tpid_from_packet_s * param)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(vlan_translate_tpid_from_packet_init(unit, param), "");
    ...
    for (i = 0; i < NUM_OF_PORTS; i++)
    {
        snprintf(error_msg, sizeof(error_msg), "(port = %d)", g_vlan_translate_tpid_from_packet.in_ports[i]);
        BCM_IF_ERROR_RETURN_MSG(bcm_port_class_set(unit, g_vlan_translate_tpid_from_packet.in_ports[i], bcmPortClassId,
                                g_vlan_translate_tpid_from_packet.in_ports[i]), error_msg);

        snprintf(error_msg, sizeof(error_msg), "(port = %d)", g_vlan_translate_tpid_from_packet.out_ports[i]);
        BCM_IF_ERROR_RETURN_MSG(bcm_port_class_set(unit, g_vlan_translate_tpid_from_packet.out_ports[i], bcmPortClassId,
                                g_vlan_translate_tpid_from_packet.out_ports[i]), error_msg);
    }
    ...
    snprintf(error_msg, sizeof(error_msg), "(tpid_value=0x%04x)", g_vlan_translate_tpid_from_packet.tpid_value.packet_s_tag);
    BCM_IF_ERROR_RETURN_MSG(tpid__tpid_add(unit, g_vlan_translate_tpid_from_packet.tpid_value.packet_s_tag), error_msg);

    snprintf(error_msg, sizeof(error_msg), "(tpid_value=0x%04x)", g_vlan_translate_tpid_from_packet.tpid_value.packet_c_tag);
    BCM_IF_ERROR_RETURN_MSG(tpid__tpid_add(unit, g_vlan_translate_tpid_from_packet.tpid_value.packet_c_tag), error_msg);

    snprintf(error_msg, sizeof(error_msg), "(tpid_value=0x%04x)", g_vlan_translate_tpid_from_packet.tpid_value.ingress_outer_tpid);
    BCM_IF_ERROR_RETURN_MSG(tpid__tpid_add(unit, g_vlan_translate_tpid_from_packet.tpid_value.ingress_outer_tpid), error_msg);

    snprintf(error_msg, sizeof(error_msg), "(tpid_value=0x%04x)", g_vlan_translate_tpid_from_packet.tpid_value.ingress_inner_tpid);
    BCM_IF_ERROR_RETURN_MSG(tpid__tpid_add(unit, g_vlan_translate_tpid_from_packet.tpid_value.ingress_inner_tpid), error_msg);

    snprintf(error_msg, sizeof(error_msg), "(tpid_value=0x%04x)", g_vlan_translate_tpid_from_packet.tpid_value.egress_outer_tpid);
    BCM_IF_ERROR_RETURN_MSG(tpid__tpid_add(unit, g_vlan_translate_tpid_from_packet.tpid_value.egress_outer_tpid), error_msg);

    snprintf(error_msg, sizeof(error_msg), "(tpid_value=0x%04x)", g_vlan_translate_tpid_from_packet.tpid_value.egress_inner_tpid);
    BCM_IF_ERROR_RETURN_MSG(tpid__tpid_add(unit, g_vlan_translate_tpid_from_packet.tpid_value.egress_inner_tpid), error_msg);
    ...
    for (i = 0; i < NUM_OF_PORTS; i++)
    {
        snprintf(error_msg, sizeof(error_msg), "(vis=%d)", g_vlan_translate_tpid_from_packet.vsi[i]);
        BCM_IF_ERROR_RETURN_MSG(bcm_vlan_create(unit, g_vlan_translate_tpid_from_packet.vsi[i]), error_msg);
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_vlan_port_add(unit, g_vlan_translate_tpid_from_packet.vsi[i], pbmp, untag_pbmp), "");
    }
    ...
    for (i = 0; i < NUM_OF_PORTS; i++)
    {
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_vswitch_port_add(unit, g_vlan_translate_tpid_from_packet.vsi[i], vlan_port.vlan_port_id), "");
    }
    ...
    for (i = 0; i < NUM_OF_PORTS; i++)
    {
        snprintf(error_msg, sizeof(error_msg), "(setting iPort%d IVE action)", i);
        BCM_IF_ERROR_RETURN_MSG(vlan_translate_ive_eve_translation_set(unit, g_vlan_translate_tpid_from_packet.inLifList[i],                  /* lif  */
     ...
     */
    snprintf(error_msg, sizeof(error_msg), "(setting iPort%d IVE action)", IN_PORT1_INDEX);
    BCM_IF_ERROR_RETURN_MSG(vlan_translate_ive_eve_translation_set_with_tpid_action(unit, g_vlan_translate_tpid_from_packet.inLifList[IN_PORT1_INDEX],                  /* lif  */
     ...
     */
    snprintf(error_msg, sizeof(error_msg), "(setting iPort%d IVE action)", IN_PORT2_INDEX);
    BCM_IF_ERROR_RETURN_MSG(vlan_translate_ive_eve_translation_set_with_tpid_action(unit, g_vlan_translate_tpid_from_packet.inLifList[IN_PORT2_INDEX],                  /* lif  */
     ...
     */
    snprintf(error_msg, sizeof(error_msg), "(setting iPort%d IVE action)", IN_PORT3_INDEX);
    BCM_IF_ERROR_RETURN_MSG(vlan_translate_ive_eve_translation_set_with_tpid_action(unit, g_vlan_translate_tpid_from_packet.inLifList[IN_PORT3_INDEX],                  /* lif  */
                                                                  BCM_SWITCH_TPID_VALUE_INVALID,                                                      /* outer_tpid */
                                                                  BCM_SWITCH_TPID_VALUE_INVALID,                                                      /* inner_tpid */
    ...
    for (i = 0; i < NUM_OF_PORTS; i++)
    {
        ...
        snprintf(error_msg, sizeof(error_msg), "( iPort%d )", i);
    ...
    for (i = 0; i < NUM_OF_PORTS; i++)
    {
        ...
        snprintf(error_msg, sizeof(error_msg), "( oPort%d )", i);
        BCM_IF_ERROR_RETURN_MSG(bcm_port_tpid_class_set(unit, &port_tpid_class), error_msg);
    }
    ...
    int unit)
{
    ...
    for (i = 0; i < NUM_OF_PORTS; i++)
    {
        snprintf(error_msg, sizeof(error_msg), "(gport = 0x%08X)", g_vlan_translate_tpid_from_packet.inLifList[i]);
        BCM_IF_ERROR_RETURN_MSG(bcm_vlan_port_destroy(unit, g_vlan_translate_tpid_from_packet.inLifList[i]), error_msg);
    }
    ...
    for (i = 0; i < NUM_OF_PORTS; i++)
    {
        snprintf(error_msg, sizeof(error_msg), "(vsi=%d)", g_vlan_translate_tpid_from_packet.vsi[i]);
        BCM_IF_ERROR_RETURN_MSG(bcm_vlan_destroy(unit, g_vlan_translate_tpid_from_packet.vsi[i]), error_msg);
     ...
     */
     BCM_IF_ERROR_RETURN_MSG(bcm_stk_module_enable(unit, 0 , 0, 0), "");
     ...
     */
     BCM_IF_ERROR_RETURN_MSG(bcm_stk_module_enable(unit, 0 , 0, 1), "");
     ...
     {
        snprintf(error_msg, sizeof(error_msg), "(tag_format_class_id = %d)", g_vlan_translate_tpid_from_packet.tag_format[i]);
        BCM_IF_ERROR_RETURN_MSG(bcm_port_tpid_class_destroy(unit, 0, g_vlan_translate_tpid_from_packet.tag_format[i]), error_msg);
