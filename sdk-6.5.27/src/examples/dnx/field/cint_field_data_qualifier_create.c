    ...
    char * context_name)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_create(unit, 0, field_stage, &context_info, context_id), "");
    ...
    int num_of_qualifiers)
{
    ...
    {
        BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &Cint_field_data_qualifier_create_qual_ids[qual_iter]), "");
    }
    ...
    while (fg_config_iter < Cint_field_data_qualifier_create_nof_fg)
    {
        switch (fg_config_iter)
        {
            ...
            {
                /** Create FWD context. */
                BCM_IF_ERROR_RETURN_MSG(cint_field_data_qualifier_create_context_create(unit, Cint_field_data_qualifier_create_field_stage,
        ...
        for (fg_iter = 0; fg_iter < Cint_field_data_qualifier_create_nof_fg / 2; fg_iter++)
        {
            ...
            {
                BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &Cint_field_data_qualifier_create_fg_ids[fg_config_iter + fg_iter]), "");

                printf("Field Group ID %d was created. \n", Cint_field_data_qualifier_create_fg_ids[fg_config_iter + fg_iter]);
            }
            else
            {
                BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &Cint_field_data_qualifier_create_fg_ids[fg_iter]), "");
        ...
        if (fg_config_iter == Cint_field_data_qualifier_create_nof_fg / 2)
        {
            BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, Cint_field_data_qualifier_create_fg_ids[fg_config_iter + (fg_iter - 1)],
        ...
        {
            BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, Cint_field_data_qualifier_create_fg_ids[fg_iter - 1],
        ...
        if (fg_config_iter == Cint_field_data_qualifier_create_nof_fg / 2)
        {
            ...
            BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, Cint_field_data_qualifier_create_fg_ids[fg_config_iter + (fg_iter - 1)], &entry_info,
        ...
        else
        {
            ...
            BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, Cint_field_data_qualifier_create_fg_ids[fg_iter - 1], &entry_info,
    ...
    int num_of_qualifiers)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, Cint_field_data_qualifier_create_fg_ids[3], NULL, Cint_field_data_qualifier_create_entry_handle[0]), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, Cint_field_data_qualifier_create_fg_ids[7], NULL, Cint_field_data_qualifier_create_entry_handle[1]), "");


    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, Cint_field_data_qualifier_create_fg_ids[3], Cint_field_data_qualifier_create_context_id[0]), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, Cint_field_data_qualifier_create_fg_ids[7], Cint_field_data_qualifier_create_context_id[1]), "");

    for (fg_iter = 0; fg_iter < Cint_field_data_qualifier_create_nof_fg; fg_iter++)
    {
        BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, Cint_field_data_qualifier_create_fg_ids[fg_iter]), "");
    }
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_destroy(unit, Cint_field_data_qualifier_create_field_stage, Cint_field_data_qualifier_create_context_id[0]), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_destroy(unit, Cint_field_data_qualifier_create_field_stage, Cint_field_data_qualifier_create_context_id[1]), "");
    for (qual_index = 0; qual_index < num_of_qualifiers; qual_index++)
    {
        BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_destroy(unit, Cint_field_data_qualifier_create_qual_ids[qual_index]), "");
    }
    return BCM_E_NONE;
}
