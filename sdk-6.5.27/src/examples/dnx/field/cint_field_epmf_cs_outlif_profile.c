    ...
    int is_lif)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_create(unit, 0, epmf_cs_outlif_profile_stage, &context_info, &epmf_cs_outlif_profile_context_id), "");
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &epmf_cs_outlif_profile_fg_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, epmf_cs_outlif_profile_fg_id, epmf_cs_outlif_profile_context_id, &attach_info), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, epmf_cs_outlif_profile_fg_id, &entry_info, &epmf_cs_outlif_profile_entry_id), "");
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_info_get(unit,bcmFieldActionTrap,bcmFieldStageEgress,&action_info_get_size), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &cint_const_action_id1), "cint_const_action_id1");
    ...
    int unit)
{
    ...
    {
        BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, epmf_cs_outlif_profile_fg_id, NULL, epmf_cs_outlif_profile_entry_id), "");
    ...
    {
        BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, epmf_cs_outlif_profile_fg_id, epmf_cs_outlif_profile_context_id), "");
        printf("TCAM Field Group %d was detach from context %d. \n", epmf_cs_outlif_profile_fg_id, epmf_cs_outlif_profile_context_id);
    }

    if (epmf_cs_outlif_profile_fg_id != BCM_FIELD_ID_INVALID)
    {
        BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, epmf_cs_outlif_profile_fg_id), "");
    ...
    if (epmf_cs_outlif_profile_context_id != BCM_FIELD_ID_INVALID)
    {
        BCM_IF_ERROR_RETURN_MSG(bcm_field_context_destroy(unit, epmf_cs_outlif_profile_stage, epmf_cs_outlif_profile_context_id), "");
    ...
    int outlif_profile)
{
    ...
    else
    {
         ...
         */
        BCM_IF_ERROR_RETURN_MSG(bcm_port_class_set(unit, outlif_gport, bcmPortClassFieldEgressVportCs, outlif_profile), "");
    ...
    int outrif_profile)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_port_class_set(unit, intf_gport, bcmPortClassFieldEgressVport, outrif_profile), "");
...
cint_field_epmf_cs_outlif_profile_main(
    ...
    int outlif_profile)
{
    BCM_IF_ERROR_RETURN_MSG(cint_field_epmf_cs_outlif_profile_set_outlif_profile(unit, outlif_gport, outlif_profile), "");


    BCM_IF_ERROR_RETURN_MSG(cint_field_epmf_cs_outlif_profile_ctx_create(unit, outlif_profile, 1), "");


    BCM_IF_ERROR_RETURN_MSG(cint_field_epmf_cs_outlif_profile_fg_create(unit), "");
    ...
    int outlif_profile)
{
    ...
    {
        BCM_IF_ERROR_RETURN_MSG(cint_field_epmf_cs_outlif_profile_ctx_create(unit, outlif_profile, 1), "");
        BCM_IF_ERROR_RETURN_MSG(cint_field_epmf_cs_outlif_profile_fg_disable_filters_create(unit), "");
    }
    return BCM_E_NONE;
}
...
cint_field_epmf_cs_outrif_profile_main(
    ...
    int outrif_profile)
{
    BCM_IF_ERROR_RETURN_MSG(cint_field_epmf_cs_outlif_profile_set_outrif_profile(unit, in_port, out_port, outrif_profile), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_epmf_cs_outlif_profile_ctx_create(unit, outrif_profile, 0), "");
