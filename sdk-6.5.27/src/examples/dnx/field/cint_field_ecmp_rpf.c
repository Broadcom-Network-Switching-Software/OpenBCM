 ...
 * Test Scenario - start
   ...
   cint;
   int unit = 0;
   bcm_field_context_t context_id_ipmf3 = 0;
   int in_port_1 = 200;
   int in_port_2 = 201;
   int out_port = 202;
 ...
 */
    ...
    int unit)
 {
    ...
    if (rv == BCM_E_EXISTS)
    {
        printf("bcmRxTrapUcStrictRpfFail already exists\n");
        return BCM_E_NONE;
    }

    BCM_IF_ERROR_RETURN_MSG(bcm_rx_trap_set(unit, rpf_uc_strict_trap, &config), "");
 ...
 */
    ...
    int unit)
 {
     ...
     * set uc strict to drop packet
     */
    BCM_IF_ERROR_RETURN_MSG(bcm_rx_trap_type_create(unit, 0, bcmRxTrapUserDefine, &cint_field_ecmp_rpf_pmf_info.rpf_uc_ecmp_strict_trap), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_rx_trap_set(unit, cint_field_ecmp_rpf_pmf_info.rpf_uc_ecmp_strict_trap, &config), "");
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_rx_trap_type_destroy(unit, cint_field_ecmp_rpf_pmf_info.rpf_uc_ecmp_strict_trap), "");
 ...
 */
    ...
    int out_port)
 {
    ...
    BCM_IF_ERROR_RETURN_MSG(get_first_fec_in_range_which_not_in_ecmp_range(unit,0,0,&cint_field_ecmp_rpf_pre_pmf_info.fec_id_fwd),"");
    cint_field_ecmp_rpf_pre_pmf_info.fec_id_fwd = cint_field_ecmp_rpf_pre_pmf_info.fec_id_fwd + 5;
    cint_field_ecmp_rpf_pre_pmf_info.fec_id = cint_field_ecmp_rpf_pre_pmf_info.fec_id_fwd +1 ;
    fec_fwd = cint_field_ecmp_rpf_pre_pmf_info.fec_id_fwd;
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(in_port_intf_set(unit, cint_field_ecmp_rpf_pre_pmf_info.in_port_1, cint_field_ecmp_rpf_pre_pmf_info.intf_in_1), "");
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(in_port_intf_set(unit, cint_field_ecmp_rpf_pre_pmf_info.in_port_2, cint_field_ecmp_rpf_pre_pmf_info.intf_in_2), "");
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(out_port_set(unit, cint_field_ecmp_rpf_pre_pmf_info.out_port), "");
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create(unit, cint_field_ecmp_rpf_pre_pmf_info.intf_in_1, cint_field_ecmp_rpf_pre_pmf_info.intf_in_mac_address_1), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_l3_ingress_create(unit, l3_ing_if, cint_field_ecmp_rpf_pre_pmf_info.intf_in_1), "");
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create(unit, cint_field_ecmp_rpf_pre_pmf_info.intf_in_2, cint_field_ecmp_rpf_pre_pmf_info.intf_in_mac_address_2), "");
    printf("Created In Eth-Rif %d with MAC address %d:%d:%d:%d:%d:%d.\n", 
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_l3_ingress_create(unit, l3_ing_if, cint_field_ecmp_rpf_pre_pmf_info.intf_in_2), "");
    printf("In Eth-RIF %d set to VRF %d urpf_mode bcmL3IngressUrpfStrict.\n", 
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create(unit, cint_field_ecmp_rpf_pre_pmf_info.intf_out, cint_field_ecmp_rpf_pre_pmf_info.intf_out_mac_address), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create(unit, fec_fwd, cint_field_ecmp_rpf_pre_pmf_info.intf_out, cint_field_ecmp_rpf_pre_pmf_info.encap_id_fwd, gport_out, 0,flags2), "");
     ...
     for (iter = 0; iter < ECMP_RPF_NOF_MEMBERS_ECMP_GROUP; iter++)
     {
          ...
          */
         BCM_IF_ERROR_RETURN_MSG(l3__egress_only_encap__create(unit, 0, &cint_field_ecmp_rpf_pre_pmf_info.encap_id, cint_field_ecmp_rpf_pre_pmf_info.arp_next_hop_mac, 0), "");
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(bcm_l3_egress_ecmp_create(unit, &ecmp, ECMP_RPF_NOF_MEMBERS_ECMP_GROUP, intf_array), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv4(unit, cint_field_ecmp_rpf_pre_pmf_info.host_dip, cint_field_ecmp_rpf_pre_pmf_info.vrf, fec_fwd, 0, 0), "");
   ...
   BCM_IF_ERROR_RETURN_MSG(add_route_ipv4_rpf(unit, cint_field_ecmp_rpf_pre_pmf_info.host_sip,0xffffffff, cint_field_ecmp_rpf_pre_pmf_info.vrf, cint_field_ecmp_rpf_pre_pmf_info.ecmp_id), "");
    printf("add_route_ipv4_rpf: host %u VRF %d ecmp_id %d, encap_id %d, destination %d.\n",
 ...
 */
 int field_ecmp_rpf_pmf(int unit, bcm_field_context_t context_id, uint8 is_mc)
 {
     ...
     BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &cint_field_ecmp_rpf_pmf_info.ecmp_lookup_fg_id), "");
     ...
     BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, cint_field_ecmp_rpf_pmf_info.ecmp_lookup_fg_id, context_id, &attach_info), "");
     ...
     BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &cint_field_ecmp_rpf_pmf_info.trap_fg_id), "");
     ...
     BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, cint_field_ecmp_rpf_pmf_info.trap_fg_id, context_id, &attach_info), "");
     ...
     BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, cint_field_ecmp_rpf_pmf_info.trap_fg_id, &entry_info, &cint_field_ecmp_rpf_pmf_info.entry_handle_trap), "");
 ...
 */
 int field_ecmp_rpf_pmf_destroy(int unit, bcm_field_context_t context_id)
 {
     ...
     BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit,cint_field_ecmp_rpf_pmf_info.ecmp_lookup_fg_id,context_id), "");
     printf("Detach FG_ID(%d) from context (%d) \n",cint_field_ecmp_rpf_pmf_info.ecmp_lookup_fg_id,context_id);
     
     BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, cint_field_ecmp_rpf_pmf_info.ecmp_lookup_fg_id), "");
     printf("Delete FG_ID(%d) \n",cint_field_ecmp_rpf_pmf_info.ecmp_lookup_fg_id);

     BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, cint_field_ecmp_rpf_pmf_info.trap_fg_id, &entry_qual_info[0], cint_field_ecmp_rpf_pmf_info.entry_handle_trap), "");
 
     BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit,cint_field_ecmp_rpf_pmf_info.trap_fg_id,context_id), "");
     printf("Detach FG_ID(%d) from context (%d) \n",cint_field_ecmp_rpf_pmf_info.trap_fg_id,context_id);
     
     BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, cint_field_ecmp_rpf_pmf_info.trap_fg_id), "");
 ...
 */
 int field_ecmp_rpf_pmf_entry_add(int unit, bcm_field_context_t context_id, bcm_if_t ecmp_id, int intf_id)
 {
     ...
     BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, cint_field_ecmp_rpf_pmf_info.ecmp_lookup_fg_id, &entry_info, NULL), "");
 ...
 */
 int field_ecmp_rpf_pmf_entry_delete(int unit, bcm_field_context_t context_id, bcm_if_t ecmp_id, int intf_id)
 {
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, cint_field_ecmp_rpf_pmf_info.ecmp_lookup_fg_id, entry_qual_info, 0), "");
 ...
 */
 int field_ecmp_rpf_main(int unit, bcm_field_context_t context_id_ipmf3, int in_port_1, int in_port_2, int out_port)
 {
    ...
    BCM_IF_ERROR_RETURN_MSG(field_ecmp_rpf_trap_pre_pmf(unit), "");

    BCM_IF_ERROR_RETURN_MSG(field_ecmp_rpf_trap_pmf(unit), "");

    BCM_IF_ERROR_RETURN_MSG(field_ecmp_rpf_pre_pmf(unit, in_port_1, in_port_2, out_port), "");

    BCM_IF_ERROR_RETURN_MSG(field_ecmp_rpf_pmf(unit, context_id_ipmf3, FALSE), "");

    /* 
     * Add entries for the ECMP interfaces.
     */

    BCM_IF_ERROR_RETURN_MSG(field_ecmp_rpf_pmf_entry_add(unit, context_id_ipmf3, cint_field_ecmp_rpf_pre_pmf_info.ecmp_id, cint_field_ecmp_rpf_pre_pmf_info.intf_in_1), "");

    BCM_IF_ERROR_RETURN_MSG(field_ecmp_rpf_pmf_entry_add(unit, context_id_ipmf3, cint_field_ecmp_rpf_pre_pmf_info.ecmp_id, cint_field_ecmp_rpf_pre_pmf_info.intf_in_2), "");
...
{
    BCM_IF_ERROR_RETURN_MSG(field_ecmp_rpf_pmf_entry_delete(unit, context_id_ipmf3, cint_field_ecmp_rpf_pre_pmf_info.ecmp_id, cint_field_ecmp_rpf_pre_pmf_info.intf_in_1), "");

    BCM_IF_ERROR_RETURN_MSG(field_ecmp_rpf_pmf_entry_delete(unit, context_id_ipmf3, cint_field_ecmp_rpf_pre_pmf_info.ecmp_id, cint_field_ecmp_rpf_pre_pmf_info.intf_in_2), "");

    BCM_IF_ERROR_RETURN_MSG(field_ecmp_rpf_pmf_destroy(unit, context_id_ipmf3), "");

    BCM_IF_ERROR_RETURN_MSG(field_ecmp_rpf_pre_pmf_destroy(unit), "");

    BCM_IF_ERROR_RETURN_MSG(field_ecmp_rpf_trap_pmf_destroy(unit), "");
