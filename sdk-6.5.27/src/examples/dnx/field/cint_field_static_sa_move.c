...
int field_static_sa_move_main(int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, cint_attach_fg_id, &ent_info, &cint_attach_entry_id), "");
...
int field_static_sa_move_destroy(int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit,cint_attach_fg_id,entry_qual_info,cint_attach_entry_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit,cint_attach_fg_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_destroy(unit, action_drop), "");
