...
int cint_field_stat_sampling_main(int unit, bcm_field_context_t context_id, int stat_sampling_code, int stat_sampling_qualifier)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &cint_stat_sampling_fg_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, cint_stat_sampling_fg_id, context_id, &attach_info), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, cint_stat_sampling_fg_id, &ent_info, &cint_stat_sampling_ent_id), "");
...
{
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, cint_stat_sampling_fg_id, NULL, cint_stat_sampling_ent_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, cint_stat_sampling_fg_id, context_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, cint_stat_sampling_fg_id), "");
...
int cint_field_stat_sampling_qual_main(int unit, bcm_field_context_t context_id, int stat_sampling_code, int stat_sampling_qualifier)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &cint_stat_sampling_fg_id_qual), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, cint_stat_sampling_fg_id_qual, context_id, &attach_info), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, cint_stat_sampling_fg_id_qual, &ent_info, &cint_stat_sampling_ent_id_qual), "");
...
int cint_field_stat_sampling_destroy(int unit, bcm_field_context_t context_id_ipmf1, bcm_field_context_t context_id_ipmf3)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, cint_stat_sampling_fg_id, context_id_ipmf1), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, cint_stat_sampling_fg_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, cint_stat_sampling_fg_id_qual, NULL, cint_stat_sampling_ent_id_qual), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, cint_stat_sampling_fg_id_qual, context_id_ipmf3), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, cint_stat_sampling_fg_id_qual), "");
