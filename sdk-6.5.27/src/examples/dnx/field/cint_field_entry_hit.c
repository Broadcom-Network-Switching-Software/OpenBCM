    ...
    int unit)
{
    ...
    /** Create FWD context. */
    BCM_IF_ERROR_RETURN_MSG(field_presel_fwd_layer_main(unit, cint_field_entry_hit_presel_id, cint_field_entry_hit_field_stage,
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &cint_field_entry_hit_fg_info,
                             &cint_field_entry_hit_fg_id), "");


    printf("Field Group ID %d was created. \n", cint_field_entry_hit_fg_id);

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, cint_field_entry_hit_fg_id, cint_field_entry_hit_context_id,
                                        &attach_info), "");
    ...
    bcm_core_t core_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, cint_field_entry_hit_fg_id, &entry_info, &cint_field_entry_hit_entry_handle), "");
    ...
    uint8 entry_hit_verify)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_hit_get(unit, 0, cint_field_entry_hit_entry_handle, &entry_hit_core_bmp), "");
...
cint_field_entry_hit_destroy(
    int unit)
{
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, cint_field_entry_hit_fg_id, NULL, cint_field_entry_hit_entry_handle), "");


    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, cint_field_entry_hit_fg_id, cint_field_entry_hit_context_id), "");


    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, cint_field_entry_hit_fg_id), "");


    BCM_IF_ERROR_RETURN_MSG(field_presel_fwd_layer_destroy(unit, cint_field_entry_hit_presel_id, cint_field_entry_hit_field_stage,
                                        cint_field_entry_hit_context_id), "");
