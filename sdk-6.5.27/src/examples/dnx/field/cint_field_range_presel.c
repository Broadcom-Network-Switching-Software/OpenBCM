    ...
    bcm_field_stage_t stage)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_create(unit, 0, stage, &context_info, &CINT_FIELD_RANGE_PRESEL_CONTEXT_ID), "");
    ...
    bcm_field_stage_t stage)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &CINT_FIELD_RANGE_PRESEL_FG_ID), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, CINT_FIELD_RANGE_PRESEL_FG_ID, context_id, &attach_info), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, CINT_FIELD_RANGE_PRESEL_FG_ID, &entry_info, &entry_id), "");
    ...
    int range_configuration)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_range_set(unit, 0, stage, CINT_FIELD_RANGE_PRESEL_RANGE_ID, &range_info), "");
    ...
    int range_configuration)
{
     ...
     * Set the range.
     */
    BCM_IF_ERROR_RETURN_MSG(cint_field_range_presel_vport_range_set(unit, stage, range_configuration), "");

    /**
     * Create a context and set a preselector.
     */
    BCM_IF_ERROR_RETURN_MSG(cint_field_range_presel_context_create_presel_set(unit, stage), "");

    /**
     * Create a FG, attach it to a context and add an entry.
     */
    BCM_IF_ERROR_RETURN_MSG(cint_field_range_presel_fg_create_context_attach_entry_add(unit, CINT_FIELD_RANGE_PRESEL_CONTEXT_ID, stage), "");
    ...
    bcm_field_stage_t stage)
{
    ...
    */
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, CINT_FIELD_RANGE_PRESEL_FG_ID, NULL, entry_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, CINT_FIELD_RANGE_PRESEL_FG_ID, CINT_FIELD_RANGE_PRESEL_CONTEXT_ID), "");


    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, CINT_FIELD_RANGE_PRESEL_FG_ID), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_destroy(unit, stage, CINT_FIELD_RANGE_PRESEL_CONTEXT_ID), "");
