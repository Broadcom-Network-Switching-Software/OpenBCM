...
int field_tcam_prefix_main(int unit, int src_mac_val, int tc_val, int bad_tc_val)
{
     ...
     * Presel if not congigured for this context, since we expect to hit the other fg
     */
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &fg1_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, fg1_id, context_id, &attach_info), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &fg2_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, fg2_id, 0, &attach_info), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, fg1_id, &ent_info, &ent1_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, fg2_id, &ent_info, &ent2_id), "");
...
{
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, fg1_id, NULL, ent1_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, fg2_id, NULL, ent2_id), "");

    /* Detach the IPMF2 FG from its context */
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, fg1_id, context_id), "");

    /* Detach the IPMF2 FG from its context */
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, fg2_id, 0 /*Default context */), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, fg1_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, fg2_id), "");
