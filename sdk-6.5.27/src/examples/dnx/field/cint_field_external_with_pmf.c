    ...
    bcm_field_group_t * fg_id_p)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &cint_field_external_pmf_external_uda), "");
    ...
    bcm_field_group_t * fg_id_p)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_external_pmf_fg_add_flags(unit, 0, fg_info_p, fg_id_p), "");
    ...
    bcm_field_group_info_t *fg_info_p)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, external_fg_id, &entry_info, &cint_field_external_pmf_entry_id[index]), "");
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_presel_set(unit, 0, &cint_field_external_pmf_presel_entry_id, &ipmf1_p_data), "");
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_external_pmf_ipmf2_payload_qual), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_info_get(unit, cint_field_external_pmf_ipmf2_action_type, bcmFieldStageIngressPMF2, &action_info), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &cint_field_external_pmf_ipmf2_uda), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_action_offset_get(unit, 0, cint_field_external_pmf_fg_id, cint_field_external_pmf_external_uda, &action_offset_in_fg), "");
...
cint_field_external_pmf_main(int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_external_pmf_fg_add(unit, &fg_info, &cint_field_external_pmf_fg_id), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_external_pmf_fg_attach(unit, cint_field_external_pmf_fg_id, &fg_info, cint_field_external_pmf_external_app_type, cint_field_external_pmf_payload_id, cint_field_external_pmf_payload_offset), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_switch_control_set(unit, bcmSwitchExternalTcamSync, 0), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_external_pmf_entry_add(unit, 0, cint_field_external_pmf_fg_id, &fg_info), "");
...
cint_field_external_pmf_destroy(int unit)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, cint_field_external_pmf_fg_id, NULL, cint_field_external_pmf_entry_id[0]), "");

    presel_entry_data.entry_valid = FALSE;
    presel_entry_data.context_id = 0;
    BCM_IF_ERROR_RETURN_MSG(bcm_field_presel_set(unit, 0, &cint_field_external_pmf_presel_entry_id, &presel_entry_data), "");
...
cint_field_external_pmf_destroy_all(int unit)
{
    ...
    {
        BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, cint_field_external_pmf_fg_id, NULL, cint_field_external_pmf_entry_id[index]), "");
    }
...
cint_field_external_counters_pmf_main(int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_external_pmf_fg_add_flags(unit, (BCM_FIELD_FLAG_EXTERNAL_COUNTERS),
                                              &acl_counters_fg_info, &cint_field_external_pmf_fg_id), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_external_pmf_fg_attach(unit, cint_field_external_pmf_fg_id, &acl_counters_fg_info, cint_field_external_pmf_external_app_type,
    ...
    for (index=0; index<5; index++)
    {
        BCM_IF_ERROR_RETURN_MSG(cint_field_external_pmf_entry_add(unit, index, cint_field_external_pmf_fg_id, &acl_counters_fg_info), "");
    }
...
cint_field_external_counters_get_main(int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_info_get(unit, cint_field_external_pmf_fg_id, &acl_counters_fg_info), "");

    printf("before kbp_db_counter_read_initiate\n\n");
    BCM_IF_ERROR_RETURN_MSG(dnx_kbp_db_counter_read_initiate(unit, acl_counters_fg_info.ext_acl_db), "");

    do {
        BCM_IF_ERROR_RETURN_MSG(dnx_kbp_db_is_counter_read_complete(unit, acl_counters_fg_info.ext_acl_db, &is_complete), "");
    } while (is_complete == 0);
    ...
    for (index=0; index<3; index++)
    {
        ...
        BCM_IF_ERROR_RETURN_MSG(dnx_kbp_entry_get_counter_value(unit, acl_counters_fg_info.ext_acl_db, &entry_handle, &value), "");
