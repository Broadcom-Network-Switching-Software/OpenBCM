 ...
 *
 * Test Scenario - start
   cint ../../../../src/examples/dnx/field/cint_field_fem_increment.c
   cint;
   int unit = 0;
    ...
    bcm_field_context_t context_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &Cint_field_fem_increment_void_action_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &Cint_field_fem_increment_fg_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_fem_action_add(unit,0 , Cint_field_fem_increment_fg_id, action_priority, &fem_action_info), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, Cint_field_fem_increment_fg_id, context_id, &attach_info), "");
...
cint_field_fem_increment_main(
    ...
    bcm_field_context_t context_id)
{
    BCM_IF_ERROR_RETURN_MSG(cint_field_fem_increment_config_ipmf2_de(unit, context_id), "");
    ...
    bcm_field_context_t context_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, Cint_field_fem_increment_fg_id, context_id), "");

    action_priority = BCM_FIELD_ACTION_POSITION(3, 2);
    BCM_IF_ERROR_RETURN_MSG(bcm_field_fem_action_delete(unit, Cint_field_fem_increment_fg_id, action_priority), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, Cint_field_fem_increment_fg_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_destroy(unit, Cint_field_fem_increment_void_action_id), "");
