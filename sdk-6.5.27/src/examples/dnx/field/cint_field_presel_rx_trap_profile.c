    ...
    int * trap_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_rx_trap_type_create(unit, 0, bcmRxTrapLinkLayerSaEqualsDa, trap_id), "");
    ...
    bcm_field_context_t  * context_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_presel_rx_trap_profile_fg_config(unit, *context_id), "");
    ...
    bcm_field_context_t context_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_info_get(unit, bcmFieldActionUDHData0, bcmFieldStageIngressPMF3, &action_info_get_size), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &cint_field_presel_rx_trap_profile_action_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &cint_field_presel_rx_trap_profile_fg_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, cint_field_presel_rx_trap_profile_fg_id, context_id, &attach_info), "");
    ...
    bcm_field_context_t context_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, cint_field_presel_rx_trap_profile_fg_id, context_id), "");

    /* Delete constant FG */
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, cint_field_presel_rx_trap_profile_fg_id), "");

    /* Delete user define action */
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_destroy(unit, cint_field_presel_rx_trap_profile_action_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_destroy(unit, bcmFieldStageIngressPMF3, context_id), "");
