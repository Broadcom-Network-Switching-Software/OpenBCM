...
int cint_field_exem_5fg_same_entries_ud_qual_create(int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_exem_5fg_same_entries_key_gen_qual), "");
...
int cint_field_exem_5fg_same_entries_ctx_create(int unit)
{
    ...
    for (ii = 0; ii < cint_field_exem_5fg_same_entries_nof_ctxs; ii++)
    {
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_field_context_create(unit, 0, cint_field_exem_5fg_same_entries_ctx_stage, &context_info, &cint_field_exem_5fg_same_entries_context_id_list[ii]), "");
...
int cint_field_exem_5fg_same_entries_fg_configure(int unit)
{
    ...
    {
        BCM_IF_ERROR_RETURN_MSG(cint_field_exem_5fg_same_entries_add_field_group(unit, &fg_info[ii], ii), "");
    }
	
    for (ii = 0; ii < cint_field_exem_5fg_same_entries_nof_fgs; ii++)
    {
        BCM_IF_ERROR_RETURN_MSG(cint_field_exem_5fg_same_entries_attach_field_group(unit, fg_info[ii], ii), "");
    }

    for (ii = 0; ii < cint_field_exem_5fg_same_entries_nof_fgs; ii++)
    {
        BCM_IF_ERROR_RETURN_MSG(cint_field_exem_5fg_same_entries_add_entries(unit, fg_info[ii], ii), "");
    }
        ...
        int fg_idx)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, fg_info, &cint_field_exem_5fg_same_entries_fg_id_list[fg_idx]), "");
        ...
        int fg_idx)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, cint_field_exem_5fg_same_entries_fg_id_list[fg_idx], cint_field_exem_5fg_same_entries_context_id_list[fg_idx * 2], &attach_info), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, cint_field_exem_5fg_same_entries_fg_id_list[fg_idx], cint_field_exem_5fg_same_entries_context_id_list[fg_idx * 2 + 1], &attach_info), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_param_set(unit, 0, cint_field_exem_5fg_same_entries_ctx_stage, cint_field_exem_5fg_same_entries_context_id_list[fg_idx * 2], &param_info), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_param_set(unit, 0, cint_field_exem_5fg_same_entries_ctx_stage, cint_field_exem_5fg_same_entries_context_id_list[fg_idx * 2 + 1], &param_info), "");
        ...
        int fg_idx)
{
   ...
   for (jj = 0; jj < cint_field_exem_5fg_same_entries_nof_entries_per_fg ; jj++)
   {
       ...
       BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, cint_field_exem_5fg_same_entries_fg_id_list[fg_idx], &cint_field_exem_5fg_same_entries_entry_info_list[entry_index], NULL), "");
   }
...
int cint_field_exem_5fg_same_entries_main(int unit)
{
     ...
     * Create qualifier
     */
    BCM_IF_ERROR_RETURN_MSG(cint_field_exem_5fg_same_entries_ud_qual_create(unit), "");

    /*
     * Create contexts
     */
    BCM_IF_ERROR_RETURN_MSG(cint_field_exem_5fg_same_entries_ctx_create(unit), "");

    /*
     * Create field groups and add entries
     */
    BCM_IF_ERROR_RETURN_MSG(cint_field_exem_5fg_same_entries_fg_configure(unit), "");
    return BCM_E_NONE;
}
...
int cint_field_exem_5fg_same_entries_destroy(int unit)
{
    ...
    for (ii = 0; ii < cint_field_exem_5fg_same_entries_nof_fgs; ii++)
    {
        for (jj = 0; jj < cint_field_exem_5fg_same_entries_nof_entries_per_fg; jj++)
        {
             ...
             */
            BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, cint_field_exem_5fg_same_entries_fg_id_list[ii], cint_field_exem_5fg_same_entries_entry_info_list[ii * cint_field_exem_5fg_same_entries_nof_entries_per_fg + jj].entry_qual, 0), "");
        }
         ...
         */
        BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, cint_field_exem_5fg_same_entries_fg_id_list[ii], cint_field_exem_5fg_same_entries_context_id_list[ii * 2]), "");
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, cint_field_exem_5fg_same_entries_fg_id_list[ii], cint_field_exem_5fg_same_entries_context_id_list[ii * 2 + 1]), "");
         ...
         */
        BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, cint_field_exem_5fg_same_entries_fg_id_list[ii]), "");
    ...
    for(ii = 0; ii < cint_field_exem_5fg_same_entries_nof_ctxs; ii++)
    {
        BCM_IF_ERROR_RETURN_MSG(bcm_field_context_destroy(unit, cint_field_exem_5fg_same_entries_ctx_stage, cint_field_exem_5fg_same_entries_context_id_list[ii]), "");
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_destroy(unit, cint_field_exem_5fg_same_entries_key_gen_qual), "");
