    ...
    int pair_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &Cint_field_compare_fg_id_pair), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, Cint_field_compare_fg_id_pair, Cint_field_compare_context_id, &attach_info), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, Cint_field_compare_fg_id_pair, &entry_info, &Cint_field_compare_entry_arr[0]), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, Cint_field_compare_fg_id_pair, &entry_info, &Cint_field_compare_entry_arr[1]), "");
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_compare_config(unit, bcmFieldStageIngressPMF1, Cint_field_compare_context_id), "");

    printf("Create a preselector which is going to qualify upon Ethernet header \n");
    BCM_IF_ERROR_RETURN_MSG(cint_field_compare_presel_set(unit, bcmFieldStageIngressPMF1, Cint_field_compare_context_id), "");

    printf("Create TCAM Fg and Attach it to the context and add an entry. \n");
    BCM_IF_ERROR_RETURN_MSG(cint_field_compare_fg_config(unit, Cint_field_compare_context_id, 0), "");
    return BCM_E_NONE;
}
    ...
    int unit)
{
    ...
    {
        BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, Cint_field_compare_fg_id_pair, NULL, Cint_field_compare_entry_arr[entry_iterator]), "");
    }
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, Cint_field_compare_fg_id_pair, Cint_field_compare_context_id), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, Cint_field_compare_fg_id_pair), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_compare_destroy(unit, bcmFieldStageIngressPMF1, Cint_field_compare_context_id, 0), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_destroy(unit, bcmFieldStageIngressPMF1, Cint_field_compare_context_id), "");
