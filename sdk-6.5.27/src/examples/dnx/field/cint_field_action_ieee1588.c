 ...
 * cint_reset();
 * exit;
  cint ../../../../src/examples/dnx/field/cint_field_action_ieee1588.c
  cint;
  int unit = 0;
...
{
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, ieee1588_fg_id, NULL, ieee1588_ent_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, ieee1588_fg_id, context_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, ieee1588_fg_id), "");
    ...
    )
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &ieee1588_fg_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, ieee1588_fg_id, context_id, &attach_info), "");
    ...
    printf("Adding Entry\n");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, ieee1588_fg_id, &ent_info, &ieee1588_ent_id), "");
