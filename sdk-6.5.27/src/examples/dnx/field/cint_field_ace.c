...
int field_ace_main(int unit, bcm_field_context_t epmf_context_id, int write_value)
{
   ...
   BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &Cint_field_ace_action_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, epmf_fg_id, epmf_context_id, &epmf_attach_info), "");
...
int field_ace_destroy(int unit, bcm_field_context_t epmf_context_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, epmf_fg_id, epmf_context_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_destroy(unit, Cint_field_ace_action_id), "");
