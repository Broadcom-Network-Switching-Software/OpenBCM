    ...
    int unit)
{
    ...
    */
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_create(unit, 0, bcmFieldStageIngressPMF1, &context_info, &cint_field_6_hash_keys_context_id), "");
    ...
    */
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_hash_create(unit, 0, bcmFieldStageIngressPMF1, cint_field_6_hash_keys_context_id, &cint_field_6_hash_keys_hash_info), "");
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_hash_create(unit, BCM_FIELD_FLAG_UPDATE, bcmFieldStageIngressPMF1, cint_field_6_hash_keys_context_id, &cint_field_6_hash_keys_hash_info), "");
...
int cint_field_6_hash_keys_destroy(
    int unit)
{
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_hash_destroy(unit, bcmFieldStageIngressPMF1, cint_field_6_hash_keys_context_id), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_destroy(unit, bcmFieldStageIngressPMF1, cint_field_6_hash_keys_context_id), "");
