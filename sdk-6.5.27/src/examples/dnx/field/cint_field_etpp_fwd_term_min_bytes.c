    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_create(unit, 0, bcmFieldStageIngressPMF3, &context_info, &etpp_fwd_term_context_id_ipmf3_v4), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &etpp_fwd_term_qual_const_one), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &etpp_fwd_term_qual_layer_offset), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_info_get(unit, bcmFieldActionParsingStartOffset, fg_info.stage, &pars_offset_action_info), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &pars_offset_action_info, &etpp_fwd_term_parsing_start_offset_action_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &etpp_fwd_term_de_fg_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, etpp_fwd_term_de_fg_id, etpp_fwd_term_context_id_ipmf3_v4, &attach_info), "");


    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, etpp_fwd_term_de_fg_id, etpp_fwd_term_context_id_ipmf3_v6, &attach_info), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, etpp_fwd_term_tcam_fg_id, etpp_fwd_term_context_id_ipmf3_v4, &attach_info), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, etpp_fwd_term_tcam_fg_id, &ent_info, &etpp_fwd_term_ent_3_ipv4_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, etpp_fwd_term_tcam_fg_id, &ent_info, &etpp_fwd_term_ent_4_ipv4_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, etpp_fwd_term_tcam_fg_id, &ent_info, &etpp_fwd_term_ent_4_ipv6_id), "");


    ent_info.entry_qual[0].value[0] = 3; /* fwd_layer_index = 3 */
    ent_info.entry_action[1].value[0] = 3; /* Egress FWD Index should be equal to fwd_layer_index */

    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, etpp_fwd_term_tcam_fg_id, &ent_info, &etpp_fwd_term_ent_3_ipv6_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, etpp_fwd_term_tcam_fg_id, &ent_info, &etpp_fwd_term_ent_def_id), "");
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, etpp_fwd_term_tcam_fg_id, NULL, etpp_fwd_term_ent_3_ipv4_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, etpp_fwd_term_tcam_fg_id, NULL, etpp_fwd_term_ent_4_ipv4_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, etpp_fwd_term_tcam_fg_id, NULL, etpp_fwd_term_ent_3_ipv6_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, etpp_fwd_term_tcam_fg_id, NULL, etpp_fwd_term_ent_4_ipv6_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, etpp_fwd_term_tcam_fg_id, NULL, etpp_fwd_term_ent_def_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, etpp_fwd_term_tcam_fg_id, etpp_fwd_term_context_id_ipmf3_v4), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, etpp_fwd_term_tcam_fg_id, etpp_fwd_term_context_id_ipmf3_v6), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, etpp_fwd_term_tcam_fg_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, etpp_fwd_term_de_fg_id, etpp_fwd_term_context_id_ipmf3_v4), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, etpp_fwd_term_de_fg_id, etpp_fwd_term_context_id_ipmf3_v6), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, etpp_fwd_term_de_fg_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_destroy(unit, etpp_fwd_term_qual_const_one), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_destroy(unit, etpp_fwd_term_qual_layer_offset), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_destroy(unit, etpp_fwd_term_parsing_start_offset_action_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_destroy(unit, bcmFieldStageIngressPMF3, etpp_fwd_term_context_id_ipmf3_v4), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_destroy(unit, bcmFieldStageIngressPMF3, etpp_fwd_term_context_id_ipmf3_v6), "");
