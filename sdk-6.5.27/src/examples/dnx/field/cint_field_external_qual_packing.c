    ...
    bcm_field_group_t * fg_id_p)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_external_qual_packing_external_udq_tcp_flags_3lsb), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &cint_field_external_qual_packing_external_uda), "");
    ...
    uint32 payload_offset)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_info_get(unit, bcmFieldQualifyTcpControl, bcmFieldStageExternal, &qual_info_get), "");
    ...
    bcm_field_group_info_t *fg_info_p)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, external_fg_id, &entry_info, &cint_field_external_qual_packing_entry_id), "");
...
cint_field_external_qual_packing_main(int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_external_qual_packing_fg_add(unit, &fg_info, &cint_field_external_qual_packing_fg_id), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_external_qual_packing_fg_attach(unit, cint_field_external_qual_packing_fg_id, &fg_info, cint_field_external_qual_packing_external_app_type, cint_field_external_qual_packing_payload_id, cint_field_external_qual_packing_payload_offset), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_switch_control_set(unit, bcmSwitchExternalTcamSync, 0), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_external_qual_packing_entry_add(unit, cint_field_external_qual_packing_fg_id, &fg_info), "");
...
cint_field_external_qual_packing_destroy(int unit)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, cint_field_external_qual_packing_fg_id, NULL, cint_field_external_qual_packing_entry_id), "");
