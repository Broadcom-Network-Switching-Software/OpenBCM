...
int field_app_type_main(int unit, bcm_field_presel_t presel_id, bcm_field_AppType_t app_type, bcm_port_t in_port)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_create(unit, 0, bcmFieldStageIngressPMF1, &context_info, &cint_field_app_type_context_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &cint_field_app_type_fg_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, cint_field_app_type_fg_id, cint_field_app_type_context_id, &attach_info), "");
    ...
    printf("Adding Entry\n");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, cint_field_app_type_fg_id, &ent_info, &cint_field_app_type_entry_id), "");
...
int field_app_type_destroy(int unit, bcm_field_presel_t presel_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, cint_field_app_type_fg_id, NULL, cint_field_app_type_entry_id), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, cint_field_app_type_fg_id, cint_field_app_type_context_id), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, cint_field_app_type_fg_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_destroy(unit, bcmFieldStageIngressPMF1, cint_field_app_type_context_id), "");
