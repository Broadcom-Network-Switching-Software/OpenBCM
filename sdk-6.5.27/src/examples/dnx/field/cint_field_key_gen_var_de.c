    ...
    uint32 key_gen_val)
{
    ...
    {
        BCM_IF_ERROR_RETURN_MSG(cint_field_key_gen_var_de_qual_config(unit, stage, Cint_field_key_gen_var_de_qual_info_arr[qual_index]), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &Cint_field_key_gen_var_de_fg_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, Cint_field_key_gen_var_de_fg_id, context_id, &attach_info), "");
    ...
    bcm_field_context_t context_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, Cint_field_key_gen_var_de_fg_id, context_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, Cint_field_key_gen_var_de_fg_id), "");

    for(qual_index = 0; qual_index < Cint_field_key_gen_var_de_nof_quals; qual_index++)
    {

        BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_destroy(unit, Cint_field_key_gen_var_de_qual_info_arr[qual_index].qual_id), "");
    }
    return BCM_E_NONE;
}
