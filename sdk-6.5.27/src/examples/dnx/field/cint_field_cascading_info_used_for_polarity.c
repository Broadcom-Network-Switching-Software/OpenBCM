    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &Cint_field_cascading_info_used_for_polarity_de_val_bit_qual_id), "");
    ...
    bcm_field_context_t context_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &Cint_field_cascading_info_used_for_polarity_tcam_void_action_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &Cint_field_cascading_info_used_for_polarity_tcam_fg_id), "");
    printf("Field Group ID %d was created. \n", Cint_field_cascading_info_used_for_polarity_tcam_fg_id);

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, Cint_field_cascading_info_used_for_polarity_tcam_fg_id, context_id, &attach_info), "");
    printf("Field Group ID %d was attached to Context ID %d. \n", Cint_field_cascading_info_used_for_polarity_tcam_fg_id, context_id);

    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, Cint_field_cascading_info_used_for_polarity_tcam_fg_id,
            &entry_info, &Cint_field_cascading_info_used_for_polarity_tcam_entry_handle), "");
    ...
    bcm_field_group_t * fg_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_action_offset_get(unit, 0, Cint_field_cascading_info_used_for_polarity_tcam_fg_id,
    ...
    if (is_trap)
    {
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &Cint_field_cascading_info_used_for_polarity_de_const_trap_q_id), "");
    ...
    {
        int snoop_qual_offset = *(dnxc_data_get(unit, "field", "encoded_qual_actions_offset", "sniff_qualifier_offset", NULL));
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &Cint_field_cascading_info_used_for_polarity_de_const_snoop_q_id), "");
        ...
        Cint_field_cascading_info_used_for_polarity_de_const_snp_q_val =
            ((Cint_field_cascading_info_used_for_polarity_snp_code) | (Cint_field_cascading_info_used_for_polarity_trap_str << 9) |
                (Cint_field_cascading_info_used_for_polarity_trap_qual << snoop_qual_offset));
...
cint_field_cascading_info_used_for_polarity_main(
    ...
    bcm_field_context_t context_id)
{
    BCM_IF_ERROR_RETURN_MSG(cint_field_cascading_info_used_for_polarity_tcam_fg_create(unit, in_port, dst_mac_lsb, context_id), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_cascading_info_used_for_polarity_val_bit_qual_create(unit), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_cascading_info_used_for_polarity_de_fg_create(unit, TRUE, context_id, &Cint_field_cascading_info_used_for_polarity_de_trap_fg_id), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_cascading_info_used_for_polarity_de_fg_create(unit, FALSE, context_id,  &Cint_field_cascading_info_used_for_polarity_de_snoop_fg_id), "");
...
cint_field_cascading_info_used_for_polarity_destroy(
    ...
    bcm_field_context_t context_id)
{
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, Cint_field_cascading_info_used_for_polarity_tcam_fg_id, NULL,
                                Cint_field_cascading_info_used_for_polarity_tcam_entry_handle), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, Cint_field_cascading_info_used_for_polarity_de_trap_fg_id,
                                        context_id), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, Cint_field_cascading_info_used_for_polarity_de_snoop_fg_id,
                                        context_id), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, Cint_field_cascading_info_used_for_polarity_tcam_fg_id,
                                        context_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, Cint_field_cascading_info_used_for_polarity_tcam_fg_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, Cint_field_cascading_info_used_for_polarity_de_trap_fg_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, Cint_field_cascading_info_used_for_polarity_de_snoop_fg_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_destroy(unit, Cint_field_cascading_info_used_for_polarity_de_val_bit_qual_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_destroy(unit, Cint_field_cascading_info_used_for_polarity_de_const_trap_q_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_destroy(unit, Cint_field_cascading_info_used_for_polarity_de_const_snoop_q_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_destroy(unit, Cint_field_cascading_info_used_for_polarity_tcam_void_action_id), "");
