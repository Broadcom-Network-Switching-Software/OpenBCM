...
int field_attach_main(int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_create(unit, 0, bcmFieldStageIngressPMF1, &context_info, &cint_attach_context_id_ipv4), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, cint_attach_fg_id, cint_attach_context_id_ipv4, &attach_info), "");
...
int field_attach_destroy(int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, cint_attach_fg_id, cint_attach_context_id_ipv4), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, cint_attach_fg_id, cint_attach_context_id_eth), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_destroy(unit,bcmFieldStageIngressPMF1,cint_attach_context_id_eth), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_destroy(unit,bcmFieldStageIngressPMF1,cint_attach_context_id_ipv4), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit,cint_attach_fg_id,entry_qual_info,cint_attach_entry_id[0]), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit,cint_attach_fg_id), "");
