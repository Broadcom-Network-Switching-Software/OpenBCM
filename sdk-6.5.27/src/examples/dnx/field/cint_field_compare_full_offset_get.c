    ...
    bcm_field_context_t * context_id_p)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_compare_create(unit, 0, stage, *context_id_p, 0, &compare_info), "");
    ...
    bcm_field_context_t * context_id_p)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_presel_set(unit, 0, &Cint_field_compare_full_offset_get_presel_entry_id, &presel_entry_data), "");
    ...
    int pair_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, Cint_field_compare_full_offset_get_fg_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, Cint_field_compare_full_offset_get_fg_id, Cint_field_compare_full_offset_get_context_id, &attach_info), "");

    /**
     * Get the offset.
     * Give the enum value that you want to be compared.
     */
    BCM_IF_ERROR_RETURN_MSG(bcm_field_compare_operand_offset_get(unit, pair_id, bcmFieldCompareOperandNotEqual, &op_offset), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, Cint_field_compare_full_offset_get_fg_id, &entry_info, &Cint_field_compare_full_offset_get_entry_arr[0]), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, Cint_field_compare_full_offset_get_fg_id, &entry_info, &Cint_field_compare_full_offset_get_entry_arr[1]), "");
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_compare_full_offset_get_config(unit, bcmFieldStageIngressPMF1, Cint_field_compare_full_offset_get_context_id), "");

    printf("Create a preselector which is going to qualify upon Ethernet header \n");
    BCM_IF_ERROR_RETURN_MSG(cint_field_compare_full_offset_get_presel_set(unit, bcmFieldStageIngressPMF1, Cint_field_compare_full_offset_get_context_id), "");

    printf("Create TCAM Fg and Attach it to the context and add an entry. \n");
    BCM_IF_ERROR_RETURN_MSG(cint_field_compare_full_offset_get_fg_config(unit, Cint_field_compare_full_offset_get_context_id, 0), "");
    ...
    int unit)
{
    ...
    {
        BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, Cint_field_compare_full_offset_get_fg_id, NULL, Cint_field_compare_full_offset_get_entry_arr[entry_iterator]), "");

    }

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, Cint_field_compare_full_offset_get_fg_id, Cint_field_compare_full_offset_get_context_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, Cint_field_compare_full_offset_get_fg_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_compare_destroy(unit, bcmFieldStageIngressPMF1, Cint_field_compare_full_offset_get_context_id, 0), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_destroy(unit, bcmFieldStageIngressPMF1, Cint_field_compare_full_offset_get_context_id), "");
