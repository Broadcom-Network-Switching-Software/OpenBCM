...
int cint_field_user_qual_ethertype_main(int unit, int ether_type)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_always_hit_context_main(unit, cint_field_user_qual_ethertype_presel_id, bcmFieldStageIngressPMF1, &cint_field_user_qual_ethertype_context_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &etype_qual_info, &cint_field_user_qual_ethertype_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &cint_field_user_qual_ethertype_fg_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, cint_field_user_qual_ethertype_fg_id, cint_field_user_qual_ethertype_context_id, &attach_info), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, cint_field_user_qual_ethertype_fg_id, &ent_info, &cint_field_user_qual_ethertype_ent_id), "");
...
{
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, cint_field_user_qual_ethertype_fg_id, NULL, cint_field_user_qual_ethertype_ent_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, cint_field_user_qual_ethertype_fg_id, cint_field_user_qual_ethertype_context_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, cint_field_user_qual_ethertype_fg_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_destroy(unit, cint_field_user_qual_ethertype_id), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_always_hit_contex_destroy(unit, cint_field_user_qual_ethertype_presel_id, bcmFieldStageIngressPMF1, cint_field_user_qual_ethertype_context_id), "");
