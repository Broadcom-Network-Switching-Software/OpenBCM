...
int cint_field_evpn_ingress_fg_add(int unit, bcm_field_group_t *fg_id_p)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &dnx_evpn_field_info.esi_type_qual), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &dnx_evpn_field_info.esi_qual), "");
    ...
    */
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &dnx_evpn_field_info.esi_action), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &dnx_evpn_field_info.ing_fg.fg_info, fg_id_p), "");
...
int cint_field_evpn_ingress(int unit, int inlif_profile)
{
    ...
    if (feature_mpls_term_till_bos) {
        ...
        BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_fl_ingress(unit, inlif_profile), "");

        return BCM_E_NONE;
    }

    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_ingress_context_create(unit, &dnx_evpn_field_info.ing_fg.context_id, inlif_profile, 3,
                                                dnx_evpn_field_info.ing_fg.presel_id, "EVPN", &dnx_evpn_field_info.ing_fg.presel_entry_id), "");


    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_ingress_fg_add(unit, &dnx_evpn_field_info.ing_fg.fg_id), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_ingress_fg_attach(unit, dnx_evpn_field_info.ing_fg.context_id, dnx_evpn_field_info.ing_fg.fg_id), "");
...
int cint_field_evpn_fl_ingress_pmf1_fg_add(int unit, evpn_fg_info_s *fg)
{
    ...
    * Calling the API bcm_field_action_create for positive case
    */
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &dnx_evpn_field_info.esi_indication_action), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &ing_fg->fg_info, &ing_fg->fg_id), "");
...
int cint_field_evpn_fl_ingress_pmf1_fg_attach(int unit, evpn_fg_info_s * ing_pmf1_fg)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, ing_pmf1_fg->fg_id, ing_pmf1_fg->context_id, &attach_info), "");
...
int cint_field_evpn_fl_ingress_pmf1_install(int unit, int inlif_profile)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_fl_ingress_pmf1_context_create(unit,
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_fl_ingress_pmf1_fg_add(unit, &dnx_evpn_field_info.ing_pmf1_fg), "");


    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_fl_ingress_pmf1_fg_attach(unit, &dnx_evpn_field_info.ing_pmf1_fg), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, dnx_evpn_field_info.ing_pmf1_fg.fg_id, &entry_in_info, &entry_handle), "");

    /** Store the entry handle for destroy convenience.*/
    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_field_entry_handle_store(unit, entry_handle, dnx_evpn_field_info.ing_pmf1_fg.entry_handle), "");
    ...
    bcm_field_presel_entry_id_t * presel_entry_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_create(unit, 0, bcmFieldStageIngressPMF2, &context_info, context_id_p), "");
...
int cint_field_evpn_fl_ingress_pmf2_cas_fg_add(int unit, int fl_enable, evpn_fg_info_s *fg)
{
    ...
    if (dnx_evpn_field_info.esi_valid_qual == 0) {
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &dnx_evpn_field_info.esi_valid_qual), "");
...
int cint_field_evpn_fl_ingress_pmf2_cas_fg_attach(int unit, int fl_enable, evpn_fg_info_s * ing_pmf2_fg)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, ing_pmf2_fg->fg_id, ing_pmf2_fg->context_id, &attach_info), "");
...
int cint_field_evpn_fl_ingress_pmf2_install(int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_fl_ingress_pmf2_cas_context_create(unit, 1,
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_fl_ingress_pmf2_cas_fg_add(unit, 1, &dnx_evpn_field_info.ing_pmf2_fg1), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_fl_ingress_pmf2_cas_fg_attach(unit, 1, &dnx_evpn_field_info.ing_pmf2_fg1), "");

    printf("Install PMF2 configurations for EVPN without Flow Label.\n");

    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_fl_ingress_pmf2_cas_context_create(unit, 0,
                                                            dnx_evpn_field_info.ing_pmf1_fg,
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_fl_ingress_pmf2_cas_fg_add(unit, 0, &dnx_evpn_field_info.ing_pmf2_fg2), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_fl_ingress_pmf2_cas_fg_attach(unit, 0, &dnx_evpn_field_info.ing_pmf2_fg2), "");
...
int cint_field_evpn_fl_ingress(int unit, int inlif_profile)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_fl_ingress_pmf1_install(unit, inlif_profile), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_fl_ingress_pmf2_install(unit), "");
...
int cint_field_evpn_egress_context_create(int unit, bcm_field_context_t *context_id_p)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_presel_set(unit, 0, &dnx_evpn_field_info.egr_fg.presel_entry_id, &presel_entry_data), "");
...
int cint_field_evpn_egress_fg_add(int unit, bcm_field_group_t *fg_id_p)
{
    ...
    */
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &dnx_evpn_field_info.egr_fg.fg_info, fg_id_p), "");
        ...
        bcm_field_entry_t *entry_handle_p)
{
    ...
    /** Store the entry handle for destroy convenience.*/
    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_field_entry_handle_store(unit, *entry_handle_p, dnx_evpn_field_info.egr_fg.entry_handle), "");
        ...
        uint8 is_drop)
{
    ...
    /** Store the entry handle for destroy convenience.*/
    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_field_entry_handle_store(unit, *entry_handle_esi_port_p, dnx_evpn_field_info.egr_fg.entry_handle), "");
        ...
        int port)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_egress_entry_add(unit, context_id, fg_id, entry_handle_esi_port_p, esi_label,port, TRUE), "");
        ...
        int esi_label)
{
    ...
    printf("Running: cint_field_evpn_egress_default_entry_add()\n");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_info_get(unit, fg_id, &fg_info), "");

    /*
     * Add the Entry (ESI) --> Do Nothing.
     */
    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_egress_entry_add(unit, context_id, fg_id, entry_handle_esi_p,esi_label, BCM_GPORT_INVALID, FALSE), "");
...
int cint_field_evpn_egress(int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_egress_context_create(unit, &dnx_evpn_field_info.egr_fg.context_id), "");


    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_egress_fg_add(unit, &dnx_evpn_field_info.egr_fg.fg_id), "");


    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_egress_fg_attach(unit, dnx_evpn_field_info.egr_fg.context_id, dnx_evpn_field_info.egr_fg.fg_id), "");


    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_egress_default_entry_add(unit, dnx_evpn_field_info.egr_fg.context_id, dnx_evpn_field_info.egr_fg.fg_id, &dnx_evpn_field_info.default_entry_handle), "");
...
int cint_field_evpn_etree_ingress_fg_add(int unit)
{
    ...
    if (dnx_evpn_field_info.inac_leaf_indication_qual == 0)
    {
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &dnx_evpn_field_info.inac_leaf_indication_qual), "");
    ...
    if (dnx_evpn_field_info.mact_leaf_indication_qual == 0)
    {
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &dnx_evpn_field_info.mact_leaf_indication_qual), "");
    ...
    if (dnx_evpn_field_info.ingress_drop_action == 0)
    {
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &dnx_evpn_field_info.ingress_drop_action), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &dnx_evpn_field_info.ing_etree_fg.fg_info, &dnx_evpn_field_info.ing_etree_fg.fg_id), "");
...
int cint_field_evpn_etree_ingress_fg_attach(int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_info_get(unit, bcmFieldQualifyAcInLifWideData, bcmFieldStageIngressPMF2, &inac_wide_data_qual_info), "");

    /** Get the MACT.entry_group qual info, we need to qualify its MSB*/
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_info_get(unit, bcmFieldQualifyDstClassL2, bcmFieldStageIngressPMF2, &mact_entry_group_qual_info), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, dnx_evpn_field_info.ing_etree_fg.fg_id, dnx_evpn_field_info.ing_etree_fg.context_id, &attach_info), "");
...
int cint_field_evpn_etree_ingress_fg_entry_add(int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, dnx_evpn_field_info.ing_etree_fg.fg_id, &entry_in_info, &dnx_evpn_field_info.ing_etree_fg.entry_handle[0]), "");
...
int cint_field_evpn_etree_ingress(int unit, int inlif_profile)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_ingress_context_create(unit, &dnx_evpn_field_info.ing_etree_fg.context_id, inlif_profile, 0,
                                                dnx_evpn_field_info.ing_etree_fg.presel_id, "EVPN_Etree", &dnx_evpn_field_info.ing_etree_fg.presel_entry_id), "");


    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_etree_ingress_fg_add(unit), "");


    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_etree_ingress_fg_attach(unit), "");


    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_etree_ingress_fg_entry_add(unit), "");
        ...
        int port)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_egress_entry_add(unit, dnx_evpn_field_info.egr_fg.context_id,
...
int cint_field_evpn_destroy_all_entries(int unit)
{
    ...
    for (entry_idx = 0; entry_idx < max_nof_entry_handles; entry_idx++)
    {
        ...
        if (dnx_evpn_field_info.ing_fg.entry_handle[entry_idx] != 0)
        {
            ...
            BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit,dnx_evpn_field_info.ing_fg.fg_id, NULL, dnx_evpn_field_info.ing_fg.entry_handle[entry_idx]), "");
        }

        if (dnx_evpn_field_info.ing_fg2.entry_handle[entry_idx] != 0)
        {
            printf(" FG(%d)",dnx_evpn_field_info.ing_fg2.fg_id);
            BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit,dnx_evpn_field_info.ing_fg2.fg_id, NULL, dnx_evpn_field_info.ing_fg2.entry_handle[entry_idx]), "");
        }

        if (dnx_evpn_field_info.egr_fg.entry_handle[entry_idx] != 0)
        {
            printf(" FG(%d)",dnx_evpn_field_info.egr_fg.fg_id);
            BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit,dnx_evpn_field_info.egr_fg.fg_id, NULL, dnx_evpn_field_info.egr_fg.entry_handle[entry_idx]), "");
        ...
        if (dnx_evpn_field_info.ing_etree_fg.entry_handle[entry_idx] != 0)
        {
            ...
            BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit,dnx_evpn_field_info.ing_etree_fg.fg_id, NULL, dnx_evpn_field_info.ing_etree_fg.entry_handle[entry_idx]), "");
        }

        if (dnx_evpn_field_info.egr_etree_fg.entry_handle[entry_idx] != 0)
        {
            printf(" FG(%d)",dnx_evpn_field_info.egr_etree_fg.fg_id);
            BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit,dnx_evpn_field_info.egr_etree_fg.fg_id, NULL, dnx_evpn_field_info.egr_etree_fg.entry_handle[entry_idx]), "");
        }
        printf("\n");
    }
...
int cint_field_evpn_destroy_udq_and_uda(int unit)
{
    ...
    for (index = 0; index < max_nof_entry_handles; index++)
    {
        if (udq[index] != 0)
        {
            BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_destroy(unit, udq[index]), "");

        }

        if (uda[index] != 0)
        {
            BCM_IF_ERROR_RETURN_MSG(bcm_field_action_destroy(unit, uda[index]), "");
...
int cint_field_evpn_fg_destroy(int unit, evpn_fg_info_s fg_info)
{
    ...
    for (index = 0; index < max_nof_entry_handles; index++)
    {
        if (fg_info.entry_handle[index] != 0)
        {
            ...
            BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit,fg_info.fg_id, NULL, fg_info.entry_handle[index]), "");
        }
    }
    printf("\n");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, fg_info.fg_id, fg_info.context_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, fg_info.fg_id), "");

    bcm_field_presel_entry_data_info_init(&presel_entry_data);
    presel_entry_data.entry_valid = FALSE;
    presel_entry_data.context_id = 0;
    BCM_IF_ERROR_RETURN_MSG(bcm_field_presel_set(unit, 0, &fg_info.presel_entry_id, &presel_entry_data), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_destroy(unit, fg_info.presel_entry_id.stage, fg_info.context_id), "");
...
int cint_field_evpn_destroy_all(int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_fg_destroy(unit, dnx_evpn_field_info.ing_fg), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_fg_destroy(unit, dnx_evpn_field_info.egr_fg), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_fg_destroy(unit, dnx_evpn_field_info.ing_pmf1_fg), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_fg_destroy(unit, dnx_evpn_field_info.ing_pmf2_fg1), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_fg_destroy(unit, dnx_evpn_field_info.ing_pmf2_fg2), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_fg_destroy(unit, dnx_evpn_field_info.ing_etree_fg), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_fg_destroy(unit, dnx_evpn_field_info.egr_etree_fg), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_destroy_udq_and_uda(unit), "");
