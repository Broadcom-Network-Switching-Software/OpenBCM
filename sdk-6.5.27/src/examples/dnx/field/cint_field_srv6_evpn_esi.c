...
bcm_field_presel_t ingress_1st_pass_presel_srv6_ext_term_id = 14;  /** Higher priority than USD*/
...
bcm_field_presel_entry_id_t ingress_1st_pass_presel_srv6_ext_term_entry_id;
...
int cint_field_srv6_evpn_ingress_2nd_pass_rch_fg_add(int unit, bcm_field_group_t *fg_id_p)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &esi_type_qual), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &esi_qual), "");
    ...
    */
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &esi_action), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &ingress_2nd_pass_fg_info, fg_id_p), "");
    return BCM_E_NONE;
}
                                                     ...
                                                     int btr_compensation)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &esi_type_msb_qual), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &esi_type_lsb_qual), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &esi_udh3_data_qual), "");
    ...
    if (srv6_btr_compensation)
    {
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &btr_le_udh2_data_qual), "");
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &btr_le_udh2_type_qual), "");
    ...
    * Calling the API bcm_field_action_create for positive case
    */
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &udh3_esi_data_user_action), "");
    ...
    if (srv6_btr_compensation)
    {
        ...
        * Calling the API bcm_field_action_create for positive case
        */
        BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &udh2_btr_le_data_user_action), "");
    }
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, fg_id_p), "");
    ...
    if (first_pass_case == FIRST_PASS_SRV6)
    {
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_info_get(unit, bcmFieldQualifyLayerRecordQualifier, bcmFieldStageIngressPMF2, &layer_qual_info), "");
        ...
        {
            attach_info.key_info.qual_info[qual_idx].offset = layer_qual_info.offset + 14;  /** take layer_qualifiers[fwd - 1][14] */
        }
    }
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, *fg_id_p, context_id, &attach_info), "");
...
int cint_field_srv6_evpn_ingress_2nd_pass_rch_fg_attach(int unit, bcm_field_context_t context_id, bcm_field_group_t fg_id)
{
    ...
    attach_info.key_info.qual_info[qual_idx].offset = *dnxc_data_get(unit, "headers", "system_headers", "system_headers_ibch1_supported", NULL) ? 156 : 176; /** offset of type_specific_container in RCH*/
    qual_idx++;
...
int cint_field_srv6_evpn_ingress_2nd_pass_rch_context_create(int unit, bcm_field_context_t * context_id_p, int inlif_profile)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_create(unit, 0, bcmFieldStageIngressPMF1, &context_info, context_id_p), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_param_set(unit, 0, bcmFieldStageIngressPMF2, *context_id_p, &param_info), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_presel_set(unit, 0, &ingress_2nd_pass_presel_entry_id, &presel_entry_data), "");
                                                         ...
                                                         int inlif_profile, int with_srh)
{
    ...
    if (with_srh == 1)
    {
        ...
        if (*dnxc_data_get (unit, "dev_init", "general", "application_v2", NULL))
        {
            presel_entry_data.qual_data[2].qual_value =  0x2 | (0xa << 2);
            presel_entry_data.qual_data[2].qual_mask = 0x2 | (0xf << 2);
        }
    }

    BCM_IF_ERROR_RETURN_MSG(bcm_field_presel_set(unit, 0, presel_entry_id_p, &presel_entry_data), "");
...
/*
 * Same as cint_field_srv6_evpn_ingress_1st_pass_context_create, but with in_lif_profile 1 and ext_termination
 * indication for the cs additionally.
 */
int cint_field_srv6_evpn_ingress_1st_pass_ext_term_context_create(int unit, bcm_field_context_t context_id,
                                                                  bcm_field_presel_t presel_id,
                                                                  bcm_field_presel_entry_id_t *presel_entry_id_p,
                                                                  int inlif_profile)
{
    ...
    if (*dnxc_data_get (unit, "dev_init", "general", "application_v2", NULL))
    {
        presel_entry_data.qual_data[2].qual_value =  0x2 | (0xa << 2) | 0 << 14;
        presel_entry_data.qual_data[2].qual_mask = 0x2 | (0xf << 2) | 1 << 14;
    }
...
int cint_field_srv6_evpn_ingress(int unit, int inlif_profile)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(cint_field_srv6_evpn_ingress_2nd_pass_rch_context_create(unit, &ingress_context_2nd_pass_id, inlif_profile), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_srv6_evpn_ingress_2nd_pass_rch_fg_add(unit, &ingress_2nd_pass_fg_id), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_srv6_evpn_ingress_2nd_pass_rch_fg_attach(unit, ingress_context_2nd_pass_id, ingress_2nd_pass_fg_id), "");
     ...
     *    - set UDH3 type to ESI (activate EPMF for ESI filtering)
     */
    BCM_IF_ERROR_RETURN_MSG(cint_field_srv6_evpn_ingress_1st_pass_context_create(unit, &ingress_context_1st_pass_ipv6_id,
    ...
    */
    BCM_IF_ERROR_RETURN_MSG(cint_field_srv6_evpn_ingress_1st_pass_context_create(unit, &ingress_context_1st_pass_srv6_id,
                                                             ingress_1st_pass_presel_srv6_id,
                                                             &ingress_1st_pass_presel_srv6_entry_id,
                                                             inlif_profile, 1), "");

   /*
    * Re-use Ingress PMF 1st Pass Context, for extended termination case:
    * 3. SRH must exist since it's extended termination
    *    In this case we need an additional context for extended termination case.
    *    This is because the extended termination LIF (the last inLIF in the first pass) has an in_lif_profile field,
    *    and the ESI indication is set in IP tunnel inLIF.
    *    That means the in_lif_profile1 should be used for the pmf context selection.
    *
    *    - copy ESI from IPv6 DIP to UDH3
    *    - set UDH3 type to Normal mode (not set EPMF for ESI filtering)
    */
    if(*dnxc_data_get(unit, "lif", "in_lif", "p2p_or_mp_based_on_cs_in_lif_profile", NULL))
    {
        BCM_IF_ERROR_RETURN_MSG(cint_field_srv6_evpn_ingress_1st_pass_ext_term_context_create(unit, ingress_context_1st_pass_srv6_id,
                                                                     ingress_1st_pass_presel_srv6_ext_term_id,
                                                                     &ingress_1st_pass_presel_srv6_ext_term_entry_id, inlif_profile), "");
    }
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_srv6_evpn_ingress_1st_pass_fg_add(unit, ingress_context_1st_pass_ipv6_id,
                                                          &ingress_1st_pass_ipv6_fg_id, FIRST_PASS_IPV6, btr_compensation), "");


    BCM_IF_ERROR_RETURN_MSG(cint_field_srv6_evpn_ingress_1st_pass_fg_add(unit, ingress_context_1st_pass_srv6_id,
...
int cint_field_srv6_evpn_egress_context_create(int unit, bcm_field_context_t *context_id_p)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_create(unit, 0, bcmFieldStageEgress, &context_info, context_id_p), "");
    ...
    if (!*dnxc_data_get(unit, "field", "features", "udh_base_cs_is_mapped", NULL)) {
        ...
        presel_entry_data.qual_data[0].qual_type = bcmFieldQualifyUDHBaseFieldCs;
        presel_entry_data.qual_data[0].qual_arg = 0;
        presel_entry_data.qual_data[0].qual_value = epmf_udh_base_cs_var;
        presel_entry_data.qual_data[0].qual_mask = 0xf;
    }
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_presel_set(unit, 0, &egress_presel_entry_id, &presel_entry_data), "");
...
int cint_field_srv6_evpn_egress_fg_add(int unit, bcm_field_group_t *fg_id_p)
{
    ...
    /* Action - Drop */
    egress_fg_info.action_types[0] = bcmFieldActionTrap;
    egress_fg_info.action_with_valid_bit[0] = TRUE;

    egress_fg_info.nof_actions = 1;

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &egress_fg_info, fg_id_p), "");
...
int cint_field_srv6_evpn_egress_btr_comp_fg_add_attach(int unit, bcm_field_context_t context_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &egress_btr_fg_info, &fg_id), "");
        ...
        int port)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, fg_id, &entry_in_info, entry_handle_esi_port_p), "");
        ...
        int esi_label)
{
    ...
    entry_in_info.nof_entry_quals = 1;
    entry_in_info.nof_entry_actions = 0;
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, fg_id, &entry_in_info, entry_handle_esi_p), "");
...
int cint_field_srv6_evpn_egress(int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_srv6_evpn_egress_context_create(unit, &egress_context_id), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_srv6_evpn_egress_fg_add(unit, &egress_fg_id), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_srv6_evpn_egress_fg_attach(unit, egress_context_id, egress_fg_id), "");


    BCM_IF_ERROR_RETURN_MSG(cint_field_srv6_evpn_egress_default_entry_add(unit, egress_context_id, egress_fg_id, &default_entry_handle), "");
    ...
    if (btr_compensation)
    {
        BCM_IF_ERROR_RETURN_MSG(cint_field_srv6_evpn_egress_btr_comp_context_create(unit, &egress_btr_context_id), "");

        BCM_IF_ERROR_RETURN_MSG(cint_field_srv6_evpn_egress_btr_comp_fg_add_attach(unit, egress_btr_context_id), "");
    }
    ...
    int dst_port)
{
    ...
    void * void_ptr = NULL;
    int ace_support = *dnxc_data_get(unit, "field", "ace", "supported", NULL);
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_port_class_set(unit, dst_port, bcmPortClassFieldEgressPacketProcessingPortCs, port_class_evpn_epmf), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_create(unit, 0, bcmFieldStageEgress, &context_info, &field_srv6_evpn_esi_encap_info.egress_context_id), "");
    ...
    */
    ...
    field_srv6_evpn_esi_encap_info.egress_fg_info.action_types[0] = ace_support ? bcmFieldActionAceEntryId : bcmFieldActionOutVport0;
    field_srv6_evpn_esi_encap_info.egress_fg_info.action_with_valid_bit[0] = TRUE;

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &field_srv6_evpn_esi_encap_info.egress_fg_info, &field_srv6_evpn_esi_encap_info.egress_fg_id), "");

    /************ Configure the ACE format **************/
    if (ace_support) {
        /** The device supports ACE doesn't support to update out_lif directly.*/
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_field_ace_format_add(unit, 0, &ace_format_info, &field_srv6_evpn_esi_encap_info.ace_format_id), "");
    }
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, field_srv6_evpn_esi_encap_info.egress_fg_id, field_srv6_evpn_esi_encap_info.egress_context_id, &attach_info), "");
    ...
    int esi_tunnel_id)
{
    ...
    /*********************** Add the ACE entry ************************/
    if (ace_support) {
        /** ACE can assist if ePMF can't update out_lif directly.*/
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_field_ace_entry_add(unit, 0, field_srv6_evpn_esi_encap_info.ace_format_id, &ace_entry_info, &ace_entry_id), "");
    ...
    */
    ...
    entry_in_info.entry_action[0].value[0] = ace_support ? ace_entry_id : esi_tunnel_id;
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, field_srv6_evpn_esi_encap_info.egress_fg_id, &entry_in_info, entry_handle), "");
    ...
    int unit)
{
    ...
    for (index = 0; index < field_srv6_evpn_esi_encap_info.nof_esi_encap_egress_entries; index ++) {
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, field_srv6_evpn_esi_encap_info.egress_fg_id, NULL, field_srv6_evpn_esi_encap_info.egress_entry_handles[index]), "");

        if (ace_support) {
            BCM_IF_ERROR_RETURN_MSG(bcm_field_ace_entry_delete(unit, field_srv6_evpn_esi_encap_info.ace_entry_id[index]), "");
        }
    }
    printf("\n");
    ...
    if (ace_support) {
        BCM_IF_ERROR_RETURN_MSG(bcm_field_ace_format_delete(unit, field_srv6_evpn_esi_encap_info.ace_format_id), "");
    }

    /** Deattach the context and FG */
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, field_srv6_evpn_esi_encap_info.egress_fg_id, field_srv6_evpn_esi_encap_info.egress_context_id), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, field_srv6_evpn_esi_encap_info.egress_fg_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_destroy(unit, bcmFieldStageEgress, field_srv6_evpn_esi_encap_info.egress_context_id), "");
...
int cint_field_srv6_evpn_destroy_all_entries(int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit,egress_fg_id, NULL, default_entry_handle), "");

    if(entry_handle_esi_port != 0)
    {
        /* Destroy the entry */
        BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit,egress_fg_id, NULL, entry_handle_esi_port), "");
    }
    if(entry_handle_esi != 0)
    {
        /* Destroy the entry */
        BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit,egress_fg_id, NULL, entry_handle_esi), "");

    }
    if(entry_handle_esi_port_1 != 0)
    {
        /* Destroy the entry */
        BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit,egress_fg_id, NULL, entry_handle_esi_port_1), "");
    }
    return BCM_E_NONE;
}
...
int cint_field_evpn_destroy_ugq_and_uda(int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_destroy(unit, esi_type_qual), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_destroy(unit, esi_qual), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_destroy(unit, esi_action), "");
...
int cint_field_srv6_evpn_destroy_all(int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_srv6_evpn_destroy_all_entries(unit), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, egress_fg_id, egress_context_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, egress_fg_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_destroy(unit, bcmFieldStageEgress, egress_context_id), "");

    /* Destroy Ingress configuration */

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, ingress_2nd_pass_fg_id, ingress_context_2nd_pass_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, ingress_2nd_pass_fg_id), "");

    /* Destroy UDQ & UDA */
    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_destroy_ugq_and_uda(unit), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_presel_set(unit, 0, &ingress_2nd_pass_presel_entry_id, &presel_entry_data), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_destroy(unit, bcmFieldStageIngressPMF1, ingress_context_2nd_pass_id), "");
