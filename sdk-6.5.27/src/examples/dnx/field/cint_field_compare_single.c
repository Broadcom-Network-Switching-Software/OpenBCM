    ...
    bcm_field_context_t * context_id_p)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_create(unit, 0, stage, &context_info, context_id_p), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_compare_create(unit, 0, stage, *context_id_p, Cint_field_compare_single_pair_id, &compare_info), "");
    ...
    bcm_field_context_t * context_id_p)
{
    ...
    printf("Running: cint_field_compare_single_presel_set()\n");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_presel_set(unit, 0, &Cint_field_compare_single_presel_entry_id, &presel_entry_data), "");
    ...
    int compare_id)
{
    ...
    printf("Running: cint_field_compare_single_fg_config_ipmf1()\n");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &Cint_field_compare_single_action_void), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &Cint_field_compare_single_fg_id_ipmf1), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, Cint_field_compare_single_fg_id_ipmf1, Cint_field_compare_single_context_id, &attach_info), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, Cint_field_compare_single_fg_id_ipmf1, &entry_info, Cint_field_compare_single_ipmf1_entry_id), "");
    ...
    bcm_field_context_t * context_id_p)
{
    ...
    printf("Running: cint_field_compare_single_fg_config_ipmf2()\n");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &Cint_field_compare_single_fg_id_ipmf2), "");
    ...
    attach_info.payload_info.nof_actions = fg_info.nof_actions;
    attach_info.payload_info.action_types[0] = fg_info.action_types[0];
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, Cint_field_compare_single_fg_id_ipmf2, Cint_field_compare_single_context_id, &attach_info), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_compare_operand_offset_get(unit, Cint_field_compare_single_pair_id, bcmFieldCompareOperandEqual, &op_offset), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, Cint_field_compare_single_fg_id_ipmf2, &entry_info, &Cint_field_compare_single_ipmf2_entry_id_arr[0]), "");
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(bcm_field_compare_operand_offset_get(unit, 1, bcmFieldCompareOperandNotEqual, &op_offset), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, Cint_field_compare_single_fg_id_ipmf2, &entry_info, &Cint_field_compare_single_ipmf2_entry_id_arr[1]), "");
...
cint_field_compare_single_main(
    ...
    int compare_id)
{
    printf("Running: cint_field_compare_single_main()\n");
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_compare_single_config(unit, bcmFieldStageIngressPMF1, compare_id, Cint_field_compare_single_context_id), "");

    printf("Create a preselector which is going to qualify upon Ethernet header \n");
    BCM_IF_ERROR_RETURN_MSG(cint_field_compare_single_presel_set(unit, bcmFieldStageIngressPMF1, Cint_field_compare_single_context_id), "");

    printf("Create IPMF1 TCAM Fg and Attach it to the context and add an entry. \n");
    BCM_IF_ERROR_RETURN_MSG(cint_field_compare_single_fg_config_ipmf1(unit, Cint_field_compare_single_context_id, compare_id), "");

    printf("Create IPMF2 TCAM Fg and Attach it to the context and add an entry. \n");
    BCM_IF_ERROR_RETURN_MSG(cint_field_compare_single_fg_config_ipmf2(unit, Cint_field_compare_single_context_id), "");
    ...
    int unit)
{
    bcm_field_presel_entry_data_t presel_entry_data;
    int entry_iterator;
    printf("Running: cint_field_compare_single_destroy()\n");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, Cint_field_compare_single_fg_id_ipmf1, NULL, Cint_field_compare_single_ipmf1_entry_id), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, Cint_field_compare_single_fg_id_ipmf1, Cint_field_compare_single_context_id), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, Cint_field_compare_single_fg_id_ipmf1), "");

    for (entry_iterator = 0; entry_iterator < Cint_field_compare_single_nof_entries; entry_iterator++)
    {
        BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, Cint_field_compare_single_fg_id_ipmf2, NULL, Cint_field_compare_single_ipmf2_entry_id_arr[entry_iterator]), "");
    }

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, Cint_field_compare_single_fg_id_ipmf2, Cint_field_compare_single_context_id), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, Cint_field_compare_single_fg_id_ipmf2), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_compare_destroy(unit, bcmFieldStageIngressPMF1, Cint_field_compare_single_context_id, Cint_field_compare_single_pair_id), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_destroy(unit, bcmFieldStageIngressPMF1, Cint_field_compare_single_context_id), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_destroy(unit, Cint_field_compare_single_action_void), "");
