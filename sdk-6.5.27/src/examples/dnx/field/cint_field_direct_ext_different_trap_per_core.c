    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &Cint_field_direct_ext_different_trap_per_core_val_bit_qual_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &Cint_field_direct_ext_different_trap_per_core_key_gen_qual_id), "");
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_rx_trap_type_create(unit, 0, bcmRxTrapUserDefine, &Cint_field_direct_ext_different_trap_per_core_trap_id_drop), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_rx_trap_set(unit, Cint_field_direct_ext_different_trap_per_core_trap_id_drop, &trap_config), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_rx_trap_type_create(unit, 0, bcmRxTrapUserDefine, &Cint_field_direct_ext_different_trap_per_core_trap_id_cpu), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_rx_trap_set(unit, Cint_field_direct_ext_different_trap_per_core_trap_id_cpu, &trap_config), "");
    ...
    bcm_field_context_t context_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_info_get(unit, bcmFieldQualifyInPort, bcmFieldStageIngressPMF2, &qual_info_get), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_info_get(unit, bcmFieldQualifyKeyGenVar, bcmFieldStageIngressPMF2, &qual_info_get), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &Cint_field_direct_ext_different_trap_per_core_trap_drop_act_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &Cint_field_direct_ext_different_trap_per_core_fg_id_1), "");
    printf("Field Group ID %d was created. \n", Cint_field_direct_ext_different_trap_per_core_fg_id_1);

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, Cint_field_direct_ext_different_trap_per_core_fg_id_1, context_id, &attach_info), "");
    ...
    bcm_field_context_t context_id)
{
    ...
    attach_info.key_info.qual_info[0].input_type = bcmFieldInputTypeMetaData;
    /** Get the offset of IN_PORT qualifier. */
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_info_get(unit, bcmFieldQualifyInPort, bcmFieldStageIngressPMF1, &qual_info_get), "");

    attach_info.key_info.qual_info[0].offset = qual_info_get.offset;
    attach_info.key_info.qual_types[1] = fg_info.qual_types[1];
    attach_info.key_info.qual_info[1].input_type = bcmFieldInputTypeMetaData;
    /** Get the offset of KEY_GEN_VAR qualifier. */
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_info_get(unit, bcmFieldQualifyKeyGenVar, bcmFieldStageIngressPMF1, &qual_info_get), "");
    ...
    action_info.prefix_value = ((Cint_field_direct_ext_different_trap_per_core_trap_str) |
                                (Cint_field_direct_ext_different_trap_per_core_trap_qual << 4));
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &Cint_field_direct_ext_different_trap_per_core_trap_cpu_act_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &Cint_field_direct_ext_different_trap_per_core_fg_id_2), "");
    printf("Field Group ID %d was created. \n", Cint_field_direct_ext_different_trap_per_core_fg_id_2);

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, Cint_field_direct_ext_different_trap_per_core_fg_id_2,context_id, &attach_info), "");
    printf("Field Group ID %d was attached to Context ID %d. \n",
    ...
    bcm_field_context_t context_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_direct_ext_different_trap_per_core_trap_config(unit), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_direct_ext_different_trap_per_core_qual_create(unit), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_direct_ext_different_trap_per_core_fg_trap_drop_create(unit, context_id), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_direct_ext_different_trap_per_core_fg_trap_cpu_create(unit, context_id), "");
...
cint_field_direct_ext_different_trap_per_core_destroy(
    ...
    bcm_field_context_t context_id)
{
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, Cint_field_direct_ext_different_trap_per_core_fg_id_1,context_id), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, Cint_field_direct_ext_different_trap_per_core_fg_id_2,context_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, Cint_field_direct_ext_different_trap_per_core_fg_id_1), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, Cint_field_direct_ext_different_trap_per_core_fg_id_2), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_destroy(unit, Cint_field_direct_ext_different_trap_per_core_val_bit_qual_id), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_destroy(unit, Cint_field_direct_ext_different_trap_per_core_key_gen_qual_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_destroy(unit, Cint_field_direct_ext_different_trap_per_core_trap_drop_act_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_destroy(unit, Cint_field_direct_ext_different_trap_per_core_trap_cpu_act_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_rx_trap_type_destroy(unit, Cint_field_direct_ext_different_trap_per_core_trap_id_drop), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_rx_trap_type_destroy(unit, Cint_field_direct_ext_different_trap_per_core_trap_id_cpu), "");
