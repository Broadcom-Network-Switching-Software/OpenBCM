    ...
    bcm_field_context_t context_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &Cint_field_dir_ext_epmf_fg_id), "");

    printf("Field Group ID %d was created. \n", Cint_field_dir_ext_epmf_fg_id);

    
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, Cint_field_dir_ext_epmf_fg_id, context_id, &attach_info), "");
...
int cint_field_dir_ext_epmf_destroy(
    ...
    bcm_field_context_t context_id)
{
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, Cint_field_dir_ext_epmf_fg_id, context_id), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, Cint_field_dir_ext_epmf_fg_id), "");
