...
int cint_field_hash_ipt_ipmf2_tcam_entry_add(int unit, uint32 hash,bcm_field_entry_t *entry_handle)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, cint_field_hash_ipt_fg_id_ipmf2_hash, &ent_info, entry_handle), "");
                                                    ...
                                                    bcm_field_entry_t *entry_handle)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, cint_field_hash_ipt_fg_id_tcam, &ent_info, entry_handle), "");
...
int cint_field_hash_ipt_main(int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_create(unit, 0, bcmFieldStageIngressPMF1, &context_info, &cint_field_hash_ipt_context_id_ipmf1), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_hash_create(unit, 0, bcmFieldStageIngressPMF1,cint_field_hash_ipt_context_id_ipmf1,&hash_info), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &cint_field_hash_ipt_fg_id_ipmf2_hash), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, cint_field_hash_ipt_fg_id_ipmf2_hash, cint_field_hash_ipt_context_id_ipmf1, &attach_info), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_create(unit, 0, bcmFieldStageIngressPMF3, &context_info, &cint_field_hash_ipt_context_id_ipmf3), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &cint_field_hash_ipt_fg_id_tcam), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, cint_field_hash_ipt_fg_id_tcam, cint_field_hash_ipt_context_id_ipmf3, &attach_info), "");
...
int cint_field_hash_ipt_destroy(int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, cint_field_hash_ipt_fg_id_ipmf2_hash, cint_field_hash_ipt_context_id_ipmf1), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, cint_field_hash_ipt_fg_id_ipmf2_hash), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_hash_destroy(unit, bcmFieldStageIngressPMF1, cint_field_hash_ipt_context_id_ipmf1), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_destroy(unit, bcmFieldStageIngressPMF1, cint_field_hash_ipt_context_id_ipmf1), "");

    /* Detach the IPMF3 FG from its context */
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, cint_field_hash_ipt_fg_id_tcam, cint_field_hash_ipt_context_id_ipmf3), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, cint_field_hash_ipt_fg_id_tcam), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_destroy(unit, bcmFieldStageIngressPMF3, cint_field_hash_ipt_context_id_ipmf3), "");
