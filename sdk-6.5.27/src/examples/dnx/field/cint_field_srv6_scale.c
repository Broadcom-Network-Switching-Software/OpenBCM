...
bcm_field_context_t cint_field_term_ipmf1_context = 6;
    ...
    bcm_field_group_t * fg_id_p)
{
    ...
    void *dest_char;
    char *tmp_ptr;
    printf("Running: cint_field_external_pmf_fg_add()\n");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &cint_field_external_pmf_external_uda_0), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &cint_field_external_pmf_external_uda_1), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &cint_field_external_pmf_external_uda_2), "");
    ...
    bcm_field_group_t * fg_id_p)
{
    ...
    void *dest_char;
    char *tmp_ptr;
    printf("Running: cint_field_external_pmf_fg_add_term()\n");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &ue_term_ext_qual), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &cint_field_external_pmf_external_uda_term_hit), "");
    ...
    uint32 payload_offset)
{
    ...
    bcm_field_group_attach_info_t group_attach_info;
    bcm_field_context_t context_id;
    printf("Running: cint_field_external_pmf_fg_attach_term()\n");
    ...
    bcm_field_group_info_t *fg_info_p)
{
    ...
    dest_char = &(fg_info_p->name[0]);
    fg_name = dest_char;
    printf("Running: cint_field_external_pmf_entry_add() fg_id (%d) name(%s) \n",external_fg_id,fg_name);
    ...
    while (entry_index < max_entry_index)
    {
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, external_fg_id, &entry_info, &cint_field_external_pmf_entry_id), "");

        entry_index++;

    }

    printf("\n SUCCESSFULLY ADDED (%d) ENTRIES In ENCAP \n", entry_index);
    ...
    bcm_field_group_info_t *fg_info_p)
{
    ...
    dest_char = &(fg_info_p->name[0]);
    fg_name = dest_char;
    printf("Running: cint_field_external_pmf_entry_add_term() fg_id (%d) name(%s) \n",external_fg_id,fg_name);
    ...
    while (entry_index < max_entry_index)
    {
        ...
        entry_info.priority = cint_field_external_pmf_priority;
        printf(" (%d),",entry_index);
        BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, external_fg_id, &entry_info, &cint_field_external_pmf_entry_id_term), "");

        entry_index++;
    }

    printf("\n SUCCESSFULLY ADDED (%d) ENTRIES In TERM \n", entry_index);
...
{bcm_field_context_info_t context_info;
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_create(unit, 0, bcmFieldStageIngressPMF1, &context_info, &cint_field_external_pmf_ipmf1_context), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_presel_set(unit, 0, &presel_entry_id, &ipmf1_p_data), "");
    ...
    int unit)
{
    ...
    printf("Running: cint_field_external_pmf_context_ipmf1_create_term()\n");
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_external_pmf_ipmf2_ue_qual), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_external_pmf_ipmf2_udhbase_qual), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &cint_field_external_pmf_ipmf2_udh2_action), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &cint_field_external_pmf_fg_id_ipmf2), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_action_offset_get(unit, 0, cint_field_external_pmf_fg_id, cint_field_external_pmf_external_uda_0, &action_offset_in_fg), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, cint_field_external_pmf_fg_id_ipmf2, cint_field_external_pmf_ipmf1_context, &attach_info), "");
    ...
    int unit)
{
    ...
    printf("Running: cint_field_external_pmf_fg_ipmf2_add_term()\n");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &cint_ipmf2_black_hole_qual), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &cint_field_term_fg_id_ipmf2), "");
    ...
    */
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, cint_field_term_fg_id_ipmf2, cint_field_term_ipmf1_context, &attach_info), "");
...
{
    printf("Running: cint_field_srv6_kbp_config()\n");

    /*
     * Configure KBP for Encap
     */
    BCM_IF_ERROR_RETURN_MSG(cint_field_external_pmf_fg_add(unit, &fg_info_encap, &cint_field_external_pmf_fg_id), "");


    cint_field_external_pmf_external_app_type = is_ipv6_flow ? bcmFieldAppTypeIp6UcastRpf : bcmFieldAppTypeIp4UcastRpf;
    BCM_IF_ERROR_RETURN_MSG(cint_field_external_pmf_fg_attach(unit, cint_field_external_pmf_fg_id, &fg_info_encap, cint_field_external_pmf_external_app_type, cint_field_external_pmf_payload_id, cint_field_external_pmf_payload_offset), "");


    /*
     * Configure KBP for Term
     */
    BCM_IF_ERROR_RETURN_MSG(cint_field_external_pmf_fg_add_term(unit, &fg_info_term, &cint_field_external_pmf_fg_id_term), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_external_pmf_fg_attach_term(unit, cint_field_external_pmf_fg_id_term, &fg_info_term, cint_field_external_pmf_external_app_type_term, cint_field_external_pmf_payload_id, cint_field_external_pmf_payload_offset), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_switch_control_set(unit, bcmSwitchExternalTcamSync, 0), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_external_pmf_entry_add(unit, cint_field_external_pmf_fg_id, &fg_info_encap), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_external_pmf_entry_add_term(unit, cint_field_external_pmf_fg_id_term, &fg_info_term), "");
                            ...
                            bcm_field_group_info_t fg_info)
{
    ...
    printf("Running: cint_field_srv6_pmf_config_encap()\n");


    printf("Config external FG on IFWD2, fg_id=%d, external_app_type %d\n", cint_field_external_pmf_fg_id,  (cint_field_external_pmf_external_app_type & 0x00ff));

    BCM_IF_ERROR_RETURN_MSG(cint_field_external_pmf_context_ipmf1_create(unit), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_external_pmf_fg_ipmf2_add(unit), "");
                            ...
                            bcm_field_group_info_t fg_info)
{
    ...
    printf("Running: cint_field_srv6_pmf_config_term()\n");

    BCM_IF_ERROR_RETURN_MSG(cint_field_external_pmf_context_ipmf1_create_term(unit), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_external_pmf_fg_ipmf2_add_term(unit), "");
...
cint_field_external_pmf_main(int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_srv6_kbp_config(unit, fg_info_encap, fg_info_term), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_srv6_pmf_config_encap(unit, fg_info_encap), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_srv6_pmf_config_term(unit, fg_info_term), "");
