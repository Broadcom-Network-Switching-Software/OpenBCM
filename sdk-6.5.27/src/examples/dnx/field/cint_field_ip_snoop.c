                             ...
                             /* in */ bcm_gport_t snoop_trap_gport_id)
{
    ...
    */
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_range_set(unit, 0, bcmFieldStageIngressPMF1, range_id, &range_info), "");
    ...
    */
    ...
    fg_info.qual_types[1] = bcmFieldQualifyL4PortRangeCheck;
    ...
    sal_strncpy_s(dest_char, "IP_snoop", sizeof(fg_info.name));
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &cint_field_ip_snoop_fg_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, cint_field_ip_snoop_fg_id, context_id, &attach_info), "");
    ...
    */
    ...
    ent_info.entry_qual[0].value[0] = 0x11;
    ent_info.entry_qual[0].mask[0] = 0xFFFF;
    ent_info.entry_qual[1].type = fg_info.qual_types[1];
    ent_info.entry_qual[1].value[0] = (1 << range_id);
    ent_info.entry_qual[1].mask[0] = (1 << range_id);
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, cint_field_ip_snoop_fg_id, &ent_info, &cint_field_ip_snoop_ent_id), "");
...
int cint_field_ip_snoop_main(int unit,bcm_field_context_t context_id, bcm_port_t in_port, int dest_local_port, int udp_port_min, int udp_port_max)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_ip_snoop_set(unit, dest_local_port,0, 0, 0, &snoop_trap_gport_id, &mirror_dest_id_dummy), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_ip_snoop_fg_set(unit, context_id, in_port, udp_port_min, udp_port_max, snoop_trap_gport_id), "");
...
int cint_field_ip_snoop_destroy(int unit, bcm_field_context_t context_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_mirror_destination_destroy(unit, mirror_dest.mirror_dest_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_rx_trap_type_destroy(unit, trap_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, cint_field_ip_snoop_fg_id, NULL, cint_field_ip_snoop_ent_id), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, cint_field_ip_snoop_fg_id, context_id), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, cint_field_ip_snoop_fg_id), "");
