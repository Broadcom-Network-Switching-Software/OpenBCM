    ...
    int bank_mode)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_dt_multi_context_create(unit, 0, field_stage_internal, dt_fg_info), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &(dt_fg_info->fg_id)), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, dt_fg_info->fg_id, dt_fg_info->context_id, &attach_info), "");
    ...
    cint_field_dt_multi_fg_info_t * dt_fg_info)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, dt_fg_info->fg_id, Cint_field_dt_multi_entries_entry_info_array[entry_index], &dt_fg_info->entry_handle), "");
    ...
    int bank_mode)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_dt_multi_entries_fg_create(unit, field_stage, Cint_field_dt_multi_entries_fg_info_array[0], bank_mode), "");
    ...
    for (entry_index = 0; entry_index < Cint_field_dt_multi_entries_nof_entries; entry_index++)
    {
        ...
        {
            BCM_IF_ERROR_RETURN_MSG(cint_field_dt_multi_entries_entry_create(unit, entry_index, port, FALSE, field_stage, Cint_field_dt_multi_entries_fg_info_array[0]), "");

            valid_entry_index++;
        }
        else
        {
            BCM_IF_ERROR_RETURN_MSG(cint_field_dt_multi_entries_entry_create(unit, entry_index, dummy_port, TRUE, field_stage, Cint_field_dt_multi_entries_fg_info_array[0]), "");
        }
    ...
    bcm_field_stage_t field_stage)
{
    ...
    for (entry_index = 0; entry_index < Cint_field_dt_multi_entries_nof_entries; entry_index++)
    {
        BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, Cint_field_dt_multi_entries_fg_info_array[0].fg_id,
            Cint_field_dt_multi_entries_entry_info_array[entry_index].entry_qual, Cint_field_dt_multi_entries_entry_handle[entry_index]), "");
    }

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, Cint_field_dt_multi_entries_fg_info_array[0].fg_id, Cint_field_dt_multi_entries_fg_info_array[0].context_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, Cint_field_dt_multi_entries_fg_info_array[0].fg_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_destroy(unit, field_stage_internal, Cint_field_dt_multi_entries_fg_info_array[0].context_id), "");
