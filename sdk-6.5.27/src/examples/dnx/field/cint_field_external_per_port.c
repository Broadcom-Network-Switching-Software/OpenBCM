    ...
    int is_multi_core)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &cint_field_external_per_port_external_uda), "");
    ...
    int is_multi_core)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, external_fg_id, &entry_info, &cint_field_external_per_port_entry_id), "");
    ...
    int in_port)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_external_per_port_fg_add(unit, &fg_info, &cint_field_external_per_port_fg_id, is_multi_core), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_external_per_port_fg_attach(unit, cint_field_external_per_port_fg_id, &fg_info, cint_field_external_per_port_external_app_type, cint_field_external_per_port_payload_id, cint_field_external_per_port_payload_offset), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_switch_control_set(unit, bcmSwitchExternalTcamSync, 0), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_external_per_port_entry_add(unit, cint_field_external_per_port_fg_id, &fg_info, in_port, is_multi_core), "");
...
cint_field_external_per_port_destroy(int unit)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, cint_field_external_per_port_fg_id, NULL, cint_field_external_per_port_entry_id), "");
