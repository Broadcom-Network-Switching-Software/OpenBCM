...
int cint_field_hashing_main(int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_create(unit, 0, bcmFieldStageIngressPMF1, &context_info, &cint_hashing_context_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_hash_create(unit, 0, bcmFieldStageIngressPMF1,cint_hashing_context_id,&hash_info), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &cint_hashing_fg_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, cint_hashing_fg_id, cint_hashing_context_id, &attach_info), "");
    ...
    printf("Adding  entry\n");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, cint_hashing_fg_id, &ent_info, &cint_hashing_ent_id), "");
...
int cint_field_hashing_destroy(int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, cint_hashing_fg_id, NULL, cint_hashing_ent_id), "");

    /* Detach the IPMF2 FG from its context */
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, cint_hashing_fg_id, cint_hashing_context_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, cint_hashing_fg_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_hash_destroy(unit, bcmFieldStageIngressPMF1, cint_hashing_context_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_destroy(unit, bcmFieldStageIngressPMF1, cint_hashing_context_id), "");
...
int cint_field_hashing_ipv6_asymmetrical(int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_switch_control_get(unit, bcmSwitchECMPHashConfig, &ecmp_hash_config_crc), "");
