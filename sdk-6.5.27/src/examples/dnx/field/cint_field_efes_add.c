    ...
    bcm_field_context_t context2)
{
    ...
    printf("Running: cint_field_efes_diff_actions_diff_contexts_main()\n");

    /*
     *  Get the size of the actions.
     */
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_info_get(unit, action_1, stage, &action_info), "");
    action_size = action_info.size;
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_info_get(unit, action_2, stage, &action_info), "");
    if (action_size != action_info.size)
    {
        printf("cint_field_efes_add_diff_actions_diff_contexts_main() Error, The two actions are of different sizes (%d and %d).\n", action_size, action_info.size);
        return BCM_E_FAIL;
    }
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &Cint_field_efes_add_uda_1), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &Cint_field_efes_add_fg_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, Cint_field_efes_add_fg_id, &entry_info, &Cint_field_efes_add_entry_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, Cint_field_efes_add_fg_id, context1, &attach_info), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, Cint_field_efes_add_fg_id, context2, &attach_info), "");
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_action_offset_get(unit, 0, Cint_field_efes_add_fg_id, Cint_field_efes_add_uda_1, &action_offset_within_fg), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_efes_action_add(unit, 0, Cint_field_efes_add_fg_id, context1, &action_priority, &efes_action_info), "");
    efes_action_info.efes_condition_conf[0].action_type = action_2;
    action_priority = BCM_FIELD_ACTION_POSITION(0, 2);
    BCM_IF_ERROR_RETURN_MSG(bcm_field_efes_action_add(unit, 0, Cint_field_efes_add_fg_id, context2, &action_priority, &efes_action_info), "");
    ...
    bcm_field_context_t context)
{
    ...
    if (action_size != action_info.size)
    {
        printf("cint_field_efes_add_two_actions_same_data_tcam_main() Error, The two actions are of different sizes (%d and %d).\n", action_size, action_info.size);
        return BCM_E_FIAL;
    }
    ...
    attach_info.key_info.qual_info[0].input_arg = 0;
    attach_info.key_info.qual_info[0].offset = 0;
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, Cint_field_efes_add_fg_id, context, &attach_info), "");

    /*
     * Find position of action on the field group.
     */
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_action_offset_get(unit, 0, Cint_field_efes_add_fg_id, action_1, &action_offset_within_fg), "");
    ...
    efes_action_info.efes_condition_conf[0].action_with_valid_bit = TRUE;
    action_priority = BCM_FIELD_ACTION_POSITION(0, 1);
    BCM_IF_ERROR_RETURN_MSG(bcm_field_efes_action_add(unit, 0, Cint_field_efes_add_fg_id, context, &action_priority, &efes_action_info), "");
    ...
    bcm_field_context_t context)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &Cint_field_efes_add_uda_2), "");
    bcm_field_action_info_t_init(&action_info);
    action_info.stage = stage;
    action_info.action_type = bcmFieldActionVoid;
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &Cint_field_efes_add_uda_3), "");
    bcm_field_qualifier_info_create_t_init(&qual_info);
    qual_info.size = action_size_1 - 1;
    dest_char = &(qual_info.name[0]);
    sal_strncpy_s(dest_char, "EFES_UDQ1", sizeof(qual_info.name));
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &Cint_field_efes_add_udq_1), "");
    bcm_field_qualifier_info_create_t_init(&qual_info);
    qual_info.size = 1;
    dest_char = &(qual_info.name[0]);
    sal_strncpy_s(dest_char, "EFES_UDQ2", sizeof(qual_info.name));
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &Cint_field_efes_add_udq_2), "");
    bcm_field_qualifier_info_create_t_init(&qual_info);
    qual_info.size = action_size_2 - 1;
    dest_char = &(qual_info.name[0]);
    sal_strncpy_s(dest_char, "EFES_UDQ3", sizeof(qual_info.name));
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &Cint_field_efes_add_udq_3), "");
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_action_offset_get(unit, 0, Cint_field_efes_add_fg_id, Cint_field_efes_add_uda_1, &action_offset_within_fg_1), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_action_offset_get(unit, 0, Cint_field_efes_add_fg_id, Cint_field_efes_add_uda_2, &action_offset_within_fg_2), "");
    ...
    bcm_field_context_t context)
{
     ...
     *  Get the size of the actions.
     */
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_info_get(unit, action_1_1, stage, &action_info), "");
    action_size_1_1 = action_info.size;
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_info_get(unit, action_1_2, stage, &action_info), "");
    action_size_1_2 = action_info.size;
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_info_get(unit, action_2_1, stage, &action_info), "");
    ...
    entry_info.priority = 9;
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, Cint_field_efes_add_fg_id, &entry_info, &Cint_field_efes_add_entry_id_2), "");
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_action_offset_get(unit, 0, Cint_field_efes_add_fg_id, Cint_field_efes_add_uda_1, &first_action_offset_on_fg), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_action_offset_get(unit, 0, Cint_field_efes_add_fg_id, Cint_field_efes_add_uda_3, &condition_offset_on_fg), "");
    ...
    bcm_field_context_t context)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_info_get(unit, action, stage, &action_info), "");
    action_size = action_info.size;
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_info_get(unit, bcmFieldQualifyTcpControl, stage, &qual_info_get), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, BCM_FIELD_FLAG_32_RESULT_MSB_ALIGN, Cint_field_efes_add_fg_id, context, &attach_info), "");

    /*
     * Find position of void actions on the field group.
     */
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_action_offset_get(unit, 0, Cint_field_efes_add_fg_id, Cint_field_efes_add_uda_2, &action_offset_within_fg_action_bits), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_action_offset_get(unit, 0, Cint_field_efes_add_fg_id, Cint_field_efes_add_uda_3, &action_offset_within_fg_condition_bits), "");
...
cint_field_efes_add_destroy(
    ...
    bcm_field_context_t context2)
{
    printf("Running: cint_field_efes_add_destroy()\n");

    if (Cint_field_efes_add_entry_id != BCM_FIELD_ID_INVALID)
    {
        BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, Cint_field_efes_add_fg_id, NULL, Cint_field_efes_add_entry_id), "");
        Cint_field_efes_add_entry_id = BCM_FIELD_ID_INVALID;
    }
    if (Cint_field_efes_add_entry_id_2 != BCM_FIELD_ID_INVALID)
    {
        BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, Cint_field_efes_add_fg_id, NULL, Cint_field_efes_add_entry_id_2), "");
        Cint_field_efes_add_entry_id_2 = BCM_FIELD_ID_INVALID;
    }

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, Cint_field_efes_add_fg_id, context1), "");
    if (context2 != BCM_FIELD_ID_INVALID)
    {
        BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, Cint_field_efes_add_fg_id, context2), "");
    }

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, Cint_field_efes_add_fg_id), "");
    Cint_field_efes_add_fg_id = BCM_FIELD_ID_INVALID;

    if (Cint_field_efes_add_uda_1 != BCM_FIELD_ID_INVALID)
    {
        BCM_IF_ERROR_RETURN_MSG(bcm_field_action_destroy(unit, Cint_field_efes_add_uda_1), "");
        Cint_field_efes_add_uda_1 = BCM_FIELD_ID_INVALID;
    }

    if (Cint_field_efes_add_uda_2 != BCM_FIELD_ID_INVALID)
    {
        BCM_IF_ERROR_RETURN_MSG(bcm_field_action_destroy(unit, Cint_field_efes_add_uda_2), "");
        Cint_field_efes_add_uda_2 = BCM_FIELD_ID_INVALID;
    }

    if (Cint_field_efes_add_uda_3 != BCM_FIELD_ID_INVALID)
    {
        BCM_IF_ERROR_RETURN_MSG(bcm_field_action_destroy(unit, Cint_field_efes_add_uda_3), "");
        Cint_field_efes_add_uda_3 = BCM_FIELD_ID_INVALID;
    }

    if (Cint_field_efes_add_udq_1 != BCM_FIELD_ID_INVALID)
    {
        BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_destroy(unit, Cint_field_efes_add_udq_1), "");
        Cint_field_efes_add_udq_1 = BCM_FIELD_ID_INVALID;
    }

    if (Cint_field_efes_add_udq_2 != BCM_FIELD_ID_INVALID)
    {
        BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_destroy(unit, Cint_field_efes_add_udq_2), "");
        Cint_field_efes_add_udq_2 = BCM_FIELD_ID_INVALID;
    }

    if (Cint_field_efes_add_udq_3 != BCM_FIELD_ID_INVALID)
    {
        BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_destroy(unit, Cint_field_efes_add_udq_3), "");
