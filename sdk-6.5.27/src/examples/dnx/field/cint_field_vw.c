    ...
    int ipv4_header_offset_in_layer)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_name_to_id(unit, 0, &name_to_id_info, &nof_ids, ids), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &Cint_field_vw_fg_id_ipmf2), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, Cint_field_vw_fg_id_ipmf2, context_id_ipmf2, &attach_info), "");
    ...
    int ipv4_header_offset_in_layer)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &Cint_field_vw_fg_id_ipmf3), "");
    ...
    attach_info.payload_info.nof_actions = fg_info.nof_actions;
    attach_info.payload_info.action_types[0] = fg_info.action_types[0];
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, Cint_field_vw_fg_id_ipmf3, context_id_ipmf3, &attach_info), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, Cint_field_vw_fg_id_ipmf3, &entry_info, &Cint_field_vw_entry_id_ipmf3), "");
...
int field_vw_main(
    ...
    int ipv4_header_offset_in_layer)
{
    printf("Running: field_vw_main()\n");

    BCM_IF_ERROR_RETURN_MSG(field_vw_ipmf2(unit, context_id_ipmf2, ipv4_header_layer, ipv4_header_offset_in_layer), "");


    BCM_IF_ERROR_RETURN_MSG(field_vw_ipmf3(unit, context_id_ipmf3, ipv4_header_layer, ipv4_header_offset_in_layer), "");
...
int field_vw_destroy(
    ...
    bcm_field_context_t context_id_ipmf3)
{
    printf("Running: field_vw_destroy()\n");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, Cint_field_vw_fg_id_ipmf2, context_id_ipmf2), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, Cint_field_vw_fg_id_ipmf2), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, Cint_field_vw_fg_id_ipmf3, NULL, Cint_field_vw_entry_id_ipmf3), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, Cint_field_vw_fg_id_ipmf3, context_id_ipmf3), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, Cint_field_vw_fg_id_ipmf3), "");
