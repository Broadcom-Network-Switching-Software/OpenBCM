         ...
         bcm_field_action_t action_type, int action_value,char * name)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &cint_const_action), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, cint_const_fg_id, context_id, &attach_info), "");
...
{
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, cint_const_fg_id, context_id), "");

    /* Delete constant FG */
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, cint_const_fg_id), "");

    /* Delete user define action */
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_destroy(unit, cint_const_action), "");
...
int cint_field_group_const_example_ipt_gen(int unit, bcm_field_context_t context_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_group_const_main(unit, stage,context_id,bcmFieldActionIPTProfile, 2 , "IPT_prof_2"), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_group_const_main(unit, stage,context_id,bcmFieldActionIPTCommand, 1 , "IPT_com_1"), "");
...
int cint_field_group_const_example_UDH_gen(int unit, bcm_field_context_t context_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_group_const_main(unit, bcmFieldStageIngressPMF1,context_id,bcmFieldActionUDHData2,0xABCDABCD , "UDH2_const"), "");
