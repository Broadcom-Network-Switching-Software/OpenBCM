    ...
    int unit)
{
    ...
    qual_info.size = 1;
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &Cint_field_efes_polarity_basic_example_val_bit_qual_id), "");
    ...
    qual_info.name[sizeof(qual_info.name) - 1] = 0;
    qual_info.size = 3;
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &Cint_field_efes_polarity_basic_example_qual_id), "");
    ...
    bcm_field_group_info_t *fg_info)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, fg_info, &Cint_field_efes_polarity_basic_example_fg_id), "");
    ...
    int polarity)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, Cint_field_efes_polarity_basic_example_fg_id, context_id, &attach_info), "");
    ...
    bcm_field_context_t context_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_efes_polarity_basic_example_qual_create(unit), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_efes_polarity_basic_example_fg_create(unit, &fg_info), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_efes_polarity_basic_example_attach(unit, context_id, fg_info, 0), "");
    ...
    bcm_field_context_t context_id2)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_efes_polarity_basic_example_attach(unit, context_id1, fg_info, 0), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_efes_polarity_basic_example_attach(unit, context_id2, fg_info, 1), "");
...
cint_field_efes_polarity_basic_example_destroy(
    ...
    bcm_field_context_t context_id)
{
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, Cint_field_efes_polarity_basic_example_fg_id, context_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, Cint_field_efes_polarity_basic_example_fg_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_destroy(unit, Cint_field_efes_polarity_basic_example_val_bit_qual_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_destroy(unit, Cint_field_efes_polarity_basic_example_qual_id), "");
...
cint_field_efes_different_polarity_destroy(
    ...
    bcm_field_context_t context_id2)
{
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, Cint_field_efes_polarity_basic_example_fg_id, context_id1), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, Cint_field_efes_polarity_basic_example_fg_id, context_id2), "");
