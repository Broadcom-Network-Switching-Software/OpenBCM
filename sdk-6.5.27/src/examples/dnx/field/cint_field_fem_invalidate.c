 ...
 * Test Scenario - start
  ...
  cint;
  int unit = 0;
  bcm_field_context_t context_ipv4 = 0;
  bcm_field_context_t context_ipv6 = 0;
    ...
    bcm_field_context_t context_ipv6)
{
    ...
    printf("Running: cint_field_fem_invalidate_main()\n");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit, 0, &qual_info, &Cint_field_fem_invalidate_udq), "");
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_info_get(unit, bcmFieldActionUDHData0, bcmFieldStageIngressPMF2, &action_info_get), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &Cint_field_fem_invalidate_uda), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &Cint_field_fem_invalidate_fg_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_fem_action_add(unit, 0, Cint_field_fem_invalidate_fg_id, Cint_field_fem_invalidate_fem_position_1, &fem_action_info), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_fem_action_add(unit, 0, Cint_field_fem_invalidate_fg_id, Cint_field_fem_invalidate_fem_position_2, &fem_action_info), "");

    /* 
     * Get the offsets of TTL and hop limit
     */
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_info_get(unit, bcmFieldQualifyIp4Ttl, bcmFieldStageIngressPMF2, &qual_info_get), "");

    ttl_offset = qual_info_get.offset;
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_info_get(unit, bcmFieldQualifyIp6HopLimit, bcmFieldStageIngressPMF2, &qual_info_get), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, Cint_field_fem_invalidate_fg_id, context_ipv4, &fg_attach_info), "");
    ...
    fg_attach_info.payload_info.nof_invalidate_fems = 1;
    fg_attach_info.payload_info.invalidate_fems = invalidate_fems;
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, Cint_field_fem_invalidate_fg_id, context_ipv6, &fg_attach_info), "");
    ...
    bcm_field_context_t context_ipv6)
{
    ...
    printf("Running: cint_field_fem_invalidate_destroy()\n");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, Cint_field_fem_invalidate_fg_id, context_ipv4), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, Cint_field_fem_invalidate_fg_id, context_ipv6), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_fem_action_delete(unit, Cint_field_fem_invalidate_fg_id, Cint_field_fem_invalidate_fem_position_1), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_field_fem_action_delete(unit, Cint_field_fem_invalidate_fg_id, Cint_field_fem_invalidate_fem_position_2), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, Cint_field_fem_invalidate_fg_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_destroy(unit, Cint_field_fem_invalidate_udq), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_destroy(unit, Cint_field_fem_invalidate_uda), "");
