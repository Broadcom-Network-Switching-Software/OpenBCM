...
cint_sflow_basic_ingress_create(int unit, int in_port, int sflow_out_port, bcm_gport_t sflow_destination)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_sflow_field_entry_add(unit, bcmFieldLayerTypeEth, bcmFieldLayerTypeIp4, TRUE, 
    ...
    int route_out_port)
{
     ...
     * Create a field entry for IPoETH
     */
    BCM_IF_ERROR_RETURN_MSG(cint_sflow_egress_field_entry_add(unit, route_out_port, cint_sflow_basic_info.egress_sflow.egress_mirror_destination), "");
...
cint_sflow_basic_route_main(int unit, int in_port, int route_out_port, int sflow_out_port, int eventor_port, int eventor_id, int is_aggregated, int is_ITMH_forwarding)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(dnx_basic_example(unit, in_port, route_out_port, cint_sflow_basic_info.kaps_result), "");
    ...
    if (cint_sflow_basic_info.egress_sflow.is_egress_sflow) {
        BCM_IF_ERROR_RETURN_MSG(cint_sflow_basic_egress_create(unit, route_out_port), "");
    }
     ...
     */
    if (is_aggregated) {
       BCM_IF_ERROR_RETURN_MSG(cint_sflow_basic_ingress_create(unit, in_port, eventor_port, sflow_destination), "");
    }
    else {
       BCM_IF_ERROR_RETURN_MSG(cint_sflow_basic_ingress_create(unit, in_port, sflow_out_port, sflow_destination), "");
    }
    ...
    if (is_aggregated && (is_ITMH_forwarding == 0)) {
         ...
         */
        BCM_IF_ERROR_RETURN_MSG(cint_sflow_utils_route_sflow_datagram(unit, eventor_port, sflow_out_port, fec_id +1), "");
         ...
         */
        BCM_IF_ERROR_RETURN_MSG(cint_sflow_utils_sflow_sn_config(unit, eventor_port, sflow_out_port, context_id), "");
...
cint_sflow_basic_general_init(int unit, int sflow_out_port, int eventor_port, int eventor_id, int nof_samples, int is_aggregated, int is_ITMH_forwarding)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(cint_sflow_field_main(unit, cint_sflow_basic_info.egress_sflow.is_egress_sflow, context_id), "");
    ...
    if (is_aggregated) {
       BCM_IF_ERROR_RETURN_MSG(cint_sflow_basic_eventor_set(unit, sflow_out_port, eventor_port, nof_samples, eventor_id, is_ITMH_forwarding), "");
    }
    return BCM_E_NONE;
}
...
cint_sflow_basic_egress_general_init(int unit, int is_egress_sflow, int egress_mirror_port)
{
    ...
    if (is_egress_sflow) {
        BCM_IF_ERROR_RETURN_MSG(field_presel_fwd_layer_main(unit,40,bcmFieldStageEgress,bcmFieldLayerTypeIp4,&egress_context_id,"egress_mirror_ctx"), "");
		
        /*
         * Map the out packet to the mirror destination.
         */
        BCM_IF_ERROR_RETURN_MSG(cint_sflow_egress_field_main(unit, egress_context_id), "");
    }
...
sflow_basic_eventor_set_internal(int unit, int sflow_out_port, int eventor_port, int nof_samples, int eventor_id, int is_ITMH_forwarding, int reconfigure)
{
   ...
   */
   if (is_ITMH_forwarding) {
      ...
      BCM_IF_ERROR_RETURN_MSG(cint_sflow_utils_eventor_itmh_set(unit, eventor_id, cint_sflow_basic_info.buffer_size, nof_samples, eventor_port, sflow_out_port), "");
   }
   else {
      BCM_IF_ERROR_RETURN_MSG(cint_sflow_utils_eventor_set(unit, eventor_id, cint_sflow_basic_info.buffer_size, nof_samples, eventor_port, sflow_out_port, reconfigure), "");
   }
...
cint_sflow_basic_eventor_set(int unit, int sflow_out_port, int eventor_port, int nof_samples, int eventor_id, int is_ITMH_forwarding)
{
     ...
     * Set eventor configuration.
     */
    BCM_IF_ERROR_RETURN_MSG(sflow_basic_eventor_set_internal(unit, sflow_out_port, eventor_port, nof_samples, eventor_id, is_ITMH_forwarding, 0), "");
...
cint_sflow_basic_eventor_reconfig(int unit, int sflow_out_port, int eventor_port, int nof_samples, int eventor_id, int is_ITMH_forwarding)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_sflow_utils_mirror_create(unit, eventor_port, cint_sflow_basic_info.sflow_encap_id,
            0, cint_sflow_basic_info.sample_rate_divisor,
            &cint_sflow_basic_info.sflow_mirror_destination, 1), "(dividend=0)");
     ...
     *   3. Reconfigure Eventor
     */     
    BCM_IF_ERROR_RETURN_MSG(sflow_basic_eventor_set_internal(unit, sflow_out_port, eventor_port, nof_samples, eventor_id, is_ITMH_forwarding, 1), "");
