...
int ip_tunnel_term_set_fec_rif_intf = 1;
struct cint_ip_tunnel_basic_info_s
{
    ...
    uint8 is_udp_tunnel_src_nat;            /* indicate if udp tunnel dest nat */
    int gre_flags;                       /* tunnel termination gre flags */
};
...
cint_ip_tunnel_basic_info_s cint_ip_tunnel_basic_info = {
    ...
    /*
     * indicate if udp tunnel src nat
     */
    0,
    /*
     * gre flags
    ...
    int access_port)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(ip_tunnel_termination_open_route_interfaces_provider(unit, provider_port), "");

    /*
     * Configure egress interfaces
     */
    BCM_IF_ERROR_RETURN_MSG(ip_tunnel_termination_open_route_interfaces_access(unit, access_port), "");
    ...
    int provider_port)
{
    ...
    {
        BCM_IF_ERROR_RETURN_MSG(in_port_intf_wide_set(unit, provider_port, cint_ip_tunnel_basic_info.eth_rif_intf_provider), "");
    }
    else
    {
    ...
    BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create_vrf(unit,
            ...
            cint_ip_tunnel_basic_info.intf_provider_mac_address), "eth_rif_intf_provider");
    ...
    int access_port)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(ip_tunnel_termination_open_route_interfaces(unit, provider_port, access_port), "");

    /** Create VXLAN-GPE IP tunnel terminator */
    BCM_IF_ERROR_RETURN_MSG(tunnel_terminator_create(unit, &tunnel_intf, &cint_ip_tunnel_basic_info.tunnel_id_v4), "");

    /** Add MPLS route to IP-Tunnel.*/
    BCM_IF_ERROR_RETURN_MSG(ip_tunnel_termination_create_mpls_swap_tunnel(unit, &mpls_intf_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create(unit, cint_ip_tunnel_basic_info.fec_id, mpls_intf_id, 0,
                                     access_port, 0, 0), "");

    /** Create mpls LSF for port pointed by FEC, pointed by ECMP group id */
    BCM_IF_ERROR_RETURN_MSG(ip_tunnel_termination_ilm_switch_tunnel_create(unit,
    ...
    int access_port)
{
    ...
    for (i=0; i< nof_tunnel_termination_priorities; i++) {
        ...
        int arp_id;
        BCM_IF_ERROR_RETURN_MSG(l3__egress_only_encap__create(unit, 0, &(arp_id),
        ...
        BCM_IF_ERROR_RETURN_MSG(add_host_ipv4(unit, cint_ip_tunnel_basic_info.route_dip,
                           ...
                           cint_ip_tunnel_basic_info.fec_id, 0, 0), "route_dip");
        ...
        bcm_l3_ingress_urpf_mode_t urpf_mode)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(intf_ingress_rif_rpf_set(unit, rif_id, resolved_vrf, urpf_mode), "");
    return BCM_E_NONE;
}
    ...
    int access_port)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(in_port_intf_set(unit, provider_port_v4, eth_rif_intf_in_v4), "eth_rif_intf_in_v4");
    BCM_IF_ERROR_RETURN_MSG(in_port_intf_set(unit, provider_port_v6, eth_rif_intf_in_v6), "eth_rif_intf_in_v6");
    ...
    BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create(unit, eth_rif_intf_in_v4,
                             cint_ip_tunnel_basic_info.intf_provider_mac_address), "eth_rif_intf_in_v4");
    BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create(unit, eth_rif_intf_in_v6,
                             cint_ip_tunnel_basic_info.intf_provider_mac_address), "eth_rif_intf_in_v6");
    /** Acess */
    BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create(unit, cint_ip_tunnel_basic_info.eth_rif_intf_access,
                             cint_ip_tunnel_basic_info.intf_access_mac_address), "eth_rif_intf_access");
    ...
    BCM_IF_ERROR_RETURN_MSG(intf_ingress_rif_set(unit, &ingr_itf), "eth_rif_intf_in_v4");
    l3_ingress_intf_init(&ingr_itf);
    ingr_itf.intf_id = eth_rif_intf_in_v6;
    ingr_itf.vrf = provider_vrf_v6;
    BCM_IF_ERROR_RETURN_MSG(intf_ingress_rif_set(unit, &ingr_itf), "eth_rif_intf_in_v6");

    /** Create VXLAN-GPE IP tunnel terminators */
    cint_ip_tunnel_basic_info.provider_vrf = provider_vrf_v4;

    BCM_IF_ERROR_RETURN_MSG(tunnel_terminator_create(unit, &tunnel_intf_v4, &cint_ip_tunnel_basic_info.tunnel_id_v4),
        "provider_vrf_v4");
    cint_ip_tunnel_basic_info.provider_vrf = provider_vrf_v6;

    BCM_IF_ERROR_RETURN_MSG(tunnel_terminator_create(unit, &tunnel_intf_v6, &cint_ip_tunnel_basic_info.tunnel_id_v6),
        "provider_vrf_v6");

     /** Set Tunnel termination In-LIFs properties for RPF forwarding */
    BCM_IF_ERROR_RETURN_MSG(ip_tunnel_termination_rif_rpf_set(unit, tunnel_intf_v4, provider_vrf_v4,
            bcmL3IngressUrpfStrict), "tunnel_intf_v4");
    BCM_IF_ERROR_RETURN_MSG(ip_tunnel_termination_rif_rpf_set(unit, tunnel_intf_v6, provider_vrf_v6,
                                  bcmL3IngressUrpfStrict), "tunnel_intf_v6");
    ...
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create(unit, cint_ip_tunnel_basic_info.fec_id,
                                     cint_ip_tunnel_basic_info.eth_rif_intf_access,
                                     cint_ip_tunnel_basic_info.arp_id, gport, 0, 0), "fec_id");
    /** FECs for RPF strict */
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create(unit, fec_rpf_strict_v4, tunnel_intf_v4, 0, gport, 0, 0),
        "fec_rpf_strict_v4");
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create(unit, fec_rpf_strict_v6, tunnel_intf_v6, 0, gport, 0, 0),
        "fec_rpf_strict_v6");

    /** IPv4 DIP forwarding entry */
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv4(unit, cint_ip_tunnel_basic_info.route_dip, access_vrf_v4,
                       cint_ip_tunnel_basic_info.fec_id, 0, 0), "route_dip");
    /** Strict RPF IPv4 route entries - hit and miss */
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv4(unit, route_sip_rpf_hit_rif_miss_v4, access_vrf_v4,
                       cint_ip_tunnel_basic_info.fec_id, 0, 0), "route_sip_rpf_hit_rif_miss_v4");
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv4(unit, route_sip_rpf_hit_rif_hit_v4, access_vrf_v4, fec_rpf_strict_v4, 0,0),
        "route_sip_rpf_hit_rif_hit_v4");

    /** IPv6 DIP forwarding entry */
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv6(unit, cint_ip_tunnel_basic_info.ipv6_dip, access_vrf_v6,
                       cint_ip_tunnel_basic_info.fec_id), "ipv6_dip");
    /** Strict RPF IPv6 route entries - hit and miss */
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv6(unit, route_sip_rpf_hit_rif_miss_v6, access_vrf_v6,
                       cint_ip_tunnel_basic_info.fec_id), "route_sip_rpf_hit_rif_miss_v6");
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv6(unit, route_sip_rpf_hit_rif_hit_v6, access_vrf_v6, fec_rpf_strict_v6),
        "route_sip_rpf_hit_rif_hit_v6");
    BCM_IF_ERROR_RETURN_MSG(vxlan_network_domain_management_l3_ingress(unit, cint_ip_tunnel_basic_info.vni_v4, access_vrf_v4), "");
    BCM_IF_ERROR_RETURN_MSG(vxlan_network_domain_management_l3_ingress(unit, cint_ip_tunnel_basic_info.vni_v6, access_vrf_v6), "");
    ...
    bcm_gport_t *tunnel_id)
{
    ...
    if (cint_ip_tunnel_basic_info.gre_flags) {
        tunnel_term.flags |= cint_ip_tunnel_basic_info.gre_flags;
    }
    ...
    if (cint_ip_tunnel_basic_info.is_udp_tunnel_src_nat)
    {
        tunnel_term.flags |= BCM_TUNNEL_TERM_TUNNEL_SRC_NAT;
    }
    ...
    int access_port)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(tunnel_terminator_create(unit, &ingress_tunnel_intf, &cint_ip_tunnel_basic_info.tunnel_id_v4), "");

    if (cint_ip_tunnel_basic_info.forwarding_type == IPv4TerminationForwardTypeMPLS)
    {
        BCM_IF_ERROR_RETURN_MSG(ip_tunnel_termination_create_mpls_swap_tunnel(unit, &egress_tunnel_intf), "");
    } else {
    ...
    if (ip_tunnel_term_set_fec_rif_intf)
    {
        fec_rif_intf = cint_ip_tunnel_basic_info.eth_rif_intf_access;
    }
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create(unit, cint_ip_tunnel_basic_info.fec_id,
                                        fec_rif_intf,
                                        egress_tunnel_intf ,
                                        access_port, 0, flags2), "create egress object FEC only");
    ...
    if (cint_ip_tunnel_basic_info.forwarding_type == IPv4TerminationForwardTypeIPv4)
    {
        ...
        printf("%s(): Add IPv4 route entry.  route 0x%08X mask 0x%08X vrf %d fec 0x%08X. \n",proc_name,
                                                                                    ...
                                                                                    vrf,
                                                                                    cint_ip_tunnel_basic_info.fec_id);
        BCM_IF_ERROR_RETURN_MSG(add_route_ipv4(unit, cint_ip_tunnel_basic_info.route_dip,
                                    cint_ip_tunnel_basic_info.mask,
                                    vrf,
                                    cint_ip_tunnel_basic_info.fec_id), "");
    }
    else if (cint_ip_tunnel_basic_info.forwarding_type == IPv4TerminationForwardTypeIPv6)
    {
        ...
        BCM_IF_ERROR_RETURN_MSG(add_route_ipv6(unit, cint_ip_tunnel_basic_info.ipv6_dip,
    ...
    int provider_vrf_strict)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_ip_rpf_port_intf_set(unit, provider_port_loose, eth_rif_intf_in_loose,
            provider_vrf_loose, bcmL3IngressUrpfLoose), "Loose");

    BCM_IF_ERROR_RETURN_MSG(cint_ip_rpf_port_intf_set(unit, provider_port_strict, eth_rif_intf_in_strict,
            provider_vrf_strict, bcmL3IngressUrpfStrict), "Strict");
    ...
    BCM_IF_ERROR_RETURN_MSG(tunnel_terminator_create(unit, &tunnel_inlif_intf_id_rpf_loose, &cint_ip_tunnel_basic_info.tunnel_id_v4), "");

    cint_ip_tunnel_basic_info.provider_vrf = provider_vrf_strict;
    bcm_if_t tunnel_inlif_intf_id_rpf_strict;
    BCM_IF_ERROR_RETURN_MSG(tunnel_terminator_create(unit, &tunnel_inlif_intf_id_rpf_strict, &cint_ip_tunnel_basic_info.tunnel_id_v4), "");

    /** Set Tunnel termination In-LIF properties for RPF forwarding */
    BCM_IF_ERROR_RETURN_MSG(ip_tunnel_termination_rif_rpf_set(unit, tunnel_inlif_intf_id_rpf_loose, provider_vrf_loose,
                                  bcmL3IngressUrpfLoose), "intf_in_loose vrf_loose");
    BCM_IF_ERROR_RETURN_MSG(ip_tunnel_termination_rif_rpf_set(unit, tunnel_inlif_intf_id_rpf_strict, provider_vrf_strict,
                                  bcmL3IngressUrpfStrict), "intf_in_strict vrf_strict");

    /*
     * Create ARP entry and set its properties
     */
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_encap__create(unit, 0, &(cint_ip_tunnel_basic_info.arp_id),
        cint_ip_tunnel_basic_info.arp_next_hop_mac, 0), "create egress object ARP only");
    ...
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create(unit, fec_rpf_strict, tunnel_inlif_intf_id_rpf_strict, 0,
        gport, 0, rpf_flag), "create egress object FEC only, fec_rpf_strict");
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create(unit, fec_rpf_loose, tunnel_inlif_intf_id_rpf_loose, 0,
                                     gport, 0, rpf_flag), "create egress object FEC only, fec_rpf_loose");
    ...
    BCM_IF_ERROR_RETURN_MSG(add_route_ipv4(unit, cint_ip_tunnel_basic_info.route_dip, 0xffffffff, provider_vrf_loose, cint_ip_tunnel_basic_info.fec_id),
        "route_dip, vrf_loose");
    /* add routing entry for the SIPxVRF-> FEC (with FEC.RIF <> IN_RIF) */
    BCM_IF_ERROR_RETURN_MSG(add_route_ipv4_rpf(unit, route_sip_rpf_hit_rif_miss, 0xffffffff, provider_vrf_loose, cint_ip_tunnel_basic_info.fec_id),
        "route_sip_rpf_hit_rif_miss, vrf_loose");
    /* add routing entry for the SIPxVRF-> FEC (with FEC.RIF == IN_RIF) */
    BCM_IF_ERROR_RETURN_MSG(add_route_ipv4_rpf(unit, route_sip_rpf_hit_rif_hit, 0xffffffff, provider_vrf_loose, fec_rpf_loose),
        "route_sip_rpf_hit_rif_hit, vrf_loose");

    /** Strict */

    /* add routing entry for the DIPxVRF-> FEC */
    BCM_IF_ERROR_RETURN_MSG(add_route_ipv4(unit, cint_ip_tunnel_basic_info.route_dip, 0xffffffff, provider_vrf_strict, cint_ip_tunnel_basic_info.fec_id),
        "route_dip, vrf_strict");
    /* add routing entry for the SIPxVRF-> FEC (with FEC.RIF <> IN_RIF) */
    BCM_IF_ERROR_RETURN_MSG(add_route_ipv4_rpf(unit, route_sip_rpf_hit_rif_miss, 0xffffffff, provider_vrf_strict, cint_ip_tunnel_basic_info.fec_id),
        "route_sip_rpf_hit_rif_miss, vrf_strict");
    /* add routing entry for the SIPxVRF-> FEC (with FEC.RIF == IN_RIF) */
    BCM_IF_ERROR_RETURN_MSG(add_route_ipv4_rpf(unit, route_sip_rpf_hit_rif_hit, 0xffffffff, provider_vrf_strict, fec_rpf_strict),
        "route_sip_rpf_hit_rif_hit, vrf_strict");
    return BCM_E_NONE;
}
    ...
    int rif)
{
    ...
    /** Set Out-Port default properties */
    BCM_IF_ERROR_RETURN_MSG(out_port_set(unit, access_port_1), "access_port_1");

    BCM_IF_ERROR_RETURN_MSG(out_port_set(unit, access_port_2), "access_port_2");
    ...
    BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create(unit, cint_ip_tunnel_basic_info.eth_rif_intf_provider,
        cint_ip_tunnel_basic_info.intf_provider_mac_address), "cint_ip_tunnel_basic_info.eth_rif_intf_provider");
    ...
    BCM_IF_ERROR_RETURN_MSG(intf_ingress_rif_set(unit, &ingr_itf), "cint_ip_tunnel_basic_info.eth_rif_intf_provider");
    ...
    for (i = 0; i < nof_mc_replications; i++)
    {
        ...
        {
            BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create(unit, intf_out,
                                     cint_ip_tunnel_basic_info.intf_access_mac_address), "eth_rif_intf_access");
        }
        /** Set the replication */
    ...
    BCM_IF_ERROR_RETURN_MSG(create_multicast(unit, replications, cint_ipmc_info.nof_replications, cint_ip_tunnel_basic_info.ipmc_group), "");

    /** Select the bcmTunnelTypes */
    cint_ip_tunnel_basic_info.tunnel_type = bcmTunnelTypeIpAnyIn4;

    /** Create the tunnel termination lookup and the tunnel termination inlif */
    BCM_IF_ERROR_RETURN_MSG(tunnel_terminator_create(unit, &tunnel_inlif_intf_id, &cint_ip_tunnel_basic_info.tunnel_id_v4), "");
    ...
    for (i = 0; i < 4; i++)
    {
        BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create(unit, fec_ids[i], tunnel_in_lifs[i], 0, mc_gport, flags[i], 0),
            "create egress object FEC inner, fecs[0]");
    }

    /** For SIP-based RPF we need to add an UC entry with the IP of the SRC IP */
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv4(unit, cint_ip_tunnel_basic_info.mrpf_sip, cint_ip_tunnel_basic_info.access_vrf, fec_ids[0], 0, 0), "");
    /** For failing Explicit RPF we need to add an UC entry with the IP of the SRC IP and a wrong FEC */
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv4(unit, cint_ip_tunnel_basic_info.mrpf_sip + 1, cint_ip_tunnel_basic_info.access_vrf, fec_ids[3],
            0, 0), "");

    /** Create four IPMC entries - two leading to SIP-based RPF, two leading to Explicit RPF. */
    for (i = 0; i < 4; i++)
    {
        snprintf(error_msg, sizeof(error_msg), "iter = %d", i);
        BCM_IF_ERROR_RETURN_MSG(add_ipv4_ipmc(unit, cint_ip_tunnel_basic_info.ipmc_dip, cint_ip_tunnel_basic_info.mask, 0,
                cint_ip_tunnel_basic_info.mrpf_sip_mask, tunnel_inlif_intf_id, cint_ip_tunnel_basic_info.access_vrf, 0,
                fec_ids[i], 0), error_msg);
...
vxlan_network_domain_update(
    ...
    int tunnel_term_id)
{
    BCM_IF_ERROR_RETURN_MSG(bcm_port_class_set (unit, tunnel_term_id, bcmPortClassIngress, update_value), "");
    return BCM_E_NONE;
}
    ...
    int access_port)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(ip_tunnel_term_with_various_fwd(unit, provider_port, access_port), "");
    ...
    int access_port)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_l3_egress_get(unit, l3egid, &l3eg), "");

    l3eg.intf = l3eg.encap_id;
    l3eg.encap_id = 0;
    BCM_IF_ERROR_RETURN_MSG(bcm_l3_egress_create(unit, BCM_L3_INGRESS_ONLY | BCM_L3_WITH_ID | BCM_L3_REPLACE, &l3eg, &l3egid), "");
 ...
 */
int
ip_tunnel_term_udp_with_src_nat_fwd(
    int unit,
    int provider_port,
    int access_port,
    uint32 nat_port,
    uint32 nat_signature_lsb,
    uint32 nat_signature_msb)
{

    BCM_IF_ERROR_RETURN_MSG(ip_tunnel_pemla_tunneled_nat_udp_cfg_enable(unit, nat_port, nat_signature_lsb, nat_signature_msb), "");

    ip_tunnel_term_set_fec_rif_intf = 0;

    cint_ip_tunnel_basic_info.is_udp_tunnel_src_nat = TRUE;
...
int
ip_tunnel_pemla_tunneled_nat_udp_cfg_enable(
    int unit,
    uint32 nat_port,
    uint32 nat_signature_lsb,
    uint32 nat_signature_msb)
{
    ...
    uint32 signature_value[2] = {nat_signature_lsb, nat_signature_msb};
    uint32 value = 1;
    uint32 core_id  = -17; /*CORE_ALL*/

    /** configure NAT parsing enabler and dport */
    BCM_IF_ERROR_RETURN_MSG(dnx_dbal_entry_handle_take(unit, "PEMLA_PARSERUDP", &entry_handle_id), "");
    BCM_IF_ERROR_RETURN_MSG(dnx_dbal_entry_value_field_arr32_set(unit, entry_handle_id, "TUNNELED_NATOUDP_ENABLE", 0, &value), "");
    BCM_IF_ERROR_RETURN_MSG(dnx_dbal_entry_value_field_arr32_set(unit, entry_handle_id, "DSTPORTTUNNELED_NAT", 0, &nat_port), "");
    BCM_IF_ERROR_RETURN_MSG(dnx_dbal_entry_commit(unit, entry_handle_id, "DBAL_COMMIT"), "[PEMLA_PARSERUDP]");
    BCM_IF_ERROR_RETURN_MSG(dnx_dbal_entry_handle_free(unit,entry_handle_id), "");

    /** configure NAT signature value */
    BCM_IF_ERROR_RETURN_MSG(dnx_dbal_entry_handle_take(unit, "PEMLA_TUNNELED_NAT", &entry_handle_id), "");
    BCM_IF_ERROR_RETURN_MSG(dnx_dbal_entry_value_field_arr32_set(unit, entry_handle_id, "NAT_SIGNATURE_LSB", 0, &nat_signature_lsb), "");
    BCM_IF_ERROR_RETURN_MSG(dnx_dbal_entry_value_field_arr32_set(unit, entry_handle_id, "NAT_SIGNATURE_MSB", 0, &nat_signature_msb), "");
    BCM_IF_ERROR_RETURN_MSG(dnx_dbal_entry_commit(unit, entry_handle_id, "DBAL_COMMIT"), "[PEMLA_TUNNELED_NAT]");
    BCM_IF_ERROR_RETURN_MSG(dnx_dbal_entry_handle_free(unit,entry_handle_id), "");

    /** configure NAT signature lookup */
    BCM_IF_ERROR_RETURN_MSG(dnx_dbal_entry_handle_take(unit, "NAT_SIGNATURE_CHECK", &entry_handle_id), "");
    BCM_IF_ERROR_RETURN_MSG(dnx_dbal_entry_key_field_arr32_set(unit, entry_handle_id, "NAT_SIGNATURE", signature_value), "");
    BCM_IF_ERROR_RETURN_MSG(dnx_dbal_entry_key_field_arr32_set(unit, entry_handle_id, "CORE_ID", &core_id), "");
    BCM_IF_ERROR_RETURN_MSG(dnx_dbal_entry_value_field_arr32_set(unit, entry_handle_id, "FOUND", 0, &value), "");
    BCM_IF_ERROR_RETURN_MSG(dnx_dbal_entry_commit(unit, entry_handle_id, "DBAL_COMMIT"), "[NAT_SIGNATURE_CHECK]");
    BCM_IF_ERROR_RETURN_MSG(dnx_dbal_entry_handle_free(unit,entry_handle_id), "");
 ...
 */
int
ip_tunnel_term_udp_with_dst_nat_fwd(
    int unit,
    int provider_port,
    int access_port)
{
    ...
    cint_ip_tunnel_basic_info.tunnel_dip    = 0xA1000011;
    cint_ip_tunnel_basic_info.tunnel_sip    = 0xA0000011;
    cint_ip_tunnel_basic_info.route_dip     = 0xA1000011;
    cint_ip_tunnel_basic_info.tunnel_type   = bcmTunnelTypeIpAnyIn4;

    cint_ip_tunnel_basic_info.forwarding_type = IPv4TerminationForwardTypeIPv4;
    cint_ip_tunnel_basic_info.access_vrf = cint_ip_tunnel_basic_info.provider_vrf;
    BCM_IF_ERROR_RETURN_MSG(ip_tunnel_term_with_various_fwd(unit, provider_port, access_port), "");
    ...
    int access_port)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(ip_tunnel_term_ipanyin4_with_ipvx_fwd(unit, provider_port, access_port), "");

    /* Create the faulty port */
    cint_ip_tunnel_basic_info.eth_rif_intf_provider     = 16;
    cint_ip_tunnel_basic_info.provider_vrf              = 2;

    BCM_IF_ERROR_RETURN_MSG(ip_tunnel_termination_open_route_interfaces_provider(unit, provider_port_faulty), "");
    ...
    printf("%s(): Add route entry.  route 0x%08X mask 0x%08X vrf %d fec 0x%08X. \n",proc_name,
                                                            ...
                                                            cint_ip_tunnel_basic_info.provider_vrf,
                                                            cint_ip_tunnel_basic_info.fec_id);
    BCM_IF_ERROR_RETURN_MSG(add_route_ipv4(unit, cint_ip_tunnel_basic_info.tunnel_dip,
                                cint_ip_tunnel_basic_info.mask,
                                cint_ip_tunnel_basic_info.provider_vrf,
                                cint_ip_tunnel_basic_info.fec_id), "");
    ...
    int access_port)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(vxlan_network_domain_management_l3_ingress(unit, cint_ip_tunnel_basic_info.vni_v4, cint_ip_tunnel_basic_info.access_vrf), "");
 ...
 */
int
ip_tunnel_term_vxlan_gpe_with_p2p_fwd(
    int unit,
    int provider_port,
    int access_port)
{
    ...
    int access_port)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_l3_vpbr_entry_add(unit, &entry), "");
    ...
    int access_port)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(ip_tunnel_term_gre4_with_ipv4_fwd_with_tunnel_vpbr(unit, provider_port, access_port), "");
