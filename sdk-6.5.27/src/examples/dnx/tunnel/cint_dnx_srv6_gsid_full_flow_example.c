                    ...
                    int is_gsid_prefix_64b)
{
    ...
    snprintf(error_msg, sizeof(error_msg), "end-point = %d", end_idx);
    BCM_IF_ERROR_RETURN_MSG(bcm_tunnel_terminator_create(unit, &tunnel_term_set), error_msg);
                        ...
                        int arp_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(vlan_translate_ive_eve_translation_set(unit, gport_arp_id,
                                                0,                                0,
                        ...
                        uint8 is_gsid_prefix_64b) /** if set, the last GSID Prefix is 64b, otherwise 48b */
{
    ...
    BCM_IF_ERROR_RETURN_MSG(in_port_intf_set(unit, in_port_end1, cint_srv6_tunnel_info.eth_rif_intf_in[ENDPOINT_GSID1]),
        "in_port_end1");

    /** End-Point-2 Eth RIF based on Port only - configuring Port match and resolting VSI of the IN_LIF */
    BCM_IF_ERROR_RETURN_MSG(in_port_intf_set(unit, in_port_end2, cint_srv6_tunnel_info.eth_rif_intf_in[ENDPOINT_GSID0]),
        "in_port_end2");

    /** Egress Eth RIF based on Port only - configuring Port match and resolting VSI of the IN_LIF */
    snprintf(error_msg, sizeof(error_msg), "in_port = %d, intf_in = %d", in_port_egress, cint_srv6_tunnel_info.eth_rif_intf_in[EGRESS]);
    BCM_IF_ERROR_RETURN_MSG(in_port_intf_set(unit, in_port_egress, cint_srv6_tunnel_info.eth_rif_intf_in[EGRESS]), error_msg);

    /** Egress to emulate GSID3 with VID to reuse Egress Node (with SI==3) with Port + VID */
    snprintf(error_msg, sizeof(error_msg), "in_port = %d, intf_in = %d", in_port_egress, cint_srv6_tunnel_info.eth_rif_intf_in[ENDPOINT_GSID3]);
    BCM_IF_ERROR_RETURN_MSG(in_port_vid_intf_set(unit, in_port_egress, cint_srv6_tunnel_info.tunnel_vid[EGRESS_VID], cint_srv6_tunnel_info.eth_rif_intf_in[ENDPOINT_GSID3]), error_msg);
    ...
    snprintf(error_msg, sizeof(error_msg), "intf_in %d", cint_srv6_tunnel_info.eth_rif_intf_in[ENDPOINT_GSID0]);
    BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create(unit, cint_srv6_tunnel_info.eth_rif_intf_in[ENDPOINT_GSID0], cint_srv6_tunnel_info.intf_in_mac_address[ENDPOINT_GSID0]), error_msg);

    /** End-Point-2 out-port SA  */
    BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create(unit, cint_srv6_tunnel_info.eth_rif_intf_out[ENDPOINT_GSID0], cint_srv6_tunnel_info.intf_out_mac_address[ENDPOINT_GSID0]), "intf_out");
    ...
    snprintf(error_msg, sizeof(error_msg), "intf_in %d", cint_srv6_tunnel_info.eth_rif_intf_in[ENDPOINT_GSID3]);
    BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create(unit, cint_srv6_tunnel_info.eth_rif_intf_in[ENDPOINT_GSID3], cint_srv6_tunnel_info.intf_in_mac_address[EGRESS]), error_msg);
    ...
    snprintf(error_msg, sizeof(error_msg), "intf_in = %d, vrf = %d",
        cint_srv6_tunnel_info.eth_rif_intf_in[ENDPOINT_GSID3], cint_srv6_tunnel_info.vrf_in[EGRESS]);
    BCM_IF_ERROR_RETURN_MSG(intf_ingress_rif_set(unit, &ingress_rif), error_msg);
    ...
    BCM_IF_ERROR_RETURN_MSG(set_eth_arp_ac_untagged(unit, cint_srv6_tunnel_info.tunnel_arp_id[INGRESS]), "");


    /** End-Point-1 ARP create, with VLAN ID of expected in End-Point-2*/
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_encap__create_inner(unit, 0, &cint_srv6_tunnel_info.tunnel_arp_id[ENDPOINT_GSID1], cint_srv6_tunnel_info.arp_next_hop_mac[ENDPOINT_GSID1], cint_srv6_tunnel_info.tunnel_vid[END_POINT_2_VID], 0, flags2),
        "create egress object ARP only, in End-Point-1");

    /** Set ETH encap to Untagged */
    BCM_IF_ERROR_RETURN_MSG(set_eth_arp_ac_untagged(unit, cint_srv6_tunnel_info.tunnel_arp_id[ENDPOINT_GSID1]), "");

    /** End-Point-2 ARP create, with VLAN ID of Egress Tunnel, however there we will look on only the Port */
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_encap__create_inner(unit, 0, &cint_srv6_tunnel_info.tunnel_arp_id[ENDPOINT_GSID0], cint_srv6_tunnel_info.arp_next_hop_mac[ENDPOINT_GSID0], cint_srv6_tunnel_info.tunnel_vid[EGRESS_VID], 0, flags2),
        "create egress object ARP only, in End-Point-2");

    /** Set ETH encap to Untagged */
    BCM_IF_ERROR_RETURN_MSG(set_eth_arp_ac_untagged(unit, cint_srv6_tunnel_info.tunnel_arp_id[ENDPOINT_GSID0]), "");
    ...
    /** Set ETH encap to Untagged */
    BCM_IF_ERROR_RETURN_MSG(set_eth_arp_ac_untagged(unit, cint_srv6_tunnel_info.tunnel_arp_id[EGRESS]), "");

    /*
     * 6. SRV6 FEC Entries
     */

    bcm_gport_t gport, gport_2nd_hier;
    ...
    snprintf(error_msg, sizeof(error_msg), "create egress object FEC only for End-Point-1: fec = %d, intf_out = %d, encap_id = %d, out_port = %d",
        cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID], cint_srv6_tunnel_info.eth_rif_intf_out[ENDPOINT_GSID1], cint_srv6_tunnel_info.tunnel_arp_id[ENDPOINT_GSID1], out_port_end1);
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create(unit, cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID], cint_srv6_tunnel_info.eth_rif_intf_out[ENDPOINT_GSID1],
                                            cint_srv6_tunnel_info.tunnel_arp_id[ENDPOINT_GSID1], gport, 0, fec_flags2), error_msg);
    ...
    snprintf(error_msg, sizeof(error_msg), "create egress object FEC only for End-Point-2: fec = %d, intf_out = %d, encap_id = %d, out_port = %d",
        cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_2_FEC_ID], cint_srv6_tunnel_info.eth_rif_intf_out[ENDPOINT_GSID0], cint_srv6_tunnel_info.tunnel_arp_id[ENDPOINT_GSID0], out_port_end2);
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create(unit, cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_2_FEC_ID], cint_srv6_tunnel_info.eth_rif_intf_out[ENDPOINT_GSID0],
                                            cint_srv6_tunnel_info.tunnel_arp_id[ENDPOINT_GSID0], gport, 0, fec_flags2), error_msg);
    ...
    if(*dnxc_data_get(unit, "l3", "fwd", "host_entry_support", NULL))
    {
        ...
        BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create_inner(unit, cint_srv6_tunnel_info.tunnel_fec_id[EGRESS_FEC_ID], 0 , cint_srv6_tunnel_info.tunnel_arp_id[EGRESS], gport, 0, fec_flags2,
    ...
    if (*dnxc_data_get(unit, "l3", "fwd", "host_entry_support", NULL))
    {
        ...
        if (is_gsid_prefix_64b)
        {
            BCM_IF_ERROR_RETURN_MSG(add_host_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip_64b[DIP_ENDPOINT_GSID0], cint_srv6_tunnel_info.vrf_in[ENDPOINT_GSID1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]), error_msg);
        }
        else
        {
            BCM_IF_ERROR_RETURN_MSG(add_host_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[DIP_ENDPOINT_GSID0], cint_srv6_tunnel_info.vrf_in[ENDPOINT_GSID1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]), error_msg);
        }
        ...
        if (is_gsid_eoc)
        {
            ...
            snprintf(error_msg, sizeof(error_msg), "for GSID0 is EOC: vrf = %d, fec = %d",
                cint_srv6_tunnel_info.vrf_in[ENDPOINT_GSID0], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_2_FEC_ID]);
            if (is_gsid_prefix_64b)
            {
                BCM_IF_ERROR_RETURN_MSG(add_host_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip_64b[DIP_ENDPOINT_CLASSIC], cint_srv6_tunnel_info.vrf_in[ENDPOINT_GSID0], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_2_FEC_ID]), error_msg);
            }
            else
            {
                BCM_IF_ERROR_RETURN_MSG(add_host_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[DIP_ENDPOINT_CLASSIC], cint_srv6_tunnel_info.vrf_in[ENDPOINT_GSID0], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_2_FEC_ID]), error_msg);
            }
        ...
        {
            /** add Egress as host to do forwarding on to FEC */
            snprintf(error_msg, sizeof(error_msg), "for GSID0 none EOC: vrf = %d, fec = %d",
                cint_srv6_tunnel_info.vrf_in[ENDPOINT_GSID0], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_2_FEC_ID]);
            if (is_gsid_prefix_64b)
            {
                BCM_IF_ERROR_RETURN_MSG(add_host_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip_64b[DIP_EGRESS], cint_srv6_tunnel_info.vrf_in[ENDPOINT_GSID0], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_2_FEC_ID]), error_msg);
            }
            else
            {
                BCM_IF_ERROR_RETURN_MSG(add_host_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[DIP_EGRESS], cint_srv6_tunnel_info.vrf_in[ENDPOINT_GSID0], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_2_FEC_ID]), error_msg);
            }

        }

        /** just to add Endpoint GSID2 case of SI==3 to SI==2 with VRF of "Egress Node SI==3" & FEC of ENDPOINT_GSID2 */
        snprintf(error_msg, sizeof(error_msg), "for GSID2: vrf = %d, fec = %d",
            cint_srv6_tunnel_info.vrf_in[EGRESS], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
        if (is_gsid_prefix_64b)
        {
            BCM_IF_ERROR_RETURN_MSG(add_host_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip_64b[DIP_ENDPOINT_GSID2], cint_srv6_tunnel_info.vrf_in[EGRESS], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]), error_msg);
        }
        else
        {
            BCM_IF_ERROR_RETURN_MSG(add_host_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[DIP_ENDPOINT_GSID2], cint_srv6_tunnel_info.vrf_in[EGRESS], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]), error_msg);
        }
    ...
    else
    {
        ...
        if (is_gsid_prefix_64b)
        {
            BCM_IF_ERROR_RETURN_MSG(add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip_64b[DIP_ENDPOINT_GSID0], ip6_mask, cint_srv6_tunnel_info.vrf_in[ENDPOINT_GSID1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]), error_msg);
        }
        else
        {
            BCM_IF_ERROR_RETURN_MSG(add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[DIP_ENDPOINT_GSID0], ip6_mask, cint_srv6_tunnel_info.vrf_in[ENDPOINT_GSID1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]), error_msg);
        }
        ...
        if (is_gsid_eoc)
        {
            ...
            if (is_gsid_prefix_64b)
            {
                BCM_IF_ERROR_RETURN_MSG(add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip_64b[DIP_ENDPOINT_CLASSIC], ip6_mask, cint_srv6_tunnel_info.vrf_in[ENDPOINT_GSID0], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_2_FEC_ID]), error_msg);
            }
            else
            {
                BCM_IF_ERROR_RETURN_MSG(add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[DIP_ENDPOINT_CLASSIC], ip6_mask, cint_srv6_tunnel_info.vrf_in[ENDPOINT_GSID0], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_2_FEC_ID]), error_msg);
            }
        ...
        else
        {
            ...
            if (is_gsid_prefix_64b)
            {
                BCM_IF_ERROR_RETURN_MSG(add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip_64b[DIP_EGRESS], ip6_mask, cint_srv6_tunnel_info.vrf_in[ENDPOINT_GSID0], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_2_FEC_ID]), error_msg);
            }
            else
            {
                BCM_IF_ERROR_RETURN_MSG(add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[DIP_EGRESS], ip6_mask, cint_srv6_tunnel_info.vrf_in[ENDPOINT_GSID0], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_2_FEC_ID]), error_msg);
            }
        ...
        if (is_gsid_prefix_64b)
        {
            BCM_IF_ERROR_RETURN_MSG(add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip_64b[DIP_ENDPOINT_GSID2], ip6_mask, cint_srv6_tunnel_info.vrf_in[EGRESS], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]), error_msg);
        }
        else
        {
            BCM_IF_ERROR_RETURN_MSG(add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[DIP_ENDPOINT_GSID2], ip6_mask, cint_srv6_tunnel_info.vrf_in[EGRESS], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]), error_msg);
        }
...

    {
       ...
       /** call the sid_initiator API to create the SID EEDB Entry and return its GPORT Tunnel-id */
       BCM_IF_ERROR_RETURN_MSG(bcm_srv6_sid_initiator_create(unit, &sid_info), "for SID3");
     ...
     */
    {
        ...
        BCM_IF_ERROR_RETURN_MSG(srv6_tunnel_termination(unit, DIP_ENDPOINT_GSID1, 0, cint_srv6_tunnel_info.vrf_in[ENDPOINT_GSID1], 0, 1, 0, 0, is_gsid_prefix_64b), "");
        BCM_IF_ERROR_RETURN_MSG(srv6_tunnel_termination(unit, DIP_ENDPOINT_GSID0, 0, cint_srv6_tunnel_info.vrf_in[ENDPOINT_GSID0], 0, 1, is_gsid_eoc, 0, is_gsid_prefix_64b), "");
        ...
        if (next_header_is_eth)
        {
            ...
            BCM_IF_ERROR_RETURN_MSG(srv6_tunnel_termination(unit, DIP_EGRESS, 1, cint_srv6_tunnel_info.vrf_in[EGRESS], cint_srv6_tunnel_info.l2_termination_vsi, 1, 0, 0, is_gsid_prefix_64b), "");
            /** to allow termination of GSID because of SL == 0 && EOC */
            BCM_IF_ERROR_RETURN_MSG(srv6_tunnel_termination(unit, DIP_EGRESS_EOC, 1, cint_srv6_tunnel_info.vrf_in[EGRESS], cint_srv6_tunnel_info.l2_termination_vsi, 1, is_gsid_eoc, 0, is_gsid_prefix_64b), "");
        }
        else
        {
            /** to allow termination of GSID because of SL == 0 && SI==0 */
            BCM_IF_ERROR_RETURN_MSG(srv6_tunnel_termination(unit, DIP_EGRESS, 1, cint_srv6_tunnel_info.vrf_in[EGRESS], 0, 1, 0, 0, is_gsid_prefix_64b), "");
            /** to allow termination of GSID because of SL == 0 && EOC */
            BCM_IF_ERROR_RETURN_MSG(srv6_tunnel_termination(unit, DIP_EGRESS_EOC, 1, cint_srv6_tunnel_info.vrf_in[EGRESS], 0, 1, is_gsid_eoc, 0, is_gsid_prefix_64b), "");
        }
        BCM_IF_ERROR_RETURN_MSG(srv6_tunnel_termination(unit, DIP_ENDPOINT_GSID1, 0, cint_srv6_tunnel_info.vrf_in[ENDPOINT_GSID1], 0, 1, is_gsid_eoc, default_tunnel_for_gsid_cascading, is_gsid_prefix_64b), "");
    }
