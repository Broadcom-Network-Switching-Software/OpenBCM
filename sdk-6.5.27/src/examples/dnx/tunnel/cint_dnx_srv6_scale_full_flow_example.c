                            ...
                            uint8 lif_cs_profile)     /** if not 0, terminated LIFs are set with this CS Profile */
{
    ...
    BCM_IF_ERROR_RETURN_MSG(in_port_vid_intf_set(unit, in_port_end1, cint_srv6_tunnel_info.tunnel_vid[END_POINT_1_VID], cint_srv6_tunnel_info.eth_rif_intf_in[END_POINT_1]),
        "in_port_end1");
    ...
    BCM_IF_ERROR_RETURN_MSG(in_port_vid_intf_set(unit, in_port_end2, cint_srv6_tunnel_info.tunnel_vid[END_POINT_2_VID], cint_srv6_tunnel_info.eth_rif_intf_in[END_POINT_2]),
        "in_port_end2");
    ...
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create_inner(unit, cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_SRH_FEC_ID], 0 , srv6_basic_lif_encode, gport, 0, 0,
    ...
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create_inner(unit, cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_FIRST_SID_FEC_ID], 0 , srv6_first_lif_encode, gport, BCM_L3_2ND_HIERARCHY, 0,
    ...
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create(unit, cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID], cint_srv6_tunnel_info.eth_rif_intf_out[END_POINT_1], cint_srv6_tunnel_info.tunnel_arp_id[END_POINT_1], gport, 0, 0), error_msg);
    ...
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create(unit, cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_2_FEC_ID], cint_srv6_tunnel_info.eth_rif_intf_out[END_POINT_2], cint_srv6_tunnel_info.tunnel_arp_id[END_POINT_2], gport, 0, 0), error_msg);
    ...
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create_inner(unit, cint_srv6_tunnel_info.tunnel_fec_id[EGRESS_FEC_ID], 0 , cint_srv6_tunnel_info.tunnel_arp_id[EGRESS], gport, 0, 0, 0, 0,&egress_encoded_fec1),
     ...
     */
    {
        ...
        if (next_header_is_eth)
        {
            BCM_IF_ERROR_RETURN_MSG(srv6_tunnel_termination(unit, SIDPASS, 1, cint_srv6_tunnel_info.vrf_in[EGRESS], cint_srv6_tunnel_info.l2_termination_vsi, lif_cs_profile), "");
            BCM_IF_ERROR_RETURN_MSG(srv6_tunnel_termination(unit, SIDDROP, 1, cint_srv6_tunnel_info.vrf_in[EGRESS], cint_srv6_tunnel_info.l2_termination_vsi, lif_cs_profile), "");
        }
        else
        {
            BCM_IF_ERROR_RETURN_MSG(srv6_tunnel_termination(unit, SIDPASS, 1, cint_srv6_tunnel_info.vrf_in[EGRESS], 0, lif_cs_profile), "");
            BCM_IF_ERROR_RETURN_MSG(srv6_tunnel_termination(unit, SIDDROP, 1, cint_srv6_tunnel_info.vrf_in[EGRESS], 0, lif_cs_profile), "");
        }
