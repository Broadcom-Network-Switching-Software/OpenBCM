    ...
    int access_port)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(ip_tunnel_term_basic(unit, provider_port, access_port), "");
    return BCM_E_NONE;
}
    ...
    int access_port)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(in_port_intf_set(unit, provider_port, cint_ip_tunnel_basic_info.eth_rif_intf_provider), "");
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create(unit, cint_ip_tunnel_basic_info.eth_rif_intf_access, cint_ip_tunnel_basic_info.intf_access_mac_address),
        "eth_rif_intf_access");
    ...
    */
    ...
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create(unit, cint_ip_tunnel_basic_info.fec_id,
     ...
     * Add Route entry
     */
    BCM_IF_ERROR_RETURN_MSG(add_route_ipv4(unit, cint_ip_tunnel_basic_info.route_dip, cint_ip_tunnel_basic_info.mask,
                        cint_ip_tunnel_basic_info.access_vrf, cint_ip_tunnel_basic_info.fec_id), "");

    BCM_IF_ERROR_RETURN_MSG(add_host_ipv6(unit, cint_ip_route_basic_ipv6_host, cint_ip_tunnel_basic_info.access_vrf, cint_ip_tunnel_basic_info.fec_id), "");
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(tunnel_terminator_create_set_default_vrf(unit, &tunnel_term), "");
...
int
ip_tunnel_term_double_ipv4_tunnel(
    int unit,
    int provider_port,
    int access_port)
{
    ...
    cint_ip_tunnel_basic_info.tunnel_dip = 0xB5000001;
    cint_ip_tunnel_basic_info.tunnel_sip = 0xB6000001;
    cint_ip_tunnel_basic_info.provider_vrf = cint_ip_tunnel_basic_info.access_vrf;
    cint_ip_tunnel_basic_info.access_vrf = 100;
    cint_ip_tunnel_basic_info.tunnel_dip_mask = 0xFFFF0000;
    ...
    int unit, int provider_port, int access_port)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(add_route_ipv4(unit, cint_ip_tunnel_basic_info.tunnel_dip, cint_ip_tunnel_basic_info.tunnel_dip_mask,
