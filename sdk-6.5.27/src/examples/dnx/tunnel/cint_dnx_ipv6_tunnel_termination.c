    ...
    int access_port)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(ipv6_tunnel_termination_open_route_interfaces_provider(unit, provider_port), "");

    /*
     * Configure egress interfaces
     */
    BCM_IF_ERROR_RETURN_MSG(ipv6_tunnel_termination_open_route_interfaces_access(unit, access_port), "");
    ...
    {
        BCM_IF_ERROR_RETURN_MSG(l3__egress_only_encap__create(unit, 0, &(cint_ipv6_tunnel_info.arp_id),
    ...
    int provider_port)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(in_port_intf_set(unit, provider_port, cint_ipv6_tunnel_info.eth_rif_intf_provider),
        "eth_rif_intf_provider");
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create_vrf(unit,
            cint_ipv6_tunnel_info.eth_rif_intf_provider,
            cint_ipv6_tunnel_info.provider_vrf,
            cint_ipv6_tunnel_info.intf_provider_mac_address), "eth_rif_intf_provider");
    ...
    int access_port)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(out_port_set(unit, access_port), "access port");
    /*
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create(unit, cint_ipv6_tunnel_info.eth_rif_intf_access,
                             cint_ipv6_tunnel_info.intf_access_mac_address), "eth_rif_intf_access");
    ...
    int *tunnel_term_id)
{
    ...
    if (term_type == IPv6TerminationTypeP2P)
    {
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_tunnel_terminator_create(unit, &tunnel_termination_obj),
            "Term Type: IPv6TerminationTypeP2P");
    }
    else
    {
        /*
        ...
        term_type_int = term_type;
        snprintf(error_msg, sizeof(error_msg), "Term Type: %d", term_type_int);
        BCM_IF_ERROR_RETURN_MSG(bcm_tunnel_terminator_create(unit, &tunnel_termination_obj), error_msg);
    }

    term_type_int = term_type;
    snprintf(error_msg, sizeof(error_msg), "Term Type: %d", term_type_int);
    BCM_IF_ERROR_RETURN_MSG(ipv6_tunnel_termination_vrf_update(unit, cint_ipv6_tunnel_info.access_vrf, tunnel_termination_obj.tunnel_id), error_msg);
    ...
    if (term_type == IPv6TerminationTypeP2PMP)
    {
        ...
        */
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_tunnel_terminator_create(unit, &tunnel_termination_obj), "Term Type: IPv6TerminationTypeP2PMP");

        BCM_IF_ERROR_RETURN_MSG(ipv6_tunnel_termination_vrf_update(unit, cint_ipv6_tunnel_info.access_vrf, tunnel_termination_obj.tunnel_id),
            "Term Type: IPv6TerminationTypeP2PMP");
    }
    ...
    int bcm_tunnel_type)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(get_first_fec_in_range_which_not_in_ecmp_range(unit, 0, 0, &cint_ipv6_tunnel_info.fec_id), "");
    ...
    if (cint_ipv6_tunnel_info.forwarding_type == IPv6TerminationForwardTypeBridge)
    {
         ...
         * Build L2 VPN
         */
        snprintf(error_msg, sizeof(error_msg), "vpn=%d", cint_ipv6_tunnel_info.vpn_id);
        BCM_IF_ERROR_RETURN_MSG(dnx_utils_vxlan_open_vpn(unit, cint_ipv6_tunnel_info.vpn_id, 0, cint_ipv6_tunnel_info.vni), error_msg);
    }

    BCM_IF_ERROR_RETURN_MSG(ipv6_tunnel_termination_open_route_interfaces(unit, provider_port, access_port),
        "failed to execute!");

    /** Create the tunnel termination lookup and the tunnel termination inlif */
    BCM_IF_ERROR_RETURN_MSG(ipv6_tunnel_terminator_create(unit, term_type, &term_tunnel_id), "failed to execute!");
        ...
        cint_ipv6_tunnel_info.forwarding_type == IPv6TerminationForwardTypeIPv6)
    {
        ...
        BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create(unit,
                ...
                access_port,
                0, flags2), "create egress object FEC only");
        ...
        if(cint_ipv6_tunnel_info.forwarding_type == IPv6TerminationForwardTypeIPv4)
        {
             ...
             */
            BCM_IF_ERROR_RETURN_MSG(add_route_ipv4(unit, cint_ipv6_tunnel_info.route_ipv4_dip,
        ...
        else
        {
             ...
             */
            BCM_IF_ERROR_RETURN_MSG(add_route_ipv6(unit, cint_ipv6_tunnel_info.route_ipv6_dip,
    ...
    else if (cint_ipv6_tunnel_info.forwarding_type == IPv6TerminationForwardTypeMPLS)
    {
        ...
        BCM_IF_ERROR_RETURN_MSG(ipv6_tunnel_termination_create_mpls_swap_tunnel(unit, &mpls_tunnel_id), "");

        /*
         * Create FEC and configure its: Outlif (ARP), Destination port, Global Out-EthRIF
         */
        BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create(unit, cint_ipv6_tunnel_info.fec_id, mpls_tunnel_id, 0, access_port, 0, flags2), "");
        BCM_IF_ERROR_RETURN_MSG(ipv6_tunnel_termination_ilm_switch_tunnel_create(unit, cint_ipv6_tunnel_info.route_mpls_label,
                cint_ipv6_tunnel_info.fec_id), "");
    }
    ...
    */
    else if (cint_ipv6_tunnel_info.forwarding_type == IPv6TerminationForwardTypeBridge)
    {
        ...
        */
       BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create(unit, cint_ipv6_tunnel_info.fec_id, encap_tunnel_intf,
                                        0, access_port, 0, flags2), "create egress object FEC only");

       /*
        * Add VXLAN port properties and configure the tunnel terminator In-Lif and tunnel initiatior Out-Lif
        */

       BCM_IF_ERROR_RETURN_MSG(vxlan_port_add(unit, provider_port, term_tunnel_id, &vxlan_port_id), "");
       cint_ipv6_tunnel_info.vxlan_port_id = vxlan_port_id;

       /*
        * Create an MACT entry for VXLAN tunnel, mapped to the VPN
        */
       BCM_IF_ERROR_RETURN_MSG(mact_entry_add(unit, access_port), "");
    ...
    if (bcm_tunnel_type == bcmTunnelTypeVxlan6Gpe)
    {

        BCM_IF_ERROR_RETURN_MSG(vxlan_network_domain_management_l3_ingress(unit, cint_ipv6_tunnel_info.vni,cint_ipv6_tunnel_info.access_vrf), "");
    }
    ...
    int access_port)
{
    ...
    cint_ipv6_tunnel_info.forwarding_type = IPv6TerminationForwardTypeIPv6;
    BCM_IF_ERROR_RETURN_MSG(ipv6_tunnel_termination_generic(unit, provider_port, access_port, 0, bcmTunnelTypeIpAnyIn6), "");

    BCM_IF_ERROR_RETURN_MSG(add_route_ipv6(unit, cint_ipv6_tunnel_info.tunnel_ipv6_dip,
    ...
    int access_port)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(ipv6_tunnel_termination_generic(unit, provider_port, access_port,
    ...
    int access_port)
{
    ...
    cint_ipv6_tunnel_info.tunnel_id = 0;
    /** Create the tunnel termination lookup and the tunnel termination inlif */
    BCM_IF_ERROR_RETURN_MSG(ipv6_tunnel_terminator_create(unit, IPv6TerminationTypeMP, &term_tunnel_id), "");
    ...
    int is_subnet)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(ipv6_tunnel_termination_generic(unit, provider_port, access_port, term_type, bcm_tunnel_type), "");
    ...
    int is_subnet)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(ipv6_tunnel_term_with_ipvx_fwd(unit, provider_port, access_port, bcmTunnelTypeGeneve6, term_type, is_subnet), "");
    ...
    int is_subnet)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(ipv6_tunnel_termination_generic(unit, provider_port, access_port, term_type, bcmTunnelTypeGeneve6), "");
