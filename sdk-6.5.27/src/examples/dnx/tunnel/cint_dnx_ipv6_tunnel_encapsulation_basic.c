...
int ipv6_basic_tunnel_encapsulation(int unit, int access_port, int provider_port)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(get_first_fec_in_range_which_not_in_ecmp_range(unit, 0, 0, &cint_ipv6_tunnel_basic_info.tunnel_fec_id), "");

    /*
     * Set In-Port to In ETh-RIF
     */
    BCM_IF_ERROR_RETURN_MSG(in_port_intf_set(unit, access_port, cint_ipv6_tunnel_basic_info.eth_rif_intf_access),
        "failed to execute!");
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create(unit, cint_ipv6_tunnel_basic_info.eth_rif_intf_access, cint_ipv6_tunnel_basic_info.intf_access_mac_address),
        "failed to execute!");
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create(unit, cint_ipv6_tunnel_basic_info.eth_rif_intf_provider, cint_ipv6_tunnel_basic_info.intf_access_mac_address),
        "failed to execute!");
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_encap__create(unit, 0,&(cint_ipv6_tunnel_basic_info.tunnel_arp_id), cint_ipv6_tunnel_basic_info.tunnel_next_hop_mac,
            cint_ipv6_tunnel_basic_info.provider_vlan), "create egress object ARP only");

    /*
     * Create the tunnel initiator
     * and set next-lif-pointer to the ARP entry
     */
    BCM_IF_ERROR_RETURN_MSG(ipv6_basic_tunnel_initiator_create(unit, cint_ipv6_tunnel_basic_info.tunnel_arp_id, &tunnel_inlif),
        "failed to execute!");
    ...
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create(unit, cint_ipv6_tunnel_basic_info.tunnel_fec_id, tunnel_inlif, 0, provider_port, 0, fwd_flag),
        "failed to execute!");
    ...
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv4(unit, cint_ipv6_tunnel_basic_info.route_ipv4_dip, cint_ipv6_tunnel_basic_info.access_vrf, fec_id, 0,0),
        "failed to execute!");

    BCM_IF_ERROR_RETURN_MSG(add_host_ipv6(unit, cint_ip_route_basic_ipv6_host, cint_ipv6_tunnel_basic_info.access_vrf, fec_id), "");
