    ...
    int provider_port)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(ip_tunnel_encapsulation_open_route_interfaces_access(unit, access_port), "");

    /*
     * Configure egress interfaces
     */
    BCM_IF_ERROR_RETURN_MSG(ip_tunnel_encapsulation_open_route_interfaces_provider(unit, provider_port), "");

    /*
     * Create ARP entry and set its properties.
     */
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_encap__create(unit, 0, &(cint_ip_tunnel_basic_info.tunnel_arp_id),
    ...
    int access_port)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(intf_ingress_rif_set(unit, &ingr_intf), "eth_rif_intf_access");
    ...
    int provider_port)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(out_port_set(unit, provider_port), "");
    ...
    int gre_type)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(get_first_fec_in_range_which_not_in_ecmp_range(unit, 0, 0, &cint_ip_tunnel_basic_info.tunnel_fec_id), "");
    /*
     * Initialize ports, LIFs, Eth-RIFs etc
     */
    BCM_IF_ERROR_RETURN_MSG(ip_tunnel_encapsulation_open_route_interfaces(unit, access_port, provider_port), "");

    /*
     * Create GRE IP tunnel
     */
    BCM_IF_ERROR_RETURN_MSG(tunnel_initiator_create(unit, cint_ip_tunnel_basic_info.tunnel_arp_id, &cint_ip_tunnel_basic_info.tunnel_intf,
    ...
    if (gre_type == IPv4EncapsulationMPLSoGRE )
    {
        ...
        BCM_IF_ERROR_RETURN_MSG(mpls_swap_tunnel_create(unit, cint_ip_tunnel_basic_info.encap_label, cint_ip_tunnel_basic_info.tunnel_intf, &mpls_intf_id), "");
    ...
    if (forward_type == IPv4EncapsulationForwardTypeMPLS)
    {
         ...
         */
        bcm_if_t mpls_intf_id;
        BCM_IF_ERROR_RETURN_MSG(mpls_swap_tunnel_create(unit, cint_ip_tunnel_basic_info.mpls_fwd_label, cint_ip_tunnel_basic_info.tunnel_intf, &mpls_intf_id), "");
        cint_ip_tunnel_basic_info.tunnel_intf = mpls_intf_id;
    }
    ...
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create(unit, cint_ip_tunnel_basic_info.tunnel_fec_id, cint_ip_tunnel_basic_info.tunnel_intf, 0, provider_port, 0, fwd_flag),
        "failed to execute!");
    ...
    else if (forward_type == IPv4EncapsulationForwardTypeIPv4)
    {
         ...
         * Add Host entry
         */
        BCM_IF_ERROR_RETURN_MSG(add_host_ipv4(unit, cint_ip_tunnel_basic_info.route_ipv4_dip, cint_ip_tunnel_basic_info.access_vrf, fec_id, 0, 0),
            "failed to execute!");
    }
    else
    {
        BCM_IF_ERROR_RETURN_MSG(add_host_ipv6(unit, cint_ip_tunnel_basic_info.ipv6_dip, cint_ip_tunnel_basic_info.access_vrf, fec_id),
            "failed to execute!");
    }
    ...
    int udp_dst_port)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(ip_tunnel_encap_with_various_fwd(unit, access_port, provider_port, IPv4EncapsulationForwardTypeIPv4, IPv4EncapsulationGRE4), "");
...
ip_tunnel_encap_gre4_mpls_fwd(
    ...
    int provider_port)
{
    BCM_IF_ERROR_RETURN_MSG(ip_tunnel_encap_with_various_fwd(unit, access_port, provider_port, IPv4EncapsulationForwardTypeMPLS, IPv4EncapsulationGRE4), "");
    ...
    int vsi)
{
    ...
    /** Create FEC and configure its: Outlif, Destination port, Global Out-EthRIF */
    int fwd_flag = (*dnxc_data_get(unit, "l3", "feature", "separate_fwd_rpf_dbs", NULL)) ? BCM_L3_FLAGS2_FWD_ONLY : 0;
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create(unit, cint_ip_tunnel_basic_info.tunnel_fec_id, mpls_intf_id,
    ...
    BCM_IF_ERROR_RETURN_MSG(mpls_switch_tunnel_create(unit, cint_ip_tunnel_basic_info.mpls_fwd_label, cint_ip_tunnel_basic_info.ecmp_id), "");
    ...
    int vsi)
{
    ...
    /** Create FEC and configure its: Outlif, Destination port, Global Out-EthRIF */
    int fwd_flag = (*dnxc_data_get(unit, "l3", "feature", "separate_fwd_rpf_dbs", NULL)) ? BCM_L3_FLAGS2_FWD_ONLY : 0;
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create(unit, cint_ip_tunnel_basic_info.tunnel_fec_id, cint_ip_tunnel_basic_info.tunnel_intf,
                                     0, provider_port, 0, fwd_flag), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv6(unit, cint_ip_tunnel_basic_info.ipv6_dip,
...
vxlan_network_domain_management_l3_egress_replace(int unit, int qos_map_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_vxlan_network_domain_config_get(unit, &config), "");
    /**replace qos map id*/
    ...
    int provider_port)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(ip_tunnel_encap_with_various_fwd(unit, access_port, provider_port, IPv4EncapsulationForwardTypeIPv6, IPv4EncapsulationGRE4), "");
    ...
    int provider_port)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(ip_tunnel_encap_with_various_fwd(unit, access_port, provider_port, IPv4EncapsulationForwardTypeIPv4, IPv4EncapsulationMPLSoGRE), "");
    /* add host entry for ipv6 forwarding */
    int fec_id;
    BCM_L3_ITF_SET(&fec_id, BCM_L3_ITF_TYPE_FEC, cint_ip_tunnel_basic_info.tunnel_fec_id);
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv6(unit, cint_ip_tunnel_basic_info.ipv6_dip, cint_ip_tunnel_basic_info.access_vrf, fec_id),
    ...
    int provider_port)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(ip_tunnel_encap_with_various_fwd(unit, access_port, provider_port, IPv4EncapsulationForwardTypeIPv4, IPv4EncapsulationGRE8), "");
    /* add host entry for ipv6 forwarding */
    int fec_id;
    BCM_L3_ITF_SET(&fec_id, BCM_L3_ITF_TYPE_FEC, cint_ip_tunnel_basic_info.tunnel_fec_id);
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv6(unit, cint_ip_tunnel_basic_info.ipv6_dip, cint_ip_tunnel_basic_info.access_vrf, fec_id),
...
ip_tunnel_encap_gre8_mpls_fwd(
    ...
    int provider_port)
{
    BCM_IF_ERROR_RETURN_MSG(ip_tunnel_encap_with_various_fwd(unit, access_port, provider_port, IPv4EncapsulationForwardTypeMPLS, IPv4EncapsulationGRE8), "");
    return BCM_E_NONE;
}
    ...
    int forward_type)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(ip_tunnel_encap_with_various_fwd(unit, access_port, provider_port, forward_type, 0), "");
