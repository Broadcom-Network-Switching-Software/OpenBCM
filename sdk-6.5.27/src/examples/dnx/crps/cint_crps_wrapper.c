    ...
    int database_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_stat_counter_database_create(unit, flags, core_id, &database_id), "");
    return BCM_E_NONE;
}
    ...
    int database_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_stat_counter_database_destroy(unit, 0, &database), "");
    ...
    int database_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_stat_counter_engine_attach(unit, flags, &database, engine_id), "");
    return BCM_E_NONE;
}
    ...
    int database_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_stat_counter_engine_detach(unit, flags, &database, engine_id), "");
    return BCM_E_NONE;
}
    ...
    int algorithmic_is_disable)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_stat_counter_eviction_set(unit, flags, &engine, &eviction), "");
    return BCM_E_NONE;
}
    ...
    int database_size)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_stat_counter_interface_set(unit, flags, &database, &config), "");
    return BCM_E_NONE;
}
    ...
    int enable_eviction)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_stat_counter_database_enable_set(unit, flags, &database, &enable), "");
    return BCM_E_NONE;
}
