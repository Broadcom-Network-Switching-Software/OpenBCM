    ...
    int p2_port)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(evpn_etree_filter_init(unit), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(evpn_etree_leaf_encap_config(unit), "");
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_etree_ingress(unit, evpn_global_info.in_lif_acl_profile_esi), "");

    /** Add leaf -> root entries for traffic*/
    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_etree_egress_leaf_port_entry_add(unit, evpn_etree_info.pe1_pe2_ce3_leaf_label, cint_evpn_info.ce1_port), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_etree_egress_leaf_port_entry_add(unit, evpn_etree_info.pe1_pe3_ce3_leaf_label, cint_evpn_info.ce1_port), "");

    BCM_IF_ERROR_RETURN_MSG(cint_field_evpn_etree_egress_leaf_port_entry_add(unit, evpn_etree_info.pe1_pe4_ce3_leaf_label, cint_evpn_info.ce1_port), "");
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_mpls_esi_encap_add(unit, &pe1_pe3_esi_400_encap), "esi-400");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_mpls_esi_encap_add(unit, &pe1_pe4_esi_100_encap), "esi-100");
