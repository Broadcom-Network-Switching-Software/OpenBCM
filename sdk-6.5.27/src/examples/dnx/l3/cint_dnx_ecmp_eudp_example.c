    ...
    int ecmp_id)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create_vrf(unit, cint_ecmp_info.intf_in, cint_ecmp_info.vrf, cint_ecmp_info.intf_in_mac_address), "intf_in");
     ...
     * Create ETH-RIF and set its properties
     */
    BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create_vrf(unit, cint_ecmp_info.intf_out, 0, cint_ecmp_info.intf_out_mac_address), "intf_out");
...

    {
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_l3_egress_ecmp_user_profile_create(unit, ecmp_profile, count, wcmp_offsets_array), "");
