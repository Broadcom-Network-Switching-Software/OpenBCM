 ...
 * 
 ...
 Copyright 2007-2022 Broadcom Inc. All rights reserved. File: cint_srv6_alternate_marking.c.
 */
    ...
    int unit)
{
    ...
    */
    ...
    if (g_cint_field_ipv6_am_ing_ent.is_ext_encap == 1) {
        BCM_IF_ERROR_RETURN_MSG(cint_field_ipv6_ext_alternate_marking_ingress_node_ePMF(unit), "");
    }
    else {
    ...
    int last_sid_is_dip)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(srv6_ingress_tunnel_config(unit, in_port, in_port_eth, out_port, nof_sids, secondary_srh_flags, secondary_sids_flags, is_t_insert_encap, last_sid_is_dip), "");

    /*
     * Add CRPS configuration
     */
    BCM_IF_ERROR_RETURN_MSG(ipv6_alternate_marking_crps(unit, in_port), "");

    /*
     * Configure PMF rules
     */
    BCM_IF_ERROR_RETURN_MSG(srv6_alternate_marking_ingress_node_field(unit), "");
    ...
    int nof_sids_third_pass)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(srv6_ingress_tunnel_ext_encap_config(unit, in_port, out_port, rch_port, nof_sids_first_pass, nof_sids_second_pass, nof_sids_third_pass, 0), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_port_class_set(unit, out_port, bcmPortClassFieldEgressPacketProcessingPortCs, g_cint_field_ipv6_am_ing_ent.egr_port_pmf_data), "");
