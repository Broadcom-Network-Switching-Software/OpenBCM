...
srv6_update_fecs_values(int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(get_first_fec_in_range_which_not_in_ecmp_range(unit, 1, 0, &first_fec_in_hier), "1");
    ...
    BCM_IF_ERROR_RETURN_MSG(get_first_fec_in_range_which_not_in_ecmp_range(unit, 2, 0, &first_fec_in_hier), "2");
        ...
        int is_uniform)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_switch_control_get(unit, bcmSwitchSRV6ReducedModeEnable, &reduced_mode), "bcmSwitchSRV6ReducedModeEnable");
    ...
    /** when IBCH1 not supported, set the recycle application.
     * If ibch1 supported, the port knows to support multiple recycle applications, and the default recycle application is used
     */

    if (!ibch1_supported)
    {
        snprintf(error_msg, sizeof(error_msg), "intf_in %d", cint_srv6_tunnel_info.eth_rif_intf_in[INGRESS]);
        BCM_IF_ERROR_RETURN_MSG(bcm_port_control_set(unit, rch_port, bcmPortControlRecycleApp, bcmPortControlRecycleAppExtendedEncap), error_msg);
    }

    /** Set port class in order for PMF Keep RCH to Egress, and set parsing start type to RCY */
    BCM_IF_ERROR_RETURN_MSG(bcm_port_class_set(unit,rch_port,bcmPortClassFieldIngressPMF3TrafficManagementPortCs,5), "");
    /*
    ...
    if(!is_t_insert)
    {
        ...
        BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create_inner(unit, cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_IP_TUNNEL_L2VPN_FEC_ID], 0 , global_lif_encoded, gport, 0, fec_flags2,
                                               0, 0,&encoded_fec_ip_tunnel), "create egress object FEC_1 only");
    ...
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create_inner(unit, cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_SRH_FIRST_PASS_FEC_ID], 0 , global_lif_encoded, gport, BCM_L3_2ND_HIERARCHY, fec_flags2,
    ...
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create_inner(unit, cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_RCH_1_2_PASS_FEC_ID], 0 , global_lif_encoded, gport, BCM_L3_3RD_HIERARCHY, fec_flags2,
   ...
   BCM_IF_ERROR_RETURN_MSG(bcm_l2_egress_create(unit, &recycle_entry_2_to_3), "");
   /*
    * Create RCH_2_3 pass FEC
    */
   BCM_L3_ITF_SET(global_lif_encoded, BCM_L3_ITF_TYPE_LIF, recycle_entry_2_to_3.encap_id);
   BCM_GPORT_LOCAL_SET(gport, rch_port);
   BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create_inner(unit, cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_RCH_2_3_PASS_FEC_ID], 0 , global_lif_encoded, gport, BCM_L3_3RD_HIERARCHY, fec_flags2,
                                          0, 0,&encoded_fec_rch), "create egress object FEC_3 only");
   ...
   BCM_GPORT_LOCAL_SET(gport, out_port);
   BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create_inner(unit, cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_SRH_THIRD_PASS_FEC_ID], 0 , global_lif_encoded, gport, BCM_L3_2ND_HIERARCHY, fec_flags2,
                                          0, 0,&encoded_fec_srh), "create egress object FEC_2 only");
    ...
    else
    {
        ...
        BCM_IF_ERROR_RETURN_MSG(add_route_ipv4(unit, cint_srv6_tunnel_info.route_ipv4_dip, cint_srv6_tunnel_info.route_ipv4_mask, cint_srv6_tunnel_info.vrf_in[INGRESS], fec), error_msg);

        BCM_IF_ERROR_RETURN_MSG(add_route_ipv6(unit, cint_srv6_tunnel_info.route_ipv6_dip, cint_srv6_tunnel_info.route_ipv6_mask, cint_srv6_tunnel_info.vrf_in[INGRESS], fec), error_msg);
    ...
    if(is_t_insert)
    {
        BCM_IF_ERROR_RETURN_MSG(srv6_endpoint_tunnel_cross_connect(unit, 0, cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_SRH_FIRST_PASS_FEC_ID], 0), "for End.B6");
    }
    ...
    if(nof_sids_third_pass > 0)
    {
        ...
        for (sid_count = 0; sid_count < nof_sids_third_pass; sid_count++)
        {
            ...
            snprintf(error_msg, sizeof(error_msg), "for SID%d 3rd pass", sid_count);
    ...
    if(nof_sids_second_pass > 0)
    {
        ...
        /** if 3rd pass is present, mark 2nd pass SRH as extended encap */
        if(ibch1_supported && (nof_sids_third_pass > 0))
        {
    ...
    if(nof_sids_first_pass > 0)
    {
        ...
        for (sid_count = 0; sid_count < nof_sids_first_pass; sid_count++)
        {
            ...
            /** call the sid_initiator API to create the SID EEDB Entry and return its GPORT Tunnel-id */
            snprintf(error_msg, sizeof(error_msg), "for SID%d 1st pass", sid_count);
            BCM_IF_ERROR_RETURN_MSG(bcm_srv6_sid_initiator_create(unit, &sid_info), error_msg);
            next_sid_tunnel_id = sid_info.tunnel_id;
        }
        ...
        /** call the srh_base_initiator API to create the SRH EEDB Entry and local-out-LIF for it */
        BCM_IF_ERROR_RETURN_MSG(bcm_srv6_srh_base_initiator_create(unit, &srh_base_info), "1st pass");
    ...
    if(!is_t_insert)
    {
         ...
         */
        BCM_IF_ERROR_RETURN_MSG(vlan_translate_ive_eve_translation_set(unit, in_port_intf[0],
                                                          0x9100,
                                                          0x8100,
         ...
         */
        BCM_IF_ERROR_RETURN_MSG(vlan_translate_ive_eve_translation_set(unit, egress_native_ac,
                                                          0x8100,
                                                          0x9100,
                                                          bcmVlanActionReplace,
                                                          bcmVlanActionReplace,
        ...
        int nof_sids)
{
    ...
    snprintf(error_msg, sizeof(error_msg), "intf_out out_port of SRV6 Ingress Tunnel %d", pe_port);
    BCM_IF_ERROR_RETURN_MSG(out_port_set(unit, pe_port), error_msg);
    ...
    for (i = 0; i < 2; i++) {
        ...
        BCM_IF_ERROR_RETURN_MSG(l3__egress_only_encap__create_inner(unit, 0, &arp_id, cint_srv6_tunnel_info.arp_next_hop_mac[INGRESS], cint_srv6_tunnel_info.eth_rif_intf_out[INGRESS], 0, flags2),
            "create egress object ARP only, in SRV6 Ingress Tunnel");

        arp_fec_id = first_fec_in_hier + 0x100 + i;
        /* FEC */
        BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create_inner(unit, arp_fec_id, 0 , arp_id, gport, BCM_L3_2ND_HIERARCHY, fec_flags2, 0, 0,&encoded_fec),
            "create egress object only, fec");
        /* Save FEC ids */
    ...
    BCM_IF_ERROR_RETURN_MSG(l3__ecmp_create(unit, ecmp_id, 2, intf_array, BCM_L3_WITH_ID | BCM_L3_2ND_HIERARCHY, BCM_L3_ECMP_DYNAMIC_MODE_RESILIENT, &ecmp, 0),
        "create ECMP group");
    ...
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create_inner(unit, cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_SRH_SECOND_PASS_FEC_ID], 0 , global_lif_encoded, gport, 0, fec_flags2,
                                           0, 0,&encoded_fec_srh), "create egress object FEC_2 only");
    ...
    BCM_IF_ERROR_RETURN_MSG(vlan_translate_eve_translation_set(unit,egress_native_ac,0), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_multicast_create(unit, mc_flags | BCM_MULTICAST_WITH_ID, mc_id), "");
    ...
    snprintf(error_msg, sizeof(error_msg), "in Port= %d", ce_port);
    BCM_IF_ERROR_RETURN_MSG(bcm_multicast_add(unit, mc_id, mc_flags, 1, &rep_array), error_msg);
    ...
    snprintf(error_msg, sizeof(error_msg), "in Port= %d", rch_port);
    BCM_IF_ERROR_RETURN_MSG(bcm_multicast_add(unit, mc_id, mc_flags, 1, &rep_array), error_msg);
        ...
        int nof_sids_second_pass)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_vlan_gport_add(unit, cint_srv6_tunnel_info.eth_rif_intf_in[INGRESS], in_port, 0), "");
    ...
    /** SRv6 ingress remote PE port*/
    snprintf(error_msg, sizeof(error_msg), "out_port_set intf_out out_port of SRV6 Ingress Tunnel %d", pe_port);
    BCM_IF_ERROR_RETURN_MSG(out_port_set(unit, pe_port), error_msg);
    ...
    /* Update FEC ids */
    BCM_IF_ERROR_RETURN_MSG(get_first_fec_in_range_which_not_in_ecmp_range(unit, 2, 0, &first_fec_in_hier), "0");
    ...
    for (i = 0; i < 2; i++) {
        ...
        arp_fec_id = first_fec_in_hier + 0x100 + i;
        /* FEC */
        BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create_inner(unit, arp_fec_id, 0 , arp_id, gport, BCM_L3_3RD_HIERARCHY, fec_flags2, 0, 0,&encoded_fec),
            "create egress object only, fec");
        /* Save FEC ids */
        intf_array[i] = encoded_fec;
        cint_srv6_tunnel_info.arp_next_hop_mac[INGRESS][5]++;
    ...
    /* Create an ECMP group */
    BCM_IF_ERROR_RETURN_MSG(l3__ecmp_create(unit, ecmp_id, 2, intf_array, BCM_L3_WITH_ID | BCM_L3_3RD_HIERARCHY, BCM_L3_ECMP_DYNAMIC_MODE_RESILIENT, &ecmp,0),
        "create ECMP group");
        ...
        int last_sid_is_dip)
{
    ...
    BCM_GPORT_LOCAL_SET(gport, out_port);
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create_inner(unit, cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_SRH_THIRD_PASS_FEC_ID], 0 , global_lif_encoded, gport, BCM_L3_2ND_HIERARCHY, fec_flags2,
                                           0, 0,&encoded_fec_srh), "create SRH 3rd pass FEC");
    ...
    BCM_GPORT_FORWARD_PORT_SET(recycle_entry_2_to_3.dest_port, cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_SRH_THIRD_PASS_FEC_ID]);
    recycle_entry_2_to_3.recycle_app = bcmL2EgressRecycleAppExtendedEncap;
    BCM_IF_ERROR_RETURN_MSG(bcm_l2_egress_create(unit, &recycle_entry_2_to_3), "RCH EE from 2nd to 3rd pass");
    ...
    BCM_GPORT_LOCAL_SET(gport, rch_port);
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create_inner(unit, cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_RCH_2_3_PASS_FEC_ID], 0 , global_lif_encoded, gport, BCM_L3_3RD_HIERARCHY, fec_flags2,
                                           0, 0,&encoded_fec_rch), "create RCH 2nd to 3rd pass FEC");
    ...
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create_inner(unit, cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_SRH_SECOND_PASS_FEC_ID], 0 , global_lif_encoded, gport, BCM_L3_2ND_HIERARCHY,fec_flags2,
                                           0, 0,&encoded_fec_srh), "create SRH 2nd pass FEC");
    ...
    BCM_GPORT_FORWARD_PORT_SET(recycle_entry_1_to_2.dest_port, cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_SRH_SECOND_PASS_FEC_ID]);
    recycle_entry_1_to_2.recycle_app = bcmL2EgressRecycleAppExtendedEncap;
    BCM_IF_ERROR_RETURN_MSG(bcm_l2_egress_create(unit, &recycle_entry_1_to_2), "RCH EE from 1st to 2nd pass");
    ...
    BCM_GPORT_LOCAL_SET(gport, rch_port);
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create_inner(unit, cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_RCH_1_2_PASS_FEC_ID], 0 , global_lif_encoded, gport, BCM_L3_3RD_HIERARCHY, fec_flags2,
                                           0, 0,&encoded_fec_rch), "create RCH 1st to 2nd pass FEC");
    ...
    BCM_GPORT_FORWARD_PORT_SET(gport, cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_RCH_1_2_PASS_FEC_ID]);
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create_inner(unit, cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_SRH_FIRST_PASS_FEC_ID], 0 , global_lif_encoded, gport, BCM_L3_2ND_HIERARCHY, fec_flags2,
                                           0, 0,&encoded_fec_srh), "create SRH 1st pass FEC");
    ...
    if(!is_t_insert)
    {
        ...
        BCM_GPORT_FORWARD_PORT_SET(gport, cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_SRH_FIRST_PASS_FEC_ID]);
        BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create_inner(unit, cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_IP_TUNNEL_FEC_ID], 0 , global_lif_encoded, gport, 0, fec_flags2,
                                               0, 0,&encoded_fec_ip_tunnel), "create IP tunnel FEC");
    }
        ...
        int nof_sids)
{
    ...
    */
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(srv6_endpoint_tunnel(unit, 0, 0), "");

    /*
     * 12. Configure PMF to sets FAI
     */
    BCM_IF_ERROR_RETURN_MSG(srv6_ingress_tunnel_2nd_pass_insert_set_field(unit), "");
...
int srv6_ingress_tunnel_2nd_pass_insert_set_field(int unit) {
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &insert_2nd_pass_fg_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, insert_2nd_pass_fg_id, context_id, &attach_info), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, insert_2nd_pass_fg_id, &ent_info, &ent_id), "");
        ...
        int nof_sids_2nd_pass)
{
    ...
    if (!ibch1_supported)
    {
        snprintf(error_msg, sizeof(error_msg), "rch_port %d", rch_port_ee_uncollapse);
        BCM_IF_ERROR_RETURN_MSG(bcm_port_control_set(unit, rch_port_ee_uncollapse, bcmPortControlRecycleApp, bcmPortControlRecycleAppExtendedEncapUncollapse), error_msg);
    }
    /** Set port class in order for PMF to crop RCH ad IRPP */
    BCM_IF_ERROR_RETURN_MSG(bcm_port_class_set(unit,rch_port_ee_uncollapse, bcmPortClassFieldIngressPMF3TrafficManagementPortCs,4), "");
    /** when IBCH1 not supported, set the recycle application.
     * If ibch1 supported, the port knows to support multiple recycle applications, and the default recycle application is used.
     */
    ...
    if (!ibch1_supported)
    {
        snprintf(error_msg, sizeof(error_msg), "rch_port %d", rch_port_ee);
        BCM_IF_ERROR_RETURN_MSG(bcm_port_control_set(unit,rch_port_ee, bcmPortControlRecycleApp, bcmPortControlRecycleAppExtendedEncap), error_msg);
    }
    /** Set port class in order for PMF Keep RCH to Egress, and set parsing start type to RCY */
    BCM_IF_ERROR_RETURN_MSG(bcm_port_class_set(unit,rch_port_ee,bcmPortClassFieldIngressPMF3TrafficManagementPortCs,5), "");
    ...
    /* Update FEC ids */
    BCM_IF_ERROR_RETURN_MSG(get_first_fec_in_range_which_not_in_ecmp_range(unit, 1, 0, &first_fec_in_hier1), "0");
    ...
    BCM_IF_ERROR_RETURN_MSG(get_first_fec_in_range_which_not_in_ecmp_range(unit, 0, 0, &first_fec_in_hier0), "0");
    ...
    BCM_L3_ITF_SET(global_lif_encoded, BCM_L3_ITF_TYPE_LIF, cint_srv6_tunnel_info.tunnel_global_lif[INGRESS_SRH_3RD_PASS_GLOBAL_LIF]);
    BCM_GPORT_FORWARD_PORT_SET(gport, ecmp_id);
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create_inner(unit, cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_SRH_THIRD_PASS_FEC_ID], 0 , global_lif_encoded, gport, 0, fec_flags2,
                                           0, 0,&encoded_fec_srh_3rd), "create egress object FEC_2 only");
    ...
    BCM_L3_ITF_SET(global_lif_encoded, BCM_L3_ITF_TYPE_LIF, cint_srv6_tunnel_info.tunnel_global_lif[INGRESS_SRH_2ND_PASS_GLOBAL_LIF]);
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create_inner(unit, rch_encap_fec_id, 0 , global_lif_encoded, gport, BCM_L3_2ND_HIERARCHY, fec_flags2, 0, 0,&encoded_fec),
        "create egress object only, fec");
    ...
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create_inner(unit, cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_SRH_SECOND_PASS_FEC_ID], 0 , recycle_entry_2_to_3.encap_id, gport, 0, fec_flags2,
                                           0, 0,&encoded_fec_srh_2nd), "create egress object FEC_2 only");
    ...
    BCM_L3_ITF_SET(global_lif_encoded, BCM_L3_ITF_TYPE_LIF, cint_srv6_tunnel_info.tunnel_global_lif[INGRESS_SRH_2ND_PASS_GLOBAL_LIF]);
    BCM_GPORT_FORWARD_PORT_SET(gport, rch_encap_fec_id);
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create_inner(unit, fec_id_2nd_pass_uc, 0 , recycle_entry_2_to_3.encap_id, gport, 0, fec_flags2,
                                           0, 0,&fec_id_2nd_pass_uc), "create egress object FEC_2 only");
    ...
    snprintf(error_msg, sizeof(error_msg), "in Port= %d", rep_array.port);
    BCM_IF_ERROR_RETURN_MSG(bcm_multicast_add(unit, mc_id, mc_flags, 1, &rep_array), error_msg);
