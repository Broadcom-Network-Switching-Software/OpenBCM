...
{
    BCM_IF_ERROR_RETURN_MSG(cint_field_ele_flow_learn_get_actions_offsets_with_32b_of_learn_payload(unit, NULL, NULL, age_action_offset), "");
...
int cint_field_ele_flow_learn_payload_set(int unit, int state ,int snoop_str, int snoop_cmd , int age_profile, int *learn_action_value)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_ele_flow_learn_get_actions_offsets_with_32b_of_learn_payload(unit, &state_action_offset , &snoop_action_offset , &age_action_offset), "");
...
int cint_field_ele_flow_ipmf1_set(int unit,bcm_field_layer_type_t fwd_layer)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_create(unit, 0, bcmFieldStageIngressPMF1, &context_info, &cint_field_ele_flow_ctx_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_param_set(unit, 0, bcmFieldStageIngressPMF2, cint_field_ele_flow_ctx_id, &param_info), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_hash_create(unit, 0, bcmFieldStageIngressPMF1,cint_field_ele_flow_ctx_id,&hash_info), "");
...
int cint_field_ele_flow_FEM_add(int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_ele_flow_learn_get_actions_offsets_with_32b_of_learn_payload( unit, &state_action_offset,  &snoop_action_offset,  &age_action_offset), "cint_field_ele_flow_EFES_add");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_fem_action_add(unit, 0, cint_field_ele_flow_exem_fg_id, action_priority, &fem_action_info), "");
...
int cint_field_ele_flow_exem_fg_set(int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &state_act_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &snoop_act_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &age_profile_act_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &vmv_pad_act_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_action_create(unit, 0, &action_info, &zero_padding_to_sizeof_learn_action), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &exem_fg_info, &cint_field_ele_flow_exem_fg_id), "");
    printf("EXEM FG Created: fg_id = %d\n", cint_field_ele_flow_exem_fg_id);

    BCM_IF_ERROR_RETURN_MSG(cint_field_ele_flow_FEM_add(unit), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, cint_field_ele_flow_exem_fg_id, cint_field_ele_flow_ctx_id, &attach_info), "");
...
int cint_field_ele_flow_flush_entry_add(int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_flush_entry_add(unit, 0, cint_field_ele_flow_exem_fg_id, cint_field_ele_flow_flush_entry_id_mouse_to_elephant, &flush_entry_info), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_flush_entry_add(unit, 0, cint_field_ele_flow_exem_fg_id, cint_field_ele_flow_flush_entry_id_elephant_to_mouse, &flush_entry_info), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_flush_entry_add(unit, 0, cint_field_ele_flow_exem_fg_id, cint_field_ele_flow_flush_entry_id_elephant_reported_to_mouse, &flush_entry_info), "");
...
int cint_field_ele_flow_main(int unit,  bcm_field_layer_type_t fwd_layer, int snoop_cmd, int snoop_str, int age_profile)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_ele_flow_init_cb(unit), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_ele_flow_ipmf1_set(unit,fwd_layer), "");


    /*Set learn actions*/
    BCM_IF_ERROR_RETURN_MSG(cint_field_ele_flow_learn_payload_set(unit, EL_STATE_MOUSE, snoop_str, snoop_cmd, age_profile , &learn_action_value_mouse), "");
    BCM_IF_ERROR_RETURN_MSG(cint_field_ele_flow_learn_payload_set(unit, EL_STATE_ELEPHANT_REPORTED, snoop_str, snoop_cmd, age_profile , &learn_action_value_elephant_reported), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_ele_flow_exem_fg_set(unit), "");



    /* Add entries to flush TCAM */
    BCM_IF_ERROR_RETURN_MSG(cint_field_ele_flow_flush_entry_add(unit), "");
...
int cint_field_ele_flow_destroy(int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_flush_entry_delete(unit, 0, cint_field_ele_flow_exem_fg_id, cint_field_ele_flow_flush_entry_id_elephant_reported_to_mouse), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_flush_entry_delete(unit, 0, cint_field_ele_flow_exem_fg_id, cint_field_ele_flow_flush_entry_id_elephant_to_mouse), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_flush_entry_delete(unit, 0, cint_field_ele_flow_exem_fg_id, cint_field_ele_flow_flush_entry_id_mouse_to_elephant), "");
