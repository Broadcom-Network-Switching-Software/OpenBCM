    ...
    int fwd_strength)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_utils_rx_trap_create_and_set(unit, flags, bcmRxTrapLinkLayerSaEqualsDa, trap_config, &cint_rx_trap_saequalsda_trap_trap_id), "");
...
{
    BCM_IF_ERROR_RETURN_MSG(bcm_rx_trap_type_destroy(unit, cint_rx_trap_saequalsda_trap_trap_id), "");
