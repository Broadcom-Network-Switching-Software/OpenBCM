    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_rx_trap_type_create(unit, 0, trap_type, &cint_rx_trap_epmf_trap_action_trap_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_rx_trap_set(unit, cint_rx_trap_epmf_trap_action_trap_id, &trap_config), "");
    ...
    bcm_field_context_t  context_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, fg_info, &cint_rx_trap_epmf_trap_action_fg_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, cint_rx_trap_epmf_trap_action_fg_id, context_id, &attach_info), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, cint_rx_trap_epmf_trap_action_fg_id, &entry_info, &cint_rx_trap_epmf_trap_action_entry_id), "");
...
int cint_rx_trap_epmf_trap_action_destroy(
    ...
    bcm_field_context_t  context_id)
{
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, cint_rx_trap_epmf_trap_action_fg_id, NULL, cint_rx_trap_epmf_trap_action_entry_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, cint_rx_trap_epmf_trap_action_fg_id, context_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, cint_rx_trap_epmf_trap_action_fg_id), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_rx_trap_type_destroy(unit, cint_rx_trap_epmf_trap_action_trap_id), "");
...
int cint_rx_trap_epmf_trap_action_main(
    ...
    bcm_field_context_t context_id)
{
    BCM_IF_ERROR_RETURN_MSG(cint_rx_trap_epmf_trap_action_trap_create_and_set(unit), "");

    printf("Trap_ID = %d \n", cint_rx_trap_epmf_trap_action_trap_id);

    BCM_IF_ERROR_RETURN_MSG(cint_rx_trap_epmf_trap_action_pmf_configuration_create(unit, context_id), "");
