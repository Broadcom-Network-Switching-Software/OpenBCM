    ...
    bcm_gport_t action_gport)
{
    ...
    {
        BCM_IF_ERROR_RETURN_MSG(cint_rx_trap_lif_traps_lif_set(unit, lif_type, lif_gport, action_gport), "");
    }
    else if ((lif_type == bcmRxTrapLifTypeInRif) || (lif_type == bcmRxTrapLifTypeOutRif))
    {
        BCM_IF_ERROR_RETURN_MSG(cint_rx_trap_lif_traps_rif_set(unit, lif_type, rif_intf, action_gport), "");
    }
    ...
    bcm_gport_t set_action_gport)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_rx_trap_lif_get(unit, &lif_config), "");
    ...
    bcm_if_t rif_intf)
{
    if ((lif_type == bcmRxTrapLifTypeInLif) || (lif_type == bcmRxTrapLifTypeOutLif))
    {
        BCM_IF_ERROR_RETURN_MSG(cint_rx_trap_lif_traps_lif_clear(unit, lif_type, lif_gport), "");
    }
    else if ((lif_type == bcmRxTrapLifTypeInRif) || (lif_type == bcmRxTrapLifTypeOutRif))
    {
        BCM_IF_ERROR_RETURN_MSG(cint_rx_trap_lif_traps_rif_clear(unit, lif_type, rif_intf), "");
    }
