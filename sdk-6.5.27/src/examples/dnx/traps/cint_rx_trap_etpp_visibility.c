...
cint_rx_trap_etpp_visibility_config_utils_s* etpp_config_p)
{
	...
	BCM_IF_ERROR_RETURN_MSG(trap_config_from_etpp_config_fill(&cint_rx_trap_etpp_visibility_config, is_pkt_drop, &trap_config), "");

	/* Set the trap */
	BCM_IF_ERROR_RETURN_MSG(cint_utils_rx_trap_create_and_set(unit, 0, bcmRxTrapEgTxVisibility, &trap_config, &cint_rx_trap_etpp_visibility_trap_id), "");
...
int unit)
{
    BCM_IF_ERROR_RETURN_MSG(bcm_rx_trap_type_destroy(unit, cint_rx_trap_etpp_visibility_trap_id), "");
