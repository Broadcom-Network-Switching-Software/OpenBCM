    ...
    int *trap_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_utils_rx_trap_ingress_create_and_set_to_drop(unit, BCM_RX_TRAP_WITH_ID, bcmRxTrapUserDefine, 0, trap_id), "");
    printf("Trap ID: %d \n", *trap_id);
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_rx_trap_prog_set(unit, 0, cint_rx_trap_programmable_traps_index_eth, cint_rx_trap_programmable_traps_config_eth), "");
    ...
    bcm_rx_trap_prog_config_t * prog_config)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_rx_trap_prog_set(unit, 0, prog_index, prog_config), "");
    ...
    int *trap_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(programmable_trap_config_fill_and_set_ipv4(unit, cint_rx_trap_programmable_traps_index_ipv4, &cint_rx_trap_programmable_traps_config_ipv4, &prog_config), "");
    ...
    int is_ipv4_fwd)
{
    if(trap_type != NULL)
    {
        BCM_IF_ERROR_RETURN_MSG(run_rx_programmable_trap_traffic_config_ipv4_default_traps(unit,
                                                                    fwd_strength,
    ...
    else if(trap_id != NULL)
    {
        if(is_ipv4_fwd == TRUE)
        {
            BCM_IF_ERROR_RETURN_MSG(run_rx_programmable_trap_traffic_config_ipv4_fwd(unit,
                                                                 0,
                                                                 fwd_strength,
                                                                 prog_config_ipv4_fwd,
                                                                 trap_id), "");
        ...
        {
            BCM_IF_ERROR_RETURN_MSG(run_rx_programmable_trap_traffic_config_eth_fwd(unit,
                                                                 0,
                                                                 fwd_strength,
                                                                 prog_config_eth_fwd,
                                                                 trap_id), "");
    ...
    int trap_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_rx_trap_prog_set(unit, 0, cint_rx_trap_programmable_traps_index_eth, prog_config), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_rx_trap_prog_set(unit, 0, cint_rx_trap_programmable_traps_index_ipv4, prog_config), "");
