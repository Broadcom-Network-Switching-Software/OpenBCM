	...
	int is_icmpv6)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_rx_trap_protocol_traps_args_and_profiles_fill(unit, protocol_type, trap_profile, trap_args, is_icmpv6), "");

    if(port != 0)
    {
        BCM_IF_ERROR_RETURN_MSG(bcm_rx_trap_protocol_profiles_set(unit, port, &cint_rx_trap_protocol_traps_protocol_profiles), "");
    }
    else if(intf != 0)
    {
        BCM_IF_ERROR_RETURN_MSG(bcm_rx_trap_protocol_interface_profiles_set(unit, intf, &cint_rx_trap_protocol_traps_protocol_profiles), "");
    }

    BCM_IF_ERROR_RETURN_MSG(bcm_rx_trap_protocol_set(unit, &cint_rx_trap_protocol_traps_key, trap_gport), "");
    ...
    int my_ip2)
{
    ...
    if (protocol_type == bcmRxTrapArpMyIp)
    {
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_switch_control_set(unit, switch_control_ip1, my_ip1), "");

        BCM_IF_ERROR_RETURN_MSG(bcm_switch_control_set(unit, switch_control_ip2, my_ip2), "");
    }
    ...
    int ignore_da)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_switch_control_set(unit, switch_control_ignore_da, ignore_da), "");
	...
	int is_icmpv6)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_rx_trap_protocol_traps_args_and_profiles_fill(unit, protocol_type, 0, trap_args, is_icmpv6), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_rx_trap_protocol_clear(unit,&cint_rx_trap_protocol_traps_key), "");
