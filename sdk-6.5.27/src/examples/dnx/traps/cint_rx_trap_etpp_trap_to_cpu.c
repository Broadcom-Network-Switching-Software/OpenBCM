...
int* etpp_trap_id_p)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_rx_trap_type_create(unit, 0, bcmRxTrapEgTxUserDefine, etpp_trap_id_p), "");
    ...
    */
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_rx_trap_set(unit, *etpp_trap_id_p, &trap_config), "");
