    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_tunnel_initiator_clear(unit, &initiator_info), "");
    return BCM_E_NONE;
}
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_tunnel_terminator_delete(unit, &tunnel_term), "");
    return BCM_E_NONE;
}
    ...
    uint8 ttl_value)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(get_first_fec_in_range_which_not_in_ecmp_range(unit,0,0,&first_fec_id_in_hierarchy), "");
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_encap__create(unit, 0, &(cint_l2tp_mpls_encapsulation_info.arp_id_push),
                                       cint_l2tp_mpls_encapsulation_info.intf_out_mac_address,
                                       cint_l2tp_basic_info.intf_in), "create egress object ARP only push");
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(l2tp_mpls_encapsulation_create_push_or_swap_tunnel(unit, ttl_value), "");
    
    /*
     * Configure fec entry for encapsulation flow
     */
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create(unit, cint_l2tp_mpls_encapsulation_info.fec_id_enc,
                                     cint_l2tp_mpls_encapsulation_info.push_tunnel_id, 0,
                                     uni_port, 0, 0), "create egress object FEC only");

    /*
     * Connect MPLS tunnel entry to ARP.
     * ARP entry configuration can be also done inside bcm_mpls_tunnel_inititator_create.
     */
    BCM_IF_ERROR_RETURN_MSG(l2tp_mpls_encapsulation_update_arp_entry(unit), "");

    /*
     * Create l3 forwarding entry for the pushed label
     */
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv4(unit, cint_l2tp_basic_info.tunnel_dip, cint_l2tp_basic_info.vrf,
  ...
  int ttl_value)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(in_port_intf_set(unit, nni_port, cint_l2tp_basic_info.intf_out), "");

    /*
     * 2. Set NNI-Port default properties, in case of ARP+AC no need
     */
    BCM_IF_ERROR_RETURN_MSG(out_port_set(unit, uni_port), "intf_out");
    ...
    BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create(unit, cint_l2tp_basic_info.intf_in, cint_l2tp_basic_info.intf_in_mac_address), "in_rif");

    /*
     * 4. Create NNI ETH-RIF and set its properties
     */
    BCM_IF_ERROR_RETURN_MSG(bcm_vlan_create(unit ,cint_l2tp_basic_info.intf_out), ""); /* to avoid error from vlan_db_vsi_allocate_single */
    BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create(unit, cint_l2tp_basic_info.intf_out, cint_l2tp_basic_info.intf_out_mac_address), "out_rif");
    ...
    BCM_IF_ERROR_RETURN_MSG(intf_ingress_rif_set(unit, &ingress_rif), "out_rif");

    l2tp_mpls_encapsulation_set(unit,uni_port,nni_port,ttl_value);

    /*
     * 6. Create UDP IP tunnel, it should be connected to MPLS tunnel inforamation with 
     */
    BCM_IF_ERROR_RETURN_MSG(l2tp_tunnel_initiator_create(unit, cint_l2tp_mpls_encapsulation_info.push_tunnel_id, &cint_l2tp_basic_info.ip_tunnel_outlif), "");

    /*
     * 7. Create l2tp encap object and set its properties
     */
    BCM_IF_ERROR_RETURN_MSG(l2tp_encapsulation_create(unit, cint_l2tp_basic_info.ip_tunnel_outlif), "");
    ...
    */
    ...
    BCM_IF_ERROR_RETURN_MSG(get_first_fec_in_range_which_not_in_ecmp_range(unit, 0, 0, &cint_l2tp_basic_info.fec_id), "");
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create(unit, cint_l2tp_basic_info.fec_id, l3_intf_id, 0, gport, 0, 0),
    ...
    if (is_ipv4)
    {
        BCM_IF_ERROR_RETURN_MSG(add_host_ipv4(unit, cint_l2tp_basic_info.host_nni2uni, cint_l2tp_basic_info.vrf, fec_id, 0, 0), "");
    }
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_qos_port_map_set(unit, cint_l2tp_basic_info.initiator_id, -1, cint_pppoe_basic_info.l3_eg_map_id), "");
    return BCM_E_NONE;
}
  ...
  int port2)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(get_first_fec_in_range_which_not_in_ecmp_range(unit, 0, 0, &cint_l2tp_mpls_info.fec_id), "");

    BCM_IF_ERROR_RETURN_MSG(in_port_intf_set(unit, port1, cint_l2tp_basic_info.intf_in), "");

    /*
    * Create ETH-RIF and set its properties 
    */
    BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create(unit, cint_l2tp_basic_info.intf_in,
        cint_l2tp_basic_info.intf_in_mac_address), "intf_in");
    ...
    */
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_l2_egress_create(unit, &recycle_entry), "with recycle_app is bcmL2EgressRecycleAppExtendedTerm");
    ...
    if (egress_filters_enable_per_recycle_port_supported == 0)
    {
        ...
        BCM_IF_ERROR_RETURN_MSG(cint_field_epmf_cs_outlif_profile_disable_egress_filters_main(unit, recycle_entry.encap_id, outlif_profile_id), "");
    }
    ...
    */
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_port_class_set(unit, entry.tunnel_id, bcmPortClassIngress, network_domain),
        "with type == bcmPortClassFieldIngressPMF1PacketProcessingPort");
    ...
    int is_anti_spoofing)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(l2tp_mpls_termination_set(unit,uni_port,nni_port), "intf_in");
    
    BCM_IF_ERROR_RETURN_MSG(l2tp_field_extended_term_flow_set_ipmf1(unit, uni_port, cint_l2tp_mpls_info.recycle_port_id, 
        cint_l2tp_mpls_info.rcy_extended_term_encap_id), "");
    /*
     * 1. Set UNI-Port to In ETh-RIF
     */
    BCM_IF_ERROR_RETURN_MSG(in_port_intf_set(unit, cint_l2tp_mpls_info.recycle_port_id, cint_l2tp_basic_info.intf_in), "intf_in");
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(l2tp_tunnel_terminator_create(unit, &tunnel_inlif_id, &cint_l2tp_basic_info.ip_tunnel_id), "");
    
    /*
     * 6. Create l2tp tunnel termination
     */
    cint_l2tp_basic_info.network_domain = cint_l2tp_mpls_info.network_domain;
    BCM_IF_ERROR_RETURN_MSG(l2tp_termination_create(unit, 1, is_anti_spoofing), "");
      
    /*
     * 7. Create ARP and set its properties
     */
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_encap__create(unit, 0, &cint_l2tp_basic_info.arp_id,
              cint_l2tp_basic_info.arp_next_hop_mac, cint_l2tp_basic_info.intf_out), "create egress object ARP only");
    ...
    BCM_IF_ERROR_RETURN_MSG(get_first_fec_in_range_which_not_in_ecmp_range(unit, 0, 0, &cint_l2tp_basic_info.fec_id), "");
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create(unit, cint_l2tp_basic_info.fec_id, cint_l2tp_basic_info.intf_out, cint_l2tp_basic_info.arp_id, gport, 0, 0),
        "create egress object FEC only");
    ...
    if (is_ipv4)
    {
        BCM_IF_ERROR_RETURN_MSG(add_host_ipv4(unit, cint_l2tp_basic_info.host_uni2nni, cint_l2tp_basic_info.vrf, cint_l2tp_basic_info.fec_id, 0, 0), "");
    ...
    int is_anti_spoofing)
{
     ...
     * 1. Set UNI-Port to In ETh-RIF
     */
    BCM_IF_ERROR_RETURN_MSG(in_port_intf_set(unit, uni_port, cint_l2tp_basic_info.intf_in), "intf_in");
    ...
    if ((*dnxc_data_get(unit, "tunnel", "feature", "short_network_domain", NULL)) == TRUE)
    {
        cint_l2tp_basic_info.network_domain = 3;
    }
    else
    {
    ...
    if (ibch1_supported)
    {
        /** Result is IPvX InLIF provides L2TP NameSPACE (NEXT_LAYER_NETWORK_DOMAIN) */
        BCM_IF_ERROR_RETURN_MSG(bcm_port_class_set(unit, cint_l2tp_basic_info.ip_tunnel_id, bcmPortClassIngress, cint_l2tp_basic_info.network_domain), "");
    }
    ...
    BCM_IF_ERROR_RETURN_MSG(get_first_fec_in_range_which_not_in_ecmp_range(unit, 0, 0, &cint_l2tp_basic_info.fec_id), "");
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create(unit, cint_l2tp_basic_info.fec_id, cint_l2tp_basic_info.intf_out, cint_l2tp_basic_info.arp_id, gport, 0, fec_flags2),
        "create egress object FEC only");
    ...
    {
        BCM_IF_ERROR_RETURN_MSG(add_host_ipv6(unit, cint_l2tp_basic_info.host6_uni2nni, cint_l2tp_basic_info.vrf, cint_l2tp_basic_info.fec_id), "");
    }
    ...
    int is_ipv4)
{
     ...
     * 1. Set NNI-Port default ETh-RIF
     */
    BCM_IF_ERROR_RETURN_MSG(in_port_intf_set(unit, nni_port, cint_l2tp_basic_info.intf_out), "intf_in");
     ...
     * 3. Create L2TP ETH-RIF and set its properties
     */
    BCM_IF_ERROR_RETURN_MSG(bcm_vlan_create(unit ,cint_l2tp_basic_info.intf_in), "");  /* to avoid error from vlan_db_vsi_allocate_single */
    BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create(unit, cint_l2tp_basic_info.intf_in, cint_l2tp_basic_info.intf_in_mac_address), "intf_in");
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_encap__create(unit, 0, &cint_l2tp_basic_info.arp_id,
                cint_l2tp_basic_info.arp_next_hop_mac_in, cint_l2tp_basic_info.intf_in), "create egress object ARP only");

    /*
     * 7. Create UDP IP tunnel
     */
    BCM_IF_ERROR_RETURN_MSG(l2tp_tunnel_initiator_create(unit, cint_l2tp_basic_info.arp_id, &cint_l2tp_basic_info.ip_tunnel_outlif),
        "create l2tp ip tunnel");

    /*
     * 8. Create l2tp encap object and set its properties
     */
    BCM_IF_ERROR_RETURN_MSG(l2tp_encapsulation_create(unit, cint_l2tp_basic_info.ip_tunnel_outlif), "create l2tp tunnel");
    ...
    fec_flags2 = (*dnxc_data_get(unit, "l3", "feature", "separate_fwd_rpf_dbs", NULL)) ? BCM_L3_FLAGS2_FWD_ONLY : 0;
    BCM_IF_ERROR_RETURN_MSG(get_first_fec_in_range_which_not_in_ecmp_range(unit, 0, 0, &cint_l2tp_basic_info.fec_id), "");
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create(unit, cint_l2tp_basic_info.fec_id, l3_intf_id, 0, gport, 0 ,fec_flags2),
        "create egress object FEC only");
    ...
    {
        BCM_IF_ERROR_RETURN_MSG(add_host_ipv6(unit, cint_l2tp_basic_info.host6_nni2uni, cint_l2tp_basic_info.vrf, cint_l2tp_basic_info.fec_id), "");
    }
    ...
    int nni_port)
{
    ...
    if ((*dnxc_data_get(unit, "tunnel", "feature", "short_network_domain", NULL)) == TRUE)
    {
        cint_l2tp_basic_info.network_domain = 6;
    }
    else
    {
    ...
    BCM_IF_ERROR_RETURN_MSG(l2tp_termination_create(unit, 0, 0), "");
    if (ibch1_supported)
    {
        /** Result is IPvX InLIF provides L2TP NameSPACE (NEXT_LAYER_NETWORK_DOMAIN) */
        BCM_IF_ERROR_RETURN_MSG(bcm_port_class_set(unit, cint_l2tp_basic_info.ip_tunnel_id, bcmPortClassIngress, cint_l2tp_basic_info.network_domain), "");
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(pppoe_encapsulation_create(unit, cint_pppoe_basic_info.session_id, cint_pppoe_basic_info.arp_id_enc,
        &(cint_pppoe_basic_info.initiator_id)), "");
    ...
    fec_flags2 = (*dnxc_data_get(unit, "l3", "feature", "separate_fwd_rpf_dbs", NULL)) ? BCM_L3_FLAGS2_FWD_ONLY : 0;
    cint_pppoe_basic_info.fec_id_term = 0;
    BCM_IF_ERROR_RETURN_MSG(get_first_fec_in_range_which_not_in_ecmp_range(unit, 0, 0, &cint_pppoe_basic_info.fec_id_term), "");
    cint_pppoe_basic_info.fec_id_enc = cint_pppoe_basic_info.fec_id_term + 1;
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create(unit, cint_pppoe_basic_info.fec_id_enc, l3_intf_id, 0, gport, 0, fec_flags2),
        "create egress object FEC only");
    ...
    int nni_port)
{
    ...
    /*
     * 6. L2TPv2 -> PPPoE P2P service
     */
    BCM_IF_ERROR_RETURN_MSG(l2tp_2_pppoe_p2p(unit, uni_port, nni_port), "create tunnel termination");
    /*
     * 7. PPPoE -> L2TPv2 P2P service
     */
    /** Enable P2P */
    ...
    int nni_port)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(l2tp_termination(unit, uni_port, nni_port, is_ipv4, is_anti_spoofing), "");
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_ppp_term_spoofing_check_traverse(unit, &additional_info, &ppp_term_spoofing_check_traverse_cb, NULL), "");
