...
int create_fqs(int unit, int core, int nof_elements_in_shared_shaper, bcm_gport_t * gport_ucast_scheduler_fq_arr)
{
    ...
    for (se_index = 0; se_index < nof_elements_in_shared_shaper; se_index++) {
        BCM_IF_ERROR_RETURN_MSG(bcm_cosq_scheduler_gport_add(unit, 0, fq_params, &gport_ucast_scheduler_fq_arr[se_index]), "");
    }
...
int attach_fqs_to_e2e_gport (int unit, int nof_elements_in_shared_shaper, bcm_gport_t * gport_ucast_scheduler_fq_arr, bcm_gport_t e2e_gport)
{
    ...
    for (se_index = 0; se_index < nof_elements_in_shared_shaper; se_index++) {
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_cosq_gport_sched_set(unit, gport_ucast_scheduler_fq_arr[se_index], 0, FQ_SCHEDULER_MODE, 0), "");
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_cosq_gport_attach(unit, e2e_gport, gport_ucast_scheduler_fq_arr[se_index], 0), "");
    }
...
int attach_shared_shaper_to_fqs(int unit, int nof_elements_in_shared_shaper, bcm_gport_t gport_shared_shaper, bcm_gport_t * gport_ucast_scheduler_fq_arr)
{
    ...
    for (se_index = 0; se_index < nof_elements_in_shared_shaper; se_index++) {
         ...
         *
         */
        BCM_IF_ERROR_RETURN_MSG(bcm_cosq_gport_attach(unit, gport_ucast_scheduler_fq_arr[se_index], gport_info.out_gport, 0), "");
    }
...
int attach_voq_connectorto_to_shared_shaper(int unit, int nof_elements_in_shared_shaper, bcm_gport_t gport_voq_connector, bcm_gport_t gport_shared_shaper)
{
    ...
    for (cos = 0; cos < nof_elements_in_shared_shaper; cos++) {
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_cosq_control_set(unit, gport_voq_connector, cos, bcmCosqControlFlowSlowRate, 1), "");
    }
...
int configure_shapers(int unit,int nof_elements_in_shared_shaper, uint32 cir_rate, uint32 eir_rate, bcm_gport_t e2e_gport, bcm_gport_t * gport_ucast_scheduler_fq_arr, bcm_gport_t gport_shared_shaper, bcm_gport_t gport_voq_connector) {
    ...
    for (se_index = 0; se_index < nof_elements_in_shared_shaper; se_index++) {
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_cosq_gport_bandwidth_set(unit, gport_ucast_scheduler_fq_arr[se_index], 0, 0, SCHED_KBITS_SEC_MAX, 0), "");

        BCM_IF_ERROR_RETURN_MSG(bcm_cosq_control_set(unit, gport_ucast_scheduler_fq_arr[se_index], 0, bcmCosqControlBandwidthBurstMax, SCHED_MAX_BURST), "");
    }
    ...
    for (se_index = 0; se_index < nof_elements_in_shared_shaper; se_index++) {
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_cosq_gport_bandwidth_set(unit, gport_info.out_gport, 0, 0, shaper_kbps_max, 0), "");
                            ...
                            bcm_cosq_scheduler_gport_shared_order_t shared_order)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(create_fqs(unit, mapping_info.core, nof_elements_in_shared_shaper, gport_ucast_scheduler_fq_arr), "");

    BCM_IF_ERROR_RETURN_MSG(attach_fqs_to_e2e_gport (unit, nof_elements_in_shared_shaper, gport_ucast_scheduler_fq_arr, e2e_gport), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(attach_shared_shaper_to_fqs(unit, nof_elements_in_shared_shaper, gport_shared_shaper, gport_ucast_scheduler_fq_arr), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(attach_voq_connectorto_to_shared_shaper(unit, nof_elements_in_shared_shaper, gport_voq_connector, gport_shared_shaper), "");
    ...
    */
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_cosq_gport_connection_set(unit, &connection), "");
     ...
     printf("\n **********  Configure shapers ********** \n");
     BCM_IF_ERROR_RETURN_MSG(configure_shapers(unit, nof_elements_in_shared_shaper, cir_rate_kbps, eir_rate_kbps,  e2e_gport, gport_ucast_scheduler_fq_arr, gport_shared_shaper, gport_voq_connector), "");
...
int e2e_shared_shaper_setup_teardown(int unit, int nof_elements_in_shared_shaper)
{
    ...
    for (se_index = 0; se_index < nof_elements_in_shared_shaper; se_index++) {
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_cosq_gport_detach(unit, e2e_gport,  gport_ucast_scheduler_fq_arr[se_index] , -1), "");
    }
    ...
    for (se_index = 0; se_index < nof_elements_in_shared_shaper; se_index++) {
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_cosq_gport_detach(unit, gport_ucast_scheduler_fq_arr[se_index], gport_info.out_gport , -1), "");
    }
    ...
    for (se_index = 0; se_index < nof_elements_in_shared_shaper; se_index++) {
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_cosq_gport_detach(unit, gport_info.out_gport , gport_voq_connector, se_index), "");
    }
    ...
    for (se_index = 0; se_index < nof_elements_in_shared_shaper; se_index++) {
        printf("\n  Delete FQs");
        BCM_IF_ERROR_RETURN_MSG(bcm_cosq_gport_delete(unit, gport_ucast_scheduler_fq_arr[se_index]), "");
    }

    printf("\n  Delete Shared shaper");
    BCM_IF_ERROR_RETURN_MSG(bcm_cosq_gport_delete(unit, gport_shared_shaper), "");

    printf("\n  Delete VOQ connector");
    BCM_IF_ERROR_RETURN_MSG(bcm_cosq_gport_delete(unit, gport_voq_connector), "");

    printf("\n  Delete VOQ");
    BCM_IF_ERROR_RETURN_MSG(bcm_cosq_gport_delete(unit, gport_ucast_voq), "");
