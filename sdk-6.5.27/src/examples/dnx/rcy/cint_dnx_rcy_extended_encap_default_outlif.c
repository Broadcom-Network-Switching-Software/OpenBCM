 ...
 * Test Scenario - start
  ...
  config add tm_port_header_type_in_40.0=RCH_1
 * if ibch1_supported, "config add tm_port_header_type_in_40.0=IBCH1_MODE"
  0: tr 141 NoInit=1
 *
...
int cint_dnx_rcy_extended_encap_default_outlif(int unit, int inPort, int outPort, int rcyPort)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_vlan_port_add(unit, vlan, pbmp_loc, ubmp_loc), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_vlan_control_vlan_set(unit, vlan, control_local), "");
    ...
    */
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_multicast_create(unit, flags, &group), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_multicast_encap_extension_create(unit, BCM_MULTICAST_ENCAP_EXTENSION_WITH_ID, &rep_index, 2, cuds), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_multicast_add(unit, group, flags, 1, &rep_array), "");
    ...
    if (!ibch1_supported)
    {
        BCM_IF_ERROR_RETURN_MSG(bcm_port_control_set(unit, rcyPort, bcmPortControlRecycleApp, bcmPortControlRecycleAppExtendedEncap), "");
    }
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(bcm_port_learn_set(unit, inPort, BCM_PORT_LEARN_FWD), "");
