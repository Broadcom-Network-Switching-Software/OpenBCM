    ...
    int core_port2)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(vxlan_roo_basic_init(unit,access_port1, access_port2, core_port1, core_port2), "");
     ...
     */
    snprintf(error_msg, sizeof(error_msg), "vpn=%d", cint_vxlan_roo_basic_info.vpn_id);
    BCM_IF_ERROR_RETURN_MSG(multicast__open_mc_group(unit, cint_vxlan_roo_basic_info.vpn_id, 0), error_msg); 


    /** Configure port properties */
    BCM_IF_ERROR_RETURN_MSG(vxlan_roo_basic_configure_port_properties(unit,
    ...
    BCM_IF_ERROR_RETURN_MSG(vxlan_ipv6_tunnel_terminator_create(unit, &vxlan_ipv6_term_tunnel_id), "");

    /** Create the Ipv6 tunnel termination lookup and the tunnel termination inlif*/
    BCM_IF_ERROR_RETURN_MSG(ipv6_gre_tunnel_terminator_create(unit), "");
    /** Create the Ipv6 tunnel termination lookup and the tunnel termination inlif*/
    ...
    BCM_IF_ERROR_RETURN_MSG(vxlan_tunnel_initiator_create(unit, cint_vxlan_roo_basic_info.core_overlay_arp_id,
                                       &(cint_vxlan_roo_basic_info.core_overlay_encap_tunnel_intf), &encap_tunnel_id), "");
    /** Create ipv6 tunnel initiator*/
    BCM_IF_ERROR_RETURN_MSG(ipv6_tunnel_initiator_create(unit, cint_vxlan_roo_basic_info.access_arp_id,
                                       &(cint_vxlan_roo_basic_info.encap_ipv6_tunnel_intf)), "");
    /** Create MPLS swap tunnel*/
    BCM_IF_ERROR_RETURN_MSG(mpls_encapsulation_basic_create_push_or_swap_tunnel(unit, cint_vxlan_roo_basic_info.swap_after_label,
    ...
    BCM_IF_ERROR_RETURN_MSG(mpls_encapsulation_basic_create_push_or_swap_tunnel(unit, cint_vxlan_roo_basic_info.push2_label,
                                                             cint_vxlan_roo_basic_info.push_tunnel_id,
                                                             bcmEncapAccessTunnel2,
                                                             &cint_vxlan_roo_basic_info.push_tunnel2_id), "");
    /** Create MPLS push tunnel*/
    BCM_IF_ERROR_RETURN_MSG(mpls_encapsulation_basic_create_push_or_swap_tunnel(unit, cint_vxlan_roo_basic_info.push3_label,
                                                             cint_vxlan_roo_basic_info.push_tunnel2_id,
                                                             bcmEncapAccessTunnel1,
                                                             &cint_vxlan_roo_basic_info.push_tunnel3_id), "");
    /** Create MPLS 12 labels push stack*/
    BCM_IF_ERROR_RETURN_MSG(mpls_encapsulation_deep_stack(unit, cint_vxlan_roo_basic_info.mpls_stack_arp_id, &cint_vxlan_roo_basic_info.push_stack_tunnel_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(vxlan_port_add(unit, core_port1, term_tunnel_id, cint_vxlan_roo_basic_info.core_overlay_fec_id1, &vxlan_port_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(vxlan_roo_basic_eve_swap(unit, cint_vxlan_roo_basic_info.core_port1), "");
    /**Configure EVE commands for core port 2*/
    BCM_IF_ERROR_RETURN_MSG(vxlan_roo_basic_eve_swap(unit, cint_vxlan_roo_basic_info.core_port2), "");
    /** Configure vlan port*/
    BCM_IF_ERROR_RETURN_MSG(vlan_port_add(unit, access_port1, cint_vxlan_roo_basic_info.access_vid, &vlan_port_id1), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_vlan_gport_add(unit, cint_vxlan_roo_basic_info.access_vid, access_port1, 0), "");

    /** Configure vlan port*/
    BCM_IF_ERROR_RETURN_MSG(vlan_port_add(unit, access_port2, cint_vxlan_roo_basic_info.access_vid, &vlan_port_id2), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_vlan_gport_add(unit, cint_vxlan_roo_basic_info.access_vid, access_port2, 0), "");

    /** Configure vswitch with the created vlan port*/
    BCM_IF_ERROR_RETURN_MSG(vswitch_add_port(unit, cint_vxlan_roo_basic_info.vpn_id, vlan_port_id1), "");
    /** Configure vswitch with the created vlan port*/
    BCM_IF_ERROR_RETURN_MSG(vswitch_add_port(unit, cint_vxlan_roo_basic_info.vpn_id, vlan_port_id2), "");
    /** Create an MACT entry to VXLAN tunnel, mapped to the VPN */
    BCM_IF_ERROR_RETURN_MSG(mact_entry_add(unit, cint_vxlan_roo_basic_info.access_eth_fwd_mac1, cint_vxlan_roo_basic_info.vpn_id, vxlan_port_id), "");
    /** Create an MACT entry to VXLAN tunnel, mapped to the VPN */
    BCM_IF_ERROR_RETURN_MSG(mact_entry_add(unit, cint_vxlan_roo_basic_info.access_eth_fwd_mac2, cint_vxlan_roo_basic_info.vpn_id, vxlan_port_id), "");
    /** Add MPLS termination entries */
    tunnel_id = 0x15a5a;
    BCM_IF_ERROR_RETURN_MSG(mpls_termination_basic_create_termination_tunnel(unit, cint_vxlan_roo_basic_info.termination_stack[0],
                                                          &tunnel_id), "1");
    /** Add MPLS termination entries */
    tunnel_id = 0x2a5a5;
    BCM_IF_ERROR_RETURN_MSG(mpls_termination_basic_create_termination_tunnel(unit, cint_vxlan_roo_basic_info.termination_stack[1],
                                                          &tunnel_id), "2");
    /** Add MPLS termination entries */
    tunnel_id = 0x37373;
    BCM_IF_ERROR_RETURN_MSG(mpls_termination_basic_create_termination_tunnel(unit, cint_vxlan_roo_basic_info.termination_stack[2],
                                                          &tunnel_id), "3");
    /** Use 18 bits global Out-LIFf for compatiblity with JR1 system headers mode.*/
    tunnel_id = 0x3f737;
    BCM_IF_ERROR_RETURN_MSG(mpls_termination_basic_create_termination_tunnel(unit, cint_vxlan_roo_basic_info.termination_stack[3],
                                                          &tunnel_id), "4");
    /** Add ILM tunnel switch */
    BCM_IF_ERROR_RETURN_MSG(mpls_encapsulation_basic_create_ilm_switch_tunnel_create(unit, cint_vxlan_roo_basic_info.swap_before_label,
                                                                  cint_vxlan_roo_basic_info.mpls_fec_id), "4");
    /** Add IP-Tunnel termination */
    BCM_IF_ERROR_RETURN_MSG(tunnel_terminator_create(unit, cint_vxlan_roo_basic_info.dip_term_tunnel, 0xFFFF0000,
    ...
    int unit)
{
    ...
    dnx_utils_l3_host_ipv6_s host_ipv6_structure;
    dnx_utils_l3_route_ipv4_s route_ipv4_structure;
    dnx_utils_l3_route_ipv6_s route_ipv6_structure;
    dnx_utils_l3_vpbr_ipv4_s vpbr_ipv4_structure;
    /*
     * Add Host entry for access to core traffic     */

    BCM_IF_ERROR_RETURN_MSG(add_host_ipv4(unit, cint_vxlan_roo_basic_info.route_dip_into_overlay, cint_vxlan_roo_basic_info.access_eth_vrf, cint_vxlan_roo_basic_info.core_native_fec_id1, 0, 0), "");

    /*
     * Add Host entry for core to access traffic     */
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv4(unit, cint_vxlan_roo_basic_info.route_dip_out_of_overlay, cint_vxlan_roo_basic_info.tunnel_termination_vrf, cint_vxlan_roo_basic_info.access_fec_id1, 0, 0), "");

    /*
     * Add Host entry for core to access traffic     */
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv4(unit, cint_vxlan_roo_basic_info.route_dip_out_of_overlay+1, cint_vxlan_roo_basic_info.tunnel_termination_vrf, cint_vxlan_roo_basic_info.access_fec_id2, 0, 0), "");

    /** Add LPM Public route entry for core to access traffic */
    if (!*dnxc_data_get(unit, "l3", "fwd", "host_entry_support", NULL))
    {
        BCM_IF_ERROR_RETURN_MSG(add_host_ipv4(unit, cint_vxlan_roo_basic_info.public_dip_ipv4, 0, cint_vxlan_roo_basic_info.access_fec_id_public, 0, 0), "");
    }
    else 
    {
        dnx_utils_l3_route_ipv4_s_common_init(unit, 0, &route_ipv4_structure, cint_vxlan_roo_basic_info.public_dip_ipv4, cint_vxlan_roo_basic_info.public_dip_ipv4_mask, 0, 0, 0, cint_vxlan_roo_basic_info.access_fec_id_public);
        BCM_IF_ERROR_RETURN_MSG(dnx_utils_l3_route_ipv4_add(unit, &route_ipv4_structure), "");
    }

    /*
     * Add Route entry
     */
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv4(unit, cint_vxlan_roo_basic_info.route_dip_into_mpls,
            cint_vxlan_roo_basic_info.tunnel_termination_vrf, cint_vxlan_roo_basic_info.access_fec_id1, 0, 0), "");

    /*
     * Add Host entry
     */
    int fwd_flag = (*dnxc_data_get(unit, "l3", "feature", "separate_fwd_rpf_dbs", NULL)) ? BCM_L3_FLAGS2_FWD_ONLY : 0;
    dnx_utils_l3_route_ipv6_s_common_init(unit, 0, &route_ipv6_structure, cint_vxlan_roo_basic_info.routev6_dip_out_of_overlay, cint_vxlan_roo_basic_info.maskv6_dip_out_of_overlay,
            cint_vxlan_roo_basic_info.tunnel_termination_vrf, 0, fwd_flag, cint_vxlan_roo_basic_info.access_fec_id1);
    BCM_IF_ERROR_RETURN_MSG(dnx_utils_l3_route_ipv6_add(unit, &route_ipv6_structure), "");

    /*
     * Add Host entry
     */
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv6(unit, cint_vxlan_roo_basic_info.hostv6_dip_out_of_overlay, cint_vxlan_roo_basic_info.tunnel_termination_vrf, cint_vxlan_roo_basic_info.access_fec_id1), "");

    /*
     * Add Host entry for routing into Ipv6 tunnel
     */
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv6(unit, cint_vxlan_roo_basic_info.dip_to_tunnel, cint_vxlan_roo_basic_info.tunnel_termination_vrf, cint_vxlan_roo_basic_info.ipv6_provider_fec), "");
    /*
     *
     * Add pbr entry
     */
    dnx_utils_l3_vpbr_ipv4_s_common_init(unit, 0, &vpbr_ipv4_structure, cint_vxlan_roo_basic_info.host_dip_out_of_overlay, 0xFFFFFFFF,
    ...
    BCM_IF_ERROR_RETURN_MSG(dnx_utils_l3_vpbr_ipv4_add(unit, &vpbr_ipv4_structure), "");
    /*
     * Add vpbr Host
     */
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv4(unit, cint_vxlan_roo_basic_info.host_dip_out_of_overlay, cint_vxlan_roo_basic_info.vpbr_vrf, cint_vxlan_roo_basic_info.access_fec_id1, 0, 0), "");

    /*
     * Add Host entry
     */
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv4(unit, cint_vxlan_roo_basic_info.host_dip_tunnel_out_of_overlay, cint_vxlan_roo_basic_info.tunnel_termination_vrf, cint_vxlan_roo_basic_info.mpls2_fec_id, 0, 0), "");

    /*
     * Add Host entry
     */
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv4(unit, cint_vxlan_roo_basic_info.host_dip_into_mpls_stack, cint_vxlan_roo_basic_info.tunnel_termination_vrf, cint_vxlan_roo_basic_info.mpls3_fec_id, 0, 0), "");
    /*
     * Add Host entry for routing into MPLS stack
     */
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv6(unit, cint_vxlan_roo_basic_info.dip_to_mpls, cint_vxlan_roo_basic_info.tunnel_termination_vrf, cint_vxlan_roo_basic_info.mpls3_fec_id), "");

    /*
     * Add Route entry for Public LPM lookup
     */
    dnx_utils_l3_route_ipv6_s_common_init(unit, 0, &route_ipv6_structure, cint_vxlan_roo_basic_info.public_dip, cint_vxlan_roo_basic_info.public_dip_mask,
            0, 0, fwd_flag, cint_vxlan_roo_basic_info.access_fec_id_public);
    BCM_IF_ERROR_RETURN_MSG(dnx_utils_l3_route_ipv6_add(unit, &route_ipv6_structure), "");
    return BCM_E_NONE;
}
int
    ...
    int unit)
{
    ...
    dnx_utils_l3_fec_s_common_init(unit, BCM_L3_WITH_ID, 0, &fec_structure, cint_vxlan_roo_basic_info.core_native_fec_id1, flags, 0, gport, cint_vxlan_roo_basic_info.core_native_eth_rif, cint_vxlan_roo_basic_info.core_native_arp_id);
    ...
    dnx_utils_l3_fec_s_common_init(unit, BCM_L3_WITH_ID, 0, &fec_structure, cint_vxlan_roo_basic_info.core_native_fec_id2, flags, 0, gport, cint_vxlan_roo_basic_info.core_native_eth_rif, cint_vxlan_roo_basic_info.core_native_arp_id);
    BCM_IF_ERROR_RETURN_MSG(dnx_utils_l3_fec_create(unit, &fec_structure), "");
    ...
    dnx_utils_l3_fec_s_common_init(unit, BCM_L3_WITH_ID, 0, &fec_structure, cint_vxlan_roo_basic_info.core_overlay_fec_id1, flags, 0, gport, cint_vxlan_roo_basic_info.core_overlay_encap_tunnel_intf,
            0);
    BCM_IF_ERROR_RETURN_MSG(dnx_utils_l3_fec_create(unit, &fec_structure), "in creating overlay FEC for routing into overlay");

    gport = 0;
    flags |= BCM_L3_CASCADED;
    BCM_GPORT_LOCAL_SET(gport, cint_vxlan_roo_basic_info.core_port2);
    dnx_utils_l3_fec_s_common_init(unit, BCM_L3_WITH_ID, 0, &fec_structure, cint_vxlan_roo_basic_info.core_overlay_fec_id2, flags, 0, gport, cint_vxlan_roo_basic_info.core_overlay_encap_tunnel_intf,
            0);
    BCM_IF_ERROR_RETURN_MSG(dnx_utils_l3_fec_create(unit, &fec_structure), "in creating overlay FEC for routing into overlay");
     ...
     */
    flags = 0;
    dnx_utils_l3_fec_s_common_init(unit, BCM_L3_WITH_ID, 0, &fec_structure, cint_vxlan_roo_basic_info.access_fec_id1, flags, 0, cint_vxlan_roo_basic_info.access_port1, cint_vxlan_roo_basic_info.access_eth_rif,
            cint_vxlan_roo_basic_info.access_arp_id);
    BCM_IF_ERROR_RETURN_MSG(dnx_utils_l3_fec_create(unit, &fec_structure), "in creating FEC routing out of overlay");
    flags = 0;
    dnx_utils_l3_fec_s_common_init(unit, BCM_L3_WITH_ID, 0, &fec_structure, cint_vxlan_roo_basic_info.access_fec_id2, flags, 0, cint_vxlan_roo_basic_info.access_port2, cint_vxlan_roo_basic_info.access_eth_rif,
            cint_vxlan_roo_basic_info.access_arp_id);
    BCM_IF_ERROR_RETURN_MSG(dnx_utils_l3_fec_create(unit, &fec_structure), "in creating FEC routing out of overlay");

    flags = 0;
    dnx_utils_l3_fec_s_common_init(unit, BCM_L3_WITH_ID, 0, &fec_structure, cint_vxlan_roo_basic_info.access_fec_id_public, flags, 0, cint_vxlan_roo_basic_info.access_port2, cint_vxlan_roo_basic_info.access_eth_rif_public,
            cint_vxlan_roo_basic_info.access_arp_id_public);
    BCM_IF_ERROR_RETURN_MSG(dnx_utils_l3_fec_create(unit, &fec_structure), "in creating FEC routing out of overlay");

    flags = 0;
    dnx_utils_l3_fec_s_common_init(unit, BCM_L3_WITH_ID, 0, &fec_structure, cint_vxlan_roo_basic_info.ipv6_provider_fec, flags, 0, cint_vxlan_roo_basic_info.access_port2, cint_vxlan_roo_basic_info.encap_ipv6_tunnel_intf, 0);
    BCM_IF_ERROR_RETURN_MSG(dnx_utils_l3_fec_create(unit, &fec_structure), "in creating FEC routing out of overlay");

    flags = 0;
    dnx_utils_l3_fec_s_common_init(unit, BCM_L3_WITH_ID, 0, &fec_structure, cint_vxlan_roo_basic_info.mpls_fec_id, flags, 0, cint_vxlan_roo_basic_info.access_port1, cint_vxlan_roo_basic_info.push_tunnel_id, 0);
    BCM_IF_ERROR_RETURN_MSG(dnx_utils_l3_fec_create(unit, &fec_structure), "in creating FEC mpls");

    flags = 0;
    dnx_utils_l3_fec_s_common_init(unit, BCM_L3_WITH_ID, 0, &fec_structure, cint_vxlan_roo_basic_info.mpls2_fec_id, flags, 0, cint_vxlan_roo_basic_info.access_port1, cint_vxlan_roo_basic_info.push_tunnel3_id, 0);
    BCM_IF_ERROR_RETURN_MSG(dnx_utils_l3_fec_create(unit, &fec_structure), "in creating FEC ip");

    flags = 0;
    dnx_utils_l3_fec_s_common_init(unit, BCM_L3_WITH_ID, 0, &fec_structure, cint_vxlan_roo_basic_info.mpls3_fec_id, flags, 0, cint_vxlan_roo_basic_info.access_port1, cint_vxlan_roo_basic_info.push_stack_tunnel_id, 0);
    BCM_IF_ERROR_RETURN_MSG(dnx_utils_l3_fec_create(unit, &fec_structure), "in creating FEC ip");
    return BCM_E_NONE;
}
int
    ...
    int unit)
{
    ...
    dnx_utils_l3_arp_s_common_init(unit, 0, &arp_structure, cint_vxlan_roo_basic_info.core_native_arp_id, BCM_L3_NATIVE_ENCAP, BCM_L3_FLAGS2_VLAN_TRANSLATION, cint_vxlan_roo_basic_info.core_native_next_hop_mac, cint_vxlan_roo_basic_info.core_native_eth_rif);
    ...
    dnx_utils_l3_arp_s_common_init(unit, 0, &arp_structure, 0, 0, cint_vxlan_roo_basic_info.core_overlay_arp_id, cint_vxlan_roo_basic_info.core_overlay_next_hop_mac, cint_vxlan_roo_basic_info.core_overlay_eth_rif);
    BCM_IF_ERROR_RETURN_MSG(dnx_utils_l3_arp_create(unit, &arp_structure), "create AC egress object ARP only");
    cint_vxlan_roo_basic_info.core_overlay_arp_id = arp_structure.l3eg_arp_id;
    /** Configure access ARP entry */
    dnx_utils_l3_arp_s_common_init(unit, 0, &arp_structure, 0, 0, cint_vxlan_roo_basic_info.access_arp_id, cint_vxlan_roo_basic_info.access_next_hop_mac, cint_vxlan_roo_basic_info.access_eth_rif);
    BCM_IF_ERROR_RETURN_MSG(dnx_utils_l3_arp_create(unit, &arp_structure), "create AC egress object ARP only");
    cint_vxlan_roo_basic_info.access_arp_id = arp_structure.l3eg_arp_id;
    /** Configure access ARP entry */
    dnx_utils_l3_arp_s_common_init(unit, 0, &arp_structure, 0, 0, cint_vxlan_roo_basic_info.access_arp_id_public, cint_vxlan_roo_basic_info.access_next_hop_mac_public, cint_vxlan_roo_basic_info.access_eth_rif_public);
    BCM_IF_ERROR_RETURN_MSG(dnx_utils_l3_arp_create(unit, &arp_structure), "create AC egress object ARP only");
    cint_vxlan_roo_basic_info.access_arp_id_public = arp_structure.l3eg_arp_id;

    dnx_utils_l3_arp_s_common_init(unit, 0, &arp_structure, cint_vxlan_roo_basic_info.mpls_stack_arp_id, 0, BCM_L3_FLAGS2_VLAN_TRANSLATION, cint_vxlan_roo_basic_info.core_overlay_next_hop_mac, cint_vxlan_roo_basic_info.core_overlay_eth_rif);
    BCM_IF_ERROR_RETURN_MSG(dnx_utils_l3_arp_create(unit, &arp_structure), "create AC egress object ARP2 only");
    ...
    int core_port2)
{
    ...
    dnx_utils_l3_port_s_common_init(unit, 0, &l3_port_structure, cint_vxlan_roo_basic_info.access_port1, cint_vxlan_roo_basic_info.access_eth_rif);
    BCM_IF_ERROR_RETURN_MSG(dnx_utils_l3_port_set(unit, &l3_port_structure), "");

    dnx_utils_l3_port_s_common_init(unit, 0, &l3_port_structure, cint_vxlan_roo_basic_info.access_port2, cint_vxlan_roo_basic_info.access_eth_rif);
    BCM_IF_ERROR_RETURN_MSG(dnx_utils_l3_port_set(unit, &l3_port_structure), "");
    ...
    tagged_vlan[0] = 1;
    tagged_vlan[1] = 1;
    BCM_IF_ERROR_RETURN_MSG(vlan__open_vlan_per_ports(unit, cint_vxlan_roo_basic_info.access_eth_rif, ports_vlan, tagged_vlan, 2), "");

    dnx_utils_l3_port_s_common_init(unit, 0, &l3_port_structure, cint_vxlan_roo_basic_info.core_port1, cint_vxlan_roo_basic_info.core_overlay_eth_rif);
    BCM_IF_ERROR_RETURN_MSG(dnx_utils_l3_port_set(unit, &l3_port_structure), "");

    dnx_utils_l3_port_s_common_init(unit, 0, &l3_port_structure, cint_vxlan_roo_basic_info.core_port2, cint_vxlan_roo_basic_info.core_overlay_eth_rif);
    BCM_IF_ERROR_RETURN_MSG(dnx_utils_l3_port_set(unit, &l3_port_structure), "");
    ...
    tagged_vlan[0] = 1;
    tagged_vlan[1] = 1;
    BCM_IF_ERROR_RETURN_MSG(vlan__open_vlan_per_ports(unit, cint_vxlan_roo_basic_info.core_overlay_eth_rif, ports_vlan, tagged_vlan, 2), "");
    ...
    int unit)
{
    ...
    dnx_utils_l3_eth_rif_s_common_init(unit, 0, &eth_rif_structure, cint_vxlan_roo_basic_info.core_overlay_eth_rif, 0, 0, cint_vxlan_roo_basic_info.core_overlay_eth_rif_mac, cint_vxlan_roo_basic_info.core_overlay_eth_vrf);
    BCM_IF_ERROR_RETURN_MSG(dnx_utils_l3_eth_rif_create(unit, &eth_rif_structure), "core_overlay_eth_rif");

    dnx_utils_l3_eth_rif_s_common_init(unit, 0, &eth_rif_structure, cint_vxlan_roo_basic_info.access_eth_rif, 0, 0, cint_vxlan_roo_basic_info.access_eth_rif_mac, cint_vxlan_roo_basic_info.access_eth_vrf);
        ...
        int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_tunnel_terminator_create(unit, &tunnel_termination_obj), "failed to create tunnel termination object");
    ...
    bcm_gport_t * tunnel_id)
{
    ...
    *tunnel_id = entry.tunnel_id;
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_l3_ingress_create(unit, l3_ing_if, l3_intf_id), "");
    return BCM_E_NONE;
}
int
    ...
    bcm_if_t * tunnel_id)
{
    ...
    if(*dnxc_data_get(unit, "mpls", "general", "tandem_supported", NULL))
    {
        ...
        for (i = 5; i >= 0; i--)
        {
            ...
            snprintf(error_msg, sizeof(error_msg), "i %d", i);
            BCM_IF_ERROR_RETURN_MSG(bcm_mpls_tunnel_initiator_create(unit, 0, 2, label_array), error_msg);
    ...
    else
    {
        ...
        for (i = 5; i >= 0; i -= 2)
        {
            ...
            label_array[0].label = entry_first[i-1];
            label_array[0].flags = BCM_MPLS_EGRESS_LABEL_TTL_DECREMENT;
            label_array[0].egress_qos_model.egress_qos = bcmQosEgressModelUniform;
            label_array[0].egress_qos_model.egress_ttl = bcmQosEgressModelUniform;
            label_array[0].l3_intf_id = next_pointer;
            label_array[0].encap_access = encap_access[i-1];
            label_array[1].label = entry_second[i-1];
            label_array[1].flags = BCM_MPLS_EGRESS_LABEL_TTL_DECREMENT;
            label_array[1].egress_qos_model.egress_qos = bcmQosEgressModelUniform;
            label_array[1].egress_qos_model.egress_ttl = bcmQosEgressModelUniform;
            label_array[1].l3_intf_id = next_pointer;
            label_array[1].encap_access = encap_access[i-1];
            label_array[2].label = entry_first[i];
            label_array[2].flags = BCM_MPLS_EGRESS_LABEL_TTL_DECREMENT;
            label_array[2].egress_qos_model.egress_qos = bcmQosEgressModelUniform;
            label_array[2].egress_qos_model.egress_ttl = bcmQosEgressModelUniform;
            label_array[2].l3_intf_id = next_pointer;
            label_array[2].encap_access = encap_access[i];
            label_array[3].label = entry_second[i];
            label_array[3].flags = BCM_MPLS_EGRESS_LABEL_TTL_DECREMENT;
            label_array[3].egress_qos_model.egress_qos = bcmQosEgressModelUniform;
            label_array[3].egress_qos_model.egress_ttl = bcmQosEgressModelUniform;
            label_array[3].l3_intf_id = next_pointer;
            label_array[3].encap_access = encap_access[i];
            snprintf(error_msg, sizeof(error_msg), "i %d", i);
            BCM_IF_ERROR_RETURN_MSG(bcm_mpls_tunnel_initiator_create(unit, 0, 4, label_array), error_msg);

            next_pointer = label_array[0].tunnel_id;
        }
    }
    *tunnel_id = next_pointer;
    return BCM_E_NONE;
}
