    ...
    int access_side_sys_port)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(get_first_fec_in_range_which_not_in_ecmp_range(access_side_unit, 0, 0, &cint_vxlan_roo_info.core_native_fec_id), "");

    BCM_IF_ERROR_RETURN_MSG(get_first_fec_in_range_which_not_in_ecmp_range(access_side_unit, 1, 0, &cint_vxlan_roo_info.core_overlay_fec_id), "");

    BCM_IF_ERROR_RETURN_MSG(get_first_fec_in_range_which_not_in_ecmp_range(core_side_unit, 0, 0, &cint_vxlan_roo_info.access_fec_id), "");
    ...
    int access_side_sys_port)
{
    ...
    if (rv != BCM_E_NONE) {
        ...
        BCM_IF_ERROR_RETURN_MSG(dnx_utils_l3_eth_rif_create(access_side_unit, &eth_rif_structure), "");
    }
    ...
    if (rv != BCM_E_NONE) {
        ...
        BCM_IF_ERROR_RETURN_MSG(dnx_utils_l3_eth_rif_create(core_side_unit, &eth_rif_structure), "");
    }
    ...
    int into_overlay)
{
    ...
    if (into_overlay) {
        ...
        BCM_IF_ERROR_RETURN_MSG(dnx_utils_l3_arp_create(core_side_unit, &arp_structure),
        ...
        BCM_IF_ERROR_RETURN_MSG(dnx_utils_l3_arp_create(access_side_unit, &arp_structure),
            "create AC egress object ARP only");
    ...
    int into_overlay)
{
    ...
    if (into_overlay) {
        ...
        snprintf(error_msg, sizeof(error_msg), "create egress object hierarchy 2 FEC 0x%x only", fec_structure.fec_id);
        BCM_IF_ERROR_RETURN_MSG(dnx_utils_l3_fec_create(access_side_unit, &fec_structure), error_msg);
        ...
        snprintf(error_msg, sizeof(error_msg), "create egress object hierarchy 1 FEC 0x%x only", fec_structure.fec_id);
        BCM_IF_ERROR_RETURN_MSG(dnx_utils_l3_fec_create(access_side_unit, &fec_structure), error_msg);
        ...
        snprintf(error_msg, sizeof(error_msg), "create egress object FEC 0x%x only", fec_structure.fec_id);
        BCM_IF_ERROR_RETURN_MSG(dnx_utils_l3_fec_create(core_side_unit, &fec_structure), error_msg);
    ...
    int into_overlay)
{
     ...
     */
        BCM_IF_ERROR_RETURN_MSG(add_host_ipv4(access_side_unit, cint_vxlan_roo_info.route_dip_into_overlay, cint_vxlan_roo_info.access_eth_vrf, cint_vxlan_roo_info.core_native_fec_id, 0, 0), "");
     ...
     */
        BCM_IF_ERROR_RETURN_MSG(add_host_ipv4(core_side_unit, cint_vxlan_roo_info.route_dip_out_of_overlay, cint_vxlan_roo_info.core_native_eth_vrf, cint_vxlan_roo_info.access_fec_id, 0, 0), "");
    ...
    int core_side_unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_tunnel_terminator_create(core_side_unit,&tunnel_term), "");
    ...
    int core_side_unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_tunnel_initiator_create(core_side_unit,&l3_intf, tunnel_init), "");
    ...
    int vxlan_port_exist)
{
    ...
    {
        /* Delete VXLAN port */
        BCM_IF_ERROR_RETURN_MSG(bcm_vxlan_port_delete(unit, cint_vxlan_roo_info.vpn_id, cint_vxlan_roo_info.vxlan_port_id), "");
    }

    /* Destroy VPN */
    BCM_IF_ERROR_RETURN_MSG(bcm_vxlan_vpn_destroy(unit, cint_vxlan_roo_info.vpn_id), "");

    /* Destroy multicast */
    BCM_IF_ERROR_RETURN_MSG(bcm_multicast_destroy(unit, cint_vxlan_roo_info.vpn_id), "");
    ...
    int access_side_sys_port)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(multi_dev_ingress_port_configuration(access_side_unit,cint_vxlan_roo_info.access_port,cint_vxlan_roo_info.access_eth_rif), "");

    BCM_IF_ERROR_RETURN_MSG(multi_dev_egress_port_configuration(core_side_unit,cint_vxlan_roo_info.core_port), "");

    /*
     * 2. vxlan vpn creation, put it here just because this routing will reset the nativ-rif property.
     *    So call this first.
     */
    snprintf(error_msg, sizeof(error_msg), "vpn=%d", cint_vxlan_roo_info.vpn_id);
    BCM_IF_ERROR_RETURN_MSG(dnx_utils_vxlan_open_vpn(core_side_unit, cint_vxlan_roo_info.vpn_id, 0, cint_vxlan_roo_info.vni), error_msg);
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_vlan_port_create(core_side_unit, vlan_port), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_vlan_port_translation_set(core_side_unit, &vlan_port_translation), "");
    /*
     * Create action ID
     */
    int action_id;
    BCM_IF_ERROR_RETURN_MSG(bcm_vlan_translate_action_id_create(core_side_unit, BCM_VLAN_ACTION_SET_EGRESS, &action_id), "");
    /*
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_vlan_translate_action_id_set(core_side_unit,
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_vlan_translate_action_class_set(core_side_unit, &action_class), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(multi_dev_vxlan_roo_l3_intf_configuration(core_side_unit,access_side_unit,core_side_sys_port,access_side_sys_port), "");
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(multi_dev_vxlan_roo_arp_configuration(core_side_unit,access_side_unit,core_side_sys_port,access_side_sys_port,into_overlay), "");

    /*
     * 5.Vxlan tunnel encapsulation
     */

    BCM_IF_ERROR_RETURN_MSG(multi_dev_vxlan_roo_tunnel_encap_configuration(core_side_unit), "");
     ...
     *    FEC for L3 route result
     */
    BCM_IF_ERROR_RETURN_MSG(multi_dev_vxlan_roo_fec_entry_configuration(-1,access_side_unit,core_side_sys_port,-1,into_overlay), "");

    /*
     * 7. FWD configuration(L3 route)
     */
    BCM_IF_ERROR_RETURN_MSG(multi_dev_vxlan_roo_forward_entry_configuration(-1,access_side_unit,core_side_sys_port,-1,into_overlay), "");
    ...
    int access_side_sys_port)
{
     ...
     * 1.Basic ingress L2 configuration(Port default LIF)
     */
    BCM_IF_ERROR_RETURN_MSG(multi_dev_ingress_port_configuration(core_side_unit,cint_vxlan_roo_info.core_port,cint_vxlan_roo_info.core_overlay_eth_rif), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(multi_dev_vxlan_roo_tunnel_termination_configuration(core_side_unit), "");
     ...
     *    FEC for L3 route result
     */
    BCM_IF_ERROR_RETURN_MSG(multi_dev_vxlan_roo_fec_entry_configuration(core_side_unit,-1,-1,access_side_sys_port,into_overlay), "");

    /*
     * 7. FWD configuration(L3 route)
     */
    BCM_IF_ERROR_RETURN_MSG(multi_dev_vxlan_roo_forward_entry_configuration(core_side_unit,-1,-1,access_side_sys_port,into_overlay), "");


    /*
     * 8. Add VXLAN port properties and configure the tunnel terminator In-Lif and tunnel initiatior Out-Lif
     */
    BCM_IF_ERROR_RETURN_MSG(multi_dev_vxlan_roo_vxlan_port_add(core_side_unit, core_side_sys_port, cint_vxlan_roo_info.vxlan_tunnel_if, &cint_vxlan_roo_info.vxlan_port_id), "");
    ...
    int is_roo)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(multi_dev_vxlan_roo_init(core_side_unit,access_side_unit,core_side_sys_port,access_side_sys_port), "");

    if (is_roo)
    {
        BCM_IF_ERROR_RETURN_MSG(multi_dev_vxlan_roo_out_of_overlay_configuration(core_side_unit,access_side_unit,core_side_sys_port,access_side_sys_port), "");
    }
    else
    {
        BCM_IF_ERROR_RETURN_MSG(multi_dev_vxlan_roo_into_overlay_configuration(core_side_unit,access_side_unit,core_side_sys_port,access_side_sys_port), "");
