...
int cint_field_IFA_datapath_intermediate_ingress_entry_add(int unit, uint32 probe_1, uint32 probe_2, bcm_field_entry_t *entry_handle)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, cint_field_IFA_datapath_ingress_fg_id, &ent_info, entry_handle), "");
...
int cint_field_IFA_datapath_intermediate_ingress_main(int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit,0,&qual_info,&cint_field_IFA_datapath_ingress_probe_qual), "");
...
int field_attach_destroy(int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, cint_field_IFA_datapath_ingress_fg_id, cint_field_IFA_datapath_ingress_context_id_ipv4), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_destroy(unit,bcmFieldStageIngressPMF1,cint_field_IFA_datapath_ingress_context_id_ipv4), "");
...
int cint_field_group_const_example_IFA_gen(int unit,int Outlif,int recycle_port)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_field_ip_snoop_set(unit, system_recycle_port, 1, 1, outlif_encap_id, &snoop_trap_gport_id, &mirror_dest_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_context_param_set(unit, 0, bcmFieldStageIngressPMF2, context_id, &param_info), "");

    /* Add flow_id in field */
    BCM_IF_ERROR_RETURN_MSG(appl_dnx_field_flow_id_init(unit,context_id), "");
    ...
    if (*dnxc_data_get(unit,"instru","ifa","ingress_tod_feature",NULL))
    {
      ...
      BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit,0,&qual_info,&cint_field_IFA_datapath_ingress_2ndpass), "");

      bcm_field_qualifier_info_create_t_init(&qual_info);
      qual_info.size=32;
      dest_char = &(qual_info.name[0]);
      sal_strncpy_s(dest_char, "IFA_ptch1P", sizeof(qual_info.name));
      BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit,0,&qual_info,&cint_field_IFA_datapath_ingress_ptch1P), "");

      bcm_field_qualifier_info_create_t_init(&qual_info);
      qual_info.size=2;
      dest_char = &(qual_info.name[0]);
      sal_strncpy_s(dest_char, "IFA_ptch1PBase", sizeof(qual_info.name));
      BCM_IF_ERROR_RETURN_MSG(bcm_field_qualifier_create(unit,0,&qual_info,&cint_field_IFA_datapath_ingress_ptch1PBase), "");
      ...
      BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &cint_field_IFA_datapath_ingress_fg_id_2p_tsh), "");
      ...
      BCM_IF_ERROR_RETURN_MSG(bcm_field_group_action_offset_get(unit, 0, cint_field_IFA_datapath_ingress_fg_id,cint_field_IFA_datapath_ingress_act_container_1b, &attach_info.key_info.qual_info[0].offset), "");
      ...
      BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, cint_field_IFA_datapath_ingress_fg_id_2p_tsh, context_id, &attach_info), "");
    }
