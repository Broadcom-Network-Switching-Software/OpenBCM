...
int dnx_l3_egress_create(int unit, uint32 flags, bcm_l3_egress_t *egr, bcm_if_t *if_id)
{
    ...
    if (is_egress) {
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_l3_egress_create(unit, allocation_flags, egr, &l3egid_dummy), "egress object");
    ...
    if (is_ingress) {
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_l3_egress_create(unit, allocation_flags, egr, if_id), "ingress object");
...
int dnx_utils_l3_fec_create(int unit, dnx_utils_l3_fec_s *fec_structure) {
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_l3_egress_create(unit, fec_structure->allocation_flags, &l3eg, &l3egid), error_msg);
...
int dnx_utils_l3_arp_create(int unit, dnx_utils_l3_arp_s *arp_structure)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_l3_egress_create(unit, flags, &l3eg, &l3egid_null), "create egress object");
...
int dnx_utils_l3_egress_create(int unit, l3_egress_s *l3_egress) {
    ...
    snprintf(error_msg, sizeof(error_msg), "create egress object, unit=%d", unit);
    BCM_IF_ERROR_RETURN_MSG(dnx_l3_egress_create(unit, l3_egress->allocation_flags, &l3eg, &l3egid), error_msg);
...
int dnx_utils_l3_eth_rif_create(int unit, dnx_utils_l3_eth_rif_s *eth_rif_structure)
{
    ...
    if (eth_rif_structure->mtu_valid) {
        ...
        BCM_IF_ERROR_RETURN_MSG(mtu_check_etpp_rif_set(unit, eth_rif_structure->l3_rif, compressed_layer_type , eth_rif_structure->mtu, 1/*is_set*/), "");
    }
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_l3_ingress_create(unit, l3_ing_if, &l3if.l3a_intf_id), "");
...
int dnx_utils_l3_port_set(int unit, dnx_utils_l3_port_s *l3_port_structure)
{
    ...
    if (!l3_port_structure->eg_vlan_port_id)
    {
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_vlan_port_create(unit, &vlan_port2), "");
    ...
    if (l3_port_structure->eg_vlan_port_id != default_esem_invalid)
    {
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_port_match_add(unit, l3_port_structure->eg_vlan_port_id, &match_info), "");
    }
    default_egr_vlan_port_id_out = l3_port_structure->eg_vlan_port_id;
    BCM_IF_ERROR_RETURN_MSG(bcm_vlan_gport_add(unit, l3_port_structure->eth_rif_id, l3_port_structure->port, 0), "");
...
int dnx_utils_l3__intf_rif__create(int unit, create_l3_intf_s *l3_intf){
    ...
    if ((l3_intf->no_publc == 0) &&
        /* Update the in_rif to have public searches enabled for vrf == 0 */
         (l3_intf->vrf == 0) &&
         (*dnxc_data_get(unit, "l3", "feature", "public_routing_support", NULL)))
    {
        l3_intf->vrf_valid = 1;
        enable_public = 1;
    }
    ...
    if (l3_intf->vrf_valid || l3_intf->rpf_valid) {
        ...
        if (l3_intf->rpf_valid) {
            ...
            BCM_IF_ERROR_RETURN_MSG(bcm_switch_control_set(unit, bcmSwitchL3UrpfMode, l3_intf->urpf_mode), "");
        }
...
int dnx_utils_l3__egress_only_encap__create(int unit, create_l3_egress_s *l3_egress) {
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_l3_egress_create(unit, BCM_L3_EGRESS_ONLY | l3_egress->allocation_flags, &l3eg, &l3egid_null), "");
...
int dnx_utils_l3__egress_only_fec__create(int unit, create_l3_egress_s *l3_egress) {
    ...
    snprintf(error_msg, sizeof(error_msg), "create egress object, unit=%d", unit);
    BCM_IF_ERROR_RETURN_MSG(bcm_l3_egress_create(unit, BCM_L3_INGRESS_ONLY | l3_egress->allocation_flags, &l3eg, &l3egid), error_msg);
...
int dnx_utils_l3__intf__delete(int unit, int intf)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_l3_intf_delete(unit, l3if), "");
