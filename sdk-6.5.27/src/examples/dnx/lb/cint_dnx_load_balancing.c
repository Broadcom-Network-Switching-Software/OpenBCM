    ...
    int out_port)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(in_port_intf_set(unit, in_port1, intf_in1), "intf_in");
    BCM_IF_ERROR_RETURN_MSG(in_port_intf_set(unit, in_port2, intf_in2), "intf_in");
    /*
     ...
     */
    snprintf(error_msg, sizeof(error_msg), "intf_in %d", intf_in1);
    BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create(unit, intf_in1, intf_in_mac_address), error_msg);
    snprintf(error_msg, sizeof(error_msg), "intf_in %d", intf_in2);
    BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create(unit, intf_in2, src_in_mac_address), error_msg);
    ...
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create(unit, fec, 0, encap_id, gport, 0, fec_flags2),
    ...
    BCM_GPORT_LOCAL_SET(gport, out_port);
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv4(unit, dip, vrf, _l3_itf, 0, 0), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv6(unit, dip_v6, vrf, fec), error_msg);
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv6(unit, sip_v6, vrf, fec), error_msg);
