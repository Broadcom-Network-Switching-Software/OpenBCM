...
cint ../../../../src/examples/dnx/lb/cint_cbts.c 
c
    ...
    int port4)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(get_first_fec_in_range_which_not_in_ecmp_range(unit, 1, 0, &cint_mpls_encapsulation_basic_info.fec_id_enc), "");
    cint_mpls_encapsulation_basic_info.fec_id_fwd = cint_mpls_encapsulation_basic_info.fec_id_enc + 20;

    BCM_IF_ERROR_RETURN_MSG(cint_field_hash_ipt_main(unit), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create(unit, cint_mpls_encapsulation_basic_info.fec_id_enc,
                                     ...
                                     cint_mpls_encapsulation_basic_info.out_port, BCM_L3_2ND_HIERARCHY, fec_flags2),
    ...
    for (i = 0; i < MEMBERS_IN_ECMP_GROUP; i++)
    {
        ...
        BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create(unit, cint_mpls_ecmp_basic_info.fec_ids[i], cint_mpls_encapsulation_basic_info.push_tunnel_id, 0, dest_port, BCM_L3_2ND_HIERARCHY, fec_flags2), "");
    }


    BCM_IF_ERROR_RETURN_MSG(l3__ecmp_create(unit, cint_mpls_ecmp_basic_info.ecmp_intf, 8, cint_mpls_ecmp_basic_info.fec_ids, BCM_L3_WITH_ID |BCM_L3_2ND_HIERARCHY, BCM_L3_ECMP_DYNAMIC_MODE_DISABLED,&ecmp, 0), "");
