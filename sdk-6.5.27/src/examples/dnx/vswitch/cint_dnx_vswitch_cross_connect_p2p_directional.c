...
mpls_tunnels_config(
    ...
    BCM_IF_ERROR_RETURN_MSG(dnx_utils_l3__egress_only_encap__create(unit,&l3eg), "");
...
mpls_port_create_ingress_egress(
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_mpls_port_add(unit, 0, mpls_port), "EGRESS");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_mpls_port_add(unit, 0, mpls_port), "INGRESS");
    ...
    BCM_IF_ERROR_RETURN_MSG(dnx_utils_l3__egress_only_fec__create(unit,&l3eg), "");
...
dnx_vswitch_cross_connect_p2p_directional_run(int unit, int port1, int type1, int port2, int type2) {
    ...
    case 1:
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_vlan_gport_add(unit, vlan, cross_connect_info.port_1, 0), error_msg);
    ...
    case 2:
        /* create mpls port */
        snprintf(error_msg, sizeof(error_msg), "with port %d", cross_connect_info.port_1);
        BCM_IF_ERROR_RETURN_MSG(mpls_port_create_ingress_egress(unit, 
                              cross_connect_info.port_1, 
    ...
    case 1:
        ...
        /** Add the gport to vlan*/
        BCM_IF_ERROR_RETURN_MSG(bcm_vlan_gport_add(unit, vlan, cross_connect_info.port_2, 0), error_msg);
