    ...
    bcm_gport_t gport)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_stat_stif_source_mapping_set(unit, flags, source, stif_logical_port), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_cosq_control_range_set(unit, gport, flags, bcmCosqStatIfQueues , queue_range),
        "with control bcmCosqStatIfQueue");
    /** step 4: set Scrubber queue ranges */
    scrubber_range.range_start = 100;
    scrubber_range.range_end = max_queue/16;
    BCM_IF_ERROR_RETURN_MSG(bcm_cosq_control_range_set(unit, gport, flags, bcmCosqStatIfScrubberQueues , scrubber_range),
        "with control bcmCosqStatIfScrubberQueues");
