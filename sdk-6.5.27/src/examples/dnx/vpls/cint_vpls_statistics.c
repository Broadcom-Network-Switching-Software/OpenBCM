   ...
   int pwe_p)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_stat_pp_config_main(unit, cint_stat_pp_config_info_default, bcmStatCounterInterfaceIngressReceivePp, 0, BCM_CORE_ALL, 0), "");
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(cint_stat_pp_config_crps(unit, cint_stat_pp_config_info_default, bcmStatCounterInterfaceIngressReceivePp, BCM_CORE_ALL), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_stat_pp_create_pp_profile(unit, cint_stat_pp_config_info_default, bcmStatCounterInterfaceIngressReceivePp, &pp_profile, &pp_profile_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_gport_stat_set(unit, pwe_term.mpls_port_id, BCM_CORE_ALL, bcmStatCounterInterfaceIngressReceivePp, stat_info), "");
