    ...
    int *core_port)
{
    ...
    {
        snprintf(error_msg, sizeof(error_msg), "port=%d", core_port[i]);
        BCM_IF_ERROR_RETURN_MSG(bcm_port_class_set(unit, core_port[i], bcmPortClassId, core_port[i]), error_msg);
        printf("core_port=%d, vlan domain =%d\n", core_port[i], core_port[i]);

        BCM_IF_ERROR_RETURN_MSG(in_port_intf_set(unit, cint_vpls_roo_mc_info.core_port[i], cint_vpls_roo_mc_info.core_overlay_eth_rif + i), "intf_in");
        printf("core_port=%d, overlay_eth_rif =%d\n", core_port[i], cint_vpls_roo_mc_info.core_overlay_eth_rif + i);

        BCM_IF_ERROR_RETURN_MSG(out_port_set(unit, cint_vpls_roo_mc_info.core_port[i]), "intf_out");
    }
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(in_port_intf_set(unit, cint_vpls_roo_mc_info.core_port[0], cint_vpls_roo_mc_info.access_eth_rif), "intf_in");
    ...
    {
        snprintf(error_msg, sizeof(error_msg), "port=%d", access_port[i]);
        BCM_IF_ERROR_RETURN_MSG(bcm_port_class_set(unit, access_port[i], bcmPortClassId, access_port[i]), error_msg);
        printf("access_port=%d, vlan domain =%d\n", access_port[i], access_port[i]);
        /*
         * Access port
         */
        BCM_IF_ERROR_RETURN_MSG(in_port_intf_set(unit, cint_vpls_roo_mc_info.access_port[i], (cint_vpls_roo_mc_info.access_eth_rif + i)), "intf_in");
         ...
         */
        BCM_IF_ERROR_RETURN_MSG(out_port_set(unit, cint_vpls_roo_mc_info.access_port[i]), "intf_out");
    }
    ...
    int unit)
{
    ...
    for (i = 0; i < NUM_OF_CORE_PORTS; i++)
    {
        snprintf(error_msg, sizeof(error_msg), "Failed to create VLAN %d", cint_vpls_roo_mc_info.core_native_eth_rif + i);
        BCM_IF_ERROR_RETURN_MSG(bcm_vlan_create(unit, (cint_vpls_roo_mc_info.core_native_eth_rif + i)), error_msg);
        printf("bcm_vlan_create : %d\n", (cint_vpls_roo_mc_info.core_native_eth_rif + i));

        /*
         * create vlan based on the vsi (vpn) 
         */
        snprintf(error_msg, sizeof(error_msg), "Failed to create VLAN %d", cint_vpls_roo_mc_info.core_overlay_eth_rif + i);
        BCM_IF_ERROR_RETURN_MSG(bcm_vlan_create(unit, (cint_vpls_roo_mc_info.core_overlay_eth_rif + i)), error_msg);
    ...
    for (i = 0; i < NUM_OF_ACCESS_PORTS; i++)
    {
        snprintf(error_msg, sizeof(error_msg), "Failed to create VLAN %d", cint_vpls_roo_mc_info.access_eth_rif + i);
        BCM_IF_ERROR_RETURN_MSG(bcm_vlan_create(unit, (cint_vpls_roo_mc_info.access_eth_rif + i)), error_msg);
        printf(" ACCESS bcm_vlan_create : %d\n", (cint_vpls_roo_mc_info.access_eth_rif + i));
    }

    snprintf(error_msg, sizeof(error_msg), "Failed to create VLAN %d", cint_vpls_roo_mc_info.core_native_eth_rif + i);
    BCM_IF_ERROR_RETURN_MSG(bcm_vlan_create(unit, (cint_vpls_roo_mc_info.core_native_eth_rif + 3)), error_msg);
    ...
    int unit)
{
    ...
    for (i = 0; i < NUM_OF_CORE_PORTS; i++)
    {
        ...
        BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create(unit, cint_vpls_roo_mc_info.core_native_eth_rif + i, temp_mac), "");
        ...
        temp_mac[5] = temp_mac[5] + i;
        BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create(unit, cint_vpls_roo_mc_info.core_overlay_eth_rif + i, temp_mac), "pwe_intf");
    ...
    BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create(unit, cint_vpls_roo_mc_info.core_overlay_eth_rif + 2, temp_mac), "pwe_intf");
    ...
    for (i = 0; i < NUM_OF_ACCESS_PORTS; i++)
    {
        ...
        temp_mac[5] = temp_mac[5] + i;
        BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create(unit, cint_vpls_roo_mc_info.access_eth_rif + i, temp_mac), "pwe_intf");
    ...
    temp_mac = cint_vpls_roo_mc_info.access_my_mac;
    temp_mac[5] = temp_mac[5] + 2;
    BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create(unit, cint_vpls_roo_mc_info.access_eth_rif + 2, temp_mac), "pwe_intf");
    printf("intf_eth_rif_create : rif =%d ", cint_vpls_roo_mc_info.access_eth_rif + 2);
    vpls_roo_mc_print_mac(temp_mac);

    temp_mac = cint_vpls_roo_mc_info.core_native_eth_rif_mac;
    temp_mac[5] = temp_mac[5] + 1;
    BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create(unit, cint_vpls_roo_mc_info.core_native_eth_rif + 3, temp_mac), "");
    ...
    int unit)
{
    ...
    for (i = 0; i < NUM_OF_CORE_PORTS; i++)
    {
        ...
        temp_mac[5] = temp_mac[5] + i;
        BCM_IF_ERROR_RETURN_MSG(l3__egress_only_encap__create_inner(unit, 0, &cint_vpls_roo_mc_info.core_native_arp_id[i], temp_mac, cint_vpls_roo_mc_info.core_native_eth_rif + i, BCM_L3_NATIVE_ENCAP, 0),
        ...
        temp_mac[5] = temp_mac[5] + i;
        BCM_IF_ERROR_RETURN_MSG(l3__egress_only_encap__create_inner(unit, 0, &cint_vpls_roo_mc_info.core_overlay_arp_id[i], temp_mac, cint_vpls_roo_mc_info.core_overlay_eth_rif + i, 0, core_arp_flags2),
            "create egress object ARP only");
    ...
    temp_mac = cint_vpls_roo_mc_info.core_native_next_hop_mac;
    temp_mac[5] = temp_mac[5] + 2;
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_encap__create_inner(unit, 0, &cint_vpls_roo_mc_info.core_native_arp_id[2], temp_mac, cint_vpls_roo_mc_info.access_eth_rif, BCM_L3_NATIVE_ENCAP, 0),
        "create egress object ARP only");
    ...
    temp_mac = cint_vpls_roo_mc_info.core_overlay_next_hop_mac;
    temp_mac[5] = temp_mac[5] + 2;
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_encap__create_inner(unit, 0, &cint_vpls_roo_mc_info.core_overlay_arp_id[2], temp_mac, cint_vpls_roo_mc_info.core_overlay_eth_rif + 2, 0, core_arp_flags2),
        "create egress object ARP only");
    ...
    for (i = 0; i < NUM_OF_ACCESS_PORTS; i++)
    {
        ...
        temp_mac[5] = temp_mac[5] + i;
        BCM_IF_ERROR_RETURN_MSG(l3__egress_only_encap__create(unit, 0, &cint_vpls_roo_mc_info.access_arp_id[i], temp_mac, cint_vpls_roo_mc_info.access_eth_rif + i),
            "create egress object ARP only");
    ...
    int unit)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(add_ipv4_ipmc(unit, cint_vpls_roo_mc_info.dip1, cint_vpls_roo_mc_info.dip_mask, cint_vpls_roo_mc_info.sip1,
                       cint_vpls_roo_mc_info.sip_mask, cint_vpls_roo_mc_info.access_eth_rif,
                       cint_vpls_roo_mc_info.access_eth_rif, cint_vpls_roo_mc_info.ipmc_group1, 0, 0), "to LEM table");

    /*
     * Add KAPS entry for tunnel to native flow
     */
    BCM_IF_ERROR_RETURN_MSG(add_ipv4_ipmc(unit, cint_vpls_roo_mc_info.dip2, cint_vpls_roo_mc_info.dip_mask, cint_vpls_roo_mc_info.sip2,
                       cint_vpls_roo_mc_info.sip_mask, (cint_vpls_roo_mc_info.core_native_eth_rif + 3),
                       (cint_vpls_roo_mc_info.core_native_eth_rif + 3), cint_vpls_roo_mc_info.ipmc_group2, 0, 0), "to KAPS table");
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_multicast_create(unit, flags, &cint_vpls_roo_mc_info.ipmc_group1), "");
    ...
    if ((system_headers_mode == 0) && (*dnxc_data_get(unit, "fabric", "general", "blocks_exist", NULL)))
    {
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_fabric_multicast_set(unit, cint_vpls_roo_mc_info.ipmc_group1, 0, nof_cores, mreps), "");
    }
    ...
    for (i = 0; i < NUM_OF_CORE_PORTS; i++)
    {
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_multicast_add(unit, cint_vpls_roo_mc_info.ipmc_group1, flags, 1, &rep_array), "");
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_multicast_encap_extension_create(unit, BCM_MULTICAST_ENCAP_EXTENSION_WITH_ID, &rep_array.encap1, 3, ifs), "");
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_multicast_create(unit, flags, &cint_vpls_roo_mc_info.ipmc_group2), "");
    ...
    for (i = 0; i < NUM_OF_ACCESS_PORTS; i++)
    {
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_multicast_add(unit, cint_vpls_roo_mc_info.ipmc_group2, flags, 1, &rep_array), "");
     ...
     * 0x3fffff);
     * 
     * BCM_IF_ERROR_RETURN_MSG(bcm_multicast_add(unit,cint_vpls_roo_mc_info.ipmc_group2 , BCM_MULTICAST_INGRESS_GROUP, 1, &rep_array), "");
     * 
     */
    ...
    int core_port_2)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(vpls_roo_mc_configure_port_properties(unit, &cint_vpls_roo_mc_info.access_port,
                                               &cint_vpls_roo_mc_info.core_port), "");

    /*
     * create vsi
     */
    BCM_IF_ERROR_RETURN_MSG(vpls_roo_mc_create_eth_rifs(unit), "");

    /*
     * Configure L3 interfaces 
     */
    BCM_IF_ERROR_RETURN_MSG(vpls_roo_mc_create_l3_interfaces(unit), "");

    /*
     * arpid to mac
     */
    BCM_IF_ERROR_RETURN_MSG(vpls_roo_mc_create_arp_entries(unit), "");
    ...
    for (i = 0; i < NUM_OF_CORE_PORTS; i++)
    {
         ...
         */
        BCM_IF_ERROR_RETURN_MSG(vpls_roo_mc_create_mpls_tunnel(unit,
    ...
    BCM_IF_ERROR_RETURN_MSG(vpls_roo_mc_mpls_port_add_encapsulation(unit), "");

    /*
     * insert LEM and KAPS entries for fwd lookup
     */
    BCM_IF_ERROR_RETURN_MSG(vpls_roo_mc_fwd_lookup_entires_create(unit), "");

    /*
     * create IPMC group for native to tunnel flow
     */
    BCM_IF_ERROR_RETURN_MSG(vpls_roo_mc_create_ipmc_group1(unit), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(vpls_roo_mc_create_termination_stack(unit, label_array, 2), "");

    /*
     * configure PWE tunnel - ingress flow 
     */
    BCM_IF_ERROR_RETURN_MSG(vpls_roo_mc_mpls_port_add_termination(unit, cint_vpls_roo_mc_info.core_native_eth_rif + 3), "");

    /*
     * create IPMC group for native to tunnel flow
     */
    BCM_IF_ERROR_RETURN_MSG(vpls_roo_mc_create_ipmc_group2(unit), "");
