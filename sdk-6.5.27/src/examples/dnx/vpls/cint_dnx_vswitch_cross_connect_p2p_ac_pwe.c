    ...
    vswitch_cross_connect_p2p_ac_pwe_s * param)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(get_first_fec_in_range_which_not_in_ecmp_range(unit, 0, 0, &cint_pwe_basic_info.mpls_encap_fec_id), "");
    ...
    vswitch_cross_connect_p2p_ac_pwe_s * param)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(vswitch_cross_connect_p2p_ac_pwe_init(unit, param), "");
    ...
    for (i = 0; i < NUM_OF_PORTS; i++)
    {
        ...
        snprintf(error_msg, sizeof(error_msg), "(port = %d)", g_vswitch_cross_connect_p2p_ac_pwe.ports[i]);
        BCM_IF_ERROR_RETURN_MSG(bcm_port_class_set(unit, g_vswitch_cross_connect_p2p_ac_pwe.ports[i], bcmPortClassId,
                                g_vswitch_cross_connect_p2p_ac_pwe.ports[i]), error_msg);
    }
    ...
    snprintf(error_msg, sizeof(error_msg), "(port = %d)", g_vswitch_cross_connect_p2p_ac_pwe.ports[PORT1_INDEX]);
    BCM_IF_ERROR_RETURN_MSG(bcm_vlan_gport_add(unit, g_vswitch_cross_connect_p2p_ac_pwe.vid[LIF_1_INDEX],
        g_vswitch_cross_connect_p2p_ac_pwe.ports[PORT1_INDEX], BCM_VLAN_GPORT_ADD_INGRESS_ONLY), error_msg);
    ...
    snprintf(error_msg, sizeof(error_msg), "(port = %d)", g_vswitch_cross_connect_p2p_ac_pwe.ports[PORT2_INDEX]);
    BCM_IF_ERROR_RETURN_MSG(bcm_vlan_gport_add(unit, g_vswitch_cross_connect_p2p_ac_pwe.vid[LIF_2_INDEX],
        g_vswitch_cross_connect_p2p_ac_pwe.ports[PORT2_INDEX], BCM_VLAN_GPORT_ADD_INGRESS_ONLY), error_msg);
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(in_port_intf_set(unit, g_vswitch_cross_connect_p2p_ac_pwe.ports[PORT1_INDEX], g_vswitch_cross_connect_p2p_ac_pwe.vid[LIF_1_INDEX]),
        "intf_in");
    /*
     * Set In-Port to In ETh-RIF
     */
    BCM_IF_ERROR_RETURN_MSG(in_port_intf_set(unit, g_vswitch_cross_connect_p2p_ac_pwe.ports[PORT2_INDEX], g_vswitch_cross_connect_p2p_ac_pwe.vid[LIF_2_INDEX]), "intf_in");
    /*
     * Creates LIF-3:
     * PWE, P2P
     */
    snprintf(error_msg, sizeof(error_msg), "(port = %d)", g_vswitch_cross_connect_p2p_ac_pwe.ports[PORT3_INDEX]);
    BCM_IF_ERROR_RETURN_MSG(pwe_basic_main(unit, g_vswitch_cross_connect_p2p_ac_pwe.ports[PORT3_INDEX]), error_msg);
    ...
    snprintf(error_msg, sizeof(error_msg), "(port = %d)", g_vswitch_cross_connect_p2p_ac_pwe.ports[PORT4_INDEX]);
    BCM_IF_ERROR_RETURN_MSG(pwe_basic_main(unit, g_vswitch_cross_connect_p2p_ac_pwe.ports[PORT4_INDEX]), error_msg);
    ...
    */
    ...
    snprintf(error_msg, sizeof(error_msg), "(flags = %d, gport = %d)",
