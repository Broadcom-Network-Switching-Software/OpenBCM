    ...
    int scenario)
{
    ...
    switch (scenario)
    {
        case 0:
            ...
            BCM_IF_ERROR_RETURN_MSG(bcm_switch_network_group_config_set(unit,pwe_term.pwe_nwk_group_id,
                                                     &config), "");


            config.dest_network_group_id = pwe_encap.pwe_nwk_group_id;

            BCM_IF_ERROR_RETURN_MSG(bcm_switch_network_group_config_set(unit, ac_port.ac_nwk_group_id,
                                                     &config), "");
...
vpls_split_horizon_inherit_pwe_nwk_group_to_native_ac(int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_port_match_add(unit,default_native_ac.vlan_port_id,&match_info), "");
    return BCM_E_NONE;
}
    ...
    int pwe_nwk_group_id)
{
    ...
    vpls_split_horizon_init(ac_nwk_group_id,pwe_nwk_group_id);
    ...
    BCM_IF_ERROR_RETURN_MSG(vpls_main(unit, ac_port,pwe_port), "");
	...
	{
        BCM_IF_ERROR_RETURN_MSG(vpls_split_horizon_inherit_pwe_nwk_group_to_native_ac(unit), "");
    }
