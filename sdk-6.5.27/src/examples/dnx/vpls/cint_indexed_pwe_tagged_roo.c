 ...
 * 
 ...
 Copyright 2007-2022 Broadcom Inc. All rights reserved. File: cint_indexed_pwe_tagged_roo.c Purpose: test indexed VPLS with ROO
 */
    ...
    int port2)
{
    ...
    mpls_util_entity[1].arps[0].intf = &mpls_util_entity[0].rifs[0].intf;
    /***************************************/
    /* encapsulation entry */    
    ...
    */
    ...
    vpls_util_entity[1].tpids[0].class_id = (*dnxc_data_get(unit, "port", "general", "ingress_vlan_domain_size", NULL) > 9) ? 0x7e3 : 508;
    ...
    int port2)
{
    ...
    {
        BCM_IF_ERROR_RETURN_MSG(indexed_pwe_tagged_roo_params_init(unit, port1, port2), "");
    }
    ...
    BCM_IF_ERROR_RETURN_MSG(vpls_util_advanced_main(unit, 0, 0), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(indexed_pwe_tagged_roo_l3_forwarding(unit, l3_routes, INDEXED_PWE_TAGGED_ROO_MAX_NOF_L3_ROUTE), "");
