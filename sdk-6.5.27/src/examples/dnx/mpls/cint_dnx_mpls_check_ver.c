 ...
 * Test Scenario - start
       cd ../../../../src
       cint examples/dnx/utility/cint_dnx_utils_global.c
       cint examples/dnx/l3/cint_dnx_ip_route_basic.c
       cint examples/dnx/utility/cint_dnx_utility_mpls.c
       cint examples/dnx/utility/cint_dnx_utils_l3.c
       cint examples/dnx/utility/cint_dnx_utils_vpls.c
       cint examples/dnx/mpls/cint_dnx_mpls_check_ver.c
       cint
       print mpls_check_ver_example(0, 200, 201);
 * Test Scenario - end
 * 
    ...
    int out_port)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(in_port_intf_set(unit, in_port, cint_mpls_check_ver_info.in_rif), "intf_in");

    BCM_IF_ERROR_RETURN_MSG(in_port_intf_set(unit, out_port, cint_mpls_check_ver_info.in_rif), "intf_in");
    ...
    int unit)
{
    ...
    for (tunnel_num = 0; tunnel_num < 4; tunnel_num++) {
        ...
        BCM_IF_ERROR_RETURN_MSG(mpls_create_initiator_tunnels(unit, mpls_encap_tunnel, tunnel_num+1), "");
    ...
    int unit)
{
     ...
     * for case 13,15
     */
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv4(unit, cint_mpls_check_ver_info.dip_routing_after_termination, cint_mpls_check_ver_info.vrf, cint_mpls_check_ver_info.routing_to_rif_fec_id, 0, 0), "");

    /** step 6:routing into tunnel
     * for case 11,14
     */
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv4(unit, cint_mpls_check_ver_info.dip_routing_into_tunnel, cint_mpls_check_ver_info.vrf, cint_mpls_check_ver_info.common_tunnel_fec_id, 0, 0), "");

    /** step 7:routing into tunnel with eli
     * for case 16
     */
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv4(unit, cint_mpls_check_ver_info.dip_routing_with_el, cint_mpls_check_ver_info.vrf, cint_mpls_check_ver_info.tunnel_with_eli_fec_id, 0, 0), "");
    ...
    int out_port)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(mpls_check_ver_l3_intf_configuration(unit,in_port,out_port), "");

    BCM_IF_ERROR_RETURN_MSG(mpls_check_ver_arp_configuration(unit), "");

    BCM_IF_ERROR_RETURN_MSG(mpls_check_ver_mpls_tunnel_configuration(unit), "");

    BCM_IF_ERROR_RETURN_MSG(mpls_check_ver_fec_entry_configuration(unit,out_port), "");

    BCM_IF_ERROR_RETURN_MSG(mpls_check_ver_forward_entry_configuration(unit), "");

    BCM_IF_ERROR_RETURN_MSG(mpls_check_ver_mpls_termination_stack_configuration(unit), "");
