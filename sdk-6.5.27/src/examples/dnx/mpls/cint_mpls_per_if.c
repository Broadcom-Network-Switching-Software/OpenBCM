    ...
    int out_port)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(get_first_fec_in_range_which_not_in_ecmp_range(unit, 0, 0, &cint_mpls_per_if_basic_info.ipv4_info.fec_id), "");
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(mpls_per_if_configure_port_properties(unit, in_port, out_port), "");

    /*
     * Create ingress interfaces
     */
    BCM_IF_ERROR_RETURN_MSG(mpls_per_if_l3_ingr_interfaces_create(unit), "");

    /*
     * Create out RIF + ARP for all flows
     */
    BCM_IF_ERROR_RETURN_MSG(mpls_per_if_out_rif_arp_create(unit), "");

    /*
     * Create terminated IP tunnel
     */
    BCM_IF_ERROR_RETURN_MSG(mpls_per_if_udp_terminator_create(unit), "");

    /*
     * Setup IP forwarding
     */
    BCM_IF_ERROR_RETURN_MSG(mpls_per_if_ipv4_forwarding_add(unit), "");
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(mpls_per_if_termination_create(unit), "");

    /*
     * Setup label switching for the processed label
     */
    BCM_IF_ERROR_RETURN_MSG(mpls_per_if_lsr_set(unit), "");
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(mpls_per_if_udp_tunnel_terminator_create(unit, &cint_mpls_per_if_basic_info.ipv4_tunnel_1), "1");

    BCM_IF_ERROR_RETURN_MSG(mpls_per_if_udp_tunnel_terminator_create(unit, &cint_mpls_per_if_basic_info.ipv4_tunnel_2), "2");
    ...
    int out_port)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(mpls_per_if_in_port_intf_set(unit, &cint_mpls_per_if_basic_info.eth_in_rif_1), "eth_in_rif_1");
    BCM_IF_ERROR_RETURN_MSG(bcm_vlan_gport_add(unit, cint_mpls_per_if_basic_info.eth_in_rif_1.vid, cint_mpls_per_if_basic_info.in_port, 0), "");

    /*
     * Set In-Port to In ETh-RIF-2
     */
    BCM_IF_ERROR_RETURN_MSG(mpls_per_if_in_port_intf_set(unit, &cint_mpls_per_if_basic_info.eth_in_rif_2), "eth_in_rif_2");
    BCM_IF_ERROR_RETURN_MSG(bcm_vlan_gport_add(unit, cint_mpls_per_if_basic_info.eth_in_rif_2.vid, cint_mpls_per_if_basic_info.in_port, 0), "");

    /*
     * Set In-Port to In ETh-RIF-3
     */
    BCM_IF_ERROR_RETURN_MSG(mpls_per_if_in_port_intf_set(unit, &cint_mpls_per_if_basic_info.eth_in_rif_3), "eth_in_rif_3");
    BCM_IF_ERROR_RETURN_MSG(bcm_vlan_gport_add(unit, cint_mpls_per_if_basic_info.eth_in_rif_3.vid, cint_mpls_per_if_basic_info.in_port, 0), "");

    /*
     * Set Out-Port default properties
     */
    BCM_IF_ERROR_RETURN_MSG(out_port_set(unit, cint_mpls_per_if_basic_info.out_port), "");
    ...
    int unit)
{
     ...
     * ETH1
     */
    BCM_IF_ERROR_RETURN_MSG(mpls_per_if_eth_in_rif_create(unit, BCM_L3_INGRESS_MPLS_INTF_NAMESPACE,
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(mpls_per_if_eth_in_rif_create(unit, 0,
     ...
     * LBL2
     */
    BCM_IF_ERROR_RETURN_MSG(mpls_per_if_term_label_create(unit, BCM_L3_INGRESS_MPLS_INTF_NAMESPACE,
    ...
    bcm_mac_t mac)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create(unit, intf, mac), "");
    ...
    int unit)
{
     ...
     * Setup out-RIF
     */
    BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create(unit, cint_mpls_per_if_basic_info.out_rif_info.intf,
                             cint_mpls_per_if_basic_info.out_rif_info.my_mac_out), "");

    /*
     * Configure ARP entry
     */
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_encap__create(unit, 0, &(cint_mpls_per_if_basic_info.out_rif_info.arp_id),
    ...
    int unit)
{
     ...
     * 4) Give the out port.
     */
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create(unit, cint_mpls_per_if_basic_info.ipv4_info.fec_id,
                                     cint_mpls_per_if_basic_info.out_rif_info.intf,
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv4(unit, cint_mpls_per_if_basic_info.ipv4_info.dip, cint_mpls_per_if_basic_info.vrf, cint_mpls_per_if_basic_info.ipv4_info.fec_id, 0        /* arp 
                                                                                                                                                                 * id 
                                                                                                                                                                 */ , 0), "");
    ...
    int unit)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(mpls_per_if_processed_label_termination_create(unit, cint_mpls_per_if_basic_info.eth_in_rif_1.intf), "");
    /*
     * Create termination of processed label in the context of LBL2
     */
    BCM_IF_ERROR_RETURN_MSG(mpls_per_if_processed_label_termination_create(unit, cint_mpls_per_if_basic_info.term_label_2.intf), "");
    /*
     * Create termination of processed label in the context of IPv4_tunnel_1
     */
    BCM_IF_ERROR_RETURN_MSG(mpls_per_if_processed_label_termination_create(unit, cint_mpls_per_if_basic_info.ipv4_tunnel_1.intf), "");
    ...
    int unit)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(mpls_per_if_swap_label_info_create(unit), "");

    /*
     * Create fwd of processed label in the context of ETH2
     */
    BCM_IF_ERROR_RETURN_MSG(mpls_per_if_processed_label_switch_create(unit, cint_mpls_per_if_basic_info.eth_in_rif_2.intf), "rif_2");
    /*
     * Create fwd of processed label in the context of LBL3
     */
    BCM_IF_ERROR_RETURN_MSG(mpls_per_if_processed_label_switch_create(unit, cint_mpls_per_if_basic_info.term_label_3.intf), "label_3");
    /*
     * Create fwd of processed label in the context of IPv4_tunnel_2
     */
    BCM_IF_ERROR_RETURN_MSG(mpls_per_if_processed_label_switch_create(unit, cint_mpls_per_if_basic_info.ipv4_tunnel_2.intf), "label_3");
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_mpls_tunnel_initiator_create(unit, 0 /* intf, must be 0 */ , 1, &eg_label), "");
     ...
     * 4) Give the out port.
     */
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create(unit, cint_mpls_per_if_basic_info.mpls_swap_info.fec_id,
