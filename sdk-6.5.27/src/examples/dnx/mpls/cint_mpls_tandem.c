 ...
 * 
 ...
 Copyright 2007-2022 Broadcom Inc. All rights reserved. File: cint_mpls_tandem.c Purpose: utility for MPLS TANDEM over VPLS. 
 */
    ...
    int special_label)
{
    ...
    {
        mpls_encap_tunnel[0].num_labels = nof_tandem + nof_mpls;
        mpls_encap_tunnel[0].label[1] = 0x4444;
        mpls_encap_tunnel[0].data_label[0] = 0x5656;
        mpls_encap_tunnel[0].data_label[1] = 0x4545;
    }
