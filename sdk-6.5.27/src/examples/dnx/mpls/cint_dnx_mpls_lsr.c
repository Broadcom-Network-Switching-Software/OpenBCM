    ...
    int out_sys_port)
{
    ...
    if (!BCM_GPORT_IS_TRUNK(in_sys_port)) {
        BCM_IF_ERROR_RETURN_MSG(bcm_port_local_get(ingress_unit, in_sys_port, &cint_mpls_lsr_info.in_local_port),
            "in local port");

        BCM_IF_ERROR_RETURN_MSG(bcm_port_local_get(egress_unit, out_sys_port, &cint_mpls_lsr_info.out_local_port),
            "out local port");
    } else {
    ...
    int out_sys_port)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(out_port_set(unit, out_sys_port), "");
    ...
    int enable)
{
    ...
    snprintf(error_msg, sizeof(error_msg), "port:%d", in_port);
    BCM_IF_ERROR_RETURN_MSG(bcm_switch_control_port_set(unit, in_port, bcmSwitchPortHeaderType, header_type), error_msg);

    snprintf(error_msg, sizeof(error_msg), "port:%d", out_port);
    BCM_IF_ERROR_RETURN_MSG(bcm_switch_control_port_set(unit, out_port, bcmSwitchPortHeaderType, header_type), error_msg);
    ...
    int rif)
{
    ...
    */
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_l3_ingress_get(unit, rif, l3_ing_if), "");

    l3_ing_if.flags = l3_ing_if.flags | BCM_L3_INGRESS_WITH_ID |BCM_L3_INGRESS_MPLS_INTF_NAMESPACE;
    BCM_IF_ERROR_RETURN_MSG(bcm_l3_ingress_create(unit,l3_ing_if, rif), "");
    ...
    int term_label)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(intf_ingress_rif_set(unit, &ingress_itf), "");
    ...
    int out_sys_port)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(dnx_mpls_lsr_init(ingress_unit,egress_unit,in_sys_port,out_sys_port), "");

    /*
     * step 1.ingress L2/L3 configuration(Port,In-RIF)
     */
    BCM_IF_ERROR_RETURN_MSG(bcm_vlan_create(ingress_unit,cint_mpls_lsr_info.in_rif), "");

    BCM_IF_ERROR_RETURN_MSG(mpls_lsr_ingress_port_configuration(ingress_unit,in_sys_port,cint_mpls_lsr_info.in_rif), "");

    BCM_IF_ERROR_RETURN_MSG(mpls_lsr_l3_intf_configuration(ingress_unit,in_sys_port), "");
    printf("0\n");

    /*
     * step 2. ingress FEC configuration
     */
    BCM_IF_ERROR_RETURN_MSG(mpls_lsr_fec_for_arp_configuration(ingress_unit,out_sys_port), "");

    /*
     * step 3. egress L2/L3 configuration(Port, Out-RIF, ARP)
     */
    BCM_IF_ERROR_RETURN_MSG(mpls_lsr_egress_port_configuration(egress_unit,out_sys_port), "");

    BCM_IF_ERROR_RETURN_MSG(mpls_lsr_l3_intf_configuration(egress_unit,cint_mpls_lsr_info.out_local_port), "");

    BCM_IF_ERROR_RETURN_MSG(mpls_lsr_arp_configuration(egress_unit,cint_mpls_lsr_info.out_local_port), "");
    ...
    int out_sys_port)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(mpls_lsr_l2_l3_configuration(ingress_unit,egress_unit, in_sys_port,out_sys_port), "");

    /*
     * step 2. ingress FWD configuration
     */
    BCM_IF_ERROR_RETURN_MSG(mpls_lsr_forward_entry_configuration(ingress_unit,in_sys_port, out_sys_port), "");
    ...
    int out_port)
{
    ...
    if (cint_mpls_lsr_info.is_ingress_mpls_raw && cint_mpls_lsr_info.is_egress_mpls_raw)
    {
         ...
         */
        BCM_IF_ERROR_RETURN_MSG(dnx_mpls_lsr_init(unit, unit, in_port, out_port), "");
    }
    else
    {
        /*
         ...
         */
        BCM_IF_ERROR_RETURN_MSG(mpls_lsr_l2_l3_configuration(unit, unit, in_port,out_port), "");
    }

    /*
     * step 2. ingress FWD configuration
     */
    BCM_IF_ERROR_RETURN_MSG(mpls_lsr_forward_entry_configuration(unit,in_port, out_port), "");
    ...
    {
        BCM_IF_ERROR_RETURN_MSG(mpls_raw_port_setting(unit, in_port, out_port, 1), "");
    }
    ...
    int out_sys_port)
{
     ...
     * step 1.ingress L2/L3 configuration(Port,In-RIF)
     */
    snprintf(error_msg, sizeof(error_msg), "vlan=%d", cint_mpls_lsr_info.in_rif);
    BCM_IF_ERROR_RETURN_MSG(mpls_lsr_ingress_port_configuration(ingress_unit, in_sys_port,cint_mpls_lsr_info.in_rif), error_msg);
    ...
    {
        snprintf(error_msg, sizeof(error_msg), "with vlan %d continue", cint_mpls_lsr_info.out_rif);
        BCM_IF_ERROR_RETURN_MSG(bcm_vlan_create(egress_unit, cint_mpls_lsr_info.out_rif), error_msg);
    }
    /* add port to vlan  */
    snprintf(error_msg, sizeof(error_msg), "vlan=%d", cint_mpls_lsr_info.out_rif);
    BCM_IF_ERROR_RETURN_MSG(bcm_vlan_gport_add(egress_unit, cint_mpls_lsr_info.out_rif, out_sys_port, BCM_VLAN_GPORT_ADD_EGRESS_ONLY), error_msg);
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(mpls_lsr_forward_entry_configuration_with_context(ingress_unit,out_sys_port,cint_mpls_lsr_info.in_rif), "");
    ...
    int out_sys_port)
{
     ...
     * step 2. ingress FWD configuration
     */
    BCM_IF_ERROR_RETURN_MSG(mpls_lsr_ilm_php_entry_create(ingress_unit,out_sys_port), "");
    ...
    int out_sys_port)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(mpls_lsr_eedb_php_entry_create(egress_unit,0), "");

    /*
     * step 3: update FEC point to tunnel
     */
    BCM_IF_ERROR_RETURN_MSG(mpls_lsr_l3_egress_fec_replace(ingress_unit, out_sys_port), "");
    ...
    entry.label = cint_mpls_lsr_info.incoming_label[1];
    entry.egress_if = cint_mpls_lsr_info.fec_id_for_arp;
    BCM_IF_ERROR_RETURN_MSG(bcm_mpls_tunnel_switch_create(ingress_unit, &entry), "");
    ...
    int with_entropy)
{
     ...
     */
    if (with_entropy > 2) {
        BCM_IF_ERROR_RETURN_MSG(mpls_lsr_2_encap_entries_create(egress_unit,2,tunnel_force_flags), "");
    } else {
        BCM_IF_ERROR_RETURN_MSG(mpls_lsr_encap_entry_create(egress_unit,2,tunnel_force_flags), "");
    }
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv4(ingress_unit, cint_mpls_lsr_info.dip_into_tunnel, cint_mpls_lsr_info.vrf, cint_mpls_lsr_info.fec_id_for_arp, 0, 0), "");

    /*
     * step 5: push over IPv6
     */
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv6(ingress_unit, cint_mpls_lsr_info.dip_into_tunnel_ipv6, cint_mpls_lsr_info.vrf, cint_mpls_lsr_info.fec_id_for_arp), "");
    ...
    int out_sys_port)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(dnx_qos_map_l3_ingress_profile(ingress_unit), "");

    /*
     * step 2: egress mpls qos remarking and marking
     */
    BCM_IF_ERROR_RETURN_MSG(dnx_qos_map_mpls_egress_profile(egress_unit), "");

    /*
     * step 3: ip route to tunnel
     */
    BCM_IF_ERROR_RETURN_MSG(multi_dev_mpls_ip_route_tunnel_example(ingress_unit, egress_unit,in_sys_port,out_sys_port,0), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_l3_ingress_get(ingress_unit, cint_mpls_lsr_info.in_rif, &l3i), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_l3_ingress_create(ingress_unit, l3i, cint_mpls_lsr_info.in_rif), "");
    ...
    bcm_l3_egress_t_init(&l3eg);
    BCM_IF_ERROR_RETURN_MSG(bcm_l3_egress_get(egress_unit, cint_mpls_lsr_info.arp_encap_id, &l3eg), "");

    l3eg.qos_map_id = mpls_eg_map_id;
    l3eg.encap_id = cint_mpls_lsr_info.arp_encap_id;

    BCM_IF_ERROR_RETURN_MSG(bcm_l3_egress_create(egress_unit, flags, &l3eg, &l3egid_null), "");
    return BCM_E_NONE;
}
    ...
    int out_sys_port)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(mpls_lsr_ilm_p2mp_entry_create(ingress_unit,cint_mpls_lsr_info.incoming_label[2],cint_mpls_lsr_info.outgoing_label[1]), "");

    /*
     * step 3. Create multicast group
     */
    BCM_IF_ERROR_RETURN_MSG(multicast__open_mc_group(ingress_unit, &cint_mpls_lsr_info.mc_group, 0), "");
    ...
    BCM_L3_ITF_SET(cint_mpls_lsr_info.egr_mpls_tunnel_encap_id,BCM_L3_ITF_TYPE_LIF, 0x6001);
    BCM_IF_ERROR_RETURN_MSG(mpls_lsr_encap_entry_create(egress_unit, 1, 0), "");

    /* Add tunnel to multicast group */
    BCM_IF_ERROR_RETURN_MSG(multicast__add_multicast_entry(ingress_unit, cint_mpls_lsr_info.mc_group, &out_sys_port, &(cint_mpls_lsr_info.egr_mpls_tunnel_encap_id& 0x3fffff), 1, 0),
        "for tunnel");

    /* 2nd tunnel, push 2 labels */
    BCM_L3_ITF_SET(cint_mpls_lsr_info.egr_mpls_tunnel_encap_id,BCM_L3_ITF_TYPE_LIF, 0x6002);
    BCM_IF_ERROR_RETURN_MSG(mpls_lsr_encap_entry_create(egress_unit, 2, 0), "");
    ...
    int out_sys_port)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv4(ingress_unit, cint_mpls_lsr_info.dip_into_tunnel+1, cint_mpls_lsr_info.vrf, cint_mpls_lsr_info.fec_id_for_arp, 0, 0), "");
...
multi_dev_mpls_ip_route_tunnel_qos_clean (
    ...
    int egress_unit)
{
    BCM_IF_ERROR_RETURN_MSG(bcm_qos_map_destroy(ingress_unit, l3_in_map_id), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_qos_map_destroy(ingress_unit, l3_qos_in_internal_map_id_phb), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_qos_map_destroy(ingress_unit, l3_qos_in_internal_map_id_remark), "");

    BCM_IF_ERROR_RETURN_MSG(bcm_qos_map_destroy(egress_unit, mpls_qos_eg_internal_map_id), "");
    BCM_IF_ERROR_RETURN_MSG(bcm_qos_map_destroy(egress_unit, mpls_eg_map_id), "");
