 ...
 * Test Scenario - start
  ...
  cint ../../../../src/examples/dnx/crps/cint_crps_etpp_config.c
  cint ../../../../src/examples/dnx/stat_pp/cint_stat_pp_mpls_egress.c
  cint
    ...
    int port2)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_stat_pp_config_main(unit, etps_1_statistics_config, interface_type, gport, BCM_CORE_ALL, is_lif),
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_stat_pp_config_main(unit, etps_2_statistics_config, interface_type, gport, BCM_CORE_ALL, is_lif),
        "failed for etps_2_statistics_config");
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_stat_pp_config_main(unit, etps_3_statistics_config, interface_type, gport, BCM_CORE_ALL, is_lif),
        "failed for etps_3_statistics_config");
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_stat_pp_config_main(unit, etps_4_statistics_config, interface_type, gport, BCM_CORE_ALL, is_lif),
        "failed for etps_4_statistics_config");
    ...
    int port2)
{
    ...
    BCM_L3_ITF_LIF_TO_GPORT_TUNNEL(gport, mpls_util_entity[0].mpls_encap_tunnel[0].tunnel_id);
    BCM_IF_ERROR_RETURN_MSG(cint_stat_pp_config_main(unit, mpls_php_statistics_config, interface_type, gport, BCM_CORE_ALL, is_lif),
        "failed for etps_1_statistics_config");
