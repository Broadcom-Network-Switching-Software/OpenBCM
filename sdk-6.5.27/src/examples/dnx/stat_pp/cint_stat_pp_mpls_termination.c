    ...
    int port2)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(get_first_fec_in_range_which_not_in_ecmp_range(unit, 0, 0, &cint_stat_pp_mpls_4_labels_term_info.fec_id), "");

    /** Counfigure statistics */
    BCM_IF_ERROR_RETURN_MSG(cint_stat_pp_config_main(unit, tunnel_1_statistics_config, bcmStatCounterInterfaceIngressReceivePp, 0, BCM_CORE_ALL, 0),
        "failed for tunnel_1_statistics_config");

    BCM_IF_ERROR_RETURN_MSG(cint_stat_pp_config_main(unit, tunnel_2_statistics_config, bcmStatCounterInterfaceIngressReceivePp, 0, BCM_CORE_ALL, 0),
        "failed for tunnel_2_statistics_config");

    BCM_IF_ERROR_RETURN_MSG(cint_stat_pp_config_main(unit, tunnel_3_statistics_config, bcmStatCounterInterfaceIngressReceivePp, 0, BCM_CORE_ALL, 0),
        "failed for tunnel_3_statistics_config");

    BCM_IF_ERROR_RETURN_MSG(cint_stat_pp_config_main(unit, tunnel_4_statistics_config, bcmStatCounterInterfaceIngressReceivePp, 0, BCM_CORE_ALL, 0),
        "failed for tunnel_4_statistics_config");
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(in_port_intf_set(unit, cint_stat_pp_mpls_4_labels_term_info.in_port, cint_stat_pp_mpls_4_labels_term_info.intf_in), "intf_in");

    /*
     * Set Out-Port default properties
     */
    BCM_IF_ERROR_RETURN_MSG(out_port_set(unit, cint_stat_pp_mpls_4_labels_term_info.out_port), "intf_out");

    /*
     * Create ETH-RIF and set its properties
     */
    BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create(unit, cint_stat_pp_mpls_4_labels_term_info.intf_in,
                             cint_stat_pp_mpls_4_labels_term_info.intf_in_mac_address), "intf_in");

    BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create(unit, cint_stat_pp_mpls_4_labels_term_info.intf_out,
                             cint_stat_pp_mpls_4_labels_term_info.intf_out_mac_address), "intf_out");


    /*
     * Configure ARP entry
     */
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_encap__create(unit, 0, &(cint_stat_pp_mpls_4_labels_term_info.arp_id),
                                       cint_stat_pp_mpls_4_labels_term_info.arp_next_hop_mac,
                                       cint_stat_pp_mpls_4_labels_term_info.intf_out), "create egress object ARP only");

    /*
     * Configure a fec entry
     */
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_fec__create(unit, cint_stat_pp_mpls_4_labels_term_info.fec_id,
                                     cint_stat_pp_mpls_4_labels_term_info.intf_out, cint_stat_pp_mpls_4_labels_term_info.arp_id,
                                     cint_stat_pp_mpls_4_labels_term_info.out_port, 0, 0), "create egress object FEC only");
    ...
    {
        BCM_IF_ERROR_RETURN_MSG(cint_stat_pp_mpls_4_labels_term_build_termination_stack(unit, cint_stat_pp_mpls_4_labels_term_info.termination_stack[i], &cint_stat_pp_mpls_4_labels_term_info.tunnel_ids[i]), "");
    }
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_gport_stat_set(unit, cint_stat_pp_mpls_4_labels_term_info.tunnel_ids[0], BCM_CORE_ALL, bcmStatCounterInterfaceIngressReceivePp, stat_info), "tunnel_1");

    stat_info.stat_pp_profile = tunnel_2_statistics_config.pp_profile;
    stat_info.stat_id = tunnel_2_statistics_config.stat_id;
    BCM_IF_ERROR_RETURN_MSG(bcm_gport_stat_set(unit, cint_stat_pp_mpls_4_labels_term_info.tunnel_ids[1], BCM_CORE_ALL, bcmStatCounterInterfaceIngressReceivePp, stat_info), "tunnel_2");

    stat_info.stat_pp_profile = tunnel_3_statistics_config.pp_profile;
    stat_info.stat_id = tunnel_3_statistics_config.stat_id;
    BCM_IF_ERROR_RETURN_MSG(bcm_gport_stat_set(unit, cint_stat_pp_mpls_4_labels_term_info.tunnel_ids[2], BCM_CORE_ALL, bcmStatCounterInterfaceIngressReceivePp, stat_info), "tunnel_3");

    stat_info.stat_pp_profile = tunnel_4_statistics_config.pp_profile;
    stat_info.stat_id = tunnel_4_statistics_config.stat_id;
    BCM_IF_ERROR_RETURN_MSG(bcm_gport_stat_set(unit, cint_stat_pp_mpls_4_labels_term_info.tunnel_ids[3], BCM_CORE_ALL, bcmStatCounterInterfaceIngressReceivePp, stat_info), "tunnel_4");

    /*
     * Create a l3 forwarding entry
     */
    BCM_IF_ERROR_RETURN_MSG(add_host_ipv4(unit, cint_stat_pp_mpls_4_labels_term_info.dip, cint_stat_pp_mpls_4_labels_term_info.vrf, cint_stat_pp_mpls_4_labels_term_info.fec_id,
        0 /* arp
           * id */ , 0), "");
