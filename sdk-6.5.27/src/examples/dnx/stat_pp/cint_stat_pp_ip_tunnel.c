 ...
 * 
 ...
 Copyright 2007-2022 Broadcom Inc. All rights reserved. File: cint_stat_pp_ip_tunnel.c Purpose: Statistics examples for SDK ingress APIs using ip tunnel.
 */
 ...
 * Test Scenario - start
  ...
  cint ../../../../src/examples/dnx/utility/cint_dnx_utils_pwe.c
  cint ../../../../src/examples/dnx/utility/cint_dnx_utils_global.c
  ...
  cint ../../../../src/examples/dnx/tunnel/cint_dnx_ip_tunnel_term_basic.c
  cint ../../../../src/examples/dnx/tunnel/cint_dnx_ip_tunnel_encap_basic.c
  cint
 * 1. IPV4 tunnel term
   ...
   int outP)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_stat_pp_config_main(unit, ipv4_tunnel_inlif_statistics_properties, bcmStatCounterInterfaceIngressReceivePp, 0, BCM_CORE_ALL, 0),
        "failed for ipv4_tunnel_inlif_statistics_properties");

    /** A GRE4oIPv4 tunnel header is being terminated */
    BCM_IF_ERROR_RETURN_MSG(ip_tunnel_term_basic(unit, inP, outP), "");
    ...
    print stat_info;
    BCM_IF_ERROR_RETURN_MSG(bcm_gport_stat_set(unit, cint_ip_tunnel_basic_info.tunnel_id, BCM_CORE_ALL, bcmStatCounterInterfaceIngressReceivePp, stat_info), "in IRPP");
   ...
   int outP)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_stat_pp_config_main(unit, ipv4_tunnel_outlif_statistics_properties, interface_type, 0, BCM_CORE_ALL, 0),
        "failed for ipv4_tunnel_outlif_statistics_properties");

    /** A GRE4oIPv4 tunnel header is being encapsulated */
    BCM_IF_ERROR_RETURN_MSG(ip_tunnel_encap_basic(unit, inP, outP), "");

    /** configure statistics on the ipv4 tunnel outlif, now that the gport is encoded */
    BCM_GPORT_TUNNEL_ID_SET(gport, cint_ip_tunnel_basic_info.g_tunnel_id);
    ...
    print stat_info;
    BCM_IF_ERROR_RETURN_MSG(bcm_gport_stat_set(unit, gport, BCM_CORE_ALL, interface_type, stat_info), "in IRPP");
   ...
   int outP)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_stat_pp_config_main(unit, ipv6_tunnel_inlif_statistics_properties, bcmStatCounterInterfaceIngressReceivePp, 0, BCM_CORE_ALL, 0),
        "failed for ipv6_tunnel_inlif_statistics_properties");

    /** A GRE4oIPv6 tunnel header is being terminated */
    BCM_IF_ERROR_RETURN_MSG(ipv6_tunnel_term_basic(unit, inP, outP), "");
    ...
    print stat_info;
    BCM_IF_ERROR_RETURN_MSG(bcm_gport_stat_set(unit, gport, BCM_CORE_ALL, bcmStatCounterInterfaceIngressReceivePp, stat_info), "in IRPP");
   ...
   int outP)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_stat_pp_config_main(unit, ipv6_tunnel_outlif_statistics_properties, bcmStatCounterInterfaceEgressTransmitPp, 0, BCM_CORE_ALL, 0),
        "failed for ipv6_tunnel_outlif_statistics_properties");

    /** A GRE4oIPv6 tunnel header is being encapsulated */
    BCM_IF_ERROR_RETURN_MSG(ipv6_basic_tunnel_encapsulation(unit, inP, outP), "");
    ...
    print stat_info;
    engine_source = *(dnxc_data_get(unit, "stat", "stat_pp", "supported_egress_interface_counter_enum", NULL));
    BCM_IF_ERROR_RETURN_MSG(bcm_gport_stat_set(unit, gport, BCM_CORE_ALL, engine_source, stat_info), "in IRPP");
