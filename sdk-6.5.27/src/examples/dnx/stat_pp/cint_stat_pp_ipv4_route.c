 ...
 * Test Scenario - start
  ...
  cint ../../../../src/examples/dnx/crps/cint_crps_etpp_config.c
  cint ../../../../src/examples/dnx/stat_pp/cint_stat_pp_ipv4_route.c
  cint
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(get_first_fec_in_range_which_not_in_ecmp_range(unit, 0, 0, &cint_stat_pp_ipv4_route_info.fec_id1),
        "hierarchy 1");

    BCM_IF_ERROR_RETURN_MSG(get_first_fec_in_range_which_not_in_ecmp_range(unit, 1, 0, &cint_stat_pp_ipv4_route_info.fec_id2),
        "hierarchy 2");

    BCM_IF_ERROR_RETURN_MSG(get_first_fec_in_range_which_not_in_ecmp_range(unit, 2, 0, &cint_stat_pp_ipv4_route_info.fec_id3),
        "hierarchy 3");
    ...
    int out_port)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_stat_pp_update_fec_ids_values(unit), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(in_port_intf_set(unit, cint_stat_pp_ipv4_route_info.in_port, cint_stat_pp_ipv4_route_info.intf_in),
        "intf_in");

    /** Set Out-Port default properties */
    BCM_IF_ERROR_RETURN_MSG(out_port_set(unit, cint_stat_pp_ipv4_route_info.out_port), "intf_out");

    /** Create ETH-RIF and set its properties */
    BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create(unit, cint_stat_pp_ipv4_route_info.intf_in, cint_stat_pp_ipv4_route_info.intf_in_mac_address),
        "intf_in");
    BCM_IF_ERROR_RETURN_MSG(intf_eth_rif_create(unit, cint_stat_pp_ipv4_route_info.intf_out, cint_stat_pp_ipv4_route_info.intf_out_mac_address),
        "intf_out");
    ...
    BCM_IF_ERROR_RETURN_MSG(intf_ingress_rif_rpf_set(unit, cint_stat_pp_ipv4_route_info.intf_in, cint_stat_pp_ipv4_route_info.vrf, bcmL3IngressUrpfLoose),
        "ingr_itf");

    /** Create ARP for second FEC and set its properties */
    BCM_IF_ERROR_RETURN_MSG(l3__egress_only_encap__create(unit, 0, &cint_stat_pp_ipv4_route_info.encap_id1, cint_stat_pp_ipv4_route_info.arp_next_hop_mac, 0),
        "create egress object ARP only");

    /** Create AC-Ptr for 3rd FEC and set its properties */
    BCM_IF_ERROR_RETURN_MSG(out_vlan_port_intf_set(unit, cint_stat_pp_ipv4_route_info.out_port, cint_stat_pp_ipv4_route_info.encap_id2, &lif_as_gport),
        "out_port");
    ...
    BCM_IF_ERROR_RETURN_MSG(vlan_translate_ive_eve_translation_set(unit, lif_as_gport, cint_stat_pp_ipv4_route_info.outer_tpid,
    ...
    BCM_IF_ERROR_RETURN_MSG(cint_stat_pp_ipv4_route_create_ecmp(unit,
                                             cint_stat_pp_ipv4_route_info.fec_id3,
