 ...
 * 
 ...
 Copyright 2007-2022 Broadcom Inc. All rights reserved. File: cint_stat_pp_port_ingress_meter_crps.c Purpose: Statistics examples for SDK ingress APIs using PP port object.
 */
    ...
    int *pp_profile_id)
{
    ...
    *pp_profile_id = cint_stat_pp_config_meter_info.pp_profile;
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_stat_pp_profile_create(unit, flags, bcmStatCounterInterfaceIngressReceivePp, *pp_profile_id, pp_profile), "");
    return BCM_E_NONE;
}
    ...
    int port_meter)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(cint_stat_pp_config_crps(unit, crps_statistics_config, bcmStatCounterInterfaceIngressReceivePp, core), "");

    /*
     * Configure pp profile
     */
    BCM_IF_ERROR_RETURN_MSG(cint_stat_pp_create_pp_profile(unit, crps_statistics_config, bcmStatCounterInterfaceIngressReceivePp, &pp_profile_crps, &pp_profile_id_crps), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_gport_stat_set(unit, local_gport, core, bcmStatCounterInterfaceIngressReceivePp, stat_info_crps), "");
     ...
     * Configure meter database
     */
    BCM_IF_ERROR_RETURN_MSG(cint_stat_pp_config_meter(unit, core, meter_statistics_config), "");

    /*
     * Configure pp profile
     */
    BCM_IF_ERROR_RETURN_MSG(cint_stat_pp_create_pp_profile_meter(unit, meter_statistics_config, &pp_profile_meter, &pp_profile_id_meter), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_gport_stat_set(unit, local_gport, core, bcmStatCounterInterfaceIngressReceivePp, stat_info_meter), "");
