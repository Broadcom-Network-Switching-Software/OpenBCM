    ...
    int in_port)
{
     ...
     */
    BCM_IF_ERROR_RETURN_MSG(cint_stat_pp_config_crps(unit, crps_statistics_config, bcmStatCounterInterfaceIngressReceivePp, in_core), "");

    /*
     * Configure pp profile
     */
    BCM_IF_ERROR_RETURN_MSG(cint_stat_pp_create_pp_profile(unit, crps_statistics_config, bcmStatCounterInterfaceIngressReceivePp, &pp_profile, &pp_profile_id), "");
    ...
    if (BCM_GPORT_IS_LOCAL(in_port))
    {
        ...
        BCM_IF_ERROR_RETURN_MSG(bcm_gport_stat_set(unit, local_gport, in_core, bcmStatCounterInterfaceIngressReceivePp, stat_info), "");
    } else {
        BCM_IF_ERROR_RETURN_MSG(bcm_gport_stat_set(unit, in_port, in_core, bcmStatCounterInterfaceIngressReceivePp, stat_info), "");
    }
