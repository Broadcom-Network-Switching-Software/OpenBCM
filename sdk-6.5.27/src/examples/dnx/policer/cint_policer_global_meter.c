    ...
    int header_truncate)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_policer_expansion_groups_set(unit, flags, core, &expansion_group), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_policer_set(unit, policer_id, &pol_cfg), "for global meter offset 0");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_policer_set(unit, policer_id, &pol_cfg), "for global meter offset 1");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_policer_set(unit, policer_id, &pol_cfg), "for global meter offset 2");

    /** step 3: enable the global policer */
    BCM_IF_ERROR_RETURN_MSG(bcm_policer_database_enable_set(unit, flags, database_handle, TRUE), "for global meter");
    ...
    uint32 expected)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_policer_stat_get(unit, policer_id, 0, stat, &value), "for global meter offset 0");
    ...
    bcm_field_context_t context_id)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_add(unit, 0, &fg_info, &policer_fg_id), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_attach(unit, 0, policer_fg_id, context_id, &attach_info), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_add(unit, 0, policer_fg_id, &ent_info, &policer_fe_id), "");
...
int policer_acl_rule_destroy(int unit, bcm_field_context_t context_id)
{
    ...
    snprintf(error_msg, sizeof(error_msg), "fg %d", policer_fg_id);
    BCM_IF_ERROR_RETURN_MSG(bcm_field_entry_delete(unit, policer_fg_id, NULL, policer_fe_id), error_msg);
    snprintf(error_msg, sizeof(error_msg), "fg %d from context %d", policer_fg_id, context_id);
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_context_detach(unit, policer_fg_id, context_id), error_msg);
    snprintf(error_msg, sizeof(error_msg), "fg %d", policer_fg_id);
    BCM_IF_ERROR_RETURN_MSG(bcm_field_group_delete(unit, policer_fg_id), error_msg);
