    ...
    int stream_id_base)
{
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_port_get(unit, src_port, &flags, &interface_info, &mapping_info), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_tdm_interface_config_set(unit, 0, gport, &set_interface_config), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_tdm_ingress_context_create(unit, 0, &set_stream_context, &ingress_context), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_tdm_stream_ingress_context_set(unit, 0, gport, set_stream_context), "");
    ...
    BCM_IF_ERROR_RETURN_MSG(bcm_tdm_egress_editing_set(unit, flags, gport, &editing), "");
    return BCM_E_NONE;
}
