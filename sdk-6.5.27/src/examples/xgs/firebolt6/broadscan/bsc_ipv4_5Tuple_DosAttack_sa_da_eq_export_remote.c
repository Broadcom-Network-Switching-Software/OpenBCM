/*  Feature  : Broadscan
 *
 *  Usage    : BCM.0> cint bsc_ipv4_5Tuple_DosAttack_sa_da_eq_export_remote.c 
 *
 *  config   : broadscan_config.bcm
 *
 *  Log file : bsc_ipv4_5Tuple_DosAttack_sa_da_eq_export_remote_log.txt
 *  
 *  Test Topology :
 *
 *                   +------------------------------+ 
 ...
 *  Summary:
 *  ========
 *  This CINT configures Broadscan Engine to export a record to remote collector for MACSA==MACDA DOS attack packets
 *  recieved on a ingress port. 
 *  Flow Selection is composed of 5 tuple and TTL. We use CPU port as remote collector in this case.
 * 
 ...
 *        Packet:
 *        ======
 *        2233 4455 6677 2233 4455 6677 8100 001E 
 *        0800 4508 0038 0000 4000 4006 4998 0A0A
 *        0101 0A0A 0102 3344 5566 02A1 A2A3 02B1
 ...
 *      [bcmFtRMon.0]0005: 08 07 00 98 4e 3c 00 0a
 *      [bcmFtRMon.0]0006: 00 90 00 00 00 00 00 00
 *      [bcmFtRMon.0]0007: 00 00 00 00 00 01 1e fe
 *      [bcmFtRMon.0]0008: 00 80 02 04 03 e8 00 20
 ...
 *      [bcmFtRMon.0]0014: 00 01 00 00 06 0a 0a 01
 *      [bcmFtRMon.0]0015: 02 0a 0a 01 01 00 00 00
 *      [bcmFtRMon.0]0016: 00 00 00 00 00 02 55 66
 *      [bcmFtRMon.0]0017: 55 66 06 00 00 00 00 00
 ...
 *      [bcmFtRMon.0]Template Id matching with set id 7934 is 0 and num of elements = 14
 ...
 *      [bcmFtRMon.0]Template Id:  0 Info Element( 2) = 15 (            Reserved) Size = 40
 *      [bcmFtRMon.0]Template Id:  0 Info Element( 3) = 19 (           DosAttack) Size = 04
 *      [bcmFtRMon.0]Template Id:  0 Info Element( 4) = 15 (            Reserved) Size = 02
 *      [bcmFtRMon.0]Template Id:  0 Info Element( 5) =  6 (          IPProtocol) Size = 01
 *      [bcmFtRMon.0]Template Id:  0 Info Element( 6) =  1 (             DstIPv4) Size = 04
 *      [bcmFtRMon.0]Template Id:  0 Info Element( 7) =  0 (             SrcIPv4) Size = 04
 *      [bcmFtRMon.0]Template Id:  0 Info Element( 8) = 15 (            Reserved) Size = 05
 *      [bcmFtRMon.0]Template Id:  0 Info Element( 9) =  7 (            PktCount) Size = 04
 *      [bcmFtRMon.0]Template Id:  0 Info Element(10) =  5 (           L4DstPort) Size = 02
 *      [bcmFtRMon.0]Template Id:  0 Info Element(11) =  5 (           L4DstPort) Size = 02
 *      [bcmFtRMon.0]Template Id:  0 Info Element(12) =  6 (          IPProtocol) Size = 01
 *      [bcmFtRMon.0]Template Id:  0 Info Element(13) = 15 (            Reserved) Size = 51
 *      [bcmFtRMon.0]Info Element:: 15 (            Reserved) | Size: 02 | Value: (????)
 *      [bcmFtRMon.0]Info Element:: 14 (    FlowtrackerGroup) | Size: 02 | Value: 0x03e8(1000)
 *      [bcmFtRMon.0]Info Element:: 15 (            Reserved) | Size: 40 | Value: (????)
 *      [bcmFtRMon.0]Info Element:: 19 (           DosAttack) | Size: 04 | Value: 0x00000001(00000001)
 *      [bcmFtRMon.0]Info Element:: 15 (            Reserved) | Size: 02 | Value: (????)
 *      [bcmFtRMon.0]Info Element:: 06 (          IPProtocol) | Size: 01 | Value: 0x06(06)
 *      [bcmFtRMon.0]Info Element:: 01 (             DstIPv4) | Size: 04 | Value: (10.10.1.2)
 *      [bcmFtRMon.0]Info Element:: 00 (             SrcIPv4) | Size: 04 | Value: (10.10.1.1)
 *      [bcmFtRMon.0]Info Element:: 15 (            Reserved) | Size: 05 | Value: (????)
 *      [bcmFtRMon.0]Info Element:: 07 (            PktCount) | Size: 04 | Value: 0x00000002(00000002)
 *      [bcmFtRMon.0]Info Element:: 05 (           L4DstPort) | Size: 02 | Value: 0x5566(21862)
 *      [bcmFtRMon.0]Info Element:: 05 (           L4DstPort) | Size: 02 | Value: 0x5566(21862)
 *      [bcmFtRMon.0]Info Element:: 06 (          IPProtocol) | Size: 01 | Value: 0x06(06)
 *      [bcmFtRMon.0]Info Element:: 15 (            Reserved) | Size: 51 | Value: (????)
 *      [bcmFtRMon.0]*************************************************
 */
...
verify(int unit, bcm_flowtracker_group_t flow_group_id)
{
	...
	snprintf(str, 512, "tx 2 pbm=%d 
			data=0x2233445566772233445566778100001E08004508003800004000400649980A0A01010A0A01023344556602A1A2A302B1B2B3500211F5F8C30000F5F5F5F5F5F5F5F5F5F5F5F5F5F5F5F5F5F5F5F5F5F5F5F5F5F5;
...
int 
broadscan_collector_create(int unit, bcm_collector_t collector_id, bcm_collector_info_t collector_info)
{
	int rv = BCM_E_NONE;
	uint32 options = 0;
...
int execute()
{
	...
	int min_value = 0x1; /* macsa == macda */
	int max_value = 0x1; /* Will be trated as mask*/
	...
	bcm_collector_t collector_id         = 0;
