/*  Feature  : Broadscan
 *
 *  Usage    : BCM.0> cint bsc_ipv4_5Tuple_ttlRangeCheck_export_remote.c
 *
 *  config   : broadscan_config.bcm
 *
 *  Log file : bsc_ipv4_5Tuple_ttlRangeCheck_export_remote_log.txt
 *  
 *  Test Topology :
 *
 *                   +------------------------------+ 
 ...
 *  Summary:
 *  ========
 *  This CINT configures Broadscan Engine to export a record to remote collector when two or more 
 *  packets with TTL range (1-200) are recieved on a ingress port.
 *  In this test we send a flow from ingress port and configure broadscan engine to export the record
 *  to remote collector when the packets in specific TTl range (1-200) are received more than 2.
 ...
 *  [bcmFtRMon.0]0005: 08 07 00 98 48 7b 00 0a
 *  [bcmFtRMon.0]0006: 00 90 00 00 00 00 00 00
 *  [bcmFtRMon.0]0007: 00 00 00 00 00 01 1e fe
 *  [bcmFtRMon.0]0008: 00 80 0b a8 03 e8 00 40
 ...
 *  [bcmFtRMon.0]0016: 00 02 00 00 00 00 00 00
 ...
 *  [bcmFtRMon.0]Template Id matching with set id 7934 is 0 and num of elem1) = 14 (    FlowtrackerGroup) Size = 02
