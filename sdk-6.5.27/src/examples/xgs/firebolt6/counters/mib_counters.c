 ...
 *      f) Expected Result:
 *      ===================
 *         First print will have 10 Tx Unicast, 10 Rx Unicast and 10 discard packet count
 *         Second print will have 20 Tx Unicast, 20 Rx Unicast and 20 discard packet count
*/
