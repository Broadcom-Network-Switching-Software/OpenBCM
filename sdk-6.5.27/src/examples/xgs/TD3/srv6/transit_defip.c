/*
ABSTRACT:
  SRv6 Transit for L2-IPv6-SRH-IPv4 with Standard SID.
  L3 Lookup in L3_DEFIP_PAIR_128

        network port     ---- TD3 ---- access port
 IPv4 in IPv6 with SRH header     Transit via L3_DEFIP table
...
bcm_ip6_t dip6      = {0x00,0x18,0x00,0x01,0x00,0x02,0x00,0x00,0x00,0x04,0x00,0x05,0x00,0x06,0x03,0xf0};
bcm_ip6_t sid1      = {0x00,0x18,0x00,0x01,0x00,0x02,0x00,0x00,0x00,0x04,0x00,0x05,0x00,0x06,0x00,0x00};
bcm_ip6_t sid1_mask = {0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0x00,0x00};
...
/* L3 DEFIP setup */
rv = add_to_l3_defip6_table(unit, vrf, egr_obj_acc1, sid1, sid1_mask);
printf("Create a L3 IPv6 DEFIP entry ...... %s\n", bcm_errmsg(rv));
...
char *pkt_data = "";
...
[bcmPW.0]Packet[1]: data[00f0]: 5657 5859 0002 9ea9 d3fc 7e4d 78f1
