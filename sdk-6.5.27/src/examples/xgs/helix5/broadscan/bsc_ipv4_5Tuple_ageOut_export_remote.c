/*  Feature  : Broadscan
 *
 *  Usage    : BCM.0> cint bsc_ipv6_5Tuple_ageOut_export_remote.c
 *
 *  config   : broadscan_config.bcm
 *
 *  Log file : bsc_ipv6_5Tuple_ageOut_export_remote_log.txt
 *  
 *  Test Topology :
 *
 *                   +------------------------------+ 
 ...
 * [bcmFtRMon.0]Template Id matching with set id 7934 is 0 and num of elements = 10
 ...
 * [bcmFtRMon.0]Template Id:  0 Info Element( 2) = 15 (            Reserved) Size = 19
 * [bcmFtRMon.0]Template Id:  0 Info Element( 3) =  5 (           L4DstPort) Size = 02
 * [bcmFtRMon.0]Template Id:  0 Info Element( 4) =  4 (           L4SrcPort) Size = 02
 * [bcmFtRMon.0]Template Id:  0 Info Element( 5) =  3 (             DstIPv6) Size = 16
 * [bcmFtRMon.0]Template Id:  0 Info Element( 6) =  2 (             SrcIPv6) Size = 16
 * [bcmFtRMon.0]Template Id:  0 Info Element( 7) = 15 (            Reserved) Size = 01
 * [bcmFtRMon.0]Template Id:  0 Info Element( 8) =  7 (            PktCount) Size = 04
 * [bcmFtRMon.0]Template Id:  0 Info Element( 9) = 15 (            Reserved) Size = 60
 * [bcmFtRMon.0]Info Element:: 15 (            Reserved) | Size: 02 | Value: (????)
 * [bcmFtRMon.0]Info Element:: 14 (    FlowtrackerGroup) | Size: 02 | Value: 0x03e8(1000)
 * [bcmFtRMon.0]Info Element:: 15 (            Reserved) | Size: 19 | Value: (????)
 ...
 *
 *      Dumping the Flow group stats one more time to check age out count getting incremented.
 *
 *    ////////////////////////////////////////////////////////////
...
verify(int unit, bcm_flowtracker_group_t flow_group_id)
{
	...
	snprintf(str, 512, "tx 1 pbm=%d 
			data=0x10111213141220212223242286DD6500000100420614000000010002000300040000000000020000000200030004000500060007000255667788000000004006E23B90020002A0A8780210002000000000010000000050122233D9EA6600000102030405060708090A0B0C0D0E0F10111213141516000103;sleep 1", ingress_port);
	bshell(unit, str);
...
int execute()
{
	...
	/* Creating Flow Selection  based on ingress packet*/
        int ipprot = 6;
        int vlanformat = 0; /* untagged */
        rv = broadscan_flow_selection(unit, &ftfp_group, flow_group_id, ipprot, vlanformat);
	if (BCM_FAILURE(rv)) {
