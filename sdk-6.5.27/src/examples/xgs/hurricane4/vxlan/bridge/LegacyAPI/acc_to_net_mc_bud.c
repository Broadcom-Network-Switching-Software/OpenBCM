...
bcm_error_t vxlan_access_to_network_bud(int unit)
{
  ...
  BCM_IF_ERROR_RETURN(create_ingress_l3_intf_vlan_set(unit, 0, net_vid_1, net_vid_1));
  BCM_IF_ERROR_RETURN(create_ingress_l3_intf_vlan_set(unit, 0, net_vid_2, net_vid_2));
  BCM_IF_ERROR_RETURN(create_ingress_l3_intf_vlan_set(unit, 0, acc_vid, acc_vid));
