 ...
 *
 *  Usage    : BCM.0> cint macsec_encrypt_decrypt_4_sa_multi_vlans_qinq_per_pvlan_sc_cos.c
 *
 *  config   : hr4_sdk6_macsec_config.bcm
 *
 *  Log file : macsec_encrypt_decrypt_4_sa_multi_vlans_qinq_per_pvlan_sc_log.txt
 *
 *  Test Topology :
 *
 *                   +----------------------------+
 ...
 *
 *      1.5) For MACsec-enabled port (egress_port1) and p_vlan 100
 *           1.5.1) For decryption direction
 *                  1.5.1.1) Configure a decryption SC and 4 SA's
 *                  1.5.1.2) Configure a decryption policy
 *                  1.5.1.3) Configure a decryption flow (port and outer vlan)
 *           1.5.2) For encryption direction:
 *                  1.5.2.1) Configure an encryption SC and 4 SA's (secTag offset = 16)
 ...
 *                           Expected result:
 *                           The packet is doubled-tagged, encrypted with the egress SC for <ovid, egress_port1> and forwarded to egress_port1.
 ...
 *                  3.1.2.2) Unicast packet encrypted for ingress SC for <ovid, egress_port1> is received from egress_port1
 *                           Expected result:
...
macsec_vlan_port_config_sc_sa_setup(int unit, macsec_vlan_port_s *macsec_vlan_port)
{
    ...
    BCM_IF_ERROR_RETURN(assign_egress_sc_by_efp(unit, port, p_vlan, macsec_vlan_port->encrypt_sc_id, bcmColorGreen, macsec_efp_group, &macsec_vlan_port->efp_encrypt_stat_id[0]));
    BCM_IF_ERROR_RETURN(assign_egress_sc_by_efp(unit, port, p_vlan, macsec_vlan_port->encrypt_sc_id, bcmColorYellow, macsec_efp_group, &macsec_vlan_port->efp_encrypt_stat_id[1]));
    BCM_IF_ERROR_RETURN(assign_egress_sc_by_efp(unit, port, p_vlan, macsec_vlan_port->encrypt_sc_id, bcmColorRed, macsec_efp_group, &macsec_vlan_port->efp_encrypt_stat_id[2]));
...
unsigned char expected_encrypted_packet1[512] = {
    ...
    0x00, 0x64, 0x88, 0xe5, 0x2c, 0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x08, 0xf5, 0x6b, 0x48, 0x78, 0xbd, 0xef, 0xb3, 0x06, 0x03, 0xbc,
    0x70, 0x31, 0x8f, 0xe8, 0x73, 0x55, 0xd0, 0x14, 0x2b, 0x93, 0x9c, 0x35, 0x58, 0x44,
    0x1b, 0x4a, 0x07, 0x01, 0xf7, 0x14, 0x93, 0x15, 0x7a, 0x69, 0x53, 0xd9, 0x49, 0xdd,
    0x25, 0x2f, 0x0e, 0x42, 0x78, 0x58, 0x42, 0xbc, 0xe8, 0xaf, 0x8a, 0x75, 0xfd, 0x46,
    0x50, 0xc0, 0x5e, 0x76, 0x50, 0xd8, 0x01, 0x2a, 0x00, 0x10, 0xd5, 0x6f, 0xab, 0x6d,
    0x7c, 0xd8, 0xa4, 0x31, 0x3a, 0x9d, 0x1a, 0x7d, 0xd6, 0x04};

unsigned char expected_encrypted_packet2[512] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x22, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x81, 0x00,
    0x00, 0x64, 0x88, 0xe5, 0x2d, 0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x08, 0xf5, 0x91, 0x7c, 0x2d, 0x26, 0xfd, 0x26, 0x10, 0x35, 0x99,
    0xd8, 0x65, 0x9a, 0x7c, 0x62, 0xa8, 0xe2, 0x5c, 0xcf, 0x0b, 0x33, 0x84, 0x58, 0x1f,
    0x2f, 0x39, 0xf5, 0x9b, 0x40, 0xb5, 0xd5, 0xd9, 0x8d, 0x17, 0x0c, 0xfa, 0xdb, 0x04,
    0x89, 0xde, 0x8f, 0x83, 0x99, 0xd2, 0x37, 0x2d, 0xd6, 0xc2, 0xf9, 0x11, 0x03, 0x08,
    0xf8, 0x72, 0x65, 0xa3, 0x18, 0x67, 0x14, 0x98, 0x18, 0xc5, 0xdd, 0x00, 0x12, 0xb8,
    0x65, 0x6d, 0xe1, 0x3c, 0x55, 0xda, 0xc6, 0x44, 0xb1, 0x12};
...
unsigned char expected_encrypted_mc_packet1[512] = {
    ...
    0x00, 0x64, 0x88, 0xe5, 0x2c, 0x00, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x08, 0x5f, 0x4c, 0xa1, 0x50, 0x73, 0xff, 0xf0, 0xac, 0x18, 0x78,
    0xf8, 0x3e, 0xd0, 0x70, 0xf7, 0xcc, 0xaa, 0x8c, 0xf1, 0x44, 0xe2, 0xc9, 0xee, 0x0a,
    0xa0, 0xdd, 0x29, 0x7d, 0x2f, 0x3d, 0x04, 0xa5, 0x8b, 0x9b, 0x0a, 0xaa, 0x10, 0xe7,
    0xa2, 0xb5, 0x4e, 0x9e, 0x1f, 0x40, 0xdf, 0xbc, 0xaf, 0x33, 0x3f, 0x51, 0xb0, 0x8a,
    0x91, 0x6f, 0xbf, 0x2a, 0xa1, 0x62, 0xe7, 0x24, 0xb5, 0x38, 0x76, 0xbc, 0x92, 0xf0,
    0x56, 0xbe, 0x14, 0x08, 0x07, 0x81, 0x9a, 0x7e, 0x70, 0x44};
...
test_verify(int unit)
{
    ...
    snprintf(uc_enc_pkt_1, 512,"%s","0000000000220000000000018100006488e52c00000000050000000000000008f56b4878bdefb30603bc70318fe87355d0142b939c3558441b4a0701f71493157a6953d949dd252f0e42785842bce8af8a75fd4650c05e7650d8012a0010d56fab6d7cd8a4313a9d");

    snprintf(uc_enc_pkt_2, 512,"%s","0000000000220000000000018100006488e52d00000000050000000000000008f5917c2d26fd26103599d8659a7c62a8e25ccf0b3384581f2f39f59b40b5d5d98d170cfadb0489de8f8399d2372dd6c2f9110308f87265a31867149818c5dd0012b8656de13c55da");
