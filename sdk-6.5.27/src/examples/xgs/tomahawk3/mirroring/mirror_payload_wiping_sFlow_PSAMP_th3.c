 ...
 *
 *  Usage    : BCM.0> cint mirror_payload_wiping_sFlow_PSAMP_th3.c [YES] [IpType] [TunnelType]
 ...
 *  E.g.
 *          cint mirror_payload_wiping_sFlow_PSAMP_th3.c YES 0 2 1 1       <<<< sFlow
 *          cint mirror_payload_wiping_sFlow_PSAMP_th3.c YES 0 3 1 1       <<<< PSAMP
 *
...
bcm_error_t ConfigureMirror()
{
    ...
    else if( opt_DoPsampTunnel )
    {
        ...
        mirror_flags |= (BCM_MIRROR_PORT_PSAMP | BCM_MIRROR_PORT_SFLOW);
    }
