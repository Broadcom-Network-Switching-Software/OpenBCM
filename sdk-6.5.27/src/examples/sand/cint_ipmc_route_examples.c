    ...
    int trap_id_fec)
{
    ...
    if (!is_device_or_above(unit, JERICHO2)) {
        printf("The test is supported on Jericho 2 devices.\n");
        return BCM_E_FAIL;
    }
 ...
 * exit;
 *
 * tx 1 psrc=200 data=0x01005e60e0010000000000018100000a08004508002e000040004006b85bc0800104e0e0e0013344556600a1a2a300b1b2b3500f01f57e4e0000f5f5f5f5f5f5f5f5f5f5
 *
 ...
 *    Data: 01a000640000000003e49ba957000000f9437a7004841600140000504202000300000000000001005e60e0020000000000018100000a08004508002e00004000400606d178fffa0ee0e0e0023344556600a1a2a300b1b2b3500f01f5ccc30000
 *
 */
 ...
 *    Source port: 0, Destination port: 0
 *    Egress VLAN: 101
 *    Data: 0xa00000000001000c000200008100806508004508002e000040003f0658dac080fefeef1234563344556600a1a2a300b1b2b3500f01f51dcd0000f5f5f5f5f5f5
 *
 ...
 *    Source port: 0, Destination port: 0
 *    Egress VLAN: 102
 *    Data: 0xb00000000002000c000200008100806608004508002e000040003f060f000c08fefeefab32103344556600a1a2a300b1b2b3500f01f5d3f20000f5f5f5f5f5f5
 *
 */
 ...
 * cint ../../../../src/examples/sand/cint_ipmc_route_examples.c
 * cint
 * run_with_ports_ipv4_mc_example(0, 200, 201);
 * exit;
 *
 * tx 1 psrc=200 data=0x01005e60e0010000000000018100000208004508002e000040004006b85bc0800101e0e0e0013344556600a1a2a300b1b2b3500f01f57e4e0000f5f5f5f5f5f5f5f5f5f5
 *
 * Expected egress packets:
 *
 * on port 201: 01005e60e00100000000ab1d8100800308004508002e000040003f06b95bc0800101e0e0e0013344556600a1a2a300b1b2b3500f01f57e4e0000f5f5f5f5f5f5
 * on port 202: 01005e60e00100000000ab1d8100800408004508002e000040003f06b95bc0800101e0e0e0013344556600a1a2a300b1b2b3500f01f57e4e0000f5f5f5f5f5f5
 * on port 203: 01005e60e00100000000ab1d8100800508004508002e000040003f06b95bc0800101e0e0e0013344556600a1a2a300b1b2b3500f01f57e4e0000f5f5f5f5f5f5
 *
 */
int
 ...
 * cint ../../../../src/examples/sand/cint_ipmc_route_examples.c
 * cint
 * run_with_prefix_ipv4_mc_example(0, 200, 201, 20, 16, 3, 6000, 1);
 * exit;
 *
 * cint
 * run_with_prefix_ipv4_mc_example(0, 200, 201, 20, 32, 3, 6000, 0);
 * exit;
 *
 * tx 1 psrc=200 data=0x01005e60e0010000000000018100000208004508002e000040004006b85bc0800101e0e0e0013344556600a1a2a300b1b2b3500f01f57e4e0000f5f5f5f5f5f5f5f5f5f5
 *
 ...
 * exit;
 *
 * tx 1 psrc=200 data=0x3333000000010000000000018100000186dd608000100014060a12cd0000000000000000000000000001ff0000000000000000000000000000013344556600a1a2a300b1b2b3500001f5bccc0000
 * 
 */
 /* Received packets on unit 0 should be:
  * Source port: 0, Destination port: 0
  * Data: 0x608000100014060912cd0000000000000000000000000001ff0000000000000000000000000000013344556600a1a2a300b1b2b3500001f5
  *
 */
int
 ...
 * exit;
 *
 * # The following packet will hit VSI *without* bridge fallback configuration. Packet will be dropped.
 ...
 * on port 201: 0x01005E0202020000070001009100000C080045000035000000006400B343C0800101E0020202000102030405060708090A0B
 * on port 202: 0x01005E0202020000070001009100000C080045000035000000006400B343C0800101E0020202000102030405060708090A0B
 * on port 203: 0x01005E0202020000070001009100000C080045000035000000006400B343C0800101E0020202000102030405060708090A0B
 */
int
 ...
 *
 * packets on unit 0 should be dropped because packtet TTL=24 is lower than the out-RIF TTL threshold 25
 *
 ...
 *
 * packets on unit 0 should be dropped because packet TTL=25 is equal with the out-RIF TTL threshold 25
 *
