 ...
 * print rv;
 *
 * tx 1 psrc=200 data=0x000c0002005600500000123408004500002e000000000b11abba010203047fffff03002001c7001ab17c000102030405060708090a0b0c0d0e0f1011c83758af
 *
 ...
 *
 * ==========================================================================================================================================================================================================================================================================================
 * |                                                                                                                              Entries dump table EEDB_IPV4_TUNNEL                                                                                                                       |
 * |   Result type  ETPS_IPV4_TUNNEL_GRE_GENEVE                                                                                                                                                                                                                                             |
 * |   Total Entries: 1                                                                                                                                                                                                                                                                     |
 * ==========================================================================================================================================================================================================================================================================================
 * | # | OUT_   || OUT_LIF_| ESEM_ | ACTION_ | SOURCE_ | TTL_    | NWK_ | ENCAP_QOS_MODEL       | FORWARD_QOS_  | TTL_       | TTL_MODE   | LIF_AHP_GRE_GENEVE | MTU_    | VRF   | REMARK_ | STAT_   | STAT_   | IPV4_   | IPV4_     | IPV4_DIP                | EEDB_  | NEXT_   | HITBIT  |
 * |   | LIF    || PROFILE | NAME_ | PROFILE | IDX     | PIPE_   | QOS_ |                       | MODEL         | DECREMENT_ |            |                    | PROFILE |       | PROFILE | OBJECT_ | OBJECT_ | HEADER_ | HEADER_   |                         | LL_    | OUTLIF_ |         |
 * |   |        ||         | SPACE |         |         | PROFILE | IDX  |                       |               | DISABLE    |            |                    |         |       |         | ID      | CMD     | DF_FLAG | RESERVED_ |                         | EXTRA_ | POINTER |         |
 * |   |        ||         |       |         |         |         |      |                       |               |            |            |                    |         |       |         |         |         |         | FLAG      |                         | DATA   |         |         |
 * ==========================================================================================================================================================================================================================================================================================
 * | 0 | 0xa000 || 56      | 0     | 0       | 128     | 0       | 0    | PIPE_NEXT_SPACE (0x1) | UNIFORM (0x0) | False      | PIPE (0x1) | LIF_AHP_NONE (0x0) | 0       | 64512 | 0       | 0       | 0       | False   | False     | 161.0.0.17 (0xa1000011) | 0      | 81920   | PRI_1ST |
 * ==========================================================================================================================================================================================================================================================================================
 *
 * ==============================================================================================================================================================================
 * |                                                                             Entries dump table EEDB_ARP                                                                    |
 * |   Result type  ETPS_ARP_SA_TUNNELING                                                                                                                                       |
 * |   Total Entries: 1                                                                                                                                                         |
 * ==============================================================================================================================================================================
 * | # | OUT_LIF || L2_MAC            | ACTION_ | OAM_  | VSI | FORWARD_QOS_  | REMARK_ | TTL_       | TTL_MODE      | MTU_    | STAT_   | STAT_   | EEDB_  | NEXT_   | HITBIT  |
 * |   |         ||                   | PROFILE | LIF_  |     | MODEL         | PROFILE | DECREMENT_ |               | PROFILE | OBJECT_ | OBJECT_ | LL_    | OUTLIF_ |         |
 * |   |         ||                   |         | SET   |     |               |         | DISABLE    |               |         | ID      | CMD     | EXTRA_ | POINTER |         |
 * |   |         ||                   |         |       |     |               |         |            |               |         |         |         | DATA   |         |         |
 * ==============================================================================================================================================================================
 * | 0 | 0x14000 || 00:02:00:00:cd:1d | 0       | False | 100 | UNIFORM (0x0) | 0       | False      | UNIFORM (0x0) | 0       | 0       | 0       | 0      | 0       | PRI_1ST |
 * ==============================================================================================================================================================================
 *
 *  Traffic:
 *
 ...
 *   |    |00:02:00:00:CD:1D||00:0C:00:02:00:56||    160.0.0.17   ||    161.0.0.17   ||   4   ||   1.2.3.4   || 127.255.255.03 ||
 *   |    |                 ||                 ||    A0.00.00.11  ||    A1.00.00.11  ||  800  || 01.02.03.04 ||  7f.ff.ff.03   ||
 *   |    +-+-+-+-+-+-+-+-+-+-+-+-+-+--+-+-+-+-+-+-+-+-++-+-+-+-+-+-+-+-+-+-+-+-+-+--+-+-+-+-+-+-+-+-+-+-+-++-+-+-+-+-+-+-+-+-+-+-+
 *   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 *
 *   Egress packet:
 *   Data: 0x00020000cd1d000c000200568100a0640800450a004a00000000402f3959a0000011a1000011000008004500002e000000000a11acba010203047fffff03002001c7001ab17c000102030405060708090a0b0c0d0e0f1011c83758af
 *
 */
