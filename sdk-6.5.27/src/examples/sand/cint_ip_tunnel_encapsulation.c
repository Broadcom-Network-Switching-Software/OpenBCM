 ...
 * |   Total Entries: 1                                                                                                                                                                                                                                                                      |
 * ===========================================================================================================================================================================================================================================================================================
 * | # | OUT_LIF || OUT_LIF_| ESEM_ | ACTION_ | SOURCE_ | TTL_    | NWK_ | ENCAP_QOS_MODEL       | FORWARD_QOS_  | TTL_       | TTL_MODE   | LIF_AHP_GRE_GENEVE | MTU_    | VRF   | REMARK_ | STAT_   | STAT_   | IPV4_   | IPV4_     | IPV4_DIP                | EEDB_  | NEXT_   | HITBIT  |
 * |   |         || PROFILE | NAME_ | PROFILE | IDX     | PIPE_   | QOS_ |                       | MODEL         | DECREMENT_ |            |                    | PROFILE |       | PROFILE | OBJECT_ | OBJECT_ | HEADER_ | HEADER_   |                         | LL_    | OUTLIF_ |         |
 * |   |         ||         | SPACE |         |         | PROFILE | IDX  |                       |               | DISABLE    |            |                    |         |       |         | ID      | CMD     | DF_FLAG | RESERVED_ |                         | EXTRA_ | POINTER |         |
 * |   |         ||         |       |         |         |         |      |                       |               |            |            |                    |         |       |         |         |         |         | FLAG      |                         | DATA   |         |         |
 * ===========================================================================================================================================================================================================================================================================================
 * | 0 | 0x16000 || 56      | 0     | 0       | 128     | 0       | 0    | PIPE_NEXT_SPACE (0x1) | UNIFORM (0x0) | False      | PIPE (0x1) | LIF_AHP_NONE (0x0) | 0       | 64512 | 0       | 0       | 0       | False   | False     | 161.0.0.17 (0xa1000011) | 0      | 81920   | PRI_1ST |
 * ===========================================================================================================================================================================================================================================================================================
 *
 *  Traffic:
 *
 ...
 *  A GRE4oIPv4oETH tunnel header is being encapsulated.
 *
 * BCM.0> dbal tbl dump tbl=IPV6_UNICAST_PRIVATE_HOST
 * ===================================================================================
 * |                  Entries dump table IPV6_UNICAST_PRIVATE_HOST                   |
 * |   Result type  FWD_DEST                                                         |
 * |   Total Entries: 1                                                              |
 * ===================================================================================
 * | # | VRF | IPV6                                    || DESTINATION       | HITBIT |
 * ===================================================================================
 * | 0 | 1   | e1e2:e3e4:e5e6:e7e8:e9ea:ebec:edee:efec || FEC 52430 (52430) | NONE   |
 * ===================================================================================
 *
 * ==============================================================================================================================================================================================================
 * |                                                                                    Entries dump table EEDB_MPLS_TUNNEL                                                                                     |
 * |   Result type  ETPS_MPLS_1                                                                                                                                                                                 |
 * |   Total Entries: 1                                                                                                                                                                                         |
 * ==============================================================================================================================================================================================================
 * | # | OUT_LIF || MPLS_ | OUT_LIF_| OAM_  | LIF_AHP_MPLS       | TTL_    | NWK_ | REMARK_ | ENCAP_QOS_    | FORWARD_QOS_  | TTL_       | TTL_MODE   | MTU_    | ACTION_ | ESEM_   | EEDB_  | NEXT_   | HITBIT |
 * |   |         || LABEL | PROFILE | LIF_  |                    | PIPE_   | QOS_ | PROFILE | MODEL         | MODEL         | DECREMENT_ |            | PROFILE | PROFILE | COMMAND | LL_    | OUTLIF_ |        |
 * |   |         ||       |         | SET   |                    | PROFILE | IDX  |         |               |               | DISABLE    |            |         |         |         | EXTRA_ | POINTER |        |
 * |   |         ||       |         |       |                    |         |      |         |               |               |            |            |         |         |         | DATA   |         |        |
 * ==============================================================================================================================================================================================================
 * | 0 | 0x18000 || 200   | 52      | False | LIF_AHP_NONE (0x0) | 1       | 0    | 0       | UNIFORM (0x0) | UNIFORM (0x0) | False      | PIPE (0x1) | 0       | 0       | 0       | 0      | 90112   | NONE   |
 * ==============================================================================================================================================================================================================
 *
 *  Traffic:
 *
