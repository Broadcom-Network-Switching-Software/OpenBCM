...
/* Globals */
  ...
  /*
   * For the JR2-J2C device, recycle port is port 45.
   ...
   */
  int recycle_port_core0_j2c_comp_jr2 = 45;
        ...
        int is_server_client)
{
    ...
    port_1 = server_port1;
    port_2 = server_port2;
    rv = mpls_oam_init(server_unit, type, use_mpls_out_gport, &server_gport, &outlif, &arp_out_lif_server, &label, &out_gport, &tunnel_switch, &mpls_termination_label_index_enable);
    if (rv != BCM_E_NONE) {
        printf("(%s) \n",bcm_errmsg(rv));
        return rv;
    }
    ...
    port_1 = client_port1;
    port_2 = client_port2;
    rv = mpls_oam_init(client_unit, type, use_mpls_out_gport, &client_gport, &outlif, &arp_out_lif_client, &label, &out_gport, &tunnel_switch, &mpls_termination_label_index_enable);
    if (rv != BCM_E_NONE) {
        printf("(%s) \n",bcm_errmsg(rv));
        return rv;
    }
