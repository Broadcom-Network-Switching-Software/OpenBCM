 ...
 * Egress packets:
 * port 201 VLAN 256
 * 01005e02020200123456789a81000100080045000035000000007f009843c0800101e0020202000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c
 * port 202 VLAN 257
 * 01005e02020200123456789b81000101080045000035000000007f009843c0800101e0020202000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c
 *
 ...
 * Egress packets:
 * port 201 VLAN 256
 * 33330000111100123456789a8100010086dd600000000049067f00000000000000000000333322221111ffff0000000000000000000000001111000102030405
 * port 202 VLAN 257
 * 33330000111100123456789b8100010186dd600000000049067f00000000000000000000333322221111ffff0000000000000000000000001111000102030405
 */
...
/** Indicate whether to create an entry in TCAM */
int use_tcam = 0;
/*
 * Utilities APIs
 */
    ...
    uint32 flags)
{
    ...
    if ((flags & BCM_IPMC_TCAM) || ((s_ip_mask[0] == 0) && (eth_rif_id != 0)))
    {
        if (eth_rif_id < IPMC_NOF_ETH_RIFS)
        {
           data.vid = eth_rif_id;
    ...
    int unit)
{
    ...
    if (use_tcam)
    {
        ...
        rv = add_ipv6_ipmc(unit, cint_ipmc_info.ipv6_dip_addr, full_mask, cint_ipmc_info.ipv6_sip_addr, part_mask,
                           cint_ipmc_info.intf_in, cint_ipmc_info.vrf, 0, 0, cint_ipmc_info.mc_group, 0, BCM_IPMC_TCAM);
        if (rv != BCM_E_NONE)
        {
