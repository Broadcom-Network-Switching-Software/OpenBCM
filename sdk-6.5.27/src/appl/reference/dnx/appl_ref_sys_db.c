...
#include <appl/reference/dnx/appl_ref_sys_db.h>
...
shr_error_e
appl_dnx_system_port_db_add_internal(
    int unit,
...
shr_error_e
appl_dnx_system_port_db_remove_internal(
    int unit,
    system_port_db_t * system_port_db,
    int system_port_id,
    system_port_mapping_t * sys_port_map_info)
...
shr_error_e
appl_dnx_system_port_db_get_internal(
    int unit,
    system_port_db_t * system_port_db,
    int system_port_id,
    system_port_mapping_t * sys_port_map_info)
{
    ...
    if (system_port_db->entries[system_port_id].valid_entry == 0)
    {
        LOG_INFO(BSL_LOG_MODULE, (BSL_META_U(unit, "system port %d is not in use\n"), system_port_id));
    ...
    system_port_mapping_t * sys_port_map_info)
{
    ...
    SHR_IF_ERR_EXIT(appl_dnx_sys_device_params_get(unit, &sys_params));
    SHR_IF_ERR_EXIT(appl_dnx_system_port_db_add_internal
                    (unit, sys_params->system_port_db, system_port_id, sys_port_map_info));
    ...
    system_port_mapping_t * sys_port_map_info)
{
    ...
    SHR_IF_ERR_EXIT(appl_dnx_sys_device_params_get(unit, &sys_params));
    SHR_IF_ERR_EXIT(appl_dnx_system_port_db_remove_internal
                    (unit, sys_params->system_port_db, system_port_id, sys_port_map_info));
    ...
    system_port_mapping_t * sys_port_map_info)
{
    ...
    SHR_IF_ERR_EXIT(appl_dnx_sys_device_params_get(unit, &sys_params));
    SHR_IF_ERR_EXIT(appl_dnx_system_port_db_get_internal
                    (unit, sys_params->system_port_db, system_port_id, sys_port_map_info));
    ...
    int nof_devices)
{
    ...
    for (int sys_port_iter = 0; sys_port_iter < DNX_DATA_MAX_DEVICE_GENERAL_MAX_NOF_SYSTEM_PORTS; ++sys_port_iter)
    {
        ...
        {
            SHR_IF_ERR_EXIT(appl_dnx_system_port_db_add_internal(unit, system_port_db, sys_port_iter, &sys_port_map));
        }
        else
        {
