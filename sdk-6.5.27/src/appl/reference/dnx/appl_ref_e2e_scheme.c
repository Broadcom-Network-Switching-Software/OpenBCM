    ...
    int port)
{
    ...
    rv = appl_dnx_system_port_db_get_internal(unit, sys_params->system_port_db, system_port_id, &sys_port_map);
    ...
    else
    {
        ...
        if ((flags & APPL_DNX_FILTERED_PORTS_FLAGS) || (interface_info.flags & APPL_DNX_FILTERED_PORT_INTERFACE_FLAGS))
        {
            SHR_EXIT();
        }
    }
