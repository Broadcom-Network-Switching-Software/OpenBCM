...
#define MAX_DEVICE_NOF_FAP_ID   DNX_DATA_MAX_DEVICE_GENERAL_NOF_CORES * (1<<DNX_DATA_MAX_DEVICE_GENERAL_FAP_IDS_PER_CORE_BITS)
...
#define APPL_DNX_FILTERED_PORTS_FLAGS (BCM_PORT_ADD_KBP_PORT | BCM_PORT_ADD_STIF_PORT |                             \
                                       ...
                                       BCM_PORT_ADD_CROSS_CONNECT | BCM_PORT_ADD_FLEXE_SAR)
/**
 * List of dynamic port flags (bcm_port_interface_info_t) that represent special filtered out ports from application
 */
#define APPL_DNX_FILTERED_PORT_INTERFACE_FLAGS (BCM_PORT_ADD_TX_FEEDBACK_ONLY)
/*
 * }
 */
