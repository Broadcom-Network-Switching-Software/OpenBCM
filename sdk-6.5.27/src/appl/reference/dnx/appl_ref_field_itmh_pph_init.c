...
#define FLAG_BIT_ITMH_1588_CONTEXT      0x10
#define FLAG_BIT_ITMH_1588_PPH_CONTEXT  0x20
#define FLAG_BIT_ITMH_1588_PPH_FHEI_CONTEXT       0x40
#define FLAG_BIT_ITMH_1588_PPH_FHEI_VLAN_CONTEXT  0x80
#define FLAG_BIT_PPH_ROUTING_CONTEXT    0x100
...
#define FWD_LAYER_INDEX_OFFSET  3
...
#define FEM_1588_PRIORITY           BCM_FIELD_ACTION_POSITION(3, 7)

#define PTCH_SIZE_IN_BYTES      2
#define ITMH_SIZE_IN_BYTES      5
#define ASE_1588_SIZE_IN_BYTES  6
#define TSH_SIZE_IN_BYTES       4
...
static shr_error_e
appl_dnx_field_itmh_pph_field_name_to_id(
    int unit,
    char *name,
    bcm_field_name_to_id_type_t type,
    uint32 *field_id)
{
    ...
    sal_strncpy_s((char *) name_to_id_info.name, name, sizeof(name_to_id_info.name));
    SHR_IF_ERR_EXIT(bcm_field_name_to_id(unit, 0, &name_to_id_info, &nof_ids, &id_from_name));

    if (type == bcmFieldNameToIdQualifier)
    {
        *(bcm_field_qualify_t *) field_id = id_from_name;
    }
    else
    {
        *(bcm_field_action_t *) field_id = id_from_name;
    }
...
static shr_error_e
appl_dnx_field_itmh_trap_group_config(
    int unit,
    bcm_field_group_t * fg_id,
    bcm_field_group_attach_info_t * attach_info)
{
    bcm_field_action_t trap_str_zero_padding_action;
    bcm_field_group_info_t fg_info;
    ...
    fg_info.fg_type = bcmFieldGroupTypeDirectExtraction;
    fg_info.stage = bcmFieldStageIngressPMF2;
    sal_strncpy_s((char *) fg_info.name, "ITMH-trap", sizeof(fg_info.name));
    ...
    bcm_field_group_attach_info_t * attach_info)
{
    ...
    bcm_field_action_t udh3_ase_action;
    bcm_field_group_info_t fg_info;
    SHR_FUNC_INIT_VARS(unit);
    ...
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_pph_field_name_to_id
                    (unit, "forwarding_layer_index", bcmFieldNameToIdQualifier, &fwd_layer_index_qual));
    ...
    fg_info.nof_quals = 3;
    fg_info.qual_types[0] = ase_inj_qual;
    fg_info.qual_types[1] = fwd_layer_index_qual;
    fg_info.qual_types[2] = fbr_header_qual;

    fg_info.nof_actions = 3;
    fg_info.action_types[0] = udh3_ase_action;
    fg_info.action_with_valid_bit[0] = FALSE;
    ...
    attach_info->key_info.qual_info[0].input_type = bcmFieldInputTypeLayerAbsolute;
    attach_info->key_info.qual_info[0].input_arg = ITMH_PPH_APPL_ITMH_LAYER;
    attach_info->key_info.qual_info[0].offset = ASE_INJ_OFFSET;
    ...
    attach_info->key_info.qual_info[2].input_arg = DNX_FIELD_CONTEXT_SYS_HDR_PROFILE_FTMH;
    ...
    bcm_field_group_attach_info_t * attach_info)
{
    ...
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_pph_field_name_to_id
                    (unit, "pars_offset", bcmFieldNameToIdQualifier, &pars_offset_qual));
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_pph_user_qual_create
    ...
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_pph_user_qual_create
                    (unit, "fwd_trap_code", TRAP_CODE_LENGTH, &fwd_trap_code_qual));
    ...
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_pph_field_name_to_id
                    (unit, ITMH_IS_TSH_INJ, bcmFieldNameToIdQualifier, &is_tsh_inj_qual));
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_pph_field_name_to_id
                    (unit, "sys_header_profile", bcmFieldNameToIdQualifier, &hdr_profile_qual));
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_pph_user_action_create
    ...
    attach_info->key_info.qual_info[9].input_arg = DNX_FIELD_CONTEXT_SYS_HDR_PROFILE_FTMH_PPH;
    ...
    attach_info->payload_info.action_info[9].priority = TRAP_PRIORITY_PPH;
    attach_info->payload_info.action_info[9].valid_bit_polarity = 0;
    ...
    bcm_field_group_attach_info_t * attach_info)
{
    ...
    bcm_field_action_priority_t action_priority;
    int mapping_bits_index, conditions_id;
    int ieee_1588_action_size, ieee_1588_cmd_size;
    SHR_FUNC_INIT_VARS(unit);
    ...
    ieee_1588_cmd_size =
        action_info.size - (ASE_1588_OFFSET_LENGTH + TS_ENCAPSULATION_LENGTH + USE_INGRESS_TIME_COMPENSATION_LENGTH +
                            1);
    ...
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_pph_user_qual_create
                    (unit, "time_stamp_command", ieee_1588_cmd_size, &time_stamp_command_qual));
    ...
    fem_action_info.fem_extraction[0].increment = PTCH_SIZE_IN_BYTES + ITMH_SIZE_IN_BYTES + ASE_1588_SIZE_IN_BYTES;

    fem_action_info.fem_extraction[1].action_type = bcmFieldActionIEEE1588;
    
    fem_action_info.fem_extraction[1].increment =
        PTCH_SIZE_IN_BYTES + ITMH_SIZE_IN_BYTES + ASE_1588_SIZE_IN_BYTES + TSH_SIZE_IN_BYTES;
    ...
    action_priority = FEM_1588_PRIORITY;
    SHR_IF_ERR_EXIT(bcm_field_fem_action_add(unit, 0, *fg_id, action_priority, &fem_action_info));
    ...
    attach_info->key_info.qual_info[7].input_arg = DNX_FIELD_CONTEXT_SYS_HDR_PROFILE_FTMH;

    attach_info->payload_info.action_types[0] = fg_info.action_types[0];
    attach_info->payload_info.action_types[1] = fg_info.action_types[1];
    attach_info->payload_info.action_types[2] = fg_info.action_types[2];
    attach_info->payload_info.action_info[0].priority = PRIORITY_1588;
    ...
    attach_info->payload_info.action_info[2].valid_bit_polarity = 0;
    ...
    bcm_field_group_attach_info_t * attach_info)
{
    ...
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_pph_field_name_to_id
                    (unit, "fwd_trap_code", bcmFieldNameToIdQualifier, &fwd_trap_code_qual));
    
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_pph_field_name_to_id
                    (unit, "itmh_fwd_str", bcmFieldNameToIdQualifier, &itmh_fwd_str_qual));
    
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_pph_field_name_to_id
                    (unit, "pph_fwd_str", bcmFieldNameToIdQualifier, &pph_fwd_str_qual));
...
static shr_error_e
appl_dnx_field_pph_routing_group_config(
    int unit,
    bcm_field_group_t * fg_id,
    bcm_field_group_attach_info_t * attach_info)
{
    bcm_field_group_info_t fg_info;
    bcm_field_qualify_t compare_qual, hdr_profile_qual, fwd_trap_code_qual;
    bcm_field_action_t trap_drop_action;
    bcm_field_qualifier_info_get_t qual_info_get;
    int key_bigger_offset;
    int trap_code_drop;
    ...
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_pph_user_qual_create(unit, "compare_bigger_than", 1, &compare_qual));
    ...
    SHR_IF_ERR_EXIT(bcm_field_compare_operand_offset_get
                    (unit, 0, bcmFieldCompareOperandFirstKeyBigger, &key_bigger_offset));
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_pph_user_action_create
                    (unit, "trap_code_drop", bcmFieldActionTrapRaw, bcmFieldStageIngressPMF2, TRAP_CODE_LENGTH, 0xf,
                     &trap_drop_action));

    bcm_field_group_info_t_init(&fg_info);
    fg_info.fg_type = bcmFieldGroupTypeDirectExtraction;
    fg_info.stage = bcmFieldStageIngressPMF2;
    sal_strncpy_s((char *) fg_info.name, "ITMH-PPH-Routing", sizeof(fg_info.name));

    fg_info.nof_quals = 3;
    fg_info.qual_types[0] = compare_qual;
    fg_info.qual_types[1] = fwd_trap_code_qual;
    fg_info.qual_types[2] = hdr_profile_qual;

    fg_info.nof_actions = 2;
    
    fg_info.action_types[0] = trap_drop_action;
    fg_info.action_with_valid_bit[0] = TRUE;
    fg_info.action_types[1] = bcmFieldActionFabricHeaderSetRaw;
    fg_info.action_with_valid_bit[1] = FALSE;
    ...
    attach_info->key_info.qual_types[0] = fg_info.qual_types[0];
    attach_info->key_info.qual_info[0].input_type = bcmFieldInputTypeMetaData;
    attach_info->key_info.qual_info[0].offset = qual_info_get.offset + key_bigger_offset;

    
    SHR_IF_ERR_EXIT(bcm_rx_trap_type_get(unit, 0, bcmRxTrapItmhError, &trap_code_drop));
    attach_info->key_info.qual_types[1] = fg_info.qual_types[1];
    attach_info->key_info.qual_info[1].input_type = bcmFieldInputTypeConst;
    attach_info->key_info.qual_info[1].input_arg = trap_code_drop;

    attach_info->key_info.qual_types[2] = fg_info.qual_types[2];
    attach_info->key_info.qual_info[2].input_type = bcmFieldInputTypeConst;
    attach_info->key_info.qual_info[2].input_arg = DNX_FIELD_CONTEXT_SYS_HDR_PROFILE_FTMH_TSH_PPH_UDH;
    ...
    int unit)
{
    ...
    bcm_field_qualify_t parsing_start_offset_qual, fwd_layer_index_qual;
    ...
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_pph_user_qual_create
                    (unit, "pars_offset", PARSING_OFFSET_LENGTH, &parsing_start_offset_qual));
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_pph_field_name_to_id
                    (unit, "forwarding_layer_index", bcmFieldNameToIdQualifier, &fwd_layer_index_qual));
    ...
    context_id = dnx_data_field.context.default_itmh_1588_pph_context_get(unit);
    SHR_IF_ERR_EXIT(bcm_field_context_compare_create
                    (unit, 0, bcmFieldStageIngressPMF1, context_id, pair_id, &compare_info));
    ...
    pair_id = 0;
    context_id = dnx_data_field.context.default_itmh_1588_pph_fhei_context_get(unit);
    SHR_IF_ERR_EXIT(bcm_field_context_compare_create
                    (unit, 0, bcmFieldStageIngressPMF1, context_id, pair_id, &compare_info));
    ...
    compare_info.first_key_info.nof_quals = 2;
    compare_info.first_key_info.qual_types[0] = parsing_start_offset_qual;
    compare_info.first_key_info.qual_info[0].input_type = bcmFieldInputTypeLayerAbsolute;
    compare_info.first_key_info.qual_info[0].input_arg = ITMH_PPH_APPL_PPH_LAYER;
    compare_info.first_key_info.qual_info[0].offset = PARSING_OFFSET_OFFSET;

    compare_info.first_key_info.qual_types[1] = fwd_layer_index_qual;
    compare_info.first_key_info.qual_info[1].input_type = bcmFieldInputTypeLayerAbsolute;
    compare_info.first_key_info.qual_info[1].input_arg = ITMH_PPH_APPL_PPH_LAYER;
    compare_info.first_key_info.qual_info[1].offset = FWD_LAYER_INDEX_OFFSET;

    compare_info.second_key_info.nof_quals = 2;
    
    compare_info.second_key_info.qual_types[0] = parsing_start_offset_qual;
    ...
    compare_info.second_key_info.qual_types[1] = fwd_layer_index_qual;
    compare_info.second_key_info.qual_info[1].input_type = bcmFieldInputTypeConst;
    compare_info.second_key_info.qual_info[1].input_arg = 0;

    
    pair_id = 0;
    context_id = dnx_data_field.context.default_itmh_pph_routing_context_get(unit);
    SHR_IF_ERR_EXIT(bcm_field_context_compare_create
                    (unit, 0, bcmFieldStageIngressPMF1, context_id, pair_id, &compare_info));
...
appl_dnx_field_itmh_pph_ipmf1_contexts(
    int unit)
{
    bcm_field_context_t itmh_pph_context_id, itmh_pph_fhei_context_id, itmh_1588_pph_context_id,
        itmh_1588_pph_fhei_context_id, itmh_pph_rounting_context_id;
    ...
    itmh_1588_pph_context_id = dnx_data_field.context.default_itmh_1588_pph_context_get(unit);
    bcm_field_context_info_t_init(&context_info);
    
    context_info.context_compare_modes.compare_1_mode = bcmFieldContextCompareTypeDouble;
    sal_strncpy_s((char *) (context_info.name), "ITMH_1588_PPH_IPMF1", sizeof(context_info.name));
    SHR_IF_ERR_EXIT(bcm_field_context_create
                    (unit, BCM_FIELD_FLAG_WITH_ID, bcmFieldStageIngressPMF1, &context_info, &itmh_1588_pph_context_id));
    ...
    SHR_IF_ERR_EXIT(bcm_field_context_param_set
                    (unit, 0, bcmFieldStageIngressPMF1, itmh_1588_pph_context_id, &param_info));
    ...
    presel_entry_data.qual_data[3].qual_type = bcmFieldQualifyForwardingLayerQualifier;
    presel_entry_data.qual_data[3].qual_arg = 1;
    presel_entry_data.qual_data[3].qual_value = 0x2;
    presel_entry_data.qual_data[3].qual_mask = 0x7;
    presel_entry_id.presel_id = dnx_data_field.preselector.default_itmh_1588_pph_presel_id_ipmf1_get(unit);
    presel_entry_data.nof_qualifiers++;
    presel_entry_data.context_id = itmh_1588_pph_context_id;
    SHR_IF_ERR_EXIT(bcm_field_presel_set(unit, 0, &presel_entry_id, &presel_entry_data));
    ...
    itmh_1588_pph_fhei_context_id = dnx_data_field.context.default_itmh_1588_pph_fhei_context_get(unit);
    bcm_field_context_info_t_init(&context_info);
    
    context_info.context_compare_modes.compare_1_mode = bcmFieldContextCompareTypeDouble;
    context_info.context_compare_modes.compare_2_mode = bcmFieldContextCompareTypeDouble;
    sal_strncpy_s((char *) (context_info.name), "ITMH_1588_PPH_FHEI_IPMF1", sizeof(context_info.name));

    SHR_IF_ERR_EXIT(bcm_field_context_create
                    (unit, BCM_FIELD_FLAG_WITH_ID, bcmFieldStageIngressPMF1, &context_info,
                     &itmh_1588_pph_fhei_context_id));
    ...
    SHR_IF_ERR_EXIT(bcm_field_context_param_set
                    (unit, 0, bcmFieldStageIngressPMF1, itmh_1588_pph_fhei_context_id, &param_info));
    ...
    presel_entry_data.qual_data[3].qual_value = 0x2;
    presel_entry_data.qual_data[3].qual_mask = 0x7;
    presel_entry_id.presel_id = dnx_data_field.preselector.default_itmh_1588_pph_fhei_presel_id_ipmf1_get(unit);
    presel_entry_data.nof_qualifiers++;
    presel_entry_data.context_id = itmh_1588_pph_fhei_context_id;
    SHR_IF_ERR_EXIT(bcm_field_presel_set(unit, 0, &presel_entry_id, &presel_entry_data));

    

    itmh_pph_rounting_context_id = dnx_data_field.context.default_itmh_pph_routing_context_get(unit);
    bcm_field_context_info_t_init(&context_info);
    
    context_info.context_compare_modes.compare_1_mode = bcmFieldContextCompareTypeDouble;
    sal_strncpy_s((char *) (context_info.name), "ITMH_PPH_Rounting_IPMF1", sizeof(context_info.name));

    SHR_IF_ERR_EXIT(bcm_field_context_create
                    (unit, BCM_FIELD_FLAG_WITH_ID, bcmFieldStageIngressPMF1, &context_info,
                     &itmh_pph_rounting_context_id));
    ...
    SHR_IF_ERR_EXIT(bcm_field_context_param_set
                    (unit, 0, bcmFieldStageIngressPMF1, itmh_pph_rounting_context_id, &param_info));

    bcm_field_presel_entry_id_info_init(&presel_entry_id);

    presel_entry_id.presel_id = dnx_data_field.preselector.default_itmh_pph_eth_presel_id_ipmf1_get(unit);
    presel_entry_id.stage = bcmFieldStageIngressPMF1;

    bcm_field_presel_entry_data_info_init(&presel_entry_data);
    presel_entry_data.nof_qualifiers = 3;
    presel_entry_data.context_id = itmh_pph_rounting_context_id;
    presel_entry_data.entry_valid = TRUE;
    ...
    presel_entry_data.qual_data[2].qual_value = bcmFieldLayerTypeEth;
    presel_entry_data.qual_data[2].qual_mask = 0x1F;
    SHR_IF_ERR_EXIT(bcm_field_presel_set(unit, 0, &presel_entry_id, &presel_entry_data));

    presel_entry_id.presel_id = dnx_data_field.preselector.default_itmh_pph_ipv4_presel_id_ipmf1_get(unit);
    
    presel_entry_data.qual_data[2].qual_type = bcmFieldQualifyForwardingType;
    presel_entry_data.qual_data[2].qual_arg = 3;
    presel_entry_data.qual_data[2].qual_value = bcmFieldLayerTypeIp4;
    presel_entry_data.qual_data[2].qual_mask = 0x1F;
    SHR_IF_ERR_EXIT(bcm_field_presel_set(unit, 0, &presel_entry_id, &presel_entry_data));

    presel_entry_id.presel_id = dnx_data_field.preselector.default_itmh_pph_ipv6_presel_id_ipmf1_get(unit);
    ...
    presel_entry_id.presel_id = dnx_data_field.preselector.default_itmh_pph_mpls_presel_id_ipmf1_get(unit);
    ...
    int unit)
{
    ...
    bcm_field_context_param_info_t param_info;
    bcm_field_presel_entry_id_t presel_entry_id;
    bcm_field_context_t itmh_pph_context_id = dnx_data_field.context.default_itmh_pph_context_get(unit);
    bcm_field_context_t itmh_pph_fhei_context_id = dnx_data_field.context.default_itmh_pph_fhei_context_get(unit);
    bcm_field_context_t itmh_pph_vlan_context_id =
        dnx_data_field.context.default_itmh_pph_fhei_vlan_ipmf2_context_get(unit);
    bcm_field_context_t itmh_pph_un_ext_context_id =
        dnx_data_field.context.default_itmh_pph_unsupported_ext_ipmf2_context_get(unit);
    bcm_field_context_t itmh_pph_fhei_un_ext_context_id =
        dnx_data_field.context.default_itmh_pph_fhei_unsupported_ext_ipmf2_context_get(unit);
    bcm_field_context_t itmh_1588_pph_context_id = dnx_data_field.context.default_itmh_1588_pph_context_get(unit);
    bcm_field_context_t itmh_1588_pph_fhei_context_id =
        dnx_data_field.context.default_itmh_1588_pph_fhei_context_get(unit);
    bcm_field_context_t itmh_1588_pph_un_ext_context_id =
        dnx_data_field.context.default_itmh_1588_pph_unsupported_ext_ipmf2_context_get(unit);
    bcm_field_context_t itmh_1588_pph_vlan_context_id =
        dnx_data_field.context.default_itmh_1588_pph_fhei_vlan_ipmf2_context_get(unit);
    bcm_field_context_t itmh_1588_pph_fhei_un_ext_context_id =
        dnx_data_field.context.default_itmh_1588_pph_fhei_unsupported_ext_ipmf2_context_get(unit);
    bcm_field_context_t itmh_pph_routing_context_id = dnx_data_field.context.default_itmh_pph_routing_context_get(unit);
    ...
    bcm_field_presel_entry_id_info_init(&presel_entry_id);
    presel_entry_id.presel_id = dnx_data_field.preselector.default_itmh_pph_fhei_trap_presel_id_ipmf2_get(unit);
    presel_entry_id.stage = bcmFieldStageIngressPMF2;
    ...
    bcm_field_context_info_t_init(&context_info);
    sal_strncpy_s((char *) (context_info.name), "ITMH_1588_PPH_FHEI_Vlan", sizeof(context_info.name));
    context_info.cascaded_from = itmh_1588_pph_fhei_context_id;
    SHR_IF_ERR_EXIT(bcm_field_context_create
                    (unit, BCM_FIELD_FLAG_WITH_ID, bcmFieldStageIngressPMF2, &context_info,
                     &itmh_1588_pph_vlan_context_id));

    
    bcm_field_presel_entry_id_info_init(&presel_entry_id);
    presel_entry_id.presel_id = dnx_data_field.preselector.default_itmh_1588_pph_fhei_vlan_presel_id_ipmf2_get(unit);
    presel_entry_id.stage = bcmFieldStageIngressPMF2;

    bcm_field_presel_entry_data_info_init(&presel_entry_data);
    presel_entry_data.nof_qualifiers = 1;
    presel_entry_data.context_id = itmh_1588_pph_vlan_context_id;
    presel_entry_data.entry_valid = TRUE;
    ...
    bcm_field_presel_entry_id_info_init(&presel_entry_id);
    presel_entry_id.presel_id = dnx_data_field.preselector.default_itmh_1588_pph_fhei_trap_presel_id_ipmf2_get(unit);
    presel_entry_id.stage = bcmFieldStageIngressPMF2;
    ...
    bcm_field_context_info_t_init(&context_info);
    sal_strncpy_s((char *) (context_info.name), "ITMH_PPH_Un_Ext", sizeof(context_info.name));
    context_info.cascaded_from = itmh_pph_context_id;
    SHR_IF_ERR_EXIT(bcm_field_context_create
                    (unit, BCM_FIELD_FLAG_WITH_ID, bcmFieldStageIngressPMF2, &context_info,
                     &itmh_pph_un_ext_context_id));
    ...
    SHR_IF_ERR_EXIT(bcm_field_context_param_set
                    (unit, 0, bcmFieldStageIngressPMF2, itmh_pph_un_ext_context_id, &param_info));

    bcm_field_presel_entry_id_info_init(&presel_entry_id);
    presel_entry_id.presel_id = dnx_data_field.preselector.default_itmh_pph_unsupported_ext_presel_id_ipmf2_get(unit);
    presel_entry_id.stage = bcmFieldStageIngressPMF2;

    bcm_field_presel_entry_data_info_init(&presel_entry_data);
    presel_entry_data.nof_qualifiers = 1;
    presel_entry_data.context_id = itmh_pph_un_ext_context_id;
    presel_entry_data.entry_valid = TRUE;
    ...
    bcm_field_context_info_t_init(&context_info);
    sal_strncpy_s((char *) (context_info.name), "ITMH_1588_PPH_Un_Ext", sizeof(context_info.name));
    context_info.cascaded_from = itmh_1588_pph_context_id;
    SHR_IF_ERR_EXIT(bcm_field_context_create
                    (unit, BCM_FIELD_FLAG_WITH_ID, bcmFieldStageIngressPMF2, &context_info,
                     &itmh_1588_pph_un_ext_context_id));
    ...
    param_info.param_val = BCM_FIELD_PACKET_STRIP(bcmFieldPacketRemoveLayerForwardingOffset1, 0);
    SHR_IF_ERR_EXIT(bcm_field_context_param_set
                    (unit, 0, bcmFieldStageIngressPMF2, itmh_1588_pph_un_ext_context_id, &param_info));

    bcm_field_presel_entry_id_info_init(&presel_entry_id);
    presel_entry_id.presel_id =
        dnx_data_field.preselector.default_itmh_1588_pph_unsupported_ext_presel_id_ipmf2_get(unit);
    presel_entry_id.stage = bcmFieldStageIngressPMF2;

    bcm_field_presel_entry_data_info_init(&presel_entry_data);
    presel_entry_data.nof_qualifiers = 1;
    presel_entry_data.context_id = itmh_1588_pph_un_ext_context_id;
    presel_entry_data.entry_valid = TRUE;
    ...
    bcm_field_context_info_t_init(&context_info);
    sal_strncpy_s((char *) (context_info.name), "ITMH_PPH_FHEI_Un_Ext", sizeof(context_info.name));
    context_info.cascaded_from = itmh_pph_fhei_context_id;
    SHR_IF_ERR_EXIT(bcm_field_context_create
                    (unit, BCM_FIELD_FLAG_WITH_ID, bcmFieldStageIngressPMF2, &context_info,
                     &itmh_pph_fhei_un_ext_context_id));
    ...
    param_info.param_val = BCM_FIELD_PACKET_STRIP(bcmFieldPacketRemoveLayerForwardingOffset1, 0);
    SHR_IF_ERR_EXIT(bcm_field_context_param_set
                    (unit, 0, bcmFieldStageIngressPMF2, itmh_pph_fhei_un_ext_context_id, &param_info));

    bcm_field_presel_entry_id_info_init(&presel_entry_id);
    presel_entry_id.presel_id =
        dnx_data_field.preselector.default_itmh_pph_fhei_unsupported_ext_presel_id_ipmf2_get(unit);
    presel_entry_id.stage = bcmFieldStageIngressPMF2;

    bcm_field_presel_entry_data_info_init(&presel_entry_data);
    presel_entry_data.nof_qualifiers = 1;
    presel_entry_data.context_id = itmh_pph_fhei_un_ext_context_id;
    presel_entry_data.entry_valid = TRUE;
    ...
    bcm_field_presel_entry_id_info_init(&presel_entry_id);
    presel_entry_id.presel_id =
        dnx_data_field.preselector.default_itmh_pph_fhei_unsupported_ext_presel_id_2nd_ipmf2_get(unit);
    presel_entry_id.stage = bcmFieldStageIngressPMF2;
    ...
    bcm_field_context_info_t_init(&context_info);
    sal_strncpy_s((char *) (context_info.name), "ITMH_1588_PPH_FHEI_Un_Ext", sizeof(context_info.name));
    context_info.cascaded_from = itmh_1588_pph_fhei_context_id;
    SHR_IF_ERR_EXIT(bcm_field_context_create
                    (unit, BCM_FIELD_FLAG_WITH_ID, bcmFieldStageIngressPMF2, &context_info,
                     &itmh_1588_pph_fhei_un_ext_context_id));
    ...
    param_info.param_val = BCM_FIELD_PACKET_STRIP(bcmFieldPacketRemoveLayerForwardingOffset1, 0);
    SHR_IF_ERR_EXIT(bcm_field_context_param_set
                    (unit, 0, bcmFieldStageIngressPMF2, itmh_1588_pph_fhei_un_ext_context_id, &param_info));

    bcm_field_presel_entry_id_info_init(&presel_entry_id);
    presel_entry_id.presel_id =
        dnx_data_field.preselector.default_itmh_1588_pph_fhei_unsupported_ext_presel_id_ipmf2_get(unit);
    presel_entry_id.stage = bcmFieldStageIngressPMF2;

    bcm_field_presel_entry_data_info_init(&presel_entry_data);
    presel_entry_data.nof_qualifiers = 1;
    presel_entry_data.context_id = itmh_1588_pph_fhei_un_ext_context_id;
    presel_entry_data.entry_valid = TRUE;
    ...
    bcm_field_presel_entry_id_info_init(&presel_entry_id);
    presel_entry_id.presel_id =
        dnx_data_field.preselector.default_itmh_1588_pph_fhei_unsupported_ext_presel_id_2nd_ipmf2_get(unit);
    presel_entry_id.stage = bcmFieldStageIngressPMF2;
    ...
    param_info.param_val = BCM_FIELD_PACKET_STRIP(bcmFieldPacketRemoveLayerForwardingOffset0, 0);
    SHR_IF_ERR_EXIT(bcm_field_context_param_set
                    (unit, 0, bcmFieldStageIngressPMF2, itmh_pph_routing_context_id, &param_info));
    ...
    int unit)
{
    ...
    bcm_field_presel_entry_id_t presel_entry_id;
    bcm_field_context_t itmh_pph_context_id = dnx_data_field.context.default_itmh_pph_context_get(unit);
    bcm_field_context_t itmh_pph_fhei_trap_context_id = dnx_data_field.context.default_itmh_pph_fhei_context_get(unit);
    bcm_field_context_t itmh_pph_fhei_vlan_context_id =
        dnx_data_field.context.default_itmh_pph_fhei_vlan_ipmf2_context_get(unit);
    bcm_field_context_t itmh_1588_pph_context_id = dnx_data_field.context.default_itmh_1588_pph_context_get(unit);
    bcm_field_context_t itmh_1588_pph_fhei_trap_context_id =
        dnx_data_field.context.default_itmh_1588_pph_fhei_context_get(unit);
    bcm_field_context_t itmh_1588_pph_fhei_vlan_context_id =
        dnx_data_field.context.default_itmh_1588_pph_fhei_vlan_ipmf2_context_get(unit);
    bcm_field_context_t itmh_pph_routing_context_id = dnx_data_field.context.default_itmh_pph_routing_context_get(unit);
    ...
    presel_entry_id.presel_id = dnx_data_field.preselector.default_itmh_1588_pph_presel_id_ipmf3_get(unit);
    presel_entry_id.stage = bcmFieldStageIngressPMF3;
    ...
    presel_entry_data.qual_data[0].qual_type = bcmFieldQualifyContextId;
    presel_entry_data.qual_data[0].qual_arg = 0;
    presel_entry_data.qual_data[0].qual_value = itmh_1588_pph_context_id;
    presel_entry_data.qual_data[0].qual_mask = 0x3F;
    SHR_IF_ERR_EXIT(bcm_field_presel_set(unit, 0, &presel_entry_id, &presel_entry_data));

    bcm_field_presel_entry_id_info_init(&presel_entry_id);

    presel_entry_id.presel_id = dnx_data_field.preselector.default_itmh_pph_trap_presel_id_ipmf3_get(unit);
    presel_entry_id.stage = bcmFieldStageIngressPMF3;
    ...
    presel_entry_id.presel_id = dnx_data_field.preselector.default_itmh_pph_vlan_presel_id_ipmf3_get(unit);
    presel_entry_id.stage = bcmFieldStageIngressPMF3;
    ...
    presel_entry_id.presel_id = dnx_data_field.preselector.default_itmh_1588_pph_vlan_presel_id_ipmf3_get(unit);
    presel_entry_id.stage = bcmFieldStageIngressPMF3;
    ...
    presel_entry_data.qual_data[0].qual_type = bcmFieldQualifyContextId;
    presel_entry_data.qual_data[0].qual_arg = 0;
    presel_entry_data.qual_data[0].qual_value = itmh_1588_pph_fhei_vlan_context_id;
    presel_entry_data.qual_data[0].qual_mask = 0x3F;
    SHR_IF_ERR_EXIT(bcm_field_presel_set(unit, 0, &presel_entry_id, &presel_entry_data));

    bcm_field_presel_entry_id_info_init(&presel_entry_id);

    presel_entry_id.presel_id = dnx_data_field.preselector.default_itmh_1588_pph_trap_presel_id_ipmf3_get(unit);
    presel_entry_id.stage = bcmFieldStageIngressPMF3;
    ...
    presel_entry_data.qual_data[0].qual_type = bcmFieldQualifyContextId;
    presel_entry_data.qual_data[0].qual_arg = 0;
    presel_entry_data.qual_data[0].qual_value = itmh_1588_pph_fhei_trap_context_id;
    presel_entry_data.qual_data[0].qual_mask = 0x3F;
    SHR_IF_ERR_EXIT(bcm_field_presel_set(unit, 0, &presel_entry_id, &presel_entry_data));

    bcm_field_presel_entry_id_info_init(&presel_entry_id);

    presel_entry_id.presel_id = dnx_data_field.preselector.default_itmh_pph_routing_presel_id_ipmf3_get(unit);
    presel_entry_id.stage = bcmFieldStageIngressPMF3;
    ...
    presel_entry_data.qual_data[0].qual_type = bcmFieldQualifyContextId;
    presel_entry_data.qual_data[0].qual_arg = 0;
    presel_entry_data.qual_data[0].qual_value = itmh_pph_routing_context_id;
    presel_entry_data.qual_data[0].qual_mask = 0x3F;
    SHR_IF_ERR_EXIT(bcm_field_presel_set(unit, 0, &presel_entry_id, &presel_entry_data));
    ...
    int unit)
{
    ...
    bcm_field_context_param_info_t param_info;
    bcm_field_presel_entry_id_t presel_entry_id;
    bcm_field_context_t itmh_1588_context_id = dnx_data_field.context.default_itmh_1588_context_get(unit);
    ...
    if (flow_id)
    {
        ...
        SHR_IF_ERR_EXIT(bcm_field_context_create
                        (unit, BCM_FIELD_FLAG_WITH_ID, bcmFieldStageIngressPMF1, &context_info, &itmh_1588_context_id));
        bcm_field_context_param_info_t_init(&param_info);
        param_info.param_type = bcmFieldContextParamTypeSystemHeaderProfile;
        param_info.param_val = bcmFieldSystemHeaderProfileFtmhTsh;
        SHR_IF_ERR_EXIT(bcm_field_context_param_set
                        (unit, 0, bcmFieldStageIngressPMF1, itmh_1588_context_id, &param_info));
        ...
        param_info.param_val = BCM_FIELD_PACKET_STRIP(bcmFieldPacketRemoveLayerForwardingOffset1, 0);
        SHR_IF_ERR_EXIT(bcm_field_context_param_set
                        (unit, 0, bcmFieldStageIngressPMF2, itmh_1588_context_id, &param_info));
    }

    bcm_field_presel_entry_id_info_init(&presel_entry_id);
    
    presel_entry_id.presel_id = dnx_data_field.preselector.default_itmh_1588_presel_id_ipmf1_get(unit);
    presel_entry_id.stage = bcmFieldStageIngressPMF1;

    bcm_field_presel_entry_data_info_init(&presel_entry_data);
    presel_entry_data.nof_qualifiers = 2;
    presel_entry_data.context_id = flow_id ? itmh_1588_context_id : itmh_context_id;
    presel_entry_data.entry_valid = TRUE;
    ...
    bcm_field_group_attach_info_t * attach_info)
{
    ...
    itmh_context_id = dnx_data_field.context.default_itmh_context_get(unit);
    itmh_1588_context_id = dnx_data_field.context.default_itmh_1588_context_get(unit);
    ...
    if ((context_ids & FLAG_BIT_ITMH_1588_CONTEXT) && flow_id)
    {
    ...
    bcm_field_group_attach_info_t * attach_info)
{
    ...
    {
        SHR_IF_ERR_EXIT(bcm_field_group_context_attach(unit, 0, fg_id, itmh_pph_context_id, attach_info));
    }

    if (context_ids & FLAG_BIT_PPH_FHEI_CONTEXT)
    {
        SHR_IF_ERR_EXIT(bcm_field_group_context_attach(unit, 0, fg_id, itmh_pph_fhei_context_id, attach_info));
    }

    if (context_ids & FLAG_BIT_PPH_FHEI_VLAN_CONTEXT)
    {
        SHR_IF_ERR_EXIT(bcm_field_group_context_attach(unit, 0, fg_id, itmh_pph_vlan_context_id, attach_info));
    }

    if (context_ids & FLAG_BIT_ITMH_1588_PPH_CONTEXT)
    {
        SHR_IF_ERR_EXIT(bcm_field_group_context_attach(unit, 0, fg_id, itmh_1588_pph_context_id, attach_info));
    }

    if (context_ids & FLAG_BIT_ITMH_1588_PPH_FHEI_CONTEXT)
    {
        SHR_IF_ERR_EXIT(bcm_field_group_context_attach(unit, 0, fg_id, itmh_1588_pph_fhei_context_id, attach_info));
    }

    if (context_ids & FLAG_BIT_ITMH_1588_PPH_FHEI_VLAN_CONTEXT)
    {
        SHR_IF_ERR_EXIT(bcm_field_group_context_attach(unit, 0, fg_id, itmh_1588_pph_vlan_context_id, attach_info));
    }

    if (context_ids & FLAG_BIT_ITMH_CONTEXT)
    {
        SHR_IF_ERR_EXIT(bcm_field_group_context_attach(unit, 0, fg_id, itmh_pph_un_ext_context_id, attach_info));
        SHR_IF_ERR_EXIT(bcm_field_group_context_attach(unit, 0, fg_id, itmh_pph_fhei_un_ext_context_id, attach_info));
        if (!flow_id)
        {
            
            SHR_IF_ERR_EXIT(bcm_field_group_context_attach
                            (unit, 0, fg_id, itmh_1588_pph_un_ext_context_id, attach_info));
            SHR_IF_ERR_EXIT(bcm_field_group_context_attach
                            (unit, 0, fg_id, itmh_1588_pph_fhei_un_ext_context_id, attach_info));
        }
    }

    if (context_ids & FLAG_BIT_ITMH_1588_CONTEXT)
    {
        if (flow_id)
        {
    ...
    if (context_ids & FLAG_BIT_PPH_ROUTING_CONTEXT)
    {
        SHR_IF_ERR_EXIT(bcm_field_group_context_attach(unit, 0, fg_id, itmh_pph_routing_context_id, attach_info));
    }
...
static shr_error_e
appl_dnx_field_common_qualifiers_create(
    int unit)
{
    bcm_field_qualify_t fwd_layer_index_qual;
    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_group_context_attach
                    (unit, fg_id, FLAG_BIT_ITMH_CONTEXT | FLAG_BIT_ITMH_1588_CONTEXT, &attach_info));

    
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_trap_group_config(unit, &fg_id, &attach_info));
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_group_context_attach
                    (unit, fg_id, FLAG_BIT_ITMH_CONTEXT | FLAG_BIT_ITMH_1588_CONTEXT, &attach_info));

    
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_only_group_config(unit, &fg_id, &attach_info));
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_group_context_attach(unit, fg_id, FLAG_BIT_ITMH_CONTEXT, &attach_info));

    
    SHR_IF_ERR_EXIT(appl_dnx_field_tsh_group_config(unit, &fg_id, &attach_info));
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_group_context_attach(unit, fg_id, FLAG_BIT_ITMH_1588_CONTEXT, &attach_info));
    ...
    if (flow_id)
    {
        ...
        SHR_IF_ERR_EXIT(appl_dnx_field_itmh_group_context_attach
                        (unit, fg_id, FLAG_BIT_ITMH_1588_CONTEXT, &attach_info));
    }
    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_only_group_config(unit, &fg_id, &attach_info));
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_pph_group_context_attach(unit, fg_id, FLAG_BIT_ITMH_CONTEXT, &attach_info));

    
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_group_config(unit, &fg_id, &attach_info));
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_pph_group_context_attach
                    (unit, fg_id,
                     FLAG_BIT_ITMH_CONTEXT | FLAG_BIT_ITMH_1588_CONTEXT | FLAG_BIT_PPH_CONTEXT |
                     FLAG_BIT_ITMH_1588_PPH_CONTEXT | FLAG_BIT_PPH_FHEI_CONTEXT | FLAG_BIT_PPH_FHEI_VLAN_CONTEXT |
                     FLAG_BIT_ITMH_1588_PPH_FHEI_CONTEXT | FLAG_BIT_ITMH_1588_PPH_FHEI_VLAN_CONTEXT |
                     FLAG_BIT_PPH_ROUTING_CONTEXT, &attach_info));

    
    SHR_IF_ERR_EXIT(appl_dnx_field_tsh_group_config(unit, &fg_id, &attach_info));
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_pph_group_context_attach
                    (unit, fg_id,
                     FLAG_BIT_ITMH_1588_CONTEXT | FLAG_BIT_PPH_CONTEXT | FLAG_BIT_PPH_FHEI_CONTEXT |
                     FLAG_BIT_ITMH_1588_PPH_CONTEXT | FLAG_BIT_ITMH_1588_PPH_FHEI_CONTEXT |
                     FLAG_BIT_ITMH_1588_PPH_FHEI_VLAN_CONTEXT | FLAG_BIT_PPH_FHEI_VLAN_CONTEXT |
                     FLAG_BIT_PPH_ROUTING_CONTEXT, &attach_info));
    ...
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_pph_group_context_attach
                    (unit, fg_id,
                     FLAG_BIT_PPH_CONTEXT | FLAG_BIT_PPH_FHEI_CONTEXT | FLAG_BIT_PPH_FHEI_VLAN_CONTEXT |
                     FLAG_BIT_ITMH_1588_PPH_FHEI_CONTEXT | FLAG_BIT_ITMH_1588_PPH_FHEI_VLAN_CONTEXT |
                     FLAG_BIT_ITMH_1588_PPH_CONTEXT | FLAG_BIT_PPH_ROUTING_CONTEXT, &attach_info));

    
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_pph_fhei_trap_group_config(unit, &fg_id, &attach_info));
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_pph_group_context_attach
                    (unit, fg_id, FLAG_BIT_PPH_FHEI_CONTEXT | FLAG_BIT_ITMH_1588_PPH_FHEI_CONTEXT, &attach_info));

    
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_pph_fhei_vlan_group_config(unit, &fg_id, &attach_info));
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_pph_group_context_attach
                    (unit, fg_id, FLAG_BIT_PPH_FHEI_VLAN_CONTEXT | FLAG_BIT_ITMH_1588_PPH_FHEI_VLAN_CONTEXT,
                     &attach_info));
    ...
    invalidate_fems[0] = FEM_1588_PRIORITY;
    attach_info.payload_info.nof_invalidate_fems = 1;
    attach_info.payload_info.invalidate_fems = invalidate_fems;
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_pph_group_context_attach
                    (unit, fg_id,
                     FLAG_BIT_ITMH_1588_PPH_CONTEXT | FLAG_BIT_ITMH_1588_PPH_FHEI_CONTEXT |
                     FLAG_BIT_ITMH_1588_PPH_FHEI_VLAN_CONTEXT, &attach_info));

    
    SHR_IF_ERR_EXIT(appl_dnx_field_ase_oam_group_config(unit, &fg_id, &attach_info));
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_pph_group_context_attach
                    (unit, fg_id,
                     FLAG_BIT_PPH_CONTEXT | FLAG_BIT_PPH_ROUTING_CONTEXT | FLAG_BIT_PPH_FHEI_CONTEXT |
    ...
    SHR_IF_ERR_EXIT(appl_dnx_field_pph_routing_group_config(unit, &fg_id, &attach_info));
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_pph_group_context_attach
                    (unit, fg_id, FLAG_BIT_PPH_ROUTING_CONTEXT, &attach_info));
    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(appl_dnx_field_common_qualifiers_create(unit));
