...
/** ids for traps */
    ...
    int oamp_eth_performance_response_trap_id;
    int oamp_mpls_performance_response_trap_id;
    int oamp_eth_slm_trap_id;
    int oamp_eth_slr_trap_id;
    ...
    bcm_rx_trap_config_t * trap_config)
{
    ...
    SHR_IF_ERR_EXIT(bcm_rx_trap_type_create(unit, flags, trap_type, trap_id));
    ...
    uint32 trap_mask)
{
    ...
    sal_strncpy_s((char *) (context_info.name), "OAM_No_Header", sizeof(context_info.name));
    ...
    SHR_IF_ERR_EXIT(bcm_field_context_param_set(unit, 0, bcmFieldStageIngressPMF1, context_id, &context_param));
    ...
    SHR_IF_ERR_EXIT(bcm_field_context_param_set(unit, 0, bcmFieldStageIngressPMF2, context_id, &context_param));
    ...
    SHR_IF_ERR_EXIT(bcm_field_presel_set(unit, 0, &presel_entry_id, &presel_data));
    ...
    int trap_id)
{
    ...
    sal_strncpy_s((char *) (fg_info.name), "DEST<-SSP", sizeof(fg_info.name));
    SHR_IF_ERR_EXIT(bcm_field_group_add(unit, 0, &fg_info, &downmep_reflector_fg_id));

    /** Creating new context */
    bcm_field_context_info_t_init(&context_info);
    sal_strncpy_s((char *) (context_info.name), "OAM DOWNMEP REFLECTOR", sizeof(context_info.name));
    ...
    oam_traps_t * oam_traps)
{
    ...
    bcm_flow_initiator_info_t oam_encap_flow = { 0 };
    ...
    /** allocate OAM reflector OUTLIF using FLOW API */
    SHR_IF_ERR_EXIT(bcm_flow_handle_get(unit, "OAM_REFLECTOR_INITIATOR", &flow_handle));
    flow_handle_info.flow_handle = flow_handle;
    oam_encap_flow.encap_access = bcmEncapAccessAc;
    /** Set raw_data with LBR opcode */
    BCM_IF_ERROR_RETURN(bcm_flow_logical_field_id_get(unit, flow_handle, "OAM_REFLECTOR_RAW_DATA", &field_id));
    SPECIAL_FIELD_UINT32_DATA_ADD((&special_fields), field_id, bcmOamOpcodeLBR);
    if (!dnx_data_flow.general.feature_get(unit, dnx_data_flow_general_is_flow_enabled_for_legacy_applications))
    {
        /** Set egress last layer */
        BCM_IF_ERROR_RETURN(bcm_flow_logical_field_id_get(unit, flow_handle, "REFLECTOR_EGRESS_LAST_LAYER", &field_id));
        SPECIAL_FIELD_ENABLER_ADD((&special_fields), field_id);
    }
    SHR_IF_ERR_EXIT(bcm_flow_initiator_info_create(unit, &flow_handle_info, &oam_encap_flow, &special_fields));

    /** allocate and set trap */
    bcm_rx_trap_config_t_init(&trap_config);
    BCM_GPORT_FLOW_LIF_TO_L3_ITF_LIF(lif_gport, flow_handle_info.flow_id);
    BCM_L3_ITF_LIF_TO_GPORT_TUNNEL(lif_gport, lif_gport);
    ...
    oam_traps_t * oam_traps)
{
    ...
    sal_strncpy_s((char *) (trap_config.name), "OAM_UP_MEP_OAMP", sizeof(trap_config.name));
    ...
    sal_strncpy_s((char *) (trap_config.name), "OAM_UP_MEP_DEST1", sizeof(trap_config.name));
    ...
    bcm_gport_t cpu_port)
{
    ...
    sal_strncpy_s((char *) trap_config.name, trap_name, sizeof(trap_config.name));
    ...
    bcm_gport_t cpu_port)
{
    ...
    /** punt config */
    SHR_IF_ERR_EXIT(appl_dnx_oam_single_punt_config(unit, bcmRxTrapOampTypeErr, "OAMP_TYPE_ERR", cpu_port));
    SHR_IF_ERR_EXIT(appl_dnx_oam_single_punt_config(unit, bcmRxTrapOampRmepErr, "OAMP_RMEP_ERR", cpu_port));
    SHR_IF_ERR_EXIT(appl_dnx_oam_single_punt_config(unit, bcmRxTrapOampMaidErr, "OAMP_MAID_ERR", cpu_port));
    SHR_IF_ERR_EXIT(appl_dnx_oam_single_punt_config(unit, bcmRxTrapOampMdlErr, "OAMP_MDL_ERR", cpu_port));
    SHR_IF_ERR_EXIT(appl_dnx_oam_single_punt_config(unit, bcmRxTrapOampCcmIntrvErr, "OAMP_CCM_INTRV_ERR", cpu_port));
    SHR_IF_ERR_EXIT(appl_dnx_oam_single_punt_config(unit, bcmRxTrapOampMyDiscErr, "OAMP_MY_DISC_ERR", cpu_port));
    SHR_IF_ERR_EXIT(appl_dnx_oam_single_punt_config(unit, bcmRxTrapOampTimestampErr, "OAMP_TIME_STAMP_ERR", cpu_port));
    SHR_IF_ERR_EXIT(appl_dnx_oam_single_punt_config(unit, bcmRxTrapOampTrapErr, "OAMP_TRAP_ERR", cpu_port));
    SHR_IF_ERR_EXIT(appl_dnx_oam_single_punt_config(unit, bcmRxTrapOampMplsLmDmErr, "OAMP_MPLS_LM_DM_ERR", cpu_port));
    SHR_IF_ERR_EXIT(appl_dnx_oam_single_punt_config
                    (unit, bcmRxTrapOampRmepStateChange, "OAMP_RMEP_STATE_CHANGE", cpu_port));
    SHR_IF_ERR_EXIT(appl_dnx_oam_single_punt_config(unit, bcmRxTrapOampYourDiscErr, "OAMP_YOUR_DISC_ERR", cpu_port));
    SHR_IF_ERR_EXIT(appl_dnx_oam_single_punt_config(unit, bcmRxTrapOampSrcIpErr, "OAMP_SRC_IP_ERR", cpu_port));

    if (dnx_data_oam.oamp.feature_get(unit, dnx_data_oam_oamp_oamp_v2) == 0)
    {
        SHR_IF_ERR_EXIT(appl_dnx_oam_single_punt_config
                        (unit, bcmRxTrapOampFlexCrcMissErr, "OAMP_FLEX_CRC_MISS_ERR", cpu_port));
        SHR_IF_ERR_EXIT(appl_dnx_oam_single_punt_config
                        (unit, bcmRxTrapOampChanTypeMissErr, "OAMP_CHAN_TYPE_MISS_ERR", cpu_port));
        SHR_IF_ERR_EXIT(appl_dnx_oam_single_punt_config(unit, bcmRxTrapOampSrcPortErr, "OAMP_SRC_PORT_ERR", cpu_port));
        SHR_IF_ERR_EXIT(appl_dnx_oam_single_punt_config(unit, bcmRxTrapOampParityErr, "OAMP_PARITY_ERR", cpu_port));
        SHR_IF_ERR_EXIT(appl_dnx_oam_single_punt_config
                        (unit, bcmRxTrapOampPuntNextGoodPacket, "OAMP_PUNT_NEXT_GOOD_PACKET", cpu_port));
    }
    else
    {
    }
    ...
    oam_traps_t * oam_traps)
{
    ...
    else
    {
         ...
         */
        SHR_IF_ERR_EXIT(appl_dnx_oam_trap_config(unit, bcmRxTrapOamEthAccelerated, &oam_traps->oamp_eth_trap_id,
                                                 &trap_config));

        /*
         * Set OAM performance OAMP trap
         */
        SHR_IF_ERR_EXIT(appl_dnx_oam_trap_config(unit, bcmRxTrapOamPerformanceEthAccelerated,
         ...
         */
        SHR_IF_ERR_EXIT(appl_dnx_oam_trap_config(unit, bcmRxTrapOamY1731MplsTp, &trap_id, &trap_config));

        /*
         * Set  Y.1731 over MPLS-TP performance trap.
         */
        SHR_IF_ERR_EXIT(appl_dnx_oam_trap_config(unit, bcmRxTrapOamPerformanceY1731MplsTp,
         ...
         */
        SHR_IF_ERR_EXIT(appl_dnx_oam_trap_config(unit, bcmRxTrapOamY1731Pwe, &trap_id, &trap_config));

        /*
         * Set Y.1731 over PWE performance trap
         */
        SHR_IF_ERR_EXIT(appl_dnx_oam_trap_config(unit, bcmRxTrapOamPerformanceY1731Pwe,
    ...
    else
    {
         ...
         */
        SHR_IF_ERR_EXIT(appl_dnx_oam_trap_config(unit, bcmRxTrapBfdOamDownMEP, &oam_traps->downmep_trap_id,
                                                 &trap_config));
        /*
         * Set OAM Level trap
         */
        SHR_IF_ERR_EXIT(appl_dnx_oam_trap_config(unit, bcmRxTrapOamLevel, &oam_traps->level_trap_id, &trap_config));

        /*
         * Set OAM passive trap
         */
        SHR_IF_ERR_EXIT(appl_dnx_oam_trap_config(unit, bcmRxTrapOamPassive, &oam_traps->passive_trap_id, &trap_config));

        /*
         *  Set OAM snoop trap
         */
        SHR_IF_ERR_EXIT(appl_dnx_oam_snoop_config(unit, cpu_port, oam_traps));
        ...
        if (count >= 1)
        {
            ...
            {
                SHR_IF_ERR_EXIT(appl_dnx_oam_punt_config(unit, cpu_port));
            }
            {
                /** UP-MEP configuration(egress side) */
                SHR_IF_ERR_EXIT(appl_dnx_oam_up_mep_trap_init(unit, cpu_port, oamp_gport[0], oam_traps));
            }
        }
    }
    ...
    int unit)
{
    ...
    else
    {
         ...
         */
        SHR_IF_ERR_EXIT(appl_dnx_oam_trap_config(unit, bcmRxTrapEgBfdIpv6InvalidUdpChecksum, &udp_checksum_trap_id,
                                                 &trap_config));
    }
    ...
    bfd_traps_t * bfd_traps)
{
    ...
    else
    {
         ...
         */
        SHR_IF_ERR_EXIT(appl_dnx_oam_trap_config(unit, bcmRxTrapOamBfdIpv4, &bfd_traps->ipv4_trap_id, &trap_config));
        ...
        if (dnx_data_oam.oamp.feature_get(unit, dnx_data_oam_oamp_oamp_v2) == 0)
        {
            trap_config_bfd_ipv6.egress_forwarding_index = 7;   /* use oam offset */
            trap_config_bfd_ipv6.forwarding_header = 7; /* use oam offset */
        }
        SHR_IF_ERR_EXIT(appl_dnx_oam_trap_config(unit, bcmRxTrapOamBfdIpv6, &bfd_traps->ipv6_trap_id,
                                                 &trap_config_bfd_ipv6));

        /*
         * Set  BFD over MPLS trap.
         */
        SHR_IF_ERR_EXIT(appl_dnx_oam_trap_config(unit, bcmRxTrapOamBfdMpls, &bfd_traps->mpls_trap_id, &trap_config));

        /*
         * Set BFD over PWE trap
         */
        SHR_IF_ERR_EXIT(appl_dnx_oam_trap_config(unit, bcmRxTrapOamBfdPwe, &bfd_traps->pwe_trap_id, &trap_config));

        /*
         * Set  trap for BFD VCCV Type 1 With IP encapsulation.
         */
        trap_config.flags |= (BCM_RX_TRAP_UPDATE_EGRESS_FWD_INDEX | BCM_RX_TRAP_UPDATE_FORWARDING_HEADER);
        trap_config.egress_forwarding_index = 5;
        trap_config.forwarding_header = 5;
        SHR_IF_ERR_EXIT(appl_dnx_oam_trap_config(unit, bcmRxTrapOamBfdCcMplsTp, &bfd_traps->mpls_vccv_trap_id,
                                                 &trap_config));
    }
        ...
        for (opcode_index = 0; opcode_index < nof_supported_opcodes; opcode_index++)
        {
            ...
            for (endpoint_type = endpoint_type_start; endpoint_type <= endpoint_type_end; endpoint_type++)
            {
                ...
                if (skip_config == 0)
                {
                     ...
                     */
                    SHR_IF_ERR_EXIT(bcm_oam_profile_action_set(unit, flags, profile_id, &action_key, &action_result));
                }
            }
        }
    }
    ...
    oam_traps_t oam_traps)
{
    ...
    SHR_IF_ERR_EXIT(bcm_oam_profile_create(unit, flags, oam_profile_type, &profile_id));
     ...
     */
    SHR_IF_ERR_EXIT(appl_dnx_oam_default_profile_set(unit, is_ingress, NOT_ACCELERATED, profile_id,
                                                     active_dest_gport, &oam_traps));
    ...
    oam_traps_t oam_traps)
{
    ...
    flags = BCM_OAM_NO_FLAG;    /* Setting no flags. Default LM type will be SINGLE ENDED LM */
    SHR_IF_ERR_EXIT(bcm_oam_profile_create(unit, flags, oam_acc_profile_type, &acc_profile_id));
     ...
     */
    SHR_IF_ERR_EXIT(appl_dnx_oam_default_profile_set(unit, is_ingress, ACCELERATED, acc_profile_id,
                                                     active_dest_gport, &oam_traps));
    ...
    int counter_enable)
{
    ...
    bcm_oam_profile_t profile_id = 0;
    SHR_FUNC_INIT_VARS(unit);
    ...
    SHR_IF_ERR_EXIT(bcm_oam_profile_id_get_by_type
                    (unit, reserved_acc_egr_profile_id, bcmOAMProfileEgressAcceleratedEndpoint, &flags, &profile_id));
     ...
     */
    SHR_IF_ERR_EXIT(bcm_oam_profile_action_get(unit, flags, profile_id, &oam_action_key, &oam_action_result));

    oam_action_result.counter_increment = counter_enable;
    oam_action_result.destination = BCM_GPORT_INVALID;

    /*
     * Set new profile configuration, with and without da-is-mc
     */
    SHR_IF_ERR_EXIT(bcm_oam_profile_action_set(unit, flags, profile_id, &oam_action_key, &oam_action_result));

    oam_action_key.dest_mac_type = bcmOAMDestMacTypeMcast;
    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(appl_dnx_oam_trap_init(unit, &oam_traps));

    SHR_IF_ERR_EXIT(appl_dnx_bfd_trap_init(unit, &bfd_traps));

    {
        SHR_IF_ERR_EXIT(appl_dnx_bfd_ipv6_invalid_udp_checksum(unit));

        /*
         * Set OAM up MEP reflectors
         */
        SHR_IF_ERR_EXIT(appl_dnx_oam_upmep_reflector_init(unit, &oam_traps));
    }

    /*
     * Set OAM down MEP reflectors
     */
    SHR_IF_ERR_EXIT(appl_dnx_oam_downmep_reflector_init(unit, &oam_traps));

    /*
     * Configure the default profile on ingress side
     */
    SHR_IF_ERR_EXIT(appl_dnx_oam_configure_default_profile(unit, INGRESS_SIDE, oam_traps));

    /*
     * Configure the default accelerated profile on ingress side
     */
    SHR_IF_ERR_EXIT(appl_dnx_oam_configure_default_acc_profile(unit, INGRESS_SIDE, oam_traps));

    /*
     * Configure the default profile on egress side
     */
    SHR_IF_ERR_EXIT(appl_dnx_oam_configure_default_profile(unit, EGRESS_SIDE, oam_traps));

    /*
     * Configure the default accelerated profile  on egress side
     */
    SHR_IF_ERR_EXIT(appl_dnx_oam_configure_default_acc_profile(unit, EGRESS_SIDE, oam_traps));
    ...
    if (indexed_mode_enable == IN_LIF_PROFILE_PWE_INDEXED_MODE_NOF_VALUES)
    {
        ...
        SHR_IF_ERR_EXIT(bcm_oam_control_set(unit, bcmOamControlNativeEthernetOverPweClassification, arg));
    }

    {
         ...
         */
        SHR_IF_ERR_EXIT(appl_bcm_dnx_oam_failover_state_ignore_set(unit));
        ...
        {
            SHR_IF_ERR_EXIT(appl_dnx_oam_hlm_egress_with_update_counter_in_egr_acc_profile(unit, opcodes_dis_cnt[i],
                                                                                           0));
        }
    }
exit:
