    ...
    int unit)
{
    ...
    {
        /*
         * Add 2 entries per last entry:
         * 1. Without additional 8B TLV
         * 2. With additional 8B TLV
         */
        ...
        ent_info.entry_action[0].value[0] += 8;
        SHR_IF_ERR_EXIT(bcm_field_entry_add(unit, 0, fg_id, &ent_info, &ent_id));
    }
    ...
    int unit)
{
    ...
    /*
     * Give the USP trap a default strength of 7.
     */
    bcm_rx_trap_config_t_init(&trap_config);
    trap_config.trap_strength = 7;
    SHR_IF_ERR_EXIT(bcm_rx_trap_set(unit, trap_id_srv6, &trap_config));
