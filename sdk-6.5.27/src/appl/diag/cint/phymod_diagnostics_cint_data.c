...
CINT_FWRAPPER_CREATE_RP2(int, int, 0, 0,
                         phymod_phy_tx_pattern_get,
                         phymod_phy_access_t*, phymod_phy_access_t, phy, 1, 0,
                         phymod_phy_tx_pattern_t*, phymod_phy_tx_pattern_t, tx_pattern, 1, 0);

CINT_FWRAPPER_CREATE_RP2(int, int, 0, 0,
                         phymod_phy_tx_pattern_set,
                         phymod_phy_access_t*, phymod_phy_access_t, phy, 1, 0,
                         phymod_phy_tx_pattern_t, phymod_phy_tx_pattern_t, tx_pattern, 0, 0);
...
CINT_FWRAPPER_CREATE_RP2(int, int, 0, 0,
                         phymod_phy_linkcat,
                         phymod_phy_access_t*, phymod_phy_access_t, phy, 1, 0,
                         phymod_linkcat_config_t, phymod_linkcat_config_t, linkcat_config, 0, 0);
...
CINT_FWRAPPER_CREATE_RP2(int, int, 0, 0,
                         phymod_phy_fec_error_bits_counter_get,
                         phymod_phy_access_t*, phymod_phy_access_t, phy, 1, 0,
                         uint32_t*, uint32_t, count, 1, 0);

CINT_FWRAPPER_CREATE_RP2(int, int, 0, 0,
                         phymod_phy_fec_error_inject_config_get,
                         phymod_phy_access_t*, phymod_phy_access_t, phy, 1, 0,
                         phymod_fec_error_injection_config_t*, phymod_fec_error_injection_config_t, error_injection_config, 1, 0);

CINT_FWRAPPER_CREATE_RP2(int, int, 0, 0,
                         phymod_phy_fec_error_inject_config_set,
                         phymod_phy_access_t*, phymod_phy_access_t, phy, 1, 0,
                         phymod_fec_error_injection_config_t*, phymod_fec_error_injection_config_t, error_injection_config, 1, 0);

CINT_FWRAPPER_CREATE_RP2(int, int, 0, 0,
                         phymod_phy_fec_error_inject_enable_get,
                         phymod_phy_access_t*, phymod_phy_access_t, phy, 1, 0,
                         phymod_fec_error_injection_enable_t*, phymod_fec_error_injection_enable_t, error_injection_enable, 1, 0);

CINT_FWRAPPER_CREATE_RP2(int, int, 0, 0,
                         phymod_phy_fec_error_inject_enable_set,
                         phymod_phy_access_t*, phymod_phy_access_t, phy, 1, 0,
                         phymod_fec_error_injection_enable_t*, phymod_fec_error_injection_enable_t, error_injection_enable, 1, 0);
...
static cint_function_t __cint_functions[] =
{
    ...
    CINT_FWRAPPER_ENTRY(phymod_phy_tx_pattern_get),
    CINT_FWRAPPER_ENTRY(phymod_phy_tx_pattern_set),
    ...
    CINT_FWRAPPER_ENTRY(phymod_phy_fec_error_bits_counter_get),
    CINT_FWRAPPER_ENTRY(phymod_phy_fec_error_inject_config_get),
    CINT_FWRAPPER_ENTRY(phymod_phy_fec_error_inject_config_set),
    CINT_FWRAPPER_ENTRY(phymod_phy_fec_error_inject_enable_get),
    CINT_FWRAPPER_ENTRY(phymod_phy_fec_error_inject_enable_set),
    { NULL }
};
...
static void*
__cint_maddr__phymod_linkcat_config_t(void* p, int mnum, cint_struct_type_t* parent)
{
    void* rv;
    phymod_linkcat_config_t* s = (phymod_linkcat_config_t*) p;
    switch(mnum)
    {
        case 0: rv = &(s->mode);break;
        case 1: rv = &(s->donot_change_osr);break;
        default: rv = NULL; break;
    }
    return rv;
}
...
__cint_maddr__phymod_fec_error_mask_t(void* p, int mnum, cint_struct_type_t* parent)
{
    ...
    switch(mnum)
    {
        ...
        case 3: rv = &(s->error_injection_freq);break;
        default: rv = NULL; break;
    }
    return rv;
}
...
static void*
__cint_maddr__phymod_fec_error_injection_config_t(void* p, int mnum, cint_struct_type_t* parent)
{
    void* rv;
    phymod_fec_error_injection_config_t* s = (phymod_fec_error_injection_config_t*) p;
    switch(mnum)
    {
        case 0: rv = &(s->error_mask_bit_31_0);break;
        case 1: rv = &(s->error_mask_bit_63_32);break;
        case 2: rv = &(s->error_mask_bit_79_64);break;
        case 3: rv = &(s->block_offset);break;
        case 4: rv = &(s->contiguous_blocks_count);break;
        case 5: rv = &(s->error_injection_freq);break;
        default: rv = NULL; break;
    }
    return rv;
}
...
static void*
__cint_maddr__phymod_fec_error_injection_enable_t(void* p, int mnum, cint_struct_type_t* parent)
{
    void* rv;
    phymod_fec_error_injection_enable_t* s = (phymod_fec_error_injection_enable_t*) p;
    switch(mnum)
    {
        case 0: rv = &(s->codeword_1_enable);break;
        case 1: rv = &(s->codeword_2_enable);break;
        case 2: rv = &(s->codeword_1_parity_enable);break;
        case 3: rv = &(s->codeword_2_parity_enable);break;
        default: rv = NULL; break;
    }
    return rv;
}
...
static cint_parameter_desc_t __cint_struct_members__phymod_linkcat_config_t[] = 
{
    {"phymod_linkCAT_op_mode_t", "mode", 0, 0},
    {"int", "donot_change_osr", 0, 0},
    { NULL }
};
...
static cint_parameter_desc_t __cint_struct_members__phymod_fec_error_mask_t[] = 
{
    ...
    {"uint32_t", "error_injection_freq", 0, 0},
    { NULL }
};

static cint_parameter_desc_t __cint_struct_members__phymod_fec_error_injection_config_t[] = 
{
    {"uint32_t", "error_mask_bit_31_0", 0, 0},
    {"uint32_t", "error_mask_bit_63_32", 0, 0},
    {"uint16_t", "error_mask_bit_79_64", 0, 0},
    {"uint32_t", "block_offset", 0, 0},
    {"uint32_t", "contiguous_blocks_count", 0, 0},
    {"uint32_t", "error_injection_freq", 0, 0},
    { NULL }
};

static cint_parameter_desc_t __cint_struct_members__phymod_fec_error_injection_enable_t[] = 
{
    {"uint32_t", "codeword_1_enable", 0, 0},
    {"uint32_t", "codeword_2_enable", 0, 0},
    {"uint32_t", "codeword_1_parity_enable", 0, 0},
    {"uint32_t", "codeword_2_parity_enable", 0, 0},
    { NULL }
};
...
static cint_struct_type_t __cint_structures[] =
{
    ...
    {
    "phymod_linkcat_config_t",
    sizeof(phymod_linkcat_config_t),
    __cint_struct_members__phymod_linkcat_config_t,
    __cint_maddr__phymod_linkcat_config_t
    },
    {
    ...
    {
    "phymod_fec_error_injection_config_t",
    sizeof(phymod_fec_error_injection_config_t),
    __cint_struct_members__phymod_fec_error_injection_config_t,
    __cint_maddr__phymod_fec_error_injection_config_t
    },
    {
    "phymod_fec_error_injection_enable_t",
    sizeof(phymod_fec_error_injection_enable_t),
    __cint_struct_members__phymod_fec_error_injection_enable_t,
    __cint_maddr__phymod_fec_error_injection_enable_t
    },
    { NULL }
};
...
static cint_enum_map_t __cint_enum_map__phymod_eyescan_mode_t[] =
{
    ...
    { "phymodEyescanModeIntrusive", phymodEyescanModeIntrusive },
...
static cint_enum_map_t __cint_enum_map__phymod_diag_type_t[] =
{
    ...
    { "phymod_diag_DFE_TAPS", phymod_diag_DFE_TAPS },
...
static cint_enum_map_t __cint_enum_map__phymod_phy_tx_pattern_t[] =
{
    { "phymodPhyTxPatternOff", phymodPhyTxPatternOff },
    { "phymodPhyTxPatternPAM4_JP03B", phymodPhyTxPatternPAM4_JP03B },
    { "phymodPhyTxPatternPAM4_Linear", phymodPhyTxPatternPAM4_Linear },
    { "phymodPhyTxPatternCustom", phymodPhyTxPatternCustom },
    { "phymodPhyTxPatternCount", phymodPhyTxPatternCount },
    { NULL }
};
...
static cint_enum_map_t __cint_enum_map__phymod_linkCAT_op_mode_t[] =
{
    ...
    { "phymodlinkCAT_PRE_RX", phymodlinkCAT_PRE_RX },
    { "phymodlinkCAT_RX_MEASURE", phymodlinkCAT_RX_MEASURE },
    { "phymodlinkCAT_DNC_OSR_UNSET", phymodlinkCAT_DNC_OSR_UNSET },
    { "phymodlinkCAT_DNC_OSR_SET", phymodlinkCAT_DNC_OSR_SET },
...
static cint_enum_type_t __cint_enums[] =
{
    ...
    {"phymod_phy_tx_pattern_t", __cint_enum_map__phymod_phy_tx_pattern_t },
...
static cint_constants_t __cint_constants[] =
{
    ...
    { "PHYMOD_NUM_CUSTOM_PATTERN_WORD", PHYMOD_NUM_CUSTOM_PATTERN_WORD },
