...
CINT_FWRAPPER_CREATE_VP4(soc_schan_dump,
                         int,int,unit,0,0,
                         schan_msg_t *,schan_msg_t,msg,1,0,
                         int,int,dwc,0,0,
                         int,int,verbosity,0,0);
...
CINT_FWRAPPER_CREATE_RP5(int,int,0,0,
                         soc_interrupt_counter_list_get,
                         int,int,unit,0,0,
                         uint32,uint32,flags,0,0,
                         int*,int,intr_number,1,0,
                         int*,int,intr_list,1,0,
                         uint32*,uint32,count_list,1,0);
#endif
...
#if defined(BCM_DNXF_SUPPORT) || defined(BCM_DNX_SUPPORT)
        CINT_FWRAPPER_ENTRY(soc_interrupt_counter_list_get),
#endif
