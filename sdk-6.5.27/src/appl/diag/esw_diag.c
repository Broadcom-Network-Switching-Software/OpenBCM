...
char if_esw_phy_usage[] =
    ...
    "   fecstat - periodically collects FEC status counters such as\n\t"
    "          corrected and uncorrected FEC codewords, symbols error and\n\t"
    "          and bits error for a given port.\n\t"
    "          The command then uses the bits error count to compute pre-FEC\n\t"
    "          bit error rate for the port, and uses symbols error count to \n\t"
    "          compute the symbol error rate for each lane of the port.\n\t"
    "          Parameters:\n\t"
    "             [STArt [Interval=<secs>]]\n\t"
    "             [STOp]\n\t"
    "             [Counters]\n\t"
...
#else
    "Parameters: <pbmp> [[ENCap=IEEE|HIGIG|B5632|HIGIG2|HGOE|HIGIG3]\n\t"
...
char cmd_esw_tx_usage[] =
    ...
    "      L3Routed=<val>      - L3 Routed\n"
    "      Mirror=<val>        - Mirror packet\n"
    "      MultiPoint=<val>    - MultiPoint\n"
    "      DestVP=<val>        - Destination VP\n"
    "      SrcVP=<val>         - Source VP\n"
    "      DonotLearn=<val>    - Do Not Learn\n"
    "      LagFailover=<val>   - Lag Failover\n"
#endif
