    ...
    char *fname)
{
    ...
    if (filesize < sizeof(uint32) * 9)
    {
        SHR_EXIT_WITH_LOG(_SHR_E_INTERNAL, "File %s too small: %d bytes%s\n", fname, filesize, EMPTY);
    }
...
#ifndef NO_FILEIO
    {"LOAD", sh_sand_mbist_load_cmd, NULL, sand_mbist_load_options, &sh_sand_mbist_load_man, NULL, NULL,
     SH_CMD_NOT_RELEASE}
    ,
#endif
    {"Stop_On_Error", sh_sand_mbist_stop_on_error_cmd, NULL, sand_mbist_stop_on_error_options,
     &sh_sand_mbist_stop_on_error_man, NULL, NULL, SH_CMD_NOT_RELEASE}
    ,
    {"Test", sh_sand_mbist_test_cmd, NULL, sand_mbist_test_options, &sh_sand_mbist_test_man, NULL, NULL,
     SH_CMD_NOT_RELEASE}
    ,
    {"Device_Data", sh_sand_mbist_device_data_cmd, NULL, sand_mbist_device_data_options, &sh_sand_mbist_device_data_man,
     NULL, NULL, SH_CMD_NOT_RELEASE}
    ,
#ifndef NO_FILEIO
    {"Print", sh_sand_mbist_print_cmd, NULL, sand_mbist_print_options, &sh_sand_mbist_print_man, NULL, NULL,
     SH_CMD_NOT_RELEASE}
    ,
#endif
    {NULL}
    ...
    args_t * args)
{
    ...
    sh_sand_act(unit, args, sh_sand_mbist_cmds, sh_sand_sys_cmds, NULL, SH_CMD_FLAGS_NONE);
    ARG_DISCARD(args);
    /*
