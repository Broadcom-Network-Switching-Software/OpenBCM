...
#ifdef INCLUDE_AUTOCOMPLETE
/**
 * \brief A callback that serves to add autocomplete support - starting from root commands
 * \par DIRECT INPUT:
 *     \param [in] unit unit id
 *     \param [in] root_cmds root commands tree
 */
void sh_sand_cmd_autocomplete_init_root(
    int unit,
