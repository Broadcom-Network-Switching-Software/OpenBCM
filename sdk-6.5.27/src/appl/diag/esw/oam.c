    ...
    bcm_oam_endpoint_t endpoint, void *user_data)
{
    ...
    switch (event_type)
    {
        ...
        case bcmOAMEventEndpointInterfaceTesting:
            oam_event_string = "Interface TLV Testing";
            group_valid = 1;
            endpoint_valid = 1;
            break;

        case bcmOAMEventEndpointInterfaceUnkonwn:
            oam_event_string = "Interface TLV Unknown";
            group_valid = 1;
            endpoint_valid = 1;
            break;

        case bcmOAMEventEndpointInterfaceDormant:
            oam_event_string = "Interface TLV Dormant";
            group_valid = 1;
            endpoint_valid = 1;
            break;

        case bcmOAMEventEndpointInterfaceNotPresent:
            oam_event_string = "Interface TLV NotPresent";
            group_valid = 1;
            endpoint_valid = 1;
            break;

        case bcmOAMEventEndpointInterfaceLLDown:
            oam_event_string = "Interface TLV LLDown";
            group_valid = 1;
            endpoint_valid = 1;
            break;

        case bcmOAMEventEndpointInterfaceTestingToUp:
            oam_event_string = "Interface TLV Testing to UP";
            group_valid = 1;
            endpoint_valid = 1;
            break;

        case bcmOAMEventEndpointInterfaceUnknownToUp:
            oam_event_string = "Interface TLV Unknown to UP";
            group_valid = 1;
            endpoint_valid = 1;
            break;

        case bcmOAMEventEndpointInterfaceDormantToUp:
            oam_event_string = "Interface TLV Dormant to UP";
            group_valid = 1;
            endpoint_valid = 1;
            break;

        case bcmOAMEventEndpointInterfaceNotPresentToUp:
            oam_event_string = "Interface TLV NotPresent to UP";
            group_valid = 1;
            endpoint_valid = 1;
            break;

        case bcmOAMEventEndpointInterfaceLLDownToUp:
            oam_event_string = "Interface TLV LLDown to UP";
            group_valid = 1;
            endpoint_valid = 1;
            break;
...
char cmd_esw_oam_usage[] = 
    ...
    "      [P0=#] [P1=#]\n"
#endif /* !BCM_ENDURO_SUPPORT || !BCM_TRIUMPH3_SUPPORT */
#if defined(BCM_KATANA_SUPPORT) || defined(BCM_TRIUMPH3_SUPPORT) || defined(BCM_HURRICANE3_SUPPORT) || defined(BCM_GREYHOUND_SUPPORT)
...
#endif /* !BCM_ENDURO_SUPPORT || !BCM_TRIUMPH3_SUPPORT */
#if defined(BCM_KATANA_SUPPORT) || defined(BCM_TRIUMPH3_SUPPORT) || defined(BCM_HURRICANE2_SUPPORT)
    int cpu_pri;
...
#if defined(BCM_KATANA_SUPPORT) || defined(BCM_TRIUMPH3_SUPPORT) || defined(BCM_KATANA2_SUPPORT) || defined(BCM_SABER2_SUPPORT)
