...
do_dump_sw(int unit, args_t *a)
{
    ...
    if (dump_all || !sal_strcasecmp(c, "l3")) {
        uint32 l3_sw_dump_bitmap = 0xffffffff;
        char *sub_c;
        if ((sub_c = ARG_GET(a)) != NULL) {
            if (!sal_strcasecmp(sub_c, "intf")) {
                l3_sw_dump_bitmap = _BCM_L3_DUMP_BITMAP_INTF;
            } else if (!sal_strcasecmp(sub_c, "defip")) {
                l3_sw_dump_bitmap = _BCM_L3_DUMP_BITMAP_DEFIP;
            } else if (!sal_strcasecmp(sub_c, "host")) {
                l3_sw_dump_bitmap = _BCM_L3_DUMP_BITMAP_HOST;
            } else if (!sal_strcasecmp(sub_c, "ecmp")) {
                l3_sw_dump_bitmap = _BCM_L3_DUMP_BITMAP_ECMP;
            } else if (!sal_strcasecmp(sub_c, "nexthop")) {
                l3_sw_dump_bitmap = _BCM_L3_DUMP_BITMAP_NH;
            } else if (!sal_strcasecmp(sub_c, "tunnel")) {
                l3_sw_dump_bitmap = _BCM_L3_DUMP_BITMAP_TUNNEL;
            } else if (!sal_strcasecmp(sub_c, "alpm")) {
                l3_sw_dump_bitmap = _BCM_L3_DUMP_BITMAP_ALPM;
            } else if (!sal_strcasecmp(sub_c, "dgm")) {
                l3_sw_dump_bitmap = _BCM_L3_DUMP_BITMAP_DGM;
            }
        }
        _bcm_l3_sw_dump(unit, l3_sw_dump_bitmap);
    }
#endif
...
bypass_dump_table(int unit, soc_mem_t mem, uint32 copyno, int flags)
{
    ...
    int port = 0 , phy_port = 0, blk_num = 0 ;
     int port_found = 0;
#endif
    memp = &SOC_MEM_INFO(unit, mem);
        ...
        if (SOC_BLOCK_TYPE(unit, copyno) == SOC_BLK_CPRI) {
            ...
            PBMP_ITER(PBMP_ROE_ALL(unit), port)  {
               ...
               if (blk_num == copyno ) {
                   port_found = 1;
                   switch(mem) {
                    case CPRI_ENCAP_DATA_0m:
                    case CPRI_GCW_CFG_TAB_CFG_0m:
                    case CPRI_DECAP_DATA_0m:
                    case CPRI_DECAP_QUEUE_STS_0m:
                    case CPRI_DECAP_QUEUE_STATS_0m:
                    case CPRI_DECAP_ULAW_LUT_0m:
                    case CPRI_BFA_TAB0_CFG_0m:
                    case CPRI_BFA_TAB1_CFG_0m:
                    case CPRI_CA_MAP_TAB_CFG_0m:
                    case CPRI_CA_PAY_TAB_CFG_0m:
                    case CPRI_CA_MAP_STATE_TAB_STS_0m:
                    case CPRI_IQU_BUFFER_STS_0m:
                    case CPRI_IQU_STATE_STS_0m:
                    case CPRI_DECAP_FLOWID_QUE_LOOKUP_0m:
                    case CPRI_DECAP_FLOW_CONTROL_0m:
                    case CPRI_DECAP_CLS_TO_QUEUE_LOOKUP_0m:
                    case CPRI_DECAP_QUE_NUM_TO_ORDERING_INDEX_0m:
                    case CPRI_DECAP_ORDERING_INFO_TAB_0m:
                    case CPRI_DECAP_ORDERING_SEQOFF_TAB_0m:
                    case CPRI_CWA_VSD_CTRL_FLOW_BUFFER0_STS_0m:
                    case CPRI_CWA_VSD_CTRL_CONFIG_CFG_0m:
                    case CPRI_CWA_VSD_CTRL_FLOWID_MAP_TAB_CFG_0m:
                    case CPRI_CWA_VSD_CTRL_GRP_CFG_TAB_CFG_0m:
                    case CPRI_CWA_VSD_CTRL_GRP_ASSIGN_CFG_TAB_CFG_0m:
                    case CPRI_CWA_VSD_RAW_LOC_TAB_CFG_0m:
                    case CPRI_CWA_VSD_RAW_MAP_TAB_CFG_0m:
                    case CPRI_CWA_GCW_CFG_TAB_CFG_0m:
                    case CPRI_DECAP_COMP_TAB_0m:
                    case CPRI_CWA_GCW_REGS_CFG_0m:
                    case CPRI_ENCAP_QUEUE_STS_0m:
                    case CPRI_ENCAP_QUEUE_STATS_0m:
                    case CPRI_BFP_TAB0_CFG_0m:
                    case CPRI_BFP_TAB1_CFG_0m:
                    case CPRI_CPRSR_MAP_TAB_CFG_0m:
                    case CPRI_CPRSR_IQ_PK_BUFF_CFG_0m:
                    case CPRI_CPRSR_MAP_STATE_TAB_STS_0m:
                    case CPRI_IQ_PK_BUFF_AXC_PLD_STS_0m:
                    case CPRI_IQ_PK_BUFF_AXC_STATE_STS_0m:
                    case CPRI_VSDCTRL_CFLW_BUF_TAB_STS_0m:
                    case CPRI_VSDCTRL_CFLW_PGC_TAB_CFG_0m:
                    case CPRI_VSDCTRL_NUM_SEC_TAB_CFG_0m:
                    case CPRI_VSDCTRL_GRP_STT_TAB_STS_0m:
                    case CPRI_VSDCTRL_GRP_CFG_TAB_CFG_0m:
                    case CPRI_VSDCTRL_GRP_ASSIGN_TAB_CFG_0m:
                    case CPRI_VSDRAW_LOC_TAB_CFG_0m:
                    case CPRI_VSDRAW_FLT_TAB_CFG_0m:
                    case CPRI_VSDRAW_STATE_TAB_STS_0m:
                    case CPRI_HDR_CMP_TAB_CFG_0m:
                    case CPRI_ENCAP_ORDERING_INFO_TAB_0m:
                    case CPRI_ENCAP_ORDERING_INFO_STS_0m:
                    case CPRI_ENCAP_QUE_ETH_HDR_0m:
                    case CPRI_ENCAP_QUE_DA_TAB_0m:
                    case CPRI_ENCAP_QUE_SA_TAB_0m:
                    case CPRI_ENCAP_QUE_VLAN0_TAB_0m:
                    case CPRI_ENCAP_QUE_VLAN1_TAB_0m:
                    case CPRI_ENCAP_QUE_CTL_FLOWID_TAB_0m:
                    case BRCM_RESERVED_CPM_18m:
                    case BRCM_RESERVED_CPM_23m:
                    case BRCM_RESERVED_CPM_27m:
                    case BRCM_RESERVED_CPM_31m:
                    case BRCM_RESERVED_CPM_35m:
                    case BRCM_RESERVED_CPM_39m:
                    case BRCM_RESERVED_CPM_60m:
                    case BRCM_RESERVED_CPM_44m:
                    case BRCM_RESERVED_CPM_48m:
                    case BRCM_RESERVED_CPM_52m:
                    case BRCM_RESERVED_CPM_56m:
                    case BRCM_RESERVED_CPM_335m:
                    case BRCM_RESERVED_CPM_339m:
                    case CPRI_CWA_VSD_CTRL_FLOW_BUFFER1_STS_0m:

                        if ((phy_port % 4) != 1)  {
                             return TRUE;
                        }
                        break;
                    case CPRI_ENCAP_DATA_1m:
                    case CPRI_GCW_CFG_TAB_CFG_1m:
                    case CPRI_DECAP_DATA_1m:
                    case CPRI_DECAP_QUEUE_STS_1m:
                    case CPRI_DECAP_QUEUE_STATS_1m:
                    case CPRI_DECAP_ULAW_LUT_1m:
                    case CPRI_BFA_TAB0_CFG_1m:
                    case CPRI_BFA_TAB1_CFG_1m:
                    case CPRI_CA_MAP_TAB_CFG_1m:
                    case CPRI_CA_PAY_TAB_CFG_1m:
                    case CPRI_CA_MAP_STATE_TAB_STS_1m:
                    case CPRI_IQU_BUFFER_STS_1m:
                    case CPRI_IQU_STATE_STS_1m:
                    case CPRI_DECAP_FLOWID_QUE_LOOKUP_1m:
                    case CPRI_DECAP_FLOW_CONTROL_1m:
                    case CPRI_DECAP_CLS_TO_QUEUE_LOOKUP_1m:
                    case CPRI_DECAP_QUE_NUM_TO_ORDERING_INDEX_1m:
                    case CPRI_DECAP_ORDERING_INFO_TAB_1m:
                    case CPRI_DECAP_ORDERING_SEQOFF_TAB_1m:
                    case CPRI_CWA_VSD_CTRL_FLOW_BUFFER0_STS_1m:
                    case CPRI_CWA_VSD_CTRL_CONFIG_CFG_1m:
                    case CPRI_CWA_VSD_CTRL_FLOWID_MAP_TAB_CFG_1m:
                    case CPRI_CWA_VSD_CTRL_GRP_CFG_TAB_CFG_1m:
                    case CPRI_CWA_VSD_CTRL_GRP_ASSIGN_CFG_TAB_CFG_1m:
                    case CPRI_CWA_VSD_RAW_LOC_TAB_CFG_1m:
                    case CPRI_CWA_VSD_RAW_MAP_TAB_CFG_1m:
                    case CPRI_CWA_GCW_CFG_TAB_CFG_1m:
                    case CPRI_DECAP_COMP_TAB_1m:
                    case CPRI_CWA_GCW_REGS_CFG_1m:
                    case CPRI_ENCAP_QUEUE_STS_1m:
                    case CPRI_ENCAP_QUEUE_STATS_1m:
                    case CPRI_BFP_TAB0_CFG_1m:
                    case CPRI_BFP_TAB1_CFG_1m:
                    case CPRI_CPRSR_MAP_TAB_CFG_1m:
                    case CPRI_CPRSR_IQ_PK_BUFF_CFG_1m:
                    case CPRI_CPRSR_MAP_STATE_TAB_STS_1m:
                    case CPRI_IQ_PK_BUFF_AXC_PLD_STS_1m:
                    case CPRI_IQ_PK_BUFF_AXC_STATE_STS_1m:
                    case CPRI_VSDCTRL_CFLW_BUF_TAB_STS_1m:
                    case CPRI_VSDCTRL_CFLW_PGC_TAB_CFG_1m:
                    case CPRI_VSDCTRL_NUM_SEC_TAB_CFG_1m:
                    case CPRI_VSDCTRL_GRP_STT_TAB_STS_1m:
                    case CPRI_VSDCTRL_GRP_CFG_TAB_CFG_1m:
                    case CPRI_VSDCTRL_GRP_ASSIGN_TAB_CFG_1m:
                    case CPRI_VSDRAW_LOC_TAB_CFG_1m:
                    case CPRI_VSDRAW_FLT_TAB_CFG_1m:
                    case CPRI_VSDRAW_STATE_TAB_STS_1m:
                    case CPRI_HDR_CMP_TAB_CFG_1m:
                    case CPRI_ENCAP_ORDERING_INFO_TAB_1m:
                    case CPRI_ENCAP_ORDERING_INFO_STS_1m:
                    case CPRI_ENCAP_QUE_ETH_HDR_1m:
                    case CPRI_ENCAP_QUE_DA_TAB_1m:
                    case CPRI_ENCAP_QUE_SA_TAB_1m:
                    case CPRI_ENCAP_QUE_VLAN0_TAB_1m:
                    case CPRI_ENCAP_QUE_VLAN1_TAB_1m:
                    case CPRI_ENCAP_QUE_CTL_FLOWID_TAB_1m:
                    case BRCM_RESERVED_CPM_19m:
                    case BRCM_RESERVED_CPM_24m:
                    case BRCM_RESERVED_CPM_28m:
                    case BRCM_RESERVED_CPM_32m:
                    case BRCM_RESERVED_CPM_36m:
                    case BRCM_RESERVED_CPM_40m:
                    case BRCM_RESERVED_CPM_61m:
                    case BRCM_RESERVED_CPM_45m:
                    case BRCM_RESERVED_CPM_49m:
                    case BRCM_RESERVED_CPM_53m:
                    case BRCM_RESERVED_CPM_57m:
                    case BRCM_RESERVED_CPM_336m:
                    case BRCM_RESERVED_CPM_340m:
                    case CPRI_CWA_VSD_CTRL_FLOW_BUFFER1_STS_1m:
                         ...
                         break;
                    case CPRI_ENCAP_DATA_2m:
                    case CPRI_GCW_CFG_TAB_CFG_2m:
                    case CPRI_DECAP_DATA_2m:
                    case CPRI_DECAP_QUEUE_STS_2m:
                    case CPRI_DECAP_QUEUE_STATS_2m:
                    case CPRI_DECAP_ULAW_LUT_2m:
                    case CPRI_BFA_TAB0_CFG_2m:
                    case CPRI_BFA_TAB1_CFG_2m:
                    case CPRI_CA_MAP_TAB_CFG_2m:
                    case CPRI_CA_PAY_TAB_CFG_2m:
                    case CPRI_CA_MAP_STATE_TAB_STS_2m:
                    case CPRI_IQU_BUFFER_STS_2m:
                    case CPRI_IQU_STATE_STS_2m:
                    case CPRI_DECAP_FLOWID_QUE_LOOKUP_2m:
                    case CPRI_DECAP_FLOW_CONTROL_2m:
                    case CPRI_DECAP_CLS_TO_QUEUE_LOOKUP_2m:
                    case CPRI_DECAP_QUE_NUM_TO_ORDERING_INDEX_2m:
                    case CPRI_DECAP_ORDERING_INFO_TAB_2m:
                    case CPRI_DECAP_ORDERING_SEQOFF_TAB_2m:
                    case CPRI_CWA_VSD_CTRL_FLOW_BUFFER0_STS_2m:
                    case CPRI_CWA_VSD_CTRL_FLOW_BUFFER1_STS_2m:
                    case CPRI_CWA_VSD_CTRL_CONFIG_CFG_2m:
                    case CPRI_CWA_VSD_CTRL_FLOWID_MAP_TAB_CFG_2m:
                    case CPRI_CWA_VSD_CTRL_GRP_CFG_TAB_CFG_2m:
                    case CPRI_CWA_VSD_CTRL_GRP_ASSIGN_CFG_TAB_CFG_2m:
                    case CPRI_CWA_VSD_RAW_LOC_TAB_CFG_2m:
                    case CPRI_CWA_VSD_RAW_MAP_TAB_CFG_2m:
                    case CPRI_CWA_GCW_CFG_TAB_CFG_2m:
                    case CPRI_DECAP_COMP_TAB_2m:
                    case CPRI_CWA_GCW_REGS_CFG_2m:
                    case CPRI_ENCAP_QUEUE_STS_2m:
                    case CPRI_ENCAP_QUEUE_STATS_2m:
                    case CPRI_BFP_TAB0_CFG_2m:
                    case CPRI_BFP_TAB1_CFG_2m:
                    case CPRI_CPRSR_MAP_TAB_CFG_2m:
                    case CPRI_CPRSR_IQ_PK_BUFF_CFG_2m:
                    case CPRI_CPRSR_MAP_STATE_TAB_STS_2m:
                    case CPRI_IQ_PK_BUFF_AXC_PLD_STS_2m:
                    case CPRI_IQ_PK_BUFF_AXC_STATE_STS_2m:
                    case CPRI_VSDCTRL_CFLW_BUF_TAB_STS_2m:
                    case CPRI_VSDCTRL_CFLW_PGC_TAB_CFG_2m:
                    case CPRI_VSDCTRL_NUM_SEC_TAB_CFG_2m:
                    case CPRI_VSDCTRL_GRP_STT_TAB_STS_2m:
                    case CPRI_VSDCTRL_GRP_CFG_TAB_CFG_2m:
                    case CPRI_VSDCTRL_GRP_ASSIGN_TAB_CFG_2m:
                    case CPRI_VSDRAW_LOC_TAB_CFG_2m:
                    case CPRI_VSDRAW_FLT_TAB_CFG_2m:
                    case CPRI_VSDRAW_STATE_TAB_STS_2m:
                    case CPRI_HDR_CMP_TAB_CFG_2m:
                    case CPRI_ENCAP_ORDERING_INFO_TAB_2m:
                    case CPRI_ENCAP_ORDERING_INFO_STS_2m:
                    case CPRI_ENCAP_QUE_ETH_HDR_2m:
                    case CPRI_ENCAP_QUE_DA_TAB_2m:
                    case CPRI_ENCAP_QUE_SA_TAB_2m:
                    case CPRI_ENCAP_QUE_VLAN0_TAB_2m:
                    case CPRI_ENCAP_QUE_VLAN1_TAB_2m:
                    case CPRI_ENCAP_QUE_CTL_FLOWID_TAB_2m:
                    case BRCM_RESERVED_CPM_20m:
                    case BRCM_RESERVED_CPM_25m:
                    case BRCM_RESERVED_CPM_29m:
                    case BRCM_RESERVED_CPM_33m:
                    case BRCM_RESERVED_CPM_37m:
                    case BRCM_RESERVED_CPM_41m:
                    case BRCM_RESERVED_CPM_62m:
                    case BRCM_RESERVED_CPM_46m:
                    case BRCM_RESERVED_CPM_50m:
                    case BRCM_RESERVED_CPM_54m:
                    case BRCM_RESERVED_CPM_58m:
                    case BRCM_RESERVED_CPM_337m:
                    case BRCM_RESERVED_CPM_341m:

                         if ((phy_port % 4) != 3)  {
                              return TRUE;
                         }
                         break;
                    case CPRI_ENCAP_DATA_3m:
                    case CPRI_GCW_CFG_TAB_CFG_3m:
                    case CPRI_DECAP_DATA_3m:
                    case CPRI_DECAP_QUEUE_STS_3m:
                    case CPRI_DECAP_QUEUE_STATS_3m:
                    case CPRI_DECAP_ULAW_LUT_3m:
                    case CPRI_BFA_TAB1_CFG_3m:
                    case CPRI_BFA_TAB0_CFG_3m:
                    case CPRI_CA_MAP_TAB_CFG_3m:
                    case CPRI_CA_PAY_TAB_CFG_3m:
                    case CPRI_IQU_BUFFER_STS_3m:
                    case CPRI_CA_MAP_STATE_TAB_STS_3m:
                    case CPRI_IQU_STATE_STS_3m:
                    case CPRI_DECAP_FLOWID_QUE_LOOKUP_3m:
                    case CPRI_DECAP_FLOW_CONTROL_3m:
                    case CPRI_DECAP_CLS_TO_QUEUE_LOOKUP_3m:
                    case CPRI_DECAP_QUE_NUM_TO_ORDERING_INDEX_3m:
                    case CPRI_DECAP_ORDERING_SEQOFF_TAB_3m:
                    case CPRI_CWA_VSD_CTRL_FLOW_BUFFER0_STS_3m:
                    case CPRI_CWA_VSD_CTRL_FLOW_BUFFER1_STS_3m:
                    case CPRI_CWA_VSD_CTRL_CONFIG_CFG_3m:
                    case CPRI_CWA_VSD_CTRL_FLOWID_MAP_TAB_CFG_3m:
                    case CPRI_CWA_VSD_CTRL_GRP_CFG_TAB_CFG_3m:
                    case CPRI_CWA_VSD_CTRL_GRP_ASSIGN_CFG_TAB_CFG_3m:
                    case CPRI_CWA_VSD_RAW_LOC_TAB_CFG_3m:
                    case CPRI_CWA_VSD_RAW_MAP_TAB_CFG_3m:
                    case CPRI_CWA_GCW_CFG_TAB_CFG_3m:
                    case CPRI_DECAP_COMP_TAB_3m:
                    case CPRI_CWA_GCW_REGS_CFG_3m:
                    case CPRI_ENCAP_QUEUE_STS_3m:
                    case CPRI_ENCAP_QUEUE_STATS_3m:
                    case CPRI_BFP_TAB0_CFG_3m:
                    case CPRI_BFP_TAB1_CFG_3m:
                    case CPRI_CPRSR_MAP_TAB_CFG_3m:
                    case CPRI_CPRSR_IQ_PK_BUFF_CFG_3m:
                    case CPRI_CPRSR_MAP_STATE_TAB_STS_3m:
                    case CPRI_IQ_PK_BUFF_AXC_PLD_STS_3m:
                    case CPRI_IQ_PK_BUFF_AXC_STATE_STS_3m:
                    case CPRI_VSDCTRL_CFLW_BUF_TAB_STS_3m:
                    case CPRI_VSDCTRL_CFLW_PGC_TAB_CFG_3m:
                    case CPRI_VSDCTRL_NUM_SEC_TAB_CFG_3m:
                    case CPRI_VSDCTRL_GRP_STT_TAB_STS_3m:
                    case CPRI_VSDCTRL_GRP_CFG_TAB_CFG_3m:
                    case CPRI_VSDCTRL_GRP_ASSIGN_TAB_CFG_3m:
                    case CPRI_VSDRAW_LOC_TAB_CFG_3m:
                    case CPRI_VSDRAW_FLT_TAB_CFG_3m:
                    case CPRI_VSDRAW_STATE_TAB_STS_3m:
                    case CPRI_HDR_CMP_TAB_CFG_3m:
                    case CPRI_ENCAP_ORDERING_INFO_TAB_3m:
                    case CPRI_ENCAP_ORDERING_INFO_STS_3m:
                    case CPRI_ENCAP_QUE_ETH_HDR_3m:
                    case CPRI_ENCAP_QUE_DA_TAB_3m:
                    case CPRI_ENCAP_QUE_SA_TAB_3m:
                    case CPRI_ENCAP_QUE_VLAN0_TAB_3m:
                    case CPRI_ENCAP_QUE_VLAN1_TAB_3m:
                    case CPRI_ENCAP_QUE_CTL_FLOWID_TAB_3m:
                    case CPRI_DECAP_ORDERING_INFO_TAB_3m:
                    case BRCM_RESERVED_CPM_21m:
                    case BRCM_RESERVED_CPM_26m:
                    case BRCM_RESERVED_CPM_30m:
                    case BRCM_RESERVED_CPM_34m:
                    case BRCM_RESERVED_CPM_38m:
                    case BRCM_RESERVED_CPM_42m:
                    case BRCM_RESERVED_CPM_63m:
                    case BRCM_RESERVED_CPM_47m:
                    case BRCM_RESERVED_CPM_51m:
                    case BRCM_RESERVED_CPM_55m:
                    case BRCM_RESERVED_CPM_59m:
                    case BRCM_RESERVED_CPM_338m:
                    case BRCM_RESERVED_CPM_342m:
...
int
mem_dump_cpri(int unit, soc_mem_t mem, void *data, int index , int max)
{
    uint32     index_min, count;
    int        copyno;
    int        rv = SOC_E_NONE;
...
cmd_esw_dump(int unit, args_t *a)
{
    ...
    if (SOC_IS_TRIDENT3X(unit) && arg1 != NULL) {
        ...
        if (strstr((char *)arg1,(char *)"flowset") &&
            strstr((char *)arg1,(char *)"timestamp_page") == NULL) {
#else
        if (sal_strcasestr((char *)arg1,(char *)"flowset") && 
            sal_strcasestr((char *)arg1,(char *)"timestamp_page") == NULL) {
#endif
	...
	if ((arg2) && (isint(arg2))) {
        ...
        if (SOC_BLOCK_TYPE(unit, copyno) == SOC_BLK_CPRI && dumpall == 1) {
            rv = mem_dump_cpri( unit, mem, INT_TO_PTR(flags) , index , count);
         } else {
