...
#if (defined(BCM_TRIUMPH3_SUPPORT) && (86 <= SOC_MAX_NUM_MMU_PORTS))
...
rval_test_skip_reg(int unit, soc_regaddrinfo_t *ainfo, reg_data_t *rd)
{
    ...
    if(SOC_IS_DNX(unit)) {
        ...
        switch(ainfo->reg) {
            ...
            case ARB_INDIRECT_COMMAND_ADDRESSr:
            ...
            case ECI_FRAMER_PLL_CONFIGURATIONSr:
            case ECI_GLOBAL_REGISTER_ADDRESS_MAPPINGr:
            case ECI_NIF_TSC_PLL_CONFIGURATIONSr:
            case ECI_SAR_PLL_CONFIGURATIONSr:
            case ECI_PRM_SBUS_MASTER_CTRLr:
            ...
            case MSW_INDIRECT_COMMAND_ADDRESSr:
            case MSW_SBUS_LAST_IN_CHAINr:
            /* Changed value right after the soft reset */
            case HBMC_HBM_PHY_SBUS_MASTER_RESET_CONTROLr:
            /* Will be fixed after taking the latest PL file*/
            case OCBM_DISABLE_BANK_DBGr:
            /* BRINGUP_FIX Under investigation for J2X */
            case FRWBC_WB_TX_CLIENT_FIFO_STATUSr:
            case MESH_TOPOLOGY_GTIMER_CYCLEr:
            case MSW_MACSEC_CFGr:
            case OFT_TX_MSW_PER_CONTEXT_CRDT_COUNTERS_CFGr:
            case OFT_TX_OFT_BIST_GEN_DATA_PATTERNr:
            case PMD_X1_PMD0_CONTROLr:
            case PMD_X1_PMD1_CONTROLr:
            case PMD_X1_PMD2_CONTROLr:
            case PMD_X1_PMD3_CONTROLr:
            case PMD_X4_FCLK_PERIOD_PORTr:
            case RX_X1_CONTROL0_FEC_DEGRADED_CONTROL0r:
            case WB_WB_RX_CLIENT_FIFO_STATUSr:
               return 1; /* Skip these registers */
            default:
                break;
		}
