...
extern sh_sand_man_t sh_dnxc_calibrate_man;
...
extern sh_sand_cmd_t sh_dnxc_swstate_new_cmds[];
extern sh_sand_man_t sh_swstate_new_man;
...
extern sh_sand_man_t sh_dnxc_techsupport_man;
extern sh_sand_cmd_t sh_dnxc_techsupport_cmds[];

extern sh_sand_man_t sh_dnxc_diag_ser_man;
#ifdef BCM_DNXF_SUPPORT
extern sh_sand_cmd_t sh_dnxf_diag_ser_cmds[];
#endif
#ifdef BCM_DNX_SUPPORT
extern sh_sand_cmd_t sh_dnx_diag_ser_cmds[];
#endif
...
extern shr_error_e sh_dnxc_calibrate_cmd(
    int unit,
    args_t * args,
    sh_sand_control_t * sand_control);
