    ...
    char *cmd)
{
    ...
    int core_group_id = DBAL_CORE_GROUP_ALL;
    ...
    SH_SAND_GET_INT32("CORE_GrouP", core_group_id);
    ...
    int *out_result_type)
{
    ...
    if (dbal_table_is_out_lif(entry_handle->table) && (entry_handle->table->allocator_field_id == DBAL_FIELD_OUT_LIF))
    {
        SHR_IF_ERR_EXIT(dnx_algo_res_dbal_out_lif_is_allocated
                        (unit, entry_handle->phy_entry.core_id, lif_val, entry_handle->table_id, &result_type, 0,
                         &is_allocated));
    }
    ...
    else
    {
        SHR_IF_ERR_EXIT(dnx_algo_res_dbal_lif_is_allocated
                        (unit, entry_handle->phy_entry.core_id, lif_val, 0, entry_handle->table_id, &result_type, 0,
                         &is_allocated));
    }
    ...
    sh_sand_control_t * sand_control)
{
    ...
    uint32 access_id;
    /*
     * Get will be done for core group id 0 by default 
     */
    int core_group_id = 0;
...
static sh_sand_option_t diag_dbal_entry_commit_options[] = {
    ...
    {"CORE_GrouP", SAL_FIELD_TYPE_INT32, "Specify the core group to be set.\n", "-17"},
    {NULL}
};
...
static sh_sand_man_t diag_dbal_entry_commit_man = {
    ...
    .examples =
        ...
        "TaBLe=MULTIPLE_CORE_GROUPS_EXAMPLE MUL_CG_KEY_0=1 MUL_CG_RES_0=2 CORE_GrouP=0\n"
};
...
static sh_sand_man_t diag_dbal_entry_update_man = {
    ...
    .examples = "table=IN_AC_C_VLAN_DB Priority=1 VLAN_DOMAIN=1 C_VID=2 IN_LIF=3\n"
        ...
        "TaBLe=IPV4_RPF_FIB VRF=1 IPV4=2 NoPayload\n"
        "TaBLe=MULTIPLE_CORE_GROUPS_EXAMPLE MUL_CG_KEY_0=1 MUL_CG_RES_0=3 CORE_GrouP=0\n"
};
...
static sh_sand_man_t diag_dbal_entry_get_man = {
    ...
    .examples = "table=IN_AC_C_VLAN_DB VLAN_DOMAIN=1 C_VID=2 IN_LIF=4 ClearHitBit\n"
        ...
        "TaBLe=IPV4_RPF_FIB VRF=1 IPV4=2\n" "TaBLe=MULTIPLE_CORE_GROUPS_EXAMPLE MUL_CG_KEY_0=1 CORE_GrouP=0\n"
};
