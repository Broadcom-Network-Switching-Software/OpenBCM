...
static sh_sand_cmd_t sh_dnx_tm_ingress_cmds[] = {
    ...
    {"portdrop",     NULL,                            sh_dnx_tm_ingress_prd_cmds, NULL,                                          &sh_dnx_ingress_port_drop_show_man},
...
static sh_sand_cmd_t sh_dnx_tm_egress_cmds[] = {
    ...
    {"MiRror_ReCYcle",   sh_dnx_tm_egr_mirror_rcy_cmd,      NULL,                     sh_dnx_egr_mirror_rcy_options,          &sh_dnx_egr_mirror_rcy_man},
...
static sh_sand_cmd_t sh_dnx_scheduler_fsm_cmds[] = {
    /*keyword,            action,        command,                          options,            man                              */
    {"Count",             NULL,          sh_dnx_scheduler_fsm_count_cmds,  NULL,               &sh_dnx_scheduler_fsm_count_man},
    {NULL}
};
...
sh_sand_cmd_t sh_dnx_tm_cmds[] = {
    ...
    {"flow_aggregate",  sh_dnx_flow_agg_cmd,   NULL,                     sh_dnx_flow_agg_arguments,    &sh_dnx_flow_agg_man},
