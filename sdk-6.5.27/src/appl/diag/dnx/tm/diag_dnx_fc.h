...
/** LLFC from CFC sent to ILKN */
    DNX_FC_NIF_TYPE_LLFC_FROM_CFC_ILKN = 5,
/** LLFC from QMLF */
    DNX_FC_NIF_TYPE_LLFC_FROM_QMLF = 6,
/** LLFC to Port Macro for reception */
    DNX_FC_NIF_TYPE_STOP_TO_PM = 7,
/** LLFC was from CFC for reception */
    DNX_FC_NIF_TYPE_STOP_FROM_CFC = 8,
/** PFC from Port Macro */
    DNX_FC_NIF_TYPE_PFC_FROM_PM = 9,
/** PFC sent to CFC */
    DNX_FC_NIF_TYPE_PFC_TO_CFC = 10,
/** LLFC sent to ILKN */
    DNX_FC_NIF_TYPE_LLFC_TO_ILKN = 11,
