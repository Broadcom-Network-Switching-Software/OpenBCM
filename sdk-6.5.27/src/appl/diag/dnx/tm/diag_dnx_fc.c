...
static sh_sand_enum_t sand_diag_fc_nif_type_enum[] = {
   /**String            Value                               Description */
    ...
    {"LLFC_FROM_CFC_ILKN", DNX_FC_NIF_TYPE_LLFC_FROM_CFC_ILKN, "LLFC generation: Present indications if signal to generate LLFC was received from CFC. Port must he ILKN type."},
    ...
    for (type = type_start; type <= type_end; type++)
    {
        ...
        switch (type)
        {
            case DNX_FC_NIF_TYPE_PFC_FROM_QMLF:
                ...
                break;
            case DNX_FC_NIF_TYPE_LLFC_FROM_CFC_ILKN:
        ...
        BCM_PBMP_ITER(logical_ports, logical_port_i)
        {
            ...
            if (!DNX_ALGO_PORT_TYPE_IS_NIF_ETH(unit, port_info, DNX_ALGO_PORT_TYPE_INCLUDE(STIF, L1))
                && (type != DNX_FC_NIF_TYPE_LLFC_TO_ILKN) && (type != DNX_FC_NIF_TYPE_LLFC_FROM_CFC_ILKN))
            {
            ...
            if ((type == DNX_FC_NIF_TYPE_LLFC_TO_ILKN) || (type == DNX_FC_NIF_TYPE_LLFC_FROM_CFC_ILKN))
            {
