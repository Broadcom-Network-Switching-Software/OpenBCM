    ...
    sh_sand_control_t * sand_control)
{
    ...
    {
        SHR_IF_ERR_EXIT_NO_MSG(sand_signal_output_find(unit, core, 0, NULL, "FWD2", "IPMF1", "Stats_Objects",
                                                       &stats_ids));
    ...
    {
        /** In case the signals are not found, exit silently */
        SHR_IF_ERR_EXIT_ELSE_SET_EXPECT(sand_signal_output_find(unit, core, 0, NULL, "FWD2", "IPMF1",
                                                                "flp_statistics_objects", &stats_ids),
                                        _SHR_E_NOT_FOUND);
        ...
        SHR_IF_ERR_EXIT_ELSE_SET_EXPECT(sand_signal_output_find(unit, core, 0, NULL, "FWD2", "IPMF1",
                                                                "flp_statistics_objects_cmd", &stats_profiles),
                                        _SHR_E_NOT_FOUND);
        if (SHR_GET_CURRENT_ERR() == _SHR_E_NOT_FOUND)
        {
            SHR_SET_CURRENT_ERR(_SHR_E_NONE);
    ...
    {
        SHR_IF_ERR_EXIT_NO_MSG(sand_signal_output_find
                               (unit, core, 0, NULL, "VTT4", "FWD1", "Stats_Meta_Data",
                                &stats_metadatas[STAT_PP_IRPP_OBJ_IDX_VTD_LIF]));
    }
    SHR_IF_ERR_EXIT_NO_MSG(sand_signal_output_find
    ...
    {
        SHR_IF_ERR_EXIT(dnx_stat_pp_irpp_vis_gen_stats
                        (unit, "VTD terminated FODO", STAT_PP_IRPP_OBJ_IDX_VTE_TERM_FODO, stats_ids, stats_profiles,
                         stats_metadatas[STAT_PP_IRPP_OBJ_IDX_VTD_LIF], stats_metadatas[STAT_PP_IRPP_OBJ_IDX_VTD_LIF],
                         prt_ctr));
        SHR_IF_ERR_EXIT(dnx_stat_pp_irpp_vis_gen_stats
                        (unit, "FWD1 forward FODO", STAT_PP_IRPP_OBJ_IDX_FWD1_FWD_FODO, stats_ids, stats_profiles,
                         stats_metadatas[STAT_PP_IRPP_OBJ_IDX_VTD_LIF],
    ...
    prt_control_t * prt_ctr)
{
    ...
    /**Stat id i*/
    SHR_IF_ERR_EXIT_ELSE_SET_EXPECT(sand_signal_output_find(unit, core, 0, NULL, "TRAP", signal_to, object_id,
                                                            &stats), _SHR_E_NOT_FOUND);
    if (SHR_GET_CURRENT_ERR() == _SHR_E_NOT_FOUND)
    {
        SHR_SET_CURRENT_ERR(_SHR_E_NONE);
        SHR_EXIT();
    ...
    /**valid indication*/
    SHR_IF_ERR_EXIT_ELSE_SET_EXPECT(sand_signal_output_find(unit, core, 0, NULL, "TRAP", signal_to, object_valid,
                                                            &stats), _SHR_E_NOT_FOUND);
    if (SHR_GET_CURRENT_ERR() == _SHR_E_NOT_FOUND)
    {
        SHR_SET_CURRENT_ERR(_SHR_E_NONE);
    ...
    sh_sand_control_t * sand_control)
{
...

    {
        ...
        /** In case the signals are not found, exit silently */
        SHR_IF_ERR_EXIT_ELSE_SET_EXPECT(dpp_dsig_read(unit, core, "ETPP", "Trap", "CRPS", "Internal_Metadata",
                                                      &metadata, 1), _SHR_E_NOT_FOUND);
        if (SHR_GET_CURRENT_ERR() == _SHR_E_NOT_FOUND)
        {
            SHR_SET_CURRENT_ERR(_SHR_E_NONE);
            SHR_EXIT();
    ...
    sh_sand_control_t * sand_control)
{
    ...
    DNXCMN_CORES_ITER(unit, core_in, core)
    {
        if (!ISEMPTY(block))
        {
            if (sal_strncasecmp("irpp", block, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH) == 0)
            {
                SHR_IF_ERR_EXIT(dnx_stat_pp_irpp_vis(unit, core, sand_control));
            }
            else if (sal_strncasecmp("itpp", block, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH) == 0)
            {
                SHR_ERR_EXIT(_SHR_E_PARAM, "ITPP is not yet supported in SDK");
            }
            else if (sal_strncasecmp("erpp", block, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH) == 0)
            {
                SHR_ERR_EXIT(_SHR_E_PARAM, "ERPP is not yet supported in SDK");
            }
            else if (sal_strncasecmp("etpp", block, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH) == 0)
            {
                SHR_IF_ERR_EXIT(dnx_stat_pp_etpp_vis(unit, core, sand_control));
            }
            else if (sal_strncasecmp("all", block, SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH) == 0)
            {
                SHR_IF_ERR_EXIT(dnx_stat_pp_irpp_vis(unit, core, sand_control));
                SHR_IF_ERR_EXIT(dnx_stat_pp_etpp_vis(unit, core, sand_control));
            }
