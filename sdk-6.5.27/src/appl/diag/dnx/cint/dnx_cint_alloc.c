...
static cint_parameter_desc_t __cint_struct_members__lif_mngr_global_lif_info_t[] = {
    {
     "int",
     "bta",
     0,
...
static void *
__cint_maddr__lif_mngr_global_lif_info_t(
    void *p,
    int mnum,
    cint_struct_type_t * parent)
{
    void *rv;
    lif_mngr_global_lif_info_t *s = (lif_mngr_global_lif_info_t *) p;
...
static void *
__cint_maddr__lif_mngr_local_inlif_str_info_t(
    void *p,
    int mnum,
    cint_struct_type_t * parent)
{
...
static void *
__cint_maddr__lif_mngr_local_outlif_str_info_t(
    void *p,
    int mnum,
    cint_struct_type_t * parent)
{
    ...
    switch (mnum)
    {
        ...
        case 1:
            ...
            break;
        case 2:
            rv = &(s->outlif_phase_name);
            break;
        case 3:
            rv = &(s->local_lif_flags);
            break;
        case 4:
            rv = &(s->local_outlif);
            break;
...
static cint_struct_type_t __cint_alloc_structures[] = {
    ...
    CINT_STRUCT_TYPE_DEFINE(lif_mngr_global_lif_info_t),
    {NULL},
};
