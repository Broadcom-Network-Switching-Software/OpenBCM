...
extern int is_mem_belong_to_ingress0_or_egress1(
    phy_mem_t * mem,
    int min_ndx,
    int max_ndx);

extern void flush_applets_to_single_mem(
    int unit,
    const int is_ingress0_egress1);

extern int flush_applets(
    int unit);

extern int start_writing_applets(
    int unit);
    ...
    cint_struct_type_t * parent)
{
    ...
    switch (mnum)
    {
        ...
        case 3:
            ...
            break;
        case 4:
            rv = &(s->mem_width_in_bits);
            break;
        case 5:
            rv = &(s->is_reg);
            break;
        case 6:
            rv = &(s->is_industrial_tcam);
            break;
        default:
            rv = NULL;
            break;
...
CINT_FWRAPPER_CREATE_VP2(flush_applets_to_single_mem, int,
                         int,
                         unit,
                         0,
                         0,
