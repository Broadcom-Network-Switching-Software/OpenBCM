...
#include <include/shared/gport.h>
#include <soc/counter.h>
#include <src/bcm/dnx/tsn/tsn_counter.h>
/*
 * }
 */

CINT_FWRAPPER_CREATE_RP5(int,
                         int,
                         0,
                         0,
...
CINT_FWRAPPER_CREATE_RP2(int,
                         ...
                         0,
                         0,
                         soc_counter_actual_interval_get,
                         int,
                         int,
                         unit,
                         0,
...
static int
__macro___SHR_GPORT_FLOW_LIF_VAL_GET_ID(
    int *_gport)
{
    return _SHR_GPORT_FLOW_LIF_VAL_GET_ID((*_gport));
}

CINT_FWRAPPER_CREATE2_RP1(int, int, 0, 0,
                          __macro___SHR_GPORT_FLOW_LIF_VAL_GET_ID, int *, int, _gport, 1, 0, CINT_PARAM_IN);
...
static cint_function_t __cint_dnx_functions[] = {
    ...
    CINT_FWRAPPER_NENTRY("appl_dnx_dynamic_port_speed_set", appl_dnx_dynamic_port_speed_set),
    ...
    CINT_FWRAPPER_NENTRY("dnx_dram_buffers_buffer_verify",
                         dnx_dram_buffers_buffer_verify),
    CINT_FWRAPPER_NENTRY("soc_counter_actual_interval_get",
                         soc_counter_actual_interval_get),
    ...
    CINT_FWRAPPER_NENTRY("dnx_cosq_ingress_receive_shaper_grant_size_and_timer_cycles_calc",
                         dnx_cosq_ingress_receive_shaper_grant_size_and_timer_cycles_calc),
    CINT_FWRAPPER_NENTRY("sh_dnx_nif_rx_fifo_status_get",
                         sh_dnx_nif_rx_fifo_status_get),
    CINT_FWRAPPER_NENTRY("_SHR_GPORT_FLOW_LIF_VAL_GET_ID", __macro___SHR_GPORT_FLOW_LIF_VAL_GET_ID),
    CINT_FWRAPPER_NENTRY("dnx_tsn_counter_ptp_curr_time_get", dnx_tsn_counter_ptp_curr_time_get),
    CINT_ENTRY_LAST
};
    ...
    cint_struct_type_t * parent)
{
    ...
    {
        case 0:
            rv = &(s->one_clk_time_measured_int);
            break;
        case 1:
            rv = &(s->one_clk_time_measured_remainder);
            break;
        case 2:
            rv = &(s->serdes_freq_int);
            break;
        case 3:
            rv = &(s->serdes_freq_remainder);
            break;
        case 4:
            rv = &(s->ref_clk_int);
            break;
        case 5:
            rv = &(s->ref_clk_remainder);
            break;
        case 6:
            rv = &(s->lane);
            break;
    ...
    cint_struct_type_t * parent)
{
    ...
    switch (mnum)
    {
        case 0:
            ...
            break;
        case 1:
            rv = &(s->stand_alone_configuration);
            break;
        case 2:
            rv = &(s->max_nof_ports_per_modid);
            break;
        case 3:
            rv = &(s->devices_array);
            break;
        case 4:
            rv = &(s->unit_to_device_index);
            break;
        case 5:
            rv = &(s->modid_to_index);
            break;
...
static cint_constants_t __cint_constants[] = {
    ...
    {"APPL_DNX_DYN_PORT_SKIP_COMPENSATION_PER_PORT", APPL_DNX_DYN_PORT_SKIP_COMPENSATION_PER_PORT},
    {NULL}
};
...
static cint_enum_map_t __cint_dnxf_enum_map__dnx_sch_region_type_e[] = {
    {"DNX_SCH_REGION_TYPE_CON", DNX_SCH_REGION_TYPE_CON},
    {"DNX_SCH_REGION_TYPE_INTERDIG_1", DNX_SCH_REGION_TYPE_INTERDIG_1},
    {"DNX_SCH_REGION_TYPE_SE", DNX_SCH_REGION_TYPE_SE},
    {"DNX_SCH_REGION_TYPE_SE_HR", DNX_SCH_REGION_TYPE_SE_HR},
    {NULL}
};

static cint_enum_type_t __cint_dnx_enums[] = {
    {"dnx_sch_flow_quartet_type_e", __cint_dnxf_enum_map__dnx_sch_flow_quartet_type_e},
    {"dnx_sch_region_type_e", __cint_dnxf_enum_map__dnx_sch_region_type_e},
    {NULL}
};
