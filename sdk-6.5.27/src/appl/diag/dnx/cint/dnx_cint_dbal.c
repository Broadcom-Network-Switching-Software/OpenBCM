...
static cint_function_t __cint_dnx_dbal_functions[] = {
    ...
    CINT_FWRAPPER_NENTRY("dnx_dbal_fields_field_type_enum_value_get", dnx_dbal_fields_field_type_enum_value_get),
    ...
    CINT_FWRAPPER_NENTRY("dnx_dbal_entry_handle_key_field_arr32_masked_get",
                         dnx_dbal_entry_handle_key_field_arr32_masked_get),
    CINT_FWRAPPER_NENTRY("dnx_dbal_entry_handle_key_field_arr8_masked_get",
                         dnx_dbal_entry_handle_key_field_arr8_masked_get),
    ...
    CINT_FWRAPPER_NENTRY("dnx_dbal_entry_handle_access_id_allocate_and_set",
                         dnx_dbal_entry_handle_access_id_allocate_and_set),
