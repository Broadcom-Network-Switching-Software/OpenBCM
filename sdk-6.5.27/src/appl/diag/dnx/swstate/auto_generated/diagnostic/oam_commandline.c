...
shr_error_e sh_dnx_swstate_oam_oam_group_sw_db_info_oam_group_array_of_linked_lists_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(oam_sw_db_info_info[unit], oam_sw_db_info_layout_str, OAM_SW_DB_INFO_INFO_NOF_ENTRIES, "OAM_SW_DB_INFO~OAM_GROUP_SW_DB_INFO~OAM_GROUP_ARRAY_OF_LINKED_LISTS~", 0);
    dnx_sw_state_size_print(size);
...
sh_sand_cmd_t sh_dnx_swstate_oam_oam_endpoint_sw_db_info_cmds[] = {
    ...
    {"oam_endpoint_array_of_mep_linked_lists", NULL, sh_dnx_swstate_oam_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_cmds, NULL, &dnx_swstate_oam_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_man},
...
shr_error_e sh_dnx_swstate_oam_oam_endpoint_sw_db_info_oam_endpoint_array_of_rmep_linked_lists_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(oam_sw_db_info_info[unit], oam_sw_db_info_layout_str, OAM_SW_DB_INFO_INFO_NOF_ENTRIES, "OAM_SW_DB_INFO~OAM_ENDPOINT_SW_DB_INFO~OAM_ENDPOINT_ARRAY_OF_RMEP_LINKED_LISTS~", 0);
    dnx_sw_state_size_print(size);
...
sh_sand_cmd_t sh_dnx_swstate_oam_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_cmds[] = {
    {"dump", sh_dnx_swstate_oam_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_dump_cmd, NULL, dnx_swstate_oam_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_dump_options, &dnx_swstate_oam_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_dump_man},
    {"size_get", sh_dnx_swstate_oam_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_size_get_cmd, NULL, dnx_swstate_oam_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_size_get_options, &dnx_swstate_oam_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_size_get_man},
    {NULL}
};


sh_sand_man_t dnx_swstate_oam_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_man = {
    cmd_dnx_swstate_oam_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_desc,
    NULL,
    NULL,
    NULL,
};
...
const char cmd_dnx_swstate_oam_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_desc[] = "oam_sw_db_info oam_endpoint_sw_db_info oam_endpoint_array_of_mep_linked_lists commands";
...
sh_sand_option_t dnx_swstate_oam_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_dump_options[] = {
    {"nocontent",      SAL_FIELD_TYPE_BOOL, "Decision if to perform content dump or to print the access tree.",  "false"},
    {"typefilter",     SAL_FIELD_TYPE_STR,  "Filter for the variable type.",         ""},
    {"namefilter",     SAL_FIELD_TYPE_STR,  "Filter for the variable name.",         ""},
    {NULL}
...
sh_sand_man_t dnx_swstate_oam_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_dump_man = {
    "swstate dump",
    "print the variable value",
    "oam_sw_db_info oam_endpoint_sw_db_info oam_endpoint_array_of_mep_linked_lists dump []\n",
    "oam_sw_db_info oam_endpoint_sw_db_info oam_endpoint_array_of_mep_linked_lists dump nocontent=false typefilter="" namefilter="" ",
};
...
shr_error_e sh_dnx_swstate_oam_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(oam_sw_db_info_info[unit], oam_sw_db_info_layout_str, OAM_SW_DB_INFO_INFO_NOF_ENTRIES, "OAM_SW_DB_INFO~OAM_ENDPOINT_SW_DB_INFO~OAM_ENDPOINT_ARRAY_OF_MEP_LINKED_LISTS~", 0);
    dnx_sw_state_size_print(size);
...
sh_sand_option_t dnx_swstate_oam_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_size_get_options[] = {
    {NULL}
};


sh_sand_man_t dnx_swstate_oam_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_size_get_man = {
    "swstate size_get",
    "print the variable size",
    "oam_sw_db_info oam_endpoint_sw_db_info oam_endpoint_array_of_mep_linked_lists size_get",
    "oam_sw_db_info oam_endpoint_sw_db_info oam_endpoint_array_of_mep_linked_lists size_get",
};
