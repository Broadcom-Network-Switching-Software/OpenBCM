...
extern sh_sand_cmd_t sh_dnx_swstate_kbp_db_handles_info_core_id_cmds[];
extern sh_sand_man_t dnx_swstate_kbp_db_handles_info_core_id_man;
extern const char cmd_dnx_swstate_kbp_db_handles_info_core_id_desc[];
shr_error_e sh_dnx_swstate_kbp_db_handles_info_core_id_dump_cmd(int unit, args_t *args, sh_sand_control_t *sand_control);
extern sh_sand_option_t dnx_swstate_kbp_db_handles_info_core_id_dump_options[];
extern sh_sand_man_t dnx_swstate_kbp_db_handles_info_core_id_dump_man;


shr_error_e sh_dnx_swstate_kbp_db_handles_info_core_id_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control);
extern sh_sand_option_t dnx_swstate_kbp_db_handles_info_core_id_size_get_options[];
extern sh_sand_man_t dnx_swstate_kbp_db_handles_info_core_id_size_get_man;
...
extern sh_sand_cmd_t sh_dnx_swstate_kbp_db_handles_info_regular_result_size_cmds[];
extern sh_sand_man_t dnx_swstate_kbp_db_handles_info_regular_result_size_man;
extern const char cmd_dnx_swstate_kbp_db_handles_info_regular_result_size_desc[];
shr_error_e sh_dnx_swstate_kbp_db_handles_info_regular_result_size_dump_cmd(int unit, args_t *args, sh_sand_control_t *sand_control);
extern sh_sand_option_t dnx_swstate_kbp_db_handles_info_regular_result_size_dump_options[];
extern sh_sand_man_t dnx_swstate_kbp_db_handles_info_regular_result_size_dump_man;


shr_error_e sh_dnx_swstate_kbp_db_handles_info_regular_result_size_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control);
extern sh_sand_option_t dnx_swstate_kbp_db_handles_info_regular_result_size_size_get_options[];
extern sh_sand_man_t dnx_swstate_kbp_db_handles_info_regular_result_size_size_get_man;
