...
sh_sand_cmd_t sh_dnx_swstate_algo_trunk_cmds[] = {
    ...
    {"user_profile_manager", NULL, sh_dnx_swstate_algo_trunk_user_profile_manager_cmds, NULL, &dnx_swstate_algo_trunk_user_profile_manager_man},
...
sh_sand_cmd_t sh_dnx_swstate_algo_trunk_user_profile_manager_cmds[] = {
    {"dump", sh_dnx_swstate_algo_trunk_user_profile_manager_dump_cmd, NULL, dnx_swstate_algo_trunk_user_profile_manager_dump_options, &dnx_swstate_algo_trunk_user_profile_manager_dump_man},
    {"size_get", sh_dnx_swstate_algo_trunk_user_profile_manager_size_get_cmd, NULL, dnx_swstate_algo_trunk_user_profile_manager_size_get_options, &dnx_swstate_algo_trunk_user_profile_manager_size_get_man},
    {NULL}
};


sh_sand_man_t dnx_swstate_algo_trunk_user_profile_manager_man = {
    cmd_dnx_swstate_algo_trunk_user_profile_manager_desc,
    NULL,
    NULL,
    NULL,
};
...
const char cmd_dnx_swstate_algo_trunk_user_profile_manager_desc[] = "algo_trunk_db user_profile_manager commands";
...
sh_sand_option_t dnx_swstate_algo_trunk_user_profile_manager_dump_options[] = {
    {"nocontent",      SAL_FIELD_TYPE_BOOL, "Decision if to perform content dump or to print the access tree.",  "false"},
    {"typefilter",     SAL_FIELD_TYPE_STR,  "Filter for the variable type.",         ""},
    {"namefilter",     SAL_FIELD_TYPE_STR,  "Filter for the variable name.",         ""},
    {NULL}
...
sh_sand_man_t dnx_swstate_algo_trunk_user_profile_manager_dump_man = {
    "swstate dump",
    "print the variable value",
    "algo_trunk_db user_profile_manager dump []\n",
    "algo_trunk_db user_profile_manager dump nocontent=false typefilter="" namefilter="" ",
};
...
shr_error_e sh_dnx_swstate_algo_trunk_user_profile_manager_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(algo_trunk_db_info[unit], algo_trunk_db_layout_str, ALGO_TRUNK_DB_INFO_NOF_ENTRIES, "ALGO_TRUNK_DB~USER_PROFILE_MANAGER~", 0);
    dnx_sw_state_size_print(size);
...
sh_sand_option_t dnx_swstate_algo_trunk_user_profile_manager_size_get_options[] = {
    {NULL}
};


sh_sand_man_t dnx_swstate_algo_trunk_user_profile_manager_size_get_man = {
    "swstate size_get",
    "print the variable size",
    "algo_trunk_db user_profile_manager size_get",
    "algo_trunk_db user_profile_manager size_get",
};
