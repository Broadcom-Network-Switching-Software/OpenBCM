...
static shr_error_e
diag_dnx_field_virtualwire_condition_standard_1(
    int unit,
    rhlist_t * list)
{
    uint8 is_default_image;
    ...
    sh_sand_control_t * sand_control)
{
    ...
    if (is_std_1)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "\r\n" "Virtual wires are not supported on standard_1.\r\n\n");
    }
    ...
    for (stage_index = stage_lower; stage_index <= stage_upper; stage_index++)
    {
        ...
        while (1)
        {
            char signals_string[DIAG_DNX_FIELD_UTILS_STR_SIZE_LARGER] = { 0 };
            char actions_string[DIAG_DNX_FIELD_UTILS_STR_SIZE_LARGER] = { 0 };
            ...
            if (dnx_data_pp.stages.params_get(unit, pp_stages[0])->valid)
            {
    ...
    sh_sand_control_t * sand_control)
{
    ...
    for (stage_index = stage_lower; stage_index <= stage_upper; stage_index++)
    {
        ...
        for (signal_index = 0; signal_index < signals_nof; signal_index++)
        {
            ...
            if (dnx_data_signals_struct_p->signal_name == NULL)
            {
                continue;
            }
...
sh_sand_cmd_t Sh_dnx_field_virtualwire_cmds[] = {
    {"info", diag_dnx_field_virtualwire_info_cb, NULL, Field_virtualwire_info_options,
     &Field_virtualwire_info_man, NULL, NULL, SH_CMD_CONDITIONAL, diag_dnx_field_virtualwire_condition_standard_1}
    ,
    {"signals", diag_dnx_field_virtualwire_signals_cb, NULL, Field_virtualwire_signals_options,
     &Field_virtualwire_signals_man, NULL, NULL, SH_CMD_CONDITIONAL, diag_dnx_field_virtualwire_condition_standard_1}
    ,
    {NULL}
};
