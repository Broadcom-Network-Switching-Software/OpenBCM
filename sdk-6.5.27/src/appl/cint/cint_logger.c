...
static cint_parameter_desc_t __cint_struct_members__cint_logger_rtime_t[] = {
    ...
    { "uint64"       , "total" , 0 , 0 , CINT_VARIABLE_F_CONST },
    { NULL           , NULL    , 0 , 0 },
};
...
cint_logger_thread_specific (void)
{
    ...
    if (!tdata) {
        ...
        /*
         * Allocate memory but ignore it for memory testing purposes.
         */
        tdata = CINT_MALLOC_IGNORE_COUNTERS(sizeof(*tdata));
