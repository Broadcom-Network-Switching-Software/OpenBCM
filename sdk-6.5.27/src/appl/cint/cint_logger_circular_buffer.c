...
cbuf_consumer_thread (void *arg)
{
    ...
    do {
         ...
         *
         * There is no way for CBUF_UNLOCK to be not called after CBUF_LOCK is
         * called. It seems that coverity is unaware that CBUF_UNLOCK unlocks
         * the mutex, and it concludes that the already locked mutex is being
         * locked again at the next iteration of the while loop.
         *
         * Therefore this warning is being ignored.
         */
