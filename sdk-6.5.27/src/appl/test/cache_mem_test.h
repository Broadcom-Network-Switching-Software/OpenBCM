...
typedef enum cache_mem_test_type_e {
	...
	cache_mem_test_type_access_mode
...
typedef enum cache_mem_test_partial_e {
	...
	cache_mem_test_cache_broadcast,
...
typedef struct tr_do_cache_mem_test_e
{
    ...
    char*                               access_type_parse;
    char*                               block_name_parse;
    char*                               regmem_name_parse;

    uint32                              block_type;
    uint32                              access_test_regmem_flags;   /* bit0: memory, bit1: register */
    
    uint32                              *access_test_result_flag;
} tr_do_cache_mem_test_t;

#define ACCESS_CACHE_REGMEM_TEST_FLAG_MEM       (1 << 0)
#define ACCESS_CACHE_REGMEM_TEST_FLAG_REG       (1 << 1)
#define ACCESS_CACHE_REGMEM_TEST_FLAG_ACCESS    (1 << 2)
...
#define CACHE_MEM_TEST_COMPARE_BCAST_FLAG       (1 << 7)
#define CACHE_MEM_TEST_ACCESS_FAIL_FLAG         (1 << 8)
