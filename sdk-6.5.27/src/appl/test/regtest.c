...
try_reg_dispatch(int unit, soc_regaddrinfo_t *ainfo, void *data)
{
    ...
    if(SOC_IS_DNX(unit)) {
        ...
        switch(ainfo->reg) {
            ...
            /* J2X indirect command, Gtimer configuration */
            case WB_INDIRECT_COMMANDr:
            case ARB_INDIRECT_COMMANDr:
            case BDM_INDIRECT_COMMANDr:
            case FMX_INDIRECT_COMMANDr:
            case FRA_INDIRECT_COMMANDr:
            case MSW_INDIRECT_COMMANDr:
            case OFR_INDIRECT_COMMANDr:
            case OFT_INDIRECT_COMMANDr:
            case SIF_INDIRECT_COMMANDr:
            case TSN_INDIRECT_COMMANDr:
            case EPRE_INDIRECT_COMMANDr:
            case FAWR_INDIRECT_COMMANDr:
            case FAWT_INDIRECT_COMMANDr:
            case FBSW_INDIRECT_COMMANDr:
            case FDMP_INDIRECT_COMMANDr:
            case FDMX_INDIRECT_COMMANDr:
            case FFOA_INDIRECT_COMMANDr:
            case FFOB_INDIRECT_COMMANDr:
            case FLFR_INDIRECT_COMMANDr:
            case FLFT_INDIRECT_COMMANDr:
            case FMAP_INDIRECT_COMMANDr:
            case FMXC_INDIRECT_COMMANDr:
            case FMXT_INDIRECT_COMMANDr:
            case FOAM_INDIRECT_COMMANDr:
            case FOSW_INDIRECT_COMMANDr:
            case FPMR_INDIRECT_COMMANDr:
            case FPMT_INDIRECT_COMMANDr:
            case FPTPR_INDIRECT_COMMANDr:
            case FPTPT_INDIRECT_COMMANDr:
            case FODUO_INDIRECT_COMMANDr:
            case FMXAI_INDIRECT_COMMANDr:
            case FMXAJ_INDIRECT_COMMANDr:
            case FMXBI_INDIRECT_COMMANDr:
            case FMXBJ_INDIRECT_COMMANDr:
            case FMXBK_INDIRECT_COMMANDr:
            case FLOTN_INDIRECT_COMMANDr:
            case FMACR_INDIRECT_COMMANDr:
            case FMACT_INDIRECT_COMMANDr:
            case FGDMP_INDIRECT_COMMANDr:
            case FGMAP_INDIRECT_COMMANDr:
            case FICPB_INDIRECT_COMMANDr:
            case FDMXC_INDIRECT_COMMANDr:
            case FDMXT_INDIRECT_COMMANDr:
            case FDCRL_INDIRECT_COMMANDr:
            case FDCRS_INDIRECT_COMMANDr:
            case FDMXA_INDIRECT_COMMANDr:
            case FECPB_INDIRECT_COMMANDr:
            case FECRL_INDIRECT_COMMANDr:
            case FECRS_INDIRECT_COMMANDr:
            case FFLXO_INDIRECT_COMMANDr:
            case FDMXBI_INDIRECT_COMMANDr:
            case FDMXBJ_INDIRECT_COMMANDr:
            case FLEXMAC_INDIRECT_COMMANDr:
            case ARB_GTIMER_CONFIGURATIONr:
            case FAWR_GTIMER_CONFIGURATIONr:
            case FAWT_GTIMER_CONFIGURATIONr:
            case FBSW_GTIMER_CONFIGURATIONr:
            case FDCRL_GTIMER_CONFIGURATIONr:
            case FDCRS_GTIMER_CONFIGURATIONr:
            case FDMP_GTIMER_CONFIGURATIONr:
            case FDMXA_GTIMER_CONFIGURATIONr:
            case FDMXBI_GTIMER_CONFIGURATIONr:
            case FDMXBJ_GTIMER_CONFIGURATIONr:
            case FDMXC_GTIMER_CONFIGURATIONr:
            case FDMXT_GTIMER_CONFIGURATIONr:
            case FDMX_GTIMER_CONFIGURATIONr:
            case FECPB_GTIMER_CONFIGURATIONr:
            case FECRL_GTIMER_CONFIGURATIONr:
            case FECRS_GTIMER_CONFIGURATIONr:
            case FFLXO_GTIMER_CONFIGURATIONr:
            case FFOA_GTIMER_CONFIGURATIONr:
            case FFOB_GTIMER_CONFIGURATIONr:
            case FGDMP_GTIMER_CONFIGURATIONr:
            case FGMAP_GTIMER_CONFIGURATIONr:
            case FICPB_GTIMER_CONFIGURATIONr:
            case FLEXMAC_GTIMER_CONFIGURATIONr:
            case FLFR_GTIMER_CONFIGURATIONr:
            case FLFT_GTIMER_CONFIGURATIONr:
            case FLOTN_GTIMER_CONFIGURATIONr:
            case FMACR_GTIMER_CONFIGURATIONr:
            case FMACT_GTIMER_CONFIGURATIONr:
            case FMAP_GTIMER_CONFIGURATIONr:
            case FMXAI_GTIMER_CONFIGURATIONr:
            case FMXAJ_GTIMER_CONFIGURATIONr:
            case FMXBI_GTIMER_CONFIGURATIONr:
            case FMXBJ_GTIMER_CONFIGURATIONr:
            case FMXBK_GTIMER_CONFIGURATIONr:
            case FMXC_GTIMER_CONFIGURATIONr:
            case FMXT_GTIMER_CONFIGURATIONr:
            case FMX_GTIMER_CONFIGURATIONr:
            case FOAM_GTIMER_CONFIGURATIONr:
            case FODUO_GTIMER_CONFIGURATIONr:
            case FOSW_GTIMER_CONFIGURATIONr:
            case FPMR_GTIMER_CONFIGURATIONr:
            case FPMT_GTIMER_CONFIGURATIONr:
            case FPTPR_GTIMER_CONFIGURATIONr:
            case FPTPT_GTIMER_CONFIGURATIONr:
            case FRA_GTIMER_CONFIGURATIONr:
            case FRWA_GTIMER_CONFIGURATIONr:
            case FRWBC_GTIMER_CONFIGURATIONr:
            case MSW_GTIMER_CONFIGURATIONr:
            case OFR_GTIMER_CONFIGURATIONr:
            case OFT_GTIMER_CONFIGURATIONr:
            case TSN_GTIMER_CONFIGURATIONr:
            case W40_GTIMER_CONFIGURATIONr:
            case WB_GTIMER_CONFIGURATIONr:
            case MACSEC_ESEC_INTR_ENABLEr:
            case MACSEC_MACSEC_ECC_CTRLr:
            case ETPPC_SPECIAL_CLOCK_CONTROLSr:
            case KAPS_SPECIAL_CLOCK_CONTROLSr: 
               return 1; /* Skip these registers */
            default:
                break;
        }
    ...
    LOG_VERBOSE(BSL_LS_APPL_COMMON, (BSL_META_U(unit, "access register: %s\n"), SOC_REG_NAME(unit, ainfo->reg)));
...
{
    int rv = 0;
    if ((SOC_IS_DNXF(unit) || SOC_IS_DNX(unit)) && soc_property_suffix_num_get(unit, -1, spn_CUSTOM_FEATURE, "access_only", 0))
    {
        return rv;
    }
    else
    ...
    for (blk = 0; SOC_BLOCK_INFO(unit, blk).type >= 0; blk++) {
        ...
        if (sal_strncmp(SOC_BLOCK_NAME(unit,blk), "BRDC_", BRDC_PREFIX_LEN) == 0) {
            ...
            else
            {
                ...
                {
                    LOG_INFO(BSL_LS_APPL_TESTS,
                        (BSL_META("BROADCAST block %d (instance=%d) %s is not valid, skip it \n"),
                        blk, brdc_count, SOC_BLOCK_NAME(unit,blk)));
                    continue;
                }
