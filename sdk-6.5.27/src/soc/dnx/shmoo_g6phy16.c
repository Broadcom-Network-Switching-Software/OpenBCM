...
#include <soc/dnx/g6ddrc16.h>
#include <soc/dnx/shmoo_g6phy16.h>
...
static _shmoo_g6phy16_drc_gddr6_dq_byte_pairs_swap_info_get_t _shmoo_g6phy16_drc_gddr6_dq_byte_pairs_swap_info_get =
    NULL;
...
_g6phy16_get_random(
    void)
{
    static uint32 m_w = 6483;
    static uint32 m_z = 31245;
    ...
    int unit)
{
    ...
    if ((shmoo_dram_info.ctl_type == 0)
        ...
        || (shmoo_dram_info.ref_clk_mhz == -1) || (shmoo_dram_info.ref_clk_bitmap == 0))
    {
...
uint32
_shmoo_g6phy16_validate_cbi(
    int unit)
{
    SOC_INIT_FUNC_DEFS;
    if ((soc_g6phy16_phy_reg_read == NULL)
        ...
        || (_shmoo_g6phy16_drc_soft_reset_drc_without_dram == NULL) || (_shmoo_g6phy16_drc_dram_info_access == NULL))
    {
...
static void
g6phy16_training_bist_info_t_init(
    ...
    switch (scPtr->shmooType)
    {
        ...
        case SHMOO_G6PHY16_DBI_WR_DESKEW:
        {
            ...
            for (pattern_iter = 0; pattern_iter < SHMOO_G6PHY16_BIST_NOF_PATTERNS; pattern_iter++)
            {
                ...
                sal_memset(gbiPtr->bist_data_pattern[pattern_iter], 0xFF,
                           sizeof(gbiPtr->bist_data_pattern[pattern_iter]));
...
_g6phy16_run_bist(
    ...
    g6phy16_bist_info_t * biPtr,
    g6phy16_training_bist_info_t * gbiPtr,
    g6phy16_shmoo_error_array_t * seaPtr)
{
        ...
        case SHMOO_G6PHY16_EDC_START_FISH:
        {
            ...
            if (gbe.bist_sanity_err_bitmap[0])
            {
                LOG_VERBOSE(BSL_LS_SOC_DDR,
                            (BSL_META_U(unit, "sanity error in this spot, error in bytes 0x%x\n"),
...
STATIC int
_g6phy16_calculate_ui_position(
    uint32 linearPos,
    g6phy16_shmoo_container_t * scPtr,
    g6phy16_ui_position_t * upPtr)
{
    uint32 ui;
    uint32 position;
...
STATIC int
_g6phy16_calculate_addr_ui_position(
    uint32 linearPos,
    g6phy16_shmoo_container_t * scPtr,
    g6phy16_ui_position_t * upPtr)
{
...
STATIC int
_g6phy16_move_read_max_vdl_glitch_free(
    int unit,
    int dram_index,
    uint32 byte_map,
    uint32 position,
    g6phy16_shmoo_container_t * scPtr)
{
    ...
    soc_reg_t SOC_PHY_GDDR6_REG_DQ_BYTE_READ_MAX_VDL_RCK_MASTER_CTRLl[] =
    ...
    {
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_read
                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_READ_MAX_VDL_RCK_MASTER_CTRLl[byte_iter], dram_index, &data));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_READ_MAX_VDL_RCK_MASTER_CTRLl[byte_iter], data,
                          SOC_PHY_GDDR6_MAX_VDL_STEPf, &curPosition));
        ...
        while (curPosition != position)
        {
            ...
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_READ_MAX_VDL_RCK_MASTER_CTRLl[byte_iter], &data,
                              SOC_PHY_GDDR6_MAX_VDL_STEPf, curPosition));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_write
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_READ_MAX_VDL_RCK_MASTER_CTRLl[byte_iter], dram_index,
                              data));
    ...
    g6phy16_shmoo_container_t * scPtr)
{
    ...
    for (x = 0; x < scPtr->sizeX; x++)
    {
        ...
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MAX_VDL_WCKr, &data0, SOC_PHY_GDDR6_MAX_VDL_STEPf, x));
    ...
    for (delay = 0; delay < 16; delay++)
    {
        ...
        for (ui = 3; ui < 11; ui++)
        {
            ...
            if (fish0)
            {
                ...
                _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                 (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_ALIGNMENT_CTRLr, &data,
                                  SOC_PHY_GDDR6_DATA_UI_SHIFTf, ui));
            ...
            if (fish1)
            {
                ...
                _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                 (unit, SOC_PHY_GDDR6_REG_DQ_BYTE1_READ_ALIGNMENT_CTRLr, &data,
                                  SOC_PHY_GDDR6_DATA_UI_SHIFTf, ui));
            ...
            if (fish2)
            {
                ...
                _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                 (unit, SOC_PHY_GDDR6_REG_DQ_BYTE2_READ_ALIGNMENT_CTRLr, &data,
                                  SOC_PHY_GDDR6_DATA_UI_SHIFTf, ui));
            ...
            if (fish3)
            {
                ...
                _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                 (unit, SOC_PHY_GDDR6_REG_DQ_BYTE3_READ_ALIGNMENT_CTRLr, &data,
                                  SOC_PHY_GDDR6_DATA_UI_SHIFTf, ui));
            ...
            for (x = 0; x < ((scPtr->endUI[0] + 1) >> jump); x++)
            {
                ...
                {
                    LOG_VERBOSE(BSL_LS_SOC_DDR,
                                (BSL_META_U(unit, "d: %02d    UI: %d    Pos: %03d    Result: 0x%08X\n"), delay, ui,
                                 x << jump, result));
                }
                ...
                if (fish0)
                {
                    if ((result & 0x000000FF) != 0x000000FF)
                    {
                        ...
                        if (!fish0)
                        {
                            _SOC_IF_ERR_EXIT(READ_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_ALIGNMENT_CTRLr
                                             (unit, drc_ndx, &data));
                            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_ALIGNMENT_CTRLr, &data,
                                              SOC_PHY_GDDR6_DATA_UI_SHIFTf, ui + 2));
                            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_ALIGNMENT_CTRLr
                                             (unit, drc_ndx, data));
                        }
                    }
                    else
                ...
                if (fish1)
                {
                    if ((result & 0x0000FF00) != 0x0000FF00)
                    {
                        ...
                        if (!fish1)
                        {
                            _SOC_IF_ERR_EXIT(READ_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_READ_ALIGNMENT_CTRLr
                                             (unit, drc_ndx, &data));
                            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE1_READ_ALIGNMENT_CTRLr, &data,
                                              SOC_PHY_GDDR6_DATA_UI_SHIFTf, ui + 2));
                            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_READ_ALIGNMENT_CTRLr
                                             (unit, drc_ndx, data));
                        }
                    }
                    else
                ...
                if (fish2)
                {
                    if ((result & 0x00FF0000) != 0x00FF0000)
                    {
                        ...
                        if (!fish2)
                        {
                            _SOC_IF_ERR_EXIT(READ_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_READ_ALIGNMENT_CTRLr
                                             (unit, drc_ndx, &data));
                            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE2_READ_ALIGNMENT_CTRLr, &data,
                                              SOC_PHY_GDDR6_DATA_UI_SHIFTf, ui + 2));
                            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_READ_ALIGNMENT_CTRLr
                                             (unit, drc_ndx, data));
                        }
                    }
                    else
                ...
                if (fish3)
                {
                    if ((result & 0xFF000000) != 0xFF000000)
                    {
                        ...
                        if (!fish3)
                        {
                            _SOC_IF_ERR_EXIT(READ_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_READ_ALIGNMENT_CTRLr
                                             (unit, drc_ndx, &data));
                            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE3_READ_ALIGNMENT_CTRLr, &data,
                                              SOC_PHY_GDDR6_DATA_UI_SHIFTf, ui + 2));
                            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_READ_ALIGNMENT_CTRLr
                                             (unit, drc_ndx, data));
                        }
                    }
                    else
        ...
        LOG_INFO(BSL_LS_SOC_DDR,
                 (BSL_META_U(unit, "   ** Delay %02d........: %01d %01d %01d %01d\n"), delay, fish3, fish2, fish1,
                  fish0));
        ...
        if (fish0)
        {
            ...
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_ALIGNMENT_CTRLr, data,
                              SOC_PHY_GDDR6_DATA_VALID_WR2RD_DELAY_INCf, &inc));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_ALIGNMENT_CTRLr, &data,
                              SOC_PHY_GDDR6_DATA_VALID_WR2RD_DELAY_INCf, inc ^ 0x1));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_ALIGNMENT_CTRLr, &data,
                              SOC_PHY_GDDR6_DATA_VALID_WR2RD_DELAYf, delay + 1));
            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_ALIGNMENT_CTRLr(unit, drc_ndx, data));
        }
        if (fish1)
        {
    ...
    g6phy16_shmoo_container_t * scPtr)
{
    ...
    _SOC_IF_ERR_EXIT(READ_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_ALIGNMENT_CTRLr(unit, drc_ndx, &data));
    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_ALIGNMENT_CTRLr, data, SOC_PHY_GDDR6_DATA_UI_SHIFTf, &ui));
    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_ALIGNMENT_CTRLr, data,
                      SOC_PHY_GDDR6_DATA_VALID_WR2RD_DELAYf, &valid_wr2rd_delay[0]));
    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_ALIGNMENT_CTRLr, &data, SOC_PHY_GDDR6_EDC_UI_SHIFTf, ui));
    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_ALIGNMENT_CTRLr(unit, drc_ndx, data));

    _SOC_IF_ERR_EXIT(READ_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_READ_ALIGNMENT_CTRLr(unit, drc_ndx, &data));
    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE1_READ_ALIGNMENT_CTRLr, data, SOC_PHY_GDDR6_DATA_UI_SHIFTf, &ui));
    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE1_READ_ALIGNMENT_CTRLr, data,
                      SOC_PHY_GDDR6_DATA_VALID_WR2RD_DELAYf, &valid_wr2rd_delay[1]));
    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE1_READ_ALIGNMENT_CTRLr, &data, SOC_PHY_GDDR6_EDC_UI_SHIFTf, ui));
    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_READ_ALIGNMENT_CTRLr(unit, drc_ndx, data));

    _SOC_IF_ERR_EXIT(READ_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_READ_ALIGNMENT_CTRLr(unit, drc_ndx, &data));
    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE2_READ_ALIGNMENT_CTRLr, data, SOC_PHY_GDDR6_DATA_UI_SHIFTf, &ui));
    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE2_READ_ALIGNMENT_CTRLr, data,
                      SOC_PHY_GDDR6_DATA_VALID_WR2RD_DELAYf, &valid_wr2rd_delay[2]));
    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE2_READ_ALIGNMENT_CTRLr, &data, SOC_PHY_GDDR6_EDC_UI_SHIFTf, ui));
    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_READ_ALIGNMENT_CTRLr(unit, drc_ndx, data));

    _SOC_IF_ERR_EXIT(READ_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_READ_ALIGNMENT_CTRLr(unit, drc_ndx, &data));
    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE3_READ_ALIGNMENT_CTRLr, data, SOC_PHY_GDDR6_DATA_UI_SHIFTf, &ui));
    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE3_READ_ALIGNMENT_CTRLr, data,
                      SOC_PHY_GDDR6_DATA_VALID_WR2RD_DELAYf, &valid_wr2rd_delay[3]));
    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE3_READ_ALIGNMENT_CTRLr, &data, SOC_PHY_GDDR6_EDC_UI_SHIFTf, ui));
    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_READ_ALIGNMENT_CTRLr(unit, drc_ndx, data));
    ...
    for (delay = 0; delay < 16; delay++)
    {
        ...
        if (delay >= min_valid_wr2rd_delay)
        {
            for (x = 0; x < ((scPtr->endUI[3] + 1) >> jump); x++)
            {
                ...
                {
                    LOG_VERBOSE(BSL_LS_SOC_DDR,
                                (BSL_META_U(unit, "delay: %02d    UI: %delay    Pos: %03d    Result: 0x%08X\n"), delay,
                                 ui, x << jump, result));
                }
        ...
        if (fish0)
        {
            ...
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_ALIGNMENT_CTRLr, data,
                              SOC_PHY_GDDR6_EDC_VALID_WR2RD_DELAY_INCf, &inc));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_ALIGNMENT_CTRLr, &data,
                              SOC_PHY_GDDR6_EDC_VALID_WR2RD_DELAY_INCf, inc ^ 0x1));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_ALIGNMENT_CTRLr, &data,
                              SOC_PHY_GDDR6_EDC_VALID_WR2RD_DELAYf, delay + 1));
            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_ALIGNMENT_CTRLr(unit, drc_ndx, data));
        }
        if (fish1)
        {
    ...
    g6phy16_shmoo_container_t * scPtr)
{
    ...
    for (b = 0; b < SHMOO_G6PHY16_BYTE; b++)
    {
        ...
        for (x = 0; x < scPtr->sizeX; x++)
        {
            ...
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MAX_VDL_DATAr, &data, SOC_PHY_GDDR6_UI_SHIFTf,
                              ui));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MAX_VDL_DATAr, &data, SOC_PHY_GDDR6_MAX_VDL_STEPf,
                              position));
            position++;
            ...
            LOG_VERBOSE(BSL_LS_SOC_DDR,
                        (BSL_META_U
                         (unit,
                          "bit in byte: 0x%01x; VDL position:%04d; UI position:%02d; SHMOO error array:0x%08x; SHMOO error counter=%05d \n"),
    ...
    g6phy16_shmoo_container_t * scPtr)
{
    ...
    for (x = 0; x < scPtr->sizeX; x++)
    {
        ...
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MAX_VDL_DATAr, &data, SOC_PHY_GDDR6_UI_SHIFTf, ui));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MAX_VDL_DATAr, &data, SOC_PHY_GDDR6_MAX_VDL_STEPf,
                          position));
        position++;
    ...
    g6phy16_shmoo_container_t * scPtr)
{
    ...
    for (x = 0; x < scPtr->sizeX; x++)
    {
        ...
        LOG_VERBOSE(BSL_LS_SOC_DDR,
                    (BSL_META_U
                     (unit,
                      "VDL position:%04d; UI position:%02d; SHMOO error array:0x%08x; SHMOO error counter=%05d \n"),
    ...
    g6phy16_shmoo_container_t * scPtr)
{
    ...
    if (optimized_run)
    {
        ...
        for (byte_index = 0; byte_index < 4; ++byte_index)
        {
            int center_position;
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_read
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_WRITE_MAX_VDL_DATAl[byte_index], drc_ndx, &data));

            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_WRITE_MAX_VDL_DATAl[byte_index], data,
                              SOC_PHY_GDDR6_UI_SHIFTf, &ui));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_WRITE_MAX_VDL_DATAl[byte_index], data,
                              SOC_PHY_GDDR6_MAX_VDL_STEPf, &position));
    ...
    for (y = yCapMin; y < yCapMax; y++)
    {
        ...
        {
            MRfield = y | 0x780;
            _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_modify_mrs
                             (unit, drc_ndx, SHMOO_G6PHY16_MR_CMD_ALL_CHANNELS, 6, MRfield, 0xFFF));
            MRfield = y | 0xF80;
            _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_modify_mrs
                             (unit, drc_ndx, SHMOO_G6PHY16_MR_CMD_ALL_CHANNELS, 6, MRfield, 0xFFF));
        }
    ...
    g6phy16_shmoo_container_t * scPtr)
{
    ...
    for (b = 0; b < SHMOO_G6PHY16_BYTE; b++)
    {
        ...
        {
            _SOC_IF_ERR_EXIT(READ_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_MAX_VDL_RCK_MASTER_CTRLr
                             (unit, drc_ndx, &data));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_MAX_VDL_RCK_MASTER_CTRLr, &data,
                              SOC_PHY_GDDR6_MAX_VDL_STEPf, x));
            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_MAX_VDL_RCK_MASTER_CTRLr
                             (unit, drc_ndx, data));
            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_READ_MAX_VDL_RCK_MASTER_CTRLr
                             (unit, drc_ndx, data));
            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_READ_MAX_VDL_RCK_MASTER_CTRLr
                             (unit, drc_ndx, data));
            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_READ_MAX_VDL_RCK_MASTER_CTRLr
                             (unit, drc_ndx, data));
...
STATIC int
_shmoo_g6phy16_dbi_edc_rd_deskew(
    int unit,
    int drc_ndx,
    g6phy16_shmoo_container_t * scPtr)
{
    ...
    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_MAX_VDL_RCK_MASTER_CTRLr, data, SOC_PHY_GDDR6_MAX_VDL_STEPf,
                      &pos0));
    _SOC_IF_ERR_EXIT(READ_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_READ_MAX_VDL_RCK_MASTER_CTRLr(unit, drc_ndx, &data));
    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE1_READ_MAX_VDL_RCK_MASTER_CTRLr, data, SOC_PHY_GDDR6_MAX_VDL_STEPf,
                      &pos1));
    _SOC_IF_ERR_EXIT(READ_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_READ_MAX_VDL_RCK_MASTER_CTRLr(unit, drc_ndx, &data));
    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE2_READ_MAX_VDL_RCK_MASTER_CTRLr, data, SOC_PHY_GDDR6_MAX_VDL_STEPf,
                      &pos2));
    _SOC_IF_ERR_EXIT(READ_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_READ_MAX_VDL_RCK_MASTER_CTRLr(unit, drc_ndx, &data));
    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE3_READ_MAX_VDL_RCK_MASTER_CTRLr, data, SOC_PHY_GDDR6_MAX_VDL_STEPf,
                      &pos3));
    ...
    for (b = 0; b < 2; b++)
    {
        ...
        for (x = scPtr->calibStart; x < scPtr->sizeX; x++)
        {
            ...
            LOG_VERBOSE(BSL_LS_SOC_DDR,
                        (BSL_META_U
                         (unit, "bit %d; DBI SHMOO error array: 0x%08x; EDC SHMOO error array: 0x%08x; position:%d\n"),
                         b, sea[0], sea[1], x));
        }
    }
    ...
    g6phy16_shmoo_container_t * scPtr)
{
    ...
    for (y = yCapMin; y < yCapMax; y++)
    {
        if (!scPtr->restore)
        {
            ...
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_VREF_DAC_CONFIGr, &data, SOC_PHY_GDDR6_DATAf, y << 1));
...
STATIC int
_shmoo_g6phy16_addr_ctrl_short(
    int unit,
    int drc_ndx,
    g6phy16_shmoo_container_t * scPtr)
{
    ...
    for (x = 0; x < scPtr->sizeX; x++)
    {
        ...
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_AQ_L_MAX_VDL_ADDRr, &data, SOC_PHY_GDDR6_UI_SHIFTf, addr_ui));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_AQ_L_MAX_VDL_ADDRr, &data, SOC_PHY_GDDR6_MAX_VDL_STEPf, position));
        position++;
    ...
    uint32 groupNumBits)
{
    ...
    if (calibSweep != SHMOO_G6PHY16_CALIB_SWEEP_1)
    {
        switch (groupOrder)
        {
            ...
            default:
                _SOC_EXIT_WITH_ERR(SOC_E_FAIL,
                                   (BSL_META_U(unit, "Unsupported 2D calibration group order: %02d\n"), groupOrder));
        }
        ...
        for (i = 0; i < iter; i++)
        {
            ...
            for (x = calibStart[i]; x < calibEnd[i]; x++)
            {
                switch (decisionMode)
                {
                    ...
                    default:
                        _SOC_EXIT_WITH_ERR(SOC_E_FAIL,
                                           (BSL_META_U(unit, "Unsupported calibration decision mode: %02d\n"),
                                            decisionMode));
                }
            ...
            switch (calibPos)
            {
                ...
                default:
                    _SOC_EXIT_WITH_ERR(SOC_E_FAIL,
                                       (BSL_META_U(unit, "Unsupported calibration position: %02d\n"), calibPos));
            }
        }
        xStart += sizeX;
    }
    ...
    g6phy16_shmoo_container_t * scPtr)
{
    ...
    {
        case SHMOO_G6PHY16_ADDR_CTRL_SHORT:
            _SOC_IF_ERR_EXIT(_g6phy16_calib_2D
                             (unit, drc_ndx, scPtr, SHMOO_G6PHY16_HALFWORD, SHMOO_G6PHY16_CALIB_CENTER_PASS,
                              SHMOO_G6PHY16_CALIB_SWEEP_1, SHMOO_G6PHY16_CALIB_PASS_ALL,
                              SHMOO_G6PHY16_CALIB_GROUP_ORDER_DONT_CARE, 0));
            break;
        case SHMOO_G6PHY16_WCK2CK:
            break;
        case SHMOO_G6PHY16_RD_START_FISH:
        ...
        case SHMOO_G6PHY16_RD_DESKEW:
            _SOC_IF_ERR_EXIT(_g6phy16_calib_2D
                             (unit, drc_ndx, scPtr, SHMOO_G6PHY16_BYTE, SHMOO_G6PHY16_CALIB_CENTER_PASS,
                              SHMOO_G6PHY16_CALIB_SWEEP_1, SHMOO_G6PHY16_CALIB_PASS_ANY,
                              SHMOO_G6PHY16_CALIB_GROUP_ORDER_DONT_CARE, 0));
            _SOC_IF_ERR_EXIT(_g6phy16_calib_2D
                             (unit, drc_ndx, scPtr, SHMOO_G6PHY16_BIT, SHMOO_G6PHY16_CALIB_CENTER_PASS,
                              SHMOO_G6PHY16_CALIB_SWEEP_BYTE_TO_BIT, SHMOO_G6PHY16_CALIB_PASS_ALL,
                              SHMOO_G6PHY16_CALIB_GROUP_ORDER_00112233, 8));
            break;
        case SHMOO_G6PHY16_DBI_EDC_RD_DESKEW:
            _SOC_IF_ERR_EXIT(_g6phy16_calib_2D
                             (unit, drc_ndx, scPtr, SHMOO_G6PHY16_BIT, SHMOO_G6PHY16_CALIB_CENTER_PASS,
                              SHMOO_G6PHY16_CALIB_SWEEP_BYTE_TO_BIT, SHMOO_G6PHY16_CALIB_PASS_ALL,
                              SHMOO_G6PHY16_CALIB_GROUP_ORDER_01230123, 2));
            break;
        case SHMOO_G6PHY16_RD_SHORT:
            _SOC_IF_ERR_EXIT(_g6phy16_calib_2D
                             (unit, drc_ndx, scPtr, SHMOO_G6PHY16_BYTE, SHMOO_G6PHY16_CALIB_CENTER_PASS,
        ...
        case SHMOO_G6PHY16_RD_EXTENDED:
            _SOC_IF_ERR_EXIT(_g6phy16_calib_2D
                             (unit, drc_ndx, scPtr, SHMOO_G6PHY16_BYTE, SHMOO_G6PHY16_CALIB_XY_AVERAGE,
                              SHMOO_G6PHY16_CALIB_SWEEP_1, SHMOO_G6PHY16_CALIB_PASS_ALL,
                              SHMOO_G6PHY16_CALIB_GROUP_ORDER_DONT_CARE, 0));
            break;
        case SHMOO_G6PHY16_WR_EXTENDED:
    ...
    uint32 add_value)
{
    ...
    soc_phy_gddr6_reg_t DQ_MIN_VDL_REGS[4][8] =
        { {SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_MIN_VDL_BIT0r, SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_MIN_VDL_BIT1r,
    ...
    LOG_INFO(BSL_LS_SOC_DDR,
             (BSL_META_U(unit, "changing min VDL values for interface%d; byte %d; by value of %d .\n"), drc_index,
              byte_index, add_value));
    ...
    for (bit_iter = 0; bit_iter < 8; ++bit_iter)
    {
        ...
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                         (unit, DQ_MIN_VDL_REGS[byte_index][bit_iter], reg_val, SOC_PHY_GDDR6_MIN_VDL_STEPf,
                          &min_vdl_val));
        ...
        if (new_min_vdl_val >= SHMOO_G6PHY16_MIN_VDL_LENGTH)
        {
            ...
            LOG_INFO(BSL_LS_SOC_DDR,
                     (BSL_META_U
                      (unit,
                       "WARNING: Bit skew adjustment is beyond available MIN VDL range. Results may not be optimal.\n")));
    ...
    switch (scPtr->shmooType)
    {
            ...
            switch (calibMode)
            {
                case SHMOO_G6PHY16_HALFWORD:
                    ...
                    if (engageUIshift)
                    {
                        ...
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_AQ_L_MAX_VDL_ADDRr, &data, SOC_PHY_GDDR6_UI_SHIFTf,
                                          up.ui));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_AQ_L_MAX_VDL_ADDRr, &data,
                                          SOC_PHY_GDDR6_MAX_VDL_STEPf, up.position));
                    }
                    else
                    {
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_AQ_L_MAX_VDL_ADDRr, &data,
                                          SOC_PHY_GDDR6_MAX_VDL_STEPf, scPtr->resultData[0] & 0xFFFF));
                    }
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_AQ_L_MAX_VDL_ADDRr(unit, drc_ndx, data));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_AQ_L_MAX_VDL_CTRLr(unit, drc_ndx, data));
                    ...
                    if (engageUIshift)
                    {
                        ...
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_AQ_U_MAX_VDL_ADDRr, &data, SOC_PHY_GDDR6_UI_SHIFTf,
                                          up.ui));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_AQ_U_MAX_VDL_ADDRr, &data,
                                          SOC_PHY_GDDR6_MAX_VDL_STEPf, up.position));
                    }
                    else
                    {
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_AQ_U_MAX_VDL_ADDRr, &data,
                                          SOC_PHY_GDDR6_MAX_VDL_STEPf, scPtr->resultData[1] & 0xFFFF));
                    }
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_AQ_U_MAX_VDL_ADDRr(unit, drc_ndx, data));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_AQ_U_MAX_VDL_CTRLr(unit, drc_ndx, data));
        ...
        case SHMOO_G6PHY16_RD_DESKEW:
            switch (calibMode)
            {
                case SHMOO_G6PHY16_BIT:
                    ...
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_MIN_VDL_BIT0r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      max0 - (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte0][0]] & 0xFFFF) +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_MIN_VDL_BIT0r(unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_MIN_VDL_BIT1r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      max0 - (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte0][1]] & 0xFFFF) +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_MIN_VDL_BIT1r(unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_MIN_VDL_BIT2r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      max0 - (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte0][2]] & 0xFFFF) +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_MIN_VDL_BIT2r(unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_MIN_VDL_BIT3r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      max0 - (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte0][3]] & 0xFFFF) +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_MIN_VDL_BIT3r(unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_MIN_VDL_BIT4r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      max0 - (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte0][4]] & 0xFFFF) +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_MIN_VDL_BIT4r(unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_MIN_VDL_BIT5r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      max0 - (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte0][5]] & 0xFFFF) +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_MIN_VDL_BIT5r(unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_MIN_VDL_BIT6r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      max0 - (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte0][6]] & 0xFFFF) +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_MIN_VDL_BIT6r(unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_MIN_VDL_BIT7r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      max0 - (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte0][7]] & 0xFFFF) +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_MIN_VDL_BIT7r(unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE1_READ_MIN_VDL_BIT0r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      max1 -
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte1][0] + 8] & 0xFFFF) +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_READ_MIN_VDL_BIT0r(unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE1_READ_MIN_VDL_BIT1r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      max1 -
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte1][1] + 8] & 0xFFFF) +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_READ_MIN_VDL_BIT1r(unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE1_READ_MIN_VDL_BIT2r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      max1 -
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte1][2] + 8] & 0xFFFF) +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_READ_MIN_VDL_BIT2r(unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE1_READ_MIN_VDL_BIT3r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      max1 -
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte1][3] + 8] & 0xFFFF) +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_READ_MIN_VDL_BIT3r(unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE1_READ_MIN_VDL_BIT4r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      max1 -
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte1][4] + 8] & 0xFFFF) +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_READ_MIN_VDL_BIT4r(unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE1_READ_MIN_VDL_BIT5r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      max1 -
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte1][5] + 8] & 0xFFFF) +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_READ_MIN_VDL_BIT5r(unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE1_READ_MIN_VDL_BIT6r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      max1 -
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte1][6] + 8] & 0xFFFF) +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_READ_MIN_VDL_BIT6r(unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE1_READ_MIN_VDL_BIT7r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      max1 -
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte1][7] + 8] & 0xFFFF) +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_READ_MIN_VDL_BIT7r(unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE2_READ_MIN_VDL_BIT0r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      max2 -
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte2][0] + 16] & 0xFFFF) +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_READ_MIN_VDL_BIT0r(unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE2_READ_MIN_VDL_BIT1r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      max2 -
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte2][1] + 16] & 0xFFFF) +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_READ_MIN_VDL_BIT1r(unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE2_READ_MIN_VDL_BIT2r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      max2 -
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte2][2] + 16] & 0xFFFF) +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_READ_MIN_VDL_BIT2r(unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE2_READ_MIN_VDL_BIT3r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      max2 -
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte2][3] + 16] & 0xFFFF) +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_READ_MIN_VDL_BIT3r(unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE2_READ_MIN_VDL_BIT4r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      max2 -
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte2][4] + 16] & 0xFFFF) +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_READ_MIN_VDL_BIT4r(unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE2_READ_MIN_VDL_BIT5r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      max2 -
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte2][5] + 16] & 0xFFFF) +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_READ_MIN_VDL_BIT5r(unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE2_READ_MIN_VDL_BIT6r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      max2 -
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte2][6] + 16] & 0xFFFF) +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_READ_MIN_VDL_BIT6r(unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE2_READ_MIN_VDL_BIT7r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      max2 -
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte2][7] + 16] & 0xFFFF) +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_READ_MIN_VDL_BIT7r(unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE3_READ_MIN_VDL_BIT0r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      max3 -
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte3][0] + 24] & 0xFFFF) +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_READ_MIN_VDL_BIT0r(unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE3_READ_MIN_VDL_BIT1r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      max3 -
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte3][1] + 24] & 0xFFFF) +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_READ_MIN_VDL_BIT1r(unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE3_READ_MIN_VDL_BIT2r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      max3 -
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte3][2] + 24] & 0xFFFF) +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_READ_MIN_VDL_BIT2r(unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE3_READ_MIN_VDL_BIT3r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      max3 -
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte3][3] + 24] & 0xFFFF) +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_READ_MIN_VDL_BIT3r(unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE3_READ_MIN_VDL_BIT4r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      max3 -
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte3][4] + 24] & 0xFFFF) +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_READ_MIN_VDL_BIT4r(unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE3_READ_MIN_VDL_BIT5r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      max3 -
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte3][5] + 24] & 0xFFFF) +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_READ_MIN_VDL_BIT5r(unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE3_READ_MIN_VDL_BIT6r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      max3 -
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte3][6] + 24] & 0xFFFF) +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_READ_MIN_VDL_BIT6r(unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE3_READ_MIN_VDL_BIT7r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      max3 -
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte3][7] + 24] & 0xFFFF) +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_READ_MIN_VDL_BIT7r(unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(_g6phy16_move_read_max_vdl_glitch_free
                                     (unit, drc_ndx, 0x1, max0 - initAdjustment, scPtr));
                    _SOC_IF_ERR_EXIT(_g6phy16_move_read_max_vdl_glitch_free
                                     (unit, drc_ndx, 0x2, max1 - initAdjustment, scPtr));
                    _SOC_IF_ERR_EXIT(_g6phy16_move_read_max_vdl_glitch_free
                                     (unit, drc_ndx, 0x4, max2 - initAdjustment, scPtr));
                    _SOC_IF_ERR_EXIT(_g6phy16_move_read_max_vdl_glitch_free
                                     (unit, drc_ndx, 0x8, max3 - initAdjustment, scPtr));
        ...
        case SHMOO_G6PHY16_DBI_EDC_RD_DESKEW:
            switch (calibMode)
            {
                case SHMOO_G6PHY16_BIT:
                {
                    soc_phy_gddr6_reg_t DQ_MAX_VDL_REGS[] = { SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_MAX_VDL_RCK_MASTER_CTRLr,
                        SOC_PHY_GDDR6_REG_DQ_BYTE1_READ_MAX_VDL_RCK_MASTER_CTRLr,
                        SOC_PHY_GDDR6_REG_DQ_BYTE2_READ_MAX_VDL_RCK_MASTER_CTRLr,
                        SOC_PHY_GDDR6_REG_DQ_BYTE3_READ_MAX_VDL_RCK_MASTER_CTRLr
                    };
                    soc_phy_gddr6_reg_t DBI_MIN_VDL_REGS[] = { SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_MIN_VDL_DBI_Nr,
                    ...
                    soc_phy_gddr6_reg_t EDC_MIN_VDL_REGS[] =
                        { SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_MIN_VDL_EDCr, SOC_PHY_GDDR6_REG_DQ_BYTE1_READ_MIN_VDL_EDCr,
                    ...
                    for (bit_iter = 0; bit_iter < 4; ++bit_iter)
                    {
                        ...
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                                         (unit, DQ_MAX_VDL_REGS[bit_iter], data, SOC_PHY_GDDR6_MAX_VDL_STEPf,
                                          &old_max));
                        ...
                        data = 0;
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, DBI_MIN_VDL_REGS[bit_iter], &data, SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                          new_max - dbi_val));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_write(unit, DBI_MIN_VDL_REGS[bit_iter], drc_ndx, data));

                        data = 0;
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, EDC_MIN_VDL_REGS[bit_iter], &data, SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                          new_max - edc_val));
        ...
        case SHMOO_G6PHY16_RD_SHORT:
            switch (calibMode)
            {
                case SHMOO_G6PHY16_BYTE:
                    ...
                    if (xMin < (scPtr->endUI[2] >> 2))
                    {
                        if ((xMax - xMin) < scPtr->endUI[0])
                        {
                            data =
                                (((((xMax - xMin) +
                                    (scPtr->endUI[0] >> 2)) << 4) | 0x4) & 0x1FFC) | (data & 0xFFFFE003);
                        }
                        else
                        {
                ...
                case SHMOO_G6PHY16_HALFWORD:
                    ...
                    _SOC_IF_ERR_EXIT(_g6phy16_move_read_max_vdl_glitch_free
                                     (unit, drc_ndx, 0x3, scPtr->resultData[0] & 0xFFFF, scPtr));
                    _SOC_IF_ERR_EXIT(_g6phy16_move_read_max_vdl_glitch_free
                                     (unit, drc_ndx, 0xC, scPtr->resultData[1] & 0xFFFF, scPtr));
                ...
                case SHMOO_G6PHY16_WORD:
                    ...
                    _SOC_IF_ERR_EXIT(_g6phy16_move_read_max_vdl_glitch_free
                                     (unit, drc_ndx, 0xF, scPtr->resultData[0] & 0xFFFF, scPtr));
        ...
        case SHMOO_G6PHY16_WR_DESKEW:
            switch (calibMode)
            {
                case SHMOO_G6PHY16_BIT:
                    ...
                    data = 0;
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MIN_VDL_BIT0r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte0][0]] & 0xFFFF) - min0 +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MIN_VDL_BIT0r
                                     (unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MIN_VDL_BIT1r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte0][1]] & 0xFFFF) - min0 +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MIN_VDL_BIT1r
                                     (unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MIN_VDL_BIT2r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte0][2]] & 0xFFFF) - min0 +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MIN_VDL_BIT2r
                                     (unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MIN_VDL_BIT3r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte0][3]] & 0xFFFF) - min0 +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MIN_VDL_BIT3r
                                     (unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MIN_VDL_BIT4r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte0][4]] & 0xFFFF) - min0 +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MIN_VDL_BIT4r
                                     (unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MIN_VDL_BIT5r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte0][5]] & 0xFFFF) - min0 +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MIN_VDL_BIT5r
                                     (unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MIN_VDL_BIT6r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte0][6]] & 0xFFFF) - min0 +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MIN_VDL_BIT6r
                                     (unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MIN_VDL_BIT7r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte0][7]] & 0xFFFF) - min0 +
                                      initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MIN_VDL_BIT7r
                                     (unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE1_WRITE_MIN_VDL_BIT0r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte1][0] + 8] & 0xFFFF) -
                                      min1 + initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_WRITE_MIN_VDL_BIT0r
                                     (unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE1_WRITE_MIN_VDL_BIT1r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte1][1] + 8] & 0xFFFF) -
                                      min1 + initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_WRITE_MIN_VDL_BIT1r
                                     (unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE1_WRITE_MIN_VDL_BIT2r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte1][2] + 8] & 0xFFFF) -
                                      min1 + initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_WRITE_MIN_VDL_BIT2r
                                     (unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE1_WRITE_MIN_VDL_BIT3r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte1][3] + 8] & 0xFFFF) -
                                      min1 + initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_WRITE_MIN_VDL_BIT3r
                                     (unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE1_WRITE_MIN_VDL_BIT4r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte1][4] + 8] & 0xFFFF) -
                                      min1 + initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_WRITE_MIN_VDL_BIT4r
                                     (unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE1_WRITE_MIN_VDL_BIT5r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte1][5] + 8] & 0xFFFF) -
                                      min1 + initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_WRITE_MIN_VDL_BIT5r
                                     (unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE1_WRITE_MIN_VDL_BIT6r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte1][6] + 8] & 0xFFFF) -
                                      min1 + initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_WRITE_MIN_VDL_BIT6r
                                     (unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE1_WRITE_MIN_VDL_BIT7r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte1][7] + 8] & 0xFFFF) -
                                      min1 + initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_WRITE_MIN_VDL_BIT7r
                                     (unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE2_WRITE_MIN_VDL_BIT0r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte2][0] + 16] & 0xFFFF) -
                                      min2 + initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_WRITE_MIN_VDL_BIT0r
                                     (unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE2_WRITE_MIN_VDL_BIT1r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte2][1] + 16] & 0xFFFF) -
                                      min2 + initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_WRITE_MIN_VDL_BIT1r
                                     (unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE2_WRITE_MIN_VDL_BIT2r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte2][2] + 16] & 0xFFFF) -
                                      min2 + initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_WRITE_MIN_VDL_BIT2r
                                     (unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE2_WRITE_MIN_VDL_BIT3r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte2][3] + 16] & 0xFFFF) -
                                      min2 + initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_WRITE_MIN_VDL_BIT3r
                                     (unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE2_WRITE_MIN_VDL_BIT4r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte2][4] + 16] & 0xFFFF) -
                                      min2 + initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_WRITE_MIN_VDL_BIT4r
                                     (unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE2_WRITE_MIN_VDL_BIT5r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte2][5] + 16] & 0xFFFF) -
                                      min2 + initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_WRITE_MIN_VDL_BIT5r
                                     (unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE2_WRITE_MIN_VDL_BIT6r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte2][6] + 16] & 0xFFFF) -
                                      min2 + initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_WRITE_MIN_VDL_BIT6r
                                     (unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE2_WRITE_MIN_VDL_BIT7r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte2][7] + 16] & 0xFFFF) -
                                      min2 + initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_WRITE_MIN_VDL_BIT7r
                                     (unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE3_WRITE_MIN_VDL_BIT0r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte3][0] + 24] & 0xFFFF) -
                                      min3 + initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_WRITE_MIN_VDL_BIT0r
                                     (unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE3_WRITE_MIN_VDL_BIT1r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte3][1] + 24] & 0xFFFF) -
                                      min3 + initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_WRITE_MIN_VDL_BIT1r
                                     (unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE3_WRITE_MIN_VDL_BIT2r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte3][2] + 24] & 0xFFFF) -
                                      min3 + initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_WRITE_MIN_VDL_BIT2r
                                     (unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE3_WRITE_MIN_VDL_BIT3r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte3][3] + 24] & 0xFFFF) -
                                      min3 + initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_WRITE_MIN_VDL_BIT3r
                                     (unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE3_WRITE_MIN_VDL_BIT4r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte3][4] + 24] & 0xFFFF) -
                                      min3 + initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_WRITE_MIN_VDL_BIT4r
                                     (unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE3_WRITE_MIN_VDL_BIT5r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte3][5] + 24] & 0xFFFF) -
                                      min3 + initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_WRITE_MIN_VDL_BIT5r
                                     (unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE3_WRITE_MIN_VDL_BIT6r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte3][6] + 24] & 0xFFFF) -
                                      min3 + initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_WRITE_MIN_VDL_BIT6r
                                     (unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE3_WRITE_MIN_VDL_BIT7r, &data,
                                      SOC_PHY_GDDR6_MIN_VDL_STEPf,
                                      (scPtr->resultData[shmoo_dram_info.dq_swap[drc_ndx][byte3][7] + 24] & 0xFFFF) -
                                      min3 + initAdjustment));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_WRITE_MIN_VDL_BIT7r
                                     (unit, drc_ndx, data));

                    _SOC_IF_ERR_EXIT(READ_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MAX_VDL_DATAr
                                     (unit, drc_ndx, &data));
                    if (engageUIshift)
                    {
                        _SOC_IF_ERR_EXIT(_g6phy16_calculate_ui_position(min0 - initAdjustment, scPtr, &up));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MAX_VDL_DATAr, &data,
                                          SOC_PHY_GDDR6_UI_SHIFTf, up.ui));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MAX_VDL_DATAr, &data,
                                          SOC_PHY_GDDR6_MAX_VDL_STEPf, up.position));
                        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MAX_VDL_DATAr
                                         (unit, drc_ndx, data));

                        _SOC_IF_ERR_EXIT(_g6phy16_calculate_ui_position(min1 - initAdjustment, scPtr, &up));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE1_WRITE_MAX_VDL_DATAr, &data,
                                          SOC_PHY_GDDR6_UI_SHIFTf, up.ui));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE1_WRITE_MAX_VDL_DATAr, &data,
                                          SOC_PHY_GDDR6_MAX_VDL_STEPf, up.position));
                        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_WRITE_MAX_VDL_DATAr
                                         (unit, drc_ndx, data));

                        _SOC_IF_ERR_EXIT(_g6phy16_calculate_ui_position(min2 - initAdjustment, scPtr, &up));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE2_WRITE_MAX_VDL_DATAr, &data,
                                          SOC_PHY_GDDR6_UI_SHIFTf, up.ui));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE2_WRITE_MAX_VDL_DATAr, &data,
                                          SOC_PHY_GDDR6_MAX_VDL_STEPf, up.position));
                        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_WRITE_MAX_VDL_DATAr
                                         (unit, drc_ndx, data));

                        _SOC_IF_ERR_EXIT(_g6phy16_calculate_ui_position(min3 - initAdjustment, scPtr, &up));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE3_WRITE_MAX_VDL_DATAr, &data,
                                          SOC_PHY_GDDR6_UI_SHIFTf, up.ui));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE3_WRITE_MAX_VDL_DATAr, &data,
                                          SOC_PHY_GDDR6_MAX_VDL_STEPf, up.position));
                        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_WRITE_MAX_VDL_DATAr
                                         (unit, drc_ndx, data));
                    }
                    else
                    {
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MAX_VDL_DATAr, &data,
                                          SOC_PHY_GDDR6_MAX_VDL_STEPf, min0 - initAdjustment));
                        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MAX_VDL_DATAr
                                         (unit, drc_ndx, data));

                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE1_WRITE_MAX_VDL_DATAr, &data,
                                          SOC_PHY_GDDR6_MAX_VDL_STEPf, min1 - initAdjustment));
                        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_WRITE_MAX_VDL_DATAr
                                         (unit, drc_ndx, data));

                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE2_WRITE_MAX_VDL_DATAr, &data,
                                          SOC_PHY_GDDR6_MAX_VDL_STEPf, min2 - initAdjustment));
                        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_WRITE_MAX_VDL_DATAr
                                         (unit, drc_ndx, data));

                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE3_WRITE_MAX_VDL_DATAr, &data,
                                          SOC_PHY_GDDR6_MAX_VDL_STEPf, min3 - initAdjustment));
                        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_WRITE_MAX_VDL_DATAr
                                         (unit, drc_ndx, data));
                    }
        ...
        case SHMOO_G6PHY16_DBI_WR_DESKEW:
            switch (calibMode)
            {
                case SHMOO_G6PHY16_BIT:
                    ...
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MAX_VDL_DATAr, data,
                                      SOC_PHY_GDDR6_MAX_VDL_STEPf, &min0));
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MAX_VDL_DATAr, data,
                                      SOC_PHY_GDDR6_UI_SHIFTf, &val0));
                    if (val0)
                    {
                        min0 += (scPtr->endUI[val0 - 1] + 1);
                    }
                    _SOC_IF_ERR_EXIT(READ_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_WRITE_MAX_VDL_DATAr
                                     (unit, drc_ndx, &data));
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE1_WRITE_MAX_VDL_DATAr, data,
                                      SOC_PHY_GDDR6_MAX_VDL_STEPf, &min1));
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE1_WRITE_MAX_VDL_DATAr, data,
                                      SOC_PHY_GDDR6_UI_SHIFTf, &val1));
                    if (val1)
                    {
                        min1 += (scPtr->endUI[val1 - 1] + 1);
                    }
                    _SOC_IF_ERR_EXIT(READ_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_WRITE_MAX_VDL_DATAr
                                     (unit, drc_ndx, &data));
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE2_WRITE_MAX_VDL_DATAr, data,
                                      SOC_PHY_GDDR6_MAX_VDL_STEPf, &min2));
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE2_WRITE_MAX_VDL_DATAr, data,
                                      SOC_PHY_GDDR6_UI_SHIFTf, &val2));
                    if (val2)
                    {
                        min2 += (scPtr->endUI[val2 - 1] + 1);
                    }
                    _SOC_IF_ERR_EXIT(READ_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_WRITE_MAX_VDL_DATAr
                                     (unit, drc_ndx, &data));
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE3_WRITE_MAX_VDL_DATAr, data,
                                      SOC_PHY_GDDR6_MAX_VDL_STEPf, &min3));
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE3_WRITE_MAX_VDL_DATAr, data,
                                      SOC_PHY_GDDR6_UI_SHIFTf, &val3));
                    if (val3)
                    {
                    ...
                    {
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MIN_VDL_DBI_Nr, &data,
                                          SOC_PHY_GDDR6_MIN_VDL_STEPf, 0));
                    }
                    else
                    {
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MIN_VDL_DBI_Nr, &data,
                                          SOC_PHY_GDDR6_MIN_VDL_STEPf, (scPtr->resultData[0] & 0xFFFF) - min0));
                    }
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MIN_VDL_DBI_Nr
                                     (unit, drc_ndx, data));
                    ...
                    {
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE1_WRITE_MIN_VDL_DBI_Nr, &data,
                                          SOC_PHY_GDDR6_MIN_VDL_STEPf, 0));
                    }
                    else
                    {
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE1_WRITE_MIN_VDL_DBI_Nr, &data,
                                          SOC_PHY_GDDR6_MIN_VDL_STEPf, (scPtr->resultData[1] & 0xFFFF) - min1));
                    }
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_WRITE_MIN_VDL_DBI_Nr
                                     (unit, drc_ndx, data));
                    ...
                    {
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE2_WRITE_MIN_VDL_DBI_Nr, &data,
                                          SOC_PHY_GDDR6_MIN_VDL_STEPf, 0));
                    }
                    else
                    {
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE2_WRITE_MIN_VDL_DBI_Nr, &data,
                                          SOC_PHY_GDDR6_MIN_VDL_STEPf, (scPtr->resultData[2] & 0xFFFF) - min2));
                    }
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_WRITE_MIN_VDL_DBI_Nr
                                     (unit, drc_ndx, data));
                    ...
                    {
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE3_WRITE_MIN_VDL_DBI_Nr, &data,
                                          SOC_PHY_GDDR6_MIN_VDL_STEPf, 0));
                    }
                    else
                    {
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE3_WRITE_MIN_VDL_DBI_Nr, &data,
                                          SOC_PHY_GDDR6_MIN_VDL_STEPf, (scPtr->resultData[3] & 0xFFFF) - min3));
                    }
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_WRITE_MIN_VDL_DBI_Nr
                                     (unit, drc_ndx, data));
            ...
            switch (calibMode)
            {
                case SHMOO_G6PHY16_BYTE:
                    ...
                    else
                    {
                        ...
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE2_WRITE_MAX_VDL_DATAr, &data,
                                          SOC_PHY_GDDR6_MAX_VDL_STEPf, scPtr->resultData[2] & 0xFFFF));
                        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_WRITE_MAX_VDL_DATAr
                                         (unit, drc_ndx, data));

                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE3_WRITE_MAX_VDL_DATAr, &data,
                                          SOC_PHY_GDDR6_MAX_VDL_STEPf, scPtr->resultData[3] & 0xFFFF));
                        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_WRITE_MAX_VDL_DATAr
                                         (unit, drc_ndx, data));
                    }
        ...
        case SHMOO_G6PHY16_RD_EXTENDED:
            switch (calibMode)
            {
                case SHMOO_G6PHY16_BYTE:
                    _SOC_IF_ERR_EXIT(_g6phy16_move_read_max_vdl_glitch_free
                                     (unit, drc_ndx, 0x1, scPtr->resultData[0] & 0xFFFF, scPtr));
                    _SOC_IF_ERR_EXIT(_g6phy16_move_read_max_vdl_glitch_free
                                     (unit, drc_ndx, 0x2, scPtr->resultData[1] & 0xFFFF, scPtr));
                    _SOC_IF_ERR_EXIT(_g6phy16_move_read_max_vdl_glitch_free
                                     (unit, drc_ndx, 0x4, scPtr->resultData[2] & 0xFFFF, scPtr));
                    _SOC_IF_ERR_EXIT(_g6phy16_move_read_max_vdl_glitch_free
                                     (unit, drc_ndx, 0x8, scPtr->resultData[3] & 0xFFFF, scPtr));

                    if (!scPtr->restore)
                    {
                        _SOC_IF_ERR_EXIT(READ_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_VREF_DAC_CONFIGr
                                         (unit, drc_ndx, &data));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_VREF_DAC_CONFIGr, &data, SOC_PHY_GDDR6_DATAf,
                                          ((scPtr->resultData[0] >> 16) & 0xFFFF) << 1));
                        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_VREF_DAC_CONFIGr
                                         (unit, drc_ndx, data));

                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE1_VREF_DAC_CONFIGr, &data, SOC_PHY_GDDR6_DATAf,
                                          ((scPtr->resultData[1] >> 16) & 0xFFFF) << 1));
                        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_VREF_DAC_CONFIGr
                                         (unit, drc_ndx, data));

                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE2_VREF_DAC_CONFIGr, &data, SOC_PHY_GDDR6_DATAf,
                                          ((scPtr->resultData[2] >> 16) & 0xFFFF) << 1));
                        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_VREF_DAC_CONFIGr
                                         (unit, drc_ndx, data));

                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE3_VREF_DAC_CONFIGr, &data, SOC_PHY_GDDR6_DATAf,
                                          ((scPtr->resultData[3] >> 16) & 0xFFFF) << 1));
                        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_VREF_DAC_CONFIGr
                                         (unit, drc_ndx, data));
                    }
            ...
            switch (calibMode)
            {
                case SHMOO_G6PHY16_BYTE:
                    ...
                    if (!scPtr->restore)
                    {
                        ...
                        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_MACRO_RESERVED_REGr
                                         (unit, drc_ndx, MRfield0));
                        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_MACRO_RESERVED_REGr
                                         (unit, drc_ndx, MRfield1));
                        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_MACRO_RESERVED_REGr
                                         (unit, drc_ndx, MRfield2));
                        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_MACRO_RESERVED_REGr
                                         (unit, drc_ndx, MRfield3));
                        ...
                        {
                            _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_modify_mrs
                                             (unit, drc_ndx, 0, 6, MRfield2 | 0x780, 0xFFF));
                            _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_modify_mrs
                                             (unit, drc_ndx, 0, 6, MRfield3 | 0xF80, 0xFFF));
                            _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_modify_mrs
                                             (unit, drc_ndx, 1, 6, MRfield0 | 0x780, 0xFFF));
                            _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_modify_mrs
                                             (unit, drc_ndx, 1, 6, MRfield1 | 0xF80, 0xFFF));
                        }
                        else
                        {
                            _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_modify_mrs
                                             (unit, drc_ndx, 0, 6, MRfield0 | 0x780, 0xFFF));
                            _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_modify_mrs
                                             (unit, drc_ndx, 0, 6, MRfield1 | 0xF80, 0xFFF));
                            _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_modify_mrs
                                             (unit, drc_ndx, 1, 6, MRfield2 | 0x780, 0xFFF));
                            _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_modify_mrs
                                             (unit, drc_ndx, 1, 6, MRfield3 | 0xF80, 0xFFF));
                        }
                    }
                    ...
                    if (!scPtr->restore)
                    {
                        ...
                        if (swap)
                        {
                            _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_modify_mrs
                                             (unit, drc_ndx, 0, 6, MRfield2 | 0x780, 0xFFF));
                            _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_modify_mrs
                                             (unit, drc_ndx, 0, 6, MRfield2 | 0xF80, 0xFFF));
                            _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_modify_mrs
                                             (unit, drc_ndx, 1, 6, MRfield0 | 0x780, 0xFFF));
                            _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_modify_mrs
                                             (unit, drc_ndx, 1, 6, MRfield0 | 0xF80, 0xFFF));
                        }
                        else
                        {
                            _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_modify_mrs
                                             (unit, drc_ndx, 0, 6, MRfield0 | 0x780, 0xFFF));
                            _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_modify_mrs
                                             (unit, drc_ndx, 0, 6, MRfield0 | 0xF80, 0xFFF));
                            _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_modify_mrs
                                             (unit, drc_ndx, 1, 6, MRfield2 | 0x780, 0xFFF));
                            _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_modify_mrs
                                             (unit, drc_ndx, 1, 6, MRfield2 | 0xF80, 0xFFF));
                        }
                    }
                ...
                case SHMOO_G6PHY16_WORD:
                    ...
                    if (!scPtr->restore)
                    {
                        ...
                        _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_modify_mrs
                                         (unit, drc_ndx, SHMOO_G6PHY16_MR_CMD_ALL_CHANNELS, 6, MRfield0 | 0x780,
                                          0xFFF));
                        _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_modify_mrs
                                         (unit, drc_ndx, SHMOO_G6PHY16_MR_CMD_ALL_CHANNELS, 6, MRfield0 | 0xF80,
                                          0xFFF));
                    }
    ...
    uint32 plotMode)
{
    ...
    switch (plotMode)
    {
            ...
            switch (calibMode)
            {
                ...
                default:
                    LOG_ERROR(BSL_LS_SOC_DDR,
                              (BSL_META_U(unit, "Unsupported calibration mode during plot: %02d\n"), calibMode));
                    return SOC_E_FAIL;
            }
            break;
        case SHMOO_G6PHY16_BYTE:
            ...
            switch (calibMode)
            {
                case SHMOO_G6PHY16_BIT:
                    LOG_INFO(BSL_LS_SOC_DDR,
                             (BSL_META_U(unit, "WARNING: Plot mode coerced from byte mode to bit mode\n")));
                    iter = 32;
                    shiftAmount = 0;
                    dataMask = 0x1;
                    calibShiftAmount = 0;
        ...
        case SHMOO_G6PHY16_HALFWORD:
            ...
            switch (calibMode)
            {
                case SHMOO_G6PHY16_BIT:
                    LOG_INFO(BSL_LS_SOC_DDR,
                             (BSL_META_U(unit, "WARNING: Plot mode coerced from halfword mode to bit mode\n")));
                    iter = 32;
                    shiftAmount = 0;
                    dataMask = 0x1;
                    calibShiftAmount = 0;
                ...
                case SHMOO_G6PHY16_BYTE:
                    LOG_INFO(BSL_LS_SOC_DDR,
                             (BSL_META_U(unit, "WARNING: Plot mode coerced from halfword mode to byte mode\n")));
                    iter = 4;
                    shiftAmount = 3;
                    dataMask = 0xFF;
                    calibShiftAmount = 0;
        ...
        case SHMOO_G6PHY16_WORD:
            ...
            switch (calibMode)
            {
                case SHMOO_G6PHY16_BIT:
                    LOG_INFO(BSL_LS_SOC_DDR,
                             (BSL_META_U(unit, "WARNING: Plot mode coerced from word mode to bit mode\n")));
                    iter = 32;
                    shiftAmount = 0;
                    dataMask = 0x1;
                    calibShiftAmount = 0;
                ...
                case SHMOO_G6PHY16_BYTE:
                    LOG_INFO(BSL_LS_SOC_DDR,
                             (BSL_META_U(unit, "WARNING: Plot mode coerced from word mode to byte mode\n")));
                    iter = 4;
                    shiftAmount = 3;
                    dataMask = 0xFF;
                    calibShiftAmount = 0;
                ...
                case SHMOO_G6PHY16_HALFWORD:
                    LOG_INFO(BSL_LS_SOC_DDR,
                             (BSL_META_U(unit, "WARNING: Plot mode coerced from word mode to halfword mode\n")));
                    iter = 2;
                    shiftAmount = 4;
                    dataMask = 0xFFFF;
                    calibShiftAmount = 0;
    ...
    for (i = 0; i < iter; i++)
    {
        ...
        if ((sizeY > 1) || (i == 0))
        {
            LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "***** Interface.......: %3d\n"), drc_ndx));
            LOG_INFO(BSL_LS_SOC_DDR,
                     (BSL_META_U(unit, " **** VDL step size...: %3d.%03d ps\n"), (step1000 / 1000), (step1000 % 1000)));
            LOG_INFO(BSL_LS_SOC_DDR,
                     (BSL_META_U(unit, " **** UI size.........: %3d.%03d steps\n"), (size1000UI / 1000),
                      (size1000UI % 1000)));
            ...
            for (y = yCapMin; y < yCapMax; y++)
            {
                ...
                for (x = calibStart; x < sizeX; x++)
                {
                    if ((scPtr->result2D[xStart + x] >> (i << shiftAmount)) & dataMask)
                    {
                        ...
                        {
                            if ((calibPos == SHMOO_G6PHY16_CALIB_ANY_EDGE)
                                || (calibPos == SHMOO_G6PHY16_CALIB_RISING_EDGE)
                                || (calibPos == SHMOO_G6PHY16_CALIB_FAIL_START))
                            {
        ...
        else
        {
            ...
            for (x = calibStart; x < sizeX; x++)
            {
                if ((scPtr->result2D[x] >> (i << shiftAmount)) & dataMask)
                {
                    ...
                    {
                        if ((calibPos == SHMOO_G6PHY16_CALIB_ANY_EDGE) || (calibPos == SHMOO_G6PHY16_CALIB_RISING_EDGE)
                            || (calibPos == SHMOO_G6PHY16_CALIB_FAIL_START))
                        {
                            LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "X")));
                        }
...
int
soc_g6phy16_calculate_step_size(
    int unit,
    int drc_ndx,
    g6phy16_step_size_t * ssPtr)
{
    uint32 data;
    ...
    ro_vdl_step2 = 128;
    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                     (unit, SOC_PHY_GDDR6_REG_CONTROL_REGS_FREQ_CNTR_CONFIGr, &data, SOC_PHY_GDDR6_OBS_INTERVALf,
                      obs_interval));
    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                     (unit, SOC_PHY_GDDR6_REG_CONTROL_REGS_FREQ_CNTR_CONFIGr, &data, SOC_PHY_GDDR6_SEL_FC_REFCLKf, 0));
    ...
    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                     (unit, SOC_PHY_GDDR6_REG_CONTROL_REGS_RESET_CTRLr, &reset_ctrl_data,
                      SOC_PHY_GDDR6_FREQ_CNTR_FC_RESET_Nf, 0));
    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                     (unit, SOC_PHY_GDDR6_REG_CONTROL_REGS_RESET_CTRLr, &reset_ctrl_data,
                      SOC_PHY_GDDR6_FREQ_CNTR_RO_RESET_Nf, 0));
    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_CONTROL_REGS_RESET_CTRLr(unit, drc_ndx, reset_ctrl_data));
    sal_usleep(SHMOO_G6PHY16_SHORT_SLEEP);

    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                     (unit, SOC_PHY_GDDR6_REG_CONTROL_REGS_FREQ_CNTR_CONFIGr, &data, SOC_PHY_GDDR6_START_OBSf, 0));
    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                     (unit, SOC_PHY_GDDR6_REG_CONTROL_REGS_FREQ_CNTR_CONFIGr, &data, SOC_PHY_GDDR6_EN_NLDL_CLKOUT_BARf,
                      0));
    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_CONTROL_REGS_FREQ_CNTR_CONFIGr(unit, drc_ndx, data));
    sal_usleep(SHMOO_G6PHY16_SHORT_SLEEP);

    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                     (unit, SOC_PHY_GDDR6_REG_CONTROL_REGS_FREQ_CNTR_CONFIGr, &data, SOC_PHY_GDDR6_RO_VDL_STEPf,
                      ro_vdl_step1));
    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_CONTROL_REGS_FREQ_CNTR_CONFIGr(unit, drc_ndx, data));
    sal_usleep(SHMOO_G6PHY16_SHORT_SLEEP);
    ...
    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                     (unit, SOC_PHY_GDDR6_REG_CONTROL_REGS_RESET_CTRLr, &reset_ctrl_data,
                      SOC_PHY_GDDR6_FREQ_CNTR_FC_RESET_Nf, 1));
    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                     (unit, SOC_PHY_GDDR6_REG_CONTROL_REGS_RESET_CTRLr, &reset_ctrl_data,
                      SOC_PHY_GDDR6_FREQ_CNTR_RO_RESET_Nf, 1));
    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_CONTROL_REGS_RESET_CTRLr(unit, drc_ndx, reset_ctrl_data));
    sal_usleep(SHMOO_G6PHY16_SHORT_SLEEP);

    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                     (unit, SOC_PHY_GDDR6_REG_CONTROL_REGS_FREQ_CNTR_CONFIGr, &data, SOC_PHY_GDDR6_START_OBSf, 1));
    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_CONTROL_REGS_FREQ_CNTR_CONFIGr(unit, drc_ndx, data));
    sal_usleep(SHMOO_G6PHY16_SHORT_SLEEP);
    ...
    do
    {
        ...
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                         (unit, SOC_PHY_GDDR6_REG_CONTROL_REGS_STATUS_FREQ_CNTR_DCOUNTr, data, SOC_PHY_GDDR6_DCOUNTf,
                          &fld_dcount));
        if (!fld_dcount)
        {
            _SOC_IF_ERR_EXIT(READ_G6DDRC16_SOC_PHY_GDDR6_REG_CONTROL_REGS_STATUS_FREQ_CNTR_UCOUNTr
                             (unit, drc_ndx, &data));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_CONTROL_REGS_STATUS_FREQ_CNTR_UCOUNTr, data,
                              SOC_PHY_GDDR6_RO_OVERFLOWf, &fld_ro_overflow));
            if (fld_ro_overflow & 0x4)
            {
                _SOC_EXIT_WITH_ERR(SOC_E_FAIL,
                                   (BSL_META_U(unit, "VDL step size computation rollover during first pass\n")));
            }
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_CONTROL_REGS_STATUS_FREQ_CNTR_UCOUNTr, data,
                              SOC_PHY_GDDR6_RO_UCOUNTf, &ucount1));
            break;
        }
        if (soc_timeout_check(&to))
        {
            _SOC_EXIT_WITH_ERR(SOC_E_TIMEOUT,
                               (BSL_META_U(unit, "Timed out waiting for first pass of VDL step size computation\n")));
        }
    }
    while (TRUE);
    ...
    do
    {
        ...
        if (!fld_dcount)
        {
            ...
            {
                _SOC_EXIT_WITH_ERR(SOC_E_FAIL,
                                   (BSL_META_U(unit, "VDL step size computation rollover during second pass\n")));
            }
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_CONTROL_REGS_STATUS_FREQ_CNTR_UCOUNTr, data,
                              SOC_PHY_GDDR6_RO_UCOUNTf, &ucount2));
            break;
        }
        if (soc_timeout_check(&to))
        {
            _SOC_EXIT_WITH_ERR(SOC_E_TIMEOUT,
                               (BSL_META_U(unit, "Timed out waiting for second pass of VDL step size computation\n")));
        }
    }
    while (TRUE);
    ...
    {
        _SOC_EXIT_WITH_ERR(SOC_E_FAIL,
                           (BSL_META_U(unit, "VDL step size computation failed. Check power rails and clocks.\n")));
    }
    else
    {
        ssPtr->step1000 =
            ((((((1000000000 / (ro_vdl_step2 - ro_vdl_step1)) << 4) / shmoo_dram_info.data_rate_mbps) * obs_interval) /
              ucount2) * (ucount1 - ucount2)) / ucount1;
    ...
    g6phy16_shmoo_container_t * scPtr)
{
    ...
    switch (scPtr->shmooType)
    {
        case SHMOO_G6PHY16_ADDR_CTRL_SHORT:
        {
            ...
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                             (unit, SOC_PHY_GDDR6_REG_AQ_L_MAX_VDL_ADDRr, &data, SOC_PHY_GDDR6_UI_SHIFTf,
                              SHMOO_G6PHY16_GDDR6_INIT_ADDR_CTRL_UI_SHIFT));
            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_AQ_L_MAX_VDL_ADDRr(unit, drc_ndx, data));
            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_AQ_U_MAX_VDL_ADDRr(unit, drc_ndx, data));
            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_AQ_L_MAX_VDL_CTRLr(unit, drc_ndx, data));
            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_AQ_U_MAX_VDL_CTRLr(unit, drc_ndx, data));

            _SOC_IF_ERR_EXIT(READ_G6DDRC16_SOC_PHY_GDDR6_REG_CONTROL_REGS_SHARED_VREF_DAC_CONFIGr
                             (unit, drc_ndx, &data));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                             (unit, SOC_PHY_GDDR6_REG_CONTROL_REGS_SHARED_VREF_DAC_CONFIGr, &data, SOC_PHY_GDDR6_DATAf,
                              0x92));
            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_VREF_DAC_CONFIGr(unit, drc_ndx, data));
            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_VREF_DAC_CONFIGr(unit, drc_ndx, data));
            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_VREF_DAC_CONFIGr(unit, drc_ndx, data));
            ...
            _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_modify_mrs
                             (unit, drc_ndx, SHMOO_G6PHY16_MR_CMD_ALL_CHANNELS, 6, 0x2A | 0x780, 0xFFF));
            _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_modify_mrs
                             (unit, drc_ndx, SHMOO_G6PHY16_MR_CMD_ALL_CHANNELS, 6, 0x2A | 0xF80, 0xFFF));

            _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_modify_mrs
                             (unit, drc_ndx, SHMOO_G6PHY16_MR_CMD_ALL_CHANNELS, 8, 0x10, 0x010));
            sal_usleep(SHMOO_G6PHY16_SHORT_SLEEP);
        ...
        {
            _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_modify_mrs
                             (unit, drc_ndx, SHMOO_G6PHY16_MR_CMD_ALL_CHANNELS, 10, 0x000, 0x0F0));
            _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_modify_mrs
                             (unit, drc_ndx, SHMOO_G6PHY16_MR_CMD_ALL_CHANNELS, 1, 0x005, 0x00F));
            _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_modify_mrs
                             (unit, drc_ndx, SHMOO_G6PHY16_MR_CMD_ALL_CHANNELS, 9, 0x5 | 0x780, 0xFFF));
            _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_modify_mrs
                             (unit, drc_ndx, SHMOO_G6PHY16_MR_CMD_ALL_CHANNELS, 9, 0x5 | 0xF80, 0xFFF));
            sal_usleep(SHMOO_G6PHY16_SHORT_SLEEP);
            ...
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MAX_VDL_WCKr, &data, SOC_PHY_GDDR6_MAX_VDL_STEPf,
                              0));
            ...
            _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_modify_mrs
                             (unit, drc_ndx, SHMOO_G6PHY16_MR_CMD_ALL_CHANNELS, 10, 0x100, 0x100));
            sal_usleep(SHMOO_G6PHY16_SHORT_SLEEP);
            ...
            data = 0;
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_LEVELING_CONFIGr, &data,
                              SOC_PHY_GDDR6_WRITE_LEVELING_MODEf, 1));
        ...
        case SHMOO_G6PHY16_RD_START_FISH:
        {
            ...
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_ALIGNMENT_CTRLr, &data,
                              SOC_PHY_GDDR6_RDATA_WR2RD_DELAYf, 4));
            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_ALIGNMENT_CTRLr(unit, drc_ndx, data));
            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_READ_ALIGNMENT_CTRLr(unit, drc_ndx, data));
            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_READ_ALIGNMENT_CTRLr(unit, drc_ndx, data));
            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_READ_ALIGNMENT_CTRLr(unit, drc_ndx, data));
            ...
            data = 0;
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_FSM_CTRLr, &data, SOC_PHY_GDDR6_SYSTEM_ENABLEf, 0));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_FSM_CTRLr, &data,
                              SOC_PHY_GDDR6_DATA_VALID_GEN_ENABLEf, 0));
            ...
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_FSM_CTRLr, &data,
                              SOC_PHY_GDDR6_DATA_VALID_GEN_ENABLEf, 1));
            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_FSM_CTRLr(unit, drc_ndx, data));
            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_READ_FSM_CTRLr(unit, drc_ndx, data));
            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_READ_FSM_CTRLr(unit, drc_ndx, data));
            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_READ_FSM_CTRLr(unit, drc_ndx, data));
            ...
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_FSM_CTRLr, &data, SOC_PHY_GDDR6_SYSTEM_ENABLEf, 1));
            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_FSM_CTRLr(unit, drc_ndx, data));
            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_READ_FSM_CTRLr(unit, drc_ndx, data));
            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_READ_FSM_CTRLr(unit, drc_ndx, data));
            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_READ_FSM_CTRLr(unit, drc_ndx, data));
        ...
        case SHMOO_G6PHY16_RD_DESKEW:
        {
            ...
            _SOC_IF_ERR_EXIT(READ_G6DDRC16_SOC_PHY_GDDR6_REG_CONTROL_REGS_RESERVED_REGr(unit, drc_ndx, &data));
            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_CONTROL_REGS_RESERVED_REGr
                             (unit, drc_ndx, data & 0xFFFFFFFC));
            break;
        }
        case SHMOO_G6PHY16_DBI_EDC_RD_DESKEW:
        {
    ...
    g6phy16_shmoo_container_t * scPtr)
{
    ...
    switch (scPtr->shmooType)
    {
        ...
        case SHMOO_G6PHY16_WCK2CK:
        {
            ...
            _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_vendor_info_get(unit, drc_ndx, &shmoo_vendor_info));
            if ((shmoo_vendor_info.manufacture_id == SHMOO_G6PHY16_VENDOR_MICRON)
                && (shmoo_dram_info.data_rate_mbps > 7000))
            {

                sal_usleep(SHMOO_G6PHY16_DEEP_SLEEP);
                _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_modify_mrs
                                 (unit, drc_ndx, SHMOO_G6PHY16_MR_CMD_ALL_CHANNELS, 1, 0x80, 0x80));
                _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_modify_mrs
                                 (unit, drc_ndx, SHMOO_G6PHY16_MR_CMD_ALL_CHANNELS, 1, 0x00, 0x80));
            }

            sal_usleep(SHMOO_G6PHY16_DEEP_SLEEP);
            _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_modify_mrs
                             (unit, drc_ndx, SHMOO_G6PHY16_MR_CMD_ALL_CHANNELS, 10, 0x000, 0x100));

            data = 0;
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_LEVELING_CONFIGr, &data,
                              SOC_PHY_GDDR6_WRITE_LEVELING_MODEf, 0));
            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_LEVELING_CONFIGr(unit, drc_ndx, data));
            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_WRITE_LEVELING_CONFIGr(unit, drc_ndx, data));
            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_WRITE_LEVELING_CONFIGr(unit, drc_ndx, data));
            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_WRITE_LEVELING_CONFIGr(unit, drc_ndx, data));
...
_shmoo_g6phy16_save(
    int unit,
    int drc_ndx,
    g6phy16_shmoo_config_param_t * config_param)
{
    uint32 data;
    SOC_INIT_FUNC_DEFS;
    ...
    g6phy16_shmoo_config_param_t * config_param)
{
    ...
    SHR_BIT_ITER(dram_bitmap, SHMOO_G6PHY16_MAX_INTERFACES, dram_iter)
    {
        ...
        if ((action == SHMOO_G6PHY16_ACTION_RUN) || (action == SHMOO_G6PHY16_ACTION_RUN_AND_SAVE)
            || (action == SHMOO_G6PHY16_ACTION_RESTORE))
        {
    ...
    int drc_ndx)
{
    ...
    for (; ndx < ndxEnd; ndx++)
    {
        ...
        LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A01. Reset all PHY logic\n")));
        reset_ctrl_data = 0;
        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_CONTROL_REGS_RESET_CTRLr(unit, ndx, reset_ctrl_data));
        sal_usleep(SHMOO_G6PHY16_SHORT_SLEEP);

        LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A02. Enable Read FIFO\n")));
        read_fifo_ctrl_data = 0;
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_CONTROL_REGS_READ_FIFO_CTRLr, &read_fifo_ctrl_data,
                          SOC_PHY_GDDR6_W2R_MIN_DELAY_2f, 0));
        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_CONTROL_REGS_READ_FIFO_CTRLr(unit, ndx, read_fifo_ctrl_data));
        sal_usleep(SHMOO_G6PHY16_SHORT_SLEEP);

        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_CONTROL_REGS_RESET_CTRLr, &reset_ctrl_data,
                          SOC_PHY_GDDR6_READ_FIFO_RESET_Nf, 1));
        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_CONTROL_REGS_RESET_CTRLr(unit, ndx, reset_ctrl_data));
        sal_usleep(SHMOO_G6PHY16_SHORT_SLEEP);

        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_CONTROL_REGS_READ_FIFO_CTRLr, &read_fifo_ctrl_data,
                          SOC_PHY_GDDR6_ENABLEf, 1));
        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_CONTROL_REGS_READ_FIFO_CTRLr(unit, ndx, read_fifo_ctrl_data));
        sal_usleep(SHMOO_G6PHY16_SHORT_SLEEP);

        LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A03. Configure input shift control\n")));
        data = 0;
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_CONTROL_REGS_INPUT_SHIFT_CTRLr, &data,
                          SOC_PHY_GDDR6_DATAPATH_SHIFT_ENABLEf, 0));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_CONTROL_REGS_INPUT_SHIFT_CTRLr, &data,
                          SOC_PHY_GDDR6_DATAPATH_ADDITIONAL_LATENCYf, 0));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_CONTROL_REGS_INPUT_SHIFT_CTRLr, &data,
                          SOC_PHY_GDDR6_ADDRPATH_SHIFT_ENABLEf, 0));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_CONTROL_REGS_INPUT_SHIFT_CTRLr, &data,
                          SOC_PHY_GDDR6_ADDRPATH_ADDITIONAL_LATENCYf, 0));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_CONTROL_REGS_INPUT_SHIFT_CTRLr, &data,
                          SOC_PHY_GDDR6_RCMD_SHIFT_ENABLEf, 1));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_CONTROL_REGS_INPUT_SHIFT_CTRLr, &data,
                          SOC_PHY_GDDR6_RCMD_ADDITIONAL_LATENCYf, 10));
        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_CONTROL_REGS_INPUT_SHIFT_CTRLr(unit, ndx, data));
        sal_usleep(SHMOO_G6PHY16_SHORT_SLEEP);

        LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A04. Configure power regulation\n")));
        data = 0;
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_COMMON_LDO_CONFIGr, &data, SOC_PHY_GDDR6_PWRDNf, 1));
        ...
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_COMMON_LDO_CONFIGr, &data, SOC_PHY_GDDR6_BIAS_CTRLf, 0));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_COMMON_LDO_CONFIGr, &data, SOC_PHY_GDDR6_BYPASSf, 0));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_COMMON_LDO_CONFIGr, &data, SOC_PHY_GDDR6_CTRLf, 0x00));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_COMMON_LDO_CONFIGr, &data, SOC_PHY_GDDR6_REF_EXTf, 1));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_COMMON_LDO_CONFIGr, &data, SOC_PHY_GDDR6_REF_SEL_EXTf, 0));
        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_COMMON_LDO_CONFIGr(unit, ndx, data));
        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_AQ_LDO_CONFIGr(unit, ndx, data));
        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_LDO_R_CONFIGr(unit, ndx, data));
        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_LDO_W_CONFIGr(unit, ndx, data));
        ...
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_COMMON_LDO_CONFIGr, &data, SOC_PHY_GDDR6_PWRDNf, 0));
        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_COMMON_LDO_CONFIGr(unit, ndx, data));
        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_AQ_LDO_CONFIGr(unit, ndx, data));
        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_LDO_R_CONFIGr(unit, ndx, data));
        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_LDO_W_CONFIGr(unit, ndx, data));
        ...
        LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A05. Configure reference voltage\n")));
        data = 0;
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_CONTROL_REGS_SHARED_VREF_DAC_CONFIGr, &data, SOC_PHY_GDDR6_CTRLf,
                          0x0001));
        ...
        LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A06. Release VDL resets\n")));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_CONTROL_REGS_RESET_CTRLr, &reset_ctrl_data,
                          SOC_PHY_GDDR6_VDL_1G_RESET_Nf, 1));
        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_CONTROL_REGS_RESET_CTRLr(unit, ndx, reset_ctrl_data));
        sal_usleep(SHMOO_G6PHY16_SHORT_SLEEP);

        LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A07. Compute VDL step size\n")));
        ...
        LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A08. Configure UI shifts\n")));
        ...
        data = 0;
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_COMMON_MAX_VDL_CKr, &data, SOC_PHY_GDDR6_UI_SHIFTf, ck_ui));
        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_COMMON_MAX_VDL_CKr(unit, ndx, data));

        data = 0;
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_AQ_L_MAX_VDL_ADDRr, &data, SOC_PHY_GDDR6_UI_SHIFTf, addr_ctrl_ui));
        ...
        data = 0;
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MAX_VDL_WCKr, &data, SOC_PHY_GDDR6_UI_SHIFTf, dqs_ui));
        ...
        LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A09. Configure VDLs\n")));
        data = 0;
        ...
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MAX_VDL_WCKr, &data, SOC_PHY_GDDR6_MAX_VDL_STEPf,
                          SHMOO_G6PHY16_MAX_VDL_LENGTH - 1));
        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE0_WRITE_MAX_VDL_WCKr(unit, ndx, data));
        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE1_WRITE_MAX_VDL_WCKr(unit, ndx, data));
        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE2_WRITE_MAX_VDL_WCKr(unit, ndx, data));
        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_DQ_BYTE3_WRITE_MAX_VDL_WCKr(unit, ndx, data));
        ...
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_MAX_VDL_RCK_MASTER_CTRLr, &data,
                          SOC_PHY_GDDR6_MAX_VDL_STEPf, 0));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_MAX_VDL_RCK_MASTER_CTRLr, &data,
                          SOC_PHY_GDDR6_MASTER_MODEf, 1));
        ...
        LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A10. ZQ calibration\n")));
        if (shmoo_dram_info.sim_system_mode)
        {
        ...
        {
            LOG_INFO(BSL_LS_SOC_DDR,
                     (BSL_META_U(unit, "     Copying ZQ calibration results from PHY %02d\n"),
        ...
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_COMMON_RESCAL_OPERATION_CONFIGr, &data,
                          SOC_PHY_GDDR6_MANUAL_OVERRIDE_ENf, 1));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_COMMON_RESCAL_OPERATION_CONFIGr, &data, SOC_PHY_GDDR6_COMP_ENf, 1));
        ...
        for (i = 0; i < 32; i++)
        {
            ...
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                             (unit, SOC_PHY_GDDR6_REG_COMMON_RESCAL_OPERATION_CONFIGr, &data,
                              SOC_PHY_GDDR6_OVERRIDE_VALUEf, i));
            _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_COMMON_RESCAL_OPERATION_CONFIGr(unit, ndx, data));
            sal_usleep(SHMOO_G6PHY16_DEEP_SLEEP);

            _SOC_IF_ERR_EXIT(READ_G6DDRC16_SOC_PHY_GDDR6_REG_COMMON_STATUS_RESCALr(unit, ndx, &data));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_COMMON_STATUS_RESCALr, data, SOC_PHY_GDDR6_PCOMP_DINf, &status));
            if ((temp1 == 32) && status)
            {
                temp1 = i;
            }
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_COMMON_STATUS_RESCALr, data, SOC_PHY_GDDR6_NCOMP_DINf, &status));
            if ((temp2 == 32) && !status)
            {
                temp2 = i;
            }
        ...
        if ((temp1 == 32) || (temp2 == 32))
        {
            ...
            status = 1;
            LOG_ERROR(BSL_LS_SOC_DDR,
                      (BSL_META_U(unit, "     WARNING: ZQ calibration error - Default settings are used\n")));
        ...
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_COMMON_RESCAL_OPERATION_CONFIGr, &data,
                          SOC_PHY_GDDR6_MANUAL_OVERRIDE_ENf, 0));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_COMMON_RESCAL_OPERATION_CONFIGr, &data, SOC_PHY_GDDR6_COMP_ENf, 0));
        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_COMMON_RESCAL_OPERATION_CONFIGr(unit, ndx, data));
...
SHMOO_G6PHY16_ZQ_CALIBRATION_SLAVE_READ:
        ...
        if (shmoo_dram_info.zq_cal_array[ndx] != ndx)
        {
            _SOC_IF_ERR_EXIT(READ_G6DDRC16_SOC_PHY_GDDR6_REG_COMMON_IO_CONFIGr
                             (unit, (uint32) shmoo_dram_info.zq_cal_array[ndx], &data));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_COMMON_IO_CONFIGr, data, SOC_PHY_GDDR6_PDf, &temp1));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_COMMON_IO_CONFIGr, data, SOC_PHY_GDDR6_NDf, &temp2));
        ...
        {
            LOG_ERROR(BSL_LS_SOC_DDR,
                      (BSL_META_U(unit, "              Status Code......................: 0x%02X\n"), status));
            LOG_ERROR(BSL_LS_SOC_DDR,
                      (BSL_META_U(unit, "              DQ/DQS/CK Pdrive.................: 0x%02X\n"), 0xFF & dq_pd));
            LOG_ERROR(BSL_LS_SOC_DDR,
                      (BSL_META_U(unit, "              DQ/DQS/CK Ndrive.................: 0x%02X\n"), 0xFF & dq_nd));
            LOG_ERROR(BSL_LS_SOC_DDR,
                      (BSL_META_U(unit, "              DQ/DQS/CK Ptermination...........: 0x%02X\n"), 0xFF & dq_pterm));
            LOG_ERROR(BSL_LS_SOC_DDR,
                      (BSL_META_U(unit, "              DQ/DQS/CK Ntermination (RFU).....: 0x%02X\n"), 0xFF & dq_nterm));
            LOG_ERROR(BSL_LS_SOC_DDR,
                      (BSL_META_U(unit, "              AQ Pdrive........................: 0x%02X\n"), 0xFF & aq_pd));
            LOG_ERROR(BSL_LS_SOC_DDR,
                      (BSL_META_U(unit, "              AQ Ndrive........................: 0x%02X\n"), 0xFF & aq_nd));
            LOG_ERROR(BSL_LS_SOC_DDR,
                      (BSL_META_U(unit, "              AQ Ptermination..................: 0x%02X\n"), 0xFF & aq_pterm));
            LOG_ERROR(BSL_LS_SOC_DDR,
                      (BSL_META_U(unit, "              AQ Ntermination (RFU)............: 0x%02X\n"), 0xFF & aq_nterm));
        ...
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_COMMON_IO_CONFIGr, &data, SOC_PHY_GDDR6_PDf, dq_pd));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_COMMON_IO_CONFIGr, &data, SOC_PHY_GDDR6_PTERMf, dq_pterm));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_COMMON_IO_CONFIGr, &data, SOC_PHY_GDDR6_NDf, dq_nd));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_COMMON_IO_CONFIGr, &data, SOC_PHY_GDDR6_NTERMf, dq_nterm));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_COMMON_IO_CONFIGr, &data, SOC_PHY_GDDR6_PULL_UP_OFF_Bf, 0x0));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_COMMON_IO_CONFIGr, &data, SOC_PHY_GDDR6_RX_BIASf, 0x0));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_COMMON_IO_CONFIGr, &data, SOC_PHY_GDDR6_PEAKf, 0x0));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_COMMON_IO_CONFIGr, &data, SOC_PHY_GDDR6_DEMf, 0x0));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_COMMON_IO_CONFIGr, &data, SOC_PHY_GDDR6_RXENBf, 0x1));
        ...
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_AQ_IO_CONFIGr, &data, SOC_PHY_GDDR6_PDf, aq_pd));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_AQ_IO_CONFIGr, &data, SOC_PHY_GDDR6_PTERMf, aq_pterm));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_AQ_IO_CONFIGr, &data, SOC_PHY_GDDR6_NDf, aq_nd));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_AQ_IO_CONFIGr, &data, SOC_PHY_GDDR6_NTERMf, aq_nterm));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_AQ_IO_CONFIGr, &data, SOC_PHY_GDDR6_PULL_UP_OFF_Bf, 0x0));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_AQ_IO_CONFIGr, &data, SOC_PHY_GDDR6_RX_BIASf, 0x0));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_AQ_IO_CONFIGr, &data, SOC_PHY_GDDR6_PEAKf, 0x0));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_AQ_IO_CONFIGr, &data, SOC_PHY_GDDR6_DEMf, 0x0));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_AQ_IO_CONFIGr, &data, SOC_PHY_GDDR6_RXENBf, 0x1));
        ...
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_DATA_IO_CONFIGr, &data, SOC_PHY_GDDR6_PDf, dq_pd));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_DATA_IO_CONFIGr, &data, SOC_PHY_GDDR6_PTERMf, dq_pterm));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_DATA_IO_CONFIGr, &data, SOC_PHY_GDDR6_NDf, dq_nd));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_DATA_IO_CONFIGr, &data, SOC_PHY_GDDR6_NTERMf, dq_nterm));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_DATA_IO_CONFIGr, &data, SOC_PHY_GDDR6_PULL_UP_OFF_Bf, 0x0));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_DATA_IO_CONFIGr, &data, SOC_PHY_GDDR6_RX_BIASf, 0x0));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_DATA_IO_CONFIGr, &data, SOC_PHY_GDDR6_RXENBf, 0x0));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_DATA_IO_CONFIGr, &data, SOC_PHY_GDDR6_PEAKf, 0x2));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_DATA_IO_CONFIGr, &data, SOC_PHY_GDDR6_DEMf, 0x0));
        ...
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WCK_IO_CONFIGr, &data, SOC_PHY_GDDR6_PDf, dq_pd));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WCK_IO_CONFIGr, &data, SOC_PHY_GDDR6_PTERMf, dq_pterm));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WCK_IO_CONFIGr, &data, SOC_PHY_GDDR6_NDf, dq_nd));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WCK_IO_CONFIGr, &data, SOC_PHY_GDDR6_NTERMf, dq_nterm));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WCK_IO_CONFIGr, &data, SOC_PHY_GDDR6_PULL_UP_OFF_Bf, 0x0));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WCK_IO_CONFIGr, &data, SOC_PHY_GDDR6_RX_BIASf, 0x0));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WCK_IO_CONFIGr, &data, SOC_PHY_GDDR6_PEAKf, 0x0));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WCK_IO_CONFIGr, &data, SOC_PHY_GDDR6_DEMf, 0x0));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_WCK_IO_CONFIGr, &data, SOC_PHY_GDDR6_RXENBf, 0x1));
...
SHMOO_G6PHY16_ZQ_CALIBRATION_END:
        ...
        LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A11. Enable CK\n")));
        _SOC_IF_ERR_EXIT(READ_G6DDRC16_SOC_PHY_GDDR6_REG_COMMON_CK_CONFIGr(unit, ndx, &data));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_COMMON_CK_CONFIGr, &data, SOC_PHY_GDDR6_CK_ENABLEf, 1));
        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_COMMON_CK_CONFIGr(unit, ndx, data));
        sal_usleep(SHMOO_G6PHY16_SHORT_SLEEP);

        LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A12. Configure FIFOs\n")));
        data = 0;
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_ALIGNMENT_CTRLr, &data,
                          SOC_PHY_GDDR6_RDATA_WR2RD_DELAYf, 4));
        ...
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_FSM_CTRLr, &data, SOC_PHY_GDDR6_SYSTEM_ENABLEf, 0));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE0_READ_FSM_CTRLr, &data, SOC_PHY_GDDR6_DATA_VALID_GEN_ENABLEf,
                          0));
        ...
        LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A13. Release PHY resets\n")));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_CONTROL_REGS_RESET_CTRLr, &reset_ctrl_data,
                          SOC_PHY_GDDR6_DRC_1G_RESET_Nf, 1));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_CONTROL_REGS_RESET_CTRLr, &reset_ctrl_data,
                          SOC_PHY_GDDR6_PHY_1G_RESET_Nf, 1));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                         (unit, SOC_PHY_GDDR6_REG_CONTROL_REGS_RESET_CTRLr, &reset_ctrl_data,
                          SOC_PHY_GDDR6_CLOCK_DIV_RESET_Nf, 1));
        _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_CONTROL_REGS_RESET_CTRLr(unit, ndx, reset_ctrl_data));
        sal_usleep(SHMOO_G6PHY16_SHORT_SLEEP);

        LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A14. Enable FIFOs\n")));
        ...
        LOG_INFO(BSL_LS_SOC_DDR,
                 (BSL_META_U(unit, "A Series - PHY Initialization complete (DRC index: %02d)\n\n"), ndx));
    }
...
int
soc_g6phy16_shmoo_interface_cb_register(
    int unit,
    g6phy16_shmoo_cbi_t shmoo_cbi)
{
    ...
    _shmoo_g6phy16_drc_gddr6_dq_byte_pairs_swap_info_get =
        shmoo_cbi.g6phy16_gddr6_shmoo_drc_dq_byte_pairs_swap_info_get;
...
soc_g6phy16_cdr_ctl(
    ...
    int drc_ndx,
    int stat,
    g6phy16_cdr_config_param_t * config_param)
{
    ...
    soc_reg_t SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_EP_VDL_STATl[] =
    ...
    soc_reg_t SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_DP_VDL_STATl[] =
    ...
    soc_reg_t SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_EN_VDL_STATl[] =
    ...
    soc_reg_t SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_DN_VDL_STATl[] =
    ...
    if ((!stat) || ((*config_param).enable != SHMOO_G6PHY16_CDR_UNDEFINED_VALUE))
    {
        ...
        if ((*config_param).reset_n == 0)
        {
            ...
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_CONTROL_REGS_RESET_CTRLr, data, SOC_PHY_GDDR6_CDR_RESET_Nf,
                              &field));
            ...
            if (field)
            {
                ...
                {
                    LOG_INFO(BSL_LS_SOC_DDR,
                             (BSL_META_U(unit, "Enable request is ignored. CDR is going into reset.\n")));
                    LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "All bytes are disabled by force.\n")));
                }

                LOG_INFO(BSL_LS_SOC_DDR,
                         (BSL_META_U(unit, "All programming requests are ignored. CDR is going into reset.\n")));

                for (byte_iter = 0; byte_iter < SHMOO_G6PHY16_BYTES_PER_INTERFACE; byte_iter++)
                {
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_read
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_OPERATION_CONFIGl[byte_iter], dram_index,
                                      &data));
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_OPERATION_CONFIGl[byte_iter], data,
                                      SOC_PHY_GDDR6_ENABLEf, &field));
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_OPERATION_CONFIGl[byte_iter], &data,
                                      SOC_PHY_GDDR6_ENABLEf, 0));
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_write
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_OPERATION_CONFIGl[byte_iter], dram_index,
                                      data));
                    ...
                    {
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_read
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_P_VDLl[byte_iter], dram_index,
                                          &data));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_P_VDLl[byte_iter], data,
                                          SOC_PHY_GDDR6_EP_VDL_VALUEf, &ep));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_P_VDLl[byte_iter], data,
                                          SOC_PHY_GDDR6_DP_VDL_VALUEf, &dp));

                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_read
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_N_VDLl[byte_iter], dram_index,
                                          &data));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_N_VDLl[byte_iter], data,
                                          SOC_PHY_GDDR6_EN_VDL_VALUEf, &en));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_N_VDLl[byte_iter], data,
                                          SOC_PHY_GDDR6_DN_VDL_VALUEf, &dn));

                        data = 0;
                        if ((ep == dp) && (dp == en) && (en == dn))
                        {
                            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_READ_MAX_VDL_RCK_MASTER_CTRLl[byte_iter],
                                              &data, SOC_PHY_GDDR6_MASTER_MODEf, 1));
                            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_READ_MAX_VDL_RCK_MASTER_CTRLl[byte_iter],
                                              &data, SOC_PHY_GDDR6_MAX_VDL_STEPf, ep));
                        }
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_write
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_READ_MAX_VDL_RCK_MASTER_CTRLl[byte_iter],
                                          dram_index, data));
                        ...
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_write
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_READ_MAX_VDL_RCKEPl[byte_iter], dram_index,
                                          ep));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_write
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_READ_MAX_VDL_RCKDPl[byte_iter], dram_index,
                                          dp));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_write
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_READ_MAX_VDL_RCKENl[byte_iter], dram_index,
                                          en));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_write
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_READ_MAX_VDL_RCKDNl[byte_iter], dram_index,
                                          dn));

                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_read
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_TIMINGl[byte_iter], dram_index,
                                          &data));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_TIMINGl[byte_iter], data,
                                          SOC_PHY_GDDR6_DATA_VALID_WR2RD_DELAYf, &data_valid_wr2rd));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_TIMINGl[byte_iter], data,
                                          SOC_PHY_GDDR6_EDC_VALID_WR2RD_DELAYf, &edc_valid_wr2rd));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_TIMINGl[byte_iter], data,
                                          SOC_PHY_GDDR6_DATA_READ_UI_SHIFTf, &data_read_ui_shift));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_TIMINGl[byte_iter], data,
                                          SOC_PHY_GDDR6_EDC_READ_UI_SHIFTf, &edc_read_ui_shift));

                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_read
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_READ_ALIGNMENT_CTRLl[byte_iter], dram_index,
                                          &data));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_READ_ALIGNMENT_CTRLl[byte_iter], &data,
                                          SOC_PHY_GDDR6_DATA_VALID_WR2RD_DELAYf, data_valid_wr2rd));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_READ_ALIGNMENT_CTRLl[byte_iter], &data,
                                          SOC_PHY_GDDR6_EDC_VALID_WR2RD_DELAYf, edc_valid_wr2rd));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_READ_ALIGNMENT_CTRLl[byte_iter], &data,
                                          SOC_PHY_GDDR6_DATA_UI_SHIFTf, data_read_ui_shift));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_READ_ALIGNMENT_CTRLl[byte_iter], &data,
                                          SOC_PHY_GDDR6_EDC_UI_SHIFTf, edc_read_ui_shift));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_write
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_READ_ALIGNMENT_CTRLl[byte_iter], dram_index,
                                          data));
                    }
                ...
                LOG_INFO(BSL_LS_SOC_DDR,
                         (BSL_META_U
                          (unit,
                           "VDL settings, UI shifts, and FIFO distances are auto-copied back into the register file for all bytes. (Rollovers are TBI.)\n")));
                sal_usleep(SHMOO_G6PHY16_SHORT_SLEEP);

                for (byte_iter = 0; byte_iter < SHMOO_G6PHY16_BYTES_PER_INTERFACE; byte_iter++)
                {
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_read
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_TIMING_CONFIGl[byte_iter], dram_index,
                                      &data));
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_TIMING_CONFIGl[byte_iter], &data,
                                      SOC_PHY_GDDR6_VDL_SWITCHf, 0));
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_write
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_TIMING_CONFIGl[byte_iter], dram_index, data));
                }
                LOG_INFO(BSL_LS_SOC_DDR,
                         (BSL_META_U(unit, "VDL controls are coerced to the register file for all bytes.\n")));
                sal_usleep(SHMOO_G6PHY16_SHORT_SLEEP);
                ...
                _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_modify_mrs
                                 (unit, dram_index, SHMOO_G6PHY16_MR_CMD_ALL_CHANNELS, 4, 0x00F, 0x00F));
        ...
        else
        {
            ...
            vdl_value_max_cap = SHMOO_G6PHY16_MAX_VDL_LENGTH - 1;
            vdl_value_min_cap = 0;
            ...
            for (byte_iter = 0; byte_iter < SHMOO_G6PHY16_BYTES_PER_INTERFACE; byte_iter++)
            {
                if ((*config_param).auto_copy == 1)
                {
                    ...
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_READ_MAX_VDL_RCK_MASTER_CTRLl[byte_iter], data,
                                      SOC_PHY_GDDR6_MASTER_MODEf, &field));
                    if (field)
                    {
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_READ_MAX_VDL_RCK_MASTER_CTRLl[byte_iter],
                                          data, SOC_PHY_GDDR6_MAX_VDL_STEPf, &vdl_init_pos));
                    ...
                    else
                    {
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_read
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_READ_MAX_VDL_RCKEPl[byte_iter], dram_index,
                                          &vdl_init_ep[byte_iter]));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_read
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_READ_MAX_VDL_RCKDPl[byte_iter], dram_index,
                                          &vdl_init_dp[byte_iter]));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_read
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_READ_MAX_VDL_RCKENl[byte_iter], dram_index,
                                          &vdl_init_en[byte_iter]));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_read
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_READ_MAX_VDL_RCKDNl[byte_iter], dram_index,
                                          &vdl_init_dn[byte_iter]));
                    }
                }
                else
                {
                    vdl_init_pos = ((ss.size1000UI) << 1) / 1000;
                    vdl_init_ep[byte_iter] = vdl_init_pos;
                    vdl_init_dp[byte_iter] = vdl_init_pos;
                    vdl_init_en[byte_iter] = vdl_init_pos;
                    vdl_init_dn[byte_iter] = vdl_init_pos;
            ...
            if ((*config_param).reset_n == 1)
            {
                ...
                {
                    _SOC_IF_ERR_EXIT(_shmoo_g6phy16_drc_modify_mrs
                                     (unit, dram_index, SHMOO_G6PHY16_MR_CMD_ALL_CHANNELS, 4, 0x005, 0x00F));
                    ...
                    {
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_read
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_VDL_CAP_CONFIGl[byte_iter], dram_index,
                                          &data));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_VDL_CAP_CONFIGl[byte_iter], &data,
                                          SOC_PHY_GDDR6_FLEXIBLE_VDL_CAPf, 1));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_VDL_CAP_CONFIGl[byte_iter], &data,
                                          SOC_PHY_GDDR6_VDL_MAX_VALUE_CAPf, vdl_value_max_cap));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_VDL_CAP_CONFIGl[byte_iter], &data,
                                          SOC_PHY_GDDR6_VDL_MIN_VALUE_CAPf, vdl_value_min_cap));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_write
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_VDL_CAP_CONFIGl[byte_iter], dram_index,
                                          data));
                    }
                    ...
                    _SOC_IF_ERR_EXIT(READ_G6DDRC16_SOC_PHY_GDDR6_REG_CONTROL_REGS_RESET_CTRLr(unit, dram_index, &data));
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_CONTROL_REGS_RESET_CTRLr, &data,
                                      SOC_PHY_GDDR6_CDR_RESET_Nf, 1));
                    _SOC_IF_ERR_EXIT(WRITE_G6DDRC16_SOC_PHY_GDDR6_REG_CONTROL_REGS_RESET_CTRLr(unit, dram_index, data));
            ...
            SHR_BIT_ITER(&((*config_param).byte_map), SHMOO_G6PHY16_BYTES_PER_INTERFACE, byte_iter)
            {
                ...
                {
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_read
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_P_VDL_CONFIGl[byte_iter], dram_index, &data));
                    if ((*config_param).ep != SHMOO_G6PHY16_CDR_UNDEFINED_VALUE)
                    {
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_P_VDL_CONFIGl[byte_iter], &data,
                                          SOC_PHY_GDDR6_EP_VDL_LOAD_VALUEf,
                                          (*config_param).ep + vdl_init_ep[byte_iter]));
                    }
                    else
                    {
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_P_VDL_CONFIGl[byte_iter], &data,
                                          SOC_PHY_GDDR6_EP_VDL_LOAD_VALUEf, vdl_init_ep[byte_iter]));
                    }
                    if ((*config_param).dp != SHMOO_G6PHY16_CDR_UNDEFINED_VALUE)
                    {
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_P_VDL_CONFIGl[byte_iter], &data,
                                          ...
                                          (*config_param).dp + vdl_init_dp[byte_iter]));
                    }
                    else
                    {
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_P_VDL_CONFIGl[byte_iter], &data,
                                          SOC_PHY_GDDR6_DP_VDL_LOAD_VALUEf, vdl_init_dp[byte_iter]));
                    }
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_write
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_P_VDL_CONFIGl[byte_iter], dram_index, data));

                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_read
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_N_VDL_CONFIGl[byte_iter], dram_index, &data));
                    if ((*config_param).en != SHMOO_G6PHY16_CDR_UNDEFINED_VALUE)
                    {
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_N_VDL_CONFIGl[byte_iter], &data,
                                          SOC_PHY_GDDR6_EN_VDL_LOAD_VALUEf,
                                          (*config_param).en + vdl_init_en[byte_iter]));
                    }
                    else
                    {
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_N_VDL_CONFIGl[byte_iter], &data,
                                          SOC_PHY_GDDR6_EN_VDL_LOAD_VALUEf, vdl_init_en[byte_iter]));
                    }
                    if ((*config_param).dn != SHMOO_G6PHY16_CDR_UNDEFINED_VALUE)
                    {
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_N_VDL_CONFIGl[byte_iter], &data,
                                          ...
                                          (*config_param).dn + vdl_init_dn[byte_iter]));
                    }
                    else
                    {
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_N_VDL_CONFIGl[byte_iter], &data,
                                          SOC_PHY_GDDR6_DN_VDL_LOAD_VALUEf, vdl_init_dn[byte_iter]));
                    }
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_write
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_N_VDL_CONFIGl[byte_iter], dram_index, data));
                    ...
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_TIMING_CONFIGl[byte_iter], &data,
                                      SOC_PHY_GDDR6_DATA_VALID_WR2RD_DELAY_LOAD_VALUEf, data_valid_wr2rd));
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_TIMING_CONFIGl[byte_iter], &data,
                                      SOC_PHY_GDDR6_EDC_VALID_WR2RD_DELAY_LOAD_VALUEf, edc_valid_wr2rd));
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_TIMING_CONFIGl[byte_iter], &data,
                                      SOC_PHY_GDDR6_DATA_READ_UI_SHIFT_LOAD_VALUEf, data_read_ui_shift));
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_TIMING_CONFIGl[byte_iter], &data,
                                      SOC_PHY_GDDR6_EDC_READ_UI_SHIFT_LOAD_VALUEf, edc_read_ui_shift));
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_write
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_TIMING_CONFIGl[byte_iter], dram_index, data));
                    ...
                    LOG_INFO(BSL_LS_SOC_DDR,
                             (BSL_META_U
                              (unit,
                               "VDL settings, UI shifts, and FIFO distances are auto-copied back into the CDR for Byte %d.\n"),
                              byte_iter));
                }
                else
                {
                        ...
                        || ((*config_param).dn != SHMOO_G6PHY16_CDR_UNDEFINED_VALUE))
                    {
                        ...
                        LOG_INFO(BSL_LS_SOC_DDR,
                                 (BSL_META_U
                                  (unit, "Only manually-entered VDL settings are written into the CDR for Byte %d.\n"),
                                  byte_iter));
                    }
                }

                _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_read
                                 (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_UPDATE_CONFIGl[byte_iter], dram_index, &data));
                if ((*config_param).update_gap != SHMOO_G6PHY16_CDR_UNDEFINED_VALUE)
                {
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_UPDATE_CONFIGl[byte_iter], &data,
                                      SOC_PHY_GDDR6_VDL_UPDATE_GAPf, (*config_param).update_gap));
                }
                _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_write
                                 (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_UPDATE_CONFIGl[byte_iter], dram_index, data));

                _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_read
                                 (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_OPERATION_CONFIGl[byte_iter], dram_index, &data));
                if ((*config_param).init_track_transition != SHMOO_G6PHY16_CDR_UNDEFINED_VALUE)
                {
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_OPERATION_CONFIGl[byte_iter], &data,
                                      SOC_PHY_GDDR6_INIT_TRACK_TRANSITIONf, (*config_param).init_track_transition));
                }
                if ((*config_param).accu_pos_threshold != SHMOO_G6PHY16_CDR_UNDEFINED_VALUE)
                {
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_OPERATION_CONFIGl[byte_iter], &data,
                                      SOC_PHY_GDDR6_ACCU_POS_THRESHOLDf, (*config_param).accu_pos_threshold));
                }
                if ((*config_param).update_mode != SHMOO_G6PHY16_CDR_UNDEFINED_VALUE)
                {
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_OPERATION_CONFIGl[byte_iter], &data,
                                      SOC_PHY_GDDR6_UPDATE_MODEf, (*config_param).update_mode));
                }
                _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_write
                                 (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_OPERATION_CONFIGl[byte_iter], dram_index, data));
                ...
                if ((field) && ((*config_param).enable != 0))
                {
                    LOG_INFO(BSL_LS_SOC_DDR,
                             (BSL_META_U
                              (unit, "WARNING: CDR configuration is modified while CDR is enabled for Byte %d.\n"),
                              byte_iter));
                    LOG_INFO(BSL_LS_SOC_DDR,
                             (BSL_META_U
                              (unit,
                ...
                else
                {
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_OPERATION_CONFIGl[byte_iter], &data,
                                      SOC_PHY_GDDR6_INIT_TRACK_OPTIONSf, 0));
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_write
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_OPERATION_CONFIGl[byte_iter], dram_index,
                                      data));
                    LOG_INFO(BSL_LS_SOC_DDR,
                             (BSL_META_U(unit, "CDR configuration is complete for Byte %d.\n"), byte_iter));
                }
            }
            sal_usleep(SHMOO_G6PHY16_SHORT_SLEEP);
            ...
            if ((*config_param).enable == 1)
            {
                ...
                else
                {
                    SHR_BIT_ITER(&((*config_param).byte_map), SHMOO_G6PHY16_BYTES_PER_INTERFACE, byte_iter)
                    {
                        ...
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_TIMING_CONFIGl[byte_iter], &data,
                                          SOC_PHY_GDDR6_VDL_SWITCHf, 1));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_write
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_TIMING_CONFIGl[byte_iter], dram_index,
                                          data));
                        LOG_INFO(BSL_LS_SOC_DDR,
                                 (BSL_META_U(unit, "VDL controls are transferred to the CDR for Byte %d.\n"),
                                  byte_iter));
                        sal_usleep(SHMOO_G6PHY16_SHORT_SLEEP);

                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_TIMING_CONFIGl[byte_iter], &data,
                                          SOC_PHY_GDDR6_CLEAR_VDL_STATSf, 1));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_write
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_TIMING_CONFIGl[byte_iter], dram_index,
                                          data));
                        sal_usleep(SHMOO_G6PHY16_SHORT_SLEEP);
                        ...
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_TIMING_CONFIGl[byte_iter], &data,
                                          SOC_PHY_GDDR6_CLEAR_VDL_STATSf, 0));
                        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_write
                                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_TIMING_CONFIGl[byte_iter], dram_index,
                                          data));
                        LOG_INFO(BSL_LS_SOC_DDR,
                                 (BSL_META_U(unit, "VDL statistics are cleared for Byte %d.\n"), byte_iter));
                        sal_usleep(SHMOO_G6PHY16_SHORT_SLEEP);
                        ...
                        if (!field)
                        {
                            ...
                            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_set
                                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_OPERATION_CONFIGl[byte_iter], &data,
                                              SOC_PHY_GDDR6_ENABLEf, 1));
                            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_write
                                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_OPERATION_CONFIGl[byte_iter],
                                              dram_index, data));
                            ...
                            {
                                _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_read
                                                 (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_OPERATIONl[byte_iter],
                                                  dram_index, &data));
                                _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                                                 (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_OPERATIONl[byte_iter],
                                                  data, SOC_PHY_GDDR6_INIT_SEARCH_COMPLETEf, &field));
                                if (field)
                                {
                                    LOG_INFO(BSL_LS_SOC_DDR,
                                             (BSL_META_U(unit, "Byte %d is locked and ready.\n"), byte_iter));
                                    break;
                                }
                                ...
                                {
                                    LOG_INFO(BSL_LS_SOC_DDR,
                                             (BSL_META_U(unit, "WARNING: Byte %d could not lock.\n"), byte_iter));
                                    break;
                                }
                                sal_usleep(SHMOO_G6PHY16_SHORT_SLEEP);
                            }
                        ...
                        {
                            LOG_INFO(BSL_LS_SOC_DDR,
                                     (BSL_META_U(unit, "Enable request is ignored. Byte %d is already enabled.\n"),
                                      byte_iter));
                        }
                    }
                }
    ...
    else
    {
        ...
        SHR_BIT_ITER(&((*config_param).byte_map), SHMOO_G6PHY16_BYTES_PER_INTERFACE, byte_iter)
        {
            ...
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_UPDATE_CONFIGl[byte_iter], data,
                              SOC_PHY_GDDR6_VDL_UPDATE_GAPf, &field));
            LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "Update gap.........................: %3d\n"), field));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_UPDATE_CONFIGl[byte_iter], data,
                              SOC_PHY_GDDR6_ROLLOVER_AMOUNTf, &field));
            ...
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_P_VDL_CONFIGl[byte_iter], data,
                              SOC_PHY_GDDR6_EP_VDL_LOAD_VALUEf, &field));
            LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "Initial EP value...................: %3d\n"), field));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_P_VDL_CONFIGl[byte_iter], data,
                              SOC_PHY_GDDR6_DP_VDL_LOAD_VALUEf, &field));
            ...
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_N_VDL_CONFIGl[byte_iter], data,
                              SOC_PHY_GDDR6_EN_VDL_LOAD_VALUEf, &field));
            LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "Initial EN value...................: %3d\n"), field));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_N_VDL_CONFIGl[byte_iter], data,
                              SOC_PHY_GDDR6_DN_VDL_LOAD_VALUEf, &field));
            LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "Initial DN value...................: %3d\n"), field));

            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_read
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_P_VDLl[byte_iter], dram_index, &data));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_P_VDLl[byte_iter], data,
                              SOC_PHY_GDDR6_EP_VDL_VALUEf, &field));
            LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "Current EP value...................: %3d\n"), field));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_P_VDLl[byte_iter], data,
                              SOC_PHY_GDDR6_DP_VDL_VALUEf, &field));
            LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "Current DP value...................: %3d\n"), field));

            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_read
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_N_VDLl[byte_iter], dram_index, &data));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_N_VDLl[byte_iter], data,
                              SOC_PHY_GDDR6_EN_VDL_VALUEf, &field));
            LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "Current EN value...................: %3d\n"), field));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_N_VDLl[byte_iter], data,
                              SOC_PHY_GDDR6_DN_VDL_VALUEf, &field));
            LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "Current DN value...................: %3d\n"), field));

            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_read
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_EP_VDL_STATl[byte_iter], dram_index, &data));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_EP_VDL_STATl[byte_iter], data,
                              SOC_PHY_GDDR6_MAX_VDL_VALUEf, &vmax));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_EP_VDL_STATl[byte_iter], data,
                              SOC_PHY_GDDR6_MIN_VDL_VALUEf, &vmin));
            LOG_INFO(BSL_LS_SOC_DDR,
                     (BSL_META_U(unit, "Historical EP range (Min/Max)......: %3d / %3d\n"), vmin, vmax));

            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_read
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_DP_VDL_STATl[byte_iter], dram_index, &data));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_DP_VDL_STATl[byte_iter], data,
                              SOC_PHY_GDDR6_MAX_VDL_VALUEf, &vmax));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_DP_VDL_STATl[byte_iter], data,
                              SOC_PHY_GDDR6_MIN_VDL_VALUEf, &vmin));
            LOG_INFO(BSL_LS_SOC_DDR,
                     (BSL_META_U(unit, "Historical DP range (Min/Max)......: %3d / %3d\n"), vmin, vmax));

            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_read
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_EN_VDL_STATl[byte_iter], dram_index, &data));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_EN_VDL_STATl[byte_iter], data,
                              SOC_PHY_GDDR6_MAX_VDL_VALUEf, &vmax));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_EN_VDL_STATl[byte_iter], data,
                              SOC_PHY_GDDR6_MIN_VDL_VALUEf, &vmin));
            LOG_INFO(BSL_LS_SOC_DDR,
                     (BSL_META_U(unit, "Historical EN range (Min/Max)......: %3d / %3d\n"), vmin, vmax));

            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_read
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_DN_VDL_STATl[byte_iter], dram_index, &data));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_DN_VDL_STATl[byte_iter], data,
                              SOC_PHY_GDDR6_MAX_VDL_VALUEf, &vmax));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_DN_VDL_STATl[byte_iter], data,
                              SOC_PHY_GDDR6_MIN_VDL_VALUEf, &vmin));
            LOG_INFO(BSL_LS_SOC_DDR,
                     (BSL_META_U(unit, "Historical DN range (Min/Max)......: %3d / %3d\n"), vmin, vmax));

            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_read
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_VDL_CAP_CONFIGl[byte_iter], dram_index, &data));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_VDL_CAP_CONFIGl[byte_iter], data,
                              SOC_PHY_GDDR6_FLEXIBLE_VDL_CAPf, &field));
            LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "Flexible VDL cap...................: %3d\n"), field));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_VDL_CAP_CONFIGl[byte_iter], data,
                              SOC_PHY_GDDR6_VDL_MAX_VALUE_CAPf, &vmax));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_VDL_CAP_CONFIGl[byte_iter], data,
                              SOC_PHY_GDDR6_VDL_MIN_VALUE_CAPf, &vmin));
            LOG_INFO(BSL_LS_SOC_DDR,
                     (BSL_META_U(unit, "Rollover points (Min/Max)..........: %3d / %3d\n"), vmin, vmax));

            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_read
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_TIMING_CONFIGl[byte_iter], dram_index, &data));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_TIMING_CONFIGl[byte_iter], data,
                              SOC_PHY_GDDR6_VDL_SWITCHf, &field));
            LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "VDL switch.........................: %3d\n"), field));

            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_read
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_OPERATIONl[byte_iter], dram_index, &data));
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_OPERATIONl[byte_iter], data,
                              SOC_PHY_GDDR6_ACCU_VALUEf, &field));
            if (field & 0x40)
            {
                field |= 0xFFFFFF80;
            }
            ...
            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_OPERATIONl[byte_iter], data,
                              SOC_PHY_GDDR6_ROLLOVER_COUNTf, &field));
            if (field & 0x40)
            {
                field |= 0xFFFFFF80;
            }
            ...
            if (check_lock)
            {
                ...
                {
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_read
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_OPERATIONl[byte_iter], dram_index,
                                      &init_operation_status));
                    _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                                     (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_OPERATIONl[byte_iter],
                                      init_operation_status, SOC_PHY_GDDR6_INIT_SEARCH_COMPLETEf,
                                      &fld_init_track_status));
                    if (fld_init_track_status)
                    {
                        ...
                        do
                        {
                            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_read
                                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_OPERATIONl[byte_iter],
                                              dram_index, &current_operation_status));
                            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_read
                                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_P_VDLl[byte_iter], dram_index,
                                              &current_vdl_status));
                            if (soc_timeout_check(&to))
                            ...
                            _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                                             (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_STATUS_CDR_OPERATIONl[byte_iter],
                                              current_operation_status, SOC_PHY_GDDR6_TRACK_ACTIVEf, &fld_lock_status));
                        }
                        while ((current_vdl_status == init_vdl_status)
                               && (current_operation_status == init_operation_status) && !fld_lock_status);
                    ...
                    if (soc_timeout_check(&to))
                    {
                        LOG_INFO(BSL_LS_SOC_DDR,
                                 (BSL_META_U
                                  (unit, "Lock status........................: NOT LOCKED (Lock indication error)\n")));
                        break;
                    }
                }
                while (TRUE);
    ...
    int *cdr_is_enabled)
{
    ...
    uint32 data;
    uint32 field;
    soc_reg_t SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_OPERATION_CONFIGl[] =
        { SOC_PHY_GDDR6_REG_DQ_BYTE0_CDR_OPERATION_CONFIGr, SOC_PHY_GDDR6_REG_DQ_BYTE1_CDR_OPERATION_CONFIGr,
        SOC_PHY_GDDR6_REG_DQ_BYTE2_CDR_OPERATION_CONFIGr, SOC_PHY_GDDR6_REG_DQ_BYTE3_CDR_OPERATION_CONFIGr
    };
    ...
    *cdr_is_enabled = 1;
    ...
    for (byte_iter = 0; byte_iter < SHMOO_G6PHY16_BYTES_PER_INTERFACE; byte_iter++)
    {
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg32_read
                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_OPERATION_CONFIGl[byte_iter], dram_index, &data));
        _SOC_IF_ERR_EXIT(soc_phy_g6ddrc16_reg_field_get
                         (unit, SOC_PHY_GDDR6_REG_DQ_BYTE_CDR_OPERATION_CONFIGl[byte_iter], data, SOC_PHY_GDDR6_ENABLEf,
                          &field));
