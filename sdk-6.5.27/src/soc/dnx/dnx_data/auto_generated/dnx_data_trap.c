    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_trap_ingress_ipv4_fragmented_trap_support].name = "ipv4_fragmented_trap_support";
    submodule_data->features[dnx_data_trap_ingress_ipv4_fragmented_trap_support].doc = "";
    submodule_data->features[dnx_data_trap_ingress_ipv4_fragmented_trap_support].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_trap_ingress_arp_reply_trap_support].name = "arp_reply_trap_support";
    submodule_data->features[dnx_data_trap_ingress_arp_reply_trap_support].doc = "";
    submodule_data->features[dnx_data_trap_ingress_arp_reply_trap_support].flags |= DNXC_DATA_F_FEATURE;
    ...
    submodule_data->defines[dnx_data_trap_ingress_define_max_legal_predefined_trap_id].name = "max_legal_predefined_trap_id";
    submodule_data->defines[dnx_data_trap_ingress_define_max_legal_predefined_trap_id].doc = "";
    
    submodule_data->defines[dnx_data_trap_ingress_define_max_legal_predefined_trap_id].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_trap_ingress_max_legal_predefined_trap_id_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_trap, dnx_data_trap_submodule_ingress, dnx_data_trap_ingress_define_max_legal_predefined_trap_id);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_trap_etpp_mtu_context_enable_support].name = "mtu_context_enable_support";
    submodule_data->features[dnx_data_trap_etpp_mtu_context_enable_support].doc = "";
    submodule_data->features[dnx_data_trap_etpp_mtu_context_enable_support].flags |= DNXC_DATA_F_FEATURE;
    ...
    submodule_data->features[dnx_data_trap_etpp_stack_trap_etps_support].name = "stack_trap_etps_support";
    submodule_data->features[dnx_data_trap_etpp_stack_trap_etps_support].doc = "";
    submodule_data->features[dnx_data_trap_etpp_stack_trap_etps_support].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_trap_etpp_fabric_ptp_trap_support].name = "fabric_ptp_trap_support";
    submodule_data->features[dnx_data_trap_etpp_fabric_ptp_trap_support].doc = "";
    submodule_data->features[dnx_data_trap_etpp_fabric_ptp_trap_support].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_trap_etpp_deep_editing_trap_support].name = "deep_editing_trap_support";
    submodule_data->features[dnx_data_trap_etpp_deep_editing_trap_support].doc = "";
    submodule_data->features[dnx_data_trap_etpp_deep_editing_trap_support].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_trap_etpp_ffc_out_of_bound_trap_support].name = "ffc_out_of_bound_trap_support";
    submodule_data->features[dnx_data_trap_etpp_ffc_out_of_bound_trap_support].doc = "";
    submodule_data->features[dnx_data_trap_etpp_ffc_out_of_bound_trap_support].flags |= DNXC_DATA_F_FEATURE;
