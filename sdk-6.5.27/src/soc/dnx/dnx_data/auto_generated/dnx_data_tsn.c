    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_tsn_general_power_down].name = "power_down";
    submodule_data->features[dnx_data_tsn_general_power_down].doc = "";
    submodule_data->features[dnx_data_tsn_general_power_down].flags |= DNXC_DATA_F_FEATURE;
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_tsn_time_counters_atomic_read].name = "counters_atomic_read";
    submodule_data->features[dnx_data_tsn_time_counters_atomic_read].doc = "";
    submodule_data->features[dnx_data_tsn_time_counters_atomic_read].flags |= DNXC_DATA_F_FEATURE;
    ...
    submodule_data->defines[dnx_data_tsn_time_define_tsn_counter_max_diff].name = "tsn_counter_max_diff";
    submodule_data->defines[dnx_data_tsn_time_define_tsn_counter_max_diff].doc = "";
    
    submodule_data->defines[dnx_data_tsn_time_define_tsn_counter_max_diff].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_tsn_time_define_tas_tod_update_interrupt_id].name = "tas_tod_update_interrupt_id";
    submodule_data->defines[dnx_data_tsn_time_define_tas_tod_update_interrupt_id].doc = "";
    
    submodule_data->defines[dnx_data_tsn_time_define_tas_tod_update_interrupt_id].flags |= DNXC_DATA_F_NUMERIC;
...
uint32
dnx_data_tsn_time_tsn_counter_max_diff_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_tsn, dnx_data_tsn_submodule_time, dnx_data_tsn_time_define_tsn_counter_max_diff);
}

uint32
dnx_data_tsn_time_tas_tod_update_interrupt_id_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_tsn, dnx_data_tsn_submodule_time, dnx_data_tsn_time_define_tas_tod_update_interrupt_id);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_tsn_taf_define_taf_admission_profile].name = "taf_admission_profile";
    submodule_data->defines[dnx_data_tsn_taf_define_taf_admission_profile].doc = "";
    
    submodule_data->defines[dnx_data_tsn_taf_define_taf_admission_profile].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_tsn_taf_taf_admission_profile_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_tsn, dnx_data_tsn_submodule_taf, dnx_data_tsn_taf_define_taf_admission_profile);
}
