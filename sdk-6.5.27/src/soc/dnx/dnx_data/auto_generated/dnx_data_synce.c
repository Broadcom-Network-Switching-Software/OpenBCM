...
extern shr_error_e j2x_a0_data_synce_attach(
    int unit);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_synce_general_synce_no_sdm_mode].doc = "";
    ...
    submodule_data->features[dnx_data_synce_general_synce_nmg_chain_select].doc = "";
    submodule_data->features[dnx_data_synce_general_synce_nmg_chain_select].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_synce_general_synce_ouput_force_is_supported].name = "synce_ouput_force_is_supported";
    submodule_data->features[dnx_data_synce_general_synce_ouput_force_is_supported].doc = "";
    submodule_data->features[dnx_data_synce_general_synce_ouput_force_is_supported].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_synce_general_synce_in_nanosync].name = "synce_in_nanosync";
    submodule_data->features[dnx_data_synce_general_synce_in_nanosync].doc = "";
    submodule_data->features[dnx_data_synce_general_synce_in_nanosync].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_synce_general_synce_no_fdr_cfg].name = "synce_no_fdr_cfg";
    submodule_data->features[dnx_data_synce_general_synce_no_fdr_cfg].doc = "";
    submodule_data->features[dnx_data_synce_general_synce_no_fdr_cfg].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_synce_general_synce_no_nif_div_cfg].name = "synce_no_nif_div_cfg";
    submodule_data->features[dnx_data_synce_general_synce_no_nif_div_cfg].doc = "";
    submodule_data->features[dnx_data_synce_general_synce_no_nif_div_cfg].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_synce_general_synce_nif_clk_en_cfg].name = "synce_nif_clk_en_cfg";
    submodule_data->features[dnx_data_synce_general_synce_nif_clk_en_cfg].doc = "";
    submodule_data->features[dnx_data_synce_general_synce_nif_clk_en_cfg].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_synce_general_multi_set_is_supported].name = "multi_set_is_supported";
    submodule_data->features[dnx_data_synce_general_multi_set_is_supported].doc = "";
    submodule_data->features[dnx_data_synce_general_multi_set_is_supported].flags |= DNXC_DATA_F_FEATURE;
    ...
    submodule_data->defines[dnx_data_synce_general_define_nof_synce_type].name = "nof_synce_type";
    submodule_data->defines[dnx_data_synce_general_define_nof_synce_type].doc = "";
    
    submodule_data->defines[dnx_data_synce_general_define_nof_synce_type].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_synce_general_define_nif_div_min].name = "nif_div_min";
    submodule_data->defines[dnx_data_synce_general_define_nif_div_min].doc = "";
    ...
    submodule_data->defines[dnx_data_synce_general_define_nif_div_max].doc = "";
    ...
    submodule_data->defines[dnx_data_synce_general_define_fabric_div_min].doc = "";
    ...
    submodule_data->defines[dnx_data_synce_general_define_fabric_div_max].doc = "";
    ...
    submodule_data->defines[dnx_data_synce_general_define_nof_clk_blocks].doc = "";
    ...
    submodule_data->defines[dnx_data_synce_general_define_nof_fabric_clk_blocks].doc = "";
    
    submodule_data->defines[dnx_data_synce_general_define_nof_fabric_clk_blocks].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_synce_general_define_nof_mas].name = "nof_mas";
    submodule_data->defines[dnx_data_synce_general_define_nof_mas].doc = "";
    
    submodule_data->defines[dnx_data_synce_general_define_nof_mas].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_synce_general_define_output_clk_mode].name = "output_clk_mode";
    submodule_data->defines[dnx_data_synce_general_define_output_clk_mode].doc = "";
    ...
    submodule_data->tables[dnx_data_synce_general_table_cfg].doc = "";
    ...
    submodule_data->tables[dnx_data_synce_general_table_cfg].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_synce_general_table_cfg].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_synce_general_table_cfg].values[1].doc = "";
    ...
    submodule_data->tables[dnx_data_synce_general_table_cfg].values[2].doc = "";
    ...
    submodule_data->tables[dnx_data_synce_general_table_nmg_chain_map].doc = "";
    ...
    submodule_data->tables[dnx_data_synce_general_table_nmg_chain_map].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_synce_general_table_nmg_chain_map].values[0].doc = "";
...
uint32
dnx_data_synce_general_nof_synce_type_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_synce, dnx_data_synce_submodule_general, dnx_data_synce_general_define_nof_synce_type);
}
...
uint32
dnx_data_synce_general_nof_mas_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_synce, dnx_data_synce_submodule_general, dnx_data_synce_general_define_nof_mas);
}
    ...
    dnxc_data_module_t *module_data)
{
    ...
    {
        SHR_IF_ERR_EXIT(jr2_a0_data_synce_attach(unit));
        SHR_IF_ERR_EXIT(j2x_a0_data_synce_attach(unit));
    }
    else
