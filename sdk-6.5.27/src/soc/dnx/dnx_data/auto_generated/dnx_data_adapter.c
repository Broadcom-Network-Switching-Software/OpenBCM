    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_adapter_tx_define_loopback_enable].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_adapter_rx_define_constant_header_size].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_adapter_general_define_lib_ver].doc = "";
    ...
    submodule_data->defines[dnx_data_adapter_general_define_oamp_ms_id].doc = "";
    
    submodule_data->defines[dnx_data_adapter_general_define_oamp_ms_id].flags |= DNXC_DATA_F_NUMERIC;

    submodule_data->defines[dnx_data_adapter_general_define_sat_ms_id].name = "sat_ms_id";
    submodule_data->defines[dnx_data_adapter_general_define_sat_ms_id].doc = "";
    
    submodule_data->defines[dnx_data_adapter_general_define_sat_ms_id].flags |= DNXC_DATA_F_NUMERIC;

    submodule_data->defines[dnx_data_adapter_general_define_transaction_type_code].name = "transaction_type_code";
    submodule_data->defines[dnx_data_adapter_general_define_transaction_type_code].doc = "";
    ...
    submodule_data->defines[dnx_data_adapter_general_define_transaction_type_width].doc = "";
    ...
    submodule_data->defines[dnx_data_adapter_general_define_input_oam_packet_code].doc = "";
    ...
    submodule_data->defines[dnx_data_adapter_general_define_input_oam_packet_width].doc = "";
    ...
    submodule_data->defines[dnx_data_adapter_general_define_input_packet_size_code].doc = "";
    ...
    submodule_data->defines[dnx_data_adapter_general_define_input_packet_size_width].doc = "";
    ...
    submodule_data->defines[dnx_data_adapter_general_define_tx_packet_header_signal_id].doc = "";
    ...
    submodule_data->defines[dnx_data_adapter_general_define_tx_packet_tag_swap_res_signal_id].doc = "";
    ...
    submodule_data->defines[dnx_data_adapter_general_define_tx_packet_recycle_command_signal_id].doc = "";
    ...
    submodule_data->defines[dnx_data_adapter_general_define_tx_packet_recycle_context_signal_id].doc = "";
    ...
    submodule_data->defines[dnx_data_adapter_general_define_tx_packet_valid_bytes_signal_id].doc = "";
    ...
    submodule_data->defines[dnx_data_adapter_general_define_tx_packet_header_signal_width].doc = "";
    ...
    submodule_data->defines[dnx_data_adapter_general_define_tx_packet_tag_swap_res_signal_width].doc = "";
    ...
    submodule_data->defines[dnx_data_adapter_general_define_tx_packet_recycle_command_signal_width].doc = "";
    ...
    submodule_data->defines[dnx_data_adapter_general_define_tx_packet_recycle_context_signal_width].doc = "";
    ...
    submodule_data->defines[dnx_data_adapter_general_define_tx_packet_valid_bytes_signal_width].doc = "";
    ...
    submodule_data->tables[dnx_data_adapter_general_table_Injection].doc = "";
    ...
    submodule_data->tables[dnx_data_adapter_general_table_Injection].values[0].doc = "";
...
uint32
dnx_data_adapter_general_sat_ms_id_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_adapter, dnx_data_adapter_submodule_general, dnx_data_adapter_general_define_sat_ms_id);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_adapter_reg_mem_access_define_do_collect_enable].doc = "";
    ...
    submodule_data->defines[dnx_data_adapter_reg_mem_access_define_cmic_block_index].doc = "";
    ...
    submodule_data->defines[dnx_data_adapter_reg_mem_access_define_iproc_block_index].doc = "";
    ...
    submodule_data->defines[dnx_data_adapter_reg_mem_access_define_swap_core_index_zero_with_core_index].doc = "";
    ...
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_swap_core_ignore_map].doc = "";
    ...
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_swap_core_ignore_map].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_swap_core_ignore_map].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_swap_core_ignore_map_by_global_block_ids_enum].doc = "";
    ...
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_swap_core_ignore_map_by_global_block_ids_enum].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_swap_core_ignore_map_by_global_block_ids_enum].values[0].name = "indication";
    ...
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_swap_core_ignore_map_by_global_block_ids_enum].values[0].doc = "";
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_swap_core_ignore_map_by_global_block_ids_enum].values[0].offset = UTILEX_OFFSETOF(dnx_data_adapter_reg_mem_access_swap_core_ignore_map_by_global_block_ids_enum_t, indication);

    
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_special_swap_core_table].name = "special_swap_core_table";
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_special_swap_core_table].doc = "";
    ...
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_special_swap_core_table].keys[0].name = "index";
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_special_swap_core_table].keys[0].doc = "";

    
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_special_swap_core_table].nof_values = 4;
    ...
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_special_swap_core_table].values[0].name = "block_type";
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_special_swap_core_table].values[0].type = "int";
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_special_swap_core_table].values[0].doc = "";
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_special_swap_core_table].values[0].offset = UTILEX_OFFSETOF(dnx_data_adapter_reg_mem_access_special_swap_core_table_t, block_type);
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_special_swap_core_table].values[1].name = "regmem_id";
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_special_swap_core_table].values[1].type = "int";
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_special_swap_core_table].values[1].doc = "";
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_special_swap_core_table].values[1].offset = UTILEX_OFFSETOF(dnx_data_adapter_reg_mem_access_special_swap_core_table_t, regmem_id);
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_special_swap_core_table].values[2].name = "type";
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_special_swap_core_table].values[2].type = "int";
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_special_swap_core_table].values[2].doc = "";
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_special_swap_core_table].values[2].offset = UTILEX_OFFSETOF(dnx_data_adapter_reg_mem_access_special_swap_core_table_t, type);
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_special_swap_core_table].values[3].name = "arg";
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_special_swap_core_table].values[3].type = "int";
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_special_swap_core_table].values[3].doc = "";
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_special_swap_core_table].values[3].offset = UTILEX_OFFSETOF(dnx_data_adapter_reg_mem_access_special_swap_core_table_t, arg);

    
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_clear_on_read_mems].name = "clear_on_read_mems";
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_clear_on_read_mems].doc = "";
    ...
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_clear_on_read_mems].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_clear_on_read_mems].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_clear_on_read_regs].doc = "";
    ...
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_clear_on_read_regs].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_clear_on_read_regs].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_clear_on_read_regmems].name = "clear_on_read_regmems";
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_clear_on_read_regmems].doc = "";
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_clear_on_read_regmems].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_clear_on_read_regmems].size_of_values = sizeof(dnx_data_adapter_reg_mem_access_clear_on_read_regmems_t);
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_clear_on_read_regmems].entry_get = dnx_data_adapter_reg_mem_access_clear_on_read_regmems_entry_str_get;

    
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_clear_on_read_regmems].nof_keys = 1;
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_clear_on_read_regmems].keys[0].name = "index";
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_clear_on_read_regmems].keys[0].doc = "";

    
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_clear_on_read_regmems].nof_values = 1;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_adapter_reg_mem_access_table_clear_on_read_regmems].values, dnxc_data_value_t, submodule_data->tables[dnx_data_adapter_reg_mem_access_table_clear_on_read_regmems].nof_values, "_dnx_data_adapter_reg_mem_access_table_clear_on_read_regmems table values");
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_clear_on_read_regmems].values[0].name = "regmem";
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_clear_on_read_regmems].values[0].type = "int";
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_clear_on_read_regmems].values[0].doc = "";
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_clear_on_read_regmems].values[0].offset = UTILEX_OFFSETOF(dnx_data_adapter_reg_mem_access_clear_on_read_regmems_t, regmem);
...
const dnx_data_adapter_reg_mem_access_clear_on_read_regmems_t *
dnx_data_adapter_reg_mem_access_clear_on_read_regmems_get(
    int unit,
    int index)
{
    char *data;
    ...
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_adapter, dnx_data_adapter_submodule_reg_mem_access, dnx_data_adapter_reg_mem_access_table_clear_on_read_regmems);
    
    data = dnxc_data_mgmt_table_data_get(unit, table, index, 0);
    return (const dnx_data_adapter_reg_mem_access_clear_on_read_regmems_t *) data;
    ...
    int value_index)
{
    ...
    {
        case 0:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->indication);
            break;
    }
    ...
    int value_index)
{
    ...
    switch (value_index)
    {
        case 0:
            ...
            break;
        case 1:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->regmem_id);
            break;
        case 2:
...
shr_error_e
dnx_data_adapter_reg_mem_access_clear_on_read_regmems_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_adapter_reg_mem_access_clear_on_read_regmems_t *data;
    SHR_FUNC_INIT_VARS(unit);

    
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_adapter, dnx_data_adapter_submodule_reg_mem_access, dnx_data_adapter_reg_mem_access_table_clear_on_read_regmems);
    data = (const dnx_data_adapter_reg_mem_access_clear_on_read_regmems_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
...
const dnxc_data_table_info_t *
dnx_data_adapter_reg_mem_access_clear_on_read_regmems_info_get(
    int unit)
{

    
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_adapter, dnx_data_adapter_submodule_reg_mem_access, dnx_data_adapter_reg_mem_access_table_clear_on_read_regmems);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_adapter_mdb_table_debug_signals_dest_mapping].name = "debug_signals_dest_mapping";
    submodule_data->tables[dnx_data_adapter_mdb_table_debug_signals_dest_mapping].doc = "";
    submodule_data->tables[dnx_data_adapter_mdb_table_debug_signals_dest_mapping].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_adapter_mdb_table_debug_signals_dest_mapping].size_of_values = sizeof(dnx_data_adapter_mdb_debug_signals_dest_mapping_t);
    submodule_data->tables[dnx_data_adapter_mdb_table_debug_signals_dest_mapping].entry_get = dnx_data_adapter_mdb_debug_signals_dest_mapping_entry_str_get;

    
    submodule_data->tables[dnx_data_adapter_mdb_table_debug_signals_dest_mapping].nof_keys = 1;
    submodule_data->tables[dnx_data_adapter_mdb_table_debug_signals_dest_mapping].keys[0].name = "index";
    submodule_data->tables[dnx_data_adapter_mdb_table_debug_signals_dest_mapping].keys[0].doc = "";

    
    submodule_data->tables[dnx_data_adapter_mdb_table_debug_signals_dest_mapping].nof_values = 4;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_adapter_mdb_table_debug_signals_dest_mapping].values, dnxc_data_value_t, submodule_data->tables[dnx_data_adapter_mdb_table_debug_signals_dest_mapping].nof_values, "_dnx_data_adapter_mdb_table_debug_signals_dest_mapping table values");
    submodule_data->tables[dnx_data_adapter_mdb_table_debug_signals_dest_mapping].values[0].name = "key_signal_name";
    submodule_data->tables[dnx_data_adapter_mdb_table_debug_signals_dest_mapping].values[0].type = "char *";
    submodule_data->tables[dnx_data_adapter_mdb_table_debug_signals_dest_mapping].values[0].doc = "";
    submodule_data->tables[dnx_data_adapter_mdb_table_debug_signals_dest_mapping].values[0].offset = UTILEX_OFFSETOF(dnx_data_adapter_mdb_debug_signals_dest_mapping_t, key_signal_name);
    submodule_data->tables[dnx_data_adapter_mdb_table_debug_signals_dest_mapping].values[1].name = "signal_name";
    submodule_data->tables[dnx_data_adapter_mdb_table_debug_signals_dest_mapping].values[1].type = "char *";
    submodule_data->tables[dnx_data_adapter_mdb_table_debug_signals_dest_mapping].values[1].doc = "";
    submodule_data->tables[dnx_data_adapter_mdb_table_debug_signals_dest_mapping].values[1].offset = UTILEX_OFFSETOF(dnx_data_adapter_mdb_debug_signals_dest_mapping_t, signal_name);
    submodule_data->tables[dnx_data_adapter_mdb_table_debug_signals_dest_mapping].values[2].name = "from";
    submodule_data->tables[dnx_data_adapter_mdb_table_debug_signals_dest_mapping].values[2].type = "char *";
    submodule_data->tables[dnx_data_adapter_mdb_table_debug_signals_dest_mapping].values[2].doc = "";
    submodule_data->tables[dnx_data_adapter_mdb_table_debug_signals_dest_mapping].values[2].offset = UTILEX_OFFSETOF(dnx_data_adapter_mdb_debug_signals_dest_mapping_t, from);
    submodule_data->tables[dnx_data_adapter_mdb_table_debug_signals_dest_mapping].values[3].name = "to";
    submodule_data->tables[dnx_data_adapter_mdb_table_debug_signals_dest_mapping].values[3].type = "char *";
    submodule_data->tables[dnx_data_adapter_mdb_table_debug_signals_dest_mapping].values[3].doc = "";
    submodule_data->tables[dnx_data_adapter_mdb_table_debug_signals_dest_mapping].values[3].offset = UTILEX_OFFSETOF(dnx_data_adapter_mdb_debug_signals_dest_mapping_t, to);
...
const dnx_data_adapter_mdb_debug_signals_dest_mapping_t *
dnx_data_adapter_mdb_debug_signals_dest_mapping_get(
    int unit,
    int index)
{
    char *data;
    ...
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_adapter, dnx_data_adapter_submodule_mdb, dnx_data_adapter_mdb_table_debug_signals_dest_mapping);
    
    data = dnxc_data_mgmt_table_data_get(unit, table, index, 0);
    return (const dnx_data_adapter_mdb_debug_signals_dest_mapping_t *) data;
...
shr_error_e
dnx_data_adapter_mdb_debug_signals_dest_mapping_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_adapter_mdb_debug_signals_dest_mapping_t *data;
    SHR_FUNC_INIT_VARS(unit);

    
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_adapter, dnx_data_adapter_submodule_mdb, dnx_data_adapter_mdb_table_debug_signals_dest_mapping);
    data = (const dnx_data_adapter_mdb_debug_signals_dest_mapping_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%s", data->key_signal_name == NULL ? "" : data->key_signal_name);
            break;
        case 1:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%s", data->signal_name == NULL ? "" : data->signal_name);
            break;
        case 2:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%s", data->from == NULL ? "" : data->from);
            break;
        case 3:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%s", data->to == NULL ? "" : data->to);
            break;
    }
...
const dnxc_data_table_info_t *
dnx_data_adapter_mdb_debug_signals_dest_mapping_info_get(
    int unit)
{

    
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_adapter, dnx_data_adapter_submodule_mdb, dnx_data_adapter_mdb_table_debug_signals_dest_mapping);
