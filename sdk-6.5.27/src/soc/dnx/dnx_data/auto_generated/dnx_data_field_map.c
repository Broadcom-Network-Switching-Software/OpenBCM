    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_field_map_qual_table_cs_special_general_data_qual].name = "cs_special_general_data_qual";
    submodule_data->tables[dnx_data_field_map_qual_table_cs_special_general_data_qual].doc = "";
    submodule_data->tables[dnx_data_field_map_qual_table_cs_special_general_data_qual].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_field_map_qual_table_cs_special_general_data_qual].size_of_values = sizeof(dnx_data_field_map_qual_cs_special_general_data_qual_t);
    submodule_data->tables[dnx_data_field_map_qual_table_cs_special_general_data_qual].entry_get = dnx_data_field_map_qual_cs_special_general_data_qual_entry_str_get;

    
    submodule_data->tables[dnx_data_field_map_qual_table_cs_special_general_data_qual].nof_keys = 2;
    submodule_data->tables[dnx_data_field_map_qual_table_cs_special_general_data_qual].keys[0].name = "stage";
    submodule_data->tables[dnx_data_field_map_qual_table_cs_special_general_data_qual].keys[0].doc = "";
    submodule_data->tables[dnx_data_field_map_qual_table_cs_special_general_data_qual].keys[1].name = "qual";
    submodule_data->tables[dnx_data_field_map_qual_table_cs_special_general_data_qual].keys[1].doc = "";

    
    submodule_data->tables[dnx_data_field_map_qual_table_cs_special_general_data_qual].nof_values = 3;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_field_map_qual_table_cs_special_general_data_qual].values, dnxc_data_value_t, submodule_data->tables[dnx_data_field_map_qual_table_cs_special_general_data_qual].nof_values, "_dnx_data_field_map_qual_table_cs_special_general_data_qual table values");
    submodule_data->tables[dnx_data_field_map_qual_table_cs_special_general_data_qual].values[0].name = "offset";
    submodule_data->tables[dnx_data_field_map_qual_table_cs_special_general_data_qual].values[0].type = "uint16";
    submodule_data->tables[dnx_data_field_map_qual_table_cs_special_general_data_qual].values[0].doc = "";
    submodule_data->tables[dnx_data_field_map_qual_table_cs_special_general_data_qual].values[0].offset = UTILEX_OFFSETOF(dnx_data_field_map_qual_cs_special_general_data_qual_t, offset);
    submodule_data->tables[dnx_data_field_map_qual_table_cs_special_general_data_qual].values[1].name = "size";
    submodule_data->tables[dnx_data_field_map_qual_table_cs_special_general_data_qual].values[1].type = "uint8";
    submodule_data->tables[dnx_data_field_map_qual_table_cs_special_general_data_qual].values[1].doc = "";
    submodule_data->tables[dnx_data_field_map_qual_table_cs_special_general_data_qual].values[1].offset = UTILEX_OFFSETOF(dnx_data_field_map_qual_cs_special_general_data_qual_t, size);
    submodule_data->tables[dnx_data_field_map_qual_table_cs_special_general_data_qual].values[2].name = "vw_name";
    submodule_data->tables[dnx_data_field_map_qual_table_cs_special_general_data_qual].values[2].type = "char *";
    submodule_data->tables[dnx_data_field_map_qual_table_cs_special_general_data_qual].values[2].doc = "";
    submodule_data->tables[dnx_data_field_map_qual_table_cs_special_general_data_qual].values[2].offset = UTILEX_OFFSETOF(dnx_data_field_map_qual_cs_special_general_data_qual_t, vw_name);

    
    submodule_data->tables[dnx_data_field_map_qual_table_cs_pem_scratch_pad_mapping].name = "cs_pem_scratch_pad_mapping";
    submodule_data->tables[dnx_data_field_map_qual_table_cs_pem_scratch_pad_mapping].doc = "";
    submodule_data->tables[dnx_data_field_map_qual_table_cs_pem_scratch_pad_mapping].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_field_map_qual_table_cs_pem_scratch_pad_mapping].size_of_values = sizeof(dnx_data_field_map_qual_cs_pem_scratch_pad_mapping_t);
    submodule_data->tables[dnx_data_field_map_qual_table_cs_pem_scratch_pad_mapping].entry_get = dnx_data_field_map_qual_cs_pem_scratch_pad_mapping_entry_str_get;

    
    submodule_data->tables[dnx_data_field_map_qual_table_cs_pem_scratch_pad_mapping].nof_keys = 2;
    submodule_data->tables[dnx_data_field_map_qual_table_cs_pem_scratch_pad_mapping].keys[0].name = "stage";
    submodule_data->tables[dnx_data_field_map_qual_table_cs_pem_scratch_pad_mapping].keys[0].doc = "";
    submodule_data->tables[dnx_data_field_map_qual_table_cs_pem_scratch_pad_mapping].keys[1].name = "container";
    submodule_data->tables[dnx_data_field_map_qual_table_cs_pem_scratch_pad_mapping].keys[1].doc = "";

    
    submodule_data->tables[dnx_data_field_map_qual_table_cs_pem_scratch_pad_mapping].nof_values = 3;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_field_map_qual_table_cs_pem_scratch_pad_mapping].values, dnxc_data_value_t, submodule_data->tables[dnx_data_field_map_qual_table_cs_pem_scratch_pad_mapping].nof_values, "_dnx_data_field_map_qual_table_cs_pem_scratch_pad_mapping table values");
    submodule_data->tables[dnx_data_field_map_qual_table_cs_pem_scratch_pad_mapping].values[0].name = "nof_bits";
    submodule_data->tables[dnx_data_field_map_qual_table_cs_pem_scratch_pad_mapping].values[0].type = "uint8";
    submodule_data->tables[dnx_data_field_map_qual_table_cs_pem_scratch_pad_mapping].values[0].doc = "";
    submodule_data->tables[dnx_data_field_map_qual_table_cs_pem_scratch_pad_mapping].values[0].offset = UTILEX_OFFSETOF(dnx_data_field_map_qual_cs_pem_scratch_pad_mapping_t, nof_bits);
    submodule_data->tables[dnx_data_field_map_qual_table_cs_pem_scratch_pad_mapping].values[1].name = "lsb_on_general_data";
    submodule_data->tables[dnx_data_field_map_qual_table_cs_pem_scratch_pad_mapping].values[1].type = "uint16";
    submodule_data->tables[dnx_data_field_map_qual_table_cs_pem_scratch_pad_mapping].values[1].doc = "";
    submodule_data->tables[dnx_data_field_map_qual_table_cs_pem_scratch_pad_mapping].values[1].offset = UTILEX_OFFSETOF(dnx_data_field_map_qual_cs_pem_scratch_pad_mapping_t, lsb_on_general_data);
    submodule_data->tables[dnx_data_field_map_qual_table_cs_pem_scratch_pad_mapping].values[2].name = "lsb_on_pem_scratch_pad";
    submodule_data->tables[dnx_data_field_map_qual_table_cs_pem_scratch_pad_mapping].values[2].type = "uint8";
    submodule_data->tables[dnx_data_field_map_qual_table_cs_pem_scratch_pad_mapping].values[2].doc = "";
    submodule_data->tables[dnx_data_field_map_qual_table_cs_pem_scratch_pad_mapping].values[2].offset = UTILEX_OFFSETOF(dnx_data_field_map_qual_cs_pem_scratch_pad_mapping_t, lsb_on_pem_scratch_pad);
    ...
    submodule_data->tables[dnx_data_field_map_qual_table_header].name = "header";
    submodule_data->tables[dnx_data_field_map_qual_table_header].doc = "";
    submodule_data->tables[dnx_data_field_map_qual_table_header].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_field_map_qual_table_header].size_of_values = sizeof(dnx_data_field_map_qual_header_t);
    submodule_data->tables[dnx_data_field_map_qual_table_header].entry_get = dnx_data_field_map_qual_header_entry_str_get;

    
    submodule_data->tables[dnx_data_field_map_qual_table_header].nof_keys = 1;
    submodule_data->tables[dnx_data_field_map_qual_table_header].keys[0].name = "qual";
    submodule_data->tables[dnx_data_field_map_qual_table_header].keys[0].doc = "";

    
    submodule_data->tables[dnx_data_field_map_qual_table_header].nof_values = 3;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_field_map_qual_table_header].values, dnxc_data_value_t, submodule_data->tables[dnx_data_field_map_qual_table_header].nof_values, "_dnx_data_field_map_qual_table_header table values");
    submodule_data->tables[dnx_data_field_map_qual_table_header].values[0].name = "dbal_field";
    submodule_data->tables[dnx_data_field_map_qual_table_header].values[0].type = "int";
    submodule_data->tables[dnx_data_field_map_qual_table_header].values[0].doc = "";
    submodule_data->tables[dnx_data_field_map_qual_table_header].values[0].offset = UTILEX_OFFSETOF(dnx_data_field_map_qual_header_t, dbal_field);
    submodule_data->tables[dnx_data_field_map_qual_table_header].values[1].name = "offset";
    submodule_data->tables[dnx_data_field_map_qual_table_header].values[1].type = "int";
    submodule_data->tables[dnx_data_field_map_qual_table_header].values[1].doc = "";
    submodule_data->tables[dnx_data_field_map_qual_table_header].values[1].offset = UTILEX_OFFSETOF(dnx_data_field_map_qual_header_t, offset);
    submodule_data->tables[dnx_data_field_map_qual_table_header].values[2].name = "size";
    submodule_data->tables[dnx_data_field_map_qual_table_header].values[2].type = "int";
    submodule_data->tables[dnx_data_field_map_qual_table_header].values[2].doc = "";
    submodule_data->tables[dnx_data_field_map_qual_table_header].values[2].offset = UTILEX_OFFSETOF(dnx_data_field_map_qual_header_t, size);
...
const dnx_data_field_map_qual_cs_special_general_data_qual_t *
dnx_data_field_map_qual_cs_special_general_data_qual_get(
    int unit,
    int stage,
    int qual)
{
    ...
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_field_map, dnx_data_field_map_submodule_qual, dnx_data_field_map_qual_table_cs_special_general_data_qual);
    
    data = dnxc_data_mgmt_table_data_get(unit, table, stage, qual);
    return (const dnx_data_field_map_qual_cs_special_general_data_qual_t *) data;

}

const dnx_data_field_map_qual_cs_pem_scratch_pad_mapping_t *
dnx_data_field_map_qual_cs_pem_scratch_pad_mapping_get(
    int unit,
    int stage,
    int container)
{
    ...
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_field_map, dnx_data_field_map_submodule_qual, dnx_data_field_map_qual_table_cs_pem_scratch_pad_mapping);
    
    data = dnxc_data_mgmt_table_data_get(unit, table, stage, container);
    return (const dnx_data_field_map_qual_cs_pem_scratch_pad_mapping_t *) data;
...
const dnx_data_field_map_qual_header_t *
dnx_data_field_map_qual_header_get(
    int unit,
    int qual)
{
    char *data;
    ...
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_field_map, dnx_data_field_map_submodule_qual, dnx_data_field_map_qual_table_header);
    
    data = dnxc_data_mgmt_table_data_get(unit, table, qual, 0);
    return (const dnx_data_field_map_qual_header_t *) data;
...
shr_error_e
dnx_data_field_map_qual_cs_special_general_data_qual_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_field_map_qual_cs_special_general_data_qual_t *data;
    SHR_FUNC_INIT_VARS(unit);

    
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_field_map, dnx_data_field_map_submodule_qual, dnx_data_field_map_qual_table_cs_special_general_data_qual);
    data = (const dnx_data_field_map_qual_cs_special_general_data_qual_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, key1);
    switch (value_index)
    {
        case 0:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->offset);
...
shr_error_e
dnx_data_field_map_qual_cs_pem_scratch_pad_mapping_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_field_map_qual_cs_pem_scratch_pad_mapping_t *data;
    SHR_FUNC_INIT_VARS(unit);

    
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_field_map, dnx_data_field_map_submodule_qual, dnx_data_field_map_qual_table_cs_pem_scratch_pad_mapping);
    data = (const dnx_data_field_map_qual_cs_pem_scratch_pad_mapping_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, key1);
    switch (value_index)
    {
        case 0:
            ...
            break;
        case 1:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->lsb_on_general_data);
            break;
        case 2:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->lsb_on_pem_scratch_pad);
            break;
    }
...
shr_error_e
dnx_data_field_map_qual_header_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_field_map_qual_header_t *data;
    SHR_FUNC_INIT_VARS(unit);

    
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_field_map, dnx_data_field_map_submodule_qual, dnx_data_field_map_qual_table_header);
    data = (const dnx_data_field_map_qual_header_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->dbal_field);
...
const dnxc_data_table_info_t *
dnx_data_field_map_qual_cs_special_general_data_qual_info_get(
    int unit)
{

    
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_field_map, dnx_data_field_map_submodule_qual, dnx_data_field_map_qual_table_cs_special_general_data_qual);

}

const dnxc_data_table_info_t *
dnx_data_field_map_qual_cs_pem_scratch_pad_mapping_info_get(
    int unit)
{

    
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_field_map, dnx_data_field_map_submodule_qual, dnx_data_field_map_qual_table_cs_pem_scratch_pad_mapping);
...
const dnxc_data_table_info_t *
dnx_data_field_map_qual_header_info_get(
    int unit)
{

    
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_field_map, dnx_data_field_map_submodule_qual, dnx_data_field_map_qual_table_header);
...
static shr_error_e
dnx_data_field_map_port_profile_init(
    int unit,
    dnxc_data_submodule_t *submodule_data)
{
    SHR_FUNC_INIT_VARS(unit);

    submodule_data->name = "port_profile";
    submodule_data->doc = "";
    
    submodule_data->nof_features = _dnx_data_field_map_port_profile_feature_nof;
    DNXC_DATA_ALLOC(submodule_data->features, dnxc_data_feature_t,  submodule_data->nof_features, "_dnxc_data field_map port_profile features");

    
    submodule_data->nof_defines = _dnx_data_field_map_port_profile_define_nof;
    DNXC_DATA_ALLOC(submodule_data->defines, dnxc_data_define_t, submodule_data->nof_defines, "_dnxc_data field_map port_profile defines");

    
    submodule_data->nof_tables = _dnx_data_field_map_port_profile_table_nof;
    DNXC_DATA_ALLOC(submodule_data->tables, dnxc_data_table_t, submodule_data->nof_tables, "_dnxc_data field_map port_profile tables");

    
    submodule_data->tables[dnx_data_field_map_port_profile_table_port_class_profile].name = "port_class_profile";
    submodule_data->tables[dnx_data_field_map_port_profile_table_port_class_profile].doc = "";
    submodule_data->tables[dnx_data_field_map_port_profile_table_port_class_profile].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_field_map_port_profile_table_port_class_profile].size_of_values = sizeof(dnx_data_field_map_port_profile_port_class_profile_t);
    submodule_data->tables[dnx_data_field_map_port_profile_table_port_class_profile].entry_get = dnx_data_field_map_port_profile_port_class_profile_entry_str_get;

    
    submodule_data->tables[dnx_data_field_map_port_profile_table_port_class_profile].nof_keys = 1;
    submodule_data->tables[dnx_data_field_map_port_profile_table_port_class_profile].keys[0].name = "port_class";
    submodule_data->tables[dnx_data_field_map_port_profile_table_port_class_profile].keys[0].doc = "";

    
    submodule_data->tables[dnx_data_field_map_port_profile_table_port_class_profile].nof_values = 4;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_field_map_port_profile_table_port_class_profile].values, dnxc_data_value_t, submodule_data->tables[dnx_data_field_map_port_profile_table_port_class_profile].nof_values, "_dnx_data_field_map_port_profile_table_port_class_profile table values");
    submodule_data->tables[dnx_data_field_map_port_profile_table_port_class_profile].values[0].name = "profile_type";
    submodule_data->tables[dnx_data_field_map_port_profile_table_port_class_profile].values[0].type = "int";
    submodule_data->tables[dnx_data_field_map_port_profile_table_port_class_profile].values[0].doc = "";
    submodule_data->tables[dnx_data_field_map_port_profile_table_port_class_profile].values[0].offset = UTILEX_OFFSETOF(dnx_data_field_map_port_profile_port_class_profile_t, profile_type);
    submodule_data->tables[dnx_data_field_map_port_profile_table_port_class_profile].values[1].name = "dbal_table";
    submodule_data->tables[dnx_data_field_map_port_profile_table_port_class_profile].values[1].type = "int";
    submodule_data->tables[dnx_data_field_map_port_profile_table_port_class_profile].values[1].doc = "";
    submodule_data->tables[dnx_data_field_map_port_profile_table_port_class_profile].values[1].offset = UTILEX_OFFSETOF(dnx_data_field_map_port_profile_port_class_profile_t, dbal_table);
    submodule_data->tables[dnx_data_field_map_port_profile_table_port_class_profile].values[2].name = "dbal_key";
    submodule_data->tables[dnx_data_field_map_port_profile_table_port_class_profile].values[2].type = "int";
    submodule_data->tables[dnx_data_field_map_port_profile_table_port_class_profile].values[2].doc = "";
    submodule_data->tables[dnx_data_field_map_port_profile_table_port_class_profile].values[2].offset = UTILEX_OFFSETOF(dnx_data_field_map_port_profile_port_class_profile_t, dbal_key);
    submodule_data->tables[dnx_data_field_map_port_profile_table_port_class_profile].values[3].name = "dbal_result";
    submodule_data->tables[dnx_data_field_map_port_profile_table_port_class_profile].values[3].type = "int";
    submodule_data->tables[dnx_data_field_map_port_profile_table_port_class_profile].values[3].doc = "";
    submodule_data->tables[dnx_data_field_map_port_profile_table_port_class_profile].values[3].offset = UTILEX_OFFSETOF(dnx_data_field_map_port_profile_port_class_profile_t, dbal_result);
...
int
dnx_data_field_map_port_profile_feature_get(
    int unit,
    dnx_data_field_map_port_profile_feature_e feature)
{
    return dnxc_data_mgmt_feature_data_get(unit, dnx_data_module_field_map, dnx_data_field_map_submodule_port_profile, feature);
}




const dnx_data_field_map_port_profile_port_class_profile_t *
dnx_data_field_map_port_profile_port_class_profile_get(
    int unit,
    int port_class)
{
    char *data;
    ...
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_field_map, dnx_data_field_map_submodule_port_profile, dnx_data_field_map_port_profile_table_port_class_profile);
    
    data = dnxc_data_mgmt_table_data_get(unit, table, port_class, 0);
    return (const dnx_data_field_map_port_profile_port_class_profile_t *) data;

}


shr_error_e
dnx_data_field_map_port_profile_port_class_profile_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_field_map_port_profile_port_class_profile_t *data;
    SHR_FUNC_INIT_VARS(unit);

    
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_field_map, dnx_data_field_map_submodule_port_profile, dnx_data_field_map_port_profile_table_port_class_profile);
    data = (const dnx_data_field_map_port_profile_port_class_profile_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->profile_type);
            break;
        case 1:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->dbal_table);
            break;
        case 2:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->dbal_key);
            break;
        case 3:
...
const dnxc_data_table_info_t *
dnx_data_field_map_port_profile_port_class_profile_info_get(
    int unit)
{

    
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_field_map, dnx_data_field_map_submodule_port_profile, dnx_data_field_map_port_profile_table_port_class_profile);
    ...
    dnxc_data_module_t *module_data)
{
    ...
    SHR_IF_ERR_EXIT(dnx_data_field_map_port_profile_init(unit, &module_data->submodules[dnx_data_field_map_submodule_port_profile]));
