...
extern shr_error_e j2x_a0_data_snif_attach(
    int unit);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_snif_egress_high_scale_mapping_db_supported].name = "high_scale_mapping_db_supported";
    submodule_data->features[dnx_data_snif_egress_high_scale_mapping_db_supported].doc = "";
    submodule_data->features[dnx_data_snif_egress_high_scale_mapping_db_supported].flags |= DNXC_DATA_F_FEATURE;
    ...
    dnxc_data_module_t *module_data)
{
    ...
    {
        SHR_IF_ERR_EXIT(jr2_a0_data_snif_attach(unit));
        SHR_IF_ERR_EXIT(j2x_a0_data_snif_attach(unit));
    }
    else
