    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_sbusdma_desc_global_desc_dma].doc = "";
    ...
    submodule_data->features[dnx_data_sbusdma_desc_global_force_enable].doc = "";
    ...
    submodule_data->defines[dnx_data_sbusdma_desc_global_define_dma_desc_aggregator_chain_length_max].doc = "";
    ...
    submodule_data->defines[dnx_data_sbusdma_desc_global_define_dma_desc_aggregator_buff_size_kb].doc = "";
    ...
    submodule_data->defines[dnx_data_sbusdma_desc_global_define_dma_desc_aggregator_timeout_usec].doc = "";
    ...
    submodule_data->tables[dnx_data_sbusdma_desc_global_table_enable_module_desc_dma].doc = "";
    ...
    submodule_data->tables[dnx_data_sbusdma_desc_global_table_enable_module_desc_dma].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_sbusdma_desc_global_table_enable_module_desc_dma].values[0].doc = "";
