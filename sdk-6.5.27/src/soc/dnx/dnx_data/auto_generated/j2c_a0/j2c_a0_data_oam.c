...
static shr_error_e
j2c_a0_dnx_data_oam_general_oam_twamp_flow_id_ext_enable_set(
    int unit)
{
...
static shr_error_e
j2c_a0_dnx_data_oam_general_oam_y1711_enable_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_oam;
    ...
    int unit)
{
    ...
    feature->set = j2c_a0_dnx_data_oam_general_oam_twamp_flow_id_ext_enable_set;
    data_index = dnx_data_oam_general_oam_y1711_enable;
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_oam_general_oam_y1711_enable_set;
