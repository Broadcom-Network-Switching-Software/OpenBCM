...
static shr_error_e
j2c_a0_dnx_data_dev_init_time_init_total_time_set(
    int unit)
{
...
static shr_error_e
j2c_a0_dnx_data_dev_init_time_appl_init_total_time_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
j2c_a0_dnx_data_dev_init_time_down_deviation_total_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
j2c_a0_dnx_data_dev_init_time_up_deviation_total_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
j2c_a0_dnx_data_dev_init_time_test_sensitivity_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
j2c_a0_dnx_data_dev_init_time_step_time_set(
    int unit)
{
    int step_id_index;
...
static shr_error_e
j2c_a0_dnx_data_dev_init_time_appl_step_time_set(
    int unit)
{
    int step_id_index;
    ...
    int unit)
{
    ...
    define->set = j2c_a0_dnx_data_dev_init_time_init_total_time_set;
    data_index = dnx_data_dev_init_time_define_appl_init_total_time;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_dev_init_time_appl_init_total_time_set;
    data_index = dnx_data_dev_init_time_define_down_deviation_total;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_dev_init_time_down_deviation_total_set;
    data_index = dnx_data_dev_init_time_define_up_deviation_total;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_dev_init_time_up_deviation_total_set;
    data_index = dnx_data_dev_init_time_define_test_sensitivity;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_dev_init_time_test_sensitivity_set;
    ...
    table->set = j2c_a0_dnx_data_dev_init_time_step_time_set;
    data_index = dnx_data_dev_init_time_table_appl_step_time;
    table = &submodule->tables[data_index];
    table->set = j2c_a0_dnx_data_dev_init_time_appl_step_time_set;
