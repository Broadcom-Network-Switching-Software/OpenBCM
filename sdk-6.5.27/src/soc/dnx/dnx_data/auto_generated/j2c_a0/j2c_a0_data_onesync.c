...
static shr_error_e
j2c_a0_dnx_data_onesync_onesync_firmware_knetsync_cosq_port_set(
    int unit)
{
    ...
    int unit)
{
    ...
    define->set = j2c_a0_dnx_data_onesync_onesync_firmware_knetsync_cosq_port_set;
