...
static shr_error_e
j2c_a0_dnx_data_graphical_diag_num_of_rows_set(
    int unit)
{
...
static shr_error_e
j2c_a0_dnx_data_graphical_diag_num_of_index_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_graphical;
...
static shr_error_e
j2c_a0_dnx_data_graphical_diag_num_of_block_entries_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_graphical;
...
static shr_error_e
j2c_a0_dnx_data_graphical_diag_blocks_left_set(
    int unit)
{
    int row_index;
    int index_index;
...
static shr_error_e
j2c_a0_dnx_data_graphical_diag_blocks_right_set(
    int unit)
{
    int row_index;
    int index_index;
...
static shr_error_e
j2c_a0_dnx_data_graphical_diag_counters_set(
    int unit)
{
    int block_index;
    int index_index;
    ...
    table->values[1].default_val = "INVALID";
    table->values[2].default_val = "INVALIDr, INVALIDr, INVALIDr, INVALIDr, INVALIDr,INVALIDr, INVALIDr, INVALIDr, INVALIDr, INVALIDr, INVALIDr";
    table->values[3].default_val = "INVALIDf, INVALIDf, INVALIDf, INVALIDf, INVALIDf,INVALIDf, INVALIDf, INVALIDf, INVALIDf, INVALIDf, INVALIDf";
    table->values[4].default_val = "INVALIDf, INVALIDf, INVALIDf, INVALIDf, INVALIDf,INVALIDf, INVALIDf, INVALIDf, INVALIDf, INVALIDf, INVALIDf";
    table->values[5].default_val = "INVALID_CORE, INVALID_CORE, INVALID_CORE, INVALID_CORE, INVALID_CORE, INVALID_CORE, INVALID_CORE, INVALID_CORE, INVALID_CORE, INVALID_CORE, INVALID_CORE";
    table->values[6].default_val = "0";
    table->values[7].default_val = "1";
    table->values[8].default_val = "INVALID";
    ...
    SHR_RANGE_VERIFY(11, 0, DNX_DIAG_COUNTER_REG_NOF_REGS, _SHR_E_INTERNAL, "out of bound access to array")
    default_data->regs[0] = INVALIDr;
    default_data->regs[1] = INVALIDr;
    default_data->regs[2] = INVALIDr;
    default_data->regs[3] = INVALIDr;
    default_data->regs[4] = INVALIDr;
    default_data->regs[5] = INVALIDr;
    default_data->regs[6] = INVALIDr;
    default_data->regs[7] = INVALIDr;
    default_data->regs[8] = INVALIDr;
    default_data->regs[9] = INVALIDr;
    default_data->regs[10] = INVALIDr;
    SHR_RANGE_VERIFY(11, 0, DNX_DIAG_COUNTER_REG_NOF_REGS, _SHR_E_INTERNAL, "out of bound access to array")
    default_data->flds[0] = INVALIDf;
    default_data->flds[1] = INVALIDf;
    default_data->flds[2] = INVALIDf;
    default_data->flds[3] = INVALIDf;
    default_data->flds[4] = INVALIDf;
    default_data->flds[5] = INVALIDf;
    default_data->flds[6] = INVALIDf;
    default_data->flds[7] = INVALIDf;
    default_data->flds[8] = INVALIDf;
    default_data->flds[9] = INVALIDf;
    default_data->flds[10] = INVALIDf;
    SHR_RANGE_VERIFY(11, 0, DNX_DIAG_COUNTER_REG_NOF_REGS, _SHR_E_INTERNAL, "out of bound access to array")
    ...
    default_data->overflow_field[4] = INVALIDf;
    default_data->overflow_field[5] = INVALIDf;
    default_data->overflow_field[6] = INVALIDf;
    default_data->overflow_field[7] = INVALIDf;
    default_data->overflow_field[8] = INVALIDf;
    default_data->overflow_field[9] = INVALIDf;
    default_data->overflow_field[10] = INVALIDf;
    SHR_RANGE_VERIFY(11, 0, DNX_DIAG_COUNTER_REG_NOF_REGS, _SHR_E_INTERNAL, "out of bound access to array")
    default_data->core_fld_map[0] = INVALID_CORE;
    default_data->core_fld_map[1] = INVALID_CORE;
    default_data->core_fld_map[2] = INVALID_CORE;
    default_data->core_fld_map[3] = INVALID_CORE;
    default_data->core_fld_map[4] = INVALID_CORE;
    default_data->core_fld_map[5] = INVALID_CORE;
    default_data->core_fld_map[6] = INVALID_CORE;
    default_data->core_fld_map[7] = INVALID_CORE;
    default_data->core_fld_map[8] = INVALID_CORE;
    default_data->core_fld_map[9] = INVALID_CORE;
    default_data->core_fld_map[10] = INVALID_CORE;
    ...
    if (dnx_graphical_spb < table->keys[0].size && 4 < table->keys[1].size)
    {
        ...
        data->name = "DISCARDED_PACKETS";
        data->short_name = "DSC_PKTS";
        data->regs[0] = SPB_DISCARDED_PACKETS_CNTr;
        data->flds[0] = DISCARDED_PACKETS_N_CNTf;
        data->arr_i = 0;
        data->doc = "Number of Discarded packets for configured reassembly context";
    }
    ...
    if (dnx_graphical_spb < table->keys[0].size && 8 < table->keys[1].size)
    {
        data = (dnx_data_graphical_diag_counters_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_graphical_spb, 8);
    ...
    if (dnx_graphical_fdt < table->keys[0].size && 1 < table->keys[1].size)
    {
        ...
        data->name = "MIN_NOF_LINKS_DROP_CELLS";
        data->short_name = "MIN_NOF_LINKS_DROP_CELLS";
        data->regs[0] = FDT_MIN_NOF_LINKS_DROP_CNTr;
        data->flds[0] = MIN_NOF_LINKS_DROP_CNT_Nf;
        data->doc = "Counts minimum number of links drop counter";
        data->is_err = 1;
    }
    if (dnx_graphical_fdt < table->keys[0].size && 2 < table->keys[1].size)
    {
        data = (dnx_data_graphical_diag_counters_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_graphical_fdt, 2);
    ...
    if (dnx_graphical_fdr < table->keys[0].size && 4 < table->keys[1].size)
    {
        data = (dnx_data_graphical_diag_counters_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_graphical_fdr, 4);
        data->name = "IN_TOTAL_CELL_DROP";
        data->short_name = "IN_TTL_CELLS_DROP";
        SHR_RANGE_VERIFY(11, 0, DNX_DIAG_COUNTER_REG_NOF_REGS, _SHR_E_INTERNAL, "out of bound access to array")
        data->regs[0] = FDR_P_1_FDR_DISCARD_COUNTER_MACNr;
        data->regs[1] = FDR_P_2_FDR_DISCARD_COUNTER_MACNr;
        data->regs[2] = FDR_P_3_FDR_DISCARD_COUNTER_MACNr;
        data->regs[3] = FDR_P_1_FDR_FIFO_DISCARD_COUNTER_MACNr;
        data->regs[4] = FDR_P_2_FDR_FIFO_DISCARD_COUNTER_MACNr;
        data->regs[5] = FDR_P_3_FDR_FIFO_DISCARD_COUNTER_MACNr;
        data->regs[6] = FDR_AUTO_DOC_NAME_49r;
        data->regs[7] = FDR_FDR_REGISTER_6r;
        data->regs[8] = FDR_P_DROP_FILTER_CNTr;
        data->regs[9] = FDR_OFM_FIFO_OVFLW_DROP_CNT_Pr;
        data->regs[10] = FDR_OFM_FIFO_TRAFFIC_CLASS_DROP_CNT_Pr;
        SHR_RANGE_VERIFY(11, 0, DNX_DIAG_COUNTER_REG_NOF_REGS, _SHR_E_INTERNAL, "out of bound access to array")
        data->flds[0] = P_1_FDR_DISC_CNT_MACNf;
        data->flds[1] = P_2_FDR_DISC_CNT_MACNf;
        data->flds[2] = P_3_FDR_DISC_CNT_MACNf;
        data->flds[3] = P_1_FDR_FIFO_DISC_CNT_MACNf;
        data->flds[4] = P_2_FDR_FIFO_DISC_CNT_MACNf;
        data->flds[5] = P_3_FDR_FIFO_DISC_CNT_MACNf;
        data->flds[6] = FIELD_0_30f;
        data->flds[7] = FIELD_0_31f;
        data->flds[8] = P_N_DROP_FILTER_CNTf;
        data->flds[9] = OFM_FIFO_OVFLW_DROP_CNT_P_Nf;
        data->flds[10] = OFM_FIFO_TRAFFIC_CLASS_DROP_CNT_P_Nf;
        SHR_RANGE_VERIFY(7, 0, DNX_DIAG_COUNTER_REG_NOF_REGS, _SHR_E_INTERNAL, "out of bound access to array")
        data->overflow_field[0] = P_1_TSC_DISC_MAC_N_CNT_OVERFLOWf;
        data->overflow_field[1] = P_2_TSC_DISC_MAC_N_CNT_OVERFLOWf;
        data->overflow_field[2] = P_3_TSC_DISC_MAC_N_CNT_OVERFLOWf;
        data->overflow_field[3] = P_1_SRT_DISC_MAC_N_CNT_OVERFLOWf;
        data->overflow_field[4] = P_2_SRT_DISC_MAC_N_CNT_OVERFLOWf;
        data->overflow_field[5] = P_3_SRT_DISC_MAC_N_CNT_OVERFLOWf;
        data->overflow_field[6] = FIELD_31_31f;
        data->fld_num = 11;
        data->doc = "FDR total drop cell counter at the pipe";
    }
    ...
    if (dnx_graphical_rqp < table->keys[0].size && 8 < table->keys[1].size)
    {
        ...
        data->name = "CDC_TDM_PACKET_CNT";
        data->short_name = "CDC_TDM_PKTS";
        data->regs[0] = RQP_CELL_DECODER_DEBUG_COUNTERSr;
        data->flds[0] = CDC_TDM_PACKET_CNTf;
        data->doc = "Counts the number of TDM packets reach the cell decoder";
    }
    ...
    if (dnx_graphical_rqp < table->keys[0].size && 15 < table->keys[1].size)
    {
        data = (dnx_data_graphical_diag_counters_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_graphical_rqp, 15);
    ...
    if (dnx_graphical_rqp < table->keys[0].size && 16 < table->keys[1].size)
    {
        data = (dnx_data_graphical_diag_counters_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_graphical_rqp, 16);
    ...
    if (dnx_graphical_rqp < table->keys[0].size && 17 < table->keys[1].size)
    {
        data = (dnx_data_graphical_diag_counters_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_graphical_rqp, 17);
    ...
    if (dnx_graphical_nif_tx < table->keys[0].size && 2 < table->keys[1].size)
    {
        ...
        data->name = "TX_TOTAL_ERR_PACKETS";
        ...
        data->regs[0] = CDU_TX_TOTAL_PKT_WITH_ERR_COUNTERr;
        data->regs[1] = CLU_TX_TOTAL_PKT_WITH_ERR_COUNTERr;
        SHR_RANGE_VERIFY(2, 0, DNX_DIAG_COUNTER_REG_NOF_REGS, _SHR_E_INTERNAL, "out of bound access to array")
    ...
    int unit)
{
    ...
    define->set = j2c_a0_dnx_data_graphical_diag_num_of_rows_set;
    data_index = dnx_data_graphical_diag_define_num_of_index;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_graphical_diag_num_of_index_set;
    data_index = dnx_data_graphical_diag_define_num_of_block_entries;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_graphical_diag_num_of_block_entries_set;
    ...
    table->set = j2c_a0_dnx_data_graphical_diag_blocks_left_set;
    data_index = dnx_data_graphical_diag_table_blocks_right;
    table = &submodule->tables[data_index];
    table->set = j2c_a0_dnx_data_graphical_diag_blocks_right_set;
    data_index = dnx_data_graphical_diag_table_counters;
    table = &submodule->tables[data_index];
    table->set = j2c_a0_dnx_data_graphical_diag_counters_set;
