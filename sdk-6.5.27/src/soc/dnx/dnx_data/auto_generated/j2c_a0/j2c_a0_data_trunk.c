...
static shr_error_e
j2c_a0_dnx_data_trunk_egress_trunk_multiple_egress_trunk_sizes_set(
    int unit)
{
...
static shr_error_e
j2c_a0_dnx_data_trunk_egress_trunk_nof_set(
    int unit)
{
...
static shr_error_e
j2c_a0_dnx_data_trunk_egress_trunk_nof_lb_keys_per_profile_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_trunk;
...
static shr_error_e
j2c_a0_dnx_data_trunk_egress_trunk_dbal_egress_trunk_index_multiplier_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_trunk;
...
static shr_error_e
j2c_a0_dnx_data_trunk_egress_trunk_dbal_entry_index_divider_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_trunk;
...
static shr_error_e
j2c_a0_dnx_data_trunk_egress_trunk_dbal_entry_index_msb_multiplier_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_trunk;
...
static shr_error_e
j2c_a0_dnx_data_trunk_egress_trunk_size_mode_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_trunk;
...
static shr_error_e
j2c_a0_dnx_data_trunk_flow_agg_nof_flow_aggs_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_trunk;
    ...
    int unit)
{
    ...
    define->set = j2c_a0_dnx_data_trunk_egress_trunk_nof_set;
    data_index = dnx_data_trunk_egress_trunk_define_nof_lb_keys_per_profile;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_trunk_egress_trunk_nof_lb_keys_per_profile_set;
    data_index = dnx_data_trunk_egress_trunk_define_dbal_egress_trunk_index_multiplier;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_trunk_egress_trunk_dbal_egress_trunk_index_multiplier_set;
    data_index = dnx_data_trunk_egress_trunk_define_dbal_entry_index_divider;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_trunk_egress_trunk_dbal_entry_index_divider_set;
    data_index = dnx_data_trunk_egress_trunk_define_dbal_entry_index_msb_multiplier;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_trunk_egress_trunk_dbal_entry_index_msb_multiplier_set;
    data_index = dnx_data_trunk_egress_trunk_define_size_mode;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_trunk_egress_trunk_size_mode_set;

    
    data_index = dnx_data_trunk_egress_trunk_multiple_egress_trunk_sizes;
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_trunk_egress_trunk_multiple_egress_trunk_sizes_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_trunk_flow_agg_nof_flow_aggs_set;
