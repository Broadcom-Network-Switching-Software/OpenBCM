...
static shr_error_e
j2c_a0_dnx_data_egr_queuing_params_txq_tdm_irdy_sel_exist_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_egr_queuing;
...
static shr_error_e
j2c_a0_dnx_data_egr_queuing_params_credits_above_max_burst_for_negative_comp_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_egr_queuing;
    int submodule_index = dnx_data_egr_queuing_submodule_params;
    int feature_index = dnx_data_egr_queuing_params_credits_above_max_burst_for_negative_comp;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
j2c_a0_dnx_data_egr_queuing_params_txq_reduce_max_credits_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_egr_queuing;
...
static shr_error_e
j2c_a0_dnx_data_egr_queuing_params_reserved_if_fc_config_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_egr_queuing;
...
static shr_error_e
j2c_a0_dnx_data_egr_queuing_params_allow_aloc_ae_ifc_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_egr_queuing;
    ...
    int unit)
{
    ...
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_egr_queuing_params_txq_tdm_irdy_sel_exist_set;
    ...
    data_index = dnx_data_egr_queuing_params_credits_above_max_burst_for_negative_comp;
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_egr_queuing_params_credits_above_max_burst_for_negative_comp_set;
    data_index = dnx_data_egr_queuing_params_txq_reduce_max_credits;
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_egr_queuing_params_txq_reduce_max_credits_set;
    data_index = dnx_data_egr_queuing_params_reserved_if_fc_config;
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_egr_queuing_params_reserved_if_fc_config_set;
    data_index = dnx_data_egr_queuing_params_allow_aloc_ae_ifc_support;
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_egr_queuing_params_allow_aloc_ae_ifc_support_set;
