    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_linkscan_general_define_error_delay].doc = "";
    ...
    submodule_data->defines[dnx_data_linkscan_general_define_max_error].doc = "";
    ...
    submodule_data->defines[dnx_data_linkscan_general_define_thread_priority].doc = "";
    ...
    submodule_data->defines[dnx_data_linkscan_general_define_m0_pause_enable].doc = "";
