    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_spb_ocb_is_power_optimization_supported].name = "is_power_optimization_supported";
    submodule_data->features[dnx_data_spb_ocb_is_power_optimization_supported].doc = "";
    submodule_data->features[dnx_data_spb_ocb_is_power_optimization_supported].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_spb_ocb_configure_banks_full_threshold].name = "configure_banks_full_threshold";
    submodule_data->features[dnx_data_spb_ocb_configure_banks_full_threshold].doc = "";
    submodule_data->features[dnx_data_spb_ocb_configure_banks_full_threshold].flags |= DNXC_DATA_F_FEATURE;
    ...
    submodule_data->defines[dnx_data_spb_ocb_define_sram_in_power_down].name = "sram_in_power_down";
    submodule_data->defines[dnx_data_spb_ocb_define_sram_in_power_down].doc = "";
    
    submodule_data->defines[dnx_data_spb_ocb_define_sram_in_power_down].flags |= DNXC_DATA_F_NUMERIC;

    submodule_data->defines[dnx_data_spb_ocb_define_bank_full_threshold_bits].name = "bank_full_threshold_bits";
    submodule_data->defines[dnx_data_spb_ocb_define_bank_full_threshold_bits].doc = "";
    
    submodule_data->defines[dnx_data_spb_ocb_define_bank_full_threshold_bits].flags |= DNXC_DATA_F_NUMERIC;

    submodule_data->defines[dnx_data_spb_ocb_define_bank_full_threshold].name = "bank_full_threshold";
    submodule_data->defines[dnx_data_spb_ocb_define_bank_full_threshold].doc = "";
    
    submodule_data->defines[dnx_data_spb_ocb_define_bank_full_threshold].flags |= DNXC_DATA_F_NUMERIC;
    ...
    submodule_data->tables[dnx_data_spb_ocb_table_last_in_chain].values[0].doc = "";
...
uint32
dnx_data_spb_ocb_sram_in_power_down_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_spb, dnx_data_spb_submodule_ocb, dnx_data_spb_ocb_define_sram_in_power_down);
}

uint32
dnx_data_spb_ocb_bank_full_threshold_bits_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_spb, dnx_data_spb_submodule_ocb, dnx_data_spb_ocb_define_bank_full_threshold_bits);
}

uint32
dnx_data_spb_ocb_bank_full_threshold_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_spb, dnx_data_spb_submodule_ocb, dnx_data_spb_ocb_define_bank_full_threshold);
}
