    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_qos_qos_ecn_L4S].doc = "";
    ...
    submodule_data->features[dnx_data_qos_qos_qos_var_type_map_enable].doc = "";
    ...
    submodule_data->defines[dnx_data_qos_qos_define_nof_ingress_profiles].doc = "";
    ...
    submodule_data->defines[dnx_data_qos_qos_define_nof_ingress_opcode_profiles].doc = "";
    ...
    submodule_data->defines[dnx_data_qos_qos_define_nof_ingress_ecn_profiles].doc = "";
    ...
    submodule_data->defines[dnx_data_qos_qos_define_nof_ingress_policer_profiles].doc = "";
    ...
    submodule_data->defines[dnx_data_qos_qos_define_nof_ingress_vlan_pcp_profiles].doc = "";
    ...
    submodule_data->defines[dnx_data_qos_qos_define_nof_egress_profiles].doc = "";
    ...
    submodule_data->defines[dnx_data_qos_qos_define_nof_egress_policer_profiles].doc = "";
    ...
    submodule_data->defines[dnx_data_qos_qos_define_nof_egress_mpls_php_profiles].doc = "";
    ...
    submodule_data->defines[dnx_data_qos_qos_define_nof_egress_opcode_profiles].doc = "";
    ...
    submodule_data->defines[dnx_data_qos_qos_define_nof_egress_php_opcode_profiles].doc = "";
    ...
    submodule_data->defines[dnx_data_qos_qos_define_nof_egress_ttl_pipe_profiles].doc = "";
    ...
    submodule_data->defines[dnx_data_qos_qos_define_nof_ingress_propagation_profiles].doc = "";
    ...
    submodule_data->defines[dnx_data_qos_qos_define_nof_ingress_ecn_opcode_profiles].doc = "";
    ...
    submodule_data->defines[dnx_data_qos_qos_define_nof_egress_network_qos_pipe_profiles].doc = "";
    ...
    submodule_data->defines[dnx_data_qos_qos_define_nof_egress_cos_profiles].doc = "";
    ...
    submodule_data->defines[dnx_data_qos_qos_define_packet_max_priority].doc = "";
    ...
    submodule_data->defines[dnx_data_qos_qos_define_packet_max_exp].doc = "";
    ...
    submodule_data->defines[dnx_data_qos_qos_define_packet_max_dscp].doc = "";
    ...
    submodule_data->defines[dnx_data_qos_qos_define_packet_max_cfi].doc = "";
    ...
    submodule_data->defines[dnx_data_qos_qos_define_packet_max_tc].doc = "";
    ...
    submodule_data->defines[dnx_data_qos_qos_define_packet_max_dp].doc = "";
    ...
    submodule_data->defines[dnx_data_qos_qos_define_packet_max_ecn].doc = "";
    ...
    submodule_data->defines[dnx_data_qos_qos_define_packet_max_egress_policer_offset].doc = "";
    ...
    submodule_data->defines[dnx_data_qos_qos_define_max_int_map_id].doc = "";
    ...
    submodule_data->defines[dnx_data_qos_qos_define_max_egress_var].doc = "";
    ...
    submodule_data->defines[dnx_data_qos_qos_define_ecn_bits_width].doc = "";
    ...
    submodule_data->defines[dnx_data_qos_qos_define_eei_mpls_ttl_profile].doc = "";
    ...
    submodule_data->defines[dnx_data_qos_qos_define_routing_dscp_preserve_mode].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_qos_feature_egress_remark_or_keep_enabler].doc = "";
    ...
    submodule_data->features[dnx_data_qos_feature_fwd_eve_pcp_diff_encap].doc = "";
    ...
    submodule_data->features[dnx_data_qos_feature_phb_rm_ffc_extend].doc = "";
    ...
    submodule_data->features[dnx_data_qos_feature_hdr_qual_after_mpls_available].doc = "";
    ...
    submodule_data->features[dnx_data_qos_feature_seperate_tc_dp].doc = "";
    ...
    submodule_data->features[dnx_data_qos_feature_initial_qos_selection].doc = "";
    ...
    submodule_data->features[dnx_data_qos_feature_fwd_remark_keep_ecn].doc = "";
    ...
    submodule_data->features[dnx_data_qos_feature_ingress_explicit_qos_remark].doc = "";
    submodule_data->features[dnx_data_qos_feature_ingress_explicit_qos_remark].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_qos_feature_ttl_uniform_small].name = "ttl_uniform_small";
    submodule_data->features[dnx_data_qos_feature_ttl_uniform_small].doc = "";
    submodule_data->features[dnx_data_qos_feature_ttl_uniform_small].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_qos_feature_fwd_plus_1_bit_map_index].name = "fwd_plus_1_bit_map_index";
    submodule_data->features[dnx_data_qos_feature_fwd_plus_1_bit_map_index].doc = "";
    ...
    submodule_data->features[dnx_data_qos_feature_fwd_plus_1_remark_mpls].doc = "";
    submodule_data->features[dnx_data_qos_feature_fwd_plus_1_remark_mpls].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_qos_feature_ingress_mpls_swap_qos_ttl_model].name = "ingress_mpls_swap_qos_ttl_model";
    submodule_data->features[dnx_data_qos_feature_ingress_mpls_swap_qos_ttl_model].doc = "";
    submodule_data->features[dnx_data_qos_feature_ingress_mpls_swap_qos_ttl_model].flags |= DNXC_DATA_F_FEATURE;
    ...
    submodule_data->defines[dnx_data_qos_feature_define_phb_rm_ffc_bits_width].doc = "";
