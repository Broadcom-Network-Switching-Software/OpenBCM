    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_sat_generator_define_gtf_min_pkt_len].name = "gtf_min_pkt_len";
    submodule_data->defines[dnx_data_sat_generator_define_gtf_min_pkt_len].doc = "";
    
    submodule_data->defines[dnx_data_sat_generator_define_gtf_min_pkt_len].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_sat_generator_gtf_min_pkt_len_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_sat, dnx_data_sat_submodule_generator, dnx_data_sat_generator_define_gtf_min_pkt_len);
}
