    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_pvt_general_define_pvt_offset].name = "pvt_offset";
    submodule_data->defines[dnx_data_pvt_general_define_pvt_offset].doc = "";
    
    submodule_data->defines[dnx_data_pvt_general_define_pvt_offset].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_pvt_general_pvt_offset_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_pvt, dnx_data_pvt_submodule_general, dnx_data_pvt_general_define_pvt_offset);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_pvt_vtmon_table_vtmon_access].nof_values = 15;
    ...
    submodule_data->tables[dnx_data_pvt_vtmon_table_vtmon_access].values[12].name = "vdd_sel";
    ...
    submodule_data->tables[dnx_data_pvt_vtmon_table_vtmon_access].values[12].offset = UTILEX_OFFSETOF(dnx_data_pvt_vtmon_vtmon_access_t, vdd_sel);
    submodule_data->tables[dnx_data_pvt_vtmon_table_vtmon_access].values[13].name = "vss_sel";
    submodule_data->tables[dnx_data_pvt_vtmon_table_vtmon_access].values[13].type = "uint32";
    submodule_data->tables[dnx_data_pvt_vtmon_table_vtmon_access].values[13].doc = "";
    submodule_data->tables[dnx_data_pvt_vtmon_table_vtmon_access].values[13].offset = UTILEX_OFFSETOF(dnx_data_pvt_vtmon_vtmon_access_t, vss_sel);
    submodule_data->tables[dnx_data_pvt_vtmon_table_vtmon_access].values[14].name = "voltage_bit";
    submodule_data->tables[dnx_data_pvt_vtmon_table_vtmon_access].values[14].type = "int";
    submodule_data->tables[dnx_data_pvt_vtmon_table_vtmon_access].values[14].doc = "";
    submodule_data->tables[dnx_data_pvt_vtmon_table_vtmon_access].values[14].offset = UTILEX_OFFSETOF(dnx_data_pvt_vtmon_vtmon_access_t, voltage_bit);
