    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_stat_stat_pp_epp_combined_interfaces].doc = "";
    ...
    submodule_data->features[dnx_data_stat_stat_pp_full_stat_support].doc = "";
    ...
    submodule_data->features[dnx_data_stat_stat_pp_erpp_counter_profile_per_outlif].doc = "";
    submodule_data->features[dnx_data_stat_stat_pp_erpp_counter_profile_per_outlif].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_stat_stat_pp_reduced_fec_stat_cmd].name = "reduced_fec_stat_cmd";
    submodule_data->features[dnx_data_stat_stat_pp_reduced_fec_stat_cmd].doc = "";
    submodule_data->features[dnx_data_stat_stat_pp_reduced_fec_stat_cmd].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_stat_stat_pp_fec_protection_stat_id_is_minus_one].name = "fec_protection_stat_id_is_minus_one";
    submodule_data->features[dnx_data_stat_stat_pp_fec_protection_stat_id_is_minus_one].doc = "";
    submodule_data->features[dnx_data_stat_stat_pp_fec_protection_stat_id_is_minus_one].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_stat_stat_pp_protection_direct_stat_only].name = "protection_direct_stat_only";
    submodule_data->features[dnx_data_stat_stat_pp_protection_direct_stat_only].doc = "";
    submodule_data->features[dnx_data_stat_stat_pp_protection_direct_stat_only].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_stat_stat_pp_etpp_metadata_fwd_and_fwd_plus_share].name = "etpp_metadata_fwd_and_fwd_plus_share";
    submodule_data->features[dnx_data_stat_stat_pp_etpp_metadata_fwd_and_fwd_plus_share].doc = "";
    submodule_data->features[dnx_data_stat_stat_pp_etpp_metadata_fwd_and_fwd_plus_share].flags |= DNXC_DATA_F_FEATURE;
    ...
    submodule_data->defines[dnx_data_stat_stat_pp_define_max_irpp_profile_value].doc = "";
    ...
    submodule_data->defines[dnx_data_stat_stat_pp_define_max_etpp_profile_value].doc = "";
    ...
    submodule_data->defines[dnx_data_stat_stat_pp_define_max_etpp_counting_profile_value].doc = "";
    ...
    submodule_data->defines[dnx_data_stat_stat_pp_define_max_etpp_metering_profile_value].doc = "";
    ...
    submodule_data->defines[dnx_data_stat_stat_pp_define_max_erpp_profile_value].doc = "";
    ...
    submodule_data->defines[dnx_data_stat_stat_pp_define_etpp_reversed_stat_cmd].doc = "";
    ...
    submodule_data->defines[dnx_data_stat_stat_pp_define_etpp_enc_stat_cmd_is_reversed].doc = "";
    ...
    submodule_data->defines[dnx_data_stat_stat_pp_define_etpp_egress_vsi_always_pushed].doc = "";
    ...
    submodule_data->defines[dnx_data_stat_stat_pp_define_irpp_start_profile_value].doc = "";
    ...
    submodule_data->defines[dnx_data_stat_stat_pp_define_erpp_start_profile_value].doc = "";
    ...
    submodule_data->defines[dnx_data_stat_stat_pp_define_etpp_start_profile_value].doc = "";
    ...
    submodule_data->defines[dnx_data_stat_stat_pp_define_etpp_counting_start_profile_value].doc = "";
    ...
    submodule_data->defines[dnx_data_stat_stat_pp_define_etpp_metering_start_profile_value].doc = "";
    ...
    submodule_data->defines[dnx_data_stat_stat_pp_define_supported_egress_interface_counter_enum].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_stat_diag_counter_table_ovf_info].doc = "";
    ...
    submodule_data->tables[dnx_data_stat_diag_counter_table_ovf_info].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_stat_diag_counter_table_ovf_info].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_stat_diag_counter_table_ovf_info].values[1].doc = "";
    ...
    submodule_data->tables[dnx_data_stat_diag_counter_table_ovf_info].values[2].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_stat_drop_reasons_define_nof_drop_reasons].doc = "";
    ...
    submodule_data->tables[dnx_data_stat_drop_reasons_table_group_drop_reason_index].doc = "";
    ...
    submodule_data->tables[dnx_data_stat_drop_reasons_table_group_drop_reason_index].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_stat_drop_reasons_table_group_drop_reason_index].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_stat_drop_reasons_table_drop_reason_index].doc = "";
    ...
    submodule_data->tables[dnx_data_stat_drop_reasons_table_drop_reason_index].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_stat_drop_reasons_table_drop_reason_index].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_stat_drop_reasons_table_drop_reasons_groups].doc = "";
    ...
    submodule_data->tables[dnx_data_stat_drop_reasons_table_drop_reasons_groups].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_stat_drop_reasons_table_drop_reasons_groups].values[0].doc = "";
