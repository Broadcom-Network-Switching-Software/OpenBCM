...
static shr_error_e
j2p_a0_dnx_data_oam_general_oam_twamp_flow_id_ext_enable_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_oam;
...
static shr_error_e
j2p_a0_dnx_data_oam_general_oam_y1711_enable_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_oam;
...
static shr_error_e
j2p_a0_dnx_data_oam_general_oam_tod_config_in_ns_version_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_oam;
...
static shr_error_e
j2p_a0_dnx_data_oam_general_oam_tod_config_in_ns_nof_bits_in_load_enable_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_oam;
...
static shr_error_e
j2p_a0_dnx_data_oam_general_tod_init_in_oam_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_oam;
...
static shr_error_e
j2p_a0_dnx_data_oam_general_oam_ns_freq_control_upper_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_oam;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_oam_general_oam_tod_config_in_ns_version_set;
    data_index = dnx_data_oam_general_define_oam_tod_config_in_ns_nof_bits_in_load_enable;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_oam_general_oam_tod_config_in_ns_nof_bits_in_load_enable_set;
    data_index = dnx_data_oam_general_define_tod_init_in_oam;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_oam_general_tod_init_in_oam_set;
    data_index = dnx_data_oam_general_define_oam_ns_freq_control_upper;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_oam_general_oam_ns_freq_control_upper_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_oam_general_oam_twamp_flow_id_ext_enable_set;
    data_index = dnx_data_oam_general_oam_y1711_enable;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_oam_general_oam_y1711_enable_set;
