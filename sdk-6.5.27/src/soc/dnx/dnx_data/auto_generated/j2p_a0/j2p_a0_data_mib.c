...
static shr_error_e
j2p_a0_dnx_data_mib_controlled_counters_map_data_set(
    int unit)
{
    ...
    if (snmpBcmRxBipErrorCount < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmRxBipErrorCount, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF);
        data->counters_to_add_array[0] = dnx_mib_counter_nif_rx_bip_errors;
    }
    if (snmpBcmRxBerCountOnly < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmRxBerCountOnly, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF);
        data->counters_to_add_array[0] = dnx_mib_counter_nif_rx_ber_only;
    }
    if (snmpBcmRxBipErrorCountOnly < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmRxBipErrorCountOnly, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF);
        data->counters_to_add_array[0] = dnx_mib_counter_nif_rx_bip_errors_only;
    }
    ...
    if (snmpBcmRxRsFecSymbolError < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmRxRsFecSymbolError, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF);
        data->counters_to_add_array[0] = dnx_mib_counter_rx_rs_fec_symbol_error_rate;
    }
    if (snmpBcmRxRsFecBitError < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmRxRsFecBitError, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF);
        data->counters_to_add_array[0] = dnx_mib_counter_rx_rs_fec_bit_error;
    }
    if (snmpBcmRxRsFecBitError < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmRxRsFecBitError, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC);
        data->counters_to_add_array[0] = dnx_mib_counter_rx_rs_fec_bit_error;
    }
    ...
    if (snmpIfInDiscards < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpIfInDiscards, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF);
        data->counters_to_add_array[0] = dnx_mib_counter_nif_rx_stats_discards;
    }
    ...
    if (snmpEtherStatsDropEvents < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_ILKN < table->keys[1].size)
    {
        ...
        SHR_RANGE_VERIFY(2, 0, DNX_MIB_MAX_COUNTER_BUNDLE, _SHR_E_INTERNAL, "out of bound access to array")
        data->counters_to_add_array[0] = dnx_mib_counter_nif_rx_stats_drop_events_sch_data;
    ...
    if (snmpEtherStatsPkts < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        ...
        SHR_RANGE_VERIFY(2, 0, DNX_MIB_MAX_COUNTER_BUNDLE, _SHR_E_INTERNAL, "out of bound access to array")
        data->counters_to_add_array[0] = dnx_mib_counter_nif_eth_rpkt;
        data->counters_to_add_array[1] = dnx_mib_counter_nif_eth_rrpkt;
    }
    ...
    if (snmpBcmRxVlanTagFrame < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmRxVlanTagFrame, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_counter_nif_eth_rvln;
    }
    if (snmpBcmRxDoubleVlanTagFrame < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmRxDoubleVlanTagFrame, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_counter_nif_eth_rdvln;
    }
    if (snmpBcmTxVlanTagFrame < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmTxVlanTagFrame, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_counter_nif_eth_tvln;
    }
    if (snmpBcmTxDoubleVlanTagFrame < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmTxDoubleVlanTagFrame, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_counter_nif_eth_tdvln;
    }
    if (snmpBcmReceivedPreemptPkts64Octets < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmReceivedPreemptPkts64Octets, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_r64;
    }
    if (snmpBcmReceivedPreemptPkts65to127Octets < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmReceivedPreemptPkts65to127Octets, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_r127;
    }
    if (snmpBcmReceivedPreemptPkts128to255Octets < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmReceivedPreemptPkts128to255Octets, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_r255;
    }
    if (snmpBcmReceivedPreemptPkts256to511Octets < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmReceivedPreemptPkts256to511Octets, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_r511;
    }
    if (snmpBcmReceivedPreemptPkts512to1023Octets < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmReceivedPreemptPkts512to1023Octets, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_r1023;
    }
    if (snmpBcmReceivedPreemptPkts1024to1518Octets < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmReceivedPreemptPkts1024to1518Octets, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_r1518;
    }
    if (snmpBcmReceivedPreemptPkts1519to2047Octets < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmReceivedPreemptPkts1519to2047Octets, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_r2047;
    }
    if (snmpBcmReceivedPreemptPkts2048to4095Octets < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmReceivedPreemptPkts2048to4095Octets, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_r4095;
    }
    if (snmpBcmReceivedPreemptPkts4095to9216Octets < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmReceivedPreemptPkts4095to9216Octets, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_r9216;
    }
    if (snmpBcmReceivedPreemptPkts9217to16383Octets < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmReceivedPreemptPkts9217to16383Octets, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_r16383;
    }
    if (snmpBcmTransmittedPreemptPkts64Octets < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmTransmittedPreemptPkts64Octets, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_t64;
    }
    if (snmpBcmTransmittedPreemptPkts65to127Octets < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmTransmittedPreemptPkts65to127Octets, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_t127;
    }
    if (snmpBcmTransmittedPreemptPkts128to255Octets < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmTransmittedPreemptPkts128to255Octets, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_t255;
    }
    if (snmpBcmTransmittedPreemptPkts256to511Octets < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmTransmittedPreemptPkts256to511Octets, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_t511;
    }
    if (snmpBcmTransmittedPreemptPkts512to1023Octets < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmTransmittedPreemptPkts512to1023Octets, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_t1023;
    }
    if (snmpBcmTransmittedPreemptPkts1024to1518Octets < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmTransmittedPreemptPkts1024to1518Octets, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_t1518;
    }
    if (snmpBcmTransmittedPreemptPkts1519to2047Octets < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmTransmittedPreemptPkts1519to2047Octets, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_t2047;
    }
    if (snmpBcmTransmittedPreemptPkts2048to4095Octets < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmTransmittedPreemptPkts2048to4095Octets, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_t4095;
    }
    if (snmpBcmTransmittedPreemptPkts4095to9216Octets < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmTransmittedPreemptPkts4095to9216Octets, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_t9216;
    }
    if (snmpBcmTransmittedPreemptPkts9217to16383Octets < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmTransmittedPreemptPkts9217to16383Octets, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_t16383;
    }
    if (snmpBcmIfInUcastPreemptPkts < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmIfInUcastPreemptPkts, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_ruca;
    }
    if (snmpBcmIfInPreemptOctets < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmIfInPreemptOctets, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        SHR_RANGE_VERIFY(2, 0, DNX_MIB_MAX_COUNTER_BUNDLE, _SHR_E_INTERNAL, "out of bound access to array")
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_rbyt;
        data->counters_to_add_array[1] = dnx_mib_preempt_counter_nif_eth_rrbyt;
    }
    if (snmpBcmIfInPreemptErrors < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmIfInPreemptErrors, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        SHR_RANGE_VERIFY(3, 0, DNX_MIB_MAX_COUNTER_BUNDLE, _SHR_E_INTERNAL, "out of bound access to array")
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_rfcs;
        data->counters_to_add_array[1] = dnx_mib_preempt_counter_nif_eth_rjbr;
        data->counters_to_add_array[2] = dnx_mib_preempt_counter_nif_eth_rmtue;
    }
    if (snmpBcmIfInMulticastPreemptPkts < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmIfInMulticastPreemptPkts, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_rmca;
    }
    if (snmpBcmIfInBroadcastPreemptPkts < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmIfInBroadcastPreemptPkts, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_rbca;
    }
    if (snmpBcmIfOutPreemptOctets < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmIfOutPreemptOctets, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_tbyt;
    }
    if (snmpBcmIfOutUcastPreemptPkts < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmIfOutUcastPreemptPkts, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_tuca;
    }
    if (snmpBcmIfOutPreemptErrors < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmIfOutPreemptErrors, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_get_cb = dnx_mib_counters_map_get_cb;
    }
    if (snmpBcmIfOutBroadcastPreemptPkts < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmIfOutBroadcastPreemptPkts, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_tbca;
    }
    if (snmpBcmIfOutMulticastPreemptPkts < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmIfOutMulticastPreemptPkts, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_tmca;
    }
    if (snmpBcmEtherStatsPreemptOctets < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmEtherStatsPreemptOctets, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        SHR_RANGE_VERIFY(3, 0, DNX_MIB_MAX_COUNTER_BUNDLE, _SHR_E_INTERNAL, "out of bound access to array")
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_rbyt;
        data->counters_to_add_array[1] = dnx_mib_preempt_counter_nif_eth_tbyt;
        data->counters_to_add_array[2] = dnx_mib_preempt_counter_nif_eth_rrbyt;
    }
    if (snmpBcmEtherStatsPreemptPkts < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmEtherStatsPreemptPkts, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        SHR_RANGE_VERIFY(3, 0, DNX_MIB_MAX_COUNTER_BUNDLE, _SHR_E_INTERNAL, "out of bound access to array")
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_rpkt;
        data->counters_to_add_array[1] = dnx_mib_preempt_counter_nif_eth_rflr;
        data->counters_to_add_array[2] = dnx_mib_preempt_counter_nif_eth_tpkt;
    }
    if (snmpBcmEtherStatsBroadcastPreemptPkts < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmEtherStatsBroadcastPreemptPkts, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        SHR_RANGE_VERIFY(2, 0, DNX_MIB_MAX_COUNTER_BUNDLE, _SHR_E_INTERNAL, "out of bound access to array")
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_rbca;
        data->counters_to_add_array[1] = dnx_mib_preempt_counter_nif_eth_tbca;
    }
    if (snmpBcmEtherStatsMulticastPreemptPkts < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmEtherStatsMulticastPreemptPkts, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        SHR_RANGE_VERIFY(2, 0, DNX_MIB_MAX_COUNTER_BUNDLE, _SHR_E_INTERNAL, "out of bound access to array")
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_rmca;
        data->counters_to_add_array[1] = dnx_mib_preempt_counter_nif_eth_tmca;
    }
    if (snmpBcmEtherStatsCRCAlignPreemptErrors < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmEtherStatsCRCAlignPreemptErrors, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_rfcs;
    }
    if (snmpBcmEtherStatsOversizePreemptPkts < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmEtherStatsOversizePreemptPkts, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        SHR_RANGE_VERIFY(2, 0, DNX_MIB_MAX_COUNTER_BUNDLE, _SHR_E_INTERNAL, "out of bound access to array")
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_rovr;
        data->counters_to_add_array[1] = dnx_mib_preempt_counter_nif_eth_tovr;
    }
    if (snmpBcmEtherStatsPreemptFragments < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmEtherStatsPreemptFragments, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_rmfc;
    }
    if (snmpBcmEtherStatsPreemptJabbers < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmEtherStatsPreemptJabbers, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_preempt_counter_nif_eth_rjbr;
    }
    ...
    if (snmpBcmSignalQualityLastErrorRate < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmSignalQualityLastErrorRate, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_get_cb = dnx_mib_counters_map_get_dummy_cb;
    }
    if (snmpBcmSignalQualityLastErrorRate < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmSignalQualityLastErrorRate, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_FABRIC);
        data->counters_to_get_cb = dnx_mib_counters_map_get_dummy_cb;
    }
    if (snmpBcmTxEncryptedPFCFramePriority0 < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmTxEncryptedPFCFramePriority0, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_counter_nif_eth_epfc_tpfc0;
    }
    if (snmpBcmTxEncryptedPFCFramePriority1 < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmTxEncryptedPFCFramePriority1, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_counter_nif_eth_epfc_tpfc1;
    }
    if (snmpBcmTxEncryptedPFCFramePriority2 < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmTxEncryptedPFCFramePriority2, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_counter_nif_eth_epfc_tpfc2;
    }
    if (snmpBcmTxEncryptedPFCFramePriority3 < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmTxEncryptedPFCFramePriority3, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_counter_nif_eth_epfc_tpfc3;
    }
    if (snmpBcmTxEncryptedPFCFramePriority4 < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmTxEncryptedPFCFramePriority4, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_counter_nif_eth_epfc_tpfc4;
    }
    if (snmpBcmTxEncryptedPFCFramePriority5 < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmTxEncryptedPFCFramePriority5, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_counter_nif_eth_epfc_tpfc5;
    }
    if (snmpBcmTxEncryptedPFCFramePriority6 < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmTxEncryptedPFCFramePriority6, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_counter_nif_eth_epfc_tpfc6;
    }
    if (snmpBcmTxEncryptedPFCFramePriority7 < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmTxEncryptedPFCFramePriority7, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_counter_nif_eth_epfc_tpfc7;
    }
    ...
    int unit)
{
    ...
    if (dnx_mib_counter_nif_rx_stats_drop_events_sch_low < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_set_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_nif_rx_stats_drop_events_sch_low, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->get_cb = dnx_mib_nif_counter_get;
        data->clear_cb = dnx_mib_nif_counter_clear;
    }
    if (dnx_mib_counter_nif_rx_stats_drop_events_sch_high < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_set_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_nif_rx_stats_drop_events_sch_high, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->get_cb = dnx_mib_nif_counter_get;
        data->clear_cb = dnx_mib_nif_counter_clear;
    }
    if (dnx_mib_counter_nif_rx_stats_drop_events_sch_tdm < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_set_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_nif_rx_stats_drop_events_sch_tdm, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->get_cb = dnx_mib_nif_counter_get;
        data->clear_cb = dnx_mib_nif_counter_clear;
    }
    ...
    if (dnx_mib_counter_nif_rx_stats_discards < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_set_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_nif_rx_stats_discards, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF);
        data->get_cb = dnx_mib_nif_counter_get;
        data->clear_cb = dnx_mib_nif_counter_clear;
    }
    ...
    if (dnx_mib_counter_nif_eth_epfc_tpfc0 < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_set_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_nif_eth_epfc_tpfc0, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->get_cb = dnx_mib_nif_eth_epfc_counter_get;
        data->clear_cb = dnx_mib_nif_eth_epfc_counter_clear;
    }
    if (dnx_mib_counter_nif_eth_epfc_tpfc1 < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_set_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_nif_eth_epfc_tpfc1, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->get_cb = dnx_mib_nif_eth_epfc_counter_get;
        data->clear_cb = dnx_mib_nif_eth_epfc_counter_clear;
    }
    if (dnx_mib_counter_nif_eth_epfc_tpfc2 < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_set_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_nif_eth_epfc_tpfc2, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->get_cb = dnx_mib_nif_eth_epfc_counter_get;
        data->clear_cb = dnx_mib_nif_eth_epfc_counter_clear;
    }
    if (dnx_mib_counter_nif_eth_epfc_tpfc3 < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_set_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_nif_eth_epfc_tpfc3, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->get_cb = dnx_mib_nif_eth_epfc_counter_get;
        data->clear_cb = dnx_mib_nif_eth_epfc_counter_clear;
    }
    if (dnx_mib_counter_nif_eth_epfc_tpfc4 < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_set_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_nif_eth_epfc_tpfc4, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->get_cb = dnx_mib_nif_eth_epfc_counter_get;
        data->clear_cb = dnx_mib_nif_eth_epfc_counter_clear;
    }
    if (dnx_mib_counter_nif_eth_epfc_tpfc5 < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_set_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_nif_eth_epfc_tpfc5, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->get_cb = dnx_mib_nif_eth_epfc_counter_get;
        data->clear_cb = dnx_mib_nif_eth_epfc_counter_clear;
    }
    if (dnx_mib_counter_nif_eth_epfc_tpfc6 < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_set_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_nif_eth_epfc_tpfc6, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->get_cb = dnx_mib_nif_eth_epfc_counter_get;
        data->clear_cb = dnx_mib_nif_eth_epfc_counter_clear;
    }
    if (dnx_mib_counter_nif_eth_epfc_tpfc7 < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_set_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_nif_eth_epfc_tpfc7, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->get_cb = dnx_mib_nif_eth_epfc_counter_get;
        data->clear_cb = dnx_mib_nif_eth_epfc_counter_clear;
    }
...
static shr_error_e
j2p_a0_dnx_data_mib_controlled_counters_counter_data_set(
    int unit)
{
    int counter_id_index;
    ...
    table->values[4].default_val = "N/A";
    ...
    if (dnx_mib_counter_rx_rs_fec_symbol_error_rate < table->keys[0].size)
    {
        ...
        data->length = 48;
        data->doc = "RX RS-FEC symbol error";
    }
    ...
    if (dnx_mib_counter_nif_rx_ber_only < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_nif_rx_ber_only, 0);
        data->length = 64;
        data->doc = "RX NIF BER count only";
    }
    if (dnx_mib_counter_nif_rx_bip_errors_only < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_nif_rx_bip_errors_only, 0);
        data->length = 64;
        data->doc = "RX NIF BIP error count only";
    }
    ...
    if (dnx_mib_counter_nif_rx_stats_drop_events_sch_data < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_nif_rx_stats_drop_events_sch_data, 0);
        data->length = 64;
        data->doc = "RX nif ILKN drop events";
    }
    if (dnx_mib_counter_nif_rx_stats_discards < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_nif_rx_stats_discards, 0);
        data->length = 64;
        data->doc = "RX nif discard count";
    }
    ...
    if (dnx_mib_counter_nif_eth_tspare3 < table->keys[0].size)
    {
        ...
        data->length = 48;
        data->ctr_map_idx = 116;
        data->doc = "TX Spare3";
    }
    if (dnx_mib_preempt_counter_nif_eth_r64 < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_r64, 0);
        data->length = 40;
        data->row = 13;
        data->offset_in_row = 0;
        data->doc = "PREEMPT:RX 64-byte frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_r127 < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_r127, 0);
        data->length = 40;
        data->row = 13;
        data->offset_in_row = 1;
        data->doc = "PREEMPT:RX 65 to 127 byte frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_r255 < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_r255, 0);
        data->length = 40;
        data->row = 13;
        data->offset_in_row = 2;
        data->doc = "PREEMPT:RX 128 to 255 byte frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_r511 < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_r511, 0);
        data->length = 40;
        data->row = 13;
        data->offset_in_row = 3;
        data->doc = "PREEMPT:RX 256 to 511 byte frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_r1023 < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_r1023, 0);
        data->length = 40;
        data->row = 13;
        data->offset_in_row = 4;
        data->doc = "PREEMPT:RX 512 to 1023 byte frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_r1518 < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_r1518, 0);
        data->length = 40;
        data->row = 13;
        data->offset_in_row = 5;
        data->doc = "PREEMPT:RX 1024 to 1518 byte frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_rmgv < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rmgv, 0);
        data->length = 40;
        data->row = 13;
        data->offset_in_row = 6;
        data->doc = "PREEMPT:RX 1519 to 1522 byte frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_r2047 < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_r2047, 0);
        data->length = 40;
        data->row = 13;
        data->offset_in_row = 7;
        data->doc = "PREEMPT:RX 1519 to 2047 byte frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_r4095 < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_r4095, 0);
        data->length = 40;
        data->row = 14;
        data->offset_in_row = 0;
        data->doc = "PREEMPT:RX 2048 to 4095 byte frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_r9216 < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_r9216, 0);
        data->length = 40;
        data->row = 14;
        data->offset_in_row = 1;
        data->doc = "PREEMPT:RX 4096 to 9216 byte frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_r16383 < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_r16383, 0);
        data->length = 40;
        data->row = 14;
        data->offset_in_row = 2;
        data->doc = "PREEMPT:RX 9217 to 16383 byte frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_rbca < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rbca, 0);
        data->length = 40;
        data->row = 14;
        data->offset_in_row = 3;
        data->doc = "PREEMPT:RX BC frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_rprog0 < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rprog0, 0);
        data->length = 40;
        data->row = 14;
        data->offset_in_row = 4;
        data->doc = "PREEMPT:RX RPROG0 frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_rprog1 < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rprog1, 0);
        data->length = 40;
        data->row = 14;
        data->offset_in_row = 5;
        data->doc = "PREEMPT:RX RPROG1 frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_rprog2 < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rprog2, 0);
        data->length = 40;
        data->row = 14;
        data->offset_in_row = 6;
        data->doc = "PREEMPT:RX RPROG2 frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_rprog3 < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rprog3, 0);
        data->length = 40;
        data->row = 14;
        data->offset_in_row = 7;
        data->doc = "PREEMPT:RX RPROG3 frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_rpkt < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rpkt, 0);
        data->length = 40;
        data->row = 15;
        data->offset_in_row = 0;
        data->doc = "PREEMPT:RX all packets frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_rpok < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rpok, 0);
        data->length = 40;
        data->row = 15;
        data->offset_in_row = 1;
        data->doc = "PREEMPT:RX good frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_ruca < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_ruca, 0);
        data->length = 40;
        data->row = 15;
        data->offset_in_row = 2;
        data->doc = "PREEMPT:RX UC frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_rmca < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rmca, 0);
        data->length = 40;
        data->row = 15;
        data->offset_in_row = 4;
        data->doc = "PREEMPT:RX MC frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_rxpf < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rxpf, 0);
        data->length = 40;
        data->row = 15;
        data->offset_in_row = 5;
        data->doc = "PREEMPT:RX pause frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_rxpp < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rxpp, 0);
        data->length = 40;
        data->row = 15;
        data->offset_in_row = 6;
        data->doc = "PREEMPT:RX PFC frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_rxcf < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rxcf, 0);
        data->length = 40;
        data->row = 15;
        data->offset_in_row = 7;
        data->doc = "PREEMPT:RX control frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_rfcs < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rfcs, 0);
        data->length = 40;
        data->row = 16;
        data->offset_in_row = 0;
        data->doc = "PREEMPT:RX FCS error frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_rerpkt < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rerpkt, 0);
        data->length = 40;
        data->row = 16;
        data->offset_in_row = 1;
        data->doc = "PREEMPT:RX code error frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_rflr < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rflr, 0);
        data->length = 40;
        data->row = 16;
        data->offset_in_row = 2;
        data->doc = "PREEMPT:RX out-of-range length frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_rjbr < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rjbr, 0);
        data->length = 40;
        data->row = 16;
        data->offset_in_row = 3;
        data->doc = "PREEMPT:RX jabber frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_rmtue < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rmtue, 0);
        data->length = 40;
        data->row = 16;
        data->offset_in_row = 4;
        data->doc = "PREEMPT:RX MTU check error frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_rovr < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rovr, 0);
        data->length = 40;
        data->row = 16;
        data->offset_in_row = 5;
        data->doc = "PREEMPT:RX oversized frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_rvln < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rvln, 0);
        data->length = 40;
        data->row = 16;
        data->offset_in_row = 6;
        data->doc = "PREEMPT:RX single and double VLAN tagged frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_rdvln < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rdvln, 0);
        data->length = 40;
        data->row = 16;
        data->offset_in_row = 7;
        data->doc = "PREEMPT:RX double VLAN tagged frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_rxuo < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rxuo, 0);
        data->length = 40;
        data->row = 17;
        data->offset_in_row = 0;
        data->doc = "PREEMPT:RX unsupported opcode frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_rxuda < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rxuda, 0);
        data->length = 40;
        data->row = 17;
        data->offset_in_row = 1;
        data->doc = "PREEMPT:RX unsupported DA for pause/PFC frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_rxwsa < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rxwsa, 0);
        data->length = 40;
        data->row = 17;
        data->offset_in_row = 2;
        data->doc = "PREEMPT:RX incorrect SA frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_rprm < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rprm, 0);
        data->length = 40;
        data->row = 17;
        data->offset_in_row = 3;
        data->doc = "PREEMPT:RX promiscuous frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_rmfse < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rmfse, 0);
        data->length = 40;
        data->row = 17;
        data->offset_in_row = 4;
        data->doc = "PREEMPT:Receive MAC Expected to receive start of a new frame delimeter";
    }
    if (dnx_mib_preempt_counter_nif_eth_rmfae < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rmfae, 0);
        data->length = 40;
        data->row = 17;
        data->offset_in_row = 5;
        data->doc = "PREEMPT:Receive MAC Merge frame assembly error counter";
    }
    if (dnx_mib_preempt_counter_nif_eth_rmfao < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rmfao, 0);
        data->length = 40;
        data->row = 17;
        data->offset_in_row = 6;
        data->doc = "PREEMPT:Receive MAC Merge Frame assembly OK counter";
    }
    if (dnx_mib_preempt_counter_nif_eth_rmfc < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rmfc, 0);
        data->length = 40;
        data->row = 17;
        data->offset_in_row = 7;
        data->doc = "PREEMPT:Receive MAC Merge Fragment Counter";
    }
    if (dnx_mib_preempt_counter_nif_eth_rmdis < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rmdis, 0);
        data->length = 40;
        data->row = 18;
        data->offset_in_row = 0;
        data->doc = "PREEMPT:Receive MAC Discarded Frames Counter";
    }
    if (dnx_mib_preempt_counter_nif_eth_rnffmse < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rnffmse, 0);
        data->length = 40;
        data->row = 18;
        data->offset_in_row = 1;
        data->doc = "PREEMPT:Receive MAC Non-Final Fragment Min Size Error Counter";
    }
    if (dnx_mib_preempt_counter_nif_eth_rffmse < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rffmse, 0);
        data->length = 40;
        data->row = 18;
        data->offset_in_row = 2;
        data->doc = "PREEMPT:Receive MAC Final Fragment Min Size Error Counter";
    }
    if (dnx_mib_preempt_counter_nif_eth_rreply < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rreply, 0);
        data->length = 40;
        data->row = 18;
        data->offset_in_row = 3;
        data->doc = "PREEMPT:Receive RREPLY";
    }
    if (dnx_mib_preempt_counter_nif_eth_rverify < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rverify, 0);
        data->length = 40;
        data->row = 18;
        data->offset_in_row = 4;
        data->doc = "PREEMPT:Receive RVERIFY";
    }
    if (dnx_mib_preempt_counter_nif_eth_t64 < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_t64, 0);
        data->length = 40;
        data->row = 19;
        data->offset_in_row = 0;
        data->doc = "PREEMPT:TX 64-byte frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_t127 < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_t127, 0);
        data->length = 40;
        data->row = 19;
        data->offset_in_row = 1;
        data->doc = "PREEMPT:TX 65 to 127 byte frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_t255 < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_t255, 0);
        data->length = 40;
        data->row = 19;
        data->offset_in_row = 2;
        data->doc = "PREEMPT:TX 128 to 255 byte frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_t511 < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_t511, 0);
        data->length = 40;
        data->row = 19;
        data->offset_in_row = 3;
        data->doc = "PREEMPT:TX 256 to 511 byte frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_t1023 < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_t1023, 0);
        data->length = 40;
        data->row = 19;
        data->offset_in_row = 4;
        data->doc = "PREEMPT:TX 512 to 1023 byte frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_t1518 < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_t1518, 0);
        data->length = 40;
        data->row = 19;
        data->offset_in_row = 5;
        data->doc = "PREEMPT:TX 1024 to 1518 byte frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_tmgv < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_tmgv, 0);
        data->length = 40;
        data->row = 19;
        data->offset_in_row = 6;
        data->doc = "PREEMPT:TX 1519 to 1522 byte frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_t2047 < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_t2047, 0);
        data->length = 40;
        data->row = 19;
        data->offset_in_row = 7;
        data->doc = "PREEMPT:TX 1519 to 2047 byte frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_t4095 < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_t4095, 0);
        data->length = 40;
        data->row = 20;
        data->offset_in_row = 0;
        data->doc = "PREEMPT:TX 2048 to 4095 byte frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_t9216 < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_t9216, 0);
        data->length = 40;
        data->row = 20;
        data->offset_in_row = 1;
        data->doc = "PREEMPT:TX 4096 to 9216 byte frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_t16383 < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_t16383, 0);
        data->length = 40;
        data->row = 20;
        data->offset_in_row = 2;
        data->doc = "PREEMPT:TX 9217 to 16383 byte frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_tbca < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_tbca, 0);
        data->length = 40;
        data->row = 20;
        data->offset_in_row = 3;
        data->doc = "PREEMPT:TX Broadcast frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_tmfae < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_tmfae, 0);
        data->length = 40;
        data->row = 20;
        data->offset_in_row = 4;
        data->doc = "PREEMPT:Transmit MAC Merge Frame Assembly Error Counter";
    }
    if (dnx_mib_preempt_counter_nif_eth_tmfc < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_tmfc, 0);
        data->length = 40;
        data->row = 20;
        data->offset_in_row = 5;
        data->doc = "PREEMPT:Transmit MAC Merge Fragment Counter";
    }
    if (dnx_mib_preempt_counter_nif_eth_tverify < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_tverify, 0);
        data->length = 40;
        data->row = 20;
        data->offset_in_row = 6;
        data->doc = "PREEMPT:Transmit TVERIFY";
    }
    if (dnx_mib_preempt_counter_nif_eth_treply < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_treply, 0);
        data->length = 40;
        data->row = 20;
        data->offset_in_row = 7;
        data->doc = "PREEMPT:Transmit TREPLY";
    }
    if (dnx_mib_preempt_counter_nif_eth_tpkt < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_tpkt, 0);
        data->length = 40;
        data->row = 21;
        data->offset_in_row = 4;
        data->doc = "PREEMPT:TX all packets frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_tpok < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_tpok, 0);
        data->length = 40;
        data->row = 21;
        data->offset_in_row = 5;
        data->doc = "PREEMPT:TX good frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_tuca < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_tuca, 0);
        data->length = 40;
        data->row = 21;
        data->offset_in_row = 6;
        data->doc = "PREEMPT:TX UC frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_tufl < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_tufl, 0);
        data->length = 40;
        data->row = 21;
        data->offset_in_row = 7;
        data->doc = "PREEMPT:TX FIFO Underrun frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_tmca < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_tmca, 0);
        data->length = 40;
        data->row = 22;
        data->offset_in_row = 0;
        data->doc = "PREEMPT:TX MC frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_txcf < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_txcf, 0);
        data->length = 40;
        data->row = 22;
        data->offset_in_row = 3;
        data->doc = "PREEMPT:TX control frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_tfcs < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_tfcs, 0);
        data->length = 40;
        data->row = 22;
        data->offset_in_row = 4;
        data->doc = "PREEMPT:TX FCS error frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_terr < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_terr, 0);
        data->length = 40;
        data->row = 22;
        data->offset_in_row = 5;
        data->doc = "PREEMPT:TX Error frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_tovr < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_tovr, 0);
        data->length = 40;
        data->row = 22;
        data->offset_in_row = 6;
        data->doc = "PREEMPT:TX Oversize frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_tjbr < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_tjbr, 0);
        data->length = 40;
        data->row = 22;
        data->offset_in_row = 7;
        data->doc = "PREEMPT:TX jabber frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_trpkt < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_trpkt, 0);
        data->length = 40;
        data->row = 23;
        data->offset_in_row = 0;
        data->doc = "PREEMPT:TX RUNT frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_tfrg < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_tfrg, 0);
        data->length = 40;
        data->row = 23;
        data->offset_in_row = 1;
        data->doc = "PREEMPT:TX runt packet with invalid FCS frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_tvln < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_tvln, 0);
        data->length = 40;
        data->row = 23;
        data->offset_in_row = 2;
        data->doc = "PREEMPT:TX single and double VLAN tagged frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_tdvln < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_tdvln, 0);
        data->length = 40;
        data->row = 23;
        data->offset_in_row = 3;
        data->doc = "PREEMPT:TX double VLAN tagged frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_rbyt < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rbyt, 0);
        data->length = 48;
        data->row = 23;
        data->offset_in_row = 4;
        data->doc = "PREEMPT:RX Byte frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_rrbyt < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_rrbyt, 0);
        data->length = 48;
        data->row = 23;
        data->offset_in_row = 5;
        data->doc = "PREEMPT:RX Runt Byte frame";
    }
    if (dnx_mib_preempt_counter_nif_eth_tbyt < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_preempt_counter_nif_eth_tbyt, 0);
        data->length = 48;
        data->row = 23;
        data->offset_in_row = 6;
        data->doc = "PREEMPT:TX Byte frame";
    }
    if (dnx_mib_counter_nif_eth_epfc_tpfc0 < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_nif_eth_epfc_tpfc0, 0);
        data->length = 64;
        data->doc = "TX Encrypted PFC frame with enable bit set for Priority0";
    }
    if (dnx_mib_counter_nif_eth_epfc_tpfc1 < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_nif_eth_epfc_tpfc1, 0);
        data->length = 64;
        data->doc = "TX Encrypted PFC frame with enable bit set for Priority1";
    }
    if (dnx_mib_counter_nif_eth_epfc_tpfc2 < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_nif_eth_epfc_tpfc2, 0);
        data->length = 64;
        data->doc = "TX Encrypted PFC frame with enable bit set for Priority2";
    }
    if (dnx_mib_counter_nif_eth_epfc_tpfc3 < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_nif_eth_epfc_tpfc3, 0);
        data->length = 64;
        data->doc = "TX Encrypted PFC frame with enable bit set for Priority3";
    }
    if (dnx_mib_counter_nif_eth_epfc_tpfc4 < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_nif_eth_epfc_tpfc4, 0);
        data->length = 64;
        data->doc = "TX Encrypted PFC frame with enable bit set for Priority4";
    }
    if (dnx_mib_counter_nif_eth_epfc_tpfc5 < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_nif_eth_epfc_tpfc5, 0);
        data->length = 64;
        data->doc = "TX Encrypted PFC frame with enable bit set for Priority5";
    }
    if (dnx_mib_counter_nif_eth_epfc_tpfc6 < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_nif_eth_epfc_tpfc6, 0);
        data->length = 64;
        data->doc = "TX Encrypted PFC frame with enable bit set for Priority6";
    }
    if (dnx_mib_counter_nif_eth_epfc_tpfc7 < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_nif_eth_epfc_tpfc7, 0);
        data->length = 64;
        data->doc = "TX Encrypted PFC frame with enable bit set for Priority7";
    }
    ...
    int unit)
{
    ...
    table->set = j2p_a0_dnx_data_mib_controlled_counters_map_data_set;
    ...
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_mib_controlled_counters_counter_data_set;
