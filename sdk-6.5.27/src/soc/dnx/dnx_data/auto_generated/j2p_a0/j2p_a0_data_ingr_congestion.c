...
static shr_error_e
j2p_a0_dnx_data_ingr_congestion_vsq_vsq_with_id_on_nif_port_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_ingr_congestion;
    int submodule_index = dnx_data_ingr_congestion_submodule_vsq;
    int feature_index = dnx_data_ingr_congestion_vsq_vsq_with_id_on_nif_port_support;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_ingr_congestion_vsq_vsq_with_id_on_nif_port_support;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_ingr_congestion_vsq_vsq_with_id_on_nif_port_support_set;
