...
static shr_error_e
j2p_a0_dnx_data_fc_coe_nof_coe_cal_instances_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_fc;
    ...
    define->default_data = (dnx_data_device.general.valid_cores_bitmap_get(unit)+1)/2;

    
    define->data = (dnx_data_device.general.valid_cores_bitmap_get(unit)+1)/2;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_fc_coe_nof_coe_cal_instances_set;
