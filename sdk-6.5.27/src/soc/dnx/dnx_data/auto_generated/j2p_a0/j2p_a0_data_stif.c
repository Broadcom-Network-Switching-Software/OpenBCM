...
static shr_error_e
j2p_a0_dnx_data_stif_regression_supported_modes_set(
    int unit)
{
    int mode_index;
    int speed_index;
    ...
    if (dnx_stat_stif_mgmt_port_mode_single < table->keys[0].size && dnx_stat_stif_mgmt_port_speed_400000 < table->keys[1].size)
    {
        data = (dnx_data_stif_regression_supported_modes_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_stat_stif_mgmt_port_mode_single, dnx_stat_stif_mgmt_port_speed_400000);
        data->valid = 1;
        data->ports_type = "CDGE";
    }
    ...
    if (dnx_stat_stif_mgmt_port_mode_quad < table->keys[0].size && dnx_stat_stif_mgmt_port_speed_100000 < table->keys[1].size)
    {
        data = (dnx_data_stif_regression_supported_modes_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_stat_stif_mgmt_port_mode_quad, dnx_stat_stif_mgmt_port_speed_100000);
        data->valid = 1;
        data->ports_type = "CGE2_";
    }
    if (dnx_stat_stif_mgmt_port_mode_quad < table->keys[0].size && dnx_stat_stif_mgmt_port_speed_200000 < table->keys[1].size)
    {
        data = (dnx_data_stif_regression_supported_modes_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_stat_stif_mgmt_port_mode_quad, dnx_stat_stif_mgmt_port_speed_200000);
        data->valid = 1;
        data->ports_type = "CCGE";
    }
    ...
    int unit)
{
    ...
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_stif_regression_supported_modes_set;
