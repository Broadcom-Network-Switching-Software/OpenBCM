    ...
    int unit)
{
    ...
    if (dnx_graphical_fdr < table->keys[0].size && 3 < table->keys[1].size)
    {
        ...
        SHR_RANGE_VERIFY(9, 0, DNX_DIAG_COUNTER_REG_NOF_REGS, _SHR_E_INTERNAL, "out of bound access to array")
        data->regs[0] = FDR_P_1_FDR_DISCARD_COUNTER_MACNr;
        data->regs[1] = FDR_P_2_FDR_DISCARD_COUNTER_MACNr;
        data->regs[2] = FDR_P_1_FDR_FIFO_DISCARD_COUNTER_MACNr;
        data->regs[3] = FDR_P_2_FDR_FIFO_DISCARD_COUNTER_MACNr;
        data->regs[4] = FDR_AUTO_DOC_NAME_49r;
        data->regs[5] = FDR_FDR_REGISTER_2r;
        data->regs[6] = FDR_P_DROP_FILTER_CNTr;
        data->regs[7] = FDR_OFM_FIFO_OVFLW_DROP_CNT_Pr;
        data->regs[8] = FDR_OFM_FIFO_TRAFFIC_CLASS_DROP_CNT_Pr;
        SHR_RANGE_VERIFY(9, 0, DNX_DIAG_COUNTER_REG_NOF_REGS, _SHR_E_INTERNAL, "out of bound access to array")
        data->flds[0] = P_1_FDR_DISC_CNT_MACNf;
        data->flds[1] = P_2_FDR_DISC_CNT_MACNf;
        data->flds[2] = P_1_FDR_FIFO_DISC_CNT_MACNf;
        data->flds[3] = P_2_FDR_FIFO_DISC_CNT_MACNf;
        data->flds[4] = FIELD_0_30f;
        data->flds[5] = FIELD_0_31f;
        data->flds[6] = P_N_DROP_FILTER_CNTf;
        data->flds[7] = OFM_FIFO_OVFLW_DROP_CNT_P_Nf;
        data->flds[8] = OFM_FIFO_TRAFFIC_CLASS_DROP_CNT_P_Nf;
        SHR_RANGE_VERIFY(5, 0, DNX_DIAG_COUNTER_REG_NOF_REGS, _SHR_E_INTERNAL, "out of bound access to array")
        data->overflow_field[0] = P_1_TSC_DISC_MAC_N_CNT_OVERFLOWf;
        data->overflow_field[1] = P_2_TSC_DISC_MAC_N_CNT_OVERFLOWf;
        data->overflow_field[2] = P_1_SRT_DISC_MAC_N_CNT_OVERFLOWf;
        data->overflow_field[3] = P_2_SRT_DISC_MAC_N_CNT_OVERFLOWf;
        data->overflow_field[4] = FIELD_31_31f;
        data->fld_num = 9;
    ...
    if (dnx_graphical_nif_tx < table->keys[0].size && 2 < table->keys[1].size)
    {
        ...
        data->regs[1] = CDBM_TX_TOTAL_PKT_WITH_ERR_COUNTERr;
        SHR_RANGE_VERIFY(2, 0, DNX_DIAG_COUNTER_REG_NOF_REGS, _SHR_E_INTERNAL, "out of bound access to array")
