...
static shr_error_e
j2p_a0_dnx_data_adapter_general_oamp_ms_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
j2p_a0_dnx_data_adapter_general_tx_packet_header_signal_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
    int submodule_index = dnx_data_adapter_submodule_general;
    int define_index = dnx_data_adapter_general_define_tx_packet_header_signal_id;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
j2p_a0_dnx_data_adapter_general_tx_packet_tag_swap_res_signal_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
    int submodule_index = dnx_data_adapter_submodule_general;
    int define_index = dnx_data_adapter_general_define_tx_packet_tag_swap_res_signal_id;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
j2p_a0_dnx_data_adapter_general_tx_packet_recycle_command_signal_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
    int submodule_index = dnx_data_adapter_submodule_general;
    int define_index = dnx_data_adapter_general_define_tx_packet_recycle_command_signal_id;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
j2p_a0_dnx_data_adapter_general_tx_packet_recycle_context_signal_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
    int submodule_index = dnx_data_adapter_submodule_general;
    int define_index = dnx_data_adapter_general_define_tx_packet_recycle_context_signal_id;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
j2p_a0_dnx_data_adapter_general_tx_packet_valid_bytes_signal_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
    int submodule_index = dnx_data_adapter_submodule_general;
    int define_index = dnx_data_adapter_general_define_tx_packet_valid_bytes_signal_id;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
j2p_a0_dnx_data_adapter_general_tx_packet_header_signal_width_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
    int submodule_index = dnx_data_adapter_submodule_general;
    int define_index = dnx_data_adapter_general_define_tx_packet_header_signal_width;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
j2p_a0_dnx_data_adapter_general_tx_packet_tag_swap_res_signal_width_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
    int submodule_index = dnx_data_adapter_submodule_general;
    int define_index = dnx_data_adapter_general_define_tx_packet_tag_swap_res_signal_width;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
j2p_a0_dnx_data_adapter_general_tx_packet_recycle_command_signal_width_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
    int submodule_index = dnx_data_adapter_submodule_general;
    int define_index = dnx_data_adapter_general_define_tx_packet_recycle_command_signal_width;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
j2p_a0_dnx_data_adapter_general_tx_packet_recycle_context_signal_width_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
    int submodule_index = dnx_data_adapter_submodule_general;
    int define_index = dnx_data_adapter_general_define_tx_packet_recycle_context_signal_width;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
j2p_a0_dnx_data_adapter_general_tx_packet_valid_bytes_signal_width_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
    int submodule_index = dnx_data_adapter_submodule_general;
    int define_index = dnx_data_adapter_general_define_tx_packet_valid_bytes_signal_width;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
j2p_a0_dnx_data_adapter_general_Injection_set(
    int unit)
{
    ...
    table->values[0].default_val = "PRSR_J2P_A0";
    ...
    default_data->Injected_packet_name = "PRSR_J2P_A0";
...
static shr_error_e
j2p_a0_dnx_data_adapter_reg_mem_access_cmic_block_index_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
j2p_a0_dnx_data_adapter_reg_mem_access_iproc_block_index_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
j2p_a0_dnx_data_adapter_reg_mem_access_clear_on_read_mems_set(
    int unit)
{
    int index_index;
...
static shr_error_e
j2p_a0_dnx_data_adapter_reg_mem_access_clear_on_read_regs_set(
    int unit)
{
    int index_index;
    ...
    {
        data = (dnx_data_adapter_reg_mem_access_clear_on_read_regs_t *) dnxc_data_mgmt_table_data_get(unit, table, 0, 0);
        data->reg = CDB_RX_MLF_MAX_OCCUPANCYr;
    }
    if (1 < table->keys[0].size)
    {
        data = (dnx_data_adapter_reg_mem_access_clear_on_read_regs_t *) dnxc_data_mgmt_table_data_get(unit, table, 1, 0);
        data->reg = CDBM_RX_MLF_MAX_OCCUPANCYr;
    }
...
static shr_error_e
j2p_a0_dnx_data_adapter_reg_mem_access_clear_on_read_regmems_set(
    int unit)
{
    int index_index;
    dnx_data_adapter_reg_mem_access_clear_on_read_regmems_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnx_data_module_adapter;
    int submodule_index = dnx_data_adapter_submodule_reg_mem_access;
    int table_index = dnx_data_adapter_reg_mem_access_table_clear_on_read_regmems;
    SHR_FUNC_INIT_VARS(unit);
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_adapter_reg_mem_access_clear_on_read_regmems_t, (1 * (table->keys[0].size) + 1  ), "data of dnx_data_adapter_reg_mem_access_table_clear_on_read_regmems");

    
    default_data = (dnx_data_adapter_reg_mem_access_clear_on_read_regmems_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    default_data->regmem = 0;
    
    for (index_index = 0; index_index < table->keys[0].size; index_index++)
    {
        data = (dnx_data_adapter_reg_mem_access_clear_on_read_regmems_t *) dnxc_data_mgmt_table_data_get(unit, table, index_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
...
static shr_error_e
j2p_a0_dnx_data_adapter_mdb_lookup_caller_id_mapping_key_map(
    int unit,
    int key0_val,
    int key1_val,
    int *key0_index,
    int *key1_index)
{
    ...
    switch (key1_val)
    {
        ...
        case DNX_PP_STAGE_IPMF2+100*DBAL_PHYSICAL_TABLE_LEXEM:
            *key1_index = 14;
            break;
        case DNX_PP_STAGE_IFWD1+100*DBAL_PHYSICAL_TABLE_LEM:
            *key1_index = 15;
            break;
...
static shr_error_e
j2p_a0_dnx_data_adapter_mdb_lookup_caller_id_mapping_key_reverse_map(
    int unit,
    int key0_index,
    int key1_index,
    int *key0_val,
    ...
    switch (key1_index)
    {
        ...
        case 14:
            *key1_val = DNX_PP_STAGE_IPMF2+100*DBAL_PHYSICAL_TABLE_LEXEM;
            break;
        case 15:
            *key1_val = DNX_PP_STAGE_IFWD1+100*DBAL_PHYSICAL_TABLE_LEM;
            break;
        case 16:
...
static shr_error_e
j2p_a0_dnx_data_adapter_mdb_lookup_caller_id_mapping_set(
    int unit)
{
    int caller_id_index;
    ...
    table->keys[0].size = 45;
    table->info_get.key_size[0] = 45;
    table->keys[1].size = 29;
    table->info_get.key_size[1] = 29;
    ...
    table->key_map = j2p_a0_dnx_data_adapter_mdb_lookup_caller_id_mapping_key_map;
    table->key_map_reverse = j2p_a0_dnx_data_adapter_mdb_lookup_caller_id_mapping_key_reverse_map;
    ...
    data->mdb = DBAL_PHYSICAL_TABLE_TCAM;
    data->interface = "UnknownInterface";
    data = (dnx_data_adapter_mdb_lookup_caller_id_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 275, DNX_PP_STAGE_IPMF2+100*DBAL_PHYSICAL_TABLE_TCAM);
    ...
    data->mdb = DBAL_PHYSICAL_TABLE_TCAM;
    data->interface = "UnknownInterface";
    data = (dnx_data_adapter_mdb_lookup_caller_id_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 171, DNX_PP_STAGE_IFWD1+100*DBAL_PHYSICAL_TABLE_TCAM);
    ...
    data->interface = "UnknownInterface";
    data = (dnx_data_adapter_mdb_lookup_caller_id_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 175, DNX_PP_STAGE_IFWD2+100*DBAL_PHYSICAL_TABLE_TCAM);
    ...
    data->interface = "UnknownInterface";
    data = (dnx_data_adapter_mdb_lookup_caller_id_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 11, DNX_PP_STAGE_IFWD1+100*DBAL_PHYSICAL_TABLE_LEM);
    data->stage = DNX_PP_STAGE_IFWD1;
    data->mdb = DBAL_PHYSICAL_TABLE_LEM;
    data->interface = "UnknownInterface";
    data = (dnx_data_adapter_mdb_lookup_caller_id_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 12, DNX_PP_STAGE_IFWD1+100*DBAL_PHYSICAL_TABLE_TCAM);
    data->stage = DNX_PP_STAGE_IFWD1;
    data->mdb = DBAL_PHYSICAL_TABLE_TCAM;
    data->interface = "UnknownInterface";
    data = (dnx_data_adapter_mdb_lookup_caller_id_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 13, DNX_PP_STAGE_IFWD1+100*DBAL_PHYSICAL_TABLE_TCAM);
    data->stage = DNX_PP_STAGE_IFWD1;
    data->mdb = DBAL_PHYSICAL_TABLE_TCAM;
    data->interface = "UnknownInterface";
    data = (dnx_data_adapter_mdb_lookup_caller_id_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 5, DNX_PP_STAGE_VTT1+100*DBAL_PHYSICAL_TABLE_SEXEM_1);
    data->stage = DNX_PP_STAGE_VTT1;
    data->mdb = DBAL_PHYSICAL_TABLE_SEXEM_1;
    data->interface = "UnknownInterface";
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_adapter_general_oamp_ms_id_set;
    data_index = dnx_data_adapter_general_define_tx_packet_header_signal_id;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_adapter_general_tx_packet_header_signal_id_set;
    data_index = dnx_data_adapter_general_define_tx_packet_tag_swap_res_signal_id;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_adapter_general_tx_packet_tag_swap_res_signal_id_set;
    data_index = dnx_data_adapter_general_define_tx_packet_recycle_command_signal_id;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_adapter_general_tx_packet_recycle_command_signal_id_set;
    data_index = dnx_data_adapter_general_define_tx_packet_recycle_context_signal_id;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_adapter_general_tx_packet_recycle_context_signal_id_set;
    data_index = dnx_data_adapter_general_define_tx_packet_valid_bytes_signal_id;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_adapter_general_tx_packet_valid_bytes_signal_id_set;
    data_index = dnx_data_adapter_general_define_tx_packet_header_signal_width;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_adapter_general_tx_packet_header_signal_width_set;
    data_index = dnx_data_adapter_general_define_tx_packet_tag_swap_res_signal_width;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_adapter_general_tx_packet_tag_swap_res_signal_width_set;
    data_index = dnx_data_adapter_general_define_tx_packet_recycle_command_signal_width;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_adapter_general_tx_packet_recycle_command_signal_width_set;
    data_index = dnx_data_adapter_general_define_tx_packet_recycle_context_signal_width;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_adapter_general_tx_packet_recycle_context_signal_width_set;
    data_index = dnx_data_adapter_general_define_tx_packet_valid_bytes_signal_width;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_adapter_general_tx_packet_valid_bytes_signal_width_set;
    ...
    table->set = j2p_a0_dnx_data_adapter_general_Injection_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_adapter_reg_mem_access_cmic_block_index_set;
    data_index = dnx_data_adapter_reg_mem_access_define_iproc_block_index;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_adapter_reg_mem_access_iproc_block_index_set;
    ...
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_adapter_reg_mem_access_clear_on_read_mems_set;
    data_index = dnx_data_adapter_reg_mem_access_table_clear_on_read_regs;
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_adapter_reg_mem_access_clear_on_read_regs_set;
    data_index = dnx_data_adapter_reg_mem_access_table_clear_on_read_regmems;
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_adapter_reg_mem_access_clear_on_read_regmems_set;
    ...
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_adapter_mdb_lookup_caller_id_mapping_set;
