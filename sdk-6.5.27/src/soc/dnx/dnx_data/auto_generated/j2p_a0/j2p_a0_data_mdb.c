...
static shr_error_e
j2p_a0_dnx_data_mdb_pdbs_table_mdb_kaps_dynamic_memory_access_memory_access_field_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_mdb;
...
static shr_error_e
j2p_a0_dnx_data_mdb_pdbs_table_mdb_ddha_dynamic_memory_access_memory_access_field_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_mdb;
...
static shr_error_e
j2p_a0_dnx_data_mdb_em_compare_size_set(
    int unit)
{
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_mdb_pdbs_table_mdb_kaps_dynamic_memory_access_memory_access_field_size_set;
    data_index = dnx_data_mdb_pdbs_define_table_mdb_ddha_dynamic_memory_access_memory_access_field_size;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_mdb_pdbs_table_mdb_ddha_dynamic_memory_access_memory_access_field_size_set;
    ...
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_mdb_em_compare_size_set;
