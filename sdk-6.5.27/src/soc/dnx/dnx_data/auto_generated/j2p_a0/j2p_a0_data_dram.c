...
static shr_error_e
j2p_a0_dnx_data_dram_hbm_is_freeze_boot_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_dram;
...
static shr_error_e
j2p_a0_dnx_data_dram_hbm_driver_strength_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
static shr_error_e
j2p_a0_dnx_data_dram_hbm_t_rdlat_offset_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
static shr_error_e
j2p_a0_dnx_data_dram_hbm_hbc_sbus_chain_set(
    int unit)
{
    int channel_index;
    ...
    if (8 < table->keys[0].size)
    {
        data = (dnx_data_dram_hbm_hbc_sbus_chain_t *) dnxc_data_mgmt_table_data_get(unit, table, 8, 0);
        data->sbus_chain = 1;
    }
    if (9 < table->keys[0].size)
    {
        data = (dnx_data_dram_hbm_hbc_sbus_chain_t *) dnxc_data_mgmt_table_data_get(unit, table, 9, 0);
        data->sbus_chain = 1;
    }
    if (10 < table->keys[0].size)
    {
        data = (dnx_data_dram_hbm_hbc_sbus_chain_t *) dnxc_data_mgmt_table_data_get(unit, table, 10, 0);
        data->sbus_chain = 1;
    }
    if (11 < table->keys[0].size)
    {
        data = (dnx_data_dram_hbm_hbc_sbus_chain_t *) dnxc_data_mgmt_table_data_get(unit, table, 11, 0);
        data->sbus_chain = 1;
    }
    if (12 < table->keys[0].size)
    {
        data = (dnx_data_dram_hbm_hbc_sbus_chain_t *) dnxc_data_mgmt_table_data_get(unit, table, 12, 0);
        data->sbus_chain = 1;
    }
    if (13 < table->keys[0].size)
    {
        data = (dnx_data_dram_hbm_hbc_sbus_chain_t *) dnxc_data_mgmt_table_data_get(unit, table, 13, 0);
        data->sbus_chain = 1;
    }
    if (14 < table->keys[0].size)
    {
        data = (dnx_data_dram_hbm_hbc_sbus_chain_t *) dnxc_data_mgmt_table_data_get(unit, table, 14, 0);
        data->sbus_chain = 1;
    }
    if (15 < table->keys[0].size)
    {
        data = (dnx_data_dram_hbm_hbc_sbus_chain_t *) dnxc_data_mgmt_table_data_get(unit, table, 15, 0);
        data->sbus_chain = 1;
    }
...
static shr_error_e
j2p_a0_dnx_data_dram_general_info_dq_write_parity_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
static shr_error_e
j2p_a0_dnx_data_dram_general_info_write_latency_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
static shr_error_e
j2p_a0_dnx_data_dram_general_info_read_data_enable_delay_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
static shr_error_e
j2p_a0_dnx_data_dram_general_info_supported_dram_bitmap_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
static shr_error_e
j2p_a0_dnx_data_dram_dram_block_dram_block_params_set(
    int unit)
{
    int mechanism_index;
    ...
    if (DNX_DRAM_BLOCK_MECHANISM_WRITE_PLUS_READ < table->keys[0].size)
    {
        ...
        data->increment_threshold_0 = 152 * dnx_data_dram.dram_block.wpr_increment_thr_factor_get(unit) / 100;
        data->increment_threshold_1 = 154 * dnx_data_dram.dram_block.wpr_increment_thr_factor_get(unit) / 100;
        data->increment_threshold_2 = 156 * dnx_data_dram.dram_block.wpr_increment_thr_factor_get(unit) / 100;
    ...
    if (DNX_DRAM_BLOCK_MECHANISM_WRITE < table->keys[0].size)
    {
        data = (dnx_data_dram_dram_block_dram_block_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_DRAM_BLOCK_MECHANISM_WRITE, 0);
        data->is_valid = TRUE;
        data->dbal_table = DBAL_TABLE_DRAM_COMMON_TDU_DRAM_BLOCK_WRITE_LEAKY_BUCKET_CONFIG;
        data->increment_threshold_0 = 102 * dnx_data_dram.dram_block.wpr_increment_thr_factor_get(unit) / 100;
        data->increment_threshold_1 = 104 * dnx_data_dram.dram_block.wpr_increment_thr_factor_get(unit) / 100;
        data->increment_threshold_2 = 106 * dnx_data_dram.dram_block.wpr_increment_thr_factor_get(unit) / 100;
        data->increment_size_0 = 2;
        data->increment_size_1 = 3;
        data->increment_size_2 = 4;
        data->decrement_size_0 = 1;
    ...
    if (DNX_DRAM_BLOCK_MECHANISM_AVERAGE_READ_INFLIGHTS < table->keys[0].size)
    {
        ...
        data->bucket_assert_threshold = 20;
        data->bucket_deassert_threshold = 4;
...
static shr_error_e
j2p_a0_dnx_data_dram_dbal_hbm_write_latency_nof_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
static shr_error_e
j2p_a0_dnx_data_dram_dbal_hbm_rd_data_en_delay_nof_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
static shr_error_e
j2p_a0_dnx_data_dram_firmware_max_timeout_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
    int submodule_index = dnx_data_dram_submodule_firmware;
    int define_index = dnx_data_dram_firmware_define_max_timeout;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    if (0x1e < table->keys[0].size)
    {
        ...
        data->description = "ERROR_EXTEST_SLB_FAILURE";
    }
    ...
    int unit)
{
    ...
    table->keys[0].size = 0x25;
    table->info_get.key_size[0] = 0x25;
    ...
    {
        data = (dnx_data_dram_firmware_operation_result_last_operation_t *) dnxc_data_mgmt_table_data_get(unit, table, 0x24, 0);
        data->description = "OP_EXTEST_SLB";
    }
    ...
    int unit)
{
    ...
    table->values[2].default_val = "0x00";
    ...
    default_data->ch_enable_bitmap = 0x00;
...
static shr_error_e
j2p_a0_dnx_data_dram_ctests_rate_set(
    int unit)
{
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_dram_hbm_driver_strength_set;
    data_index = dnx_data_dram_hbm_define_t_rdlat_offset;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_dram_hbm_t_rdlat_offset_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_dram_hbm_is_freeze_boot_supported_set;
    ...
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_dram_hbm_hbc_sbus_chain_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_dram_general_info_dq_write_parity_set;
    data_index = dnx_data_dram_general_info_define_write_latency;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_dram_general_info_write_latency_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_dram_general_info_read_data_enable_delay_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_dram_general_info_supported_dram_bitmap_set;
    ...
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_dram_dram_block_dram_block_params_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_dram_dbal_hbm_write_latency_nof_bits_set;
    data_index = dnx_data_dram_dbal_define_hbm_rd_data_en_delay_nof_bits;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_dram_dbal_hbm_rd_data_en_delay_nof_bits_set;
    ...
    data_index = dnx_data_dram_firmware_define_max_timeout;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_dram_firmware_max_timeout_set;
    ...
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_dram_ctests_rate_set;
