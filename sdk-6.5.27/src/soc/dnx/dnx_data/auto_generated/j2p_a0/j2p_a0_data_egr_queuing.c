...
static shr_error_e
j2p_a0_dnx_data_egr_queuing_params_txq_reduce_max_credits_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_egr_queuing;
...
static shr_error_e
j2p_a0_dnx_data_egr_queuing_params_reserved_if_fc_config_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_egr_queuing;
...
static shr_error_e
j2p_a0_dnx_data_egr_queuing_params_allow_aloc_ae_ifc_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_egr_queuing;
    ...
    int unit)
{
    ...
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_egr_queuing_params_txq_reduce_max_credits_set;
    data_index = dnx_data_egr_queuing_params_reserved_if_fc_config;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_egr_queuing_params_reserved_if_fc_config_set;
    data_index = dnx_data_egr_queuing_params_allow_aloc_ae_ifc_support;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_egr_queuing_params_allow_aloc_ae_ifc_support_set;
    ...
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_egr_queuing_params_fqp_dbf_additional_latency_set;
