...
static shr_error_e
j2p_a0_dnx_data_led_general_last_port_on_scan_chain_set(
    int unit)
{
...
static shr_error_e
j2p_a0_dnx_data_led_general_m0ss_freq_mhz_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_led;
    ...
    int unit)
{
    ...
    define->set = j2p_a0_dnx_data_led_general_last_port_on_scan_chain_set;
    data_index = dnx_data_led_general_define_m0ss_freq_mhz;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_led_general_m0ss_freq_mhz_set;
