...
static shr_error_e
q2a_a0_dnx_data_dev_init_time_init_total_time_set(
    int unit)
{
...
static shr_error_e
q2a_a0_dnx_data_dev_init_time_appl_init_total_time_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
q2a_a0_dnx_data_dev_init_time_down_deviation_total_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
q2a_a0_dnx_data_dev_init_time_up_deviation_total_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
q2a_a0_dnx_data_dev_init_time_test_sensitivity_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
q2a_a0_dnx_data_dev_init_time_step_time_set(
    int unit)
{
    int step_id_index;
...
static shr_error_e
q2a_a0_dnx_data_dev_init_time_appl_step_time_set(
    int unit)
{
    int step_id_index;
    ...
    int unit)
{
    ...
    table->keys[0].size = 96;
    table->info_get.key_size[0] = 96;
    ...
    {
        data = (dnx_data_dev_init_mem_default_t *) dnxc_data_mgmt_table_data_get(unit, table, 90, 0);
        data->mem = MDB_ISEM_2m;
        data->mode = dnx_init_mem_default_mode_none;
    }
    if (91 < table->keys[0].size)
    {
        data = (dnx_data_dev_init_mem_default_t *) dnxc_data_mgmt_table_data_get(unit, table, 91, 0);
        data->mem = MDB_ISEM_3m;
        data->mode = dnx_init_mem_default_mode_none;
    }
    if (92 < table->keys[0].size)
    {
        data = (dnx_data_dev_init_mem_default_t *) dnxc_data_mgmt_table_data_get(unit, table, 92, 0);
        data->mem = MDB_MC_IDm;
        data->mode = dnx_init_mem_default_mode_none;
    }
    if (93 < table->keys[0].size)
    {
        data = (dnx_data_dev_init_mem_default_t *) dnxc_data_mgmt_table_data_get(unit, table, 93, 0);
        data->mem = MDB_RMEPm;
        data->mode = dnx_init_mem_default_mode_none;
    }
    if (94 < table->keys[0].size)
    {
        data = (dnx_data_dev_init_mem_default_t *) dnxc_data_mgmt_table_data_get(unit, table, 94, 0);
        data->mem = IPPB_FLPA_FWD_DOMAIN_STATISTICS_OBJECT_COMMAND_MAPm;
        data->mode = dnx_init_mem_default_mode_index;
    }
    if (95 < table->keys[0].size)
    {
        data = (dnx_data_dev_init_mem_default_t *) dnxc_data_mgmt_table_data_get(unit, table, 95, 0);
    ...
    int unit)
{
    ...
    table->keys[0].size = 194;
    table->info_get.key_size[0] = 194;
...
static shr_error_e
q2a_a0_dnx_data_dev_init_general_erpp_threshold_prp_per_port_info_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
q2a_a0_dnx_data_dev_init_general_heat_up_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
q2a_a0_dnx_data_dev_init_general_clock_power_down_set(
    int unit)
{
    int index_index;
    ...
    if (0 < table->keys[0].size)
    {
        ...
        data->reg = CDU_SPECIAL_CLOCK_CONTROLSr;
    ...
    if (1 < table->keys[0].size)
    {
        ...
        data->reg = CDU_CLK_POWER_DOWN_2r;
        data->field = CLK_POWER_DOWN_2_VALf;
    }
    if (2 < table->keys[0].size)
    {
        data = (dnx_data_dev_init_general_clock_power_down_t *) dnxc_data_mgmt_table_data_get(unit, table, 2, 0);
        data->reg = CLU_SPECIAL_CLOCK_CONTROLSr;
        data->field = CLOCK_PD_POWER_DOWNf;
    }
    if (3 < table->keys[0].size)
    {
        data = (dnx_data_dev_init_general_clock_power_down_t *) dnxc_data_mgmt_table_data_get(unit, table, 3, 0);
        data->reg = ILE_SPECIAL_CLOCK_CONTROLSr;
        data->field = CLOCK_PD_POWER_DOWNf;
    }
    if (4 < table->keys[0].size)
    {
        data = (dnx_data_dev_init_general_clock_power_down_t *) dnxc_data_mgmt_table_data_get(unit, table, 4, 0);
...
static shr_error_e
q2a_a0_dnx_data_dev_init_context_forwarding_context_selection_mask_offset_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
q2a_a0_dnx_data_dev_init_context_forwarding_context_selection_result_offset_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
q2a_a0_dnx_data_dev_init_context_termination_context_selection_mask_offset_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
q2a_a0_dnx_data_dev_init_context_termination_context_selection_result_offset_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
q2a_a0_dnx_data_dev_init_context_prp_pem_context_selection_mask_offset_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
q2a_a0_dnx_data_dev_init_context_prp_context_selection_result_offset_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
    ...
    int unit)
{
    ...
    table->keys[0].size = 115;
    table->info_get.key_size[0] = 115;
    ...
    int unit)
{
    ...
    define->set = q2a_a0_dnx_data_dev_init_time_init_total_time_set;
    data_index = dnx_data_dev_init_time_define_appl_init_total_time;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_dev_init_time_appl_init_total_time_set;
    data_index = dnx_data_dev_init_time_define_down_deviation_total;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_dev_init_time_down_deviation_total_set;
    data_index = dnx_data_dev_init_time_define_up_deviation_total;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_dev_init_time_up_deviation_total_set;
    data_index = dnx_data_dev_init_time_define_test_sensitivity;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_dev_init_time_test_sensitivity_set;
    ...
    table->set = q2a_a0_dnx_data_dev_init_time_step_time_set;
    data_index = dnx_data_dev_init_time_table_appl_step_time;
    table = &submodule->tables[data_index];
    table->set = q2a_a0_dnx_data_dev_init_time_appl_step_time_set;
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_dev_init_general_heat_up_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_dev_init_general_erpp_threshold_prp_per_port_info_set;

    
    data_index = dnx_data_dev_init_general_table_clock_power_down;
    table = &submodule->tables[data_index];
    table->set = q2a_a0_dnx_data_dev_init_general_clock_power_down_set;
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_dev_init_context_forwarding_context_selection_mask_offset_set;
    data_index = dnx_data_dev_init_context_define_forwarding_context_selection_result_offset;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_dev_init_context_forwarding_context_selection_result_offset_set;
    data_index = dnx_data_dev_init_context_define_termination_context_selection_mask_offset;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_dev_init_context_termination_context_selection_mask_offset_set;
    data_index = dnx_data_dev_init_context_define_termination_context_selection_result_offset;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_dev_init_context_termination_context_selection_result_offset_set;
    data_index = dnx_data_dev_init_context_define_prp_pem_context_selection_mask_offset;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_dev_init_context_prp_pem_context_selection_mask_offset_set;
    data_index = dnx_data_dev_init_context_define_prp_context_selection_result_offset;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_dev_init_context_prp_context_selection_result_offset_set;
