...
static shr_error_e
q2a_a0_dnx_data_nif_phys_txpi_supported_in_pm8x50_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
    ...
    int unit)
{
    ...
    default_data->measure_rate_on_down_port_supported = 1;
...
static shr_error_e
q2a_a0_dnx_data_nif_eth_ethu_per_core_set(
    int unit)
{
    int ethu_index_index;
...
static shr_error_e
q2a_a0_dnx_data_nif_eth_nif_cores_ethus_set(
    int unit)
{
    int core_id_index;
...
static shr_error_e
q2a_a0_dnx_data_nif_framer_ptp_channel_max_bandwidth_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
...
static shr_error_e
q2a_a0_dnx_data_nif_framer_oam_channel_max_bandwidth_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
...
static shr_error_e
q2a_a0_dnx_data_nif_flexe_unaware_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
...
static shr_error_e
q2a_a0_dnx_data_nif_flexe_nb_tx_cal_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
    ...
    int unit)
{
    ...
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_nif_phys_txpi_supported_in_pm8x50_set;
    ...
    table = &submodule->tables[data_index];
    table->set = q2a_a0_dnx_data_nif_eth_ethu_per_core_set;
    data_index = dnx_data_nif_eth_table_nif_cores_ethus;
    table = &submodule->tables[data_index];
    table->set = q2a_a0_dnx_data_nif_eth_nif_cores_ethus_set;
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_nif_framer_ptp_channel_max_bandwidth_set;
    data_index = dnx_data_nif_framer_define_oam_channel_max_bandwidth;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_nif_framer_oam_channel_max_bandwidth_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_nif_flexe_unaware_support_set;
    data_index = dnx_data_nif_flexe_nb_tx_cal_support;
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_nif_flexe_nb_tx_cal_support_set;
