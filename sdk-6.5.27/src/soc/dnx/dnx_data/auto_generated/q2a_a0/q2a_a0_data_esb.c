...
static shr_error_e
q2a_a0_dnx_data_esb_general_is_used_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_esb;
    ...
    int unit)
{
    ...
    define->default_data = dnx_data_esb.general.nof_nif_eth_queues_get(unit)+dnx_data_esb.general.nof_nif_ilkn_queues_get(unit)+dnx_data_esb.general.nof_ilkn_tdm_or_lp_queues_get(unit)+dnx_data_esb.general.nof_special_queues_get(unit)+dnx_data_nif.mac_client.nof_clients_get(unit)+dnx_data_esb.general.nof_reserved_queues_get(unit);

    
    define->data = dnx_data_esb.general.nof_nif_eth_queues_get(unit)+dnx_data_esb.general.nof_nif_ilkn_queues_get(unit)+dnx_data_esb.general.nof_ilkn_tdm_or_lp_queues_get(unit)+dnx_data_esb.general.nof_special_queues_get(unit)+dnx_data_nif.mac_client.nof_clients_get(unit)+dnx_data_esb.general.nof_reserved_queues_get(unit);
    ...
    int unit)
{
    ...
    define->default_data = dnx_data_nif.mac_client.nof_clients_get(unit);

    
    define->data = dnx_data_nif.mac_client.nof_clients_get(unit);
...
static shr_error_e
q2a_a0_dnx_data_esb_general_nif_credits_resolution_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_esb;
...
static shr_error_e
q2a_a0_dnx_data_esb_general_nif_credits_rate_resolution_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_esb;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_esb_general_nif_credits_resolution_set;
    data_index = dnx_data_esb_general_define_nif_credits_rate_resolution;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_esb_general_nif_credits_rate_resolution_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_esb_general_is_used_set;
