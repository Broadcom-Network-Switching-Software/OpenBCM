...
static shr_error_e
q2a_a0_dnx_data_mpls_general_support_alternate_marking_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_mpls;
...
static shr_error_e
q2a_a0_dnx_data_mpls_general_mpls_control_word_flag_bits_lsb_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_mpls;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_mpls_general_mpls_control_word_flag_bits_lsb_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_mpls_general_support_alternate_marking_set;
