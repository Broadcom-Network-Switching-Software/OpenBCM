...
static shr_error_e
q2a_a0_dnx_data_oam_general_oam_twamp_flow_id_ext_enable_set(
    int unit)
{
...
static shr_error_e
q2a_a0_dnx_data_oam_general_oam_y1711_enable_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_oam;
...
static shr_error_e
q2a_a0_dnx_data_oam_general_oam_local_outlif_msb_bit_index_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_oam;
...
static shr_error_e
q2a_a0_dnx_data_oam_oamp_up_mep_tod_recycle_port_core_0_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_oam;
...
static shr_error_e
q2a_a0_dnx_data_oam_oamp_up_mep_tod_recycle_port_core_1_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_oam;
    ...
    int unit)
{
    ...
    define->default_data = Q2A_INT_OAMP_PENDING_EVENT;

    
    define->data = Q2A_INT_OAMP_PENDING_EVENT;
    ...
    int unit)
{
    ...
    define->default_data = Q2A_INT_OAMP_STAT_PENDING_EVENT;

    
    define->data = Q2A_INT_OAMP_STAT_PENDING_EVENT;
...
static shr_error_e
q2a_a0_dnx_data_oam_feature_up_mep_tod_recycle_enable_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_oam;
...
static shr_error_e
q2a_a0_dnx_data_oam_feature_ptch_oam_offset_limitation_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_oam;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_oam_general_oam_local_outlif_msb_bit_index_set;

    
    data_index = dnx_data_oam_general_oam_twamp_flow_id_ext_enable;
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_oam_general_oam_twamp_flow_id_ext_enable_set;
    data_index = dnx_data_oam_general_oam_y1711_enable;
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_oam_general_oam_y1711_enable_set;
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_oam_oamp_up_mep_tod_recycle_port_core_0_set;
    data_index = dnx_data_oam_oamp_define_up_mep_tod_recycle_port_core_1;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_oam_oamp_up_mep_tod_recycle_port_core_1_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_oam_feature_up_mep_tod_recycle_enable_set;
    data_index = dnx_data_oam_feature_ptch_oam_offset_limitation;
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_oam_feature_ptch_oam_offset_limitation_set;
