...
static shr_error_e
q2a_a0_dnx_data_mdb_pdbs_table_mdb_kaps_dynamic_memory_access_memory_access_field_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_mdb;
...
static shr_error_e
q2a_a0_dnx_data_mdb_pdbs_table_mdb_ddha_dynamic_memory_access_memory_access_field_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_mdb;
...
static shr_error_e
q2a_a0_dnx_data_mdb_em_is_isem_dpc_in_vtt5_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_mdb;
...
static shr_error_e
q2a_a0_dnx_data_mdb_em_scan_bank_participate_in_cuckoo_partial_support_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_mdb;
...
static shr_error_e
q2a_a0_dnx_data_mdb_em_defrag_interrupt_support_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_mdb;
...
static shr_error_e
q2a_a0_dnx_data_mdb_em_mdb_em_dbal_phy_tables_info_set(
    int unit)
{
    int dbal_id_index;
...
static shr_error_e
q2a_a0_dnx_data_mdb_em_filter_rules_set(
    int unit)
{
    int dbal_id_index;
    ...
    if (DBAL_PHYSICAL_TABLE_LEM < table->keys[0].size)
    {
        ...
        data->entry_mask = ITEM_8_263f;
        data->entry_filter = ITEM_274_529f;
        data->src_mask = ITEM_264_266f;
        data->src_filter = ITEM_530_532f;
        data->appdb_id_mask = ITEM_2_7f;
        data->appdb_id_filter = ITEM_268_273f;
        data->accessed_mask = ITEM_1_1f;
        data->accessed_filter = ITEM_267_267f;
    }
...
static shr_error_e
q2a_a0_dnx_data_mdb_em_data_rules_set(
    int unit)
{
    int dbal_id_index;
...
static shr_error_e
q2a_a0_dnx_data_mdb_direct_mdb_direct_mdb_phy_tables_info_set(
    int unit)
{
    int mdb_table_id_index;
...
static shr_error_e
q2a_a0_dnx_data_mdb_kaps_kaps_lookup_result_set(
    int unit)
{
    int db_idx_index;
    int core_index;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_mdb_pdbs_table_mdb_kaps_dynamic_memory_access_memory_access_field_size_set;
    data_index = dnx_data_mdb_pdbs_define_table_mdb_ddha_dynamic_memory_access_memory_access_field_size;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_mdb_pdbs_table_mdb_ddha_dynamic_memory_access_memory_access_field_size_set;
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_mdb_em_scan_bank_participate_in_cuckoo_partial_support_set;
    data_index = dnx_data_mdb_em_define_defrag_interrupt_support;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_mdb_em_defrag_interrupt_support_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_mdb_em_is_isem_dpc_in_vtt5_set;
    ...
    table = &submodule->tables[data_index];
    table->set = q2a_a0_dnx_data_mdb_em_mdb_em_dbal_phy_tables_info_set;
    data_index = dnx_data_mdb_em_table_filter_rules;
    table = &submodule->tables[data_index];
    table->set = q2a_a0_dnx_data_mdb_em_filter_rules_set;
    data_index = dnx_data_mdb_em_table_data_rules;
    table = &submodule->tables[data_index];
    table->set = q2a_a0_dnx_data_mdb_em_data_rules_set;
    ...
    table = &submodule->tables[data_index];
    table->set = q2a_a0_dnx_data_mdb_direct_mdb_direct_mdb_phy_tables_info_set;
    ...
    table = &submodule->tables[data_index];
    table->set = q2a_a0_dnx_data_mdb_kaps_kaps_lookup_result_set;
