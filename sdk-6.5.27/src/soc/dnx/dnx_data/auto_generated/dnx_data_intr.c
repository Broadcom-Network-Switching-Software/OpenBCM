    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_intr_general_soft_init_for_debug].name = "soft_init_for_debug";
    submodule_data->features[dnx_data_intr_general_soft_init_for_debug].doc = "";
    submodule_data->features[dnx_data_intr_general_soft_init_for_debug].flags |= DNXC_DATA_F_FEATURE;
    ...
    submodule_data->tables[dnx_data_intr_general_table_active_on_init].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_general_table_disable_on_init].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_general_table_disable_print_on_init].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_general_table_block_intr_field_mapping].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_init].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_general_table_force_unmask_on_init].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_regress].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_general_table_framer_module_map].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_general_table_framer_module_map].values[1].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_remap].name = "chip_intr_remap";
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_remap].doc = "";
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_remap].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_remap].size_of_values = sizeof(dnx_data_intr_general_chip_intr_remap_t);
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_remap].entry_get = dnx_data_intr_general_chip_intr_remap_entry_str_get;

    
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_remap].nof_keys = 1;
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_remap].keys[0].name = "offset";
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_remap].keys[0].doc = "";

    
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_remap].nof_values = 3;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_intr_general_table_chip_intr_remap].values, dnxc_data_value_t, submodule_data->tables[dnx_data_intr_general_table_chip_intr_remap].nof_values, "_dnx_data_intr_general_table_chip_intr_remap table values");
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_remap].values[0].name = "start";
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_remap].values[0].type = "uint32";
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_remap].values[0].doc = "";
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_remap].values[0].offset = UTILEX_OFFSETOF(dnx_data_intr_general_chip_intr_remap_t, start);
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_remap].values[1].name = "end";
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_remap].values[1].type = "uint32";
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_remap].values[1].doc = "";
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_remap].values[1].offset = UTILEX_OFFSETOF(dnx_data_intr_general_chip_intr_remap_t, end);
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_remap].values[2].name = "vector";
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_remap].values[2].type = "uint32";
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_remap].values[2].doc = "";
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_remap].values[2].offset = UTILEX_OFFSETOF(dnx_data_intr_general_chip_intr_remap_t, vector);

    
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_enable].name = "chip_intr_enable";
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_enable].doc = "";
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_enable].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_enable].size_of_values = sizeof(dnx_data_intr_general_chip_intr_enable_t);
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_enable].entry_get = dnx_data_intr_general_chip_intr_enable_entry_str_get;

    
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_enable].nof_keys = 1;
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_enable].keys[0].name = "offset";
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_enable].keys[0].doc = "";

    
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_enable].nof_values = 1;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_intr_general_table_chip_intr_enable].values, dnxc_data_value_t, submodule_data->tables[dnx_data_intr_general_table_chip_intr_enable].nof_values, "_dnx_data_intr_general_table_chip_intr_enable table values");
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_enable].values[0].name = "bit";
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_enable].values[0].type = "uint32";
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_enable].values[0].doc = "";
    submodule_data->tables[dnx_data_intr_general_table_chip_intr_enable].values[0].offset = UTILEX_OFFSETOF(dnx_data_intr_general_chip_intr_enable_t, bit);
...
const dnx_data_intr_general_chip_intr_remap_t *
dnx_data_intr_general_chip_intr_remap_get(
    int unit,
    int offset)
{
    char *data;
    ...
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_intr, dnx_data_intr_submodule_general, dnx_data_intr_general_table_chip_intr_remap);
    
    data = dnxc_data_mgmt_table_data_get(unit, table, offset, 0);
    return (const dnx_data_intr_general_chip_intr_remap_t *) data;

}

const dnx_data_intr_general_chip_intr_enable_t *
dnx_data_intr_general_chip_intr_enable_get(
    int unit,
    int offset)
{
    char *data;
    ...
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_intr, dnx_data_intr_submodule_general, dnx_data_intr_general_table_chip_intr_enable);
    
    data = dnxc_data_mgmt_table_data_get(unit, table, offset, 0);
    return (const dnx_data_intr_general_chip_intr_enable_t *) data;
...
shr_error_e
dnx_data_intr_general_chip_intr_remap_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_intr_general_chip_intr_remap_t *data;
    SHR_FUNC_INIT_VARS(unit);

    
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_intr, dnx_data_intr_submodule_general, dnx_data_intr_general_table_chip_intr_remap);
    data = (const dnx_data_intr_general_chip_intr_remap_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
...
shr_error_e
dnx_data_intr_general_chip_intr_enable_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_intr_general_chip_intr_enable_t *data;
    SHR_FUNC_INIT_VARS(unit);

    
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_intr, dnx_data_intr_submodule_general, dnx_data_intr_general_table_chip_intr_enable);
    data = (const dnx_data_intr_general_chip_intr_enable_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
...
const dnxc_data_table_info_t *
dnx_data_intr_general_chip_intr_remap_info_get(
    int unit)
{

    
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_intr, dnx_data_intr_submodule_general, dnx_data_intr_general_table_chip_intr_remap);

}

const dnxc_data_table_info_t *
dnx_data_intr_general_chip_intr_enable_info_get(
    int unit)
{

    
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_intr, dnx_data_intr_submodule_general, dnx_data_intr_general_table_chip_intr_enable);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_intr_ser_define_new_tcam_scan_mode].name = "new_tcam_scan_mode";
    submodule_data->defines[dnx_data_intr_ser_define_new_tcam_scan_mode].doc = "";
    
    submodule_data->defines[dnx_data_intr_ser_define_new_tcam_scan_mode].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->tables[dnx_data_intr_ser_table_mem_mask].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_mem_mask].values[1].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_mem_mask].values[2].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_xor_mem].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_xor_mem].values[1].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_xor_mem].values[2].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_xor_mem].values[3].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_intr_exception].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_intr_exception].values[1].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_static_mem].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_dynamic_mem].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_mdb_mem_map].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_mdb_mem_map].values[1].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_kaps_tcam_scan].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_kaps_tcam_scan].values[1].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_kaps_tcam_scan].values[2].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_kaps_tcam_scan].values[3].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_severity_mem].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_severity_mem].values[1].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].name = "tcam_scan";
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].doc = "";
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].size_of_values = sizeof(dnx_data_intr_ser_tcam_scan_t);
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].entry_get = dnx_data_intr_ser_tcam_scan_entry_str_get;

    
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].nof_keys = 1;
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].keys[0].name = "index";
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].keys[0].doc = "";

    
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].nof_values = 10;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values, dnxc_data_value_t, submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].nof_values, "_dnx_data_intr_ser_table_tcam_scan table values");
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[0].name = "scan_cfg_reg";
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[0].type = "uint32";
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[0].doc = "";
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[0].offset = UTILEX_OFFSETOF(dnx_data_intr_ser_tcam_scan_t, scan_cfg_reg);
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[1].name = "scan_pause_reg";
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[1].type = "uint32";
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[1].doc = "";
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[1].offset = UTILEX_OFFSETOF(dnx_data_intr_ser_tcam_scan_t, scan_pause_reg);
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[2].name = "scan_index_reg";
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[2].type = "uint32";
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[2].doc = "";
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[2].offset = UTILEX_OFFSETOF(dnx_data_intr_ser_tcam_scan_t, scan_index_reg);
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[3].name = "tcam_memory";
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[3].type = "uint32";
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[3].doc = "";
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[3].offset = UTILEX_OFFSETOF(dnx_data_intr_ser_tcam_scan_t, tcam_memory);
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[4].name = "scan_window";
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[4].type = "uint32";
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[4].doc = "";
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[4].offset = UTILEX_OFFSETOF(dnx_data_intr_ser_tcam_scan_t, scan_window);
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[5].name = "dec_action";
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[5].type = "uint32";
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[5].doc = "";
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[5].offset = UTILEX_OFFSETOF(dnx_data_intr_ser_tcam_scan_t, dec_action);
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[6].name = "sec_action";
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[6].type = "uint32";
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[6].doc = "";
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[6].offset = UTILEX_OFFSETOF(dnx_data_intr_ser_tcam_scan_t, sec_action);
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[7].name = "dec_pause";
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[7].type = "uint32";
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[7].doc = "";
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[7].offset = UTILEX_OFFSETOF(dnx_data_intr_ser_tcam_scan_t, dec_pause);
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[8].name = "sec_pause";
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[8].type = "uint32";
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[8].doc = "";
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[8].offset = UTILEX_OFFSETOF(dnx_data_intr_ser_tcam_scan_t, sec_pause);
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[9].name = "shadowed";
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[9].type = "uint32";
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[9].doc = "";
    submodule_data->tables[dnx_data_intr_ser_table_tcam_scan].values[9].offset = UTILEX_OFFSETOF(dnx_data_intr_ser_tcam_scan_t, shadowed);
...
uint32
dnx_data_intr_ser_new_tcam_scan_mode_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_intr, dnx_data_intr_submodule_ser, dnx_data_intr_ser_define_new_tcam_scan_mode);
}
...
const dnx_data_intr_ser_tcam_scan_t *
dnx_data_intr_ser_tcam_scan_get(
    int unit,
    int index)
{
    char *data;
    ...
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_intr, dnx_data_intr_submodule_ser, dnx_data_intr_ser_table_tcam_scan);
    
    data = dnxc_data_mgmt_table_data_get(unit, table, index, 0);
    return (const dnx_data_intr_ser_tcam_scan_t *) data;
...
shr_error_e
dnx_data_intr_ser_tcam_scan_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_intr_ser_tcam_scan_t *data;
    SHR_FUNC_INIT_VARS(unit);

    
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_intr, dnx_data_intr_submodule_ser, dnx_data_intr_ser_table_tcam_scan);
    data = (const dnx_data_intr_ser_tcam_scan_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->scan_cfg_reg);
            break;
        case 1:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->scan_pause_reg);
            break;
        case 2:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->scan_index_reg);
            break;
        case 3:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->tcam_memory);
            break;
        case 4:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->scan_window);
            break;
        case 5:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->dec_action);
            break;
        case 6:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->sec_action);
            break;
        case 7:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->dec_pause);
            break;
        case 8:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->sec_pause);
            break;
        case 9:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->shadowed);
            break;
    }
...
const dnxc_data_table_info_t *
dnx_data_intr_ser_tcam_scan_info_get(
    int unit)
{

    
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_intr, dnx_data_intr_submodule_ser, dnx_data_intr_ser_table_tcam_scan);
