    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_fc_general_pass_control_frames_support].name = "pass_control_frames_support";
    submodule_data->features[dnx_data_fc_general_pass_control_frames_support].doc = "";
    submodule_data->features[dnx_data_fc_general_pass_control_frames_support].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_fc_general_only_nif_rmc_for_fc].name = "only_nif_rmc_for_fc";
    submodule_data->features[dnx_data_fc_general_only_nif_rmc_for_fc].doc = "";
    submodule_data->features[dnx_data_fc_general_only_nif_rmc_for_fc].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_fc_general_pfc_remapping].name = "pfc_remapping";
    submodule_data->features[dnx_data_fc_general_pfc_remapping].doc = "";
    submodule_data->features[dnx_data_fc_general_pfc_remapping].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_fc_general_pfc_to_stop_pm_support].name = "pfc_to_stop_pm_support";
    submodule_data->features[dnx_data_fc_general_pfc_to_stop_pm_support].doc = "";
    submodule_data->features[dnx_data_fc_general_pfc_to_stop_pm_support].flags |= DNXC_DATA_F_FEATURE;
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_fc_pfc_deadlock_define_nbu_intr_id].name = "nbu_intr_id";
    submodule_data->defines[dnx_data_fc_pfc_deadlock_define_nbu_intr_id].doc = "";
    
    submodule_data->defines[dnx_data_fc_pfc_deadlock_define_nbu_intr_id].flags |= DNXC_DATA_F_NUMERIC;
...
uint32
dnx_data_fc_pfc_deadlock_nbu_intr_id_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_fc, dnx_data_fc_submodule_pfc_deadlock, dnx_data_fc_pfc_deadlock_define_nbu_intr_id);
}
