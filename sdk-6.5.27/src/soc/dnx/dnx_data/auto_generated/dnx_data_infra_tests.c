    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_infra_tests_sw_state_define_htb_rh_hashing_algorithm].name = "htb_rh_hashing_algorithm";
    submodule_data->defines[dnx_data_infra_tests_sw_state_define_htb_rh_hashing_algorithm].doc = "";
    
    submodule_data->defines[dnx_data_infra_tests_sw_state_define_htb_rh_hashing_algorithm].flags |= DNXC_DATA_F_NUMERIC;

    submodule_data->defines[dnx_data_infra_tests_sw_state_define_htb_rh_create_flags].name = "htb_rh_create_flags";
    submodule_data->defines[dnx_data_infra_tests_sw_state_define_htb_rh_create_flags].doc = "";
    
    submodule_data->defines[dnx_data_infra_tests_sw_state_define_htb_rh_create_flags].flags |= DNXC_DATA_F_NUMERIC;
...
uint32
dnx_data_infra_tests_sw_state_htb_rh_hashing_algorithm_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_infra_tests, dnx_data_infra_tests_submodule_sw_state, dnx_data_infra_tests_sw_state_define_htb_rh_hashing_algorithm);
}

uint32
dnx_data_infra_tests_sw_state_htb_rh_create_flags_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_infra_tests, dnx_data_infra_tests_submodule_sw_state, dnx_data_infra_tests_sw_state_define_htb_rh_create_flags);
}
