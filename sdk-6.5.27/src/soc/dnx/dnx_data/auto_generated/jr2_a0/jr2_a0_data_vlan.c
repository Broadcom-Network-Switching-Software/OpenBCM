...
static shr_error_e
jr2_a0_dnx_data_vlan_llvp_outlif_llvp_profile_zero_is_valid_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_vlan;
    int submodule_index = dnx_data_vlan_submodule_llvp;
    int feature_index = dnx_data_vlan_llvp_outlif_llvp_profile_zero_is_valid;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_vlan_llvp_outlif_llvp_profile_zero_is_valid;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_vlan_llvp_outlif_llvp_profile_zero_is_valid_set;
