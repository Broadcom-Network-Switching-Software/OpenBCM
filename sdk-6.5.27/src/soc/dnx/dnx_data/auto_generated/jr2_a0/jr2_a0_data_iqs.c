...
static shr_error_e
jr2_a0_dnx_data_iqs_deq_default_dequeue_params_configuration_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_iqs;
    int submodule_index = dnx_data_iqs_submodule_deq_default;
    int feature_index = dnx_data_iqs_deq_default_dequeue_params_configuration;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_iqs_dbal_credit_worth_nof_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_iqs;
    int submodule_index = dnx_data_iqs_submodule_dbal;
    int define_index = dnx_data_iqs_dbal_define_credit_worth_nof_bits;
    SHR_FUNC_INIT_VARS(unit);

    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    
    define->default_data = utilex_log2_round_up(dnx_data_iqs.credit.max_worth_get(unit));

    
    define->data = utilex_log2_round_up(dnx_data_iqs.credit.max_worth_get(unit));
...
static shr_error_e
jr2_a0_dnx_data_iqs_dbal_fsm_sn_mask_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_iqs;
    int submodule_index = dnx_data_iqs_submodule_dbal;
    int define_index = dnx_data_iqs_dbal_define_fsm_sn_mask;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_iqs_general_is_used_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_iqs;
    ...
    int unit)
{
    ...
    data_index = dnx_data_iqs_deq_default_dequeue_params_configuration;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_iqs_deq_default_dequeue_params_configuration_set;
    ...
    data_index = dnx_data_iqs_dbal_define_credit_worth_nof_bits;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_iqs_dbal_credit_worth_nof_bits_set;
    data_index = dnx_data_iqs_dbal_define_fsm_sn_mask;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_iqs_dbal_fsm_sn_mask_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_iqs_general_is_used_set;
