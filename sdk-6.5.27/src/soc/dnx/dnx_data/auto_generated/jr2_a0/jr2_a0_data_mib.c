    ...
    int unit)
{
    ...
    feature->default_data = dnx_data_intr.general.table_dma_enable_get(unit)*dnx_data_intr.general.tslam_dma_enable_get(unit);

    
    feature->data = dnx_data_intr.general.table_dma_enable_get(unit)*dnx_data_intr.general.tslam_dma_enable_get(unit);
