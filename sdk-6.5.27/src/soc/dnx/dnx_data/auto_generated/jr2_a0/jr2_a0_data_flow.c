...
static shr_error_e
jr2_a0_dnx_data_flow_general_match_per_gport_sw_nof_entries_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_flow;
    int submodule_index = dnx_data_flow_submodule_general;
    int define_index = dnx_data_flow_general_define_match_per_gport_sw_nof_entries;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_flow_general_define_match_per_gport_sw_nof_entries;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_flow_general_match_per_gport_sw_nof_entries_set;
