...
static shr_error_e
jr2_a0_dnx_data_stif_general_is_used_set(
    int unit)
{
...
static shr_error_e
jr2_a0_dnx_data_stif_general_is_tap_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_stif;
    int submodule_index = dnx_data_stif_submodule_general;
    int feature_index = dnx_data_stif_general_is_tap_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_stif_regression_last_stif_data_length_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_stif;
...
static shr_error_e
jr2_a0_dnx_data_stif_regression_supported_modes_set(
    int unit)
{
    int mode_index;
    int speed_index;
    ...
    int unit)
{
    ...
    feature->set = jr2_a0_dnx_data_stif_general_is_used_set;
    data_index = dnx_data_stif_general_is_tap_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_stif_general_is_tap_supported_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_stif_regression_last_stif_data_length_set;
    ...
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_stif_regression_supported_modes_set;
