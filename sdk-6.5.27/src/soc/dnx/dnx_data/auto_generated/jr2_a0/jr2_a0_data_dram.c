...
static shr_error_e
jr2_a0_dnx_data_dram_hbm_enable_dram_bist_on_init_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
    int submodule_index = dnx_data_dram_submodule_hbm;
    int define_index = dnx_data_dram_hbm_define_enable_dram_bist_on_init;
    SHR_FUNC_INIT_VARS(unit);
    ...
    define->property.suffix = "enable_dram_bist_on_init";
...
static shr_error_e
jr2_a0_dnx_data_dram_hbm_nof_channel_dwords_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
    int submodule_index = dnx_data_dram_submodule_hbm;
    int define_index = dnx_data_dram_hbm_define_nof_channel_dwords;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    table->values[1].default_val = "0x20";
    ...
    default_data->same_row_commands = 0x20;
...
static shr_error_e
jr2_a0_dnx_data_dram_hbm_hbc_sbus_chain_set(
    int unit)
{
    int channel_index;
    ...
    int unit)
{
    ...
    define->property.mapping[5].name = "RESTORE_TUNE_PARAMS_FROM_OTP_OR_TUNE";
    define->property.mapping[5].val = DNX_HBMC_RESTORE_TUNE_PARAMS_FROM_OTP_OR_TUNE;
...
static shr_error_e
jr2_a0_dnx_data_dram_general_info_supported_dram_bitmap_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
static shr_error_e
jr2_a0_dnx_data_dram_general_info_dram_bitmap_internal_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
    ...
    define->default_data = dnx_data_dram.general_info.supported_dram_bitmap_get(unit);

    
    define->data = dnx_data_dram.general_info.supported_dram_bitmap_get(unit);
...
static shr_error_e
jr2_a0_dnx_data_dram_general_info_tertw_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
static shr_error_e
jr2_a0_dnx_data_dram_general_info_dram_blocks_in_power_down_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
    int submodule_index = dnx_data_dram_submodule_general_info;
    int define_index = dnx_data_dram_general_info_define_dram_blocks_in_power_down;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    table->values[11].default_val = "47";
    table->values[12].default_val = "9";
    table->values[13].default_val = "5";
    table->values[14].default_val = "21";
    table->values[15].default_val = "3";
    table->values[16].default_val = "2";
    table->values[17].default_val = "4";
    table->values[18].default_val = "8";
    table->values[19].default_val = "160";
    table->values[20].default_val = "260";
    table->values[21].default_val = "8";
    table->values[22].default_val = "15";
...
static shr_error_e
jr2_a0_dnx_data_dram_address_translation_max_tdu_index_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
    int submodule_index = dnx_data_dram_submodule_address_translation;
    int define_index = dnx_data_dram_address_translation_define_max_tdu_index;
    SHR_FUNC_INIT_VARS(unit);

    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    
    define->default_data = dnx_data_dram.general_info.max_nof_drams_get(unit)*dnx_data_dram.address_translation.nof_tdus_per_dram_get(unit)-1;

    
    define->data = dnx_data_dram.general_info.max_nof_drams_get(unit)*dnx_data_dram.address_translation.nof_tdus_per_dram_get(unit)-1;
    ...
    int unit)
{
    ...
    feature->default_data = dnx_data_dram.dram_block.dram_block_params_get(unit, DNX_DRAM_BLOCK_MECHANISM_WRITE_MINUS_READ)->is_valid;

    
    feature->data = dnx_data_dram.dram_block.dram_block_params_get(unit, DNX_DRAM_BLOCK_MECHANISM_WRITE_MINUS_READ)->is_valid;
...
static shr_error_e
jr2_a0_dnx_data_dram_dram_block_write_plus_read_leaky_bucket_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_dram;
    int submodule_index = dnx_data_dram_submodule_dram_block;
    int feature_index = dnx_data_dram_dram_block_write_plus_read_leaky_bucket;
    SHR_FUNC_INIT_VARS(unit);

    feature = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].features[feature_index];
    
    feature->default_data = dnx_data_dram.dram_block.dram_block_params_get(unit, DNX_DRAM_BLOCK_MECHANISM_WRITE_PLUS_READ)->is_valid;

    
    feature->data = dnx_data_dram.dram_block.dram_block_params_get(unit, DNX_DRAM_BLOCK_MECHANISM_WRITE_PLUS_READ)->is_valid;
...
static shr_error_e
jr2_a0_dnx_data_dram_dram_block_write_leaky_bucket_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_dram;
    ...
    feature->default_data = dnx_data_dram.dram_block.dram_block_params_get(unit, DNX_DRAM_BLOCK_MECHANISM_WRITE)->is_valid;

    
    feature->data = dnx_data_dram.dram_block.dram_block_params_get(unit, DNX_DRAM_BLOCK_MECHANISM_WRITE)->is_valid;
...
static shr_error_e
jr2_a0_dnx_data_dram_dram_block_average_read_inflights_leaky_bucket_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_dram;
    ...
    feature->default_data = dnx_data_dram.dram_block.dram_block_params_get(unit, DNX_DRAM_BLOCK_MECHANISM_AVERAGE_READ_INFLIGHTS)->is_valid;

    
    feature->data = dnx_data_dram.dram_block.dram_block_params_get(unit, DNX_DRAM_BLOCK_MECHANISM_AVERAGE_READ_INFLIGHTS)->is_valid;
...
static shr_error_e
jr2_a0_dnx_data_dram_dram_block_write_minus_read_leaky_bucket_disable_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_dram;
    ...
    feature->default_data = dnx_data_dram.dram_block.dram_block_params_get(unit, DNX_DRAM_BLOCK_MECHANISM_WRITE_MINUS_READ)->is_disable_supported;

    
    feature->data = dnx_data_dram.dram_block.dram_block_params_get(unit, DNX_DRAM_BLOCK_MECHANISM_WRITE_MINUS_READ)->is_disable_supported;
...
static shr_error_e
jr2_a0_dnx_data_dram_dram_block_write_plus_read_leaky_bucket_disable_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_dram;
    ...
    feature->default_data = dnx_data_dram.dram_block.dram_block_params_get(unit, DNX_DRAM_BLOCK_MECHANISM_WRITE_PLUS_READ)->is_disable_supported;

    
    feature->data = dnx_data_dram.dram_block.dram_block_params_get(unit, DNX_DRAM_BLOCK_MECHANISM_WRITE_PLUS_READ)->is_disable_supported;
...
static shr_error_e
jr2_a0_dnx_data_dram_dram_block_average_read_inflights_log2_window_size_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_dram;
    ...
    feature->default_data = dnx_data_dram.dram_block.dram_block_params_get(unit, DNX_DRAM_BLOCK_MECHANISM_AVERAGE_READ_INFLIGHTS)->log2_window_size!=DNX_DRAM_BLOCK_CONFIG_PARAM_INVALID;

    
    feature->data = dnx_data_dram.dram_block.dram_block_params_get(unit, DNX_DRAM_BLOCK_MECHANISM_AVERAGE_READ_INFLIGHTS)->log2_window_size!=DNX_DRAM_BLOCK_CONFIG_PARAM_INVALID;
...
static shr_error_e
jr2_a0_dnx_data_dram_dram_block_dram_block_params_set(
    int unit)
{
    int mechanism_index;
...
static shr_error_e
jr2_a0_dnx_data_dram_dbal_hbm_write_latency_nof_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
static shr_error_e
jr2_a0_dnx_data_dram_dbal_hbm_output_enable_delay_nof_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
static shr_error_e
jr2_a0_dnx_data_dram_dbal_hbm_c_u_nof_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
static shr_error_e
jr2_a0_dnx_data_dram_dbal_hbm_r_u_nof_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
static shr_error_e
jr2_a0_dnx_data_dram_ctests_rate_set(
    int unit)
{
    ...
    table->values[1].default_val = "68";
    table->values[2].default_val = "98500";
    table->values[3].default_val = "1850000";
    ...
    default_data->nof_lanes_in_snake = 68;
    default_data->expected_rate_in_mbps = 98500;
    default_data->expected_dram_rate_in_mbps = 1850000;
    ...
    int unit)
{
    ...
    data_index = dnx_data_dram_hbm_define_enable_dram_bist_on_init;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_dram_hbm_enable_dram_bist_on_init_set;
    data_index = dnx_data_dram_hbm_define_default_model_part_num;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_dram_hbm_default_model_part_num_set;
    data_index = dnx_data_dram_hbm_define_nof_channel_dwords;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_dram_hbm_nof_channel_dwords_set;
    ...
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_dram_hbm_hbc_sbus_chain_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_dram_general_info_supported_dram_bitmap_set;
    data_index = dnx_data_dram_general_info_define_dram_bitmap_internal;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_dram_general_info_dram_bitmap_internal_set;
    data_index = dnx_data_dram_general_info_define_tertw;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_dram_general_info_tertw_set;
    data_index = dnx_data_dram_general_info_define_dram_blocks_in_power_down;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_dram_general_info_dram_blocks_in_power_down_set;
    ...
    data_index = dnx_data_dram_address_translation_define_max_tdu_index;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_dram_address_translation_max_tdu_index_set;
    ...
    data_index = dnx_data_dram_dram_block_write_plus_read_leaky_bucket;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_dram_dram_block_write_plus_read_leaky_bucket_set;
    data_index = dnx_data_dram_dram_block_write_leaky_bucket;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_dram_dram_block_write_leaky_bucket_set;
    data_index = dnx_data_dram_dram_block_average_read_inflights_leaky_bucket;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_dram_dram_block_average_read_inflights_leaky_bucket_set;
    data_index = dnx_data_dram_dram_block_write_minus_read_leaky_bucket_disable;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_dram_dram_block_write_minus_read_leaky_bucket_disable_set;
    data_index = dnx_data_dram_dram_block_write_plus_read_leaky_bucket_disable;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_dram_dram_block_write_plus_read_leaky_bucket_disable_set;
    data_index = dnx_data_dram_dram_block_average_read_inflights_log2_window_size;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_dram_dram_block_average_read_inflights_log2_window_size_set;

    
    data_index = dnx_data_dram_dram_block_table_dram_block_params;
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_dram_dram_block_dram_block_params_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_dram_dbal_hbm_write_latency_nof_bits_set;
    data_index = dnx_data_dram_dbal_define_hbm_output_enable_delay_nof_bits;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_dram_dbal_hbm_output_enable_delay_nof_bits_set;
    data_index = dnx_data_dram_dbal_define_hbm_c_u_nof_bits;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_dram_dbal_hbm_c_u_nof_bits_set;
    data_index = dnx_data_dram_dbal_define_hbm_r_u_nof_bits;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_dram_dbal_hbm_r_u_nof_bits_set;
    ...
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_dram_ctests_rate_set;
