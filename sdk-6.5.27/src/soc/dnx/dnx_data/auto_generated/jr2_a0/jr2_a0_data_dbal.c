...
static shr_error_e
jr2_a0_dnx_data_dbal_db_init_tcam_cs_as_hl_tcam_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_dbal;
    int submodule_index = dnx_data_dbal_submodule_db_init;
    int feature_index = dnx_data_dbal_db_init_tcam_cs_as_hl_tcam;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_dbal_db_init_default_std_set(
    int unit)
{
    dnx_data_dbal_db_init_default_std_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnx_data_module_dbal;
    int submodule_index = dnx_data_dbal_submodule_db_init;
    int table_index = dnx_data_dbal_db_init_table_default_std;
    SHR_FUNC_INIT_VARS(unit);
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_dbal_db_init_default_std_t, (1 + 1  ), "data of dnx_data_dbal_db_init_table_default_std");

    
    default_data = (dnx_data_dbal_db_init_default_std_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    default_data->image_name = "standard_1";
    
    data = (dnx_data_dbal_db_init_default_std_t *) dnxc_data_mgmt_table_data_get(unit, table, 0, 0);
    sal_memcpy(data, default_data, table->size_of_values);
...
static shr_error_e
jr2_a0_dnx_data_dbal_table_support_mdb_general_phys_db_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_dbal;
    int submodule_index = dnx_data_dbal_submodule_table;
    int feature_index = dnx_data_dbal_table_support_mdb_general_phys_db;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_dbal_db_init_tcam_cs_as_hl_tcam;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_dbal_db_init_tcam_cs_as_hl_tcam_set;

    
    data_index = dnx_data_dbal_db_init_table_default_std;
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_dbal_db_init_default_std_set;
    ...
    data_index = dnx_data_dbal_table_support_mdb_general_phys_db;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_dbal_table_support_mdb_general_phys_db_set;
