...
static shr_error_e
jr2_a0_dnx_data_snif_egress_high_scale_mapping_db_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_snif;
    int submodule_index = dnx_data_snif_submodule_egress;
    int feature_index = dnx_data_snif_egress_high_scale_mapping_db_supported;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_snif_egress_high_scale_mapping_db_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_snif_egress_high_scale_mapping_db_supported_set;
