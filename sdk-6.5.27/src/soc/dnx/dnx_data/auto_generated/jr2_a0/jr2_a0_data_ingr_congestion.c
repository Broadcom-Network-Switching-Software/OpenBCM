...
static shr_error_e
jr2_a0_dnx_data_ingr_congestion_vsq_vsq_with_id_on_nif_port_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_ingr_congestion;
    ...
    int unit)
{
    ...
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_ingr_congestion_vsq_vsq_with_id_on_nif_port_support_set;
