...
static shr_error_e
jr2_a0_dnx_data_infra_tests_sw_state_htb_rh_hashing_algorithm_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_infra_tests;
    int submodule_index = dnx_data_infra_tests_submodule_sw_state;
    int define_index = dnx_data_infra_tests_sw_state_define_htb_rh_hashing_algorithm;
    SHR_FUNC_INIT_VARS(unit);
    ...
    define->property.method = dnxc_data_property_method_suffix_range;
    define->property.method_str = "suffix_range";
    define->property.suffix = "htb_rh_hashing_algorithm";
    define->property.range_min = 0;
    define->property.range_max = 0xFFFFFFFF;
...
static shr_error_e
jr2_a0_dnx_data_infra_tests_sw_state_htb_rh_create_flags_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_infra_tests;
    int submodule_index = dnx_data_infra_tests_submodule_sw_state;
    int define_index = dnx_data_infra_tests_sw_state_define_htb_rh_create_flags;
    SHR_FUNC_INIT_VARS(unit);
    ...
    define->property.method = dnxc_data_property_method_suffix_range;
    define->property.method_str = "suffix_range";
    define->property.suffix = "htb_rh_create_flags";
    define->property.range_min = 0;
    define->property.range_max = 0xFFFFFFFF;
    ...
    int unit)
{
    ...
    data_index = dnx_data_infra_tests_sw_state_define_htb_rh_hashing_algorithm;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_infra_tests_sw_state_htb_rh_hashing_algorithm_set;
    data_index = dnx_data_infra_tests_sw_state_define_htb_rh_create_flags;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_infra_tests_sw_state_htb_rh_create_flags_set;
