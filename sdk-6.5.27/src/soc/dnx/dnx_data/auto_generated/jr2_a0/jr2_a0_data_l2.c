...
static shr_error_e
jr2_a0_dnx_data_l2_general_l2_add_get_apis_supported_flags_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_l2;
    int submodule_index = dnx_data_l2_submodule_general;
    int define_index = dnx_data_l2_general_define_l2_add_get_apis_supported_flags;
    SHR_FUNC_INIT_VARS(unit);

    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    
    define->default_data = (BCM_L2_STATIC | BCM_L2_MCAST | BCM_L2_TRUNK_MEMBER | BCM_L2_DISCARD_SRC | BCM_L2_DISCARD_DST | BCM_L2_DES_HIT | BCM_L2_SRC_HIT | BCM_L2_MOVE_PORT);

    
    define->data = (BCM_L2_STATIC | BCM_L2_MCAST | BCM_L2_TRUNK_MEMBER | BCM_L2_DISCARD_SRC | BCM_L2_DISCARD_DST | BCM_L2_DES_HIT | BCM_L2_SRC_HIT | BCM_L2_MOVE_PORT);
    ...
    int unit)
{
    ...
    if ((uint8)l2ActionTypeFwdAndNA < table->keys[0].size && (uint8)l2AddrMactSvl < table->keys[1].size)
    {
        ...
        data->dest_lif_stat = DBAL_RESULT_TYPE_FWD_MACT_FWD_MACT_RESULT_DEST__LIF__STAT;
        data->dest_stat = DBAL_RESULT_TYPE_FWD_MACT_FWD_MACT_RESULT_DEST__STAT;
        data->eei = DBAL_RESULT_TYPE_FWD_MACT_FWD_MACT_RESULT_EEI__FEC;
        data->no_outlif = DBAL_RESULT_TYPE_FWD_MACT_FWD_MACT_RESULT_DEST__XL_FGID;
        data->single_outlif = DBAL_RESULT_TYPE_FWD_MACT_FWD_MACT_RESULT_DEST__LIF__XL_FGID;
    }
    if ((uint8)l2ActionTypeFwdAndNA < table->keys[0].size && (uint8)l2AddrMactIvl < table->keys[1].size)
    {
        ...
        data->dest_lif_stat = DBAL_RESULT_TYPE_FWD_MACT_IVL_FWD_MACT_RESULT_DEST__LIF__STAT;
        data->dest_stat = DBAL_RESULT_TYPE_FWD_MACT_IVL_FWD_MACT_RESULT_DEST__STAT;
        data->eei = DBAL_RESULT_TYPE_FWD_MACT_IVL_FWD_MACT_RESULT_EEI__FEC;
        data->no_outlif = DBAL_RESULT_TYPE_FWD_MACT_IVL_FWD_MACT_RESULT_DEST__XL_FGID;
        data->single_outlif = DBAL_RESULT_TYPE_FWD_MACT_IVL_FWD_MACT_RESULT_DEST__LIF__XL_FGID;
    }
...
static shr_error_e
jr2_a0_dnx_data_l2_feature_no_black_hole_for_unknown_destination_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l2;
    int submodule_index = dnx_data_l2_submodule_feature;
    int feature_index = dnx_data_l2_feature_no_black_hole_for_unknown_destination;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_l2_feature_accepted_data_with_vmv_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l2;
...
static shr_error_e
jr2_a0_dnx_data_l2_olp_olp_learning_block_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_l2;
    int submodule_index = dnx_data_l2_submodule_olp;
    int define_index = dnx_data_l2_olp_define_olp_learning_block_id;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_l2_olp_olp_fwd_block_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_l2;
    int submodule_index = dnx_data_l2_submodule_olp;
    int define_index = dnx_data_l2_olp_define_olp_fwd_block_id;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_l2_general_define_l2_add_get_apis_supported_flags;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_l2_general_l2_add_get_apis_supported_flags_set;
    ...
    data_index = dnx_data_l2_feature_no_black_hole_for_unknown_destination;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_l2_feature_no_black_hole_for_unknown_destination_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_l2_feature_accepted_data_with_vmv_set;
    ...
    data_index = dnx_data_l2_olp_define_olp_learning_block_id;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_l2_olp_olp_learning_block_id_set;
    data_index = dnx_data_l2_olp_define_olp_fwd_block_id;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_l2_olp_olp_fwd_block_id_set;
