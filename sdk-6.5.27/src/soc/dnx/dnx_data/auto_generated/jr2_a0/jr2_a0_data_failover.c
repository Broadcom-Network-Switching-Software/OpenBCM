...
static shr_error_e
jr2_a0_dnx_data_failover_path_select_ingress_mc_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_failover;
    int submodule_index = dnx_data_failover_submodule_path_select;
    int define_index = dnx_data_failover_path_select_define_ingress_mc_size;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_failover_path_select_ing_mc_no_protection_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_failover;
    int submodule_index = dnx_data_failover_submodule_path_select;
    int define_index = dnx_data_failover_path_select_define_ing_mc_no_protection;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_failover_path_select_nof_fec_path_select_banks_in_hw_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_failover;
    int submodule_index = dnx_data_failover_submodule_path_select;
    int define_index = dnx_data_failover_path_select_define_nof_fec_path_select_banks_in_hw;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_failover_facility_wcmp_facility_protection_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_failover;
    int submodule_index = dnx_data_failover_submodule_facility;
    int feature_index = dnx_data_failover_facility_wcmp_facility_protection_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_failover_facility_protection_any_hierarchy_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_failover;
    int submodule_index = dnx_data_failover_submodule_facility;
    int feature_index = dnx_data_failover_facility_protection_any_hierarchy_supported;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_failover_path_select_define_ingress_mc_size;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_failover_path_select_ingress_mc_size_set;
    ...
    data_index = dnx_data_failover_path_select_define_ing_mc_no_protection;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_failover_path_select_ing_mc_no_protection_set;
    ...
    data_index = dnx_data_failover_path_select_define_nof_fec_path_select_banks_in_hw;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_failover_path_select_nof_fec_path_select_banks_in_hw_set;
    ...
    data_index = dnx_data_failover_facility_wcmp_facility_protection_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_failover_facility_wcmp_facility_protection_supported_set;
    ...
    data_index = dnx_data_failover_facility_protection_any_hierarchy_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_failover_facility_protection_any_hierarchy_supported_set;
