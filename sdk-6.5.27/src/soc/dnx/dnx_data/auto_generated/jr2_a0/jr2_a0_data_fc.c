...
static shr_error_e
jr2_a0_dnx_data_fc_general_is_used_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_fc;
...
static shr_error_e
jr2_a0_dnx_data_fc_general_pass_control_frames_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_fc;
...
static shr_error_e
jr2_a0_dnx_data_fc_general_pfc_remapping_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_fc;
    int submodule_index = dnx_data_fc_submodule_general;
    int feature_index = dnx_data_fc_general_pfc_remapping;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_fc_general_pfc_to_stop_pm_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_fc;
...
static shr_error_e
jr2_a0_dnx_data_fc_pfc_deadlock_nof_bits_in_port_num_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_fc;
    ...
    int unit)
{
    ...
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_fc_general_is_used_set;
    data_index = dnx_data_fc_general_pass_control_frames_support;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_fc_general_pass_control_frames_support_set;
    data_index = dnx_data_fc_general_pfc_remapping;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_fc_general_pfc_remapping_set;
    data_index = dnx_data_fc_general_pfc_to_stop_pm_support;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_fc_general_pfc_to_stop_pm_support_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_fc_pfc_deadlock_nof_bits_in_port_num_set;
