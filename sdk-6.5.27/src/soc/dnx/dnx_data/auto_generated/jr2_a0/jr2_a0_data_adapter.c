...
static shr_error_e
jr2_a0_dnx_data_adapter_mdb_debug_signals_dest_mapping_set(
    int unit)
{
    int index_index;
    dnx_data_adapter_mdb_debug_signals_dest_mapping_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnx_data_module_adapter;
    int submodule_index = dnx_data_adapter_submodule_mdb;
    int table_index = dnx_data_adapter_mdb_table_debug_signals_dest_mapping;
    SHR_FUNC_INIT_VARS(unit);
    ...
    table->values[0].default_val = "NotFound";
    table->values[1].default_val = "NotFound";
    table->values[2].default_val = "NotFound";
    table->values[3].default_val = "NotFound";
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_adapter_mdb_debug_signals_dest_mapping_t, (1 * (table->keys[0].size) + 1  ), "data of dnx_data_adapter_mdb_table_debug_signals_dest_mapping");

    
    default_data = (dnx_data_adapter_mdb_debug_signals_dest_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    default_data->key_signal_name = "NotFound";
    default_data->signal_name = "NotFound";
    default_data->from = "NotFound";
    default_data->to = "NotFound";
    
    for (index_index = 0; index_index < table->keys[0].size; index_index++)
    {
        data = (dnx_data_adapter_mdb_debug_signals_dest_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, index_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
    
    if (0 < table->keys[0].size)
    {
        data = (dnx_data_adapter_mdb_debug_signals_dest_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 0, 0);
        data->key_signal_name = "direct_key_0";
        data->signal_name = "Key";
        data->to = "DE0";
    }
    if (1 < table->keys[0].size)
    {
        data = (dnx_data_adapter_mdb_debug_signals_dest_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 1, 0);
        data->key_signal_name = "direct_key_1";
        data->signal_name = "Key";
        data->to = "DE1";
    }
    if (2 < table->keys[0].size)
    {
        data = (dnx_data_adapter_mdb_debug_signals_dest_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 2, 0);
        data->key_signal_name = "direct_appdb_0";
        data->signal_name = "Appdb";
        data->to = "DE0";
    }
    if (3 < table->keys[0].size)
    {
        data = (dnx_data_adapter_mdb_debug_signals_dest_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 3, 0);
        data->key_signal_name = "direct_appdb_1";
        data->signal_name = "Appdb";
        data->to = "DE1";
    }
    ...
    int unit)
{
    ...
    data_index = dnx_data_adapter_mdb_table_debug_signals_dest_mapping;
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_adapter_mdb_debug_signals_dest_mapping_set;
