...
static shr_error_e
jr2_a0_dnx_data_sch_flow_nof_low_rate_ranges_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_sch;
    int submodule_index = dnx_data_sch_submodule_flow;
    int define_index = dnx_data_sch_flow_define_nof_low_rate_ranges;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_sch_flow_nof_low_rate_regions_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_sch;
    int submodule_index = dnx_data_sch_submodule_flow;
    int define_index = dnx_data_sch_flow_define_nof_low_rate_regions;
    SHR_FUNC_INIT_VARS(unit);

    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    
    define->default_data = dnx_data_sch.flow.nof_connectors_only_regions_get(unit);

    
    define->data = dnx_data_sch.flow.nof_connectors_only_regions_get(unit);
...
static shr_error_e
jr2_a0_dnx_data_sch_flow_low_rate_pattern_mask_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_sch;
    int submodule_index = dnx_data_sch_submodule_flow;
    int define_index = dnx_data_sch_flow_define_low_rate_pattern_mask;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_sch_flow_low_rate_flow_resolution_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_sch;
    int submodule_index = dnx_data_sch_submodule_flow;
    int define_index = dnx_data_sch_flow_define_low_rate_flow_resolution;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_sch_flow_define_nof_low_rate_ranges;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_sch_flow_nof_low_rate_ranges_set;
    data_index = dnx_data_sch_flow_define_nof_low_rate_regions;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_sch_flow_nof_low_rate_regions_set;
    data_index = dnx_data_sch_flow_define_low_rate_pattern_mask;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_sch_flow_low_rate_pattern_mask_set;
    data_index = dnx_data_sch_flow_define_low_rate_flow_resolution;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_sch_flow_low_rate_flow_resolution_set;
