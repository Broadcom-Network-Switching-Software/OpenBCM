...
static shr_error_e
jr2_a0_dnx_data_trap_general_use_rx_trap_map_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
    int submodule_index = dnx_data_trap_submodule_general;
    int feature_index = dnx_data_trap_general_use_rx_trap_map;
...
static shr_error_e
jr2_a0_dnx_data_trap_ingress_support_code_clear_configurable_code_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
    int submodule_index = dnx_data_trap_submodule_ingress;
    int feature_index = dnx_data_trap_ingress_support_code_clear_configurable_code;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_trap_ingress_bypass_filtering_action_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
    int submodule_index = dnx_data_trap_submodule_ingress;
    int feature_index = dnx_data_trap_ingress_bypass_filtering_action;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_trap_ingress_tcp_frag_offset_lt8_trap_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
    int submodule_index = dnx_data_trap_submodule_ingress;
    int feature_index = dnx_data_trap_ingress_tcp_frag_offset_lt8_trap_support;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_trap_ingress_eth_trap_vec_mapping_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
    int submodule_index = dnx_data_trap_submodule_ingress;
    int feature_index = dnx_data_trap_ingress_eth_trap_vec_mapping_support;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_trap_ingress_support_fabric_header_set_action_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
    int submodule_index = dnx_data_trap_submodule_ingress;
    int feature_index = dnx_data_trap_ingress_support_fabric_header_set_action;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_trap_ingress_support_update_exem_learn_action_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
    int submodule_index = dnx_data_trap_submodule_ingress;
    int feature_index = dnx_data_trap_ingress_support_update_exem_learn_action;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_trap_ingress_support_update_trunk_members_action_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
    int submodule_index = dnx_data_trap_submodule_ingress;
    int feature_index = dnx_data_trap_ingress_support_update_trunk_members_action;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_trap_ingress_ipv4_fragmented_trap_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
    int submodule_index = dnx_data_trap_submodule_ingress;
    int feature_index = dnx_data_trap_ingress_ipv4_fragmented_trap_support;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_trap_ingress_arp_reply_trap_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
    int submodule_index = dnx_data_trap_submodule_ingress;
    int feature_index = dnx_data_trap_ingress_arp_reply_trap_support;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_trap_ingress_max_legal_predefined_trap_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_trap;
    int submodule_index = dnx_data_trap_submodule_ingress;
    int define_index = dnx_data_trap_ingress_define_max_legal_predefined_trap_id;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_trap_ingress_nof_user_defined_traps_in_jr1_mode_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_trap;
    int submodule_index = dnx_data_trap_submodule_ingress;
    int define_index = dnx_data_trap_ingress_define_nof_user_defined_traps_in_jr1_mode;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_trap_etpp_visibility_trap_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
    int submodule_index = dnx_data_trap_submodule_etpp;
    int feature_index = dnx_data_trap_etpp_visibility_trap_support;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_trap_etpp_oam_traps_predefined_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
    int submodule_index = dnx_data_trap_submodule_etpp;
    int feature_index = dnx_data_trap_etpp_oam_traps_predefined_support;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_trap_etpp_mtu_trap_action_profile_indirection_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
    int submodule_index = dnx_data_trap_submodule_etpp;
    int feature_index = dnx_data_trap_etpp_mtu_trap_action_profile_indirection;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_trap_etpp_mtu_layer_to_compressed_layer_mapping_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
    int submodule_index = dnx_data_trap_submodule_etpp;
    int feature_index = dnx_data_trap_etpp_mtu_layer_to_compressed_layer_mapping_support;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_trap_etpp_mtu_context_enable_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
    int submodule_index = dnx_data_trap_submodule_etpp;
    int feature_index = dnx_data_trap_etpp_mtu_context_enable_support;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_trap_etpp_latency_trap_mirror_config_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
    int submodule_index = dnx_data_trap_submodule_etpp;
    int feature_index = dnx_data_trap_etpp_latency_trap_mirror_config_support;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_trap_etpp_stack_trap_etps_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
    int submodule_index = dnx_data_trap_submodule_etpp;
    int feature_index = dnx_data_trap_etpp_stack_trap_etps_support;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_trap_etpp_fabric_ptp_trap_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
    int submodule_index = dnx_data_trap_submodule_etpp;
    int feature_index = dnx_data_trap_etpp_fabric_ptp_trap_support;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_trap_etpp_deep_editing_trap_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
    int submodule_index = dnx_data_trap_submodule_etpp;
    int feature_index = dnx_data_trap_etpp_deep_editing_trap_support;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_trap_etpp_ffc_out_of_bound_trap_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
    int submodule_index = dnx_data_trap_submodule_etpp;
    int feature_index = dnx_data_trap_etpp_ffc_out_of_bound_trap_support;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_trap_etpp_first_etpp_user_configurable_profile_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_trap;
    int submodule_index = dnx_data_trap_submodule_etpp;
    int define_index = dnx_data_trap_etpp_define_first_etpp_user_configurable_profile;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_trap_etpp_nof_mtu_trap_action_profiles_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_trap;
    int submodule_index = dnx_data_trap_submodule_etpp;
    int define_index = dnx_data_trap_etpp_define_nof_mtu_trap_action_profiles;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_trap_etpp_nof_mtu_map_table_entries_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_trap;
    int submodule_index = dnx_data_trap_submodule_etpp;
    int define_index = dnx_data_trap_etpp_define_nof_mtu_map_table_entries;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    submodule_index = dnx_data_trap_submodule_general;
    submodule = &module->submodules[submodule_index];

    

    
    data_index = dnx_data_trap_general_use_rx_trap_map;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_trap_general_use_rx_trap_map_set;
    ...
    data_index = dnx_data_trap_ingress_define_max_legal_predefined_trap_id;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_trap_ingress_max_legal_predefined_trap_id_set;
    ...
    data_index = dnx_data_trap_ingress_define_nof_user_defined_traps_in_jr1_mode;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_trap_ingress_nof_user_defined_traps_in_jr1_mode_set;
    ...
    data_index = dnx_data_trap_ingress_support_code_clear_configurable_code;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_trap_ingress_support_code_clear_configurable_code_set;
    data_index = dnx_data_trap_ingress_bypass_filtering_action;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_trap_ingress_bypass_filtering_action_set;
    ...
    data_index = dnx_data_trap_ingress_tcp_frag_offset_lt8_trap_support;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_trap_ingress_tcp_frag_offset_lt8_trap_support_set;
    data_index = dnx_data_trap_ingress_eth_trap_vec_mapping_support;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_trap_ingress_eth_trap_vec_mapping_support_set;
    data_index = dnx_data_trap_ingress_support_fabric_header_set_action;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_trap_ingress_support_fabric_header_set_action_set;
    data_index = dnx_data_trap_ingress_support_update_exem_learn_action;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_trap_ingress_support_update_exem_learn_action_set;
    data_index = dnx_data_trap_ingress_support_update_trunk_members_action;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_trap_ingress_support_update_trunk_members_action_set;
    data_index = dnx_data_trap_ingress_ipv4_fragmented_trap_support;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_trap_ingress_ipv4_fragmented_trap_support_set;
    data_index = dnx_data_trap_ingress_arp_reply_trap_support;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_trap_ingress_arp_reply_trap_support_set;
    ...
    data_index = dnx_data_trap_etpp_define_first_etpp_user_configurable_profile;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_trap_etpp_first_etpp_user_configurable_profile_set;
    ...
    data_index = dnx_data_trap_etpp_define_nof_mtu_trap_action_profiles;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_trap_etpp_nof_mtu_trap_action_profiles_set;
    data_index = dnx_data_trap_etpp_define_nof_mtu_map_table_entries;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_trap_etpp_nof_mtu_map_table_entries_set;

    
    data_index = dnx_data_trap_etpp_glem_hw_support;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_trap_etpp_glem_hw_support_set;
    data_index = dnx_data_trap_etpp_visibility_trap_support;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_trap_etpp_visibility_trap_support_set;
    data_index = dnx_data_trap_etpp_oam_traps_predefined_support;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_trap_etpp_oam_traps_predefined_support_set;
    data_index = dnx_data_trap_etpp_mtu_trap_action_profile_indirection;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_trap_etpp_mtu_trap_action_profile_indirection_set;
    data_index = dnx_data_trap_etpp_mtu_layer_to_compressed_layer_mapping_support;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_trap_etpp_mtu_layer_to_compressed_layer_mapping_support_set;
    data_index = dnx_data_trap_etpp_mtu_context_enable_support;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_trap_etpp_mtu_context_enable_support_set;
    data_index = dnx_data_trap_etpp_latency_trap_mirror_config_support;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_trap_etpp_latency_trap_mirror_config_support_set;
    data_index = dnx_data_trap_etpp_stack_trap_etps_support;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_trap_etpp_stack_trap_etps_support_set;
    data_index = dnx_data_trap_etpp_fabric_ptp_trap_support;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_trap_etpp_fabric_ptp_trap_support_set;
    data_index = dnx_data_trap_etpp_deep_editing_trap_support;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_trap_etpp_deep_editing_trap_support_set;
    data_index = dnx_data_trap_etpp_ffc_out_of_bound_trap_support;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_trap_etpp_ffc_out_of_bound_trap_support_set;
