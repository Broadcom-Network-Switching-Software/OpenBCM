...
static shr_error_e
jr2_a0_dnx_data_mdb_global_mdb_access_version_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_mdb;
    int submodule_index = dnx_data_mdb_submodule_global;
    int feature_index = dnx_data_mdb_global_mdb_access_version;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_mdb_dh_macro_global_indexes_set(
    int unit)
{
    dnx_data_mdb_dh_macro_global_indexes_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnx_data_module_mdb;
    int submodule_index = dnx_data_mdb_submodule_dh;
    int table_index = dnx_data_mdb_dh_table_macro_global_indexes;
    SHR_FUNC_INIT_VARS(unit);
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_mdb_dh_macro_global_indexes_t, (1 + 1  ), "data of dnx_data_mdb_dh_table_macro_global_indexes");

    
    default_data = (dnx_data_mdb_dh_macro_global_indexes_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    default_data->is_valid[0] = 0;
    default_data->total_nof_active_macroes = 0;
    
    data = (dnx_data_mdb_dh_macro_global_indexes_t *) dnxc_data_mgmt_table_data_get(unit, table, 0, 0);
    sal_memcpy(data, default_data, table->size_of_values);
    
    data = (dnx_data_mdb_dh_macro_global_indexes_t *) dnxc_data_mgmt_table_data_get(unit, table, 0, 0);
    data->is_valid[0] = 0x000FFFFF;
    data->is_valid[1] = 0x00000000;
    data->total_nof_active_macroes = 20;
...
static shr_error_e
jr2_a0_dnx_data_mdb_pdbs_table_mdb_kaps_dynamic_memory_access_memory_access_field_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_mdb;
...
static shr_error_e
jr2_a0_dnx_data_mdb_pdbs_table_mdb_ddha_dynamic_memory_access_memory_access_field_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_mdb;
    ...
    int unit)
{
    ...
    if (DBAL_PHYSICAL_TABLE_FLP_LARGE_TCAM < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_dbal_pdb_info_t *) dnxc_data_mgmt_table_data_get(unit, table, DBAL_PHYSICAL_TABLE_FLP_LARGE_TCAM, 0);
        data->logical_to_physical = MDB_NOF_PHYSICAL_TABLES;
        data->db_type = DBAL_ENUM_FVAL_MDB_DB_TYPE_NONE;
        data->db_subtype = 0;
    ...
    int unit)
{
    ...
    if (DBAL_PHYSICAL_TABLE_FLP_LARGE_TCAM < table->keys[0].size)
    {
        data = (dnx_data_mdb_pdbs_mdb_adapter_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, DBAL_PHYSICAL_TABLE_FLP_LARGE_TCAM, 0);
        data->mdb_type = 0;
        data->memory_id = 0;
    }
    if (DBAL_PHYSICAL_TABLE_KAPS_1 < table->keys[0].size)
...
static shr_error_e
jr2_a0_dnx_data_mdb_em_compare_size_set(
    int unit)
{
...
static shr_error_e
jr2_a0_dnx_data_mdb_kaps_mdb_lpm_blackhole_mode_enable_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_mdb;
    int submodule_index = dnx_data_mdb_submodule_kaps;
    int define_index = dnx_data_mdb_kaps_define_mdb_lpm_blackhole_mode_enable;
    SHR_FUNC_INIT_VARS(unit);
    ...
    define->property.method = dnxc_data_property_method_suffix_enable;
    define->property.method_str = "suffix_enable";
    define->property.suffix = "mdb_lpm_blackhole_mode_enable";
    ...
    int unit)
{
    ...
    data_index = dnx_data_mdb_global_mdb_access_version;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_mdb_global_mdb_access_version_set;
    ...
    data_index = dnx_data_mdb_dh_table_macro_global_indexes;
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_mdb_dh_macro_global_indexes_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_mdb_pdbs_table_mdb_kaps_dynamic_memory_access_memory_access_field_size_set;
    data_index = dnx_data_mdb_pdbs_define_table_mdb_ddha_dynamic_memory_access_memory_access_field_size;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_mdb_pdbs_table_mdb_ddha_dynamic_memory_access_memory_access_field_size_set;
    ...
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_mdb_em_compare_size_set;
    ...
    data_index = dnx_data_mdb_kaps_define_mdb_lpm_blackhole_mode_enable;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_mdb_kaps_mdb_lpm_blackhole_mode_enable_set;
