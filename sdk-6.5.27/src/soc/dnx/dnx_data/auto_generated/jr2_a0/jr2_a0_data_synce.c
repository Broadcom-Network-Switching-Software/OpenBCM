...
static shr_error_e
jr2_a0_dnx_data_synce_general_nof_synce_type_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_synce;
    int submodule_index = dnx_data_synce_submodule_general;
    int define_index = dnx_data_synce_general_define_nof_synce_type;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_synce_general_define_nof_synce_type;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_synce_general_nof_synce_type_set;
