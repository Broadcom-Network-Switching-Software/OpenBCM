...
static shr_error_e
jr2_a0_dnx_data_fabric_general_measure_down_port_with_rx_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_fabric;
...
static shr_error_e
jr2_a0_dnx_data_fabric_cell_sr_cell_rx_fifo_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_fabric;
    int submodule_index = dnx_data_fabric_submodule_cell;
    int define_index = dnx_data_fabric_cell_define_sr_cell_rx_fifo_size;
    SHR_FUNC_INIT_VARS(unit);

    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    
    define->default_data = 585;
...
static shr_error_e
jr2_a0_dnx_data_fabric_cell_sr_cell_data_valid_offset_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_fabric;
    int submodule_index = dnx_data_fabric_submodule_cell;
    int define_index = dnx_data_fabric_cell_define_sr_cell_data_valid_offset;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_fabric_cell_sr_cell_rx_parsing_table_set(
    int unit)
{
    int index_index;
    dnx_data_fabric_cell_sr_cell_rx_parsing_table_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnx_data_module_fabric;
    int submodule_index = dnx_data_fabric_submodule_cell;
    int table_index = dnx_data_fabric_cell_table_sr_cell_rx_parsing_table;
    SHR_FUNC_INIT_VARS(unit);
    ...
    table->values[0].default_val = "soc_dnxc_fabric_cell_field_invalid";
    table->values[1].default_val = "0";
    table->values[2].default_val = "-1";
    table->values[3].default_val = "-1";
    table->values[4].default_val = "INVALID";
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_fabric_cell_sr_cell_rx_parsing_table_t, (1 * (table->keys[0].size) + 1  ), "data of dnx_data_fabric_cell_table_sr_cell_rx_parsing_table");

    
    default_data = (dnx_data_fabric_cell_sr_cell_rx_parsing_table_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    default_data->dest_id = soc_dnxc_fabric_cell_field_invalid;
    default_data->dest_start_bit = 0;
    default_data->src_start_bit = -1;
    default_data->length = -1;
    default_data->field_name = "INVALID";
    
    for (index_index = 0; index_index < table->keys[0].size; index_index++)
    {
        data = (dnx_data_fabric_cell_sr_cell_rx_parsing_table_t *) dnxc_data_mgmt_table_data_get(unit, table, index_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
    
    if (0 < table->keys[0].size)
    {
        data = (dnx_data_fabric_cell_sr_cell_rx_parsing_table_t *) dnxc_data_mgmt_table_data_get(unit, table, 0, 0);
        data->dest_id = soc_dnxc_fabric_cell_field_cell_type;
        data->dest_start_bit = 0;
        data->src_start_bit = 583;
        data->length = 2;
        data->field_name = "CELL_TYPE";
    }
    if (1 < table->keys[0].size)
    {
        data = (dnx_data_fabric_cell_sr_cell_rx_parsing_table_t *) dnxc_data_mgmt_table_data_get(unit, table, 1, 0);
        data->dest_id = soc_dnxc_fabric_cell_field_src_device;
        data->dest_start_bit = 0;
        data->src_start_bit = 555;
        data->length = 11;
        data->field_name = "SOURCE_DEVICE";
    }
    if (2 < table->keys[0].size)
    {
        data = (dnx_data_fabric_cell_sr_cell_rx_parsing_table_t *) dnxc_data_mgmt_table_data_get(unit, table, 2, 0);
        data->dest_id = soc_dnxc_fabric_cell_field_src_level;
        data->dest_start_bit = 0;
        data->src_start_bit = 552;
        data->length = 3;
        data->field_name = "SOURCE_LEVEL";
    }
    if (3 < table->keys[0].size)
    {
        data = (dnx_data_fabric_cell_sr_cell_rx_parsing_table_t *) dnxc_data_mgmt_table_data_get(unit, table, 3, 0);
        data->dest_id = soc_dnxc_fabric_cell_field_dest_level;
        data->dest_start_bit = 0;
        data->src_start_bit = 549;
        data->length = 3;
        data->field_name = "DEST_LEVEL";
    }
    if (4 < table->keys[0].size)
    {
        data = (dnx_data_fabric_cell_sr_cell_rx_parsing_table_t *) dnxc_data_mgmt_table_data_get(unit, table, 4, 0);
        data->dest_id = soc_dnxc_fabric_cell_field_fip;
        data->dest_start_bit = 0;
        data->src_start_bit = 544;
        data->length = 5;
        data->field_name = "FIP[0:4]";
    }
    if (5 < table->keys[0].size)
    {
        data = (dnx_data_fabric_cell_sr_cell_rx_parsing_table_t *) dnxc_data_mgmt_table_data_get(unit, table, 5, 0);
        data->dest_id = soc_dnxc_fabric_cell_field_fip;
        data->dest_start_bit = 5;
        data->src_start_bit = 527;
        data->length = 1;
        data->field_name = "FIP[5]";
    }
    if (6 < table->keys[0].size)
    {
        data = (dnx_data_fabric_cell_sr_cell_rx_parsing_table_t *) dnxc_data_mgmt_table_data_get(unit, table, 6, 0);
        data->dest_id = soc_dnxc_fabric_cell_field_fe1;
        data->dest_start_bit = 0;
        data->src_start_bit = 539;
        data->length = 5;
        data->field_name = "FE1[0:4]";
    }
    if (7 < table->keys[0].size)
    {
        data = (dnx_data_fabric_cell_sr_cell_rx_parsing_table_t *) dnxc_data_mgmt_table_data_get(unit, table, 7, 0);
        data->dest_id = soc_dnxc_fabric_cell_field_fe1;
        data->dest_start_bit = 5;
        data->src_start_bit = 526;
        data->length = 1;
        data->field_name = "FE1[5]";
    }
    if (8 < table->keys[0].size)
    {
        data = (dnx_data_fabric_cell_sr_cell_rx_parsing_table_t *) dnxc_data_mgmt_table_data_get(unit, table, 8, 0);
        data->dest_id = soc_dnxc_fabric_cell_field_fe1;
        data->dest_start_bit = 6;
        data->src_start_bit = 569;
        data->length = 2;
        data->field_name = "FE1[6:7]";
    }
    if (9 < table->keys[0].size)
    {
        data = (dnx_data_fabric_cell_sr_cell_rx_parsing_table_t *) dnxc_data_mgmt_table_data_get(unit, table, 9, 0);
        data->dest_id = soc_dnxc_fabric_cell_field_fe2;
        data->dest_start_bit = 0;
        data->src_start_bit = 533;
        data->length = 6;
        data->field_name = "FE2[0:5]";
    }
    if (10 < table->keys[0].size)
    {
        data = (dnx_data_fabric_cell_sr_cell_rx_parsing_table_t *) dnxc_data_mgmt_table_data_get(unit, table, 10, 0);
        data->dest_id = soc_dnxc_fabric_cell_field_fe2;
        data->dest_start_bit = 6;
        data->src_start_bit = 525;
        data->length = 1;
        data->field_name = "FE2[6]";
    }
    if (11 < table->keys[0].size)
    {
        data = (dnx_data_fabric_cell_sr_cell_rx_parsing_table_t *) dnxc_data_mgmt_table_data_get(unit, table, 11, 0);
        data->dest_id = soc_dnxc_fabric_cell_field_fe2;
        data->dest_start_bit = 7;
        data->src_start_bit = 568;
        data->length = 1;
        data->field_name = "FE2[7]";
    }
    if (12 < table->keys[0].size)
    {
        data = (dnx_data_fabric_cell_sr_cell_rx_parsing_table_t *) dnxc_data_mgmt_table_data_get(unit, table, 12, 0);
        data->dest_id = soc_dnxc_fabric_cell_field_fe3;
        data->dest_start_bit = 0;
        data->src_start_bit = 528;
        data->length = 5;
        data->field_name = "FE3[0:4]";
    }
    if (13 < table->keys[0].size)
    {
        data = (dnx_data_fabric_cell_sr_cell_rx_parsing_table_t *) dnxc_data_mgmt_table_data_get(unit, table, 13, 0);
        data->dest_id = soc_dnxc_fabric_cell_field_fe3;
        data->dest_start_bit = 5;
        data->src_start_bit = 524;
        data->length = 1;
        data->field_name = "FE3[5]";
    }
    if (14 < table->keys[0].size)
    {
        data = (dnx_data_fabric_cell_sr_cell_rx_parsing_table_t *) dnxc_data_mgmt_table_data_get(unit, table, 14, 0);
        data->dest_id = soc_dnxc_fabric_cell_field_fe3;
        data->dest_start_bit = 6;
        data->src_start_bit = 566;
        data->length = 2;
        data->field_name = "FE3[6:7]";
    }
    if (15 < table->keys[0].size)
    {
        data = (dnx_data_fabric_cell_sr_cell_rx_parsing_table_t *) dnxc_data_mgmt_table_data_get(unit, table, 15, 0);
        data->dest_id = soc_dnxc_fabric_cell_field_is_inband;
        data->dest_start_bit = 0;
        data->src_start_bit = 523;
        data->length = 1;
        data->field_name = "IS_INBAND";
    }
    if (16 < table->keys[0].size)
    {
        data = (dnx_data_fabric_cell_sr_cell_rx_parsing_table_t *) dnxc_data_mgmt_table_data_get(unit, table, 16, 0);
        data->dest_id = soc_dnxc_fabric_cell_field_pipe_id;
        data->dest_start_bit = 0;
        data->src_start_bit = 571;
        data->length = 3;
        data->field_name = "PIPE_ID";
    }
    if (17 < table->keys[0].size)
    {
        data = (dnx_data_fabric_cell_sr_cell_rx_parsing_table_t *) dnxc_data_mgmt_table_data_get(unit, table, 17, 0);
        data->dest_id = soc_dnxc_fabric_cell_field_payload;
        data->dest_start_bit = 0;
        data->src_start_bit = 0;
        data->length = 512;
        data->field_name = "PAYLOAD";
    }
    if (18 < table->keys[0].size)
    {
        data = (dnx_data_fabric_cell_sr_cell_rx_parsing_table_t *) dnxc_data_mgmt_table_data_get(unit, table, 18, 0);
        data->dest_id = soc_dnxc_fabric_cell_field_invalid;
        data->dest_start_bit = 0;
        data->src_start_bit = -1;
        data->length = -1;
    }
...
static shr_error_e
jr2_a0_dnx_data_fabric_debug_mesh_topology_replication_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_fabric;
    int submodule_index = dnx_data_fabric_submodule_debug;
    int feature_index = dnx_data_fabric_debug_mesh_topology_replication;
    SHR_FUNC_INIT_VARS(unit);
    ...
    feature->property.method = dnxc_data_property_method_suffix_enable;
    feature->property.method_str = "suffix_enable";
    feature->property.suffix = "mesh_topology_replication";
    SHR_IF_ERR_EXIT(dnxc_data_mgmt_property_read(unit, &feature->property, -1, &feature->data));
    ...
    int unit)
{
    ...
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_fabric_general_measure_down_port_with_rx_supported_set;
    ...
    data_index = dnx_data_fabric_cell_define_sr_cell_rx_fifo_size;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_fabric_cell_sr_cell_rx_fifo_size_set;
    data_index = dnx_data_fabric_cell_define_sr_cell_data_valid_offset;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_fabric_cell_sr_cell_data_valid_offset_set;
    ...
    data_index = dnx_data_fabric_cell_table_sr_cell_rx_parsing_table;
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_fabric_cell_sr_cell_rx_parsing_table_set;
    ...
    data_index = dnx_data_fabric_debug_mesh_topology_replication;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_fabric_debug_mesh_topology_replication_set;
