...
static shr_error_e
jr2_a0_dnx_data_dev_init_time_init_total_time_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
jr2_a0_dnx_data_dev_init_time_appl_init_total_time_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
jr2_a0_dnx_data_dev_init_time_down_deviation_total_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
jr2_a0_dnx_data_dev_init_time_up_deviation_total_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
jr2_a0_dnx_data_dev_init_time_test_sensitivity_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
jr2_a0_dnx_data_dev_init_time_step_time_set(
    int unit)
{
    int step_id_index;
    ...
    {
        data = (dnx_data_dev_init_time_step_time_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_INIT_STEP_SW_STATE_GENERAL, 0);
        data->time = 282000;
    }
...
static shr_error_e
jr2_a0_dnx_data_dev_init_time_appl_step_time_set(
    int unit)
{
    int step_id_index;
    ...
    {
        data = (dnx_data_dev_init_time_appl_step_time_t *) dnxc_data_mgmt_table_data_get(unit, table, APPL_DNX_STEP_FP_OAM_INDEX, 0);
        data->time = 409332;
    }
    ...
    {
        data = (dnx_data_dev_init_time_appl_step_time_t *) dnxc_data_mgmt_table_data_get(unit, table, APPL_DNX_STEP_INTERRUPT, 0);
        data->time = 53274;
    }
    ...
    {
        data = (dnx_data_dev_init_time_appl_step_time_t *) dnxc_data_mgmt_table_data_get(unit, table, APPL_DNX_STEP_OAM, 0);
        data->time = 223471;
    }
    ...
    {
        data = (dnx_data_dev_init_time_appl_step_time_t *) dnxc_data_mgmt_table_data_get(unit, table, APPL_DNX_STEP_FP_APPS, 0);
        data->time = 443840;
    }
    ...
    if (APPL_DNX_STEP_ITMH < table->keys[0].size)
    {
        data = (dnx_data_dev_init_time_appl_step_time_t *) dnxc_data_mgmt_table_data_get(unit, table, APPL_DNX_STEP_ITMH, 0);
        data->time = 495397;
    }
...
static shr_error_e
jr2_a0_dnx_data_dev_init_general_multithreading_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_dev_init;
    int submodule_index = dnx_data_dev_init_submodule_general;
    int feature_index = dnx_data_dev_init_general_multithreading;
    SHR_FUNC_INIT_VARS(unit);
    ...
    feature->property.suffix = "multithread_en";
...
static shr_error_e
jr2_a0_dnx_data_dev_init_general_egress_estimated_bta_btr_hw_config_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
jr2_a0_dnx_data_dev_init_general_outlif_intf_hw_config_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_dev_init;
    int submodule_index = dnx_data_dev_init_submodule_general;
    int feature_index = dnx_data_dev_init_general_outlif_intf_hw_config;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_dev_init_general_outlif_group_hw_config_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_dev_init;
    int submodule_index = dnx_data_dev_init_submodule_general;
    int feature_index = dnx_data_dev_init_general_outlif_group_hw_config;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_dev_init_general_application_v1_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_dev_init;
    int submodule_index = dnx_data_dev_init_submodule_general;
    int feature_index = dnx_data_dev_init_general_application_v1;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_dev_init_general_application_v2_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_dev_init;
    int submodule_index = dnx_data_dev_init_submodule_general;
    int feature_index = dnx_data_dev_init_general_application_v2;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_dev_init_general_erpp_threshold_prp_per_port_info_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
jr2_a0_dnx_data_dev_init_general_ippe_sync_counter_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
jr2_a0_dnx_data_dev_init_general_fai_namespace_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_dev_init;
    int submodule_index = dnx_data_dev_init_submodule_general;
    int feature_index = dnx_data_dev_init_general_fai_namespace;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_dev_init_general_rch_remove_field_program_enable_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_dev_init;
    int submodule_index = dnx_data_dev_init_submodule_general;
    int feature_index = dnx_data_dev_init_general_rch_remove_field_program_enable;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_dev_init_general_mem_conf_test_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
jr2_a0_dnx_data_dev_init_general_is_pp_used_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
jr2_a0_dnx_data_dev_init_general_clock_power_down_set(
    int unit)
{
    int index_index;
...
static shr_error_e
jr2_a0_dnx_data_dev_init_context_etps_selection_profile_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
jr2_a0_dnx_data_dev_init_context_prp_pem_context_selection_mask_offset_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
jr2_a0_dnx_data_dev_init_context_prp_context_selection_result_offset_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
jr2_a0_dnx_data_dev_init_ha_sw_state_diagnostics_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_dev_init;
    int submodule_index = dnx_data_dev_init_submodule_ha;
    int feature_index = dnx_data_dev_init_ha_sw_state_diagnostics;
    SHR_FUNC_INIT_VARS(unit);
    ...
    feature->property.method = dnxc_data_property_method_suffix_enable;
    feature->property.method_str = "suffix_enable";
    feature->property.suffix = "sw_state_diagnostics";
    SHR_IF_ERR_EXIT(dnxc_data_mgmt_property_read(unit, &feature->property, -1, &feature->data));
    ...
    int unit)
{
    ...
    define->property.mapping[2].name = "auto-sync";
    ...
    int unit)
{
    ...
    if (!(define->data  <= dnx_data_dev_init.ha.stable_size_get(unit) || dnx_data_dev_init.ha.warmboot_support_get(unit) == 0))
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "Assert failed for:sw_state_max_size");
    }
    ...
    int unit)
{
    ...
    if (105 < table->keys[0].size)
    {
        ...
        data->mem = OAMP_SAT_RX_FLOW_PARAMSm;
    }
    if (106 < table->keys[0].size)
    {
...
static shr_error_e
jr2_a0_dnx_data_dev_init_shadow_uncacheable_regmem_set(
    int unit)
{
    int index_index;
...
static shr_error_e
jr2_a0_dnx_data_dev_init_rx_rx_pool_nof_pkts_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
    int submodule_index = dnx_data_dev_init_submodule_rx;
    int define_index = dnx_data_dev_init_rx_define_rx_pool_nof_pkts;
    SHR_FUNC_INIT_VARS(unit);

    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    
    define->default_data = BCM_RX_POOL_COUNT_DEFAULT;

    
    define->data = BCM_RX_POOL_COUNT_DEFAULT;

    
    define->flags |= DNXC_DATA_F_SUPPORTED;
    
    define->property.name = spn_RX_POOL_NOF_PKTS;
    define->property.doc = 
        "\n"
    ;
    define->property.method = dnxc_data_property_method_range;
    define->property.method_str = "range";
    define->property.range_min = 0;
    define->property.range_max = 1024;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_dev_init_time_init_total_time_set;
    data_index = dnx_data_dev_init_time_define_appl_init_total_time;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_dev_init_time_appl_init_total_time_set;
    data_index = dnx_data_dev_init_time_define_down_deviation_total;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_dev_init_time_down_deviation_total_set;
    data_index = dnx_data_dev_init_time_define_up_deviation_total;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_dev_init_time_up_deviation_total_set;
    data_index = dnx_data_dev_init_time_define_test_sensitivity;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_dev_init_time_test_sensitivity_set;
    ...
    table->set = jr2_a0_dnx_data_dev_init_time_step_time_set;
    data_index = dnx_data_dev_init_time_table_appl_step_time;
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_dev_init_time_appl_step_time_set;
    ...
    data_index = dnx_data_dev_init_general_multithreading;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_dev_init_general_multithreading_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_dev_init_general_egress_estimated_bta_btr_hw_config_set;
    data_index = dnx_data_dev_init_general_outlif_intf_hw_config;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_dev_init_general_outlif_intf_hw_config_set;
    data_index = dnx_data_dev_init_general_outlif_group_hw_config;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_dev_init_general_outlif_group_hw_config_set;
    data_index = dnx_data_dev_init_general_application_v1;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_dev_init_general_application_v1_set;
    data_index = dnx_data_dev_init_general_application_v2;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_dev_init_general_application_v2_set;
    data_index = dnx_data_dev_init_general_erpp_threshold_prp_per_port_info;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_dev_init_general_erpp_threshold_prp_per_port_info_set;
    data_index = dnx_data_dev_init_general_ippe_sync_counter;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_dev_init_general_ippe_sync_counter_set;
    data_index = dnx_data_dev_init_general_fai_namespace;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_dev_init_general_fai_namespace_set;
    data_index = dnx_data_dev_init_general_rch_remove_field_program_enable;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_dev_init_general_rch_remove_field_program_enable_set;
    data_index = dnx_data_dev_init_general_mem_conf_test;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_dev_init_general_mem_conf_test_set;
    data_index = dnx_data_dev_init_general_is_pp_used;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_dev_init_general_is_pp_used_set;

    
    data_index = dnx_data_dev_init_general_table_clock_power_down;
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_dev_init_general_clock_power_down_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_dev_init_context_prp_pem_context_selection_mask_offset_set;
    data_index = dnx_data_dev_init_context_define_prp_context_selection_result_offset;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_dev_init_context_prp_context_selection_result_offset_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_dev_init_context_etps_selection_profile_set;
    ...
    data_index = dnx_data_dev_init_ha_sw_state_diagnostics;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_dev_init_ha_sw_state_diagnostics_set;
    ...
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_dev_init_shadow_uncacheable_regmem_set;
    ...
    submodule_index = dnx_data_dev_init_submodule_rx;
    submodule = &module->submodules[submodule_index];

    
    data_index = dnx_data_dev_init_rx_define_rx_pool_nof_pkts;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_dev_init_rx_rx_pool_nof_pkts_set;
