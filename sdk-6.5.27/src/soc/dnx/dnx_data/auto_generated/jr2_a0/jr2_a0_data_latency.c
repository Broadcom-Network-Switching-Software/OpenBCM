...
static shr_error_e
jr2_a0_dnx_data_latency_ingress_nof_flow_profile_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_latency;
    int submodule_index = dnx_data_latency_submodule_ingress;
    int define_index = dnx_data_latency_ingress_define_nof_flow_profile;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_latency_ingress_define_nof_flow_profile;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_latency_ingress_nof_flow_profile_set;
