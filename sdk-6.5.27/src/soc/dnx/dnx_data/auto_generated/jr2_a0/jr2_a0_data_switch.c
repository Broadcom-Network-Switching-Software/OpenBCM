...
static shr_error_e
jr2_a0_dnx_data_switch_load_balancing_paser_seed_update_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_switch;
    int submodule_index = dnx_data_switch_submodule_load_balancing;
    int feature_index = dnx_data_switch_load_balancing_paser_seed_update_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_switch_load_balancing_ipv6_reparse_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_switch;
    int submodule_index = dnx_data_switch_submodule_load_balancing;
    int feature_index = dnx_data_switch_load_balancing_ipv6_reparse_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_switch_load_balancing_ipv6_unsymmetrical_hashing_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_switch;
    int submodule_index = dnx_data_switch_submodule_load_balancing;
    int feature_index = dnx_data_switch_load_balancing_ipv6_unsymmetrical_hashing_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_switch_load_balancing_cw_exclude_from_hash_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_switch;
...
static shr_error_e
jr2_a0_dnx_data_switch_load_balancing_swig_base_offline_simulation_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_switch;
    int submodule_index = dnx_data_switch_submodule_load_balancing;
    int define_index = dnx_data_switch_load_balancing_define_swig_base_offline_simulation;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_switch_load_balancing_pmf_simulation_support_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_switch;
    int submodule_index = dnx_data_switch_submodule_load_balancing;
    int define_index = dnx_data_switch_load_balancing_define_pmf_simulation_support;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_switch_feature_fwd1_default_result_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_switch;
    int submodule_index = dnx_data_switch_submodule_feature;
    int feature_index = dnx_data_switch_feature_fwd1_default_result_support;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_switch_wide_data_ext_key_by_global_ac_lif_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_switch;
    int submodule_index = dnx_data_switch_submodule_wide_data;
    int feature_index = dnx_data_switch_wide_data_ext_key_by_global_ac_lif;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_switch_wide_data_ext_key_by_global_eth_rif_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_switch;
    int submodule_index = dnx_data_switch_submodule_wide_data;
    int feature_index = dnx_data_switch_wide_data_ext_key_by_global_eth_rif;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_switch_wide_data_ext_key_by_data_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_switch;
    int submodule_index = dnx_data_switch_submodule_wide_data;
    int feature_index = dnx_data_switch_wide_data_ext_key_by_data;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_switch_load_balancing_define_swig_base_offline_simulation;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_switch_load_balancing_swig_base_offline_simulation_set;
    data_index = dnx_data_switch_load_balancing_define_pmf_simulation_support;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_switch_load_balancing_pmf_simulation_support_set;
    ...
    data_index = dnx_data_switch_load_balancing_paser_seed_update_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_switch_load_balancing_paser_seed_update_supported_set;
    data_index = dnx_data_switch_load_balancing_ipv6_reparse_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_switch_load_balancing_ipv6_reparse_supported_set;
    data_index = dnx_data_switch_load_balancing_ipv6_unsymmetrical_hashing_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_switch_load_balancing_ipv6_unsymmetrical_hashing_supported_set;
    data_index = dnx_data_switch_load_balancing_cw_exclude_from_hash;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_switch_load_balancing_cw_exclude_from_hash_set;
    ...
    data_index = dnx_data_switch_feature_fwd1_default_result_support;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_switch_feature_fwd1_default_result_support_set;

    
    
    submodule_index = dnx_data_switch_submodule_wide_data;
    submodule = &module->submodules[submodule_index];

    

    
    data_index = dnx_data_switch_wide_data_ext_key_by_global_ac_lif;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_switch_wide_data_ext_key_by_global_ac_lif_set;
    data_index = dnx_data_switch_wide_data_ext_key_by_global_eth_rif;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_switch_wide_data_ext_key_by_global_eth_rif_set;
    data_index = dnx_data_switch_wide_data_ext_key_by_data;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_switch_wide_data_ext_key_by_data_set;
