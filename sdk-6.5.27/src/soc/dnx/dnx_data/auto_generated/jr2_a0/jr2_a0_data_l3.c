    ...
    int unit)
{
    ...
    define->default_data = (dnx_data_l3.ecmp.nof_ecmp_get(unit) + dnx_data_l3.fec.bank_size_get(unit) - 1)/dnx_data_l3.fec.bank_size_get(unit);

    
    define->data = (dnx_data_l3.ecmp.nof_ecmp_get(unit) + dnx_data_l3.fec.bank_size_get(unit) - 1)/dnx_data_l3.fec.bank_size_get(unit);
    ...
    int unit)
{
    ...
    int module_index = dnx_data_module_l3;
    int submodule_index = dnx_data_l3_submodule_fec;
    int define_index = dnx_data_l3_fec_define_uneven_bank_sizes;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_l3_source_address_is_mymac_prefix_limitted_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_l3;
    int submodule_index = dnx_data_l3_submodule_source_address;
    int define_index = dnx_data_l3_source_address_define_is_mymac_prefix_limitted;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_l3_ecmp_cbts_implementation_using_field_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l3;
    int submodule_index = dnx_data_l3_submodule_ecmp;
    int feature_index = dnx_data_l3_ecmp_cbts_implementation_using_field_support;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_l3_feature_fec_rpf_protection_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l3;
    int submodule_index = dnx_data_l3_submodule_feature;
    int feature_index = dnx_data_l3_feature_fec_rpf_protection_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_l3_feature_mc_bridge_fallback_use_default_destination_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l3;
    int submodule_index = dnx_data_l3_submodule_feature;
    int feature_index = dnx_data_l3_feature_mc_bridge_fallback_use_default_destination;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_l3_feature_nof_layers_to_terminate_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l3;
    int submodule_index = dnx_data_l3_submodule_feature;
    int feature_index = dnx_data_l3_feature_nof_layers_to_terminate_support;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_l3_fec_define_uneven_bank_sizes;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_l3_fec_uneven_bank_sizes_set;
    ...
    data_index = dnx_data_l3_source_address_define_is_mymac_prefix_limitted;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_l3_source_address_is_mymac_prefix_limitted_set;
    ...
    data_index = dnx_data_l3_ecmp_cbts_implementation_using_field_support;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_l3_ecmp_cbts_implementation_using_field_support_set;
    ...
    data_index = dnx_data_l3_feature_fec_rpf_protection_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_l3_feature_fec_rpf_protection_supported_set;
    data_index = dnx_data_l3_feature_mc_bridge_fallback_use_default_destination;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_l3_feature_mc_bridge_fallback_use_default_destination_set;
    data_index = dnx_data_l3_feature_nof_layers_to_terminate_support;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_l3_feature_nof_layers_to_terminate_support_set;
