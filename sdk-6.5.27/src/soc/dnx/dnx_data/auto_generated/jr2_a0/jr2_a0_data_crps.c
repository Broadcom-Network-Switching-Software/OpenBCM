...
static shr_error_e
jr2_a0_dnx_data_crps_eviction_iteration_interval_time_config_is_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_crps;
    int submodule_index = dnx_data_crps_submodule_eviction;
    int feature_index = dnx_data_crps_eviction_iteration_interval_time_config_is_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_crps_src_interface_crps_eviction_set(
    int unit)
{
    int source_index;
    dnx_data_crps_src_interface_crps_eviction_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnx_data_module_crps;
    int submodule_index = dnx_data_crps_submodule_src_interface;
    int table_index = dnx_data_crps_src_interface_table_crps_eviction;
    SHR_FUNC_INIT_VARS(unit);
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_crps_src_interface_crps_eviction_t, (1 * (table->keys[0].size) + 1  ), "data of dnx_data_crps_src_interface_table_crps_eviction");

    
    default_data = (dnx_data_crps_src_interface_crps_eviction_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    default_data->valid_for_eviction = 0;
    
    for (source_index = 0; source_index < table->keys[0].size; source_index++)
    {
        data = (dnx_data_crps_src_interface_crps_eviction_t *) dnxc_data_mgmt_table_data_get(unit, table, source_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
    
    if (bcmStatCounterInterfaceIngressReceivePp < table->keys[0].size)
    {
        data = (dnx_data_crps_src_interface_crps_eviction_t *) dnxc_data_mgmt_table_data_get(unit, table, bcmStatCounterInterfaceIngressReceivePp, 0);
        data->valid_for_eviction = 1;
    }
    if (bcmStatCounterInterfaceIngressOam < table->keys[0].size)
    {
        data = (dnx_data_crps_src_interface_crps_eviction_t *) dnxc_data_mgmt_table_data_get(unit, table, bcmStatCounterInterfaceIngressOam, 0);
        data->valid_for_eviction = 1;
    }
    if (bcmStatCounterInterfaceIngressVoq < table->keys[0].size)
    {
        data = (dnx_data_crps_src_interface_crps_eviction_t *) dnxc_data_mgmt_table_data_get(unit, table, bcmStatCounterInterfaceIngressVoq, 0);
        data->valid_for_eviction = 1;
    }
    if (bcmStatCounterInterfaceIngressTransmitPp < table->keys[0].size)
    {
        data = (dnx_data_crps_src_interface_crps_eviction_t *) dnxc_data_mgmt_table_data_get(unit, table, bcmStatCounterInterfaceIngressTransmitPp, 0);
        data->valid_for_eviction = 1;
    }
    if (bcmStatCounterInterfaceEgressReceivePp < table->keys[0].size)
    {
        data = (dnx_data_crps_src_interface_crps_eviction_t *) dnxc_data_mgmt_table_data_get(unit, table, bcmStatCounterInterfaceEgressReceivePp, 0);
        data->valid_for_eviction = 1;
    }
    if (bcmStatCounterInterfaceEgressReceiveQueue < table->keys[0].size)
    {
        data = (dnx_data_crps_src_interface_crps_eviction_t *) dnxc_data_mgmt_table_data_get(unit, table, bcmStatCounterInterfaceEgressReceiveQueue, 0);
        data->valid_for_eviction = 1;
    }
    if (bcmStatCounterInterfaceEgressTransmitPp < table->keys[0].size)
    {
        data = (dnx_data_crps_src_interface_crps_eviction_t *) dnxc_data_mgmt_table_data_get(unit, table, bcmStatCounterInterfaceEgressTransmitPp, 0);
        data->valid_for_eviction = 1;
    }
    if (bcmStatCounterInterfaceEgressOam < table->keys[0].size)
    {
        data = (dnx_data_crps_src_interface_crps_eviction_t *) dnxc_data_mgmt_table_data_get(unit, table, bcmStatCounterInterfaceEgressOam, 0);
        data->valid_for_eviction = 0;
    }
    if (bcmStatCounterInterfaceOamp < table->keys[0].size)
    {
        data = (dnx_data_crps_src_interface_crps_eviction_t *) dnxc_data_mgmt_table_data_get(unit, table, bcmStatCounterInterfaceOamp, 0);
        data->valid_for_eviction = 1;
    }
...
static shr_error_e
jr2_a0_dnx_data_crps_latency_epp_command_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_crps;
    int submodule_index = dnx_data_crps_submodule_latency;
    int define_index = dnx_data_crps_latency_define_epp_command_id;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_crps_general_is_used_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_crps;
...
static shr_error_e
jr2_a0_dnx_data_crps_general_crps_rate_calculation_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_crps;
    int submodule_index = dnx_data_crps_submodule_general;
    int feature_index = dnx_data_crps_general_crps_rate_calculation_support;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_crps_eviction_iteration_interval_time_config_is_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_crps_eviction_iteration_interval_time_config_is_supported_set;
    ...
    data_index = dnx_data_crps_src_interface_table_crps_eviction;
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_crps_src_interface_crps_eviction_set;
    ...
    data_index = dnx_data_crps_latency_define_epp_command_id;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_crps_latency_epp_command_id_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_crps_general_is_used_set;
    data_index = dnx_data_crps_general_crps_rate_calculation_support;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_crps_general_crps_rate_calculation_support_set;
