...
static shr_error_e
jr2_a0_dnx_data_elk_general_is_egw_block_exist_set(
    int unit)
{
    ...
    int unit)
{
    ...
    feature->default_data = g_kbp_compiled*dnx_data_elk.general.feature_get(unit, dnx_data_elk_general_is_egw_block_exist);

    
    feature->data = g_kbp_compiled*dnx_data_elk.general.feature_get(unit, dnx_data_elk_general_is_egw_block_exist);
...
static shr_error_e
jr2_a0_dnx_data_elk_general_are_two_kbps_connected_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_elk;
    int submodule_index = dnx_data_elk_submodule_general;
    int feature_index = dnx_data_elk_general_are_two_kbps_connected;
    SHR_FUNC_INIT_VARS(unit);

    feature = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].features[feature_index];
    
    feature->default_data = ((dnx_data_elk.connectivity.topology_get(unit)->start_lane[2] >= dnx_data_elk.general.max_lane_id_get(unit)) || (dnx_data_elk.connectivity.blackhole_get(unit) == 2)) ? TRUE : FALSE;

    
    feature->data = ((dnx_data_elk.connectivity.topology_get(unit)->start_lane[2] >= dnx_data_elk.general.max_lane_id_get(unit)) || (dnx_data_elk.connectivity.blackhole_get(unit) == 2)) ? TRUE : FALSE;
...
static shr_error_e
jr2_a0_dnx_data_elk_general_hard_reset_after_kbp_soft_reset_fail_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_elk;
    int submodule_index = dnx_data_elk_submodule_general;
    int feature_index = dnx_data_elk_general_hard_reset_after_kbp_soft_reset_fail;
    SHR_FUNC_INIT_VARS(unit);
    ...
    feature->property.suffix = "hard_reset_after_kbp_soft_reset_fail";
...
static shr_error_e
jr2_a0_dnx_data_elk_general_nof_dbs_per_core_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_elk;
    int submodule_index = dnx_data_elk_submodule_general;
    int define_index = dnx_data_elk_general_define_nof_dbs_per_core;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    define->property.mapping[2].name = "BCM5235";
    define->property.mapping[2].val = 3;
    define->property.mapping[3].name = "BCM52321_BCM5235";
    define->property.mapping[3].val = 4;
    ...
    int unit)
{
    ...
    data->initial_regular_capacity = 65536;
    data->initial_optimized_capacity = 524288;
    data->xl_db = 0;
    data->locality = 2;
    data->zero_size_ad = 1;
    ...
    int unit)
{
    ...
    data_index = dnx_data_elk_general_define_nof_dbs_per_core;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_elk_general_nof_dbs_per_core_set;
    ...
    feature->set = jr2_a0_dnx_data_elk_general_is_egw_block_exist_set;
    ...
    data_index = dnx_data_elk_general_are_two_kbps_connected;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_elk_general_are_two_kbps_connected_set;
    data_index = dnx_data_elk_general_hard_reset_after_kbp_soft_reset_fail;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_elk_general_hard_reset_after_kbp_soft_reset_fail_set;
