...
static shr_error_e
jr2_a0_dnx_data_nif_phys_txpi_supported_in_pm8x50_set(
    int unit)
{
...
static shr_error_e
jr2_a0_dnx_data_nif_phys_txpi_sdm_scheme_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
...
static shr_error_e
jr2_a0_dnx_data_nif_eth_legacy_interfaces_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_eth;
    int feature_index = dnx_data_nif_eth_legacy_interfaces_support;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    define->default_data = dnx_data_ingr_congestion.info.max_jumbo_packet_size_get(unit);

    
    define->data = dnx_data_ingr_congestion.info.max_jumbo_packet_size_get(unit);
...
static shr_error_e
jr2_a0_dnx_data_nif_eth_is_nif_loopback_supported_set(
    int unit)
{
    int type_index;
    dnx_data_nif_eth_is_nif_loopback_supported_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_eth;
    int table_index = dnx_data_nif_eth_table_is_nif_loopback_supported;
    SHR_FUNC_INIT_VARS(unit);
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_nif_eth_is_nif_loopback_supported_t, (1 * (table->keys[0].size) + 1  ), "data of dnx_data_nif_eth_table_is_nif_loopback_supported");

    
    default_data = (dnx_data_nif_eth_is_nif_loopback_supported_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    default_data->is_supported = 0;
    
    for (type_index = 0; type_index < table->keys[0].size; type_index++)
    {
        data = (dnx_data_nif_eth_is_nif_loopback_supported_t *) dnxc_data_mgmt_table_data_get(unit, table, type_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
...
static shr_error_e
jr2_a0_dnx_data_nif_eth_mac_padding_set(
    int unit)
{
    int type_index;
    dnx_data_nif_eth_mac_padding_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_eth;
    int table_index = dnx_data_nif_eth_table_mac_padding;
    SHR_FUNC_INIT_VARS(unit);
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_nif_eth_mac_padding_t, (1 * (table->keys[0].size) + 1  ), "data of dnx_data_nif_eth_table_mac_padding");

    
    default_data = (dnx_data_nif_eth_mac_padding_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    default_data->is_supported = 1;
    
    for (type_index = 0; type_index < table->keys[0].size; type_index++)
    {
        data = (dnx_data_nif_eth_mac_padding_t *) dnxc_data_mgmt_table_data_get(unit, table, type_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
...
static shr_error_e
jr2_a0_dnx_data_nif_eth_supported_clu_mgu_an_abilities_set(
    int unit)
{
    int idx_index;
    dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_eth;
    int table_index = dnx_data_nif_eth_table_supported_clu_mgu_an_abilities;
    SHR_FUNC_INIT_VARS(unit);
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_nif_eth_supported_clu_mgu_an_abilities_t, (1 * (table->keys[0].size) + 1  ), "data of dnx_data_nif_eth_table_supported_clu_mgu_an_abilities");

    
    default_data = (dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    ...
    for (idx_index = 0; idx_index < table->keys[0].size; idx_index++)
    {
        data = (dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, idx_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
    
    if (0 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 0, 0);
    ...
    if (1 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 1, 0);
        data->an_mode = bcmPortAnModeCL73;
        data->speed = 10000;
        data->nof_lanes = 1;
        data->fec_type = bcmPortPhyFecBaseR;
    ...
    if (2 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 2, 0);
        data->an_mode = bcmPortAnModeCL73;
        data->speed = 25000;
        data->nof_lanes = 1;
        data->fec_type = bcmPortPhyFecNone;
    ...
    if (3 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 3, 0);
        data->an_mode = bcmPortAnModeCL73;
        data->speed = 25000;
        data->nof_lanes = 1;
        data->fec_type = bcmPortPhyFecNone;
    ...
    if (4 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 4, 0);
        data->an_mode = bcmPortAnModeCL73;
        data->speed = 25000;
        data->nof_lanes = 1;
        data->fec_type = bcmPortPhyFecBaseR;
    ...
    if (5 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 5, 0);
        data->an_mode = bcmPortAnModeCL73;
        data->speed = 25000;
        data->nof_lanes = 1;
        data->fec_type = bcmPortPhyFecBaseR;
    ...
    if (6 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 6, 0);
        data->an_mode = bcmPortAnModeCL73;
        data->speed = 25000;
        data->nof_lanes = 1;
        data->fec_type = bcmPortPhyFecRsFec;
    ...
    if (7 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 7, 0);
        data->an_mode = bcmPortAnModeCL73;
        data->speed = 25000;
        data->nof_lanes = 1;
        data->fec_type = bcmPortPhyFecRsFec;
    ...
    if (8 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 8, 0);
        data->an_mode = bcmPortAnModeCL73;
        data->speed = 40000;
        data->nof_lanes = 4;
        data->fec_type = bcmPortPhyFecNone;
    ...
    if (9 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 9, 0);
        data->an_mode = bcmPortAnModeCL73;
        data->speed = 40000;
        data->nof_lanes = 4;
        data->fec_type = bcmPortPhyFecNone;
    ...
    if (10 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 10, 0);
        data->an_mode = bcmPortAnModeCL73;
        data->speed = 40000;
        data->nof_lanes = 4;
        data->fec_type = bcmPortPhyFecBaseR;
    ...
    if (11 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 11, 0);
        data->an_mode = bcmPortAnModeCL73;
        data->speed = 40000;
        data->nof_lanes = 4;
        data->fec_type = bcmPortPhyFecBaseR;
    ...
    if (12 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 12, 0);
        data->an_mode = bcmPortAnModeCL73;
        data->speed = 100000;
        data->nof_lanes = 4;
        data->fec_type = bcmPortPhyFecNone;
    ...
    if (13 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 13, 0);
        data->an_mode = bcmPortAnModeCL73;
        data->speed = 100000;
        data->nof_lanes = 4;
        data->fec_type = bcmPortPhyFecNone;
    ...
    if (14 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 14, 0);
        data->an_mode = bcmPortAnModeCL73;
        data->speed = 100000;
        data->nof_lanes = 4;
        data->fec_type = bcmPortPhyFecRsFec;
    ...
    if (15 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 15, 0);
        data->an_mode = bcmPortAnModeCL73;
        data->speed = 100000;
        data->nof_lanes = 4;
        data->fec_type = bcmPortPhyFecRsFec;
    ...
    if (16 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 16, 0);
    ...
    if (17 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 17, 0);
        data->an_mode = bcmPortAnModeCL73BAM;
        data->speed = 25000;
        data->nof_lanes = 1;
        data->fec_type = bcmPortPhyFecNone;
    ...
    if (18 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 18, 0);
        data->an_mode = bcmPortAnModeCL73BAM;
        data->speed = 25000;
        data->nof_lanes = 1;
        data->fec_type = bcmPortPhyFecBaseR;
    ...
    if (19 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 19, 0);
        data->an_mode = bcmPortAnModeCL73BAM;
        data->speed = 25000;
        data->nof_lanes = 1;
        data->fec_type = bcmPortPhyFecBaseR;
    ...
    if (20 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 20, 0);
        data->an_mode = bcmPortAnModeCL73BAM;
        data->speed = 25000;
        data->nof_lanes = 1;
        data->fec_type = bcmPortPhyFecRsFec;
    ...
    if (21 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 21, 0);
        data->an_mode = bcmPortAnModeCL73BAM;
        data->speed = 25000;
        data->nof_lanes = 1;
        data->fec_type = bcmPortPhyFecRsFec;
    ...
    if (22 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 22, 0);
        data->an_mode = bcmPortAnModeCL73BAM;
        data->speed = 40000;
        data->nof_lanes = 2;
        data->fec_type = bcmPortPhyFecNone;
    ...
    if (23 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 23, 0);
        data->an_mode = bcmPortAnModeCL73BAM;
        data->speed = 40000;
        data->nof_lanes = 2;
        data->fec_type = bcmPortPhyFecNone;
    ...
    if (24 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 24, 0);
        data->an_mode = bcmPortAnModeCL73BAM;
        data->speed = 50000;
        data->nof_lanes = 2;
        data->fec_type = bcmPortPhyFecNone;
    ...
    if (25 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 25, 0);
        data->an_mode = bcmPortAnModeCL73BAM;
        data->speed = 50000;
        data->nof_lanes = 2;
        data->fec_type = bcmPortPhyFecNone;
    ...
    if (26 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 26, 0);
        data->an_mode = bcmPortAnModeCL73BAM;
        data->speed = 50000;
        data->nof_lanes = 2;
        data->fec_type = bcmPortPhyFecRsFec;
    ...
    if (27 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *) dnxc_data_mgmt_table_data_get(unit, table, 27, 0);
        data->an_mode = bcmPortAnModeCL73BAM;
        data->speed = 50000;
        data->nof_lanes = 2;
        data->fec_type = bcmPortPhyFecRsFec;
...
static shr_error_e
jr2_a0_dnx_data_nif_eth_ingress_reassembly_context_mapping_set(
    int unit)
{
    int scheduler_priority_index;
    dnx_data_nif_eth_ingress_reassembly_context_mapping_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_eth;
    int table_index = dnx_data_nif_eth_table_ingress_reassembly_context_mapping;
    SHR_FUNC_INIT_VARS(unit);
    ...
    table->keys[0].size = bcmPortNifSchedulerTDM;
    table->info_get.key_size[0] = bcmPortNifSchedulerTDM;
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_nif_eth_ingress_reassembly_context_mapping_t, (1 * (table->keys[0].size) + 1  ), "data of dnx_data_nif_eth_table_ingress_reassembly_context_mapping");

    
    default_data = (dnx_data_nif_eth_ingress_reassembly_context_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    default_data->channel = 0;
    
    for (scheduler_priority_index = 0; scheduler_priority_index < table->keys[0].size; scheduler_priority_index++)
    {
        data = (dnx_data_nif_eth_ingress_reassembly_context_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, scheduler_priority_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
    
    if (bcmPortNifSchedulerLow < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_ingress_reassembly_context_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, bcmPortNifSchedulerLow, 0);
        data->channel = 0;
    }
    if (bcmPortNifSchedulerHigh < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_ingress_reassembly_context_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, bcmPortNifSchedulerHigh, 0);
        data->channel = 1;
    }
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_phys_txpi_sdm_scheme_set;

    
    data_index = dnx_data_nif_phys_txpi_supported_in_pm8x50;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_nif_phys_txpi_supported_in_pm8x50_set;
    ...
    data_index = dnx_data_nif_eth_legacy_interfaces_support;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_nif_eth_legacy_interfaces_support_set;
    ...
    data_index = dnx_data_nif_eth_table_is_nif_loopback_supported;
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_nif_eth_is_nif_loopback_supported_set;
    data_index = dnx_data_nif_eth_table_mac_padding;
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_nif_eth_mac_padding_set;
    ...
    data_index = dnx_data_nif_eth_table_supported_clu_mgu_an_abilities;
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_nif_eth_supported_clu_mgu_an_abilities_set;
    data_index = dnx_data_nif_eth_table_ingress_reassembly_context_mapping;
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_nif_eth_ingress_reassembly_context_mapping_set;
