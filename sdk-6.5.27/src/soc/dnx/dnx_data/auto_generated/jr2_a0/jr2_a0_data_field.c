...
static shr_error_e
jr2_a0_dnx_data_field_external_tcam_multicore_fg_supports_core_all_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_external_tcam;
    int define_index = dnx_data_field_external_tcam_define_multicore_fg_supports_core_all;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_field_tcam_hitbit_splits_banks_like_sram_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_tcam;
    int feature_index = dnx_data_field_tcam_hitbit_splits_banks_like_sram;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    define->default_data = (2*(dnx_data_field.tcam.key_size_half_get(unit)));

    
    define->data = (2*(dnx_data_field.tcam.key_size_half_get(unit)));
    ...
    int unit)
{
    ...
    define->default_data = (2*(dnx_data_field.tcam.key_size_single_get(unit)));

    
    define->data = (2*(dnx_data_field.tcam.key_size_single_get(unit)));
    ...
    int unit)
{
    ...
    define->default_data = (2*(dnx_data_field.tcam.action_size_half_get(unit)));

    
    define->data = (2*(dnx_data_field.tcam.action_size_half_get(unit)));
    ...
    int unit)
{
    ...
    define->default_data = (2*(dnx_data_field.tcam.action_size_single_get(unit)));

    
    define->data = (2*(dnx_data_field.tcam.action_size_single_get(unit)));
    ...
    int unit)
{
    ...
    define->default_data = dnx_data_field.tcam.hw_bank_size_get(unit);

    
    define->data = dnx_data_field.tcam.hw_bank_size_get(unit);
    ...
    int unit)
{
    ...
    define->default_data = (dnx_data_field.tcam.nof_big_banks_get(unit) + dnx_data_field.tcam.nof_small_banks_get(unit));

    
    define->data = (dnx_data_field.tcam.nof_big_banks_get(unit) + dnx_data_field.tcam.nof_small_banks_get(unit));
    ...
    int unit)
{
    ...
    define->default_data = (2*(dnx_data_field.tcam.nof_banks_get(unit)));

    
    define->data = (2*(dnx_data_field.tcam.nof_banks_get(unit)));
    ...
    int unit)
{
    ...
    define->default_data = (((dnx_data_field.tcam.nof_big_bank_lines_get(unit)) * (dnx_data_field.tcam.nof_big_banks_get(unit))) + ((dnx_data_field.tcam.nof_small_bank_lines_get(unit)) * (dnx_data_field.tcam.nof_small_banks_get(unit))));

    
    define->data = (((dnx_data_field.tcam.nof_big_bank_lines_get(unit)) * (dnx_data_field.tcam.nof_big_banks_get(unit))) + ((dnx_data_field.tcam.nof_small_bank_lines_get(unit)) * (dnx_data_field.tcam.nof_small_banks_get(unit))));
    ...
    int unit)
{
    ...
    define->default_data = ((dnx_data_field.tcam.nof_entries_80_bits_get(unit))/2);

    
    define->data = ((dnx_data_field.tcam.nof_entries_80_bits_get(unit))/2);
    ...
    int unit)
{
    ...
    define->default_data = ((dnx_data_field.tcam.nof_banks_get(unit)) * (dnx_data_field.tcam.hw_bank_size_get(unit)));

    
    define->data = ((dnx_data_field.tcam.nof_banks_get(unit)) * (dnx_data_field.tcam.hw_bank_size_get(unit)));
    ...
    int unit)
{
    ...
    define->default_data = ((((dnx_data_field.tcam.nof_banks_get(unit)) - 1) * (dnx_data_field.tcam.hw_bank_size_get(unit))) + (dnx_data_field.tcam.nof_small_bank_lines_get(unit)));

    
    define->data = ((((dnx_data_field.tcam.nof_banks_get(unit)) - 1) * (dnx_data_field.tcam.hw_bank_size_get(unit))) + (dnx_data_field.tcam.nof_small_bank_lines_get(unit)));
...
static shr_error_e
jr2_a0_dnx_data_field_tcam_nof_banks_hitbit_units_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_tcam;
    int define_index = dnx_data_field_tcam_define_nof_banks_hitbit_units;
    SHR_FUNC_INIT_VARS(unit);

    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    
    define->default_data = ((dnx_data_field.tcam.nof_banks_get(unit))*(dnx_data_field.tcam.action_width_selector_size_get(unit)));

    
    define->data = ((dnx_data_field.tcam.nof_banks_get(unit))*(dnx_data_field.tcam.action_width_selector_size_get(unit)));
...
static shr_error_e
jr2_a0_dnx_data_field_tcam_nof_big_bank_lines_per_hitbit_unit_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_tcam;
    int define_index = dnx_data_field_tcam_define_nof_big_bank_lines_per_hitbit_unit;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_field_tcam_nof_small_bank_lines_per_hitbit_unit_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_tcam;
    int define_index = dnx_data_field_tcam_define_nof_small_bank_lines_per_hitbit_unit;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_field_context_default_itmh_pph_routing_context_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_context;
    int define_index = dnx_data_field_context_define_default_itmh_pph_routing_context;
    SHR_FUNC_INIT_VARS(unit);

    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    
    define->default_data = (dnx_data_field.base_ipmf1.nof_contexts_get(unit)-23);

    
    define->data = (dnx_data_field.base_ipmf1.nof_contexts_get(unit)-23);
...
static shr_error_e
jr2_a0_dnx_data_field_context_default_ftmh_mc_ipmf3_context_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_context;
    int define_index = dnx_data_field_context_define_default_ftmh_mc_ipmf3_context;
    SHR_FUNC_INIT_VARS(unit);

    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    
    define->default_data = (dnx_data_field.base_ipmf3.nof_contexts_get(unit)-14);

    
    define->data = (dnx_data_field.base_ipmf3.nof_contexts_get(unit)-14);
...
static shr_error_e
jr2_a0_dnx_data_field_preselector_default_itmh_pph_eth_presel_id_ipmf1_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_preselector;
    int define_index = dnx_data_field_preselector_define_default_itmh_pph_eth_presel_id_ipmf1;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_field_preselector_default_itmh_pph_ipv4_presel_id_ipmf1_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_preselector;
    int define_index = dnx_data_field_preselector_define_default_itmh_pph_ipv4_presel_id_ipmf1;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_field_preselector_default_itmh_pph_ipv6_presel_id_ipmf1_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_preselector;
    int define_index = dnx_data_field_preselector_define_default_itmh_pph_ipv6_presel_id_ipmf1;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_field_preselector_default_itmh_pph_mpls_presel_id_ipmf1_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_preselector;
    int define_index = dnx_data_field_preselector_define_default_itmh_pph_mpls_presel_id_ipmf1;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_field_preselector_default_itmh_y1711_rcpu_presel_id_ipmf1_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_preselector;
    int define_index = dnx_data_field_preselector_define_default_itmh_y1711_rcpu_presel_id_ipmf1;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_field_preselector_default_itmh_pph_routing_presel_id_ipmf3_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_preselector;
    int define_index = dnx_data_field_preselector_define_default_itmh_pph_routing_presel_id_ipmf3;
    SHR_FUNC_INIT_VARS(unit);

    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    
    define->default_data = 105;
...
static shr_error_e
jr2_a0_dnx_data_field_preselector_default_nat_presel_id_epmf_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_preselector;
    int define_index = dnx_data_field_preselector_define_default_nat_presel_id_epmf;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_field_preselector_nof_uint32_in_cs_qual_hw_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_preselector;
    int define_index = dnx_data_field_preselector_define_nof_uint32_in_cs_qual_hw;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_field_virtual_wire_general_data_nof_containers_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_virtual_wire;
    int define_index = dnx_data_field_virtual_wire_define_general_data_nof_containers;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_field_mdb_dt_ipmf1_ipmf2_concurrent_support_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_mdb_dt;
    int define_index = dnx_data_field_mdb_dt_define_ipmf1_ipmf2_concurrent_support;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_field_mdb_dt_signal_block_name_is_map_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_mdb_dt;
    int define_index = dnx_data_field_mdb_dt_define_signal_block_name_is_map;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_field_mdb_dt_signal_key_is_entire_key_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_mdb_dt;
    int define_index = dnx_data_field_mdb_dt_define_signal_key_is_entire_key;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_field_exem_debug_key_signal_includes_zero_padding_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_exem;
    int define_index = dnx_data_field_exem_define_debug_key_signal_includes_zero_padding;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_field_ace_hw_invalid_action_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
...
static shr_error_e
jr2_a0_dnx_data_field_features_dir_ext_epmf_key_has_debug_signal_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_features;
    int define_index = dnx_data_field_features_define_dir_ext_epmf_key_has_debug_signal;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_field_features_key_result_hit_signals_exist_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_features;
    int define_index = dnx_data_field_features_define_key_result_hit_signals_exist;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_field_features_external_cs_based_on_fwd2_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_features;
    int define_index = dnx_data_field_features_define_external_cs_based_on_fwd2;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_field_features_cs_lif_profile_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_features;
    int define_index = dnx_data_field_features_define_cs_lif_profile;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_field_features_has_last_keys_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_features;
    int define_index = dnx_data_field_features_define_has_last_keys;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_field_features_ipmf3_has_last_keys_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_features;
    int define_index = dnx_data_field_features_define_ipmf3_has_last_keys;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_field_features_ipmf3_context_signal_is_from_register_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_features;
    int define_index = dnx_data_field_features_define_ipmf3_context_signal_is_from_register;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_field_features_epmf_context_signal_exists_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_features;
    int define_index = dnx_data_field_features_define_epmf_context_signal_exists;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_field_features_epmf_context_signal_from_phl_block_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_features;
    int define_index = dnx_data_field_features_define_epmf_context_signal_from_phl_block;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_field_features_epmf_is_on_etpp_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_features;
    int define_index = dnx_data_field_features_define_epmf_is_on_etpp;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_field_features_de_has_debug_signals_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_features;
    int define_index = dnx_data_field_features_define_de_has_debug_signals;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_field_features_result_hit_signal_names_always_include_key_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_features;
    int define_index = dnx_data_field_features_define_result_hit_signal_names_always_include_key;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_field_features_ipmf3_context_has_oam_stateless_property_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_features;
    int define_index = dnx_data_field_features_define_ipmf3_context_has_oam_stateless_property;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_field_tests_first_part_of_acr_zero_padded_by_32_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_tests;
    int define_index = dnx_data_field_tests_define_first_part_of_acr_zero_padded_by_32;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_field_tests_ext_stat_valid_can_be_read_in_tm_cmd_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_field;
    int submodule_index = dnx_data_field_submodule_tests;
    int define_index = dnx_data_field_tests_define_ext_stat_valid_can_be_read_in_tm_cmd;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_field_external_tcam_define_multicore_fg_supports_core_all;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_external_tcam_multicore_fg_supports_core_all_set;
    ...
    data_index = dnx_data_field_tcam_define_nof_banks_hitbit_units;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_tcam_nof_banks_hitbit_units_set;
    data_index = dnx_data_field_tcam_define_nof_big_bank_lines_per_hitbit_unit;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_tcam_nof_big_bank_lines_per_hitbit_unit_set;
    data_index = dnx_data_field_tcam_define_nof_small_bank_lines_per_hitbit_unit;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_tcam_nof_small_bank_lines_per_hitbit_unit_set;
    ...
    data_index = dnx_data_field_tcam_hitbit_splits_banks_like_sram;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_field_tcam_hitbit_splits_banks_like_sram_set;
    ...
    data_index = dnx_data_field_context_define_default_itmh_pph_routing_context;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_context_default_itmh_pph_routing_context_set;
    ...
    data_index = dnx_data_field_context_define_default_ftmh_mc_ipmf3_context;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_context_default_ftmh_mc_ipmf3_context_set;
    ...
    data_index = dnx_data_field_preselector_define_default_itmh_pph_eth_presel_id_ipmf1;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_preselector_default_itmh_pph_eth_presel_id_ipmf1_set;
    data_index = dnx_data_field_preselector_define_default_itmh_pph_ipv4_presel_id_ipmf1;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_preselector_default_itmh_pph_ipv4_presel_id_ipmf1_set;
    data_index = dnx_data_field_preselector_define_default_itmh_pph_ipv6_presel_id_ipmf1;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_preselector_default_itmh_pph_ipv6_presel_id_ipmf1_set;
    data_index = dnx_data_field_preselector_define_default_itmh_pph_mpls_presel_id_ipmf1;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_preselector_default_itmh_pph_mpls_presel_id_ipmf1_set;
    data_index = dnx_data_field_preselector_define_default_itmh_y1711_rcpu_presel_id_ipmf1;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_preselector_default_itmh_y1711_rcpu_presel_id_ipmf1_set;
    ...
    data_index = dnx_data_field_preselector_define_default_itmh_pph_routing_presel_id_ipmf3;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_preselector_default_itmh_pph_routing_presel_id_ipmf3_set;
    ...
    data_index = dnx_data_field_preselector_define_default_nat_presel_id_epmf;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_preselector_default_nat_presel_id_epmf_set;
    ...
    data_index = dnx_data_field_preselector_define_nof_uint32_in_cs_qual_hw;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_preselector_nof_uint32_in_cs_qual_hw_set;
    ...
    data_index = dnx_data_field_virtual_wire_define_general_data_nof_containers;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_virtual_wire_general_data_nof_containers_set;
    ...
    data_index = dnx_data_field_mdb_dt_define_ipmf1_ipmf2_concurrent_support;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_mdb_dt_ipmf1_ipmf2_concurrent_support_set;
    data_index = dnx_data_field_mdb_dt_define_signal_block_name_is_map;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_mdb_dt_signal_block_name_is_map_set;
    data_index = dnx_data_field_mdb_dt_define_signal_key_is_entire_key;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_mdb_dt_signal_key_is_entire_key_set;
    ...
    data_index = dnx_data_field_exem_define_debug_key_signal_includes_zero_padding;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_exem_debug_key_signal_includes_zero_padding_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_ace_hw_invalid_action_id_set;
    ...
    data_index = dnx_data_field_features_define_dir_ext_epmf_key_has_debug_signal;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_features_dir_ext_epmf_key_has_debug_signal_set;
    ...
    data_index = dnx_data_field_features_define_key_result_hit_signals_exist;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_features_key_result_hit_signals_exist_set;
    data_index = dnx_data_field_features_define_external_cs_based_on_fwd2;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_features_external_cs_based_on_fwd2_set;
    ...
    data_index = dnx_data_field_features_define_cs_lif_profile;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_features_cs_lif_profile_set;
    ...
    data_index = dnx_data_field_features_define_has_last_keys;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_features_has_last_keys_set;
    data_index = dnx_data_field_features_define_ipmf3_has_last_keys;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_features_ipmf3_has_last_keys_set;
    data_index = dnx_data_field_features_define_ipmf3_context_signal_is_from_register;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_features_ipmf3_context_signal_is_from_register_set;
    data_index = dnx_data_field_features_define_epmf_context_signal_exists;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_features_epmf_context_signal_exists_set;
    data_index = dnx_data_field_features_define_epmf_context_signal_from_phl_block;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_features_epmf_context_signal_from_phl_block_set;
    data_index = dnx_data_field_features_define_epmf_is_on_etpp;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_features_epmf_is_on_etpp_set;
    data_index = dnx_data_field_features_define_de_has_debug_signals;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_features_de_has_debug_signals_set;
    data_index = dnx_data_field_features_define_result_hit_signal_names_always_include_key;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_features_result_hit_signal_names_always_include_key_set;
    data_index = dnx_data_field_features_define_ipmf3_context_has_oam_stateless_property;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_features_ipmf3_context_has_oam_stateless_property_set;
    ...
    data_index = dnx_data_field_tests_define_first_part_of_acr_zero_padded_by_32;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_tests_first_part_of_acr_zero_padded_by_32_set;
    data_index = dnx_data_field_tests_define_ext_stat_valid_can_be_read_in_tm_cmd;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_field_tests_ext_stat_valid_can_be_read_in_tm_cmd_set;
