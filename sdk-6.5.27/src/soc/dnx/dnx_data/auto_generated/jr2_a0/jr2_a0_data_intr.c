...
static shr_error_e
jr2_a0_dnx_data_intr_general_soft_init_for_debug_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_intr;
    ...
    int unit)
{
    ...
    table->keys[0].size = 433;
    table->info_get.key_size[0] = 433;
...
static shr_error_e
jr2_a0_dnx_data_intr_general_chip_intr_remap_set(
    int unit)
{
    int offset_index;
    dnx_data_intr_general_chip_intr_remap_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnx_data_module_intr;
    int submodule_index = dnx_data_intr_submodule_general;
    int table_index = dnx_data_intr_general_table_chip_intr_remap;
    SHR_FUNC_INIT_VARS(unit);
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_intr_general_chip_intr_remap_t, (1 * (table->keys[0].size) + 1  ), "data of dnx_data_intr_general_table_chip_intr_remap");

    
    default_data = (dnx_data_intr_general_chip_intr_remap_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    ...
    for (offset_index = 0; offset_index < table->keys[0].size; offset_index++)
    {
        data = (dnx_data_intr_general_chip_intr_remap_t *) dnxc_data_mgmt_table_data_get(unit, table, offset_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
...
static shr_error_e
jr2_a0_dnx_data_intr_general_chip_intr_enable_set(
    int unit)
{
    int offset_index;
    dnx_data_intr_general_chip_intr_enable_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnx_data_module_intr;
    int submodule_index = dnx_data_intr_submodule_general;
    int table_index = dnx_data_intr_general_table_chip_intr_enable;
    SHR_FUNC_INIT_VARS(unit);
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_intr_general_chip_intr_enable_t, (1 * (table->keys[0].size) + 1  ), "data of dnx_data_intr_general_table_chip_intr_enable");

    
    default_data = (dnx_data_intr_general_chip_intr_enable_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    default_data->bit = 0;
    
    for (offset_index = 0; offset_index < table->keys[0].size; offset_index++)
    {
        data = (dnx_data_intr_general_chip_intr_enable_t *) dnxc_data_mgmt_table_data_get(unit, table, offset_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
    
    if (0 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_chip_intr_enable_t *) dnxc_data_mgmt_table_data_get(unit, table, 0, 0);
        data->bit = 0;
    }
...
static shr_error_e
jr2_a0_dnx_data_intr_ser_new_tcam_scan_mode_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_intr;
    int submodule_index = dnx_data_intr_submodule_ser;
    int define_index = dnx_data_intr_ser_define_new_tcam_scan_mode;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_intr_ser_tcam_scan_set(
    int unit)
{
    int index_index;
    dnx_data_intr_ser_tcam_scan_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnx_data_module_intr;
    int submodule_index = dnx_data_intr_submodule_ser;
    int table_index = dnx_data_intr_ser_table_tcam_scan;
    SHR_FUNC_INIT_VARS(unit);
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_intr_ser_tcam_scan_t, (1 * (table->keys[0].size) + 1  ), "data of dnx_data_intr_ser_table_tcam_scan");

    
    default_data = (dnx_data_intr_ser_tcam_scan_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    default_data->scan_cfg_reg = INVALIDr;
    default_data->scan_pause_reg = INVALIDr;
    default_data->scan_index_reg = INVALIDr;
    default_data->tcam_memory = INVALIDm;
    default_data->scan_window = 0;
    default_data->dec_action = 0;
    default_data->sec_action = 0;
    default_data->dec_pause = 0;
    default_data->sec_pause = 0;
    default_data->shadowed = 0;
    
    for (index_index = 0; index_index < table->keys[0].size; index_index++)
    {
        data = (dnx_data_intr_ser_tcam_scan_t *) dnxc_data_mgmt_table_data_get(unit, table, index_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
    ...
    int unit)
{
    ...
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_intr_general_soft_init_for_debug_set;
    ...
    data_index = dnx_data_intr_general_table_chip_intr_remap;
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_intr_general_chip_intr_remap_set;
    data_index = dnx_data_intr_general_table_chip_intr_enable;
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_intr_general_chip_intr_enable_set;
    ...
    data_index = dnx_data_intr_ser_define_new_tcam_scan_mode;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_intr_ser_new_tcam_scan_mode_set;
    ...
    data_index = dnx_data_intr_ser_table_tcam_scan;
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_intr_ser_tcam_scan_set;
