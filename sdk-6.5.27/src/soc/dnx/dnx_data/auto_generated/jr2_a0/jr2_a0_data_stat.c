...
static shr_error_e
jr2_a0_dnx_data_stat_stat_pp_reduced_fec_stat_cmd_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_stat;
    int submodule_index = dnx_data_stat_submodule_stat_pp;
    int feature_index = dnx_data_stat_stat_pp_reduced_fec_stat_cmd;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_stat_stat_pp_fec_protection_stat_id_is_minus_one_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_stat;
    int submodule_index = dnx_data_stat_submodule_stat_pp;
    int feature_index = dnx_data_stat_stat_pp_fec_protection_stat_id_is_minus_one;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_stat_stat_pp_protection_direct_stat_only_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_stat;
    int submodule_index = dnx_data_stat_submodule_stat_pp;
    int feature_index = dnx_data_stat_stat_pp_protection_direct_stat_only;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_stat_stat_pp_etpp_metadata_fwd_and_fwd_plus_share_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_stat;
    int submodule_index = dnx_data_stat_submodule_stat_pp;
    int feature_index = dnx_data_stat_stat_pp_etpp_metadata_fwd_and_fwd_plus_share;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_stat_stat_pp_reduced_fec_stat_cmd;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_stat_stat_pp_reduced_fec_stat_cmd_set;
    data_index = dnx_data_stat_stat_pp_fec_protection_stat_id_is_minus_one;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_stat_stat_pp_fec_protection_stat_id_is_minus_one_set;
    data_index = dnx_data_stat_stat_pp_protection_direct_stat_only;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_stat_stat_pp_protection_direct_stat_only_set;
    data_index = dnx_data_stat_stat_pp_etpp_metadata_fwd_and_fwd_plus_share;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_stat_stat_pp_etpp_metadata_fwd_and_fwd_plus_share_set;
