    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_pp_ETPP_define_btc_max_header_to_add_in_bytes].name = "btc_max_header_to_add_in_bytes";
    submodule_data->defines[dnx_data_pp_ETPP_define_btc_max_header_to_add_in_bytes].doc = "";
    
    submodule_data->defines[dnx_data_pp_ETPP_define_btc_max_header_to_add_in_bytes].flags |= DNXC_DATA_F_NUMERIC;
...
uint32
dnx_data_pp_ETPP_btc_max_header_to_add_in_bytes_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_pp, dnx_data_pp_submodule_ETPP, dnx_data_pp_ETPP_define_btc_max_header_to_add_in_bytes);
}
