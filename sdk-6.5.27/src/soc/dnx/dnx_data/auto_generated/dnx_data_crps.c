    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_crps_src_interface_table_crps_eviction].name = "crps_eviction";
    submodule_data->tables[dnx_data_crps_src_interface_table_crps_eviction].doc = "";
    submodule_data->tables[dnx_data_crps_src_interface_table_crps_eviction].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_crps_src_interface_table_crps_eviction].size_of_values = sizeof(dnx_data_crps_src_interface_crps_eviction_t);
    submodule_data->tables[dnx_data_crps_src_interface_table_crps_eviction].entry_get = dnx_data_crps_src_interface_crps_eviction_entry_str_get;

    
    submodule_data->tables[dnx_data_crps_src_interface_table_crps_eviction].nof_keys = 1;
    submodule_data->tables[dnx_data_crps_src_interface_table_crps_eviction].keys[0].name = "source";
    submodule_data->tables[dnx_data_crps_src_interface_table_crps_eviction].keys[0].doc = "";

    
    submodule_data->tables[dnx_data_crps_src_interface_table_crps_eviction].nof_values = 1;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_crps_src_interface_table_crps_eviction].values, dnxc_data_value_t, submodule_data->tables[dnx_data_crps_src_interface_table_crps_eviction].nof_values, "_dnx_data_crps_src_interface_table_crps_eviction table values");
    submodule_data->tables[dnx_data_crps_src_interface_table_crps_eviction].values[0].name = "valid_for_eviction";
    submodule_data->tables[dnx_data_crps_src_interface_table_crps_eviction].values[0].type = "int";
    submodule_data->tables[dnx_data_crps_src_interface_table_crps_eviction].values[0].doc = "";
    submodule_data->tables[dnx_data_crps_src_interface_table_crps_eviction].values[0].offset = UTILEX_OFFSETOF(dnx_data_crps_src_interface_crps_eviction_t, valid_for_eviction);
...
const dnx_data_crps_src_interface_crps_eviction_t *
dnx_data_crps_src_interface_crps_eviction_get(
    int unit,
    int source)
{
    char *data;
    ...
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_crps, dnx_data_crps_submodule_src_interface, dnx_data_crps_src_interface_table_crps_eviction);
    
    data = dnxc_data_mgmt_table_data_get(unit, table, source, 0);
    return (const dnx_data_crps_src_interface_crps_eviction_t *) data;
...
shr_error_e
dnx_data_crps_src_interface_crps_eviction_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_crps_src_interface_crps_eviction_t *data;
    SHR_FUNC_INIT_VARS(unit);

    
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_crps, dnx_data_crps_submodule_src_interface, dnx_data_crps_src_interface_table_crps_eviction);
    data = (const dnx_data_crps_src_interface_crps_eviction_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->valid_for_eviction);
            break;
    }
...
const dnxc_data_table_info_t *
dnx_data_crps_src_interface_crps_eviction_info_get(
    int unit)
{

    
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_crps, dnx_data_crps_submodule_src_interface, dnx_data_crps_src_interface_table_crps_eviction);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_crps_latency_define_epp_command_id].name = "epp_command_id";
    submodule_data->defines[dnx_data_crps_latency_define_epp_command_id].doc = "";
    
    submodule_data->defines[dnx_data_crps_latency_define_epp_command_id].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_crps_latency_epp_command_id_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_crps, dnx_data_crps_submodule_latency, dnx_data_crps_latency_define_epp_command_id);
}
