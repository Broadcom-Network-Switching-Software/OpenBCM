    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].nof_values = 28;
    ...
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[19].name = "is_framer_mgmt";
    ...
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[19].offset = UTILEX_OFFSETOF(dnx_data_port_static_add_ucode_port_t, is_framer_mgmt);
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[20].name = "is_feedback";
    ...
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[20].offset = UTILEX_OFFSETOF(dnx_data_port_static_add_ucode_port_t, is_feedback);
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[21].name = "sch_priority_propagation_en";
    ...
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[21].offset = UTILEX_OFFSETOF(dnx_data_port_static_add_ucode_port_t, sch_priority_propagation_en);
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[22].name = "frame_preemptable";
    ...
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[22].offset = UTILEX_OFFSETOF(dnx_data_port_static_add_ucode_port_t, frame_preemptable);
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[23].name = "num_priorities";
    ...
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[23].offset = UTILEX_OFFSETOF(dnx_data_port_static_add_ucode_port_t, num_priorities);
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[24].name = "base_q_pair";
    ...
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[24].offset = UTILEX_OFFSETOF(dnx_data_port_static_add_ucode_port_t, base_q_pair);
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[25].name = "num_sch_priorities";
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[25].type = "int";
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[25].doc = "";
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[25].offset = UTILEX_OFFSETOF(dnx_data_port_static_add_ucode_port_t, num_sch_priorities);
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[26].name = "base_hr";
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[26].type = "int";
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[26].doc = "";
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[26].offset = UTILEX_OFFSETOF(dnx_data_port_static_add_ucode_port_t, base_hr);
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[27].name = "framer_mgmt_channel";
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[27].type = "int";
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[27].doc = "";
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[27].offset = UTILEX_OFFSETOF(dnx_data_port_static_add_ucode_port_t, framer_mgmt_channel);
    ...
    int value_index)
{
    ...
    switch (value_index)
    {
        ...
        case 18:
            ...
            break;
        case 19:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->is_framer_mgmt);
            break;
        case 20:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->is_feedback);
            break;
        case 21:
        ...
        case 26:
            ...
            break;
        case 27:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->framer_mgmt_channel);
            break;
    }
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_port_general_is_port_extender_supported].name = "is_port_extender_supported";
    submodule_data->features[dnx_data_port_general_is_port_extender_supported].doc = "";
    submodule_data->features[dnx_data_port_general_is_port_extender_supported].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_port_general_is_mpls_raw_supported].name = "is_mpls_raw_supported";
    submodule_data->features[dnx_data_port_general_is_mpls_raw_supported].doc = "";
    submodule_data->features[dnx_data_port_general_is_mpls_raw_supported].flags |= DNXC_DATA_F_FEATURE;
    ...
    submodule_data->defines[dnx_data_port_general_define_max_nof_mirror_channels].name = "max_nof_mirror_channels";
    submodule_data->defines[dnx_data_port_general_define_max_nof_mirror_channels].doc = "";
    
    submodule_data->defines[dnx_data_port_general_define_max_nof_mirror_channels].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->tables[dnx_data_port_general_table_pm_info].nof_values = 3;
    ...
    submodule_data->tables[dnx_data_port_general_table_pm_info].values[2].name = "is_phy_rx_taps_supported";
    submodule_data->tables[dnx_data_port_general_table_pm_info].values[2].type = "int";
    submodule_data->tables[dnx_data_port_general_table_pm_info].values[2].doc = "";
    submodule_data->tables[dnx_data_port_general_table_pm_info].values[2].offset = UTILEX_OFFSETOF(dnx_data_port_general_pm_info_t, is_phy_rx_taps_supported);

    
    submodule_data->tables[dnx_data_port_general_table_phy_controls_features].name = "phy_controls_features";
    submodule_data->tables[dnx_data_port_general_table_phy_controls_features].doc = "";
    submodule_data->tables[dnx_data_port_general_table_phy_controls_features].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_port_general_table_phy_controls_features].size_of_values = sizeof(dnx_data_port_general_phy_controls_features_t);
    submodule_data->tables[dnx_data_port_general_table_phy_controls_features].entry_get = dnx_data_port_general_phy_controls_features_entry_str_get;

    
    submodule_data->tables[dnx_data_port_general_table_phy_controls_features].nof_keys = 1;
    submodule_data->tables[dnx_data_port_general_table_phy_controls_features].keys[0].name = "phy_control_type";
    submodule_data->tables[dnx_data_port_general_table_phy_controls_features].keys[0].doc = "";

    
    submodule_data->tables[dnx_data_port_general_table_phy_controls_features].nof_values = 1;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_port_general_table_phy_controls_features].values, dnxc_data_value_t, submodule_data->tables[dnx_data_port_general_table_phy_controls_features].nof_values, "_dnx_data_port_general_table_phy_controls_features table values");
    submodule_data->tables[dnx_data_port_general_table_phy_controls_features].values[0].name = "port_disable_required";
    submodule_data->tables[dnx_data_port_general_table_phy_controls_features].values[0].type = "uint8";
    submodule_data->tables[dnx_data_port_general_table_phy_controls_features].values[0].doc = "";
    submodule_data->tables[dnx_data_port_general_table_phy_controls_features].values[0].offset = UTILEX_OFFSETOF(dnx_data_port_general_phy_controls_features_t, port_disable_required);
...
uint32
dnx_data_port_general_max_nof_mirror_channels_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_port, dnx_data_port_submodule_general, dnx_data_port_general_define_max_nof_mirror_channels);
}
...
const dnx_data_port_general_phy_controls_features_t *
dnx_data_port_general_phy_controls_features_get(
    int unit,
    int phy_control_type)
{
    ...
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_port, dnx_data_port_submodule_general, dnx_data_port_general_table_phy_controls_features);
    
    data = dnxc_data_mgmt_table_data_get(unit, table, phy_control_type, 0);
    return (const dnx_data_port_general_phy_controls_features_t *) data;
    ...
    int value_index)
{
    ...
    switch (value_index)
    {
        ...
        case 1:
            ...
            break;
        case 2:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->is_phy_rx_taps_supported);
            break;
    }
...
shr_error_e
dnx_data_port_general_phy_controls_features_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_port_general_phy_controls_features_t *data;
    SHR_FUNC_INIT_VARS(unit);

    
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_port, dnx_data_port_submodule_general, dnx_data_port_general_table_phy_controls_features);
    data = (const dnx_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
...
const dnxc_data_table_info_t *
dnx_data_port_general_phy_controls_features_info_get(
    int unit)
{

    
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_port, dnx_data_port_submodule_general, dnx_data_port_general_table_phy_controls_features);
