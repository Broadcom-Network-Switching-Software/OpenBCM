    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_nif_global_framer_phy_hw_linkscan_supported].name = "framer_phy_hw_linkscan_supported";
    submodule_data->features[dnx_data_nif_global_framer_phy_hw_linkscan_supported].doc = "";
    submodule_data->features[dnx_data_nif_global_framer_phy_hw_linkscan_supported].flags |= DNXC_DATA_F_FEATURE;
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_nif_ilkn_per_port_segmentation_hrf_reset].name = "per_port_segmentation_hrf_reset";
    submodule_data->features[dnx_data_nif_ilkn_per_port_segmentation_hrf_reset].doc = "";
    submodule_data->features[dnx_data_nif_ilkn_per_port_segmentation_hrf_reset].flags |= DNXC_DATA_F_FEATURE;
    ...
    submodule_data->features[dnx_data_nif_ilkn_is_data_path_through_w40].name = "is_data_path_through_w40";
    submodule_data->features[dnx_data_nif_ilkn_is_data_path_through_w40].doc = "";
    submodule_data->features[dnx_data_nif_ilkn_is_data_path_through_w40].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_nif_ilkn_ensure_tx_rx_reset_order].name = "ensure_tx_rx_reset_order";
    submodule_data->features[dnx_data_nif_ilkn_ensure_tx_rx_reset_order].doc = "";
    submodule_data->features[dnx_data_nif_ilkn_ensure_tx_rx_reset_order].flags |= DNXC_DATA_F_FEATURE;
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_nif_eth_legacy_interfaces_support].name = "legacy_interfaces_support";
    submodule_data->features[dnx_data_nif_eth_legacy_interfaces_support].doc = "";
    submodule_data->features[dnx_data_nif_eth_legacy_interfaces_support].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_nif_eth_tx_fdbk_port_supported].name = "tx_fdbk_port_supported";
    submodule_data->features[dnx_data_nif_eth_tx_fdbk_port_supported].doc = "";
    submodule_data->features[dnx_data_nif_eth_tx_fdbk_port_supported].flags |= DNXC_DATA_F_FEATURE;
    ...
    submodule_data->tables[dnx_data_nif_eth_table_pm_properties].nof_values = 10;
    ...
    submodule_data->tables[dnx_data_nif_eth_table_pm_properties].values[9].name = "measure_rate_on_down_port_supported";
    submodule_data->tables[dnx_data_nif_eth_table_pm_properties].values[9].type = "int";
    submodule_data->tables[dnx_data_nif_eth_table_pm_properties].values[9].doc = "";
    submodule_data->tables[dnx_data_nif_eth_table_pm_properties].values[9].offset = UTILEX_OFFSETOF(dnx_data_nif_eth_pm_properties_t, measure_rate_on_down_port_supported);
    ...
    submodule_data->tables[dnx_data_nif_eth_table_mac_padding].name = "mac_padding";
    submodule_data->tables[dnx_data_nif_eth_table_mac_padding].doc = "";
    submodule_data->tables[dnx_data_nif_eth_table_mac_padding].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_nif_eth_table_mac_padding].size_of_values = sizeof(dnx_data_nif_eth_mac_padding_t);
    submodule_data->tables[dnx_data_nif_eth_table_mac_padding].entry_get = dnx_data_nif_eth_mac_padding_entry_str_get;

    
    submodule_data->tables[dnx_data_nif_eth_table_mac_padding].nof_keys = 1;
    submodule_data->tables[dnx_data_nif_eth_table_mac_padding].keys[0].name = "type";
    submodule_data->tables[dnx_data_nif_eth_table_mac_padding].keys[0].doc = "";

    
    submodule_data->tables[dnx_data_nif_eth_table_mac_padding].nof_values = 1;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_nif_eth_table_mac_padding].values, dnxc_data_value_t, submodule_data->tables[dnx_data_nif_eth_table_mac_padding].nof_values, "_dnx_data_nif_eth_table_mac_padding table values");
    submodule_data->tables[dnx_data_nif_eth_table_mac_padding].values[0].name = "is_supported";
    submodule_data->tables[dnx_data_nif_eth_table_mac_padding].values[0].type = "int";
    submodule_data->tables[dnx_data_nif_eth_table_mac_padding].values[0].doc = "";
    submodule_data->tables[dnx_data_nif_eth_table_mac_padding].values[0].offset = UTILEX_OFFSETOF(dnx_data_nif_eth_mac_padding_t, is_supported);
    ...
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].name = "supported_clu_mgu_an_abilities";
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].doc = "";
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].size_of_values = sizeof(dnx_data_nif_eth_supported_clu_mgu_an_abilities_t);
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].entry_get = dnx_data_nif_eth_supported_clu_mgu_an_abilities_entry_str_get;

    
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].nof_keys = 1;
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].keys[0].name = "idx";
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].keys[0].doc = "";

    
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].nof_values = 7;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].values, dnxc_data_value_t, submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].nof_values, "_dnx_data_nif_eth_table_supported_clu_mgu_an_abilities table values");
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].values[0].name = "an_mode";
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].values[0].type = "int";
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].values[0].doc = "";
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].values[0].offset = UTILEX_OFFSETOF(dnx_data_nif_eth_supported_clu_mgu_an_abilities_t, an_mode);
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].values[1].name = "speed";
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].values[1].type = "int";
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].values[1].doc = "";
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].values[1].offset = UTILEX_OFFSETOF(dnx_data_nif_eth_supported_clu_mgu_an_abilities_t, speed);
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].values[2].name = "nof_lanes";
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].values[2].type = "int";
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].values[2].doc = "";
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].values[2].offset = UTILEX_OFFSETOF(dnx_data_nif_eth_supported_clu_mgu_an_abilities_t, nof_lanes);
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].values[3].name = "fec_type";
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].values[3].type = "bcm_port_phy_fec_t";
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].values[3].doc = "";
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].values[3].offset = UTILEX_OFFSETOF(dnx_data_nif_eth_supported_clu_mgu_an_abilities_t, fec_type);
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].values[4].name = "medium";
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].values[4].type = "bcm_port_medium_t";
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].values[4].doc = "";
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].values[4].offset = UTILEX_OFFSETOF(dnx_data_nif_eth_supported_clu_mgu_an_abilities_t, medium);
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].values[5].name = "channel";
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].values[5].type = "bcm_port_phy_channel_t";
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].values[5].doc = "";
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].values[5].offset = UTILEX_OFFSETOF(dnx_data_nif_eth_supported_clu_mgu_an_abilities_t, channel);
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].values[6].name = "is_valid";
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].values[6].type = "int";
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].values[6].doc = "";
    submodule_data->tables[dnx_data_nif_eth_table_supported_clu_mgu_an_abilities].values[6].offset = UTILEX_OFFSETOF(dnx_data_nif_eth_supported_clu_mgu_an_abilities_t, is_valid);

    
    submodule_data->tables[dnx_data_nif_eth_table_ingress_reassembly_context_mapping].name = "ingress_reassembly_context_mapping";
    submodule_data->tables[dnx_data_nif_eth_table_ingress_reassembly_context_mapping].doc = "";
    submodule_data->tables[dnx_data_nif_eth_table_ingress_reassembly_context_mapping].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_nif_eth_table_ingress_reassembly_context_mapping].size_of_values = sizeof(dnx_data_nif_eth_ingress_reassembly_context_mapping_t);
    submodule_data->tables[dnx_data_nif_eth_table_ingress_reassembly_context_mapping].entry_get = dnx_data_nif_eth_ingress_reassembly_context_mapping_entry_str_get;

    
    submodule_data->tables[dnx_data_nif_eth_table_ingress_reassembly_context_mapping].nof_keys = 1;
    submodule_data->tables[dnx_data_nif_eth_table_ingress_reassembly_context_mapping].keys[0].name = "scheduler_priority";
    submodule_data->tables[dnx_data_nif_eth_table_ingress_reassembly_context_mapping].keys[0].doc = "";

    
    submodule_data->tables[dnx_data_nif_eth_table_ingress_reassembly_context_mapping].nof_values = 1;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_nif_eth_table_ingress_reassembly_context_mapping].values, dnxc_data_value_t, submodule_data->tables[dnx_data_nif_eth_table_ingress_reassembly_context_mapping].nof_values, "_dnx_data_nif_eth_table_ingress_reassembly_context_mapping table values");
    submodule_data->tables[dnx_data_nif_eth_table_ingress_reassembly_context_mapping].values[0].name = "channel";
    submodule_data->tables[dnx_data_nif_eth_table_ingress_reassembly_context_mapping].values[0].type = "int";
    submodule_data->tables[dnx_data_nif_eth_table_ingress_reassembly_context_mapping].values[0].doc = "";
    submodule_data->tables[dnx_data_nif_eth_table_ingress_reassembly_context_mapping].values[0].offset = UTILEX_OFFSETOF(dnx_data_nif_eth_ingress_reassembly_context_mapping_t, channel);
...
const dnx_data_nif_eth_mac_padding_t *
dnx_data_nif_eth_mac_padding_get(
    int unit,
    int type)
{
    char *data;
    ...
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_nif, dnx_data_nif_submodule_eth, dnx_data_nif_eth_table_mac_padding);
    
    data = dnxc_data_mgmt_table_data_get(unit, table, type, 0);
    return (const dnx_data_nif_eth_mac_padding_t *) data;
...
const dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *
dnx_data_nif_eth_supported_clu_mgu_an_abilities_get(
    int unit,
    int idx)
{
    char *data;
    ...
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_nif, dnx_data_nif_submodule_eth, dnx_data_nif_eth_table_supported_clu_mgu_an_abilities);
    
    data = dnxc_data_mgmt_table_data_get(unit, table, idx, 0);
    return (const dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *) data;

}

const dnx_data_nif_eth_ingress_reassembly_context_mapping_t *
dnx_data_nif_eth_ingress_reassembly_context_mapping_get(
    int unit,
    int scheduler_priority)
{
    ...
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_nif, dnx_data_nif_submodule_eth, dnx_data_nif_eth_table_ingress_reassembly_context_mapping);
    
    data = dnxc_data_mgmt_table_data_get(unit, table, scheduler_priority, 0);
    return (const dnx_data_nif_eth_ingress_reassembly_context_mapping_t *) data;
    ...
    int value_index)
{
    ...
    switch (value_index)
    {
        ...
        case 8:
            ...
            break;
        case 9:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->measure_rate_on_down_port_supported);
            break;
    }
...
shr_error_e
dnx_data_nif_eth_mac_padding_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_nif_eth_mac_padding_t *data;
    SHR_FUNC_INIT_VARS(unit);

    
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_nif, dnx_data_nif_submodule_eth, dnx_data_nif_eth_table_mac_padding);
    data = (const dnx_data_nif_eth_mac_padding_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->is_supported);
...
shr_error_e
dnx_data_nif_eth_supported_clu_mgu_an_abilities_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *data;
    SHR_FUNC_INIT_VARS(unit);

    
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_nif, dnx_data_nif_submodule_eth, dnx_data_nif_eth_table_supported_clu_mgu_an_abilities);
    data = (const dnx_data_nif_eth_supported_clu_mgu_an_abilities_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
...
shr_error_e
dnx_data_nif_eth_ingress_reassembly_context_mapping_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_nif_eth_ingress_reassembly_context_mapping_t *data;
    SHR_FUNC_INIT_VARS(unit);

    
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_nif, dnx_data_nif_submodule_eth, dnx_data_nif_eth_table_ingress_reassembly_context_mapping);
    data = (const dnx_data_nif_eth_ingress_reassembly_context_mapping_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->channel);
...
const dnxc_data_table_info_t *
dnx_data_nif_eth_mac_padding_info_get(
    int unit)
{

    
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_nif, dnx_data_nif_submodule_eth, dnx_data_nif_eth_table_mac_padding);
...
const dnxc_data_table_info_t *
dnx_data_nif_eth_supported_clu_mgu_an_abilities_info_get(
    int unit)
{

    
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_nif, dnx_data_nif_submodule_eth, dnx_data_nif_eth_table_supported_clu_mgu_an_abilities);

}

const dnxc_data_table_info_t *
dnx_data_nif_eth_ingress_reassembly_context_mapping_info_get(
    int unit)
{

    
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_nif, dnx_data_nif_submodule_eth, dnx_data_nif_eth_table_ingress_reassembly_context_mapping);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_nif_flexe_nb_tx_delay_per_pm].name = "nb_tx_delay_per_pm";
    submodule_data->features[dnx_data_nif_flexe_nb_tx_delay_per_pm].doc = "";
    submodule_data->features[dnx_data_nif_flexe_nb_tx_delay_per_pm].flags |= DNXC_DATA_F_FEATURE;
    ...
    submodule_data->tables[dnx_data_nif_flexe_table_nb_tx_delay_table].name = "nb_tx_delay_table";
    submodule_data->tables[dnx_data_nif_flexe_table_nb_tx_delay_table].doc = "";
    submodule_data->tables[dnx_data_nif_flexe_table_nb_tx_delay_table].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_nif_flexe_table_nb_tx_delay_table].size_of_values = sizeof(dnx_data_nif_flexe_nb_tx_delay_table_t);
    submodule_data->tables[dnx_data_nif_flexe_table_nb_tx_delay_table].entry_get = dnx_data_nif_flexe_nb_tx_delay_table_entry_str_get;

    
    submodule_data->tables[dnx_data_nif_flexe_table_nb_tx_delay_table].nof_keys = 1;
    submodule_data->tables[dnx_data_nif_flexe_table_nb_tx_delay_table].keys[0].name = "pm_index";
    submodule_data->tables[dnx_data_nif_flexe_table_nb_tx_delay_table].keys[0].doc = "";

    
    submodule_data->tables[dnx_data_nif_flexe_table_nb_tx_delay_table].nof_values = 1;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_nif_flexe_table_nb_tx_delay_table].values, dnxc_data_value_t, submodule_data->tables[dnx_data_nif_flexe_table_nb_tx_delay_table].nof_values, "_dnx_data_nif_flexe_table_nb_tx_delay_table table values");
    submodule_data->tables[dnx_data_nif_flexe_table_nb_tx_delay_table].values[0].name = "val";
    submodule_data->tables[dnx_data_nif_flexe_table_nb_tx_delay_table].values[0].type = "int";
    submodule_data->tables[dnx_data_nif_flexe_table_nb_tx_delay_table].values[0].doc = "";
    submodule_data->tables[dnx_data_nif_flexe_table_nb_tx_delay_table].values[0].offset = UTILEX_OFFSETOF(dnx_data_nif_flexe_nb_tx_delay_table_t, val);
...
const dnx_data_nif_flexe_nb_tx_delay_table_t *
dnx_data_nif_flexe_nb_tx_delay_table_get(
    int unit,
    int pm_index)
{
    char *data;
    ...
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_nif, dnx_data_nif_submodule_flexe, dnx_data_nif_flexe_table_nb_tx_delay_table);
    
    data = dnxc_data_mgmt_table_data_get(unit, table, pm_index, 0);
    return (const dnx_data_nif_flexe_nb_tx_delay_table_t *) data;
...
shr_error_e
dnx_data_nif_flexe_nb_tx_delay_table_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_nif_flexe_nb_tx_delay_table_t *data;
    SHR_FUNC_INIT_VARS(unit);

    
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_nif, dnx_data_nif_submodule_flexe, dnx_data_nif_flexe_table_nb_tx_delay_table);
    data = (const dnx_data_nif_flexe_nb_tx_delay_table_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->val);
...
const dnxc_data_table_info_t *
dnx_data_nif_flexe_nb_tx_delay_table_info_get(
    int unit)
{

    
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_nif, dnx_data_nif_submodule_flexe, dnx_data_nif_flexe_table_nb_tx_delay_table);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_nif_dbal_define_nbu_tx_threshold_after_ovf_entry_size].name = "nbu_tx_threshold_after_ovf_entry_size";
    submodule_data->defines[dnx_data_nif_dbal_define_nbu_tx_threshold_after_ovf_entry_size].doc = "";
    
    submodule_data->defines[dnx_data_nif_dbal_define_nbu_tx_threshold_after_ovf_entry_size].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_nif_dbal_define_mgu_tx_threshold_after_ovf_entry_size].name = "mgu_tx_threshold_after_ovf_entry_size";
    submodule_data->defines[dnx_data_nif_dbal_define_mgu_tx_threshold_after_ovf_entry_size].doc = "";
    
    submodule_data->defines[dnx_data_nif_dbal_define_mgu_tx_threshold_after_ovf_entry_size].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_nif_dbal_define_nbu_rx_fifo_srstn_entry_size].name = "nbu_rx_fifo_srstn_entry_size";
    submodule_data->defines[dnx_data_nif_dbal_define_nbu_rx_fifo_srstn_entry_size].doc = "";
    
    submodule_data->defines[dnx_data_nif_dbal_define_nbu_rx_fifo_srstn_entry_size].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_nif_dbal_define_mgu_rx_fifo_srstn_entry_size].name = "mgu_rx_fifo_srstn_entry_size";
    submodule_data->defines[dnx_data_nif_dbal_define_mgu_rx_fifo_srstn_entry_size].doc = "";
    
    submodule_data->defines[dnx_data_nif_dbal_define_mgu_rx_fifo_srstn_entry_size].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_nif_dbal_nbu_tx_threshold_after_ovf_entry_size_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_nif, dnx_data_nif_submodule_dbal, dnx_data_nif_dbal_define_nbu_tx_threshold_after_ovf_entry_size);
}

uint32
dnx_data_nif_dbal_mgu_tx_threshold_after_ovf_entry_size_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_nif, dnx_data_nif_submodule_dbal, dnx_data_nif_dbal_define_mgu_tx_threshold_after_ovf_entry_size);
}

uint32
dnx_data_nif_dbal_nbu_rx_fifo_srstn_entry_size_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_nif, dnx_data_nif_submodule_dbal, dnx_data_nif_dbal_define_nbu_rx_fifo_srstn_entry_size);
}

uint32
dnx_data_nif_dbal_mgu_rx_fifo_srstn_entry_size_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_nif, dnx_data_nif_submodule_dbal, dnx_data_nif_dbal_define_mgu_rx_fifo_srstn_entry_size);
}
