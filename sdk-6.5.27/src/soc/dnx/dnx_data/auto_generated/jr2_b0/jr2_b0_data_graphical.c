...
static shr_error_e
jr2_b0_dnx_data_graphical_diag_num_of_rows_set(
    int unit)
{
...
static shr_error_e
jr2_b0_dnx_data_graphical_diag_num_of_index_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_graphical;
...
static shr_error_e
jr2_b0_dnx_data_graphical_diag_num_of_block_entries_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_graphical;
...
static shr_error_e
jr2_b0_dnx_data_graphical_diag_blocks_left_set(
    int unit)
{
    int row_index;
    int index_index;
...
static shr_error_e
jr2_b0_dnx_data_graphical_diag_blocks_right_set(
    int unit)
{
    int row_index;
    int index_index;
...
static shr_error_e
jr2_b0_dnx_data_graphical_diag_counters_set(
    int unit)
{
    int block_index;
    int index_index;
    ...
    if (dnx_graphical_fdr < table->keys[0].size && 4 < table->keys[1].size)
    {
        ...
        data->regs[7] = FDR_FDR_REGISTER_1r;
    ...
    if (dnx_graphical_rqp < table->keys[0].size && 13 < table->keys[1].size)
    {
        ...
        data->flds[0] = PRS_DROP_CELL_0_CNTf;
    ...
    if (dnx_graphical_nif_tx < table->keys[0].size && 2 < table->keys[1].size)
    {
        ...
        data->regs[1] = CDUM_TX_TOTAL_PKT_WITH_ERR_COUNTERr;
        SHR_RANGE_VERIFY(2, 0, DNX_DIAG_COUNTER_REG_NOF_REGS, _SHR_E_INTERNAL, "out of bound access to array")
...
static shr_error_e
jr2_b0_dnx_data_graphical_diag_drop_reason_set(
    int unit)
{
    int index_index;
    ...
    int unit)
{
    ...
    define->set = jr2_b0_dnx_data_graphical_diag_num_of_rows_set;
    data_index = dnx_data_graphical_diag_define_num_of_index;
    define = &submodule->defines[data_index];
    define->set = jr2_b0_dnx_data_graphical_diag_num_of_index_set;
    data_index = dnx_data_graphical_diag_define_num_of_block_entries;
    define = &submodule->defines[data_index];
    define->set = jr2_b0_dnx_data_graphical_diag_num_of_block_entries_set;
    ...
    table->set = jr2_b0_dnx_data_graphical_diag_blocks_left_set;
    data_index = dnx_data_graphical_diag_table_blocks_right;
    table = &submodule->tables[data_index];
    table->set = jr2_b0_dnx_data_graphical_diag_blocks_right_set;
    data_index = dnx_data_graphical_diag_table_counters;
    table = &submodule->tables[data_index];
    table->set = jr2_b0_dnx_data_graphical_diag_counters_set;
    data_index = dnx_data_graphical_diag_table_drop_reason;
    table = &submodule->tables[data_index];
    table->set = jr2_b0_dnx_data_graphical_diag_drop_reason_set;
