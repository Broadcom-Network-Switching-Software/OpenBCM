    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_egr_queuing_params_allow_aloc_ae_ifc_support].name = "allow_aloc_ae_ifc_support";
    submodule_data->features[dnx_data_egr_queuing_params_allow_aloc_ae_ifc_support].doc = "";
    submodule_data->features[dnx_data_egr_queuing_params_allow_aloc_ae_ifc_support].flags |= DNXC_DATA_F_FEATURE;
    ...
    submodule_data->defines[dnx_data_egr_queuing_params_define_bubble_pulse_width_for_polling].name = "bubble_pulse_width_for_polling";
    submodule_data->defines[dnx_data_egr_queuing_params_define_bubble_pulse_width_for_polling].doc = "";
    
    submodule_data->defines[dnx_data_egr_queuing_params_define_bubble_pulse_width_for_polling].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->tables[dnx_data_egr_queuing_params_table_if_speed_params].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_egr_queuing_params_table_if_speed_params].values[1].doc = "";
    ...
    submodule_data->tables[dnx_data_egr_queuing_params_table_if_speed_params].values[2].doc = "";
    ...
    submodule_data->tables[dnx_data_egr_queuing_params_table_if_speed_params].values[3].doc = "";
    ...
    submodule_data->tables[dnx_data_egr_queuing_params_table_if_speed_params].values[4].doc = "";
    ...
    submodule_data->tables[dnx_data_egr_queuing_params_table_if_speed_params].values[5].doc = "";
    ...
    submodule_data->tables[dnx_data_egr_queuing_params_table_if_speed_params].values[6].doc = "";
    ...
    submodule_data->tables[dnx_data_egr_queuing_params_table_emr_fifo].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_egr_queuing_params_table_emr_fifo].values[1].doc = "";
    ...
    submodule_data->tables[dnx_data_egr_queuing_params_table_emr_fifo].values[2].doc = "";
    ...
    submodule_data->tables[dnx_data_egr_queuing_params_table_if_speed_params_clk_th].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_egr_queuing_params_table_fqp_dbf_additional_latency].values[0].doc = "";
...
uint32
dnx_data_egr_queuing_params_bubble_pulse_width_for_polling_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_egr_queuing, dnx_data_egr_queuing_submodule_params, dnx_data_egr_queuing_params_define_bubble_pulse_width_for_polling);
}
...
static shr_error_e
dnx_data_egr_queuing_general_init(
    int unit,
    dnxc_data_submodule_t *submodule_data)
{
    SHR_FUNC_INIT_VARS(unit);
    ...
    submodule_data->nof_features = _dnx_data_egr_queuing_general_feature_nof;
    DNXC_DATA_ALLOC(submodule_data->features, dnxc_data_feature_t,  submodule_data->nof_features, "_dnxc_data egr_queuing general features");

    submodule_data->features[dnx_data_egr_queuing_general_is_used].name = "is_used";
    submodule_data->features[dnx_data_egr_queuing_general_is_used].doc = "";
    submodule_data->features[dnx_data_egr_queuing_general_is_used].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_egr_queuing_general_power_down_supported].name = "power_down_supported";
    submodule_data->features[dnx_data_egr_queuing_general_power_down_supported].doc = "";
    submodule_data->features[dnx_data_egr_queuing_general_power_down_supported].flags |= DNXC_DATA_F_FEATURE;

    
    submodule_data->nof_defines = _dnx_data_egr_queuing_general_define_nof;
    DNXC_DATA_ALLOC(submodule_data->defines, dnxc_data_define_t, submodule_data->nof_defines, "_dnxc_data egr_queuing general defines");

    
    submodule_data->nof_tables = _dnx_data_egr_queuing_general_table_nof;
    DNXC_DATA_ALLOC(submodule_data->tables, dnxc_data_table_t, submodule_data->nof_tables, "_dnxc_data egr_queuing general tables");
...
int
dnx_data_egr_queuing_general_feature_get(
    int unit,
    dnx_data_egr_queuing_general_feature_e feature)
{
    return dnxc_data_mgmt_feature_data_get(unit, dnx_data_module_egr_queuing, dnx_data_egr_queuing_submodule_general, feature);
}
    ...
    dnxc_data_module_t *module_data)
{
    ...
    SHR_IF_ERR_EXIT(dnx_data_egr_queuing_general_init(unit, &module_data->submodules[dnx_data_egr_queuing_submodule_general]));
