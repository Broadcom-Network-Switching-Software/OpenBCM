    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_vlan_vlan_translate_ive_4_tag_support].name = "ive_4_tag_support";
    submodule_data->features[dnx_data_vlan_vlan_translate_ive_4_tag_support].doc = "";
    submodule_data->features[dnx_data_vlan_vlan_translate_ive_4_tag_support].flags |= DNXC_DATA_F_FEATURE;
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_vlan_llvp_outlif_llvp_profile_zero_is_valid].name = "outlif_llvp_profile_zero_is_valid";
    submodule_data->features[dnx_data_vlan_llvp_outlif_llvp_profile_zero_is_valid].doc = "";
    submodule_data->features[dnx_data_vlan_llvp_outlif_llvp_profile_zero_is_valid].flags |= DNXC_DATA_F_FEATURE;
