    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_oam_general_oam_short_group_support].name = "oam_short_group_support";
    submodule_data->features[dnx_data_oam_general_oam_short_group_support].doc = "";
    submodule_data->features[dnx_data_oam_general_oam_short_group_support].flags |= DNXC_DATA_F_FEATURE;
    ...
    submodule_data->features[dnx_data_oam_general_oam_tx_inject_lm_responder_support].name = "oam_tx_inject_lm_responder_support";
    submodule_data->features[dnx_data_oam_general_oam_tx_inject_lm_responder_support].doc = "";
    submodule_data->features[dnx_data_oam_general_oam_tx_inject_lm_responder_support].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_oam_general_oam_y1711_enable].name = "oam_y1711_enable";
    submodule_data->features[dnx_data_oam_general_oam_y1711_enable].doc = "";
    submodule_data->features[dnx_data_oam_general_oam_y1711_enable].flags |= DNXC_DATA_F_FEATURE;
    ...
    submodule_data->defines[dnx_data_oam_general_define_oam_tod_config_in_ns_version].name = "oam_tod_config_in_ns_version";
    submodule_data->defines[dnx_data_oam_general_define_oam_tod_config_in_ns_version].doc = "";
    
    submodule_data->defines[dnx_data_oam_general_define_oam_tod_config_in_ns_version].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_oam_general_define_oam_tod_config_in_ns_nof_bits_in_load_enable].name = "oam_tod_config_in_ns_nof_bits_in_load_enable";
    submodule_data->defines[dnx_data_oam_general_define_oam_tod_config_in_ns_nof_bits_in_load_enable].doc = "";
    
    submodule_data->defines[dnx_data_oam_general_define_oam_tod_config_in_ns_nof_bits_in_load_enable].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_oam_general_define_tod_init_in_oam].name = "tod_init_in_oam";
    submodule_data->defines[dnx_data_oam_general_define_tod_init_in_oam].doc = "";
    
    submodule_data->defines[dnx_data_oam_general_define_tod_init_in_oam].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_oam_general_define_oam_ns_freq_control_upper].name = "oam_ns_freq_control_upper";
    submodule_data->defines[dnx_data_oam_general_define_oam_ns_freq_control_upper].doc = "";
    
    submodule_data->defines[dnx_data_oam_general_define_oam_ns_freq_control_upper].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->defines[dnx_data_oam_general_define_bfd_nof_cluster_profile].name = "bfd_nof_cluster_profile";
    submodule_data->defines[dnx_data_oam_general_define_bfd_nof_cluster_profile].doc = "";
    
    submodule_data->defines[dnx_data_oam_general_define_bfd_nof_cluster_profile].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_oam_general_oam_tod_config_in_ns_version_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_oam, dnx_data_oam_submodule_general, dnx_data_oam_general_define_oam_tod_config_in_ns_version);
}

uint32
dnx_data_oam_general_oam_tod_config_in_ns_nof_bits_in_load_enable_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_oam, dnx_data_oam_submodule_general, dnx_data_oam_general_define_oam_tod_config_in_ns_nof_bits_in_load_enable);
}

uint32
dnx_data_oam_general_tod_init_in_oam_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_oam, dnx_data_oam_submodule_general, dnx_data_oam_general_define_tod_init_in_oam);
}

uint32
dnx_data_oam_general_oam_ns_freq_control_upper_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_oam, dnx_data_oam_submodule_general, dnx_data_oam_general_define_oam_ns_freq_control_upper);
}
...
uint32
dnx_data_oam_general_bfd_nof_cluster_profile_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_oam, dnx_data_oam_submodule_general, dnx_data_oam_general_define_bfd_nof_cluster_profile);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_oam_oamp_define_mep_id_in_rx_pkt_nof_bits].name = "mep_id_in_rx_pkt_nof_bits";
    submodule_data->defines[dnx_data_oam_oamp_define_mep_id_in_rx_pkt_nof_bits].doc = "";
    
    submodule_data->defines[dnx_data_oam_oamp_define_mep_id_in_rx_pkt_nof_bits].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->defines[dnx_data_oam_oamp_define_oamp_dual_mode].name = "oamp_dual_mode";
    submodule_data->defines[dnx_data_oam_oamp_define_oamp_dual_mode].doc = "";
    
    submodule_data->defines[dnx_data_oam_oamp_define_oamp_dual_mode].flags |= DNXC_DATA_F_NUMERIC;
...
uint32
dnx_data_oam_oamp_mep_id_in_rx_pkt_nof_bits_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_oam, dnx_data_oam_submodule_oamp, dnx_data_oam_oamp_define_mep_id_in_rx_pkt_nof_bits);
}
...
uint32
dnx_data_oam_oamp_oamp_dual_mode_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_oam, dnx_data_oam_submodule_oamp, dnx_data_oam_oamp_define_oamp_dual_mode);
}
