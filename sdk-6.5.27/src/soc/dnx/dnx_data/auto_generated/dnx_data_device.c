    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_device_general_xltcam_support].name = "xltcam_support";
    submodule_data->features[dnx_data_device_general_xltcam_support].doc = "";
    submodule_data->features[dnx_data_device_general_xltcam_support].flags |= DNXC_DATA_F_FEATURE;
    ...
    submodule_data->defines[dnx_data_device_general_define_max_nof_faps].name = "max_nof_faps";
    submodule_data->defines[dnx_data_device_general_define_max_nof_faps].doc = "";
    
    submodule_data->defines[dnx_data_device_general_define_max_nof_faps].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_device_general_max_nof_faps_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_device, dnx_data_device_submodule_general, dnx_data_device_general_define_max_nof_faps);
}
