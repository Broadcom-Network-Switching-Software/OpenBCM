    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_debug_mem_table_params].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_debug_mem_table_params].values[1].doc = "";
    ...
    submodule_data->tables[dnx_data_debug_mem_table_params].values[2].doc = "";
    ...
    submodule_data->tables[dnx_data_debug_mem_table_block_map].nof_values = 4;
    ...
    submodule_data->tables[dnx_data_debug_mem_table_block_map].values[0].name = "is_asic_block";
    submodule_data->tables[dnx_data_debug_mem_table_block_map].values[0].type = "int";
    submodule_data->tables[dnx_data_debug_mem_table_block_map].values[0].doc = "";
    submodule_data->tables[dnx_data_debug_mem_table_block_map].values[0].offset = UTILEX_OFFSETOF(dnx_data_debug_mem_block_map_t, is_asic_block);
    submodule_data->tables[dnx_data_debug_mem_table_block_map].values[1].name = "dbal_table";
    submodule_data->tables[dnx_data_debug_mem_table_block_map].values[1].type = "int";
    submodule_data->tables[dnx_data_debug_mem_table_block_map].values[1].doc = "";
    submodule_data->tables[dnx_data_debug_mem_table_block_map].values[1].offset = UTILEX_OFFSETOF(dnx_data_debug_mem_block_map_t, dbal_table);
    submodule_data->tables[dnx_data_debug_mem_table_block_map].values[2].name = "dbal_field";
    submodule_data->tables[dnx_data_debug_mem_table_block_map].values[2].type = "int";
    submodule_data->tables[dnx_data_debug_mem_table_block_map].values[2].doc = "";
    submodule_data->tables[dnx_data_debug_mem_table_block_map].values[2].offset = UTILEX_OFFSETOF(dnx_data_debug_mem_block_map_t, dbal_field);
    submodule_data->tables[dnx_data_debug_mem_table_block_map].values[3].name = "direction";
    submodule_data->tables[dnx_data_debug_mem_table_block_map].values[3].type = "int";
    submodule_data->tables[dnx_data_debug_mem_table_block_map].values[3].doc = "";
    submodule_data->tables[dnx_data_debug_mem_table_block_map].values[3].offset = UTILEX_OFFSETOF(dnx_data_debug_mem_block_map_t, direction);
    ...
    submodule_data->tables[dnx_data_debug_mem_table_mem_array].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_debug_mem_table_mem_array].values[1].doc = "";
