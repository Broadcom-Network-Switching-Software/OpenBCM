    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_dev_init_time_define_init_total_time].name = "init_total_time";
    submodule_data->defines[dnx_data_dev_init_time_define_init_total_time].doc = "";
    
    submodule_data->defines[dnx_data_dev_init_time_define_init_total_time].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_dev_init_time_define_appl_init_total_time].name = "appl_init_total_time";
    submodule_data->defines[dnx_data_dev_init_time_define_appl_init_total_time].doc = "";
    
    submodule_data->defines[dnx_data_dev_init_time_define_appl_init_total_time].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_dev_init_time_define_down_deviation_total].name = "down_deviation_total";
    submodule_data->defines[dnx_data_dev_init_time_define_down_deviation_total].doc = "";
    
    submodule_data->defines[dnx_data_dev_init_time_define_down_deviation_total].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_dev_init_time_define_up_deviation_total].name = "up_deviation_total";
    submodule_data->defines[dnx_data_dev_init_time_define_up_deviation_total].doc = "";
    
    submodule_data->defines[dnx_data_dev_init_time_define_up_deviation_total].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_dev_init_time_define_test_sensitivity].name = "test_sensitivity";
    submodule_data->defines[dnx_data_dev_init_time_define_test_sensitivity].doc = "";
    
    submodule_data->defines[dnx_data_dev_init_time_define_test_sensitivity].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->tables[dnx_data_dev_init_time_table_step_time].name = "step_time";
    submodule_data->tables[dnx_data_dev_init_time_table_step_time].doc = "";
    submodule_data->tables[dnx_data_dev_init_time_table_step_time].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_dev_init_time_table_step_time].size_of_values = sizeof(dnx_data_dev_init_time_step_time_t);
    submodule_data->tables[dnx_data_dev_init_time_table_step_time].entry_get = dnx_data_dev_init_time_step_time_entry_str_get;

    
    submodule_data->tables[dnx_data_dev_init_time_table_step_time].nof_keys = 1;
    submodule_data->tables[dnx_data_dev_init_time_table_step_time].keys[0].name = "step_id";
    submodule_data->tables[dnx_data_dev_init_time_table_step_time].keys[0].doc = "";

    
    submodule_data->tables[dnx_data_dev_init_time_table_step_time].nof_values = 4;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_dev_init_time_table_step_time].values, dnxc_data_value_t, submodule_data->tables[dnx_data_dev_init_time_table_step_time].nof_values, "_dnx_data_dev_init_time_table_step_time table values");
    submodule_data->tables[dnx_data_dev_init_time_table_step_time].values[0].name = "time";
    submodule_data->tables[dnx_data_dev_init_time_table_step_time].values[0].type = "uint32";
    submodule_data->tables[dnx_data_dev_init_time_table_step_time].values[0].doc = "";
    submodule_data->tables[dnx_data_dev_init_time_table_step_time].values[0].offset = UTILEX_OFFSETOF(dnx_data_dev_init_time_step_time_t, time);
    submodule_data->tables[dnx_data_dev_init_time_table_step_time].values[1].name = "down_deviation";
    submodule_data->tables[dnx_data_dev_init_time_table_step_time].values[1].type = "uint8";
    submodule_data->tables[dnx_data_dev_init_time_table_step_time].values[1].doc = "";
    submodule_data->tables[dnx_data_dev_init_time_table_step_time].values[1].offset = UTILEX_OFFSETOF(dnx_data_dev_init_time_step_time_t, down_deviation);
    submodule_data->tables[dnx_data_dev_init_time_table_step_time].values[2].name = "up_deviation";
    submodule_data->tables[dnx_data_dev_init_time_table_step_time].values[2].type = "uint8";
    submodule_data->tables[dnx_data_dev_init_time_table_step_time].values[2].doc = "";
    submodule_data->tables[dnx_data_dev_init_time_table_step_time].values[2].offset = UTILEX_OFFSETOF(dnx_data_dev_init_time_step_time_t, up_deviation);
    submodule_data->tables[dnx_data_dev_init_time_table_step_time].values[3].name = "non_perc_up_deviation";
    submodule_data->tables[dnx_data_dev_init_time_table_step_time].values[3].type = "uint32";
    submodule_data->tables[dnx_data_dev_init_time_table_step_time].values[3].doc = "";
    submodule_data->tables[dnx_data_dev_init_time_table_step_time].values[3].offset = UTILEX_OFFSETOF(dnx_data_dev_init_time_step_time_t, non_perc_up_deviation);

    
    submodule_data->tables[dnx_data_dev_init_time_table_appl_step_time].name = "appl_step_time";
    submodule_data->tables[dnx_data_dev_init_time_table_appl_step_time].doc = "";
    submodule_data->tables[dnx_data_dev_init_time_table_appl_step_time].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_dev_init_time_table_appl_step_time].size_of_values = sizeof(dnx_data_dev_init_time_appl_step_time_t);
    submodule_data->tables[dnx_data_dev_init_time_table_appl_step_time].entry_get = dnx_data_dev_init_time_appl_step_time_entry_str_get;

    
    submodule_data->tables[dnx_data_dev_init_time_table_appl_step_time].nof_keys = 1;
    submodule_data->tables[dnx_data_dev_init_time_table_appl_step_time].keys[0].name = "step_id";
    submodule_data->tables[dnx_data_dev_init_time_table_appl_step_time].keys[0].doc = "";

    
    submodule_data->tables[dnx_data_dev_init_time_table_appl_step_time].nof_values = 4;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_dev_init_time_table_appl_step_time].values, dnxc_data_value_t, submodule_data->tables[dnx_data_dev_init_time_table_appl_step_time].nof_values, "_dnx_data_dev_init_time_table_appl_step_time table values");
    submodule_data->tables[dnx_data_dev_init_time_table_appl_step_time].values[0].name = "time";
    submodule_data->tables[dnx_data_dev_init_time_table_appl_step_time].values[0].type = "uint32";
    submodule_data->tables[dnx_data_dev_init_time_table_appl_step_time].values[0].doc = "";
    submodule_data->tables[dnx_data_dev_init_time_table_appl_step_time].values[0].offset = UTILEX_OFFSETOF(dnx_data_dev_init_time_appl_step_time_t, time);
    submodule_data->tables[dnx_data_dev_init_time_table_appl_step_time].values[1].name = "down_deviation";
    submodule_data->tables[dnx_data_dev_init_time_table_appl_step_time].values[1].type = "uint8";
    submodule_data->tables[dnx_data_dev_init_time_table_appl_step_time].values[1].doc = "";
    submodule_data->tables[dnx_data_dev_init_time_table_appl_step_time].values[1].offset = UTILEX_OFFSETOF(dnx_data_dev_init_time_appl_step_time_t, down_deviation);
    submodule_data->tables[dnx_data_dev_init_time_table_appl_step_time].values[2].name = "up_deviation";
    submodule_data->tables[dnx_data_dev_init_time_table_appl_step_time].values[2].type = "uint8";
    submodule_data->tables[dnx_data_dev_init_time_table_appl_step_time].values[2].doc = "";
    submodule_data->tables[dnx_data_dev_init_time_table_appl_step_time].values[2].offset = UTILEX_OFFSETOF(dnx_data_dev_init_time_appl_step_time_t, up_deviation);
    submodule_data->tables[dnx_data_dev_init_time_table_appl_step_time].values[3].name = "non_perc_up_deviation";
    submodule_data->tables[dnx_data_dev_init_time_table_appl_step_time].values[3].type = "uint32";
    submodule_data->tables[dnx_data_dev_init_time_table_appl_step_time].values[3].doc = "";
    submodule_data->tables[dnx_data_dev_init_time_table_appl_step_time].values[3].offset = UTILEX_OFFSETOF(dnx_data_dev_init_time_appl_step_time_t, non_perc_up_deviation);
...
uint32
dnx_data_dev_init_time_init_total_time_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_dev_init, dnx_data_dev_init_submodule_time, dnx_data_dev_init_time_define_init_total_time);
}

uint32
dnx_data_dev_init_time_appl_init_total_time_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_dev_init, dnx_data_dev_init_submodule_time, dnx_data_dev_init_time_define_appl_init_total_time);
}

uint32
dnx_data_dev_init_time_down_deviation_total_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_dev_init, dnx_data_dev_init_submodule_time, dnx_data_dev_init_time_define_down_deviation_total);
}

uint32
dnx_data_dev_init_time_up_deviation_total_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_dev_init, dnx_data_dev_init_submodule_time, dnx_data_dev_init_time_define_up_deviation_total);
}

uint32
dnx_data_dev_init_time_test_sensitivity_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_dev_init, dnx_data_dev_init_submodule_time, dnx_data_dev_init_time_define_test_sensitivity);
}



const dnx_data_dev_init_time_step_time_t *
dnx_data_dev_init_time_step_time_get(
    int unit,
    int step_id)
{
    char *data;
    ...
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_dev_init, dnx_data_dev_init_submodule_time, dnx_data_dev_init_time_table_step_time);
    
    data = dnxc_data_mgmt_table_data_get(unit, table, step_id, 0);
    return (const dnx_data_dev_init_time_step_time_t *) data;

}

const dnx_data_dev_init_time_appl_step_time_t *
dnx_data_dev_init_time_appl_step_time_get(
    int unit,
    int step_id)
{
    char *data;
    ...
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_dev_init, dnx_data_dev_init_submodule_time, dnx_data_dev_init_time_table_appl_step_time);
    
    data = dnxc_data_mgmt_table_data_get(unit, table, step_id, 0);
    return (const dnx_data_dev_init_time_appl_step_time_t *) data;

}


shr_error_e
dnx_data_dev_init_time_step_time_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_dev_init_time_step_time_t *data;
    SHR_FUNC_INIT_VARS(unit);

    
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_dev_init, dnx_data_dev_init_submodule_time, dnx_data_dev_init_time_table_step_time);
    data = (const dnx_data_dev_init_time_step_time_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
...
shr_error_e
dnx_data_dev_init_time_appl_step_time_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_dev_init_time_appl_step_time_t *data;
    SHR_FUNC_INIT_VARS(unit);

    
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_dev_init, dnx_data_dev_init_submodule_time, dnx_data_dev_init_time_table_appl_step_time);
    data = (const dnx_data_dev_init_time_appl_step_time_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->time);
...
dnx_data_dev_init_time_step_time_info_get(
    int unit)
{

    
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_dev_init, dnx_data_dev_init_submodule_time, dnx_data_dev_init_time_table_step_time);

}

const dnxc_data_table_info_t *
dnx_data_dev_init_time_appl_step_time_info_get(
    int unit)
{

    
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_dev_init, dnx_data_dev_init_submodule_time, dnx_data_dev_init_time_table_appl_step_time);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_dev_init_general_mem_conf_test].name = "mem_conf_test";
    submodule_data->features[dnx_data_dev_init_general_mem_conf_test].doc = "";
    submodule_data->features[dnx_data_dev_init_general_mem_conf_test].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_dev_init_general_is_pp_used].name = "is_pp_used";
    submodule_data->features[dnx_data_dev_init_general_is_pp_used].doc = "";
    submodule_data->features[dnx_data_dev_init_general_is_pp_used].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_dev_init_general_ingress_power_down_supported].name = "ingress_power_down_supported";
    submodule_data->features[dnx_data_dev_init_general_ingress_power_down_supported].doc = "";
    submodule_data->features[dnx_data_dev_init_general_ingress_power_down_supported].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_dev_init_general_egress_power_down_supported].name = "egress_power_down_supported";
    submodule_data->features[dnx_data_dev_init_general_egress_power_down_supported].doc = "";
    submodule_data->features[dnx_data_dev_init_general_egress_power_down_supported].flags |= DNXC_DATA_F_FEATURE;
