...
static shr_error_e
j2x_a0_dnx_data_macsec_general_stat_special_map_set(
    int unit)
{
    int index_index;
...
static shr_error_e
j2x_a0_dnx_data_macsec_general_counter_map_set(
    int unit)
{
...
static shr_error_e
j2x_a0_dnx_data_macsec_general_stat_map_set(
    int unit)
{
    int stat_type_index;
...
static shr_error_e
j2x_a0_dnx_data_macsec_wrapper_tdm_calendar_speed_granularity_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_macsec;
    int submodule_index = dnx_data_macsec_submodule_wrapper;
    int define_index = dnx_data_macsec_wrapper_define_tdm_calendar_speed_granularity;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    table = &submodule->tables[data_index];
    table->set = j2x_a0_dnx_data_macsec_general_stat_special_map_set;
    ...
    table = &submodule->tables[data_index];
    table->set = j2x_a0_dnx_data_macsec_general_counter_map_set;
    ...
    table = &submodule->tables[data_index];
    table->set = j2x_a0_dnx_data_macsec_general_stat_map_set;
    ...
    data_index = dnx_data_macsec_wrapper_define_tdm_calendar_speed_granularity;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_macsec_wrapper_tdm_calendar_speed_granularity_set;
