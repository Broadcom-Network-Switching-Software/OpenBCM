    ...
    int unit)
{
    ...
    define->default_data = J2X_INT_MACT_LARGE_EM_LARGE_EM_MNGMNT_REQ_FID_EXCEED_LIMIT;

    
    define->data = J2X_INT_MACT_LARGE_EM_LARGE_EM_MNGMNT_REQ_FID_EXCEED_LIMIT;
    ...
    int unit)
{
    ...
    define->default_data = J2X_INT_MACT_LARGE_EM_LARGE_EM_LEL_FID_EXCEED_LIMIT;

    
    define->data = J2X_INT_MACT_LARGE_EM_LARGE_EM_LEL_FID_EXCEED_LIMIT;
