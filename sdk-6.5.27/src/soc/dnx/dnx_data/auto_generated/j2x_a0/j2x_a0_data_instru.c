...
static shr_error_e
j2x_a0_dnx_data_instru_ifa_ifa2_is_supported_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_instru;
...
static shr_error_e
j2x_a0_dnx_data_instru_hbh_pt_Ingress_1588_ToD_LSB_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_instru;
...
static shr_error_e
j2x_a0_dnx_data_instru_synced_counters_limited_ports_for_pfc_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_instru;
...
static shr_error_e
j2x_a0_dnx_data_instru_synced_counters_nif_write_counter_wrap_around_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_instru;
...
static shr_error_e
j2x_a0_dnx_data_instru_synced_counters_nof_pms_for_pfc_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_instru;
    int submodule_index = dnx_data_instru_submodule_synced_counters;
    int define_index = dnx_data_instru_synced_counters_define_nof_pms_for_pfc;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
j2x_a0_dnx_data_instru_synced_counters_nof_ports_for_pfc_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_instru;
    int submodule_index = dnx_data_instru_submodule_synced_counters;
    int define_index = dnx_data_instru_synced_counters_define_nof_ports_for_pfc;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
j2x_a0_dnx_data_instru_synced_counters_nof_tcs_per_port_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_instru;
    int submodule_index = dnx_data_instru_submodule_synced_counters;
    int define_index = dnx_data_instru_synced_counters_define_nof_tcs_per_port;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_instru_ifa_ifa2_is_supported_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_instru_hbh_pt_Ingress_1588_ToD_LSB_size_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_instru_synced_counters_nif_write_counter_wrap_around_set;
    data_index = dnx_data_instru_synced_counters_define_nof_pms_for_pfc;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_instru_synced_counters_nof_pms_for_pfc_set;
    data_index = dnx_data_instru_synced_counters_define_nof_ports_for_pfc;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_instru_synced_counters_nof_ports_for_pfc_set;
    data_index = dnx_data_instru_synced_counters_define_nof_tcs_per_port;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_instru_synced_counters_nof_tcs_per_port_set;

    
    data_index = dnx_data_instru_synced_counters_limited_ports_for_pfc;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_instru_synced_counters_limited_ports_for_pfc_set;
