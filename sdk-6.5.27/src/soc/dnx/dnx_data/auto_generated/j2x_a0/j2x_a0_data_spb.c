...
static shr_error_e
j2x_a0_dnx_data_spb_ocb_configure_banks_full_threshold_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_spb;
...
static shr_error_e
j2x_a0_dnx_data_spb_ocb_bank_full_threshold_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_spb;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_spb_ocb_bank_full_threshold_bits_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_spb_ocb_configure_banks_full_threshold_set;
