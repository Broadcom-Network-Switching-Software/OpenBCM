...
static shr_error_e
j2x_a0_dnx_data_snif_general_original_destination_is_supported_set(
    int unit)
{
...
static shr_error_e
j2x_a0_dnx_data_snif_ingress_nof_mirror_on_drop_profiles_set(
    int unit)
{
...
static shr_error_e
j2x_a0_dnx_data_snif_egress_probability_sample_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_snif;
    ...
    int unit)
{
    ...
    feature->set = j2x_a0_dnx_data_snif_general_original_destination_is_supported_set;
    ...
    define->set = j2x_a0_dnx_data_snif_ingress_nof_mirror_on_drop_profiles_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_snif_egress_probability_sample_set;
