...
static shr_error_e
j2x_a0_dnx_data_graphical_diag_num_of_rows_set(
    int unit)
{
...
static shr_error_e
j2x_a0_dnx_data_graphical_diag_num_of_index_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_graphical;
...
static shr_error_e
j2x_a0_dnx_data_graphical_diag_num_of_block_entries_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_graphical;
...
static shr_error_e
j2x_a0_dnx_data_graphical_diag_blocks_left_set(
    int unit)
{
    int row_index;
    int index_index;
...
static shr_error_e
j2x_a0_dnx_data_graphical_diag_blocks_right_set(
    int unit)
{
    int row_index;
    int index_index;
...
static shr_error_e
j2x_a0_dnx_data_graphical_diag_counters_set(
    int unit)
{
    int block_index;
    int index_index;
    ...
    if (dnx_graphical_nif_rx < table->keys[0].size && 0 < table->keys[1].size)
    {
        ...
        data->regs[0] = ILU_ILU_RX_NUM_TOTAL_DROPPED_EOPSr;
        data->regs[1] = OFR_RX_TOTAL_PKT_DROP_COUNTERr;
        SHR_RANGE_VERIFY(2, 0, DNX_DIAG_COUNTER_REG_NOF_REGS, _SHR_E_INTERNAL, "out of bound access to array")
        data->flds[0] = ILU_RX_NUM_TOTAL_DROPPED_EOPSf;
        data->flds[1] = RX_TOTAL_PKT_DROP_COUNTERf;
        data->fld_num = 2;
    ...
    if (dnx_graphical_nif_rx < table->keys[0].size && 1 < table->keys[1].size)
    {
        ...
        data->regs[0] = ILU_RX_TOTAL_PKT_COUNTERr;
        data->regs[1] = ARB_RX_PM_TOTAL_INCOMING_PKT_BYTE_COUNTERr;
        data->regs[2] = ARB_RX_TMAC_TOTAL_INCOMING_PKT_BYTE_COUNTERr;
        SHR_RANGE_VERIFY(3, 0, DNX_DIAG_COUNTER_REG_NOF_REGS, _SHR_E_INTERNAL, "out of bound access to array")
        data->flds[0] = RX_TOTAL_PKT_COUNTERf;
        data->flds[1] = RX_PM_N_TOTAL_INCOMING_PKT_COUNTERf;
        data->flds[2] = RX_TMAC_TOTAL_INCOMING_PKT_COUNTERf;
        data->fld_num = 3;
    ...
    if (dnx_graphical_fdr < table->keys[0].size && 3 < table->keys[1].size)
    {
        ...
        data->regs[7] = FDR_FDR_REGISTER_5r;
    ...
    if (dnx_graphical_nif_tx < table->keys[0].size && 0 < table->keys[1].size)
    {
        ...
        data->short_name = "TTL_PKTS";
        SHR_RANGE_VERIFY(3, 0, DNX_DIAG_COUNTER_REG_NOF_REGS, _SHR_E_INTERNAL, "out of bound access to array")
        data->regs[0] = ILU_TX_TOTAL_PKT_COUNTERr;
        data->regs[1] = ARB_TX_PM_TOTAL_OUTGOING_PKT_BYTE_COUNTERr;
        data->regs[2] = ARB_TX_TMAC_TOTAL_OUTGOING_PKT_BYTE_COUNTERr;
        SHR_RANGE_VERIFY(3, 0, DNX_DIAG_COUNTER_REG_NOF_REGS, _SHR_E_INTERNAL, "out of bound access to array")
        data->flds[0] = TX_TOTAL_PKT_COUNTERf;
        data->flds[1] = TX_PM_N_TOTAL_OUTGOING_PKT_COUNTERf;
        data->flds[2] = TX_TMAC_TOTAL_OUTGOING_PKT_COUNTERf;
        data->fld_num = 3;
        data->doc = "Counter for total packets sent  to NIF";
    }
    if (dnx_graphical_nif_tx < table->keys[0].size && 1 < table->keys[1].size)
    {
        ...
        SHR_RANGE_VERIFY(3, 0, DNX_DIAG_COUNTER_REG_NOF_REGS, _SHR_E_INTERNAL, "out of bound access to array")
        data->regs[0] = ILU_TX_TOTAL_BYTE_COUNTERr;
        data->regs[1] = ARB_TX_PM_TOTAL_OUTGOING_PKT_BYTE_COUNTERr;
        data->regs[2] = ARB_TX_TMAC_TOTAL_OUTGOING_PKT_BYTE_COUNTERr;
        SHR_RANGE_VERIFY(3, 0, DNX_DIAG_COUNTER_REG_NOF_REGS, _SHR_E_INTERNAL, "out of bound access to array")
        data->flds[0] = TX_TOTAL_BYTE_COUNTERf;
        data->flds[1] = TX_PM_N_TOTAL_OUTGOING_BYTE_COUNTERf;
        data->flds[2] = TX_TMAC_TOTAL_OUTGOING_BYTE_COUNTERf;
        data->fld_num = 3;
        data->doc = "Counter for total bytes sent to NIF";
    }
    ...
    int unit)
{
    ...
    define->set = j2x_a0_dnx_data_graphical_diag_num_of_rows_set;
    data_index = dnx_data_graphical_diag_define_num_of_index;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_graphical_diag_num_of_index_set;
    data_index = dnx_data_graphical_diag_define_num_of_block_entries;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_graphical_diag_num_of_block_entries_set;
    ...
    table->set = j2x_a0_dnx_data_graphical_diag_blocks_left_set;
    data_index = dnx_data_graphical_diag_table_blocks_right;
    table = &submodule->tables[data_index];
    table->set = j2x_a0_dnx_data_graphical_diag_blocks_right_set;
    data_index = dnx_data_graphical_diag_table_counters;
    table = &submodule->tables[data_index];
    table->set = j2x_a0_dnx_data_graphical_diag_counters_set;
