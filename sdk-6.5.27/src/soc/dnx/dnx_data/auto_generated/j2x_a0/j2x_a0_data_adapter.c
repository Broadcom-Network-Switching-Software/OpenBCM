...
static shr_error_e
j2x_a0_dnx_data_adapter_general_tx_packet_header_signal_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
j2x_a0_dnx_data_adapter_general_tx_packet_tag_swap_res_signal_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
j2x_a0_dnx_data_adapter_general_tx_packet_recycle_command_signal_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
j2x_a0_dnx_data_adapter_general_tx_packet_recycle_context_signal_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
j2x_a0_dnx_data_adapter_general_tx_packet_valid_bytes_signal_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
j2x_a0_dnx_data_adapter_general_tx_packet_header_signal_width_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
j2x_a0_dnx_data_adapter_general_tx_packet_tag_swap_res_signal_width_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
j2x_a0_dnx_data_adapter_general_tx_packet_recycle_command_signal_width_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
j2x_a0_dnx_data_adapter_general_tx_packet_recycle_context_signal_width_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
j2x_a0_dnx_data_adapter_general_tx_packet_valid_bytes_signal_width_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_adapter_general_tx_packet_header_signal_id_set;
    data_index = dnx_data_adapter_general_define_tx_packet_tag_swap_res_signal_id;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_adapter_general_tx_packet_tag_swap_res_signal_id_set;
    data_index = dnx_data_adapter_general_define_tx_packet_recycle_command_signal_id;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_adapter_general_tx_packet_recycle_command_signal_id_set;
    data_index = dnx_data_adapter_general_define_tx_packet_recycle_context_signal_id;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_adapter_general_tx_packet_recycle_context_signal_id_set;
    data_index = dnx_data_adapter_general_define_tx_packet_valid_bytes_signal_id;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_adapter_general_tx_packet_valid_bytes_signal_id_set;
    data_index = dnx_data_adapter_general_define_tx_packet_header_signal_width;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_adapter_general_tx_packet_header_signal_width_set;
    data_index = dnx_data_adapter_general_define_tx_packet_tag_swap_res_signal_width;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_adapter_general_tx_packet_tag_swap_res_signal_width_set;
    data_index = dnx_data_adapter_general_define_tx_packet_recycle_command_signal_width;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_adapter_general_tx_packet_recycle_command_signal_width_set;
    data_index = dnx_data_adapter_general_define_tx_packet_recycle_context_signal_width;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_adapter_general_tx_packet_recycle_context_signal_width_set;
    data_index = dnx_data_adapter_general_define_tx_packet_valid_bytes_signal_width;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_adapter_general_tx_packet_valid_bytes_signal_width_set;
