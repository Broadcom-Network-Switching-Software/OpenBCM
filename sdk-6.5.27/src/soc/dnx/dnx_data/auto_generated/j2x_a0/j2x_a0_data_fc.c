...
static shr_error_e
j2x_a0_dnx_data_fc_general_is_used_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_fc;
    int submodule_index = dnx_data_fc_submodule_general;
    int feature_index = dnx_data_fc_general_is_used;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
j2x_a0_dnx_data_fc_general_power_down_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_fc;
    int submodule_index = dnx_data_fc_submodule_general;
    int feature_index = dnx_data_fc_general_power_down_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
j2x_a0_dnx_data_fc_general_pass_control_frames_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_fc;
    int submodule_index = dnx_data_fc_submodule_general;
    int feature_index = dnx_data_fc_general_pass_control_frames_support;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
j2x_a0_dnx_data_fc_general_pfc_to_stop_pm_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_fc;
    int submodule_index = dnx_data_fc_submodule_general;
    int feature_index = dnx_data_fc_general_pfc_to_stop_pm_support;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    define->default_data = J2X_INT_OFR_PFC_DEADLOCK_BREAKING_MECHANISM_INT;

    
    define->data = J2X_INT_OFR_PFC_DEADLOCK_BREAKING_MECHANISM_INT;
    ...
    int unit)
{
    ...
    data_index = dnx_data_fc_general_is_used;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_fc_general_is_used_set;
    data_index = dnx_data_fc_general_power_down_supported;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_fc_general_power_down_supported_set;
    data_index = dnx_data_fc_general_pass_control_frames_support;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_fc_general_pass_control_frames_support_set;
    data_index = dnx_data_fc_general_pfc_to_stop_pm_support;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_fc_general_pfc_to_stop_pm_support_set;
