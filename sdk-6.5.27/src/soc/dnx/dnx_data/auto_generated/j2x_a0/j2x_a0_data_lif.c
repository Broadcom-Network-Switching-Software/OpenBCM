...
static shr_error_e
j2x_a0_dnx_data_lif_global_lif_prevent_tunnel_update_rif_set(
    int unit)
{
...
static shr_error_e
j2x_a0_dnx_data_lif_global_lif_glem_rif_optimization_enabled_set(
    int unit)
{
...
static shr_error_e
j2x_a0_dnx_data_lif_global_lif_null_lif_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_lif;
...
static shr_error_e
j2x_a0_dnx_data_lif_global_lif_egress_in_lif_null_value_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_lif;
...
static shr_error_e
j2x_a0_dnx_data_lif_global_lif_global_lif_grain_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_lif;
...
static shr_error_e
j2x_a0_dnx_data_lif_in_lif_mapped_in_lif_profile_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_lif;
...
static shr_error_e
j2x_a0_dnx_data_lif_in_lif_in_lif_profile_iop_mode_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_lif;
...
static shr_error_e
j2x_a0_dnx_data_lif_in_lif_separate_ipv4_ipv6_urpf_mode_config_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_lif;
...
static shr_error_e
j2x_a0_dnx_data_lif_in_lif_mc_bridge_fallback_per_lif_profile_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_lif;
...
static shr_error_e
j2x_a0_dnx_data_lif_out_lif_global_outlif_bta_sop_resolution_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_lif;
...
static shr_error_e
j2x_a0_dnx_data_lif_out_lif_global_lif_allocation_estimated_encap_size_enable_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_lif;
...
static shr_error_e
j2x_a0_dnx_data_lif_feature_iop_mode_outlif_selection_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_lif;
...
static shr_error_e
j2x_a0_dnx_data_lif_feature_iop_mode_orientation_selection_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_lif;
...
static shr_error_e
j2x_a0_dnx_data_lif_feature_in_lif_tunnel_wide_data_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_lif;
    ...
    int unit)
{
    ...
    define->set = j2x_a0_dnx_data_lif_global_lif_glem_rif_optimization_enabled_set;
    data_index = dnx_data_lif_global_lif_define_null_lif;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_lif_global_lif_null_lif_set;
    data_index = dnx_data_lif_global_lif_define_egress_in_lif_null_value;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_lif_global_lif_egress_in_lif_null_value_set;
    data_index = dnx_data_lif_global_lif_define_global_lif_grain_size;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_lif_global_lif_global_lif_grain_size_set;

    
    data_index = dnx_data_lif_global_lif_prevent_tunnel_update_rif;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_lif_global_lif_prevent_tunnel_update_rif_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_lif_in_lif_mc_bridge_fallback_per_lif_profile_set;

    
    data_index = dnx_data_lif_in_lif_mapped_in_lif_profile;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_lif_in_lif_mapped_in_lif_profile_set;
    data_index = dnx_data_lif_in_lif_in_lif_profile_iop_mode;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_lif_in_lif_in_lif_profile_iop_mode_set;
    data_index = dnx_data_lif_in_lif_separate_ipv4_ipv6_urpf_mode_config;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_lif_in_lif_separate_ipv4_ipv6_urpf_mode_config_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_lif_out_lif_global_outlif_bta_sop_resolution_set;
    data_index = dnx_data_lif_out_lif_define_global_lif_allocation_estimated_encap_size_enable;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_lif_out_lif_global_lif_allocation_estimated_encap_size_enable_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_lif_feature_iop_mode_outlif_selection_set;
    data_index = dnx_data_lif_feature_iop_mode_orientation_selection;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_lif_feature_iop_mode_orientation_selection_set;
    data_index = dnx_data_lif_feature_in_lif_tunnel_wide_data;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_lif_feature_in_lif_tunnel_wide_data_set;
