...
static shr_error_e
j2x_a0_dnx_data_sch_general_is_used_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_sch;
...
static shr_error_e
j2x_a0_dnx_data_sch_general_power_down_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_sch;
    int submodule_index = dnx_data_sch_submodule_general;
    int feature_index = dnx_data_sch_general_power_down_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
j2x_a0_dnx_data_sch_ps_max_port_rate_mbps_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_sch;
    ...
    int unit)
{
    ...
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_sch_general_is_used_set;
    data_index = dnx_data_sch_general_power_down_supported;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_sch_general_power_down_supported_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_sch_ps_max_port_rate_mbps_set;
