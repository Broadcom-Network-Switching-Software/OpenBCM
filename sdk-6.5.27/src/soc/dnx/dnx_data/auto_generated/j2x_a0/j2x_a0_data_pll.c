    ...
    int unit)
{
    ...
    if (0 < table->keys[0].size)
    {
        ...
        data->in_freq = DNXC_SERDES_REF_CLOCK_312_5;
        data->out_freq = DNXC_SERDES_REF_CLOCK_312_5;
    }
...
static shr_error_e
j2x_a0_dnx_data_pll_pll4_bs_pll_holdover_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_pll;
    int submodule_index = dnx_data_pll_submodule_pll4;
    int feature_index = dnx_data_pll_pll4_bs_pll_holdover_support;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
j2x_a0_dnx_data_pll_pll4_ts_pll_dither_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_pll;
    int submodule_index = dnx_data_pll_submodule_pll4;
    int feature_index = dnx_data_pll_pll4_ts_pll_dither_support;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
j2x_a0_dnx_data_pll_pll4_bs_pll_holdover_enable_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_pll;
    int submodule_index = dnx_data_pll_submodule_pll4;
    int feature_index = dnx_data_pll_pll4_bs_pll_holdover_enable;
    SHR_FUNC_INIT_VARS(unit);
    ...
    feature->property.name = spn_BS_PLL_HOLDOVER_ENABLE;
...
static shr_error_e
j2x_a0_dnx_data_pll_pll4_ts_pll_dither_enable_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_pll;
    int submodule_index = dnx_data_pll_submodule_pll4;
    int feature_index = dnx_data_pll_pll4_ts_pll_dither_enable;
    SHR_FUNC_INIT_VARS(unit);
    ...
    feature->property.name = spn_TS_PLL_DITHER_ENABLE;
    feature->property.doc = 
        "\n"
    ;
    feature->property.method = dnxc_data_property_method_enable;
    ...
    int unit)
{
    ...
    data_index = dnx_data_pll_pll4_bs_pll_holdover_support;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_pll_pll4_bs_pll_holdover_support_set;
    data_index = dnx_data_pll_pll4_ts_pll_dither_support;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_pll_pll4_ts_pll_dither_support_set;
    data_index = dnx_data_pll_pll4_bs_pll_holdover_enable;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_pll_pll4_bs_pll_holdover_enable_set;
    data_index = dnx_data_pll_pll4_ts_pll_dither_enable;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_pll_pll4_ts_pll_dither_enable_set;
