...
static shr_error_e
j2x_a0_dnx_data_dram_general_info_is_power_optimization_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_dram;
    int submodule_index = dnx_data_dram_submodule_general_info;
    int feature_index = dnx_data_dram_general_info_is_power_optimization_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
j2x_a0_dnx_data_dram_general_info_dram_blocks_in_power_down_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
    ...
    define->default_data = dnx_data_nif.global.l1_only_mode_get(unit) == DNX_PORT_NIF_L1_ONLY_MODE_WITH_ILKN || dnx_data_nif.global.l1_only_mode_get(unit) == DNX_PORT_NIF_L1_ONLY_MODE_WITHOUT_ILKN;

    
    define->data = dnx_data_nif.global.l1_only_mode_get(unit) == DNX_PORT_NIF_L1_ONLY_MODE_WITH_ILKN || dnx_data_nif.global.l1_only_mode_get(unit) == DNX_PORT_NIF_L1_ONLY_MODE_WITHOUT_ILKN;
    ...
    int unit)
{
    ...
    table->values[1].default_val = "DATA(dram,general_info,dram_bitmap_internal) * !DATA(dram,general_info,dram_blocks_in_power_down)";
    ...
    default_data->dram_bitmap = dnx_data_dram.general_info.dram_bitmap_internal_get(unit) * !dnx_data_dram.general_info.dram_blocks_in_power_down_get(unit);
    ...
    int unit)
{
    ...
    if (DNX_HBMC_SINGLE_HBM_ATM < table->keys[0].size)
    {
        ...
        data->logical_to_physical[24] = 0x200000;
...
static shr_error_e
j2x_a0_dnx_data_dram_dram_block_dram_block_params_set(
    int unit)
{
    int mechanism_index;
    ...
    if (DNX_DRAM_BLOCK_MECHANISM_WRITE_PLUS_READ < table->keys[0].size)
    {
        ...
        data->increment_threshold_0 = 93 * dnx_data_dram.dram_block.wpr_increment_thr_factor_get(unit) / 100;
        data->increment_threshold_1 = 94 * dnx_data_dram.dram_block.wpr_increment_thr_factor_get(unit) / 100;
    ...
    if (DNX_DRAM_BLOCK_MECHANISM_WRITE < table->keys[0].size)
    {
        ...
        data->increment_threshold_0 = 50 * dnx_data_dram.dram_block.wpr_increment_thr_factor_get(unit) / 100;
        data->increment_threshold_1 = 51 * dnx_data_dram.dram_block.wpr_increment_thr_factor_get(unit) / 100;
        data->increment_threshold_2 = 52 * dnx_data_dram.dram_block.wpr_increment_thr_factor_get(unit) / 100;
        data->increment_size_0 = 2;
        data->increment_size_1 = 3;
        data->increment_size_2 = 4;
        data->decrement_size_0 = 1;
    ...
    if (DNX_DRAM_BLOCK_MECHANISM_AVERAGE_READ_INFLIGHTS < table->keys[0].size)
    {
        ...
        data->increment_threshold_0 = 850;
        data->increment_threshold_1 = 950;
        data->increment_threshold_2 = 1050;
        data->decrement_threshold_0 = 850;
        data->decrement_threshold_1 = 750;
        data->decrement_threshold_2 = 650;
        data->increment_size_0 = 2;
...
static shr_error_e
j2x_a0_dnx_data_dram_firmware_max_timeout_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_dram_general_info_dram_blocks_in_power_down_set;
    ...
    data_index = dnx_data_dram_general_info_is_power_optimization_supported;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_dram_general_info_is_power_optimization_supported_set;
    ...
    table = &submodule->tables[data_index];
    table->set = j2x_a0_dnx_data_dram_dram_block_dram_block_params_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_dram_firmware_max_timeout_set;
