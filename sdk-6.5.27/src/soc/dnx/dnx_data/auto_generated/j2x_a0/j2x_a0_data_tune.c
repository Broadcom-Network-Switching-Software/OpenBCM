...
static shr_error_e
j2x_a0_dnx_data_tune_ecgm_port_dp_ratio_set(
    int unit)
{
    int dp_index;
...
static shr_error_e
j2x_a0_dnx_data_tune_iqs_fmq_max_rate_set(
    int unit)
{
...
static shr_error_e
j2x_a0_dnx_data_tune_fabric_cgm_llfc_pipe_th_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_tune;
...
static shr_error_e
j2x_a0_dnx_data_tune_fabric_cgm_drop_fabric_class_th_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_tune;
...
static shr_error_e
j2x_a0_dnx_data_tune_fabric_cgm_rci_high_sev_min_links_param_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_tune;
    ...
    int unit)
{
    ...
    table->set = j2x_a0_dnx_data_tune_ecgm_port_dp_ratio_set;
    ...
    define->set = j2x_a0_dnx_data_tune_iqs_fmq_max_rate_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_tune_fabric_cgm_llfc_pipe_th_set;
    data_index = dnx_data_tune_fabric_define_cgm_drop_fabric_class_th;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_tune_fabric_cgm_drop_fabric_class_th_set;
    data_index = dnx_data_tune_fabric_define_cgm_rci_high_sev_min_links_param;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_tune_fabric_cgm_rci_high_sev_min_links_param_set;
