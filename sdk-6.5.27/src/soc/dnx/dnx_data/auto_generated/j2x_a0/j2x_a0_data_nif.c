...
static shr_error_e
j2x_a0_dnx_data_nif_global_framer_phy_hw_linkscan_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_global;
    int feature_index = dnx_data_nif_global_framer_phy_hw_linkscan_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
j2x_a0_dnx_data_nif_ilkn_per_port_segmentation_hrf_reset_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_ilkn;
    int feature_index = dnx_data_nif_ilkn_per_port_segmentation_hrf_reset;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
j2x_a0_dnx_data_nif_ilkn_ensure_tx_rx_reset_order_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_ilkn;
    int feature_index = dnx_data_nif_ilkn_ensure_tx_rx_reset_order;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
j2x_a0_dnx_data_nif_ilkn_max_nof_elk_ifs_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
...
static shr_error_e
j2x_a0_dnx_data_nif_eth_tx_fdbk_port_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_eth;
    int feature_index = dnx_data_nif_eth_tx_fdbk_port_supported;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    default_data->measure_rate_on_down_port_supported = 0;
...
static shr_error_e
j2x_a0_dnx_data_nif_flexe_nb_tx_delay_per_pm_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_flexe;
    int feature_index = dnx_data_nif_flexe_nb_tx_delay_per_pm;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
j2x_a0_dnx_data_nif_flexe_nb_tx_fifo_th_for_first_read_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
...
static shr_error_e
j2x_a0_dnx_data_nif_flexe_nb_tx_delay_table_set(
    int unit)
{
    int pm_index_index;
    dnx_data_nif_flexe_nb_tx_delay_table_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_flexe;
    int table_index = dnx_data_nif_flexe_table_nb_tx_delay_table;
    SHR_FUNC_INIT_VARS(unit);
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_nif_flexe_nb_tx_delay_table_t, (1 * (table->keys[0].size) + 1  ), "data of dnx_data_nif_flexe_table_nb_tx_delay_table");

    
    default_data = (dnx_data_nif_flexe_nb_tx_delay_table_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    default_data->val = 0x0;
    
    for (pm_index_index = 0; pm_index_index < table->keys[0].size; pm_index_index++)
    {
        data = (dnx_data_nif_flexe_nb_tx_delay_table_t *) dnxc_data_mgmt_table_data_get(unit, table, pm_index_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
    
    if (0 < table->keys[0].size)
    {
        data = (dnx_data_nif_flexe_nb_tx_delay_table_t *) dnxc_data_mgmt_table_data_get(unit, table, 0, 0);
        data->val = 0;
    }
    if (1 < table->keys[0].size)
    {
        data = (dnx_data_nif_flexe_nb_tx_delay_table_t *) dnxc_data_mgmt_table_data_get(unit, table, 1, 0);
        data->val = 0;
    }
    if (2 < table->keys[0].size)
    {
        data = (dnx_data_nif_flexe_nb_tx_delay_table_t *) dnxc_data_mgmt_table_data_get(unit, table, 2, 0);
        data->val = 2;
    }
    if (3 < table->keys[0].size)
    {
        data = (dnx_data_nif_flexe_nb_tx_delay_table_t *) dnxc_data_mgmt_table_data_get(unit, table, 3, 0);
        data->val = 4;
    }
    if (4 < table->keys[0].size)
    {
        data = (dnx_data_nif_flexe_nb_tx_delay_table_t *) dnxc_data_mgmt_table_data_get(unit, table, 4, 0);
        data->val = 4;
    }
    if (5 < table->keys[0].size)
    {
        data = (dnx_data_nif_flexe_nb_tx_delay_table_t *) dnxc_data_mgmt_table_data_get(unit, table, 5, 0);
        data->val = 2;
    }
    if (6 < table->keys[0].size)
    {
        data = (dnx_data_nif_flexe_nb_tx_delay_table_t *) dnxc_data_mgmt_table_data_get(unit, table, 6, 0);
        data->val = 0;
    }
    if (7 < table->keys[0].size)
    {
        data = (dnx_data_nif_flexe_nb_tx_delay_table_t *) dnxc_data_mgmt_table_data_get(unit, table, 7, 0);
        data->val = 0;
    }
...
static shr_error_e
j2x_a0_dnx_data_nif_prd_flex_key_offset_key_max_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    ...
    int unit)
{
    ...
    feature->default_data = dnx_data_nif.otn.feature_get(unit, dnx_data_nif_otn_is_supported);

    
    feature->data = dnx_data_nif.otn.feature_get(unit, dnx_data_nif_otn_is_supported);
    ...
    int unit)
{
    ...
    data_index = dnx_data_nif_global_framer_phy_hw_linkscan_supported;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_nif_global_framer_phy_hw_linkscan_supported_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_nif_ilkn_max_nof_elk_ifs_set;
    ...
    data_index = dnx_data_nif_ilkn_per_port_segmentation_hrf_reset;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_nif_ilkn_per_port_segmentation_hrf_reset_set;
    data_index = dnx_data_nif_ilkn_legacy_lane_format;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_nif_ilkn_legacy_lane_format_set;
    data_index = dnx_data_nif_ilkn_ensure_tx_rx_reset_order;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_nif_ilkn_ensure_tx_rx_reset_order_set;
    ...
    data_index = dnx_data_nif_eth_tx_fdbk_port_supported;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_nif_eth_tx_fdbk_port_supported_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_nif_flexe_nb_tx_fifo_th_for_first_read_set;
    ...
    data_index = dnx_data_nif_flexe_nb_tx_delay_per_pm;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_nif_flexe_nb_tx_delay_per_pm_set;
    ...
    data_index = dnx_data_nif_flexe_table_nb_tx_delay_table;
    table = &submodule->tables[data_index];
    table->set = j2x_a0_dnx_data_nif_flexe_nb_tx_delay_table_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_nif_prd_flex_key_offset_key_max_set;
