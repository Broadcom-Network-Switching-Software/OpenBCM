...
static shr_error_e
j2x_a0_dnx_data_intr_general_soft_init_for_debug_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_intr;
    int submodule_index = dnx_data_intr_submodule_general;
    int feature_index = dnx_data_intr_general_soft_init_for_debug;
    ...
    int unit)
{
    ...
    table->keys[0].size = 571;
    table->info_get.key_size[0] = 571;
    ...
    if (73 < table->keys[0].size)
    {
        ...
        data->intr = J2X_INT_FDA_AUTO_DOC_NAME_1;
    }
    ...
    if (545 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_active_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 545, 0);
        data->intr = J2X_INT_SCH_ECC_ECC_2B_ERR_INT;
    }
    if (546 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_active_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 546, 0);
        data->intr = J2X_INT_SIF_ECC_ECC_2B_ERR_INT;
    }
    if (547 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_active_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 547, 0);
        data->intr = J2X_INT_SPB_ECC_ECC_2B_ERR_INT;
    }
    if (548 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_active_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 548, 0);
        data->intr = J2X_INT_SQM_ECC_ECC_2B_ERR_INT;
    }
    if (549 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_active_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 549, 0);
        data->intr = J2X_INT_TCAM_ECC_ECC_2B_ERR_INT;
    }
    if (550 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_active_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 550, 0);
        data->intr = J2X_INT_TDU_ECC_ECC_2B_ERR_INT;
    }
    if (551 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_active_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 551, 0);
        data->intr = J2X_INT_TSN_ECC_ECC_2B_ERR_INT;
    }
    if (552 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_active_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 552, 0);
        data->intr = J2X_INT_WB_ECC_ECC_2B_ERR_INT;
    }
    if (553 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_active_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 553, 0);
        data->intr = J2X_INT_TCAM_TCAM_PROTECTION_ERROR_1_BIT_ECC;
    }
    if (554 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_active_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 554, 0);
        data->intr = J2X_INT_TCAM_TCAM_PROTECTION_ERROR_2_BIT_ECC;
    }
    if (555 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_active_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 555, 0);
        data->intr = J2X_INT_KAPS_TECC_A_0_1B_ERROR;
    }
    if (556 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_active_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 556, 0);
        data->intr = J2X_INT_KAPS_TECC_A_0_2B_ERROR;
    }
    if (557 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_active_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 557, 0);
        data->intr = J2X_INT_KAPS_TECC_B_0_1B_ERROR;
    }
    if (558 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_active_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 558, 0);
        data->intr = J2X_INT_KAPS_TECC_B_0_2B_ERROR;
    }
    if (559 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_active_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 559, 0);
        data->intr = J2X_INT_KAPS_TECC_A_1_1B_ERROR;
    }
    if (560 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_active_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 560, 0);
        data->intr = J2X_INT_KAPS_TECC_A_1_2B_ERROR;
    }
    if (561 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_active_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 561, 0);
        data->intr = J2X_INT_KAPS_TECC_B_1_1B_ERROR;
    }
    if (562 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_active_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 562, 0);
        data->intr = J2X_INT_KAPS_TECC_B_1_2B_ERROR;
    }
    if (563 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_active_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 563, 0);
        data->intr = J2X_INT_DDP_DELETE_BDB_FIFO_NOT_EMPTY;
    }
    if (564 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_active_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 564, 0);
        data->intr = J2X_INT_DDP_DELETE_BDB_FIFO_FULL;
    }
    if (565 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_active_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 565, 0);
        data->intr = J2X_INT_RQP_PKT_REAS_INT_VEC;
    }
    if (566 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_active_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 566, 0);
        data->intr = J2X_INT_EPNI_ETPP_TOTAL_INC_ABOVE_TH_WITH_EBD_INT;
    }
    if (567 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_active_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 567, 0);
        data->intr = J2X_INT_EPNI_ETPP_EBD_ERR_INT;
    }
    if (568 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_active_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 568, 0);
        data->intr = J2X_INT_MSW_MACSEC_MACSEC_INTERRUPT_REGISTER;
    }
    if (569 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_active_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 569, 0);
        data->intr = J2X_INT_ECI_NANOSYNC_TAS_TOD_UPDATE;
    }
    if (570 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_active_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 570, 0);
        data->intr = INVALIDr;
    }
    ...
    int unit)
{
    ...
    table->keys[0].size = 78;
    table->info_get.key_size[0] = 78;
    ...
    if (7 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 7, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_2;
    }
    if (8 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 8, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_3;
    }
    if (9 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 9, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_4;
    }
    if (10 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 10, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_5;
    }
    if (11 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 11, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_6;
    }
    if (12 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 12, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_7;
    }
    if (13 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 13, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_8;
    }
    if (14 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 14, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_9;
    }
    if (15 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 15, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_10;
    }
    if (16 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 16, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_11;
    }
    if (17 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 17, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_12;
    }
    if (18 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 18, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_13;
    }
    if (19 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 19, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_14;
    }
    if (20 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 20, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_15;
    }
    if (21 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 21, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_16;
    }
    if (22 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 22, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_17;
    }
    if (23 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 23, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_18;
    }
    if (24 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 24, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_19;
    }
    if (25 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 25, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_20;
    }
    if (26 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 26, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_21;
    }
    if (27 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 27, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_22;
    }
    if (28 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 28, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_23;
    }
    if (29 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 29, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_24;
    }
    if (30 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 30, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_25;
    }
    if (31 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 31, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_26;
    }
    if (32 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 32, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_27;
    }
    if (33 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 33, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_28;
    }
    if (34 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 34, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_29;
    }
    if (35 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 35, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_30;
    }
    if (36 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 36, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_31;
    }
    if (37 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 37, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_32;
    }
    if (38 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 38, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_33;
    }
    if (39 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 39, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_34;
    }
    if (40 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 40, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_35;
    }
    if (41 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 41, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_36;
    }
    if (42 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 42, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_37;
    }
    if (43 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 43, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_38;
    }
    if (44 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 44, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_39;
    }
    if (45 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 45, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_40;
    }
    if (46 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 46, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_41;
    }
    if (47 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 47, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_42;
    }
    if (48 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 48, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_43;
    }
    if (49 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 49, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_44;
    }
    if (50 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 50, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_45;
    }
    if (51 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 51, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_46;
    }
    if (52 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 52, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_47;
    }
    if (53 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 53, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_48;
    }
    if (54 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 54, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_49;
    }
    if (55 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 55, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_50;
    }
    if (56 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 56, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_51;
    }
    if (57 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 57, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_52;
    }
    if (58 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 58, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_53;
    }
    if (59 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 59, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_54;
    }
    if (60 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 60, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_55;
    }
    if (61 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 61, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_56;
    }
    if (62 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 62, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_57;
    }
    if (63 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 63, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_58;
    }
    if (64 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 64, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_59;
    }
    if (65 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 65, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_60;
    }
    if (66 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 66, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_61;
    }
    if (67 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 67, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_62;
    }
    if (68 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 68, 0);
        data->intr = J2X_INT_W40_W_40_FLR_W_40_FLR_INT_63;
    }
    if (69 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 69, 0);
        data->intr = J2X_INT_CDPM_LINK_STATUS_CHANGE_LINK_STATUS_CHANGE_INTERRUPT_REGISTER_0;
    }
    if (70 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 70, 0);
        data->intr = J2X_INT_CDPM_LINK_STATUS_CHANGE_LINK_STATUS_CHANGE_INTERRUPT_REGISTER_1;
    }
    if (71 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 71, 0);
        data->intr = J2X_INT_CDPM_LINK_STATUS_CHANGE_LINK_STATUS_CHANGE_INTERRUPT_REGISTER_2;
    }
    if (72 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 72, 0);
        data->intr = J2X_INT_CDPM_LINK_STATUS_CHANGE_LINK_STATUS_CHANGE_INTERRUPT_REGISTER_3;
    }
    if (73 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 73, 0);
        data->intr = J2X_INT_CDPM_LINK_STATUS_CHANGE_LINK_STATUS_CHANGE_INTERRUPT_REGISTER_4;
    }
    if (74 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 74, 0);
        data->intr = J2X_INT_CDPM_LINK_STATUS_CHANGE_LINK_STATUS_CHANGE_INTERRUPT_REGISTER_5;
    }
    if (75 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 75, 0);
        data->intr = J2X_INT_CDPM_LINK_STATUS_CHANGE_LINK_STATUS_CHANGE_INTERRUPT_REGISTER_6;
    }
    if (76 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 76, 0);
        data->intr = J2X_INT_CDPM_LINK_STATUS_CHANGE_LINK_STATUS_CHANGE_INTERRUPT_REGISTER_7;
    }
    if (77 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_disable_print_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 77, 0);
        data->intr = INVALIDr;
    }
    ...
    int unit)
{
    ...
    if (2 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_skip_clear_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 2, 0);
        data->intr = J2X_INT_CDPM_LINK_STATUS_CHANGE_LINK_STATUS_CHANGE_INTERRUPT_REGISTER_0;
    }
    if (3 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_skip_clear_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 3, 0);
        data->intr = J2X_INT_CDPM_LINK_STATUS_CHANGE_LINK_STATUS_CHANGE_INTERRUPT_REGISTER_1;
    }
    if (4 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_skip_clear_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 4, 0);
        data->intr = J2X_INT_CDPM_LINK_STATUS_CHANGE_LINK_STATUS_CHANGE_INTERRUPT_REGISTER_2;
    }
    if (5 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_skip_clear_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 5, 0);
        data->intr = J2X_INT_CDPM_LINK_STATUS_CHANGE_LINK_STATUS_CHANGE_INTERRUPT_REGISTER_3;
    }
    if (6 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_skip_clear_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 6, 0);
        data->intr = J2X_INT_CDPM_LINK_STATUS_CHANGE_LINK_STATUS_CHANGE_INTERRUPT_REGISTER_4;
    }
    if (7 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_skip_clear_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 7, 0);
        data->intr = J2X_INT_CDPM_LINK_STATUS_CHANGE_LINK_STATUS_CHANGE_INTERRUPT_REGISTER_5;
    }
    if (8 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_skip_clear_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 8, 0);
        data->intr = J2X_INT_CDPM_LINK_STATUS_CHANGE_LINK_STATUS_CHANGE_INTERRUPT_REGISTER_6;
    }
    if (9 < table->keys[0].size)
    {
        data = (dnx_data_intr_general_skip_clear_on_init_t *) dnxc_data_mgmt_table_data_get(unit, table, 9, 0);
        data->intr = J2X_INT_CDPM_LINK_STATUS_CHANGE_LINK_STATUS_CHANGE_INTERRUPT_REGISTER_7;
    }
    ...
    int unit)
{
    ...
    table->keys[0].size = 159;
    table->info_get.key_size[0] = 159;
    ...
    if (0 < table->keys[0].size)
    {
        ...
        data->reg = ARB_ECC_ERR_1B_MONITOR_MEM_MASKr;
    ...
    if (29 < table->keys[0].size)
    {
        ...
        data->reg = FRWA_ECC_ERR_1B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (30 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 30, 0);
        data->reg = FRWBC_ECC_ERR_1B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (31 < table->keys[0].size)
    {
    ...
    if (55 < table->keys[0].size)
    {
        ...
        data->reg = OFR_ECC_ERR_1B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (56 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 56, 0);
        data->reg = OFT_ECC_ERR_1B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (57 < table->keys[0].size)
    {
    ...
    if (100 < table->keys[0].size)
    {
        ...
        data->reg = FRWA_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (101 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 101, 0);
        data->reg = FRWBC_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (102 < table->keys[0].size)
    {
    ...
    if (126 < table->keys[0].size)
    {
        ...
        data->reg = OFR_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (127 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 127, 0);
        data->reg = OFT_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (128 < table->keys[0].size)
    {
    ...
    if (140 < table->keys[0].size)
    {
        ...
        data->reg = TSN_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (141 < table->keys[0].size)
    {
        data = (dnx_data_intr_ser_mem_mask_t *) dnxc_data_mgmt_table_data_get(unit, table, 141, 0);
        data->reg = WB_ECC_ERR_2B_MONITOR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (142 < table->keys[0].size)
    {
    ...
    int unit)
{
    ...
    if (0 < table->keys[0].size)
    {
        ...
        data->mem = ARB_TX_BYPASS_DATA_FIFOm;
    ...
    int unit)
{
    ...
    data_index = dnx_data_intr_general_soft_init_for_debug;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_intr_general_soft_init_for_debug_set;
