    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_fifodma_general_define_nof_fifodma_channels].doc = "";
    ...
    submodule_data->defines[dnx_data_fifodma_general_define_min_nof_host_entries].doc = "";
    ...
    submodule_data->defines[dnx_data_fifodma_general_define_max_nof_host_entries].doc = "";
    ...
    submodule_data->tables[dnx_data_fifodma_general_table_fifodma_map].doc = "";
    ...
    submodule_data->tables[dnx_data_fifodma_general_table_fifodma_map].keys[0].doc = "";

    
    submodule_data->tables[dnx_data_fifodma_general_table_fifodma_map].nof_values = 3;
    ...
    submodule_data->tables[dnx_data_fifodma_general_table_fifodma_map].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_fifodma_general_table_fifodma_map].values[1].name = "target_fifoid";
    submodule_data->tables[dnx_data_fifodma_general_table_fifodma_map].values[1].type = "int";
    submodule_data->tables[dnx_data_fifodma_general_table_fifodma_map].values[1].doc = "";
    submodule_data->tables[dnx_data_fifodma_general_table_fifodma_map].values[1].offset = UTILEX_OFFSETOF(dnx_data_fifodma_general_fifodma_map_t, target_fifoid);
    submodule_data->tables[dnx_data_fifodma_general_table_fifodma_map].values[2].name = "fifo_counter_if";
    submodule_data->tables[dnx_data_fifodma_general_table_fifodma_map].values[2].type = "int";
    submodule_data->tables[dnx_data_fifodma_general_table_fifodma_map].values[2].doc = "";
    submodule_data->tables[dnx_data_fifodma_general_table_fifodma_map].values[2].offset = UTILEX_OFFSETOF(dnx_data_fifodma_general_fifodma_map_t, fifo_counter_if);
    ...
    int value_index)
{
    ...
    switch (value_index)
    {
        case 0:
            ...
            break;
        case 1:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->target_fifoid);
            break;
        case 2:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->fifo_counter_if);
            break;
    }
