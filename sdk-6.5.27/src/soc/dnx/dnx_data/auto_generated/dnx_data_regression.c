    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_regression_dvapi_topology_table_pm_ext_loops].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_regression_dvapi_topology_table_pm_p2p_links].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_regression_dvapi_topology_table_pm_p2p_links].values[1].doc = "";
    ...
    submodule_data->tables[dnx_data_regression_dvapi_topology_table_pm_force_er].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_regression_dvapi_topology_table_pm_test_limitations].values[0].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_regression_ser_parameters_table_cgm_ipp_map].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_regression_ser_parameters_table_cgm_voq_dram_bound_prms].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_regression_ser_parameters_table_cgm_voq_dram_bound_prms_2].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_regression_ser_parameters_table_cgm_voq_dram_recovery_prms].values[0].doc = "";
    ...
    submodule_data->tables[dnx_data_regression_ser_parameters_table_cgm_voq_dram_recovery_prms_2].values[0].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_regression_source_info_table_tlist].values[0].doc = "";
