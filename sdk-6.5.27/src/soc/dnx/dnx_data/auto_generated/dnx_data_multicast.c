    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_multicast_params_table_olp_ing_multicast_id].name = "olp_ing_multicast_id";
    submodule_data->tables[dnx_data_multicast_params_table_olp_ing_multicast_id].doc = "";
    submodule_data->tables[dnx_data_multicast_params_table_olp_ing_multicast_id].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_multicast_params_table_olp_ing_multicast_id].size_of_values = sizeof(dnx_data_multicast_params_olp_ing_multicast_id_t);
    submodule_data->tables[dnx_data_multicast_params_table_olp_ing_multicast_id].entry_get = dnx_data_multicast_params_olp_ing_multicast_id_entry_str_get;

    
    submodule_data->tables[dnx_data_multicast_params_table_olp_ing_multicast_id].nof_keys = 1;
    submodule_data->tables[dnx_data_multicast_params_table_olp_ing_multicast_id].keys[0].name = "cores_group";
    submodule_data->tables[dnx_data_multicast_params_table_olp_ing_multicast_id].keys[0].doc = "";

    
    submodule_data->tables[dnx_data_multicast_params_table_olp_ing_multicast_id].nof_values = 1;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_multicast_params_table_olp_ing_multicast_id].values, dnxc_data_value_t, submodule_data->tables[dnx_data_multicast_params_table_olp_ing_multicast_id].nof_values, "_dnx_data_multicast_params_table_olp_ing_multicast_id table values");
    submodule_data->tables[dnx_data_multicast_params_table_olp_ing_multicast_id].values[0].name = "multicast_id";
    submodule_data->tables[dnx_data_multicast_params_table_olp_ing_multicast_id].values[0].type = "uint32";
    submodule_data->tables[dnx_data_multicast_params_table_olp_ing_multicast_id].values[0].doc = "";
    submodule_data->tables[dnx_data_multicast_params_table_olp_ing_multicast_id].values[0].offset = UTILEX_OFFSETOF(dnx_data_multicast_params_olp_ing_multicast_id_t, multicast_id);
...
const dnx_data_multicast_params_olp_ing_multicast_id_t *
dnx_data_multicast_params_olp_ing_multicast_id_get(
    int unit,
    int cores_group)
{
    char *data;
    ...
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_multicast, dnx_data_multicast_submodule_params, dnx_data_multicast_params_table_olp_ing_multicast_id);
    
    data = dnxc_data_mgmt_table_data_get(unit, table, cores_group, 0);
    return (const dnx_data_multicast_params_olp_ing_multicast_id_t *) data;

}


shr_error_e
dnx_data_multicast_params_olp_ing_multicast_id_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_multicast_params_olp_ing_multicast_id_t *data;
    SHR_FUNC_INIT_VARS(unit);

    
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_multicast, dnx_data_multicast_submodule_params, dnx_data_multicast_params_table_olp_ing_multicast_id);
    data = (const dnx_data_multicast_params_olp_ing_multicast_id_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->multicast_id);
            break;
    }
...
dnx_data_multicast_params_olp_ing_multicast_id_info_get(
    int unit)
{

    
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_multicast, dnx_data_multicast_submodule_params, dnx_data_multicast_params_table_olp_ing_multicast_id);
