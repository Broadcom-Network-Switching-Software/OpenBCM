    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_failover_facility_protection_any_hierarchy_supported].name = "protection_any_hierarchy_supported";
    submodule_data->features[dnx_data_failover_facility_protection_any_hierarchy_supported].doc = "";
    submodule_data->features[dnx_data_failover_facility_protection_any_hierarchy_supported].flags |= DNXC_DATA_F_FEATURE;
