    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_port_pp_general_rcy_info_prt_qualifier_eth_over_append64_support].name = "rcy_info_prt_qualifier_eth_over_append64_support";
    submodule_data->features[dnx_data_port_pp_general_rcy_info_prt_qualifier_eth_over_append64_support].doc = "";
    submodule_data->features[dnx_data_port_pp_general_rcy_info_prt_qualifier_eth_over_append64_support].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_port_pp_general_prt_qualifier_injected_2_jr1_reserved_parsing_context_support].name = "prt_qualifier_injected_2_jr1_reserved_parsing_context_support";
    submodule_data->features[dnx_data_port_pp_general_prt_qualifier_injected_2_jr1_reserved_parsing_context_support].doc = "";
    submodule_data->features[dnx_data_port_pp_general_prt_qualifier_injected_2_jr1_reserved_parsing_context_support].flags |= DNXC_DATA_F_FEATURE;
