    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_lif_in_lif_in_lif_profile_mc_bridge_fallback_support].name = "in_lif_profile_mc_bridge_fallback_support";
    submodule_data->features[dnx_data_lif_in_lif_in_lif_profile_mc_bridge_fallback_support].doc = "";
    submodule_data->features[dnx_data_lif_in_lif_in_lif_profile_mc_bridge_fallback_support].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_lif_in_lif_separate_ipv4_ipv6_urpf_mode_config].name = "separate_ipv4_ipv6_urpf_mode_config";
    submodule_data->features[dnx_data_lif_in_lif_separate_ipv4_ipv6_urpf_mode_config].doc = "";
    submodule_data->features[dnx_data_lif_in_lif_separate_ipv4_ipv6_urpf_mode_config].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_lif_in_lif_ingress_interface_vip_supported].name = "ingress_interface_vip_supported";
    submodule_data->features[dnx_data_lif_in_lif_ingress_interface_vip_supported].doc = "";
    submodule_data->features[dnx_data_lif_in_lif_ingress_interface_vip_supported].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_lif_in_lif_vxlan_vni2lif_supported].name = "vxlan_vni2lif_supported";
    submodule_data->features[dnx_data_lif_in_lif_vxlan_vni2lif_supported].doc = "";
    submodule_data->features[dnx_data_lif_in_lif_vxlan_vni2lif_supported].flags |= DNXC_DATA_F_FEATURE;
    ...
    submodule_data->defines[dnx_data_lif_in_lif_define_max_nof_per_core_inlifs_ratio].name = "max_nof_per_core_inlifs_ratio";
    submodule_data->defines[dnx_data_lif_in_lif_define_max_nof_per_core_inlifs_ratio].doc = "";
    
    submodule_data->defines[dnx_data_lif_in_lif_define_max_nof_per_core_inlifs_ratio].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_lif_in_lif_define_generic_data_1_start_position].name = "generic_data_1_start_position";
    submodule_data->defines[dnx_data_lif_in_lif_define_generic_data_1_start_position].doc = "";
    
    submodule_data->defines[dnx_data_lif_in_lif_define_generic_data_1_start_position].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_lif_in_lif_max_nof_per_core_inlifs_ratio_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_lif, dnx_data_lif_submodule_in_lif, dnx_data_lif_in_lif_define_max_nof_per_core_inlifs_ratio);
}

uint32
dnx_data_lif_in_lif_generic_data_1_start_position_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_lif, dnx_data_lif_submodule_in_lif, dnx_data_lif_in_lif_define_generic_data_1_start_position);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_lif_out_lif_table_logical_to_physical_phase_map].values[0].doc = "";
