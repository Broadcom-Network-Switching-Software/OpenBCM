    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_mdb_global_mdb_access_version].name = "mdb_access_version";
    submodule_data->features[dnx_data_mdb_global_mdb_access_version].doc = "";
    submodule_data->features[dnx_data_mdb_global_mdb_access_version].flags |= DNXC_DATA_F_FEATURE;
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_mdb_dh_table_logical_macro_info].nof_values = 3;
    ...
    submodule_data->tables[dnx_data_mdb_dh_table_logical_macro_info].values[2].name = "is_dpc";
    submodule_data->tables[dnx_data_mdb_dh_table_logical_macro_info].values[2].type = "int";
    submodule_data->tables[dnx_data_mdb_dh_table_logical_macro_info].values[2].doc = "";
    submodule_data->tables[dnx_data_mdb_dh_table_logical_macro_info].values[2].offset = UTILEX_OFFSETOF(dnx_data_mdb_dh_logical_macro_info_t, is_dpc);
    ...
    submodule_data->tables[dnx_data_mdb_dh_table_macro_type_info].nof_values = 9;
    ...
    submodule_data->tables[dnx_data_mdb_dh_table_macro_type_info].values[8].name = "blk_core_group_inc";
    submodule_data->tables[dnx_data_mdb_dh_table_macro_type_info].values[8].type = "uint8";
    submodule_data->tables[dnx_data_mdb_dh_table_macro_type_info].values[8].doc = "";
    submodule_data->tables[dnx_data_mdb_dh_table_macro_type_info].values[8].offset = UTILEX_OFFSETOF(dnx_data_mdb_dh_macro_type_info_t, blk_core_group_inc);
    ...
    submodule_data->tables[dnx_data_mdb_dh_table_macro_global_indexes].name = "macro_global_indexes";
    submodule_data->tables[dnx_data_mdb_dh_table_macro_global_indexes].doc = "";
    submodule_data->tables[dnx_data_mdb_dh_table_macro_global_indexes].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_mdb_dh_table_macro_global_indexes].size_of_values = sizeof(dnx_data_mdb_dh_macro_global_indexes_t);
    submodule_data->tables[dnx_data_mdb_dh_table_macro_global_indexes].entry_get = dnx_data_mdb_dh_macro_global_indexes_entry_str_get;

    
    submodule_data->tables[dnx_data_mdb_dh_table_macro_global_indexes].nof_keys = 0;

    
    submodule_data->tables[dnx_data_mdb_dh_table_macro_global_indexes].nof_values = 2;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_mdb_dh_table_macro_global_indexes].values, dnxc_data_value_t, submodule_data->tables[dnx_data_mdb_dh_table_macro_global_indexes].nof_values, "_dnx_data_mdb_dh_table_macro_global_indexes table values");
    submodule_data->tables[dnx_data_mdb_dh_table_macro_global_indexes].values[0].name = "is_valid";
    submodule_data->tables[dnx_data_mdb_dh_table_macro_global_indexes].values[0].type = "uint32[2]";
    submodule_data->tables[dnx_data_mdb_dh_table_macro_global_indexes].values[0].doc = "";
    submodule_data->tables[dnx_data_mdb_dh_table_macro_global_indexes].values[0].offset = UTILEX_OFFSETOF(dnx_data_mdb_dh_macro_global_indexes_t, is_valid);
    submodule_data->tables[dnx_data_mdb_dh_table_macro_global_indexes].values[1].name = "total_nof_active_macroes";
    submodule_data->tables[dnx_data_mdb_dh_table_macro_global_indexes].values[1].type = "uint32";
    submodule_data->tables[dnx_data_mdb_dh_table_macro_global_indexes].values[1].doc = "";
    submodule_data->tables[dnx_data_mdb_dh_table_macro_global_indexes].values[1].offset = UTILEX_OFFSETOF(dnx_data_mdb_dh_macro_global_indexes_t, total_nof_active_macroes);
...
const dnx_data_mdb_dh_macro_global_indexes_t *
dnx_data_mdb_dh_macro_global_indexes_get(
    int unit)
{
    char *data;
    dnxc_data_table_t *table;
    ...
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_mdb, dnx_data_mdb_submodule_dh, dnx_data_mdb_dh_table_macro_global_indexes);
    
    data = dnxc_data_mgmt_table_data_get(unit, table, 0, 0);
    return (const dnx_data_mdb_dh_macro_global_indexes_t *) data;
    ...
    int value_index)
{
    ...
    switch (value_index)
    {
        ...
        case 1:
            ...
            break;
        case 2:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->is_dpc);
            break;
    }
    ...
    int value_index)
{
    ...
    switch (value_index)
    {
        ...
        case 7:
            ...
            break;
        case 8:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->blk_core_group_inc);
            break;
    }
...
shr_error_e
dnx_data_mdb_dh_macro_global_indexes_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_mdb_dh_macro_global_indexes_t *data;
    SHR_FUNC_INIT_VARS(unit);

    
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_mdb, dnx_data_mdb_submodule_dh, dnx_data_mdb_dh_table_macro_global_indexes);
    data = (const dnx_data_mdb_dh_macro_global_indexes_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, 0, 0);
    switch (value_index)
    {
        case 0:
            DNXC_DATA_MGMT_ARR_STR(buffer, 2, data->is_valid);
            break;
        case 1:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->total_nof_active_macroes);
            break;
    }
...
const dnxc_data_table_info_t *
dnx_data_mdb_dh_macro_global_indexes_info_get(
    int unit)
{

    
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_mdb, dnx_data_mdb_submodule_dh, dnx_data_mdb_dh_table_macro_global_indexes);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_mdb_pdbs_define_table_mdb_kaps_dynamic_memory_access_memory_access_field_size].name = "table_mdb_kaps_dynamic_memory_access_memory_access_field_size";
    submodule_data->defines[dnx_data_mdb_pdbs_define_table_mdb_kaps_dynamic_memory_access_memory_access_field_size].doc = "";
    
    submodule_data->defines[dnx_data_mdb_pdbs_define_table_mdb_kaps_dynamic_memory_access_memory_access_field_size].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_mdb_pdbs_define_table_mdb_ddha_dynamic_memory_access_memory_access_field_size].name = "table_mdb_ddha_dynamic_memory_access_memory_access_field_size";
    submodule_data->defines[dnx_data_mdb_pdbs_define_table_mdb_ddha_dynamic_memory_access_memory_access_field_size].doc = "";
    
    submodule_data->defines[dnx_data_mdb_pdbs_define_table_mdb_ddha_dynamic_memory_access_memory_access_field_size].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_mdb_pdbs_define_table_ddha_dynamic_memory_access_memory_access_field_size].name = "table_ddha_dynamic_memory_access_memory_access_field_size";
    submodule_data->defines[dnx_data_mdb_pdbs_define_table_ddha_dynamic_memory_access_memory_access_field_size].doc = "";
    
    submodule_data->defines[dnx_data_mdb_pdbs_define_table_ddha_dynamic_memory_access_memory_access_field_size].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_mdb_pdbs_define_table_ddhab_dynamic_memory_access_memory_access_field_size].name = "table_ddhab_dynamic_memory_access_memory_access_field_size";
    submodule_data->defines[dnx_data_mdb_pdbs_define_table_ddhab_dynamic_memory_access_memory_access_field_size].doc = "";
    
    submodule_data->defines[dnx_data_mdb_pdbs_define_table_ddhab_dynamic_memory_access_memory_access_field_size].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_mdb_pdbs_define_table_mdba_dynamic_memory_access_memory_access_field_size].name = "table_mdba_dynamic_memory_access_memory_access_field_size";
    submodule_data->defines[dnx_data_mdb_pdbs_define_table_mdba_dynamic_memory_access_memory_access_field_size].doc = "";
    
    submodule_data->defines[dnx_data_mdb_pdbs_define_table_mdba_dynamic_memory_access_memory_access_field_size].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_mdb_pdbs_define_table_mdbb_dynamic_memory_access_memory_access_field_size].name = "table_mdbb_dynamic_memory_access_memory_access_field_size";
    submodule_data->defines[dnx_data_mdb_pdbs_define_table_mdbb_dynamic_memory_access_memory_access_field_size].doc = "";
    
    submodule_data->defines[dnx_data_mdb_pdbs_define_table_mdbb_dynamic_memory_access_memory_access_field_size].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_mdb_pdbs_define_table_mdbk_dynamic_memory_access_memory_access_field_size].name = "table_mdbk_dynamic_memory_access_memory_access_field_size";
    submodule_data->defines[dnx_data_mdb_pdbs_define_table_mdbk_dynamic_memory_access_memory_access_field_size].doc = "";
    
    submodule_data->defines[dnx_data_mdb_pdbs_define_table_mdbk_dynamic_memory_access_memory_access_field_size].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_mdb_pdbs_table_mdb_kaps_dynamic_memory_access_memory_access_field_size_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_mdb, dnx_data_mdb_submodule_pdbs, dnx_data_mdb_pdbs_define_table_mdb_kaps_dynamic_memory_access_memory_access_field_size);
}

uint32
dnx_data_mdb_pdbs_table_mdb_ddha_dynamic_memory_access_memory_access_field_size_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_mdb, dnx_data_mdb_submodule_pdbs, dnx_data_mdb_pdbs_define_table_mdb_ddha_dynamic_memory_access_memory_access_field_size);
}

uint32
dnx_data_mdb_pdbs_table_ddha_dynamic_memory_access_memory_access_field_size_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_mdb, dnx_data_mdb_submodule_pdbs, dnx_data_mdb_pdbs_define_table_ddha_dynamic_memory_access_memory_access_field_size);
}

uint32
dnx_data_mdb_pdbs_table_ddhab_dynamic_memory_access_memory_access_field_size_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_mdb, dnx_data_mdb_submodule_pdbs, dnx_data_mdb_pdbs_define_table_ddhab_dynamic_memory_access_memory_access_field_size);
}

uint32
dnx_data_mdb_pdbs_table_mdba_dynamic_memory_access_memory_access_field_size_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_mdb, dnx_data_mdb_submodule_pdbs, dnx_data_mdb_pdbs_define_table_mdba_dynamic_memory_access_memory_access_field_size);
}

uint32
dnx_data_mdb_pdbs_table_mdbb_dynamic_memory_access_memory_access_field_size_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_mdb, dnx_data_mdb_submodule_pdbs, dnx_data_mdb_pdbs_define_table_mdbb_dynamic_memory_access_memory_access_field_size);
}

uint32
dnx_data_mdb_pdbs_table_mdbk_dynamic_memory_access_memory_access_field_size_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_mdb, dnx_data_mdb_submodule_pdbs, dnx_data_mdb_pdbs_define_table_mdbk_dynamic_memory_access_memory_access_field_size);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_mdb_em_table_compare_size].name = "compare_size";
    submodule_data->tables[dnx_data_mdb_em_table_compare_size].doc = "";
    submodule_data->tables[dnx_data_mdb_em_table_compare_size].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_mdb_em_table_compare_size].size_of_values = sizeof(dnx_data_mdb_em_compare_size_t);
    submodule_data->tables[dnx_data_mdb_em_table_compare_size].entry_get = dnx_data_mdb_em_compare_size_entry_str_get;

    
    submodule_data->tables[dnx_data_mdb_em_table_compare_size].nof_keys = 1;
    submodule_data->tables[dnx_data_mdb_em_table_compare_size].keys[0].name = "entry_size";
    submodule_data->tables[dnx_data_mdb_em_table_compare_size].keys[0].doc = "";

    
    submodule_data->tables[dnx_data_mdb_em_table_compare_size].nof_values = 1;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_mdb_em_table_compare_size].values, dnxc_data_value_t, submodule_data->tables[dnx_data_mdb_em_table_compare_size].nof_values, "_dnx_data_mdb_em_table_compare_size table values");
    submodule_data->tables[dnx_data_mdb_em_table_compare_size].values[0].name = "max_compare_size";
    submodule_data->tables[dnx_data_mdb_em_table_compare_size].values[0].type = "uint8";
    submodule_data->tables[dnx_data_mdb_em_table_compare_size].values[0].doc = "";
    submodule_data->tables[dnx_data_mdb_em_table_compare_size].values[0].offset = UTILEX_OFFSETOF(dnx_data_mdb_em_compare_size_t, max_compare_size);
    ...
    submodule_data->tables[dnx_data_mdb_em_table_mdb_24_info].nof_values = 5;
    ...
    submodule_data->tables[dnx_data_mdb_em_table_mdb_24_info].values[2].name = "mdb_item_0_field_size";
    ...
    submodule_data->tables[dnx_data_mdb_em_table_mdb_24_info].values[2].offset = UTILEX_OFFSETOF(dnx_data_mdb_em_mdb_24_info_t, mdb_item_0_field_size);
    submodule_data->tables[dnx_data_mdb_em_table_mdb_24_info].values[3].name = "mdb_item_1_array_size";
    ...
    submodule_data->tables[dnx_data_mdb_em_table_mdb_24_info].values[3].offset = UTILEX_OFFSETOF(dnx_data_mdb_em_mdb_24_info_t, mdb_item_1_array_size);
    submodule_data->tables[dnx_data_mdb_em_table_mdb_24_info].values[4].name = "mdb_item_1_field_size";
    submodule_data->tables[dnx_data_mdb_em_table_mdb_24_info].values[4].type = "uint32";
    submodule_data->tables[dnx_data_mdb_em_table_mdb_24_info].values[4].doc = "";
    submodule_data->tables[dnx_data_mdb_em_table_mdb_24_info].values[4].offset = UTILEX_OFFSETOF(dnx_data_mdb_em_mdb_24_info_t, mdb_item_1_field_size);
...
const dnx_data_mdb_em_compare_size_t *
dnx_data_mdb_em_compare_size_get(
    int unit,
    int entry_size)
{
    char *data;
    ...
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_mdb, dnx_data_mdb_submodule_em, dnx_data_mdb_em_table_compare_size);
    
    data = dnxc_data_mgmt_table_data_get(unit, table, entry_size, 0);
    return (const dnx_data_mdb_em_compare_size_t *) data;
...
shr_error_e
dnx_data_mdb_em_compare_size_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_mdb_em_compare_size_t *data;
    SHR_FUNC_INIT_VARS(unit);

    
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_mdb, dnx_data_mdb_submodule_em, dnx_data_mdb_em_table_compare_size);
    data = (const dnx_data_mdb_em_compare_size_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->max_compare_size);
            break;
    }
...
const dnxc_data_table_info_t *
dnx_data_mdb_em_compare_size_info_get(
    int unit)
{

    
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_mdb, dnx_data_mdb_submodule_em, dnx_data_mdb_em_table_compare_size);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_mdb_direct_define_nof_fec_dbs].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_mdb_kaps_define_mdb_lpm_blackhole_mode_enable].name = "mdb_lpm_blackhole_mode_enable";
    submodule_data->defines[dnx_data_mdb_kaps_define_mdb_lpm_blackhole_mode_enable].doc = "";
    
    submodule_data->defines[dnx_data_mdb_kaps_define_mdb_lpm_blackhole_mode_enable].flags |= DNXC_DATA_F_NUMERIC;
    ...
    submodule_data->tables[dnx_data_mdb_kaps_table_kaps_lookup_result].nof_values = 6;
    ...
    submodule_data->tables[dnx_data_mdb_kaps_table_kaps_lookup_result].values[1].name = "payload_field";
    submodule_data->tables[dnx_data_mdb_kaps_table_kaps_lookup_result].values[1].type = "uint32";
    submodule_data->tables[dnx_data_mdb_kaps_table_kaps_lookup_result].values[1].doc = "";
    submodule_data->tables[dnx_data_mdb_kaps_table_kaps_lookup_result].values[1].offset = UTILEX_OFFSETOF(dnx_data_mdb_kaps_kaps_lookup_result_t, payload_field);
    submodule_data->tables[dnx_data_mdb_kaps_table_kaps_lookup_result].values[2].name = "prefix_length_field";
    submodule_data->tables[dnx_data_mdb_kaps_table_kaps_lookup_result].values[2].type = "uint32";
    submodule_data->tables[dnx_data_mdb_kaps_table_kaps_lookup_result].values[2].doc = "";
    submodule_data->tables[dnx_data_mdb_kaps_table_kaps_lookup_result].values[2].offset = UTILEX_OFFSETOF(dnx_data_mdb_kaps_kaps_lookup_result_t, prefix_length_field);
    submodule_data->tables[dnx_data_mdb_kaps_table_kaps_lookup_result].values[3].name = "result_found_field";
    submodule_data->tables[dnx_data_mdb_kaps_table_kaps_lookup_result].values[3].type = "uint32";
    submodule_data->tables[dnx_data_mdb_kaps_table_kaps_lookup_result].values[3].doc = "";
    submodule_data->tables[dnx_data_mdb_kaps_table_kaps_lookup_result].values[3].offset = UTILEX_OFFSETOF(dnx_data_mdb_kaps_kaps_lookup_result_t, result_found_field);
    submodule_data->tables[dnx_data_mdb_kaps_table_kaps_lookup_result].values[4].name = "result_error_field";
    submodule_data->tables[dnx_data_mdb_kaps_table_kaps_lookup_result].values[4].type = "uint32";
    submodule_data->tables[dnx_data_mdb_kaps_table_kaps_lookup_result].values[4].doc = "";
    submodule_data->tables[dnx_data_mdb_kaps_table_kaps_lookup_result].values[4].offset = UTILEX_OFFSETOF(dnx_data_mdb_kaps_kaps_lookup_result_t, result_error_field);
    submodule_data->tables[dnx_data_mdb_kaps_table_kaps_lookup_result].values[5].name = "result_type_field";
    submodule_data->tables[dnx_data_mdb_kaps_table_kaps_lookup_result].values[5].type = "uint32";
    submodule_data->tables[dnx_data_mdb_kaps_table_kaps_lookup_result].values[5].doc = "";
    submodule_data->tables[dnx_data_mdb_kaps_table_kaps_lookup_result].values[5].offset = UTILEX_OFFSETOF(dnx_data_mdb_kaps_kaps_lookup_result_t, result_type_field);
...
uint32
dnx_data_mdb_kaps_mdb_lpm_blackhole_mode_enable_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_mdb, dnx_data_mdb_submodule_kaps, dnx_data_mdb_kaps_define_mdb_lpm_blackhole_mode_enable);
}
    ...
    int value_index)
{
    ...
    switch (value_index)
    {
        case 0:
            ...
            break;
        case 1:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->payload_field);
            break;
        case 2:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->prefix_length_field);
            break;
        case 3:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->result_found_field);
            break;
        case 4:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->result_error_field);
            break;
        case 5:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->result_type_field);
            break;
    }
