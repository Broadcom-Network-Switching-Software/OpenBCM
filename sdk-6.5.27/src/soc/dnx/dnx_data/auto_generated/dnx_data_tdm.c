...
extern shr_error_e j2x_a0_data_tdm_attach(
    int unit);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_tdm_params_is_supported].doc = "";
    submodule_data->features[dnx_data_tdm_params_is_supported].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_tdm_params_is_egress_bypass_supported].name = "is_egress_bypass_supported";
    submodule_data->features[dnx_data_tdm_params_is_egress_bypass_supported].doc = "";
    submodule_data->features[dnx_data_tdm_params_is_egress_bypass_supported].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_tdm_params_is_sid_wide_mode_supported].name = "is_sid_wide_mode_supported";
    submodule_data->features[dnx_data_tdm_params_is_sid_wide_mode_supported].doc = "";
    submodule_data->features[dnx_data_tdm_params_is_sid_wide_mode_supported].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_tdm_params_egress_bypass_enable].name = "egress_bypass_enable";
    submodule_data->features[dnx_data_tdm_params_egress_bypass_enable].doc = "";
    submodule_data->features[dnx_data_tdm_params_egress_bypass_enable].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_tdm_params_bypass_port_is_ingress_tm].name = "bypass_port_is_ingress_tm";
    submodule_data->features[dnx_data_tdm_params_bypass_port_is_ingress_tm].doc = "";
    submodule_data->features[dnx_data_tdm_params_bypass_port_is_ingress_tm].flags |= DNXC_DATA_F_FEATURE;
    ...
    submodule_data->defines[dnx_data_tdm_params_define_context_map_base_size].doc = "";
    ...
    submodule_data->defines[dnx_data_tdm_params_define_context_map_base_nof].doc = "";
    ...
    submodule_data->defines[dnx_data_tdm_params_define_sid_min_size].doc = "";
    ...
    submodule_data->defines[dnx_data_tdm_params_define_sid_size].doc = "";
    ...
    submodule_data->defines[dnx_data_tdm_params_define_nof_stream_ids].doc = "";
    ...
    submodule_data->defines[dnx_data_tdm_params_define_global_sid_offset_size].doc = "";
    ...
    submodule_data->defines[dnx_data_tdm_params_define_global_sid_offset_nof].doc = "";
    ...
    submodule_data->defines[dnx_data_tdm_params_define_sid_offset_size].doc = "";
    ...
    submodule_data->defines[dnx_data_tdm_params_define_sid_offset_nof].doc = "";
    ...
    submodule_data->defines[dnx_data_tdm_params_define_sid_offset_nof_in_bits].doc = "";
    
    submodule_data->defines[dnx_data_tdm_params_define_sid_offset_nof_in_bits].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_tdm_params_define_sid_max_size].name = "sid_max_size";
    submodule_data->defines[dnx_data_tdm_params_define_sid_max_size].doc = "";
    
    submodule_data->defines[dnx_data_tdm_params_define_sid_max_size].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_tdm_params_define_context_size].name = "context_size";
    submodule_data->defines[dnx_data_tdm_params_define_context_size].doc = "";
    ...
    submodule_data->defines[dnx_data_tdm_params_define_nof_contexts].doc = "";
    ...
    submodule_data->defines[dnx_data_tdm_params_define_pkt_size_size].doc = "";
    ...
    submodule_data->defines[dnx_data_tdm_params_define_pkt_size_lower_limit].doc = "";
    ...
    submodule_data->defines[dnx_data_tdm_params_define_pkt_size_upper_limit].doc = "";
    ...
    submodule_data->defines[dnx_data_tdm_params_define_link_mask_size].doc = "";
    ...
    submodule_data->defines[dnx_data_tdm_params_define_link_mask_nof].doc = "";
    ...
    submodule_data->defines[dnx_data_tdm_params_define_tdm_tc].doc = "";
    ...
    submodule_data->defines[dnx_data_tdm_params_define_tdm_dp].doc = "";
    ...
    submodule_data->defines[dnx_data_tdm_params_define_mode].doc = "";
...
uint32
dnx_data_tdm_params_sid_max_size_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_tdm, dnx_data_tdm_submodule_params, dnx_data_tdm_params_define_sid_max_size);
}
    ...
    dnxc_data_module_t *module_data)
{
    ...
    {
        SHR_IF_ERR_EXIT(jr2_a0_data_tdm_attach(unit));
        SHR_IF_ERR_EXIT(j2x_a0_data_tdm_attach(unit));
    }
    else
