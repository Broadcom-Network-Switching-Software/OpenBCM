...
example_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(example_bitmap_include_only_example_dump(unit, -1, filters));
    SHR_IF_ERR_EXIT(example_bitmap_array_dump(unit, -1, -1, filters));
    SHR_IF_ERR_EXIT(example_bitmap_variable_access_dump(unit, -1, filters));
    ...
    SHR_IF_ERR_EXIT(example_htb_dump(unit, -1, filters));
    SHR_IF_ERR_EXIT(example_htb_rh_dump(unit, filters));
    SHR_IF_ERR_EXIT(example_multihead_htb_rh_dump(unit, filters));
    SHR_IF_ERR_EXIT(example_index_htb_rh_dump(unit, filters));
...
example_dynamic_array_dump(int  unit,  int  dynamic_array_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DYNAMIC_ARRAY, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->dynamic_array))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DYNAMIC_ARRAY, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->dynamic_array) == 0)
        {
            SHR_EXIT();
        }
...
example_dynamic_array_zero_size_dump(int  unit,  int  dynamic_array_zero_size_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DYNAMIC_ARRAY_ZERO_SIZE, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->dynamic_array_zero_size))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DYNAMIC_ARRAY_ZERO_SIZE, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->dynamic_array_zero_size) == 0)
        {
            SHR_EXIT();
        }
...
example_dynamic_dynamic_array_dump(int  unit,  int  first_d_index,  int  dynamic_index,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DYNAMIC_DYNAMIC_ARRAY, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->dynamic_dynamic_array))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DYNAMIC_DYNAMIC_ARRAY, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->dynamic_dynamic_array) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DYNAMIC_DYNAMIC_ARRAY, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->dynamic_dynamic_array[i0]))
            {
                LOG_CLI((BSL_META("example[]->((sw_state_example*)sw_state_roots_array[][EXAMPLE_MODULE_ID])->dynamic_dynamic_array[][]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DYNAMIC_DYNAMIC_ARRAY, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->dynamic_dynamic_array[i0]) == 0)
            {
                SHR_EXIT();
            }
...
example_dynamic_array_static_dump(int  unit,  int  dynamic_index,  int  static_index,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DYNAMIC_ARRAY_STATIC, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->dynamic_array_static))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DYNAMIC_ARRAY_STATIC, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->dynamic_array_static) == 0)
        {
            SHR_EXIT();
        }
...
example_DNXData_array_alloc_exception_dump(int  unit,  int  DNXData_array_alloc_exception_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DNXDATA_ARRAY_ALLOC_EXCEPTION, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->DNXData_array_alloc_exception))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DNXDATA_ARRAY_ALLOC_EXCEPTION, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->DNXData_array_alloc_exception) == 0)
        {
            SHR_EXIT();
        }
...
example_DNXData_array_dump(int  unit,  int  DNXData_array_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DNXDATA_ARRAY, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->DNXData_array))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DNXDATA_ARRAY, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->DNXData_array) == 0)
        {
            SHR_EXIT();
        }
...
example_DNXData_array_dyn_dnxdata_dump(int  unit,  int  DNXData_array_dyn_dnxdata_idx_0,  int  DNXData_array_dyn_dnxdata_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DNXDATA_ARRAY_DYN_DNXDATA, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->DNXData_array_dyn_dnxdata))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DNXDATA_ARRAY_DYN_DNXDATA, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->DNXData_array_dyn_dnxdata) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DNXDATA_ARRAY_DYN_DNXDATA, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->DNXData_array_dyn_dnxdata[i0]))
            {
                LOG_CLI((BSL_META("example[]->((sw_state_example*)sw_state_roots_array[][EXAMPLE_MODULE_ID])->DNXData_array_dyn_dnxdata[][]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DNXDATA_ARRAY_DYN_DNXDATA, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->DNXData_array_dyn_dnxdata[i0]) == 0)
            {
                SHR_EXIT();
            }
...
example_DNXData_array_dnxdata_dyn_dump(int  unit,  int  DNXData_array_dnxdata_dyn_idx_0,  int  DNXData_array_dnxdata_dyn_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DNXDATA_ARRAY_DNXDATA_DYN, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->DNXData_array_dnxdata_dyn))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DNXDATA_ARRAY_DNXDATA_DYN, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->DNXData_array_dnxdata_dyn) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DNXDATA_ARRAY_DNXDATA_DYN, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->DNXData_array_dnxdata_dyn[i0]))
            {
                LOG_CLI((BSL_META("example[]->((sw_state_example*)sw_state_roots_array[][EXAMPLE_MODULE_ID])->DNXData_array_dnxdata_dyn[][]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DNXDATA_ARRAY_DNXDATA_DYN, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->DNXData_array_dnxdata_dyn[i0]) == 0)
            {
                SHR_EXIT();
            }
...
example_DNXData_array_dnxdata_dnxdata_dump(int  unit,  int  DNXData_array_dnxdata_dnxdata_idx_0,  int  DNXData_array_dnxdata_dnxdata_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DNXDATA_ARRAY_DNXDATA_DNXDATA, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->DNXData_array_dnxdata_dnxdata))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DNXDATA_ARRAY_DNXDATA_DNXDATA, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->DNXData_array_dnxdata_dnxdata) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DNXDATA_ARRAY_DNXDATA_DNXDATA, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->DNXData_array_dnxdata_dnxdata[i0]))
            {
                LOG_CLI((BSL_META("example[]->((sw_state_example*)sw_state_roots_array[][EXAMPLE_MODULE_ID])->DNXData_array_dnxdata_dnxdata[][]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DNXDATA_ARRAY_DNXDATA_DNXDATA, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->DNXData_array_dnxdata_dnxdata[i0]) == 0)
            {
                SHR_EXIT();
            }
...
example_DNXData_array_static_dnxdata_dyn_dump(int  unit,  int  DNXData_array_static_dnxdata_dyn_idx_0,  int  DNXData_array_static_dnxdata_dyn_idx_1,  int  DNXData_array_static_dnxdata_dyn_idx_2,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DNXDATA_ARRAY_STATIC_DNXDATA_DYN, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->DNXData_array_static_dnxdata_dyn[i0]))
            {
                LOG_CLI((BSL_META("example[]->((sw_state_example*)sw_state_roots_array[][EXAMPLE_MODULE_ID])->DNXData_array_static_dnxdata_dyn[][][]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DNXDATA_ARRAY_STATIC_DNXDATA_DYN, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->DNXData_array_static_dnxdata_dyn[i0]) == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                if(i2 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DNXDATA_ARRAY_STATIC_DNXDATA_DYN, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->DNXData_array_static_dnxdata_dyn[i0][i1]))
                {
                    LOG_CLI((BSL_META("example[]->((sw_state_example*)sw_state_roots_array[][EXAMPLE_MODULE_ID])->DNXData_array_static_dnxdata_dyn[][][]: ")));
                    LOG_CLI((BSL_META("Invalid index: %d \n"),i2));
                    SHR_EXIT();
                ...
                if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DNXDATA_ARRAY_STATIC_DNXDATA_DYN, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->DNXData_array_static_dnxdata_dyn[i0][i1]) == 0)
                {
                    SHR_EXIT();
                }
...
example_DNXData_array_static_dyn_dnxdata_dump(int  unit,  int  DNXData_array_static_dyn_dnxdata_idx_0,  int  DNXData_array_static_dyn_dnxdata_idx_1,  int  DNXData_array_static_dyn_dnxdata_idx_2,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DNXDATA_ARRAY_STATIC_DYN_DNXDATA, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->DNXData_array_static_dyn_dnxdata[i0]))
            {
                LOG_CLI((BSL_META("example[]->((sw_state_example*)sw_state_roots_array[][EXAMPLE_MODULE_ID])->DNXData_array_static_dyn_dnxdata[][][]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DNXDATA_ARRAY_STATIC_DYN_DNXDATA, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->DNXData_array_static_dyn_dnxdata[i0]) == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                if(i2 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DNXDATA_ARRAY_STATIC_DYN_DNXDATA, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->DNXData_array_static_dyn_dnxdata[i0][i1]))
                {
                    LOG_CLI((BSL_META("example[]->((sw_state_example*)sw_state_roots_array[][EXAMPLE_MODULE_ID])->DNXData_array_static_dyn_dnxdata[][][]: ")));
                    LOG_CLI((BSL_META("Invalid index: %d \n"),i2));
                    SHR_EXIT();
                ...
                if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DNXDATA_ARRAY_STATIC_DYN_DNXDATA, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->DNXData_array_static_dyn_dnxdata[i0][i1]) == 0)
                {
                    SHR_EXIT();
                }
...
example_DNXData_array_static_dnxdata_dnxdata_dump(int  unit,  int  DNXData_array_static_dnxdata_dnxdata_idx_0,  int  DNXData_array_static_dnxdata_dnxdata_idx_1,  int  DNXData_array_static_dnxdata_dnxdata_idx_2,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DNXDATA_ARRAY_STATIC_DNXDATA_DNXDATA, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->DNXData_array_static_dnxdata_dnxdata[i0]))
            {
                LOG_CLI((BSL_META("example[]->((sw_state_example*)sw_state_roots_array[][EXAMPLE_MODULE_ID])->DNXData_array_static_dnxdata_dnxdata[][][]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DNXDATA_ARRAY_STATIC_DNXDATA_DNXDATA, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->DNXData_array_static_dnxdata_dnxdata[i0]) == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                if(i2 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DNXDATA_ARRAY_STATIC_DNXDATA_DNXDATA, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->DNXData_array_static_dnxdata_dnxdata[i0][i1]))
                {
                    LOG_CLI((BSL_META("example[]->((sw_state_example*)sw_state_roots_array[][EXAMPLE_MODULE_ID])->DNXData_array_static_dnxdata_dnxdata[][][]: ")));
                    LOG_CLI((BSL_META("Invalid index: %d \n"),i2));
                    SHR_EXIT();
                ...
                if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DNXDATA_ARRAY_STATIC_DNXDATA_DNXDATA, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->DNXData_array_static_dnxdata_dnxdata[i0][i1]) == 0)
                {
                    SHR_EXIT();
                }
...
example_DNXData_array_table_data_dump(int  unit,  int  DNXData_array_table_data_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DNXDATA_ARRAY_TABLE_DATA, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->DNXData_array_table_data))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DNXDATA_ARRAY_TABLE_DATA, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->DNXData_array_table_data) == 0)
        {
            SHR_EXIT();
        }
...
example_bitmap_variable_dump(int  unit,  int  bitmap_variable_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__BITMAP_VARIABLE, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->bitmap_variable))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__BITMAP_VARIABLE, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->bitmap_variable) == 0)
        {
            SHR_EXIT();
        }
...
example_bitmap_dnx_data_dump(int  unit,  int  bitmap_dnx_data_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__BITMAP_DNX_DATA, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->bitmap_dnx_data))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__BITMAP_DNX_DATA, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->bitmap_dnx_data) == 0)
        {
            SHR_EXIT();
        }
...
example_bitmap_exclude_example_dump(int  unit,  int  bitmap_exclude_example_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__BITMAP_EXCLUDE_EXAMPLE, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->bitmap_exclude_example))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__BITMAP_EXCLUDE_EXAMPLE, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->bitmap_exclude_example) == 0)
        {
            SHR_EXIT();
        }
...
int
example_bitmap_include_only_example_dump(int  unit,  int  bitmap_include_only_example_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = bitmap_include_only_example_idx_0, I0 = bitmap_include_only_example_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "example bitmap_include_only_example") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate example bitmap_include_only_example\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "example/bitmap_include_only_example.txt",
            "example[%d]->","((sw_state_example*)sw_state_roots_array[%d][EXAMPLE_MODULE_ID])->","bitmap_include_only_example[]: ");
        ...
        if (i0 == -1) {
            ...
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->bitmap_include_only_example
                , sizeof(*((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->bitmap_include_only_example), I0, &s0) ? I0 - 1 : 0;
        }

        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__BITMAP_INCLUDE_ONLY_EXAMPLE, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->bitmap_include_only_example))
        {
            LOG_CLI((BSL_META("example[]->((sw_state_example*)sw_state_roots_array[][EXAMPLE_MODULE_ID])->bitmap_include_only_example[]: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__BITMAP_INCLUDE_ONLY_EXAMPLE, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->bitmap_include_only_example) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "example[%d]->","((sw_state_example*)sw_state_roots_array[%d][EXAMPLE_MODULE_ID])->","bitmap_include_only_example[%s%d]: ", s0, i0);
            ...
            dnx_sw_state_print_shr_bitdcl(
                unit,
                &((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->bitmap_include_only_example[i0]);
...
example_bitmap_array_dump(int  unit,  int  bitmap_array_idx_0,  int  bitmap_array_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__BITMAP_ARRAY, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->bitmap_array))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__BITMAP_ARRAY, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->bitmap_array) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__BITMAP_ARRAY, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->bitmap_array[i0]))
            {
                LOG_CLI((BSL_META("example[]->((sw_state_example*)sw_state_roots_array[][EXAMPLE_MODULE_ID])->bitmap_array[][]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__BITMAP_ARRAY, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->bitmap_array[i0]) == 0)
            {
                SHR_EXIT();
            }
...
int
example_bitmap_variable_access_dump(int  unit,  int  bitmap_variable_access_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = bitmap_variable_access_idx_0, I0 = bitmap_variable_access_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "example bitmap_variable_access") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate example bitmap_variable_access\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "example/bitmap_variable_access.txt",
            "example[%d]->","((sw_state_example*)sw_state_roots_array[%d][EXAMPLE_MODULE_ID])->","bitmap_variable_access[]: ");
        ...
        if (i0 == -1) {
            ...
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ...
                , sizeof(*((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->bitmap_variable_access), I0, &s0) ? I0 - 1 : 0;
        }

        if(i0 >= ((10)/SHR_BITWID)+1)
        {
            LOG_CLI((BSL_META("example[]->((sw_state_example*)sw_state_roots_array[][EXAMPLE_MODULE_ID])->bitmap_variable_access[]: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(((10)/SHR_BITWID)+1 == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "example[%d]->","((sw_state_example*)sw_state_roots_array[%d][EXAMPLE_MODULE_ID])->","bitmap_variable_access[%s%d]: ", s0, i0);
            ...
            dnx_sw_state_print_shr_bitdcl(
                unit,
                &((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->bitmap_variable_access[i0]);
...
example_buffer_array_dump(int  unit,  int  buffer_array_idx_0,  int  buffer_array_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__BUFFER_ARRAY, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->buffer_array))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__BUFFER_ARRAY, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->buffer_array) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__BUFFER_ARRAY, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->buffer_array[i0]))
            {
                LOG_CLI((BSL_META("example[]->((sw_state_example*)sw_state_roots_array[][EXAMPLE_MODULE_ID])->buffer_array[][]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__BUFFER_ARRAY, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->buffer_array[i0]) == 0)
            {
                SHR_EXIT();
            }
...
example_buffer_dump(int  unit,  int  buffer_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__BUFFER, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->buffer))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__BUFFER, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->buffer) == 0)
        {
            SHR_EXIT();
        }
...
example_default_value_tree_array_dnxdata_array_dynamic_array_static_static_my_variable_dump(int  unit,  int  array_dnxdata_idx_0,  int  array_dynamic_idx_0,  int  array_static_static_idx_0,  int  array_static_static_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DEFAULT_VALUE_TREE__ARRAY_DNXDATA__ARRAY_DYNAMIC__ARRAY_STATIC_STATIC__MY_VARIABLE, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->default_value_tree.array_dnxdata))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DEFAULT_VALUE_TREE__ARRAY_DNXDATA__ARRAY_DYNAMIC__ARRAY_STATIC_STATIC__MY_VARIABLE, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->default_value_tree.array_dnxdata) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DEFAULT_VALUE_TREE__ARRAY_DNXDATA__ARRAY_DYNAMIC__ARRAY_STATIC_STATIC__MY_VARIABLE, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->default_value_tree.array_dnxdata[i0].array_dynamic))
            {
                LOG_CLI((BSL_META("example[]->((sw_state_example*)sw_state_roots_array[][EXAMPLE_MODULE_ID])->default_value_tree.array_dnxdata[].array_dynamic[].array_static_static[][].my_variable: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DEFAULT_VALUE_TREE__ARRAY_DNXDATA__ARRAY_DYNAMIC__ARRAY_STATIC_STATIC__MY_VARIABLE, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->default_value_tree.array_dnxdata[i0].array_dynamic) == 0)
            {
                SHR_EXIT();
            }
...
example_default_value_tree_array_dnxdata_array_dynamic_default_value_l3_my_variable_dump(int  unit,  int  array_dnxdata_idx_0,  int  array_dynamic_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DEFAULT_VALUE_TREE__ARRAY_DNXDATA__ARRAY_DYNAMIC__DEFAULT_VALUE_L3__MY_VARIABLE, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->default_value_tree.array_dnxdata))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DEFAULT_VALUE_TREE__ARRAY_DNXDATA__ARRAY_DYNAMIC__DEFAULT_VALUE_L3__MY_VARIABLE, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->default_value_tree.array_dnxdata) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DEFAULT_VALUE_TREE__ARRAY_DNXDATA__ARRAY_DYNAMIC__DEFAULT_VALUE_L3__MY_VARIABLE, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->default_value_tree.array_dnxdata[i0].array_dynamic))
            {
                LOG_CLI((BSL_META("example[]->((sw_state_example*)sw_state_roots_array[][EXAMPLE_MODULE_ID])->default_value_tree.array_dnxdata[].array_dynamic[].default_value_l3.my_variable: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DEFAULT_VALUE_TREE__ARRAY_DNXDATA__ARRAY_DYNAMIC__DEFAULT_VALUE_L3__MY_VARIABLE, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->default_value_tree.array_dnxdata[i0].array_dynamic) == 0)
            {
                SHR_EXIT();
            }
...
example_default_value_tree_array_dnxdata_array_dynamic_array_dynamic_dynamic_my_variable_dump(int  unit,  int  array_dnxdata_idx_0,  int  array_dynamic_idx_0,  int  array_dynamic_dynamic_idx_0,  int  array_dynamic_dynamic_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DEFAULT_VALUE_TREE__ARRAY_DNXDATA__ARRAY_DYNAMIC__ARRAY_DYNAMIC_DYNAMIC__MY_VARIABLE, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->default_value_tree.array_dnxdata))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DEFAULT_VALUE_TREE__ARRAY_DNXDATA__ARRAY_DYNAMIC__ARRAY_DYNAMIC_DYNAMIC__MY_VARIABLE, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->default_value_tree.array_dnxdata) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DEFAULT_VALUE_TREE__ARRAY_DNXDATA__ARRAY_DYNAMIC__ARRAY_DYNAMIC_DYNAMIC__MY_VARIABLE, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->default_value_tree.array_dnxdata[i0].array_dynamic))
            {
                LOG_CLI((BSL_META("example[]->((sw_state_example*)sw_state_roots_array[][EXAMPLE_MODULE_ID])->default_value_tree.array_dnxdata[].array_dynamic[].array_dynamic_dynamic[][].my_variable: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DEFAULT_VALUE_TREE__ARRAY_DNXDATA__ARRAY_DYNAMIC__ARRAY_DYNAMIC_DYNAMIC__MY_VARIABLE, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->default_value_tree.array_dnxdata[i0].array_dynamic) == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                if(i2 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DEFAULT_VALUE_TREE__ARRAY_DNXDATA__ARRAY_DYNAMIC__ARRAY_DYNAMIC_DYNAMIC__MY_VARIABLE, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->default_value_tree.array_dnxdata[i0].array_dynamic[i1].array_dynamic_dynamic))
                {
                    LOG_CLI((BSL_META("example[]->((sw_state_example*)sw_state_roots_array[][EXAMPLE_MODULE_ID])->default_value_tree.array_dnxdata[].array_dynamic[].array_dynamic_dynamic[][].my_variable: ")));
                    LOG_CLI((BSL_META("Invalid index: %d \n"),i2));
                    SHR_EXIT();
                ...
                if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DEFAULT_VALUE_TREE__ARRAY_DNXDATA__ARRAY_DYNAMIC__ARRAY_DYNAMIC_DYNAMIC__MY_VARIABLE, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->default_value_tree.array_dnxdata[i0].array_dynamic[i1].array_dynamic_dynamic) == 0)
                {
                    SHR_EXIT();
                }
                ...
                for(; i2 < I2; i2++) {
                    ...
                    if(i3 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DEFAULT_VALUE_TREE__ARRAY_DNXDATA__ARRAY_DYNAMIC__ARRAY_DYNAMIC_DYNAMIC__MY_VARIABLE, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->default_value_tree.array_dnxdata[i0].array_dynamic[i1].array_dynamic_dynamic[i2]))
                    {
                        LOG_CLI((BSL_META("example[]->((sw_state_example*)sw_state_roots_array[][EXAMPLE_MODULE_ID])->default_value_tree.array_dnxdata[].array_dynamic[].array_dynamic_dynamic[][].my_variable: ")));
                        LOG_CLI((BSL_META("Invalid index: %d \n"),i3));
                        SHR_EXIT();
                    ...
                    if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DEFAULT_VALUE_TREE__ARRAY_DNXDATA__ARRAY_DYNAMIC__ARRAY_DYNAMIC_DYNAMIC__MY_VARIABLE, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->default_value_tree.array_dnxdata[i0].array_dynamic[i1].array_dynamic_dynamic[i2]) == 0)
                    {
                        SHR_EXIT();
                    }
...
example_default_value_tree_array_dnxdata_default_value_l2_my_variable_dump(int  unit,  int  array_dnxdata_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DEFAULT_VALUE_TREE__ARRAY_DNXDATA__DEFAULT_VALUE_L2__MY_VARIABLE, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->default_value_tree.array_dnxdata))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__DEFAULT_VALUE_TREE__ARRAY_DNXDATA__DEFAULT_VALUE_L2__MY_VARIABLE, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->default_value_tree.array_dnxdata) == 0)
        {
            SHR_EXIT();
        }
...
int
example_sorted_multihead_ll_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;

    if (dnx_sw_state_compare(filters.typefilter, "sw_state_sorted_multihead_ll_t") != TRUE)
    {
         SHR_EXIT();
    }

    if (dnx_sw_state_compare(filters.namefilter, "example sorted_multihead_ll") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate example sorted_multihead_ll\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "example/sorted_multihead_ll.txt",
            "example[%d]->","((sw_state_example*)sw_state_roots_array[%d][EXAMPLE_MODULE_ID])->","sorted_multihead_ll: ");
...
int
example_htb_dump(int  unit,  int  htb_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = htb_idx_0, I0 = htb_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    else
    {
        ...
        if (i0 == -1) {
            ...
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ...
                , sizeof(*((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->htb), I0, &s0) ? I0 - 1 : 0;
        }

        if(i0 >= 2)
        {
            LOG_CLI((BSL_META("example[]->((sw_state_example*)sw_state_roots_array[][EXAMPLE_MODULE_ID])->htb[]: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "example[%d]->","((sw_state_example*)sw_state_roots_array[%d][EXAMPLE_MODULE_ID])->","htb[%s%d]: ", s0, i0);
            ...
            SW_STATE_HTB_DEFAULT_PRINT(
                unit,
                EXAMPLE_MODULE_ID,
                &((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->htb[i0]);
...
int
example_htb_rh_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "example htb_rh") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate example htb_rh\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "example/htb_rh.txt",
            "example[%d]->","((sw_state_example*)sw_state_roots_array[%d][EXAMPLE_MODULE_ID])->","htb_rh: ");
...
int
example_multihead_htb_rh_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;

    if (dnx_sw_state_compare(filters.typefilter, "sw_state_multihead_htb_t") != TRUE)
    {
         SHR_EXIT();
    }

    if (dnx_sw_state_compare(filters.namefilter, "example multihead_htb_rh") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate example multihead_htb_rh\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "example/multihead_htb_rh.txt",
            "example[%d]->","((sw_state_example*)sw_state_roots_array[%d][EXAMPLE_MODULE_ID])->","multihead_htb_rh: ");
        ...
        SW_STATE_HTB_RH_DEFAULT_PRINT(
            unit,
            &((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->multihead_htb_rh);
...
int
example_index_htb_rh_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;

    if (dnx_sw_state_compare(filters.typefilter, "sw_state_index_htb_t") != TRUE)
    {
         SHR_EXIT();
    }

    if (dnx_sw_state_compare(filters.namefilter, "example index_htb_rh") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate example index_htb_rh\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "example/index_htb_rh.txt",
            "example[%d]->","((sw_state_example*)sw_state_roots_array[%d][EXAMPLE_MODULE_ID])->","index_htb_rh: ");
        ...
        SW_STATE_INDEX_HTB_RH_DEFAULT_PRINT(
            unit,
            &((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->index_htb_rh);
...
example_index_htb_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    if (dnx_sw_state_compare(filters.typefilter, "sw_state_idx_htbl_t") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    else
    {
        ...
        SW_STATE_INDEX_HTB_DEFAULT_PRINT(
            unit,
            EXAMPLE_MODULE_ID,
...
int
example_occ2_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "example occ2") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate example occ2\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "example/occ2.txt",
            "example[%d]->","((sw_state_example*)sw_state_roots_array[%d][EXAMPLE_MODULE_ID])->","occ2: ");
...
int
example_params_flags_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
#ifdef BCM_WARM_BOOT_SUPPORT
...
#endif  
    SHR_IF_ERR_EXIT(example_params_flags_buff_variable_dump(unit, -1, filters));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
int
example_params_flags_var_warm_boot_ifdef_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "example params_flags var_warm_boot_ifdef") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate example params_flags var_warm_boot_ifdef\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "example/params_flags/var_warm_boot_ifdef.txt",
            "example[%d]->","((sw_state_example*)sw_state_roots_array[%d][EXAMPLE_MODULE_ID])->","params_flags.var_warm_boot_ifdef: ");
...
int
example_params_flags_var_warm_boot_ifndef_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "example params_flags var_warm_boot_ifndef") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate example params_flags var_warm_boot_ifndef\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "example/params_flags/var_warm_boot_ifndef.txt",
            "example[%d]->","((sw_state_example*)sw_state_roots_array[%d][EXAMPLE_MODULE_ID])->","params_flags.var_warm_boot_ifndef: ");
...
int
example_params_flags_var_warm_boot_if_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "example params_flags var_warm_boot_if") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate example params_flags var_warm_boot_if\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "example/params_flags/var_warm_boot_if.txt",
            "example[%d]->","((sw_state_example*)sw_state_roots_array[%d][EXAMPLE_MODULE_ID])->","params_flags.var_warm_boot_if: ");
...
int
example_params_flags_integer_multiple_flags_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "example params_flags integer_multiple_flags") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate example params_flags integer_multiple_flags\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "example/params_flags/integer_multiple_flags.txt",
            "example[%d]->","((sw_state_example*)sw_state_roots_array[%d][EXAMPLE_MODULE_ID])->","params_flags.integer_multiple_flags: ");
...
int
example_params_flags_buff_variable_dump(int  unit,  int  buff_variable_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = buff_variable_idx_0, I0 = buff_variable_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "example params_flags buff_variable") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate example params_flags buff_variable\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "example/params_flags/buff_variable.txt",
            "example[%d]->","((sw_state_example*)sw_state_roots_array[%d][EXAMPLE_MODULE_ID])->","params_flags.buff_variable[]: ");
        ...
        if (i0 == -1) {
            ...
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ...
                , sizeof(*((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->params_flags.buff_variable), I0, &s0) ? I0 - 1 : 0;
        }

        if(i0 >= 10)
        {
            LOG_CLI((BSL_META("example[]->((sw_state_example*)sw_state_roots_array[][EXAMPLE_MODULE_ID])->params_flags.buff_variable[]: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "example[%d]->","((sw_state_example*)sw_state_roots_array[%d][EXAMPLE_MODULE_ID])->","params_flags.buff_variable[%s%d]: ", s0, i0);
            ...
            dnx_sw_state_print_uint8(
                unit,
                &((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->params_flags.buff_variable[i0]);
...
example_alloc_child_check_static_array_of_p_dump(int  unit,  int  alloc_child_check_idx_0,  int  static_array_of_p_idx_0,  int  static_array_of_p_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__ALLOC_CHILD_CHECK__STATIC_ARRAY_OF_P, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->alloc_child_check))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__ALLOC_CHILD_CHECK__STATIC_ARRAY_OF_P, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->alloc_child_check) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            for(; i1 < I1; i1++) {
                ...
                if(i2 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__ALLOC_CHILD_CHECK__STATIC_ARRAY_OF_P, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->alloc_child_check[i0].static_array_of_p[i1]))
                {
                    LOG_CLI((BSL_META("example[]->((sw_state_example*)sw_state_roots_array[][EXAMPLE_MODULE_ID])->alloc_child_check[].static_array_of_p[][]: ")));
                    LOG_CLI((BSL_META("Invalid index: %d \n"),i2));
                    SHR_EXIT();
                ...
                if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__ALLOC_CHILD_CHECK__STATIC_ARRAY_OF_P, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->alloc_child_check[i0].static_array_of_p[i1]) == 0)
                {
                    SHR_EXIT();
                }
...
example_alloc_child_check_static_array_dump(int  unit,  int  alloc_child_check_idx_0,  int  static_array_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__ALLOC_CHILD_CHECK__STATIC_ARRAY, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->alloc_child_check))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__ALLOC_CHILD_CHECK__STATIC_ARRAY, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->alloc_child_check) == 0)
        {
            SHR_EXIT();
        }
...
example_alloc_child_check_integer_variable_dump(int  unit,  int  alloc_child_check_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__ALLOC_CHILD_CHECK__INTEGER_VARIABLE, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->alloc_child_check))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__ALLOC_CHILD_CHECK__INTEGER_VARIABLE, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->alloc_child_check) == 0)
        {
            SHR_EXIT();
        }
...
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(example_large_DS_examples_large_htb_dump(unit, -1, filters));
...
int
example_large_DS_examples_large_htb_dump(int  unit,  int  large_htb_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = large_htb_idx_0, I0 = large_htb_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    else
    {
        ...
        if (i0 == -1) {
            ...
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ...
                , sizeof(*((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->large_DS_examples.large_htb), I0, &s0) ? I0 - 1 : 0;
        }

        if(i0 >= 2)
        {
            LOG_CLI((BSL_META("example[]->((sw_state_example*)sw_state_roots_array[][EXAMPLE_MODULE_ID])->large_DS_examples.large_htb[]: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "example[%d]->","((sw_state_example*)sw_state_roots_array[%d][EXAMPLE_MODULE_ID])->","large_DS_examples.large_htb[%s%d]: ", s0, i0);
            ...
            SW_STATE_HTB_DEFAULT_PRINT(
                unit,
                EXAMPLE_MODULE_ID,
                &((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->large_DS_examples.large_htb[i0]);
...
example_alloc_after_init_variable_dump(int  unit,  int  alloc_after_init_variable_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__ALLOC_AFTER_INIT_VARIABLE, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->alloc_after_init_variable))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__ALLOC_AFTER_INIT_VARIABLE, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->alloc_after_init_variable) == 0)
        {
            SHR_EXIT();
        }
...
example_alloc_after_init_test_dump(int  unit,  int  alloc_after_init_test_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__ALLOC_AFTER_INIT_TEST, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->alloc_after_init_test))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_EXAMPLE__ALLOC_AFTER_INIT_TEST, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->alloc_after_init_test) == 0)
        {
            SHR_EXIT();
        }
...
const char* example_layout_str[EXAMPLE_INFO_NOF_ENTRIES] = {
    ...
    "EXAMPLE~BITMAP_INCLUDE_ONLY_EXAMPLE~",
    "EXAMPLE~BITMAP_ARRAY~",
    "EXAMPLE~BITMAP_VARIABLE_ACCESS~",
    ...
    "EXAMPLE~SORTED_MULTIHEAD_LL~",
    "EXAMPLE~SORTED_LL~",
    "EXAMPLE~BT~",
    "EXAMPLE~HTB~",
    "EXAMPLE~HTB_RH~",
    "EXAMPLE~MULTIHEAD_HTB_RH~",
    "EXAMPLE~INDEX_HTB_RH~",
    "EXAMPLE~HTB_ARR~",
    "EXAMPLE~INDEX_HTB~",
    "EXAMPLE~OCC~",
    "EXAMPLE~OCC2~",
    ...
    "EXAMPLE~PARAMS_FLAGS~",
#ifdef BCM_WARM_BOOT_SUPPORT
    "EXAMPLE~PARAMS_FLAGS~VAR_WARM_BOOT_IFDEF~",
#endif  
#ifndef BCM_WARM_BOOT_SUPPORT
    "EXAMPLE~PARAMS_FLAGS~VAR_WARM_BOOT_IFNDEF~",
#endif  
#if defined(BCM_WARM_BOOT_SUPPORT)
    "EXAMPLE~PARAMS_FLAGS~VAR_WARM_BOOT_IF~",
#endif  
#if defined(BCM_WARM_BOOT_SUPPORT) && defined(BCM_DNX_SUPPORT) 
    "EXAMPLE~PARAMS_FLAGS~INTEGER_MULTIPLE_FLAGS~",
#endif  
    "EXAMPLE~PARAMS_FLAGS~BUFF_VARIABLE~",
    "EXAMPLE~MY_UNION~",
