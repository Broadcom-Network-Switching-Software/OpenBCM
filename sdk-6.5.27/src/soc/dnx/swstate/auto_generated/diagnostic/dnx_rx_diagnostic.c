...
dnx_rx_parser_info_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(dnx_rx_parser_info_ftmh_pp_dsp_to_cpu_port_dump(unit, -1, filters));
    SHR_IF_ERR_EXIT(dnx_rx_parser_info_etpp_oam_up_mep_dest_trap_id1_dump(unit, filters));
    SHR_IF_ERR_EXIT(dnx_rx_parser_info_etpp_oam_up_mep_dest_trap_id2_dump(unit, filters));
...
dnx_rx_parser_info_dma_channel_to_cpu_port_dump(int  unit,  int  dma_channel_to_cpu_port_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_RX_PARSER_INFO__DMA_CHANNEL_TO_CPU_PORT, ((rx_paser_info_t*)sw_state_roots_array[unit][DNX_RX_MODULE_ID])->dma_channel_to_cpu_port))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_RX_PARSER_INFO__DMA_CHANNEL_TO_CPU_PORT, ((rx_paser_info_t*)sw_state_roots_array[unit][DNX_RX_MODULE_ID])->dma_channel_to_cpu_port) == 0)
        {
            SHR_EXIT();
        }
...
dnx_rx_parser_info_cpu_port_to_dma_channel_dump(int  unit,  int  cpu_port_to_dma_channel_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_RX_PARSER_INFO__CPU_PORT_TO_DMA_CHANNEL, ((rx_paser_info_t*)sw_state_roots_array[unit][DNX_RX_MODULE_ID])->cpu_port_to_dma_channel))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_RX_PARSER_INFO__CPU_PORT_TO_DMA_CHANNEL, ((rx_paser_info_t*)sw_state_roots_array[unit][DNX_RX_MODULE_ID])->cpu_port_to_dma_channel) == 0)
        {
            SHR_EXIT();
        }
...
int
dnx_rx_parser_info_ftmh_pp_dsp_to_cpu_port_dump(int  unit,  int  ftmh_pp_dsp_to_cpu_port_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = ftmh_pp_dsp_to_cpu_port_idx_0, I0 = ftmh_pp_dsp_to_cpu_port_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_rx ftmh_pp_dsp_to_cpu_port") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_rx ftmh_pp_dsp_to_cpu_port\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_rx_parser_info/ftmh_pp_dsp_to_cpu_port.txt",
            "dnx_rx_parser_info[%d]->","((rx_paser_info_t*)sw_state_roots_array[%d][DNX_RX_MODULE_ID])->","ftmh_pp_dsp_to_cpu_port[]: ");
        ...
        if (i0 == -1) {
            ...
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ((rx_paser_info_t*)sw_state_roots_array[unit][DNX_RX_MODULE_ID])->ftmh_pp_dsp_to_cpu_port
                , sizeof(*((rx_paser_info_t*)sw_state_roots_array[unit][DNX_RX_MODULE_ID])->ftmh_pp_dsp_to_cpu_port), I0, &s0) ? I0 - 1 : 0;
        }

        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_RX_PARSER_INFO__FTMH_PP_DSP_TO_CPU_PORT, ((rx_paser_info_t*)sw_state_roots_array[unit][DNX_RX_MODULE_ID])->ftmh_pp_dsp_to_cpu_port))
        {
            LOG_CLI((BSL_META("dnx_rx_parser_info[]->((rx_paser_info_t*)sw_state_roots_array[][DNX_RX_MODULE_ID])->ftmh_pp_dsp_to_cpu_port[]: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_RX_PARSER_INFO__FTMH_PP_DSP_TO_CPU_PORT, ((rx_paser_info_t*)sw_state_roots_array[unit][DNX_RX_MODULE_ID])->ftmh_pp_dsp_to_cpu_port) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "dnx_rx_parser_info[%d]->","((rx_paser_info_t*)sw_state_roots_array[%d][DNX_RX_MODULE_ID])->","ftmh_pp_dsp_to_cpu_port[%s%d]: ", s0, i0);
            ...
            dnx_sw_state_print_int(
                unit,
                &((rx_paser_info_t*)sw_state_roots_array[unit][DNX_RX_MODULE_ID])->ftmh_pp_dsp_to_cpu_port[i0]);
...
int
dnx_rx_parser_info_etpp_oam_up_mep_dest_trap_id1_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_rx etpp_oam_up_mep_dest_trap_id1") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_rx etpp_oam_up_mep_dest_trap_id1\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_rx_parser_info/etpp_oam_up_mep_dest_trap_id1.txt",
            "dnx_rx_parser_info[%d]->","((rx_paser_info_t*)sw_state_roots_array[%d][DNX_RX_MODULE_ID])->","etpp_oam_up_mep_dest_trap_id1: ");
...
int
dnx_rx_parser_info_etpp_oam_up_mep_dest_trap_id2_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_rx etpp_oam_up_mep_dest_trap_id2") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_rx etpp_oam_up_mep_dest_trap_id2\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_rx_parser_info/etpp_oam_up_mep_dest_trap_id2.txt",
            "dnx_rx_parser_info[%d]->","((rx_paser_info_t*)sw_state_roots_array[%d][DNX_RX_MODULE_ID])->","etpp_oam_up_mep_dest_trap_id2: ");
...
const char* dnx_rx_parser_info_layout_str[DNX_RX_PARSER_INFO_INFO_NOF_ENTRIES] = {
    ...
    "DNX_RX_PARSER_INFO~FTMH_PP_DSP_TO_CPU_PORT~",
    "DNX_RX_PARSER_INFO~ETPP_OAM_UP_MEP_DEST_TRAP_ID1~",
    "DNX_RX_PARSER_INFO~ETPP_OAM_UP_MEP_DEST_TRAP_ID2~",
};
#endif 
