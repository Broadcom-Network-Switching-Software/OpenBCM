...
kbp_sw_state_db_handles_info_dump(int  unit,  int  db_handles_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(kbp_sw_state_db_handles_info_regular_result_size_dump(unit, db_handles_info_idx_0, filters));
...
int
kbp_sw_state_db_handles_info_regular_result_size_dump(int  unit,  int  db_handles_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    DNXC_SW_STATE_FUNC_RETURN;
}
...
const char* kbp_sw_state_layout_str[KBP_SW_STATE_INFO_NOF_ENTRIES] = {
    ...
    "KBP_SW_STATE~DB_HANDLES_INFO~REGULAR_RESULT_SIZE~",
