...
dnx_field_tcam_access_profile_sw_access_profiles_occupied_dump(int  unit,  int  access_profiles_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_PROFILE_SW__ACCESS_PROFILES__OCCUPIED, ((dnx_field_tcam_access_profile_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_PROFILE_MODULE_ID])->access_profiles))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_PROFILE_SW__ACCESS_PROFILES__OCCUPIED, ((dnx_field_tcam_access_profile_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_PROFILE_MODULE_ID])->access_profiles) == 0)
        {
            SHR_EXIT();
        }
...
dnx_field_tcam_access_profile_sw_access_profiles_key_size_dump(int  unit,  int  access_profiles_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_PROFILE_SW__ACCESS_PROFILES__KEY_SIZE, ((dnx_field_tcam_access_profile_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_PROFILE_MODULE_ID])->access_profiles))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_PROFILE_SW__ACCESS_PROFILES__KEY_SIZE, ((dnx_field_tcam_access_profile_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_PROFILE_MODULE_ID])->access_profiles) == 0)
        {
            SHR_EXIT();
        }
...
dnx_field_tcam_access_profile_sw_access_profiles_action_size_dump(int  unit,  int  access_profiles_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_PROFILE_SW__ACCESS_PROFILES__ACTION_SIZE, ((dnx_field_tcam_access_profile_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_PROFILE_MODULE_ID])->access_profiles))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_PROFILE_SW__ACCESS_PROFILES__ACTION_SIZE, ((dnx_field_tcam_access_profile_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_PROFILE_MODULE_ID])->access_profiles) == 0)
        {
            SHR_EXIT();
        }
...
dnx_field_tcam_access_profile_sw_access_profiles_bank_ids_bmp_dump(int  unit,  int  access_profiles_idx_0,  int  bank_ids_bmp_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_PROFILE_SW__ACCESS_PROFILES__BANK_IDS_BMP, ((dnx_field_tcam_access_profile_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_PROFILE_MODULE_ID])->access_profiles))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_PROFILE_SW__ACCESS_PROFILES__BANK_IDS_BMP, ((dnx_field_tcam_access_profile_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_PROFILE_MODULE_ID])->access_profiles) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_PROFILE_SW__ACCESS_PROFILES__BANK_IDS_BMP, ((dnx_field_tcam_access_profile_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_PROFILE_MODULE_ID])->access_profiles[i0].bank_ids_bmp))
            {
                LOG_CLI((BSL_META("dnx_field_tcam_access_profile_sw[]->((dnx_field_tcam_access_profile_sw_t*)sw_state_roots_array[][DNX_FIELD_TCAM_ACCESS_PROFILE_MODULE_ID])->access_profiles[].bank_ids_bmp[]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_PROFILE_SW__ACCESS_PROFILES__BANK_IDS_BMP, ((dnx_field_tcam_access_profile_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_PROFILE_MODULE_ID])->access_profiles[i0].bank_ids_bmp) == 0)
            {
                SHR_EXIT();
            }
...
dnx_field_tcam_access_profile_sw_access_profiles_is_direct_dump(int  unit,  int  access_profiles_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_PROFILE_SW__ACCESS_PROFILES__IS_DIRECT, ((dnx_field_tcam_access_profile_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_PROFILE_MODULE_ID])->access_profiles))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_PROFILE_SW__ACCESS_PROFILES__IS_DIRECT, ((dnx_field_tcam_access_profile_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_PROFILE_MODULE_ID])->access_profiles) == 0)
        {
            SHR_EXIT();
        }
...
dnx_field_tcam_access_profile_sw_access_profiles_prefix_dump(int  unit,  int  access_profiles_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_PROFILE_SW__ACCESS_PROFILES__PREFIX, ((dnx_field_tcam_access_profile_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_PROFILE_MODULE_ID])->access_profiles))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_PROFILE_SW__ACCESS_PROFILES__PREFIX, ((dnx_field_tcam_access_profile_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_PROFILE_MODULE_ID])->access_profiles) == 0)
        {
            SHR_EXIT();
        }
...
dnx_field_tcam_access_profile_sw_access_profiles_handler_id_dump(int  unit,  int  access_profiles_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_PROFILE_SW__ACCESS_PROFILES__HANDLER_ID, ((dnx_field_tcam_access_profile_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_PROFILE_MODULE_ID])->access_profiles))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_PROFILE_SW__ACCESS_PROFILES__HANDLER_ID, ((dnx_field_tcam_access_profile_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_PROFILE_MODULE_ID])->access_profiles) == 0)
        {
            SHR_EXIT();
        }
