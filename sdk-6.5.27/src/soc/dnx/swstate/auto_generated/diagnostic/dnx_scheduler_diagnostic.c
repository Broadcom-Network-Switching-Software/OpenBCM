...
dnx_scheduler_db_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(dnx_scheduler_db_low_rate_ranges_dump(unit, -1, -1, filters));
...
int
dnx_scheduler_db_low_rate_ranges_dump(int  unit,  int  low_rate_ranges_idx_0,  int  low_rate_ranges_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dnx_scheduler_db_low_rate_ranges_pattern_dump(int  unit,  int  low_rate_ranges_idx_0,  int  low_rate_ranges_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = low_rate_ranges_idx_0, I0 = low_rate_ranges_idx_0 + 1;
    int i1 = low_rate_ranges_idx_1, I1 = low_rate_ranges_idx_1 + 1, org_i1 = low_rate_ranges_idx_1;
    char *s0 = "", *s1 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_scheduler low_rate_ranges pattern") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_scheduler low_rate_ranges pattern\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_scheduler_db/low_rate_ranges/pattern.txt",
            "dnx_scheduler_db[%d]->","((dnx_scheduler_db_t*)sw_state_roots_array[%d][DNX_SCHEDULER_MODULE_ID])->","low_rate_ranges[][].pattern: ");
        ...
        if (i0 == -1) {
            ...
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ((dnx_scheduler_db_t*)sw_state_roots_array[unit][DNX_SCHEDULER_MODULE_ID])->low_rate_ranges
                , sizeof(*((dnx_scheduler_db_t*)sw_state_roots_array[unit][DNX_SCHEDULER_MODULE_ID])->low_rate_ranges), I0, &s0) ? I0 - 1 : 0;
        }

        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_SCHEDULER_DB__LOW_RATE_RANGES__PATTERN, ((dnx_scheduler_db_t*)sw_state_roots_array[unit][DNX_SCHEDULER_MODULE_ID])->low_rate_ranges))
        {
            LOG_CLI((BSL_META("dnx_scheduler_db[]->((dnx_scheduler_db_t*)sw_state_roots_array[][DNX_SCHEDULER_MODULE_ID])->low_rate_ranges[][].pattern: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_SCHEDULER_DB__LOW_RATE_RANGES__PATTERN, ((dnx_scheduler_db_t*)sw_state_roots_array[unit][DNX_SCHEDULER_MODULE_ID])->low_rate_ranges) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
                ...
                DNX_SW_STATE_DUMP_PTR_NULL_CHECK(
                    unit,
                    ((dnx_scheduler_db_t*)sw_state_roots_array[unit][DNX_SCHEDULER_MODULE_ID])->low_rate_ranges[i0]);
            ...
            if (i1 == -1) {
                ...
                i1 = dnx_sw_state_dump_check_all_the_same(unit,
                    ((dnx_scheduler_db_t*)sw_state_roots_array[unit][DNX_SCHEDULER_MODULE_ID])->low_rate_ranges[i0]
                    , sizeof(*((dnx_scheduler_db_t*)sw_state_roots_array[unit][DNX_SCHEDULER_MODULE_ID])->low_rate_ranges[i0]), I1, &s1) ? I1 - 1 : 0;
            }

            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_SCHEDULER_DB__LOW_RATE_RANGES__PATTERN, ((dnx_scheduler_db_t*)sw_state_roots_array[unit][DNX_SCHEDULER_MODULE_ID])->low_rate_ranges[i0]))
            {
                LOG_CLI((BSL_META("dnx_scheduler_db[]->((dnx_scheduler_db_t*)sw_state_roots_array[][DNX_SCHEDULER_MODULE_ID])->low_rate_ranges[][].pattern: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_SCHEDULER_DB__LOW_RATE_RANGES__PATTERN, ((dnx_scheduler_db_t*)sw_state_roots_array[unit][DNX_SCHEDULER_MODULE_ID])->low_rate_ranges[i0]) == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                DNX_SW_STATE_PRINT_MONITOR(
                    unit,
                    "dnx_scheduler_db[%d]->","((dnx_scheduler_db_t*)sw_state_roots_array[%d][DNX_SCHEDULER_MODULE_ID])->","low_rate_ranges[%s%d][%s%d].pattern: ", s0, i0, s1, i1);
                ...
                dnx_sw_state_print_uint32(
                    unit,
                    &((dnx_scheduler_db_t*)sw_state_roots_array[unit][DNX_SCHEDULER_MODULE_ID])->low_rate_ranges[i0][i1].pattern);
...
int
dnx_scheduler_db_low_rate_ranges_range_start_dump(int  unit,  int  low_rate_ranges_idx_0,  int  low_rate_ranges_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = low_rate_ranges_idx_0, I0 = low_rate_ranges_idx_0 + 1;
    int i1 = low_rate_ranges_idx_1, I1 = low_rate_ranges_idx_1 + 1, org_i1 = low_rate_ranges_idx_1;
    char *s0 = "", *s1 = "";
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_scheduler low_rate_ranges range_start") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_scheduler low_rate_ranges range_start\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_scheduler_db/low_rate_ranges/range_start.txt",
            "dnx_scheduler_db[%d]->","((dnx_scheduler_db_t*)sw_state_roots_array[%d][DNX_SCHEDULER_MODULE_ID])->","low_rate_ranges[][].range_start: ");
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_SCHEDULER_DB__LOW_RATE_RANGES__RANGE_START, ((dnx_scheduler_db_t*)sw_state_roots_array[unit][DNX_SCHEDULER_MODULE_ID])->low_rate_ranges))
        {
            LOG_CLI((BSL_META("dnx_scheduler_db[]->((dnx_scheduler_db_t*)sw_state_roots_array[][DNX_SCHEDULER_MODULE_ID])->low_rate_ranges[][].range_start: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_SCHEDULER_DB__LOW_RATE_RANGES__RANGE_START, ((dnx_scheduler_db_t*)sw_state_roots_array[unit][DNX_SCHEDULER_MODULE_ID])->low_rate_ranges) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_SCHEDULER_DB__LOW_RATE_RANGES__RANGE_START, ((dnx_scheduler_db_t*)sw_state_roots_array[unit][DNX_SCHEDULER_MODULE_ID])->low_rate_ranges[i0]))
            {
                LOG_CLI((BSL_META("dnx_scheduler_db[]->((dnx_scheduler_db_t*)sw_state_roots_array[][DNX_SCHEDULER_MODULE_ID])->low_rate_ranges[][].range_start: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_SCHEDULER_DB__LOW_RATE_RANGES__RANGE_START, ((dnx_scheduler_db_t*)sw_state_roots_array[unit][DNX_SCHEDULER_MODULE_ID])->low_rate_ranges[i0]) == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                DNX_SW_STATE_PRINT_MONITOR(
                    unit,
                    "dnx_scheduler_db[%d]->","((dnx_scheduler_db_t*)sw_state_roots_array[%d][DNX_SCHEDULER_MODULE_ID])->","low_rate_ranges[%s%d][%s%d].range_start: ", s0, i0, s1, i1);
                ...
                dnx_sw_state_print_uint32(
                    unit,
                    &((dnx_scheduler_db_t*)sw_state_roots_array[unit][DNX_SCHEDULER_MODULE_ID])->low_rate_ranges[i0][i1].range_start);
...
int
dnx_scheduler_db_low_rate_ranges_range_end_dump(int  unit,  int  low_rate_ranges_idx_0,  int  low_rate_ranges_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = low_rate_ranges_idx_0, I0 = low_rate_ranges_idx_0 + 1;
    int i1 = low_rate_ranges_idx_1, I1 = low_rate_ranges_idx_1 + 1, org_i1 = low_rate_ranges_idx_1;
    char *s0 = "", *s1 = "";
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_scheduler low_rate_ranges range_end") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_scheduler low_rate_ranges range_end\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_scheduler_db/low_rate_ranges/range_end.txt",
            "dnx_scheduler_db[%d]->","((dnx_scheduler_db_t*)sw_state_roots_array[%d][DNX_SCHEDULER_MODULE_ID])->","low_rate_ranges[][].range_end: ");
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_SCHEDULER_DB__LOW_RATE_RANGES__RANGE_END, ((dnx_scheduler_db_t*)sw_state_roots_array[unit][DNX_SCHEDULER_MODULE_ID])->low_rate_ranges))
        {
            LOG_CLI((BSL_META("dnx_scheduler_db[]->((dnx_scheduler_db_t*)sw_state_roots_array[][DNX_SCHEDULER_MODULE_ID])->low_rate_ranges[][].range_end: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_SCHEDULER_DB__LOW_RATE_RANGES__RANGE_END, ((dnx_scheduler_db_t*)sw_state_roots_array[unit][DNX_SCHEDULER_MODULE_ID])->low_rate_ranges) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_SCHEDULER_DB__LOW_RATE_RANGES__RANGE_END, ((dnx_scheduler_db_t*)sw_state_roots_array[unit][DNX_SCHEDULER_MODULE_ID])->low_rate_ranges[i0]))
            {
                LOG_CLI((BSL_META("dnx_scheduler_db[]->((dnx_scheduler_db_t*)sw_state_roots_array[][DNX_SCHEDULER_MODULE_ID])->low_rate_ranges[][].range_end: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_SCHEDULER_DB__LOW_RATE_RANGES__RANGE_END, ((dnx_scheduler_db_t*)sw_state_roots_array[unit][DNX_SCHEDULER_MODULE_ID])->low_rate_ranges[i0]) == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                DNX_SW_STATE_PRINT_MONITOR(
                    unit,
                    "dnx_scheduler_db[%d]->","((dnx_scheduler_db_t*)sw_state_roots_array[%d][DNX_SCHEDULER_MODULE_ID])->","low_rate_ranges[%s%d][%s%d].range_end: ", s0, i0, s1, i1);
                ...
                dnx_sw_state_print_uint32(
                    unit,
                    &((dnx_scheduler_db_t*)sw_state_roots_array[unit][DNX_SCHEDULER_MODULE_ID])->low_rate_ranges[i0][i1].range_end);
...
int
dnx_scheduler_db_low_rate_ranges_is_enabled_dump(int  unit,  int  low_rate_ranges_idx_0,  int  low_rate_ranges_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = low_rate_ranges_idx_0, I0 = low_rate_ranges_idx_0 + 1;
    int i1 = low_rate_ranges_idx_1, I1 = low_rate_ranges_idx_1 + 1, org_i1 = low_rate_ranges_idx_1;
    char *s0 = "", *s1 = "";
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_scheduler low_rate_ranges is_enabled") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_scheduler low_rate_ranges is_enabled\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_scheduler_db/low_rate_ranges/is_enabled.txt",
            "dnx_scheduler_db[%d]->","((dnx_scheduler_db_t*)sw_state_roots_array[%d][DNX_SCHEDULER_MODULE_ID])->","low_rate_ranges[][].is_enabled: ");
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_SCHEDULER_DB__LOW_RATE_RANGES__IS_ENABLED, ((dnx_scheduler_db_t*)sw_state_roots_array[unit][DNX_SCHEDULER_MODULE_ID])->low_rate_ranges))
        {
            LOG_CLI((BSL_META("dnx_scheduler_db[]->((dnx_scheduler_db_t*)sw_state_roots_array[][DNX_SCHEDULER_MODULE_ID])->low_rate_ranges[][].is_enabled: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_SCHEDULER_DB__LOW_RATE_RANGES__IS_ENABLED, ((dnx_scheduler_db_t*)sw_state_roots_array[unit][DNX_SCHEDULER_MODULE_ID])->low_rate_ranges) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_SCHEDULER_DB__LOW_RATE_RANGES__IS_ENABLED, ((dnx_scheduler_db_t*)sw_state_roots_array[unit][DNX_SCHEDULER_MODULE_ID])->low_rate_ranges[i0]))
            {
                LOG_CLI((BSL_META("dnx_scheduler_db[]->((dnx_scheduler_db_t*)sw_state_roots_array[][DNX_SCHEDULER_MODULE_ID])->low_rate_ranges[][].is_enabled: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_SCHEDULER_DB__LOW_RATE_RANGES__IS_ENABLED, ((dnx_scheduler_db_t*)sw_state_roots_array[unit][DNX_SCHEDULER_MODULE_ID])->low_rate_ranges[i0]) == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                DNX_SW_STATE_PRINT_MONITOR(
                    unit,
                    "dnx_scheduler_db[%d]->","((dnx_scheduler_db_t*)sw_state_roots_array[%d][DNX_SCHEDULER_MODULE_ID])->","low_rate_ranges[%s%d][%s%d].is_enabled: ", s0, i0, s1, i1);
                ...
                dnx_sw_state_print_uint32(
                    unit,
                    &((dnx_scheduler_db_t*)sw_state_roots_array[unit][DNX_SCHEDULER_MODULE_ID])->low_rate_ranges[i0][i1].is_enabled);
...
const char* dnx_scheduler_db_layout_str[DNX_SCHEDULER_DB_INFO_NOF_ENTRIES] = {
    ...
    "DNX_SCHEDULER_DB~LOW_RATE_RANGES~",
    "DNX_SCHEDULER_DB~LOW_RATE_RANGES~PATTERN~",
    "DNX_SCHEDULER_DB~LOW_RATE_RANGES~RANGE_START~",
    "DNX_SCHEDULER_DB~LOW_RATE_RANGES~RANGE_END~",
    "DNX_SCHEDULER_DB~LOW_RATE_RANGES~IS_ENABLED~",
};
#endif 
