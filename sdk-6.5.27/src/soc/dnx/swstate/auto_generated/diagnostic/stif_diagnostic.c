...
dnx_stif_db_instance_logical_port_dump(int  unit,  int  instance_idx_0,  int  instance_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_STIF_DB__INSTANCE__LOGICAL_PORT, ((dnx_stif_db_t*)sw_state_roots_array[unit][STIF_MODULE_ID])->instance))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_STIF_DB__INSTANCE__LOGICAL_PORT, ((dnx_stif_db_t*)sw_state_roots_array[unit][STIF_MODULE_ID])->instance) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_STIF_DB__INSTANCE__LOGICAL_PORT, ((dnx_stif_db_t*)sw_state_roots_array[unit][STIF_MODULE_ID])->instance[i0]))
            {
                LOG_CLI((BSL_META("dnx_stif_db[]->((dnx_stif_db_t*)sw_state_roots_array[][STIF_MODULE_ID])->instance[][].logical_port: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_STIF_DB__INSTANCE__LOGICAL_PORT, ((dnx_stif_db_t*)sw_state_roots_array[unit][STIF_MODULE_ID])->instance[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_stif_db_source_mapping_first_port_dump(int  unit,  int  source_mapping_idx_0,  int  source_mapping_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_STIF_DB__SOURCE_MAPPING__FIRST_PORT, ((dnx_stif_db_t*)sw_state_roots_array[unit][STIF_MODULE_ID])->source_mapping))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_STIF_DB__SOURCE_MAPPING__FIRST_PORT, ((dnx_stif_db_t*)sw_state_roots_array[unit][STIF_MODULE_ID])->source_mapping) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_STIF_DB__SOURCE_MAPPING__FIRST_PORT, ((dnx_stif_db_t*)sw_state_roots_array[unit][STIF_MODULE_ID])->source_mapping[i0]))
            {
                LOG_CLI((BSL_META("dnx_stif_db[]->((dnx_stif_db_t*)sw_state_roots_array[][STIF_MODULE_ID])->source_mapping[][].first_port: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_STIF_DB__SOURCE_MAPPING__FIRST_PORT, ((dnx_stif_db_t*)sw_state_roots_array[unit][STIF_MODULE_ID])->source_mapping[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_stif_db_source_mapping_second_port_dump(int  unit,  int  source_mapping_idx_0,  int  source_mapping_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_STIF_DB__SOURCE_MAPPING__SECOND_PORT, ((dnx_stif_db_t*)sw_state_roots_array[unit][STIF_MODULE_ID])->source_mapping))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_STIF_DB__SOURCE_MAPPING__SECOND_PORT, ((dnx_stif_db_t*)sw_state_roots_array[unit][STIF_MODULE_ID])->source_mapping) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_STIF_DB__SOURCE_MAPPING__SECOND_PORT, ((dnx_stif_db_t*)sw_state_roots_array[unit][STIF_MODULE_ID])->source_mapping[i0]))
            {
                LOG_CLI((BSL_META("dnx_stif_db[]->((dnx_stif_db_t*)sw_state_roots_array[][STIF_MODULE_ID])->source_mapping[][].second_port: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_STIF_DB__SOURCE_MAPPING__SECOND_PORT, ((dnx_stif_db_t*)sw_state_roots_array[unit][STIF_MODULE_ID])->source_mapping[i0]) == 0)
            {
                SHR_EXIT();
            }
