...
local_outlif_info_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(local_outlif_info_dynamic_algo_dump(unit, filters));
...
local_outlif_info_outlif_bank_info_assigned_dump(int  unit,  int  outlif_bank_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__OUTLIF_BANK_INFO__ASSIGNED, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->outlif_bank_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__OUTLIF_BANK_INFO__ASSIGNED, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->outlif_bank_info) == 0)
        {
            SHR_EXIT();
        }
...
local_outlif_info_outlif_bank_info_in_use_dump(int  unit,  int  outlif_bank_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__OUTLIF_BANK_INFO__IN_USE, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->outlif_bank_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__OUTLIF_BANK_INFO__IN_USE, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->outlif_bank_info) == 0)
        {
            SHR_EXIT();
        }
...
local_outlif_info_outlif_bank_info_used_logical_phase_dump(int  unit,  int  outlif_bank_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__OUTLIF_BANK_INFO__USED_LOGICAL_PHASE, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->outlif_bank_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__OUTLIF_BANK_INFO__USED_LOGICAL_PHASE, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->outlif_bank_info) == 0)
        {
            SHR_EXIT();
        }
...
local_outlif_info_outlif_bank_info_ll_in_use_dump(int  unit,  int  outlif_bank_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__OUTLIF_BANK_INFO__LL_IN_USE, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->outlif_bank_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__OUTLIF_BANK_INFO__LL_IN_USE, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->outlif_bank_info) == 0)
        {
            SHR_EXIT();
        }
...
local_outlif_info_outlif_bank_info_ll_index_dump(int  unit,  int  outlif_bank_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__OUTLIF_BANK_INFO__LL_INDEX, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->outlif_bank_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__OUTLIF_BANK_INFO__LL_INDEX, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->outlif_bank_info) == 0)
        {
            SHR_EXIT();
        }
...
local_outlif_info_outlif_bank_info_eedb_data_banks_dump(int  unit,  int  outlif_bank_info_idx_0,  int  eedb_data_banks_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__OUTLIF_BANK_INFO__EEDB_DATA_BANKS, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->outlif_bank_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__OUTLIF_BANK_INFO__EEDB_DATA_BANKS, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->outlif_bank_info) == 0)
        {
            SHR_EXIT();
        }
...
local_outlif_info_logical_phase_info_dump(int  unit,  int  logical_phase_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(local_outlif_info_logical_phase_info_first_no_ll_bank_dump(unit, logical_phase_info_idx_0, filters));
    SHR_IF_ERR_EXIT(local_outlif_info_logical_phase_info_last_no_ll_bank_dump(unit, logical_phase_info_idx_0, filters));
...
local_outlif_info_logical_phase_info_physical_phase_dump(int  unit,  int  logical_phase_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__LOGICAL_PHASE_INFO__PHYSICAL_PHASE, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->logical_phase_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__LOGICAL_PHASE_INFO__PHYSICAL_PHASE, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->logical_phase_info) == 0)
        {
            SHR_EXIT();
        }
...
local_outlif_info_logical_phase_info_address_granularity_dump(int  unit,  int  logical_phase_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__LOGICAL_PHASE_INFO__ADDRESS_GRANULARITY, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->logical_phase_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__LOGICAL_PHASE_INFO__ADDRESS_GRANULARITY, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->logical_phase_info) == 0)
        {
            SHR_EXIT();
        }
...
local_outlif_info_logical_phase_info_first_bank_dump(int  unit,  int  logical_phase_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__LOGICAL_PHASE_INFO__FIRST_BANK, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->logical_phase_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__LOGICAL_PHASE_INFO__FIRST_BANK, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->logical_phase_info) == 0)
        {
            SHR_EXIT();
        }
...
local_outlif_info_logical_phase_info_last_bank_dump(int  unit,  int  logical_phase_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__LOGICAL_PHASE_INFO__LAST_BANK, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->logical_phase_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__LOGICAL_PHASE_INFO__LAST_BANK, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->logical_phase_info) == 0)
        {
            SHR_EXIT();
        }
...
int
local_outlif_info_logical_phase_info_first_no_ll_bank_dump(int  unit,  int  logical_phase_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = logical_phase_info_idx_0, I0 = logical_phase_info_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "algo_lif logical_phase_info first_no_ll_bank") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate algo_lif logical_phase_info first_no_ll_bank\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "local_outlif_info/logical_phase_info/first_no_ll_bank.txt",
            "local_outlif_info[%d]->","((local_outlif_info_t*)sw_state_roots_array[%d][ALGO_LIF_MODULE_ID])->","logical_phase_info[].first_no_ll_bank: ");
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__LOGICAL_PHASE_INFO__FIRST_NO_LL_BANK, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->logical_phase_info))
        {
            LOG_CLI((BSL_META("local_outlif_info[]->((local_outlif_info_t*)sw_state_roots_array[][ALGO_LIF_MODULE_ID])->logical_phase_info[].first_no_ll_bank: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__LOGICAL_PHASE_INFO__FIRST_NO_LL_BANK, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->logical_phase_info) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "local_outlif_info[%d]->","((local_outlif_info_t*)sw_state_roots_array[%d][ALGO_LIF_MODULE_ID])->","logical_phase_info[%s%d].first_no_ll_bank: ", s0, i0);
            ...
            dnx_sw_state_print_uint32(
                unit,
                &((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->logical_phase_info[i0].first_no_ll_bank);
...
int
local_outlif_info_logical_phase_info_last_no_ll_bank_dump(int  unit,  int  logical_phase_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = logical_phase_info_idx_0, I0 = logical_phase_info_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "algo_lif logical_phase_info last_no_ll_bank") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate algo_lif logical_phase_info last_no_ll_bank\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "local_outlif_info/logical_phase_info/last_no_ll_bank.txt",
            "local_outlif_info[%d]->","((local_outlif_info_t*)sw_state_roots_array[%d][ALGO_LIF_MODULE_ID])->","logical_phase_info[].last_no_ll_bank: ");
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__LOGICAL_PHASE_INFO__LAST_NO_LL_BANK, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->logical_phase_info))
        {
            LOG_CLI((BSL_META("local_outlif_info[]->((local_outlif_info_t*)sw_state_roots_array[][ALGO_LIF_MODULE_ID])->logical_phase_info[].last_no_ll_bank: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__LOGICAL_PHASE_INFO__LAST_NO_LL_BANK, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->logical_phase_info) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "local_outlif_info[%d]->","((local_outlif_info_t*)sw_state_roots_array[%d][ALGO_LIF_MODULE_ID])->","logical_phase_info[%s%d].last_no_ll_bank: ", s0, i0);
            ...
            dnx_sw_state_print_uint32(
                unit,
                &((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->logical_phase_info[i0].last_no_ll_bank);
...
local_outlif_info_logical_phase_info_first_ll_bank_dump(int  unit,  int  logical_phase_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__LOGICAL_PHASE_INFO__FIRST_LL_BANK, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->logical_phase_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__LOGICAL_PHASE_INFO__FIRST_LL_BANK, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->logical_phase_info) == 0)
        {
            SHR_EXIT();
        }
...
local_outlif_info_logical_phase_info_last_ll_bank_dump(int  unit,  int  logical_phase_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__LOGICAL_PHASE_INFO__LAST_LL_BANK, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->logical_phase_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__LOGICAL_PHASE_INFO__LAST_LL_BANK, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->logical_phase_info) == 0)
        {
            SHR_EXIT();
        }
...
local_outlif_info_logical_phase_info_dbal_valid_combinations_dump(int  unit,  int  logical_phase_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__LOGICAL_PHASE_INFO__DBAL_VALID_COMBINATIONS, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->logical_phase_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__LOGICAL_PHASE_INFO__DBAL_VALID_COMBINATIONS, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->logical_phase_info) == 0)
        {
            SHR_EXIT();
        }
...
local_outlif_info_physical_phase_to_logical_phase_map_dump(int  unit,  int  physical_phase_to_logical_phase_map_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__PHYSICAL_PHASE_TO_LOGICAL_PHASE_MAP, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->physical_phase_to_logical_phase_map))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__PHYSICAL_PHASE_TO_LOGICAL_PHASE_MAP, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->physical_phase_to_logical_phase_map) == 0)
        {
            SHR_EXIT();
        }
...
local_outlif_info_eedb_banks_info_bank_occupation_bitmap_dump(int  unit,  int  bank_occupation_bitmap_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__EEDB_BANKS_INFO__BANK_OCCUPATION_BITMAP, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->eedb_banks_info.bank_occupation_bitmap))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__EEDB_BANKS_INFO__BANK_OCCUPATION_BITMAP, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->eedb_banks_info.bank_occupation_bitmap) == 0)
        {
            SHR_EXIT();
        }
...
local_outlif_info_eedb_banks_info_outlif_prefix_occupation_bitmap_dump(int  unit,  int  outlif_prefix_occupation_bitmap_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__EEDB_BANKS_INFO__OUTLIF_PREFIX_OCCUPATION_BITMAP, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->eedb_banks_info.outlif_prefix_occupation_bitmap))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_LOCAL_OUTLIF_INFO__EEDB_BANKS_INFO__OUTLIF_PREFIX_OCCUPATION_BITMAP, ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->eedb_banks_info.outlif_prefix_occupation_bitmap) == 0)
        {
            SHR_EXIT();
        }
...
int
local_outlif_info_dynamic_algo_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "algo_lif dynamic_algo") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate algo_lif dynamic_algo\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "local_outlif_info/dynamic_algo.txt",
            "local_outlif_info[%d]->","((local_outlif_info_t*)sw_state_roots_array[%d][ALGO_LIF_MODULE_ID])->","dynamic_algo: ");
        ...
        dnx_sw_state_print_uint8(
            unit,
            &((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->dynamic_algo);
...
const char* local_outlif_info_layout_str[LOCAL_OUTLIF_INFO_INFO_NOF_ENTRIES] = {
    ...
    "LOCAL_OUTLIF_INFO~LOGICAL_PHASE_INFO~FIRST_NO_LL_BANK~",
    "LOCAL_OUTLIF_INFO~LOGICAL_PHASE_INFO~LAST_NO_LL_BANK~",
    ...
    "LOCAL_OUTLIF_INFO~DYNAMIC_ALGO~",
};
#endif 
