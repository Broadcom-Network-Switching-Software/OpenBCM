...
mdb_db_infos_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(mdb_db_infos_fec_db_info_dump(unit, filters));
...
mdb_db_infos_em_key_format_dump(int  unit,  int  em_key_format_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(mdb_db_infos_em_key_format_nof_ways_dump(unit, em_key_format_idx_0, filters));
    SHR_IF_ERR_EXIT(mdb_db_infos_em_key_format_nof_flex_ways_dump(unit, em_key_format_idx_0, filters));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
mdb_db_infos_em_key_format_em_bank_info_dump(int  unit,  int  em_key_format_idx_0,  int  em_bank_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(mdb_db_infos_em_key_format_em_bank_info_bank_size_used_nof_rows_dump(unit, em_key_format_idx_0, em_bank_info_idx_0, filters));
...
int
mdb_db_infos_em_key_format_em_bank_info_bank_size_used_nof_rows_dump(int  unit,  int  em_key_format_idx_0,  int  em_bank_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = em_key_format_idx_0, I0 = em_key_format_idx_0 + 1;
    int i1 = em_bank_info_idx_0, I1 = em_bank_info_idx_0 + 1, org_i1 = em_bank_info_idx_0;
    char *s0 = "", *s1 = "";
    ...
    if (dnx_sw_state_compare(filters.namefilter, "mdb em_key_format em_bank_info bank_size_used_nof_rows") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate mdb em_key_format em_bank_info bank_size_used_nof_rows\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "mdb_db_infos/em_key_format/em_bank_info/bank_size_used_nof_rows.txt",
            "mdb_db_infos[%d]->","((mdb_tables_info*)sw_state_roots_array[%d][MDB_MODULE_ID])->","em_key_format[].em_bank_info[].bank_size_used_nof_rows: ");
        ...
        if(i0 >= DBAL_NOF_PHYSICAL_TABLES)
        {
            LOG_CLI((BSL_META("mdb_db_infos[]->((mdb_tables_info*)sw_state_roots_array[][MDB_MODULE_ID])->em_key_format[].em_bank_info[].bank_size_used_nof_rows: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            for(; i1 < I1; i1++) {
                ...
                DNX_SW_STATE_PRINT_MONITOR(
                    unit,
                    "mdb_db_infos[%d]->","((mdb_tables_info*)sw_state_roots_array[%d][MDB_MODULE_ID])->","em_key_format[%s%d].em_bank_info[%s%d].bank_size_used_nof_rows: ", s0, i0, s1, i1);
                ...
                dnx_sw_state_print_uint32(
                    unit,
                    &((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->em_key_format[i0].em_bank_info[i1].bank_size_used_nof_rows);
...
int
mdb_db_infos_em_key_format_nof_ways_dump(int  unit,  int  em_key_format_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = em_key_format_idx_0, I0 = em_key_format_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "mdb em_key_format nof_ways") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate mdb em_key_format nof_ways\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "mdb_db_infos/em_key_format/nof_ways.txt",
            "mdb_db_infos[%d]->","((mdb_tables_info*)sw_state_roots_array[%d][MDB_MODULE_ID])->","em_key_format[].nof_ways: ");
        ...
        if(i0 >= DBAL_NOF_PHYSICAL_TABLES)
        {
            LOG_CLI((BSL_META("mdb_db_infos[]->((mdb_tables_info*)sw_state_roots_array[][MDB_MODULE_ID])->em_key_format[].nof_ways: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "mdb_db_infos[%d]->","((mdb_tables_info*)sw_state_roots_array[%d][MDB_MODULE_ID])->","em_key_format[%s%d].nof_ways: ", s0, i0);
            ...
            dnx_sw_state_print_uint32(
                unit,
                &((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->em_key_format[i0].nof_ways);
...
int
mdb_db_infos_em_key_format_nof_flex_ways_dump(int  unit,  int  em_key_format_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = em_key_format_idx_0, I0 = em_key_format_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "mdb em_key_format nof_flex_ways") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate mdb em_key_format nof_flex_ways\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "mdb_db_infos/em_key_format/nof_flex_ways.txt",
            "mdb_db_infos[%d]->","((mdb_tables_info*)sw_state_roots_array[%d][MDB_MODULE_ID])->","em_key_format[].nof_flex_ways: ");
        ...
        if(i0 >= DBAL_NOF_PHYSICAL_TABLES)
        {
            LOG_CLI((BSL_META("mdb_db_infos[]->((mdb_tables_info*)sw_state_roots_array[][MDB_MODULE_ID])->em_key_format[].nof_flex_ways: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "mdb_db_infos[%d]->","((mdb_tables_info*)sw_state_roots_array[%d][MDB_MODULE_ID])->","em_key_format[%s%d].nof_flex_ways: ", s0, i0);
            ...
            dnx_sw_state_print_uint32(
                unit,
                &((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->em_key_format[i0].nof_flex_ways);
...
mdb_db_infos_db_dump(int  unit,  int  db_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(mdb_db_infos_db_address_space_bits_dump(unit, db_idx_0, filters));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
mdb_db_infos_db_clusters_info_macro_type_dump(int  unit,  int  db_idx_0,  int  clusters_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__DB__CLUSTERS_INFO__MACRO_TYPE, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->db[i0].clusters_info))
            {
                LOG_CLI((BSL_META("mdb_db_infos[]->((mdb_tables_info*)sw_state_roots_array[][MDB_MODULE_ID])->db[].clusters_info[].macro_type: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__DB__CLUSTERS_INFO__MACRO_TYPE, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->db[i0].clusters_info) == 0)
            {
                SHR_EXIT();
            }
...
mdb_db_infos_db_clusters_info_macro_index_dump(int  unit,  int  db_idx_0,  int  clusters_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__DB__CLUSTERS_INFO__MACRO_INDEX, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->db[i0].clusters_info))
            {
                LOG_CLI((BSL_META("mdb_db_infos[]->((mdb_tables_info*)sw_state_roots_array[][MDB_MODULE_ID])->db[].clusters_info[].macro_index: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__DB__CLUSTERS_INFO__MACRO_INDEX, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->db[i0].clusters_info) == 0)
            {
                SHR_EXIT();
            }
...
mdb_db_infos_db_clusters_info_cluster_index_dump(int  unit,  int  db_idx_0,  int  clusters_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__DB__CLUSTERS_INFO__CLUSTER_INDEX, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->db[i0].clusters_info))
            {
                LOG_CLI((BSL_META("mdb_db_infos[]->((mdb_tables_info*)sw_state_roots_array[][MDB_MODULE_ID])->db[].clusters_info[].cluster_index: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__DB__CLUSTERS_INFO__CLUSTER_INDEX, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->db[i0].clusters_info) == 0)
            {
                SHR_EXIT();
            }
...
mdb_db_infos_db_clusters_info_cluster_position_in_entry_dump(int  unit,  int  db_idx_0,  int  clusters_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__DB__CLUSTERS_INFO__CLUSTER_POSITION_IN_ENTRY, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->db[i0].clusters_info))
            {
                LOG_CLI((BSL_META("mdb_db_infos[]->((mdb_tables_info*)sw_state_roots_array[][MDB_MODULE_ID])->db[].clusters_info[].cluster_position_in_entry: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__DB__CLUSTERS_INFO__CLUSTER_POSITION_IN_ENTRY, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->db[i0].clusters_info) == 0)
            {
                SHR_EXIT();
            }
...
mdb_db_infos_db_clusters_info_start_address_dump(int  unit,  int  db_idx_0,  int  clusters_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__DB__CLUSTERS_INFO__START_ADDRESS, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->db[i0].clusters_info))
            {
                LOG_CLI((BSL_META("mdb_db_infos[]->((mdb_tables_info*)sw_state_roots_array[][MDB_MODULE_ID])->db[].clusters_info[].start_address: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__DB__CLUSTERS_INFO__START_ADDRESS, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->db[i0].clusters_info) == 0)
            {
                SHR_EXIT();
            }
...
mdb_db_infos_db_clusters_info_end_address_dump(int  unit,  int  db_idx_0,  int  clusters_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__DB__CLUSTERS_INFO__END_ADDRESS, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->db[i0].clusters_info))
            {
                LOG_CLI((BSL_META("mdb_db_infos[]->((mdb_tables_info*)sw_state_roots_array[][MDB_MODULE_ID])->db[].clusters_info[].end_address: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__DB__CLUSTERS_INFO__END_ADDRESS, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->db[i0].clusters_info) == 0)
            {
                SHR_EXIT();
            }
...
int
mdb_db_infos_db_address_space_bits_dump(int  unit,  int  db_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = db_idx_0, I0 = db_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "mdb db address_space_bits") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate mdb db address_space_bits\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "mdb_db_infos/db/address_space_bits.txt",
            "mdb_db_infos[%d]->","((mdb_tables_info*)sw_state_roots_array[%d][MDB_MODULE_ID])->","db[].address_space_bits: ");
        ...
        if(i0 >= MDB_NOF_PHYSICAL_TABLES)
        {
            LOG_CLI((BSL_META("mdb_db_infos[]->((mdb_tables_info*)sw_state_roots_array[][MDB_MODULE_ID])->db[].address_space_bits: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "mdb_db_infos[%d]->","((mdb_tables_info*)sw_state_roots_array[%d][MDB_MODULE_ID])->","db[%s%d].address_space_bits: ", s0, i0);
            ...
            dnx_sw_state_print_int(
                unit,
                &((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->db[i0].address_space_bits);
...
mdb_db_infos_mdb_cluster_infos_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(mdb_db_infos_mdb_cluster_infos_macro_cluster_cache_dump(unit, -1, -1, -1, filters));
...
mdb_db_infos_mdb_cluster_infos_macro_cluster_assoc_pdb_dump(int  unit,  int  macro_cluster_assoc_idx_0,  int  macro_cluster_assoc_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__MDB_CLUSTER_INFOS__MACRO_CLUSTER_ASSOC__PDB, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->mdb_cluster_infos.macro_cluster_assoc[i0]))
            {
                LOG_CLI((BSL_META("mdb_db_infos[]->((mdb_tables_info*)sw_state_roots_array[][MDB_MODULE_ID])->mdb_cluster_infos.macro_cluster_assoc[][].pdb: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__MDB_CLUSTER_INFOS__MACRO_CLUSTER_ASSOC__PDB, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->mdb_cluster_infos.macro_cluster_assoc[i0]) == 0)
            {
                SHR_EXIT();
            }
...
mdb_db_infos_mdb_cluster_infos_macro_cluster_assoc_flags_dump(int  unit,  int  macro_cluster_assoc_idx_0,  int  macro_cluster_assoc_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__MDB_CLUSTER_INFOS__MACRO_CLUSTER_ASSOC__FLAGS, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->mdb_cluster_infos.macro_cluster_assoc[i0]))
            {
                LOG_CLI((BSL_META("mdb_db_infos[]->((mdb_tables_info*)sw_state_roots_array[][MDB_MODULE_ID])->mdb_cluster_infos.macro_cluster_assoc[][].flags: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__MDB_CLUSTER_INFOS__MACRO_CLUSTER_ASSOC__FLAGS, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->mdb_cluster_infos.macro_cluster_assoc[i0]) == 0)
            {
                SHR_EXIT();
            }
...
int
mdb_db_infos_mdb_cluster_infos_macro_cluster_cache_dump(int  unit,  int  macro_cluster_cache_idx_0,  int  macro_cluster_cache_idx_1,  int  macro_cluster_cache_idx_2,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(mdb_db_infos_mdb_cluster_infos_macro_cluster_cache_data_dump(unit, macro_cluster_cache_idx_0,macro_cluster_cache_idx_1,macro_cluster_cache_idx_2, -1, -1, filters));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
int
mdb_db_infos_mdb_cluster_infos_macro_cluster_cache_data_dump(int  unit,  int  macro_cluster_cache_idx_0,  int  macro_cluster_cache_idx_1,  int  macro_cluster_cache_idx_2,  int  data_idx_0,  int  data_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    int i2 = macro_cluster_cache_idx_2, I2 = macro_cluster_cache_idx_2 + 1, org_i2 = macro_cluster_cache_idx_2;
    int i3 = data_idx_0, I3 = data_idx_0 + 1, org_i3 = data_idx_0;
    int i4 = data_idx_1, I4 = data_idx_1 + 1, org_i4 = data_idx_1;
    char *s0 = "", *s1 = "", *s2 = "", *s3 = "", *s4 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__MDB_CLUSTER_INFOS__MACRO_CLUSTER_CACHE__DATA, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->mdb_cluster_infos.macro_cluster_cache[i0]))
            {
                LOG_CLI((BSL_META("mdb_db_infos[]->((mdb_tables_info*)sw_state_roots_array[][MDB_MODULE_ID])->mdb_cluster_infos.macro_cluster_cache[][][].data[][]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__MDB_CLUSTER_INFOS__MACRO_CLUSTER_CACHE__DATA, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->mdb_cluster_infos.macro_cluster_cache[i0]) == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                    ...
                    DNX_SW_STATE_DUMP_PTR_NULL_CHECK(
                        unit,
                        ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->mdb_cluster_infos.macro_cluster_cache[i0][i1]);
                ...
                if (i2 == -1) {
                    ...
                    i2 = dnx_sw_state_dump_check_all_the_same(unit,
                        ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->mdb_cluster_infos.macro_cluster_cache[i0][i1]
                        , sizeof(*((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->mdb_cluster_infos.macro_cluster_cache[i0][i1]), I2, &s2) ? I2 - 1 : 0;
                }

                if(i2 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__MDB_CLUSTER_INFOS__MACRO_CLUSTER_CACHE__DATA, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->mdb_cluster_infos.macro_cluster_cache[i0][i1]))
                {
                    LOG_CLI((BSL_META("mdb_db_infos[]->((mdb_tables_info*)sw_state_roots_array[][MDB_MODULE_ID])->mdb_cluster_infos.macro_cluster_cache[][][].data[][]: ")));
                    LOG_CLI((BSL_META("Invalid index: %d \n"),i2));
                    SHR_EXIT();
                ...
                if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__MDB_CLUSTER_INFOS__MACRO_CLUSTER_CACHE__DATA, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->mdb_cluster_infos.macro_cluster_cache[i0][i1]) == 0)
                {
                    SHR_EXIT();
                }
                ...
                for(; i2 < I2; i2++) {
                        ...
                        DNX_SW_STATE_DUMP_PTR_NULL_CHECK(
                            unit,
                            ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->mdb_cluster_infos.macro_cluster_cache[i0][i1][i2].data);
                    ...
                    if (i3 == -1) {
                        ...
                        i3 = dnx_sw_state_dump_check_all_the_same(unit,
                            ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->mdb_cluster_infos.macro_cluster_cache[i0][i1][i2].data
                            , sizeof(*((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->mdb_cluster_infos.macro_cluster_cache[i0][i1][i2].data), I3, &s3) ? I3 - 1 : 0;
                    }

                    if(i3 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__MDB_CLUSTER_INFOS__MACRO_CLUSTER_CACHE__DATA, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->mdb_cluster_infos.macro_cluster_cache[i0][i1][i2].data))
                    {
                        LOG_CLI((BSL_META("mdb_db_infos[]->((mdb_tables_info*)sw_state_roots_array[][MDB_MODULE_ID])->mdb_cluster_infos.macro_cluster_cache[][][].data[][]: ")));
                        LOG_CLI((BSL_META("Invalid index: %d \n"),i3));
                        SHR_EXIT();
                    ...
                    if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__MDB_CLUSTER_INFOS__MACRO_CLUSTER_CACHE__DATA, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->mdb_cluster_infos.macro_cluster_cache[i0][i1][i2].data) == 0)
                    {
                        SHR_EXIT();
                    }
                    ...
                    for(; i3 < I3; i3++) {
                        if (i4 == -1) {
                            I4 = DNX_DATA_MAX_MDB_DH_CLUSTER_ROW_WIDTH_UINT32;
                            i4 = dnx_sw_state_dump_check_all_the_same(unit,
                                ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->mdb_cluster_infos.macro_cluster_cache[i0][i1][i2].data[i3]
                                , sizeof(*((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->mdb_cluster_infos.macro_cluster_cache[i0][i1][i2].data[i3]), I4, &s4) ? I4 - 1 : 0;
                        }

                        if(i4 >= DNX_DATA_MAX_MDB_DH_CLUSTER_ROW_WIDTH_UINT32)
                        {
                            LOG_CLI((BSL_META("mdb_db_infos[]->((mdb_tables_info*)sw_state_roots_array[][MDB_MODULE_ID])->mdb_cluster_infos.macro_cluster_cache[][][].data[][]: ")));
                            LOG_CLI((BSL_META("Invalid index: %d \n"),i4));
                            SHR_EXIT();
                        ...
                        for(; i4 < I4; i4++) {
                            dnx_sw_state_dump_update_current_idx(unit, i4);
                            DNX_SW_STATE_PRINT_MONITOR(
                                unit,
                                "mdb_db_infos[%d]->","((mdb_tables_info*)sw_state_roots_array[%d][MDB_MODULE_ID])->","mdb_cluster_infos.macro_cluster_cache[%s%d][%s%d][%s%d].data[%s%d][%s%d]: ", s0, i0, s1, i1, s2, i2, s3, i3, s4, i4);

                            DNX_SW_STATE_PRINT_FILE(
                                unit,
                                "[%s%d][%s%d][%s%d][%s%d][%s%d]: ", s0, i0, s1, i1, s2, i2, s3, i3, s4, i4);

                            dnx_sw_state_print_uint32(
                                unit,
                                &((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->mdb_cluster_infos.macro_cluster_cache[i0][i1][i2].data[i3][i4]);
...
mdb_db_infos_mdb_cluster_infos_eedb_banks_hitbit_dump(int  unit,  int  eedb_banks_hitbit_idx_0,  int  eedb_banks_hitbit_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__MDB_CLUSTER_INFOS__EEDB_BANKS_HITBIT, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->mdb_cluster_infos.eedb_banks_hitbit[i0]))
            {
                LOG_CLI((BSL_META("mdb_db_infos[]->((mdb_tables_info*)sw_state_roots_array[][MDB_MODULE_ID])->mdb_cluster_infos.eedb_banks_hitbit[][]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__MDB_CLUSTER_INFOS__EEDB_BANKS_HITBIT, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->mdb_cluster_infos.eedb_banks_hitbit[i0]) == 0)
            {
                SHR_EXIT();
            }
...
mdb_db_infos_mdb_cluster_infos_small_kaps_bb_hitbit_dump(int  unit,  int  small_kaps_bb_hitbit_idx_0,  int  small_kaps_bb_hitbit_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__MDB_CLUSTER_INFOS__SMALL_KAPS_BB_HITBIT, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->mdb_cluster_infos.small_kaps_bb_hitbit))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__MDB_CLUSTER_INFOS__SMALL_KAPS_BB_HITBIT, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->mdb_cluster_infos.small_kaps_bb_hitbit) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__MDB_CLUSTER_INFOS__SMALL_KAPS_BB_HITBIT, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->mdb_cluster_infos.small_kaps_bb_hitbit[i0]))
            {
                LOG_CLI((BSL_META("mdb_db_infos[]->((mdb_tables_info*)sw_state_roots_array[][MDB_MODULE_ID])->mdb_cluster_infos.small_kaps_bb_hitbit[][]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__MDB_CLUSTER_INFOS__SMALL_KAPS_BB_HITBIT, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->mdb_cluster_infos.small_kaps_bb_hitbit[i0]) == 0)
            {
                SHR_EXIT();
            }
...
mdb_db_infos_mdb_cluster_infos_small_kaps_rpb_hitbit_dump(int  unit,  int  small_kaps_rpb_hitbit_idx_0,  int  small_kaps_rpb_hitbit_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__MDB_CLUSTER_INFOS__SMALL_KAPS_RPB_HITBIT, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->mdb_cluster_infos.small_kaps_rpb_hitbit))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__MDB_CLUSTER_INFOS__SMALL_KAPS_RPB_HITBIT, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->mdb_cluster_infos.small_kaps_rpb_hitbit) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__MDB_CLUSTER_INFOS__SMALL_KAPS_RPB_HITBIT, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->mdb_cluster_infos.small_kaps_rpb_hitbit[i0]))
            {
                LOG_CLI((BSL_META("mdb_db_infos[]->((mdb_tables_info*)sw_state_roots_array[][MDB_MODULE_ID])->mdb_cluster_infos.small_kaps_rpb_hitbit[][]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__MDB_CLUSTER_INFOS__SMALL_KAPS_RPB_HITBIT, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->mdb_cluster_infos.small_kaps_rpb_hitbit[i0]) == 0)
            {
                SHR_EXIT();
            }
...
mdb_db_infos_mdb_cluster_infos_direct_address_mapping_dump(int  unit,  int  direct_address_mapping_idx_0,  int  direct_address_mapping_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__MDB_CLUSTER_INFOS__DIRECT_ADDRESS_MAPPING, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->mdb_cluster_infos.direct_address_mapping[i0]))
            {
                LOG_CLI((BSL_META("mdb_db_infos[]->((mdb_tables_info*)sw_state_roots_array[][MDB_MODULE_ID])->mdb_cluster_infos.direct_address_mapping[][]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__MDB_CLUSTER_INFOS__DIRECT_ADDRESS_MAPPING, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->mdb_cluster_infos.direct_address_mapping[i0]) == 0)
            {
                SHR_EXIT();
            }
...
mdb_db_infos_mdb_cluster_infos_eedb_address_mapping_dump(int  unit,  int  eedb_address_mapping_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__MDB_CLUSTER_INFOS__EEDB_ADDRESS_MAPPING, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->mdb_cluster_infos.eedb_address_mapping))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__MDB_CLUSTER_INFOS__EEDB_ADDRESS_MAPPING, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->mdb_cluster_infos.eedb_address_mapping) == 0)
        {
            SHR_EXIT();
        }
...
mdb_db_infos_eedb_bank_traffic_lock_local_lifs_dump(int  unit,  int  local_lifs_idx_0,  int  local_lifs_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__EEDB_BANK_TRAFFIC_LOCK__LOCAL_LIFS, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->eedb_bank_traffic_lock.local_lifs[i0]))
            {
                LOG_CLI((BSL_META("mdb_db_infos[]->((mdb_tables_info*)sw_state_roots_array[][MDB_MODULE_ID])->eedb_bank_traffic_lock.local_lifs[][]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__EEDB_BANK_TRAFFIC_LOCK__LOCAL_LIFS, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->eedb_bank_traffic_lock.local_lifs[i0]) == 0)
            {
                SHR_EXIT();
            }
...
int
mdb_db_infos_fec_db_info_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(mdb_db_infos_fec_db_info_fec_db_map_dump(unit, -1, filters));
    SHR_IF_ERR_EXIT(mdb_db_infos_fec_db_info_fec_id_range_start_dump(unit, -1, filters));
    SHR_IF_ERR_EXIT(mdb_db_infos_fec_db_info_fec_id_range_size_dump(unit, -1, filters));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
int
mdb_db_infos_fec_db_info_fec_db_map_dump(int  unit,  int  bank_id,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = bank_id, I0 = bank_id + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "mdb fec_db_info fec_db_map") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate mdb fec_db_info fec_db_map\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "mdb_db_infos/fec_db_info/fec_db_map.txt",
            "mdb_db_infos[%d]->","((mdb_tables_info*)sw_state_roots_array[%d][MDB_MODULE_ID])->","fec_db_info.fec_db_map[]: ");
        ...
        if (i0 == -1) {
            ...
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->fec_db_info.fec_db_map
                , sizeof(*((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->fec_db_info.fec_db_map), I0, &s0) ? I0 - 1 : 0;
        }

        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__FEC_DB_INFO__FEC_DB_MAP, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->fec_db_info.fec_db_map))
        {
            LOG_CLI((BSL_META("mdb_db_infos[]->((mdb_tables_info*)sw_state_roots_array[][MDB_MODULE_ID])->fec_db_info.fec_db_map[]: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__FEC_DB_INFO__FEC_DB_MAP, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->fec_db_info.fec_db_map) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "mdb_db_infos[%d]->","((mdb_tables_info*)sw_state_roots_array[%d][MDB_MODULE_ID])->","fec_db_info.fec_db_map[%s%d]: ", s0, i0);
            ...
            dnx_sw_state_print_uint32(
                unit,
                &((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->fec_db_info.fec_db_map[i0]);
...
int
mdb_db_infos_fec_db_info_fec_id_range_start_dump(int  unit,  int  index,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = index, I0 = index + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "mdb fec_db_info fec_id_range_start") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate mdb fec_db_info fec_id_range_start\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "mdb_db_infos/fec_db_info/fec_id_range_start.txt",
            "mdb_db_infos[%d]->","((mdb_tables_info*)sw_state_roots_array[%d][MDB_MODULE_ID])->","fec_db_info.fec_id_range_start[]: ");
        ...
        if (i0 == -1) {
            ...
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->fec_db_info.fec_id_range_start
                , sizeof(*((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->fec_db_info.fec_id_range_start), I0, &s0) ? I0 - 1 : 0;
        }

        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__FEC_DB_INFO__FEC_ID_RANGE_START, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->fec_db_info.fec_id_range_start))
        {
            LOG_CLI((BSL_META("mdb_db_infos[]->((mdb_tables_info*)sw_state_roots_array[][MDB_MODULE_ID])->fec_db_info.fec_id_range_start[]: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__FEC_DB_INFO__FEC_ID_RANGE_START, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->fec_db_info.fec_id_range_start) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "mdb_db_infos[%d]->","((mdb_tables_info*)sw_state_roots_array[%d][MDB_MODULE_ID])->","fec_db_info.fec_id_range_start[%s%d]: ", s0, i0);
            ...
            dnx_sw_state_print_uint32(
                unit,
                &((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->fec_db_info.fec_id_range_start[i0]);
...
int
mdb_db_infos_fec_db_info_fec_id_range_size_dump(int  unit,  int  index,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = index, I0 = index + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "mdb fec_db_info fec_id_range_size") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate mdb fec_db_info fec_id_range_size\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "mdb_db_infos/fec_db_info/fec_id_range_size.txt",
            "mdb_db_infos[%d]->","((mdb_tables_info*)sw_state_roots_array[%d][MDB_MODULE_ID])->","fec_db_info.fec_id_range_size[]: ");
        ...
        if (i0 == -1) {
            ...
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->fec_db_info.fec_id_range_size
                , sizeof(*((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->fec_db_info.fec_id_range_size), I0, &s0) ? I0 - 1 : 0;
        }

        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__FEC_DB_INFO__FEC_ID_RANGE_SIZE, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->fec_db_info.fec_id_range_size))
        {
            LOG_CLI((BSL_META("mdb_db_infos[]->((mdb_tables_info*)sw_state_roots_array[][MDB_MODULE_ID])->fec_db_info.fec_id_range_size[]: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_MDB_DB_INFOS__FEC_DB_INFO__FEC_ID_RANGE_SIZE, ((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->fec_db_info.fec_id_range_size) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "mdb_db_infos[%d]->","((mdb_tables_info*)sw_state_roots_array[%d][MDB_MODULE_ID])->","fec_db_info.fec_id_range_size[%s%d]: ", s0, i0);
            ...
            dnx_sw_state_print_uint32(
                unit,
                &((mdb_tables_info*)sw_state_roots_array[unit][MDB_MODULE_ID])->fec_db_info.fec_id_range_size[i0]);
...
const char* mdb_db_infos_layout_str[MDB_DB_INFOS_INFO_NOF_ENTRIES] = {
    ...
    "MDB_DB_INFOS~EM_KEY_FORMAT~EM_BANK_INFO~BANK_SIZE_USED_NOF_ROWS~",
    ...
    "MDB_DB_INFOS~EM_KEY_FORMAT~NOF_WAYS~",
    "MDB_DB_INFOS~EM_KEY_FORMAT~NOF_FLEX_WAYS~",
    "MDB_DB_INFOS~DB~",
    ...
    "MDB_DB_INFOS~DB~ADDRESS_SPACE_BITS~",
    ...
    "MDB_DB_INFOS~FEC_DB_INFO~",
    "MDB_DB_INFOS~FEC_DB_INFO~FEC_DB_MAP~",
    "MDB_DB_INFOS~FEC_DB_INFO~FEC_ID_RANGE_START~",
    "MDB_DB_INFOS~FEC_DB_INFO~FEC_ID_RANGE_SIZE~",
