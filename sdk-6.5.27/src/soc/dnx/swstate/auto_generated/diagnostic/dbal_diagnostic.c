...
dbal_db_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_field_names_override_locations_dump(unit, filters));
    SHR_IF_ERR_EXIT(dbal_db_field_names_override_strings_dump(unit, -1, filters));
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_ENUM(
                unit,
                dbal_sw_state_table_type_e_get_name(((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->sw_tables[i0].table_type));
...
dbal_db_sw_tables_entries_dump(int  unit,  int  sw_tables_idx_0,  int  entries_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__SW_TABLES__ENTRIES, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->sw_tables[i0].entries))
            {
                LOG_CLI((BSL_META("dbal_db[]->((dnx_dbal_sw_state_t*)sw_state_roots_array[][DBAL_MODULE_ID])->sw_tables[].entries[]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__SW_TABLES__ENTRIES, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->sw_tables[i0].entries) == 0)
            {
                SHR_EXIT();
            }
...
dbal_db_tables_properties_table_status_dump(int  unit,  int  tables_properties_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__TABLES_PROPERTIES__TABLE_STATUS, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->tables_properties))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__TABLES_PROPERTIES__TABLE_STATUS, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->tables_properties) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_ENUM(
                unit,
                dbal_table_status_e_get_name(((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->tables_properties[i0].table_status));
...
dbal_db_tables_properties_nof_entries_dump(int  unit,  int  tables_properties_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__TABLES_PROPERTIES__NOF_ENTRIES, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->tables_properties))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__TABLES_PROPERTIES__NOF_ENTRIES, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->tables_properties) == 0)
        {
            SHR_EXIT();
        }
...
dbal_db_tables_properties_tcam_handler_id_dump(int  unit,  int  tables_properties_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__TABLES_PROPERTIES__TCAM_HANDLER_ID, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->tables_properties))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__TABLES_PROPERTIES__TCAM_HANDLER_ID, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->tables_properties) == 0)
        {
            SHR_EXIT();
        }
...
dbal_db_tables_properties_indications_bm_dump(int  unit,  int  tables_properties_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__TABLES_PROPERTIES__INDICATIONS_BM, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->tables_properties))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__TABLES_PROPERTIES__INDICATIONS_BM, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->tables_properties) == 0)
        {
            SHR_EXIT();
        }
...
dbal_db_tables_properties_iterator_optimized_bitmap_dump(int  unit,  int  tables_properties_idx_0,  int  iterator_optimized_idx_0,  int  bitmap_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__TABLES_PROPERTIES__ITERATOR_OPTIMIZED__BITMAP, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->tables_properties))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__TABLES_PROPERTIES__ITERATOR_OPTIMIZED__BITMAP, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->tables_properties) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__TABLES_PROPERTIES__ITERATOR_OPTIMIZED__BITMAP, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->tables_properties[i0].iterator_optimized))
            {
                LOG_CLI((BSL_META("dbal_db[]->((dnx_dbal_sw_state_t*)sw_state_roots_array[][DBAL_MODULE_ID])->tables_properties[].iterator_optimized[].bitmap[]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__TABLES_PROPERTIES__ITERATOR_OPTIMIZED__BITMAP, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->tables_properties[i0].iterator_optimized) == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                if(i2 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__TABLES_PROPERTIES__ITERATOR_OPTIMIZED__BITMAP, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->tables_properties[i0].iterator_optimized[i1].bitmap))
                {
                    LOG_CLI((BSL_META("dbal_db[]->((dnx_dbal_sw_state_t*)sw_state_roots_array[][DBAL_MODULE_ID])->tables_properties[].iterator_optimized[].bitmap[]: ")));
                    LOG_CLI((BSL_META("Invalid index: %d \n"),i2));
                    SHR_EXIT();
                ...
                if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__TABLES_PROPERTIES__ITERATOR_OPTIMIZED__BITMAP, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->tables_properties[i0].iterator_optimized[i1].bitmap) == 0)
                {
                    SHR_EXIT();
                }
...
dbal_db_dbal_dynamic_tables_table_id_dump(int  unit,  int  dbal_dynamic_tables_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_TABLES__TABLE_ID, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_tables))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_TABLES__TABLE_ID, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_tables) == 0)
        {
            SHR_EXIT();
        }
...
dbal_db_dbal_dynamic_tables_table_name_dump(int  unit,  int  dbal_dynamic_tables_idx_0,  int  table_name_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_TABLES__TABLE_NAME, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_tables))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_TABLES__TABLE_NAME, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_tables) == 0)
        {
            SHR_EXIT();
        }
...
dbal_db_dbal_dynamic_tables_labels_dump(int  unit,  int  dbal_dynamic_tables_idx_0,  int  labels_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_TABLES__LABELS, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_tables))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_TABLES__LABELS, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_tables) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_TABLES__LABELS, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_tables[i0].labels))
            {
                LOG_CLI((BSL_META("dbal_db[]->((dnx_dbal_sw_state_t*)sw_state_roots_array[][DBAL_MODULE_ID])->dbal_dynamic_tables[].labels[]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_TABLES__LABELS, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_tables[i0].labels) == 0)
            {
                SHR_EXIT();
            }
...
dbal_db_dbal_dynamic_tables_data_dump(int  unit,  int  dbal_dynamic_tables_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_TABLES__DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_tables))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_TABLES__DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_tables) == 0)
        {
            SHR_EXIT();
        }
...
dbal_db_dbal_dynamic_tables_key_info_data_dump(int  unit,  int  dbal_dynamic_tables_idx_0,  int  key_info_data_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_TABLES__KEY_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_tables))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_TABLES__KEY_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_tables) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_TABLES__KEY_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_tables[i0].key_info_data))
            {
                LOG_CLI((BSL_META("dbal_db[]->((dnx_dbal_sw_state_t*)sw_state_roots_array[][DBAL_MODULE_ID])->dbal_dynamic_tables[].key_info_data[]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_TABLES__KEY_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_tables[i0].key_info_data) == 0)
            {
                SHR_EXIT();
            }
...
dbal_db_dbal_dynamic_tables_multi_res_info_data_dump(int  unit,  int  dbal_dynamic_tables_idx_0,  int  multi_res_info_data_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_TABLES__MULTI_RES_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_tables))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_TABLES__MULTI_RES_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_tables) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_TABLES__MULTI_RES_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_tables[i0].multi_res_info_data))
            {
                LOG_CLI((BSL_META("dbal_db[]->((dnx_dbal_sw_state_t*)sw_state_roots_array[][DBAL_MODULE_ID])->dbal_dynamic_tables[].multi_res_info_data[]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_TABLES__MULTI_RES_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_tables[i0].multi_res_info_data) == 0)
            {
                SHR_EXIT();
            }
...
dbal_db_dbal_dynamic_tables_res_info_data_dump(int  unit,  int  dbal_dynamic_tables_idx_0,  int  res_info_data_idx_0,  int  res_info_data_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_TABLES__RES_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_tables))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_TABLES__RES_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_tables) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_TABLES__RES_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_tables[i0].res_info_data))
            {
                LOG_CLI((BSL_META("dbal_db[]->((dnx_dbal_sw_state_t*)sw_state_roots_array[][DBAL_MODULE_ID])->dbal_dynamic_tables[].res_info_data[][]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_TABLES__RES_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_tables[i0].res_info_data) == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                if(i2 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_TABLES__RES_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_tables[i0].res_info_data[i1]))
                {
                    LOG_CLI((BSL_META("dbal_db[]->((dnx_dbal_sw_state_t*)sw_state_roots_array[][DBAL_MODULE_ID])->dbal_dynamic_tables[].res_info_data[][]: ")));
                    LOG_CLI((BSL_META("Invalid index: %d \n"),i2));
                    SHR_EXIT();
                ...
                if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_TABLES__RES_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_tables[i0].res_info_data[i1]) == 0)
                {
                    SHR_EXIT();
                }
...
dbal_db_dbal_dynamic_tables_access_info_dump(int  unit,  int  dbal_dynamic_tables_idx_0,  int  access_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_TABLES__ACCESS_INFO, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_tables))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_TABLES__ACCESS_INFO, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_tables) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_TABLES__ACCESS_INFO, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_tables[i0].access_info))
            {
                LOG_CLI((BSL_META("dbal_db[]->((dnx_dbal_sw_state_t*)sw_state_roots_array[][DBAL_MODULE_ID])->dbal_dynamic_tables[].access_info[]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_TABLES__ACCESS_INFO, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_tables[i0].access_info) == 0)
            {
                SHR_EXIT();
            }
...
dbal_db_dbal_dynamic_xml_tables_table_id_dump(int  unit,  int  dbal_dynamic_xml_tables_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_XML_TABLES__TABLE_ID, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_xml_tables))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_XML_TABLES__TABLE_ID, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_xml_tables) == 0)
        {
            SHR_EXIT();
        }
...
dbal_db_dbal_dynamic_xml_tables_table_name_dump(int  unit,  int  dbal_dynamic_xml_tables_idx_0,  int  table_name_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_XML_TABLES__TABLE_NAME, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_xml_tables))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_XML_TABLES__TABLE_NAME, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_xml_tables) == 0)
        {
            SHR_EXIT();
        }
...
dbal_db_dbal_dynamic_xml_tables_labels_dump(int  unit,  int  dbal_dynamic_xml_tables_idx_0,  int  labels_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_XML_TABLES__LABELS, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_xml_tables))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_XML_TABLES__LABELS, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_xml_tables) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_XML_TABLES__LABELS, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_xml_tables[i0].labels))
            {
                LOG_CLI((BSL_META("dbal_db[]->((dnx_dbal_sw_state_t*)sw_state_roots_array[][DBAL_MODULE_ID])->dbal_dynamic_xml_tables[].labels[]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_XML_TABLES__LABELS, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_xml_tables[i0].labels) == 0)
            {
                SHR_EXIT();
            }
...
dbal_db_dbal_dynamic_xml_tables_data_dump(int  unit,  int  dbal_dynamic_xml_tables_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_XML_TABLES__DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_xml_tables))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_XML_TABLES__DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_xml_tables) == 0)
        {
            SHR_EXIT();
        }
...
dbal_db_dbal_dynamic_xml_tables_key_info_data_dump(int  unit,  int  dbal_dynamic_xml_tables_idx_0,  int  key_info_data_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_XML_TABLES__KEY_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_xml_tables))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_XML_TABLES__KEY_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_xml_tables) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_XML_TABLES__KEY_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_xml_tables[i0].key_info_data))
            {
                LOG_CLI((BSL_META("dbal_db[]->((dnx_dbal_sw_state_t*)sw_state_roots_array[][DBAL_MODULE_ID])->dbal_dynamic_xml_tables[].key_info_data[]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_XML_TABLES__KEY_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_xml_tables[i0].key_info_data) == 0)
            {
                SHR_EXIT();
            }
...
dbal_db_dbal_dynamic_xml_tables_multi_res_info_data_dump(int  unit,  int  dbal_dynamic_xml_tables_idx_0,  int  multi_res_info_data_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_XML_TABLES__MULTI_RES_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_xml_tables))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_XML_TABLES__MULTI_RES_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_xml_tables) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_XML_TABLES__MULTI_RES_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_xml_tables[i0].multi_res_info_data))
            {
                LOG_CLI((BSL_META("dbal_db[]->((dnx_dbal_sw_state_t*)sw_state_roots_array[][DBAL_MODULE_ID])->dbal_dynamic_xml_tables[].multi_res_info_data[]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_XML_TABLES__MULTI_RES_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_xml_tables[i0].multi_res_info_data) == 0)
            {
                SHR_EXIT();
            }
...
dbal_db_dbal_dynamic_xml_tables_res_info_data_dump(int  unit,  int  dbal_dynamic_xml_tables_idx_0,  int  res_info_data_idx_0,  int  res_info_data_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_XML_TABLES__RES_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_xml_tables))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_XML_TABLES__RES_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_xml_tables) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_XML_TABLES__RES_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_xml_tables[i0].res_info_data))
            {
                LOG_CLI((BSL_META("dbal_db[]->((dnx_dbal_sw_state_t*)sw_state_roots_array[][DBAL_MODULE_ID])->dbal_dynamic_xml_tables[].res_info_data[][]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_XML_TABLES__RES_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_xml_tables[i0].res_info_data) == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                if(i2 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_XML_TABLES__RES_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_xml_tables[i0].res_info_data[i1]))
                {
                    LOG_CLI((BSL_META("dbal_db[]->((dnx_dbal_sw_state_t*)sw_state_roots_array[][DBAL_MODULE_ID])->dbal_dynamic_xml_tables[].res_info_data[][]: ")));
                    LOG_CLI((BSL_META("Invalid index: %d \n"),i2));
                    SHR_EXIT();
                ...
                if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_XML_TABLES__RES_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_xml_tables[i0].res_info_data[i1]) == 0)
                {
                    SHR_EXIT();
                }
...
dbal_db_dbal_dynamic_xml_tables_access_info_dump(int  unit,  int  dbal_dynamic_xml_tables_idx_0,  int  access_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_XML_TABLES__ACCESS_INFO, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_xml_tables))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_XML_TABLES__ACCESS_INFO, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_xml_tables) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_XML_TABLES__ACCESS_INFO, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_xml_tables[i0].access_info))
            {
                LOG_CLI((BSL_META("dbal_db[]->((dnx_dbal_sw_state_t*)sw_state_roots_array[][DBAL_MODULE_ID])->dbal_dynamic_xml_tables[].access_info[]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_XML_TABLES__ACCESS_INFO, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_xml_tables[i0].access_info) == 0)
            {
                SHR_EXIT();
            }
...
dbal_db_dbal_ppmc_table_res_types_multi_res_info_status_dump(int  unit,  int  multi_res_info_status_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_PPMC_TABLE_RES_TYPES__MULTI_RES_INFO_STATUS, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_ppmc_table_res_types.multi_res_info_status))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_PPMC_TABLE_RES_TYPES__MULTI_RES_INFO_STATUS, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_ppmc_table_res_types.multi_res_info_status) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_ENUM(
                unit,
                dbal_multi_res_info_status_e_get_name(((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_ppmc_table_res_types.multi_res_info_status[i0]));
...
dbal_db_dbal_ppmc_table_res_types_multi_res_info_data_sep_multi_res_info_data_dump(int  unit,  int  multi_res_info_data_sep_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_PPMC_TABLE_RES_TYPES__MULTI_RES_INFO_DATA_SEP__MULTI_RES_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_ppmc_table_res_types.multi_res_info_data_sep))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_PPMC_TABLE_RES_TYPES__MULTI_RES_INFO_DATA_SEP__MULTI_RES_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_ppmc_table_res_types.multi_res_info_data_sep) == 0)
        {
            SHR_EXIT();
        }
...
dbal_db_dbal_ppmc_table_res_types_multi_res_info_data_sep_res_info_data_dump(int  unit,  int  multi_res_info_data_sep_idx_0,  int  res_info_data_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_PPMC_TABLE_RES_TYPES__MULTI_RES_INFO_DATA_SEP__RES_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_ppmc_table_res_types.multi_res_info_data_sep))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_PPMC_TABLE_RES_TYPES__MULTI_RES_INFO_DATA_SEP__RES_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_ppmc_table_res_types.multi_res_info_data_sep) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_PPMC_TABLE_RES_TYPES__MULTI_RES_INFO_DATA_SEP__RES_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_ppmc_table_res_types.multi_res_info_data_sep[i0].res_info_data))
            {
                LOG_CLI((BSL_META("dbal_db[]->((dnx_dbal_sw_state_t*)sw_state_roots_array[][DBAL_MODULE_ID])->dbal_ppmc_table_res_types.multi_res_info_data_sep[].res_info_data[]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DBAL_DB__DBAL_PPMC_TABLE_RES_TYPES__MULTI_RES_INFO_DATA_SEP__RES_INFO_DATA, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_ppmc_table_res_types.multi_res_info_data_sep[i0].res_info_data) == 0)
            {
                SHR_EXIT();
            }
...
int
dbal_db_field_names_override_locations_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dbal field_names_override_locations") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dbal field_names_override_locations\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dbal_db/field_names_override_locations.txt",
            "dbal_db[%d]->","((dnx_dbal_sw_state_t*)sw_state_roots_array[%d][DBAL_MODULE_ID])->","field_names_override_locations: ");
...
int
dbal_db_field_names_override_strings_dump(int  unit,  int  field_names_override_strings_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dbal_db_field_names_override_strings_string_dump(unit, field_names_override_strings_idx_0, -1, filters));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
int
dbal_db_field_names_override_strings_string_dump(int  unit,  int  field_names_override_strings_idx_0,  int  string_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = field_names_override_strings_idx_0, I0 = field_names_override_strings_idx_0 + 1;
    int i1 = string_idx_0, I1 = string_idx_0 + 1, org_i1 = string_idx_0;
    char *s0 = "", *s1 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dbal field_names_override_strings string") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dbal field_names_override_strings string\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dbal_db/field_names_override_strings/string.txt",
            "dbal_db[%d]->","((dnx_dbal_sw_state_t*)sw_state_roots_array[%d][DBAL_MODULE_ID])->","field_names_override_strings[].string[]: ");
        ...
        if (i0 == -1) {
            I0 = DBAL_NOF_FIELD_NAME_OVERRIDE_INSTANCES;
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->field_names_override_strings
                , sizeof(*((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->field_names_override_strings), I0, &s0) ? I0 - 1 : 0;
        }

        if(i0 >= DBAL_NOF_FIELD_NAME_OVERRIDE_INSTANCES)
        {
            LOG_CLI((BSL_META("dbal_db[]->((dnx_dbal_sw_state_t*)sw_state_roots_array[][DBAL_MODULE_ID])->field_names_override_strings[].string[]: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(DBAL_NOF_FIELD_NAME_OVERRIDE_INSTANCES == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            if (i1 == -1) {
                I1 = DBAL_MAX_STRING_LENGTH;
                i1 = dnx_sw_state_dump_check_all_the_same(unit,
                    ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->field_names_override_strings[i0].string
                    , sizeof(*((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->field_names_override_strings[i0].string), I1, &s1) ? I1 - 1 : 0;
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                DNX_SW_STATE_PRINT_MONITOR(
                    unit,
                    "dbal_db[%d]->","((dnx_dbal_sw_state_t*)sw_state_roots_array[%d][DBAL_MODULE_ID])->","field_names_override_strings[%s%d].string[%s%d]: ", s0, i0, s1, i1);
                ...
                dnx_sw_state_print_char(
                    unit,
                    &((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->field_names_override_strings[i0].string[i1]);
...
const char* dbal_db_layout_str[DBAL_DB_INFO_NOF_ENTRIES] = {
    ...
    "DBAL_DB~FIELD_NAMES_OVERRIDE_LOCATIONS~",
    "DBAL_DB~FIELD_NAMES_OVERRIDE_STRINGS~",
    "DBAL_DB~FIELD_NAMES_OVERRIDE_STRINGS~STRING~",
};
#endif 
