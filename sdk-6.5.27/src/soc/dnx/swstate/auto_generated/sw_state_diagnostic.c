...
#include <src/soc/dnx/swstate/auto_generated/diagnostic/dnx_epfc_sw_state_diagnostic.c>
...
#include <src/soc/dnx/swstate/auto_generated/diagnostic/rx_trap_diagnostic.c>
