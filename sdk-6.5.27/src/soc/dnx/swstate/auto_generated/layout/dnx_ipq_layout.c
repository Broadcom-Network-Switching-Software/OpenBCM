...
dnx_ipq_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_ipq[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_ipq[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_IPQ_DB__LAST)-1;
    ...
    layout_array_dnx_ipq[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_IPQ_DB__BASE_QUEUES__LAST)-1;
    ...
    layout_array_dnx_ipq[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA_BITMAP;
    layout_array_dnx_ipq[idx].parent  = 0;
