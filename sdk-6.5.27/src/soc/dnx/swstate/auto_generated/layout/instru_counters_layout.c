...
instru_counters_init_layout_structure(int unit)
{
    ...
    idx = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_INSTRU_SYNC_COUNTERS__PORTS_FOR_PFC_COUNTERS);
    layout_array_instru_counters[idx].name = "instru_sync_counters__ports_for_pfc_counters";
    layout_array_instru_counters[idx].type = "sync_counters_ports_for_pfc_t";
    layout_array_instru_counters[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_instru_counters[idx].size_of = sizeof(sync_counters_ports_for_pfc_t);
    layout_array_instru_counters[idx].array_indexes[0].num_elements = DNX_DATA_MAX_INSTRU_SYNCED_COUNTERS_NOF_PORTS_FOR_PFC;
    layout_array_instru_counters[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_instru_counters[idx].parent  = 0;
    layout_array_instru_counters[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_INSTRU_SYNC_COUNTERS__PORTS_FOR_PFC_COUNTERS__FIRST);
    layout_array_instru_counters[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_INSTRU_SYNC_COUNTERS__PORTS_FOR_PFC_COUNTERS__LAST)-1;

    idx = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_INSTRU_SYNC_COUNTERS__NOF_PORTS_FOR_PFC_COUNTERS);
    layout_array_instru_counters[idx].name = "instru_sync_counters__nof_ports_for_pfc_counters";
    layout_array_instru_counters[idx].type = "int";
    layout_array_instru_counters[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_instru_counters[idx].size_of = sizeof(int);
    layout_array_instru_counters[idx].parent  = 0;
    ...
    layout_array_instru_counters[idx].parent  = 7;
    layout_array_instru_counters[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_instru_counters[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_instru_counters[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    layout_array_instru_counters[idx].parent  = 11;
    layout_array_instru_counters[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_instru_counters[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;

    idx = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_INSTRU_SYNC_COUNTERS__PORTS_FOR_PFC_COUNTERS__PORT);
    layout_array_instru_counters[idx].name = "instru_sync_counters__ports_for_pfc_counters__port";
    layout_array_instru_counters[idx].type = "int";
    layout_array_instru_counters[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_instru_counters[idx].size_of = sizeof(int);
    layout_array_instru_counters[idx].parent  = 3;
    layout_array_instru_counters[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_instru_counters[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;

    idx = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_INSTRU_SYNC_COUNTERS__PORTS_FOR_PFC_COUNTERS__TC_BMP);
    layout_array_instru_counters[idx].name = "instru_sync_counters__ports_for_pfc_counters__tc_bmp";
    layout_array_instru_counters[idx].type = "uint8";
    layout_array_instru_counters[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_instru_counters[idx].size_of = sizeof(uint8);
    layout_array_instru_counters[idx].parent  = 3;
    ...
    idx = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_INSTRU_SYNC_COUNTERS__PORTS_FOR_PFC_COUNTERS__PFC_PM_IDX);
    layout_array_instru_counters[idx].name = "instru_sync_counters__ports_for_pfc_counters__pfc_pm_idx";
    layout_array_instru_counters[idx].type = "uint8";
    layout_array_instru_counters[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_instru_counters[idx].size_of = sizeof(uint8);
    layout_array_instru_counters[idx].parent  = 3;
    ...
    idx = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_INSTRU_SYNC_COUNTERS__PORTS_FOR_PFC_COUNTERS__PFC_PORT_IDX_BASE);
    layout_array_instru_counters[idx].name = "instru_sync_counters__ports_for_pfc_counters__pfc_port_idx_base";
    layout_array_instru_counters[idx].type = "uint8";
    layout_array_instru_counters[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_instru_counters[idx].size_of = sizeof(uint8);
    layout_array_instru_counters[idx].parent  = 3;
