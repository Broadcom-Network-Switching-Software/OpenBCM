...
kbp_init_layout_structure(int unit)
{
    ...
    layout_array_kbp[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_kbp[idx].size_of = sizeof(kbp_sw_state_t);
    layout_array_kbp[idx].parent  = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_kbp[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_KBP_SW_STATE__FIRST);
    layout_array_kbp[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_KBP_SW_STATE__LAST)-1;
    ...
    layout_array_kbp[idx].array_indexes[0].num_elements = DNX_KBP_NOF_DBS;
    layout_array_kbp[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_kbp[idx].parent  = 0;
    layout_array_kbp[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_KBP_SW_STATE__DB_HANDLES_INFO__FIRST);
    layout_array_kbp[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_KBP_SW_STATE__DB_HANDLES_INFO__LAST)-1;
    ...
    layout_array_kbp[idx].array_indexes[0].num_elements = DNX_KBP_NOF_INSTRUCTIONS;
    layout_array_kbp[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_kbp[idx].parent  = 0;
    layout_array_kbp[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_KBP_SW_STATE__INSTRUCTION_INFO__FIRST);
    layout_array_kbp[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_KBP_SW_STATE__INSTRUCTION_INFO__LAST)-1;
    layout_array_kbp[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
    ...
    layout_array_kbp[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_kbp[idx].size_of = sizeof(kbp_ad_db_t_p);
    layout_array_kbp[idx].array_indexes[0].num_elements = DNX_KBP_NOF_AD_DB_INDEX;
    layout_array_kbp[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_kbp[idx].parent  = 3;
    layout_array_kbp[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_kbp[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    idx = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_KBP_SW_STATE__DB_HANDLES_INFO__REGULAR_RESULT_SIZE);
    layout_array_kbp[idx].name = "kbp_sw_state__db_handles_info__regular_result_size";
    layout_array_kbp[idx].type = "int";
    layout_array_kbp[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_kbp[idx].size_of = sizeof(int);
    layout_array_kbp[idx].parent  = 3;
    ...
    layout_array_kbp[idx].array_indexes[0].num_elements = DNX_KBP_NOF_SMTS;
    layout_array_kbp[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
