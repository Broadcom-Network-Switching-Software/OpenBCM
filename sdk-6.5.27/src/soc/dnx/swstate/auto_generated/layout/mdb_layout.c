...
mdb_init_layout_structure(int unit)
{
    ...
    uint32 mdb_db_infos__mdb_cluster_infos__direct_address_mapping__default_val = MDB_DIRECT_INVALID_START_ADDRESS;
    uint32 mdb_db_infos__mdb_cluster_infos__eedb_address_mapping__default_val = MDB_DIRECT_INVALID_START_ADDRESS;
    ...
    layout_array_mdb[idx].array_indexes[1].num_elements = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].array_indexes[1].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC;
    layout_array_mdb[idx].array_indexes[2].num_elements = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].array_indexes[2].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC;
    layout_array_mdb[idx].parent  = 7;
