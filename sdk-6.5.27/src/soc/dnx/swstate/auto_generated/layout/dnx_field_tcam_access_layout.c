...
dnx_field_tcam_access_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_field_tcam_access[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_field_tcam_access[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__LAST)-1;
    ...
    layout_array_dnx_field_tcam_access[idx].type = "sw_state_index_htb_t";
    layout_array_dnx_field_tcam_access[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_tcam_access[idx].size_of = sizeof(sw_state_index_htb_t);
    ...
    layout_array_dnx_field_tcam_access[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__VALID_BMP__LAST)-1;
    ...
    layout_array_dnx_field_tcam_access[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__ENTRY_IN_USE_BMP__LAST)-1;
    ...
    layout_array_dnx_field_tcam_access[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__FG_PARAMS__LAST)-1;
    ...
    layout_array_dnx_field_tcam_access[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA_BITMAP;
