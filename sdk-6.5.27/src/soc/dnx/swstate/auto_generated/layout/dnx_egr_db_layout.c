...
dnx_egr_db_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_egr_db[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_egr_db[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_EGR_DB__LAST)-1;
    ...
    layout_array_dnx_egr_db[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_EGR_DB__PS__LAST)-1;
