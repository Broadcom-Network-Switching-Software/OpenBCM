...
dnx_scheduler_init_layout_structure(int unit)
{
    ...
    uint32 dnx_scheduler_db__low_rate_ranges__pattern__default_val = dnx_data_sch.flow.low_rate_pattern_mask_get(unit);
    ...
    layout_array_dnx_scheduler[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_scheduler[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_SCHEDULER_DB__LAST)-1;
    ...
    layout_array_dnx_scheduler[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_SCHEDULER_DB__PORT_SHAPER__LAST)-1;
    ...
    layout_array_dnx_scheduler[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_SCHEDULER_DB__HR__LAST)-1;
    ...
    layout_array_dnx_scheduler[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_SCHEDULER_DB__INTERFACE__LAST)-1;
    ...
    layout_array_dnx_scheduler[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_SCHEDULER_DB__FMQ__LAST)-1;
    ...
    layout_array_dnx_scheduler[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_SCHEDULER_DB__VIRTUAL_FLOWS__LAST)-1;
    ...
    layout_array_dnx_scheduler[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_SCHEDULER_DB__GENERAL__LAST)-1;

    idx = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_SCHEDULER_DB__LOW_RATE_RANGES);
    layout_array_dnx_scheduler[idx].name = "dnx_scheduler_db__low_rate_ranges";
    layout_array_dnx_scheduler[idx].type = "dnx_scheduler_db_low_rate_info_t";
    layout_array_dnx_scheduler[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_scheduler[idx].size_of = sizeof(dnx_scheduler_db_low_rate_info_t);
    layout_array_dnx_scheduler[idx].array_indexes[0].num_elements = dnx_data_device.general.nof_cores_get(unit);
    layout_array_dnx_scheduler[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    layout_array_dnx_scheduler[idx].array_indexes[1].num_elements = dnx_data_sch.flow.nof_low_rate_ranges_get(unit);
    layout_array_dnx_scheduler[idx].array_indexes[1].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    layout_array_dnx_scheduler[idx].parent  = 0;
    layout_array_dnx_scheduler[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_SCHEDULER_DB__LOW_RATE_RANGES__FIRST);
    layout_array_dnx_scheduler[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_SCHEDULER_DB__LOW_RATE_RANGES__LAST)-1;
    ...
    layout_array_dnx_scheduler[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA_BITMAP;
    ...
    layout_array_dnx_scheduler[idx].array_indexes[1].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA_BITMAP;
    layout_array_dnx_scheduler[idx].parent  = 5;
    layout_array_dnx_scheduler[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_scheduler[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    idx = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_SCHEDULER_DB__LOW_RATE_RANGES__PATTERN);
    layout_array_dnx_scheduler[idx].name = "dnx_scheduler_db__low_rate_ranges__pattern";
    layout_array_dnx_scheduler[idx].type = "uint32";
    layout_array_dnx_scheduler[idx].default_value= &(dnx_scheduler_db__low_rate_ranges__pattern__default_val);
    layout_array_dnx_scheduler[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_scheduler[idx].size_of = sizeof(uint32);
    layout_array_dnx_scheduler[idx].parent  = 7;
    layout_array_dnx_scheduler[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_scheduler[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;

    idx = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_SCHEDULER_DB__LOW_RATE_RANGES__RANGE_START);
    layout_array_dnx_scheduler[idx].name = "dnx_scheduler_db__low_rate_ranges__range_start";
    layout_array_dnx_scheduler[idx].type = "uint32";
    layout_array_dnx_scheduler[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_scheduler[idx].size_of = sizeof(uint32);
    layout_array_dnx_scheduler[idx].parent  = 7;
    ...
    idx = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_SCHEDULER_DB__LOW_RATE_RANGES__RANGE_END);
    layout_array_dnx_scheduler[idx].name = "dnx_scheduler_db__low_rate_ranges__range_end";
    layout_array_dnx_scheduler[idx].type = "uint32";
    layout_array_dnx_scheduler[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_scheduler[idx].size_of = sizeof(uint32);
    layout_array_dnx_scheduler[idx].parent  = 7;
    ...
    idx = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_SCHEDULER_DB__LOW_RATE_RANGES__IS_ENABLED);
    layout_array_dnx_scheduler[idx].name = "dnx_scheduler_db__low_rate_ranges__is_enabled";
    layout_array_dnx_scheduler[idx].type = "uint32";
    layout_array_dnx_scheduler[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_scheduler[idx].size_of = sizeof(uint32);
    layout_array_dnx_scheduler[idx].parent  = 7;
