...
dnx_rx_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_rx[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_rx[idx].size_of = sizeof(rx_paser_info_t);
    layout_array_dnx_rx[idx].parent  = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_rx[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_RX_PARSER_INFO__FIRST);
    layout_array_dnx_rx[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_RX_PARSER_INFO__LAST)-1;
    ...
    layout_array_dnx_rx[idx].array_indexes[0].num_elements = DNXC_SW_STATE_LAYOUT_INVALID;
