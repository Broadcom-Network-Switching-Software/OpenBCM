...
stif_init_layout_structure(int unit)
{
    ...
    layout_array_stif[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_stif[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_STIF_DB__LAST)-1;
    ...
    layout_array_stif[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_STIF_DB__INSTANCE__LAST)-1;
    ...
    layout_array_stif[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_STIF_DB__SOURCE_MAPPING__LAST)-1;
