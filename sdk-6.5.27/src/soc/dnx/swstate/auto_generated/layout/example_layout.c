...
example_init_layout_structure(int unit)
{
    ...
    layout_array_example[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_example[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_example[idx].to_string_cb = &dnxc_sw_state_to_string_uint32_cb;
    ...
    layout_array_example[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_example[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_GENERATE_FREE;
    layout_array_example[idx].to_string_cb = &dnxc_sw_state_to_string_shr_bitdcl_cb;
    ...
    layout_array_example[idx].size_of = sizeof(SHR_BITDCL);
    layout_array_example[idx].array_indexes[0].num_elements = dnx_data_module_testing.example_tests.field_size_get(unit);
    layout_array_example[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA_BITMAP;
    layout_array_example[idx].parent  = 0;
    layout_array_example[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_example[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    idx = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_EXAMPLE__MULTIHEAD_HTB_RH);
    layout_array_example[idx].name = "example__multihead_htb_rh";
    layout_array_example[idx].type = "sw_state_multihead_htb_t";
    layout_array_example[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_example[idx].size_of = sizeof(sw_state_multihead_htb_t);
    layout_array_example[idx].parent  = 0;
    layout_array_example[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_example[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_example[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_EXPANDED_INTERFACE | DNXC_SW_STATE_LAYOUT_LABEL_ALLOC_EXCEPTION ;

    idx = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_EXAMPLE__INDEX_HTB_RH);
    layout_array_example[idx].name = "example__index_htb_rh";
    layout_array_example[idx].type = "sw_state_index_htb_t";
    layout_array_example[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_example[idx].size_of = sizeof(sw_state_index_htb_t);
    layout_array_example[idx].parent  = 0;
    layout_array_example[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_example[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_example[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_EXPANDED_INTERFACE | DNXC_SW_STATE_LAYOUT_LABEL_ALLOC_EXCEPTION ;
    ...
    layout_array_example[idx].array_indexes[0].num_elements = 100;
    layout_array_example[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STRING;
    layout_array_example[idx].parent  = 0;
    layout_array_example[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_example[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_example[idx].array_indexes[0].num_elements = dnx_data_module_testing.example_tests.field_size_get(unit);
    layout_array_example[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    layout_array_example[idx].parent  = 32;
    ...
    layout_array_example[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_example[idx].size_of = sizeof(uint32);
    layout_array_example[idx].parent  = 70;
    layout_array_example[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_example[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_example[idx].to_string_cb = &dnxc_sw_state_to_string_uint32_cb;
    ...
    layout_array_example[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_example[idx].size_of = sizeof(uint32);
    layout_array_example[idx].parent  = 71;
    layout_array_example[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_example[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_example[idx].to_string_cb = &dnxc_sw_state_to_string_uint32_cb;
    ...
    layout_array_example[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_example[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_example[idx].to_string_cb = &dnxc_sw_state_to_string_int_cb;
