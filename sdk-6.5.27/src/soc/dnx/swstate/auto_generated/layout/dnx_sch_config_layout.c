...
dnx_sch_config_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_sch_config[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_sch_config[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_COSQ_CONFIG__LAST)-1;
    ...
    layout_array_dnx_sch_config[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_COSQ_CONFIG__FLOW__LAST)-1;
    ...
    layout_array_dnx_sch_config[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_COSQ_CONFIG__CONNECTOR__LAST)-1;
    ...
    layout_array_dnx_sch_config[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_COSQ_CONFIG__SE__LAST)-1;
    ...
    layout_array_dnx_sch_config[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_COSQ_CONFIG__FLOW__CREDIT_SRC__LAST)-1;
    layout_array_dnx_sch_config[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
