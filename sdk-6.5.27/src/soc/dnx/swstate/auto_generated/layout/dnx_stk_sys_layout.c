...
dnx_stk_sys_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_stk_sys[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_stk_sys[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_STK_SYS_DB__LAST)-1;
