...
oam_init_layout_structure(int unit)
{
    ...
    layout_array_oam[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_oam[idx].size_of = sizeof(oam_sw_db_info_t);
    layout_array_oam[idx].parent  = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_oam[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_OAM_SW_DB_INFO__FIRST);
    layout_array_oam[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_OAM_SW_DB_INFO__LAST)-1;
    ...
    layout_array_oam[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_OAM_SW_DB_INFO__OAM_GROUP_SW_DB_INFO__FIRST);
    layout_array_oam[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_OAM_SW_DB_INFO__OAM_GROUP_SW_DB_INFO__LAST)-1;
    ...
    layout_array_oam[idx].parent  = 0;
    layout_array_oam[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_OAM_SW_DB_INFO__OAM_ENDPOINT_SW_DB_INFO__FIRST);
    layout_array_oam[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_OAM_SW_DB_INFO__OAM_ENDPOINT_SW_DB_INFO__LAST)-1;
    ...
    layout_array_oam[idx].parent  = 0;
    layout_array_oam[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_OAM_SW_DB_INFO__REFLECTOR__FIRST);
    layout_array_oam[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_OAM_SW_DB_INFO__REFLECTOR__LAST)-1;
