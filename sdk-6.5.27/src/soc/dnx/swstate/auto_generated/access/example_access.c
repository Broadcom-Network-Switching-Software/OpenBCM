...
int
example_array_range_example_range_read(int unit, uint32 from_idx, uint32 nof_elements, uint32 *dest)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
example_array_range_example_range_write(int unit, uint32 from_idx, uint32 nof_elements, const uint32 *source)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
example_multihead_ll_next_node(int unit, sw_state_ll_node_t node, sw_state_ll_node_t *next_node)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
example_multihead_ll_previous_node(int unit, sw_state_ll_node_t node, sw_state_ll_node_t *prev_node)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
example_sorted_multihead_ll_next_node(int unit, sw_state_ll_node_t node, sw_state_ll_node_t *next_node)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
example_sorted_multihead_ll_previous_node(int unit, sw_state_ll_node_t node, sw_state_ll_node_t *prev_node)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
example_htb_rh_create(int unit, sw_state_htb_create_info_t *init_info)
{
    ...
    SW_STATE_HTB_RH_CREATE(
        ...
        init_info,
        sizeof(int),
        SW_STATE_HTB_RH_DATA_NOT_PROVIDED_IN_XML,
        DNXC_SW_STATE_AUTO_GENERATED_ALLOCATION | DNXC_SW_STATE_DNX_DATA_ALLOC_EXCEPTION);
...
int
example_htb_rh_find(int unit, const int *key, void *value)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
example_htb_rh_get_next(int unit, uint32 *iter, int *key, void *value)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
example_htb_rh_insert(int unit, const int *key, const void *value)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
example_htb_rh_replace(int unit, const int *key, const void *value)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
example_htb_rh_delete(int unit, const int *key)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
example_htb_rh_traverse(int unit, sw_state_htb_traverse_cb traverse_func, void *user_data)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
example_multihead_htb_rh_create(int unit, sw_state_htb_create_info_t *init_info, int key_size, int value_size)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    SW_STATE_MULTIHEAD_HTB_RH_CREATE(
        DNX_SW_STATE_EXAMPLE__MULTIHEAD_HTB_RH,
...
int
example_multihead_htb_rh_find(int unit, uint8 table_idx, const void *key, void *value)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    SW_STATE_MULTIHEAD_HTB_RH_FIND(
        ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->multihead_htb_rh,
        table_idx,
        key,
        value);
...
int
example_multihead_htb_rh_get_next(int unit, uint8 table_idx, uint32 *iter, void *key, void *value)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    SW_STATE_MULTIHEAD_HTB_RH_GET_NEXT(
        ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->multihead_htb_rh,
        table_idx,
        iter,
        key,
...
int
example_multihead_htb_rh_insert(int unit, uint8 table_idx, const void *key, const void *value)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    SW_STATE_MULTIHEAD_HTB_RH_INSERT(
        ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->multihead_htb_rh,
        table_idx,
        key,
        value);
...
int
example_multihead_htb_rh_replace(int unit, uint8 table_idx, const void *key, const void *value)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    SW_STATE_MULTIHEAD_HTB_RH_REPLACE(
        ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->multihead_htb_rh,
        table_idx,
        key,
        value);
...
int
example_multihead_htb_rh_delete(int unit, uint8 table_idx, const void *key)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    SW_STATE_MULTIHEAD_HTB_RH_DELETE(
        ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->multihead_htb_rh,
        table_idx,
        key);
...
int
example_multihead_htb_rh_delete_all(int unit, uint8 table_idx)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    SW_STATE_MULTIHEAD_HTB_RH_DELETE_ALL(
        ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->multihead_htb_rh,
        table_idx);
...
int
example_multihead_htb_rh_print(int unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    SW_STATE_MULTIHEAD_HTB_RH_PRINT(
        ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->multihead_htb_rh);
...
int
example_multihead_htb_rh_traverse(int unit, uint8 table_idx, sw_state_htb_traverse_cb traverse_func, void *user_data)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    SW_STATE_MULTIHEAD_HTB_RH_TRAVERSE(
        ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->multihead_htb_rh,
        table_idx,
        traverse_func,
        user_data);
...
int
example_multihead_htb_rh_delete_all_tables(int unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    SW_STATE_MULTIHEAD_HTB_RH_DELETE_ALL_TABLES(
        ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->multihead_htb_rh);

    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_HTB_RH_DELETE_ALL_TABLES_LOGGING,
        BSL_LS_SWSTATEDNX_HTB_RHDELETE_ALL_TABLES,
        DNX_SW_STATE_EXAMPLE__MULTIHEAD_HTB_RH,
        &((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->multihead_htb_rh,
        "example[%d]->multihead_htb_rh",
        unit);
...
int
example_index_htb_rh_create(int unit, sw_state_htb_create_info_t *init_info)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
example_index_htb_rh_find(int unit, const int *key, uint32 *value)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
example_index_htb_rh_get_next(int unit, uint32 *iter, int *key, uint32 *value)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
example_index_htb_rh_insert(int unit, const int *key, uint32 *data_idx)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
example_index_htb_rh_delete(int unit, const int *key)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
example_index_htb_rh_delete_all(int unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    SW_STATE_INDEX_HTB_RH_DELETE_ALL(
        ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->index_htb_rh);

    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_INDEX_HTB_RH_DELETE_ALL_LOGGING,
        BSL_LS_SWSTATEDNX_INDEX_HTB_RHDELETE_ALL,
        DNX_SW_STATE_EXAMPLE__INDEX_HTB_RH,
        &((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->index_htb_rh,
        "example[%d]->index_htb_rh",
        unit);
...
int
example_index_htb_rh_print(int unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
example_index_htb_rh_traverse(int unit, sw_state_htb_traverse_cb traverse_func, void *user_data)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
example_index_htb_rh_insert_at_index(int unit, const int *key, uint32 data_idx)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
example_index_htb_rh_delete_by_index(int unit, uint32 data_index)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
example_index_htb_rh_get_by_index(int unit, uint32 data_index, int *key)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
example_defragmented_chunk_example_get_free_slots(int unit, uint32 defragmented_chunk_example_idx_0, uint32 *output)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    SW_STATE_DEFRAGMENTED_CHUNK_GET_FREE_SLOTS(
        DNX_SW_STATE_EXAMPLE__DEFRAGMENTED_CHUNK_EXAMPLE,
        ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->defragmented_chunk_example[defragmented_chunk_example_idx_0],
        output);
    ...
    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_DEFRAGMENTED_CHUNK_GET_FREE_SLOTS_LOGGING,
        BSL_LS_SWSTATEDNX_DEFRAGMENTED_CHUNKGET_FREE_SLOTS,
        DNX_SW_STATE_EXAMPLE__DEFRAGMENTED_CHUNK_EXAMPLE,
        &((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->defragmented_chunk_example[defragmented_chunk_example_idx_0],
        "example[%d]->defragmented_chunk_example[%d]",
        unit, defragmented_chunk_example_idx_0);
...
example_cbs example = 	{
	...
	,
		...
		example_htb_rh_find,
		example_htb_rh_get_next,
		example_htb_rh_insert,
		example_htb_rh_replace,
		example_htb_rh_delete,
		example_htb_rh_delete_all,
		example_htb_rh_print,
		example_htb_rh_traverse}
	,
		{
		
		example_multihead_htb_rh_create,
		example_multihead_htb_rh_find,
		example_multihead_htb_rh_get_next,
		example_multihead_htb_rh_insert,
		example_multihead_htb_rh_replace,
		example_multihead_htb_rh_delete,
		example_multihead_htb_rh_delete_all,
		example_multihead_htb_rh_print,
		example_multihead_htb_rh_traverse,
		example_multihead_htb_rh_delete_all_tables}
	,
		{
		
		example_index_htb_rh_create,
		example_index_htb_rh_find,
		example_index_htb_rh_get_next,
		example_index_htb_rh_insert,
		example_index_htb_rh_delete,
		example_index_htb_rh_delete_all,
		example_index_htb_rh_print,
		example_index_htb_rh_traverse,
		example_index_htb_rh_insert_at_index,
		example_index_htb_rh_delete_by_index,
		example_index_htb_rh_get_by_index}
	,
		{
	...
	,
		...
		example_defragmented_chunk_example_get_free_slots,
