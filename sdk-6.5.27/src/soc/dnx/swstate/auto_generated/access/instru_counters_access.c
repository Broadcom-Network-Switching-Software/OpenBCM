...
instru_sync_counters_init(int unit)
{
    ...
    DNX_SW_STATE_DIAG_INFO_POST(
        ...
        DNX_SW_STATE_DIAG_ALLOC,
        ((instru_sync_counters_sw_state_t*)sw_state_roots_array[unit][INSTRU_COUNTERS_MODULE_ID]),
        sw_state_layout_array[unit][INSTRU_COUNTERS_MODULE_ID]);
...
instru_sync_counters_nif_countes_per_ethu_info_alloc(int unit)
{
    ...
    DNX_SW_STATE_LOG(
        ...
        unit,
        dnx_data_nif.eth.max_ethu_nof_per_core_get(unit) * sizeof(sync_counters_nif_per_eth_info_t) / sizeof(*((instru_sync_counters_sw_state_t*)sw_state_roots_array[unit][INSTRU_COUNTERS_MODULE_ID])->nif_countes.per_ethu_info)+(dnx_data_nif.eth.max_ethu_nof_per_core_get(unit) * sizeof(sync_counters_nif_per_eth_info_t)));
...
int
instru_sync_counters_ports_for_pfc_counters_port_set(int unit, uint32 ports_for_pfc_counters_idx_0, int port)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_OOB_STATIC_ARRAY_CHECK(
        ports_for_pfc_counters_idx_0,
        DNX_DATA_MAX_INSTRU_SYNCED_COUNTERS_NOF_PORTS_FOR_PFC);
    ...
    DNX_SW_STATE_SET(
        unit,
        DNX_SW_STATE_INSTRU_SYNC_COUNTERS__PORTS_FOR_PFC_COUNTERS__PORT,
        ((instru_sync_counters_sw_state_t*)sw_state_roots_array[unit][INSTRU_COUNTERS_MODULE_ID])->ports_for_pfc_counters[ports_for_pfc_counters_idx_0].port,
        port,
        int,
        0,
        "instru_sync_counters_ports_for_pfc_counters_port_set");
    ...
    DNX_SW_STATE_LOG(
        ...
        DNX_SW_STATE_INSTRU_SYNC_COUNTERS__PORTS_FOR_PFC_COUNTERS__PORT,
        &port,
        "instru_sync_counters[%d]->ports_for_pfc_counters[%d].port",
        unit, ports_for_pfc_counters_idx_0);
...
int
instru_sync_counters_ports_for_pfc_counters_port_get(int unit, uint32 ports_for_pfc_counters_idx_0, int *port)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    *port = ((instru_sync_counters_sw_state_t*)sw_state_roots_array[unit][INSTRU_COUNTERS_MODULE_ID])->ports_for_pfc_counters[ports_for_pfc_counters_idx_0].port;
    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_GET_LOGGING,
        BSL_LS_SWSTATEDNX_GET,
...
int
instru_sync_counters_ports_for_pfc_counters_tc_bmp_set(int unit, uint32 ports_for_pfc_counters_idx_0, uint8 tc_bmp)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_SET(
        unit,
        DNX_SW_STATE_INSTRU_SYNC_COUNTERS__PORTS_FOR_PFC_COUNTERS__TC_BMP,
        ((instru_sync_counters_sw_state_t*)sw_state_roots_array[unit][INSTRU_COUNTERS_MODULE_ID])->ports_for_pfc_counters[ports_for_pfc_counters_idx_0].tc_bmp,
        tc_bmp,
        uint8,
        0,
        "instru_sync_counters_ports_for_pfc_counters_tc_bmp_set");
    ...
    DNX_SW_STATE_LOG(
        ...
        DNX_SW_STATE_INSTRU_SYNC_COUNTERS__PORTS_FOR_PFC_COUNTERS__TC_BMP,
        &tc_bmp,
        "instru_sync_counters[%d]->ports_for_pfc_counters[%d].tc_bmp",
        unit, ports_for_pfc_counters_idx_0);
...
int
instru_sync_counters_ports_for_pfc_counters_tc_bmp_get(int unit, uint32 ports_for_pfc_counters_idx_0, uint8 *tc_bmp)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    *tc_bmp = ((instru_sync_counters_sw_state_t*)sw_state_roots_array[unit][INSTRU_COUNTERS_MODULE_ID])->ports_for_pfc_counters[ports_for_pfc_counters_idx_0].tc_bmp;
    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_GET_LOGGING,
        BSL_LS_SWSTATEDNX_GET,
...
int
instru_sync_counters_ports_for_pfc_counters_pfc_pm_idx_set(int unit, uint32 ports_for_pfc_counters_idx_0, uint8 pfc_pm_idx)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_SET(
        unit,
        DNX_SW_STATE_INSTRU_SYNC_COUNTERS__PORTS_FOR_PFC_COUNTERS__PFC_PM_IDX,
        ((instru_sync_counters_sw_state_t*)sw_state_roots_array[unit][INSTRU_COUNTERS_MODULE_ID])->ports_for_pfc_counters[ports_for_pfc_counters_idx_0].pfc_pm_idx,
        pfc_pm_idx,
        uint8,
        0,
        "instru_sync_counters_ports_for_pfc_counters_pfc_pm_idx_set");
    ...
    DNX_SW_STATE_LOG(
        ...
        DNX_SW_STATE_INSTRU_SYNC_COUNTERS__PORTS_FOR_PFC_COUNTERS__PFC_PM_IDX,
        &pfc_pm_idx,
        "instru_sync_counters[%d]->ports_for_pfc_counters[%d].pfc_pm_idx",
        unit, ports_for_pfc_counters_idx_0);
...
int
instru_sync_counters_ports_for_pfc_counters_pfc_pm_idx_get(int unit, uint32 ports_for_pfc_counters_idx_0, uint8 *pfc_pm_idx)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    *pfc_pm_idx = ((instru_sync_counters_sw_state_t*)sw_state_roots_array[unit][INSTRU_COUNTERS_MODULE_ID])->ports_for_pfc_counters[ports_for_pfc_counters_idx_0].pfc_pm_idx;
    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_GET_LOGGING,
        BSL_LS_SWSTATEDNX_GET,
...
int
instru_sync_counters_ports_for_pfc_counters_pfc_port_idx_base_set(int unit, uint32 ports_for_pfc_counters_idx_0, uint8 pfc_port_idx_base)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_SET(
        unit,
        DNX_SW_STATE_INSTRU_SYNC_COUNTERS__PORTS_FOR_PFC_COUNTERS__PFC_PORT_IDX_BASE,
        ((instru_sync_counters_sw_state_t*)sw_state_roots_array[unit][INSTRU_COUNTERS_MODULE_ID])->ports_for_pfc_counters[ports_for_pfc_counters_idx_0].pfc_port_idx_base,
        pfc_port_idx_base,
        uint8,
        0,
        "instru_sync_counters_ports_for_pfc_counters_pfc_port_idx_base_set");
    ...
    DNX_SW_STATE_LOG(
        ...
        DNX_SW_STATE_INSTRU_SYNC_COUNTERS__PORTS_FOR_PFC_COUNTERS__PFC_PORT_IDX_BASE,
        &pfc_port_idx_base,
        "instru_sync_counters[%d]->ports_for_pfc_counters[%d].pfc_port_idx_base",
        unit, ports_for_pfc_counters_idx_0);
...
int
instru_sync_counters_ports_for_pfc_counters_pfc_port_idx_base_get(int unit, uint32 ports_for_pfc_counters_idx_0, uint8 *pfc_port_idx_base)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    *pfc_port_idx_base = ((instru_sync_counters_sw_state_t*)sw_state_roots_array[unit][INSTRU_COUNTERS_MODULE_ID])->ports_for_pfc_counters[ports_for_pfc_counters_idx_0].pfc_port_idx_base;
    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_GET_LOGGING,
        BSL_LS_SWSTATEDNX_GET,
...
int
instru_sync_counters_nof_ports_for_pfc_counters_set(int unit, int nof_ports_for_pfc_counters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_SET(
        ...
        nof_ports_for_pfc_counters,
        int,
        0,
        "instru_sync_counters_nof_ports_for_pfc_counters_set");
    ...
    DNX_SW_STATE_LOG(
        ...
        DNX_SW_STATE_INSTRU_SYNC_COUNTERS__NOF_PORTS_FOR_PFC_COUNTERS,
        &nof_ports_for_pfc_counters,
        "instru_sync_counters[%d]->nof_ports_for_pfc_counters",
        unit);
...
int
instru_sync_counters_nof_ports_for_pfc_counters_get(int unit, int *nof_ports_for_pfc_counters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    *nof_ports_for_pfc_counters = ((instru_sync_counters_sw_state_t*)sw_state_roots_array[unit][INSTRU_COUNTERS_MODULE_ID])->nof_ports_for_pfc_counters;
    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_GET_LOGGING,
        BSL_LS_SWSTATEDNX_GET,
	...
	,
		{
			...
			instru_sync_counters_ports_for_pfc_counters_port_set,
			instru_sync_counters_ports_for_pfc_counters_port_get}
		,
			{
			
			instru_sync_counters_ports_for_pfc_counters_tc_bmp_set,
			instru_sync_counters_ports_for_pfc_counters_tc_bmp_get}
		,
			{
			
			instru_sync_counters_ports_for_pfc_counters_pfc_pm_idx_set,
			instru_sync_counters_ports_for_pfc_counters_pfc_pm_idx_get}
		,
			{
			
			instru_sync_counters_ports_for_pfc_counters_pfc_port_idx_base_set,
			instru_sync_counters_ports_for_pfc_counters_pfc_port_idx_base_get}
		}
	,
		{
		
		instru_sync_counters_nof_ports_for_pfc_counters_set,
		instru_sync_counters_nof_ports_for_pfc_counters_get}
	}
;
