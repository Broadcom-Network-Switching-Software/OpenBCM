...
int
kbp_sw_state_db_handles_info_regular_result_size_set(int unit, uint32 db_handles_info_idx_0, int regular_result_size)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_SET(
        unit,
        DNX_SW_STATE_KBP_SW_STATE__DB_HANDLES_INFO__REGULAR_RESULT_SIZE,
        ((kbp_sw_state_t*)sw_state_roots_array[unit][KBP_MODULE_ID])->db_handles_info[db_handles_info_idx_0].regular_result_size,
        regular_result_size,
        int,
        0,
        "kbp_sw_state_db_handles_info_regular_result_size_set");
    ...
    DNX_SW_STATE_LOG(
        ...
        DNX_SW_STATE_KBP_SW_STATE__DB_HANDLES_INFO__REGULAR_RESULT_SIZE,
        &regular_result_size,
        "kbp_sw_state[%d]->db_handles_info[%d].regular_result_size",
        unit, db_handles_info_idx_0);
...
int
kbp_sw_state_db_handles_info_regular_result_size_get(int unit, uint32 db_handles_info_idx_0, int *regular_result_size)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    *regular_result_size = ((kbp_sw_state_t*)sw_state_roots_array[unit][KBP_MODULE_ID])->db_handles_info[db_handles_info_idx_0].regular_result_size;
    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_GET_LOGGING,
        BSL_LS_SWSTATEDNX_GET,
...
kbp_sw_state_cbs kbp_sw_state = 	{
	...
	,
		...
		,
			...
			kbp_sw_state_db_handles_info_regular_result_size_set,
			kbp_sw_state_db_handles_info_regular_result_size_get}
		,
			{
