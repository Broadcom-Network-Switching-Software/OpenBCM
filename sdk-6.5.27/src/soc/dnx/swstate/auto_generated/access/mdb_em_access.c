...
int
mdb_em_db_shadow_em_db_alloc(int unit, uint32 shadow_em_db_idx_0, uint32 nof_instances_to_alloc_1)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_LOG(
        ...
        nof_instances_to_alloc_1 * sizeof(sw_state_htbl_t) / sizeof(*((mdb_em_sw_state_t*)sw_state_roots_array[unit][MDB_EM_MODULE_ID])->shadow_em_db[shadow_em_db_idx_0]));
...
int
mdb_em_db_shadow_em_db_create(int unit, uint32 shadow_em_db_idx_0, uint32 shadow_em_db_idx_1, sw_state_htbl_init_info_t *init_info, int key_size, int value_size)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    SW_STATE_HTB_CREATE_WITH_SIZE(
        DNX_SW_STATE_MDB_EM_DB__SHADOW_EM_DB,
        ((mdb_em_sw_state_t*)sw_state_roots_array[unit][MDB_EM_MODULE_ID])->shadow_em_db[shadow_em_db_idx_0][shadow_em_db_idx_1],
        init_info,
        key_size,
        value_size,
        0,
    ...
    DNX_SW_STATE_LOG(
        ...
        DNX_SW_STATE_MDB_EM_DB__SHADOW_EM_DB,
        &((mdb_em_sw_state_t*)sw_state_roots_array[unit][MDB_EM_MODULE_ID])->shadow_em_db[shadow_em_db_idx_0][shadow_em_db_idx_1],
        "mdb_em_db[%d]->shadow_em_db[%d][%d]",
        unit, shadow_em_db_idx_0, shadow_em_db_idx_1);
...
int
mdb_em_db_shadow_em_db_find(int unit, uint32 shadow_em_db_idx_0, uint32 shadow_em_db_idx_1, const void *key, void *value, uint8 *found)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
mdb_em_db_shadow_em_db_insert(int unit, uint32 shadow_em_db_idx_0, uint32 shadow_em_db_idx_1, const void *key, const void *value, uint8 *success)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
mdb_em_db_shadow_em_db_get_next(int unit, uint32 shadow_em_db_idx_0, uint32 shadow_em_db_idx_1, SW_STATE_HASH_TABLE_ITER *iter, const void *key, const void *value)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
mdb_em_db_shadow_em_db_clear(int unit, uint32 shadow_em_db_idx_0, uint32 shadow_em_db_idx_1)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
mdb_em_db_shadow_em_db_delete(int unit, uint32 shadow_em_db_idx_0, uint32 shadow_em_db_idx_1, const void *key)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
mdb_em_db_shadow_em_db_delete_all(int unit, uint32 shadow_em_db_idx_0, uint32 shadow_em_db_idx_1)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
