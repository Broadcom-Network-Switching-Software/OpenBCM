...
int
srv6_modes_usid_prefix_is_48b_set(int unit, uint8 usid_prefix_is_48b)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_SET(
        unit,
        DNX_SW_STATE_SRV6_MODES__USID_PREFIX_IS_48B,
        ((srv6_modes_struct*)sw_state_roots_array[unit][SRV6_MODULE_ID])->usid_prefix_is_48b,
        usid_prefix_is_48b,
        uint8,
        0,
        "srv6_modes_usid_prefix_is_48b_set");
    ...
    DNX_SW_STATE_LOG(
        ...
        DNX_SW_STATE_SRV6_MODES__USID_PREFIX_IS_48B,
        &usid_prefix_is_48b,
        "srv6_modes[%d]->usid_prefix_is_48b",
        unit);
...
int
srv6_modes_usid_prefix_is_48b_get(int unit, uint8 *usid_prefix_is_48b)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    *usid_prefix_is_48b = ((srv6_modes_struct*)sw_state_roots_array[unit][SRV6_MODULE_ID])->usid_prefix_is_48b;
    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_GET_LOGGING,
        BSL_LS_SWSTATEDNX_GET,
...
int
srv6_modes_lpm_destination_for_usp_trap_set(int unit, int lpm_destination_for_usp_trap)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_SET(
        unit,
        DNX_SW_STATE_SRV6_MODES__LPM_DESTINATION_FOR_USP_TRAP,
        ((srv6_modes_struct*)sw_state_roots_array[unit][SRV6_MODULE_ID])->lpm_destination_for_usp_trap,
        lpm_destination_for_usp_trap,
        int,
        0,
        "srv6_modes_lpm_destination_for_usp_trap_set");
    ...
    DNX_SW_STATE_LOG(
        ...
        DNX_SW_STATE_SRV6_MODES__LPM_DESTINATION_FOR_USP_TRAP,
        &lpm_destination_for_usp_trap,
        "srv6_modes[%d]->lpm_destination_for_usp_trap",
        unit);
...
int
srv6_modes_lpm_destination_for_usp_trap_get(int unit, int *lpm_destination_for_usp_trap)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    *lpm_destination_for_usp_trap = ((srv6_modes_struct*)sw_state_roots_array[unit][SRV6_MODULE_ID])->lpm_destination_for_usp_trap;
    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_GET_LOGGING,
        BSL_LS_SWSTATEDNX_GET,
...
srv6_modes_cbs srv6_modes = 	{
	...
	,
		...
		srv6_modes_usid_prefix_is_48b_set,
		srv6_modes_usid_prefix_is_48b_get}
	,
		{
		
		srv6_modes_lpm_destination_for_usp_trap_set,
		srv6_modes_lpm_destination_for_usp_trap_get}
	}
;
