...
int
dbal_db_sw_tables_hash_table_create(int unit, uint32 sw_tables_idx_0, sw_state_htb_create_info_t *init_info)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    SW_STATE_INDEX_HTB_RH_CREATE(
        ...
        init_info,
        SW_STATE_HTB_RH_KEY_NOT_PROVIDED_IN_XML,
...
int
dbal_db_sw_tables_hash_table_find(int unit, uint32 sw_tables_idx_0, const void *key, uint32 *value)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dbal_db_sw_tables_hash_table_get_next(int unit, uint32 sw_tables_idx_0, uint32 *iter, void *key, uint32 *value)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dbal_db_sw_tables_hash_table_insert(int unit, uint32 sw_tables_idx_0, const void *key, uint32 *data_idx)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dbal_db_sw_tables_hash_table_delete(int unit, uint32 sw_tables_idx_0, const void *key)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dbal_db_sw_tables_hash_table_delete_all(int unit, uint32 sw_tables_idx_0)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dbal_db_sw_tables_hash_table_print(int unit, uint32 sw_tables_idx_0)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dbal_db_sw_tables_hash_table_traverse(int unit, uint32 sw_tables_idx_0, sw_state_htb_traverse_cb traverse_func, void *user_data)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dbal_db_sw_tables_hash_table_insert_at_index(int unit, uint32 sw_tables_idx_0, const void *key, uint32 data_idx)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dbal_db_sw_tables_hash_table_get_by_index(int unit, uint32 sw_tables_idx_0, uint32 data_index, void *key)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
dbal_db_cbs dbal_db = 	{
	...
	dbal_db_init,
		...
		,
			...
			dbal_db_sw_tables_hash_table_delete_all,
			dbal_db_sw_tables_hash_table_print,
			dbal_db_sw_tables_hash_table_traverse,
