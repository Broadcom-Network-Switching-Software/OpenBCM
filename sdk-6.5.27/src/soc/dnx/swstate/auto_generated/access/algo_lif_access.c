...
local_outlif_info_init(int unit)
{
    ...
    DNX_SW_STATE_DIAG_INFO_POST(
        ...
        DNX_SW_STATE_DIAG_ALLOC,
        ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID]),
        sw_state_layout_array[unit][ALGO_LIF_MODULE_ID]);
...
int
local_outlif_info_eedb_banks_info_used_data_bank_per_logical_phase_next_node(int unit, sw_state_ll_node_t node, sw_state_ll_node_t *next_node)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
local_outlif_info_eedb_banks_info_used_data_bank_per_logical_phase_previous_node(int unit, sw_state_ll_node_t node, sw_state_ll_node_t *prev_node)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
local_outlif_info_dynamic_algo_set(int unit, uint8 dynamic_algo)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_SET(
        ...
        uint8,
        0,
        "local_outlif_info_dynamic_algo_set");
    ...
    DNX_SW_STATE_LOG(
        ...
        DNX_SW_STATE_LOCAL_OUTLIF_INFO__DYNAMIC_ALGO,
        &dynamic_algo,
        "local_outlif_info[%d]->dynamic_algo",
        unit);
    ...
    DNX_SW_STATE_DIAG_INFO_POST(
        ...
        DNX_SW_STATE_LOCAL_OUTLIF_INFO__DYNAMIC_ALGO,
        local_outlif_info_info,
        LOCAL_OUTLIF_INFO_DYNAMIC_ALGO_INFO,
        DNX_SW_STATE_DIAG_MODIFY,
        NULL,
        sw_state_layout_array[unit][ALGO_LIF_MODULE_ID]);
...
int
local_outlif_info_dynamic_algo_get(int unit, uint8 *dynamic_algo)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    *dynamic_algo = ((local_outlif_info_t*)sw_state_roots_array[unit][ALGO_LIF_MODULE_ID])->dynamic_algo;
    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_GET_LOGGING,
        BSL_LS_SWSTATEDNX_GET,
...
local_outlif_info_cbs local_outlif_info = 	{
	...
	,
		...
		local_outlif_info_dynamic_algo_set,
		local_outlif_info_dynamic_algo_get}
	}
;
