...
int
dnx_fabric_db_signal_quality_lane_state_set(int unit, uint32 lane_state_idx_0, CONST dnx_fabric_signal_quality_lane_state_t *lane_state)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_MEMCPY(
        unit,
        DNX_SW_STATE_DNX_FABRIC_DB__SIGNAL_QUALITY__LANE_STATE,
        ((dnx_fabric_db_t*)sw_state_roots_array[unit][DNX_FABRIC_MODULE_ID])->signal_quality.lane_state[lane_state_idx_0],
        lane_state,
        dnx_fabric_signal_quality_lane_state_t,
        0,
        "dnx_fabric_db_signal_quality_lane_state_set");
    ...
    DNX_SW_STATE_LOG(
        ...
        DNX_SW_STATE_DNX_FABRIC_DB__SIGNAL_QUALITY__LANE_STATE,
        lane_state,
        "dnx_fabric_db[%d]->signal_quality.lane_state[%d]",
        unit, lane_state_idx_0);
...
int
dnx_fabric_db_signal_quality_lane_state_get(int unit, uint32 lane_state_idx_0, dnx_fabric_signal_quality_lane_state_t *lane_state)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    *lane_state = ((dnx_fabric_db_t*)sw_state_roots_array[unit][DNX_FABRIC_MODULE_ID])->signal_quality.lane_state[lane_state_idx_0];
    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_GET_LOGGING,
        BSL_LS_SWSTATEDNX_GET,
...
int
dnx_fabric_db_signal_quality_lane_state_alloc(int unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_AUTOGEN_ALLOC(
        ...
        DNXC_SWSTATE_LAYOUT_MAX_ARRAY_DIMENSIONS+1,
        DNXC_SW_STATE_DNX_DATA_ALLOC | DNXC_SW_STATE_AUTO_GENERATED_ALLOCATION,
        "dnx_fabric_db_signal_quality_lane_state_alloc");
    ...
    DNX_SW_STATE_LOG(
        ...
        DNX_SW_STATE_DNX_FABRIC_DB__SIGNAL_QUALITY__LANE_STATE,
        ((dnx_fabric_db_t*)sw_state_roots_array[unit][DNX_FABRIC_MODULE_ID])->signal_quality.lane_state,
        "dnx_fabric_db[%d]->signal_quality.lane_state",
        unit,
        dnx_data_fabric.links.nof_links_get(unit) * sizeof(dnx_fabric_signal_quality_lane_state_t) / sizeof(*((dnx_fabric_db_t*)sw_state_roots_array[unit][DNX_FABRIC_MODULE_ID])->signal_quality.lane_state));
...
int
dnx_fabric_db_signal_quality_lane_state_prev_error_rate_set(int unit, uint32 lane_state_idx_0, uint32 prev_error_rate)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_SET(
        unit,
        DNX_SW_STATE_DNX_FABRIC_DB__SIGNAL_QUALITY__LANE_STATE__PREV_ERROR_RATE,
        ((dnx_fabric_db_t*)sw_state_roots_array[unit][DNX_FABRIC_MODULE_ID])->signal_quality.lane_state[lane_state_idx_0].prev_error_rate,
        prev_error_rate,
        uint32,
        0,
        "dnx_fabric_db_signal_quality_lane_state_prev_error_rate_set");
    ...
    DNX_SW_STATE_LOG(
        ...
        DNX_SW_STATE_DNX_FABRIC_DB__SIGNAL_QUALITY__LANE_STATE__PREV_ERROR_RATE,
        &prev_error_rate,
        "dnx_fabric_db[%d]->signal_quality.lane_state[%d].prev_error_rate",
        unit, lane_state_idx_0);
...
int
dnx_fabric_db_signal_quality_lane_state_prev_error_rate_get(int unit, uint32 lane_state_idx_0, uint32 *prev_error_rate)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    *prev_error_rate = ((dnx_fabric_db_t*)sw_state_roots_array[unit][DNX_FABRIC_MODULE_ID])->signal_quality.lane_state[lane_state_idx_0].prev_error_rate;
    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_GET_LOGGING,
        BSL_LS_SWSTATEDNX_GET,
...
int
dnx_fabric_db_signal_quality_lane_state_prev_cnt_set(int unit, uint32 lane_state_idx_0, uint64 prev_cnt)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_SET(
        unit,
        DNX_SW_STATE_DNX_FABRIC_DB__SIGNAL_QUALITY__LANE_STATE__PREV_CNT,
        ((dnx_fabric_db_t*)sw_state_roots_array[unit][DNX_FABRIC_MODULE_ID])->signal_quality.lane_state[lane_state_idx_0].prev_cnt,
        prev_cnt,
        uint64,
        0,
        "dnx_fabric_db_signal_quality_lane_state_prev_cnt_set");
    ...
    DNX_SW_STATE_LOG(
        ...
        DNX_SW_STATE_DNX_FABRIC_DB__SIGNAL_QUALITY__LANE_STATE__PREV_CNT,
        &prev_cnt,
        "dnx_fabric_db[%d]->signal_quality.lane_state[%d].prev_cnt",
        unit, lane_state_idx_0);
...
int
dnx_fabric_db_signal_quality_lane_state_prev_cnt_get(int unit, uint32 lane_state_idx_0, uint64 *prev_cnt)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    *prev_cnt = ((dnx_fabric_db_t*)sw_state_roots_array[unit][DNX_FABRIC_MODULE_ID])->signal_quality.lane_state[lane_state_idx_0].prev_cnt;
    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_GET_LOGGING,
        BSL_LS_SWSTATEDNX_GET,
...
int
dnx_fabric_db_signal_quality_lane_state_prev_uncorrectable_cnt_set(int unit, uint32 lane_state_idx_0, uint64 prev_uncorrectable_cnt)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_SET(
        unit,
        DNX_SW_STATE_DNX_FABRIC_DB__SIGNAL_QUALITY__LANE_STATE__PREV_UNCORRECTABLE_CNT,
        ((dnx_fabric_db_t*)sw_state_roots_array[unit][DNX_FABRIC_MODULE_ID])->signal_quality.lane_state[lane_state_idx_0].prev_uncorrectable_cnt,
        prev_uncorrectable_cnt,
        uint64,
        0,
        "dnx_fabric_db_signal_quality_lane_state_prev_uncorrectable_cnt_set");
    ...
    DNX_SW_STATE_LOG(
        ...
        DNX_SW_STATE_DNX_FABRIC_DB__SIGNAL_QUALITY__LANE_STATE__PREV_UNCORRECTABLE_CNT,
        &prev_uncorrectable_cnt,
        "dnx_fabric_db[%d]->signal_quality.lane_state[%d].prev_uncorrectable_cnt",
        unit, lane_state_idx_0);
...
int
dnx_fabric_db_signal_quality_lane_state_prev_uncorrectable_cnt_get(int unit, uint32 lane_state_idx_0, uint64 *prev_uncorrectable_cnt)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    *prev_uncorrectable_cnt = ((dnx_fabric_db_t*)sw_state_roots_array[unit][DNX_FABRIC_MODULE_ID])->signal_quality.lane_state[lane_state_idx_0].prev_uncorrectable_cnt;
    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_GET_LOGGING,
        BSL_LS_SWSTATEDNX_GET,
	...
	,
		{
			...
			dnx_fabric_db_signal_quality_lane_state_set,
			dnx_fabric_db_signal_quality_lane_state_get,
			dnx_fabric_db_signal_quality_lane_state_alloc,
				{
				
				dnx_fabric_db_signal_quality_lane_state_prev_error_rate_set,
				dnx_fabric_db_signal_quality_lane_state_prev_error_rate_get}
			,
				{
				
				dnx_fabric_db_signal_quality_lane_state_prev_cnt_set,
				dnx_fabric_db_signal_quality_lane_state_prev_cnt_get}
			,
				{
				
				dnx_fabric_db_signal_quality_lane_state_prev_uncorrectable_cnt_set,
				dnx_fabric_db_signal_quality_lane_state_prev_uncorrectable_cnt_get}
			}
		,
