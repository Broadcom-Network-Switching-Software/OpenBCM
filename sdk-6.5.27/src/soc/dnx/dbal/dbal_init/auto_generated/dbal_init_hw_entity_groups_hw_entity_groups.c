...
shr_error_e
_dbal_init_hw_entity_groups_hw_entity_groups_ingress_map_vsi_mac_prefix_to_da_msb_init(
int unit,
hl_group_info_t * group_info)
{
    hl_group_info_t * group_info_entry = &group_info[DBAL_HW_ENTITY_GROUP_INGRESS_MAP_VSI_MAC_PREFIX_TO_DA_MSB];
    SHR_FUNC_INIT_VARS(unit);
    dbal_db_init_hw_entity_group_general_info_set(unit, group_info_entry, 2, FALSE);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 0, IPPA_MAP_VSI_MAC_PREFIX_TO_DA_MSB_1m);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 1, IPPF_MAP_VSI_MAC_PREFIX_TO_DA_MSBm);
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
shr_error_e
_dbal_init_hw_entity_groups_hw_entity_groups_ofr_rx_port_map_to_rmc_init(
int unit,
hl_group_info_t * group_info)
{
    hl_group_info_t * group_info_entry = &group_info[DBAL_HW_ENTITY_GROUP_OFR_RX_PORT_MAP_TO_RMC];
    SHR_FUNC_INIT_VARS(unit);
    if (DBAL_IS_J2X_A0)
    {
        dbal_db_init_hw_entity_group_general_info_set(unit, group_info_entry, 8, TRUE);
        dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 0, OFR_RX_PORT_PROFILE_0_MAP_TO_PRIORITYr);
        dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 1, OFR_RX_PORT_PROFILE_1_MAP_TO_PRIORITYr);
        dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 2, OFR_RX_PORT_PROFILE_2_MAP_TO_PRIORITYr);
        dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 3, OFR_RX_PORT_PROFILE_3_MAP_TO_PRIORITYr);
        dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 4, OFR_RX_PORT_PROFILE_4_MAP_TO_PRIORITYr);
        dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 5, OFR_RX_PORT_PROFILE_5_MAP_TO_PRIORITYr);
        dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 6, OFR_RX_PORT_PROFILE_6_MAP_TO_PRIORITYr);
        dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 7, OFR_RX_PORT_PROFILE_7_MAP_TO_PRIORITYr);
    }
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
...
hl_group_info_t * group_info)
{
    ...
    {
        dbal_db_init_hw_entity_group_general_info_set(unit, group_info_entry, 2, FALSE);
        dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 0, IPPA_MAP_PORT_TO_MEMBERSHIP_IF_1m);
        dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 1, IPPF_MAP_PORT_TO_MEMBERSHIP_IFm);
    }
...
shr_error_e
_dbal_init_hw_entity_groups_hw_entity_groups_ofr_parser_soft_stage_tcam_init(
int unit,
hl_group_info_t * group_info)
{
    hl_group_info_t * group_info_entry = &group_info[DBAL_HW_ENTITY_GROUP_OFR_PARSER_SOFT_STAGE_TCAM];
    SHR_FUNC_INIT_VARS(unit);
    dbal_db_init_hw_entity_group_general_info_set(unit, group_info_entry, 4, TRUE);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 0, OFR_PARSER_SOFT_TCAM_0_TO_7r);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 1, OFR_PARSER_SOFT_TCAM_8_TO_15r);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 2, OFR_PARSER_SOFT_TCAM_16_TO_23r);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 3, OFR_PARSER_SOFT_TCAM_24_TO_31r);
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
hl_group_info_t * group_info)
{
    ...
    {
        dbal_db_init_hw_entity_group_general_info_set(unit, group_info_entry, 2, FALSE);
        dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 0, IPPA_VLAN_MEMBERSHIP_IF_ATTR_1m);
...
hl_group_info_t * group_info)
{
    ...
    {
        dbal_db_init_hw_entity_group_general_info_set(unit, group_info_entry, 2, FALSE);
        dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 0, IPPA_VD_TO_VLAN_CLASSIFICATION_PROFILE_1m);
...
shr_error_e
_dbal_init_hw_entity_groups_hw_entity_groups_ingress_cpu_trap_code_profile_init(
int unit,
hl_group_info_t * group_info)
{
    hl_group_info_t * group_info_entry = &group_info[DBAL_HW_ENTITY_GROUP_INGRESS_CPU_TRAP_CODE_PROFILE];
    SHR_FUNC_INIT_VARS(unit);
    dbal_db_init_hw_entity_group_general_info_set(unit, group_info_entry, 2, TRUE);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 0, IPPD_CPU_TRAP_CODE_PROFILEr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 1, IPPC_CPU_TRAP_CODE_PROFILEr);
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
shr_error_e
_dbal_init_hw_entity_groups_hw_entity_groups_ofr_global_counters_init(
int unit,
hl_group_info_t * group_info)
{
    hl_group_info_t * group_info_entry = &group_info[DBAL_HW_ENTITY_GROUP_OFR_GLOBAL_COUNTERS];
    SHR_FUNC_INIT_VARS(unit);
    dbal_db_init_hw_entity_group_general_info_set(unit, group_info_entry, 8, TRUE);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 0, OFR_PRD_DROP_MACHINE_0_PRIOR_INDICATIONS_PRIOR_0r);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 1, OFR_PRD_DROP_MACHINE_0_PRIOR_INDICATIONS_PRIOR_1r);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 2, OFR_PRD_DROP_MACHINE_0_PRIOR_INDICATIONS_PRIOR_2r);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 3, OFR_PRD_DROP_MACHINE_0_PRIOR_INDICATIONS_PRIOR_3r);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 4, OFR_PRD_DROP_MACHINE_1_PRIOR_INDICATIONS_PRIOR_0r);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 5, OFR_PRD_DROP_MACHINE_1_PRIOR_INDICATIONS_PRIOR_1r);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 6, OFR_PRD_DROP_MACHINE_1_PRIOR_INDICATIONS_PRIOR_2r);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 7, OFR_PRD_DROP_MACHINE_1_PRIOR_INDICATIONS_PRIOR_3r);
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
shr_error_e
_dbal_init_hw_entity_groups_hw_entity_groups_framer_otn_blocks_power_down_init(
int unit,
hl_group_info_t * group_info)
{
    hl_group_info_t * group_info_entry = &group_info[DBAL_HW_ENTITY_GROUP_FRAMER_OTN_BLOCKS_POWER_DOWN];
    SHR_FUNC_INIT_VARS(unit);
    dbal_db_init_hw_entity_group_general_info_set(unit, group_info_entry, 33, TRUE);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 0, FLFR_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 1, FLFT_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 2, FPMR_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 3, FPMT_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 4, FFLXO_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 5, FLOTN_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 6, FDMXC_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 7, FMXBI_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 8, FMXBJ_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 9, FDMXA_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 10, FDMXBI_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 11, FDMXBJ_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 12, FDMXT_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 13, FMXC_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 14, FMXBK_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 15, FMXAI_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 16, FMXAJ_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 17, FMXT_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 18, FOSW_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 19, FFOB_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 20, FAWR_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 21, FAWT_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 22, FDCRL_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 23, FDCRS_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 24, FDMP_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 25, FMAP_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 26, FGMAP_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 27, FECPB_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 28, FICPB_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 29, FODUO_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 30, FECRS_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 31, FECRL_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 32, FGDMP_SPECIAL_CLOCK_CONTROLSr);
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
shr_error_e
_dbal_init_hw_entity_groups_hw_entity_groups_framer_common_blocks_power_down_init(
int unit,
hl_group_info_t * group_info)
{
    hl_group_info_t * group_info_entry = &group_info[DBAL_HW_ENTITY_GROUP_FRAMER_COMMON_BLOCKS_POWER_DOWN];
    SHR_FUNC_INIT_VARS(unit);
    dbal_db_init_hw_entity_group_general_info_set(unit, group_info_entry, 11, TRUE);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 0, FRA_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 1, FSAR_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 2, FBSW_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 3, FDMX_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 4, FFOA_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 5, FMX_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 6, FOAM_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 7, FPTPR_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 8, FPTPT_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 9, FMACR_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 10, FMACT_SPECIAL_CLOCK_CONTROLSr);
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
shr_error_e
_dbal_init_hw_entity_groups_hw_entity_groups_ingress_pp_blocks_power_down_init(
int unit,
hl_group_info_t * group_info)
{
    hl_group_info_t * group_info_entry = &group_info[DBAL_HW_ENTITY_GROUP_INGRESS_PP_BLOCKS_POWER_DOWN];
    SHR_FUNC_INIT_VARS(unit);
    dbal_db_init_hw_entity_group_general_info_set(unit, group_info_entry, 13, TRUE);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 0, IPPA_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 1, IPPB_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 2, IPPC_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 3, IPPD_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 4, IPPE_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 5, IPPF_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 6, ITPP_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 7, ITPPD_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 8, KAPS_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 9, MACT_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 10, PDM_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 11, OAMP_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 12, OLP_SPECIAL_CLOCK_CONTROLSr);
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
shr_error_e
_dbal_init_hw_entity_groups_hw_entity_groups_egress_pp_blocks_power_down_init(
int unit,
hl_group_info_t * group_info)
{
    hl_group_info_t * group_info_entry = &group_info[DBAL_HW_ENTITY_GROUP_EGRESS_PP_BLOCKS_POWER_DOWN];
    SHR_FUNC_INIT_VARS(unit);
    dbal_db_init_hw_entity_group_general_info_set(unit, group_info_entry, 9, TRUE);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 0, EPRE_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 1, ERPP_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 2, ETPPA_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 3, ETPPB_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 4, ETPPC_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 5, MDB_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 6, DDHA_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 7, DDHB_SPECIAL_CLOCK_CONTROLSr);
    dbal_db_init_hw_entity_group_reg_mem_name_set(unit, group_info_entry, 8, TCAM_SPECIAL_CLOCK_CONTROLSr);
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
hl_group_info_t * group_info)
{
    ...
    SHR_IF_ERR_EXIT(_dbal_init_hw_entity_groups_hw_entity_groups_ingress_map_vsi_mac_prefix_to_da_msb_init(unit, group_info));
    ...
    SHR_IF_ERR_EXIT(_dbal_init_hw_entity_groups_hw_entity_groups_ofr_rx_port_map_to_rmc_init(unit, group_info));
    ...
    SHR_IF_ERR_EXIT(_dbal_init_hw_entity_groups_hw_entity_groups_ofr_parser_soft_stage_tcam_init(unit, group_info));
    ...
    SHR_IF_ERR_EXIT(_dbal_init_hw_entity_groups_hw_entity_groups_ingress_cpu_trap_code_profile_init(unit, group_info));
    ...
    SHR_IF_ERR_EXIT(_dbal_init_hw_entity_groups_hw_entity_groups_ofr_global_counters_init(unit, group_info));
    SHR_IF_ERR_EXIT(_dbal_init_hw_entity_groups_hw_entity_groups_framer_otn_blocks_power_down_init(unit, group_info));
    SHR_IF_ERR_EXIT(_dbal_init_hw_entity_groups_hw_entity_groups_framer_common_blocks_power_down_init(unit, group_info));
    SHR_IF_ERR_EXIT(_dbal_init_hw_entity_groups_hw_entity_groups_ingress_pp_blocks_power_down_init(unit, group_info));
    SHR_IF_ERR_EXIT(_dbal_init_hw_entity_groups_hw_entity_groups_egress_pp_blocks_power_down_init(unit, group_info));
exit:
    SHR_FUNC_EXIT;
}
