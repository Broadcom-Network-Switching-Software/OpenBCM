...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_init_tables_hard_logic_tm_hl_tm_dram_common_definition_init(unit, cur_table_param, table_info));
    ...
    SHR_IF_ERR_EXIT(dbal_init_tables_hard_logic_tm_hl_tm_nif_arb_definition_init(unit, cur_table_param, table_info));
    SHR_IF_ERR_EXIT(dbal_init_tables_hard_logic_tm_hl_tm_nif_ofr_definition_init(unit, cur_table_param, table_info));
    SHR_IF_ERR_EXIT(dbal_init_tables_hard_logic_tm_hl_tm_nif_oft_definition_init(unit, cur_table_param, table_info));
    ...
    SHR_IF_ERR_EXIT(dbal_init_tables_hard_logic_tm_hl_tm_tsn_definition_init(unit, cur_table_param, table_info));
exit:
    SHR_FUNC_EXIT;
}
