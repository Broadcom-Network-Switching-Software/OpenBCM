...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_SRAM_PACKET_BUFFER_DYNAMIC_CONFIGURATION, is_valid, maturity_level, "SRAM_PACKET_BUFFER_DYNAMIC_CONFIGURATION", DBAL_ACCESS_METHOD_HARD_LOGIC, current_image, &is_skip_table_init));
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_SRAM_PACKET_BUFFER_CONTEXT_MRU, is_valid, maturity_level, "SRAM_PACKET_BUFFER_CONTEXT_MRU", DBAL_ACCESS_METHOD_HARD_LOGIC, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_SRAM_PACKET_BUFFER_DROP_THRESHOLDS, is_valid, maturity_level, "SRAM_PACKET_BUFFER_DROP_THRESHOLDS", DBAL_ACCESS_METHOD_HARD_LOGIC, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_SRAM_PACKET_BUFFER_DROP_CONTEXT_PROFILE_MAP, is_valid, maturity_level, "SRAM_PACKET_BUFFER_DROP_CONTEXT_PROFILE_MAP", DBAL_ACCESS_METHOD_HARD_LOGIC, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_SRAM_PACKET_BUFFER_DROP_PRIORITY_MAP, is_valid, maturity_level, "SRAM_PACKET_BUFFER_DROP_PRIORITY_MAP", DBAL_ACCESS_METHOD_HARD_LOGIC, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_REASSEMBLY_CONTEXT_COUNTERS_CONFIG, is_valid, maturity_level, "REASSEMBLY_CONTEXT_COUNTERS_CONFIG", DBAL_ACCESS_METHOD_HARD_LOGIC, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_SRAM_PACKET_BUFFER_OCB_LAST_IN_CHAIN, is_valid, maturity_level, "SRAM_PACKET_BUFFER_OCB_LAST_IN_CHAIN", DBAL_ACCESS_METHOD_HARD_LOGIC, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_SRAM_PACKET_BUFFER_OCBM_BANKS_CFG, is_valid, maturity_level, "SRAM_PACKET_BUFFER_OCBM_BANKS_CFG", DBAL_ACCESS_METHOD_HARD_LOGIC, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
    ...
    }
    {
        ...
        DBAL_DB_INIT_TABLE_NOF_RESULT_TYPES_SET(table_entry, 1);
        SHR_IF_ERR_EXIT(dbal_db_init_table_db_interface_results_alloc(unit, table_entry));
        DBAL_DB_INIT_TABLE_NOF_RESULT_FIELDS_SET(table_entry, (table_entry->multi_res_info[result_type_counter]), 1 + (((dnx_data_spb.ocb.feature_get(unit, dnx_data_spb_ocb_is_bank_redundancy_supported))>0)?1:0) + (((dnx_data_spb.ocb.feature_get(unit, dnx_data_spb_ocb_is_bank_redundancy_supported))>0)?1:0));
        DBAL_DB_INIT_TABLE_INTERFACE_RESULT_FIELDS_ALLOC(table_entry, table_entry->multi_res_info[result_type_counter]);
        {
            dbal_db_field = &table_entry->multi_res_info[result_type_counter].results_info[field_index];
            ...
            dbal_db_init_table_field_params_init(&db_field);
            db_field.size = dnx_data_spb.ocb.bank_full_threshold_bits_get(unit);
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_optional_or_default_values(unit, table_entry, dbal_db_field, &db_field, FALSE));
            field_index += dbal_db_field->nof_instances;
        }
        if (dnx_data_spb.ocb.feature_get(unit, dnx_data_spb_ocb_is_bank_redundancy_supported) != 0)
        {
            dbal_db_field = &table_entry->multi_res_info[result_type_counter].results_info[field_index];
            ...
            dbal_db_init_table_field_params_init(&db_field);
            db_field.valid = dnx_data_spb.ocb.feature_get(unit, dnx_data_spb_ocb_is_bank_redundancy_supported);
            db_field.size = 1;
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_optional_or_default_values(unit, table_entry, dbal_db_field, &db_field, FALSE));
            field_index += dbal_db_field->nof_instances;
        }
        ...
        {
            {
                table_db_access_params_struct_t * access_params;
                {
                    ...
                    access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                    {
                        SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, OCB_BANKS_FULL_TH_REGISTERr, BANKS_FULL_THf));
                    }
                }
            }
        }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_SRAM_PACKET_BUFFER_OCBM_PER_BANK_PER_RING_CFG, is_valid, maturity_level, "SRAM_PACKET_BUFFER_OCBM_PER_BANK_PER_RING_CFG", DBAL_ACCESS_METHOD_HARD_LOGIC, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_SRAM_PACKET_BUFFER_OCBM_PER_BANK_CFG, is_valid, maturity_level, "SRAM_PACKET_BUFFER_OCBM_PER_BANK_CFG", DBAL_ACCESS_METHOD_HARD_LOGIC, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_SRAM_PACKET_BUFFER_OCBM_FREE_BUFFERS_STATUS_REGISTER, is_valid, maturity_level, "SRAM_PACKET_BUFFER_OCBM_FREE_BUFFERS_STATUS_REGISTER", DBAL_ACCESS_METHOD_HARD_LOGIC, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_SRAM_PACKET_BUFFER_OCBM_FREE_BUFFERS_BANK_STATUS_REGISTER, is_valid, maturity_level, "SRAM_PACKET_BUFFER_OCBM_FREE_BUFFERS_BANK_STATUS_REGISTER", DBAL_ACCESS_METHOD_HARD_LOGIC, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_NEXT_QUARANTINED_BDB_IN_FIFO, is_valid, maturity_level, "NEXT_QUARANTINED_BDB_IN_FIFO", DBAL_ACCESS_METHOD_HARD_LOGIC, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_RELEASE_BDB_CONTROL, is_valid, maturity_level, "RELEASE_BDB_CONTROL", DBAL_ACCESS_METHOD_HARD_LOGIC, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_DELETE_BDB_CONTROL, is_valid, maturity_level, "DELETE_BDB_CONTROL", DBAL_ACCESS_METHOD_HARD_LOGIC, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_FREE_BDB_COUNTER, is_valid, maturity_level, "FREE_BDB_COUNTER", DBAL_ACCESS_METHOD_HARD_LOGIC, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_DELETE_BDB_POINTER, is_valid, maturity_level, "DELETE_BDB_POINTER", DBAL_ACCESS_METHOD_HARD_LOGIC, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_DQM_CONTROL, is_valid, maturity_level, "DQM_CONTROL", DBAL_ACCESS_METHOD_HARD_LOGIC, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_BDB_CONFIG, is_valid, maturity_level, "BDB_CONFIG", DBAL_ACCESS_METHOD_HARD_LOGIC, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_BDM_FPC_CONFIG, is_valid, maturity_level, "BDM_FPC_CONFIG", DBAL_ACCESS_METHOD_HARD_LOGIC, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_BDM_INIT, is_valid, maturity_level, "BDM_INIT", DBAL_ACCESS_METHOD_HARD_LOGIC, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_PDM_INIT, is_valid, maturity_level, "PDM_INIT", DBAL_ACCESS_METHOD_HARD_LOGIC, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_DELETE_BDB_CONFIGS, is_valid, maturity_level, "DELETE_BDB_CONFIGS", DBAL_ACCESS_METHOD_HARD_LOGIC, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_DDP_GENERAL_CONFIGURATION, is_valid, maturity_level, "DDP_GENERAL_CONFIGURATION", DBAL_ACCESS_METHOD_HARD_LOGIC, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_DDP_FIFOS_CONFIG, is_valid, maturity_level, "DDP_FIFOS_CONFIG", DBAL_ACCESS_METHOD_HARD_LOGIC, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_OCBM_GLOBAL_INIT, is_valid, maturity_level, "OCBM_GLOBAL_INIT", DBAL_ACCESS_METHOD_HARD_LOGIC, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_BDM_POWER_DOWN, is_valid, maturity_level, "BDM_POWER_DOWN", DBAL_ACCESS_METHOD_HARD_LOGIC, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_SRAM_BLOCKS_POWER_DOWN, is_valid, maturity_level, "SRAM_BLOCKS_POWER_DOWN", DBAL_ACCESS_METHOD_HARD_LOGIC, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
