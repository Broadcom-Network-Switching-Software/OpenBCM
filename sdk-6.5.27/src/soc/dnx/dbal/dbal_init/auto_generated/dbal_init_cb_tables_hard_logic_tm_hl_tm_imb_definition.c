...
uint32 * offset)
{
    ...
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_TC, key_value__tc);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_DP, key_value__dp);
    *offset = 4*3*key_value__tc+3*key_value__dp;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_PCP, key_value__pcp);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_DEI, key_value__dei);
    *offset = 2*3*key_value__pcp+3*key_value__dei;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_CORE_ID, key_value__core_id);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_ETHU, key_value__ethu);
    *offset = key_value__core_id*8+key_value__ethu-1;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    dbal_entry_handle_t *  eh = (dbal_entry_handle_t *) entry_handle;
    uint32 key_value__rmc;
    uint32 key_value__rmc_prio;
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_RMC, key_value__rmc);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_RMC_PRIO, key_value__rmc_prio);
    *offset = key_value__rmc*3 + key_value__rmc_prio*194;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_CORE_ID, key_value__core_id);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_ETHU_ID, key_value__ethu_id);
    *offset = key_value__core_id*key_value__ethu_id;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
{
    dbal_entry_handle_t *  eh = (dbal_entry_handle_t *) entry_handle;
    uint32 key_value__port_client;
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_PORT_CLIENT, key_value__port_client);
    *offset = key_value__port_client;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
{
    dbal_entry_handle_t *  eh = (dbal_entry_handle_t *) entry_handle;
    uint32 key_value__framer_pm;
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_FRAMER_PM, key_value__framer_pm);
    *offset = key_value__framer_pm;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    *offset = key_value__framer_pm*8+key_value__pcs_port;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_PCS_PORT, key_value__pcs_port);
    *offset = key_value__pcs_port*2+24;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_SLOT_ID, key_value__slot_id);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_CAL_INDEX, key_value__cal_index);
    *offset = key_value__slot_id/512+key_value__cal_index*14;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_CLIENT_CHANNEL, key_value__client_channel);
    *offset = key_value__client_channel*2;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
{
    dbal_entry_handle_t *  eh = (dbal_entry_handle_t *) entry_handle;
    uint32 key_value__sar_channel;
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_SAR_CHANNEL, key_value__sar_channel);
    *offset = key_value__sar_channel;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
{
    dbal_entry_handle_t *  eh = (dbal_entry_handle_t *) entry_handle;
    uint32 key_value__sar_egq_port_id;
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_SAR_EGQ_PORT_ID, key_value__sar_egq_port_id);
    *offset = key_value__sar_egq_port_id;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_CORE_ID, key_value__core_id);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_ETHU_ID, key_value__ethu_id);
    *offset = key_value__core_id*dnx_data_nif.eth.cdu_nof_per_core_get(unit)+key_value__ethu_id;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
{
    dbal_entry_handle_t *  eh = (dbal_entry_handle_t *) entry_handle;
    uint32 key_value__framer_pm_lane;
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_FRAMER_PM_LANE, key_value__framer_pm_lane);
    *offset = key_value__framer_pm_lane*5;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
{
    dbal_entry_handle_t *  eh = (dbal_entry_handle_t *) entry_handle;
    uint32 key_value__pm_id;
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_PM_ID, key_value__pm_id);
    *offset = key_value__pm_id;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
{
    dbal_entry_handle_t *  eh = (dbal_entry_handle_t *) entry_handle;
    uint32 key_value__pm_internal_lane;
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_PM_INTERNAL_LANE, key_value__pm_internal_lane);
    *offset = key_value__pm_internal_lane%8 * 4;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
{
    dbal_entry_handle_t *  eh = (dbal_entry_handle_t *) entry_handle;
    uint32 key_value__pm_lane;
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_PM_LANE, key_value__pm_lane);
    *offset = key_value__pm_lane;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_LANE_IN_CORE, key_value__lane_in_core);
    *offset = key_value__lane_in_core*6;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
