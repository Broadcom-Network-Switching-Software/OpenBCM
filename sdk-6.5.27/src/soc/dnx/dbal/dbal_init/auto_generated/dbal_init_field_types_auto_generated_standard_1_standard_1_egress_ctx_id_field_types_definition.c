...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_field_type_general_info_set(unit, cur_field_types_info, "PRP2_CONTEXT_ID", 6, is_valid, FALSE, DBAL_FIELD_PRINT_TYPE_ENUM, 1, current_image, &is_skip_field_type_init));
    ...
    DBAL_INIT_FIELD_TYPES_ENUMS_CLEAR(cur_field_type_param);
    {
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_PRP2_CONTEXT_ID_OAM___PRIMARY_VLAN, "OAM___PRIMARY_VLAN");
    ...
    if (DBAL_IS_J2P_A0 || DBAL_IS_J2X_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_PRP2_CONTEXT_ID_OAM___PRIMARY_VLAN].value_from_mapping = 13;
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_field_type_db_struct_clear(unit, cur_field_type_param);
    SHR_IF_ERR_EXIT(dbal_db_init_field_type_general_info_set(unit, cur_field_types_info, "TERM_CONTEXT_ID", 6, is_valid, FALSE, DBAL_FIELD_PRINT_TYPE_ENUM, 1, current_image, &is_skip_field_type_init));
    if (is_skip_field_type_init)
    {
        SHR_EXIT();
    }
    cur_field_type_param->nof_enum_vals = DBAL_ENUM_FVAL_TERM_CONTEXT_ID_SRV6___SEGMENT_ENDPOINT_HBH_PT_MIDPOINT + 1;
    DBAL_INIT_FIELD_TYPES_ENUMS_CLEAR(cur_field_type_param);
    {
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___TWAMP_TX, "GENERAL___TWAMP_TX");
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_TERM_CONTEXT_ID_OAM___PRIMARY_VLAN, "OAM___PRIMARY_VLAN");
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_TERM_CONTEXT_ID_REFLECTORS___TWAMP_STATELESS_2ND_PASS, "REFLECTORS___TWAMP_STATELESS_2ND_PASS");
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___1588_DM_OVER_MPLS_INJECTED_FROM_OAMP, "GENERAL___1588_DM_OVER_MPLS_INJECTED_FROM_OAMP");
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_TERM_CONTEXT_ID_SRV6___SEGMENT_ENDPOINT_HBH_PT_MIDPOINT, "SRV6___SEGMENT_ENDPOINT_HBH_PT_MIDPOINT");
    }
    if (DBAL_IS_J2C_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___HEADER_TERMINATION_DEEP_UP_MEP].value_from_mapping = 3;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___MPLS_INJECTED_FROM_OAMP].value_from_mapping = 4;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___W_FWD_PLUS_1_REMARK_HEADER_TERMINATION].value_from_mapping = 5;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___TERMINATE_UP_TO_PSO].value_from_mapping = 6;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___BUILD_FTMH_FROM_PIPE].value_from_mapping = 7;
            ...
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___1588].value_from_mapping = 14;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___OAM].value_from_mapping = 15;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___IPT_TAIL].value_from_mapping = 17;
            ...
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___NOP_CTX].value_from_mapping = 23;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___INGRESS_TRAPPED_OAMP].value_from_mapping = 24;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___CPU_PORT].value_from_mapping = 25;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___MIRROR_OR_SS].value_from_mapping = 26;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___DM_CPU_PORT].value_from_mapping = 27;
            ...
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___TWAMP_TX].value_from_mapping = 32;
            ...
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_OAM___PRIMARY_VLAN].value_from_mapping = 39;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_REFLECTORS___TWAMPOIPV4_1ST_PASS].value_from_mapping = 40;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_REFLECTORS___TWAMPOIPV6_1ST_PASS].value_from_mapping = 41;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_REFLECTORS___TWAMP_2ND_PASS].value_from_mapping = 42;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_REFLECTORS___TWAMP_STATELESS_2ND_PASS].value_from_mapping = 43;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___SFLOW_SEQUENCE_RESET].value_from_mapping = 44;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_REFLECTORS___L2_OAM_TERM].value_from_mapping = 45;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_REFLECTORS___IP_UDP_SWAP].value_from_mapping = 46;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_REFLECTORS___IPV6_UDP_SWAP].value_from_mapping = 47;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_REFLECTORS___UDP_SWAP].value_from_mapping = 48;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_REFLECTORS___SEAMLESS_BFD].value_from_mapping = 49;
            ...
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_SRV6___SEGMENT_ENDPOINT].value_from_mapping = 52;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_SRV6___PSP].value_from_mapping = 53;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_TM___TX_INJECT].value_from_mapping = 55;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___IPT_IFA2_0_INTERMEDIATE].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___IPT_IFA2_0_EGRESS_NO_MD].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___IPT_IFA2_0_INGRESS].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___IPT_IFA2_0_INTERMEDIATE_NO_MD].is_invalid_value_from_mapping = TRUE;
            ...
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_SRV6___T_OR_B_INSERT_EXTENDED_PASS].value_from_mapping = 54;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___1588_DM_OVER_MPLS_INJECTED_FROM_OAMP].value_from_mapping = 13;
            ...
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_SRV6___SEGMENT_ENDPOINT_HBH_PT_MIDPOINT].is_invalid_value_from_mapping = TRUE;
        }
    }
    else if (DBAL_IS_J2P_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_SRV6___SEGMENT_ENDPOINT_HBH_PT_MIDPOINT].value_from_mapping = 22;
        }
    }
    ...
    else if (DBAL_IS_JR2_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___1588_DM_OVER_MPLS_INJECTED_FROM_OAMP].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___IOAM_JP].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___1588_HEADER_SIZE_COMPENSATION].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_SRV6___SEGMENT_ENDPOINT_HBH_PT_MIDPOINT].is_invalid_value_from_mapping = TRUE;
        }
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_field_type_db_struct_clear(unit, cur_field_type_param);
    SHR_IF_ERR_EXIT(dbal_db_init_field_type_general_info_set(unit, cur_field_types_info, "FWD_CONTEXT_ID", 6, is_valid, FALSE, DBAL_FIELD_PRINT_TYPE_ENUM, 1, current_image, &is_skip_field_type_init));
    if (is_skip_field_type_init)
    {
        SHR_EXIT();
    }
    cur_field_type_param->nof_enum_vals = DBAL_ENUM_FVAL_FWD_CONTEXT_ID_SRV6___SRV6_SEGMENT_ENDPOINT_HBH_PT_MIDPOINT + 1;
    DBAL_INIT_FIELD_TYPES_ENUMS_CLEAR(cur_field_type_param);
    {
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_FWD_CONTEXT_ID_IPV6___ETPP_FORWARDING_HBH_PT_MIDPOINT, "IPV6___ETPP_FORWARDING_HBH_PT_MIDPOINT");
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_FWD_CONTEXT_ID_OAM___UP_MEP, "OAM___UP_MEP");
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_FWD_CONTEXT_ID_SRV6___T_INSERT_ENDPOINT_MIDDLE_OF_COMPRESSION, "SRV6___T_INSERT_ENDPOINT_MIDDLE_OF_COMPRESSION");
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_FWD_CONTEXT_ID_REFLECTORS___L2_SWAP_SVTAG, "REFLECTORS___L2_SWAP_SVTAG");
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_FWD_CONTEXT_ID_REFLECTORS___L2_SWAP_AND_MC_SA_SVTAG, "REFLECTORS___L2_SWAP_AND_MC_SA_SVTAG");
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_FWD_CONTEXT_ID_SRV6___SRV6_SEGMENT_ENDPOINT_HBH_PT_MIDPOINT, "SRV6___SRV6_SEGMENT_ENDPOINT_HBH_PT_MIDPOINT");
    }
    if (DBAL_IS_J2C_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___DO_NOT_EDIT].value_from_mapping = 7;
            ...
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___DO_NOT_EDIT_AND_POP_ETPS].value_from_mapping = 14;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___IPT_TAIL_AM].value_from_mapping = 15;
            ...
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_IPV4___ETPP_FORWARDING_WO_ETPS_POP].value_from_mapping = 24;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_IPV4___ETPP_FORWARDING_WO_ETPS_POP_REMARK_TOS_P1].value_from_mapping = 25;
            ...
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_IPV6___ETPP_FORWARDING_WO_ETPS_POP].value_from_mapping = 33;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_IPV6___ETPP_FORWARDING_WO_ETPS_POP_REMARK_TOS_P1].value_from_mapping = 34;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_IPV6___ETPP_FORWARDING_HBH_PT_MIDPOINT].value_from_mapping = 35;
            ...
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_OAM___UP_MEP].value_from_mapping = 40;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_REFLECTORS___L2_SWAP].value_from_mapping = 41;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_REFLECTORS___L2_SWAP_INTERNAL_REFLECTOR].value_from_mapping = 42;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_REFLECTORS___L2_SWAP_WITH_IPV6_SWAP].value_from_mapping = 43;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_BNG___NOP_CTX].value_from_mapping = 44;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_REFLECTORS___L2_SWAP_WITH_IPV6_SWAP_COE].value_from_mapping = 45;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_REFLECTORS___L2_SWAP_AND_MC_SA_INTERNAL_REFLECTOR].value_from_mapping = 46;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_REFLECTORS___L2_SWAP_AND_MC_SA].value_from_mapping = 47;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_REFLECTORS___IPV4_SWAP].value_from_mapping = 48;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_REFLECTORS___SEAMLESS_BFD_OVER_MPLS].value_from_mapping = 49;
            ...
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_REFLECTORS___TWAMP_IPV4].value_from_mapping = 52;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_REFLECTORS___TWAMP_IPV6].value_from_mapping = 53;
            ...
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___IPT_IFA2_0_INTERMEDIATE].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___IPT_IFA2_0_EGRESS_NO_MD_FORWARD].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___IPT_IFA2_0_INGRESS].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_IPV4___NAT_EDITING].value_from_mapping = 17;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___IPT_IFA2_0_INTERMEDIATE_NO_MD].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_IPV4___BFD_IPV4_EXTRA_SIP].value_from_mapping = 32;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_MPLS___SWAP_WO_ETPS_POP].value_from_mapping = 37;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_SRV6___T_INSERT_SRV6_ENPOINT].value_from_mapping = 54;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_SRV6___T_INSERT_SRV6_ENPOINT_PSP].value_from_mapping = 55;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_SRV6___T_INSERT_NO_SIDS_SRV6_ENPOINT_PSP].value_from_mapping = 56;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_SRV6___T_OR_B_INSERT_EXTENDED_PASS].value_from_mapping = 57;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_SRV6___T_INSERT_IPV6].value_from_mapping = 58;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_SRV6___T_INSERT_ENDPOINT_MIDDLE_OF_COMPRESSION].value_from_mapping = 59;
            ...
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_REFLECTORS___L2_SWAP_SVTAG].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_REFLECTORS___L2_SWAP_AND_MC_SA_SVTAG].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_SRV6___SRV6_SEGMENT_ENDPOINT_HBH_PT_MIDPOINT].is_invalid_value_from_mapping = TRUE;
        }
    }
    else if (DBAL_IS_J2P_A0 || DBAL_IS_J2X_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___NOP_ADD_SVTAG].value_from_mapping = 12;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_REFLECTORS___L2_SWAP_SVTAG].value_from_mapping = 13;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_REFLECTORS___L2_SWAP_AND_MC_SA_SVTAG].value_from_mapping = 16;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_SRV6___SRV6_SEGMENT_ENDPOINT_HBH_PT_MIDPOINT].value_from_mapping = 22;
        }
    }
    else if (DBAL_IS_JR2_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_SRV6___T_INSERT_ENDPOINT_MIDDLE_OF_COMPRESSION].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___IOAM_JP].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_BRIDGE___ETPP_FORWARDING_SVTAG].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___NOP_ADD_SVTAG].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_REFLECTORS___L2_SWAP_SVTAG].is_invalid_value_from_mapping = TRUE;
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_field_type_db_struct_clear(unit, cur_field_type_param);
    SHR_IF_ERR_EXIT(dbal_db_init_field_type_general_info_set(unit, cur_field_types_info, "ENCAP_1_CONTEXT_ID", 6, is_valid, FALSE, DBAL_FIELD_PRINT_TYPE_ENUM, 1, current_image, &is_skip_field_type_init));
    if (is_skip_field_type_init)
    {
        SHR_EXIT();
    }
    ...
    DBAL_INIT_FIELD_TYPES_ENUMS_CLEAR(cur_field_type_param);
    {
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_GENERAL___ARP_PLUS_AC_ETH_FOR_SEC_TOD_TO_RCPU, "GENERAL___ARP_PLUS_AC_ETH_FOR_SEC_TOD_TO_RCPU");
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_MPLS___MPLS_RFC8321_IN_AH, "MPLS___MPLS_RFC8321_IN_AH");
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_MPLS___MPLS_1PLUSX, "MPLS___MPLS_1PLUSX");
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_MPLS___MPLS_2PLUSX, "MPLS___MPLS_2PLUSX");
    ...
    if (DBAL_IS_J2C_A0 || DBAL_IS_Q2A_A0 || DBAL_IS_Q2A_B0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_BNG___PPPOE_WO_PPP].value_from_mapping = 3;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_BNG___PPPOE_W_PPP].value_from_mapping = 4;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_BNG___L2TP_WO_PPP].value_from_mapping = 5;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_BNG___L2TP_W_PPP].value_from_mapping = 6;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_BRIDGE___ETH_COMPATIBLE_MC_BASIC].value_from_mapping = 7;
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_BRIDGE___IN_ETH_COMPATIBLE_MC_WO_ETPS_POP].value_from_mapping = 14;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_BRIDGE___IN_ETH_W_1_ETPS_POP].value_from_mapping = 15;
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_BRIDGE___ARP_AC_ETH].value_from_mapping = 18;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_BRIDGE___ARP_PLUS_AC_ETH].value_from_mapping = 19;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_GENERAL___NOP_AND_POP_CTX].value_from_mapping = 20;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_GENERAL___RAW_DATA_AT_VAR_SIZE].value_from_mapping = 21;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_GENERAL___ARP_PLUS_AC_ETH_FOR_SEC_TOD_TO_RCPU].value_from_mapping = 22;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_MPLS___IMPLICIT_NULL].value_from_mapping = 23;
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_MPLS___MPLS_RFC8321_IN_AH].value_from_mapping = 26;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_MPLS___MPLS_1PLUSX].value_from_mapping = 28;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_MPLS___PUSH_TWO_MPLS_LABELS_FROM_UDH].value_from_mapping = 29;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_MPLS___MPLS_2PLUSX].value_from_mapping = 30;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_MPLS___EVPN_WITH_ESI].value_from_mapping = 33;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_MPLS___EVPN_NO_ESI].value_from_mapping = 34;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_SRV6___ENCAP_SEGMENT_EXTENDED_PASS].value_from_mapping = 38;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_SRV6___ENCAP_SEGMENT_EXTENDED_PASS_REDUCED].value_from_mapping = 39;
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_GENERAL___IPT_IFA2_0_INTERMEDIATE].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_GENERAL___IPT_IFA2_0_EGRESS_NO_MD].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_GENERAL___IPT_IFA2_0_INGRESS].is_invalid_value_from_mapping = TRUE;
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_MPLS___MPLS_2PLUS1_BOS_LABEL_USED_IN_FWD_AS_SWAP].value_from_mapping = 31;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_MPLS___MPLS_2PLUS2_BOS_LABEL_USED_IN_FWD_AS_SWAP].value_from_mapping = 32;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_MPLS___IFIT_MPLS].value_from_mapping = 35;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_SRV6___B6_INSERT_SEGMENT_MAIN_PASS].value_from_mapping = 36;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_SRV6___B6_INSERT_SEGMENT_MAIN_PASS_REDUCED].value_from_mapping = 37;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_SRV6___B6_INSERT_SEGMENT_EXTENDED_PASS].value_from_mapping = 40;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_SRV6___B6_INSERT_SEGMENT_EXTENDED_PASS_REDUCED].value_from_mapping = 41;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_SRV6___T_INSERT_SEGMENT_EXTENDED_PASS].value_from_mapping = 42;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_SRV6___T_INSERT_SEGMENT_EXTENDED_PASS_REDUCED].value_from_mapping = 43;
    ...
    else if (DBAL_IS_J2P_A0 || DBAL_IS_J2X_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_SRV6___ENCAP_T_INSERT_ENCAP_SID].value_from_mapping = 50;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_SRV6___ENCAP_T_INSERT_ENCAP_SID_REDUCED].value_from_mapping = 51;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_BRIDGE___ETH_COMPATIBLE_MC_BASIC_SVTAG].value_from_mapping = 12;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_BRIDGE___ARP_AC_ETH_SVTAG].value_from_mapping = 13;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_BRIDGE___ARP_PLUS_AC_ETH_SVTAG].value_from_mapping = 16;
        }
    }
    else if (DBAL_IS_JR2_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_GENERAL___SFLOW_EXT_FIRST].value_from_mapping = 10;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_GENERAL___SFLOW_EXT_SECOND].value_from_mapping = 11;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_MPLS___1_MPLS_W_AH].value_from_mapping = 12;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_MPLS___2_MPLS_1_AH].value_from_mapping = 13;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_BRIDGE___IN_ETH_COMPATIBLE_MC_WO_ETPS_POP].value_from_mapping = 14;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_BRIDGE___IN_ETH_W_1_ETPS_POP].value_from_mapping = 15;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_MPLS___2_MPLS_2_AH].value_from_mapping = 16;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_MPLS___2_MPLS_3_AH].value_from_mapping = 17;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_BRIDGE___ARP_AC_ETH].value_from_mapping = 18;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_BRIDGE___ARP_PLUS_AC_ETH].value_from_mapping = 19;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_GENERAL___NOP_AND_POP_CTX].value_from_mapping = 20;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_GENERAL___RAW_DATA_AT_VAR_SIZE].value_from_mapping = 21;
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_field_type_db_struct_clear(unit, cur_field_type_param);
    SHR_IF_ERR_EXIT(dbal_db_init_field_type_general_info_set(unit, cur_field_types_info, "ENCAP_2_CONTEXT_ID", 6, is_valid, FALSE, DBAL_FIELD_PRINT_TYPE_ENUM, 1, current_image, &is_skip_field_type_init));
    if (is_skip_field_type_init)
    {
        SHR_EXIT();
    }
    ...
    DBAL_INIT_FIELD_TYPES_ENUMS_CLEAR(cur_field_type_param);
    {
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_SRV6___ENCAP_NULL, "SRV6___ENCAP_NULL");
        DBAL_INIT_FIELD_TYPES_ENUM_INVALID_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_SRV6___ENCAP_NULL, !(dnx_data_headers.system_headers.system_headers_mode_get(unit)));
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_UPF___GTPV1U_MUP_HEADER, "UPF___GTPV1U_MUP_HEADER");
        DBAL_INIT_FIELD_TYPES_ENUM_INVALID_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_UPF___GTPV1U_MUP_HEADER, !(dnx_data_headers.system_headers.system_headers_mode_get(unit)));
    ...
    if (DBAL_IS_J2C_A0 || DBAL_IS_Q2A_A0 || DBAL_IS_Q2A_B0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_GENERAL___RAW_DATA_AT_VAR_SIZE].value_from_mapping = 3;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_IPV4___TUNNEL].value_from_mapping = 4;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_MPLS___1_MPLS_W_AH].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_IPV4___IPV4_VXLAN].value_from_mapping = 6;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_IPV4___IPV4_VXLAN_ECN].value_from_mapping = 7;
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_IPV4___IPV4_GRE_WO_TNI].value_from_mapping = 14;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_IPV4___IPV4_UDP].value_from_mapping = 15;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_MPLS___2_MPLS_3_AH].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_IPV4___IPV4_GRE8_GRE12_GENEVE].value_from_mapping = 18;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_IPV6___TUNNEL].value_from_mapping = 19;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_IPV6___TUNNEL_ECN].value_from_mapping = 20;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_IPV6___VXLAN_ONLY].value_from_mapping = 21;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_MPLS___IMPLICIT_NULL].value_from_mapping = 22;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_MPLS___MPLS_1].value_from_mapping = 23;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_MPLS___MPLS_1_W_AH].value_from_mapping = 24;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_MPLS___MPLS_2].value_from_mapping = 25;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_MPLS___MPLS_1PLUS1].value_from_mapping = 26;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_MPLS___MPLS_1PLUS2].value_from_mapping = 27;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_MPLS___MPLS_2PLUS1].value_from_mapping = 28;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_MPLS___MPLS_2PLUS2].value_from_mapping = 29;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_MPLS___EVPN_WITH_ESI].value_from_mapping = 30;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_SRV6___ENCAP_2_SEGMENTS].value_from_mapping = 31;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_SRV6___ENCAP_1_SEGMENT].value_from_mapping = 32;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_SRV6___ENCAP_0_SEGMENTS].value_from_mapping = 33;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_SRV6___ENCAP_NULL].value_from_mapping = 37;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_UPF___GTPV1U_GPDU_HEADER].value_from_mapping = 38;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_UPF___GTPV1U_MUP_HEADER].value_from_mapping = 39;
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_GENERAL___IPT_IFA2_0_INTERMEDIATE].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_GENERAL___IPT_IFA2_0_EGRESS_NO_MD].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_GENERAL___IPT_IFA2_0_INGRESS].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_IPV4___NAT_BUILD_IP].value_from_mapping = 17;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_SRV6___ENCAP_T_INSERT_2_SEGMENTS].value_from_mapping = 34;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_SRV6___ENCAP_T_INSERT_1_SEGMENT].value_from_mapping = 35;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_SRV6___ENCAP_T_INSERT_0_SEGMENTS].value_from_mapping = 36;
    ...
    else if (DBAL_IS_J2P_A0 || DBAL_IS_J2X_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_SRV6___ENCAP_T_INSERT_1_SEGMENT].value_from_mapping = 35;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_SRV6___ENCAP_T_INSERT_0_SEGMENTS].value_from_mapping = 36;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_IPV4___TUNNEL_COPY_INNER].value_from_mapping = 5;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_IPV4___IPV4_DOUBLE_UDP_VXLAN].value_from_mapping = 12;
        }
    }
    else if (DBAL_IS_JR2_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_GENERAL___RAW_DATA_AT_VAR_SIZE].value_from_mapping = 3;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_IPV4___TUNNEL].value_from_mapping = 4;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_MPLS___1_MPLS_W_AH].value_from_mapping = 5;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_IPV4___IPV4_VXLAN].value_from_mapping = 6;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_IPV4___IPV4_VXLAN_ECN].value_from_mapping = 7;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_GENERAL___SFLOW_HDR_DP].value_from_mapping = 8;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_GENERAL___SFLOW_HDR_SAMP].value_from_mapping = 9;
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_MPLS___2_MPLS_2_AH].value_from_mapping = 13;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_IPV4___IPV4_GRE_WO_TNI].value_from_mapping = 14;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_IPV4___IPV4_UDP].value_from_mapping = 15;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_MPLS___2_MPLS_3_AH].value_from_mapping = 16;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_IPV4___IPV4_GRE8_GRE12_GENEVE].value_from_mapping = 18;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_IPV6___TUNNEL].value_from_mapping = 19;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_IPV6___TUNNEL_ECN].value_from_mapping = 20;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_IPV6___VXLAN_ONLY].value_from_mapping = 21;
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_field_type_db_struct_clear(unit, cur_field_type_param);
    SHR_IF_ERR_EXIT(dbal_db_init_field_type_general_info_set(unit, cur_field_types_info, "ENCAP_3_CONTEXT_ID", 6, is_valid, FALSE, DBAL_FIELD_PRINT_TYPE_ENUM, 1, current_image, &is_skip_field_type_init));
    if (is_skip_field_type_init)
    {
        SHR_EXIT();
    }
    ...
    DBAL_INIT_FIELD_TYPES_ENUMS_CLEAR(cur_field_type_param);
    {
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV4___NAT_SIGNATURE, "IPV4___NAT_SIGNATURE");
    ...
    if (DBAL_IS_J2C_A0 || DBAL_IS_Q2A_A0 || DBAL_IS_Q2A_B0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_GENERAL___RAW_DATA_AT_VAR_SIZE].value_from_mapping = 3;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV4___TUNNEL].value_from_mapping = 4;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV4___IPV4_VXLAN].value_from_mapping = 5;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV4___IPV4_VXLAN_ECN].value_from_mapping = 6;
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV4___IPV4_GRE_WO_TNI].value_from_mapping = 14;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV4___IPV4_UDP].value_from_mapping = 15;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_MPLS___2_MPLS_3_AH].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV4___NAT_SIGNATURE].value_from_mapping = 18;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV4___IPV4_GRE8_GRE12_GENEVE].value_from_mapping = 19;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV6___TUNNEL].value_from_mapping = 20;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV6___TUNNEL_ECN].value_from_mapping = 21;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV6___VXLAN_ONLY].value_from_mapping = 22;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV6___GENEVE_ONLY].value_from_mapping = 23;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV6___GRE_ONLY].value_from_mapping = 24;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV6___GRE_ONLY_WO_TNI].value_from_mapping = 25;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV6___UDP_ONLY].value_from_mapping = 26;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_MPLS___IMPLICIT_NULL].value_from_mapping = 27;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_MPLS___MPLS_1].value_from_mapping = 28;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_MPLS___MPLS_2].value_from_mapping = 29;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_MPLS___MPLS_1PLUS1].value_from_mapping = 30;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_MPLS___MPLS_1PLUS2].value_from_mapping = 31;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_MPLS___MPLS_2PLUS1].value_from_mapping = 32;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_MPLS___MPLS_2PLUS2].value_from_mapping = 33;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___TWO_SEGMENTS].value_from_mapping = 34;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___ONE_SEGMENT].value_from_mapping = 35;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___ZERO_SEGMENTS].value_from_mapping = 36;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___SRH_AND_2_SEGMENTS].value_from_mapping = 37;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___SRH_AND_1_SEGMENT].value_from_mapping = 38;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___SRH_AND_0_SEGMENT].value_from_mapping = 39;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_GENERAL___IPT_IFA2_0_INTERMEDIATE].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_GENERAL___IPT_IFA2_0_EGRESS_NO_MD].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_GENERAL___IPT_IFA2_0_INGRESS].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV4___KEEP_ORIGINAL_ETH].value_from_mapping = 17;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___T_INSERT_SRH_AND_2_SEGMENTS].value_from_mapping = 40;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___T_INSERT_SRH_AND_1_SEGMENT].value_from_mapping = 41;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___T_INSERT_SRH_AND_0_SEGMENT].value_from_mapping = 42;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___T_INSERT_TWO_SEGMENTS].value_from_mapping = 43;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___T_INSERT_ONE_SEGMENT].value_from_mapping = 44;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___T_INSERT_ZERO_SEGMENTS].value_from_mapping = 45;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___VPN_ENHANCED_SRH_AND_1_SEGMENT].value_from_mapping = 46;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___VPN_ENHANCED_SRH_AND_0_SEGMENT].value_from_mapping = 47;
    ...
    else if (DBAL_IS_J2P_A0 || DBAL_IS_J2X_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___VPN_ENHANCED_SRH_AND_1_SEGMENT].value_from_mapping = 46;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___VPN_ENHANCED_SRH_AND_0_SEGMENT].value_from_mapping = 47;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV4___IPV4_DOUBLE_UDP_VXLAN].value_from_mapping = 7;
        }
    }
    else if (DBAL_IS_JR2_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV4___IPV4_VXLAN].value_from_mapping = 5;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV4___IPV4_VXLAN_ECN].value_from_mapping = 6;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_MPLS___1_MPLS_W_AH].value_from_mapping = 7;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_GENERAL___SFLOW_HDR_DP].value_from_mapping = 8;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_GENERAL___SFLOW_HDR_SAMP].value_from_mapping = 9;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_GENERAL___SFLOW_EXT_FIRST].value_from_mapping = 10;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_GENERAL___SFLOW_EXT_SECOND].value_from_mapping = 11;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_MPLS___2_MPLS_1_AH].value_from_mapping = 12;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_MPLS___2_MPLS_2_AH].value_from_mapping = 13;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV4___IPV4_GRE_WO_TNI].value_from_mapping = 14;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV4___IPV4_UDP].value_from_mapping = 15;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_MPLS___2_MPLS_3_AH].value_from_mapping = 16;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV4___NAT_SIGNATURE].value_from_mapping = 18;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV4___IPV4_GRE8_GRE12_GENEVE].value_from_mapping = 19;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV6___TUNNEL].value_from_mapping = 20;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV6___TUNNEL_ECN].value_from_mapping = 21;
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_field_type_db_struct_clear(unit, cur_field_type_param);
    SHR_IF_ERR_EXIT(dbal_db_init_field_type_general_info_set(unit, cur_field_types_info, "ENCAP_4_CONTEXT_ID", 6, is_valid, FALSE, DBAL_FIELD_PRINT_TYPE_ENUM, 1, current_image, &is_skip_field_type_init));
    if (is_skip_field_type_init)
    {
        SHR_EXIT();
    }
    ...
    DBAL_INIT_FIELD_TYPES_ENUMS_CLEAR(cur_field_type_param);
    {
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_4_CONTEXT_ID_IPV4___TUNNEL_MUP, "IPV4___TUNNEL_MUP");
        DBAL_INIT_FIELD_TYPES_ENUM_INVALID_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_4_CONTEXT_ID_IPV4___TUNNEL_MUP, !(dnx_data_headers.system_headers.system_headers_mode_get(unit)));
    ...
    if (DBAL_IS_JR2_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_4_CONTEXT_ID_IPV4___TUNNEL_MUP].value_from_mapping = 4;
            enum_info[DBAL_ENUM_FVAL_ENCAP_4_CONTEXT_ID_IPV4___IPV4_VXLAN].value_from_mapping = 5;
            enum_info[DBAL_ENUM_FVAL_ENCAP_4_CONTEXT_ID_IPV4___IPV4_VXLAN_ECN].value_from_mapping = 6;
            enum_info[DBAL_ENUM_FVAL_ENCAP_4_CONTEXT_ID_IPV4___IPV4_GRE_WO_TNI].value_from_mapping = 7;
            enum_info[DBAL_ENUM_FVAL_ENCAP_4_CONTEXT_ID_IPV4___IPV4_UDP].value_from_mapping = 8;
            enum_info[DBAL_ENUM_FVAL_ENCAP_4_CONTEXT_ID_IPV4___IPV4_GRE8_GRE12_GENEVE].value_from_mapping = 9;
            enum_info[DBAL_ENUM_FVAL_ENCAP_4_CONTEXT_ID_IPV6___TUNNEL].value_from_mapping = 10;
            enum_info[DBAL_ENUM_FVAL_ENCAP_4_CONTEXT_ID_IPV6___TUNNEL_ECN].value_from_mapping = 11;
            enum_info[DBAL_ENUM_FVAL_ENCAP_4_CONTEXT_ID_MPLS___IMPLICIT_NULL].value_from_mapping = 12;
            enum_info[DBAL_ENUM_FVAL_ENCAP_4_CONTEXT_ID_MPLS___MPLS_1].value_from_mapping = 13;
            enum_info[DBAL_ENUM_FVAL_ENCAP_4_CONTEXT_ID_MPLS___1_MPLS_W_AH].value_from_mapping = 14;
            enum_info[DBAL_ENUM_FVAL_ENCAP_4_CONTEXT_ID_MPLS___MPLS_2].value_from_mapping = 15;
            enum_info[DBAL_ENUM_FVAL_ENCAP_4_CONTEXT_ID_MPLS___2_MPLS_1_AH].value_from_mapping = 16;
            enum_info[DBAL_ENUM_FVAL_ENCAP_4_CONTEXT_ID_MPLS___2_MPLS_2_AH].value_from_mapping = 17;
            enum_info[DBAL_ENUM_FVAL_ENCAP_4_CONTEXT_ID_MPLS___2_MPLS_3_AH].value_from_mapping = 18;
            enum_info[DBAL_ENUM_FVAL_ENCAP_4_CONTEXT_ID_MPLS___MPLS_1PLUS1].value_from_mapping = 19;
            enum_info[DBAL_ENUM_FVAL_ENCAP_4_CONTEXT_ID_MPLS___MPLS_1PLUS2].value_from_mapping = 20;
            enum_info[DBAL_ENUM_FVAL_ENCAP_4_CONTEXT_ID_MPLS___MPLS_2PLUS1].value_from_mapping = 21;
            enum_info[DBAL_ENUM_FVAL_ENCAP_4_CONTEXT_ID_MPLS___MPLS_2PLUS2].value_from_mapping = 22;
            enum_info[DBAL_ENUM_FVAL_ENCAP_4_CONTEXT_ID_SRV6___SRV6_IPV6_HEADER].value_from_mapping = 23;
            enum_info[DBAL_ENUM_FVAL_ENCAP_4_CONTEXT_ID_SRV6___EXTENDED_PASS_FIRST].value_from_mapping = 24;
            enum_info[DBAL_ENUM_FVAL_ENCAP_4_CONTEXT_ID_SRV6___EXTENDED_PASS_MIDDLE].value_from_mapping = 25;
            enum_info[DBAL_ENUM_FVAL_ENCAP_4_CONTEXT_ID_SRV6___EXTENDED_PASS_LAST].value_from_mapping = 26;
    ...
    else if (DBAL_IS_JR2_B0 || DBAL_IS_J2C_A0 || DBAL_IS_Q2A_A0 || DBAL_IS_Q2A_B0 || DBAL_IS_J2P_A0 || DBAL_IS_J2X_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_4_CONTEXT_ID_SRV6___EXTENDED_PASS_MIDDLE].value_from_mapping = 25;
            enum_info[DBAL_ENUM_FVAL_ENCAP_4_CONTEXT_ID_SRV6___EXTENDED_PASS_LAST].value_from_mapping = 26;
            enum_info[DBAL_ENUM_FVAL_ENCAP_4_CONTEXT_ID_SRV6___T_INSERT].value_from_mapping = 14;
            enum_info[DBAL_ENUM_FVAL_ENCAP_4_CONTEXT_ID_SRV6___T_INSERT_EXTENDED_PASS_FIRST].value_from_mapping = 16;
            enum_info[DBAL_ENUM_FVAL_ENCAP_4_CONTEXT_ID_SRV6___B6_INSERT_EXTENDED_PASS_FIRST].value_from_mapping = 17;
            enum_info[DBAL_ENUM_FVAL_ENCAP_4_CONTEXT_ID_SRV6___T_OR_B_INSERT_EXTENDED_PASS_MIDDLE_OR_LAST].value_from_mapping = 18;
        }
    }
    SHR_IF_ERR_EXIT(dbal_db_init_field_type_add(unit, cur_field_type_param, cur_field_types_info));
exit:
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_field_type_db_struct_clear(unit, cur_field_type_param);
    SHR_IF_ERR_EXIT(dbal_db_init_field_type_general_info_set(unit, cur_field_types_info, "ENCAP_5_CONTEXT_ID", 6, is_valid, FALSE, DBAL_FIELD_PRINT_TYPE_ENUM, 1, current_image, &is_skip_field_type_init));
    if (is_skip_field_type_init)
    {
        SHR_EXIT();
    }
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_field_type_db_struct_clear(unit, cur_field_type_param);
    SHR_IF_ERR_EXIT(dbal_db_init_field_type_general_info_set(unit, cur_field_types_info, "TRAP_CONTEXT_ID", 6, is_valid, FALSE, DBAL_FIELD_PRINT_TYPE_ENUM, 1, current_image, &is_skip_field_type_init));
    if (is_skip_field_type_init)
    {
        SHR_EXIT();
    }
    ...
    if (DBAL_IS_J2C_A0 || DBAL_IS_Q2A_A0 || DBAL_IS_Q2A_B0 || DBAL_IS_J2X_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_GENERAL___RCH_DROP_AND_CONT].value_from_mapping = 2;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_GENERAL___RCH_EXT_ENCAP].value_from_mapping = 3;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_GENERAL___RCH_XTERMINATION].value_from_mapping = 4;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_GENERAL___PTCH1_FROM_FTMH_SSPA].value_from_mapping = 5;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_GENERAL___RECYCLE_W_PTCH2].value_from_mapping = 6;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_GENERAL___OAM_UPMEP_REFLECTOR].value_from_mapping = 7;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_GENERAL___NORMAL_FWD].value_from_mapping = 8;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_GENERAL___NORMAL_FWD_NO_MIRROR].value_from_mapping = 9;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_GENERAL___DROP_PKT].value_from_mapping = 10;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_GENERAL___VISIBILITY].value_from_mapping = 11;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_GENERAL___CPU_PORT_TRAPPED].value_from_mapping = 12;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_GENERAL___USER_TRAP_1].value_from_mapping = 13;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_GENERAL___USER_TRAP_2].value_from_mapping = 14;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_GENERAL___USER_TRAP_3].value_from_mapping = 15;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_GENERAL___USER_TRAP_4].value_from_mapping = 16;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_GENERAL___IPT_IFA_FIRST_DP].value_from_mapping = 17;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_TM___JR1_COMP_MACT_LEARNING_JR2_TO_JR1].value_from_mapping = 17;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_GENERAL___RCH_VRF_REDIRECT].value_from_mapping = 18;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_GENERAL___DM_CPU_PORT_TRAPPED].value_from_mapping = 19;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_OAM___OAM_DM_TO_OAMP].value_from_mapping = 20;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_OAM___OAM_DM_TO_CPU].value_from_mapping = 21;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_OAM___OAM_DM_TO_FPGA].value_from_mapping = 22;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_OAM___OAM_LM_TO_OAMP].value_from_mapping = 23;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_OAM___OAM_LM_TO_CPU].value_from_mapping = 24;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_OAM___OAM_LM_TO_FPGA].value_from_mapping = 25;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_OAM___OAM_CCM_TO_OAMP].value_from_mapping = 26;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_OAM___OAM_CCM_TO_CPU].value_from_mapping = 27;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_OAM___OAM_CCM_TO_FPGA].value_from_mapping = 28;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_OAM___OAM_LVLERR].value_from_mapping = 29;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_OAM___OAM_PSVERR].value_from_mapping = 30;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_OAM___OAM_REFLECTOR].value_from_mapping = 31;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_SRV6___RCH_SRV6_USP_PSP].value_from_mapping = 32;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_TELEMETRY___IFA_EGRESS_PORT].value_from_mapping = 33;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_TM___RAW_PORT].value_from_mapping = 34;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_TM___DEFAULT].value_from_mapping = 35;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_TM___TDM_NO_OTMH].value_from_mapping = 36;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_TM___TDM_STAMP_MC_CUD_ON_OTMH].value_from_mapping = 37;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_TM___TDM_STAMP_PORT_VAL_ON_OTMH].value_from_mapping = 38;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_TM___TDM_STAMP_NOTHING_ON_OTMH].value_from_mapping = 39;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_TM___TDM_STAMP_MC_CUD_ON_FTMH].value_from_mapping = 40;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_TM___TDM_STAMP_PORT_VAL_ON_FTMH].value_from_mapping = 41;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_TM___TDM_STAMP_NOTHING_ON_FTMH].value_from_mapping = 42;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_TM___TDM_STAMP_MC_CUD_ON_OPT_FTMH].value_from_mapping = 43;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_TM___TDM_STAMP_PORT_VAL_ON_OPT_FTMH].value_from_mapping = 44;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_TM___TDM_STAMP_NOTHING_ON_OPT_FTMH].value_from_mapping = 45;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_TM___STAMP_OTMH_OUTLIF_EXT_IF_MC].value_from_mapping = 46;
        }
    }
