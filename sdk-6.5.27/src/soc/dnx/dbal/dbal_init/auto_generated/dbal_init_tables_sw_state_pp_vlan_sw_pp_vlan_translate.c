...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_IVEC_ACTION_ID_SW_INFO, is_valid, maturity_level, "IVEC_ACTION_ID_SW_INFO", DBAL_ACCESS_METHOD_SW_STATE, current_image, &is_skip_table_init));
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_EVEC_FRWRD_STAGE_ACTION_ID_INFO_SW, is_valid, maturity_level, "EVEC_FRWRD_STAGE_ACTION_ID_INFO_SW", DBAL_ACCESS_METHOD_SW_STATE, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_TAG_STRUCT_INGRESS_HW_ID_TO_SW_ID, is_valid, maturity_level, "TAG_STRUCT_INGRESS_HW_ID_TO_SW_ID", DBAL_ACCESS_METHOD_SW_STATE, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_TAG_STRUCT_EGRESS_HW_ID_TO_SW_ID, is_valid, maturity_level, "TAG_STRUCT_EGRESS_HW_ID_TO_SW_ID", DBAL_ACCESS_METHOD_SW_STATE, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_TAG_STRUCT_INGRESS_SW_ID_TO_HW_ID, is_valid, maturity_level, "TAG_STRUCT_INGRESS_SW_ID_TO_HW_ID", DBAL_ACCESS_METHOD_SW_STATE, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_TAG_STRUCT_EGRESS_SW_ID_TO_HW_ID, is_valid, maturity_level, "TAG_STRUCT_EGRESS_SW_ID_TO_HW_ID", DBAL_ACCESS_METHOD_SW_STATE, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
