...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_KLEAP_IPMF1_INITIAL_KBR_INFO, is_valid, maturity_level, "KLEAP_IPMF1_INITIAL_KBR_INFO", DBAL_ACCESS_METHOD_HARD_LOGIC, current_image, &is_skip_table_init));
