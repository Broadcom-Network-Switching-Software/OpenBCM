...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_ESEM_DEFAULT_RESULT_TABLE, is_valid, maturity_level, "ESEM_DEFAULT_RESULT_TABLE", DBAL_ACCESS_METHOD_HARD_LOGIC, current_image, &is_skip_table_init));
    ...
    }
    {
        ...
        field_index = 0;
        if (dnx_data_dnx2_mdb_app_db.fields.numeric_mdb_field___0___valid_get(unit) != 0)
        {
            ...
            DBAL_DB_INIT_TABLE_INTERFACE_RESULT_FIELDS_ALLOC(table_entry, table_entry->multi_res_info[result_type_counter]);
            {
                ...
                dbal_db_init_table_field_params_init(&db_field);
                db_field.size = dnx_data_dnx2_mdb_app_db.fields.numeric_mdb_field___0_get(unit);
        ...
        field_index = 0;
        if (dnx_data_dnx2_mdb_app_db.fields.numeric_mdb_field___1___valid_get(unit) != 0)
        {
            ...
            DBAL_DB_INIT_TABLE_INTERFACE_RESULT_FIELDS_ALLOC(table_entry, table_entry->multi_res_info[result_type_counter]);
            {
                ...
                SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_mandatory_values(unit, DBAL_FIELD_RESULT_TYPE, DBAL_FIELD_TYPE_DEF_RESULT_TYPE, dbal_db_field));
                dbal_db_init_table_field_params_init(&db_field);
                db_field.size = dnx_data_dnx2_mdb_app_db.fields.numeric_mdb_field___1_get(unit);
                SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_optional_or_default_values(unit, table_entry, dbal_db_field, &db_field, FALSE));
                field_index += dbal_db_field->nof_instances;
            }
            {
        ...
        field_index = 0;
        if (dnx_data_dnx2_mdb_app_db.fields.numeric_mdb_field___5___valid_get(unit) != 0)
        {
            DBAL_DB_INIT_TABLE_NOF_RESULT_FIELDS_SET(table_entry, (table_entry->multi_res_info[result_type_counter]), 2);
            DBAL_DB_INIT_TABLE_INTERFACE_RESULT_FIELDS_ALLOC(table_entry, table_entry->multi_res_info[result_type_counter]);
            {
                ...
                SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_mandatory_values(unit, DBAL_FIELD_RESULT_TYPE, DBAL_FIELD_TYPE_DEF_RESULT_TYPE, dbal_db_field));
                dbal_db_init_table_field_params_init(&db_field);
                db_field.size = dnx_data_dnx2_mdb_app_db.fields.numeric_mdb_field___5_get(unit);
                SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_optional_or_default_values(unit, table_entry, dbal_db_field, &db_field, FALSE));
                field_index += dbal_db_field->nof_instances;
            }
            {
            ...
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_MEMORY;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ETPPC_ESEM_DEFAULT_RESULT_TABLEm, DBAL_HL_ACCESS_HW_FIELD_INVALID));
                    {
                        ...
                        result_size__result_type += dnx_data_dnx2_mdb_app_db.fields.numeric_mdb_field___0_get(unit);
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, "ETPS_DUAL_HOMING", sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_MEMORY;
                {
                    ...
                    {
                        uint32 result_size__result_type = 0;
                        result_size__result_type += dnx_data_dnx2_mdb_app_db.fields.numeric_mdb_field___1_get(unit);
                        access_params->data_offset.formula_int = 60-result_size__result_type;
                    }
                }
            }
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, "ETPS_NULL", sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_MEMORY;
                {
                    ...
                    {
                        uint32 result_size__result_type = 0;
                        result_size__result_type += dnx_data_dnx2_mdb_app_db.fields.numeric_mdb_field___5_get(unit);
                        access_params->data_offset.formula_int = 60-result_size__result_type;
                    }
                }
            }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_JR1_MPLS_PUSH_COMMAND, is_valid, maturity_level, "JR1_MPLS_PUSH_COMMAND", DBAL_ACCESS_METHOD_HARD_LOGIC, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
    ...
    }
    {
        ...
        field_index = 0;
        if (dnx_data_dnx2_mdb_app_db.fields.numeric_mdb_field___2___valid_get(unit) != 0)
        {
            ...
            DBAL_DB_INIT_TABLE_INTERFACE_RESULT_FIELDS_ALLOC(table_entry, table_entry->multi_res_info[result_type_counter]);
            {
                ...
                SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_mandatory_values(unit, DBAL_FIELD_RESULT_TYPE, DBAL_FIELD_TYPE_DEF_RESULT_TYPE, dbal_db_field));
                dbal_db_init_table_field_params_init(&db_field);
                db_field.size = dnx_data_dnx2_mdb_app_db.fields.numeric_mdb_field___2_get(unit);
                SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_optional_or_default_values(unit, table_entry, dbal_db_field, &db_field, FALSE));
                field_index += dbal_db_field->nof_instances;
            }
            {
            ...
            }
            {
                ...
                dbal_db_init_table_field_params_init(&db_field);
                db_field.size = 3;
                dbal_db_init_table_set_field_arr_prefix(unit, &db_field, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_5_get(unit), 8);
                SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_optional_or_default_values(unit, table_entry, dbal_db_field, &db_field, FALSE));
                field_index += dbal_db_field->nof_instances;
            }
            {
            ...
            }
            {
                ...
                dbal_db_init_table_field_params_init(&db_field);
                db_field.size = 1;
                dbal_db_init_table_set_field_arr_prefix(unit, &db_field, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_14_get(unit), 8);
                SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_optional_or_default_values(unit, table_entry, dbal_db_field, &db_field, FALSE));
                field_index += dbal_db_field->nof_instances;
            }
            {
        ...
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_MEMORY;
                {
                    ...
                    {
                        access_params->data_offset.formula_int = 89;
                    }
                }
            }
        }
        ...
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_MEMORY;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ETPPA_EEI_MPLS_PUSH_2_EES_MAPm, EEI_DATAf));
                    {
                        access_params->data_offset.formula_int = 85;
                    }
                }
            }
        }
