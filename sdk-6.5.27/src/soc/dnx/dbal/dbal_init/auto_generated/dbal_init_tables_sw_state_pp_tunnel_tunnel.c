...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_SRV6_DIP_IDX_TYPES_PER_TUNNEL_GPORT_SW, is_valid, maturity_level, "SRV6_DIP_IDX_TYPES_PER_TUNNEL_GPORT_SW", DBAL_ACCESS_METHOD_SW_STATE, current_image, &is_skip_table_init));
