...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_VIRTUAL_PORT_TCAM_SW, is_valid, maturity_level, "VIRTUAL_PORT_TCAM_SW", DBAL_ACCESS_METHOD_SW_STATE, current_image, &is_skip_table_init));
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_VIRTUAL_PORT_TCAM_SW_CONTROL, is_valid, maturity_level, "VIRTUAL_PORT_TCAM_SW_CONTROL", DBAL_ACCESS_METHOD_SW_STATE, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
...
dbal_logical_table_t * table_info)
{
    ...
    dbal_init_table_db_struct_clear(cur_table_param);
    maturity_level = DBAL_MATURITY_HIGH;
    SHR_IF_ERR_EXIT(dbal_db_init_table_general_info_and_image_handle(unit, table_entry, DBAL_TABLE_VIRTUAL_PORT_COE_LAG_CONTROL_SW, is_valid, maturity_level, "VIRTUAL_PORT_COE_LAG_CONTROL_SW", DBAL_ACCESS_METHOD_SW_STATE, current_image, &is_skip_table_init));
    if (is_skip_table_init)
    {
        SHR_EXIT();
    }
