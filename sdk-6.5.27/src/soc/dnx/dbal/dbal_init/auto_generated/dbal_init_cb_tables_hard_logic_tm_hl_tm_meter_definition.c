...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_INDEX, key_value__index);
    *offset = key_value__index/dnx_data_meter.mem_mgmt.nof_profiles_per_entry_get(unit);
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_INDEX, key_value__index);
    *offset = key_value__index%dnx_data_meter.mem_mgmt.nof_profiles_per_entry_get(unit)*10;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    *offset = key_value__meter_id/dnx_data_meter.mem_mgmt.nof_single_buckets_per_entry_get(unit);
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_METER_ID, key_value__meter_id);
    *offset = (key_value__meter_id%dnx_data_meter.mem_mgmt.nof_single_buckets_per_entry_get(unit))*dnx_data_meter.mem_mgmt.bucket_size_nof_bits_get(unit);
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
