...
#define DBAL_HL_NEW_ACCESS_DEVICE_TYPE_INFO(unit) (ACCESS_RUNTIME_INFO(unit)->device_type_info)
...
shr_error_e dbal_hl_hook_entry_decode(
    int unit,
    dbal_entry_handle_t * entry_handle);
...
shr_error_e dbal_hl_register_write_per_access(
    int unit,
    dbal_entry_handle_t * entry_handle,
    int reg,
    int block_indx,
...
shr_error_e dbal_hl_register_read_per_access(
    int unit,
    const dbal_logical_table_t * table,
    int reg,
    int block_indx,
