    ...
    *param = 0;
    switch (en_interrupt)
    {
        ...
        case Q2A_INT_IPPD_INVALID_DESTINATION_VALID:
            ...
            break;
        case Q2A_INT_EPNI_ETPP_INC_ABOVE_TH_INT:
        case Q2A_INT_EPNI_ETPP_TOTAL_INC_ABOVE_TH_INT:
        case Q2A_INT_EPNI_ETPP_TOTAL_DEC_ABOVE_TH_INT:
        case Q2A_INT_EPNI_ETPP_TAIL_ABOVE_INC_INT:
        case Q2A_INT_EPNI_ETPP_PKT_INC_ABOVE_MAX_PKT_SIZE_INT:
        case Q2A_INT_EPNI_ETPP_TOTAL_DEC_ABOVE_PKT_SIZE_INT:
        case Q2A_INT_EPNI_ALIGNER_TRANSMIT_SIZE_ABOVE_TH_INT:
            sal_snprintf(special_msg, DNXC_INTERRUPT_SPECIAL_MSG_SIZE - 1, "%s", msg);
    ...
    int unit)
{
    ...
    dnxc_intr_add_handler_ext(unit, Q2A_INT_OCB_ERROR_FREE_INT, 0, 0, q2a_hard_reset, q2a_none, "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, Q2A_INT_SPB_REASSEMBLY_REASSEMBLY_ERROR_PACKET_REJECT, 0, 0, q2a_none, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_SPB_FIFO_ERROR_S_2F_RPC_SROT_FIFO_OVERFLOW_0, 0, 0, q2a_hard_reset,
                              q2a_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_SPB_FIFO_ERROR_S_2F_RPC_SROT_FIFO_OVERFLOW_1, 0, 0, q2a_hard_reset,
                              q2a_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_SPB_FIFO_ERROR_S_2F_RPC_SROT_FIFO_OVERFLOW_2, 0, 0, q2a_hard_reset,
                              q2a_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_SPB_FIFO_ERROR_S_2F_RPC_SROT_FIFO_UNDERFLOW_0, 0, 0, q2a_hard_reset,
                              q2a_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_SPB_FIFO_ERROR_S_2F_RPC_SROT_FIFO_UNDERFLOW_1, 0, 0, q2a_hard_reset,
                              q2a_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_SPB_FIFO_ERROR_S_2F_RPC_SROT_FIFO_UNDERFLOW_2, 0, 0, q2a_hard_reset,
                              q2a_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_SPB_FIFO_ERROR_S_2D_RPC_SROT_FIFO_OVERFLOW_0, 0, 0, q2a_hard_reset,
                              q2a_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_SPB_FIFO_ERROR_S_2D_RPC_SROT_FIFO_OVERFLOW_1, 0, 0, q2a_hard_reset,
                              q2a_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_SPB_FIFO_ERROR_S_2D_RPC_SROT_FIFO_UNDERFLOW_0, 0, 0, q2a_hard_reset,
                              q2a_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_SPB_FIFO_ERROR_S_2D_RPC_SROT_FIFO_UNDERFLOW_1, 0, 0, q2a_hard_reset,
                              q2a_none, "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, Q2A_INT_BDM_ECC_ECC_2B_ERR_INT, 0, 0, q2a_intr_ecc_2b_handler,
                              q2a_intr_ecc_2b_recurr, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_ILU_RX_HRF_BURST_MERGE_ERROR_INT_0, 0, 0, q2a_hard_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_ILU_RX_HRF_BURST_MERGE_ERROR_INT_1, 0, 0, q2a_hard_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_ILU_RX_HRF_BURST_MERGE_ERROR_INT_2, 0, 0, q2a_hard_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_ILU_RX_HRF_BURST_MERGE_ERROR_INT_3, 0, 0, q2a_hard_reset, q2a_none,
                              "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, Q2A_INT_ETPPB_BTC_POP_BEFORE_FIFO_READY, 0, 0, q2a_reprogram_resource, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_MTM_ING_ERR_MAX_REPLICATION, 0, 0, q2a_soft_init, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_MTM_ING_ERR_REPLICATION_EMPTY, 0, 0, q2a_none, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_MTM_EGR_ERR_MAX_REPLICATION, 0, 0, q2a_soft_init, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_MTM_EGR_ERR_REPLICATION_EMPTY, 0, 0, q2a_none, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_MTM_ING_BMP_DIRECT_ACCESS, 0, 0, q2a_soft_init, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_MTM_EGR_BMP_DIRECT_ACCESS, 0, 0, q2a_soft_init, q2a_none,
                              "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPPD_ILLEGAL_CONSTRUCTED_HEADER_SIZE, 0, 0, q2a_none, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPPD_INVALID_DESTINATION_VALID, 0, 0, q2a_none, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPPD_NIF_PHYSICAL_ERR, 0, 0, q2a_special_handling, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPPD_SEQ_RX_BIGER_SEQ_EXP_AND_SMALLER_SEQ_TX, 0, 0, q2a_special_handling,
                              NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPPD_SEQ_RX_SMALLER_SEQ_EXP_OR_BIGGER_EQ_SEQ_TX, 0, 0, q2a_special_handling,
                              NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPPD_FLP_FIFO_FULL, 0, 0, q2a_soft_reset, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPPD_FLP_LOOKUP_TIMEOUT, 0, 0, q2a_soft_reset, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPPD_NIF_RX_FIFO_OVF, 0, 0, q2a_soft_reset, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPPD_CPU_LOOKUP_REPLY_OVF, 0, 0, q2a_soft_reset, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPPD_BAD_CHANNEL_NUM, 0, 0, q2a_special_handling, NULL,
                              "check if SER on memories, either Jericho/OP2, or link. If so, action");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPPD_CPU_INFO_REPLY_OVF, 0, 0, q2a_soft_reset, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPPD_BAD_LKP_TYPE, 0, 0, q2a_reprogram_resource, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPPD_NIF_TX_FIFO_FULL, 0, 0, q2a_soft_reset, NULL, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPPD_RX_BROKEN_RECORD, 0, 0, q2a_special_handling, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPPD_CPU_INFO_REPLY_VALID, 0, 0, q2a_special_handling, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPPD_CPU_INFO_REPLY_ERR, 0, 0, q2a_special_handling, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPPD_CPU_LOOKUP_REPLY_VALID, 0, 0, q2a_special_handling, NULL,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPPD_CPU_LOOKUP_REPLY_ERR, 0, 0, q2a_special_handling, NULL,
                              "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, Q2A_INT_DDP_ERROR_UNPACK_PACKET_SIZE_ERROR, 0, 0, q2a_hard_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_DDP_ERROR_UNPACK_PACKET_SIZE_MISMATCH, 0, 0, q2a_hard_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_DDP_ERROR_UNPACK_BUNDLE_OVERFLOW_ERROR, 0, 0, q2a_hard_reset, q2a_none,
                              "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, Q2A_INT_MRPS_EGR_ENG_OOP_FIFO_NOT_EMPTY_EGR_ENG_1_OOP_FIFO_NOT_EMPTY_INT, 0, 0,
                              q2a_special_handling, q2a_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_ESB_EMPTY_BUFF_ALLOC_INT, 0, 0, q2a_special_handling, q2a_soft_init,
    ...
    dnxc_intr_add_handler_ext(unit, Q2A_INT_NMG_WRONG_EGQ_WORD_INT, 0, 0, q2a_hard_reset, q2a_none,
                              "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, Q2A_INT_ECI_UC_PLL_LOCKED_LOST, 0, 0, q2a_hard_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_ECI_CORE_PLL_LOCKED_LOST, 0, 0, q2a_hard_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_ECI_FAB_0_LOCKED_LOST, 0, 0, q2a_hard_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_ECI_FAB_1_LOCKED_LOST, 0, 0, q2a_hard_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_ECI_NIF_0_LOCKED_LOST, 0, 0, q2a_hard_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_ECI_NIF_1_LOCKED_LOST, 0, 0, q2a_hard_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_ECI_BS_PLL_LOCKED_LOST, 0, 0, q2a_hard_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_ECI_TS_PLL_LOCKED_LOST, 0, 0, q2a_hard_reset, q2a_none,
                              "Check Configuration");
    ...
    dnxc_intr_add_handler_ext(unit, Q2A_INT_DDP_ERROR_PACKET_OVERSIZE, 0, 0, q2a_none, q2a_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_DDP_ERROR_DRAM_BUNDLE_OVERSIZE, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_DDP_ERROR_SRAM_16B_CNT_OVRF, 0, 0, q2a_none, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_DDP_ERROR_OMAC_CNT_OVRF, 0, 0, q2a_none, q2a_none, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_DDP_ERROR_UNPACK_PACKET_SIZE_ERROR, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_DDP_ERROR_UNPACK_PACKET_SIZE_MISMATCH, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_DDP_ERROR_UNPACK_BUNDLE_OVERFLOW_ERROR, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_DDP_DELETE_BDB_FIFO_FULL, 0, 0, q2a_special_handling, q2a_none,
                              "Clear the deleted bdbs fifo by reading DeleteBdbFifoHead");
    ...
    dnxc_intr_add_handler_ext(unit, Q2A_INT_DDP_PKUP_RX_CFIF_UNDERFLOW, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_DDP_PKUP_RX_CFIF_OVERFLOW, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_DDP_PKP_OUT_FIF_OVERFLOW, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_DDP_BEC_PTR_FIFO_OVERFLOW, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_DDP_BEC_ENQ_FIFO_OVERFLOW, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_DDP_BEC_WAIT_FIFO_OVERFLOW, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_DDP_ECC_ECC_1B_ERR_INT, 0, 0, q2a_intr_ecc_1b_handler,
                              q2a_intr_ecc_1b_recurr, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_DDP_ECC_ECC_2B_ERR_INT, 0, 0, q2a_intr_ecc_2b_handler,
    ...
    dnxc_intr_add_handler_ext(unit, Q2A_INT_DDP_EXT_MEM_ERR_PKUP_CPYDAT_ECC_1B_ERR_INT, 0, 0, q2a_none, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_DDP_EXT_MEM_ERR_PKUP_CPYDAT_ECC_2B_ERR_INT, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_DDP_EXT_MEM_ERR_PKUP_CPYDAT_CRC_ERR_INT, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_DDP_EXT_MEM_ERR_PKUP_PACKET_CRC_ERR_INT, 0, 0, q2a_none, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_DDP_EXT_MEM_ERR_BTC_TDU_ERR_INT, 0, 0, q2a_none, q2a_none,
    ...
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_ECC_ECC_2B_ERR_INT, 0, 0, q2a_intr_ecc_2b_handler,
                              q2a_intr_ecc_2b_recurr, "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_RRF_OVERFLOW_0, 0, 0, q2a_special_handling, q2a_none,
                              "Fix rrf size in rrf_cfg");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_RRF_OVERFLOW_1, 0, 0, q2a_special_handling, q2a_none,
                              "Fix rrf size in rrf_cfg");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_RRF_OVERFLOW_2, 0, 0, q2a_special_handling, q2a_none,
                              "Fix rrf size in rrf_cfg");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_RRF_UNDERFLOW_0, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_RRF_UNDERFLOW_1, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_RRF_UNDERFLOW_2, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_RRF_MISCONFIG_0, 0, 0, q2a_special_handling, q2a_none,
                              "fix rrf size in rrf_cfg");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_RRF_MISCONFIG_1, 0, 0, q2a_special_handling, q2a_none,
                              "fix rrf size in rrf_cfg");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_RRF_MISCONFIG_2, 0, 0, q2a_special_handling, q2a_none,
                              "fix rrf size in rrf_cfg");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_RRF_OVERSIZE, 0, 0, q2a_special_handling, q2a_none,
                              "Fix RRF size configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_RDF_CRDT_OVERFLOW_0, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_RDF_CRDT_OVERFLOW_1, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_RDF_CRDT_OVERFLOW_2, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_RDF_SRAM_OVERFLOW_0, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_RDF_SRAM_OVERFLOW_1, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_RDF_SRAM_OVERFLOW_2, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_RDF_SRAM_UNDERFLOW_0, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_RDF_SRAM_UNDERFLOW_1, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_RDF_SRAM_UNDERFLOW_2, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_RDF_SRAM_OVERSIZE, 0, 0, q2a_special_handling, q2a_none,
                              "Fix rdf size in rdf_cfg");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_DQCF_OVERFLOW, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_DQCF_UNDERFLOW, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_DQCF_OVERSIZE, 0, 0, q2a_special_handling, q2a_none,
                              "fix dqcf size in pdq_cfg");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_D_BLF_OVERFLOW, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_D_BLF_UNDERFLOW, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_PBF_OVERFLOW, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_PBF_UNDERFLOW, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_PBF_MISCONFIG, 0, 0, q2a_special_handling, q2a_none,
                              "fix pbf size");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_PBF_OVERSIZE, 0, 0, q2a_special_handling, q2a_none,
                              "Configuration error in Pdq_Cfg. Make sure size of each queue is correct");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_S_2D_DQCF_OVERFLOW, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_S_2D_DQCF_UNDERFLOW, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_S_2D_DQCF_OVERSIZE, 0, 0, q2a_special_handling, q2a_none,
                              "Fix Dqcf size in pdq_cfg");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_S_2D_D_BLF_OVERFLOW, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_S_2D_D_BLF_UNDERFLOW, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_S_2D_D_BLF_MISCONFIG, 0, 0, q2a_special_handling, q2a_none,
                              "fix dblf fifo size in pdq_cfg");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_S_2D_PBF_OVERFLOW, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_S_2D_PBF_UNDERFLOW, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_S_2D_PBF_MISCONFIG, 0, 0, q2a_special_handling, q2a_none,
                              "fix pbf size in pdq_cfg");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_ERROR_S_2D_PBF_OVERSIZE, 0, 0, q2a_special_handling, q2a_none,
                              "Configuration error in Pdq_Cfg. Make sure size of each queue is correct");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_COMP_CNT_UNDERFLOW, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_COMP_CNT_OVERFLOW, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_FIFO_SCS_UNDERFLOW, 0, 0, q2a_soft_reset, q2a_none,
                              "Check Configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_ITE_ERR_FTMH_PKT_SIZE_IS_NOT_STAMPPED, 0, 0, q2a_special_handling,
                              q2a_none,
                              "Configuration problem in ITPP is casuing packet size not to be stamped. Check and correct the ITPP configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_ITE_ERR_FTMH_IS_NOT_STAMPPED, 0, 0, q2a_special_handling, q2a_none,
                              "Configuration problem in ITPP is casuing unstamped FTMH. Check and correct the ITPP configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_ITE_ERR_BYTES_TO_ADD_ABOVE_MAX, 0, 0, q2a_special_handling, q2a_none,
                              "Configuration problem in ITPP is casuing wrong editing command to be sent to ITE. Check and correct the ITPP configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_ITE_ERR_BYTES_TO_REMOVE_ABOVE_PSIZE, 0, 0, q2a_special_handling,
                              q2a_none,
                              "Configuration problem in ITPP is casuing wrong editing command to be sent to ITE. Check and correct the ITPP configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_ITE_ERR_FTMH_PSIZE_MISMATCH, 0, 0, q2a_special_handling, q2a_none,
                              "Configuration problem in ITPP is casuing wrong packet size to be stamped in FTMH. Check and correct the ITPP configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_ITE_ERR_PSIZE_MISMATCH, 0, 0, q2a_special_handling, q2a_none,
                              "Configuration problem in ITPP is casuing wrong packet size to be stamped in FTMH. Check and correct the ITPP configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_ITE_ERR_EXPECTED_ITPP_DELTA_MISMATCH, 0, 0, q2a_special_handling,
                              q2a_none,
                              "Configuration problem in ITPP is casuing wrong editing which conflicts with the CGM calcualtion of the packet size after editing. Check and correct the ITPP configuration");
    dnxc_intr_add_handler_ext(unit, Q2A_INT_IPT_ITE_ERR_NEGATIVE_DELTA, 0, 0, q2a_special_handling, q2a_none,
                              "Configuration problem in ITPP is casuing wrong editing command to be sent to ITE. Check and correct the ITPP configuration");
