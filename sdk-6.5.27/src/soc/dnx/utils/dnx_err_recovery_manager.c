...
static inline uint8
dnx_err_recovery_are_init_prerequisites_met(
    int unit)
{
...
#define DNX_ERR_RECOVERY_EXIT_IF_INIT_PREREQUESITES_NOT_MET(_unit)           \
do{                                                                          \
    if (!dnx_err_recovery_are_init_prerequisites_met(_unit)) {               \
        SHR_EXIT();                                                          \
    }                                                                        \
}while(0)
    ...
    int unit)
{
    ...
    DNX_ERR_RECOVERY_COMMON_EXIT_IF_DISABLED(unit);
    ...
    int unit)
{
    ...
    DNX_ERR_RECOVERY_EXIT_IF_INIT_PREREQUESITES_NOT_MET(unit);
    ...
    const char *function_name)
{
    ...
    SHR_IF_ERR_EXIT(dnx_er_regress_affirm_er_macro_usage_legality(unit, dnx_er_db, function_name, TRUE));
...
dnx_err_recovery_are_prerequisites_met(
    ...
    dnx_er_db_t * dnx_er_db)
{
    return (dnx_err_recovery_are_init_prerequisites_met(unit) &&
    ...
    const char *func_name)
{
    ...
    if (!dnx_err_recovery_flag_is_on(unit, dnx_er_db, DNX_ROLLBACK_JOURNAL_TYPE_ROLLBACK,
                                     DNX_ERR_RECOVERY_COMMON_IS_ON_INITIALIZED))
    {
        return _SHR_E_NONE;
    }
    ...
    const char *function_name)
{
    ...
    SHR_IF_ERR_EXIT(dnx_er_regress_transaction_start(unit, dnx_er_db, is_top_level_transaction, function_name));
    ...
    const char *function_name)
{
    ...
    SHR_IF_ERR_EXIT(dnx_err_recovery_transaction_start_internal(unit, dnx_er_db, function_name));
    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(dnx_err_recovery_transaction_start_internal(unit, dnx_er_db, NULL));
