...
#define FIFODMA_ENTRY_SIZE_GET(unit, chan, entry_size) fifodma_entry_size_get(unit, chan, entry_size)

#else

#define FIFODMA_ENTRY_SIZE_GET(unit, chan, entry_size) dnx_fifodma_info.entry.entry_size.get(unit, chan, entry_size);
    ...
    uint32 *entry_size)
{
    ...
    FIFODMA_ENTRY_SIZE_GET(unit, chan, entry_size);
