    ...
    int unit)
{
    ...
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.IPPB_EXISTING_ARR_get(unit);
    ...
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.IPPB_EXISTING_INCOMING_STRENGTH_ARR_get(unit);
    ...
    {
        soc_reg_above_64_val_t data;
        int max_nof_entries = dnx_data_dnx2_arr.max_nof_entries.IPPB_INCOMING_ARR_get(unit);
    ...
    
    {
        ...
        for(index = 0; index < max_nof_entries; index++)
        {
            ...
            if(table->valid)
            {
                ...
                if (table->AGING_CONFIG_valid)
                {
                    soc_mem_field32_set(unit, IPPB_FLP_FWD_FORMAT_CONFIGURATION_TABLEm, data, AGING_CONFIGf, table->AGING_CONFIG);
                }
                if (table->DESTINATION_CONFIG_valid)
                {
                ...
                if (table->ENTRY_GROUPING_CONFIG_valid)
                {
                    soc_mem_field32_set(unit, IPPB_FLP_FWD_FORMAT_CONFIGURATION_TABLEm, data, ENTRY_GROUPING_CONFIGf, table->ENTRY_GROUPING_CONFIG);
                }
                if (table->DESTINATION_CONFIG_valid)
                {
                    soc_mem_field32_set(unit, IPPB_FLP_FWD_FORMAT_CONFIGURATION_TABLEm, data, DESTINATION_CONFIGf, table->DESTINATION_CONFIG);
                ...
                if (table->MAC_ENTRY_STRENGTH_CONFIG_valid)
                {
                    soc_mem_field32_set(unit, IPPB_FLP_FWD_FORMAT_CONFIGURATION_TABLEm, data, MAC_ENTRY_STRENGTH_CONFIGf, table->MAC_ENTRY_STRENGTH_CONFIG);
                }
                if (table->STAT_OBJ_CMD_CONFIG_valid)
                {
                ...
                if (table->UNKNOWN_ADDR_CONFIG_valid)
                {
                    soc_mem_field32_set(unit, IPPB_FLP_FWD_FORMAT_CONFIGURATION_TABLEm, data, UNKNOWN_ADDR_CONFIGf, table->UNKNOWN_ADDR_CONFIG);
                }
    ...
    
    {
        ...
        for(index = 0; index < max_nof_entries; index++)
        {
            ...
            if(table->valid)
            {
                ...
                if (table->OPAQUE_FIELD_CONFIG_valid)
                {
                    soc_mem_field32_set(unit, IPPB_FLP_RPF_FORMAT_CONFIGURATION_TABLEm, data, OPAQUE_FIELD_CONFIGf, table->OPAQUE_FIELD_CONFIG);
                }
                if (table->DEFAULT_CONFIG_valid)
                {
                    soc_mem_field32_set(unit, IPPB_FLP_RPF_FORMAT_CONFIGURATION_TABLEm, data, DEFAULT_CONFIGf, table->DEFAULT_CONFIG);
    ...
    
    {
        ...
        for(index = 0; index < max_nof_entries; index++)
        {
            ...
            if(table->valid)
            {
                ...
                if (table->RESEREVED_valid)
                {
                    soc_mem_field32_set(unit, IPPA_VTT_FORMAT_CONFIGURATION_TABLEm, data, RESEREVEDf, table->RESEREVED);
                }
    ...
    
    {
        ...
        for(index = 0; index < max_nof_entries; index++)
        {
            ...
            if(table->valid)
            {
                ...
                if (table->RESEREVED_valid)
                {
                    soc_mem_field32_set(unit, IPPF_VTT_FORMAT_CONFIGURATION_TABLEm, data, RESEREVEDf, table->RESEREVED);
                }
                if (table->SERVICE_TYPE_CONFIG_valid)
                {
...

    {
        ...
        soc_mem_field32_set(unit, ETPPC_ENC_1_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_0_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_ENC_1_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_1_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_ENC_1_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_2_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_ENC_1_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_3_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_ENC_1_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_4_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_ENC_1_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_5_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_ENC_1_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_6_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_ENC_1_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_7_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_ENC_1_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_8_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_ENC_1_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_9_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_ENC_1_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_10_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_ENC_1_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_11_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_ENC_1_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_12_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_ENC_1_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_13_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_ENC_1_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_14_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_ENC_1_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_15_get(unit));
...

    {
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_2_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_0_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_2_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_1_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_2_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_2_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_2_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_3_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_2_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_4_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_2_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_5_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_2_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_6_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_2_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_7_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_2_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_8_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_2_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_9_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_2_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_10_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_2_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_11_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_2_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_12_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_2_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_13_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_2_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_14_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_2_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_15_get(unit));
...

    {
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_3_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_0_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_3_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_1_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_3_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_2_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_3_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_3_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_3_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_4_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_3_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_5_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_3_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_6_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_3_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_7_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_3_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_8_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_3_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_9_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_3_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_10_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_3_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_11_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_3_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_12_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_3_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_13_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_3_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_14_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_3_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_15_get(unit));
...

    {
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_4_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_0_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_4_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_1_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_4_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_2_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_4_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_3_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_4_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_4_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_4_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_5_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_4_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_6_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_4_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_7_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_4_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_8_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_4_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_9_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_4_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_10_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_4_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_11_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_4_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_12_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_4_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_13_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_4_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_14_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_4_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_15_get(unit));
...

    {
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_5_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_0_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_5_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_1_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_5_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_2_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_5_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_3_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_5_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_4_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_5_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_5_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_5_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_6_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_5_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_7_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_5_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_8_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_5_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_9_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_5_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_10_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_5_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_11_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_5_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_12_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_5_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_13_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_5_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_14_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPB_ENC_5_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_15_get(unit));
...

    {
        ...
        soc_mem_field32_set(unit, ETPPC_FORWARDING_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_0_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_FORWARDING_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_1_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_FORWARDING_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_2_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_FORWARDING_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_3_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_FORWARDING_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_4_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_FORWARDING_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_5_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_FORWARDING_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_6_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_FORWARDING_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_7_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_FORWARDING_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_8_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_FORWARDING_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_9_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_FORWARDING_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_10_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_FORWARDING_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_11_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_FORWARDING_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_12_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_FORWARDING_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_13_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_FORWARDING_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_14_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_FORWARDING_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_15_get(unit));
...

    {
        ...
        soc_mem_field32_set(unit, ETPPA_PRP_EES_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_0_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPA_PRP_EES_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_1_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPA_PRP_EES_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_2_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPA_PRP_EES_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_3_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPA_PRP_EES_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_4_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPA_PRP_EES_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_5_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPA_PRP_EES_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_6_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPA_PRP_EES_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_7_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPA_PRP_EES_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_8_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPA_PRP_EES_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_9_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPA_PRP_EES_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_10_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPA_PRP_EES_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_11_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPA_PRP_EES_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_12_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPA_PRP_EES_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_13_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPA_PRP_EES_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_14_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPA_PRP_EES_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_15_get(unit));
...

    {
        ...
        soc_mem_field32_set(unit, ETPPC_TERM_ETPS_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_0_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_TERM_ETPS_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_1_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_TERM_ETPS_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_2_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_TERM_ETPS_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_3_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_TERM_ETPS_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_4_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_TERM_ETPS_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_5_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_TERM_ETPS_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_6_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_TERM_ETPS_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_7_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_TERM_ETPS_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_8_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_TERM_ETPS_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_9_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_TERM_ETPS_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_10_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_TERM_ETPS_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_11_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_TERM_ETPS_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_12_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_TERM_ETPS_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_13_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_TERM_ETPS_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_14_get(unit));
        ...
        soc_mem_field32_set(unit, ETPPC_TERM_ETPS_ARR_PREFIX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.ETPP_ETPS_FORMATS___prefix_15_get(unit));
...

    {
        ...
        soc_mem_field32_set(unit, IPPD_FEC_ARR_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FEC_ENTRY_FORMAT___prefix_0_get(unit));
        ...
        soc_mem_field32_set(unit, IPPD_FEC_ARR_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FEC_ENTRY_FORMAT___prefix_2_get(unit));
        ...
        soc_mem_field32_set(unit, IPPD_FEC_ARR_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FEC_ENTRY_FORMAT___prefix_3_get(unit));
        ...
        soc_mem_field32_set(unit, IPPD_FEC_ARR_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FEC_ENTRY_FORMAT___prefix_4_get(unit));
        ...
        soc_mem_field32_set(unit, IPPD_FEC_ARR_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FEC_ENTRY_FORMAT___prefix_5_get(unit));
...

    {
        ...
        soc_mem_field32_set(unit, IPPD_SUPER_ARR_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FEC_SUPER_ENTRY_FORMAT___prefix_0_get(unit));
...

    {
        ...
        soc_mem_field32_set(unit, IPPB_FLP_FWD_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FWD_STAGE_FORMATS___prefix_0_get(unit));
        ...
        soc_mem_field32_set(unit, IPPB_FLP_FWD_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FWD_STAGE_FORMATS___prefix_1_get(unit));
        ...
        soc_mem_field32_set(unit, IPPB_FLP_FWD_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FWD_STAGE_FORMATS___prefix_2_get(unit));
        ...
        soc_mem_field32_set(unit, IPPB_FLP_FWD_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FWD_STAGE_FORMATS___prefix_3_get(unit));
        ...
        soc_mem_field32_set(unit, IPPB_FLP_FWD_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FWD_STAGE_FORMATS___prefix_4_get(unit));
        ...
        soc_mem_field32_set(unit, IPPB_FLP_FWD_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FWD_STAGE_FORMATS___prefix_5_get(unit));
        ...
        soc_mem_field32_set(unit, IPPB_FLP_FWD_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FWD_STAGE_FORMATS___prefix_6_get(unit));
        ...
        soc_mem_field32_set(unit, IPPB_FLP_FWD_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FWD_STAGE_FORMATS___prefix_7_get(unit));
...

    {
        ...
        soc_mem_field32_set(unit, IPPB_FLP_RPF_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FWD_STAGE_FORMATS___prefix_0_get(unit));
        ...
        soc_mem_field32_set(unit, IPPB_FLP_RPF_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FWD_STAGE_FORMATS___prefix_1_get(unit));
        ...
        soc_mem_field32_set(unit, IPPB_FLP_RPF_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FWD_STAGE_FORMATS___prefix_2_get(unit));
        ...
        soc_mem_field32_set(unit, IPPB_FLP_RPF_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FWD_STAGE_FORMATS___prefix_3_get(unit));
        ...
        soc_mem_field32_set(unit, IPPB_FLP_RPF_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FWD_STAGE_FORMATS___prefix_4_get(unit));
        ...
        soc_mem_field32_set(unit, IPPB_FLP_RPF_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FWD_STAGE_FORMATS___prefix_5_get(unit));
        ...
        soc_mem_field32_set(unit, IPPB_FLP_RPF_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FWD_STAGE_FORMATS___prefix_6_get(unit));
        ...
        soc_mem_field32_set(unit, IPPB_FLP_RPF_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FWD_STAGE_FORMATS___prefix_7_get(unit));
...

    {
        ...
        soc_mem_field32_set(unit, IPPA_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_0_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_1_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_3_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_4_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_5_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_6_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_7_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_8_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_10_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_11_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_12_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_13_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_14_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_15_get(unit));
...

    {
        ...
        soc_mem_field32_set(unit, IPPF_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_0_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_1_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_3_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_4_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_5_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_6_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_7_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_8_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_10_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_11_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_12_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_13_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_14_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_15_get(unit));
...

    {
        ...
        soc_mem_field32_set(unit, IPPA_VSI_PREFIX_INDEX_TABLE_1m, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_VSI_FORMATS___prefix_0_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VSI_PREFIX_INDEX_TABLE_1m, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_VSI_FORMATS___prefix_1_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VSI_PREFIX_INDEX_TABLE_1m, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_VSI_FORMATS___prefix_2_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VSI_PREFIX_INDEX_TABLE_1m, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_VSI_FORMATS___prefix_3_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VSI_PREFIX_INDEX_TABLE_1m, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_VSI_FORMATS___prefix_4_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VSI_PREFIX_INDEX_TABLE_1m, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_VSI_FORMATS___prefix_5_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VSI_PREFIX_INDEX_TABLE_1m, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_VSI_FORMATS___prefix_6_get(unit));
        ...
        soc_mem_field32_set(unit, IPPA_VSI_PREFIX_INDEX_TABLE_1m, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_VSI_FORMATS___prefix_7_get(unit));
...

    {
        ...
        soc_mem_field32_set(unit, IPPF_VSI_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_VSI_FORMATS___prefix_0_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VSI_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_VSI_FORMATS___prefix_1_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VSI_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_VSI_FORMATS___prefix_2_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VSI_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_VSI_FORMATS___prefix_3_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VSI_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_VSI_FORMATS___prefix_4_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VSI_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_VSI_FORMATS___prefix_5_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VSI_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_VSI_FORMATS___prefix_6_get(unit));
        ...
        soc_mem_field32_set(unit, IPPF_VSI_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_VSI_FORMATS___prefix_7_get(unit));
