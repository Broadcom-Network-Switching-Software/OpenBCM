...
soc_reg_info_t soc_phy_gddr6_reg_list[] = {
    {
     ...
     SOC_RESET_VAL_DEC(0x00000000, 0x00000000) SOC_RESET_MASK_DEC(0x00000000, 0x00000000) - 1,
     -1,
     }
    ,
    {
...
const char *soc_phy_gddr6_reg_desc[] = {
    "IO configuration - AQ IOs",
    "LDO configuration",
    "Macro Reserved Register - Lower Macro",
    "Address max delay - Address/Command Bits of Lower Macro",
    "Address max delay - Control Bits of Lower Macro",
    "Macro reserved status - Lower Macro",
    "Macro Reserved Register - Upper Macro",
    "Address max delay - Address/Command Bits of Upper Macro",
    "Address max delay - Control Bits of Upper Macro",
    "Macro reserved status - Upper Macro",
    "CK pads configuration",
    "IO configuration - Common IOs",
    "LDO configuration - Common Macro",
    "Macro Reserved Register - Common Macro",
    "CK max delay",
    "ResCal initialization configuration",
    "ResCal operation configuration",
    "Macro reserved status - Common Macro",
    "ResCal status register",
    "Frequency Counter configuration",
    "Shift register configuration for inputs",
    "Read phase FIFO control",
    "Macro Reserved Register - Control",
    "Resets for PHY",
    "Core revision",
    "Shared Vref DAC configuration - AQ & Common macros",
    "Frequency Counter DCount",
    "Frequency Counter UCount",
    "Macro reserved status - Control",
    "Write phase FIFO control",
    "CDR EN/DN VDL load settings",
    "CDR operation configuration",
    "CDR EP/DP VDL load settings",
    "CDR timing configuration",
    "CDR tracking configuration",
    "CDR update configuration",
    "CDR VDL cap configuration",
    "IO configuration - Non-WCK IOs",
    "LDO R configuration per DQ macro",
    "LDO W configuration per DQ macro",
    "Macro Reserved Register - DQ Macro",
    "Read alignment control",
    "Read FSM control",
    "Read data max delay - RCKDN Bit",
    "Read data max delay - RCKDP Bit",
    "Read data max delay - RCKEN Bit",
    "Read data max delay - RCKEP Bit",
    "Read data max delay - RCKEP/RCKDP/RCKEN/RCKDN Bits",
    "Read data min delay - Bit 0",
    "Read data min delay - Bit 1",
    "Read data min delay - Bit 2",
    "Read data min delay - Bit 3",
    "Read data min delay - Bit 4",
    "Read data min delay - Bit 5",
    "Read data min delay - Bit 6",
    "Read data min delay - Bit 7",
    "Read data min delay - DBI_N Bit",
    "Read data min delay - EDC Bit",
    "CDR DN VDL statistics",
    "CDR DP VDL statistics",
    "CDR EN VDL statistics",
    "CDR EP VDL statistics",
    "CDR EN/DN VDL status",
    "CDR operation status",
    "CDR EP/DP VDL status",
    "CDR timing status",
    "Data valid generator error status",
    "Data valid generator error RCMDs 1-4 status",
    "Data valid generator error RCMDs 5-8 status",
    "Data valid generator error states status",
    "Data valid generator error valids status",
    "Data valid generator last RCMDs 1-4 status",
    "Data valid generator last RCMDs 5-8 status",
    "Data valid generator last states status",
    "Data valid generator last valids status",
    "FIFO pointers status",
    "Macro reserved status - DQ Macro",
    "Write leveling status",
    "Vref DAC configuration per DQ macro",
    "IO configuration - WCK IOs",
    "Write leveling configuration for reads",
    "Write data max delay - Non-WCK Bits",
    "Write data max delay - Non-WCK Bits - Shadow Register",
    "Write data max delay - WCK Bit",
    "Write data min delay - Bit 0",
    "Write data min delay - Bit 1",
    "Write data min delay - Bit 2",
    "Write data min delay - Bit 3",
    "Write data min delay - Bit 4",
    "Write data min delay - Bit 5",
    "Write data min delay - Bit 6",
    "Write data min delay - Bit 7",
    "Write data min delay - DBI_N Bit",
