    ...
    int unit)
{
    ...
    last_port = dnx_data_led.general.last_port_on_scan_chain_get(unit);
...
shr_error_e
soc_dnx_ecc_indication_on_sbus_set(
    int unit,
    int enable)
{
    CONST STATIC soc_reg_t special_clock_control_reg[] = {
        ARB_SPECIAL_CLOCK_CONTROLSr,
        BDM_SPECIAL_CLOCK_CONTROLSr,
        CDPM_SPECIAL_CLOCK_CONTROLSr,
        CFC_SPECIAL_CLOCK_CONTROLSr,
        CGM_SPECIAL_CLOCK_CONTROLSr,
        CRPS_SPECIAL_CLOCK_CONTROLSr,
        DDHA_SPECIAL_CLOCK_CONTROLSr,
        DDHB_SPECIAL_CLOCK_CONTROLSr,
        DDP_SPECIAL_CLOCK_CONTROLSr,
        DQM_SPECIAL_CLOCK_CONTROLSr,
        ECGM_SPECIAL_CLOCK_CONTROLSr,
        ECI_SPECIAL_CLOCK_CONTROLSr,
        EDB_SPECIAL_CLOCK_CONTROLSr,
        EPNI_SPECIAL_CLOCK_CONTROLSr,
        EPRE_SPECIAL_CLOCK_CONTROLSr,
        EPS_SPECIAL_CLOCK_CONTROLSr,
        ERPP_SPECIAL_CLOCK_CONTROLSr,
        ESB_SPECIAL_CLOCK_CONTROLSr,
        ETPPA_SPECIAL_CLOCK_CONTROLSr,
        ETPPB_SPECIAL_CLOCK_CONTROLSr,
        ETPPC_SPECIAL_CLOCK_CONTROLSr,
        EVNT_SPECIAL_CLOCK_CONTROLSr,
        FAWR_SPECIAL_CLOCK_CONTROLSr,
        FAWT_SPECIAL_CLOCK_CONTROLSr,
        FBSW_SPECIAL_CLOCK_CONTROLSr,
        FCR_SPECIAL_CLOCK_CONTROLSr,
        FCT_SPECIAL_CLOCK_CONTROLSr,
        FDA_SPECIAL_CLOCK_CONTROLSr,
        FDCRL_SPECIAL_CLOCK_CONTROLSr,
        FDCRS_SPECIAL_CLOCK_CONTROLSr,
        FDMP_SPECIAL_CLOCK_CONTROLSr,
        FDMXA_SPECIAL_CLOCK_CONTROLSr,
        FDMXBI_SPECIAL_CLOCK_CONTROLSr,
        FDMXBJ_SPECIAL_CLOCK_CONTROLSr,
        FDMXC_SPECIAL_CLOCK_CONTROLSr,
        FDMXT_SPECIAL_CLOCK_CONTROLSr,
        FDMX_SPECIAL_CLOCK_CONTROLSr,
        FDR_SPECIAL_CLOCK_CONTROLSr,
        FDTL_SPECIAL_CLOCK_CONTROLSr,
        FDT_SPECIAL_CLOCK_CONTROLSr,
        FECPB_SPECIAL_CLOCK_CONTROLSr,
        FECRL_SPECIAL_CLOCK_CONTROLSr,
        FECRS_SPECIAL_CLOCK_CONTROLSr,
        FFLXO_SPECIAL_CLOCK_CONTROLSr,
        FFOA_SPECIAL_CLOCK_CONTROLSr,
        FFOB_SPECIAL_CLOCK_CONTROLSr,
        FGDMP_SPECIAL_CLOCK_CONTROLSr,
        FGMAP_SPECIAL_CLOCK_CONTROLSr,
        FICPB_SPECIAL_CLOCK_CONTROLSr,
        FLEXMAC_SPECIAL_CLOCK_CONTROLSr,
        FLFR_SPECIAL_CLOCK_CONTROLSr,
        FLFT_SPECIAL_CLOCK_CONTROLSr,
        FLOTN_SPECIAL_CLOCK_CONTROLSr,
        FMACR_SPECIAL_CLOCK_CONTROLSr,
        FMACT_SPECIAL_CLOCK_CONTROLSr,
        FMAC_SPECIAL_CLOCK_CONTROLSr,
        FMAP_SPECIAL_CLOCK_CONTROLSr,
        FMXAI_SPECIAL_CLOCK_CONTROLSr,
        FMXAJ_SPECIAL_CLOCK_CONTROLSr,
        FMXBI_SPECIAL_CLOCK_CONTROLSr,
        FMXBJ_SPECIAL_CLOCK_CONTROLSr,
        FMXBK_SPECIAL_CLOCK_CONTROLSr,
        FMXC_SPECIAL_CLOCK_CONTROLSr,
        FMXT_SPECIAL_CLOCK_CONTROLSr,
        FMX_SPECIAL_CLOCK_CONTROLSr,
        FOAM_SPECIAL_CLOCK_CONTROLSr,
        FODUO_SPECIAL_CLOCK_CONTROLSr,
        FOSW_SPECIAL_CLOCK_CONTROLSr,
        FPMR_SPECIAL_CLOCK_CONTROLSr,
        FPMT_SPECIAL_CLOCK_CONTROLSr,
        FPTPR_SPECIAL_CLOCK_CONTROLSr,
        FPTPT_SPECIAL_CLOCK_CONTROLSr,
        FQP_SPECIAL_CLOCK_CONTROLSr,
        FRA_SPECIAL_CLOCK_CONTROLSr,
        FRWA_SPECIAL_CLOCK_CONTROLSr,
        FRWBC_SPECIAL_CLOCK_CONTROLSr,
        FSAR_SPECIAL_CLOCK_CONTROLSr,
        FSRD_SPECIAL_CLOCK_CONTROLSr,
        HBC_SPECIAL_CLOCK_CONTROLSr,
        HBMC_SPECIAL_CLOCK_CONTROLSr,
        ILE_SPECIAL_CLOCK_CONTROLSr,
        ILU_SPECIAL_CLOCK_CONTROLSr,
        IPPA_SPECIAL_CLOCK_CONTROLSr,
        IPPB_SPECIAL_CLOCK_CONTROLSr,
        IPPC_SPECIAL_CLOCK_CONTROLSr,
        IPPD_SPECIAL_CLOCK_CONTROLSr,
        IPPE_SPECIAL_CLOCK_CONTROLSr,
        IPPF_SPECIAL_CLOCK_CONTROLSr,
        IPS_SPECIAL_CLOCK_CONTROLSr,
        IPT_SPECIAL_CLOCK_CONTROLSr,
        IQM_SPECIAL_CLOCK_CONTROLSr,
        IRE_SPECIAL_CLOCK_CONTROLSr,
        ITPPD_SPECIAL_CLOCK_CONTROLSr,
        ITPP_SPECIAL_CLOCK_CONTROLSr,
        KAPS_SPECIAL_CLOCK_CONTROLSr,
        MACT_SPECIAL_CLOCK_CONTROLSr,
        MCP_SPECIAL_CLOCK_CONTROLSr,
        MDB_SPECIAL_CLOCK_CONTROLSr,
        MESH_TOPOLOGY_SPECIAL_CLOCK_CONTROLSr,
        MRPS_SPECIAL_CLOCK_CONTROLSr,
        MSW_SPECIAL_CLOCK_CONTROLSr,
        MTM_SPECIAL_CLOCK_CONTROLSr,
        OAMP_SPECIAL_CLOCK_CONTROLSr,
        OCBM_SPECIAL_CLOCK_CONTROLSr,
        OCB_SPECIAL_CLOCK_CONTROLSr,
        OFR_SPECIAL_CLOCK_CONTROLSr,
        OFT_SPECIAL_CLOCK_CONTROLSr,
        OLP_SPECIAL_CLOCK_CONTROLSr,
        PDM_SPECIAL_CLOCK_CONTROLSr,
        PEM_SPECIAL_CLOCK_CONTROLSr,
        PQP_SPECIAL_CLOCK_CONTROLSr,
        RQP_SPECIAL_CLOCK_CONTROLSr,
        RTP_SPECIAL_CLOCK_CONTROLSr,
        SCH_SPECIAL_CLOCK_CONTROLSr,
        SIF_SPECIAL_CLOCK_CONTROLSr,
        SPB_SPECIAL_CLOCK_CONTROLSr,
        SQM_SPECIAL_CLOCK_CONTROLSr,
        TCAM_SPECIAL_CLOCK_CONTROLSr,
        TDU_SPECIAL_CLOCK_CONTROLSr,
        TSN_SPECIAL_CLOCK_CONTROLSr,
        W40_SPECIAL_CLOCK_CONTROLSr,
        WB_SPECIAL_CLOCK_CONTROLSr
    };
    int i;
    int instance = 0, nof_instances, first_blk_instance;
    uint32 reg32, fld_val;
    SHR_FUNC_INIT_VARS(unit);
    ...
    for (i = 0; i < sizeof(special_clock_control_reg) / sizeof(special_clock_control_reg[0]); i++)
    {
        nof_instances = SOC_REG_BLOCK_NOF_INSTANCES(unit, special_clock_control_reg[i]);
        first_blk_instance = SOC_REG_BLOCK_FIRST_INSTANCES(unit, special_clock_control_reg[i]);
        for (instance = 0; instance < nof_instances; instance++)
        {
            if (SOC_INFO(unit).block_valid[first_blk_instance + instance] == 0)
            {
                continue;
            }

            SHR_IF_ERR_EXIT(soc_reg32_get(unit, special_clock_control_reg[i], instance, 0, &reg32));

            soc_reg_field_set(unit, special_clock_control_reg[i], &reg32, DISABLE_ECC_INDICATION_ON_SBUSf, fld_val);

            SHR_IF_ERR_EXIT(soc_reg32_set(unit, special_clock_control_reg[i], instance, 0, reg32));
        }
    }
    ...
    int unit)
{
    ...
    uint64 reg64 = 0;
    uint32 nof_block_inst, block_inst, first_instance, inst_id;
    soc_reg_t r;
    unsigned j;
    ...
    CONST STATIC soc_reg_t j2x_dnx_indirect_command_regs[] = {
        ARB_INDIRECT_COMMANDr,
        BDM_INDIRECT_COMMANDr,
        CFC_INDIRECT_COMMANDr,
        CGM_INDIRECT_COMMANDr,
        CRPS_INDIRECT_COMMANDr,
        DDHA_INDIRECT_COMMANDr,
        DDHB_INDIRECT_COMMANDr,
        DDP_INDIRECT_COMMANDr,
        DQM_INDIRECT_COMMANDr,
        ECGM_INDIRECT_COMMANDr,
        ECI_INDIRECT_COMMANDr,
        EDB_INDIRECT_COMMANDr,
        EPNI_INDIRECT_COMMANDr,
        EPRE_INDIRECT_COMMANDr,
        EPS_INDIRECT_COMMANDr,
        ERPP_INDIRECT_COMMANDr,
        ESB_INDIRECT_COMMANDr,
        ETPPA_INDIRECT_COMMANDr,
        ETPPB_INDIRECT_COMMANDr,
        ETPPC_INDIRECT_COMMANDr,
        EVNT_INDIRECT_COMMANDr,
        FAWR_INDIRECT_COMMANDr,
        FAWT_INDIRECT_COMMANDr,
        FBSW_INDIRECT_COMMANDr,
        FCR_INDIRECT_COMMANDr,
        FCT_INDIRECT_COMMANDr,
        FDCRL_INDIRECT_COMMANDr,
        FDCRS_INDIRECT_COMMANDr,
        FDMP_INDIRECT_COMMANDr,
        FDMX_INDIRECT_COMMANDr,
        FDMXA_INDIRECT_COMMANDr,
        FDMXBI_INDIRECT_COMMANDr,
        FDMXBJ_INDIRECT_COMMANDr,
        FDMXC_INDIRECT_COMMANDr,
        FDMXT_INDIRECT_COMMANDr,
        FDT_INDIRECT_COMMANDr,
        FECPB_INDIRECT_COMMANDr,
        FECRL_INDIRECT_COMMANDr,
        FECRS_INDIRECT_COMMANDr,
        FFLXO_INDIRECT_COMMANDr,
        FFOA_INDIRECT_COMMANDr,
        FFOB_INDIRECT_COMMANDr,
        FGDMP_INDIRECT_COMMANDr,
        FGMAP_INDIRECT_COMMANDr,
        FICPB_INDIRECT_COMMANDr,
        FLEXMAC_INDIRECT_COMMANDr,
        FLFR_INDIRECT_COMMANDr,
        FLFT_INDIRECT_COMMANDr,
        FLOTN_INDIRECT_COMMANDr,
        FMACR_INDIRECT_COMMANDr,
        FMACT_INDIRECT_COMMANDr,
        FMAP_INDIRECT_COMMANDr,
        FMX_INDIRECT_COMMANDr,
        FMXAI_INDIRECT_COMMANDr,
        FMXAJ_INDIRECT_COMMANDr,
        FMXBI_INDIRECT_COMMANDr,
        FMXBJ_INDIRECT_COMMANDr,
        FMXBK_INDIRECT_COMMANDr,
        FMXC_INDIRECT_COMMANDr,
        FMXT_INDIRECT_COMMANDr,
        FOAM_INDIRECT_COMMANDr,
        FODUO_INDIRECT_COMMANDr,
        FOSW_INDIRECT_COMMANDr,
        FPMR_INDIRECT_COMMANDr,
        FPMT_INDIRECT_COMMANDr,
        FPTPR_INDIRECT_COMMANDr,
        FPTPT_INDIRECT_COMMANDr,
        FQP_INDIRECT_COMMANDr,
        FRA_INDIRECT_COMMANDr,
        FSAR_INDIRECT_COMMANDr,
        FSRD_INDIRECT_COMMANDr,
        HBC_INDIRECT_COMMANDr,
        HBMC_INDIRECT_COMMANDr,
        ILE_INDIRECT_COMMANDr,
        ILU_INDIRECT_COMMANDr,
        IPPA_INDIRECT_COMMANDr,
        IPPB_INDIRECT_COMMANDr,
        IPPC_INDIRECT_COMMANDr,
        IPPD_INDIRECT_COMMANDr,
        IPPE_INDIRECT_COMMANDr,
        IPPF_INDIRECT_COMMANDr,
        IPS_INDIRECT_COMMANDr,
        IPT_INDIRECT_COMMANDr,
        IQM_INDIRECT_COMMANDr,
        IRE_INDIRECT_COMMANDr,
        ITPP_INDIRECT_COMMANDr,
        ITPPD_INDIRECT_COMMANDr,
        KAPS_INDIRECT_COMMANDr,
        MACT_INDIRECT_COMMANDr,
        MCP_INDIRECT_COMMANDr,
        MDB_INDIRECT_COMMANDr,
        MRPS_INDIRECT_COMMANDr,
        MSW_INDIRECT_COMMANDr,
        MTM_INDIRECT_COMMANDr,
        OAMP_INDIRECT_COMMANDr,
        OCBM_INDIRECT_COMMANDr,
        OFR_INDIRECT_COMMANDr,
        OFT_INDIRECT_COMMANDr,
        OLP_INDIRECT_COMMANDr,
        PDM_INDIRECT_COMMANDr,
        PEM_INDIRECT_COMMANDr,
        PQP_INDIRECT_COMMANDr,
        RQP_INDIRECT_COMMANDr,
        RTP_INDIRECT_COMMANDr,
        SCH_INDIRECT_COMMANDr,
        SIF_INDIRECT_COMMANDr,
        SPB_INDIRECT_COMMANDr,
        SQM_INDIRECT_COMMANDr,
        TCAM_INDIRECT_COMMANDr,
        TSN_INDIRECT_COMMANDr,
        WB_INDIRECT_COMMANDr
    };
    ...
    if (SOC_IS_J2X(unit))
    {
        ...
        SHR_IF_ERR_EXIT(sand_indirect_command_reg_get(unit, ECI_INDIRECT_COMMANDr, &reg64));
        soc_reg64_field32_set(unit, ECI_INDIRECT_COMMANDr, &reg64, INDIRECT_COMMAND_TIMEOUTf,
                              SOC_CONTROL(unit)->bistTimeout);

        for (j = 0; j < (sizeof(j2x_dnx_indirect_command_regs) / sizeof(j2x_dnx_indirect_command_regs[0])); j++)
        {
            r = j2x_dnx_indirect_command_regs[j];

            nof_block_inst = SOC_REG_BLOCK_NOF_INSTANCES(unit, r);
            first_instance = SOC_REG_BLOCK_FIRST_INSTANCES(unit, r);

            for (block_inst = 0; block_inst < nof_block_inst; block_inst++)
            {
                inst_id = first_instance + block_inst;
                if (SOC_INFO(unit).block_valid[inst_id])
                {

                    SHR_IF_ERR_EXIT(sand_indirect_command_reg_set(unit, inst_id, reg64));
                }
            }
        }
    }
    ...
    SHR_IF_ERR_EXIT(soc_dnx_ecc_indication_on_sbus_set(unit, 0));
    ...
    int unit)
{
    ...
    DNXCMN_CORES_ITER(unit, BCM_CORE_ALL, core)
    {
        SHR_IF_ERR_EXIT(dnx_sch_dbal_low_rate_flow_range_get
                        (unit, core, 0, &flow_range_start, &flow_range_end, &pattern));
        if (pattern != 0)
        {
            enabled[core] = TRUE;
    ...
    int without_ile)
{
    ...
    uint32 flexe_pcs_ports[DNX_DATA_MAX_NIF_ETH_CDU_NOF] = { 0 };
    uint32 active_flexe_pms[1] = { 0 };
    int is_port_enable;
    bcm_port_t ilkn_port, ilkn_core, eth_port;
    bcm_pbmp_t all_ilkn_ports, all_ilkn_cores, all_eth_ports;
    ...
    if (SOC_IS_J2X(unit) && dnxc_init_is_init_done_get(unit))
    {
        BCM_PBMP_CLEAR(all_eth_ports);
    ...
    if (SOC_IS_J2X(unit) && dnxc_init_is_init_done_get(unit))
    {
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FRWAf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FAWRf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FAWTf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FBSWf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FDCRLf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FDCRSf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FDMPf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FDMXAf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FDMXBIf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FDMXBJf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FDMXCf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FDMXTf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FDMX_0f, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FDMX_1f, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FECPBf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FECRLf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FECRSf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FFLXOf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FFOAf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FFOBf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FGDMPf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FGMAPf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FICPBf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FLFR_0f, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FLFR_1f, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FLFR_2f, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FLFR_3f, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FLFT_0f, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FLFT_1f, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FLOTNf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FMACRf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FMACTf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FMAPf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FMXAIf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FMXAJf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FMXBIf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FMXBJf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FMXBKf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FMXCf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FMXTf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FMX_0f, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FMX_1f, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FOAM_0f, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FOAM_1f, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FODUO_0f, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FODUO_1f, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FOSWf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FPMRf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FPMTf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FPTPRf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FPTPTf, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FRA_0f, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FRA_1f, 0);
        soc_reg_above_64_field32_set(unit, ECI_BLOCKS_SOFT_INITr, reg_above_64_val, BLOCKS_SOFT_INIT_FSARf, 0);
    }
                        ...
                        BCM_PBMP_ITER(pm_pmbp, phy_id)
                        {
                            ...
                            if (is_active)
                            {
                                ...
                                if (DNX_ALGO_PORT_TYPE_IS_NIF_ETH(unit, active_port_info,
                                                                  DNX_ALGO_PORT_TYPE_INCLUDE(STIF, L1, MGMT, FEEDBACK)))
                                {
    ...
    if (SOC_IS_J2X(unit) && dnxc_init_is_init_done_get(unit))
    {
        bcm_port_t framer_port;
        int nof_phys, pm_id;
        _shr_pbmp_t framer_ports, framer_mac_ports;
        portmod_access_get_params_t params;
        phymod_phy_access_t phy_access[SOC_DNXC_PORT_MAX_CORE_ACCESS_PER_PORT];
        dnx_algo_port_ethu_access_info_t ethu_access;
        soc_reg_above_64_val_t enc_dec_reg_val;

        SHR_IF_ERR_EXIT(dnx_algo_port_logicals_get
                        (unit, BCM_CORE_ALL, DNX_ALGO_PORT_LOGICALS_TYPE_FRAMER_PHY, 0, &framer_ports));

        if (_SHR_PBMP_NOT_NULL(framer_ports))
        {

            _SHR_PBMP_ITER(framer_ports, framer_port)
            {

                SHR_IF_ERR_EXIT(portmod_access_get_params_t_init(unit, &params));
                params.phyn = 0;
                SHR_IF_ERR_EXIT(portmod_port_phy_lane_access_get
                                (unit, framer_port, &params, 1, phy_access, &nof_phys, NULL));
                SHR_IF_ERR_EXIT(phymod_phy_pcs_enable_set(phy_access, 0));

                SHR_IF_ERR_EXIT(dnx_algo_port_ethu_access_info_get(unit, framer_port, &ethu_access));
                SHR_BITSET(&flexe_pcs_ports[ethu_access.ethu_id], ethu_access.first_lane_in_port);
                SHR_BITSET(active_flexe_pms, ethu_access.ethu_id);
            }
            SHR_BIT_ITER(active_flexe_pms, dnx_data_nif.eth.cdu_nof_get(unit), pm_id)
            {

                SHR_IF_ERR_EXIT(soc_reg32_set(unit, FRWA_W_66_TX_PM_CONFIGr, REG_PORT_ANY, pm_id, 0));
                SHR_IF_ERR_EXIT(soc_reg_above_64_field32_modify
                                (unit, FRWA_W_66_PM_TSC_PORT_CFGr, REG_PORT_ANY, pm_id, PM_N_TSC_PORT_ENABLEDf, 0));
            }
        }

        SHR_IF_ERR_EXIT(dnx_algo_port_logicals_get
                        (unit, BCM_CORE_ALL, DNX_ALGO_PORT_LOGICALS_TYPE_FRAMER_MAC, 0, &framer_mac_ports));
        if (_SHR_PBMP_NOT_NULL(framer_mac_ports))
        {

            SHR_IF_ERR_EXIT(soc_reg32_get(unit, FRWBC_WBC_ASYNCFIFO_CONFIGr, REG_PORT_ANY, 0, &reg_val));
            soc_reg_field_set(unit, FRWBC_WBC_ASYNCFIFO_CONFIGr, &reg_val, WB_RX_ASYNC_FIFO_RSTBf, 0);
            soc_reg_field_set(unit, FRWBC_WBC_ASYNCFIFO_CONFIGr, &reg_val, WB_TX_ASYNC_FIFO_RSTBf, 0);
            soc_reg_field_set(unit, FRWBC_WBC_ASYNCFIFO_CONFIGr, &reg_val, WB_TX_CRDT_ASYNC_FIFO_RSTBf, 0);
            SHR_IF_ERR_EXIT(soc_reg32_set(unit, FRWBC_WBC_ASYNCFIFO_CONFIGr, REG_PORT_ANY, 0, reg_val));

            SOC_REG_ABOVE_64_CLEAR(field_above_64_val);
            SHR_IF_ERR_EXIT(soc_reg_above_64_set(unit, FRWBC_WB_TX_CLIENT_RSTr, REG_PORT_ANY, 0, field_above_64_val));
            SHR_IF_ERR_EXIT(soc_reg_above_64_set(unit, WB_WB_RX_CLIENT_RSTr, REG_PORT_ANY, 0, field_above_64_val));

            SHR_IF_ERR_EXIT(soc_reg_above_64_get(unit, WB_CL_49_CL_82_DEC_CONFIG_3r, REG_PORT_ANY, 0, enc_dec_reg_val));
            soc_reg_above_64_field_set(unit, WB_CL_49_CL_82_DEC_CONFIG_3r, enc_dec_reg_val, I_DEC_CLIENT_RSTBf,
                                       field_above_64_val);
            soc_reg_above_64_field_set(unit, WB_CL_49_CL_82_DEC_CONFIG_3r, enc_dec_reg_val, I_DP_RSTBf,
                                       field_above_64_val);
            SHR_IF_ERR_EXIT(soc_reg_above_64_set(unit, WB_CL_49_CL_82_DEC_CONFIG_3r, REG_PORT_ANY, 0, enc_dec_reg_val));

            SHR_IF_ERR_EXIT(soc_reg_above_64_get(unit, WB_CL_49_CL_82_ENC_CONFIG_2r, REG_PORT_ANY, 0, enc_dec_reg_val));
            soc_reg_above_64_field_set(unit, WB_CL_49_CL_82_ENC_CONFIG_2r, enc_dec_reg_val, I_ENC_DP_RSTBf,
                                       field_above_64_val);
            soc_reg_above_64_field_set(unit, WB_CL_49_CL_82_ENC_CONFIG_2r, enc_dec_reg_val, I_ENC_CLIENT_RSTBf,
                                       field_above_64_val);
            SHR_IF_ERR_EXIT(soc_reg_above_64_set(unit, WB_CL_49_CL_82_ENC_CONFIG_2r, REG_PORT_ANY, 0, enc_dec_reg_val));
        }

        if (dnx_data_nif.framer.feature_get(unit, dnx_data_nif_framer_is_supported))
        {
            SHR_IF_ERR_EXIT(flexe_core_soft_reset(unit, 1));
        }
    }
...
/* *INDENT-OFF* */
    ...
    if (SOC_IS_J2X(unit) && dnxc_init_is_init_done_get(unit))
    {
        BCM_PBMP_ITER(all_eth_ports, eth_port)
        {
            SHR_IF_ERR_EXIT(dnx_esb_port_txi_config_set(unit, eth_port, TRUE));
        }
    }
    ...
    {
        bcm_port_t framer_port;
        int nof_phys, pm_id, flexe_channel;
        _shr_pbmp_t framer_ports, framer_mac_ports;
        portmod_access_get_params_t params;
        phymod_phy_access_t phy_access[SOC_DNXC_PORT_MAX_CORE_ACCESS_PER_PORT];
        soc_reg_above_64_val_t framer_mac_channels;
        soc_reg_above_64_val_t enc_dec_reg_val;
        
        if (dnx_data_nif.framer.feature_get(unit, dnx_data_nif_framer_is_supported))
        {
            SHR_IF_ERR_EXIT(flexe_core_soft_reset(unit, 0));
        }
        SHR_IF_ERR_EXIT(dnx_algo_port_logicals_get
                        (unit, BCM_CORE_ALL, DNX_ALGO_PORT_LOGICALS_TYPE_FRAMER_PHY, 0, &framer_ports));
        if (_SHR_PBMP_NOT_NULL(framer_ports))
        {
            ...
            {
                reg_val =
                    ((flexe_pcs_ports[pm_id] << dnx_data_nif.
                      eth.nof_cdu_lanes_in_pm_get(unit)) | flexe_pcs_ports[pm_id]);
                SHR_IF_ERR_EXIT(soc_reg32_set(unit, FRWA_W_66_TX_PM_CONFIGr, REG_PORT_ANY, pm_id, reg_val));
                SHR_IF_ERR_EXIT(soc_reg_above_64_field32_modify
                                (unit, FRWA_W_66_PM_TSC_PORT_CFGr, REG_PORT_ANY, pm_id, PM_N_TSC_PORT_ENABLEDf,
                                 flexe_pcs_ports[pm_id]));
            }
            ...
            _SHR_PBMP_ITER(framer_ports, framer_port)
            {
                ...
                SHR_IF_ERR_EXIT(portmod_port_phy_lane_access_get
                                (unit, framer_port, &params, 1, phy_access, &nof_phys, NULL));
                SHR_IF_ERR_EXIT(phymod_phy_pcs_enable_set(phy_access, 1));
            }
        }
        ...
        if (_SHR_PBMP_NOT_NULL(framer_mac_ports))
        {
            SOC_REG_ABOVE_64_CLEAR(framer_mac_channels);
            _SHR_PBMP_ITER(framer_mac_ports, framer_port)
            {
                SHR_IF_ERR_EXIT(dnx_algo_port_flexe_channel_get(unit, framer_port, &flexe_channel));
                SHR_BITSET(framer_mac_channels, flexe_channel);
            }
            
            _SHR_PBMP_FIRST(framer_mac_ports, framer_port);
            SHR_IF_ERR_EXIT(imb_calendar_set(unit, framer_port, (IMB_FLEXE_DIRECTION_RX | IMB_FLEXE_DIRECTION_TX)));
            
            SHR_IF_ERR_EXIT(soc_reg32_get(unit, FRWBC_WBC_ASYNCFIFO_CONFIGr, REG_PORT_ANY, 0, &reg_val));
            soc_reg_field_set(unit, FRWBC_WBC_ASYNCFIFO_CONFIGr, &reg_val, WB_RX_ASYNC_FIFO_RSTBf, 1);
            soc_reg_field_set(unit, FRWBC_WBC_ASYNCFIFO_CONFIGr, &reg_val, WB_TX_ASYNC_FIFO_RSTBf, 1);
            soc_reg_field_set(unit, FRWBC_WBC_ASYNCFIFO_CONFIGr, &reg_val, WB_TX_CRDT_ASYNC_FIFO_RSTBf, 1);
            SHR_IF_ERR_EXIT(soc_reg32_set(unit, FRWBC_WBC_ASYNCFIFO_CONFIGr, REG_PORT_ANY, 0, reg_val));
            
            reg_val = 0;
            soc_reg_field_set(unit, FRWBC_WB_TX_CLIENT_FIFO_CONFIGr, &reg_val, WB_TX_CLIENT_FIFO_CONFIG_FORCEf, 1);
            SHR_IF_ERR_EXIT(soc_reg32_set(unit, FRWBC_WB_TX_CLIENT_FIFO_CONFIGr, REG_PORT_ANY, 0, reg_val));
            reg_val = 0;
            SHR_IF_ERR_EXIT(soc_reg32_set(unit, FRWBC_WB_TX_CLIENT_FIFO_CONFIGr, REG_PORT_ANY, 0, reg_val));

            soc_reg_field_set(unit, WB_WB_RX_CLIENT_FIFO_CONFIGr, &reg_val, WB_RX_CLIENT_FIFO_CONFIG_FORCEf, 1);
            SHR_IF_ERR_EXIT(soc_reg32_set(unit, WB_WB_RX_CLIENT_FIFO_CONFIGr, REG_PORT_ANY, 0, reg_val));
            reg_val = 0;
            SHR_IF_ERR_EXIT(soc_reg32_set(unit, WB_WB_RX_CLIENT_FIFO_CONFIGr, REG_PORT_ANY, 0, reg_val));
            ...
            soc_reg_above_64_field_set(unit, WB_CL_49_CL_82_DEC_CONFIG_3r, enc_dec_reg_val, I_DEC_CLIENT_RSTBf,
                                       framer_mac_channels);
            soc_reg_above_64_field32_set(unit, WB_CL_49_CL_82_DEC_CONFIG_3r, enc_dec_reg_val, I_DP_RSTBf, 1);
            SHR_IF_ERR_EXIT(soc_reg_above_64_set(unit, WB_CL_49_CL_82_DEC_CONFIG_3r, REG_PORT_ANY, 0, enc_dec_reg_val));

            SHR_IF_ERR_EXIT(soc_reg_above_64_get(unit, WB_CL_49_CL_82_ENC_CONFIG_2r, REG_PORT_ANY, 0, enc_dec_reg_val));
            soc_reg_above_64_field32_set(unit, WB_CL_49_CL_82_ENC_CONFIG_2r, enc_dec_reg_val, I_ENC_DP_RSTBf, 1);
            soc_reg_above_64_field_set(unit, WB_CL_49_CL_82_ENC_CONFIG_2r, enc_dec_reg_val, I_ENC_CLIENT_RSTBf,
                                       framer_mac_channels);
            SHR_IF_ERR_EXIT(soc_reg_above_64_set(unit, WB_CL_49_CL_82_ENC_CONFIG_2r, REG_PORT_ANY, 0, enc_dec_reg_val));
            
            SHR_IF_ERR_EXIT(soc_reg_above_64_set(unit, FRWBC_WB_TX_CLIENT_RSTr, REG_PORT_ANY, 0, framer_mac_channels));
            SHR_IF_ERR_EXIT(soc_reg_above_64_set(unit, WB_WB_RX_CLIENT_RSTr, REG_PORT_ANY, 0, framer_mac_channels));
        }
    }
    ...
    int unit)
{
    ...
    if (!SOC_WARM_BOOT(unit))
    {
             ...
             mbist_soc_prop_enable) && !SAL_BOOT_PLISIM)
        {
            ...
            int deinit_steps[] =
                { DNX_INIT_STEP_DMA, DNX_INIT_STEP_SBUS, DNX_INIT_STEP_INTERRUPT, DNX_INIT_STEP_PRE_PLL,
                DNX_INIT_STEP_POST_PLL
            };
            int init_steps[] =
                { DNX_INIT_STEP_IPROC, DNX_INIT_STEP_HARD_RESET, DNX_INIT_STEP_SBUS, DNX_INIT_STEP_INTERRUPT,
                DNX_INIT_STEP_PRE_PLL,
                DNX_INIT_STEP_SOFT_RESET,
                DNX_INIT_STEP_DMA, DNX_INIT_STEP_POST_PLL,
            ...
            do
            {
                ...
                {
                    LOG_ERROR(BSL_LS_SOC_MBIST, (BSL_META_U(unit, "software MBIST not supported on this device\n")));
                }
                else
                {
    ...
    int unit)
{
    ...
    if (SOC_IS_J2P(unit) && (dnx_data_device.general.valid_cores_bitmap_get(unit) == 0x1))
    {
        
#ifndef PLISIM
        if (!(SAL_BOOT_PLISIM))
        {
            soc_block_type_t blk_type;
            uint32 nof_instances;
            int first_blk_instance, blk_id;
            soc_reg_access_info_t access_info;
            uint32 reg32;

            for (blk_type = 0; blk_type < SOC_BLK_LAST_DNX; blk_type++)
            {
                if ((blk_type == SOC_BLK_MACSEC) || (blk_type == SOC_BLK_CDPORT)
                    || (blk_type == SOC_BLK_CDMAC) || (blk_type == SOC_BLK_SCH) ||
                                                 
                    (blk_type == SOC_BLK_HBC) || (blk_type == SOC_BLK_HRC) || (blk_type == SOC_BLK_CFC) ||
                                                 
                    (blk_type == SOC_BLK_DDHA) || 
                    (blk_type == SOC_BLK_DDHB))
                {
                    continue;
                }
                nof_instances = SOC_BLOCK_INSTANCES(unit, blk_type).nof_block_instance;
                first_blk_instance = SOC_BLOCK_INSTANCES(unit, blk_type).first_blk_instance;

                if (nof_instances > 1)
                {
                    for (blk_id = first_blk_instance + (nof_instances / 2); blk_id < first_blk_instance + nof_instances;
                         blk_id++)
                    {
                        
                        SOC_INFO(unit).block_valid[blk_id] = 0;
                        
                        if (!
                            ((blk_type == SOC_BLK_FSRD) || (blk_type == SOC_BLK_FMAC) || (blk_type == SOC_BLK_BRDC_FSRD)
                             || (blk_type == SOC_BLK_BRDC_FMAC) || (blk_type == SOC_BLK_BRDC_HBC)))
                        {
                            
                            SHR_IF_ERR_EXIT(soc_reg_xaddr_get
                                            (unit, ECI_SPECIAL_CLOCK_CONTROLSr, REG_PORT_ANY, 0,
                                             SOC_REG_ADDR_OPTION_NONE, &access_info));
                            SHR_IF_ERR_EXIT(soc_direct_reg_get
                                            (unit, SOC_BLOCK2OFFSET(unit, blk_id), access_info.offset, 1, &reg32));
                            soc_reg_field_set(unit, ECI_SPECIAL_CLOCK_CONTROLSr, &reg32, CLOCK_PD_POWER_DOWNf, 1);
                            SHR_IF_ERR_EXIT(soc_direct_reg_set
                                            (unit, SOC_BLOCK2OFFSET(unit, blk_id), access_info.offset, 1, &reg32));
                        }
    ...
    if (SOC_IS_J2X(unit))
    {
        ...
        {
            int inst, macsec_blk;
            for (inst = 0; inst < dnx_data_macsec.general.macsec_nof_get(unit); inst++)
            {
                macsec_blk = MACSEC_BLOCK(unit, inst);

                
                if (macsec_blk < 0)
                {
                    SHR_ERR_EXIT(_SHR_E_ACCESS, "macsec_blk must not be negative\n");
                }

                SOC_INFO(unit).block_valid[macsec_blk] = 0;
            }
        }
    }
