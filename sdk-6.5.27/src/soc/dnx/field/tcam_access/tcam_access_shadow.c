    ...
    uint8 *valid_bits)
{
    ...
    dnx_field_tcam_access_key_mode_e dummy_key_mode;

    SHR_FUNC_INIT_VARS(unit);

    SHR_IF_ERR_EXIT(dnx_field_tcam_access_entry_key_read_shadow_with_key_mode
                    (unit, core, bank_id, bank_offset, data, valid_bits, &dummy_key_mode));
...
shr_error_e
dnx_field_tcam_access_entry_key_read_shadow_with_key_mode(
    int unit,
    int core,
    uint32 bank_id,
    uint32 bank_offset,
    ...
    dnx_field_tcam_access_key_mode_e * key_mode)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_tcam_cache_shadow.tcam_bank.entry_key.
                    key_data.range_read(unit, core, bank_id, bank_offset, 0,
    ...
    {
        *key_mode = data[0] & SAL_UPTO_BIT(KEY_MODE_BIT_SIZE);

        SHR_BITCOPY_RANGE(data, 0, data, KEY_MODE_BIT_SIZE, HALF_KEY_BIT_SIZE);
        SHR_BITCOPY_RANGE(data, HALF_KEY_BIT_SIZE, data, HALF_KEY_BIT_SIZE + 2 * KEY_MODE_BIT_SIZE, HALF_KEY_BIT_SIZE);
    }
    else
    {
        *key_mode = 0;
    ...
    uint32 *data)
{
    ...
    if (part == DNX_FIELD_TCAM_ACCESS_PART_LSB || part == DNX_FIELD_TCAM_ACCESS_PART_MSB)
    {
        ...
        SHR_IF_ERR_EXIT(dnx_field_tcam_cache_shadow.tcam_bank.entry_key.
                        key_data.range_read(unit, core, bank_id, tcam_bank_offset, 0,
    ...
    SHR_IF_ERR_EXIT(dnx_field_tcam_cache_shadow.tcam_bank.entry_key.
                    key_data.range_write(unit, core, bank_id, tcam_bank_offset, 0,
                                         BITS2BYTES(DNX_DATA_MAX_FIELD_TCAM_ENTRY_SIZE_SINGLE_KEY_SHADOW),
                                         shadow_data));
    ...
    uint32 *payload)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_tcam_cache_shadow.payload_table.entry_payload.
                    payload_data.range_read(unit, core, action_bank_id, action_bank_offset, 0,
    ...
    uint32 *payload)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_tcam_cache_shadow.payload_table.entry_payload.
                    payload_data.range_write(unit, core, action_bank_id, action_bank_offset, 0,
                                             BITS2BYTES(DNX_DATA_MAX_FIELD_TCAM_ACTION_SIZE_HALF), shadow_data));
...
shr_error_e
dnx_field_tcam_access_entry_key_n_mask_read_shadow(
    int unit,
    int core,
    uint32 bank_id,
    uint32 bank_offset,
    ...
    uint8 *equal)
{
    ...
    *equal = FALSE;
    ...
    SHR_IF_ERR_EXIT(dnx_field_tcam_access_entry_key_n_mask_read_shadow
