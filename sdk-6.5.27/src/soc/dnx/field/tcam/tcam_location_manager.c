    ...
    dnx_field_tcam_location_t * location)
{
    ...
    SHR_IF_ERR_EXIT_ELSE_SET_EXPECT(dnx_field_tcam_access_sw.
                                    entry_location_hash.insert_at_index(unit, core, &entry_id, absolute_location),
                                    _SHR_E_FAIL);
    ...
    uint32 location_to)
{
    ...
    SHR_IF_ERR_EXIT_ELSE_SET_EXPECT(dnx_field_tcam_access_sw.entry_location_hash.get_by_index
                                    (unit, core, location_from, &entry_id), _SHR_E_NOT_FOUND);
    ...
    SHR_IF_ERR_EXIT_ELSE_SET_EXPECT(dnx_field_tcam_access_sw.
                                    entry_location_hash.insert_at_index(unit, core, &entry_id, location_to),
                                    _SHR_E_FAIL);
    if (SHR_GET_CURRENT_ERR() == _SHR_E_FAIL)
    {
    ...
    uint8 is_dt)
{
    ...
    SHR_IF_ERR_EXIT_WITH_LOG(dnx_field_tcam_access_sw.
                             entry_location_hash.find(unit, core, &entry_id, &absolute_location),
                             "Error freeing entry %d, entry not allocated%s%s", entry_id, EMPTY, EMPTY);
    ...
    uint32 *location_start)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_tcam_access_move
                    (unit, core, handler_id, *location_to_copy_from, location_to_copy_to, FALSE));
    ...
    uint32 location_end)
{
    ...
    while (location_to_copy_from != location_start)
    {
        ...
        SHR_IF_ERR_EXIT(dnx_field_tcam_access_move
                        (unit, core, handler_id, location_to_copy_from, location_to_copy_to, TRUE));
    ...
    uint32 *location)
{
    ...
    SHR_IF_ERR_EXIT_NO_MSG(dnx_field_tcam_access_sw.entry_location_hash.find(unit, core, &entry_id, location));
    ...
    uint32 *entry_id)
{
    ...
    SHR_IF_ERR_EXIT_ELSE_SET_EXPECT(dnx_field_tcam_access_sw.
                                    entry_location_hash.get_by_index(unit, core, location, entry_id), _SHR_E_NOT_FOUND);
    if (SHR_GET_CURRENT_ERR() == _SHR_E_NOT_FOUND)
    {
    ...
    uint8 *found_p)
{
    ...
    SHR_IF_ERR_EXIT_ELSE_SET_EXPECT(dnx_field_tcam_access_sw.
                                    entry_location_hash.find(unit, core, &entry_id, &abs_location), _SHR_E_NOT_FOUND);
    *found_p = TRUE;
    if (SHR_GET_CURRENT_ERR() == _SHR_E_NOT_FOUND)
    {
        SHR_SET_CURRENT_ERR(_SHR_E_NONE);
