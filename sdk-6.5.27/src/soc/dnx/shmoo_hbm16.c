...
static shmoo_hbm16_hbmc_soft_reset_controller_without_dram_t _shmoo_hbm16_hbmc_soft_reset_controller_without_dram =
    NULL;
...
static shmoo_hbm16_hbmc_phy_channel_dwords_alignment_check_t _shmoo_hbm16_hbmc_phy_channel_dwords_alignment_check =
    NULL;
...
const hbmc_shmoo_channel_config_param_t channel_config_param_metadata[HBMC_SHMOO_CHANNEL_METADATA_SIZE] = {
    ...
    {HBM16_DWORD0_WRITE_MAX_VDL_DATAr, HBMC_SHMOO_FIELDS_ALL, HBMC_SHMOO_LEVEL_0,
     "DWORD0_WRITE_MAX_VDL_DATA__FIELDS_ALL"},
    ...
    {HBM16_DWORD0_WRITE_MAX_VDL_DQSr, HBMC_SHMOO_FIELDS_ALL, HBMC_SHMOO_LEVEL_2,
     "DWORD0_WRITE_MAX_VDL_DQS__FIELDS_ALL"},
    {HBM16_DWORD0_READ_MIN_VDL_DATAr, HBMC_SHMOO_FIELDS_ALL, HBMC_SHMOO_LEVEL_2,
     "DWORD0_READ_MIN_VDL_DATA__FIELDS_ALL"},
    {HBM16_DWORD0_READ_MAX_VDL_DQS_Pr, HBMC_SHMOO_FIELDS_ALL, HBMC_SHMOO_LEVEL_0,
     "DWORD0_READ_MAX_VDL_DQS_P__FIELDS_ALL"},
    {HBM16_DWORD0_READ_MAX_VDL_DQS_Pr, HBM16_MAX_VDL_STEPf, HBMC_SHMOO_OTP_VER_1_2, NULL},
    {HBM16_DWORD0_READ_MAX_VDL_DQS_Nr, HBMC_SHMOO_FIELDS_ALL, HBMC_SHMOO_LEVEL_0,
     "DWORD0_READ_MAX_VDL_DQS_N__FIELDS_ALL"},
    ...
    {HBM16_DWORD0_RXEN_RXBV_GEN_CONFIGr, HBM16_AUTO_UPDATEf, HBMC_SHMOO_LEVEL_2,
     "DWORD0_RXEN_RXBV_GEN_CONFIG__AUTO_UPDATE"},
    {HBM16_DWORD0_RXEN_RXBV_GEN_CONFIGr, HBM16_RD_DATA_DELAYf, HBMC_SHMOO_LEVEL_2,
     "DWORD0_RXEN_RXBV_GEN_CONFIG__RD_DATA_DELAY"},
    {HBM16_DWORD0_RXEN_RXBV_GEN_CONFIGr, HBM16_PAR_LATENCYf, HBMC_SHMOO_LEVEL_2,
     "DWORD0_RXEN_RXBV_GEN_CONFIG__PAR_LATENCY"},
    {HBM16_DWORD0_RXEN_RXBV_GEN_CONFIGr, HBM16_RXEN_PRE_CYCLESf, HBMC_SHMOO_LEVEL_2,
     "DWORD0_RXEN_RXBV_GEN_CONFIG__RXEN_PRE_CYCLES"},
    {HBM16_DWORD0_RXEN_RXBV_GEN_CONFIGr, HBM16_RXEN_POST_CYCLESf, HBMC_SHMOO_LEVEL_2,
     "DWORD0_RXEN_RXBV_GEN_CONFIG__RXEN_POST_CYCLES"},
    {HBM16_DWORD0_READ_MACHINE_CONFIGr, HBM16_PHASE_FIFO_MIN_DELAY_2f, HBMC_SHMOO_LEVEL_2,
     "DWORD0_READ_MACHINE_CONFIG__PHASE_FIFO_MIN_DELAY_2"},
    {HBM16_DWORD0_READ_MACHINE_CONFIGr, HBM16_RDATA_FIFO_WR2RD_DELAYf, HBMC_SHMOO_LEVEL_2,
     "DWORD0_READ_MACHINE_CONFIG__RDATA_FIFO_WR2RD_DELAY"},
    {HBM16_DWORD0_IO_CONFIGr, HBM16_DIFF_PORT_DQS_DRIVE_STRENGTHf, HBMC_SHMOO_LEVEL_2,
     "DWORD0_IO_CONFIG__DIFF_PORT_DQS_DRIVE_STRENGTH"},
    {HBM16_DWORD0_IO_CONFIGr, HBM16_SINGLE_PORT_DQ_DRIVE_STRENGTHf, HBMC_SHMOO_LEVEL_2,
     "DWORD0_IO_CONFIG__SINGLE_PORT_DQ_DRIVE_STRENGTH"},
    ...
    {HBM16_DWORD0_DAC_CONFIGr, HBM16_DAC_DATAf, HBMC_SHMOO_LEVEL_0 | HBMC_SHMOO_OTP_VER_1_2,
     "DWORD0_DAC_CONFIG__DAC_DATA"},
    {HBM16_DWORD0_REG_RESERVEDr, HBMC_SHMOO_FIELDS_ALL, HBMC_SHMOO_LEVEL_1, "DWORD0_REG_RESERVED__FIELDS_ALL"},

    {HBM16_DWORD1_WRITE_MAX_VDL_DATAr, HBMC_SHMOO_FIELDS_ALL, HBMC_SHMOO_LEVEL_0,
     "DWORD1_WRITE_MAX_VDL_DATA__FIELDS_ALL"},
    ...
    {HBM16_DWORD1_WRITE_MAX_VDL_DQSr, HBMC_SHMOO_FIELDS_ALL, HBMC_SHMOO_LEVEL_2,
     "DWORD1_WRITE_MAX_VDL_DQS__FIELDS_ALL"},
    {HBM16_DWORD1_READ_MIN_VDL_DATAr, HBMC_SHMOO_FIELDS_ALL, HBMC_SHMOO_LEVEL_2,
     "DWORD1_READ_MIN_VDL_DATA__FIELDS_ALL"},
    {HBM16_DWORD1_READ_MAX_VDL_DQS_Pr, HBMC_SHMOO_FIELDS_ALL, HBMC_SHMOO_LEVEL_0,
     "DWORD1_READ_MAX_VDL_DQS_P__FIELDS_ALL"},
    {HBM16_DWORD1_READ_MAX_VDL_DQS_Pr, HBM16_MAX_VDL_STEPf, HBMC_SHMOO_OTP_VER_1_2, NULL},
    {HBM16_DWORD1_READ_MAX_VDL_DQS_Nr, HBMC_SHMOO_FIELDS_ALL, HBMC_SHMOO_LEVEL_0,
     "DWORD1_READ_MAX_VDL_DQS_N__FIELDS_ALL"},
    ...
    {HBM16_DWORD1_RXEN_RXBV_GEN_CONFIGr, HBM16_AUTO_UPDATEf, HBMC_SHMOO_LEVEL_2,
     "DWORD1_RXEN_RXBV_GEN_CONFIG__AUTO_UPDATE"},
    {HBM16_DWORD1_RXEN_RXBV_GEN_CONFIGr, HBM16_RD_DATA_DELAYf, HBMC_SHMOO_LEVEL_2,
     "DWORD1_RXEN_RXBV_GEN_CONFIG__RD_DATA_DELAY"},
    {HBM16_DWORD1_RXEN_RXBV_GEN_CONFIGr, HBM16_PAR_LATENCYf, HBMC_SHMOO_LEVEL_2,
     "DWORD1_RXEN_RXBV_GEN_CONFIG__PAR_LATENCY"},
    {HBM16_DWORD1_RXEN_RXBV_GEN_CONFIGr, HBM16_RXEN_PRE_CYCLESf, HBMC_SHMOO_LEVEL_2,
     "DWORD1_RXEN_RXBV_GEN_CONFIG__RXEN_PRE_CYCLES"},
    {HBM16_DWORD1_RXEN_RXBV_GEN_CONFIGr, HBM16_RXEN_POST_CYCLESf, HBMC_SHMOO_LEVEL_2,
     "DWORD1_RXEN_RXBV_GEN_CONFIG__RXEN_POST_CYCLES"},
    {HBM16_DWORD1_READ_MACHINE_CONFIGr, HBM16_PHASE_FIFO_MIN_DELAY_2f, HBMC_SHMOO_LEVEL_2,
     "DWORD1_READ_MACHINE_CONFIG__PHASE_FIFO_MIN_DELAY_2"},
    {HBM16_DWORD1_READ_MACHINE_CONFIGr, HBM16_RDATA_FIFO_WR2RD_DELAYf, HBMC_SHMOO_LEVEL_2,
     "DWORD1_READ_MACHINE_CONFIG__RDATA_FIFO_WR2RD_DELAY"},
    {HBM16_DWORD1_IO_CONFIGr, HBM16_DIFF_PORT_DQS_DRIVE_STRENGTHf, HBMC_SHMOO_LEVEL_2,
     "DWORD1_IO_CONFIG__DIFF_PORT_DQS_DRIVE_STRENGTH"},
    {HBM16_DWORD1_IO_CONFIGr, HBM16_SINGLE_PORT_DQ_DRIVE_STRENGTHf, HBMC_SHMOO_LEVEL_2,
     "DWORD1_IO_CONFIG__SINGLE_PORT_DQ_DRIVE_STRENGTH"},
    ...
    {HBM16_DWORD1_DAC_CONFIGr, HBM16_DAC_DATAf, HBMC_SHMOO_LEVEL_0 | HBMC_SHMOO_OTP_VER_1_2,
     "DWORD1_DAC_CONFIG__DAC_DATA"},
    {HBM16_DWORD1_REG_RESERVEDr, HBMC_SHMOO_FIELDS_ALL, HBMC_SHMOO_LEVEL_1, "DWORD1_REG_RESERVED__FIELDS_ALL"},

    {HBM16_DWORD2_WRITE_MAX_VDL_DATAr, HBMC_SHMOO_FIELDS_ALL, HBMC_SHMOO_LEVEL_0,
     "DWORD2_WRITE_MAX_VDL_DATA__FIELDS_ALL"},
    ...
    {HBM16_DWORD2_WRITE_MAX_VDL_DQSr, HBMC_SHMOO_FIELDS_ALL, HBMC_SHMOO_LEVEL_2,
     "DWORD2_WRITE_MAX_VDL_DQS__FIELDS_ALL"},
    {HBM16_DWORD2_READ_MIN_VDL_DATAr, HBMC_SHMOO_FIELDS_ALL, HBMC_SHMOO_LEVEL_2,
     "DWORD2_READ_MIN_VDL_DATA__FIELDS_ALL"},
    {HBM16_DWORD2_READ_MAX_VDL_DQS_Pr, HBMC_SHMOO_FIELDS_ALL, HBMC_SHMOO_LEVEL_0,
     "DWORD2_READ_MAX_VDL_DQS_P__FIELDS_ALL"},
    {HBM16_DWORD2_READ_MAX_VDL_DQS_Pr, HBM16_MAX_VDL_STEPf, HBMC_SHMOO_OTP_VER_1_2, NULL},
    {HBM16_DWORD2_READ_MAX_VDL_DQS_Nr, HBMC_SHMOO_FIELDS_ALL, HBMC_SHMOO_LEVEL_0,
     "DWORD2_READ_MAX_VDL_DQS_N__FIELDS_ALL"},
    ...
    {HBM16_DWORD2_RXEN_RXBV_GEN_CONFIGr, HBM16_AUTO_UPDATEf, HBMC_SHMOO_LEVEL_2,
     "DWORD2_RXEN_RXBV_GEN_CONFIG__AUTO_UPDATE"},
    {HBM16_DWORD2_RXEN_RXBV_GEN_CONFIGr, HBM16_RD_DATA_DELAYf, HBMC_SHMOO_LEVEL_2,
     "DWORD2_RXEN_RXBV_GEN_CONFIG__RD_DATA_DELAY"},
    {HBM16_DWORD2_RXEN_RXBV_GEN_CONFIGr, HBM16_PAR_LATENCYf, HBMC_SHMOO_LEVEL_2,
     "DWORD2_RXEN_RXBV_GEN_CONFIG__PAR_LATENCY"},
    {HBM16_DWORD2_RXEN_RXBV_GEN_CONFIGr, HBM16_RXEN_PRE_CYCLESf, HBMC_SHMOO_LEVEL_2,
     "DWORD2_RXEN_RXBV_GEN_CONFIG__RXEN_PRE_CYCLES"},
    {HBM16_DWORD2_RXEN_RXBV_GEN_CONFIGr, HBM16_RXEN_POST_CYCLESf, HBMC_SHMOO_LEVEL_2,
     "DWORD2_RXEN_RXBV_GEN_CONFIG__RXEN_POST_CYCLES"},
    {HBM16_DWORD2_READ_MACHINE_CONFIGr, HBM16_PHASE_FIFO_MIN_DELAY_2f, HBMC_SHMOO_LEVEL_2,
     "DWORD2_READ_MACHINE_CONFIG__PHASE_FIFO_MIN_DELAY_2"},
    {HBM16_DWORD2_READ_MACHINE_CONFIGr, HBM16_RDATA_FIFO_WR2RD_DELAYf, HBMC_SHMOO_LEVEL_2,
     "DWORD2_READ_MACHINE_CONFIG__RDATA_FIFO_WR2RD_DELAY"},
    {HBM16_DWORD2_IO_CONFIGr, HBM16_DIFF_PORT_DQS_DRIVE_STRENGTHf, HBMC_SHMOO_LEVEL_2,
     "DWORD2_IO_CONFIG__DIFF_PORT_DQS_DRIVE_STRENGTH"},
    {HBM16_DWORD2_IO_CONFIGr, HBM16_SINGLE_PORT_DQ_DRIVE_STRENGTHf, HBMC_SHMOO_LEVEL_2,
     "DWORD2_IO_CONFIG__SINGLE_PORT_DQ_DRIVE_STRENGTH"},
    ...
    {HBM16_DWORD2_DAC_CONFIGr, HBM16_DAC_DATAf, HBMC_SHMOO_LEVEL_0 | HBMC_SHMOO_OTP_VER_1_2,
     "DWORD2_DAC_CONFIG__DAC_DATA"},
    {HBM16_DWORD2_REG_RESERVEDr, HBMC_SHMOO_FIELDS_ALL, HBMC_SHMOO_LEVEL_1, "DWORD2_REG_RESERVED__FIELDS_ALL"},

    {HBM16_DWORD3_WRITE_MAX_VDL_DATAr, HBMC_SHMOO_FIELDS_ALL, HBMC_SHMOO_LEVEL_0,
     "DWORD3_WRITE_MAX_VDL_DATA__FIELDS_ALL"},
    ...
    {HBM16_DWORD3_WRITE_MAX_VDL_DQSr, HBMC_SHMOO_FIELDS_ALL, HBMC_SHMOO_LEVEL_2,
     "DWORD3_WRITE_MAX_VDL_DQS__FIELDS_ALL"},
    {HBM16_DWORD3_READ_MIN_VDL_DATAr, HBMC_SHMOO_FIELDS_ALL, HBMC_SHMOO_LEVEL_2,
     "DWORD3_READ_MIN_VDL_DATA__FIELDS_ALL"},
    {HBM16_DWORD3_READ_MAX_VDL_DQS_Pr, HBMC_SHMOO_FIELDS_ALL, HBMC_SHMOO_LEVEL_0,
     "DWORD3_READ_MAX_VDL_DQS_P__FIELDS_ALL"},
    {HBM16_DWORD3_READ_MAX_VDL_DQS_Pr, HBM16_MAX_VDL_STEPf, HBMC_SHMOO_OTP_VER_1_2, NULL},
    {HBM16_DWORD3_READ_MAX_VDL_DQS_Nr, HBMC_SHMOO_FIELDS_ALL, HBMC_SHMOO_LEVEL_0,
     "DWORD3_READ_MAX_VDL_DQS_N__FIELDS_ALL"},
    ...
    {HBM16_DWORD3_RXEN_RXBV_GEN_CONFIGr, HBM16_AUTO_UPDATEf, HBMC_SHMOO_LEVEL_2,
     "DWORD3_RXEN_RXBV_GEN_CONFIG__AUTO_UPDATE"},
    {HBM16_DWORD3_RXEN_RXBV_GEN_CONFIGr, HBM16_RD_DATA_DELAYf, HBMC_SHMOO_LEVEL_2,
     "DWORD3_RXEN_RXBV_GEN_CONFIG__RD_DATA_DELAY"},
    {HBM16_DWORD3_RXEN_RXBV_GEN_CONFIGr, HBM16_PAR_LATENCYf, HBMC_SHMOO_LEVEL_2,
     "DWORD3_RXEN_RXBV_GEN_CONFIG__PAR_LATENCY"},
    {HBM16_DWORD3_RXEN_RXBV_GEN_CONFIGr, HBM16_RXEN_PRE_CYCLESf, HBMC_SHMOO_LEVEL_2,
     "DWORD3_RXEN_RXBV_GEN_CONFIG__RXEN_PRE_CYCLES"},
    {HBM16_DWORD3_RXEN_RXBV_GEN_CONFIGr, HBM16_RXEN_POST_CYCLESf, HBMC_SHMOO_LEVEL_2,
     "DWORD3_RXEN_RXBV_GEN_CONFIG__RXEN_POST_CYCLES"},
    {HBM16_DWORD3_READ_MACHINE_CONFIGr, HBM16_PHASE_FIFO_MIN_DELAY_2f, HBMC_SHMOO_LEVEL_2,
     "DWORD3_READ_MACHINE_CONFIG__PHASE_FIFO_MIN_DELAY_2"},
    {HBM16_DWORD3_READ_MACHINE_CONFIGr, HBM16_RDATA_FIFO_WR2RD_DELAYf, HBMC_SHMOO_LEVEL_2,
     "DWORD3_READ_MACHINE_CONFIG__RDATA_FIFO_WR2RD_DELAY"},
    {HBM16_DWORD3_IO_CONFIGr, HBM16_DIFF_PORT_DQS_DRIVE_STRENGTHf, HBMC_SHMOO_LEVEL_2,
     "DWORD3_IO_CONFIG__DIFF_PORT_DQS_DRIVE_STRENGTH"},
    {HBM16_DWORD3_IO_CONFIGr, HBM16_SINGLE_PORT_DQ_DRIVE_STRENGTHf, HBMC_SHMOO_LEVEL_2,
     "DWORD3_IO_CONFIG__SINGLE_PORT_DQ_DRIVE_STRENGTH"},
    ...
    {HBM16_DWORD3_DAC_CONFIGr, HBM16_DAC_DATAf, HBMC_SHMOO_LEVEL_0 | HBMC_SHMOO_OTP_VER_1_2,
     "DWORD3_DAC_CONFIG__DAC_DATA"},
    ...
    {HBM16_AWORD_WRITE_MAX_VDL_ADDRr, HBMC_SHMOO_FIELDS_ALL, HBMC_SHMOO_LEVEL_0,
     "AWORD_WRITE_MAX_VDL_ADDR__FIELDS_ALL"},
    ...
    {HBM16_AWORD_IO_CONFIGr, HBM16_DIFF_PORT_CK_DRIVE_STRENGTHf, HBMC_SHMOO_LEVEL_2,
     "AWORD_IO_CONFIG__DIFF_PORT_CK_DRIVE_STRENGTH"},
    {HBM16_AWORD_IO_CONFIGr, HBM16_SINGLE_PORT_AQ_DRIVE_STRENGTHf, HBMC_SHMOO_LEVEL_2,
     "AWORD_IO_CONFIG__SINGLE_PORT_AQ_DRIVE_STRENGTH"},
    ...
    {HBM16_AWORD_DAC_CONFIGr, HBM16_DAC_DATAf, HBMC_SHMOO_LEVEL_0 | HBMC_SHMOO_OTP_VER_1_2,
     "AWORD_DAC_CONFIG__DAC_DATA"},
...
const hbmc_shmoo_midstack_config_param_t midstack_config_param_metadata[HBMC_SHMOO_MIDSTACK_METADATA_SIZE] = {
    {HBM16_MIDSTACK_DAC_CONFIGr, HBM16_DAC_DATAf, HBMC_SHMOO_LEVEL_0 | HBMC_SHMOO_OTP_VER_1_2,
     "MIDSTACK_DAC_CONFIG__DAC_DATA"},
    {HBM16_MIDSTACK_IO_CONFIGr, HBM16_RESET_DRIVE_STRENGTHf, HBMC_SHMOO_LEVEL_2,
     "MIDSTACK_IO_CONFIG__RESET_DRIVE_STRENGTH"},
    ...
    int unit)
{
    ...
    LOG_VERBOSE(BSL_LS_SOC_DDR,
                (BSL_META_U
                 (unit,
                  "shmo_dram_info: ctl_type=%d, dram_type=%d, num_columns=%d, num_rows=%d, num_banks=%d, data_rate_mbps=%d, ref_clk_mhz=%d, dram_bitmap=0x%08X\n"),
                 shmoo_dram_info.ctl_type, shmoo_dram_info.dram_type, shmoo_dram_info.num_columns,
                 shmoo_dram_info.num_rows, shmoo_dram_info.num_banks, shmoo_dram_info.data_rate_mbps,
                 shmoo_dram_info.ref_clk_mhz, shmoo_dram_info.dram_bitmap));

    return ((shmoo_dram_info.dram_type != 0)
            && (shmoo_dram_info.num_columns != -1)
            && (shmoo_dram_info.num_rows != -1)
            && (shmoo_dram_info.num_banks != -1)
            && (shmoo_dram_info.data_rate_mbps != -1) && (shmoo_dram_info.ref_clk_mhz != -1));
}

uint32
_shmoo_hbm16_validate_cbi(
    void)
{
    return ((soc_hbm16_phy_reg_read != NULL)
...
STATIC int
_hbm16_initialize_bist(
    int unit,
    int hbm_ndx,
    int channel,
    hbm16_shmoo_container_t * scPtr,
...
_hbm16_run_bist(
    ...
    hbm16_shmoo_container_t * scPtr,
    hbmc_shmoo_bist_info_t * biPtr,
    hbmc_shmoo_error_array_t * seaPtr)
{
    uint32 data[1];
    ...
    switch ((*scPtr).shmooType)
    {
        ...
        case SHMOO_HBM16_ADDR_CTRL_EXTENDED:
            ...
            else
            {
                ...
                SOC_IF_ERROR_RETURN(_shmoo_hbm16_hbmc_bist_status_get
                ...
                SOC_IF_ERROR_RETURN(READ_HBM16_DWORD0_STATUS_RDATA_FIFO_PTRr
                                    (unit, hbm_ndx, channel, &status_rdata_fifo_ptr[0]));
                SOC_IF_ERROR_RETURN(READ_HBM16_DWORD1_STATUS_RDATA_FIFO_PTRr
                                    (unit, hbm_ndx, channel, &status_rdata_fifo_ptr[1]));
                SOC_IF_ERROR_RETURN(READ_HBM16_DWORD2_STATUS_RDATA_FIFO_PTRr
                                    (unit, hbm_ndx, channel, &status_rdata_fifo_ptr[2]));
                SOC_IF_ERROR_RETURN(READ_HBM16_DWORD3_STATUS_RDATA_FIFO_PTRr
                                    (unit, hbm_ndx, channel, &status_rdata_fifo_ptr[3]));

                LOG_VERBOSE(BSL_LS_SOC_DDR,
                            (BSL_META_U
                             (unit,
                              "      Raw 0: 0x %08X %08X %08X %08X | STATUS_RDATA_FIFO_PTR: 0x %08X %08X %08X %08X | READ_DATA_CNT: 0x%08X%08X\n"),
                             p3, p2, p1, p0, status_rdata_fifo_ptr[3], status_rdata_fifo_ptr[2],
                             status_rdata_fifo_ptr[1], status_rdata_fifo_ptr[0], read_data_counter[1],
                             read_data_counter[0]));
            }
            break;
...
STATIC int
_hbm16_calculate_ui_position(
    uint32 linearPos,
    hbm16_shmoo_container_t * scPtr,
    hbm16_ui_position_t * upPtr)
{
    uint32 ui;
    uint32 position;
    ...
    int input_dword)
{
    ...
    soc_reg_t DWORD_LATENCY_SHIFTERl[SHMOO_HBM16_WORDS_PER_CHANNEL] =
        { HBM16_DWORD0_LATENCY_SHIFTERr, HBM16_DWORD1_LATENCY_SHIFTERr,
    ...
    SOC_IF_ERROR_RETURN(soc_hbm16_channel_read
                        (unit, hbm_ndx, channel, DWORD_LATENCY_SHIFTERl[input_dword], REG_PORT_ANY, &reg32_val));

    SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_get
                        (unit, DWORD_LATENCY_SHIFTERl[input_dword], reg32_val, HBM16_RCMD_ADDITIONAL_LATENCYf,
                         &read_command_additonal_latency));

    for (curr_dword = 0; curr_dword < SHMOO_HBM16_WORDS_PER_CHANNEL; ++curr_dword)
    {
        SOC_IF_ERROR_RETURN(soc_hbm16_channel_read
                            (unit, hbm_ndx, channel, DWORD_LATENCY_SHIFTERl[curr_dword], REG_PORT_ANY, &reg32_val));
        SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                            (unit, DWORD_LATENCY_SHIFTERl[curr_dword], &reg32_val, HBM16_RCMD_ADDITIONAL_LATENCYf,
                             read_command_additonal_latency));
        SOC_IF_ERROR_RETURN(soc_hbm16_channel_write
                            (unit, hbm_ndx, channel, DWORD_LATENCY_SHIFTERl[curr_dword], REG_PORT_ANY, reg32_val));
    }
    ...
    SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                        (unit, DWORD_LATENCY_SHIFTERl[input_dword], &reg32_val, HBM16_RCMD_ADDITIONAL_LATENCYf,
                         read_command_additonal_latency - 1));
    SOC_IF_ERROR_RETURN(soc_hbm16_channel_write
                        (unit, hbm_ndx, channel, DWORD_LATENCY_SHIFTERl[input_dword], REG_PORT_ANY, reg32_val));
    LOG_VERBOSE(BSL_LS_SOC_DDR,
                (BSL_META_U(unit, "DWORD%d - RCMD_ADDITIONAL_LATENCY = %d\n"), input_dword,
                 read_command_additonal_latency - 1));
    ...
    if ((flags & SHMOO_HBM16_PHY_RESET_FLAG_DWORD_ALIGNMENT_NOT_NEEDED) == 0)
    {
        ...
        if (!is_aligned)
        {
            ...
            for (dword_index = 0; dword_index < SHMOO_HBM16_WORDS_PER_CHANNEL; ++dword_index)
            {
                ...
                SOC_IF_ERROR_RETURN(_shmoo_hbm16_hbmc_phy_channel_dwords_alignment_check
                                    (unit, hbm_ndx, channel, &is_aligned));
                if (is_aligned)
                {
                    break;
                }
    ...
    hbm16_shmoo_container_t * scPtr)
{
    ...
    LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "***** Channel.........: %3d\n"), channel));
    LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, " **** Shmoo type......: RD_EN_FISH\n")));
    LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "  *** Searching.......: RD_DATA_DELAY\n")));
    ...
    for (d = 0; d < 16; d++)
    {
        if (fish0)
        {
            SOC_IF_ERROR_RETURN(READ_HBM16_DWORD0_RXEN_RXBV_GEN_CONFIGr(unit, hbm_ndx, channel, &data));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD0_RXEN_RXBV_GEN_CONFIGr, &data, HBM16_RD_DATA_DELAYf, d));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD0_RXEN_RXBV_GEN_CONFIGr(unit, hbm_ndx, channel, data));
        }
        if (fish1)
        {
            SOC_IF_ERROR_RETURN(READ_HBM16_DWORD1_RXEN_RXBV_GEN_CONFIGr(unit, hbm_ndx, channel, &data));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD1_RXEN_RXBV_GEN_CONFIGr, &data, HBM16_RD_DATA_DELAYf, d));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD1_RXEN_RXBV_GEN_CONFIGr(unit, hbm_ndx, channel, data));
        }
        if (fish2)
        {
            SOC_IF_ERROR_RETURN(READ_HBM16_DWORD2_RXEN_RXBV_GEN_CONFIGr(unit, hbm_ndx, channel, &data));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD2_RXEN_RXBV_GEN_CONFIGr, &data, HBM16_RD_DATA_DELAYf, d));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD2_RXEN_RXBV_GEN_CONFIGr(unit, hbm_ndx, channel, data));
        }
        if (fish3)
        {
            SOC_IF_ERROR_RETURN(READ_HBM16_DWORD3_RXEN_RXBV_GEN_CONFIGr(unit, hbm_ndx, channel, &data));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD3_RXEN_RXBV_GEN_CONFIGr, &data, HBM16_RD_DATA_DELAYf, d));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD3_RXEN_RXBV_GEN_CONFIGr(unit, hbm_ndx, channel, data));
        }
    ...
    hbm16_shmoo_container_t * scPtr)
{
    ...
    for (y = yCapMin; y < yCapMax; y++)
    {
        ...
        for (x = 0; x < (*scPtr).sizeX; x++)
        {
            ...
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD0_WRITE_MAX_VDL_DATAr, &data, HBM16_UI_SHIFTf, ui));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD0_WRITE_MAX_VDL_DATAr, &data, HBM16_MAX_VDL_STEPf, position));
            position++;
    ...
    hbm16_shmoo_container_t * scPtr)
{
    ...
    else
    {
        ...
        if (model_part == HBM_TYPE_SAMSUNG_CORE_GROUP_B)
        {
            yCapMin = 2;
            yCapMax = 3;
        }
        else if (model_part == HBM_TYPE_SAMSUNG_CORE_GROUP_X)
        {
            yCapMin = 4;
            yCapMax = 5;
        }
    ...
    for (y = yCapMin; y < yCapMax; y++)
    {
        ...
        SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                            (unit, HBM16_DWORD0_DAC_CONFIGr, &data, HBM16_DAC_DATAf, y << 1));
        ...
        for (x = (*scPtr).calibStart; x < (*scPtr).sizeX; x++)
        {
            ...
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD0_READ_MAX_VDL_DQS_Pr, &data, HBM16_MAX_VDL_STEPf, x));
...
STATIC int
_shmoo_hbm16_addr_ctrl_extended(
    int unit,
    int hbm_ndx,
    int channel,
    hbm16_shmoo_container_t * scPtr)
{
    ...
    for (x = 0; x < (*scPtr).sizeX; x++)
    {
        ...
        SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                            (unit, HBM16_AWORD_WRITE_MAX_VDL_ADDRr, &data, HBM16_UI_SHIFTf, ui));
        SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                            (unit, HBM16_AWORD_WRITE_MAX_VDL_ADDRr, &data, HBM16_MAX_VDL_STEPf, position));
        position++;
    ...
    uint32 decisionMode)
{
    ...
    switch (calibMode)
    {
        ...
        case SHMOO_HBM16_QUADWORD:
            ...
            break;
        default:
            LOG_ERROR(BSL_LS_SOC_DDR, (BSL_META_U(unit, "Unsupported 2D calibration mode: %02d\n"), calibMode));
            return SOC_E_FAIL;
    }
    ...
    hbm16_shmoo_container_t * scPtr)
{
    switch ((*scPtr).shmooType)
    {
        case SHMOO_HBM16_RD_EN_FISH:
            break;
        case SHMOO_HBM16_RD_EXTENDED:
            return _hbm16_calib_2D(unit, hbm_ndx, channel, scPtr, SHMOO_HBM16_WORD, SHMOO_HBM16_CALIB_CENTER_PASS,
                                   SHMOO_HBM16_CALIB_PASS_ALL);
        case SHMOO_HBM16_WR_EXTENDED:
            return _hbm16_calib_2D(unit, hbm_ndx, channel, scPtr, SHMOO_HBM16_WORD, SHMOO_HBM16_CALIB_CENTER_PASS,
                                   SHMOO_HBM16_CALIB_PASS_ALL);
        case SHMOO_HBM16_ADDR_CTRL_EXTENDED:
            return _hbm16_calib_2D(unit, hbm_ndx, channel, scPtr, SHMOO_HBM16_QUADWORD, SHMOO_HBM16_CALIB_CENTER_PASS,
                                   SHMOO_HBM16_CALIB_PASS_ALL);
        default:
            LOG_ERROR(BSL_LS_SOC_DDR, (BSL_META_U(unit, "Unsupported shmoo type: %02d\n"), (*scPtr).shmooType));
            return SOC_E_FAIL;
        ...
        case SHMOO_HBM16_RD_EXTENDED:
            switch (calibMode)
            {
                case SHMOO_HBM16_WORD:
                    SOC_IF_ERROR_RETURN(READ_HBM16_DWORD0_READ_MAX_VDL_DQS_Pr(unit, hbm_ndx, channel, &data));
                    SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                        (unit, HBM16_DWORD0_READ_MAX_VDL_DQS_Pr, &data, HBM16_MAX_VDL_STEPf,
                                         (*scPtr).resultData[0] & 0xFFFF));
                    SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD0_READ_MAX_VDL_DQS_Pr(unit, hbm_ndx, channel, data));
                    SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD0_READ_MAX_VDL_DQS_Nr(unit, hbm_ndx, channel, data));

                    SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                        (unit, HBM16_DWORD1_READ_MAX_VDL_DQS_Pr, &data, HBM16_MAX_VDL_STEPf,
                                         (*scPtr).resultData[1] & 0xFFFF));
                    SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD1_READ_MAX_VDL_DQS_Pr(unit, hbm_ndx, channel, data));
                    SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD1_READ_MAX_VDL_DQS_Nr(unit, hbm_ndx, channel, data));

                    SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                        (unit, HBM16_DWORD2_READ_MAX_VDL_DQS_Pr, &data, HBM16_MAX_VDL_STEPf,
                                         (*scPtr).resultData[2] & 0xFFFF));
                    SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD2_READ_MAX_VDL_DQS_Pr(unit, hbm_ndx, channel, data));
                    SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD2_READ_MAX_VDL_DQS_Nr(unit, hbm_ndx, channel, data));

                    SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                        (unit, HBM16_DWORD3_READ_MAX_VDL_DQS_Pr, &data, HBM16_MAX_VDL_STEPf,
                                         (*scPtr).resultData[3] & 0xFFFF));
                    SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD3_READ_MAX_VDL_DQS_Pr(unit, hbm_ndx, channel, data));
                    SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD3_READ_MAX_VDL_DQS_Nr(unit, hbm_ndx, channel, data));

                    SOC_IF_ERROR_RETURN(READ_HBM16_DWORD0_DAC_CONFIGr(unit, hbm_ndx, channel, &data));
                    SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                        (unit, HBM16_DWORD0_DAC_CONFIGr, &data, HBM16_DAC_DATAf,
            ...
            switch (calibMode)
            {
                case SHMOO_HBM16_WORD:
                    ...
                    if (engageUIshift)
                    {
                        ...
                        SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                            (unit, HBM16_DWORD0_WRITE_MAX_VDL_DATAr, &data, HBM16_UI_SHIFTf, up.ui));
                        SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                            (unit, HBM16_DWORD0_WRITE_MAX_VDL_DATAr, &data, HBM16_MAX_VDL_STEPf,
                                             up.position));
                        SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD0_WRITE_MAX_VDL_DATAr(unit, hbm_ndx, channel, data));

                        _hbm16_calculate_ui_position((*scPtr).resultData[1] & 0xFFFF, scPtr, &up);
                        SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                            (unit, HBM16_DWORD1_WRITE_MAX_VDL_DATAr, &data, HBM16_UI_SHIFTf, up.ui));
                        SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                            (unit, HBM16_DWORD1_WRITE_MAX_VDL_DATAr, &data, HBM16_MAX_VDL_STEPf,
                                             up.position));
                        SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD1_WRITE_MAX_VDL_DATAr(unit, hbm_ndx, channel, data));

                        _hbm16_calculate_ui_position((*scPtr).resultData[2] & 0xFFFF, scPtr, &up);
                        SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                            (unit, HBM16_DWORD2_WRITE_MAX_VDL_DATAr, &data, HBM16_UI_SHIFTf, up.ui));
                        SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                            (unit, HBM16_DWORD2_WRITE_MAX_VDL_DATAr, &data, HBM16_MAX_VDL_STEPf,
                                             up.position));
                        SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD2_WRITE_MAX_VDL_DATAr(unit, hbm_ndx, channel, data));

                        _hbm16_calculate_ui_position((*scPtr).resultData[3] & 0xFFFF, scPtr, &up);
                        SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                            (unit, HBM16_DWORD3_WRITE_MAX_VDL_DATAr, &data, HBM16_UI_SHIFTf, up.ui));
                        SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                            (unit, HBM16_DWORD3_WRITE_MAX_VDL_DATAr, &data, HBM16_MAX_VDL_STEPf,
                                             up.position));
                        SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD3_WRITE_MAX_VDL_DATAr(unit, hbm_ndx, channel, data));
                    }
                    else
                    ...
                    SOC_IF_ERROR_RETURN(_shmoo_hbm16_hbmc_modify_mrs
                                        (unit, hbm_ndx, channel, 15, shmoo_hbm16_gen2_wr_vref[MRfield0], 0x7));
                    break;
                case SHMOO_HBM16_DOUBLEWORD:
                    SOC_IF_ERROR_RETURN(READ_HBM16_DWORD0_WRITE_MAX_VDL_DATAr(unit, hbm_ndx, channel, &data));
                    if (engageUIshift)
            ...
            switch (calibMode)
            {
                case SHMOO_HBM16_QUADWORD:
                    ...
                    if (engageUIshift)
                    {
                        _hbm16_calculate_ui_position((*scPtr).resultData[0] & 0xFFFF, scPtr, &up);
                        SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                            (unit, HBM16_AWORD_WRITE_MAX_VDL_ADDRr, &data, HBM16_UI_SHIFTf, up.ui));
                        SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                            (unit, HBM16_AWORD_WRITE_MAX_VDL_ADDRr, &data, HBM16_MAX_VDL_STEPf,
                                             up.position));
                    }
                    else
                    {
                        SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                            (unit, HBM16_AWORD_WRITE_MAX_VDL_ADDRr, &data, HBM16_UI_SHIFTf,
                                             (*scPtr).resultData[0] & 0xFFFF));
                    }
                    SOC_IF_ERROR_RETURN(WRITE_HBM16_AWORD_WRITE_MAX_VDL_ADDRr(unit, hbm_ndx, channel, data));
                    break;
    ...
    switch (plotMode)
    {
        ...
        case SHMOO_HBM16_DOUBLEWORD:
            ...
            switch (calibMode)
            {
                case SHMOO_HBM16_WORD:
                    LOG_INFO(BSL_LS_SOC_DDR,
                             (BSL_META_U(unit, "WARNING: Plot mode coerced from doubleword mode to word mode\n")));
                    iter = 1;
                    wordIter = 4;
                    shiftAmount = 5;
                    dataMask = 0xFFFFFFFF;
        ...
        case SHMOO_HBM16_QUADWORD:
            ...
            switch (calibMode)
            {
                case SHMOO_HBM16_WORD:
                    LOG_INFO(BSL_LS_SOC_DDR,
                             (BSL_META_U(unit, "WARNING: Plot mode coerced from quadword mode to word mode\n")));
                    iter = 1;
                    wordIter = 4;
                    shiftAmount = 5;
                    dataMask = 0xFFFFFFFF;
                ...
                case SHMOO_HBM16_DOUBLEWORD:
                    LOG_INFO(BSL_LS_SOC_DDR,
                             (BSL_META_U(unit, "WARNING: Plot mode coerced from quadword mode to doubleword mode\n")));
                    iter = 1;
                    wordIter = 2;
                    shiftAmount = 5;
                    dataMask = 0xFFFFFFFF;
        ...
        if ((sizeY > 1) || (i == 0))
        {
            ...
            switch ((*scPtr).shmooType)
            {
                ...
                case SHMOO_HBM16_WR_EXTENDED:
                    ...
                    break;
                case SHMOO_HBM16_ADDR_CTRL_EXTENDED:
                    LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, " **** Shmoo type......: ADDR_CTRL_EXTENDED\n")));
                    break;
                default:
                    LOG_ERROR(BSL_LS_SOC_DDR, (BSL_META_U(unit, "Unsupported shmoo type: %02d\n"), (*scPtr).shmooType));
                    rv = SOC_E_FAIL;
        ...
        if (sizeY > 1)
        {
            switch (calibMode)
            {
                case SHMOO_HBM16_WORD:
                    ...
                    break;
                case SHMOO_HBM16_DOUBLEWORD:
                    LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "  *** Calib mode......: 2D Doubleword-wise\n")));
                    break;
                case SHMOO_HBM16_QUADWORD:
                    LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "  *** Calib mode......: 2D Quadword-wise\n")));
                    break;
                default:
                    LOG_ERROR(BSL_LS_SOC_DDR,
                              (BSL_META_U(unit, "Unsupported calibration mode during plot: %02d\n"), calibMode));
            ...
            switch (plotMode)
            {
                ...
                case SHMOO_HBM16_WORD:
                    ...
                    break;
                case SHMOO_HBM16_DOUBLEWORD:
                    LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "  *** Plot mode.......: 2D Doubleword-wise\n")));
                    LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "   ** Halfword........: %03d\n"), i));
                    break;
                case SHMOO_HBM16_QUADWORD:
                    LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "  *** Plot mode.......: 2D Quadword-wise\n")));
                    LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "   ** Word............: %03d\n"), i));
                    break;
                default:
                    LOG_ERROR(BSL_LS_SOC_DDR, (BSL_META_U(unit, "Unsupported plot mode: %02d\n"), plotMode));
            ...
            for (y = yCapMin; y < yCapMax; y++)
            {
                ...
                for (x = calibStart; x < sizeX; x++)
                {
                    switch (wordIter)
                    {
                        case 4:
                            result =
                                ((*scPtr).result2D[i / iter][xStart + x] >> ((i % iter) << shiftAmount)) & dataMask;
                            break;
                        case 2:
                            result =
                                ((*scPtr).result2D[i / iter][xStart + x] >> ((i % iter) << shiftAmount)) & dataMask;
                            result &=
                                ((*scPtr).result2D[(i / iter) + 1][xStart + x] >> ((i % iter) << shiftAmount)) &
                                dataMask;
                            break;
                        case 1:
                            result =
                            ...
                            result &=
                                ...
                                dataMask;
                            result &=
                                ((*scPtr).result2D[(i / iter) + 2][xStart + x] >> ((i % iter) << shiftAmount)) &
                                dataMask;
                            result &=
                                ((*scPtr).result2D[(i / iter) + 3][xStart + x] >> ((i % iter) << shiftAmount)) &
                                dataMask;
                            break;
                        default:
                            LOG_ERROR(BSL_LS_SOC_DDR,
                                      (BSL_META_U(unit, "Unsupported plot word iteration: %02d\n"), wordIter));
                            return SOC_E_FAIL;
                    }
                    ...
                    if (result)
                    {
                        ...
                        {
                            if ((calibPos == SHMOO_HBM16_CALIB_ANY_EDGE) || (calibPos == SHMOO_HBM16_CALIB_RISING_EDGE)
                                || (calibPos == SHMOO_HBM16_CALIB_FAIL_START))
                            {
            ...
            if (i == 0)
            {
                switch (calibMode)
                {
                    case SHMOO_HBM16_WORD:
                        ...
                        break;
                    case SHMOO_HBM16_DOUBLEWORD:
                        LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "  *** Calib mode......: 1D Doubleword-wise\n")));
                        break;
                    case SHMOO_HBM16_QUADWORD:
                        LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "  *** Calib mode......: 1D Quadword-wise\n")));
                        break;
                    default:
                        LOG_ERROR(BSL_LS_SOC_DDR,
                                  (BSL_META_U(unit, "Unsupported calibration mode during plot: %02d\n"), calibMode));
                ...
                switch (plotMode)
                {
                    ...
                    case SHMOO_HBM16_WORD:
                        ...
                        break;
                    case SHMOO_HBM16_DOUBLEWORD:
                        LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "  *** Plot mode.......: 1D Doubleword-wise\n")));
                        break;
                    case SHMOO_HBM16_QUADWORD:
                        LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "  *** Plot mode.......: 1D Quadword-wise\n")));
                        break;
                    default:
                        LOG_ERROR(BSL_LS_SOC_DDR, (BSL_META_U(unit, "Unsupported plot mode: %02d\n"), plotMode));
                        rv = SOC_E_FAIL;
...
int
soc_hbm16_calculate_step_size(
    int unit,
    int hbm_ndx,
    hbm16_step_size_t * ssPtr)
{
    uint32 data;
    ...
    ro_vdl_step1 = 128;
    ro_vdl_step2 = 256;
    SOC_IF_ERROR_RETURN(soc_hbm16_midstack_field_set
                        (unit, HBM16_MIDSTACK_FREQ_CNTR_CONFIGr, &data, HBM16_OBS_INTERVALf, obs_interval));
    SOC_IF_ERROR_RETURN(soc_hbm16_midstack_field_set
                        (unit, HBM16_MIDSTACK_FREQ_CNTR_CONFIGr, &data, HBM16_SEL_FC_REFCLKf, 0));
    ...
    SOC_IF_ERROR_RETURN(soc_hbm16_midstack_field_set
                        (unit, HBM16_MIDSTACK_FREQ_CNTR_RST_CTRLr, &reset_ctrl_data, HBM16_FREQ_CNTR_FC_RESET_Nf, 0));
    SOC_IF_ERROR_RETURN(soc_hbm16_midstack_field_set
                        (unit, HBM16_MIDSTACK_FREQ_CNTR_RST_CTRLr, &reset_ctrl_data, HBM16_FREQ_CNTR_RO_RESET_Nf, 0));
    SOC_IF_ERROR_RETURN(WRITE_HBM16_MIDSTACK_FREQ_CNTR_RST_CTRLr(unit, hbm_ndx, reset_ctrl_data));
    sal_usleep(SHMOO_HBM16_SHORT_SLEEP);

    SOC_IF_ERROR_RETURN(soc_hbm16_midstack_field_set
                        (unit, HBM16_MIDSTACK_FREQ_CNTR_CONFIGr, &data, HBM16_START_OBSf, 0));
    SOC_IF_ERROR_RETURN(soc_hbm16_midstack_field_set
                        (unit, HBM16_MIDSTACK_FREQ_CNTR_CONFIGr, &data, HBM16_EN_NLDL_CLKOUT_BARf, 0));
    SOC_IF_ERROR_RETURN(WRITE_HBM16_MIDSTACK_FREQ_CNTR_CONFIGr(unit, hbm_ndx, data));
    sal_usleep(SHMOO_HBM16_SHORT_SLEEP);

    SOC_IF_ERROR_RETURN(soc_hbm16_midstack_field_set
                        (unit, HBM16_MIDSTACK_FREQ_CNTR_CONFIGr, &data, HBM16_RO_VDL_STEPf, ro_vdl_step1));
    SOC_IF_ERROR_RETURN(WRITE_HBM16_MIDSTACK_FREQ_CNTR_CONFIGr(unit, hbm_ndx, data));
    sal_usleep(SHMOO_HBM16_SHORT_SLEEP);

    SOC_IF_ERROR_RETURN(soc_hbm16_midstack_field_set
                        (unit, HBM16_MIDSTACK_FREQ_CNTR_CONFIGr, &data, HBM16_EN_NLDL_CLKOUT_BARf, 1));
    SOC_IF_ERROR_RETURN(WRITE_HBM16_MIDSTACK_FREQ_CNTR_CONFIGr(unit, hbm_ndx, data));
    sal_usleep(SHMOO_HBM16_SHORT_SLEEP);

    SOC_IF_ERROR_RETURN(soc_hbm16_midstack_field_set
                        (unit, HBM16_MIDSTACK_FREQ_CNTR_RST_CTRLr, &reset_ctrl_data, HBM16_FREQ_CNTR_FC_RESET_Nf, 1));
    SOC_IF_ERROR_RETURN(soc_hbm16_midstack_field_set
                        (unit, HBM16_MIDSTACK_FREQ_CNTR_RST_CTRLr, &reset_ctrl_data, HBM16_FREQ_CNTR_RO_RESET_Nf, 1));
    SOC_IF_ERROR_RETURN(WRITE_HBM16_MIDSTACK_FREQ_CNTR_RST_CTRLr(unit, hbm_ndx, reset_ctrl_data));
    sal_usleep(SHMOO_HBM16_SHORT_SLEEP);

    SOC_IF_ERROR_RETURN(soc_hbm16_midstack_field_set
                        (unit, HBM16_MIDSTACK_FREQ_CNTR_CONFIGr, &data, HBM16_START_OBSf, 1));
    SOC_IF_ERROR_RETURN(WRITE_HBM16_MIDSTACK_FREQ_CNTR_CONFIGr(unit, hbm_ndx, data));
    sal_usleep(SHMOO_HBM16_SHORT_SLEEP);
    ...
    do
    {
        ...
        SOC_IF_ERROR_RETURN(soc_hbm16_midstack_field_get
                            (unit, HBM16_MIDSTACK_STATUS_FREQ_CNTR_DCOUNTr, data, HBM16_DCOUNTf, &fld_dcount));
        if (!fld_dcount)
        {
            SOC_IF_ERROR_RETURN(READ_HBM16_MIDSTACK_STATUS_FREQ_CNTR_UCOUNTr(unit, hbm_ndx, &data));
            SOC_IF_ERROR_RETURN(soc_hbm16_midstack_field_get
                                (unit, HBM16_MIDSTACK_STATUS_FREQ_CNTR_UCOUNTr, data, HBM16_RO_OVERFLOWf,
                                 &fld_ro_overflow));
            ...
            SOC_IF_ERROR_RETURN(soc_hbm16_midstack_field_get
                                (unit, HBM16_MIDSTACK_STATUS_FREQ_CNTR_UCOUNTr, data, HBM16_RO_UCOUNTf, &ucount1));
            break;
        }
    ...
    SOC_IF_ERROR_RETURN(soc_hbm16_midstack_field_set
                        (unit, HBM16_MIDSTACK_FREQ_CNTR_CONFIGr, &data, HBM16_RO_VDL_STEPf, ro_vdl_step2));
    SOC_IF_ERROR_RETURN(WRITE_HBM16_MIDSTACK_FREQ_CNTR_CONFIGr(unit, hbm_ndx, data));
    sal_usleep(SHMOO_HBM16_SHORT_SLEEP);
    ...
    do
    {
        ...
        if (!fld_dcount)
        {
            ...
            SOC_IF_ERROR_RETURN(soc_hbm16_midstack_field_get
                                (unit, HBM16_MIDSTACK_STATUS_FREQ_CNTR_UCOUNTr, data, HBM16_RO_UCOUNTf, &ucount2));
            break;
        }
        if (soc_timeout_check(&to))
        {
    ...
    {
        (*ssPtr).step1000 =
            (((((((1000000000 / (ro_vdl_step2 - ro_vdl_step1)) << 3) / shmoo_dram_info.data_rate_mbps) * obs_interval) /
               ucount2) * (ucount1 - ucount2)) / ucount1) >> 1;
    ...
    uint32 mode)
{
    ...
    switch ((*scPtr).shmooType)
    {
        case SHMOO_HBM16_RD_EN_FISH:
            SOC_IF_ERROR_RETURN(_shmoo_hbm16_hbmc_modify_mrs
                                (unit, hbm_ndx, channel, 15, shmoo_hbm16_gen2_wr_vref[3], 0x7));
            sal_usleep(SHMOO_HBM16_SHORT_SLEEP);

            SOC_IF_ERROR_RETURN(READ_HBM16_DWORD0_RXEN_RXBV_GEN_CONFIGr(unit, hbm_ndx, channel, &data));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD0_RXEN_RXBV_GEN_CONFIGr, &data, HBM16_RXEN_PRE_CYCLESf, 0));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD0_RXEN_RXBV_GEN_CONFIGr, &data, HBM16_RXEN_POST_CYCLESf, 0));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD0_RXEN_RXBV_GEN_CONFIGr, &data, HBM16_FORCE_RXENf, 0));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD0_RXEN_RXBV_GEN_CONFIGr(unit, hbm_ndx, channel, data));
            SOC_IF_ERROR_RETURN(READ_HBM16_DWORD1_RXEN_RXBV_GEN_CONFIGr(unit, hbm_ndx, channel, &data));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD1_RXEN_RXBV_GEN_CONFIGr, &data, HBM16_RXEN_PRE_CYCLESf, 0));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD1_RXEN_RXBV_GEN_CONFIGr, &data, HBM16_RXEN_POST_CYCLESf, 0));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD0_RXEN_RXBV_GEN_CONFIGr, &data, HBM16_FORCE_RXENf, 0));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD1_RXEN_RXBV_GEN_CONFIGr(unit, hbm_ndx, channel, data));
            SOC_IF_ERROR_RETURN(READ_HBM16_DWORD2_RXEN_RXBV_GEN_CONFIGr(unit, hbm_ndx, channel, &data));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD2_RXEN_RXBV_GEN_CONFIGr, &data, HBM16_RXEN_PRE_CYCLESf, 0));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD2_RXEN_RXBV_GEN_CONFIGr, &data, HBM16_RXEN_POST_CYCLESf, 0));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD0_RXEN_RXBV_GEN_CONFIGr, &data, HBM16_FORCE_RXENf, 0));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD2_RXEN_RXBV_GEN_CONFIGr(unit, hbm_ndx, channel, data));
            SOC_IF_ERROR_RETURN(READ_HBM16_DWORD3_RXEN_RXBV_GEN_CONFIGr(unit, hbm_ndx, channel, &data));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD3_RXEN_RXBV_GEN_CONFIGr, &data, HBM16_RXEN_PRE_CYCLESf, 0));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD3_RXEN_RXBV_GEN_CONFIGr, &data, HBM16_RXEN_POST_CYCLESf, 0));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD0_RXEN_RXBV_GEN_CONFIGr, &data, HBM16_FORCE_RXENf, 0));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD3_RXEN_RXBV_GEN_CONFIGr(unit, hbm_ndx, channel, data));
    ...
    uint32 mode)
{
    ...
    switch ((*scPtr).shmooType)
    {
        case SHMOO_HBM16_RD_EN_FISH:
            SOC_IF_ERROR_RETURN(READ_HBM16_DWORD0_RXEN_RXBV_GEN_CONFIGr(unit, hbm_ndx, channel, &data));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD0_RXEN_RXBV_GEN_CONFIGr, &data, HBM16_RXEN_PRE_CYCLESf, 2));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD0_RXEN_RXBV_GEN_CONFIGr, &data, HBM16_RXEN_POST_CYCLESf, 2));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD0_RXEN_RXBV_GEN_CONFIGr(unit, hbm_ndx, channel, data));
            SOC_IF_ERROR_RETURN(READ_HBM16_DWORD1_RXEN_RXBV_GEN_CONFIGr(unit, hbm_ndx, channel, &data));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD1_RXEN_RXBV_GEN_CONFIGr, &data, HBM16_RXEN_PRE_CYCLESf, 2));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD1_RXEN_RXBV_GEN_CONFIGr, &data, HBM16_RXEN_POST_CYCLESf, 2));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD1_RXEN_RXBV_GEN_CONFIGr(unit, hbm_ndx, channel, data));
            SOC_IF_ERROR_RETURN(READ_HBM16_DWORD2_RXEN_RXBV_GEN_CONFIGr(unit, hbm_ndx, channel, &data));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD2_RXEN_RXBV_GEN_CONFIGr, &data, HBM16_RXEN_PRE_CYCLESf, 2));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD2_RXEN_RXBV_GEN_CONFIGr, &data, HBM16_RXEN_POST_CYCLESf, 2));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD2_RXEN_RXBV_GEN_CONFIGr(unit, hbm_ndx, channel, data));
            SOC_IF_ERROR_RETURN(READ_HBM16_DWORD3_RXEN_RXBV_GEN_CONFIGr(unit, hbm_ndx, channel, &data));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD3_RXEN_RXBV_GEN_CONFIGr, &data, HBM16_RXEN_PRE_CYCLESf, 2));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD3_RXEN_RXBV_GEN_CONFIGr, &data, HBM16_RXEN_POST_CYCLESf, 2));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD3_RXEN_RXBV_GEN_CONFIGr(unit, hbm_ndx, channel, data));
            break;
        case SHMOO_HBM16_RD_EXTENDED:
            break;
...
_shmoo_hbm16_save(
    ...
    int hbm_ndx,
    int channel,
    hbmc_shmoo_config_param_t * config_param)
{
    uint32 regval;
    int metadata_ndx;
    ...
    for (metadata_ndx = 0; metadata_ndx < HBMC_SHMOO_CHANNEL_METADATA_SIZE; metadata_ndx++)
    {
        ...
        if (HBMC_SHMOO_FIELDS_ALL != channel_config_param_metadata[metadata_ndx].field)
        {
            ...
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_get
                                (unit, channel_config_param_metadata[metadata_ndx].reg, regval,
                                 channel_config_param_metadata[metadata_ndx].field,
                                 &config_param->channel_data[channel][metadata_ndx].value));
        }

        else
        {
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_read(unit, hbm_ndx, channel,
                                                       channel_config_param_metadata[metadata_ndx].reg, 0,
                                                       &config_param->channel_data[channel][metadata_ndx].value));
        }
    ...
    for (metadata_ndx = 0; metadata_ndx < HBMC_SHMOO_MIDSTACK_METADATA_SIZE; metadata_ndx++)
    {
        ...
        {
            SOC_IF_ERROR_RETURN(soc_hbm16_midstack_read
                                (unit, hbm_ndx, midstack_config_param_metadata[metadata_ndx].reg, 0, &regval));
            SOC_IF_ERROR_RETURN(soc_hbm16_midstack_field_get
                                (unit, midstack_config_param_metadata[metadata_ndx].reg, regval,
                                 midstack_config_param_metadata[metadata_ndx].field,
        ...
        {
            SOC_IF_ERROR_RETURN(soc_hbm16_midstack_read
                                (unit, hbm_ndx, midstack_config_param_metadata[metadata_ndx].reg, 0,
                                 &config_param->midstack_data[metadata_ndx].value));
        }
            ...
            if (HBMC_SHMOO_FIELDS_ALL != channel_config_param_metadata[metadata_ndx].field)
            {
                ...
                SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                    (unit, channel_config_param_metadata[metadata_ndx].reg, &regval,
                                     ...
                                     config_param->channel_data[channel][metadata_ndx].value));
                SOC_IF_ERROR_RETURN(soc_hbm16_channel_write
                                    (unit, hbm_ndx, channel, channel_config_param_metadata[metadata_ndx].reg, 0,
                                     regval));
            }
            ...
            if (HBMC_SHMOO_FIELDS_ALL != midstack_config_param_metadata[metadata_ndx].field)
            {
                ...
                SOC_IF_ERROR_RETURN(soc_hbm16_midstack_field_set
                                    (unit, midstack_config_param_metadata[metadata_ndx].reg, &regval,
                                     midstack_config_param_metadata[metadata_ndx].field,
                                     config_param->midstack_data[metadata_ndx].value));
                SOC_IF_ERROR_RETURN(soc_hbm16_midstack_write
                                    (unit, hbm_ndx, midstack_config_param_metadata[metadata_ndx].reg, 0, regval));
            }
    ...
    hbmc_shmoo_config_param_t * config_param)
{
    ...
    {
        LOG_ERROR(BSL_LS_SOC_DDR,
                  (BSL_META_U(unit, "Invalid PHY PLL or DRAM configuration identified during Shmoo\n")));
        return SOC_E_FAIL;
    }
            ...
            for (; chn < chnEnd; chn++)
            {
                if (action == SHMOO_HBM16_ACTION_RESTORE)
                {
                    ...
                    switch (ctlType)
                    {
                        ...
                        default:
                            LOG_ERROR(BSL_LS_SOC_DDR,
                                      (BSL_META_U(unit, "Unsupported controller type: %02d\n"), ctlType));
                ...
                if ((action == SHMOO_HBM16_ACTION_RUN) || (action == SHMOO_HBM16_ACTION_RUN_AND_SAVE)
                    || (action == SHMOO_HBM16_ACTION_RESTORE))
                {
                    switch (ctlType)
                    {
                        case SHMOO_HBM16_CTL_TYPE_RSVP:
                        ...
                        case SHMOO_HBM16_CTL_TYPE_1:
                            if ((*scPtr).restore)
                            {
                                switch (dramType)
                                {
                                    ...
                                    default:
                                        LOG_ERROR(BSL_LS_SOC_DDR,
                                                  (BSL_META_U(unit, "Unsupported dram type: %02d\n"), dramType));
                                        _SOC_EXIT_WITH_ERR(SOC_E_FAIL, (BSL_META("%s\n"), soc_errmsg(SOC_E_FAIL)));
                                }
                            }
                            else
    ...
    else
    {
        ...
        switch (ctlType)
        {
            ...
            case SHMOO_HBM16_CTL_TYPE_1:
                break;
            default:
                LOG_ERROR(BSL_LS_SOC_DDR, (BSL_META_U(unit, "Unsupported controller type: %02d\n"), ctlType));
                _SOC_EXIT_WITH_ERR(SOC_E_FAIL, (BSL_META("%s\n"), soc_errmsg(SOC_E_FAIL)));
        }
    }
    ...
    int hbm_ndx)
{
    ...
    {
        LOG_ERROR(BSL_LS_SOC_DDR,
                  (BSL_META_U(unit, "Invalid PHY PLL or DRAM configuration identified during PLL initialization\n")));
        return SOC_E_FAIL;
    }
    ...
    int channel)
{
    ...
    {
        LOG_ERROR(BSL_LS_SOC_DDR,
                  (BSL_META_U(unit, "Invalid PHY PLL or DRAM configuration identified during PHY initialization\n")));
        return SOC_E_FAIL;
    }
    ...
    for (; ndx < ndxEnd; ndx++)
    {
        ...
        {
            LOG_INFO(BSL_LS_SOC_DDR,
                     (BSL_META_U(unit, "C Series - PHY Initialization (HBM index: %d / Channel index: %d)\n"), ndx,
                      chn));

            LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "C01. Reset all PHY logic\n")));
            reset_ctrl_data = 0;
            SOC_IF_ERROR_RETURN(WRITE_HBM16_CONTROL_RESETSr(unit, ndx, chn, reset_ctrl_data));
            sal_usleep(SHMOO_HBM16_SHORT_SLEEP);

            LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "C02. Configure input shift control\n")));
            data = 0;
            switch (dramType)
            {
                case SHMOO_HBM16_DRAM_TYPE_GEN2:
                    SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                        (unit, HBM16_DWORD0_LATENCY_SHIFTERr, &data, HBM16_DATA_PATH_SHIFT_ENABLEf, 0));
                    SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                        (unit, HBM16_DWORD0_LATENCY_SHIFTERr, &data,
                                         HBM16_DATA_PATH_ADDITIONAL_LATENCYf, 0));
                    SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                        (unit, HBM16_DWORD0_LATENCY_SHIFTERr, &data, HBM16_RCMD_SHIFT_ENABLEf, 1));
                    SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                        (unit, HBM16_DWORD0_LATENCY_SHIFTERr, &data, HBM16_RCMD_ADDITIONAL_LATENCYf,
                                         12));
                    break;
            }
            ...
            switch (dramType)
            {
                case SHMOO_HBM16_DRAM_TYPE_GEN2:
                    SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                        (unit, HBM16_AWORD_LATENCY_SHIFTERr, &data, HBM16_DATA_PATH_SHIFT_ENABLEf, 0));
                    SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                        (unit, HBM16_AWORD_LATENCY_SHIFTERr, &data, HBM16_DATA_PATH_ADDITIONAL_LATENCYf,
                                         0));
                    break;
            }
            ...
            LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "C03. Configure reference voltage\n")));
            data = 0;
            ...
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD0_DAC_CONFIGr, &data, HBM16_DAC_DATAf, dac_data_val));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_AWORD_DAC_CONFIGr(unit, ndx, chn, data));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD0_DAC_CONFIGr(unit, ndx, chn, data));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD1_DAC_CONFIGr(unit, ndx, chn, data));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD2_DAC_CONFIGr(unit, ndx, chn, data));
            ...
            LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "C04. Compute VDL step size\n")));
            ...
            LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "C05. Configure read clock\n")));
            data = 0;
            switch (dramType)
            {
                case SHMOO_HBM16_DRAM_TYPE_GEN2:
                    SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                        (unit, HBM16_DWORD0_READ_MACHINE_CONFIGr, &data, HBM16_CONTINUOUS_MODEf, 0));
                    break;
            }
            ...
            {
                data = 0;
                setting = size1000UI / 1000;
                SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                    (unit, HBM16_DWORD0_READ_MAX_VDL_FSMr, &data, HBM16_MAX_VDL_STEPf, setting));
            ...
            LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "C06. Configure UI shifts\n")));
            switch (dramType)
            {
                case SHMOO_HBM16_DRAM_TYPE_GEN2:
            ...
            data = 0;
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_AWORD_WRITE_MAX_VDL_CKr, &data, HBM16_UI_SHIFTf, ck_ui));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_AWORD_WRITE_MAX_VDL_CKr(unit, ndx, chn, data));

            data = 0;
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_AWORD_WRITE_MAX_VDL_ADDRr, &data, HBM16_UI_SHIFTf, addr_ctrl_ui));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_AWORD_WRITE_MAX_VDL_ADDRr(unit, ndx, chn, data));

            data = 0;
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD0_WRITE_MAX_VDL_DQSr, &data, HBM16_UI_SHIFTf, dqs_ui));
            ...
            data = 0;
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD0_WRITE_MAX_VDL_DATAr, &data, HBM16_UI_SHIFTf, data_ui));
            ...
            LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "C07. Configure VDLs\n")));
            SOC_IF_ERROR_RETURN(READ_HBM16_DWORD0_WRITE_MAX_VDL_DQSr(unit, ndx, chn, &data));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD0_WRITE_MAX_VDL_DQSr, &data, HBM16_MAX_VDL_STEPf, 0));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD0_WRITE_MAX_VDL_DQSr(unit, ndx, chn, data));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD1_WRITE_MAX_VDL_DQSr(unit, ndx, chn, data));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD2_WRITE_MAX_VDL_DQSr(unit, ndx, chn, data));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD3_WRITE_MAX_VDL_DQSr(unit, ndx, chn, data));

            SOC_IF_ERROR_RETURN(READ_HBM16_DWORD0_READ_MAX_VDL_DQS_Pr(unit, ndx, chn, &data));
            setting = (size1000UI * 435) / 1000000;
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD0_READ_MAX_VDL_DQS_Pr, &data, HBM16_MAX_VDL_STEPf, setting));
            ...
            SOC_IF_ERROR_RETURN(READ_HBM16_DWORD0_WRITE_MAX_VDL_DATAr(unit, ndx, chn, &data));
            setting = (size1000UI * 462) / 1000000;
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD0_WRITE_MAX_VDL_DATAr, &data, HBM16_MAX_VDL_STEPf, setting));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD0_WRITE_MAX_VDL_DATAr(unit, ndx, chn, data));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD1_WRITE_MAX_VDL_DATAr(unit, ndx, chn, data));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD2_WRITE_MAX_VDL_DATAr(unit, ndx, chn, data));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD3_WRITE_MAX_VDL_DATAr(unit, ndx, chn, data));
            ...
            SOC_IF_ERROR_RETURN(READ_HBM16_AWORD_WRITE_MAX_VDL_ADDRr(unit, ndx, chn, &data));
            setting = (size1000UI * 462) / 1000000;
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_AWORD_WRITE_MAX_VDL_ADDRr, &data, HBM16_MAX_VDL_STEPf, setting));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_AWORD_WRITE_MAX_VDL_ADDRr(unit, ndx, chn, data));
            sal_usleep(SHMOO_HBM16_SHORT_SLEEP);

            LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "C08. Configure Lane Repair\n")));
            ...
            LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "C09. Configure IOs\n")));
            single_ended_drive = 4;
            differential_drive = 4;

            LOG_INFO(BSL_LS_SOC_DDR,
                     (BSL_META_U(unit, "              Single-ended Drive...............: 0x%02X\n"),
                      single_ended_drive));
            LOG_INFO(BSL_LS_SOC_DDR,
                     (BSL_META_U(unit, "              Differential Drive...............: 0x%02X\n"),
                      differential_drive));
            ...
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_AWORD_IO_CONFIGr, &data, HBM16_SINGLE_PORT_AQ_DRIVE_STRENGTHf,
                                 single_ended_drive));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_AWORD_IO_CONFIGr, &data, HBM16_DIFF_PORT_CK_DRIVE_STRENGTHf,
                                 differential_drive));
            ...
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD0_IO_CONFIGr, &data, HBM16_RXENB_DERRf, 0));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD0_IO_CONFIGr, &data, HBM16_RXENB_RDQSf, 0));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD0_IO_CONFIGr, &data, HBM16_SINGLE_PORT_DQ_DRIVE_STRENGTHf,
                                 single_ended_drive));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD0_IO_CONFIGr, &data, HBM16_DIFF_PORT_DQS_DRIVE_STRENGTHf,
                                 differential_drive));
            ...
            LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "C10. Configure FSMs\n")));
            SOC_IF_ERROR_RETURN(READ_HBM16_DWORD0_READ_MACHINE_CONFIGr(unit, ndx, chn, &data));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD0_READ_MACHINE_CONFIGr, &data, HBM16_RDATA_FIFO_WR2RD_DELAYf, 4));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD0_READ_MACHINE_CONFIGr(unit, ndx, chn, data));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD1_READ_MACHINE_CONFIGr(unit, ndx, chn, data));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD2_READ_MACHINE_CONFIGr(unit, ndx, chn, data));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD3_READ_MACHINE_CONFIGr(unit, ndx, chn, data));
            ...
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD0_RXEN_RXBV_GEN_CONFIGr, &data, HBM16_RXEN_PRE_CYCLESf, 2));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD0_RXEN_RXBV_GEN_CONFIGr, &data, HBM16_PAR_LATENCYf,
                                 shmoo_dram_info.parity_latency));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD0_RXEN_RXBV_GEN_CONFIGr, &data, HBM16_RD_DATA_DELAYf, 8));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD0_RXEN_RXBV_GEN_CONFIGr, &data, HBM16_FORCE_RXENf, 1));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD0_RXEN_RXBV_GEN_CONFIGr, &data, HBM16_AUTO_UPDATEf, 1));
            ...
            LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "C11. Release PHY resets\n")));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_CONTROL_RESETSr, &reset_ctrl_data, HBM16_PHY_RSTB_1Gf, 1));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_CONTROL_RESETSr(unit, ndx, chn, reset_ctrl_data));
            sal_usleep(SHMOO_HBM16_SHORT_SLEEP);

            LOG_INFO(BSL_LS_SOC_DDR, (BSL_META_U(unit, "C12. Enable FSMs\n")));
            SOC_IF_ERROR_RETURN(READ_HBM16_DWORD0_RXEN_RXBV_GEN_CONFIGr(unit, ndx, chn, &data));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD0_RXEN_RXBV_GEN_CONFIGr, &data, HBM16_ENABLEf, 1));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD0_RXEN_RXBV_GEN_CONFIGr(unit, ndx, chn, data));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD1_RXEN_RXBV_GEN_CONFIGr(unit, ndx, chn, data));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD2_RXEN_RXBV_GEN_CONFIGr(unit, ndx, chn, data));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD3_RXEN_RXBV_GEN_CONFIGr(unit, ndx, chn, data));
            ...
            SOC_IF_ERROR_RETURN(READ_HBM16_DWORD0_READ_MACHINE_CONFIGr(unit, ndx, chn, &data));
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD0_READ_MACHINE_CONFIGr, &data, HBM16_ENABLEf, 1));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD0_READ_MACHINE_CONFIGr(unit, ndx, chn, data));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD1_READ_MACHINE_CONFIGr(unit, ndx, chn, data));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD2_READ_MACHINE_CONFIGr(unit, ndx, chn, data));
            SOC_IF_ERROR_RETURN(WRITE_HBM16_DWORD3_READ_MACHINE_CONFIGr(unit, ndx, chn, data));
            ...
            SOC_IF_ERROR_RETURN(soc_hbm16_channel_field_set
                                (unit, HBM16_DWORD0_BV_GEN_CONFIGr, &data, HBM16_ENABLEf, 1));
            ...
            LOG_INFO(BSL_LS_SOC_DDR,
                     (BSL_META_U(unit, "C Series - PHY Initialization complete (HBM index: %d / Channel index: %d)\n"),
                      ndx, chn));
        }
    }
...
int
soc_hbm16_shmoo_interface_cb_register(
    int unit,
...
soc_hbm16_shmoo_channel_config_param_metadata_get(
    void)
{
    return channel_config_param_metadata;
}
const hbmc_shmoo_midstack_config_param_t *
soc_hbm16_shmoo_midstack_config_param_metadata_get(
    void)
{
