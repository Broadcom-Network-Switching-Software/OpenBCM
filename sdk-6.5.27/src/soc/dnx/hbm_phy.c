...
int
soc_hbm16_midstack_field_size_get(
    int unit,
    soc_reg_t reg,
    soc_field_t field,
    uint32 *field_size)
...
int
soc_hbm16_channel_field_size_get(
    int unit,
    soc_reg_t reg,
    soc_field_t field,
    uint32 *field_size)
