    ...
    int unit)
{
    ...
    if (ACCESS_IS_INITIALIZED(unit))
    {
        ...
        SHR_IF_ERR_EXIT(access_dnxc_regmem_cache_init(unit));
        if (SOC_WARM_BOOT(unit))
        {
            SHR_IF_ERR_EXIT(access_regmem_cache_recovery(unit));
        }
        SHR_EXIT();
    }
#endif
    ...
    int unit)
{
    ...
    if (ACCESS_IS_INITIALIZED(unit))
    {
        SHR_IF_ERR_EXIT(access_dnxc_regmem_cache_deinit(unit));
        SHR_EXIT();
    }
#endif
