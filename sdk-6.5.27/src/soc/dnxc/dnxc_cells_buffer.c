    ...
    int max_buffered_cells)
{
    ...
    rc = cyclic_buffer_create(unit, cells_buffer, sizeof(dnxc_sr_cell_t), max_buffered_cells, "cells_buffer->cells");
    SHR_IF_ERR_EXIT(rc);
