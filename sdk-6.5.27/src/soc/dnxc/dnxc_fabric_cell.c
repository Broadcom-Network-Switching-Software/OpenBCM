    ...
    uint32 *buf)
{
    ...
    soc_dnxc_fabric_cell_parse_table_t *table_pointer = NULL;
    ...
    if (max_vsc_format_size == DNXC_VSC256_DESTINATION_ROUTED_CELL_PAYLOAD_SIZE_BYTES)
    {
        switch (nof_pipes)
        {
            case 1:
                table_pointer = vsc256_parse_table_1_pipe;
                break;
            case 2:
                table_pointer = vsc256_parse_table_2_pipe;
                break;
            case 3:
                table_pointer = vsc256_parse_table_3_pipe;
                break;
            default:
