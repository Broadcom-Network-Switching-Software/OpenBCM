...
{
    uint32 module_id = DNXC_SW_STATE_LAYOUT_GET_MODULE_ID(node_id);
    ...
    if (dnxc_sw_state_is_warmboot_supported_get(unit) && implementation == DNXC_SW_STATE_IMPLEMENTATION_WB) {
        ...
        dnxc_sw_state_dispatcher[unit][module_id].memcpy = dnxc_sw_state_memcpy_wb;
        dnxc_sw_state_dispatcher[unit][module_id].memset = dnxc_sw_state_memset_wb;
        dnxc_sw_state_dispatcher[unit][module_id].counter_inc = dnxc_sw_state_counter_inc_wb;
        dnxc_sw_state_dispatcher[unit][module_id].counter_dec = dnxc_sw_state_counter_dec_wb;
        ...
        dnxc_sw_state_dispatcher[unit][module_id].module_size_update = dnxc_sw_state_wb_module_size_update;
        dnxc_sw_state_dispatcher[unit][module_id].module_size_get = dnxc_sw_state_wb_module_size_get;
        dnxc_sw_state_dispatcher[unit][module_id].layout_init = dnxc_sw_state_layout_init_wb;
        dnxc_sw_state_dispatcher[unit][module_id].layout_deinit = dnxc_sw_state_layout_deinit_wb;
        return _SHR_E_NONE;
    }
#endif
     ...
     dnxc_sw_state_dispatcher[unit][module_id].memcpy = dnxc_sw_state_memcpy_plain;
     dnxc_sw_state_dispatcher[unit][module_id].memset = dnxc_sw_state_memset_plain;
     dnxc_sw_state_dispatcher[unit][module_id].counter_inc = dnxc_sw_state_counter_inc_plain;
     dnxc_sw_state_dispatcher[unit][module_id].counter_dec = dnxc_sw_state_counter_dec_plain;
     ...
     dnxc_sw_state_dispatcher[unit][module_id].module_size_update = dnxc_sw_state_plain_module_size_update;
     dnxc_sw_state_dispatcher[unit][module_id].module_size_get = dnxc_sw_state_plain_module_size_get;
     dnxc_sw_state_dispatcher[unit][module_id].layout_init = dnxc_sw_state_layout_init_plain;
     dnxc_sw_state_dispatcher[unit][module_id].layout_deinit = dnxc_sw_state_layout_deinit_plain;
     return _SHR_E_NONE;
}
