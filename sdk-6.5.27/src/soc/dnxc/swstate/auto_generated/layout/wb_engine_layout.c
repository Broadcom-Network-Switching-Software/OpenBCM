...
wb_engine_init_layout_structure(int unit)
{
    ...
    layout_array_wb_engine[idx].sum_of_allocation = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_wb_engine[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_SW_STATE_WB_ENGINE__LAST)-1;
    ...
    layout_array_wb_engine[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_SW_STATE_WB_ENGINE__BUFFER__LAST)-1;
