...
int dnxc_sw_state_verifications_init(
    ...
    SW_STATE_VERF_MATRIX_INIT(SW_STATE_FUNC_TRAVERSE,                   1,    1,    0,    0);
    ...
    SW_STATE_VERF_MATRIX_INIT(SW_STATE_FUNC_DELETE_ALL_TABLES,          1,    1,    0,    0);
    ...
    SW_STATE_VERF_MATRIX_INIT(SW_STATE_FUNC_GET_FREE_SLOTS,             1,    1,    1,    1);
