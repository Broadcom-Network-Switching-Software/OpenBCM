...
void arad_pp_dbal_tt_program_mc_pppoe_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 unused);
...
ARAD_PP_DBAL_VTT_PROGRAM_INFO tt_dbal_programs[ARAD_PP_DBAL_TT_NOF_PROGRAMS] = {
    ...
    {ARAD_PP_DBAL_TT_PROG_MC_PPPOE                      , arad_pp_dbal_tt_program_mc_pppoe_property_set                       , {-1}    , 0                        }
...
int32 arad_pp_dbal_tt_cam_mc_pppoe_set(int unit, ARAD_PP_IHP_VTT2ND_KEY_PROGRAM_SELECTION_CAM_TBL_DATA   *prog_selection, int next_line, uint32 unused       );
...
ARAD_PP_DBAL_TT_PROGRAM_SELECTION_INFO tt_dbal_program_selection[ARAD_PP_DBAL_TT_NOF_PROGRAM_SELECTION] = {
        ...
        {ARAD_PP_DBAL_TT_PROG_SELECTION_MC_PPPOE                                     , arad_pp_dbal_tt_cam_mc_pppoe_set                         , {-1}, {ARAD_PP_DBAL_TT_PROG_INVALID}, 0                    },
...
void arad_pp_dbal_tt_program_ipv4_for_explicit_mpls_property_set(int unit, ARAD_PP_DBAL_VTT_PROGRAM_PROPERTY  *program_property, uint32 unused)
{
    ...
    program_property->result_to_use_1          = (0);                                        
    program_property->result_to_use_2          = (0);                                        
    program_property->second_stage_parsing     = (0x1);                                    
