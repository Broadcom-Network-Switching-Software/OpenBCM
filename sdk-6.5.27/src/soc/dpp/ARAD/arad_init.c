  ...
  )
{
  ...
  SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  36,  exit, ARAD_REG_ACCESS_ERR,WRITE_BRDC_FMAC_CNTRL_INTRLVD_MODE_REGr(unit, 0xf));
    ...
    SOC_SAND_IN  ARAD_MGMT_INIT               *init)
{
    ...
    SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  100,  exit, ARAD_REG_ACCESS_ERR,soc_reg32_get(unit, IRE_STATIC_CONFIGURATIONr, REG_PORT_ANY, 0, &reg_val));
    soc_reg_field_set(unit, IRE_STATIC_CONFIGURATIONr, &reg_val, STAMP_UC_DESTINATION_IN_FTMHf, 0x1);
    SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  110,  exit, ARAD_REG_ACCESS_ERR,soc_reg32_set(unit, IRE_STATIC_CONFIGURATIONr, REG_PORT_ANY, 0, reg_val));
  ...
  )
{
  ...
  SOC_SAND_SOC_IF_ERROR_RETURN(res, 140, exit, soc_reg32_get(unit, IRE_STATIC_CONFIGURATIONr, REG_PORT_ANY, 0, &val32));
  soc_reg_field_set(unit, IRE_STATIC_CONFIGURATIONr, &val32, ENABLE_DATA_PATHf, 1);
  SOC_SAND_SOC_IF_ERROR_RETURN(res, 150, exit, soc_reg32_set(unit, IRE_STATIC_CONFIGURATIONr, REG_PORT_ANY, 0, val32));
  ...
  SOC_SAND_SOC_IF_ERROR_RETURN(res, 420, exit, soc_reg32_get(unit, IRE_STATIC_CONFIGURATIONr, REG_PORT_ANY, 0, &val32));
  soc_reg_field_set(unit, IRE_STATIC_CONFIGURATIONr, &val32, ENABLE_DATA_PATHf, 0);
  SOC_SAND_SOC_IF_ERROR_RETURN(res, 430, exit, soc_reg32_set(unit, IRE_STATIC_CONFIGURATIONr, REG_PORT_ANY, 0, val32));
