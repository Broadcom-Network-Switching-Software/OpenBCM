...
STATIC
 int
 jerp_soft_reset(int unit, int block_instance, uint32 en_interrupt, char *msg)
 {
...
void jerp_interrupt_cb_init(int unit)
{
    ...
    dcmn_intr_add_handler(unit, JERP_INT_IQM_DRAM_DYN_SIZE_ROLL_OVER, 0,0,jerp_soft_reset,NULL);
