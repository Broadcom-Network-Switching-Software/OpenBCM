...
STATIC
kaps_jr1_status qax_kaps_translate_blk_func_offset_to_mem_reg(int unit,
                                                         uint8 blk_id,
                                                         uint32 func,
                                                         uint32 offset,
                                                         soc_mem_t *mem,
                                     ...
                                     uint8 *bytes)
{
    ...
    if (mem != INVALIDm) {
        ...
        if ((func == KAPS_JR1_FUNC5) && ((mem == KAPS_BUCKET_MEMORYm) || (mem == KAPS_BBS_BUCKET_MEMORYm))) {
