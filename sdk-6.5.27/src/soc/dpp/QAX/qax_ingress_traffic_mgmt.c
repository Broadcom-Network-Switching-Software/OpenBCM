  ...
  )
{
    ...
    data = 0;
    res = READ_IPS_SRAM_TO_DRAM_CONFIGURATIONSr(unit, &data);
    SOCDNX_IF_ERR_EXIT(res);
    soc_reg_field_set(unit, IPS_SRAM_TO_DRAM_CONFIGURATIONSr, &data, FIELD_2_2f, FALSE);
    res = WRITE_IPS_SRAM_TO_DRAM_CONFIGURATIONSr(unit, data);
    SOCDNX_IF_ERR_EXIT(res);
