...
STATIC
 int
 jer_intr_handle_soft_reset(int unit, int block_instance, uint32 en_interrupt, char *msg)
 {
...
void jer_interrupt_cb_init(int unit)
{
    ...
    dcmn_intr_add_handler(unit, JER_INT_EDB_ESEM_ONE_ESEM_ERROR_TABLE_COHERENCY, 0,0,dcmn_interrupt_handle_EDB_EsemErrorTableCoherency_Int,NULL);
    dcmn_intr_add_handler(unit, JER_INT_EDB_GLEM_ONE_GLEM_ERROR_TABLE_COHERENCY, 0,0,dcmn_interrupt_handle_EDB_GlemErrorTableCoherency_Int,NULL);

    
    dcmn_intr_add_handler(unit, JER_INT_IQM_DRAM_DYN_SIZE_ROLL_OVER, 0,0,jer_intr_handle_soft_reset,NULL);
