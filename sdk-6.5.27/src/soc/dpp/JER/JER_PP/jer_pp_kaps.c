...
#ifdef USE_MODEL
#include <libs/kaps_jr1/include/kaps_jr1_sw_model.h>
#endif
    ...
    JER_KAPS_TABLE_CONFIG
        jer_kaps_table_config_info_static[JER_KAPS_IP_NOF_TABLES] = {
            ...
            {   
                ...
                {3, {{"TBL_ID_0", JER_KAPS_TABLE_PREFIX_LENGTH, KAPS_JR1_KEY_FIELD_TABLE_ID}, {"IPV4: VRF_0 + DIP_0", 14 + 32 + (112 ), KAPS_JR1_KEY_FIELD_PREFIX}}}, 
                NULL 
            },
            ...
            {   
                ...
                JER_KAPS_TABLE_USE_DB_HANDLE, 
                {3, {{"TBL_ID_1", JER_KAPS_TABLE_PREFIX_LENGTH, KAPS_JR1_KEY_FIELD_TABLE_ID}, {"IPV4: VRF_1 + SIP_1", 14 + 32 + (112 ), KAPS_JR1_KEY_FIELD_PREFIX}}}, 
                NULL 
            }, 
            ...
            {   
                ...
                {3, {{"TBL_ID_2", JER_KAPS_TABLE_PREFIX_LENGTH, KAPS_JR1_KEY_FIELD_TABLE_ID}, {"VRF_2", 14, KAPS_JR1_KEY_FIELD_EM}, {"DIP_2", 128+ (16 ), KAPS_JR1_KEY_FIELD_PREFIX}}}, 
                NULL 
            },
            ...
            {   
                ...
                {3, {{"TBL_ID_3", JER_KAPS_TABLE_PREFIX_LENGTH, KAPS_JR1_KEY_FIELD_TABLE_ID}, {"VRF_3", 14, KAPS_JR1_KEY_FIELD_EM}, {"SIP_3", 128+ (16 ), KAPS_JR1_KEY_FIELD_PREFIX}}}, 
                NULL 
            }, 
            ...
            {   
                JER_KAPS_IP_CORE_0_PRIVATE_DB_ID,  
                JER_KAPS_IP_NOF_TABLES, 
                {3, {{"TBL_ID_4", JER_KAPS_TABLE_PREFIX_LENGTH, KAPS_JR1_KEY_FIELD_TABLE_ID}, {"VRF_4", 14, KAPS_JR1_KEY_FIELD_EM}, {"MC-G-SIP-INRIF_4", 28 + 32 + 15 + (69 ), KAPS_JR1_KEY_FIELD_PREFIX}}}, 
                NULL 
            },
            ...
            {   
                JER_KAPS_IP_CORE_0_PRIVATE_DB_ID,  
                JER_KAPS_IP_NOF_TABLES, 
                {4, {{"TBL_ID_5", JER_KAPS_TABLE_PREFIX_LENGTH, KAPS_JR1_KEY_FIELD_TABLE_ID}, {"VRF_5", 14, KAPS_JR1_KEY_FIELD_EM}, {"MC-GROUP_5", 128, KAPS_JR1_KEY_FIELD_EM}, {"INRIF_5", 15 + (1 ), KAPS_JR1_KEY_FIELD_PREFIX}}}, 
                NULL 
            },
            ...
            {   
                JER_KAPS_IP_CORE_0_PUBLIC_DB_ID,  
                JER_KAPS_TABLE_USE_DB_HANDLE, 
                {3, {{"TBL_ID_6", JER_KAPS_TABLE_PREFIX_LENGTH, KAPS_JR1_KEY_FIELD_TABLE_ID}, {"IPV4: VRF_6 + DIP_6", 14 + 32 + (112 ), KAPS_JR1_KEY_FIELD_PREFIX}}}, 
                NULL 
            },
            ...
            {   
                ...
                JER_KAPS_TABLE_USE_DB_HANDLE, 
                {3, {{"TBL_ID_7", JER_KAPS_TABLE_PREFIX_LENGTH, KAPS_JR1_KEY_FIELD_TABLE_ID}, {"IPV4: VRF_7 + SIP_7", 14 + 32 + (112 ), KAPS_JR1_KEY_FIELD_PREFIX}}}, 
                NULL 
            }, 
            ...
            {   
                JER_KAPS_IP_CORE_0_PUBLIC_DB_ID,  
                JER_KAPS_IP_NOF_TABLES, 
                {3, {{"TBL_ID_8", JER_KAPS_TABLE_PREFIX_LENGTH, KAPS_JR1_KEY_FIELD_TABLE_ID}, {"VRF_8", 14, KAPS_JR1_KEY_FIELD_EM}, {"DIP_8", 128 + (16 ), KAPS_JR1_KEY_FIELD_PREFIX}}}, 
                NULL 
            },
            ...
            {   
                ...
                {3, {{"TBL_ID_9", JER_KAPS_TABLE_PREFIX_LENGTH, KAPS_JR1_KEY_FIELD_TABLE_ID}, {"VRF_9", 14, KAPS_JR1_KEY_FIELD_EM}, {"SIP_9", 128 + (16 ), KAPS_JR1_KEY_FIELD_PREFIX}}}, 
                NULL 
            }, 
            ...
            {   
                JER_KAPS_IP_CORE_0_PUBLIC_DB_ID,  
                JER_KAPS_IP_NOF_TABLES, 
                {3, {{"TBL_ID_10", JER_KAPS_TABLE_PREFIX_LENGTH, KAPS_JR1_KEY_FIELD_TABLE_ID}, {"VRF_10", 14, KAPS_JR1_KEY_FIELD_EM}, {"MC-G-SIP-INRIF_10", 28 + 32 + 15 + (69 ), KAPS_JR1_KEY_FIELD_PREFIX}}}, 
                NULL 
            },
            ...
            {   
                JER_KAPS_IP_CORE_0_PUBLIC_DB_ID,  
                JER_KAPS_IP_NOF_TABLES, 
                {4, {{"TBL_ID_11", JER_KAPS_TABLE_PREFIX_LENGTH, KAPS_JR1_KEY_FIELD_TABLE_ID}, {"VRF_11", 14, KAPS_JR1_KEY_FIELD_EM}, {"MC-GROUP_11", 128, KAPS_JR1_KEY_FIELD_EM}, {"INRIF_11", 15 + (1 ), KAPS_JR1_KEY_FIELD_PREFIX}}}, 
                NULL 
            },
        };  
...
STATIC int jer_kaps_init_device(int unit)
{
    ...
    res = kaps_jr1_sw_model_init(JerAppData[unit]->dalloc_p, KAPS_JR1_DEVICE, KAPS_JR1_DEVICE_DEFAULT,
                              KAPS_JR1_DEFAULT_DEVICE_ID, 0, 0, &(JerAppData[unit]->kaps_xpt_p));
    if(JER_KAPS_TO_SOC_RESULT(res) != SOC_SAND_OK) {
       LOG_ERROR(BSL_LS_SOC_TCAM,
                 (BSL_META_U(unit,
                             "Error in %s(): kaps_jr1_sw_model_init with failed: %s!\n"), 
                             FUNCTION_NAME(),
    ...
    flags = KAPS_JR1_DEVICE_DEFAULT | KAPS_JR1_DEVICE_ISSU;
    if (SOC_WARM_BOOT(unit)) {
        flags |= KAPS_JR1_DEVICE_SKIP_INIT;
    }
    KAPS_JR1_TRY(kaps_jr1_device_init(KAPS_JR1_DEVICE_PAIR_TYPE_A,
                            flags, 
                            (struct kaps_jr1_xpt*)JerAppData[unit]->kaps_xpt_p,
                            &JerAppData[unit]->kaps_device_p));
    {
        if (SOC_WARM_BOOT(unit)) {
            res = kaps_jr1_device_restore_state(JerAppData[unit]->kaps_device_p, warmboot_data->kaps_file_read , warmboot_data->kaps_file_write, warmboot_data->kaps_file_fp);
            if(JER_KAPS_TO_SOC_RESULT(res) != SOC_SAND_OK) {
                LOG_ERROR(BSL_LS_SOC_TCAM,
                          (BSL_META_U(unit,
    ...
    if (!SOC_WARM_BOOT(unit)) {
       LOG_VERBOSE(BSL_LS_SOC_TCAM,
        ...
        if (db_config_info->clone_of_db_id == JER_KAPS_IP_NOF_DB) {
            ...
            KAPS_JR1_TRY(kaps_jr1_ad_db_init(
                        JerAppData[unit]->kaps_device_p, 
                        db_id,
                        db_config_info->db_size, 
                        JER_KAPS_AD_WIDTH_IN_BITS,
            ...
            KAPS_JR1_TRY(kaps_jr1_db_set_ad(db_config_info->db_p,
                                  db_config_info->ad_db_p));
            ...
            if (SOC_IS_JERICHO_PLUS(unit)) {
                KAPS_JR1_TRY(kaps_jr1_hb_db_init(
                   JerAppData[unit]->kaps_device_p,
                   db_id,
                   db_config_info->db_size,
                ...
                KAPS_JR1_TRY(kaps_jr1_hb_db_set_property(db_config_info->hb_db_p, KAPS_JR1_PROP_AGE_COUNT, KAPS_HB_AGE_COUNT));

                KAPS_JR1_TRY(kaps_jr1_db_set_hb(db_config_info->db_p,
                                      db_config_info->hb_db_p));
            }
            ...
            KAPS_JR1_TRY(kaps_jr1_db_clone(jer_kaps_db_config_info[unit][db_config_info->clone_of_db_id].db_p,
                                 db_id,
                                 &(db_config_info->db_p))
                    );
        }
        ...
        res = kaps_jr1_db_refresh_handle(JerAppData[unit]->kaps_device_p, db_handles_info.db_p, &db_handles_info.db_p);
        if(JER_KAPS_TO_SOC_RESULT(res) != SOC_SAND_OK) {
           LOG_ERROR(BSL_LS_SOC_TCAM,
                     (BSL_META_U(unit,
                                 "Error in %s(): Table Key : kaps_db_refresh_handle failed: %s, db_id = %d!\n"),
                                 FUNCTION_NAME(),
                      kaps_jr1_get_status_string(res), db_id));

            SOC_SAND_SET_ERROR_CODE(SOC_SAND_GEN_ERR, 31, exit);
        }

        if (db_config_info->clone_of_db_id == JER_KAPS_IP_NOF_DB) {
            res = kaps_jr1_ad_db_refresh_handle(JerAppData[unit]->kaps_device_p, db_handles_info.ad_db_p, &db_handles_info.ad_db_p);
            if(JER_KAPS_TO_SOC_RESULT(res) != SOC_SAND_OK) {
               LOG_ERROR(BSL_LS_SOC_TCAM,
                         (BSL_META_U(unit,
            ...
            if (SOC_IS_JERICHO_PLUS(unit)) {
                ...
                res = kaps_jr1_hb_db_refresh_handle(JerAppData[unit]->kaps_device_p, db_handles_info.hb_db_p, &db_handles_info.hb_db_p);
                if(JER_KAPS_TO_SOC_RESULT(res) != SOC_SAND_OK) {
                   LOG_ERROR(BSL_LS_SOC_TCAM,
                             (BSL_META_U(unit,
...
STATIC uint32 jer_kaps_dma_db_init(int unit, uint32 db_id)
{
    ...
    if (!SOC_WARM_BOOT(unit)) {
        ...
        res = kaps_jr1_dma_db_refresh_handle(JerAppData[unit]->kaps_device_p, dma_db_handles_info.dma_db_p, &dma_db_handles_info.dma_db_p);
        if(JER_KAPS_TO_SOC_RESULT(res) != SOC_SAND_OK) {
           LOG_ERROR(BSL_LS_SOC_TCAM,
                     (BSL_META_U(unit,
...
STATIC uint32 jer_kaps_table_init(int unit, uint32 tbl_id)
{
    ...
    if (!SOC_WARM_BOOT(unit)) 
    {
        ...
        {
            res = kaps_jr1_db_clone(jer_kaps_table_config_info[unit][tbl_config_info->clone_of_tbl_id].tbl_p,
                                 tbl_id + TABLE_ID_OFFSET,
                                 &(tbl_config_info->tbl_p));
            if(JER_KAPS_TO_SOC_RESULT(res) != SOC_SAND_OK) {
               LOG_ERROR(BSL_LS_SOC_TCAM,
        ...
        KAPS_JR1_TRY(kaps_jr1_key_init(JerAppData[unit]->kaps_device_p, &key));
             ...
             key_ndx++)
        {
            ...
            if(tbl_config_info->key_fields.key_segment[key_ndx].nof_bits){
                ...
                if(JER_KAPS_TO_SOC_RESULT(res) != SOC_SAND_OK) {
                    if(res != KAPS_JR1_DUPLICATE_KEY_FIELD) {
                       LOG_ERROR(BSL_LS_SOC_TCAM,
                                 (BSL_META_U(unit,
        ...
        if(JER_KAPS_TO_SOC_RESULT(res) != SOC_SAND_OK) {
           LOG_ERROR(BSL_LS_SOC_TCAM,
                     (BSL_META_U(unit,
                                 ...
                                 FUNCTION_NAME(),
                      kaps_jr1_get_status_string(res), tbl_id));
        ...
        else
        {
            ...
            res = kaps_jr1_db_refresh_handle(JerAppData[unit]->kaps_device_p, table_handle.tbl_p, &(table_handle.tbl_p));
            if(JER_KAPS_TO_SOC_RESULT(res) != SOC_SAND_OK) {
               LOG_ERROR(BSL_LS_SOC_TCAM,
                         (BSL_META_U(unit,
...
STATIC uint32 jer_kaps_search_init(int unit, uint32 search_id)
{
    ...
    if (!SOC_WARM_BOOT(unit)) {
        ...
        KAPS_JR1_TRY(kaps_jr1_instruction_init(
                    JerAppData[unit]->kaps_device_p, 
                    search_id,
                    0, 
        ...
        KAPS_JR1_TRY(kaps_jr1_key_init(JerAppData[unit]->kaps_device_p, &master_key));
        ...
        KAPS_JR1_TRY(kaps_jr1_instruction_set_key(search_config_info->inst_p, master_key));
        ...
        for (tbl_idx = 0; tbl_idx < search_config_info->valid_tables_num; tbl_idx++)
        {
            ...
            if (SOC_IS_JERICHO_PLUS(unit) && !SOC_IS_QAX(unit)) {
                res = kaps_jr1_instruction_add_db(search_config_info->inst_p,
            ...
            if(JER_KAPS_TO_SOC_RESULT(res) != SOC_SAND_OK) {
               LOG_ERROR(BSL_LS_SOC_TCAM,
                         (BSL_META_U(unit,
                                     ...
                                     FUNCTION_NAME(),
                          kaps_jr1_get_status_string(res), tbl_id, tbl_idx));

                SOC_SAND_SET_ERROR_CODE(SOC_SAND_GEN_ERR, 10, exit);
            }
        }

        res = kaps_jr1_instruction_install(search_config_info->inst_p);
        if(JER_KAPS_TO_SOC_RESULT(res) != SOC_SAND_OK) {
           LOG_ERROR(BSL_LS_SOC_TCAM,
                     (BSL_META_U(unit,
                                 "Error in %s(): kaps_instruction_install failed with : %s, search_id = %d!\n"), 
                                 FUNCTION_NAME(),
                      kaps_jr1_get_status_string(res), search_id));
        ...
        KAPS_JR1_TRY(kaps_jr1_instruction_refresh_handle(JerAppData[unit]->kaps_device_p, instruction_handles_info.inst_p, &instruction_handles_info.inst_p));
    ...
    )
{
    ...
    res = kaps_jr1_device_lock(JerAppData[unit]->kaps_device_p);
    if(JER_KAPS_TO_SOC_RESULT(res) != SOC_SAND_OK) {
       LOG_ERROR(BSL_LS_SOC_TCAM,
                 (BSL_META_U(unit,
...
uint32 jer_kaps_init_app(int unit)
{
    ...
    KAPS_JR1_TRY(kaps_jr1_default_allocator_create(&JerAppData[unit]->dalloc_p));
    ...
    )
{
    ...
    if (!no_sync_flag)
    {
        KAPS_JR1_TRY(kaps_jr1_device_destroy(JerAppData[unit]->kaps_device_p));
    }
    else
    {
        KAPS_JR1_TRY(kaps_jr1_default_allocator_destroy(JerAppData[unit]->dalloc_p));
        KAPS_JR1_TRY(kaps_jr1_default_allocator_create(&JerAppData[unit]->dalloc_p));
    }
    ...
    if (!no_sync_flag)
    {
        KAPS_JR1_TRY(kaps_jr1_sw_model_destroy(JerAppData[unit]->kaps_xpt_p));
    }
#else
#ifndef BLACKHOLE_MODE
 ...
 jer_kaps_sync(int unit)
{
    ...
    SOC_SAND_INIT_ERROR_DEFINITIONS(0);
    {
        ...
        KAPS_JR1_TRY(kaps_jr1_device_save_state_and_continue(JerAppData[unit]->kaps_device_p, warmboot_data->kaps_file_read , warmboot_data->kaps_file_write, warmboot_data->kaps_file_fp));
    }
    ...
    for (db_idx = 0; db_idx < JER_KAPS_IP_NOF_DB; db_idx++)
    {
        ...
        if (db_config_info->valid)
        {
            if (db_config_info->clone_of_db_id == JER_KAPS_IP_NOF_DB) {
                ...
                KAPS_JR1_TRY(kaps_jr1_hb_db_timer(db_handles_info.hb_db_p));
            }
        }
    }
