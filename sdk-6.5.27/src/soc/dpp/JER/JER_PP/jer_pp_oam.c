   ...
   )
{
    ...
    if (is_ntp) {
        ...
        SOCDNX_IF_ERR_EXIT(soc_reg_above_64_get(unit, ECI_GP_CONTROL_8r, REG_PORT_ANY, 0, reg_above_64_val));
        soc_reg_above_64_field32_set(unit, ECI_GP_CONTROL_8r, reg_above_64_val, TOD_NTP_LOAD_ENABLEf, 0x1);
        soc_reg_above_64_field32_set(unit, ECI_GP_CONTROL_8r, reg_above_64_val, TOD_NTP_COUNT_ENABLEf, 0x0);
        SOCDNX_IF_ERR_EXIT(soc_reg_above_64_set(unit, ECI_GP_CONTROL_8r, REG_PORT_ANY, 0, reg_above_64_val));

        SOC_REG_ABOVE_64_CLEAR(reg_above_64_val);
        SOCDNX_IF_ERR_EXIT(soc_reg_above_64_get(unit, ECI_GP_CONTROL_6r, REG_PORT_ANY, 0, reg_above_64_val));
        
        tmp=0;
        SHR_BITCOPY_RANGE(&tmp, 26, &time_frac, 0, 6);
        soc_reg_above_64_field32_set(unit, ECI_GP_CONTROL_6r, reg_above_64_val, TOD_NTP_TIME_FRAC_SEC_LOWERf, tmp);
        
        tmp=0;
        SHR_BITCOPY_RANGE(&tmp, 0, &time_frac, 6, 26);
        soc_reg_above_64_field32_set(unit, ECI_GP_CONTROL_6r, reg_above_64_val, TOD_NTP_TIME_FRAC_SEC_UPPERf, tmp);
        
        soc_reg_above_64_field32_set(unit, ECI_GP_CONTROL_6r, reg_above_64_val, TOD_NTP_TIME_FREQ_CONTROLf, 0x44b82fa1);
        
        tmp=0;
        SHR_BITCOPY_RANGE(&tmp, 0, &time_sec, 1, 31);
        soc_reg_above_64_field32_set(unit, ECI_GP_CONTROL_6r, reg_above_64_val, TOD_NTP_ONE_SECf, (time_sec & 0x00000001)!=0 );
        soc_reg_above_64_field32_set(unit, ECI_GP_CONTROL_6r, reg_above_64_val, TOD_NTP_UPPER_SECf, tmp);
        SOCDNX_IF_ERR_EXIT(soc_reg_above_64_set(unit, ECI_GP_CONTROL_6r, REG_PORT_ANY, 0, reg_above_64_val));

        SOC_REG_ABOVE_64_CLEAR(reg_above_64_val);
        SOCDNX_IF_ERR_EXIT(soc_reg_above_64_get(unit, ECI_GP_CONTROL_8r, REG_PORT_ANY, 0, reg_above_64_val));
        soc_reg_above_64_field32_set(unit, ECI_GP_CONTROL_8r, reg_above_64_val, TOD_NTP_LOAD_ONCEf, 0x1);
        soc_reg_above_64_field32_set(unit, ECI_GP_CONTROL_8r, reg_above_64_val, TOD_NTP_LOAD_ENABLEf, 0x0);
        soc_reg_above_64_field32_set(unit, ECI_GP_CONTROL_8r, reg_above_64_val, TOD_NTP_COUNT_ENABLEf, 0x1);
        SOCDNX_IF_ERR_EXIT(soc_reg_above_64_set(unit, ECI_GP_CONTROL_8r, REG_PORT_ANY, 0, reg_above_64_val));
    }
    else {
        ...
        SOC_REG_ABOVE_64_CLEAR(reg_above_64_val);
        SOCDNX_IF_ERR_EXIT(soc_reg_above_64_get(unit, ECI_GP_CONTROL_8r, REG_PORT_ANY, 0, reg_above_64_val));
        soc_reg_above_64_field32_set(unit, ECI_GP_CONTROL_8r, reg_above_64_val, TOD_IEEE_1588_LOAD_ENABLEf, 0x1);
        soc_reg_above_64_field32_set(unit, ECI_GP_CONTROL_8r, reg_above_64_val, TOD_IEEE_1588_COUNT_ENABLEf, 0x0);
        SOCDNX_IF_ERR_EXIT(soc_reg_above_64_set(unit, ECI_GP_CONTROL_8r, REG_PORT_ANY, 0, reg_above_64_val));

        SOC_REG_ABOVE_64_CLEAR(reg_above_64_val);
        SOCDNX_IF_ERR_EXIT(soc_reg_above_64_get(unit, ECI_GP_CONTROL_7r, REG_PORT_ANY, 0, reg_above_64_val));
        
        tmp=0;
        SHR_BITCOPY_RANGE(&tmp, 26, &time_frac, 0, 6);
        soc_reg_above_64_field32_set(unit, ECI_GP_CONTROL_7r, reg_above_64_val, TOD_IEEE_1588_TIME_FRAC_SEC_LOWERf, tmp);
        
        tmp=0;
        SHR_BITCOPY_RANGE(&tmp, 0, &time_frac, 6, 26);
        soc_reg_above_64_field32_set(unit, ECI_GP_CONTROL_7r, reg_above_64_val, TOD_IEEE_1588_TIME_FRAC_SEC_UPPERf, tmp);
        
        soc_reg_above_64_field32_set(unit, ECI_GP_CONTROL_7r, reg_above_64_val, TOD_IEEE_1588_TIME_FREQ_CONTROLf, 0x10000000);
        
        soc_reg_above_64_field32_set(unit, ECI_GP_CONTROL_7r, reg_above_64_val, TOD_IEEE_1588_ONE_SECf, (time_sec & 0x00000001)!=0);
        tmp=0;
        SHR_BITCOPY_RANGE(&tmp, 0, &time_sec, 1, 31);
        soc_reg_above_64_field32_set(unit, ECI_GP_CONTROL_7r, reg_above_64_val, TOD_IEEE_1588_UPPER_SECf, tmp);
        SOCDNX_IF_ERR_EXIT(soc_reg_above_64_set(unit, ECI_GP_CONTROL_7r, REG_PORT_ANY, 0, reg_above_64_val));

        SOC_REG_ABOVE_64_CLEAR(reg_above_64_val);
        SOCDNX_IF_ERR_EXIT(soc_reg_above_64_get(unit, ECI_GP_CONTROL_8r, REG_PORT_ANY, 0, reg_above_64_val));
        
        soc_reg_above_64_field32_set(unit, ECI_GP_CONTROL_8r, reg_above_64_val, TOD_IEEE_1588_LOAD_ONCEf, 0x1);
        
        soc_reg_above_64_field32_set(unit, ECI_GP_CONTROL_8r, reg_above_64_val, TOD_IEEE_1588_LOAD_ENABLEf, 0x0);
        soc_reg_above_64_field32_set(unit, ECI_GP_CONTROL_8r, reg_above_64_val, TOD_IEEE_1588_COUNT_ENABLEf, 0x1);
        SOCDNX_IF_ERR_EXIT(soc_reg_above_64_set(unit, ECI_GP_CONTROL_8r, REG_PORT_ANY, 0, reg_above_64_val));
    }
