...
_shmoo_combo16_dqs2ck(int unit, int drc_ndx, combo16_shmoo_container_t *scPtr)
{
    ...
    {
        _combo16_calculate_ui_position((*scPtr).endUI[addr_ctrl_ui - 1] + 1 + addr_ctrl_step + ((*scPtr).endUI[0] >> 1) - 15, scPtr, &up);  
    ...
    {
        _combo16_calculate_ui_position(addr_ctrl_step + ((*scPtr).endUI[0] >> 1) - 15, scPtr, &up);                                         
        position = up.position;
        ui = up.ui;
        if(ui > 0)
        {
...
soc_combo16_shmoo_phy_init(int unit, int drc_ndx)
{
 ...
 LOG_VERBOSE(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A01. Reset all PHY logic\n")));
        reset_ctrl_data = 0;
        SOC_IF_ERROR_RETURN(WRITE_DDRC16_CONTROL_REGS_RESET_CTRLr(unit, ndx, reset_ctrl_data));
        sal_usleep(SHMOO_COMBO16_SHORT_SLEEP);
        
 LOG_VERBOSE(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A02. Enable Read FIFO\n")));
 ...
 LOG_VERBOSE(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A03. Configure input shift control\n")));
        data = 0;
        switch(dramType)
        {
            case SHMOO_COMBO16_DRAM_TYPE_DDR4:
 ...
 LOG_VERBOSE(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A04. Configure power regulation\n")));
        data = 0;
 ...
 LOG_VERBOSE(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A05. Configure reference voltage\n")));
        data = 0;
 ...
 LOG_VERBOSE(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A06. Release VDL resets\n")));
 ...
 LOG_VERBOSE(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A07. Compute VDL step size\n")));
 ...
 LOG_VERBOSE(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A08. Configure read clock\n")));
        data = 0;
        switch(dramType)
        {
            case SHMOO_COMBO16_DRAM_TYPE_DDR4:
 ...
 LOG_VERBOSE(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A09. Configure UI shifts\n")));
        switch(dramType)
        {
            case SHMOO_COMBO16_DRAM_TYPE_DDR4:
 ...
 LOG_VERBOSE(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A10. Configure VDLs\n")));
        if(dramType == SHMOO_COMBO16_DRAM_TYPE_DDR4)
        {
            data = SHMOO_COMBO16_DDR4_INIT_WRITE_MIN_VDL_POS;
        }
 ...
 LOG_VERBOSE(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A11. ZQ calibration\n")));
        if(shmoo_dram_info->sim_system_mode)
        {
        ...
        SOC_IF_ERROR_RETURN( soc_phy_ddrc16_reg_field_set(unit, SOC_PHY_DDRC16_REG_COMMON_RESCAL_INIT_CONFIGr, &data, SOC_PHY_DDRC16_PNCOMP_INIT_DIFFf, 0x1F));     
 ...
 LOG_VERBOSE(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A12. Enable CK\n")));
 ...
 LOG_VERBOSE(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A13. Configure FIFOs\n")));
        switch(dramType)
        {
            case SHMOO_COMBO16_DRAM_TYPE_DDR4:
                data = 0;
 ...
 LOG_VERBOSE(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A14. Release PHY resets\n")));
        switch(dramType)
        {
            case SHMOO_COMBO16_DRAM_TYPE_DDR4:
 ...
 LOG_VERBOSE(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A15. Enable FIFOs\n")));
        switch(dramType)
        {
            case SHMOO_COMBO16_DRAM_TYPE_DDR4:
 ...
 LOG_VERBOSE(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A16. Configure CDR default values\n")));
