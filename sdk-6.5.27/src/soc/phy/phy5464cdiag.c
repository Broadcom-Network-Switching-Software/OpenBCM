...
,l105,l106,l107,l108,l109;int16 l110; uint16 l40a1; l84 = 0x0000;if(l40>= 0){l84|= l59(l34,-
...
0x15,&l106);assert((l40+1)>= 0);l40a1=(l40<0)?0:(l40+1); if(l109 == 0){l75[l40a1] = 1;l84|= 0x0001;}
else if((l106&0xF000)!= 0){l75[l40a1] = 1;l84|= 0x0002;}else{l75[l40a1] = 0;}
for(l110=0;l110<4;l110++){l76[l110][l40a1] = (l106>>(l110*2))&0x0003;}if(l40<=
0){l84|= l46(l34,0x17,0x0F12);l84|= l43(l34,0x15,&l107);l77[0][l40a1] = l75[
l40a1]?-99:(l107&0x00FF);l77[1][l40a1] = l75[l40a1]?-99:((l107&0xFF00)>>8);}
l84|= l46(l34,0x17,0x0F13);l84|= l43(l34,0x15,&l108);l77[2][l40a1] = l75[l40a1]
?-99:(l108&0x00FF);l77[3][l40a1] = l75[l40a1]?-99:((l108&0xFF00)>>8);return
...
int16 l80[4]){int16 l113,l84;int16 l89;int16 l102;int32 l104[4+1][4+1]={{0}};l84 =
...
l262,&l263);if(l262 == 0){if(l28 == 0x00000002)l171 = (int32)1.4;l84|= l37(l28,l34);
...
int16 l89,l283;int16 l53,l196[4],l197[4];int16 l284;int16 l40,l113,l216[4]={0},
l246[4],l248[4][4];int32 l247[4],l265[4],l249[4],l266[4];int32 l222[(5000/(60
+60)+1)][4];int16 l251[4]={0};int32 l28;int16 l75[4+1],l76[4+1][4+1],l77[4+1][4+1
];int16 l78[4];int32 l79[4];int16 l285[4],l286[4],l287=0;int32 l288[4],l47[4];
...
#else /* INCLUDE_PHY_5464 || INCLUDE_PHY_5482 */
typedef int _phy_5464cdiag_not_empty; /* Make ISO compilers happy. */
