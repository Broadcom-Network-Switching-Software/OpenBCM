...
extern int
bmacsec_phy84756_macsec_reg_read(bmacsec_dev_addr_t phy_addr, buint32_t flags,
                         buint32_t reg_addr, buint32_t *data);
extern int
bmacsec_phy84756_macsec_reg_write(bmacsec_dev_addr_t phy_addr, buint32_t flags,
                         buint32_t reg_addr, buint32_t data);
extern int
bmacsec_phy84756_macsec_reg_modify(bmacsec_dev_addr_t phy_addr, buint32_t flags,
                         buint32_t reg_addr, buint32_t data, buint32_t mask);
#define  BMACSEC_PHY_REG_MACSEC         0x04000000
#define  BMACSEC_PHY_REG64_DATA_HI32    0x08000000
#define  MACSEC_REG_PORT_SHIFT          12
#define  MACSEC_REG_PORT_MASK           (0xFU << MACSEC_REG_PORT_SHIFT)
#define  UINT16_MASK                    0xFFFF
#define  REG64_SIZE_IN_INT              2
#define  REG64_INDEX_HI                 1
#define  REG64_INDEX_LO                 0
#define  REG64_HI(_v)                   (_v[REG64_INDEX_HI])
#define  REG64_LO(_v)                   (_v[REG64_INDEX_LO])
