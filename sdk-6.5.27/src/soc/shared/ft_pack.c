...
shr_ft_msg_ctrl_init_pack(uint8 *buf, shr_ft_msg_ctrl_init_t *msg)
{
    ...
    if (ft_msg_version >= FT_MSG_VERSION_9) {
        _SHR_PACK_U8(buf, msg->max_collectors);
    }
...
shr_ft_msg_ctrl_init_unpack(uint8 *buf, shr_ft_msg_ctrl_init_t *msg)
{
    ...
    if (ft_msg_version >= FT_MSG_VERSION_9) {
        _SHR_UNPACK_U8(buf, msg->max_collectors);
    }
...
/*
 * Update collector - pack
 */
uint8*
shr_ft_msg_ctrl_collector_update_pack(uint8* buf, shr_ft_msg_ctrl_collector_update_t *msg)
{
    int i;
...
/*
 * Update collector - unpack
 */
uint8*
shr_ft_msg_ctrl_collector_update_unpack(uint8* buf, shr_ft_msg_ctrl_collector_update_t *msg)
{
    int i;
