...
_soc_saber2_mmu_init(int unit)
{
    ...
    SOC_IF_ERROR_RETURN(WRITE_THDIEXT_PORT_PROFILE_MAPr(unit, rval1));
    SOC_IF_ERROR_RETURN(WRITE_THDIEMA_PORT_PROFILE_MAPr(unit, rval1));
...
soc_sb2_mem_config(int unit, int dev_id)
{
    ...
    if (soc_property_get(unit, "l3_defip_sizing", TRUE)) {
        ...
        mem_index_max = (SOC_CONTROL(unit)->l3_defip_max_tcams *
            SOC_CONTROL(unit)->l3_defip_tcam_size) - (num_ipv6_128b_entries * 2) - 1;
    ...
    if (!(SAL_BOOT_BCMSIM || SAL_BOOT_PLISIM)) {
        ...
        case BCM56233_DEVICE_ID:
             ...
             SOP_MEM_STATE_MAX_INDEX_SET(unit, LMEPm, 511);
             SOP_MEM_STATE_MAX_INDEX_SET(unit, LMEP_1m, 511);
             SOP_MEM_STATE_MAX_INDEX_SET(unit, RMEPm, 2047);
             SOP_MEM_STATE_MAX_INDEX_SET(unit, MA_INDEXm, 1535);
             SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_MA_INDEXm, 1535);
             SOP_MEM_STATE_MAX_INDEX_SET(unit, MA_STATEm, 511);
             SOP_MEM_STATE_MAX_INDEX_SET(unit, MAID_REDUCTIONm, 511);
             SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_OAM_LM_COUNTERS_0m, 1023);
             SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_OAM_LM_COUNTERS_0m, 1023);
             SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_OAM_LM_COUNTERS_1m, 511);
             SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_OAM_LM_COUNTERS_1m, 511);
             SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_OAM_LM_COUNTERS_2m, 511);
             SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_OAM_LM_COUNTERS_2m, 511);

             SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_ONLYm, 4095);
             SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_HIT_ONLYm, 255);
             SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_IPV4_UNICASTm, 4095);
             SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_IPV4_MULTICASTm, 2047);
             SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_IPV6_UNICASTm, 2047);
             SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_IPV6_MULTICASTm, 1023);
             if (dev_id == BCM56233_DEVICE_ID) {
                 /* L2 MAC Address : 16K */
                 ...
                 /* MPLS Labels : 2K */
                 SOP_MEM_STATE_MAX_INDEX_SET(unit, MPLS_ENTRYm, 2047);
                 ...
                 SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_QUEUE_MAPm, 511);
                 SOP_MEM_STATE_MAX_INDEX_SET(unit, LLS_L0_PARENTm, 63);
                 SOP_MEM_STATE_MAX_INDEX_SET(unit, LLS_L0_CONFIGm, 63);
                 SOP_MEM_STATE_MAX_INDEX_SET(unit, LLS_L0_MIN_CONFIG_Cm, 63);
                 SOP_MEM_STATE_MAX_INDEX_SET(unit, LLS_L0_SHAPER_CONFIG_Cm, 63);
                 SOP_MEM_STATE_MAX_INDEX_SET(unit, LLS_L1_PARENTm, 127);
                 SOP_MEM_STATE_MAX_INDEX_SET(unit, LLS_L1_CONFIGm, 127);
                 SOP_MEM_STATE_MAX_INDEX_SET(unit, LLS_L1_SHAPER_CONFIG_Cm, 127);
                 SOP_MEM_STATE_MAX_INDEX_SET(unit, LLS_L2_PARENTm, 511);
                 SOP_MEM_STATE_MAX_INDEX_SET(unit, LLS_L2_SHAPER_CONFIG_Cm, 127);
             }
             ...
             SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_FLEX_CTR_COUNTER_TABLE_0m, 511); 
             SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_FLEX_CTR_COUNTER_TABLE_1m, 511); 
             SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_FLEX_CTR_COUNTER_TABLE_2m, 511); 
             SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_FLEX_CTR_COUNTER_TABLE_3m, 511); 
             SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_FLEX_CTR_COUNTER_TABLE_4m, 511); 
             SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_FLEX_CTR_COUNTER_TABLE_5m, 511); 
             SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_FLEX_CTR_COUNTER_TABLE_6m, 511); 
             SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_FLEX_CTR_COUNTER_TABLE_7m, 511); 
             ...
             SOP_MEM_STATE_MAX_INDEX_SET(unit, L2MCm, 2047);
             ...
             if (dev_id == BCM56233_DEVICE_ID) {
                 ...
                 SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_IPMC_GROUP_TBL0m, 255);
                 SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_IPMC_GROUP_TBL1m, 255);
                 SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_IPMC_GROUP_TBL2m, 255);
                 SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_IPMC_GROUP_TBL3m, 255);
                 SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_IPMC_GROUP_TBLm, 255);
             } else {
                 ...
                 SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_IPMC_GROUP_TBLm, 2047);
             }
             SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_REPL_HEAD_TBLm, 16383);
             SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_REPL_LIST_TBLm, 4095);
             if (dev_id == BCM56233_DEVICE_ID) {
                 SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_REPL_GRP_TBL0m, 256);
                 SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_REPL_GRP_TBL1m, 256);
             } else {
                 SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_REPL_GRP_TBL0m, 2047);
                 SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_REPL_GRP_TBL1m, 2047);
             }
             SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_EXT_MC_GROUP_MAPm, 2047);
             SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_EXT_MC_QUEUE_LIST0m, 4095);
             SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_EXT_MC_QUEUE_LIST4m, 4095);

             SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ECMP_COUNTm, 127);
             SOP_MEM_STATE_MAX_INDEX_SET(unit, INITIAL_L3_ECMP_GROUPm, 127);
             SOP_MEM_STATE_MAX_INDEX_SET(unit, INITIAL_L3_ECMPm, 255);
             SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ECMPm, 255);
             ...
             SOP_MEM_STATE_MAX_INDEX_SET(unit, INITIAL_PROT_NHI_TABLEm, 4095);
