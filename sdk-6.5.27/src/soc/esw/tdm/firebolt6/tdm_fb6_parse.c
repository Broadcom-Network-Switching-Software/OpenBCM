...
int param_dummy = 0;
    ...
    switch (param_clk_freq) {
       ...
       case FB6_CLK_4731_1012: param_mgmt_size = 24; param_lpbk=3; param_fae = 3; param_null = 8; param_dummy = 0; break;
       case FB6_CLK_4732_1016:
       case FB6_CLK_4732_1012: param_mgmt_size = 24;  param_lpbk=3; param_fae = 3; param_null = 8; param_dummy = 0;  break;
       ...
       case FB6_CLK_4700_1250: param_mgmt_size = 20; param_lpbk=2; param_fae = 2; param_null = 8; param_dummy = 0;  break;
...
int param_dummy = 0;
   ...
   switch (param_clk_freq) {
       ...
       case FB6_CLK_4731_1012: param_mgmt_size = 24; param_lpbk=3; param_fae = 0; param_null = 9; param_dummy = 3;  break;
       case FB6_CLK_4732_1016:
       case FB6_CLK_4732_1012: param_mgmt_size = 24; param_lpbk=3; param_fae = 0; param_null = 9; param_dummy = 3; break;
       ...
       case FB6_CLK_4700_1250: param_mgmt_size = 20; param_lpbk=2; param_fae = 0; param_null = 9; param_dummy = 2; break;
 ...
 /*   } */
    ...
    /*mgmt_init = 1;
     ...
     if(exp_no_of_mgmt_ports == no_of_mgmt_ports) {
       ...
       TDM_PRINT2(" No of Mgmt Ports Mismatch Expected %d Actual %d \n", exp_no_of_mgmt_ports, no_of_mgmt_ports);
     }
...
int tdm_fb6_parse_tdm_cal_idb_mmu(tdm_mod_t *_tdm, int cal_id, int param_mgmt_size, int param_lpbk, int param_fae, int param_idle1, int param_null, int param_clk_freq, int param_cal_len, int param_token_ancl, int param_dummy, int no_of_mgmt_ports)
{
    ...
    if(no_of_mgmt_ports == 1) {
      param_dummy = param_dummy+param_mgmt_size/2;
    }
    /*TDM_PRINT3("IDB_MMU::j %d mgmt_mode %d mgmt_pm %d\n",  j, param_mgmt_mode[j], param_mgmt_pm[j%4]);*/
    TDM_PRINT2("IDB_MMU::no_of_mgmt_ports %d param_dummy %d\n",  no_of_mgmt_ports, param_dummy);
    param_cal_id = cal_id;
    ...
    if(no_of_mgmt_ports == 0) {
      mgmt1_credits = 0;
      mgmt2_credits = 0;
      mgmt3_credits = 0;
      mgmt4_credits = 0;
    }
    else if(no_of_mgmt_ports == 1) {
      mgmt1_credits = (param_mgmt_size * param_mgmt_pm[0])/2;
      mgmt2_credits = (param_mgmt_size * param_mgmt_pm[1])/2;
      mgmt3_credits = (param_mgmt_size * param_mgmt_pm[2])/2;
      mgmt4_credits = (param_mgmt_size * param_mgmt_pm[3])/2;
    }
    else {
...
/*    switch (param_clk_freq) {
    ...
    if((param_clk_freq == FB6_CLK_4731_1012) || (param_clk_freq == FB6_CLK_4732_1012) || (param_clk_freq == FB6_CLK_4732_1016)) {
      mgmt_same_spacing = 12;
    }
    else if(mgmt1_credits > 0) {
