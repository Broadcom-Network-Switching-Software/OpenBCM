...
soc_enduro_mem_config(int unit)
{
    ...
    case BCM56320_DEVICE_ID:
        SOP_MEM_STATE_MAX_INDEX_SET(unit, MPLS_ENTRYm, 0);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, OAM_LM_COUNTERSm, 0);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_MPLS_VC_AND_SWAP_LABEL_TABLEm, 0);
        break;
    case BCM56321_DEVICE_ID:
        ...
        SOP_MEM_STATE_MAX_INDEX_SET(unit, L2_HITSA_ONLYm, 2047);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_DEFIPm, 511);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_DEFIP_ONLYm, 511);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_DEFIP_DATA_ONLYm, 511);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_DEFIP_HIT_ONLYm, 511);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_TUNNELm, 127);
        break;
    ...
    case BCM56231_DEVICE_ID:
        ...
        /* MPLS Labels : 1K */
        SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_IP_TUNNELm, 255);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_IP_TUNNEL_IPV6m, 127);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_IP_TUNNEL_MPLSm, 255);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, MPLS_ENTRYm, 1023);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_MPLS_VC_AND_SWAP_LABEL_TABLEm, 1023);

        /* VPLS VFI : 1K */
        SOP_MEM_STATE_MAX_INDEX_SET(unit, VFIm, 1023);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, VFI_1m, 1023);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, VLAN_OR_VFI_MAC_COUNTm, 5119);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, VLAN_OR_VFI_MAC_LIMITm, 5119);

        /* Virtual Ports : 4K */
        SOP_MEM_STATE_MAX_INDEX_SET(unit, SOURCE_VPm, 4095);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, SVP_DISABLE_VLAN_CHECKS_TABm, 4095);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_DVP_TABLEm, 4095);

        /* IPMc Groups : 512 */
        SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_IPMCm, 511);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_IPMCm, 511);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_IPMC_GROUP_TBL0m, 511);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_IPMC_GROUP_TBL1m, 511);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_IPMC_GROUP_TBL2m, 511);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_IPMC_GROUP_TBL3m, 511);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_MTU_VALUESm, 8703);
        ...
        SOP_MEM_STATE_MAX_INDEX_SET(unit, INITIAL_ING_L3_NEXT_HOPm, 2047);        
        break;
    default:
        break;
    }
