...
_soc_triumph3_esm_init_adjust_mem_size(int unit)
{
    ...
    index_max = partitions[TCAM_PARTITION_FWD_L2].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_L2_ENTRY_1m, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_L2_ENTRY_TCAMm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_L2_ENTRY_DATA_ONLYm, index_max);

    index_max = (partitions[TCAM_PARTITION_FWD_L2].num_entries + 31) / 32 - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_SRC_HIT_BITS_L2m, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_LOC_SRC_HIT_BITS_L2m, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DST_HIT_BITS_L2m, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_TCAM_VBIT_L2_ENTRY_1m, index_max);

    index_max = partitions[TCAM_PARTITION_FWD_L2_WIDE].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_L2_ENTRY_2m, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_L2_ENTRY_TCAM_WIDEm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_L2_ENTRY_DATA_ONLY_WIDEm, index_max);

    index_max = (partitions[TCAM_PARTITION_FWD_L2_WIDE].num_entries + 31) / 32 - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_SRC_HIT_BITS_L2_WIDEm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_LOC_SRC_HIT_BITS_L2_WIDEm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DST_HIT_BITS_L2_WIDEm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_TCAM_VBIT_L2_ENTRY_2m, index_max);

    /* IP4 forwarding partition */
    index_max = partitions[TCAM_PARTITION_FWD_IP4].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV4_DEFIPm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV4_DEFIP_TCAMm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DEFIP_DATA_IPV4m, index_max);

    index_max = (partitions[TCAM_PARTITION_FWD_IP4].num_entries + 31) / 32 - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_SRC_HIT_BITS_IPV4m, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DST_HIT_BITS_IPV4m, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_TCAM_VBIT_DEFIP_IPV4m, index_max);

    index_max = partitions[TCAM_PARTITION_FWD_IP4_UCAST].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV4_UCASTm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV4_UCAST_TCAMm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_L3_UCAST_DATA_IPV4m, index_max);

    index_max = (partitions[TCAM_PARTITION_FWD_IP4_UCAST].num_entries + 31) / 32 - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_SRC_HIT_BITS_IPV4_UCASTm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DST_HIT_BITS_IPV4_UCASTm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_TCAM_VBIT_IPV4_UCASTm, index_max);

    index_max = partitions[TCAM_PARTITION_FWD_IP4_UCAST_WIDE].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV4_UCAST_WIDEm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV4_UCAST_WIDE_TCAMm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_L3_UCAST_DATA_WIDE_IPV4m, index_max);

    index_max = (partitions[TCAM_PARTITION_FWD_IP4_UCAST_WIDE].num_entries + 31)/32 - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_SRC_HIT_BITS_IPV4_UCAST_WIDEm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DST_HIT_BITS_IPV4_UCAST_WIDEm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_TCAM_VBIT_IPV4_UCAST_WIDEm, index_max);

    index_max = /* SRC hit bit */
        partitions[TCAM_PARTITION_FWD_IP4].num_entries + 
        partitions[TCAM_PARTITION_FWD_IP4_UCAST].num_entries + 
        partitions[TCAM_PARTITION_FWD_IP4_UCAST_WIDE].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV4_TCAMm, index_max);

    /* IP6 64-bit prefix forwarding partition */
    index_max =partitions[TCAM_PARTITION_FWD_IP6U].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV6_64_DEFIPm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV6_64_DEFIP_TCAMm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DEFIP_DATA_IPV6_64m, index_max);

    index_max = partitions[TCAM_PARTITION_FWD_IP6U].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV6_64_TCAMm, index_max);

    index_max = (partitions[TCAM_PARTITION_FWD_IP6U].num_entries + 31) / 32 - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_SRC_HIT_BITS_IPV6_64m, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DST_HIT_BITS_IPV6_64m, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_TCAM_VBIT_DEFIP_IPV6_64m, index_max);

    /* IP6 128-bit prefix forwarding partition */
    index_max = partitions[TCAM_PARTITION_FWD_IP6].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV6_128_DEFIPm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV6_128_DEFIP_TCAMm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DEFIP_DATA_IPV6_128m, index_max);

    index_max = (partitions[TCAM_PARTITION_FWD_IP6].num_entries + 31)/32 - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_SRC_HIT_BITS_IPV6_128m, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DST_HIT_BITS_IPV6_128m, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_TCAM_VBIT_DEFIP_IPV6_128m, index_max);

    index_max = partitions[TCAM_PARTITION_FWD_IP6_128_UCAST].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV6_128_UCASTm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV6_128_UCAST_TCAMm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_L3_UCAST_DATA_IPV6_128m, index_max);

    index_max = (partitions[TCAM_PARTITION_FWD_IP6_128_UCAST].num_entries + 63)/64 - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_SRC_HIT_BITS_IPV6_128_UCASTm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DST_HIT_BITS_IPV6_128_UCASTm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_TCAM_VBIT_IPV6_128_UCASTm, index_max);

    index_max = partitions[TCAM_PARTITION_FWD_IP6_128_UCAST_WIDE].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV6_128_UCAST_WIDEm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV6_128_UCAST_WIDE_TCAMm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_L3_UCAST_DATA_WIDE_IPV6_128m, index_max);

    index_max = (partitions[TCAM_PARTITION_FWD_IP6_128_UCAST_WIDE].num_entries+63/64)-1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_SRC_HIT_BITS_IPV6_128_UCAST_WIDEm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DST_HIT_BITS_IPV6_128_UCAST_WIDEm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_TCAM_VBIT_IPV6_128_UCAST_WIDEm, index_max);

    index_max = /* TCAM */
        partitions[TCAM_PARTITION_FWD_IP6].num_entries +
        partitions[TCAM_PARTITION_FWD_IP6_128_UCAST].num_entries +
        partitions[TCAM_PARTITION_FWD_IP6_128_UCAST_WIDE].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV6_128_TCAMm, index_max);

    /* L2 288-bit ACL partition */
    index_max = /* TCAM */
        partitions[TCAM_PARTITION_ACL_L2].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL288_TCAM_L2m, index_max);


    policy_width = soc_property_get(unit, spn_EXT_L2_ACL_TABLE_POLICY_WIDTH, 0);
    SOC_TR3_SET_POLICY_TABLE_SIZE(unit, EXT_FP_POLICY_ACL288_L2_1Xm, 
    ...
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL288_TCAM_IPV4m, index_max);

    policy_width =soc_property_get(unit, spn_EXT_IP4_ACL_TABLE_POLICY_WIDTH, 0);
    SOC_TR3_SET_POLICY_TABLE_SIZE(unit, EXT_FP_POLICY_ACL288_IPV4_1Xm, 
    ...
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL360_TCAM_DATA_IPV6_SHORTm, index_max);

    policy_width=soc_property_get(unit, spn_EXT_IP6S_ACL_TABLE_POLICY_WIDTH, 0);
    SOC_TR3_SET_POLICY_TABLE_SIZE(unit, EXT_FP_POLICY_ACL360_IPV6_SHORT_1Xm, 
    ...
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL432_TCAM_DATA_IPV6_LONGm, index_max);

    policy_width=soc_property_get(unit, spn_EXT_IP6F_ACL_TABLE_POLICY_WIDTH, 0);
    SOC_TR3_SET_POLICY_TABLE_SIZE(unit, EXT_FP_POLICY_ACL432_IPV6_LONG_1Xm, 
    ...
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL144_TCAM_L2m, index_max);

    policy_width=soc_property_get(unit, spn_EXT_L2C_ACL_TABLE_POLICY_WIDTH, 0);
    SOC_TR3_SET_POLICY_TABLE_SIZE(unit, EXT_FP_POLICY_ACL144_L2_1Xm, 
    ...
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL144_TCAM_IPV4m, index_max);

    policy_width=soc_property_get(unit, spn_EXT_IP4C_ACL_TABLE_POLICY_WIDTH, 0);
    SOC_TR3_SET_POLICY_TABLE_SIZE(unit, EXT_FP_POLICY_ACL144_IPV4_1Xm, 
    ...
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL144_TCAM_IPV6m, index_max);

    policy_width=soc_property_get(unit, spn_EXT_IP6C_ACL_TABLE_POLICY_WIDTH, 0);
    SOC_TR3_SET_POLICY_TABLE_SIZE(unit, EXT_FP_POLICY_ACL144_IPV6_1Xm, 
    ...
    index_max = partitions[TCAM_PARTITION_ACL_L2IP4].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL432_TCAM_DATA_L2_IPV4m, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL432_L2_IPV4m, index_max);

    policy_width=soc_property_get(unit, spn_EXT_L2IP4_ACL_TABLE_POLICY_WIDTH,0);
    SOC_TR3_SET_POLICY_TABLE_SIZE(unit, EXT_FP_POLICY_ACL432_L2_IPV4_1Xm, 
    ...
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL432_TCAM_DATA_L2_IPV6m, index_max);

    policy_width = soc_property_get(unit, spn_EXT_L2IP6_ACL_TABLE_POLICY_WIDTH,
                   0);
    SOC_TR3_SET_POLICY_TABLE_SIZE(unit, EXT_FP_POLICY_ACL432_L2_IPV6_1Xm, 
    ...
    index_max = partitions[TCAM_PARTITION_ACL80].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL80_TCAMm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL80_FP_POLICY_1Xm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL80_FP_POLICY_2Xm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL80_FP_POLICY_3Xm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL80_FP_POLICY_4Xm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL80_FP_POLICY_6Xm, index_max);

    index_max = (partitions[TCAM_PARTITION_ACL80].num_entries + 31 / 32) - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_TCAM_VBIT_ACL80m, index_max);

    /* 160-bit ACL partition */
    index_max = partitions[TCAM_PARTITION_ACL160].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL160_TCAMm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL160_FP_POLICY_1Xm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL160_FP_POLICY_2Xm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL160_FP_POLICY_3Xm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL160_FP_POLICY_4Xm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL160_FP_POLICY_6Xm, index_max);

    index_max = (partitions[TCAM_PARTITION_ACL160].num_entries + 31 / 32) - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_TCAM_VBIT_ACL160m, index_max);

    /* 320-bit ACL partition */
    index_max = partitions[TCAM_PARTITION_ACL320].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL320_TCAMm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL320_FP_POLICY_1Xm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL320_FP_POLICY_2Xm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL320_FP_POLICY_3Xm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL320_FP_POLICY_4Xm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL320_FP_POLICY_6Xm, index_max);

    index_max = (partitions[TCAM_PARTITION_ACL320].num_entries + 31 / 32) - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_TCAM_VBIT_ACL320m, index_max);

    /* 480-bit ACL partition */
    /* this is a special 1-entry memory */
    index_max = 0;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL480_TCAM_MASKm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL360_TCAM_MASKm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL432_TCAM_MASKm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL360_TCAM_MASK_IPV6_SHORTm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL432_TCAM_MASK_IPV6_LONGm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL432_TCAM_MASK_L2_IPV6m, index_max);

    index_max = partitions[TCAM_PARTITION_ACL480].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL480_TCAM_DATAm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL480_FP_POLICY_1Xm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL480_FP_POLICY_2Xm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL480_FP_POLICY_3Xm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL480_FP_POLICY_4Xm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL480_FP_POLICY_6Xm, index_max);

    index_max = (partitions[TCAM_PARTITION_ACL480].num_entries + 31 / 32) - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_TCAM_VBIT_ACL480m, index_max);

    /* All L2+L3 forwarding entries */
    index_max = /* SRC / DST hit bit */
    ...
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_SRC_HBITSm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DST_HBITSm, index_max);

    /* All L2 */
    index_max = /* Local src hit bit */
        (partitions[TCAM_PARTITION_FWD_L2].num_entries + 31) / 32 +
        (partitions[TCAM_PARTITION_FWD_L2_WIDE].num_entries + 31) / 32 - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_LOC_SRC_HBITSm, index_max);
    ...
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DEFIP_DATAm, index_max);

    index_max = /* SRAM */
        partitions[TCAM_PARTITION_FWD_IP4_UCAST].num_entries +
        partitions[TCAM_PARTITION_FWD_IP6_128_UCAST].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_L3_UCAST_DATAm, index_max);

    index_max = /* SRAM */
        partitions[TCAM_PARTITION_FWD_IP4_UCAST_WIDE].num_entries +
        partitions[TCAM_PARTITION_FWD_IP6_128_UCAST_WIDE].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_L3_UCAST_DATA_WIDEm, index_max);
    ...
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_1Xm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_2Xm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_3Xm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_4Xm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_6Xm, index_max);

    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_TCAM_VBITm, 1048575);
    return SOC_E_NONE;
}
...
soc_triumph3_esm_init_mem_config(int unit)
{
    ...
    /* L2 forwarding partition */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_L2_ENTRY_1m, -1); /* TCAM + SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_L2_ENTRY_2m, -1); /* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_L2_ENTRY_TCAMm, -1); /* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_L2_ENTRY_TCAM_WIDEm, -1); /* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_L2_ENTRY_DATA_ONLYm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_L2_ENTRY_DATA_ONLY_WIDEm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_SRC_HIT_BITS_L2m, -1); /* SRC hit bit */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DST_HIT_BITS_L2m, -1); /* DST hit bit */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_SRC_HIT_BITS_L2_WIDEm, -1); /* SRC hit bit */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DST_HIT_BITS_L2_WIDEm, -1); /* DST hit bit */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_LOC_SRC_HIT_BITS_L2m, -1); /* DST hit bit */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_LOC_SRC_HIT_BITS_L2_WIDEm, -1); /* DST hit bit */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_TCAM_VBIT_L2_ENTRY_1m, -1); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_TCAM_VBIT_L2_ENTRY_2m, -1); 

    /* IP4 forwarding partition */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV4_DEFIPm, -1); /* TCAM + SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV4_DEFIP_TCAMm, -1); /* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DEFIP_DATA_IPV4m, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV4_UCASTm, -1); /* TCAM + SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV4_UCAST_TCAMm, -1); /* TCAM + SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_L3_UCAST_DATA_IPV4m, -1); /* TCAM + SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV4_UCAST_WIDEm, -1); /* TCAM + SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV4_UCAST_WIDE_TCAMm, -1); /* TCAM + SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_L3_UCAST_DATA_WIDE_IPV4m, -1); /* TCAM + SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_SRC_HIT_BITS_IPV4_UCASTm, -1); /* SRC hit bit */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DST_HIT_BITS_IPV4_UCASTm, -1); /* DST hit bit */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_SRC_HIT_BITS_IPV4_UCAST_WIDEm, -1); /* SRC hit bit */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DST_HIT_BITS_IPV4_UCAST_WIDEm, -1); /* DST hit bit */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_SRC_HIT_BITS_IPV4m, -1); /* SRC hit bit */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DST_HIT_BITS_IPV4m, -1); /* DST hit bit */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_TCAM_VBIT_DEFIP_IPV4m, -1); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_TCAM_VBIT_IPV4_UCASTm, -1); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_TCAM_VBIT_IPV4_UCAST_WIDEm, -1); 

    /* IP6 64-bit prefix forwarding partition */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV6_64_DEFIPm, -1); /* TCAM + SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV6_64_DEFIP_TCAMm, -1); /* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DEFIP_DATA_IPV6_64m, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_SRC_HIT_BITS_IPV6_64m, -1); /* SRC hit bit */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DST_HIT_BITS_IPV6_64m, -1); /* DST hit bit */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_TCAM_VBIT_DEFIP_IPV6_64m, -1); 

    /* IP6 128-bit prefix forwarding partition */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV6_128_DEFIPm, -1); /* TCAM + SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV6_128_DEFIP_TCAMm, -1); /* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DEFIP_DATA_IPV6_128m, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV6_128_UCASTm, -1); /* TCAM + SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV6_128_UCAST_TCAMm, -1); /* TCAM + SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_L3_UCAST_DATA_IPV6_128m, -1); /* TCAM + SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV6_128_UCAST_WIDEm, -1); /* TCAM + SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV6_128_UCAST_WIDE_TCAMm, -1); /* TCAM + SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_L3_UCAST_DATA_WIDE_IPV6_128m, -1); /* TCAM + SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_SRC_HIT_BITS_IPV6_128_UCASTm, -1); /* SRC hit bit */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DST_HIT_BITS_IPV6_128_UCASTm, -1); /* DST hit bit */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_SRC_HIT_BITS_IPV6_128_UCAST_WIDEm, -1); /* SRC hit bit */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DST_HIT_BITS_IPV6_128_UCAST_WIDEm, -1); /* DST hit bit */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_SRC_HIT_BITS_IPV6_128m, -1); /* SRC hit bit */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DST_HIT_BITS_IPV6_128m, -1); /* DST hit bit */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_TCAM_VBIT_IPV6_128_UCASTm, -1); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_TCAM_VBIT_IPV6_128_UCAST_WIDEm, -1); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_TCAM_VBIT_DEFIP_IPV6_128m, -1); 

    /* L2 288-bit ACL partition */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL288_TCAM_L2m, -1); /* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL288_L2_1Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL288_L2_2Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL288_L2_3Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL288_L2_4Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL288_L2_6Xm, -1); /* SRAM */

    /* IP4 288-bit ACL partition */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL288_TCAM_IPV4m, -1); /* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL288_IPV4_1Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL288_IPV4_2Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL288_IPV4_3Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL288_IPV4_4Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL288_IPV4_6Xm, -1); /* SRAM */

    /* IP6 short form 360-bit ACL partition */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL360_TCAM_DATA_IPV6_SHORTm, -1); /* TCAM data */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL360_IPV6_SHORT_1Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL360_IPV6_SHORT_2Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL360_IPV6_SHORT_3Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL360_IPV6_SHORT_4Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL360_IPV6_SHORT_6Xm, -1); /* SRAM */

    /* IP6 full form 432-bit ACL partition */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL432_TCAM_DATA_IPV6_LONGm, -1); /* TCAM data */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL432_IPV6_LONG_1Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL432_IPV6_LONG_2Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL432_IPV6_LONG_3Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL432_IPV6_LONG_4Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL432_IPV6_LONG_6Xm, -1); /* SRAM */

    /* L2 compact form 144-bit ACL partition */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL144_TCAM_L2m, -1); /* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL144_L2_1Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL144_L2_2Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL144_L2_3Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL144_L2_4Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL144_L2_6Xm, -1); /* SRAM */

    /* IP4 compact form 144-bit ACL partition */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL144_TCAM_IPV4m, -1); /* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL144_IPV4_1Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL144_IPV4_2Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL144_IPV4_3Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL144_IPV4_4Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL144_IPV4_6Xm, -1); /* SRAM */

    /* IP6 compact form 144-bit ACL partition */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL144_TCAM_IPV6m, -1); /* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL144_IPV6_1Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL144_IPV6_2Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL144_IPV6_3Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL144_IPV6_4Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL144_IPV6_6Xm, -1); /* SRAM */

    /* L2+IP4 432-bit ACL partition */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL432_TCAM_DATA_L2_IPV4m, -1); /* TCAM data */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL432_L2_IPV4_1Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL432_L2_IPV4_2Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL432_L2_IPV4_3Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL432_L2_IPV4_4Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL432_L2_IPV4_6Xm, -1); /* SRAM */

    /* L2+IP6 432-bit ACL partition */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL432_TCAM_DATA_L2_IPV6m, -1); /* TCAM data */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL432_L2_IPV6_1Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL432_L2_IPV6_2Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL432_L2_IPV6_3Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL432_L2_IPV6_4Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL432_L2_IPV6_6Xm, -1); /* SRAM */

    /* 80-bit ACL partition */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL80_TCAMm, -1); /* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL80_FP_POLICY_1Xm, -1); /* AD */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL80_FP_POLICY_2Xm, -1); /* AD */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL80_FP_POLICY_3Xm, -1); /* AD */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL80_FP_POLICY_4Xm, -1); /* AD */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL80_FP_POLICY_6Xm, -1); /* AD */

    /* 160-bit ACL partition */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL160_TCAMm, -1); /* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL160_FP_POLICY_1Xm, -1); /* AD */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL160_FP_POLICY_2Xm, -1); /* AD */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL160_FP_POLICY_3Xm, -1); /* AD */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL160_FP_POLICY_4Xm, -1); /* AD */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL160_FP_POLICY_6Xm, -1); /* AD */

    /* 320-bit ACL partition */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL320_TCAMm, -1); /* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL320_FP_POLICY_1Xm, -1); /* AD */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL320_FP_POLICY_2Xm, -1); /* AD */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL320_FP_POLICY_3Xm, -1); /* AD */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL320_FP_POLICY_4Xm, -1); /* AD */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL320_FP_POLICY_6Xm, -1); /* AD */

    /* 480-bit ACL partition */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL432_TCAM_MASKm, -1); /* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL432_TCAM_MASK_L2_IPV6m, -1); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL432_TCAM_MASK_IPV6_LONGm, -1); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL360_TCAM_MASKm, -1); /* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL360_TCAM_MASK_IPV6_SHORTm, -1); /* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL480_TCAM_MASKm, -1); /* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL480_TCAM_DATAm, -1); /* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL480_FP_POLICY_1Xm, -1); /* AD */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL480_FP_POLICY_2Xm, -1); /* AD */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL480_FP_POLICY_3Xm, -1); /* AD */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL480_FP_POLICY_4Xm, -1); /* AD */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL480_FP_POLICY_6Xm, -1); /* AD */

    /* All L2 local src entries */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_LOC_SRC_HBITSm, -1); /* SRC hit bit */

    /* All L2+L3 forwarding entries */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_SRC_HBITSm, -1); /* SRC hit bit */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DST_HBITSm, -1); /* DST hit bit */

    /* All L3 forwarding entries */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV4_TCAMm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV6_64_TCAMm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV6_128_TCAMm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DEFIP_DATAm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_L3_UCAST_DATAm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_L3_UCAST_DATA_WIDEm, -1); /* SRAM */

    /* All ACL entries */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_1Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_2Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_3Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_4Xm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_6Xm, -1); /* SRAM */

    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_TCAM_VBIT_ACL80m, -1); /* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_TCAM_VBIT_ACL160m, -1); /* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_TCAM_VBIT_ACL320m, -1); /* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_TCAM_VBIT_ACL480m, -1); /* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_TCAM_VBITm, -1); /* TCAM */
}
