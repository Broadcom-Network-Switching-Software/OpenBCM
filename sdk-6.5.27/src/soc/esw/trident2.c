...
STATIC
_soc_mem_ser_en_info_t _soc_trident2_ip_ecc_mem_ser_info[] = {
    { SOURCE_TRUNK_MAP_TABLEm, {{IPARS_SER_CONTROLr}, 0, SRC_TRUNK_ECC_ENf, -1}, {{IPARS_EN_COR_ERR_RPTr}, 0, SRC_TRUNKf, -1} },
    { PORT_TABm, {{CFG_SER_CONTROLr}, 0, PORT_TABLE_ECC_ENf, -1}, {{ICFG_EN_COR_ERR_RPTr}, 0, PORT_TABLEf, -1} },
    { INVALIDm } /* end */
};
    ...
    switch(*mem) {
        ...
        case MMU_THDM_MCQE_PORTSP_CONFIG_1Bm:
            *mem = MMU_THDM_MCQE_PORTSP_CONFIG_1m;
            break;
        case MMU_THDM_MCQE_QUEUE_OFFSET_0Am:
        case MMU_THDM_MCQE_QUEUE_OFFSET_0Bm:
        case MMU_THDM_MCQE_QUEUE_OFFSET_0Cm:
            *mem = MMU_THDM_MCQE_QUEUE_OFFSET_0m;
            break;
        case MMU_THDM_MCQE_QUEUE_OFFSET_1Am:
        case MMU_THDM_MCQE_QUEUE_OFFSET_1Bm:
        case MMU_THDM_MCQE_QUEUE_OFFSET_1Cm:
            *mem = MMU_THDM_MCQE_QUEUE_OFFSET_1m;
            break;
        case MMU_THDM_MCQE_QUEUE_CONFIG_0Am:
        case MMU_THDM_MCQE_QUEUE_CONFIG_0Bm:
        case MMU_THDM_MCQE_QUEUE_CONFIG_0Cm:
            *mem = MMU_THDM_MCQE_QUEUE_CONFIG_0m;
            break;
        case MMU_THDM_MCQE_QUEUE_CONFIG_1Am:
        case MMU_THDM_MCQE_QUEUE_CONFIG_1Bm:
        case MMU_THDM_MCQE_QUEUE_CONFIG_1Cm:
            *mem = MMU_THDM_MCQE_QUEUE_CONFIG_1m;
            break;
        case MMU_THDM_DB_QUEUE_OFFSET_0Am:
        case MMU_THDM_DB_QUEUE_OFFSET_0Bm:
        case MMU_THDM_DB_QUEUE_OFFSET_0Cm:
            *mem = MMU_THDM_DB_QUEUE_OFFSET_0m;
            break;
        case MMU_THDM_DB_QUEUE_OFFSET_1Am:
        case MMU_THDM_DB_QUEUE_OFFSET_1Bm:
        case MMU_THDM_DB_QUEUE_OFFSET_1Cm:
            *mem = MMU_THDM_DB_QUEUE_OFFSET_1m;
            break;
        case MMU_THDM_DB_QUEUE_CONFIG_0Am:
        case MMU_THDM_DB_QUEUE_CONFIG_0Bm:
        case MMU_THDM_DB_QUEUE_CONFIG_0Cm:
            *mem = MMU_THDM_DB_QUEUE_CONFIG_0m;
            break;
        case MMU_THDM_DB_QUEUE_CONFIG_1Am:
        case MMU_THDM_DB_QUEUE_CONFIG_1Bm:
        case MMU_THDM_DB_QUEUE_CONFIG_1Cm:
            *mem = MMU_THDM_DB_QUEUE_CONFIG_1m;
            break;
        default:
            break;
    }
...
soc_bcm56830_mem_config(int unit)
{
    ...
    index_max = 23;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, TRUNK_GROUPm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, TRUNK_BITMAPm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, TRUNK_CBL_TABLEm, index_max);


    SOP_MEM_STATE_MAX_INDEX_SET(unit, L2MCm, 8191);
...
soc_trident2_mem_config(int unit)
{
    ...
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L2_HITDA_ONLY_Xm, l2_entries / 4 - 1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L2_HITDA_ONLY_Ym, l2_entries / 4 - 1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L2_HITSA_ONLYm, l2_entries / 4 - 1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L2_HITSA_ONLY_Xm, l2_entries / 4 - 1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L2_HITSA_ONLY_Ym, l2_entries / 4 - 1);
    if (soc_feature(unit, soc_feature_shared_bank_lp_disabled)) {
        ...
        SOP_MEM_STATE_MAX_INDEX_SET(unit, L2_ENTRY_LPm, (l2_entries - shared_entries) / 4 - 1);
    } else {
        SOP_MEM_STATE_MAX_INDEX_SET(unit, L2_ENTRY_LPm, l2_entries / 4 - 1);
    }
    ...
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_HIT_ONLY_Xm, l3_entries / 4 - 1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_HIT_ONLY_Ym, l3_entries / 4 - 1);

    if (soc_feature(unit, soc_feature_shared_bank_lp_disabled)) {
        /* Initialize to dedicated L3 entries count. */
        shared_entries = shared_l3_banks * shared_bank_size * 1024;
        SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_LPm, (l3_entries - shared_entries) / 4 - 1);
    } else {
        SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_LPm, l3_entries / 4 - 1);
    }
    ...
    if (!(alpm_enable && soc_feature(unit, soc_feature_alpm))) {
        ...
        SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_DEFIP_ALPM_HIT_ONLY_Xm, -1);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_DEFIP_ALPM_HIT_ONLY_Ym, -1);
#ifdef BCM_TRIDENT2PLUS_SUPPORT
        if (SOC_IS_TD2P_TT2P(unit)) {
    ...
    switch (num_ecmp_rh_flowset_entries) {
        ...
        case 32768:
            ...
            SOP_MEM_STATE_MAX_INDEX_SET(unit, RH_LAG_FLOWSETm, index_max / 2);
            SOP_MEM_STATE_MAX_INDEX_GET(unit, RH_ECMP_FLOWSETm, index_max);
            SOP_MEM_STATE_MAX_INDEX_SET(unit, RH_ECMP_FLOWSETm, index_max / 2);
            break;
        case 65536:
    ...
    if (!soc_feature(unit, soc_feature_lpm_tcam)) {
        ...
        SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_DEFIP_PAIR_128_HIT_ONLY_Xm, -1);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_DEFIP_PAIR_128_HIT_ONLY_Ym, -1);
        ...
        SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_DEFIP_HIT_ONLY_Xm, -1);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_DEFIP_HIT_ONLY_Ym, -1);
        ...
        if (!(soc_property_get(unit, spn_L3_ALPM_ENABLE, 0) &&
            ...
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_DEFIP_PAIR_128_HIT_ONLY_Xm, num_ipv6_128b_entries - 1);
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_DEFIP_PAIR_128_HIT_ONLY_Ym, num_ipv6_128b_entries - 1);
           ...
           */
            ...
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_DEFIP_HIT_ONLY_Xm, num_defip_entries - 1);
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_DEFIP_HIT_ONLY_Ym, num_defip_entries - 1);
...
#endif
        {
            /* (PVT_DATA * 990 * 8) / (1024 * 7) */
            fval = (fval * 990 * 8) / (1024 * 7);
        }
        avg += fval;
        LOG_CLI((BSL_META_U(unit,
...
STATIC int
soc_trident2_ser_single_bit_sw_correction_enable_set(int unit, int enable)
{
    int i, value, k;
    soc_reg_t ecc_reg;
    soc_field_t ecc_fld;
    ...
    value = enable ? 1:0;
    mem_ser_info_all[0] = _soc_trident2_ip_ecc_mem_ser_info;
    mem_ser_info_all[1] = _soc_trident2_mmu_ecc_mem_ser_info;
    mem_ser_info_all[2] = NULL;

    for (k = 0; k < MEM_SER_INFO_COUNT; k++) {
        mem_ser_info = mem_ser_info_all[k];
        if (mem_ser_info == NULL) {
            break;
        }
        for (i = 0; mem_ser_info[i].mem != INVALIDm; i++) {
            if (!SOC_MEM_IS_VALID(unit, mem_ser_info[i].mem)) {
...
STATIC int
soc_trident2_ser_single_bit_sw_correction_enable_get(int unit, int *enable)
{
    soc_reg_t ecc_reg;
    soc_field_t ecc_fld;
    _soc_mem_ser_en_info_t *mem_ser_info;
    ...
    mem_ser_info = _soc_trident2_ip_ecc_mem_ser_info;
...
STATIC int
soc_trident2p_ser_single_bit_sw_correction_enable_set(int unit, int enable)
{
#ifdef BCM_56860_A0
    int i, value, k;
    soc_reg_t ecc_reg;
...
STATIC int
soc_trident2p_ser_single_bit_sw_correction_enable_get(int unit, int *enable)
{
#ifdef BCM_56860_A0
    soc_reg_t ecc_reg;
    soc_field_t ecc_fld;
...
/*
 * Function:
 *      soc_td2x_ser_single_bit_sw_correction_enable_set
 * Purpose:
 *      Enable/Disable single bit eror reporting for the memories which are
 *      protected by ECC logic and whoes SER_RESPONSE is not SER_NONE on TD2/TD2p chips
 * Parameters:
 *      unit        - (IN) Device Number
 *      enable         - (IN) Enable/Disable
 * Returns:
 *      SOC_E_NONE if set successfully, an error otherwise
 */
int soc_td2x_ser_single_bit_sw_correction_enable_set(int unit, int enable)
{
    int rv = SOC_E_NONE;

#ifdef BCM_TRIDENT2PLUS_SUPPORT
    if (SOC_IS_TD2P_TT2P(unit)) {
        rv = soc_trident2p_ser_single_bit_sw_correction_enable_set(unit, enable);
    } else
#endif
    {
        rv = soc_trident2_ser_single_bit_sw_correction_enable_set(unit, enable);
    }
    return rv;
}
...
/*
 * Function:
 *      soc_td2x_ser_single_bit_sw_correction_enable_get
 * Purpose:
 *      Get the status of single bit eror reporting for the memories which are
 *      protected by ECC logic and whoes SER_RESPONSE is not SER_NONE on TD2/TD2p chips
 * Parameters:
 ...
 *      SOC_E_NONE if get successfully, an error otherwise
 */
int soc_td2x_ser_single_bit_sw_correction_enable_get(int unit, int *enable)
{
    int rv = SOC_E_NONE;

#ifdef BCM_TRIDENT2PLUS_SUPPORT
    if (SOC_IS_TD2P_TT2P(unit)) {
        rv = soc_trident2p_ser_single_bit_sw_correction_enable_get(unit, enable);
    } else
#endif
    {
        rv = soc_trident2_ser_single_bit_sw_correction_enable_get(unit, enable);
    }
    return rv;
}
