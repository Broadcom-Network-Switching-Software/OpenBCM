...
soc_ml_mem_config(int unit, int dev_id)
{
    ...
    int defip_config = 0, index_max = 0;
    ...
    if (soc_feature(unit, soc_feature_untethered_otp)) {
        ...
        if (socBondInfoFeatureL2Entry8k) {
            ...
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L2Xm, 32767);
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L2_ENTRY_ONLYm, 32767);
        } else {
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L2Xm, 32767);
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L2_ENTRY_ONLYm, 32767); 
        }
        ...
        if (socBondInfoFeatureIpVlanXlate1k) {
            SOP_MEM_STATE_MAX_INDEX_SET(unit, VLAN_XLATEm, 1023);
            SOP_MEM_STATE_MAX_INDEX_SET(unit, VLAN_MACm, 1023); 
        ...
        if (socBondInfoFeatureMpls1k) {
            ...
            SOP_MEM_STATE_MAX_INDEX_SET(unit, MPLS_ENTRYm, 4095);
        }else {
            SOP_MEM_STATE_MAX_INDEX_SET(unit, MPLS_ENTRYm, 4095);
        }
        if (socBondInfoFeatureL3Entry1k) {
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_ONLYm, 1023);
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_IPV4_UNICASTm, 1023);
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_IPV4_MULTICASTm, 511);
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_IPV6_UNICASTm, 511);
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_IPV6_MULTICASTm, 255);
        }
