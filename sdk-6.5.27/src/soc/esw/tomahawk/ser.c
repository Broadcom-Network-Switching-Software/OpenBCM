...
_soc_buffer_ser_en_info_t _soc_th_ip_buffer_ser_info[] = {
    ...
    { "BUBBLE_MOP", ISW2_SER_CONTROL_0_64r, CPB_PARITY_ENf, ISW2_SER_CONTROL_0_64r, CPB_EN_COR_ERR_RPTf },
    ...
    { "LEARN_FIFO", LEARN_FIFO_ECC_CONTROLr, ECC_ENf, LEARN_FIFO_ECC_CONTROLr, EN_COR_ERR_RPTf },
...
_soc_buffer_ser_en_info_t _soc_th_ep_buffer_ser_info[] = {
    { "EDB_PM0_MEM", EGR_EDATABUF_PARITY_CONTROLr, PM0_ECC_ENf, EGR_EDATABUF_EN_COR_ERR_RPTr, PM0_ENf },
    { "EDB_PM1_MEM", EGR_EDATABUF_PARITY_CONTROLr, PM1_ECC_ENf, EGR_EDATABUF_EN_COR_ERR_RPTr, PM1_ENf },
    { "EDB_PM2_MEM", EGR_EDATABUF_PARITY_CONTROLr, PM2_ECC_ENf, EGR_EDATABUF_EN_COR_ERR_RPTr, PM2_ENf },
    { "EDB_PM3_MEM", EGR_EDATABUF_PARITY_CONTROLr, PM3_ECC_ENf, EGR_EDATABUF_EN_COR_ERR_RPTr, PM3_ENf },
    { "EDB_PM4_MEM", EGR_EDATABUF_PARITY_CONTROLr, PM4_ECC_ENf, EGR_EDATABUF_EN_COR_ERR_RPTr, PM4_ENf },
    { "EDB_PM5_MEM", EGR_EDATABUF_PARITY_CONTROLr, PM5_ECC_ENf, EGR_EDATABUF_EN_COR_ERR_RPTr, PM5_ENf },
    { "EDB_PM6_MEM", EGR_EDATABUF_PARITY_CONTROLr, PM6_ECC_ENf, EGR_EDATABUF_EN_COR_ERR_RPTr, PM6_ENf },
    { "EDB_PM7_MEM", EGR_EDATABUF_PARITY_CONTROLr, PM7_ECC_ENf, EGR_EDATABUF_EN_COR_ERR_RPTr, PM7_ENf },
    { "EDB_CM_MEM", EGR_EDATABUF_PARITY_CONTROLr, CM_ECC_ENf, EGR_EDATABUF_EN_COR_ERR_RPTr, CM_ENf },
    { "EDB_LBP_MEM", EGR_EDATABUF_PARITY_CONTROLr, LBP_ECC_ENf, EGR_EDATABUF_EN_COR_ERR_RPTr, LBP_ENf },
    { "EDB_PERQ_MEM", EGR_EDATABUF_PARITY_CONTROLr, PERQ_ECC_ENf, EGR_EDATABUF_EN_COR_ERR_RPTr, PERQ_ENf },
    { "EDB_EFPCTR_MEM", EGR_EDATABUF_PARITY_CONTROLr, EFPCTR_ECC_ENf, EGR_EDATABUF_EN_COR_ERR_RPTr, EFPCTR_ENf },
    { "EDB_PM0_CTRL", EGR_EDB_CTRL_PARITY_ENr, PM0_ECC_ENf, EGR_EDATABUF_EN_COR_ERR_RPT_1r, PM0_ENf },
    { "EDB_PM1_CTRL", EGR_EDB_CTRL_PARITY_ENr, PM1_ECC_ENf, EGR_EDATABUF_EN_COR_ERR_RPT_1r, PM1_ENf },
    { "EDB_PM2_CTRL", EGR_EDB_CTRL_PARITY_ENr, PM2_ECC_ENf, EGR_EDATABUF_EN_COR_ERR_RPT_1r, PM2_ENf },
    { "EDB_PM3_CTRL", EGR_EDB_CTRL_PARITY_ENr, PM3_ECC_ENf, EGR_EDATABUF_EN_COR_ERR_RPT_1r, PM3_ENf },
    { "EDB_PM4_CTRL", EGR_EDB_CTRL_PARITY_ENr, PM4_ECC_ENf, EGR_EDATABUF_EN_COR_ERR_RPT_1r, PM4_ENf },
    { "EDB_PM5_CTRL", EGR_EDB_CTRL_PARITY_ENr, PM5_ECC_ENf, EGR_EDATABUF_EN_COR_ERR_RPT_1r, PM5_ENf },
    { "EDB_PM6_CTRL", EGR_EDB_CTRL_PARITY_ENr, PM6_ECC_ENf, EGR_EDATABUF_EN_COR_ERR_RPT_1r, PM6_ENf },
    { "EDB_PM7_CTRL", EGR_EDB_CTRL_PARITY_ENr, PM7_ECC_ENf, EGR_EDATABUF_EN_COR_ERR_RPT_1r, PM7_ENf },
    { "EDB_CM_CTRL", EGR_EDB_CTRL_PARITY_ENr, CM_ECC_ENf, EGR_EDATABUF_EN_COR_ERR_RPT_1r, CM_ENf },
    { "EDB_LBP_CTRL", EGR_EDB_CTRL_PARITY_ENr, LBP_ECC_ENf, EGR_EDATABUF_EN_COR_ERR_RPT_1r, LBP_ENf },
    { "INITBUF", EGR_EL3_ECC_PARITY_CONTROLr, INITBUF_ECC_ENf, EGR_EHCPM_EN_COR_ERR_RPTr, EINITBUFf },
    { "EGR_MPB", EGR_EL3_ECC_PARITY_CONTROLr, EGR_MPB_ECC_ENf, EGR_EL3_EN_COR_ERR_RPTr, MPB_DATAf },
    { "EP_EDB_PM_RESI_BUFF", EGR_EDATABUF_PARITY_CONTROLr, PM_RESI_BUFFER_PAR_ENf, INVALIDr, INVALIDf },
    { "", INVALIDr }
};
...
#ifdef BCM_TOMAHAWK3_SUPPORT
                if (SOC_IS_TOMAHAWK3(unit)) {
                    if (rb->cmic_bit != _SOC_TH3_CEV_INTR) {
...
STATIC void
_soc_thx_ser_reg_control_get(int unit,
                             const _soc_reg_ser_en_info_t *ser_en_info_list,
                             soc_reg_t   reg,
                             soc_reg_t   *ser_control_reg,
                             soc_mem_t   *ser_control_mem,
                             soc_field_t *ser_enable_field)
{
    int i;
    if ((ser_en_info_list == NULL) || (ser_control_reg == NULL) ||
        (ser_control_mem == NULL) || (ser_enable_field == NULL)) {
        return;
    }
    for (i = 0; ser_en_info_list[i].reg != INVALIDr; i++) {
        if (ser_en_info_list[i].reg == reg) {
            *ser_control_reg = ser_en_info_list[i].en_ctrl.flag_reg_mem ? INVALIDr :
                               ser_en_info_list[i].en_ctrl.ctrl_type.en_reg;
            *ser_control_mem = ser_en_info_list[i].en_ctrl.flag_reg_mem ?
                               ser_en_info_list[i].en_ctrl.ctrl_type.en_mem :
...
STATIC int
_soc_th_reg_is_dyn(int unit, soc_reg_t reg)
{
    int rv = 0; /* reg is not dynamic */

    if ((SOC_REG_INFO(unit, reg).flags & SOC_MEM_FLAG_SER_ENTRY_CLEAR) ||
        (SOC_REG_INFO(unit, reg).flags & SOC_MEM_FLAG_SER_WRITE_CACHE_RESTORE)) {
        /* 1st term means mem is dynamic - eg: counter */
        /* 2nd term means table with both software managed and hardware updated fields */
        rv = 1;
    } else {
    ...
    if (rv) {
        LOG_VERBOSE(BSL_LS_SOC_SER,
            (BSL_META_U(unit,
                        "unit %d, reg %s is dynamic - so read of corrupted"
                        " entry will be skipped !!\n"),
             unit, SOC_REG_NAME(unit,reg)));
    }
    return rv;
                         ...
                         uint32 hwbase)
{
    ...
    */
    ...
    if (mem != INVALIDm) {
        ...
        SOC_MEM_STATE_MEMBER_GET(unit, mem, cache[mem_block], cache);
        SOC_MEM_STATE_MEMBER_GET(unit, mem, vmap[mem_block], vmap);
...
STATIC int
_soc_th_populate_ser_log_for_reg(int unit, soc_reg_t parity_enable_reg,
                                 soc_mem_t parity_enable_mem,
                                 soc_field_t parity_enable_field,
                                 soc_reg_t reg,
                                 int index,
                                 ...
                                 sal_usecs_t detect_time)
{
    int log_entry_size, id;
    soc_ser_log_tlv_register_t log_reg;
    soc_ser_log_tlv_generic_t log_generic;
    int skip_pop = 0;
    int cache = 0;
    int rv;
    uint64 rval64, rval64_cache;

    sal_memset(&log_generic, 0, sizeof(log_generic));
    sal_memset(&log_reg, 0, sizeof(log_reg));
    COMPILER_64_ZERO(rval64);
    COMPILER_64_ZERO(rval64_cache);
    ...
    if (reg != INVALIDr) {
        skip_pop = _soc_th_reg_is_dyn(unit, reg) ||
                   ((parity_enable_reg == INVALIDr) &&
                   (parity_enable_mem == INVALIDm)) ||
                   (parity_enable_field == INVALIDf);
        ...
        /* Check to make sure this isn't a duplicate */
        /* Search for a log entry with the same reg, port, and index with within
         * the last 5 seconds */
        rv = soc_ser_reg_log_find_recent(unit, reg, port, index, sal_time_usecs());
        if (rv > 0) {
            LOG_VERBOSE(BSL_LS_SOC_SER,
                (BSL_META_U(unit,
                            "unit %d, ser_logging was skipped for reg %s "
                            "- too close to similar event !!\n"),
                 unit, SOC_REG_NAME(unit,reg)));
            return rv;
        }
        ...
        if (!skip_pop) {
            log_entry_size += sizeof(soc_ser_log_tlv_hdr_t) + sizeof(uint64);

            rv = soc_ser_reg_cache_get(unit, reg, port, index, &rval64_cache);
            if (rv == SOC_E_NONE) {
                cache = 1;
                log_entry_size += sizeof(soc_ser_log_tlv_hdr_t) + sizeof(uint64);
            }
        ...
        /* Add the register information to the log now so we can detect duplicate errors */
        log_generic.time = detect_time;
        log_reg.reg = reg;
        log_reg.port = port;
        log_reg.index = index;
        soc_ser_log_add_tlv(unit, id, SOC_SER_LOG_TLV_REGISTER,
                            sizeof(soc_ser_log_tlv_register_t), &log_reg);
        soc_ser_log_add_tlv(unit, id, SOC_SER_LOG_TLV_GENERIC,
                            sizeof(soc_ser_log_tlv_generic_t), &log_generic);

        /* If we have decoded the register we can record its contents
         * (which can help with analysis with nature of the error
         */
        if (!skip_pop) {
#ifdef BCM_TOMAHAWK3_SUPPORT
            ...
            /* read the reg data */
            soc_reg_get(unit, reg, port, index, &rval64);
            ...
            /* fill in the reg contents tlv */
            if (soc_ser_log_add_tlv(unit, id, SOC_SER_LOG_TLV_CONTENTS,
                sizeof(uint64), &rval64) < 0) {
                return 0;
            }

            if (cache) {
                /* fill in the reg cache tlv */
                if (soc_ser_log_add_tlv(unit, id, SOC_SER_LOG_TLV_CACHE,
                    sizeof(uint64), &rval64_cache) < 0) {
                    return 0;
                }
            }
        }
...
_soc_tomahawk_ser_mmu_mem_remap(_soc_ser_correct_info_t *spci)
{
    ...
    case MMU_MTRO_L0_MEM_A_PIPE0m:
    case MMU_MTRO_L0_MEM_B_PIPE0m:
        spci->mem = MMU_MTRO_L0_MEM_PIPE0m; break;
    case MMU_MTRO_L0_MEM_A_PIPE1m:
    case MMU_MTRO_L0_MEM_B_PIPE1m:
        spci->mem = MMU_MTRO_L0_MEM_PIPE1m; break;
    case MMU_MTRO_L0_MEM_A_PIPE2m:
    case MMU_MTRO_L0_MEM_B_PIPE2m:
        spci->mem = MMU_MTRO_L0_MEM_PIPE2m; break;
    case MMU_MTRO_L0_MEM_A_PIPE3m:
    case MMU_MTRO_L0_MEM_B_PIPE3m:
        spci->mem = MMU_MTRO_L0_MEM_PIPE3m; break;
    case MMU_MTRO_L1_MEM_A_PIPE0m:
    case MMU_MTRO_L1_MEM_B_PIPE0m:
        spci->mem = MMU_MTRO_L1_MEM_PIPE0m; break;
    case MMU_MTRO_L1_MEM_A_PIPE1m:
    case MMU_MTRO_L1_MEM_B_PIPE1m:
        spci->mem = MMU_MTRO_L1_MEM_PIPE1m; break;
    case MMU_MTRO_L1_MEM_A_PIPE2m:
    case MMU_MTRO_L1_MEM_B_PIPE2m:
        spci->mem = MMU_MTRO_L1_MEM_PIPE2m; break;
    case MMU_MTRO_L1_MEM_A_PIPE3m:
    case MMU_MTRO_L1_MEM_B_PIPE3m:
        spci->mem = MMU_MTRO_L1_MEM_PIPE3m; break;
    case MMU_INTFO_TC2PRI_MAPPING0m:
    case MMU_INTFO_TC2PRI_MAPPING1m:
    case MMU_INTFO_TC2PRI_MAPPING2m:
    case MMU_INTFO_TC2PRI_MAPPING3m:
        spci->mem = MMU_INTFO_TC2PRI_MAPPINGm; break;
#endif
#ifdef BCM_TOMAHAWK3_SUPPORT
        ...
        if (parity_error == 1) {
            ...
            do {
                ...
                if ((spci.mem != INVALIDm) &&
...
#if defined(BCM_TOMAHAWK3_SUPPORT)
                    if (SOC_IS_TOMAHAWK3(unit) &&
                        (spci.mem == MMU_QSCH_L2_WEIGHT_MEM_PIPE0m ||
                         spci.mem == MMU_QSCH_L2_WEIGHT_MEM_PIPE1m ||
                         spci.mem == MMU_QSCH_L2_WEIGHT_MEM_PIPE2m ||
                         spci.mem == MMU_QSCH_L2_WEIGHT_MEM_PIPE3m ||
                         spci.mem == MMU_QSCH_L2_WEIGHT_MEM_PIPE4m ||
                         spci.mem == MMU_QSCH_L2_WEIGHT_MEM_PIPE5m ||
                         spci.mem == MMU_QSCH_L2_WEIGHT_MEM_PIPE6m ||
                         spci.mem == MMU_QSCH_L2_WEIGHT_MEM_PIPE7m)) {
                        uint32 value = 0;
                        SOC_IF_ERROR_RETURN(soc_reg32_get(unit, MMU_QSCH_VOQ_FAIRNESS_CONFIGr,
                                                          REG_PORT_ANY, 0, &rval));
                        value = soc_reg_field_get(unit, MMU_QSCH_VOQ_FAIRNESS_CONFIGr, rval,
                                                  DYNAMIC_WEIGHT_ENABLEf);
                        if (value) {
                            if (spci.double_bit) {
                                soc_event_generate(unit, SOC_SWITCH_EVENT_PARITY_ERROR,
                            ...
                            if (spci.flags & SOC_SER_ECC_1BIT_ERROR) {
                                soc_event_generate(unit, SOC_SWITCH_EVENT_PARITY_ERROR,
                    ...
                    spci.pipe_num = (spci.addr >> 15) & 0x3;
                    (void)soc_add_log_generic(unit, &spci);
                              ...
                              int schan, char *prefix_str, char *mem_str, soc_block_t blocktype)
{
    ...
    if (has_error) {
        ...
        if (id != 0) {
            ...
            sal_memset(&log_generic, 0, sizeof(log_generic));
            sal_memset(&log_reg, 0, sizeof(soc_ser_log_tlv_register_t));
            log_generic.flags = 0;
            if (double_bit) {
                log_generic.flags |= SOC_SER_LOG_FLAG_DOUBLEBIT;
            }
            log_generic.boot_count = soc_ser_log_get_boot_count(unit);
            log_generic.block_type = blocktype;
            log_generic.parity_type = SOC_PARITY_TYPE_ECC;
            log_generic.ser_response_flag = 0;
            log_generic.corrected = single_bit ? SOC_SER_CORRECTED : SOC_SER_UNCORRECTED;
            log_generic.pipe_num = pipe;

            soc_ser_log_add_tlv(unit, id, SOC_SER_LOG_TLV_GENERIC,
                sizeof(soc_ser_log_tlv_generic_t), &log_generic);
            log_reg.port = port;
            log_reg.reg = INVALIDr;
            soc_ser_log_add_tlv(unit, id, SOC_SER_LOG_TLV_REGISTER,
                sizeof(soc_ser_log_tlv_register_t), &log_reg);

            soc_event_generate(unit, SOC_SWITCH_EVENT_PARITY_ERROR,
                               SOC_SWITCH_EVENT_DATA_ERROR_LOG, id, 0);
        }
    }
...
#endif
#ifdef BCM_TOMAHAWK2_SUPPORT
STATIC char *_soc_th2_ser_hwmem_base_info[] = {
    /* from SER_STATUS_BUS format in regsfile */
                ...
                if (non_sbus) {
                    ...
                    if (SOC_IS_TOMAHAWK2(unit)) {
                        LOG_WARN(BSL_LS_SOC_SER,
                                  (BSL_META_U(unit,
                                              "Mem hwbase: 0x%x [%s]\n"), base,
                                   _soc_th2_ser_hwmem_base_info[base]));
                    } else
#endif
                    {
                        LOG_WARN(BSL_LS_SOC_SER,
...
STATIC void
_soc_thx_check_flex_counter(soc_mem_t mem, int index, int *disable)
{
    switch(mem) {
...
#ifdef BCM_TOMAHAWK3_SUPPORT
STATIC void
_soc_tomahawk3_tcam_only_remap(int unit, soc_mem_t *mem)
{
    switch(*mem) {
        case MY_STATION_TCAM_ENTRY_ONLYm:
            *mem = MY_STATION_TCAMm;
                              ...
                              char *prefix_str, int l2_mgmt_ser_fifo, int reg_type, int cmic_bit)
{
    ...
    _soc_reg_ser_en_info_t *ser_reg_info_table = NULL;
    ...
    case SOC_BLK_IPIPE:
        ...
        ser_reg_info_table = SOC_IP_REG_SER_INFO(unit);
        break;
    case SOC_BLK_EPIPE:
#ifdef BCM_TOMAHAWK3_SUPPORT
        if (SOC_IS_TOMAHAWK3(unit)) {
        ...
        ser_reg_info_table = SOC_EP_REG_SER_INFO(unit);
        break;
 ...
 */
                ...
                if (non_sbus == 0) {
                    ...
                    if (SOC_IS_TOMAHAWK3(unit) &&
                        soc_feature(unit, soc_feature_tcam_scan_engine)) {
                        _soc_tomahawk3_tcam_only_remap(unit, &spci.mem);
                    }
#endif
                    if (spci.mem != INVALIDm) {
                        spci.flags |= SOC_SER_REG_MEM_KNOWN;
                        if (!spci.double_bit) {
                            ...
                            _soc_thx_check_flex_counter(spci.mem, spci.index, &disable_ser_correction);
                        }
 ...
 */
                    ...
                    if (!disable_ser_correction && !l2_mgmt_ser_fifo) {
                        LOG_VERBOSE(BSL_LS_SOC_SER, (BSL_META_U(unit,
                            ...
                            unit, (spci.mem != INVALIDm) ? SOC_MEM_NAME(unit, spci.mem) : "INVALIDm",
                            spci.pipe_num));
                        rv = soc_ser_correction(unit, &spci);
                    } else {
                        (void)soc_add_log_generic(unit, &spci);
                ...
                if (l2_mgmt_ser_fifo) {
                    ...
                    spci.reg = ainfo.reg;
                    _soc_thx_ser_reg_control_get(unit, ser_reg_info_table,
                                                 spci.reg,
                                                 &parity_enable_reg,
                                                 &parity_enable_mem,
                                                 &parity_enable_field);
                    spci.log_id = _soc_th_populate_ser_log_for_reg(unit,
                                                                   parity_enable_reg,
                                                                   parity_enable_mem,
                                                                   parity_enable_field,
                                                                   spci.reg,
...
int
soc_th_ifp_slice_mode_check(int unit, soc_mem_t mem, int slice, int *slice_skip)
{
    ...
    *slice_skip = 0;
    ...
    LOG_VERBOSE(BSL_LS_SOC_SER,
        (BSL_META_U(unit, "soc_th_ifp_slice_mode_check: For mem %s, read reg %s, slice_enabled = %0d, slice_width = %0d, slice_skip = %0d\n"),
                         ...
                         int en_per_pipe_read, uint8 *vmap)
{
    ...
    for (slice = 0; slice < slice_count; slice++) {
        ...
        SOC_IF_ERROR_RETURN(
            soc_th_ifp_slice_mode_check(unit, mem, slice,
                                        &slice_skip));
        if (!slice_skip) {
            if (en_per_pipe_read) {
                int i;
...
_soc_th_ifp_tcam_index_valid(int unit, soc_mem_t mem, int index) {
    ...
    for (slice = 0; slice < slice_count && index >= slice_start_addr; slice++) {
        ...
        if (index >= slice_start_addr && index <= slice_end_addr) {
            rv = soc_th_ifp_slice_mode_check(unit, mem, slice, &slice_skip);
            if (SOC_FAILURE(rv)) {
                LOG_ERROR(BSL_LS_SOC_SER,
                        (BSL_META_U(unit,
...
int soc_th_ser_single_bit_report_for_bus_buf_set(int unit, int enable)
{
    int i, value, k;
    soc_reg_t ecc_reg;
    soc_field_t ecc_fld;
...
#ifdef BCM_TOMAHAWK3_SUPPORT
    soc_reg_t edb_ctrl_reg = EDB_CONTROL_BUFFER_EN_COR_ERR_RPTr;
    soc_reg_t edb_data_reg = EDB_DATA_BUFFER_EN_COR_ERR_RPTr;
    soc_field_t edb_ctrl_fields[] = {PM3_ENf, PM2_ENf, PM1_ENf, PM0_ENf, INVALIDf};
    soc_field_t edb_data_fields[] = {PM3_ENf, PM2_ENf, PM1_ENf, PM0_ENf, RESIDUAL_ENf, INVALIDf};
#endif
...
#ifdef BCM_TOMAHAWK_SUPPORT
    if (SOC_IS_TOMAHAWK(unit)) {
        bus_ser_info_all[0] = _soc_th_ip_bus_ser_info;
        bus_ser_info_all[1] = _soc_th_ep_bus_ser_info;
        buf_ser_info_all[0] = _soc_th_ip_buffer_ser_info;
        buf_ser_info_all[1] = _soc_th_ep_buffer_ser_info;
    } else
#endif
    {
...
#ifdef BCM_TOMAHAWK3_SUPPORT
    if (SOC_IS_TOMAHAWK3(unit)) {
        for(i = 0; edb_ctrl_fields[i] != INVALIDf; i++) {
            SOC_IF_ERROR_RETURN
                (soc_reg_field32_modify(unit, edb_ctrl_reg, REG_PORT_ANY,
                                        edb_ctrl_fields[i], value));
        }
        for(i = 0; edb_data_fields[i] != INVALIDf; i++) {
            SOC_IF_ERROR_RETURN
                (soc_reg_field32_modify(unit, edb_data_reg, REG_PORT_ANY,
                                        edb_data_fields[i], value));
        }
    }
#endif
    return SOC_E_NONE;
...
int soc_th_ser_single_bit_report_for_bus_buf_get(int unit, int *enable)
{
    int i;
    soc_reg_t ecc_reg;
    soc_field_t ecc_fld;
...
#ifdef BCM_TOMAHAWK_SUPPORT
    if (SOC_IS_TOMAHAWK(unit)) {
        buf_ser_info = _soc_th_ip_buffer_ser_info;
    } else
#endif
    {
        buf_ser_info = SOC_IP_BUF_SER_INFO(unit);
    }

    if (NULL == buf_ser_info) {
        return SOC_E_UNAVAIL;
    }
    ...
    for (i = 0; buf_ser_info[i].en_reg != INVALIDr; i++) {
        ...
        COMPILER_64_ZERO(rval64);
        SOC_IF_ERROR_RETURN(soc_reg_get(unit, ecc_reg, REG_PORT_ANY, 0, &rval64));
        value = soc_reg64_field32_get(unit, ecc_reg, rval64, ecc_fld);
        break;
    }
...
const ser_th_skipped_mem_t th_skipped_mems[] = {
    ...
    { MMU_CBPDATA0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA0_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA0_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA0_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA0_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA1_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA1_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA1_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA1_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA2_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA2_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA2_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA2_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA3_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA3_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA3_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA3_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA4m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA4_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA4_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA4_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA4_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA5m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA5_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA5_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA5_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA5_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA6m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA6_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA6_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA6_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA6_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA7m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA7_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA7_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA7_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA7_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA8m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA8_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA8_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA8_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA8_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA9m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA9_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA9_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA9_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA9_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA10m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA10_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA10_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA10_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA10_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA11m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA11_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA11_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA11_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA11_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA12m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA12_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA12_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA12_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA12_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA13m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA13_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA13_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA13_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA13_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA14m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA14_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA14_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA14_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA14_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA15m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA15_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA15_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA15_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA15_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA16m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA16_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA16_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA16_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA16_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA17m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA17_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA17_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA17_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA17_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA18m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA18_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA18_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA18_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA18_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA19m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA19_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA19_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA19_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA19_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA20m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA20_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA20_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA20_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA20_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA21m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA21_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA21_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA21_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA21_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA22m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA22_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA22_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA22_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA22_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA23m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA23_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA23_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA23_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA23_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA24m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA24_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA24_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA24_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA24_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA25m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA25_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA25_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA25_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA25_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA26m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA26_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA26_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA26_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA26_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA27m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA27_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA27_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA27_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA27_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA28m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA28_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA28_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA28_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA28_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA29m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA29_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA29_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA29_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA29_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA30m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA30_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA30_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA30_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA30_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA31m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA31_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA31_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA31_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA31_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA32m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA32_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA32_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA32_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA32_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA33m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA33_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA33_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA33_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA33_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA34m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA34_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA34_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA34_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA34_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA35m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA35_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA35_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA35_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA35_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA36m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA36_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA36_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA36_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA36_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA37m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA37_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA37_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA37_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA37_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA38m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA38_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA38_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA38_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA38_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA39m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA39_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA39_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA39_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA39_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA40m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA40_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA40_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA40_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA40_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA41m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA41_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA41_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA41_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA41_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA42m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA42_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA42_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA42_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA42_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA43m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA43_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA43_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA43_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA43_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA44m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA44_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA44_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA44_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA44_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA45m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA45_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA45_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA45_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA45_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA46m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA46_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA46_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA46_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA46_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA47m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA47_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA47_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA47_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA47_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA48m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA48_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA48_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA48_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA48_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA49m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA49_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA49_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA49_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA49_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA50m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA50_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA50_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA50_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA50_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA51m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA51_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA51_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA51_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA51_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA52m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA52_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA52_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA52_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA52_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA53m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA53_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA53_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA53_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA53_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA54m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA54_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA54_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA54_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA54_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA55m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA55_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA55_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA55_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA55_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA56m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA56_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA56_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA56_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA56_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA57m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA57_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA57_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA57_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA57_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA58m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA58_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA58_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA58_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA58_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA59m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA59_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA59_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA59_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CBPDATA59_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CCP_MEMm, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CCP_MEM_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CCP_MEM_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CCP_MEM_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CCP_MEM_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CCP_RESEQ_MEMm, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CCP_RESEQ_MEM_XPE0_PIPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CCP_RESEQ_MEM_XPE0_PIPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CCP_RESEQ_MEM_XPE1_PIPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CCP_RESEQ_MEM_XPE1_PIPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CCP_RESEQ_MEM_XPE2_PIPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CCP_RESEQ_MEM_XPE2_PIPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CCP_RESEQ_MEM_XPE3_PIPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CCP_RESEQ_MEM_XPE3_PIPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CELL_LINKm, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CELL_LINK_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CELL_LINK_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CELL_LINK_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CELL_LINK_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    ...
    { MMU_CFAP_BANK14_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CFAP_BANK14_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_CFAP_BANK14_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_ENQS_CT_FIFOm, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_ENQS_CT_FIFO_PIPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_ENQS_CT_FIFO_PIPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_ENQS_CT_FIFO_PIPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_ENQS_CT_FIFO_PIPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_ENQS_PBI_DBm, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_ENQS_PBI_DB_SC0_PIPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_ENQS_PBI_DB_SC0_PIPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_ENQS_PBI_DB_SC0_PIPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_ENQS_PBI_DB_SC0_PIPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_ENQS_PBI_DB_SC1_PIPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_ENQS_PBI_DB_SC1_PIPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_ENQS_PBI_DB_SC1_PIPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_ENQS_PBI_DB_SC1_PIPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
#ifdef BCM_TOMAHAWK2_SUPPORT
    { MMU_ENQS_PBI_DBm, _SOC_ACC_TYPE_PIPE_ANY, 1 },
...
#endif
    { MMU_ENQX_PIPEMEM_HIm, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_ENQX_PIPEMEM_HI_XPE0_PIPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_ENQX_PIPEMEM_HI_XPE0_PIPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_ENQX_PIPEMEM_HI_XPE1_PIPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_ENQX_PIPEMEM_HI_XPE1_PIPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_ENQX_PIPEMEM_HI_XPE2_PIPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_ENQX_PIPEMEM_HI_XPE2_PIPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_ENQX_PIPEMEM_HI_XPE3_PIPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_ENQX_PIPEMEM_HI_XPE3_PIPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_ENQX_PIPEMEM_LOm, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_ENQX_PIPEMEM_LO_XPE0_PIPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_ENQX_PIPEMEM_LO_XPE0_PIPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_ENQX_PIPEMEM_LO_XPE1_PIPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_ENQX_PIPEMEM_LO_XPE1_PIPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_ENQX_PIPEMEM_LO_XPE2_PIPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_ENQX_PIPEMEM_LO_XPE2_PIPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_ENQX_PIPEMEM_LO_XPE3_PIPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_ENQX_PIPEMEM_LO_XPE3_PIPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_EPRG_MEMm, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_EPRG_MEM_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_EPRG_MEM_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_EPRG_MEM_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_EPRG_MEM_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCFPm, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCFP_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCFP_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCFP_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCFP_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCQDB_X_Am, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCQDB_X_A_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCQDB_X_A_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCQDB_X_A_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCQDB_X_A_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCQDB_X_Bm, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCQDB_X_B_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCQDB_X_B_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCQDB_X_B_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCQDB_X_B_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCQDB_Y_Am, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCQDB_Y_A_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCQDB_Y_A_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCQDB_Y_A_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCQDB_Y_A_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCQDB_Y_Bm, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCQDB_Y_B_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCQDB_Y_B_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCQDB_Y_B_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCQDB_Y_B_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCQEm, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCQE_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCQE_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCQE_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCQE_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCQNm, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCQN_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCQN_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCQN_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_MCQN_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PDB_Xm, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PDB_X_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PDB_X_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PDB_X_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PDB_X_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PDB_Ym, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PDB_Y_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PDB_Y_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PDB_Y_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PDB_Y_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PKTHDRm, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PKTHDR_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PKTHDR_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PKTHDR_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PKTHDR_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PKT_LINKm, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PKT_LINK_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PKT_LINK_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PKT_LINK_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PKT_LINK_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PORTCNTm, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PORTCNT_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PORTCNT_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PORTCNT_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PORTCNT_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PQE0_MEMm, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PQE0_MEM_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PQE0_MEM_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PQE0_MEM_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PQE0_MEM_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PQE1_MEMm, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PQE1_MEM_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PQE1_MEM_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PQE1_MEM_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_PQE1_MEM_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_UCQDB_Xm, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_UCQDB_X_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_UCQDB_X_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_UCQDB_X_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_UCQDB_X_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_UCQDB_Ym, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_UCQDB_Y_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_UCQDB_Y_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_UCQDB_Y_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { MMU_UCQDB_Y_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    ...
    { RQE_FREE_LISTm, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { RQE_FREE_LIST_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { RQE_FREE_LIST_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { RQE_FREE_LIST_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { RQE_FREE_LIST_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { RQE_LINK_LISTm, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { RQE_LINK_LIST_XPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { RQE_LINK_LIST_XPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { RQE_LINK_LIST_XPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { RQE_LINK_LIST_XPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
...
#ifdef BCM_TOMAHAWK3_SUPPORT
const ser_th_skipped_mem_t th3_skipped_mems[] = {
    ...
    { IDB_OBM0_IOM_STATS_WINDOW_RESULTSm, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM0_IOM_STATS_WINDOW_RESULTS_PIPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM0_IOM_STATS_WINDOW_RESULTS_PIPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM0_IOM_STATS_WINDOW_RESULTS_PIPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM0_IOM_STATS_WINDOW_RESULTS_PIPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM0_IOM_STATS_WINDOW_RESULTS_PIPE4m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM0_IOM_STATS_WINDOW_RESULTS_PIPE5m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM0_IOM_STATS_WINDOW_RESULTS_PIPE6m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM0_IOM_STATS_WINDOW_RESULTS_PIPE7m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM1_IOM_STATS_WINDOW_RESULTSm, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM1_IOM_STATS_WINDOW_RESULTS_PIPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM1_IOM_STATS_WINDOW_RESULTS_PIPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM1_IOM_STATS_WINDOW_RESULTS_PIPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM1_IOM_STATS_WINDOW_RESULTS_PIPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM1_IOM_STATS_WINDOW_RESULTS_PIPE4m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM1_IOM_STATS_WINDOW_RESULTS_PIPE5m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM1_IOM_STATS_WINDOW_RESULTS_PIPE6m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM1_IOM_STATS_WINDOW_RESULTS_PIPE7m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM2_IOM_STATS_WINDOW_RESULTSm, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM2_IOM_STATS_WINDOW_RESULTS_PIPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM2_IOM_STATS_WINDOW_RESULTS_PIPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM2_IOM_STATS_WINDOW_RESULTS_PIPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM2_IOM_STATS_WINDOW_RESULTS_PIPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM2_IOM_STATS_WINDOW_RESULTS_PIPE4m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM2_IOM_STATS_WINDOW_RESULTS_PIPE5m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM2_IOM_STATS_WINDOW_RESULTS_PIPE6m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM2_IOM_STATS_WINDOW_RESULTS_PIPE7m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM3_IOM_STATS_WINDOW_RESULTSm, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM3_IOM_STATS_WINDOW_RESULTS_PIPE0m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM3_IOM_STATS_WINDOW_RESULTS_PIPE1m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM3_IOM_STATS_WINDOW_RESULTS_PIPE2m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM3_IOM_STATS_WINDOW_RESULTS_PIPE3m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM3_IOM_STATS_WINDOW_RESULTS_PIPE4m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM3_IOM_STATS_WINDOW_RESULTS_PIPE5m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM3_IOM_STATS_WINDOW_RESULTS_PIPE6m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
    { IDB_OBM3_IOM_STATS_WINDOW_RESULTS_PIPE7m, _SOC_ACC_TYPE_PIPE_ANY, 1 },
...
{
    /* Will be executed only when test_data->mem is one of the tcam mems
     *
     * XSM_FIXME: We want to simply set, clear one of the bits in
     * SER_RANGE_ENABLEr
     * Should we lock SER_RANGE_ENABLEr ?
     *
     * Can we assume memscan is OFF ? or should we write mem_update style
     * function?
     *
     */
    uint32 rval;
...
#ifdef BCM_TOMAHAWK3_SUPPORT
    if (SOC_IS_TOMAHAWK3(unit)) {
        for (i = 0; th3_skipped_mems[i].mem != INVALIDm; i++) {
            if ((th3_skipped_mems[i].mem == mem) &&
                ((_SOC_ACC_TYPE_PIPE_ANY == th3_skipped_mems[i].acc_type) ||
                 (th3_skipped_mems[i].acc_type == soc_acc_type_target))) {
                if (th3_skipped_mems[i].allow_error_inj) {
                    return SOC_E_NONE;
                } else {
                    return rv;
                }
        ...
        if (mem == MMU_QSCH_L2_WEIGHT_MEM_PIPE0m ||
            mem == MMU_QSCH_L2_WEIGHT_MEM_PIPE1m ||
            ...
            mem == MMU_QSCH_L2_WEIGHT_MEM_PIPE6m ||
...
#ifdef BCM_TOMAHAWK3_SUPPORT
    if (SOC_IS_TOMAHAWK3(unit)) {
        for (k = 0; th3_skipped_mems[k].mem != INVALIDm; k++) {
            if ((th3_skipped_mems[k].mem == test_data->mem_fv) &&
                ((_SOC_ACC_TYPE_PIPE_ANY == th3_skipped_mems[k].acc_type) ||
                 (th3_skipped_mems[k].acc_type == test_data->acc_type))) {
                skip_mem = TRUE;
            }
        }
        if (test_data->mem_fv == MMU_QSCH_L2_WEIGHT_MEM_PIPE0m ||
            test_data->mem_fv == MMU_QSCH_L2_WEIGHT_MEM_PIPE1m ||
            test_data->mem_fv == MMU_QSCH_L2_WEIGHT_MEM_PIPE2m ||
            test_data->mem_fv == MMU_QSCH_L2_WEIGHT_MEM_PIPE3m ||
            test_data->mem_fv == MMU_QSCH_L2_WEIGHT_MEM_PIPE4m ||
            test_data->mem_fv == MMU_QSCH_L2_WEIGHT_MEM_PIPE5m ||
            test_data->mem_fv == MMU_QSCH_L2_WEIGHT_MEM_PIPE6m ||
            test_data->mem_fv == MMU_QSCH_L2_WEIGHT_MEM_PIPE7m) {
            uint32 value = 0;
            uint32 rval = 0;
        ...
        for (i = 0; th3_skipped_mems[i].mem != INVALIDm; i++) {
            if ((th3_skipped_mems[i].mem == mem) &&
                ((_SOC_ACC_TYPE_PIPE_ANY == th3_skipped_mems[i].acc_type) ||
                 (th3_skipped_mems[i].acc_type == soc_acc_type_target))) {
                /* coverity[secure_coding] */
                if (inject_only && th3_skipped_mems[i].allow_error_inj) {
                    break;
                }
                TR_TEST_MEM_PRINT(unit, fail_message, mem);
                return SOC_E_UNAVAIL;
...
soc_th2_vfp_ser_correction(int unit, soc_mem_t mem, int index, int copyno, int entry_dw)
{
    ...
    SOC_MEM_STATE_MEMBER_GET(unit, mem, cache[copyno], cache);
    SOC_MEM_STATE_MEMBER_GET(unit, mem, vmap[copyno], vmap);
...
int soc_th3_idb_enable_field_check(int unit, soc_reg_t reg, soc_field_t field,
                                   int *is_idb, int *match)
{
    ...
    uint32 value = 0;
    uint8 acc_type;
    soc_reg_t tsc_reg = TOP_TSC_ENABLEr;
    soc_reg_t obm_ctrl_enable[] =
                { IDB_OBM0_SER_CONTROLr,
                  IDB_OBM1_SER_CONTROLr,
                  IDB_OBM2_SER_CONTROLr,
    ...
    for (i = 0; i < _TH3_PBLKS_PER_PIPE; i++) {
        if ((reg == obm_ctrl_enable[i]) || (reg == ca_ctrl_enable[i])) {
            *is_idb = 1;
            break;
        }
    }
    ...
    addr = soc_reg_addr_get(unit, reg, REG_PORT_ANY, 0,
                             SOC_REG_ADDR_OPTION_NONE,
                             &block, &acc_type);
    SOC_IF_ERROR_RETURN(soc_reg32_get(unit, tsc_reg, REG_PORT_ANY, 0, &rval1));
    for (pipe = 0; pipe < _TH3_PIPES_PER_DEV; pipe++) {
        pm_num = pipe * _TH3_PBLKS_PER_PIPE + i;
        ...
        if (rval1 & (1 << pm_num)) {
            ...
            if (value == 0) {
                ...
                LOG_WARN(BSL_LS_SOC_SER,
                         (BSL_META_U(unit,
                                  "parity control %s.%s is disabled in pipe %d!!\n"),
                                  SOC_REG_NAME(unit, reg),
                                  SOC_FIELD_NAME(unit, field), pipe));
                continue;
            }
        } else {
            continue;
