...
soc_triumph_esm_init_mem_config(int unit)
{
    ...
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_L2_ENTRYm, -1); /* TCAM + SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_L2_ENTRY_TCAMm, -1); /* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_L2_ENTRY_DATAm, -1); /* SRAM */
    ...
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL288_L2m, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR_ACL288_L2m, -1); /* SRAM counter */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR8_ACL288_L2m, -1); /* SRAM counter */

    /* IP4 288-bit ACL partition */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL288_TCAM_IPV4m, -1); /* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL288_IPV4m, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR_ACL288_IPV4m, -1); /* SRAM counter */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR8_ACL288_IPV4m, -1); /* SRAM counter */

    /* IP6 short form 360-bit ACL partition */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL360_TCAM_DATA_IPV6_SHORTm, -1); /* TCAM data */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL360_IPV6_SHORTm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR_ACL360_IPV6_SHORTm, -1); /* SRAM counter */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR8_ACL360_IPV6_SHORTm, -1); /* SRAM counter */

    /* IP6 full form 432-bit ACL partition */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL432_TCAM_DATA_IPV6_LONGm, -1); /* TCAM data */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL432_IPV6_LONGm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR_ACL432_IPV6_LONGm, -1); /* SRAM counter */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR8_ACL432_IPV6_LONGm, -1); /* SRAM counter */

    /* L2 compact form 144-bit ACL partition */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL144_TCAM_L2m, -1); /* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL144_L2m, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR_ACL144_L2m, -1); /* SRAM counter */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR8_ACL144_L2m, -1); /* SRAM counter */

    /* IP4 compact form 144-bit ACL partition */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL144_TCAM_IPV4m, -1); /* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL144_IPV4m, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR_ACL144_IPV4m, -1); /* SRAM counter */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR8_ACL144_IPV4m, -1); /* SRAM counter */

    /* IP6 compact form 144-bit ACL partition */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL144_TCAM_IPV6m, -1); /* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL144_IPV6m, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR_ACL144_IPV6m, -1); /* SRAM counter */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR8_ACL144_IPV6m, -1); /* SRAM counter */

    /* L2+IP4 432-bit ACL partition */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL432_TCAM_DATA_L2_IPV4m, -1); /* TCAM data */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL432_L2_IPV4m, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR_ACL432_L2_IPV4m, -1); /* SRAM counter */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR8_ACL432_L2_IPV4m, -1); /* SRAM counter */

    /* L2+IP6 432-bit ACL partition */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL432_TCAM_DATA_L2_IPV6m, -1); /* TCAM data */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL432_L2_IPV6m, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR_ACL432_L2_IPV6m, -1); /* SRAM counter */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR8_ACL432_L2_IPV6m, -1); /* SRAM counter */

    /* All L2+L3 forwarding entries */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_SRC_HIT_BITSm, -1); /* SRC hit bit */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DST_HIT_BITSm, -1); /* DST hit bit */

    /* All L3 forwarding entries */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DEFIP_DATAm, -1); /* SRAM */

    /* All 144-bit ACL entries */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL144_TCAMm, -1); /* TCAM */

    /* All 288-bit ACL entries */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL288_TCAMm, -1); /* TCAM */

    /* All 360-bit ACL entries */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL360_TCAM_DATAm, -1); /* TCAM data */

    /* All 432-bit ACL entries */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL432_TCAM_DATAm, -1); /* TCAM data */

    /* All ACL entries */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICYm, -1); /* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTRm, -1); /* SRAM counter */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR8m, -1); /* SRAM counter */
}
...
_soc_triumph_esm_init_adjust_mem_size(int unit)
{
    ...
    /* L2 forwarding partition */
    max_index = partitions[TCAM_PARTITION_FWD_L2].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_L2_ENTRYm, max_index);/* TCAM + SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_L2_ENTRY_TCAMm, max_index);/* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_L2_ENTRY_DATAm, max_index);/* SRAM */

    max_index = (partitions[TCAM_PARTITION_FWD_L2].num_entries + 31) / 32 - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_SRC_HIT_BITS_L2m, max_index);/* SRC hit bit */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DST_HIT_BITS_L2m, max_index);/* DST hit bit */

    /* IP4 forwarding partition */
    max_index = partitions[TCAM_PARTITION_FWD_IP4].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV4_DEFIPm, max_index);/* TCAM + SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV4_DEFIP_TCAMm, max_index);/* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DEFIP_DATA_IPV4m, max_index);/* SRAM */

    max_index = (partitions[TCAM_PARTITION_FWD_IP4].num_entries + 31) / 32 - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_SRC_HIT_BITS_IPV4m, max_index);/* SRC hit bit */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DST_HIT_BITS_IPV4m, max_index);/* DST hit bit */

    /* IP6 64-bit prefix forwarding partition */
    max_index = partitions[TCAM_PARTITION_FWD_IP6U].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV6_64_DEFIPm, max_index);/* TCAM + SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV6_64_DEFIP_TCAMm, max_index);/* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DEFIP_DATA_IPV6_64m, max_index);/* SRAM */

    max_index = (partitions[TCAM_PARTITION_FWD_IP6U].num_entries + 31) / 32 - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_SRC_HIT_BITS_IPV6_64m, max_index);/* SRC hit bit */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DST_HIT_BITS_IPV6_64m, max_index);/* DST hit bit */

    /* IP6 128-bit prefix forwarding partition */
    max_index = partitions[TCAM_PARTITION_FWD_IP6].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV6_128_DEFIPm, max_index);/* TCAM + SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_IPV6_128_DEFIP_TCAMm, max_index);/* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DEFIP_DATA_IPV6_128m, max_index);/* SRAM */

    max_index = (partitions[TCAM_PARTITION_FWD_IP6].num_entries + 31) / 32 - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_SRC_HIT_BITS_IPV6_128m, max_index);/* SRC hit bit */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DST_HIT_BITS_IPV6_128m, max_index);/* DST hit bit */

    /* L2 288-bit ACL partition */
    max_index = partitions[TCAM_PARTITION_ACL_L2].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL288_TCAM_L2m, max_index);/* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL288_L2m, max_index);/* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR_ACL288_L2m, max_index);/* SRAM counter */

    max_index = (partitions[TCAM_PARTITION_ACL_L2].num_entries + 7) / 8 - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR8_ACL288_L2m, max_index);/* SRAM counter */

    /* IP4 288-bit ACL partition */
    max_index = partitions[TCAM_PARTITION_ACL_IP4].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL288_TCAM_IPV4m, max_index);/* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL288_IPV4m, max_index);/* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR_ACL288_IPV4m, max_index);/* SRAM counter */

    max_index = (partitions[TCAM_PARTITION_ACL_IP4].num_entries + 7) / 8 - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR8_ACL288_IPV4m, max_index);/* SRAM counter */

    /* IP6 short form 360-bit ACL partition */
    max_index = partitions[TCAM_PARTITION_ACL_IP6S].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL360_TCAM_DATA_IPV6_SHORTm, max_index);/* TCAM data */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL360_IPV6_SHORTm, max_index);/* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR_ACL360_IPV6_SHORTm, max_index);/* SRAM counter */

    max_index = (partitions[TCAM_PARTITION_ACL_IP6S].num_entries + 7) / 8 - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR8_ACL360_IPV6_SHORTm, max_index);/* SRAM counter */

    /* IP6 full form 432-bit ACL partition */
    max_index = partitions[TCAM_PARTITION_ACL_IP6F].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL432_TCAM_DATA_IPV6_LONGm, max_index);/* TCAM data */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL432_IPV6_LONGm, max_index);/* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR_ACL432_IPV6_LONGm, max_index);/* SRAM counter */

    max_index = (partitions[TCAM_PARTITION_ACL_IP6F].num_entries + 7) / 8 - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR8_ACL432_IPV6_LONGm, max_index);/* SRAM counter */

    /* L2 compact form 144-bit ACL partition */
    max_index = partitions[TCAM_PARTITION_ACL_L2C].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL144_TCAM_L2m, max_index);/* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL144_L2m, max_index);/* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR_ACL144_L2m, max_index);/* SRAM counter */

    max_index = (partitions[TCAM_PARTITION_ACL_L2C].num_entries + 7) / 8 - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR8_ACL144_L2m, max_index);/* SRAM counter */

    /* IP4 compact form 144-bit ACL partition */
    max_index = partitions[TCAM_PARTITION_ACL_IP4C].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL144_TCAM_IPV4m, max_index);/* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL144_IPV4m, max_index);/* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR_ACL144_IPV4m, max_index);/* SRAM counter */

    max_index = (partitions[TCAM_PARTITION_ACL_IP4C].num_entries + 7) / 8 - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR8_ACL144_IPV4m, max_index);/* SRAM counter */

    /* IP6 compact form 144-bit ACL partition */
    max_index = partitions[TCAM_PARTITION_ACL_IP6C].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL144_TCAM_IPV6m, max_index);/* TCAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL144_IPV6m, max_index);/* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR_ACL144_IPV6m, max_index);/* SRAM counter */

    max_index = (partitions[TCAM_PARTITION_ACL_IP6C].num_entries + 7) / 8 - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR8_ACL144_IPV6m, max_index);/* SRAM counter */

    /* L2+IP4 432-bit ACL partition */
    max_index = partitions[TCAM_PARTITION_ACL_L2IP4].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL432_TCAM_DATA_L2_IPV4m, max_index);/* TCAM data */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL432_L2_IPV4m, max_index);/* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR_ACL432_L2_IPV4m, max_index);/* SRAM counter */

    max_index = (partitions[TCAM_PARTITION_ACL_L2IP4].num_entries + 7) / 8 - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR8_ACL432_L2_IPV4m, max_index);/* SRAM counter */

    /* L2+IP6 432-bit ACL partition */
    max_index = partitions[TCAM_PARTITION_ACL_L2IP6].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL432_TCAM_DATA_L2_IPV6m, max_index);/* TCAM data */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICY_ACL432_L2_IPV6m, max_index);/* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR_ACL432_L2_IPV6m, max_index);/* SRAM counter */

    max_index = (partitions[TCAM_PARTITION_ACL_L2IP6].num_entries + 7) / 8 - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR8_ACL432_L2_IPV6m, max_index);/* SRAM counter */

    /* All L2+L3 forwarding entries */
    max_index = (partitions[TCAM_PARTITION_FWD_L2].num_entries + 31) / 32 +
    ...
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_SRC_HIT_BITSm, max_index);/* SRC hit bit */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DST_HIT_BITSm, max_index);/* DST hit bit */

    /* All L3 forwarding entries */
    max_index = partitions[TCAM_PARTITION_FWD_IP4].num_entries +
        partitions[TCAM_PARTITION_FWD_IP6U].num_entries +
        partitions[TCAM_PARTITION_FWD_IP6].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_DEFIP_DATAm, max_index);/* SRAM */

    /* All 144-bit ACL entries */
    max_index = partitions[TCAM_PARTITION_ACL_L2C].num_entries +
        partitions[TCAM_PARTITION_ACL_IP4C].num_entries +
        partitions[TCAM_PARTITION_ACL_IP6C].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL144_TCAMm, max_index);/* TCAM */

    /* All 288-bit ACL entries */
    max_index = partitions[TCAM_PARTITION_ACL_L2].num_entries +
        partitions[TCAM_PARTITION_ACL_IP4].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL288_TCAMm, max_index);/* TCAM */

    /* All 360-bit ACL entries */
    max_index = partitions[TCAM_PARTITION_ACL_IP6S].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL360_TCAM_DATAm, max_index);/* TCAM data */

    /* All 432-bit ACL entries */
    max_index = partitions[TCAM_PARTITION_ACL_IP6F].num_entries +
        partitions[TCAM_PARTITION_ACL_L2IP4].num_entries +
        partitions[TCAM_PARTITION_ACL_L2IP6].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_ACL432_TCAM_DATAm, max_index);/* TCAM data */
    ...
    max_index = partitions[TCAM_PARTITION_ACL_L2].num_entries +
        ...
        partitions[TCAM_PARTITION_ACL_L2IP4].num_entries +
        partitions[TCAM_PARTITION_ACL_L2IP6].num_entries - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_POLICYm, max_index);/* SRAM */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTRm, max_index);/* SRAM counter */

    max_index = (partitions[TCAM_PARTITION_ACL_L2].num_entries + 7) / 8 +
    ...
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXT_FP_CNTR8m, max_index);/* SRAM counter */
...
soc_triumph_ext_l2_entry_update(int unit, int index, void *entry)
{
    ...
    SOC_MEM_STATE_MEMBER_GET(unit, EXT_L2_ENTRY_TCAMm, cache[copyno], cache);
    if (cache != NULL) {
        if (entry != NULL) {
