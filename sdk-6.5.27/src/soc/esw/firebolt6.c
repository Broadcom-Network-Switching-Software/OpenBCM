...
_soc_fb6_mmu_idb_ports_assign(int unit)
{
    ...
    if (soc_property_get(unit, spn_BCM_TDM_FREQUENCY, 0)) {
        cli_out("Warning: bcm_tdm_frequency config property should not be used in the config.\n");
    }
...
soc_firebolt6_mem_config(int unit)
{
    ...
    index_max = (((4 * 2 * 1024) + (shared_l2_banks * 8 * 1024))/div_factor) - 1;
    ...
    index_max = (((7 * 2* 1024) + (shared_l3_banks * 14 * 1024))/div_factor) - 1;
    ...
    index_max = ((shared_fpem_banks * 6 * 1024)/div_factor) - 1;
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXACT_MATCH_LPm, index_max);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EXACT_MATCH_LP_PIPE0m, index_max);
    ...
    /* 1.5k per IUAT bank */
    index_max = (mpls_uat_banks * 1536) - 1;
    ...
    /* 1.5k per IUAT bank */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, VLAN_XLATE_1_LPm, (vlan_xlate_1_uat_banks * 1536) - 1);
    ...
    /* 1.5k per IUAT bank */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, VLAN_XLATE_2_LPm, (vlan_xlate_2_uat_banks * 1536) - 1);
    ...
    /* 1.5k per EUAT bank */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_VLAN_XLATE_1_LPm, (egr_vlan_xlate_1_banks * 1536) - 1);
    ...
    /* 1.5k per EUAT bank */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_VLAN_XLATE_2_LPm, (egr_vlan_xlate_2_banks * 1536) - 1);
    ...
    if (soc_property_get(unit, "l3_defip_sizing", TRUE)) {
        if (!soc_feature(unit, soc_feature_utt)) {
            ...
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_DEFIP_AUX_TABLEm, index_max);
    ...
    */
    ...
    if (ft_entries) {
        SOP_MEM_STATE_MAX_INDEX_SET(unit, FT_KEY_SINGLEm, ft_entries - 1);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, FT_KEY_ECCm, ft_entries - 1);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, FT_KEY_DOUBLEm, ft_entries/2 - 1);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, FT_KEY_DOUBLE_PIPE0m, ft_entries/2 - 1);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, BSC_DT_FLEX_SESSION_DATA_SINGLEm, ft_entries - 1);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, BSC_DT_FLEX_SESSION_DATA_DOUBLEm, ft_entries/2 - 1);
    }
    ...
    if (soc_feature(unit, soc_feature_flowtracker_half_entries_ft_group)) {
        SOP_MEM_STATE_MAX_INDEX_SET(unit, BSC_KG_GROUP_TABLEm, 511);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, BSC_DG_GROUP_TABLEm, 511);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, BSC_KG_FLOW_ACTIVE_COUNTERm, 511);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, BSC_KG_FLOW_LEARNED_COUNTERm, 511);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, BSC_KG_FLOW_AGE_OUT_COUNTERm, 511);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, BSC_KG_FLOW_EXCEED_COUNTERm, 511);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, BSC_KG_FLOW_MISSED_COUNTERm, 511);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, BSC_DG_FLOW_OPAQUE_COUNTER_0m, 511);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, BSC_DG_FLOW_OPAQUE_COUNTER_1m, 511);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, BSC_DG_FLOW_METER_EXCEED_COUNTERm, 511);
    }
    ...
    if (soc_feature(unit, soc_feature_td3x4_ax_reduced_ifp_meter_table)) {
        SOP_MEM_STATE_MAX_INDEX_SET(unit, IFP_METER_TABLEm, 6143);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, IFP_METER_TABLE_PIPE0m, 6143);
    }
    ...
    if (soc_feature(unit, soc_feature_td3x4_ax_reduced_ing_flex_ctr)) {
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_0m, 2047);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_1m, 2047);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_2m, 2047);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_3m, 2047);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_4m, 2047);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_5m, 2047);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_6m, 2047);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_7m, 2047);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_8m, 1023);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_9m, 1023);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_10m, 1023);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_11m, 1023);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_12m, 1023);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_13m, 1023);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_14m, 1023);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_15m, 1023);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_16m, 1023);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_17m, 1023);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_18m, 1023);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_19m, 1023);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_0_PIPE0m, 2047);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_1_PIPE0m, 2047);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_2_PIPE0m, 2047);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_3_PIPE0m, 2047);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_4_PIPE0m, 2047);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_5_PIPE0m, 2047);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_6_PIPE0m, 2047);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_7_PIPE0m, 2047);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_8_PIPE0m, 1023);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_9_PIPE0m, 1023);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_10_PIPE0m, 1023);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_11_PIPE0m, 1023);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_12_PIPE0m, 1023);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_13_PIPE0m, 1023);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_14_PIPE0m, 1023);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_15_PIPE0m, 1023);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_16_PIPE0m, 1023);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_17_PIPE0m, 1023);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_18_PIPE0m, 1023);
      SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_FLEX_CTR_COUNTER_TABLE_19_PIPE0m, 1023);
    }
...
_soc_firebolt6_tdm_init(int unit, soc_port_schedule_state_t *port_schedule_state)
{
    ...
    port_schedule_state->frequency =
        soc_property_get(unit, spn_BCM_TDM_FREQUENCY, si->frequency);
                               ...
                               _soc_fb6_mmu_sw_config_info_t *swcfg)
{
    ...
    rval = 0;
    fval = _FB6_MMU_PHYSICAL_CELLS_PER_XPE;
    if (dev_id == BCM56474_DEVICE_ID) {
        /* 16MB packet buffer */
        fval /= 2;
    }
    fval -= _FB6_MMU_RSVD_CELLS_CFAP_PER_XPE;
