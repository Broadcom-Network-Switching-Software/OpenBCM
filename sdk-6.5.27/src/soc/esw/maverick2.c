...
soc_maverick2_mem_config(int unit)
{
     ...
     */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_MAP_MHm, (16 * MV2_NUM_PORT) - 1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, IFP_STORM_CONTROL_METERSm, (4 * MV2_NUM_PORT) - 1);

    /* EDATABUF memories indexed by physical ports.
     * Set to MV2 max physical ports (MV2_NUM_PHY_PORT).
     */
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_ENABLEm, MV2_NUM_PHY_PORT);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_MMU_CELL_CREDITm, MV2_NUM_PHY_PORT);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_PORT_CREDIT_RESETm, MV2_NUM_PHY_PORT);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_PER_PORT_BUFFER_SFT_RESETm, MV2_NUM_PHY_PORT);
