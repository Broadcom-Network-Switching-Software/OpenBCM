...
soc_fb_l3_defip_resize(int unit)
{
    ...
    index_max = SOC_MEM_INFO(unit, L3_DEFIPm).index_max - (unused_count << 10);
...
{
/*
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L2Xm, 8191);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L2_ENTRY_ONLYm, 8191);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L2_HITDA_ONLYm, 1023);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L2_HITSA_ONLYm, 1023);

    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_ONLYm, 2047);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_IPV4_UNICASTm, 2047);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_IPV4_MULTICASTm, 2047);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_IPV6_UNICASTm, 1023);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_IPV6_MULTICASTm, 511);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_VALID_ONLYm, 255);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_HIT_ONLYm, 255);
*/

    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_DEFIPm, 255);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_DEFIP_ONLYm, 255);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_DEFIP_DATA_ONLYm, 255);

    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_DEFIP_HIT_ONLYm, 255);

    SOP_MEM_STATE_MAX_INDEX_SET(unit, FP_TCAMm, 1023);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, FP_TCAM_PLUS_POLICYm, 1023);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, FP_POLICY_TABLEm, 1023);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, FP_METER_TABLEm, 1023);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, FP_COUNTER_TABLEm, 1023);

    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ECMPm, 127);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, ING_L3_NEXT_HOPm, 2047);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_L3_NEXT_HOPm, 2047);

    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_XQ0m, 0x2ff);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_XQ1m, 0x2ff);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_XQ2m, 0x2ff);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_XQ3m, 0x2ff);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_XQ4m, 0x2ff);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_XQ5m, 0x2ff);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_XQ6m, 0x2ff);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_XQ7m, 0x2ff);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_XQ8m, 0x2ff);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_XQ9m, 0x2ff);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_XQ10m, 0x2ff);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_XQ11m, 0x2ff);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_XQ12m, 0x2ff);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_XQ13m, 0x2ff);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_XQ14m, 0x2ff);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_XQ15m, 0x2ff);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_XQ16m, 0x2ff);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_XQ17m, 0x2ff);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_XQ18m, 0x2ff);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_XQ19m, 0x2ff);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_XQ20m, 0x2ff);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_XQ21m, 0x2ff);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_XQ22m, 0x2ff);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_XQ23m, 0x2ff);

    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_XQ24m, 0x3ff);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_XQ25m, 0x3ff);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_XQ26m, 0x3ff);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_XQ27m, 0x3ff);

    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_XQ28m, 0x2ff);

    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_AGING_CTRm, 0x2ff);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_AGING_EXPm, 0x2ff);

    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPCELLHEADERm, 0x17ff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPDATA0m, 0x17ff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPDATA1m, 0x17ff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPDATA2m, 0x17ff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPDATA3m, 0x17ff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPDATA4m, 0x17ff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPDATA5m, 0x17ff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPDATA6m, 0x17ff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPDATA7m, 0x17ff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPDATA8m, 0x17ff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPDATA9m, 0x17ff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPDATA10m, 0x17ff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPDATA11m, 0x17ff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPDATA12m, 0x17ff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPDATA13m, 0x17ff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPDATA14m, 0x17ff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPDATA15m, 0x17ff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPPKTHEADER0m, 0x17ff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPPKTHEADER1m, 0x17ff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CCPm, 0x17ff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CFAPm, 0x17ff); 
}

void
soc_bcm53300_mem_config(int unit)
{
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPCELLHEADERm, 0xfff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPDATA0m, 0xfff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPDATA1m, 0xfff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPDATA2m, 0xfff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPDATA3m, 0xfff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPDATA4m, 0xfff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPDATA5m, 0xfff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPDATA6m, 0xfff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPDATA7m, 0xfff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPDATA8m, 0xfff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPDATA9m, 0xfff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPDATA10m, 0xfff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPDATA11m, 0xfff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPDATA12m, 0xfff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPDATA13m, 0xfff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPDATA14m, 0xfff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPDATA15m, 0xfff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPPKTHEADER0m, 0xfff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CBPPKTHEADER1m, 0xfff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CCPm, 0xfff); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_CFAPm, 0xfff); 

    SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_VLAN_STGm, 31); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, STG_TABm, 31); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L2MCm, 255); 

    SOP_MEM_STATE_MAX_INDEX_SET(unit, TRUNK_BITMAPm, 15); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, TRUNK_EGR_MASKm, 15); 
    SOP_MEM_STATE_MAX_INDEX_SET(unit, TRUNK_GROUPm, 15); 

    SOP_MEM_STATE_MAX_INDEX_SET(unit, FP_TCAMm, 511);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, FP_TCAM_PLUS_POLICYm, 511);
    ...
    /* SOP_MEM_STATE_MAX_INDEX_SET(unit, FP_RANGE_CHECKm, 1); */

    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_DEFIPm, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_DEFIP_DATA_ONLYm, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_DEFIP_HIT_ONLYm, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_DEFIP_ONLYm, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ECMPm, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_HIT_ONLYm, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_IPV4_MULTICASTm, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_IPV4_UNICASTm, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_IPV6_MULTICASTm, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_IPV6_UNICASTm, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_ONLYm, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_VALID_ONLYm, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_IPMCm, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_TUNNELm, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_IPMC_GROUP_TBL0m, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_IPMC_GROUP_TBL1m, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_IPMC_GROUP_TBL2m, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_IPMC_GROUP_TBL3m, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_IPMC_GROUP_TBL4m, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_IPMC_GROUP_TBL5m, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_IPMC_GROUP_TBL6m, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_IPMC_GROUP_TBL7m, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MMU_IPMC_VLAN_TBLm, -1);
}
...
soc_firebolt2_mem_config(int unit)
{
    ...
    if ((dev_id == BCM56322_DEVICE_ID) || (dev_id == BCM56324_DEVICE_ID)) {
        SOP_MEM_STATE_MAX_INDEX_SET(unit, L2Xm, 0x3fff);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_IPV4_UNICASTm, 0xfff);

        SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_DEFIPm, 0x7ff);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_DEFIP_ONLYm, 0x7ff);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_DEFIP_DATA_ONLYm, 0x7ff);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_DEFIP_HIT_ONLYm, 0x7ff);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, FP_TCAMm, 0x7ff);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, FP_POLICY_TABLEm, 0x7ff);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, FP_METER_TABLEm, 0x7ff);
        SOP_MEM_STATE_MAX_INDEX_SET(unit, FP_COUNTER_TABLEm, 0x7ff);
    }
#endif /* EXCLUDE_BCM56324 */

    /* L2 tables */
    SOP_MEM_STATE_MAX_INDEX_GET(unit, L2Xm, entry_mask);
    ...
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L2Xm, entry_mask);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L2_ENTRY_ONLYm, entry_mask);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L2_HITDA_ONLYm, entry_mask >> 3);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L2_HITSA_ONLYm, entry_mask >> 3);

    /* L3 tables */
    SOP_MEM_STATE_MAX_INDEX_GET(unit, L3_ENTRY_IPV4_UNICASTm, entry_mask);
    ...
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_ONLYm, entry_mask);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_IPV4_UNICASTm, entry_mask);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_IPV4_MULTICASTm, entry_mask);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_IPV6_UNICASTm, entry_mask >> 1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_IPV6_MULTICASTm, entry_mask >> 2);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_VALID_ONLYm, entry_mask >> 3);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_HIT_ONLYm, entry_mask >> 3);
    ...
    SOP_MEM_STATE_MAX_INDEX_SET(unit, STG_TABm, entry_mask);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_VLAN_STGm, entry_mask);
}
#endif /* BCM_FIREBOLT2_SUPPORT */
