    ...
    if((mem != INVALIDm) &&
       ...
       (SOC_MEM_SER_CORRECTION_TYPE(unit, mem) != 0)) {
        ...
        if (entry_found != 0) {
            ...
            SOC_MEM_STATE_MEMBER_GET(unit, mem, cache[SOC_MEM_BLOCK_ANY(unit, mem)], cache);
            SOC_MEM_STATE_MEMBER_GET(unit, mem, vmap[SOC_MEM_BLOCK_ANY(unit, mem)], vmap);
            if(cache != NULL && CACHE_VMAP_TST(vmap, index)) {
                log_entry_size += sizeof(soc_ser_log_tlv_hdr_t) + entry_dw*4;
            }
...
soc_trident_mem_config(int unit)
{
    ...
    switch (dev_id) {
        case BCM56838_DEVICE_ID:
            ...
            /* ECMP entry */
            index_max = 1023;
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ECMPm, index_max);         
            SOP_MEM_STATE_MAX_INDEX_SET(unit, INITIAL_L3_ECMPm, index_max);
            SOP_MEM_STATE_MAX_INDEX_SET(unit, INITIAL_L3_ECMP_Xm, index_max);
            SOP_MEM_STATE_MAX_INDEX_SET(unit, INITIAL_L3_ECMP_Ym, index_max);           
            break;
        case BCM56831_DEVICE_ID:
            ...
            /* L2MC */
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L2MCm, 12287);
            break;
        case BCM56847_DEVICE_ID:
            ...
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L2_HITDA_ONLYm, l2_entries / 8 - 1);
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L2_HITSA_ONLYm, l2_entries / 8 - 1);

            /* L2MC: 4K L2MC + 2K IPMC */
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L2MCm, 6143);            
            ...
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_IPV4_UNICAST_Xm, l3_entries - 1);
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_IPV4_UNICAST_Ym, l3_entries - 1);

            SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_IPV4_MULTICASTm, l3_entries / 2 - 1);
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_IPV4_MULTICAST_Xm, l3_entries / 2 - 1);
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_IPV4_MULTICAST_Ym, l3_entries / 2 - 1);
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_IPV6_UNICASTm, l3_entries / 2 - 1);
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_IPV6_UNICAST_Xm, l3_entries / 2 - 1);
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_IPV6_UNICAST_Ym, l3_entries / 2 - 1);

            SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_IPV6_MULTICASTm, l3_entries / 4 - 1);
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_IPV6_MULTICAST_Xm, l3_entries / 4 - 1);
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_IPV6_MULTICAST_Ym, l3_entries / 4 - 1);           
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_HIT_ONLYm, l3_entries / 16 - 1);
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_HIT_ONLY_Xm, l3_entries / 16 - 1);
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_HIT_ONLY_Ym, l3_entries / 16 - 1);
            ...
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_DEFIP_Xm, 8191);
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_DEFIP_Ym, 8191);
            ...
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_DEFIP_HIT_ONLY_Xm, 8191);
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_DEFIP_HIT_ONLY_Ym, 8191);
 
            /* MPLS Labels : 4K */
            SOP_MEM_STATE_MAX_INDEX_SET(unit, MPLS_ENTRYm, 4095);
            SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_MPLS_VC_AND_SWAP_LABEL_TABLEm, 4095);
            ...
            SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_SERVICE_COUNTER_TABLEm, 4095);
            SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_SERVICE_COUNTER_TABLE_Xm, 4095);  
            SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_SERVICE_COUNTER_TABLE_Ym, 4095); 
            SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_VINTF_COUNTER_TABLEm, 4095);            
            SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_VINTF_COUNTER_TABLE_Xm, 4095); 
            SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_VINTF_COUNTER_TABLE_Ym, 4095); 
            
            /* MSTP : 255 */
            SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_VLAN_STGm, 255); 
            SOP_MEM_STATE_MAX_INDEX_SET(unit, STG_TABm, 255);
            break;
        case BCM56835_DEVICE_ID:
            ...
            /* L2MC */
            SOP_MEM_STATE_MAX_INDEX_SET(unit, L2MCm, 4351);            
