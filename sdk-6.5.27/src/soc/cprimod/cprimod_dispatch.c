...
int cprimod_encap_header_config_get(int unit, int port, uint32 queue_num, cprimod_cpri_roe_frame_format_t frame_format, cprimod_encap_header_config_t* config_info)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_encap_header_config_get) {
        cprimod_mutex_take(unit);
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_encap_header_config_get(unit, port, queue_num, frame_format, config_info);
        cprimod_mutex_give(unit);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
int cprimod_tx_framer_tgen_enable_set(int unit, int port, uint32 enable)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_tx_framer_tgen_enable_set) {
        cprimod_mutex_take(unit);
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_tx_framer_tgen_enable_set(unit, port, enable);
        cprimod_mutex_give(unit);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("cprimod_tx_framer_tgen_enable_set isn't implemented for driver type"));
    }
...
int cprimod_tx_framer_tgen_enable_get(int unit, int port, uint32* enable)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_tx_framer_tgen_enable_get) {
        cprimod_mutex_take(unit);
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_tx_framer_tgen_enable_get(unit, port, enable);
        cprimod_mutex_give(unit);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("cprimod_tx_framer_tgen_enable_get isn't implemented for driver type"));
    }
...
int cprimod_header_compare_entry_for_flow_get(int unit, int port, uint8 flow_id, cprimod_flow_type_t flow_type, cprimod_header_compare_entry_t* compare_entry)
{
    ...
    if(compare_entry == NULL) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("compare_entry NULL parameter"));
    }
    if(SOC_E_NONE != cprimod_header_compare_entry_t_init(compare_entry)) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("compare_entry initialization failed"));
    }
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_header_compare_entry_for_flow_get) {
        cprimod_mutex_take(unit);
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_header_compare_entry_for_flow_get(unit, port, flow_id, flow_type, compare_entry);
        cprimod_mutex_give(unit);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("cprimod_header_compare_entry_for_flow_get isn't implemented for driver type"));
    }
...
int cprimod_core_init(int unit, int port, const phymod_core_access_t* phy, const phymod_core_init_config_t* init_config, int master_pll, phymod_core_status_t* core_status)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_core_init) {
        cprimod_mutex_take(unit);
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_core_init(unit, port, phy, init_config, master_pll, core_status);
        cprimod_mutex_give(unit);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
int cprimod_rx_tag_config_get(int unit, int port, uint32* default_tag, uint32* no_match_tag)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_rx_tag_config_get) {
        cprimod_mutex_take(unit);
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_rx_tag_config_get(unit, port, default_tag, no_match_tag);
        cprimod_mutex_give(unit);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("cprimod_rx_tag_config_get isn't implemented for driver type"));
    }
...
int cprimod_rsvd4_tx_control_flow_group_member_get(int unit, int port, uint32 group_id, uint32 priority, uint32* queue_num, cprimod_control_msg_proc_type_t* proc_type)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_rsvd4_tx_control_flow_group_member_get) {
        cprimod_mutex_take(unit);
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_rsvd4_tx_control_flow_group_member_get(unit, port, group_id, priority, queue_num, proc_type);
        cprimod_mutex_give(unit);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("cprimod_rsvd4_tx_control_flow_group_member_get isn't implemented for driver type"));
    }
...
int cprimod_rsvd4_tx_control_flow_group_member_get_all(int unit, int port, uint32 group_id, cprimod_rsvd4_control_group_entry_t* group_config)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_rsvd4_tx_control_flow_group_member_get_all) {
        cprimod_mutex_take(unit);
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_rsvd4_tx_control_flow_group_member_get_all(unit, port, group_id, group_config);
        cprimod_mutex_give(unit);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("cprimod_rsvd4_tx_control_flow_group_member_get_all isn't implemented for driver type"));
    }
...
int cprimod_rsvd4_tx_single_tunnel_message_config_get(int unit, int port, cprimod_cpri_crc_option_t* crc_option)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_rsvd4_tx_single_tunnel_message_config_get) {
        cprimod_mutex_take(unit);
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_rsvd4_tx_single_tunnel_message_config_get(unit, port, crc_option);
        cprimod_mutex_give(unit);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("cprimod_rsvd4_tx_single_tunnel_message_config_get isn't implemented for driver type"));
    }
...
int cprimod_rsvd4_fast_eth_config_get(int unit, int port, cprimod_cpri_fast_eth_config_t* config_info)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_rsvd4_fast_eth_config_get) {
        cprimod_mutex_take(unit);
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_rsvd4_fast_eth_config_get(unit, port, config_info);
        cprimod_mutex_give(unit);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("cprimod_rsvd4_fast_eth_config_get isn't implemented for driver type"));
    }
...
int cprimod_cpri_port_clock_disable_set(int unit, int port, int rst)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_cpri_port_clock_disable_set) {
        cprimod_mutex_take(unit);
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_cpri_port_clock_disable_set(unit, port, rst);
        cprimod_mutex_give(unit);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("cprimod_cpri_port_clock_disable_set isn't implemented for driver type"));
    }
...
int cprimod_cpri_port_lane_map_get(int unit, int port, uint32 flags, phymod_lane_map_t* lane_map)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_cpri_port_lane_map_get) {
        cprimod_mutex_take(unit);
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_cpri_port_lane_map_get(unit, port, flags, lane_map);
        cprimod_mutex_give(unit);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("cprimod_cpri_port_lane_map_get isn't implemented for driver type"));
    }
