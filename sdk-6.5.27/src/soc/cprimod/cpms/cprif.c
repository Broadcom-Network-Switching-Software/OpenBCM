                    ...
                    phymod_core_status_t* core_status)
{
    ...
    if (master_pll) {
        /* Enable PLL1 Ref Out PLL1_REFOUT_ENf. */
        SOC_IF_ERROR_RETURN
            (cprif_drv_top_ctrl_config_ref_clk_out_enable_set(unit, port, 1, 1));
    }
    ...
    if (init_config->pll0_div_init_value) {
        ...
        /* enable ref clk in  */
        SOC_IF_ERROR_RETURN(cprif_drv_top_ctrl_config_ref_clk_in_enable_set(unit, port, 0, 1));
        /* Set lcref_sel */
    ...
    if (init_config->pll1_div_init_value) {
        ...
        /* enable ref clk in  */
        SOC_IF_ERROR_RETURN(cprif_drv_top_ctrl_config_ref_clk_in_enable_set(unit, port, 1, 1));
        /* Set lcref_sel */
