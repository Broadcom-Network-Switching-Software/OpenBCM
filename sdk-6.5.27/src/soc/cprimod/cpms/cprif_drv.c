...
int cprif_drv_top_ctrl_config_ref_clk_in_enable_set(int unit, int port, int pll_num, int refin)
{
    uint32 data;
    SOC_INIT_FUNC_DEFS;
...
int cprif_drv_top_ctrl_config_ref_clk_in_enable_get(int unit, int port, int pll_num, int *refin)
{
    uint32 data;
    SOC_INIT_FUNC_DEFS;
...
int cprif_drv_top_ctrl_config_ref_clk_out_enable_set(int unit, int port, int pll_num, int refout)
{
    uint32 data;
    SOC_INIT_FUNC_DEFS;
...
int cprif_drv_top_ctrl_config_ref_clk_out_enable_get(int unit, int port, int pll_num, int *refout)
{
    uint32 data;
    SOC_INIT_FUNC_DEFS;
