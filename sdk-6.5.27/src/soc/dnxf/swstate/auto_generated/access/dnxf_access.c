...
dnxf_state_init(int unit)
{
    ...
    DNX_SW_STATE_DEFAULT_VALUE_LOOP(def_val_idx[1], DNXF_DATA_MAX_FABRIC_RXTX_NOF_TX_CHANNELS)

    DNX_SW_STATE_DEFAULT_VALUE_LOOP(def_val_idx[1], DNXF_DATA_MAX_FABRIC_RXTX_NOF_TX_CHANNELS)

    DNX_SW_STATE_DEFAULT_VALUE_LOOP(def_val_idx[1], DNXF_DATA_MAX_FABRIC_RXTX_NOF_TX_CHANNELS)

    DNX_SW_STATE_DEFAULT_VALUE_LOOP(def_val_idx[2], DNXC_CELL_NOF_LINKS_IN_PATH_LINKS)
...
int
dnxf_state_info_valid_fsrd_bmp_get(int unit, CONST SHR_BITDCL **valid_fsrd_bmp)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    *valid_fsrd_bmp = &((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->info.valid_fsrd_bmp[0];
    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_GET_LOGGING,
        BSL_LS_SWSTATEDNX_GET,
        DNX_SW_STATE_DNXF_STATE__INFO__VALID_FSRD_BMP,
        &((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->info.valid_fsrd_bmp[0],
        "dnxf_state[%d]->info.valid_fsrd_bmp[%d]",
        unit, 0);
...
int
dnxf_state_info_valid_fsrd_bmp_alloc_bitmap(int unit, uint32 _nof_bits_to_alloc)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_ALLOC_BITMAP(
        ...
        DNXC_SWSTATE_LAYOUT_MAX_ARRAY_DIMENSIONS,
        DNXC_SW_STATE_AUTO_GENERATED_ALLOCATION,
        "dnxf_state_info_valid_fsrd_bmp_alloc");
    ...
    DNX_SW_STATE_LOG(
        ...
        DNX_SW_STATE_DNXF_STATE__INFO__VALID_FSRD_BMP,
        ((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->info.valid_fsrd_bmp,
        "dnxf_state[%d]->info.valid_fsrd_bmp",
        unit,
        _nof_bits_to_alloc);
...
int
dnxf_state_info_valid_fsrd_bmp_bit_set(int unit, uint32 _bit_num)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dnxf_state_info_valid_fsrd_bmp_bit_clear(int unit, uint32 _bit_num)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dnxf_state_info_valid_fsrd_bmp_bit_get(int unit, uint32 _bit_num, uint8* result)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dnxf_state_info_valid_fsrd_bmp_bit_range_clear(int unit, uint32 _first, uint32 _count)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dnxf_state_info_valid_fsrd_bmp_bit_range_set(int unit, uint32 _first, uint32 _count)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dnxf_state_info_valid_dch_dcml_core_bmp_get(int unit, CONST SHR_BITDCL **valid_dch_dcml_core_bmp)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    *valid_dch_dcml_core_bmp = &((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->info.valid_dch_dcml_core_bmp[0];
    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_GET_LOGGING,
        BSL_LS_SWSTATEDNX_GET,
        DNX_SW_STATE_DNXF_STATE__INFO__VALID_DCH_DCML_CORE_BMP,
        &((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->info.valid_dch_dcml_core_bmp[0],
        "dnxf_state[%d]->info.valid_dch_dcml_core_bmp[%d]",
        unit, 0);
...
int
dnxf_state_info_valid_dch_dcml_core_bmp_alloc_bitmap(int unit, uint32 _nof_bits_to_alloc)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_ALLOC_BITMAP(
        ...
        DNXC_SWSTATE_LAYOUT_MAX_ARRAY_DIMENSIONS,
        DNXC_SW_STATE_AUTO_GENERATED_ALLOCATION,
        "dnxf_state_info_valid_dch_dcml_core_bmp_alloc");
    ...
    DNX_SW_STATE_LOG(
        ...
        DNX_SW_STATE_DNXF_STATE__INFO__VALID_DCH_DCML_CORE_BMP,
        ((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->info.valid_dch_dcml_core_bmp,
        "dnxf_state[%d]->info.valid_dch_dcml_core_bmp",
        unit,
        _nof_bits_to_alloc);
...
int
dnxf_state_info_valid_dch_dcml_core_bmp_bit_set(int unit, uint32 _bit_num)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dnxf_state_info_valid_dch_dcml_core_bmp_bit_clear(int unit, uint32 _bit_num)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dnxf_state_info_valid_dch_dcml_core_bmp_bit_get(int unit, uint32 _bit_num, uint8* result)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dnxf_state_info_valid_dch_dcml_core_bmp_bit_range_clear(int unit, uint32 _first, uint32 _count)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dnxf_state_info_valid_dch_dcml_core_bmp_bit_range_set(int unit, uint32 _first, uint32 _count)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
dnxf_state_cbs dnxf_state = 	{
	...
	dnxf_state_init,
		...
		,
			...
			dnxf_state_info_valid_fsrd_bmp_get,
			dnxf_state_info_valid_fsrd_bmp_alloc_bitmap,
			dnxf_state_info_valid_fsrd_bmp_bit_set,
			dnxf_state_info_valid_fsrd_bmp_bit_clear,
			dnxf_state_info_valid_fsrd_bmp_bit_get,
			dnxf_state_info_valid_fsrd_bmp_bit_range_clear,
			dnxf_state_info_valid_fsrd_bmp_bit_range_set}
		,
			{
			
			dnxf_state_info_valid_dch_dcml_core_bmp_get,
			dnxf_state_info_valid_dch_dcml_core_bmp_alloc_bitmap,
			dnxf_state_info_valid_dch_dcml_core_bmp_bit_set,
			dnxf_state_info_valid_dch_dcml_core_bmp_bit_clear,
			dnxf_state_info_valid_dch_dcml_core_bmp_bit_get,
			dnxf_state_info_valid_dch_dcml_core_bmp_bit_range_clear,
			dnxf_state_info_valid_dch_dcml_core_bmp_bit_range_set}
		}
	,
		{
