    ...
    int master_id)
{
    ...
    soc_reg_above_64_field32_set(unit, MESH_TOPOLOGY_REG_01DEr, reg_above_64_val, FIELD_23_41f, frac);
    soc_reg_above_64_field32_set(unit, MESH_TOPOLOGY_REG_01DEr, reg_above_64_val, FIELD_42_45f, intg);
    soc_reg_above_64_field32_set(unit, MESH_TOPOLOGY_REG_01DEr, reg_above_64_val, FIELD_111_121f, master_id);
    SHR_IF_ERR_EXIT(WRITE_MESH_TOPOLOGY_REG_01DEr(unit, reg_above_64_val));
    ...
    uint32 target)
{
    ...
    soc_reg_above_64_field32_set(unit, MESH_TOPOLOGY_REG_01DEr, reg_above_64_val, FIELD_0_18f, frac);
    soc_reg_above_64_field32_set(unit, MESH_TOPOLOGY_REG_01DEr, reg_above_64_val, FIELD_19_22f, intg);
    SHR_IF_ERR_EXIT(WRITE_MESH_TOPOLOGY_REG_01DEr(unit, reg_above_64_val));
