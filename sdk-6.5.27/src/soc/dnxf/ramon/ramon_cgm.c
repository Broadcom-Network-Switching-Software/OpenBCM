...
static const soc_dnxf_cgm_registers_table_t QRH_MC_LOW_PRIO_DROP_LOW_TH_description[] = {
    
    {QRH_LOW_PR_MULTHr,                    {LOW_PR_MUL_DROP_TH_LOWf }}, \
};

static const soc_dnxf_cgm_registers_table_t QRH_MC_LOW_PRIO_DROP_HIGH_TH_description[] = {
    
    {QRH_LOW_PR_MULTHr,                    {LOW_PR_MUL_DROP_TH_HIGHf }}, \
};
...
static const soc_dnxf_cgm_registers_table_t DTM_FIFOS_DEPTH_TYPE_description[] = {
    
    {LCM_DTM_FIFOS_DEPTH_TYPEr,                    {DTM_FIFO_DEPTH_P_0_TYPE_Nf, DTM_FIFO_DEPTH_P_1_TYPE_Nf, INVALIDf}},
    {LCM_LCM_REGISTER_5r,                          {FIELD_0_12f, FIELD_16_28f, FIELD_32_44f}},
};

static const soc_dnxf_cgm_registers_table_t DTL_FIFOS_DEPTH_TYPE_description[] = {
    
    {LCM_DTL_FIFOS_DEPTH_TYPEr,                    {DTL_FIFO_DEPTH_P_0_TYPE_Nf, DTL_FIFO_DEPTH_P_1_TYPE_Nf, DTL_FIFO_DEPTH_P_2_TYPE_Nf}},
    {LCM_LCM_REGISTER_6r,                          {FIELD_0_12f, FIELD_13_25f, FIELD_26_38f}},
};
...
const soc_dnxf_cgm_threshold_to_reg_binding_t ramon_soc_cgm_threshold_to_register_table[] = {
    ...
    {_SHR_FABRIC_MID_MC_LOW_PRIO_DROP_LOW_TH,      soc_dnxf_cgm_reg_structure_1,      1,                  QRH_MC_LOW_PRIO_DROP_LOW_TH_description  }, 
    {_SHR_FABRIC_MID_MC_LOW_PRIO_DROP_HIGH_TH,     soc_dnxf_cgm_reg_structure_1,      1,                  QRH_MC_LOW_PRIO_DROP_HIGH_TH_description  },
    ...
    {_SHR_FABRIC_RX_FIFO_SIZE_PIPE_TH,             soc_dnxf_cgm_reg_structure_1,      1,                  DCH_FIFOS_DEPTH_TYPE_description  },
    {_SHR_FABRIC_MID_FIFO_SIZE_PIPE_TH,            soc_dnxf_cgm_reg_structure_1,      2,                  DTM_FIFOS_DEPTH_TYPE_description  },
    {_SHR_FABRIC_TX_FIFO_SIZE_PIPE_TH,             soc_dnxf_cgm_reg_structure_1,      2,                  DTL_FIFOS_DEPTH_TYPE_description  },
    ...
    int *max_value)
{
    ...
    field_size = soc_reg_field_length(unit, reg_name, field_name);
    *max_value = utilex_max_value_by_size(field_size);
    ...
    int threshold_value)
{
    ...
    if (dnx_drv_soc_reg_is_above_64(unit, reg_name))
    {
        SHR_IF_ERR_EXIT(soc_reg_above_64_get(unit, reg_name, block_id, numel, reg_above_64_val));
        soc_reg_above_64_field32_set(unit, reg_name, reg_above_64_val, field_name, threshold_value);
        SHR_IF_ERR_EXIT(soc_reg_above_64_set(unit, reg_name, block_id, numel, reg_above_64_val));
    }
    else if (dnx_drv_soc_reg_is_64(unit, reg_name))
    {
        SHR_IF_ERR_EXIT(soc_reg_get(unit, reg_name, block_id, numel, &reg_val64));
        soc_reg64_field_set(unit, reg_name, &reg_val64, field_name, threshold_value);
        SHR_IF_ERR_EXIT(soc_reg_set(unit, reg_name, block_id, numel, reg_val64));
    }
    else
    {
        SHR_IF_ERR_EXIT(soc_reg32_get(unit, reg_name, block_id, numel, &reg_val));
        soc_reg_field_set(unit, reg_name, &reg_val, field_name, threshold_value);
        SHR_IF_ERR_EXIT(soc_reg32_set(unit, reg_name, block_id, numel, reg_val));
    }
    ...
    int *threshold_value)
{
    ...
    {
        SHR_IF_ERR_EXIT(soc_reg_get(unit, reg_name, block_id, numel, &reg_val64));
        *threshold_value = soc_reg64_field_get(unit, reg_name, reg_val64, field_name);
    }
    else
    {
        SHR_IF_ERR_EXIT(soc_reg32_get(unit, reg_name, block_id, numel, &reg_val));
    ...
    for (ii = 0; ii < links_count; ii++)
    {
        ...
        SHR_IF_ERR_EXIT(MBCM_DNXF_DRIVER_CALL
                        (unit, mbcm_dnxf_drv_link_to_block_mapping,
                         (unit, link, &blk_id, &inner_link, SOC_DNXF_DRV_BLOCK_TYPE_DCH)));
