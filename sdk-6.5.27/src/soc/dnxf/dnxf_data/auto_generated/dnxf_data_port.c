    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnxf_data_port_general_table_phy_controls_features].name = "phy_controls_features";
    submodule_data->tables[dnxf_data_port_general_table_phy_controls_features].doc = "";
    submodule_data->tables[dnxf_data_port_general_table_phy_controls_features].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnxf_data_port_general_table_phy_controls_features].size_of_values = sizeof(dnxf_data_port_general_phy_controls_features_t);
    submodule_data->tables[dnxf_data_port_general_table_phy_controls_features].entry_get = dnxf_data_port_general_phy_controls_features_entry_str_get;

    
    submodule_data->tables[dnxf_data_port_general_table_phy_controls_features].nof_keys = 1;
    submodule_data->tables[dnxf_data_port_general_table_phy_controls_features].keys[0].name = "phy_control_type";
    submodule_data->tables[dnxf_data_port_general_table_phy_controls_features].keys[0].doc = "";

    
    submodule_data->tables[dnxf_data_port_general_table_phy_controls_features].nof_values = 1;
    DNXC_DATA_ALLOC(submodule_data->tables[dnxf_data_port_general_table_phy_controls_features].values, dnxc_data_value_t, submodule_data->tables[dnxf_data_port_general_table_phy_controls_features].nof_values, "_dnxf_data_port_general_table_phy_controls_features table values");
    submodule_data->tables[dnxf_data_port_general_table_phy_controls_features].values[0].name = "port_disable_required";
    submodule_data->tables[dnxf_data_port_general_table_phy_controls_features].values[0].type = "uint8";
    submodule_data->tables[dnxf_data_port_general_table_phy_controls_features].values[0].doc = "";
    submodule_data->tables[dnxf_data_port_general_table_phy_controls_features].values[0].offset = UTILEX_OFFSETOF(dnxf_data_port_general_phy_controls_features_t, port_disable_required);
...
const dnxf_data_port_general_phy_controls_features_t *
dnxf_data_port_general_phy_controls_features_get(
    int unit,
    int phy_control_type)
{
    ...
    table = dnxc_data_mgmt_table_get(unit, dnxf_data_module_port, dnxf_data_port_submodule_general, dnxf_data_port_general_table_phy_controls_features);
    
    data = dnxc_data_mgmt_table_data_get(unit, table, phy_control_type, 0);
    return (const dnxf_data_port_general_phy_controls_features_t *) data;
...
shr_error_e
dnxf_data_port_general_phy_controls_features_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnxf_data_port_general_phy_controls_features_t *data;
    SHR_FUNC_INIT_VARS(unit);

    
    table = dnxc_data_mgmt_table_get(unit, dnxf_data_module_port, dnxf_data_port_submodule_general, dnxf_data_port_general_table_phy_controls_features);
    data = (const dnxf_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->port_disable_required);
            break;
    }
...
const dnxc_data_table_info_t *
dnxf_data_port_general_phy_controls_features_info_get(
    int unit)
{

    
    return dnxc_data_mgmt_table_info_get(unit, dnxf_data_module_port, dnxf_data_port_submodule_general, dnxf_data_port_general_table_phy_controls_features);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnxf_data_port_lane_map_is_full_fsrd_mapping_range_supported].name = "is_full_fsrd_mapping_range_supported";
    submodule_data->features[dnxf_data_port_lane_map_is_full_fsrd_mapping_range_supported].doc = "";
    submodule_data->features[dnxf_data_port_lane_map_is_full_fsrd_mapping_range_supported].flags |= DNXC_DATA_F_FEATURE;
