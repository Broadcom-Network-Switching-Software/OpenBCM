    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnxf_data_fabric_pipes_table_map].values[0].doc = "";
    ...
    submodule_data->tables[dnxf_data_fabric_pipes_table_map].values[1].doc = "";
    ...
    submodule_data->tables[dnxf_data_fabric_pipes_table_map].values[2].doc = "";
    ...
    submodule_data->tables[dnxf_data_fabric_pipes_table_map].values[3].doc = "";
    ...
    submodule_data->tables[dnxf_data_fabric_pipes_table_map].values[4].doc = "";
    ...
    submodule_data->tables[dnxf_data_fabric_pipes_table_map].values[5].doc = "";
    ...
    submodule_data->tables[dnxf_data_fabric_pipes_table_valid_map_config].values[0].doc = "";
    ...
    submodule_data->tables[dnxf_data_fabric_pipes_table_valid_map_config].values[1].doc = "";
    ...
    submodule_data->tables[dnxf_data_fabric_pipes_table_valid_map_config].values[2].doc = "";
    ...
    submodule_data->tables[dnxf_data_fabric_pipes_table_valid_map_config].values[3].doc = "";
    ...
    submodule_data->tables[dnxf_data_fabric_pipes_table_valid_map_config].values[4].doc = "";
    ...
    submodule_data->tables[dnxf_data_fabric_pipes_table_valid_map_config].values[5].doc = "";
    ...
    submodule_data->tables[dnxf_data_fabric_pipes_table_valid_map_config].values[6].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnxf_data_fabric_multicast_static_mode_supported].name = "static_mode_supported";
    submodule_data->features[dnxf_data_fabric_multicast_static_mode_supported].doc = "";
    submodule_data->features[dnxf_data_fabric_multicast_static_mode_supported].flags |= DNXC_DATA_F_FEATURE;
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnxf_data_fabric_fifos_table_rx_depth_per_pipe].values[0].doc = "";
    ...
    submodule_data->tables[dnxf_data_fabric_fifos_table_rx_depth_per_pipe].values[1].doc = "";
    ...
    submodule_data->tables[dnxf_data_fabric_fifos_table_mid_depth_per_pipe].values[0].doc = "";
    ...
    submodule_data->tables[dnxf_data_fabric_fifos_table_mid_depth_per_pipe].values[1].doc = "";
    ...
    submodule_data->tables[dnxf_data_fabric_fifos_table_mid_depth_per_pipe].values[2].doc = "";
    ...
    submodule_data->tables[dnxf_data_fabric_fifos_table_mid_depth_per_pipe].values[3].doc = "";
    ...
    submodule_data->tables[dnxf_data_fabric_fifos_table_tx_depth_per_pipe].values[0].doc = "";
    ...
    submodule_data->tables[dnxf_data_fabric_fifos_table_tx_depth_per_pipe].values[1].doc = "";
    ...
    submodule_data->tables[dnxf_data_fabric_fifos_table_tx_depth_per_pipe].values[2].doc = "";
    ...
    submodule_data->tables[dnxf_data_fabric_fifos_table_tx_depth_per_pipe].values[3].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnxf_data_fabric_congestion_table_thresholds_info].values[0].doc = "";
    ...
    submodule_data->tables[dnxf_data_fabric_congestion_table_thresholds_info].values[1].doc = "";
    ...
    submodule_data->tables[dnxf_data_fabric_congestion_table_thresholds_info].values[2].doc = "";
    ...
    submodule_data->tables[dnxf_data_fabric_congestion_table_thresholds_info].values[3].doc = "";
    ...
    submodule_data->tables[dnxf_data_fabric_congestion_table_thresholds_info].values[4].doc = "";
    ...
    submodule_data->tables[dnxf_data_fabric_congestion_table_thresholds_info].values[5].doc = "";
    ...
    submodule_data->tables[dnxf_data_fabric_congestion_table_thresholds_info].values[6].doc = "";
    ...
    submodule_data->tables[dnxf_data_fabric_congestion_table_thresholds_info].values[7].doc = "";
    ...
    submodule_data->tables[dnxf_data_fabric_congestion_table_thresholds_info].values[8].doc = "";
...
static shr_error_e
dnxf_data_fabric_fifo_dma_init(
    int unit,
    dnxc_data_submodule_t *submodule_data)
{
    SHR_FUNC_INIT_VARS(unit);

    submodule_data->name = "fifo_dma";
    submodule_data->doc = "";
    
    submodule_data->nof_features = _dnxf_data_fabric_fifo_dma_feature_nof;
    DNXC_DATA_ALLOC(submodule_data->features, dnxc_data_feature_t,  submodule_data->nof_features, "_dnxc_data fabric fifo_dma features");

    
    submodule_data->nof_defines = _dnxf_data_fabric_fifo_dma_define_nof;
    DNXC_DATA_ALLOC(submodule_data->defines, dnxc_data_define_t, submodule_data->nof_defines, "_dnxc_data fabric fifo_dma defines");

    submodule_data->defines[dnxf_data_fabric_fifo_dma_define_fabric_cell_nof_entries_per_cell].name = "fabric_cell_nof_entries_per_cell";
    submodule_data->defines[dnxf_data_fabric_fifo_dma_define_fabric_cell_nof_entries_per_cell].doc = "";
    
    submodule_data->defines[dnxf_data_fabric_fifo_dma_define_fabric_cell_nof_entries_per_cell].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnxf_data_fabric_fifo_dma_define_nof_channels].name = "nof_channels";
    submodule_data->defines[dnxf_data_fabric_fifo_dma_define_nof_channels].doc = "";
    
    submodule_data->defines[dnxf_data_fabric_fifo_dma_define_nof_channels].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnxf_data_fabric_fifo_dma_define_entry_size].name = "entry_size";
    submodule_data->defines[dnxf_data_fabric_fifo_dma_define_entry_size].doc = "";
    
    submodule_data->defines[dnxf_data_fabric_fifo_dma_define_entry_size].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnxf_data_fabric_fifo_dma_define_max_nof_entries].name = "max_nof_entries";
    submodule_data->defines[dnxf_data_fabric_fifo_dma_define_max_nof_entries].doc = "";
    
    submodule_data->defines[dnxf_data_fabric_fifo_dma_define_max_nof_entries].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnxf_data_fabric_fifo_dma_define_min_nof_entries].name = "min_nof_entries";
    submodule_data->defines[dnxf_data_fabric_fifo_dma_define_min_nof_entries].doc = "";
    
    submodule_data->defines[dnxf_data_fabric_fifo_dma_define_min_nof_entries].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnxf_data_fabric_fifo_dma_define_enable].name = "enable";
    submodule_data->defines[dnxf_data_fabric_fifo_dma_define_enable].doc = "";
    
    submodule_data->defines[dnxf_data_fabric_fifo_dma_define_enable].flags |= DNXC_DATA_F_NUMERIC;

    submodule_data->defines[dnxf_data_fabric_fifo_dma_define_buffer_size].name = "buffer_size";
    submodule_data->defines[dnxf_data_fabric_fifo_dma_define_buffer_size].doc = "";
    
    submodule_data->defines[dnxf_data_fabric_fifo_dma_define_buffer_size].flags |= DNXC_DATA_F_NUMERIC;

    submodule_data->defines[dnxf_data_fabric_fifo_dma_define_threshold].name = "threshold";
    submodule_data->defines[dnxf_data_fabric_fifo_dma_define_threshold].doc = "";
    
    submodule_data->defines[dnxf_data_fabric_fifo_dma_define_threshold].flags |= DNXC_DATA_F_NUMERIC;

    submodule_data->defines[dnxf_data_fabric_fifo_dma_define_timeout].name = "timeout";
    submodule_data->defines[dnxf_data_fabric_fifo_dma_define_timeout].doc = "";
    
    submodule_data->defines[dnxf_data_fabric_fifo_dma_define_timeout].flags |= DNXC_DATA_F_NUMERIC;

    
    submodule_data->nof_tables = _dnxf_data_fabric_fifo_dma_table_nof;
    DNXC_DATA_ALLOC(submodule_data->tables, dnxc_data_table_t, submodule_data->nof_tables, "_dnxc_data fabric fifo_dma tables");
...
int
dnxf_data_fabric_fifo_dma_feature_get(
    int unit,
    dnxf_data_fabric_fifo_dma_feature_e feature)
{
    return dnxc_data_mgmt_feature_data_get(unit, dnxf_data_module_fabric, dnxf_data_fabric_submodule_fifo_dma, feature);
}


uint32
dnxf_data_fabric_fifo_dma_fabric_cell_nof_entries_per_cell_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnxf_data_module_fabric, dnxf_data_fabric_submodule_fifo_dma, dnxf_data_fabric_fifo_dma_define_fabric_cell_nof_entries_per_cell);
}

uint32
dnxf_data_fabric_fifo_dma_nof_channels_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnxf_data_module_fabric, dnxf_data_fabric_submodule_fifo_dma, dnxf_data_fabric_fifo_dma_define_nof_channels);
}

uint32
dnxf_data_fabric_fifo_dma_entry_size_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnxf_data_module_fabric, dnxf_data_fabric_submodule_fifo_dma, dnxf_data_fabric_fifo_dma_define_entry_size);
}

uint32
dnxf_data_fabric_fifo_dma_max_nof_entries_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnxf_data_module_fabric, dnxf_data_fabric_submodule_fifo_dma, dnxf_data_fabric_fifo_dma_define_max_nof_entries);
}

uint32
dnxf_data_fabric_fifo_dma_min_nof_entries_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnxf_data_module_fabric, dnxf_data_fabric_submodule_fifo_dma, dnxf_data_fabric_fifo_dma_define_min_nof_entries);
}

uint32
dnxf_data_fabric_fifo_dma_enable_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnxf_data_module_fabric, dnxf_data_fabric_submodule_fifo_dma, dnxf_data_fabric_fifo_dma_define_enable);
}

uint32
dnxf_data_fabric_fifo_dma_buffer_size_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnxf_data_module_fabric, dnxf_data_fabric_submodule_fifo_dma, dnxf_data_fabric_fifo_dma_define_buffer_size);
}

uint32
dnxf_data_fabric_fifo_dma_threshold_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnxf_data_module_fabric, dnxf_data_fabric_submodule_fifo_dma, dnxf_data_fabric_fifo_dma_define_threshold);
}

uint32
dnxf_data_fabric_fifo_dma_timeout_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnxf_data_module_fabric, dnxf_data_fabric_submodule_fifo_dma, dnxf_data_fabric_fifo_dma_define_timeout);
}
...
static shr_error_e
dnxf_data_fabric_rxtx_init(
    int unit,
    dnxc_data_submodule_t *submodule_data)
{
    SHR_FUNC_INIT_VARS(unit);

    submodule_data->name = "rxtx";
    submodule_data->doc = "";
    
    submodule_data->nof_features = _dnxf_data_fabric_rxtx_feature_nof;
    DNXC_DATA_ALLOC(submodule_data->features, dnxc_data_feature_t,  submodule_data->nof_features, "_dnxc_data fabric rxtx features");

    submodule_data->features[dnxf_data_fabric_rxtx_pkt_dma_supported].name = "pkt_dma_supported";
    submodule_data->features[dnxf_data_fabric_rxtx_pkt_dma_supported].doc = "";
    submodule_data->features[dnxf_data_fabric_rxtx_pkt_dma_supported].flags |= DNXC_DATA_F_FEATURE;

    
    submodule_data->nof_defines = _dnxf_data_fabric_rxtx_define_nof;
    DNXC_DATA_ALLOC(submodule_data->defines, dnxc_data_define_t, submodule_data->nof_defines, "_dnxc_data fabric rxtx defines");

    submodule_data->defines[dnxf_data_fabric_rxtx_define_nof_tx_channels].name = "nof_tx_channels";
    submodule_data->defines[dnxf_data_fabric_rxtx_define_nof_tx_channels].doc = "";
    
    submodule_data->defines[dnxf_data_fabric_rxtx_define_nof_tx_channels].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnxf_data_fabric_rxtx_define_nof_ep_ip_instances].name = "nof_ep_ip_instances";
    submodule_data->defines[dnxf_data_fabric_rxtx_define_nof_ep_ip_instances].doc = "";
    
    submodule_data->defines[dnxf_data_fabric_rxtx_define_nof_ep_ip_instances].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnxf_data_fabric_rxtx_define_pktsrc_id_to_channel_bit_field_size].name = "pktsrc_id_to_channel_bit_field_size";
    submodule_data->defines[dnxf_data_fabric_rxtx_define_pktsrc_id_to_channel_bit_field_size].doc = "";
    
    submodule_data->defines[dnxf_data_fabric_rxtx_define_pktsrc_id_to_channel_bit_field_size].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnxf_data_fabric_rxtx_define_pktsrc_id_to_dest_field_size].name = "pktsrc_id_to_dest_field_size";
    submodule_data->defines[dnxf_data_fabric_rxtx_define_pktsrc_id_to_dest_field_size].doc = "";
    
    submodule_data->defines[dnxf_data_fabric_rxtx_define_pktsrc_id_to_dest_field_size].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnxf_data_fabric_rxtx_define_max_nof_sub_channels_used].name = "max_nof_sub_channels_used";
    submodule_data->defines[dnxf_data_fabric_rxtx_define_max_nof_sub_channels_used].doc = "";
    
    submodule_data->defines[dnxf_data_fabric_rxtx_define_max_nof_sub_channels_used].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnxf_data_fabric_rxtx_define_rx_pool_nof_pkts].name = "rx_pool_nof_pkts";
    submodule_data->defines[dnxf_data_fabric_rxtx_define_rx_pool_nof_pkts].doc = "";
    
    submodule_data->defines[dnxf_data_fabric_rxtx_define_rx_pool_nof_pkts].flags |= DNXC_DATA_F_NUMERIC;

    
    submodule_data->nof_tables = _dnxf_data_fabric_rxtx_table_nof;
    DNXC_DATA_ALLOC(submodule_data->tables, dnxc_data_table_t, submodule_data->nof_tables, "_dnxc_data fabric rxtx tables");

    
    submodule_data->tables[dnxf_data_fabric_rxtx_table_tx_dma_channel_info].name = "tx_dma_channel_info";
    submodule_data->tables[dnxf_data_fabric_rxtx_table_tx_dma_channel_info].doc = "";
    submodule_data->tables[dnxf_data_fabric_rxtx_table_tx_dma_channel_info].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnxf_data_fabric_rxtx_table_tx_dma_channel_info].size_of_values = sizeof(dnxf_data_fabric_rxtx_tx_dma_channel_info_t);
    submodule_data->tables[dnxf_data_fabric_rxtx_table_tx_dma_channel_info].entry_get = dnxf_data_fabric_rxtx_tx_dma_channel_info_entry_str_get;

    
    submodule_data->tables[dnxf_data_fabric_rxtx_table_tx_dma_channel_info].nof_keys = 2;
    submodule_data->tables[dnxf_data_fabric_rxtx_table_tx_dma_channel_info].keys[0].name = "channel_type";
    submodule_data->tables[dnxf_data_fabric_rxtx_table_tx_dma_channel_info].keys[0].doc = "";
    submodule_data->tables[dnxf_data_fabric_rxtx_table_tx_dma_channel_info].keys[1].name = "index";
    submodule_data->tables[dnxf_data_fabric_rxtx_table_tx_dma_channel_info].keys[1].doc = "";

    
    submodule_data->tables[dnxf_data_fabric_rxtx_table_tx_dma_channel_info].nof_values = 1;
    DNXC_DATA_ALLOC(submodule_data->tables[dnxf_data_fabric_rxtx_table_tx_dma_channel_info].values, dnxc_data_value_t, submodule_data->tables[dnxf_data_fabric_rxtx_table_tx_dma_channel_info].nof_values, "_dnxf_data_fabric_rxtx_table_tx_dma_channel_info table values");
    submodule_data->tables[dnxf_data_fabric_rxtx_table_tx_dma_channel_info].values[0].name = "dma_channel";
    submodule_data->tables[dnxf_data_fabric_rxtx_table_tx_dma_channel_info].values[0].type = "int";
    submodule_data->tables[dnxf_data_fabric_rxtx_table_tx_dma_channel_info].values[0].doc = "";
    submodule_data->tables[dnxf_data_fabric_rxtx_table_tx_dma_channel_info].values[0].offset = UTILEX_OFFSETOF(dnxf_data_fabric_rxtx_tx_dma_channel_info_t, dma_channel);

    
    submodule_data->tables[dnxf_data_fabric_rxtx_table_rx_dma_channel_info].name = "rx_dma_channel_info";
    submodule_data->tables[dnxf_data_fabric_rxtx_table_rx_dma_channel_info].doc = "";
    submodule_data->tables[dnxf_data_fabric_rxtx_table_rx_dma_channel_info].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnxf_data_fabric_rxtx_table_rx_dma_channel_info].size_of_values = sizeof(dnxf_data_fabric_rxtx_rx_dma_channel_info_t);
    submodule_data->tables[dnxf_data_fabric_rxtx_table_rx_dma_channel_info].entry_get = dnxf_data_fabric_rxtx_rx_dma_channel_info_entry_str_get;

    
    submodule_data->tables[dnxf_data_fabric_rxtx_table_rx_dma_channel_info].nof_keys = 1;
    submodule_data->tables[dnxf_data_fabric_rxtx_table_rx_dma_channel_info].keys[0].name = "channel_type";
    submodule_data->tables[dnxf_data_fabric_rxtx_table_rx_dma_channel_info].keys[0].doc = "";

    
    submodule_data->tables[dnxf_data_fabric_rxtx_table_rx_dma_channel_info].nof_values = 2;
    DNXC_DATA_ALLOC(submodule_data->tables[dnxf_data_fabric_rxtx_table_rx_dma_channel_info].values, dnxc_data_value_t, submodule_data->tables[dnxf_data_fabric_rxtx_table_rx_dma_channel_info].nof_values, "_dnxf_data_fabric_rxtx_table_rx_dma_channel_info table values");
    submodule_data->tables[dnxf_data_fabric_rxtx_table_rx_dma_channel_info].values[0].name = "dma_channel";
    submodule_data->tables[dnxf_data_fabric_rxtx_table_rx_dma_channel_info].values[0].type = "int";
    submodule_data->tables[dnxf_data_fabric_rxtx_table_rx_dma_channel_info].values[0].doc = "";
    submodule_data->tables[dnxf_data_fabric_rxtx_table_rx_dma_channel_info].values[0].offset = UTILEX_OFFSETOF(dnxf_data_fabric_rxtx_rx_dma_channel_info_t, dma_channel);
    submodule_data->tables[dnxf_data_fabric_rxtx_table_rx_dma_channel_info].values[1].name = "cos";
    submodule_data->tables[dnxf_data_fabric_rxtx_table_rx_dma_channel_info].values[1].type = "bcm_pbmp_t";
    submodule_data->tables[dnxf_data_fabric_rxtx_table_rx_dma_channel_info].values[1].doc = "";
    submodule_data->tables[dnxf_data_fabric_rxtx_table_rx_dma_channel_info].values[1].offset = UTILEX_OFFSETOF(dnxf_data_fabric_rxtx_rx_dma_channel_info_t, cos);
...
int
dnxf_data_fabric_rxtx_feature_get(
    int unit,
    dnxf_data_fabric_rxtx_feature_e feature)
{
    return dnxc_data_mgmt_feature_data_get(unit, dnxf_data_module_fabric, dnxf_data_fabric_submodule_rxtx, feature);
}


uint32
dnxf_data_fabric_rxtx_nof_tx_channels_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnxf_data_module_fabric, dnxf_data_fabric_submodule_rxtx, dnxf_data_fabric_rxtx_define_nof_tx_channels);
}

uint32
dnxf_data_fabric_rxtx_nof_ep_ip_instances_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnxf_data_module_fabric, dnxf_data_fabric_submodule_rxtx, dnxf_data_fabric_rxtx_define_nof_ep_ip_instances);
}

uint32
dnxf_data_fabric_rxtx_pktsrc_id_to_channel_bit_field_size_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnxf_data_module_fabric, dnxf_data_fabric_submodule_rxtx, dnxf_data_fabric_rxtx_define_pktsrc_id_to_channel_bit_field_size);
}

uint32
dnxf_data_fabric_rxtx_pktsrc_id_to_dest_field_size_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnxf_data_module_fabric, dnxf_data_fabric_submodule_rxtx, dnxf_data_fabric_rxtx_define_pktsrc_id_to_dest_field_size);
}

uint32
dnxf_data_fabric_rxtx_max_nof_sub_channels_used_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnxf_data_module_fabric, dnxf_data_fabric_submodule_rxtx, dnxf_data_fabric_rxtx_define_max_nof_sub_channels_used);
}

uint32
dnxf_data_fabric_rxtx_rx_pool_nof_pkts_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnxf_data_module_fabric, dnxf_data_fabric_submodule_rxtx, dnxf_data_fabric_rxtx_define_rx_pool_nof_pkts);
}



const dnxf_data_fabric_rxtx_tx_dma_channel_info_t *
dnxf_data_fabric_rxtx_tx_dma_channel_info_get(
    int unit,
    int channel_type,
    int index)
{
    ...
    table = dnxc_data_mgmt_table_get(unit, dnxf_data_module_fabric, dnxf_data_fabric_submodule_rxtx, dnxf_data_fabric_rxtx_table_tx_dma_channel_info);
    
    data = dnxc_data_mgmt_table_data_get(unit, table, channel_type, index);
    return (const dnxf_data_fabric_rxtx_tx_dma_channel_info_t *) data;

}

const dnxf_data_fabric_rxtx_rx_dma_channel_info_t *
dnxf_data_fabric_rxtx_rx_dma_channel_info_get(
    int unit,
    int channel_type)
{
    char *data;
    ...
    table = dnxc_data_mgmt_table_get(unit, dnxf_data_module_fabric, dnxf_data_fabric_submodule_rxtx, dnxf_data_fabric_rxtx_table_rx_dma_channel_info);
    
    data = dnxc_data_mgmt_table_data_get(unit, table, channel_type, 0);
    return (const dnxf_data_fabric_rxtx_rx_dma_channel_info_t *) data;

}


shr_error_e
dnxf_data_fabric_rxtx_tx_dma_channel_info_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnxf_data_fabric_rxtx_tx_dma_channel_info_t *data;
    SHR_FUNC_INIT_VARS(unit);

    
    table = dnxc_data_mgmt_table_get(unit, dnxf_data_module_fabric, dnxf_data_fabric_submodule_rxtx, dnxf_data_fabric_rxtx_table_tx_dma_channel_info);
    data = (const dnxf_data_fabric_rxtx_tx_dma_channel_info_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, key1);
    switch (value_index)
    {
        case 0:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->dma_channel);
            break;
    }
...
shr_error_e
dnxf_data_fabric_rxtx_rx_dma_channel_info_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnxf_data_fabric_rxtx_rx_dma_channel_info_t *data;
    SHR_FUNC_INIT_VARS(unit);

    
    table = dnxc_data_mgmt_table_get(unit, dnxf_data_module_fabric, dnxf_data_fabric_submodule_rxtx, dnxf_data_fabric_rxtx_table_rx_dma_channel_info);
    data = (const dnxf_data_fabric_rxtx_rx_dma_channel_info_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->dma_channel);
            break;
        case 1:
            DNXC_DATA_MGMT_PBMP_STR(buffer, data->cos);
            break;
    }
...
const dnxc_data_table_info_t *
dnxf_data_fabric_rxtx_tx_dma_channel_info_info_get(
    int unit)
{

    
    return dnxc_data_mgmt_table_info_get(unit, dnxf_data_module_fabric, dnxf_data_fabric_submodule_rxtx, dnxf_data_fabric_rxtx_table_tx_dma_channel_info);

}

const dnxc_data_table_info_t *
dnxf_data_fabric_rxtx_rx_dma_channel_info_info_get(
    int unit)
{

    
    return dnxc_data_mgmt_table_info_get(unit, dnxf_data_module_fabric, dnxf_data_fabric_submodule_rxtx, dnxf_data_fabric_rxtx_table_rx_dma_channel_info);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnxf_data_fabric_cell_table_cell_match_filter_reg_mask].values[0].doc = "";
    ...
    submodule_data->tables[dnxf_data_fabric_cell_table_cell_match_filter_reg_mask].values[1].doc = "";
    ...
    submodule_data->tables[dnxf_data_fabric_cell_table_cell_match_filter_reg_mask].values[2].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnxf_data_fabric_system_upgrade_table_target].values[0].doc = "";
    ...
    dnxc_data_module_t *module_data)
{
    ...
    SHR_IF_ERR_EXIT(dnxf_data_fabric_fifo_dma_init(unit, &module_data->submodules[dnxf_data_fabric_submodule_fifo_dma]));
    SHR_IF_ERR_EXIT(dnxf_data_fabric_rxtx_init(unit, &module_data->submodules[dnxf_data_fabric_submodule_rxtx]));
