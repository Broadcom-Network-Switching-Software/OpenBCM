...
static shr_error_e
ramon_a0_dnxf_data_device_general_fabric_advanced_power_down_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnxf_data_module_device;
    int submodule_index = dnxf_data_device_submodule_general;
    int feature_index = dnxf_data_device_general_fabric_advanced_power_down;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    define->default_data = dnxf_data_device.general.nof_main_monitors_get(unit);

    
    define->data = dnxf_data_device.general.nof_main_monitors_get(unit);
...
static shr_error_e
ramon_a0_dnxf_data_device_general_nof_main_monitors_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_device;
    int submodule_index = dnxf_data_device_submodule_general;
    int define_index = dnxf_data_device_general_define_nof_main_monitors;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_device_blocks_nof_instances_pcu_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_device;
    int submodule_index = dnxf_data_device_submodule_blocks;
    int define_index = dnxf_data_device_blocks_define_nof_instances_pcu;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_device_blocks_nof_instances_ccml_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_device;
    int submodule_index = dnxf_data_device_submodule_blocks;
    int define_index = dnxf_data_device_blocks_define_nof_instances_ccml;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_device_blocks_nof_instances_dfl_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_device;
    int submodule_index = dnxf_data_device_submodule_blocks;
    int define_index = dnxf_data_device_blocks_define_nof_instances_dfl;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_device_blocks_nof_instances_dtm_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_device;
    int submodule_index = dnxf_data_device_submodule_blocks;
    int define_index = dnxf_data_device_blocks_define_nof_instances_dtm;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_device_blocks_nof_instances_pads_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_device;
    int submodule_index = dnxf_data_device_submodule_blocks;
    int define_index = dnxf_data_device_blocks_define_nof_instances_pads;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_device_blocks_nof_instances_dfl_fbc_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_device;
    int submodule_index = dnxf_data_device_submodule_blocks;
    int define_index = dnxf_data_device_blocks_define_nof_instances_dfl_fbc;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_device_blocks_nof_instances_dtl_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_device;
    int submodule_index = dnxf_data_device_submodule_blocks;
    int define_index = dnxf_data_device_blocks_define_nof_instances_dtl;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_device_blocks_nof_instances_mesh_topology_wrap_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_device;
    int submodule_index = dnxf_data_device_submodule_blocks;
    int define_index = dnxf_data_device_blocks_define_nof_instances_mesh_topology_wrap;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_device_vtmon_vol_factor_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_device;
    int submodule_index = dnxf_data_device_submodule_vtmon;
    int define_index = dnxf_data_device_vtmon_define_vol_factor;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_device_vtmon_vol_multiple_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_device;
    int submodule_index = dnxf_data_device_submodule_vtmon;
    int define_index = dnxf_data_device_vtmon_define_vol_multiple;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_device_vtmon_vol_divisor_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_device;
    int submodule_index = dnxf_data_device_submodule_vtmon;
    int define_index = dnxf_data_device_vtmon_define_vol_divisor;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_device_otp_nof_words_in_row_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_device;
    int submodule_index = dnxf_data_device_submodule_otp;
    int define_index = dnxf_data_device_otp_define_nof_words_in_row;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_device_otp_read_timeout_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_device;
    int submodule_index = dnxf_data_device_submodule_otp;
    int define_index = dnxf_data_device_otp_define_read_timeout;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_device_otp_otp_instance_attributes_set(
    int unit)
{
    int otp_instance_index_index;
    dnxf_data_device_otp_otp_instance_attributes_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnxf_data_module_device;
    int submodule_index = dnxf_data_device_submodule_otp;
    int table_index = dnxf_data_device_otp_table_otp_instance_attributes;
    SHR_FUNC_INIT_VARS(unit);
    ...
    DNXC_DATA_ALLOC(table->data, dnxf_data_device_otp_otp_instance_attributes_t, (1 * (table->keys[0].size) + 1  ), "data of dnxf_data_device_otp_table_otp_instance_attributes");

    
    default_data = (dnxf_data_device_otp_otp_instance_attributes_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    ...
    {
        data = (dnxf_data_device_otp_otp_instance_attributes_t *) dnxc_data_mgmt_table_data_get(unit, table, otp_instance_index_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
    
    if (SOC_DNXC_OTP_INSTANCE_GENERAL_USE < table->keys[0].size)
    {
        data = (dnxf_data_device_otp_otp_instance_attributes_t *) dnxc_data_mgmt_table_data_get(unit, table, SOC_DNXC_OTP_INSTANCE_GENERAL_USE, 0);
        data->block_id = 84;
        data->is_supported = 1;
        data->size = 18432;
    }
...
static shr_error_e
ramon_a0_dnxf_data_device_otp_reg_addresses_set(
    int unit)
{
    dnxf_data_device_otp_reg_addresses_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnxf_data_module_device;
    int submodule_index = dnxf_data_device_submodule_otp;
    int table_index = dnxf_data_device_otp_table_reg_addresses;
    SHR_FUNC_INIT_VARS(unit);
    ...
    DNXC_DATA_ALLOC(table->data, dnxf_data_device_otp_reg_addresses_t, (1 + 1  ), "data of dnxf_data_device_otp_table_reg_addresses");

    
    default_data = (dnxf_data_device_otp_reg_addresses_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    ...
    data = (dnxf_data_device_otp_reg_addresses_t *) dnxc_data_mgmt_table_data_get(unit, table, 0, 0);
    sal_memcpy(data, default_data, table->size_of_values);
    ...
    int unit)
{
    ...
    data_index = dnxf_data_device_general_define_nof_main_monitors;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_device_general_nof_main_monitors_set;
    ...
    data_index = dnxf_data_device_general_fabric_advanced_power_down;
    feature = &submodule->features[data_index];
    feature->set = ramon_a0_dnxf_data_device_general_fabric_advanced_power_down_set;
    ...
    data_index = dnxf_data_device_blocks_define_nof_instances_pcu;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_device_blocks_nof_instances_pcu_set;
    data_index = dnxf_data_device_blocks_define_nof_instances_ccml;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_device_blocks_nof_instances_ccml_set;
    data_index = dnxf_data_device_blocks_define_nof_instances_dfl;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_device_blocks_nof_instances_dfl_set;
    data_index = dnxf_data_device_blocks_define_nof_instances_dtm;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_device_blocks_nof_instances_dtm_set;
    data_index = dnxf_data_device_blocks_define_nof_instances_pads;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_device_blocks_nof_instances_pads_set;
    data_index = dnxf_data_device_blocks_define_nof_instances_dfl_fbc;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_device_blocks_nof_instances_dfl_fbc_set;
    data_index = dnxf_data_device_blocks_define_nof_instances_dtl;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_device_blocks_nof_instances_dtl_set;
    data_index = dnxf_data_device_blocks_define_nof_instances_mesh_topology_wrap;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_device_blocks_nof_instances_mesh_topology_wrap_set;
    ...
    submodule_index = dnxf_data_device_submodule_vtmon;
    submodule = &module->submodules[submodule_index];

    
    data_index = dnxf_data_device_vtmon_define_vol_factor;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_device_vtmon_vol_factor_set;
    data_index = dnxf_data_device_vtmon_define_vol_multiple;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_device_vtmon_vol_multiple_set;
    data_index = dnxf_data_device_vtmon_define_vol_divisor;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_device_vtmon_vol_divisor_set;
    ...
    submodule_index = dnxf_data_device_submodule_otp;
    submodule = &module->submodules[submodule_index];

    
    data_index = dnxf_data_device_otp_define_nof_words_in_row;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_device_otp_nof_words_in_row_set;
    data_index = dnxf_data_device_otp_define_read_timeout;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_device_otp_read_timeout_set;

    

    
    data_index = dnxf_data_device_otp_table_otp_instance_attributes;
    table = &submodule->tables[data_index];
    table->set = ramon_a0_dnxf_data_device_otp_otp_instance_attributes_set;
    data_index = dnxf_data_device_otp_table_reg_addresses;
    table = &submodule->tables[data_index];
    table->set = ramon_a0_dnxf_data_device_otp_reg_addresses_set;
