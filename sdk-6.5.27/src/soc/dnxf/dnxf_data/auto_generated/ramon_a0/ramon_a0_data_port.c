...
static shr_error_e
ramon_a0_dnxf_data_port_general_bw_update_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnxf_data_module_port;
    int submodule_index = dnxf_data_port_submodule_general;
    int feature_index = dnxf_data_port_general_bw_update;
...
static shr_error_e
ramon_a0_dnxf_data_port_general_is_connection_to_repeater_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnxf_data_module_port;
    int submodule_index = dnxf_data_port_submodule_general;
    int feature_index = dnxf_data_port_general_is_connection_to_repeater_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_port_general_fmac_only_disable_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnxf_data_module_port;
    int submodule_index = dnxf_data_port_submodule_general;
    int feature_index = dnxf_data_port_general_fmac_only_disable_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_port_general_max_speed_api_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnxf_data_module_port;
    int submodule_index = dnxf_data_port_submodule_general;
    int feature_index = dnxf_data_port_general_max_speed_api_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_port_general_fec_ber_proj_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnxf_data_module_port;
    int submodule_index = dnxf_data_port_submodule_general;
    int feature_index = dnxf_data_port_general_fec_ber_proj_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_port_general_port_selective_set_api_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnxf_data_module_port;
    int submodule_index = dnxf_data_port_submodule_general;
    int feature_index = dnxf_data_port_general_port_selective_set_api_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_port_general_is_phy_rx_taps_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnxf_data_module_port;
    int submodule_index = dnxf_data_port_submodule_general;
    int feature_index = dnxf_data_port_general_is_phy_rx_taps_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_port_general_is_scrambling_disable_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnxf_data_module_port;
    int submodule_index = dnxf_data_port_submodule_general;
    int feature_index = dnxf_data_port_general_is_scrambling_disable_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_port_general_nof_ber_proj_error_analyzer_counters_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_port;
    int submodule_index = dnxf_data_port_submodule_general;
    int define_index = dnxf_data_port_general_define_nof_ber_proj_error_analyzer_counters;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_port_general_default_fec_key_map(
    int unit,
    int key0_val,
    int key1_val,
    int *key0_index,
...
static shr_error_e
ramon_a0_dnxf_data_port_general_default_fec_key_reverse_map(
    int unit,
    int key0_index,
    int key1_index,
    int *key0_val,
...
static shr_error_e
ramon_a0_dnxf_data_port_general_supported_lanes_set(
    int unit)
{
    dnxf_data_port_general_supported_lanes_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnxf_data_module_port;
    int submodule_index = dnxf_data_port_submodule_general;
    int table_index = dnxf_data_port_general_table_supported_lanes;
    SHR_FUNC_INIT_VARS(unit);
    ...
    DNXC_DATA_ALLOC(table->data, dnxf_data_port_general_supported_lanes_t, (1 + 1  ), "data of dnxf_data_port_general_table_supported_lanes");

    
    default_data = (dnxf_data_port_general_supported_lanes_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    ...
    data = (dnxf_data_port_general_supported_lanes_t *) dnxc_data_mgmt_table_data_get(unit, table, 0, 0);
...
static shr_error_e
ramon_a0_dnxf_data_port_general_supported_interfaces_set(
    int unit)
{
    int index_index;
    dnxf_data_port_general_supported_interfaces_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnxf_data_module_port;
    int submodule_index = dnxf_data_port_submodule_general;
    int table_index = dnxf_data_port_general_table_supported_interfaces;
    SHR_FUNC_INIT_VARS(unit);
    ...
    DNXC_DATA_ALLOC(table->data, dnxf_data_port_general_supported_interfaces_t, (1 * (table->keys[0].size) + 1  ), "data of dnxf_data_port_general_table_supported_interfaces");

    
    default_data = (dnxf_data_port_general_supported_interfaces_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    ...
    {
        data = (dnxf_data_port_general_supported_interfaces_t *) dnxc_data_mgmt_table_data_get(unit, table, index_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
    
    if (0 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_interfaces_t *) dnxc_data_mgmt_table_data_get(unit, table, 0, 0);
        data->speed = 10312;
        data->fec_type = bcmPortPhyFecNone;
    }
    if (1 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_interfaces_t *) dnxc_data_mgmt_table_data_get(unit, table, 1, 0);
        data->speed = 10312;
        data->fec_type = bcmPortPhyFecBaseR;
    }
    if (2 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_interfaces_t *) dnxc_data_mgmt_table_data_get(unit, table, 2, 0);
        data->speed = 10312;
        data->fec_type = bcmPortPhyFecRs206;
    }
    if (3 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_interfaces_t *) dnxc_data_mgmt_table_data_get(unit, table, 3, 0);
        data->speed = 10312;
        data->fec_type = bcmPortPhyFecRs108;
    }
    if (4 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_interfaces_t *) dnxc_data_mgmt_table_data_get(unit, table, 4, 0);
        data->speed = 11500;
        data->fec_type = bcmPortPhyFecNone;
    }
    if (5 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_interfaces_t *) dnxc_data_mgmt_table_data_get(unit, table, 5, 0);
        data->speed = 11500;
        data->fec_type = bcmPortPhyFecBaseR;
    }
    if (6 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_interfaces_t *) dnxc_data_mgmt_table_data_get(unit, table, 6, 0);
        data->speed = 11500;
        data->fec_type = bcmPortPhyFecRs206;
    }
    if (7 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_interfaces_t *) dnxc_data_mgmt_table_data_get(unit, table, 7, 0);
        data->speed = 11500;
        data->fec_type = bcmPortPhyFecRs108;
    }
    if (8 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_interfaces_t *) dnxc_data_mgmt_table_data_get(unit, table, 8, 0);
        data->speed = 20625;
        data->fec_type = bcmPortPhyFecNone;
    }
    if (9 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_interfaces_t *) dnxc_data_mgmt_table_data_get(unit, table, 9, 0);
        data->speed = 20625;
        data->fec_type = bcmPortPhyFecRs206;
    }
    if (10 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_interfaces_t *) dnxc_data_mgmt_table_data_get(unit, table, 10, 0);
        data->speed = 20625;
        data->fec_type = bcmPortPhyFecRs108;
    }
    if (11 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_interfaces_t *) dnxc_data_mgmt_table_data_get(unit, table, 11, 0);
        data->speed = 23000;
        data->fec_type = bcmPortPhyFecNone;
    }
    if (12 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_interfaces_t *) dnxc_data_mgmt_table_data_get(unit, table, 12, 0);
        data->speed = 23000;
        data->fec_type = bcmPortPhyFecRs206;
    }
    if (13 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_interfaces_t *) dnxc_data_mgmt_table_data_get(unit, table, 13, 0);
        data->speed = 23000;
        data->fec_type = bcmPortPhyFecRs108;
    }
    if (14 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_interfaces_t *) dnxc_data_mgmt_table_data_get(unit, table, 14, 0);
        data->speed = 25000;
        data->fec_type = bcmPortPhyFecNone;
    }
    if (15 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_interfaces_t *) dnxc_data_mgmt_table_data_get(unit, table, 15, 0);
        data->speed = 25000;
        data->fec_type = bcmPortPhyFecRs206;
    }
    if (16 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_interfaces_t *) dnxc_data_mgmt_table_data_get(unit, table, 16, 0);
        data->speed = 25000;
        data->fec_type = bcmPortPhyFecRs108;
    }
    if (17 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_interfaces_t *) dnxc_data_mgmt_table_data_get(unit, table, 17, 0);
        data->speed = 25781;
        data->fec_type = bcmPortPhyFecNone;
    }
    if (18 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_interfaces_t *) dnxc_data_mgmt_table_data_get(unit, table, 18, 0);
        data->speed = 25781;
        data->fec_type = bcmPortPhyFecRs206;
    }
    if (19 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_interfaces_t *) dnxc_data_mgmt_table_data_get(unit, table, 19, 0);
        data->speed = 25781;
        data->fec_type = bcmPortPhyFecRs108;
    }
    if (20 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_interfaces_t *) dnxc_data_mgmt_table_data_get(unit, table, 20, 0);
        data->speed = 50000;
        data->fec_type = bcmPortPhyFecNone;
    }
    if (21 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_interfaces_t *) dnxc_data_mgmt_table_data_get(unit, table, 21, 0);
        data->speed = 50000;
        data->fec_type = bcmPortPhyFecRs206;
    }
    if (22 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_interfaces_t *) dnxc_data_mgmt_table_data_get(unit, table, 22, 0);
        data->speed = 50000;
        data->fec_type = bcmPortPhyFecRs108;
    }
    if (23 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_interfaces_t *) dnxc_data_mgmt_table_data_get(unit, table, 23, 0);
        data->speed = 50000;
        data->fec_type = bcmPortPhyFecRs545;
    }
    if (24 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_interfaces_t *) dnxc_data_mgmt_table_data_get(unit, table, 24, 0);
        data->speed = 50000;
        data->fec_type = bcmPortPhyFecRs304;
    }
    if (25 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_interfaces_t *) dnxc_data_mgmt_table_data_get(unit, table, 25, 0);
        data->speed = 53125;
        data->fec_type = bcmPortPhyFecNone;
    }
    if (26 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_interfaces_t *) dnxc_data_mgmt_table_data_get(unit, table, 26, 0);
        data->speed = 53125;
        data->fec_type = bcmPortPhyFecRs206;
    }
    if (27 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_interfaces_t *) dnxc_data_mgmt_table_data_get(unit, table, 27, 0);
        data->speed = 53125;
        data->fec_type = bcmPortPhyFecRs108;
    }
    if (28 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_interfaces_t *) dnxc_data_mgmt_table_data_get(unit, table, 28, 0);
        data->speed = 53125;
        data->fec_type = bcmPortPhyFecRs545;
    }
    if (29 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_interfaces_t *) dnxc_data_mgmt_table_data_get(unit, table, 29, 0);
        data->speed = 53125;
        data->fec_type = bcmPortPhyFecRs304;
    }
...
static shr_error_e
ramon_a0_dnxf_data_port_general_default_fec_set(
    int unit)
{
    int speed_index;
    dnxf_data_port_general_default_fec_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnxf_data_module_port;
    int submodule_index = dnxf_data_port_submodule_general;
    int table_index = dnxf_data_port_general_table_default_fec;
    SHR_FUNC_INIT_VARS(unit);
    ...
    table->values[0].default_val = "bcmPortPhyFecInvalid";
    ...
    DNXC_DATA_ALLOC(table->data, dnxf_data_port_general_default_fec_t, (1 * (table->keys[0].size) + 1  ), "data of dnxf_data_port_general_table_default_fec");

    
    default_data = (dnxf_data_port_general_default_fec_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    default_data->fec_type = bcmPortPhyFecInvalid;
    
    for (speed_index = 0; speed_index < table->keys[0].size; speed_index++)
    {
        data = (dnxf_data_port_general_default_fec_t *) dnxc_data_mgmt_table_data_get(unit, table, speed_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
    table->key_map = ramon_a0_dnxf_data_port_general_default_fec_key_map;
    table->key_map_reverse = ramon_a0_dnxf_data_port_general_default_fec_key_reverse_map;
    
    data = (dnxf_data_port_general_default_fec_t *) dnxc_data_mgmt_table_data_get(unit, table, 10312, 0);
    data->fec_type = bcmPortPhyFecRs206;
    data = (dnxf_data_port_general_default_fec_t *) dnxc_data_mgmt_table_data_get(unit, table, 11500, 0);
    data->fec_type = bcmPortPhyFecRs206;
    data = (dnxf_data_port_general_default_fec_t *) dnxc_data_mgmt_table_data_get(unit, table, 20625, 0);
    data->fec_type = bcmPortPhyFecRs206;
    data = (dnxf_data_port_general_default_fec_t *) dnxc_data_mgmt_table_data_get(unit, table, 23000, 0);
    data->fec_type = bcmPortPhyFecRs206;
    data = (dnxf_data_port_general_default_fec_t *) dnxc_data_mgmt_table_data_get(unit, table, 25000, 0);
    data->fec_type = bcmPortPhyFecRs206;
    data = (dnxf_data_port_general_default_fec_t *) dnxc_data_mgmt_table_data_get(unit, table, 25781, 0);
    data->fec_type = bcmPortPhyFecRs206;
    data = (dnxf_data_port_general_default_fec_t *) dnxc_data_mgmt_table_data_get(unit, table, 50000, 0);
    data->fec_type = bcmPortPhyFecRs545;
    data = (dnxf_data_port_general_default_fec_t *) dnxc_data_mgmt_table_data_get(unit, table, 53125, 0);
    data->fec_type = bcmPortPhyFecRs545;
...
static shr_error_e
ramon_a0_dnxf_data_port_general_supported_fec_controls_set(
    int unit)
{
    int index_index;
    dnxf_data_port_general_supported_fec_controls_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnxf_data_module_port;
    int submodule_index = dnxf_data_port_submodule_general;
    int table_index = dnxf_data_port_general_table_supported_fec_controls;
    SHR_FUNC_INIT_VARS(unit);
    ...
    table->values[0].default_val = "bcmPortPhyFecInvalid";
    table->values[1].default_val = "bcmPortControlFecErrorDetectEnable";
    table->values[2].default_val = "1";
    ...
    DNXC_DATA_ALLOC(table->data, dnxf_data_port_general_supported_fec_controls_t, (1 * (table->keys[0].size) + 1  ), "data of dnxf_data_port_general_table_supported_fec_controls");

    
    default_data = (dnxf_data_port_general_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    default_data->fec_type = bcmPortPhyFecInvalid;
    default_data->control_type = bcmPortControlFecErrorDetectEnable;
    default_data->is_valid = 1;
    
    for (index_index = 0; index_index < table->keys[0].size; index_index++)
    {
        data = (dnxf_data_port_general_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, index_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
    
    if (0 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, 0, 0);
        data->fec_type = bcmPortPhyFecBaseR;
        data->control_type = bcmPortControlLowLatencyLLFCEnable;
    }
    if (1 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, 1, 0);
        data->fec_type = bcmPortPhyFecBaseR;
        data->control_type = bcmPortControlFecErrorDetectEnable;
    }
    if (2 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, 2, 0);
        data->fec_type = bcmPortPhyFecBaseR;
        data->control_type = bcmPortControlLlfcCellsCongestionIndEnable;
    }
    if (3 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, 3, 0);
        data->fec_type = bcmPortPhyFecRs206;
        data->control_type = bcmPortControlFecErrorDetectEnable;
    }
    if (4 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, 4, 0);
        data->fec_type = bcmPortPhyFecRs206;
        data->control_type = bcmPortControlLLFCAfterFecEnable;
    }
    if (5 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, 5, 0);
        data->fec_type = bcmPortPhyFecRs206;
        data->control_type = bcmPortControlControlCellsFecBypassEnable;
    }
    if (6 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, 6, 0);
        data->fec_type = bcmPortPhyFecRs108;
        data->control_type = bcmPortControlFecErrorDetectEnable;
    }
    if (7 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, 7, 0);
        data->fec_type = bcmPortPhyFecRs108;
        data->control_type = bcmPortControlLLFCAfterFecEnable;
    }
    if (8 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, 8, 0);
        data->fec_type = bcmPortPhyFecRs108;
        data->control_type = bcmPortControlControlCellsFecBypassEnable;
    }
    if (9 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, 9, 0);
        data->fec_type = bcmPortPhyFecRs545;
        data->control_type = bcmPortControlFecErrorDetectEnable;
    }
    if (10 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, 10, 0);
        data->fec_type = bcmPortPhyFecRs545;
        data->control_type = bcmPortControlLLFCAfterFecEnable;
    }
    if (11 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, 11, 0);
        data->fec_type = bcmPortPhyFecRs545;
        data->control_type = bcmPortControlControlCellsFecBypassEnable;
    }
    if (12 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, 12, 0);
        data->fec_type = bcmPortPhyFecRs304;
        data->control_type = bcmPortControlFecErrorDetectEnable;
    }
    if (13 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, 13, 0);
        data->fec_type = bcmPortPhyFecRs304;
        data->control_type = bcmPortControlLLFCAfterFecEnable;
    }
    if (14 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_supported_fec_controls_t *) dnxc_data_mgmt_table_data_get(unit, table, 14, 0);
        data->fec_type = bcmPortPhyFecRs304;
        data->control_type = bcmPortControlControlCellsFecBypassEnable;
    }
...
static shr_error_e
ramon_a0_dnxf_data_port_general_fec_compensation_info_set(
    int unit)
{
    int fec_type_index;
    dnxf_data_port_general_fec_compensation_info_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnxf_data_module_port;
    int submodule_index = dnxf_data_port_submodule_general;
    int table_index = dnxf_data_port_general_table_fec_compensation_info;
    SHR_FUNC_INIT_VARS(unit);
    ...
    DNXC_DATA_ALLOC(table->data, dnxf_data_port_general_fec_compensation_info_t, (1 * (table->keys[0].size) + 1  ), "data of dnxf_data_port_general_table_fec_compensation_info");

    
    default_data = (dnxf_data_port_general_fec_compensation_info_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    ...
    {
        data = (dnxf_data_port_general_fec_compensation_info_t *) dnxc_data_mgmt_table_data_get(unit, table, fec_type_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
    
    if (bcmPortPhyFecRs545 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_fec_compensation_info_t *) dnxc_data_mgmt_table_data_get(unit, table, bcmPortPhyFecRs545, 0);
    ...
    if (bcmPortPhyFecRs304 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_fec_compensation_info_t *) dnxc_data_mgmt_table_data_get(unit, table, bcmPortPhyFecRs304, 0);
...
static shr_error_e
ramon_a0_dnxf_data_port_general_phy_controls_features_set(
    int unit)
{
    int phy_control_type_index;
    dnxf_data_port_general_phy_controls_features_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnxf_data_module_port;
    int submodule_index = dnxf_data_port_submodule_general;
    int table_index = dnxf_data_port_general_table_phy_controls_features;
    SHR_FUNC_INIT_VARS(unit);
    ...
    DNXC_DATA_ALLOC(table->data, dnxf_data_port_general_phy_controls_features_t, (1 * (table->keys[0].size) + 1  ), "data of dnxf_data_port_general_table_phy_controls_features");

    
    default_data = (dnxf_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    ...
    {
        data = (dnxf_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_get(unit, table, phy_control_type_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
    
    if (SOC_PHY_CONTROL_DUMP < table->keys[0].size)
    {
        data = (dnxf_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_get(unit, table, SOC_PHY_CONTROL_DUMP, 0);
        data->port_disable_required = 0;
    }
    if (SOC_PHY_CONTROL_TX_PATTERN_LENGTH < table->keys[0].size)
    {
        data = (dnxf_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_get(unit, table, SOC_PHY_CONTROL_TX_PATTERN_LENGTH, 0);
        data->port_disable_required = 0;
    }
    if (SOC_PHY_CONTROL_TX_PATTERN_GEN_ENABLE < table->keys[0].size)
    {
        data = (dnxf_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_get(unit, table, SOC_PHY_CONTROL_TX_PATTERN_GEN_ENABLE, 0);
        data->port_disable_required = 0;
    }
    if (SOC_PHY_CONTROL_TX_PATTERN_DATA0 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_get(unit, table, SOC_PHY_CONTROL_TX_PATTERN_DATA0, 0);
        data->port_disable_required = 0;
    }
    if (SOC_PHY_CONTROL_TX_PATTERN_DATA1 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_get(unit, table, SOC_PHY_CONTROL_TX_PATTERN_DATA1, 0);
        data->port_disable_required = 0;
    }
    if (SOC_PHY_CONTROL_TX_PATTERN_DATA2 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_get(unit, table, SOC_PHY_CONTROL_TX_PATTERN_DATA2, 0);
        data->port_disable_required = 0;
    }
    if (SOC_PHY_CONTROL_TX_PATTERN_DATA3 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_get(unit, table, SOC_PHY_CONTROL_TX_PATTERN_DATA3, 0);
        data->port_disable_required = 0;
    }
    if (SOC_PHY_CONTROL_TX_PATTERN_DATA4 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_get(unit, table, SOC_PHY_CONTROL_TX_PATTERN_DATA4, 0);
        data->port_disable_required = 0;
    }
    if (SOC_PHY_CONTROL_TX_PATTERN_DATA5 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_get(unit, table, SOC_PHY_CONTROL_TX_PATTERN_DATA5, 0);
        data->port_disable_required = 0;
    }
    if (SOC_PHY_CONTROL_TX_PATTERN_DATA6 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_get(unit, table, SOC_PHY_CONTROL_TX_PATTERN_DATA6, 0);
        data->port_disable_required = 0;
    }
    if (SOC_PHY_CONTROL_TX_PATTERN_DATA7 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_get(unit, table, SOC_PHY_CONTROL_TX_PATTERN_DATA7, 0);
        data->port_disable_required = 0;
    }
    if (SOC_PHY_CONTROL_PRBS_DECOUPLED_TX_POLYNOMIAL < table->keys[0].size)
    {
        data = (dnxf_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_get(unit, table, SOC_PHY_CONTROL_PRBS_DECOUPLED_TX_POLYNOMIAL, 0);
        data->port_disable_required = 0;
    }
    if (SOC_PHY_CONTROL_PRBS_DECOUPLED_TX_INVERT_DATA < table->keys[0].size)
    {
        data = (dnxf_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_get(unit, table, SOC_PHY_CONTROL_PRBS_DECOUPLED_TX_INVERT_DATA, 0);
        data->port_disable_required = 0;
    }
    if (SOC_PHY_CONTROL_PRBS_DECOUPLED_TX_ENABLE < table->keys[0].size)
    {
        data = (dnxf_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_get(unit, table, SOC_PHY_CONTROL_PRBS_DECOUPLED_TX_ENABLE, 0);
        data->port_disable_required = 0;
    }
    if (SOC_PHY_CONTROL_PRBS_DECOUPLED_RX_POLYNOMIAL < table->keys[0].size)
    {
        data = (dnxf_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_get(unit, table, SOC_PHY_CONTROL_PRBS_DECOUPLED_RX_POLYNOMIAL, 0);
        data->port_disable_required = 0;
    }
    if (SOC_PHY_CONTROL_PRBS_DECOUPLED_RX_INVERT_DATA < table->keys[0].size)
    {
        data = (dnxf_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_get(unit, table, SOC_PHY_CONTROL_PRBS_DECOUPLED_RX_INVERT_DATA, 0);
        data->port_disable_required = 0;
    }
    if (SOC_PHY_CONTROL_PRBS_DECOUPLED_RX_ENABLE < table->keys[0].size)
    {
        data = (dnxf_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_get(unit, table, SOC_PHY_CONTROL_PRBS_DECOUPLED_RX_ENABLE, 0);
        data->port_disable_required = 0;
    }
    if (SOC_PHY_CONTROL_RX_PEAK_FILTER < table->keys[0].size)
    {
        data = (dnxf_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_get(unit, table, SOC_PHY_CONTROL_RX_PEAK_FILTER, 0);
        data->port_disable_required = 0;
    }
    if (SOC_PHY_CONTROL_RX_LOW_FREQ_PEAK_FILTER < table->keys[0].size)
    {
        data = (dnxf_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_get(unit, table, SOC_PHY_CONTROL_RX_LOW_FREQ_PEAK_FILTER, 0);
        data->port_disable_required = 0;
    }
    if (SOC_PHY_CONTROL_RX_HIGH_FREQ_PEAK_FILTER < table->keys[0].size)
    {
        data = (dnxf_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_get(unit, table, SOC_PHY_CONTROL_RX_HIGH_FREQ_PEAK_FILTER, 0);
        data->port_disable_required = 0;
    }
    if (SOC_PHY_CONTROL_RX_VGA < table->keys[0].size)
    {
        data = (dnxf_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_get(unit, table, SOC_PHY_CONTROL_RX_VGA, 0);
        data->port_disable_required = 0;
    }
    if (SOC_PHY_CONTROL_RX_TAP1 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_get(unit, table, SOC_PHY_CONTROL_RX_TAP1, 0);
        data->port_disable_required = 0;
    }
    if (SOC_PHY_CONTROL_RX_TAP2 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_get(unit, table, SOC_PHY_CONTROL_RX_TAP2, 0);
        data->port_disable_required = 0;
    }
    if (SOC_PHY_CONTROL_RX_TAP3 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_get(unit, table, SOC_PHY_CONTROL_RX_TAP3, 0);
        data->port_disable_required = 0;
    }
    if (SOC_PHY_CONTROL_RX_TAP4 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_get(unit, table, SOC_PHY_CONTROL_RX_TAP4, 0);
        data->port_disable_required = 0;
    }
    if (SOC_PHY_CONTROL_RX_TAP5 < table->keys[0].size)
    {
        data = (dnxf_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_get(unit, table, SOC_PHY_CONTROL_RX_TAP5, 0);
        data->port_disable_required = 0;
    }
    if (SOC_PHY_CONTROL_RX_ADAPTATION_RESUME < table->keys[0].size)
    {
        data = (dnxf_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_get(unit, table, SOC_PHY_CONTROL_RX_ADAPTATION_RESUME, 0);
        data->port_disable_required = 0;
    }
    if (SOC_PHY_CONTROL_RX_LANE_SQUELCH < table->keys[0].size)
    {
        data = (dnxf_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_get(unit, table, SOC_PHY_CONTROL_RX_LANE_SQUELCH, 0);
        data->port_disable_required = 0;
    }
    if (SOC_PHY_CONTROL_TX_LANE_SQUELCH < table->keys[0].size)
    {
        data = (dnxf_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_get(unit, table, SOC_PHY_CONTROL_TX_LANE_SQUELCH, 0);
        data->port_disable_required = 0;
    }
    if (SOC_PHY_CONTROL_FLEXE_50G_NOFEC_20K_AM_SPACING_ENABLE < table->keys[0].size)
    {
        data = (dnxf_data_port_general_phy_controls_features_t *) dnxc_data_mgmt_table_data_get(unit, table, SOC_PHY_CONTROL_FLEXE_50G_NOFEC_20K_AM_SPACING_ENABLE, 0);
        data->port_disable_required = 0;
    }
...
static shr_error_e
ramon_a0_dnxf_data_port_stat_thread_flags_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_port;
    int submodule_index = dnxf_data_port_submodule_stat;
    int define_index = dnxf_data_port_stat_define_thread_flags;
    SHR_FUNC_INIT_VARS(unit);
    ...
    define->property.name = spn_BCM_STAT_FLAGS;
    define->property.doc = 
        "\n"
    ;
    define->property.method = dnxc_data_property_method_range;
    ...
    int unit)
{
    ...
    table->values[8].default_val = "BCM_FABRIC_LINK_CELL_FORMAT_VSC256_V2";
    ...
    default_data->cell_format = BCM_FABRIC_LINK_CELL_FORMAT_VSC256_V2;
    ...
    int unit)
{
    ...
    table->values[1].default_val = "0";
    table->values[2].default_val = "0";
    table->values[3].default_val = "DNXC_PORT_TX_FIR_INVALID_MAIN_TAP";
    table->values[4].default_val = "0";
    table->values[5].default_val = "0";
    table->values[6].default_val = "0";
...
static shr_error_e
ramon_a0_dnxf_data_port_lane_map_is_flexible_link_mapping_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnxf_data_module_port;
    int submodule_index = dnxf_data_port_submodule_lane_map;
    int feature_index = dnxf_data_port_lane_map_is_flexible_link_mapping_supported;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    table->keys[0].size = dnxf_data_device.blocks.nof_instances_fmac_get(unit) * dnxf_data_device.blocks.nof_links_in_fmac_get(unit);
    table->info_get.key_size[0] = dnxf_data_device.blocks.nof_instances_fmac_get(unit) * dnxf_data_device.blocks.nof_links_in_fmac_get(unit);
    ...
    int unit)
{
    ...
    table->values[0].default_val = "DNXC_SERDES_REF_CLOCK_312_5";
    table->values[1].default_val = "DNXC_SERDES_REF_CLOCK_BYPASS";
    ...
    default_data->fabric_ref_clk_in = DNXC_SERDES_REF_CLOCK_312_5;
    default_data->fabric_ref_clk_out = DNXC_SERDES_REF_CLOCK_BYPASS;
    ...
    table->values[0].property.mapping[0].name = "1";
    table->values[0].property.mapping[0].val = DNXC_SERDES_REF_CLOCK_156_25;
    table->values[0].property.mapping[1].name = "3";
    table->values[0].property.mapping[1].val = DNXC_SERDES_REF_CLOCK_312_5;
    ...
    table->values[1].property.mapping[0].val = DNXC_SERDES_REF_CLOCK_156_25;
    table->values[1].property.mapping[1].name = "3";
    table->values[1].property.mapping[1].val = DNXC_SERDES_REF_CLOCK_312_5;
    table->values[1].property.mapping[2].name = "bypass";
    table->values[1].property.mapping[2].val = DNXC_SERDES_REF_CLOCK_BYPASS;
...
static shr_error_e
ramon_a0_dnxf_data_port_pll_force_single_pll_set(
    int unit)
{
    int pm_index;
    dnxf_data_port_pll_force_single_pll_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnxf_data_module_port;
    int submodule_index = dnxf_data_port_submodule_pll;
    int table_index = dnxf_data_port_pll_table_force_single_pll;
    SHR_FUNC_INIT_VARS(unit);
    ...
    table->keys[0].size = dnxf_data_port.general.nof_pms_get(unit);
    table->info_get.key_size[0] = dnxf_data_port.general.nof_pms_get(unit);
    ...
    DNXC_DATA_ALLOC(table->data, dnxf_data_port_pll_force_single_pll_t, (1 * (table->keys[0].size) + 1  ), "data of dnxf_data_port_pll_table_force_single_pll");

    
    default_data = (dnxf_data_port_pll_force_single_pll_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    default_data->enable = 0;
    
    for (pm_index = 0; pm_index < table->keys[0].size; pm_index++)
    {
        data = (dnxf_data_port_pll_force_single_pll_t *) dnxc_data_mgmt_table_data_get(unit, table, pm_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
    ...
    int unit)
{
    ...
    table->keys[0].size = DNXC_SERDES_REF_CLOCK_NOF;
    table->info_get.key_size[0] = DNXC_SERDES_REF_CLOCK_NOF;
    table->keys[1].size = DNXC_SERDES_REF_CLOCK_NOF;
    table->info_get.key_size[1] = DNXC_SERDES_REF_CLOCK_NOF;
    ...
    if (DNXC_SERDES_REF_CLOCK_125 < table->keys[0].size && DNXC_SERDES_REF_CLOCK_156_25 < table->keys[1].size)
    {
        data = (dnxf_data_port_pll_config_t *) dnxc_data_mgmt_table_data_get(unit, table, DNXC_SERDES_REF_CLOCK_125, DNXC_SERDES_REF_CLOCK_156_25);
        SHR_RANGE_VERIFY(8, 0, DNXF_DATA_MAX_PORT_PLL_NOF_CONFIG_WORDS, _SHR_E_INTERNAL, "out of bound access to array")
    ...
    if (DNXC_SERDES_REF_CLOCK_125 < table->keys[0].size && DNXC_SERDES_REF_CLOCK_312_5 < table->keys[1].size)
    {
        data = (dnxf_data_port_pll_config_t *) dnxc_data_mgmt_table_data_get(unit, table, DNXC_SERDES_REF_CLOCK_125, DNXC_SERDES_REF_CLOCK_312_5);
        SHR_RANGE_VERIFY(8, 0, DNXF_DATA_MAX_PORT_PLL_NOF_CONFIG_WORDS, _SHR_E_INTERNAL, "out of bound access to array")
        data->data[0] = 0x00000000;
    ...
    if (DNXC_SERDES_REF_CLOCK_156_25 < table->keys[0].size && DNXC_SERDES_REF_CLOCK_156_25 < table->keys[1].size)
    {
        data = (dnxf_data_port_pll_config_t *) dnxc_data_mgmt_table_data_get(unit, table, DNXC_SERDES_REF_CLOCK_156_25, DNXC_SERDES_REF_CLOCK_156_25);
        SHR_RANGE_VERIFY(8, 0, DNXF_DATA_MAX_PORT_PLL_NOF_CONFIG_WORDS, _SHR_E_INTERNAL, "out of bound access to array")
        data->data[0] = 0x00000000;
        data->data[1] = 0x28000000;
        data->data[2] = 0x01c14000;
    ...
    if (DNXC_SERDES_REF_CLOCK_156_25 < table->keys[0].size && DNXC_SERDES_REF_CLOCK_312_5 < table->keys[1].size)
    {
        data = (dnxf_data_port_pll_config_t *) dnxc_data_mgmt_table_data_get(unit, table, DNXC_SERDES_REF_CLOCK_156_25, DNXC_SERDES_REF_CLOCK_312_5);
        SHR_RANGE_VERIFY(8, 0, DNXF_DATA_MAX_PORT_PLL_NOF_CONFIG_WORDS, _SHR_E_INTERNAL, "out of bound access to array")
        data->data[0] = 0x00000000;
        data->data[1] = 0x14000000;
        data->data[2] = 0x01c14000;
    ...
    if (DNXC_SERDES_REF_CLOCK_156_25 < table->keys[0].size && DNXC_SERDES_REF_CLOCK_BYPASS < table->keys[1].size)
    {
        data = (dnxf_data_port_pll_config_t *) dnxc_data_mgmt_table_data_get(unit, table, DNXC_SERDES_REF_CLOCK_156_25, DNXC_SERDES_REF_CLOCK_BYPASS);
        SHR_RANGE_VERIFY(8, 0, DNXF_DATA_MAX_PORT_PLL_NOF_CONFIG_WORDS, _SHR_E_INTERNAL, "out of bound access to array")
        data->data[0] = 0x00000000;
        data->data[1] = 0x14000000;
        data->data[2] = 0x01c14000;
    ...
    if (DNXC_SERDES_REF_CLOCK_312_5 < table->keys[0].size && DNXC_SERDES_REF_CLOCK_156_25 < table->keys[1].size)
    {
        data = (dnxf_data_port_pll_config_t *) dnxc_data_mgmt_table_data_get(unit, table, DNXC_SERDES_REF_CLOCK_312_5, DNXC_SERDES_REF_CLOCK_156_25);
        SHR_RANGE_VERIFY(8, 0, DNXF_DATA_MAX_PORT_PLL_NOF_CONFIG_WORDS, _SHR_E_INTERNAL, "out of bound access to array")
        data->data[0] = 0x00000000;
        data->data[1] = 0x28000000;
        data->data[2] = 0x01c14000;
    ...
    if (DNXC_SERDES_REF_CLOCK_312_5 < table->keys[0].size && DNXC_SERDES_REF_CLOCK_312_5 < table->keys[1].size)
    {
        data = (dnxf_data_port_pll_config_t *) dnxc_data_mgmt_table_data_get(unit, table, DNXC_SERDES_REF_CLOCK_312_5, DNXC_SERDES_REF_CLOCK_312_5);
        SHR_RANGE_VERIFY(8, 0, DNXF_DATA_MAX_PORT_PLL_NOF_CONFIG_WORDS, _SHR_E_INTERNAL, "out of bound access to array")
        data->data[0] = 0x00000000;
        data->data[1] = 0x14000000;
        data->data[2] = 0x01c14000;
    ...
    if (DNXC_SERDES_REF_CLOCK_312_5 < table->keys[0].size && DNXC_SERDES_REF_CLOCK_BYPASS < table->keys[1].size)
    {
        data = (dnxf_data_port_pll_config_t *) dnxc_data_mgmt_table_data_get(unit, table, DNXC_SERDES_REF_CLOCK_312_5, DNXC_SERDES_REF_CLOCK_BYPASS);
        SHR_RANGE_VERIFY(8, 0, DNXF_DATA_MAX_PORT_PLL_NOF_CONFIG_WORDS, _SHR_E_INTERNAL, "out of bound access to array")
        data->data[0] = 0x00000000;
        data->data[1] = 0x14000000;
        data->data[2] = 0x01c14000;
...
static shr_error_e
ramon_a0_dnxf_data_port_synce_multi_set_is_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnxf_data_module_port;
    int submodule_index = dnxf_data_port_submodule_synce;
    int feature_index = dnxf_data_port_synce_multi_set_is_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_port_synce_fabric_div_min_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_port;
    int submodule_index = dnxf_data_port_submodule_synce;
    int define_index = dnxf_data_port_synce_define_fabric_div_min;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_port_synce_fabric_div_max_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_port;
    int submodule_index = dnxf_data_port_submodule_synce;
    int define_index = dnxf_data_port_synce_define_fabric_div_max;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_port_regression_is_cell_format_set_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnxf_data_module_port;
    int submodule_index = dnxf_data_port_submodule_regression;
    int feature_index = dnxf_data_port_regression_is_cell_format_set_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_port_regression_is_power_measurement_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnxf_data_module_port;
    int submodule_index = dnxf_data_port_submodule_regression;
    int feature_index = dnxf_data_port_regression_is_power_measurement_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_port_regression_is_hist_errcnt_thresh_used_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnxf_data_module_port;
    int submodule_index = dnxf_data_port_submodule_regression;
    int feature_index = dnxf_data_port_regression_is_hist_errcnt_thresh_used;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnxf_data_port_general_define_nof_ber_proj_error_analyzer_counters;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_port_general_nof_ber_proj_error_analyzer_counters_set;
    ...
    data_index = dnxf_data_port_general_bw_update;
    feature = &submodule->features[data_index];
    feature->set = ramon_a0_dnxf_data_port_general_bw_update_set;
    data_index = dnxf_data_port_general_is_connection_to_repeater_supported;
    feature = &submodule->features[data_index];
    feature->set = ramon_a0_dnxf_data_port_general_is_connection_to_repeater_supported_set;
    data_index = dnxf_data_port_general_fmac_only_disable_supported;
    feature = &submodule->features[data_index];
    feature->set = ramon_a0_dnxf_data_port_general_fmac_only_disable_supported_set;
    data_index = dnxf_data_port_general_max_speed_api_supported;
    feature = &submodule->features[data_index];
    feature->set = ramon_a0_dnxf_data_port_general_max_speed_api_supported_set;
    data_index = dnxf_data_port_general_fec_ber_proj_supported;
    feature = &submodule->features[data_index];
    feature->set = ramon_a0_dnxf_data_port_general_fec_ber_proj_supported_set;
    data_index = dnxf_data_port_general_port_selective_set_api_supported;
    feature = &submodule->features[data_index];
    feature->set = ramon_a0_dnxf_data_port_general_port_selective_set_api_supported_set;
    data_index = dnxf_data_port_general_is_phy_rx_taps_supported;
    feature = &submodule->features[data_index];
    feature->set = ramon_a0_dnxf_data_port_general_is_phy_rx_taps_supported_set;
    data_index = dnxf_data_port_general_is_scrambling_disable_supported;
    feature = &submodule->features[data_index];
    feature->set = ramon_a0_dnxf_data_port_general_is_scrambling_disable_supported_set;

    
    data_index = dnxf_data_port_general_table_supported_lanes;
    table = &submodule->tables[data_index];
    table->set = ramon_a0_dnxf_data_port_general_supported_lanes_set;
    data_index = dnxf_data_port_general_table_fmac_bus_size;
    table = &submodule->tables[data_index];
    table->set = ramon_a0_dnxf_data_port_general_fmac_bus_size_set;
    data_index = dnxf_data_port_general_table_supported_interfaces;
    table = &submodule->tables[data_index];
    table->set = ramon_a0_dnxf_data_port_general_supported_interfaces_set;
    data_index = dnxf_data_port_general_table_default_fec;
    table = &submodule->tables[data_index];
    table->set = ramon_a0_dnxf_data_port_general_default_fec_set;
    data_index = dnxf_data_port_general_table_supported_fec_controls;
    table = &submodule->tables[data_index];
    table->set = ramon_a0_dnxf_data_port_general_supported_fec_controls_set;
    data_index = dnxf_data_port_general_table_fec_compensation_info;
    table = &submodule->tables[data_index];
    table->set = ramon_a0_dnxf_data_port_general_fec_compensation_info_set;
    data_index = dnxf_data_port_general_table_phy_controls_features;
    table = &submodule->tables[data_index];
    table->set = ramon_a0_dnxf_data_port_general_phy_controls_features_set;
    ...
    data_index = dnxf_data_port_stat_define_thread_flags;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_port_stat_thread_flags_set;
    ...
    data_index = dnxf_data_port_lane_map_is_flexible_link_mapping_supported;
    feature = &submodule->features[data_index];
    feature->set = ramon_a0_dnxf_data_port_lane_map_is_flexible_link_mapping_supported_set;
    ...
    data_index = dnxf_data_port_pll_table_force_single_pll;
    table = &submodule->tables[data_index];
    table->set = ramon_a0_dnxf_data_port_pll_force_single_pll_set;
    ...
    data_index = dnxf_data_port_synce_define_fabric_div_min;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_port_synce_fabric_div_min_set;
    data_index = dnxf_data_port_synce_define_fabric_div_max;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_port_synce_fabric_div_max_set;

    
    data_index = dnxf_data_port_synce_multi_set_is_supported;
    feature = &submodule->features[data_index];
    feature->set = ramon_a0_dnxf_data_port_synce_multi_set_is_supported_set;
    ...
    submodule_index = dnxf_data_port_submodule_regression;
    submodule = &module->submodules[submodule_index];

    

    
    data_index = dnxf_data_port_regression_is_cell_format_set_supported;
    feature = &submodule->features[data_index];
    feature->set = ramon_a0_dnxf_data_port_regression_is_cell_format_set_supported_set;
    data_index = dnxf_data_port_regression_is_power_measurement_supported;
    feature = &submodule->features[data_index];
    feature->set = ramon_a0_dnxf_data_port_regression_is_power_measurement_supported_set;
    data_index = dnxf_data_port_regression_is_hist_errcnt_thresh_used;
    feature = &submodule->features[data_index];
    feature->set = ramon_a0_dnxf_data_port_regression_is_hist_errcnt_thresh_used_set;
