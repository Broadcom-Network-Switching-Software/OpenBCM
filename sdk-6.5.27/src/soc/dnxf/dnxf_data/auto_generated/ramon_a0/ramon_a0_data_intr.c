...
static shr_error_e
ramon_a0_dnxf_data_intr_general_soft_init_for_debug_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnxf_data_module_intr;
    int submodule_index = dnxf_data_intr_submodule_general;
    int feature_index = dnxf_data_intr_general_soft_init_for_debug;
    ...
    int unit)
{
    ...
    data_index = dnxf_data_intr_general_soft_init_for_debug;
    feature = &submodule->features[data_index];
    feature->set = ramon_a0_dnxf_data_intr_general_soft_init_for_debug_set;
