...
static shr_error_e
ramon_a0_dnxf_data_fabric_multicast_static_mode_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnxf_data_module_fabric;
    int submodule_index = dnxf_data_fabric_submodule_multicast;
    int feature_index = dnxf_data_fabric_multicast_static_mode_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_fabric_fifo_dma_fabric_cell_nof_entries_per_cell_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_fabric;
    int submodule_index = dnxf_data_fabric_submodule_fifo_dma;
    int define_index = dnxf_data_fabric_fifo_dma_define_fabric_cell_nof_entries_per_cell;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_fabric_fifo_dma_nof_channels_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_fabric;
    int submodule_index = dnxf_data_fabric_submodule_fifo_dma;
    int define_index = dnxf_data_fabric_fifo_dma_define_nof_channels;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_fabric_fifo_dma_entry_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_fabric;
    int submodule_index = dnxf_data_fabric_submodule_fifo_dma;
    int define_index = dnxf_data_fabric_fifo_dma_define_entry_size;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_fabric_fifo_dma_max_nof_entries_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_fabric;
    int submodule_index = dnxf_data_fabric_submodule_fifo_dma;
    int define_index = dnxf_data_fabric_fifo_dma_define_max_nof_entries;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_fabric_fifo_dma_min_nof_entries_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_fabric;
    int submodule_index = dnxf_data_fabric_submodule_fifo_dma;
    int define_index = dnxf_data_fabric_fifo_dma_define_min_nof_entries;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_fabric_fifo_dma_enable_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_fabric;
    int submodule_index = dnxf_data_fabric_submodule_fifo_dma;
    int define_index = dnxf_data_fabric_fifo_dma_define_enable;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_fabric_fifo_dma_buffer_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_fabric;
    int submodule_index = dnxf_data_fabric_submodule_fifo_dma;
    int define_index = dnxf_data_fabric_fifo_dma_define_buffer_size;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_fabric_fifo_dma_threshold_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_fabric;
    int submodule_index = dnxf_data_fabric_submodule_fifo_dma;
    int define_index = dnxf_data_fabric_fifo_dma_define_threshold;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_fabric_fifo_dma_timeout_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_fabric;
    int submodule_index = dnxf_data_fabric_submodule_fifo_dma;
    int define_index = dnxf_data_fabric_fifo_dma_define_timeout;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnxf_data_fabric_multicast_static_mode_supported;
    feature = &submodule->features[data_index];
    feature->set = ramon_a0_dnxf_data_fabric_multicast_static_mode_supported_set;
    ...
    submodule_index = dnxf_data_fabric_submodule_fifo_dma;
    submodule = &module->submodules[submodule_index];

    
    data_index = dnxf_data_fabric_fifo_dma_define_fabric_cell_nof_entries_per_cell;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_fabric_fifo_dma_fabric_cell_nof_entries_per_cell_set;
    data_index = dnxf_data_fabric_fifo_dma_define_nof_channels;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_fabric_fifo_dma_nof_channels_set;
    data_index = dnxf_data_fabric_fifo_dma_define_entry_size;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_fabric_fifo_dma_entry_size_set;
    data_index = dnxf_data_fabric_fifo_dma_define_max_nof_entries;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_fabric_fifo_dma_max_nof_entries_set;
    data_index = dnxf_data_fabric_fifo_dma_define_min_nof_entries;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_fabric_fifo_dma_min_nof_entries_set;
    data_index = dnxf_data_fabric_fifo_dma_define_enable;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_fabric_fifo_dma_enable_set;
    data_index = dnxf_data_fabric_fifo_dma_define_buffer_size;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_fabric_fifo_dma_buffer_size_set;
    data_index = dnxf_data_fabric_fifo_dma_define_threshold;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_fabric_fifo_dma_threshold_set;
    data_index = dnxf_data_fabric_fifo_dma_define_timeout;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_fabric_fifo_dma_timeout_set;

    

    
    
    submodule_index = dnxf_data_fabric_submodule_rxtx;
    submodule = &module->submodules[submodule_index];
