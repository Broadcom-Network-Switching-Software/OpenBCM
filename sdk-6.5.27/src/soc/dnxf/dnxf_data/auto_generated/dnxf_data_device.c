    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnxf_data_device_general_fabric_advanced_power_down].name = "fabric_advanced_power_down";
    submodule_data->features[dnxf_data_device_general_fabric_advanced_power_down].doc = "";
    submodule_data->features[dnxf_data_device_general_fabric_advanced_power_down].flags |= DNXC_DATA_F_FEATURE;
    ...
    submodule_data->defines[dnxf_data_device_general_define_nof_main_monitors].name = "nof_main_monitors";
    submodule_data->defines[dnxf_data_device_general_define_nof_main_monitors].doc = "";
    
    submodule_data->defines[dnxf_data_device_general_define_nof_main_monitors].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->tables[dnxf_data_device_general_table_ctest_full_file_indentifier].values[0].doc = "";
    ...
    submodule_data->tables[dnxf_data_device_general_table_ctest_full_file_indentifier].values[1].doc = "";
...
uint32
dnxf_data_device_general_nof_main_monitors_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnxf_data_module_device, dnxf_data_device_submodule_general, dnxf_data_device_general_define_nof_main_monitors);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_override].values[0].doc = "";
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_override].values[1].doc = "";
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_override].values[2].doc = "";
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_fsrd_sbus_chain].values[0].doc = "";
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_fmac_sbus_chain].values[0].doc = "";
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_fmac_lane_to_block_map].values[0].doc = "";
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_dch_instances_to_device_stage].values[0].doc = "";
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_rtp].nof_values = 4;
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_rtp].values[0].doc = "";
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_rtp].values[1].doc = "";
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_rtp].values[2].name = "clock_field";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_rtp].values[2].type = "int";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_rtp].values[2].doc = "";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_rtp].values[2].offset = UTILEX_OFFSETOF(dnxf_data_device_blocks_power_down_per_rtp_t, clock_field);
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_rtp].values[3].name = "soft_init_fields";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_rtp].values[3].type = "uint32[DNXF_DATA_MAX_DEVICE_BLOCKS_NOF_INSTANCES_RTP]";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_rtp].values[3].doc = "";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_rtp].values[3].offset = UTILEX_OFFSETOF(dnxf_data_device_blocks_power_down_per_rtp_t, soft_init_fields);
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dch].nof_values = 4;
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dch].values[0].doc = "";
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dch].values[1].doc = "";
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dch].values[2].name = "clock_field";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dch].values[2].type = "int";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dch].values[2].doc = "";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dch].values[2].offset = UTILEX_OFFSETOF(dnxf_data_device_blocks_power_down_per_dch_t, clock_field);
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dch].values[3].name = "soft_init_fields";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dch].values[3].type = "uint32[DNXF_DATA_MAX_DEVICE_BLOCKS_NOF_INSTANCES_DCH]";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dch].values[3].doc = "";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dch].values[3].offset = UTILEX_OFFSETOF(dnxf_data_device_blocks_power_down_per_dch_t, soft_init_fields);
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_fmac].nof_values = 4;
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_fmac].values[0].doc = "";
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_fmac].values[1].doc = "";
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_fmac].values[2].name = "clock_field";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_fmac].values[2].type = "int";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_fmac].values[2].doc = "";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_fmac].values[2].offset = UTILEX_OFFSETOF(dnxf_data_device_blocks_power_down_per_fmac_t, clock_field);
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_fmac].values[3].name = "soft_init_fields";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_fmac].values[3].type = "uint32[DNXF_DATA_MAX_DEVICE_BLOCKS_NOF_INSTANCES_FMAC]";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_fmac].values[3].doc = "";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_fmac].values[3].offset = UTILEX_OFFSETOF(dnxf_data_device_blocks_power_down_per_fmac_t, soft_init_fields);
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dfl_fbc].nof_values = 4;
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dfl_fbc].values[0].doc = "";
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dfl_fbc].values[1].doc = "";
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dfl_fbc].values[2].name = "clock_field";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dfl_fbc].values[2].type = "int";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dfl_fbc].values[2].doc = "";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dfl_fbc].values[2].offset = UTILEX_OFFSETOF(dnxf_data_device_blocks_power_down_per_dfl_fbc_t, clock_field);
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dfl_fbc].values[3].name = "soft_init_fields";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dfl_fbc].values[3].type = "uint32[DNXF_DATA_MAX_DEVICE_BLOCKS_NOF_LINKS_IN_DCH]";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dfl_fbc].values[3].doc = "";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dfl_fbc].values[3].offset = UTILEX_OFFSETOF(dnxf_data_device_blocks_power_down_per_dfl_fbc_t, soft_init_fields);
    ...
    int value_index)
{
    ...
    switch (value_index)
    {
        ...
        case 1:
            ...
            break;
        case 2:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->clock_field);
            break;
        case 3:
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->nof_features = _dnxf_data_device_vtmon_feature_nof;
    DNXC_DATA_ALLOC(submodule_data->features, dnxc_data_feature_t,  submodule_data->nof_features, "_dnxc_data device vtmon features");

    submodule_data->features[dnxf_data_device_vtmon_remote_temp_sensors_supported].name = "remote_temp_sensors_supported";
    submodule_data->features[dnxf_data_device_vtmon_remote_temp_sensors_supported].doc = "";
    submodule_data->features[dnxf_data_device_vtmon_remote_temp_sensors_supported].flags |= DNXC_DATA_F_FEATURE;

    
    submodule_data->nof_defines = _dnxf_data_device_vtmon_define_nof;
    DNXC_DATA_ALLOC(submodule_data->defines, dnxc_data_define_t, submodule_data->nof_defines, "_dnxc_data device vtmon defines");

    submodule_data->defines[dnxf_data_device_vtmon_define_vol_factor].name = "vol_factor";
    submodule_data->defines[dnxf_data_device_vtmon_define_vol_factor].doc = "";
    
    submodule_data->defines[dnxf_data_device_vtmon_define_vol_factor].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnxf_data_device_vtmon_define_vol_multiple].name = "vol_multiple";
    submodule_data->defines[dnxf_data_device_vtmon_define_vol_multiple].doc = "";
    
    submodule_data->defines[dnxf_data_device_vtmon_define_vol_multiple].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnxf_data_device_vtmon_define_vol_divisor].name = "vol_divisor";
    submodule_data->defines[dnxf_data_device_vtmon_define_vol_divisor].doc = "";
    
    submodule_data->defines[dnxf_data_device_vtmon_define_vol_divisor].flags |= DNXC_DATA_F_DEFINE;

    
    submodule_data->nof_tables = _dnxf_data_device_vtmon_table_nof;
    DNXC_DATA_ALLOC(submodule_data->tables, dnxc_data_table_t, submodule_data->nof_tables, "_dnxc_data device vtmon tables");

    
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].name = "vtmon_access";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].doc = "";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].size_of_values = sizeof(dnxf_data_device_vtmon_vtmon_access_t);
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].entry_get = dnxf_data_device_vtmon_vtmon_access_entry_str_get;

    
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].nof_keys = 1;
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].keys[0].name = "index";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].keys[0].doc = "";

    
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].nof_values = 15;
    DNXC_DATA_ALLOC(submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values, dnxc_data_value_t, submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].nof_values, "_dnxf_data_device_vtmon_table_vtmon_access table values");
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[0].name = "name";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[0].type = "char *";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[0].doc = "";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[0].offset = UTILEX_OFFSETOF(dnxf_data_device_vtmon_vtmon_access_t, name);
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[1].name = "control_reg";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[1].type = "int";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[1].doc = "";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[1].offset = UTILEX_OFFSETOF(dnxf_data_device_vtmon_vtmon_access_t, control_reg);
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[2].name = "lock_bit";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[2].type = "int";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[2].doc = "";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[2].offset = UTILEX_OFFSETOF(dnxf_data_device_vtmon_vtmon_access_t, lock_bit);
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[3].name = "remote_sensor_supported";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[3].type = "int";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[3].doc = "";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[3].offset = UTILEX_OFFSETOF(dnxf_data_device_vtmon_vtmon_access_t, remote_sensor_supported);
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[4].name = "vtmon_sel_field";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[4].type = "uint32";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[4].doc = "";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[4].offset = UTILEX_OFFSETOF(dnxf_data_device_vtmon_vtmon_access_t, vtmon_sel_field);
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[5].name = "peak_data_clear_field";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[5].type = "int";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[5].doc = "";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[5].offset = UTILEX_OFFSETOF(dnxf_data_device_vtmon_vtmon_access_t, peak_data_clear_field);
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[6].name = "temp_mon_sel";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[6].type = "int";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[6].doc = "";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[6].offset = UTILEX_OFFSETOF(dnxf_data_device_vtmon_vtmon_access_t, temp_mon_sel);
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[7].name = "data_reg";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[7].type = "int";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[7].doc = "";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[7].offset = UTILEX_OFFSETOF(dnxf_data_device_vtmon_vtmon_access_t, data_reg);
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[8].name = "thermal_data_field";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[8].type = "int";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[8].doc = "";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[8].offset = UTILEX_OFFSETOF(dnxf_data_device_vtmon_vtmon_access_t, thermal_data_field);
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[9].name = "peak_data_field";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[9].type = "int";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[9].doc = "";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[9].offset = UTILEX_OFFSETOF(dnxf_data_device_vtmon_vtmon_access_t, peak_data_field);
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[10].name = "block_instance";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[10].type = "int";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[10].doc = "";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[10].offset = UTILEX_OFFSETOF(dnxf_data_device_vtmon_vtmon_access_t, block_instance);
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[11].name = "voltage_sensing";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[11].type = "int";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[11].doc = "";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[11].offset = UTILEX_OFFSETOF(dnxf_data_device_vtmon_vtmon_access_t, voltage_sensing);
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[12].name = "vdd_sel";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[12].type = "uint32";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[12].doc = "";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[12].offset = UTILEX_OFFSETOF(dnxf_data_device_vtmon_vtmon_access_t, vdd_sel);
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[13].name = "vss_sel";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[13].type = "uint32";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[13].doc = "";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[13].offset = UTILEX_OFFSETOF(dnxf_data_device_vtmon_vtmon_access_t, vss_sel);
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[14].name = "voltage_bit";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[14].type = "int";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[14].doc = "";
    submodule_data->tables[dnxf_data_device_vtmon_table_vtmon_access].values[14].offset = UTILEX_OFFSETOF(dnxf_data_device_vtmon_vtmon_access_t, voltage_bit);
...
int
dnxf_data_device_vtmon_feature_get(
    int unit,
    dnxf_data_device_vtmon_feature_e feature)
{
    return dnxc_data_mgmt_feature_data_get(unit, dnxf_data_module_device, dnxf_data_device_submodule_vtmon, feature);
}


uint32
dnxf_data_device_vtmon_vol_factor_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnxf_data_module_device, dnxf_data_device_submodule_vtmon, dnxf_data_device_vtmon_define_vol_factor);
}

uint32
dnxf_data_device_vtmon_vol_multiple_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnxf_data_module_device, dnxf_data_device_submodule_vtmon, dnxf_data_device_vtmon_define_vol_multiple);
}

uint32
dnxf_data_device_vtmon_vol_divisor_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnxf_data_module_device, dnxf_data_device_submodule_vtmon, dnxf_data_device_vtmon_define_vol_divisor);
}



const dnxf_data_device_vtmon_vtmon_access_t *
dnxf_data_device_vtmon_vtmon_access_get(
    int unit,
    int index)
{
    char *data;
    ...
    table = dnxc_data_mgmt_table_get(unit, dnxf_data_module_device, dnxf_data_device_submodule_vtmon, dnxf_data_device_vtmon_table_vtmon_access);
    
    data = dnxc_data_mgmt_table_data_get(unit, table, index, 0);
    return (const dnxf_data_device_vtmon_vtmon_access_t *) data;

}


shr_error_e
dnxf_data_device_vtmon_vtmon_access_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnxf_data_device_vtmon_vtmon_access_t *data;
    SHR_FUNC_INIT_VARS(unit);

    
    table = dnxc_data_mgmt_table_get(unit, dnxf_data_module_device, dnxf_data_device_submodule_vtmon, dnxf_data_device_vtmon_table_vtmon_access);
    data = (const dnxf_data_device_vtmon_vtmon_access_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
        ...
        case 11:
            ...
            break;
        case 12:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->vdd_sel);
            break;
        case 13:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->vss_sel);
            break;
        case 14:
...
const dnxc_data_table_info_t *
dnxf_data_device_vtmon_vtmon_access_info_get(
    int unit)
{

    
    return dnxc_data_mgmt_table_info_get(unit, dnxf_data_module_device, dnxf_data_device_submodule_vtmon, dnxf_data_device_vtmon_table_vtmon_access);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnxf_data_device_properties_table_unsupported].values[0].doc = "";
    ...
    submodule_data->tables[dnxf_data_device_properties_table_unsupported].values[1].doc = "";
    ...
    submodule_data->tables[dnxf_data_device_properties_table_unsupported].values[2].doc = "";
    ...
    submodule_data->tables[dnxf_data_device_properties_table_unsupported].values[3].doc = "";
    ...
    submodule_data->tables[dnxf_data_device_properties_table_unsupported].values[4].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->nof_features = _dnxf_data_device_docs_feature_nof;
    DNXC_DATA_ALLOC(submodule_data->features, dnxc_data_feature_t,  submodule_data->nof_features, "_dnxc_data device docs features");

    submodule_data->features[dnxf_data_device_docs_is_fap].name = "is_fap";
    submodule_data->features[dnxf_data_device_docs_is_fap].doc = "";
    submodule_data->features[dnxf_data_device_docs_is_fap].flags |= DNXC_DATA_F_FEATURE;

    
    submodule_data->nof_defines = _dnxf_data_device_docs_define_nof;
    DNXC_DATA_ALLOC(submodule_data->defines, dnxc_data_define_t, submodule_data->nof_defines, "_dnxc_data device docs defines");

    
    submodule_data->nof_tables = _dnxf_data_device_docs_table_nof;
...
int
dnxf_data_device_docs_feature_get(
    int unit,
    dnxf_data_device_docs_feature_e feature)
{
    return dnxc_data_mgmt_feature_data_get(unit, dnxf_data_module_device, dnxf_data_device_submodule_docs, feature);
}
    ...
    dnxc_data_module_t *module_data)
{
    ...
    SHR_IF_ERR_EXIT(dnxf_data_device_vtmon_init(unit, &module_data->submodules[dnxf_data_device_submodule_vtmon]));
    ...
    SHR_IF_ERR_EXIT(dnxf_data_device_docs_init(unit, &module_data->submodules[dnxf_data_device_submodule_docs]));
