        ...
        if (size) {
            ...
            switch (mem) {
                case SOC_ISM_MEM_VLAN_XLATE:
                    SOP_MEM_STATE_MAX_INDEX_GET(unit, VLAN_XLATEm, index_max_mem);
                    index_max_mem += (size * 2);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, VLAN_XLATEm, index_max_mem);

                    SOP_MEM_STATE_MAX_INDEX_GET(unit, VLAN_XLATE_1m, index_max_mem);
                    index_max_mem += (size * 2);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, VLAN_XLATE_1m, index_max_mem);

                    SOP_MEM_STATE_MAX_INDEX_GET(unit, VLAN_XLATE_1_HIT_ONLYm, index_max_mem);
                    index_max_mem += (size * 2);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, VLAN_XLATE_1_HIT_ONLYm, index_max_mem);

                    SOP_MEM_STATE_MAX_INDEX_GET(unit, VLAN_XLATE_EXTDm, index_max_mem);
                    index_max_mem += size;
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, VLAN_XLATE_EXTDm, index_max_mem);

                    SOP_MEM_STATE_MAX_INDEX_GET(unit, VLAN_XLATE_2_HIT_ONLYm, index_max_mem);
                    index_max_mem += size;
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, VLAN_XLATE_2_HIT_ONLYm, index_max_mem);
                    break;
                case SOC_ISM_MEM_L2_ENTRY:
                    SOP_MEM_STATE_MAX_INDEX_GET(unit, L2_ENTRY_1m, index_max_mem);
                    index_max_mem += (size * 2);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, L2_ENTRY_1m, index_max_mem);

                    SOP_MEM_STATE_MAX_INDEX_GET(unit, L2_ENTRY_1_HIT_ONLYm, index_max_mem);
                    index_max_mem += (size * 2);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, L2_ENTRY_1_HIT_ONLYm, index_max_mem);

                    SOP_MEM_STATE_MAX_INDEX_GET(unit, L2_ENTRY_2m, index_max_mem);
                    index_max_mem += size;
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, L2_ENTRY_2m, index_max_mem);

                    SOP_MEM_STATE_MAX_INDEX_GET(unit, L2_ENTRY_2_HIT_ONLYm, index_max_mem);
                    index_max_mem += size;
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, L2_ENTRY_2_HIT_ONLYm, index_max_mem);
                    break;
                case SOC_ISM_MEM_L3_ENTRY:
                    SOP_MEM_STATE_MAX_INDEX_GET(unit, L3_ENTRY_1m, index_max_mem);
                    index_max_mem += (size * 4);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_1m, index_max_mem);

                    SOP_MEM_STATE_MAX_INDEX_GET(unit, L3_ENTRY_1_HIT_ONLYm, index_max_mem);
                    index_max_mem += (size * 4);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_1_HIT_ONLYm, index_max_mem);

                    SOP_MEM_STATE_MAX_INDEX_GET(unit, L3_ENTRY_2m, index_max_mem);
                    index_max_mem += (size * 2);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_2m, index_max_mem);

                    SOP_MEM_STATE_MAX_INDEX_GET(unit, L3_ENTRY_2_HIT_ONLYm, index_max_mem);
                    index_max_mem += (size * 2);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_2_HIT_ONLYm, index_max_mem);

                    SOP_MEM_STATE_MAX_INDEX_GET(unit, L3_ENTRY_4m, index_max_mem);
                    index_max_mem += size;
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_4m, index_max_mem);

                    SOP_MEM_STATE_MAX_INDEX_GET(unit, L3_ENTRY_4_HIT_ONLYm, index_max_mem);
                    index_max_mem += size;
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_4_HIT_ONLYm, index_max_mem);
                    break;
                case SOC_ISM_MEM_EP_VLAN_XLATE:
                    SOP_MEM_STATE_MAX_INDEX_GET(unit, EGR_VLAN_XLATEm, index_max_mem);
                    index_max_mem += size;
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_VLAN_XLATEm, index_max_mem);

                    SOP_MEM_STATE_MAX_INDEX_GET(unit, EP_VLAN_XLATE_1m, index_max_mem);
                    index_max_mem += size;
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, EP_VLAN_XLATE_1m, index_max_mem);

                    SOP_MEM_STATE_MAX_INDEX_GET(unit, EP_VLAN_XLATE_1_HIT_ONLYm, index_max_mem);
                    index_max_mem += size;
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, EP_VLAN_XLATE_1_HIT_ONLYm, index_max_mem);
                    break;
                case SOC_ISM_MEM_MPLS:
                    SOP_MEM_STATE_MAX_INDEX_GET(unit, MPLS_ENTRYm, index_max_mem);
                    index_max_mem += (size * 2);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, MPLS_ENTRYm, index_max_mem);

                    SOP_MEM_STATE_MAX_INDEX_GET(unit, MPLS_ENTRY_1m, index_max_mem);
                    index_max_mem += (size * 2);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, MPLS_ENTRY_1m, index_max_mem);

                    SOP_MEM_STATE_MAX_INDEX_GET(unit, MPLS_ENTRY_1_HIT_ONLYm, index_max_mem);
                    index_max_mem += (size * 2);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, MPLS_ENTRY_1_HIT_ONLYm, index_max_mem);

                    SOP_MEM_STATE_MAX_INDEX_GET(unit, MPLS_ENTRY_EXTDm, index_max_mem);
                    index_max_mem += size;
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, MPLS_ENTRY_EXTDm, index_max_mem);

                    SOP_MEM_STATE_MAX_INDEX_GET(unit, MPLS_ENTRY_2_HIT_ONLYm, index_max_mem);
                    index_max_mem += size;
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, MPLS_ENTRY_2_HIT_ONLYm, index_max_mem);
                    break;
...
soc_ism_mem_config(int unit, soc_ism_mem_size_config_t *mem_cfg, int count)
{
    ...
    SOP_MEM_STATE_MAX_INDEX_SET(unit, VLAN_XLATE_1m, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, VLAN_XLATE_1_HIT_ONLYm, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, VLAN_XLATE_EXTDm, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, VLAN_XLATE_2_HIT_ONLYm, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L2_ENTRY_1m, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L2_ENTRY_1_HIT_ONLYm, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L2_ENTRY_2m, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L2_ENTRY_2_HIT_ONLYm, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_1m, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_1_HIT_ONLYm, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_2m, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_2_HIT_ONLYm, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_4m, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_4_HIT_ONLYm, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_VLAN_XLATEm, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EP_VLAN_XLATE_1m, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, EP_VLAN_XLATE_1_HIT_ONLYm, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MPLS_ENTRYm, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MPLS_ENTRY_1m, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MPLS_ENTRY_1_HIT_ONLYm, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MPLS_ENTRY_EXTDm, -1);
    SOP_MEM_STATE_MAX_INDEX_SET(unit, MPLS_ENTRY_2_HIT_ONLYm, -1);
...
next_mem:
            ...
            switch (mem) {
                case SOC_ISM_MEM_VLAN_XLATE:
                    SOP_MEM_STATE_MAX_INDEX_GET(unit, VLAN_XLATEm, index_max);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, VLAN_XLATEm, index_max + size * 2);
                    SOP_MEM_STATE_MAX_INDEX_GET(unit, VLAN_XLATE_1m, index_max);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, VLAN_XLATE_1m, index_max + size * 2);
                    SOP_MEM_STATE_MAX_INDEX_GET(unit, VLAN_XLATE_1_HIT_ONLYm, index_max);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, VLAN_XLATE_1_HIT_ONLYm, index_max + size * 2);
                    SOP_MEM_STATE_MAX_INDEX_GET(unit, VLAN_XLATE_EXTDm, index_max);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, VLAN_XLATE_EXTDm, index_max + size);
                    SOP_MEM_STATE_MAX_INDEX_GET(unit, VLAN_XLATE_2_HIT_ONLYm, index_max);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, VLAN_XLATE_2_HIT_ONLYm, index_max + size);
                    break;
                case SOC_ISM_MEM_L2_ENTRY:
                    SOP_MEM_STATE_MAX_INDEX_GET(unit, L2_ENTRY_1m, index_max);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, L2_ENTRY_1m, index_max + size * 2);
                    SOP_MEM_STATE_MAX_INDEX_GET(unit, L2_ENTRY_1_HIT_ONLYm, index_max);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, L2_ENTRY_1_HIT_ONLYm, index_max + size * 2);
                    SOP_MEM_STATE_MAX_INDEX_GET(unit, L2_ENTRY_2m, index_max);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, L2_ENTRY_2m, index_max + size);
                    SOP_MEM_STATE_MAX_INDEX_GET(unit, L2_ENTRY_2_HIT_ONLYm, index_max);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, L2_ENTRY_2_HIT_ONLYm, index_max + size);                    break;
                case SOC_ISM_MEM_L3_ENTRY:
                    SOP_MEM_STATE_MAX_INDEX_GET(unit, L3_ENTRY_1m, index_max);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_1m, index_max + size * 4);
                    SOP_MEM_STATE_MAX_INDEX_GET(unit, L3_ENTRY_1_HIT_ONLYm, index_max);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_1_HIT_ONLYm, index_max + size * 4);
                    SOP_MEM_STATE_MAX_INDEX_GET(unit, L3_ENTRY_2m, index_max);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_2m, index_max + size * 2);
                    SOP_MEM_STATE_MAX_INDEX_GET(unit, L3_ENTRY_2_HIT_ONLYm, index_max);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_2_HIT_ONLYm, index_max + size * 2);
                    SOP_MEM_STATE_MAX_INDEX_GET(unit, L3_ENTRY_4m, index_max);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_4m, index_max + size);
                    SOP_MEM_STATE_MAX_INDEX_GET(unit, L3_ENTRY_4_HIT_ONLYm, index_max);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, L3_ENTRY_4_HIT_ONLYm, index_max + size);
                    break;
                case SOC_ISM_MEM_EP_VLAN_XLATE:
                    SOP_MEM_STATE_MAX_INDEX_GET(unit, EGR_VLAN_XLATEm, index_max);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, EGR_VLAN_XLATEm, index_max + size);
                    SOP_MEM_STATE_MAX_INDEX_GET(unit, EP_VLAN_XLATE_1m, index_max);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, EP_VLAN_XLATE_1m, index_max + size);
                    SOP_MEM_STATE_MAX_INDEX_GET(unit, EP_VLAN_XLATE_1_HIT_ONLYm, index_max);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, EP_VLAN_XLATE_1_HIT_ONLYm, index_max + size);
                    break;
                case SOC_ISM_MEM_MPLS:
                    SOP_MEM_STATE_MAX_INDEX_GET(unit, MPLS_ENTRYm, index_max);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, MPLS_ENTRYm, index_max + size * 2);
                    SOP_MEM_STATE_MAX_INDEX_GET(unit, MPLS_ENTRY_1m, index_max);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, MPLS_ENTRY_1m, index_max + size * 2);
                    SOP_MEM_STATE_MAX_INDEX_GET(unit, MPLS_ENTRY_1_HIT_ONLYm, index_max);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, MPLS_ENTRY_1_HIT_ONLYm, index_max + size * 2);
                    SOP_MEM_STATE_MAX_INDEX_GET(unit, MPLS_ENTRY_EXTDm, index_max);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, MPLS_ENTRY_EXTDm, index_max + size);
                    SOP_MEM_STATE_MAX_INDEX_GET(unit, MPLS_ENTRY_2_HIT_ONLYm, index_max);
                    SOP_MEM_STATE_MAX_INDEX_SET(unit, MPLS_ENTRY_2_HIT_ONLYm, index_max + size);
                    break;
                case SOC_ISM_MEM_ESM_L2:
                case SOC_ISM_MEM_ESM_L3:
                case SOC_ISM_MEM_ESM_ACL:
