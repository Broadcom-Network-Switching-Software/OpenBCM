...
#ifdef BCM_ACCESS_SUPPORT
    if ((ACCESS_RUNTIME_INFO(unit) != NULL) && soc_feature(unit, soc_feature_cmicx_gen2)) {
        return access_cmic_intr_enable(unit,  intr);
    }
#endif
...
#ifdef BCM_ACCESS_SUPPORT
    if ((ACCESS_RUNTIME_INFO(unit) != NULL) && soc_feature(unit, soc_feature_cmicx_gen2)) {
        return access_cmic_intr_disable(unit,  intr);
    }
#endif
...
#ifdef BCM_ACCESS_SUPPORT
    if ((ACCESS_RUNTIME_INFO(unit) != NULL) && soc_feature(unit, soc_feature_cmicx_gen2)){
        return access_cmic_intr_dump(unit,  intr);
    }
#endif
...
#ifdef BCM_ACCESS_SUPPORT
    if ((ACCESS_RUNTIME_INFO(unit) != NULL) && soc_feature(unit, soc_feature_cmicx_gen2)){
        return access_cmic_intr_all_enable(unit);
    }
#endif
...
#ifdef BCM_ACCESS_SUPPORT
    if ((ACCESS_RUNTIME_INFO(unit) != NULL) && soc_feature(unit, soc_feature_cmicx_gen2)){
        return access_cmic_intr_all_disable(unit);
    }
#endif
...
#ifdef BCM_ACCESS_SUPPORT
    if ((ACCESS_RUNTIME_INFO(unit) != NULL) && soc_feature(unit, soc_feature_cmicx_gen2)){
        return access_cmic_intr_is_mask(unit,  intr, mask);
    }
#endif
...
#ifdef BCM_ACCESS_SUPPORT
    if ((ACCESS_RUNTIME_INFO(unit) != NULL) && soc_feature(unit, soc_feature_cmicx_gen2)){
        return access_cmic_intr_register(unit,  (access_cmic_intr_handler_t *)handle, size);
    }
#endif
...
soc_cmic_intr_init(int unit)
{
    ...
    if (soc_feature(unit, soc_feature_cmicx_gen2)) {
        ...
        return access_cmic_intr_init(unit, &runtime_info->cmic_intr_op);
    }
#endif
