...
# if defined(BCM_RAVEN_SUPPORT)
...
#ifdef BCM_PETRA_SUPPORT
    {
        ...
        SOC_INFO_CHIP_TYPE_ARADPLUS, "BCM88660_A0",
        ARADPLUS_DEVICE_ID, ARADPLUS_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM88360_DEVICE_ID, BCM88360_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_ARADPLUS, "BCM88360_A0",
        BCM88360_DEVICE_ID, BCM88360_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    ...
    },
    {
        ...
        SOC_INFO_CHIP_TYPE_ARADPLUS, "BCM88361_A0",
        BCM88361_DEVICE_ID, BCM88361_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    ...
    },
    {
        ...
        SOC_INFO_CHIP_TYPE_ARADPLUS, "BCM88363_A0",
        BCM88363_DEVICE_ID, BCM88363_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    ...
    },
    {
        ...
        SOC_INFO_CHIP_TYPE_ARADPLUS, "BCM88460_A0",
        BCM88460_DEVICE_ID, BCM88460_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    ...
    },
    {
        ...
        SOC_INFO_CHIP_TYPE_ARADPLUS, "BCM88461_A0",
        BCM88461_DEVICE_ID, BCM88461_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    ...
    },
    {
        ...
        SOC_INFO_CHIP_TYPE_ARADPLUS, "BCM88560_A0",
        BCM88560_DEVICE_ID, BCM88560_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    ...
    },
    {
        ...
        SOC_INFO_CHIP_TYPE_ARADPLUS, "BCM88561_A0",
        BCM88561_DEVICE_ID, BCM88561_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    ...
    },
     {
        ...
        SOC_INFO_CHIP_TYPE_ARADPLUS, "BCM88562_A0",
        BCM88562_DEVICE_ID, BCM88562_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    ...
    },
    {
        ...
        SOC_INFO_CHIP_TYPE_ARADPLUS, "BCM88661_A0",
        BCM88661_DEVICE_ID, BCM88661_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    ...
    },
    {
        ...
        SOC_INFO_CHIP_TYPE_ARADPLUS, "BCM88664_A0",
        BCM88664_DEVICE_ID, BCM88664_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
...
/* { */
    {
        ...
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88675_A0",
        JERICHO_DEVICE_ID, JERICHO_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        JERICHO_DEVICE_ID, JERICHO_B0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88675_B0",
        JERICHO_DEVICE_ID, JERICHO_B0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        JERICHO_DEVICE_ID, JERICHO_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88675_A1",
        JERICHO_DEVICE_ID, JERICHO_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88670_DEVICE_ID, BCM88670_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88670_A0",
        BCM88670_DEVICE_ID, BCM88670_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88670_DEVICE_ID, BCM88670_B0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88670_B0",
        BCM88670_DEVICE_ID, BCM88670_B0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88670_DEVICE_ID, BCM88670_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88670_A1",
        BCM88670_DEVICE_ID, BCM88670_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88671_DEVICE_ID, BCM88671_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88671_A0",
        BCM88671_DEVICE_ID, BCM88671_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88671_DEVICE_ID, BCM88671_B0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88671_B0",
        BCM88671_DEVICE_ID, BCM88671_B0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88671_DEVICE_ID, BCM88671_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88671_A1",
        BCM88671_DEVICE_ID, BCM88671_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88671M_DEVICE_ID, BCM88671M_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88671M_A0",
        BCM88671M_DEVICE_ID, BCM88671M_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88671M_DEVICE_ID, BCM88671M_B0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88671M_B0",
        BCM88671M_DEVICE_ID, BCM88671M_B0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88671M_DEVICE_ID, BCM88671M_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88671M_A1",
        BCM88671M_DEVICE_ID, BCM88671M_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88672_DEVICE_ID, BCM88672_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88672_A0",
        BCM88672_DEVICE_ID, BCM88672_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88672_DEVICE_ID, BCM88672_B0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88672_B0",
        BCM88672_DEVICE_ID, BCM88672_B0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88672_DEVICE_ID, BCM88672_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88672_A1",
        BCM88672_DEVICE_ID, BCM88672_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88673_DEVICE_ID, BCM88673_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88673_A0",
        BCM88673_DEVICE_ID, BCM88673_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88673_DEVICE_ID, BCM88673_B0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88673_B0",
        BCM88673_DEVICE_ID, BCM88673_B0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88673_DEVICE_ID, BCM88673_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88673_A1",
        BCM88673_DEVICE_ID, BCM88673_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88674_DEVICE_ID, BCM88674_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88674_A0",
        BCM88674_DEVICE_ID, BCM88674_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88674_DEVICE_ID, BCM88674_B0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88674_B0",
        BCM88674_DEVICE_ID, BCM88674_B0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88674_DEVICE_ID, BCM88674_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88674_A1",
        BCM88674_DEVICE_ID, BCM88674_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88675M_DEVICE_ID, BCM88675M_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88675M_A0",
        BCM88675M_DEVICE_ID, BCM88675M_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88675M_DEVICE_ID, BCM88675M_B0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88675M_B0",
        BCM88675M_DEVICE_ID, BCM88675M_B0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88675M_DEVICE_ID, BCM88675M_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88675M_A1",
        BCM88675M_DEVICE_ID, BCM88675M_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88676_DEVICE_ID, BCM88676_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88676_A0",
        BCM88676_DEVICE_ID, BCM88676_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88676_DEVICE_ID, BCM88676_B0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88676_B0",
        BCM88676_DEVICE_ID, BCM88676_B0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88676_DEVICE_ID, BCM88676_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88676_A1",
        BCM88676_DEVICE_ID, BCM88676_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88676M_DEVICE_ID, BCM88676M_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88676M_A0",
        BCM88676M_DEVICE_ID, BCM88676M_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88676M_DEVICE_ID, BCM88676M_B0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88676M_B0",
        BCM88676M_DEVICE_ID, BCM88676M_B0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88676M_DEVICE_ID, BCM88676M_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88676M_A1",
        BCM88676M_DEVICE_ID, BCM88676M_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88677_DEVICE_ID, BCM88677_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88677_A0",
        BCM88677_DEVICE_ID, BCM88677_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88677_DEVICE_ID, BCM88677_B0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88677_B0",
        BCM88677_DEVICE_ID, BCM88677_B0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88677_DEVICE_ID, BCM88677_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88677_A1",
        BCM88677_DEVICE_ID, BCM88677_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88678_DEVICE_ID, BCM88678_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88678_A0",
        BCM88678_DEVICE_ID, BCM88678_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88678_DEVICE_ID, BCM88678_B0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88678_B0",
        BCM88678_DEVICE_ID, BCM88678_B0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88678_DEVICE_ID, BCM88678_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88678_A1",
        BCM88678_DEVICE_ID, BCM88678_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88679_DEVICE_ID, BCM88679_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88679_A0",
        BCM88679_DEVICE_ID, BCM88679_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88679_DEVICE_ID, BCM88679_B0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88679_B0",
        BCM88679_DEVICE_ID, BCM88679_B0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88679_DEVICE_ID, BCM88679_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO, "BCM88679_A1",
        BCM88679_DEVICE_ID, BCM88679_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        QMX_DEVICE_ID, QMX_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_QMX, "BCM88375_A0",
        QMX_DEVICE_ID, QMX_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        QMX_DEVICE_ID, QMX_B0_REV_ID,
        SOC_INFO_CHIP_TYPE_QMX, "BCM88375_B0",
        QMX_DEVICE_ID, QMX_B0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        QMX_DEVICE_ID, QMX_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_QMX, "BCM88375_A1",
        QMX_DEVICE_ID, QMX_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88370_DEVICE_ID, BCM88370_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_QMX, "BCM88370_A0",
        BCM88370_DEVICE_ID, BCM88370_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88370_DEVICE_ID, BCM88370_B0_REV_ID,
        SOC_INFO_CHIP_TYPE_QMX, "BCM88370_B0",
        BCM88370_DEVICE_ID, BCM88370_B0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88370_DEVICE_ID, BCM88370_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_QMX, "BCM88370_A1",
        BCM88370_DEVICE_ID, BCM88370_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88371_DEVICE_ID, BCM88371_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_QMX, "BCM88371_A0",
        BCM88371_DEVICE_ID, BCM88371_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88371_DEVICE_ID, BCM88371_B0_REV_ID,
        SOC_INFO_CHIP_TYPE_QMX, "BCM88371_B0",
        BCM88371_DEVICE_ID, BCM88371_B0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88371_DEVICE_ID, BCM88371_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_QMX, "BCM88371_A1",
        BCM88371_DEVICE_ID, BCM88371_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88371M_DEVICE_ID, BCM88371M_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_QMX, "BCM88371M_A0",
        BCM88371M_DEVICE_ID, BCM88371M_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88371M_DEVICE_ID, BCM88371M_B0_REV_ID,
        SOC_INFO_CHIP_TYPE_QMX, "BCM88371M_B0",
        BCM88371M_DEVICE_ID, BCM88371M_B0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88371M_DEVICE_ID, BCM88371M_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_QMX, "BCM88371M_A1",
        BCM88371M_DEVICE_ID, BCM88371M_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88376_DEVICE_ID, BCM88376_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_QMX, "BCM88376_A0",
        BCM88376_DEVICE_ID, BCM88376_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88376_DEVICE_ID, BCM88376_B0_REV_ID,
        SOC_INFO_CHIP_TYPE_QMX, "BCM88376_B0",
        BCM88376_DEVICE_ID, BCM88376_B0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88376_DEVICE_ID, BCM88376_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_QMX, "BCM88376_A1",
        BCM88376_DEVICE_ID, BCM88376_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88376M_DEVICE_ID, BCM88376M_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_QMX, "BCM88376M_A0",
        BCM88376M_DEVICE_ID, BCM88376M_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88376M_DEVICE_ID, BCM88376M_B0_REV_ID,
        SOC_INFO_CHIP_TYPE_QMX, "BCM88376M_B0",
        BCM88376M_DEVICE_ID, BCM88376M_B0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88376M_DEVICE_ID, BCM88376M_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_QMX, "BCM88376M_A1",
        BCM88376M_DEVICE_ID, BCM88376M_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88377_DEVICE_ID, BCM88377_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_QMX, "BCM88377_A0",
        BCM88377_DEVICE_ID, BCM88377_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88377_DEVICE_ID, BCM88377_B0_REV_ID,
        SOC_INFO_CHIP_TYPE_QMX, "BCM88377_B0",
        BCM88377_DEVICE_ID, BCM88377_B0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88377_DEVICE_ID, BCM88377_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_QMX, "BCM88377_A1",
        BCM88377_DEVICE_ID, BCM88377_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88378_DEVICE_ID, BCM88378_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_QMX, "BCM88378_A0",
        BCM88378_DEVICE_ID, BCM88378_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88378_DEVICE_ID, BCM88378_B0_REV_ID,
        SOC_INFO_CHIP_TYPE_QMX, "BCM88378_B0",
        BCM88378_DEVICE_ID, BCM88378_B0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88378_DEVICE_ID, BCM88378_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_QMX, "BCM88378_A1",
        BCM88378_DEVICE_ID, BCM88378_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88379_DEVICE_ID, BCM88379_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_QMX, "BCM88379_A0",
        BCM88379_DEVICE_ID, BCM88379_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88379_DEVICE_ID, BCM88379_B0_REV_ID,
        SOC_INFO_CHIP_TYPE_QMX, "BCM88379_B0",
        BCM88379_DEVICE_ID, BCM88379_B0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88379_DEVICE_ID, BCM88379_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_QMX, "BCM88379_A1",
        BCM88379_DEVICE_ID, BCM88379_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88680_DEVICE_ID, BCM88680_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO_PLUS, "BCM88680_A0",
        BCM88680_DEVICE_ID, BCM88680_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88680_DEVICE_ID, BCM88680_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO_PLUS, "BCM88680_A1",
        BCM88680_DEVICE_ID, BCM88680_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88681_DEVICE_ID, BCM88680_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO_PLUS, "BCM88681_A1",
        BCM88681_DEVICE_ID, BCM88680_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88682_DEVICE_ID, BCM88680_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO_PLUS, "BCM88682_A1",
        BCM88682_DEVICE_ID, BCM88680_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88683_DEVICE_ID, BCM88680_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO_PLUS, "BCM88683_A1",
        BCM88683_DEVICE_ID, BCM88680_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88684_DEVICE_ID, BCM88680_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO_PLUS, "BCM88684_A1",
        BCM88684_DEVICE_ID, BCM88680_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88685_DEVICE_ID, BCM88680_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO_PLUS, "BCM88685_A1",
        BCM88685_DEVICE_ID, BCM88680_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88687_DEVICE_ID, BCM88680_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO_PLUS, "BCM88687_A1",
        BCM88687_DEVICE_ID, BCM88680_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88380_DEVICE_ID, BCM88680_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO_PLUS, "BCM88380_A1",
        BCM88380_DEVICE_ID, BCM88680_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88381_DEVICE_ID, BCM88680_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO_PLUS, "BCM88381_A1",
        BCM88381_DEVICE_ID, BCM88680_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88681_DEVICE_ID, BCM88681_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO_PLUS, "BCM88681_A0",
        BCM88681_DEVICE_ID, BCM88681_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88682_DEVICE_ID, BCM88682_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO_PLUS, "BCM88682_A0",
        BCM88682_DEVICE_ID, BCM88682_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88683_DEVICE_ID, BCM88683_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO_PLUS, "BCM88683_A0",
        BCM88683_DEVICE_ID, BCM88683_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88684_DEVICE_ID, BCM88684_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO_PLUS, "BCM88684_A0",
        BCM88684_DEVICE_ID, BCM88684_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88685_DEVICE_ID, BCM88685_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO_PLUS, "BCM88685_A0",
        BCM88685_DEVICE_ID, BCM88685_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88687_DEVICE_ID, BCM88687_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO_PLUS, "BCM88687_A0",
        BCM88687_DEVICE_ID, BCM88687_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88380_DEVICE_ID, BCM88380_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO_PLUS, "BCM88380_A0",
        BCM88380_DEVICE_ID, BCM88380_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88381_DEVICE_ID, BCM88381_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_JERICHO_PLUS, "BCM88381_A0",
        BCM88381_DEVICE_ID, BCM88381_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        QAX_DEVICE_ID, QAX_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_QAX, "BCM88470_A0",
        QAX_DEVICE_ID, QAX_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        QAX_DEVICE_ID, QAX_B0_REV_ID,
        SOC_INFO_CHIP_TYPE_QAX, "BCM88470_B0",
        QAX_DEVICE_ID, QAX_B0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88470P_DEVICE_ID, QAX_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_QAX, "BCM88470P_A0",
        BCM88470P_DEVICE_ID, QAX_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88471_DEVICE_ID, QAX_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_QAX, "BCM88471_A0",
        BCM88471_DEVICE_ID, QAX_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88471_DEVICE_ID, QAX_B0_REV_ID,
        SOC_INFO_CHIP_TYPE_QAX, "BCM88471_B0",
        BCM88471_DEVICE_ID, QAX_B0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88473_DEVICE_ID, QAX_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_QAX, "BCM88473_A0",
        BCM88473_DEVICE_ID, QAX_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88474_DEVICE_ID, QAX_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_QAX, "BCM88474_A0",
        BCM88474_DEVICE_ID, QAX_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88474_DEVICE_ID, QAX_B0_REV_ID,
        SOC_INFO_CHIP_TYPE_QAX, "BCM88474_B0",
        BCM88474_DEVICE_ID, QAX_B0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88474H_DEVICE_ID, QAX_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_QAX, "BCM88474H_A0",
        BCM88474H_DEVICE_ID, QAX_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88474H_DEVICE_ID, QAX_B0_REV_ID,
        SOC_INFO_CHIP_TYPE_QAX, "BCM88474H_B0",
        BCM88474H_DEVICE_ID, QAX_B0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88476_DEVICE_ID, QAX_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_KALIA, "BCM88476_A0",
        BCM88476_DEVICE_ID, QAX_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88476_DEVICE_ID, QAX_B0_REV_ID,
        SOC_INFO_CHIP_TYPE_KALIA, "BCM88476_B0",
        BCM88476_DEVICE_ID, QAX_B0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88477_DEVICE_ID, QAX_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_KALIA, "BCM88477_A0",
        BCM88477_DEVICE_ID, QAX_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88477_DEVICE_ID, QAX_B0_REV_ID,
        SOC_INFO_CHIP_TYPE_KALIA, "BCM88477_B0",
        BCM88477_DEVICE_ID, QAX_B0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88479_DEVICE_ID, QAX_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_QAX, "BCM88479_A0",
        BCM88479_DEVICE_ID, QAX_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88479_DEVICE_ID, QAX_B0_REV_ID,
        SOC_INFO_CHIP_TYPE_QAX, "BCM88479_B0",
        BCM88479_DEVICE_ID, QAX_B0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
       QUX_DEVICE_ID, QUX_A0_REV_ID,
       SOC_INFO_CHIP_TYPE_QUX, "BCM88270_A0",
       QUX_DEVICE_ID, QUX_A0_REV_ID,
       (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
       QUX_DEVICE_ID, QUX_A1_REV_ID,
       SOC_INFO_CHIP_TYPE_QUX, "BCM88270_A1",
       QUX_DEVICE_ID, QUX_A1_REV_ID,
       (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
       BCM88271_DEVICE_ID, QUX_A1_REV_ID,
       SOC_INFO_CHIP_TYPE_QUX, "BCM88271_A1",
       BCM88271_DEVICE_ID, QUX_A1_REV_ID,
       (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
       BCM88272_DEVICE_ID, QUX_A0_REV_ID,
       SOC_INFO_CHIP_TYPE_QUX, "BCM88272_A0",
       BCM88272_DEVICE_ID, QUX_A0_REV_ID,
       (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
       BCM88272_DEVICE_ID, QUX_A1_REV_ID,
       SOC_INFO_CHIP_TYPE_QUX, "BCM88272_A1",
       BCM88272_DEVICE_ID, QUX_A1_REV_ID,
       (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
       BCM88273_DEVICE_ID, QUX_A0_REV_ID,
       SOC_INFO_CHIP_TYPE_QUX, "BCM88273_A0",
       BCM88273_DEVICE_ID, QUX_A0_REV_ID,
       (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
       BCM88273_DEVICE_ID, QUX_A1_REV_ID,
       SOC_INFO_CHIP_TYPE_QUX, "BCM88273_A1",
       BCM88273_DEVICE_ID, QUX_A1_REV_ID,
       (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
       BCM88274_DEVICE_ID, QUX_A0_REV_ID,
       SOC_INFO_CHIP_TYPE_QUX, "BCM88274_A0",
       BCM88274_DEVICE_ID, QUX_A0_REV_ID,
       (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
       BCM88274_DEVICE_ID, QUX_A1_REV_ID,
       SOC_INFO_CHIP_TYPE_QUX, "BCM88274_A1",
       BCM88274_DEVICE_ID, QUX_A1_REV_ID,
       (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
       BCM88276_DEVICE_ID, QUX_A1_REV_ID,
       SOC_INFO_CHIP_TYPE_QUX, "BCM88276_A1",
       BCM88276_DEVICE_ID, QUX_A1_REV_ID,
       (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
       BCM88278_DEVICE_ID, QUX_A0_REV_ID,
       SOC_INFO_CHIP_TYPE_QUX, "BCM88278_A0",
       BCM88278_DEVICE_ID, QUX_A0_REV_ID,
       (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
       BCM88278_DEVICE_ID, QUX_A1_REV_ID,
       SOC_INFO_CHIP_TYPE_QUX, "BCM88278_A1",
       BCM88278_DEVICE_ID, QUX_A1_REV_ID,
       (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
       BCM88279_DEVICE_ID, QUX_A1_REV_ID,
       SOC_INFO_CHIP_TYPE_QUX, "BCM88279_A1",
       BCM88279_DEVICE_ID, QUX_A1_REV_ID,
       (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
/* } */
...
/* { */
    {
        ...
        SOC_INFO_CHIP_TYPE_FE3200, "BCM88770_A1",
        BCM88770_DEVICE_ID, BCM88770_A1_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM88773_DEVICE_ID, BCM88773_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_FE3200, "BCM88773_A1",
        BCM88773_DEVICE_ID, BCM88773_A1_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM88774_DEVICE_ID, BCM88774_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_FE3200, "BCM88774_A1",
        BCM88774_DEVICE_ID, BCM88774_A1_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM88775_DEVICE_ID, BCM88775_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_FE3200, "BCM88775_A1",
        BCM88775_DEVICE_ID, BCM88775_A1_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM88776_DEVICE_ID, BCM88776_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_FE3200, "BCM88776_A1",
        BCM88776_DEVICE_ID, BCM88776_A1_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM88777_DEVICE_ID, BCM88777_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_FE3200, "BCM88777_A1",
        BCM88777_DEVICE_ID, BCM88777_A1_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM88950_DEVICE_ID, BCM88950_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_FE3200, "BCM88950_A0",
        BCM88950_DEVICE_ID, BCM88950_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM88950_DEVICE_ID, BCM88950_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_FE3200, "BCM88950_A1",
        BCM88950_DEVICE_ID, BCM88950_A1_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM88953_DEVICE_ID, BCM88953_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_FE3200, "BCM88953_A1",
        BCM88953_DEVICE_ID, BCM88953_A1_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM88954_DEVICE_ID, BCM88954_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_FE3200, "BCM88954_A1",
        BCM88954_DEVICE_ID, BCM88954_A1_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM88955_DEVICE_ID, BCM88955_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_FE3200, "BCM88955_A1",
        BCM88955_DEVICE_ID, BCM88955_A1_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM88956_DEVICE_ID, BCM88956_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_FE3200, "BCM88956_A1",
        BCM88956_DEVICE_ID, BCM88956_A1_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM88772_DEVICE_ID, BCM88772_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_FE3200, "BCM88772_A1",
        BCM88772_DEVICE_ID, BCM88772_A1_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM88952_DEVICE_ID, BCM88952_A0_REV_ID,
        SOC_INFO_CHIP_TYPE_FE3200, "BCM88952_A0",
        BCM88952_DEVICE_ID, BCM88952_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
    {
        BCM88952_DEVICE_ID, BCM88952_A1_REV_ID,
        SOC_INFO_CHIP_TYPE_FE3200, "BCM88952_A1",
        BCM88952_DEVICE_ID, BCM88952_A1_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE)
    },
/* } */
...
/* { */
    ...
    },
    {
        ...
        SOC_INFO_CHIP_TYPE_JERICHO2, "BCM88690_B1",
        BCM88690_DEVICE_ID, BCM88690_B1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88800_DEVICE_ID, DNXC_A0_REV_ID | SOC_CM_DEVICE_ANY_LAST_DEVID_DIGIT,
        SOC_INFO_CHIP_TYPE_J2C, "BCM88800_A0",
        BCM88800_DEVICE_ID, DNXC_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88800_DEVICE_ID, DNXC_A1_REV_ID | SOC_CM_DEVICE_LARGER_REVID_AND_ANY_LAST_DEVID_DIGIT,
        SOC_INFO_CHIP_TYPE_J2C, "BCM88800_A1",
        BCM88800_DEVICE_ID, DNXC_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88820_DEVICE_ID, DNXC_A0_REV_ID | SOC_CM_DEVICE_ANY_LAST_DEVID_DIGIT,
        SOC_INFO_CHIP_TYPE_J2C, "BCM88820_A0",
        BCM88820_DEVICE_ID, DNXC_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88820_DEVICE_ID, DNXC_A1_REV_ID | SOC_CM_DEVICE_LARGER_REVID_AND_ANY_LAST_DEVID_DIGIT,
        SOC_INFO_CHIP_TYPE_J2C, "BCM88820_A1",
        BCM88820_DEVICE_ID, DNXC_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88850_DEVICE_ID, DNXC_A0_REV_ID | SOC_CM_DEVICE_ANY_LAST_DEVID_DIGIT,
        SOC_INFO_CHIP_TYPE_J2P, "BCM88850_A0",
        BCM88850_DEVICE_ID, DNXC_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88850_DEVICE_ID, DNXC_A1_REV_ID | SOC_CM_DEVICE_ANY_LAST_DEVID_DIGIT,
        SOC_INFO_CHIP_TYPE_J2P, "BCM88850_A1",
        BCM88850_DEVICE_ID, DNXC_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88850_DEVICE_ID, DNXC_A2_REV_ID | SOC_CM_DEVICE_LARGER_REVID_AND_ANY_LAST_DEVID_DIGIT,
        SOC_INFO_CHIP_TYPE_J2P, "BCM88850_A2",
        BCM88850_DEVICE_ID, DNXC_A2_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88840_DEVICE_ID, DNXC_A0_REV_ID | SOC_CM_DEVICE_ANY_LAST_DEVID_DIGIT,
        SOC_INFO_CHIP_TYPE_J2P, "BCM88840_A0",
        BCM88840_DEVICE_ID, DNXC_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88840_DEVICE_ID, DNXC_A1_REV_ID | SOC_CM_DEVICE_ANY_LAST_DEVID_DIGIT,
        SOC_INFO_CHIP_TYPE_J2P, "BCM88840_A1",
        BCM88840_DEVICE_ID, DNXC_A1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88840_DEVICE_ID, DNXC_A2_REV_ID | SOC_CM_DEVICE_LARGER_REVID_AND_ANY_LAST_DEVID_DIGIT,
        SOC_INFO_CHIP_TYPE_J2P, "BCM88840_A2",
        BCM88840_DEVICE_ID, DNXC_A2_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88830_DEVICE_ID, DNXC_A0_REV_ID | SOC_CM_DEVICE_LARGER_REVID_AND_ANY_LAST_DEVID_DIGIT,
        SOC_INFO_CHIP_TYPE_J2X, "BCM88830_A0",
        BCM88830_DEVICE_ID, DNXC_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88480_DEVICE_ID, DNXC_A0_REV_ID | SOC_CM_DEVICE_ANY_LAST_DEVID_DIGIT,
        SOC_INFO_CHIP_TYPE_Q2A, "BCM88480_A0",
        BCM88480_DEVICE_ID, DNXC_A0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88480_DEVICE_ID, DNXC_B0_REV_ID | SOC_CM_DEVICE_ANY_LAST_DEVID_DIGIT,
        SOC_INFO_CHIP_TYPE_Q2A, "BCM88480_B0",
        BCM88480_DEVICE_ID, DNXC_B0_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88480_DEVICE_ID, DNXC_B1_REV_ID | SOC_CM_DEVICE_LARGER_REVID_AND_ANY_LAST_DEVID_DIGIT,
        SOC_INFO_CHIP_TYPE_Q2A, "BCM88480_B1",
        BCM88480_DEVICE_ID, DNXC_B1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88280_DEVICE_ID, DNXC_B1_REV_ID | SOC_CM_DEVICE_LARGER_REVID_AND_ANY_LAST_DEVID_DIGIT,
        SOC_INFO_CHIP_TYPE_Q2A, "BCM88280_B1",
        BCM88280_DEVICE_ID, DNXC_B1_REV_ID,
        (SOC_SWITCH_DEV_TYPE | SOC_PCI_DEV_TYPE)
    },
    {
        BCM88290_DEVICE_ID, DNXC_B1_REV_ID | SOC_CM_DEVICE_LARGER_REVID_AND_ANY_LAST_DEVID_DIGIT,
        SOC_INFO_CHIP_TYPE_Q2A, "BCM88290_B1",
...
/* { */
    ...
    },
    {
        ...
        SOC_INFO_CHIP_TYPE_RAMON, "BCM88790_B0",
...
/* } */
    ...
    {   /* Tomahawk4D */
        BCM56999_DEVICE_ID, BCM56999_B0_REV_ID,
        0, "BCM56999_B0",
        BCM56999_DEVICE_ID, BCM56999_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE | SOC_LTSW_DRV_TYPE)
    },
    ...
    {   /* Tomahawk4D */
        BCM56995_DEVICE_ID, BCM56995_B0_REV_ID,
        0, "BCM56995_B0",
        BCM56999_DEVICE_ID, BCM56999_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE | SOC_LTSW_DRV_TYPE)
    },
...
soc_cm_device_create_id(uint16 dev_id, uint16 rev_id, void *cookie, int unit, int bde_dev)
{
    ...
    CMDEV(unit).dev.chip_enum = info->chip_enum;
...
soc_cm_device_create_composite(uint32 composite_dev_type, int *sub_units, void *cookie, int comp_unit)
{
    ...
    for (sub_dev_i = 0; sub_dev_i < nof_sub_devs; ++sub_dev_i) {
        ...
        subdev_chip_enum = CMDEV(unit).dev.info->chip_enum;
    ...
    CMDEV(comp_unit).dev.chip_enum = subdev_chip_enum;
...
{
#if defined(BCM_ESW_SUPPORT) || defined(BCM_SAND_SUPPORT)
#if defined(BCM_ESW_SUPPORT) || defined(BCM_PETRA_SUPPORT) || defined(BCM_DFE_SUPPORT) || defined(INCLUDE_CPU_I2C)
    uint32 regval;
#endif
...
/*
 * Purpose: Get the DLL path configured via soc property issu_dll_path.
 *
 * This function could be used to fetch the issu_dll_path during warmboot
 * or ISSU. This function must not be used during cold boot or FFB.
 *
 * Parameters:
 *      dllpath - DLL path
 *
 ...
 */
int
soc_cm_issu_dll_path_get(const char **dllpath)
{
#if defined(BCM_LTSW_SUPPORT) || defined(BCM_CTSW_SUPPORT)
    if (!soc_ndev) {
        return SOC_E_INIT;
    ...
    return soc_ltsw_issu_dll_path_get(SOC_NDEV_IDX2DEV(0), dllpath);
#else
    return SOC_E_UNAVAIL;
#endif
}
