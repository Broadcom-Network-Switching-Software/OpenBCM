...
typedef struct pmm_periodic_per_port_info_s {
    portmod_shr_thread_manager_f ports_callback;
    int interval;
...
typedef struct pmm_periodic_data_s {
    ...
    /* Handler for periodic events - see shr_thread_manager.h for details */
    shr_thread_manager_handler_t periodic_handler;
...
int _portmod_pm_type_to_nof_pms(int unit, portmod_dispatch_type_t pm_type, int *nof_pms)
{
    ...
    case portmodDispatchTypePm4x25d:
    ...
    case portmodDispatchTypePm8x100_fabric:
        *nof_pms = 1;
        break;
    ...
    case portmodDispatchTypePm8x50_flexe_gen2:
        *nof_pms = 1;
        ...
        case portmodDispatchTypePm8x100_gen2:
            *nof_pms = 1;
            break;
...
#endif
#ifdef PORTMOD_PM8X50_FLEXE_GEN2_SUPPORT
                (pm_info->type == portmodDispatchTypePm8x50_flexe_gen2) ||
#endif
#ifdef PORTMOD_PM8X100_GEN2_SUPPORT
                (pm_info->type == portmodDispatchTypePm8x100_gen2) ||
#endif
           0)
        {
...
#if (PHYMOD_CONFIG_INCLUDE_FLOATING_POINT == 0)
    LOG_WARN(BSL_LS_SOC_PORT,
             (BSL_META_U(unit,
                         "Some PHY functionality will be unavailable "
                         "due to missing floating point support\n")));
#endif
...
#define _PORTMOD_PE_NAME_MAX 30
        ...
        shr_thread_manager_config_t pe_config;
        shr_thread_manager_config_t_init(&pe_config);

        pe_config.name = "Portmod Periodic";
        pe_config.bsl_module = _ERR_MSG_MODULE_NAME;
        pe_config.type = SHR_THREAD_MANAGER_TYPE_EVENT;
        ...
        _SOC_IF_ERR_EXIT(shr_thread_manager_create(unit, &pe_config, &(pmm->periodic.periodic_handler)));
    }
...
static void  periodic_event_working_port_set(int unit, int port)
{
    _pmm_info[unit]->periodic.current_working_port = port;
}

static int  periodic_event_working_port_get(int unit)
{
    return _pmm_info[unit]->periodic.current_working_port;
}
...
int portmod_destroy(int unit)
{
    ...
    _SOC_IF_ERR_EXIT(shr_thread_manager_destroy(&(_pmm_info[unit]->periodic.periodic_handler)));

    periodic_event_working_port_set(unit, -1);
...
int portmod_thread_stop(int unit)
{
    ...
    _SOC_IF_ERR_EXIT(shr_thread_manager_stop(_pmm_info[unit]->periodic.periodic_handler, FALSE));
...
{
    return _pmm_info[unit] != NULL;
}


#if defined(PORTMOD_PM4X25_SUPPORT) || defined(PORTMOD_PM4X10_SUPPORT) || defined(PORTMOD_DNX_FABRIC_SUPPORT) || defined(PORTMOD_PM12X10_SUPPORT) || defined(PORTMOD_PM4x10Q_SUPPORT) || defined(PORTMOD_PM_OS_ILKN_SUPPORT) || defined(PORTMOD_PM8X100_FABRIC_SUPPORT) || defined(PORTMOD_PM8X50_FABRIC_SUPPORT) || defined(PORTMOD_PM8X50_SUPPORT) \
    || defined(PORTMOD_PM4X10_QTC_SUPPORT) || defined(PORTMOD_PM8X50_FLEXE_GEN2_SUPPORT) || defined(PORTMOD_PM8X100_GEN2_SUPPORT)
STATIC
...
#endif /* defined(PORTMOD_PM4X25_SUPPORT) || defined(PORTMOD_PM4X10_SUPPORT) || defined(PORTMOD_DNX_FABRIC_SUPPORT) || defined(PORTMOD_PM12X10_SUPPORT) || defined(PORTMOD_PM4x10Q_SUPPORT) || defined(PORTMOD_PM_OS_ILKN_SUPPORT) || defined(PORTMOD_PM8X100_FABRIC_SUPPORT) || defined(PORTMOD_PM8X50_FABRIC_SUPPORT)  || defined(PORTMOD_PM8X50_FLEXE_GEN2_SUPPORT) */


#if defined(PORTMOD_PM4X25_SUPPORT) || \
    defined(PORTMOD_PM4X10_SUPPORT) || \
    defined(PORTMOD_DNX_FABRIC_SUPPORT) || \
    defined(PORTMOD_PM8X100_FABRIC_SUPPORT) || \
    defined(PORTMOD_PM8X50_FABRIC_SUPPORT) || \
    defined(PORTMOD_PM8X50_SUPPORT) || \
    defined(PORTMOD_PM8X50_FLEXE_GEN2_SUPPORT) || \
    defined(PORTMOD_PM8X100_GEN2_SUPPORT) || \
...
#ifdef PORTMOD_PM8X100_FABRIC_SUPPORT
    case portmodDispatchTypePm8x100_fabric:
        specific_info_size = sizeof(pm_add_info->pm_specific_info.pm8x100_fabric);
        break;
#endif /*PORTMOD_PM8X100_FABRIC_SUPPORT  */
#ifdef PORTMOD_PMNULL_SUPPORT
...
#ifdef PORTMOD_PM8X100_GEN2_SUPPORT
    case portmodDispatchTypePm8x100_gen2:
        specific_info_size = sizeof(pm_add_info->pm_specific_info.pm8x100_gen2);
        break;
#endif /*PORTMOD_PM8X100_GEN2_SUPPORT  */
#ifdef PORTMOD_PM8X50_FLEXE_GEN2_SUPPORT
    case portmodDispatchTypePm8x50_flexe_gen2:
        specific_info_size = sizeof(pm_add_info->pm_specific_info.pm8x50_flexe_gen2);
        break;
#endif /*PORTMOD_PM8X50_FLEXE_GEN2_SUPPORT  */
#ifdef PORTMOD_PM4X10_QTC_SUPPORT
    case portmodDispatchTypePm4x10_qtc:
...
int _portmod_os_ilkn_add(int unit, const portmod_pm_create_info_t *pm_add_info)
{
    ...
    os_ilkn_create_info.pm_specific_info.os_ilkn.fec_dependency = pm_add_info->pm_specific_info.os_ilkn.fec_dependency;
...
int portmod_port_add(int unit, int port, const portmod_port_add_info_t *port_add_info)
{
    ...
    int is_qsgmii = 0;
#endif
#if defined(PORTMOD_PM8X50_SUPPORT) || defined(PORTMOD_PM8X50_FLEXE_GEN2_SUPPORT) || defined(PORTMOD_PM8X100_GEN2_SUPPORT)
    ...
    PORTMOD_PBMP_ITER(port_add_info->phys, phy){
        ...
        /* coverity[check_return] */
        portmod_phy_pm_type_get(unit, phy, &pm_type);
        /* For PM8x50_flexe_gen2 port add is done as part of init pass1 */
        if (pm_type == portmodDispatchTypePm8x50_flexe_gen2) {
            is_init_pass1 = PORTMOD_PORT_ADD_F_INIT_PASS1_GET(port_add_info);
            if (is_init_pass1) {
                add_port = TRUE;
            }
    ...
    PORTMOD_PBMP_ITER(port_add_info->phys, phy){
        ...
        /* coverity[check_return] */
        portmod_phy_pm_type_get(unit, phy, &pm_type);
        /* For PM8x100_gen2 port add is done as part of init pass1 */
        if (pm_type == portmodDispatchTypePm8x100_gen2) {
            is_init_pass1 = PORTMOD_PORT_ADD_F_INIT_PASS1_GET(port_add_info);
            if (is_init_pass1) {
                add_port = TRUE;
            }
...
#if defined(PORTMOD_PM8X50_SUPPORT) || defined(PORTMOD_PM8X50_FLEXE_GEN2_SUPPORT)
    phymod_firmware_lane_config_t fw_lane_config;
    portmod_speed_config_t speed_config;
#endif
#if defined(PORTMOD_PM8X50_SUPPORT) || defined(PORTMOD_PM4X10_SUPPORT) || defined(PORTMOD_PM8X50_FLEXE_GEN2_SUPPORT)
...
#ifdef PORTMOD_PM8X50_FLEXE_GEN2_SUPPORT
    if (pm_info->type == portmodDispatchTypePm8x50_flexe_gen2) {
        rv = phymod_phy_firmware_lane_config_get(&phy_access[0], &fw_lane_config);
        _SOC_IF_ERR_EXIT(rv);
        diag_info->medium = fw_lane_config.MediaType;
        rv = portmod_port_speed_config_get(unit, port, &speed_config);
...
#ifdef PORTMOD_PM8X100_GEN2_SUPPORT
    if (pm_info->type == portmodDispatchTypePm8x100_gen2) {
        rv = phymod_phy_firmware_lane_config_get(&phy_access[0], &fw_lane_config);
        _SOC_IF_ERR_EXIT(rv);
        diag_info->medium = fw_lane_config.MediaType;
        rv = portmod_port_speed_config_get(unit, port, &speed_config);
...
static void portmod_periodic_port_callback_set(int unit, int port, portmod_shr_thread_manager_f callback)
{
    _pmm_info[unit]->periodic.ports_periodic[port].ports_callback = callback;
}


static portmod_shr_thread_manager_f portmod_periodic_port_callback_get(int unit, int port)
{
    return _pmm_info[unit]->periodic.ports_periodic[port].ports_callback;
}




/* A  callback for periodic thread to execute per-port callbacks */
static int portmod_periodic_event(int unit, void* user_data)
{
    int port_i, rv, rv_failure, is_quit_signaled;
    portmod_shr_thread_manager_f port_callback;
    SOC_INIT_FUNC_DEFS;
    ...
    for (port_i=0 ; port_i<_pmm_info[unit]->max_ports ; port_i++) {
        ...
        periodic_event_working_port_set(unit, port_i);

        _SOC_IF_ERR_EXIT(shr_thread_manager_is_quit_signaled_get(_pmm_info[unit]->periodic.periodic_handler, &is_quit_signaled));

        if (is_quit_signaled) {
            break;
        }

        port_callback = portmod_periodic_port_callback_get(unit, port_i);
 ...
 *                 remove.
 * @param set_interval - whether to set the interval or ignore it
 * 
 * @return int 
 */
#define _PORTMOD_MIN_INTERVAL_NOT_FOUND -2

static int portmod_port_callback_update_internal(int unit, int port, portmod_shr_thread_manager_f callback, int interval, int set_interval)
{
    int port_i;
    ...
    /* Update DB*/
    portmod_periodic_port_callback_set(unit, port, callback);
    ...
    if(set_interval) {
        ...
        for (port_i=0 ; port_i<_pmm_info[unit]->max_ports ; port_i++) {
            ...
            if (portmod_periodic_port_callback_get(unit, port_i) != NULL) {
        ...
        _SOC_IF_ERR_EXIT(shr_thread_manager_interval_set(_pmm_info[unit]->periodic.periodic_handler, 0, min_interval));
    }
...
/* gracefully unregister a callback for port 
    update_interval - whether to unset the interval as well, or just the callback
    Usually when the unregister will be follow by a new registretion, there is no need to unset the interval*/
static int portmod_port_periodic_callback_unregister_internal(int unit, int port, int update_interval)
{
    soc_timeout_t to;
    ...
    _SOC_IF_ERR_EXIT(portmod_port_callback_update_internal(unit, port, NULL, 0, update_interval));
    ...
    _SOC_IF_ERR_EXIT(shr_thread_manager_context_get(_pmm_info[unit]->periodic.periodic_handler, &is_callback_conetxt));
    if (!is_callback_conetxt) {

        soc_timeout_init(&to, SECOND_USEC /*1 sec*/, 100);

        while (periodic_event_working_port_get(unit) == port) {
            /*
             * Release lock before sleep to let scheduling of other threads
            ...
            sal_mutex_take(_pmm_info[unit]->periodic.periodic_lock,
                           sal_mutex_FOREVER);
        }
    }
    sal_mutex_give(_pmm_info[unit]->periodic.periodic_lock);
...
int portmod_port_periodic_callback_unregister(int unit, int port)
{
    ...
    _SOC_IF_ERR_EXIT(portmod_port_periodic_callback_unregister_internal(unit, port, 1));
...
/* see .h file */ 
int portmod_port_periodic_callback_unregister_all(int unit)
{
    int port_i;
    SOC_INIT_FUNC_DEFS;
    ...
    for (port_i=0 ; port_i<_pmm_info[unit]->max_ports ; port_i++) {
        if (portmod_periodic_port_callback_get(unit, port_i) != NULL) {
            _SOC_IF_ERR_EXIT(portmod_port_periodic_callback_unregister_internal(unit, port_i, 1));
        }
    }
...
/* see .h file */ 
int portmod_port_periodic_callback_register(int unit, int port, portmod_shr_thread_manager_f callback, int interval)
{
    int is_active;
    int portmon_disable;
    SOC_INIT_FUNC_DEFS;
    ...
    _SOC_IF_ERR_EXIT(portmod_port_periodic_callback_unregister_internal(unit, port, 0));

    /* Update new callback */
    _SOC_IF_ERR_EXIT(portmod_port_callback_update_internal(unit, port, callback, interval, 1));

    /* If thread never started - start it now */
    _SOC_IF_ERR_EXIT(shr_thread_manager_is_active_get(_pmm_info[unit]->periodic.periodic_handler, &is_active));

    if (!is_active) {
        _SOC_IF_ERR_EXIT(shr_thread_manager_start(_pmm_info[unit]->periodic.periodic_handler));
    }
...
int portmod_port_periodic_interval_get(int unit, int* interval)
{
    ...
    _SOC_IF_ERR_EXIT(shr_thread_manager_interval_get(_pmm_info[unit]->periodic.periodic_handler, interval));
...
int portmod_pm_phys_from_pm_id_get(int unit, int pm_id, portmod_pbmp_t *phys) {
    ...
    _SOC_IF_ERR_EXIT(portmod_pm_phys_get(unit, pm_info, phys));
