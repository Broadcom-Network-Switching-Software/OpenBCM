...
__portmod__dispatch__t__ portmod_pm4x2p5_driver = {
    ...
    NULL, /* portmod_port_phy_flr_link_up_event */
    ...
    NULL, /* portmod_port_remote_fault_force_set */
    NULL, /* portmod_port_remote_fault_force_get */
    NULL, /* portmod_port_local_fault_force_set */
    NULL, /* portmod_port_local_fault_force_get */
    ...
    pm4x2p5_port_timesync_tx_info_get,
    ...
    NULL, /* portmod_port_tx_padding_set */
    NULL, /* portmod_port_tx_padding_get */
    NULL, /* portmod_port_rate_egress_ppt_set */
    NULL, /* portmod_port_rate_egress_ppt_get */
#ifdef CPRIMOD_SUPPORT
    ...
    NULL, /* portmod_port_mac_strip_crc_set */
    NULL, /* portmod_port_mac_strip_crc_get */
    NULL, /* portmod_port_mac_tx_crc_mode_set */
    NULL, /* portmod_port_mac_tx_crc_mode_get */
    NULL, /* portmod_port_mac_rsv_mask_get */
    NULL, /* portmod_port_external_los_enable_set */
    NULL, /* portmod_port_external_los_enable_get */
};
