...
__portmod__dispatch__t__ portmod_pm8x100_gen2_driver = {
    ...
    pm8x100_gen2_port_speed_ability_local_get,
    pm8x100_gen2_pm_interface_type_is_supported,
    pm8x100_gen2_pm_init,
    pm8x100_gen2_pm_destroy,
    pm8x100_gen2_port_attach,
    NULL, /* portmod_default_bus_update */
    NULL, /* portmod_pm_bypass_set */
    pm8x100_gen2_pm_core_info_get,
    NULL, /* portmod_pm_aggregated_update */
    pm8x100_gen2_pm_phys_get,
    pm8x100_gen2_port_detach,
    NULL, /* portmod_port_callback_unregister */
    pm8x100_gen2_port_replace,
    pm8x100_gen2_port_enable_set,
    pm8x100_gen2_port_enable_get,
    ...
    pm8x100_gen2_port_cl72_set,
    pm8x100_gen2_port_cl72_get,
    pm8x100_gen2_port_cl72_status_get,
    pm8x100_gen2_port_loopback_set,
    pm8x100_gen2_port_loopback_get,
    ...
    pm8x100_gen2_port_rx_mac_enable_set,
    pm8x100_gen2_port_rx_mac_enable_get,
    pm8x100_gen2_port_tx_mac_enable_set,
    pm8x100_gen2_port_tx_mac_enable_get,
    NULL, /* portmod_port_ability_local_get */
    pm8x100_gen2_port_autoneg_set,
    pm8x100_gen2_port_autoneg_get,
    pm8x100_gen2_port_autoneg_status_get,
    pm8x100_gen2_port_link_get,
    NULL, /* portmod_port_link_latch_down_get */
    NULL, /* portmod_port_phy_flr_link_up_event */
    pm8x100_gen2_port_phy_link_up_event,
    NULL, /* portmod_port_phy_link_down_event */
    pm8x100_gen2_port_prbs_config_set,
    pm8x100_gen2_port_prbs_config_get,
    pm8x100_gen2_port_prbs_enable_set,
    pm8x100_gen2_port_prbs_enable_get,
    pm8x100_gen2_port_prbs_status_get,
    pm8x100_gen2_port_nof_lanes_get,
    ...
    pm8x100_gen2_port_runt_threshold_set,
    pm8x100_gen2_port_runt_threshold_get,
    pm8x100_gen2_port_tx_threshold_set,
    pm8x100_gen2_port_tx_threshold_get,
    pm8x100_gen2_port_max_packet_size_set,
    pm8x100_gen2_port_max_packet_size_get,
    NULL, /* portmod_port_pad_size_set */
    NULL, /* portmod_port_pad_size_get */
    pm8x100_gen2_port_tx_mac_sa_set,
    pm8x100_gen2_port_tx_mac_sa_get,
    pm8x100_gen2_port_rx_mac_sa_set,
    pm8x100_gen2_port_rx_mac_sa_get,
    pm8x100_gen2_port_tx_average_ipg_set,
    pm8x100_gen2_port_tx_average_ipg_get,
    NULL, /* portmod_port_tx_preamble_length_set */
    NULL, /* portmod_port_tx_preamble_length_get */
    pm8x100_gen2_port_local_fault_control_set,
    pm8x100_gen2_port_local_fault_control_get,
    pm8x100_gen2_port_remote_fault_control_set,
    pm8x100_gen2_port_remote_fault_control_get,
    pm8x100_gen2_port_local_fault_status_get,
    pm8x100_gen2_port_remote_fault_status_get,
    pm8x100_gen2_port_local_fault_status_clear,
    pm8x100_gen2_port_remote_fault_status_clear,
    pm8x100_gen2_port_remote_fault_force_set,
    pm8x100_gen2_port_remote_fault_force_get,
    pm8x100_gen2_port_local_fault_force_set,
    pm8x100_gen2_port_local_fault_force_get,
    pm8x100_gen2_port_local_fault_reasons_get,
    pm8x100_gen2_port_pause_control_set,
    pm8x100_gen2_port_pause_control_get,
    pm8x100_gen2_port_pfc_control_set,
    pm8x100_gen2_port_pfc_control_get,
    NULL, /* portmod_port_llfc_control_set */
    NULL, /* portmod_port_llfc_control_get */
    NULL, /* portmod_port_update */
    pm8x100_gen2_port_core_access_get,
    pm8x100_gen2_port_phy_lane_access_get,
    pm8x100_gen2_pm_phy_lane_access_get,
    NULL, /* portmod_port_duplex_set */
    NULL, /* portmod_port_duplex_get */
    pm8x100_gen2_port_phy_reg_read,
    pm8x100_gen2_port_phy_reg_write,
    pm8x100_gen2_port_reset_set,
    pm8x100_gen2_port_reset_get,
    NULL, /* portmod_port_adv_remote_get */
    NULL, /* portmod_port_drv_name */
    pm8x100_gen2_port_drv_name_get,
    pm8x100_gen2_port_fec_enable_set,
    pm8x100_gen2_port_fec_enable_get,
    ...
    pm8x100_gen2_port_rx_control_set,
    pm8x100_gen2_port_rx_control_get,
    pm8x100_gen2_port_pfc_config_set,
    pm8x100_gen2_port_pfc_config_get,
    NULL, /* portmod_port_eee_set */
    NULL, /* portmod_port_eee_get */
    NULL, /* portmod_port_eee_clock_set */
    NULL, /* portmod_port_eee_clock_get */
    pm8x100_gen2_port_vlan_tag_set,
    pm8x100_gen2_port_vlan_tag_get,
    ...
    pm8x100_gen2_port_mode_set,
    pm8x100_gen2_port_mode_get,
    pm8x100_gen2_port_encap_set,
    pm8x100_gen2_port_encap_get,
    ...
    pm8x100_gen2_port_cntmaxsize_set,
    pm8x100_gen2_port_cntmaxsize_get,
    NULL, /* portmod_port_multi_get */
    pm8x100_gen2_port_drain_cell_get,
    pm8x100_gen2_port_drain_cell_stop,
    pm8x100_gen2_port_drain_cell_start,
    pm8x100_gen2_port_drain_cells_rx_enable,
    pm8x100_gen2_port_egress_queue_drain_rx_en,
    pm8x100_gen2_port_mac_ctrl_set,
    pm8x100_gen2_port_txfifo_cell_cnt_get,
    pm8x100_gen2_port_egress_queue_drain_get,
    pm8x100_gen2_port_mac_reset_set,
    pm8x100_gen2_port_mac_reset_get,
    NULL, /* portmod_port_soft_reset_toggle */
    pm8x100_gen2_port_soft_reset,
    pm8x100_gen2_port_mac_reset_check,
    ...
    pm8x100_gen2_port_control_phy_timesync_set,
    pm8x100_gen2_port_control_phy_timesync_get,
    pm8x100_gen2_port_timesync_config_set,
    pm8x100_gen2_port_timesync_config_get,
    ...
    pm8x100_gen2_port_interrupt_enable_set,
    pm8x100_gen2_port_interrupt_enable_get,
    pm8x100_gen2_port_interrupt_get,
    pm8x100_gen2_port_interrupts_get,
    NULL, /* portmod_port_check_legacy_phy */
    NULL, /* portmod_port_failover_mode_set */
    NULL, /* portmod_port_failover_mode_get */
    pm8x100_gen2_port_mac_rsv_mask_set,
    ...
    pm8x100_gen2_port_lane_map_set,
    pm8x100_gen2_port_lane_map_get,
    ...
    pm8x100_gen2_core_add,
    pm8x100_gen2_pm_serdes_core_init,
    pm8x100_gen2_pm_is_initialized,
    pm8x100_gen2_port_speed_config_validate,
    pm8x100_gen2_pm_enable,
    pm8x100_gen2_pm_logical_pbmp_get,
    pm8x100_gen2_pm_vco_reconfig,
    pm8x100_gen2_port_speed_config_set,
    pm8x100_gen2_port_speed_config_get,
    ...
    pm8x100_gen2_pm_speed_config_validate,
    pm8x100_gen2_pm_vcos_get,
    NULL, /* portmod_pm_specific_vcos_get */
    pm8x100_gen2_port_autoneg_ability_advert_set,
    pm8x100_gen2_port_autoneg_ability_advert_get,
    pm8x100_gen2_port_autoneg_ability_remote_get,
#ifdef CPRIMOD_SUPPORT
...
#endif /* CPRIMOD_SUPPORT */
    pm8x100_gen2_port_tx_set,
    pm8x100_gen2_port_tx_get,
    pm8x100_gen2_port_synce_clk_ctrl_set,
    pm8x100_gen2_port_synce_clk_ctrl_get,
...
#endif /* CPRIMOD_SUPPORT */
    pm8x100_gen2_pm_interrupt_process,
...
#endif /* CPRIMOD_SUPPORT */
    pm8x100_gen2_port_mac_enable_set,
    ...
    pm8x100_gen2_pm_wb_debug_log,
    pm8x100_gen2_port_fec_error_inject_set,
    pm8x100_gen2_port_fec_error_inject_get,
#ifdef CPRIMOD_SUPPORT
    ...
    pm8x100_gen2_port_faults_status_get,
    NULL, /* portmod_port_flr_config_set */
    NULL, /* portmod_port_flr_config_get */
    pm8x100_gen2_port_pmd_rx_lock_status_get,
