...
#define CDMAC_VERSION_PM8X50_FLEXE_GEN2_7NM_B0  0x8000b011
...
int cdmac_init(int unit, soc_port_t port, uint32 init_flags)
{
    ...
    if (soc_reg_field_valid(unit, CDMAC_RX_CTRLr, RX_PASS_PAUSEf)) {
        soc_reg_field_set(unit, CDMAC_RX_CTRLr, &rval, RX_PASS_PAUSEf, 0);
    }
    if (soc_reg_field_valid(unit, CDMAC_RX_CTRLr, RX_PASS_PFCf)) {
...
int cdmac_pass_control_frame_set(int unit, int port, int value)
{
    ...
    if (soc_reg_field_valid(unit, CDMAC_RX_CTRLr, RX_PASS_CTRLf)) {
        /*
...
int cdmac_txfifo_cell_cnt_get(int unit, int port, uint32* val)
{
    ...
    if ((rval == CDMAC_VERSION_PM8X50_GEN2) || (rval == CDMAC_VERSION_PM8X50_FLEXE) ||
        (rval == CDMAC_VERSION_PM8X50_GEN2_7NM_B0) || (rval == CDMAC_VERSION_PM8X50_FLEXE_GEN2_7NM_B0)) {
...
int cdmac_link_fault_os_set(int unit, int port, int is_remote, uint32 enable)
{
    uint32 rval;
    ...
    if (enable) {
        soc_reg_field_set(unit, CDMAC_RX_LSS_CTRLr, &rval, field, 1);
        soc_reg_field_set(unit, CDMAC_RX_LSS_CTRLr, &rval, other_field, 0);
        soc_reg_field_set(unit, CDMAC_RX_LSS_CTRLr, &rval, FAULT_SOURCE_FOR_TXf, 2);
    } else {
        soc_reg_field_set(unit, CDMAC_RX_LSS_CTRLr, &rval, FORCE_REMOTE_FAULT_OSf, 0);
        soc_reg_field_set(unit, CDMAC_RX_LSS_CTRLr, &rval, FORCE_LOCAL_FAULT_OSf, 0);
        soc_reg_field_set(unit, CDMAC_RX_LSS_CTRLr, &rval, FAULT_SOURCE_FOR_TXf, 0);
    }
...
int cdmac_link_fault_os_get(int unit, int port, int is_remote, uint32 * enable)
{
    uint32 rval;
    SOC_INIT_FUNC_DEFS;
    ...
    if (is_remote) {
        *enable = soc_reg_field_get(unit, CDMAC_RX_LSS_CTRLr, rval,
...
int cdmac_preemption_mode_set(int32 unit, soc_port_t port, uint32 enable)
{
    ...
    SOC_IF_ERROR_RETURN(READ_CDMAC_MERGE_CONFIGr(unit, port, &reg_val));
    value = soc_reg_field_get(unit, CDMAC_MERGE_CONFIGr,
                                  reg_val, PREEMPTION_MODEf);

    if (value != enable) {
        soc_reg_field_set(unit, CDMAC_MERGE_CONFIGr,
                              &reg_val, PREEMPTION_MODEf, enable? 1: 0);
        SOC_IF_ERROR_RETURN(WRITE_CDMAC_MERGE_CONFIGr(unit, port, reg_val));
    }
...
int cdmac_preemption_mode_get(int32 unit, soc_port_t port, uint32 *enable)
{
    ...
    SOC_IF_ERROR_RETURN(READ_CDMAC_MERGE_CONFIGr(unit, port, &reg_val));
    *enable = soc_reg_field_get(unit, CDMAC_MERGE_CONFIGr,
                                    reg_val, PREEMPTION_MODEf);
...
int cdmac_preemption_tx_enable_set(int32 unit, soc_port_t port, uint32 enable)
{
    ...
    is_verify_set = soc_reg_field_get(unit, CDMAC_MERGE_CONFIGr,
    ...
    if (enable) {
        /* If verifcation operation is enabled and preemption
         * becomes active after successful verification.
         */
        if (is_verify_set) {
            /*
             ...
             */
            timeout = soc_reg_field_get(unit, CDMAC_MERGE_CONFIGr,
                                            reg_val, VERIFY_TIMEf);
            num_attempts = soc_reg_field_get(unit, CDMAC_MERGE_CONFIGr,
            ...
            SOC_IF_ERROR_RETURN(
                   READ_CDMAC_MERGE_VERIFY_STATEr(unit, port, &v_reg_val));
            verify_status = soc_reg_field_get(unit,
                                                  CDMAC_MERGE_VERIFY_STATEr,
                                                  v_reg_val,
                                                  PREEMPTION_VERIFY_STATUSf);
            if ((verify_status == CDMAC_PREEMPT_VERIFY_SUCCEED) ||
                (verify_status == CDMAC_PREEMPT_VERIFY_FAILED)) {
                verify_op_done = 1;
            }
        ...
        if (verify_op_done) {
            rc = (verify_status == CDMAC_PREEMPT_VERIFY_SUCCEED)? SOC_E_NONE:
                                                                 SOC_E_FAIL;
        }
    }
                                     ...
                                     uint32 *time_val)
{
    ...
    SOC_IF_ERROR_RETURN(READ_CDMAC_MERGE_CONFIGr(unit, port, &reg_val));
    *time_val = soc_reg_field_get(unit, CDMAC_MERGE_CONFIGr,
                                    reg_val, VERIFY_TIMEf);
                                         ...
                                         uint32 num_attempts)
{
    ...
    if (value != num_attempts) {
        SOC_IF_ERROR_RETURN(soc_reg_field_validate(unit, CDMAC_MERGE_CONFIGr,
                                   ...
                                   int flags, uint32 *value)
{
    ...
    SOC_IF_ERROR_RETURN(READ_CDMAC_MERGE_VERIFY_STATEr(unit, port, &reg_val));

    switch (flags) {
        case CDMAC_PREEMPTION_TX_STATUS:
            *value = soc_reg_field_get(unit, CDMAC_MERGE_VERIFY_STATEr,
                                           reg_val, PREEMPTION_TX_STATUSf);
            break;
        case CDMAC_PREEMPTION_VERIFY_STATUS:
            *value = soc_reg_field_get(unit, CDMAC_MERGE_VERIFY_STATEr,
                                           reg_val, PREEMPTION_VERIFY_STATUSf);
            break;
        case CDMAC_PREEMPTION_VERIFY_CNT_STATUS:
            *value = soc_reg_field_get(unit, CDMAC_MERGE_VERIFY_STATEr,
                                           ...
                                           int flags, uint32 value)
{
    ...
    switch (flags) {
        case CDMAC_PREEMPTION_FORCE_SW_RX_EOP:
            /*
            ...
            if (value) {
                ...
                SOC_IF_ERROR_RETURN(
                        WRITE_CDMAC_MERGE_CONFIGr(unit, port, reg_val));
                sal_udelay(10);
            }
            soc_reg_field_set(unit, CDMAC_MERGE_CONFIGr,
            ...
            SOC_IF_ERROR_RETURN(
                    WRITE_CDMAC_MERGE_CONFIGr(unit, port, reg_val));
            break;
        case CDMAC_PREEMPTION_FORCE_AUTO_HW_RX_EOP:
            soc_reg_field_set(unit, CDMAC_MERGE_CONFIGr,
                                         ...
                                         uint32 enable, uint32 timeout_val)
{
    ...
    SOC_IF_ERROR_RETURN(
            READ_CDMAC_MERGE_RX_TIMEOUT_CONFIGr(unit, port, &reg_val));

    soc_reg_field_set(unit, CDMAC_MERGE_RX_TIMEOUT_CONFIGr,
    ...
    SOC_IF_ERROR_RETURN(
            WRITE_CDMAC_MERGE_RX_TIMEOUT_CONFIGr(unit, port, reg_val));
                                         ...
                                         uint32 *enable, uint32 *timeout_val)
{
    ...
    *enable = soc_reg_field_get(unit, CDMAC_MERGE_RX_TIMEOUT_CONFIGr,
                                    reg_val, TIMEOUT_ENABLEf);

    *timeout_val = soc_reg_field_get(unit, CDMAC_MERGE_RX_TIMEOUT_CONFIGr,
                                         reg_val, TIMEOUT_CNTf);

    return SOC_E_NONE;
}

int cdmac_preemption_rx_frag_size_set(int unit, soc_port_t port,
                                      uint32 frag, uint32 value)
{
    ...
    SOC_IF_ERROR_RETURN(
        READ_CDMAC_MERGE_MIB_MIN_FRAG_SIZEr(unit, port, &reg_val));

    if (frag == CDMAC_PREEMPTION_FINAL_FRAG) {
        field = MIN_FINAL_FRAG_SIZEf;
    } else {
        field = MIN_NON_FINAL_FRAG_SIZEf;
    }

    soc_reg_field_set(unit, CDMAC_MERGE_MIB_MIN_FRAG_SIZEr, &reg_val, field, value);
    SOC_IF_ERROR_RETURN(
        WRITE_CDMAC_MERGE_MIB_MIN_FRAG_SIZEr(unit, port, reg_val));

    return SOC_E_NONE;
}

int cdmac_preemption_rx_frag_size_get(int unit, soc_port_t port,
                                      uint32 frag, uint32 *value)
{
    uint32 reg_val;
    soc_field_t field;
    ...
    *value = soc_reg_field_get(unit, CDMAC_MERGE_MIB_MIN_FRAG_SIZEr, reg_val, field);
