 ...
 */
sal_field_type_e
sal_field_scan_str(char *source, sal_field_type_e in_field_type, void *value, int value_size) SAL_ATTR_WEAK;
 ...
 */
void
sal_field_format_str(char *target, int target_size, sal_field_type_e out_field_type, void *value, int value_size) SAL_ATTR_WEAK;
 ...
 */
char*
sal_field_type_str(sal_field_type_e field_type) SAL_ATTR_WEAK;
 ...
 */
sal_field_type_e
sal_field_type_by_name(char *field_type_name) SAL_ATTR_WEAK;
