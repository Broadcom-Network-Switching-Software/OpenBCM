...
extern uint32 sal_boot_flags_get(void) SAL_ATTR_WEAK;
extern void sal_boot_flags_set(uint32) SAL_ATTR_WEAK;
extern char *sal_boot_script(void) SAL_ATTR_WEAK;
...
extern void sal_assert_set(sal_assert_func_t f) SAL_ATTR_WEAK;
extern void _default_assert(const char *expr, const char *file, int line) SAL_ATTR_WEAK;


/*
 * Init
 */
extern int sal_core_init(void) SAL_ATTR_WEAK;

/*
 * Clean up resources created during sal_core_init
 */
extern void sal_core_cleanup(void) SAL_ATTR_WEAK;

/*
 * Returns a string describing the current Operating System
 */
extern const char* sal_os_name(void) SAL_ATTR_WEAK;
