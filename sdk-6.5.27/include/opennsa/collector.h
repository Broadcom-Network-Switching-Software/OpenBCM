...
/* Collector info flags. */
#define BCM_COLLECTOR_INFO_FLAGS_IFA2   (1U << 0)  /* Indicate the source of the
                                                      collector is IFA 2.0 or
                                                      above. */
...
typedef struct bcm_collector_info_s {
    ...
    uint32 flags;                       /* See BCM_COLLECTOR_INFO_xxx flag
                                           definitions. */
