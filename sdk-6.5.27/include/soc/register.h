...
extern int soc_reg_above_64_get_actual_size(int unit, soc_reg_t reg, int port, int index, uint32 *data);
extern int soc_reg_above_64_set(int unit, soc_reg_t reg, int port, int index, 
                soc_reg_above_64_val_t data);
extern int soc_reg_above_64_set_actual_size(int unit, soc_reg_t reg, int port, int index, uint32 *data);
...
extern int soc_reg_above_64_field_get_actual_size(int unit, soc_reg_t reg, uint32 *regval, soc_field_t field, uint32 *field_val);
...
extern int soc_reg_above_64_field_set_actual_size(int unit, soc_reg_t reg, uint32 *regval, soc_field_t field, CONST uint32 *value);
...
extern int soc_is_reg_framer(int unit, soc_reg_t reg);
