...
extern int soc_tomahawk_sbus_ring_map_dump(int unit);
...
extern int
soc_tomahawk_voltage_monitor_get(int unit, int* avg_voltage);
...
extern int soc_th_ser_single_bit_report_for_bus_buf_get(int unit, int *enable);
...
typedef struct _soc_th_rtag7_flow_hash_entry_s {
    uint8 sub_sel;
    uint8 offset;
    uint8 concat;
} soc_th_rtag7_flow_hash_entry_t;

extern void
soc_th_rtag7_flow_hash_entry_shuffle(
    soc_th_rtag7_flow_hash_entry_t *entry,
    int cnt,
    uint32 seed);

extern void
soc_th_rtag7_flow_hash_entry_order(
    soc_th_rtag7_flow_hash_entry_t *entry,
    soc_th_rtag7_flow_hash_entry_t *entry_insert,
    int *entry_cur_cnt);
