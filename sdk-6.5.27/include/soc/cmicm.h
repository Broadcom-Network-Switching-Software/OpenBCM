...
#define CMIC_COMMON_CMCx_SCHAN_ACK_DATA_BEAT_COUNT_OFFSET(cmc) (cmc == CMIC_CMC_NUM_MAX) ? \
            CMIC_COMMON_SCHAN_ACK_DATA_BEAT_COUNT_OFFSET : \
            CMIC_CMCx_SCHAN_ACK_DATA_BEAT_COUNT_OFFSET(cmc)
