...
/*******************************************
* @function soc_cmicx_miim_cycle_type_get
* purpose return MDIO CYCLE type depending on if this data only mode
*
* @param unit [in] unit #
* @param unit [in] is_write - whether to perform read or write operation
* @param unit [in] clause45 - clause 45 or clause 22
* @param unit [in] phy_devad - phy device address
*
* @returns MDIO cycel
*
* @end
