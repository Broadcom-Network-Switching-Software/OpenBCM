...
typedef enum soc_phy_control_e {
    ...
    SOC_PHY_CONTROL_CODEC_MODE_CL49 = _SHR_PORT_PHY_CONTROL_CODEC_MODE_CL49,
    SOC_PHY_CONTROL_CODEC_MODE_CL82 = _SHR_PORT_PHY_CONTROL_CODEC_MODE_CL82,
    SOC_PHY_CONTROL_CODEC_MODE_REDUCED_IPG = _SHR_PORT_PHY_CONTROL_CODEC_MODE_REDUCED_IPG,
    SOC_PHY_CONTROL_AN_LINK_FAIL_INHIBIT_TIMER_LT_PAM4 = _SHR_PORT_PHY_CONTROL_AN_LINK_FAIL_INHIBIT_TIMER_LT_PAM4,
    SOC_PHY_CONTROL_RS_FEC_BIT_ERROR_COUNT = _SHR_PORT_PHY_CONTROL_RS_FEC_BIT_ERROR_COUNT,
    SOC_PHY_CONTROL_RX_DC_OFFSET = _SHR_PORT_PHY_CONTROL_RX_DC_OFFSET,
...
typedef enum soc_phy_control_scramble_mode_e {
    SOC_PHY_CONTROL_SCRAMBLE_OFF     = _SHR_PORT_PHY_SCRAMBLE_OFF,
    SOC_PHY_CONTROL_SCRAMBLE_ON      = _SHR_PORT_PHY_SCRAMBLE_ON,
    SOC_PHY_CONTROL_SCRAMBLE_DEFAULT = _SHR_PORT_PHY_SCRAMBLE_DEFAULT
}soc_phy_control_scramble_mode_t;
...
#define SOC_PHYCTRL_MAX_LANES_PER_CORE 12
...
typedef struct soc_phy_diag_stats_s {
    uint32 pcs_bip_err_count[SOC_PHYCTRL_MAX_LANES_PER_CORE]; /**< BIP error count per lane */
    uint32 pcs_ber_count[SOC_PHYCTRL_MAX_LANES_PER_CORE];     /**< BER count per lane */
} soc_phy_diag_stats_t;
...
/*
 * phy_addr encoding
 * bit31-16, bitmap for MDIO bus. Bit 16 represents bus 0,
 *           bit 17 represents bus 1, and so on.
...
typedef struct soc_phy_signal_detect_status_s {
    ...
    uint32 signal_detect_change_bmp;    /* The lane bitmap indicates PHY signal
                                           ...
                                           read. */
} soc_phy_signal_detect_status_t;
