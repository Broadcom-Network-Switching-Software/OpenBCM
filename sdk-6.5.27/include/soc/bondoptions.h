...
typedef enum {
    ...
    socBondInfoFeatureEfp256HalfSlice,/* EFP Half Slice (256) */
    socBondInfoFeatureEfp512HalfSlice,/* EFP Half Slice (512) */
    socBondInfoFeatureEfp3kHalfSlice,/* EFP Half Slice (3k) */
    socBondInfoFeatureVfp64HalfSlice,/* VFP Half Slice (64) */
    socBondInfoFeatureVfp256HalfSlice,/* VFP Half Slice (256) */
    ...
    socBondInfoFeatureIpmc2k,               /* 2K IPMC */
...
typedef struct soc_bond_info_s {
    ...
    uint32 clk_to_pm_clk_factor;    /*   4b:   CLK_TO_CLK_NX_FACTOR    */
