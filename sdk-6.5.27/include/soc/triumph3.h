...
#define SOC_TR3_SET_POLICY_TABLE_SIZE(unit, table1, table2, table3, table4, table6, \
                                      policy_width, num_entries)\
do {\
    switch ((policy_width)) {\
    case 1:\
        SOP_MEM_STATE_MAX_INDEX_SET(unit, table1, num_entries);\
        break;\
    case 2:\
        SOP_MEM_STATE_MAX_INDEX_SET(unit, table2, num_entries);\
        break;\
    case 3:\
        SOP_MEM_STATE_MAX_INDEX_SET(unit, table3, num_entries);\
        break;\
    case 4:\
        SOP_MEM_STATE_MAX_INDEX_SET(unit, table4, num_entries);\
        break;\
    case 6:\
        SOP_MEM_STATE_MAX_INDEX_SET(unit, table6, num_entries);\
        break;\
    default: \
