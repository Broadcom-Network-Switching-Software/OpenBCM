...
#define SOC_PORT_PHY_TIMESYNC_TWO_STEP_ENABLE _SHR_PORT_PHY_TIMESYNC_TWO_STEP_ENABLE /* Enable two step Timesamping in Serdes */
#define SOC_PORT_PHY_TIMESYNC_SELECT_SFD _SHR_PORT_PHY_TIMESYNC_SELECT_SFD /* Select SFD as timestam alignment, Oterwise check MAC_DA */
#define SOC_PORT_PHY_TIMESYNC_COMP_MODE_ON  _SHR_PORT_PHY_TIMESYNC_COMP_MODE_ON /* Turn on the
                                                          Compensation Mode.
                                                          Check LATEST_LANE bit */
#define SOC_PORT_PHY_TIMESYNC_COMP_MODE_LATEST_LANE _SHR_PORT_PHY_TIMESYNC_COMP_MODE_LATEST_LANE /* This bit is  Valid Only
                                                          when COMP_MODE_ON is
                                                          set.  Compensation
                                                          Latest Lane Mode 1.
                                                          Compensation Earliest
                                                          Lane Mode 0 */
#define SOC_PORT_PHY_TIMESYNC_SELECT_MAC_DA _SHR_PORT_PHY_TIMESYNC_SELECT_MAC_DA /* Select MAC_DA as timestamp location, Oterwise SOP */
...
/* Timesync AM Norm mode */
typedef _shr_port_phy_timesync_compensation_mode_t soc_port_phy_timesync_compensation_mode_t;
...
/* soc_port_phy_timesync_tx_info_get */
extern int soc_port_phy_timesync_tx_info_get(
    int unit,
    soc_port_t port,
