...
extern int      soc_cmicx_dma_ctrl_release_cpu_credits(int unit, int reset);
#endif
...
#if defined(SRC_SOC_COMMON_ACTIVATE_UNUSED) || defined(BCM_ESW_SUPPORT) || defined(BCM_CMICM_SUPPORT)
...
#if defined(SRC_SOC_COMMON_ACTIVATE_UNUSED) || defined(BCM_ESW_SUPPORT) ||  defined (BCM_DFE_SUPPORT)|| defined (BCM_PETRA_SUPPORT)
