...
#define FE3200_PORT_PCS_8_10_EFFECTIVE_RATE_PERCENT (80)
...
soc_error_t soc_fe3200_port_rate_egress_ppt_set(int unit, soc_port_t port, uint32 burst, uint32 nof_tiks);
soc_error_t soc_fe3200_port_rate_egress_ppt_get(int unit, soc_port_t port, uint32 *burst, uint32 *nof_tiks);
soc_error_t soc_fe3200_port_fault_get(int unit, soc_port_t port, uint32* flags);
soc_error_t soc_fe3200_port_dynamic_port_update(int unit, int port, int enable, soc_dfe_port_update_type_t type);
soc_error_t soc_fe3200_port_bucket_fill_rate_validate(int unit, uint32 bucket_fill_rate);
