...
typedef enum
{
    ...
    dnxf_data_module_testing_submodule_max_test,
...
int dnxf_data_module_testing_max_test_feature_get(
    int unit,
...
typedef enum
{
    dnxf_data_module_testing_max_test_define_greater_d3,
    dnxf_data_module_testing_max_test_define_greater_d1,
    dnxf_data_module_testing_max_test_define_same_value,
    dnxf_data_module_testing_max_test_define_d1_undefined,
    dnxf_data_module_testing_max_test_define_d3_undefined,

    
    _dnxf_data_module_testing_max_test_define_nof
} dnxf_data_module_testing_max_test_define_e;



uint32 dnxf_data_module_testing_max_test_greater_d3_get(
    int unit);


uint32 dnxf_data_module_testing_max_test_greater_d1_get(
    int unit);


uint32 dnxf_data_module_testing_max_test_same_value_get(
    int unit);


uint32 dnxf_data_module_testing_max_test_d1_undefined_get(
    int unit);


uint32 dnxf_data_module_testing_max_test_d3_undefined_get(
    int unit);
...
typedef enum
{
    ...
    _dnxf_data_module_testing_max_test_table_nof
} dnxf_data_module_testing_max_test_table_e;
