...
typedef enum
{
    ...
    dnxf_data_intr_general_define_ser_event_generate_support,
    dnxf_data_intr_general_define_ser_reset_cb_en_support,
...
uint32 dnxf_data_intr_general_ser_event_generate_support_get(
    int unit);


uint32 dnxf_data_intr_general_ser_reset_cb_en_support_get(
    int unit);
...
typedef enum
{
    ...
    dnxf_data_intr_general_table_skip_clear_on_regress,
    dnxf_data_intr_general_table_block_intr_field_mapping,
    dnxf_data_intr_general_table_chip_intr_remap,
    dnxf_data_intr_general_table_chip_intr_enable,
...
const dnxf_data_intr_general_skip_clear_on_regress_t * dnxf_data_intr_general_skip_clear_on_regress_get(
    int unit,
    int offset);


const dnxf_data_intr_general_block_intr_field_mapping_t * dnxf_data_intr_general_block_intr_field_mapping_get(
    int unit,
    int offset);


const dnxf_data_intr_general_chip_intr_remap_t * dnxf_data_intr_general_chip_intr_remap_get(
    int unit,
    int offset);


const dnxf_data_intr_general_chip_intr_enable_t * dnxf_data_intr_general_chip_intr_enable_get(
    int unit,
    int offset);
...
shr_error_e dnxf_data_intr_general_skip_clear_on_regress_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
shr_error_e dnxf_data_intr_general_block_intr_field_mapping_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
shr_error_e dnxf_data_intr_general_chip_intr_remap_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
shr_error_e dnxf_data_intr_general_chip_intr_enable_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
const dnxc_data_table_info_t * dnxf_data_intr_general_skip_clear_on_regress_info_get(
    int unit);


const dnxc_data_table_info_t * dnxf_data_intr_general_block_intr_field_mapping_info_get(
    int unit);


const dnxc_data_table_info_t * dnxf_data_intr_general_chip_intr_remap_info_get(
    int unit);


const dnxc_data_table_info_t * dnxf_data_intr_general_chip_intr_enable_info_get(
    int unit);
