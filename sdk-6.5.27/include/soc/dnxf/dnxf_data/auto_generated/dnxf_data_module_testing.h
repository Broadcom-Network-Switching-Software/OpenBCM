...
typedef enum
{
    ...
    _dnxf_data_module_testing_max_test_feature_nof
} dnxf_data_module_testing_max_test_feature_e;



typedef int(
    *dnxf_data_module_testing_max_test_feature_get_f) (
    int unit,
    dnxf_data_module_testing_max_test_feature_e feature);


typedef uint32(
    *dnxf_data_module_testing_max_test_greater_d3_get_f) (
    int unit);


typedef uint32(
    *dnxf_data_module_testing_max_test_greater_d1_get_f) (
    int unit);


typedef uint32(
    *dnxf_data_module_testing_max_test_same_value_get_f) (
    int unit);


typedef uint32(
    *dnxf_data_module_testing_max_test_d1_undefined_get_f) (
    int unit);


typedef uint32(
    *dnxf_data_module_testing_max_test_d3_undefined_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnxf_data_module_testing_max_test_feature_get_f feature_get;
    
    dnxf_data_module_testing_max_test_greater_d3_get_f greater_d3_get;
    
    dnxf_data_module_testing_max_test_greater_d1_get_f greater_d1_get;
    
    dnxf_data_module_testing_max_test_same_value_get_f same_value_get;
    
    dnxf_data_module_testing_max_test_d1_undefined_get_f d1_undefined_get;
    
    dnxf_data_module_testing_max_test_d3_undefined_get_f d3_undefined_get;
} dnxf_data_if_module_testing_max_test_t;
...
typedef struct
{
    ...
    dnxf_data_if_module_testing_max_test_t max_test;
