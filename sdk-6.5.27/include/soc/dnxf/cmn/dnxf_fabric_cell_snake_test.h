...
#define SOC_DNXF_SNAKE_TEST_INTERRUPT_RESULT_SIZE_IN_WORDS \
    (SOC_REG_ABOVE_64_MAX_SIZE_U32 * 4)

typedef struct soc_dnxf_fabric_cell_snake_test_results_s
{
    int test_failed;
    uint32 interrupts_status[SOC_DNXF_SNAKE_TEST_INTERRUPT_RESULT_SIZE_IN_WORDS];
