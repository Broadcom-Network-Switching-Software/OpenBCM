...
typedef int (
    *mbcm_dnxf_drv_fmac_bmp_to_internal_block_bmp_convert_f) (
    int unit,
    soc_pbmp_t fmac_bmp,
...
typedef shr_error_e(
    *mbcm_dnxf_cgm_register_field_max_value_get_f) (
    int unit,
    soc_reg_t reg_name,
...
typedef shr_error_e(
    *mbcm_dnxf_port_local_fault_get_f) (
    int unit,
    soc_port_t port,
    int *value);

typedef shr_error_e(
    *mbcm_dnxf_port_remote_fault_get_f) (
    int unit,
    soc_port_t port,
    int *value);

typedef shr_error_e(
    *mbcm_dnxf_port_local_fault_clear_f) (
    int unit,
    soc_port_t port);

typedef shr_error_e(
    *mbcm_dnxf_port_remote_fault_clear_f) (
    int unit,
    soc_port_t port);
...
typedef shr_error_e(
    *mbcm_dnxf_port_blocks_power_disable_f) (
    int unit,
...
typedef int (
    *mbcm_dnxf_temperature_monitors_get_f) (
    int unit,
...
typedef shr_error_e(
    *mbcm_dnxf_port_internal_blocks_power_down_get_f) (
    int unit,
    int block_type,
    soc_pbmp_t * block_bmp);

typedef shr_error_e(
    *mbcm_dnxf_port_signal_quality_control_set_f) (
    int unit,
    soc_port_t port,
    soc_dnxf_port_signal_quality_t type,
    int value);

typedef shr_error_e(
    *mbcm_dnxf_port_signal_quality_control_get_f) (
    int unit,
    soc_port_t port,
    soc_dnxf_port_signal_quality_t type,
    int *value_p);
...
typedef shr_error_e(
    *mbcm_dnxf_port_signal_quality_error_info_get_f) (
    int unit,
    soc_port_t port,
...
typedef shr_error_e(
    *mbcm_dnxf_drv_reset_init_f) (
    int unit);

typedef shr_error_e(
    *mbcm_dnxf_drv_reset_deinit_f) (
    int unit);

typedef shr_error_e(
    *mbcm_dnxf_drv_interrupts_init_f) (
    int unit);

typedef shr_error_e(
    *mbcm_dnxf_drv_interrupts_deinit_f) (
    int unit);

typedef shr_error_e(
    *mbcm_dnxf_drv_ser_init_f) (
    int unit);

typedef shr_error_e(
    *mbcm_dnxf_cell_tx_init_f) (
    int unit);
...
typedef struct mbcm_dnxf_functions_s
{
    ...
    mbcm_dnxf_drv_fmac_bmp_to_internal_block_bmp_convert_f mbcm_dnxf_drv_fmac_bmp_to_internal_block_bmp_convert;
    ...
    mbcm_dnxf_cgm_register_field_max_value_get_f mbcm_dnxf_cgm_register_field_max_value_get;
    mbcm_dnxf_cgm_register_set_f mbcm_dnxf_cgm_register_set;
    mbcm_dnxf_cgm_register_get_f mbcm_dnxf_cgm_register_get;
    ...
    mbcm_dnxf_port_local_fault_get_f mbcm_dnxf_port_local_fault_get;
    mbcm_dnxf_port_remote_fault_get_f mbcm_dnxf_port_remote_fault_get;
    mbcm_dnxf_port_local_fault_clear_f mbcm_dnxf_port_local_fault_clear;
    mbcm_dnxf_port_remote_fault_clear_f mbcm_dnxf_port_remote_fault_clear;
    mbcm_dnxf_port_speed_max_f mbcm_dnxf_port_speed_max;
    mbcm_dnxf_port_blocks_power_disable_f mbcm_dnxf_port_blocks_power_disable;
    ...
    mbcm_dnxf_sync_e_init_f mbcm_dnxf_synce_init;
    ...
    mbcm_dnxf_temperature_monitors_get_f mbcm_dnxf_temperature_monitors_get;
    ...
    mbcm_dnxf_tx_prepare_f mbcm_dnxf_tx_prepare;
    ...
    mbcm_dnxf_port_internal_blocks_power_down_get_f mbcm_dnxf_port_internal_blocks_power_down_get;
    mbcm_dnxf_port_signal_quality_control_set_f mbcm_dnxf_port_signal_quality_control_set;
    mbcm_dnxf_port_signal_quality_control_get_f mbcm_dnxf_port_signal_quality_control_get;
    mbcm_dnxf_port_signal_quality_error_info_get_f mbcm_dnxf_port_signal_quality_error_info_get;
    ...
    mbcm_dnxf_drv_reset_init_f mbcm_dnxf_drv_device_reset_init;
    mbcm_dnxf_drv_reset_deinit_f mbcm_dnxf_drv_device_reset_deinit;
    mbcm_dnxf_drv_interrupts_init_f mbcm_dnxf_drv_interrupts_init;
    mbcm_dnxf_drv_interrupts_deinit_f mbcm_dnxf_drv_interrupts_deinit;
    mbcm_dnxf_drv_ser_init_f mbcm_dnxf_drv_ser_init;
    mbcm_dnxf_cell_tx_init_f mbcm_dnxf_cell_tx_init;
