...
typedef enum
{
    ...
    DNXC_INT_CORR_ACT_ILKN_RX_LANE_LOCK_STATUS_CHANGE = SAND_INT_CORR_ACT_ILKN_RX_LANE_LOCK_STATUS_CHANGE,
    ...
    DNXC_INT_CORR_ACT_MSS_MACSEC_SA_EXPIRY = SAND_INT_CORR_ACT_MSS_MACSEC_SA_EXPIRY,
    DNXC_INT_CORR_ACT_MSD_MACSEC_SA_EXPIRY = SAND_INT_CORR_ACT_MSD_MACSEC_SA_EXPIRY,
    DNXC_INT_CORR_ACT_MSW_MACSEC_SA_EXPIRY = SAND_INT_CORR_ACT_MSW_MACSEC_SA_EXPIRY,
    DNXC_INT_CORR_ACT_KAPS_TECC = SAND_INT_CORR_ACT_KAPS_TECC,
    DNXC_INT_CORR_ACT_EPNI_TOTAL_INC_ABOVE_TH_WITH_EBD = SAND_INT_CORR_ACT_EPNI_TOTAL_INC_ABOVE_TH_WITH_EBD,
    DNXC_INT_CORR_ACT_EPNI_EBD_ERR_INT = SAND_INT_CORR_ACT_EPNI_EBD_ERR_INT,
    DNXC_INT_CORR_ACT_SIGNAL_QUALITY_ERR_INT = SAND_INT_CORR_ACT_SIGNAL_QUALITY_ERR_INT,
    DNXC_INT_CORR_ACT_RETRAIN_LINK = SAND_INT_CORR_ACT_RETRAIN_LINK,
    DNXC_INT_CORR_ACT_TCAM_SCAN_ECC_1B = SAND_INT_CORR_ACT_TCAM_SCAN_ECC_1B,
    DNXC_INT_CORR_ACT_TCAM_SCAN_ECC_2B = SAND_INT_CORR_ACT_TCAM_SCAN_ECC_2B,
    DNXC_INT_CORR_ACT_NANOSYNC_TAS_TOD_UPDATE = SAND_INT_CORR_ACT_NANOSYNC_TAS_TOD_UPDATE,
    DNXC_INT_CORR_ACT_W40_FLR = SAND_INT_CORR_ACT_W40_FLR,
    DNXC_INT_CORR_ACT_RESET_FABRIC_LINK = SAND_INT_CORR_ACT_RESET_FABRIC_LINK,
...
int _dnxc_ser_event_support(
    int unit);
int _dnxc_ser_event_generate(
    int unit,
    uint32 blk,
    uint32 addrf,
    sand_memory_dc_t dc_type);
int dnxc_is_mdb_physical_mem(
    int unit,
    soc_mem_t mem);
int dnxc_mem_mdb_ser_alias(
    int unit,
    soc_mem_t * mem);
...
int dnxc_interrupt_handles_corrective_action_tcam_ecc_2bits_done(
    int unit,
    int block_instance);
...
int dnxc_decide_interrupt_action_fmac_print_link(
    ...
    char *special_msg,
    const char *msg);
int dnxc_signal_quality_interrupt_handling(
    int unit,
    int block_instance,
    uint32 en_interrupt,
    char *msg);
int dnxc_decide_interrupt_action_fmac_tuning_serdes(
    ...
    dnxc_int_corr_act_type * p_corrective_action,
    char *special_msg);
int dnxc_interrupt_handles_corrective_action_reset_fabric_link(
    int unit,
    int block_instance,
    uint32 interrupt_id,
    char *msg);
