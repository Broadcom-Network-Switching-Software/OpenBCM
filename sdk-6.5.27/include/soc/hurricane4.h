...
/* MODPORT_MAP_SUBPORT_M0/M1/M2/M3 size */
#define SOC_HR4_MODPORT_MAP_SUBPORT_M0_SIZE 584
...
#define SOC_HR4_PORT_BLOCK_BASE_PHY_PORT(phy_port)                             \
    ((phy_port >= 57) ?                   \
     (57 + ((phy_port - 57) & ~0x3)) :    \
     (phy_port >= 25) ?                   \
     (25 + ((phy_port - 25) & ~0xF)) :    \
...
extern int soc_hr4_cosq_threshold_dynamic_change_check(
    int unit,
    int new_threshold,
    soc_reg_t ctr_reg,
...
extern int soc_hurricane4_port_blk_reset(int unit, int blk);
...
#define _HR4_MMU_TOTAL_CELLS_PER_XPE     16384 /* 4MB internal buffer, cellsize 256B ((4*1024*1024)/256) */
#define _TD3X1_MMU_TOTAL_CELLS_PER_XPE   8192 /* 2MB internal buffer, cellsize 256B ((2*1024*1024)/256) */
#define _WH3_MMU_TOTAL_CELLS_PER_XPE     6144 /* 1.5MB internal buffer, cellsize 256B ((1.5*1024*1024)/256) */
...
#define _HR4_MMU_ISEC_CELLS_RSVD_PER_XPE 900    /* Reserved cells for MACSEC decrypt port per XPE */
...
extern int soc_hr4_xflow_macse_svtag_dot1p_map_add(int unit,
                                            bcm_qos_map_t *map);
extern int soc_hr4_xflow_macse_svtag_dot1p_map_delete(int unit,
                                            bcm_qos_map_t *map);
extern int soc_hr4_sec_sa_table_mem_write_special(int unit, uint32 flags, soc_mem_t mem_orig,
