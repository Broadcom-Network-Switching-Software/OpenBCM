...
int portmod_common_phy_sbus_reg_write_access(soc_mem_t reg_access_mem, void* user_acc, uint32_t core_addr, uint32_t reg_addr, uint32_t val);
int portmod_common_phy_sbus_reg_read_access(soc_mem_t reg_access_mem, void* user_acc, uint32_t core_addr, uint32_t reg_addr, uint32_t *val);
#endif
