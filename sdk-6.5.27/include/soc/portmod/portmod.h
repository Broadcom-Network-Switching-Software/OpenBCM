...
#define PORTMOD_PORT_PHY_FEC_COUNT  _SHR_PORT_PHY_FEC_COUNT /**< Fec type count */
...
#define PORTMOD_PORT_PHY_MEDIUM_COUNT _SHR_PORT_MEDIUM_COUNT
...
#define PORTMOD_PORT_PHY_PAUSE_COUNT _SHR_PORT_PHY_PAUSE_COUNT
...
#define PORTMOD_PORT_PHY_CHANNEL_COUNT _SHR_PORT_PHY_CHANNEL_COUNT
...
#define PORTMOD_PORT_PHY_CONTROL_AUTONEG_MODE_COUNT _SHR_PORT_PHY_CONTROL_AUTONEG_MODE_COUNT
...
#define PORTMOD_SPEED_CONFIG_F_TRANSPARENT_AM 0x2 /**< Transparent AM configuration */
...
#define PORTMOD_SPEED_CONFIG_F_TRANSPARENT_AM_SET(speed_config) ((speed_config)->flags |= PORTMOD_SPEED_CONFIG_F_TRANSPARENT_AM)
...
#define PORTMOD_SPEED_CONFIG_F_TRANSPARENT_AM_CLR(speed_config) ((speed_config)->flags &= ~PORTMOD_SPEED_CONFIG_F_TRANSPARENT_AM)
...
#define PORTMOD_SPEED_CONFIG_F_TRANSPARENT_AM_GET(speed_config) ((speed_config)->flags & PORTMOD_SPEED_CONFIG_F_TRANSPARENT_AM ? 1 : 0)
 ...
 *
 * @brief  Get Control Message Configuration..  
 *
 * @param [in]  unit            - unit id
 * @param [in]  port            - logical port
 * @param [in]  flow_id         - Control Flow ID. 
...
#ifdef CPRIMOD_SUPPORT
typedef _shr_rsvd4_control_group_entry_t portmod_rsvd4_control_group_entry_t;
 ...
 *
 * @brief  Get member information from  the Tx Control Flow Group..  
 *
 * @param [in]  unit            - unit id
 * @param [in]  port            - logical port
 * @param [in]  group_id        - Group Number 0 or 1. 
 ...
 *
 * @brief  Set/Get RSVD4 Single Raw Control Message Configuration..  
 *
 * @param [in]  unit            - unit id
 * @param [in]  port            - logical port
 ...
 *
 * @brief  Set/Get CPRI port RoE frame formation configuration. 
 *
 * @param [in]  unit            - unit id
 * @param [in]  port            - logical port
...
#ifdef PORTMOD_DIAG
extern enum_mapping_t portmod_flr_timeout_t_mapping[];
#endif /*PORTMOD_DIAG*/
...
#ifdef PORTMOD_DIAG
extern enum_mapping_t portmod_mac_rsv_fields_t_mapping[];
#endif /*PORTMOD_DIAG*/
...
#ifdef PORTMOD_DIAG
extern enum_mapping_t portmod_mac_tx_crc_mode_t_mapping[];
#endif /*PORTMOD_DIAG*/
 ...
 */
int portmod_port_external_los_enable_set(int unit, int port, uint32 enable);
/*! 
 ...
 */
int portmod_port_external_los_enable_get(int unit, int port, uint32* enable);
