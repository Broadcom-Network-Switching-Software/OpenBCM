...
int pm8x50_fabric_port_phase_interpolator_rx_set(int unit, int port, pm_info_t pm_info, int enable);

/*Port pass through phase interpolator tx set*/
int pm8x50_fabric_port_phase_interpolator_tx_set(int unit, int port, pm_info_t pm_info, int enable);
...
/*Port fmac egress shaper ppt set\get*/
int pm8x50_fabric_port_rate_egress_ppt_set(int unit, int port, pm_info_t pm_info, uint32 burst, uint32 nof_tiks);
int pm8x50_fabric_port_rate_egress_ppt_get(int unit, int port, pm_info_t pm_info, uint32* burst, uint32* nof_tiks);
