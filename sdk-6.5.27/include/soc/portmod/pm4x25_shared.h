...
typedef enum pm4x25_fabric_wb_vars{
    ...
    roePortFrameFormat,   /* Port frame format for RoE port. */
    timesyncEnable,       /* timesync setting on phy */
}pm4x25_wb_vars_t;
...
int pm4x25_port_tsc_is_master_pll(int unit, int port, pm_info_t pm_info);
...
#define PM4x25_CPRI_PORT_FRAME_FORMAT_SET(unit, pm_info, frame_format, lane_index) \
    SOC_WB_ENGINE_SET_ARR(unit, SOC_WB_ENGINE_PORTMOD, pm_info->wb_vars_ids[roePortFrameFormat], \
                          &frame_format, lane_index)
#define PM4x25_CPRI_PORT_FRAME_FORMAT_GET(unit, pm_info, frame_format, lane_index) \
    SOC_WB_ENGINE_GET_ARR(unit, SOC_WB_ENGINE_PORTMOD, pm_info->wb_vars_ids[roePortFrameFormat],    \
                          frame_format, lane_index)

#define PM4x25_TIMESYNC_CONFIG_SET(unit, pm_info, timesync_config, port_index) \
        SOC_WB_ENGINE_SET_ARR(unit, SOC_WB_ENGINE_PORTMOD,                       \
                              pm_info->wb_vars_ids[timesyncEnable], &timesync_config, port_index)
#define PM4x25_TIMESYNC_CONFIG_GET(unit, pm_info, timesync_config, port_index) \
        SOC_WB_ENGINE_GET_ARR(unit, SOC_WB_ENGINE_PORTMOD,                       \
                              pm_info->wb_vars_ids[timesyncEnable], timesync_config, port_index)
