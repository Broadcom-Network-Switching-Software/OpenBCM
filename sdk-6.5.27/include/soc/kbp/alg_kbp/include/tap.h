...
kbp_status kbp_tap_db_pa_entry_get_value(struct kbp_tap_db *db, uint32_t clear_counter,
                                         uint32_t entry_num, uint32_t counter_offset,
                                         uint64_t *value);


kbp_status kbp_tap_db_pa_entry_pair_get_value(struct kbp_tap_db *db, uint32_t clear_counter,
                                              uint32_t entry_num, uint32_t counter_offset,
