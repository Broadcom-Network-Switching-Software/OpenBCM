...
int cprif_drv_tx_framer_tgen_enable_set (int unit, int port, uint32 enable);
int cprif_drv_tx_framer_tgen_enable_get (int unit, int port, uint32 *enable);
...
int cprif_drv_top_ctrl_config_ref_clk_in_enable_set(int unit, int port,
                                                    int pll_num, int refin);
int cprif_drv_top_ctrl_config_ref_clk_in_enable_get(int unit, int port,
                                                    int pll_num, int *refin);
int cprif_drv_top_ctrl_config_ref_clk_out_enable_set(int unit, int port,
                                                     int pll_num, int refout);
int cprif_drv_top_ctrl_config_ref_clk_out_enable_get(int unit, int port,
                                                     int pll_num, int *refout);
