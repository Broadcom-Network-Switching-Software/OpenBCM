...
int cprif_encap_header_config_get(int unit, int port, uint32 queue_num, cprimod_cpri_roe_frame_format_t frame_format, cprimod_encap_header_config_t* config_info);
...
/*  Set/Get Tx Framer Tgen Enable/Disable.  */
...
/* Header Compare Entry Delete by Flow ID only.  */
int cprif_header_compare_entry_for_flow_get(int unit, int port, uint8 flow_id, cprimod_flow_type_t flow_type, cprimod_header_compare_entry_t* compare_entry);
...
/*Core Initialization*/
int cprif_core_init(int unit, int port, const phymod_core_access_t* phy, const phymod_core_init_config_t* init_config, int master_pll, phymod_core_status_t* core_status);
...
/* Get member from the Tx Control Flow Group.. */
int cprif_rsvd4_tx_control_flow_group_member_get(int unit, int port, uint32 group_id, uint32 priority, uint32* queue_num, cprimod_control_msg_proc_type_t* proc_type);

/* Get Group member information from  the Tx Control Flow Group.. */
int cprif_rsvd4_tx_control_flow_group_member_get_all(int unit, int port, uint32 group_id, cprimod_rsvd4_control_group_entry_t* group_config);
...
/* Set CPRI port CLK disable value active 1. */
...
/*function to get board lane swap. */
int cprif_cpri_port_lane_map_get(int unit, int port, uint32 flags, phymod_lane_map_t* lane_map);
