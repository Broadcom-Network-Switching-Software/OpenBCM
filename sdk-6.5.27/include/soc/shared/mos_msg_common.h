...
#define   MOS_MSG_SUBCLASS_SYSTEM_TOD_SET          17 /* Time of the day set */
#define   MOS_MSG_SUBCLASS_SYSTEM_TOD_GET          18 /* Time of the day get */
...
#define _BFD_L3IIF_VRF_MAP                    0x17
...
#define MOS_MSG_SUBCLASS_BFD_L3IIF_VRF_MAP          \
    MOS_MSG_DMA_SET(_BFD_L3IIF_VRF_MAP)
#define MOS_MSG_SUBCLASS_BFD_L3IIF_VRF_MAP_REPLY    \
    MOS_MSG_SUBCLASS_REPLY(_BFD_L3IIF_VRF_MAP)
...
#define   MOS_MSG_SUBCLASS_PTP_TAG_CONFIG               (133)

#define   MOS_MSG_SUBCLASS_PTP_TAG_COUNT                (8)
...
#define _FT_QCM_UPDATE_PRI_QUE_MAP             0x2F
#define _FT_DROP_REPORT_ORG_PKT_MAX_LEN_GET    0x30
#define _FT_COLLECTOR_UPDATE                   0x31
...
#define MOS_MSG_SUBCLASS_FT_COLLECTOR_UPDATE                                    \
    MOS_MSG_DMA_SET(_FT_COLLECTOR_UPDATE)

#define MOS_MSG_SUBCLASS_FT_COLLECTOR_UPDATE_REPLY                              \
    MOS_MSG_SUBCLASS_REPLY(_FT_COLLECTOR_UPDATE)
...
#define MOS_MSG_SUBCLASS_FT_QCM_UPDATE_PRI_QUE_MAP                               \
    _FT_QCM_UPDATE_PRI_QUE_MAP

#define MOS_MSG_SUBCLASS_FT_QCM_UPDATE_PRI_QUE_MAP_REPLY                         \
    MOS_MSG_SUBCLASS_REPLY(_FT_QCM_UPDATE_PRI_QUE_MAP)

#define MOS_MSG_SUBCLASS_FT_DROP_REPORT_ORG_PKT_MAX_LEN_GET                      \
    _FT_DROP_REPORT_ORG_PKT_MAX_LEN_GET

#define MOS_MSG_SUBCLASS_FT_DROP_REPORT_ORG_PKT_MAX_LEN_GET_REPLY                \
    MOS_MSG_SUBCLASS_REPLY(_FT_DROP_REPORT_ORG_PKT_MAX_LEN_GET)
...
#define IFA2_COSQ_MAP_SET                       0x0E
#define IFA2_CONFIG_GET                         0x0F
...
#define MOS_MSG_SUBCLASS_IFA2_COSQ_MAP_SET                                    \
    MOS_MSG_DMA_SET(IFA2_COSQ_MAP_SET)

#define MOS_MSG_SUBCLASS_IFA2_COSQ_MAP_SET_REPLY                              \
    MOS_MSG_SUBCLASS_REPLY(IFA2_COSQ_MAP_SET)

#define MOS_MSG_SUBCLASS_IFA2_CONFIG_GET                                      \
    IFA2_CONFIG_GET

#define MOS_MSG_SUBCLASS_IFA2_CONFIG_GET_REPLY                                \
    MOS_MSG_SUBCLASS_REPLY(MOS_MSG_DMA_SET(IFA2_CONFIG_GET))


/* ETH-OAM messages. */
#define MOS_MSG_CLASS_ETH_OAM                32

#define ETH_OAM_APPL_READY                         0x00
#define ETH_OAM_INIT                               0x01
#define ETH_OAM_SHUTDOWN                           0x02
#define ETH_OAM_WARMBOOT                           0x03
#define ETH_OAM_LMEP_SET                           0x04
#define ETH_OAM_LMEP_GET                           0x05
#define ETH_OAM_LMEP_DEL                           0x06
#define ETH_OAM_RMEP_SET                           0x07
#define ETH_OAM_RMEP_GET                           0x08
#define ETH_OAM_RMEP_DEL                           0x09
#define ETH_OAM_SLM_SET                            0x0A
#define ETH_OAM_SLM_GET                            0x0B
#define ETH_OAM_SLM_DEL                            0x0C
#define ETH_OAM_TRUNK_SET                          0x0D
#define ETH_OAM_TRUNK_GET                          0x0E
#define ETH_OAM_EVENT_MASKS_SET                    0x0F
#define ETH_OAM_PM_PSTATS_SLM_GET                  0x10
#define ETH_OAM_PM_RSTATS_ADDR_SET                 0x11

#define MOS_MSG_SUBCLASS_ETH_OAM_APPL_READY                                     \
    ETH_OAM_APPL_READY

#define MOS_MSG_SUBCLASS_ETH_OAM_INIT                                           \
    MOS_MSG_DMA_SET(ETH_OAM_INIT)

#define MOS_MSG_SUBCLASS_ETH_OAM_INIT_REPLY                                     \
    MOS_MSG_SUBCLASS_REPLY(ETH_OAM_INIT)

#define MOS_MSG_SUBCLASS_ETH_OAM_SHUTDOWN                                       \
    ETH_OAM_SHUTDOWN

#define MOS_MSG_SUBCLASS_ETH_OAM_SHUTDOWN_REPLY                                 \
    MOS_MSG_SUBCLASS_REPLY(ETH_OAM_SHUTDOWN)

#define MOS_MSG_SUBCLASS_ETH_OAM_WARMBOOT                                       \
    ETH_OAM_WARMBOOT

#define MOS_MSG_SUBCLASS_ETH_OAM_WARMBOOT_REPLY                                 \
    MOS_MSG_SUBCLASS_REPLY(ETH_OAM_WARMBOOT)

#define MOS_MSG_SUBCLASS_ETH_OAM_LMEP_SET                                       \
    MOS_MSG_DMA_SET(ETH_OAM_LMEP_SET)

#define MOS_MSG_SUBCLASS_ETH_OAM_LMEP_SET_REPLY                                 \
    MOS_MSG_SUBCLASS_REPLY(ETH_OAM_LMEP_SET)

#define MOS_MSG_SUBCLASS_ETH_OAM_LMEP_GET                                       \
    ETH_OAM_LMEP_GET

#define MOS_MSG_SUBCLASS_ETH_OAM_LMEP_GET_REPLY                                 \
    MOS_MSG_SUBCLASS_REPLY(MOS_MSG_DMA_SET(ETH_OAM_LMEP_GET))

#define MOS_MSG_SUBCLASS_ETH_OAM_LMEP_DEL                                       \
    MOS_MSG_DMA_SET(ETH_OAM_LMEP_DEL)

#define MOS_MSG_SUBCLASS_ETH_OAM_LMEP_DEL_REPLY                                 \
    MOS_MSG_SUBCLASS_REPLY(ETH_OAM_LMEP_DEL)

#define MOS_MSG_SUBCLASS_ETH_OAM_RMEP_SET                                       \
    MOS_MSG_DMA_SET(ETH_OAM_RMEP_SET)

#define MOS_MSG_SUBCLASS_ETH_OAM_RMEP_SET_REPLY                                 \
    MOS_MSG_SUBCLASS_REPLY(ETH_OAM_RMEP_SET)

#define MOS_MSG_SUBCLASS_ETH_OAM_RMEP_GET                                       \
    ETH_OAM_RMEP_GET

#define MOS_MSG_SUBCLASS_ETH_OAM_RMEP_GET_REPLY                                 \
    MOS_MSG_SUBCLASS_REPLY(MOS_MSG_DMA_SET(ETH_OAM_RMEP_GET))

#define MOS_MSG_SUBCLASS_ETH_OAM_RMEP_DEL                                       \
    ETH_OAM_RMEP_DEL

#define MOS_MSG_SUBCLASS_ETH_OAM_RMEP_DEL_REPLY                                 \
    MOS_MSG_SUBCLASS_REPLY(ETH_OAM_RMEP_DEL)

#define MOS_MSG_SUBCLASS_ETH_OAM_SLM_SET                                        \
    MOS_MSG_DMA_SET(ETH_OAM_SLM_SET)

#define MOS_MSG_SUBCLASS_ETH_OAM_SLM_SET_REPLY                                  \
    MOS_MSG_SUBCLASS_REPLY(ETH_OAM_SLM_SET)

#define MOS_MSG_SUBCLASS_ETH_OAM_SLM_GET                                        \
    ETH_OAM_SLM_GET

#define MOS_MSG_SUBCLASS_ETH_OAM_SLM_GET_REPLY                                  \
    MOS_MSG_SUBCLASS_REPLY(MOS_MSG_DMA_SET(ETH_OAM_SLM_GET))

#define MOS_MSG_SUBCLASS_ETH_OAM_SLM_DEL                                        \
    ETH_OAM_SLM_DEL

#define MOS_MSG_SUBCLASS_ETH_OAM_SLM_DEL_REPLY                                  \
    MOS_MSG_SUBCLASS_REPLY(ETH_OAM_SLM_DEL)

#define MOS_MSG_SUBCLASS_ETH_OAM_TRUNK_SET                                      \
    MOS_MSG_DMA_SET(ETH_OAM_TRUNK_SET)

#define MOS_MSG_SUBCLASS_ETH_OAM_TRUNK_SET_REPLY                                \
    MOS_MSG_SUBCLASS_REPLY(ETH_OAM_TRUNK_SET)

#define MOS_MSG_SUBCLASS_ETH_OAM_TRUNK_GET                                      \
    ETH_OAM_TRUNK_GET

#define MOS_MSG_SUBCLASS_ETH_OAM_TRUNK_GET_REPLY                                \
    MOS_MSG_SUBCLASS_REPLY(MOS_MSG_DMA_SET(ETH_OAM_TRUNK_GET))

#define MOS_MSG_SUBCLASS_ETH_OAM_EVENT_MASKS_SET                                \
    MOS_MSG_DMA_SET(ETH_OAM_EVENT_MASKS_SET)

#define MOS_MSG_SUBCLASS_ETH_OAM_EVENT_MASKS_SET_REPLY                          \
    MOS_MSG_SUBCLASS_REPLY(ETH_OAM_EVENT_MASKS_SET)

#define MOS_MSG_SUBCLASS_ETH_OAM_PM_PSTATS_SLM_GET                              \
    ETH_OAM_PM_PSTATS_SLM_GET

#define MOS_MSG_SUBCLASS_ETH_OAM_PM_PSTATS_SLM_GET_REPLY                        \
    MOS_MSG_SUBCLASS_REPLY(MOS_MSG_DMA_SET(ETH_OAM_PM_PSTATS_SLM_GET))

#define MOS_MSG_SUBCLASS_ETH_OAM_PM_RSTATS_ADDR_SET                             \
    MOS_MSG_DMA_SET(ETH_OAM_PM_RSTATS_ADDR_SET)

#define MOS_MSG_SUBCLASS_ETH_OAM_PM_RSTATS_ADDR_SET_REPLY                       \
    MOS_MSG_SUBCLASS_REPLY(ETH_OAM_PM_RSTATS_ADDR_SET)

/* ETH-OAM events. */
#define MOS_MSG_CLASS_ETH_OAM_EVENT       33

#define MOS_MSG_SUBCLASS_ETH_OAM_EVENT_LMEP  0x1
#define MOS_MSG_SUBCLASS_ETH_OAM_EVENT_RMEP  0x2
#define MOS_MSG_SUBCLASS_ETH_OAM_PM_RSTATS   0x3

/* Time Of Day . */
#define MOS_MSG_CLASS_TOD                 34


/* OneSync. */
#define MOS_MSG_CLASS_ONESYNC             35

/* Onesync message subclass definitions in onesync.h */
...
/* KnetSync. */
#define MOS_MSG_CLASS_KNETSYNC             36

/* Knetsync message subclass definitions in knetsync.h */

/* Encrypted PFC */
#define MOS_MSG_CLASS_PFC                 37

/* PFC message subclasses */
#define _PFC_APPL_READY                       0x00
#define _PFC_INIT                             0x01
#define _PFC_UNINIT                           0x02
#define _PFC_PORT_CONFIG_SET                  0x03
#define _PFC_PORT_CONFIG_GET                  0x04
#define _PFC_TX_STAT_SET                      0x05
#define _PFC_TX_STAT_GET                      0x06
#define _PFC_TX_START_STOP                    0x07
#define _PFC_TX_START_STOP_GET                0x08

#define MOS_MSG_SUBCLASS_PFC_APPL_READY             \
    _PFC_APPL_READY

#define MOS_MSG_SUBCLASS_PFC_INIT                   \
    MOS_MSG_DMA_SET(_PFC_INIT)
#define MOS_MSG_SUBCLASS_PFC_INIT_REPLY             \
    MOS_MSG_SUBCLASS_REPLY(_PFC_INIT)

#define MOS_MSG_SUBCLASS_PFC_UNINIT                 \
    _PFC_UNINIT
#define MOS_MSG_SUBCLASS_PFC_UNINIT_REPLY           \
    MOS_MSG_SUBCLASS_REPLY(_PFC_UNINIT)

#define MOS_MSG_SUBCLASS_PFC_PORT_CONFIG_SET        \
    MOS_MSG_DMA_SET(_PFC_PORT_CONFIG_SET)
#define MOS_MSG_SUBCLASS_PFC_PORT_CONFIG_SET_REPLY  \
    MOS_MSG_SUBCLASS_REPLY(_PFC_PORT_CONFIG_SET)

#define MOS_MSG_SUBCLASS_PFC_PORT_CONFIG_GET        \
    _PFC_PORT_CONFIG_GET
#define MOS_MSG_SUBCLASS_PFC_PORT_CONFIG_GET_REPLY  \
    MOS_MSG_SUBCLASS_REPLY(MOS_MSG_DMA_SET(_PFC_PORT_CONFIG_GET))

#define MOS_MSG_SUBCLASS_PFC_TX_START_STOP          \
    _PFC_TX_START_STOP
#define MOS_MSG_SUBCLASS_PFC_TX_START_STOP_REPLY    \
    MOS_MSG_SUBCLASS_REPLY(_PFC_TX_START_STOP)

#define MOS_MSG_SUBCLASS_PFC_TX_START_STOP_GET          \
    _PFC_TX_START_STOP_GET
#define MOS_MSG_SUBCLASS_PFC_TX_START_STOP_GET_REPLY    \
        MOS_MSG_SUBCLASS_REPLY(_PFC_TX_START_STOP_GET)

#define MOS_MSG_SUBCLASS_PFC_TX_STAT_GET            \
    MOS_MSG_DMA_SET(_PFC_TX_STAT_GET)
#define MOS_MSG_SUBCLASS_PFC_TX_STAT_GET_REPLY      \
    MOS_MSG_SUBCLASS_REPLY(MOS_MSG_DMA_SET(_PFC_TX_STAT_GET))

#define MOS_MSG_SUBCLASS_PFC_TX_STAT_SET            \
    MOS_MSG_DMA_SET(_PFC_TX_STAT_SET)
#define MOS_MSG_SUBCLASS_PFC_TX_STAT_SET_REPLY      \
    MOS_MSG_SUBCLASS_REPLY(_PFC_TX_STAT_SET)
