...
typedef enum shr_ft_em_qual_e {
    ...
    SHR_FT_EM_QUAL_SRC_MAC_LOWER32 = 24,
    SHR_FT_EM_QUAL_SRC_MAC_UPPER16 = 25,
    SHR_FT_EM_QUAL_DST_MAC_LOWER32 = 26,
    SHR_FT_EM_QUAL_DST_MAC_UPPER16 = 27,
    SHR_FT_EM_QUAL_ETHER_TYPE      = 28,
    SHR_FT_EM_QUAL_OUTER_VLAN_TAG  = 29,
    SHR_FT_EM_QUAL_SRC_IPV6_PART0  = 30,
    SHR_FT_EM_QUAL_SRC_IPV6_PART1  = 31,
    SHR_FT_EM_QUAL_SRC_IPV6_PART2  = 32,
    SHR_FT_EM_QUAL_SRC_IPV6_PART3  = 33,
    SHR_FT_EM_QUAL_DST_IPV6_PART0  = 34,
    SHR_FT_EM_QUAL_DST_IPV6_PART1  = 35,
    SHR_FT_EM_QUAL_DST_IPV6_PART2  = 36,
    SHR_FT_EM_QUAL_DST_IPV6_PART3  = 37,
    SHR_FT_EM_QUAL_COUNT
} shr_ft_em_qual_t;

/* Maximum number of EM qualifiers that can be part of an EM group. */
#define SHR_FT_EM_MAX_QUAL (SHR_FT_EM_QUAL_COUNT)
...
typedef enum shr_ft_tp_e {
    ...
    SHR_FT_TP_SRC_MAC              = 15,
    SHR_FT_TP_DST_MAC              = 16,
    SHR_FT_TP_OUTER_VLAN_TAG       = 17,
    SHR_FT_TP_ETHER_TYPE           = 18,
    SHR_FT_TP_SRC_IPV6             = 19,
    SHR_FT_TP_DST_IPV6             = 20,
    SHR_FT_TP_COUNT
} shr_ft_tp_t;
...
#define SHR_FT_MAX_TP (SHR_FT_TP_COUNT)
...
typedef enum shr_ft_udf_base_offset_e {
    ...
    SHR_FT_UDF_BASE_OFFSET_14_BYTES_AFTER_OUTER_L2 = 5,
...
/* Maximum number of IPFIX/Protobuf collectors */
#define SHR_FT_MAX_COLLECTORS (32)
...
typedef enum shr_ft_group_update_e {
    ...
    SHR_FT_GROUP_UPDATE_DROP_REPORT_ORG_PKT_MAX_LEN = 17,
...
typedef enum shr_ft_template_info_elem_e {
    ...
    SHR_FT_TEMPLATE_INFO_ELEM_SRC_IPV6                = 23,
    SHR_FT_TEMPLATE_INFO_ELEM_DST_IPV6                = 24,
    SHR_FT_TEMPLATE_INFO_ELEM_SRC_MAC                 = 25,
    SHR_FT_TEMPLATE_INFO_ELEM_DST_MAC                 = 26,
    SHR_FT_TEMPLATE_INFO_ELEM_ETHER_TYPE              = 27,
    SHR_FT_TEMPLATE_INFO_ELEM_OUTER_VLAN_TAG          = 28,
    SHR_FT_TEMPLATE_MAX_INFO_ELEMENTS
} shr_ft_template_info_elem_t;


#define SHR_FT_TEMPLATE_INFO_ELEM_NAMES                  \
    {                                                    \
    "SRC_IPV4               ",                           \
    "DST_IPV4               ",                           \
    "L4_SRC_PORT            ",                           \
    ...
    "INNER_L4_DST_PORT      ",                           \
    "INNER_IP_PROTOCOL      ",                           \
    "QUEUE_DROP_BYTE_COUNT  ",                           \
    "QUEUE_DROP_PKT_COUNT   ",                           \
    "QUEUE_RX_BYTE_COUNT    ",                           \
    "QUEUE_RX_PKT_COUNT     ",                           \
    "INNER_SRC_IPV6         ",                           \
    "INNER_DST_IPV6         ",                           \
...
#define SHR_FT_UC_FEATURE_MULTIPLE_COLLECTORS       (1 << 11)

/* Features supported by SDK */
#define SHR_FT_SDK_FEATURE_MULTIPLE_COLLECTORS       (1 << 0)
