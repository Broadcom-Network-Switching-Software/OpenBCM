...
/*
 * Enhanced shr_ft_msg_ctrl_init_t to add
 * - max_collectors
 */
#define FT_MSG_VERSION_9 9

#define FT_MSG_VERSION  FT_MSG_VERSION_9
...
/* Enable drop monitoring IPFIX exports */
#define SHR_FT_MSG_INIT_FLAGS_DROP_MONITOR_IPFIX_ENABLE (1 << 5)
...
/* FT ProtoBuf collector set update */
#define SHR_FT_MSG_GROUP_UPDATE_FLAGS_PROTOBUF (1 << 0)
 ...
 * Create  collector
 */
typedef struct __COMPILER_ATTR__ shr_ft_msg_ctrl_collector_update_s {
    /* Flags */
    uint32 flags;
   ...
   /* Max size of the packet that can be sent to collector */
    ...
    /* IPFIX domain id */
    uint32 domain_id;
} shr_ft_msg_ctrl_collector_update_t;
...
/* ProtoBuf collector */
#define SHR_FT_MSG_COLLECTOR_FLAGS_PROTOBUF        (1 << 2)
...
typedef union shr_ft_msg_ctrl_s {
    ...
    shr_ft_msg_ctrl_collector_update_t          collector_update;
} shr_ft_msg_ctrl_t;
