...
#define DSIG_MDB_MAX_SIZE_UINT32    256
#define DSIG_MDB_MAX_SIZE_STR       ((DSIG_MDB_MAX_SIZE_UINT32 * 4 * 2) + 2)
#define DSIG_MDB_MAX_SIZE_BITS      DSIG_MDB_MAX_SIZE_UINT32 * 32
...
#ifdef BCM_DNX_SUPPORT
    debug_signal_t *stage_debug_signals[DNX_DATA_MAX_DEVICE_GENERAL_NOF_CORES];
#else
    debug_signal_t *stage_debug_signals[1];
#endif
    struct pp_stage_s *stage_to;
#ifdef BCM_DNX_SUPPORT
    int stage_signal_num[DNX_DATA_MAX_DEVICE_GENERAL_NOF_CORES];
#else
    int stage_signal_num[1];
#endif
    int number;
    int buffer0_size;
    int buffer1_size;
