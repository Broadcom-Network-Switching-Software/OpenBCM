...
#define SHMOO_COMBO16_DDR4_VREF_RANGE_CROSSOVER     36  
...
typedef struct combo16_shmoo_cbi_s
{
    ...
    *combo16_phy_reg_modify) (
    ...
    int (
    *combo16_drc_bist_conf_set) (
    int unit,
    int drc_ndx,
    combo16_bist_info_t info);
    
    int (
    *combo16_drc_bist_err_cnt) (
    int unit,
    int drc_ndx,
    combo16_bist_err_cnt_t * info);
    
    int (
    *combo16_drc_dram_init) (
    int unit,
    int drc_ndx,
    int phase);
    ...
    *combo16_drc_pll_set) (
    int unit,
    int drc_ndx,
    const combo16_drc_pll_t * pll_info);

    
    int (
    *combo16_drc_modify_mrs) (
    int unit,
    int drc_ndx,
    uint32 mr_ndx,
    uint32 data,
    ...
    int (
    *combo16_drc_enable_adt) (
    int unit,
    int drc_ndx,
    int enable);
    
    int (
    *combo16_drc_enable_wck2ck_training) (
    int unit,
    int drc_ndx,
    int enable);
    
    int (
    *combo16_drc_enable_write_leveling) (
    int unit,
    int drc_ndx,
    uint32 command_parity_lattency,
    int use_continious_gddr5_dqs,
    int enable);
    ...
    *combo16_drc_mpr_en) (
    ...
    int (
    *combo16_drc_mpr_load) (
    int unit,
    int drc_ndx,
    uint8 *mpr_pattern);
    
    int (
    *combo16_drc_enable_gddr5_training_protocol) (
    int unit,
    int drc_ndx,
    int enable);
    
    int (
    *combo16_drc_vendor_info_get) (
    int unit,
    int drc_ndx,
    combo16_vendor_info_t * info);
    
    int (
    *combo16_drc_dqs_pulse_gen) (
    int unit,
    int drc_ndx,
    int use_continious_gddr5_dqs);
    
    int (
    *combo16_gddr5_shmoo_drc_bist_conf_set) (
    int unit,
    int drc_ndx,
    combo16_gddr5_bist_info_t info);
    
    int (
    *combo16_gddr5_shmoo_drc_bist_err_cnt) (
    int unit,
    int drc_ndx,
    combo16_gddr5_bist_err_cnt_t * info);
    
    int (
    *combo16_gddr5_shmoo_drc_dq_byte_pairs_swap_info_get) (
    int unit,
    int drc_ndx,
    int *pairs_were_swapped);
    
    int (
    *combo16_drc_enable_wr_crc) (
    int unit,
    int drc_ndx,
    int enable);
    
    int (
    *combo16_drc_enable_rd_crc) (
    int unit,
    int drc_ndx,
    int enable);
    
    int (
    *combo16_drc_enable_wr_dbi) (
    int unit,
    int drc_ndx,
    int enable);
    
    int (
    *combo16_drc_enable_rd_dbi) (
    int unit,
    int drc_ndx,
    int enable);
    
    int (
    *combo16_drc_enable_refresh) (
    int unit,
    int drc_ndx,
    int enable,
    uint32 new_trefi,
    ...
    int (
    *combo16_drc_force_dqs) (
    int unit,
    int drc_ndx,
    uint32 force_dqs_val,
    uint32 force_dqs_oeb);
    
    int (
    *combo16_drc_soft_reset_drc_without_dram) (
    int unit,
    int drc_ndx);
    
    int (
    *combo16_shmoo_dram_info_access) (
    int unit,
    combo16_shmoo_dram_info_t ** shmoo_info);
    
    int (
    *combo16_vendor_info_access) (
    int unit,
    combo16_vendor_info_t ** vendor_info);
} combo16_shmoo_cbi_t;
...
typedef int (
    *soc_combo16_phy_reg_read_t) (
    int unit,
    int drc_ndx,
    uint32 addr,
    uint32 *data);
typedef int (
    *soc_combo16_phy_reg_write_t) (
    int unit,
    int drc_ndx,
    uint32 addr,
    uint32 data);
typedef int (
    *soc_combo16_phy_reg_modify_t) (
    int unit,
    int drc_ndx,
    uint32 addr,
    uint32 data,
    uint32 mask);
typedef int (
    *_shmoo_combo16_drc_bist_conf_set_t) (
    int unit,
    int drc_ndx,
    combo16_bist_info_t info);
typedef int (
    *_shmoo_combo16_drc_bist_err_cnt_t) (
    int unit,
    int drc_ndx,
    combo16_bist_err_cnt_t * info);
typedef int (
    *_shmoo_combo16_drc_dram_init_t) (
    int unit,
    int drc_ndx,
    int phase);
typedef int (
    *_shmoo_combo16_drc_pll_set_t) (
    int unit,
    int drc_ndx,
    const combo16_drc_pll_t * pll_info);
typedef int (
    *_shmoo_combo16_drc_modify_mrs_t) (
    int unit,
    int drc_ndx,
    uint32 mr_ndx,
    uint32 data,
    uint32 mask);
typedef int (
    *_shmoo_combo16_drc_enable_adt_t) (
    int unit,
    int drc_ndx,
    int enable);
typedef int (
    *_shmoo_combo16_drc_enable_wck2ck_training_t) (
    int unit,
    int drc_ndx,
    int enable);
typedef int (
    *_shmoo_combo16_drc_enable_write_leveling_t) (
    int unit,
    int drc_ndx,
    uint32 command_parity_lattency,
    int use_continious_gddr5_dqs,
    int enable);
typedef int (
    *_shmoo_combo16_drc_mpr_en_t) (
    int unit,
    int drc_ndx,
    int enable);
typedef int (
    *_shmoo_combo16_drc_mpr_load_t) (
    int unit,
    int drc_ndx,
    uint8 *mpr_pattern);
typedef int (
    *_shmoo_combo16_drc_enable_gddr5_training_protocol_t) (
    int unit,
    int drc_ndx,
    int enable);
typedef int (
    *_shmoo_combo16_drc_vendor_info_get_t) (
    int unit,
    int drc_ndx,
    combo16_vendor_info_t * info);
typedef int (
    *_shmoo_combo16_drc_dqs_pulse_gen_t) (
    int unit,
    int drc_ndx,
    int use_continious_gddr5_dqs);
typedef int (
    *_shmoo_combo16_drc_gddr5_bist_conf_set_t) (
    int unit,
    int drc_ndx,
    combo16_gddr5_bist_info_t info);
typedef int (
    *_shmoo_combo16_drc_gddr5_bist_err_cnt_t) (
    int unit,
    int drc_ndx,
    combo16_gddr5_bist_err_cnt_t * info);
typedef int (
    *_shmoo_combo16_drc_gddr5_dq_byte_pairs_swap_info_get_t) (
    int unit,
    int drc_ndx,
    int *pairs_were_swapped);
typedef int (
    *_shmoo_combo16_drc_enable_wr_crc_t) (
    int unit,
    int drc_ndx,
    int enable);
typedef int (
    *_shmoo_combo16_drc_enable_rd_crc_t) (
    int unit,
    int drc_ndx,
    int enable);
typedef int (
    *_shmoo_combo16_drc_enable_wr_dbi_t) (
    int unit,
    int drc_ndx,
    int enable);
typedef int (
    *_shmoo_combo16_drc_enable_rd_dbi_t) (
    int unit,
    int drc_ndx,
    int enable);
typedef int (
    *_shmoo_combo16_drc_enable_refresh_t) (
    int unit,
    int drc_ndx,
    int enable,
    uint32 new_trefi,
    uint32 *curr_refi);
typedef int (
    *_shmoo_combo16_drc_force_dqs_t) (
    int unit,
    int drc_ndx,
    uint32 force_dqs_val,
    uint32 force_dqs_oeb);
typedef int (
    *_shmoo_combo16_drc_soft_reset_drc_without_dram_t) (
    int unit,
    int drc_ndx);
typedef int (
    *_shmoo_combo16_drc_dram_info_access_t) (
    int unit,
    combo16_shmoo_dram_info_t ** shmoo_info);
typedef int (
    *_shmoo_combo16_drc_vendor_info_access_t) (
    int unit,
    combo16_vendor_info_t ** shmoo_info);
...
extern int soc_combo16_shmoo_interface_cb_register(
    int unit,
    combo16_shmoo_cbi_t shmoo_cbi);
extern int soc_combo16_calculate_step_size(
    int unit,
    int drc_ndx,
    combo16_step_size_t * ssPtr);
extern int soc_combo16_shmoo_dram_info_set(
    int unit,
    CONST combo16_shmoo_dram_info_t * sdi);
extern int soc_combo16_shmoo_phy_cfg_pll(
    int unit,
    int drc_ndx);
extern int soc_combo16_shmoo_phy_init(
    int unit,
    int drc_ndx);
extern int soc_combo16_shmoo_ctl(
    int unit,
    int drc_ndx,
    int shmoo_type,
    uint32 flags,
    int action,
    combo16_shmoo_config_param_t * config_param);
extern int soc_combo16_cdr_ctl(
    int unit,
    int drc_ndx,
    int stat,
    combo16_cdr_config_param_t * config_param);
