...
typedef enum {
    ...
    SAND_INT_CORR_ACT_ILKN_RX_LANE_LOCK_STATUS_CHANGE,
    ...
    SAND_INT_CORR_ACT_TCAM_SCAN_ECC_1B,
    SAND_INT_CORR_ACT_TCAM_SCAN_ECC_2B,
    SAND_INT_CORR_ACT_NANOSYNC_TAS_TOD_UPDATE,
    SAND_INT_CORR_ACT_W40_FLR,
    SAND_INT_CORR_ACT_RESET_FABRIC_LINK,
