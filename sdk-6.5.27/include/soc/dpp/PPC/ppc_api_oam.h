...
typedef enum {
  ...
  SOC_PPC_OAM_TRAP_ID_SAT_LB_TST_UP,
...
typedef struct {
   ...
   uint32 last_rmeb_db_ndx;      
   uint32 last_report_mode;      
   uint32 last_event_size;       
   uint8  last_event_type;       
   uint32 last_event_data[9];    
...
#define SOC_PPC_OAM_BFD_MEP_DB_EXT_DATA_RESERVED_BITS           (320)
#define SOC_PPC_OAM_BFD_MEP_DB_EXT_DATA_MAX_SIZE_BITS       \
        (SOC_PPC_OAM_BFD_MEP_DB_EXT_DATA_RESERVED_BITS + SOC_PPC_OAM_BFD_MEP_DB_EXT_DATA_FIRST_HDR_SIZE_BITS \
