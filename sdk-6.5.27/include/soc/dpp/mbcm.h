...
typedef soc_error_t (*mbcm_dpp_port_control_ecn_enable_set_f) (
    SOC_SAND_IN  int                     unit,
    SOC_SAND_IN  soc_port_t              port,
    SOC_SAND_IN  int                     value
 );
typedef soc_error_t (*mbcm_dpp_port_control_ecn_enable_get_f) (
    SOC_SAND_IN  int                     unit,
    SOC_SAND_IN  soc_port_t              port,
    SOC_SAND_OUT int                     *value
 );
...
typedef soc_error_t (*mbcm_dpp_egr_flow_profile_property_set_f) (
    SOC_SAND_IN  int                                   unit,
    SOC_SAND_IN  int                                   profile,
    SOC_SAND_IN  soc_dpp_flow_profile_property_t  property,
    SOC_SAND_IN  int                                   value
  );

typedef soc_error_t (*mbcm_dpp_egr_flow_profile_property_get_f) (
    SOC_SAND_IN   int                                    unit,
    SOC_SAND_IN   int                                    profile,
    SOC_SAND_IN   soc_dpp_flow_profile_property_t   property,
    SOC_SAND_OUT  int                                    *value
...
typedef int (* mbcm_dpp_egr_prog_editor_pp_profile_set_f)(
    SOC_SAND_IN  int                        unit,
    SOC_SAND_IN  int                        port,
    SOC_SAND_IN  uint32                     prog_editor_profile
  );

typedef int (* mbcm_dpp_egr_prog_editor_pp_profile_get_f)(
    SOC_SAND_IN  int                        unit,
    SOC_SAND_IN  int                        port,
    SOC_SAND_OUT uint32                    *prog_editor_profile
  );
...
typedef soc_error_t (*mbcm_dpp_lb_enhancement_support_get_f) (
    SOC_SAND_IN  int                          unit,
    SOC_SAND_OUT uint32                       *is_support
  );

typedef soc_error_t (*mbcm_dpp_lb_port_speed_sw_set_f) (
    SOC_SAND_IN  int         unit,
    SOC_SAND_IN  soc_port_t  port,
    SOC_SAND_IN  soc_lbg_t   lbg_id,
    SOC_SAND_IN  int         speed
...
typedef soc_error_t (*mbcm_dpp_sram_drop_threshold_set_f) (
    int                                 unit,
    SOC_SAND_IN  int                    priority,
    SOC_SAND_IN  uint32                 value
  );

typedef soc_error_t (*mbcm_dpp_sram_drop_threshold_get_f) (
    int                                 unit,
    SOC_SAND_IN  int                    priority,
    SOC_SAND_OUT uint32                 *value
  );

typedef soc_error_t (*mbcm_dpp_sram_drop_reassembly_context_profile_map_set_f) (
    int                                 unit,
    SOC_SAND_IN  int                    core,
...
typedef soc_error_t (*mbcm_dpp_sram_drop_reassembly_context_profile_map_get_f) (
    int                                 unit,
    SOC_SAND_IN  int                    core,
    SOC_SAND_IN  uint32                 reassembly_context,
    SOC_SAND_OUT uint32                 *profile_id
  );

typedef soc_error_t (*mbcm_dpp_sram_drop_profile_priority_map_set_f) (
    int                                 unit,
    SOC_SAND_IN  uint32                 profile_id,
    SOC_SAND_IN  uint32                 tc,
    SOC_SAND_IN  uint32                 dp,
...
typedef soc_error_t (*mbcm_dpp_sram_drop_profile_priority_map_get_f) (
    int                                 unit,
    SOC_SAND_IN  uint32                 profile_id,
    SOC_SAND_IN  uint32                 tc,
    SOC_SAND_IN  uint32                 dp,
...
typedef int (*mbcm_dpp_lb_is_control_port_get_f)(
    int unit, 
    soc_port_t port, 
    uint32* is_ctrl_port,
    int is_on_modem
...
typedef soc_error_t (*mbcm_dpp_lb_ing_control_packet_identification_config_set_f) (
    SOC_SAND_IN  int unit, 
    SOC_SAND_IN  uint32 flags, 
    SOC_SAND_IN  uint16 global_tpid
   );

typedef soc_error_t (*mbcm_dpp_lb_ing_control_packet_identification_config_get_f) (
    SOC_SAND_IN  int unit, 
    SOC_SAND_IN  uint32 flags, 
...
typedef struct mbcm_dpp_functions_s {
    ...
    mbcm_dpp_port_control_ecn_enable_set_f        mbcm_dpp_port_control_ecn_enable_set;
    mbcm_dpp_port_control_ecn_enable_get_f        mbcm_dpp_port_control_ecn_enable_get;
    ...
    mbcm_dpp_egr_flow_profile_property_set_f                            mbcm_dpp_egr_flow_profile_property_set;
    mbcm_dpp_egr_flow_profile_property_get_f                            mbcm_dpp_egr_flow_profile_property_get;
    ...
    mbcm_dpp_egr_prog_editor_pp_profile_set_f                           mbcm_dpp_egr_prog_editor_pp_profile_set;
    mbcm_dpp_egr_prog_editor_pp_profile_get_f                           mbcm_dpp_egr_prog_editor_pp_profile_get;
    ...
    mbcm_dpp_sram_drop_threshold_set_f                                  mbcm_dpp_sram_drop_threshold_set;
    mbcm_dpp_sram_drop_threshold_get_f                                  mbcm_dpp_sram_drop_threshold_get;
    mbcm_dpp_sram_drop_reassembly_context_profile_map_set_f             mbcm_dpp_sram_drop_reassembly_context_profile_map_set;
    mbcm_dpp_sram_drop_reassembly_context_profile_map_get_f             mbcm_dpp_sram_drop_reassembly_context_profile_map_get;
    mbcm_dpp_sram_drop_profile_priority_map_set_f                       mbcm_dpp_sram_drop_profile_priority_map_set;
    mbcm_dpp_sram_drop_profile_priority_map_get_f                       mbcm_dpp_sram_drop_profile_priority_map_get;
    mbcm_dpp_lb_is_control_port_get_f                                   mbcm_dpp_lb_is_control_port_get;
    mbcm_dpp_lb_ing_control_packet_identification_config_set_f          mbcm_dpp_lb_ing_control_packet_identification_config_set;
    mbcm_dpp_lb_ing_control_packet_identification_config_get_f          mbcm_dpp_lb_ing_control_packet_identification_config_get;
    mbcm_dpp_lb_enhancement_support_get_f                               mbcm_dpp_lb_enhancement_support_get;
    mbcm_dpp_lb_port_speed_sw_set_f                                     mbcm_dpp_lb_port_speed_sw_set;
