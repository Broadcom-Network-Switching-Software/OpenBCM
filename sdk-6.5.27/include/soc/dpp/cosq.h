...
typedef enum soc_dpp_flow_profile_property_e {
    soc_dpp_flow_profile_ecn_enable = 0,
    soc_dpp_flow_profile_threshold = 1
} soc_dpp_flow_profile_property_t;
...
soc_error_t
  soc_dpp_lb_enhancement_support_get(
    SOC_SAND_IN  int                     unit,
