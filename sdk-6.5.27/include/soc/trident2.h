...
extern int
soc_trident2_voltage_monitor_get(int unit, int* avg_voltage);
...
extern int soc_td2_cosq_threshold_dynamic_change_check(int unit,
                                                       int new_threshold,
                                                       soc_reg_t ctr_reg,
                                                       soc_port_t port,
                                                       int ar_idx,
...
extern int
soc_td2x_ser_single_bit_sw_correction_enable_set(int unit, int enable);

extern int
soc_td2x_ser_single_bit_sw_correction_enable_get(int unit, int *enable);

extern int
soc_td2x_ser_single_bit_report_for_bus_buf_set(int unit, int enable);

extern int
soc_td2x_ser_single_bit_report_for_bus_buf_get(int unit, int *enable);

extern void
_soc_td2_ser_reg_control_get(int unit, void *ser_en_info_list, soc_reg_t reg,
                              soc_reg_t *ser_control_reg,
                              soc_field_t *ser_enable_field);
extern int
_soc_td2_populate_ser_log_for_reg(int unit, soc_reg_t parity_enable_reg,
                                  soc_field_t parity_enable_field,
                                  soc_reg_t reg, int index,
                                  int port, int pipe,
                                  soc_acc_type_t acc_type,
