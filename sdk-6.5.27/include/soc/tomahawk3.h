...
/* PVTMON interrupt bits for min max temperature interrupts */
#define PVT_INTR_MON_13_MAX    (1UL << 26)
#define PVT_INTR_MON_13_MIN    (1UL << 27)
#define PVT_INTR_MON_14_MAX    (1UL << 28)
#define PVT_INTR_MON_14_MIN    (1UL << 29)
...
extern int soc_th3_l2x_appl_callback_disable_config_state_get(int unit);
extern int soc_th3_l2x_appl_callback_config_state_set(int unit, int val);
extern int soc_th3_l2x_appl_callback_disable_config_state_set(int unit, int val);
...
extern int soc_th3_l2_learn_wb_recovery_rebuild_cb_action_set(int unit, int action);
extern int soc_th3_l2_learn_wb_recovery_rebuild_cb_action_get(int unit, int *action);
extern int soc_th3_l2_age_wb_recovery_rebuild_cb_action_set(int unit, int action);
extern int soc_th3_l2_age_wb_recovery_rebuild_cb_action_get(int unit, int *action);
extern int soc_th3_l2_wb_recovery_rebuild_property_set(int unit, int value);
