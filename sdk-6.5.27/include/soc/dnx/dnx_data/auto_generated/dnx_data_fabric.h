...
typedef enum
{
    ...
    dnx_data_fabric_general_fabric_advanced_power_down,
...
typedef enum
{
    ...
    dnx_data_fabric_links_fmac_tx_pump_disable,
...
typedef struct
{
    ...
    uint32 length;
    char *field_name;
} dnx_data_fabric_cell_sr_cell_rx_parsing_table_t;
...
typedef uint32(
    *dnx_data_fabric_cell_sr_cell_rx_fifo_size_get_f) (
    int unit);


typedef uint32(
    *dnx_data_fabric_cell_sr_cell_data_valid_offset_get_f) (
    int unit);
...
typedef const dnx_data_fabric_cell_sr_cell_rx_parsing_table_t *(
    *dnx_data_fabric_cell_sr_cell_rx_parsing_table_get_f) (
    int unit,
    int index);
...
typedef struct
{
    ...
    dnx_data_fabric_cell_sr_cell_rx_fifo_size_get_f sr_cell_rx_fifo_size_get;
    
    dnx_data_fabric_cell_sr_cell_data_valid_offset_get_f sr_cell_data_valid_offset_get;
    ...
    dnx_data_fabric_cell_sr_cell_rx_parsing_table_get_f sr_cell_rx_parsing_table_get;
    
    dnxc_data_table_info_get_f sr_cell_rx_parsing_table_info_get;
...
typedef enum
{
    dnx_data_fabric_debug_mesh_topology_replication,
