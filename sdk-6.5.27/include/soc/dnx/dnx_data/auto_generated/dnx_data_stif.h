...
typedef enum
{
    dnx_data_stif_general_is_used,
    dnx_data_stif_general_power_down_supported,
    dnx_data_stif_general_is_tap_supported,

    
    _dnx_data_stif_general_feature_nof
} dnx_data_stif_general_feature_e;



typedef int(
    *dnx_data_stif_general_feature_get_f) (
    int unit,
...
typedef struct
{
    ...
    dnx_data_stif_general_feature_get_f feature_get;
} dnx_data_if_stif_general_t;
...
typedef enum
{
    ...
    dnx_data_stif_config_is_stif_hard_wire_to_nif,
...
typedef uint32(
    *dnx_data_stif_regression_last_stif_data_length_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_stif_regression_last_stif_data_length_get_f last_stif_data_length_get;
...
typedef struct
{
    ...
    dnx_data_if_stif_general_t general;
