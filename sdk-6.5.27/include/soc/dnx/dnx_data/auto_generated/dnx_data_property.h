...
shr_error_e dnx_data_property_device_general_nof_faps_read(
    int unit,
    uint32 *nof_faps);
...
shr_error_e dnx_data_property_dram_general_info_tertw_read(
    int unit,
    uint32 *tertw);
...
shr_error_e dnx_data_property_lane_map_otn_logical_lanes_val_read(
    int unit,
    int port,
    bcm_pbmp_t *val);
