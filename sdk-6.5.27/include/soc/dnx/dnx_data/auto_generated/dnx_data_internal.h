...
typedef enum
{
    ...
    dnx_data_module_dnx2_aod,


    dnx_data_module_dnx2_aod_sizes,


    dnx_data_module_dnx2_arr,


    dnx_data_module_dnx2_mdb_app_db,


    dnx_data_module_dnx2_pemla_soc,

    dnx_data_module_dram,
    dnx_data_module_ecgm,
    dnx_data_module_egr_queuing,
    dnx_data_module_egr_queuing_v1,
    dnx_data_module_elk,
    dnx_data_module_esb,
    ...
    dnx_data_module_field_map,
    dnx_data_module_fifodma,
    dnx_data_module_flow,
    ...
    dnx_data_module_ipq,
    dnx_data_module_iqs,
    dnx_data_module_kaps,
    dnx_data_module_kleap_stage_info,
    dnx_data_module_l2,
    dnx_data_module_l3,
    ...
    dnx_data_module_nif,
    dnx_data_module_oam,
    dnx_data_module_onesync,
    dnx_data_module_parser,
    dnx_data_module_pll,
