...
typedef enum
{
    dnx_data_stif_submodule_general,
    ...
    dnx_data_stif_submodule_regression,
...
int dnx_data_stif_general_feature_get(
    int unit,
...
typedef enum
{
    ...
    _dnx_data_stif_general_define_nof
} dnx_data_stif_general_define_e;
...
typedef enum
{
    ...
    _dnx_data_stif_general_table_nof
} dnx_data_stif_general_table_e;
...
typedef enum
{
    ...
    dnx_data_stif_port_define_ethu_id,
...
uint32 dnx_data_stif_port_ethu_id_get(
    int unit);
...
int dnx_data_stif_regression_feature_get(
    int unit,
...
typedef enum
{
    dnx_data_stif_regression_define_last_stif_data_length,

    
    _dnx_data_stif_regression_define_nof
} dnx_data_stif_regression_define_e;



uint32 dnx_data_stif_regression_last_stif_data_length_get(
    int unit);
...
typedef enum
{
    dnx_data_stif_regression_table_supported_modes,

    
    _dnx_data_stif_regression_table_nof
} dnx_data_stif_regression_table_e;



const dnx_data_stif_regression_supported_modes_t * dnx_data_stif_regression_supported_modes_get(
    int unit,
    int mode,
    int speed);
...
shr_error_e dnx_data_stif_regression_supported_modes_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
const dnxc_data_table_info_t * dnx_data_stif_regression_supported_modes_info_get(
    int unit);
