...
typedef enum
{
    ...
    dnx_data_oam_general_define_oam_tod_config_in_ns_version,
    dnx_data_oam_general_define_oam_tod_config_in_ns_nof_bits_in_load_enable,
    dnx_data_oam_general_define_tod_init_in_oam,
    dnx_data_oam_general_define_oam_ns_freq_control_upper,
    ...
    dnx_data_oam_general_define_oam_tcam_key_pkt_data_at_fwd_header,
    dnx_data_oam_general_define_oam_trap_action_profile_nof_bits,
    dnx_data_oam_general_define_bfd_nof_cluster_profile,
...
uint32 dnx_data_oam_general_oam_tod_config_in_ns_version_get(
    int unit);


uint32 dnx_data_oam_general_oam_tod_config_in_ns_nof_bits_in_load_enable_get(
    int unit);


uint32 dnx_data_oam_general_tod_init_in_oam_get(
    int unit);


uint32 dnx_data_oam_general_oam_ns_freq_control_upper_get(
    int unit);
...
uint32 dnx_data_oam_general_oam_tcam_key_pkt_data_at_fwd_header_get(
    int unit);


uint32 dnx_data_oam_general_oam_trap_action_profile_nof_bits_get(
    int unit);


uint32 dnx_data_oam_general_bfd_nof_cluster_profile_get(
    int unit);
...
typedef enum
{
    ...
    dnx_data_oam_oamp_define_mep_id_in_rx_pkt_nof_bits,
    ...
    dnx_data_oam_oamp_define_oamp_scan_sycles_in_us,
    dnx_data_oam_oamp_define_oamp_scan_sycles_in_ms,
    ...
    dnx_data_oam_oamp_define_oamp_dual_mode,
...
uint32 dnx_data_oam_oamp_mep_id_in_rx_pkt_nof_bits_get(
    int unit);
...
uint32 dnx_data_oam_oamp_oamp_scan_sycles_in_us_get(
    int unit);


uint32 dnx_data_oam_oamp_oamp_scan_sycles_in_ms_get(
    int unit);
...
uint32 dnx_data_oam_oamp_oamp_dual_mode_get(
    int unit);
