...
typedef enum
{
    ...
    dnx_data_esem_access_cmd_define_port_svtag,
    ...
    dnx_data_esem_access_cmd_define_esem_cmd_arr_prefix_arp_plus_ac,
    ...
    dnx_data_esem_access_cmd_define_allocation_mngr_default,
...
uint32 dnx_data_esem_access_cmd_port_svtag_get(
    int unit);
...
uint32 dnx_data_esem_access_cmd_esem_cmd_arr_prefix_arp_plus_ac_get(
    int unit);
...
uint32 dnx_data_esem_access_cmd_allocation_mngr_default_get(
    int unit);
...
typedef enum
{
    dnx_data_esem_feature_define_esem_name_space_nof_bits,
...
uint32 dnx_data_esem_feature_esem_name_space_nof_bits_get(
    int unit);
