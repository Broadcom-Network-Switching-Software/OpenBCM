...
typedef enum
{
    ...
    dnx_data_sch_flow_define_nof_low_rate_ranges,
    dnx_data_sch_flow_define_nof_low_rate_regions,
    dnx_data_sch_flow_define_low_rate_pattern_mask,
    dnx_data_sch_flow_define_low_rate_flow_resolution,
...
uint32 dnx_data_sch_flow_nof_low_rate_ranges_get(
    int unit);


uint32 dnx_data_sch_flow_nof_low_rate_regions_get(
    int unit);


uint32 dnx_data_sch_flow_low_rate_pattern_mask_get(
    int unit);


uint32 dnx_data_sch_flow_low_rate_flow_resolution_get(
    int unit);
...
typedef enum
{
    ...
    dnx_data_sch_dbal_define_flow_shaper_max_burst_bits,
...
uint32 dnx_data_sch_dbal_flow_shaper_max_burst_bits_get(
    int unit);
