...
typedef enum
{
    dnx_data_synce_general_define_nof_synce_type,
    ...
    dnx_data_synce_general_define_nof_mas,
...
uint32 dnx_data_synce_general_nof_synce_type_get(
    int unit);
...
uint32 dnx_data_synce_general_nof_mas_get(
    int unit);
