...
typedef enum
{
    ...
    dnx_data_ingr_congestion_info_wred_c1_high_precision_supported,
    dnx_data_ingr_congestion_info_wred_continuous_probabilty_supported,
...
typedef uint32(
    *dnx_data_ingr_congestion_info_max_total_bytes_get_f) (
    int unit);


typedef uint32(
    *dnx_data_ingr_congestion_info_nof_active_drams_get_f) (
    int unit);


typedef uint32(
    *dnx_data_ingr_congestion_info_total_bytes_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_ingr_congestion_info_max_total_bytes_get_f max_total_bytes_get;
    
    dnx_data_ingr_congestion_info_nof_active_drams_get_f nof_active_drams_get;
    
    dnx_data_ingr_congestion_info_total_bytes_get_f total_bytes_get;
...
typedef enum
{
    ...
    dnx_data_ingr_congestion_vsq_colorless_guaranteed_support,
    dnx_data_ingr_congestion_vsq_vsq_with_id_on_nif_port_support,
...
typedef enum
{
    dnx_data_ingr_congestion_dbal_fabric_and_dram_separate_dequeue_pkt_counters,
