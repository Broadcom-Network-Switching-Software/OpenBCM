...
{
    uint32 memory_size;
} dnx_data_module_testing_example_tests_mem_consumption_t;



typedef enum
{
    dnx_data_module_testing_example_tests_disable_mem_cache,
...
typedef uint32(
    *dnx_data_module_testing_example_tests_default_memory_size_get_f) (
    int unit);
...
typedef const dnx_data_module_testing_example_tests_mem_consumption_t *(
    *dnx_data_module_testing_example_tests_mem_consumption_get_f) (
    int unit,
    int module_id);
...
typedef struct
{
    ...
    dnx_data_module_testing_example_tests_default_memory_size_get_f default_memory_size_get;
    
    dnx_data_module_testing_example_tests_all_get_f all_get;
    
    dnxc_data_table_info_get_f all_info_get;
    
    dnx_data_module_testing_example_tests_mem_consumption_get_f mem_consumption_get;
    
    dnxc_data_table_info_get_f mem_consumption_info_get;
...
} dnx_data_module_testing_compile_flags_submodule_standard_table_flags_t;
...
typedef enum
{
    ...
    dnx_data_module_testing_compile_flags_submodule_standard_feature_flags,

#endif 

    
    _dnx_data_module_testing_compile_flags_submodule_standard_feature_nof
} dnx_data_module_testing_compile_flags_submodule_standard_feature_e;



typedef int(
    *dnx_data_module_testing_compile_flags_submodule_standard_feature_get_f) (
    int unit,
...
typedef uint32(
    *dnx_data_module_testing_compile_flags_submodule_standard_define_ifdef_get_f) (
    int unit);
...
typedef uint32(
    *dnx_data_module_testing_compile_flags_submodule_standard_define_ifndef_get_f) (
    int unit);
...
typedef uint32(
    *dnx_data_module_testing_compile_flags_submodule_standard_define_if_get_f) (
    int unit);
...
typedef uint32(
    *dnx_data_module_testing_compile_flags_submodule_standard_numeric_flags_get_f) (
    int unit);
...
typedef const dnx_data_module_testing_compile_flags_submodule_standard_table_flags_t *(
    *dnx_data_module_testing_compile_flags_submodule_standard_table_flags_get_f) (
    int unit,
    int table_flags_key);
...
typedef struct
{
    ...
    dnx_data_module_testing_compile_flags_submodule_standard_feature_get_f feature_get;
#ifdef INCLUDE_XFLOW_MACSEC

    
    dnx_data_module_testing_compile_flags_submodule_standard_define_ifdef_get_f define_ifdef_get;

#endif 
#ifndef INCLUDE_XFLOW_MACSEC

    
    dnx_data_module_testing_compile_flags_submodule_standard_define_ifndef_get_f define_ifndef_get;

#endif 
#if defined(INCLUDE_XFLOW_MACSEC)

    
    dnx_data_module_testing_compile_flags_submodule_standard_define_if_get_f define_if_get;

#endif 
#ifdef INCLUDE_XFLOW_MACSEC

    
    dnx_data_module_testing_compile_flags_submodule_standard_numeric_flags_get_f numeric_flags_get;

#endif 
#ifdef INCLUDE_XFLOW_MACSEC

    
    dnx_data_module_testing_compile_flags_submodule_standard_table_flags_get_f table_flags_get;
...
#endif 
} dnx_data_if_module_testing_compile_flags_submodule_standard_t;
...
} dnx_data_module_testing_compile_flags_submodule_flags_table_no_flags_t;
...
} dnx_data_module_testing_compile_flags_submodule_flags_table_flags_t;
...
typedef enum
{
    dnx_data_module_testing_compile_flags_submodule_flags_feature_no_flags,
#ifdef BCM_WARM_BOOT_SUPPORT

    dnx_data_module_testing_compile_flags_submodule_flags_feature_flags,

#endif 

    
    _dnx_data_module_testing_compile_flags_submodule_flags_feature_nof
} dnx_data_module_testing_compile_flags_submodule_flags_feature_e;



typedef int(
    *dnx_data_module_testing_compile_flags_submodule_flags_feature_get_f) (
    int unit,
    dnx_data_module_testing_compile_flags_submodule_flags_feature_e feature);


typedef uint32(
    *dnx_data_module_testing_compile_flags_submodule_flags_define_no_flags_get_f) (
    int unit);
...
typedef uint32(
    *dnx_data_module_testing_compile_flags_submodule_flags_define_flags_get_f) (
    int unit);

#endif 

typedef uint32(
    *dnx_data_module_testing_compile_flags_submodule_flags_numeric_no_flags_get_f) (
    int unit);
...
typedef uint32(
    *dnx_data_module_testing_compile_flags_submodule_flags_numeric_flags_get_f) (
    int unit);

#endif 

typedef const dnx_data_module_testing_compile_flags_submodule_flags_table_no_flags_t *(
    *dnx_data_module_testing_compile_flags_submodule_flags_table_no_flags_get_f) (
    int unit,
...
typedef const dnx_data_module_testing_compile_flags_submodule_flags_table_flags_t *(
    *dnx_data_module_testing_compile_flags_submodule_flags_table_flags_get_f) (
    int unit,
    int table_flag_key);
...
typedef struct
{
    ...
    dnx_data_module_testing_compile_flags_submodule_flags_feature_get_f feature_get;
    
    dnx_data_module_testing_compile_flags_submodule_flags_define_no_flags_get_f define_no_flags_get;
#ifdef BCM_WARM_BOOT_SUPPORT

    
    dnx_data_module_testing_compile_flags_submodule_flags_define_flags_get_f define_flags_get;

#endif 
    
    dnx_data_module_testing_compile_flags_submodule_flags_numeric_no_flags_get_f numeric_no_flags_get;
#ifdef BCM_WARM_BOOT_SUPPORT

    
    dnx_data_module_testing_compile_flags_submodule_flags_numeric_flags_get_f numeric_flags_get;

#endif 
    
    dnx_data_module_testing_compile_flags_submodule_flags_table_no_flags_get_f table_no_flags_get;
    
    dnxc_data_table_info_get_f table_no_flags_info_get;
#ifdef BCM_WARM_BOOT_SUPPORT

    
    dnx_data_module_testing_compile_flags_submodule_flags_table_flags_get_f table_flags_get;
...
#endif 
} dnx_data_if_module_testing_compile_flags_submodule_flags_t;
...
typedef enum
{
    ...
    _dnx_data_module_testing_max_test_feature_nof
} dnx_data_module_testing_max_test_feature_e;



typedef int(
    *dnx_data_module_testing_max_test_feature_get_f) (
    int unit,
    dnx_data_module_testing_max_test_feature_e feature);


typedef uint32(
    *dnx_data_module_testing_max_test_greater_d3_get_f) (
    int unit);


typedef uint32(
    *dnx_data_module_testing_max_test_greater_d2_get_f) (
    int unit);


typedef uint32(
    *dnx_data_module_testing_max_test_same_value_get_f) (
    int unit);


typedef uint32(
    *dnx_data_module_testing_max_test_d2_undefined_get_f) (
    int unit);


typedef uint32(
    *dnx_data_module_testing_max_test_d3_undefined_get_f) (
    int unit);



typedef uint32(
    *dnx_data_module_testing_max_test_dnx2_exclusive_get_f) (
    int unit);
...
typedef uint32(
    *dnx_data_module_testing_max_test_compile_flags_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_module_testing_max_test_feature_get_f feature_get;
    
    dnx_data_module_testing_max_test_greater_d3_get_f greater_d3_get;
    
    dnx_data_module_testing_max_test_greater_d2_get_f greater_d2_get;
    
    dnx_data_module_testing_max_test_same_value_get_f same_value_get;
    
    dnx_data_module_testing_max_test_d2_undefined_get_f d2_undefined_get;
    
    dnx_data_module_testing_max_test_d3_undefined_get_f d3_undefined_get;

    
    dnx_data_module_testing_max_test_dnx2_exclusive_get_f dnx2_exclusive_get;

#ifdef INCLUDE_XFLOW_MACSEC

    
    dnx_data_module_testing_max_test_compile_flags_get_f compile_flags_get;

#endif 
} dnx_data_if_module_testing_max_test_t;
...
typedef struct
{
    ...
    dnx_data_if_module_testing_compile_flags_submodule_standard_t compile_flags_submodule_standard;
#ifdef INCLUDE_XFLOW_MACSEC

    
    dnx_data_if_module_testing_compile_flags_submodule_flags_t compile_flags_submodule_flags;

#endif 
    
    dnx_data_if_module_testing_max_test_t max_test;
