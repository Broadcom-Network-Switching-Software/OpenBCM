...
typedef enum
{
    ...
    dnx_data_port_general_define_max_nof_mirror_channels,
...
uint32 dnx_data_port_general_max_nof_mirror_channels_get(
    int unit);
...
typedef enum
{
    ...
    dnx_data_port_general_table_phy_controls_features,
...
const dnx_data_port_general_phy_controls_features_t * dnx_data_port_general_phy_controls_features_get(
    int unit,
...
shr_error_e dnx_data_port_general_phy_controls_features_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
const dnxc_data_table_info_t * dnx_data_port_general_phy_controls_features_info_get(
    int unit);
