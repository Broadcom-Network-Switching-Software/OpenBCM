...
typedef struct
{
    int freq_x2_range_upper_limit;
    uint32 dll_config_val;
    uint32 qc_ck_delay_config_val;
    uint32 qc_wr_delay_config_val;
    uint32 qc_rd_delay_config_val;
} dnx_data_dram_hbm_dll_and_qc_conf_vals_per_freq_range_t;
...
typedef enum
{
    ...
    dnx_data_dram_hbm_hbm2e_support,
    dnx_data_dram_hbm_is_coherency_enforcer_supported,
    dnx_data_dram_hbm_sbus_execute_delay,
...
typedef uint32(
    *dnx_data_dram_hbm_sbus_execute_delay_default_get_f) (
    int unit);


typedef uint32(
    *dnx_data_dram_hbm_enable_dram_bist_on_init_get_f) (
    int unit);
...
typedef const dnx_data_dram_hbm_dll_and_qc_conf_vals_per_freq_range_t *(
    *dnx_data_dram_hbm_dll_and_qc_conf_vals_per_freq_range_get_f) (
    int unit,
    int index);
...
typedef struct
{
    ...
    dnx_data_dram_hbm_sbus_execute_delay_default_get_f sbus_execute_delay_default_get;
    
    dnx_data_dram_hbm_enable_dram_bist_on_init_get_f enable_dram_bist_on_init_get;
    ...
    dnx_data_dram_hbm_dll_and_qc_conf_vals_per_freq_range_get_f dll_and_qc_conf_vals_per_freq_range_get;
    
    dnxc_data_table_info_get_f dll_and_qc_conf_vals_per_freq_range_info_get;
...
typedef struct
{
    uint32 ch_a_start_bit;
    uint32 ch_b_start_bit;
    uint32 field_val;
    uint32 nof_bits;
} dnx_data_dram_gddr6_ca_system_config_fields_t;
...
typedef enum
{
    ...
    dnx_data_dram_gddr6_enable_temp_read_samsung,
    dnx_data_dram_gddr6_enable_temp_read_micron,
...
typedef uint32(
    *dnx_data_dram_gddr6_ck_termination_mr_conf_val_get_f) (
    int unit);


typedef uint32(
    *dnx_data_dram_gddr6_ck_termination_ca_conf_val_get_f) (
    int unit);


typedef uint32(
    *dnx_data_dram_gddr6_wck_granularity_get_f) (
    int unit);


typedef uint32(
    *dnx_data_dram_gddr6_ref_clk_bitmap_get_f) (
    int unit);


typedef uint32(
    *dnx_data_dram_gddr6_ca_termination_conf_val_get_f) (
    int unit);
...
typedef const dnx_data_dram_gddr6_ca_system_config_fields_t *(
    *dnx_data_dram_gddr6_ca_system_config_fields_get_f) (
    int unit,
    int index);
...
typedef struct
{
    ...
    dnx_data_dram_gddr6_ck_termination_mr_conf_val_get_f ck_termination_mr_conf_val_get;
    
    dnx_data_dram_gddr6_ck_termination_ca_conf_val_get_f ck_termination_ca_conf_val_get;
    
    dnx_data_dram_gddr6_wck_granularity_get_f wck_granularity_get;
    
    dnx_data_dram_gddr6_ref_clk_bitmap_get_f ref_clk_bitmap_get;
    
    dnx_data_dram_gddr6_ca_termination_conf_val_get_f ca_termination_conf_val_get;
    ...
    dnx_data_dram_gddr6_ca_system_config_fields_get_f ca_system_config_fields_get;
    
    dnxc_data_table_info_get_f ca_system_config_fields_info_get;
...
typedef enum
{
    ...
    dnx_data_dram_general_info_is_power_optimization_supported,
...
typedef uint32(
    *dnx_data_dram_general_info_write_latency_hbm2e_get_f) (
    int unit);
...
typedef uint32(
    *dnx_data_dram_general_info_read_latency_hbm2e_get_f) (
    int unit);
...
typedef uint32(
    *dnx_data_dram_general_info_supported_dram_bitmap_get_f) (
    int unit);


typedef uint32(
    *dnx_data_dram_general_info_dram_bitmap_internal_get_f) (
    int unit);


typedef uint32(
    *dnx_data_dram_general_info_tertw_get_f) (
    int unit);


typedef uint32(
    *dnx_data_dram_general_info_dram_blocks_in_power_down_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_dram_general_info_write_latency_hbm2e_get_f write_latency_hbm2e_get;
    
    dnx_data_dram_general_info_read_latency_get_f read_latency_get;
    
    dnx_data_dram_general_info_read_latency_hbm2e_get_f read_latency_hbm2e_get;
    ...
    dnx_data_dram_general_info_supported_dram_bitmap_get_f supported_dram_bitmap_get;
    
    dnx_data_dram_general_info_dram_bitmap_internal_get_f dram_bitmap_internal_get;
    
    dnx_data_dram_general_info_tertw_get_f tertw_get;
    
    dnx_data_dram_general_info_dram_blocks_in_power_down_get_f dram_blocks_in_power_down_get;
...
typedef struct
{
    uint32 is_valid;
    uint32 is_used;
    uint32 is_disable_supported;
    uint32 dbal_table;
    uint32 increment_threshold_0;
    uint32 increment_threshold_1;
    uint32 increment_threshold_2;
    uint32 decrement_threshold_0;
    uint32 decrement_threshold_1;
    uint32 decrement_threshold_2;
    uint32 increment_size_0;
    uint32 increment_size_1;
    uint32 increment_size_2;
    uint32 decrement_size_0;
    uint32 decrement_size_1;
    uint32 decrement_size_2;
    uint32 bucket_full_size;
    uint32 bucket_assert_threshold;
    uint32 bucket_deassert_threshold;
    uint32 log2_window_size;
    uint32 reset_on_deassert;
} dnx_data_dram_dram_block_dram_block_params_t;
...
typedef enum
{
    ...
    dnx_data_dram_dram_block_write_plus_read_leaky_bucket,
...
typedef const dnx_data_dram_dram_block_dram_block_params_t *(
    *dnx_data_dram_dram_block_dram_block_params_get_f) (
    int unit,
    int mechanism);
...
typedef struct
{
    ...
    dnx_data_dram_dram_block_dram_block_params_get_f dram_block_params_get;
    
    dnxc_data_table_info_get_f dram_block_params_info_get;
...
typedef uint32(
    *dnx_data_dram_dbal_hbm_write_latency_nof_bits_get_f) (
    int unit);


typedef uint32(
    *dnx_data_dram_dbal_hbm_output_enable_delay_nof_bits_get_f) (
    int unit);


typedef uint32(
    *dnx_data_dram_dbal_hbm_rd_data_en_delay_nof_bits_get_f) (
    int unit);


typedef uint32(
    *dnx_data_dram_dbal_hbm_c_u_nof_bits_get_f) (
    int unit);


typedef uint32(
    *dnx_data_dram_dbal_hbm_r_u_nof_bits_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_dram_dbal_hbm_write_latency_nof_bits_get_f hbm_write_latency_nof_bits_get;
    
    dnx_data_dram_dbal_hbm_output_enable_delay_nof_bits_get_f hbm_output_enable_delay_nof_bits_get;
    
    dnx_data_dram_dbal_hbm_rd_data_en_delay_nof_bits_get_f hbm_rd_data_en_delay_nof_bits_get;
    
    dnx_data_dram_dbal_hbm_c_u_nof_bits_get_f hbm_c_u_nof_bits_get;
    
    dnx_data_dram_dbal_hbm_r_u_nof_bits_get_f hbm_r_u_nof_bits_get;
...
typedef uint32(
    *dnx_data_dram_firmware_max_timeout_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_dram_firmware_max_timeout_get_f max_timeout_get;
