...
typedef enum
{
    ...
    dnx_data_headers_submodule_fhei_sz1_stamp_ive,
...
typedef enum
{
    ...
    dnx_data_headers_internal_define_fwd_layer_index_offset,
    dnx_data_headers_internal_define_fwd_layer_index_bits,
...
uint32 dnx_data_headers_internal_fwd_layer_index_offset_get(
    int unit);


uint32 dnx_data_headers_internal_fwd_layer_index_bits_get(
    int unit);
...
int dnx_data_headers_fhei_sz1_stamp_ive_feature_get(
    int unit,
...
typedef enum
{
    dnx_data_headers_fhei_sz1_stamp_ive_define_fhei_ivec_offset,
    dnx_data_headers_fhei_sz1_stamp_ive_define_fhei_ivec_bits,
    dnx_data_headers_fhei_sz1_stamp_ive_define_fhei_ive_type_offset,
    dnx_data_headers_fhei_sz1_stamp_ive_define_fhei_ive_type_bits,

    
    _dnx_data_headers_fhei_sz1_stamp_ive_define_nof
} dnx_data_headers_fhei_sz1_stamp_ive_define_e;



uint32 dnx_data_headers_fhei_sz1_stamp_ive_fhei_ivec_offset_get(
    int unit);


uint32 dnx_data_headers_fhei_sz1_stamp_ive_fhei_ivec_bits_get(
    int unit);


uint32 dnx_data_headers_fhei_sz1_stamp_ive_fhei_ive_type_offset_get(
    int unit);


uint32 dnx_data_headers_fhei_sz1_stamp_ive_fhei_ive_type_bits_get(
    int unit);
...
typedef enum
{
    ...
    _dnx_data_headers_fhei_sz1_stamp_ive_table_nof
} dnx_data_headers_fhei_sz1_stamp_ive_table_e;
...
typedef enum
{
    ...
    dnx_data_headers_system_headers_define_max_udh0_block_size,
    dnx_data_headers_system_headers_define_max_udh1_block_size,
    dnx_data_headers_system_headers_define_max_udh2_block_size,
    dnx_data_headers_system_headers_define_max_udh3_block_size,
    dnx_data_headers_system_headers_define_itmh_itpp_termination,
...
uint32 dnx_data_headers_system_headers_max_udh0_block_size_get(
    int unit);


uint32 dnx_data_headers_system_headers_max_udh1_block_size_get(
    int unit);


uint32 dnx_data_headers_system_headers_max_udh2_block_size_get(
    int unit);


uint32 dnx_data_headers_system_headers_max_udh3_block_size_get(
    int unit);


uint32 dnx_data_headers_system_headers_itmh_itpp_termination_get(
    int unit);
