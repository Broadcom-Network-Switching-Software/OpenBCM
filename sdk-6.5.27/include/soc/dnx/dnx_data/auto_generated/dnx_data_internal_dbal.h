...
typedef enum
{
    dnx_data_dbal_db_init_table_default_std,
...
const dnx_data_dbal_db_init_default_std_t * dnx_data_dbal_db_init_default_std_get(
    int unit);



shr_error_e dnx_data_dbal_db_init_default_std_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
const dnxc_data_table_info_t * dnx_data_dbal_db_init_default_std_info_get(
    int unit);
