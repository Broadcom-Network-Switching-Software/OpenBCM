...
typedef enum
{
    ...
    dnx_data_lane_map_submodule_otn,
...
int dnx_data_lane_map_otn_feature_get(
    int unit,
...
typedef enum
{
    ...
    _dnx_data_lane_map_otn_define_nof
} dnx_data_lane_map_otn_define_e;
...
typedef enum
{
    dnx_data_lane_map_otn_table_logical_lanes,
    dnx_data_lane_map_otn_table_logical_otn_lane,

    
    _dnx_data_lane_map_otn_table_nof
} dnx_data_lane_map_otn_table_e;



const dnx_data_lane_map_otn_logical_lanes_t * dnx_data_lane_map_otn_logical_lanes_get(
    int unit,
    int port);


const dnx_data_lane_map_otn_logical_otn_lane_t * dnx_data_lane_map_otn_logical_otn_lane_get(
    int unit,
    int port);



shr_error_e dnx_data_lane_map_otn_logical_lanes_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
shr_error_e dnx_data_lane_map_otn_logical_otn_lane_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
const dnxc_data_table_info_t * dnx_data_lane_map_otn_logical_lanes_info_get(
    int unit);


const dnxc_data_table_info_t * dnx_data_lane_map_otn_logical_otn_lane_info_get(
    int unit);
