...
typedef enum
{
    ...
    dnx_data_synce_general_multi_set_is_supported,
...
typedef uint32(
    *dnx_data_synce_general_nof_synce_type_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_synce_general_nof_synce_type_get_f nof_synce_type_get;
