...
typedef enum
{
    ...
    dnx_data_dram_general_info_define_dram_blocks_in_power_down,
...
uint32 dnx_data_dram_general_info_dram_blocks_in_power_down_get(
    int unit);
...
typedef enum
{
    dnx_data_dram_dram_block_table_dram_block_params,
...
const dnx_data_dram_dram_block_dram_block_params_t * dnx_data_dram_dram_block_dram_block_params_get(
    int unit,
    int mechanism);



shr_error_e dnx_data_dram_dram_block_dram_block_params_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
const dnxc_data_table_info_t * dnx_data_dram_dram_block_dram_block_params_info_get(
    int unit);
...
typedef enum
{
    ...
    dnx_data_dram_firmware_define_max_timeout,
...
uint32 dnx_data_dram_firmware_max_timeout_get(
    int unit);
