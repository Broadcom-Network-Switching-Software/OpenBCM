...
typedef enum
{
    ...
    dnx_data_dev_init_time_define_init_total_time,
    dnx_data_dev_init_time_define_appl_init_total_time,
    dnx_data_dev_init_time_define_down_deviation_total,
    dnx_data_dev_init_time_define_up_deviation_total,
    dnx_data_dev_init_time_define_test_sensitivity,
...
uint32 dnx_data_dev_init_time_init_total_time_get(
    int unit);


uint32 dnx_data_dev_init_time_appl_init_total_time_get(
    int unit);


uint32 dnx_data_dev_init_time_down_deviation_total_get(
    int unit);


uint32 dnx_data_dev_init_time_up_deviation_total_get(
    int unit);


uint32 dnx_data_dev_init_time_test_sensitivity_get(
    int unit);
...
typedef enum
{
    dnx_data_dev_init_time_table_step_time,
    dnx_data_dev_init_time_table_appl_step_time,
...
const dnx_data_dev_init_time_step_time_t * dnx_data_dev_init_time_step_time_get(
    int unit,
    int step_id);


const dnx_data_dev_init_time_appl_step_time_t * dnx_data_dev_init_time_appl_step_time_get(
    int unit,
    int step_id);



shr_error_e dnx_data_dev_init_time_step_time_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
shr_error_e dnx_data_dev_init_time_appl_step_time_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
const dnxc_data_table_info_t * dnx_data_dev_init_time_step_time_info_get(
    int unit);


const dnxc_data_table_info_t * dnx_data_dev_init_time_appl_step_time_info_get(
    int unit);
