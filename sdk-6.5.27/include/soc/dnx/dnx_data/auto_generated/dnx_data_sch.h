...
typedef enum
{
    ...
    dnx_data_sch_general_tcg_mapping_hardcoded,
    dnx_data_sch_general_global_tcg_strict_priority,
    dnx_data_sch_general_fc_on_channelized_if_only,
    dnx_data_sch_general_priority_propagation_on_channelized_if_only,
    dnx_data_sch_general_low_rate_connectors_token_count_update,
    dnx_data_sch_general_scheduler_allocation_legacy_api_supported,
    dnx_data_sch_general_is_used,
    dnx_data_sch_general_power_down_supported,
...
typedef uint32(
    *dnx_data_sch_ps_assigned_credit_worth_multiplier_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_sch_ps_assigned_credit_worth_multiplier_get_f assigned_credit_worth_multiplier_get;
...
typedef enum
{
    ...
    dnx_data_sch_flow_multi_low_rate_ranges,
...
typedef uint32(
    *dnx_data_sch_flow_nof_low_rate_ranges_get_f) (
    int unit);


typedef uint32(
    *dnx_data_sch_flow_nof_low_rate_regions_get_f) (
    int unit);


typedef uint32(
    *dnx_data_sch_flow_low_rate_pattern_mask_get_f) (
    int unit);


typedef uint32(
    *dnx_data_sch_flow_low_rate_flow_resolution_get_f) (
    int unit);
...
typedef uint32(
    *dnx_data_sch_flow_virtual_flow_mapped_queue_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_sch_flow_nof_low_rate_ranges_get_f nof_low_rate_ranges_get;
    
    dnx_data_sch_flow_nof_low_rate_regions_get_f nof_low_rate_regions_get;
    
    dnx_data_sch_flow_low_rate_pattern_mask_get_f low_rate_pattern_mask_get;
    
    dnx_data_sch_flow_low_rate_flow_resolution_get_f low_rate_flow_resolution_get;
    ...
    dnx_data_sch_flow_virtual_flow_mapped_queue_get_f virtual_flow_mapped_queue_get;
...
typedef uint32(
    *dnx_data_sch_interface_max_calendar_size_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_sch_interface_max_calendar_size_get_f max_calendar_size_get;
...
typedef uint32(
    *dnx_data_sch_dbal_flow_shaper_max_burst_bits_get_f) (
    int unit);
...
typedef uint32(
    *dnx_data_sch_dbal_priority_propagation_if_group_max_get_f) (
    int unit);


typedef uint32(
    *dnx_data_sch_dbal_max_sch_interfaces_with_fc_get_f) (
    int unit);
...
typedef uint32(
    *dnx_data_sch_dbal_priority_propagation_if_group_nof_bits_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_sch_dbal_flow_shaper_max_burst_bits_get_f flow_shaper_max_burst_bits_get;
    ...
    dnx_data_sch_dbal_priority_propagation_if_group_max_get_f priority_propagation_if_group_max_get;
    
    dnx_data_sch_dbal_max_sch_interfaces_with_fc_get_f max_sch_interfaces_with_fc_get;
    ...
    dnx_data_sch_dbal_priority_propagation_if_group_nof_bits_get_f priority_propagation_if_group_nof_bits_get;
...
typedef enum
{
    dnx_data_sch_fc_context_based_mapping,

    
    _dnx_data_sch_fc_feature_nof
} dnx_data_sch_fc_feature_e;



typedef int(
    *dnx_data_sch_fc_feature_get_f) (
    int unit,
...
typedef struct
{
    ...
    dnx_data_sch_fc_feature_get_f feature_get;
} dnx_data_if_sch_fc_t;
