...
typedef enum
{
    dnx_data_gtimer_ipc_is_supported,

    
    _dnx_data_gtimer_ipc_feature_nof
} dnx_data_gtimer_ipc_feature_e;



typedef int(
    *dnx_data_gtimer_ipc_feature_get_f) (
    int unit,
    dnx_data_gtimer_ipc_feature_e feature);


typedef uint32(
    *dnx_data_gtimer_ipc_block_index_size_get_f) (
    int unit);


typedef uint32(
    *dnx_data_gtimer_ipc_block_index_max_value_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_gtimer_ipc_feature_get_f feature_get;
    
    dnx_data_gtimer_ipc_block_index_size_get_f block_index_size_get;
    
    dnx_data_gtimer_ipc_block_index_max_value_get_f block_index_max_value_get;
} dnx_data_if_gtimer_ipc_t;
