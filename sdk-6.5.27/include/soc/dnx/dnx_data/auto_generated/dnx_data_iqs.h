...
typedef enum
{
    dnx_data_iqs_dbal_fsm_sn_mask_supported,
...
typedef uint32(
    *dnx_data_iqs_dbal_fsm_sn_mask_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_iqs_dbal_fsm_sn_mask_get_f fsm_sn_mask_get;
...
typedef enum
{
    dnx_data_iqs_general_is_used,
    dnx_data_iqs_general_power_down_supported,

    
    _dnx_data_iqs_general_feature_nof
} dnx_data_iqs_general_feature_e;



typedef int(
    *dnx_data_iqs_general_feature_get_f) (
    int unit,
...
typedef struct
{
    ...
    dnx_data_iqs_general_feature_get_f feature_get;
} dnx_data_if_iqs_general_t;
...
typedef struct
{
    ...
    dnx_data_if_iqs_general_t general;
