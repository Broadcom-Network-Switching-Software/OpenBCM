...
typedef enum
{
    dnx_data_srv6_submodule_general,
...
int dnx_data_srv6_general_feature_get(
    int unit,
...
typedef enum
{
    ...
    _dnx_data_srv6_general_define_nof
} dnx_data_srv6_general_define_e;
...
typedef enum
{
    ...
    _dnx_data_srv6_general_table_nof
} dnx_data_srv6_general_table_e;
...
typedef enum
{
    dnx_data_srv6_termination_define_max_nof_terminated_sids_psp_extended,
    ...
    dnx_data_srv6_termination_define_max_nof_terminated_sids_usd_1pass,
    dnx_data_srv6_termination_define_max_nof_locators,
...
uint32 dnx_data_srv6_termination_max_nof_terminated_sids_psp_extended_get(
    int unit);
...
uint32 dnx_data_srv6_termination_max_nof_terminated_sids_usd_1pass_get(
    int unit);


uint32 dnx_data_srv6_termination_max_nof_locators_get(
    int unit);
