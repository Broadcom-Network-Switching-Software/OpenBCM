...
int dnx_data_gtimer_ipc_feature_get(
    int unit,
...
typedef enum
{
    dnx_data_gtimer_ipc_define_block_index_size,
    dnx_data_gtimer_ipc_define_block_index_max_value,

    
    _dnx_data_gtimer_ipc_define_nof
} dnx_data_gtimer_ipc_define_e;



uint32 dnx_data_gtimer_ipc_block_index_size_get(
    int unit);


uint32 dnx_data_gtimer_ipc_block_index_max_value_get(
    int unit);
...
typedef enum
{
    ...
    _dnx_data_gtimer_ipc_table_nof
} dnx_data_gtimer_ipc_table_e;
