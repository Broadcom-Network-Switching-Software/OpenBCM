...
typedef enum
{
    dnx_data_ingr_reassembly_submodule_general,
...
int dnx_data_ingr_reassembly_general_feature_get(
    int unit,
...
typedef enum
{
    ...
    _dnx_data_ingr_reassembly_general_define_nof
} dnx_data_ingr_reassembly_general_define_e;
...
typedef enum
{
    ...
    _dnx_data_ingr_reassembly_general_table_nof
} dnx_data_ingr_reassembly_general_table_e;
...
typedef enum
{
    ...
    dnx_data_ingr_reassembly_context_define_rcy_unique_context,
...
uint32 dnx_data_ingr_reassembly_context_rcy_unique_context_get(
    int unit);
