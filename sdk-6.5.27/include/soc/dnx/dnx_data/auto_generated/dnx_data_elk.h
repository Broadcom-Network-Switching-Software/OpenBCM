...
typedef enum
{
    dnx_data_elk_general_is_egw_block_exist,
    ...
    dnx_data_elk_general_back_pressure_bit_exists,
    dnx_data_elk_general_are_two_kbps_connected,
    dnx_data_elk_general_hard_reset_after_kbp_soft_reset_fail,
...
typedef uint32(
    *dnx_data_elk_general_nof_dbs_per_core_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_elk_general_nof_dbs_per_core_get_f nof_dbs_per_core_get;
...
typedef uint32(
    *dnx_data_elk_application_large_mc_mode1_get_f) (
    int unit);


typedef uint32(
    *dnx_data_elk_application_large_mc_mode2_get_f) (
    int unit);


typedef uint32(
    *dnx_data_elk_application_large_mc_mode3_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_elk_application_large_mc_mode1_get_f large_mc_mode1_get;
    
    dnx_data_elk_application_large_mc_mode2_get_f large_mc_mode2_get;
    
    dnx_data_elk_application_large_mc_mode3_get_f large_mc_mode3_get;
