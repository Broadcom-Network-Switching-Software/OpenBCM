...
typedef enum
{
    ...
    dnx_data_ipq_submodule_general,
...
int dnx_data_ipq_general_feature_get(
    int unit,
...
typedef enum
{
    ...
    _dnx_data_ipq_general_define_nof
} dnx_data_ipq_general_define_e;
...
typedef enum
{
    ...
    _dnx_data_ipq_general_table_nof
} dnx_data_ipq_general_table_e;
