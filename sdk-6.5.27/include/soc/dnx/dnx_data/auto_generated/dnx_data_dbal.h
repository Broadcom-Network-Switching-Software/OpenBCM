...
{
    char *image_name;
} dnx_data_dbal_db_init_default_std_t;
...
typedef enum
{
    ...
    dnx_data_dbal_db_init_tcam_cs_as_hl_tcam,
...
typedef const dnx_data_dbal_db_init_default_std_t *(
    *dnx_data_dbal_db_init_default_std_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_dbal_db_init_default_std_get_f default_std_get;
    
    dnxc_data_table_info_get_f default_std_info_get;
