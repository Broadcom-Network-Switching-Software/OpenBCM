...
typedef enum
{
    dnx_data_trap_submodule_general,
...
int dnx_data_trap_general_feature_get(
    int unit,
...
typedef enum
{
    ...
    _dnx_data_trap_general_define_nof
} dnx_data_trap_general_define_e;
...
typedef enum
{
    ...
    _dnx_data_trap_general_table_nof
} dnx_data_trap_general_table_e;
...
typedef enum
{
    ...
    dnx_data_trap_ingress_define_max_legal_predefined_trap_id,
    dnx_data_trap_ingress_define_nof_user_defined_traps,
    dnx_data_trap_ingress_define_nof_user_defined_traps_in_jr1_mode,
...
uint32 dnx_data_trap_ingress_max_legal_predefined_trap_id_get(
    int unit);
...
uint32 dnx_data_trap_ingress_nof_user_defined_traps_in_jr1_mode_get(
    int unit);
