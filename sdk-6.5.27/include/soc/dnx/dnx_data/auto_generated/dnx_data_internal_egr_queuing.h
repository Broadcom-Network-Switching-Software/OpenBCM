...
typedef enum
{
    ...
    dnx_data_egr_queuing_submodule_general,
...
typedef enum
{
    ...
    dnx_data_egr_queuing_params_define_nof_bits_in_channel,
    ...
    dnx_data_egr_queuing_params_define_first_lp_egr_interface,
    dnx_data_egr_queuing_params_define_nof_egr_ch_interfaces,
    dnx_data_egr_queuing_params_define_nof_egr_rcy_interfaces,
    dnx_data_egr_queuing_params_define_nof_egr_olp_interfaces,
    ...
    dnx_data_egr_queuing_params_define_txq_max_credits_reduce_factor,
    ...
    dnx_data_egr_queuing_params_define_egr_if_flexe_base,
    dnx_data_egr_queuing_params_define_nof_dedicated_flexe_interfaces,
    dnx_data_egr_queuing_params_define_nof_egr_interfaces_wo_flexe,
    dnx_data_egr_queuing_params_define_egr_if_nif_alloc_start,
    dnx_data_egr_queuing_params_define_egr_if_nif_alloc_end,
    dnx_data_egr_queuing_params_define_egr_if_ilkn_alloc_start,
    dnx_data_egr_queuing_params_define_egr_if_ilkn_alloc_end,
    dnx_data_egr_queuing_params_define_egq_shaper_max_mbps,
    dnx_data_egr_queuing_params_define_nof_fqp_profiles,
    dnx_data_egr_queuing_params_define_min_gap_bits,
    dnx_data_egr_queuing_params_define_bubble_pulse_width_for_polling,
    dnx_data_egr_queuing_params_define_invalid_otm_port,
    dnx_data_egr_queuing_params_define_burst_size_below_mtu,
    dnx_data_egr_queuing_params_define_egress_bubble_delay,
...
uint32 dnx_data_egr_queuing_params_nof_bits_in_channel_get(
    int unit);
...
uint32 dnx_data_egr_queuing_params_first_lp_egr_interface_get(
    int unit);
...
uint32 dnx_data_egr_queuing_params_nof_egr_rcy_interfaces_get(
    int unit);


uint32 dnx_data_egr_queuing_params_nof_egr_olp_interfaces_get(
    int unit);
...
uint32 dnx_data_egr_queuing_params_txq_max_credits_reduce_factor_get(
    int unit);
...
uint32 dnx_data_egr_queuing_params_egr_if_flexe_base_get(
    int unit);


uint32 dnx_data_egr_queuing_params_nof_dedicated_flexe_interfaces_get(
    int unit);


uint32 dnx_data_egr_queuing_params_nof_egr_interfaces_wo_flexe_get(
    int unit);


uint32 dnx_data_egr_queuing_params_egr_if_nif_alloc_start_get(
    int unit);


uint32 dnx_data_egr_queuing_params_egr_if_nif_alloc_end_get(
    int unit);


uint32 dnx_data_egr_queuing_params_egr_if_ilkn_alloc_start_get(
    int unit);


uint32 dnx_data_egr_queuing_params_egr_if_ilkn_alloc_end_get(
    int unit);


uint32 dnx_data_egr_queuing_params_egq_shaper_max_mbps_get(
    int unit);


uint32 dnx_data_egr_queuing_params_nof_fqp_profiles_get(
    int unit);


uint32 dnx_data_egr_queuing_params_min_gap_bits_get(
    int unit);


uint32 dnx_data_egr_queuing_params_bubble_pulse_width_for_polling_get(
    int unit);
...
uint32 dnx_data_egr_queuing_params_egress_bubble_delay_get(
    int unit);
...
typedef enum
{
    ...
    dnx_data_egr_queuing_params_table_fqp_dbf_additional_latency,
...
const dnx_data_egr_queuing_params_fqp_dbf_additional_latency_t * dnx_data_egr_queuing_params_fqp_dbf_additional_latency_get(
    int unit,
    int core_index);
...
shr_error_e dnx_data_egr_queuing_params_fqp_dbf_additional_latency_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
const dnxc_data_table_info_t * dnx_data_egr_queuing_params_fqp_dbf_additional_latency_info_get(
    int unit);
...
int dnx_data_egr_queuing_general_feature_get(
    int unit,
...
typedef enum
{
    ...
    _dnx_data_egr_queuing_general_define_nof
} dnx_data_egr_queuing_general_define_e;
...
typedef enum
{
    ...
    _dnx_data_egr_queuing_general_table_nof
} dnx_data_egr_queuing_general_table_e;
