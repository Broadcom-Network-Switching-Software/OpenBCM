...
typedef enum
{
    ...
    dnx_data_trunk_submodule_protection,
...
int dnx_data_trunk_protection_feature_get(
    int unit,
...
typedef enum
{
    ...
    _dnx_data_trunk_protection_define_nof
} dnx_data_trunk_protection_define_e;
...
typedef enum
{
    ...
    _dnx_data_trunk_protection_table_nof
} dnx_data_trunk_protection_table_e;
