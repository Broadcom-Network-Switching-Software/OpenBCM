...
typedef enum
{
    ...
    dnx_data_trunk_psc_consistent_hashing_hw_support,
...
typedef enum
{
    dnx_data_trunk_flow_agg_member_resolution_v1,
...
typedef enum
{
    ...
    _dnx_data_trunk_protection_feature_nof
} dnx_data_trunk_protection_feature_e;



typedef int(
    *dnx_data_trunk_protection_feature_get_f) (
    int unit,
...
typedef struct
{
    ...
    dnx_data_trunk_protection_feature_get_f feature_get;
} dnx_data_if_trunk_protection_t;
...
typedef struct
{
    ...
    dnx_data_if_trunk_protection_t protection;
} dnx_data_if_trunk_t;
