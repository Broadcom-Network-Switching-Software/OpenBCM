...
#define DBAL_NOF_CORE_GROUPS                            (dnx_data_device.general.nof_core_groups_get(unit))
...
#define DBAL_FIELD_IND_IS_SPECIFIC_IMAGE_AND_IS_NOT_DEFAULT_STANDARD   17
#define DBAL_NOF_FIELD_IND                             (18)
