...
typedef enum
{
    ...
    DNX_SW_STATE_DNX_ALGO_SYNCE_DB__FIRST,
    DNX_SW_STATE_DNX_ALGO_SYNCE_DB__FIRST_SUB = DNX_SW_STATE_DNX_ALGO_SYNCE_DB__FIRST - 1,
    DNX_SW_STATE_DNX_ALGO_SYNCE_DB__FABRIC_SYNCE_STATUS,
    DNX_SW_STATE_DNX_ALGO_SYNCE_DB__NIF_SYNCE_STATUS,
    DNX_SW_STATE_DNX_ALGO_SYNCE_DB__SYNCE_TYPE_CORE_GROUP_ID,
    DNX_SW_STATE_DNX_ALGO_SYNCE_DB__LAST,
    DNX_SW_STATE_DNX_ALGO_SYNCE_DB__LAST_SUB = DNX_SW_STATE_DNX_ALGO_SYNCE_DB__LAST - 1,
    DNX_SW_STATE_DNX_ALGO_SYNCE_DB__FABRIC_SYNCE_STATUS__FIRST,
    DNX_SW_STATE_DNX_ALGO_SYNCE_DB__FABRIC_SYNCE_STATUS__FIRST_SUB = DNX_SW_STATE_DNX_ALGO_SYNCE_DB__FABRIC_SYNCE_STATUS__FIRST - 1,
    ...
    DNX_SW_STATE_DNX_ALGO_SYNCE_DB__FABRIC_SYNCE_STATUS__LAST,
    DNX_SW_STATE_DNX_ALGO_SYNCE_DB__FABRIC_SYNCE_STATUS__LAST_SUB = DNX_SW_STATE_DNX_ALGO_SYNCE_DB__FABRIC_SYNCE_STATUS__LAST - 1,
    DNX_SW_STATE_DNX_ALGO_SYNCE_DB__NIF_SYNCE_STATUS__FIRST,
    DNX_SW_STATE_DNX_ALGO_SYNCE_DB__NIF_SYNCE_STATUS__FIRST_SUB = DNX_SW_STATE_DNX_ALGO_SYNCE_DB__NIF_SYNCE_STATUS__FIRST - 1,
    ...
    DNX_SW_STATE_DNX_ALGO_SYNCE_DB__NIF_SYNCE_STATUS__LAST,
    DNX_SW_STATE_DNX_ALGO_SYNCE_DB__NIF_SYNCE_STATUS__LAST_SUB = DNX_SW_STATE_DNX_ALGO_SYNCE_DB__NIF_SYNCE_STATUS__LAST - 1,
