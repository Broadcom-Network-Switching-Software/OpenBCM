...
typedef struct {
    ...
    dnx_field_predefined_qual_info_t predefined[DNX_DATA_MAX_FIELD_QUAL_PREDEFINED_NOF];
    dnx_field_predefined_qual_info_t layer_record[DNX_DATA_MAX_FIELD_QUAL_LAYER_RECORD_NOF];
