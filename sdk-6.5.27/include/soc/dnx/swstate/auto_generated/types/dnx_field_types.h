...
#define DNX_ACTION(dnx_class, dnx_stage, dnx_index) ((((uint32)(dnx_class)) << DNX_ACTION_CLASS_SHIFT) | (((uint32)(dnx_stage)) << DNX_ACTION_STAGE_SHIFT) | (dnx_index))
...
#define DNX_QUAL(dnx_class, dnx_stage, dnx_index) ((((uint32)(dnx_class)) << DNX_QUAL_CLASS_SHIFT) | (((uint32)(dnx_stage)) << DNX_QUAL_STAGE_SHIFT) | (dnx_index))
...
#define DNX_FIELD_ACTION_PRIORITY_INVALID (~(1U << BCM_FIELD_ACTION_VALID_OFFSET))
...
typedef enum {
    ...
    DNX_FIELD_KEY_LENGTH_TYPE_E_DUMMY
...
typedef enum {
    ...
    DNX_FIELD_ACTION_LENGTH_TYPE_E_DUMMY
...
typedef enum {
    ...
    DNX_FIELD_ACTION_CLASS_E_DUMMY
