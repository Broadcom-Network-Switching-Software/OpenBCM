...
typedef enum {
    ...
    DNX_FIELD_CONTEXT_COMPARE_MODE_E_DUMMY
...
typedef enum {
    ...
    DNX_FIELD_CONTEXT_HASH_MODE_E_DUMMY
...
typedef enum {
    ...
    DNX_FIELD_CONTEXT_STATE_TABLE_MODE_E_DUMMY
} dnx_field_context_state_table_mode_e;

typedef enum {
    DNX_FIELD_CONTEXT_STATE_TABLE_OPCODE_QUAL,
    DNX_FIELD_CONTEXT_STATE_TABLE_OPCODE_INCREMENT,
    DNX_FIELD_CONTEXT_STATE_TABLE_OPCODE_ADD,
    DNX_FIELD_CONTEXT_STATE_TABLE_OPCODE_WRITE,
    DNX_FIELD_CONTEXT_STATE_TABLE_OPCODE_AND,
    DNX_FIELD_CONTEXT_STATE_TABLE_OPCODE_OR,
    DNX_FIELD_CONTEXT_STATE_TABLE_OPCODE_XOR,
    DNX_FIELD_CONTEXT_STATE_TABLE_OPCODE_NOF,
    
    DNX_FIELD_CONTEXT_STATE_TABLE_OPCODE_E_DUMMY
} dnx_field_context_state_table_opcode_e;
