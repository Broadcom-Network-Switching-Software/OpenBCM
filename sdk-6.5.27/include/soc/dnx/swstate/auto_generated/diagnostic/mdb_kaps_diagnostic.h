...
#ifndef __DNX_MDB_KAPS_DIAGNOSTIC_H__
#define __DNX_MDB_KAPS_DIAGNOSTIC_H__
...
typedef enum {
    ...
    MDB_KAPS_DB_DB_INFO_AD_DB_P_ARR_INFO,
    MDB_KAPS_DB_DB_INFO_AD_DB_SIZE_ARR_INFO,
...
int mdb_kaps_db_db_info_ad_db_p_arr_dump(
    int unit, int db_info_idx_0, int ad_db_p_arr_idx_0, dnx_sw_state_dump_filters_t filters);

int mdb_kaps_db_db_info_ad_db_size_arr_dump(
    int unit, int db_info_idx_0, int ad_db_size_arr_idx_0, dnx_sw_state_dump_filters_t filters);
...
int mdb_kaps_db_ad_size_supported_dump(
    int unit, int ad_size_supported_idx_0, int ad_size_supported_idx_1, dnx_sw_state_dump_filters_t filters);
