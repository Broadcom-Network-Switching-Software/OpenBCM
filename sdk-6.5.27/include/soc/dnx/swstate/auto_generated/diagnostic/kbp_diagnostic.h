...
#ifndef __DNX_KBP_DIAGNOSTIC_H__
#define __DNX_KBP_DIAGNOSTIC_H__
...
typedef enum {
    ...
    KBP_SW_STATE_DB_HANDLES_INFO_REGULAR_RESULT_SIZE_INFO,
...
int kbp_sw_state_fwd_caching_enabled_dump(
    int unit, dnx_sw_state_dump_filters_t filters);
...
int kbp_sw_state_db_handles_info_core_id_dump(
    int unit, int db_handles_info_idx_0, dnx_sw_state_dump_filters_t filters);

int kbp_sw_state_db_handles_info_caching_enabled_dump(
    int unit, int db_handles_info_idx_0, dnx_sw_state_dump_filters_t filters);
...
int kbp_sw_state_db_handles_info_regular_result_size_dump(
    int unit, int db_handles_info_idx_0, dnx_sw_state_dump_filters_t filters);

int kbp_sw_state_db_handles_info_opt_result_size_dump(
    int unit, int db_handles_info_idx_0, dnx_sw_state_dump_filters_t filters);

int kbp_sw_state_db_handles_info_large_opt_result_size_dump(
    int unit, int db_handles_info_idx_0, dnx_sw_state_dump_filters_t filters);
