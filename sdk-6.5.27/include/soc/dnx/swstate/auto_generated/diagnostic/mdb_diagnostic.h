...
#ifndef __DNX_MDB_DIAGNOSTIC_H__
#define __DNX_MDB_DIAGNOSTIC_H__
...
int mdb_db_infos_em_key_format_em_bank_info_bank_size_used_nof_rows_dump(
    int unit, int em_key_format_idx_0, int em_bank_info_idx_0, dnx_sw_state_dump_filters_t filters);
...
int mdb_db_infos_em_key_format_nof_ways_dump(
    int unit, int em_key_format_idx_0, dnx_sw_state_dump_filters_t filters);

int mdb_db_infos_em_key_format_nof_flex_ways_dump(
    int unit, int em_key_format_idx_0, dnx_sw_state_dump_filters_t filters);
...
int mdb_db_infos_db_address_space_bits_dump(
    int unit, int db_idx_0, dnx_sw_state_dump_filters_t filters);
...
int mdb_db_infos_mdb_cluster_infos_macro_cluster_cache_dump(
    int unit, int macro_cluster_cache_idx_0, int macro_cluster_cache_idx_1, int macro_cluster_cache_idx_2, dnx_sw_state_dump_filters_t filters);

int mdb_db_infos_mdb_cluster_infos_macro_cluster_cache_data_dump(
    int unit, int macro_cluster_cache_idx_0, int macro_cluster_cache_idx_1, int macro_cluster_cache_idx_2, int data_idx_0, int data_idx_1, dnx_sw_state_dump_filters_t filters);
...
int mdb_db_infos_fec_db_info_dump(
    int unit, dnx_sw_state_dump_filters_t filters);

int mdb_db_infos_fec_db_info_fec_db_map_dump(
    int unit, int bank_id, dnx_sw_state_dump_filters_t filters);

int mdb_db_infos_fec_db_info_fec_id_range_start_dump(
    int unit, int index, dnx_sw_state_dump_filters_t filters);

int mdb_db_infos_fec_db_info_fec_id_range_size_dump(
    int unit, int index, dnx_sw_state_dump_filters_t filters);
