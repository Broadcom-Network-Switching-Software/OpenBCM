...
int dnx_rx_parser_info_ftmh_pp_dsp_to_cpu_port_dump(
    int unit, int ftmh_pp_dsp_to_cpu_port_idx_0, dnx_sw_state_dump_filters_t filters);

int dnx_rx_parser_info_etpp_oam_up_mep_dest_trap_id1_dump(
    int unit, dnx_sw_state_dump_filters_t filters);

int dnx_rx_parser_info_etpp_oam_up_mep_dest_trap_id2_dump(
    int unit, dnx_sw_state_dump_filters_t filters);
