...
#ifndef __DNX_ALGO_LIF_DIAGNOSTIC_H__
#define __DNX_ALGO_LIF_DIAGNOSTIC_H__
...
int local_outlif_info_logical_phase_info_first_no_ll_bank_dump(
    int unit, int logical_phase_info_idx_0, dnx_sw_state_dump_filters_t filters);

int local_outlif_info_logical_phase_info_last_no_ll_bank_dump(
    int unit, int logical_phase_info_idx_0, dnx_sw_state_dump_filters_t filters);
...
int local_outlif_info_dynamic_algo_dump(
    int unit, dnx_sw_state_dump_filters_t filters);
