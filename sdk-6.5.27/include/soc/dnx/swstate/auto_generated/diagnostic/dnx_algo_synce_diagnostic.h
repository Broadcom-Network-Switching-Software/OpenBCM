...
typedef enum {
    ...
    DNX_ALGO_SYNCE_DB_NIF_SYNCE_STATUS_INFO,
...
int dnx_algo_synce_db_nif_synce_status_dump(
    int unit, dnx_sw_state_dump_filters_t filters);

int dnx_algo_synce_db_nif_synce_status_master_synce_enabled_dump(
    int unit, dnx_sw_state_dump_filters_t filters);

int dnx_algo_synce_db_nif_synce_status_slave_synce_enabled_dump(
    int unit, dnx_sw_state_dump_filters_t filters);

int dnx_algo_synce_db_nif_synce_status_master_set1_synce_enabled_dump(
    int unit, dnx_sw_state_dump_filters_t filters);

int dnx_algo_synce_db_nif_synce_status_slave_set1_synce_enabled_dump(
    int unit, dnx_sw_state_dump_filters_t filters);

int dnx_algo_synce_db_synce_type_core_group_id_dump(
    int unit, int synce_type_core_group_id_idx_0, dnx_sw_state_dump_filters_t filters);
