...
typedef int (*dnx_rx_parser_info_etpp_oam_up_mep_dest_trap_id1_set_cb)(
    int unit, uint32 etpp_oam_up_mep_dest_trap_id1);

typedef int (*dnx_rx_parser_info_etpp_oam_up_mep_dest_trap_id1_get_cb)(
    int unit, uint32 *etpp_oam_up_mep_dest_trap_id1);

typedef int (*dnx_rx_parser_info_etpp_oam_up_mep_dest_trap_id2_set_cb)(
    int unit, uint32 etpp_oam_up_mep_dest_trap_id2);

typedef int (*dnx_rx_parser_info_etpp_oam_up_mep_dest_trap_id2_get_cb)(
    int unit, uint32 *etpp_oam_up_mep_dest_trap_id2);
...
typedef struct {
    dnx_rx_parser_info_etpp_oam_up_mep_dest_trap_id1_set_cb set;
    dnx_rx_parser_info_etpp_oam_up_mep_dest_trap_id1_get_cb get;
} dnx_rx_parser_info_etpp_oam_up_mep_dest_trap_id1_cbs;

typedef struct {
    dnx_rx_parser_info_etpp_oam_up_mep_dest_trap_id2_set_cb set;
    dnx_rx_parser_info_etpp_oam_up_mep_dest_trap_id2_get_cb get;
} dnx_rx_parser_info_etpp_oam_up_mep_dest_trap_id2_cbs;
...
typedef struct {
    ...
    dnx_rx_parser_info_etpp_oam_up_mep_dest_trap_id1_cbs etpp_oam_up_mep_dest_trap_id1;
    dnx_rx_parser_info_etpp_oam_up_mep_dest_trap_id2_cbs etpp_oam_up_mep_dest_trap_id2;
