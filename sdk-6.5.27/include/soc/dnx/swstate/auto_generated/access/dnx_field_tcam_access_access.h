...
typedef int (*dnx_field_tcam_access_sw_entry_location_hash_create_cb)(
    int unit, uint32 entry_location_hash_idx_0, sw_state_htb_create_info_t *init_info);

typedef int (*dnx_field_tcam_access_sw_entry_location_hash_find_cb)(
    int unit, uint32 entry_location_hash_idx_0, const uint32 *key, uint32 *value);

typedef int (*dnx_field_tcam_access_sw_entry_location_hash_get_next_cb)(
    int unit, uint32 entry_location_hash_idx_0, uint32 *iter, uint32 *key, uint32 *value);

typedef int (*dnx_field_tcam_access_sw_entry_location_hash_insert_cb)(
    int unit, uint32 entry_location_hash_idx_0, const uint32 *key, uint32 *data_idx);
...
typedef int (*dnx_field_tcam_access_sw_entry_location_hash_print_cb)(
    int unit, uint32 entry_location_hash_idx_0);

typedef int (*dnx_field_tcam_access_sw_entry_location_hash_traverse_cb)(
    int unit, uint32 entry_location_hash_idx_0, sw_state_htb_traverse_cb traverse_func, void *user_data);
...
typedef int (*dnx_field_tcam_access_sw_entry_location_hash_get_by_index_cb)(
    int unit, uint32 entry_location_hash_idx_0, uint32 data_index, uint32 *key);
...
typedef struct {
    ...
    dnx_field_tcam_access_sw_entry_location_hash_print_cb print;
    dnx_field_tcam_access_sw_entry_location_hash_traverse_cb traverse;
