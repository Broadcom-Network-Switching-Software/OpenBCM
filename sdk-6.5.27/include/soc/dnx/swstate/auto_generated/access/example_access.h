...
typedef int (*example_array_range_example_range_read_cb)(
    int unit, uint32 from_idx, uint32 nof_elements, uint32 *dest);

typedef int (*example_array_range_example_range_write_cb)(
    int unit, uint32 from_idx, uint32 nof_elements, const uint32 *source);
...
typedef int (*example_htb_rh_find_cb)(
    int unit, const int *key, void *value);

typedef int (*example_htb_rh_get_next_cb)(
    int unit, uint32 *iter, int *key, void *value);

typedef int (*example_htb_rh_insert_cb)(
    int unit, const int *key, const void *value);
...
typedef int (*example_htb_rh_traverse_cb)(
    int unit, sw_state_htb_traverse_cb traverse_func, void *user_data);

typedef int (*example_multihead_htb_rh_create_cb)(
    int unit, sw_state_htb_create_info_t *init_info, int key_size, int value_size);

typedef int (*example_multihead_htb_rh_find_cb)(
    int unit, uint8 table_idx, const void *key, void *value);

typedef int (*example_multihead_htb_rh_get_next_cb)(
    int unit, uint8 table_idx, uint32 *iter, void *key, void *value);

typedef int (*example_multihead_htb_rh_insert_cb)(
    int unit, uint8 table_idx, const void *key, const void *value);

typedef int (*example_multihead_htb_rh_replace_cb)(
    int unit, uint8 table_idx, const void *key, const void *value);

typedef int (*example_multihead_htb_rh_delete_cb)(
    int unit, uint8 table_idx, const void *key);

typedef int (*example_multihead_htb_rh_delete_all_cb)(
    int unit, uint8 table_idx);

typedef int (*example_multihead_htb_rh_print_cb)(
    int unit);

typedef int (*example_multihead_htb_rh_traverse_cb)(
    int unit, uint8 table_idx, sw_state_htb_traverse_cb traverse_func, void *user_data);

typedef int (*example_multihead_htb_rh_delete_all_tables_cb)(
    int unit);

typedef int (*example_index_htb_rh_create_cb)(
    int unit, sw_state_htb_create_info_t *init_info);

typedef int (*example_index_htb_rh_find_cb)(
    int unit, const int *key, uint32 *value);

typedef int (*example_index_htb_rh_get_next_cb)(
    int unit, uint32 *iter, int *key, uint32 *value);

typedef int (*example_index_htb_rh_insert_cb)(
    int unit, const int *key, uint32 *data_idx);

typedef int (*example_index_htb_rh_delete_cb)(
    int unit, const int *key);

typedef int (*example_index_htb_rh_delete_all_cb)(
    int unit);

typedef int (*example_index_htb_rh_print_cb)(
    int unit);

typedef int (*example_index_htb_rh_traverse_cb)(
    int unit, sw_state_htb_traverse_cb traverse_func, void *user_data);

typedef int (*example_index_htb_rh_insert_at_index_cb)(
    int unit, const int *key, uint32 data_idx);

typedef int (*example_index_htb_rh_delete_by_index_cb)(
    int unit, uint32 data_index);

typedef int (*example_index_htb_rh_get_by_index_cb)(
    int unit, uint32 data_index, int *key);
...
typedef int (*example_defragmented_chunk_example_get_free_slots_cb)(
    int unit, uint32 defragmented_chunk_example_idx_0, uint32 *output);
...
typedef struct {
    ...
    example_htb_rh_get_next_cb get_next;
    ...
    example_htb_rh_traverse_cb traverse;
} example_htb_rh_cbs;

typedef struct {
    example_multihead_htb_rh_create_cb create;
    example_multihead_htb_rh_find_cb find;
    example_multihead_htb_rh_get_next_cb get_next;
    example_multihead_htb_rh_insert_cb insert;
    example_multihead_htb_rh_replace_cb replace;
    example_multihead_htb_rh_delete_cb delete;
    example_multihead_htb_rh_delete_all_cb delete_all;
    example_multihead_htb_rh_print_cb print;
    example_multihead_htb_rh_traverse_cb traverse;
    example_multihead_htb_rh_delete_all_tables_cb delete_all_tables;
} example_multihead_htb_rh_cbs;

typedef struct {
    example_index_htb_rh_create_cb create;
    example_index_htb_rh_find_cb find;
    example_index_htb_rh_get_next_cb get_next;
    example_index_htb_rh_insert_cb insert;
    example_index_htb_rh_delete_cb delete;
    example_index_htb_rh_delete_all_cb delete_all;
    example_index_htb_rh_print_cb print;
    example_index_htb_rh_traverse_cb traverse;
    example_index_htb_rh_insert_at_index_cb insert_at_index;
    example_index_htb_rh_delete_by_index_cb delete_by_index;
    example_index_htb_rh_get_by_index_cb get_by_index;
} example_index_htb_rh_cbs;
...
typedef struct {
    ...
    example_defragmented_chunk_example_get_free_slots_cb get_free_slots;
...
typedef struct {
    ...
    example_multihead_htb_rh_cbs multihead_htb_rh;
    example_index_htb_rh_cbs index_htb_rh;
