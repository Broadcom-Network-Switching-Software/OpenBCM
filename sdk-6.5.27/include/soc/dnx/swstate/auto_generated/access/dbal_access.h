...
typedef int (*dbal_db_sw_tables_hash_table_create_cb)(
    int unit, uint32 sw_tables_idx_0, sw_state_htb_create_info_t *init_info);

typedef int (*dbal_db_sw_tables_hash_table_find_cb)(
    int unit, uint32 sw_tables_idx_0, const void *key, uint32 *value);

typedef int (*dbal_db_sw_tables_hash_table_get_next_cb)(
    int unit, uint32 sw_tables_idx_0, uint32 *iter, void *key, uint32 *value);

typedef int (*dbal_db_sw_tables_hash_table_insert_cb)(
    int unit, uint32 sw_tables_idx_0, const void *key, uint32 *data_idx);

typedef int (*dbal_db_sw_tables_hash_table_delete_cb)(
    int unit, uint32 sw_tables_idx_0, const void *key);

typedef int (*dbal_db_sw_tables_hash_table_delete_all_cb)(
    int unit, uint32 sw_tables_idx_0);

typedef int (*dbal_db_sw_tables_hash_table_print_cb)(
    int unit, uint32 sw_tables_idx_0);

typedef int (*dbal_db_sw_tables_hash_table_traverse_cb)(
    int unit, uint32 sw_tables_idx_0, sw_state_htb_traverse_cb traverse_func, void *user_data);
...
typedef int (*dbal_db_sw_tables_hash_table_get_by_index_cb)(
    int unit, uint32 sw_tables_idx_0, uint32 data_index, void *key);
...
typedef int (*dbal_db_dbal_dynamic_xml_tables_alloc_cb)(
    int unit);
...
typedef int (*dbal_db_hw_ent_direct_map_hash_tbl_get_next_cb)(
    int unit, SW_STATE_INDEX_HASH_TABLE_ITER *iter, const hw_ent_direct_map_hash_key *key, const uint32 *data_index);
...
typedef int (*dbal_db_hw_ent_groups_map_hash_tbl_get_next_cb)(
    int unit, SW_STATE_INDEX_HASH_TABLE_ITER *iter, const hw_ent_groups_map_hash_key *key, const uint32 *data_index);
...
typedef int (*dbal_db_field_names_override_locations_create_cb)(
    int unit, sw_state_idx_htbl_init_info_t *init_info);

typedef int (*dbal_db_field_names_override_locations_find_cb)(
    int unit, const dbal_fields_e *key, uint32 *data_index, uint8 *found);

typedef int (*dbal_db_field_names_override_locations_insert_cb)(
    int unit, const dbal_fields_e *key, const uint32 *data_index, uint8 *success);

typedef int (*dbal_db_field_names_override_locations_get_next_cb)(
    int unit, SW_STATE_INDEX_HASH_TABLE_ITER *iter, const dbal_fields_e *key, const uint32 *data_index);

typedef int (*dbal_db_field_names_override_locations_clear_cb)(
    int unit);

typedef int (*dbal_db_field_names_override_locations_delete_cb)(
    int unit, const dbal_fields_e *key);

typedef int (*dbal_db_field_names_override_locations_insert_at_index_cb)(
    int unit, const dbal_fields_e *key, uint32 data_idx, uint8 *success);

typedef int (*dbal_db_field_names_override_locations_delete_by_index_cb)(
    int unit, uint32 data_index);

typedef int (*dbal_db_field_names_override_locations_get_by_index_cb)(
    int unit, uint32 data_index, dbal_fields_e *key, uint8 *found);

typedef int (*dbal_db_field_names_override_strings_set_cb)(
    int unit, uint32 field_names_override_strings_idx_0, CONST encap_string_type_t *field_names_override_strings);

typedef int (*dbal_db_field_names_override_strings_get_cb)(
    int unit, uint32 field_names_override_strings_idx_0, CONST encap_string_type_t **field_names_override_strings);
...
typedef struct {
    ...
    dbal_db_sw_tables_hash_table_delete_all_cb delete_all;
    dbal_db_sw_tables_hash_table_print_cb print;
    dbal_db_sw_tables_hash_table_traverse_cb traverse;
...
typedef struct {
    dbal_db_dbal_dynamic_xml_tables_alloc_cb alloc;
...
typedef struct {
    dbal_db_field_names_override_locations_create_cb create;
    dbal_db_field_names_override_locations_find_cb find;
    dbal_db_field_names_override_locations_insert_cb insert;
    dbal_db_field_names_override_locations_get_next_cb get_next;
    dbal_db_field_names_override_locations_clear_cb clear;
    dbal_db_field_names_override_locations_delete_cb delete;
    dbal_db_field_names_override_locations_insert_at_index_cb insert_at_index;
    dbal_db_field_names_override_locations_delete_by_index_cb delete_by_index;
    dbal_db_field_names_override_locations_get_by_index_cb get_by_index;
} dbal_db_field_names_override_locations_cbs;

typedef struct {
    dbal_db_field_names_override_strings_set_cb set;
    dbal_db_field_names_override_strings_get_cb get;
} dbal_db_field_names_override_strings_cbs;
...
typedef struct {
    ...
    dbal_db_field_names_override_locations_cbs field_names_override_locations;
    dbal_db_field_names_override_strings_cbs field_names_override_strings;
} dbal_db_cbs;
