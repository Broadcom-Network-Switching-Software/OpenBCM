...
typedef int (*local_outlif_info_dynamic_algo_set_cb)(
    int unit, uint8 dynamic_algo);

typedef int (*local_outlif_info_dynamic_algo_get_cb)(
    int unit, uint8 *dynamic_algo);
...
typedef struct {
    local_outlif_info_dynamic_algo_set_cb set;
    local_outlif_info_dynamic_algo_get_cb get;
} local_outlif_info_dynamic_algo_cbs;
...
typedef struct {
    ...
    local_outlif_info_dynamic_algo_cbs dynamic_algo;
