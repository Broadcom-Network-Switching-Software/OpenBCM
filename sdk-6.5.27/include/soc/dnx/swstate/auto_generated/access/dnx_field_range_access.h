...
typedef int (*dnx_field_range_sw_db_ext_l4_ops_ffc_quals_qual_info_base_qual_set_cb)(
    int unit, uint32 ext_l4_ops_ffc_quals_idx_0, dnx_field_qual_t base_qual);

typedef int (*dnx_field_range_sw_db_ext_l4_ops_ffc_quals_qual_info_base_qual_get_cb)(
    int unit, uint32 ext_l4_ops_ffc_quals_idx_0, dnx_field_qual_t *base_qual);
...
typedef struct {
    dnx_field_range_sw_db_ext_l4_ops_ffc_quals_qual_info_base_qual_set_cb set;
    dnx_field_range_sw_db_ext_l4_ops_ffc_quals_qual_info_base_qual_get_cb get;
} dnx_field_range_sw_db_ext_l4_ops_ffc_quals_qual_info_base_qual_cbs;
...
typedef struct {
    ...
    dnx_field_range_sw_db_ext_l4_ops_ffc_quals_qual_info_base_qual_cbs base_qual;
