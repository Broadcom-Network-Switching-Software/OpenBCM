...
typedef int (*dnx_field_tcam_bank_sw_tcam_banks_owner_stage_set_cb)(
    int unit, uint32 tcam_banks_idx_0, uint32 owner_stage_idx_0, dnx_field_tcam_stage_e owner_stage);

typedef int (*dnx_field_tcam_bank_sw_tcam_banks_owner_stage_get_cb)(
    int unit, uint32 tcam_banks_idx_0, uint32 owner_stage_idx_0, dnx_field_tcam_stage_e *owner_stage);

typedef int (*dnx_field_tcam_bank_sw_tcam_banks_owner_stage_alloc_cb)(
    int unit, uint32 tcam_banks_idx_0);

typedef int (*dnx_field_tcam_bank_sw_tcam_banks_active_handlers_id_alloc_cb)(
    int unit, uint32 tcam_banks_idx_0);

typedef int (*dnx_field_tcam_bank_sw_tcam_banks_active_handlers_id_create_empty_cb)(
    int unit, uint32 tcam_banks_idx_0, uint32 active_handlers_id_idx_0, sw_state_ll_init_info_t *init_info);

typedef int (*dnx_field_tcam_bank_sw_tcam_banks_active_handlers_id_nof_elements_cb)(
    int unit, uint32 tcam_banks_idx_0, uint32 active_handlers_id_idx_0, uint32 *nof_elements);

typedef int (*dnx_field_tcam_bank_sw_tcam_banks_active_handlers_id_node_value_cb)(
    int unit, uint32 tcam_banks_idx_0, uint32 active_handlers_id_idx_0, sw_state_ll_node_t node, uint32 *value);

typedef int (*dnx_field_tcam_bank_sw_tcam_banks_active_handlers_id_node_update_cb)(
    int unit, uint32 tcam_banks_idx_0, uint32 active_handlers_id_idx_0, sw_state_ll_node_t node, const uint32 *value);

typedef int (*dnx_field_tcam_bank_sw_tcam_banks_active_handlers_id_next_node_cb)(
    int unit, uint32 tcam_banks_idx_0, uint32 active_handlers_id_idx_0, sw_state_ll_node_t node, sw_state_ll_node_t *next_node);

typedef int (*dnx_field_tcam_bank_sw_tcam_banks_active_handlers_id_previous_node_cb)(
    int unit, uint32 tcam_banks_idx_0, uint32 active_handlers_id_idx_0, sw_state_ll_node_t node, sw_state_ll_node_t *prev_node);

typedef int (*dnx_field_tcam_bank_sw_tcam_banks_active_handlers_id_remove_node_cb)(
    int unit, uint32 tcam_banks_idx_0, uint32 active_handlers_id_idx_0, sw_state_ll_node_t node);
...
typedef int (*dnx_field_tcam_bank_sw_tcam_banks_active_handlers_id_add_first_cb)(
    int unit, uint32 tcam_banks_idx_0, uint32 active_handlers_id_idx_0, const uint32 *value);
...
typedef int (*dnx_field_tcam_bank_sw_tcam_banks_key_size_set_cb)(
    int unit, uint32 tcam_banks_idx_0, uint32 key_size);

typedef int (*dnx_field_tcam_bank_sw_tcam_banks_key_size_get_cb)(
    int unit, uint32 tcam_banks_idx_0, uint32 *key_size);
...
typedef struct {
    ...
    dnx_field_tcam_bank_sw_tcam_banks_owner_stage_alloc_cb alloc;
} dnx_field_tcam_bank_sw_tcam_banks_owner_stage_cbs;

typedef struct {
    dnx_field_tcam_bank_sw_tcam_banks_active_handlers_id_alloc_cb alloc;
...
typedef struct {
    dnx_field_tcam_bank_sw_tcam_banks_key_size_set_cb set;
    dnx_field_tcam_bank_sw_tcam_banks_key_size_get_cb get;
} dnx_field_tcam_bank_sw_tcam_banks_key_size_cbs;
...
typedef struct {
    ...
    dnx_field_tcam_bank_sw_tcam_banks_key_size_cbs key_size;
