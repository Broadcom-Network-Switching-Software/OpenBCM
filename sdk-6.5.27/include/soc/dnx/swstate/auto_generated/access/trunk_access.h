...
typedef int (*trunk_db_pools_groups_members_range_read_cb)(
    int unit, uint32 pools_idx_0, uint32 groups_idx_0, uint32 from_idx, uint32 nof_elements, trunk_group_member_info_t *dest);

typedef int (*trunk_db_pools_groups_members_range_write_cb)(
    int unit, uint32 pools_idx_0, uint32 groups_idx_0, uint32 from_idx, uint32 nof_elements, const trunk_group_member_info_t *source);
...
typedef int (*trunk_db_pools_groups_members_protecting_system_port_set_cb)(
    int unit, uint32 pools_idx_0, uint32 groups_idx_0, uint32 members_idx_0, uint32 protecting_system_port);

typedef int (*trunk_db_pools_groups_members_protecting_system_port_get_cb)(
    int unit, uint32 pools_idx_0, uint32 groups_idx_0, uint32 members_idx_0, uint32 *protecting_system_port);
...
typedef int (*trunk_db_pools_groups_pp_ports_range_read_cb)(
    int unit, uint32 pools_idx_0, uint32 groups_idx_0, uint32 from_idx, uint32 nof_elements, uint32 *dest);

typedef int (*trunk_db_pools_groups_pp_ports_range_write_cb)(
    int unit, uint32 pools_idx_0, uint32 groups_idx_0, uint32 from_idx, uint32 nof_elements, const uint32 *source);
...
typedef int (*trunk_db_trunk_system_port_db_trunk_system_port_entries_range_read_cb)(
    int unit, uint32 from_idx, uint32 nof_elements, trunk_system_port_entry_t *dest);

typedef int (*trunk_db_trunk_system_port_db_trunk_system_port_entries_range_write_cb)(
    int unit, uint32 from_idx, uint32 nof_elements, const trunk_system_port_entry_t *source);
...
typedef int (*trunk_db_psc_general_info_profile_info_range_read_cb)(
    int unit, uint32 from_idx, uint32 nof_elements, profile_info_t *dest);

typedef int (*trunk_db_psc_general_info_profile_info_range_write_cb)(
    int unit, uint32 from_idx, uint32 nof_elements, const profile_info_t *source);
...
typedef int (*trunk_db_psc_general_info_user_profile_info_set_cb)(
    int unit, uint32 user_profile_info_idx_0, CONST user_profile_info_t *user_profile_info);

typedef int (*trunk_db_psc_general_info_user_profile_info_get_cb)(
    int unit, uint32 user_profile_info_idx_0, user_profile_info_t *user_profile_info);

typedef int (*trunk_db_psc_general_info_user_profile_info_range_read_cb)(
    int unit, uint32 from_idx, uint32 nof_elements, user_profile_info_t *dest);

typedef int (*trunk_db_psc_general_info_user_profile_info_range_write_cb)(
    int unit, uint32 from_idx, uint32 nof_elements, const user_profile_info_t *source);

typedef int (*trunk_db_psc_general_info_user_profile_info_range_fill_cb)(
    int unit, uint32 from_idx, uint32 nof_elements, user_profile_info_t value);

typedef int (*trunk_db_psc_general_info_user_profile_info_alloc_cb)(
    int unit);

typedef int (*trunk_db_psc_general_info_user_profile_info_assigned_psc_profile_set_cb)(
    int unit, uint32 user_profile_info_idx_0, int assigned_psc_profile);

typedef int (*trunk_db_psc_general_info_user_profile_info_assigned_psc_profile_get_cb)(
    int unit, uint32 user_profile_info_idx_0, int *assigned_psc_profile);

typedef int (*trunk_db_psc_general_info_user_profile_info_ref_counter_set_cb)(
    int unit, uint32 user_profile_info_idx_0, int ref_counter);

typedef int (*trunk_db_psc_general_info_user_profile_info_ref_counter_get_cb)(
    int unit, uint32 user_profile_info_idx_0, int *ref_counter);
...
typedef struct {
    trunk_db_pools_groups_members_protecting_system_port_set_cb set;
    trunk_db_pools_groups_members_protecting_system_port_get_cb get;
} trunk_db_pools_groups_members_protecting_system_port_cbs;
...
typedef struct {
    ...
    trunk_db_pools_groups_members_protecting_system_port_cbs protecting_system_port;
...
typedef struct {
    trunk_db_psc_general_info_user_profile_info_assigned_psc_profile_set_cb set;
    trunk_db_psc_general_info_user_profile_info_assigned_psc_profile_get_cb get;
} trunk_db_psc_general_info_user_profile_info_assigned_psc_profile_cbs;

typedef struct {
    trunk_db_psc_general_info_user_profile_info_ref_counter_set_cb set;
    trunk_db_psc_general_info_user_profile_info_ref_counter_get_cb get;
} trunk_db_psc_general_info_user_profile_info_ref_counter_cbs;

typedef struct {
    trunk_db_psc_general_info_user_profile_info_set_cb set;
    trunk_db_psc_general_info_user_profile_info_get_cb get;
    trunk_db_psc_general_info_user_profile_info_range_read_cb range_read;
    trunk_db_psc_general_info_user_profile_info_range_write_cb range_write;
    trunk_db_psc_general_info_user_profile_info_range_fill_cb range_fill;
    trunk_db_psc_general_info_user_profile_info_alloc_cb alloc;
    trunk_db_psc_general_info_user_profile_info_assigned_psc_profile_cbs assigned_psc_profile;
    trunk_db_psc_general_info_user_profile_info_ref_counter_cbs ref_counter;
} trunk_db_psc_general_info_user_profile_info_cbs;

typedef struct {
    trunk_db_psc_general_info_chm_handle_cbs chm_handle;
    trunk_db_psc_general_info_profile_info_cbs profile_info;
    trunk_db_psc_general_info_user_profile_info_cbs user_profile_info;
