...
typedef int (*dnx_algo_field_action_sw_fem_set_cb)(
    int unit, CONST dnx_field_action_fem_priorities_t *fem);

typedef int (*dnx_algo_field_action_sw_fem_get_cb)(
    int unit, dnx_field_action_fem_priorities_t *fem);

typedef int (*dnx_algo_field_action_sw_fem_is_priority_position_set_cb)(
    int unit, uint32 is_priority_position_idx_0, uint32 is_priority_position_idx_1, uint8 is_priority_position);

typedef int (*dnx_algo_field_action_sw_fem_is_priority_position_get_cb)(
    int unit, uint32 is_priority_position_idx_0, uint32 is_priority_position_idx_1, uint8 *is_priority_position);
...
typedef struct {
    dnx_algo_field_action_sw_fem_is_priority_position_set_cb set;
    dnx_algo_field_action_sw_fem_is_priority_position_get_cb get;
} dnx_algo_field_action_sw_fem_is_priority_position_cbs;

typedef struct {
    dnx_algo_field_action_sw_fem_set_cb set;
    dnx_algo_field_action_sw_fem_get_cb get;
    dnx_algo_field_action_sw_fem_is_priority_position_cbs is_priority_position;
} dnx_algo_field_action_sw_fem_cbs;
...
typedef struct {
    ...
    dnx_algo_field_action_sw_fem_cbs fem;
