...
typedef int (*dnx_field_qual_sw_db_predefined_set_cb)(
    int unit, uint32 predefined_idx_0, CONST dnx_field_predefined_qual_info_t *predefined);

typedef int (*dnx_field_qual_sw_db_predefined_get_cb)(
    int unit, uint32 predefined_idx_0, dnx_field_predefined_qual_info_t *predefined);

typedef int (*dnx_field_qual_sw_db_predefined_field_id_set_cb)(
    int unit, uint32 predefined_idx_0, dbal_fields_e field_id);

typedef int (*dnx_field_qual_sw_db_predefined_field_id_get_cb)(
    int unit, uint32 predefined_idx_0, dbal_fields_e *field_id);

typedef int (*dnx_field_qual_sw_db_layer_record_set_cb)(
    int unit, uint32 layer_record_idx_0, CONST dnx_field_predefined_qual_info_t *layer_record);

typedef int (*dnx_field_qual_sw_db_layer_record_get_cb)(
    int unit, uint32 layer_record_idx_0, dnx_field_predefined_qual_info_t *layer_record);

typedef int (*dnx_field_qual_sw_db_layer_record_field_id_set_cb)(
    int unit, uint32 layer_record_idx_0, dbal_fields_e field_id);

typedef int (*dnx_field_qual_sw_db_layer_record_field_id_get_cb)(
    int unit, uint32 layer_record_idx_0, dbal_fields_e *field_id);
...
typedef struct {
    dnx_field_qual_sw_db_predefined_field_id_set_cb set;
    dnx_field_qual_sw_db_predefined_field_id_get_cb get;
} dnx_field_qual_sw_db_predefined_field_id_cbs;

typedef struct {
    dnx_field_qual_sw_db_predefined_set_cb set;
    dnx_field_qual_sw_db_predefined_get_cb get;
    dnx_field_qual_sw_db_predefined_field_id_cbs field_id;
} dnx_field_qual_sw_db_predefined_cbs;

typedef struct {
    dnx_field_qual_sw_db_layer_record_field_id_set_cb set;
    dnx_field_qual_sw_db_layer_record_field_id_get_cb get;
} dnx_field_qual_sw_db_layer_record_field_id_cbs;

typedef struct {
    dnx_field_qual_sw_db_layer_record_set_cb set;
    dnx_field_qual_sw_db_layer_record_get_cb get;
    dnx_field_qual_sw_db_layer_record_field_id_cbs field_id;
} dnx_field_qual_sw_db_layer_record_cbs;

typedef struct {
    dnx_field_qual_sw_db_is_init_cb is_init;
    dnx_field_qual_sw_db_init_cb init;
    dnx_field_qual_sw_db_info_cbs info;
    dnx_field_qual_sw_db_predefined_cbs predefined;
    dnx_field_qual_sw_db_layer_record_cbs layer_record;
