...
typedef int (*kbp_sw_state_db_handles_info_core_id_set_cb)(
    int unit, uint32 db_handles_info_idx_0, uint8 core_id);

typedef int (*kbp_sw_state_db_handles_info_core_id_get_cb)(
    int unit, uint32 db_handles_info_idx_0, uint8 *core_id);
...
typedef int (*kbp_sw_state_db_handles_info_regular_result_size_set_cb)(
    int unit, uint32 db_handles_info_idx_0, int regular_result_size);

typedef int (*kbp_sw_state_db_handles_info_regular_result_size_get_cb)(
    int unit, uint32 db_handles_info_idx_0, int *regular_result_size);
...
typedef struct {
    kbp_sw_state_db_handles_info_core_id_set_cb set;
    kbp_sw_state_db_handles_info_core_id_get_cb get;
} kbp_sw_state_db_handles_info_core_id_cbs;
...
typedef struct {
    kbp_sw_state_db_handles_info_regular_result_size_set_cb set;
    kbp_sw_state_db_handles_info_regular_result_size_get_cb get;
} kbp_sw_state_db_handles_info_regular_result_size_cbs;
...
typedef struct {
    ...
    kbp_sw_state_db_handles_info_core_id_cbs core_id;
    ...
    kbp_sw_state_db_handles_info_regular_result_size_cbs regular_result_size;
