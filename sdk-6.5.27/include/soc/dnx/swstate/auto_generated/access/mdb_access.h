...
typedef int (*mdb_db_infos_em_key_format_em_bank_info_bank_size_used_nof_rows_set_cb)(
    int unit, uint32 em_key_format_idx_0, uint32 em_bank_info_idx_0, uint32 bank_size_used_nof_rows);

typedef int (*mdb_db_infos_em_key_format_em_bank_info_bank_size_used_nof_rows_get_cb)(
    int unit, uint32 em_key_format_idx_0, uint32 em_bank_info_idx_0, uint32 *bank_size_used_nof_rows);
...
typedef int (*mdb_db_infos_db_clusters_info_start_address_set_cb)(
    int unit, uint32 db_idx_0, uint32 clusters_info_idx_0, uint32 start_address);
...
typedef int (*mdb_db_infos_db_clusters_info_end_address_set_cb)(
    int unit, uint32 db_idx_0, uint32 clusters_info_idx_0, uint32 end_address);

typedef int (*mdb_db_infos_db_clusters_info_end_address_get_cb)(
    int unit, uint32 db_idx_0, uint32 clusters_info_idx_0, uint32 *end_address);

typedef int (*mdb_db_infos_db_address_space_bits_set_cb)(
    int unit, uint32 db_idx_0, int address_space_bits);

typedef int (*mdb_db_infos_db_address_space_bits_get_cb)(
    int unit, uint32 db_idx_0, int *address_space_bits);
...
typedef int (*mdb_db_infos_mdb_cluster_infos_macro_cluster_cache_alloc_cb)(
    int unit, uint32 macro_cluster_cache_idx_0, uint32 nof_instances_to_alloc_1, uint32 nof_instances_to_alloc_2);

typedef int (*mdb_db_infos_mdb_cluster_infos_macro_cluster_cache_data_set_cb)(
    int unit, uint32 macro_cluster_cache_idx_0, uint32 macro_cluster_cache_idx_1, uint32 macro_cluster_cache_idx_2, uint32 data_idx_0, uint32 data_idx_1, uint32 data);
...
typedef int (*mdb_db_infos_mdb_cluster_infos_macro_cluster_cache_data_range_read_cb)(
    int unit, uint32 macro_cluster_cache_idx_0, uint32 macro_cluster_cache_idx_1, uint32 macro_cluster_cache_idx_2, uint32 data_idx_0, uint32 from_idx, uint32 nof_elements, uint32 *dest);

typedef int (*mdb_db_infos_mdb_cluster_infos_macro_cluster_cache_data_range_write_cb)(
    int unit, uint32 macro_cluster_cache_idx_0, uint32 macro_cluster_cache_idx_1, uint32 macro_cluster_cache_idx_2, uint32 data_idx_0, uint32 from_idx, uint32 nof_elements, const uint32 *source);

typedef int (*mdb_db_infos_mdb_cluster_infos_macro_cluster_cache_data_range_fill_cb)(
    int unit, uint32 macro_cluster_cache_idx_0, uint32 macro_cluster_cache_idx_1, uint32 macro_cluster_cache_idx_2, uint32 data_idx_0, uint32 from_idx, uint32 nof_elements, uint32 value);

typedef int (*mdb_db_infos_mdb_cluster_infos_macro_cluster_cache_data_alloc_cb)(
    int unit, uint32 macro_cluster_cache_idx_0, uint32 macro_cluster_cache_idx_1, uint32 macro_cluster_cache_idx_2, uint32 nof_instances_to_alloc_0);
...
typedef int (*mdb_db_infos_fec_db_info_fec_db_map_set_cb)(
    int unit, uint32 bank_id, uint32 fec_db_map);

typedef int (*mdb_db_infos_fec_db_info_fec_db_map_get_cb)(
    int unit, uint32 bank_id, uint32 *fec_db_map);

typedef int (*mdb_db_infos_fec_db_info_fec_db_map_alloc_cb)(
    int unit);

typedef int (*mdb_db_infos_fec_db_info_fec_id_range_start_set_cb)(
    int unit, uint32 index, uint32 fec_id_range_start);

typedef int (*mdb_db_infos_fec_db_info_fec_id_range_start_get_cb)(
    int unit, uint32 index, uint32 *fec_id_range_start);

typedef int (*mdb_db_infos_fec_db_info_fec_id_range_start_alloc_cb)(
    int unit);

typedef int (*mdb_db_infos_fec_db_info_fec_id_range_size_set_cb)(
    int unit, uint32 index, uint32 fec_id_range_size);

typedef int (*mdb_db_infos_fec_db_info_fec_id_range_size_get_cb)(
    int unit, uint32 index, uint32 *fec_id_range_size);

typedef int (*mdb_db_infos_fec_db_info_fec_id_range_size_alloc_cb)(
    int unit);
...
typedef struct {
    mdb_db_infos_em_key_format_em_bank_info_bank_size_used_nof_rows_set_cb set;
    mdb_db_infos_em_key_format_em_bank_info_bank_size_used_nof_rows_get_cb get;
} mdb_db_infos_em_key_format_em_bank_info_bank_size_used_nof_rows_cbs;
...
typedef struct {
    ...
    mdb_db_infos_em_key_format_em_bank_info_bank_size_used_nof_rows_cbs bank_size_used_nof_rows;
...
typedef struct {
    mdb_db_infos_db_address_space_bits_set_cb set;
    mdb_db_infos_db_address_space_bits_get_cb get;
} mdb_db_infos_db_address_space_bits_cbs;
...
typedef struct {
    ...
    mdb_db_infos_db_address_space_bits_cbs address_space_bits;
} mdb_db_infos_db_cbs;
...
typedef struct {
    mdb_db_infos_fec_db_info_fec_db_map_set_cb set;
    mdb_db_infos_fec_db_info_fec_db_map_get_cb get;
    mdb_db_infos_fec_db_info_fec_db_map_alloc_cb alloc;
} mdb_db_infos_fec_db_info_fec_db_map_cbs;

typedef struct {
    mdb_db_infos_fec_db_info_fec_id_range_start_set_cb set;
    mdb_db_infos_fec_db_info_fec_id_range_start_get_cb get;
    mdb_db_infos_fec_db_info_fec_id_range_start_alloc_cb alloc;
} mdb_db_infos_fec_db_info_fec_id_range_start_cbs;

typedef struct {
    mdb_db_infos_fec_db_info_fec_id_range_size_set_cb set;
    mdb_db_infos_fec_db_info_fec_id_range_size_get_cb get;
    mdb_db_infos_fec_db_info_fec_id_range_size_alloc_cb alloc;
} mdb_db_infos_fec_db_info_fec_id_range_size_cbs;

typedef struct {
    mdb_db_infos_fec_db_info_fec_db_map_cbs fec_db_map;
    mdb_db_infos_fec_db_info_fec_id_range_start_cbs fec_id_range_start;
    mdb_db_infos_fec_db_info_fec_id_range_size_cbs fec_id_range_size;
} mdb_db_infos_fec_db_info_cbs;
...
typedef struct {
    ...
    mdb_db_infos_fec_db_info_cbs fec_db_info;
