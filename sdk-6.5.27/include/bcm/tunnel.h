...
#define BCM_TUNNEL_INIT_SRV6_SCALE_VPN_SID  BCM_TUNNEL_TERM_UDP_CHECKSUM_ENABLE /* In case set, scale the
                                                          number of VPN SID. */
#define BCM_TUNNEL_TERM_L3_IIF_PHB          0x04000000 /* L2 follows Tunnel
                                                          termination PHB and L3
                                                          follows L3_IIF PHB. */
#define BCM_TUNNEL_TERM_TUNNEL_SRC_NAT      BCM_TUNNEL_TERM_KEEP_INNER_DSCP /* Create a source
                                                          tunneled NAT */
#define BCM_TUNNEL_TERM_TUNNEL_DST_NAT      BCM_TUNNEL_TERM_WLAN_REMOTE_TERMINATE /* Create a destination
                                                          tunneled NAT */
#define BCM_TUNNEL_TERM_SERVICE_TAGGED      BCM_TUNNEL_TERM_WLAN_SET_ROAM /* Service tagged
                                                          indication */
#define BCM_TUNNEL_TERM_SERVICE_TAGGED_PLATFORM_NAMESPACE BCM_TUNNEL_TERM_USE_OUTER_QOS /* Service tag namespace
                                                          indication */
#define BCM_TUNNEL_TERM_SERVICE_TAGGED_BASED_HEADER_ONLY BCM_TUNNEL_INIT_USE_OUTER_TTL /* service tag source
                                                          indicatio */
#define BCM_TUNNEL_TERM_GRE_KEY_USE_LB      BCM_TUNNEL_INIT_STAT_ENABLE /* GRE key presented and
                                                          include LB key, used
                                                          with
                                                          bcmTunnelTypeGreAnyIn4
                                                          and
                                                          ...
                                                          tunnel types. */
#define BCM_TUNNEL_TERM_GRE_WITH_SN         BCM_TUNNEL_INIT_GRE_WITH_SN /* GRE8 with Sequence
                                                          Number, used with
                                                          bcmTunnelTypeGreAnyIn4
                                                          and
                                                          bcmTunnelTypeGreAnyIn6
                                                          tunnel types. */
#define BCM_TUNNEL_INIT_SERVICE_TAGGED_PLATFORM_NAMESPACE BCM_TUNNEL_TERM_SERVICE_TAGGED_PLATFORM_NAMESPACE /* If set, the tunnel
                                                          initiator is working
