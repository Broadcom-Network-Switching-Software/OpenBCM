...
typedef enum bcm_stat_val_e {
    ...
    snmpBcmSignalQualityLastErrorRate = 292, /* Signal Quality error rate as
                                           ...
                                           (Broadcom-specific) */
    snmpBcmRxBerCountOnly = 293,        /* RX Sync Header Error(CL49 BER)
                                           counter (Broadcom-specific) */
    snmpBcmRxBipErrorCountOnly = 294,   /* RX BIP Error counter
                                           (Broadcom-specific) */
    snmpBcmCpuTxMasqueradePkts = 295,   /* Number of CPU transmitted masquerade
                                           packets with SOBMH + loopback header.
                                           (Broadcom-specific) */
    snmpBcmCpuTxDstPortOrTrunkPkts = 296, /* Number of CPU transmitted packets
                                           with a logical port or a trunk as a
                                           destination. (Broadcom-specific) */
    snmpBcmCpuTxDstL3EgressPkts = 297,  /* Number of CPU transmitted packets
                                           with a L3 egress as a destination.
                                           (Broadcom-specific) */
    snmpBcmCpuTxDstEcmpPkts = 298,      /* Number of CPU transmitted packets
                                           with an ECMP group as a destination.
                                           (Broadcom-specific) */
    snmpBcmCpuTxDstEcmpMemberPkts = 299, /* Number of CPU transmitted packets
                                           with an ECMP member as a destination.
                                           (Broadcom-specific) */
    snmpBcmCpuTxDstIpmcPkts = 300,      /* Number of CPU transmitted packets
                                           with an IPMC group as a destination.
                                           (Broadcom-specific) */
    snmpBcmCpuTxDstL2mcPkts = 301,      /* Number of CPU transmitted packets
                                           with a L2MC group as a destination.
                                           (Broadcom-specific) */
    snmpBcmCpuTxVlanFloodPkts = 302,    /* Number of CPU transmitted packets
                                           flooded in VLAN. (Broadcom-specific) */
    snmpBcmTxEncryptedPFCFramePriority0 = 303, /* Transmit Encrypted PFC Frame Priority
                                           0 */
    snmpBcmTxEncryptedPFCFramePriority1 = 304, /* Transmit Encrypted PFC Frame Priority
                                           1 */
    snmpBcmTxEncryptedPFCFramePriority2 = 305, /* Transmit Encrypted PFC Frame Priority
                                           2 */
    snmpBcmTxEncryptedPFCFramePriority3 = 306, /* Transmit Encrypted PFC Frame Priority
                                           3 */
    snmpBcmTxEncryptedPFCFramePriority4 = 307, /* Transmit Encrypted PFC Frame Priority
                                           4 */
    snmpBcmTxEncryptedPFCFramePriority5 = 308, /* Transmit Encrypted PFC Frame Priority
                                           5 */
    snmpBcmTxEncryptedPFCFramePriority6 = 309, /* Transmit Encrypted PFC Frame Priority
                                           6 */
    snmpBcmTxEncryptedPFCFramePriority7 = 310, /* Transmit Encrypted PFC Frame Priority
                                           7 */
    snmpValCount = 311 
} bcm_stat_val_t;
...
{ \
    ...
    "snmpBcmRxBerCountOnly", \
    "snmpBcmRxBipErrorCountOnly", \
    "snmpBcmCpuTxMasqueradePkts", \
    "snmpBcmCpuTxDstPortOrTrunkPkts", \
    "snmpBcmCpuTxDstL3EgressPkts", \
    "snmpBcmCpuTxDstEcmpPkts", \
    "snmpBcmCpuTxDstEcmpMemberPkts", \
    "snmpBcmCpuTxDstIpmcPkts", \
    "snmpBcmCpuTxDstL2mcPkts", \
    "snmpBcmCpuTxVlanFloodPkts", \
    "snmpBcmTxEncryptedPFCFramePriority0", \
    "snmpBcmTxEncryptedPFCFramePriority1", \
    "snmpBcmTxEncryptedPFCFramePriority2", \
    "snmpBcmTxEncryptedPFCFramePriority3", \
    "snmpBcmTxEncryptedPFCFramePriority4", \
    "snmpBcmTxEncryptedPFCFramePriority5", \
    "snmpBcmTxEncryptedPFCFramePriority6", \
    "snmpBcmTxEncryptedPFCFramePriority7"  \
}
...
#define BCM_STAT_DATABASE_CREATE_WITH_ID    0x00000001 /* Create a counter
                                                          database with id */
#define BCM_STAT_DATABASE_MAX_NOF_PARTITIONS 0x00000002 
...
typedef struct bcm_stat_eviction_s {
    ...
    int evm_id;                         /* Eviction machine identifier. */
} bcm_stat_eviction_t;
...
typedef enum bcm_stat_control_e {
    ...
    bcmStatControlEgressL2FwdPlusOneMetadataEnable = 3, /* General enabler for the egress L2
                                           ...
                                           plus one layer */
    bcmStatControlCounterSequentialSkipZerosEnable = 4, 
    bcmStatControlCounterWraparoundEnable = 5, 
    bcmStatControlSize = 6              /* enum size */
} bcm_stat_control_t;
...
#define BCM_STAT_CONTROL_CPX    0x1        /* Set cpx properties. */
#define BCM_STAT_DATABASE_CPX   0x2        /* Config cpx-database */

/* 
 * Define the mapping between a crps-database-partition to the source
 * database.
 */
typedef struct bcm_stat_database_partition_mapping_s {
    uint32 stat_id_start;           /* First stat-object-id to map */
    uint32 stat_id_end;             /* Last stat-object-id to map */
    uint32 dest_database_id;        /* Other database identifier */
    uint32 dest_database_offset;    /* The offset in the other database to map
                                       the counters to */
} bcm_stat_database_partition_mapping_t;

typedef struct bcm_stat_database_mapping_s {
    uint32 nof_partitions; 
    bcm_stat_database_partition_mapping_t used_by_objects[BCM_STAT_DATABASE_MAX_NOF_PARTITIONS]; 
} bcm_stat_database_mapping_t;

/* List of stat control types. */
typedef enum bcm_stat_counter_generic_control_e {
    bcmStatCounterGenericEvictionMachineSamplingInterval = 0, 
    bcmStatCounterGenericEvictionMachineSamplingZeroInterval = 1, 
    bcmStatCounterGenericEvictionMachineIterationInterval = 2, 
    bcmStatCounterGenericForceEvictionEnable = 3, 
    bcmStatCounterGenericCount = 6      /* enum size */
} bcm_stat_counter_generic_control_t;

#ifndef BCM_HIDE_DISPATCHABLE

/* Database mapping set */
extern int bcm_stat_counter_database_mapping_set(
    int unit, 
    uint32 flags, 
    bcm_stat_counter_database_t *database, 
...
extern int bcm_stat_counter_database_mapping_get(
    int unit, 
    uint32 flags, 
    bcm_stat_counter_database_t *database, 
    bcm_stat_database_mapping_t *map_config);

/* Counter generic control set */
extern int bcm_stat_counter_generic_control_set(
    int unit, 
    uint32 flags, 
    int Key, 
...
/* Counter generic control get */
extern int bcm_stat_counter_generic_control_get(
    int unit, 
    uint32 flags, 
    int Key, 
    bcm_stat_counter_generic_control_t control, 
...
#define BCM_STAT_GENERIC_KEY_CPX_CORE_ID_SET(key, core_id)  _SHR_STAT_GENERIC_KEY_CPX_CORE_ID_SET(key, core_id) 
#define BCM_STAT_GENERIC_KEY_CPX_CORE_ID_GET(key)  _SHR_STAT_GENERIC_KEY_CPX_CORE_ID_GET(key) 
#define BCM_STAT_GENERIC_KEY_CPX_EVICTION_MACINE_ID_SET(key, cpx_evm_id)  _SHR_STAT_GENERIC_KEY_CPX_EVM_ID_SET(key, cpx_evm_id) 
#define BCM_STAT_GENERIC_KEY_CPX_EVICTION_MACINE_ID_GET(key)  _SHR_STAT_GENERIC_KEY_CPX_EVM_ID_GET(key) 
