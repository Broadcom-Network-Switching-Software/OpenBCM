...
typedef enum bcm_collector_timestamp_source_e {
    ...
    bcmCollectorTimestampSourceNTP = 1, /* Network Time Protocol source with
                                           epoch of 1 Jan 1900 */
    bcmCollectorTimestampSourcePTP = 2, /* Precision Time Protocol source */
    bcmCollectorTimestampSourceNTPUnix = 3, /* Network Time Protocol source with
                                           epoch of 1 Jan 1970 */
    bcmCollectorTimestampSourceCount = 4 /* Always Last. Not a usable value */
