...
typedef enum bcm_vlan_translate_key_e {
    ...
    bcmVlanTranslateEgressKeyVpnPortGroupInnerTag = 51, /* Use VPN, port group ID, and incoming
                                           IVID. */
    bcmVlanTranslateEgressKeyVpnPortGroupInnerTagIngressPortGroup = 52, /* Use VPN, port group ID, incoming
                                           IVID, and ingress port group ID. */
    bcmVlanTranslateEgressKeyPortGroupVfiDoubleTagPreserveInnerTag = 53, /* Use port group ID, VFI,
                                           OTAG-Preserve, ITAG-Preserve, and
                                           incoming IVID. */
    bcmVlanTranslateEgressKeyPortGroupVfiDoubleTagPreserveInnerTagIngressPortGroup = 54 /* Use port group ID, VFI,
                                           OTAG-Preserve, ITAG-Preserve,
                                           incoming IVID, and ingress port group
                                           ID. */
...
typedef enum bcm_vlan_control_e {
    ...
    bcmVlanControlTranslateEgressMissDrop = 25, /* Packet drop on egress VLAN
                                           translation miss. */
    bcmVlanControlTranslateL2TunnelVnidAssignMissDrop = 26, /* Packet drop on egress VLAN
                                           translation miss for VNID assignment. */
    bcmVlanControlCount = 27            /*  Always last. */
} bcm_vlan_control_t;
...
#define BCM_VLAN_CONTROL_STR \
    ...
    "bcmVlanControlTranslateL2TunnelVnidAssignMissDrop" 
...
typedef enum bcm_vlan_translate_egress_key_e {
    ...
    bcmVlanTranslateEgressKeyEsIdSrcDstGport = 22, /* Use ethernet segment ID, source GPORT
                                           and destination GPORT. */
    bcmVlanTranslateEgressKeyCount = 23 /* Egress VLAN translation key count.
                                           Always the last. */
...
typedef enum bcm_vlan_control_port_e {
    ...
    bcmVlanPortTranslateEgressKeyDoubleTagPreserveEnable = 32, /* Enable OTAG-Preserve and
                                           ...
                                           translation keys. */
    bcmVlanTranslateIngressMissDropFirst = 33 /* Enable to drop packets if the first
                                           ingress adaptation lookup misses. */
} bcm_vlan_control_port_t;
...
#define BCM_VLAN_FLAGS2_EGRESS_TRANSLATION_OUTER_VLAN_ENABLE 0x00000100 /* Enable the incoming
                                                          ...
                                                          egress VLAN
                                                          translation */
#define BCM_VLAN_FLAGS2_EGRESS_TRANSLATION_INNER_VLAN_ENABLE 0x00000200 /* Enable the incoming
                                                          packet's IVID key in
                                                          egress VLAN
                                                          translation */
...
#define BCM_VLAN_PORT_FLAGS2_OAM_TRUNK_MEMBER 0x00000001 /* Identify OAM endpoint
                                                          to be per Trunk
                                                          member. */
#define BCM_VLAN_PORT_FLAGS2_MAC_SAV        0x00000002 /* Identify the MAC SAV
                                                          for the LIF */
#define BCM_VLAN_PORT_FLAGS2_OAM_PRIMARY_VLAN 0x00000004 /* Classify OAM Primary
                                                          VLAN. */
...
typedef enum bcm_vlan_port_match_e {
    ...
    BCM_VLAN_PORT_MATCH_PORT_TUNNEL_UNTAGGED = 34, /* Mod/port/trunk + Tunnel Value +
                                           untagged packets. */
    BCM_VLAN_PORT_MATCH_MAC_PORT = 35,  /* Mod/port/trunk + MAC. */
    BCM_VLAN_PORT_MATCH_MAC_PORT_TAGGED = 36, /* Mod/port/trunk + MAC + Tagged. */
    BCM_VLAN_PORT_MATCH_MAC_PORT_VLAN = 37, /* Mod/port/trunk + MAC + VLAN. */
    BCM_VLAN_PORT_MATCH_COUNT = 38      /* Must be last. */
...
typedef struct bcm_vlan_port_s {
    ...
    bcm_mac_t match_srcmac;             /* Source MAC address */
} bcm_vlan_port_t;
...
typedef struct bcm_vlan_translate_egress_key_config_s {
    ...
    bcm_vlan_t ingress_outer_vlan;      /* Incoming packet's Outer VLAN ID to
                                           match. */
    bcm_vlan_t ingress_inner_vlan;      /* Incoming packet's Inner VLAN ID to
                                           match. */
