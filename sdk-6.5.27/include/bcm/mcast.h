...
#define BCM_MCAST_GPORT_IS_ELEMENT_ID(gport)  _SHR_MCAST_GPORT_IS_ELEMENT_ID(gport) 
#define BCM_MCAST_GPORT_ELEMENT_ID_SET(gport, mcast_id, is_static)  _SHR_MCAST_GPORT_ELEMENT_ID_SET(gport, mcast_id, is_static) 
#define BCM_MCAST_GPORT_ELEMENT_ID_GET(gport)  _SHR_MCAST_GPORT_ELEMENT_ID_GET(gport) 
#define BCM_MCAST_GPORT_IS_ELEMENT_STATIC(gport)  _SHR_MCAST_GPORT_IS_ELEMENT_STATIC(gport) 
