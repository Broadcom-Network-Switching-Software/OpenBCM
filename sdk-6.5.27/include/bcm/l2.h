...
#define BCM_L2_FLAGS2_NO_MOVE           0x00000200 /* The L2 entry cannot be
                                                      transplanted. */
#define BCM_L2_FLAGS2_FWD_ONLY          0x00000400 /* L2 address for DA MACT
                                                      used for forwarding only. */
#define BCM_L2_FLAGS2_LEARN_ONLY        0x00000800 /* L2 address for SA MACT. */
#define BCM_L2_FLAGS2_L3_ECMP           0x00001000 /* The destination of the l2
                                                      address is an ECMP group. */
...
typedef struct bcm_l2_addr_s {
    ...
    bcm_if_t egress_if;                 /* XGS: Next Hop when used with
                                           BCM_L2_FLAGS2_ROE_NHI flag. L3-ECMP
                                           group when used with
                                           BCM_L2_FLAGS2_L3_ECMP flag */
...
#define BCM_L2_EGRESS_PORT_INJECTION_MAP    0x00020000 /* Indicates to select in
                                                          pp port based on the
                                                          injected map */
...
/* L2 learn action resolution info. */
typedef struct bcm_l2_learn_action_resolution_s {
    uint32 existing_strength;   /* Strength of existing L2 entry. */
    uint32 learn_strength;      /* Strength of learned L2 entry. */
    bcm_gport_t gport;          /* GPORT identifier. */
} bcm_l2_learn_action_resolution_t;

#ifndef BCM_HIDE_DISPATCHABLE

/* Sets learn action resolution. */
extern int bcm_l2_learn_action_resolution_set(
    int unit, 
    bcm_l2_learn_action_resolution_t *action_res);

/* Sets learn action resolution. */
extern int bcm_l2_learn_action_resolution_get(
    int unit, 
    bcm_l2_learn_action_resolution_t *action_res);
...
typedef struct bcm_l2_station_s {
    ...
    bcm_vlan_t forwarding_domain;       /* Forwarding domain for the packet with
                                           matched VLAN. */
    uint8 my_cfm_mac_lsb_range_min;     /* MAC address LSBs Range Min Value. */
    uint8 my_cfm_mac_lsb_range_max;     /* MAC address LSBs Range Max Value. */
} bcm_l2_station_t;
...
#define BCM_L2_STATION_OAM_RANGE    (1 << 19)  /* Subject packets matching this
                                                  entry to OAM mac range. */
...
/* Set L2 global station. */
extern int bcm_l2_global_station_set(
    int unit, 
    bcm_l2_station_t *station);

/* Get L2 global station. */
extern int bcm_l2_global_station_get(
    int unit, 
    bcm_l2_station_t *station);
...
/* Drop events that can be enabled/disabled for L2 learning. */
typedef enum bcm_l2_learn_drop_event_e {
    bcmL2LearnDropEventL2SrcStaticMove = 0, /* L2 Src Static Move. */
    bcmL2LearnDropEventL2SrcDiscard = 1, /* L2 Src Discard. */
    bcmL2LearnDropEventMacsaMulticast = 2, /* Macsa Multicast. */
    bcmL2LearnDropEventOuterTpidCheckFailed = 3, /* Outer Tpid Check Failed. */
    bcmL2LearnDropEventIncomingPvlanCheckFailed = 4, /* Incoming Pvlan Check Failed. */
    bcmL2LearnDropEventPktIntegrityCheckFailed = 5, /* Pkt Integrity Check Failed. */
    bcmL2LearnDropEventProtocolPktDrop = 6, /* Protocol Pkt Drop. */
    bcmL2LearnDropEventMembershipCheckFailed = 7, /* Membership Check Failed. */
    bcmL2LearnDropEventL2DstLookupMiss = 8, /* L2 Dst Lookup Miss. */
    bcmL2LearnDropEventL2DstDiscard = 9, /* L2 Dst Discard. */
    bcmL2LearnDropEventL3DstLookupMiss = 10, /* L3 Dst Lookup Miss. */
    bcmL2LearnDropEventL3DstDiscard = 11, /* L3 Dst Discard. */
    bcmL2LearnDropEventL3HdrError = 12, /* L3 Hdr Error. */
    bcmL2LearnDropEventL3TtlError = 13, /* L3 Ttl Error. */
    bcmL2LearnDropEventIpmcL3IifOrRpaIdCheckFailed = 14, /* Ipmc L3 Iif Or Rpa Id Check Failed. */
    bcmL2LearnDropEventTunnelTtlCheckFailed = 15, /* Tunnel Ttl Check Failed. */
    bcmL2LearnDropEventTunnelObjectValidationFailed = 16, /* Tunnel Object Validation Failed. */
    bcmL2LearnDropEventTunnelAdaptDrop = 17, /* Tunnel Adapt Drop. */
    bcmL2LearnDropEventVfp = 18,        /* Vfp. */
    bcmL2LearnDropEventMplsProtectionDrop = 19, /* Mpls Protection Drop. */
    bcmL2LearnDropEventMplsLabelActionInvalid = 20, /* Mpls Label Action Invalid. */
    bcmL2LearnDropEventMplsTermPolicySelectTableDrop = 21, /* Mpls Term Policy Select Table Drop. */
    bcmL2LearnDropEventMplsReservedLabelExposed = 22, /* Mpls Reserved Label Exposed. */
    bcmL2LearnDropEventMplsTtlError = 23, /* Mpls Ttl Error. */
    bcmL2LearnDropEventMplsEcnError = 24, /* Mpls Ecn Error. */
    bcmL2LearnDropEventEmFt = 25,       /* Em Ft. */
    bcmL2LearnDropEventIvxlt = 26,      /* Ivxlt. */
    bcmL2LearnDropEventMplsCtrlPktDrop = 27, /* Mpls Ctrl Pkt Drop. */
    bcmL2LearnDropEventCount = 28       /* Always last. Not a usable value. */
} bcm_l2_learn_drop_event_t;

#ifndef BCM_HIDE_DISPATCHABLE

/* Enable/disable L2 learning for packets dropped due to an event. */
extern int bcm_l2_learn_drop_event_enable_set(
    int unit, 
    bcm_l2_learn_drop_event_t drop_event, 
    int enable);

/* Get all L2 learning enabled drop events. */
extern int bcm_l2_learn_drop_event_enable_get_all(
    int unit, 
    int max_size, 
    bcm_l2_learn_drop_event_t *drop_event_array, 
    int *actual_size);

/* Get L2 learning enabled status of a drop event. */
extern int bcm_l2_learn_drop_event_enable_get(
    int unit, 
    bcm_l2_learn_drop_event_t drop_event, 
    int *enable);
