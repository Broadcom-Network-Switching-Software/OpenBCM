...
/* RX packet metadata field IDs. */
#define BCM_PKTIO_RXPMD_FID_INVALID         BCMPKT_RXPMD_FID_INVALID /* Invalid
                                                          BCM_PKTIO_RXPMD FID
                                                          indicator */
#define BCM_PKTIO_RXPMD_UNICAST_QUEUE       BCMPKT_RXPMD_UNICAST_QUEUE /* Cell was stored in
                                                          Unicast Queue in MMU. */
#define BCM_PKTIO_RXPMD_QUEUE_NUM           BCMPKT_RXPMD_QUEUE_NUM /* Queue number used in
                                                          MMU, PBE field */
#define BCM_PKTIO_RXPMD_CPU_COS             BCMPKT_RXPMD_CPU_COS /* OVERLAY ON QUEUE_NUM
                                                          Queue number used in
                                                          MMU for cpu port, PBE
                                                          field */
#define BCM_PKTIO_RXPMD_HGI                 BCMPKT_RXPMD_HGI /* Valid only for packets
                                                          which came in on
                                                          Higig+ source port.
                                                          Higig+ moduleheader
                                                          field, PBE field. */
#define BCM_PKTIO_RXPMD_MATCHED_RULE        BCMPKT_RXPMD_MATCHED_RULE /* Matched Rule, PBE
                                                          field. */
#define BCM_PKTIO_RXPMD_PKT_LENGTH          BCMPKT_RXPMD_PKT_LENGTH /* DO NOT CHANGE, USED BY
                                                          CMIC HW: Packet length
                                                          after all
                                                          modification. */
#define BCM_PKTIO_RXPMD_SRC_PORT_NUM        BCMPKT_RXPMD_SRC_PORT_NUM /* Source Port Number,
                                                          PBE field. */
...
#define BCM_PKTIO_RXPMD_CHANGE_DSCP         BCMPKT_RXPMD_CHANGE_DSCP /* Set to 1 if the DSCP
                                                          value has been changed
                                                          by the EP */
#define BCM_PKTIO_RXPMD_DSCP                BCMPKT_RXPMD_DSCP /* New DSCP value
                                                          computed by the chip
                                                          (EP) for the packet */
#define BCM_PKTIO_RXPMD_CHANGE_ECN          BCMPKT_RXPMD_CHANGE_ECN /* Change the ECN as
                                                          indicated by the IFP. */
#define BCM_PKTIO_RXPMD_ECN                 BCMPKT_RXPMD_ECN /* New ECN value provided
                                                          by the IFP. */
#define BCM_PKTIO_RXPMD_TIMESTAMP_TYPE      BCMPKT_RXPMD_TIMESTAMP_TYPE /* NEW This pretty much
                                                          maps from
                                                          EP_TO_CPU_HEADER_OVERLAY_TYPE
                                                          from the MPB0:
                                                          Invalid1: TIMESTAMP
                                                          field carries the LM
                                                          packet-count for an
                                                          OAM loss measurement  
                                                          packet2:
                                                          TIMESTAMP_UPPER,TIMESTAMP
                                                          fields carry the
                                                          64-bit DM Time-stamp
                                                          for an   OAMdelay
                                                          measurement packet3:
                                                          802.1AS timestamp in
                                                          the TIMESTAMP field */
#define BCM_PKTIO_RXPMD_TIMESTAMP           BCMPKT_RXPMD_TIMESTAMP /* Low 32 bits of
                                                          timestamp. */
#define BCM_PKTIO_RXPMD_TIMESTAMP_HI        BCMPKT_RXPMD_TIMESTAMP_HI /* High 32/16bits of
                                                          timestamp. */
#define BCM_PKTIO_RXPMD_MTP_INDEX           BCMPKT_RXPMD_MTP_INDEX /* Mirror-to-Port Index,
                                                          PBE field */
#define BCM_PKTIO_RXPMD_BPDU                BCMPKT_RXPMD_BPDU /* BPDU Packet, PBE field */
#define BCM_PKTIO_RXPMD_REPLICATION         BCMPKT_RXPMD_REPLICATION /* Indicates the packet
                                                          is generated as a
                                                          result of packet
                                                          replication */
#define BCM_PKTIO_RXPMD_L3ONLY              BCMPKT_RXPMD_L3ONLY /* L3 IP Multicast Packet
                                                          Flag, PBE field */
#define BCM_PKTIO_RXPMD_IP_ROUTED           BCMPKT_RXPMD_IP_ROUTED /* Indicates packet was
                                                          routed - UC OR MC */
...
#define BCM_PKTIO_RXPMD_UC_SW_COPY_DROPPED  BCMPKT_RXPMD_UC_SW_COPY_DROPPED /* Indicates all switch
                                                          ...
                                                          port). */
#define BCM_PKTIO_RXPMD_SWITCH              BCMPKT_RXPMD_SWITCH /* Flag to indicate this
                                                          is a switched packet
                                                          as opposed to a
                                                          mirrored packet,PBE
                                                          field */
#define BCM_PKTIO_RXPMD_SD_TAG_PRESENT      BCMPKT_RXPMD_SD_TAG_PRESENT /* Indicates there is an
                                                          SD tag in the packet */
#define BCM_PKTIO_RXPMD_ING_ITAG_ACTION     BCMPKT_RXPMD_ING_ITAG_ACTION /* Indicates ingress
                                                          inner VLAN tag action,
                                                          PBE field:0: do not
                                                          modify, 1: add I-VID,
                                                          2: replace I-VID, 3:
                                                          remove I-VID */
#define BCM_PKTIO_RXPMD_ING_OTAG_ACTION     BCMPKT_RXPMD_ING_OTAG_ACTION /* Indicates ingress
                                                          outer VLAN tag action,
                                                          PBE field:0: do not
                                                          modify, 1: add O-VID,
                                                          2: replace O-VID, 3:
                                                          reserved */
#define BCM_PKTIO_RXPMD_ING_TAG_TYPE        BCMPKT_RXPMD_ING_TAG_TYPE /* Indicates the incoming
                                                          tag status
...
#define BCM_PKTIO_RXPMD_EH_TYPE             BCMPKT_RXPMD_EH_TYPE /* Defines the header
                                                          type enabling
                                                          flexibility for future
                                                          applications.0x0:
                                                          Queue selections for
                                                          Sirius/Arad.0x1:
                                                          ClassID0x2: ClassID +
                                                          QTag0x3-0x15: Reserved
                                                          for future use. */
...
#define BCM_PKTIO_RXPMD_I2E_CLASSID_TYPE    BCMPKT_RXPMD_I2E_CLASSID_TYPE /* Valid for non-BFD
                                                          packet */
#define BCM_PKTIO_RXPMD_I2E_CLASSID         BCMPKT_RXPMD_I2E_CLASSID /* Valid for non-BFD
                                                          packet */
#define BCM_PKTIO_RXPMD_ING_L3_INTF         BCMPKT_RXPMD_ING_L3_INTF /* Ingress L3 Intf
                                                          number. */
#define BCM_PKTIO_RXPMD_LOOPBACK_PACKET_TYPE BCMPKT_RXPMD_LOOPBACK_PACKET_TYPE /* Indication to next
                                                          pass about the type of
                                                          loopback. */
#define BCM_PKTIO_RXPMD_REGEN_CRC           BCMPKT_RXPMD_REGEN_CRC /* If set, then packet
                                                          has been modified by
                                                          the EP and CRC needs
                                                          to be regenerated */
...
#define BCM_PKTIO_RXPMD_HG2_EXT_HDR_VALID   BCMPKT_RXPMD_HG2_EXT_HDR_VALID /* HG2 Extended Header
                                                          Valid. (was in
                                                          FRC_reserved) */
#define BCM_PKTIO_RXPMD_VNTAG_ACTION        BCMPKT_RXPMD_VNTAG_ACTION /* New field for
                                                          VNTAG/ETAGs: 00: Do
                                                          not Modify 01:
                                                          Add/Replace incoming
                                                          VNTAG/ETAG with
                                                          Ingress Port Based
                                                          VNTAG 10: Add/Replace
                                                          incoming VNTAG/ETAG
                                                          with Ingress Port
                                                          Based ETAG. 11: Delete
                                                          Packets VNTAG/ETAG */
#define BCM_PKTIO_RXPMD_DVP_NHI_SEL         BCMPKT_RXPMD_DVP_NHI_SEL /* If set, the
                                                          DVP/NHOP_INDEX overlay
                                                          has the DVP. Else, it
                                                          has the Next Hop
                                                          Index. */
...
#define BCM_PKTIO_RXPMD_MATCH_ID_LO         BCMPKT_RXPMD_MATCH_ID_LO /* Low 32 bits of the
                                                          packet MATCH_ID. */
#define BCM_PKTIO_RXPMD_MATCH_ID_HI         BCMPKT_RXPMD_MATCH_ID_HI /* High 18 bits of the
                                                          packet MATCH_ID. */
#define BCM_PKTIO_RXPMD_MPB_FLEX_DATA_TYPE  BCMPKT_RXPMD_MPB_FLEX_DATA_TYPE /* MPB flex data_type
                                                          from
                                                          MPB_FIXED.flex_data_type */
#define BCM_PKTIO_RXPMD_INT_CN              BCMPKT_RXPMD_INT_CN /* From EPRE/EDEV_CONFIG
                                                          table
...
#define BCM_PKTIO_RXPMD_MULTICAST           BCMPKT_RXPMD_MULTICAST /* Multicast packet from
                                                          MPB_FIXED */
#define BCM_PKTIO_RXPMD_COPY_TO_CPU         BCMPKT_RXPMD_COPY_TO_CPU /* Copy to CPU from
                                                          MPB_FIXED */
...
#define BCM_PKTIO_RXPMD_IEU                 BCMPKT_RXPMD_IEU /* Inner Entropy Used
                                                          indication. */
#define BCM_PKTIO_RXPMD_IEU_VALID           BCMPKT_RXPMD_IEU_VALID /* IEU indication is
                                                          valid. */
...
#define BCM_PKTIO_RXPMD_ARC_ID_LO           BCMPKT_RXPMD_ARC_ID_LO /* Low 32 bits of the
                                                          packet ARC_ID. */
#define BCM_PKTIO_RXPMD_ARC_ID_HI           BCMPKT_RXPMD_ARC_ID_HI /* High 18 bits of the
                                                          packet ARC_ID. */
#define BCM_PKTIO_RXPMD_VRF                 BCMPKT_RXPMD_VRF /* VRF. */
#define BCM_PKTIO_RXPMD_IEEE_802_1AS_TIMESTAMP_ENABLED BCMPKT_RXPMD_IEEE_802_1AS_TIMESTAMP_ENABLED /* IEEE 802_1AS timestamp
                                                          status. */
#define BCM_PKTIO_RXPMD_FID_COUNT           BCMPKT_RXPMD_FID_COUNT /* RXPMD FIELD ID NUMBER */

/* BCM_PKTIO_RXPMD_TIMESTAMP_TYPE encodings. */
...
/* BCM_PKTIO_RXPMD_ING_TAG_TYPE encodings. */
...
/* BCM_PKTIO_RXPMD_EH_TYPE encodings. */
...
#define BCM_PKTIO_RX_REASON_CPU_IPMC_INTERFACE_MISMATCH BCMPKT_RX_REASON_CPU_IPMC_INTERFACE_MISMATCH /* IPMC interface
                                                          mismatch */
#define BCM_PKTIO_RX_REASON_NAT             BCMPKT_RX_REASON_NAT /* Get: Indicate NAT
                                                          REASON happened; Set:
                                                          Configure NAT REASON
                                                          mask. */
...
#define BCM_PKTIO_RX_REASON_TRILL           BCMPKT_RX_REASON_TRILL /* Get: Indicate TRILL
                                                          REASON happened; Set:
                                                          Configure TRILL REASON
                                                          mask. */
...
#define BCM_PKTIO_RX_REASON_TIME_SYNC       BCMPKT_RX_REASON_TIME_SYNC /* Indicates packet was
                                                          ...
                                                          packet.  This isset
                                                          either by dedicated
                                                          IEEE 802.1AS controls
                                                          or the FP. */
#define BCM_PKTIO_RX_REASON_VXLT_MISS       BCMPKT_RX_REASON_VXLT_MISS /* Indicates packet was
                                                          copied to the CPU due
                                                          to VLAN Translation
                                                          miss. */
#define BCM_PKTIO_RX_REASON_NIV             BCMPKT_RX_REASON_NIV /* Get: Indicate NIV
                                                          REASON happened; Set:
                                                          Configure NIV REASON
                                                          mask. */
...
#define BCM_PKTIO_RX_REASON_MY_STATION      BCMPKT_RX_REASON_MY_STATION /* Copy to CPU for
                                                          MY_STATION match
                                                          reason */
#define BCM_PKTIO_RX_REASON_MPLS_UNKNOWN_ACH_ERROR BCMPKT_RX_REASON_MPLS_UNKNOWN_ACH_ERROR /* MPLS unknown ACH */
#define BCM_PKTIO_RX_REASON_L3_NEXT_HOP     BCMPKT_RX_REASON_L3_NEXT_HOP /* ING_L3_NEXT_HOP table
                                                          copy to CPU */
...
#define BCM_PKTIO_RX_REASON_CBSM_PREVENTED  BCMPKT_RX_REASON_CBSM_PREVENTED /* Bit26 - CBSM_PREVENTED
                                                          - copy to CPU */
#define BCM_PKTIO_RX_REASON_CPU_VFP         BCMPKT_RX_REASON_CPU_VFP /* Bit25 - VFP Action -
                                                          copy to CPU */
#define BCM_PKTIO_RX_REASON_MCIDX_ERROR     BCMPKT_RX_REASON_MCIDX_ERROR /* Bit24 - Multicast
                                                          index error */
#define BCM_PKTIO_RX_REASON_HGHDR_ERROR     BCMPKT_RX_REASON_HGHDR_ERROR /* Bit23 - HiGig Header
                                                          error */
...
#define BCM_PKTIO_RX_REASON_PARITY_ERROR    BCMPKT_RX_REASON_PARITY_ERROR /* Bit21 - Parity error
                                                          on IP tables */
#define BCM_PKTIO_RX_REASON_L3_SLOWPATH     BCMPKT_RX_REASON_L3_SLOWPATH /* Bit20 - L3 slow path
                                                          CPU processed packets */
...
#define BCM_PKTIO_RX_REASON_CPU_L3HDR_ERR   BCMPKT_RX_REASON_CPU_L3HDR_ERR /* Bit13 - L3 header  -
                                                          IP options, TTL=0,
                                                          !IPv4 etc. */
#define BCM_PKTIO_RX_REASON_CPU_FFP         BCMPKT_RX_REASON_CPU_FFP /* Bit12 - FFP Action -
                                                          copy to CPU */
...
#define BCM_PKTIO_RX_REASON_CPU_L2CPU       BCMPKT_RX_REASON_CPU_L2CPU /* Bit4 - L2_TABLE - copy
                                                          to CPU */
...
#define BCM_PKTIO_RX_REASON_CPU_UVLAN       BCMPKT_RX_REASON_CPU_UVLAN /* Bit0- CPU Learn bit is
                                                          set in PTABLE and SA
                                                          is learnt; unknown
                                                          VLAN; VID = 0xfff */
#define BCM_PKTIO_RX_REASON_PROTECTION_DATA_DROP BCMPKT_RX_REASON_PROTECTION_DATA_DROP /* Bit18 - protection
                                                          data dropped packet
                                                          copied to CPU */
#define BCM_PKTIO_RX_REASON_OAM_ERROR       BCMPKT_RX_REASON_OAM_ERROR /* OAM packets copied to
                                                          the CPU for error
                                                          cases */
#define BCM_PKTIO_RX_REASON_OAM_LMDM        BCMPKT_RX_REASON_OAM_LMDM /* Copy to CPU for OAM
                                                          LMDM */
#define BCM_PKTIO_RX_REASON_CPU_SFLOW       BCMPKT_RX_REASON_CPU_SFLOW /* Get: Indicate SFLOW
                                                          REASON happened; Set:
...
#define BCM_PKTIO_RX_REASON_INVALID_GSH_NON_GSH BCMPKT_RX_REASON_INVALID_GSH_NON_GSH /* Invalid GSH or NON_GSH
                                                          packet based on port
                                                          configuration. */
#define BCM_PKTIO_RX_REASON_EP_CTC          BCMPKT_RX_REASON_EP_CTC /* Copy to CPU triggered
                                                          at egress pipeline. */
#define BCM_PKTIO_RX_REASON_COUNT           BCMPKT_RX_REASON_COUNT /* RX REASON TYPE NUMBER */

/* TX packet metadata field IDs. */
#define BCM_PKTIO_TXPMD_FID_INVALID         BCMPKT_TXPMD_FID_INVALID /* Invalid
                                                          BCM_PKTIO_TXPMD FID
                                                          indicator */
#define BCM_PKTIO_TXPMD_START               BCMPKT_TXPMD_START /* Start of frame
                                                          indicator. */
#define BCM_PKTIO_TXPMD_HEADER_TYPE         BCMPKT_TXPMD_HEADER_TYPE /* 64 Header Types
                                                          Supported. 1 means
                                                          Packets from CPU with
                                                          SOBMH header formatto
                                                          Passthru NLF */
#define BCM_PKTIO_TXPMD_PKT_LENGTH          BCMPKT_TXPMD_PKT_LENGTH /* PKT_LENGTH (set by
                                                          hardware - in Iarb). */
#define BCM_PKTIO_TXPMD_IPCF_PTR            BCMPKT_TXPMD_IPCF_PTR /* Pointer to cell buffer
                                                          of this SOBMH cell.
                                                          (Set by hardware) */
#define BCM_PKTIO_TXPMD_SOP                 BCMPKT_TXPMD_SOP /* SOP indicator (set by
                                                          hardware - in Iarb). */
#define BCM_PKTIO_TXPMD_EOP                 BCMPKT_TXPMD_EOP /* EOP indicator (set by
                                                          hardware - in Iarb). */
#define BCM_PKTIO_TXPMD_CELL_LENGTH         BCMPKT_TXPMD_CELL_LENGTH /* CELL_LENGTH (set by
                                                          hardware - in Iarb). */
#define BCM_PKTIO_TXPMD_CELL_ERROR          BCMPKT_TXPMD_CELL_ERROR /* CELL_ERROR or PURGE */
#define BCM_PKTIO_TXPMD_LOCAL_DEST_PORT     BCMPKT_TXPMD_LOCAL_DEST_PORT /* Indicates the local
                                                          port to send a SOBMH
                                                          packet out. */
#define BCM_PKTIO_TXPMD_SRC_MODID           BCMPKT_TXPMD_SRC_MODID /* Source module ID, must
                                                          be programmed to
                                                          MY_MODID. */
#define BCM_PKTIO_TXPMD_COS                 BCMPKT_TXPMD_COS /* Class of service for
                                                          MMU queueing for this
                                                          packet - sets COS
                                                          values,PBI.UC_COS,
                                                          PBI.MC_COS1, and
                                                          PBI.MC_COS2. */
#define BCM_PKTIO_TXPMD_INPUT_PRI           BCMPKT_TXPMD_INPUT_PRI /* Traffic priority to be
                                                          applied to MMU via
                                                          PBI.INPUT_PRIORITY. */
#define BCM_PKTIO_TXPMD_UNICAST             BCMPKT_TXPMD_UNICAST /* Indicates that
                                                          PBI.UNICAST should be
                                                          set to queue as
                                                          unicast packet. */
#define BCM_PKTIO_TXPMD_RQE_Q_NUM           BCMPKT_TXPMD_RQE_Q_NUM /* Value for
                                                          CCBI.RSQ_Q_NUM. */
#define BCM_PKTIO_TXPMD_SET_L2BM            BCMPKT_TXPMD_SET_L2BM /* Indicates that
                                                          PBI.L2_BITMAP should
                                                          be set (to queue as
                                                          L2MC packet). */
...
#define BCM_PKTIO_TXPMD_TX_TS               BCMPKT_TXPMD_TX_TS /* Indicates for TS
                                                          packet transmitted
                                                          from CPU into IP that
                                                          the outgoing
                                                          packetneeds to have
                                                          its transmit timestamp
                                                          captured by the port. */
#define BCM_PKTIO_TXPMD_SPID_OVERRIDE       BCMPKT_TXPMD_SPID_OVERRIDE /* For PBI.SPID_Override */
#define BCM_PKTIO_TXPMD_SPID                BCMPKT_TXPMD_SPID /* For PBI.SPID - Service
                                                          Pool ID */
#define BCM_PKTIO_TXPMD_SPAP                BCMPKT_TXPMD_SPAP /* For PBI.SPAP - Service
                                                          Pool Priority (color) */
#define BCM_PKTIO_TXPMD_UNICAST_PKT         BCMPKT_TXPMD_UNICAST_PKT /* Will set
                                                          CCBI_B.UNICAST_PKT */
...
#define BCM_PKTIO_TXPMD_TS_TYPE             BCMPKT_TXPMD_TS_TYPE /* Time statmp type. 
                                                          Encodings are 0-NTP
                                                          TOD(64 bit), 1-PTP
                                                          TOD(64bit) */
#define BCM_PKTIO_TXPMD_DST_SUBPORT_NUM     BCMPKT_TXPMD_DST_SUBPORT_NUM /* Destination subport
                                                          number */
...
#define BCM_PKTIO_TXPMD_UDP_CHECKSUM_OFFSET BCMPKT_TXPMD_UDP_CHECKSUM_OFFSET /* Offset to UDP checksum
                                                          field from start of
                                                          MACS-SA */
#define BCM_PKTIO_TXPMD_CNG                 BCMPKT_TXPMD_CNG /* CNG Field. */
#define BCM_PKTIO_TXPMD_DESTINATION         BCMPKT_TXPMD_DESTINATION /* DESTINATION Field. */
#define BCM_PKTIO_TXPMD_DESTINATION_TYPE    BCMPKT_TXPMD_DESTINATION_TYPE /* Destination Field
                                                          Type. */
#define BCM_PKTIO_TXPMD_WRED_MARK_ELIGIBLE  BCMPKT_TXPMD_WRED_MARK_ELIGIBLE /* WRED Mark Eligible
                                                          field. */
#define BCM_PKTIO_TXPMD_WRED_RESPONSE       BCMPKT_TXPMD_WRED_RESPONSE /* WRED Response Field. */
#define BCM_PKTIO_TXPMD_CPU_TX_MCAST_LB_INDEX BCMPKT_TXPMD_CPU_TX_MCAST_LB_INDEX /* Allows software to
                                                          select load balancing
                                                          bitmap for non-unicast
                                                          packets. */
#define BCM_PKTIO_TXPMD_CPU_TX_ECMP_MEMBER_ID BCMPKT_TXPMD_CPU_TX_ECMP_MEMBER_ID /* ECMP member ID for
                                                          case where
                                                          DESTINATION_TYPE=ECMP_MEMBER.
                                                          Only valid for single
                                                          level ECMP. */
#define BCM_PKTIO_TXPMD_CPU_TX_DESTINATION  BCMPKT_TXPMD_CPU_TX_DESTINATION /* Destination Field. */
#define BCM_PKTIO_TXPMD_CPU_TX_DESTINATION_TYPE BCMPKT_TXPMD_CPU_TX_DESTINATION_TYPE /* Destination Field
                                                          Type. */
#define BCM_PKTIO_TXPMD_CPU_TX_DP           BCMPKT_TXPMD_CPU_TX_DP /* Drop Precedence. */
#define BCM_PKTIO_TXPMD_CPU_TX_INPUT_PRI    BCMPKT_TXPMD_CPU_TX_INPUT_PRI /* Traffic priority to be
                                                          applied to MMU via
                                                          PBI.INPUT_PRIORITY. */
#define BCM_PKTIO_TXPMD_CPU_TX_INT_CN       BCMPKT_TXPMD_CPU_TX_INT_CN /* Internal congestion. */
#define BCM_PKTIO_TXPMD_CPU_TX_INT_PRI      BCMPKT_TXPMD_CPU_TX_INT_PRI /* Internal priority. */
#define BCM_PKTIO_TXPMD_CPU_TX_MCAST_LB_INDEX_VLD BCMPKT_TXPMD_CPU_TX_MCAST_LB_INDEX_VLD /* Load balancing bitmap
                                                          is valid indication. */
#define BCM_PKTIO_TXPMD_CPU_TX_PKT_PROFILE  BCMPKT_TXPMD_CPU_TX_PKT_PROFILE /* Pointer to
                                                          CPU_PACKET_PROFILE_1/2
                                                          registers. */
#define BCM_PKTIO_TXPMD_CPU_TX_QOS_FIELDS_VLD BCMPKT_TXPMD_CPU_TX_QOS_FIELDS_VLD /* QoS fields (INT_PRI,
                                                          DP, INT_CN) valid
                                                          indication. */
#define BCM_PKTIO_TXPMD_CPU_TX_ROUTED_PKT   BCMPKT_TXPMD_CPU_TX_ROUTED_PKT /* If set packet marked
                                                          as Layer 3 routed. */
#define BCM_PKTIO_TXPMD_CPU_TX_UNICAST      BCMPKT_TXPMD_CPU_TX_UNICAST /* Unicast packet of
                                                          CPU_TX view. */
#define BCM_PKTIO_TXPMD_CPU_TX_SOP          BCMPKT_TXPMD_CPU_TX_SOP /* SOP indicator of
                                                          CPU_TX view. */
#define BCM_PKTIO_TXPMD_CPU_TX_VRF          BCMPKT_TXPMD_CPU_TX_VRF /* VRF ID. */
#define BCM_PKTIO_TXPMD_CPU_TX_VRF_VALID    BCMPKT_TXPMD_CPU_TX_VRF_VALID /* VRF ID is valid. */
#define BCM_PKTIO_TXPMD_CPU_TX_WCMP_SEL     BCMPKT_TXPMD_CPU_TX_WCMP_SEL /* WCMP Selection of
                                                          CPU_TX view. */
#define BCM_PKTIO_TXPMD_OAM_DOWNMEP_TX_CELL_ERROR BCMPKT_TXPMD_OAM_DOWNMEP_TX_CELL_ERROR /* Cell error of
                                                          OAM_DOWNMEP view. */
#define BCM_PKTIO_TXPMD_OAM_DOWNMEP_TX_CELL_LENGTH BCMPKT_TXPMD_OAM_DOWNMEP_TX_CELL_LENGTH /* Cell length of
                                                          OAM_DOWNMEP view. */
#define BCM_PKTIO_TXPMD_OAM_DOWNMEP_TX_COS  BCMPKT_TXPMD_OAM_DOWNMEP_TX_COS /* Class of service of
                                                          OAM_DOWNMEP view. */
#define BCM_PKTIO_TXPMD_OAM_DOWNMEP_TX_DESTINATION BCMPKT_TXPMD_OAM_DOWNMEP_TX_DESTINATION /* Destination of
                                                          OAM_DOWNMEP view. */
#define BCM_PKTIO_TXPMD_OAM_DOWNMEP_TX_DESTINATION_TYPE BCMPKT_TXPMD_OAM_DOWNMEP_TX_DESTINATION_TYPE /* Destination type of
                                                          OAM_DOWNMEP view. */
#define BCM_PKTIO_TXPMD_OAM_DOWNMEP_TX_EOP  BCMPKT_TXPMD_OAM_DOWNMEP_TX_EOP /* EOP indicator of
                                                          OAM_DOWNMEP view. */
#define BCM_PKTIO_TXPMD_OAM_DOWNMEP_TX_INPUT_PRI BCMPKT_TXPMD_OAM_DOWNMEP_TX_INPUT_PRI /* Input priority of
                                                          OAM_DOWNMEP view. */
#define BCM_PKTIO_TXPMD_OAM_DOWNMEP_TX_LM_COUNTER_ACTION BCMPKT_TXPMD_OAM_DOWNMEP_TX_LM_COUNTER_ACTION /* LM counter action of
                                                          OAM_DOWNMEP view. */
#define BCM_PKTIO_TXPMD_OAM_DOWNMEP_TX_LM_COUNTER_ID BCMPKT_TXPMD_OAM_DOWNMEP_TX_LM_COUNTER_ID /* LM counter ID of
                                                          OAM_DOWNMEP view. */
#define BCM_PKTIO_TXPMD_OAM_DOWNMEP_TX_OAM_REPLACEMENT_OFFSET BCMPKT_TXPMD_OAM_DOWNMEP_TX_OAM_REPLACEMENT_OFFSET /* OAM replacement offset
                                                          of OAM_DOWNMEP view. */
#define BCM_PKTIO_TXPMD_OAM_DOWNMEP_TX_PKT_LENGTH BCMPKT_TXPMD_OAM_DOWNMEP_TX_PKT_LENGTH /* Packet length of
                                                          OAM_DOWNMEP view. */
#define BCM_PKTIO_TXPMD_OAM_DOWNMEP_TX_RQE_Q_NUM BCMPKT_TXPMD_OAM_DOWNMEP_TX_RQE_Q_NUM /* RQE Queue Number of
                                                          OAM_DOWNMEP view. */
#define BCM_PKTIO_TXPMD_OAM_DOWNMEP_TX_SOP  BCMPKT_TXPMD_OAM_DOWNMEP_TX_SOP /* SOP indicator of
                                                          OAM_DOWNMEP view. */
#define BCM_PKTIO_TXPMD_OAM_DOWNMEP_TX_SPAP BCMPKT_TXPMD_OAM_DOWNMEP_TX_SPAP /* Service Pool
                                                          Allocation Precedence
                                                          of OAM_DOWNMEP view. */
#define BCM_PKTIO_TXPMD_OAM_DOWNMEP_TX_SPID BCMPKT_TXPMD_OAM_DOWNMEP_TX_SPID /* Service Pool ID of
                                                          OAM_DOWNMEP view. */
#define BCM_PKTIO_TXPMD_OAM_DOWNMEP_TX_SPID_OVERRIDE BCMPKT_TXPMD_OAM_DOWNMEP_TX_SPID_OVERRIDE /* For Service Pool ID
                                                          override of
                                                          OAM_DOWNMEP view. */
#define BCM_PKTIO_TXPMD_OAM_DOWNMEP_TX_SRC_MODID BCMPKT_TXPMD_OAM_DOWNMEP_TX_SRC_MODID /* Source module ID of
                                                          OAM_DOWNMEP view. */
#define BCM_PKTIO_TXPMD_OAM_DOWNMEP_TX_TIMESTAMP_ACTION BCMPKT_TXPMD_OAM_DOWNMEP_TX_TIMESTAMP_ACTION /* Timestamp action of
                                                          OAM_DOWNMEP view. */
#define BCM_PKTIO_TXPMD_OAM_DOWNMEP_TX_UNICAST BCMPKT_TXPMD_OAM_DOWNMEP_TX_UNICAST /* Unicast packet of
                                                          OAM_DOWNMEP view. */
#define BCM_PKTIO_TXPMD_COPY_TO_DEBUG       BCMPKT_TXPMD_COPY_TO_DEBUG /* Indicates a copy
                                                          should be sent to the
                                                          the CPU port mapped to
                                                          R5. */
#define BCM_PKTIO_TXPMD_COPY_TO_CPU         BCMPKT_TXPMD_COPY_TO_CPU /* copy to cpu. */
#define BCM_PKTIO_TXPMD_WRED_RESPONSIVE     BCMPKT_TXPMD_WRED_RESPONSIVE /* Used to set
                                                          PBI.WRED_RESPONSIVE. */
#define BCM_PKTIO_TXPMD_FID_COUNT           BCMPKT_TXPMD_FID_COUNT /* TXPMD FIELD ID NUMBER */

/* BCM_PKTIO_TXPMD_START encodings. */
...
/* BCM_PKTIO_TXPMD_HEADER_TYPE encodings. */
...
#define BCM_PKTIO_TXPMD_HEADER_T_MIM        BCMPKT_TXPMD_HEADER_T_MIM /* MAC in MAC packets to
                                                          Passthru NLF */
#define BCM_PKTIO_TXPMD_HEADER_T_CPU_TX     BCMPKT_TXPMD_HEADER_T_CPU_TX /* Header type CPU_TX */
...
#define BCM_PKTIO_TXPMD_HEADER_T_WLAN_ENCAP BCMPKT_TXPMD_HEADER_T_WLAN_ENCAP /* WLAN Encap packets
                                                          sent to WTX NLF */
#define BCM_PKTIO_TXPMD_HEADER_T_QCN        BCMPKT_TXPMD_HEADER_T_QCN /* QCN Packets to
                                                          Passthru NLF */
...
/* BCM_PKTIO_TXPMD_DESTINATION_TYPE encodings. */
#define BCM_PKTIO_TXPMD_DESTINATION_T_EGRESS_PORT BCMPKT_TXPMD_DESTINATION_T_EGRESS_PORT /* Egress Port */
#define BCM_PKTIO_TXPMD_DESTINATION_T_L2_PBM BCMPKT_TXPMD_DESTINATION_T_L2_PBM /* Asserts bit selected
                                                          by destination field
                                                          in L2_PBM */
#define BCM_PKTIO_TXPMD_DESTINATION_T_INVALID BCMPKT_TXPMD_DESTINATION_T_INVALID /* Destination is Invalid */

/* BCM_PKTIO_TXPMD_CPU_TX_DESTINATION_TYPE encodings. */
#define BCM_PKTIO_TXPMD_CPU_TX_DESTINATION_T_EGRESS_PORT BCMPKT_TXPMD_CPU_TX_DESTINATION_T_EGRESS_PORT /* Egress Port */
#define BCM_PKTIO_TXPMD_CPU_TX_DESTINATION_T_NHI BCMPKT_TXPMD_CPU_TX_DESTINATION_T_NHI /* Next Hop Index */
#define BCM_PKTIO_TXPMD_CPU_TX_DESTINATION_T_ECMP BCMPKT_TXPMD_CPU_TX_DESTINATION_T_ECMP /* ECMP Group */
#define BCM_PKTIO_TXPMD_CPU_TX_DESTINATION_T_ECMP_MEMBER BCMPKT_TXPMD_CPU_TX_DESTINATION_T_ECMP_MEMBER /* ECMP member id */
#define BCM_PKTIO_TXPMD_CPU_TX_DESTINATION_T_IPMC BCMPKT_TXPMD_CPU_TX_DESTINATION_T_IPMC /* IP Multicast Group */
#define BCM_PKTIO_TXPMD_CPU_TX_DESTINATION_T_L2MC BCMPKT_TXPMD_CPU_TX_DESTINATION_T_L2MC /* L2MC group */
#define BCM_PKTIO_TXPMD_CPU_TX_DESTINATION_T_VLAN_FLOOD BCMPKT_TXPMD_CPU_TX_DESTINATION_T_VLAN_FLOOD /* Vlan Flooding */
#define BCM_PKTIO_TXPMD_CPU_TX_DESTINATION_T_L2_PBM BCMPKT_TXPMD_CPU_TX_DESTINATION_T_L2_PBM /* Asserts bit selected
                                                          by destination field
                                                          in L2_PBM */
#define BCM_PKTIO_TXPMD_CPU_TX_DESTINATION_T_LAG_ID BCMPKT_TXPMD_CPU_TX_DESTINATION_T_LAG_ID /* LAG ID */
#define BCM_PKTIO_TXPMD_CPU_TX_DESTINATION_T_INVALID BCMPKT_TXPMD_CPU_TX_DESTINATION_T_INVALID /* Destination is Invalid */

/* BCM_PKTIO_TXPMD_CPU_TX_DP encodings. */
#define BCM_PKTIO_TXPMD_CPU_TX_DP_GREEN     BCMPKT_TXPMD_CPU_TX_DP_GREEN /* Green */
#define BCM_PKTIO_TXPMD_CPU_TX_DP_RED       BCMPKT_TXPMD_CPU_TX_DP_RED /* Red */
#define BCM_PKTIO_TXPMD_CPU_TX_DP_YELLOW    BCMPKT_TXPMD_CPU_TX_DP_YELLOW /* Yellow */

/* BCM_PKTIO_TXPMD_OAM_DOWNMEP_TX_DESTINATION_TYPE encodings. */
#define BCM_PKTIO_TXPMD_OAM_DOWNMEP_TX_DESTINATION_T_EGRESS_PORT BCMPKT_TXPMD_OAM_DOWNMEP_TX_DESTINATION_T_EGRESS_PORT /* Egress Port */

/* BCM_PKTIO_TXPMD_OAM_DOWNMEP_TX_LM_COUNTER_ACTION encodings. */
#define BCM_PKTIO_TXPMD_OAM_DOWNMEP_TX_LM_COUNTER_ACTION_NO_OP BCMPKT_TXPMD_OAM_DOWNMEP_TX_LM_COUNTER_ACTION_NO_OP /* No operation */
#define BCM_PKTIO_TXPMD_OAM_DOWNMEP_TX_LM_COUNTER_ACTION_INCREMENT BCMPKT_TXPMD_OAM_DOWNMEP_TX_LM_COUNTER_ACTION_INCREMENT /* Increment */
#define BCM_PKTIO_TXPMD_OAM_DOWNMEP_TX_LM_COUNTER_ACTION_INCREMENT_SAMPLE BCMPKT_TXPMD_OAM_DOWNMEP_TX_LM_COUNTER_ACTION_INCREMENT_SAMPLE /* Increment and sample */
#define BCM_PKTIO_TXPMD_OAM_DOWNMEP_TX_LM_COUNTER_ACTION_SAMPLE BCMPKT_TXPMD_OAM_DOWNMEP_TX_LM_COUNTER_ACTION_SAMPLE /* Sample */

/* BCM_PKTIO_TXPMD_OAM_DOWNMEP_TX_TIMESTAMP_ACTION encodings. */
#define BCM_PKTIO_TXPMD_OAM_DOWNMEP_TX_TIMESTAMP_ACTION_NO_OP BCMPKT_TXPMD_OAM_DOWNMEP_TX_TIMESTAMP_ACTION_NO_OP /* No operation */
#define BCM_PKTIO_TXPMD_OAM_DOWNMEP_TX_TIMESTAMP_ACTION_SAMPLE BCMPKT_TXPMD_OAM_DOWNMEP_TX_TIMESTAMP_ACTION_SAMPLE /* Sample */

/* TRACE metadata field IDs. */
#define BCM_PKTIO_TRACE_FID_INVALID         BCMPKT_TRACE_FID_INVALID /* Invalid
                                                          BCM_PKTIO_TRACE FID
                                                          indicator */
#define BCM_PKTIO_TRACE_MY_STATION_HIT      BCMPKT_TRACE_MY_STATION_HIT /* Indicates
                                                          MY_STATION_TCAM lookup
                                                          hit. */
...
#define BCM_PKTIO_TRACE_UNRESOLVED_SA       BCMPKT_TRACE_UNRESOLVED_SA /* Unresolved source
                                                          address. */
...
#define BCM_PKTIO_TRACE_SRC_TBL_HALF_ENTRY_NUM BCMPKT_TRACE_SRC_TBL_HALF_ENTRY_NUM /* LPM table source
                                                          address half entry
                                                          number. */
#define BCM_PKTIO_TRACE_SRC_TBL_INDEX       BCMPKT_TRACE_SRC_TBL_INDEX /* LPM table source
                                                          address table index */
#define BCM_PKTIO_TRACE_TBL_HALF_ENTRY_NUM  BCMPKT_TRACE_TBL_HALF_ENTRY_NUM /* LPM table destination
                                                          address half entry
                                                          number. */
#define BCM_PKTIO_TRACE_TBL_INDEX           BCMPKT_TRACE_TBL_INDEX /* LPM table destination
                                                          address table index. */
...
#define BCM_PKTIO_TRACE_SRC_PRIVATE_HIT     BCMPKT_TRACE_SRC_PRIVATE_HIT /* L3 lookup source
                                                          address private hit. */
#define BCM_PKTIO_TRACE_SRC_PUBLIC_HIT      BCMPKT_TRACE_SRC_PUBLIC_HIT /* L3 lookup source
                                                          address public hit. */
...
#define BCM_PKTIO_TRACE_DST_PUBLIC_HIT      BCMPKT_TRACE_DST_PUBLIC_HIT /* L3 lookup destination
                                                          address public hit. */
#define BCM_PKTIO_TRACE_L2LU_SRC_INDEX      BCMPKT_TRACE_L2LU_SRC_INDEX /* L2 lookup source
                                                          index. */
#define BCM_PKTIO_TRACE_L2LU_SRC_KEY_TYPE   BCMPKT_TRACE_L2LU_SRC_KEY_TYPE /* Key type used for
                                                          Source lookup to L2
                                                          table. */
#define BCM_PKTIO_TRACE_L2LU_SRC_HIT        BCMPKT_TRACE_L2LU_SRC_HIT /* Indicates Source
                                                          lookup in L2 table
                                                          hit. */
...
#define BCM_PKTIO_TRACE_MPLS_ENTRY_KEY_TYPE_1 BCMPKT_TRACE_MPLS_ENTRY_KEY_TYPE_1 /* Key type used for
                                                          MPLS_ENTRY lookup 1. */
#define BCM_PKTIO_TRACE_VT_INDEX_2          BCMPKT_TRACE_VT_INDEX_2 /* Index for VLAN
                                                          translation lookup 2
                                                          when hit. */
#define BCM_PKTIO_TRACE_VT_INDEX_1          BCMPKT_TRACE_VT_INDEX_1 /* Index for VLAN
...
#define BCM_PKTIO_TRACE_VT_KEY_TYPE_2       BCMPKT_TRACE_VT_KEY_TYPE_2 /* Key type used for VLAN
                                                          translation lookup 2. */
#define BCM_PKTIO_TRACE_VT_HIT_2            BCMPKT_TRACE_VT_HIT_2 /* Indicates VLAN
                                                          translation lookup 2
                                                          hit. */
#define BCM_PKTIO_TRACE_VT_KEY_TYPE_1       BCMPKT_TRACE_VT_KEY_TYPE_1 /* Key type used for VLAN
                                                          translation lookup 1. */
#define BCM_PKTIO_TRACE_VT_HIT_1            BCMPKT_TRACE_VT_HIT_1 /* Indicates VLAN
                                                          translation lookup 1
                                                          hit. */
...
#define BCM_PKTIO_TRACE_HIT_BIT_INDEX       BCMPKT_TRACE_HIT_BIT_INDEX /* Index of hitbit in the
                                                          hit table. [15:0] is
                                                          the index to the hit
                                                          table, and [19:16] is
                                                          thebit position within
                                                          the entry. */
#define BCM_PKTIO_TRACE_HIT_BIT_TABLE       BCMPKT_TRACE_HIT_BIT_TABLE /* 0:
                                                          L3_DEFIP_LEVEL1_HIT,
                                                          1:
                                                          L3_DEFIP_LEVEL2_HIT,
                                                          2:
                                                          L3_DEFIP_LEVEL3_HIT. */
#define BCM_PKTIO_TRACE_SUB_DB_PRIORITY     BCMPKT_TRACE_SUB_DB_PRIORITY /* Sub DB Priority, used
...
#define BCM_PKTIO_TRACE_L3_ENTRY_SRC_HIT    BCMPKT_TRACE_L3_ENTRY_SRC_HIT /* L3 lookup destination
                                                          address source hit. */
#define BCM_PKTIO_TRACE_L3_TUNNEL_HIT_1     BCMPKT_TRACE_L3_TUNNEL_HIT_1 /* Indicates L3_TUNNEL
                                                          lookup hit. */
...
#define BCM_PKTIO_TRACE_L3_TUNNEL_KEY_TYPE_1 BCMPKT_TRACE_L3_TUNNEL_KEY_TYPE_1 /* Key type of L3_TUNNEL
                                                          lookup hit. */
#define BCM_PKTIO_TRACE_COMP_DST_HIT        BCMPKT_TRACE_COMP_DST_HIT /* Indicates LPM table
                                                          hit. */
...
#define BCM_PKTIO_TRACE_COMP_DST_SUB_DB_PRIORITY BCMPKT_TRACE_COMP_DST_SUB_DB_PRIORITY /* Sub DB Priority, used
                                                          by Level1 resolution
                                                          block. */
#define BCM_PKTIO_TRACE_COMP_SRC_HIT        BCMPKT_TRACE_COMP_SRC_HIT /* Indicates LPM table
                                                          hit. */
...
#define BCM_PKTIO_TRACE_COMP_SRC_SUB_DB_PRIORITY BCMPKT_TRACE_COMP_SRC_SUB_DB_PRIORITY /* Sub DB Priority, used
                                                          by Level1 resolution
                                                          block. */
#define BCM_PKTIO_TRACE_LPM_DST_HIT         BCMPKT_TRACE_LPM_DST_HIT /* Indicates LPM table
                                                          hit. */
...
#define BCM_PKTIO_TRACE_LPM_DST_SUB_DB_PRIORITY BCMPKT_TRACE_LPM_DST_SUB_DB_PRIORITY /* Sub DB Priority, used
                                                          by Level1 resolution
                                                          block. */
#define BCM_PKTIO_TRACE_LPM_SRC_HIT         BCMPKT_TRACE_LPM_SRC_HIT /* Indicates LPM table
                                                          hit. */
...
#define BCM_PKTIO_TRACE_MY_STATION_2_INDEX  BCMPKT_TRACE_MY_STATION_2_INDEX /* Index for
                                                          ...
                                                          hit. */
#define BCM_PKTIO_TRACE_LAG_INDICATOR       BCMPKT_TRACE_LAG_INDICATOR /* Trunked Port (LAG)
                                                          indication. */
#define BCM_PKTIO_TRACE_MY_PREFIX_TCAM_HIT  BCMPKT_TRACE_MY_PREFIX_TCAM_HIT /* MY_PREFIX TCAM hit. */
#define BCM_PKTIO_TRACE_L3_TUNNEL_TCAM_KEY_TYPE BCMPKT_TRACE_L3_TUNNEL_TCAM_KEY_TYPE /* Key type of
                                                          L3_TUNNEL_TCAM lookup
                                                          key type. */
#define BCM_PKTIO_TRACE_L3_TUNNEL_HASH_KEY_TYPE_1 BCMPKT_TRACE_L3_TUNNEL_HASH_KEY_TYPE_1 /* Key type of L3_TUNNEL
                                                          hash lookup key type. */
#define BCM_PKTIO_TRACE_FID_COUNT           BCMPKT_TRACE_FID_COUNT /* TRACE FIELD ID NUMBER */

/* BCM_PKTIO_TRACE_INCOMING_TAG_STATUS encodings. */
...
/* BCM_PKTIO_TRACE_FORWARDING_TYPE encodings. */
...
#define BCM_PKTIO_TRACE_FORWARDING_T_L3_CROSS_CONNECT BCMPKT_TRACE_FORWARDING_T_L3_CROSS_CONNECT /* L3 cross connect. */
#define BCM_PKTIO_TRACE_FORWARDING_T_L2_CROSS_CONNECT BCMPKT_TRACE_FORWARDING_T_L2_CROSS_CONNECT /* L2 cross connect. */
...
#define BCM_PKTIO_TRACE_FORWARDING_T_MPLS   BCMPKT_TRACE_FORWARDING_T_MPLS /* LSR Operation (label
                                                          ...
                                                          BOS label). */
#define BCM_PKTIO_TRACE_FORWARDING_T_GSH_TRANSIT BCMPKT_TRACE_FORWARDING_T_GSH_TRANSIT /* GSH transit. */

/* BCM_PKTIO_TRACE_FWD_DESTINATION_TYPE encodings. */
...
#define BCM_PKTIO_TRACE_FWD_DESTINATION_T_DVP BCMPKT_TRACE_FWD_DESTINATION_T_DVP /* DVP. */
#define BCM_PKTIO_TRACE_FWD_DESTINATION_T_ECMP_MEMBER -1         /* Invaid forwarding
                                                          destination type. */
#define BCM_PKTIO_TRACE_FWD_DESTINATION_T_VLAN_FLOOD -1         /* Invaid forwarding
                                                          destination type. */

/* BCM_PKTIO_TRACE_PKT_RESOLUTION_VECTOR encodings. */
...
/* Packet TRACE DROP Reason Types. */
...
#define BCM_PKTIO_TRACE_DROP_REASON_MY_STATION BCMPKT_TRACE_DROP_REASON_MY_STATION /* Drop due to my station
                                                          lookup miss. */
#define BCM_PKTIO_TRACE_DROP_REASON_PFM     BCMPKT_TRACE_DROP_REASON_PFM /* Port filtering mode
                                                          drop. */
...
#define BCM_PKTIO_TRACE_DROP_REASON_VXLAN_SIP_LOOKUP_MISS_DROP BCMPKT_TRACE_DROP_REASON_VXLAN_SIP_LOOKUP_MISS_DROP /* VXLAN SIP lookup miss
                                                          drop. */
#define BCM_PKTIO_TRACE_DROP_REASON_SVTAG_LOOKUP_MISS BCMPKT_TRACE_DROP_REASON_SVTAG_LOOKUP_MISS /* Packet dropped due to
                                                          SVTAG lookup miss. */
#define BCM_PKTIO_TRACE_DROP_REASON_L2_TUNNEL_SIP_LOOKUP_MISS_DROP BCMPKT_TRACE_DROP_REASON_L2_TUNNEL_SIP_LOOKUP_MISS_DROP /* VXLAN/SRv6_L2 SIP
                                                          lookup miss drop. */
#define BCM_PKTIO_TRACE_DROP_REASON_INVALID BCMPKT_TRACE_DROP_REASON_INVALID /* Invalid. */
#define BCM_PKTIO_TRACE_DROP_REASON_COUNT   BCMPKT_TRACE_DROP_REASON_COUNT /* TRACE DROP REASON TYPE
                                                          NUMBER */

/* Packet TRACE COUNTER Types. */
#define BCM_PKTIO_TRACE_COUNTER_RIPD4       BCMPKT_TRACE_COUNTER_RIPD4 /* L3 pkt discarded due
                                                          to resource. */
#define BCM_PKTIO_TRACE_COUNTER_RIPC4       BCMPKT_TRACE_COUNTER_RIPC4 /* Forwarded IPv4
                                                          packets. */
#define BCM_PKTIO_TRACE_COUNTER_RIPHE4      BCMPKT_TRACE_COUNTER_RIPHE4 /* IP Header Error
                                                          packets. */
#define BCM_PKTIO_TRACE_COUNTER_IMRP4       BCMPKT_TRACE_COUNTER_IMRP4 /* Routed IPv4 Muliticast
                                                          packets. */
#define BCM_PKTIO_TRACE_COUNTER_RIPD6       BCMPKT_TRACE_COUNTER_RIPD6 /* L3 pkt discarded due
                                                          to resource. */
#define BCM_PKTIO_TRACE_COUNTER_RIPC6       BCMPKT_TRACE_COUNTER_RIPC6 /* Forwarded IPv6
                                                          packets. */
#define BCM_PKTIO_TRACE_COUNTER_RIPHE6      BCMPKT_TRACE_COUNTER_RIPHE6 /* IP Header Error
                                                          packets. */
...
#define BCM_PKTIO_TRACE_COUNTER_DSFRAG      BCMPKT_TRACE_COUNTER_DSFRAG /* DOS fragment error
                                                          packets. */
#define BCM_PKTIO_TRACE_COUNTER_DSICMP      BCMPKT_TRACE_COUNTER_DSICMP /* DOS ICMP error
                                                          packets. */
#define BCM_PKTIO_TRACE_COUNTER_DSL2HE      BCMPKT_TRACE_COUNTER_DSL2HE /* Dos Attack L2 Packets. */
#define BCM_PKTIO_TRACE_COUNTER_IMBP        BCMPKT_TRACE_COUNTER_IMBP /* Bridged Multicast
                                                          pkts. */
#define BCM_PKTIO_TRACE_COUNTER_LAGLUP      BCMPKT_TRACE_COUNTER_LAGLUP /* LAG failover loopback
                                                          pkt. */
#define BCM_PKTIO_TRACE_COUNTER_LAGLUPD     BCMPKT_TRACE_COUNTER_LAGLUPD /* LAG failover loopback
                                                          pkt discarded. */
#define BCM_PKTIO_TRACE_COUNTER_MTU_CHECK_FAIL BCMPKT_TRACE_COUNTER_MTU_CHECK_FAIL /* Pkts dropped due to
                                                          MTU check fail. */
#define BCM_PKTIO_TRACE_COUNTER_PARITYD     BCMPKT_TRACE_COUNTER_PARITYD /* Pkts dropped due to
                                                          parity error. */
...
#define BCM_PKTIO_TRACE_COUNTER_RDROP       BCMPKT_TRACE_COUNTER_RDROP /* Portbitmap zero drop
                                                          condition. */
#define BCM_PKTIO_TRACE_COUNTER_RIMDR       BCMPKT_TRACE_COUNTER_RIMDR /* Multicast (L2+L3)
                                                          packets that are
                                                          dropped. */
#define BCM_PKTIO_TRACE_COUNTER_RPORTD      BCMPKT_TRACE_COUNTER_RPORTD /* Pkts dropped as
                                                          ingress port's SP
                                                          state is not
                                                          forwarding. */
...
#define BCM_PKTIO_TRACE_COUNTER_SRC_PORT_KNOCKOUT_DROP BCMPKT_TRACE_COUNTER_SRC_PORT_KNOCKOUT_DROP /* Drop due to source
                                                          port knockout. */
#define BCM_PKTIO_TRACE_COUNTER_RDISC       BCMPKT_TRACE_COUNTER_RDISC /* IBP discard and CBP
                                                          full. */
#define BCM_PKTIO_TRACE_COUNTER_RFILDR      BCMPKT_TRACE_COUNTER_RFILDR /* Packets dropped by FP. */
#define BCM_PKTIO_TRACE_COUNTER_IRPSE       BCMPKT_TRACE_COUNTER_IRPSE /* HiGig IPIC pause
                                                          receive counter. */
...
#define BCM_PKTIO_TRACE_COUNTER_DSL3HE      BCMPKT_TRACE_COUNTER_DSL3HE /* DOS L3 header error
                                                          ...
                                                          from 10GE port). */
#define BCM_PKTIO_TRACE_COUNTER_IUNKHDR     BCMPKT_TRACE_COUNTER_IUNKHDR /* Unknown HiGig header
                                                          type packet (only
                                                          applicable to packet
                                                          from HiGig port). */
#define BCM_PKTIO_TRACE_COUNTER_DSL4HE      BCMPKT_TRACE_COUNTER_DSL4HE /* DOS L4 header error
                                                          ...
                                                          applicable to packet
                                                          from 10GE port). */
#define BCM_PKTIO_TRACE_COUNTER_IMIRROR     BCMPKT_TRACE_COUNTER_IMIRROR /* HiGig mirror packet
                                                          (only applicable to
                                                          packet from HiGig
                                                          port). */
#define BCM_PKTIO_TRACE_COUNTER_MTUERR      BCMPKT_TRACE_COUNTER_MTUERR /* Packets trapped to CPU
                                                          due to egress L3 MTU
                                                          violation. */
#define BCM_PKTIO_TRACE_COUNTER_VLANDR      BCMPKT_TRACE_COUNTER_VLANDR /* Receive VLAN drop
                                                          cases. */
...
#define BCM_PKTIO_TRACE_COUNTER_RHGUC       BCMPKT_TRACE_COUNTER_RHGUC /* Receive HiGig Unicast
                                                          packet. */
#define BCM_PKTIO_TRACE_COUNTER_RHGMC       BCMPKT_TRACE_COUNTER_RHGMC /* Receive HiGig
                                                          non-Unicast packet. */
...
#define BCM_PKTIO_TRACE_COUNTER_DSTDISC     BCMPKT_TRACE_COUNTER_DSTDISC /* L2/L3 lookup
                                                          DST_DISCARD drop. */
#define BCM_PKTIO_TRACE_COUNTER_CBLDROP     BCMPKT_TRACE_COUNTER_CBLDROP /* Class based learning
                                                          drop. */
...
#define BCM_PKTIO_TRACE_COUNTER_COUNT       BCMPKT_TRACE_COUNTER_COUNT /* TRACE COUNTER TYPE
                                                          NUMBER */
...
#define BCM_PKTIO_TRACE_DOP_IFTA10_I1T_00_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT BCMPKT_TRACE_DOP_IFTA10_I1T_00_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT /* IFTA10_I1T_00_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_IFTA10_I1T_00_INDEX_DOP_LKP0_LTPR_WIN BCMPKT_TRACE_DOP_IFTA10_I1T_00_INDEX_DOP_LKP0_LTPR_WIN /* IFTA10_I1T_00_INDEX_DOP_LKP0_LTPR_WIN. */
...
#define BCM_PKTIO_TRACE_DOP_IFTA20_I1T_00_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT BCMPKT_TRACE_DOP_IFTA20_I1T_00_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT /* IFTA20_I1T_00_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_IFTA20_I1T_00_INDEX_DOP_LKP0_LTPR_WIN BCMPKT_TRACE_DOP_IFTA20_I1T_00_INDEX_DOP_LKP0_LTPR_WIN /* IFTA20_I1T_00_INDEX_DOP_LKP0_LTPR_WIN. */
...
#define BCM_PKTIO_TRACE_DOP_IFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE /* IFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA BCMPKT_TRACE_DOP_IFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA /* IFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA. */
#define BCM_PKTIO_TRACE_DOP_IFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH /* IFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE /* IFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH /* IFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA30_E2T_00_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT BCMPKT_TRACE_DOP_IFTA30_E2T_00_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT /* IFTA30_E2T_00_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT. */
...
#define BCM_PKTIO_TRACE_DOP_IFTA40_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA40_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA40_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA40_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE /* IFTA40_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA BCMPKT_TRACE_DOP_IFTA40_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA /* IFTA40_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_E2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA40_E2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH /* IFTA40_E2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_E2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA40_E2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA40_E2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_E2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA40_E2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE /* IFTA40_E2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_E2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA40_E2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH /* IFTA40_E2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_E2T_00_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT BCMPKT_TRACE_DOP_IFTA40_E2T_00_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT /* IFTA40_E2T_00_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_E2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA40_E2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA40_E2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_E2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA40_E2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE /* IFTA40_E2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_E2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA BCMPKT_TRACE_DOP_IFTA40_E2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA /* IFTA40_E2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_E2T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA40_E2T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH /* IFTA40_E2T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_E2T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA40_E2T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA40_E2T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_E2T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA40_E2T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE /* IFTA40_E2T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_E2T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA40_E2T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH /* IFTA40_E2T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_E2T_01_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT BCMPKT_TRACE_DOP_IFTA40_E2T_01_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT /* IFTA40_E2T_01_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_E2T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA40_E2T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA40_E2T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_E2T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA40_E2T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE /* IFTA40_E2T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_E2T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA BCMPKT_TRACE_DOP_IFTA40_E2T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA /* IFTA40_E2T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_E2T_02_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA40_E2T_02_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH /* IFTA40_E2T_02_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_E2T_02_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA40_E2T_02_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA40_E2T_02_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_E2T_02_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA40_E2T_02_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE /* IFTA40_E2T_02_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_E2T_02_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA40_E2T_02_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH /* IFTA40_E2T_02_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_E2T_02_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT BCMPKT_TRACE_DOP_IFTA40_E2T_02_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT /* IFTA40_E2T_02_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT. */
...
#define BCM_PKTIO_TRACE_DOP_IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE /* IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA BCMPKT_TRACE_DOP_IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA /* IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH /* IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE /* IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH /* IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_KEY_TYPE /* IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_2_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_2_TCAM_MATCH /* IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_2_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_KEY_TYPE /* IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_3_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_3_TCAM_MATCH /* IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_3_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_T4T_00_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT BCMPKT_TRACE_DOP_IFTA40_T4T_00_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT /* IFTA40_T4T_00_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE /* IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA BCMPKT_TRACE_DOP_IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA /* IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH /* IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE /* IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH /* IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_KEY_TYPE /* IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_2_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_2_TCAM_MATCH /* IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_2_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_KEY_TYPE /* IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_3_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_3_TCAM_MATCH /* IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_3_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA40_T4T_01_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT BCMPKT_TRACE_DOP_IFTA40_T4T_01_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT /* IFTA40_T4T_01_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT. */
...
#define BCM_PKTIO_TRACE_DOP_IFTA50_I1T_00_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT BCMPKT_TRACE_DOP_IFTA50_I1T_00_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT /* IFTA50_I1T_00_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_IFTA50_I1T_00_INDEX_DOP_LKP0_LTPR_WIN BCMPKT_TRACE_DOP_IFTA50_I1T_00_INDEX_DOP_LKP0_LTPR_WIN /* IFTA50_I1T_00_INDEX_DOP_LKP0_LTPR_WIN. */
#define BCM_PKTIO_TRACE_DOP_IFTA50_I1T_01_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT BCMPKT_TRACE_DOP_IFTA50_I1T_01_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT /* IFTA50_I1T_01_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_IFTA50_I1T_01_INDEX_DOP_LKP0_LTPR_WIN BCMPKT_TRACE_DOP_IFTA50_I1T_01_INDEX_DOP_LKP0_LTPR_WIN /* IFTA50_I1T_01_INDEX_DOP_LKP0_LTPR_WIN. */
...
#define BCM_PKTIO_TRACE_DOP_IFTA60_I1T_00_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT BCMPKT_TRACE_DOP_IFTA60_I1T_00_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT /* IFTA60_I1T_00_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_IFTA60_I1T_00_INDEX_DOP_LKP0_LTPR_WIN BCMPKT_TRACE_DOP_IFTA60_I1T_00_INDEX_DOP_LKP0_LTPR_WIN /* IFTA60_I1T_00_INDEX_DOP_LKP0_LTPR_WIN. */
#define BCM_PKTIO_TRACE_DOP_IFTA60_I1T_01_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT BCMPKT_TRACE_DOP_IFTA60_I1T_01_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT /* IFTA60_I1T_01_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_IFTA60_I1T_01_INDEX_DOP_LKP0_LTPR_WIN BCMPKT_TRACE_DOP_IFTA60_I1T_01_INDEX_DOP_LKP0_LTPR_WIN /* IFTA60_I1T_01_INDEX_DOP_LKP0_LTPR_WIN. */
#define BCM_PKTIO_TRACE_DOP_IFTA60_I1T_02_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT BCMPKT_TRACE_DOP_IFTA60_I1T_02_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT /* IFTA60_I1T_02_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_IFTA60_I1T_02_INDEX_DOP_LKP0_LTPR_WIN BCMPKT_TRACE_DOP_IFTA60_I1T_02_INDEX_DOP_LKP0_LTPR_WIN /* IFTA60_I1T_02_INDEX_DOP_LKP0_LTPR_WIN. */
#define BCM_PKTIO_TRACE_DOP_IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE /* IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA BCMPKT_TRACE_DOP_IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA /* IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA. */
#define BCM_PKTIO_TRACE_DOP_IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH /* IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE /* IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH /* IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_KEY_TYPE /* IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_2_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_2_TCAM_MATCH /* IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_2_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_KEY_TYPE /* IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_3_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_3_TCAM_MATCH /* IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_3_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA60_T4T_00_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT BCMPKT_TRACE_DOP_IFTA60_T4T_00_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT /* IFTA60_T4T_00_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_1_KEY_DOP_MEM0_1_KEY BCMPKT_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_1_KEY_DOP_MEM0_1_KEY /* MEMDB_TCAM_IFTA60_MEM0_1_KEY_DOP_MEM0_1_KEY. */
#define BCM_PKTIO_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_1_KEY_DOP_MEM0_1_PKT_RD BCMPKT_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_1_KEY_DOP_MEM0_1_PKT_RD /* MEMDB_TCAM_IFTA60_MEM0_1_KEY_DOP_MEM0_1_PKT_RD. */
#define BCM_PKTIO_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_3_KEY_DOP_MEM0_1_KEY BCMPKT_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_3_KEY_DOP_MEM0_1_KEY /* MEMDB_TCAM_IFTA60_MEM0_3_KEY_DOP_MEM0_1_KEY. */
#define BCM_PKTIO_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_3_KEY_DOP_MEM0_1_PKT_RD BCMPKT_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_3_KEY_DOP_MEM0_1_PKT_RD /* MEMDB_TCAM_IFTA60_MEM0_3_KEY_DOP_MEM0_1_PKT_RD. */
#define BCM_PKTIO_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_2_KEY_DOP_MEM0_1_KEY BCMPKT_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_2_KEY_DOP_MEM0_1_KEY /* MEMDB_TCAM_IFTA60_MEM0_2_KEY_DOP_MEM0_1_KEY. */
#define BCM_PKTIO_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_2_KEY_DOP_MEM0_1_PKT_RD BCMPKT_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_2_KEY_DOP_MEM0_1_PKT_RD /* MEMDB_TCAM_IFTA60_MEM0_2_KEY_DOP_MEM0_1_PKT_RD. */
#define BCM_PKTIO_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_0_KEY_DOP_MEM0_1_KEY BCMPKT_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_0_KEY_DOP_MEM0_1_KEY /* MEMDB_TCAM_IFTA60_MEM0_0_KEY_DOP_MEM0_1_KEY. */
#define BCM_PKTIO_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_0_KEY_DOP_MEM0_1_PKT_RD BCMPKT_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_0_KEY_DOP_MEM0_1_PKT_RD /* MEMDB_TCAM_IFTA60_MEM0_0_KEY_DOP_MEM0_1_PKT_RD. */
#define BCM_PKTIO_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_0_MATCH_INDEX BCMPKT_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_0_MATCH_INDEX /* MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_0_MATCH_INDEX. */
#define BCM_PKTIO_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_0_TCAM_MATCH BCMPKT_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_0_TCAM_MATCH /* MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_0_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_0_TCAM_INDEX BCMPKT_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_0_TCAM_INDEX /* MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_0_TCAM_INDEX. */
#define BCM_PKTIO_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_1_MATCH_INDEX BCMPKT_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_1_MATCH_INDEX /* MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_1_MATCH_INDEX. */
#define BCM_PKTIO_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_1_TCAM_INDEX BCMPKT_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_1_TCAM_INDEX /* MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_1_TCAM_INDEX. */
#define BCM_PKTIO_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_1_TCAM_MATCH BCMPKT_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_1_TCAM_MATCH /* MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_1_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_2_MATCH_INDEX BCMPKT_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_2_MATCH_INDEX /* MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_2_MATCH_INDEX. */
#define BCM_PKTIO_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_2_TCAM_INDEX BCMPKT_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_2_TCAM_INDEX /* MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_2_TCAM_INDEX. */
#define BCM_PKTIO_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_2_TCAM_MATCH BCMPKT_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_2_TCAM_MATCH /* MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_2_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_3_MATCH_INDEX BCMPKT_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_3_MATCH_INDEX /* MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_3_MATCH_INDEX. */
#define BCM_PKTIO_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_3_TCAM_INDEX BCMPKT_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_3_TCAM_INDEX /* MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_3_TCAM_INDEX. */
#define BCM_PKTIO_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_3_TCAM_MATCH BCMPKT_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_3_TCAM_MATCH /* MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP_MEM0_3_TCAM_MATCG. */
#define BCM_PKTIO_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_3_KEY_DOP_MEM0_3_KEY BCMPKT_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_3_KEY_DOP_MEM0_3_KEY /* MEMDB_TCAM_IFTA60_MEM0_3_KEY_DOP_MEM0_3_KEY. */
#define BCM_PKTIO_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_3_KEY_DOP_MEM0_3_PKT_RD BCMPKT_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_3_KEY_DOP_MEM0_3_PKT_RD /* MEMDB_TCAM_IFTA60_MEM0_3_KEY_DOP_MEM0_3_PKT_RD. */
#define BCM_PKTIO_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_0_KEY_DOP_MEM0_0_KEY BCMPKT_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_0_KEY_DOP_MEM0_0_KEY /* MEMDB_TCAM_IFTA60_MEM0_0_KEY_DOP_MEM0_0_KEY. */
#define BCM_PKTIO_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_0_KEY_DOP_MEM0_0_PKT_RD BCMPKT_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_0_KEY_DOP_MEM0_0_PKT_RD /* MEMDB_TCAM_IFTA60_MEM0_0_KEY_DOP_MEM0_0_PKT_RD. */
#define BCM_PKTIO_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_2_KEY_DOP_MEM0_2_KEY BCMPKT_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_2_KEY_DOP_MEM0_2_KEY /* MEMDB_TCAM_IFTA60_MEM0_2_KEY_DOP_MEM0_2_KEY. */
#define BCM_PKTIO_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_2_KEY_DOP_MEM0_2_PKT_RD BCMPKT_TRACE_DOP_MEMDB_TCAM_IFTA60_MEM0_2_KEY_DOP_MEM0_2_PKT_RD /* MEMDB_TCAM_IFTA60_MEM0_2_KEY_DOP_MEM0_2_PKT_RD. */
...
#define BCM_PKTIO_TRACE_DOP_IFTA70_I1T_00_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT BCMPKT_TRACE_DOP_IFTA70_I1T_00_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT /* IFTA70_I1T_00_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_IFTA70_I1T_00_INDEX_DOP_LKP0_LTPR_WIN BCMPKT_TRACE_DOP_IFTA70_I1T_00_INDEX_DOP_LKP0_LTPR_WIN /* IFTA70_I1T_00_INDEX_DOP_LKP0_LTPR_WIN. */
#define BCM_PKTIO_TRACE_DOP_IFTA70_I1T_01_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT BCMPKT_TRACE_DOP_IFTA70_I1T_01_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT /* IFTA70_I1T_01_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_IFTA70_I1T_01_INDEX_DOP_LKP0_LTPR_WIN BCMPKT_TRACE_DOP_IFTA70_I1T_01_INDEX_DOP_LKP0_LTPR_WIN /* IFTA70_I1T_01_INDEX_DOP_LKP0_LTPR_WIN. */
...
#define BCM_PKTIO_TRACE_DOP_IFTA80_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA80_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA80_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA80_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE /* IFTA80_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA BCMPKT_TRACE_DOP_IFTA80_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA /* IFTA80_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_E2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA80_E2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH /* IFTA80_E2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_E2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA80_E2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA80_E2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_E2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA80_E2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE /* IFTA80_E2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_E2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA80_E2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH /* IFTA80_E2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_E2T_00_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT BCMPKT_TRACE_DOP_IFTA80_E2T_00_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT /* IFTA80_E2T_00_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_E2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA80_E2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA80_E2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_E2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA80_E2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE /* IFTA80_E2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_E2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA BCMPKT_TRACE_DOP_IFTA80_E2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA /* IFTA80_E2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_E2T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA80_E2T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH /* IFTA80_E2T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_E2T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA80_E2T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA80_E2T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_E2T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA80_E2T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE /* IFTA80_E2T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_E2T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA80_E2T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH /* IFTA80_E2T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_E2T_01_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT BCMPKT_TRACE_DOP_IFTA80_E2T_01_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT /* IFTA80_E2T_01_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_E2T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA80_E2T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA80_E2T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_E2T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA80_E2T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE /* IFTA80_E2T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_E2T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA BCMPKT_TRACE_DOP_IFTA80_E2T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA /* IFTA80_E2T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_E2T_02_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA80_E2T_02_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH /* IFTA80_E2T_02_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_E2T_02_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA80_E2T_02_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA80_E2T_02_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_E2T_02_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA80_E2T_02_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE /* IFTA80_E2T_02_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_E2T_02_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA80_E2T_02_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH /* IFTA80_E2T_02_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_E2T_02_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT BCMPKT_TRACE_DOP_IFTA80_E2T_02_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT /* IFTA80_E2T_02_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_E2T_03_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA80_E2T_03_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA80_E2T_03_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_E2T_03_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA80_E2T_03_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE /* IFTA80_E2T_03_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_E2T_03_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA BCMPKT_TRACE_DOP_IFTA80_E2T_03_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA /* IFTA80_E2T_03_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_E2T_03_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA80_E2T_03_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH /* IFTA80_E2T_03_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_E2T_03_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA80_E2T_03_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA80_E2T_03_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_E2T_03_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA80_E2T_03_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE /* IFTA80_E2T_03_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_E2T_03_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA80_E2T_03_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH /* IFTA80_E2T_03_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_E2T_03_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT BCMPKT_TRACE_DOP_IFTA80_E2T_03_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT /* IFTA80_E2T_03_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT. */
...
#define BCM_PKTIO_TRACE_DOP_IFTA80_T2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA80_T2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA80_T2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_T2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA80_T2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE /* IFTA80_T2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_T2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA BCMPKT_TRACE_DOP_IFTA80_T2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA /* IFTA80_T2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_T2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA80_T2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH /* IFTA80_T2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_T2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA80_T2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA80_T2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_T2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA80_T2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE /* IFTA80_T2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_T2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA80_T2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH /* IFTA80_T2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_T2T_00_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT BCMPKT_TRACE_DOP_IFTA80_T2T_00_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT /* IFTA80_T2T_00_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_T2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA80_T2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA80_T2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_T2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA80_T2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE /* IFTA80_T2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_T2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA BCMPKT_TRACE_DOP_IFTA80_T2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA /* IFTA80_T2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_T2T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA80_T2T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH /* IFTA80_T2T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_T2T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA80_T2T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA80_T2T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_T2T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA80_T2T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE /* IFTA80_T2T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_T2T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA80_T2T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH /* IFTA80_T2T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA80_T2T_01_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT BCMPKT_TRACE_DOP_IFTA80_T2T_01_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT /* IFTA80_T2T_01_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT. */
...
#define BCM_PKTIO_TRACE_DOP_FLEX_QOS_PHB_LTS_TCAM_INDEX_DOP_LTS_TCAM_POLICY_DATA BCMPKT_TRACE_DOP_FLEX_QOS_PHB_LTS_TCAM_INDEX_DOP_LTS_TCAM_POLICY_DATA /* FLEX_QOS_PHB_LTS_TCAM_INDEX_DOP_LTS_TCAM_POLICY_DATA. */
#define BCM_PKTIO_TRACE_DOP_FLEX_QOS_PHB_LTS_TCAM_INDEX_DOP_LTS_TCAM_POLICY_DATA_HIT_INDEX BCMPKT_TRACE_DOP_FLEX_QOS_PHB_LTS_TCAM_INDEX_DOP_LTS_TCAM_POLICY_DATA_HIT_INDEX /* FLEX_QOS_PHB_LTS_TCAM_INDEX_DOP_LTS_TCAM_POLICY_DATA_HIT_INDEX. */
#define BCM_PKTIO_TRACE_DOP_FLEX_QOS_PHB2_LTS_TCAM_KEY_DOP_LTS_TCAM_KEY BCMPKT_TRACE_DOP_FLEX_QOS_PHB2_LTS_TCAM_KEY_DOP_LTS_TCAM_KEY /* FLEX_QOS_PHB2_LTS_TCAM_KEY_DOP_LTS_TCAM_KEY. */
#define BCM_PKTIO_TRACE_DOP_FLEX_QOS_PHB2_LTS_TCAM_INDEX_DOP_LTS_TCAM_TCAM_MATCH BCMPKT_TRACE_DOP_FLEX_QOS_PHB2_LTS_TCAM_INDEX_DOP_LTS_TCAM_TCAM_MATCH /* FLEX_QOS_PHB2_LTS_TCAM_INDEX_DOP_LTS_TCAM_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_FLEX_QOS_PHB2_LTS_TCAM_INDEX_DOP_LTS_TCAM_POLICY_DATA BCMPKT_TRACE_DOP_FLEX_QOS_PHB2_LTS_TCAM_INDEX_DOP_LTS_TCAM_POLICY_DATA /* FLEX_QOS_PHB2_LTS_TCAM_INDEX_DOP_LTS_TCAM_POLICY_DATA. */
#define BCM_PKTIO_TRACE_DOP_FLEX_QOS_PHB2_LTS_TCAM_INDEX_DOP_LTS_TCAM_POLICY_DATA_HIT_INDEX BCMPKT_TRACE_DOP_FLEX_QOS_PHB2_LTS_TCAM_INDEX_DOP_LTS_TCAM_POLICY_DATA_HIT_INDEX /* FLEX_QOS_PHB2_LTS_TCAM_INDEX_DOP_LTS_TCAM_POLICY_DATA_HIT_INDEX. */
...
#define BCM_PKTIO_TRACE_DOP_IFTA90_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA90_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA90_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA90_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA90_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE /* IFTA90_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA90_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA BCMPKT_TRACE_DOP_IFTA90_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA /* IFTA90_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA. */
#define BCM_PKTIO_TRACE_DOP_IFTA90_E2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA90_E2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH /* IFTA90_E2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA90_E2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA90_E2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA90_E2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA90_E2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA90_E2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE /* IFTA90_E2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA90_E2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA90_E2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH /* IFTA90_E2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA90_E2T_00_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT BCMPKT_TRACE_DOP_IFTA90_E2T_00_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT /* IFTA90_E2T_00_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_IFTA90_E2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA90_E2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA90_E2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA90_E2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA90_E2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE /* IFTA90_E2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA90_E2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA BCMPKT_TRACE_DOP_IFTA90_E2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA /* IFTA90_E2T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA. */
#define BCM_PKTIO_TRACE_DOP_IFTA90_E2T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA90_E2T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH /* IFTA90_E2T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA90_E2T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA90_E2T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA90_E2T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA90_E2T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA90_E2T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE /* IFTA90_E2T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA90_E2T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA90_E2T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH /* IFTA90_E2T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA90_E2T_01_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT BCMPKT_TRACE_DOP_IFTA90_E2T_01_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT /* IFTA90_E2T_01_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_IFTA90_E2T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA90_E2T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA90_E2T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA90_E2T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA90_E2T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE /* IFTA90_E2T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA90_E2T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA BCMPKT_TRACE_DOP_IFTA90_E2T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA /* IFTA90_E2T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA. */
#define BCM_PKTIO_TRACE_DOP_IFTA90_E2T_02_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA90_E2T_02_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH /* IFTA90_E2T_02_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA90_E2T_02_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA90_E2T_02_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA90_E2T_02_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA90_E2T_02_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA90_E2T_02_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE /* IFTA90_E2T_02_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA90_E2T_02_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA90_E2T_02_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH /* IFTA90_E2T_02_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA90_E2T_02_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT BCMPKT_TRACE_DOP_IFTA90_E2T_02_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT /* IFTA90_E2T_02_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_IFTA90_E2T_03_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA90_E2T_03_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA90_E2T_03_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA90_E2T_03_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA90_E2T_03_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE /* IFTA90_E2T_03_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA90_E2T_03_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA BCMPKT_TRACE_DOP_IFTA90_E2T_03_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA /* IFTA90_E2T_03_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA. */
#define BCM_PKTIO_TRACE_DOP_IFTA90_E2T_03_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA90_E2T_03_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH /* IFTA90_E2T_03_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA90_E2T_03_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA90_E2T_03_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA90_E2T_03_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA90_E2T_03_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA90_E2T_03_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE /* IFTA90_E2T_03_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA90_E2T_03_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA90_E2T_03_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH /* IFTA90_E2T_03_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA90_E2T_03_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT BCMPKT_TRACE_DOP_IFTA90_E2T_03_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT /* IFTA90_E2T_03_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT. */
...
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_ING0_COUNTER_B_DOP_BUS_COUNTER_B0 BCMPKT_TRACE_DOP_FLEX_CTR_ST_ING0_COUNTER_B_DOP_BUS_COUNTER_B0 /* FLEX_CTR_ST_ING0_COUNTER_B_DOP_BUS_COUNTER_B0. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_ING0_COUNTER_B_DOP_BUS_COUNTER_B1 BCMPKT_TRACE_DOP_FLEX_CTR_ST_ING0_COUNTER_B_DOP_BUS_COUNTER_B1 /* FLEX_CTR_ST_ING0_COUNTER_B_DOP_BUS_COUNTER_B1. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_ING0_COUNTER_B_DOP_BUS_COUNTER_B2 BCMPKT_TRACE_DOP_FLEX_CTR_ST_ING0_COUNTER_B_DOP_BUS_COUNTER_B2 /* FLEX_CTR_ST_ING0_COUNTER_B_DOP_BUS_COUNTER_B2. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_ING0_COUNTER_B_DOP_BUS_COUNTER_B3 BCMPKT_TRACE_DOP_FLEX_CTR_ST_ING0_COUNTER_B_DOP_BUS_COUNTER_B3 /* FLEX_CTR_ST_ING0_COUNTER_B_DOP_BUS_COUNTER_B3. */
...
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_ING0_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_0 BCMPKT_TRACE_DOP_FLEX_CTR_ST_ING0_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_0 /* FLEX_CTR_ST_ING0_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_0. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_ING0_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_1 BCMPKT_TRACE_DOP_FLEX_CTR_ST_ING0_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_1 /* FLEX_CTR_ST_ING0_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_1. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_ING0_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_2 BCMPKT_TRACE_DOP_FLEX_CTR_ST_ING0_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_2 /* FLEX_CTR_ST_ING0_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_2. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_ING0_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_3 BCMPKT_TRACE_DOP_FLEX_CTR_ST_ING0_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_3 /* FLEX_CTR_ST_ING0_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_3. */
...
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_ING0_COUNTER_A_DOP_BUS_COUNTER_A0 BCMPKT_TRACE_DOP_FLEX_CTR_ST_ING0_COUNTER_A_DOP_BUS_COUNTER_A0 /* FLEX_CTR_ST_ING0_COUNTER_A_DOP_BUS_COUNTER_A0. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_ING0_COUNTER_A_DOP_BUS_COUNTER_A1 BCMPKT_TRACE_DOP_FLEX_CTR_ST_ING0_COUNTER_A_DOP_BUS_COUNTER_A1 /* FLEX_CTR_ST_ING0_COUNTER_A_DOP_BUS_COUNTER_A1. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_ING0_COUNTER_A_DOP_BUS_COUNTER_A2 BCMPKT_TRACE_DOP_FLEX_CTR_ST_ING0_COUNTER_A_DOP_BUS_COUNTER_A2 /* FLEX_CTR_ST_ING0_COUNTER_A_DOP_BUS_COUNTER_A2. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_ING0_COUNTER_A_DOP_BUS_COUNTER_A3 BCMPKT_TRACE_DOP_FLEX_CTR_ST_ING0_COUNTER_A_DOP_BUS_COUNTER_A3 /* FLEX_CTR_ST_ING0_COUNTER_A_DOP_BUS_COUNTER_A3. */
...
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE /* IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA BCMPKT_TRACE_DOP_IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA /* IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH /* IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE /* IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH /* IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_KEY_TYPE /* IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_2_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_2_TCAM_MATCH /* IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_2_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_KEY_TYPE /* IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_3_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_3_TCAM_MATCH /* IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_3_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_00_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT BCMPKT_TRACE_DOP_IFTA100_T4T_00_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT /* IFTA100_T4T_00_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE /* IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA BCMPKT_TRACE_DOP_IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA /* IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH /* IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE /* IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH /* IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_KEY_TYPE /* IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_2_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_2_TCAM_MATCH /* IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_2_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_KEY_TYPE /* IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_3_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_3_TCAM_MATCH /* IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP_LTS_TCAM_3_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_01_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT BCMPKT_TRACE_DOP_IFTA100_T4T_01_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT /* IFTA100_T4T_01_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE /* IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA BCMPKT_TRACE_DOP_IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA /* IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH /* IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE /* IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH /* IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_KEY_TYPE /* IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LTS_TCAM_2_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LTS_TCAM_2_TCAM_MATCH /* IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LTS_TCAM_2_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_KEY_TYPE /* IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LTS_TCAM_3_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LTS_TCAM_3_TCAM_MATCH /* IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP_LTS_TCAM_3_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA100_T4T_02_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT BCMPKT_TRACE_DOP_IFTA100_T4T_02_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT /* IFTA100_T4T_02_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT. */
...
#define BCM_PKTIO_TRACE_DOP_IFTA130_I1T_00_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT BCMPKT_TRACE_DOP_IFTA130_I1T_00_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT /* IFTA130_I1T_00_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_IFTA130_I1T_00_INDEX_DOP_LKP0_LTPR_WIN BCMPKT_TRACE_DOP_IFTA130_I1T_00_INDEX_DOP_LKP0_LTPR_WIN /* IFTA130_I1T_00_INDEX_DOP_LKP0_LTPR_WIN. */
#define BCM_PKTIO_TRACE_DOP_IFTA130_I1T_01_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT BCMPKT_TRACE_DOP_IFTA130_I1T_01_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT /* IFTA130_I1T_01_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_IFTA130_I1T_01_INDEX_DOP_LKP0_LTPR_WIN BCMPKT_TRACE_DOP_IFTA130_I1T_01_INDEX_DOP_LKP0_LTPR_WIN /* IFTA130_I1T_01_INDEX_DOP_LKP0_LTPR_WIN. */
#define BCM_PKTIO_TRACE_DOP_IFTA130_I1T_02_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT BCMPKT_TRACE_DOP_IFTA130_I1T_02_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT /* IFTA130_I1T_02_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_IFTA130_I1T_02_INDEX_DOP_LKP0_LTPR_WIN BCMPKT_TRACE_DOP_IFTA130_I1T_02_INDEX_DOP_LKP0_LTPR_WIN /* IFTA130_I1T_02_INDEX_DOP_LKP0_LTPR_WIN. */
#define BCM_PKTIO_TRACE_DOP_IFTA130_I1T_03_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT BCMPKT_TRACE_DOP_IFTA130_I1T_03_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT /* IFTA130_I1T_03_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_IFTA130_I1T_03_INDEX_DOP_LKP0_LTPR_WIN BCMPKT_TRACE_DOP_IFTA130_I1T_03_INDEX_DOP_LKP0_LTPR_WIN /* IFTA130_I1T_03_INDEX_DOP_LKP0_LTPR_WIN. */
...
#define BCM_PKTIO_TRACE_DOP_IFTA140_I1T_00_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT BCMPKT_TRACE_DOP_IFTA140_I1T_00_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT /* IFTA140_I1T_00_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_IFTA140_I1T_00_INDEX_DOP_LKP0_LTPR_WIN BCMPKT_TRACE_DOP_IFTA140_I1T_00_INDEX_DOP_LKP0_LTPR_WIN /* IFTA140_I1T_00_INDEX_DOP_LKP0_LTPR_WIN. */
...
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_ING1_COUNTER_B_DOP_BUS_COUNTER_B0 BCMPKT_TRACE_DOP_FLEX_CTR_ST_ING1_COUNTER_B_DOP_BUS_COUNTER_B0 /* FLEX_CTR_ST_ING1_COUNTER_B_DOP_BUS_COUNTER_B0. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_ING1_COUNTER_B_DOP_BUS_COUNTER_B1 BCMPKT_TRACE_DOP_FLEX_CTR_ST_ING1_COUNTER_B_DOP_BUS_COUNTER_B1 /* FLEX_CTR_ST_ING1_COUNTER_B_DOP_BUS_COUNTER_B1. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_ING1_COUNTER_B_DOP_BUS_COUNTER_B2 BCMPKT_TRACE_DOP_FLEX_CTR_ST_ING1_COUNTER_B_DOP_BUS_COUNTER_B2 /* FLEX_CTR_ST_ING1_COUNTER_B_DOP_BUS_COUNTER_B2. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_ING1_COUNTER_B_DOP_BUS_COUNTER_B3 BCMPKT_TRACE_DOP_FLEX_CTR_ST_ING1_COUNTER_B_DOP_BUS_COUNTER_B3 /* FLEX_CTR_ST_ING1_COUNTER_B_DOP_BUS_COUNTER_B3. */
...
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_ING1_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_0 BCMPKT_TRACE_DOP_FLEX_CTR_ST_ING1_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_0 /* FLEX_CTR_ST_ING1_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_0. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_ING1_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_1 BCMPKT_TRACE_DOP_FLEX_CTR_ST_ING1_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_1 /* FLEX_CTR_ST_ING1_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_1. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_ING1_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_2 BCMPKT_TRACE_DOP_FLEX_CTR_ST_ING1_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_2 /* FLEX_CTR_ST_ING1_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_2. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_ING1_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_3 BCMPKT_TRACE_DOP_FLEX_CTR_ST_ING1_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_3 /* FLEX_CTR_ST_ING1_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_3. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_ING1_COUNTER_A_DOP_BUS_COUNTER_A0 BCMPKT_TRACE_DOP_FLEX_CTR_ST_ING1_COUNTER_A_DOP_BUS_COUNTER_A0 /* FLEX_CTR_ST_ING1_COUNTER_A_DOP_BUS_COUNTER_A0. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_ING1_COUNTER_A_DOP_BUS_COUNTER_A1 BCMPKT_TRACE_DOP_FLEX_CTR_ST_ING1_COUNTER_A_DOP_BUS_COUNTER_A1 /* FLEX_CTR_ST_ING1_COUNTER_A_DOP_BUS_COUNTER_A1. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_ING1_COUNTER_A_DOP_BUS_COUNTER_A2 BCMPKT_TRACE_DOP_FLEX_CTR_ST_ING1_COUNTER_A_DOP_BUS_COUNTER_A2 /* FLEX_CTR_ST_ING1_COUNTER_A_DOP_BUS_COUNTER_A2. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_ING1_COUNTER_A_DOP_BUS_COUNTER_A3 BCMPKT_TRACE_DOP_FLEX_CTR_ST_ING1_COUNTER_A_DOP_BUS_COUNTER_A3 /* FLEX_CTR_ST_ING1_COUNTER_A_DOP_BUS_COUNTER_A3. */
...
#define BCM_PKTIO_TRACE_DOP_IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE /* IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA BCMPKT_TRACE_DOP_IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA /* IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA. */
#define BCM_PKTIO_TRACE_DOP_IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH /* IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE /* IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH /* IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_KEY_TYPE /* IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_2_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_2_TCAM_MATCH /* IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_2_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_KEY_TYPE /* IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_3_TCAM_MATCH BCMPKT_TRACE_DOP_IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_3_TCAM_MATCH /* IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_3_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_IFTA150_T4T_00_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT BCMPKT_TRACE_DOP_IFTA150_T4T_00_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT /* IFTA150_T4T_00_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT. */
...
#define BCM_PKTIO_TRACE_DOP_EFTA10_I1T_00_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT BCMPKT_TRACE_DOP_EFTA10_I1T_00_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT /* EFTA10_I1T_00_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_EFTA10_I1T_00_INDEX_DOP_LKP0_LTPR_WIN BCMPKT_TRACE_DOP_EFTA10_I1T_00_INDEX_DOP_LKP0_LTPR_WIN /* EFTA10_I1T_00_INDEX_DOP_LKP0_LTPR_WIN. */
#define BCM_PKTIO_TRACE_DOP_EFTA10_I1T_01_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT BCMPKT_TRACE_DOP_EFTA10_I1T_01_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT /* EFTA10_I1T_01_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_EFTA10_I1T_01_INDEX_DOP_LKP0_LTPR_WIN BCMPKT_TRACE_DOP_EFTA10_I1T_01_INDEX_DOP_LKP0_LTPR_WIN /* EFTA10_I1T_01_INDEX_DOP_LKP0_LTPR_WIN. */
#define BCM_PKTIO_TRACE_DOP_EFTA10_I1T_02_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT BCMPKT_TRACE_DOP_EFTA10_I1T_02_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT /* EFTA10_I1T_02_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_EFTA10_I1T_02_INDEX_DOP_LKP0_LTPR_WIN BCMPKT_TRACE_DOP_EFTA10_I1T_02_INDEX_DOP_LKP0_LTPR_WIN /* EFTA10_I1T_02_INDEX_DOP_LKP0_LTPR_WIN. */
#define BCM_PKTIO_TRACE_DOP_EFTA10_I1T_03_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT BCMPKT_TRACE_DOP_EFTA10_I1T_03_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT /* EFTA10_I1T_03_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_EFTA10_I1T_03_INDEX_DOP_LKP0_LTPR_WIN BCMPKT_TRACE_DOP_EFTA10_I1T_03_INDEX_DOP_LKP0_LTPR_WIN /* EFTA10_I1T_03_INDEX_DOP_LKP0_LTPR_WIN. */
...
#define BCM_PKTIO_TRACE_DOP_EFTA20_I1T_00_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT BCMPKT_TRACE_DOP_EFTA20_I1T_00_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT /* EFTA20_I1T_00_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_EFTA20_I1T_00_INDEX_DOP_LKP0_LTPR_WIN BCMPKT_TRACE_DOP_EFTA20_I1T_00_INDEX_DOP_LKP0_LTPR_WIN /* EFTA20_I1T_00_INDEX_DOP_LKP0_LTPR_WIN. */
#define BCM_PKTIO_TRACE_DOP_EFTA20_I1T_01_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT BCMPKT_TRACE_DOP_EFTA20_I1T_01_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT /* EFTA20_I1T_01_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_EFTA20_I1T_01_INDEX_DOP_LKP0_LTPR_WIN BCMPKT_TRACE_DOP_EFTA20_I1T_01_INDEX_DOP_LKP0_LTPR_WIN /* EFTA20_I1T_01_INDEX_DOP_LKP0_LTPR_WIN. */
#define BCM_PKTIO_TRACE_DOP_EFTA20_I1T_02_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT BCMPKT_TRACE_DOP_EFTA20_I1T_02_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT /* EFTA20_I1T_02_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_EFTA20_I1T_02_INDEX_DOP_LKP0_LTPR_WIN BCMPKT_TRACE_DOP_EFTA20_I1T_02_INDEX_DOP_LKP0_LTPR_WIN /* EFTA20_I1T_02_INDEX_DOP_LKP0_LTPR_WIN. */
#define BCM_PKTIO_TRACE_DOP_EFTA20_I1T_03_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT BCMPKT_TRACE_DOP_EFTA20_I1T_03_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT /* EFTA20_I1T_03_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_EFTA20_I1T_03_INDEX_DOP_LKP0_LTPR_WIN BCMPKT_TRACE_DOP_EFTA20_I1T_03_INDEX_DOP_LKP0_LTPR_WIN /* EFTA20_I1T_03_INDEX_DOP_LKP0_LTPR_WIN. */
#define BCM_PKTIO_TRACE_DOP_EFTA20_I1T_04_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT BCMPKT_TRACE_DOP_EFTA20_I1T_04_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT /* EFTA20_I1T_04_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_EFTA20_I1T_04_INDEX_DOP_LKP0_LTPR_WIN BCMPKT_TRACE_DOP_EFTA20_I1T_04_INDEX_DOP_LKP0_LTPR_WIN /* EFTA20_I1T_04_INDEX_DOP_LKP0_LTPR_WIN. */
#define BCM_PKTIO_TRACE_DOP_EFTA20_I1T_05_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT BCMPKT_TRACE_DOP_EFTA20_I1T_05_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT /* EFTA20_I1T_05_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_EFTA20_I1T_05_INDEX_DOP_LKP0_LTPR_WIN BCMPKT_TRACE_DOP_EFTA20_I1T_05_INDEX_DOP_LKP0_LTPR_WIN /* EFTA20_I1T_05_INDEX_DOP_LKP0_LTPR_WIN. */
#define BCM_PKTIO_TRACE_DOP_EFTA20_I1T_06_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT BCMPKT_TRACE_DOP_EFTA20_I1T_06_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT /* EFTA20_I1T_06_INDEX_DOP_LKP0_TILE_KEY_COMPRESSION_MUX_OUT. */
#define BCM_PKTIO_TRACE_DOP_EFTA20_I1T_06_INDEX_DOP_LKP0_LTPR_WIN BCMPKT_TRACE_DOP_EFTA20_I1T_06_INDEX_DOP_LKP0_LTPR_WIN /* EFTA20_I1T_06_INDEX_DOP_LKP0_LTPR_WIN. */
...
#define BCM_PKTIO_TRACE_DOP_EFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA BCMPKT_TRACE_DOP_EFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA /* EFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA. */
#define BCM_PKTIO_TRACE_DOP_EFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH BCMPKT_TRACE_DOP_EFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH /* EFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_EFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_EFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* EFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_EFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_EFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE /* EFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_EFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH BCMPKT_TRACE_DOP_EFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH /* EFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_EFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_EFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* EFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_EFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_EFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE /* EFTA30_E2T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_EFTA30_E2T_00_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT BCMPKT_TRACE_DOP_EFTA30_E2T_00_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT /* EFTA30_E2T_00_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT. */
...
#define BCM_PKTIO_TRACE_DOP_EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA BCMPKT_TRACE_DOP_EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA /* EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA. */
#define BCM_PKTIO_TRACE_DOP_EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE /* EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LKP0_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH BCMPKT_TRACE_DOP_EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH /* EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_0_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE /* EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LKP1_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH BCMPKT_TRACE_DOP_EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH /* EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_1_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_KEY_TYPE /* EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LKP2_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_2_TCAM_MATCH BCMPKT_TRACE_DOP_EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_2_TCAM_MATCH /* EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_2_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_LOGICAL_TABLE_ID BCMPKT_TRACE_DOP_EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_LOGICAL_TABLE_ID /* EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_LOGICAL_TABLE_ID. */
#define BCM_PKTIO_TRACE_DOP_EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_KEY_TYPE BCMPKT_TRACE_DOP_EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_KEY_TYPE /* EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LKP3_LTS_TCAM_DATA_KEY_TYPE. */
#define BCM_PKTIO_TRACE_DOP_EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_3_TCAM_MATCH BCMPKT_TRACE_DOP_EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_3_TCAM_MATCH /* EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP_LTS_TCAM_3_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_EFTA30_T4T_00_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT BCMPKT_TRACE_DOP_EFTA30_T4T_00_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT /* EFTA30_T4T_00_LTS_PRE_SEL_MUX_OUT_DOP_LTS_PRE_SEL_MUX_OUT. */
...
#define BCM_PKTIO_TRACE_DOP_EGR_TIMESTAMP_TIMESTAMP_COUNT_DOP_INGRESS_TIMESTAMP BCMPKT_TRACE_DOP_EGR_TIMESTAMP_TIMESTAMP_COUNT_DOP_INGRESS_TIMESTAMP /* EGR_TIMESTAMP_TIMESTAMP_COUNT_DOP_INGRESS_TIMESTAMP. */
...
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR0_COUNTER_ACTION_VECTOR_DOP_FLEX_STATE_ACTION_CTRL_0 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR0_COUNTER_ACTION_VECTOR_DOP_FLEX_STATE_ACTION_CTRL_0 /* FLEX_CTR_ST_EGR0_COUNTER_ACTION_VECTOR_DOP_FLEX_STATE_ACTION_CTRL_0. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR0_COUNTER_ACTION_VECTOR_DOP_FLEX_STATE_ACTION_CTRL_1 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR0_COUNTER_ACTION_VECTOR_DOP_FLEX_STATE_ACTION_CTRL_1 /* FLEX_CTR_ST_EGR0_COUNTER_ACTION_VECTOR_DOP_FLEX_STATE_ACTION_CTRL_1. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR0_COUNTER_POOL_1_UPDATE_CMD_DOP_POOL1_COUNTER_UPDATE_CMDPOOL1_CMD_VALID BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR0_COUNTER_POOL_1_UPDATE_CMD_DOP_POOL1_COUNTER_UPDATE_CMDPOOL1_CMD_VALID /* FLEX_CTR_ST_EGR0_COUNTER_POOL_1_UPDATE_CMD_DOP_POOL1_COUNTER_UPDATE_CMDPOOL1_CMD_VALID. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR0_COUNTER_POOL_2_UPDATE_CMD_DOP_POOL2_COUNTER_UPDATE_CMDPOOL2_CMD_VALID BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR0_COUNTER_POOL_2_UPDATE_CMD_DOP_POOL2_COUNTER_UPDATE_CMDPOOL2_CMD_VALID /* FLEX_CTR_ST_EGR0_COUNTER_POOL_2_UPDATE_CMD_DOP_POOL2_COUNTER_UPDATE_CMDPOOL2_CMD_VALID. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR0_COUNTER_POOL_3_UPDATE_CMD_DOP_POOL3_COUNTER_UPDATE_CMDPOOL3_CMD_VALID BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR0_COUNTER_POOL_3_UPDATE_CMD_DOP_POOL3_COUNTER_UPDATE_CMDPOOL3_CMD_VALID /* FLEX_CTR_ST_EGR0_COUNTER_POOL_3_UPDATE_CMD_DOP_POOL3_COUNTER_UPDATE_CMDPOOL3_CMD_VALID. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR0_COUNTER_POOL_0_UPDATE_CMD_DOP_POOL0_COUNTER_UPDATE_CMDPOOL0_CMD_VALID BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR0_COUNTER_POOL_0_UPDATE_CMD_DOP_POOL0_COUNTER_UPDATE_CMDPOOL0_CMD_VALID /* FLEX_CTR_ST_EGR0_COUNTER_POOL_0_UPDATE_CMD_DOP_POOL0_COUNTER_UPDATE_CMDPOOL0_CMD_VALID. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR0_COUNTER_B_DOP_BUS_COUNTER_B0 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR0_COUNTER_B_DOP_BUS_COUNTER_B0 /* FLEX_CTR_ST_EGR0_COUNTER_B_DOP_BUS_COUNTER_B0. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR0_COUNTER_B_DOP_BUS_COUNTER_B1 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR0_COUNTER_B_DOP_BUS_COUNTER_B1 /* FLEX_CTR_ST_EGR0_COUNTER_B_DOP_BUS_COUNTER_B1. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR0_COUNTER_B_DOP_BUS_COUNTER_B2 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR0_COUNTER_B_DOP_BUS_COUNTER_B2 /* FLEX_CTR_ST_EGR0_COUNTER_B_DOP_BUS_COUNTER_B2. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR0_COUNTER_B_DOP_BUS_COUNTER_B3 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR0_COUNTER_B_DOP_BUS_COUNTER_B3 /* FLEX_CTR_ST_EGR0_COUNTER_B_DOP_BUS_COUNTER_B3. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR0_TRIGGER_STATE_CTRL_DOP_TRIGGER_STATE_CTRL_0 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR0_TRIGGER_STATE_CTRL_DOP_TRIGGER_STATE_CTRL_0 /* FLEX_CTR_ST_EGR0_TRIGGER_STATE_CTRL_DOP_TRIGGER_STATE_CTRL_0. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR0_TRIGGER_STATE_CTRL_DOP_TRIGGER_STATE_CTRL_1 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR0_TRIGGER_STATE_CTRL_DOP_TRIGGER_STATE_CTRL_1 /* FLEX_CTR_ST_EGR0_TRIGGER_STATE_CTRL_DOP_TRIGGER_STATE_CTRL_1. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR0_TRIGGER_STATE_CTRL_DOP_TRIGGER_STATE_CTRL_2 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR0_TRIGGER_STATE_CTRL_DOP_TRIGGER_STATE_CTRL_2 /* FLEX_CTR_ST_EGR0_TRIGGER_STATE_CTRL_DOP_TRIGGER_STATE_CTRL_2. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR0_TRIGGER_STATE_CTRL_DOP_TRIGGER_STATE_CTRL_3 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR0_TRIGGER_STATE_CTRL_DOP_TRIGGER_STATE_CTRL_3 /* FLEX_CTR_ST_EGR0_TRIGGER_STATE_CTRL_DOP_TRIGGER_STATE_CTRL_3. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR0_COUNTER_A_DOP_BUS_COUNTER_A0 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR0_COUNTER_A_DOP_BUS_COUNTER_A0 /* FLEX_CTR_ST_EGR0_COUNTER_A_DOP_BUS_COUNTER_A0. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR0_COUNTER_A_DOP_BUS_COUNTER_A1 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR0_COUNTER_A_DOP_BUS_COUNTER_A1 /* FLEX_CTR_ST_EGR0_COUNTER_A_DOP_BUS_COUNTER_A1. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR0_COUNTER_A_DOP_BUS_COUNTER_A2 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR0_COUNTER_A_DOP_BUS_COUNTER_A2 /* FLEX_CTR_ST_EGR0_COUNTER_A_DOP_BUS_COUNTER_A2. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR0_COUNTER_A_DOP_BUS_COUNTER_A3 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR0_COUNTER_A_DOP_BUS_COUNTER_A3 /* FLEX_CTR_ST_EGR0_COUNTER_A_DOP_BUS_COUNTER_A3. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR0_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_0 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR0_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_0 /* FLEX_CTR_ST_EGR0_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_0. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR0_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_1 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR0_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_1 /* FLEX_CTR_ST_EGR0_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_1. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR0_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_2 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR0_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_2 /* FLEX_CTR_ST_EGR0_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_2. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR0_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_3 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR0_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_3 /* FLEX_CTR_ST_EGR0_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_3. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR1_COUNTER_ACTION_VECTOR_DOP_FLEX_STATE_ACTION_CTRL_0 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR1_COUNTER_ACTION_VECTOR_DOP_FLEX_STATE_ACTION_CTRL_0 /* FLEX_CTR_ST_EGR1_COUNTER_ACTION_VECTOR_DOP_FLEX_STATE_ACTION_CTRL_0. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR1_COUNTER_ACTION_VECTOR_DOP_FLEX_STATE_ACTION_CTRL_1 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR1_COUNTER_ACTION_VECTOR_DOP_FLEX_STATE_ACTION_CTRL_1 /* FLEX_CTR_ST_EGR1_COUNTER_ACTION_VECTOR_DOP_FLEX_STATE_ACTION_CTRL_1. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR1_COUNTER_POOL_1_UPDATE_CMD_DOP_POOL1_COUNTER_UPDATE_CMDPOOL1_CMD_VALID BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR1_COUNTER_POOL_1_UPDATE_CMD_DOP_POOL1_COUNTER_UPDATE_CMDPOOL1_CMD_VALID /* FLEX_CTR_ST_EGR1_COUNTER_POOL_1_UPDATE_CMD_DOP_POOL1_COUNTER_UPDATE_CMDPOOL1_CMD_VALID. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR1_COUNTER_POOL_2_UPDATE_CMD_DOP_POOL2_COUNTER_UPDATE_CMDPOOL2_CMD_VALID BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR1_COUNTER_POOL_2_UPDATE_CMD_DOP_POOL2_COUNTER_UPDATE_CMDPOOL2_CMD_VALID /* FLEX_CTR_ST_EGR1_COUNTER_POOL_2_UPDATE_CMD_DOP_POOL2_COUNTER_UPDATE_CMDPOOL2_CMD_VALID. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR1_COUNTER_POOL_3_UPDATE_CMD_DOP_POOL3_COUNTER_UPDATE_CMDPOOL3_CMD_VALID BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR1_COUNTER_POOL_3_UPDATE_CMD_DOP_POOL3_COUNTER_UPDATE_CMDPOOL3_CMD_VALID /* FLEX_CTR_ST_EGR1_COUNTER_POOL_3_UPDATE_CMD_DOP_POOL3_COUNTER_UPDATE_CMDPOOL3_CMD_VALID. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR1_COUNTER_POOL_0_UPDATE_CMD_DOP_POOL0_COUNTER_UPDATE_CMDPOOL0_CMD_VALID BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR1_COUNTER_POOL_0_UPDATE_CMD_DOP_POOL0_COUNTER_UPDATE_CMDPOOL0_CMD_VALID /* FLEX_CTR_ST_EGR1_COUNTER_POOL_0_UPDATE_CMD_DOP_POOL0_COUNTER_UPDATE_CMDPOOL0_CMD_VALID. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR1_COUNTER_B_DOP_BUS_COUNTER_B0 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR1_COUNTER_B_DOP_BUS_COUNTER_B0 /* FLEX_CTR_ST_EGR1_COUNTER_B_DOP_BUS_COUNTER_B0. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR1_COUNTER_B_DOP_BUS_COUNTER_B1 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR1_COUNTER_B_DOP_BUS_COUNTER_B1 /* FLEX_CTR_ST_EGR1_COUNTER_B_DOP_BUS_COUNTER_B1. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR1_COUNTER_B_DOP_BUS_COUNTER_B2 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR1_COUNTER_B_DOP_BUS_COUNTER_B2 /* FLEX_CTR_ST_EGR1_COUNTER_B_DOP_BUS_COUNTER_B2. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR1_COUNTER_B_DOP_BUS_COUNTER_B3 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR1_COUNTER_B_DOP_BUS_COUNTER_B3 /* FLEX_CTR_ST_EGR1_COUNTER_B_DOP_BUS_COUNTER_B3. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR1_TRIGGER_STATE_CTRL_DOP_TRIGGER_STATE_CTRL_0 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR1_TRIGGER_STATE_CTRL_DOP_TRIGGER_STATE_CTRL_0 /* FLEX_CTR_ST_EGR1_TRIGGER_STATE_CTRL_DOP_TRIGGER_STATE_CTRL_0. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR1_TRIGGER_STATE_CTRL_DOP_TRIGGER_STATE_CTRL_1 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR1_TRIGGER_STATE_CTRL_DOP_TRIGGER_STATE_CTRL_1 /* FLEX_CTR_ST_EGR1_TRIGGER_STATE_CTRL_DOP_TRIGGER_STATE_CTRL_1. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR1_TRIGGER_STATE_CTRL_DOP_TRIGGER_STATE_CTRL_2 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR1_TRIGGER_STATE_CTRL_DOP_TRIGGER_STATE_CTRL_2 /* FLEX_CTR_ST_EGR1_TRIGGER_STATE_CTRL_DOP_TRIGGER_STATE_CTRL_2. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR1_TRIGGER_STATE_CTRL_DOP_TRIGGER_STATE_CTRL_3 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR1_TRIGGER_STATE_CTRL_DOP_TRIGGER_STATE_CTRL_3 /* FLEX_CTR_ST_EGR1_TRIGGER_STATE_CTRL_DOP_TRIGGER_STATE_CTRL_3. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR1_COUNTER_A_DOP_BUS_COUNTER_A0 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR1_COUNTER_A_DOP_BUS_COUNTER_A0 /* FLEX_CTR_ST_EGR1_COUNTER_A_DOP_BUS_COUNTER_A0. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR1_COUNTER_A_DOP_BUS_COUNTER_A1 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR1_COUNTER_A_DOP_BUS_COUNTER_A1 /* FLEX_CTR_ST_EGR1_COUNTER_A_DOP_BUS_COUNTER_A1. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR1_COUNTER_A_DOP_BUS_COUNTER_A2 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR1_COUNTER_A_DOP_BUS_COUNTER_A2 /* FLEX_CTR_ST_EGR1_COUNTER_A_DOP_BUS_COUNTER_A2. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR1_COUNTER_A_DOP_BUS_COUNTER_A3 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR1_COUNTER_A_DOP_BUS_COUNTER_A3 /* FLEX_CTR_ST_EGR1_COUNTER_A_DOP_BUS_COUNTER_A3. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR1_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_0 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR1_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_0 /* FLEX_CTR_ST_EGR1_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_0. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR1_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_1 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR1_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_1 /* FLEX_CTR_ST_EGR1_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_1. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR1_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_2 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR1_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_2 /* FLEX_CTR_ST_EGR1_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_2. */
#define BCM_PKTIO_TRACE_DOP_FLEX_CTR_ST_EGR1_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_3 BCMPKT_TRACE_DOP_FLEX_CTR_ST_EGR1_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_3 /* FLEX_CTR_ST_EGR1_TRUTH_TABLE_CMD_OUTPUT_DOP_TRUTH_TABLE_OUTPUT_3. */
...
#define BCM_PKTIO_TRACE_DOP_QOS_REMARKING_LTS_TCAM_KEY_DOP_LTS_TCAM_KEY BCMPKT_TRACE_DOP_QOS_REMARKING_LTS_TCAM_KEY_DOP_LTS_TCAM_KEY /* QOS_REMARKING_LTS_TCAM_KEY_DOP_LTS_TCAM_KEY. */
...
#define BCM_PKTIO_TRACE_DOP_QOS_REMARKING_LTS_TCAM_HIT_AND_INDEX_DOP_LTS_TCAM_POLICY_DATA BCMPKT_TRACE_DOP_QOS_REMARKING_LTS_TCAM_HIT_AND_INDEX_DOP_LTS_TCAM_POLICY_DATA /* QOS_REMARKING_LTS_TCAM_HIT_AND_INDEX_DOP_LTS_TCAM_POLICY_DATA. */
#define BCM_PKTIO_TRACE_DOP_QOS_REMARKING_LTS_TCAM_HIT_AND_INDEX_DOP_LTS_TCAM_POLICY_DATA_HIT_INDEX BCMPKT_TRACE_DOP_QOS_REMARKING_LTS_TCAM_HIT_AND_INDEX_DOP_LTS_TCAM_POLICY_DATA_HIT_INDEX /* QOS_REMARKING_LTS_TCAM_HIT_AND_INDEX_DOP_LTS_TCAM_POLICY_DATA_HIT_INDEX. */
#define BCM_PKTIO_TRACE_DOP_QOS_REMARKING_LTS_TCAM_INDEX_DOP_LTS_TCAM_ONLY_TCAM_MATCH BCMPKT_TRACE_DOP_QOS_REMARKING_LTS_TCAM_INDEX_DOP_LTS_TCAM_ONLY_TCAM_MATCH /* QOS_REMARKING_LTS_TCAM_INDEX_DOP_LTS_TCAM_ONLY_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_QOS_REMARKING_LTS_TCAM_INDEX_DOP_LTS_TCAM_POLICY_DATA BCMPKT_TRACE_DOP_QOS_REMARKING_LTS_TCAM_INDEX_DOP_LTS_TCAM_POLICY_DATA /* QOS_REMARKING_LTS_TCAM_INDEX_DOP_LTS_TCAM_POLICY_DATA. */
#define BCM_PKTIO_TRACE_DOP_QOS_REMARKING_LTS_TCAM_INDEX_DOP_LTS_TCAM_POLICY_DATA_HIT_INDEX BCMPKT_TRACE_DOP_QOS_REMARKING_LTS_TCAM_INDEX_DOP_LTS_TCAM_POLICY_DATA_HIT_INDEX /* QOS_REMARKING_LTS_TCAM_INDEX_DOP_LTS_TCAM_POLICY_DATA_HIT_INDEX. */
#define BCM_PKTIO_TRACE_DOP_QOS_REMARKING_LTS_TCAM_INDEX_DOP_LTS_TCAM_TCAM_MATCH BCMPKT_TRACE_DOP_QOS_REMARKING_LTS_TCAM_INDEX_DOP_LTS_TCAM_TCAM_MATCH /* QOS_REMARKING_LTS_TCAM_INDEX_DOP_LTS_TCAM_TCAM_MATCH. */
...
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_4_LTS_TCAM_KEY_DOP_TCAM_4_A_KEY BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_4_LTS_TCAM_KEY_DOP_TCAM_4_A_KEY /* EDIT_CTRL_ZONE_4_LTS_TCAM_KEY_DOP_TCAM_4_A_KEY. */
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_3_LTS_TCAM_KEY_DOP_TCAM_3_A_KEY BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_3_LTS_TCAM_KEY_DOP_TCAM_3_A_KEY /* EDIT_CTRL_ZONE_3_LTS_TCAM_KEY_DOP_TCAM_3_A_KEY. */
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_2_LTS_TCAM_KEY_DOP_TCAM_2_A_KEY BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_2_LTS_TCAM_KEY_DOP_TCAM_2_A_KEY /* EDIT_CTRL_ZONE_2_LTS_TCAM_KEY_DOP_TCAM_2_A_KEY. */
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_1_LTS_TCAM_KEY_DOP_TCAM_1_A_KEY BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_1_LTS_TCAM_KEY_DOP_TCAM_1_A_KEY /* EDIT_CTRL_ZONE_1_LTS_TCAM_KEY_DOP_TCAM_1_A_KEY. */
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_0_LTS_TCAM_KEY_DOP_TCAM_0_A_KEY BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_0_LTS_TCAM_KEY_DOP_TCAM_0_A_KEY /* EDIT_CTRL_ZONE_0_LTS_TCAM_KEY_DOP_TCAM_0_A_KEY. */
...
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_0_LTS_TCAM_INDEX_DOP_TCAM_0_C_TCAM_MATCH BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_0_LTS_TCAM_INDEX_DOP_TCAM_0_C_TCAM_MATCH /* EDIT_CTRL_ZONE_0_LTS_TCAM_INDEX_DOP_TCAM_0_C_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_0_LTS_TCAM_INDEX_DOP_TCAM_0_C_MATCH_INDEX BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_0_LTS_TCAM_INDEX_DOP_TCAM_0_C_MATCH_INDEX /* EDIT_CTRL_ZONE_0_LTS_TCAM_INDEX_DOP_TCAM_0_C_MATCH_INDEX. */
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_0_LTS_TCAM_INDEX_DOP_TCAM_0_B_TCAM_MATCH BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_0_LTS_TCAM_INDEX_DOP_TCAM_0_B_TCAM_MATCH /* EDIT_CTRL_ZONE_0_LTS_TCAM_INDEX_DOP_TCAM_0_B_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_0_LTS_TCAM_INDEX_DOP_TCAM_0_B_MATCH_INDEX BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_0_LTS_TCAM_INDEX_DOP_TCAM_0_B_MATCH_INDEX /* EDIT_CTRL_ZONE_0_LTS_TCAM_INDEX_DOP_TCAM_0_B_MATCH_INDEX. */
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_0_LTS_TCAM_INDEX_DOP_TCAM_0_A_TCAM_MATCH BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_0_LTS_TCAM_INDEX_DOP_TCAM_0_A_TCAM_MATCH /* EDIT_CTRL_ZONE_0_LTS_TCAM_INDEX_DOP_TCAM_0_A_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_0_LTS_TCAM_INDEX_DOP_TCAM_0_A_MATCH_INDEX BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_0_LTS_TCAM_INDEX_DOP_TCAM_0_A_MATCH_INDEX /* EDIT_CTRL_ZONE_0_LTS_TCAM_INDEX_DOP_TCAM_0_A_MATCH_INDEX. */
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_1_LTS_TCAM_INDEX_DOP_TCAM_1_C_TCAM_MATCH BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_1_LTS_TCAM_INDEX_DOP_TCAM_1_C_TCAM_MATCH /* EDIT_CTRL_ZONE_1_LTS_TCAM_INDEX_DOP_TCAM_1_C_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_1_LTS_TCAM_INDEX_DOP_TCAM_1_C_MATCH_INDEX BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_1_LTS_TCAM_INDEX_DOP_TCAM_1_C_MATCH_INDEX /* EDIT_CTRL_ZONE_1_LTS_TCAM_INDEX_DOP_TCAM_1_C_MATCH_INDEX. */
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_1_LTS_TCAM_INDEX_DOP_TCAM_1_B_TCAM_MATCH BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_1_LTS_TCAM_INDEX_DOP_TCAM_1_B_TCAM_MATCH /* EDIT_CTRL_ZONE_1_LTS_TCAM_INDEX_DOP_TCAM_1_B_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_1_LTS_TCAM_INDEX_DOP_TCAM_1_B_MATCH_INDEX BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_1_LTS_TCAM_INDEX_DOP_TCAM_1_B_MATCH_INDEX /* EDIT_CTRL_ZONE_1_LTS_TCAM_INDEX_DOP_TCAM_1_B_MATCH_INDEX. */
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_1_LTS_TCAM_INDEX_DOP_TCAM_1_A_TCAM_MATCH BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_1_LTS_TCAM_INDEX_DOP_TCAM_1_A_TCAM_MATCH /* EDIT_CTRL_ZONE_1_LTS_TCAM_INDEX_DOP_TCAM_1_A_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_1_LTS_TCAM_INDEX_DOP_TCAM_1_A_MATCH_INDEX BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_1_LTS_TCAM_INDEX_DOP_TCAM_1_A_MATCH_INDEX /* EDIT_CTRL_ZONE_1_LTS_TCAM_INDEX_DOP_TCAM_1_A_MATCH_INDEX. */
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_2_LTS_TCAM_INDEX_DOP_TCAM_2_C_TCAM_MATCH BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_2_LTS_TCAM_INDEX_DOP_TCAM_2_C_TCAM_MATCH /* EDIT_CTRL_ZONE_2_LTS_TCAM_INDEX_DOP_TCAM_2_C_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_2_LTS_TCAM_INDEX_DOP_TCAM_2_C_MATCH_INDEX BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_2_LTS_TCAM_INDEX_DOP_TCAM_2_C_MATCH_INDEX /* EDIT_CTRL_ZONE_2_LTS_TCAM_INDEX_DOP_TCAM_2_C_MATCH_INDEX. */
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_2_LTS_TCAM_INDEX_DOP_TCAM_2_B_TCAM_MATCH BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_2_LTS_TCAM_INDEX_DOP_TCAM_2_B_TCAM_MATCH /* EDIT_CTRL_ZONE_2_LTS_TCAM_INDEX_DOP_TCAM_2_B_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_2_LTS_TCAM_INDEX_DOP_TCAM_2_B_MATCH_INDEX BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_2_LTS_TCAM_INDEX_DOP_TCAM_2_B_MATCH_INDEX /* EDIT_CTRL_ZONE_2_LTS_TCAM_INDEX_DOP_TCAM_2_B_MATCH_INDEX. */
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_2_LTS_TCAM_INDEX_DOP_TCAM_2_A_TCAM_MATCH BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_2_LTS_TCAM_INDEX_DOP_TCAM_2_A_TCAM_MATCH /* EDIT_CTRL_ZONE_2_LTS_TCAM_INDEX_DOP_TCAM_2_A_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_2_LTS_TCAM_INDEX_DOP_TCAM_2_A_MATCH_INDEX BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_2_LTS_TCAM_INDEX_DOP_TCAM_2_A_MATCH_INDEX /* EDIT_CTRL_ZONE_2_LTS_TCAM_INDEX_DOP_TCAM_2_A_MATCH_INDEX. */
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_3_LTS_TCAM_INDEX_DOP_TCAM_3_C_TCAM_MATCH BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_3_LTS_TCAM_INDEX_DOP_TCAM_3_C_TCAM_MATCH /* EDIT_CTRL_ZONE_3_LTS_TCAM_INDEX_DOP_TCAM_3_C_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_3_LTS_TCAM_INDEX_DOP_TCAM_3_C_MATCH_INDEX BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_3_LTS_TCAM_INDEX_DOP_TCAM_3_C_MATCH_INDEX /* EDIT_CTRL_ZONE_3_LTS_TCAM_INDEX_DOP_TCAM_3_C_MATCH_INDEX. */
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_3_LTS_TCAM_INDEX_DOP_TCAM_3_B_TCAM_MATCH BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_3_LTS_TCAM_INDEX_DOP_TCAM_3_B_TCAM_MATCH /* EDIT_CTRL_ZONE_3_LTS_TCAM_INDEX_DOP_TCAM_3_B_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_3_LTS_TCAM_INDEX_DOP_TCAM_3_B_MATCH_INDEX BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_3_LTS_TCAM_INDEX_DOP_TCAM_3_B_MATCH_INDEX /* EDIT_CTRL_ZONE_3_LTS_TCAM_INDEX_DOP_TCAM_3_B_MATCH_INDEX. */
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_3_LTS_TCAM_INDEX_DOP_TCAM_3_A_TCAM_MATCH BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_3_LTS_TCAM_INDEX_DOP_TCAM_3_A_TCAM_MATCH /* EDIT_CTRL_ZONE_3_LTS_TCAM_INDEX_DOP_TCAM_3_A_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_3_LTS_TCAM_INDEX_DOP_TCAM_3_A_MATCH_INDEX BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_3_LTS_TCAM_INDEX_DOP_TCAM_3_A_MATCH_INDEX /* EDIT_CTRL_ZONE_3_LTS_TCAM_INDEX_DOP_TCAM_3_A_MATCH_INDEX. */
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_4_LTS_TCAM_INDEX_DOP_TCAM_4_C_TCAM_MATCH BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_4_LTS_TCAM_INDEX_DOP_TCAM_4_C_TCAM_MATCH /* EDIT_CTRL_ZONE_4_LTS_TCAM_INDEX_DOP_TCAM_4_C_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_4_LTS_TCAM_INDEX_DOP_TCAM_4_C_MATCH_INDEX BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_4_LTS_TCAM_INDEX_DOP_TCAM_4_C_MATCH_INDEX /* EDIT_CTRL_ZONE_4_LTS_TCAM_INDEX_DOP_TCAM_4_C_MATCH_INDEX. */
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_4_LTS_TCAM_INDEX_DOP_TCAM_4_B_TCAM_MATCH BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_4_LTS_TCAM_INDEX_DOP_TCAM_4_B_TCAM_MATCH /* EDIT_CTRL_ZONE_4_LTS_TCAM_INDEX_DOP_TCAM_4_B_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_4_LTS_TCAM_INDEX_DOP_TCAM_4_B_MATCH_INDEX BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_4_LTS_TCAM_INDEX_DOP_TCAM_4_B_MATCH_INDEX /* EDIT_CTRL_ZONE_4_LTS_TCAM_INDEX_DOP_TCAM_4_B_MATCH_INDEX. */
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_4_LTS_TCAM_INDEX_DOP_TCAM_4_A_TCAM_MATCH BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_4_LTS_TCAM_INDEX_DOP_TCAM_4_A_TCAM_MATCH /* EDIT_CTRL_ZONE_4_LTS_TCAM_INDEX_DOP_TCAM_4_A_TCAM_MATCH. */
#define BCM_PKTIO_TRACE_DOP_EDIT_CTRL_ZONE_4_LTS_TCAM_INDEX_DOP_TCAM_4_A_MATCH_INDEX BCMPKT_TRACE_DOP_EDIT_CTRL_ZONE_4_LTS_TCAM_INDEX_DOP_TCAM_4_A_MATCH_INDEX /* EDIT_CTRL_ZONE_4_LTS_TCAM_INDEX_DOP_TCAM_4_A_MATCH_INDEX. */
...
#define BCM_PKTIO_TRACE_DOP_FID_COUNT       BCMPKT_TRACE_DOP_FID_COUNT /* TRACE_DOP FIELD ID
                                                          NUMBER */
...
#define BCM_PKTIO_TRACE_DOP_ID_IFTA10_I1T_00_INDEX_DOP BCMPKT_TRACE_DOP_ID_IFTA10_I1T_00_INDEX_DOP /* IFTA10_I1T_00_INDEX_DOP. */
...
#define BCM_PKTIO_TRACE_DOP_ID_IFTA20_I1T_00_INDEX_DOP BCMPKT_TRACE_DOP_ID_IFTA20_I1T_00_INDEX_DOP /* IFTA20_I1T_00_INDEX_DOP. */
...
#define BCM_PKTIO_TRACE_DOP_ID_IFTA30_E2T_00_LTS_HIT_CONTEXT_DOP BCMPKT_TRACE_DOP_ID_IFTA30_E2T_00_LTS_HIT_CONTEXT_DOP /* IFTA30_E2T_00_LTS_HIT_CONTEXT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA30_E2T_00_LTS_PRE_SEL_MUX_OUT_DOP BCMPKT_TRACE_DOP_ID_IFTA30_E2T_00_LTS_PRE_SEL_MUX_OUT_DOP /* IFTA30_E2T_00_LTS_PRE_SEL_MUX_OUT_DOP. */
...
#define BCM_PKTIO_TRACE_DOP_ID_IFTA40_E2T_00_LTS_HIT_CONTEXT_DOP BCMPKT_TRACE_DOP_ID_IFTA40_E2T_00_LTS_HIT_CONTEXT_DOP /* IFTA40_E2T_00_LTS_HIT_CONTEXT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA40_E2T_00_LTS_PRE_SEL_MUX_OUT_DOP BCMPKT_TRACE_DOP_ID_IFTA40_E2T_00_LTS_PRE_SEL_MUX_OUT_DOP /* IFTA40_E2T_00_LTS_PRE_SEL_MUX_OUT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA40_E2T_01_LTS_HIT_CONTEXT_DOP BCMPKT_TRACE_DOP_ID_IFTA40_E2T_01_LTS_HIT_CONTEXT_DOP /* IFTA40_E2T_01_LTS_HIT_CONTEXT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA40_E2T_01_LTS_PRE_SEL_MUX_OUT_DOP BCMPKT_TRACE_DOP_ID_IFTA40_E2T_01_LTS_PRE_SEL_MUX_OUT_DOP /* IFTA40_E2T_01_LTS_PRE_SEL_MUX_OUT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA40_E2T_02_LTS_HIT_CONTEXT_DOP BCMPKT_TRACE_DOP_ID_IFTA40_E2T_02_LTS_HIT_CONTEXT_DOP /* IFTA40_E2T_02_LTS_HIT_CONTEXT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA40_E2T_02_LTS_PRE_SEL_MUX_OUT_DOP BCMPKT_TRACE_DOP_ID_IFTA40_E2T_02_LTS_PRE_SEL_MUX_OUT_DOP /* IFTA40_E2T_02_LTS_PRE_SEL_MUX_OUT_DOP. */
...
#define BCM_PKTIO_TRACE_DOP_ID_IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP BCMPKT_TRACE_DOP_ID_IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP /* IFTA40_T4T_00_LTS_HIT_CONTEXT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA40_T4T_00_LTS_PRE_SEL_MUX_OUT_DOP BCMPKT_TRACE_DOP_ID_IFTA40_T4T_00_LTS_PRE_SEL_MUX_OUT_DOP /* IFTA40_T4T_00_LTS_PRE_SEL_MUX_OUT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP BCMPKT_TRACE_DOP_ID_IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP /* IFTA40_T4T_01_LTS_HIT_CONTEXT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA40_T4T_01_LTS_PRE_SEL_MUX_OUT_DOP BCMPKT_TRACE_DOP_ID_IFTA40_T4T_01_LTS_PRE_SEL_MUX_OUT_DOP /* IFTA40_T4T_01_LTS_PRE_SEL_MUX_OUT_DOP. */
...
#define BCM_PKTIO_TRACE_DOP_ID_IFTA50_I1T_00_INDEX_DOP BCMPKT_TRACE_DOP_ID_IFTA50_I1T_00_INDEX_DOP /* IFTA50_I1T_00_INDEX_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA50_I1T_01_INDEX_DOP BCMPKT_TRACE_DOP_ID_IFTA50_I1T_01_INDEX_DOP /* IFTA50_I1T_01_INDEX_DOP. */
...
#define BCM_PKTIO_TRACE_DOP_ID_IFTA60_I1T_00_INDEX_DOP BCMPKT_TRACE_DOP_ID_IFTA60_I1T_00_INDEX_DOP /* IFTA60_I1T_00_INDEX_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA60_I1T_01_INDEX_DOP BCMPKT_TRACE_DOP_ID_IFTA60_I1T_01_INDEX_DOP /* IFTA60_I1T_01_INDEX_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA60_I1T_02_INDEX_DOP BCMPKT_TRACE_DOP_ID_IFTA60_I1T_02_INDEX_DOP /* IFTA60_I1T_02_INDEX_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP BCMPKT_TRACE_DOP_ID_IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP /* IFTA60_T4T_00_LTS_HIT_CONTEXT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA60_T4T_00_LTS_PRE_SEL_MUX_OUT_DOP BCMPKT_TRACE_DOP_ID_IFTA60_T4T_00_LTS_PRE_SEL_MUX_OUT_DOP /* IFTA60_T4T_00_LTS_PRE_SEL_MUX_OUT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_MEMDB_TCAM_IFTA60_MEM0_1_KEY_DOP BCMPKT_TRACE_DOP_ID_MEMDB_TCAM_IFTA60_MEM0_1_KEY_DOP /* MEMDB_TCAM_IFTA60_MEM0_1_KEY_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_MEMDB_TCAM_IFTA60_MEM0_3_KEY_DOP BCMPKT_TRACE_DOP_ID_MEMDB_TCAM_IFTA60_MEM0_3_KEY_DOP /* MEMDB_TCAM_IFTA60_MEM0_3_KEY_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_MEMDB_TCAM_IFTA60_MEM0_2_KEY_DOP BCMPKT_TRACE_DOP_ID_MEMDB_TCAM_IFTA60_MEM0_2_KEY_DOP /* MEMDB_TCAM_IFTA60_MEM0_2_KEY_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_MEMDB_TCAM_IFTA60_MEM0_0_KEY_DOP BCMPKT_TRACE_DOP_ID_MEMDB_TCAM_IFTA60_MEM0_0_KEY_DOP /* MEMDB_TCAM_IFTA60_MEM0_0_KEY_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP BCMPKT_TRACE_DOP_ID_MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP /* MEMDB_TCAM_IFTA60_MEM0_INDEX_DOP. */
...
#define BCM_PKTIO_TRACE_DOP_ID_IFTA70_I1T_00_INDEX_DOP BCMPKT_TRACE_DOP_ID_IFTA70_I1T_00_INDEX_DOP /* IFTA70_I1T_00_INDEX_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA70_I1T_01_INDEX_DOP BCMPKT_TRACE_DOP_ID_IFTA70_I1T_01_INDEX_DOP /* IFTA70_I1T_01_INDEX_DOP. */
...
#define BCM_PKTIO_TRACE_DOP_ID_IFTA80_E2T_00_LTS_HIT_CONTEXT_DOP BCMPKT_TRACE_DOP_ID_IFTA80_E2T_00_LTS_HIT_CONTEXT_DOP /* IFTA80_E2T_00_LTS_HIT_CONTEXT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA80_E2T_00_LTS_PRE_SEL_MUX_OUT_DOP BCMPKT_TRACE_DOP_ID_IFTA80_E2T_00_LTS_PRE_SEL_MUX_OUT_DOP /* IFTA80_E2T_00_LTS_PRE_SEL_MUX_OUT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA80_E2T_01_LTS_HIT_CONTEXT_DOP BCMPKT_TRACE_DOP_ID_IFTA80_E2T_01_LTS_HIT_CONTEXT_DOP /* IFTA80_E2T_01_LTS_HIT_CONTEXT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA80_E2T_01_LTS_PRE_SEL_MUX_OUT_DOP BCMPKT_TRACE_DOP_ID_IFTA80_E2T_01_LTS_PRE_SEL_MUX_OUT_DOP /* IFTA80_E2T_01_LTS_PRE_SEL_MUX_OUT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA80_E2T_02_LTS_HIT_CONTEXT_DOP BCMPKT_TRACE_DOP_ID_IFTA80_E2T_02_LTS_HIT_CONTEXT_DOP /* IFTA80_E2T_02_LTS_HIT_CONTEXT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA80_E2T_02_LTS_PRE_SEL_MUX_OUT_DOP BCMPKT_TRACE_DOP_ID_IFTA80_E2T_02_LTS_PRE_SEL_MUX_OUT_DOP /* IFTA80_E2T_02_LTS_PRE_SEL_MUX_OUT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA80_E2T_03_LTS_HIT_CONTEXT_DOP BCMPKT_TRACE_DOP_ID_IFTA80_E2T_03_LTS_HIT_CONTEXT_DOP /* IFTA80_E2T_03_LTS_HIT_CONTEXT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA80_E2T_03_LTS_PRE_SEL_MUX_OUT_DOP BCMPKT_TRACE_DOP_ID_IFTA80_E2T_03_LTS_PRE_SEL_MUX_OUT_DOP /* IFTA80_E2T_03_LTS_PRE_SEL_MUX_OUT_DOP. */
...
#define BCM_PKTIO_TRACE_DOP_ID_IFTA80_T2T_00_LTS_HIT_CONTEXT_DOP BCMPKT_TRACE_DOP_ID_IFTA80_T2T_00_LTS_HIT_CONTEXT_DOP /* IFTA80_T2T_00_LTS_HIT_CONTEXT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA80_T2T_00_LTS_PRE_SEL_MUX_OUT_DOP BCMPKT_TRACE_DOP_ID_IFTA80_T2T_00_LTS_PRE_SEL_MUX_OUT_DOP /* IFTA80_T2T_00_LTS_PRE_SEL_MUX_OUT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA80_T2T_01_LTS_HIT_CONTEXT_DOP BCMPKT_TRACE_DOP_ID_IFTA80_T2T_01_LTS_HIT_CONTEXT_DOP /* IFTA80_T2T_01_LTS_HIT_CONTEXT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA80_T2T_01_LTS_PRE_SEL_MUX_OUT_DOP BCMPKT_TRACE_DOP_ID_IFTA80_T2T_01_LTS_PRE_SEL_MUX_OUT_DOP /* IFTA80_T2T_01_LTS_PRE_SEL_MUX_OUT_DOP. */
...
#define BCM_PKTIO_TRACE_DOP_ID_FLEX_QOS_PHB2_LTS_TCAM_KEY_DOP BCMPKT_TRACE_DOP_ID_FLEX_QOS_PHB2_LTS_TCAM_KEY_DOP /* FLEX_QOS_PHB2_LTS_TCAM_KEY_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_FLEX_QOS_PHB2_LTS_TCAM_INDEX_DOP BCMPKT_TRACE_DOP_ID_FLEX_QOS_PHB2_LTS_TCAM_INDEX_DOP /* FLEX_QOS_PHB2_LTS_TCAM_INDEX_DOP. */
...
#define BCM_PKTIO_TRACE_DOP_ID_IFTA90_E2T_00_LTS_HIT_CONTEXT_DOP BCMPKT_TRACE_DOP_ID_IFTA90_E2T_00_LTS_HIT_CONTEXT_DOP /* IFTA90_E2T_00_LTS_HIT_CONTEXT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA90_E2T_00_LTS_PRE_SEL_MUX_OUT_DOP BCMPKT_TRACE_DOP_ID_IFTA90_E2T_00_LTS_PRE_SEL_MUX_OUT_DOP /* IFTA90_E2T_00_LTS_PRE_SEL_MUX_OUT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA90_E2T_01_LTS_HIT_CONTEXT_DOP BCMPKT_TRACE_DOP_ID_IFTA90_E2T_01_LTS_HIT_CONTEXT_DOP /* IFTA90_E2T_01_LTS_HIT_CONTEXT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA90_E2T_01_LTS_PRE_SEL_MUX_OUT_DOP BCMPKT_TRACE_DOP_ID_IFTA90_E2T_01_LTS_PRE_SEL_MUX_OUT_DOP /* IFTA90_E2T_01_LTS_PRE_SEL_MUX_OUT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA90_E2T_02_LTS_HIT_CONTEXT_DOP BCMPKT_TRACE_DOP_ID_IFTA90_E2T_02_LTS_HIT_CONTEXT_DOP /* IFTA90_E2T_02_LTS_HIT_CONTEXT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA90_E2T_02_LTS_PRE_SEL_MUX_OUT_DOP BCMPKT_TRACE_DOP_ID_IFTA90_E2T_02_LTS_PRE_SEL_MUX_OUT_DOP /* IFTA90_E2T_02_LTS_PRE_SEL_MUX_OUT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA90_E2T_03_LTS_HIT_CONTEXT_DOP BCMPKT_TRACE_DOP_ID_IFTA90_E2T_03_LTS_HIT_CONTEXT_DOP /* IFTA90_E2T_03_LTS_HIT_CONTEXT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA90_E2T_03_LTS_PRE_SEL_MUX_OUT_DOP BCMPKT_TRACE_DOP_ID_IFTA90_E2T_03_LTS_PRE_SEL_MUX_OUT_DOP /* IFTA90_E2T_03_LTS_PRE_SEL_MUX_OUT_DOP. */
...
#define BCM_PKTIO_TRACE_DOP_ID_FLEX_CTR_ST_ING0_TRUTH_TABLE_CMD_OUTPUT_DOP BCMPKT_TRACE_DOP_ID_FLEX_CTR_ST_ING0_TRUTH_TABLE_CMD_OUTPUT_DOP /* FLEX_CTR_ST_ING0_TRUTH_TABLE_CMD_OUTPUT_DOP. */
...
#define BCM_PKTIO_TRACE_DOP_ID_IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP BCMPKT_TRACE_DOP_ID_IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP /* IFTA100_T4T_00_LTS_HIT_CONTEXT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA100_T4T_00_LTS_PRE_SEL_MUX_OUT_DOP BCMPKT_TRACE_DOP_ID_IFTA100_T4T_00_LTS_PRE_SEL_MUX_OUT_DOP /* IFTA100_T4T_00_LTS_PRE_SEL_MUX_OUT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP BCMPKT_TRACE_DOP_ID_IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP /* IFTA100_T4T_01_LTS_HIT_CONTEXT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA100_T4T_01_LTS_PRE_SEL_MUX_OUT_DOP BCMPKT_TRACE_DOP_ID_IFTA100_T4T_01_LTS_PRE_SEL_MUX_OUT_DOP /* IFTA100_T4T_01_LTS_PRE_SEL_MUX_OUT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP BCMPKT_TRACE_DOP_ID_IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP /* IFTA100_T4T_02_LTS_HIT_CONTEXT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA100_T4T_02_LTS_PRE_SEL_MUX_OUT_DOP BCMPKT_TRACE_DOP_ID_IFTA100_T4T_02_LTS_PRE_SEL_MUX_OUT_DOP /* IFTA100_T4T_02_LTS_PRE_SEL_MUX_OUT_DOP. */
...
#define BCM_PKTIO_TRACE_DOP_ID_IFTA130_I1T_00_INDEX_DOP BCMPKT_TRACE_DOP_ID_IFTA130_I1T_00_INDEX_DOP /* IFTA130_I1T_00_INDEX_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA130_I1T_01_INDEX_DOP BCMPKT_TRACE_DOP_ID_IFTA130_I1T_01_INDEX_DOP /* IFTA130_I1T_01_INDEX_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA130_I1T_02_INDEX_DOP BCMPKT_TRACE_DOP_ID_IFTA130_I1T_02_INDEX_DOP /* IFTA130_I1T_02_INDEX_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA130_I1T_03_INDEX_DOP BCMPKT_TRACE_DOP_ID_IFTA130_I1T_03_INDEX_DOP /* IFTA130_I1T_03_INDEX_DOP. */
...
#define BCM_PKTIO_TRACE_DOP_ID_IFTA140_I1T_00_INDEX_DOP BCMPKT_TRACE_DOP_ID_IFTA140_I1T_00_INDEX_DOP /* IFTA140_I1T_00_INDEX_DOP. */
...
#define BCM_PKTIO_TRACE_DOP_ID_FLEX_CTR_ST_ING1_TRUTH_TABLE_CMD_OUTPUT_DOP BCMPKT_TRACE_DOP_ID_FLEX_CTR_ST_ING1_TRUTH_TABLE_CMD_OUTPUT_DOP /* FLEX_CTR_ST_ING1_TRUTH_TABLE_CMD_OUTPUT_DOP. */
...
#define BCM_PKTIO_TRACE_DOP_ID_IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP BCMPKT_TRACE_DOP_ID_IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP /* IFTA150_T4T_00_LTS_HIT_CONTEXT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_IFTA150_T4T_00_LTS_PRE_SEL_MUX_OUT_DOP BCMPKT_TRACE_DOP_ID_IFTA150_T4T_00_LTS_PRE_SEL_MUX_OUT_DOP /* IFTA150_T4T_00_LTS_PRE_SEL_MUX_OUT_DOP. */
...
#define BCM_PKTIO_TRACE_DOP_ID_EFTA10_I1T_00_INDEX_DOP BCMPKT_TRACE_DOP_ID_EFTA10_I1T_00_INDEX_DOP /* EFTA10_I1T_00_INDEX_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_EFTA10_I1T_01_INDEX_DOP BCMPKT_TRACE_DOP_ID_EFTA10_I1T_01_INDEX_DOP /* EFTA10_I1T_01_INDEX_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_EFTA10_I1T_02_INDEX_DOP BCMPKT_TRACE_DOP_ID_EFTA10_I1T_02_INDEX_DOP /* EFTA10_I1T_02_INDEX_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_EFTA10_I1T_03_INDEX_DOP BCMPKT_TRACE_DOP_ID_EFTA10_I1T_03_INDEX_DOP /* EFTA10_I1T_03_INDEX_DOP. */
...
#define BCM_PKTIO_TRACE_DOP_ID_EFTA20_I1T_00_INDEX_DOP BCMPKT_TRACE_DOP_ID_EFTA20_I1T_00_INDEX_DOP /* EFTA20_I1T_00_INDEX_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_EFTA20_I1T_01_INDEX_DOP BCMPKT_TRACE_DOP_ID_EFTA20_I1T_01_INDEX_DOP /* EFTA20_I1T_01_INDEX_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_EFTA20_I1T_02_INDEX_DOP BCMPKT_TRACE_DOP_ID_EFTA20_I1T_02_INDEX_DOP /* EFTA20_I1T_02_INDEX_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_EFTA20_I1T_03_INDEX_DOP BCMPKT_TRACE_DOP_ID_EFTA20_I1T_03_INDEX_DOP /* EFTA20_I1T_03_INDEX_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_EFTA20_I1T_04_INDEX_DOP BCMPKT_TRACE_DOP_ID_EFTA20_I1T_04_INDEX_DOP /* EFTA20_I1T_04_INDEX_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_EFTA20_I1T_05_INDEX_DOP BCMPKT_TRACE_DOP_ID_EFTA20_I1T_05_INDEX_DOP /* EFTA20_I1T_05_INDEX_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_EFTA20_I1T_06_INDEX_DOP BCMPKT_TRACE_DOP_ID_EFTA20_I1T_06_INDEX_DOP /* EFTA20_I1T_06_INDEX_DOP. */
...
#define BCM_PKTIO_TRACE_DOP_ID_EFTA30_E2T_00_LTS_HIT_CONTEXT_DOP BCMPKT_TRACE_DOP_ID_EFTA30_E2T_00_LTS_HIT_CONTEXT_DOP /* EFTA30_E2T_00_LTS_HIT_CONTEXT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_EFTA30_E2T_00_LTS_PRE_SEL_MUX_OUT_DOP BCMPKT_TRACE_DOP_ID_EFTA30_E2T_00_LTS_PRE_SEL_MUX_OUT_DOP /* EFTA30_E2T_00_LTS_PRE_SEL_MUX_OUT_DOP. */
...
#define BCM_PKTIO_TRACE_DOP_ID_EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP BCMPKT_TRACE_DOP_ID_EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP /* EFTA30_T4T_00_LTS_HIT_CONTEXT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_EFTA30_T4T_00_LTS_PRE_SEL_MUX_OUT_DOP BCMPKT_TRACE_DOP_ID_EFTA30_T4T_00_LTS_PRE_SEL_MUX_OUT_DOP /* EFTA30_T4T_00_LTS_PRE_SEL_MUX_OUT_DOP. */
...
#define BCM_PKTIO_TRACE_DOP_ID_FLEX_CTR_ST_EGR0_COUNTER_ACTION_VECTOR_DOP BCMPKT_TRACE_DOP_ID_FLEX_CTR_ST_EGR0_COUNTER_ACTION_VECTOR_DOP /* FLEX_CTR_ST_EGR0_COUNTER_ACTION_VECTOR_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_FLEX_CTR_ST_EGR0_COUNTER_POOL_1_UPDATE_CMD_DOP BCMPKT_TRACE_DOP_ID_FLEX_CTR_ST_EGR0_COUNTER_POOL_1_UPDATE_CMD_DOP /* FLEX_CTR_ST_EGR0_COUNTER_POOL_1_UPDATE_CMD_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_FLEX_CTR_ST_EGR0_COUNTER_POOL_2_UPDATE_CMD_DOP BCMPKT_TRACE_DOP_ID_FLEX_CTR_ST_EGR0_COUNTER_POOL_2_UPDATE_CMD_DOP /* FLEX_CTR_ST_EGR0_COUNTER_POOL_2_UPDATE_CMD_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_FLEX_CTR_ST_EGR0_COUNTER_POOL_3_UPDATE_CMD_DOP BCMPKT_TRACE_DOP_ID_FLEX_CTR_ST_EGR0_COUNTER_POOL_3_UPDATE_CMD_DOP /* FLEX_CTR_ST_EGR0_COUNTER_POOL_3_UPDATE_CMD_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_FLEX_CTR_ST_EGR0_COUNTER_POOL_0_UPDATE_CMD_DOP BCMPKT_TRACE_DOP_ID_FLEX_CTR_ST_EGR0_COUNTER_POOL_0_UPDATE_CMD_DOP /* FLEX_CTR_ST_EGR0_COUNTER_POOL_0_UPDATE_CMD_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_FLEX_CTR_ST_EGR0_COUNTER_B_DOP BCMPKT_TRACE_DOP_ID_FLEX_CTR_ST_EGR0_COUNTER_B_DOP /* FLEX_CTR_ST_EGR0_COUNTER_B_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_FLEX_CTR_ST_EGR0_TRIGGER_STATE_CTRL_DOP BCMPKT_TRACE_DOP_ID_FLEX_CTR_ST_EGR0_TRIGGER_STATE_CTRL_DOP /* FLEX_CTR_ST_EGR0_TRIGGER_STATE_CTRL_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_FLEX_CTR_ST_EGR0_COUNTER_A_DOP BCMPKT_TRACE_DOP_ID_FLEX_CTR_ST_EGR0_COUNTER_A_DOP /* FLEX_CTR_ST_EGR0_COUNTER_A_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_FLEX_CTR_ST_EGR0_TRUTH_TABLE_CMD_OUTPUT_DOP BCMPKT_TRACE_DOP_ID_FLEX_CTR_ST_EGR0_TRUTH_TABLE_CMD_OUTPUT_DOP /* FLEX_CTR_ST_EGR0_TRUTH_TABLE_CMD_OUTPUT_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_FLEX_CTR_ST_EGR1_COUNTER_ACTION_VECTOR_DOP BCMPKT_TRACE_DOP_ID_FLEX_CTR_ST_EGR1_COUNTER_ACTION_VECTOR_DOP /* FLEX_CTR_ST_EGR1_COUNTER_ACTION_VECTOR_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_FLEX_CTR_ST_EGR1_COUNTER_POOL_1_UPDATE_CMD_DOP BCMPKT_TRACE_DOP_ID_FLEX_CTR_ST_EGR1_COUNTER_POOL_1_UPDATE_CMD_DOP /* FLEX_CTR_ST_EGR1_COUNTER_POOL_1_UPDATE_CMD_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_FLEX_CTR_ST_EGR1_COUNTER_POOL_2_UPDATE_CMD_DOP BCMPKT_TRACE_DOP_ID_FLEX_CTR_ST_EGR1_COUNTER_POOL_2_UPDATE_CMD_DOP /* FLEX_CTR_ST_EGR1_COUNTER_POOL_2_UPDATE_CMD_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_FLEX_CTR_ST_EGR1_COUNTER_POOL_3_UPDATE_CMD_DOP BCMPKT_TRACE_DOP_ID_FLEX_CTR_ST_EGR1_COUNTER_POOL_3_UPDATE_CMD_DOP /* FLEX_CTR_ST_EGR1_COUNTER_POOL_3_UPDATE_CMD_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_FLEX_CTR_ST_EGR1_COUNTER_POOL_0_UPDATE_CMD_DOP BCMPKT_TRACE_DOP_ID_FLEX_CTR_ST_EGR1_COUNTER_POOL_0_UPDATE_CMD_DOP /* FLEX_CTR_ST_EGR1_COUNTER_POOL_0_UPDATE_CMD_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_FLEX_CTR_ST_EGR1_COUNTER_B_DOP BCMPKT_TRACE_DOP_ID_FLEX_CTR_ST_EGR1_COUNTER_B_DOP /* FLEX_CTR_ST_EGR1_COUNTER_B_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_FLEX_CTR_ST_EGR1_TRIGGER_STATE_CTRL_DOP BCMPKT_TRACE_DOP_ID_FLEX_CTR_ST_EGR1_TRIGGER_STATE_CTRL_DOP /* FLEX_CTR_ST_EGR1_TRIGGER_STATE_CTRL_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_FLEX_CTR_ST_EGR1_COUNTER_A_DOP BCMPKT_TRACE_DOP_ID_FLEX_CTR_ST_EGR1_COUNTER_A_DOP /* FLEX_CTR_ST_EGR1_COUNTER_A_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_FLEX_CTR_ST_EGR1_TRUTH_TABLE_CMD_OUTPUT_DOP BCMPKT_TRACE_DOP_ID_FLEX_CTR_ST_EGR1_TRUTH_TABLE_CMD_OUTPUT_DOP /* FLEX_CTR_ST_EGR1_TRUTH_TABLE_CMD_OUTPUT_DOP. */
...
#define BCM_PKTIO_TRACE_DOP_ID_QOS_REMARKING_LTS_TCAM_KEY_DOP BCMPKT_TRACE_DOP_ID_QOS_REMARKING_LTS_TCAM_KEY_DOP /* QOS_REMARKING_LTS_TCAM_KEY_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_QOS_REMARKING_LTS_TCAM_INDEX_DOP BCMPKT_TRACE_DOP_ID_QOS_REMARKING_LTS_TCAM_INDEX_DOP /* QOS_REMARKING_LTS_TCAM_INDEX_DOP. */
...
#define BCM_PKTIO_TRACE_DOP_ID_EDIT_CTRL_ZONE_4_LTS_TCAM_KEY_DOP BCMPKT_TRACE_DOP_ID_EDIT_CTRL_ZONE_4_LTS_TCAM_KEY_DOP /* EDIT_CTRL_ZONE_4_LTS_TCAM_KEY_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_EDIT_CTRL_ZONE_3_LTS_TCAM_KEY_DOP BCMPKT_TRACE_DOP_ID_EDIT_CTRL_ZONE_3_LTS_TCAM_KEY_DOP /* EDIT_CTRL_ZONE_3_LTS_TCAM_KEY_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_EDIT_CTRL_ZONE_2_LTS_TCAM_KEY_DOP BCMPKT_TRACE_DOP_ID_EDIT_CTRL_ZONE_2_LTS_TCAM_KEY_DOP /* EDIT_CTRL_ZONE_2_LTS_TCAM_KEY_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_EDIT_CTRL_ZONE_1_LTS_TCAM_KEY_DOP BCMPKT_TRACE_DOP_ID_EDIT_CTRL_ZONE_1_LTS_TCAM_KEY_DOP /* EDIT_CTRL_ZONE_1_LTS_TCAM_KEY_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_EDIT_CTRL_ZONE_0_LTS_TCAM_KEY_DOP BCMPKT_TRACE_DOP_ID_EDIT_CTRL_ZONE_0_LTS_TCAM_KEY_DOP /* EDIT_CTRL_ZONE_0_LTS_TCAM_KEY_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_EDIT_CTRL_ZONE_0_LTS_TCAM_INDEX_DOP BCMPKT_TRACE_DOP_ID_EDIT_CTRL_ZONE_0_LTS_TCAM_INDEX_DOP /* EDIT_CTRL_ZONE_0_LTS_TCAM_INDEX_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_EDIT_CTRL_ZONE_1_LTS_TCAM_INDEX_DOP BCMPKT_TRACE_DOP_ID_EDIT_CTRL_ZONE_1_LTS_TCAM_INDEX_DOP /* EDIT_CTRL_ZONE_1_LTS_TCAM_INDEX_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_EDIT_CTRL_ZONE_2_LTS_TCAM_INDEX_DOP BCMPKT_TRACE_DOP_ID_EDIT_CTRL_ZONE_2_LTS_TCAM_INDEX_DOP /* EDIT_CTRL_ZONE_2_LTS_TCAM_INDEX_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_EDIT_CTRL_ZONE_3_LTS_TCAM_INDEX_DOP BCMPKT_TRACE_DOP_ID_EDIT_CTRL_ZONE_3_LTS_TCAM_INDEX_DOP /* EDIT_CTRL_ZONE_3_LTS_TCAM_INDEX_DOP. */
#define BCM_PKTIO_TRACE_DOP_ID_EDIT_CTRL_ZONE_4_LTS_TCAM_INDEX_DOP BCMPKT_TRACE_DOP_ID_EDIT_CTRL_ZONE_4_LTS_TCAM_INDEX_DOP /* EDIT_CTRL_ZONE_4_LTS_TCAM_INDEX_DOP. */
...
/* Loopback module header field IDs. */
#define BCM_PKTIO_LBHDR_FID_INVALID         BCMPKT_LBHDR_FID_INVALID /* Invalid BCMPKT_LBHDR
                                                          FID indicator */
#define BCM_PKTIO_LBHDR_START               BCMPKT_LBHDR_START /* Start of frame
                                                          indicator (must be set
                                                          to 0xFB) */
#define BCM_PKTIO_LBHDR_HEADER_TYPE         BCMPKT_LBHDR_HEADER_TYPE /* 64 Header Types
                                                          Supported. 1 means
                                                          packets from CPU with
                                                          SOBMH header format to
                                                          Passthru NLF. */
#define BCM_PKTIO_LBHDR_INPUT_PRIORITY      BCMPKT_LBHDR_INPUT_PRIORITY /* Indicates the loopback
                                                          COS queue and is used
                                                          by the MMU for per
                                                          application group
                                                          accounting for packets
                                                          received from the
                                                          internal loopback
                                                          port. This must be put
                                                          the PBI.INPUT_PRIORITY
                                                          whenever the source
                                                          port is the loopback
                                                          port. */
...
#define BCM_PKTIO_LBHDR_VISIBILITY_PKT      BCMPKT_LBHDR_VISIBILITY_PKT /* Triggers capture of
                                                          ...
                                                          this packet. */
#define BCM_PKTIO_LBHDR_SOURCE              BCMPKT_LBHDR_SOURCE /* Source field for the
                                                          packet.
                                                          SOURCE_TYPE=0x0:
                                                          [15:0] SOURCE_VP.
                                                          SOURCE_TYPE=0x1:
                                                          [15:8] SRC_MODID,
                                                          [7:0] SRC_PORT. */
#define BCM_PKTIO_LBHDR_SOURCE_TYPE         BCMPKT_LBHDR_SOURCE_TYPE /* Indicates contents of
                                                          SOURCE field. 0x1:
                                                          SGPP 0x0: SVP. */
...
#define BCM_PKTIO_LBHDR_ETH_DEST            BCMPKT_LBHDR_ETH_DEST /* Destination based on
                                                          ...
                                                          cases, this field
                                                          contains
                                                          ECMP_GROUP_PTR). Valid
                                                          only if
                                                          SUBFLOW_TYPE=CPU_TX_PROC. */
#define BCM_PKTIO_LBHDR_ETH_DP              BCMPKT_LBHDR_ETH_DP /* Drop precedence for
                                                          the apcket. Valid only
                                                          if
                                                          SUBFLOW_TYPE=CPU_TX_PROC. */
#define BCM_PKTIO_LBHDR_ETH_ECMP_MEMBER_ID  BCMPKT_LBHDR_ETH_ECMP_MEMBER_ID /* ECMP member ID for
                                                          ...
                                                          if
                                                          SUBFLOW_TYPE=CPU_TX_PROC. */
#define BCM_PKTIO_LBHDR_ETH_INT_CN          BCMPKT_LBHDR_ETH_INT_CN /* Internal Congestion to
                                                          be used for the
                                                          packet. Valid only if
                                                          SUBFLOW_TYPE=CPU_TX_PROC. */
#define BCM_PKTIO_LBHDR_ETH_INT_PRI         BCMPKT_LBHDR_ETH_INT_PRI /* Internal priority to
                                                          be used for the
                                                          packet. Valid only if
                                                          SUBFLOW_TYPE=CPU_TX_PROC. */
...
#define BCM_PKTIO_LBHDR_ETH_MCAST_LB_INDEX_VLD BCMPKT_LBHDR_ETH_MCAST_LB_INDEX_VLD /* If set, MCAST_LB_INDEX
                                                          field is valid. */
#define BCM_PKTIO_LBHDR_ETH_PP_PORT         BCMPKT_LBHDR_ETH_PP_PORT /* Device Port Number
                                                          which is to be used
                                                          for processing packet
                                                          in Ingress Pipeline. */
#define BCM_PKTIO_LBHDR_ETH_QOS_FIELDS_VLD  BCMPKT_LBHDR_ETH_QOS_FIELDS_VLD /* If set, the qos fields
                                                          ...
                                                          only if
                                                          SUBFLOW_TYPE=CPU_TX_PROC. */
#define BCM_PKTIO_LBHDR_ETH_ROUTED_PKT      BCMPKT_LBHDR_ETH_ROUTED_PKT /* Indicates whether
                                                          packets should be
                                                          treated as routed or
                                                          bridged. Valid only if
                                                          SUBFLOW_TYPE=CPU_TX_PROC. */
...
#define BCM_PKTIO_LBHDR_ZERO                BCMPKT_LBHDR_ZERO /* MUST Always be 0 */
#define BCM_PKTIO_LBHDR_PP_PORT             BCMPKT_LBHDR_PP_PORT /* Device Port Number
                                                          which is to be used
                                                          for processing packet
                                                          in Ingress Pipeline. */
#define BCM_PKTIO_LBHDR_ROUTED_PKT          BCMPKT_LBHDR_ROUTED_PKT /* Indicates whether
                                                          packets should be
                                                          treated as routed or
                                                          bridged. Valid only if
                                                          SUBFLOW_TYPE=CPU_TX_PROC. */
#define BCM_PKTIO_LBHDR_VRF                 BCMPKT_LBHDR_VRF /* VRF */
#define BCM_PKTIO_LBHDR_VRF_VALID           BCMPKT_LBHDR_VRF_VALID /* VRF valid */
#define BCM_PKTIO_LBHDR_QOS_FIELD_VALID     BCMPKT_LBHDR_QOS_FIELD_VALID /* Qos field valid */
#define BCM_PKTIO_LBHDR_OPAQUE_OBJECT       BCMPKT_LBHDR_OPAQUE_OBJECT /* Opaque object */
#define BCM_PKTIO_LBHDR_QOS_FIELD_ETH       BCMPKT_LBHDR_QOS_FIELD_ETH /* Qos field ethernet */
#define BCM_PKTIO_LBHDR_INT_PRI_ETH         BCMPKT_LBHDR_INT_PRI_ETH /* Internal priority
                                                          ethernet */
#define BCM_PKTIO_LBHDR_INT_CN_ETH          BCMPKT_LBHDR_INT_CN_ETH /* Internal CN ethernet */
#define BCM_PKTIO_LBHDR_CNG_ETH             BCMPKT_LBHDR_CNG_ETH /* CNG ethernet */
#define BCM_PKTIO_LBHDR_FID_COUNT           BCMPKT_LBHDR_FID_COUNT /* LBHDR field ID number */

/* BCM_PKTIO_LBHDR_HEADER_TYPE encodings. */
...
#define BCM_PKTIO_LBHDR_HEADER_T_MIM        BCMPKT_LBHDR_HEADER_T_MIM /* MAC in MAC packets to
                                                          Passthru NLF */
#define BCM_PKTIO_LBHDR_HEADER_T_QCN        BCMPKT_LBHDR_HEADER_T_QCN /* QCN Packets to
                                                          Passthru NLF */
#define BCM_PKTIO_LBHDR_HEADER_T_GENERIC    BCMPKT_LBHDR_HEADER_T_GENERIC /* Generic loopback */
#define BCM_PKTIO_LBHDR_HEADER_T_LOOPBACK_MH BCMPKT_LBHDR_HEADER_T_LOOPBACK_MH /* LB Hdr type ETH */
#define BCM_PKTIO_LBHDR_HEADER_T_TRANSPORT  BCMPKT_LBHDR_HEADER_T_TRANSPORT /* Transport header */

/* BCM_PKTIO_LBHDR_ETH_DEST_TYPE encodings. */
#define BCM_PKTIO_LBHDR_ETH_DEST_T_DGLP     BCMPKT_LBHDR_ETH_DEST_T_DGLP /* Destination GLP. Note
...
/* BCM_PKTIO_LBHDR_ETH_SUBFLOW_TYPE encodings. */
