...
#define BCM_XFLOW_MACSEC_SECURE_CHAN_ID_WITH_INSTANCE_CREATE(inst, flag, chan_id)                  \
                XFLOW_MACSEC_SECURE_CHAN_ID_WITH_INSTANCE_CREATE(inst, flag, chan_id) 
...
#define BCM_XFLOW_MACSEC_IPSEC_SECURE_CHAN_ENCRYPT_SVTAG_OFFSET_TO_ESP XFLOW_MACSEC_IPSEC_SECURE_CHAN_ENCRYPT_SVTAG_OFFSET_TO_ESP /* Add the offset
                                                          ...
                                                          to ESP offset. */
#define BCM_XFLOW_MACSEC_IPSEC_SECURE_CHAN_RFC_6054_ENABLE XFLOW_MACSEC_IPSEC_SECURE_CHAN_RFC_6054_ENABLE /* Support RFC 6054 on
                                                          this IPSEC secure
                                                          channel. */
#define BCM_XFLOW_MACSEC_IPSEC_SECURE_CHAN_SPECULATIVE_PARSING_ENABLE XFLOW_MACSEC_IPSEC_SECURE_CHAN_SPECULATIVE_PARSING_ENABLE /* Support speculative
                                                          parsing on this IPSEC
                                                          secure channel. */
...
#define BCM_XFLOW_MACSEC_SECURE_ASSOC_ID_WITH_INSTANCE_CREATE(inst, flag, assoc_id)                  \
                XFLOW_MACSEC_SECURE_ASSOC_ID_WITH_INSTANCE_CREATE(inst, flag, assoc_id) 
...
#define BCM_XFLOW_MACSEC_DECRYPT_POLICY_ID_WITH_INSTANCE_CREATE(instance, id)                  \
                XFLOW_MACSEC_POLICY_ID_WITH_INSTANCE_CREATE(instance, BCM_XFLOW_MACSEC_DECRYPT, id) 
...
#define BCM_XFLOW_MACSEC_DECRYPT_FLOW_ID_WITH_INSTANCE_CREATE(instance, id)                  \
                XFLOW_MACSEC_FLOW_ID_WITH_INSTANCE_CREATE(instance, XFLOW_MACSEC_DECRYPT, id) 
...
typedef enum bcm_xflow_macsec_control_e {
    ...
    bcmXflowMacsecIpsecControlPNThreshold = xflowMacsecIpsecControlPNThreshold, 
    bcmXflowMacsecIpsecControlXPNThreshold = xflowMacsecIpsecControlXPNThreshold, 
    ...
    bcmXflowMacsecControlPNThresholdMask0 = xflowMacsecControlPNThresholdMask0, 
    bcmXflowMacsecControlPNThresholdMask1 = xflowMacsecControlPNThresholdMask1, 
    bcmXflowMacsecControlPNThresholdMask2 = xflowMacsecControlPNThresholdMask2, 
    bcmXflowMacsecControlPNThresholdMask3 = xflowMacsecControlPNThresholdMask3, 
    bcmXflowMacsecIpsecControlXPNThresholdMask0 = xflowMacsecIpsecControlXPNThresholdMask0, 
    bcmXflowMacsecIpsecControlXPNThresholdMask1 = xflowMacsecIpsecControlXPNThresholdMask1, 
    bcmXflowMacsecIpsecControlXPNThresholdMask2 = xflowMacsecIpsecControlXPNThresholdMask2, 
    bcmXflowMacsecIpsecControlXPNThresholdMask3 = xflowMacsecIpsecControlXPNThresholdMask3, 
    bcmXflowMacsecIpsecControlPNThresholdMask0 = xflowMacsecIpsecControlPNThresholdMask0, 
    bcmXflowMacsecIpsecControlPNThresholdMask1 = xflowMacsecIpsecControlPNThresholdMask1, 
    bcmXflowMacsecIpsecControlPNThresholdMask2 = xflowMacsecIpsecControlPNThresholdMask2, 
    bcmXflowMacsecIpsecControlPNThresholdMask3 = xflowMacsecIpsecControlPNThresholdMask3, 
    ...
    bcmXflowMacsecIpsecControlNextHopDummy1 = xflowMacsecIpsecControlNextHopDummy1, 
    bcmXflowMacsecIpsecControlNextHopDummy2 = xflowMacsecIpsecControlNextHopDummy2, 
    bcmXflowMacsecIpsecControlNextHopDummy3 = xflowMacsecIpsecControlNextHopDummy3, 
    ...
    bcmxflowMacsecIpsecControlDummyPktStrictChk = xflowMacsecIpsecControlDummyPktStrictChk, 
    bcmXflowMacsecControlEncryptMaxNofAnValues = xflowMacsecControlEncryptMaxNofAnValues, 
    bcmXflowMacsecControlCount = xflowMacsecControlCount 
} bcm_xflow_macsec_control_t;

#define BCM_XFLOW_MACSEC_CONTROL_STR \
    "bcmXflowMacsecControlPNThreshold", \
    "bcmXflowMacsecControlXPNThreshold", \
    "bcmXflowMacsecIpsecControlPNThreshold", \
    "bcmXflowMacsecIpsecControlXPNThreshold", \
    "bcmXflowMacsecControlEncryptFailCopyToCpu", \
    "bcmXflowMacsecControlDecryptFailCopyToCpu", \
    "bcmXflowMacsecControlEncryptFailDrop", \
    "bcmXflowMacsecControlDecryptFailDrop", \
    "bcmXflowMacsecControlMgmtMTU", \
    "bcmXflowMacsecControlSVTagEnable", \
    "bcmXflowMacsecControlPTPDestPortGeneral", \
    "bcmXflowMacsecControlPTPDestPortEvent", \
    "bcmXflowMacsecControlPbbTpidBTag", \
    "bcmXflowMacsecControlPbbTpidITag", \
    "bcmXflowMacsecControlEtypeNIV", \
    "bcmXflowMacsecControlEtypePE", \
    "bcmXflowMacsecControlEtypeMgmt0", \
    "bcmXflowMacsecControlEtypeMgmt1", \
    "bcmXflowMacsecControlEtypeMgmt2", \
    "bcmXflowMacsecControlEtypeMgmt3", \
    "bcmXflowMacsecControlEtypeMgmt4", \
    "bcmXflowMacsecControlEtypeMgmt5", \
    "bcmXflowMacsecControlEtypeMgmt6", \
    "bcmXflowMacsecControlEtypeMgmt7", \
    "bcmXflowMacsecControlVxLANSecDestPort", \
    "bcmXflowMacsecControlOutDestPort", \
    "bcmXflowMacsecControlMplsEtype0", \
    "bcmXflowMacsecControlMplsEtype1", \
    "bcmXflowMacsecControlMplsEtype2", \
    "bcmXflowMacsecControlMplsEtype3", \
    "bcmXflowMacsecControlSVTagTPIDEtype", \
    "bcmXflowMacsecControlSelIpInfoAfterMplsBos", \
    "bcmXflowMacsecControlSvtagSopErrorDrop", \
    "bcmXflowMacsecControlXPNThresholdMask0", \
    "bcmXflowMacsecControlXPNThresholdMask1", \
    "bcmXflowMacsecControlXPNThresholdMask2", \
    "bcmXflowMacsecControlXPNThresholdMask3", \
    "bcmXflowMacsecControlPNThresholdMask0", \
    "bcmXflowMacsecControlPNThresholdMask1", \
    "bcmXflowMacsecControlPNThresholdMask2", \
    "bcmXflowMacsecControlPNThresholdMask3", \
    "bcmXflowMacsecIpsecControlXPNThresholdMask0", \
    "bcmXflowMacsecIpsecControlXPNThresholdMask1", \
    "bcmXflowMacsecIpsecControlXPNThresholdMask2", \
    "bcmXflowMacsecIpsecControlXPNThresholdMask3", \
    "bcmXflowMacsecIpsecControlPNThresholdMask0", \
    "bcmXflowMacsecIpsecControlPNThresholdMask1", \
    "bcmXflowMacsecIpsecControlPNThresholdMask2", \
    "bcmXflowMacsecIpsecControlPNThresholdMask3", \
    "bcmXflowMacsecIpsecControlUdpDstPortWithNonEsp", \
    "bcmXflowMacsecIpsecControlUdpDstPortWithoutNonEsp", \
    "bcmXflowMacsecIpsecControlNatUdpDstPort", \
    "bcmXflowMacsecIpsecControlNatUdpSrcPort", \
    "bcmXflowMacsecIpsecControlESPUdpDstPort", \
    "bcmXflowMacsecIpsecControlESPUdpSrcPort", \
    "bcmXflowMacsecIpsecControlIncrementPadBytes", \
    "bcmXflowMacsecIpsecControlNextHopDummy", \
    "bcmXflowMacsecIpsecControlNextHopDummy1", \
    "bcmXflowMacsecIpsecControlNextHopDummy2", \
    "bcmXflowMacsecIpsecControlNextHopDummy3", \
    "bcmXflowMacsecControlUdpDestPort", \
    "bcmXflowMacsecControlTcpDestPort", \
    "bcmXflowMacsecControlSectagE0C1Error", \
    "bcmXflowMacsecControlMibOctetMode", \
    "bcmXflowMacsecIpsecControlEspTrailPadChk", \
    "bcmXflowMacsecIpsecControlIncrByteForEspTrailPadChk", \
    "bcmXflowMacsecControlSecurePktIpLengthChk", \
    "bcmXflowMacsecIpsecControlSecurePktIpLengthChk", \
    "bcmxflowMacsecIpsecControlDummyPktStrictChk", \
    "bcmXflowMacsecControlEncryptMaxNofAnValues", \
    "bcmXflowMacsecControlCount" 
...
#define BCM_XFLOW_MACSEC_MAC_ADDR_CONTROL_STR \
    "bcmXflowMacsecMgmtDstMac0", \
    "bcmXflowMacsecMgmtDstMac1", \
    "bcmXflowMacsecMgmtDstMac2", \
    "bcmXflowMacsecMgmtDstMac3", \
    "bcmXflowMacsecMgmtDstMac4", \
    "bcmXflowMacsecMgmtDstMac5", \
    "bcmXflowMacsecMgmtDstMac6", \
    "bcmXflowMacsecMgmtDstMac7", \
    "bcmXflowMacsecMgmtDstMacRangeLow", \
    "bcmXflowMacsecMgmtDstMacRangeHigh", \
    "bcmXflowMacsecMgmtDstMacEthertype0", \
    "bcmXflowMacsecMgmtDstMacEthertype1", \
    "bcmXflowMacsecStationDstMac", \
    "bcmXflowMacsecMacAddrControlCount" 
...
typedef enum bcm_xflow_macsec_port_control_e {
    ...
    bcmXflowMacsecIPsecPortNatKeepalive = xflowMacsecIPsecPortNatKeepalive, /* Enable NAT keepalive packet
                                           detection. */
    bcmXflowMacsecPortPFCTransmit = xflowMacsecPortPFCTransmit, /* Enable PFC frame generation */
    bcmXflowMacsecPortPFCReceive = xflowMacsecPortPFCReceive, /* Enable PFC frame detection */
    bcmXflowMacsecPortPFCRefreshTime = xflowMacsecPortPFCRefreshTime, /* Set PFC Refresh Time. */
    bcmXflowMacsecPortPFCXoffTime = xflowMacsecPortPFCXoffTime, /* Set pause time sent on XOFF mode of a
                                           transmitted PFC Frame . */
    bcmXflowMacsecPortLLFCTransmit = xflowMacsecPortLLFCTransmit, /* Enable PAUSE frame detection and
                                           generation. */
    bcmXflowMacsecPortLLFCReceive = xflowMacsecPortLLFCReceive, /* Enable PAUSE frame detection and
                                           generation. */
    bcmXflowMacsecPortLLFCRefreshTime = xflowMacsecPortLLFCRefreshTime, /* Set PAUSE Refresh Time . */
    bcmXflowMacsecPortLLFCXoffTime = xflowMacsecPortLLFCXoffTime, /* Set pause time sent on XOFF mode of a
                                           transmitted PAUSE Frame. */
    bcmXflowMacsecPortCount = xflowMacsecPortCount /* Maximum enum value. */
} bcm_xflow_macsec_port_control_t;

#define BCM_XFLOW_MACSEC_PORT_CONTROL_STR \
    "bcmXflowMacsecPortSectagEtypeSel", \
    "bcmXflowMacsecPortSectagVersion", \
    "bcmXflowMacsecPortSectagRuleEnable", \
    "bcmXflowMacsecPortTPIDEnable", \
    "bcmXflowMacsecPortPBBEnable", \
    "bcmXflowMacsecPortMPLSEnable", \
    "bcmXflowMacsecPortIPv4EtypeEnable", \
    "bcmXflowMacsecPortIPv6EtypeEnable", \
    "bcmXflowMacsecPortPTPEtypeEnable", \
    "bcmXflowMacsecPortNIVEtypeEnable", \
    "bcmXflowMacsecPortPEEtypeEnable", \
    "bcmXflowMacsecPortUDPEnable", \
    "bcmXflowMacsecPortTCPEnable", \
    "bcmXflowMacsecPortPTPDestPortEnable", \
    "bcmXflowMacsecPortPTPMatchRuleEnable", \
    "bcmXflowMacsecPortSectagAfterIPv4Enable", \
    "bcmXflowMacsecPortSectagAfterIPv6Enable", \
    "bcmXflowMacsecPortSectagAfterTCPEnable", \
    "bcmXflowMacsecPortSectagAfterUDPEnable", \
    "bcmXflowMacsecPortIPv4ChecksumEnable", \
    "bcmXflowMacsecPortVxLANIpv6UDPVNIMatchEnable", \
    "bcmXflowMacsecPortMTU", \
    "bcmXflowMacsecPortMgmtPktRulesEnable", \
    "bcmXflowMacsecPortMgmtDefaultSubPort", \
    "bcmXflowMacsecPortBasedScEnable", \
    "bcmXflowMacsecPortEnable", \
    "bcmXflowMacsecIPsecPortEsp", \
    "bcmXflowMacsecIPsecPortEspUdp", \
    "bcmXflowMacsecIPsecPortEspSnZero", \
    "bcmXflowMacsecIPsecPortEspSpiZero", \
    "bcmXflowMacsecIPsecPortEspSpi1To255", \
    "bcmXflowMacsecIPsecPortIPv4Fragment", \
    "bcmXflowMacsecIPsecPortEspUdpSrcPort", \
    "bcmXflowMacsecIPsecPortNatKeepalive", \
    "bcmXflowMacsecPortPFCTransmit", \
    "bcmXflowMacsecPortPFCReceive", \
    "bcmXflowMacsecPortPFCRefreshTime", \
    "bcmXflowMacsecPortPFCXoffTime", \
    "bcmXflowMacsecPortLLFCTransmit", \
    "bcmXflowMacsecPortLLFCReceive", \
    "bcmXflowMacsecPortLLFCRefreshTime", \
    "bcmXflowMacsecPortLLFCXoffTime", \
    "bcmXflowMacsecPortCount" 
...
typedef xflow_macsec_svtag_map_info_t bcm_xflow_macsec_svtag_map_info_t;

#ifndef BCM_HIDE_DISPATCHABLE

/* 
 * Map local SC index to a global SC index, which will be used when
 * filling the SVTAG header
 */
extern int bcm_xflow_macsec_svtag_map_set(
    int unit, 
    uint32 flags, 
    bcm_xflow_macsec_secure_chan_id_t id, 
    bcm_xflow_macsec_svtag_map_info_t *map_info);

/* Get the global SC index to which a local SC index is mapped */
extern int bcm_xflow_macsec_svtag_map_get(
    int unit, 
    uint32 flags, 
    bcm_xflow_macsec_secure_chan_id_t id, 
    bcm_xflow_macsec_svtag_map_info_t *map_info);
