...
typedef enum bcm_switch_control_e {
    ...
    bcmSwitchMultipathCompressBuffer = 715, /* Set the size of the L3 ECMP table
                                           defragmentation buffer. In
                                           hierarchical ECMP, if
                                           MultipathOverlayCompressBuffer is not
                                           set explicitly,
                                           MultipathCompressBuffer sets the size
                                           for both underlay and overlay
                                           defragment buffers. If
                                           MultipathOverlayCompressBuffer is set
                                           explicitly, MultipathCompressBuffer
                                           sets only the size for underlay
                                           defragment buffer. */
    ...
    bcmSwitchEcnNonTcpResponsive = 1228, /* Set default responsive indication
                                           ...
                                           NON-IP packets. */
    bcmSwitchHigig3Ethertype = 1229,    /* Set HIGIG3 Ethernet type. */
    ...
    bcmSwitchBufUseMode = 1560,         /* Cosq buffer usage mode. Auto: 0,
                                           ...
                                           specified values. */
    bcmSwitchSynchronousPortClockSourceSet1 = 1561, /* Set ITU-T G.8261/8262 synchronous
                                           Ethernet recovered clock source.
                                           Configure master clock to set1. */
    bcmSwitchSynchronousPortClockSourceSet1DivCtrl = 1562, /* Set ITU-T G.8261/8262 synchronous
                                           Ethernet recovered clock source.
                                           Selects master clock divide to set1. */
    bcmSwitchSynchronousPortClockSourceBkupSet1 = 1563, /* Set ITU-T G.8261/8262 synchronous
                                           Ethernet recovered clock source.
                                           Configure slave clock to set1. */
    bcmSwitchSynchronousPortClockSourceBkupSet1DivCtrl = 1564, /* Set ITU-T G.8261/8262 synchronous
                                           Ethernet recovered clock source.
                                           Selects slave clock divide to set1. */
    bcmSwitchEgressUDHBaseFieldCsMap = 1565, /* Map egress UDH base to UDH base CS
                                           var. */
    bcmSwitchStatEgrL3IntfUnderlayPool = 1566, /* Enable different pool for EgrL3Intf
                                           underlay. */
    bcmSwitchEccSingleBitSwCorrectionEvent = 1567, /* Enable/Disable 1bit ECC error
                                           reporting for memories which 1bit
                                           error can be corrected by SW. */
    bcmSwitchL2GlobalStationMode = 1568, /* L2 global station modes. Default is
                                           disable. */
    bcmSwitchHashUseFlowSelEcmpTertiary = 1569, /* Enable/Disable flow based hashing for
                                           tertiary ECMP. */
    bcmSwitchHashUseFlowSelEcmpSecondaryResilientHash = 1570, /* Enable/Disable flow based hashing for
                                           secondary ECMP resilient hashing. */
    bcmSwitchHashUseFlowSelEcmpWeightedSecondary = 1571, /* Enable/Disable flow based hashing for
                                           secondary weighted ECMP. */
    bcmSwitchEcmpTertiaryRandomSeed = 1572, /* Random seed value for tertiary ECMP. */
    bcmSwitchEcmpWeightedOverlayRandomSeed = 1573, /* Random seed value for overlay
                                           weighted ECMP. */
    bcmSwitchEcmpWeightedRandomSeed = 1574, /* Random seed value for weighted ECMP. */
    bcmSwitchEcmpWeightedSecondaryRandomSeed = 1575, /* Random seed value for secondary
                                           weighted ECMP. */
    bcmSwitchHashUseFlowSelL2EcmpSecondary = 1576, /* Enable/Disable L2 traffic flow based
                                           hashing of secondary ECMP. */
    bcmSwitchMacroFlowHashShuffleRandomSeed = 1577, /* Random seed for flow based RTAG7 hash
                                           shuffling. */
    bcmSwitchWideDataExtKeyMode = 1578, /* wide data extension key mode. */
    bcmSwitchEgressFieldCopyToCpuDropEnable = 1579, /* Enable copy to CPU packets drop in
                                           action bcmFieldActionDrop at egress. */
    bcmSwitchSampleEgressFlexRandomSeed = 1580, /* Set sFlow flex RNG seed at egress. */
    bcmSwitchEgressAdaptEnable = 1581,  /* Enable/disable egress adaptation
                                           table lookup. */
    bcmSwitchL3VpbrTunnel = 1582,       /* In case enabled L3 VPBR tunnel can be
                                           used, note: tunnel Termination TCAM
                                           DB is disabled. */
    bcmSwitchVxlanGbpFlexEnable = 1583, /* Requires BROADCOM_PREMIUM license */
    bcmSwitchVxlanGbpFlags = 1584,      /* Requires BROADCOM_PREMIUM license */
    bcmSwitchHigig3EthertypeMask = 1585, /* Set HIGIG3 ethernet type mask. */
    bcmSwitchLoopbackToLoopbackDrop = 1586, /* Enable loopback to loopback drop. */
    bcmSwitchHashUseFlowSelMplsEcmpSecondary = 1587, /* Enable/Disable flow based hashing of
                                           secondary ECMP for MPLS packets. */
    bcmSwitchHashEnable = 1588,         /* Enable/Disable RTAG7 hash. */
    bcmSwitchL3EgressFailoverEnable = 1589, /* Enable/Disable L3 egress object
                                           failover when failover is triggered
                                           by bcm_failover_status_set. */
    bcmSwitchPortL3EgressFailoverEnable = 1590, /* Enable/Disable L3 egress object
                                           failover when the egress port is
                                           down. */
    bcmSwitchTunnelTermEnable = 1591,   /* Enable/Disable tunnel termination. */
    bcmSwitchTunnelTermExactMatchEnable = 1592, /* Enable/Disable tunnel termination on
                                           exact match. */
    bcmSwitchTunnelInitDisableOverride = 1593, /* Override tunnel initiation disabling. */
    bcmSwitchTunnelTermDisableOverride = 1594, /* Override tunnel termination
                                           disabling. */
    bcmSwitchEcmpEnable = 1595,         /* Enable/Disable ECMP. */
    bcmSwitchEpRecircInputPriBase = 1596, /* Input priority base used on EPRC. */
    bcmSwitchTwampStatelessModeEnable = 1597, /* Enable/Disable TWAMP stateless mode. */
    bcmSwitchSamplingTxStatType = 1598, /* TX stat type for sampling. Valid
                                           values in
                                           bcm_switch_sampling_tx_stat_type_t. */
    bcmSwitchDosAttackInnerIcmpPktOversize = 1599, /* Max packet size for Inner ICMP size
                                           check. */
    bcmSwitchDosAttackMinInnerTcpHdrSize = 1600, /* Header length for min Inner TCP
                                           header checking. */
    bcmSwitchDosAttackInnerIcmpV6PingSize = 1601, /* Max packet size for Inner v6 ping
                                           check. */
    bcmSwitchDosAttackInnerV6MinFragSize = 1602, /* Min packet size for fragmented Inner
                                           IPv6. */
    bcmSwitchL2TunnelBasedTermQosEnable = 1603, /* Enable/Disable L2 tunnel based DSCP
                                           and 802.1p/CFI to internal
                                           priority/CNG mapping for termination. */
    bcmSwitchControlProtSwitchLinkSourceSelect = 1604, /* Select link source from one of the
                                           signal inputs for each protection
                                           switching link (indexed). */
    bcmSwitchControlProtSwitchLinkSwOverrideEnable = 1605, /* Enable software override for
                                           protection switching link status. */
    bcmSwitchControlProtSwitchLinkSwOverrideValue = 1606, /* Specify SW override value for the
                                           protection switching link status
                                           (indexed). */
    bcmSwitchControlProtSwitchLinkStatus = 1607, /* Get protection switching link status
                                           (indexed and read-only). */
    bcmSwitchSrv6UsidPrefixBits = 1608, /* Allow support of multiple USID prefix
                                           sizes. */
    bcmSwitchSubportTagType = 1609,     /* Configure subport tag type (e.g.
                                           SVTAG/EPMTAG) or disable subport tag.
                                           Refer to
                                           bcm_switch_subport_tag_type_t. */
    bcmSwitchSubportTagDefault = 1610,  /* Configure default value of the egress
                                           subport tag. */
    bcmSwitchInnerMplsUdpDstPortEnable = 1611, /* Enable to match against the
                                           destination UDP port to identify the
                                           inner MPLS label stack in IP tunnel
                                           packets. */
    bcmSwitchInnerMplsUdpDstPort = 1612, /* Value to match against the
                                           destination UDP port to identify the
                                           inner MPLS label stack in IP tunnel
                                           packets. */
    bcmSwitchInnerMplsIpProtocolEnable = 1613, /* Enable to match against the IP
                                           protocol to identify the inner MPLS
                                           label stack in IP tunnel packets. */
    bcmSwitchInnerMplsIpProtocol = 1614, /* Value to match against the IP
                                           protocol to identify the inner MPLS
                                           label stack in IP tunnel packets. */
    bcmSwitchInnerMplsGreUcEthertypeEnable = 1615, /* Enable to match against the ethertype
                                           to identify the inner MPLS label
                                           stack in unicast IP GRE tunnel
                                           packets. */
    bcmSwitchInnerMplsGreUcEthertype = 1616, /* Value to match against the ethertype
                                           to identify the inner MPLS label
                                           stack in unicast IP GRE tunnel
                                           packets. */
    bcmSwitchInnerMplsGreMcEthertypeEnable = 1617, /* Enable to match against the ethertype
                                           to identify the inner MPLS label
                                           stack in multicast IP GRE tunnel
                                           packets. */
    bcmSwitchInnerMplsGreMcEthertype = 1618, /* Value to match against the ethertype
                                           to identify the inner MPLS label
                                           stack in multicast IP GRE tunnel
                                           packets. */
    bcmSwitchPktDropOnPortHigig3CheckToCpu = 1619, /* Dropped HIGIG3/non-HIGIG3 packets
                                           copied to CPU. Packets drop is due to
                                           BCM_PORT_ENCAP_IEEE or
                                           BCM_PORT_ENCAP_HIGIG3 configuration
                                           in bcm_port_encap_config_set for
                                           HIGIG3 allowance check. */
    bcmSwitchReflectorL2IntPriority = 1620, /* Priority of recycle packet for L2
                                           Internal reflector. */
    bcmSwitchPfcRxSvtagEnable = 1621,   /* Enable PFC for SVTAG. */
    bcmSwitchTrunkEgressSvtagLookupEnable = 1622, /* Enable or disable SVTAG ESEM command
                                           lookup over the given trunk. */
    bcmSwitchMirrorErspanGreKeyEnable = 1623, /* Requires BROADCOM_PREMIUM license */
    bcmSwitchTwampStatelessContext = 1624, /* Field Processor context for Twamp
                                           Stateless Mode. */
    bcmSwitchDcnPoolHighWatermarkClearOnRead = 1625, /* Enable clear on read of the high
                                           watermark counter in DCN pool. */
    bcmSwitchDcnCosqEnable = 1626,      /* Enable DCN in COSQ. */
    bcmSwitchGbpShimEtherType = 1627,   /* EtherType field in GBP Shim header */
    bcmSwitchGbpShimSubType = 1628,     /* SubType field in GBP Shim header */
    bcmSwitchGbpShimVersion = 1629,     /* Version field in GBP Shim header */
    bcmSwitchUdfInnerL3OffsetAfterMplsBos = 1630, /* Use the position of the first byte
                                           after the bottom of the MPLS label
                                           stack as UDF inner L3 the MPLS label
                                           stack as UDF inner L3. */
    bcmSwitchMacroFlowEcmpSecondaryHashConcatEnable = 1631, /* Enable hash concatenation for
                                           secondary ECMP macroflow. */
    bcmSwitchMacroFlowEcmpSecondaryHashMinOffset = 1632, /* Minimum offset value to be used in
                                           RTAG7 macroflow for secondary ECMP. */
    bcmSwitchMacroFlowEcmpSecondaryHashMaxOffset = 1633, /* Maximum offset value to be used in
                                           RTAG7 macroflow for secondary ECMP. */
    bcmSwitchMacroFlowEcmpSecondaryHashStrideOffset = 1634, /* Offset increment value to be used in
                                           RTAG7 macroflow for secondary ECMP. */
    bcmSwitchMacroFlowEcmpTertiaryHashConcatEnable = 1635, /* Enable hash concatenation for
                                           tertiary ECMP macro flow. */
    bcmSwitchMacroFlowEcmpTertiaryHashMinOffset = 1636, /* Minimum offset value to be used in
                                           RTAG7 macroflow for tertiary ECMP. */
    bcmSwitchMacroFlowEcmpTertiaryHashMaxOffset = 1637, /* Maximum offset value to be used in
                                           RTAG7 macroflow for tertiary ECMP. */
    bcmSwitchMacroFlowEcmpTertiaryHashStrideOffset = 1638, /* Offset increment value to be used in
                                           RTAG7 macroflow for tertiary ECMP. */
    bcmSwitchMacroFlowEcmpSecondaryWeightedHashConcatEnable = 1639, /* Enable hash concatenation for
                                           weighted secondary ECMP macroflow. */
    bcmSwitchMacroFlowEcmpSecondaryWeightedHashMinOffset = 1640, /* Minimum offset value to be used in
                                           RTAG7 macroflow for weighted
                                           secondary ECMP. */
    bcmSwitchMacroFlowEcmpSecondaryWeightedHashMaxOffset = 1641, /* Maximum offset value to be used in
                                           RTAG7 macroflow for weighted
                                           secondary ECMP. */
    bcmSwitchMacroFlowEcmpSecondaryWeightedHashStrideOffset = 1642, /* Offset increment value to be used in
                                           RTAG7 macroflow for weighted
                                           secondary ECMP. */
    bcmSwitchMacroFlowL2EcmpSecondaryHashConcatEnable = 1643, /* Enable hash concatenation for L2
                                           secondary ECMP macroflow. */
    bcmSwitchMacroFlowL2EcmpSecondaryHashMinOffset = 1644, /* Minimum offset value to be used in
                                           RTAG7 macroflow for L2 secondary
                                           ECMP. */
    bcmSwitchMacroFlowL2EcmpSecondaryHashMaxOffset = 1645, /* Maximum offset value to be used in
                                           RTAG7 macroflow for L2 secondary
                                           ECMP. */
    bcmSwitchMacroFlowL2EcmpSecondaryHashStrideOffset = 1646, /* Offset increment value to be used in
                                           RTAG7 macroflow for L2 secondary
                                           ECMP. */
    bcmSwitchMacroFlowEcmpSecondaryMplsHashConcatEnable = 1647, /* Enable hash concatenation for MPLS
                                           secondary ECMP macroflow. */
    bcmSwitchMacroFlowEcmpSecondaryMplsHashMinOffset = 1648, /* Minimum offset value to be used in
                                           RTAG7 macroflow for MPLS secondary
                                           ECMP. */
    bcmSwitchMacroFlowEcmpSecondaryMplsHashMaxOffset = 1649, /* Maximum Offset value to be used in
                                           RTAG7 macroflow for MPLS secondary
                                           ECMP. */
    bcmSwitchMacroFlowEcmpSecondaryMplsHashStrideOffset = 1650, /* Offset increment value to be used in
                                           RTAG7 macroflow for MPLS secondary
                                           ECMP. */
    bcmSwitchMacroFlowEcmpSecondaryResilientHashConcatEnable = 1651, /* Enable hash concatenation for
                                           secondary ECMP resilient hashing
                                           macroflow. */
    bcmSwitchMacroFlowEcmpSecondaryResilientHashMinOffset = 1652, /* Minimum offset value to be used in
                                           RTAG7 macroflow for secondary ECMP
                                           resilient hashing. */
    bcmSwitchMacroFlowEcmpSecondaryResilientHashMaxOffset = 1653, /* Maximum Offset value to be used in
                                           RTAG7 macroflow for secondary ECMP
                                           resilient hashing. */
    bcmSwitchMacroFlowEcmpSecondaryResilientHashStrideOffset = 1654, /* Offset increment value to be used in
                                           RTAG7 macroflow for secondary ECMP
                                           resilient hashing. */
    bcmSwitchL2EcmpSecondaryHashOffset = 1655, /* Enhanced hash selection for L2
                                           secondary ECMP hashing. */
    bcmSwitchEcmpSecondaryHashOffset = 1656, /* Enhanced hash selection for secondary
                                           ECMP hashing. */
    bcmSwitchEcmpTertiaryHashOffset = 1657, /* Enhanced hash select for tertiary
                                           ECMP hashing. */
    bcmSwitchEcmpSecondaryWeightedHashOffset = 1658, /* Enhanced hash selection for weighted
                                           secondary ECMP. */
    bcmSwitchEcmpSecondaryMplsHashOffset = 1659, /* Enhanced hash selection for MPLS
                                           secondary ECMP. */
    bcmSwitchEcmpSecondaryResilientHashOffset = 1660, /* Enhanced hash selection for secondary
                                           ECMP resilient hashing. */
    bcmSwitchHashL2Srv6PayloadSelect0 = 1661, /* Set hash control to select L2 SRv6
                                           payload L2/L3 fields for Hash Block
                                           A. */
    bcmSwitchHashL2Srv6PayloadSelect1 = 1662, /* Set hash control to select L2 SRv6
                                           payload L2/L3 fields for Hash Block
                                           B. */
    bcmSwitchHashL2Srv6L2PayloadField0 = 1663, /* Hash A selection for L2 payload of L2
                                           SRv6 packets. */
    bcmSwitchHashL2Srv6L2PayloadField1 = 1664, /* Hash B selection for L2 payload of L2
                                           SRv6 packets. */
    bcmSwitchHashL2Srv6L3PayloadField0 = 1665, /* Hash A selection for L3 payload of L2
                                           SRv6 packets. */
    bcmSwitchHashL2Srv6L3PayloadField1 = 1666, /* Hash B selection for L3 payload of L2
                                           SRv6 packets. */
    bcmSwitchL3AggregatedHostFlexctrObjectOffset = 1667, /* Flex counter object offset for
                                           aggregated host route. */
    bcmSwitchRetainIngressPktOtpid = 1668, /* Retain outer TPID from the ingress
                                           packet. */
    bcmSwitchControlRouteSrv6UspTrapSet = 1669, /* Configure the LPM result to be
                                           identified as an SRv6 USP trap */
    bcmSwitchSrv6RoutingType = 1670,    /* Routing type to be matched with SRH
                                           routing type. */
    bcmSwitchSrv6Flags = 1671,          /* Flags to be matched with SRH flags. */
    bcmSwitchSrv6FlagsMask = 1672,      /* Mask to be applied to SRH flags. */
    bcmSwitchSrv6NextHeaderEthernet = 1673, /* Ethernet protocol number to be
                                           matched with SRH next header. */
    bcmSwitchSrv6NextHeaderSrh = 1674,  /* Segment routing protocol number to be
                                           matched with SRH next header. This
                                           indicates that incoming packets have
                                           stacked SRHs. */
    bcmSwitchSrv6NextHeaderValue1 = 1675, /* Custom next header protocol number 1
                                           to be matched with SRH next header. */
    bcmSwitchSrv6NextHeaderValue2 = 1676, /* Custom next header protocol number 2
                                           to be matched with SRH next header. */
    bcmSwitchSrv6InitRoutingType = 1677, /* Routing type for SRH encapsulation. */
    bcmSwitchSrv6InitFlags = 1678,      /* Flags for SRH encapsulation. */
    bcmSwitchSrv6InitTag = 1679,        /* Tag for SRH encapsulation. Applicable
                                           only when a fixed tag is selected. */
    bcmSwitchSrv6InitNextHeaderEthernet = 1680, /* Ethernet protocol number for SRH
                                           encapsulation. */
    bcmSwitchSrv6InitNextHeaderSrh = 1681, /* Segment routing protocol number for
                                           SRH encapsulation. This is used for
                                           outgoing packets with stacked SRHs. */
    bcmSwitchSrv6UsidLength = 1682,     /* USID length. */
    bcmSwitchSrv6GsidLength = 1683,     /* GSID length. */
    bcmSwitchSrv6GsidSegmentIndexOffset = 1684, /* Segment index LSB offset in GSID. */
    bcmSwitchSrv6EsFilterKeySelect = 1685, /* Ethernet segment filtering key
                                           selection for SRv6 termination. */
    bcmSwitchSrv6FlagsMismatchDrop = 1686, /* SRv6 packets drop on SRH flags
                                           mismatch. */
    bcmSwitchSrv6PortDisableDrop = 1687, /* SRv6 packets drop on disabled SRv6
                                           transit/termination per port. */
    bcmSwitchSrv6SvpAssignFailToCpu = 1688, /* SRv6 packets with SVP assignment
                                           failure to CPU. */
    bcmSwitchSrv6RoutingTypeMismatchToCpu = 1689, /* SRv6 packets with mismatched routing
                                           type to CPU. */
    bcmSwitchSrv6ValidationErrorToCpu = 1690, /* SRv6 packets validation error to CPU. */
    bcmSwitchSrv6ProcessErrorToCpu = 1691, /* SRv6 packets process error to CPU. */
    bcmSwitchDcnIngressEnable = 1692,   /* Enable DCN at the ingress. */
    bcmSwitchDcnEgressEnable = 1693,    /* Enable DCN at the egress. */
    bcmSwitchDcnIngressUdpDstPort = 1694, /* Match against UDP destination port in
                                           UDP header to identify DCN packets at
                                           the ingress. */
    bcmSwitchDcnEgressUdpDstPort = 1695, /* Match against UDP destination port in
                                           UDP header to identify DCN packets at
                                           the egress. */
    bcmSwitchDcnDropPktInstrumentationUpdate = 1696, /* Update instrumentation information
                                           including switch ID, packet TTL,
                                           egress port and queue number in
                                           locally generated DCN data drop
                                           packets. */
    bcmSwitchDcnDataPktQueueLengthUpdate = 1697, /* Update current queue usage in
                                           kilobytes in DCN data packets. */
    bcmSwitchDcnDropPktIpLengthUpdate = 1698, /* Update the length field in IP header
                                           for locally generated DCN data drop
                                           packets. */
    bcmSwitchDcnRoutingPlaneVrfOverwrite = 1699, /* Overwrite the upper two bits of VRF
                                           ID with the resolved ingress routing
                                           plane for DCN packets. */
    bcmSwitchVxlanEvpnVlanAware = 1700, /* Enables VxLAN EVPN C-VLAN aware mode
                                           lookup for VFI assignment. */
    bcmSwitchSubportCongestionTxType = 1701, /* Type of the channelized flow control
                                           messages to be transmitted. See
                                           bcm_switch_subport_congestion_tx_type_t. */
    bcmSwitchSubportCongestionTxDestMacOui = 1702, /* Higher 3 bytes of destination MAC
                                           address used in transmit flow control
                                           messages. */
    bcmSwitchSubportCongestionTxDestMacNonOui = 1703, /* Lower 3 bytes of destination MAC
                                           address used in transmit flow control
                                           messages. */
    bcmSwitchSubportCongestionTxSrcMacOui = 1704, /* Higher 3 bytes of source MAC address
                                           used in transmit flow control
                                           messages. */
    bcmSwitchSubportCongestionTxSrcMacNonOui = 1705, /* Lower 3 bytes of source MAC address
                                           used in transmit flow control
                                           messages. */
    bcmSwitchSubportCongestionTxPfcCev = 1706, /* Class Enable Vector (CEV) used in
                                           transmit C-PFC (channelized PFC)
                                           messages. */
    bcmSwitchSubportCongestionTxPfcPauseTime = 1707, /* Pause time used in transmit C-PFC
                                           messages. */
    bcmSwitchSubportCongestionTxPfcRefreshTime = 1708, /* The timeout value in nanoseconds used
                                           in the refresh timer mechanism to
                                           trigger transmit C-PFC message
                                           generation. */
    bcmSwitchSubportCongestionTxPfcRefreshTimeOper = 1709, /* Get the operational value of
                                           TxPfcRefreshTime above. The
                                           operational value can be different if
                                           the configured value is not in the
                                           correct device granularity
                                           (read-only). */
    bcmSwitchSubportCongestionTxE2eccPeriod = 1710, /* Period in nanoseconds to transmit
                                           E2ECC messages periodically used in
                                           channelized flow control. */
    bcmSwitchSubportCongestionTxE2eccPeriodOper = 1711, /* Get the operational value of
                                           TxE2eccPeriod above. The operational
                                           value can be different if the
                                           configured value is not in the
                                           correct device granularity
                                           (read-only). */
    bcmSwitchMonDebugCpuCosq = 1712,    /* COS for debug packets intended for
                                           R5. */
    bcmSwitchEcmpDynamicAlternateEnable = 1713, /* Use DLB offset for generating
                                           alternate next hop index. */
    bcmSwitchHashUseFlowSelEcmpUnderlayAlternate = 1714, /* Enable/Disable flow based hashing for
                                           ECMP level 2 alternate path. */
    bcmSwitchEcmpUnderlayAlternateHashOffset = 1715, /* Hash selection for ECMP level 2
                                           alternate path. */
    bcmSwitchEcmpUnderlayAlternateHashBitCountSelect = 1716, /* The number of bits required in the
                                           final hash result for ECMP level 2
                                           alternate path. */
    bcmSwitchMacroFlowEcmpUnderlayAlternateHashConcatEnable = 1717, /* Enable hash concatenation for ECMP
                                           level 2 alternate path. */
    bcmSwitchMacroFlowEcmpUnderlayAlternateHashSeed = 1718, /* Set hash seed for ECMP level 2
                                           alternate path. */
    bcmSwitchMacroFlowEcmpUnderlayAlternateHashMinOffset = 1719, /* Minimum offset value to be used in
                                           macroflow based hashing for ECMP
                                           level 2 alternate path. */
    bcmSwitchMacroFlowEcmpUnderlayAlternateHashMaxOffset = 1720, /* Maximum offset value to be used in
                                           macroflow based hashing for ECMP
                                           level 2 alternate path. */
    bcmSwitchMacroFlowEcmpUnderlayAlternateHashStrideOffset = 1721, /* Offset increment to be used in
                                           macroflow based hashing for ECMP
                                           level 2 alternate path. */
    bcmSwitchEcmpUnderlayAlternateRandomSeed = 1722, /* Random seed value for ECMP level 2
                                           alternate path. */
    bcmSwitchFailoverEcmpUnderlayDynamicEnable = 1723, /* Enable protection switching to DLB
                                           alternate next hop. */
    bcmSwitchFailoverEcmpUnderlayAlternateEnable = 1724, /* Enable protection switching to
                                           alternate next hop. */
    bcmSwitchL2ApplCallbackDisable = 1725, /* Enable/Disable application callback
                                           for entries added by bcm_l2_addr_add
                                           and deleted by bcm_l2_addr_delete.
                                           Delete case covers learned L2 entries
                                           as well as entries added by
                                           bcm_l2_addr_add API. If
                                           bcmSwitchL2ApplCallbackDisable is
                                           enabled, then switch control
                                           bcmSwitchL2ApplCallbackSuppress
                                           should not be enabled and vice versa. */
    bcmSwitchShaperAdjustMode = 1726,   /* Shaper adjust mode for adding or
                                           subtracting number of bytes on
                                           shaping length. */
    bcmSwitchEncryptedPfcTxEnable = 1727, /* Enable and disable encrypted PFC
                                           frames transmission. */
    bcmSwitchMultipathOverlayCompressBuffer = 1728, /* Set the size of the overlay L3 ECMP
                                           table defragmentation buffer. */
    bcmSwitchSubportCongestionTxSvtagSubportNum = 1729, /* Specify subport number field of SVTAG
                                           used in channelized flow control. */
    bcmSwitchExtStatAlwaysValid = 1730, /* Enable and disable always setting
                                           ext_statistics_valid to 1. */
    bcmSwitch__Count = 1731             /* Must be last.  Not a usable value. */
...
#define BCM_SWITCH_CONTROL_STR \
    ...
    "VxlanGbpFlags", \
    "Higig3EthertypeMask", \
    "LoopbackToLoopbackDrop", \
    "HashUseFlowSelMplsEcmpSecondary", \
    "HashEnable", \
    "L3EgressFailoverEnable", \
    "PortL3EgressFailoverEnable", \
    "TunnelTermEnable", \
    "TunnelTermExactMatchEnable", \
    "TunnelInitDisableOverride", \
    "TunnelTermDisableOverride", \
    "EcmpEnable", \
    "EpRecircInputPriBase", \
    "TwampStatelessModeEnable", \
    "SamplingTxStatType", \
    "DosAttackInnerIcmpPktOversize", \
    "DosAttackMinInnerTcpHdrSize", \
    "DosAttackInnerIcmpV6PingSize", \
    "DosAttackInnerV6MinFragSize", \
    "L2TunnelBasedTermQosEnable", \
    "ControlProtSwitchLinkSourceSelect", \
    "ControlProtSwitchLinkSwOverrideEnable", \
    "ControlProtSwitchLinkSwOverrideValue", \
    "ControlProtSwitchLinkStatus", \
    "Srv6UsidPrefixBits", \
    "SubportTagType", \
    "SubportTagDefault", \
    "InnerMplsUdpDstPortEnable", \
    "InnerMplsUdpDstPort", \
    "InnerMplsIpProtocolEnable", \
    "InnerMplsIpProtocol", \
    "InnerMplsGreUcEthertypeEnable", \
    "InnerMplsGreUcEthertype", \
    "InnerMplsGreMcEthertypeEnable", \
    "InnerMplsGreMcEthertype", \
    "PktDropOnPortHigig3CheckToCpu", \
    "ReflectorL2IntPriority", \
    "PfcRxSvtagEnable", \
    "TrunkEgressSvtagLookupEnable", \
    "MirrorErspanGreKeyEnable", \
    "TwampStatelessContext", \
    "DcnPoolHighWatermarkClearOnRead", \
    "DcnCosqEnable", \
    "GbpShimEtherType", \
    "GbpShimSubType", \
    "GbpShimVersion", \
    "UdfInnerL3OffsetAfterMplsBos", \
    "MacroFlowEcmpSecondaryHashConcatEnable", \
    "MacroFlowEcmpSecondaryHashMinOffset", \
    "MacroFlowEcmpSecondaryHashMaxOffset", \
    "MacroFlowEcmpSecondaryHashStrideOffset", \
    "MacroFlowEcmpTertiaryHashConcatEnable", \
    "MacroFlowEcmpTertiaryHashMinOffset", \
    "MacroFlowEcmpTertiaryHashMaxOffset", \
    "MacroFlowEcmpTertiaryHashStrideOffset", \
    "MacroFlowEcmpSecondaryWeightedHashConcatEnable", \
    "MacroFlowEcmpSecondaryWeightedHashMinOffset", \
    "MacroFlowEcmpSecondaryWeightedHashMaxOffset", \
    "MacroFlowEcmpSecondaryWeightedHashStrideOffset", \
    "MacroFlowL2EcmpSecondaryHashConcatEnable", \
    "MacroFlowL2EcmpSecondaryHashMinOffset", \
    "MacroFlowL2EcmpSecondaryHashMaxOffset", \
    "MacroFlowL2EcmpSecondaryHashStrideOffset", \
    "MacroFlowEcmpSecondaryMplsHashConcatEnable", \
    "MacroFlowEcmpSecondaryMplsHashMinOffset", \
    "MacroFlowEcmpSecondaryMplsHashMaxOffset", \
    "MacroFlowEcmpSecondaryMplsHashStrideOffset", \
    "MacroFlowEcmpSecondaryResilientHashConcatEnable", \
    "MacroFlowEcmpSecondaryResilientHashMinOffset", \
    "MacroFlowEcmpSecondaryResilientHashMaxOffset", \
    "MacroFlowEcmpSecondaryResilientHashStrideOffset", \
    "L2EcmpSecondaryHashOffset", \
    "EcmpSecondaryHashOffset", \
    "EcmpTertiaryHashOffset", \
    "EcmpSecondaryWeightedHashOffset", \
    "EcmpSecondaryMplsHashOffset", \
    "EcmpSecondaryResilientHashOffset", \
    "HashL2Srv6PayloadSelect0", \
    "HashL2Srv6PayloadSelect1", \
    "HashL2Srv6L2PayloadField0", \
    "HashL2Srv6L2PayloadField1", \
    "HashL2Srv6L3PayloadField0", \
    "HashL2Srv6L3PayloadField1", \
    "L3AggregatedHostFlexctrObjectOffset", \
    "RetainIngressPktOtpid", \
    "ControlRouteSrv6UspTrapSet", \
    "Srv6RoutingType", \
    "Srv6Flags", \
    "Srv6FlagsMask", \
    "Srv6NextHeaderEthernet", \
    "Srv6NextHeaderSrh", \
    "Srv6NextHeaderValue1", \
    "Srv6NextHeaderValue2", \
    "Srv6InitRoutingType", \
    "Srv6InitFlags", \
    "Srv6InitTag", \
    "Srv6InitNextHeaderEthernet", \
    "Srv6InitNextHeaderSrh", \
    "Srv6UsidLength", \
    "Srv6GsidLength", \
    "Srv6GsidSegmentIndexOffset", \
    "Srv6EsFilterKeySelect", \
    "Srv6FlagsMismatchDrop", \
    "Srv6PortDisableDrop", \
    "Srv6SvpAssignFailToCpu", \
    "Srv6RoutingTypeMismatchToCpu", \
    "Srv6ValidationErrorToCpu", \
    "Srv6ProcessErrorToCpu", \
    "DcnIngressEnable", \
    "DcnEgressEnable", \
    "DcnIngressUdpDstPort", \
    "DcnEgressUdpDstPort", \
    "DcnDropPktInstrumentationUpdate", \
    "DcnDataPktQueueLengthUpdate", \
    "DcnDropPktIpLengthUpdate", \
    "DcnRoutingPlaneVrfOverwrite", \
    "VxlanEvpnVlanAware", \
    "SubportCongestionTxType", \
    "SubportCongestionTxDestMacOui", \
    "SubportCongestionTxDestMacNonOui", \
    "SubportCongestionTxSrcMacOui", \
    "SubportCongestionTxSrcMacNonOui", \
    "SubportCongestionTxPfcCev", \
    "SubportCongestionTxPfcPauseTime", \
    "SubportCongestionTxPfcRefreshTime", \
    "SubportCongestionTxPfcRefreshTimeOper", \
    "SubportCongestionTxE2eccPeriod", \
    "SubportCongestionTxE2eccPeriodOper", \
    "MonDebugCpuCosq", \
    "EcmpDynamicAlternateEnable", \
    "HashUseFlowSelEcmpUnderlayAlternate", \
    "EcmpUnderlayAlternateHashOffset", \
    "EcmpUnderlayAlternateHashBitCountSelect", \
    "MacroFlowEcmpUnderlayAlternateHashConcatEnable", \
    "MacroFlowEcmpUnderlayAlternateHashSeed", \
    "MacroFlowEcmpUnderlayAlternateHashMinOffset", \
    "MacroFlowEcmpUnderlayAlternateHashMaxOffset", \
    "MacroFlowEcmpUnderlayAlternateHashStrideOffset", \
    "EcmpUnderlayAlternateRandomSeed", \
    "FailoverEcmpUnderlayDynamicEnable", \
    "FailoverEcmpUnderlayAlternateEnable", \
    "L2ApplCallbackDisable", \
    "ShaperAdjustMode", \
    "EncryptedPfcTxEnable", \
    "MultipathOverlayCompressBuffer", \
    "SubportCongestionTxSvtagSubportNum", \
    "ExtStatAlwaysValid" 

/* 
 * Shaper adjust mode enumerations for setting switch control
 * bcmSwitchShaperAdjustMode.
 */
typedef enum bcm_switch_shaper_adjust_mode_e {
    bcmSwitchShaperAdjustModeAdd = 0,   /* Add. */
    bcmSwitchShaperAdjustModeSubtract = 1, /* Subtract. */
    bcmShaperAdjustModeCount = 2        /* Must be the last. Not a usable value. */
} bcm_switch_shaper_adjust_mode_t;
...
/* Enum for EES location profile */
typedef enum bcm_switch_ees_location_profile_e {
    bcmSwitchEesLocationProfileNull = 0 /* Dummy element */
} bcm_switch_ees_location_profile_t;
...
typedef enum bcm_switch_external_table_e {
    ...
    bcmSwitchExternalTableIp4RpfLargeResult = 9, 
    bcmSwitchExternalTableIp6RpfLargeResult = 10 
} bcm_switch_external_table_t;

/* Values passed for setting bcmSwitchSamplingTxStatType. */
typedef enum bcm_switch_sampling_tx_stat_type_e {
    bcmSwitchSamplingTxStatTypePort = 0, /* Port type. */
    bcmSwitchSamplingTxStatTypeQueue = 1, /* Queue type. */
    bcmSwitchSamplingTxStatTypeCount = 2 /* Always Last, not a usable value. */
} bcm_switch_sampling_tx_stat_type_t;

/* 
 * SRv6 USID/GSID length for
 * bcmSwitchSrv6UsidLength/bcmSwitchSrv6GsidLength.
 */
typedef enum bcm_switch_srv6_sid_length_e {
    bcmSwitchSrv6SidLength16Bit = 0,    /* 16bit SID length. */
    bcmSwitchSrv6SidLength32Bit = 1,    /* 32bit SID length. */
    bcmSwitchSrv6SidLengthCount = 2     /* Always Last, not a usable value. */
} bcm_switch_srv6_sid_length_t;

/* 
 * Ethernet segment filtering key selection for
 * bcmSwitchSrv6EsFilterKeySelect.
 */
typedef enum bcm_switch_srv6_es_filter_key_e {
    bcmSwitchSrv6EsFilterKeyEsIdDstGport = 0, /* Ethernet segment filtering based on
                                           ethernet segment ID and destination
                                           GPORT. */
    bcmSwitchSrv6EsFilterKeySrcDstGport = 1, /* Ethernet segment filtering based on
                                           source and destination GPORT. */
    bcmSwitchSrv6EsFilterKeyCount = 2   /* Always Last, not a usable value. */
} bcm_switch_srv6_es_filter_key_t;

/* 
 * Types of channelized flow control messages to transmit for subport
 * congestion.
 */
typedef enum bcm_switch_subport_congestion_tx_type_e {
    bcmSwitchSubportCongestionTxTypeNone = 0, /* Channelized flow control transmission
                                           disabled. */
    bcmSwitchSubportCongestionTxTypeE2ecc = 1, /* End to end congestion control
                                           (E2ECC). */
    bcmSwitchSubportCongestionTxTypePfc = 2, /* Channelized priority based flow
                                           control (C-PFC). */
    bcmSwitchSubportCongestionTxTypeCount = 3 /* Must be last.  Not a usable value. */
} bcm_switch_subport_congestion_tx_type_t;
...
#define BCM_L3MC_DNAPT_SNAPT_WITH_MACDA_UPDATE 10         /* Enable both Multicast
                                                          ...
                                                          updates and MACDA
                                                          update. */
#define BCM_L3MC_DNAPT_SNAT                 11         /* Enable both Multicast
                                                          DNAPT and SNAT
                                                          updates. */
#define BCM_L3MC_DNAPT_SNAT_WITH_MACDA_UPDATE 12         /* Enable both Multicast
                                                          DNAPT and SNAT updates
                                                          and MACDA update. */
...
/* 
 *  This API retrieves the current average voltage reading of the chip.
 * The voltage reading is in milli volt (mV) format
 */
extern int bcm_switch_voltage_monitor_get(
    int unit, 
    int *avg_voltage);
...
typedef struct bcm_switch_pkt_info_s {
    ...
    bcm_flexdigest_entry_t flexdigest_entry_id; /* Flex digest entry ID. */
...
#define BCM_HASH_FIELD1_DISABLE_ROCE2_IP6   0x00000020 /* Hash block B field
                                                          selection disable for
                                                          RoCEv2 IPv6 packet. */
#define BCM_HASH_FIELD0_DISABLE_MPLS_TRANSIT_L3_PAYLOAD 0x00000040 /* Hash block A field
                                                          selection disable for
                                                          inner L3 payload
                                                          header of MPLS transit
                                                          packets. */
#define BCM_HASH_FIELD1_DISABLE_MPLS_TRANSIT_L3_PAYLOAD 0x00000080 /* Hash block B field
                                                          selection disable for
                                                          inner L3 payload
                                                          header of MPLS transit
                                                          packets. */
#define BCM_HASH_FIELD0_DISABLE_INNER_MPLS_TRANSIT_L3_PAYLOAD 0x00000100 /* Hash block A field
                                                          selection disable for
                                                          inner L3 payload
                                                          header of MPLS over L3
                                                          tunnel transit
                                                          packets. */
#define BCM_HASH_FIELD1_DISABLE_INNER_MPLS_TRANSIT_L3_PAYLOAD 0x00000200 /* Hash block B field
                                                          selection disable for
                                                          inner L3 payload
                                                          header of MPLS over L3
                                                          tunnel transit
                                                          packets. */
#define BCM_HASH_FIELD0_DISABLE_L2_SRV6_TERM_PAYLOAD 0x00000400 /* Hash block A field
                                                          selection disable for
                                                          inner payload of L2
                                                          SRv6 terminated
                                                          packets. */
#define BCM_HASH_FIELD1_DISABLE_L2_SRV6_TERM_PAYLOAD 0x00000800 /* Hash block B field
                                                          selection disable for
                                                          inner payload of L2
                                                          SRv6 terminated
                                                          packets. */
...
#define BCM_HASH_NON_SYMMETRICAL            BCM_HASH_FIELD_LOOKUP_ID_LO /* Non symmetrical
                                                          hashing. */
...
typedef enum bcm_switch_object_e {
    ...
    bcmSwitchObjectEcmpMemberDefragStat = 68, /* Read-only, and returns the total
                                           number of times defragmentation
                                           operation has been performed on the
                                           single-level ECMP member. */
    bcmSwitchObjectOverlayEcmpMemberDefragStat = 69, /* Read-only, and returns the total
                                           number of times defragmentation
                                           operation has been performed on the
                                           overlay ECMP member. */
    bcmSwitchObjectUnderlayEcmpMemberDefragStat = 70, /* Read-only, and returns the total
                                           number of times defragmentation
                                           operation has been performed on the
                                           underlay ECMP member. */
    bcmSwitchObjectMyStationMax = 71,   /* Read-only, and returns the max number
                                           of MY_STATION entries. */
    bcmSwitchObjectMyStationUsed = 72,  /* Read-only, and returns the number of
                                           used MY_STATION entries. */
...
typedef enum bcm_switch_tpid_type_e {
    ...
    bcmTpidTypeOpaqueTag = 12,          /* Global TPID value for Opaque-Tag */
    bcmTpidTypeCount = 13               /* Always Last, not a usable value */
...
typedef struct bcm_switch_pkt_trace_info_s {
    ...
    bcm_switch_pkt_trace_field_info_t pkt_trace_field_info[BCM_SWITCH_PKT_TRACE_FIELD_STAGE_MAX]; /* packet trace field processor
                                           information */
    bcm_pktio_bitmap_t pkt_format;      /* Packet format in bit array. */
    bcm_port_t src_port;                /* Source port of CPU injected packets. */
...
typedef struct bcm_switch_pkt_protocol_match_s {
    ...
    uint8 fixed_hve_result_set_3;       /* Fixed hve result set 3. */
    uint8 fixed_hve_result_set_3_mask;  /* Fixed hve result set 3 mask. */
...
#define BCM_SWITCH_MON_ACTION_LOOPBACK_DROP 0x2        /* Enable to drop
                                                          loopback copy. */
#define BCM_SWITCH_MON_ACTION_COPY_TO_DEBUG 0x4        /* Enable to copy packets
                                                          to debug. */
...
typedef struct bcm_switch_drop_event_mon_s {
    ...
    uint32 flags;                       /* BCM_SWITCH_DROP_EVENT_MON_FLAGS_XXX
                                           flags definitions. */
    int uncompressed_drop_reason_enable; /* Enable the generation of uncompressed
                                           drop reason for the given drop event. */
    uint16 strength;                    /* Strength of the drop event. */
...
typedef enum bcm_switch_ep_recirc_nih_dest_type_e {
    ...
    bcmSwitchEpRecircNihDestTypeEgressL2Interface = 2, /* Destination type is Egress L2
                                           interface (L2 OIF). */
    bcmSwitchEpRecircNihDestTypeSubport = 3, /* Destination type is CES Subport. */
    bcmSwitchEpRecircNihDestTypeCount = 4 /* Must be last. Not a usable value. */
} bcm_switch_ep_recirc_nih_dest_type_t;

/* Header type in the EPRC loopback header. */
typedef enum bcm_switch_ep_recirc_header_type_e {
    bcmSwitchEpRecircHeaderTypeEth = 0, /* Ethernet */
    bcmSwitchEpRecircHeaderTypeCopyToCpu = 1, /* Copy to CPU */
    bcmSwitchEpRecircHeaderTypeMirror = 2, /* Mirror */
    bcmSwitchEpRecircHeaderTypeIfa = 3, /* IFA */
    bcmSwitchEpRecircHeaderTypeCount = 4 /* Always last. Not a usable value. */
} bcm_switch_ep_recirc_header_type_t;

/* 
 * Header sub-type in the EPRC loopback header together with above header
 * type for how EPRC loopback packets are triggered.
 */
typedef enum bcm_switch_ep_recirc_header_sub_type_e {
    bcmSwitchEpRecircHeaderSubTypeNone = 0, /* Normal forwarding */
    bcmSwitchEpRecircHeaderSubTypeIngressEth = 1, /* Ingress ethernet packets forwarding.
                                           Applicable when header_type is
                                           bcmSwitchEpRecircHeaderTypeEth. */
    bcmSwitchEpRecircHeaderSubTypeEgressEth = 2, /* Egress ethernet packets forwarding.
                                           Applicable when header_type is
                                           bcmSwitchEpRecircHeaderTypeEth. */
    bcmSwitchEpRecircHeaderSubTypeIngressStatefulMod = 3, /* Ingress or MMU stateful MOD.
                                           Applicable when header_type is
                                           bcmSwitchEpRecircHeaderTypeEth. */
    bcmSwitchEpRecircHeaderSubTypeEgressStatefulMod = 4, /* Egress stateful MOD. Applicable when
                                           header_type is
                                           bcmSwitchEpRecircHeaderTypeEth. */
    bcmSwitchEpRecircHeaderSubTypeEgressRedirect = 5, /* Egress redirection. Applicable when
                                           header_type is
                                           bcmSwitchEpRecircHeaderTypeEth or
                                           bcmSwitchEpRecircHeaderTypeIfa. */
    bcmSwitchEpRecircHeaderSubTypeIfaProbeInit = 6, /* IFA probe initialization. Applicable
                                           when header_type is
                                           bcmSwitchEpRecircHeaderTypeEth. */
    bcmSwitchEpRecircHeaderSubTypeMirrorLegacy = 7, /* Legacy mirror encapsulation.
                                           Applicable when header_type is
                                           bcmSwitchEpRecircHeaderTypeMirror or
                                           bcmSwitchEpRecircHeaderTypeIfa. */
    bcmSwitchEpRecircHeaderSubTypeMirrorPostcard = 8, /* Mirror encapsulation for postcard.
                                           Applicable when header_type is
                                           bcmSwitchEpRecircHeaderTypeMirror. */
    bcmSwitchEpRecircHeaderSubTypeCount = 9 /* Always last. Not a usable value. */
} bcm_switch_ep_recirc_header_sub_type_t;

/* 
 * Enumeration type to specify the L3 egress interface type in the EPRC
 * loopback header.
 */
typedef enum bcm_switch_ep_recirc_l3_egr_intf_type_e {
    bcmSwitchEpRecircL3EgrIntfTypeOverlay = 0, /* Overlay egress interface. */
    bcmSwitchEpRecircL3EgrIntfTypeUnderlay = 1, /* Underlay egress interface. */
    bcmSwitchEpRecircL3EgrIntfTypeCount = 2 /* Always last. Not a usable value. */
} bcm_switch_ep_recirc_l3_egr_intf_type_t;

/* 
 * Enumeration type to select the source port ID for EPRC loopback
 * packets.
 */
typedef enum bcm_switch_ep_recirc_src_port_select_e {
    bcmSwitchEpRecircSrcPortSelectKeep = 0, /* Keep the original source port. */
    bcmSwitchEpRecircSrcPortSelectAssign = 1, /* Assign the source port from an EPRC
                                           profile. */
    bcmSwitchEpRecircSrcPortSelectDstPort = 2, /* Select the destination port as a
                                           source port. */
    bcmSwitchEpRecircSrcPortSelectCount = 3 /* Always last. Not a usable value. */
} bcm_switch_ep_recirc_src_port_select_t;
...
#define BCM_SWITCH_EP_RECIRC_DROP_SWITCHED_PACKET (1U << 2)  /* Drop the switched
                                                          packet in the first
                                                          pass. */
#define BCM_SWITCH_EP_RECIRC_COPY_DROP_ON_SWITCH_DROP (1U << 3)  /* Drop the loopback copy
                                                          if the original packet
                                                          is dropped. */
#define BCM_SWITCH_EP_RECIRC_MTU_ERROR_DROP (1U << 4)  /* Drop the loopback copy
                                                          in MTU checking error. */
#define BCM_SWITCH_EP_RECIRC_VRF_APPLY      (1U << 5)  /* Carry the assigned VRF
                                                          in the EPRC loopback
                                                          header. */
#define BCM_SWITCH_EP_RECIRC_HIGH_PRI_SELECT (1U << 6)  /* Select high priority
                                                          for admission control
                                                          and scheduling. */
#define BCM_SWITCH_EP_RECIRC_COS_REPLACE    (1U << 7)  /* Replace non EFP
                                                          assigned COS. */
#define BCM_SWITCH_EP_RECIRC_CPU_Q_HIGH_PRIORITY_SELECT (1U << 8)  /* Select the high
                                                          priority queue for
                                                          copy to CPU packets. */
#define BCM_SWITCH_EP_RECIRC_QOS_REPLACE    (1U << 9)  /* Replace internal
                                                          priority/CNG and
                                                          internal CN. */
#define BCM_SWITCH_EP_RECIRC_QOS_APPLY      (1U << 10) /* Apply the internal
                                                          priority/CNG and
                                                          internal CN carried in
                                                          the EPRC loopback
                                                          header on the second
                                                          pass. */
#define BCM_SWITCH_EP_RECIRC_L3_ROUTE       (1U << 11) /* Enable to force IP
                                                          routing on the second
                                                          pass. */
#define BCM_SWITCH_EP_RECIRC_ENABLE         (1U << 12) /* Enable EP
                                                          recirculation (EPRC)
                                                          profiles. */
#define BCM_SWITCH_EP_RECIRC_GLOBAL         (1U << 13) /* Global EPRC profile in
                                                          pipe unique mode. */
...
/* EP Recirculate (EPRC) profile structure. */
typedef struct bcm_switch_ep_recirc_profile_s {
    int recirc_profile_id;              /* Profile id. */
    uint32 flags;                       /* See BCM_SWITCH_EP_RECIRC_PROFILE_XXX
                                           flag definitions. */
    ...
    bcm_pbmp_t pbmp;                    /* Port bitmap to indicate where the
                                           profile is applied. */
    int override_offset;                /* Offset set in
                                           bcm_switch_ep_recirc_override_set to
                                           override EPRC packets generation. */
    bcm_switch_ep_recirc_header_type_t header_type; /* Header type. */
    bcm_switch_ep_recirc_header_sub_type_t header_sub_type; /* Header sub-type. */
    bcm_cos_t cos;                      /* COS value. Applicable only if
                                           BCM_SWITCH_EP_RECIRC_COS_REPLACE is
                                           enabled. */
    bcm_gport_t gport;                  /* Logical port or TRUNK. Carried in the
                                           EPRC loopback header and used as a
                                           destination on the second pass. */
    bcm_multicast_t mc_group;           /* Multicast group. Carried in the EPRC
                                           loopback header and used as a
                                           destination on the second pass. */
    bcm_switch_ep_recirc_l3_egr_intf_type_t l3_egress_intf_type; /* L3 egress interface overlay/underlay
                                           type to be carried in the EPRC
                                           loopback header. Applicable when both
                                           underlay and overlay egress
                                           interfaces are valid. */
    int int_pri;                        /* Internal priority. Applicable only if
                                           BCM_SWITCH_EP_RECIRC_QOS_REPLACE is
                                           enabled. */
    int int_cn;                         /* Internal congestion notification.
                                           Applicable only if
                                           BCM_SWITCH_EP_RECIRC_QOS_REPLACE is
                                           enabled. */
    bcm_color_t color;                  /* Color/drop precedence. Applicable
                                           only if
                                           BCM_SWITCH_EP_RECIRC_QOS_REPLACE is
                                           enabled. */
    uint32 opaque_object;               /* Opaque object to be carried in the
                                           EPRC loopback header. It can be used
                                           as a qualifier of VFP, IFP, EM FP. */
    int second_pass_profile_id;         /* EPRC second pass profile ID. */
    bcm_switch_ep_recirc_src_port_select_t src_port_select; /* Source logical port ID to be carried
                                           in the EPRC loopback header. */
    bcm_port_t src_port_instance_0;     /* Source logical port ID for pipe
                                           instance 0. Applicable only if
                                           src_port_mode is
                                           bcmSwitchEpRecircSrcPortSelectAssign. */
    bcm_port_t src_port_instance_1;     /* Source logical port ID for pipe
                                           instance 1. Applicable only if
                                           src_port_mode is
                                           bcmSwitchEpRecircSrcPortSelectAssign. */
    int mirror_payload_zero_profile_id; /* Mirror payload zero profile ID. */
...
/* EPRC override profile create options. */
#define BCM_SWITCH_EP_RECIRC_OVERRIDE_PROFILE_OPTIONS_WITH_ID (1U << 0)  /* Create the EPRC
                                                          override profile with
                                                          ID. */

#ifndef BCM_HIDE_DISPATCHABLE

/* Create an EPRC override profile. */
extern int bcm_switch_ep_recirc_override_profile_create(
    int unit, 
    uint32 options, 
    int *profile_id);

/* Enable EPRC override on given profile ID/offset. */
extern int bcm_switch_ep_recirc_override_enable_set(
    int unit, 
    int profile_id, 
    int offset, 
    int enable);

/* Get EPRC override status on given profiled ID/offset. */
extern int bcm_switch_ep_recirc_override_enable_get(
    int unit, 
    int profile_id, 
    int offset, 
    int *enable);

/* Destroy the EPRC override profile. */
extern int bcm_switch_ep_recirc_override_profile_destroy(
    int unit, 
    int profile_id);

#endif /* BCM_HIDE_DISPATCHABLE */

/* EPRC second pass profile create options. */
#define BCM_SWITCH_EP_RECIRC_SECOND_PASS_PROFILE_OPTIONS_WITH_ID (1U << 0)  /* Create the EPRC second
                                                          pass profile with ID. */
#define BCM_SWITCH_EP_RECIRC_SECOND_PASS_PROFILE_OPTIONS_REPLACE (1U << 1)  /* Replace the EPRC
                                                          second pass profile. */

/* EPRC second pass profile flags. */
#define BCM_SWITCH_EP_RECIRC_SECOND_PASS_INGRESS_FIELD (1U << 0)  /* Mark packets as the
                                                          second pass for IFP
                                                          key. */
#define BCM_SWITCH_EP_RECIRC_SECOND_PASS_EGRESS_FIELD (1U << 1)  /* Mark packets as the
                                                          second pass for EFP
                                                          key. */
#define BCM_SWITCH_EP_RECIRC_SECOND_PASS_INGRESS_STAT (1U << 2)  /* Mark packets as the
                                                          second pass for
                                                          ingress flexible
                                                          counter and counter
                                                          event. */
#define BCM_SWITCH_EP_RECIRC_SECOND_PASS_EGRESS_STAT (1U << 3)  /* Mark packets as the
                                                          second pass for egress
                                                          flexible counter and
                                                          counter event. */
#define BCM_SWITCH_EP_RECIRC_SECOND_PASS_CTC_ALLOW (1U << 4)  /* Allow non IFP copy to
                                                          CPU. */
#define BCM_SWITCH_EP_RECIRC_SECOND_PASS_MIRROR_ALLOW (1U << 5)  /* Allow non IFP mirror. */
#define BCM_SWITCH_EP_RECIRC_SECOND_PASS_COSQ_DROP (1U << 6)  /* Drop packets in MMU. */
#define BCM_SWITCH_EP_RECIRC_SECOND_PASS_L2_LEARN_SKIP (1U << 7)  /* Skip L2 learning. */
#define BCM_SWITCH_EP_RECIRC_SECOND_PASS_OVERRIDE_PROFILE_ENABLE (1U << 8)  /* Apply
                                                          override_profile_id. */

/* EPRC second pass profile. */
typedef struct bcm_switch_ep_recirc_second_pass_profile_s {
    uint32 flags;               /* See BCM_SWITCH_EP_RECIRC_SECOND_PASS_XXX flag
                                   definitions. */
    int override_profile_id;    /* Override profile ID to invalidate the
                                   generation of EPRC packets. */
} bcm_switch_ep_recirc_second_pass_profile_t;

/* EPRC second pass profile callback function prototype. */
typedef int(*bcm_switch_ep_recirc_second_pass_profile_traverse_cb)(
    int unit, 
    int profile_id, 
    bcm_switch_ep_recirc_second_pass_profile_t *profile, 
    void *user_data);

/* Initialize the bcm_switch_ep_recirc_second_pass_profile_t struct. */
extern void bcm_switch_ep_recirc_second_pass_profile_t_init(
    bcm_switch_ep_recirc_second_pass_profile_t *profile);

#ifndef BCM_HIDE_DISPATCHABLE

/* Create an EPRC second pass profile. */
extern int bcm_switch_ep_recirc_second_pass_profile_create(
    int unit, 
    uint32 options, 
    bcm_switch_ep_recirc_second_pass_profile_t *profile, 
    int *profile_id);

/* Get the EPRC second pass profile. */
extern int bcm_switch_ep_recirc_second_pass_profile_get(
    int unit, 
    int profile_id, 
    bcm_switch_ep_recirc_second_pass_profile_t *profile);

/* Destroy the EPRC second pass profile. */
extern int bcm_switch_ep_recirc_second_pass_profile_destroy(
    int unit, 
    int profile_id);

/* Traverse all EPRC second pass profiles. */
extern int bcm_switch_ep_recirc_second_pass_profile_traverse(
    int unit, 
...
/* 
 * Global EPRC profile control to trigger EPRC loopback packets when
 * there are no other effective profiles set by
 * bcm_switch_ep_recirc_profile_create.
 */
typedef struct bcm_switch_ep_recirc_profile_control_s {
    bcm_pbmp_t pbmp;                    /* Port bitmap to indicate where the
                                           profile is applied. */
    uint8 ingress_field_profile0_strength; /* Profile strength for EPRC profile 0
                                           in IFP and EM FP. */
    uint8 ingress_field_profile1_strength; /* Profile strength for EPRC profile 1
                                           in IFP and EM FP. */
    uint8 l3_egress_profile_strength;   /* Profile strength for EPRC profile in
                                           L3 egress. */
    int ingress_profile_id;             /* Ingress ethernet forwarding, e.g. L2
                                           switching to a loopback port. */
    uint8 ingress_profile_strength;     /* Profile strength for above ingress
                                           ethernet forwarding. */
    int ingress_mirror_profile_id;      /* Packets mirrored to a loopback port. */
    uint8 ingress_mirror_profile_strength; /* Profile strength for above mirrored
                                           packets. */
    int ingress_stateful_mod_profile_id; /* Ingress/MMU stateful MOD. */
    uint8 ingress_stateful_mod_profile_strength; /* Profile strength for above
                                           ingress/MMU stateful MOD. */
    int ifa_probe_init_profile_id;      /* IFA probe initiation. */
    uint8 ifa_probe_init_profile_strength; /* Profile strength for above IFA probe
                                           initiation. */
    int srv6_ifa_probe_init_profile_id; /* Both IFA probe initiation and SRv6
                                           initiation. */
    uint8 srv6_ifa_probe_init_profile_strength; /* Profile strength for above both IFA
                                           probe initiation and SRv6 initiation. */
    int ifa_term_profile_id;            /* IFA termination. */
    uint8 ifa_term_profile_strength;    /* Profile strength for above IFA
                                           termination. */
    int ifa_probe_init_and_term_profile_id; /* Both IFA probe initiation and
                                           termination. */
    uint8 ifa_probe_init_and_term_profile_strength; /* Profile strength for above both IFA
                                           probe initiation and termination. */
    int postcard_profile_id;            /* Postcard packets. */
    uint8 postcard_profile_strength;    /* Profile strength for above postcard
                                           packets. */
    int parity_error_profile_id;        /* Packets triggering parity error. */
} bcm_switch_ep_recirc_profile_control_t;

/* Initialize the bcm_switch_ep_recirc_profile_control_t struct. */
extern void bcm_switch_ep_recirc_profile_control_t_init(
    bcm_switch_ep_recirc_profile_control_t *control);

#ifndef BCM_HIDE_DISPATCHABLE

/* Set EPRC profile control. */
extern int bcm_switch_ep_recirc_profile_control_set(
    int unit, 
    bcm_switch_ep_recirc_profile_control_t *control);

/* Get EPRC profile control. */
extern int bcm_switch_ep_recirc_profile_control_get(
    int unit, 
    bcm_switch_ep_recirc_profile_control_t *control);
...
/* Subport tag types. */
typedef enum bcm_switch_subport_tag_type_e {
    bcmSwitchSubportTagTypeDisable = 0, /* Disable subport tag. */
    bcmSwitchSubportTagTypeSvtag = 1,   /* Subport tag type is SVTAG. */
    bcmSwitchSubportTagTypeEpmtag = 2,  /* Subport tag type is EPMTAG. */
    bcmSwitchSubportTagTypeCount = 3    /* Must be last. Not a usable value. */
} bcm_switch_subport_tag_type_t;
...
#define BCM_SWITCH_PCIE_FW_VER_LEN  (12)       /* PCIE firmware version name
                                                  string length */

/* PCIE firmware information */
typedef struct bcm_switch_pcie_firmware_info_s {
    uint32 build_date;                  /* PCIE loader build date(yyyymmdd -
                                           each character holds 4 bits) */
    uint32 loader_version;              /* Loader version */
    uint32 loaded_version;              /* Firmware version in the PCIE PHY */
    char stored_version[BCM_SWITCH_PCIE_FW_VER_LEN]; /* Firmware version name in the flash */
} bcm_switch_pcie_firmware_info_t;

/* Initialize the bcm_switch_pcie_firmware_info_t structure. */
extern void bcm_switch_pcie_firmware_info_t_init(
    bcm_switch_pcie_firmware_info_t *info);

#ifndef BCM_HIDE_DISPATCHABLE

/* Get PCIE firmware information. */
extern int bcm_switch_pcie_firmware_info_get(
    int unit, 
    bcm_switch_pcie_firmware_info_t *info);

#endif /* BCM_HIDE_DISPATCHABLE */

#define BCM_SWITCH_GTP_TERM_REPLACE         (1 << 0)   
#define BCM_SWITCH_GTP_TERM_CROSS_CONNECT   (1 << 1)   /* Indicates to create
                                                          P2P service. */
#define BCM_SWITCH_GTP_TERM_TRAVERSE_DELETE_ALL (1 << 2)   /* Delete all GTP
                                                          terminator using
                                                          traverse API. */

/* GTP switch terminator information */
typedef struct bcm_switch_gtp_terminator_s {
    uint32 flags;                       /* BCM_SWITCH_GTP_TERMINATOR_XXX */
    uint32 match_tunnel_endpoint_id;    /* TEID classification key. */
    bcm_vrf_t match_vrf;                /* virtual route instance classification
                                           key. */
    uint32 stat_id;                     /* Object Statistic id. */
    int stat_pp_profile;                /* Statistics profile. */
    bcm_gport_t dest_port;              /* Destination gport. */
    bcm_if_t dest_encap;                /* Destination encapsulation. */
} bcm_switch_gtp_terminator_t;

/* Initialize a bcm_switch_gtp_terminator_t structure. */
extern void bcm_switch_gtp_terminator_t_init(
    bcm_switch_gtp_terminator_t *config);

#ifndef BCM_HIDE_DISPATCHABLE

/* Add a new GTP terminator. */
extern int bcm_switch_gtp_terminator_add(
    int unit, 
    bcm_switch_gtp_terminator_t *info);

/* Get a GTP terminator. */
extern int bcm_switch_gtp_terminator_get(
    int unit, 
    bcm_switch_gtp_terminator_t *info);

/* Delete a GTP terminator. */
extern int bcm_switch_gtp_terminator_delete(
    int unit, 
    bcm_switch_gtp_terminator_t *info);

#endif /* BCM_HIDE_DISPATCHABLE */

typedef struct bcm_switch_gtp_terminator_additional_info_s {
    uint32 flags;   /* BCM_SWITCH_GTP_TERM_XXX */
} bcm_switch_gtp_terminator_additional_info_t;

/* bcm_switch_gtp_terminator_traverse_cb */
typedef int (*bcm_switch_gtp_terminator_traverse_cb)(
    int unit, 
    bcm_switch_gtp_terminator_t *info, 
    void *user_data);
...
/* Traverse GTP terminator Info. */
extern int bcm_switch_gtp_terminator_traverse(
    int unit, 
...
/* Flow type for drop event overriding. */
typedef enum bcm_switch_drop_event_override_flow_e {
    bcmSwitchDropEventOverrideFlowForwarding = 0, /* Normal forwarding flow. */
    bcmSwitchDropEventOverrideFlowMirror = 1, /* Mirror flow. */
    bcmSwitchDropEventOverrideFlowCopyToCpu = 2, /* Copy to CPU flow. */
    bcmSwitchDropEventOverrideFlowBpdu = 3, /* BPDU flow. */
    bcmSwitchDropEventOverrideFlowCount = 4 /* Must be last. Not a usable value. */
} bcm_switch_drop_event_override_flow_t;

/* Drop event overriding structure. */
typedef struct bcm_switch_drop_event_override_s {
    bcm_pkt_drop_event_t drop_event;    /* Drop event. */
    bcm_switch_drop_event_override_flow_t flow; /* Flow type. */
    uint32 override;                    /* Drop event overriding. */
} bcm_switch_drop_event_override_t;

/*  Initialize a bcm_switch_drop_event_override_t structure. */
extern void bcm_switch_drop_event_override_t_init(
    bcm_switch_drop_event_override_t *override);

#ifndef BCM_HIDE_DISPATCHABLE

/* 
 * These APIs set/get override configuration for a drop event of a given
 * flow.
 */
extern int bcm_switch_drop_event_override_set(
    int unit, 
    bcm_switch_drop_event_override_t *override);
 ...
 * flow.
 */
extern int bcm_switch_drop_event_override_get(
    int unit, 
    bcm_switch_drop_event_override_t *override);

#endif /* BCM_HIDE_DISPATCHABLE */

/* Maximum length of the description string for a drop. */
#define BCM_SWITCH_MON_DROP_DESCRIPTION_LENGTH_MAX 128        

/* Maximum number of supported drops. */
#define BCM_SWITCH_MON_DROPS_MAX    1024       

/* Drop types based on the pipeline stage. */
typedef enum bcm_switch_mon_drop_type_e {
    bcmSwitchMonDropTypeIp = 0,     /* IP Drops */
    bcmSwitchMonDropTypeMmu = 1,    /* MMU drops */
    bcmSwitchMonDropTypeEp = 2      /* EP drops */
} bcm_switch_mon_drop_type_t;

/* Information structure for one drop. */
typedef struct bcm_switch_mon_supported_drop_info_s {
    int drop_reason_code;               /* Drop reason code in the hardware */
    bcm_switch_mon_drop_type_t drop_type; /* Type of the drop */
    char drop_description[BCM_SWITCH_MON_DROP_DESCRIPTION_LENGTH_MAX]; /* Description of the drop */
} bcm_switch_mon_supported_drop_info_t;

/* Drops information structure. */
typedef struct bcm_switch_mon_supported_drops_info_s {
    int num_supported_drops;            /* Number of drop reasons */
    bcm_switch_mon_supported_drop_info_t drop_info[BCM_SWITCH_MON_DROPS_MAX]; /* Information of the drop */
} bcm_switch_mon_supported_drops_info_t;

#ifndef BCM_HIDE_DISPATCHABLE

/* Get the list of supported drops in a device. */
extern int bcm_switch_mon_supported_drops_info_get(
    int unit, 
    bcm_switch_mon_supported_drops_info_t *drops_info);

#endif /* BCM_HIDE_DISPATCHABLE */

/* DCN routing plane map flags. */
#define BCM_SWITCH_DCN_ROUTING_PLANE_MAP_FLAGS_DROP (1U << 0)  /* Drop DCN packets. */
#define BCM_SWITCH_DCN_ROUTING_PLANE_MAP_FLAGS_UPDATE (1U << 1)  /* Update routing plane
                                                          in DCN packets. */

/* DCN routing plane map. */
typedef struct bcm_switch_dcn_routing_plane_map_s {
    uint32 flags;                   /* BCM_SWITCH_DCN_ROUTING_PLANE_MAP_FLAGS_XXX. */
    int ingress_port_routing_plane; /* Ingress port routing plane. */
    int egress_port_routing_plane;  /* Egress port routing plane. */
    int packet_routing_plane;       /* Packet routing plane. */
    int new_routing_plane;          /* New routing plane in DCN packets, valid
                                       when
                                       BCM_SWITCH_DCN_ROUTING_PLANE_MAP_FLAGS_UPDATE
                                       is set. */
} bcm_switch_dcn_routing_plane_map_t;

/* Initialize bcm_switch_dcn_routing_plane_map_t. */
extern void bcm_switch_dcn_routing_plane_map_t_init(
    bcm_switch_dcn_routing_plane_map_t *map);

#ifndef BCM_HIDE_DISPATCHABLE

/* Set a DCN routing plane map. */
extern int bcm_switch_dcn_routing_plane_map_set(
    int unit, 
    bcm_switch_dcn_routing_plane_map_t *map);

/* Get a DCN routing plane map. */
extern int bcm_switch_dcn_routing_plane_map_get(
    int unit, 
    bcm_switch_dcn_routing_plane_map_t *map);

#endif /* BCM_HIDE_DISPATCHABLE */

/* Dos attack event information. */
typedef struct bcm_switch_dosattack_event_info_s {
    bcm_switch_dosattack_event_t event; /* Dos attack event */
    int offset;                         /* offset in the dos attack vector */
} bcm_switch_dosattack_event_info_t;

/* Options for bcm_switch_dosattack_event_info_get_all */
#define BCM_SWITCH_DOSATTACK_EVENT_INFO_OUTER_INNER 0          /* Dos attack event
                                                          information for
                                                          outer/inner frames */


/* Select the source appplication to use the FIFO. */
typedef enum bcm_switch_fifo_source_type_e {
    bcmSwitchFifoSourceFlowTrackerLearnFlow = 0, /* Flow tracker application */
    bcmSwitchFifoSourceFlowTrackerElephantFlow = 1, /* Elephant trap application */
    bcmSwitchFifoSourceCount = 2        /* Swith Fifo Source max count */
} bcm_switch_fifo_source_type_t;

#ifndef BCM_HIDE_DISPATCHABLE

/* Set the source appplication to use the FIFO. */
extern int bcm_switch_fifo_source_set(
    int unit, 
    bcm_switch_fifo_source_type_t *src_info);

/* Get the source appplication to use the FIFO. */
extern int bcm_switch_fifo_source_get(
    int unit, 
    bcm_switch_fifo_source_type_t *src_info);
