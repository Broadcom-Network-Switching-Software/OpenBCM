...
#define BCM_LB_FLAG_MODEM_SHAPER_SEGMENT    (1 << 3)   /* set modem segment
                                                          shaper. */
#define BCM_LB_FLAG_CONTROL_TRAFFIC         (1 << 4)   /* Setting for Link
                                                          Bonding Control
                                                          traffic */
...
typedef enum bcm_lb_control_e {
    ...
    bcmLbControlNofGuaranteedBuffers = 7, /* Guaranteed buffers the link bonding
                                           group can acquire */
    bcmLbControlTPIDOfControlPackets = 8, /* Sertting special TPID for control
                                           packets */
    bcmLbControlTrafficEnable = 9,      /* Enabling/disabling link bonding
                                           control traffic in egress interface */
    bcmLbControlCount = 10              /* Always Last. Not a usable value. */
} bcm_lb_control_t;
