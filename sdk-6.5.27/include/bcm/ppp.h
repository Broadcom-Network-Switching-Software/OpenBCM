...
/* Initialize a bcm_ppp_terminator_t structure. */
extern void bcm_ppp_terminator_t_init(
    bcm_ppp_terminator_t *info);

/* Initialize a bcm_ppp_initiator_t structure. */
extern void bcm_ppp_initiator_t_init(
    bcm_ppp_initiator_t *info);
