...
typedef struct bcm_port_config_s {
    ...
    bcm_pbmp_t framer_sar;              /* Mask of Framer SAR clients. */
    bcm_pbmp_t framer_mac;              /* Mask of Framer MAC clients. */
    bcm_pbmp_t flexe_client;            /* Mask of FlexE clients. */
} bcm_port_config_t;
...
typedef struct bcm_port_mapping_info_s {
    ...
    uint32 mgmt_channel;        /* The channel for Framer management ports. */
...
#define BCM_PORT_ADD_TX_FEEDBACK_ONLY   0x2        /* Indicate this port is only
                                                      used for providing Tx
                                                      feedback clock. Relevant
                                                      for L1 ETH only */
...
/* Set egress rate shaping for HULL. */
extern int bcm_port_hull_rate_egress_set(
    int unit, 
    bcm_port_t port, 
    uint32 kbits_sec, 
    uint32 kbits_burst);

/* Get egress rate shaping for HULL. */
extern int bcm_port_hull_rate_egress_get(
    int unit, 
    bcm_port_t port, 
    uint32 *kbits_sec, 
    uint32 *kbits_burst);
...
typedef enum bcm_port_class_e {
    ...
    bcmPortClassFieldEgressVportCs = 49, /* Context selection class for LIF
                                           ...
                                           ePMF */
    bcmPortClassFieldIngressVportCs = 50, /* Context selection class for LIF
                                           encoded as Gport in the Field Ingress
                                           stages */
    bcmPortClassI2EOpaqueObj0 = 51,     /* Ingress opaque object 0 passed to
                                           egress pipeline. */
    bcmPortClassCount = 52              /* Last enum value. */
} bcm_port_class_t;
...
typedef enum bcm_port_control_e {
    ...
    bcmPortControlHonorL2SrcDiscardOnStationMove = 469, /* Honor L2 Src Discard in case of
                                           station move. */
    bcmPortControlEpRecircEgressEnable = 470, /* Enable egress port based EPRC. */
    ...
    bcmPortControlCrcErrorFramesPurge = 473, /* Enable/disable CRC error frames
                                           detection and drop. */
    bcmPortControlSubportTagNameSpace = 474, /* Set the port subport-tag name space
                                           for cascaded port. */
    bcmPortControlSubportTagId = 475,   /* Set the ingress port subport-tag ID. */
    bcmPortControlL1Eth1588RxEnable = 476, /* Enable/Disable 1588 Rx for L1 ETH
                                           port. By default, 1588 is disabled */
    bcmPortControlL1Eth1588TxEnable = 477, /* Enable/Disable 1588 Tx for L1 ETH
                                           port. By default, 1588 is disabled */
    bcmPortControlIngEgrModEnable = 478, /* Enable or disable port-based
                                           ingress/egress mirror on drop. */
    bcmPortControlEgressSourceKnockout = 479, /* Set source port pruning for non
                                           unicast packets at egress. */
    bcmPortControlMplsIpVXParseEnable = 480, /* Enable or disable IPvX Parse over
                                           MPLS. */
    bcmPortControlDcnDropPktGen = 481,  /* Generate DCN data drop packets during
                                           MMU drop. */
    bcmPortControlDcnIngressRoutingPlaneSelect = 482, /* Select ingress routing plane for
                                           overwriting VRF. Applicable when
                                           enabling
                                           bcmSwitchDcnRoutingPlaneVrfOverwrite. */
    bcmPortControlDcnIngressPortRoutingPlane = 483, /* Routing plane on ingress port. Used
                                           for outgoing DCN packet routing plane
                                           mapping and VRF ID overriding. */
    bcmPortControlDcnEgressPortRoutingPlane = 484, /* Routing plane on egress port. Used
                                           for outgoing DCN packet routing plane
                                           mapping. */
    bcmPortControlL2StationVFIKeyFromVlan = 485, /* Enable packet outer VID overlaid on
                                           VFI key for L2 station lookup. */
    bcmPortControlGbpDstId = 486,       /* GBP destination ID associated with a
                                           given outgoing L2 interface */
    bcmPortControlSourceBindCheckEnable = 487, /* Enable source binding checks */
    bcmPortControlSourceBindWithPortCheckEnable = 488, /* Enable source binding checks also
                                           including incoming port */
    bcmPortControlFromRemoteCpuPktParse = 489, /* Enable/Disable packets parsing from
                                           remote CPU. */
    bcmPortControlPacketTimeStampTxProfileId = 490, /* TX Packet Timestamp profile id */
    bcmPortControlPacketTimeStampRxProfileId = 491, /* RX Packet Timestamp profile id */
    bcmPortControlHullEnable = 492,     /* Enable HULL. */
    bcmPortControlSrv6DefaultTunnelEnable = 493, /* Enable default SVP assignment for
                                           SRv6. */
    bcmPortControlLowLatencyPacketProcessing = 494, /* Enable the low latency PP flow. */
    bcmPortControlTxpiCtrlSelect = 495  /* Select TXPI control for the port */
} bcm_port_control_t;
...
#define BCM_PORT_CONTROL_STR \
    ...
    "bcmPortControlEpRecircEgressEnable", \
    "bcmPortControlFlexHashEnable", \
    "bcmPortControlTxCrcMode", \
    "bcmPortControlCrcErrorFramesPurge", \
    "bcmPortControlSubportTagNameSpace", \
    "bcmPortControlSubportTagId", \
    "bcmPortControlL1Eth1588RxEnable", \
    "bcmPortControlL1Eth1588TxEnable", \
    "bcmPortControlIngEgrModEnable", \
    "bcmPortControlEgressSourceKnockout", \
    "bcmPortControlMplsIpVXParseEnable", \
    "bcmPortControlDcnDropPktGen", \
    "bcmPortControlDcnIngressRoutingPlaneSelect", \
    "bcmPortControlDcnIngressPortRoutingPlane", \
    "bcmPortControlDcnEgressPortRoutingPlane", \
    "bcmPortControlL2StationVFIKeyFromVlan", \
    "bcmPortControlGbpDstId", \
    "bcmPortControlSourceBindCheckEnable", \
    "bcmPortControlSourceBindWithPortCheckEnable", \
    "bcmPortControlFromRemoteCpuPktParse", \
    "bcmPortControlPacketTimeStampTxProfileId", \
    "bcmPortControlPacketTimeStampRxProfileId", \
    "bcmPortControlHullEnable", \
    "bcmPortControlSrv6DefaultTunnelEnable", \
    "bcmPortControlLowLatencyPacketProcessing", \
    "bcmPortControlTxpiCtrlSelect" 
...
/* 
 * DCN ingress routing plane selection, used with
 * bcmPortControlDcnIngressRoutingPlaneSelect.
 */
typedef enum bcm_port_dcn_ingress_routing_plane_select_e {
    bcmPortDcnRoutingPlaneSelectPkt = 0, /* Select routing plane from packets. */
    bcmPortDcnRoutingPlaneSelectPort = 1, /* Select routing plane from ports. */
    bcmPortDcnRoutingPlaneSelectCount = 2 /* This should be the last one. */
} bcm_port_dcn_ingress_routing_plane_select_t;
...
typedef enum bcm_port_match_e {
    ...
    BCM_PORT_MATCH_PORT_GROUP_VLAN_STACKED = 50, /*  Match on port group + inner and
                                           outer VLAN. */
    BCM_PORT_MATCH_MAC_PORT_TAGGED = 51, /* Match on mac address + Mod/port/trunk
                                           + Tagged. */
    BCM_PORT_MATCH_MAC_PORT_VLAN = 52,  /* Match on mac address + Mod/port/trunk
                                           + VLAN. */
    BCM_PORT_MATCH_COUNT = 53           /* Must be last */
} bcm_port_match_t;
...
#define BCM_PORT_RESOURCE_G_HAO             0x80       /* If set, performs G.HAO
                                                          speed change. */
#define BCM_PORT_RESOURCE_AM_TRANSPARENT    0x100      /* If set, the AM for ETH
                                                          ports will be
                                                          transparent. Only
                                                          relevant for L1 ETH
                                                          ports */
...
/* FlexE group G.hao action */
typedef enum bcm_port_flexe_group_ghao_action_e {
    bcmPortFlexeGHaoCalAToB = 0,    /* Start FlexE calendar switching from A to
                                       B */
    bcmPortFlexeGHaoCalBToA = 1,    /* Start FlexE calendar switching from B to
                                       A */
    bcmPortFlexeGHaoComplete = 2,   /* Complete the G.hao procedure */
    bcmPortFlexeGHaoStop = 3,       /* Stop the G.hao procedure, only relevant
                                       for demux side */
    bcmPortFlexeGHaoNofActions = 4  /* Number of FlexE G.hao actions */
} bcm_port_flexe_group_ghao_action_t;

#ifndef BCM_HIDE_DISPATCHABLE

/* Configure G.hao actions for Demux and Mux. */
extern int bcm_port_flexe_group_ghao_action_set(
    int unit, 
    bcm_gport_t gport, 
    uint32 flags, 
...
typedef struct bcm_port_phy_fec_error_mask_s {
    ...
    uint32 error_injection_freq;    /* Repeat the error injection every N-th(0 -
                                       32)codeword, Not applicable to
                                       PM8x50_GEN1/GEN2/GEN3. */
...
/* Configuration for FEC error injection. */
typedef struct bcm_port_phy_fec_error_inject_config_s {
    uint32 error_mask_bit_31_0;     /* Error mask bit 31-0. */
    uint32 error_mask_bit_63_32;    /* Error mask bit 63-32. */
    uint16 error_mask_bit_79_64;    /* Error mask bit 79-64. */
    uint32 block_offset;            /* Which block(0-79) start to corrupt within
                                       a codeword. */
    uint32 contiguous_blocks_count; /* How many continuous blocks within a
                                       codeword to corrupt, starting from
                                       block_offset(68-bit block for RS544/RS272
                                       or 66-bit block for RS528). 0 : no error
                                       injection. N(1-80) : start from
                                       block_offset_control block, N number of
                                       blocks apply corruption on error_mask
                                       bits. */
    uint32 error_injection_freq;    /* Repeat the error injection every N-th(0 -
                                       32) codeword. */
} bcm_port_phy_fec_error_inject_config_t;

/* Enable FEC error injection. */
typedef struct bcm_port_phy_fec_error_inject_enable_s {
    uint8 codeword_1_enable;        /* Enable codeword 1 corruption. */
    uint8 codeword_2_enable;        /* Enable codeword 2 corruption, only
                                       applies to FEC 2xN. */
    uint8 codeword_1_parity_enable; /* Enable codeword 1 parity corruption. */
    uint8 codeword_2_parity_enable; /* Enable codeword 2 parity corruption, only
                                       applies to FEC 2xN. */
} bcm_port_phy_fec_error_inject_enable_t;

#ifndef BCM_HIDE_DISPATCHABLE

/* Set one-time or continuous fec error injection configuration. */
extern int bcm_port_phy_fec_error_inject_config_set(
    int unit, 
    bcm_port_t port, 
    bcm_port_phy_fec_error_inject_config_t config);

/* Get one-time or continuous fec error injection configuration. */
extern int bcm_port_phy_fec_error_inject_config_get(
    int unit, 
    bcm_port_t port, 
    bcm_port_phy_fec_error_inject_config_t *config);

/* Enable/disable one-time or continuous fec error injection. */
extern int bcm_port_phy_fec_error_inject_enable_set(
    int unit, 
    bcm_port_t port, 
    bcm_port_phy_fec_error_inject_enable_t enable);

/* Get one-time or continuous fec error injection enable/disable status. */
extern int bcm_port_phy_fec_error_inject_enable_get(
    int unit, 
    bcm_port_t port, 
    bcm_port_phy_fec_error_inject_enable_t *enable);
...
/* port polarity flip */
typedef struct bcm_port_polarity_s {
    int num_lanes;                      /* number of lanes in the PM core. */
    uint8 tx_polarity[BCM_PORT_MAX_LANES]; /* tx_polarity[0] is the tx polarity for
                                           logic lane 0, etc. */
    uint8 rx_polarity[BCM_PORT_MAX_LANES]; /* rx_polarity[0] is the rx polarity for
                                           logic lane 0, etc. */
} bcm_port_polarity_t;

#ifndef BCM_HIDE_DISPATCHABLE

/* Get the polarity flip for the port. */
extern int bcm_port_polarity_get(
    int unit, 
    bcm_port_t port, 
    bcm_port_polarity_t *polarity);

/* Set the polarity flip for the port. */
extern int bcm_port_polarity_set(
    int unit, 
    bcm_port_t port, 
    bcm_port_polarity_t *polarity);
...
/* serdes lane information */
typedef struct bcm_port_lane_info_s {
    int num_lanes;                      /* number of lanes for a port */
    uint16 lanes[BCM_PORT_MAX_LANES];   /* the list of physical lanes for a port */
} bcm_port_lane_info_t;

#ifndef BCM_HIDE_DISPATCHABLE

/* Get the Serdes lane list associated with the logical port */
extern int bcm_port_lane_info_get(
    int unit, 
    bcm_port_t port, 
...
/* physical port map information */
typedef struct bcm_port_physical_pmap_info_s {
    int num_phys_ports;                 /* number of physical ports associated
                                           with the logical port */
    uint16 phys_ports[BCM_PORT_MAX_LANES]; /* The list of physical ports associated
                                           with the logical port. If
                                           num_phy_ports >1, the first  phy_port
                                           is active, and the others are
                                           inactive. */
} bcm_port_physical_pmap_info_t;

#ifndef BCM_HIDE_DISPATCHABLE

/* Get the physical ports list associated with the logical port */
extern int bcm_port_physical_pmap_info_get(
    int unit, 
    bcm_port_t port, 
...
/* Port egress block mask flags. */
#define BCM_PORT_GPORT_EGRESS_BLOCK 0x00000001 /* Port egress block is set to
                                                  APPLY_EGR_MASK. */

#ifndef BCM_HIDE_DISPATCHABLE

/* 
 * Configure ports to block or allow packets from a given ingress
 * port/subport.
 */
extern int bcm_port_gport_egress_set(
    int unit, 
...
/* 
 * Configure which egress ports/subports a stacking port/subport is
 * permitted to forward packets to.
 */
extern int bcm_port_gport_egress_get(
    int unit, 
    bcm_gport_t source_gport, 
    uint32 *flags, 
    int max_gports, 
...
#define BCM_PORT_CLASS_ALLOCATION_WITH_ID   0x1        /* Use the specified ID. */
#define BCM_PORT_CLASS_ALLOCATION_BY_CORE_BM 0x2        /* Use to create entry
                                                          per core_bitmap,
                                                          otherwise all cores */

/* Port class properties structure. */
typedef struct bcm_port_class_allocation_info_s {
    uint32 flags;               /* flags of port. */
    bcm_port_class_t pclass; 
    uint32 core_bitmap; 
    uint32 class_id; 
} bcm_port_class_allocation_info_t;

#ifndef BCM_HIDE_DISPATCHABLE

/* Allocate port class per information */
extern int bcm_port_class_allocation_create(
    int unit, 
    bcm_port_class_allocation_info_t *class_info);

/* Get port class per information */
extern int bcm_port_class_allocation_get(
    int unit, 
    bcm_port_class_allocation_info_t *class_info);

/* Destroy port class per information */
extern int bcm_port_class_allocation_destroy(
    int unit, 
    bcm_port_class_allocation_info_t *class_info);

#endif /* BCM_HIDE_DISPATCHABLE */

/* Encrypted PFC TX Init Configuration structure. */
typedef struct bcm_port_encrypted_pfc_tx_init_config_s {
    uint32 cpu_port;    /* Source CPU port used for encrypted PFC packets
                           transmission. */
} bcm_port_encrypted_pfc_tx_init_config_t;

#ifndef BCM_HIDE_DISPATCHABLE

/* Initialize Encrypted PFC TX application. */
extern int bcm_port_encrypted_pfc_tx_init(
    int unit, 
    bcm_port_encrypted_pfc_tx_init_config_t *config);

/* Denitialize Encrypted PFC TX application. */
extern int bcm_port_encrypted_pfc_tx_deinit(
    int unit);

#endif /* BCM_HIDE_DISPATCHABLE */

/* Per port encrypted PFC TX configuration structure. */
typedef struct bcm_port_encrypted_pfc_tx_config_s {
    uint8 tc_enable_bmp;            /* Bit map of traffic class enabled for
                                       encrypted PFC transmission. */
    bcm_mac_t src_mac;              /* Source MAC. */
    uint32 refresh_interval_usecs;  /* Retransmit interval for XOFF  frames in
                                       micro seconds when congestion is ongoing. */
    bcm_if_t encap_id;              /* Egress interface. */
} bcm_port_encrypted_pfc_tx_config_t;

#ifndef BCM_HIDE_DISPATCHABLE

/* Set per port Encrypted PFC TX config. */
extern int bcm_port_encrypted_pfc_tx_config_set(
    int unit, 
    bcm_gport_t gport, 
    bcm_port_encrypted_pfc_tx_config_t *config);

/* Get per port Encrypted PFC TX config. */
extern int bcm_port_encrypted_pfc_tx_config_get(
    int unit, 
    bcm_gport_t gport, 
    bcm_port_encrypted_pfc_tx_config_t *config);
...
/* Initialize structure bcm_port_encrypted_pfc_tx_config_t */
extern void bcm_port_encrypted_pfc_tx_config_t_init(
    bcm_port_encrypted_pfc_tx_config_t *config);

/* Initialize structure bcm_port_encrypted_pfc_tx_init_config_t */
extern void bcm_port_encrypted_pfc_tx_init_config_t_init(
    bcm_port_encrypted_pfc_tx_init_config_t *config);
