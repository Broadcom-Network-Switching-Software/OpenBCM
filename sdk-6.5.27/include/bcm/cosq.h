...
typedef enum bcm_cosq_control_e {
    ...
    bcmCosqLowRateFactor = 217,         /* Low rate scheduler factor. */
    ...
    bcmCosqControlDcnPoolLimitBytes = 280, /* Pool limit bytes for DCN control
                                           packets and data drop packets. */
    bcmCosqControlEgressUCQueueYellowResumeOffsetBytes = 281, /* Egress UC Queue yellow resume offset
                                           limit. */
    bcmCosqControlEgressUCQueueRedResumeOffsetBytes = 282, /* Egress UC Queue red resume offset
                                           limit. */
    bcmCosqControlEgressMCQueueYellowResumeLimitBytes = 283, /* Egress MC Queue yellow resume limit
                                           bytes. Only max 8 different values
                                           can be configured for this resume
                                           limit on various queues at any given
                                           time. */
    bcmCosqControlEgressMCQueueRedResumeLimitBytes = 284, /* Egress MC Queue red resume limit
                                           bytes. Only max 8 different values
                                           can be configured for this resume
                                           limit on various queues at any given
                                           time. */
    bcmCosqControlEgressMCQueueEntryResumeLimit = 285, /* Resume limit for egress MC Queue
                                           entries. */
    bcmCosqControlEgressMCQueueEntryRedResumeLimit = 286, /* Red resume limit for egress MC Queue
                                           entries. Only max 8 different values
                                           can be configured for this resume
                                           limit on various at any given time. */
    bcmCosqControlEgressMCQueueEntryYellowResumeLimit = 287 /* Yellow resume limit for egress MC
                                           Queue entries. Only max 8 different
                                           values can be configured for this
                                           resume limit on various queues at any
                                           given time. */
} bcm_cosq_control_t;
...
#define BCM_COSQ_CONTROL_STR \
    ...
    "bcmCosqControlDcnPoolLimitBytes", \
    "bcmCosqControlEgressUCQueueYellowResumeOffsetBytes", \
    "bcmCosqControlEgressUCQueueRedResumeOffsetBytes", \
    "bcmCosqControlEgressMCQueueYellowResumeLimitBytes", \
    "bcmCosqControlEgressMCQueueRedResumeLimitBytes", \
    "bcmCosqControlEgressMCQueueEntryResumeLimit", \
    "bcmCosqControlEgressMCQueueEntryRedResumeLimit", \
    "bcmCosqControlEgressMCQueueEntryYellowResumeLimit" 
...
typedef enum bcm_cosq_stat_e {
    ...
    bcmCosqStatDcnPoolDroppedPackets = 136, /* Number of packets dropped due to full
                                           DCN pool. */
    bcmCosqStatDcnEligibleDropPackets = 137, /* Number of DCN data drop packets that
                                           are supposed to be generated.  Some
                                           of them may be dropped due to full
                                           DCN pool. */
    bcmCosqStatDcnPoolBytesCurrent = 138, /* Current bytes used in DCN pool. */
    bcmCosqStatDcnPoolHighWatermarkBytes = 139, /* DCN pool high watermark usage in
                                           bytes. */
    bcmCosqStatAverageBufferBytes = 140, /* Average buffer usage in bytes. */
    bcmCosqStatRqeQueueMinPacketsCurrent = 141, /* Current minimum guarantee usage per
                                           RQE queue in packets. */
    bcmCosqStatRqeQueueSharedPacketsCurrent = 142, /* Current shared usage per RQE queue in
                                           packets. */
    bcmCosqStatRqeQueueTotalPacketsCurrent = 143, /* Current total usage per RQE queue in
                                           packets. */
    bcmCosqStatRqePoolSharedPacketsCurrent = 144, /* Current value of RQE pool in use by
                                           all RQE queues in packets. */
    bcmCosqStatMaxCount = 145           /* this should be the last one. */
} bcm_cosq_stat_t;
...
/* 
 * Retrieve various MMU statistics based on stat type and integrated COSQ
 * index.
 */
extern int bcm_cosq_stat_extended_get(
    int unit, 
    bcm_cosq_object_id_t *id, 
    bcm_cosq_stat_t stat, 
    uint64 *value);
...
/* 
 * Force an immediate counter update and retrieve various MMU statistics,
 * based on stat type and integrated COS index.
 */
extern int bcm_cosq_stat_sync_extended_get(
    int unit, 
    bcm_cosq_object_id_t *id, 
    bcm_cosq_stat_t stat, 
    uint64 *value);
...
typedef enum bcm_cosq_control_range_type_e {
    ...
    bcmCosqRangeLowRate_0 = 15,         /* First low rate scheduler range. */
    bcmCosqRangeLowRate_1 = 16,         /* First low rate scheduler range. */
    bcmCosqRangeLowRate_2 = 17          /* First low rate scheduler range. */
...
typedef enum bcm_cosq_profile_type_e {
    ...
    bcmCosqProfileDcnDropPkt = 6,       /* Profile for actions on DCN data drop
                                           packets. */
    bcmCosqProfileHullMeter = 7,        /* Profile for HULL meter on COS queue. */
    bcmCosqProfileHullEcnMarking = 8,   /* Profile for HULL ECN marking on COS
                                           queue. */
    bcmCosqProfileCount = 9             /* This should be the last one */
...
/* Dynamic ECN threshold profile flags. */
#define BCM_COSQ_DYNAMIC_ECN_THRESHOLD_PROFILE_ENABLE 0x00000001 /* Enable dynamic ECN. */

/* Dynamic ECN threshold profile. */
typedef struct bcm_cosq_dynamic_ecn_threshold_profile_s {
    uint32 flags;   /* BCM_COSQ_DYNAMIC_ECN_THRESHOLD_PROFILE_XXX flags. */
    uint32 offset;  /* Dynamic ECN threshold offset in bytes. */
    uint32 floor;   /* Minimum value for dynamic ECN threshold in bytes. */
} bcm_cosq_dynamic_ecn_threshold_profile_t;

/* Initialize bcm_cosq_dynamic_ecn_threshold_profile_t. */
extern void bcm_cosq_dynamic_ecn_threshold_profile_t_init(
...
/* Set dynamic ECN threshold profile. */
extern int bcm_cosq_dynamic_ecn_threshold_profile_set(
    int unit, 
    int profile_id, 
    bcm_cosq_object_id_t *object_id, 
    bcm_cosq_dynamic_ecn_threshold_profile_t *profile);

/* Get dynamic ECN threshold profile. */
extern int bcm_cosq_dynamic_ecn_threshold_profile_get(
    int unit, 
    int profile_id, 
    bcm_cosq_object_id_t *object_id, 
    bcm_cosq_dynamic_ecn_threshold_profile_t *profile);
...
typedef enum bcm_cosq_generic_control_e {
    ...
    bcmCosqGenericControlLatencyEcnMinSize = 5, /* Minimal queue size for latency-based
                                           ECN marking. */
    bcmCosqGenericControlLowRatePattern = 6 /* Generic control to configure
                                           scheduler low rate range pattern */
...
#define BCM_COSQ_QUEUE_OFFSET_MAPPING_EGRESS_UNICAST 0x00000001 /* egress_mapping unicast
                                                          flag */
#define BCM_COSQ_QUEUE_OFFSET_MAPPING_EGRESS_MULTICAST 0x00000002 /* egress_mapping
                                                          multicast flag */

/* Flags for actions on DCN data drop packets. */
#define BCM_COSQ_DCN_DROP_PKT_PROFILE_ADMISSION_DROP_GEN 0x00000001 /* Generate DCN data drop
                                                          packets due to
                                                          admission control
                                                          drop. */
#define BCM_COSQ_DCN_DROP_PKT_PROFILE_WRED_DROP_GEN 0x00000002 /* Generate DCN data drop
                                                          packets due to WRED
                                                          drop. */

/* DCN data drop packet profile. */
typedef struct bcm_cosq_dcn_drop_pkt_profile_s {
    uint32 flags;   /* Flags. See BCM_COSQ_DCN_DROP_PKT_PROFILE_xxx. */
} bcm_cosq_dcn_drop_pkt_profile_t;

/* Initialize bcm_cosq_dcn_drop_pkt_profile_t. */
extern void bcm_cosq_dcn_drop_pkt_profile_t_init(
    bcm_cosq_dcn_drop_pkt_profile_t *profile);

/* DCN profile options. */
#define BCM_COSQ_DCN_DROP_PKT_PROFILE_OPTIONS_WITH_ID 0x00000001 /* Create a DCN drop
                                                          packet profile with
                                                          ID. */

#ifndef BCM_HIDE_DISPATCHABLE

/* Create a profile for actions on DCN data drop packets. */
extern int bcm_cosq_dcn_drop_pkt_profile_create(
    int unit, 
    uint32 options, 
    int *profile_id);

/* Destroy a DCN data drop packet profile. */
extern int bcm_cosq_dcn_drop_pkt_profile_destroy(
    int unit, 
    int profile_id);

/* Set a profile for actions on DCN drop packets. */
extern int bcm_cosq_dcn_drop_pkt_profile_set(
    int unit, 
    int profile_id, 
    bcm_cosq_object_id_t *object_id, 
    bcm_cosq_dcn_drop_pkt_profile_t *profile);

/* Get a profile for actions on DCN drop packets. */
extern int bcm_cosq_dcn_drop_pkt_profile_get(
    int unit, 
    int profile_id, 
    bcm_cosq_object_id_t *object_id, 
    bcm_cosq_dcn_drop_pkt_profile_t *profile);
...
/* HULL meter profile. */
typedef struct bcm_cosq_hull_meter_profile_s {
    bcm_pbmp_t ports;       /* Port bitmap. */
    int profile_id;         /* Profile ID. */
    bcm_cos_queue_t cosq;   /* COSQ ID. */
    uint32 flags;           /* Flags. See BCM_COSQ_HULL_METER_xxx. */
} bcm_cosq_hull_meter_profile_t;

/* Initialize bcm_cosq_hull_meter_profile_t. */
extern void bcm_cosq_hull_meter_profile_t_init(
    bcm_cosq_hull_meter_profile_t *profile);

#define BCM_COSQ_HULL_METER_PROFILE_OPTIONS_WITH_ID 0x00000001 /* Create a HULL meter
                                                          profile with ID. */

#define BCM_COSQ_HULL_METER_0_ENABLE    0x00000001 /* HULL meter 0 is enabled,
                                                      else disabled. */
#define BCM_COSQ_HULL_METER_1_ENABLE    0x00000002 /* HULL meter 1 is enabled,
                                                      else disabled. */

#ifndef BCM_HIDE_DISPATCHABLE

/* Create a HULL meter profile. */
extern int bcm_cosq_hull_meter_profile_create(
    int unit, 
    uint32 options, 
    int *profile_id);

/* Destroy a HULL meter profile. */
extern int bcm_cosq_hull_meter_profile_destroy(
    int unit, 
    int profile_id);

/*  Set HULL meter profile. */
extern int bcm_cosq_hull_meter_profile_set(
    int unit, 
    bcm_cosq_hull_meter_profile_t *profile);

/*  Get HULL meter profile. */
extern int bcm_cosq_hull_meter_profile_get(
    int unit, 
    bcm_cosq_hull_meter_profile_t *profile);
...
/* HULL meter state. */
typedef enum bcm_cosq_hull_meter_state_e {
    bcmCosqHullMeterInProfile = 0,      /* Meter is in profile. */
    bcmCosqHullMeterOutOfProfile = 1,   /* Meter is out of profile. */
    bcmCosqHullMeterCount = 2           /* Always last. */
} bcm_cosq_hull_meter_state_t;

#define BCM_COSQ_HULL_ECN_MARKING_ENABLE    0x00000001 /* Enable HULL ECN
                                                          marking, else
                                                          disabled. */

/* HULL ECN marking profile. */
typedef struct bcm_cosq_hull_ecn_marking_profile_s {
    bcm_pbmp_t ports;                   /* Port bitmap. */
    int profile_id;                     /* Profile ID. */
    bcm_cos_queue_t cosq;               /* COSQ ID. */
    bcm_cosq_hull_meter_state_t meter_0_state; /* State of meter 0. */
    bcm_cosq_hull_meter_state_t meter_1_state; /* State of meter 1. */
    uint32 flags;                       /* Flags. See
                                           BCM_COSQ_HULL_ECN_MARKING_xxx. */
} bcm_cosq_hull_ecn_marking_profile_t;

/* Initialize bcm_cosq_hull_ecn_marking_profile_t. */
extern void bcm_cosq_hull_ecn_marking_profile_t_init(
    bcm_cosq_hull_ecn_marking_profile_t *profile);

#define BCM_COSQ_HULL_ECN_MARKING_PROFILE_OPTIONS_WITH_ID 0x00000001 /* Create a HULL ECN
                                                          marking profile with
                                                          ID. */

#ifndef BCM_HIDE_DISPATCHABLE

/* Create a HULL ECN marking profile. */
extern int bcm_cosq_hull_ecn_marking_profile_create(
    int unit, 
    uint32 options, 
    int *profile_id);

/* Destroy a HULL ECN marking profile. */
extern int bcm_cosq_hull_ecn_marking_profile_destroy(
    int unit, 
    int profile_id);

/* Set HULL ECN marking profile. */
extern int bcm_cosq_hull_ecn_marking_profile_set(
    int unit, 
    bcm_cosq_hull_ecn_marking_profile_t *profile);

/* Get HULL ECN marking profile. */
extern int bcm_cosq_hull_ecn_marking_profile_get(
    int unit, 
    bcm_cosq_hull_ecn_marking_profile_t *profile);
