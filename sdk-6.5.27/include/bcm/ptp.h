...
#define BCM_PTP_CLOCK_FLAGS_TRIGGERED_DELREQ (1u)       /* Sync-triggered Delay
                                                          Requests */
#define BCM_PTP_CLOCK_FLAGS_FIXED_DELREQ    (2u)       /* Fixed-interval Delay
                                                          Requests */
#define BCM_PTP_CLOCK_FLAGS_ONEWAY_BIT      (3u)       /* One-way operation bit */
#define BCM_PTP_CLOCK_FLAGS_TELECOM_PROFILE_BIT (4u)       /* Telecom profile bit */
#define BCM_PTP_CLOCK_FLAGS_DELREQ_ALTMASTER_BIT (6u)       /* Alternate master
                                                          Delay_Req messages bit */
#define BCM_PTP_CLOCK_FLAGS_SYNCOAM_BIT     (7u)       /* Set Sync OAM register,
                                                          and override
                                                          servo-reported phase */
#define BCM_PTP_CLOCK_FLAGS_PROFILE_TYPE_START_BIT (8u)       /* Bit 8-11 represents
                                                          profile type */
#define BCM_PTP_CLOCK_FLAGS_TARGETED_DELREQ_DELRESP_TX_BIT (12u)      /* Feature to reduce
                                                          replication of delay
                                                          request and delay resp */
#define BCM_PTP_CLOCK_FLAGS_UNTAGGED_DELREQ_DELRESP_TX_BIT (13u)      /* Use to send untagged
                                                          delay request and
                                                          delay resp */
#define BCM_PTP_CLOCK_FLAGS_NTP_TOD_UPDATE_DISABLE (14u)      /* Flag to disable NTP
                                                          ToD updates */
#define BCM_PTP_CLOCK_FLAGS_PTP_TOD_UPDATE_DISABLE (15u)      /* Flag to disable PTP
                                                          ToD updates */
#define BCM_PTP_CLOCK_FLAGS_SIGNALING_MULTI_TLV_BIT (30u)      /* Multi-TLV signaling
                                                          message support bit */
