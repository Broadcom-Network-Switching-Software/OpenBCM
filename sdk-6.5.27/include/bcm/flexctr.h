...
typedef enum bcm_flexctr_source_e {
    ...
    bcmFlexctrSourceSrv6TunnelTerminator = 49, /* Segment Routing over IPv6(SRv6)
                                           tunnel termination. */
    bcmFlexctrSourceSrv6TransitFunction = 50, /* SRv6 transit function. */
    bcmFlexctrSourceSrv6VlanAwareL2TunnelTerminator = 51, /* SRv6 vlan aware L2 tunnel
                                           termination. */
    bcmFlexctrSourceSrv6TunnelTransitOrTerminator = 52, /* SRv6 tunnel transit or termination. */
    bcmFlexctrSourceSrv6L2TunnelTerminatorSvpAssignment = 53, /* SRv6 L2 tunnel termination source VP
                                           assignment. */
    bcmFlexctrSourceSrv6L2TunnelTerminatorEsFilter = 54, /* Ethernet segment filter during SRv6
                                           L2 tunnel termination. */
    bcmFlexctrSourceSrv6L2TunnelInitiatorEsIdInsertion = 55, /* Ethernet segment ID insertion during
                                           SRv6 L2 tunnel initialization. */
    bcmFlexctrSourceCount = 56          /* Always last one. */
...
{ \
    ...
    "bcmFlexctrSourceSrv6TunnelTerminator", \
    "bcmFlexctrSourceSrv6TransitFunction", \
    "bcmFlexctrSourceSrv6VlanAwareL2TunnelTerminator", \
    "bcmFlexctrSourceSrv6TunnelTransitOrTerminator", \
    "bcmFlexctrSourceSrv6L2TunnelTerminatorSvpAssignment", \
    "bcmFlexctrSourceSrv6L2TunnelTerminatorEsFilter", \
    "bcmFlexctrSourceSrv6L2TunnelInitiatorEsIdInsertion", \
...
typedef enum bcm_flexctr_object_e {
    ...
    bcmFlexctrObjectStaticEgr1588CfEgrTriggered = 119, /* Egress: set when the 1588 correction
                                           ...
                                           triggered. */
    bcmFlexctrObjectStaticEgrCosqStat0Lower = 120, /* Egress: COSQ stat 0 lower object. */
    bcmFlexctrObjectStaticEgrCosqStat0Upper = 121, /* Egress: COSQ stat 0 upper object. */
    bcmFlexctrObjectStaticEgrCosqStat1Lower = 122, /* Egress: COSQ stat 1 lower object. */
    bcmFlexctrObjectStaticEgrCosqStat1Upper = 123, /* Egress: COSQ stat 1 upper object. */
    bcmFlexctrObjectStaticEgrPreFieldOuterVlan = 124, /* Egress: pre EFP outer VLAN ID. */
    bcmFlexctrObjectStaticEgrL3 = 125,  /* Egress: L3 routing experienced
                                           indication. */
    bcmFlexctrObjectStaticEgrMirror = 126, /* Egress: mirror copy indication. */
    bcmFlexctrObjectStaticEgrMirrorInstanceId = 127, /* Egress: mirror instance ID for mirror
                                           copy. */
    bcmFlexctrObjectStaticEgrPortGroupId = 128, /* Egress: port group ID. */
    bcmFlexctrObjectStaticEgrDvpGroupId = 129, /* Egress: destination VP (virtual port)
                                           group ID. */
    bcmFlexctrObjectStaticEgrOverlayVfi = 130, /* Egress: overlay VFI (virtual
                                           forwarding instance). */
    bcmFlexctrObjectStaticIngSrv6TunnelTransitOrTerminator = 131, /* Ingress: SRv6 tunnel
                                           transit/termination object. */
    bcmFlexctrObjectStaticEgrSrv6L2TunnelEsIdInsertion = 132, /* Egress: SRv6 L2 tunnel initialization
                                           ethernet segment ID insertion object. */
    bcmFlexctrObjectStaticEgrSrv6L2TunnelEsFilter = 133, /* Egress: SRv6 L2 tunnel termination
                                           ethernet segment filter object. */
    bcmFlexctrObjectStaticCount = 134,  /* Always last for static objects. Not a
                                           usable value. */
    ...
    bcmFlexctrObjectEgrPipePort = 1081, /* Egress pipe port object */
    bcmFlexctrObjectEgrEcnMapInputVectorQueueNum = 1082, /* Egress ECN map input vector queue num
                                           object. */
    bcmFlexctrObjectIngTunnelSrv6SidFlexCtrIndex = 1083, /* SRv6 tunnel termination flex counter
                                           index object. */
    bcmFlexctrObjectIngEmFtFlexCtrIndexMsb = 1084, /* Ingress EM FT Flex Counter Index MSB */
    bcmFlexctrObjectCount = 1085        /* Always last one. */
...
{ \
    ...
    "bcmFlexctrObjectStaticEgrCosqStat0Lower", \
    "bcmFlexctrObjectStaticEgrCosqStat0Upper", \
    "bcmFlexctrObjectStaticEgrCosqStat1Lower", \
    "bcmFlexctrObjectStaticEgrCosqStat1Upper", \
    "bcmFlexctrObjectStaticEgrPreFieldOuterVlan", \
    "bcmFlexctrObjectStaticEgrL3", \
    "bcmFlexctrObjectStaticEgrMirror", \
    "bcmFlexctrObjectStaticEgrMirrorInstanceId", \
    "bcmFlexctrObjectStaticEgrPortGroupId", \
    "bcmFlexctrObjectStaticEgrDvpGroupId", \
    "bcmFlexctrObjectStaticEgrOverlayVfi", \
    "bcmFlexctrObjectStaticIngSrv6TunnelTransitOrTerminator", \
    "bcmFlexctrObjectStaticEgrSrv6L2TunnelEsIdInsertion", \
    "bcmFlexctrObjectStaticEgrSrv6L2TunnelEsFilter", \
    ...
    "bcmFlexctrObjectEgrPipePort", \
    "bcmFlexctrObjectEgrEcnMapInputVectorQueueNum", \
    "bcmFlexctrObjectIngTunnelSrv6SidFlexCtrIndex", \
    "bcmFlexctrObjectIngEmFtFlexCtrIndexMsb", \
