...
typedef enum bcm_fabric_control_e {
    ...
    bcmFabricLocalRouteControlCellsEnable = 86, /* Enable/disable FE1 control traffic
                                           ...
                                           through FE2 */
    bcmFabricKeepAliveCellEnable = 87,  /* Enables sending source routed cells
                                           before full system bring up */
    bcmFabricWfdEnable = 88,            /* Enables WFD mechanism */
    bcmFabricForceTrafficFabric = 89    /* Force all traffic through Fabric */
} bcm_fabric_control_t;
...
#define BCM_FABRIC_MAX_MULTICAST_MODULES    (256)      /* Max number of MC
                                                          modules */

#define BCM_FABRIC_MAX_MULTICAST_TABLE_ENTRY_SIZE (258)      /* max MCT entry size */
...
#define BCM_FABRIC_LINK_CELL_FORMAT_VSC256_V2x2 _SHR_FABRIC_LINK_CELL_FORMAT_VSC256_V2x2 /* VS256_V2x2 cell format */
#define BCM_FABRIC_LINK_CELL_FORMAT_VSC512  _SHR_FABRIC_LINK_CELL_FORMAT_VSC512 /* VS512 cell format */

typedef enum bcm_fabric_link_control_e {
    bcmFabricLinkCellFormat = 0,        /* link cell format */
    ...
    bcmFabricLinkCableSwapEnable = 13,  /* Enable cable swap on link. This
                                           configuration can be set only if all
                                           links on same PM as the requested
                                           link are disabled */
    bcmFabricLinkCableSwapMasterMode = 14, /* Set cable swap to master
                                           configuration. This configuration can
                                           be set only if all links on same PM
                                           as the requested link are disabled.
                                           Should be called only while cable
                                           swap is disabled */
    bcmFabricLLFControlType = 15        /* Configure LLFC type */
...
#define BCM_FABRIC_LINK_LLFC_TYPE_NONE      _SHR_FABRIC_LINK_LLFC_TYPE_NONE /* Disable LLFC */
#define BCM_FABRIC_LINK_LLFC_TYPE_LLFC      _SHR_FABRIC_LINK_LLFC_TYPE_LLFC /* Enable standart LLFC */
#define BCM_FABRIC_LINK_LLFC_TYPE_CREDIT_BASED _SHR_FABRIC_LINK_LLFC_TYPE_CREDIT_BASED /* Enable credit based
                                                          LLFC */

#define BCM_FABRIC_LINK_STATUS_CRC_ERROR    _SHR_FABRIC_LINK_STATUS_CRC_ERROR /* A cell with CRC error
                                                          was received on this
                                                          link */
#define BCM_FABRIC_LINK_STATUS_SIZE_ERROR   _SHR_FABRIC_LINK_STATUS_SIZE_ERROR /* A data cell with wrong
                                                          size was received */
#define BCM_FABRIC_LINK_STATUS_CODE_GROUP_ERROR _SHR_FABRIC_LINK_STATUS_CODE_GROUP_ERROR /* FEC uncorrectable
                                                          error. */
#define BCM_FABRIC_LINK_STATUS_MISALIGN     _SHR_FABRIC_LINK_STATUS_MISALIGN /* Loss of FEC sync is
                                                          detected on this link. */
#define BCM_FABRIC_LINK_STATUS_NO_SIG_LOCK  _SHR_FABRIC_LINK_STATUS_NO_SIG_LOCK /* SerDes signal lock
                                                          error. */
#define BCM_FABRIC_LINK_STATUS_NO_SIG_ACCEP _SHR_FABRIC_LINK_STATUS_NO_SIG_ACCEP /* No PMD lock in the
                                                          SerDes. */
#define BCM_FABRIC_LINK_STATUS_ERRORED_TOKENS _SHR_FABRIC_LINK_STATUS_ERRORED_TOKENS /* The tokens are
                                                          increased when cells
                                                          with no CRC errors and
                                                          no decoding errors
                                                          arrive, and decreased
                                                          when a faulty cell is
                                                          detected. Value less
                                                          than 63 indicates an
                                                          unacceptable amount of
                                                          faulty cells received
                                                          on link. */
#define BCM_FABRIC_LINK_STATUS_LOCAL_FAULT  _SHR_FABRIC_LINK_STATUS_LOCAL_FAULT /* Local Fault. */
#define BCM_FABRIC_LINK_STATUS_REMOTE_FAULT _SHR_FABRIC_LINK_STATUS_REMOTE_FAULT /* Remote Fault. */
...
typedef enum bcm_fabric_device_type_e {
    bcmFabricDeviceTypeUnknown = _SHR_FABRIC_DEVICE_TYPE_UNKNOWN, /* Unknown device type */
    bcmFabricDeviceTypeFE13 = _SHR_FABRIC_DEVICE_TYPE_FE13, /* FE13 device type */
    bcmFabricDeviceTypeFE2 = _SHR_FABRIC_DEVICE_TYPE_FE2, /* FE2 device type */
    bcmFabricDeviceTypeFAP = _SHR_FABRIC_DEVICE_TYPE_FAP, /* FAP device type */
    bcmFabricDeviceTypeFE1 = _SHR_FABRIC_DEVICE_TYPE_FE1, /* FE1 device type */
    bcmFabricDeviceTypeFE3 = _SHR_FABRIC_DEVICE_TYPE_FE3, /* FE3 device type */
    bcmFabricDeviceTypeFIP = _SHR_FABRIC_DEVICE_TYPE_FIP, /* FIP device type */
    bcmFabricDeviceTypeFOP = _SHR_FABRIC_DEVICE_TYPE_FOP, /* FOP device type */
    bcmFabricDeviceTypeNOF = _SHR_FABRIC_DEVICE_TYPE_NOF /* Number of device types */
} bcm_fabric_device_type_t;

typedef struct bcm_fabric_link_connectivity_s {
    uint32 local_link_id;               /* Local device link id */
...
typedef enum bcm_fabric_module_control_e {
    bcmFabricModuleControlFSMSeqNumberEnable = 0, /* Flow Status Message sequence numbers
                                           mechanism enable/disable */
    bcmFabricModuleControlMcTopologySwControlEnable = 1, 
    bcmFabricModuleControlWfdProfile = 2 /* WFD profile */
} bcm_fabric_module_control_t;
...
typedef struct bcm_fabric_route_s {
    ...
    int number_of_hops;                 /* Corresponds to the number of routing
                                           hops (number traversed links) */
    int *hop_ids;                       /* Traversed links */
    bcm_fabric_device_type_t dest_device_type; /* Destination device type */
} bcm_fabric_route_t;
...
typedef enum bcm_fabric_threshold_type_e {
    ...
    bcmFabricMidMcLowPrioDropLowTh = _SHR_FABRIC_MID_MC_LOW_PRIO_DROP_LOW_TH, 
    bcmFabricMidMcLowPrioDropHighTh = _SHR_FABRIC_MID_MC_LOW_PRIO_DROP_HIGH_TH, 
    bcmFabricRxFragGciPipeTh = _SHR_FABRIC_RX_FRAG_GCI_PIPE_TH, 
    bcmFabricRxLLFCFcPipeTh = _SHR_FABRIC_RX_LLFCFC_PIPE_TH, 
    bcmFabricRxFifoSizePipeTh = _SHR_FABRIC_RX_FIFO_SIZE_PIPE_TH, 
    bcmFabricMidFifoSizePipeTh = _SHR_FABRIC_MID_FIFO_SIZE_PIPE_TH, 
    bcmFabricTxFifoSizePipeTh = _SHR_FABRIC_TX_FIFO_SIZE_PIPE_TH, 
...
#define BCM_FABRIC_TH_INDEX_PIPE_LINK_SET(pipe, link)  _SHR_FABRIC_TH_INDEX_PIPE_LINK_SET(pipe, link) 
...
#define BCM_FABRIC_TH_INDEX_CAST_LEVEL_SET(cast, level)  _SHR_FABRIC_TH_INDEX_CAST_LEVEL_SET(cast, level) 
...
typedef enum bcm_fabric_cgm_control_type_e {
    ...
    bcmFabricCgmAdaptiveMnolEnable = 30, 
    bcmFabricCgmAdaptiveMnolMaxFactor = 31, 
    bcmFabricCgmAdaptiveMnolMinFactor = 32, 
    bcmFabricCgmAdaptiveMnolFifoThreshold = 33, 
    bcmFabricCgmAdaptiveMnolNofLinksThreshold = 34, 
    bcmFabricCgmAdaptiveMnolDecDelta = 35, 
    bcmFabricCgmAdaptiveMnolIncDelta = 36, 
    bcmFabricCgmAdaptiveMnolFastReleaseEnable = 37, 
    bcmFabricCgmAdaptiveMnolFastReleaseValue = 38, 
    bcmFabricCgmAdaptiveTotalFillEnable = 39, 
    bcmFabricCgmAdaptiveTotalFillMaxFactor = 40, 
    bcmFabricCgmAdaptiveTotalFillMinFactor = 41, 
    bcmFabricCgmAdaptiveTotalFillThreshold = 42, 
    bcmFabricCgmAdaptiveTotalFillFastReleaseEnable = 43, 
    bcmFabricCgmAdaptiveTotalFillFastReleaseValue = 44, 
    bcmFabricCgmAdaptiveTotalFillIncDelta = 45, 
    bcmFabricCgmAdaptiveTotalFillDecDelta = 46, 
    bcmFabricCgmGlobalCellShaperEn = 47, 
    bcmFabricCgmGlobalCellShaperRate = 48, 
    bcmFabricCgmGlobalCellShaperCellSizeMode = 49, 
    bcmFabricCgmFcSetTotalTh = 50, 
    bcmFabricCgmFcSetTotalOcbTh = 51, 
    bcmFabricCgmFcSetLocalTh = 52, 
    bcmFabricCgmFcSetFabricTh = 53, 
    bcmFabricCgmFcClearFabricTh = 54, 
    bcmFabricCgmFcClearFabricOcbTh = 55, 
    bcmFabricCgmFcClearLocalTh = 56, 
    bcmFabricCgmFcClearLocalOcbTh = 57, 
    bcmFabricCgmNof = 58 
...
/* Fabric system upgrade flags. */
#define BCM_FABRIC_SYSTEM_UPGRADE_FIRST_ITERATION 0x1        /* Used in
                                                          bcm_fabric_system_upgrade_phase1_set(),
                                                          indicates it's first
                                                          iteration */
#define BCM_FABRIC_SYSTEM_UPGRADE_REPEAT_ITERATION 0x2        /* Used in
                                                          bcm_fabric_system_upgrade_phase1_set(),
                                                          indicates it's repeat
                                                          iteration */

/* Fabric system upgrade targets. */
typedef enum bcm_fabric_system_upgrade_target_e {
    bcmFabricSystemUpgradeTargetInvalid = -1, /* Fabric system upgrade target invalid */
    bcmFabricSystemUpgradeTarget0 = 0,  /* Fabric system upgrade target 0 */
    bcmFabricSystemUpgradeTarget1 = 1,  /* Fabric system upgrade target 1 */
    bcmFabricSystemUpgradeTargetCount = 2 /* Fabric system upgrade target count */
} bcm_fabric_system_upgrade_target_t;

#ifndef BCM_HIDE_DISPATCHABLE

/* Configure fabric system upgrade phase 1. */
extern int bcm_fabric_system_upgrade_phase1_set(
    int unit, 
    int flags, 
    int master_id, 
    bcm_fabric_system_upgrade_target_t target);

/* Retrieve fabric system upgrade phase 1 settings. */
extern int bcm_fabric_system_upgrade_phase1_get(
    int unit, 
    int flags, 
    int *master_id, 
    bcm_fabric_system_upgrade_target_t *target);

/* Fabric system upgrade phase 2 trigger. */
extern int bcm_fabric_system_upgrade_phase2_trig(
    int unit, 
    int flags);

#endif /* BCM_HIDE_DISPATCHABLE */

/* Fabric system upgrade status. */
typedef enum bcm_fabric_system_upgrade_status_e {
    bcmFabricSystemUpgradeStatusError = -1, /* Fabric system upgrade error */
    bcmFabricSystemUpgradeStatusInProgress = 0, /* Fabric system upgrade in progress */
    bcmFabricSystemUpgradeStatusOk = 1, /* Fabric system upgrade OK */
    bcmFabricSystemUpgradeStatusComplete = 2 /* Fabric system upgrade complete */
} bcm_fabric_system_upgrade_status_t;

#ifndef BCM_HIDE_DISPATCHABLE

/* Retrieve system upgrade phase 3 status. */
extern int bcm_fabric_system_upgrade_phase3_get(
    int unit, 
    int flags, 
...
/* Link WFD configuration */
typedef struct bcm_fabric_wfd_link_config_s {
    uint32 weight;  /* Link weight (in percentage) */
} bcm_fabric_wfd_link_config_t;

#ifndef BCM_HIDE_DISPATCHABLE

/* Set WFD profile configuration */
extern int bcm_fabric_wfd_profile_set(
    int unit, 
    uint32 flags, 
    int profile_id, 
    int links_count, 
...
extern int bcm_fabric_wfd_profile_get(
    int unit, 
    uint32 flags, 
    int profile_id, 
    int links_count_max, 
