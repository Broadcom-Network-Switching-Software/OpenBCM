...
/* Default TX timestamp profile ID. */
#define BCM_TIME_TX_TIMESTAMP_PROFILE_ID_DEFAULT 0          /* Default TX timestamp
                                                          profile ID. */

/* TX timestamp profile structure. */
typedef struct bcm_time_tx_timestamp_profile_s {
    bcm_time_spec_t ntp_offset; /* NTP Offset. */
    bcm_time_spec_t ptp_offset; /* PTP Offset. */
} bcm_time_tx_timestamp_profile_t;

/* Initialize bcm_time_tx_timestamp_profile_t struct */
extern void bcm_time_tx_timestamp_profile_t_init(
    bcm_time_tx_timestamp_profile_t *profile);

#ifndef BCM_HIDE_DISPATCHABLE

/* Create profile id for TX timestamp profile. */
extern int bcm_time_tx_timestamp_profile_create(
    int unit, 
    bcm_time_tx_timestamp_profile_t *profile, 
    int *profile_id);

/* Destroy a TX timestamp profile. */
extern int bcm_time_tx_timestamp_profile_destroy(
    int unit, 
    int profile_id);

/* Get TX timestamp profile entry with given profile id. */
extern int bcm_time_tx_timestamp_profile_get(
    int unit, 
    int profile_id, 
    bcm_time_tx_timestamp_profile_t *profile);
...
/* Default RX timestamp profile ID. */
#define BCM_TIME_RX_TIMESTAMP_PROFILE_ID_DEFAULT 0          /* Default RX timestamp
                                                          profile ID. */

/* RX timestamp profile structure. */
typedef struct bcm_time_rx_timestamp_profile_s {
    bcm_time_spec_t ntp_offset; /* NTP Offset. */
    bcm_time_spec_t ptp_offset; /* PTP Offset. */
} bcm_time_rx_timestamp_profile_t;

/* Initialize bcm_time_rx_timestamp_profile_t struct */
extern void bcm_time_rx_timestamp_profile_t_init(
    bcm_time_rx_timestamp_profile_t *profile);

#ifndef BCM_HIDE_DISPATCHABLE

/* Create profile id for RX timestamp profile. */
extern int bcm_time_rx_timestamp_profile_create(
    int unit, 
    bcm_time_rx_timestamp_profile_t *profile, 
    int *profile_id);

/* Destroy a RX timestamp profile. */
extern int bcm_time_rx_timestamp_profile_destroy(
    int unit, 
    int profile_id);

/* Get RX timestamp profile entry with given profile id. */
extern int bcm_time_rx_timestamp_profile_get(
    int unit, 
    int profile_id, 
    bcm_time_rx_timestamp_profile_t *profile);
