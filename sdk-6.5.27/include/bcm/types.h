...
#define BCM_MAX_LT_NAME         128        /* Maximum logical table name bytes. */
...
#define BCM_COSQ_GPORT_TYPE_PORT_TC_SCHED   _SHR_COSQ_GPORT_TYPE_PORT_TC_SCHED 
...
#define BCM_GPORT_TYPE_FLOW_LIF             _SHR_GPORT_TYPE_FLOW_LIF 
...
#define BCM_GPORT_IS_FLOW_AGG(_gport)       _SHR_GPORT_IS_FLOW_AGG(_gport) 
...
#define BCM_COSQ_GPORT_IS_PORT_TC_SCHED(_gport)  _SHR_COSQ_GPORT_IS_PORT_TC_SCHED(_gport) 
...
#define BCM_GPORT_IS_FLOW_LIF(_gport)       _SHR_GPORT_IS_FLOW_LIF(_gport) 
...
#define BCM_GPORT_FLOW_AGG_SET(_gport, _flow_agg_id)  \
    _SHR_GPORT_FLOW_AGG_SET(_gport, _flow_agg_id) 
...
#define BCM_GPORT_FLOW_AGG_GET(_gport)  \
    (!_SHR_GPORT_IS_FLOW_AGG(_gport) ? -1 : \
    _SHR_GPORT_FLOW_AGG_GET(_gport)) 
...
#define BCM_COSQ_GPORT_PORT_TC_SCHED_SET(_gport, _port)  \
    _SHR_COSQ_GPORT_PORT_TC_SCHED_SET(_gport, _port) 

#define BCM_COSQ_GPORT_PORT_TC_SCHED_GET(_gport)  \
    (!_SHR_COSQ_GPORT_IS_PORT_TC_SCHED(_gport) ? -1 :  \
    _SHR_COSQ_GPORT_PORT_TC_SCHED_GET(_gport)) 
...
#define BCM_GPORT_FLOW_LIF_ID_SET(_gport, _flow_lif_id)  \
    _SHR_GPORT_FLOW_LIF_ID_SET(_gport, _flow_lif_id) 

#define BCM_GPORT_FLOW_LIF_ID_GET(_gport)  \
    (!_SHR_GPORT_IS_FLOW_LIF(_gport) ? -1 :  \
    _SHR_GPORT_FLOW_LIF_ID_GET(_gport)) 
...
#define BCM_FOREACH_LOCAL_UNIT(_unit)  \
    for (_unit = 0; _unit < BCM_LOCAL_UNITS_MAX; _unit++) \
...
/* VLAN SVTAG configuration. */
typedef struct bcm_vlan_svtag_config_s {
    uint32 sc_index;                /* Secure channel index. */
    bcm_svtag_pkt_type_t pkt_type;  /* The packet type. */
    uint32 offset_adder;            /* The offset addition to place the security
                                       tag. */
} bcm_vlan_svtag_config_t;
...
typedef struct bcm_vlan_action_set_s {
    ...
    bcm_vlan_action_t outer_tag;        /* Outer-tag action for all tagged
                                           packets. */
    bcm_vlan_action_t inner_tag;        /* Inner-tag action for all tagged
                                           packets. */
    ...
    bcm_vlan_action_t opaque_tag_present; /* Opaque-tag action for opaque-tagged
                                           packets. */
    bcm_vlan_action_t opaque_tag_not_present; /* Opaque-tag action for
                                           non-opaque-tagged packets. */
    bcm_gport_t gport;                  /* Gport. */
    uint32 gport_group;                 /* Gport group ID. */
    bcm_vlan_t new_third_vlan;          /* Third tag to be added. */
    bcm_vlan_action_t third_tag_action; /* Only Add or None supported. */
    bcm_vlan_svtag_config_t svtag_cfg;  /* SVTAG configuration. */
    int egr_pkt_length_adjust_profile;  /* Egress packet length adjust profile. */
...
#define BCM_PKT_FORMAT_TUNNEL_L3        (1 << 6)   /* L3 tunneled packet where
                                                      outer_ip and inner_ip are
                                                      involved */
...
#define BCM_GPORT_SUB_TYPE_IN_LIF           _SHR_GPORT_SUB_TYPE_IN_LIF 
#define BCM_GPORT_SUB_TYPE_OUT_LIF          _SHR_GPORT_SUB_TYPE_OUT_LIF 
...
#define BCM_GPORT_SUB_TYPE_VIRTUAL_INGRESS  _SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS 
...
#define BCM_GPORT_SUB_TYPE_VIRTUAL_INGRESS_NON_NATIVE _SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS_NON_NATIVE 
#define BCM_GPORT_SUB_TYPE_VIRTUAL_EGRESS_OAM_PRIMARY_VLAN _SHR_GPORT_SUB_TYPE_VIRTUAL_EGRESS_OAM_PRIMARY_VLAN 
...
#define BCM_GPORT_SUB_TYPE_IS_IN_LIF(_gport)  _SHR_GPORT_SUB_TYPE_IS_IN_LIF(_gport) 
#define BCM_GPORT_SUB_TYPE_IS_OUT_LIF(_gport)  _SHR_GPORT_SUB_TYPE_IS_OUT_LIF(_gport) 
...
#define BCM_GPORT_SUB_TYPE_IS_VIRTUAL_INGRESS(_gport)  _SHR_GPORT_SUB_TYPE_IS_VIRTUAL_INGRESS(_gport) 
...
#define BCM_GPORT_SUB_TYPE_IN_LIF_VAL_GET(_gport)  _SHR_GPORT_SUB_TYPE_IN_LIF_VAL_GET(_gport) 
#define BCM_GPORT_SUB_TYPE_OUT_LIF_VAL_GET(_gport)  _SHR_GPORT_SUB_TYPE_OUT_LIF_VAL_GET(_gport) 
...
#define BCM_GPORT_SUB_TYPE_VIRTUAL_INGRESS_GET(_gport)  _SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS_GET(_gport) 
...
#define BCM_GPORT_SUB_TYPE_IS_VIRTUAL_INGRESS_NON_NATIVE(_gport)  _SHR_GPORT_SUB_TYPE_IS_VIRTUAL_INGRESS_NON_NATIVE(_gport) 
#define BCM_GPORT_SUB_TYPE_VIRTUAL_INGRESS_NATIVE_GET(_gport)  _SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS_NATIVE_GET(_gport) 
#define BCM_GPORT_SUB_TYPE_VIRTUAL_INGRESS_NON_NATIVE_GET(_gport)  _SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS_NON_NATIVE_GET(_gport) 
...
#define BCM_GPORT_SUB_TYPE_IS_VIRTUAL_EGRESS_OAM_PRIMARY_VLAN(_gport)  _SHR_GPORT_SUB_TYPE_IS_VIRTUAL_EGRESS_OAM_PRIMARY_VLAN(_gport) 
#define BCM_GPORT_SUB_TYPE_VIRTUAL_EGRESS_OAM_PRIMARY_VLAN_GET(_gport)  _SHR_GPORT_SUB_TYPE_VIRTUAL_EGRESS_OAM_PRIMARY_VLAN_GET(_gport) 
#define BCM_GPORT_SUB_TYPE_VIRTUAL_EGRESS_OAM_PRIMARY_VLAN_SET(_gport, _virtual_id)  _SHR_GPORT_SUB_TYPE_VIRTUAL_EGRESS_OAM_PRIMARY_VLAN_SET(_gport, _virtual_id) 
...
#define BCM_GPORT_SUB_TYPE_IN_LIF_SET(_gport, _in_lif_val)  \
        (_SHR_GPORT_SUB_TYPE_IN_LIF_SET(_gport, _in_lif_val)) 

#define BCM_GPORT_SUB_TYPE_OUT_LIF_SET(_gport, _out_lif_val)  \
        (_SHR_GPORT_SUB_TYPE_OUT_LIF_SET(_gport, _out_lif_val)) 
...
#define BCM_GPORT_SUB_TYPE_VIRTUAL_INGRESS_SET(_gport, _virtual_ingress_val)  \
        (_SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS_SET(_gport, _virtual_ingress_val)) 

#define BCM_GPORT_SUB_TYPE_VIRTUAL_INGRESS_NON_NATIVE_SET(_gport, _virtual_ingress_val)  \
        (_SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS_NON_NATIVE_SET(_gport, _virtual_ingress_val)) 
...
/* GPORT to IF */
#define BCM_L3_ITF_LIF_TO_GPORT_FLOW_LIF(_gport_flow_lif, _l3_itf_lif)  \
        _SHR_L3_ITF_LIF_TO_GPORT_FLOW_LIF(_gport_flow_lif , _l3_itf_lif) 

/* GPORT to IF */
#define BCM_GPORT_FLOW_LIF_TO_L3_ITF_LIF(_l3_itf_lif, _gport_flow_lif)  \
        _SHR_GPORT_FLOW_LIF_TO_L3_ITF_LIF(_l3_itf_lif , _gport_flow_lif) 
...
/* Packet Format: GSH Header Type */
#define BCM_PKT_FORMAT_GSH_HEADER_TYPE_NON_GSH (0x0)      /* Non GSH */
#define BCM_PKT_FORMAT_GSH_HEADER_TYPE_GSH_BASE (1 << 0)   /* GSH Base */
#define BCM_PKT_FORMAT_GSH_HEADER_TYPE_GSH_BASE_EXT0 (1 << 1)   /* GSH Base extension 0 */
#define BCM_PKT_FORMAT_GSH_HEADER_TYPE_GSH_BASE_EXT0_EXT1 (1 << 2)   /* GSH Base extensions 0
                                                          & 1 */

/* Packet Format: Module Header Type */
#define BCM_PKT_FORMAT_MODULE_HEADER_TYPE_NONE (0x0)      /* Module Header Type
                                                          None */
#define BCM_PKT_FORMAT_MODULE_HEADER_TYPE_CPU_TX_HDR (1 << 0)   /* CPU TX Header */
#define BCM_PKT_FORMAT_MODULE_HEADER_TYPE_INTERNAL_LOOPBACK_HDR (1 << 1)   /* Internal Loopback
                                                          Header */
...
typedef enum bcm_pkt_drop_event_e {
    ...
    bcmPktDropEventIngressEpRecircDrop = 71, /* Ingress: Switched Packet Dropped Due
                                           To EP Recirculate */
    bcmPktDropEventIngressForteIpv4GatewayTable = 72, /* Ingress: IPv4 Packet Dropped As A
                                           Result Of FORTE IPv4 Gateway Table
                                           Lookup */
    ...
    bcmPktDropEventIngressPktEtagUnexpected = 75, /* Ingress: Pkt Etag Unexpected */
    bcmPktDropEventIngressPktEtagExpected = 76, /* Ingress: Pkt Etag Expected */
    bcmPktDropEventIngressPeRpf = 77,   /* Ingress: Pe Rpf */
    bcmPktDropEventIngressPeVidRpfMiss = 78, /* Ingress: Pe Vid Rpf Miss */
    bcmPktDropEventIngressPeVidFwdMiss = 79, /* Ingress: Pe Vid Forward Lookup Miss */
    bcmPktDropEventIngressClassBasedStationMoveFailed = 80, /* Ingress: Class Based Station Move
                                           Failed */
    bcmPktDropEventIngressBfdTerminated = 81, /* Ingress: Drop due to BFD termination */
    bcmPktDropEventIngressBpdu = 82,    /* Ingress: Drop due to BPDU */
    bcmPktDropEventIngressCfiOrL3Disabled = 83, /* Ingress: Drop due to CFI or L3
                                           disabled */
    bcmPktDropEventIngressControlFrame = 84, /* Ingress: Drop due to control frame */
    bcmPktDropEventIngressIpv4ProtocolError = 85, /* Ingress: Drop due to IPv4 protocol
                                           error */
    bcmPktDropEventIngressIpv6ProtocolError = 86, /* Ingress: Drop due to IPv6 protocol
                                           error */
    bcmPktDropEventIngressL3DosAttack = 87, /* Ingress: Drop due to L3 DoS attack */
    bcmPktDropEventIngressL4DosAttack = 88, /* Ingress: Drop due to L4 DoS attack */
    bcmPktDropEventIngressTrunkFailoverLoopback = 89, /* Ingress: Drop due to trunk failover
                                           loopback drops */
    bcmPktDropEventIngressSrcMacEqualsDstMac = 90, /* Ingress: Drop due to source mac
                                           address being equal to destination
                                           mac address */
    bcmPktDropEventIngressEcmpResolutionError = 91, /* Ingress: Drop due to ECMP resolution
                                           error */
    bcmPktDropEventIngressFpL2FieldChangeWithoutRedirect = 92, /* Ingress: Drop due to presence of L2
                                           fields change action from FP without
                                           a valid redirect action */
    bcmPktDropEventIngressIntErrorDrop = 93, /* Ingress: Drop due to error in the
                                           Inband telemetry packet */
    bcmPktDropEventIngressInvalidGSH = 94, /* Ingress: Drop due to invalid GSH
                                           packets */
    bcmPktDropEventIngressInvalidNonGSH = 95, /* Ingress: Drop due to invalid non-GSH
                                           packets */
    bcmPktDropEventIngressIpmcHdrError = 96, /* Ingress: Drop due to IPMC header
                                           error */
    bcmPktDropEventIngressL2TunnelSrcIpLookupMiss = 97, /* Ingress: Drop due to Source IP lookup
                                           miss for L2 tunnel packets */
    bcmPktDropEventIngressSrcMacZero = 98, /* Ingress: Drop due to Source Mac equal
                                           to zero */
    bcmPktDropEventIngressMplsError = 99, /* Ingress: Drop due to various errors
                                           during the MPLS processing stage */
    bcmPktDropEventIngressMulticastIndexError = 100, /* Ingress: Drop due to invalid
                                           multicast index */
    bcmPktDropEventIngressMyStationHitDiscard = 101, /* Ingress: Drop due to My station hit
                                           discard */
    bcmPktDropEventIngressNextHopDrop = 102, /* Ingress: Drop due to indication of
                                           drop from next hop table */
    bcmPktDropEventIngressOverlayUnderlayRangeError = 103, /* Ingress: Drop due to overlay or
                                           underlay next hop indices not
                                           complying with configured bank
                                           allocation bitmap */
    bcmPktDropEventIngressPortFilteringMode = 104, /* Ingress: Drop due to port filtering
                                           mode */
    bcmPktDropEventIngressSerDrop = 105, /* Ingress: Drop due to parity or ecc
                                           errors */
    bcmPktDropEventIngressSrv6ProcessError = 106, /* Ingress: Drop due to error in SRV6
                                           processing */
    bcmPktDropEventIngressSrv6ValidationError = 107, /* Ingress: Drop due to error in SRV6
                                           validation */
    bcmPktDropEventIngressTagUntagDiscard = 108, /* Ingress: Drop due to discard setting
                                           of tagged and untagged packets */
    bcmPktDropEventIngressTimeSync = 109, /* Ingress: Drop of a time sync packet */
    bcmPktDropEventIngressTunnelDecapEcn = 110, /* Ingress: Drop due to indication in
                                           tunnel decapsulation ecn table */
    bcmPktDropEventIngressTunnelError = 111, /* Ingress: Drop due to tunnel errors */
    bcmPktDropEventIngressMplsGalLabelLookupMiss = 112, /* Ingress: Drop due to MPLS GAL label
                                           miss */
    bcmPktDropEventIngressMplsCtrlWordInvalid = 113, /* Ingress: Drop due to invalid MPLS
                                           Control word */
    bcmPktDropEventIngressMplsInvalidPayload = 114, /* Ingress: Drop due to invalid payload
                                           on MPLS packets */
    bcmPktDropEventIngressMplsLabelLookupMiss = 115, /* Ingress: Drop due to MPLS label
                                           lookup miss */
    bcmPktDropEventIngressVxlanTunnelError = 116, /* Ingress: Drop due to errors in VXLAN
                                           tunnel processing */
    bcmPktDropEventIngressVxlanVnidLookupMiss = 117, /* Ingress: Drop due to VXLAN VNID
                                           lookup miss */
    bcmPktDropEventIngressSrv6UnknownRoutingType = 118, /* Ingress: Drop due to unknown routing
                                           type in the SRV6 packet with non zero
                                           segmentleft field. */
    bcmPktDropEventIngressVlanCrossConnect = 119, /* Ingress: Drop due to Vlan cross
                                           connect */
    bcmPktDropEventIngressInvalidVlan = 120, /* Ingress: Drop due to invalid VLAN ID
                                           in the packet */
    bcmPktDropEventIngressIpv4Discard = 121, /* Ingress: Drop of an IPv4 RX packet */
    bcmPktDropEventIngressIpv4HdrError = 122, /* Ingress: Drop due to error in the
                                           IPv4 header */
    bcmPktDropEventIngressIpv6Discard = 123, /* Ingress: Drop of an IPv6 RX packet */
    bcmPktDropEventIngressIpv6HdrError = 124, /* Ingress: Drop due to error in the
                                           IPv6 header */
    bcmPktDropEventIngressBfdUnknownAch = 125, /* Ingress: Drop due to an unknown
                                           Associated channel header in the BFD
                                           packet */
    bcmPktDropEventIngressBfdUnknownCtrlPkt = 126, /* Ingress: Drop due to an unknown
                                           control channel in the BFD packet */
    bcmPktDropEventIngressBfdUnknownVersionOrDiscriminator = 127, /* Ingress: Drop due to an unknown
                                           version or unknown discriminator in
                                           the BFD packet */
    bcmPktDropEventIngressDosFragment = 128, /* Ingress: DOS attack fragment error
                                           packets */
    bcmPktDropEventIngressDosIcmp = 129, /* Ingress: DOS attack ICMP error
                                           packets */
    bcmPktDropEventIngressDosL2 = 130,  /* Ingress: DOS attack L2 packets */
    bcmPktDropEventIngressTrunkFailoverLoopbackDiscard = 131, /* Ingress: Drop due to Trunk failover
                                           loopback discard */
    bcmPktDropEventIngressParityError = 132, /* Ingress: Drop due to parity error */
    bcmPktDropEventIngressNonIp = 133,  /* Ingress: Drop of a non IP packet */
    bcmPktDropEventIngressL2L3Mcast = 134, /* Ingress: Drop of L2 or L3 Multicast
                                           packets */
    bcmPktDropEventIngressEgressMask = 135, /* Ingress: Drop due to egress mask */
    bcmPktDropEventIngressDstLinkDownPartial = 136, /* Ingress: Partial drop of non unicast
                                           packets due to destination link down */
    bcmPktDropEventIngressFpRedirectMask = 137, /* Ingress: Drop due to FP redirect mask */
    bcmPktDropEventIngressFpDelayedAction = 138, /* Ingress: Drop due to delayed FP
                                           action */
    bcmPktDropEventIngressIngEgrMask = 139, /* Ingress: Drop due to ingress egress
                                           mask */
    bcmPktDropEventIngressIntMtuCheckFail = 140, /* Ingress: Drop due to L3 MTU check
                                           failure on INT packets due to
                                           metadata insertion */
    bcmPktDropEventIngressMacMask = 141, /* Ingress: Drop due to MAC mask */
    bcmPktDropEventIngressMulticastError = 142, /* Ingress: Drop due to multicast errors */
    bcmPktDropEventIngressNextHopDown = 143, /* Ingress: Drop due to next hop being
                                           down */
    bcmPktDropEventIngressNonUnicastMask = 144, /* Ingress: Drop due to non unicast mask */
    bcmPktDropEventIngressNonUnicastTrunkMask = 145, /* Ingress: Drop due to non unicast
                                           trunk resolution mask */
    bcmPktDropEventIngressVlanStg = 146, /* Ingress: Drop due to vlan spanning
                                           tree group state */
    bcmPktDropEventIngressVlanBlock = 147, /* Ingress: Drop due to blocked ports on
                                           Vlan */
    bcmPktDropEventIngressVlanMembershipMask = 148, /* Ingress: Drop due to Ingress Vlan
                                           membership mask */
    bcmPktDropEventEgressAge = 149,     /* Egress: Aged drop packets */
    bcmPktDropEventEgressCfi = 150,     /* Egress: Packets dropped due to CFI
                                           bit set */
    bcmPktDropEventEgressParityError = 151, /* Egress: Drop due to parity errors */
    bcmPktDropEventEgressRoutingPlane = 152, /* Egress: Drop due to Routing plane
                                           table */
    bcmPktDropEventEgressEcnTable = 153, /* Egress: Drop due to ECN table */
    bcmPktDropEventEgressAdaptTableLookupMiss = 154, /* Egress: Drop due to adaptation table
                                           lookup miss */
    bcmPktDropEventEgressRedirection = 155, /* Egress: Drop due to egress
                                           redirection */
    bcmPktDropEventEgressParseLimitExceed = 156, /* Egress: Drop due to egress parse
                                           limit exceeded */
    bcmPktDropEventEgressIfaTermDropError = 157, /* Egress: Drop due to error in IFA
                                           termination */
    bcmPktDropEventEgressIfaProbeInitError = 158, /* Egress: Drop due to error in IFA
                                           probe initiation */
    bcmPktDropEventEgressIfaProbeTermDrop = 159, /* Egress: Drop due to IFA probe
                                           termination */
    bcmPktDropEventEgressIpmcL2SelfPort = 160, /* Egress: Drop due to IPMC L2 self port
                                           pruned */
    bcmPktDropEventEgressIpmcL3SelfIntf = 161, /* Egress: Drop due to IPMC self
                                           interface pruned. */
    bcmPktDropEventEgressLoopbackToLoopback = 162, /* Egress: Drop due to 2nd pass loopback
                                           to loopback packet */
    bcmPktDropEventEgressInvalidModuleId = 163, /* Egress: Drop due to invalid module id */
    bcmPktDropEventEgressNonUnicastPrune = 164, /* Egress: Drop of non unicast packets
                                           due to pruning configuration on DVP */
    bcmPktDropEventEgressOverlayUnderlayIdxError = 165, /* Egress: Drop due to error in the
                                           range of indexes of next hop or
                                           interface */
    bcmPktDropEventEgressPortInvalidGsh = 166, /* Egress: Drop due to invalid GSH
                                           packets filtered on a port */
    bcmPktDropEventEgressPortInvalidNonGsh = 167, /* Egress: Drop due to invalid non GSH
                                           packets filtered on a port */
    bcmPktDropEventEgressPurge = 168,   /* Egress: Drop due to purging */
    bcmPktDropEventEgressSvpEsDrop = 169, /* Egress: Drop due to ethernet segment
                                           filtering on a SVP */
    bcmPktDropEventEgressInvalidVlan = 170, /* Egress: Drop due to invalid vlan */
    bcmPktDropEventEgressGbpFilterDrop = 171, /* Egress: GBP filter drop. */
    bcmPktDropEventIngressSrcBindFail = 172, /* Ingress: Drop due to source binding
                                           check fail */
    bcmPktDropEventCount = 173          /* Must Be Last. Not A Valid Event */
} bcm_pkt_drop_event_t;

/* Egress drop event definitions. */
typedef enum bcm_egress_drop_event_e {
    bcmEgressDropEventAge = 0,          /* Aged drop packets */
    bcmEgressDropEventBadTpid = 1,      /* Packets dropped due to the bad TPID */
    bcmEgressDropEventCfi = 2,          /* Packets dropped due to CFI bit set */
    bcmEgressDropEventParityError = 3,  /* Packets dropped due to parity error */
    bcmEgressDropEventNewPktEcnIllegalKey = 4, /* Packets dropped due to an illegal key
                                           to get new packet ECN */
    bcmEgressDropEventField = 5,        /* Packets dropped due to enabling
                                           egress Field drop */
    bcmEgressDropEventAdaptLookupMiss = 6, /* Packets dropped due to adaptation
                                           lookup miss */
    bcmEgressDropEventPktTooLarge = 7,  /* Packets dropped due to packet size
                                           becoming too large after additional
                                           bytes were added */
    bcmEgressDropEventIntOverflow = 8,  /* Packets dropped due to INT overflow */
    bcmEgressDropEventIntProbeTermination = 9, /* Packets dropped due to INT probe
                                           termination */
    bcmEgressDropEventIpmcL2SelfPort = 10, /* Packets dropped due to IPMC L2 self
                                           port pruned */
    bcmEgressDropEventIpmcL3SelfIntf = 11, /* Packets dropped due to IPMC self
                                           interface pruned */
    bcmEgressDropEventL2MtuFail = 12,   /* Packets dropped due to L2 MTU check
                                           failure */
    bcmEgressDropEventLoopbackToLoopback = 13, /* Packets dropped due to loopback
                                           packet destination is also a loopback
                                           port */
    bcmEgressDropEventModidGreaterThan31 = 14, /* Packets dropped due to module ID
                                           greater than 31 */
    bcmEgressDropEventNonUnicastPrune = 15, /* Non-unicast packets dropped due to
                                           packet pruning configured on
                                           destination virtual port */
    bcmEgressDropEventVlanMemberFilter = 16, /* Packets dropped due to VLAN member
                                           filtering */
    bcmEgressDropEventL3OverlayUnderlayRangeError = 17, /* Packets dropped due to L3
                                           overlay/underlay egress and interface
                                           indices do not comply with configured
                                           allocation bitmap */
    bcmEgressDropEventPktTooSmall = 18, /* Packets whose size is too small */
    bcmEgressDropEventPurgePkt = 19,    /* Packets dropped due to purging
                                           packets */
    bcmEgressDropEventCellTooSmall = 20, /* Multi-cell packets whose SOP cell
                                           size is smaller than 64 bytes after
                                           decap */
    bcmEgressDropEventSplitHorizonCheck = 21, /* Packets dropped due to split horizon
                                           check */
    bcmEgressDropEventStgBlock = 22,    /* Packets dropped due to STG block */
    bcmEgressDropEventStgDisabled = 23, /* Packets dropped due to STG disabled */
    bcmEgressDropEventSvpEsFilter = 24, /* Packets dropped due to enabling
                                           ethernet segment (ES) filtering based
                                           on source virtual port */
    bcmEgressDropEventTtlCheck = 25,    /* Packets dropped due to TTL threshold
                                           exceeded */
    bcmEgressDropEventTunnelSnap = 26,  /* Packets dropped due to tunnel
                                           snapping */
    bcmEgressDropEventInvalidVlan = 27, /* Packets dropped due to invalid VLAN */
    bcmEgressDropEventVpPrune = 28,     /* Packets dropped due to enabling
                                           pruning of packets with source
                                           virtual port equals to destination
                                           virtual port */
    bcmEgressDropEventPortDiscard = 29, /* Packets dropped due to enabling
                                           discard all traffic on that outgoing
                                           port. */
    bcmEgressDropEventDcnPktRoutingPlaneMap = 30, /* Routing plane mapping drop for DCN
                                           packets. */
    bcmEgressDropEventEpRecirc = 31,    /* EP recirculation drop. */
    bcmEgressDropEventParseDepthLimitExceed = 32, /* Packet parsing depth limit exceeded. */
    bcmEgressDropEventIfaTermError = 33, /* Error conditions during IFA
                                           termination. */
    bcmEgressDropEventIfaProbeInitError = 34, /* Error conditions during IFA probe
                                           initiation. */
    bcmEgressDropEventHigig3Pkt = 35,   /* HIGIG3 packets drop configuration. */
    bcmEgressDropEventNonHigig3Pkt = 36, /* Non HIGIG3 packets drop
                                           configuration. */
    bcmEgressDropEventCount = 37        /* Must Be Last. Not A Valid Event */
} bcm_egress_drop_event_t;
...
typedef enum bcm_pkt_trace_event_e {
    ...
    bcmPktTraceEventIngressForteIpv4GatewayTable = 43, /* Ingress: IPv4 Packet Hit As A Result
                                           Of FORTE IPv4 Gateway Table Lookup */
    ...
    bcmPktTraceEventIngressPktEtagUnexpected = 46, /* Ingress: Pkt Etag Unexpected */
    bcmPktTraceEventIngressPktEtagExpected = 47, /* Ingress: Pkt Etag Expected */
    bcmPktTraceEventIngressPeRpf = 48,  /* Ingress: Pe Rpf */
    bcmPktTraceEventIngressPeVidRpfMiss = 49, /* Ingress: Pe Vid Rpf Miss */
    bcmPktTraceEventIngressPeVidFwdMiss = 50, /* Ingress: Pe Vid Forward Lookup Miss */
    bcmPktTraceEventIngressClassBasedStationMoveFailed = 51, /* Ingress: Class Based Station Move
                                           Failed */
    bcmPktTraceEventIngressSrcBindFail = 52, /* Ingress: Source binding check failed */
    bcmPktTraceEventCount = 53          /* Must Be Last. Not A Valid Event */
...
#define BCM_GPORT_IS_AQM_FLOW_ID(_gport)    \
     _SHR_GPORT_IS_LATENCY_AQM_FLOW_ID(_gport) 
#define BCM_GPORT_AQM_FLOW_ID_GET(_gport)   \
    (!_SHR_GPORT_IS_LATENCY_AQM_FLOW_ID(_gport) ? -1 : \
    _SHR_GPORT_LATENCY_AQM_FLOW_ID_GET(_gport)) 
#define BCM_GPORT_AQM_FLOW_ID_SET(_gport, _profile)  \
        (_SHR_GPORT_LATENCY_AQM_FLOW_ID_SET(_gport, _profile))
...
#define BCM_GPORT_IS_OCB_GLOBAL_DROP_PROFILE(_gport)  \
     _SHR_GPORT_IS_OCB_GLOBAL_DROP_PROFILE(_gport) 
#define BCM_GPORT_OCB_GLOBAL_DROP_PROFILE_GET(_gport)  \
    (!_SHR_GPORT_IS_OCB_GLOBAL_DROP_PROFILE(_gport) ? -1 : \
    _SHR_GPORT_OCB_GLOBAL_DROP_PROFILE_GET(_gport)) 
#define BCM_GPORT_OCB_GLOBAL_DROP_PROFILE_SET(_gport, _profile)  \
        (_SHR_GPORT_OCB_GLOBAL_DROP_PROFILE_SET(_gport, _profile))
 
#define BCM_GPORT_IS_AQM_PROFILE(_gport)    \
     _SHR_GPORT_IS_AQM_PROFILE(_gport) 
#define BCM_GPORT_AQM_PROFILE_GET(_gport)   \
    (!_SHR_GPORT_IS_AQM_PROFILE(_gport) ? -1 : \
    _SHR_GPORT_AQM_PROFILE_GET(_gport)) 
#define BCM_GPORT_AQM_PROFILE_SET(_gport, _profile)  \
        (_SHR_GPORT_AQM_PROFILE_SET(_gport, _profile))
 
#define BCM_GPORT_IS_GLOBAL_VOQ_BIN_PROFILE(_gport)  \
     _SHR_GPORT_IS_GLOBAL_VOQ_BIN_PROFILE(_gport) 
#define BCM_GPORT_GLOBAL_VOQ_BIN_PROFILE_GET(_gport)  \
    (!_SHR_GPORT_IS_GLOBAL_VOQ_BIN_PROFILE(_gport) ? -1 : \
    _SHR_GPORT_GLOBAL_VOQ_BIN_PROFILE_GET(_gport)) 
#define BCM_GPORT_GLOBAL_VOQ_BIN_PROFILE_SET(_gport, _profile)  \
        (_SHR_GPORT_GLOBAL_VOQ_BIN_PROFILE_SET(_gport, _profile))
 
#define BCM_GPORT_IS_GLOBAL_VOQ_TC_PROFILE(_gport)  \
     _SHR_GPORT_IS_GLOBAL_VOQ_TC_PROFILE(_gport) 
#define BCM_GPORT_GLOBAL_VOQ_TC_PROFILE_GET(_gport)  \
    (!_SHR_GPORT_IS_GLOBAL_VOQ_TC_PROFILE(_gport) ? -1 : \
    _SHR_GPORT_GLOBAL_VOQ_TC_PROFILE_GET(_gport)) 
#define BCM_GPORT_GLOBAL_VOQ_TC_PROFILE_SET(_gport, _profile)  \
        (_SHR_GPORT_GLOBAL_VOQ_TC_PROFILE_SET(_gport, _profile))
...
typedef enum bcm_cosq_drop_reason_e {
    ...
    bcmCosqDropReasonMacsecErrorReject = 46, 
    bcmCosqDropReasonPpErrorReject = 47, 
    bcmCosqDropReasonLagRemoteReject = 48, 
    bcmCosqDropReasonLagProtectionReject = 49, 
    bcmCosqDropReasonTAFMaxPacketSizeReject = 50, /* Rejected by the TAF gate due to a
                                           large packet size */
    bcmCosqDropReasonTAFClosedGateReject = 51, /* Rejected due to close TAF gate */
    bcmCosqDropReasonRejectCount = 52 
...
#define BCM_PORT_FLEXE_MAX_NOF_SLOTS    960        
...
#define BCM_ECN_INVALID         0xff       /* Invalid ECN value. */

/* bcm_policer_action_id_t */
typedef int bcm_policer_action_id_t;

/* bcm_policer_action_profile_id_t */
typedef int bcm_policer_action_profile_id_t;

/* Flags for core group. */
#define BCM_CORES_GROUP_ALL     -1         
