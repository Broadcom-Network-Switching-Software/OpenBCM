...
#define SHR_PKT_F_EVENT                     0x1        /* forward Eventor packet */
#define SHR_PKT_F_F1588                     0x2        /* forward F1588 packet */

typedef enum {
    _SHR_PKT_CHANNEL_TYPE_INVALID = -1, 
    _SHR_PKT_CHANNEL_TYPE_DEFAULT = 0, /* Self routed cells, packets */
    _SHR_PKT_CHANNEL_TYPE_SOURCE_ROUTED = 1, 
    _SHR_PKT_CHANNEL_TYPE_MIRROR = 2, 
    _SHR_PKT_CHANNEL_TYPE_EVENT = 3, 
    _SHR_PKT_CHANNEL_TYPE_F1588 = 4, 
    _SHR_PKT_CHANNEL_TYPE_P1588 = 5, 
    _SHR_PKT_CHANNEL_TYPE_NOF = 6, 
} _shr_rx_channel_type_t;
