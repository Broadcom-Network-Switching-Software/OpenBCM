...
#define _SHR_GPORT_TYPE_MAX _SHR_GPORT_TYPE_FLOW_LIF   /* Used for sanity checks only. */
 /*
...
#define _SHR_MCAST_GPORT_TYPE_ELEMENT_ID        3
...
#define _SHR_COSQ_GPORT_TYPE_PORT_TC_SCHED       29
...
#define _SHR_COSQ_GPORT_COMMON_CORE_BITS 4
...
#define _SHR_GPORT_SCHEDULER_MASK                       0x3fffff
#define _SHR_GPORT_SCHEDULER_CORE_SHIFT                 22
...
#define _SHR_GPORT_FLEXE_GROUP_MASK                     0xf
...
#define _SHR_MCAST_GPORT_ELEMENT_ID_TYPE_SHIFT           22
#define _SHR_MCAST_GPORT_ELEMENT_ID_TYPE_MASK            1
#define _SHR_MCAST_GPORT_ELEMENT_ID_SHIFT                0
#define _SHR_MCAST_GPORT_ELEMENT_ID_MASK                 ((1<<_SHR_MCAST_GPORT_ELEMENT_ID_TYPE_SHIFT)-1)
...
#define _SHR_VSQ_TYPE_INFO_SRC_PORT_SHIFT               0
...
#define _SHR_COSQ_GPORT_ISQ_CORE_MASK                   0x7
#define _SHR_COSQ_GPORT_ISQ_CORE_FIELD2ID(field)      ((field) != _SHR_COSQ_GPORT_ISQ_CORE_MASK ? field : _SHR_CORE_ALL)
...
#define _SHR_COSQ_GPORT_FABRIC_RX_CORE_SHIFT            17
#define _SHR_COSQ_GPORT_FABRIC_RX_CORE_MASK             _SHR_COSQ_GPORT_COMMON_CORE_MASK
...
#define _SHR_COSQ_GPORT_PORT_TC_SCHED_SHIFT             0
#define _SHR_COSQ_GPORT_PORT_TC_SCHED_MASK              0x7FF
...
#define _SHR_COSQ_GPORT_INGRESS_RECEIVE_CORE_ID_SHIFT    17
...
#define _SHR_COSQ_EXT_GPORT_VOQ_CONNECTOR_CORE_SHIFT        19
...
#define _SHR_COSQ_EXT_GPORT_SCHED_CIR_CORE_SHIFT            19
...
#define _SHR_COSQ_EXT_GPORT_SCHED_PIR_CORE_SHIFT            19
...
#define _SHR_COSQ_EXT_GPORT_SHARED_SHAPER_ELEM_CORE_SHIFT   19
...
#define _SHR_COSQ_EXT_GPORT_COMPOSITE_SF2_CORE_SHIFT        19
...
#define _SHR_MCAST_GPORT_IS_ELEMENT_ID(_gport)                                       \
        (_SHR_GPORT_IS_MCAST(_gport) &&                                                 \
        ((((_gport) >> _SHR_MCAST_GPORT_TYPE_SHIFT) & _SHR_MCAST_GPORT_TYPE_MASK) ==     \
                                                _SHR_MCAST_GPORT_TYPE_ELEMENT_ID))

#define _SHR_MCAST_GPORT_IS_ELEMENT_STATIC(_gport)                                       \
        (_SHR_GPORT_IS_MCAST(_gport) &&                                                 \
        ((((_gport) >> _SHR_MCAST_GPORT_ELEMENT_ID_TYPE_SHIFT) & _SHR_MCAST_GPORT_ELEMENT_ID_TYPE_MASK) == TRUE))
...
#define _SHR_MCAST_GPORT_ELEMENT_ID_SET(_gport, _mcast_id, is_static)                \
        ((_gport) = (_SHR_GPORT_TYPE_MCAST << _SHR_GPORT_TYPE_SHIFT)  | \
         (_SHR_MCAST_GPORT_TYPE_ELEMENT_ID << _SHR_MCAST_GPORT_TYPE_SHIFT)  | \
         (((is_static) & _SHR_MCAST_GPORT_ELEMENT_ID_TYPE_MASK) << _SHR_MCAST_GPORT_ELEMENT_ID_TYPE_SHIFT)  | \
         (((_mcast_id) & _SHR_MCAST_GPORT_ELEMENT_ID_MASK) << _SHR_MCAST_GPORT_ELEMENT_ID_SHIFT))
...
#define _SHR_MCAST_GPORT_ELEMENT_ID_GET(_gport)   \
        (((_gport) >> _SHR_MCAST_GPORT_ELEMENT_ID_SHIFT) & _SHR_MCAST_GPORT_ELEMENT_ID_MASK)
...
#define _SHR_GPORT_IS_FLOW_LIF(_gport)    \
        ((((_gport) >> _SHR_GPORT_TYPE_SHIFT) & _SHR_GPORT_TYPE_MASK) == _SHR_GPORT_TYPE_FLOW_LIF)

#define _SHR_GPORT_FLOW_LIF_ID_SET(_gport, _flow_lif_id)                       \
        ((_gport) = (_SHR_GPORT_TYPE_FLOW_LIF   << _SHR_GPORT_TYPE_SHIFT)  | \
         (((_flow_lif_id) & _SHR_GPORT_FLOW_LIF_MASK) << _SHR_GPORT_FLOW_LIF_SHIFT))

#define _SHR_GPORT_FLOW_LIF_ID_GET(_gport)   \
        (((_gport) >> _SHR_GPORT_FLOW_LIF_SHIFT) & _SHR_GPORT_FLOW_LIF_MASK)
...
#define _SHR_COSQ_GPORT_ISQ_SET(_gport, _qid) \
        ((_gport) = (_SHR_GPORT_TYPE_COSQ << _SHR_GPORT_TYPE_SHIFT) | \
         ...
         ((_SHR_COSQ_GPORT_COMMON_ALL_CORES_VALUE & _SHR_COSQ_GPORT_ISQ_CORE_MASK) << \
          _SHR_COSQ_GPORT_COMMON_CORE_SHIFT) | \
...
#define _SHR_COSQ_GPORT_ISQ_CORE_QUEUE_SET(_gport, _core, _qid) \
        ((_gport) = (_SHR_GPORT_TYPE_COSQ << _SHR_GPORT_TYPE_SHIFT) | \
         (_SHR_COSQ_GPORT_TYPE_ISQ << _SHR_COSQ_GPORT_TYPE_SHIFT) | \
         ((_SHR_CORE_ID2FIELD(_core) & _SHR_COSQ_GPORT_ISQ_CORE_MASK) << _SHR_COSQ_GPORT_COMMON_CORE_SHIFT) | \
         (((_qid) & _SHR_COSQ_GPORT_ISQ_QID_MASK) << _SHR_COSQ_GPORT_ISQ_QID_SHIFT))
#define _SHR_COSQ_GPORT_ISQ_CORE_GET(_gport) \
        _SHR_COSQ_GPORT_ISQ_CORE_FIELD2ID(((_gport) >> _SHR_COSQ_GPORT_COMMON_CORE_SHIFT) & \
        _SHR_COSQ_GPORT_COMMON_CORE_MASK)
...
#define _SHR_COSQ_GPORT_IS_PORT_TC_SCHED(_gport)                                             \
        (_SHR_GPORT_IS_COSQ_BASE(_gport) &&                                                 \
        ((((_gport) >> _SHR_COSQ_GPORT_TYPE_SHIFT) & _SHR_COSQ_GPORT_TYPE_MASK) ==     \
                                                _SHR_COSQ_GPORT_TYPE_PORT_TC_SCHED))

#define _SHR_COSQ_GPORT_PORT_TC_SCHED_SET(_gport, _port)                                     \
        ((_gport) = (_SHR_GPORT_TYPE_COSQ << _SHR_GPORT_TYPE_SHIFT)   |                \
         (_SHR_COSQ_GPORT_TYPE_PORT_TC_SCHED << _SHR_COSQ_GPORT_TYPE_SHIFT)   |              \
         (((_port) & _SHR_COSQ_GPORT_PORT_TC_SCHED_MASK)  << _SHR_COSQ_GPORT_PORT_TC_SCHED_SHIFT))

#define _SHR_COSQ_GPORT_PORT_TC_SCHED_GET(_gport)                                            \
        (((_gport) >> _SHR_COSQ_GPORT_PORT_TC_SCHED_SHIFT) & _SHR_COSQ_GPORT_PORT_TC_SCHED_MASK)
...
#define _SHR_COSQ_GPORT_FABRIC_RX_QUEUE_SET(_gport, _core, _pipe, _fabric_rx_queue_type)\
            ((_gport) = (_SHR_GPORT_TYPE_COSQ << _SHR_GPORT_TYPE_SHIFT)   | \
             ...
             (_SHR_CORE_ID2FIELD(_core) << _SHR_COSQ_GPORT_FABRIC_RX_CORE_SHIFT) | \
...
#define _SHR_COSQ_GPORT_FABRIC_RX_QUEUE_CORE_GET(_gport)\
    _SHR_CORE_FIELD2ID(((_gport) >> _SHR_COSQ_GPORT_FABRIC_RX_CORE_SHIFT) & _SHR_COSQ_GPORT_FABRIC_RX_CORE_MASK)
...
/**
 * \brief
 *  Used to hold handles to ingress glifless (virtual) non-native
 */
#define _SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS_NON_NATIVE  (9)
...
/**
 * \brief
 *  Used to hold handles to egress  oam primary vlan info.
 */

#define _SHR_GPORT_SUB_TYPE_VIRTUAL_EGRESS_OAM_PRIMARY_VLAN     (10)
...
/* SUB GPORT Flow LIF */
#define _SHR_GPORT_SUB_TYPE_FLOW_LIF_SHIFT              (0)
#define _SHR_GPORT_SUB_TYPE_FLOW_LIF_MASK               (0x3FFFFF)
...
#define _SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS_NON_NATIVE_SHIFT    (0)
#define _SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS_NON_NATIVE_MASK     (0x3FFFFF)
...
#define _SHR_GPORT_SUB_TYPE_IS_VIRTUAL_INGRESS_NON_NATIVE(_gport)             \
     ((((_gport) >> _SHR_GPORT_SUB_TYPE_SHIFT) & _SHR_GPORT_SUB_TYPE_MASK) == _SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS_NON_NATIVE)
...
/* given gport return if this is Virtual EGRESS OAM PRIMARY VLAN subtype */
#define _SHR_GPORT_SUB_TYPE_IS_VIRTUAL_EGRESS_OAM_PRIMARY_VLAN(_gport)             \
    ((((_gport) >> _SHR_GPORT_SUB_TYPE_SHIFT) & _SHR_GPORT_SUB_TYPE_MASK) == _SHR_GPORT_SUB_TYPE_VIRTUAL_EGRESS_OAM_PRIMARY_VLAN)
...
#define _SHR_GPORT_SUB_TYPE_IN_LIF_VAL_GET(_gport) \
    ((_SHR_GPORT_SUB_TYPE_GET(_gport) == _SHR_GPORT_SUB_TYPE_IN_LIF) ? \
     (((_gport) >> _SHR_GPORT_SUB_TYPE_FLOW_LIF_SHIFT) & _SHR_GPORT_SUB_TYPE_FLOW_LIF_MASK) :-1)
...
#define _SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS_NON_NATIVE_GET(_gport) \
	  ((_SHR_GPORT_SUB_TYPE_GET(_gport) == _SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS_NON_NATIVE) ? \
	   (((_gport) >> _SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS_NON_NATIVE_SHIFT) & _SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS_NON_NATIVE_MASK):-1)
...
/* Get GPORT subvalue of subtype Virtual EGRESS OAM PRIMARY VLAN */
#define _SHR_GPORT_SUB_TYPE_VIRTUAL_EGRESS_OAM_PRIMARY_VLAN_GET(_gport) \
    ((_SHR_GPORT_SUB_TYPE_GET(_gport) == _SHR_GPORT_SUB_TYPE_VIRTUAL_EGRESS_OAM_PRIMARY_VLAN) ? \
     (((_gport) >> _SHR_GPORT_SUB_TYPE_VIRTUAL_EGRESS_MATCH_SHIFT) & _SHR_GPORT_SUB_TYPE_VIRTUAL_EGRESS_MATCH_MASK):-1)

/* Get Flow GPORT LIF value with no subtype encoding */
#define _SHR_GPORT_FLOW_LIF_VAL_GET_ID(_gport) \
     (((_gport) >> _SHR_GPORT_SUB_TYPE_FLOW_LIF_SHIFT) & _SHR_GPORT_SUB_TYPE_FLOW_LIF_MASK)
...
#define _SHR_GPORT_SUB_TYPE_IN_LIF_SET(_gport, _in_lif_val) \
    ((_gport) = (_SHR_GPORT_SUB_TYPE_IN_LIF << _SHR_GPORT_SUB_TYPE_SHIFT) | \
      (((_in_lif_val) & _SHR_GPORT_SUB_TYPE_FLOW_LIF_MASK) << _SHR_GPORT_SUB_TYPE_FLOW_LIF_SHIFT))

#define _SHR_GPORT_SUB_TYPE_OUT_LIF_SET(_gport, _out_lif_val) \
    ((_gport) = (_SHR_GPORT_SUB_TYPE_OUT_LIF << _SHR_GPORT_SUB_TYPE_SHIFT) | \
      (((_out_lif_val) & _SHR_GPORT_SUB_TYPE_FLOW_LIF_MASK) << _SHR_GPORT_SUB_TYPE_FLOW_LIF_SHIFT))
...
#define _SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS_NON_NATIVE_SET(_gport, _virtual_val) \
     ((_gport) = (_SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS_NON_NATIVE << _SHR_GPORT_SUB_TYPE_SHIFT)   | \
       (((_virtual_val) & _SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS_NON_NATIVE_MASK) << _SHR_GPORT_SUB_TYPE_VIRTUAL_INGRESS_NON_NATIVE_SHIFT))
...
/* Set GPORT subvalue and subtype Virtual EGRESS OAM_PRIMARY_VLAN */
#define _SHR_GPORT_SUB_TYPE_VIRTUAL_EGRESS_OAM_PRIMARY_VLAN_SET(_gport, _virtual_egress_oam_primary_vlan_val) \
        ((_gport) = (_SHR_GPORT_SUB_TYPE_VIRTUAL_EGRESS_OAM_PRIMARY_VLAN << _SHR_GPORT_SUB_TYPE_SHIFT)   | \
          (((_virtual_egress_oam_primary_vlan_val) & _SHR_GPORT_SUB_TYPE_VIRTUAL_EGRESS_MATCH_MASK) << _SHR_GPORT_SUB_TYPE_VIRTUAL_EGRESS_MATCH_SHIFT))
...
#define _SHR_L3_ITF_LIF_TO_GPORT_FLOW_LIF(_gport_flow_lif, _l3_itf_lif)         \
    ...
    {                                       \
        ...
        {                                         \
            ...
            {    \
                 int gport_id_dummy; \
                _SHR_GPORT_SUB_TYPE_OUT_LIF_SET(gport_id_dummy, _SHR_L3_ITF_VAL_GET(_l3_itf_lif)); \
                _SHR_GPORT_FLOW_LIF_ID_SET(_gport_flow_lif, gport_id_dummy); \
            }    \
            else     \
            {        \
...
#define _SHR_GPORT_FLOW_LIF_TO_L3_ITF_LIF(_l3_itf_lif , _gport_flow_lif)    \
    ...
    { \
        ...
        {                                        \
            ...
            {                        \
                _gport_flow_lif_val = _SHR_GPORT_FLOW_LIF_VAL_GET_ID(_gport_flow_lif);          \
