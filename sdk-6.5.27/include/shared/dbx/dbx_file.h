 ...
 *   \param [in] verbose_dir_path whether to print unavailable directory error message
 * \par DIRECT OUTPUT:
 *   \retval _SHR_E_NONE if path was successfully created
 *   \retval _SHR_E_PARAM if there was some problem with parameters
...
shr_error_e dbx_file_get_db_short_name(
    int unit,
    char *db_name,
    char *short_name);
 ...
 * \par DIRECT INPUT
 *   \param [in] size - Size of the directory string
 *   \param [out] directory - pointer to string where resulting directory should be copied.
 *                            The memory for this string should be allocated outside of the function
 * \par DIRECT OUTPUT:
 *   \retval _SHR_E_NONE if path was successfully created
 *   \retval _SHR_E_PARAM if there was some problem with parameters
 */
shr_error_e dbx_file_get_db_directory(
    size_t size,
    char *directory);
