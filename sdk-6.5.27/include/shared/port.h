...
typedef enum _shr_port_encap_e {
    ...
    _SHR_PORT_ENCAP_IEEE_REDUCED_IPG = 13,  /* IEEE reduced IPG, 2B preamble */
...
typedef enum _shr_port_phy_control_e {
    ...
    _SHR_PORT_PHY_CONTROL_CODEC_MODE_CL49 = 367,
    _SHR_PORT_PHY_CONTROL_CODEC_MODE_CL82 = 368,
    _SHR_PORT_PHY_CONTROL_CODEC_MODE_REDUCED_IPG = 369,
    _SHR_PORT_PHY_CONTROL_AN_LINK_FAIL_INHIBIT_TIMER_LT_PAM4 = 370,
    _SHR_PORT_PHY_CONTROL_FIRMWARE_OS_DFE_ENABLE = 371,
    _SHR_PORT_PHY_CONTROL_TX_PATTERN_GEN_CONFIG =372,
    _SHR_PORT_PHY_CONTROL_RS_FEC_BIT_ERROR_COUNT = 373,
    _SHR_PORT_PHY_CONTROL_RX_DC_OFFSET = 374,
 ...
 *
 */
typedef enum _shr_port_phy_scramble_mode_e {
    _SHR_PORT_PHY_SCRAMBLE_OFF     = 0,
    _SHR_PORT_PHY_SCRAMBLE_ON      = 1,
    _SHR_PORT_PHY_SCRAMBLE_DEFAULT = 2,
    _SHR_PORT_PHY_SCRAMBLE_COUNT
} _shr_port_phy_scramble_mode_t;
...
#define _SHR_PORT_PHY_TIMESYNC_SELECT_SFD                           (1U<<24)
#define _SHR_PORT_PHY_TIMESYNC_COMP_MODE_ON                         (1U<<25) /* 0 mean COMP_MODE_NONE */
#define _SHR_PORT_PHY_TIMESYNC_COMP_MODE_LATEST_LANE                (1U<<26) /* 0 mean EARLIEST */
#define _SHR_PORT_PHY_TIMESYNC_TWO_STEP_ENABLE                      (1U<<27)
#define _SHR_PORT_PHY_TIMESYNC_SELECT_MAC_DA                        (1U<<28)
...
typedef enum _shr_port_pcs_e {
    ...
    _SHR_PORT_PCS_256B257B_15T_1xN_RS_FEC   = 9,
    _SHR_PORT_PCS_256B257B_15T_2xN_RS_FEC   = 10,
    _SHR_PORT_PCS_COUNT                     = 11,
...
typedef enum _shr_port_phy_control_tx_pattern_gen_e {
    _SHR_PORT_PHY_TX_PATTERN_GEN_INVALID = 0,
    _SHR_PORT_PHY_TX_PATTERN_GEN_OFF,
    _SHR_PORT_PHY_TX_PATTERN_GEN_PAM4_JP03B,
    _SHR_PORT_PHY_TX_PATTERN_GEN_PAM4_LINEAR,
    _SHR_PORT_PHY_TX_PATTERN_GEN_CUSTOM
 } _shr_port_phy_control_tx_pattern_gen_t;
