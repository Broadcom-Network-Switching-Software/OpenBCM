...
#ifdef BCM_PETRA_SUPPORT
#if defined(BCM_PETRA_SUPPORT)
typedef struct sw_state_dpp_soc_arad_tm_modport2master_lagsysport_diagnostic_cbs_s {
    sw_state_dpp_soc_arad_tm_modport2master_lagsysport_dump_cb dump;
} sw_state_dpp_soc_arad_tm_modport2master_lagsysport_diagnostic_cbs_t;
#endif /* defined(BCM_PETRA_SUPPORT)*/ 
#endif /* BCM_PETRA_SUPPORT*/ 
...
typedef struct sw_state_dpp_soc_arad_tm_diagnostic_cbs_s {
    ...
    sw_state_dpp_soc_arad_tm_modport2master_lagsysport_diagnostic_cbs_t modport2master_lagsysport;
