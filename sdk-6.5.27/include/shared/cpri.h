...
typedef struct _shr_rsvd4_control_group_entry_s {
    uint32 valid_mask;                  /*  Valid Mask */
    uint32 queue_num[4];                /*  Queue Number */
    _shr_rsvd4_control_msg_proc_type_t type[4]; /*  Control Message Processing Type */
} _shr_rsvd4_control_group_entry_t;


/*! @brief   CPRI Rx PCS config .  */
typedef enum _shr_rx_config_field_e {
    _shrRxConfig8b10bAllowSeedChange,
    _shrRxConfig8b10bDescrHw,
    _shrRxConfig8b10bDescrEn,
    _shrRxConfiglinkAcqSwMode,
    _shrRxConfig64b66bLosOption,
    _shrRxConfig8b10bForceCommaAlignEn,
    _shrRxConfig64b66bBerWindowLimit,
    _shrRxConfig64b66bBerLimit,
    _shrRxConfigtestMode,
    _shrRxConfig64b66bInvalidShCnt,
    _shrRxConfig64b66bValidShCnt,
    _shrRxConfigCount
} _shr_rx_config_field_t;

/*!  @brief   CPRI Tx PCS config .  */
typedef enum _shr_tx_config_field_e {
    _shrTxConfigagnosticMode,
    _shrTxConfigtxpmdDisableOverrideVal,
    _shrTxConfigtxpmdDisableOverrideEn,
    _shrTxConfigscrambleBypass,
    _shrTxConfigseed8b10b,
    _shrTxConfigcwaScrEn8b10b,
    _shrTxConfigCount
} _shr_tx_config_field_t;
