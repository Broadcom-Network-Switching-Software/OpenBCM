...
typedef enum
{
    ...
    /**
     * Step to store pre-init code.
     */
    APPL_DNX_STEP_PRE_INIT,
    /**
    ...
    /**
     * DISABLE_ERPP_COUNTERS enable application
     */
    APPL_DNX_STEP_FP_DISABLE_ERPP_COUNTERS,
    /**
     * EBTR ETH LAYER enable application
     */
    APPL_DNX_STEP_FP_EBTR_ETH_LAYER,
    /**
     * BIER application
     */
    APPL_DNX_STEP_FP_BIER,
    /**
    ...
    /**
     * Non-PPH dropping application
     */
    APPL_DNX_STEP_NON_PPH_DROP,
    /**
     * FTMH application
     */
    APPL_DNX_STEP_FTMH_MC,
    /**
     * RCH handle application
     */
    APPL_DNX_STEP_RCH_HANDLE,
    /**
     * SRV6 application
     */
    APPL_DNX_STEP_SRV6,
