...
#ifdef BCM_ACCESS_SUPPORT
extern void diag_print_regmem_info(access_runtime_info_t *runtime_info, const access_device_regmem_t *rm_info, access_block_instance_num_t inst_i, uint16 arr_ind, uint32 mem_ind);
...
extern int diag_reg_info_get(int unit, char *name, int *reg_id, int *block_instance_id, unsigned int  *block_instance_number, unsigned int *array_index);
...
extern int diag_reg_field_only_set(int unit, char *name, reg_val reg_value, char* field_name,
                              reg_val field_value);
extern int diag_mem_info_get(int unit, char *name, int *mem_id, int *block_instance_id, unsigned int *block_instance_number, unsigned int *array_index);
...
extern int diag_mem_field_get(int unit, char *name, char* field_name, 
                              int index, mem_val fval);
extern int diag_mem_field_only_get(int unit, char *name, mem_val mem_value, char* field_name, 
                              int index, mem_val fval);
...
extern int diag_mem_field_only_set(int unit, char *name, mem_val value, char* field_name, 
                              int start, int count, mem_val fval);
