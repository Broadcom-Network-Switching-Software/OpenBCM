...
/**
 * \brief - Determine the channel ID passed from NIF to IRE for NIF ETH
 *
 * \param [in] unit - chip unit id.
 * \param [in] port - logical port.
 * \param [out] channel_id - Channel ID passed from NIF to IRE for TDM NIF ETH packets
 *
 */
shr_error_e dnx_port_tdm_nif_eth_channel_get(
    int unit,
    bcm_port_t port,
    int *channel_id);
/* } */
