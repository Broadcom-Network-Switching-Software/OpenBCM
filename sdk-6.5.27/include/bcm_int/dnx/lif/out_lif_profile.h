...
/**
 * \brief - Clear etpp_out_lif_profile from hardware
 *
 * \param [in] unit - Relevant unit
 * \param [in] etpp_out_lif_profile - ETPP out_lif profile that should be cleared from the hw
 *
 * \return
 *   shr_error_e
 *
 ...
 *   * None
 */
shr_error_e dnx_etpp_out_lif_profile_hw_clear(
    int unit,
    int etpp_out_lif_profile);
/*
 * }
