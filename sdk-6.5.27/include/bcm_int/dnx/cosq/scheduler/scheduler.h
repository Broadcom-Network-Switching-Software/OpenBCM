 ...
 *   * none
 */
shr_error_e dnx_scheduler_low_rate_flow_range_set(
    int unit,
    bcm_gport_t gport,
    uint32 flags,
 ...
 *   * none
 */
shr_error_e dnx_scheduler_low_rate_flow_range_get(
    int unit,
    bcm_gport_t gport,
    uint32 flags,
    bcm_cosq_control_range_type_t type,
...
/**
 * \brief - Set pattern for specific low rate range
 *
 * \param [in] unit - unit ID
 ...
 *   * None
 */
shr_error_e dnx_scheduler_low_rate_pattern_set(
    int unit,
    uint32 flags,
    bcm_gport_t gport,
    uint32 key,
 ...
 * \param [in] gport - core gport
 * \param [in] key - represent range id
 * \param [out] arg - range id pattern
 *
 * \return
 *   see shr_error_e
 * \see
 *   * None
 */
shr_error_e dnx_scheduler_low_rate_pattern_get(
    int unit,
    uint32 flags,
    bcm_gport_t gport,
    uint32 key,
...
/**
 * \brief - Check if flow id is in low rate range.
 *
 * \param [in] unit - unit ID
 * \param [in] core - core
 * \param [in] flow_id - flow id to check if low rate
 * \param [out] is_low_rate - indicate if flow id is low rate
 *
 * \return
 *   see shr_error_e
 * \see
 *   * None
 */
shr_error_e dnx_sch_flow_is_low_rate_get(
    int unit,
    bcm_core_t core,
    int flow_id,
    int *is_low_rate);
