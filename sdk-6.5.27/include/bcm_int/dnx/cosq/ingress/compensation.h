 ...
 *   NONE
 */
shr_error_e dnx_cosq_ingress_compensation_scheduler_enable_set(
    int unit,
 ...
 *   NONE
 */
shr_error_e dnx_cosq_ingress_compensation_scheduler_enable_get(
    int unit,
    bcm_cosq_control_t type,
    int *enable);
