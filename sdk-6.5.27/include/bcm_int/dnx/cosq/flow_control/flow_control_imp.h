...
/**
 * \brief -  Function to set the configuration to pass all control 
 * frames with ether type 0x8808 (including PFC) except pause packets
 *
 * \par DIRECT_INPUT:
 *   \param [in] unit - unit id
 *   \param [in] port - port for which we want to set the MAC address
 *   \param [in] enable - enable the passing of Control frames
 *
 * \remark
 *   * None
 * \see
 *   * None
 */
shr_error_e dnx_fc_port_pass_control_frames_set(
    int unit,
    int port,
    int enable);

/**
 * \brief -  Function to get the configuration to pass all control 
 * frames with ether type 0x8808 (including PFC) except pause packets
 *
 * \par DIRECT_INPUT:
 *   \param [in] unit - unit id
 *   \param [in] port - port for which we want to set the MAC address
 *   \param [out] enable - enable the passing of Control frames
 *
 * \remark
 *   * None
 * \see
 *   * None
 */
shr_error_e dnx_fc_port_pass_control_frames_get(
    int unit,
    int port,
    int *enable);

/**
 * \brief -  Function to set the configuration to pass all Pause frames.
 *
 * \par DIRECT_INPUT:
 *   \param [in] unit - unit id
 *   \param [in] port - port for which we want to set the MAC address
 ...
 *   * None
 */
shr_error_e dnx_fc_port_pass_pause_frames_set(
    int unit,
    int port,
    int enable);

/**
 * \brief -  Function to get the configuration to pass all Pause frames.
 *
 * \par DIRECT_INPUT:
 *   \param [in] unit - unit id
 *   \param [in] port - port for which we want to set the MAC address
 ...
 *   * None
 */
shr_error_e dnx_fc_port_pass_pause_frames_get(
    int unit,
    int port,
    int *enable);

/**
 * \brief -  Function to set the configuration to pass all PFC 
 * frames when ethertype is not equal to 0x8808
 *
 * \par DIRECT_INPUT:
 *   \param [in] unit - unit id
 *   \param [in] port - port for which we want to set the MAC address
 ...
 *   * None
 */
shr_error_e dnx_fc_port_pass_pfc_frames_set(
    int unit,
    int port,
    int enable);

/**
 * \brief -  Function to get the configuration to pass all PFC 
 * frames when ethertype is not equal to 0x8808
 *
 * \par DIRECT_INPUT:
 *   \param [in] unit - unit id
 ...
 *   * None
 */
shr_error_e dnx_fc_port_pass_pfc_frames_get(
    int unit,
    int port,
    int *enable);
