...
#define DNX_MPLS_PUSH_DATA_MAX_NUM_LABELS 8
...
/*
 * Define L bit in EEDB_PWE.DUAL_HOMING
 */
#define DNX_MPLS_IOAM_PWE_EEDB_L_BIT_SHIFT 20
...
typedef struct
{
    ...
    /**
     * \brief
     *   indication for LLVP profile presence..
     */
    int skip_llvp_profile;
    /**
     * \brief
     *   outlif profile is valid
     */
    int out_lif_profile_valid;
    /**
     * \brief
     *   outlif profile
     */
    ...
    /**
     * \brief
     *   lif additional_headers_profile
     */
    dbal_enum_value_field_lif_ahp_mpls_e lif_additional_headers_profile;
} dnx_mpls_encap_t;
...
*/
dbal_result_type_t dnx_mpls_tunnel_egress_result_type_get(
    int unit,
    uint32 flags,
    int tunnel_type);
...
*   \param [out] out_lif_profile_last_reference - indicate if the out_lif_profile is the last reference.
* \return
*   shr_error_e
*/
...
*   \param [out] entropy_label_enable     -  true if entropy label enabled
*   \param [out] entropy_lable_indication_enable     -  true if entropy label indication enabled
* \return
*   none
*/
void dnx_mpls_encap_lif_additional_header_profile_to_label_flags(
...
*   \param [in] has_cw     -  whether cw is present.
*   \param [in] entropy_label_enable -  if true, EL required.
*   \param [in] entropy_lable_indication_enable -  if true, ELI required.
* \return
*    dbal_enum_value_field_lif_ahp_mpls_e - profile to be used
*/
dbal_enum_value_field_lif_ahp_mpls_e dnx_mpls_encap_calc_lif_additional_header_profile(
    int has_cw,
    int entropy_label_enable,
    int entropy_lable_indication_enable);
/**
...
*   \param [in] is_replace     -  Replace operation indication.
*   \param [in] encap_info_org -  Original MPLS encapsulation information.
*   \param [in,out] encap_info -  MPLS encapsulation information.
*   \param [out] headers_profile_mngr_info -  additional headers profile management info.
* \return
*    shr_error_e - Error Type
*/
shr_error_e dnx_mpls_encap_additional_header_profile_alloc(
    int unit,
    uint8 is_replace,
...
*   \param [in] unit     -  unit ID.
*   \param [in] encap_info -  MPLS encapsulation information.
* \return
*    shr_error_e - Error Type
*/
shr_error_e dnx_mpls_encap_additional_header_profile_free(
    int unit,
    dnx_mpls_encap_t * encap_info);
