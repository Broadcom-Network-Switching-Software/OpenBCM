...
#ifndef __DNX_ALGO_TRUNK_DIAGNOSTIC_H__
#define __DNX_ALGO_TRUNK_DIAGNOSTIC_H__
...
typedef enum {
    ...
    ALGO_TRUNK_DB_USER_PROFILE_MANAGER_INFO,
...
int algo_trunk_db_user_profile_manager_dump(
    int unit, dnx_sw_state_dump_filters_t filters);

#endif /* DNX_SW_STATE_DIAGNOSTIC */

#endif /* __DNX_ALGO_TRUNK_DIAGNOSTIC_H__ */
