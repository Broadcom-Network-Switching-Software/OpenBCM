...
int dnx_algo_flexe_general_db_group_info_slot_mode_dump(
    int unit, int group_info_idx_0, dnx_sw_state_dump_filters_t filters);

int dnx_algo_flexe_general_db_group_info_demux_ghao_action_dump(
    int unit, int group_info_idx_0, dnx_sw_state_dump_filters_t filters);

int dnx_algo_flexe_general_db_group_info_mux_ghao_action_dump(
    int unit, int group_info_idx_0, dnx_sw_state_dump_filters_t filters);

int dnx_algo_flexe_general_db_group_info_demux_active_cal_dump(
    int unit, int group_info_idx_0, dnx_sw_state_dump_filters_t filters);

int dnx_algo_flexe_general_db_demux_slot_info_dump(
    int unit, int demux_slot_info_idx_0, dnx_sw_state_dump_filters_t filters);

int dnx_algo_flexe_general_db_demux_slot_info_cal_slots_dump(
    int unit, int demux_slot_info_idx_0, int cal_slots_idx_0, int cal_slots_idx_1, dnx_sw_state_dump_filters_t filters);

int dnx_algo_flexe_general_db_mux_slot_info_dump(
    int unit, int mux_slot_info_idx_0, dnx_sw_state_dump_filters_t filters);

int dnx_algo_flexe_general_db_mux_slot_info_cal_slots_dump(
    int unit, int mux_slot_info_idx_0, int cal_slots_idx_0, int cal_slots_idx_1, dnx_sw_state_dump_filters_t filters);
...
int dnx_algo_flexe_general_db_resource_alloc_virtual_client_channel_dump(
    int unit, dnx_sw_state_dump_filters_t filters);

int dnx_algo_flexe_general_db_resource_alloc_mac1_dump(
    int unit, dnx_sw_state_dump_filters_t filters);

int dnx_algo_flexe_general_db_resource_alloc_mac2_dump(
    int unit, dnx_sw_state_dump_filters_t filters);
...
int dnx_algo_flexe_general_db_mgmt_channel_info_dump(
    int unit, int mgmt_channel_info_idx_0, dnx_sw_state_dump_filters_t filters);

int dnx_algo_flexe_general_db_mgmt_channel_info_valid_dump(
    int unit, int mgmt_channel_info_idx_0, dnx_sw_state_dump_filters_t filters);
