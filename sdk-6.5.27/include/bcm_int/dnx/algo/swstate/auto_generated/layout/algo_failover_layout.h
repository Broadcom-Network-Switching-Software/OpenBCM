...
typedef enum
{
    ...
    DNX_SW_STATE_ALGO_FAILOVER_DB__FIRST,
    DNX_SW_STATE_ALGO_FAILOVER_DB__FIRST_SUB = DNX_SW_STATE_ALGO_FAILOVER_DB__FIRST - 1,
    ...
    DNX_SW_STATE_ALGO_FAILOVER_DB__LAST,
    DNX_SW_STATE_ALGO_FAILOVER_DB__LAST_SUB = DNX_SW_STATE_ALGO_FAILOVER_DB__LAST - 1,
    /*
