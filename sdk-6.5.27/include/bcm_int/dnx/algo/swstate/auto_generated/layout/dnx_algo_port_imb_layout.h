...
typedef enum
{
    ...
    DNX_SW_STATE_DNX_ALGO_PORT_IMB_DB__FIRST,
    DNX_SW_STATE_DNX_ALGO_PORT_IMB_DB__FIRST_SUB = DNX_SW_STATE_DNX_ALGO_PORT_IMB_DB__FIRST - 1,
    DNX_SW_STATE_DNX_ALGO_PORT_IMB_DB__RMC_ID_RES,
    DNX_SW_STATE_DNX_ALGO_PORT_IMB_DB__LAST,
    DNX_SW_STATE_DNX_ALGO_PORT_IMB_DB__LAST_SUB = DNX_SW_STATE_DNX_ALGO_PORT_IMB_DB__LAST - 1,
    /*
