...
typedef int (*dnx_phantom_queues_db_phantom_queues_exchange_cb)(
    int unit, uint32 phantom_queues_idx_0, uint32 flags, int nof_references, const uint32 *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference);
