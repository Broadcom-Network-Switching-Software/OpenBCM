...
typedef int (*algo_l2_db_vsi_learning_profile_exchange_cb)(
    int unit, uint32 flags, int nof_references, const dnx_vsi_learning_profile_info_t *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference);
