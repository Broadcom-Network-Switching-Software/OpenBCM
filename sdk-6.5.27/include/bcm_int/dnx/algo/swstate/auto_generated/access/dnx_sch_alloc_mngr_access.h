...
typedef int (*sch_alloc_db_sch_flow_alloc_mngr_free_single_cb)(
    int unit, uint32 sch_flow_alloc_mngr_idx_0, uint32 sch_flow_alloc_mngr_idx_1, int element, void *extra_arguments);
...
typedef int (*sch_alloc_db_interface_free_several_cb)(
    int unit, uint32 interface_idx_0, uint32 nof_elements, int element, void *extra_arguments);
...
typedef int (*sch_alloc_db_cl_class_alloc_mngr_exchange_cb)(
    int unit, uint32 cl_class_alloc_mngr_idx_0, uint32 flags, int nof_references, const dnx_sch_cl_info_t *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference);
