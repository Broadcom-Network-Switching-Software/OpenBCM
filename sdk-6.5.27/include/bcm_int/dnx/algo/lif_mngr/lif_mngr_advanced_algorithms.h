...
/**
 * \brief
 * The advanced fucntionality to free several outlif elememts and the related resources.
 *
 * Full header description in \ref dnx_algo_res_free_several_cb
 *
 * \see
 * dnx_algo_res_is_allocated_cb
 */

shr_error_e dnx_algo_local_outlif_resource_free_several(
    int unit,
    uint32 node_id,
    void *res_tag_bitmap,
    uint32 nof_elements,
