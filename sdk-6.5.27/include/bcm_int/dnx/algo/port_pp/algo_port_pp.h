...
/**
 * \brief
 *  Resource for managing ipvx over MPLS parsing profiles.
 * \see
 *  algo_port_ipvx_mpls_parsing_profile_init
 */
#define DNX_ALGO_PP_PORT_IPVX_O_MPLS_PARSING "Enable/Disable profile, for IPvx over MPSL parsing"
...
/**
 * \brief
 *  Holds the ESEM command native access ID
 */
#define DNX_ALGO_PP_PORT_ESEM_CMD_ESEM_ACCESS_NATIVE ESEM_ACCESS_IF_2
/**
 * \brief
 *  Holds the ESEM command native access ID
 */
#define DNX_ALGO_PP_PORT_ESEM_CMD_ESEM_ACCESS_SVTAG ESEM_ACCESS_IF_3
 ...
 *   \param [in] unit - Relevant unit.
 *   \param [in] data - pointer to data of type uint32 which
 *       represents enable/disable mode
 *
 * \return
 *   shr_error_e
 *
 ...
 *   * None
 *****************************************************/
void dnx_algo_port_ipvx_o_mpls_parsing_print_cb(
    int unit,
    const void *data);
