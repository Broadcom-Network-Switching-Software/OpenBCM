 ...
 * In case that allocation should be not done first and according to the return value and the free element your algorithm should run, use SIMULATION
...
/**
 * Use this flag to perform silent allocation. All the steps to allocate an
 ...
 */
#define DNX_ALGO_RES_ALLOCATE_SILENTLY      SAL_BIT(2)
...
typedef struct
{
    ...
    /**
     * String represent the name of relevant advanced algorithm. If we did not have any, "SW_STATE_ALGO_RESOURCE_ADVANCED_ALGORITHM_BASIC".
     */
    char advanced_algo_name[DNX_ALGO_RES_MNGR_MAX_NAME_LENGTH];
