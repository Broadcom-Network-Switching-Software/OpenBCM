 ...
 */
#define DNX_ALGO_TEMP_MNGR_CREATE(node_id, algo_temp, data, extra_arguments, alloc_flags)\
        SHR_IF_ERR_EXIT(dnx_algo_template_create(unit, node_id, &algo_temp, data, extra_arguments, alloc_flags))

#define DNX_ALGO_TEMP_MNGR_DESTROY(node_id, algo_temp, extra_arguments)\
        SHR_IF_ERR_EXIT(dnx_algo_template_destroy(unit, node_id, &algo_temp, extra_arguments))

#define DNX_ALGO_TEMP_MNGR_ALLOCATE_SINGLE(node_id, algo_temp, flags, profile_data, extra_arguments, profile, first_reference)\
        SHR_IF_ERR_EXIT(dnx_algo_template_allocate(unit, node_id, algo_temp, flags, profile_data, \
                                                        extra_arguments, profile, first_reference))

#define DNX_ALGO_TEMP_MNGR_FREE_SINGLE(node_id, algo_temp, profile, last_reference)\
        SHR_IF_ERR_EXIT(dnx_algo_template_free(unit, node_id, algo_temp, profile, last_reference))

#define DNX_ALGO_TEMP_MNGR_EXCHANGE(node_id, algo_temp, flags, nof_references, profile_data, old_profile,extra_arguments, new_profile, first_reference, last_reference)\
        SHR_IF_ERR_EXIT(dnx_algo_template_exchange(unit, node_id, algo_temp, flags, nof_references, profile_data, old_profile, \
                        extra_arguments, new_profile, first_reference, last_reference))

#define DNX_ALGO_TEMP_MNGR_REPLACE_DATA(node_id, algo_temp, profile, new_profile_data)\
        SHR_IF_ERR_EXIT(dnx_algo_template_replace_data(unit, node_id, algo_temp, profile, new_profile_data))

#define DNX_ALGO_TEMP_MNGR_PROFILE_DATA_GET(node_id, algo_temp, profile, ref_count, profile_data)\
        SHR_IF_ERR_EXIT(dnx_algo_template_profile_data_get(unit, node_id, algo_temp, profile, ref_count, profile_data))

#define DNX_ALGO_TEMP_MNGR_PROFILE_GET(node_id, algo_temp, profile_data, profile)\
        SHR_IF_ERR_EXIT_NO_MSG(dnx_algo_template_profile_get(unit, node_id, algo_temp, profile_data, profile))

#define DNX_ALGO_TEMP_MNGR_CLEAR(node_id, algo_temp)\
        SHR_IF_ERR_EXIT(dnx_algo_template_clear(unit, node_id, algo_temp))

#define DNX_ALGO_TEMP_MNGR_FREE_ALL(node_id, algo_temp, profile)\
        SHR_IF_ERR_EXIT(dnx_algo_template_free_all(unit, node_id, algo_temp, profile))

#define DNX_ALGO_TEMP_MNGR_GET_NEXT(node_id, algo_temp, current_profile)\
        SHR_IF_ERR_EXIT(dnx_algo_template_get_next(unit, node_id, algo_temp, current_profile))

#define DNX_ALGO_TEMP_MNGR_DUMP_INFO_GET(node_id, algo_temp, info)\
        SHR_IF_ERR_EXIT(dnx_algo_template_dump_info_get(unit, node_id, algo_temp, info))

#define DNX_ALGO_TEMP_MNGR_PRINT(unit, node_id, algo_temp, print_cb)\
        SHR_IF_ERR_EXIT(dnx_algo_template_print(unit, node_id, algo_temp, print_cb))

#define DNX_ALGO_TEMP_MNGR_ADVANCED_ALGORITHM_INFO_SET(node_id, algo_temp, algorithm_info)\
        SHR_IF_ERR_EXIT(dnx_algo_template_advanced_algorithm_info_set\
                (unit, node_id, algo_temp, algorithm_info))

#define DNX_ALGO_TEMP_MNGR_ADVANCED_ALGORITHM_INFO_GET(node_id, algo_temp, algorithm_info)\
...
*
*    \param [in] unit - Relevant unit.
*    \param [in] node_id - SW State Node ID.
