...
/* ILKN interface connectivity modes */
typedef enum dnx_algo_port_ilkn_connectivity_mode_e
{
    DNX_ALGO_PORT_ILKN_CONNECTIVITY_MODE_UNDETERMINED,
    DNX_ALGO_PORT_ILKN_CONNECTIVITY_MODE_6_LANES_PER_INTERFACE,
    DNX_ALGO_PORT_ILKN_CONNECTIVITY_MODE_8_LANES_PER_INTERFACE,
    DNX_ALGO_PORT_ILKN_CONNECTIVITY_MODE_COUNT
} dnx_algo_port_ilkn_connectivity_mode_t;
...
/**
 * \brief -
 * Verify common port related information
 *
 * \param [in] unit - Relevant unit.
 * \param [in] logical_port - required logical port.
 * \param [in] port_info - basic info about port.
 * \param [in] if_id_h0 - DB interface ID - handle 0
 * \param [in] if_id_h1 - DB interface ID - handle 1
 * \param [in] info - common info
 *
 * \return
 *   see shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_algo_port_common_add_verify(
    int unit,
    bcm_port_t logical_port,
...
/**
 * \brief -
 * Verify TM port related information
 *
 * \param [in] unit - Relevant unit.
 * \param [in] logical_port - required logical port.
 * \param [in] port_info - basic info about port.
 ...
 *   * None
 */
shr_error_e dnx_algo_port_tm_add_verify(
    int unit,
    bcm_port_t logical_port,
    dnx_algo_port_info_s port_info,
    int if_id_h0,
...
shr_error_e dnx_algo_port_ilkn_phys_12lane_mode_verify(
    int unit,
    int core,
    bcm_port_t logical_port,
    uint32 ilkn_id,
...
/**
 * \brief -
 * Verify that core X pp_dsp are in supported range (per device)
 ...
 *   * None
 */
shr_error_e dnx_algo_port_pp_dsp_valid_verify(
    int unit,
    bcm_core_t core,
    int pp_dsp);
...
/**
 * \brief -
 * Verify that core X in tm port are in supported range (per device)
 * And the relevant port mark as valid.
 *
 * \param [in] unit - Relevant unit.
 * \param [in] core - core #
 * \param [in] in_tm_port - IN TM port #
 *
 * \return
 *   see shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_algo_port_in_tm_port_valid_verify(
    int unit,
    bcm_core_t core,
    int in_tm_port);
...
/**
 * \brief -
 * Verify that core X in_tm_port are in supported range (per device)
 ...
 *   * None
 */
shr_error_e dnx_algo_port_in_tm_port_free_verify(
    int unit,
    dnx_algo_port_info_s port_info,
    bcm_core_t core,
    int in_tm_port);
 ...
 *   * None
 */
shr_error_e dnx_algo_port_pp_dsp_free_verify(
    int unit,
    dnx_algo_port_info_s port_info,
    bcm_core_t core,
    int pp_dsp);
...
/**
 * \brief -
 * Verify that pp_dsp is in range defined by actual number of FAP IDs
 *
 * \param [in] unit - Relevant unit.
 * \param [in] core - core #
 * \param [in] pp_dsp - pp dsp #
 ...
 *   * None
 */
shr_error_e dnx_algo_port_pp_dsp_allowed_verify(
    int unit,
    bcm_core_t core,
    uint32_t pp_dsp,
...
/**
 * \brief -
 * Verify out TM port related information
 *
 * \param [in] unit - Relevant unit.
 * \param [in] port_info - port information #
 * \param [in] core - core #
 * \param [in] out_tm_port - OUT TM port #
 * \param [in] info - TM info
 * \param [out] if_id_h0 - DB interface ID - handle 0
 * \param [out] if_id_h1 - DB interface ID - handle 1
 *
 * \return
 *   see shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_algo_port_out_tm_add_verify(
    int unit,
    dnx_algo_port_info_s port_info,
    bcm_core_t core,
