...
/**
 * \brief get TM master port
 */
#define DNX_ALGO_PORT_MASTER_F_TM     (0x10)

/**
 * \brief mask of all the supported flags by API dnx_algo_port_master_get
 */
#define DNX_ALGO_PORT_MASTER_F_MASK     (DNX_ALGO_PORT_MASTER_F_NEXT | DNX_ALGO_PORT_MASTER_F_TDM_BYPASS | DNX_ALGO_PORT_MASTER_F_NON_TDM_BYPASS | \
                                         DNX_ALGO_PORT_MASTER_F_SCH | DNX_ALGO_PORT_MASTER_F_TM)
...
#define DNX_ALGO_PORT_APP_FLAG_PON_CHAN_MODE_1           0x4
#define DNX_ALGO_PORT_APP_FLAG_PON_CHAN_MODE_2           0x8
...
typedef enum
{
     ...
     * FRAMER MAC (bus B)
     */
    DNX_ALGO_PORT_TYPE_FRAMER_MAC = 13,
    /**
     * FRAMER SAR (bus C) port
     */
    DNX_ALGO_PORT_TYPE_FRAMER_SAR = 14,
    /**
     * FLEXE PHY port
     */
...
typedef struct
{
    ...
    unsigned int is_mgmt:1;
    unsigned int is_feedback:1;
    ...
    unsigned int is_flexe_unaware:1;
    unsigned int is_framer_client:1;
    unsigned int is_framer_phy:1;
    unsigned int is_framer_mgmt:1;
    unsigned int is_stat_only:1;
    unsigned int is_otn_sar:1;
    unsigned int is_flexe_protection:1;
...
typedef enum
{
     ...
     */
    DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH_CDMAC,
    /**
...
typedef struct
{
    ...
    /**
     * Port in channel for channelized ports (must)
     */
    int in_channel;
    /**
     * Port out channel for channelized ports (must)
     */
    int out_channel;
    /**
...
typedef struct
{
    ...
    /**
     * Number of IN TM port
     */
    uint32 in_tm_port_nof;
    ...
    /**
     * ID of the channelized egress interface - this is in addition to egress_interface
     */
    int channelized_egress_interface;
    /**
     * Egress interleaving
     */
...
typedef struct
{
    ...
    int is_mgmt;
    /**
     * If ETH port frame preemptable
     */
    int frame_preemptable;
    /**
     * The framer channel the ETH port maps to
     */
    int framer_channel;
    /**
     * FlexE unaware interface
     */
...
typedef struct
{
    ...
    /**
     * Does Firmware support Fast link recovery
     */
    int is_flr_fw_support;
    /**
     * If external TXPI mode is enabled
     */
    int ext_txpi_enable;
...
typedef struct
{
    ...
    int is_flexe_sar;
    /**
     * is the virtual client is OTN SAR
     */
    int is_otn_sar;
    /**
    ...
    int is_cross_connet;
    /**
     * is the virtual client only for statistic
     */
    int is_stat_only;
    /**
     * is protection client only
     */
    int is_flexe_protection;
    /**
     * is framer mgmt port
     */
    int is_framer_mgmt;
    ...
    int client_channel;
    /**
     * Framer mgmt channel - used just for Framer MAC client
     */
    int mgmt_channel;
} dnx_algo_port_special_if_framer_add_t;
...
typedef struct
{
     ...
     * FlexE Info
     */
    dnx_algo_port_special_if_framer_add_t framer_info;
...
typedef struct
{
    ...
    uint8 is_otn_sar;
    /*
     * Flexe Mac statistics port
     */
    uint8 is_stat_only;
    /*
     * Framer Management interface
     */
    uint8 is_framer_mgmt;
    /*
     * FlexE unaware
     */
    uint8 is_flexe_unaware;
    /*
     * FlexE protection client
     */
    uint8 is_flexe_protection;
    /*
     * TDM port
     */
    uint8 is_tdm;
     ...
     * TDM only interface
     */
    uint8 is_tdm_only_if;
    /*
     * Tx feedback clock port
     */
    uint8 is_feedback;
 ...
 *   \param [in] is_out_channel - 1 - out channel, 0 - in channel
...
/**
 * \brief - 
 * Get core and out tm port of specific logical port.
 * \par DIRECT_INPUT:
 *   \param [in] unit - unit #.
 *   \param [in] logical_port - logical port #.
 * \par INDIRECT INPUT:
 ...
 * \par INDIRECT OUTPUT
 *   \param [out] core - core id.
 *   \param [out] out_tm_port - out tm port id.
 * \remark
 *   * None
 * \see
 *   * None
 */
shr_error_e dnx_algo_port_out_tm_port_get(
    int unit,
    bcm_port_t logical_port,
    bcm_core_t * core,
    uint32 *out_tm_port);
...
/**
 * \brief - 
 * Return number of ports pointing to specified out TM port.
 *   \param [in] unit - unit #.
 *   \param [in] core - core id.
 *   \param [in] out_tm_port - out tm port id.
 *   \param [out] ref_count - number of ports pointing to this out TM port
 * \remark
 *   * None
 * \see
 *   * None
 */
shr_error_e dnx_algo_port_out_tm_port_ref_count_get(
    int unit,
    bcm_core_t core,
    int out_tm_port,
    int *ref_count);
 ...
 *   \param [in] unit - unit #.
 *   \param [in] core - core id.
 *   \param [in] base_hr - base HR id.
 *   \param [out] ref_count - number of ports pointing to this base HR
 * \remark
 *   * None
 * \see
 *   * None
 */
shr_error_e dnx_algo_port_base_hr_ref_count_get(
    int unit,
    bcm_core_t core,
    int base_hr,
    int *ref_count);
...
/**
 * \brief - 
 * Get core and pp dsp of specific logical port.
 * \par DIRECT_INPUT:
 *   \param [in] unit - unit #.
 *   \param [in] logical_port - logical port #.
 * \par INDIRECT INPUT:
 ...
 * \par INDIRECT OUTPUT
 *   \param [out] core - core id.
 *   \param [out] pp_dsp - PP DSP id.
 * \remark
 *   * None
 * \see
 *   * None
 */
shr_error_e dnx_algo_port_pp_dsp_get(
    int unit,
    bcm_port_t logical_port,
    bcm_core_t * core,
    uint32 *pp_dsp);
...
/**
 * \brief - 
 * Get core and in tm port of specific logical port.
 * \par DIRECT_INPUT:
 *   \param [in] unit - unit #.
 *   \param [in] logical_port - logical port #.
 * \par INDIRECT INPUT:
 ...
 * \par INDIRECT OUTPUT
 *   \param [out] core - core id.
 *   \param [out] in_tm_port - in tm port id.
 * \remark
 *   * None
 * \see
 *   * None
 */
shr_error_e dnx_algo_port_in_tm_port_get(
    int unit,
    bcm_port_t logical_port,
    bcm_core_t * core,
    uint32 *in_tm_port);
...
/**
 * \brief - 
 *   Convert fabric ports bitmap to pbmp of FMACs
 * \par DIRECT_INPUT:
 *   \param [in] unit - unit #.
 *   \param [in] port_bmp - fabric ports bitmap #.
 * \par INDIRECT OUTPUT
 *   \param [out] fmac_bmp - bitmap of relevant FMACs.
 * \remark
 *   * None
 * \see
 *   * None
 */
shr_error_e dnx_algo_port_fabric_pbmp_to_fmac_bmp_convert(
    int unit,
    bcm_pbmp_t port_bmp,
    bcm_pbmp_t * fmac_bmp);
...
/**
 * \brief - 
 * Get logical port from core X pp dsp
 * \par DIRECT_INPUT:
 *   \param [in] unit - unit #.
 *   \param [in] core - core id.
 *   \param [in] pp_dsp - pp dsp id.
 * \par INDIRECT INPUT:
 *   * internal algo port data base
 * \par DIRECT OUTPUT:
 *   see shr_error_e
 ...
 *   * None
 */
shr_error_e dnx_algo_port_pp_dsp_to_logical_get(
    int unit,
    bcm_core_t core,
    uint32 pp_dsp,
    bcm_port_t * logical_port);
...
/**
 * \brief - 
 * Get logical port from core X out TM port
 *   \param [in] unit - unit #.
 *   \param [in] core - core id.
 *   \param [in] out_tm_port - out TM port
 *   \param [out] logical_port - logical port #.
 * \remark
 *   * None
 * \see
 *   * None
 */
shr_error_e dnx_algo_port_out_tm_to_logical_get(
    int unit,
    bcm_core_t core,
    uint32 out_tm_port,
    bcm_port_t * logical_port);
...
/**
 * \brief - 
 * Get logical port from core X in tm port
 * \par DIRECT_INPUT:
 *   \param [in] unit - unit #.
 *   \param [in] core - core id.
 *   \param [in] in_tm_port - in tm port id.
 * \par INDIRECT INPUT:
 *   * internal algo port data base
 * \par DIRECT OUTPUT:
 *   see shr_error_e
 ...
 *   * None
 */
shr_error_e dnx_algo_port_in_tm_to_logical_get(
    int unit,
    bcm_core_t core,
    uint32 in_tm_port,
    bcm_port_t * logical_port);
 ...
 *   \param [in] unit - unit #.
 *   \param [in] logical_port - logical port #.
 *   \param [in] flags - port type flags #.
 * \par INDIRECT INPUT:
 *   * internal algo port data base
 * \par DIRECT OUTPUT:
 *   see shr_error_e
...
/**
 * \brief - Get in channel ID for
 *         TM port
 *         FlexE client
 *  
 * \param [in] unit - unit #.
 * \param [in] logical_port - logical port #.
 * \param [out] in_channel_id - IN channel ID 
 * 
 * \return
 *   See shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_algo_port_in_channel_get(
    int unit,
    bcm_port_t logical_port,
    int *in_channel_id);

/**
 * \brief - Get out channel ID for
 *         TM port
 *         FlexE client
 *  
 * \param [in] unit - unit #.
 * \param [in] logical_port - logical port #.
 * \param [out] out_channel_id - OUT channel ID 
 * 
 * \return
 *   See shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_algo_port_out_channel_get(
    int unit,
    bcm_port_t logical_port,
    int *out_channel_id);
 ...
 *   * None
 */
shr_error_e dnx_algo_port_flexe_channel_get(
    int unit,
    bcm_port_t logical_port,
    int *channel_id);
/**
 * \brief - Get Framer mgmt channel ID
 *  
 * \param [in] unit - unit #.
 * \param [in] logical_port - logical port #.
 * \param [out] mgmt_channel - MGMT channel ID 
 * 
 * \return
 *   See shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_algo_port_framer_mgmt_channel_get(
    int unit,
    bcm_port_t logical_port,
    int *mgmt_channel);
...
/**
 * \brief -
 *      Set is_mc indication
 * \param [in] unit - unit #.
 * \param [in] logical_port - logical port #.
 * \param [out] is_mc - indication if is_mc
 *
 * \return
 *   See shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_algo_port_is_mc_get(
    int unit,
    bcm_port_t logical_port,
    int *is_mc);
 ...
 *   \param [in] phy - phy id.
 *   \param [out] pm_id - pm id.
 *   \param [out] phy_offset_in_pm - phy offset in the pm.
 * \remark
 *   * None
 * \see
 *   * None
 */
shr_error_e dnx_algo_port_ilkn_phy_pms_get(
    int unit,
    bcm_port_t logical_port,
    int is_over_fabric,
    int phy,
...
/**
 * \brief - 
 * Egress channelized interface id (egress queuing).
 * Configuration is per TM interface.
 *
 * \param [in] unit - unit #.
 * \param [in] logical_port - logical port #.
 * \param [out] ch_if_id - channelized interface id number.
 *
 * \return
 *   see shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_algo_port_ch_egr_if_get(
    int unit,
    bcm_port_t logical_port,
    int *ch_if_id);
...
/**
 * \brief -
 * Get port flexe client BAS OAM period
 * Configuration is per flexe client index
 *
 * \param [in] unit - unit #.
 * \param [in] logical_port - logical port #.
 ...
 *   * None
 */
shr_error_e dnx_algo_port_flexe_client_bas_period_get(
    int unit,
    bcm_port_t logical_port,
    bcm_port_flexe_oam_base_period_t * period);
/**
 * \brief -
 * Set port flexe client BAS OAM period
 * Configuration is per flexe client index
 *
 * \param [in] unit - unit #.
 * \param [in] logical_port - logical port #.
 ...
 *   * None
 */
shr_error_e dnx_algo_port_flexe_client_bas_period_set(
    int unit,
    bcm_port_t logical_port,
    bcm_port_flexe_oam_base_period_t period);
/**
...
shr_error_e dnx_algo_port_flexe_core_port_set(
    ...
    int core_port);
/**
 * \brief - Get virtual flexe channel ID for sar switching
 *
 * \param [in] unit - unit #.
 * \param [in] logical_port - logical port #.
 ...
 *   * None
 */
shr_error_e dnx_algo_port_flexe_sar_virtual_flexe_channel_get(
    int unit,
    bcm_port_t logical_port,
    int *channel);
/**
 * \brief - Indicate if SAR connects to ETH
 *
 * \param [in] unit - unit #.
 * \param [in] logical_port - logical port #.
 * \param [in] is_rx - is rx or tx.
 * \param [out] is_eth - is ETH or flexe client.
 *
 * \return
 *   see shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_algo_port_flexe_sar_is_eth_get(
    int unit,
    bcm_port_t logical_port,
    int is_rx,
    int *is_eth);
 ...
 * \param [in] logical_port - logical port #.
 * \param [in] is_rx - is rx or tx.
 * \param [in] is_eth - is ETH or flexe client.
 *
 * \return
 *   see shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_algo_port_flexe_sar_is_eth_set(
    int unit,
    bcm_port_t logical_port,
    int is_rx,
    int is_eth);
/**
 * \brief - Get L1 ETH 1588 enable status
 *
 * \param [in] unit - unit #.
 * \param [in] logical_port - logical port #.
 ...
 *   * None
 */
shr_error_e dnx_algo_port_l1_eth_1588_enable_get(
    int unit,
    bcm_port_t logical_port,
    uint32 flags,
    int *enable);
 ...
 *   * None
 */
shr_error_e dnx_algo_port_l1_eth_1588_enable_set(
    int unit,
    bcm_port_t logical_port,
    uint32 flags,
    int enable);
/**
 * \brief - Get L1 ETH 1588 MAC channel
 *
 * \param [in] unit - unit #.
 * \param [in] logical_port - logical port #.
 * \param [out] mac1_channel - the channel of MAC1.
 * \param [out] mac2_channel - the channel of MAC2.
 *
 * \return
 *   see shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_algo_port_l1_eth_1588_mac_channel_get(
    int unit,
    bcm_port_t logical_port,
    int *mac1_channel,
    int *mac2_channel);
/**
 * \brief - Set L1 ETH 1588 MAC channel
 *
 * \param [in] unit - unit #.
 * \param [in] logical_port - logical port #.
 * \param [in] mac1_channel - the channel of MAC1.
 * \param [in] mac2_channel - the channel of MAC2.
 *
 * \return
 *   see shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_algo_port_l1_eth_1588_mac_channel_set(
    int unit,
    bcm_port_t logical_port,
    int mac1_channel,
    int mac2_channel);
/**
 * \brief - Get loopback status for
 *         Framer MAC client
 *  
 * \param [in] unit - unit #.
 * \param [in] logical_port - logical port #.
 * \param [out] lpbk_enable - loopback status 
 * 
 * \return
 *   See shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_algo_port_framer_mac_loopback_enable_get(
    int unit,
    bcm_port_t logical_port,
    int *lpbk_enable);
/**
 * \brief - Set loopback status for
 *         Framer MAC client
 *  
 * \param [in] unit - unit #.
 * \param [in] logical_port - logical port #.
 * \param [in] lpbk_enable - loopback status 
 * 
 * \return
 *   See shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_algo_port_framer_mac_loopback_enable_set(
    int unit,
    bcm_port_t logical_port,
    int lpbk_enable);
...
/**
 * \brief - Get PTC and core for a given logical port
 *
 * \param [in] unit - unit #.
 * \param [in] logical_port - logical port #.
 * \param [out] core - core_id
 * \param [out] ptc - ptc id
 *
 * \return
 *   see shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_algo_port_ptc_get(
    int unit,
    bcm_port_t logical_port,
    bcm_core_t * core,
    int *ptc);
...
/**
 * \brief - Get fec type from sw state for a given logical port
 *
 * \param [in] unit - unit #.
 * \param [in] logical_port - logical port #.
 * \param [out] fec_type - fec type
 *
 * \return
 *   see shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_algo_port_fec_type_get(
    int unit,
    bcm_port_t logical_port,
    bcm_port_phy_fec_t * fec_type);

/**
 * \brief - Set fec type to sw state for a given logical port
 *
 * \param [in] unit - unit #.
 * \param [in] logical_port - logical port #.
 ...
 *   * None
 */
shr_error_e dnx_algo_port_fec_type_set(
    int unit,
    bcm_port_t logical_port,
    bcm_port_phy_fec_t fec_type);
/**
 * \brief - Get Port FLR firmware support status
 *
 * \param [in] unit - unit #.
 * \param [in] logical_port - logical port #.
 * \param [out] is_supported - support or no_support
 *
 * \return
 *   see shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_algo_port_nif_flr_fw_support_get(
    int unit,
    bcm_port_t logical_port,
    int *is_supported);
/**
 * \brief - Get Port external TXPI enable status
 *
 * \param [in] unit - unit #.
 * \param [in] logical_port - logical port #.
 * \param [out] enable - enable or disable
 ...
 *   * None
 */
shr_error_e dnx_algo_port_nif_ext_txpi_enable_get(
    int unit,
    bcm_port_t logical_port,
    int *enable);
/**
 * \brief - Get port frame preemptable status
 *
 * \param [in] unit - unit #.
 * \param [in] logical_port - logical port #.
 * \param [out] frame_preemptable - is port frame preemptable
 *
 * \return
 *   see shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_algo_port_nif_frame_preemptable_get(
    int unit,
    bcm_port_t logical_port,
    int *frame_preemptable);
/**
 * \brief -
 * get the mapped rcy_mirror logical port (used for outbound sniffing) of a given forward port
 * Configuration is per TM interface.
 *
 * \param [in] unit - unit #.
 * \param [in] logical_port - logical port #.
 * \param [out] rcy_mirror_port - recycle mirror port
 *
 * \return
 *   see shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_algo_port_forward_to_rcy_mirror_port_get(
    int unit,
    bcm_port_t logical_port,
...
/**
 * \brief -
 * set the mapped rcy_mirror logical port (used for outbound sniffing) for a given forward port
 * Configuration is per TM interface.
 *
 * \param [in] unit - unit #.
 * \param [in] logical_port - logical port #.
 * \param [in] rcy_mirror_port - recycle mirror port
 *
 * \return
 *   see shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_algo_port_forward_to_rcy_mirror_port_set(
    int unit,
    bcm_port_t logical_port,
    bcm_port_t rcy_mirror_port);
...
/**
 * \brief -
 * get the mapped forward logical port (used for outbound sniffing) of a given mirror recycle port
 *
 * \param [in] unit - unit #.
 * \param [in] logical_port - recycle mirror logical port #.
 * \param [out] forward_port - forward logical port
 *
 * \return
 *   see shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_algo_port_forward_port_get(
    int unit,
    bcm_port_t logical_port,
    bcm_port_t * forward_port);

shr_error_e dnx_algo_port_sar_channel_logical_get(
    int unit,
    int channel_id,
    bcm_port_t * logical_port);

shr_error_e dnx_algo_port_fabric_logical_port_get(
    int unit,
 ...
 *   * None
 */
shr_error_e dnx_algo_port_otn_phy_resource_validate(
    int unit,
    bcm_port_resource_t * resource);
/**
 * \brief - Get stat channel for FlexE client.
 *
 * \param [in] unit - Unit #.
 * \param [in] logical_port - logical port.
 * \param [out] stat_channel - stat channel ID.
 * 
 * \return
 *   see shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_algo_port_flexe_client_stat_channel_get(
    int unit,
    bcm_port_t logical_port,
    int *stat_channel);
/**
 * \brief - Set stat channel for FlexE client.
 *
 * \param [in] unit - Unit #.
 * \param [in] logical_port - logical port.
 * \param [in] stat_channel - stat channel ID.
 * 
 * \return
 *   see shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_algo_port_flexe_client_stat_channel_set(
    int unit,
    bcm_port_t logical_port,
    int stat_channel);
/**
 * \brief - Get FLR link mask from DB
 *
 * \param [in] unit - Unit #.
 * \param [in] logical_port - logical port.
 * \param [out] link_config - FLR link config.
 *
 * \return
 *   see shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_algo_port_nif_flr_link_config_get(
    int unit,
    bcm_port_t logical_port,
    bcm_port_flr_link_config_t * link_config);
/**
 * \brief - Configure FLR link mask in DB
 *
 * \param [in] unit - Unit #.
 * \param [in] logical_port - logical port.
 * \param [in] link_config - FLR link config.
 *
 * \return
 *   see shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_algo_port_nif_flr_link_config_set(
    int unit,
    bcm_port_t logical_port,
    bcm_port_flr_link_config_t link_config);
