...
typedef struct
{
     ...
     */
    uint32 qual_value[DNX_DATA_MAX_FIELD_PRESELECTOR_NOF_UINT32_IN_CS_QUAL_HW];
    /*
     * Hold the mask provided for each set qualifier
     */
    uint32 qual_mask[DNX_DATA_MAX_FIELD_PRESELECTOR_NOF_UINT32_IN_CS_QUAL_HW];
...
/**
 * \brief
 *  Returns one presel that cascades from a field group.
 *
 * \param[in] unit                         - Device ID
 * \param[in] cascaded_fg_id               - The cascading field group.
 * \param[out] found_cascading_p           - If true there is a cascading presel.
 * \param[out] cascading_presel_entry_id_p - If found_cascading_p is true, returns one of the cascading presels.
 *
 * \return
 ...
 *   * None
 */
shr_error_e dnx_field_presel_find_cascading_presel(
    int unit,
