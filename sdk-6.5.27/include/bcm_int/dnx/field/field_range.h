...
/**
 * \brief
 *  Clear the dnx_field_range_type_qual_info_t, set it to preferred init values
 * \param [in] unit          - Device ID
 * \param [in] range_type_qual_info_p    - Pointer to input structure of
 *                                         dnx_field_range_type_qual_info_t that needs to be init
 * \return
 *   shr_error_e - Error Type
 * \remark
 *   * None
 ...
 *   * None
 */
shr_error_e dnx_field_range_type_qual_info_t_init(
    int unit,
    dnx_field_range_type_qual_info_t * range_type_qual_info_p);
