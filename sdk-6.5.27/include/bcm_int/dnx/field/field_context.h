...
typedef enum
{
    DNX_FIELD_CONTEXT_STATE_TABLE_FLAGS_FIRST = 0x0,
    DNX_FIELD_CONTEXT_STATE_TABLE_FLAGS_NONE = DNX_FIELD_CONTEXT_STATE_TABLE_FLAGS_FIRST,
} dnx_field_context_state_table_flags_e;
...
typedef struct
{
    ...
    /** Specifies state table feature mode */
    dnx_field_context_state_table_mode_e state_table_engine_mode;
    /**
     * Name of the context.
     */
...
} dnx_field_context_payload_action_info_t;
...
typedef struct
{
    ...
    dnx_field_context_key_qual_info_t address;
    /** The data information */
    dnx_field_context_key_qual_info_t data;
    /** The opcode information */
    dnx_field_context_key_qual_info_t opcode_based_qual;
    /** The current_state information */
    dnx_field_context_payload_action_info_t current_state;
    /** The next_state information */
    dnx_field_context_payload_action_info_t next_state;
    /** Static opcode for 8/16/32 lookup */
    dnx_field_context_state_table_opcode_e opcode;
...
/**
* \brief
*  Gets the profile ID of a ceratin acl context (in iFWD2).
*
* \param [in] unit                - Device ID
...
*   * None
*/
shr_error_e dnx_field_context_apptype_acl_cs_profile_get(
    int unit,
...
/**
* \brief
*  Sets a profile ID to a ceratin ACL context (in iFWD2).
*
* \param [in] unit                - Device ID
* \param [in] acl_context         - acl_context in iFWD2 to be profiled.
...
*   * None
*/
shr_error_e dnx_field_context_apptype_acl_cs_profile_set(
    int unit,
    dnx_field_context_t acl_context,
...
/**
 * \brief
*  Get the cascaded static opcode of a dynamic opcode.
* \param [in] unit       - Device ID
* \param [in] dynamic_opcode     - The cascading dynamic opcode.
* \param [out] base_static_opcode_p  - The cascaded static opcode.
* \return
*   shr_error_e - Error Type
* \remark
*   * None
...
*   * None
*/
shr_error_e dnx_field_context_apptype_opcode_cascaded_get(
    int unit,
...
/**
* \brief
*  Get the external stage opcode info for a dynamic opcode.
* \param [in] unit       - Device ID
* \param [in] opcode_id  - The opcode Id.
* \param [out] base_opcode_id_p  - The cascaded opcode.
* \param [out] name  - The name of the opcode.
* \return
*   shr_error_e - Error Type
* \remark
*   * None
...
*   * None
*/
shr_error_e dnx_field_context_apptype_dynamic_opcode_info_get(
    int unit,
    uint32 opcode_id,
...
* \param [in] unit       - Device ID
* \param [in] predef_opcode  - The parent predefiend opcode.
* \param [out] nof_child_opcodes_p  - The number of user defiend opcodes that cascade from the predefine opcode.
* \param [out] user_def_opcodes  - The user defiend opcodes that cascade from the predefine opcode.
* \return
*   shr_error_e - Error Type
* \remark
*   * None
...
*   * None
*/
shr_error_e dnx_field_context_apptype_opcode_to_child_opcodes(
    int unit,
...
*   * None
*/
shr_error_e dnx_field_context_state_table_sw_info_t_init(
    int unit,
...
*   * None
*/
shr_error_e dnx_field_context_state_table_sw_info_set(
    int unit,
    dnx_field_context_t context_id,
    dnx_field_context_state_table_sw_info_t * state_table_info_p);
...
*   * None
*/
shr_error_e dnx_field_context_state_table_sw_info_get(
    int unit,
    dnx_field_context_t context_id,
    dnx_field_context_state_table_sw_info_t * state_table_info_p);
...
*  Init the struct of  Context Hash info
* \param [in] unit  - Device id
* \param [in] state_table_info_p - context State table info struct (see field_context.h)
* \return
*   shr_error_e - Error Type
* \remark
*   * None
 ...
 *   * None
 */
shr_error_e dnx_field_context_ifwd2_external_tcam_acl_init(
    int unit);
