...
typedef enum
{
    ...
    /**
     * Init Error Recovery General.
     */
    DNX_INIT_STEP_ERROR_RECOVERY_GENERAL,
    /**
     * Init Error Recovery Regression.
     */
    DNX_INIT_STEP_ERROR_RECOVERY_REGRESSION,
    /**
     * Init SW State.
     */
