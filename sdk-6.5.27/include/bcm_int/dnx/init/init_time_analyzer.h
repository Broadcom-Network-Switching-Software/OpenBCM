...
#define DNX_INIT_TIME_ANALYZER_ALGO_CAL_EN      0
#define DNX_INIT_TIME_ANALYZER_CRPS_EN          0
...
#endif
/** ALGO CAL*/
#if DNX_INIT_TIME_ANALYZER_ALGO_CAL_EN
#define DNX_INIT_TIME_ANALYZER_ALGO_CAL_START(unit, module_id)       utilex_time_analyzer_module_start(unit, module_id)
#define DNX_INIT_TIME_ANALYZER_ALGO_CAL_STOP(unit, module_id)        utilex_time_analyzer_module_stop(unit, module_id)
#else
#define DNX_INIT_TIME_ANALYZER_ALGO_CAL_START(unit, module_id)
#define DNX_INIT_TIME_ANALYZER_ALGO_CAL_STOP(unit, module_id)
#endif
/** CRPS */
#if DNX_INIT_TIME_ANALYZER_CRPS_EN
#define DNX_INIT_TIME_ANALYZER_CRPS_START(unit, module_id)       utilex_time_analyzer_module_start(unit, module_id)
#define DNX_INIT_TIME_ANALYZER_CRPS_STOP(unit, module_id)        utilex_time_analyzer_module_stop(unit, module_id)
#else
#define DNX_INIT_TIME_ANALYZER_CRPS_START(unit, module_id)
#define DNX_INIT_TIME_ANALYZER_CRPS_STOP(unit, module_id)
#endif
...
typedef enum
{
    ...
    DNX_INIT_TIME_ANALYZER_ALGO_CAL_RANDOM,
    DNX_INIT_TIME_ANALYZER_ALGO_CAL_RECURSIVE,
    DNX_INIT_TIME_ANALYZER_ALGO_CAL_RECURSIVE_VALIDATE,
    ...
    DNX_INIT_TIME_ANALYSER_DBAL_L_POST_PROCESS,
    ...
    DNX_INIT_TIME_ANALYSER_CRPS_EVICTION,
...
#define DNX_INIT_TIME_ANALYZER_OPS_INIT {\
        ...
        {DNX_INIT_TIME_ANALYZER_ALGO_CAL_RANDOM, "RND CAL", DNX_INIT_TIME_ANALYZER_ALGO_CAL_EN},\
        {DNX_INIT_TIME_ANALYZER_ALGO_CAL_RECURSIVE, "RECURSIVE CAL", DNX_INIT_TIME_ANALYZER_ALGO_CAL_EN},\
        {DNX_INIT_TIME_ANALYZER_ALGO_CAL_RECURSIVE_VALIDATE, "RECURSIVE CAL VALIDATE", DNX_INIT_TIME_ANALYZER_ALGO_CAL_EN},\
        ...
        {DNX_INIT_TIME_ANALYSER_DBAL_L_POST_PROCESS, "DBAL INIT POST PROCESS", DNX_INIT_TIME_ANALYZER_DBAL_INIT_EN},\
        ...
        {DNX_INIT_TIME_ANALYSER_CRPS_EVICTION, "CRPS EVICTION INIT", DNX_INIT_TIME_ANALYZER_CRPS_EN},\
        }
/*
 * }
 */
