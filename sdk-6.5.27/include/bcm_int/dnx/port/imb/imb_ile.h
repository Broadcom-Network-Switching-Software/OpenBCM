...
/*Action on PM lock status change*/
int imb_ile_port_pm_lock_status_change_event(
    int unit,
    bcm_port_t port);

/*Set RX buffers of the port in/out of reset*/
int imb_ile_port_rx_buffers_restart(
    int unit,
    bcm_port_t port);
...
/*Configure global reset of FEC for given core. */
int imb_ile_fec_global_enable_set(
    int unit,
    int ilkn_core,
    int fec_enable);
