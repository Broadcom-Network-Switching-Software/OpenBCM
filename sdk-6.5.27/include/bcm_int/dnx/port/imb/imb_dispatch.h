...
typedef int (
    *__dispatch__imb_port_pad_size_get_f) (
    ...
    int *value);
typedef int (
    *__dispatch__imb_port_link_recovery_enable_set_f) (
    int unit,
    bcm_port_t port,
    int enable);
typedef int (
    *__dispatch__imb_port_link_recovery_enable_get_f) (
    int unit,
    bcm_port_t port,
    int *enable);
typedef int (
...
typedef int (
    *__dispatch__imb_port_loopback_get_f) (
    ...
    int *loopback);
typedef int (
    *__dispatch__imb_port_phy_loopback_adapter_set_f) (
    int unit,
    bcm_port_t port,
    int curr_loopback,
    int loopback);
...
typedef int (
    *__dispatch__imb_port_link_up_mac_update_f) (
    ...
    int link);
typedef int (
    *__dispatch__imb_port_link_up_mac_update_post_f) (
    int unit,
    bcm_port_t port,
    int link);
typedef int (
...
typedef int (
    *__dispatch__imb_port_remote_fault_enable_get_f) (
    ...
    int *enable);
typedef int (
    *__dispatch__imb_port_faults_status_get_f) (
    int unit,
    bcm_port_t port,
    int *local_fault,
    int *remote_fault);
...
typedef int (
    *__dispatch__imb_port_tx_start_thr_set_f) (
    ...
    int start_tx_thr);
typedef int (
    *__dispatch__imb_port_tx_start_thr_get_f) (
    int unit,
    bcm_port_t port,
    int *start_tx_thr);
typedef int (
...
typedef int (
    *__dispatch__imb_prd_port_last_packet_priority_get_f) (
    int unit,
    bcm_port_t port,
    uint32 *priority,
    uint32 *tdm,
...
typedef int (
    *__dispatch__imb_port_prbs_rx_status_get_f) (
    ...
    int *status);
typedef int (
    *__dispatch__imb_port_rx_rmc_priority_config_set_f) (
    int unit,
    bcm_port_t port,
...
typedef int (
    *__dispatch__imb_port_stop_pm_from_pfc_enable_get_f) (
    ...
    uint32 *enable);
typedef int (
    *__dispatch__imb_port_pfc_force_enable_set_f) (
    int unit,
    bcm_port_t port,
    int pfc,
    uint32 enable);
...
typedef int (
    *__dispatch__imb_pfc_rec_priority_unmap_f) (
    ...
    int imb_id);
typedef int (
    *__dispatch__imb_pfc_mask_on_link_fail_enable_set_f) (
    int unit,
    const imb_create_info_t * imb_info,
    uint32 enable);
typedef int (
...
typedef int (
    *__dispatch__imb_post_init_f) (
    ...
    int imb_id);
typedef int (
    *__dispatch__imb_instru_synced_counters_config_set_f) (
    int unit,
    int imb_id,
    uint8 nof_intervals,
    uint8 is_continuous);
typedef int (
    *__dispatch__imb_instru_synced_counters_config_get_f) (
    int unit,
    int imb_id,
    uint8 *nof_intervals,
    uint8 *is_continuous);
typedef int (
    *__dispatch__imb_instru_synced_counters_last_write_get_f) (
    int unit,
    bcm_port_t port,
    uint32 *last_write,
    uint32 *nof_writes);
typedef int (
    *__dispatch__imb_instru_synced_counters_per_record_get_f) (
    int unit,
    bcm_port_t port,
    int record_index,
    int nof_counters,
...
typedef int (
    *__dispatch__imb_instru_counters_reset_set_f) (
    int unit,
    int imb_id,
    uint8 reset);
typedef int (
    *__dispatch__imb_instru_counters_reset_get_f) (
    int unit,
    int imb_id,
    uint8 *reset);
typedef int (
    *__dispatch__imb_instru_traffic_counters_reset_f) (
    int unit,
    const imb_create_info_t * imb_info);
typedef int (
    *__dispatch__imb_port_instru_traffic_counters_reset_f) (
    int unit,
    bcm_port_t port);
typedef int (
    *__dispatch__imb_instru_pfc_deadlock_counters_reset_f) (
    int unit,
    const imb_create_info_t * imb_info);
typedef int (
    *__dispatch__imb_port_instru_pfc_deadlock_counters_reset_f) (
    int unit,
    bcm_port_t port);
typedef int (
...
typedef int (
    *__dispatch__imb_port_link_status_change_event_f) (
    ...
    bcm_port_t port);
typedef int (
    *__dispatch__imb_port_pm_lock_status_change_event_f) (
    int unit,
    bcm_port_t port);
typedef int (
    *__dispatch__imb_port_rx_buffers_restart_f) (
    int unit,
    bcm_port_t port);
typedef int (
...
typedef int (
    *__dispatch__imb_portmod_soft_reset_lock_f) (
    int unit,
    bcm_port_t port);
typedef int (
    *__dispatch__imb_portmod_soft_reset_unlock_f) (
    int unit,
    bcm_port_t port);
typedef int (
    *__dispatch__imb_port_link_fault_force_set_f) (
    int unit,
    bcm_port_t port,
    bcm_port_control_t type,
    int enable);
typedef int (
    *__dispatch__imb_port_link_fault_force_get_f) (
    int unit,
    bcm_port_t port,
    bcm_port_control_t type,
    int *enable);
typedef int (
    *__dispatch__imb_fec_global_enable_set_f) (
    int unit,
    int ilkn_core,
    int fec_enable);
typedef int (
    *__dispatch__imb_port_timesync_tx_info_get_f) (
    int unit,
    bcm_port_t port,
    bcm_port_timesync_tx_info_t * tx_info);
typedef int (
    *__dispatch__imb_portmod_port_add_f) (
    int unit,
    bcm_port_t port,
    const portmod_port_add_info_t * port_info);
typedef int (
    *__dispatch__imb_port_txpi_sdm_override_set_f) (
    int unit,
    bcm_port_t port,
    const portmod_txpi_override_t * override);
typedef int (
    *__dispatch__imb_port_txpi_sdm_override_get_f) (
    int unit,
    bcm_port_t port,
    portmod_txpi_override_t * override);
typedef int (
    *__dispatch__imb_port_txpi_sdm_status_get_f) (
    int unit,
    bcm_port_t port,
    int *val);
typedef int (
    *__dispatch__imb_port_lane_map_set_f) (
    int unit,
    bcm_port_t port,
    uint32 flags,
    const int *lanes,
    int nof_lanes);
typedef int (
    *__dispatch__imb_port_lane_map_get_f) (
    int unit,
    bcm_port_t port,
    uint32 flags,
    int nof_max_lanes,
...
typedef int (
    *__dispatch__imb_preemption_control_set_f) (
    int unit,
    bcm_port_t port,
    bcm_port_preempt_control_t type,
    uint32 value);
typedef int (
    *__dispatch__imb_preemption_control_get_f) (
    int unit,
    bcm_port_t port,
    bcm_port_preempt_control_t type,
    uint32 *value);
typedef int (
    *__dispatch__imb_preemption_verify_status_get_f) (
    int unit,
    bcm_port_t port,
    uint32 *value);
typedef int (
    *__dispatch__imb_preemption_tx_status_get_f) (
    int unit,
    bcm_port_t port,
    uint32 *value);
typedef int (
    *__dispatch__imb_port_flr_link_config_set_f) (
    int unit,
    bcm_port_t port,
    int lane_id,
    const bcm_port_flr_link_config_t * config);
typedef int (
    *__dispatch__imb_port_mac_tx_threshold_set_f) (
    int unit,
    bcm_port_t port,
    int speed);
typedef int (
    *__dispatch__imb_port_ghao_speed_config_set_f) (
    int unit,
    bcm_port_t port,
    int speed);
typedef int (
    *__dispatch__imb_port_l1_eth_1588_enable_set_f) (
    int unit,
    bcm_port_t port,
    uint32 flags,
    int enable);
typedef int (
    *__dispatch__imb_port_l1_eth_1588_enable_get_f) (
    int unit,
    bcm_port_t port,
    uint32 flags,
    int *enable);
typedef int (
    *__dispatch__imb_port_txpi_sdm_divider_set_f) (
    int unit,
    bcm_port_t port,
    int speed);
typedef int (
    *__dispatch__imb_pm_reset_get_f) (
    int unit,
    int ethu_id,
    int *in_reset);
...
typedef struct __imb__dispatch__s__
{
    ...
    __dispatch__imb_port_link_recovery_enable_set_f f_imb_port_link_recovery_enable_set;
    __dispatch__imb_port_link_recovery_enable_get_f f_imb_port_link_recovery_enable_get;
    ...
    __dispatch__imb_port_phy_loopback_adapter_set_f f_imb_port_phy_loopback_adapter_set;
    ...
    __dispatch__imb_port_link_up_mac_update_post_f f_imb_port_link_up_mac_update_post;
    ...
    __dispatch__imb_port_faults_status_get_f f_imb_port_faults_status_get;
    ...
    __dispatch__imb_port_tx_start_thr_get_f f_imb_port_tx_start_thr_get;
    ...
    __dispatch__imb_prd_port_last_packet_priority_get_f f_imb_prd_port_last_packet_priority_get;
    ...
    __dispatch__imb_port_rx_rmc_priority_config_set_f f_imb_port_rx_rmc_priority_config_set;
    ...
    __dispatch__imb_port_pfc_force_enable_set_f f_imb_port_pfc_force_enable_set;
    ...
    __dispatch__imb_pfc_mask_on_link_fail_enable_set_f f_imb_pfc_mask_on_link_fail_enable_set;
    ...
    __dispatch__imb_instru_synced_counters_config_set_f f_imb_instru_synced_counters_config_set;
    __dispatch__imb_instru_synced_counters_config_get_f f_imb_instru_synced_counters_config_get;
    __dispatch__imb_instru_synced_counters_last_write_get_f f_imb_instru_synced_counters_last_write_get;
    __dispatch__imb_instru_synced_counters_per_record_get_f f_imb_instru_synced_counters_per_record_get;
    __dispatch__imb_instru_counters_reset_set_f f_imb_instru_counters_reset_set;
    __dispatch__imb_instru_counters_reset_get_f f_imb_instru_counters_reset_get;
    __dispatch__imb_instru_traffic_counters_reset_f f_imb_instru_traffic_counters_reset;
    __dispatch__imb_port_instru_traffic_counters_reset_f f_imb_port_instru_traffic_counters_reset;
    __dispatch__imb_instru_pfc_deadlock_counters_reset_f f_imb_instru_pfc_deadlock_counters_reset;
    __dispatch__imb_port_instru_pfc_deadlock_counters_reset_f f_imb_port_instru_pfc_deadlock_counters_reset;
    ...
    __dispatch__imb_port_pm_lock_status_change_event_f f_imb_port_pm_lock_status_change_event;
    __dispatch__imb_port_rx_buffers_restart_f f_imb_port_rx_buffers_restart;
    ...
    __dispatch__imb_portmod_soft_reset_lock_f f_imb_portmod_soft_reset_lock;
    __dispatch__imb_portmod_soft_reset_unlock_f f_imb_portmod_soft_reset_unlock;
    __dispatch__imb_port_link_fault_force_set_f f_imb_port_link_fault_force_set;
    __dispatch__imb_port_link_fault_force_get_f f_imb_port_link_fault_force_get;
    __dispatch__imb_fec_global_enable_set_f f_imb_fec_global_enable_set;
    __dispatch__imb_port_timesync_tx_info_get_f f_imb_port_timesync_tx_info_get;
    __dispatch__imb_portmod_port_add_f f_imb_portmod_port_add;
    __dispatch__imb_port_txpi_sdm_override_set_f f_imb_port_txpi_sdm_override_set;
    __dispatch__imb_port_txpi_sdm_override_get_f f_imb_port_txpi_sdm_override_get;
    __dispatch__imb_port_txpi_sdm_status_get_f f_imb_port_txpi_sdm_status_get;
    __dispatch__imb_port_lane_map_set_f f_imb_port_lane_map_set;
    __dispatch__imb_port_lane_map_get_f f_imb_port_lane_map_get;
    __dispatch__imb_preemption_control_set_f f_imb_preemption_control_set;
    __dispatch__imb_preemption_control_get_f f_imb_preemption_control_get;
    __dispatch__imb_preemption_verify_status_get_f f_imb_preemption_verify_status_get;
    __dispatch__imb_preemption_tx_status_get_f f_imb_preemption_tx_status_get;
    __dispatch__imb_port_flr_link_config_set_f f_imb_port_flr_link_config_set;
    __dispatch__imb_port_mac_tx_threshold_set_f f_imb_port_mac_tx_threshold_set;
    __dispatch__imb_port_ghao_speed_config_set_f f_imb_port_ghao_speed_config_set;
    __dispatch__imb_port_l1_eth_1588_enable_set_f f_imb_port_l1_eth_1588_enable_set;
    __dispatch__imb_port_l1_eth_1588_enable_get_f f_imb_port_l1_eth_1588_enable_get;
    __dispatch__imb_port_txpi_sdm_divider_set_f f_imb_port_txpi_sdm_divider_set;
    __dispatch__imb_pm_reset_get_f f_imb_pm_reset_get;
