...
/**
 * \brief - Enable / disable port phy loopback in adapter mode
 *
 * \param [in] unit - chip unit id
 * \param [in] port - logical port
 * \param [in] curr_loopback - current loopback type
 ...
 *   * None
 */
int imb_ethu_port_phy_loopback_adapter_set(
    int unit,
    bcm_port_t port,
    int curr_loopback,
    int loopback);
 ...
 *   * None
 */
int imb_ethu_instru_synced_counters_config_get(
    int unit,
    int imb_id,
    uint8 *nof_intervals,
    uint8 *is_continuous);
 ...
 *   * None
 */
int imb_ethu_instru_counters_reset_set(
    int unit,
    int imb_id,
    uint8 reset);
 ...
 *   * None
 */
int imb_ethu_instru_counters_reset_get(
    int unit,
    int imb_id,
    uint8 *reset);
...
/**
 * \brief - map prd priority to RMC
 *
 * \param [in] unit - chip unit id
 * \param [in] port - logical port
 * \param [in] rmc_arr - array of RMC's to map
 * \param [in] nof_rmcs - number of RMC's in array
 *
 * \return
 *   int - see _SHR_E_*
 *
...
int imb_ethu_port_rx_rmc_priority_config_set(
    int unit,
    bcm_port_t port,
