...
int imb_fabric_port_local_fault_status_clear(
    int unit,
    bcm_port_t port);
...
int imb_fabric_port_remote_fault_status_clear(
    int unit,
    bcm_port_t port);

/*Get port local and emote faults status*/
int imb_fabric_port_faults_status_get(
    int unit,
    bcm_port_t port,
    int *local_fault,
    int *remote_fault);
