...
shr_error_e flexe_std_66b_switch_get(
    int unit,
    const flexe_core_66bswitch_channel_info_t * src_info,
...
shr_error_e flexe_std_66b_switch_reverse_get(
    int unit,
    const flexe_core_66bswitch_channel_info_t * dest_info,
...
shr_error_e flexe_std_busa_channel_map_set(
    int unit,
    uint32 flags,
...
shr_error_e flexe_std_sar_enable_set(
    int unit,
    int client_channel,
    uint32 flags,
    int enable);
shr_error_e flexe_std_sar_enable_get(
    int unit,
    int client_channel,
    uint32 flags,
    int *enable);
