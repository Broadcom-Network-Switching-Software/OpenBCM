...
#define DNX_KBP_FIELD_OMMITTED_FROM_LARGE_OPTIMIZED_RESULT(_field_id_) \
    (((_field_id_ == DBAL_FIELD_KBP_ALIGNMENT_PADDING_1) || (_field_id_ == DBAL_FIELD_RESULT_TYPE)) ? 1 : 0)
...
#define DNX_KBP_LARGE_OPTIMIZED_RESULT_SIZE_DEFAULT_CAPACITY (64 * 1024)
...
typedef struct
{
    ...
    uint32 flags;
    enum kbp_device_type device_type[DNX_KBP_MAX_NOF_INST];
...
*   \param [out] range_expansion - the returned range expansion.
*  \return
*    \retval errors if unexpected behavior. See \ref shr_error_e
*  \remark
*    None
...
*   \param [in] unit         - Relevant unit.
*   \param [in] opcode_id    - The opcode Id
*   \param [out] is_dynamic  - Whether the opcode is dynamic or static.
*   \param [out] dynamic_rel_position  - If is_dynamic is TRUE, the index within dynamic opcodes, starting from 0.
*  \return
*    \retval errors if unexpected behavior. See \ref shr_error_e
*  \remark
*    None
...
/**
* \brief
*   This function returns a static opcode, based on its position relative to the first dynamic opcode.
*   \param [in] unit         - Relevant unit.
*   \param [in] dynamic_opcode_relative_position - The opcode Id relative to the first dynamic opocde.
*   \param [out] dynamic_opcode_id  - The opocde id.
*  \return
*    \retval errors if unexpected behavior. See \ref shr_error_e
*  \remark
*    None
...
*    shr_error_e
*/
shr_error_e kbp_mngr_opcode_dynamic_index_to_opcode(
    int unit,
