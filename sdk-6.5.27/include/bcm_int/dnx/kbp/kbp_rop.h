 ...
 * {
 */
/** Should remove this include to reduce compilation time. currently it is included due to  soc_reg_above_64_val_t*/
...
#define DNX_KBP_LUT_PROG0_REG_ADDR_PORT0    \
    ((Kbp_app_data[unit]->device_type[DNX_KBP_INST_MASTER] == KBP_DEVICE_OP) ? 0xA005 : 0x2005)
#define DNX_KBP_LUT_PROG1_REG_ADDR_PORT0    \
    ((Kbp_app_data[unit]->device_type[DNX_KBP_INST_MASTER] == KBP_DEVICE_OP) ? 0xA006 : 0x2006)
...
#define DNX_KBP_LUT_PROG0_REG_ADDR_PORT1    \
    ((Kbp_app_data[unit]->device_type[DNX_KBP_INST_MASTER] == KBP_DEVICE_OP) ? 0xB005 : 0x2005)
#define DNX_KBP_LUT_PROG1_REG_ADDR_PORT1    \
    ((Kbp_app_data[unit]->device_type[DNX_KBP_INST_MASTER] == KBP_DEVICE_OP) ? 0xB006 : 0x2006)
#define DNX_KBP_LUT_PROG_REG_DEVAD_PORT1    \
    ((Kbp_app_data[unit]->device_type[DNX_KBP_INST_MASTER] == KBP_DEVICE_OP) ? 0x1 : 0x2)
...
#define DNX_KBP_ROP_OPCODE_OFFSET          (dnx_data_elk.general.feature_get(unit, dnx_data_elk_general_is_egw_support_rr) ? 0x20 : 0x0)
...
#define DNX_KBP_ROP_RECORDS_PER_CORE(unit) (dnx_data_elk.general.feature_get(unit, dnx_data_elk_general_is_egw_support_rr) ? 2 : 1)
