...
typedef enum dnx_mib_counter
{
    ...
    dnx_mib_counter_nif_rx_ber_only,
    dnx_mib_counter_nif_rx_bip_errors_only,
    ...
    dnx_mib_counter_nif_rx_stats_drop_events_sch_data,
    dnx_mib_counter_nif_rx_stats_discards,
    ...
    /** nif ethernet preempt counters */
    dnx_mib_preempt_counter_nif_eth_r64,
    dnx_mib_preempt_counter_nif_eth_r127,
    dnx_mib_preempt_counter_nif_eth_r255,
    dnx_mib_preempt_counter_nif_eth_r511,
    dnx_mib_preempt_counter_nif_eth_r1023,
    dnx_mib_preempt_counter_nif_eth_r1518,
    dnx_mib_preempt_counter_nif_eth_rmgv,
    dnx_mib_preempt_counter_nif_eth_r2047,
    dnx_mib_preempt_counter_nif_eth_r4095,
    dnx_mib_preempt_counter_nif_eth_r9216,
    dnx_mib_preempt_counter_nif_eth_r16383,
    dnx_mib_preempt_counter_nif_eth_rbca,
    dnx_mib_preempt_counter_nif_eth_rprog0,
    dnx_mib_preempt_counter_nif_eth_rprog1,
    dnx_mib_preempt_counter_nif_eth_rprog2,
    dnx_mib_preempt_counter_nif_eth_rprog3,
    dnx_mib_preempt_counter_nif_eth_rpkt,
    dnx_mib_preempt_counter_nif_eth_rpok,
    dnx_mib_preempt_counter_nif_eth_ruca,
    dnx_mib_preempt_counter_nif_eth_rmca,
    dnx_mib_preempt_counter_nif_eth_rxpf,
    dnx_mib_preempt_counter_nif_eth_rxpp,
    dnx_mib_preempt_counter_nif_eth_rxcf,
    dnx_mib_preempt_counter_nif_eth_rfcs,
    dnx_mib_preempt_counter_nif_eth_rerpkt,
    dnx_mib_preempt_counter_nif_eth_rflr,
    dnx_mib_preempt_counter_nif_eth_rjbr,
    dnx_mib_preempt_counter_nif_eth_rmtue,
    dnx_mib_preempt_counter_nif_eth_rovr,
    dnx_mib_preempt_counter_nif_eth_rvln,
    dnx_mib_preempt_counter_nif_eth_rdvln,
    dnx_mib_preempt_counter_nif_eth_rxuo,
    dnx_mib_preempt_counter_nif_eth_rxuda,
    dnx_mib_preempt_counter_nif_eth_rxwsa,
    dnx_mib_preempt_counter_nif_eth_rprm,
    dnx_mib_preempt_counter_nif_eth_rmfse,
    dnx_mib_preempt_counter_nif_eth_rmfae,
    dnx_mib_preempt_counter_nif_eth_rmfao,
    dnx_mib_preempt_counter_nif_eth_rmfc,
    dnx_mib_preempt_counter_nif_eth_rmdis,
    dnx_mib_preempt_counter_nif_eth_rnffmse,
    dnx_mib_preempt_counter_nif_eth_rffmse,
    dnx_mib_preempt_counter_nif_eth_rreply,
    dnx_mib_preempt_counter_nif_eth_rverify,
    dnx_mib_preempt_counter_nif_eth_t64,
    dnx_mib_preempt_counter_nif_eth_t127,
    dnx_mib_preempt_counter_nif_eth_t255,
    dnx_mib_preempt_counter_nif_eth_t511,
    dnx_mib_preempt_counter_nif_eth_t1023,
    dnx_mib_preempt_counter_nif_eth_t1518,
    dnx_mib_preempt_counter_nif_eth_tmgv,
    dnx_mib_preempt_counter_nif_eth_t2047,
    dnx_mib_preempt_counter_nif_eth_t4095,
    dnx_mib_preempt_counter_nif_eth_t9216,
    dnx_mib_preempt_counter_nif_eth_t16383,
    dnx_mib_preempt_counter_nif_eth_tbca,
    dnx_mib_preempt_counter_nif_eth_tmfae,
    dnx_mib_preempt_counter_nif_eth_tmfc,
    dnx_mib_preempt_counter_nif_eth_tverify,
    dnx_mib_preempt_counter_nif_eth_treply,
    dnx_mib_preempt_counter_nif_eth_tpkt,
    dnx_mib_preempt_counter_nif_eth_tpok,
    dnx_mib_preempt_counter_nif_eth_tuca,
    dnx_mib_preempt_counter_nif_eth_tufl,
    dnx_mib_preempt_counter_nif_eth_tmca,
    dnx_mib_preempt_counter_nif_eth_txcf,
    dnx_mib_preempt_counter_nif_eth_tfcs,
    dnx_mib_preempt_counter_nif_eth_terr,
    dnx_mib_preempt_counter_nif_eth_tovr,
    dnx_mib_preempt_counter_nif_eth_tjbr,
    dnx_mib_preempt_counter_nif_eth_trpkt,
    dnx_mib_preempt_counter_nif_eth_tfrg,
    dnx_mib_preempt_counter_nif_eth_tvln,
    dnx_mib_preempt_counter_nif_eth_tdvln,
    dnx_mib_preempt_counter_nif_eth_rbyt,
    dnx_mib_preempt_counter_nif_eth_rrbyt,
    dnx_mib_preempt_counter_nif_eth_tbyt,
    /*
     * Encrypted PFC counters 
     */
    dnx_mib_counter_nif_eth_epfc_tpfc0,
    dnx_mib_counter_nif_eth_epfc_tpfc1,
    dnx_mib_counter_nif_eth_epfc_tpfc2,
    dnx_mib_counter_nif_eth_epfc_tpfc3,
    dnx_mib_counter_nif_eth_epfc_tpfc4,
    dnx_mib_counter_nif_eth_epfc_tpfc5,
    dnx_mib_counter_nif_eth_epfc_tpfc6,
    dnx_mib_counter_nif_eth_epfc_tpfc7,
    /** Must be last */
    dnx_mib_counter_nof
} dnx_mib_counter_t;
...
/**
* \brief
*   Get the specified rate statistics by counter_idx
* \param [in] unit - unit id
* \param [in] port - logic port
* \param [in] type - stat type
* \param [in] counter_idx - counter index
* \param [out] rate - counter rate
* \return
*   shr_error_e - Error Type
* \remark
*   * None
...
*   * None
*/
shr_error_e dnx_stat_get_rate_by_counter_idx(
    int unit,
    bcm_port_t port,
    bcm_stat_val_t type,
    int counter_idx,
 ...
 * \brief - DNX callback to read NIF ETH MIB counters. \see soc_get_counter_f.
 */
int dnx_mib_nif_eth_preempt_counter_get(
    int unit,
    int counter_id,
    int port,
    uint64 *val,
 ...
 * \brief - DNX callback to clear NIF ETH MIB counters. \see soc_clear_counter_f.
 */
int dnx_mib_nif_eth_preempt_counter_clear(
    int unit,
    int counter_id,
    int port);
...
/**
 * \brief - DNX callback to read NIF Encrypted PFC TX counters.
 */
int dnx_mib_nif_eth_epfc_counter_get(
    int unit,
    int counter_id,
    int port,
    uint64 *val,
...
/**
 * \brief - DNX callback to clear NIF Encrypted PFC TX counters.
 */
int dnx_mib_nif_eth_epfc_counter_clear(
    int unit,
    int counter_id,
    int port);
