...
#define PTP_MGMTMSG_ID_PTP_NTP_TOD_OFFSET                          (0xd105)
...
#define PTP_MGMTMSG_PAYLOAD_CLOCK_INSTANCE_SIZE_OCTETS                 (66)
...
/* Management message PTP and NTP ToD offset size (octects) */
#define PTP_MGMTMSG_PAYLOAD_PACKET_PTP_NTP_TOD_OFFSET_SIZE_OCTETS      (40)
 ...
 *
 * NOTE:Define new clock flags in /include/bcm/ptp.h
 *      New flags should be defined before PTP_CLOCK_FLAGS_SIGNALING_MULTI_TLV_BIT
 */

/* Sync-triggered Delay Requests */
#define PTP_CLOCK_FLAGS_TRIGGERED_DELREQ                        BCM_PTP_CLOCK_FLAGS_TRIGGERED_DELREQ
/* Fixed-interval Delay Requests */
#define PTP_CLOCK_FLAGS_FIXED_DELREQ                            BCM_PTP_CLOCK_FLAGS_FIXED_DELREQ
/* One-way operation bit. */
#define PTP_CLOCK_FLAGS_ONEWAY_BIT                              BCM_PTP_CLOCK_FLAGS_ONEWAY_BIT
/* Telecom profile bit. */
#define PTP_CLOCK_FLAGS_TELECOM_PROFILE_BIT                     BCM_PTP_CLOCK_FLAGS_TELECOM_PROFILE_BIT
/* Bit 5 currently unused */
/* */
/* Alternate master Delay_Req messages bit. */
#define PTP_CLOCK_FLAGS_DELREQ_ALTMASTER_BIT                    BCM_PTP_CLOCK_FLAGS_DELREQ_ALTMASTER_BIT
/* Set Sync OAM register,
 * and override servo-reported phase */
#define PTP_CLOCK_FLAGS_SYNCOAM_BIT                             BCM_PTP_CLOCK_FLAGS_SYNCOAM_BIT

/* Bits#8-11 : used to represent profile type */
#define PTP_CLOCK_FLAGS_PROFILE_TYPE_START_BIT                  BCM_PTP_CLOCK_FLAGS_PROFILE_TYPE_START_BIT
 ...
 */
#define PTP_CLOCK_FLAGS_TARGETED_DELREQ_DELRESP_TX_BIT          BCM_PTP_CLOCK_FLAGS_TARGETED_DELREQ_DELRESP_TX_BIT
 ...
 */
#define PTP_CLOCK_FLAGS_UNTAGGED_DELREQ_DELRESP_TX_BIT          BCM_PTP_CLOCK_FLAGS_UNTAGGED_DELREQ_DELRESP_TX_BIT

/* Not passed through to TOP: */
/* Multi-TLV signaling message support bit. */
#define PTP_CLOCK_FLAGS_SIGNALING_MULTI_TLV_BIT                 BCM_PTP_CLOCK_FLAGS_SIGNALING_MULTI_TLV_BIT
...
/* Data Structure needed for User Defined Clock Class for Telecom Profile (G.8265.1) */

#define PTP_TELECOM_MAX_CUSTOM_CLKCLASS_ENTRIES   (10)

typedef struct _bcm_ptp_telecom_g8265_custom_clock_class_s {
    int clock_class;
    int enable;
} _bcm_ptp_telecom_g8265_custom_clock_class_t;


extern int _bcm_ptp_telecom_g8265_custom_clock_class_add(
    int unit, bcm_ptp_stack_id_t ptp_id, int clock_num, int clock_class,
    int enable);

extern int _bcm_ptp_telecom_g8265_custom_clock_class_remove(
    int unit, bcm_ptp_stack_id_t ptp_id, int clock_num, int clock_class);

extern int _bcm_ptp_telecom_g8265_custom_clock_class_list_get(
    int unit, bcm_ptp_stack_id_t ptp_id, int clock_num,
