...
#define EVENT_EN_BS0TC     (0x1 << 14)
#define EVENT_EN_BS1TC     (0x1 << 15)

/* Target counter definitions for BS TC conv. */
#define BS_TC_CTRL_TGT_TS0        (1 << 0)
#define BS_TC_CTRL_TGT_TS1        (1 << 1)
#define BS_TC_CTRL_TGT_PTP_TOD    (1 << 2)
...
#define BCM_TIME_READ_NS_REGr(unit, reg, idx, offset, rvp)                              \
    if (soc_feature(unit, soc_feature_nanosync_v5)) {                                   \
...
#define BCM_TIME_WRITE_NS_REGr(unit, reg, idx, offset, rv)                              \
    if (soc_feature(unit, soc_feature_nanosync_v5)) {                                   \
...
#elif defined(BCM_TIME_NANOSYNC_SUPPORT)
