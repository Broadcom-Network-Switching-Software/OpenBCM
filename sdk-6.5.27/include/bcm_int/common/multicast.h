...
#define _BCM_MULTICAST_TYPE_ELEMENT_DYNAMIC  _SHR_MULTICAST_TYPE_ELEMENT_DYNAMIC
#define _BCM_MULTICAST_TYPE_ELEMENT_STATIC   _SHR_MULTICAST_TYPE_ELEMENT_STATIC
