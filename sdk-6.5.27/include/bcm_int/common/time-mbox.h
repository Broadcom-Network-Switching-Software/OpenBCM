...
int _bcm_time_bs_debug(int unit, uint32 flags);
...
int _bcm_time_bs_ptp_tod_disable(int unit, int ptp_tod_disable);
int _bcm_time_bs_ntp_tod_disable(int unit, int ntp_tod_disable);
int _bcm_time_bs_ptp_offset_set(int unit, bcm_time_spec_t new_offset);
