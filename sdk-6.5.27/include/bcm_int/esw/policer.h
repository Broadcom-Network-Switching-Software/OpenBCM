...
/* The count of the global meter policer action data structure. */
# define bcmiGlobalMeterPolicerActionCount \
    (bcmPolicerActionRpIntCongestionNotificationNew + 1)

typedef struct bcmi_policer_global_meter_action_bk_s {
    uint32                          used;
    uint32                          reference_count;
    bcm_policer_action_t            actions[bcmiGlobalMeterPolicerActionCount];
    uint32                          param[bcmiGlobalMeterPolicerActionCount];
