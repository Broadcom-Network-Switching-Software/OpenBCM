...
extern int _bcm_tr3_l3_ipmc_nh_entry_parse(int unit, uint32 *ing_nh, 
            uint32 *egr_nh, uint32 *egr_nh_2, uint32 nh_index, bcm_l3_egress_t *l3_egress);
...
extern int bcm_tr3_ipmc_l3_intf_next_hop_l3_egress_clear(int unit, int nh_idx);
...
extern int bcm_tr3_l2gre_egress_set(int unit, int nh_index, uint32 flags, int vp, int drop);
