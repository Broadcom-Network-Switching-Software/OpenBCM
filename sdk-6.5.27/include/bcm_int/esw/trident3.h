...
/* MAX PHB_MAP_TBL_1 entries per profile for TD3 deriavtive devices */
#define _BCM_MAX_PHB_MAP_TAB1_ENTRIES_PER_PROFILE       (132)
...
/* number of same profile table chunk within EGR_TUNNEL_ECN_ENCAP table */
#define _BCM_TD3_TUNNEL_ECN_ENCAP_PROFILE_TABLE_NUM  4

/* HGOE functions */
#define BCM_TD3_HGOE_HDR_TYPE 0x8787

/* SRV6 functions */
#define BCM_TD3_SRV6_PORT_ENABLE 0x7
#define BCM_TD3_SRV6_ADAPT_MAX_MODE 7
#define BCM_TD3_SRV6_ACTION_ENABLE 1
...
/* HG3 functions */
extern int _bcm_td3_port_hg3_mode_set(int unit, bcm_port_t port,
                                     bcm_port_encap_config_t *encap_config);
extern int _bcm_td3_port_hg3_mode_get(int unit, bcm_port_t port, uint8 *is_hg3);
extern int bcm_td3_tx_hg3_list(int unit, bcm_pkt_t *pkt,
                   bcm_pkt_cb_f all_done_cb, void *cookie);
extern int bcm_td3_tx_hg3_array(int unit, bcm_pkt_t **pkt_arr, int count,
                    bcm_pkt_cb_f all_done_cb, void *cookie);
extern int bcm_td3_tx_hg3_pkt(int unit, bcm_pkt_t *pkt, void *cookie, bcm_tx_f tx_f);
extern int bcm_td3_is_hg3_enabled_port(int unit, bcm_port_t port);
extern uint16 bcm_td3_tx_hg3_ethertype_get(int unit);
/* end HG3 declarations */
...
extern int
_bcm_td3_vlan_match_action_add(int unit,
                               uint32 options,
                               bcm_gport_t port,
...
extern int
 _bcm_td3_vlan_match_action_delete(int unit,
                                   bcm_gport_t port,
                                   bcm_vlan_match_info_t *match_info);

extern int
 _bcm_td3_vlan_match_action_entry_get(int unit,
                                      void *vment,
                                      bcm_vlan_match_info_t *match_array,
                                      bcm_vlan_action_set_t *action_set);

extern int
_bcm_td3_vlan_match_action_get(int unit,
                               bcm_gport_t port,
                               bcm_vlan_match_info_t *match_info,
                               bcm_vlan_action_set_t *action_set);

extern int
_bcm_td3_vlan_match_action_multi_get(int unit,
...
#define BCMI_TD3_L3_EGR_NH_L2_OTAG_ENTRY_TYPE  21
...
/* EGR_IP_TUNNEL data types */
#define BCMI_TD3_TNL_DATA_TYPE_SRV6_L3            22
#define BCMI_TD3_TNL_DATA_TYPE_SRV6_NON_CANONICAL 23
#define BCMI_TD3_TNL_DATA_TYPE_SRV6_L2            24
#define BCMI_TD3_TNL_DATA_TYPE_SRV6_NON_CANONICAL_WO_DIP  25
...
#define BCMI_LPM_FLEX_VIEW(ent_type) (ent_type > 1) && (ent_type != 11) && (ent_type != 12) && (ent_type != 6)

#define BCMI_LPM_SEPARATE_IPSRV6_KEY_TYPE 6
...
#define _BCM_TD3_TAG_ACTION_TYPE_NONE   0
#define _BCM_TD3_TAG_ACTION_TYPE_STAG   1
#define _BCM_TD3_TAG_ACTION_TYPE_DTAG   2
...
extern int _bcm_td3_sd_tag_action_profile_get(int unit,
        ...
        uint32 *index, int replace_type, int delete_type);

extern int _bcm_td3_sd_tag_action_get(int unit, uint32 index,
        int *sd_tag_action_present,
        int *sd_tag_action_not_present, int *replace_type, int *delete_type);
extern int _bcm_td3_def_vlan_profile_get( int unit, uint32 *index);
extern int _bcm_td3_vlan_profile_get(int unit, bcm_vlan_action_set_t *action,
                                     int egress, uint32 *index);
...
extern int bcm_td3_cosq_burst_monitor_init (int unit);

extern int bcm_td3_cosq_burst_monitor_detach(int unit);

extern int bcm_td3_cosq_burst_monitor_flow_view_config_set(int unit,
                                                   uint32 options,
                                                   bcm_cosq_burst_monitor_flow_view_info_t *view_cfg);

extern int bcm_td3_cosq_burst_monitor_flow_view_config_get(int unit,
                                                   bcm_cosq_burst_monitor_flow_view_info_t *view_cfg);

extern int bcm_td3_cosq_burst_monitor_flow_view_data_clear(int unit);

extern int bcm_td3_cosq_burst_monitor_flow_view_data_get(int unit,
                                             uint32 usr_mem_size,
                                             uint8 *usr_mem_addr);

extern int bcm_td3_cosq_burst_monitor_get_current_time(int unit, uint64 *time_usecs);

extern int bcm_td3_cosq_burst_monitor_view_summary_get(int unit, uint32 mem_size,
                                               uint8 *mem_addr, int max_num_views,
                                               int *num_views);

extern int bcm_td3_cosq_burst_monitor_flow_view_stats_get(int unit, uint32 mem_size,
...
extern int
bcm_td3_cosq_pause_queue_status_get(int unit, bcm_gport_t gport,
                                   uint8* pause_status);
