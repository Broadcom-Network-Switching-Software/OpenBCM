...
typedef struct bcmi_xgs5_range_ctrl_s {
    ...
    int                 num_ranges;      /* Number of Ranges existing in the system */
    ...
    bcm_range_id_bmp_t  range_group_range_bmp[_RANGE_GROUP_TOTAL]; /* Used HW masks of the range group */
...
#define _RANGE_ID_MAX(u)     BCM_RANGE_ID_MAX
...
extern int bcmi_range_group_hw_get(int unit,
