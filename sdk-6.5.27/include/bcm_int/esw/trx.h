...
extern int _bcm_dscp_table_entry_ref_count_get(int unit, uint32 index,
                                                int* ref_count);
extern int _bcm_dscp_table_entry_set(int unit, void **entries, uint32 index);
...
extern int _bcm_dscp_table_entry_write_mode_get(int unit, uint32 index,
                                                int *mode);
...
extern int _bcm_egr_dscp_table_entry_reference(int unit, int index, 
                                               int entries_per_set_override);
extern int _bcm_egr_dscp_table_entry_write_mode_get(int unit,
                                                    uint32 index, int *mode);
...
extern int
_bcm_ecn_pkt_to_tnl_ecn_entry_get(int unit, int index,
                                      int count, void **entries);
extern int
...
extern int
_bcm_th_vlan_match_action_multi_get(
    int unit,
