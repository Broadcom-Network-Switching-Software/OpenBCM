...
typedef struct _bcm_udf_funct_s {
    ...
    int(*udf_flow_based_chunk_arrange_get) (
                           ...
                           bcm_udf_tunnel_term_flow_type_t flow_type,
                           uint32 *chunk_bmap);
    int(*udf_tunnel_flow_based_chunk_arrange_set) (
                           int unit,
                           bcm_udf_tunnel_flow_type_t flow_type,
                           uint32 chunk_bmap);
    int(*udf_tunnel_flow_based_chunk_arrange_get) (
                           int unit,
                           bcm_udf_tunnel_flow_type_t flow_type,
                           uint32 *chunk_bmap);
    ...
    int(*udf_range_checker_chunk_info_get)(          /* UDF Range checker chunk info get */
                           ...
                           uint8 *,
                           uint32 *);
    int(*udf_tunnel_type_offset_max_get)(          /* UDF tunnel offset max get */
                            int unit,
                            bcm_udf_tunnel_type_t t_type,
                            uint32 *offset_max);
