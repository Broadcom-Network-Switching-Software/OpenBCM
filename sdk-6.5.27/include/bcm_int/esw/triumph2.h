...
extern int bcm_tr2_l3_ecmp_overlay_defragment_buffer_set(int unit, int size);
extern int bcm_tr2_l3_ecmp_overlay_defragment_buffer_get(int unit, int *size);
...
extern int bcm_tr2_l3_ecmp_defragment_buffer_recover(int unit,
        uint8 **scache_ptr, int offset, int ol_defrag_buffer);
