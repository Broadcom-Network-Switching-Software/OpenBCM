...
extern int bcmi_esw_portctrl_phy_set(int unit, bcm_gport_t port, uint32 flags,
                                     uint32 phy_reg_addr, uint32 phy_data);
extern int bcmi_esw_portctrl_phy_multicast_set(int unit, bcm_gport_t port,
                                     uint32 mdio_buses, uint32 flags,
                                    uint32 phy_reg_addr, uint32 phy_data);
...
bcmi_esw_portctrl_phy_fec_error_inject_get(int unit, bcm_port_t port,
                                           ...
                                           bcm_port_phy_fec_error_mask_t *bit_error_mask);
extern int
bcmi_esw_portctrl_flr_set(int unit, bcm_port_t port, int enable,
                          bcm_port_flr_timeout_t timeout);
extern int
bcmi_esw_portctrl_flr_get(int unit, bcm_port_t port, int *enable,
                          bcm_port_flr_timeout_t *timeout);
