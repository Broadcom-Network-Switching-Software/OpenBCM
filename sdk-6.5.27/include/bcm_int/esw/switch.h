...
extern int
_bcm_td3_vxlan_gbp_flex_controls_set(int unit, bcm_switch_control_t type, int arg);

extern int
_bcm_td3_vxlan_gbp_flex_controls_get(int unit, bcm_switch_control_t type, int *arg);
...
#define BCM_SWITCH_WB_FLEXHASH_VERSION_1_2                SOC_SCACHE_VERSION(1,2)
#define BCM_SWITCH_WB_FLEXHASH_DEFAULT_VERSION            BCM_SWITCH_WB_FLEXHASH_VERSION_1_2
...
#define BCM_SWITCH_WB_MISC_VERSION_1_4                    SOC_SCACHE_VERSION(1,4)
#define BCM_SWITCH_WB_MISC_VERSION_1_5                    SOC_SCACHE_VERSION(1,5)
#define BCM_SWITCH_WB_MISC_DEFAULT_VERSION                BCM_SWITCH_WB_MISC_VERSION_1_5
