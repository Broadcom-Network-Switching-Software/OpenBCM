...
typedef enum bcm_stat_flex_group_mode_e {
   ...
   /* Update bcmStatFlexGroupModeLast when adding new enum */
   bcmStatFlexGroupModeLast = bcmIntStatGroupModeLatencyMonitor
...
bcm_error_t _bcm_esw_stat_object_hw_mode_get(int unit,
    bcm_stat_object_t object, uint32 *hw_mode_id);
bcm_error_t _bcm_esw_stat_flex_check_ingress_em_table_entry(
    ...
    uint32            base_idx);
bcm_error_t
_bcm_esw_stat_flex_check_ingress_table_entry(
    int               unit,
    soc_mem_t         pipe_num,
    _field_stage_id_t field_stage,
    uint32            offset_mode,
    uint32            pool_number,
    uint32            base_idx);
int stat_ctr_map_init(int unit);
...
extern bcm_error_t
_bcm_esw_stat_egr_l3_intf_default_pool_set(int unit, uint32 pool_number);

extern bcm_error_t
_bcm_esw_stat_egr_l3_intf_default_pool_get(int unit, uint32 *pool_number);

extern bcm_error_t
_bcm_flex_ctr_latency_monitor_resource_clean(int unit);
