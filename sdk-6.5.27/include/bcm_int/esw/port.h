...
#define BCM_PORT_WB_VERSION_1_14               SOC_SCACHE_VERSION(1,14)
#define BCM_PORT_WB_VERSION_1_15               SOC_SCACHE_VERSION(1,15)
#define BCM_PORT_WB_VERSION_1_16               SOC_SCACHE_VERSION(1,16)
#define BCM_PORT_WB_VERSION_1_17               SOC_SCACHE_VERSION(1,17)
#define BCM_PORT_WB_DEFAULT_VERSION            BCM_PORT_WB_VERSION_1_17
...
#define PORT_LOCK(unit) \
        ...
        else if(soc_mem_is_valid(unit, ING_DEVICE_PORTm)) \
        { soc_mem_lock(unit, ING_DEVICE_PORTm); }
...
#define PORT_UNLOCK(unit) \
        ...
        { soc_mem_unlock(unit, ING_DEVICE_PORTm); }
...
extern int
_bcmi_port_tx_stall_egress_meter_hw_get(int unit, bcm_port_t port, uint32 *refresh,
                                    uint32 *thd_sel);
extern int
_bcmi_port_tx_stall_egress_meter_hw_set(int unit, bcm_port_t port, uint32 refresh,
                                    uint32 thd_sel);
extern int
_bcmi_tx_stall_set_port_rate_egress_settings(int unit, bcm_port_t port, int stall);
...
extern int _bcm_esw_gport_to_glp(int unit, bcm_gport_t gport,
                                 bcm_gport_t *glp);
extern int _bcm_esw_is_hgoe_port(int,bcm_gport_t);
extern int
...
int
_bcm_esw_port_field_ingress_class_range_get(
        int unit,
        bcm_pbmp_t in_pbm,
        uint8 instance,
        uint8 *class_arr);
...
extern int
bcm_esw_port_fast_reboot_port_drv_init(int unit);
