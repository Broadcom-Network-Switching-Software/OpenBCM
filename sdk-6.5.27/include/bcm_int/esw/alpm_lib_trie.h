...
/* Bucket trie splitable function pointer */
typedef int
(*alpm_lib_trie_splitable_f)(alpm_lib_trie_node_t *trie,
...
extern int
alpm_lib_trie_splitable(alpm_lib_trie_node_t *trie,
                      alpm_lib_trie_node_t *child,
                      alpm_lib_trie_callback_ext_f cb,
                      void *user_data,
                      int max_count,
                      int max_split_count);
extern int
alpm_lib_trie_splitable2(alpm_lib_trie_node_t *trie,
                       alpm_lib_trie_node_t *child,
                       alpm_lib_trie_callback_ext_f cb,
                       void *user_data,
                       int max_count,
