...
typedef struct _bcmi_rx_sync_ctrl_s {
    uint32 sync_flags;              /* Flags for sync rx. */
    int sn;                         /* Sync rx serial number. */
    bcm_pkt_t *head;                /* Head of packet list for sync rx. */
    bcm_pkt_t *tail;                /* Tail of packet list for sync rx. */
    bcm_pkt_t *curr;                /* Current packet in sync rx. */
    sal_sem_t sync_mode;            /* Sync rx mode. */
    sal_sem_t sync_wait;            /* Sync rx wait. */
} _bcmi_rx_sync_ctrl_t;
