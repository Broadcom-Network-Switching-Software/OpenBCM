...
extern int bcmi_l3_nh_assoc_ol_ul_link_sw_delete(int unit, int ol_nh,
               int ul_nh);
extern int bcmi_l3_nh_assoc_ol_ul_link_sw_search(int unit, int ol_nh,
               int ul_nh);
...
extern int bcmi_l3_riot_bank_set_l3_intf_hw(int unit, uint32 ol_bank_bit_value);
extern int bcmi_l3_riot_bank_set_next_hop_hw(int unit, uint32 ol_bank_bit_value);
