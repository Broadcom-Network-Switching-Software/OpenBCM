...
extern
int bcmi_xgs5_bfd_detach(int unit, uint8 before_init);
extern
 ...
 */
#define BCMI_XGS5_PORT_RESOURCE_OP_NONE          \
                SOC_PORT_RESOURCE_OP_NONE
#define BCMI_XGS5_PORT_RESOURCE_OP_REMAP         \
                SOC_PORT_RESOURCE_OP_REMAP
#define BCMI_XGS5_PORT_RESOURCE_OP_LANES         \
                SOC_PORT_RESOURCE_OP_LANES
#define BCMI_XGS5_PORT_RESOURCE_OP_SPEED         \
                SOC_PORT_RESOURCE_OP_SPEED
#define BCMI_XGS5_PORT_RESOURCE_OP_ENCAP         \
                SOC_PORT_RESOURCE_OP_ENCAP
#define BCMI_XGS5_PORT_RESOURCE_OP_ADD           \
                SOC_PORT_RESOURCE_OP_ADD
#define BCMI_XGS5_PORT_RESOURCE_OP_DEL           \
                SOC_PORT_RESOURCE_OP_DEL
#define BCMI_XGS5_PORT_RESOURCE_OP_ACTIVE        \
                SOC_PORT_RESOURCE_OP_ACTIVE
#define BCMI_XGS5_PORT_RESOURCE_OP_ENABLE        \
                SOC_PORT_RESOURCE_OP_ENABLE
#define BCMI_XGS5_PORT_RESOURCE_OP_CALENDAR      \
                SOC_PORT_RESOURCE_OP_CALENDAR
#define BCMI_XGS5_PORT_RESOURCE_OP_ENCAP_FLEX    \
                SOC_PORT_RESOURCE_OP_ENCAP_FLEX
#define BCMI_XGS5_PORT_RESOURCE_OP_CHL           \
                SOC_PORT_RESOURCE_OP_CHL
#define BCMI_XGS5_PORT_RESOURCE_OP_BUFFER_MANUAL \
...
typedef struct bcmi_xgs5_port_func_s {
    ...
    int (*cosq_buf_mode_get)(int unit, int *buf_mode);
...
extern int _bcm_xgs5_ft_eapp_send_collector_create_msg (int unit,
                                                        int collector_id,
                                                        int export_profile_id);
extern int _bcm_xgs5_ft_eapp_send_collector_update_msg (int unit,
                                                        uint8 is_detach,
                                                        int collector_id,
                                                        int export_profile_id);
...
extern int _bcm_th_ft_flow_group_drop_report_org_pkt_len_get(int unit,
