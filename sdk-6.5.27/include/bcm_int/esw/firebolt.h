...
typedef struct _bcm_l3_tbl_ext_s {
    ...
    uint8  ol_ul_link;        /* flag indicates OL to UL link was added by SDK */
} _bcm_l3_tbl_ext_t;
...
typedef struct _bcm_l3_tbl_s {
    ...
    int split_idx;
    int split_maxused;
    uint32 ol_bank_bitmap;
    uint32 bank_num;
    uint32 entry_per_bank;
    uint32 reserved_banks;
#endif
...
#define BCM_XGS3_L3_ECMP_DEFRAG_COUNT(_u_) _bcm_l3_bk_info[_u_].ecmp_defrag_count
#define BCM_XGS3_L3_OVERLAY_ECMP_DEFRAG_COUNT(_u_) _bcm_l3_bk_info[_u_].overlay_ecmp_defrag_count
#define BCM_XGS3_L3_UNDERLAY_ECMP_DEFRAG_COUNT(_u_) _bcm_l3_bk_info[_u_].underlay_ecmp_defrag_count
#ifdef BCM_TRIUMPH2_SUPPORT
...
#define BCM_XGS3_L3_L2CPU_INTF_IDX(_u_)     \
               ((BCMI_L3_INTF_OVERLAY_VALID(_u_) && BCMI_L3_INTF_MEM_ALLOC_MODE_IS_UNDERLAY_FIRST(_u_)) ? \
...
/* Set ul-to-ol link flag. */
#define BCM_XGS3_L3_ENT_OL_UL_LINK_SET(_tbl_ptr, _i_, _flag_)       \
            ((_tbl_ptr)->ext_arr[_i_]).ol_ul_link = (_flag_);

/* Get ul-to-ol link flag. */
#define BCM_XGS3_L3_ENT_OL_UL_LINK(_tbl_ptr, _i_)           \
            ((_tbl_ptr)->ext_arr[_i_]).ol_ul_link
