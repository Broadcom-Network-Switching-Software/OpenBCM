...
/* Stat update flex ctr resources. */
#define _FP_STAT_UPDATE_FLEX_COUNTER  (1 << 11)
...
typedef struct _field_stat_s {
    ...
    bcm_stat_object_t    stat_object;   /* Flexstat accounting object type. */
...
extern int
_field_group_status_prio_min_max_update(int unit, _field_group_t *fg);
...
typedef enum _bcmFieldActionNoParam_e {
    ...
    _bcmFieldActionNoParamMacSecSubPortNum = 70,
    _bcmFieldActionNoParamMacSecSvtagColor = 71,
    _bcmFieldActionNoParamCount /* 72 */
