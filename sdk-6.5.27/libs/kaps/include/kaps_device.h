...
kaps_status kaps_device_init(int unit,
    enum kaps_device_pair_type pair_type,
    uint32_t flags,
    void *xpt,
...
enum kaps_device_properties {
    ...
    KAPS_DEVICE_PROP_PRINT_HEAP_INFO,            
    KAPS_DEVICE_PROP_BLACKHOLE_MODE,              
...
typedef enum
{
    KAPS_MDB_LPM_DB_CONFIG_2_STAGE,
    KAPS_MDB_LPM_DB_CONFIG_3_STAGE,
    KAPS_MDB_LPM_NOF_DB_CONFIGS
} kaps_mdb_lpm_db_config_e;
...
kaps_status kaps_device_recover(struct kaps_device *device);
