...
enum_mapping_t phymod_eyescan_mode_t_mapping[] = {
    ...
    {"Intrusive", phymodEyescanModeIntrusive},
    {NULL, 0}
};
...
enum_mapping_t phymod_phy_tx_pattern_t_mapping[] = {
    {"Off", phymodPhyTxPatternOff},
    {"PAM4_JP03B", phymodPhyTxPatternPAM4_JP03B},
    {"PAM4_Linear", phymodPhyTxPatternPAM4_Linear},
    {"Custom", phymodPhyTxPatternCustom},
    {NULL, 0}
};
...
enum_mapping_t phymod_linkCAT_op_mode_t_mapping[] = {
    ...
    {"PRE_RX", phymodlinkCAT_PRE_RX},
    {"RX_MEASURE", phymodlinkCAT_RX_MEASURE},
    {"DNC_OSR_UNSET", phymodlinkCAT_DNC_OSR_UNSET},
    {"DNC_OSR_SET", phymodlinkCAT_DNC_OSR_SET},
    {NULL, 0}
};
