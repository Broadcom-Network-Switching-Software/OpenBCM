...
extern __phymod__dispatch__t__ phymod_osprey7_v2l8p2_driver;
#endif
...
{        
    ...
    phymod_firmware_lane_config->AnForceExtendedReach = 0;
    phymod_firmware_lane_config->AnForceNormalReach = 0;
...
{        
    ...
    phymod_timesync_adjust_config_info->tx_lkup_1588_mem_sp = NULL;
    phymod_timesync_adjust_config_info->rx_lkup_1588_mem_sp = NULL;
...
{        
    if(phymod_uc_ram_variable >= phymodUcRAMVar_Count) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("Parameter is out of range")));
    }
...
int phymod_phy_uc_ram_var_set(const phymod_phy_access_t* phy, phymod_uc_ram_variable_t ram_var, int16_t value)
{
    ...
    if(PHYMOD_E_OK != phymod_uc_ram_variable_t_validate(ram_var)) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("ram_var validation failed")));
    }
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_phy_uc_ram_var_set) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_phy_uc_ram_var_set(phy, ram_var, value);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
...
int phymod_phy_uc_ram_var_get(const phymod_phy_access_t* phy, phymod_uc_ram_variable_t ram_var, int16_t* value)
{
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_phy_uc_ram_var_get) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_phy_uc_ram_var_get(phy, ram_var, value);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
...
int phymod_phy_external_los_enable_set(const phymod_phy_access_t* phy, uint32_t enable)
{
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_phy_external_los_enable_set) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_phy_external_los_enable_set(phy, enable);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
...
int phymod_phy_external_los_enable_get(const phymod_phy_access_t* phy, uint32_t* enable)
{
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_phy_external_los_enable_get) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_phy_external_los_enable_get(phy, enable);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
...
int phymod_port_multi_mpp_mode_set(const phymod_phy_access_t* phy, uint32_t enable)
{
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_port_multi_mpp_mode_set) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_port_multi_mpp_mode_set(phy, enable);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
