...
extern __phymod_diagnostics__dispatch__t__ phymod_diagnostics_osprey7_v2l8p2_diagnostics_driver;
#endif
#ifdef PHYMOD_TSCBH_FE_GEN2_SUPPORT
extern __phymod_diagnostics__dispatch__t__ phymod_diagnostics_tscbh_fe_gen2_diagnostics_driver;
#endif
#ifdef PHYMOD_BLACKHAWK7_L2P2_SUPPORT
extern __phymod_diagnostics__dispatch__t__ phymod_diagnostics_blackhawk7_l2p2_diagnostics_driver;
#endif
#ifdef PHYMOD_TSCBH_SUB10G_SUPPORT
extern __phymod_diagnostics__dispatch__t__ phymod_diagnostics_tscbh_sub10g_diagnostics_driver;
#endif
...
#endif
#ifdef PHYMOD_OSPREY7_V2L8P2_SUPPORT
    &phymod_diagnostics_osprey7_v2l8p2_diagnostics_driver,
#endif
#ifdef PHYMOD_TSCBH_FE_GEN2_SUPPORT
    &phymod_diagnostics_tscbh_fe_gen2_diagnostics_driver,
#endif
#ifdef PHYMOD_BLACKHAWK7_L2P2_SUPPORT
    &phymod_diagnostics_blackhawk7_l2p2_diagnostics_driver,
#endif
#ifdef PHYMOD_TSCBH_SUB10G_SUPPORT
    &phymod_diagnostics_tscbh_sub10g_diagnostics_driver,
#endif
...
int phymod_phy_tx_pattern_t_validate(phymod_phy_tx_pattern_t phymod_phy_tx_pattern)
{        
    if(phymod_phy_tx_pattern >= phymodPhyTxPatternCount) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("Parameter is out of range")));
    }
...
int phymod_phy_tx_pattern_set(const phymod_phy_access_t* phy, phymod_phy_tx_pattern_t tx_pattern)
{

    phymod_dispatch_type_t __type__;
    int __rv__;        
    
    if(PHYMOD_E_OK != phymod_phy_tx_pattern_t_validate(tx_pattern)) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("tx_pattern validation failed")));
    }
    ...
    if(NULL != __phymod_diagnostics__dispatch__[__type__]->f_phymod_phy_tx_pattern_set) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod_diagnostics__dispatch__[__type__]->f_phymod_phy_tx_pattern_set(phy, tx_pattern);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
...
int phymod_phy_tx_pattern_get(const phymod_phy_access_t* phy, phymod_phy_tx_pattern_t* tx_pattern)
{
    ...
    if(tx_pattern == NULL) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("tx_pattern NULL parameter")));
    }
    /* Dispatch */
    PHYMOD_DRIVER_TYPE_GET(phy,&__type__);
    if(__type__ >= phymodDispatchTypeCount) { 
    ...
    if(NULL != __phymod_diagnostics__dispatch__[__type__]->f_phymod_phy_tx_pattern_get) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod_diagnostics__dispatch__[__type__]->f_phymod_phy_tx_pattern_get(phy, tx_pattern);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
...
int phymod_linkcat_config_t_validate(const phymod_linkcat_config_t* phymod_linkcat_config)
{        
    if(phymod_linkcat_config == NULL) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("NULL parameter")));
    }

    if(PHYMOD_E_OK != phymod_linkCAT_op_mode_t_validate(phymod_linkcat_config->mode)) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("mode validation failed")));
    }
...
int phymod_linkcat_config_t_init(phymod_linkcat_config_t* phymod_linkcat_config)
{        
    
    if(phymod_linkcat_config == NULL){
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("phymod_linkcat_config NULL parameter")));
    }
    PHYMOD_MEMSET(phymod_linkcat_config, 0, sizeof(phymod_linkcat_config_t));
...
int phymod_phy_linkcat(const phymod_phy_access_t* phy, phymod_linkcat_config_t linkcat_config)
{

    phymod_dispatch_type_t __type__;
    int __rv__;        
    
    if(PHYMOD_E_OK != phymod_linkcat_config_t_validate(&linkcat_config)) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("linkcat_config validation failed")));
    }
    ...
    if(NULL != __phymod_diagnostics__dispatch__[__type__]->f_phymod_phy_linkcat) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod_diagnostics__dispatch__[__type__]->f_phymod_phy_linkcat(phy, linkcat_config);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
...
int phymod_phy_fec_error_bits_counter_get(const phymod_phy_access_t* phy, uint32_t* count)
{
    ...
    if(NULL != __phymod_diagnostics__dispatch__[__type__]->f_phymod_phy_fec_error_bits_counter_get) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod_diagnostics__dispatch__[__type__]->f_phymod_phy_fec_error_bits_counter_get(phy, count);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
...
int phymod_fec_error_injection_config_t_validate(const phymod_fec_error_injection_config_t* phymod_fec_error_injection_config)
{        
    if(phymod_fec_error_injection_config == NULL) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("NULL parameter")));
    }
...
int phymod_fec_error_injection_config_t_init(phymod_fec_error_injection_config_t* phymod_fec_error_injection_config)
{        
    
    if(phymod_fec_error_injection_config == NULL){
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("phymod_fec_error_injection_config NULL parameter")));
    }
    PHYMOD_MEMSET(phymod_fec_error_injection_config, 0, sizeof(phymod_fec_error_injection_config_t));
    phymod_fec_error_injection_config->block_offset = 0;
    phymod_fec_error_injection_config->contiguous_blocks_count = 0;
    phymod_fec_error_injection_config->error_injection_freq = 0;
...
int phymod_fec_error_injection_enable_t_validate(const phymod_fec_error_injection_enable_t* phymod_fec_error_injection_enable)
{        
    if(phymod_fec_error_injection_enable == NULL) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("NULL parameter")));
    }

    switch(phymod_fec_error_injection_enable->codeword_1_enable) {
        case 0:
        case 1:
            break;
        default:
            PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("codeword_1_enable not allowed value")));
            break;
    }

    switch(phymod_fec_error_injection_enable->codeword_2_enable) {
        case 0:
        case 1:
            break;
        default:
            PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("codeword_2_enable not allowed value")));
            break;
    }

    switch(phymod_fec_error_injection_enable->codeword_1_parity_enable) {
        case 0:
        case 1:
            break;
        default:
            PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("codeword_1_parity_enable not allowed value")));
            break;
    }

    switch(phymod_fec_error_injection_enable->codeword_2_parity_enable) {
        case 0:
        case 1:
            break;
        default:
            PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("codeword_2_parity_enable not allowed value")));
            break;
    }
...
int phymod_fec_error_injection_enable_t_init(phymod_fec_error_injection_enable_t* phymod_fec_error_injection_enable)
{        
    
    if(phymod_fec_error_injection_enable == NULL){
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("phymod_fec_error_injection_enable NULL parameter")));
    }
    PHYMOD_MEMSET(phymod_fec_error_injection_enable, 0, sizeof(phymod_fec_error_injection_enable_t));
    phymod_fec_error_injection_enable->codeword_1_enable = 0;
    phymod_fec_error_injection_enable->codeword_2_enable = 0;
    phymod_fec_error_injection_enable->codeword_1_parity_enable = 0;
    phymod_fec_error_injection_enable->codeword_2_parity_enable = 0;
...
int phymod_phy_fec_error_inject_config_set(const phymod_phy_access_t* phy, const phymod_fec_error_injection_config_t* error_injection_config)
{

    phymod_dispatch_type_t __type__;
    int __rv__;        
    
    if(PHYMOD_E_OK != phymod_fec_error_injection_config_t_validate(error_injection_config)) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("error_injection_config validation failed")));
    }
    ...
    if(NULL != __phymod_diagnostics__dispatch__[__type__]->f_phymod_phy_fec_error_inject_config_set) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod_diagnostics__dispatch__[__type__]->f_phymod_phy_fec_error_inject_config_set(phy, error_injection_config);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
...
int phymod_phy_fec_error_inject_config_get(const phymod_phy_access_t* phy, phymod_fec_error_injection_config_t* error_injection_config)
{

    phymod_dispatch_type_t __type__;
    int __rv__;        
    
    if(error_injection_config == NULL) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("error_injection_config NULL parameter")));
    }
    if(PHYMOD_E_OK != phymod_fec_error_injection_config_t_init(error_injection_config)) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("error_injection_config initialization failed")));
    }
    ...
    if(NULL != __phymod_diagnostics__dispatch__[__type__]->f_phymod_phy_fec_error_inject_config_get) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod_diagnostics__dispatch__[__type__]->f_phymod_phy_fec_error_inject_config_get(phy, error_injection_config);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
...
int phymod_phy_fec_error_inject_enable_set(const phymod_phy_access_t* phy, const phymod_fec_error_injection_enable_t* error_injection_enable)
{

    phymod_dispatch_type_t __type__;
    int __rv__;        
    
    if(PHYMOD_E_OK != phymod_fec_error_injection_enable_t_validate(error_injection_enable)) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("error_injection_enable validation failed")));
    }
    ...
    if(NULL != __phymod_diagnostics__dispatch__[__type__]->f_phymod_phy_fec_error_inject_enable_set) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod_diagnostics__dispatch__[__type__]->f_phymod_phy_fec_error_inject_enable_set(phy, error_injection_enable);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
...
int phymod_phy_fec_error_inject_enable_get(const phymod_phy_access_t* phy, phymod_fec_error_injection_enable_t* error_injection_enable)
{

    phymod_dispatch_type_t __type__;
    int __rv__;        
    
    if(error_injection_enable == NULL) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("error_injection_enable NULL parameter")));
    }
    if(PHYMOD_E_OK != phymod_fec_error_injection_enable_t_init(error_injection_enable)) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("error_injection_enable initialization failed")));
    }
    ...
    if(NULL != __phymod_diagnostics__dispatch__[__type__]->f_phymod_phy_fec_error_inject_enable_get) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod_diagnostics__dispatch__[__type__]->f_phymod_phy_fec_error_inject_enable_get(phy, error_injection_enable);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
