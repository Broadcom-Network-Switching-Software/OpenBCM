...
#ifndef PHYMOD_SPL
#error PHYMOD_SPL must be defined for the target system like this:
#error extern int PHYMOD_SPL(int level);
#endif


#ifndef PHYMOD_SPLHI
#error PHYMOD_SPLHI must be defined for the target system like this:
#error extern int PHYMOD_SPLHI(void);
#endif
