...
int tscf16_phy_signal_detect_status_get(const phymod_phy_access_t* phy, phymod_signal_detect_status_t* sd_status);
...
/*Get rx dc offset*/
int tscf16_phy_rx_dc_offset_get(const phymod_phy_access_t* phy, uint32_t* rx_dc_offset);
