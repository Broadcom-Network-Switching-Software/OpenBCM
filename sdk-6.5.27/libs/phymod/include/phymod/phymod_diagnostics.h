...
typedef struct phymod_fec_error_mask_s {
    ...
    uint32_t error_injection_freq; /**< Error rate for codewords, 0-32. */
...
typedef struct phymod_fec_error_injection_config_s {
    uint32_t error_mask_bit_31_0; /**< Error mask bit 31-0. */
    uint32_t error_mask_bit_63_32; /**< Error mask bit 63-32. */
    uint16_t error_mask_bit_79_64; /**< Error mask bit 79-64. */
    uint32_t block_offset; /**< Which block(0-79) starts to corrupt within a codeword. */
    uint32_t contiguous_blocks_count; /**< Define how many continous blocks to corrupt. */
    uint32_t error_injection_freq; /**< Repeat the error injection every N-th codeword. */
} phymod_fec_error_injection_config_t;

/* phymod_fec_error_injection_config_t initialization and validation */
...
typedef struct phymod_fec_error_injection_enable_s {
    uint32_t codeword_1_enable; /**< Enable codeword 1 corruption. */
    uint32_t codeword_2_enable; /**< Enable codeword 2 corruption. */
    uint32_t codeword_1_parity_enable; /**< Enable codeword 1 parity corruption. */
    uint32_t codeword_2_parity_enable; /**< Enable codeword 2 parity corruption. */
} phymod_fec_error_injection_enable_t;

/* phymod_fec_error_injection_enable_t initialization and validation */
 ...
 *
 * @brief Fec error injection config 
 *
 * @param [in]  phy             - phy access information
 * @param [in]  error_injection_config   - FEC error configuraiton.
 */
 ...
 *
 * @param [in]  phy             - phy access information
 * @param [out]  error_injection_config   - FEC error configuraiton.
 */
 ...
 *
 * @brief Fec error injection enable 
 *
 * @param [in]  phy             - phy access information
 * @param [in]  error_injection_enable   - Enable fec error injection
 */
 ...
 *
 * @param [in]  phy             - phy access information
 * @param [out]  error_injection_enable   - Get fec error injection enable status.
 */
