...
typedef int (*__dispatch__phymod_port_multi_mpp_mode_set_f)(const phymod_phy_access_t* phy, uint32_t enable);
...
typedef struct __phymod__dispatch__s__ {
    ...
    __dispatch__phymod_port_multi_mpp_mode_set_f                                     f_phymod_port_multi_mpp_mode_set;
