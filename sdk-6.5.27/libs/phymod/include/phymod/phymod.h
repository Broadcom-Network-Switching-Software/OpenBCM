...
typedef struct phymod_timesync_adjust_config_info_s {
    ...
    uint32_t* tx_lkup_1588_mem_sp; /**< Special Purpose table. */
    uint32_t* rx_lkup_1588_mem_sp; /**< Special Purpose table. */
...
typedef enum phymod_tscbh_pll_multiplier_e {
    ...
    phymod_TSCBH_PLL_DIV82P50128477 = (int32_t) 0x80544052, /**< Multiply ref. clk by 82.50128477  */
    phymod_TSCBH_PLL_DIV85P67380253 = (int32_t) 0xAC7E4055, /**< Multiply ref. clk by 85.67380253  */
    phymod_TSCBH_PLL_DIV88P39285714 = (int32_t) 0x64924058, /**< Multiply ref. clk by 88.39285714 */
    phymod_TSCBH_PLL_DIV88P76582278 = (int32_t) 0xC40D0058, /**< Multiply ref. clk by 88.76582278 */
    phymod_TSCBH_PLL_DIV89P44777920 = (int32_t) 0x72A1C059, /**< Multiply ref. clk by 89.44777920 */
    phymod_TSCBH_PLL_DIV89P84376637 = (int32_t) 0xD8010059, /**< Multiply ref. clk by 89.84376637 */
...
#define PHYMOD_SPEED_CONFIG_TRANSPARENT_AM 0x10
...
#define PHYMOD_SPEED_CONFIG_TRANSPARENT_AM_SET(speed_config) ((speed_config)->flags |= PHYMOD_SPEED_CONFIG_TRANSPARENT_AM)
...
#define PHYMOD_SPEED_CONFIG_TRANSPARENT_AM_CLR(speed_config) ((speed_config)->flags &= ~PHYMOD_SPEED_CONFIG_TRANSPARENT_AM)
...
#define PHYMOD_SPEED_CONFIG_TRANSPARENT_AM_GET(speed_config) ((speed_config)->flags & PHYMOD_SPEED_CONFIG_TRANSPARENT_AM ? 1 : 0)
...
/*! 
 * phymod_port_multi_mpp_mode_set
 *
 * @brief  Enable/Disables Multi-MPP port mode 
 *
 * @param [in]  phy             - phy access information
 * @param [in]  enable          - Enable/Disable Multi-MPP port mode
 */
int phymod_port_multi_mpp_mode_set(const phymod_phy_access_t* phy, uint32_t enable);
