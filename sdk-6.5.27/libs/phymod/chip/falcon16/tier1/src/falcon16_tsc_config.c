...
err_code_t falcon16_tsc_configure_pll_refclk_div(srds_access_t *sa__,
    ...
    return falcon16_tsc_INTERNAL_configure_pll(sa__, refclk, srds_div, 0, FALCON16_TSC_PLL_OPTION_NONE);
}
...
err_code_t falcon16_tsc_configure_pll_div_vco(srds_access_t *sa__,
                                        enum falcon16_tsc_pll_div_enum srds_div,
                                        uint32_t vco_freq_khz) {
    return falcon16_tsc_INTERNAL_configure_pll(sa__, FALCON16_TSC_PLL_REFCLK_UNKNOWN, srds_div, vco_freq_khz, FALCON16_TSC_PLL_OPTION_NONE);
}
...
err_code_t falcon16_tsc_configure_pll_refclk_div_div2refclk(srds_access_t *sa__,
                                           enum falcon16_tsc_pll_refclk_enum refclk,
                                           enum falcon16_tsc_pll_div_enum srds_div) {
   return falcon16_tsc_INTERNAL_configure_pll(sa__, refclk, srds_div, 0, FALCON16_TSC_PLL_OPTION_REFCLK_DIV2_EN);
}
...
err_code_t falcon16_tsc_configure_pll_div_vco_div2refclk(srds_access_t *sa__,
                                        enum falcon16_tsc_pll_div_enum srds_div,
                                        uint32_t vco_freq_khz) {
    return falcon16_tsc_INTERNAL_configure_pll(sa__, FALCON16_TSC_PLL_REFCLK_UNKNOWN, srds_div, vco_freq_khz, FALCON16_TSC_PLL_OPTION_REFCLK_DIV2_EN);
}
/* following routines divide refclk input by 2 to prevent fracn mode */
err_code_t falcon16_tsc_configure_pll_refclk_div_div4refclk(srds_access_t *sa__,
                                           enum falcon16_tsc_pll_refclk_enum refclk,
                                           enum falcon16_tsc_pll_div_enum srds_div) {
   return falcon16_tsc_INTERNAL_configure_pll(sa__, refclk, srds_div, 0, FALCON16_TSC_PLL_OPTION_REFCLK_DIV4_EN);
}
...
err_code_t falcon16_tsc_configure_pll_div_vco_div4refclk(srds_access_t *sa__,
                                        enum falcon16_tsc_pll_div_enum srds_div,
                                        uint32_t vco_freq_khz) {
    return falcon16_tsc_INTERNAL_configure_pll(sa__, FALCON16_TSC_PLL_REFCLK_UNKNOWN, srds_div, vco_freq_khz, FALCON16_TSC_PLL_OPTION_REFCLK_DIV4_EN);
}

err_code_t falcon16_tsc_configure_pll_refclk_div_refclk_2x(srds_access_t *sa__,
                                           enum falcon16_tsc_pll_refclk_enum refclk,
                                           enum falcon16_tsc_pll_div_enum srds_div) {
    return falcon16_tsc_INTERNAL_configure_pll(sa__, refclk, srds_div, 0, FALCON16_TSC_PLL_OPTION_REFCLK_DOUBLER_EN);
}
...
err_code_t falcon16_tsc_configure_pll_div_vco_refclk_2x(srds_access_t *sa__,
                                        enum falcon16_tsc_pll_div_enum srds_div,
                                        uint32_t vco_freq_khz) {
    return falcon16_tsc_INTERNAL_configure_pll(sa__, FALCON16_TSC_PLL_REFCLK_UNKNOWN, srds_div, vco_freq_khz, FALCON16_TSC_PLL_OPTION_REFCLK_DOUBLER_EN);
}
