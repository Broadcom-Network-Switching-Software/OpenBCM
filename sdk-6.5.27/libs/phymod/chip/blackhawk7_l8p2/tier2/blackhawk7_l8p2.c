...
/* This function gives the signal detect live status. */
...
/* This function gives the signal detect and signal detect change status. */
int blackhawk7_l8p2_phy_signal_detect_status_get(const phymod_phy_access_t* phy,
                                                 phymod_signal_detect_status_t* sd_status)
{
    phymod_phy_access_t pm_phy_copy;

    PHYMOD_MEMCPY(&pm_phy_copy, phy, sizeof(pm_phy_copy));
    PHYMOD_IF_ERR_RETURN
        (blackhawk7_l8p2_signal_detect_status_get(&pm_phy_copy.access,
                                                  &sd_status->signal_detect_bmp,
                                                  &sd_status->signal_detect_change_bmp));
    return PHYMOD_E_NONE;
}
...
int blackhawk7_l8p2_phy_rx_dc_offset_get(const phymod_phy_access_t* phy,  uint32_t *rx_dc_offset)
{
    int start_lane, num_lane;
    phymod_phy_access_t phy_copy;
    ...
    PHYMOD_IF_ERR_RETURN
        (blackhawk7_l8p2_rx_dc_offset_get(&phy_copy.access, rx_dc_offset));
