...
err_code_t blackhawk7_l8p2_lane_pwrdn(srds_access_t *sa__, enum srds_core_pwrdn_mode_enum mode) {
    ...
    case PWRDN_TX_DEEP:
        ...
        EFUN(blackhawk7_l8p2_set_tx_osr_mode(sa__, BLACKHAWK7_L8P2_OSX4));
        BLACKHAWK7_L8P2_UAPI_NOT_AMS_B0_ERR /* if !BLACKHAWK7_V2LXP2 and !BLACKHAWK7_V3LXP2, print error */
        EFUN(wr_ln_tx_s_pwrdn(0x1));
        break;
    case PWRDN_RX_DEEP:
        EFUN(wr_rx_ln_dp_s_rstb(0x0));
        BLACKHAWK7_L8P2_UAPI_INIT_AMS_A0    /* if BLACKHAWK7_V1LXP2 */
        EFUN(blackhawk7_l8p2_set_rx_osr_mode(sa__, BLACKHAWK7_L8P2_OSX4));
        BLACKHAWK7_L8P2_UAPI_NOT_AMS_B0_ERR /* if !BLACKHAWK7_V2LXP2 and !BLACKHAWK7_V3LXP2, print error */
        EFUN(wr_ln_rx_s_pwrdn(0x1));
        break;
    default:
