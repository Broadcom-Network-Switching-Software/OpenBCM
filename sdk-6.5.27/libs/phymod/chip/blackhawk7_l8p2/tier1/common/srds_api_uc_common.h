...
enum srds_pmd_uc_diag_cmd_enum {
    ...
    CMD_UC_DIAG_ADC_ENOB        = 9
};


/** DIAG ADC ENOB status macros **/
enum srds_pmd_uc_diag_enob_status_enum {
    DIAG_ENOB_NO_ERROR                = 0,
    DIAG_ENOB_UNUSED                  = 1,
    DIAG_ENOB_PTOTAL_NSAMPLES_OVFL    = 2,
    DIAG_ENOB_PNOISE_CALC_ERR         = 3,
    DIAG_ENOB_PSIGNAL_SQR_OVFL        = 4,
    DIAG_ENOB_CAPMEM_CAPTURE_ERR      = 5,
    DIAG_ENOB_PNOISE_SCALE_OVFL       = 6,
    DIAG_ENOB_STATUS_MAX              = 0x0f
};
