...
__phymod__dispatch__t__ phymod_tsco_driver = {
    ...
    tsco_phy_fec_override_set,
    tsco_phy_fec_override_get,
    ...
    tsco_phy_serdes_power_set,
    tsco_phy_an_timer_set,
    tsco_phy_an_timer_get,
    tsco_phy_flr_config_set,
    tsco_phy_flr_config_get,
