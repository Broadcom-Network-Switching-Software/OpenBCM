...
int tscomod_set_an_timers(PHYMOD_ST* pc, phymod_ref_clk_t refclk, uint32_t *nrz_an_timer_value, uint32_t *pam4_an_timer_value)    /* SET_AN_TIMERS */
{
    ...
    if (nrz_an_timer_value == NULL) {
        ...
        AN_X1_IGNORE_LNK_TMRr_CLR(AN_X1_TIMERS_IGNORE_LINK_TIMERr_reg);
        AN_X1_IGNORE_LNK_TMRr_SET(AN_X1_TIMERS_IGNORE_LINK_TIMERr_reg, *nrz_an_timer_value);
        PHYMOD_IF_ERR_RETURN(WRITE_AN_X1_IGNORE_LNK_TMRr(pc, AN_X1_TIMERS_IGNORE_LINK_TIMERr_reg));

        AN_X1_LNK_FAIL_INHBT_TMR_CL72r_CLR(AN_X1_TIMERS_LINK_FAIL_INHIBIT_TIMER_CL72r_reg);
        AN_X1_LNK_FAIL_INHBT_TMR_CL72r_SET(AN_X1_TIMERS_LINK_FAIL_INHIBIT_TIMER_CL72r_reg, *(nrz_an_timer_value+1));
        PHYMOD_IF_ERR_RETURN(WRITE_AN_X1_LNK_FAIL_INHBT_TMR_CL72r(pc, AN_X1_TIMERS_LINK_FAIL_INHIBIT_TIMER_CL72r_reg));

        AN_X1_LNK_FAIL_INHBT_TMR_NOT_CL72r_CLR(AN_X1_TIMERS_LINK_FAIL_INHIBIT_TIMER_NOT_CL72r_reg);
        AN_X1_LNK_FAIL_INHBT_TMR_NOT_CL72r_SET(AN_X1_TIMERS_LINK_FAIL_INHIBIT_TIMER_NOT_CL72r_reg, *(nrz_an_timer_value+2));
        PHYMOD_IF_ERR_RETURN(WRITE_AN_X1_LNK_FAIL_INHBT_TMR_NOT_CL72r(pc, AN_X1_TIMERS_LINK_FAIL_INHIBIT_TIMER_NOT_CL72r_reg));
    ...
    RX_X2_RS_FEC_TMRr_SET(RX_X2_RS_FEC_TMRr_reg, 0x3e8);
...
int tscomod_an_link_fail_inhibit_timer_set(PHYMOD_ST* pc, tscomod_an_timer_t timer_type, uint32_t period)
{
    AN_X1_LNK_FAIL_INHBT_TMR_CL72_PAM4r_t AN_X1_TIMERS_LINK_FAIL_INHIBIT_TIMER_CL72_PAM4r_reg;
    uint16_t tick_count;

    switch (timer_type) {
        case TSCOMOD_AN_FAIL_INHIBIT_TIMER_LT_PAM4:
...
int tscomod_an_link_fail_inhibit_timer_get(PHYMOD_ST* pc, tscomod_an_timer_t timer_type, uint32_t* period)
{
    AN_X1_LNK_FAIL_INHBT_TMR_CL72_PAM4r_t AN_X1_TIMERS_LINK_FAIL_INHIBIT_TIMER_CL72_PAM4r_reg;
    uint16_t tick_count;
...
int tscomod_pcs_rx_lane_swap(PHYMOD_ST* pc, int rx_lane_swap)
{
    ...
    pa_copy.lane_mask = 0x1 << (0 + start_lane);
    ...
    PHYMOD_IF_ERR_RETURN(MODIFY_RX_X1_RX_LN_SWPr(&pa_copy, RX_X1_RX_LN_SWPr_reg));

    /* first write U0/U1 mpp1 */
    RX_X1_RX_LN_SWPr_CLR(RX_X1_RX_LN_SWPr_reg);
    pa_copy.lane_mask = 0x1 << (2 + start_lane);
...
int tscomod_pcs_rx_mux_select(PHYMOD_ST* pc, int rx_lane_swap)
{
    ...
    PHYMOD_IF_ERR_RETURN(MODIFY_PMD_X1_PMD_X1_RX_MUX_SELSr(&pa_copy, PMD_X1_PMD_X1_RX_MUX_SELS_reg));
...
int tscomod_pcs_tx_m1_lane_swap(PHYMOD_ST* pc, int tx_lane_swap)
{
    ...
    PHYMOD_IF_ERR_RETURN(MODIFY_TX_X1_TX_LN_SWP_M1r(&pa_copy, TX_X1_TX_LN_SWPr_reg));
...
int tscomod_pcs_tx_m0_lane_swap(PHYMOD_ST* pc, int tx_lane_swap)
{
    ...
    PHYMOD_IF_ERR_RETURN(MODIFY_TX_X1_TX_LN_SWPr(&pa_copy, TX_X1_TX_LN_SWPr_reg));
...
int tscomod_pcs_tx_mux_select(PHYMOD_ST* pc, int tx_lane_swap)
{
    ...
    PHYMOD_IF_ERR_RETURN(MODIFY_PMD_X1_PMD_X1_TX_MUX_SELSr(&pa_copy, PMD_X1_PMD_X1_TX_MUX_SELS_reg));
...
int tscomod_pcs_1588_ts_offset_set(PHYMOD_ST *pc, uint32_t ns_offset, uint32_t sub_ns_offset)
{
    ...
    PHYMOD_IF_ERR_RETURN(MODIFY_PMD_X1_PM_TMR_OFFSr(pc, PMD_X1_PM_TMR_OFFSr_reg));

    return PHYMOD_E_NONE;
}

int tscomod_pcs_1588_ts_offset_get(PHYMOD_ST *pc, uint32_t* ns_offset, uint32_t* sub_ns_offset)
{
    ...
    /* read from MPP0, PML Lane Mask is same as MPP0 lane mask */
    phy_copy.lane_mask = TSCOMOD_PML_LANE_MASK(start_lane);

    PMD_X1_PM_TMR_OFFSr_CLR(PMD_X1_PM_TMR_OFFSr_reg);
    PHYMOD_IF_ERR_RETURN(READ_PMD_X1_PM_TMR_OFFSr(&phy_copy, &PMD_X1_PM_TMR_OFFSr_reg));
...
int tscomod_ts_offset_rx_set(PHYMOD_ST* pc, int tbl_ln, uint32_t *table)
{
    PMD_X1_PM_TMR_OFFSr_t PMD_X1_PM_TMR_OFFSr_reg;
...
int tscomod_fec_align_status_get(PHYMOD_ST* pc, uint32_t *fec_align_live)
{
    RX_X2_RS_FEC_RXP_STSr_t fec_status_reg;

    RX_X2_RS_FEC_RXP_STSr_CLR(fec_status_reg);
    PHYMOD_IF_ERR_RETURN(READ_RX_X2_RS_FEC_RXP_STSr(pc, &fec_status_reg));

    *fec_align_live = RX_X2_RS_FEC_RXP_STSr_FEC_ALIGN_STATUS_LIVEf_GET(fec_status_reg);
    return PHYMOD_E_NONE;
}
...
int tscomod_fec_correctable_counter_get(PHYMOD_ST* pc,  phymod_phy_speed_config_t* speed_config, uint32_t* count)
{
    int start_lane, num_lane;
    ...
    if (speed_config->data_rate != 400000){
        ...
        PHYMOD_IF_ERR_RETURN(READ_RX_X2_FEC_CORR_CTR0r(&pa_copy, &lower_reg));
        PHYMOD_IF_ERR_RETURN(READ_RX_X2_FEC_CORR_CTR1r(&pa_copy, &upper_reg));
        *count = RX_X2_FEC_CORR_CTR1r_RS_FEC_FEC_CORR_CW_CNTR_UPPERf_GET(upper_reg) << 16 |
            ...
            /* For 400G, read copy 0 of the register on both MPP0 and MPP1. */
            pa_copy.lane_mask = 1 << start_lane;
            PHYMOD_IF_ERR_RETURN(READ_RX_X2_FEC_CORR_CTR0r(&pa_copy, &lower_reg));
            PHYMOD_IF_ERR_RETURN(READ_RX_X2_FEC_CORR_CTR1r(&pa_copy, &upper_reg));
            *count = RX_X2_FEC_CORR_CTR1r_RS_FEC_FEC_CORR_CW_CNTR_UPPERf_GET(upper_reg) << 16 |
            ...
            pa_copy.lane_mask = 1 << (start_lane + 2);
            PHYMOD_IF_ERR_RETURN(READ_RX_X2_FEC_CORR_CTR0r(&pa_copy, &lower_reg));
            PHYMOD_IF_ERR_RETURN(READ_RX_X2_FEC_CORR_CTR1r(&pa_copy, &upper_reg));
            *count += RX_X2_FEC_CORR_CTR1r_RS_FEC_FEC_CORR_CW_CNTR_UPPERf_GET(upper_reg) << 16 |
                    RX_X2_FEC_CORR_CTR0r_RS_FEC_FEC_CORR_CW_CNTR_LOWERf_GET(lower_reg);
...
int tscomod_fec_uncorrectable_counter_get(PHYMOD_ST* pc, phymod_phy_speed_config_t* speed_config, uint32_t* count)
{
    int start_lane, num_lane;
    ...
    if (speed_config->data_rate != 400000){
        pa_copy.lane_mask = 1 << start_lane;
        PHYMOD_IF_ERR_RETURN(READ_RX_X2_FEC_UNCORR_CTR0r(&pa_copy, &lower_reg));
        PHYMOD_IF_ERR_RETURN(READ_RX_X2_FEC_UNCORR_CTR1r(&pa_copy, &upper_reg));
...
/*
 * When a multi-mpp port is detached, we clear the port_mode 
 * on both MPPs, making it ready for new port config
 */
int tscomod_port_multi_mpp_mode_set(PHYMOD_ST *pc, uint32_t enable)
{
    MAIN0_SETUPr_t mode_reg;
    PHYMOD_ST phy_copy;
    int port_mode_sel = 0, mpp_index = 0, pml_index = 0;
    ...
    /* Only 8-lane and 4-lane ports can be multi-mpp */
    if ((pc->lane_mask == 0xff) || (pc->lane_mask == 0x0f)) {
        pml_index = 0;
    } else if (pc->lane_mask == 0xf0) {
        pml_index = 1;
    } else {
        /* For other lane_mask values, multi-mpp mode
         * need not be set/cleared;
         */
        return PHYMOD_E_NONE;
    }
    ...
    if (enable) {
        ...
        port_mode_sel = TSCOMOD_DUAL_PORT; /* HW default */
    }

    /* Both MPP copies need to be updated with port mode */
    for (mpp_index = 0; mpp_index <=1; mpp_index++) {
        phy_copy.lane_mask = (0x1 << (mpp_index * 2)) << (pml_index * 4);
        MAIN0_SETUPr_PORT_MODE_SELf_SET(mode_reg, port_mode_sel);
        PHYMOD_IF_ERR_RETURN(MODIFY_MAIN0_SETUPr(&phy_copy, mode_reg));
    }
...
int tscomod_pmd_x4_reset(PHYMOD_ST* pc)              /* PMD_X4_RESET */
{
    ...
    if ((pa_copy.lane_mask == 0xff) &&
        (!PHYMOD_ACC_F_8_LANE_PORT_GET(&pa_copy))) {
        PHYMOD_ACC_F_8_LANE_PORT_SET(&pa_copy);
    }
...
*/
int tscomod_autoneg_ability_base_100g_fec_sel_set(PHYMOD_ST* pc,
                               const phymod_autoneg_advert_abilities_t* autoneg_abilities)
{
    AN_X2_LD_BASE_ABIL0r_t AN_X2_ABILITIES_LD_BASE_ABILITIES_0r_reg;
    phymod_autoneg_advert_ability_t *an_ability;
    uint32_t i;

    AN_X2_LD_BASE_ABIL0r_CLR(AN_X2_ABILITIES_LD_BASE_ABILITIES_0r_reg);

    /* Set default values of AN_X2_LD_BASE_ABIL0r_t */
    AN_X2_LD_BASE_ABIL0r_CL73_BASE_SELECTORf_SET(AN_X2_ABILITIES_LD_BASE_ABILITIES_0r_reg, 1);
    AN_X2_LD_BASE_ABIL0r_TX_NONCEf_SET(AN_X2_ABILITIES_LD_BASE_ABILITIES_0r_reg, 0x15);
    ...
    for (i = 0; i < autoneg_abilities->num_abilities; i++) {
        ...
        case 100000:
            if ((an_ability->an_mode == phymod_AN_MODE_CL73) &&
                ...
                /* CL73 100G 1 lane */
                AN_X2_LD_BASE_ABIL0r_BASE_100G_FEC_SELf_SET(AN_X2_ABILITIES_LD_BASE_ABILITIES_0r_reg, 3);
                if (an_ability->fec == phymod_fec_RS544_2XN) {
                    /* Enables the selection of the FEC */
                    AN_X2_LD_BASE_ABIL0r_BASE_100G_FEC_SEL_ENf_SET(AN_X2_ABILITIES_LD_BASE_ABILITIES_0r_reg, 1);
                } else {
                    AN_X2_LD_BASE_ABIL0r_BASE_100G_FEC_SEL_ENf_SET(AN_X2_ABILITIES_LD_BASE_ABILITIES_0r_reg, 0);
                }
            }
            break;
        default:
    ...
    PHYMOD_IF_ERR_RETURN(WRITE_AN_X2_LD_BASE_ABIL0r(pc, AN_X2_ABILITIES_LD_BASE_ABILITIES_0r_reg));
...
int tscomod_autoneg_ability_400g_8lane_get(PHYMOD_ST* pc, uint32_t *enabled)
{
...
int tscomod_autoneg_ability_400g_4lane_get(PHYMOD_ST* pc, uint32_t *enabled)
{
    AN_X2_LD_BASE_ABIL2r_t        AN_X2_LD_BASE_ABIL2r_reg;
...
int tscomod_autoneg_ability_get(PHYMOD_ST* pc, phymod_autoneg_advert_abilities_t* autoneg_abilities)
{
    ...
    AN_X2_LD_BASE_ABIL2r_t        AN_X2_LD_BASE_ABIL2r_reg;
    AN_X2_CL73_CFGr_t             AN_X2_CL73_CFGr_reg;
    AN_X2_LD_BASE_ABIL0r_t        AN_X2_LD_BASE_ABIL0r_reg;
    ...
    PHYMOD_IF_ERR_RETURN(READ_AN_X2_LD_BASE_ABIL0r(pc, &AN_X2_LD_BASE_ABIL0r_reg));
    ...
    if (AN_X2_LD_BASE_ABIL2r_BASE_100G_CR1_KR1f_GET(AN_X2_LD_BASE_ABIL2r_reg)) {
        if (AN_X2_LD_BASE_ABIL0r_BASE_100G_FEC_SEL_ENf_GET(AN_X2_LD_BASE_ABIL0r_reg)) {
            PHYMOD_IF_ERR_RETURN(
                _tscomod_an_ability_construct(&(autoneg_abilities->autoneg_abilities[i]),
...
int tscomod_autoneg_remote_ability_get(PHYMOD_ST* pc, phymod_autoneg_advert_abilities_t *autoneg_abilities)
{
    ...
    if ((base_2 >> TSCOMOD_AN_BASE2_TECH_ABILITY_400G_KR4_CR4_OFFSET) & TSCOMOD_AN_BASE2_TECH_ABILITY_400G_KR4_CR4_MASK) {
        PHYMOD_IF_ERR_RETURN(
          _tscomod_an_ability_construct(&(autoneg_abilities->autoneg_abilities[i]),
                                400000, 4, phymod_fec_RS544_2XN, pause, phymod_channel_long, phymod_AN_MODE_CL73));
        i++;
    ...
    if ((!llf_req_200g) &&
        ((base_2 >> TSCOMOD_AN_BASE2_TECH_ABILITY_200G_KR2_CR2_OFFSET) & TSCOMOD_AN_BASE2_TECH_ABILITY_200G_KR2_CR2_MASK)) {
        PHYMOD_IF_ERR_RETURN(
          _tscomod_an_ability_construct(&(autoneg_abilities->autoneg_abilities[i]),
                                200000, 2, phymod_fec_RS544_2XN, pause, phymod_channel_long, phymod_AN_MODE_CL73));
        i++;
    ...
    if ((!llf_req_100g) &&
        ((base_2 >> TSCOMOD_AN_BASE2_TECH_ABILITY_100G_KR1_CR1_OFFSET) & TSCOMOD_AN_BASE2_TECH_ABILITY_100G_KR1_CR1_MASK)) {
        if ((base_2 >> TSCOMOD_AN_BASE3_RS_FEC_544_2XN_OFFSET) & TSCOMOD_AN_BASE3_RS_FEC_544_2XN_MASK) {
            PHYMOD_IF_ERR_RETURN(
              _tscomod_an_ability_construct(&(autoneg_abilities->autoneg_abilities[i]),
                                    100000, 1, phymod_fec_RS544_2XN, pause, phymod_channel_long, phymod_AN_MODE_CL73));
        } else {
...
int tscomod_port_start_lane_get(PHYMOD_ST *pc, int *port_starting_lane, int *port_num_lane)
{
    ...
    pc_copy.lane_mask &= 0xff;
    PHYMOD_IF_ERR_RETURN
      (phymod_util_lane_config_get(&pc_copy, &start_lane, &num_of_lane));
    ...
    if (num_of_lane > 1) {
        ...
        *port_num_lane = num_of_lane;
        ...
        MAIN0_SETUPr_t mode_reg;
        int port_mode_sel_reg_mpp0, port_mode_sel_reg_mpp1;

        /* first check if 8 lane port */
        PHYMOD_MEMCPY(&pc_copy, pc, sizeof(pc_copy));
        if (PHYMOD_ACC_F_8_LANE_PORT_GET(&pc_copy)) {
            *port_starting_lane = 0;
            *port_num_lane = 8;
        } else if (PHYMOD_ACC_F_4_LANE_PORT_GET(&pc_copy)) {
            if (start_lane < 4) {
                *port_starting_lane = 0;
                *port_num_lane = 4;
            } else {
             ...
             if (start_lane < 4) {
                /* non-8 lane port */
                /* need to check if PML0 or PML1 */
                /* need to figure out the port starting lane based on the port mode */
                /* first read PML0 MPP0 port mode */
                pc_copy.lane_mask = 0x1;
                PHYMOD_IF_ERR_RETURN(READ_MAIN0_SETUPr(&pc_copy, &mode_reg));
                port_mode_sel_reg_mpp0 = MAIN0_SETUPr_PORT_MODE_SELf_GET(mode_reg);

                /* next read PML0 MPP1 port mode */
                pc_copy.lane_mask = 0x4;
                PHYMOD_IF_ERR_RETURN(READ_MAIN0_SETUPr(&pc_copy, &mode_reg));
                port_mode_sel_reg_mpp1 = MAIN0_SETUPr_PORT_MODE_SELf_GET(mode_reg);

                /*first check if 2 lane port mode */
                if ((port_mode_sel_reg_mpp0 == TSCOMOD_SINGLE_PORT) &&
                    (start_lane < 2)) {
                    /* lane 0-1 are used in 2-lane port mode */
                    *port_starting_lane = 0;
                    *port_num_lane = 2;
                } else if ((port_mode_sel_reg_mpp1 == TSCOMOD_SINGLE_PORT) &&
                           (start_lane > 1))  {
                    /* lane 2-3 are used in 2-lane port mode */
                    *port_starting_lane = 2;
                    *port_num_lane = 2;
                } else if ((port_mode_sel_reg_mpp0 == TSCOMOD_DUAL_PORT) &&
                           (start_lane < 2))  {
                    *port_starting_lane = start_lane;
                    *port_num_lane = 1;
                } else if ((port_mode_sel_reg_mpp1 == TSCOMOD_DUAL_PORT) &&
                           (start_lane > 1))  {
                    *port_starting_lane = start_lane;
                    *port_num_lane = 1;
                } else {
                ...
                PHYMOD_MEMCPY(&pc_copy, pc, sizeof(pc_copy));
                /* first read PML1 MPP0 port mode */
                pc_copy.lane_mask = 0x10;
                PHYMOD_IF_ERR_RETURN(READ_MAIN0_SETUPr(&pc_copy, &mode_reg));
                port_mode_sel_reg_mpp0 = MAIN0_SETUPr_PORT_MODE_SELf_GET(mode_reg);

                /* next read PML1 MPP1 port mode */
                pc_copy.lane_mask = 0x40;
                PHYMOD_IF_ERR_RETURN(READ_MAIN0_SETUPr(&pc_copy, &mode_reg));
                port_mode_sel_reg_mpp1 = MAIN0_SETUPr_PORT_MODE_SELf_GET(mode_reg);
                ...
                if ((port_mode_sel_reg_mpp0 == TSCOMOD_SINGLE_PORT) &&
                    (start_lane < 6)) {
                    /* lane 4-5 are used in 2-lane port mode */
                    *port_starting_lane = 4;
                    *port_num_lane = 2;
                } else if ((port_mode_sel_reg_mpp1 == TSCOMOD_SINGLE_PORT) &&
                           (start_lane > 5))  {
                    /* lane 6-7 are used in 2-lane port mode */
...
int tscomod_pcs_ts_config(PHYMOD_ST *pc, int ts_offset, int base_addr_adjust)
{
    RX_X2_RX_TS_CTLr_t RX_X2_RX_TS_CTLr_reg;
    ...
    RX_X2_RX_TS_CTLr_RX_SOP_BYTE_OFFSETf_SET(RX_X2_RX_TS_CTLr_reg, ts_offset);
    TX_X2_TX_TS_CTLr_TX_SOP_BYTE_OFFSETf_SET(TX_X2_TX_TS_CTLr_reg, ts_offset);

    RX_X2_RX_TS_CTLr_BASE_ADDRESS_CONTROLf_SET(RX_X2_RX_TS_CTLr_reg,
                                               base_addr_adjust?1:0);
    TX_X2_TX_TS_CTLr_BASE_ADDRESS_CONTROLf_SET(TX_X2_TX_TS_CTLr_reg,
                                               base_addr_adjust?1:0);
...
uint32_t _tscomod_pcs_vco_to_ui(uint32_t vco, int os_mode, int pam4)
{
    ...
    switch (vco) {
        case TSCOMOD_VCO_41G:
            if (os_mode == TSCOMOD_OS_MODE_4) {
            /* 4/41.25 = 0.096969696..
             * make 32 bit 0.096969696.. * 2^32 = 416481676 = 0x18d3018c
             */
                ui_value = TSCOMOD_UI_41G_NRZ_OSX4;
            } else { /* TSCOMOD_OS_MODE_2 */
                /* 2/41.25 = 0.04848..
                 * make 32 bit 0.04848.. * 2^32 = 208240838 = 0xc6980c6
                 */
                ui_value = TSCOMOD_UI_41G_NRZ_OSX2;
            }
            break;
        case TSCOMOD_VCO_51G:
            if (pam4) {
                if  (os_mode == TSCOMOD_OS_MODE_2) {
                    /* 2/(2*51.5625) = 0.019393939..
                     * make 32 bit 0.019393939.. * 2^32 =  83296335 = 0x04F7004F
                     */
                    ui_value = TSCOMOD_UI_51G_PAM4_OSX2;

                } else {
                    /* 1/(2*51.5625) = 0.009696969..
                     * make 32 bit 0.009696969.. * 2^32 = 41648167 = 0x27B8027
                     */
                    ui_value = TSCOMOD_UI_51G_PAM4_OSX1;
                }
            } else {
                if (os_mode == TSCOMOD_OS_MODE_5) { 
                /* 5/51.5625 = 0.09696..
                 * make 32 bit 0.09696.. * 2^32 = 416481676 = 0x18d3018c
                 */
                    ui_value = TSCOMOD_UI_51G_NRZ_OSX5;
                } else if  (os_mode == TSCOMOD_OS_MODE_2) {
                /* 2/51.5625 = 0.038787879..
                 * make 32 bit 0.038787879.. * 2^32 = 166592670 = 0x09ee009e
                 */
                    ui_value = TSCOMOD_UI_51G_NRZ_OSX2;
                } else { /* TSCOMOD_OS_MODE_1 */
                /* 1/51.5625  = 0.019393939..
                 * make 32 bit 0.019393939.. * 2^32 = 83296335 = 0x04F7004F
                 */
                    ui_value = TSCOMOD_UI_51G_NRZ_OSX1;
                }
            }
            break;
        case TSCOMOD_VCO_53G:
            if (pam4) {
               ...
               if  (os_mode == TSCOMOD_OS_MODE_2) {
                 ...
                 */
                    ui_value = TSCOMOD_UI_53G_NRZ_OSX2;
                } else { /* TSCOMOD_OS_MODE_1 */
                /* 1/53.125  = 0.0188235294117647..
                 * make 32 bit 0.0188235294.. * 2^32 = 80846443 = 0x04D19E6B
                 */
                    ui_value = TSCOMOD_UI_53G_NRZ_OSX1;
                }
            }
            break;
        default:
...
int tscomod_set_fclk_period(PHYMOD_ST *pc, uint32_t vco, int clk4sync_div)
{
    ...
    switch (vco) {
        case TSCOMOD_VCO_41G:
            if (clk4sync_div) {
                fclk_period = TSCOMOD_FCLK_PERIOD_41G_DIV8;
            } else {
                fclk_period = TSCOMOD_FCLK_PERIOD_41G_DIV6;
            }
            break;
        case TSCOMOD_VCO_51G:
            fclk_period = TSCOMOD_FCLK_PERIOD_51G;
            break;
        case TSCOMOD_VCO_53G:
            fclk_period = TSCOMOD_FCLK_PERIOD_53G;
            break;
        default:
            return PHYMOD_E_PARAM;
    }
...
int _tscomod_calc_pmd_latency(uint32_t vco, uint32_t os_mode, int pam4, int tx_or_rx)
{
    ...
    /***
    * Please refer to the Osprey user spec datapath latency table
    ...
    *****/
    if (pam4) {
        /* PAM4 */
       if (tx_or_rx == 1) {
            if (os_mode == TSCOMOD_OS_MODE_1) {
                rx_latency = ((uint32_t)((bit_ui_val * ((TSCOMOD_PMD_RX_DP_LATENCY_PAM4_OS1 * 2) + 20)) * 16));
            } else {
                rx_latency = ((uint32_t)((bit_ui_val * ((TSCOMOD_PMD_RX_DP_LATENCY_PAM4_NON_OS1 * 2) + 20)) * 16));
            }
        } else {
            if (os_mode == TSCOMOD_OS_MODE_2) {
                tx_latency = ((uint32_t)((bit_ui_val * ((TSCOMOD_PMD_TX_DP_LATENCY_PAM4+80) * 2)) * 1024));
            } else {
                tx_latency = ((uint32_t)((bit_ui_val * ((TSCOMOD_PMD_TX_DP_LATENCY_PAM4+40)* 2)) * 1024));
            }
        }
    } else {
        /* NRZ */
        if (tx_or_rx == 1) {
            if (os_mode == TSCOMOD_OS_MODE_1) {
                rx_latency = ((uint32_t)((bit_ui_val * (TSCOMOD_PMD_RX_DP_LATENCY_NRZ_OS1 + 20)) * 16));
            } else {
                rx_latency = ((uint32_t)((bit_ui_val * (TSCOMOD_PMD_RX_DP_LATENCY_NRZ_NON_OS1 + 20)) * 16));
            }
        } else {
            if (os_mode == TSCOMOD_OS_MODE_2) {
                tx_latency = ((uint32_t)((bit_ui_val * (TSCOMOD_PMD_TX_DP_LATENCY_PAM4+80)) * 1024));
            } else {
                tx_latency = ((uint32_t)((bit_ui_val * (TSCOMOD_PMD_TX_DP_LATENCY_PAM4+40)) * 1024));
            }
        }
    }
#endif
...
int tscomod_tx_pmd_latency_set(PHYMOD_ST *pc, uint32_t vco, int os_mode, int pam4)
{
    ...
    /* 
     * latency above is calculated with 10 bits of subns. 
     * Need to get rid of extra 2 bits.
     */
    PMD_X4_TX_FIXED_LATENCYr_CLR(PMD_X4_TX_FIXED_LATENCYr_reg);
...
@returns PHYMOD_E_NONE if no errors. PHYMOD_EERROR else.
@details Enables ts in rx path */
int tscomod_pcs_measure_tx_lane_skew(PHYMOD_ST *pc, uint32_t vco, int os_mode, int pam4,
                                          ...
                                          uint32_t* symb_err_cnt)
{
    ...
    PHYMOD_IF_ERR_RETURN
        (_tscomod_virtual_lane_count_get(bit_mux_mode, num_lanes, &virtual_lanes, &num_psll_per_phyl));
     ...
     *                       if start lane is 1, read entry_1;
     *                       if start lane is 2, read entry_4;
     *                       if start lane is 3, read entry_5.
     ...
     */
        ...
        case 4:
            if (start_lane % 4 == 0) {
                mem_idx = 0;
            } else if (start_lane % 4 == 1) {
                mem_idx = 1;
            } else if (start_lane % 4 == 2) {
                mem_idx = 4;
            } else if (start_lane % 4 == 3) {
                mem_idx = 5;
            }
            PHYMOD_IF_ERR_RETURN
...
int tscomod_intr_status_get(PHYMOD_ST* pc, tscomod_intr_status_t* intr_status)
{
    ...
    switch (intr_status->type) {
        case phymodIntrEccRx1588Mpp1:
            phy_copy.lane_mask <<= TSCOMOD_NOF_LANES_IN_MPP;
...
int tscomod_pcs_reg_num_copy_get(uint32_t reg_addr, int *num_copy)
{
    ...
    if (temp_reg <= TSCOMOD_IEEE_CL22_REG_ADDR) {
        *num_copy = 1;
    } else if (temp_reg < TSCOMOD_PCS_REG_START_ADDR) {
        *num_copy = 0;
        return PHYMOD_E_UNAVAIL;
        ...
        *num_copy = 4;
    } else if ((temp_reg >= TSCOMOD_PCS_FOUR_COPY_REG_BLOCK4) &&
               (temp_reg <= TSCOMOD_PCS_FOUR_COPY_REG_BLOCK4 + 0xf)) {
        *num_copy = 4;
    } else {
        *num_copy = 2;
    }
...
int tscomod_pmd_tx_pcs_delay_cnt_set(PHYMOD_ST* pc, uint32_t delay_cnt)
{
                             ...
                             uint32_t enable)
{
    ...
    switch (intr_type) {
        ...
        case phymodIntrEccRx1588Mpp1:
            pc_copy.lane_mask <<= TSCOMOD_NOF_LANES_IN_MPP;
            MAIN0_ECC_1B_ERR_INTR_ENr_ECC_1B_ERR_INTR_EN_RX_1588_MPPf_SET(reg_1b, enable);
            PHYMOD_IF_ERR_RETURN
                (MODIFY_MAIN0_ECC_1B_ERR_INTR_ENr(&pc_copy, reg_1b));
            MAIN0_ECC_2B_ERR_INTR_ENr_ECC_2B_ERR_INTR_EN_RX_1588_MPPf_SET(reg_2b, enable);
...
int tscomod_1588_ts_valid_get(PHYMOD_ST* pc, uint16_t* ts_valid)
{
    TX_X2_TX_1588_TIMESTAMP_STSr_t reg_tx_1588_timestamp_sts;

    TX_X2_TX_1588_TIMESTAMP_STSr_CLR(reg_tx_1588_timestamp_sts);
    PHYMOD_IF_ERR_RETURN(READ_TX_X2_TX_1588_TIMESTAMP_STSr(pc, &reg_tx_1588_timestamp_sts));
    *ts_valid = TX_X2_TX_1588_TIMESTAMP_STSr_TS_ENTRY_VALIDf_GET(reg_tx_1588_timestamp_sts);

    return PHYMOD_E_NONE;
}

int tscomod_fec_error_inject_set(const PHYMOD_ST *pc,
                                 ...
                                 tscomod_fec_error_mask_t bit_error_mask)
{
    ...
    TX_X2_ERR_CTLr_t TX_X2_ERR_CTLr_reg;
    TX_X2_RS_SYMr_t TX_X2_RS_SYMr_reg;
    ...
    TX_X2_ERR_CTLr_CLR(TX_X2_ERR_CTLr_reg);
    TX_X2_RS_SYMr_CLR(TX_X2_RS_SYMr_reg);

    PKTGEN_ERRMASK0r_ERROR_MASK_15_0f_SET(PKTGEN_ERRMASK0r_reg, bit_error_mask.error_mask_bit_31_0 & 0xffff);
    PHYMOD_IF_ERR_RETURN(WRITE_PKTGEN_ERRMASK0r(pc, PKTGEN_ERRMASK0r_reg));
    PKTGEN_ERRMASK1r_ERROR_MASK_31_16f_SET(PKTGEN_ERRMASK1r_reg, (bit_error_mask.error_mask_bit_31_0 >> 16) & 0xffff);
    PHYMOD_IF_ERR_RETURN(WRITE_PKTGEN_ERRMASK1r(pc, PKTGEN_ERRMASK1r_reg));
    PKTGEN_ERRMASK2r_ERROR_MASK_47_32f_SET(PKTGEN_ERRMASK2r_reg, bit_error_mask.error_mask_bit_63_32 & 0xffff);
    PHYMOD_IF_ERR_RETURN(WRITE_PKTGEN_ERRMASK2r(pc, PKTGEN_ERRMASK2r_reg));
    PKTGEN_ERRMASK3r_ERROR_MASK_63_48f_SET(PKTGEN_ERRMASK3r_reg, (bit_error_mask.error_mask_bit_63_32 >> 16) & 0xffff);
    PHYMOD_IF_ERR_RETURN(WRITE_PKTGEN_ERRMASK3r(pc, PKTGEN_ERRMASK3r_reg));
    PKTGEN_ERRMASK4r_ERROR_MASK_79_64f_SET(PKTGEN_ERRMASK4r_reg, bit_error_mask.error_mask_bit_79_64 & 0xffff);
    PHYMOD_IF_ERR_RETURN(WRITE_PKTGEN_ERRMASK4r(pc, PKTGEN_ERRMASK4r_reg));

    /* Need to clear the reg first */
    PHYMOD_IF_ERR_RETURN(WRITE_TX_X2_ERR_CTLr(pc, TX_X2_ERR_CTLr_reg));
    TX_X2_ERR_CTLr_RS_FEC_LANE_ERROR_INJECTf_SET(TX_X2_ERR_CTLr_reg, error_control_map & 0xff);
    PHYMOD_IF_ERR_RETURN(WRITE_TX_X2_ERR_CTLr(pc, TX_X2_ERR_CTLr_reg));

    TX_X2_RS_SYMr_ECWRf_SET(TX_X2_RS_SYMr_reg, bit_error_mask.error_injection_freq);
    PHYMOD_IF_ERR_RETURN(MODIFY_TX_X2_RS_SYMr(pc, TX_X2_RS_SYMr_reg));

    return PHYMOD_E_NONE;
}

int tscomod_fec_error_inject_get(const PHYMOD_ST *pc,
                                     uint16_t* error_control_map,
                                     tscomod_fec_error_mask_t* bit_error_mask)
{
    uint8_t error_gen = 0;
    ...
    PHYMOD_IF_ERR_RETURN(READ_PKTGEN_ERRMASK0r(pc, &PKTGEN_ERRMASK0r_reg));
    PHYMOD_IF_ERR_RETURN(READ_PKTGEN_ERRMASK1r(pc, &PKTGEN_ERRMASK1r_reg));
    ...
    PHYMOD_IF_ERR_RETURN(READ_PKTGEN_ERRMASK2r(pc, &PKTGEN_ERRMASK2r_reg));
    PHYMOD_IF_ERR_RETURN(READ_PKTGEN_ERRMASK3r(pc, &PKTGEN_ERRMASK3r_reg));
    ...
    PHYMOD_IF_ERR_RETURN(READ_PKTGEN_ERRMASK4r(pc, &PKTGEN_ERRMASK4r_reg));
    bit_error_mask->error_mask_bit_79_64 = PKTGEN_ERRMASK4r_ERROR_MASK_79_64f_GET(PKTGEN_ERRMASK4r_reg) & 0xffff;

    PHYMOD_IF_ERR_RETURN(READ_TX_X2_ERR_CTLr(pc, &TX_X2_ERR_CTLr_reg));
    error_gen = TX_X2_ERR_CTLr_RS_FEC_LANE_ERROR_INJECTf_GET(TX_X2_ERR_CTLr_reg);
    *error_control_map = error_gen;

    PHYMOD_IF_ERR_RETURN(READ_TX_X2_RS_SYMr(pc, &TX_X2_RS_SYMr_reg));
    bit_error_mask->error_injection_freq = TX_X2_RS_SYMr_ECWRf_GET(TX_X2_RS_SYMr_reg);

    return PHYMOD_E_NONE;
}

int tscomod_fec_error_bits_counter_get (PHYMOD_ST* pc, phymod_phy_speed_config_t* speed_config, uint32_t* count)
{
    int start_lane, num_lane;
    uint32_t count_32 = 0;
    uint64_t count_64, count_max;
    RX_X2_FEC_BIT_ERR_CTR0r_t count_low;
    RX_X2_FEC_BIT_ERR_CTR1r_t count_high;
    phymod_access_t pa_copy;
    ...
    if (speed_config->data_rate != 400000) {
        pa_copy.lane_mask = 1 << start_lane;
        PHYMOD_IF_ERR_RETURN
            (READ_RX_X2_FEC_BIT_ERR_CTR0r(&pa_copy, &count_low));
        PHYMOD_IF_ERR_RETURN
            (READ_RX_X2_FEC_BIT_ERR_CTR1r(&pa_copy, &count_high));
        *count = (RX_X2_FEC_BIT_ERR_CTR1r_GET(count_high) << 16) |
                  (RX_X2_FEC_BIT_ERR_CTR0r_GET(count_low) & 0xFFFF);
    } else {
        /* For 400G, read copy 0 of the register on both MPP0 and MPP1. */
        pa_copy.lane_mask = 1 << start_lane;
        PHYMOD_IF_ERR_RETURN
        ...
        PHYMOD_IF_ERR_RETURN
            (READ_RX_X2_FEC_BIT_ERR_CTR1r(&pa_copy, &count_high));
        count_32 = (RX_X2_FEC_BIT_ERR_CTR1r_GET(count_high) << 16) |
                  (RX_X2_FEC_BIT_ERR_CTR0r_GET(count_low) & 0xFFFF);
