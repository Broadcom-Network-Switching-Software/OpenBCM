...
#include <phymod/chip/tscf16_gen3.h>

#include <phymod/chip/falcon16_v1l4p1.h>

__phymod__dispatch__t__ phymod_tscf16_gen3_driver = {

    tscf16_gen3_core_identify,
    tscf16_gen3_core_info_get,
    tscf16_gen3_core_lane_map_set,
    tscf16_gen3_core_lane_map_get,
    tscf16_gen3_core_reset_set,
    tscf16_gen3_core_reset_get,
    tscf16_gen3_core_firmware_info_get,
    tscf16_gen3_phy_firmware_core_config_set,
    tscf16_gen3_phy_firmware_core_config_get,
    tscf16_gen3_phy_firmware_lane_config_set,
    tscf16_gen3_phy_firmware_lane_config_get,
    tscf16_gen3_core_pll_sequencer_restart,
    tscf16_gen3_core_wait_event,
    tscf16_gen3_phy_rx_restart,
    tscf16_gen3_phy_polarity_set,
    tscf16_gen3_phy_polarity_get,
    tscf16_gen3_phy_tx_set,
    tscf16_gen3_phy_tx_get,
    tscf16_gen3_phy_training_tx_fir_post_set,
    tscf16_gen3_phy_training_tx_fir_post_get,
    falcon16_v1l4p1_phy_media_type_tx_get,
    tscf16_gen3_phy_tx_override_set,
    tscf16_gen3_phy_tx_override_get,
    tscf16_gen3_phy_txpi_config_set,
    tscf16_gen3_phy_txpi_config_get,
    tscf16_gen3_phy_rx_set,
    tscf16_gen3_phy_rx_get,
    tscf16_gen3_phy_rx_adaptation_resume,
    tscf16_gen3_phy_reset_set,
    tscf16_gen3_phy_reset_get,
    tscf16_gen3_phy_power_set,
    tscf16_gen3_phy_power_get,
    tscf16_gen3_phy_hg2_codec_control_set,
    tscf16_gen3_phy_hg2_codec_control_get,
    tscf16_gen3_phy_tx_lane_control_set,
    tscf16_gen3_phy_tx_lane_control_get,
    tscf16_gen3_phy_rx_lane_control_set,
    tscf16_gen3_phy_rx_lane_control_get,
    tscf16_gen3_phy_fec_enable_set,
    tscf16_gen3_phy_fec_enable_get,
    tscf16_gen3_phy_fec_override_set,
    tscf16_gen3_phy_fec_override_get,
    ...
    tscf16_gen3_phy_autoneg_oui_set,
    tscf16_gen3_phy_autoneg_oui_get,
    tscf16_gen3_phy_eee_set,
    tscf16_gen3_phy_eee_get,
    tscf16_gen3_phy_interface_config_set,
    tscf16_gen3_phy_interface_config_get,
    tscf16_gen3_phy_cl72_set,
    tscf16_gen3_phy_cl72_get,
    tscf16_gen3_phy_cl72_status_get,
    tscf16_gen3_phy_autoneg_ability_set,
    tscf16_gen3_phy_autoneg_ability_get,
    tscf16_gen3_phy_autoneg_remote_ability_get,
    tscf16_gen3_phy_autoneg_set,
    tscf16_gen3_phy_autoneg_get,
    NULL, /* phymod_phy_autoneg_restart_set */
    tscf16_gen3_phy_autoneg_status_get,
    tscf16_gen3_core_init,
    tscf16_gen3_phy_pll_multiplier_get,
    tscf16_gen3_phy_init,
    tscf16_gen3_phy_loopback_set,
    tscf16_gen3_phy_loopback_get,
    tscf16_gen3_phy_rx_pmd_locked_get,
    NULL, /* phymod_phy_rx_pmd_lock_status_get */
    NULL, /* phymod_phy_local_fault_info_get */
    tscf16_gen3_phy_rx_signal_detect_get,
    NULL, /* phymod_phy_signal_detect_status_get */
    tscf16_gen3_phy_link_status_get,
    NULL, /* phymod_phy_status_dump */
    tscf16_gen3_phy_pcs_userspeed_set,
    tscf16_gen3_phy_pcs_userspeed_get,
    tscf16_gen3_phy_reg_read,
    tscf16_gen3_phy_reg_write,
    ...
    tscf16_gen3_timesync_enable_set,
    tscf16_gen3_timesync_enable_get,
    ...
    tscf16_gen3_timesync_offset_set,
    tscf16_gen3_timesync_offset_get,
    tscf16_gen3_timesync_adjust_set,
    ...
    tscf16_gen3_phy_eye_margin_est_get,
    NULL, /* phymod_phy_multi_get */
    tscf16_gen3_phy_rescal_set,
    tscf16_gen3_phy_rescal_get,
    ...
    tscf16_gen3_phy_fec_bypass_indication_set,
    tscf16_gen3_phy_fec_bypass_indication_get,
    ...
    tscf16_gen3_phy_osr_mode_get,
    tscf16_gen3_phy_ref_clk_get,
    ...
    tscf16_gen3_phy_rx_pmd_lock_counter_get,
    ...
    tscf16_gen3_phy_flr_config_set,
    tscf16_gen3_phy_flr_config_get,
    ...
    NULL, /* phymod_phy_temp_offset_set */
    NULL, /* phymod_phy_temp_offset_get */
    NULL, /* phymod_phy_fw_is_flr_supported */
    NULL, /* phymod_phy_rx_dc_offset_get */
    NULL, /* phymod_phy_uc_ram_var_set */
    NULL, /* phymod_phy_uc_ram_var_get */
    NULL, /* phymod_phy_external_los_enable_set */
    NULL, /* phymod_phy_external_los_enable_get */
    NULL, /* phymod_port_multi_mpp_mode_set */
};
