...
__phymod__dispatch__t__ phymod_null_driver = {

    null_core_identify,
    null_core_info_get,
    null_core_lane_map_set,
    null_core_lane_map_get,
    null_core_reset_set,
    null_core_reset_get,
    null_core_firmware_info_get,
    null_phy_firmware_core_config_set,
    null_phy_firmware_core_config_get,
    null_phy_firmware_lane_config_set,
    null_phy_firmware_lane_config_get,
    null_core_pll_sequencer_restart,
    null_core_wait_event,
    null_phy_rx_restart,
    null_phy_polarity_set,
    null_phy_polarity_get,
    null_phy_tx_set,
    null_phy_tx_get,
    NULL, /* phymod_phy_training_tx_fir_post_set */
    NULL, /* phymod_phy_training_tx_fir_post_get */
    null_phy_media_type_tx_get,
    null_phy_tx_override_set,
    null_phy_tx_override_get,
    NULL, /* phymod_phy_txpi_config_set */
    NULL, /* phymod_phy_txpi_config_get */
    null_phy_rx_set,
    null_phy_rx_get,
    null_phy_rx_adaptation_resume,
    null_phy_reset_set,
    null_phy_reset_get,
    null_phy_power_set,
    null_phy_power_get,
    null_phy_hg2_codec_control_set,
    null_phy_hg2_codec_control_get,
    null_phy_tx_lane_control_set,
    null_phy_tx_lane_control_get,
    null_phy_rx_lane_control_set,
    null_phy_rx_lane_control_get,
    null_phy_fec_enable_set,
    null_phy_fec_enable_get,
    ...
    null_phy_autoneg_oui_set,
    null_phy_autoneg_oui_get,
    null_phy_eee_set,
    null_phy_eee_get,
    null_phy_interface_config_set,
    null_phy_interface_config_get,
    null_phy_cl72_set,
    null_phy_cl72_get,
    null_phy_cl72_status_get,
    null_phy_autoneg_ability_set,
    null_phy_autoneg_ability_get,
    null_phy_autoneg_remote_ability_get,
    null_phy_autoneg_set,
    null_phy_autoneg_get,
    NULL, /* phymod_phy_autoneg_restart_set */
    null_phy_autoneg_status_get,
    null_core_init,
    null_phy_pll_multiplier_get,
    null_phy_init,
    null_phy_loopback_set,
    null_phy_loopback_get,
    null_phy_rx_pmd_locked_get,
    NULL, /* phymod_phy_rx_pmd_lock_status_get */
    NULL, /* phymod_phy_local_fault_info_get */
    null_phy_rx_signal_detect_get,
    NULL, /* phymod_phy_signal_detect_status_get */
    null_phy_link_status_get,
    NULL, /* phymod_phy_status_dump */
    null_phy_pcs_userspeed_set,
    null_phy_pcs_userspeed_get,
    null_phy_reg_read,
    null_phy_reg_write,
    ...
    null_phy_sw_autoneg_enable,
    null_phy_speed_config_set,
    null_phy_speed_config_get,
    NULL, /* phymod_phy_op_mode_get */
    null_phy_tx_taps_default_get,
    null_phy_lane_config_default_get,
    null_phy_firmware_load_info_get,
    null_phy_autoneg_advert_ability_set,
    null_phy_autoneg_advert_ability_get,
    null_phy_autoneg_remote_advert_ability_get,
    ...
    null_phy_codec_mode_set,
    null_phy_codec_mode_get,
