...
#ifndef OSPREY7_V2L8P2_API_DIAG_H
#define OSPREY7_V2L8P2_API_DIAG_H
...
struct osprey7_v2l8p2_eyescan_options_st {
...
/** Column definition header for osprey7_v2l8p2_display_core_state() API output.
 * To be called before osprey7_v2l8p2_display_core_state_line() API.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * Call osprey7_v2l8p2_display_core_state_hdr() API before and osprey7_v2l8p2_display_core_state_legend() after
...
/** Detailed description of each column in osprey7_v2l8p2_display_core_state_line() API output.
 * To be called after osprey7_v2l8p2_display_core_state_line() API to display the legends.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 *
 */
struct osprey7_v2l8p2_event_st {
 ...
 * @code
        srds_access_t *sa__ ;
        struct osprey7_v2l8p2_event_st event;
        event.event_id = 2; event.data1 = 5; event.data2 = 6;
        osprey7_v2l8p2_log_api_event(sa__, event);
 ...
 * This function only initiates the processor actions. User must use osprey7_v2l8p2_read_eye_scan_stripe() function
 ...
 * osprey7_v2l8p2_start_ber_scan_test(), osprey7_v2l8p2_read_ber_scan_data(), osprey7_v2l8p2_display_ber_scan_data().
 *
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] rate specifies the data rate in Hz.
 * @param[in] ber_scan_mode the type of test used to take the data(use #srds_diag_ber_mode_enum).
 ...
 * \n Note: Call functions osprey7_v2l8p2_display_lane_state_hdr(sa__) before and osprey7_v2l8p2_display_lane_state_legend() after
...
/** Column definition header for osprey7_v2l8p2 display state.
 * To be called before osprey7_v2l8p2_display_lane_state() function.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors).
 */
err_code_t osprey7_v2l8p2_display_lane_state_hdr(srds_access_t *sa__);

/** Detailed explanation of each column in osprey7_v2l8p2 display state.
 * To be called after osprey7_v2l8p2_display_lane_state() function to display the legends.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors).
 */
 ...
 * This function is required to be implemented by upper level software to enable osprey7_v2l8p2 support.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] diag_level is a MASK style parameter to enable variable level of display.
 *     enum srds_diag_level_enum can be used to help set the diag_level. \n
 * \verbatim
...
/** Parameterized diagnostic function which provides access to all osprey7_v2l8p2 control and status bits
 * This function is required to be implemented by upper level software to enable osprey7_v2l8p2 support.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
