...
#ifndef OSPREY7_V2L8P2_API_PRBS_H
#define OSPREY7_V2L8P2_API_PRBS_H
...
/*---------------------------------------*/
enum osprey7_v2l8p2_prbs_chk_timer_selection_enum {
    USE_HW_TIMERS = 0,
    USE_SW_TIMERS = 1
};
/*------------------------------*/
 ...
 * NOTE: osprey7_v2l8p2_tx_shared_patt_gen_en() API should be called to enable the Pattern generator for that particular lane. \n\n
 *
 ...
 * @b Example
 * @code
    EFUN(osprey7_v2l8p2_config_shared_tx_pattern(sa__, 4, "0101"));
    EFUN(osprey7_v2l8p2_tx_shared_patt_gen(en(sa__, 1, 4));
 * @endcode
 ...
 * Note: The patt_length_bits input to the function should be the value sent to the osprey7_v2l8p2_config_shared_tx_pattern() function
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] enable Enable shared fixed pattern generator (1 = Enable; 0 = Disable)
 * @param[in] patt_length_bits length of the pattern in bits used in osprey7_v2l8p2_config_shared_tx_pattern()
 ...
 * Once the PRBS generator is configured, to enable PRBS use the osprey7_v2l8p2_tx_prbs_en() API.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * Once the PRBS checker is configured, use the osprey7_v2l8p2_rx_prbs_en() API to enable the checker.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
...
struct osprey7_v2l8p2_prbs_chk_hw_timer_ctrl_st {
...
/** Setup the measurement of BER calculation using HardWare timers in the osprey7_v2l8p2.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] time_ms is the amount of time to delay for BER calculation.
...
/** Poll the Hardware based PRBS timer for expiration of time_ms in a BER calculation previously launched with osprey7_v2l8p2_BER_setup_measurement().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[out] ber_data is a struct that will get populated with number of errors and number of bits as elements.
 * @param[in] prbs_chk_hw_timer_ctrl is a structure to allow use of the PRBS error Hardware.
 * @return Error code, if generated (returns ERR_CODE_NONE if no errors).
...
/*---------------------------------*/
#define OSPREY7_V2L8P2_PRBS_FEC_RS_544_FRAME_SIZE             5440
#define OSPREY7_V2L8P2_PRBS_FEC_RS_528_FRAME_SIZE             5280

#define OSPREY7_V2L8P2_PRBS_FEC_FRAME_SIZE_MULTIPLIER         320
#define OSPREY7_V2L8P2_PRBS_FEC_FRAME_SIZE_ROUND_UP           240  /* 3/4th of difference b/w configurable fec_size's (320) */
#define OSPREY7_V2L8P2_PRBS_ERR_ANALYZER_FEC_SIZE_MIN         ( 6 * OSPREY7_V2L8P2_PRBS_FEC_FRAME_SIZE_MULTIPLIER)
#define OSPREY7_V2L8P2_PRBS_ERR_ANALYZER_FEC_SIZE_MAX         (63 * OSPREY7_V2L8P2_PRBS_FEC_FRAME_SIZE_MULTIPLIER)
#define OSPREY7_V2L8P2_PRBS_ERR_ANALYZER_ERR_THRESH_MIN        1
#define OSPREY7_V2L8P2_PRBS_ERR_ANALYZER_ERR_THRESH_MAX       15
#define OSPREY7_V2L8P2_PRBS_ERR_ANALYZER_HIST_ERR_THRESH_MIN   1
#define OSPREY7_V2L8P2_PRBS_ERR_ANALYZER_HIST_ERR_THRESH_MAX   8
#define OSPREY7_V2L8P2_PRBS_ERR_ANALYZER_FRAME_OVERLAP_FACTOR  8
#define OSPREY7_V2L8P2_PRBS_ERR_ANALYZER_LINEARITY_ADJUST      1.0
#define OSPREY7_V2L8P2_PRBS_ERR_ANALYZER_NUM_COUNTERS          8

#define OSPREY7_V2L8P2_PRBS_FEC_SIZE_FRAC_1_1                  0
#define OSPREY7_V2L8P2_PRBS_FEC_SIZE_FRAC_1_8                  1
#define OSPREY7_V2L8P2_PRBS_FEC_SIZE_FRAC_1_4                  2
#define OSPREY7_V2L8P2_PRBS_FEC_SIZE_FRAC_1_2                  3
#define OSPREY7_V2L8P2_PRBS_NUM_OF_ERROR_ANALYZER_COUNTERS    16
...
typedef struct {
  ...
  /** prbs_errcnt[i] - Num of FEC frames with >i errors (i = 0 to OSPREY7_V2L8P2_PRBS_NUM_OF_ERROR_ANALYZER_COUNTERS-1) */
  uint32_t prbs_errcnt[OSPREY7_V2L8P2_PRBS_NUM_OF_ERROR_ANALYZER_COUNTERS];
...
} osprey7_v2l8p2_prbs_err_analyzer_config_status_st;
...
typedef struct {
  ...
  uint8_t delta_n;
} osprey7_v2l8p2_prbs_err_analyzer_report_st;
...
/** Get PRBS Error Analyzer Error Counts on signle lane.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[out] err_analyzer PRBS Error Analyzer Error Count & Config Settings.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors).
 */
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors).
 */
err_code_t osprey7_v2l8p2_prbs_error_analyzer_extrapolate_err_count(srds_access_t *sa__, osprey7_v2l8p2_prbs_err_analyzer_config_status_st *err_analyzer, uint8_t error_count_index);
...
* @param[in] timeout_s Time (in seconds) for which the PRBS errors are accumulated.
* @param[in] diag_mode Selects whether errors are displayed in diag mode or normal mode -- diag mode is for internal use only. Users are required to invoke with this bit cleared.
* @return Error Code generated by API (returns ERR_CODE_NONE if no errors).
*/
