...
#ifndef OSPREY7_V2L8P2_API_PWR_MGT_H
#define OSPREY7_V2L8P2_API_PWR_MGT_H
 ...
 * To complete a osprey7_v2l8p2_core_pwrdn(), all of the lane(s) belonging to the core being powered down.
 * should also be issued a lane power down using osprey7_v2l8p2_lane_pwrdn().
 * Note: To wake up from any powerdown mode, first call PWR_ON and then de-assert core_dp_reset [osprey7_v2l8p2_core_dp_reset(sa__, 0)].
 ...
 */
err_code_t osprey7_v2l8p2_core_pwrdn(srds_access_t *sa__, enum srds_core_pwrdn_mode_enum mode);
 ...
 * Note: User also needs to configure all lanes through osprey7_v2l8p2_lane_config_for_iddq()
 * before enabling IDDQ by asserting IDDQ pin.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors).
 */
err_code_t osprey7_v2l8p2_core_config_for_iddq(srds_access_t *sa__);
/**************************************************/
 ...
 * Note: User needs to configure all lanes through osprey7_v2l8p2_lane_config_for_iddq() and also call osprey7_v2l8p2_core_config_for_iddq()
 * before enabling IDDQ by asserting IDDQ pin.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors).
 */
err_code_t osprey7_v2l8p2_lane_config_for_iddq(srds_access_t *sa__);
 ...
 *       De-assert with osprey7_v2l8p2_tx_dp_reset(..) when waking up from a TX only PWRDN, osprey7_v2l8p2_rx_dp_reset(..)
 *       for a RX only PWRDN, and osprey7_v2l8p2_ln_dp_reset(..) for both RX and TX.
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors).
 */
err_code_t osprey7_v2l8p2_lane_pwrdn(srds_access_t *sa__, enum srds_core_pwrdn_mode_enum mode);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors).
 */
err_code_t osprey7_v2l8p2_pwrdn_all(srds_access_t *sa__, enum srds_core_pwrdn_mode_enum mode);
