...
/**************************************************************************************
 **************************************************************************************
 *  File Name     :  osprey7_v2l8p2_field_access.h                                        *
...
#ifndef OSPREY7_V2L8P2_API_FIELD_ACCESS_H
#define OSPREY7_V2L8P2_API_FIELD_ACCESS_H
 ...
 */
err_code_t osprey7_v2l8p2_acc_mwr_reg_u8(srds_access_t *sa__, uint16_t addr, uint16_t mask, uint8_t lsb, uint8_t valu8);
 ...
 */
uint16_t osprey7_v2l8p2_acc_rde_reg(srds_access_t *sa__, uint16_t addr, err_code_t *err_code_p);
 ...
 */
uint16_t osprey7_v2l8p2_acc_rde_field_u16(srds_access_t *sa__, uint16_t addr, uint8_t shift_left, uint8_t shift_right, err_code_t *err_code_p);
 ...
 */
int16_t  osprey7_v2l8p2_acc_rde_field_s16(srds_access_t *sa__, uint16_t addr, uint8_t shift_left, uint8_t shift_right, err_code_t *err_code_p);
 ...
 */
uint8_t osprey7_v2l8p2_acc_rde_field_u8(srds_access_t *sa__, uint16_t addr, uint8_t shift_left, uint8_t shift_right, err_code_t *err_code_p);
 ...
 */
int8_t  osprey7_v2l8p2_acc_rde_field_s8(srds_access_t *sa__, uint16_t addr, uint8_t shift_left, uint8_t shift_right, err_code_t *err_code_p);


/*---------------------------------------------------------------------------------------------------*/
/* "Serdes ACCess" (_acc_) API dependency "wrapper" functions for osprey7_v2l8p2_dependencies.c          */
 ...
 * NOTE: This should be used instead of the API Dedendency function osprey7_v2l8p2_pmd_rdt_reg().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] addr 16-bit register address.
 * @param[out] valu16_p 16-bit unsigned value read from the register.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors).
 */
err_code_t osprey7_v2l8p2_acc_rdt_reg(srds_access_t *sa__, uint16_t addr, uint16_t *valu16_p);

/** Write to a register from the currently selected Serdes IP Lane.
 * NOTE: This should be used instead of the API Dedendency function osprey7_v2l8p2_pmd_wr_reg().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 */
err_code_t osprey7_v2l8p2_acc_wr_reg(srds_access_t *sa__, uint16_t addr, uint16_t valu16);

/** Masked Register Write to the currently selected Serdes IP core/lane.
 * NOTE: This should be used instead of the API Dedendency function osprey7_v2l8p2_pmd_mwr_reg().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * @return Error code generated by write function (returns ERR_CODE_NONE if no errors).
 */
err_code_t osprey7_v2l8p2_acc_mwr_reg(srds_access_t *sa__, uint16_t addr, uint16_t mask, uint8_t lsb, uint16_t valu16);


/*---------------------------------------------------------------------------------------------------*/
/* Additional "Serdes ACCess" (_acc_) API dependency wrapper functions for osprey7_v2l8p2_dependencies.c */
 ...
 * @return Error code generated by write function (returns ERR_CODE_NONE if no errors).
 */
err_code_t osprey7_v2l8p2_acc_wr_pram(srds_access_t *sa__, uint8_t val);
 ...
 */
err_code_t osprey7_v2l8p2_acc_delay_ns(srds_access_t *sa__, uint16_t delay_ns);
 ...
 * @return Error code generated by delay function (returns ERR_CODE_NONE if no errors).
 */
err_code_t osprey7_v2l8p2_acc_delay_us(srds_access_t *sa__, uint32_t delay_us);
 ...
 * @return Error code generated by delay function (returns ERR_CODE_NONE if no errors).
 */
err_code_t osprey7_v2l8p2_acc_delay_ms(srds_access_t *sa__, uint32_t delay_ms);

/** Return the address of current selected Serdes IP Core.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @return the IP level address of the current core.
 */
uint8_t osprey7_v2l8p2_acc_get_core(srds_access_t *sa__);
 ...
 */
uint8_t osprey7_v2l8p2_acc_get_lane(srds_access_t *sa__);

#define osprey7_v2l8p2_acc_get_physical_lane osprey7_v2l8p2_acc_get_lane
 ...
 */
err_code_t osprey7_v2l8p2_acc_set_lane(srds_access_t *sa__, uint8_t lane_index);

#define osprey7_v2l8p2_acc_set_physical_lane osprey7_v2l8p2_acc_set_lane
 ...
 */
uint8_t osprey7_v2l8p2_acc_get_pll_idx(srds_access_t *sa__);
 ...
 * @return Any error code generated during execution; ERR_CODE NONE otherwise.
 */
err_code_t osprey7_v2l8p2_acc_set_pll_idx(srds_access_t *sa__, uint8_t pll_index);
 ...
 */
uint8_t osprey7_v2l8p2_acc_get_micro_idx(srds_access_t *sa__);
 ...
 * @return Any error code generated during execution; ERR_CODE NONE otherwise.
 */
err_code_t osprey7_v2l8p2_acc_set_micro_idx(srds_access_t *sa__, uint8_t micro_index);

#if defined(SERDES_EXTERNAL_INFO_TABLE_EN)
/** Returns address of osprey7_v2l8p2 info table stored in upper level software.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @return Returns a pointer to the osprey7_v2l8p2 info table.
 */
srds_info_t *osprey7_v2l8p2_acc_get_info_table_address(srds_access_t *sa__);
#endif
