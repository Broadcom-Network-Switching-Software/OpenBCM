...
/* This function is used by PHYSIM only, set osr_mode on register instead of Ucode */
err_code_t osprey7_v2l8p2_osr_mode_set(phymod_access_t *sa__, int osr_mode)
{
...
/* This function is used by PHYSIM only, get osr_mode from register */
err_code_t osprey7_v2l8p2_osr_mode_get(phymod_access_t *sa__, int *osr_mode)
{
    err_code_t srds_err_code = ERR_CODE_NONE;
    int osr_forced;
...
err_code_t osprey7_v2l8p2_die_temp_offset_set(phymod_access_t *sa__, int temp_offset)
{
    return wrcv_die_temperature_offset(temp_offset);
}

err_code_t osprey7_v2l8p2_die_temp_offset_get(phymod_access_t *sa__, int *temp_offset)
{
    INIT_SRDS_ERR_CODE

    *temp_offset = rdcv_die_temperature_offset();
    return ERR_CODE_NONE;
}

err_code_t osprey7_v2l8p2_pam4_nr_er_lmt_bias_osx1_set(phymod_access_t *sa__, int16_t value)
{
    return wrv_pam4_lt_nr_er_lmt_bias_osx1((int8_t)value);
}

err_code_t osprey7_v2l8p2_pam4_nr_er_lmt_bias_osx2_set(phymod_access_t *sa__, int16_t value)
{
    return wrv_pam4_lt_nr_er_lmt_bias_osx2((int8_t)value);
}

err_code_t osprey7_v2l8p2_pam4_nr_er_lmt2_bias_osx1_set(phymod_access_t *sa__, int16_t value)
{
    return wrv_pam4_lt_nr_er_lmt2_bias_osx1((int8_t)value);
}

err_code_t osprey7_v2l8p2_pam4_nr_er_lmt2_bias_osx2_set(phymod_access_t *sa__, int16_t value)
{
    return wrv_pam4_lt_nr_er_lmt2_bias_osx2((int8_t)value);
}

err_code_t osprey7_v2l8p2_usr_signal_detect_threshold_set(phymod_access_t *sa__, int16_t value)
{
    return wrv_usr_signal_detect_threshold((uint8_t)value);
}

err_code_t osprey7_v2l8p2_pam4_nr_er_lmt_bias_osx1_get(phymod_access_t *sa__, int16_t *value)
{
    INIT_SRDS_ERR_CODE

    *value = rdv_pam4_lt_nr_er_lmt_bias_osx1();

    return ERR_CODE_NONE;
}

err_code_t osprey7_v2l8p2_pam4_nr_er_lmt_bias_osx2_get(phymod_access_t *sa__, int16_t *value)
{
    INIT_SRDS_ERR_CODE

    *value = rdv_pam4_lt_nr_er_lmt_bias_osx2();

    return ERR_CODE_NONE;
}

err_code_t osprey7_v2l8p2_pam4_nr_er_lmt2_bias_osx1_get(phymod_access_t *sa__, int16_t *value)
{
    INIT_SRDS_ERR_CODE

    *value = rdv_pam4_lt_nr_er_lmt2_bias_osx1();

    return ERR_CODE_NONE;
}

err_code_t osprey7_v2l8p2_pam4_nr_er_lmt2_bias_osx2_get(phymod_access_t *sa__, int16_t *value)
{
    INIT_SRDS_ERR_CODE

    *value = rdv_pam4_lt_nr_er_lmt2_bias_osx2();

    return ERR_CODE_NONE;
}

err_code_t osprey7_v2l8p2_usr_signal_detect_threshold_get(phymod_access_t *sa__, int16_t *value)
{
    INIT_SRDS_ERR_CODE

    *value = rdv_usr_signal_detect_threshold();
