...
#ifndef OSPREY7_V2L8P2_API_INTERFACE_H
#define OSPREY7_V2L8P2_API_INTERFACE_H
...
#include "osprey7_v2l8p2_pwr_mgt.h"
 ...
 *
 * osprey7_v2l8p2_interface.h - includes the header files of Serdes APIs that upper level software should interface with.
 *
 * osprey7_v2l8p2_dependencies.h - defines the functions to be provided by the IP user.
 *
