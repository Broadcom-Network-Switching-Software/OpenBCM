...
#include <phymod/chip/qtce16_diagnostics.h>

#include <phymod/chip/merlin16_diagnostics.h>

__phymod_diagnostics__dispatch__t__ phymod_diagnostics_qtce16_diagnostics_driver = {

    NULL, /* phymod_phy_rx_slicer_position_set */
    NULL, /* phymod_phy_rx_slicer_position_get */
    NULL, /* phymod_phy_rx_slicer_position_max_get */
    qtce16_phy_prbs_config_set,
    qtce16_phy_prbs_config_get,
    qtce16_phy_prbs_enable_set,
    qtce16_phy_prbs_enable_get,
    qtce16_phy_prbs_status_get,
    qtce16_phy_pattern_config_set,
    qtce16_phy_pattern_config_get,
    qtce16_phy_pattern_enable_set,
    qtce16_phy_pattern_enable_get,
    NULL, /* phymod_core_diagnostics_get */
    qtce16_phy_diagnostics_get,
    qtce16_phy_pmd_info_dump,
    qtce16_phy_pcs_info_dump,
    qtce16_phy_eyescan_run,
