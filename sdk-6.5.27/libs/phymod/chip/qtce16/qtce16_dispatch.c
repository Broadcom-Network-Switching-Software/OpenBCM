...
#include <phymod/chip/qtce16.h>

#include <phymod/chip/merlin16.h>

__phymod__dispatch__t__ phymod_qtce16_driver = {

    qtce16_core_identify,
    qtce16_core_info_get,
    qtce16_core_lane_map_set,
    qtce16_core_lane_map_get,
    NULL, /* phymod_core_reset_set */
    NULL, /* phymod_core_reset_get */
    qtce16_core_firmware_info_get,
    qtce16_phy_firmware_core_config_set,
    qtce16_phy_firmware_core_config_get,
    qtce16_phy_firmware_lane_config_set,
    qtce16_phy_firmware_lane_config_get,
    NULL, /* phymod_core_pll_sequencer_restart */
    NULL, /* phymod_core_wait_event */
    NULL, /* phymod_phy_rx_restart */
    qtce16_phy_polarity_set,
    qtce16_phy_polarity_get,
    qtce16_phy_tx_set,
    qtce16_phy_tx_get,
    ...
    qtce16_phy_power_set,
    qtce16_phy_power_get,
    NULL, /* phymod_phy_hg2_codec_control_set */
    NULL, /* phymod_phy_hg2_codec_control_get */
    qtce16_phy_tx_lane_control_set,
    qtce16_phy_tx_lane_control_get,
    qtce16_phy_rx_lane_control_set,
    qtce16_phy_rx_lane_control_get,
    ...
    qtce16_phy_eee_set,
    qtce16_phy_eee_get,
    qtce16_phy_interface_config_set,
    qtce16_phy_interface_config_get,
    qtce16_phy_cl72_set,
    qtce16_phy_cl72_get,
    qtce16_phy_cl72_status_get,
    qtce16_phy_autoneg_ability_set,
    qtce16_phy_autoneg_ability_get,
    qtce16_phy_autoneg_remote_ability_get,
    qtce16_phy_autoneg_set,
    qtce16_phy_autoneg_get,
    NULL, /* phymod_phy_autoneg_restart_set */
    qtce16_phy_autoneg_status_get,
    qtce16_core_init,
    qtce16_phy_pll_multiplier_get,
    qtce16_phy_init,
    qtce16_phy_loopback_set,
    qtce16_phy_loopback_get,
    ...
    qtce16_phy_synce_clk_ctrl_set,
    qtce16_phy_synce_clk_ctrl_get,
    NULL, /* phymod_phy_pcs_enable_set */
    qtce16_phy_rx_ppm_get,
    ...
    qtce16_phy_duplex_set,
    qtce16_phy_duplex_get,
    ...
    qtce16_phy_pcs_tx_fsm_check,
    qtce16_phy_pcs_reset,
