 ...
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *enable Returns if FLR is enabled (1 = Enabled; 0 = Disabled).
 * @param *enable_timeout  Returns if timeouts are enabled (1 = Enabled; 0 = Disabled).
 * @param *timeout_time Returns the value of the timeout time, if enable_timeout is set.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
