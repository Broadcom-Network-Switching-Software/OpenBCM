...
err_code_t blackhawk_signal_detect_status_get(phymod_access_t *sa__, uint32_t *sd_bmp, uint32_t *sd_change_bmp);
err_code_t blackhawk_rx_dc_offset_get(phymod_access_t *sa__, uint32_t *dc_offset);
