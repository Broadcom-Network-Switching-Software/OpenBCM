...
__phymod__dispatch__t__ phymod_blackhawk_driver = {
    ...
    blackhawk_phy_rx_pmd_lock_status_get,
    NULL, /* phymod_phy_local_fault_info_get */
    blackhawk_phy_rx_signal_detect_get,
    blackhawk_phy_signal_detect_status_get,
    ...
    blackhawk_phy_tx_phase_lock_rx_set,
    blackhawk_phy_tx_phase_lock_tx_set,
    blackhawk_phy_pll_reconfig,
    ...
    blackhawk_phy_rx_dc_offset_get,
