...
#define TEFMOD_PKTGEN_ERR_INJ_EN_FIELD_SET(cl74_en, index) \
    do {\
        if (cl74_en) {\
             switch (index) {                                                                         \
                 case 0:                                                                                 \
             ...
             switch (index) {                                                                         \
                 case 0:                                                                                 \
                     PKTGEN_ERR_INJ_EN1_GEN2r_CL91_40B_ERRGEN_EN_P0f_SET(PKTGEN_ERR_INJ_EN1_GEN2r_reg, 0x1); \
                     break;                                                                              \
                 case 1:                                                                                 \
                     PKTGEN_ERR_INJ_EN1_GEN2r_CL91_40B_ERRGEN_EN_P1f_SET(PKTGEN_ERR_INJ_EN1_GEN2r_reg, 0x1); \
                     break;                                                                              \
                 case 2:                                                                                 \
                     PKTGEN_ERR_INJ_EN1_GEN2r_CL91_40B_ERRGEN_EN_P2f_SET(PKTGEN_ERR_INJ_EN1_GEN2r_reg, 0x1); \
                     break;                                                                              \
                 case 3:                                                                                 \
                     PKTGEN_ERR_INJ_EN1_GEN2r_CL91_40B_ERRGEN_EN_P3f_SET(PKTGEN_ERR_INJ_EN1_GEN2r_reg, 0x1); \
                     break;                                                                              \
                 default:                                                                                \
                     return PHYMOD_E_PARAM;                                                              \
            }                                                                                            \
...
#define TEFMOD_PKTGEN_ERR_INJ_EN_FIELD_GET(cl74_en, index, errgen_en) \
     do {\
         if (cl74_en) {\
              switch (index) {                                                                         \
                  case 0:                                                                                 \
              ...
              switch (index) {                                                                         \
                  case 0:                                                                                 \
                      *errgen_en = PKTGEN_ERR_INJ_EN1_GEN2r_CL91_40B_ERRGEN_EN_P0f_GET(PKTGEN_ERR_INJ_EN1_GEN2r_reg); \
                      break;                                                                              \
                  case 1:                                                                                 \
                      *errgen_en = PKTGEN_ERR_INJ_EN1_GEN2r_CL91_40B_ERRGEN_EN_P1f_GET(PKTGEN_ERR_INJ_EN1_GEN2r_reg); \
                      break;                                                                              \
                  case 2:                                                                                 \
                      *errgen_en = PKTGEN_ERR_INJ_EN1_GEN2r_CL91_40B_ERRGEN_EN_P2f_GET(PKTGEN_ERR_INJ_EN1_GEN2r_reg); \
                      break;                                                                              \
                  case 3:                                                                                 \
                      *errgen_en = PKTGEN_ERR_INJ_EN1_GEN2r_CL91_40B_ERRGEN_EN_P3f_GET(PKTGEN_ERR_INJ_EN1_GEN2r_reg); \
                      break;                                                                              \
                  default:                                                                                \
                      return PHYMOD_E_PARAM;                                                              \
             }                                                                                            \
...
#define _RD_SYMBOL_ERROR_CNTR(pc, index, counter) \
    do { \
            PHYMOD_IF_ERR_RETURN(READ_RX_X4_CL91_FEC_SYM_ERR_CTR_LOW_##index##_GEN2r(pc,\
            &RX_X4_CL91_FEC_SYM_ERR_CTR_LOW_##index##_GEN2r_reg));\
            PHYMOD_IF_ERR_RETURN(READ_RX_X4_CL91_FEC_SYM_ERR_CTR_UP_##index##_GEN2r(pc,\
            &RX_X4_CL91_FEC_SYM_ERR_CTR_UP_##index##_GEN2r_reg));\
            *(counter) = RX_X4_CL91_FEC_SYM_ERR_CTR_UP_##index##_GEN2r_FEC_SYMBOL_ERROR_COUNTER_UPPER_##index##f_GET\
            (RX_X4_CL91_FEC_SYM_ERR_CTR_UP_##index##_GEN2r_reg) << 16 |\
            RX_X4_CL91_FEC_SYM_ERR_CTR_LOW_##index##_GEN2r_FEC_SYMBOL_ERROR_COUNTER_LOWER_##index##f_GET\
            (RX_X4_CL91_FEC_SYM_ERR_CTR_LOW_##index##_GEN2r_reg);\
    } while(0)

#define TEFMOD_RD_SYMBOL_ERROR_CNTR(pc, index, counter) \
    do {                                                       \
        switch (index) {                                       \
            case 0:                                            \
...
#define TEFMOD_SYMBOL_ERROR_CNTR_ADD(dst, src)      \
    do {  \
             /* Check overflow */                \
...
int tefmod_autoneg_ability_set(PHYMOD_ST* pc, tefmod_an_adv_ability_t *cl73_adv)
{
  ...
  */
  if((cl73_adv->an_cl72 & 0x1) == 1) {
     ...
     tefmod_set_override_1(pc, override_v);
  } else {
...
int tefmod_autoneg_control(PHYMOD_ST* pc, tefmod_an_control_t *an_control)
{
  ...
  if(an_control->an_type == TEFMOD_AN_MODE_CL73) {
    AN_X1_CL73_ERRr_SET(AN_X1_CL73_ERRr_reg, 0);
  } else if(an_control->an_type == TEFMOD_AN_MODE_HPAM){
    AN_X1_CL73_ERRr_SET(AN_X1_CL73_ERRr_reg, 0xfff0);
  } else if (an_control->an_type == TEFMOD_AN_MODE_CL73BAM) {
...
@details
  TBD
*/
int tefmod_set_override_0(PHYMOD_ST* pc, uint32_t per_field_override_en)   /* OVERRIDE_SET */
{
  int or_value;
...
@details
  TBD
*/
int tefmod_set_override_1(PHYMOD_ST* pc, uint32_t per_field_override_en)   /* OVERRIDE_SET */
{
  int or_value;
  override_type_t or_en;
  MAIN0_SETUPr_t                     MAIN0_SETUPr_reg;
  RX_X4_BLKSYNC_CFGr_t   RX_X4_CONTROL0_BLKSYNC_CONFIGr_reg;
  RX_X4_DEC_CTL0r_t             RX_X4_DEC_CTL0r_reg;
  TX_X4_CRED0r_t           TX_X4_CREDIT0_CREDIT0r_reg;
  TX_X4_CRED1r_t           TX_X4_CREDIT0_CREDIT1r_reg;
  TX_X4_LOOPCNTr_t           TX_X4_CREDIT0_LOOPCNTr_reg;
  TX_X4_MAC_CREDGENCNTr_t  TX_X4_CREDIT0_MAC_CREDITGENCNTr_reg;
  ...
  case OVERRIDE_R_HG2_ENABLE:
    RX_X4_DEC_CTL0r_CLR(RX_X4_DEC_CTL0r_reg);
    RX_X4_DEC_CTL0r_HG2_ENABLEf_SET(RX_X4_DEC_CTL0r_reg, or_value);
    PHYMOD_IF_ERR_RETURN(MODIFY_RX_X4_DEC_CTL0r(pc, RX_X4_DEC_CTL0r_reg));
...
int tefmod_FEC_control(PHYMOD_ST* pc, tefmod_fec_type_t fec_type, int enable, int cl74or91)
{
  ...
  if(enable < TEFMOD_PHY_CONTROL_FEC_AUTO) {
    if (fec_type == TEFMOD_CL91) {
      ...
      if (enable && (model == TSCF_GEN1) && ((num_lane == 1) || (num_lane == 2))) {
...
int tefmod_hg2_codec_set(PHYMOD_ST* pc, tefmod_hg2_codec_t hg2_codec)
{
  ...
  case TEFMOD_HG2_CODEC_OFF:
    /* disable override */
    field_override = OVERRIDE_T_ENC_MODE_DIS << 16;
    PHYMOD_IF_ERR_RETURN(tefmod_set_override_0(pc, field_override));
    field_override = OVERRIDE_T_HG2_ENABLE_DIS << 16;
    PHYMOD_IF_ERR_RETURN(tefmod_set_override_0(pc, field_override));
    field_override = OVERRIDE_DEC_TL_MODE_DIS << 16;
    PHYMOD_IF_ERR_RETURN(tefmod_set_override_0(pc, field_override));
    field_override = OVERRIDE_R_HG2_ENABLE_DIS << 16;
    PHYMOD_IF_ERR_RETURN(tefmod_set_override_1(pc, field_override));
  ...
  case TEFMOD_HG2_CODEC_ON_8BYTE_IPG:
    /* override t_enc_mode as T_ENC_MODE_CL49 */
    field_override = OVERRIDE_T_ENC_MODE << 16 | 1;
    PHYMOD_IF_ERR_RETURN(tefmod_set_override_0(pc, field_override));

    /* override t_HG2_enable */
    field_override = OVERRIDE_T_HG2_ENABLE << 16 | 1;
    PHYMOD_IF_ERR_RETURN(tefmod_set_override_0(pc, field_override));

    /* override r_dec_mode as R_DEC_TL_MODE_CL49 */
    field_override = OVERRIDE_DEC_TL_MODE << 16 | 1;
    PHYMOD_IF_ERR_RETURN(tefmod_set_override_0(pc, field_override));

    /* override r_HG2_enable */
    field_override = OVERRIDE_R_HG2_ENABLE << 16 | 1;
    PHYMOD_IF_ERR_RETURN(tefmod_set_override_1(pc, field_override));
...
int tefmod_fec_cl91_bit_error_counter_get (PHYMOD_ST* pc, uint32_t* count)
{
    int start_lane, num_lane;
    RX_X1_FEC_BIT_ERR_CTR0r_t count_low;
    RX_X1_FEC_BIT_ERR_CTR1r_t count_high;
    MAIN0_SERDESIDr_t serdesid;
    phymod_access_t pa_copy;
    uint32_t model;
    ...
    /* check if tscf_gen2 version */
    if (model == TSCF_GEN2) {
        RX_X4_FEC_BIT_ERR_CTR_0_GEN2r_t count_low_gen2;
        RX_X4_FEC_BIT_ERR_CTR_1_GEN2r_t count_high_gen2;

        /* Per port based counter */
        PHYMOD_IF_ERR_RETURN
            (READ_RX_X4_FEC_BIT_ERR_CTR_0_GEN2r(&pa_copy, &count_low_gen2));
        PHYMOD_IF_ERR_RETURN
            (READ_RX_X4_FEC_BIT_ERR_CTR_1_GEN2r(&pa_copy, &count_high_gen2));
        *count = (RX_X4_FEC_BIT_ERR_CTR_1_GEN2r_GET(count_high_gen2) << 16) |
                 (RX_X4_FEC_BIT_ERR_CTR_0_GEN2r_GET(count_low_gen2) & 0xFFFF);
    } else {
        /* Per port based counter */
        PHYMOD_IF_ERR_RETURN
            (READ_RX_X1_FEC_BIT_ERR_CTR0r(&pa_copy, &count_low));
        PHYMOD_IF_ERR_RETURN
            (READ_RX_X1_FEC_BIT_ERR_CTR1r(&pa_copy, &count_high));
        *count = (RX_X1_FEC_BIT_ERR_CTR1r_GET(count_high) << 16) |
                 (RX_X1_FEC_BIT_ERR_CTR0r_GET(count_low) & 0xFFFF);
    }
...
STATIC
int _tefmod_port_lane_config_get(PHYMOD_ST *pc, int port_mode, int *port_starting_lane, int *port_num_lane)
{
...
int tefmod_rsfec_symbol_error_counter_get(PHYMOD_ST* pc,
                                          int max_count,
                                          int* actual_count,
                                          uint32_t* symb_err_cnt)
{
    ...
    int i, fec_lane_id = 0;
    uint16_t lower, upper, symbol_reg_index = 0, symbol_reg_max_num = 4;
    ...
    RX_X4_CL91_FEC_SYM_ERR_CTR0r_t RX_X4_CL91_FEC_SYM_ERR_CTR0r_reg;
    RX_X4_CL91_FEC_SYM_ERR_CTR1r_t RX_X4_CL91_FEC_SYM_ERR_CTR1r_reg;
    RX_X4_CL91_FEC_SYM_ERR_CTR_LOW_0_GEN2r_t RX_X4_CL91_FEC_SYM_ERR_CTR_LOW_0_GEN2r_reg;
    RX_X4_CL91_FEC_SYM_ERR_CTR_LOW_1_GEN2r_t RX_X4_CL91_FEC_SYM_ERR_CTR_LOW_1_GEN2r_reg;
    RX_X4_CL91_FEC_SYM_ERR_CTR_LOW_2_GEN2r_t RX_X4_CL91_FEC_SYM_ERR_CTR_LOW_2_GEN2r_reg;
    RX_X4_CL91_FEC_SYM_ERR_CTR_LOW_3_GEN2r_t RX_X4_CL91_FEC_SYM_ERR_CTR_LOW_3_GEN2r_reg;
    RX_X4_CL91_FEC_SYM_ERR_CTR_UP_0_GEN2r_t RX_X4_CL91_FEC_SYM_ERR_CTR_UP_0_GEN2r_reg;
    RX_X4_CL91_FEC_SYM_ERR_CTR_UP_1_GEN2r_t RX_X4_CL91_FEC_SYM_ERR_CTR_UP_1_GEN2r_reg;
    RX_X4_CL91_FEC_SYM_ERR_CTR_UP_2_GEN2r_t RX_X4_CL91_FEC_SYM_ERR_CTR_UP_2_GEN2r_reg;
    RX_X4_CL91_FEC_SYM_ERR_CTR_UP_3_GEN2r_t RX_X4_CL91_FEC_SYM_ERR_CTR_UP_3_GEN2r_reg;
    ...
    PHYMOD_IF_ERR_RETURN
        (_tefmod_port_lane_config_get(pc, port_mode_sel, &port_start_lane, &port_num_lanes));
    ...
    for (i = 0; i < num_lane; i++) {
         ...
         if (model == TSCF_GEN1) {
             if (port_mode_sel == TEFMOD_SINGLE_PORT) {
                 PHYMOD_IF_ERR_RETURN(READ_RX_X4_CL91_FEC_SYM_ERR_CTR0r(&phy_copy, &RX_X4_CL91_FEC_SYM_ERR_CTR0r_reg));
                 PHYMOD_IF_ERR_RETURN(READ_RX_X4_CL91_FEC_SYM_ERR_CTR1r(&phy_copy, &RX_X4_CL91_FEC_SYM_ERR_CTR1r_reg));
                 lower = RX_X4_CL91_FEC_SYM_ERR_CTR0r_FEC_SYMBOL_ERROR_COUNTER_LOWERf_GET(RX_X4_CL91_FEC_SYM_ERR_CTR0r_reg);
                 upper = RX_X4_CL91_FEC_SYM_ERR_CTR1r_FEC_SYMBOL_ERROR_COUNTER_UPPERf_GET(RX_X4_CL91_FEC_SYM_ERR_CTR1r_reg);
                 symb_err_cnt[i] = upper << 16 | lower;
             } else {
                return PHYMOD_E_UNAVAIL;
             }
         } else {
             ...
             switch (port_mode_sel) {
                 case TEFMOD_SINGLE_PORT:
                     TEFMOD_RD_SYMBOL_ERROR_CNTR(&phy_copy, fec_lane_id, &error_cnt);
                     TEFMOD_SYMBOL_ERROR_CNTR_ADD(symb_err_cnt[i], error_cnt);
                     break;
                 case TEFMOD_DXGXS:
                     if (fec_lane_id < 2) {
                         TEFMOD_RD_SYMBOL_ERROR_CNTR(&phy_copy, fec_lane_id, &error_cnt);
                         TEFMOD_SYMBOL_ERROR_CNTR_ADD(symb_err_cnt[i], error_cnt);
                         TEFMOD_RD_SYMBOL_ERROR_CNTR(&phy_copy, fec_lane_id + 2, &error_cnt);
                         TEFMOD_SYMBOL_ERROR_CNTR_ADD(symb_err_cnt[i], error_cnt);
                     } else {
                         return PHYMOD_E_PARAM;
                     }
                 ...
                 case TEFMOD_TRI2_PORT:
                     if (1 == port_num_lanes) {
                         for (symbol_reg_index = 0; symbol_reg_index < symbol_reg_max_num; symbol_reg_index++) {
                              TEFMOD_RD_SYMBOL_ERROR_CNTR(&phy_copy, symbol_reg_index, &error_cnt);
                              TEFMOD_SYMBOL_ERROR_CNTR_ADD(symb_err_cnt[i], error_cnt);
                         }
                     } else {
                        if (fec_lane_id < 2) {
...
int tefmod_fec_error_inject_set(PHYMOD_ST *pc,
                                ...
                                tefmod_fec_error_mask_t bit_error_mask)
{
    ...
    PKTGEN_ERR_INJ_EN1_GEN2r_t PKTGEN_ERR_INJ_EN1_GEN2r_reg;
    TX_X1_TX_LN_SWP_GEN2r_t TX_X1_TX_LN_SWP_GEN2r_reg;
    ...
    PKTGEN_ERR_INJ_EN1_GEN2r_CLR(PKTGEN_ERR_INJ_EN1_GEN2r_reg);
    ...
    PHYMOD_IF_ERR_RETURN(tefmod_FEC_get(pc, TEFMOD_CL74, &cl74_en));
    if (cl74_en) {
        for (i = 0; i < num_lane; i++) {
             ...
             if (model == TSCF_GEN1) {
                 PHYMOD_IF_ERR_RETURN
                     (_tefmod_rx_phy_lane_get(pc, start_lane + i, &phy_lane));
             } else {
                 PHYMOD_IF_ERR_RETURN(READ_TX_X1_TX_LN_SWP_GEN2r(&pa_copy, &TX_X1_TX_LN_SWP_GEN2r_reg));
                 switch (start_lane + i) {
                     case 0x0:
                         phy_lane = TX_X1_TX_LN_SWP_GEN2r_LOGICAL0_TO_PHY_SELf_GET(TX_X1_TX_LN_SWP_GEN2r_reg);
                         break;
                     case 0x1:
                         phy_lane = TX_X1_TX_LN_SWP_GEN2r_LOGICAL1_TO_PHY_SELf_GET(TX_X1_TX_LN_SWP_GEN2r_reg);
                         break;
                     case 0x2:
                         phy_lane = TX_X1_TX_LN_SWP_GEN2r_LOGICAL2_TO_PHY_SELf_GET(TX_X1_TX_LN_SWP_GEN2r_reg);
                         break;
                     case 0x3:
                         phy_lane = TX_X1_TX_LN_SWP_GEN2r_LOGICAL3_TO_PHY_SELf_GET(TX_X1_TX_LN_SWP_GEN2r_reg);
                         break;
                     default:
                         return PHYMOD_E_PARAM;
                }
             }
             TEFMOD_PKTGEN_ERR_INJ_EN_FIELD_SET(cl74_en, phy_lane);
        }
        PHYMOD_IF_ERR_RETURN(WRITE_PKTGEN_ERR_INJ_EN0r(&pa_copy, PKTGEN_ERR_INJ_EN0r_reg));
        PHYMOD_IF_ERR_RETURN(WRITE_PKTGEN_ERR_INJ_EN1r(&pa_copy, PKTGEN_ERR_INJ_EN1r_reg));
    } else {
        if (model == TSCF_GEN2) {
            ...
            TEFMOD_PKTGEN_ERR_INJ_EN_FIELD_SET(cl74_en, start_lane);
            PHYMOD_IF_ERR_RETURN(WRITE_PKTGEN_ERR_INJ_EN1_GEN2r(&pa_copy, PKTGEN_ERR_INJ_EN1_GEN2r_reg));
        } else {
            return PHYMOD_E_UNAVAIL;
        }
    }
...
int tefmod_fec_error_inject_get(PHYMOD_ST *pc,
                                uint16_t* error_control_map,
                                tefmod_fec_error_mask_t* bit_error_mask)
{
    int start_lane = 0, num_lane = 0, phy_lane = 0;
    ...
    PHYMOD_IF_ERR_RETURN(READ_PKTGEN_ERR_INJ_EN1_GEN2r(&pa_copy, &PKTGEN_ERR_INJ_EN1_GEN2r_reg));
    ...
    if (cl74_en) {
        for (i = 0; i < num_lane; i++) {
            ...
            TEFMOD_PKTGEN_ERR_INJ_EN_FIELD_GET(cl74_en, phy_lane, &errgen_en);
            if (errgen_en) {
        ...
        if (model == TSCF_GEN2) {
            /* RSFEC error injection is per port */
            TEFMOD_PKTGEN_ERR_INJ_EN_FIELD_GET(cl74_en, start_lane, &errgen_en);
            *error_control_map =  (0x1 == errgen_en) ? 1 : 0;
        } else {
            return PHYMOD_E_UNAVAIL;
        }
    }
...
int tefmod_port_start_lane_get(PHYMOD_ST *pc,
                               ...
                               int *port_num_lane)
{
    ...
    if (num_of_lane > 1) {
        ...
        *port_num_lane = num_of_lane;
        ...
        port_mode_sel_reg = MAIN0_SETUPr_PORT_MODE_SELf_GET(mode_reg);
        PHYMOD_IF_ERR_RETURN
            (_tefmod_port_lane_config_get(pc,
                                          port_mode_sel_reg,
                                          port_starting_lane,
                                          port_num_lane));
    }
...
int tefmod_signal_detect_status_get(PHYMOD_ST *pc, uint32_t *sd_bmp, uint32_t *sd_change_bmp)
{
    ...
    PHYMOD_MEMCPY(&phy_access_copy, pc, sizeof(phy_access_copy));
    *sd_bmp = 0;
    *sd_change_bmp = 0;
    ...
    for (lane_offset = 0; lane_offset < num_lane; lane_offset++) {
        if (!PHYMOD_LANEPBMP_MEMBER(pc->lane_mask, start_lane + lane_offset)) {
            continue;
        }
