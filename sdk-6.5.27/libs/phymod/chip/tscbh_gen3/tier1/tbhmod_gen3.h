...
typedef enum {
    TBHMOD_GEN3_AN_TIMER_NONE = 0,
    TBHMOD_GEN3_AN_FAIL_INHIBIT_TIMER_LT_PAM4
}tbhmod_gen3_an_timer_t;
...
typedef struct tbhmod_gen3_fec_error_mask_s {
...
} tbhmod_gen3_fec_error_mask_t;

#define TSCBH_GEN3_TS_OFFSET_SOP        0
#define TSCBH_GEN3_TS_OFFSET_SFD        7
#define TSCBH_GEN3_TS_OFFSET_MAC_DA     8
#define TSCBH_GEN3_TS_RPM_OFFSET        4
...
extern int tbhmod_gen3_fec_align_status_get(PHYMOD_ST* pc, uint32_t* fec_align_live);
...
extern int tbhmod_gen3_pcs_ts_config(PHYMOD_ST *pc, int ts_offset);
...
extern int tbhmod_gen3_ts_rx_table_adjust_set(PHYMOD_ST* pc, uint32_t vco,
...
tbhmod_gen3_interrupt_enable_get(PHYMOD_ST *pc,
                                 phymod_interrupt_type_t intr_type,
                                 uint32_t *enable);
extern int tbhmod_gen3_1588_ts_valid_get(PHYMOD_ST* pc, uint16_t* ts_valid);
extern int tbhmod_gen3_fec_error_inject_set(const PHYMOD_ST *pc,
                                uint16_t error_control_map,
                                tbhmod_gen3_fec_error_mask_t bit_error_mask);
extern int tbhmod_gen3_fec_error_inject_get(const PHYMOD_ST *pc,
                                uint16_t* error_control_map,
                                tbhmod_gen3_fec_error_mask_t* bit_error_mask);
extern int tbhmod_gen3_an_link_fail_inhibit_timer_set(PHYMOD_ST* pc,
                                                      tbhmod_gen3_an_timer_t timer_type,
                                                      uint32_t period);
extern int tbhmod_gen3_an_link_fail_inhibit_timer_get(PHYMOD_ST* pc,
                                                      tbhmod_gen3_an_timer_t timer_type,
                                                      uint32_t* period);
extern int tbhmod_gen3_fec_error_bits_counter_get(PHYMOD_ST* pc, uint32_t* count);
extern int tbhmod_gen3_mapped_speed_get_osmode (int mapped_speed_id, tbhmod_gen3_refclk_t ref_clk);
