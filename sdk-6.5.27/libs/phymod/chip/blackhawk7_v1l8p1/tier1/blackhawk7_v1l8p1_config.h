...
if (BLACKHAWK7_V1L8P1_REVID_MODEL_DEFAULT != revid || BLACKHAWK7_V1L8P1_REVID2_DEFAULT != revid2 || ((BLACKHAWK7_V1L8P1_AFE_IPVERSION_ID_DEFAULT != ipversion) && (BLACKHAWK7_V1L8P1_AFE_IPVERSION_ID_DEFAULT_2 != ipversion))) { \
    EFUN_PRINTF(("ERROR: IP Hardware ID Mismatch. Expected: 0x%08X or %08X. Actual: 0x%08X.\n",                                             \
                (uint32_t)((BLACKHAWK7_V1L8P1_REVID_MODEL_DEFAULT << 16) | (BLACKHAWK7_V1L8P1_REVID2_DEFAULT << 8) | (BLACKHAWK7_V1L8P1_AFE_IPVERSION_ID_DEFAULT)),          \
                (uint32_t)((BLACKHAWK7_V1L8P1_REVID_MODEL_DEFAULT << 16) | (BLACKHAWK7_V1L8P1_REVID2_DEFAULT << 8) | (BLACKHAWK7_V1L8P1_AFE_IPVERSION_ID_DEFAULT_2)),        \
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_ucode_crc_verify(srds_access_t *sa__, uint32_t ucode_len, uint16_t expected_crc_value);
 ...
 * This function calls blackhawk7_v1l8p1_core_dp_reset() as needed.
 * Configures PLL registers to obtain the required configuration.
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors).
 */
err_code_t blackhawk7_v1l8p1_configure_20P625G_pll_refclk(srds_access_t *sa__,
                                        enum blackhawk7_v1l8p1_pll_refclk_enum refclk);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors).
 */
err_code_t blackhawk7_v1l8p1_configure_20P625G_pll_div(srds_access_t *sa__,
                                        enum blackhawk7_v1l8p1_pll_div_enum srds_div);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors).
 */
err_code_t blackhawk7_v1l8p1_configure_pll_refclk_div_refclk_2x(srds_access_t *sa__,
                                           enum blackhawk7_v1l8p1_pll_refclk_enum refclk,
                                           enum blackhawk7_v1l8p1_pll_div_enum srds_div);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors).
 */
err_code_t blackhawk7_v1l8p1_configure_pll_refclk_vco_refclk_2x(srds_access_t *sa__,
                                           enum blackhawk7_v1l8p1_pll_refclk_enum refclk,
                                           uint32_t vco_freq_khz);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors).
 */
err_code_t blackhawk7_v1l8p1_configure_pll_div_vco_refclk_2x(srds_access_t *sa__,
                                        enum blackhawk7_v1l8p1_pll_div_enum srds_div,
                                        uint32_t vco_freq_khz);
...
* Note: This API should be used only during configuration under dp_reset (blackhawk7_v1l8p1_ln_dp_reset()).
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[out] mode An enable/disable option from the enum blackhawk7_v1l8p1_force_cdr_mode_enum.
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors).
 */
err_code_t blackhawk7_v1l8p1_get_force_lane_cdr_mode(srds_access_t *sa__, enum blackhawk7_v1l8p1_force_cdr_mode_enum *mode);

/** Enable or disable force OS/BR/ER CDR mode
 * Note: This API should be used only during configuration under dp reset (blackhawk7_v1l8p1_ln_dp_reset()).
 *       When enabling one mode, this API will disable the other mode.
 * Note: ER-CDR Mode does not apply to 7nm Serdes cores
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] mode An enable/disable option from the enum blackhawk7_v1l8p1_force_cdr_mode_enum.
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors).
 */
err_code_t blackhawk7_v1l8p1_force_lane_cdr_mode(srds_access_t *sa__, enum blackhawk7_v1l8p1_force_cdr_mode_enum mode);
 ...
 * NOTE: Before asserting TX datapath reset, the TX must be disabled (blackhawk7_v1l8p1_tx_disable(sa__, 1).
 ...
 * reenabled (blackhawk7_v1l8p1_tx_disable(sa__, 0).
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * NOTE: Before asserting lane datapath reset, the TX must be disabled (blackhawk7_v1l8p1_tx_disable(sa__, 1).
 * This is done in order to prevent analog aging circuits from leaking garbage data out the TX.
 ...
 * Note: Calling this API will overwrite any OSR mode value previously programmed through blackhawk7_v1l8p1_set_osr_mode(),
 *       blackhawk7_v1l8p1_set_tx_osr_mode(), or blackhawk7_v1l8p1_set_rx_osr_mode().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] use_pins_only Allow the use of TX and RX osr mode pins (1 = Yes; 0 = No).
 * @return Error Code generated by invalid access (returns ERR_CODE_NONE if no errors).
 */
err_code_t blackhawk7_v1l8p1_set_use_osr_mode_pins_only(srds_access_t *sa__, uint8_t use_pins_only);
 ...
 * @return Error Code generated by invalid access (returns ERR_CODE_NONE if no errors).
 */
err_code_t blackhawk7_v1l8p1_get_use_osr_mode_pins_only(srds_access_t *sa__, uint8_t *tx_use_pins_only, uint8_t *rx_use_pins_only);

/** Configure if the RX osr mode pins should only be used to configure the RX osr mode.
 * Note: Calling this API will overwrite any OSR mode value previously programmed through blackhawk7_v1l8p1_set_osr_mode()
 *        or blackhawk7_v1l8p1_set_rx_osr_mode().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] rx_use_pins_only Allow the use of RX osr mode pins (1 = Yes; 0 = No).
 * @return Error Code generated by invalid access (returns ERR_CODE_NONE if no errors).
 */
err_code_t blackhawk7_v1l8p1_set_use_rx_osr_mode_pins_only(srds_access_t *sa__, uint8_t rx_use_pins_only);
 ...
 * @return Error Code generated by invalid access (returns ERR_CODE_NONE if no errors).
 */
err_code_t blackhawk7_v1l8p1_get_use_rx_osr_mode_pins_only(srds_access_t *sa__, uint8_t *rx_use_pins_only);

/** Configure if the RX osr mode pins should only be used to configure the TX osr mode.
 * Note: Calling this API will overwrite any OSR mode value previously programmed through blackhawk7_v1l8p1_set_osr_mode()
 *        or blackhawk7_v1l8p1_set_tx_osr_mode().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] tx_use_pins_only Allow the use of TX osr mode pins (1 = Yes; 0 = No).
 * @return Error Code generated by invalid access (returns ERR_CODE_NONE if no errors).
 */
err_code_t blackhawk7_v1l8p1_set_use_tx_osr_mode_pins_only(srds_access_t *sa__, uint8_t tx_use_pins_only);
 ...
 * @return Error Code generated by invalid access (returns ERR_CODE_NONE if no errors).
 */
err_code_t blackhawk7_v1l8p1_get_use_tx_osr_mode_pins_only(srds_access_t *sa__, uint8_t *tx_use_pins_only);

/** Set both the TX and RX osr mode.
 * Note: Calling this API will overwrite the blackhawk7_v1l8p1_set_use_osr_mode_pins_only() setting if it was previously set.
 ...
 * @return Error Code generated by invalid access (returns ERR_CODE_NONE if no errors).
 */
err_code_t blackhawk7_v1l8p1_set_osr_mode(srds_access_t *sa__, enum blackhawk7_v1l8p1_osr_mode_enum osr_mode);

/** Get both the TX and RX osr mode.
 * Note: A return value of 0x3f is uninitialized.
 * Note: This API returns the control status, not the actual hardware status. Use blackhawk7_v1l8p1_INTERNAL_get_osr_mode()
 ...
 * @return Error Code generated by invalid access (returns ERR_CODE_NONE if no errors).
 */
err_code_t blackhawk7_v1l8p1_get_osr_mode(srds_access_t *sa__, enum blackhawk7_v1l8p1_osr_mode_enum *tx_osr_mode, enum blackhawk7_v1l8p1_osr_mode_enum *rx_osr_mode);

/** Set the RX osr mode.
 * Note: Calling this API will overwrite the blackhawk7_v1l8p1_set_use_rx_osr_mode_pins_only() setting if it was previously set.
 * Note: This API should be used for configuring TX and RX osr modes when pins aren't being used. Do not write directly to the following
 *       register fields: rx_osr_mode_frc, rx_osr_mode_frc_val, tx_osr_mode_frc, tx_osr_mode_frc_val, osr_mode_frc, and osr_mode_frc_val.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * @return Error Code generated by invalid access (returns ERR_CODE_NONE if no errors).
 */
err_code_t blackhawk7_v1l8p1_set_rx_osr_mode(srds_access_t *sa__, enum blackhawk7_v1l8p1_osr_mode_enum rx_osr_mode);
 ...
 * @return Error Code generated by invalid access (returns ERR_CODE_NONE if no errors).
 */
err_code_t blackhawk7_v1l8p1_get_rx_osr_mode(srds_access_t *sa__, enum blackhawk7_v1l8p1_osr_mode_enum *rx_osr_mode);

/** Set the TX osr mode.
 * Note: Calling this API will overwrite the blackhawk7_v1l8p1_set_use_tx_osr_mode_pins_only() setting if it was previously set.
 * Note: This API should be used for configuring TX and RX osr modes when pins aren't being used. Do not write directly to the following
 *       register fields: rx_osr_mode_frc, rx_osr_mode_frc_val, tx_osr_mode_frc, tx_osr_mode_frc_val, osr_mode_frc, and osr_mode_frc_val.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * @return Error Code generated by invalid access (returns ERR_CODE_NONE if no errors).
 */
err_code_t blackhawk7_v1l8p1_set_tx_osr_mode(srds_access_t *sa__, enum blackhawk7_v1l8p1_osr_mode_enum tx_osr_mode);
 ...
 * @return Error Code generated by invalid access (returns ERR_CODE_NONE if no errors).
 */
err_code_t blackhawk7_v1l8p1_get_tx_osr_mode(srds_access_t *sa__, enum blackhawk7_v1l8p1_osr_mode_enum *tx_osr_mode);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_configure_fast_link_recovery(srds_access_t *sa__, uint8_t enable, uint8_t enable_timeout, enum blackhawk7_v1l8p1_flr_timeout_enum timeout_time);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_get_configure_fast_link_recovery(srds_access_t *sa__, uint8_t *enable, uint8_t *enable_timeout, enum blackhawk7_v1l8p1_flr_timeout_enum *timeout_time);
