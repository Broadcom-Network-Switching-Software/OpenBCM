...
int tefmod16_autoneg_set(PHYMOD_ST* pc, tefmod16_an_adv_ability_t *cl73_adv)
{
  ...
  */
  if ((cl73_adv->an_cl72 & 0x1) == 1) {
      ...
      tefmod16_set_override_1(pc, override_v);
   } else {
...
@details
  TBD
*/
int tefmod16_set_override_0(PHYMOD_ST* pc, uint32_t per_field_override_en)   /* OVERRIDE_SET */
{
  int or_value;
...
@details
  TBD
*/
int tefmod16_set_override_1(PHYMOD_ST* pc, uint32_t per_field_override_en)   /* OVERRIDE_SET */
{
  int or_value;
  override_type_t or_en;
  MAIN0_SETUPr_t                     MAIN0_SETUPr_reg;
...
int tefmod16_hg2_codec_set(PHYMOD_ST* pc, tefmod16_hg2_codec_t hg2_codec)
{
  ...
  case TEFMOD16_HG2_CODEC_OFF:
    ...
    PHYMOD_IF_ERR_RETURN(tefmod16_set_override_0(pc, field_override));
    ...
    PHYMOD_IF_ERR_RETURN(tefmod16_set_override_1(pc, field_override));
...
int tefmod16_fec_cl91_bit_error_counter_get (PHYMOD_ST* pc, uint32_t* count)
{
...
int tefmod16_port_start_lane_get(PHYMOD_ST *pc,
                                 ...
                                 int *port_num_lane)
{
    ...
    if (num_of_lane > 1) {
        ...
        *port_num_lane = num_of_lane;
        ...
        port_mode_sel_reg = MAIN0_SETUPr_PORT_MODE_SELf_GET(mode_reg);
        PHYMOD_IF_ERR_RETURN
            (_tefmod16_port_lane_config_get(pc,
                                            port_mode_sel_reg,
                                            port_starting_lane,
                                            port_num_lane));
    }
...
int tefmod16_signal_detect_status_get(PHYMOD_ST *pc, uint32_t *sd_bmp, uint32_t *sd_change_bmp)
{
