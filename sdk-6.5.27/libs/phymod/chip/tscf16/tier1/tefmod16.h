...
extern int tefmod16_set_override_0(PHYMOD_ST* pc, uint32_t per_field_override_en);
extern int tefmod16_set_override_1(PHYMOD_ST* pc, uint32_t per_field_override_en);
...
extern int tefmod16_fec_cl91_bit_error_counter_get (PHYMOD_ST* pc, uint32_t* count);
...
extern int tefmod16_fec_error_inject_get(PHYMOD_ST *pc,
                                         uint16_t* error_control_map,
                                         tefmod16_fec_error_mask_t* bit_error_mask);
extern int tefmod16_port_start_lane_get(PHYMOD_ST *pc,
                                        int *port_starting_lane,
                                        int *port_num_lane);
extern int tefmod16_signal_detect_status_get(PHYMOD_ST *pc, uint32_t *sd_bmp, uint32_t *sd_change_bmp);
#endif  /*  _tefmod16_H_ */
