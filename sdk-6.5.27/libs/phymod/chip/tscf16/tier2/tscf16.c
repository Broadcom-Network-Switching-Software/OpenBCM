...
int tscf16_phy_signal_detect_status_get(const phymod_phy_access_t* phy,
                                        phymod_signal_detect_status_t* sd_status)
{
    ...
    PHYMOD_MEMCPY(&pm_phy_copy, phy, sizeof(pm_phy_copy));
    PHYMOD_IF_ERR_RETURN
        (tefmod16_signal_detect_status_get(&pm_phy_copy.access,
...
int tscf16_phy_rx_dc_offset_get(const phymod_phy_access_t* phy,  uint32_t *rx_dc_offset)
{
    ...
    PHYMOD_IF_ERR_RETURN
        (falcon16_tsc_rx_dc_offset_get(&phy_copy.access, rx_dc_offset));
