...
__phymod__dispatch__t__ phymod_tsco_dpll_driver = {
    ...
    tsco_dpll_phy_fec_override_set,
    tsco_dpll_phy_fec_override_get,
    ...
    tsco_phy_interrupt_enable_set,
    tsco_phy_interrupt_enable_get,
    ...
    tsco_phy_an_timer_set,
    tsco_phy_an_timer_get,
    tsco_dpll_phy_flr_config_set,
    tsco_dpll_phy_flr_config_get,
    ...
    tsco_dpll_phy_temp_offset_set,
    tsco_dpll_phy_temp_offset_get,
    tsco_dpll_phy_fw_is_flr_supported,
    NULL, /* phymod_phy_rx_dc_offset_get */
    osprey7_v2l8p2_phy_uc_ram_var_set,
    osprey7_v2l8p2_phy_uc_ram_var_get,
    NULL, /* phymod_phy_external_los_enable_set */
    NULL, /* phymod_phy_external_los_enable_get */
    tsco_dpll_port_multi_mpp_mode_set,
};
