...
#define TSCBH_FE_GEN2_SYNCE_SDM_DIVISOR_20G_VCO         10560
#define TSCBH_FE_GEN2_SYNCE_SDM_DIVISOR_25G_VCO         12800
#define TSCBH_FE_GEN2_SYNCE_SDM_DIVISOR_25GP78125_VCO   13200
#define TSCBH_FE_GEN2_SYNCE_SDM_DIVISOR_26G_VCO         13600
#define TSCBH_FE_GEN2_SYNCE_SDM_DIVISOR_26P773G_VCO     13707
#define TSCBH_FE_GEN2_SYNCE_SDM_DIVISOR_27P622G_VCO     14142
#define TSCBH_FE_GEN2_SYNCE_SDM_DIVISOR_27P739G_VCO     14202
#define TSCBH_FE_GEN2_SYNCE_SDM_DIVISOR_27P952G_VCO     14311
#define TSCBH_FE_GEN2_SYNCE_SDM_DIVISOR_28P076G_VCO     14375


#define TSCBH_FE_GEN2_TS_OFFSET_SOP                 0
#define TSCBH_FE_GEN2_TS_OFFSET_SFD                 7
#define TSCBH_FE_GEN2_TS_OFFSET_MAC_DA              8
#define TSCBH_FE_GEN2_TS_RPM_OFFSET                 4
...
#define TBHMOD_FE_GEN2_UI_20G_NRZ_OSX1      0x0C698000
#define TBHMOD_FE_GEN2_UI_20G_NRZ_OSX2      0x18D30000
#define TBHMOD_FE_GEN2_UI_25G_PAM4          0x04F70000
#define TBHMOD_FE_GEN2_UI_25G_NRZ_OSX1      0x09EE0000
#define TBHMOD_FE_GEN2_UI_25G_NRZ_OSX2P5    0x18D30000
#define TBHMOD_FE_GEN2_UI_26G_PAM4          0x04D19E00
#define TBHMOD_FE_GEN2_UI_26G_NRZ           0x09A33C00
#define TBHMOD_FE_GEN2_UI_25P00G_NRZ_OSX1   0x0a3d70a3
#define TBHMOD_FE_GEN2_UI_25P00G_NRZ_OSX2   0x147ae147


#define TBHMOD_FE_GEN2_CLK4SYNC_DIV_6       0
#define TBHMOD_FE_GEN2_CLK4SYNC_DIV_8       1

/* FCLK period macros definition. */
#define TBHMOD_FE_GEN2_FCLK_PERIOD_20G_DIV8     0x634c
#define TBHMOD_FE_GEN2_FCLK_PERIOD_20G_DIV6     0x4a79
#define TBHMOD_FE_GEN2_FCLK_PERIOD_25G          0x4f70
#define TBHMOD_FE_GEN2_FCLK_PERIOD_26G          0x4d19

/* PMD datapath latency. */
#define TBHMOD_FE_GEN2_PMD_TX_DP_LATENCY_NRZ    167
#define TBHMOD_FE_GEN2_PMD_TX_DP_LATENCY_PAM4   147

/* Transparent AM */
#define TBHMOD_FE_GEN2_TRANSPARENT_AM_DEFAULT  0x0
#define TBHMOD_FE_GEN2_TRANSPARENT_AM_25G      0x1
#define TBHMOD_FE_GEN2_TRANSPARENT_AM_50G      0x2
#define TBHMOD_FE_GEN2_TRANSPARENT_AM_100G     0x3
#define TBHMOD_FE_GEN2_TRANSPARENT_AM_200G     0x4
#define TBHMOD_FE_GEN2_TRANSPARENT_AM_400G     0x5

extern int tbhmod_fe_gen2_pcs_rx_ts_en(PHYMOD_ST* pc, uint32_t en);
extern int tbhmod_fe_gen2_pcs_ts_config(PHYMOD_ST* pc, int ts_offset);
...
extern  int tbhmod_fe_gen2_pcs_tx_fclk_sel_get(PHYMOD_ST* pc, int *pll);
extern  int tbhmod_fe_gen2_pcs_tx_fclk_sel_set(PHYMOD_ST* pc, int pll);
extern  int tbhmod_fe_gen2_pcs_rx_fclk_sel_get(PHYMOD_ST* pc, int *pll);
extern  int tbhmod_fe_gen2_pcs_rx_fclk_sel_set(PHYMOD_ST* pc, int pll);
...
extern int tbhmod_fe_gen2_txclk32_en(const PHYMOD_ST* pc, uint32_t en);
...
extern int tbhmod_fe_gen2_pmd_reset_seq(PHYMOD_ST* pc, int pmd_touched);
extern int tbhmod_fe_gen2_trans_am_set(PHYMOD_ST* pc, uint32_t speed, uint32_t trans_am_en);
extern int tbhmod_fe_gen2_trans_am_get(PHYMOD_ST* pc, uint32_t speed, uint32_t* trans_am_en);
