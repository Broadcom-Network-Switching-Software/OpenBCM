...
int tscbh_fe_gen2_phy_fec_error_inject_set(const phymod_phy_access_t* phy,
                                           ...
                                           phymod_fec_error_mask_t bit_error_mask)
{
    ...
    PHYMOD_MEMSET(&speed_config, 0, sizeof(speed_config));
    ...
    PHYMOD_IF_ERR_RETURN(tscbh_fe_gen2_phy_speed_config_get(phy, &speed_config));
...
int tscbh_fe_gen2_phy_fec_error_inject_get(const phymod_phy_access_t* phy,
                                           uint16_t* error_control_map,
                                           phymod_fec_error_mask_t* bit_error_mask)
{
    int start_lane, num_lane;
