...
#ifndef BLACKHAWK7_L2P2_DEBUG_FUNCTIONS_H
#define BLACKHAWK7_L2P2_DEBUG_FUNCTIONS_H
...
/*  Full PMD State  */
/*------------------*/
/** Reads current pmd lane status and populates the provided structure of type blackhawk7_l2p2_detailed_lane_status_st.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
...
/** Displays the lane status stored in the input struct of type blackhawk7_l2p2_detailed_lane_status_st.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
...
#define BLACKHAWK7_L2P2_DAC4CK_MASK 0x10
