...
#define BLACKHAWK7_L2P2_UAPI_WR_INIT               srds_info_t const * const blackhawk7_l2p2_info_ptr = blackhawk7_l2p2_INTERNAL_get_blackhawk7_l2p2_info_ptr_with_check(sa__); \
                                          SRDS_INFO_PTR_NULL_CHECK;
#define BLACKHAWK7_L2P2_UAPI_RD_INIT               srds_info_t const * const blackhawk7_l2p2_info_ptr = blackhawk7_l2p2_INTERNAL_get_blackhawk7_l2p2_info_ptr_with_check(sa__); \
                                          if(blackhawk7_l2p2_info_ptr == NULL) {                                                                     \
                                              *err_code_p = ERR_CODE_INFO_TABLE_ERROR;                                                      \
                                              return 0;                                                                                     \
                                          }
#define BLACKHAWK7_L2P2_UAPI_EX_INIT               srds_info_t const * const blackhawk7_l2p2_info_ptr = blackhawk7_l2p2_INTERNAL_get_blackhawk7_l2p2_info_ptr_with_check(sa__); \
                                          if(blackhawk7_l2p2_info_ptr == NULL) {                                                                     \
                                              return 0;                                                                                     \
                                          }
