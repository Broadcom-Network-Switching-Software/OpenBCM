...
err_code_t osprey7_v2l8p1_ram_set(phymod_access_t *sa__)
{
    ...
    data = rdcv_production_enable_word();
    PHYMOD_EFUN_WR(wrcv_production_enable_word(data&0x7FFF));
    return ERR_CODE_NONE;
}
/***********************************************/
...
err_code_t
osprey7_v2l8p1_rx_pmd_lock_status_get(phymod_access_t *sa__, uint32_t *pmd_lock, uint32_t *pmd_lock_change)
{
