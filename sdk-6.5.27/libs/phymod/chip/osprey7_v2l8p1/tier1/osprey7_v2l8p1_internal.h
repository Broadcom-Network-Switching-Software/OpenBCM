...
/** Get a string representation of an osprey7_v2l8p1_osr_mode_enum enum value.
 * @param[in] osr_val a osprey7_v2l8p1_osr_mode_enum value.
...
typedef struct {
    ...
    uint8_t  ram_idx;
    int32_t  count;
}osprey7_v2l8p1_INTERNAL_ram_dump_state_t;
...
typedef struct {
    ...
    uint8_t *mem_ptr;
    uint32_t ram_size;
    osprey7_v2l8p1_INTERNAL_ram_dump_state_t *dump_state_ptr;
} osprey7_v2l8p1_INTERNAL_rdblk_ram_arg_t;
...
/** Callback function for reading uc RAM memory by osprey7_v2l8p1_INTERNAL_rdblk_uc_generic_ram() customized for
 ...
 ** Identical to osprey7_v2l8p1_dbgfb_stats_get_data_ptr() but usedful inside of functions that operate on multiple lanes in parallel.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[out] dbgfb_stats pointer of type osprey7_v2l8p1_dbgfb_stats_st where data from uCode will be copied.
 * @return Error Code generated by API (ERR_CODE_NONE if no errors).
 */
