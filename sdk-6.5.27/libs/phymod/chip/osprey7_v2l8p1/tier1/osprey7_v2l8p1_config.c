...
err_code_t osprey7_v2l8p1_set_use_rx_osr_mode_pins_only(srds_access_t *sa__, uint8_t rx_use_pins_only) {
    ...
    ESTM(reset_state = rd_rx_lane_dp_reset_state());
    if(reset_state < 7) {
        EFUN_PRINTF(("ERROR: osprey7_v2l8p1_set_use_rx_osr_mode_pins_only(..) called without ln_dp_s_rstb=0\n"));
        return (osprey7_v2l8p1_error(sa__, ERR_CODE_LANE_DP_NOT_RESET));
    }
...
err_code_t osprey7_v2l8p1_set_use_tx_osr_mode_pins_only(srds_access_t *sa__, uint8_t tx_use_pins_only) {
    ...
    if(reset_state < 7) {
        EFUN_PRINTF(("ERROR: osprey7_v2l8p1_set_use_tx_osr_mode_pins_only(..) called without ln_dp_s_rstb=0\n"));
        return (osprey7_v2l8p1_error(sa__, ERR_CODE_LANE_DP_NOT_RESET));
    }
...
err_code_t osprey7_v2l8p1_set_rx_osr_mode(srds_access_t *sa__, enum osprey7_v2l8p1_osr_mode_enum rx_osr_mode) {
    ...
    ESTM(reset_state = rd_rx_lane_dp_reset_state());
    if(reset_state < 7) {
        EFUN_PRINTF(("ERROR: osprey7_v2l8p1_set_rx_osr_mode(..) called without ln_dp_s_rstb=0\n"));
        return (osprey7_v2l8p1_error(sa__, ERR_CODE_LANE_DP_NOT_RESET));
    }
...
err_code_t osprey7_v2l8p1_get_rx_osr_mode(srds_access_t *sa__, enum osprey7_v2l8p1_osr_mode_enum *rx_osr_mode) {
    ...
    if(!(rx_osr_ctrl & (1 << 7))) {
        *rx_osr_mode = (enum osprey7_v2l8p1_osr_mode_enum)(rx_osr_ctrl & 0x3F);
    }
    else {
        ESTM(*rx_osr_mode = (enum osprey7_v2l8p1_osr_mode_enum)rd_rx_osr_mode_pin());
    }
...
err_code_t osprey7_v2l8p1_set_tx_osr_mode(srds_access_t *sa__, enum osprey7_v2l8p1_osr_mode_enum tx_osr_mode) {
    ...
    ESTM(reset_state = rd_tx_lane_dp_reset_state());
    if(reset_state < 7) {
        EFUN_PRINTF(("ERROR: osprey7_v2l8p1_set_tx_osr_mode(..) called without ln_dp_s_rstb=0\n"));
        return (osprey7_v2l8p1_error(sa__, ERR_CODE_LANE_DP_NOT_RESET));
    }
...
err_code_t osprey7_v2l8p1_get_tx_osr_mode(srds_access_t *sa__, enum osprey7_v2l8p1_osr_mode_enum *tx_osr_mode) {
    ...
    if(!(tx_osr_ctrl & (1 << 7))) {
        *tx_osr_mode = (enum osprey7_v2l8p1_osr_mode_enum)(tx_osr_ctrl & 0x3F);
    }
    else {
        ESTM(*tx_osr_mode = (enum osprey7_v2l8p1_osr_mode_enum)rd_tx_osr_mode_pin());
    }
...
err_code_t osprey7_v2l8p1_configure_fast_link_recovery(srds_access_t *sa__, uint8_t enable, uint8_t enable_timeout, enum osprey7_v2l8p1_flr_timeout_enum timeout_time) {
    ...
    ESTM(reset_state = rd_rx_lane_dp_reset_state());
    if(reset_state < 7) {
        EFUN_PRINTF(("ERROR: osprey7_v2l8p1_configure_fast_link_recovery(..) called without ln_dp_s_rstb=0 Lane=%d reset_state=%d\n",osprey7_v2l8p1_get_lane(sa__),reset_state));
        return (osprey7_v2l8p1_error(sa__, ERR_CODE_LANE_DP_NOT_RESET));
    }
    EFUN(osprey7_v2l8p1_INTERNAL_is_flr_supported(sa__, &flr_support));
    if(!flr_support) {
        EFUN_PRINTF(("ERROR: osprey7_v2l8p1_configure_fast_link_recovery(..) unsupported with currently loaded microcode (Core=%d Lane=%d).\n", osprey7_v2l8p1_acc_get_core(sa__), osprey7_v2l8p1_acc_get_lane(sa__)));
        return (osprey7_v2l8p1_error(sa__, ERR_CODE_BAD_PTR_OR_INVALID_INPUT));
    }

    if (timeout_time_val > 5) {
        ESTM_PRINTF(("timeout_time value for osprey7_v2l8p1_configure_fast_link_recovery() is too large:  %d\n", timeout_time_val));
        return (osprey7_v2l8p1_error(sa__, ERR_CODE_BAD_PTR_OR_INVALID_INPUT));
    }
    {
...
err_code_t osprey7_v2l8p1_get_configure_fast_link_recovery(srds_access_t *sa__, uint8_t *enable, uint8_t *enable_timeout, enum osprey7_v2l8p1_flr_timeout_enum *timeout_time) {
    ...
    EFUN(osprey7_v2l8p1_INTERNAL_is_flr_supported(sa__, &flr_support));
    if(!flr_support) {
        EFUN_PRINTF(("ERROR: osprey7_v2l8p1_get_configure_fast_link_recovery(..) unsupported with currently loaded microcode (Core=%d Lane=%d).\n", osprey7_v2l8p1_acc_get_core(sa__), osprey7_v2l8p1_acc_get_lane(sa__)));
        return (osprey7_v2l8p1_error(sa__, ERR_CODE_BAD_PTR_OR_INVALID_INPUT));
    }
    ...
    *timeout_time = (enum osprey7_v2l8p1_flr_timeout_enum)((flr_byte >> 2) & 0x7);
    return (ERR_CODE_NONE);
}
