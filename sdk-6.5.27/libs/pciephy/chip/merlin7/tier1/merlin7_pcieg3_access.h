...
#ifndef MERLIN7_PCIEG3_API_ACCESS_H
#define MERLIN7_PCIEG3_API_ACCESS_H
...
/*! uCode info
 * This struct should be populated from the values found in the ucode image .h file
 * Note: If UCODE_DR_CODE_SIZE_KB does not appear in the image .h file,
 *       then set ucode_dr_code_size_kb to 0.
 */
typedef struct {
    /** UCODE_IMAGE_SIZE */
    uint32_t ucode_size;
    ...
    /** UCODE_IMAGE_CRC */
    uint16_t crc_value;
    /** UCODE_DR_CODE_SIZE_KB */
    uint8_t ucode_dr_code_size_kb;
} ucode_info_t;
 ...
 */
uint8_t merlin7_pcieg3_rdbl_uc_var(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 */
uint16_t merlin7_pcieg3_rdwl_uc_var(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
...
/** Unsigned Double Word Write of a uC RAM Lane variable.
 * Write access through Micro Register Interface for PMD IPs; through Serdes FW DSC Command Interface for external micro IPs.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] addr Address of RAM lane variable to be written.
 ...
 */
int8_t merlin7_pcieg3_rdbls_uc_var(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
 ...
 */
int16_t merlin7_pcieg3_rdwls_uc_var(srds_access_t *sa__, err_code_t *err_code, uint16_t addr);
...
/** Signed Double Word Write of a uC RAM Lane variable.
 * Write access through Micro Register Interface for PMD IPs; through Serdes FW DSC Command Interface for external micro IPs.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] addr Address of RAM lane variable to be written.
 * @param[in] wr_val 32bit signed value to be written to RAM variable.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors).
 */
 ...
 * @return 8bit unsigned value read from uC RAM
 */
uint8_t merlin7_pcieg3_rdbc_uc_var(srds_access_t *sa__, err_code_t *err_code, uint8_t addr);
 ...
 * @return 16bit unsigned value read from uC RAM
 */
uint16_t merlin7_pcieg3_rdwc_uc_var(srds_access_t *sa__, err_code_t *err_code, uint8_t addr);
...
/** Unsigned Double Word Write of a uC RAM Core variable.
 * Write access through Micro Register Interface for PMD IPs; through Serdes FW DSC Command Interface for external micro IPs.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] addr Address of RAM core variable to be written
 * @param[in] wr_val 32bit unsigned value to be written to RAM variable
 ...
 * @return 8bit signed value read from uC RAM
 */
int8_t merlin7_pcieg3_rdbcs_uc_var(srds_access_t *sa__, err_code_t *err_code, uint8_t addr);
 ...
 * @return 16bit signed value read from uC RAM
 */
int16_t merlin7_pcieg3_rdwcs_uc_var(srds_access_t *sa__, err_code_t *err_code, uint8_t addr);
...
/** Signed Double Word Write of a uC RAM Core variable.
 * Write access through Micro Register Interface for PMD IPs; through Serdes FW DSC Command Interface for external micro IPs.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] addr Address of RAM core variable to be written
 * @param[in] wr_val 32bit signed value to be written to RAM variable
 ...
 */
uint32_t merlin7_pcieg3_rd_long_uc_prog_ram(srds_access_t *sa__, err_code_t *err_code, uint32_t addr);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin7_pcieg3_wr_long_uc_ram(srds_access_t *sa__, uint32_t addr, uint32_t wr_val);
 ...
 */
uint32_t merlin7_pcieg3_rd_long_uc_ram(srds_access_t *sa__, err_code_t *err_code, uint32_t addr);
 ...
 * @return 16bit unsigned value read from uC RAM
 */
uint16_t merlin7_pcieg3_rdw_uc_ram(srds_access_t *sa__, err_code_t *err_code, uint32_t addr);
 ...
 * @return 8bit unsigned value read from uC RAM
 */
uint8_t merlin7_pcieg3_rdb_uc_ram(srds_access_t *sa__, err_code_t *err_code, uint32_t addr);
 ...
 * @return 16bit signed value read from uC RAM
 */
int16_t merlin7_pcieg3_rdws_uc_ram(srds_access_t *sa__, err_code_t *err_code, uint32_t addr);
 ...
 * @return 8bit signed value read from uC RAM
 */
int8_t merlin7_pcieg3_rdbs_uc_ram(srds_access_t *sa__, err_code_t *err_code, uint32_t addr);
