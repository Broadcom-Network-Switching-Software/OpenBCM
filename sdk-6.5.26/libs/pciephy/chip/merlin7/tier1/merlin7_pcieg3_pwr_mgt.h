 ...
 * To complete a merlin7_pcieg3_core_pwrdn(), all of the lane(s) belonging to the core being powered down.
 * should also be issued a lane power down using merlin7_pcieg3_lane_pwrdn().
 * Note: To wake up from any powerdown mode, first call PWR_ON and then de-assert core_dp_reset [merlin7_pcieg3_core_dp_reset(sa__, 0)].
 ...
 *       De-assert with merlin7_pcieg3_tx_dp_reset(..) when waking up from a TX only PWRDN, merlin7_pcieg3_rx_dp_reset(..)
 *       for a RX only PWRDN, and merlin7_pcieg3_ln_dp_reset(..) for both RX and TX.
