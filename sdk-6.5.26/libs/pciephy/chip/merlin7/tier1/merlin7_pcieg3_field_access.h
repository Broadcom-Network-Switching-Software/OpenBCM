...
/*---------------------------------------------------------------------------------------------------*/
/* "Serdes ACCess" (_acc_) API dependency "wrapper" functions for merlin7_pcieg3_dependencies.c          */
 ...
 * NOTE: This should be used instead of the API Dedendency function merlin7_pcieg3_pmd_rdt_reg().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] addr 16-bit register address.
 ...
 * NOTE: This should be used instead of the API Dedendency function merlin7_pcieg3_pmd_wr_reg().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * NOTE: This should be used instead of the API Dedendency function merlin7_pcieg3_pmd_mwr_reg().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * @return Error code generated by write function (returns ERR_CODE_NONE if no errors).
 */
err_code_t merlin7_pcieg3_acc_wr_pram(srds_access_t *sa__, uint8_t val);
...
#define merlin7_pcieg3_acc_get_physical_lane merlin7_pcieg3_acc_get_lane
...
#define merlin7_pcieg3_acc_set_physical_lane merlin7_pcieg3_acc_set_lane
 ...
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @return Returns a pointer to the merlin7_pcieg3 info table.
 */
