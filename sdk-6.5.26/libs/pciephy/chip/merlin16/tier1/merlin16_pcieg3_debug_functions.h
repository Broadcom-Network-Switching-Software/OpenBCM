...
/** @file merlin16_pcieg3_debug_functions.h
 * Functions used internally and available in debug shell only
 */

#ifndef MERLIN16_PCIEG3_DEBUG_FUNCTIONS_H
#define MERLIN16_PCIEG3_DEBUG_FUNCTIONS_H
 ...
 * @param line __LINE__
 */
void merlin16_pcieg3_INTERNAL_print_triage_info(srds_access_t *sa__, err_code_t err_code, uint8_t print_header, uint8_t print_data, uint16_t line);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_pcieg3_reg_dump(srds_access_t *sa__, uint8_t core, uint8_t lane, char reg_buffer[][250]);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_pcieg3_uc_core_var_dump(srds_access_t *sa__, uint8_t core, char ram_buffer[][250]);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_pcieg3_uc_lane_var_dump(srds_access_t *sa__, uint8_t core, uint8_t lane, char ram_buffer[][250]);
