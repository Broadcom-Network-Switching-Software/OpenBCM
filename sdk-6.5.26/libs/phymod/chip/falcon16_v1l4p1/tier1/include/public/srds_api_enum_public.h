...
enum srds_prbs_polynomial_enum {
    ...
    SRDS_PRBS_31 = 5,
    SRDS_PRBS_58 = 6,
    SRDS_PRBS_49 = 7,           /* blackhawk only */
    SRDS_PRBS_10 = 8,           /* blackhawk only */
    SRDS_PRBS_20 = 9,           /* blackhawk only */
    SRDS_PRBS_13 = 10,          /* blackhawk only */
    SRDS_QPRBS_13 = 11,         /* blackhawk_sinai only */
    SRDS_PRBS_AUTO_DETECT = 15, /* blackhawk only */
    SRDS_PRBS_UNKNOWN = 16      /* blackhawk only */
};
