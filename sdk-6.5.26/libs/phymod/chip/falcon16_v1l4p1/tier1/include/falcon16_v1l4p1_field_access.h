 ...
 * NOTE: This should be used instead of the API Dedendency function falcon16_v1l4p1_pmd_rdt_reg().
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param addr 16-bit register address.
 ...
 * NOTE: This should be used instead of the API Dedendency function falcon16_v1l4p1_pmd_wr_reg().
 * @param sa__ is an opaque state vector passed through to device access functions.
 ...
 * NOTE: This should be used instead of the API Dedendency function falcon16_v1l4p1_pmd_mwr_reg().
 * @param sa__ is an opaque state vector passed through to device access functions.
