...
enum srds_pmd_uc_cmd_enum {
    ...
    CMD_SAR_MEASURE           = 34,
    CMD_TUNING_FUNCTION       = 35,
    CMD_DIAG_FRAMEWORK        = 36,
#endif
    CMD_MEASURE_ENOB          = 37,
    CMD_CONFIG_LINKCAT        = 50,
    CMD_MAXIMUM_VALUE         = 63,             /* Maximum value for any uc_cmd */
    CMD_INVALID_OVFL          = 64              /* Out of range for any uc_cmd */
};
...
enum srds_pmd_uc_test_dbg_cmd_enum {
    CMD_UC_DBG_WR_ADC_SKEW_CTRL =  0,
    CMD_UC_DBG_RD_ADC_SKEW_CTRL =  1,
    CMD_UC_DBG_WR_DIG_ADC_GAIN = 2,
    CMD_UC_DBG_RD_DIG_ADC_GAIN = 3,
    CMD_UC_DBG_WR_ANA_ADC_GAIN = 4,
    CMD_UC_DBG_RD_ANA_ADC_GAIN = 5,
    CMD_UC_DBG_WR_FFE_OFFSET =6,
    CMD_UC_DBG_RD_FFE_OFFSET =7,
    CMD_UC_DBG_WR_DFE_TAP=8,
    CMD_UC_DBG_RD_DFE_TAP=9,
    CMD_UC_DBG_WR_DFE_OFFSET=10,
    CMD_UC_DBG_RD_DFE_OFFSET=11,
    CMD_UC_DBG_WR_FFE_TAP=12,
    CMD_UC_DBG_RD_FFE_TAP=13,
    CMD_UC_DBG_WR_RCFIR_TAP=14,
    CMD_UC_DBG_RD_RCFIR_TAP=15,
    CMD_UC_DBG_WR_PGA_VAL=16,
    CMD_UC_DBG_RD_PGA_VAL=17
};

enum srds_pmd_uc_sar_measure_cmd_enum {
    CMD_SAR_MEASURE_OFFSET  = 0,
    CMD_SAR_MEASURE_GAIN    = 1,
    CMD_SAR_SWEEP_OFFSET    = 2,
    CMD_SAR_SWEEP_GAIN      = 3,
    CMD_SAR_MEASURE_DONE    = 10
};

enum srds_pmd_uc_tuning_cmd_enum {
    CMD_TUNING_ADC_HW_TIMING_CAL,
    CMD_TUNING_ADC_HW_OFFSET_CAL,
    CMD_TUNING_CFG_CDR_BLIND_MODE,
    CMD_TUNING_BLIND_DCO,
    CMD_TUNING_BLIND_PGA,
    CMD_TUNING_BLIND_CTLE,
    CMD_TUNING_BLIND_FFE_OFFSET,
    CMD_TUNING_BLIND_ADC_GAIN,
    CMD_TUNING_BLIND_ADC_SKEW,
    CMD_TUNING_OPTIMIZE_FFE_OFFSET,
    CMD_TUNING_OPTIMIZE_ADC_GAIN,
    CMD_TUNING_OPTIMIZE_ADC_SKEW
};
#endif
#if defined(CLANG_NOARM) 
