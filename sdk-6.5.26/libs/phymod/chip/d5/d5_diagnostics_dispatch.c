...
#include <phymod/chip/d5_diagnostics.h>


__phymod_diagnostics__dispatch__t__ phymod_diagnostics_d5_diagnostics_driver = {

    d5_phy_rx_slicer_position_set,
    d5_phy_rx_slicer_position_get,
    d5_phy_rx_slicer_position_max_get,
    d5_phy_prbs_config_set,
    d5_phy_prbs_config_get,
    d5_phy_prbs_enable_set,
    d5_phy_prbs_enable_get,
    d5_phy_prbs_status_get,
    d5_phy_pattern_config_set,
    d5_phy_pattern_config_get,
    d5_phy_pattern_enable_set,
    d5_phy_pattern_enable_get,
    NULL, /* phymod_core_diagnostics_get */
    d5_phy_diagnostics_get,
    d5_phy_pmd_info_dump,
