...
int tscf_phy_signal_detect_status_get(const phymod_phy_access_t* phy,
                                        phymod_signal_detect_status_t* sd_status)
{
    ...
    PHYMOD_MEMCPY(&pm_phy_copy, phy, sizeof(pm_phy_copy));
    PHYMOD_IF_ERR_RETURN
        (tefmod_signal_detect_status_get(&pm_phy_copy.access,
...
int tscf_phy_rx_dc_offset_get(const phymod_phy_access_t* phy,  uint32_t *rx_dc_offset)
{
    int start_lane, num_lane;
    phymod_phy_access_t phy_copy;
    ...
    PHYMOD_IF_ERR_RETURN
        (falcon_tsc_rx_dc_offset_get(&phy_copy.access, rx_dc_offset));
