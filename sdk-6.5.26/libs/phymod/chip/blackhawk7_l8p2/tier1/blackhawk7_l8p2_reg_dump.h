...
/*! blackhawk7_l8p2_reg_dump_arr_t
 *
 */
typedef const uint16_t blackhawk7_l8p2_reg_dump_arr_t[2];

/** Get blackhawk7_l8p2_reg_dump_arr
 * @return Pointer to blackhawk7_l8p2_reg_dump_arr, which is a 2-element array of const uint16_t.
 *         Element 1 = base address, Element 2 = mask of valid addresses from base address.
 */
blackhawk7_l8p2_reg_dump_arr_t *blackhawk7_l8p2_get_reg_dump_arr(void);
