...
err_code_t blackhawk7_v1l8p1_INTERNAL_test_uc_timestamp_with_print_options(srds_access_t *sa__, uint8_t console_print_options) {
    ...
    resolution=test_delay*1000.0/(USR_DOUBLE)time;
...
err_code_t blackhawk7_v1l8p1_INTERNAL_get_num_bits_per_ms(srds_access_t *sa__, uint8_t select_rx, uint32_t *num_bits_per_ms) {
    ...
    EFUN(blackhawk7_v1l8p1_acc_set_pll_idx(sa__,pll_select));
       ...
       /* *num_bits_per_ms = (uint32_t)((((uint64_t)core_config.vco_rate_in_Mhz * 100000UL) / blackhawk7_v1l8p1_osr_mode_enum_to_int_x1000(osr_mode))*10); */
    ...
    COMPILER_64_ADD_32(temp_divisor, ((uint32_t)blackhawk7_v1l8p1_osr_mode_enum_to_int_x1000(osr_mode)));
    /* (((uint64_t)core_config.vco_rate_in_Mhz * 100000UL) / blackhawk7_v1l8p1_osr_mode_enum_to_int_x1000(osr_mode)) */
    COMPILER_64_UDIV_64(temp_dividend, temp_divisor);
    /* ((((uint64_t)core_config.vco_rate_in_Mhz * 100000UL) / blackhawk7_v1l8p1_osr_mode_enum_to_int_x1000(osr_mode))*10) */
...
err_code_t blackhawk7_v1l8p1_INTERNAL_get_BER_string(srds_access_t *sa__, uint16_t time_ms, char *string, uint8_t string_size) {
    ...
    enum blackhawk7_v1l8p1_prbs_chk_timer_selection_enum timer_sel = USE_HW_TIMERS;
    ...
    }
    {
        ...
        err = blackhawk7_v1l8p1_INTERNAL_get_BER_data(sa__, time_ms, &ber_data_local, timer_sel);
    }
...
err_code_t blackhawk7_v1l8p1_INTERNAL_get_BER_data(srds_access_t *sa__, uint16_t time_ms, struct blackhawk7_v1l8p1_ber_data_st *ber_data, enum blackhawk7_v1l8p1_prbs_chk_timer_selection_enum timer_sel) {
    ...
    if(timer_sel == USE_HW_TIMERS) {
        ...
        EFUN(blackhawk7_v1l8p1_BER_setup_measurement(sa__, time_ms, ber_data, &prbs_chk_hw_timer_ctrl));
        EFUN(blackhawk7_v1l8p1_BER_poll_measurement(sa__, ber_data, &prbs_chk_hw_timer_ctrl));
        EFUN(blackhawk7_v1l8p1_BER_get_measurement(sa__, ber_data, &prbs_chk_hw_timer_ctrl));
    }
...
err_code_t blackhawk7_v1l8p1_INTERNAL_set_rx_dfe5(srds_access_t *sa__, int8_t val) {
    ...
    val = blackhawk7_v1l8p1_INTERNAL_dfe_tap_sgb2sg(val);
...
err_code_t blackhawk7_v1l8p1_INTERNAL_get_rx_dfe5(srds_access_t *sa__, int8_t *val) {
    INIT_SRDS_ERR_CODE
    int8_t temp = 0;
    ESTM(temp = (int8_t)(temp + blackhawk7_v1l8p1_INTERNAL_dfe_tap_sgb2sg(rd_rxa_dfe_tap5())));
    ESTM(temp = (int8_t)(temp + blackhawk7_v1l8p1_INTERNAL_dfe_tap_sgb2sg(rd_rxb_dfe_tap5())));
    *val = (int8_t)(temp >> 1);
    return (ERR_CODE_NONE);
}
...
err_code_t blackhawk7_v1l8p1_INTERNAL_get_rx_dfe6(srds_access_t *sa__, int8_t *val) {
    INIT_SRDS_ERR_CODE
    int8_t temp = 0;
    ESTM(temp = (int8_t)(temp + blackhawk7_v1l8p1_INTERNAL_dfe_tap_sgb2sg(rd_rxa_dfe_tap6())));
    ESTM(temp = (int8_t)(temp + blackhawk7_v1l8p1_INTERNAL_dfe_tap_sgb2sg(rd_rxb_dfe_tap6())));
    *val = (int8_t)(temp >> 1);
    return (ERR_CODE_NONE);
}
...
err_code_t blackhawk7_v1l8p1_INTERNAL_get_rx_dfe7(srds_access_t *sa__, int8_t *val) {
    INIT_SRDS_ERR_CODE
    int8_t temp = 0;
    ESTM(temp = (int8_t)(temp + blackhawk7_v1l8p1_INTERNAL_dfe_tap_sgb2sg(rd_rxa_dfe_tap7())));
    ESTM(temp = (int8_t)(temp + blackhawk7_v1l8p1_INTERNAL_dfe_tap_sgb2sg(rd_rxb_dfe_tap7())));
    *val = (int8_t)(temp >> 1);
    return (ERR_CODE_NONE);
}
...
err_code_t blackhawk7_v1l8p1_INTERNAL_get_rx_dfe8(srds_access_t *sa__, int8_t *val) {
    INIT_SRDS_ERR_CODE
    int8_t temp = 0;
    ESTM(temp = (int8_t)(temp + blackhawk7_v1l8p1_INTERNAL_dfe_tap_sgb2sg(rd_rxa_dfe_tap8())));
    ESTM(temp = (int8_t)(temp + blackhawk7_v1l8p1_INTERNAL_dfe_tap_sgb2sg(rd_rxb_dfe_tap8())));
    *val = (int8_t)(temp >> 1);
    return (ERR_CODE_NONE);
}
...
err_code_t blackhawk7_v1l8p1_INTERNAL_get_rx_dfe9(srds_access_t *sa__, int8_t *val) {
    INIT_SRDS_ERR_CODE
    int8_t temp = 0;
    ESTM(temp = (int8_t)(temp + blackhawk7_v1l8p1_INTERNAL_dfe_tap_sgb2sg(rd_rxa_dfe_tap9())));
    ESTM(temp = (int8_t)(temp + blackhawk7_v1l8p1_INTERNAL_dfe_tap_sgb2sg(rd_rxb_dfe_tap9())));
    *val = (int8_t)(temp >> 1);
    return (ERR_CODE_NONE);
}
...
err_code_t blackhawk7_v1l8p1_INTERNAL_get_rx_dfe10(srds_access_t *sa__, int8_t *val) {
    INIT_SRDS_ERR_CODE
    int8_t temp = 0;
    ESTM(temp = (int8_t)(temp + blackhawk7_v1l8p1_INTERNAL_dfe_tap_sgb2sg(rd_rxa_dfe_tap10())));
    ESTM(temp = (int8_t)(temp + blackhawk7_v1l8p1_INTERNAL_dfe_tap_sgb2sg(rd_rxb_dfe_tap10())));
    *val = (int8_t)(temp >> 1);
    return (ERR_CODE_NONE);
}
...
err_code_t blackhawk7_v1l8p1_INTERNAL_get_rx_dfe11(srds_access_t *sa__, int8_t *val) {
    INIT_SRDS_ERR_CODE
    int8_t temp = 0;
    ESTM(temp = (int8_t)(temp + blackhawk7_v1l8p1_INTERNAL_dfe_tap_sgb2sg(rd_rxa_dfe_tap11())));
    ESTM(temp = (int8_t)(temp + blackhawk7_v1l8p1_INTERNAL_dfe_tap_sgb2sg(rd_rxb_dfe_tap11())));
    *val = (int8_t)(temp >> 1);
    return (ERR_CODE_NONE);
}
...
err_code_t blackhawk7_v1l8p1_INTERNAL_get_rx_dfe12(srds_access_t *sa__, int8_t *val) {
    INIT_SRDS_ERR_CODE
    int8_t temp = 0;
    ESTM(temp = (int8_t)(temp + blackhawk7_v1l8p1_INTERNAL_dfe_tap_sgb2sg(rd_rxa_dfe_tap12())));
    ESTM(temp = (int8_t)(temp + blackhawk7_v1l8p1_INTERNAL_dfe_tap_sgb2sg(rd_rxb_dfe_tap12())));
    *val = (int8_t)(temp >> 1);
    return (ERR_CODE_NONE);
}
...
err_code_t blackhawk7_v1l8p1_INTERNAL_get_rx_dfe13(srds_access_t *sa__, int8_t *val) {
    INIT_SRDS_ERR_CODE
    int8_t temp = 0;
    ESTM(temp = (int8_t)(temp + blackhawk7_v1l8p1_INTERNAL_dfe_tap_sgb2sg(rd_rxa_dfe_tap13())));
    ESTM(temp = (int8_t)(temp + blackhawk7_v1l8p1_INTERNAL_dfe_tap_sgb2sg(rd_rxb_dfe_tap13())));
    *val = (int8_t)(temp >> 1);
    return (ERR_CODE_NONE);
}
...
err_code_t blackhawk7_v1l8p1_INTERNAL_get_rx_dfe14(srds_access_t *sa__, int8_t *val) {
    INIT_SRDS_ERR_CODE
    int8_t temp = 0;
    ESTM(temp = (int8_t)(temp + blackhawk7_v1l8p1_INTERNAL_dfe_tap_sgb2sg(rd_rxa_dfe_tap14())));
    ESTM(temp = (int8_t)(temp + blackhawk7_v1l8p1_INTERNAL_dfe_tap_sgb2sg(rd_rxb_dfe_tap14())));
    *val = (int8_t)(temp >> 1);
    return (ERR_CODE_NONE);
}
...
err_code_t blackhawk7_v1l8p1_INTERNAL_eye_scan_setup(srds_access_t *sa__, uint8_t intr_pass_b, int16_t *y_max, int16_t *y_step, uint16_t *usr_diag_status) {
    ...
    *usr_diag_status = 0;
    ...
    EFUN_PRINTF(("\n\n****  SERDES %sEYE SCAN CORE %d LANE %d   ****\n", intr_pass_b?"INTRUSIVE ":"",blackhawk7_v1l8p1_acc_get_core(sa__),blackhawk7_v1l8p1_acc_get_lane(sa__)));
...
err_code_t blackhawk7_v1l8p1_INTERNAL_read_lane_state(srds_access_t *sa__, blackhawk7_v1l8p1_lane_state_st_t *istate) {
    ...
    EFUN(blackhawk7_v1l8p1_INTERNAL_pmd_lock_status(sa__,&istate->pmd_lock, &istate->pmd_lock_chg));
    {
        err_code_t err_code = 0;
        istate->stop_state = blackhawk7_v1l8p1_INTERNAL_stop_micro(sa__,istate->pmd_lock,&err_code);

        if(err_code) USR_PRINTF(("WARNING: Unable to stop microcontroller,  following data is suspect\n"));
    }
    istate->laneid = blackhawk7_v1l8p1_acc_get_lane(sa__);
    EFUN(blackhawk7_v1l8p1_get_rx_tuning_status(sa__, &istate->rx_tuning_done));


    EFUN(blackhawk7_v1l8p1_INTERNAL_get_osr_mode(sa__, &istate->osr_mode));

    if(istate->osr_mode.tx_rx != 255) {
        tx = blackhawk7_v1l8p1_INTERNAL_get_osr_str(istate->osr_mode.tx_rx, GET_OSR_STR_LONG);
        USR_SNPRINTF(istate->tx_osr_mode_str, sizeof(istate->tx_osr_mode_str), "%s", tx);
    } else {
        tx = blackhawk7_v1l8p1_INTERNAL_get_osr_str(istate->osr_mode.tx, GET_OSR_STR_SHORT);
        rx = blackhawk7_v1l8p1_INTERNAL_get_osr_str(istate->osr_mode.rx, GET_OSR_STR_SHORT);
        USR_SNPRINTF(istate->tx_osr_mode_str, sizeof(istate->tx_osr_mode_str), "%s", tx);
    ...
    EFUN(blackhawk7_v1l8p1_INTERNAL_sigdet_status(sa__,&istate->sig_det, &istate->sig_det_chg));
    ESTM(istate->ppm = rd_cdr_integ_reg()/84);

    ESTM(istate->clk90 = rdv_usr_sts_phase_hoffset());
    EFUN(blackhawk7_v1l8p1_INTERNAL_decode_br_os_mode(sa__, &istate->CDR));

    EFUN(blackhawk7_v1l8p1_read_rx_afe(sa__, RX_AFE_PF, &istate->pf_main));
    EFUN(blackhawk7_v1l8p1_read_rx_afe(sa__, RX_AFE_PF2, &istate->pf2_ctrl));
    ESTM(istate->bwr_ctrl = rdv_afe_bw_adjust());

    EFUN(blackhawk7_v1l8p1_read_rx_afe(sa__, RX_AFE_VGA, &istate->VGA));

    ESTM(istate->DCO = rd_dc_offset_bin());

    EFUN(blackhawk7_v1l8p1_read_rx_afe(sa__, RX_AFE_PF3, &istate->pf3_ctrl));
    ESTM(istate->P1mV = rdv_usr_main_tap_est()/32);
    EFUN(blackhawk7_v1l8p1_INTERNAL_ladder_setting_to_mV(sa__, istate->P1mV, 0, INVALID_SLICER, &istate->P1mV));

    if (istate->rx_pam_mode == NRZ) {
        ESTM(istate->TP0  = rd_rx_phase02_status());
        EFUN(blackhawk7_v1l8p1_INTERNAL_ladder_setting_to_mV(sa__, (int8_t)istate->TP0, 0, INVALID_SLICER, &istate->TP0));
    ...
    if (istate->rx_pam_mode == NRZ) {
        EFUN(blackhawk7_v1l8p1_INTERNAL_get_rx_dfe1(sa__, &istate->DFE1));
    }

    EFUN(blackhawk7_v1l8p1_INTERNAL_get_rx_dfe2(sa__, &istate->DFE2));
    EFUN(blackhawk7_v1l8p1_INTERNAL_get_rx_dfe3(sa__, &istate->DFE3));
    EFUN(blackhawk7_v1l8p1_INTERNAL_get_rx_dfe4(sa__, &istate->DFE4));
    EFUN(blackhawk7_v1l8p1_INTERNAL_get_rx_dfe5(sa__, &istate->DFE5));

    EFUN(blackhawk7_v1l8p1_INTERNAL_get_rx_dfe6(sa__, &istate->dfe6));

    EFUN(blackhawk7_v1l8p1_INTERNAL_get_tx_ppm(sa__, &istate->tx_ppm));
...

    {
        uint8_t tap_num;
        for (tap_num=0; tap_num<TXFIR_ST_NUM_TAPS; ++tap_num) {
            EFUN(blackhawk7_v1l8p1_INTERNAL_get_tx_tap(sa__, tap_num, &istate->txfir.tap[tap_num]));
        }
    ...
    EFUN(blackhawk7_v1l8p1_INTERNAL_get_eye_margin_est(sa__, &istate->heye_left, &istate->heye_right, &istate->veye_upper, &istate->veye_lower));
    {
        struct blackhawk7_v1l8p1_usr_ctrl_disable_functions_st dsu, dss;
    ...
    EFUN(blackhawk7_v1l8p1_INTERNAL_get_link_time(sa__, &istate->link_time));
    {
        ...
        if (istate->pmd_lock != rx_lock_at_end) {
            USR_PRINTF(("WARNING: Lane %d rx_lock status changed while reading lane state (rx_lock_start=%d, rx_lock_chg_start=%d, rx_lock_at_end=%d, rx_lock_chg_at_end=%d) \n",
                        blackhawk7_v1l8p1_acc_get_lane(sa__), istate->pmd_lock, istate->pmd_lock_chg, rx_lock_at_end, rx_lock_chg_at_end));
        }
    ...
    EFUN(blackhawk7_v1l8p1_INTERNAL_get_BER_string(sa__, 100, istate->BER, sizeof(istate->BER)));

    {
        const char * const prepend = "    ";

        if(istate->UC_STS != 0) {
            EFUN(blackhawk7_v1l8p1_decode_uc_sts(sa__, istate->UC_STS, istate->uc_sts_decoded, sizeof(istate->uc_sts_decoded), prepend));
        }

        if(istate->UC_STS_EXT != 0) {
            EFUN(blackhawk7_v1l8p1_decode_uc_sts_ext(sa__, istate->UC_STS_EXT, istate->uc_sts_ext_decoded, sizeof(istate->uc_sts_ext_decoded), prepend));
        }
    }
...
err_code_t blackhawk7_v1l8p1_INTERNAL_display_lane_state_no_newline(srds_access_t *sa__) {
  ...
  blackhawk7_v1l8p1_lane_state_st_t *state;

  state = (blackhawk7_v1l8p1_lane_state_st_t *)USR_CALLOC(1, sizeof(blackhawk7_v1l8p1_lane_state_st_t));
  if(!state) {
      return (ERR_CODE_MEM_ALLOC_FAIL);
  }
  CFUN(blackhawk7_v1l8p1_INTERNAL_read_lane_state(sa__, state));
...
err_code_t blackhawk7_v1l8p1_INTERNAL_read_core_state(srds_access_t *sa__, blackhawk7_v1l8p1_core_state_st *istate) {
  ...
  EFUN(blackhawk7_v1l8p1_read_die_temperature(sa__, &state.die_temp));
  ...
  blackhawk7_v1l8p1_core_state_st state;
    ...
    EFUN_PRINTF(("     %01d%s  "       ,  state.pll_lock, state.pll_lock_chg ? "*" : " "));
    {
      ...
      if(state.core_status != 0) {
          EFUN_PRINTF(("\n"));
          EFUN(blackhawk7_v1l8p1_decode_core_sts(sa__, state.core_status, decode_buf, sizeof(decode_buf), ""));
...
err_code_t blackhawk7_v1l8p1_INTERNAL_resolve_pll_parameters(srds_access_t *sa__,
    ...
    if (*vco_freq_khz != 0) {
        EFUN(blackhawk7_v1l8p1_INTERNAL_check_vco_freq_khz(sa__,*vco_freq_khz));
    }
...
err_code_t blackhawk7_v1l8p1_INTERNAL_ram_dump_callback(srds_access_t *sa__, void *arg, uint8_t byte_count, uint16_t data) {
    blackhawk7_v1l8p1_INTERNAL_ram_dump_state_t * const state_ptr = (blackhawk7_v1l8p1_INTERNAL_ram_dump_state_t *)arg;
...
err_code_t blackhawk7_v1l8p1_INTERNAL_rdblk_ram_callback(srds_access_t *sa__, void *arg, uint8_t byte_count, uint16_t data) {
    ...
    blackhawk7_v1l8p1_INTERNAL_rdblk_ram_arg_t *  cast_arg = (blackhawk7_v1l8p1_INTERNAL_rdblk_ram_arg_t *)arg;
    blackhawk7_v1l8p1_INTERNAL_ram_dump_state_t * const state_ptr = (blackhawk7_v1l8p1_INTERNAL_ram_dump_state_t *)(cast_arg->dump_state_ptr);
    ...
    if (cast_arg->ram_buff == NULL) {
        EFUN(blackhawk7_v1l8p1_INTERNAL_ram_dump_callback(sa__, cast_arg->dump_state_ptr, byte_count,data));
    }
...
err_code_t blackhawk7_v1l8p1_INTERNAL_rdblk_ram_read_callback(srds_access_t * sa__,void *arg,uint8_t byte_count,uint16_t data) {
    ...
    blackhawk7_v1l8p1_INTERNAL_rdblk_ram_arg_t * const cast_arg = (blackhawk7_v1l8p1_INTERNAL_rdblk_ram_arg_t *)arg;
...
err_code_t blackhawk7_v1l8p1_dbgfb_collect_stats(srds_access_t *sa__, uint32_t time_in_us, blackhawk7_v1l8p1_dbgfb_stats_st *dbgfb_stats) {
    INIT_SRDS_ERR_CODE
    EFUN(blackhawk7_v1l8p1_dbgfb_collect_stats_api_method(sa__, time_in_us, dbgfb_stats));
    return (ERR_CODE_NONE);
}
...
err_code_t blackhawk7_v1l8p1_INTERNAL_is_flr_supported(srds_access_t *sa__, uint8_t *flr_support) {
    ...
    *flr_support = (blackhawk7_v1l8p1_info_ptr->lane_var_ram_size >= 0x950);
    return ERR_CODE_NONE;
}
