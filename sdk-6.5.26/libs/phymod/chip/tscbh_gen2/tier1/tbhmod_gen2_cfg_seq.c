...
int tbhmod_gen2_pcs_ts_config(PHYMOD_ST* pc, int ts_offset)
{
    ...
    RX_X4_RX_TS_CTL_GEN2r_RX_SOP_BYTE_OFFSETf_SET(RX_X4_RX_TS_CTL_GEN2r_reg, ts_offset);
    TX_X4_TX_TS_CTL_GEN2r_TX_SOP_BYTE_OFFSETf_SET(TX_X4_TX_TS_CTL_GEN2r_reg, ts_offset);
...
int _tbhmod_gen2_pcs_vco_to_ui(uint32_t vco, int os_mode, int pam4)
{
    ...
    switch (vco) {
        ...
        case TBHMOD_VCO_25P00G:
            if (os_mode == 1) {
                ui_value = TBHMOD_GEN2_UI_25P00G_NRZ_OSX2; /* 2/25.00 = 0.08. make 32 bit 0.08. * 2^32 = 343597383 = 0x147ae147 */
            } else {
                ui_value = TBHMOD_GEN2_UI_25P00G_NRZ_OSX1; /* 1/25.00 = 0.04. make 32 bit 0.04. * 2^32 = 171798691 = 0xa3d70a3 */
            }
            break;
        default:
...
int tbhmod_gen2_pcs_set_1588_ui (PHYMOD_ST* pc, uint32_t vco, uint32_t vco1, int os_mode, int clk4sync_div, int pam4)
{
    ...
    switch(vco1) {
      case TBHMOD_VCO_20G:
        ...
        break;
      case TBHMOD_VCO_25P00G:
        fclk_period = TBHMOD_GEN2_FCLK_PERIOD_25P00G;
        break;
      case TBHMOD_VCO_25G:
...
int tbhmod_gen2_fec_align_status_get(PHYMOD_ST* pc, uint32_t *fec_align_live)
{
    RX_X4_RS_FEC_RXP_STS_GEN2r_t fec_status_reg;

    RX_X4_RS_FEC_RXP_STS_GEN2r_CLR(fec_status_reg);
    PHYMOD_IF_ERR_RETURN(READ_RX_X4_RS_FEC_RXP_STS_GEN2r(pc, &fec_status_reg));

    *fec_align_live = RX_X4_RS_FEC_RXP_STS_GEN2r_FEC_ALIGN_STATUS_LIVEf_GET(fec_status_reg);
    return PHYMOD_E_NONE;
}

int tbhmod_gen2_fec_override_set(PHYMOD_ST* pc, uint32_t enable)
{
    SC_X4_SW_SPARE1_GEN2r_t SC_X4_SW_SPARE1_GEN2r_reg;
    uint16_t temp_reg_value;

    SC_X4_SW_SPARE1_GEN2r_CLR(SC_X4_SW_SPARE1_GEN2r_reg);
    PHYMOD_IF_ERR_RETURN(READ_SC_X4_SW_SPARE1_GEN2r(pc, &SC_X4_SW_SPARE1_GEN2r_reg));
    temp_reg_value = SC_X4_SW_SPARE1_GEN2r_GET(SC_X4_SW_SPARE1_GEN2r_reg);
    /* first clear the lowest bit */
    temp_reg_value &= ~TSCBH_GEN2_FEC_OVERRIDE_MASK;
    temp_reg_value |= (enable & TSCBH_GEN2_FEC_OVERRIDE_MASK);
    SC_X4_SW_SPARE1_GEN2r_SET(SC_X4_SW_SPARE1_GEN2r_reg, temp_reg_value);
    PHYMOD_IF_ERR_RETURN(WRITE_SC_X4_SW_SPARE1_GEN2r(pc, SC_X4_SW_SPARE1_GEN2r_reg));

    return PHYMOD_E_NONE;
}


int tbhmod_gen2_fec_override_get(PHYMOD_ST* pc, uint32_t* enable)
{
    SC_X4_SW_SPARE1_GEN2r_t SC_X4_SW_SPARE1_GEN2r_reg;
    uint16_t temp_reg_value;
    ...
    PHYMOD_IF_ERR_RETURN(READ_SC_X4_SW_SPARE1_GEN2r(pc, &SC_X4_SW_SPARE1_GEN2r_reg));
    temp_reg_value = SC_X4_SW_SPARE1_GEN2r_GET(SC_X4_SW_SPARE1_GEN2r_reg);
    *enable = temp_reg_value & TSCBH_GEN2_FEC_OVERRIDE_MASK;
