...
#define TBHMOD_GEN2_TS_MPP_MEM_SIZE 160
...
#define TBHMOD_GEN2_TS_RX_MPP1_NATIVE_START_ADDR 80
#define TBHMOD_GEN2_TS_RX_MPP_EVEN_BANK_NATIVE_TO_ADDR(na)      (na * 2)
#define TBHMOD_GEN2_TS_RX_MPP_ODD_BANK_NATIVE_TO_ADDR(na)       ((na * 2)+1)
...
typedef enum {
    ...
    TBHMOD_GEN2_SPEED_12P12G_BRCM_KR1,
    TBHMOD_GEN2_SPEED_12P12G_BRCM_KR1_CL74,
...
typedef uint32_t tbhmod_gen2_ts_table_entry_mem[TBHMOD_GEN2_TS_ENTRY_SIZE];
