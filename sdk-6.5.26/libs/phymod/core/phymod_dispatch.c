...
extern __phymod__dispatch__t__ phymod_tscbh_fe_gen2_driver;
#endif
#ifdef PHYMOD_BLACKHAWK7_L2P2_SUPPORT
extern __phymod__dispatch__t__ phymod_blackhawk7_l2p2_driver;
#endif
#ifdef PHYMOD_TSCBH_SUB10G_SUPPORT
extern __phymod__dispatch__t__ phymod_tscbh_sub10g_driver;
#endif
#ifdef PHYMOD_D5_SUPPORT
extern __phymod__dispatch__t__ phymod_d5_driver;
#endif
...
#endif
#ifdef PHYMOD_TSCBH_FE_GEN2_SUPPORT
    &phymod_tscbh_fe_gen2_driver,
#endif
#ifdef PHYMOD_BLACKHAWK7_L2P2_SUPPORT
    &phymod_blackhawk7_l2p2_driver,
#endif
#ifdef PHYMOD_TSCBH_SUB10G_SUPPORT
    &phymod_tscbh_sub10g_driver,
#endif
#ifdef PHYMOD_D5_SUPPORT
    &phymod_d5_driver,
#endif
...
{        
    ...
    if(phymod_pause_addr == NULL){
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("phymod_pause_addr NULL parameter")));
    }
    PHYMOD_MEMSET(phymod_pause_addr, 0, sizeof(phymod_pause_addr_t));
...
{        
    ...
    phymod_firmware_lane_config->ForceOsCdr = 0;
...
int phymod_port_pause_addr_set(const phymod_phy_access_t* phy, phymod_pause_addr_t addr)
{
    ...
    if(PHYMOD_E_OK != phymod_pause_addr_t_validate(&addr)) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("addr validation failed")));
    }
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_port_pause_addr_set) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_port_pause_addr_set(phy, addr);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
...
int phymod_port_pause_addr_get(const phymod_phy_access_t* phy, phymod_pause_addr_t* addr)
{
    ...
    if(addr == NULL) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("addr NULL parameter")));
    }
    if(PHYMOD_E_OK != phymod_pause_addr_t_init(addr)) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("addr initialization failed")));
    }
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_port_pause_addr_get) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_port_pause_addr_get(phy, addr);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
...
int phymod_phy_rx_pmd_lock_status_get(const phymod_phy_access_t* phy, uint32_t* rx_pmd_locked, uint32_t* rx_pmd_lock_change)
{
    ...
    if(rx_pmd_lock_change == NULL) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("rx_pmd_lock_change NULL parameter")));
    }
    /* Dispatch */
    PHYMOD_DRIVER_TYPE_GET(phy,&__type__);
    if(__type__ >= phymodDispatchTypeCount) { 
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_phy_rx_pmd_lock_status_get) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_phy_rx_pmd_lock_status_get(phy, rx_pmd_locked, rx_pmd_lock_change);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
...
int phymod_signal_detect_status_t_validate(const phymod_signal_detect_status_t* phymod_signal_detect_status)
{        
    if(phymod_signal_detect_status == NULL) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("NULL parameter")));
    }
...
int phymod_signal_detect_status_t_init(phymod_signal_detect_status_t* phymod_signal_detect_status)
{        
    
    if(phymod_signal_detect_status == NULL){
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("phymod_signal_detect_status NULL parameter")));
    }
    PHYMOD_MEMSET(phymod_signal_detect_status, 0, sizeof(phymod_signal_detect_status_t));
...
int phymod_phy_signal_detect_status_get(const phymod_phy_access_t* phy, phymod_signal_detect_status_t* sd_status)
{
    ...
    if(sd_status == NULL) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("sd_status NULL parameter")));
    }
    if(PHYMOD_E_OK != phymod_signal_detect_status_t_init(sd_status)) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("sd_status initialization failed")));
    }
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_phy_signal_detect_status_get) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_phy_signal_detect_status_get(phy, sd_status);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
...
int phymod_timesync_adjust_config_info_t_validate(const phymod_timesync_adjust_config_info_t* phymod_timesync_adjust_config_info)
{        
    if(phymod_timesync_adjust_config_info == NULL) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("NULL parameter")));
    }

    if(PHYMOD_E_OK != phymod_timesync_compensation_mode_t_validate(phymod_timesync_adjust_config_info->am_norm_mode)) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("am_norm_mode validation failed")));
    }
...
int phymod_timesync_adjust_config_info_t_init(phymod_timesync_adjust_config_info_t* phymod_timesync_adjust_config_info)
{        
    
    if(phymod_timesync_adjust_config_info == NULL){
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("phymod_timesync_adjust_config_info NULL parameter")));
    }
    PHYMOD_MEMSET(phymod_timesync_adjust_config_info, 0, sizeof(phymod_timesync_adjust_config_info_t));
    phymod_timesync_adjust_config_info->tx_lkup_1588_mem_mpp0 = NULL;
    phymod_timesync_adjust_config_info->tx_lkup_1588_mem_mpp1 = NULL;
    phymod_timesync_adjust_config_info->tx_lkup_1588_mem_400g = NULL;
    phymod_timesync_adjust_config_info->rx_lkup_1588_mem_mpp0 = NULL;
    phymod_timesync_adjust_config_info->rx_lkup_1588_mem_mpp1 = NULL;
    phymod_timesync_adjust_config_info->rx_lkup_1588_mem_400g = NULL;
...
int phymod_timesync_adjust_set(const phymod_phy_access_t* phy, uint32_t flags, const phymod_timesync_adjust_config_info_t* config_info)
{
    ...
    if(PHYMOD_E_OK != phymod_timesync_adjust_config_info_t_validate(config_info)) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("config_info validation failed")));
    }
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_timesync_adjust_set) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_timesync_adjust_set(phy, flags, config_info);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
...
int phymod_intr_info_t_validate(const phymod_intr_info_t* phymod_intr_info)
{        
    if(phymod_intr_info == NULL) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("NULL parameter")));
    }

    if(PHYMOD_E_OK != phymod_mem_type_t_validate(phymod_intr_info->mem_type)) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("mem_type validation failed")));
    }
...
int phymod_intr_info_t_init(phymod_intr_info_t* phymod_intr_info)
{        
    
    if(phymod_intr_info == NULL){
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("phymod_intr_info NULL parameter")));
    }
    PHYMOD_MEMSET(phymod_intr_info, 0, sizeof(phymod_intr_info_t));
    phymod_intr_info->mem_type = phymodMemCount;
    phymod_intr_info->mem_addr = -1;
...
int phymod_intr_handler(const phymod_phy_access_t* phy, phymod_interrupt_type_t type, uint32_t* is_handled, phymod_intr_info_t* info)
{
    ...
    if(PHYMOD_E_OK != phymod_intr_info_t_init(info)) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("info initialization failed")));
    }
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_intr_handler) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_intr_handler(phy, type, is_handled, info);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
...
{        
    if(phymod_an_timer >= phymodAnTimerCount) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("Parameter is out of range")));
    }
...
int phymod_phy_an_timer_set(const phymod_phy_access_t* phy, phymod_an_timer_t timer_type, uint32_t period)
{
    ...
    if(PHYMOD_E_OK != phymod_an_timer_t_validate(timer_type)) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("timer_type validation failed")));
    }
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_phy_an_timer_set) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_phy_an_timer_set(phy, timer_type, period);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
...
int phymod_phy_an_timer_get(const phymod_phy_access_t* phy, phymod_an_timer_t timer_type, uint32_t* period)
{
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_phy_an_timer_get) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_phy_an_timer_get(phy, timer_type, period);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
...
{        
    if(phymod_phy_flr_timeout >= phymodFlrTimeoutCount) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("Parameter is out of range")));
    }
...
int phymod_phy_flr_config_set(const phymod_phy_access_t* phy, uint32_t enable, phymod_phy_flr_timeout_t timeout_time)
{
    ...
    if(PHYMOD_E_OK != phymod_phy_flr_timeout_t_validate(timeout_time)) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("timeout_time validation failed")));
    }
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_phy_flr_config_set) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_phy_flr_config_set(phy, enable, timeout_time);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
...
int phymod_phy_flr_config_get(const phymod_phy_access_t* phy, uint32_t* enable, phymod_phy_flr_timeout_t* timeout_time)
{
    ...
    if(timeout_time == NULL) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("timeout_time NULL parameter")));
    }
    /* Dispatch */
    PHYMOD_DRIVER_TYPE_GET(phy,&__type__);
    if(__type__ >= phymodDispatchTypeCount) { 
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_phy_flr_config_get) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_phy_flr_config_get(phy, enable, timeout_time);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
...
{        
    if(phymod_fec_degraded_ser_config == NULL) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("NULL parameter")));
    }
...
{        
    ...
    if(phymod_fec_degraded_ser_config == NULL){
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("phymod_fec_degraded_ser_config NULL parameter")));
    }
    PHYMOD_MEMSET(phymod_fec_degraded_ser_config, 0, sizeof(phymod_fec_degraded_ser_config_t));
...
int phymod_phy_fec_degraded_ser_set(const phymod_phy_access_t* phy, phymod_fec_degraded_ser_config_t config)
{
    ...
    if(PHYMOD_E_OK != phymod_fec_degraded_ser_config_t_validate(&config)) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("config validation failed")));
    }
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_phy_fec_degraded_ser_set) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_phy_fec_degraded_ser_set(phy, config);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
...
int phymod_phy_fec_degraded_ser_get(const phymod_phy_access_t* phy, phymod_fec_degraded_ser_config_t* config)
{
    ...
    if(PHYMOD_E_OK != phymod_fec_degraded_ser_config_t_init(config)) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("config initialization failed")));
    }
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_phy_fec_degraded_ser_get) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_phy_fec_degraded_ser_get(phy, config);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
...
{        
    if(phymod_fec_degraded_ser_status == NULL) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("NULL parameter")));
    }
...
{        
    ...
    if(phymod_fec_degraded_ser_status == NULL){
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("phymod_fec_degraded_ser_status NULL parameter")));
    }
    PHYMOD_MEMSET(phymod_fec_degraded_ser_status, 0, sizeof(phymod_fec_degraded_ser_status_t));
...
int phymod_phy_fec_degraded_ser_status_get(const phymod_phy_access_t* phy, phymod_fec_degraded_ser_status_t* status)
{
    ...
    if(PHYMOD_E_OK != phymod_fec_degraded_ser_status_t_init(status)) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("status initialization failed")));
    }
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_phy_fec_degraded_ser_status_get) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_phy_fec_degraded_ser_status_get(phy, status);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
...
int phymod_phy_am_loss_align_multi_state_get(const phymod_phy_access_t* phy, uint32_t* am_loss_align_multi_state)
{
    ...
    if(am_loss_align_multi_state == NULL) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("am_loss_align_multi_state NULL parameter")));
    }
    /* Dispatch */
    PHYMOD_DRIVER_TYPE_GET(phy,&__type__);
    if(__type__ >= phymodDispatchTypeCount) { 
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_phy_am_loss_align_multi_state_get) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_phy_am_loss_align_multi_state_get(phy, am_loss_align_multi_state);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
...
int phymod_phy_temp_offset_set(const phymod_phy_access_t* phy, int temp_offset)
{
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_phy_temp_offset_set) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_phy_temp_offset_set(phy, temp_offset);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
...
int phymod_phy_temp_offset_get(const phymod_phy_access_t* phy, int* temp_offset)
{
    ...
    if(temp_offset == NULL) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("temp_offset NULL parameter")));
    }
    /* Dispatch */
    PHYMOD_DRIVER_TYPE_GET(phy,&__type__);
    if(__type__ >= phymodDispatchTypeCount) { 
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_phy_temp_offset_get) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_phy_temp_offset_get(phy, temp_offset);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
...
int phymod_phy_fw_is_flr_supported(const phymod_phy_access_t* phy, uint32_t* flr_support)
{
    ...
    if(flr_support == NULL) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("flr_support NULL parameter")));
    }
    /* Dispatch */
    PHYMOD_DRIVER_TYPE_GET(phy,&__type__);
    if(__type__ >= phymodDispatchTypeCount) { 
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_phy_fw_is_flr_supported) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_phy_fw_is_flr_supported(phy, flr_support);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
...
int phymod_phy_rx_dc_offset_get(const phymod_phy_access_t* phy, uint32_t* rx_dc_offset)
{
    ...
    if(rx_dc_offset == NULL) {
        PHYMOD_RETURN_WITH_ERR(PHYMOD_E_PARAM, (_PHYMOD_MSG("rx_dc_offset NULL parameter")));
    }
    /* Dispatch */
    PHYMOD_DRIVER_TYPE_GET(phy,&__type__);
    if(__type__ >= phymodDispatchTypeCount) { 
    ...
    if(NULL != __phymod__dispatch__[__type__]->f_phymod_phy_rx_dc_offset_get) {
        PHYMOD_LOCK_TAKE(phy);
        __rv__ = __phymod__dispatch__[__type__]->f_phymod_phy_rx_dc_offset_get(phy, rx_dc_offset);
        PHYMOD_LOCK_GIVE(phy);
        PHYMOD_IF_ERR_RETURN(__rv__);
    } else { 
        return PHYMOD_E_UNAVAIL;
