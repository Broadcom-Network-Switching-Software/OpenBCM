...
/*Set timesync adjust*/
int tscbh_gen3_timesync_adjust_set(const phymod_phy_access_t* phy, uint32_t flags, const phymod_timesync_adjust_config_info_t* config_info);
...
int tscbh_gen3_intr_handler(const phymod_phy_access_t* phy, phymod_interrupt_type_t type, uint32_t* is_handled, phymod_intr_info_t* info);
