...
dnxf_state_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(dnxf_state_signal_quality_dump(unit, filters));
...
dnxf_state_info_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(dnxf_state_info_soft_init_reg_above_64_val_dump(unit, -1, filters));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
int
dnxf_state_info_soft_init_reg_above_64_val_dump(int  unit,  int  soft_init_reg_above_64_val_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = soft_init_reg_above_64_val_idx_0, I0 = soft_init_reg_above_64_val_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnxf info soft_init_reg_above_64_val") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnxf info soft_init_reg_above_64_val\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnxf_state/info/soft_init_reg_above_64_val.txt",
            "dnxf_state[%d]->","((dnxf_state_t*)sw_state_roots_array[%d][DNXF_MODULE_ID])->","info.soft_init_reg_above_64_val[]: ");
        ...
        if (i0 == -1) {
            ...
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->info.soft_init_reg_above_64_val
                , sizeof(*((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->info.soft_init_reg_above_64_val), I0, &s0) ? I0 - 1 : 0;
        }

        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNXF_STATE__INFO__SOFT_INIT_REG_ABOVE_64_VAL, ((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->info.soft_init_reg_above_64_val))
        {
            LOG_CLI((BSL_META("dnxf_state[]->((dnxf_state_t*)sw_state_roots_array[][DNXF_MODULE_ID])->info.soft_init_reg_above_64_val[]: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNXF_STATE__INFO__SOFT_INIT_REG_ABOVE_64_VAL, ((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->info.soft_init_reg_above_64_val) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "dnxf_state[%d]->","((dnxf_state_t*)sw_state_roots_array[%d][DNXF_MODULE_ID])->","info.soft_init_reg_above_64_val[%s%d]: ", s0, i0);
            ...
            dnx_sw_state_print_uint32(
                unit,
                &((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->info.soft_init_reg_above_64_val[i0]);
...
int
dnxf_state_signal_quality_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnxf_state_signal_quality_fmac_config_dump(unit, -1, filters));
    SHR_IF_ERR_EXIT(dnxf_state_signal_quality_action_enabled_dump(unit, filters));
    SHR_IF_ERR_EXIT(dnxf_state_signal_quality_enabled_ports_dump(unit, filters));
    SHR_IF_ERR_EXIT(dnxf_state_signal_quality_measure_mode_dump(unit, filters));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
int
dnxf_state_signal_quality_fmac_config_dump(int  unit,  int  fmac_config_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnxf_state_signal_quality_fmac_config_degrade_thr_dump(unit, fmac_config_idx_0, filters));
    SHR_IF_ERR_EXIT(dnxf_state_signal_quality_fmac_config_degrade_cu_thr_dump(unit, fmac_config_idx_0, filters));
    SHR_IF_ERR_EXIT(dnxf_state_signal_quality_fmac_config_fail_thr_dump(unit, fmac_config_idx_0, filters));
    SHR_IF_ERR_EXIT(dnxf_state_signal_quality_fmac_config_fail_cu_thr_dump(unit, fmac_config_idx_0, filters));
    SHR_IF_ERR_EXIT(dnxf_state_signal_quality_fmac_config_interval_dump(unit, fmac_config_idx_0, filters));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
int
dnxf_state_signal_quality_fmac_config_degrade_thr_dump(int  unit,  int  fmac_config_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = fmac_config_idx_0, I0 = fmac_config_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnxf signal_quality fmac_config degrade_thr") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnxf signal_quality fmac_config degrade_thr\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnxf_state/signal_quality/fmac_config/degrade_thr.txt",
            "dnxf_state[%d]->","((dnxf_state_t*)sw_state_roots_array[%d][DNXF_MODULE_ID])->","signal_quality.fmac_config[].degrade_thr: ");
        ...
        DNX_SW_STATE_DUMP_PTR_NULL_CHECK(
            unit,
            ((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.fmac_config);

        if (i0 == -1) {
            I0 = dnx_sw_state_get_nof_elements(unit,
                DNX_SW_STATE_DNXF_STATE__SIGNAL_QUALITY__FMAC_CONFIG__DEGRADE_THR,
                ((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.fmac_config);
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.fmac_config
                , sizeof(*((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.fmac_config), I0, &s0) ? I0 - 1 : 0;
        }

        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNXF_STATE__SIGNAL_QUALITY__FMAC_CONFIG__DEGRADE_THR, ((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.fmac_config))
        {
            LOG_CLI((BSL_META("dnxf_state[]->((dnxf_state_t*)sw_state_roots_array[][DNXF_MODULE_ID])->signal_quality.fmac_config[].degrade_thr: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNXF_STATE__SIGNAL_QUALITY__FMAC_CONFIG__DEGRADE_THR, ((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.fmac_config) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "dnxf_state[%d]->","((dnxf_state_t*)sw_state_roots_array[%d][DNXF_MODULE_ID])->","signal_quality.fmac_config[%s%d].degrade_thr: ", s0, i0);
            ...
            dnx_sw_state_print_uint32(
                unit,
                &((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.fmac_config[i0].degrade_thr);
...
int
dnxf_state_signal_quality_fmac_config_degrade_cu_thr_dump(int  unit,  int  fmac_config_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = fmac_config_idx_0, I0 = fmac_config_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnxf signal_quality fmac_config degrade_cu_thr") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnxf signal_quality fmac_config degrade_cu_thr\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnxf_state/signal_quality/fmac_config/degrade_cu_thr.txt",
            "dnxf_state[%d]->","((dnxf_state_t*)sw_state_roots_array[%d][DNXF_MODULE_ID])->","signal_quality.fmac_config[].degrade_cu_thr: ");
        ...
        if (i0 == -1) {
            I0 = dnx_sw_state_get_nof_elements(unit,
                DNX_SW_STATE_DNXF_STATE__SIGNAL_QUALITY__FMAC_CONFIG__DEGRADE_CU_THR,
                ((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.fmac_config);
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.fmac_config
                , sizeof(*((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.fmac_config), I0, &s0) ? I0 - 1 : 0;
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNXF_STATE__SIGNAL_QUALITY__FMAC_CONFIG__DEGRADE_CU_THR, ((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.fmac_config))
        {
            LOG_CLI((BSL_META("dnxf_state[]->((dnxf_state_t*)sw_state_roots_array[][DNXF_MODULE_ID])->signal_quality.fmac_config[].degrade_cu_thr: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNXF_STATE__SIGNAL_QUALITY__FMAC_CONFIG__DEGRADE_CU_THR, ((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.fmac_config) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "dnxf_state[%d]->","((dnxf_state_t*)sw_state_roots_array[%d][DNXF_MODULE_ID])->","signal_quality.fmac_config[%s%d].degrade_cu_thr: ", s0, i0);
            ...
            dnx_sw_state_print_uint32(
                unit,
                &((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.fmac_config[i0].degrade_cu_thr);
...
int
dnxf_state_signal_quality_fmac_config_fail_thr_dump(int  unit,  int  fmac_config_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = fmac_config_idx_0, I0 = fmac_config_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnxf signal_quality fmac_config fail_thr") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnxf signal_quality fmac_config fail_thr\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnxf_state/signal_quality/fmac_config/fail_thr.txt",
            "dnxf_state[%d]->","((dnxf_state_t*)sw_state_roots_array[%d][DNXF_MODULE_ID])->","signal_quality.fmac_config[].fail_thr: ");
        ...
        if (i0 == -1) {
            I0 = dnx_sw_state_get_nof_elements(unit,
                DNX_SW_STATE_DNXF_STATE__SIGNAL_QUALITY__FMAC_CONFIG__FAIL_THR,
                ((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.fmac_config);
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.fmac_config
                , sizeof(*((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.fmac_config), I0, &s0) ? I0 - 1 : 0;
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNXF_STATE__SIGNAL_QUALITY__FMAC_CONFIG__FAIL_THR, ((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.fmac_config))
        {
            LOG_CLI((BSL_META("dnxf_state[]->((dnxf_state_t*)sw_state_roots_array[][DNXF_MODULE_ID])->signal_quality.fmac_config[].fail_thr: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNXF_STATE__SIGNAL_QUALITY__FMAC_CONFIG__FAIL_THR, ((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.fmac_config) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "dnxf_state[%d]->","((dnxf_state_t*)sw_state_roots_array[%d][DNXF_MODULE_ID])->","signal_quality.fmac_config[%s%d].fail_thr: ", s0, i0);
            ...
            dnx_sw_state_print_uint32(
                unit,
                &((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.fmac_config[i0].fail_thr);
...
int
dnxf_state_signal_quality_fmac_config_fail_cu_thr_dump(int  unit,  int  fmac_config_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = fmac_config_idx_0, I0 = fmac_config_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnxf signal_quality fmac_config fail_cu_thr") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnxf signal_quality fmac_config fail_cu_thr\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnxf_state/signal_quality/fmac_config/fail_cu_thr.txt",
            "dnxf_state[%d]->","((dnxf_state_t*)sw_state_roots_array[%d][DNXF_MODULE_ID])->","signal_quality.fmac_config[].fail_cu_thr: ");
        ...
        if (i0 == -1) {
            I0 = dnx_sw_state_get_nof_elements(unit,
                DNX_SW_STATE_DNXF_STATE__SIGNAL_QUALITY__FMAC_CONFIG__FAIL_CU_THR,
                ((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.fmac_config);
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.fmac_config
                , sizeof(*((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.fmac_config), I0, &s0) ? I0 - 1 : 0;
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNXF_STATE__SIGNAL_QUALITY__FMAC_CONFIG__FAIL_CU_THR, ((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.fmac_config))
        {
            LOG_CLI((BSL_META("dnxf_state[]->((dnxf_state_t*)sw_state_roots_array[][DNXF_MODULE_ID])->signal_quality.fmac_config[].fail_cu_thr: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNXF_STATE__SIGNAL_QUALITY__FMAC_CONFIG__FAIL_CU_THR, ((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.fmac_config) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "dnxf_state[%d]->","((dnxf_state_t*)sw_state_roots_array[%d][DNXF_MODULE_ID])->","signal_quality.fmac_config[%s%d].fail_cu_thr: ", s0, i0);
            ...
            dnx_sw_state_print_uint32(
                unit,
                &((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.fmac_config[i0].fail_cu_thr);
...
int
dnxf_state_signal_quality_fmac_config_interval_dump(int  unit,  int  fmac_config_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = fmac_config_idx_0, I0 = fmac_config_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnxf signal_quality fmac_config interval") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnxf signal_quality fmac_config interval\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnxf_state/signal_quality/fmac_config/interval.txt",
            "dnxf_state[%d]->","((dnxf_state_t*)sw_state_roots_array[%d][DNXF_MODULE_ID])->","signal_quality.fmac_config[].interval: ");
        ...
        if (i0 == -1) {
            I0 = dnx_sw_state_get_nof_elements(unit,
                DNX_SW_STATE_DNXF_STATE__SIGNAL_QUALITY__FMAC_CONFIG__INTERVAL,
                ((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.fmac_config);
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.fmac_config
                , sizeof(*((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.fmac_config), I0, &s0) ? I0 - 1 : 0;
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNXF_STATE__SIGNAL_QUALITY__FMAC_CONFIG__INTERVAL, ((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.fmac_config))
        {
            LOG_CLI((BSL_META("dnxf_state[]->((dnxf_state_t*)sw_state_roots_array[][DNXF_MODULE_ID])->signal_quality.fmac_config[].interval: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNXF_STATE__SIGNAL_QUALITY__FMAC_CONFIG__INTERVAL, ((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.fmac_config) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "dnxf_state[%d]->","((dnxf_state_t*)sw_state_roots_array[%d][DNXF_MODULE_ID])->","signal_quality.fmac_config[%s%d].interval: ", s0, i0);
            ...
            dnx_sw_state_print_uint32(
                unit,
                &((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.fmac_config[i0].interval);
...
int
dnxf_state_signal_quality_action_enabled_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnxf signal_quality action_enabled") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnxf signal_quality action_enabled\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnxf_state/signal_quality/action_enabled.txt",
            "dnxf_state[%d]->","((dnxf_state_t*)sw_state_roots_array[%d][DNXF_MODULE_ID])->","signal_quality.action_enabled: ");
        ...
        DNX_SW_STATE_PRINT_OPAQUE_MONITOR(
            unit,
            ((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.action_enabled,
            "dnxf_state[%d]->","((dnxf_state_t*)sw_state_roots_array[%d][DNXF_MODULE_ID])->","signal_quality.action_enabled: ");
...
int
dnxf_state_signal_quality_enabled_ports_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnxf signal_quality enabled_ports") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnxf signal_quality enabled_ports\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnxf_state/signal_quality/enabled_ports.txt",
            "dnxf_state[%d]->","((dnxf_state_t*)sw_state_roots_array[%d][DNXF_MODULE_ID])->","signal_quality.enabled_ports: ");
        ...
        DNX_SW_STATE_PRINT_OPAQUE_MONITOR(
            unit,
            ((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.enabled_ports,
            "dnxf_state[%d]->","((dnxf_state_t*)sw_state_roots_array[%d][DNXF_MODULE_ID])->","signal_quality.enabled_ports: ");
...
int
dnxf_state_signal_quality_measure_mode_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnxf signal_quality measure_mode") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnxf signal_quality measure_mode\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnxf_state/signal_quality/measure_mode.txt",
            "dnxf_state[%d]->","((dnxf_state_t*)sw_state_roots_array[%d][DNXF_MODULE_ID])->","signal_quality.measure_mode: ");
        ...
        DNX_SW_STATE_PRINT_OPAQUE_MONITOR(
            unit,
            ((dnxf_state_t*)sw_state_roots_array[unit][DNXF_MODULE_ID])->signal_quality.measure_mode,
            "dnxf_state[%d]->","((dnxf_state_t*)sw_state_roots_array[%d][DNXF_MODULE_ID])->","signal_quality.measure_mode: ");
...
const char* dnxf_state_layout_str[DNXF_STATE_INFO_NOF_ENTRIES] = {
    ...
    "DNXF_STATE~INFO~SOFT_INIT_REG_ABOVE_64_VAL~",
    "DNXF_STATE~MODID~",
    ...
    "DNXF_STATE~SIGNAL_QUALITY~",
    "DNXF_STATE~SIGNAL_QUALITY~FMAC_CONFIG~",
    ...
    "DNXF_STATE~SIGNAL_QUALITY~ACTION_ENABLED~",
    "DNXF_STATE~SIGNAL_QUALITY~ENABLED_PORTS~",
    "DNXF_STATE~SIGNAL_QUALITY~MEASURE_MODE~",
};
#endif 
