...
dnxf_init_layout_structure(int unit)
{
    ...
    layout_array_dnxf[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNXF_STATE__LAST);
    ...
    layout_array_dnxf[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNXF_STATE__INFO__LAST);
    ...
    layout_array_dnxf[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNXF_STATE__MODID__LAST);
    ...
    layout_array_dnxf[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNXF_STATE__MC__LAST);
    ...
    layout_array_dnxf[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNXF_STATE__LB__LAST);
    ...
    layout_array_dnxf[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNXF_STATE__PORT__LAST);
    ...
    layout_array_dnxf[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNXF_STATE__CABLE_SWAP__LAST);
    ...
    layout_array_dnxf[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNXF_STATE__INTR__LAST);
    ...
    layout_array_dnxf[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNXF_STATE__LANE_MAP_DB__LAST);
    ...
    layout_array_dnxf[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNXF_STATE__SYNCE__LAST);
    ...
    layout_array_dnxf[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNXF_STATE__SYSTEM_UPGRADE__LAST);
    ...
    layout_array_dnxf[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNXF_STATE__HARD_RESET__LAST);
    ...
    layout_array_dnxf[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNXF_STATE__MIB__LAST);

    idx = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNXF_STATE__SIGNAL_QUALITY);
    layout_array_dnxf[idx].name = "dnxf_state__signal_quality";
    layout_array_dnxf[idx].type = "soc_dnxf_signal_quality_db_fabric_t";
    layout_array_dnxf[idx].doc = "Holds 'signal quality based on error rate' module information";
    layout_array_dnxf[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnxf[idx].size_of = sizeof(soc_dnxf_signal_quality_db_fabric_t);
    layout_array_dnxf[idx].parent  = 0;
    layout_array_dnxf[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNXF_STATE__SIGNAL_QUALITY__FIRST);
    layout_array_dnxf[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNXF_STATE__SIGNAL_QUALITY__LAST);
    ...
    layout_array_dnxf[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNXF_STATE__MODID__LOCAL_MAP__LAST);
    ...
    layout_array_dnxf[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNXF_STATE__MODID__GROUP_MAP__LAST);
    ...
    layout_array_dnxf[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNXF_STATE__LANE_MAP_DB__SERDES_MAP__LAST);
    ...
    layout_array_dnxf[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnxf[idx].size_of = sizeof(int);
    layout_array_dnxf[idx].parent  = 37;
    layout_array_dnxf[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnxf[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnxf[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNXF_STATE__LANE_MAP_DB__SERDES_MAP__LANE2SERDES__LAST);
    layout_array_dnxf[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
    ...
    layout_array_dnxf[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNXF_STATE__LANE_MAP_DB__SERDES_MAP__SERDES2LANE__LAST);
    layout_array_dnxf[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
    ...
    layout_array_dnxf[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnxf[idx].size_of = sizeof(int);
    layout_array_dnxf[idx].parent  = 40;
    layout_array_dnxf[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnxf[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    idx = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNXF_STATE__SIGNAL_QUALITY__FMAC_CONFIG);
    layout_array_dnxf[idx].name = "dnxf_state__signal_quality__fmac_config";
    layout_array_dnxf[idx].type = "soc_dnxf_signal_quality_fmac_config_t*";
    layout_array_dnxf[idx].doc = "Signal quality BER/SER per phy struct";
    layout_array_dnxf[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnxf[idx].size_of = sizeof(soc_dnxf_signal_quality_fmac_config_t*);
    layout_array_dnxf[idx].array_indexes[0].num_elements = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnxf[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC;
    layout_array_dnxf[idx].parent  = 13;
    layout_array_dnxf[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNXF_STATE__SIGNAL_QUALITY__FMAC_CONFIG__FIRST);
    layout_array_dnxf[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNXF_STATE__SIGNAL_QUALITY__FMAC_CONFIG__LAST);
    layout_array_dnxf[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;

    idx = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNXF_STATE__SIGNAL_QUALITY__ACTION_ENABLED);
    layout_array_dnxf[idx].name = "dnxf_state__signal_quality__action_enabled";
    layout_array_dnxf[idx].type = "bcm_pbmp_t";
    layout_array_dnxf[idx].doc = "A bitmap of ports that indicate whether signal fail event should trigger an action";
    layout_array_dnxf[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnxf[idx].size_of = sizeof(bcm_pbmp_t);
    layout_array_dnxf[idx].parent  = 13;
    layout_array_dnxf[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    idx = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNXF_STATE__SIGNAL_QUALITY__ENABLED_PORTS);
    layout_array_dnxf[idx].name = "dnxf_state__signal_quality__enabled_ports";
    layout_array_dnxf[idx].type = "bcm_pbmp_t";
    layout_array_dnxf[idx].doc = "A bitmap of ports that use signal quality BER/SER logic";
    layout_array_dnxf[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnxf[idx].size_of = sizeof(bcm_pbmp_t);
    layout_array_dnxf[idx].parent  = 13;
    layout_array_dnxf[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    idx = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNXF_STATE__SIGNAL_QUALITY__MEASURE_MODE);
    layout_array_dnxf[idx].name = "dnxf_state__signal_quality__measure_mode";
    layout_array_dnxf[idx].type = "bcm_pbmp_t";
    layout_array_dnxf[idx].doc = "A bitmap of ports that use SER based measurment";
    layout_array_dnxf[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnxf[idx].size_of = sizeof(bcm_pbmp_t);
    layout_array_dnxf[idx].parent  = 13;
    layout_array_dnxf[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    idx = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNXF_STATE__SIGNAL_QUALITY__FMAC_CONFIG__DEGRADE_THR);
    layout_array_dnxf[idx].name = "dnxf_state__signal_quality__fmac_config__degrade_thr";
    layout_array_dnxf[idx].type = "uint32";
    layout_array_dnxf[idx].doc = "Degrade threshold, encoded 16MSB as mantissa, 16LSB exponent";
    layout_array_dnxf[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnxf[idx].size_of = sizeof(uint32);
    layout_array_dnxf[idx].parent  = 57;
    layout_array_dnxf[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnxf[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;

    idx = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNXF_STATE__SIGNAL_QUALITY__FMAC_CONFIG__DEGRADE_CU_THR);
    layout_array_dnxf[idx].name = "dnxf_state__signal_quality__fmac_config__degrade_cu_thr";
    layout_array_dnxf[idx].type = "uint32";
    layout_array_dnxf[idx].doc = "Degrade cross up threshold, encoded 16MSB as mantissa, 16LSB exponent";
    layout_array_dnxf[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnxf[idx].size_of = sizeof(uint32);
    layout_array_dnxf[idx].parent  = 57;
    layout_array_dnxf[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    idx = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNXF_STATE__SIGNAL_QUALITY__FMAC_CONFIG__FAIL_THR);
    layout_array_dnxf[idx].name = "dnxf_state__signal_quality__fmac_config__fail_thr";
    layout_array_dnxf[idx].type = "uint32";
    layout_array_dnxf[idx].doc = "fail threshold, encoded 16MSB as mantissa, 16LSB exponent";
    layout_array_dnxf[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnxf[idx].size_of = sizeof(uint32);
    layout_array_dnxf[idx].parent  = 57;
    layout_array_dnxf[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    idx = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNXF_STATE__SIGNAL_QUALITY__FMAC_CONFIG__FAIL_CU_THR);
    layout_array_dnxf[idx].name = "dnxf_state__signal_quality__fmac_config__fail_cu_thr";
    layout_array_dnxf[idx].type = "uint32";
    layout_array_dnxf[idx].doc = "fail cross up threshold, encoded 16MSB as mantissa, 16LSB exponent";
    layout_array_dnxf[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnxf[idx].size_of = sizeof(uint32);
    layout_array_dnxf[idx].parent  = 57;
    layout_array_dnxf[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    idx = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNXF_STATE__SIGNAL_QUALITY__FMAC_CONFIG__INTERVAL);
    layout_array_dnxf[idx].name = "dnxf_state__signal_quality__fmac_config__interval";
    layout_array_dnxf[idx].type = "uint32";
    layout_array_dnxf[idx].doc = "Amount of time in microseconds to wait before deciding if threshold was crossed";
    layout_array_dnxf[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnxf[idx].size_of = sizeof(uint32);
    layout_array_dnxf[idx].parent  = 57;
    layout_array_dnxf[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
