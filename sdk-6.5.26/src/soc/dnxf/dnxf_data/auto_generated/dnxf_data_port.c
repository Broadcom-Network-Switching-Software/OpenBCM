    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnxf_data_port_general_table_fec_compensation_info].values[0].doc = "The portion of the codeword (in bits) on which bit error counting is performed";
    ...
    submodule_data->tables[dnxf_data_port_general_table_fec_compensation_info].values[1].doc = "total number of bits in codeword";
    ...
    submodule_data->tables[dnxf_data_port_general_table_fec_compensation_info].values[2].doc = "Maximum number of erroroues symbols that can be corrected";
    ...
    submodule_data->tables[dnxf_data_port_general_table_fec_compensation_info].values[3].doc = "is FEC type supported";
