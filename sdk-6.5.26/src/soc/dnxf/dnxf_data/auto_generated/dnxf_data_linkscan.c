    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnxf_data_linkscan_general_define_interval].doc = "";
    submodule_data->defines[dnxf_data_linkscan_general_define_interval].labels[0] = "data_notrev";
    ...
    submodule_data->defines[dnxf_data_linkscan_general_define_error_delay].doc = "";
    submodule_data->defines[dnxf_data_linkscan_general_define_error_delay].labels[0] = "data_notrev";
    ...
    submodule_data->defines[dnxf_data_linkscan_general_define_max_error].doc = "";
    submodule_data->defines[dnxf_data_linkscan_general_define_max_error].labels[0] = "data_notrev";
    ...
    submodule_data->defines[dnxf_data_linkscan_general_define_thread_priority].doc = "";
    submodule_data->defines[dnxf_data_linkscan_general_define_thread_priority].labels[0] = "data_notrev";
    ...
    submodule_data->defines[dnxf_data_linkscan_general_define_m0_pause_enable].doc = "";
    submodule_data->defines[dnxf_data_linkscan_general_define_m0_pause_enable].labels[0] = "data_notrev";
    ...
    submodule_data->tables[dnxf_data_linkscan_general_table_pbmp].doc = "";
    submodule_data->tables[dnxf_data_linkscan_general_table_pbmp].labels[0] = "data_notrev";
