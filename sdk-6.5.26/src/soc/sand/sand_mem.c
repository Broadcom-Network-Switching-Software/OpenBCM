    ...
    unsigned do_read) 
{
    ...
    SOC_MEM_BLOCK_ITER(unit, mem, blk) {
        ...
        soc_reg64_field32_set(unit, ECI_INDIRECT_COMMANDr, &reg64, INDIRECT_COMMAND_TIMEOUTf, 0x3fff); 
        ...
        uint32 *value)
{
    ...
    soc_reg64_field32_set(unit, ECI_INDIRECT_COMMANDr, &reg64, INDIRECT_COMMAND_TRIGGER_ON_DATAf, 1);
    soc_reg64_field32_set(unit, ECI_INDIRECT_COMMANDr, &reg64, INDIRECT_COMMAND_TIMEOUTf, 0xe00);
