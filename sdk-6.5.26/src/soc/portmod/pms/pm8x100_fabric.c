...
{
#ifdef PHYMOD_PEREGRINE5_TC_SUPPORT
    phymodDispatchTypePeregrine5_tc,
#endif
...
int pm8x100_fabric_port_tx_padding_set(int unit, int port, pm_info_t pm_info, int pad_size)
{
    ...
    _SOC_IF_ERR_EXIT(soc_reg64_get(unit, FMAC_FMAL_TX_GENERAL_CONFIGURATIONr, fmac_index, fmac_inner_link, &reg64_val));
    soc_reg64_field32_set(unit, FMAC_FMAL_TX_GENERAL_CONFIGURATIONr, &reg64_val,
                          FMAL_TX_GENERAL_CONFIGURATION_03_FIELD_9f, pad_size ? 1 : 0);
    if (pad_size)
    {
        soc_reg64_field32_set(unit, FMAC_FMAL_TX_GENERAL_CONFIGURATIONr, &reg64_val,
                              FMAL_TX_GENERAL_CONFIGURATION_03_FIELD_10f, pad_size);
    }
    _SOC_IF_ERR_EXIT(soc_reg64_set(unit, FMAC_FMAL_TX_GENERAL_CONFIGURATIONr, fmac_index, fmac_inner_link, reg64_val));
...
int pm8x100_fabric_port_tx_padding_get(int unit, int port, pm_info_t pm_info, int * pad_size)
{
    ...
    _SOC_IF_ERR_EXIT(soc_reg64_get(unit, FMAC_FMAL_TX_GENERAL_CONFIGURATIONr, fmac_index, fmac_inner_link, &reg64_val));
    field_val =
        soc_reg64_field32_get(unit, FMAC_FMAL_TX_GENERAL_CONFIGURATIONr, reg64_val,
                              FMAL_TX_GENERAL_CONFIGURATION_03_FIELD_9f);
    if (field_val)
    {
        *pad_size =
            soc_reg64_field32_get(unit, FMAC_FMAL_TX_GENERAL_CONFIGURATIONr, reg64_val,
                                  FMAL_TX_GENERAL_CONFIGURATION_03_FIELD_10f);
    }
    else
    {
        *pad_size = 0;
