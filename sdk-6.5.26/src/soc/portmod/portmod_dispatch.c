...
{        
    ...
    portmod_port_diag_info->interface = SOC_PORT_IF_COUNT;
...
int portmod_port_phase_interpolator_rx_set(int unit, int port, int enable)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_phase_interpolator_rx_set) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_phase_interpolator_rx_set(unit, port, pm_info, enable);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_port_phase_interpolator_rx_set isn't implemented for driver type"));
    }
...
int portmod_port_phase_interpolator_tx_set(int unit, int port, int enable)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_phase_interpolator_tx_set) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_phase_interpolator_tx_set(unit, port, pm_info, enable);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_port_phase_interpolator_tx_set isn't implemented for driver type"));
    }
...
int portmod_port_phy_flr_link_up_event(int unit, int port)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_phy_flr_link_up_event) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_phy_flr_link_up_event(unit, port, pm_info);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_port_phy_flr_link_up_event isn't implemented for driver type"));
    }
...
int portmod_port_tx_threshold_set(int unit, int port, int value)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_tx_threshold_set) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_tx_threshold_set(unit, port, pm_info, value);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_port_tx_threshold_set isn't implemented for driver type"));
    }
...
int portmod_port_tx_threshold_get(int unit, int port, int* value)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_tx_threshold_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_tx_threshold_get(unit, port, pm_info, value);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_port_tx_threshold_get isn't implemented for driver type"));
    }
...
int portmod_port_remote_fault_force_set(int unit, int port, int enable)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_remote_fault_force_set) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_remote_fault_force_set(unit, port, pm_info, enable);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_port_remote_fault_force_set isn't implemented for driver type"));
    }
...
int portmod_port_remote_fault_force_get(int unit, int port, int* enable)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_remote_fault_force_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_remote_fault_force_get(unit, port, pm_info, enable);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_port_remote_fault_force_get isn't implemented for driver type"));
    }
...
int portmod_port_local_fault_force_set(int unit, int port, int enable)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_local_fault_force_set) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_local_fault_force_set(unit, port, pm_info, enable);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_port_local_fault_force_set isn't implemented for driver type"));
    }
...
int portmod_port_local_fault_force_get(int unit, int port, int* enable)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_local_fault_force_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_local_fault_force_get(unit, port, pm_info, enable);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_port_local_fault_force_get isn't implemented for driver type"));
    }
...
int portmod_cpri_port_tx_frame_tgen_enable_set(int unit, int port, uint32 enable)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_cpri_port_tx_frame_tgen_enable_set) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_cpri_port_tx_frame_tgen_enable_set(unit, port, pm_info, enable);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_cpri_port_tx_frame_tgen_enable_set isn't implemented for driver type"));
    }
...
int portmod_cpri_port_tx_frame_tgen_enable_get(int unit, int port, uint32* enable)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_cpri_port_tx_frame_tgen_enable_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_cpri_port_tx_frame_tgen_enable_get(unit, port, pm_info, enable);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_cpri_port_tx_frame_tgen_enable_get isn't implemented for driver type"));
    }
...
#ifdef CPRIMOD_SUPPORT
int portmod_rsvd4_rx_control_flow_get(int unit, int port, uint32 flow_id, portmod_control_flow_config_t* config)
{
    ...
    if(SOC_E_NONE != portmod_control_flow_config_t_init(unit, config)) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("config initialization failed"));
    }
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_rsvd4_rx_control_flow_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_rsvd4_rx_control_flow_get(unit, port, pm_info, flow_id, config);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_rsvd4_rx_control_flow_get isn't implemented for driver type"));
    }
...
#ifdef CPRIMOD_SUPPORT
int portmod_rsvd4_fast_eth_config_get(int unit, int port, portmod_cpri_fast_eth_config_t* config_info)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_rsvd4_fast_eth_config_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_rsvd4_fast_eth_config_get(unit, port, pm_info, config_info);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_rsvd4_fast_eth_config_get isn't implemented for driver type"));
    }
...
int portmod_rx_tag_config_get(int unit, int port, uint32* default_tag, uint32* no_match_tag)
{
    ...
    if(default_tag == NULL) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("default_tag NULL parameter"));
    }
    if(no_match_tag == NULL) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("no_match_tag NULL parameter"));
    }
    /* Dispatch */
    _SOC_IF_ERR_EXIT(portmod_port_pm_type_get(unit, port, &port, &__type__));
    if(__type__ >= portmodDispatchTypeCount) { 
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_rx_tag_config_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_rx_tag_config_get(unit, port, pm_info, default_tag, no_match_tag);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_rx_tag_config_get isn't implemented for driver type"));
    }
...
#ifdef CPRIMOD_SUPPORT
int portmod_rsvd4_tx_control_flow_group_member_get(int unit, int port, uint32 group_id, uint32 priority, uint32* queue_num, portmod_control_msg_proc_type_t* proc_type)
{
    ...
    if(proc_type == NULL) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("proc_type NULL parameter"));
    }
    /* Dispatch */
    _SOC_IF_ERR_EXIT(portmod_port_pm_type_get(unit, port, &port, &__type__));
    if(__type__ >= portmodDispatchTypeCount) { 
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_rsvd4_tx_control_flow_group_member_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_rsvd4_tx_control_flow_group_member_get(unit, port, pm_info, group_id, priority, queue_num, proc_type);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_rsvd4_tx_control_flow_group_member_get isn't implemented for driver type"));
    }
...
#ifdef CPRIMOD_SUPPORT
int portmod_rsvd4_tx_control_flow_group_member_get_all(int unit, int port, uint32 group_id, portmod_rsvd4_control_group_entry_t* group_config)
{
    ...
    if(group_config == NULL) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("group_config NULL parameter"));
    }
    /* Dispatch */
    _SOC_IF_ERR_EXIT(portmod_port_pm_type_get(unit, port, &port, &__type__));
    if(__type__ >= portmodDispatchTypeCount) { 
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_rsvd4_tx_control_flow_group_member_get_all) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_rsvd4_tx_control_flow_group_member_get_all(unit, port, pm_info, group_id, group_config);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_rsvd4_tx_control_flow_group_member_get_all isn't implemented for driver type"));
    }
...
#ifdef CPRIMOD_SUPPORT
int portmod_rsvd4_tx_single_tunnel_message_config_get(int unit, int port, portmod_cpri_crc_option_t* crc_option)
{
    ...
    if(crc_option == NULL) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("crc_option NULL parameter"));
    }
    /* Dispatch */
    _SOC_IF_ERR_EXIT(portmod_port_pm_type_get(unit, port, &port, &__type__));
    if(__type__ >= portmodDispatchTypeCount) { 
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_rsvd4_tx_single_tunnel_message_config_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_rsvd4_tx_single_tunnel_message_config_get(unit, port, pm_info, crc_option);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_rsvd4_tx_single_tunnel_message_config_get isn't implemented for driver type"));
    }
...
int portmod_port_tx_padding_set(int unit, int port, int pad_size)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_tx_padding_set) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_tx_padding_set(unit, port, pm_info, pad_size);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_port_tx_padding_set isn't implemented for driver type"));
    }
...
int portmod_port_tx_padding_get(int unit, int port, int* pad_size)
{
    ...
    if(pad_size == NULL) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("pad_size NULL parameter"));
    }
    /* Dispatch */
    _SOC_IF_ERR_EXIT(portmod_port_pm_type_get(unit, port, &port, &__type__));
    if(__type__ >= portmodDispatchTypeCount) { 
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_tx_padding_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_tx_padding_get(unit, port, pm_info, pad_size);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_port_tx_padding_get isn't implemented for driver type"));
    }
...
int portmod_port_rate_egress_ppt_set(int unit, int port, uint32 burst, uint32 nof_tiks)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_rate_egress_ppt_set) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_rate_egress_ppt_set(unit, port, pm_info, burst, nof_tiks);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_port_rate_egress_ppt_set isn't implemented for driver type"));
    }
...
int portmod_port_rate_egress_ppt_get(int unit, int port, uint32* burst, uint32* nof_tiks)
{
    ...
    if(burst == NULL) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("burst NULL parameter"));
    }
    if(nof_tiks == NULL) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("nof_tiks NULL parameter"));
    }
    /* Dispatch */
    _SOC_IF_ERR_EXIT(portmod_port_pm_type_get(unit, port, &port, &__type__));
    if(__type__ >= portmodDispatchTypeCount) { 
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_rate_egress_ppt_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_rate_egress_ppt_get(unit, port, pm_info, burst, nof_tiks);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_port_rate_egress_ppt_get isn't implemented for driver type"));
    }
...
#ifdef CPRIMOD_SUPPORT
int portmod_cpri_port_frame_config_get(int unit, int port, portmod_cpri_port_frame_config_t* config)
{
    ...
    if(SOC_E_NONE != portmod_cpri_port_frame_config_t_init(unit, config)) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("config initialization failed"));
    }
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_cpri_port_frame_config_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_cpri_port_frame_config_get(unit, port, pm_info, config);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_cpri_port_frame_config_get isn't implemented for driver type"));
    }
...
int portmod_ilkn_port_lane_enable(int unit, int port, int flags, int enable)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_ilkn_port_lane_enable) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_ilkn_port_lane_enable(unit, port, pm_info, flags, enable);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_ilkn_port_lane_enable isn't implemented for driver type"));
    }
...
int portmod_port_fault_status_t_validate(int unit, const portmod_port_fault_status_t* portmod_port_fault_status)
{        
    SOC_INIT_FUNC_DEFS;
...
int portmod_port_fault_status_t_init(int unit, portmod_port_fault_status_t* portmod_port_fault_status)
{        
    SOC_INIT_FUNC_DEFS;
    
    if(portmod_port_fault_status == NULL){
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("portmod_port_fault_status NULL parameter"));
    }
    sal_memset(portmod_port_fault_status, 0, sizeof(portmod_port_fault_status_t));
...
int portmod_port_faults_status_get(int unit, int port, portmod_port_fault_status_t* faults)
{
    ...
    if(faults == NULL) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("faults NULL parameter"));
    }
    if(SOC_E_NONE != portmod_port_fault_status_t_init(unit, faults)) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("faults initialization failed"));
    }
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_faults_status_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_faults_status_get(unit, port, pm_info, faults);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_port_faults_status_get isn't implemented for driver type"));
    }
...
int portmod_flr_timeout_t_validate(int unit, portmod_flr_timeout_t portmod_flr_timeout)
{        
    SOC_INIT_FUNC_DEFS;
...
int portmod_port_flr_config_set(int unit, int port, int enable, portmod_flr_timeout_t timeout_time)
{
    ...
    if(SOC_E_NONE != portmod_flr_timeout_t_validate(unit, timeout_time)) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("timeout_time validation failed"));
    }
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_flr_config_set) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_flr_config_set(unit, port, pm_info, enable, timeout_time);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_port_flr_config_set isn't implemented for driver type"));
    }
...
int portmod_port_flr_config_get(int unit, int port, int* enable, portmod_flr_timeout_t* timeout_time)
{
    ...
    if(timeout_time == NULL) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("timeout_time NULL parameter"));
    }
    /* Dispatch */
    _SOC_IF_ERR_EXIT(portmod_port_pm_type_get(unit, port, &port, &__type__));
    if(__type__ >= portmodDispatchTypeCount) { 
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_flr_config_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_flr_config_get(unit, port, pm_info, enable, timeout_time);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_port_flr_config_get isn't implemented for driver type"));
    }
...
int portmod_port_pmd_rx_lock_status_get(int unit, int port, uint32* pmd_lock, uint32* pmd_lock_change)
{
    ...
    if(pmd_lock == NULL) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("pmd_lock NULL parameter"));
    }
    if(pmd_lock_change == NULL) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("pmd_lock_change NULL parameter"));
    }
    /* Dispatch */
    _SOC_IF_ERR_EXIT(portmod_port_pm_type_get(unit, port, &port, &__type__));
    if(__type__ >= portmodDispatchTypeCount) { 
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_pmd_rx_lock_status_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_pmd_rx_lock_status_get(unit, port, pm_info, pmd_lock, pmd_lock_change);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_port_pmd_rx_lock_status_get isn't implemented for driver type"));
    }
...
int portmod_signal_detect_status_t_validate(int unit, const portmod_signal_detect_status_t* portmod_signal_detect_status)
{        
    SOC_INIT_FUNC_DEFS;
...
int portmod_signal_detect_status_t_init(int unit, portmod_signal_detect_status_t* portmod_signal_detect_status)
{        
    SOC_INIT_FUNC_DEFS;
    
    if(portmod_signal_detect_status == NULL){
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("portmod_signal_detect_status NULL parameter"));
    }
    sal_memset(portmod_signal_detect_status, 0, sizeof(portmod_signal_detect_status_t));
...
int portmod_port_signal_detect_status_get(int unit, int port, portmod_signal_detect_status_t* sd_status)
{
    ...
    if(sd_status == NULL) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("sd_status NULL parameter"));
    }
    if(SOC_E_NONE != portmod_signal_detect_status_t_init(unit, sd_status)) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("sd_status initialization failed"));
    }
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_signal_detect_status_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_signal_detect_status_get(unit, port, pm_info, sd_status);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_port_signal_detect_status_get isn't implemented for driver type"));
    }
...
int portmod_port_link_recovery_enable_set(int unit, int port, int enable)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_link_recovery_enable_set) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_link_recovery_enable_set(unit, port, pm_info, enable);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_port_link_recovery_enable_set isn't implemented for driver type"));
    }
...
int portmod_port_link_recovery_enable_get(int unit, int port, int* enable)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_link_recovery_enable_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_link_recovery_enable_get(unit, port, pm_info, enable);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_port_link_recovery_enable_get isn't implemented for driver type"));
    }
...
int portmod_fec_degraded_ser_config_t_validate(int unit, const portmod_fec_degraded_ser_config_t* portmod_fec_degraded_ser_config)
{        
    SOC_INIT_FUNC_DEFS;
...
int portmod_fec_degraded_ser_config_t_init(int unit, portmod_fec_degraded_ser_config_t* portmod_fec_degraded_ser_config)
{        
    SOC_INIT_FUNC_DEFS;
    
    if(portmod_fec_degraded_ser_config == NULL){
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("portmod_fec_degraded_ser_config NULL parameter"));
    }
    sal_memset(portmod_fec_degraded_ser_config, 0, sizeof(portmod_fec_degraded_ser_config_t));
...
int portmod_fec_degraded_ser_status_t_validate(int unit, const portmod_fec_degraded_ser_status_t* portmod_fec_degraded_ser_status)
{        
    SOC_INIT_FUNC_DEFS;
...
int portmod_fec_degraded_ser_status_t_init(int unit, portmod_fec_degraded_ser_status_t* portmod_fec_degraded_ser_status)
{        
    SOC_INIT_FUNC_DEFS;
    
    if(portmod_fec_degraded_ser_status == NULL){
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("portmod_fec_degraded_ser_status NULL parameter"));
    }
    sal_memset(portmod_fec_degraded_ser_status, 0, sizeof(portmod_fec_degraded_ser_status_t));
...
int portmod_fec_degraded_ser_set(int unit, int port, portmod_fec_degraded_ser_config_t config)
{
    ...
    if(SOC_E_NONE != portmod_fec_degraded_ser_config_t_validate(unit, &config)) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("config validation failed"));
    }
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_fec_degraded_ser_set) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_fec_degraded_ser_set(unit, port, pm_info, config);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_fec_degraded_ser_set isn't implemented for driver type"));
    }
...
int portmod_fec_degraded_ser_get(int unit, int port, portmod_fec_degraded_ser_config_t* config)
{
    ...
    if(SOC_E_NONE != portmod_fec_degraded_ser_config_t_init(unit, config)) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("config initialization failed"));
    }
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_fec_degraded_ser_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_fec_degraded_ser_get(unit, port, pm_info, config);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_fec_degraded_ser_get isn't implemented for driver type"));
    }
...
int portmod_fec_degraded_ser_status_get(int unit, int port, portmod_fec_degraded_ser_status_t* status)
{
    ...
    if(SOC_E_NONE != portmod_fec_degraded_ser_status_t_init(unit, status)) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("status initialization failed"));
    }
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_fec_degraded_ser_status_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_fec_degraded_ser_status_get(unit, port, pm_info, status);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_fec_degraded_ser_status_get isn't implemented for driver type"));
    }
...
int portmod_mac_rsv_fields_t_validate(int unit, portmod_mac_rsv_fields_t portmod_mac_rsv_fields)
{        
    SOC_INIT_FUNC_DEFS;
...
int portmod_port_mac_strip_crc_set(int unit, int port, uint32 enable)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_mac_strip_crc_set) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_mac_strip_crc_set(unit, port, pm_info, enable);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_port_mac_strip_crc_set isn't implemented for driver type"));
    }
...
int portmod_port_mac_strip_crc_get(int unit, int port, uint32* enable)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_mac_strip_crc_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_mac_strip_crc_get(unit, port, pm_info, enable);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_port_mac_strip_crc_get isn't implemented for driver type"));
    }
...
int portmod_mac_tx_crc_mode_t_validate(int unit, portmod_mac_tx_crc_mode_t portmod_mac_tx_crc_mode)
{        
    SOC_INIT_FUNC_DEFS;
...
int portmod_port_mac_tx_crc_mode_set(int unit, int port, portmod_mac_tx_crc_mode_t crc_mode)
{
    ...
    if(SOC_E_NONE != portmod_mac_tx_crc_mode_t_validate(unit, crc_mode)) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("crc_mode validation failed"));
    }
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_mac_tx_crc_mode_set) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_mac_tx_crc_mode_set(unit, port, pm_info, crc_mode);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_port_mac_tx_crc_mode_set isn't implemented for driver type"));
    }
...
int portmod_port_mac_tx_crc_mode_get(int unit, int port, portmod_mac_tx_crc_mode_t* crc_mode)
{
    ...
    if(crc_mode == NULL) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("crc_mode NULL parameter"));
    }
    /* Dispatch */
    _SOC_IF_ERR_EXIT(portmod_port_pm_type_get(unit, port, &port, &__type__));
    if(__type__ >= portmodDispatchTypeCount) { 
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_mac_tx_crc_mode_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_mac_tx_crc_mode_get(unit, port, pm_info, crc_mode);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_port_mac_tx_crc_mode_get isn't implemented for driver type"));
    }
...
int portmod_port_mac_rsv_mask_get(int unit, int port, uint32* rsv_mask)
{
    ...
    if(rsv_mask == NULL) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("rsv_mask NULL parameter"));
    }
    /* Dispatch */
    _SOC_IF_ERR_EXIT(portmod_port_pm_type_get(unit, port, &port, &__type__));
    if(__type__ >= portmodDispatchTypeCount) { 
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_port_mac_rsv_mask_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_port_mac_rsv_mask_get(unit, port, pm_info, rsv_mask);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_port_mac_rsv_mask_get isn't implemented for driver type"));
    }
