...
#ifdef BCM84756_FCMAP_UNUSED_FUNC
STATIC int
                                ...
                                uint32 phy_reg_addr, uint32 *phy_data)
{
  ...
  #if defined(INCLUDE_MACSEC)
    if ( flags & BMACSEC_PHY_REG_MACSEC ) {    /* MACSEC registers */
        rv = bmacsec_phy84756_macsec_reg_read(port, flags, phy_reg_addr, phy_data);
                          ...
                          uint32 phy_reg_addr, uint32 phy_data)
{
  ...
  #if defined(INCLUDE_MACSEC)
    if ( flags & BMACSEC_PHY_REG_MACSEC ) {    /* MACSEC registers */
        rv = bmacsec_phy84756_macsec_reg_write(port, flags, phy_reg_addr, phy_data);
