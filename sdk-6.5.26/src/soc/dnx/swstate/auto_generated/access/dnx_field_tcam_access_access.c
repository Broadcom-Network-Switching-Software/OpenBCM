...
dnx_field_tcam_access_sw_entry_location_hash_alloc(int unit)
{
    ...
    DNX_SW_STATE_LOG(
        ...
        unit,
        dnx_data_device.general.nof_cores_get(unit) * sizeof(sw_state_idx_htbl_t) / sizeof(*((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->entry_location_hash));
...
int
dnx_field_tcam_access_sw_entry_location_hash_create(int unit, uint32 entry_location_hash_idx_0, sw_state_idx_htbl_init_info_t *init_info)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dnx_field_tcam_access_sw_entry_location_hash_get_next(int unit, uint32 entry_location_hash_idx_0, SW_STATE_INDEX_HASH_TABLE_ITER *iter, const uint32 *key, const uint32 *data_index)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
