...
instru_counters_init_layout_structure(int unit)
{
    ...
    layout_array_instru_counters[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_INSTRU_SYNC_COUNTERS__LAST);
    ...
    layout_array_instru_counters[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_INSTRU_SYNC_COUNTERS__ICGM_COUNTES__LAST);
    ...
    layout_array_instru_counters[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_INSTRU_SYNC_COUNTERS__NIF_COUNTES__LAST);
    ...
    layout_array_instru_counters[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_INSTRU_SYNC_COUNTERS__ICGM_COUNTES__PER_CORE_INFO__LAST);
    ...
    layout_array_instru_counters[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_INSTRU_SYNC_COUNTERS__NIF_COUNTES__PER_ETHU_INFO__LAST);
