...
dnx_bier_db_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_bier_db[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_BIER_DB__LAST);
    ...
    layout_array_dnx_bier_db[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_BIER_DB__INGRESS__LAST);
    ...
    layout_array_dnx_bier_db[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_BIER_DB__EGRESS__LAST);
