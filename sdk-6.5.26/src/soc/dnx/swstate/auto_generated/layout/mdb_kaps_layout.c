...
mdb_kaps_init_layout_structure(int unit)
{
    ...
    layout_array_mdb_kaps[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_MDB_KAPS_DB__LAST);
    ...
    layout_array_mdb_kaps[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_MDB_KAPS_DB__DB_INFO__LAST);
    ...
    layout_array_mdb_kaps[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_MDB_KAPS_DB__SEARCH_INSTRUCTION_INFO__LAST);
    layout_array_mdb_kaps[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_LEAF_STRUCT;
