...
dnx_field_qualifier_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_field_qualifier[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_QUAL_SW_DB__LAST);
    ...
    layout_array_dnx_field_qualifier[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_QUAL_SW_DB__INFO__LAST);
    ...
    layout_array_dnx_field_qualifier[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_QUAL_SW_DB__PREDEFINED__LAST);
    layout_array_dnx_field_qualifier[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
    ...
    layout_array_dnx_field_qualifier[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_QUAL_SW_DB__LAYER_RECORD__LAST);
    layout_array_dnx_field_qualifier[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
