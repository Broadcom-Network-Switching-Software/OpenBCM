...
dnx_field_tcam_hit_indication_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_field_tcam_hit_indication[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_TCAM_HIT_INDICATION__LAST);
    ...
    layout_array_dnx_field_tcam_hit_indication[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_TCAM_HIT_INDICATION__TCAM_ACTION_HIT_INDICATION__LAST);
    ...
    layout_array_dnx_field_tcam_hit_indication[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_TCAM_HIT_INDICATION__TCAM_ACTION_HIT_INDICATION_SMALL__LAST);
