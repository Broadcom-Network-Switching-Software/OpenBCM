...
dnx_hard_reset_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_hard_reset[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_HARD_RESET_DB__LAST);
    ...
    layout_array_dnx_hard_reset[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_HARD_RESET_DB__HARD_RESET_CALLBACK__LAST);
