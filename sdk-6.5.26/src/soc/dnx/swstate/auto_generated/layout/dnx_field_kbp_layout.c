...
dnx_field_kbp_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_field_kbp[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_KBP_SW__LAST);
    ...
    layout_array_dnx_field_kbp[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_KBP_SW__OPCODE_INFO__LAST);
    ...
    layout_array_dnx_field_kbp[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_KBP_SW__OPCODE_INFO__MASTER_KEY_INFO__LAST);
    layout_array_dnx_field_kbp[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
    ...
    layout_array_dnx_field_kbp[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_KBP_SW__OPCODE_INFO__MASTER_KEY_INFO__SEGMENT_INFO__LAST);
    layout_array_dnx_field_kbp[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
