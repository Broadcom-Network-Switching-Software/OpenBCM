...
dnx_algo_lane_map_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_algo_lane_map[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_algo_lane_map[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_LANE_MAP_DB__LAST);
    ...
    layout_array_dnx_algo_lane_map[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_LANE_MAP_DB__LANE_MAP__LAST);
    ...
    layout_array_dnx_algo_lane_map[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_LANE_MAP_DB__OTN__LAST);
    ...
    layout_array_dnx_algo_lane_map[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_LANE_MAP_DB__LANE_MAP__LANE2SERDES__LAST);
    ...
    layout_array_dnx_algo_lane_map[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_LANE_MAP_DB__LANE_MAP__SERDES2LANE__LAST);
    layout_array_dnx_algo_lane_map[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
    ...
    layout_array_dnx_algo_lane_map[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_LANE_MAP_DB__OTN__LOGICAL_LANE_MAP__LAST);
