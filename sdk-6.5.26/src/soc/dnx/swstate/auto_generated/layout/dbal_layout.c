...
dbal_init_layout_structure(int unit)
{
    ...
    layout_array_dbal[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DBAL_DB__LAST);
    ...
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DBAL_DB__SW_TABLES__LAST);
    ...
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DBAL_DB__MDB_ACCESS__LAST);
    ...
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DBAL_DB__MDB_PHY_TABLES__LAST);
    ...
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DBAL_DB__TABLES_PROPERTIES__LAST);
    ...
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_TABLES__LAST);
    ...
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DBAL_DB__DBAL_DYNAMIC_XML_TABLES__LAST);
    ...
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DBAL_DB__DBAL_FIELDS__LAST);
    ...
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DBAL_DB__DBAL_PPMC_TABLE_RES_TYPES__LAST);
    ...
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DBAL_DB__FIELD_NAMES_OVERRIDE_STRINGS__LAST);
    ...
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DBAL_DB__TABLES_PROPERTIES__ITERATOR_OPTIMIZED__LAST);
    ...
    idx = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DBAL_DB__DBAL_FIELDS__FIELD_ID);
    layout_array_dbal[idx].name = "dbal_db__dbal_fields__field_id";
    layout_array_dbal[idx].type = "dbal_fields_e";
    layout_array_dbal[idx].doc = "the dynamic field id";
    layout_array_dbal[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].size_of = sizeof(dbal_fields_e);
    ...
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DBAL_DB__DBAL_PPMC_TABLE_RES_TYPES__MULTI_RES_INFO_DATA_SEP__LAST);
    ...
    layout_array_dbal[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].size_of = sizeof(multi_res_info_t);
    layout_array_dbal[idx].parent  = 46;
    layout_array_dbal[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_ACCESS_PTR;
