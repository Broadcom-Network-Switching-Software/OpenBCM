...
dnx_field_flush_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_field_flush[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_FLUSH_SW__LAST);
    ...
    layout_array_dnx_field_flush[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_FLUSH_SW__FLUSH_PROFILE__LAST);
