...
reflector_init_layout_structure(int unit)
{
    ...
    layout_array_reflector[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_REFLECTOR_SW_DB_INFO__LAST);
    ...
    layout_array_reflector[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_REFLECTOR_SW_DB_INFO__UC__LAST);
    ...
    layout_array_reflector[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_REFLECTOR_SW_DB_INFO__UC_L2_INT__LAST);
    ...
    layout_array_reflector[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_REFLECTOR_SW_DB_INFO__UC_L2_INT_ONEPASS__LAST);
