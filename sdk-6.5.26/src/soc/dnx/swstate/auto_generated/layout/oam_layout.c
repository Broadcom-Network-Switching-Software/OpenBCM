...
oam_init_layout_structure(int unit)
{
    ...
    layout_array_oam[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_OAM_SW_DB_INFO__LAST);
    ...
    layout_array_oam[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_OAM_SW_DB_INFO__OAM_GROUP_SW_DB_INFO__LAST);
    ...
    layout_array_oam[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_OAM_SW_DB_INFO__OAM_ENDPOINT_SW_DB_INFO__LAST);
    ...
    layout_array_oam[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_OAM_SW_DB_INFO__REFLECTOR__LAST);
