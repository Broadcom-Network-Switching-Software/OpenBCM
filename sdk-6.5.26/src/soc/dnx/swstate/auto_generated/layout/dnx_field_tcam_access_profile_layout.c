...
dnx_field_tcam_access_profile_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_field_tcam_access_profile[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_PROFILE_SW__LAST);
    ...
    layout_array_dnx_field_tcam_access_profile[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_PROFILE_SW__ACCESS_PROFILES__LAST);
