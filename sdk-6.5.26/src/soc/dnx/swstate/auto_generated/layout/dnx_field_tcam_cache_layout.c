...
dnx_field_tcam_cache_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_field_tcam_cache[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_TCAM_CACHE_SHADOW__LAST);
    ...
    layout_array_dnx_field_tcam_cache[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_TCAM_CACHE_SHADOW__TCAM_BANK__LAST);
    ...
    layout_array_dnx_field_tcam_cache[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_TCAM_CACHE_SHADOW__PAYLOAD_TABLE__LAST);
    ...
    layout_array_dnx_field_tcam_cache[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_TCAM_CACHE_SHADOW__TCAM_BANK__ENTRY_KEY__LAST);
    ...
    layout_array_dnx_field_tcam_cache[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_TCAM_CACHE_SHADOW__PAYLOAD_TABLE__ENTRY_PAYLOAD__LAST);
