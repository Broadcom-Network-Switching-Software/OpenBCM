...
dnx_field_tcam_location_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_field_tcam_location[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_TCAM_LOCATION_SW__LAST);
    ...
    layout_array_dnx_field_tcam_location[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_TCAM_LOCATION_SW__TCAM_HANDLERS_INFO__LAST);
