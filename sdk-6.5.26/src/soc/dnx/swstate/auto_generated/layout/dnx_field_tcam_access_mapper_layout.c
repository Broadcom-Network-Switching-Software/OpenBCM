...
dnx_field_tcam_access_mapper_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_field_tcam_access_mapper[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_MAPPER_SW__LAST);
    ...
    layout_array_dnx_field_tcam_access_mapper[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_MAPPER_SW__KEY_2_LOCATION_HASH__LAST);
