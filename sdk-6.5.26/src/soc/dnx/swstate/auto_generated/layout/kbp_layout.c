...
kbp_init_layout_structure(int unit)
{
    ...
    layout_array_kbp[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_KBP_SW_STATE__LAST);
    ...
    layout_array_kbp[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_KBP_SW_STATE__DB_HANDLES_INFO__LAST);
    ...
    layout_array_kbp[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_KBP_SW_STATE__INSTRUCTION_INFO__LAST);
    layout_array_kbp[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
