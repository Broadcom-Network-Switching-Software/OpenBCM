...
flow_init_layout_structure(int unit)
{
    ...
    layout_array_flow[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_FLOW_DB__LAST);
    ...
    layout_array_flow[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_FLOW_DB__FLOW_APPLICATION_INFO__LAST);
