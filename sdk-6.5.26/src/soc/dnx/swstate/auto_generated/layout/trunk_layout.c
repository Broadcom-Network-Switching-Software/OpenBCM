...
trunk_init_layout_structure(int unit)
{
    ...
    layout_array_trunk[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_TRUNK_DB__LAST);
    ...
    layout_array_trunk[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_TRUNK_DB__POOLS__LAST);
    ...
    layout_array_trunk[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_TRUNK_DB__TRUNK_SYSTEM_PORT_DB__LAST);
    ...
    layout_array_trunk[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_TRUNK_DB__PSC_GENERAL_INFO__LAST);
    ...
    layout_array_trunk[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__LAST);
    ...
    layout_array_trunk[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__MEMBERS__LAST);
    ...
    layout_array_trunk[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_TRUNK_DB__TRUNK_SYSTEM_PORT_DB__TRUNK_SYSTEM_PORT_ENTRIES__LAST);
    layout_array_trunk[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_ARRAY_RANGE_FUNCTIONS | DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION ;
    ...
    layout_array_trunk[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_TRUNK_DB__PSC_GENERAL_INFO__PROFILE_INFO__LAST);
    layout_array_trunk[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_ARRAY_RANGE_FUNCTIONS | DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION ;
