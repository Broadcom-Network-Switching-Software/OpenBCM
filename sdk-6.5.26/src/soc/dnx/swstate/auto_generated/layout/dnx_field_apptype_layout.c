...
dnx_field_apptype_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_field_apptype[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_field_apptype[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_APPTYPE_SW__LAST);
    ...
    layout_array_dnx_field_apptype[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_APPTYPE_SW__PREDEF_INFO__LAST);
    ...
    layout_array_dnx_field_apptype[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_APPTYPE_SW__USER_DEF_INFO__LAST);
    layout_array_dnx_field_apptype[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
