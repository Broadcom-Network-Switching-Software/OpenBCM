...
dnx_ecgm_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_ecgm[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_ecgm[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ECGM_DB__LAST);
    ...
    layout_array_dnx_ecgm[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ECGM_DB__INTERFACE_CACHING__LAST);
    ...
    layout_array_dnx_ecgm[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ECGM_DB__PORT_CACHING__LAST);
