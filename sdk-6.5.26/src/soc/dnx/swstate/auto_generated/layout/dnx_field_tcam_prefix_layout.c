...
dnx_field_tcam_prefix_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_field_tcam_prefix[idx].doc = "Holds information about prefixes for each TCAM bank per core";
    layout_array_dnx_field_tcam_prefix[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_field_tcam_prefix[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_TCAM_PREFIX_SW__LAST);
    ...
    layout_array_dnx_field_tcam_prefix[idx].doc = "Info about prefixes per TCAM bank and per core";
    layout_array_dnx_field_tcam_prefix[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_field_tcam_prefix[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_TCAM_PREFIX_SW__BANKS_PREFIX__LAST);
    ...
    layout_array_dnx_field_tcam_prefix[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_FIELD_TCAM_PREFIX_SW__BANKS_PREFIX__CORE_PREFIX_MAP__LAST);
    ...
    layout_array_dnx_field_tcam_prefix[idx].doc = "Map between prefixes in the stage and the corresponding handlers occupying them";
