...
dnx_sch_config_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_sch_config[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_COSQ_CONFIG__FIRST);
    layout_array_dnx_sch_config[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_COSQ_CONFIG__LAST);
    ...
    layout_array_dnx_sch_config[idx].array_indexes[0].num_elements = DNX_DATA_MAX_DEVICE_GENERAL_NOF_CORES;
    layout_array_dnx_sch_config[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_sch_config[idx].array_indexes[1].num_elements = dnx_data_sch.flow.nof_hr_get(unit);
    ...
    layout_array_dnx_sch_config[idx].array_indexes[0].num_elements = DNX_DATA_MAX_DEVICE_GENERAL_NOF_CORES;
    layout_array_dnx_sch_config[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_sch_config[idx].array_indexes[1].num_elements = 3;
    ...
    layout_array_dnx_sch_config[idx].array_indexes[0].num_elements = DNX_DATA_MAX_DEVICE_GENERAL_NOF_CORES;
    layout_array_dnx_sch_config[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_sch_config[idx].array_indexes[1].num_elements = dnx_data_sch.flow.nof_flows_get(unit);
    layout_array_dnx_sch_config[idx].array_indexes[1].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    layout_array_dnx_sch_config[idx].parent  = 0;
    layout_array_dnx_sch_config[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_COSQ_CONFIG__FLOW__FIRST);
    layout_array_dnx_sch_config[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_COSQ_CONFIG__FLOW__LAST);
    ...
    layout_array_dnx_sch_config[idx].array_indexes[1].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    layout_array_dnx_sch_config[idx].parent  = 0;
    layout_array_dnx_sch_config[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_COSQ_CONFIG__CONNECTOR__FIRST);
    layout_array_dnx_sch_config[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_COSQ_CONFIG__CONNECTOR__LAST);
    ...
    layout_array_dnx_sch_config[idx].array_indexes[0].num_elements = DNX_DATA_MAX_DEVICE_GENERAL_NOF_CORES;
    layout_array_dnx_sch_config[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_sch_config[idx].array_indexes[1].num_elements = dnx_data_sch.flow.nof_se_get(unit);
    layout_array_dnx_sch_config[idx].array_indexes[1].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    layout_array_dnx_sch_config[idx].parent  = 0;
    layout_array_dnx_sch_config[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_COSQ_CONFIG__SE__FIRST);
    layout_array_dnx_sch_config[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_COSQ_CONFIG__SE__LAST);
    ...
    layout_array_dnx_sch_config[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_COSQ_CONFIG__FLOW__CREDIT_SRC__FIRST);
    layout_array_dnx_sch_config[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_COSQ_CONFIG__FLOW__CREDIT_SRC__LAST);
    layout_array_dnx_sch_config[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
