...
dnx_iqs_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_iqs[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_IQS_DB__LAST);
    ...
    layout_array_dnx_iqs[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_IQS_DB__CREDIT_REQUEST_PROFILE__LAST);
    ...
    layout_array_dnx_iqs[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_IQS_DB__CREDIT_WATCHDOG__LAST);
    ...
    layout_array_dnx_iqs[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_IQS_DB__DELETE_CREDIT_REQUEST_PROFILE__LAST);
