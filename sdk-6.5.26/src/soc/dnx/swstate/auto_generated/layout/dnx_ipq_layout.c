...
dnx_ipq_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_ipq[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_IPQ_DB__FIRST);
    layout_array_dnx_ipq[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_IPQ_DB__LAST);
    ...
    layout_array_dnx_ipq[idx].array_indexes[0].num_elements = dnx_data_device.general.nof_cores_get(unit);
    layout_array_dnx_ipq[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    layout_array_dnx_ipq[idx].array_indexes[1].num_elements = dnx_data_ipq.queues.nof_queues_get(unit);
    ...
    layout_array_dnx_ipq[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_IPQ_DB__BASE_QUEUES__FIRST);
    layout_array_dnx_ipq[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_IPQ_DB__BASE_QUEUES__LAST);
    ...
    layout_array_dnx_ipq[idx].array_indexes[0].num_elements = dnx_data_ipq.queues.nof_queues_get(unit);
