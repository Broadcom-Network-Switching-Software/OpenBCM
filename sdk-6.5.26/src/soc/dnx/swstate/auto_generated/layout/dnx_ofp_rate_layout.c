...
dnx_ofp_rate_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_ofp_rate[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_OFP_RATE_DB__LAST);
    ...
    layout_array_dnx_ofp_rate[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_OFP_RATE_DB__OTM__LAST);
    ...
    layout_array_dnx_ofp_rate[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_OFP_RATE_DB__QPAIR__LAST);
    ...
    layout_array_dnx_ofp_rate[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_OFP_RATE_DB__TCG__LAST);
    ...
    layout_array_dnx_ofp_rate[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_OFP_RATE_DB__OTM_CAL__LAST);
    ...
    layout_array_dnx_ofp_rate[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_OFP_RATE_DB__OTM__SHAPING__LAST);
