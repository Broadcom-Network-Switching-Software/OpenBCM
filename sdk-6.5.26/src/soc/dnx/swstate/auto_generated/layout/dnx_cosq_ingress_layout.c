...
dnx_cosq_ingress_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_cosq_ingress[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_COSQ_INGRESS_DB__LAST);
    ...
    layout_array_dnx_cosq_ingress[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_COSQ_INGRESS_DB__FIXED_PRIORITY__LAST);
