...
dnx_algo_mib_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_algo_mib[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_algo_mib[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_MIB_DB__LAST);
    ...
    layout_array_dnx_algo_mib[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_MIB_DB__MIB__LAST);
