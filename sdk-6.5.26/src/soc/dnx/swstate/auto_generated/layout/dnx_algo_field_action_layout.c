...
dnx_algo_field_action_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_algo_field_action[idx].doc = "Hold the needed info to manage the Algo Field Action module.";
    layout_array_dnx_algo_field_action[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_algo_field_action[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_FIELD_ACTION_SW__LAST);
    ...
    layout_array_dnx_algo_field_action[idx].doc = "Hold the needed info to manage the Algo Field Action module for iPMF-2.";
    layout_array_dnx_algo_field_action[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_algo_field_action[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_FIELD_ACTION_SW__IPMF2__LAST);
    ...
    layout_array_dnx_algo_field_action[idx].doc = "Hold the needed info to manage the Algo Field Action module for iPMF-3.";
    layout_array_dnx_algo_field_action[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_algo_field_action[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_FIELD_ACTION_SW__IPMF3__LAST);
    layout_array_dnx_algo_field_action[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
    ...
    layout_array_dnx_algo_field_action[idx].doc = "Hold the needed info to manage the Algo Field Action module for ePMF-1.";
    layout_array_dnx_algo_field_action[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_algo_field_action[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_FIELD_ACTION_SW__EPMF__LAST);
    layout_array_dnx_algo_field_action[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
    ...
    layout_array_dnx_algo_field_action[idx].doc = "Hold the needed info for FEM allocation.";
    layout_array_dnx_algo_field_action[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_algo_field_action[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_FIELD_ACTION_SW__FEM__LAST);
    layout_array_dnx_algo_field_action[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
    ...
    layout_array_dnx_algo_field_action[idx].doc = "Hold the needed info to manage the Algo Field Action module, given by FES ID. Includes the zero mask.";
    layout_array_dnx_algo_field_action[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_algo_field_action[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_FIELD_ACTION_SW__IPMF2__FES_STATE__LAST);
    layout_array_dnx_algo_field_action[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
    ...
    layout_array_dnx_algo_field_action[idx].doc = "Hold the needed info to manage the Algo Field Action module, given by context ID.";
    layout_array_dnx_algo_field_action[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_algo_field_action[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_FIELD_ACTION_SW__IPMF2__CONTEXT_STATE__LAST);
    ...
    layout_array_dnx_algo_field_action[idx].doc = "The ordinal place (index) of the FES quartet in the field group (payload). \n                                                           Note we treat all four FES2msb IDS as one unit and do not split them between dofferent foeld groups.";
    layout_array_dnx_algo_field_action[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_algo_field_action[idx].type = "uint8";
    layout_array_dnx_algo_field_action[idx].doc = "Holds for each action mask in the FES ID whether it is allocated. Includes the zero mask.";
    layout_array_dnx_algo_field_action[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_field_action[idx].size_of = sizeof(uint8);
    ...
    layout_array_dnx_algo_field_action[idx].doc = "The priority for each FES quartet in the context ID. \n                                                           Note we treat all four FES2msb IDS as one unit and do not split them between dofferent foeld groups.";
    ...
    layout_array_dnx_algo_field_action[idx].type = "dnx_algo_field_action_fes_state_t";
    layout_array_dnx_algo_field_action[idx].doc = "Hold the needed info to manage the Algo Field Action module, given by FES ID.";
    layout_array_dnx_algo_field_action[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_field_action[idx].size_of = sizeof(dnx_algo_field_action_fes_state_t);
    ...
    layout_array_dnx_algo_field_action[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_FIELD_ACTION_SW__IPMF3__FES_STATE__LAST);
    layout_array_dnx_algo_field_action[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
    ...
    layout_array_dnx_algo_field_action[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_FIELD_ACTION_SW__IPMF3__CONTEXT_STATE__LAST);
    ...
    layout_array_dnx_algo_field_action[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_FIELD_ACTION_SW__EPMF__FES_STATE__LAST);
    layout_array_dnx_algo_field_action[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
    ...
    layout_array_dnx_algo_field_action[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_ALGO_FIELD_ACTION_SW__EPMF__CONTEXT_STATE__LAST);
    ...
    layout_array_dnx_algo_field_action[idx].type = "uint8";
    layout_array_dnx_algo_field_action[idx].doc = "Indication for each program in FEM ID if it was allocated with specific position.";
    layout_array_dnx_algo_field_action[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_field_action[idx].size_of = sizeof(uint8);
