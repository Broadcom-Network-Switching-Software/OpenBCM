...
dnx_ire_packet_generator_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_ire_packet_generator[idx].first_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_IRE_PACKET_GENERATOR_INFO__FIRST);
    layout_array_dnx_ire_packet_generator[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_IRE_PACKET_GENERATOR_INFO__LAST);
