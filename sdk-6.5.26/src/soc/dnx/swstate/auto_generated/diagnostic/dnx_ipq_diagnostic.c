...
dnx_ipq_db_base_queues_num_cos_dump(int  unit,  int  base_queues_idx_0,  int  base_queues_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_IPQ_DB__BASE_QUEUES__NUM_COS, ((dnx_ipq_db_t*)sw_state_roots_array[unit][DNX_IPQ_MODULE_ID])->base_queues))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_IPQ_DB__BASE_QUEUES__NUM_COS, ((dnx_ipq_db_t*)sw_state_roots_array[unit][DNX_IPQ_MODULE_ID])->base_queues) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_IPQ_DB__BASE_QUEUES__NUM_COS, ((dnx_ipq_db_t*)sw_state_roots_array[unit][DNX_IPQ_MODULE_ID])->base_queues[i0]))
            {
                LOG_CLI((BSL_META("dnx_ipq_db[]->((dnx_ipq_db_t*)sw_state_roots_array[][DNX_IPQ_MODULE_ID])->base_queues[][].num_cos: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_IPQ_DB__BASE_QUEUES__NUM_COS, ((dnx_ipq_db_t*)sw_state_roots_array[unit][DNX_IPQ_MODULE_ID])->base_queues[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_ipq_db_base_queues_sys_port_ref_counter_dump(int  unit,  int  base_queues_idx_0,  int  base_queues_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_IPQ_DB__BASE_QUEUES__SYS_PORT_REF_COUNTER, ((dnx_ipq_db_t*)sw_state_roots_array[unit][DNX_IPQ_MODULE_ID])->base_queues))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_IPQ_DB__BASE_QUEUES__SYS_PORT_REF_COUNTER, ((dnx_ipq_db_t*)sw_state_roots_array[unit][DNX_IPQ_MODULE_ID])->base_queues) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_IPQ_DB__BASE_QUEUES__SYS_PORT_REF_COUNTER, ((dnx_ipq_db_t*)sw_state_roots_array[unit][DNX_IPQ_MODULE_ID])->base_queues[i0]))
            {
                LOG_CLI((BSL_META("dnx_ipq_db[]->((dnx_ipq_db_t*)sw_state_roots_array[][DNX_IPQ_MODULE_ID])->base_queues[][].sys_port_ref_counter: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_IPQ_DB__BASE_QUEUES__SYS_PORT_REF_COUNTER, ((dnx_ipq_db_t*)sw_state_roots_array[unit][DNX_IPQ_MODULE_ID])->base_queues[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_ipq_db_base_queue_is_asymm_dump(int  unit,  int  base_queue_is_asymm_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_IPQ_DB__BASE_QUEUE_IS_ASYMM, ((dnx_ipq_db_t*)sw_state_roots_array[unit][DNX_IPQ_MODULE_ID])->base_queue_is_asymm))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_IPQ_DB__BASE_QUEUE_IS_ASYMM, ((dnx_ipq_db_t*)sw_state_roots_array[unit][DNX_IPQ_MODULE_ID])->base_queue_is_asymm) == 0)
        {
            SHR_EXIT();
        }
