...
dnx_egr_db_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(dnx_egr_db_total_egr_if_credits_dump(unit, -1, filters));
    SHR_IF_ERR_EXIT(dnx_egr_db_egr_if_credits_configured_dump(unit, -1, -1, filters));
    SHR_IF_ERR_EXIT(dnx_egr_db_total_esb_queues_allocated_dump(unit, -1, filters));
    SHR_IF_ERR_EXIT(dnx_egr_db_nof_negative_compensation_ports_dump(unit, -1, filters));
...
int
dnx_egr_db_total_egr_if_credits_dump(int  unit,  int  total_egr_if_credits_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = total_egr_if_credits_idx_0, I0 = total_egr_if_credits_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    else
    {
        ...
        if (i0 == -1) {
            ...
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ...
                , sizeof(*((dnx_egr_db_t*)sw_state_roots_array[unit][DNX_EGR_DB_MODULE_ID])->total_egr_if_credits), I0, &s0) ? I0 - 1 : 0;
        }

        if(i0 >= DNX_DATA_MAX_DEVICE_GENERAL_NOF_CORES)
        {
            LOG_CLI((BSL_META("dnx_egr_db[]->((dnx_egr_db_t*)sw_state_roots_array[][DNX_EGR_DB_MODULE_ID])->total_egr_if_credits[]: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "dnx_egr_db[%d]->","((dnx_egr_db_t*)sw_state_roots_array[%d][DNX_EGR_DB_MODULE_ID])->","total_egr_if_credits[%s%d]: ", s0, i0);
            ...
            dnx_sw_state_print_int(
                unit,
                &((dnx_egr_db_t*)sw_state_roots_array[unit][DNX_EGR_DB_MODULE_ID])->total_egr_if_credits[i0]);
...
int
dnx_egr_db_egr_if_credits_configured_dump(int  unit,  int  egr_if_credits_configured_idx_0,  int  egr_if_credits_configured_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = egr_if_credits_configured_idx_0, I0 = egr_if_credits_configured_idx_0 + 1;
    int i1 = egr_if_credits_configured_idx_1, I1 = egr_if_credits_configured_idx_1 + 1, org_i1 = egr_if_credits_configured_idx_1;
    char *s0 = "", *s1 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_egr_db egr_if_credits_configured") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_egr_db egr_if_credits_configured\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_egr_db/egr_if_credits_configured.txt",
            "dnx_egr_db[%d]->","((dnx_egr_db_t*)sw_state_roots_array[%d][DNX_EGR_DB_MODULE_ID])->","egr_if_credits_configured[][]: ");
        ...
        if (i0 == -1) {
            I0 = DNX_DATA_MAX_DEVICE_GENERAL_NOF_CORES;
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ((dnx_egr_db_t*)sw_state_roots_array[unit][DNX_EGR_DB_MODULE_ID])->egr_if_credits_configured
                , sizeof(*((dnx_egr_db_t*)sw_state_roots_array[unit][DNX_EGR_DB_MODULE_ID])->egr_if_credits_configured), I0, &s0) ? I0 - 1 : 0;
        }

        if(i0 >= DNX_DATA_MAX_DEVICE_GENERAL_NOF_CORES)
        {
            LOG_CLI((BSL_META("dnx_egr_db[]->((dnx_egr_db_t*)sw_state_roots_array[][DNX_EGR_DB_MODULE_ID])->egr_if_credits_configured[][]: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            if (i1 == -1) {
                I1 = DNX_DATA_MAX_EGR_QUEUING_PARAMS_NOF_EGR_INTERFACES;
                i1 = dnx_sw_state_dump_check_all_the_same(unit,
                    ((dnx_egr_db_t*)sw_state_roots_array[unit][DNX_EGR_DB_MODULE_ID])->egr_if_credits_configured[i0]
                    , sizeof(*((dnx_egr_db_t*)sw_state_roots_array[unit][DNX_EGR_DB_MODULE_ID])->egr_if_credits_configured[i0]), I1, &s1) ? I1 - 1 : 0;
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                DNX_SW_STATE_PRINT_MONITOR(
                    unit,
                    "dnx_egr_db[%d]->","((dnx_egr_db_t*)sw_state_roots_array[%d][DNX_EGR_DB_MODULE_ID])->","egr_if_credits_configured[%s%d][%s%d]: ", s0, i0, s1, i1);
                ...
                dnx_sw_state_print_uint8(
                    unit,
                    &((dnx_egr_db_t*)sw_state_roots_array[unit][DNX_EGR_DB_MODULE_ID])->egr_if_credits_configured[i0][i1]);
...
int
dnx_egr_db_total_esb_queues_allocated_dump(int  unit,  int  total_esb_queues_allocated_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = total_esb_queues_allocated_idx_0, I0 = total_esb_queues_allocated_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_egr_db total_esb_queues_allocated") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_egr_db total_esb_queues_allocated\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_egr_db/total_esb_queues_allocated.txt",
            "dnx_egr_db[%d]->","((dnx_egr_db_t*)sw_state_roots_array[%d][DNX_EGR_DB_MODULE_ID])->","total_esb_queues_allocated[]: ");
        ...
        if (i0 == -1) {
            I0 = DNX_DATA_MAX_DEVICE_GENERAL_NOF_CORES;
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ((dnx_egr_db_t*)sw_state_roots_array[unit][DNX_EGR_DB_MODULE_ID])->total_esb_queues_allocated
                , sizeof(*((dnx_egr_db_t*)sw_state_roots_array[unit][DNX_EGR_DB_MODULE_ID])->total_esb_queues_allocated), I0, &s0) ? I0 - 1 : 0;
        }

        if(i0 >= DNX_DATA_MAX_DEVICE_GENERAL_NOF_CORES)
        {
            LOG_CLI((BSL_META("dnx_egr_db[]->((dnx_egr_db_t*)sw_state_roots_array[][DNX_EGR_DB_MODULE_ID])->total_esb_queues_allocated[]: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "dnx_egr_db[%d]->","((dnx_egr_db_t*)sw_state_roots_array[%d][DNX_EGR_DB_MODULE_ID])->","total_esb_queues_allocated[%s%d]: ", s0, i0);
            ...
            dnx_sw_state_print_int(
                unit,
                &((dnx_egr_db_t*)sw_state_roots_array[unit][DNX_EGR_DB_MODULE_ID])->total_esb_queues_allocated[i0]);
...
int
dnx_egr_db_nof_negative_compensation_ports_dump(int  unit,  int  nof_negative_compensation_ports_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = nof_negative_compensation_ports_idx_0, I0 = nof_negative_compensation_ports_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_egr_db nof_negative_compensation_ports") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_egr_db nof_negative_compensation_ports\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_egr_db/nof_negative_compensation_ports.txt",
            "dnx_egr_db[%d]->","((dnx_egr_db_t*)sw_state_roots_array[%d][DNX_EGR_DB_MODULE_ID])->","nof_negative_compensation_ports[]: ");
        ...
        if (i0 == -1) {
            I0 = DNX_DATA_MAX_DEVICE_GENERAL_NOF_CORES;
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ((dnx_egr_db_t*)sw_state_roots_array[unit][DNX_EGR_DB_MODULE_ID])->nof_negative_compensation_ports
                , sizeof(*((dnx_egr_db_t*)sw_state_roots_array[unit][DNX_EGR_DB_MODULE_ID])->nof_negative_compensation_ports), I0, &s0) ? I0 - 1 : 0;
        }

        if(i0 >= DNX_DATA_MAX_DEVICE_GENERAL_NOF_CORES)
        {
            LOG_CLI((BSL_META("dnx_egr_db[]->((dnx_egr_db_t*)sw_state_roots_array[][DNX_EGR_DB_MODULE_ID])->nof_negative_compensation_ports[]: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "dnx_egr_db[%d]->","((dnx_egr_db_t*)sw_state_roots_array[%d][DNX_EGR_DB_MODULE_ID])->","nof_negative_compensation_ports[%s%d]: ", s0, i0);
            ...
            dnx_sw_state_print_int(
                unit,
                &((dnx_egr_db_t*)sw_state_roots_array[unit][DNX_EGR_DB_MODULE_ID])->nof_negative_compensation_ports[i0]);
...
const char* dnx_egr_db_layout_str[DNX_EGR_DB_INFO_NOF_ENTRIES] = {
    ...
    "DNX_EGR_DB~EGR_IF_CREDITS_CONFIGURED~",
    "DNX_EGR_DB~TOTAL_ESB_QUEUES_ALLOCATED~",
    "DNX_EGR_DB~NOF_NEGATIVE_COMPENSATION_PORTS~",
};
#endif 
