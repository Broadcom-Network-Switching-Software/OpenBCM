    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_ENUM(
                unit,
                dnx_field_range_type_e_get_name(((dnx_field_range_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_RANGE_MODULE_ID])->ext_l4_ops_range_types[i0]));
...
dnx_field_range_sw_db_ext_l4_ops_ffc_quals_qual_info_dump(int  unit,  int  ext_l4_ops_ffc_quals_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_range_sw_db_ext_l4_ops_ffc_quals_qual_info_base_qual_dump(unit, ext_l4_ops_ffc_quals_idx_0, filters));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
dnx_field_range_sw_db_ext_l4_ops_ffc_quals_qual_info_input_type_dump(int  unit,  int  ext_l4_ops_ffc_quals_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_ENUM(
                unit,
                dnx_field_input_type_e_get_name(((dnx_field_range_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_RANGE_MODULE_ID])->ext_l4_ops_ffc_quals[i0].qual_info.input_type));
...
int
dnx_field_range_sw_db_ext_l4_ops_ffc_quals_qual_info_base_qual_dump(int  unit,  int  ext_l4_ops_ffc_quals_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = ext_l4_ops_ffc_quals_idx_0, I0 = ext_l4_ops_ffc_quals_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_field_range ext_l4_ops_ffc_quals qual_info base_qual") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_field_range ext_l4_ops_ffc_quals qual_info base_qual\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_field_range_sw_db/ext_l4_ops_ffc_quals/qual_info/base_qual.txt",
            "dnx_field_range_sw_db[%d]->","((dnx_field_range_sw_db_t*)sw_state_roots_array[%d][DNX_FIELD_RANGE_MODULE_ID])->","ext_l4_ops_ffc_quals[].qual_info.base_qual: ");
        ...
        if(i0 >= DNX_DATA_MAX_FIELD_L4_OPS_NOF_CONFIGURABLE_RANGES)
        {
            LOG_CLI((BSL_META("dnx_field_range_sw_db[]->((dnx_field_range_sw_db_t*)sw_state_roots_array[][DNX_FIELD_RANGE_MODULE_ID])->ext_l4_ops_ffc_quals[].qual_info.base_qual: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_OPAQUE_MONITOR(
                unit,
                ((dnx_field_range_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_RANGE_MODULE_ID])->ext_l4_ops_ffc_quals[i0].qual_info.base_qual,
                "dnx_field_range_sw_db[%d]->","((dnx_field_range_sw_db_t*)sw_state_roots_array[%d][DNX_FIELD_RANGE_MODULE_ID])->","ext_l4_ops_ffc_quals[%s%d].qual_info.base_qual: ", s0, i0);
...
const char* dnx_field_range_sw_db_layout_str[DNX_FIELD_RANGE_SW_DB_INFO_NOF_ENTRIES] = {
    ...
    "DNX_FIELD_RANGE_SW_DB~EXT_L4_OPS_FFC_QUALS~QUAL_INFO~BASE_QUAL~",
};
#endif 
