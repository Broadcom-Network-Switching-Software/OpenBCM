...
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_mode_dump(int  unit,  int  context_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_1__MODE, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_1__MODE, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_ENUM(
                unit,
                dnx_field_context_compare_mode_e_get_name(((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[i0].context_ipmf1_info.compare_info.pair_1.mode));
...
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_is_set_dump(int  unit,  int  context_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_1__IS_SET, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_1__IS_SET, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
...
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_key_info_key_template_key_qual_map_qual_type_dump(int  unit,  int  context_info_idx_0,  int  key_info_idx_0,  int  key_qual_map_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_1__KEY_INFO__KEY_TEMPLATE__KEY_QUAL_MAP__QUAL_TYPE, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_1__KEY_INFO__KEY_TEMPLATE__KEY_QUAL_MAP__QUAL_TYPE, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            if (i1 == -1) {
                I1 = DNX_DATA_MAX_FIELD_COMPARE_NOF_KEYS;
            ...
            if(i1 >= DNX_DATA_MAX_FIELD_COMPARE_NOF_KEYS)
            {
                LOG_CLI((BSL_META("dnx_field_context_sw[]->((dnx_field_context_sw_t*)sw_state_roots_array[][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[].context_ipmf1_info.compare_info.pair_1.key_info[].key_template.key_qual_map[].qual_type: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(DNX_DATA_MAX_FIELD_COMPARE_NOF_KEYS == 0)
            {
                SHR_EXIT();
            }
...
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_key_info_key_template_key_qual_map_lsb_dump(int  unit,  int  context_info_idx_0,  int  key_info_idx_0,  int  key_qual_map_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_1__KEY_INFO__KEY_TEMPLATE__KEY_QUAL_MAP__LSB, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_1__KEY_INFO__KEY_TEMPLATE__KEY_QUAL_MAP__LSB, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
...
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_key_info_key_template_key_qual_map_size_dump(int  unit,  int  context_info_idx_0,  int  key_info_idx_0,  int  key_qual_map_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_1__KEY_INFO__KEY_TEMPLATE__KEY_QUAL_MAP__SIZE, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_1__KEY_INFO__KEY_TEMPLATE__KEY_QUAL_MAP__SIZE, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
...
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_key_info_key_template_key_size_in_bits_dump(int  unit,  int  context_info_idx_0,  int  key_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_1__KEY_INFO__KEY_TEMPLATE__KEY_SIZE_IN_BITS, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_1__KEY_INFO__KEY_TEMPLATE__KEY_SIZE_IN_BITS, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
...
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_key_info_key_id_dump(int  unit,  int  context_info_idx_0,  int  key_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_key_info_key_id_offset_on_first_key_dump(unit, context_info_idx_0, key_info_idx_0, filters));
    SHR_IF_ERR_EXIT(dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_key_info_key_id_nof_bits_dump(unit, context_info_idx_0, key_info_idx_0, -1, filters));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_key_info_key_id_id_dump(int  unit,  int  context_info_idx_0,  int  key_info_idx_0,  int  id_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_1__KEY_INFO__KEY_ID__ID, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_1__KEY_INFO__KEY_ID__ID, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
...
int
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_key_info_key_id_offset_on_first_key_dump(int  unit,  int  context_info_idx_0,  int  key_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = context_info_idx_0, I0 = context_info_idx_0 + 1;
    int i1 = key_info_idx_0, I1 = key_info_idx_0 + 1, org_i1 = key_info_idx_0;
    char *s0 = "", *s1 = "";
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_field_context context_info context_ipmf1_info compare_info pair_1 key_info key_id offset_on_first_key") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_field_context context_info context_ipmf1_info compare_info pair_1 key_info key_id offset_on_first_key\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_field_context_sw/context_info/context_ipmf1_info/compare_info/pair_1/key_info/key_id/offset_on_first_key.txt",
            "dnx_field_context_sw[%d]->","((dnx_field_context_sw_t*)sw_state_roots_array[%d][DNX_FIELD_CONTEXT_MODULE_ID])->","context_info[].context_ipmf1_info.compare_info.pair_1.key_info[].key_id.offset_on_first_key: ");
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_1__KEY_INFO__KEY_ID__OFFSET_ON_FIRST_KEY, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
            LOG_CLI((BSL_META("dnx_field_context_sw[]->((dnx_field_context_sw_t*)sw_state_roots_array[][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[].context_ipmf1_info.compare_info.pair_1.key_info[].key_id.offset_on_first_key: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_1__KEY_INFO__KEY_ID__OFFSET_ON_FIRST_KEY, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            for(; i1 < I1; i1++) {
                ...
                DNX_SW_STATE_PRINT_MONITOR(
                    unit,
                    "dnx_field_context_sw[%d]->","((dnx_field_context_sw_t*)sw_state_roots_array[%d][DNX_FIELD_CONTEXT_MODULE_ID])->","context_info[%s%d].context_ipmf1_info.compare_info.pair_1.key_info[%s%d].key_id.offset_on_first_key: ", s0, i0, s1, i1);
                ...
                dnx_sw_state_print_uint8(
                    unit,
                    &((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[i0].context_ipmf1_info.compare_info.pair_1.key_info[i1].key_id.offset_on_first_key);
...
int
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_key_info_key_id_nof_bits_dump(int  unit,  int  context_info_idx_0,  int  key_info_idx_0,  int  nof_bits_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = context_info_idx_0, I0 = context_info_idx_0 + 1;
    int i1 = key_info_idx_0, I1 = key_info_idx_0 + 1, org_i1 = key_info_idx_0;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_field_context context_info context_ipmf1_info compare_info pair_1 key_info key_id nof_bits") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_field_context context_info context_ipmf1_info compare_info pair_1 key_info key_id nof_bits\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_field_context_sw/context_info/context_ipmf1_info/compare_info/pair_1/key_info/key_id/nof_bits.txt",
            "dnx_field_context_sw[%d]->","((dnx_field_context_sw_t*)sw_state_roots_array[%d][DNX_FIELD_CONTEXT_MODULE_ID])->","context_info[].context_ipmf1_info.compare_info.pair_1.key_info[].key_id.nof_bits[]: ");
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_1__KEY_INFO__KEY_ID__NOF_BITS, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
            LOG_CLI((BSL_META("dnx_field_context_sw[]->((dnx_field_context_sw_t*)sw_state_roots_array[][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[].context_ipmf1_info.compare_info.pair_1.key_info[].key_id.nof_bits[]: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_1__KEY_INFO__KEY_ID__NOF_BITS, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            for(; i1 < I1; i1++) {
                if (i2 == -1) {
                    I2 = DNX_DATA_MAX_FIELD_GROUP_NOF_KEYS_PER_FG_MAX;
                    i2 = dnx_sw_state_dump_check_all_the_same(unit,
                        ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[i0].context_ipmf1_info.compare_info.pair_1.key_info[i1].key_id.nof_bits
                        , sizeof(*((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[i0].context_ipmf1_info.compare_info.pair_1.key_info[i1].key_id.nof_bits), I2, &s2) ? I2 - 1 : 0;
                }
                ...
                for(; i2 < I2; i2++) {
                    ...
                    DNX_SW_STATE_PRINT_MONITOR(
                        unit,
                        "dnx_field_context_sw[%d]->","((dnx_field_context_sw_t*)sw_state_roots_array[%d][DNX_FIELD_CONTEXT_MODULE_ID])->","context_info[%s%d].context_ipmf1_info.compare_info.pair_1.key_info[%s%d].key_id.nof_bits[%s%d]: ", s0, i0, s1, i1, s2, i2);
                    ...
                    dnx_sw_state_print_uint8(
                        unit,
                        &((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[i0].context_ipmf1_info.compare_info.pair_1.key_info[i1].key_id.nof_bits[i2]);
...
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_key_info_attach_info_dump(int  unit,  int  context_info_idx_0,  int  key_info_idx_0,  int  attach_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_key_info_attach_info_base_qual_dump(unit, context_info_idx_0, key_info_idx_0, attach_info_idx_0, filters));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_key_info_attach_info_input_type_dump(int  unit,  int  context_info_idx_0,  int  key_info_idx_0,  int  attach_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_1__KEY_INFO__ATTACH_INFO__INPUT_TYPE, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_1__KEY_INFO__ATTACH_INFO__INPUT_TYPE, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            for(; i1 < I1; i1++) {
                ...
                for(; i2 < I2; i2++) {
                    ...
                    DNX_SW_STATE_PRINT_ENUM(
                        unit,
                        dnx_field_input_type_e_get_name(((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[i0].context_ipmf1_info.compare_info.pair_1.key_info[i1].attach_info[i2].input_type));
...
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_key_info_attach_info_input_arg_dump(int  unit,  int  context_info_idx_0,  int  key_info_idx_0,  int  attach_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_1__KEY_INFO__ATTACH_INFO__INPUT_ARG, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_1__KEY_INFO__ATTACH_INFO__INPUT_ARG, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
...
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_key_info_attach_info_offset_dump(int  unit,  int  context_info_idx_0,  int  key_info_idx_0,  int  attach_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_1__KEY_INFO__ATTACH_INFO__OFFSET, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_1__KEY_INFO__ATTACH_INFO__OFFSET, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
...
int
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_key_info_attach_info_base_qual_dump(int  unit,  int  context_info_idx_0,  int  key_info_idx_0,  int  attach_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = context_info_idx_0, I0 = context_info_idx_0 + 1;
    int i1 = key_info_idx_0, I1 = key_info_idx_0 + 1, org_i1 = key_info_idx_0;
    int i2 = attach_info_idx_0, I2 = attach_info_idx_0 + 1, org_i2 = attach_info_idx_0;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_field_context context_info context_ipmf1_info compare_info pair_1 key_info attach_info base_qual") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_field_context context_info context_ipmf1_info compare_info pair_1 key_info attach_info base_qual\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_field_context_sw/context_info/context_ipmf1_info/compare_info/pair_1/key_info/attach_info/base_qual.txt",
            "dnx_field_context_sw[%d]->","((dnx_field_context_sw_t*)sw_state_roots_array[%d][DNX_FIELD_CONTEXT_MODULE_ID])->","context_info[].context_ipmf1_info.compare_info.pair_1.key_info[].attach_info[].base_qual: ");
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_1__KEY_INFO__ATTACH_INFO__BASE_QUAL, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
            LOG_CLI((BSL_META("dnx_field_context_sw[]->((dnx_field_context_sw_t*)sw_state_roots_array[][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[].context_ipmf1_info.compare_info.pair_1.key_info[].attach_info[].base_qual: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_1__KEY_INFO__ATTACH_INFO__BASE_QUAL, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            for(; i1 < I1; i1++) {
                ...
                for(; i2 < I2; i2++) {
                    ...
                    DNX_SW_STATE_PRINT_OPAQUE_MONITOR(
                        unit,
                        ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[i0].context_ipmf1_info.compare_info.pair_1.key_info[i1].attach_info[i2].base_qual,
                        "dnx_field_context_sw[%d]->","((dnx_field_context_sw_t*)sw_state_roots_array[%d][DNX_FIELD_CONTEXT_MODULE_ID])->","context_info[%s%d].context_ipmf1_info.compare_info.pair_1.key_info[%s%d].attach_info[%s%d].base_qual: ", s0, i0, s1, i1, s2, i2);
...
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_2_mode_dump(int  unit,  int  context_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_2__MODE, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_2__MODE, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_ENUM(
                unit,
                dnx_field_context_compare_mode_e_get_name(((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[i0].context_ipmf1_info.compare_info.pair_2.mode));
...
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_2_is_set_dump(int  unit,  int  context_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_2__IS_SET, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_2__IS_SET, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
...
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_2_key_info_key_template_key_qual_map_qual_type_dump(int  unit,  int  context_info_idx_0,  int  key_info_idx_0,  int  key_qual_map_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_2__KEY_INFO__KEY_TEMPLATE__KEY_QUAL_MAP__QUAL_TYPE, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_2__KEY_INFO__KEY_TEMPLATE__KEY_QUAL_MAP__QUAL_TYPE, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
...
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_2_key_info_key_template_key_qual_map_lsb_dump(int  unit,  int  context_info_idx_0,  int  key_info_idx_0,  int  key_qual_map_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_2__KEY_INFO__KEY_TEMPLATE__KEY_QUAL_MAP__LSB, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_2__KEY_INFO__KEY_TEMPLATE__KEY_QUAL_MAP__LSB, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
...
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_2_key_info_key_template_key_qual_map_size_dump(int  unit,  int  context_info_idx_0,  int  key_info_idx_0,  int  key_qual_map_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_2__KEY_INFO__KEY_TEMPLATE__KEY_QUAL_MAP__SIZE, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_2__KEY_INFO__KEY_TEMPLATE__KEY_QUAL_MAP__SIZE, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
...
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_2_key_info_key_template_key_size_in_bits_dump(int  unit,  int  context_info_idx_0,  int  key_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_2__KEY_INFO__KEY_TEMPLATE__KEY_SIZE_IN_BITS, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_2__KEY_INFO__KEY_TEMPLATE__KEY_SIZE_IN_BITS, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
...
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_2_key_info_key_id_dump(int  unit,  int  context_info_idx_0,  int  key_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_2_key_info_key_id_offset_on_first_key_dump(unit, context_info_idx_0, key_info_idx_0, filters));
    SHR_IF_ERR_EXIT(dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_2_key_info_key_id_nof_bits_dump(unit, context_info_idx_0, key_info_idx_0, -1, filters));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_2_key_info_key_id_id_dump(int  unit,  int  context_info_idx_0,  int  key_info_idx_0,  int  id_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_2__KEY_INFO__KEY_ID__ID, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_2__KEY_INFO__KEY_ID__ID, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
...
int
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_2_key_info_key_id_offset_on_first_key_dump(int  unit,  int  context_info_idx_0,  int  key_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = context_info_idx_0, I0 = context_info_idx_0 + 1;
    int i1 = key_info_idx_0, I1 = key_info_idx_0 + 1, org_i1 = key_info_idx_0;
    char *s0 = "", *s1 = "";
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_field_context context_info context_ipmf1_info compare_info pair_2 key_info key_id offset_on_first_key") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_field_context context_info context_ipmf1_info compare_info pair_2 key_info key_id offset_on_first_key\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_field_context_sw/context_info/context_ipmf1_info/compare_info/pair_2/key_info/key_id/offset_on_first_key.txt",
            "dnx_field_context_sw[%d]->","((dnx_field_context_sw_t*)sw_state_roots_array[%d][DNX_FIELD_CONTEXT_MODULE_ID])->","context_info[].context_ipmf1_info.compare_info.pair_2.key_info[].key_id.offset_on_first_key: ");
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_2__KEY_INFO__KEY_ID__OFFSET_ON_FIRST_KEY, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
            LOG_CLI((BSL_META("dnx_field_context_sw[]->((dnx_field_context_sw_t*)sw_state_roots_array[][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[].context_ipmf1_info.compare_info.pair_2.key_info[].key_id.offset_on_first_key: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_2__KEY_INFO__KEY_ID__OFFSET_ON_FIRST_KEY, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            for(; i1 < I1; i1++) {
                ...
                DNX_SW_STATE_PRINT_MONITOR(
                    unit,
                    "dnx_field_context_sw[%d]->","((dnx_field_context_sw_t*)sw_state_roots_array[%d][DNX_FIELD_CONTEXT_MODULE_ID])->","context_info[%s%d].context_ipmf1_info.compare_info.pair_2.key_info[%s%d].key_id.offset_on_first_key: ", s0, i0, s1, i1);
                ...
                dnx_sw_state_print_uint8(
                    unit,
                    &((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[i0].context_ipmf1_info.compare_info.pair_2.key_info[i1].key_id.offset_on_first_key);
...
int
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_2_key_info_key_id_nof_bits_dump(int  unit,  int  context_info_idx_0,  int  key_info_idx_0,  int  nof_bits_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = context_info_idx_0, I0 = context_info_idx_0 + 1;
    int i1 = key_info_idx_0, I1 = key_info_idx_0 + 1, org_i1 = key_info_idx_0;
    int i2 = nof_bits_idx_0, I2 = nof_bits_idx_0 + 1, org_i2 = nof_bits_idx_0;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_field_context context_info context_ipmf1_info compare_info pair_2 key_info key_id nof_bits") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_field_context context_info context_ipmf1_info compare_info pair_2 key_info key_id nof_bits\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_field_context_sw/context_info/context_ipmf1_info/compare_info/pair_2/key_info/key_id/nof_bits.txt",
            "dnx_field_context_sw[%d]->","((dnx_field_context_sw_t*)sw_state_roots_array[%d][DNX_FIELD_CONTEXT_MODULE_ID])->","context_info[].context_ipmf1_info.compare_info.pair_2.key_info[].key_id.nof_bits[]: ");
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_2__KEY_INFO__KEY_ID__NOF_BITS, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
            LOG_CLI((BSL_META("dnx_field_context_sw[]->((dnx_field_context_sw_t*)sw_state_roots_array[][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[].context_ipmf1_info.compare_info.pair_2.key_info[].key_id.nof_bits[]: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_2__KEY_INFO__KEY_ID__NOF_BITS, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            for(; i1 < I1; i1++) {
                if (i2 == -1) {
                    I2 = DNX_DATA_MAX_FIELD_GROUP_NOF_KEYS_PER_FG_MAX;
                    i2 = dnx_sw_state_dump_check_all_the_same(unit,
                        ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[i0].context_ipmf1_info.compare_info.pair_2.key_info[i1].key_id.nof_bits
                        , sizeof(*((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[i0].context_ipmf1_info.compare_info.pair_2.key_info[i1].key_id.nof_bits), I2, &s2) ? I2 - 1 : 0;
                }
                ...
                for(; i2 < I2; i2++) {
                    ...
                    DNX_SW_STATE_PRINT_MONITOR(
                        unit,
                        "dnx_field_context_sw[%d]->","((dnx_field_context_sw_t*)sw_state_roots_array[%d][DNX_FIELD_CONTEXT_MODULE_ID])->","context_info[%s%d].context_ipmf1_info.compare_info.pair_2.key_info[%s%d].key_id.nof_bits[%s%d]: ", s0, i0, s1, i1, s2, i2);
                    ...
                    dnx_sw_state_print_uint8(
                        unit,
                        &((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[i0].context_ipmf1_info.compare_info.pair_2.key_info[i1].key_id.nof_bits[i2]);
...
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_2_key_info_attach_info_dump(int  unit,  int  context_info_idx_0,  int  key_info_idx_0,  int  attach_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_2_key_info_attach_info_base_qual_dump(unit, context_info_idx_0, key_info_idx_0, attach_info_idx_0, filters));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_2_key_info_attach_info_input_type_dump(int  unit,  int  context_info_idx_0,  int  key_info_idx_0,  int  attach_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_2__KEY_INFO__ATTACH_INFO__INPUT_TYPE, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_2__KEY_INFO__ATTACH_INFO__INPUT_TYPE, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            for(; i1 < I1; i1++) {
                ...
                for(; i2 < I2; i2++) {
                    ...
                    DNX_SW_STATE_PRINT_ENUM(
                        unit,
                        dnx_field_input_type_e_get_name(((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[i0].context_ipmf1_info.compare_info.pair_2.key_info[i1].attach_info[i2].input_type));
...
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_2_key_info_attach_info_input_arg_dump(int  unit,  int  context_info_idx_0,  int  key_info_idx_0,  int  attach_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_2__KEY_INFO__ATTACH_INFO__INPUT_ARG, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_2__KEY_INFO__ATTACH_INFO__INPUT_ARG, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
...
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_2_key_info_attach_info_offset_dump(int  unit,  int  context_info_idx_0,  int  key_info_idx_0,  int  attach_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_2__KEY_INFO__ATTACH_INFO__OFFSET, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_2__KEY_INFO__ATTACH_INFO__OFFSET, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
...
int
dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_2_key_info_attach_info_base_qual_dump(int  unit,  int  context_info_idx_0,  int  key_info_idx_0,  int  attach_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = context_info_idx_0, I0 = context_info_idx_0 + 1;
    int i1 = key_info_idx_0, I1 = key_info_idx_0 + 1, org_i1 = key_info_idx_0;
    int i2 = attach_info_idx_0, I2 = attach_info_idx_0 + 1, org_i2 = attach_info_idx_0;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_field_context context_info context_ipmf1_info compare_info pair_2 key_info attach_info base_qual") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_field_context context_info context_ipmf1_info compare_info pair_2 key_info attach_info base_qual\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_field_context_sw/context_info/context_ipmf1_info/compare_info/pair_2/key_info/attach_info/base_qual.txt",
            "dnx_field_context_sw[%d]->","((dnx_field_context_sw_t*)sw_state_roots_array[%d][DNX_FIELD_CONTEXT_MODULE_ID])->","context_info[].context_ipmf1_info.compare_info.pair_2.key_info[].attach_info[].base_qual: ");
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_2__KEY_INFO__ATTACH_INFO__BASE_QUAL, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
            LOG_CLI((BSL_META("dnx_field_context_sw[]->((dnx_field_context_sw_t*)sw_state_roots_array[][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[].context_ipmf1_info.compare_info.pair_2.key_info[].attach_info[].base_qual: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__COMPARE_INFO__PAIR_2__KEY_INFO__ATTACH_INFO__BASE_QUAL, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            for(; i1 < I1; i1++) {
                ...
                for(; i2 < I2; i2++) {
                    ...
                    DNX_SW_STATE_PRINT_OPAQUE_MONITOR(
                        unit,
                        ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[i0].context_ipmf1_info.compare_info.pair_2.key_info[i1].attach_info[i2].base_qual,
                        "dnx_field_context_sw[%d]->","((dnx_field_context_sw_t*)sw_state_roots_array[%d][DNX_FIELD_CONTEXT_MODULE_ID])->","context_info[%s%d].context_ipmf1_info.compare_info.pair_2.key_info[%s%d].attach_info[%s%d].base_qual: ", s0, i0, s1, i1, s2, i2);
...
dnx_field_context_sw_context_info_context_ipmf1_info_hashing_info_mode_dump(int  unit,  int  context_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__HASHING_INFO__MODE, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__HASHING_INFO__MODE, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_ENUM(
                unit,
                dnx_field_context_hash_mode_e_get_name(((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[i0].context_ipmf1_info.hashing_info.mode));
...
dnx_field_context_sw_context_info_context_ipmf1_info_hashing_info_is_set_dump(int  unit,  int  context_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__HASHING_INFO__IS_SET, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__HASHING_INFO__IS_SET, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
...
dnx_field_context_sw_context_info_context_ipmf1_info_hashing_info_key_info_key_template_key_qual_map_qual_type_dump(int  unit,  int  context_info_idx_0,  int  key_qual_map_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__HASHING_INFO__KEY_INFO__KEY_TEMPLATE__KEY_QUAL_MAP__QUAL_TYPE, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__HASHING_INFO__KEY_INFO__KEY_TEMPLATE__KEY_QUAL_MAP__QUAL_TYPE, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
...
dnx_field_context_sw_context_info_context_ipmf1_info_hashing_info_key_info_key_template_key_qual_map_lsb_dump(int  unit,  int  context_info_idx_0,  int  key_qual_map_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__HASHING_INFO__KEY_INFO__KEY_TEMPLATE__KEY_QUAL_MAP__LSB, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__HASHING_INFO__KEY_INFO__KEY_TEMPLATE__KEY_QUAL_MAP__LSB, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
...
dnx_field_context_sw_context_info_context_ipmf1_info_hashing_info_key_info_key_template_key_qual_map_size_dump(int  unit,  int  context_info_idx_0,  int  key_qual_map_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__HASHING_INFO__KEY_INFO__KEY_TEMPLATE__KEY_QUAL_MAP__SIZE, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__HASHING_INFO__KEY_INFO__KEY_TEMPLATE__KEY_QUAL_MAP__SIZE, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
...
dnx_field_context_sw_context_info_context_ipmf1_info_hashing_info_key_info_key_template_key_size_in_bits_dump(int  unit,  int  context_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__HASHING_INFO__KEY_INFO__KEY_TEMPLATE__KEY_SIZE_IN_BITS, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__HASHING_INFO__KEY_INFO__KEY_TEMPLATE__KEY_SIZE_IN_BITS, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
...
dnx_field_context_sw_context_info_context_ipmf1_info_hashing_info_key_info_key_id_dump(int  unit,  int  context_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_context_sw_context_info_context_ipmf1_info_hashing_info_key_info_key_id_offset_on_first_key_dump(unit, context_info_idx_0, filters));
    SHR_IF_ERR_EXIT(dnx_field_context_sw_context_info_context_ipmf1_info_hashing_info_key_info_key_id_nof_bits_dump(unit, context_info_idx_0, -1, filters));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
dnx_field_context_sw_context_info_context_ipmf1_info_hashing_info_key_info_key_id_id_dump(int  unit,  int  context_info_idx_0,  int  id_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__HASHING_INFO__KEY_INFO__KEY_ID__ID, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__HASHING_INFO__KEY_INFO__KEY_ID__ID, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
...
int
dnx_field_context_sw_context_info_context_ipmf1_info_hashing_info_key_info_key_id_offset_on_first_key_dump(int  unit,  int  context_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = context_info_idx_0, I0 = context_info_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_field_context context_info context_ipmf1_info hashing_info key_info key_id offset_on_first_key") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_field_context context_info context_ipmf1_info hashing_info key_info key_id offset_on_first_key\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_field_context_sw/context_info/context_ipmf1_info/hashing_info/key_info/key_id/offset_on_first_key.txt",
            "dnx_field_context_sw[%d]->","((dnx_field_context_sw_t*)sw_state_roots_array[%d][DNX_FIELD_CONTEXT_MODULE_ID])->","context_info[].context_ipmf1_info.hashing_info.key_info.key_id.offset_on_first_key: ");
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__HASHING_INFO__KEY_INFO__KEY_ID__OFFSET_ON_FIRST_KEY, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
            LOG_CLI((BSL_META("dnx_field_context_sw[]->((dnx_field_context_sw_t*)sw_state_roots_array[][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[].context_ipmf1_info.hashing_info.key_info.key_id.offset_on_first_key: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__HASHING_INFO__KEY_INFO__KEY_ID__OFFSET_ON_FIRST_KEY, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "dnx_field_context_sw[%d]->","((dnx_field_context_sw_t*)sw_state_roots_array[%d][DNX_FIELD_CONTEXT_MODULE_ID])->","context_info[%s%d].context_ipmf1_info.hashing_info.key_info.key_id.offset_on_first_key: ", s0, i0);
            ...
            dnx_sw_state_print_uint8(
                unit,
                &((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[i0].context_ipmf1_info.hashing_info.key_info.key_id.offset_on_first_key);
...
int
dnx_field_context_sw_context_info_context_ipmf1_info_hashing_info_key_info_key_id_nof_bits_dump(int  unit,  int  context_info_idx_0,  int  nof_bits_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = context_info_idx_0, I0 = context_info_idx_0 + 1;
    int i1 = nof_bits_idx_0, I1 = nof_bits_idx_0 + 1, org_i1 = nof_bits_idx_0;
    char *s0 = "", *s1 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_field_context context_info context_ipmf1_info hashing_info key_info key_id nof_bits") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_field_context context_info context_ipmf1_info hashing_info key_info key_id nof_bits\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_field_context_sw/context_info/context_ipmf1_info/hashing_info/key_info/key_id/nof_bits.txt",
            "dnx_field_context_sw[%d]->","((dnx_field_context_sw_t*)sw_state_roots_array[%d][DNX_FIELD_CONTEXT_MODULE_ID])->","context_info[].context_ipmf1_info.hashing_info.key_info.key_id.nof_bits[]: ");
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__HASHING_INFO__KEY_INFO__KEY_ID__NOF_BITS, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
            LOG_CLI((BSL_META("dnx_field_context_sw[]->((dnx_field_context_sw_t*)sw_state_roots_array[][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[].context_ipmf1_info.hashing_info.key_info.key_id.nof_bits[]: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__HASHING_INFO__KEY_INFO__KEY_ID__NOF_BITS, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            if (i1 == -1) {
                I1 = DNX_DATA_MAX_FIELD_GROUP_NOF_KEYS_PER_FG_MAX;
                i1 = dnx_sw_state_dump_check_all_the_same(unit,
                    ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[i0].context_ipmf1_info.hashing_info.key_info.key_id.nof_bits
                    , sizeof(*((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[i0].context_ipmf1_info.hashing_info.key_info.key_id.nof_bits), I1, &s1) ? I1 - 1 : 0;
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                DNX_SW_STATE_PRINT_MONITOR(
                    unit,
                    "dnx_field_context_sw[%d]->","((dnx_field_context_sw_t*)sw_state_roots_array[%d][DNX_FIELD_CONTEXT_MODULE_ID])->","context_info[%s%d].context_ipmf1_info.hashing_info.key_info.key_id.nof_bits[%s%d]: ", s0, i0, s1, i1);
                ...
                dnx_sw_state_print_uint8(
                    unit,
                    &((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[i0].context_ipmf1_info.hashing_info.key_info.key_id.nof_bits[i1]);
...
dnx_field_context_sw_context_info_context_ipmf1_info_hashing_info_key_info_attach_info_dump(int  unit,  int  context_info_idx_0,  int  attach_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_context_sw_context_info_context_ipmf1_info_hashing_info_key_info_attach_info_base_qual_dump(unit, context_info_idx_0, attach_info_idx_0, filters));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
dnx_field_context_sw_context_info_context_ipmf1_info_hashing_info_key_info_attach_info_input_type_dump(int  unit,  int  context_info_idx_0,  int  attach_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__HASHING_INFO__KEY_INFO__ATTACH_INFO__INPUT_TYPE, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__HASHING_INFO__KEY_INFO__ATTACH_INFO__INPUT_TYPE, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            for(; i1 < I1; i1++) {
                ...
                DNX_SW_STATE_PRINT_ENUM(
                    unit,
                    dnx_field_input_type_e_get_name(((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[i0].context_ipmf1_info.hashing_info.key_info.attach_info[i1].input_type));
...
dnx_field_context_sw_context_info_context_ipmf1_info_hashing_info_key_info_attach_info_input_arg_dump(int  unit,  int  context_info_idx_0,  int  attach_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__HASHING_INFO__KEY_INFO__ATTACH_INFO__INPUT_ARG, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__HASHING_INFO__KEY_INFO__ATTACH_INFO__INPUT_ARG, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
...
dnx_field_context_sw_context_info_context_ipmf1_info_hashing_info_key_info_attach_info_offset_dump(int  unit,  int  context_info_idx_0,  int  attach_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__HASHING_INFO__KEY_INFO__ATTACH_INFO__OFFSET, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__HASHING_INFO__KEY_INFO__ATTACH_INFO__OFFSET, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
...
int
dnx_field_context_sw_context_info_context_ipmf1_info_hashing_info_key_info_attach_info_base_qual_dump(int  unit,  int  context_info_idx_0,  int  attach_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = context_info_idx_0, I0 = context_info_idx_0 + 1;
    int i1 = attach_info_idx_0, I1 = attach_info_idx_0 + 1, org_i1 = attach_info_idx_0;
    char *s0 = "", *s1 = "";
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_field_context context_info context_ipmf1_info hashing_info key_info attach_info base_qual") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_field_context context_info context_ipmf1_info hashing_info key_info attach_info base_qual\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_field_context_sw/context_info/context_ipmf1_info/hashing_info/key_info/attach_info/base_qual.txt",
            "dnx_field_context_sw[%d]->","((dnx_field_context_sw_t*)sw_state_roots_array[%d][DNX_FIELD_CONTEXT_MODULE_ID])->","context_info[].context_ipmf1_info.hashing_info.key_info.attach_info[].base_qual: ");
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__HASHING_INFO__KEY_INFO__ATTACH_INFO__BASE_QUAL, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
            LOG_CLI((BSL_META("dnx_field_context_sw[]->((dnx_field_context_sw_t*)sw_state_roots_array[][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[].context_ipmf1_info.hashing_info.key_info.attach_info[].base_qual: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF1_INFO__HASHING_INFO__KEY_INFO__ATTACH_INFO__BASE_QUAL, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            for(; i1 < I1; i1++) {
                ...
                DNX_SW_STATE_PRINT_OPAQUE_MONITOR(
                    unit,
                    ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[i0].context_ipmf1_info.hashing_info.key_info.attach_info[i1].base_qual,
                    "dnx_field_context_sw[%d]->","((dnx_field_context_sw_t*)sw_state_roots_array[%d][DNX_FIELD_CONTEXT_MODULE_ID])->","context_info[%s%d].context_ipmf1_info.hashing_info.key_info.attach_info[%s%d].base_qual: ", s0, i0, s1, i1);
...
dnx_field_context_sw_context_info_context_ipmf2_info_cascaded_from_dump(int  unit,  int  context_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF2_INFO__CASCADED_FROM, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__CONTEXT_IPMF2_INFO__CASCADED_FROM, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
...
dnx_field_context_sw_context_info_state_table_info_mode_dump(int  unit,  int  context_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__STATE_TABLE_INFO__MODE, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__STATE_TABLE_INFO__MODE, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_ENUM(
                unit,
                dnx_field_context_state_table_mode_e_get_name(((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info[i0].state_table_info.mode));
...
dnx_field_context_sw_context_info_state_table_info_is_set_dump(int  unit,  int  context_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__STATE_TABLE_INFO__IS_SET, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__STATE_TABLE_INFO__IS_SET, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
...
dnx_field_context_sw_context_info_name_value_dump(int  unit,  int  context_info_idx_0,  int  name_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__NAME__VALUE, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_CONTEXT_SW__CONTEXT_INFO__NAME__VALUE, ((dnx_field_context_sw_t*)sw_state_roots_array[unit][DNX_FIELD_CONTEXT_MODULE_ID])->context_info) == 0)
        {
            SHR_EXIT();
        }
...
const char* dnx_field_context_sw_layout_str[DNX_FIELD_CONTEXT_SW_INFO_NOF_ENTRIES] = {
    ...
    "DNX_FIELD_CONTEXT_SW~CONTEXT_INFO~CONTEXT_IPMF1_INFO~COMPARE_INFO~PAIR_1~KEY_INFO~KEY_ID~OFFSET_ON_FIRST_KEY~",
    "DNX_FIELD_CONTEXT_SW~CONTEXT_INFO~CONTEXT_IPMF1_INFO~COMPARE_INFO~PAIR_1~KEY_INFO~KEY_ID~NOF_BITS~",
    ...
    "DNX_FIELD_CONTEXT_SW~CONTEXT_INFO~CONTEXT_IPMF1_INFO~COMPARE_INFO~PAIR_1~KEY_INFO~ATTACH_INFO~BASE_QUAL~",
    ...
    "DNX_FIELD_CONTEXT_SW~CONTEXT_INFO~CONTEXT_IPMF1_INFO~COMPARE_INFO~PAIR_2~KEY_INFO~KEY_ID~OFFSET_ON_FIRST_KEY~",
    "DNX_FIELD_CONTEXT_SW~CONTEXT_INFO~CONTEXT_IPMF1_INFO~COMPARE_INFO~PAIR_2~KEY_INFO~KEY_ID~NOF_BITS~",
    ...
    "DNX_FIELD_CONTEXT_SW~CONTEXT_INFO~CONTEXT_IPMF1_INFO~COMPARE_INFO~PAIR_2~KEY_INFO~ATTACH_INFO~BASE_QUAL~",
    ...
    "DNX_FIELD_CONTEXT_SW~CONTEXT_INFO~CONTEXT_IPMF1_INFO~HASHING_INFO~KEY_INFO~KEY_ID~OFFSET_ON_FIRST_KEY~",
    "DNX_FIELD_CONTEXT_SW~CONTEXT_INFO~CONTEXT_IPMF1_INFO~HASHING_INFO~KEY_INFO~KEY_ID~NOF_BITS~",
    ...
    "DNX_FIELD_CONTEXT_SW~CONTEXT_INFO~CONTEXT_IPMF1_INFO~HASHING_INFO~KEY_INFO~ATTACH_INFO~BASE_QUAL~",
    ...
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~DATA~KEY_TEMPLATE~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~DATA~KEY_TEMPLATE~KEY_QUAL_MAP~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~DATA~KEY_TEMPLATE~KEY_QUAL_MAP~QUAL_TYPE~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~DATA~KEY_TEMPLATE~KEY_QUAL_MAP~LSB~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~DATA~KEY_TEMPLATE~KEY_QUAL_MAP~SIZE~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~DATA~KEY_TEMPLATE~KEY_SIZE_IN_BITS~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~DATA~KEY_ID~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~DATA~KEY_ID~ID~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~DATA~KEY_ID~OFFSET_ON_FIRST_KEY~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~DATA~KEY_ID~NOF_BITS~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~DATA~ATTACH_INFO~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~DATA~ATTACH_INFO~INPUT_TYPE~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~DATA~ATTACH_INFO~INPUT_ARG~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~DATA~ATTACH_INFO~OFFSET~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~DATA~ATTACH_INFO~BASE_QUAL~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~ADDRESS~KEY_TEMPLATE~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~ADDRESS~KEY_TEMPLATE~KEY_QUAL_MAP~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~ADDRESS~KEY_TEMPLATE~KEY_QUAL_MAP~QUAL_TYPE~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~ADDRESS~KEY_TEMPLATE~KEY_QUAL_MAP~LSB~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~ADDRESS~KEY_TEMPLATE~KEY_QUAL_MAP~SIZE~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~ADDRESS~KEY_TEMPLATE~KEY_SIZE_IN_BITS~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~ADDRESS~KEY_ID~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~ADDRESS~KEY_ID~ID~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~ADDRESS~KEY_ID~OFFSET_ON_FIRST_KEY~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~ADDRESS~KEY_ID~NOF_BITS~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~ADDRESS~ATTACH_INFO~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~ADDRESS~ATTACH_INFO~INPUT_TYPE~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~ADDRESS~ATTACH_INFO~INPUT_ARG~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~ADDRESS~ATTACH_INFO~OFFSET~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~ADDRESS~ATTACH_INFO~BASE_QUAL~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~OPCODE_BASED_QUAL~KEY_TEMPLATE~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~OPCODE_BASED_QUAL~KEY_TEMPLATE~KEY_QUAL_MAP~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~OPCODE_BASED_QUAL~KEY_TEMPLATE~KEY_QUAL_MAP~QUAL_TYPE~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~OPCODE_BASED_QUAL~KEY_TEMPLATE~KEY_QUAL_MAP~LSB~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~OPCODE_BASED_QUAL~KEY_TEMPLATE~KEY_QUAL_MAP~SIZE~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~OPCODE_BASED_QUAL~KEY_TEMPLATE~KEY_SIZE_IN_BITS~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~OPCODE_BASED_QUAL~KEY_ID~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~OPCODE_BASED_QUAL~KEY_ID~ID~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~OPCODE_BASED_QUAL~KEY_ID~OFFSET_ON_FIRST_KEY~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~OPCODE_BASED_QUAL~KEY_ID~NOF_BITS~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~OPCODE_BASED_QUAL~ATTACH_INFO~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~OPCODE_BASED_QUAL~ATTACH_INFO~INPUT_TYPE~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~OPCODE_BASED_QUAL~ATTACH_INFO~INPUT_ARG~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~OPCODE_BASED_QUAL~ATTACH_INFO~OFFSET~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~OPCODE_BASED_QUAL~ATTACH_INFO~BASE_QUAL~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~CURRENT_STATE~ACTIONS_ON_PAYLOAD_INFO~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~CURRENT_STATE~ACTIONS_ON_PAYLOAD_INFO~DNX_ACTION~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~CURRENT_STATE~ACTIONS_ON_PAYLOAD_INFO~DONT_USE_VALID_BIT~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~CURRENT_STATE~ACTIONS_ON_PAYLOAD_INFO~LSB~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~NEXT_STATE~ACTIONS_ON_PAYLOAD_INFO~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~NEXT_STATE~ACTIONS_ON_PAYLOAD_INFO~DNX_ACTION~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~NEXT_STATE~ACTIONS_ON_PAYLOAD_INFO~DONT_USE_VALID_BIT~",
    "DNX_FIELD_CONTEXT_SW~SCE_INFO~NEXT_STATE~ACTIONS_ON_PAYLOAD_INFO~LSB~",
};
#endif 
