...
trunk_db_pools_groups_psc_dump(int  unit,  int  pools_idx_0,  int  groups_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__PSC, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__PSC, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__PSC, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups))
            {
                LOG_CLI((BSL_META("trunk_db[]->((trunk_info_t*)sw_state_roots_array[][TRUNK_MODULE_ID])->pools[].groups[].psc: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__PSC, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups) == 0)
            {
                SHR_EXIT();
            }
...
trunk_db_pools_groups_psc_profile_id_dump(int  unit,  int  pools_idx_0,  int  groups_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__PSC_PROFILE_ID, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__PSC_PROFILE_ID, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__PSC_PROFILE_ID, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups))
            {
                LOG_CLI((BSL_META("trunk_db[]->((trunk_info_t*)sw_state_roots_array[][TRUNK_MODULE_ID])->pools[].groups[].psc_profile_id: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__PSC_PROFILE_ID, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups) == 0)
            {
                SHR_EXIT();
            }
...
trunk_db_pools_groups_members_system_port_dump(int  unit,  int  pools_idx_0,  int  groups_idx_0,  int  members_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__MEMBERS__SYSTEM_PORT, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__MEMBERS__SYSTEM_PORT, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__MEMBERS__SYSTEM_PORT, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups))
            {
                LOG_CLI((BSL_META("trunk_db[]->((trunk_info_t*)sw_state_roots_array[][TRUNK_MODULE_ID])->pools[].groups[].members[].system_port: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__MEMBERS__SYSTEM_PORT, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups) == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                if(i2 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__MEMBERS__SYSTEM_PORT, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups[i1].members))
                {
                    LOG_CLI((BSL_META("trunk_db[]->((trunk_info_t*)sw_state_roots_array[][TRUNK_MODULE_ID])->pools[].groups[].members[].system_port: ")));
                    LOG_CLI((BSL_META("Invalid index: %d \n"),i2));
                    SHR_EXIT();
                ...
                if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__MEMBERS__SYSTEM_PORT, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups[i1].members) == 0)
                {
                    SHR_EXIT();
                }
...
trunk_db_pools_groups_members_flags_dump(int  unit,  int  pools_idx_0,  int  groups_idx_0,  int  members_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__MEMBERS__FLAGS, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__MEMBERS__FLAGS, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__MEMBERS__FLAGS, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups))
            {
                LOG_CLI((BSL_META("trunk_db[]->((trunk_info_t*)sw_state_roots_array[][TRUNK_MODULE_ID])->pools[].groups[].members[].flags: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__MEMBERS__FLAGS, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups) == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                if(i2 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__MEMBERS__FLAGS, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups[i1].members))
                {
                    LOG_CLI((BSL_META("trunk_db[]->((trunk_info_t*)sw_state_roots_array[][TRUNK_MODULE_ID])->pools[].groups[].members[].flags: ")));
                    LOG_CLI((BSL_META("Invalid index: %d \n"),i2));
                    SHR_EXIT();
                ...
                if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__MEMBERS__FLAGS, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups[i1].members) == 0)
                {
                    SHR_EXIT();
                }
...
trunk_db_pools_groups_members_index_dump(int  unit,  int  pools_idx_0,  int  groups_idx_0,  int  members_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__MEMBERS__INDEX, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__MEMBERS__INDEX, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__MEMBERS__INDEX, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups))
            {
                LOG_CLI((BSL_META("trunk_db[]->((trunk_info_t*)sw_state_roots_array[][TRUNK_MODULE_ID])->pools[].groups[].members[].index: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__MEMBERS__INDEX, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups) == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                if(i2 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__MEMBERS__INDEX, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups[i1].members))
                {
                    LOG_CLI((BSL_META("trunk_db[]->((trunk_info_t*)sw_state_roots_array[][TRUNK_MODULE_ID])->pools[].groups[].members[].index: ")));
                    LOG_CLI((BSL_META("Invalid index: %d \n"),i2));
                    SHR_EXIT();
                ...
                if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__MEMBERS__INDEX, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups[i1].members) == 0)
                {
                    SHR_EXIT();
                }
...
int
trunk_db_pools_groups_members_spa_member_id_dump(int  unit,  int  pools_idx_0,  int  groups_idx_0,  int  members_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = pools_idx_0, I0 = pools_idx_0 + 1;
    int i1 = groups_idx_0, I1 = groups_idx_0 + 1, org_i1 = groups_idx_0;
    int i2 = members_idx_0, I2 = members_idx_0 + 1, org_i2 = members_idx_0;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "trunk pools groups members spa_member_id") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate trunk pools groups members spa_member_id\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "trunk_db/pools/groups/members/spa_member_id.txt",
            "trunk_db[%d]->","((trunk_info_t*)sw_state_roots_array[%d][TRUNK_MODULE_ID])->","pools[].groups[].members[].spa_member_id: ");
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__MEMBERS__SPA_MEMBER_ID, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools))
        {
            LOG_CLI((BSL_META("trunk_db[]->((trunk_info_t*)sw_state_roots_array[][TRUNK_MODULE_ID])->pools[].groups[].members[].spa_member_id: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__MEMBERS__SPA_MEMBER_ID, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__MEMBERS__SPA_MEMBER_ID, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups))
            {
                LOG_CLI((BSL_META("trunk_db[]->((trunk_info_t*)sw_state_roots_array[][TRUNK_MODULE_ID])->pools[].groups[].members[].spa_member_id: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__MEMBERS__SPA_MEMBER_ID, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups) == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                if(i2 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__MEMBERS__SPA_MEMBER_ID, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups[i1].members))
                {
                    LOG_CLI((BSL_META("trunk_db[]->((trunk_info_t*)sw_state_roots_array[][TRUNK_MODULE_ID])->pools[].groups[].members[].spa_member_id: ")));
                    LOG_CLI((BSL_META("Invalid index: %d \n"),i2));
                    SHR_EXIT();
                ...
                if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__MEMBERS__SPA_MEMBER_ID, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups[i1].members) == 0)
                {
                    SHR_EXIT();
                }
                ...
                for(; i2 < I2; i2++) {
                    ...
                    DNX_SW_STATE_PRINT_MONITOR(
                        unit,
                        "trunk_db[%d]->","((trunk_info_t*)sw_state_roots_array[%d][TRUNK_MODULE_ID])->","pools[%s%d].groups[%s%d].members[%s%d].spa_member_id: ", s0, i0, s1, i1, s2, i2);
                    ...
                    dnx_sw_state_print_int(
                        unit,
                        &((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups[i1].members[i2].spa_member_id);
...
trunk_db_pools_groups_nof_members_dump(int  unit,  int  pools_idx_0,  int  groups_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__NOF_MEMBERS, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__NOF_MEMBERS, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__NOF_MEMBERS, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups))
            {
                LOG_CLI((BSL_META("trunk_db[]->((trunk_info_t*)sw_state_roots_array[][TRUNK_MODULE_ID])->pools[].groups[].nof_members: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__NOF_MEMBERS, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups) == 0)
            {
                SHR_EXIT();
            }
...
trunk_db_pools_groups_last_member_added_index_dump(int  unit,  int  pools_idx_0,  int  groups_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__LAST_MEMBER_ADDED_INDEX, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__LAST_MEMBER_ADDED_INDEX, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__LAST_MEMBER_ADDED_INDEX, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups))
            {
                LOG_CLI((BSL_META("trunk_db[]->((trunk_info_t*)sw_state_roots_array[][TRUNK_MODULE_ID])->pools[].groups[].last_member_added_index: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__LAST_MEMBER_ADDED_INDEX, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups) == 0)
            {
                SHR_EXIT();
            }
...
trunk_db_pools_groups_in_use_dump(int  unit,  int  pools_idx_0,  int  groups_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__IN_USE, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__IN_USE, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__IN_USE, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups))
            {
                LOG_CLI((BSL_META("trunk_db[]->((trunk_info_t*)sw_state_roots_array[][TRUNK_MODULE_ID])->pools[].groups[].in_use: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__IN_USE, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups) == 0)
            {
                SHR_EXIT();
            }
...
trunk_db_pools_groups_pp_ports_dump(int  unit,  int  pools_idx_0,  int  groups_idx_0,  int  pp_ports_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__PP_PORTS, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__PP_PORTS, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__PP_PORTS, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups))
            {
                LOG_CLI((BSL_META("trunk_db[]->((trunk_info_t*)sw_state_roots_array[][TRUNK_MODULE_ID])->pools[].groups[].pp_ports[]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__PP_PORTS, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups) == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                if(i2 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__PP_PORTS, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups[i1].pp_ports))
                {
                    LOG_CLI((BSL_META("trunk_db[]->((trunk_info_t*)sw_state_roots_array[][TRUNK_MODULE_ID])->pools[].groups[].pp_ports[]: ")));
                    LOG_CLI((BSL_META("Invalid index: %d \n"),i2));
                    SHR_EXIT();
                ...
                if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__PP_PORTS, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups[i1].pp_ports) == 0)
                {
                    SHR_EXIT();
                }
...
trunk_db_pools_groups_in_header_type_dump(int  unit,  int  pools_idx_0,  int  groups_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__IN_HEADER_TYPE, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__IN_HEADER_TYPE, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__IN_HEADER_TYPE, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups))
            {
                LOG_CLI((BSL_META("trunk_db[]->((trunk_info_t*)sw_state_roots_array[][TRUNK_MODULE_ID])->pools[].groups[].in_header_type: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__IN_HEADER_TYPE, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups) == 0)
            {
                SHR_EXIT();
            }
...
trunk_db_pools_groups_out_header_type_dump(int  unit,  int  pools_idx_0,  int  groups_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__OUT_HEADER_TYPE, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__OUT_HEADER_TYPE, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__OUT_HEADER_TYPE, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups))
            {
                LOG_CLI((BSL_META("trunk_db[]->((trunk_info_t*)sw_state_roots_array[][TRUNK_MODULE_ID])->pools[].groups[].out_header_type: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__OUT_HEADER_TYPE, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups) == 0)
            {
                SHR_EXIT();
            }
...
trunk_db_pools_groups_flags_dump(int  unit,  int  pools_idx_0,  int  groups_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__FLAGS, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__FLAGS, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__FLAGS, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups))
            {
                LOG_CLI((BSL_META("trunk_db[]->((trunk_info_t*)sw_state_roots_array[][TRUNK_MODULE_ID])->pools[].groups[].flags: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__FLAGS, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups) == 0)
            {
                SHR_EXIT();
            }
...
trunk_db_pools_groups_master_trunk_id_dump(int  unit,  int  pools_idx_0,  int  groups_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__MASTER_TRUNK_ID, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__MASTER_TRUNK_ID, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__MASTER_TRUNK_ID, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups))
            {
                LOG_CLI((BSL_META("trunk_db[]->((trunk_info_t*)sw_state_roots_array[][TRUNK_MODULE_ID])->pools[].groups[].master_trunk_id: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__POOLS__GROUPS__MASTER_TRUNK_ID, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->pools[i0].groups) == 0)
            {
                SHR_EXIT();
            }
...
trunk_db_trunk_system_port_db_trunk_system_port_entries_trunk_id_dump(int  unit,  int  trunk_system_port_entries_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__TRUNK_SYSTEM_PORT_DB__TRUNK_SYSTEM_PORT_ENTRIES__TRUNK_ID, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->trunk_system_port_db.trunk_system_port_entries))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__TRUNK_SYSTEM_PORT_DB__TRUNK_SYSTEM_PORT_ENTRIES__TRUNK_ID, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->trunk_system_port_db.trunk_system_port_entries) == 0)
        {
            SHR_EXIT();
        }
...
trunk_db_trunk_system_port_db_trunk_system_port_entries_flags_dump(int  unit,  int  trunk_system_port_entries_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__TRUNK_SYSTEM_PORT_DB__TRUNK_SYSTEM_PORT_ENTRIES__FLAGS, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->trunk_system_port_db.trunk_system_port_entries))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__TRUNK_SYSTEM_PORT_DB__TRUNK_SYSTEM_PORT_ENTRIES__FLAGS, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->trunk_system_port_db.trunk_system_port_entries) == 0)
        {
            SHR_EXIT();
        }
...
int
trunk_db_psc_general_info_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(trunk_db_psc_general_info_chm_handle_dump(unit, filters));
    SHR_IF_ERR_EXIT(trunk_db_psc_general_info_profile_info_dump(unit, -1, filters));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
int
trunk_db_psc_general_info_chm_handle_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "trunk psc_general_info chm_handle") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate trunk psc_general_info chm_handle\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "trunk_db/psc_general_info/chm_handle.txt",
            "trunk_db[%d]->","((trunk_info_t*)sw_state_roots_array[%d][TRUNK_MODULE_ID])->","psc_general_info.chm_handle: ");
...
int
trunk_db_psc_general_info_profile_info_dump(int  unit,  int  profile_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
trunk_db_psc_general_info_profile_info_psc_profile_type_dump(int  unit,  int  profile_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = profile_info_idx_0, I0 = profile_info_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "trunk psc_general_info profile_info psc_profile_type") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate trunk psc_general_info profile_info psc_profile_type\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "trunk_db/psc_general_info/profile_info/psc_profile_type.txt",
            "trunk_db[%d]->","((trunk_info_t*)sw_state_roots_array[%d][TRUNK_MODULE_ID])->","psc_general_info.profile_info[].psc_profile_type: ");
        ...
        if (i0 == -1) {
            ...
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->psc_general_info.profile_info
                , sizeof(*((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->psc_general_info.profile_info), I0, &s0) ? I0 - 1 : 0;
        }

        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__PSC_GENERAL_INFO__PROFILE_INFO__PSC_PROFILE_TYPE, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->psc_general_info.profile_info))
        {
            LOG_CLI((BSL_META("trunk_db[]->((trunk_info_t*)sw_state_roots_array[][TRUNK_MODULE_ID])->psc_general_info.profile_info[].psc_profile_type: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__PSC_GENERAL_INFO__PROFILE_INFO__PSC_PROFILE_TYPE, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->psc_general_info.profile_info) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "trunk_db[%d]->","((trunk_info_t*)sw_state_roots_array[%d][TRUNK_MODULE_ID])->","psc_general_info.profile_info[%s%d].psc_profile_type: ", s0, i0);
            ...
            dnx_sw_state_print_int(
                unit,
                &((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->psc_general_info.profile_info[i0].psc_profile_type);
...
int
trunk_db_psc_general_info_profile_info_max_nof_members_dump(int  unit,  int  profile_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = profile_info_idx_0, I0 = profile_info_idx_0 + 1;
    char *s0 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "trunk psc_general_info profile_info max_nof_members") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate trunk psc_general_info profile_info max_nof_members\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "trunk_db/psc_general_info/profile_info/max_nof_members.txt",
            "trunk_db[%d]->","((trunk_info_t*)sw_state_roots_array[%d][TRUNK_MODULE_ID])->","psc_general_info.profile_info[].max_nof_members: ");
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__PSC_GENERAL_INFO__PROFILE_INFO__MAX_NOF_MEMBERS, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->psc_general_info.profile_info))
        {
            LOG_CLI((BSL_META("trunk_db[]->((trunk_info_t*)sw_state_roots_array[][TRUNK_MODULE_ID])->psc_general_info.profile_info[].max_nof_members: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_TRUNK_DB__PSC_GENERAL_INFO__PROFILE_INFO__MAX_NOF_MEMBERS, ((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->psc_general_info.profile_info) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "trunk_db[%d]->","((trunk_info_t*)sw_state_roots_array[%d][TRUNK_MODULE_ID])->","psc_general_info.profile_info[%s%d].max_nof_members: ", s0, i0);
            ...
            dnx_sw_state_print_int(
                unit,
                &((trunk_info_t*)sw_state_roots_array[unit][TRUNK_MODULE_ID])->psc_general_info.profile_info[i0].max_nof_members);
...
const char* trunk_db_layout_str[TRUNK_DB_INFO_NOF_ENTRIES] = {
    ...
    "TRUNK_DB~POOLS~GROUPS~MEMBERS~SPA_MEMBER_ID~",
    ...
    "TRUNK_DB~PSC_GENERAL_INFO~",
    "TRUNK_DB~PSC_GENERAL_INFO~CHM_HANDLE~",
    "TRUNK_DB~PSC_GENERAL_INFO~PROFILE_INFO~",
    "TRUNK_DB~PSC_GENERAL_INFO~PROFILE_INFO~PSC_PROFILE_TYPE~",
    "TRUNK_DB~PSC_GENERAL_INFO~PROFILE_INFO~MAX_NOF_MEMBERS~",
};
#endif 
