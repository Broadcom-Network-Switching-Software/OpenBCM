...
dnx_field_tcam_access_sw_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_tcam_access_sw_fg_prefix_per_core_dump(unit, -1, -1, filters));
...
dnx_field_tcam_access_sw_entry_location_hash_dump(int  unit,  int  entry_location_hash_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__ENTRY_LOCATION_HASH, ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->entry_location_hash))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__ENTRY_LOCATION_HASH, ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->entry_location_hash) == 0)
        {
            SHR_EXIT();
        }
...
dnx_field_tcam_access_sw_valid_bmp_v_bit_dump(int  unit,  int  valid_bmp_idx_0,  int  v_bit_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__VALID_BMP__V_BIT, ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->valid_bmp))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__VALID_BMP__V_BIT, ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->valid_bmp) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__VALID_BMP__V_BIT, ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->valid_bmp[i0].v_bit))
            {
                LOG_CLI((BSL_META("dnx_field_tcam_access_sw[]->((dnx_field_tcam_access_t*)sw_state_roots_array[][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->valid_bmp[].v_bit[]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__VALID_BMP__V_BIT, ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->valid_bmp[i0].v_bit) == 0)
            {
                SHR_EXIT();
            }
...
dnx_field_tcam_access_sw_entry_in_use_bmp_v_bit_dump(int  unit,  int  entry_in_use_bmp_idx_0,  int  v_bit_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__ENTRY_IN_USE_BMP__V_BIT, ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->entry_in_use_bmp))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__ENTRY_IN_USE_BMP__V_BIT, ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->entry_in_use_bmp) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__ENTRY_IN_USE_BMP__V_BIT, ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->entry_in_use_bmp[i0].v_bit))
            {
                LOG_CLI((BSL_META("dnx_field_tcam_access_sw[]->((dnx_field_tcam_access_t*)sw_state_roots_array[][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->entry_in_use_bmp[].v_bit[]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__ENTRY_IN_USE_BMP__V_BIT, ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->entry_in_use_bmp[i0].v_bit) == 0)
            {
                SHR_EXIT();
            }
...
dnx_field_tcam_access_sw_fg_params_dt_bank_id_dump(int  unit,  int  fg_params_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__FG_PARAMS__DT_BANK_ID, ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->fg_params))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__FG_PARAMS__DT_BANK_ID, ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->fg_params) == 0)
        {
            SHR_EXIT();
        }
...
dnx_field_tcam_access_sw_fg_params_stage_dump(int  unit,  int  fg_params_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__FG_PARAMS__STAGE, ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->fg_params))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__FG_PARAMS__STAGE, ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->fg_params) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_ENUM(
                unit,
                dnx_field_tcam_stage_e_get_name(((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->fg_params[i0].stage));
...
dnx_field_tcam_access_sw_fg_params_bank_allocation_mode_dump(int  unit,  int  fg_params_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__FG_PARAMS__BANK_ALLOCATION_MODE, ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->fg_params))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__FG_PARAMS__BANK_ALLOCATION_MODE, ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->fg_params) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_ENUM(
                unit,
                dnx_field_tcam_bank_allocation_mode_e_get_name(((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->fg_params[i0].bank_allocation_mode));
...
dnx_field_tcam_access_sw_fg_params_key_size_dump(int  unit,  int  fg_params_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__FG_PARAMS__KEY_SIZE, ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->fg_params))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__FG_PARAMS__KEY_SIZE, ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->fg_params) == 0)
        {
            SHR_EXIT();
        }
...
dnx_field_tcam_access_sw_fg_params_action_size_dump(int  unit,  int  fg_params_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__FG_PARAMS__ACTION_SIZE, ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->fg_params))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__FG_PARAMS__ACTION_SIZE, ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->fg_params) == 0)
        {
            SHR_EXIT();
        }
...
dnx_field_tcam_access_sw_fg_params_actual_action_size_dump(int  unit,  int  fg_params_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__FG_PARAMS__ACTUAL_ACTION_SIZE, ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->fg_params))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__FG_PARAMS__ACTUAL_ACTION_SIZE, ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->fg_params) == 0)
        {
            SHR_EXIT();
        }
...
dnx_field_tcam_access_sw_fg_params_prefix_size_dump(int  unit,  int  fg_params_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__FG_PARAMS__PREFIX_SIZE, ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->fg_params))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__FG_PARAMS__PREFIX_SIZE, ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->fg_params) == 0)
        {
            SHR_EXIT();
        }
...
dnx_field_tcam_access_sw_fg_params_direct_table_dump(int  unit,  int  fg_params_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__FG_PARAMS__DIRECT_TABLE, ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->fg_params))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__FG_PARAMS__DIRECT_TABLE, ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->fg_params) == 0)
        {
            SHR_EXIT();
        }
...
dnx_field_tcam_access_sw_fg_params_context_sharing_handlers_cb_dump(int  unit,  int  fg_params_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__FG_PARAMS__CONTEXT_SHARING_HANDLERS_CB, ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->fg_params))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__FG_PARAMS__CONTEXT_SHARING_HANDLERS_CB, ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->fg_params) == 0)
        {
            SHR_EXIT();
        }
...
int
dnx_field_tcam_access_sw_fg_prefix_per_core_dump(int  unit,  int  fg_prefix_per_core_idx_0,  int  fg_prefix_per_core_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = fg_prefix_per_core_idx_0, I0 = fg_prefix_per_core_idx_0 + 1;
    int i1 = fg_prefix_per_core_idx_1, I1 = fg_prefix_per_core_idx_1 + 1, org_i1 = fg_prefix_per_core_idx_1;
    char *s0 = "", *s1 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_field_tcam_access fg_prefix_per_core") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_field_tcam_access fg_prefix_per_core\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_field_tcam_access_sw/fg_prefix_per_core.txt",
            "dnx_field_tcam_access_sw[%d]->","((dnx_field_tcam_access_t*)sw_state_roots_array[%d][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->","fg_prefix_per_core[][]: ");
        ...
        if (i0 == -1) {
            ...
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->fg_prefix_per_core
                , sizeof(*((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->fg_prefix_per_core), I0, &s0) ? I0 - 1 : 0;
        }

        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__FG_PREFIX_PER_CORE, ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->fg_prefix_per_core))
        {
            LOG_CLI((BSL_META("dnx_field_tcam_access_sw[]->((dnx_field_tcam_access_t*)sw_state_roots_array[][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->fg_prefix_per_core[][]: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__FG_PREFIX_PER_CORE, ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->fg_prefix_per_core) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
                ...
                DNX_SW_STATE_DUMP_PTR_NULL_CHECK(
                    unit,
                    ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->fg_prefix_per_core[i0]);
            ...
            if (i1 == -1) {
                ...
                i1 = dnx_sw_state_dump_check_all_the_same(unit,
                    ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->fg_prefix_per_core[i0]
                    , sizeof(*((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->fg_prefix_per_core[i0]), I1, &s1) ? I1 - 1 : 0;
            }

            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__FG_PREFIX_PER_CORE, ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->fg_prefix_per_core[i0]))
            {
                LOG_CLI((BSL_META("dnx_field_tcam_access_sw[]->((dnx_field_tcam_access_t*)sw_state_roots_array[][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->fg_prefix_per_core[][]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_SW__FG_PREFIX_PER_CORE, ((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->fg_prefix_per_core[i0]) == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                DNX_SW_STATE_PRINT_MONITOR(
                    unit,
                    "dnx_field_tcam_access_sw[%d]->","((dnx_field_tcam_access_t*)sw_state_roots_array[%d][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->","fg_prefix_per_core[%s%d][%s%d]: ", s0, i0, s1, i1);
                ...
                dnx_sw_state_print_uint32(
                    unit,
                    &((dnx_field_tcam_access_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->fg_prefix_per_core[i0][i1]);
...
int
dnx_field_tcam_access_sw_cache_install_in_progress_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_field_tcam_access cache_install_in_progress") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_field_tcam_access cache_install_in_progress\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_field_tcam_access_sw/cache_install_in_progress.txt",
            "dnx_field_tcam_access_sw[%d]->","((dnx_field_tcam_access_t*)sw_state_roots_array[%d][DNX_FIELD_TCAM_ACCESS_MODULE_ID])->","cache_install_in_progress: ");
...
const char* dnx_field_tcam_access_sw_layout_str[DNX_FIELD_TCAM_ACCESS_SW_INFO_NOF_ENTRIES] = {
    ...
    "DNX_FIELD_TCAM_ACCESS_SW~FG_PREFIX_PER_CORE~",
    "DNX_FIELD_TCAM_ACCESS_SW~CACHE_INSTALL_IN_PROGRESS~",
};
#endif 
