...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_PEM_PER_PORT_DB, is_valid, "PEM_PER_PORT_DB", DBAL_ACCESS_METHOD_PEMLA));
    ...
    table_entry->table_labels[0] = DBAL_LABEL_PEM_DB;
    {
        ...
        DBAL_DB_INIT_TABLE_INTERFACE_KEY_FIELDS_ALLOC(table_entry, 2);
        {
            ...
            db_field.size = dnx_data_dnx2_mdb_app_db.fields.numeric_mdb_field___PEM_PER_PORT_DB___KEY___IN_PP_PORT_get(unit);
    ...
    dbal_db_init_table_db_struct_access_clear(cur_table_param, table_entry);
    {
        ...
        SHR_IF_ERR_EXIT(dbal_db_init_table_set_table_incompatible_image_sw_state_indication(unit, DBAL_TABLE_PEM_PER_PORT_DB, is_standard_1, is_compatible_with_all_images));
    }
