...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_SRV6_DIP_IDX_TYPES_PER_TUNNEL_GPORT_SW, is_valid, "SRV6_DIP_IDX_TYPES_PER_TUNNEL_GPORT_SW", DBAL_ACCESS_METHOD_SW_STATE));
    ...
    dbal_db_init_table_db_struct_access_clear(cur_table_param, table_entry);
    {
        ...
        SHR_IF_ERR_EXIT(dbal_db_init_table_set_table_incompatible_image_sw_state_indication(unit, DBAL_TABLE_SRV6_DIP_IDX_TYPES_PER_TUNNEL_GPORT_SW, is_standard_1, is_compatible_with_all_images));
    }
