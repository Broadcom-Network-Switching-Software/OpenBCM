...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    else if (DBAL_IS_J2P_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_ETPP_ETPS_FORMATS_ETPS_AC_TRIPLE_TAG].value_from_mapping = 10;
            enum_info[DBAL_ENUM_FVAL_ETPP_ETPS_FORMATS_ETPS_ARP].value_from_mapping = 7;
            enum_info[DBAL_ENUM_FVAL_ETPP_ETPS_FORMATS_ETPS_ARP_AC].value_from_mapping = 34;
            enum_info[DBAL_ENUM_FVAL_ETPP_ETPS_FORMATS_ETPS_ARP_AC_1TAG_STAT].value_from_mapping = 40;
            enum_info[DBAL_ENUM_FVAL_ETPP_ETPS_FORMATS_ETPS_ARP_SA_CUSTOM].value_from_mapping = 5;
            enum_info[DBAL_ENUM_FVAL_ETPP_ETPS_FORMATS_ETPS_ARP_SA_TUNNELING].value_from_mapping = 2;
            enum_info[DBAL_ENUM_FVAL_ETPP_ETPS_FORMATS_ETPS_BFD_IPV4_EXTRA_SIP].value_from_mapping = 22;
            enum_info[DBAL_ENUM_FVAL_ETPP_ETPS_FORMATS_ETPS_BIER_BASE].value_from_mapping = 23;
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    DBAL_INIT_FIELD_TYPES_ENUMS_CLEAR(cur_field_type_param);
    {
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_IRPP_IN_LIF_FORMATS_IN_LIF_IPVX_4, "IN_LIF_IPVX_4");
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_IRPP_IN_LIF_FORMATS_IN_LIF_PWE_P2P_NO_LEARNING_FLEXIBLE_PAYLOAD, "IN_LIF_PWE_P2P_NO_LEARNING_FLEXIBLE_PAYLOAD");
    ...
    if (DBAL_IS_J2C_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_IRPP_IN_LIF_FORMATS_IN_LIF_IPVX_4].value_from_mapping = 44;
            ...
            enum_info[DBAL_ENUM_FVAL_IRPP_IN_LIF_FORMATS_IN_LIF_PWE_P2P_NO_LEARNING_FLEXIBLE_PAYLOAD].value_from_mapping = 43;
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    DBAL_INIT_FIELD_TYPES_ENUMS_CLEAR(cur_field_type_param);
    {
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_EEDB_TYPE_EM_BUSTER_ETPS_ARP_AC___1___, "ETPS_ARP_AC___1___");
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_EEDB_TYPE_EM_BUSTER_ETPS_ARP_AC_1TAG_STAT___1___, "ETPS_ARP_AC_1TAG_STAT___1___");
    ...
    if (DBAL_IS_J2C_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_EEDB_TYPE_EM_BUSTER_ETPS_ARP_AC___1___].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_EEDB_TYPE_EM_BUSTER_ETPS_ARP_AC_1TAG_STAT].value_from_mapping = 6;
            enum_info[DBAL_ENUM_FVAL_EEDB_TYPE_EM_BUSTER_ETPS_ARP_AC_1TAG_STAT___1___].is_invalid_value_from_mapping = TRUE;
    ...
    else if (DBAL_IS_J2P_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_EEDB_TYPE_EM_BUSTER_ETPS_AC_STAT_PROTECTION].value_from_mapping = 8;
            enum_info[DBAL_ENUM_FVAL_EEDB_TYPE_EM_BUSTER_ETPS_AC_TRIPLE_TAG].value_from_mapping = 10;
            enum_info[DBAL_ENUM_FVAL_EEDB_TYPE_EM_BUSTER_ETPS_ARP_AC].value_from_mapping = 68;
            enum_info[DBAL_ENUM_FVAL_EEDB_TYPE_EM_BUSTER_ETPS_ARP_AC___1___].value_from_mapping = 69;
            enum_info[DBAL_ENUM_FVAL_EEDB_TYPE_EM_BUSTER_ETPS_ARP_AC_1TAG_STAT].value_from_mapping = 80;
            enum_info[DBAL_ENUM_FVAL_EEDB_TYPE_EM_BUSTER_ETPS_ARP_AC_1TAG_STAT___1___].value_from_mapping = 81;
            enum_info[DBAL_ENUM_FVAL_EEDB_TYPE_EM_BUSTER_ETPS_L2_FODO_VLANS].value_from_mapping = 33;
            enum_info[DBAL_ENUM_FVAL_EEDB_TYPE_EM_BUSTER_ETPS_RSPAN].value_from_mapping = 43;
        }
    }
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    DBAL_INIT_FIELD_TYPES_ENUMS_CLEAR(cur_field_type_param);
    {
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_EEDB_TYPE_VSD_ENABLE_ETPS_ARP_AC___1___, "ETPS_ARP_AC___1___");
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_EEDB_TYPE_VSD_ENABLE_ETPS_ARP_AC_1TAG_STAT___1___, "ETPS_ARP_AC_1TAG_STAT___1___");
    ...
    if (DBAL_IS_J2C_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_EEDB_TYPE_VSD_ENABLE_ETPS_ARP_AC___1___].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_EEDB_TYPE_VSD_ENABLE_ETPS_ARP_AC_1TAG_STAT].value_from_mapping = 6;
            enum_info[DBAL_ENUM_FVAL_EEDB_TYPE_VSD_ENABLE_ETPS_ARP_AC_1TAG_STAT___1___].is_invalid_value_from_mapping = TRUE;
    ...
    else if (DBAL_IS_J2P_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            dbal_db_enum_info_struct_t * enum_info = cur_field_type_param->enums;
            enum_info[DBAL_ENUM_FVAL_EEDB_TYPE_VSD_ENABLE_NONE].value_from_mapping = 0;
            enum_info[DBAL_ENUM_FVAL_EEDB_TYPE_VSD_ENABLE_ETPS_ARP_AC].value_from_mapping = 68;
            enum_info[DBAL_ENUM_FVAL_EEDB_TYPE_VSD_ENABLE_ETPS_ARP_AC___1___].value_from_mapping = 69;
            enum_info[DBAL_ENUM_FVAL_EEDB_TYPE_VSD_ENABLE_ETPS_ARP_AC_1TAG_STAT].value_from_mapping = 80;
            enum_info[DBAL_ENUM_FVAL_EEDB_TYPE_VSD_ENABLE_ETPS_ARP_AC_1TAG_STAT___1___].value_from_mapping = 81;
            enum_info[DBAL_ENUM_FVAL_EEDB_TYPE_VSD_ENABLE_ETPS_ARP_SA_CUSTOM].value_from_mapping = 5;
            enum_info[DBAL_ENUM_FVAL_EEDB_TYPE_VSD_ENABLE_ETPS_ARP_SA_TUNNELING].value_from_mapping = 2;
