...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    if (DBAL_IS_J2C_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_REFLECTORS___TWAMP_STATELESS_2ND_PASS].value_from_mapping = 48;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_REFLECTORS___L2_OAM_TERM].value_from_mapping = 49;
            ...
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_REFLECTORS___IP_UDP_SWAP].value_from_mapping = 52;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_REFLECTORS___IPV6_UDP_SWAP].value_from_mapping = 53;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_REFLECTORS___UDP_SWAP].value_from_mapping = 54;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_REFLECTORS___SEAMLESS_BFD].value_from_mapping = 55;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_SRV6___SEGMENT_ENDPOINT].value_from_mapping = 56;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_SRV6___PSP].value_from_mapping = 57;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_TM___TX_INJECT].value_from_mapping = 59;
            ...
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_SRV6___T_OR_B_INSERT_EXTENDED_PASS].value_from_mapping = 58;
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    if (DBAL_IS_J2C_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_OAM___UP_MEP].value_from_mapping = 42;
