    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_failover_path_select_define_egress_size].doc = "";
    ...
    submodule_data->defines[dnx_data_failover_path_select_define_ingress_size].doc = "";
    
    submodule_data->defines[dnx_data_failover_path_select_define_ingress_size].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_failover_path_select_define_ingress_mc_size].name = "ingress_mc_size";
    submodule_data->defines[dnx_data_failover_path_select_define_ingress_mc_size].doc = "";
    
    submodule_data->defines[dnx_data_failover_path_select_define_ingress_mc_size].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_failover_path_select_define_fec_size].name = "fec_size";
    submodule_data->defines[dnx_data_failover_path_select_define_fec_size].doc = "";
    ...
    submodule_data->defines[dnx_data_failover_path_select_define_egr_no_protection].doc = "";
    ...
    submodule_data->defines[dnx_data_failover_path_select_define_ing_no_protection].doc = "";
    
    submodule_data->defines[dnx_data_failover_path_select_define_ing_no_protection].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_failover_path_select_define_ing_mc_no_protection].name = "ing_mc_no_protection";
    submodule_data->defines[dnx_data_failover_path_select_define_ing_mc_no_protection].doc = "";
    
    submodule_data->defines[dnx_data_failover_path_select_define_ing_mc_no_protection].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_failover_path_select_define_fec_no_protection].name = "fec_no_protection";
    submodule_data->defines[dnx_data_failover_path_select_define_fec_no_protection].doc = "";
    ...
    submodule_data->defines[dnx_data_failover_path_select_define_fec_facility_protection].doc = "";
    ...
    submodule_data->defines[dnx_data_failover_path_select_define_nof_fec_path_select_banks].doc = "";
    
    submodule_data->defines[dnx_data_failover_path_select_define_nof_fec_path_select_banks].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_failover_path_select_define_nof_fec_path_select_banks_in_hw].name = "nof_fec_path_select_banks_in_hw";
    submodule_data->defines[dnx_data_failover_path_select_define_nof_fec_path_select_banks_in_hw].doc = "";
    
    submodule_data->defines[dnx_data_failover_path_select_define_nof_fec_path_select_banks_in_hw].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_failover_path_select_define_fec_bank_size].name = "fec_bank_size";
    submodule_data->defines[dnx_data_failover_path_select_define_fec_bank_size].doc = "";
    ...
    submodule_data->defines[dnx_data_failover_path_select_define_in_lif_protection_pointer_nof_msb].doc = "";
    ...
    submodule_data->defines[dnx_data_failover_path_select_define_in_lif_protection_pointer_nof_lsb].doc = "";
...
uint32
dnx_data_failover_path_select_ingress_mc_size_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_failover, dnx_data_failover_submodule_path_select, dnx_data_failover_path_select_define_ingress_mc_size);
}
...
uint32
dnx_data_failover_path_select_ing_mc_no_protection_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_failover, dnx_data_failover_submodule_path_select, dnx_data_failover_path_select_define_ing_mc_no_protection);
}
...
uint32
dnx_data_failover_path_select_nof_fec_path_select_banks_in_hw_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_failover, dnx_data_failover_submodule_path_select, dnx_data_failover_path_select_define_nof_fec_path_select_banks_in_hw);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_failover_facility_wcmp_facility_protection_supported].name = "wcmp_facility_protection_supported";
    submodule_data->features[dnx_data_failover_facility_wcmp_facility_protection_supported].doc = "";
    submodule_data->features[dnx_data_failover_facility_wcmp_facility_protection_supported].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_failover_facility_accelerated_mode_enable].name = "accelerated_mode_enable";
    submodule_data->features[dnx_data_failover_facility_accelerated_mode_enable].doc = "";
