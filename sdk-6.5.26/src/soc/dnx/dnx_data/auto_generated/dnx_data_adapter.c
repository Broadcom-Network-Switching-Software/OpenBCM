    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_special_swap_core_table].values[0].doc = "HW block type";
    ...
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_special_swap_core_table].values[1].doc = "regmem id";
    ...
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_special_swap_core_table].values[2].doc = "type of special swap";
    ...
    submodule_data->tables[dnx_data_adapter_reg_mem_access_table_special_swap_core_table].values[3].doc = "basic arg. used to calc the swapped special index/offset";
