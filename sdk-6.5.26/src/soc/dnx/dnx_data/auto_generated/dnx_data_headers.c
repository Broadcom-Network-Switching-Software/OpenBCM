    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_headers_system_headers_define_itpp_termination].name = "itpp_termination";
    submodule_data->defines[dnx_data_headers_system_headers_define_itpp_termination].doc = "";
    
    submodule_data->defines[dnx_data_headers_system_headers_define_itpp_termination].flags |= DNXC_DATA_F_NUMERIC;
...
uint32
dnx_data_headers_system_headers_itpp_termination_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_headers, dnx_data_headers_submodule_system_headers, dnx_data_headers_system_headers_define_itpp_termination);
}
