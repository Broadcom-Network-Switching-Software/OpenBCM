    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_mib_controlled_counters_table_counter_data].values[3].doc = "Counter register in the order in counter DMA buffer";
    ...
    submodule_data->tables[dnx_data_mib_controlled_counters_table_counter_data].values[4].doc = "Counter description";
    ...
    submodule_data->tables[dnx_data_mib_controlled_counters_table_flexmac_counter_data].values[0].doc = "Counter length in bits";
    ...
    submodule_data->tables[dnx_data_mib_controlled_counters_table_flexmac_counter_data].values[1].doc = "Counter description";
