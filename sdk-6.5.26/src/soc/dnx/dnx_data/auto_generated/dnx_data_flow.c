    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_flow_general_is_lif_profile_dedicated_logic_enabled].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_flow_ipv4_define_use_flow_lif_init].doc = "";
    ...
    submodule_data->defines[dnx_data_flow_ipv4_define_use_flow_lif_term].doc = "";
