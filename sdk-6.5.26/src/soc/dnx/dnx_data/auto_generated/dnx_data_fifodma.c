    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_fifodma_general_table_fifodma_map].values[1].doc = "Target FIFO ID";
    ...
    submodule_data->tables[dnx_data_fifodma_general_table_fifodma_map].values[2].doc = "FIFO count interface index";
