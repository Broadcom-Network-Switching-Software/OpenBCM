    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_ipq_queues_voq_resolution_per_dp].doc = "";
    ...
    submodule_data->features[dnx_data_ipq_queues_tc_profile_from_tm_command].doc = "";
    ...
    submodule_data->features[dnx_data_ipq_queues_invalid_queue_support].doc = "";
    ...
    submodule_data->defines[dnx_data_ipq_queues_define_nof_queues].doc = "";
    ...
    submodule_data->defines[dnx_data_ipq_queues_define_min_bundle_size].doc = "";
    ...
    submodule_data->defines[dnx_data_ipq_queues_define_fmq_bundle_size].doc = "";
    ...
    submodule_data->defines[dnx_data_ipq_queues_define_max_fmq_id].doc = "";
    ...
    submodule_data->defines[dnx_data_ipq_queues_define_queue_id_bits].doc = "";
    ...
    submodule_data->defines[dnx_data_ipq_queues_define_voq_offset_bits].doc = "";
    ...
    submodule_data->defines[dnx_data_ipq_queues_define_min_bundle_size_bits].doc = "";
    ...
    submodule_data->defines[dnx_data_ipq_queues_define_tc_profile_from_tm_command_nof_bits].doc = "";
    ...
    submodule_data->defines[dnx_data_ipq_queues_define_flow_quartet_nof_bits].doc = "";
    ...
    submodule_data->defines[dnx_data_ipq_queues_define_invalid_queue].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_ipq_regions_define_nof_queues].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_ipq_tc_map_define_nof_voq_flow_profiles].doc = "";
    ...
    submodule_data->defines[dnx_data_ipq_tc_map_define_voq_flow_profiles_bits].doc = "";
    ...
    submodule_data->defines[dnx_data_ipq_tc_map_define_default_voq_flow_profile_idx].doc = "";
    ...
    submodule_data->defines[dnx_data_ipq_tc_map_define_nof_sysport_profiles].doc = "";
    ...
    submodule_data->defines[dnx_data_ipq_tc_map_define_default_sysport_profile_idx].doc = "";
    ...
    submodule_data->defines[dnx_data_ipq_tc_map_define_voq_resolution_type_max_value].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->nof_features = _dnx_data_ipq_general_feature_nof;
    DNXC_DATA_ALLOC(submodule_data->features, dnxc_data_feature_t,  submodule_data->nof_features, "_dnxc_data ipq general features");

    submodule_data->features[dnx_data_ipq_general_is_used].name = "is_used";
    submodule_data->features[dnx_data_ipq_general_is_used].doc = "";
    submodule_data->features[dnx_data_ipq_general_is_used].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_ipq_general_power_down_supported].name = "power_down_supported";
    submodule_data->features[dnx_data_ipq_general_power_down_supported].doc = "";
    submodule_data->features[dnx_data_ipq_general_power_down_supported].flags |= DNXC_DATA_F_FEATURE;

    
    submodule_data->nof_defines = _dnx_data_ipq_general_define_nof;
    DNXC_DATA_ALLOC(submodule_data->defines, dnxc_data_define_t, submodule_data->nof_defines, "_dnxc_data ipq general defines");

    
    submodule_data->nof_tables = _dnx_data_ipq_general_table_nof;
    DNXC_DATA_ALLOC(submodule_data->tables, dnxc_data_table_t, submodule_data->nof_tables, "_dnxc_data ipq general tables");
...
int
dnx_data_ipq_general_feature_get(
    int unit,
    dnx_data_ipq_general_feature_e feature)
{
    return dnxc_data_mgmt_feature_data_get(unit, dnx_data_module_ipq, dnx_data_ipq_submodule_general, feature);
}
    ...
    dnxc_data_module_t *module_data)
{
    ...
    SHR_IF_ERR_EXIT(dnx_data_ipq_general_init(unit, &module_data->submodules[dnx_data_ipq_submodule_general]));
