...
extern shr_error_e j2x_a0_data_stack_attach(
    int unit);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_stack_general_define_nof_tm_domains_max].doc = "";
    ...
    submodule_data->defines[dnx_data_stack_general_define_dest_port_base_queue_min].doc = "";
    ...
    submodule_data->defines[dnx_data_stack_general_define_dest_port_base_queue_max].doc = "";
    ...
    submodule_data->defines[dnx_data_stack_general_define_lag_stack_trunk_resolve_entry_min].doc = "";
    ...
    submodule_data->defines[dnx_data_stack_general_define_lag_stack_trunk_resolve_entry_max].doc = "";
    ...
    submodule_data->defines[dnx_data_stack_general_define_lag_stack_trunk_resolve_entry_all].doc = "";
    ...
    submodule_data->defines[dnx_data_stack_general_define_lag_stack_fec_resolve_entry_min].doc = "";
    ...
    submodule_data->defines[dnx_data_stack_general_define_lag_stack_fec_resolve_entry_max].doc = "";
    ...
    submodule_data->defines[dnx_data_stack_general_define_lag_stack_fec_resolve_entry_all].doc = "";
    ...
    submodule_data->defines[dnx_data_stack_general_define_lag_domain_min].doc = "";
    ...
    submodule_data->defines[dnx_data_stack_general_define_lag_domain_max].doc = "";
    ...
    submodule_data->defines[dnx_data_stack_general_define_trunk_entry_per_tmd_bit_num].doc = "";
    ...
    submodule_data->defines[dnx_data_stack_general_define_stacking_enable].doc = "";
    ...
    dnxc_data_module_t *module_data)
{
    ...
    {
        SHR_IF_ERR_EXIT(jr2_a0_data_stack_attach(unit));
        SHR_IF_ERR_EXIT(j2x_a0_data_stack_attach(unit));
    }
    else
