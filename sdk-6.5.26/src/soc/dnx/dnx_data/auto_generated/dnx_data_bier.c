...
extern shr_error_e j2x_a0_data_bier_attach(
    int unit);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_bier_params_hw_supported].name = "hw_supported";
    submodule_data->features[dnx_data_bier_params_hw_supported].doc = "";
    submodule_data->features[dnx_data_bier_params_hw_supported].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_bier_params_is_supported].name = "is_supported";
    submodule_data->features[dnx_data_bier_params_is_supported].doc = "";
    submodule_data->features[dnx_data_bier_params_is_supported].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_bier_params_egress_only].name = "egress_only";
    submodule_data->features[dnx_data_bier_params_egress_only].doc = "";
    submodule_data->features[dnx_data_bier_params_egress_only].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_bier_params_ingress_only].name = "ingress_only";
    submodule_data->features[dnx_data_bier_params_ingress_only].doc = "";
    submodule_data->features[dnx_data_bier_params_ingress_only].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_bier_params_ingress_bfr_pos_msb_start].name = "ingress_bfr_pos_msb_start";
    submodule_data->features[dnx_data_bier_params_ingress_bfr_pos_msb_start].doc = "";
    submodule_data->features[dnx_data_bier_params_ingress_bfr_pos_msb_start].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_bier_params_bfr_bit_str_in_mcdb].name = "bfr_bit_str_in_mcdb";
    submodule_data->features[dnx_data_bier_params_bfr_bit_str_in_mcdb].doc = "";
    submodule_data->features[dnx_data_bier_params_bfr_bit_str_in_mcdb].flags |= DNXC_DATA_F_FEATURE;
    ...
    submodule_data->defines[dnx_data_bier_params_define_bitstring_size].doc = "";
    ...
    submodule_data->defines[dnx_data_bier_params_define_bfr_entry_size].doc = "";
    ...
    submodule_data->defines[dnx_data_bier_params_define_bank_entries].doc = "";
    ...
    submodule_data->defines[dnx_data_bier_params_define_bundle_nof_banks].doc = "";
    ...
    submodule_data->defines[dnx_data_bier_params_define_bundle_nof_banks_net].doc = "";
    ...
    submodule_data->defines[dnx_data_bier_params_define_nof_egr_table_copies].doc = "";
    
    submodule_data->defines[dnx_data_bier_params_define_nof_egr_table_copies].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_bier_params_define_mcdb_copies_per_entry].name = "mcdb_copies_per_entry";
    submodule_data->defines[dnx_data_bier_params_define_mcdb_copies_per_entry].doc = "";
    
    submodule_data->defines[dnx_data_bier_params_define_mcdb_copies_per_entry].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_bier_params_define_nof_bfr_entries].name = "nof_bfr_entries";
    submodule_data->defines[dnx_data_bier_params_define_nof_bfr_entries].doc = "";
    
    submodule_data->defines[dnx_data_bier_params_define_nof_bfr_entries].flags |= DNXC_DATA_F_NUMERIC;

    submodule_data->defines[dnx_data_bier_params_define_bier_mcdb_size].name = "bier_mcdb_size";
    submodule_data->defines[dnx_data_bier_params_define_bier_mcdb_size].doc = "";
    
    submodule_data->defines[dnx_data_bier_params_define_bier_mcdb_size].flags |= DNXC_DATA_F_NUMERIC;
...
uint32
dnx_data_bier_params_mcdb_copies_per_entry_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_bier, dnx_data_bier_submodule_params, dnx_data_bier_params_define_mcdb_copies_per_entry);
}
...
uint32
dnx_data_bier_params_bier_mcdb_size_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_bier, dnx_data_bier_submodule_params, dnx_data_bier_params_define_bier_mcdb_size);
}
    ...
    dnxc_data_module_t *module_data)
{
    ...
    {
        SHR_IF_ERR_EXIT(jr2_a0_data_bier_attach(unit));
        SHR_IF_ERR_EXIT(j2x_a0_data_bier_attach(unit));
    }
    else
