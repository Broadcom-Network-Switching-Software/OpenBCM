...
extern shr_error_e jr2_b0_data_graphical_attach(
    int unit);
...
extern shr_error_e j2x_a0_data_graphical_attach(
    int unit);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_graphical_diag_define_num_of_rows].doc = "";
    ...
    submodule_data->defines[dnx_data_graphical_diag_define_num_of_index].doc = "";
    ...
    submodule_data->defines[dnx_data_graphical_diag_define_num_of_block_entries].doc = "";
    ...
    submodule_data->tables[dnx_data_graphical_diag_table_blocks_left].doc = "";
    ...
    submodule_data->tables[dnx_data_graphical_diag_table_blocks_left].keys[0].doc = "";
    submodule_data->tables[dnx_data_graphical_diag_table_blocks_left].keys[1].name = "index";
    submodule_data->tables[dnx_data_graphical_diag_table_blocks_left].keys[1].doc = "";

    
    submodule_data->tables[dnx_data_graphical_diag_table_blocks_left].nof_values = 3;
    ...
    submodule_data->tables[dnx_data_graphical_diag_table_blocks_right].doc = "";
    ...
    submodule_data->tables[dnx_data_graphical_diag_table_blocks_right].keys[0].doc = "";
    submodule_data->tables[dnx_data_graphical_diag_table_blocks_right].keys[1].name = "index";
    submodule_data->tables[dnx_data_graphical_diag_table_blocks_right].keys[1].doc = "";

    
    submodule_data->tables[dnx_data_graphical_diag_table_blocks_right].nof_values = 3;
    ...
    submodule_data->tables[dnx_data_graphical_diag_table_counters].doc = "";
    ...
    submodule_data->tables[dnx_data_graphical_diag_table_counters].keys[0].doc = "";
    submodule_data->tables[dnx_data_graphical_diag_table_counters].keys[1].name = "index";
    submodule_data->tables[dnx_data_graphical_diag_table_counters].keys[1].doc = "";

    
    submodule_data->tables[dnx_data_graphical_diag_table_counters].nof_values = 10;
    ...
    submodule_data->tables[dnx_data_graphical_diag_table_counters].values[4].name = "core_fld_map";
    submodule_data->tables[dnx_data_graphical_diag_table_counters].values[4].type = "int[DNX_DIAG_COUNTER_REG_NOF_REGS]";
    submodule_data->tables[dnx_data_graphical_diag_table_counters].values[4].doc = "core id which the field map to";
    submodule_data->tables[dnx_data_graphical_diag_table_counters].values[4].offset = UTILEX_OFFSETOF(dnx_data_graphical_diag_counters_t, core_fld_map);
    submodule_data->tables[dnx_data_graphical_diag_table_counters].values[5].name = "overflow_field";
    submodule_data->tables[dnx_data_graphical_diag_table_counters].values[5].type = "int[DNX_DIAG_COUNTER_REG_NOF_REGS]";
    submodule_data->tables[dnx_data_graphical_diag_table_counters].values[5].doc = "overflow field name for counter";
    submodule_data->tables[dnx_data_graphical_diag_table_counters].values[5].offset = UTILEX_OFFSETOF(dnx_data_graphical_diag_counters_t, overflow_field);
    submodule_data->tables[dnx_data_graphical_diag_table_counters].values[6].name = "arr_i";
    submodule_data->tables[dnx_data_graphical_diag_table_counters].values[6].type = "uint32";
    submodule_data->tables[dnx_data_graphical_diag_table_counters].values[6].doc = "attribution index";
    submodule_data->tables[dnx_data_graphical_diag_table_counters].values[6].offset = UTILEX_OFFSETOF(dnx_data_graphical_diag_counters_t, arr_i);
    submodule_data->tables[dnx_data_graphical_diag_table_counters].values[7].name = "fld_num";
    submodule_data->tables[dnx_data_graphical_diag_table_counters].values[7].type = "uint32";
    submodule_data->tables[dnx_data_graphical_diag_table_counters].values[7].doc = "counter field number";
    submodule_data->tables[dnx_data_graphical_diag_table_counters].values[7].offset = UTILEX_OFFSETOF(dnx_data_graphical_diag_counters_t, fld_num);
    submodule_data->tables[dnx_data_graphical_diag_table_counters].values[8].name = "doc";
    submodule_data->tables[dnx_data_graphical_diag_table_counters].values[8].type = "char *";
    submodule_data->tables[dnx_data_graphical_diag_table_counters].values[8].doc = "counter description";
    submodule_data->tables[dnx_data_graphical_diag_table_counters].values[8].offset = UTILEX_OFFSETOF(dnx_data_graphical_diag_counters_t, doc);
    submodule_data->tables[dnx_data_graphical_diag_table_counters].values[9].name = "is_err";
    submodule_data->tables[dnx_data_graphical_diag_table_counters].values[9].type = "uint32";
    submodule_data->tables[dnx_data_graphical_diag_table_counters].values[9].doc = "error information need mask red";
    submodule_data->tables[dnx_data_graphical_diag_table_counters].values[9].offset = UTILEX_OFFSETOF(dnx_data_graphical_diag_counters_t, is_err);

    
    submodule_data->tables[dnx_data_graphical_diag_table_drop_reason].name = "drop_reason";
    submodule_data->tables[dnx_data_graphical_diag_table_drop_reason].doc = "";
    ...
    submodule_data->tables[dnx_data_graphical_diag_table_drop_reason].keys[0].doc = "";
    ...
    int value_index)
{
    ...
    switch (value_index)
    {
        ...
        case 3:
            ...
            break;
        case 4:
            DNXC_DATA_MGMT_ARR_STR(buffer, DNX_DIAG_COUNTER_REG_NOF_REGS, data->core_fld_map);
            break;
        case 5:
    ...
    dnxc_data_module_t *module_data)
{
    ...
    {
        SHR_IF_ERR_EXIT(jr2_a0_data_graphical_attach(unit));
        SHR_IF_ERR_EXIT(jr2_b0_data_graphical_attach(unit));
    }
    else
    ...
    {
        SHR_IF_ERR_EXIT(jr2_a0_data_graphical_attach(unit));
        SHR_IF_ERR_EXIT(j2x_a0_data_graphical_attach(unit));
    }
    else
