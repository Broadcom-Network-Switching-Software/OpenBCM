    ...
    int unit)
{
    ...
    table->values[0].default_val = "DNXC_SERDES_REF_CLOCK_156_25";
    ...
    default_data->in_freq = DNXC_SERDES_REF_CLOCK_156_25;
    ...
    if (0 < table->keys[0].size)
    {
        ...
        data->in_freq = DNXC_SERDES_REF_CLOCK_156_25;
        data->out_freq = DNXC_SERDES_REF_CLOCK_156_25;
    }
...
static shr_error_e
j2x_a0_dnx_data_pll_pll4_extra_post_div_dis_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_pll;
    int submodule_index = dnx_data_pll_submodule_pll4;
    int feature_index = dnx_data_pll_pll4_extra_post_div_dis;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_pll_pll4_extra_post_div_dis;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_pll_pll4_extra_post_div_dis_set;
