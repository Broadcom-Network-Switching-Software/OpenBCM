...
static shr_error_e
j2x_a0_dnx_data_l3_fec_supported_fec_flags_set(
    int unit)
{
...
static shr_error_e
j2x_a0_dnx_data_l3_fec_supported_fec_flags2_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_l3;
...
static shr_error_e
j2x_a0_dnx_data_l3_source_address_custom_sa_use_dual_homing_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_l3;
...
static shr_error_e
j2x_a0_dnx_data_l3_fwd_lpm_strength_profiles_support_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_l3;
...
static shr_error_e
j2x_a0_dnx_data_l3_fwd_nof_lpm_strength_profiles_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_l3;
...
static shr_error_e
j2x_a0_dnx_data_l3_fwd_lpm_profile_to_entry_strength_set(
    int unit)
{
...
static shr_error_e
j2x_a0_dnx_data_l3_ecmp_group_size_multiply_and_divide_nof_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_l3;
...
static shr_error_e
j2x_a0_dnx_data_l3_ecmp_member_table_nof_rows_size_in_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_l3;
...
static shr_error_e
j2x_a0_dnx_data_l3_ecmp_member_table_address_size_in_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_l3;
...
static shr_error_e
j2x_a0_dnx_data_l3_ecmp_tunnel_priority_support_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_l3;
...
static shr_error_e
j2x_a0_dnx_data_l3_ecmp_nof_tunnel_priority_map_profiles_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_l3;
...
static shr_error_e
j2x_a0_dnx_data_l3_ecmp_tunnel_priority_field_width_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_l3;
...
static shr_error_e
j2x_a0_dnx_data_l3_ecmp_tunnel_priority_index_field_width_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_l3;
...
static shr_error_e
j2x_a0_dnx_data_l3_feature_ipv6_mc_compatible_dmac_set(
    int unit)
{
...
static shr_error_e
j2x_a0_dnx_data_l3_feature_fec_hit_bit_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l3;
...
static shr_error_e
j2x_a0_dnx_data_l3_feature_mc_bridge_fallback_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l3;
...
static shr_error_e
j2x_a0_dnx_data_l3_feature_nat_on_a_stick_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l3;
...
static shr_error_e
j2x_a0_dnx_data_l3_feature_ingress_frag_not_first_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l3;
...
static shr_error_e
j2x_a0_dnx_data_l3_feature_my_mac_prefix_0_is_invalid_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l3;
...
static shr_error_e
j2x_a0_dnx_data_l3_feature_mc_bridge_fallback_outlifs_set_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l3;
    ...
    int unit)
{
    ...
    define->set = j2x_a0_dnx_data_l3_fec_supported_fec_flags_set;
    data_index = dnx_data_l3_fec_define_supported_fec_flags2;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_l3_fec_supported_fec_flags2_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_l3_source_address_custom_sa_use_dual_homing_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_l3_fwd_lpm_strength_profiles_support_set;
    data_index = dnx_data_l3_fwd_define_nof_lpm_strength_profiles;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_l3_fwd_nof_lpm_strength_profiles_set;
    ...
    table->set = j2x_a0_dnx_data_l3_fwd_lpm_profile_to_entry_strength_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_l3_ecmp_group_size_multiply_and_divide_nof_bits_set;
    data_index = dnx_data_l3_ecmp_define_member_table_nof_rows_size_in_bits;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_l3_ecmp_member_table_nof_rows_size_in_bits_set;
    data_index = dnx_data_l3_ecmp_define_member_table_address_size_in_bits;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_l3_ecmp_member_table_address_size_in_bits_set;
    data_index = dnx_data_l3_ecmp_define_tunnel_priority_support;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_l3_ecmp_tunnel_priority_support_set;
    data_index = dnx_data_l3_ecmp_define_nof_tunnel_priority_map_profiles;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_l3_ecmp_nof_tunnel_priority_map_profiles_set;
    data_index = dnx_data_l3_ecmp_define_tunnel_priority_field_width;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_l3_ecmp_tunnel_priority_field_width_set;
    data_index = dnx_data_l3_ecmp_define_tunnel_priority_index_field_width;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_l3_ecmp_tunnel_priority_index_field_width_set;
    ...
    feature->set = j2x_a0_dnx_data_l3_feature_ipv6_mc_compatible_dmac_set;
    data_index = dnx_data_l3_feature_fec_hit_bit;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_l3_feature_fec_hit_bit_set;
    data_index = dnx_data_l3_feature_mc_bridge_fallback;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_l3_feature_mc_bridge_fallback_set;
    data_index = dnx_data_l3_feature_nat_on_a_stick;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_l3_feature_nat_on_a_stick_set;
    data_index = dnx_data_l3_feature_ingress_frag_not_first;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_l3_feature_ingress_frag_not_first_set;
    data_index = dnx_data_l3_feature_my_mac_prefix_0_is_invalid;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_l3_feature_my_mac_prefix_0_is_invalid_set;
    data_index = dnx_data_l3_feature_mc_bridge_fallback_outlifs_set;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_l3_feature_mc_bridge_fallback_outlifs_set_set;
