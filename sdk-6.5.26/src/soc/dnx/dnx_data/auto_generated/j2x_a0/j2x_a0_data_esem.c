...
static shr_error_e
j2x_a0_dnx_data_esem_access_cmd_arp_plus_ac_port_svtag_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_esem;
...
static shr_error_e
j2x_a0_dnx_data_esem_access_cmd_nof_esem_cmd_default_profiles_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_esem;
...
static shr_error_e
j2x_a0_dnx_data_esem_feature_esem_name_space_nof_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_esem;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_esem_access_cmd_arp_plus_ac_port_svtag_set;
    data_index = dnx_data_esem_access_cmd_define_nof_esem_cmd_default_profiles;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_esem_access_cmd_nof_esem_cmd_default_profiles_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_esem_feature_esem_name_space_nof_bits_set;
