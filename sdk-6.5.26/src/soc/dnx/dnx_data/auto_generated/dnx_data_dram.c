    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_dram_gddr6_table_ca_system_config_fields].values[0].doc = "channel A start bit";
    ...
    submodule_data->tables[dnx_data_dram_gddr6_table_ca_system_config_fields].values[1].doc = "channel B start bit";
    ...
    submodule_data->tables[dnx_data_dram_gddr6_table_ca_system_config_fields].values[2].doc = "value to write to field";
    ...
    submodule_data->tables[dnx_data_dram_gddr6_table_ca_system_config_fields].values[3].doc = "number of bits to write";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_dram_general_info_table_timing_params].values[14].doc = "trtw timing parameter, non-final value,only used when numeric tertw is not set";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_dram_dram_block_define_wmr_reset_on_deassert].doc = "";
    ...
    submodule_data->defines[dnx_data_dram_dram_block_define_wmr_full_size].doc = "";
    ...
    submodule_data->defines[dnx_data_dram_dram_block_define_average_read_inflights_assert_threshold].doc = "";
    ...
    submodule_data->defines[dnx_data_dram_dram_block_define_average_read_inflights_full_size].doc = "";
    ...
    submodule_data->tables[dnx_data_dram_dram_block_table_wpr_leaky_bucket_increment_th].doc = "";
    ...
    submodule_data->tables[dnx_data_dram_dram_block_table_wpr_leaky_bucket_increment_th].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_dram_dram_block_table_write_leaky_bucket_increment_th].doc = "";
    ...
    submodule_data->tables[dnx_data_dram_dram_block_table_write_leaky_bucket_increment_th].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_dram_dram_block_table_gddr6_average_read_inflights_leaky_bucket_config_params].doc = "";
    ...
    submodule_data->tables[dnx_data_dram_dram_block_table_gddr6_average_read_inflights_leaky_bucket_config_params].keys[0].doc = "";
