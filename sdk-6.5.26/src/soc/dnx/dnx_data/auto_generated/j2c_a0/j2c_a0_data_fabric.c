...
static shr_error_e
j2c_a0_dnx_data_fabric_dbal_fdr_links_offset_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_fabric;
...
static shr_error_e
j2c_a0_dnx_data_fabric_regression_soft_reset_with_fabric_max_exec_time_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_fabric;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_fabric_dbal_fdr_links_offset_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_fabric_regression_soft_reset_with_fabric_max_exec_time_set;
