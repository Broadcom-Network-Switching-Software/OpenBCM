...
static shr_error_e
j2c_a0_dnx_data_iqs_credit_watchdog_delete_special_mode_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_iqs;
    int submodule_index = dnx_data_iqs_submodule_credit;
    int feature_index = dnx_data_iqs_credit_watchdog_delete_special_mode;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_iqs_credit_watchdog_delete_special_mode;
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_iqs_credit_watchdog_delete_special_mode_set;
