...
static shr_error_e
j2c_a0_dnx_data_nif_global_bh_refclk_termination_inverted_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_global;
    int feature_index = dnx_data_nif_global_bh_refclk_termination_inverted;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
j2c_a0_dnx_data_nif_phys_max_phys_in_core_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
...
static shr_error_e
j2c_a0_dnx_data_nif_phys_nof_phys_per_core_set(
    int unit)
{
    int core_index_index;
...
static shr_error_e
j2c_a0_dnx_data_nif_ilkn_legacy_lane_format_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
...
static shr_error_e
j2c_a0_dnx_data_nif_ilkn_is_20p6G_speed_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
...
static shr_error_e
j2c_a0_dnx_data_nif_ilkn_is_28p1G_speed_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
...
static shr_error_e
j2c_a0_dnx_data_nif_ilkn_burst_max_range_max_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
...
static shr_error_e
j2c_a0_dnx_data_nif_ilkn_burst_min_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
...
static shr_error_e
j2c_a0_dnx_data_nif_ilkn_burst_min_range_max_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
...
static shr_error_e
j2c_a0_dnx_data_nif_ilkn_interleaved_error_drop_single_context_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
...
static shr_error_e
j2c_a0_dnx_data_nif_eth_ethu_per_core_set(
    int unit)
{
    int ethu_index_index;
...
static shr_error_e
j2c_a0_dnx_data_nif_eth_nif_cores_ethus_set(
    int unit)
{
    int core_id_index;
...
static shr_error_e
j2c_a0_dnx_data_nif_prd_is_mask_parser_tdm_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
    ...
    int unit)
{
    ...
    data_index = dnx_data_nif_global_bh_refclk_termination_inverted;
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_nif_global_bh_refclk_termination_inverted_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_nif_phys_max_phys_in_core_set;
    ...
    table = &submodule->tables[data_index];
    table->set = j2c_a0_dnx_data_nif_phys_nof_phys_per_core_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_nif_ilkn_burst_max_range_max_set;
    data_index = dnx_data_nif_ilkn_define_burst_min;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_nif_ilkn_burst_min_set;
    data_index = dnx_data_nif_ilkn_define_burst_min_range_max;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_nif_ilkn_burst_min_range_max_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_nif_ilkn_interleaved_error_drop_single_context_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_nif_ilkn_legacy_lane_format_set;
    data_index = dnx_data_nif_ilkn_is_20p6G_speed_supported;
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_nif_ilkn_is_20p6G_speed_supported_set;
    data_index = dnx_data_nif_ilkn_is_25G_speed_supported;
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_nif_ilkn_is_25G_speed_supported_set;
    data_index = dnx_data_nif_ilkn_is_28p1G_speed_supported;
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_nif_ilkn_is_28p1G_speed_supported_set;
    ...
    table = &submodule->tables[data_index];
    table->set = j2c_a0_dnx_data_nif_eth_ethu_per_core_set;
    data_index = dnx_data_nif_eth_table_nif_cores_ethus;
    table = &submodule->tables[data_index];
    table->set = j2c_a0_dnx_data_nif_eth_nif_cores_ethus_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_nif_prd_is_mask_parser_tdm_supported_set;
