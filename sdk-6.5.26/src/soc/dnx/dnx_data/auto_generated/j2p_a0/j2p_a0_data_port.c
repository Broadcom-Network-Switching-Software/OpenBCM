...
static shr_error_e
j2p_a0_dnx_data_port_static_add_header_type_set(
    int unit)
{
    int port_index;
...
static shr_error_e
j2p_a0_dnx_data_port_general_unrestricted_portmod_pll_set(
    int unit)
{
...
static shr_error_e
j2p_a0_dnx_data_port_general_use_portmod_speed_when_not_enabled_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_port;
...
static shr_error_e
j2p_a0_dnx_data_port_general_ingress_vlan_domain_size_set(
    int unit)
{
...
static shr_error_e
j2p_a0_dnx_data_port_general_vlan_domain_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_port;
...
static shr_error_e
j2p_a0_dnx_data_port_general_ffc_instruction_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_port;
...
static shr_error_e
j2p_a0_dnx_data_port_general_ffc_instruction_offset_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_port;
...
static shr_error_e
j2p_a0_dnx_data_port_general_ffc_instruction_width_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_port;
...
static shr_error_e
j2p_a0_dnx_data_port_general_ffc_instruction_input_offset_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_port;
...
static shr_error_e
j2p_a0_dnx_data_port_general_prt_ffc_width_start_offset_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_port;
...
static shr_error_e
j2p_a0_dnx_data_port_general_prt_ffc_start_input_offset_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_port;
...
static shr_error_e
j2p_a0_dnx_data_port_general_nof_port_bits_in_pp_bus_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_port;
    ...
    int unit)
{
    ...
    table->set = j2p_a0_dnx_data_port_static_add_header_type_set;
    ...
    define->set = j2p_a0_dnx_data_port_general_ingress_vlan_domain_size_set;
    data_index = dnx_data_port_general_define_vlan_domain_size;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_port_general_vlan_domain_size_set;
    data_index = dnx_data_port_general_define_ffc_instruction_size;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_port_general_ffc_instruction_size_set;
    data_index = dnx_data_port_general_define_ffc_instruction_offset_size;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_port_general_ffc_instruction_offset_size_set;
    data_index = dnx_data_port_general_define_ffc_instruction_width_size;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_port_general_ffc_instruction_width_size_set;
    data_index = dnx_data_port_general_define_ffc_instruction_input_offset_size;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_port_general_ffc_instruction_input_offset_size_set;
    data_index = dnx_data_port_general_define_prt_ffc_width_start_offset;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_port_general_prt_ffc_width_start_offset_set;
    data_index = dnx_data_port_general_define_prt_ffc_start_input_offset;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_port_general_prt_ffc_start_input_offset_set;
    data_index = dnx_data_port_general_define_nof_port_bits_in_pp_bus;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_port_general_nof_port_bits_in_pp_bus_set;

    
    data_index = dnx_data_port_general_unrestricted_portmod_pll;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_port_general_unrestricted_portmod_pll_set;
    data_index = dnx_data_port_general_use_portmod_speed_when_not_enabled;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_port_general_use_portmod_speed_when_not_enabled_set;
