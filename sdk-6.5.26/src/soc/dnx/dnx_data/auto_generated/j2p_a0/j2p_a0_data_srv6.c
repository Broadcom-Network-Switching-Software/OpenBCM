...
static shr_error_e
j2p_a0_dnx_data_srv6_general_jr2_compatible_set(
    int unit)
{
...
static shr_error_e
j2p_a0_dnx_data_srv6_termination_max_nof_terminated_sids_psp_extended_set(
    int unit)
{
...
static shr_error_e
j2p_a0_dnx_data_srv6_termination_max_nof_terminated_sids_usd_1pass_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_srv6;
...
static shr_error_e
j2p_a0_dnx_data_srv6_encapsulation_is_t_insert_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_srv6;
    ...
    int unit)
{
    ...
    feature->set = j2p_a0_dnx_data_srv6_general_jr2_compatible_set;
    ...
    define->set = j2p_a0_dnx_data_srv6_termination_max_nof_terminated_sids_psp_extended_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_srv6_termination_max_nof_terminated_sids_usd_1pass_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_srv6_encapsulation_is_t_insert_support_set;
