...
static shr_error_e
j2p_a0_dnx_data_regression_dvapi_topology_nof_pm_ext_loops_set(
    int unit)
{
...
static shr_error_e
j2p_a0_dnx_data_regression_dvapi_topology_nof_pm_p2p_links_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_regression;
...
static shr_error_e
j2p_a0_dnx_data_regression_dvapi_topology_nof_pm_force_er_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_regression;
...
static shr_error_e
j2p_a0_dnx_data_regression_dvapi_topology_pm_ext_loops_set(
    int unit)
{
    int index_index;
...
static shr_error_e
j2p_a0_dnx_data_regression_dvapi_topology_pm_p2p_links_set(
    int unit)
{
    int index_index;
...
static shr_error_e
j2p_a0_dnx_data_regression_dvapi_topology_pm_force_er_set(
    int unit)
{
    int index_index;
    ...
    if (0 < table->keys[0].size)
    {
        data = (dnx_data_regression_dvapi_topology_pm_force_er_t *) dnxc_data_mgmt_table_data_get(unit, table, 0, 0);
        data->pm_id = 17;
    }
...
static shr_error_e
j2p_a0_dnx_data_regression_ser_parameters_cgm_voq_profiles_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_regression;
...
static shr_error_e
j2p_a0_dnx_data_regression_ser_parameters_ecgm_qqst_table_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_regression;
...
static shr_error_e
j2p_a0_dnx_data_regression_ser_parameters_ecgm_qdct_table_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_regression;
...
static shr_error_e
j2p_a0_dnx_data_regression_ser_parameters_erpp_per_pp_port_table_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_regression;
...
static shr_error_e
j2p_a0_dnx_data_regression_ser_parameters_mdb_ivsi_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_regression;
...
static shr_error_e
j2p_a0_dnx_data_regression_ser_parameters_mdb_evsi_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_regression;
...
static shr_error_e
j2p_a0_dnx_data_regression_ser_parameters_mdb_glem_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_regression;
...
static shr_error_e
j2p_a0_dnx_data_regression_ser_parameters_mdb_exem_1_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_regression;
...
static shr_error_e
j2p_a0_dnx_data_regression_ser_parameters_mdb_fec_1_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_regression;
...
static shr_error_e
j2p_a0_dnx_data_regression_ser_parameters_cgm_ipp_map_set(
    int unit)
{
    int index_index;
...
static shr_error_e
j2p_a0_dnx_data_regression_ser_parameters_cgm_voq_dram_bound_prms_set(
    int unit)
{
    int index_index;
...
static shr_error_e
j2p_a0_dnx_data_regression_ser_parameters_cgm_voq_dram_recovery_prms_set(
    int unit)
{
    int index_index;
...
static shr_error_e
j2p_a0_dnx_data_regression_source_info_tlist_set(
    int unit)
{
    int index_index;
    ...
    if (0 < table->keys[0].size)
    {
        ...
        data->tlist = "testDvapiJ2PPreCommitRealDevice";
    }
    if (1 < table->keys[0].size)
    {
...
static shr_error_e
j2p_a0_dnx_data_regression_access_access_mode_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_regression;
...
static shr_error_e
j2p_a0_dnx_data_regression_access_severity_miss_check_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_regression;
    ...
    int unit)
{
    ...
    define->set = j2p_a0_dnx_data_regression_dvapi_topology_nof_pm_ext_loops_set;
    data_index = dnx_data_regression_dvapi_topology_define_nof_pm_p2p_links;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_regression_dvapi_topology_nof_pm_p2p_links_set;
    data_index = dnx_data_regression_dvapi_topology_define_nof_pm_force_er;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_regression_dvapi_topology_nof_pm_force_er_set;
    ...
    table->set = j2p_a0_dnx_data_regression_dvapi_topology_pm_ext_loops_set;
    data_index = dnx_data_regression_dvapi_topology_table_pm_p2p_links;
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_regression_dvapi_topology_pm_p2p_links_set;
    data_index = dnx_data_regression_dvapi_topology_table_pm_force_er;
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_regression_dvapi_topology_pm_force_er_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_regression_ser_parameters_cgm_voq_profiles_set;
    data_index = dnx_data_regression_ser_parameters_define_ecgm_qqst_table;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_regression_ser_parameters_ecgm_qqst_table_set;
    data_index = dnx_data_regression_ser_parameters_define_ecgm_qdct_table;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_regression_ser_parameters_ecgm_qdct_table_set;
    data_index = dnx_data_regression_ser_parameters_define_erpp_per_pp_port_table;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_regression_ser_parameters_erpp_per_pp_port_table_set;
    data_index = dnx_data_regression_ser_parameters_define_mdb_ivsi;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_regression_ser_parameters_mdb_ivsi_set;
    data_index = dnx_data_regression_ser_parameters_define_mdb_evsi;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_regression_ser_parameters_mdb_evsi_set;
    data_index = dnx_data_regression_ser_parameters_define_mdb_glem;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_regression_ser_parameters_mdb_glem_set;
    data_index = dnx_data_regression_ser_parameters_define_mdb_exem_1;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_regression_ser_parameters_mdb_exem_1_set;
    data_index = dnx_data_regression_ser_parameters_define_mdb_fec_1;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_regression_ser_parameters_mdb_fec_1_set;
    ...
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_regression_ser_parameters_cgm_ipp_map_set;
    data_index = dnx_data_regression_ser_parameters_table_cgm_voq_dram_bound_prms;
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_regression_ser_parameters_cgm_voq_dram_bound_prms_set;
    data_index = dnx_data_regression_ser_parameters_table_cgm_voq_dram_recovery_prms;
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_regression_ser_parameters_cgm_voq_dram_recovery_prms_set;
    ...
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_regression_source_info_tlist_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_regression_access_access_mode_set;
    data_index = dnx_data_regression_access_define_severity_miss_check;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_regression_access_severity_miss_check_set;
