    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_intr_general_new_access_support].name = "new_access_support";
    submodule_data->features[dnx_data_intr_general_new_access_support].doc = "";
    submodule_data->features[dnx_data_intr_general_new_access_support].flags |= DNXC_DATA_F_FEATURE;
    ...
    submodule_data->defines[dnx_data_intr_general_define_nof_interrupts].doc = "";
    ...
    submodule_data->defines[dnx_data_intr_general_define_polled_irq_mode].doc = "";
    ...
    submodule_data->defines[dnx_data_intr_general_define_polled_irq_priority].doc = "";
    ...
    submodule_data->defines[dnx_data_intr_general_define_polled_irq_delay].doc = "";
    ...
    submodule_data->defines[dnx_data_intr_general_define_epni_ebd_interrupt_assert_enable].doc = "";
    ...
    submodule_data->defines[dnx_data_intr_general_define_table_dma_enable].doc = "";
    ...
    submodule_data->defines[dnx_data_intr_general_define_tdma_timeout_usec].doc = "";
    ...
    submodule_data->defines[dnx_data_intr_general_define_tdma_intr_enable].doc = "";
    ...
    submodule_data->defines[dnx_data_intr_general_define_tslam_dma_enable].doc = "";
    ...
    submodule_data->defines[dnx_data_intr_general_define_tslam_timeout_usec].doc = "";
    ...
    submodule_data->defines[dnx_data_intr_general_define_tslam_intr_enable].doc = "";
    ...
    submodule_data->defines[dnx_data_intr_general_define_schan_timeout_usec].doc = "";
    ...
    submodule_data->defines[dnx_data_intr_general_define_schan_intr_enable].doc = "";
    ...
    submodule_data->defines[dnx_data_intr_general_define_miim_timeout_usec].doc = "";
    ...
    submodule_data->defines[dnx_data_intr_general_define_miim_intr_enable].doc = "";
    ...
    submodule_data->defines[dnx_data_intr_general_define_sbus_dma_interval].doc = "";
    ...
    submodule_data->defines[dnx_data_intr_general_define_sbus_dma_intr_enable].doc = "";
    ...
    submodule_data->defines[dnx_data_intr_general_define_mem_clear_chunk_size].doc = "";
    ...
    submodule_data->defines[dnx_data_intr_general_define_ser_event_generate_support].doc = "";
    
    submodule_data->defines[dnx_data_intr_general_define_ser_event_generate_support].flags |= DNXC_DATA_F_NUMERIC;

    submodule_data->defines[dnx_data_intr_general_define_ser_reset_cb_en_support].name = "ser_reset_cb_en_support";
    submodule_data->defines[dnx_data_intr_general_define_ser_reset_cb_en_support].doc = "";
    
    submodule_data->defines[dnx_data_intr_general_define_ser_reset_cb_en_support].flags |= DNXC_DATA_F_NUMERIC;
    ...
    submodule_data->tables[dnx_data_intr_general_table_active_on_init].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_general_table_active_on_init].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_general_table_disable_on_init].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_general_table_disable_on_init].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_general_table_disable_print_on_init].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_general_table_disable_print_on_init].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_general_table_block_intr_field_mapping].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_general_table_block_intr_field_mapping].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_init].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_init].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_general_table_force_unmask_on_init].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_general_table_force_unmask_on_init].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_regress].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_general_table_skip_clear_on_regress].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_general_table_framer_module_map].name = "framer_module_map";
    submodule_data->tables[dnx_data_intr_general_table_framer_module_map].doc = "";
    submodule_data->tables[dnx_data_intr_general_table_framer_module_map].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_intr_general_table_framer_module_map].size_of_values = sizeof(dnx_data_intr_general_framer_module_map_t);
    submodule_data->tables[dnx_data_intr_general_table_framer_module_map].entry_get = dnx_data_intr_general_framer_module_map_entry_str_get;

    
    submodule_data->tables[dnx_data_intr_general_table_framer_module_map].nof_keys = 1;
    submodule_data->tables[dnx_data_intr_general_table_framer_module_map].keys[0].name = "offset";
    submodule_data->tables[dnx_data_intr_general_table_framer_module_map].keys[0].doc = "";

    
    submodule_data->tables[dnx_data_intr_general_table_framer_module_map].nof_values = 2;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_intr_general_table_framer_module_map].values, dnxc_data_value_t, submodule_data->tables[dnx_data_intr_general_table_framer_module_map].nof_values, "_dnx_data_intr_general_table_framer_module_map table values");
    submodule_data->tables[dnx_data_intr_general_table_framer_module_map].values[0].name = "core_regs";
    submodule_data->tables[dnx_data_intr_general_table_framer_module_map].values[0].type = "soc_mem_t";
    submodule_data->tables[dnx_data_intr_general_table_framer_module_map].values[0].doc = "core register memory name";
    submodule_data->tables[dnx_data_intr_general_table_framer_module_map].values[0].offset = UTILEX_OFFSETOF(dnx_data_intr_general_framer_module_map_t, core_regs);
    submodule_data->tables[dnx_data_intr_general_table_framer_module_map].values[1].name = "instance";
    submodule_data->tables[dnx_data_intr_general_table_framer_module_map].values[1].type = "uint32";
    submodule_data->tables[dnx_data_intr_general_table_framer_module_map].values[1].doc = "block instance for core register memory";
    submodule_data->tables[dnx_data_intr_general_table_framer_module_map].values[1].offset = UTILEX_OFFSETOF(dnx_data_intr_general_framer_module_map_t, instance);
...
uint32
dnx_data_intr_general_ser_reset_cb_en_support_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_intr, dnx_data_intr_submodule_general, dnx_data_intr_general_define_ser_reset_cb_en_support);
}
...
const dnx_data_intr_general_framer_module_map_t *
dnx_data_intr_general_framer_module_map_get(
    int unit,
    int offset)
{
    char *data;
    ...
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_intr, dnx_data_intr_submodule_general, dnx_data_intr_general_table_framer_module_map);
    
    data = dnxc_data_mgmt_table_data_get(unit, table, offset, 0);
    return (const dnx_data_intr_general_framer_module_map_t *) data;
...
shr_error_e
dnx_data_intr_general_framer_module_map_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_intr_general_framer_module_map_t *data;
    SHR_FUNC_INIT_VARS(unit);

    
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_intr, dnx_data_intr_submodule_general, dnx_data_intr_general_table_framer_module_map);
    data = (const dnx_data_intr_general_framer_module_map_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->core_regs);
            break;
        case 1:
...
const dnxc_data_table_info_t *
dnx_data_intr_general_framer_module_map_info_get(
    int unit)
{

    
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_intr, dnx_data_intr_submodule_general, dnx_data_intr_general_table_framer_module_map);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_intr_ser_define_tcam_protection_issue].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_mem_mask].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_mem_mask].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_xor_mem].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_xor_mem].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_intr_exception].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_intr_exception].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_static_mem].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_static_mem].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_dynamic_mem].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_dynamic_mem].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_mdb_mem_map].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_mdb_mem_map].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_kaps_tcam_scan].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_severity_mem].doc = "";
    ...
    submodule_data->tables[dnx_data_intr_ser_table_severity_mem].keys[0].doc = "";
