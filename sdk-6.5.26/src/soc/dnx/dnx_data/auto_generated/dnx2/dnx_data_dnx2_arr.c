    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_prefix_define_IRPP_IN_LIF_FORMATS___prefix_Free].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_max_nof_entries_define_IPPB_ACCEPTED_ARR].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_max_nof_entries_define_IPPB_EXPECTED_ACCEPTED_STRENGTH_ARR].doc = "";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_arr_max_nof_entries_define_IPPB_EXPECTED_ARR].doc = "";
