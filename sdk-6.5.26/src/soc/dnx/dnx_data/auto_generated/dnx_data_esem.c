    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_esem_access_cmd_define_arp_plus_ac_port_svtag].name = "arp_plus_ac_port_svtag";
    submodule_data->defines[dnx_data_esem_access_cmd_define_arp_plus_ac_port_svtag].doc = "";
    
    submodule_data->defines[dnx_data_esem_access_cmd_define_arp_plus_ac_port_svtag].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_esem_access_cmd_arp_plus_ac_port_svtag_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_esem, dnx_data_esem_submodule_access_cmd, dnx_data_esem_access_cmd_define_arp_plus_ac_port_svtag);
}
