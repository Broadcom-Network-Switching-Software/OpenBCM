    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_srv6_general_usid_extended_support].name = "usid_extended_support";
    submodule_data->features[dnx_data_srv6_general_usid_extended_support].doc = "";
    submodule_data->features[dnx_data_srv6_general_usid_extended_support].flags |= DNXC_DATA_F_FEATURE;
