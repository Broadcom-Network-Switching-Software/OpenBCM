    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_debug_mem_new_access].name = "new_access";
    submodule_data->features[dnx_data_debug_mem_new_access].doc = "";
    submodule_data->features[dnx_data_debug_mem_new_access].flags |= DNXC_DATA_F_FEATURE;
    if (!soc_is(unit, DNX2_DEVICE))
    {
        submodule_data->features[dnx_data_debug_mem_new_access].data = 0;
    }
    ...
    submodule_data->tables[dnx_data_debug_mem_table_params].doc = "";
    ...
    submodule_data->tables[dnx_data_debug_mem_table_params].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_debug_mem_table_block_map].doc = "";
    ...
    submodule_data->tables[dnx_data_debug_mem_table_block_map].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_debug_mem_table_mem_array].doc = "";
    ...
    submodule_data->tables[dnx_data_debug_mem_table_mem_array].keys[0].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_debug_feature_no_hit_bit_on_mdb_access].doc = "";
    ...
    submodule_data->features[dnx_data_debug_feature_iparser_signals_valid].doc = "";
    ...
    submodule_data->features[dnx_data_debug_feature_fwd_action_signals_from_lbp_valid].doc = "";
    ...
    submodule_data->features[dnx_data_debug_feature_esem_result_signals_valid].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_debug_kleap_define_fwd1_gen_data_size].doc = "";
    ...
    submodule_data->defines[dnx_data_debug_kleap_define_fwd2_gen_data_size].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_debug_general_define_global_visibility].doc = "";
    ...
    submodule_data->defines[dnx_data_debug_general_define_has_etpp_visibility_enabler].doc = "";
    ...
    submodule_data->defines[dnx_data_debug_general_define_has_periodic_visibility].doc = "";
    ...
    submodule_data->defines[dnx_data_debug_general_define_etpp_eop_and_sop_dec_above_threshold].doc = "";
    ...
    submodule_data->defines[dnx_data_debug_general_define_egress_port_mc_visibility].doc = "";
    ...
    submodule_data->defines[dnx_data_debug_general_define_pmf_debug_signals].doc = "";
    ...
    submodule_data->defines[dnx_data_debug_general_define_fer_debug_signals].doc = "";
    ...
    submodule_data->defines[dnx_data_debug_general_define_ees_data_device_debug_signals].doc = "";
    ...
    submodule_data->defines[dnx_data_debug_general_define_lbp_debug_signals_register_based].doc = "";
    
    submodule_data->defines[dnx_data_debug_general_define_lbp_debug_signals_register_based].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_debug_general_define_signal_version].name = "signal_version";
    submodule_data->defines[dnx_data_debug_general_define_signal_version].doc = "";
    
    submodule_data->defines[dnx_data_debug_general_define_signal_version].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_debug_general_define_mem_array_index].name = "mem_array_index";
    submodule_data->defines[dnx_data_debug_general_define_mem_array_index].doc = "";
...
uint32
dnx_data_debug_general_signal_version_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_debug, dnx_data_debug_submodule_general, dnx_data_debug_general_define_signal_version);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_debug_nif_define_extension_header].doc = "";
