...
static shr_error_e
jr2_a0_dnx_data_flow_general_is_lif_profile_dedicated_logic_enabled_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_flow;
    int submodule_index = dnx_data_flow_submodule_general;
    int feature_index = dnx_data_flow_general_is_lif_profile_dedicated_logic_enabled;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_flow_general_is_lif_profile_dedicated_logic_enabled;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_flow_general_is_lif_profile_dedicated_logic_enabled_set;
