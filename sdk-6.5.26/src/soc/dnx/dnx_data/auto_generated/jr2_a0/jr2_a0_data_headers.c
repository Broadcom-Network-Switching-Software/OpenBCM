...
static shr_error_e
jr2_a0_dnx_data_headers_internal_fwd_layer_index_offset_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_headers;
    int submodule_index = dnx_data_headers_submodule_internal;
    int define_index = dnx_data_headers_internal_define_fwd_layer_index_offset;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_headers_internal_fwd_layer_index_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_headers;
    int submodule_index = dnx_data_headers_submodule_internal;
    int define_index = dnx_data_headers_internal_define_fwd_layer_index_bits;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_headers_internal_legacy_vsi_outrif_offset_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_headers;
    int submodule_index = dnx_data_headers_submodule_internal_legacy;
    int define_index = dnx_data_headers_internal_legacy_define_vsi_outrif_offset;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_headers_internal_legacy_vsi_outrif_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_headers;
    int submodule_index = dnx_data_headers_submodule_internal_legacy;
    int define_index = dnx_data_headers_internal_legacy_define_vsi_outrif_bits;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_headers_fhei_sz1_stamp_ive_fhei_ivec_offset_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_headers;
    int submodule_index = dnx_data_headers_submodule_fhei_sz1_stamp_ive;
    int define_index = dnx_data_headers_fhei_sz1_stamp_ive_define_fhei_ivec_offset;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_headers_fhei_sz1_stamp_ive_fhei_ivec_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_headers;
    int submodule_index = dnx_data_headers_submodule_fhei_sz1_stamp_ive;
    int define_index = dnx_data_headers_fhei_sz1_stamp_ive_define_fhei_ivec_bits;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_headers_fhei_sz1_stamp_ive_fhei_ive_type_offset_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_headers;
    int submodule_index = dnx_data_headers_submodule_fhei_sz1_stamp_ive;
    int define_index = dnx_data_headers_fhei_sz1_stamp_ive_define_fhei_ive_type_offset;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_headers_fhei_sz1_stamp_ive_fhei_ive_type_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_headers;
    int submodule_index = dnx_data_headers_submodule_fhei_sz1_stamp_ive;
    int define_index = dnx_data_headers_fhei_sz1_stamp_ive_define_fhei_ive_type_bits;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_headers_udh_data_type0_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_headers;
    int submodule_index = dnx_data_headers_submodule_udh;
    int define_index = dnx_data_headers_udh_define_data_type0_size;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_headers_udh_data_type1_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_headers;
    int submodule_index = dnx_data_headers_submodule_udh;
    int define_index = dnx_data_headers_udh_define_data_type1_size;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_headers_udh_data_type2_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_headers;
    int submodule_index = dnx_data_headers_submodule_udh;
    int define_index = dnx_data_headers_udh_define_data_type2_size;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_headers_udh_data_type3_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_headers;
    int submodule_index = dnx_data_headers_submodule_udh;
    int define_index = dnx_data_headers_udh_define_data_type3_size;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_headers_udh_data_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_headers;
    int submodule_index = dnx_data_headers_submodule_udh;
    int define_index = dnx_data_headers_udh_define_data_size;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_headers_system_headers_max_udh0_block_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_headers;
    int submodule_index = dnx_data_headers_submodule_system_headers;
    int define_index = dnx_data_headers_system_headers_define_max_udh0_block_size;
    SHR_FUNC_INIT_VARS(unit);
    ...
    define->property.name = spn_IS_DNX2_IN_SYSTEM;
    define->property.doc = 
        "\n"
    ;
    define->property.method = dnxc_data_property_method_direct_map;
    ...
    define->property.mapping[0].name = "1";
    define->property.mapping[0].val = 4;
    define->property.mapping[0].is_default = 1 ;
    define->property.mapping[1].name = "0";
...
static shr_error_e
jr2_a0_dnx_data_headers_system_headers_max_udh1_block_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_headers;
    int submodule_index = dnx_data_headers_submodule_system_headers;
    int define_index = dnx_data_headers_system_headers_define_max_udh1_block_size;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_headers_system_headers_max_udh2_block_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_headers;
    int submodule_index = dnx_data_headers_submodule_system_headers;
    int define_index = dnx_data_headers_system_headers_define_max_udh2_block_size;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_headers_system_headers_max_udh3_block_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_headers;
    int submodule_index = dnx_data_headers_submodule_system_headers;
    int define_index = dnx_data_headers_system_headers_define_max_udh3_block_size;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_headers_system_headers_itpp_termination_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_headers;
    int submodule_index = dnx_data_headers_submodule_system_headers;
    int define_index = dnx_data_headers_system_headers_define_itpp_termination;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_headers_otmh_otmh_outlif_ext_mode_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_headers;
    int submodule_index = dnx_data_headers_submodule_otmh;
    int define_index = dnx_data_headers_otmh_define_otmh_outlif_ext_mode;
    SHR_FUNC_INIT_VARS(unit);
    ...
    define->property.name = spn_TM_PORT_OTMH_OUTLIF_EXT_MODE;
    define->property.doc = 
        "\n"
    ;
    define->property.method = dnxc_data_property_method_direct_map;
    ...
    define->property.mapping[0].name = "NEVER";
    define->property.mapping[0].val = 0;
    define->property.mapping[0].is_default = 1 ;
    define->property.mapping[1].name = "IF_MC";
    define->property.mapping[1].val = 1;
    define->property.mapping[2].name = "ALWAYS";
...
static shr_error_e
jr2_a0_dnx_data_headers_otmh_otmh_src_ext_enable_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_headers;
    int submodule_index = dnx_data_headers_submodule_otmh;
    int define_index = dnx_data_headers_otmh_define_otmh_src_ext_enable;
    SHR_FUNC_INIT_VARS(unit);
    ...
    define->property.name = spn_TM_PORT_OTMH_SRC_EXT_ENABLE;
    define->property.doc = 
        "\n"
    ;
    define->property.method = dnxc_data_property_method_enable;
...
static shr_error_e
jr2_a0_dnx_data_headers_layer_records_fragmented_non_first_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_headers;
    int submodule_index = dnx_data_headers_submodule_layer_records;
    int feature_index = dnx_data_headers_layer_records_fragmented_non_first_support;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_headers_internal_define_fwd_layer_index_offset;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_headers_internal_fwd_layer_index_offset_set;
    data_index = dnx_data_headers_internal_define_fwd_layer_index_bits;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_headers_internal_fwd_layer_index_bits_set;
    ...
    data_index = dnx_data_headers_internal_legacy_define_vsi_outrif_offset;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_headers_internal_legacy_vsi_outrif_offset_set;
    data_index = dnx_data_headers_internal_legacy_define_vsi_outrif_bits;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_headers_internal_legacy_vsi_outrif_bits_set;
    ...
    submodule_index = dnx_data_headers_submodule_fhei_sz1_stamp_ive;
    submodule = &module->submodules[submodule_index];

    
    data_index = dnx_data_headers_fhei_sz1_stamp_ive_define_fhei_ivec_offset;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_headers_fhei_sz1_stamp_ive_fhei_ivec_offset_set;
    data_index = dnx_data_headers_fhei_sz1_stamp_ive_define_fhei_ivec_bits;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_headers_fhei_sz1_stamp_ive_fhei_ivec_bits_set;
    data_index = dnx_data_headers_fhei_sz1_stamp_ive_define_fhei_ive_type_offset;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_headers_fhei_sz1_stamp_ive_fhei_ive_type_offset_set;
    data_index = dnx_data_headers_fhei_sz1_stamp_ive_define_fhei_ive_type_bits;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_headers_fhei_sz1_stamp_ive_fhei_ive_type_bits_set;
    ...
    data_index = dnx_data_headers_udh_define_data_type0_size;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_headers_udh_data_type0_size_set;
    data_index = dnx_data_headers_udh_define_data_type1_size;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_headers_udh_data_type1_size_set;
    data_index = dnx_data_headers_udh_define_data_type2_size;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_headers_udh_data_type2_size_set;
    data_index = dnx_data_headers_udh_define_data_type3_size;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_headers_udh_data_type3_size_set;
    data_index = dnx_data_headers_udh_define_data_size;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_headers_udh_data_size_set;
    ...
    data_index = dnx_data_headers_system_headers_define_max_udh0_block_size;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_headers_system_headers_max_udh0_block_size_set;
    data_index = dnx_data_headers_system_headers_define_max_udh1_block_size;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_headers_system_headers_max_udh1_block_size_set;
    data_index = dnx_data_headers_system_headers_define_max_udh2_block_size;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_headers_system_headers_max_udh2_block_size_set;
    data_index = dnx_data_headers_system_headers_define_max_udh3_block_size;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_headers_system_headers_max_udh3_block_size_set;
    data_index = dnx_data_headers_system_headers_define_itpp_termination;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_headers_system_headers_itpp_termination_set;
    ...
    data_index = dnx_data_headers_otmh_define_otmh_outlif_ext_mode;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_headers_otmh_otmh_outlif_ext_mode_set;
    data_index = dnx_data_headers_otmh_define_otmh_src_ext_enable;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_headers_otmh_otmh_src_ext_enable_set;
    ...
    submodule_index = dnx_data_headers_submodule_layer_records;
    submodule = &module->submodules[submodule_index];

    

    
    data_index = dnx_data_headers_layer_records_fragmented_non_first_support;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_headers_layer_records_fragmented_non_first_support_set;
