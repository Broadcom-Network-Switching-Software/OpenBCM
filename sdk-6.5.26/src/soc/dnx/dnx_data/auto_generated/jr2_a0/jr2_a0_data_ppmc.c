...
static shr_error_e
jr2_a0_dnx_data_ppmc_param_configurable_ppmc_range_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_ppmc;
    int submodule_index = dnx_data_ppmc_submodule_param;
    int feature_index = dnx_data_ppmc_param_configurable_ppmc_range;
...
static shr_error_e
jr2_a0_dnx_data_ppmc_param_ace_implementation_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ppmc;
    int submodule_index = dnx_data_ppmc_submodule_param;
    int define_index = dnx_data_ppmc_param_define_ace_implementation;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_ppmc_param_define_ace_implementation;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_ppmc_param_ace_implementation_set;

    
    data_index = dnx_data_ppmc_param_configurable_ppmc_range;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_ppmc_param_configurable_ppmc_range_set;
