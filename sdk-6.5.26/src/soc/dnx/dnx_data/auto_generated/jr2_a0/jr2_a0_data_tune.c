...
static shr_error_e
jr2_a0_dnx_data_tune_ecgm_port_queue_uc_flow_control_min_thresh_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_tune;
    int submodule_index = dnx_data_tune_submodule_ecgm;
    int define_index = dnx_data_tune_ecgm_define_port_queue_uc_flow_control_min_thresh;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_tune_fabric_cgm_drop_fabric_multicast_th_set(
    int unit)
{
    int priority_index;
...
static shr_error_e
jr2_a0_dnx_data_tune_fabric_cgm_rci_egress_level_factor_set(
    int unit)
{
    int level_index;
    ...
    int unit)
{
    ...
    data_index = dnx_data_tune_ecgm_define_port_queue_uc_flow_control_min_thresh;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_tune_ecgm_port_queue_uc_flow_control_min_thresh_set;
    ...
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_tune_fabric_cgm_drop_fabric_multicast_th_set;
    data_index = dnx_data_tune_fabric_table_cgm_rci_egress_level_factor;
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_tune_fabric_cgm_rci_egress_level_factor_set;
