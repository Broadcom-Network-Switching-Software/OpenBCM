...
static shr_error_e
jr2_a0_dnx_data_vlan_llvp_packet_pcp_dei_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_vlan;
    int submodule_index = dnx_data_vlan_submodule_llvp;
    int feature_index = dnx_data_vlan_llvp_packet_pcp_dei_support;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_vlan_llvp_outlif_llvp_from_outlif_profile_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_vlan;
    int submodule_index = dnx_data_vlan_submodule_llvp;
    int feature_index = dnx_data_vlan_llvp_outlif_llvp_from_outlif_profile;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_vlan_esem_ac_info_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_vlan;
    int submodule_index = dnx_data_vlan_submodule_esem;
    int feature_index = dnx_data_vlan_esem_ac_info;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_vlan_llvp_packet_pcp_dei_support;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_vlan_llvp_packet_pcp_dei_support_set;
    data_index = dnx_data_vlan_llvp_outlif_llvp_from_outlif_profile;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_vlan_llvp_outlif_llvp_from_outlif_profile_set;

    
    
    submodule_index = dnx_data_vlan_submodule_esem;
    submodule = &module->submodules[submodule_index];

    

    
    data_index = dnx_data_vlan_esem_ac_info;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_vlan_esem_ac_info_set;
