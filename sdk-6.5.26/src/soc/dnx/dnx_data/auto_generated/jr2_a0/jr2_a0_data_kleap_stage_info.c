    ...
    int unit)
{
    ...
    if (3 < table->keys[0].size)
    {
        ...
        data->kbr2physical[4] = DBAL_PHYSICAL_TABLE_KBP;
        data->kbr2physical[5] = DBAL_PHYSICAL_TABLE_KBP;
        ...
        data->kbr2physical[16] = DBAL_PHYSICAL_TABLE_KBP;
        data->kbr2physical[17] = DBAL_PHYSICAL_TABLE_KBP;
        data->kbr2key_sig[0] = INVALID_IF;
        data->kbr2key_sig[1] = INVALID_IF;
