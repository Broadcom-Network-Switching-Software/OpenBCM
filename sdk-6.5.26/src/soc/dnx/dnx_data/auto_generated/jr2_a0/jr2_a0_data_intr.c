...
static shr_error_e
jr2_a0_dnx_data_intr_general_new_access_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_intr;
    int submodule_index = dnx_data_intr_submodule_general;
    int feature_index = dnx_data_intr_general_new_access_support;
...
static shr_error_e
jr2_a0_dnx_data_intr_general_ser_event_generate_support_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_intr;
    int submodule_index = dnx_data_intr_submodule_general;
    int define_index = dnx_data_intr_general_define_ser_event_generate_support;
    SHR_FUNC_INIT_VARS(unit);
    ...
    define->property.suffix = "ser_event_generate";
...
static shr_error_e
jr2_a0_dnx_data_intr_general_ser_reset_cb_en_support_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_intr;
    int submodule_index = dnx_data_intr_submodule_general;
    int define_index = dnx_data_intr_general_define_ser_reset_cb_en_support;
    SHR_FUNC_INIT_VARS(unit);
    ...
    define->property.method = dnxc_data_property_method_suffix_enable;
    define->property.method_str = "suffix_enable";
    define->property.suffix = "ser_reset_cb_en";
    ...
    int unit)
{
    ...
    table->keys[0].size = 452;
    table->info_get.key_size[0] = 452;
    ...
    if (383 < table->keys[0].size)
    {
        ...
        data->intr = JR2_INT_DDP_ERROR_UNPACK_PACKET_SIZE_ERROR;
    }
...
static shr_error_e
jr2_a0_dnx_data_intr_general_skip_clear_on_init_set(
    int unit)
{
    int offset_index;
...
static shr_error_e
jr2_a0_dnx_data_intr_general_force_unmask_on_init_set(
    int unit)
{
    int offset_index;
...
static shr_error_e
jr2_a0_dnx_data_intr_general_skip_clear_on_regress_set(
    int unit)
{
    int offset_index;
...
static shr_error_e
jr2_a0_dnx_data_intr_general_framer_module_map_set(
    int unit)
{
    int offset_index;
    ...
    int unit)
{
    ...
    table->keys[0].size = 168;
    table->info_get.key_size[0] = 168;
    ...
    if (134 < table->keys[0].size)
    {
        ...
        data->reg = FMAC_PAR_ERR_MEM_MASKr;
        data->mode = dnxc_mem_mask_mode_one;
    }
    if (135 < table->keys[0].size)
    {
...
static shr_error_e
jr2_a0_dnx_data_intr_ser_dynamic_mem_set(
    int unit)
{
    int index_index;
    ...
    int unit)
{
    ...
    table->values[0].default_val = "10*DATA(device,general,core_clock_khz)/DATA(mdb,kaps,nof_rows_in_rpb_max)";
    ...
    default_data->scan_window = 10*dnx_data_device.general.core_clock_khz_get(unit)/dnx_data_mdb.kaps.nof_rows_in_rpb_max_get(unit);
...
static shr_error_e
jr2_a0_dnx_data_intr_ser_severity_mem_set(
    int unit)
{
    int index_index;
    ...
    int unit)
{
    ...
    data_index = dnx_data_intr_general_define_ser_event_generate_support;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_intr_general_ser_event_generate_support_set;
    data_index = dnx_data_intr_general_define_ser_reset_cb_en_support;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_intr_general_ser_reset_cb_en_support_set;

    
    data_index = dnx_data_intr_general_new_access_support;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_intr_general_new_access_support_set;
    ...
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_intr_general_skip_clear_on_init_set;
    data_index = dnx_data_intr_general_table_force_unmask_on_init;
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_intr_general_force_unmask_on_init_set;
    data_index = dnx_data_intr_general_table_skip_clear_on_regress;
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_intr_general_skip_clear_on_regress_set;
    data_index = dnx_data_intr_general_table_framer_module_map;
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_intr_general_framer_module_map_set;
    ...
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_intr_ser_dynamic_mem_set;
    ...
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_intr_ser_severity_mem_set;
