...
static shr_error_e
jr2_a0_dnx_data_mib_general_mib_counters_statdma_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_mib;
    ...
    feature->property.suffix = "statdma_enable";
...
static shr_error_e
jr2_a0_dnx_data_mib_general_mib_preempt_counters_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_mib;
...
static shr_error_e
jr2_a0_dnx_data_mib_general_nof_express_rows_per_cdmib_port_set(
    int unit)
{
...
static shr_error_e
jr2_a0_dnx_data_mib_general_nof_preempt_rows_per_cdmib_port_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_mib;
...
static shr_error_e
jr2_a0_dnx_data_mib_general_nof_rows_per_cdmib_port_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_mib;
...
static shr_error_e
jr2_a0_dnx_data_mib_general_nof_cdmib_port_per_pm_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_mib;
    int submodule_index = dnx_data_mib_submodule_general;
    int define_index = dnx_data_mib_general_define_nof_cdmib_port_per_pm;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_mib_general_nof_cdmib_port_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_mib;
    int submodule_index = dnx_data_mib_submodule_general;
    int define_index = dnx_data_mib_general_define_nof_cdmib_port;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    if (snmpEtherStatsPkts < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        ...
        SHR_RANGE_VERIFY(3, 0, DNX_MIB_MAX_COUNTER_BUNDLE, _SHR_E_INTERNAL, "out of bound access to array")
        data->counters_to_add_array[0] = dnx_mib_counter_nif_eth_rpkt;
        data->counters_to_add_array[1] = dnx_mib_counter_nif_eth_tpkt;
        data->counters_to_add_array[2] = dnx_mib_counter_nif_eth_rrpkt;
    }
    ...
    int unit)
{
    ...
    define->set = jr2_a0_dnx_data_mib_general_nof_express_rows_per_cdmib_port_set;
    data_index = dnx_data_mib_general_define_nof_preempt_rows_per_cdmib_port;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_mib_general_nof_preempt_rows_per_cdmib_port_set;
    data_index = dnx_data_mib_general_define_nof_rows_per_cdmib_port;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_mib_general_nof_rows_per_cdmib_port_set;
    data_index = dnx_data_mib_general_define_nof_cdmib_port_per_pm;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_mib_general_nof_cdmib_port_per_pm_set;
    data_index = dnx_data_mib_general_define_nof_cdmib_port;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_mib_general_nof_cdmib_port_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_mib_general_mib_counters_statdma_support_set;
    data_index = dnx_data_mib_general_mib_preempt_counters_support;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_mib_general_mib_preempt_counters_support_set;
