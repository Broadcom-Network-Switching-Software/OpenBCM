    ...
    int unit)
{
    ...
    define->default_data = dnx_data_nif.eth.max_ethu_nof_per_core_get(unit) + dnx_data_nif.ilkn.ilkn_unit_nof_get(unit) + dnx_data_nif.flexe.feu_nof_get(unit);

    
    define->data = dnx_data_nif.eth.max_ethu_nof_per_core_get(unit) + dnx_data_nif.ilkn.ilkn_unit_nof_get(unit) + dnx_data_nif.flexe.feu_nof_get(unit);
...
static shr_error_e
jr2_a0_dnx_data_nif_global_max_nof_lanes_per_port_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_global;
    int define_index = dnx_data_nif_global_define_max_nof_lanes_per_port;
    SHR_FUNC_INIT_VARS(unit);

    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    
    define->default_data = UTILEX_MAX(UTILEX_MAX(dnx_data_nif.eth.nof_cdu_lanes_in_pm_get(unit), dnx_data_nif.eth.nof_clu_lanes_in_pm_get(unit)), dnx_data_nif.ilkn.lanes_max_nof_get(unit));

    
    define->data = UTILEX_MAX(UTILEX_MAX(dnx_data_nif.eth.nof_cdu_lanes_in_pm_get(unit), dnx_data_nif.eth.nof_clu_lanes_in_pm_get(unit)), dnx_data_nif.ilkn.lanes_max_nof_get(unit));
...
static shr_error_e
jr2_a0_dnx_data_nif_global_otn_supported_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    ...
    int unit)
{
    ...
    if (23 < table->keys[0].size)
    {
        ...
        data->fec_type = bcmPortPhyFecNone;
        data->is_valid = dnx_data_fabric.links.nof_links_get(unit) && dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_10p3G_speed_supported);
    }
    if (24 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50_fabric;
        data->fec_type = bcmPortPhyFecRs544;
        data->is_valid = dnx_data_fabric.links.nof_links_get(unit) && dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_10p3G_speed_supported) && dnx_data_nif.ilkn.fec_units_per_core_nof_get(unit) > 0 ? TRUE : FALSE;
    }
    if (25 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50_fabric;
        data->fec_type = bcmPortPhyFecNone;
        data->is_valid = dnx_data_fabric.links.nof_links_get(unit) && dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_12p5G_speed_supported);
    }
    if (26 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50_fabric;
        data->fec_type = bcmPortPhyFecRs544;
        data->is_valid = dnx_data_fabric.links.nof_links_get(unit) && dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_12p5G_speed_supported) && dnx_data_nif.ilkn.fec_units_per_core_nof_get(unit) > 0 ? TRUE : FALSE;
    }
    if (27 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50_fabric;
        data->fec_type = bcmPortPhyFecNone;
        data->is_valid = dnx_data_fabric.links.nof_links_get(unit) && dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_20p6G_speed_supported) > 0 ? TRUE : FALSE;
    }
    if (28 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50_fabric;
        data->fec_type = bcmPortPhyFecRs544;
        data->is_valid = dnx_data_fabric.links.nof_links_get(unit) && dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_20p6G_speed_supported) && dnx_data_nif.ilkn.fec_units_per_core_nof_get(unit) > 0 ? TRUE : FALSE;
    }
    if (29 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50_fabric;
        data->fec_type = bcmPortPhyFecNone;
        data->is_valid = dnx_data_fabric.links.nof_links_get(unit) && dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_25G_speed_supported) > 0 ? TRUE : FALSE;
    }
    if (30 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50_fabric;
        data->fec_type = bcmPortPhyFecRs544;
        data->is_valid = dnx_data_fabric.links.nof_links_get(unit) && dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_25G_speed_supported) && dnx_data_nif.ilkn.fec_units_per_core_nof_get(unit) > 0 ? TRUE : FALSE;
    }
    if (31 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50_fabric;
        data->fec_type = bcmPortPhyFecNone;
        data->is_valid = dnx_data_fabric.links.nof_links_get(unit) && dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_25p7G_speed_supported);
    }
    if (32 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50_fabric;
        data->fec_type = bcmPortPhyFecRs544;
        data->is_valid = dnx_data_fabric.links.nof_links_get(unit) && dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_25p7G_speed_supported) && dnx_data_nif.ilkn.fec_units_per_core_nof_get(unit) > 0 ? TRUE : FALSE;
    }
    if (33 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50_fabric;
        data->fec_type = bcmPortPhyFecNone;
        data->is_valid = dnx_data_fabric.links.nof_links_get(unit) && dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_27p3G_speed_supported) > 0 ? TRUE : FALSE;
    }
    if (34 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50_fabric;
        data->fec_type = bcmPortPhyFecRs544;
        data->is_valid = dnx_data_fabric.links.nof_links_get(unit) && dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_27p3G_speed_supported) && dnx_data_nif.ilkn.fec_units_per_core_nof_get(unit) > 0 ? TRUE : FALSE;
    }
    if (35 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50_fabric;
        data->fec_type = bcmPortPhyFecNone;
        data->is_valid = dnx_data_fabric.links.nof_links_get(unit) && dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_28p1G_speed_supported) > 0 ? TRUE : FALSE;
    }
    if (36 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50_fabric;
        data->fec_type = bcmPortPhyFecRs544;
        data->is_valid = dnx_data_fabric.links.nof_links_get(unit) && dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_28p1G_speed_supported) && dnx_data_nif.ilkn.fec_units_per_core_nof_get(unit) > 0 ? TRUE : FALSE;
    }
    if (37 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50_fabric;
        data->fec_type = bcmPortPhyFecRs544;
        data->is_valid = dnx_data_fabric.links.nof_links_get(unit) && dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_53p1G_speed_supported) > 0 ? TRUE : FALSE;
    }
    if (38 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50_fabric;
        data->fec_type = bcmPortPhyFecRs544;
        data->is_valid = dnx_data_fabric.links.nof_links_get(unit) && dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_fabric_56G_speed_supported) > 0 ? TRUE : FALSE;
    }
    ...
    int unit)
{
    ...
    table->values[0].default_val = "DATA(nif, ilkn, burst_short)";
    ...
    table->values[0].property.name = spn_ILKN_BURST_SHORT;
    table->values[0].property.doc =
        "\n"
    ;
    ...
    table->values[0].property.range_min = dnx_data_nif.ilkn.burst_short_get(unit);
    table->values[0].property.range_max = 128;
    
    table->values[1].property.name = spn_ILKN_BURST_MAX;
    table->values[1].property.doc =
        "\n"
    ;
    ...
    table->values[1].property.range_min = 256;
    table->values[1].property.range_max = dnx_data_nif.ilkn.burst_max_range_max_get(unit);
    ...
    {
        data = (dnx_data_nif_ilkn_properties_t *) dnxc_data_mgmt_table_data_get(unit, table, ilkn_id_index, 0);
        SHR_IF_ERR_EXIT(dnxc_data_mgmt_property_read(unit, &table->values[0].property, ilkn_id_index, &data->burst_short));
    }
    for (ilkn_id_index = 0; ilkn_id_index < table->keys[0].size; ilkn_id_index++)
    {
        data = (dnx_data_nif_ilkn_properties_t *) dnxc_data_mgmt_table_data_get(unit, table, ilkn_id_index, 0);
        SHR_IF_ERR_EXIT(dnxc_data_mgmt_property_read(unit, &table->values[1].property, ilkn_id_index, &data->burst_max));
    }
    for (ilkn_id_index = 0; ilkn_id_index < table->keys[0].size; ilkn_id_index++)
    {
        data = (dnx_data_nif_ilkn_properties_t *) dnxc_data_mgmt_table_data_get(unit, table, ilkn_id_index, 0);
...
static shr_error_e
jr2_a0_dnx_data_nif_eth_is_rmc_allocation_needed_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
...
static shr_error_e
jr2_a0_dnx_data_nif_eth_mgu_nof_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_eth;
    int define_index = dnx_data_nif_eth_define_mgu_nof;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_nif_eth_nof_pms_in_nbu_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_eth;
    int define_index = dnx_data_nif_eth_define_nof_pms_in_nbu;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_nif_eth_nof_pms_in_mgu_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_eth;
    int define_index = dnx_data_nif_eth_define_nof_pms_in_mgu;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_nif_eth_nof_nbu_lanes_in_pm_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_eth;
    int define_index = dnx_data_nif_eth_define_nof_nbu_lanes_in_pm;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_nif_eth_nof_mgu_lanes_in_pm_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_eth;
    int define_index = dnx_data_nif_eth_define_nof_mgu_lanes_in_pm;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_nif_eth_nof_nbu_pms_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_eth;
    int define_index = dnx_data_nif_eth_define_nof_nbu_pms;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_nif_eth_nof_mgu_pms_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_eth;
    int define_index = dnx_data_nif_eth_define_nof_mgu_pms;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_nif_eth_max_ethu_nof_per_core_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_eth;
    int define_index = dnx_data_nif_eth_define_max_ethu_nof_per_core;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_nif_eth_total_nof_nbu_lanes_in_device_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_eth;
    int define_index = dnx_data_nif_eth_define_total_nof_nbu_lanes_in_device;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_nif_eth_nbu_mac_mode_config_nof_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_eth;
    int define_index = dnx_data_nif_eth_define_nbu_mac_mode_config_nof;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_nif_eth_nbu_mac_nof_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_eth;
    int define_index = dnx_data_nif_eth_define_nbu_mac_nof;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_nif_eth_nbu_memory_entries_nof_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_eth;
    int define_index = dnx_data_nif_eth_define_nbu_memory_entries_nof;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_nif_eth_mgu_memory_entries_nof_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_eth;
    int define_index = dnx_data_nif_eth_define_mgu_memory_entries_nof;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    default_data->link_recovery_support = 1;
...
static shr_error_e
jr2_a0_dnx_data_nif_eth_ethu_per_core_set(
    int unit)
{
    int ethu_index_index;
    ...
    if (8 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_ethu_per_core_t *) dnxc_data_mgmt_table_data_get(unit, table, 8, 0);
        data->core_id = 1;
    }
    if (9 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_ethu_per_core_t *) dnxc_data_mgmt_table_data_get(unit, table, 9, 0);
        data->core_id = 1;
    }
    if (10 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_ethu_per_core_t *) dnxc_data_mgmt_table_data_get(unit, table, 10, 0);
        data->core_id = 1;
    }
    if (11 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_ethu_per_core_t *) dnxc_data_mgmt_table_data_get(unit, table, 11, 0);
        data->core_id = 1;
    }
...
static shr_error_e
jr2_a0_dnx_data_nif_eth_nif_cores_ethus_set(
    int unit)
{
    int core_id_index;
    ...
    if (1 < table->keys[0].size)
    {
        data = (dnx_data_nif_eth_nif_cores_ethus_t *) dnxc_data_mgmt_table_data_get(unit, table, 1, 0);
        data->nof_ethus = 6;
        data->first_ethu = 6;
    }
    ...
    int unit)
{
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_nif_eth_supported_clu_an_abilities_t, (1 * (table->keys[0].size) + 1  ), "data of dnx_data_nif_eth_table_supported_clu_an_abilities");
...
static shr_error_e
jr2_a0_dnx_data_nif_framer_is_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
...
static shr_error_e
jr2_a0_dnx_data_nif_framer_is_clock_independent_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
...
static shr_error_e
jr2_a0_dnx_data_nif_framer_nof_units_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
...
static shr_error_e
jr2_a0_dnx_data_nif_framer_b66switch_set(
    int unit)
{
    int port_type_index;
...
static shr_error_e
jr2_a0_dnx_data_nif_mac_client_nof_clients_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
...
static shr_error_e
jr2_a0_dnx_data_nif_sar_client_nof_clients_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
...
static shr_error_e
jr2_a0_dnx_data_nif_flexe_nof_flexe_instances_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
...
static shr_error_e
jr2_a0_dnx_data_nif_prd_nof_framer_port_profiles_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
...
static shr_error_e
jr2_a0_dnx_data_nif_prd_nof_prd_counters_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    ...
    int unit)
{
    ...
    if (imbDispatchTypeImb_framer < table->keys[0].size)
    {
        data = (dnx_data_nif_prd_port_profile_map_t *) dnxc_data_mgmt_table_data_get(unit, table, imbDispatchTypeImb_framer, 0);
        data->is_supported = TRUE;
        data->nof_profiles = dnx_data_nif.prd.nof_framer_port_profiles_get(unit);
    }
...
static shr_error_e
jr2_a0_dnx_data_nif_dbal_nbu_tx_start_threshold_entry_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_dbal;
    int define_index = dnx_data_nif_dbal_define_nbu_tx_start_threshold_entry_size;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_nif_dbal_mgu_tx_start_threshold_entry_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_dbal;
    int define_index = dnx_data_nif_dbal_define_mgu_tx_start_threshold_entry_size;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_nif_dbal_nof_rx_fifo_counters_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
...
static shr_error_e
jr2_a0_dnx_data_nif_dbal_nof_tx_fifo_counters_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
...
static shr_error_e
jr2_a0_dnx_data_nif_signal_quality_is_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_signal_quality;
    int feature_index = dnx_data_nif_signal_quality_is_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_nif_signal_quality_is_sw_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_signal_quality;
    int feature_index = dnx_data_nif_signal_quality_is_sw_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_nif_signal_quality_is_ser_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_signal_quality;
    int feature_index = dnx_data_nif_signal_quality_is_ser_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_nif_signal_quality_is_ber_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
...
static shr_error_e
jr2_a0_dnx_data_nif_signal_quality_is_debug_enabled_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_signal_quality;
    int define_index = dnx_data_nif_signal_quality_define_is_debug_enabled;
    SHR_FUNC_INIT_VARS(unit);
    ...
    define->property.suffix = "signal_quality_debug_enable";
...
static shr_error_e
jr2_a0_dnx_data_nif_signal_quality_max_degrade_threshold_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_signal_quality;
    int define_index = dnx_data_nif_signal_quality_define_max_degrade_threshold;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_nif_signal_quality_min_degrade_threshold_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_signal_quality;
    int define_index = dnx_data_nif_signal_quality_define_min_degrade_threshold;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_nif_signal_quality_max_fail_threshold_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_signal_quality;
    int define_index = dnx_data_nif_signal_quality_define_max_fail_threshold;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_nif_signal_quality_min_fail_threshold_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_signal_quality;
    int define_index = dnx_data_nif_signal_quality_define_min_fail_threshold;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_nif_signal_quality_max_interval_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_signal_quality;
    int define_index = dnx_data_nif_signal_quality_define_max_interval;
    SHR_FUNC_INIT_VARS(unit);

    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    
    define->default_data = 600000000;

    
    define->data = 600000000;
...
static shr_error_e
jr2_a0_dnx_data_nif_signal_quality_min_interval_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_signal_quality;
    int define_index = dnx_data_nif_signal_quality_define_min_interval;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_nif_signal_quality_supported_fecs_set(
    int unit)
{
    int fec_type_index;
    dnx_data_nif_signal_quality_supported_fecs_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_signal_quality;
    int table_index = dnx_data_nif_signal_quality_table_supported_fecs;
    SHR_FUNC_INIT_VARS(unit);
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_nif_signal_quality_supported_fecs_t, (1 * (table->keys[0].size) + 1  ), "data of dnx_data_nif_signal_quality_table_supported_fecs");

    
    default_data = (dnx_data_nif_signal_quality_supported_fecs_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    default_data->is_valid = 0;
    
    for (fec_type_index = 0; fec_type_index < table->keys[0].size; fec_type_index++)
    {
        data = (dnx_data_nif_signal_quality_supported_fecs_t *) dnxc_data_mgmt_table_data_get(unit, table, fec_type_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
    
    if (bcmPortPhyFecRs544 < table->keys[0].size)
    {
        data = (dnx_data_nif_signal_quality_supported_fecs_t *) dnxc_data_mgmt_table_data_get(unit, table, bcmPortPhyFecRs544, 0);
        data->is_valid = 1;
    }
    if (bcmPortPhyFecRs544_2xN < table->keys[0].size)
    {
        data = (dnx_data_nif_signal_quality_supported_fecs_t *) dnxc_data_mgmt_table_data_get(unit, table, bcmPortPhyFecRs544_2xN, 0);
        data->is_valid = 1;
    }
    if (bcmPortPhyFecRsFec < table->keys[0].size)
    {
        data = (dnx_data_nif_signal_quality_supported_fecs_t *) dnxc_data_mgmt_table_data_get(unit, table, bcmPortPhyFecRsFec, 0);
        data->is_valid = 1;
    }
    if (bcmPortPhyFecRs272 < table->keys[0].size)
    {
        data = (dnx_data_nif_signal_quality_supported_fecs_t *) dnxc_data_mgmt_table_data_get(unit, table, bcmPortPhyFecRs272, 0);
        data->is_valid = 1;
    }
    if (bcmPortPhyFecRs272_2xN < table->keys[0].size)
    {
        data = (dnx_data_nif_signal_quality_supported_fecs_t *) dnxc_data_mgmt_table_data_get(unit, table, bcmPortPhyFecRs272_2xN, 0);
        data->is_valid = 1;
    }
...
static shr_error_e
jr2_a0_dnx_data_nif_signal_quality_hw_based_solution_set(
    int unit)
{
    int pm_type_index;
...
static shr_error_e
jr2_a0_dnx_data_nif_flr_is_advanced_flr_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
    ...
    int unit)
{
    ...
    data_index = dnx_data_nif_global_define_max_nof_lanes_per_port;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_global_max_nof_lanes_per_port_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_global_otn_supported_set;
    ...
    data_index = dnx_data_nif_eth_define_mgu_nof;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_eth_mgu_nof_set;
    ...
    data_index = dnx_data_nif_eth_define_nof_pms_in_nbu;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_eth_nof_pms_in_nbu_set;
    data_index = dnx_data_nif_eth_define_nof_pms_in_mgu;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_eth_nof_pms_in_mgu_set;
    ...
    data_index = dnx_data_nif_eth_define_nof_nbu_lanes_in_pm;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_eth_nof_nbu_lanes_in_pm_set;
    data_index = dnx_data_nif_eth_define_nof_mgu_lanes_in_pm;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_eth_nof_mgu_lanes_in_pm_set;
    data_index = dnx_data_nif_eth_define_nof_nbu_pms;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_eth_nof_nbu_pms_set;
    data_index = dnx_data_nif_eth_define_nof_mgu_pms;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_eth_nof_mgu_pms_set;
    ...
    data_index = dnx_data_nif_eth_define_max_ethu_nof_per_core;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_eth_max_ethu_nof_per_core_set;
    ...
    data_index = dnx_data_nif_eth_define_total_nof_nbu_lanes_in_device;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_eth_total_nof_nbu_lanes_in_device_set;
    data_index = dnx_data_nif_eth_define_cdu_mac_mode_config_nof;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_eth_cdu_mac_mode_config_nof_set;
    data_index = dnx_data_nif_eth_define_nbu_mac_mode_config_nof;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_eth_nbu_mac_mode_config_nof_set;
    ...
    data_index = dnx_data_nif_eth_define_nbu_mac_nof;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_eth_nbu_mac_nof_set;
    ...
    data_index = dnx_data_nif_eth_define_nbu_memory_entries_nof;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_eth_nbu_memory_entries_nof_set;
    data_index = dnx_data_nif_eth_define_mgu_memory_entries_nof;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_eth_mgu_memory_entries_nof_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_nif_eth_is_rmc_allocation_needed_set;
    ...
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_nif_eth_ethu_per_core_set;
    data_index = dnx_data_nif_eth_table_nif_cores_ethus;
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_nif_eth_nif_cores_ethus_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_framer_nof_units_set;

    
    data_index = dnx_data_nif_framer_is_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_nif_framer_is_supported_set;
    data_index = dnx_data_nif_framer_is_clock_independent;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_nif_framer_is_clock_independent_set;

    
    data_index = dnx_data_nif_framer_table_b66switch;
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_nif_framer_b66switch_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_mac_client_nof_clients_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_sar_client_nof_clients_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_flexe_nof_flexe_instances_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_prd_nof_framer_port_profiles_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_prd_nof_prd_counters_set;
    ...
    data_index = dnx_data_nif_dbal_define_nbu_tx_start_threshold_entry_size;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_dbal_nbu_tx_start_threshold_entry_size_set;
    data_index = dnx_data_nif_dbal_define_mgu_tx_start_threshold_entry_size;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_dbal_mgu_tx_start_threshold_entry_size_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_dbal_nof_rx_fifo_counters_set;
    data_index = dnx_data_nif_dbal_define_nof_tx_fifo_counters;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_dbal_nof_tx_fifo_counters_set;
    ...
    data_index = dnx_data_nif_signal_quality_define_is_debug_enabled;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_signal_quality_is_debug_enabled_set;
    data_index = dnx_data_nif_signal_quality_define_max_degrade_threshold;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_signal_quality_max_degrade_threshold_set;
    data_index = dnx_data_nif_signal_quality_define_min_degrade_threshold;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_signal_quality_min_degrade_threshold_set;
    data_index = dnx_data_nif_signal_quality_define_max_fail_threshold;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_signal_quality_max_fail_threshold_set;
    data_index = dnx_data_nif_signal_quality_define_min_fail_threshold;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_signal_quality_min_fail_threshold_set;
    data_index = dnx_data_nif_signal_quality_define_max_interval;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_signal_quality_max_interval_set;
    data_index = dnx_data_nif_signal_quality_define_min_interval;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_nif_signal_quality_min_interval_set;

    
    data_index = dnx_data_nif_signal_quality_is_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_nif_signal_quality_is_supported_set;
    data_index = dnx_data_nif_signal_quality_is_sw_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_nif_signal_quality_is_sw_supported_set;
    data_index = dnx_data_nif_signal_quality_is_ser_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_nif_signal_quality_is_ser_supported_set;
    data_index = dnx_data_nif_signal_quality_is_ber_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_nif_signal_quality_is_ber_supported_set;

    
    data_index = dnx_data_nif_signal_quality_table_supported_fecs;
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_nif_signal_quality_supported_fecs_set;
    data_index = dnx_data_nif_signal_quality_table_hw_based_solution;
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_nif_signal_quality_hw_based_solution_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_nif_flr_is_advanced_flr_supported_set;
