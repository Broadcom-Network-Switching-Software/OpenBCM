...
static shr_error_e
jr2_a0_dnx_data_ipq_queues_invalid_queue_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_ipq;
    int submodule_index = dnx_data_ipq_submodule_queues;
    int feature_index = dnx_data_ipq_queues_invalid_queue_support;
...
static shr_error_e
jr2_a0_dnx_data_ipq_general_is_used_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_ipq;
    ...
    int unit)
{
    ...
    data_index = dnx_data_ipq_queues_invalid_queue_support;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_ipq_queues_invalid_queue_support_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_ipq_general_is_used_set;
