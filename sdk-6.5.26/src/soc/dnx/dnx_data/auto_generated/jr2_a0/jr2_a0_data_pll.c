...
static shr_error_e
jr2_a0_dnx_data_pll_general_ts_ptp_fref_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_pll;
    int submodule_index = dnx_data_pll_submodule_general;
    int define_index = dnx_data_pll_general_define_ts_ptp_fref;
    SHR_FUNC_INIT_VARS(unit);
    ...
    define->property.name = spn_PTP_TS_PLL_FREF;
    define->property.doc = 
        "\n"
    ;
    ...
    int unit)
{
    ...
    table->values[1].default_val = "DNXC_SERDES_REF_CLOCK_156_25";
    ...
    default_data->in_freq = DNXC_SERDES_REF_CLOCK_312_5;
    default_data->out_freq = DNXC_SERDES_REF_CLOCK_156_25;
    ...
    table->values[0].property.mapping[0].val = DNXC_SERDES_REF_CLOCK_DISABLE;
    table->values[0].property.mapping[1].name = "1";
    table->values[0].property.mapping[1].val = DNXC_SERDES_REF_CLOCK_156_25;
    table->values[0].property.mapping[2].name = "2";
    table->values[0].property.mapping[2].val = DNXC_SERDES_REF_CLOCK_312_5;
    ...
    table->values[1].property.mapping[0].val = DNXC_SERDES_REF_CLOCK_BYPASS;
    table->values[1].property.mapping[1].name = "-1";
    table->values[1].property.mapping[1].val = DNXC_SERDES_REF_CLOCK_DISABLE;
    table->values[1].property.mapping[2].name = "1";
    table->values[1].property.mapping[2].val = DNXC_SERDES_REF_CLOCK_156_25;
    table->values[1].property.mapping[2].is_default = 1 ;
    table->values[1].property.mapping[3].name = "2";
    table->values[1].property.mapping[3].val = DNXC_SERDES_REF_CLOCK_312_5;
    ...
    int unit)
{
    ...
    table->values[0].default_val = "DNXC_SERDES_REF_CLOCK_312_5";
    table->values[1].default_val = "DNXC_SERDES_REF_CLOCK_312_5";
    ...
    default_data->in_freq = DNXC_SERDES_REF_CLOCK_312_5;
    default_data->out_freq = DNXC_SERDES_REF_CLOCK_312_5;
    ...
    int unit)
{
    ...
    data_index = dnx_data_pll_general_define_ts_ptp_fref;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_pll_general_ts_ptp_fref_set;
