...
static shr_error_e
jr2_a0_dnx_data_port_pp_general_rcy_info_prt_qualifier_eth_over_append64_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_port_pp;
    int submodule_index = dnx_data_port_pp_submodule_general;
    int define_index = dnx_data_port_pp_general_define_rcy_info_prt_qualifier_eth_over_append64;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_port_pp_general_define_rcy_info_prt_qualifier_eth_over_append64;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_port_pp_general_rcy_info_prt_qualifier_eth_over_append64_set;
