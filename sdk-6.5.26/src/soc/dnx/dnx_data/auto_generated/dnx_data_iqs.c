...
extern shr_error_e j2x_a0_data_iqs_attach(
    int unit);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_iqs_credit_fmq_shp_zero_rate_allowed].doc = "";
    submodule_data->features[dnx_data_iqs_credit_fmq_shp_zero_rate_allowed].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_iqs_credit_watchdog_delete_special_mode].name = "watchdog_delete_special_mode";
    submodule_data->features[dnx_data_iqs_credit_watchdog_delete_special_mode].doc = "";
    submodule_data->features[dnx_data_iqs_credit_watchdog_delete_special_mode].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_iqs_credit_credit_balance_support].name = "credit_balance_support";
    submodule_data->features[dnx_data_iqs_credit_credit_balance_support].doc = "";
    submodule_data->features[dnx_data_iqs_credit_credit_balance_support].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_iqs_credit_profile_is_rate_class].name = "profile_is_rate_class";
    submodule_data->features[dnx_data_iqs_credit_profile_is_rate_class].doc = "";
    submodule_data->features[dnx_data_iqs_credit_profile_is_rate_class].flags |= DNXC_DATA_F_FEATURE;
    ...
    submodule_data->defines[dnx_data_iqs_credit_define_max_credit_balance_threshold].doc = "";
    ...
    submodule_data->defines[dnx_data_iqs_credit_define_max_worth].doc = "";
    ...
    submodule_data->defines[dnx_data_iqs_credit_define_satisified_back_min].doc = "";
    ...
    submodule_data->defines[dnx_data_iqs_credit_define_satisified_back_max].doc = "";
    ...
    submodule_data->defines[dnx_data_iqs_credit_define_satisified_empty_min].doc = "";
    ...
    submodule_data->defines[dnx_data_iqs_credit_define_satisified_empty_max].doc = "";
    ...
    submodule_data->defines[dnx_data_iqs_credit_define_hungry_min].doc = "";
    ...
    submodule_data->defines[dnx_data_iqs_credit_define_hungry_max].doc = "";
    ...
    submodule_data->defines[dnx_data_iqs_credit_define_hungry_mult_min].doc = "";
    ...
    submodule_data->defines[dnx_data_iqs_credit_define_hungry_mult_max].doc = "";
    ...
    submodule_data->defines[dnx_data_iqs_credit_define_nof_bw_levels].doc = "";
    ...
    submodule_data->defines[dnx_data_iqs_credit_define_fmq_credit_fc_on_th].doc = "";
    ...
    submodule_data->defines[dnx_data_iqs_credit_define_fmq_credit_fc_off_th].doc = "";
    ...
    submodule_data->defines[dnx_data_iqs_credit_define_fmq_byte_fc_on_th].doc = "";
    ...
    submodule_data->defines[dnx_data_iqs_credit_define_fmq_byte_fc_off_th].doc = "";
    ...
    submodule_data->defines[dnx_data_iqs_credit_define_fmq_eir_credit_fc_th].doc = "";
    ...
    submodule_data->defines[dnx_data_iqs_credit_define_fmq_eir_byte_fc_th].doc = "";
    ...
    submodule_data->defines[dnx_data_iqs_credit_define_fmq_nof_be_classes].doc = "";
    ...
    submodule_data->defines[dnx_data_iqs_credit_define_fmq_max_be_weight].doc = "";
    ...
    submodule_data->defines[dnx_data_iqs_credit_define_fmq_max_burst_max].doc = "";
    ...
    submodule_data->defines[dnx_data_iqs_credit_define_fmq_shp_crdt_rate_mltp].doc = "";
    ...
    submodule_data->defines[dnx_data_iqs_credit_define_fmq_shp_crdt_rate_delta].doc = "";
    ...
    submodule_data->defines[dnx_data_iqs_credit_define_max_rate_profile_preset_gbps].doc = "";
    ...
    submodule_data->defines[dnx_data_iqs_credit_define_nof_profiles].doc = "";
    
    submodule_data->defines[dnx_data_iqs_credit_define_nof_profiles].flags |= DNXC_DATA_F_NUMERIC;

    submodule_data->defines[dnx_data_iqs_credit_define_profile_nof_bits].name = "profile_nof_bits";
    submodule_data->defines[dnx_data_iqs_credit_define_profile_nof_bits].doc = "";
    
    submodule_data->defines[dnx_data_iqs_credit_define_profile_nof_bits].flags |= DNXC_DATA_F_NUMERIC;

    submodule_data->defines[dnx_data_iqs_credit_define_worth].name = "worth";
    submodule_data->defines[dnx_data_iqs_credit_define_worth].doc = "";
    ...
    submodule_data->defines[dnx_data_iqs_credit_define_fmq_shp_rate_max].doc = "";
...
uint32
dnx_data_iqs_credit_profile_nof_bits_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_iqs, dnx_data_iqs_submodule_credit, dnx_data_iqs_credit_define_profile_nof_bits);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_iqs_deq_default_dequeue_params_configuration].name = "dequeue_params_configuration";
    submodule_data->features[dnx_data_iqs_deq_default_dequeue_params_configuration].doc = "";
    submodule_data->features[dnx_data_iqs_deq_default_dequeue_params_configuration].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_iqs_deq_default_dqcq_fc_to_dram].name = "dqcq_fc_to_dram";
    submodule_data->features[dnx_data_iqs_deq_default_dqcq_fc_to_dram].doc = "";
    ...
    submodule_data->defines[dnx_data_iqs_deq_default_define_low_delay_deq_bytes].doc = "";
    ...
    submodule_data->defines[dnx_data_iqs_deq_default_define_credit_balance_max].doc = "";
    ...
    submodule_data->defines[dnx_data_iqs_deq_default_define_credit_balance_resolution].doc = "";
    ...
    submodule_data->defines[dnx_data_iqs_deq_default_define_s2d_credit_balance_max].doc = "";
    ...
    submodule_data->defines[dnx_data_iqs_deq_default_define_s2d_credit_balance_resolution].doc = "";
    ...
    submodule_data->defines[dnx_data_iqs_deq_default_define_sram_to_fabric_credit_lfsr_thr].doc = "";
    ...
    submodule_data->defines[dnx_data_iqs_deq_default_define_sram_to_fabric_credit_lfsr_mask].doc = "";
    ...
    submodule_data->tables[dnx_data_iqs_deq_default_table_sqm_read_weight_profiles].doc = "";
    ...
    submodule_data->tables[dnx_data_iqs_deq_default_table_sqm_read_weight_profiles].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_iqs_deq_default_table_dqm_read_weight_profiles].doc = "";
    ...
    submodule_data->tables[dnx_data_iqs_deq_default_table_dqm_read_weight_profiles].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_iqs_deq_default_table_params].doc = "";
    ...
    submodule_data->tables[dnx_data_iqs_deq_default_table_params].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_iqs_deq_default_table_dram_params].doc = "";
    ...
    submodule_data->tables[dnx_data_iqs_deq_default_table_dram_params].keys[0].doc = "";
    ...
    submodule_data->tables[dnx_data_iqs_deq_default_table_max_deq_cmd].doc = "";
    ...
    submodule_data->tables[dnx_data_iqs_deq_default_table_max_deq_cmd].keys[0].doc = "";
    submodule_data->tables[dnx_data_iqs_deq_default_table_max_deq_cmd].keys[1].name = "nof_active_queues";
    submodule_data->tables[dnx_data_iqs_deq_default_table_max_deq_cmd].keys[1].doc = "";
    ...
    submodule_data->tables[dnx_data_iqs_deq_default_table_s2d_max_deq_cmd].doc = "";
    ...
    submodule_data->tables[dnx_data_iqs_deq_default_table_s2d_max_deq_cmd].keys[0].doc = "";
    submodule_data->tables[dnx_data_iqs_deq_default_table_s2d_max_deq_cmd].keys[1].name = "nof_active_queues";
    submodule_data->tables[dnx_data_iqs_deq_default_table_s2d_max_deq_cmd].keys[1].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_iqs_dqcq_8_priorities].doc = "";
    ...
    submodule_data->defines[dnx_data_iqs_dqcq_define_max_nof_contexts].doc = "";
    ...
    submodule_data->defines[dnx_data_iqs_dqcq_define_nof_priorities].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_iqs_dbal_fsm_sn_mask_supported].name = "fsm_sn_mask_supported";
    submodule_data->features[dnx_data_iqs_dbal_fsm_sn_mask_supported].doc = "";
    submodule_data->features[dnx_data_iqs_dbal_fsm_sn_mask_supported].flags |= DNXC_DATA_F_FEATURE;
    ...
    submodule_data->defines[dnx_data_iqs_dbal_define_ipt_counters_nof_bits].doc = "";
    
    submodule_data->defines[dnx_data_iqs_dbal_define_ipt_counters_nof_bits].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_iqs_dbal_define_credit_worth_nof_bits].name = "credit_worth_nof_bits";
    submodule_data->defines[dnx_data_iqs_dbal_define_credit_worth_nof_bits].doc = "";
    
    submodule_data->defines[dnx_data_iqs_dbal_define_credit_worth_nof_bits].flags |= DNXC_DATA_F_NUMERIC;

    submodule_data->defines[dnx_data_iqs_dbal_define_fsm_sn_mask].name = "fsm_sn_mask";
    submodule_data->defines[dnx_data_iqs_dbal_define_fsm_sn_mask].doc = "";
    
    submodule_data->defines[dnx_data_iqs_dbal_define_fsm_sn_mask].flags |= DNXC_DATA_F_NUMERIC;
...
uint32
dnx_data_iqs_dbal_credit_worth_nof_bits_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_iqs, dnx_data_iqs_submodule_dbal, dnx_data_iqs_dbal_define_credit_worth_nof_bits);
}

uint32
dnx_data_iqs_dbal_fsm_sn_mask_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_iqs, dnx_data_iqs_submodule_dbal, dnx_data_iqs_dbal_define_fsm_sn_mask);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->nof_features = _dnx_data_iqs_general_feature_nof;
    DNXC_DATA_ALLOC(submodule_data->features, dnxc_data_feature_t,  submodule_data->nof_features, "_dnxc_data iqs general features");

    submodule_data->features[dnx_data_iqs_general_is_used].name = "is_used";
    submodule_data->features[dnx_data_iqs_general_is_used].doc = "";
    submodule_data->features[dnx_data_iqs_general_is_used].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_iqs_general_power_down_supported].name = "power_down_supported";
    submodule_data->features[dnx_data_iqs_general_power_down_supported].doc = "";
    submodule_data->features[dnx_data_iqs_general_power_down_supported].flags |= DNXC_DATA_F_FEATURE;

    
    submodule_data->nof_defines = _dnx_data_iqs_general_define_nof;
    DNXC_DATA_ALLOC(submodule_data->defines, dnxc_data_define_t, submodule_data->nof_defines, "_dnxc_data iqs general defines");

    
    submodule_data->nof_tables = _dnx_data_iqs_general_table_nof;
    DNXC_DATA_ALLOC(submodule_data->tables, dnxc_data_table_t, submodule_data->nof_tables, "_dnxc_data iqs general tables");
...
int
dnx_data_iqs_general_feature_get(
    int unit,
    dnx_data_iqs_general_feature_e feature)
{
    return dnxc_data_mgmt_feature_data_get(unit, dnx_data_module_iqs, dnx_data_iqs_submodule_general, feature);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_iqs_flush_define_bytes_units_to_send].doc = "";
    ...
    dnxc_data_module_t *module_data)
{
    ...
    SHR_IF_ERR_EXIT(dnx_data_iqs_general_init(unit, &module_data->submodules[dnx_data_iqs_submodule_general]));
    ...
    {
        SHR_IF_ERR_EXIT(jr2_a0_data_iqs_attach(unit));
        SHR_IF_ERR_EXIT(j2x_a0_data_iqs_attach(unit));
    }
    else
