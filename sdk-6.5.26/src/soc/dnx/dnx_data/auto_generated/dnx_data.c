    ...
    int unit)
{
    ...
    dnx_data_headers.system_headers.itpp_termination_get = dnx_data_headers_system_headers_itpp_termination_get;
    ...
    dnx_data_vlan.esem.feature_get = dnx_data_vlan_esem_feature_get;
