    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_mpls_general_table_fwd_trap_destination].name = "fwd_trap_destination";
    submodule_data->tables[dnx_data_mpls_general_table_fwd_trap_destination].doc = "";
    submodule_data->tables[dnx_data_mpls_general_table_fwd_trap_destination].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_mpls_general_table_fwd_trap_destination].size_of_values = sizeof(dnx_data_mpls_general_fwd_trap_destination_t);
    submodule_data->tables[dnx_data_mpls_general_table_fwd_trap_destination].entry_get = dnx_data_mpls_general_fwd_trap_destination_entry_str_get;

    
    submodule_data->tables[dnx_data_mpls_general_table_fwd_trap_destination].nof_keys = 1;
    submodule_data->tables[dnx_data_mpls_general_table_fwd_trap_destination].keys[0].name = "index";
    submodule_data->tables[dnx_data_mpls_general_table_fwd_trap_destination].keys[0].doc = "";

    
    submodule_data->tables[dnx_data_mpls_general_table_fwd_trap_destination].nof_values = 1;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_mpls_general_table_fwd_trap_destination].values, dnxc_data_value_t, submodule_data->tables[dnx_data_mpls_general_table_fwd_trap_destination].nof_values, "_dnx_data_mpls_general_table_fwd_trap_destination table values");
    submodule_data->tables[dnx_data_mpls_general_table_fwd_trap_destination].values[0].name = "context";
    submodule_data->tables[dnx_data_mpls_general_table_fwd_trap_destination].values[0].type = "dbal_fields_e";
    submodule_data->tables[dnx_data_mpls_general_table_fwd_trap_destination].values[0].doc = "";
    submodule_data->tables[dnx_data_mpls_general_table_fwd_trap_destination].values[0].offset = UTILEX_OFFSETOF(dnx_data_mpls_general_fwd_trap_destination_t, context);
...
const dnx_data_mpls_general_fwd_trap_destination_t *
dnx_data_mpls_general_fwd_trap_destination_get(
    int unit,
    int index)
{
    char *data;
    ...
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_mpls, dnx_data_mpls_submodule_general, dnx_data_mpls_general_table_fwd_trap_destination);
    
    data = dnxc_data_mgmt_table_data_get(unit, table, index, 0);
    return (const dnx_data_mpls_general_fwd_trap_destination_t *) data;

}


shr_error_e
dnx_data_mpls_general_fwd_trap_destination_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_mpls_general_fwd_trap_destination_t *data;
    SHR_FUNC_INIT_VARS(unit);

    
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_mpls, dnx_data_mpls_submodule_general, dnx_data_mpls_general_table_fwd_trap_destination);
    data = (const dnx_data_mpls_general_fwd_trap_destination_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
...
dnx_data_mpls_general_fwd_trap_destination_info_get(
    int unit)
{

    
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_mpls, dnx_data_mpls_submodule_general, dnx_data_mpls_general_table_fwd_trap_destination);
