    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_nif_global_define_max_core_access_per_port].doc = "";
    ...
    submodule_data->defines[dnx_data_nif_global_define_max_nof_mgmt_ports].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_nif_eth_table_is_nif_loopback_supported].values[0].doc = "Is specific imb type is supporting nif loopback.";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_nif_framer_table_b66switch].values[0].doc = "The main block id";
    ...
    submodule_data->tables[dnx_data_nif_framer_table_b66switch].values[1].doc = "The backup block id";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_nif_mac_client_sb_fifo_force_supported].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_nif_scheduler_table_rx_scheduler_rmc_entries_map].values[0].doc = "optional start slots for the RMC Id";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_nif_features_txpi_supported_in_pm8x50].doc = "";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_nif_signal_quality_table_supported_fecs].values[0].doc = "is FEC type supported";
    ...
    submodule_data->tables[dnx_data_nif_signal_quality_table_hw_based_solution].values[0].doc = "is HW-based solution supported";
