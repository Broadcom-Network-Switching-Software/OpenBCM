    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[13].doc = "true if it is FlexE unaware port";
    ...
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[14].doc = "is interface interleaved in ingress";
    ...
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[15].doc = "is port contain egress interleaving";
    ...
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[16].doc = "is TDM port";
    ...
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[17].doc = "is interface includes TDM ports only";
    ...
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[18].doc = "is interface includes both TDM ports anf non TDM ports";
    ...
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[19].doc = "is sch priority propagation enabled on this port";
    ...
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[20].doc = "is port frame preemptable";
    ...
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[21].doc = "number of port priorities";
    ...
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[22].doc = "should be used just in case the user need to exlictly pick the base queue pair";
    ...
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[23].doc = "number of sch port priorities";
    ...
    submodule_data->tables[dnx_data_port_static_add_table_ucode_port].values[24].doc = "should be used just in case the user need to exlictly pick the base HR";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_port_general_table_fec_compensation_info].values[0].doc = "The portion of the codeword (in bits) on which bit error counting is performed";
    ...
    submodule_data->tables[dnx_data_port_general_table_fec_compensation_info].values[1].doc = "total number of bits in codeword";
    ...
    submodule_data->tables[dnx_data_port_general_table_fec_compensation_info].values[2].doc = "Maximum number of erroroues symbols that can be corrected";
    ...
    submodule_data->tables[dnx_data_port_general_table_fec_compensation_info].values[3].doc = "is FEC type supported";
    ...
    submodule_data->tables[dnx_data_port_general_table_pm_info].nof_values = 1;
    ...
    submodule_data->tables[dnx_data_port_general_table_pm_info].values[0].doc = "Indicates that in TX FIR 6 mode values us pre3 instead of post3";
