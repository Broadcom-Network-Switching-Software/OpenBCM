    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_l2_general_learn_payload_res_optimize].name = "learn_payload_res_optimize";
    submodule_data->features[dnx_data_l2_general_learn_payload_res_optimize].doc = "";
    submodule_data->features[dnx_data_l2_general_learn_payload_res_optimize].flags |= DNXC_DATA_F_FEATURE;
    ...
    submodule_data->tables[dnx_data_l2_general_table_fwd_mact_info].values[0].doc = "Holds the dbal logical table id";
    ...
    submodule_data->tables[dnx_data_l2_general_table_fwd_mact_info].values[1].doc = "Holds the dbal physical table id";
    ...
    submodule_data->tables[dnx_data_l2_general_table_lem_table_map_l2_action].values[0].doc = "The action type of the MACT according to the enum dnx_l2_action_type_t";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_l2_age_and_flush_machine_table_flush_pulse].values[0].doc = "Pulse the flush machine to start scanning.";
