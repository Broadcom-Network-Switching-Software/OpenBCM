...
#include "src/soc/dnx/pemladrv/auto_generated/jericho2x_a0_jr2-comp-jr1-mode_standard_1_dbx_pre_compiled.h"
#include "src/soc/dnx/pemladrv/auto_generated/jericho2x_a0_jer2pemla_standard_1_dbx_pre_compiled.h"
...
#define PRE_COMPILED_DNX2_PEMLA_UCODE_LINE_MAX_NOF_BYTES 512

uint8
pre_compiled_dnx2_pemla_db_string_exist(
    int unit,
    char *filepath)
{
    ...
    if(!sal_strncmp("jericho2x_a0/pemla/ucode/standard_1/jr2-comp-jr1-mode/u_code_db2pem.txt", _filepath, RHFILE_MAX_SIZE))
    {
        return TRUE;
    }

    if(!sal_strncmp("jericho2x_a0/pemla/ucode/standard_1/jer2pemla/u_code_db2pem.txt", _filepath, RHFILE_MAX_SIZE))
    {
        return TRUE;
    }
...
char **
pre_compiled_dnx2_pemla_db_ucode_get(
    int unit,
    const char *filepath)
{
    char db_name[RHNAME_MAX_SIZE] = { 0 };
    ...
    if(!sal_strncmp("jericho2x_a0/pemla/ucode/standard_1/jr2-comp-jr1-mode/u_code_db2pem.txt", _filepath, RHFILE_MAX_SIZE))
    {
        return (char **)pre_compiled_dnx2_pemla_db_string_j2x_a0_jr2_comp_jr1_mode_standard_1;
    }

    if(!sal_strncmp("jericho2x_a0/pemla/ucode/standard_1/jer2pemla/u_code_db2pem.txt", _filepath, RHFILE_MAX_SIZE))
    {
        return (char **)pre_compiled_dnx2_pemla_db_string_j2x_a0_jer2pemla_standard_1;
    }

    if(!sal_strncmp("jericho2p_a0/pemla/ucode/standard_1/jr2-comp-jr1-mode/u_code_db2pem.txt", _filepath, RHFILE_MAX_SIZE))
    {
        return (char **)pre_compiled_dnx2_pemla_db_string_j2p_a0_jr2_comp_jr1_mode_standard_1;
    }

    if(!sal_strncmp("jericho2p_a0/pemla/ucode/standard_1/jer2pemla/u_code_db2pem.txt", _filepath, RHFILE_MAX_SIZE))
    {
        return (char **)pre_compiled_dnx2_pemla_db_string_j2p_a0_jer2pemla_standard_1;
    }

    if(!sal_strncmp("qumran2a_b0/pemla/ucode/standard_1/jer2pemla/u_code_db2pem.txt", _filepath, RHFILE_MAX_SIZE))
    {
        return (char **)pre_compiled_dnx2_pemla_db_string_q2a_b0_jer2pemla_standard_1;
    }

    if(!sal_strncmp("qumran2a_a0/pemla/ucode/standard_1/jer2pemla/u_code_db2pem.txt", _filepath, RHFILE_MAX_SIZE))
    {
        return (char **)pre_compiled_dnx2_pemla_db_string_q2a_a0_jer2pemla_standard_1;
    }

    if(!sal_strncmp("jericho2c_a0/pemla/ucode/standard_1/jr2-comp-jr1-mode/u_code_db2pem.txt", _filepath, RHFILE_MAX_SIZE))
    {
        return (char **)pre_compiled_dnx2_pemla_db_string_j2c_a0_jr2_comp_jr1_mode_standard_1;
    }

    if(!sal_strncmp("jericho2c_a0/pemla/ucode/standard_1/jer2pemla/u_code_db2pem.txt", _filepath, RHFILE_MAX_SIZE))
    {
        return (char **)pre_compiled_dnx2_pemla_db_string_j2c_a0_jer2pemla_standard_1;
    }

    if(!sal_strncmp("jericho2_b0/pemla/ucode/standard_1/jr2-comp-jr1-mode/u_code_db2pem.txt", _filepath, RHFILE_MAX_SIZE))
    {
        return (char **)pre_compiled_dnx2_pemla_db_string_jr2_b0_jr2_comp_jr1_mode_standard_1;
    }

    if(!sal_strncmp("jericho2_b0/pemla/ucode/standard_1/jer2pemla/u_code_db2pem.txt", _filepath, RHFILE_MAX_SIZE))
    {
        return (char **)pre_compiled_dnx2_pemla_db_string_jr2_b0_jer2pemla_standard_1;
    }

    if(!sal_strncmp("jericho2_a0/pemla/ucode/standard_1/jr2-comp-jr1-mode/u_code_db2pem.txt", _filepath, RHFILE_MAX_SIZE))
    {
        return (char **)pre_compiled_dnx2_pemla_db_string_jr2_a0_jr2_comp_jr1_mode_standard_1;
    }

    if(!sal_strncmp("jericho2_a0/pemla/ucode/standard_1/jer2pemla/u_code_db2pem.txt", _filepath, RHFILE_MAX_SIZE))
    {
        return (char **)pre_compiled_dnx2_pemla_db_string_jr2_a0_jer2pemla_standard_1;
    }
