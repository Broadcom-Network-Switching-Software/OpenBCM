...
shr_error_e db_mapping_info_init(const int unit, int nof_reg);
shr_error_e reg_mapping_info_init(const int unit, int nof_dbs);
...
shr_error_e vr_mapping_info_init(const int unit, int nof_vrs);
