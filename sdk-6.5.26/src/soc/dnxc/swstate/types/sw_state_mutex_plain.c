...
int dnxc_sw_state_mutex_create(int unit, uint32 node_id, sw_state_mutex_t *ptr_mtx, char *desc, uint32 flags)
{
...
int dnxc_sw_state_mutex_destroy(int unit, uint32 node_id, sw_state_mutex_t *ptr_mtx, uint32 flags)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int dnxc_sw_state_mutex_take(int unit, uint32 node_id, sw_state_mutex_t *ptr_mtx, int usec, uint32 flags)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int dnxc_sw_state_mutex_give(int unit, uint32 node_id, sw_state_mutex_t *ptr_mtx, uint32 flags)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
