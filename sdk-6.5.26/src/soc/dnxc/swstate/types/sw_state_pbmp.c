    ...
    char *dbg_string)
{
    ...
    DNX_SW_STATE_MEMWRITE(unit, node_id, src, pbmp, 0, sizeof(dnxc_sw_state_pbmp), flags, dbg_string);
    ...
    char *dbg_string)
{
    ...
    SHR_IF_ERR_EXIT(dnxc_sw_state_pbmp_read(unit, node_id, pbmp, &tmp_pbmp, flags, dbg_string));
    ...
    char *dbg_string)
{
    ...
    SHR_IF_ERR_EXIT(dnxc_sw_state_pbmp_write(unit, node_id, pbmp, &tmp_pbmp, flags, dbg_string));
