...
multithread_analyzer_init_layout_structure(int unit)
{
    ...
    layout_array_multithread_analyzer[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_multithread_analyzer[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_MULTITHREAD_ANALYZER__LAST);
    ...
    layout_array_multithread_analyzer[idx].doc = "Hash Table for log entries.";
    layout_array_multithread_analyzer[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
