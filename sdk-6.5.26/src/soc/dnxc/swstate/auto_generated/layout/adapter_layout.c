...
adapter_init_layout_structure(int unit)
{
    ...
    layout_array_adapter[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_ADAPTER_CONTEXT_DB__LAST);
    ...
    layout_array_adapter[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_ADAPTER_CONTEXT_DB__PARAMS__LAST);
