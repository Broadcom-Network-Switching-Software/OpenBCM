...
int dcmn_wb_all_reset_test_utils_preconditions (int unit) {
...
int dcmn_wb_common_api_preconditions (int unit) {
    int no_wb_test;
    int field_wb_stop;
    int disable_once;
...
void dcmn_bcm_warm_boot_api_test_enable_if_disabled_once(int unit) {
    ...
    assert(dcmn_wb_all_reset_test_utils_preconditions(unit));
...
int dcmn_bcm_warm_boot_api_test_reset(int unit) {
    ...
    if (!dcmn_wb_common_api_preconditions(unit)) {
...
{
    sal_strncpy_s(_soc_dcmn_wb_issu_dump_directory, directory, ISSU_DUMP_DIRECTORY_MAX_LENGTH);
}
...
{
    sal_strncpy_s(_soc_dcmn_wb_default_dump_directory, directory, ISSU_DUMP_DIRECTORY_MAX_LENGTH);
}
