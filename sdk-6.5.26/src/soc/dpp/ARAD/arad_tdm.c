...
#define ARAD_TDM_FTMH_OPT_TYPE_START_BIT (ARAD_TDM_ARAD_FTMH_OPT_TYPE_START_BIT)
#define ARAD_TDM_FTMH_OPT_UC_DEST_IF_LSB (ARAD_TDM_ARAD_FTMH_OPT_UC_DEST_IF_LSB)
#define ARAD_TDM_FTMH_OPT_UC_DEST_IF_NOF_BITS (ARAD_TDM_ARAD_FTMH_OPT_UC_DEST_IF_NOF_BITS)
#define ARAD_TDM_FTMH_OPT_UC_DEST_FAP_ID_LSB (ARAD_TDM_ARAD_FTMH_OPT_UC_DEST_FAP_ID_LSB)
#define ARAD_TDM_FTMH_OPT_UC_DEST_FAP_ID_NOF_BITS (ARAD_TDM_ARAD_FTMH_OPT_UC_DEST_FAP_ID_NOF_BITS)
...
#define ARAD_TDM_FTMH_OPT_MC_MC_ID_LSB (ARAD_TDM_ARAD_FTMH_OPT_MC_MC_ID_LSB)
#define ARAD_TDM_FTMH_OPT_MC_MC_ID_NOF_BITS (ARAD_TDM_ARAD_FTMH_OPT_MC_MC_ID_NOF_BITS)
...
#define ARAD_TDM_FTMH_STA_TYPE_START_BIT (ARAD_TDM_ARAD_FTMH_STA_TYPE_START_BIT)
#define ARAD_TDM_FTMH_STA_UC_USER_DEFINED_1_LSB (ARAD_TDM_ARAD_FTMH_STA_UC_USER_DEFINED_1_LSB)
#define ARAD_TDM_FTMH_STA_UC_USER_DEFINED_1_NOF_BITS (ARAD_TDM_ARAD_FTMH_STA_UC_USER_DEFINED_1_NOF_BITS)
#define ARAD_TDM_FTMH_STA_UC_USER_DEFINED_1_GET_START_BIT (ARAD_TDM_ARAD_FTMH_STA_UC_USER_DEFINED_1_GET_START_BIT)
#define ARAD_TDM_FTMH_STA_UC_USER_DEFINED_2_LSB (ARAD_TDM_ARAD_FTMH_STA_UC_USER_DEFINED_2_LSB)
#define ARAD_TDM_FTMH_STA_UC_USER_DEFINED_2_NOF_BITS (ARAD_TDM_ARAD_FTMH_STA_UC_USER_DEFINED_2_NOF_BITS)
#define ARAD_TDM_FTMH_STA_UC_USER_DEFINED_2_GET_START_BIT (ARAD_TDM_ARAD_FTMH_STA_UC_USER_DEFINED_2_GET_START_BIT)
#define ARAD_TDM_FTMH_STA_UC_USER_DEFINED_3_LSB (ARAD_TDM_ARAD_FTMH_STA_UC_USER_DEFINED_3_LSB)
#define ARAD_TDM_FTMH_STA_UC_USER_DEFINED_3_NOF_BITS (ARAD_TDM_ARAD_FTMH_STA_UC_USER_DEFINED_3_NOF_BITS)
#define ARAD_TDM_FTMH_STA_UC_USER_DEFINED_3_GET_START_BIT (ARAD_TDM_ARAD_FTMH_STA_UC_USER_DEFINED_3_GET_START_BIT)
#define ARAD_TDM_FTMH_STA_UC_USER_DEFINED_NOF_BITS_PART_1_2 (ARAD_TDM_ARAD_FTMH_STA_UC_USER_DEFINED_NOF_BITS_PART_1_2)
#define ARAD_TDM_FTMH_STA_UC_FAP_PORT_ID_LSB (ARAD_TDM_ARAD_FTMH_STA_UC_FAP_PORT_ID_LSB)
#define ARAD_TDM_FTMH_STA_UC_FAP_PORT_ID_NOF_BITS (ARAD_TDM_ARAD_FTMH_STA_UC_FAP_PORT_ID_NOF_BITS)
#define ARAD_TDM_FTMH_STA_UC_FAP_ID_LSB (ARAD_TDM_ARAD_FTMH_STA_UC_FAP_ID_LSB)
#define ARAD_TDM_FTMH_STA_UC_FAP_ID_NOF_BITS (ARAD_TDM_ARAD_FTMH_STA_UC_FAP_ID_NOF_BITS)
...
#define ARAD_TDM_FTMH_STA_MC_USER_DEFINED_1_LSB (ARAD_TDM_ARAD_FTMH_STA_MC_USER_DEFINED_1_LSB)
#define ARAD_TDM_FTMH_STA_MC_USER_DEFINED_1_NOF_BITS (ARAD_TDM_ARAD_FTMH_STA_MC_USER_DEFINED_1_NOF_BITS)
#define ARAD_TDM_FTMH_STA_MC_USER_DEFINED_1_GET_START_BIT (ARAD_TDM_ARAD_FTMH_STA_MC_USER_DEFINED_1_GET_START_BIT)
#define ARAD_TDM_FTMH_STA_MC_USER_DEFINED_2_LSB (ARAD_TDM_ARAD_FTMH_STA_MC_USER_DEFINED_2_LSB)
#define ARAD_TDM_FTMH_STA_MC_USER_DEFINED_2_NOF_BITS (ARAD_TDM_ARAD_FTMH_STA_MC_USER_DEFINED_2_NOF_BITS)
#define ARAD_TDM_FTMH_STA_MC_USER_DEFINED_2_GET_START_BIT (ARAD_TDM_ARAD_FTMH_STA_MC_USER_DEFINED_2_GET_START_BIT)
#define ARAD_TDM_FTMH_STA_MC_USER_DEFINED_3_LSB (ARAD_TDM_ARAD_FTMH_STA_MC_USER_DEFINED_3_LSB)
#define ARAD_TDM_FTMH_STA_MC_USER_DEFINED_3_NOF_BITS (ARAD_TDM_ARAD_FTMH_STA_MC_USER_DEFINED_3_NOF_BITS)
#define ARAD_TDM_FTMH_STA_MC_USER_DEFINED_3_GET_START_BIT (ARAD_TDM_ARAD_FTMH_STA_MC_USER_DEFINED_3_GET_START_BIT)
#define ARAD_TDM_FTMH_STA_MC_USER_DEFINED_4_LSB (ARAD_TDM_ARAD_FTMH_STA_MC_USER_DEFINED_4_LSB)
#define ARAD_TDM_FTMH_STA_MC_USER_DEFINED_4_NOF_BITS (ARAD_TDM_ARAD_FTMH_STA_MC_USER_DEFINED_4_NOF_BITS)
#define ARAD_TDM_FTMH_STA_MC_USER_DEFINED_4_GET_START_BIT (ARAD_TDM_ARAD_FTMH_STA_MC_USER_DEFINED_4_GET_START_BIT)
#define ARAD_TDM_FTMH_STA_MC_USER_DEFINED_NOF_BITS_PART_1_2 (ARAD_TDM_ARAD_FTMH_STA_MC_USER_DEFINED_NOF_BITS_PART_1_2)
#define ARAD_TDM_FTMH_STA_MC_USER_DEFINED_NOF_BITS_PART_1_3 (ARAD_TDM_ARAD_FTMH_STA_MC_USER_DEFINED_NOF_BITS_PART_1_3)
#define ARAD_TDM_FTMH_STA_MC_MC_ID_LSB (ARAD_TDM_ARAD_FTMH_STA_MC_MC_ID_LSB)
#define ARAD_TDM_FTMH_STA_MC_MC_ID_NOF_BITS (ARAD_TDM_ARAD_FTMH_STA_MC_MC_ID_NOF_BITS)
#define ARAD_TDM_FTMH_STA_MC_INTERNAL_USE_LSB (ARAD_TDM_ARAD_FTMH_STA_MC_INTERNAL_USE_LSB)
#define ARAD_TDM_FTMH_STA_MC_INTERNAL_USE_NOF_BITS (ARAD_TDM_ARAD_FTMH_STA_MC_INTERNAL_USE_NOF_BITS)
  ...
  switch(action_ing)
  {
    case ARAD_TDM_ING_ACTION_ADD:
      if (tdm_mode == ARAD_MGMT_TDM_MODE_TDM_OPT)
      {
        ...
        arad_ire_tdm_config_tbl_data.mode = ARAD_TDM_FTMH_ARAD_OPT_MODE_VAL_FLD;
        ftmh_mode = (is_mc == FALSE) ? ARAD_TDM_FTMH_INFO_MODE_OPT_UC:ARAD_TDM_FTMH_INFO_MODE_OPT_MC;
      }
      else
      {
        arad_ire_tdm_config_tbl_data.mode = ARAD_TDM_FTMH_ARAD_STA_MODE_VAL_FLD;
  ...
  )
{
  ...
  if (*action_ing != ARAD_TDM_ING_ACTION_NO_CHANGE)
  {
    ...
    if (arad_ire_tdm_config_tbl_data.mode == ARAD_TDM_FTMH_ARAD_OPT_MODE_VAL_FLD)
    {
