    ...
    int unit)
{
    ...
    {
        SHR_IF_ERR_EXIT(dnx_algo_port_nif_ethu_nof_ethus_per_core_get(unit, core_id, &nof_ethus_in_core));
        for (ethu_id_in_core = 0; ethu_id_in_core < nof_ethus_in_core; ethu_id_in_core++)
        {
