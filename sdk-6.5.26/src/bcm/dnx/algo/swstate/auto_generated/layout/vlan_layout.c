...
vlan_init_layout_structure(int unit)
{
    ...
    layout_array_vlan[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_VLAN_DB__LAST);
    ...
    layout_array_vlan[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_VLAN_DB__VLAN_INFO__LAST);
