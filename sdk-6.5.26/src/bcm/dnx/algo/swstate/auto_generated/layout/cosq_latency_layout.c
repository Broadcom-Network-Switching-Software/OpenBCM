...
cosq_latency_init_layout_structure(int unit)
{
    ...
    layout_array_cosq_latency[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_cosq_latency[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_COSQ_LATENCY_DB__LAST);
    ...
    layout_array_cosq_latency[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_COSQ_LATENCY_DB__PROBABILITY_CONVERT__LAST);
