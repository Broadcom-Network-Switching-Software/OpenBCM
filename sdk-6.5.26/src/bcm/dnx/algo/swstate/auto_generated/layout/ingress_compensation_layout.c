...
ingress_compensation_init_layout_structure(int unit)
{
    ...
    layout_array_ingress_compensation[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_ingress_compensation[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_DNX_INGRESS_COMPENSATION_DB__LAST);
