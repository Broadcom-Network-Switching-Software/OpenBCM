...
instru_init_layout_structure(int unit)
{
    ...
    layout_array_instru[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_INSTRU__LAST);
    ...
    layout_array_instru[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_INSTRU__SFLOW_INFO__LAST);
    ...
    layout_array_instru[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_INSTRU__EVENTOR_INFO__LAST);
    ...
    layout_array_instru[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_INSTRU__TRIGGER_INFO__LAST);
    ...
    layout_array_instru[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_INSTRU__EVENTOR_INFO__RX_CONTEXTS_INFO__LAST);
    ...
    layout_array_instru[idx].last_child_index = DNXC_SW_STATE_LAYOUT_GET_PARAM_IDX(DNX_SW_STATE_INSTRU__EVENTOR_INFO__TX_CONTEXTS_INFO__LAST);
