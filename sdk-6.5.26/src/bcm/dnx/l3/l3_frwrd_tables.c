    ...
    uint32 fec_index)
{
    ...
    SHR_IF_ERR_EXIT(dbal_tables_field_size_get(unit, dbal_table, *dest_type, FALSE, 0, INST_SINGLE, &table_field_size));
    ...
    bcm_l3_route_t * info)
{
    ...
    else if (!dnx_data_l3.feature.feature_get(unit, dnx_data_l3_feature_separate_fwd_rpf_dbs))
    {
    ...
    int is_kbp_table)
{
    ...
    if (!is_kbp_table)
    {
        ...
        if (routed_learn_flags && dnx_data_l3.feature.feature_get(unit, dnx_data_l3_feature_routed_learning))
        {
    ...
    uint32 flags)
{
    ...
    if (routed_learn_flags &&
        dnx_data_l3.feature.feature_get(unit, dnx_data_l3_feature_routed_learning) &&
    ...
    bcm_l3_host_t * info)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_l3_host_verify(unit, info));
    ...
    bcm_l3_host_t * ip_addr)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_l3_host_verify(unit, ip_addr));
    ...
    bcm_l3_host_t * info)
{
    ...
    SHR_IF_ERR_EXIT(dnx_switch_control_routed_learn_get(unit, &routed_learn_flags));
    if (routed_learn_flags &&
        dnx_data_l3.feature.feature_get(unit, dnx_data_l3_feature_routed_learning) && !(use_kbp_ipv4 || use_kbp_ipv6))
    {
        SHR_ERR_EXIT(_SHR_E_CONFIG,
