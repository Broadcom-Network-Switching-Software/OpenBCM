    ...
    int sflow_raw_id)
{
    ...
    if ((hw_res.outlif_dbal_table_id != DBAL_TABLE_EEDB_SFLOW_DATA)
        || (hw_res.outlif_dbal_result_type != DBAL_RESULT_TYPE_EEDB_SFLOW_DATA_ETPS_DATA_SFLOW))
    {
        SHR_ERR_EXIT(_SHR_E_PARAM,
    ...
    int *global_lif)
{
    ...
    outlif_info.dbal_result_type = DBAL_RESULT_TYPE_EEDB_SFLOW_DATA_ETPS_DATA_SFLOW;
    ...
    int local_outlif)
{
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_RESULT_TYPE, INST_SINGLE,
                                 DBAL_RESULT_TYPE_EEDB_SFLOW_DATA_ETPS_DATA_SFLOW);
