    ...
    dnx_field_context_key_info_t * key_info_p)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_qual_attach_info_t_init(unit, key_info_p->attach_info));
exit:
    SHR_FUNC_EXIT;
}
    ...
    bcm_field_AppType_t * apptype_p)
{
    ...
    switch (dnx_data_field.external_tcam.type_get(unit))
    {
        ...
        {
#if defined(INCLUDE_KBP)
            SHR_IF_ERR_EXIT(dnx_field_kbp_context_apptype_create(unit, flags, apptype_info_p, apptype_p));
#else
    ...
    bcm_field_AppType_t * base_static_apptype_p)
{
    ...
    apptype_index = dynamic_apptype - dnx_data_field.external_tcam.apptype_user_1st_get(unit);
    ...
    dnx_field_context_apptype_info_t * apptype_info_p)
{
    ...
    if (apptype > bcmFieldAppTypeCount)
    {
        ...
        apptype_index = apptype - dnx_data_field.external_tcam.apptype_user_1st_get(unit);
    ...
    bcm_field_AppType_t user_app_types[DNX_DATA_MAX_FIELD_EXTERNAL_TCAM_APPTYPE_USER_NOF])
{
    ...
    bcm_field_AppType_t first_user_defind_apptype = dnx_data_field.external_tcam.apptype_user_1st_get(unit);
    ...
    sal_memset(user_app_types, 0x0, DNX_DATA_MAX_FIELD_EXTERNAL_TCAM_APPTYPE_USER_NOF * sizeof(user_app_types[0]));
    ...
    dnx_field_context_hash_info_t * hash_info_p)
{
    ...
    SHR_IF_ERR_EXIT(dbal_fields_enum_next_enum_value_get
                    (unit, DBAL_FIELD_FIELD_HASH_LB_KEY, INVALID_ENUM, &enum_iterator));
    while (enum_iterator != INVALID_ENUM)
    {
        nof_action_keys_used++;
        SHR_IF_ERR_EXIT(dbal_fields_enum_next_enum_value_get
                        (unit, DBAL_FIELD_FIELD_HASH_LB_KEY, enum_iterator, &enum_iterator));
    }
    ...
    dnx_field_context_t context_id)
{
    ...
    SHR_IF_ERR_EXIT(dbal_fields_enum_next_enum_value_get
                    (unit, DBAL_FIELD_FIELD_HASH_LB_KEY, INVALID_ENUM, &action_key_iter));
    while (action_key_iter != INVALID_ENUM)
    {
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_HASH_ACTION, action_key_iter,
                                     DBAL_ENUM_FVAL_HASH_ACTION_NONE);
        SHR_IF_ERR_EXIT(dbal_fields_enum_next_enum_value_get
                        (unit, DBAL_FIELD_FIELD_HASH_LB_KEY, action_key_iter, &action_key_iter));
    }
    ...
    bcm_field_AppType_t * apptype_p)
{
    ...
    int apptype_sw_state_index;
    char name_ndx[DBAL_MAX_STRING_LENGTH];
    int user_apptype_first = dnx_data_field.external_tcam.apptype_user_1st_get(unit);
    int user_apptype_last = dnx_data_field.external_tcam.apptype_user_1st_get(unit) +
    ...
    if (found == FALSE)
    {
        for (apptype_ndx = user_apptype_first; apptype_ndx <= user_apptype_last; apptype_ndx++)
        {
            ...
            if (is_alloc)
            {
                apptype_sw_state_index = apptype_ndx - user_apptype_first;
                SHR_IF_ERR_EXIT(dnx_field_apptype_sw.user_def_info.name.stringget(unit,
                                                                                  apptype_sw_state_index, name_ndx));
                if (0 == sal_strncmp(name, name_ndx, DBAL_MAX_STRING_LENGTH))
                {
                    found = TRUE;
                    break;
    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(dbal_fields_enum_next_enum_value_get
                    (unit, DBAL_FIELD_FIELD_HASH_LB_KEY, INVALID_ENUM, &action_key_enum_iter));
    while (action_key_enum_iter != INVALID_ENUM)
    {
        ...
        SHR_IF_ERR_EXIT(dbal_fields_enum_next_enum_value_get
                        (unit, DBAL_FIELD_FIELD_HASH_LB_KEY, action_key_enum_iter, &action_key_enum_iter));
    }
    ...
    int unit)
{
    ...
    DNX_FIELD_KBP_OPCODE_ITERATOR(opcode_id)
    {
        ...
        SHR_IF_ERR_EXIT(dnx_field_map_apptype_to_lookup_fwd_contexts
                        (unit, apptype, &nof_lkp_fwd_contexts, lkp_fwd_contexts));
        SHR_IF_ERR_EXIT(dnx_field_map_apptype_to_cs_fwd_contexts(unit, apptype, &nof_cs_fwd_contexts, cs_fwd_contexts));
