...
static const dnx_field_cs_qual_map_t dnx_epmf_cs_qual_map[bcmFieldQualifyCount] = {
        ...
        [bcmFieldQualifyContextIdRaw]               = {1, DNX_FIELD_CS_QUAL_FWD_CONTEXT_PROFILE, },
        [bcmFieldQualifyContextId]                  = {1, DNX_FIELD_CS_QUAL_FWD_CONTEXT_PROFILE, BCM_TO_DNX_ADDITIONAL_OBJ , NULL, 0, NULL, NULL, dnx_field_convert_forwarding_context},
        [bcmFieldQualifyVlanFormatRaw]              = {1, DNX_FIELD_CS_QUAL_PMF_TAG_STRUCTURE, },
        ...
        [bcmFieldQualifyOutVportClass]              = {1, DNX_FIELD_CS_QUAL_PMF_OUT_LIF_PROFILE, },
        [bcmFieldQualifyOutVportClass0]             = {1, DNX_FIELD_CS_QUAL_PMF_OUT_LIF_PROFILE, },
        [bcmFieldQualifyOutVportClass1]             = {1, DNX_FIELD_CS_QUAL_PMF_OUT_LIF_1_PROFILE, },
        [bcmFieldQualifyOutVportClass2]             = {1, DNX_FIELD_CS_QUAL_PMF_OUT_LIF_2_PROFILE, },
        [bcmFieldQualifyOutVportClass3]             = {1, DNX_FIELD_CS_QUAL_PMF_OUT_LIF_3_PROFILE, },
...
static const dnx_field_qual_map_t dnx_external_meta_qual_map[bcmFieldQualifyCount] = {
        ...
        [bcmFieldQualifyL3SrcBindHit]                = {DNX_FIELD_QUAL_L3SRCBIND_HIT,},
};
...
static const dnx_field_qual_map_t dnx_ipmf1_meta_qual_map[bcmFieldQualifyCount] = {
        ...
        [bcmFieldQualifyAcInLifWideDataExtended]     = {DNX_FIELD_QUAL_AC_IN_LIF_WIDE_DATA_EXTENDED, BCM_TO_DNX_ADDITIONAL_OBJ, dnx_field_convert_ac_in_lif_wide_data_extended},
        [bcmFieldQualifyDstClassL2]                  = {DNX_FIELD_QUAL_MACT_ENTRY_GROUPING, },
        [bcmFieldQualifyAppTypeRaw]                  = {DNX_FIELD_QUAL_MKX_OPCODE, },
        [bcmFieldQualifyAppType]                     = {DNX_FIELD_QUAL_MKX_OPCODE, BCM_TO_DNX_ADDITIONAL_OBJ, dnx_field_convert_app_type_opcode},
        [bcmFieldQualifyL3SrcBindHit]                = {DNX_FIELD_QUAL_L3SRCBIND_HIT, },
        [bcmFieldQualifySrv6GsidNextSi]              = {DNX_FIELD_QUAL_SRV6_GSID_NEXT_SI},
        [bcmFieldQualifySrv6GsidNextGsid]            = {DNX_FIELD_QUAL_SRV6_GSID_NEXT_GSID},
...
static const dnx_field_qual_map_t dnx_ipmf3_meta_qual_map[bcmFieldQualifyCount] = {
        ...
        [bcmFieldQualifyUDHData0Ext]                 = {DNX_FIELD_QUAL_USER_HEADER_1_EXT,              },
        [bcmFieldQualifyUDHData1Ext]                 = {DNX_FIELD_QUAL_USER_HEADER_2_EXT,              },
        [bcmFieldQualifyRxTrapStrength]              = {DNX_FIELD_QUAL_FWD_ACTION_STRENGTH             },
        ...
        [bcmFieldQualifyFecStatId0]                  = {DNX_FIELD_QUAL_FER_STATISTICS_OBJ_ID_0,},
        [bcmFieldQualifyFecStatId1]                  = {DNX_FIELD_QUAL_FER_STATISTICS_OBJ_ID_1,},
        [bcmFieldQualifyFecStatId2]                  = {DNX_FIELD_QUAL_FER_STATISTICS_OBJ_ID_2,},
...
static const dnx_field_qual_map_t dnx_epmf_meta_qual_map[bcmFieldQualifyCount] = {
        ...
        [bcmFieldQualifyOutVportClass0]              = {DNX_FIELD_QUAL_OUT_LIF_PROFILE, BCM_TO_DNX_ADDITIONAL_OBJ},
        [bcmFieldQualifyOutVportClass1]              = {DNX_FIELD_QUAL_OUT_LIF_PROFILE_1,},
        [bcmFieldQualifyOutVportClass2]              = {DNX_FIELD_QUAL_OUT_LIF_PROFILE_2,},
        [bcmFieldQualifyOutVportClass3]              = {DNX_FIELD_QUAL_OUT_LIF_PROFILE_3,},
        [bcmFieldQualifyInterfaceClassL2]            = {DNX_FIELD_QUAL_PMF_ETH_RIF_PROFILE       },
        [bcmFieldQualifyPortClassPacketProcessing]   = {DNX_FIELD_QUAL_PP_PORT_PMF_PROFILE,      },
        [bcmFieldQualifyPortClassTrafficManagement]  = {DNX_FIELD_QUAL_TM_PORT_PMF_PROFILE,      },
        ...
        [bcmFieldQualifyVisibility]                  = {DNX_FIELD_QUAL_FTMH_VISIBILITY,},
};
...
const char *bcm_action_description[bcmFieldActionCount] = {
    ...
    [bcmFieldActionContextId] = "Updates context value.",
    [bcmFieldActionContextIdRaw] = "Updates context value. Input expects raw value.",
...
static const dnx_field_action_map_t dnx_ipmf1_action_map[bcmFieldActionCount] = {
        ...
        [bcmFieldActionRedirect]               = {DNX_FIELD_ACTION_DST_DATA, BCM_TO_DNX_ADDITIONAL_OBJ, dnx_field_convert_gport_to_dst_plus_qual},
        ...
        [bcmFieldActionUDHData0Ext]            = {DNX_FIELD_ACTION_USER_HEADER_1_EXT},
        [bcmFieldActionUDHData1Ext]            = {DNX_FIELD_ACTION_USER_HEADER_2_EXT},
        ...
        [bcmFieldActionVSwitchNew]             = {DNX_FIELD_ACTION_FWD_DOMAIN, BCM_TO_DNX_ADDITIONAL_OBJ, },
        [bcmFieldActionFwdDomain]              = {DNX_FIELD_ACTION_FWD_DOMAIN_WITH_PROFILE, BCM_TO_DNX_ADDITIONAL_OBJ, dnx_field_convert_fwd_domain},
        [bcmFieldActionFwdDomainRaw]           = {DNX_FIELD_ACTION_FWD_DOMAIN_WITH_PROFILE },
...
static const dnx_field_action_map_t dnx_epmf_action_map[bcmFieldActionCount] = {
    ...
    [bcmFieldActionOutPortPacketProcessing]     = {DNX_FIELD_ACTION_OUT_PP_PORT},
    [bcmFieldActionPpDsp]                       = {DNX_FIELD_ACTION_FTMH_PP_DSP},
    [bcmFieldActionTrap]                        = {DNX_FIELD_ACTION_TRAP, BCM_TO_DNX_ADDITIONAL_OBJ, dnx_field_convert_egress_trap_id},
    [bcmFieldActionTrapRaw]                     = {DNX_FIELD_ACTION_TRAP},
    ...
    [bcmFieldActionDoNotChangeTtl]              = {DNX_FIELD_ACTION_FAI_DO_NOT_DECREMENT_TTL, },
    [bcmFieldActionContextIdRaw]                = {DNX_FIELD_ACTION_FORWARD_CODE, },
    [bcmFieldActionContextId]                   = {DNX_FIELD_ACTION_FORWARD_CODE, BCM_TO_DNX_ADDITIONAL_OBJ, dnx_field_convert_forwarding_context},
    [bcmFieldActionEesEntry0]                   = {DNX_FIELD_ACTION_EES_ENTRY_29_0, },
    [bcmFieldActionEesEntry1]                   = {DNX_FIELD_ACTION_EES_ENTRY_59_30, },
    [bcmFieldActionEesEntry2]                   = {DNX_FIELD_ACTION_EES_ENTRY_89_60, },
    [bcmFieldActionEesEntry3]                   = {DNX_FIELD_ACTION_EES_ENTRY_119_90, },
    [bcmFieldActionEesEntry4]                   = {DNX_FIELD_ACTION_EES_ENTRY_TYPE, },
    [bcmFieldActionEesEntryLocationProfile]     = {DNX_FIELD_ACTION_EES_ENTRY_PUSH_PROFILE, BCM_TO_DNX_ADDITIONAL_OBJ, dnx_field_convert_ees_location_profile},
    [bcmFieldActionEesEntryLocationProfileRaw]  = {DNX_FIELD_ACTION_EES_ENTRY_PUSH_PROFILE, },
    [bcmFieldActionOutVportToStamp]             = {DNX_FIELD_ACTION_OUTLIF_TO_STAMP},
...
static const dnx_field_map_port_profile_info_t dnx_field_map_port_profile_info[bcmPortClassCount] = {
        ...
        [bcmPortClassFieldEgressVportCs]    = {
                .port_profile_type = DNX_FIELD_PORT_PROFILE_TYPE_OUT_ETH_RIF_EGRESS, },
};
