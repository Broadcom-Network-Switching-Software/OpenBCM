...
* \param [out] action_ids - The list of action ids used by the signal, in the form of the DBAL enum relevant
...
dnx_field_action_vw_signal_actions_offsets(
    ...
    char *signal_name,
    int *nof_actions_p,
    dnx_field_action_id_t action_ids[DNX_DATA_MAX_FIELD_VIRTUAL_WIRE_ACTIONS_PER_SIGNAL_NOF],
    int offsets[DNX_DATA_MAX_FIELD_VIRTUAL_WIRE_ACTIONS_PER_SIGNAL_NOF])
{
    ...
    SHR_NULL_CHECK(action_ids, _SHR_E_PARAM, "action_ids");
    ...
    {
        action_ids[action_index] = DNX_FIELD_ACTION_ID_INVALID;
    ...
    for (signal_index = 0; signal_index < signals_nof; signal_index++)
    {
         ...
         */
        if ((dnx_data_signals_struct_p->mapped_action[0] != DNX_FIELD_ACTION_ID_INVALID) &&
    ...
    if (found)
    {
        ...
        {
            if (dnx_data_signals_struct_p->mapped_action[action_index] == DNX_FIELD_ACTION_ID_INVALID)
            {
                break;
            }
            action_ids[action_index] = dnx_data_signals_struct_p->mapped_action[action_index];
    ...
    int action_sizes[DNX_DATA_MAX_FIELD_VIRTUAL_WIRE_ACTIONS_PER_SIGNAL_NOF])
{
    ...
    dnx_field_action_id_t action_ids_signal[DNX_DATA_MAX_FIELD_VIRTUAL_WIRE_ACTIONS_PER_SIGNAL_NOF];
    ...
    SHR_IF_ERR_EXIT(dnx_field_action_vw_signal_actions_offsets
                    (unit, stage, mapping_info_p->physical_wire_name, &nof_actions_signal, action_ids_signal,
                     offsets_signal));
         ...
         action_signal_index++)
    {
        ...
        dnx_action_it = DNX_ACTION(DNX_FIELD_ACTION_CLASS_STATIC, stage, action_ids_signal[action_signal_index]);
        /*
        ...
        for (action_signal_index_2 = 0; action_signal_index_2 < action_signal_index; action_signal_index_2++)
        {
                   ...
                   offsets_signal[action_signal_index_2])))
            {
                 ...
                 */
                if (!((action_ids_signal[action_signal_index] == DNX_FIELD_ACTION_LEARN_OR_TRANSPLANT) ||
                      (action_ids_signal[action_signal_index_2] == DNX_FIELD_ACTION_LEARN_OR_TRANSPLANT)))
                {
    ...
    int unit)
{
    ...
    {
        if (dnx_field_map_stage_info[dnx_stages[stage_idx]].pp_stage == DNX_PP_STAGE_INVALID)
        {
