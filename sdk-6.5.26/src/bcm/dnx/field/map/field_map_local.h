...
shr_error_e dnx_field_convert_gport_to_dst_plus_qual(
    int unit,
    uint32 flags,
    int core,
    uint32 *bcm_data,
...
shr_error_e dnx_field_convert_ees_location_profile(
    int unit,
    uint32 flags,
    int core,
    uint32 *bcm_data,
...
shr_error_e dnx_field_convert_context_param_learn_enable(
    int unit,
    dnx_field_stage_e dnx_stage,
    dnx_field_context_t field_context_id,
    uint32 param_value,
...
/**
* \brief
*  Maps DNX System header profile to BCM system header profile ENUMS
* \param [in] unit                   - Device Id.
* \param [in] dnx_sys_hdr_profile    - DNX Sys hdr profile Enum.
* \param [out] bcm_sys_hdr_profile_p - BCM Sys hdr profile Enum.
* \return
*   shr_error_e - Error Type
* \remark
*   * None
...
*   * None
*/
shr_error_e dnx_field_map_system_header_profile_dnx_to_bcm(
    int unit,
