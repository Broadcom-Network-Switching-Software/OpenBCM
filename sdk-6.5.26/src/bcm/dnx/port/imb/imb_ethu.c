    ...
    int loopback)
{
    ...
    {
        mac_lp_enable = ((loopback == BCM_PORT_LOOPBACK_NONE) || (loopback == BCM_PORT_LOOPBACK_PHY_REMOTE) ||
                         (loopback == BCM_PORT_LOOPBACK_MAC_REMOTE)) ? 0 : 1;
        SHR_IF_ERR_EXIT(portmod_port_loopback_set(unit, port, portmodLoopbackMacOuter, mac_lp_enable));
