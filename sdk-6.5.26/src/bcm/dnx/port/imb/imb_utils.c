...
/**
 * \brief
 *  Logs port mode "preemption control" operation in the generic journal
 * \param [in] unit - Device Id
 * \param [in] journal_entry - journal_entry
 * \param [in] value_orig - value_orig
 * \return
 *   int - Error Type
 * \remark
 *   * None
 ...
 */
static shr_error_e
imb_generic_portmod_preemption_control_journal_set(
    int unit,
    ...
    uint32 value)
{
    ...
    SHR_IF_ERR_EXIT(imb_generic_portmod_preemption_control_journal_set(unit, &journal_entry, value_orig));
