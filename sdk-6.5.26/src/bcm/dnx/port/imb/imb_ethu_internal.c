...
static shr_error_e
imb_ethu_dbal_key_exists_in_table(
    int unit,
    ...
    uint32 value)
{
    ...
    SHR_IF_ERR_EXIT(imb_ethu_dbal_key_exists_in_table(unit, DBAL_TABLE_NIF_ETHU_RX_CTRL, DBAL_FIELD_CORE_ID, &exists));
    /*
     * set key fields
     */
    if (exists)
    ...
    {
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_GLOBAL_ETHU, ethu_info->ethu_id);
    }
    /*
     *  Set value
     */
    ...
    int enable)
{
    ...
    SHR_IF_ERR_EXIT(imb_ethu_dbal_key_exists_in_table
                    (unit, DBAL_TABLE_NIF_ETHU_TX_LANE_CTRL, DBAL_FIELD_CORE_ID, &exists));
    ...
    uint32 sch_weight)
{
     ...
     * alloc DBAL handle
     */
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_NIF_ETHU_SCHEDULER_CTRL, &entry_handle_id));

    SHR_IF_ERR_EXIT(imb_ethu_dbal_key_exists_in_table
                    (unit, DBAL_TABLE_NIF_ETHU_SCHEDULER_CTRL, DBAL_FIELD_CORE_ID, &exists));
    ...
    int sch_weight)
{
    ...
    SHR_IF_ERR_EXIT(imb_ethu_dbal_key_exists_in_table
                    (unit, DBAL_TABLE_NIF_ETHU_RX_RMC_CTRL, DBAL_FIELD_CORE_ID, &exists));
    /*
     * set key fields
     */
    if (exists)
    ...
    uint32 is_bypass)
{
    ...
    SHR_IF_ERR_EXIT(imb_ethu_dbal_key_exists_in_table
                    (unit, DBAL_TABLE_NIF_PRD_ETHU_HARD_STAGE_CTRL, DBAL_FIELD_CORE_ID, &exists));
    ...
    int threshold)
{
    ...
    SHR_IF_ERR_EXIT(imb_ethu_dbal_key_exists_in_table
                    (unit, DBAL_TABLE_NIF_ETHU_SCH_CNT_DEC_THRESHOLD, DBAL_FIELD_CORE_ID, &exists));
    ...
    int in_reset)
{
    ...
    dnx_algo_port_ethu_access_info_t ethu_info;
    uint32 entry_handle_id;
    int ii, nof_rmcs_to_reset, rmc_id_to_reset, nof_priority_groups, exists;
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FUNC_INIT_VARS(unit);
    ...
    int in_reset)
{
     ...
     * alloc DBAL table handle
     */
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_NIF_NMG_TX_CTRL, &entry_handle_id));
    /*
     * set key fields
     */
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CORE_ID, ethu_info.core);
    ...
    dbal_entry_value_field32_set(unit,
                                 entry_handle_id,
                                 DBAL_FIELD_TX_PORTS_RESET, INST_SINGLE,
                                 in_reset ?
                                 DBAL_ENUM_FVAL_NIF_RESET_REVERSE_LOGIC_IN_RESET :
                                 DBAL_ENUM_FVAL_NIF_RESET_REVERSE_LOGIC_OUT_OF_RESET);
 ...
 */
int
imb_ethu_tx_egress_flush_hw_get(
    int unit,
    dnx_algo_port_ethu_access_info_t * ethu_info,
    uint32 *flush_enable)
{
     ...
     * Get field value
     */
    dbal_value_field32_request(unit, entry_handle_id, DBAL_FIELD_FLUSH, INST_SINGLE, flush_enable);
    /*
     * Get entry
     */
    SHR_IF_ERR_EXIT(dbal_entry_get(unit, entry_handle_id, DBAL_COMMIT));
    ...
    int enable)
{
    ...
    SHR_IF_ERR_EXIT(imb_ethu_port_rx_rmc_ctrl_enable_hw_set(unit, ethu_info, rmc_id, DBAL_FIELD_DROP_DATA, enable));
    ...
    int enable)
{
    ...
    SHR_IF_ERR_EXIT(imb_ethu_port_rx_rmc_ctrl_enable_hw_set(unit, ethu_info, rmc_id, DBAL_FIELD_FLUSH_RMC, enable));
    ...
    uint32 *counter)
{
    ...
    SHR_IF_ERR_EXIT(imb_ethu_dbal_key_exists_in_table
                    (unit, DBAL_TABLE_NIF_ETHU_RX_RMC_COUNTER, DBAL_FIELD_CORE_ID, &exists));
    if (exists)
    {
        /*
         * set key fields
    ...
    {
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_ETHU, ethu_info->ethu_id);
    }
    /*
     * Get field value
     */
    ...
    uint32 enable)
{
    ...
    if (dnx_data_fc.general.feature_get(unit, dnx_data_fc_general_nif_pfc_bitmaps_e_f_support) == 0)
    {
    ...
    if (dnx_data_fc.general.feature_get(unit, dnx_data_fc_general_nif_pfc_bitmaps_e_f_support))
    {
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_PFC_FROM_LLFC_BITMAP_TYPE_E_ENABLE, INST_SINGLE,
                                     enable);
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_PFC_FROM_LLFC_BITMAP_TYPE_F_ENABLE, INST_SINGLE,
                                     enable);
    }
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
    ...
    if (dnx_data_fc.general.feature_get(unit, dnx_data_fc_general_qmlf_fc_high_and_low_rmcs_support))
    {
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_RMC_PRIO, rmc_prio);
    }
    else
    {
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_ETHU_ID, ethu_id_in_core);
 ...
 */
int
imb_ethu_internal_port_pfc_force_enable_set(
    int unit,
    bcm_core_t core,
    uint32 ethu_id_in_core,
    int pfc,
    uint32 enable)
{
    ...
    /** Set HW to stop transmission according received PFC */
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_NIF_FC_ETHU_FORCE_PFC_REC_BMP_DEBUG, &entry_handle_id));
    if (dnx_data_fc.general.feature_get(unit, dnx_data_fc_general_nif_pfc_bitmaps_e_f_support) == 0)
    {
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_ETHU_ID, ethu_id_in_core);
    }
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CORE_ID, core);
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_PRIORITY, pfc);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_FORCE_EN, INST_SINGLE, enable);
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
    ...
    uint32 threshold)
{
    ...
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_NIF_FC_ETHU_RX_MLF_RMC_THRESHOLD, &entry_handle_id));
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CORE_ID, core);
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_ETHU_ID, ethu_id_in_core);
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_RMC, rmc);
 ...
 */
int
imb_ethu_internal_port_fc_rx_qmlf_rmc_to_profile_set(
    int unit,
    int rmc_prio,
    int rmc,
    int profile)
{
    ...
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_NIF_FC_ETHU_RX_MLF_RMC_THRESHOLD_PROFILE, &entry_handle_id));
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_RMC_PRIO, rmc_prio);
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_RMC, rmc);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_PROFILE, INST_SINGLE, (uint32) profile);
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
 ...
 */
int
imb_ethu_internal_port_fc_rx_qmlf_rmc_to_profile_get(
    int unit,
    int rmc_prio,
    int rmc,
    int *profile)
{
    ...
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_RMC_PRIO, rmc_prio);
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_RMC, rmc);
    dbal_value_field32_request(unit, entry_handle_id, DBAL_FIELD_PROFILE, INST_SINGLE, (uint32 *) profile);
    SHR_IF_ERR_EXIT(dbal_entry_get(unit, entry_handle_id, DBAL_COMMIT));
 ...
 */
int
imb_ethu_internal_port_fc_rx_qmlf_profile_value_set(
    int unit,
    uint32 profile,
    dnx_rmc_thresholds_t profile_value)
{
    uint32 entry_handle_id;
    ...
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_NIF_FC_ETHU_RX_MLF_PER_PROFILE_RMC_THRESHOLD, &entry_handle_id));
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_PROFILE, profile);
    dbal_entry_value_field16_set(unit, entry_handle_id, DBAL_FIELD_PFC_THRESHOLD_SET, INST_SINGLE,
                                 profile_value.pfc_set_thresh);
    dbal_entry_value_field16_set(unit, entry_handle_id, DBAL_FIELD_PFC_THRESHOLD_CLR, INST_SINGLE,
                                 profile_value.pfc_clr_thresh);
    dbal_entry_value_field16_set(unit, entry_handle_id, DBAL_FIELD_LLFC_THRESHOLD_SET, INST_SINGLE,
                                 profile_value.llfc_set_thresh);
    dbal_entry_value_field16_set(unit, entry_handle_id, DBAL_FIELD_LLFC_THRESHOLD_CLR, INST_SINGLE,
                                 profile_value.llfc_clr_thresh);
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
 ...
 */
int
imb_ethu_internal_port_fc_rx_qmlf_profile_value_get(
    int unit,
    uint32 profile,
    dnx_rmc_thresholds_t * profile_value)
{
    ...
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_NIF_FC_ETHU_RX_MLF_PER_PROFILE_RMC_THRESHOLD, &entry_handle_id));
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_PROFILE, profile);
    dbal_value_field16_request(unit, entry_handle_id, DBAL_FIELD_PFC_THRESHOLD_SET, INST_SINGLE,
                               &profile_value->pfc_set_thresh);
    dbal_value_field16_request(unit, entry_handle_id, DBAL_FIELD_PFC_THRESHOLD_CLR, INST_SINGLE,
                               &profile_value->pfc_clr_thresh);
    dbal_value_field16_request(unit, entry_handle_id, DBAL_FIELD_LLFC_THRESHOLD_SET, INST_SINGLE,
                               &profile_value->llfc_set_thresh);
    dbal_value_field16_request(unit, entry_handle_id, DBAL_FIELD_LLFC_THRESHOLD_CLR, INST_SINGLE,
                               &profile_value->llfc_clr_thresh);
    SHR_IF_ERR_EXIT(dbal_entry_get(unit, entry_handle_id, DBAL_COMMIT));
    ...
    uint32 egq_priority)
{
    ...
    if (dnx_data_fc.general.feature_get(unit, dnx_data_fc_general_nif_pfc_bitmaps_e_f_support))
    {
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_BITMAP_TYPE_C_ENABLE, INST_SINGLE, 1);
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_BITMAP_TYPE_D_ENABLE, INST_SINGLE, 1);
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_BITMAP_TYPE_E_ENABLE, INST_SINGLE, 1);
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_BITMAP_TYPE_F_ENABLE, INST_SINGLE, 1);
    }
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
    ...
    int ethu_id_in_core)
{
    ...
    if (dnx_data_fc.general.feature_get(unit, dnx_data_fc_general_nif_pfc_bitmaps_e_f_support))
    {
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_BITMAP_TYPE_C_ENABLE, INST_SINGLE, 0);
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_BITMAP_TYPE_D_ENABLE, INST_SINGLE, 0);
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_BITMAP_TYPE_E_ENABLE, INST_SINGLE, 0);
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_BITMAP_TYPE_F_ENABLE, INST_SINGLE, 0);
    }
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
 ...
 */
int
imb_ethu_internal_pfc_mask_on_link_fail_enable_set(
    int unit,
    bcm_core_t core,
    int lane_in_core,
    uint32 enable)
{
    ...
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_NIF_FC_ETHU_PFC_MASK_ON_LINK_FAIL, &entry_handle_id));
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CORE_ID, core);
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_LANE_IN_CORE, lane_in_core);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_ENABLE, INST_SINGLE, enable);
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
    ...
    uint64 *count)
{
    ...
    /*
     * check if table requires core and set keys based on result
     */
    SHR_IF_ERR_EXIT(imb_ethu_dbal_key_exists_in_table
                    (unit, DBAL_TABLE_NIF_PRD_ETHU_COUNTERS, DBAL_FIELD_CORE_ID, &core_exists));
    if (core_exists)
    {
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CORE_ID, ethu_info.core);
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_ETHU, ethu_info.ethu_id_in_core);
...
/**
 * \brief - get fifo drop counter due to all possible reasons, per RMC
 *
 * \param [in] unit - chip unit id
    ...
    uint64 *count)
{
     ...
     * alloc DBAL table handle
     */
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_NIF_RX_FIFO_DROP_COUNTERS, &entry_handle_id));
    /*
     * check if table requires core and set keys based on result
     */
    SHR_IF_ERR_EXIT(imb_ethu_dbal_key_exists_in_table
                    (unit, DBAL_TABLE_NIF_RX_FIFO_DROP_COUNTERS, DBAL_FIELD_CORE_ID, &core_exists));
    if (core_exists)
    {
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CORE_ID, ethu_info.core);
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_ETHU, ethu_info.ethu_id_in_core);
     ...
     * request for value field
     */
    dbal_value_field64_request(unit, entry_handle_id, DBAL_FIELD_RX_FIFO_DROP_COUNTER, INST_SINGLE, count);
    /*
     * commit value
     */
    SHR_IF_ERR_EXIT(dbal_entry_get(unit, entry_handle_id, DBAL_COMMIT));
...
/**
 * \brief - Reset the port credit tx lane ctrl.
 *
 */
shr_error_e
    ...
    int in_reset)
{
    ...
    {
        SHR_IF_ERR_EXIT(dnx_algo_port_nif_phys_global_to_local_phy_get(unit, phy, &lane));
         ...
         * set value field 0
         */
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_CREDIT_RESET, INST_SINGLE, in_reset);
        /*
         * commit the value
         */
        SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
    ...
    bcm_port_t port)
{
    ...
    SHR_IF_ERR_EXIT(imb_ethu_dbal_key_exists_in_table
                    (unit, DBAL_TABLE_NIF_ETHU_TX_CREDIT_CTRL, DBAL_FIELD_CORE_ID, &exists));
    if (exists)
    {
        /*
         * set key fields
     ...
     */
    SHR_IF_ERR_EXIT(imb_ethu_port_tx_lane_ctrl_credit_reset(unit, port, 0));
    SHR_IF_ERR_EXIT(imb_ethu_port_tx_lane_ctrl_credit_reset(unit, port, 1));
    SHR_IF_ERR_EXIT(imb_ethu_port_tx_lane_ctrl_credit_reset(unit, port, 0));
    /*
     * Call this only when Macsec is not bypassed
     */
    ...
    uint32 enable)
{
     ...
     */
    SHR_IF_ERR_EXIT(imb_ethu_dbal_key_exists_in_table
                    (unit, DBAL_TABLE_NIF_PRD_ETHU_ENABLERS, DBAL_FIELD_CORE_ID, &core_exists));
    if (core_exists)
    {
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CORE_ID, ethu_info.core);
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_ETHU, ethu_info.ethu_id_in_core);
    ...
    uint32 *enable)
{
    ...
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_NIF_PRD_ETHU_ENABLERS, &entry_handle_id));
    /*
     * check if table requires core and set dbal key fields based on result
     */
    SHR_IF_ERR_EXIT(imb_ethu_dbal_key_exists_in_table
                    (unit, DBAL_TABLE_NIF_PRD_ETHU_ENABLERS, DBAL_FIELD_CORE_ID, &core_exists));
    if (core_exists)
    ...
    uint32 is_tdm)
{
     ...
     */
    SHR_IF_ERR_EXIT(imb_ethu_dbal_key_exists_in_table
                    (unit, DBAL_TABLE_NIF_PRD_ETHU_TM_PRIORITY_MAP, DBAL_FIELD_CORE_ID, &core_exists));
    if (core_exists)
    {
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CORE_ID, ethu_info.core);
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_ETHU, ethu_info.ethu_id_in_core);
    ...
    uint32 is_tdm)
{
     ...
     */
    SHR_IF_ERR_EXIT(imb_ethu_dbal_key_exists_in_table
                    (unit, DBAL_TABLE_NIF_PRD_ETHU_IP_PRIORITY_MAP, DBAL_FIELD_CORE_ID, &core_exists));
    if (core_exists)
    {
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CORE_ID, ethu_info.core);
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_ETHU, ethu_info.ethu_id_in_core);
    ...
    uint32 is_tdm)
{
     ...
     */
    SHR_IF_ERR_EXIT(imb_ethu_dbal_key_exists_in_table
                    (unit, DBAL_TABLE_NIF_PRD_ETHU_MPLS_PRIORITY_MAP, DBAL_FIELD_CORE_ID, &core_exists));
    if (core_exists)
    {
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CORE_ID, ethu_info.core);
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_ETHU, ethu_info.ethu_id_in_core);
    ...
    uint32 is_tdm)
{
     ...
     */
    SHR_IF_ERR_EXIT(imb_ethu_dbal_key_exists_in_table
                    (unit, DBAL_TABLE_NIF_PRD_ETHU_VLAN_PRIORITY_MAP, DBAL_FIELD_CORE_ID, &core_exists));
    if (core_exists)
    {
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CORE_ID, ethu_info.core);
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_ETHU, ethu_info.ethu_id_in_core);
    ...
    uint32 ether_type_val)
{
     ...
     */
    SHR_IF_ERR_EXIT(imb_ethu_dbal_key_exists_in_table
                    (unit, DBAL_TABLE_NIF_PRD_ETHU_CONFIGURABLE_ETHER_TYPE, DBAL_FIELD_CORE_ID, &core_exists));
    if (core_exists)
    {
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CORE_ID, ethu_info.core);
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_ETHU, ethu_info.ethu_id_in_core);
    ...
    uint32 offset_base)
{
     ...
     * alloc DBAL table handle
     */
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_NIF_PRD_ETHU_TCAM_KEY_OFFSET_BASE, &entry_handle_id));
    /*
     * check if table requires core and set keys based on result
     */
    SHR_IF_ERR_EXIT(imb_ethu_dbal_key_exists_in_table
                    (unit, DBAL_TABLE_NIF_PRD_ETHU_TCAM_KEY_OFFSET_BASE, DBAL_FIELD_CORE_ID, &core_exists));
    if (core_exists)
    {
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CORE_ID, ethu_info.core);
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_ETHU, ethu_info.ethu_id_in_core);
    ...
    uint32 ether_type_size)
{
     ...
     * alloc DBAL table handle
     */
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_NIF_PRD_ETHU_ETHER_TYPE_CODE_HEADER_SIZE, &entry_handle_id));
    /*
     * check if table requires core and set keys based on result
     */
    SHR_IF_ERR_EXIT(imb_ethu_dbal_key_exists_in_table
                    (unit, DBAL_TABLE_NIF_PRD_ETHU_ETHER_TYPE_CODE_HEADER_SIZE, DBAL_FIELD_CORE_ID, &core_exists));
    if (core_exists)
    {
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CORE_ID, ethu_info.core);
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_ETHU, ethu_info.ethu_id_in_core);
    ...
    uint32 offset_value)
{
    ...
    /*
     * check if core field exists and set key fields
     */
    SHR_IF_ERR_EXIT(imb_ethu_dbal_key_exists_in_table
                    (unit, DBAL_TABLE_NIF_PRD_ETHU_TCAM_KEY, DBAL_FIELD_CORE_ID, &core_exists));
    if (core_exists)
    {
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CORE_ID, ethu_info.core);
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_ETHU, ethu_info.ethu_id_in_core);
    ...
    const dnx_cosq_prd_tcam_entry_info_t * entry_info)
{
     ...
     */
    SHR_IF_ERR_EXIT(imb_ethu_dbal_key_exists_in_table
                    (unit, DBAL_TABLE_NIF_PRD_ETHU_TCAM, DBAL_FIELD_CORE_ID, &core_exists));
    if (core_exists)
    {
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CORE_ID, ethu_info.core);
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_ETHU, ethu_info.ethu_id_in_core);
    ...
    const bcm_cosq_ingress_drop_control_frame_config_t * control_frame_config)
{
     ...
     */
    SHR_IF_ERR_EXIT(imb_ethu_dbal_key_exists_in_table
                    (unit, DBAL_TABLE_NIF_PRD_ETHU_CONTROL_FRAME, DBAL_FIELD_CORE_ID, &core_exists));
    if (core_exists)
    {
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CORE_ID, ethu_info.core);
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_ETHU, ethu_info.ethu_id_in_core);
    ...
    const bcm_cosq_ingress_port_drop_mpls_special_label_config_t * label_config)
{
     ...
     */
    SHR_IF_ERR_EXIT(imb_ethu_dbal_key_exists_in_table
                    (unit, DBAL_TABLE_NIF_PRD_ETHU_MPLS_SPECIAL_LABEL, DBAL_FIELD_CORE_ID, &core_exists));
    if (core_exists)
    {
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CORE_ID, ethu_info.core);
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_ETHU, ethu_info.ethu_id_in_core);
    ...
    uint32 tpid_value)
{
    ...
    /*
     * check if table requires core
     */
    SHR_IF_ERR_EXIT(imb_ethu_dbal_key_exists_in_table
                    (unit, DBAL_TABLE_NIF_PRD_ETHU_TPID, DBAL_FIELD_CORE_ID, &core_exists));
    ...
    uint32 ignore_ip_dscp)
{
     ...
     */
    SHR_IF_ERR_EXIT(imb_ethu_dbal_key_exists_in_table
                    (unit, DBAL_TABLE_NIF_PRD_ETHU_PORT_PROPERTIES, DBAL_FIELD_CORE_ID, &core_exists));
    /*
     * set key fields
     */
    if (core_exists)
    ...
    uint32 dp_offset)
{
     ...
     */
    SHR_IF_ERR_EXIT(imb_ethu_dbal_key_exists_in_table
                    (unit, DBAL_TABLE_NIF_PRD_ETHU_HARD_STAGE_CTRL, DBAL_FIELD_CORE_ID, &core_exists));
    if (core_exists)
    {
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CORE_ID, ethu_info.core);
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_ETHU, ethu_info.ethu_id_in_core);
...
*/
int
imb_ethu_internal_instru_traffic_pfc_deadlock_counters_reset(
    int unit,
    bcm_core_t core,
    uint32 lane_in_core,
    int reset_traffic,
    int reset_pfc)
{
    ...
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_NIF_ETHU_INSTRU_TRAFFIC_PFC_CNTS_RESET, &entry_handle_id));
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CORE_ID, core);
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_LANE_IN_CORE, lane_in_core);
    if (reset_traffic)
    {
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_RESET_CNTS_TRAFFIC, INST_SINGLE, 0);
    }
    if (reset_pfc)
    {
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_RESET_CNTS_PFC, INST_SINGLE, 0);
    }
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
    /** Take out of reset */
    if (reset_traffic)
    {
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_RESET_CNTS_TRAFFIC, INST_SINGLE, 1);
    }
    if (reset_pfc)
    {
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_RESET_CNTS_PFC, INST_SINGLE, 1);
    }
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
...
*/
int
imb_ethu_internal_instru_synced_counters_config_set(
    int unit,
    bcm_core_t core,
    int ethu_in_core,
    uint8 nof_intervals,
    uint8 is_continuous)
{
    ...
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_NIF_ETHU_INSTRU_CONFIG, &entry_handle_id));
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CORE_ID, core);
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_ETHU_ID, ethu_in_core);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_NOF_INTERVALS, INST_SINGLE, nof_intervals);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_IS_CONTINUOUS, INST_SINGLE, is_continuous);
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
...
/**
* \brief - Get per IMB instrumentation sync counters last written record index
*
* see .h file
*/
int
imb_ethu_internal_instru_synced_counters_last_write_get(
    int unit,
    bcm_core_t core,
    int ethu_in_core,
    uint32 *last_write,
    uint32 *nof_writes)
{
    ...
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_NIF_ETHU_INSTRU_LAST_COUNT_NIF, &entry_handle_id));
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CORE_ID, core);
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_ETHU_ID, ethu_in_core);
    dbal_value_field32_request(unit, entry_handle_id, DBAL_FIELD_LAST_WRITE, INST_SINGLE, last_write);
    dbal_value_field32_request(unit, entry_handle_id, DBAL_FIELD_NOF_WRITES, INST_SINGLE, nof_writes);
    SHR_IF_ERR_EXIT(dbal_entry_get(unit, entry_handle_id, DBAL_COMMIT));
...
*/
int
imb_ethu_internal_instru_synced_counters_per_record_get(
    int unit,
    bcm_core_t core,
    int ethu_in_core,
    int port_in_ethu,
    ...
    uint64 counter_values[])
{
    ...
    switch (imb_type)
    {
        ...
        {
            dbal_table = DBAL_TABLE_NIF_INST_SYNCED_COUNTERS_RECORDS_NIF_CDU;
            break;
        }
        case imbDispatchTypeImb_clu:
        {
            dbal_table = DBAL_TABLE_NIF_INST_SYNCED_COUNTERS_RECORDS_NIF_CLU;
            break;
        }
        default:
        {
            SHR_ERR_EXIT(_SHR_E_INTERNAL, "port has imb_type %d, neither CDU nor CLU.\n", imb_type);
        }
    }

    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, dbal_table, &entry_handle_id));
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CORE_ID, core);
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_ETHU, ethu_in_core);
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_PHYS_PORT_IN_ETHU, port_in_ethu);
...
/**
* \brief - Get from HW the current PFC duration for the specified port
*
* see .h file
*/
int
imb_ethu_internal_pfc_deadlock_current_duration_get(
    int unit,
    int lane_in_core,
    bcm_core_t core,
    int pfc,
    uint32 *duration)
{
    ...
    /** Get from HW the current PFC duration for the specified port */
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_NIF_ETHU_INSTRU_PFC_DURATION_DEBUG, &entry_handle_id));
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CORE_ID, core);
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_NIF_PRIORITY, pfc);
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_LANE_IN_CORE, lane_in_core);
    dbal_value_field_arr32_request(unit, entry_handle_id, DBAL_FIELD_DURATION, INST_SINGLE, duration);
    SHR_IF_ERR_EXIT(dbal_entry_get(unit, entry_handle_id, DBAL_COMMIT));
    ...
    int power_down)
{
    ...
    SHR_IF_ERR_EXIT(imb_ethu_dbal_key_exists_in_table
                    (unit, DBAL_TABLE_NIF_ETHU_POWER_DOWN, DBAL_FIELD_CORE_ID, &exists));
    if (exists)
    {
        /*
         * set key fields
         */
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_CORE_ID, ethu_info->core);
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_ETHU_ID, ethu_info->ethu_id_in_core);
    }
    else
    {
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_GLOBAL_ETHU, ethu_info->ethu_id);
 ...
 */
int
imb_ethu_prd_port_last_packet_priority_tdm_hw_get(
    int unit,
    dnx_algo_port_ethu_access_info_t ethu_info,
    uint32 *priority,
    uint32 *tdm,
    uint32 *valid)
{
     ...
     * alloc DBAL table handle
     */
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_NIF_PRD_ETHU_LAST_RECEIVED_PACKET, &entry_handle_id));

    SHR_IF_ERR_EXIT(imb_ethu_dbal_key_exists_in_table
                    (unit, DBAL_TABLE_NIF_PRD_ETHU_LAST_RECEIVED_PACKET, DBAL_FIELD_CORE_ID, &exists));
    if (exists)
    {
        /*
         * set key fields
