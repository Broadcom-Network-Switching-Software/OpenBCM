...
/**
* \brief
*   Extract engine address. read the parameters from sw state
* \par DIRECT INPUT:
*   \param [in] unit        -  unit-id
*   \param [in] database    -  database ID
*   \param [in] counter_id  -  counter ID
*   \param [out] engine     -  engine ID
*   \param [out] engine_address  -  engine address
* \par INDIRECT INPUT:
*   * None
* \par DIRECT OUTPUT:
*   shr_error_e -
...
*   * None
*/
shr_error_e dnx_crps_engine_address_get(
    int unit,
