    ...
    bcm_ppp_initiator_t * info)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_ppp_initiator_create_verify(unit, info));
    ...
    bcm_ppp_initiator_t * info)
{
    ...
    /** Verification */
    SHR_INVOKE_VERIFY_DNXC(dnx_ppp_initiator_get_verify(unit, info));
    ...
    bcm_ppp_initiator_t * info)
{
    ...
    /** Verification */
    SHR_INVOKE_VERIFY_DNXC(dnx_ppp_initiator_delete_verify(unit, info));
    ...
    void *user_data)
{
    ...
    DBAL_FUNC_INIT_VARS(unit);
    DNX_ERR_RECOVERY_START(unit);
    SHR_INVOKE_VERIFY_DNXC(dnx_ppp_initiator_traverse_verify(unit, additional_info, cb, user_data));
