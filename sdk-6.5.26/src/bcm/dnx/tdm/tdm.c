...
{
    int ii = 0;
    uint32 is_ftmh_unset_hw_context_id[3][3] = {
        {DBAL_FIELD_TRAP_CONTEXT_TDM_STAMP_MC_CUD, DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_TM___TDM_STAMP_MC_CUD_ON_OTMH, 0},
        {DBAL_FIELD_TRAP_CONTEXT_TDM_STAMP_PORT_VAL, DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_TM___TDM_STAMP_PORT_VAL_ON_OTMH, 0},
        {DBAL_FIELD_TRAP_CONTEXT_TDM_STAMP_NOTHING, DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_TM___TDM_STAMP_NOTHING_ON_OTMH, 0}
    };
    uint32 is_ftmh_set_is_opt_unset_hw_context_id[3][3] = {
        {DBAL_FIELD_TRAP_CONTEXT_TDM_STAMP_MC_CUD, DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_TM___TDM_STAMP_MC_CUD_ON_FTMH, 0},
        {DBAL_FIELD_TRAP_CONTEXT_TDM_STAMP_PORT_VAL, DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_TM___TDM_STAMP_PORT_VAL_ON_FTMH, 0},
        {DBAL_FIELD_TRAP_CONTEXT_TDM_STAMP_NOTHING, DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_TM___TDM_STAMP_NOTHING_ON_FTMH, 0}
    };
    uint32 is_ftmh_set_is_opt_set_hw_context_id[3][3] = {
        {DBAL_FIELD_TRAP_CONTEXT_TDM_STAMP_MC_CUD, DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_TM___TDM_STAMP_MC_CUD_ON_OPT_FTMH, 0},
        {DBAL_FIELD_TRAP_CONTEXT_TDM_STAMP_PORT_VAL, DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_TM___TDM_STAMP_PORT_VAL_ON_OPT_FTMH,
         0},
        {DBAL_FIELD_TRAP_CONTEXT_TDM_STAMP_NOTHING, DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_TM___TDM_STAMP_NOTHING_ON_OPT_FTMH, 0}
    };
    ...
    int dbal_field_idx = 0, context_id_idx = 1, hw_value_idx = 2;
    int sys_mc_entry_is_valid = 0;
    ...
    for (ii = 0; ii < 3; ii++)
    {
        SHR_IF_ERR_EXIT(dbal_fields_enum_hw_value_get(unit, DBAL_FIELD_TRAP_CONTEXT_ID,
                                                      is_ftmh_unset_hw_context_id[ii][context_id_idx],
                                                      &is_ftmh_unset_hw_context_id[ii][hw_value_idx]));
        SHR_IF_ERR_EXIT(dbal_fields_enum_hw_value_get(unit, DBAL_FIELD_TRAP_CONTEXT_ID,
                                                      is_ftmh_set_is_opt_unset_hw_context_id[ii][context_id_idx],
                                                      &is_ftmh_set_is_opt_unset_hw_context_id[ii][hw_value_idx]));
        SHR_IF_ERR_EXIT(dbal_fields_enum_hw_value_get(unit, DBAL_FIELD_TRAP_CONTEXT_ID,
                                                      is_ftmh_set_is_opt_set_hw_context_id[ii][context_id_idx],
                                                      &is_ftmh_set_is_opt_set_hw_context_id[ii][hw_value_idx]));
    }
    ...
    for (ii = 0; ii < 3; ii++)
    {
        ...
        {
            dbal_entry_value_field32_set(unit, entry_handle_id, is_ftmh_unset_hw_context_id[ii][dbal_field_idx],
                                         INST_SINGLE, is_ftmh_unset_hw_context_id[ii][hw_value_idx]);
            sys_mc_entry_is_valid = 1;
        }
        else if (is_ftmh_set_is_opt_unset_enable)
        {
            dbal_entry_value_field32_set(unit, entry_handle_id,
                                         is_ftmh_set_is_opt_unset_hw_context_id[ii][dbal_field_idx], INST_SINGLE,
                                         is_ftmh_set_is_opt_unset_hw_context_id[ii][hw_value_idx]);
        }
        else if (is_ftmh_set_is_opt_set_enable)
        {
            dbal_entry_value_field32_set(unit, entry_handle_id,
                                         is_ftmh_set_is_opt_set_hw_context_id[ii][dbal_field_idx], INST_SINGLE,
                                         is_ftmh_set_is_opt_set_hw_context_id[ii][hw_value_idx]);
        }
    }
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_SYSTEM_MC_VALID, INST_SINGLE, sys_mc_entry_is_valid);
    ...
    int enable)
{
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_TDM_BYPASS_EN, INST_SINGLE, TRUE);
    if (dnx_data_tdm.params.feature_get(unit, dnx_data_tdm_params_is_egress_bypass_supported))
    {
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_TDM_SAR_EGRESS_BYPASS_EN, INST_SINGLE,
    ...
    int unit)
{
    ...
    /*
     * If the device supports multi flexe mode, TDM cannot coexist with FlexE when
     * FlexE is enabled.
     */
