...
/* Terminator traverse struct, holds both the user data and the legacy api user defined cb */
typedef struct
{
    void *user_data;
    bcm_tunnel_terminator_traverse_cb tunnel_cb;
} dnx_tunnel_terminator_port_flow_user_data_t;

/* Terminator config traverse struct, holds both the user data and the legacy api user defined cb */
typedef struct
{
    void *user_data;
    bcm_tunnel_terminator_config_traverse_cb tunnel_cb;
} dnx_tunnel_terminator_config_flow_user_data_t;
    ...
    bcm_gport_t * flow_lif_gport)
{
    ...
    SHR_IF_ERR_EXIT(algo_gpm_gport_flow_convert
                    (unit, tunnel_gport, BCM_GPORT_TYPE_FLOW_LIF, DNX_ALGO_GPM_CONVERSION_FLAG_FLOW_TERMINATOR,
                     flow_lif_gport));
exit:
    SHR_FUNC_EXIT;
}
...
static void
dnx_tunnel_term_flow_match_bud_flow_flag_set(
    bcm_tunnel_terminator_t * tunnel,
    uint32 *flow_flags)
{
    if (_SHR_IS_FLAG_SET(tunnel->flags, BCM_TUNNEL_TERM_BUD))
    {
        *flow_flags |= BCM_FLOW_HANDLE_INFO_BUD;
    }
    ...
    bcm_gport_t * flow_id)
{
    ...
    dnx_tunnel_term_flow_match_bud_flow_flag_set(tunnel, &(flow_handle_info.flags));
    ...
    bcm_flow_handle_info_t * flow_handle_info)
{
    ...
    if (tunnel->flags & BCM_TUNNEL_TERM_TUNNEL_WITH_ID)
    {
        ...
        SHR_IF_ERR_EXIT(algo_gpm_gport_flow_convert
                        (unit, tunnel->tunnel_id, BCM_GPORT_TYPE_FLOW_LIF,
...
static void
dnx_tunnel_term_get_flow_lif_bcm_struct_fill_default_vrf(
    int unit,
    bcm_tunnel_terminator_t * tunnel,
    bcm_flow_terminator_info_t * flow_tunnel_term)
{
...
static void
dnx_tunnel_term_get_flow_lif_bcm_struct_fill_vlan(
    int unit,
    bcm_tunnel_terminator_t * tunnel,
    bcm_flow_terminator_info_t * flow_tunnel_term)
{
    ...
    {
        if (_SHR_IS_FLAG_SET(flow_tunnel_term->valid_elements_set, BCM_FLOW_TERMINATOR_ELEMENT_VSI_VALID))
        {
            tunnel->vlan = flow_tunnel_term->vsi;
        }
    }
}

static void
dnx_tunnel_term_get_flow_lif_bcm_struct_fill_stat_enable(
    int unit,
    bcm_tunnel_terminator_t * tunnel,
    bcm_flow_terminator_info_t * flow_tunnel_term)
{
...
static void
dnx_tunnel_term_get_flow_lif_bcm_struct_fill_wide_flag(
    int unit,
    bcm_tunnel_terminator_t * tunnel,
    bcm_flow_terminator_info_t * flow_tunnel_term)
{
...
static shr_error_e
dnx_tunnel_term_get_flow_lif_bcm_struct_fill(
    int unit,
    bcm_gport_t flow_id,
    bcm_tunnel_terminator_t * tunnel)
{
    ...
    dnx_tunnel_term_get_flow_lif_bcm_struct_fill_default_vrf(unit, tunnel, &flow_tunnel_term);
    dnx_tunnel_term_get_flow_lif_bcm_struct_fill_vlan(unit, tunnel, &flow_tunnel_term);
    dnx_tunnel_term_get_flow_lif_bcm_struct_fill_stat_enable(unit, tunnel, &flow_tunnel_term);
    dnx_tunnel_term_get_flow_lif_bcm_struct_fill_wide_flag(unit, tunnel, &flow_tunnel_term);
    ...
    bcm_tunnel_terminator_t * tunnel)
{
    ...
    SHR_IF_ERR_EXIT(dnx_tunnel_term_get_flow_lif_bcm_struct_fill(unit, flow_id, tunnel));
exit:
    SHR_FUNC_EXIT;
}
    ...
    bcm_gport_t flow_id)
{
    ...
    flow_handle_info.flow_handle = flow_handle;
    SHR_IF_ERR_EXIT(algo_gpm_gport_flow_convert
                    (unit, flow_id, BCM_GPORT_TYPE_FLOW_LIF, DNX_ALGO_GPM_CONVERSION_FLAG_FLOW_TERMINATOR,
