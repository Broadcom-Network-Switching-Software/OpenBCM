    ...
    uint32 selectable_result_types)
{
    ...
    SHR_IF_ERR_EXIT(dnx_flow_lif_mgmt_set_hw
                    (unit, _SHR_CORE_ALL, FALSE, logical_phase, dbal_table_id, entry_handle_id, selected_result_type, 0,
                     local_lif_id, FALSE));
    ...
    dnx_flow_app_config_t * flow_app_info)
{
    ...
    else if (flow_app_info->flow_app_type == FLOW_APP_TYPE_TERM)
    {
        ...
        /** Get physical table id */
        SHR_IF_ERR_EXIT(dbal_tables_physical_table_get
                        (unit, gport_hw_resources->outlif_dbal_table_id, DBAL_PHY_DB_DEFAULT_INDEX,
                         &physical_table_id));
    ...
    int *local_lif_id)
{
    ...
    SHR_IF_ERR_EXIT(dnx_lif_mngr_outlif_sw_info_get
                    (unit, curr_local_lif_id, NULL, &existing_result_type, NULL, NULL, &existing_result_type_has_ll,
                     NULL));
