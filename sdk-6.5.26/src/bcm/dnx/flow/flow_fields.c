    ...
    bcm_flow_service_type_t service_type)
{
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_SERVICE_TYPE, INST_SINGLE, vtt_lif_service_type);
...
const dnx_flow_common_field_desc_t dnx_flow_common_field_l2_egress_info = {
     ...
     * field_cbs
     */
    {dnx_flow_common_field_empty_set, dnx_flow_common_field_empty_get, NULL, NULL},
    /*
     * field_print
     */
    flow_field_l2_egress_info_print_cb
    ...
    char *print_string)
{
    ...
    return sal_snprintf(print_string, FLOW_STR_MAX, "outlif_profile_group = 0x%x, egress_network_group_id = 0x%x",
                        initiator_info->outlif_profile_group, initiator_info->l2_egress_info.egress_network_group_id);
}

const char *
field_desc_oam_pcp_cb(
    int unit)
{
    return "OAM PCP";
}
    ...
    void *field_data)
{
    ...
    out_lif_profile_info.oam_lif_profile = initiator_info->outlif_profile_group;        /* oam_priority_map_profile */
    ...
    void *field_data)
{
    ...
    initiator_info->outlif_profile_group = out_lif_profile_info.oam_lif_profile;
    DNX_QOS_OAM_PCP_MAP_SET(initiator_info->outlif_profile_group);
    DNX_QOS_EGRESS_MAP_SET(initiator_info->outlif_profile_group);

exit:
    SHR_FUNC_EXIT;
}

const dnx_flow_common_field_desc_t dnx_flow_common_field_oam_pcp = {
    /*
     * field_name
     */
    "OAM_PCP",
     ...
     * field_cbs
     */
    {dnx_flow_field_oam_pcp_set, dnx_flow_field_oam_pcp_get, NULL, NULL},
    /*
     * field_print
     */
    flow_field_oam_pcp_print_cb
...
const dnx_flow_common_field_desc_t dnx_flow_common_field_outlif_group = {
     ...
     * field_cbs
     */
    {dnx_flow_common_field_empty_set, dnx_flow_field_outlif_group_get, NULL, NULL},
    /*
     * field_print
     */
    flow_field_outlif_group_print_cb
    ...
    char *print_string)
{
    ...
    return sal_snprintf(print_string, FLOW_STR_MAX,
                        "dest port = 0x%x, encap_id = 0x%x, encap_id = 0x%x, flags = 0x%x, learn_strength = 0x%x",
...
const dnx_flow_common_field_desc_t dnx_flow_common_field_init_tpid_class_id = {
     ...
     * field_cbs
     */
    {dnx_flow_field_init_tpid_class_id_set, dnx_flow_field_init_tpid_class_id_get, NULL, NULL},
    /*
     * field_print
     */
    flow_field_init_tpid_class_id_print_cb
