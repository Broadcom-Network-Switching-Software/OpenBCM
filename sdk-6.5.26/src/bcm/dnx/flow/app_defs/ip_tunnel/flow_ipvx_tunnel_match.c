...
static shr_error_e
flow_ipvx_tunnel_term_match_tunnel_type_from_special_fields_get(
    int unit,
    bcm_flow_special_fields_t * special_fields,
    uint8 is_ipv4,
...
{
    bcm_flow_special_field_t special_field_data;
    flow_special_fields_e tunnel_type_special_field_e =
        (is_ipv4 ? FLOW_S_F_IPV4_TUNNEL_TYPE : FLOW_S_F_IPV6_TUNNEL_TYPE);
    SHR_FUNC_INIT_VARS(unit);
    sal_memset(&special_field_data, 0, sizeof(bcm_flow_special_field_t));
    SHR_IF_ERR_EXIT(dnx_flow_special_field_data_get
                    (unit, special_fields, tunnel_type_special_field_e, &special_field_data));
...
static shr_error_e
flow_ipv4_tunnel_term_match_tunnel_type_from_special_fields_get(
    int unit,
    bcm_flow_special_fields_t * special_fields,
    bcm_tunnel_type_t * tunnel_type)
{
    uint8 is_ipv4 = TRUE;
    SHR_FUNC_INIT_VARS(unit);
    SHR_IF_ERR_EXIT(flow_ipvx_tunnel_term_match_tunnel_type_from_special_fields_get
                    (unit, special_fields, is_ipv4, tunnel_type));
exit:
    SHR_FUNC_EXIT;
}
...
/*
static shr_error_e
flow_ipv6_tunnel_term_match_tunnel_type_from_special_fields_get(
        int unit,
        bcm_flow_special_fields_t * special_fields,
        bcm_tunnel_type_t * tunnel_type)
{
    uint8 is_ipv4 = FALSE;
    SHR_FUNC_INIT_VARS(unit);
    SHR_IF_ERR_EXIT(flow_ipvx_tunnel_term_match_tunnel_type_from_special_fields_get(unit, special_fields, is_ipv4, tunnel_type));
exit:
    SHR_FUNC_EXIT;
}
*/
    ...
    bcm_flow_special_fields_t * special_fields)
{
    ...
    SHR_IF_ERR_EXIT(flow_ipv4_tunnel_term_match_tunnel_type_from_special_fields_get(unit, special_fields, &info.type));
