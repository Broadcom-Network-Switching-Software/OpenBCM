...
const flow_special_field_info_t flow_special_fields_db[NOF_FLOW_SPECIAL_FIELDS+1] = {
    ...
    {"IPVX_TUNNEL_TYPE",            FLOW_S_F_UNMAPPED,                      FLOW_PAYLOAD_TYPE_BCM_ENUM,         FLOW_S_FIELD_UNLINKED,   flow_special_field_ipvx_tunnel_desc, flow_special_field_ipvx_tunnel_print,  (FLOW_S_FIELD_LIF_SHOULD_BE_IGNORED | FLOW_S_FIELD_IS_LIF_MANDATORY | FLOW_S_FIELD_IS_LIF_UNCHANGEABLE), NULL, NULL, NULL, NULL, NULL},
    ...
    {"OUT_LIF_MATCH",               DBAL_FIELD_OUT_LIF,                     FLOW_PAYLOAD_TYPE_UINT32,           FLOW_S_FIELD_UNLINKED,  NULL,               NULL,           (FLOW_S_FIELD_VIRTUAL_MATCH_KEY | FLOW_S_FIELD_IS_LIF_MANDATORY),   flow_special_field_outlif_match_set, flow_special_field_outlif_match_get, NULL, NULL, NULL},
    ...
    {"SRC_ENCAP_ID_MATCH",          DBAL_FIELD_GLOB_IN_LIF,                 FLOW_PAYLOAD_TYPE_UINT32,           FLOW_S_FIELD_UNLINKED,  NULL,               NULL,           (FLOW_S_FIELD_VIRTUAL_MATCH_KEY | FLOW_S_FIELD_IS_LIF_MANDATORY),   FLOW_S_FIELD_NO_MAPPING_CBS},
    ...
    {"NATIVE_INDEX_MODE",           FLOW_S_F_UNMAPPED,                      FLOW_PAYLOAD_TYPE_UINT32,           FLOW_S_FIELD_UNLINKED,     NULL,                   NULL, FLOW_S_FIELD_SHOULD_BE_IGNORED, NULL, NULL, NULL, NULL, NULL},
    ...
    bcm_flow_special_fields_t * special_fields)
{
    ...
    if (!dnx_data_tunnel.tunnel_type.udp_tunnel_type_get(unit))
    {
        ...
        dnx_tunnel_term_ipv6_tcam_table_key_t tcam_table_key = { 0 };
