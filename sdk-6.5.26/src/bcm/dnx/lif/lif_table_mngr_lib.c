 ...
 * Note: Parend and Child fields should have the same arrtibutes. 
 */
/* *INDENT-OFF* */
static const lif_table_manager_field_actions_default_t lif_table_manager_field_actions_default[] = {
    ...
    {DBAL_FIELD_RCH_QOS_MODEL,                 SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    ...
    {DBAL_FIELD_OUTLIF_0_PUSHED_TO_STACK,      SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    {DBAL_FIELD_SERVICE_TYPE_IS_P2P,           SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    ...
    {DBAL_FIELD_HAS_DIP_LL,                    SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    /** End of ETPS_SRV6 table fields */

    /** ETPS_MPLS_IFIT table fields */
    {DBAL_FIELD_FIH_TYPE,                      SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    {DBAL_FIELD_FII_TC,                        SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    {DBAL_FIELD_FII_BOS,                       SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    {DBAL_FIELD_FII_TTL,                       SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    {DBAL_FIELD_FLOW_ID_BASIC,                 SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    {DBAL_FIELD_FLOW_ID_EXT,                   SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    {DBAL_FIELD_DIP_MASK,                      SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    {DBAL_FIELD_SIP_MASK,                      SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    {DBAL_FIELD_FIEH_EXT_DATA,                 SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    /** End of ETPS_MPLS_IFIT table fields */

    /** ETPS_BIER_BASE table fields */         
    {DBAL_FIELD_BIER_BSL,                      SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    {DBAL_FIELD_BIER_BFIR_ID,                  SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    {DBAL_FIELD_BIER_RSV,                      SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    {DBAL_FIELD_BIER_OAM,                      SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    {DBAL_FIELD_BFR_BIT_STR,                   SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    /** End of ETPS_BIER_BASE table fields */

    {DBAL_FIELD_MEMBER_LINK_ID,                SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    ...
    {DBAL_FIELD_PROPAGATION_PROFILE,              SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    ...
    {DBAL_FIELD_IPV6_DIP,                      SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  FALSE},
    {DBAL_FIELD_SFLOW_DATA,                    SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    {DBAL_FIELD_SRV6_SEGMENT_ID,               SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    ...
    {DBAL_FIELD_FWD_DOMAIN_NWK_NAME,           SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    {DBAL_FIELD_GTP_EXT_HEADER_TYPE,           SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    {DBAL_FIELD_GTP_EXT_SSN_TYPE,              SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    {DBAL_FIELD_GTP_EXT_SSN_RQI,               SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    /** These fields are set by the value given by the user. */
    ...
    {DBAL_FIELD_VLAN_EDIT_PCP_DEI_PROFILE,     SET_ACTION_USE_VALUE,        UNSET_ACTION_IGNORE,         TRUE,  TRUE},
    {DBAL_FIELD_OUT_LIF_PROFILE,               SET_ACTION_USE_VALUE,        UNSET_ACTION_IGNORE,         TRUE,  TRUE},
    ...
    {DBAL_FIELD_TEID,                          SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE, TRUE},
    /** ETC */
};
/* *INDENT-ON* */
 ...
 * Note: Parend and Child fields should have the same arrtibutes per DBAL table.
 */
/* *INDENT-OFF* */
static const lif_table_manager_field_actions_per_table_t lif_table_manager_field_actions_per_table[] = {
    ...
    {DBAL_TABLE_IN_LIF_IPvX_TUNNELS, DBAL_FIELD_LIF_GENERIC_DATA_0,SET_ACTION_USE_VALUE,      UNSET_ACTION_IGNORE,         TRUE,  TRUE},
    {DBAL_TABLE_IN_LIF_IPvX_TUNNELS, DBAL_FIELD_LIF_GENERIC_DATA_1,SET_ACTION_USE_VALUE,      UNSET_ACTION_IGNORE,         TRUE,  TRUE},
    ...
    {DBAL_TABLE_IN_LIF_IPvX_TUNNELS, DBAL_FIELD_LEARN_PAYLOAD_CONTEXT,
                                                                 SET_ACTION_USE_VALUE,        UNSET_ACTION_IGNORE,         TRUE,  TRUE},
    {DBAL_TABLE_IN_LIF_IPvX_TUNNELS, DBAL_FIELD_PROPAGATION_PROFILE,SET_ACTION_USE_VALUE,        UNSET_ACTION_IGNORE,         TRUE,  TRUE},
    ...
    {DBAL_TABLE_IN_AC_INFO_DB,       DBAL_FIELD_LEARN_INFO,      SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    ...
    {DBAL_TABLE_IN_LIF_FORMAT_SRV6_TERMINATED,  DBAL_FIELD_GLOB_OUT_LIF,
                                                                 SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    {DBAL_TABLE_IN_LIF_FORMAT_SRV6_TERMINATED,  DBAL_FIELD_DESTINATION,
                                                                 SET_ACTION_USE_VALUE,        UNSET_ACTION_IGNORE,         TRUE,  TRUE},
    ...
    {DBAL_TABLE_IN_LIF_FORMAT_L2TP,  DBAL_FIELD_PROPAGATION_PROFILE,SET_ACTION_USE_VALUE,        UNSET_ACTION_IGNORE,         TRUE,  TRUE},
    ...
    {DBAL_TABLE_IN_LIF_FORMAT_GTP,   DBAL_FIELD_GLOB_OUT_LIF,    SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    {DBAL_TABLE_IN_LIF_FORMAT_GTP,   DBAL_FIELD_FODO,            SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    {DBAL_TABLE_IN_LIF_FORMAT_GTP,   DBAL_FIELD_DESTINATION,     SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    {DBAL_TABLE_IN_LIF_FORMAT_GTP,   DBAL_FIELD_ACTION_PROFILE_IDX,
                                                                 SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    {DBAL_TABLE_IN_LIF_FORMAT_GTP,   DBAL_FIELD_STAT_OBJECT_ID,  SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    {DBAL_TABLE_IN_LIF_FORMAT_GTP,   DBAL_FIELD_STAT_OBJECT_CMD, SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    ...
    {DBAL_TABLE_EEDB_LAWFUL_INTERCEPT, DBAL_FIELD_LI_CONTENT_ID,   SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    {DBAL_TABLE_EEDB_LAWFUL_INTERCEPT, DBAL_FIELD_RAW_DATA_SIZE,   SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    ...
    {DBAL_TABLE_PON_DTC_CLASSIFICATION, DBAL_FIELD_LEARN_INFO,   SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},

    {DBAL_TABLE_EEDB_OAM_REFLECTOR,     DBAL_FIELD_RAW_DATA,     SET_ACTION_USE_VALUE,        UNSET_ACTION_IGNORE,         TRUE,  TRUE},

    {DBAL_TABLE_EEDB_DATA_IPFIX_CODE,       DBAL_FIELD_DATA_ENTRY_2B_RESERVED,      SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    {DBAL_TABLE_EEDB_DATA_IPFIX_CODE,       DBAL_FIELD_EGRESS_FWD_CODE,             SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    {DBAL_TABLE_EEDB_SRV6_DATA_SID,         DBAL_FIELD_DATA_ENTRY_2B_RESERVED,      SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    {DBAL_TABLE_EEDB_SRV6_DATA_SID,         DBAL_FIELD_SRV6_SEGMENT_ID,             SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    {DBAL_TABLE_EEDB_SFLOW_DATA,            DBAL_FIELD_DATA_ENTRY_2B_RESERVED,      SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    {DBAL_TABLE_EEDB_SFLOW_DATA,            DBAL_FIELD_SFLOW_DATA,                  SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    {DBAL_TABLE_EEDB_IPV6_DATA_DIP,         DBAL_FIELD_DATA_ENTRY_2B_RESERVED,      SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    {DBAL_TABLE_EEDB_IPV6_DATA_DIP,         DBAL_FIELD_IPV6_DIP,                    SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    {DBAL_TABLE_EEDB_BIER_DATA_BFR_BITSTR,  DBAL_FIELD_DATA_ENTRY_2B_RESERVED,      SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
    {DBAL_TABLE_EEDB_BIER_DATA_BFR_BITSTR,  DBAL_FIELD_BFR_BIT_STR,                 SET_ACTION_USE_VALUE,        UNSET_ACTION_SET_TO_DEFAULT, TRUE,  TRUE},
...
/*
 * Replace the result type of a local inlif
 */
shr_error_e
    ...
    uint8 entry_reuse)
{
    ...
    outlif_info.logical_phase = lif_info->logical_phase;
    ...
    if (!entry_reuse)
    {
        ...
        if (_SHR_IS_FLAG_SET(lif_info->flags, LIF_TABLE_MNGR_LIF_INFO_OUTLIF_REPLACE_ALLOW_LL_MISMATCH))
        {
 ...
 *   \param [in] dbal_table_id - relevant table id
 *   \param [in] result_type - new entry result type
 *   \param [in] logical_phase - Out-LIF logical phase of the
 *          current lif, invalid for inlif
    ...
    uint32 *table_specific_flags)
{
    ...
    SHR_IF_ERR_EXIT(dnx_lif_table_mngr_table_specific_flags_fill
                    (unit, dbal_table_id, result_type, logical_phase, table_specific_flags));
    ...
    lif_table_mngr_outlif_info_t * lif_info)
{
    ...
    SHR_IF_ERR_EXIT_NO_MSG(dnx_lif_mngr_outlif_sw_info_get(unit, local_lif_id,
                                                           &dbal_table_id,
                                                           &result_type, &lif_info->logical_phase,
    ...
    SHR_IF_ERR_EXIT(dnx_lif_table_mngr_get_table_fields_and_specific_flags
                    (unit, local_lif_id, dbal_table_id, result_type, lif_info->logical_phase, lif_table_entry_handle_id,
    ...
    lif_table_mngr_inlif_info_t * lif_info)
{
     ...
     */
    SHR_IF_ERR_EXIT_NO_MSG(dnx_lif_mngr_inlif_sw_info_table_id_and_result_type_get
                           (unit, local_lif_id, core_idx, physical_table_id, &dbal_table_id, &result_type));
    ...
    int local_lif_id)
{
    ...
    /*
     * Delete the entry from the relevant SW State, use valid_fields default value. 
     */
    local_lif_info.valid_fields = -1;
 ...
 *   \param [in] result_type - new entry result type
 *   \param [in] local_lif_id - new entry local outlif
 *   \param [in] core_id - The core in which the LIF is defined.
 *                         Relevant only for Ingress.
    ...
    uint32 new_local_lif_id)
{
    ...
    if ((table_id == DBAL_TABLE_IPV6_MP_TT_TCAM_BASIC) || (table_id == DBAL_TABLE_IPV6_MP_TT_TCAM_2ND_PASS))
    {
        field_id = DBAL_FIELD_IPV6_DIP_IDX_DATA;
    }
    ...
    /*
     * Expected LIF field wasn't found in any of the result types
     */
    if (result_type_idx == table_attr->nof_result_types)
    {
        SHR_ERR_EXIT(_SHR_E_INTERNAL, "For table %s, expected to find field %s, but it is missing on all result types",
    ...
    lif_table_mngr_module_e * module)
{
    ...
    switch (in_lif_dbal_table_id)
    {
        ...
        case DBAL_TABLE_IN_LIF_FORMAT_PPPoE:
    ...
    if (*module == LIF_TBL_MNGR_MODULE_UNRESOLVED)
    {
        ...
        if (dnx_data_lif.in_lif.feature_get(unit, dnx_data_lif_in_lif_phy_db_dpc) && (core_id == _SHR_CORE_ALL))
        {
            dbal_entry_key_field32_set(unit, sw_match_db_handle_id, DBAL_FIELD_CORE_ID, 0);
        }
    ...
    uint32 new_local_lif_id)
{
    ...
    while (table_id != DBAL_TABLE_EMPTY)
    {
         ...
         * Traverse by rule over the current table
         */
        if (IS_EEDB_TABLE_VALID_FOR_POINTER_UPDATE(table_id))
        {
            SHR_IF_ERR_EXIT(dnx_lif_table_mngr_update_pointers_single_table
...
/*
 * Log result-type debuf information
 */
shr_error_e
    ...
    lif_table_mngr_outlif_info_t * lif_info)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_lif_table_mngr_allocate_local_outlif_and_set_hw_verify
    ...
    SHR_IF_ERR_EXIT(dnx_algo_lif_table_mngr_decide_result_type
                    (unit, lif_info->table_specific_flags, lif_info->logical_phase, entry_handle_id, &result_type));
    ...
    SHR_IF_ERR_EXIT(dnx_lif_table_mngr_store_valid_fields
                    (unit, FALSE, dbal_table_id, -1, entry_handle_id, result_type, *local_lif_id, 0,
                     !is_new_local_lif));
        ...
        && is_new_local_lif)
    {
        ...
        else
        {
             ...
             */
            SHR_IF_ERR_EXIT(dnx_lif_lib_add_to_glem(unit, _SHR_CORE_ALL, lif_info->global_lif, *local_lif_id, TRUE));
        }

        /** Add new global to local lif mapping */
        SHR_IF_ERR_EXIT(dnx_algo_lif_mapping_create
                        (unit, DNX_ALGO_LIF_EGRESS, lif_info->global_lif, &local_lif_payload, TRUE));
    }
    ...
    lif_table_mngr_inlif_info_t * lif_info)
{
    ...
    if (_SHR_IS_FLAG_SET(lif_info->flags, LIF_TABLE_MNGR_LIF_INFO_REPLACE))
    {
        ...
        SHR_IF_ERR_EXIT(dnx_lif_mngr_inlif_sw_info_table_id_and_result_type_get
                        (unit, *local_lif_id, core_id, physical_table_id, &existing_dbal_table_id, NULL));
        if (dbal_table_id != existing_dbal_table_id)
        {
            SHR_ERR_EXIT(_SHR_E_INTERNAL,
                         "Error: handler DBAL table (%s) doesn't match the Replaced LIF's (local LIF - 0x%x) DBAL table (%s)\n",
    ...
    lif_table_mngr_inlif_info_t * lif_info)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_lif_table_mngr_allocate_local_inlif_and_set_hw_verify
     ...
     */
    SHR_IF_ERR_EXIT(dnx_lif_table_mngr_store_valid_fields
                    (unit, TRUE, dbal_table_id, physical_table_id, entry_handle_id, result_type,
                     *local_lif_id, core_id, !is_new_local_lif));
    ...
    uint32 flags)
{
    ...
    SHR_IF_ERR_EXIT(dnx_lif_mngr_outlif_sw_info_get(unit, local_lif_id,
                                                    &dbal_table_id, &result_type, NULL, NULL, NULL, NULL));
    ...
    uint8 *is_valid)
{
    ...
    if (is_ingress)
    {
        ...
        SHR_IF_ERR_EXIT(dbal_tables_physical_table_get
                        (unit, dbal_table_id, DBAL_PHY_DB_DEFAULT_INDEX, &physical_table_id));
        SHR_IF_ERR_EXIT(dnx_lif_mngr_inlif_sw_info_table_id_and_result_type_get
                        (unit, local_lif_id, core_id, physical_table_id, &dbal_table_id_get, &result_type));
    ...
    else
    {
        SHR_IF_ERR_EXIT(dnx_lif_mngr_outlif_sw_info_get(unit, local_lif_id, &dbal_table_id_get,
                                                        &result_type, NULL, NULL, NULL, NULL));
        if (dbal_table_id != dbal_table_id_get)
        {
            SHR_ERR_EXIT(_SHR_E_PARAM,
                         " There was an issue with dbal_table_id parameter, please check the input values.\n");
