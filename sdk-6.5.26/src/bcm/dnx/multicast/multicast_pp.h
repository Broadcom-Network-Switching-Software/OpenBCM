...
/**
 * The PPMC encap count that matches to DBAL result type
 */
#define DNX_MULTICAST_PPMC_SINGLE_OUTLIF_ENCAP_COUNT (1)
#define DNX_MULTICAST_PPMC_DOUBLE_OUTLIF_ENCAP_COUNT (2)
#define DNX_MULTICAST_PPMC_TRIPLE_OUTLIF_ENCAP_COUNT (3)
/**
 ...
 */
shr_error_e dnx_multicast_pp_jr1_same_interface_init(
    int unit);
