    ...
    uint8 is_standard_image)
{
    ...
    SHR_IF_ERR_EXIT(dbal_fields_enum_value_get(unit, DBAL_FIELD_FORWARD_APP_TYPES, opcode_id, &opcode_id_enum_value));
    ...
    uint32 opcode_id)
{
    ...
    if ((key_size[0] == 0) && (key_size[1] == 0))
    {
        ...
        SHR_IF_ERR_EXIT(dbal_fields_enum_value_get
                        (unit, DBAL_FIELD_FORWARD_APP_TYPES, opcode_id, &opcode_id_enum_value));
    ...
    uint8 is_standard_image)
{
    ...
    if (!disable_fwd_db)
    {
        ...
        RHDATA_ITERATOR(iter, opcode_node, "AppDB")
        {
            ...
            {
                /** W.A. due to conflicting pointer types */
                uint32 app_db_id = 0;
    ...
    if (is_standard_image)
    {
        ...
        SHR_IF_ERR_EXIT(dbal_fields_enum_value_get(unit, DBAL_FIELD_FORWARD_APP_TYPES, opcode_id, &opcode_id_enum));
    ...
    int unit)
{
    ...
    RHDATA_ITERATOR(fwd2_app_type_node, catalogue, "FWD2_APP_TYPES")
    {
        RHDATA_ITERATOR(app_type_node, fwd2_app_type_node, "AppType")
        {
            ...
            SHR_IF_ERR_EXIT(rv);
            SHR_IF_ERR_EXIT(dbal_fields_enum_hw_value_get
                            (unit, DBAL_FIELD_FORWARD_APP_TYPES, opcode_id_enum, &opcode_id));
