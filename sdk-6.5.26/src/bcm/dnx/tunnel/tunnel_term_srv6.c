    ...
    dbal_enum_value_field_ipv6_dip_idx_type_e * dip_idx_type)
{
    ...
    else if (DNX_TUNNEL_TERM_SRV6_IS_SRV6_WITH_MICRO_SEGMENT_ID(info))
    {
        if (DNX_TUNNEL_TERM_SRV6_IS_CASCADED_MISS_DISABLE_TERM(info))
        {
            *dip_idx_type = DBAL_ENUM_FVAL_IPV6_DIP_IDX_TYPE_USID_PREFIX_32_USID_16_NO_DEFAULT;
        }
        else
        {
    ...
    int *locator_nof_bits)
{
    ...
    switch (dip_idx_type)
    {
        ...
        case DBAL_ENUM_FVAL_IPV6_DIP_IDX_TYPE_USID_PREFIX_32_USID_16_NO_DEFAULT:
            *locator_nof_bits = 48;
            break;
        default:
    ...
    uint8 *result_is_lif)
{
    *result_is_lif = UTILEX_NUM2BOOL((dip_idx_type ==
                                     ...
                                     || (dip_idx_type == DBAL_ENUM_FVAL_IPV6_DIP_IDX_TYPE_USID_PREFIX_32_USID_16)
                                     || (dip_idx_type ==
                                         DBAL_ENUM_FVAL_IPV6_DIP_IDX_TYPE_USID_PREFIX_32_USID_16_NO_DEFAULT));
}
    ...
    dbal_enum_value_field_ipv6_dip_idx_type_e * dip_idx_type_value)
{
    ...
    else if (DNX_TUNNEL_TERM_SRV6_IS_SRV6_WITH_MICRO_SEGMENT_ID(info))
    {
        if (DNX_TUNNEL_TERM_SRV6_IS_CASCADED_MISS_DISABLE_TERM(info))
        {
            *dip_idx_type_value = DBAL_ENUM_FVAL_IPV6_DIP_IDX_TYPE_USID_PREFIX_32_USID_16_NO_DEFAULT;
        }
        else
        {
