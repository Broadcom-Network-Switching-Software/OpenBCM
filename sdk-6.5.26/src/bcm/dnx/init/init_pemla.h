...
#define MAX_NOF_PEMLA_PATCHES 50

typedef struct
{
    int id;                     /* patch ID */
    char str[SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH];     /* data of patch */
} dnx_pemla_patch;
 ...
 *
 * \param [in] unit         - Device ID
 * \param [out] pemla_patches    - patches information structure
 * \param [out] nof_patches    - number of patches registered
 *
 * \return
 *   shr_error_e - Error Type
 * \remark
