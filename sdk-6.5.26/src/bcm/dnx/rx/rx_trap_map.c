...
static const dnx_rx_trap_map_type_t dnx_rx_trap_type_map[bcmRxTrapCount] = {
    ...
    [bcmRxTrapTerminatedGenericCoeFlowControl]          = {0,DBAL_ENUM_FVAL_INGRESS_TRAP_ID_VTT_GENERIC_FC,
                                                           DNX_RX_TRAP_BLOCK_INGRESS,DNX_RX_TRAP_CLASS_PREDEFINED,
    ...
    [bcmRxTrapTerminatedVridMyMac]                      = {0,DBAL_ENUM_FVAL_INGRESS_TRAP_ID_VTT_VRID_MY_MAC,
                                                           DNX_RX_TRAP_BLOCK_INGRESS,DNX_RX_TRAP_CLASS_PREDEFINED,
                                                           "TerminatedVridMyMac"},
    ...
    [bcmRxTrapMcUseSipRpfFail]                          = {1,DBAL_ENUM_FVAL_INGRESS_TRAP_ID_FER_MC_USE_SIP_RPF_FAIL,
                                                           DNX_RX_TRAP_BLOCK_INGRESS,DNX_RX_TRAP_CLASS_PREDEFINED,
                                                           "McUseSipRpfFail"},
    [bcmRxTrapMcUseSipMultipath]                        = {0,DBAL_ENUM_FVAL_INGRESS_TRAP_ID_FER_SIP_TRANSPLANT_DETECTION,
                                                           DNX_RX_TRAP_BLOCK_INGRESS,DNX_RX_TRAP_CLASS_PREDEFINED,
                                                           "McUseSipMultipath"},
    ...
    [bcmRxTrapOamBfdPwe]                                = {1,DBAL_ENUM_FVAL_INGRESS_TRAP_ID_TRAP_BFD_O_PWE,
                                                           DNX_RX_TRAP_BLOCK_INGRESS,DNX_RX_TRAP_CLASS_PREDEFINED,
                                                           "OamBfdPwe",0,TRUE},
    [bcmRxTrapOamBfdCcMplsTp]                           = {1,DBAL_ENUM_FVAL_INGRESS_TRAP_ID_TRAP_BFDCC_O_MPLSTP,
                                                           DNX_RX_TRAP_BLOCK_INGRESS,DNX_RX_TRAP_CLASS_PREDEFINED,
                                                           "OamBfdCcMplsTp",0,TRUE},
    ...
    [bcmRxTrapSrv6Usp]                               = {1,DBAL_ENUM_FVAL_INGRESS_TRAP_ID_PMF_SRV6_USP,
                                                           DNX_RX_TRAP_BLOCK_INGRESS,DNX_RX_TRAP_CLASS_PREDEFINED,
                                                           "SRv6Usp",0,TRUE},
    ...
    [bcmRxTrapEgTxOamReflector]   = {1,DNX_RX_TRAP_ETPP_OAM_TRAP_TYPE_SET(DNX_RX_TRAP_ETPP_FWD_ACT_PROFILE_USER_TRAP_1,DNX_RX_TRAP_ETPP_OAM_REFLECTOR),
                                     DNX_RX_TRAP_BLOCK_ETPP, DNX_RX_TRAP_CLASS_OAM,
                                     "EgTxOamReflector"},
    /**ETPP IFA Recycle Trap: fwd_action_profile is set to DO_NOTHING since ETPP trap context selection for this trap context
      *is not dependent on fwd_action_profile (TRAP___GENERAL___IPT_IFA_First_DP.fwd_action_profile set to don't care)*/
   [bcmRxTrapEgTxIfaEgressMetadata]  = {1,DNX_RX_TRAP_ETPP_OAM_TRAP_TYPE_SET(DNX_RX_TRAP_ETPP_FWD_ACT_PROFILE_DO_NOTHING,DNX_RX_TRAP_ETPP_IFA2),
           DNX_RX_TRAP_BLOCK_ETPP, DNX_RX_TRAP_CLASS_OAM,
           "EgTxIfaEgressMetadata"},
};

static const dnx_rx_trap_map_type_t dnx_rx_app_trap_type_map[bcmRxTrapCount]= {
    [bcmRxTrapEgHairPinFilter]                      = {1, DBAL_ENUM_FVAL_ERPP_TRAP_ID_SRC_EQUAL_DEST,
                                                       DNX_RX_TRAP_BLOCK_ERPP, 0, "EgHairPinFilter"},
    [bcmRxTrapEgSplitHorizonFilter]                 = {0, DBAL_ENUM_FVAL_ERPP_TRAP_ID_SPLIT_HORIZON,
    ...
    [bcmRxTrapDssStacking]                          = {0, DBAL_ENUM_FVAL_ERPP_TRAP_ID_DSS_STACKING,
                                                       DNX_RX_TRAP_BLOCK_ERPP, 0, "DssStacking"},
    [bcmRxTrapLagMulticast]                         = {0, DBAL_ENUM_FVAL_ERPP_TRAP_ID_LAG_MULTICAST,
    ...
    [bcmRxTrapEgInvalidDestPort]                    = {0, DBAL_ENUM_FVAL_ERPP_TRAP_ID_INVALID_OTM,
                                                       DNX_RX_TRAP_BLOCK_ERPP, 0, "EgInvalidDestPort"},
    [bcmRxTrapEgRqpDiscard]                         = {0, DBAL_ENUM_FVAL_ERPP_TRAP_ID_RQP_DISCARD,
                                                       DNX_RX_TRAP_BLOCK_ERPP, 0, "EgRqpDiscard"},
    [bcmRxTrapEgTdmDiscard]                         = {0, DBAL_ENUM_FVAL_ERPP_TRAP_ID_TDM_DISCARD,
...
const dnx_rx_trap_map_ud_t dnx_rx_ud_trap_map[DNX_RX_TRAP_BLOCK_NUM_OF]= {
    [DNX_RX_TRAP_BLOCK_INGRESS]         = {DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_0,
                                           DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_275,
                                           "Ingress",
                                           {-1}},
...
static const dnx_rx_trap_map_ranges_t dnx_rx_range_trap_map[DNX_RX_TRAP_BLOCK_NUM_OF]= {
...
static const dbal_enum_value_field_etpp_trap_id_e dnx_rx_etpp_lif_trap_profile_map[DNX_RX_TRAP_ETPP_LIF_NOF_PROFILES]= {
    [DNX_RX_TRAP_ETPP_LIF_PROFILE_DEFAULT]        = 0,
    [DNX_RX_TRAP_ETPP_LIF_PROFILE_STACK_TRAP_1]   = DBAL_ENUM_FVAL_ETPP_TRAP_ID_STACK_TRAP_1,
    [DNX_RX_TRAP_ETPP_LIF_PROFILE_STACK_TRAP_2]   = DBAL_ENUM_FVAL_ETPP_TRAP_ID_STACK_TRAP_2
};

static const dnx_rx_trap_map_etpp_profile_dbal_fields_t dnx_rx_trap_map_etpp_ud_profile[DNX_RX_TRAP_ETPP_FWD_ACT_NOF_PROFILES]= {
...
static const dnx_rx_trap_map_etpp_profile_dbal_fields_t dnx_rx_trap_map_etpp_oam_profile[DNX_RX_TRAP_ETPP_OAM_NOF_TRAPS]= {
    ...
    [DNX_RX_TRAP_ETPP_IFA2]                             = {DBAL_FIELD_EMPTY,
                                                           DBAL_FIELD_EMPTY,
                                                           DBAL_FIELD_EMPTY,
...
static const dnx_rx_trap_map_stat_obj_dbal_fields_t dnx_rx_trap_map_stat_obj[DNX_RX_TRAP_NOF_STAT_OBJS_TO_OW]= {
...
static const dnx_rx_trap_map_ingress_ud_t dnx_rx_trap_map_ingress_ud[DBAL_NOF_ENUM_INGRESS_TRAP_ID_VALUES] = {
    ...
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_224]   =     {1,224},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_225]   =     {1,225},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_226]   =     {1,226},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_227]   =     {1,227},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_228]   =     {1,228},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_229]   =     {1,229},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_230]   =     {1,230},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_231]   =     {1,231},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_232]   =     {1,232},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_233]   =     {1,233},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_234]   =     {1,234},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_235]   =     {1,235},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_236]   =     {1,236},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_237]   =     {1,237},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_238]   =     {1,238},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_239]   =     {1,239},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_240]   =     {1,240},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_241]   =     {1,241},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_242]   =     {1,242},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_243]   =     {1,243},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_244]   =     {1,244},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_245]   =     {1,245},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_246]   =     {1,246},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_247]   =     {1,247},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_248]   =     {1,248},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_249]   =     {1,249},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_250]   =     {1,250},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_251]   =     {1,251},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_252]   =     {1,252},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_253]   =     {1,253},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_254]   =     {1,254},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_255]   =     {1,255},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_256]   =     {1,256},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_257]   =     {1,257},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_258]   =     {1,258},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_259]   =     {1,259},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_260]   =     {1,260},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_261]   =     {1,261},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_262]   =     {1,262},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_263]   =     {1,263},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_264]   =     {1,264},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_265]   =     {1,265},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_266]   =     {1,266},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_267]   =     {1,267},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_268]   =     {1,268},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_269]   =     {1,269},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_270]   =     {1,270},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_271]   =     {1,271},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_272]   =     {1,272},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_273]   =     {1,273},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_274]   =     {1,274},
    [DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_275]   =     {1,275},
};

static const dbal_enum_value_field_ingress_trap_id_e dnx_rx_trap_map_ingress_ud_alloc[DBAL_NOF_ENUM_INGRESS_TRAP_ID_VALUES] = {
    ...
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_224,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_225,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_226,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_227,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_228,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_229,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_230,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_231,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_232,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_233,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_234,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_235,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_236,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_237,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_238,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_239,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_240,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_241,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_242,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_243,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_244,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_245,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_246,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_247,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_248,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_249,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_250,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_251,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_252,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_253,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_254,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_255,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_256,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_257,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_258,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_259,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_260,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_261,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_262,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_263,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_264,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_265,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_266,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_267,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_268,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_269,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_270,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_271,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_272,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_273,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_274,
    DBAL_ENUM_FVAL_INGRESS_TRAP_ID_USER_DEFINED_275,
    DBAL_NOF_ENUM_INGRESS_TRAP_ID_VALUES,
};

static const char * dnx_rx_trap_type_description[bcmRxTrapCount] = {
    [bcmRxTrapLinkLayerHeaderSizeErr]                   = "Parser indicates header size error",
    [bcmRxTrapLinkLayerSaMulticast]                     = "Source address is multicast, the trap can be enabled per port using bcmPortControlSaMulticastEnable in bcm_port_control_set()",
    ...
    [bcmRxTrapMplsUnexpectedBos]                        = "Label with BOS bit set is not the last label in MPLS stack",
    [bcmRxTrapMplsUnexpectedNoBos]                      = "Last label in MPLS stack with BOS bit unset",
    ...
    [bcmRxTrapMplsTerminationFail]                      = "MPLS termination goes out of the MPLS stack",
    ...
    [bcmRxTrapTerminatedIpv4Fragmented]                 = "Terminated IPv4 header is fragmented, will be triggered only for first framgent",
    ...
    [bcmRxTrapIcmpFragmented]                           = "ICMP packet and IP-Header is Fragmented, will be triggered only for first fragment",
    ...
    [bcmRxTrapOamBfdCcMplsTp]                           = "BFD VCCV Type 1 With IP encapsulation",
    ...
    [bcmRxTrapEgGlemPpTrap]                         = "Triggered when ERPP GLEM lookup does not find an entry and packet goes through standard processingTriggered by ERPP GLEM PP error",
    [bcmRxTrapEgGlemNonePpTrap]                     = "Triggered when ERPP GLEM lookup does not find an entry and packet goes through non-standard processing, for example mirrored or ERPP trapped packets",
    ...
    [bcmRxTrapEgTxGlem]                             = "Triggered when ETPP GLEM lookup does not find an entry Triggered by ETPP GLEM error",
    ...
    [bcmRxTrapSrv6Usp]                              = "SRv6 USP flow with L4 header over SRv6 header",
    ...
    uint8 *is_user_defined_p)
{
    ...
    SHR_NULL_CHECK(is_user_defined_p, _SHR_E_PARAM, "is_user_defined_p");

    switch (trap_block)
    {
        case DNX_RX_TRAP_BLOCK_INGRESS:
            *is_user_defined_p = dnx_rx_trap_map_ingress_ud[trap_id].valid;
            break;
        case DNX_RX_TRAP_BLOCK_ERPP:
        case DNX_RX_TRAP_BLOCK_ETPP:
            *is_user_defined_p = (trap_id >= dnx_rx_ud_trap_map[trap_block].lower_bound_trap_id)
                && (trap_id <= dnx_rx_ud_trap_map[trap_block].upper_bound_trap_id);
            break;
        default:
            *is_user_defined_p = FALSE;
            break;
    }
    ...
    dnx_rx_trap_map_type_t * trap_type_info_p)
{
    uint32 hw_value = 0;
    uint8 is_illegal;
    shr_error_e hw_value_err;
    SHR_FUNC_INIT_VARS(unit);
    SHR_NULL_CHECK(trap_type_info_p, _SHR_E_PARAM, "trap_type_info_p");

    if (trap_type < bcmRxTrapCount)
    {
        trap_type_info_p->is_strengthless = dnx_rx_trap_type_map[trap_type].is_strengthless;
        trap_type_info_p->trap_block = dnx_rx_trap_type_map[trap_type].trap_block;
        trap_type_info_p->trap_class = dnx_rx_trap_type_map[trap_type].trap_class;
        trap_type_info_p->trap_id = dnx_rx_trap_type_map[trap_type].trap_id;
        trap_type_info_p->valid = dnx_rx_trap_type_map[trap_type].valid;

        /** In case of Ingress predefined traps, check if trap is supported on device using DBAL */
        if ((trap_type_info_p->trap_block == DNX_RX_TRAP_BLOCK_INGRESS) &&
            (trap_type_info_p->trap_class == DNX_RX_TRAP_CLASS_PREDEFINED))
        {
            ...
            if (is_illegal)
            {
                trap_type_info_p->valid = FALSE;
            }
            else
            {
                hw_value_err =
                    dbal_fields_enum_hw_value_get(unit, DBAL_FIELD_INGRESS_TRAP_ID,
                                                  dnx_rx_trap_type_map[trap_type].trap_id, &hw_value);
                trap_type_info_p->valid = (dnx_rx_trap_type_map[trap_type].valid && (hw_value_err == _SHR_E_NONE));
            }
        }

        sal_strncpy(trap_type_info_p->trap_name, dnx_rx_trap_type_map[trap_type].trap_name,
    ...
    dnx_rx_trap_map_etpp_profile_dbal_fields_t * ud_profile_info_p)
{
        ...
        && fwd_action_profile <= DNX_RX_TRAP_ETPP_FWD_ACT_PROFILE_VISIBILITY)
    {
        ...
        ud_profile_info_p->cfg_keep_sys_hdr = dnx_rx_trap_map_etpp_ud_profile[fwd_action_profile].cfg_keep_sys_hdr;
        ud_profile_info_p->cfg_keep_term_hdr = dnx_rx_trap_map_etpp_ud_profile[fwd_action_profile].cfg_keep_term_hdr;
        ud_profile_info_p->cfg_candidate_hdr_en =
            dnx_rx_trap_map_etpp_ud_profile[fwd_action_profile].cfg_candidate_hdr_en;
        ud_profile_info_p->cfg_kill_mirror_copy =
            dnx_rx_trap_map_etpp_ud_profile[fwd_action_profile].cfg_kill_mirror_copy;
        ud_profile_info_p->cfg_kill_snoop_copy =
            dnx_rx_trap_map_etpp_ud_profile[fwd_action_profile].cfg_kill_snoop_copy;
    }
    else
    {
 ...
 */
shr_error_e
dnx_rx_trap_map_ingress_ud_alloc_get(
    int unit,
    int alloc_index,
    int *trap_id_p)
{
    ...
    if (alloc_index < DBAL_NOF_ENUM_INGRESS_TRAP_ID_VALUES)
    {
        *trap_id_p = dnx_rx_trap_map_ingress_ud_alloc[alloc_index];
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "Invalid alloc_index=%d\n", alloc_index);
    }
 ...
 */
shr_error_e
dnx_rx_trap_etpp_lif_profile_map_to_dbal_trap_id(
    int unit,
    dnx_rx_trap_etpp_lif_profiles_e lif_trap_profile,
    dbal_enum_value_field_etpp_trap_id_e * dbal_trap_id_p)
{
    SHR_FUNC_INIT_VARS(unit);
    SHR_NULL_CHECK(dbal_trap_id_p, _SHR_E_PARAM, "dbal_trap_id_p");

    if (lif_trap_profile < DNX_RX_TRAP_ETPP_LIF_NOF_PROFILES)
    {
        *dbal_trap_id_p = dnx_rx_etpp_lif_trap_profile_map[lif_trap_profile];
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "Invalid lif trap profile = %d\n", lif_trap_profile);
    }
