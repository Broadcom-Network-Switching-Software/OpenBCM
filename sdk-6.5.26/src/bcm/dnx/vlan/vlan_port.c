...
#define BCM_VLAN_PORT_FLAGS2_MAC_SAV 0x00000002 /* Identify MAC SAV */
    ...
    int is_virtual_ac)
{
    ...
    if (vlan_port->learn_strength && DNX_CRITERIA_IS_PON(vlan_port->criteria))
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "Doesn't support learn strength setting in PON LIF");
    }
