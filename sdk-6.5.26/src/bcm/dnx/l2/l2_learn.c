...
#define DNX_LEARN_PAYLOAD_LPKGV_DEST_BIT     1
    ...
    int unit)
{
    ...
    int result_type_size, grouping_size, strength_size, age_profile_size, dest_size;
    ...
    int lpkgv_one_outlif)
{
    ...
    if (dnx_data_l2.general.feature_get(unit, dnx_data_l2_general_ivl_feature_support))
    {
        learn_payload_context_val =
            DBAL_ENUM_FVAL_LEARN_PAYLOAD_CONTEXT_SYMMETRIC_LIF__FEC_OR_SPA_OR_TRAP_DEST__16_GROUP__2L_STRENGTH__IVL;
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_LEARN_PAYLOAD_CONTEXT, learn_payload_context_val);
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_LEARN_FORMAT_INDEX, INST_SINGLE,
    ...
    int lpkgv_one_outlif)
{
    ...
    {
        learn_payload_context_val =
            DBAL_ENUM_FVAL_LEARN_PAYLOAD_CONTEXT_SYMMETRIC_LIF__TMF_OR_MC_DEST__16_GROUP__2L_STRENGTH__IVL;
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_LEARN_PAYLOAD_CONTEXT, learn_payload_context_val);
        dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_LEARN_FORMAT_INDEX, INST_SINGLE,
                                     DBAL_DEFINE_MACT_LEARN_FORMAT_IDX_ONE);
        SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
    ...
    int lpkgv_one_outlif)
{
    ...
    /** Learn_Data[47:43]: Learn_Data[47] - second part of learn strength, Learn_Data[46:43] - entry group */
    current_len = LEARN_PAYLOAD_ENTRY_GROUP_WIDTH + 1;
    current_offset -= current_len;
    learn_ffc_instruction =
    ...
    int lpkgv_one_outlif)
{
    ...
    /** Learn_Data[47:42]: type(6) + Learn_Data[41:37]: DESTINATION_SSPA_PREFIX(5) */
    current_len = 11;
    current_offset -= current_len;
    learn_ffc_instruction = BUILD_LEARN_PAYLOAD_FFC(current_offset,
                                                    (current_len - 1), (LEARN_PAYLOAD_SOURCE_LEARN_DATA_OFFSET + 37));
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_LEARN_FFC_INSTRUCTION, 0, learn_ffc_instruction);

    /** SSPA(16]: destination[15:0] */
    current_len = LEARN_PAYLOAD_SOURCE_SRC_SYSTEM_PORT_WIDTH;
    current_offset -= current_len;
    learn_ffc_instruction = BUILD_LEARN_PAYLOAD_FFC(current_offset,
                                                    (current_len - 1), LEARN_PAYLOAD_SOURCE_SRC_SYSTEM_PORT_OFFSET);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_LEARN_FFC_INSTRUCTION, 1, learn_ffc_instruction);
    ...
    int lpkgv_no_outlif)
{
    ...
    /** Learn_Data[36:31]: type(6) + Learn_Data[30:26]: DESTINATION_SSPA_PREFIX(5) */
    current_len = 11;
    current_offset -= current_len;
    learn_ffc_instruction = BUILD_LEARN_PAYLOAD_FFC(current_offset,
                                                    (current_len - 1), (LEARN_PAYLOAD_SOURCE_LEARN_DATA_OFFSET + 26));
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_LEARN_FFC_INSTRUCTION, 0, learn_ffc_instruction);
    ...
    int lpkgv_one_outlif)
{
    ...
    uint32 current_len;
    uint32 learn_payload_context_val =
        DBAL_ENUM_FVAL_LEARN_PAYLOAD_CONTEXT_SYMMETRIC_LIF0__ANY_DEST__16_GROUP__2L_STRENGTH__SVL;
    ...
    int unit)
{
     ...
     * LPKGV[7:2]: Type, LPKGV[1]: 1MSB DEST bit for fec_spa_trap_dest or tmf_mc_dest, LPKGV[0]:Age_Profile,
     */
    lpkgv_hw_value_no_outlif = ((lpkgv_hw_value_no_outlif << 2) | (1 << DNX_LEARN_PAYLOAD_LPKGV_STRENGTH_BIT));
    lpkgv_hw_value_single_outlif = ((lpkgv_hw_value_single_outlif << 2) | (1 << DNX_LEARN_PAYLOAD_LPKGV_STRENGTH_BIT));
    ...
    if (system_headers_mode == DBAL_ENUM_FVAL_SYSTEM_HEADERS_MODE_JERICHO_MODE)
    {
        ...
        lpkgv_hw_value_eei_fec = ((lpkgv_hw_value_eei_fec << 2) | (1 << DNX_LEARN_PAYLOAD_LPKGV_STRENGTH_BIT));
    ...
    bcm_l2_learn_action_resolution_t * action_res)
{
    ...
    SHR_ERR_EXIT(_SHR_E_UNAVAIL, "bcm_dnx_l2_learn_action_resolution_set not supported ");
    ...
    bcm_l2_learn_action_resolution_t * action_res)
{
    ...
    SHR_ERR_EXIT(_SHR_E_UNAVAIL, "bcm_dnx_l2_learn_action_resolution_get not supported ");
