    ...
    bcm_port_t port)
{
    ...
    if (!(DNX_ALGO_PORT_TYPE_IS_NIF(unit, port_info, DNX_ALGO_PORT_TYPE_INCLUDE(L1, FLEXE))
...
{
    SHR_FUNC_INIT_VARS(unit);
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_ingress_port_set_verify(unit, port, type, arg));
...
{
    SHR_FUNC_INIT_VARS(unit);
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_ingress_port_get_verify(unit, port, type, arg));
    ...
    bcm_cosq_ingress_drop_control_frame_config_t * control_frame_config)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_ingress_port_drop_control_frame_get_verify
    ...
    bcm_cosq_ingress_drop_control_frame_config_t * control_frame_config)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_ingress_port_drop_control_frame_set_verify
                           (unit, port, flags, control_frame_index, control_frame_config));
    ...
    uint32 *ether_type_val)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_ingress_port_drop_custom_ether_type_get_verify
    ...
    uint32 ether_type_val)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_ingress_port_drop_custom_ether_type_set_verify
                           (unit, port, flags, ether_type_code, ether_type_val));
    ...
    uint32 *default_priority)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_ingress_port_drop_default_priority_get_verify(unit, port, flags, default_priority));
    ...
    uint32 default_priority)
{
    ...
    SHR_IF_ERR_EXIT(dnx_cosq_ingress_port_drop_user_prio_decode(unit, default_priority, &priority, &is_tdm));
    ...
    uint32 default_priority)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_ingress_port_drop_default_priority_set_verify(unit, port, flags, default_priority));
    ...
    int *enable_mode)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_ingress_port_drop_enable_get_verify(unit, port, flags, enable_mode));
    ...
    int enable_mode)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_ingress_port_drop_enable_set_verify(unit, port, flags, enable_mode));
    ...
    bcm_cosq_ingress_drop_flex_key_construct_t * flex_key_config)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_ingress_port_drop_flex_key_construct_get_verify
    ...
    bcm_cosq_ingress_drop_flex_key_construct_t * flex_key_config)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_ingress_port_drop_flex_key_construct_set_verify
                           (unit, key_id, flags, flex_key_config));
    ...
    bcm_cosq_ingress_drop_flex_key_entry_t * flex_key_info)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_ingress_port_drop_flex_key_entry_get_verify
    ...
    bcm_cosq_ingress_drop_flex_key_entry_t * flex_key_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DNX_ERR_RECOVERY_START(unit);
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_ingress_port_drop_flex_key_entry_set_verify
                           (unit, port, flags, key_index, flex_key_info));
    ...
    int *priority)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_ingress_port_drop_map_get_verify(unit, port, flags, map, &key, priority));
    ...
    int priority)
{
    ...
    SHR_IF_ERR_EXIT(dnx_algo_port_info_get(unit, port, &port_info));
    if (is_tdm && DNX_ALGO_PORT_TYPE_IS_NIF_ILKN(unit, port_info, DNX_ALGO_PORT_TYPE_INCLUDE(ELK, L1)))
    {
    ...
    int priority)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_ingress_port_drop_map_set_verify(unit, port, flags, map, &key, priority));
    ...
    uint32 *value)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_ingress_port_drop_threshold_get_verify(unit, port, flags, priority, value));
    ...
    uint32 value)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_ingress_port_drop_threshold_set_verify(unit, port, flags, priority, value));
    ...
    bcm_cosq_ingress_port_drop_mpls_special_label_config_t * label_config)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_ingress_port_drop_mpls_special_label_get_verify
    ...
    bcm_cosq_ingress_port_drop_mpls_special_label_config_t * label_config)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_ingress_port_drop_mpls_special_label_set_verify
                           (unit, port, flags, label_index, label_config));
    ...
    switch (header_type)
    {
        ...
        case BCM_SWITCH_PORT_HEADER_TYPE_INJECTED_2:
            ...
            *is_eth_port = 1;
            break;
        default:
            *prd_port_type = BCM_SWITCH_PORT_HEADER_TYPE_NONE;
            break;
    }
    ...
    bcm_cosq_ingress_drop_flex_key_construct_t * flex_key_config)
{
     ...
     */
    is_mpls =
        sal_strncmp(dnx_data_nif.prd.ether_type_get(unit, ether_type_code)->ether_type_name, "MPLS",
                    SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH) ? 0 : 1;
    if (!is_mpls)
    {
