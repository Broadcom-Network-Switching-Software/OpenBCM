...
/**
 * \brief - Clear system TC (on the packet) to a VOQ offset
 *
 * \param [in] unit - chip unit id.
 * \param [in] core - device core id.
 * \param [in] tc - system TC
 ...
 * \return shr_error_e
 */
shr_error_e dnx_cosq_ipq_dbal_tc_to_voq_offset_map_clear(
    int unit,
    int core,
    uint32 tc,
    uint32 dp,
...
/**
 * \brief - Power down IPQ module
 */
shr_error_e dnx_ipq_power_down_set(
    int unit,
    int power_down);
