    ...
    uint32 round_up)
{
    ...
    else
    {
        ...
        COMPILER_64_SET(intermediate_numerator, 0, max_rate_in_mega_bits_per_sec);
        COMPILER_64_UMUL_32(intermediate_numerator, 1000);
    ...
    int *flow_id)
{
    ...
    SHR_IF_ERR_EXIT(dnx_scheduler_flow_allocate
                    (unit, core, 1, alloc_flags, FALSE, FALSE, 1, flow_type, shared_order, -1, flow_id));
    ...
    bcm_cosq_range_t * range)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_scheduler_low_rate_connector_range_set_verify(unit, gport, flags, range));
    ...
    bcm_cosq_range_t * range)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_scheduler_low_rate_connector_range_get_verify(unit, gport, flags, range));
