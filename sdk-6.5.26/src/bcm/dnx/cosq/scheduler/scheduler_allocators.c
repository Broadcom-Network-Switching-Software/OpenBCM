    ...
    int unit)
{
    ...
    create_extra_info.grains_size[0] = 8;
    create_extra_info.max_tags_value[0] = 8;
    ...
    int *interface_id)
{
     ...
     */
    alloc_info.tags[0] = nof_interfaces;
    ...
    int nof_interfaces)
{
    ...
    SHR_IF_ERR_EXIT(sch_alloc_db.interface.free_several(unit, core, nof_interfaces, interface_id, NULL));
