...
const dnxf_init_step_t dnxf_ha_modules_init_deinit_seq[] = {
    ...
    {DNXF_INIT_STEP_SW_STATE,            "SW_State",             soc_dnxf_sw_state_init,       soc_dnxf_sw_state_deinit,            TIME_PER_DEV,     NULL},
...
const dnxf_init_step_t dnxf_soc_init_deinit_seq[] = {
   /* STEP_ID,                          STEP_NAME,             STEP_INIT,                     STEP_DEINIT,                         STEP_FLAGS       SUB_STEP_LIST_PTR     */
...
#endif
    {DNXF_INIT_STEP_DEVICE_RESET,      "Device reset",         soc_dnxf_init_device_reset,    soc_dnxf_init_device_reset_deinit,   TIME_PER_DEV,    NULL},
    ...
    {DNXF_INIT_STEP_INTERRUPTS,        "Interrupts",           soc_dnxf_interrupts_init,      soc_dnxf_interrupts_deinit,          TIME_PER_DEV,    NULL},
...
const dnxf_init_step_t dnxf_init_deinit_seq[] = {
  ...
  /*                                                              V                             |                                                       */
    ...
    {DNXF_INIT_STEP_STAT,              "Stat",                 dnxf_stat_init,                dnxf_stat_deinit,                   TIME_PER_DEV,     NULL},
