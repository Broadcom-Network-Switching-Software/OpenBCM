 ...
 * cint cint_vswitch_cross_connect_p2p_one_way.c 
 * cint 
 * run(<unit>, <port1>, <port2>); 
 *  
 * run packets: 
 ...
 *  
 * the packet should arrive at system port (port2) unchanged.
 *  
 */
...
int 
run(int unit, int port1, int port2) {
    int port, i;
    int rv;
