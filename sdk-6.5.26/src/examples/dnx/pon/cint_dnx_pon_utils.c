    ...
    bcm_port_ethertype_t up_ethertype, int mac_sav, bcm_gport_t *gport)
{
    ...
    if (mac_sav) {
        vlan_port.flags2 |= 0x00000002; /*BCM_VLAN_PORT_FLAGS2_MAC_SAV*/
    }
                            ...
                            bcm_gport_t pon_gport)
{
    ...
    if (rv != BCM_E_NONE) {
        printf("Error, bcm_vlan_translate_action_id_destroy_all ing $rv\n");
        return rv;
    }
    return rv;
}
...
int pon_port_egress_vt_destroy(int unit)
{
    ...
    if (rv != BCM_E_NONE) {
        printf("Error, bcm_vlan_translate_action_id_destroy_all egr $rv\n");
        return rv;
    }
    return rv;
}
