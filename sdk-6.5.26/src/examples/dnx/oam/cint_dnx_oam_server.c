...
dnx_oam_server_client_ep_global_config_s dnx_oam_server_client_endpoint_info_glb = {
    ...
    /* server_vp1, server_vp2, client_vp1, client_vp2 */
    0, 0, 0, 0,
...
int oamp_server_create_vlan_ports(int server_unit, int client_unit, int server_port1, int server_port2, int client_port1, int client_port2) {
    ...
    rv = bcm_vlan_port_create(server_unit,&dnx_oam_server_client_endpoint_info_glb.server_vp1);
    if (rv != BCM_E_NONE) {
        printf("(%s) \n",bcm_errmsg(rv));
        return rv;
    }
    ...
    rv = bcm_vlan_port_create(server_unit,&dnx_oam_server_client_endpoint_info_glb.server_vp2);
    if (rv != BCM_E_NONE) {
        printf("(%s) \n",bcm_errmsg(rv));
        return rv;
    }
    ...
    rv = bcm_vlan_port_create(client_unit,&dnx_oam_server_client_endpoint_info_glb.client_vp1);
    if (rv != BCM_E_NONE) {
        printf("(%s) \n",bcm_errmsg(rv));
        return rv;
    }
    ...
    rv = bcm_vlan_port_create(client_unit,&dnx_oam_server_client_endpoint_info_glb.client_vp2);
    if (rv != BCM_E_NONE) {
        printf("(%s) \n",bcm_errmsg(rv));
        return rv;
    }
    ...
    rv = bcm_vswitch_cross_connect_add(server_unit, &dnx_oam_server_client_endpoint_info_glb.server_cross_connect);
    if (rv != BCM_E_NONE) {
        printf("(%s) \n",bcm_errmsg(rv));
        return rv;
    }
    ...
    rv = bcm_vswitch_cross_connect_add(client_unit, &dnx_oam_server_client_endpoint_info_glb.client_cross_connect);
    if (rv != BCM_E_NONE) {
        printf("(%s) \n",bcm_errmsg(rv));
        return rv;
    }
...
int oamp_server_set_server_endpoints(int server_unit, int client_unit, int server_port1, int server_port2, int client_port1, int client_port2, int is_server_client) {
    ...
    rv = port_to_system_port(client_unit, client_port1, &dnx_oam_server_client_endpoint_info_glb.ep_server_down.tx_gport); /* Set the transmission port to be the down MEP's port on the client */
    if (rv != BCM_E_NONE) {
        printf("(%s) \n", bcm_errmsg(rv));
        return rv;
    }
    ...
    if(is_server_client)
    {
        ...
        rv = oam__my_cfm_mac_set(server_unit, server_port1, dnx_oam_server_client_endpoint_info_glb.mac_mep_1);
        if (rv != BCM_E_NONE) {
        ...
        rv = bcm_oam_lif_profile_set(server_unit, 0, dnx_oam_server_client_endpoint_info_glb.server_vp1.vlan_port_id, ingress_profile, egress_profile);
        if (rv != BCM_E_NONE) {
          printf("bcm_oam_lif_profile_set\n");
          return rv;
        }
        rv = bcm_oam_lif_profile_set(server_unit, 0, dnx_oam_server_client_endpoint_info_glb.server_vp2.vlan_port_id, ingress_profile, egress_profile);
        if (rv != BCM_E_NONE) {
          printf("bcm_oam_lif_profile_set\n");
          return rv;
        }
    ...
    rv = bcm_oam_endpoint_create(server_unit, &dnx_oam_server_client_endpoint_info_glb.ep_server_down);
    if (rv != BCM_E_NONE) {
        printf("(%s) \n", bcm_errmsg(rv));
        return rv;
    }
    ...
    rv = bcm_oam_endpoint_create(server_unit, &dnx_oam_server_client_endpoint_info_glb.rmep);
    if (rv != BCM_E_NONE) {
        printf("(%s) \n", bcm_errmsg(rv));
        return rv;
    }
     ...
     */
    rv = port_to_system_port(client_unit, recycle_port, &dnx_oam_server_client_endpoint_info_glb.ep_server_up.tx_gport);
    if (rv != BCM_E_NONE) {
        printf("(%s) \n", bcm_errmsg(rv));
        return rv;
    }
    ...
    rv = bcm_oam_endpoint_create(server_unit, &dnx_oam_server_client_endpoint_info_glb.ep_server_up);
    if (rv != BCM_E_NONE) {
        printf("(%s) \n", bcm_errmsg(rv));
        return rv;
    }
...
int oamp_server_set_client_endpoints(int server_unit, int client_unit, int server_port1, int server_port2, int client_port1, int client_port2) {
    ...
    /* Setting My-CFM-MAC (for Jericho2 Only)*/
    rv = oam__my_cfm_mac_set(client_unit, client_port1, dnx_oam_server_client_endpoint_info_glb.mac_mep_1);
    if (rv != BCM_E_NONE) {
        printf("oam__my_cfm_mac_set fail \n");
        return rv;
    }
    ...
    rv = bcm_oam_lif_profile_set(client_unit, 0, dnx_oam_server_client_endpoint_info_glb.client_vp1.vlan_port_id, ingress_profile, egress_profile);
    if (rv != BCM_E_NONE) {
      printf("bcm_oam_lif_profile_set\n");
      return rv;
    }
    ...
    rv = bcm_oam_lif_profile_set(client_unit, 0, dnx_oam_server_client_endpoint_info_glb.client_vp2.vlan_port_id, ingress_profile, egress_profile);
    if (rv != BCM_E_NONE) {
      printf("bcm_oam_lif_profile_set\n");
      return rv;
    }
    ...
    rv = bcm_oam_endpoint_create(client_unit, &dnx_oam_server_client_endpoint_info_glb.ep_client_down);
    if (rv != BCM_E_NONE) {
        printf("(%s) \n", bcm_errmsg(rv));
        return rv;
    }
    ...
    /* Setting My-CFM-MAC (for Jericho2 Only)*/
    rv = oam__my_cfm_mac_set(client_unit, client_port2, dnx_oam_server_client_endpoint_info_glb.mac_mep_2);
    if (rv != BCM_E_NONE) {
        printf("oam__my_cfm_mac_set fail \n");
        return rv;
    }
    ...
    rv = bcm_oam_endpoint_create(client_unit, &dnx_oam_server_client_endpoint_info_glb.ep_client_up);
    if (rv != BCM_E_NONE) {
        printf("(%s) \n", bcm_errmsg(rv));
        return rv;
    }
...
int oamp_server_set_multi_server_endpoints_down(int server_unit, int client_unit, int server_port1, int server_port2, int client_port1, int client_port2) {
    ...
    rv = port_to_system_port(client_unit, client_port1, &dnx_oam_server_client_endpoint_info_glb.ep_server_down.tx_gport);
    if (rv != BCM_E_NONE) {
        printf("(%s) \n", bcm_errmsg(rv));
        return rv;
    }
    ...
    sal_memcpy(ep_server_down2.src_mac_address, dnx_oam_server_client_endpoint_info_glb.src_mac_1, 6);
    BCM_GPORT_TRAP_SET(ep_server_down2.remote_gport, dnx_oam_server_client_endpoint_info_glb.trap_code, 7, 0);
    ...
    ep_server_down2.group = dnx_oam_server_client_endpoint_info_glb.group_info_short_ma_server.id;
    ep_server_down2.level = dnx_oam_server_client_endpoint_info_glb.down_mdl;
    ...
    bcm_oam_endpoint_info_t_init(dnx_oam_server_client_endpoint_info_glb.rmep);
    dnx_oam_server_client_endpoint_info_glb.rmep.name = 202;
    dnx_oam_server_client_endpoint_info_glb.rmep.local_id = ep_server_down2.id;
    dnx_oam_server_client_endpoint_info_glb.rmep.type = bcmOAMEndpointTypeEthernet;
    dnx_oam_server_client_endpoint_info_glb.rmep.ccm_period = BCM_OAM_ENDPOINT_CCM_PERIOD_100MS;
    dnx_oam_server_client_endpoint_info_glb.rmep.flags |= BCM_OAM_ENDPOINT_REMOTE | BCM_OAM_ENDPOINT_WITH_ID;
    dnx_oam_server_client_endpoint_info_glb.rmep.loc_clear_threshold = 1;
    dnx_oam_server_client_endpoint_info_glb.rmep.id = ep_server_down2.id;
    rv = bcm_oam_endpoint_create(client_unit, &dnx_oam_server_client_endpoint_info_glb.rmep);
    if (rv != BCM_E_NONE) {
        printf("(%s) \n", bcm_errmsg(rv));
        return rv;
    }
    ...
    ep_client_down2.gport = dnx_oam_server_client_endpoint_info_glb.client_vp2.vlan_port_id;
    ep_client_down2.flags = BCM_OAM_ENDPOINT_WITH_ID;
    ep_client_down2.type = bcmOAMEndpointTypeEthernet;
    ep_client_down2.group = dnx_oam_server_client_endpoint_info_glb.group_info_short_ma_client.id;
    ep_client_down2.level = dnx_oam_server_client_endpoint_info_glb.down_mdl;
...
int oamp_server_set_multi_server_endpoints_up(int server_unit, int client_unit, int server_port1, int server_port2, int client_port1, int client_port2) {
    ...
    sal_memcpy(ep_server_up2.src_mac_address, dnx_oam_server_client_endpoint_info_glb.src_mac_1, 6);
     ...
     */
    BCM_GPORT_TRAP_SET(dnx_oam_server_client_endpoint_info_glb.ep_server_up.remote_gport, dnx_oam_server_client_endpoint_info_glb.trap_code_up_ing, 7, 0);
    ep_server_up2.remote_gport = dnx_oam_server_client_endpoint_info_glb.ep_server_up.remote_gport;
    ...
    int core, tm_port;
    rv = get_core_and_tm_port_from_port(client_unit,client_port1,&core,&tm_port);
    if (rv != BCM_E_NONE){
        printf("Error, in get_core_and_tm_port_from_port\n");
        return rv;
    }
    ...
    rv = port_to_system_port(client_unit, recycle_port, &ep_server_up2.tx_gport);
    if (rv != BCM_E_NONE) {
        printf("(%s) \n", bcm_errmsg(rv));
        return rv;
    }
    ...
    ep_server_up2.group = dnx_oam_server_client_endpoint_info_glb.group_info_short_ma_server.id;
    ep_server_up2.level = dnx_oam_server_client_endpoint_info_glb.up_mdl;
    ...
    bcm_oam_endpoint_info_t_init(dnx_oam_server_client_endpoint_info_glb.rmep);
    dnx_oam_server_client_endpoint_info_glb.rmep.name = 202;
    dnx_oam_server_client_endpoint_info_glb.rmep.local_id = ep_server_up2.id;
    dnx_oam_server_client_endpoint_info_glb.rmep.type = bcmOAMEndpointTypeEthernet;
    dnx_oam_server_client_endpoint_info_glb.rmep.ccm_period = BCM_OAM_ENDPOINT_CCM_PERIOD_100MS;
    dnx_oam_server_client_endpoint_info_glb.rmep.flags |= BCM_OAM_ENDPOINT_REMOTE | BCM_OAM_ENDPOINT_WITH_ID;
    dnx_oam_server_client_endpoint_info_glb.rmep.loc_clear_threshold = 1;
    dnx_oam_server_client_endpoint_info_glb.rmep.id = ep_server_up2.id;
    rv = bcm_oam_endpoint_create(client_unit, &dnx_oam_server_client_endpoint_info_glb.rmep);
    if (rv != BCM_E_NONE) {
        printf("(%s) \n", bcm_errmsg(rv));
        return rv;
    ...
    ep_client_up2.gport = dnx_oam_server_client_endpoint_info_glb.client_vp2.vlan_port_id;
    ep_client_up2.flags = BCM_OAM_ENDPOINT_WITH_ID | BCM_OAM_ENDPOINT_UP_FACING;
    ep_client_up2.type = bcmOAMEndpointTypeEthernet;
    ep_client_up2.group = dnx_oam_server_client_endpoint_info_glb.group_info_short_ma_client.id;
    ep_client_up2.level = dnx_oam_server_client_endpoint_info_glb.up_mdl;
    ep_client_up2.lm_counter_base_id = dnx_oam_server_client_endpoint_info_glb.counter_base_id_upmep;
...
int create_special_ingress_trap_for_upmep(int client_unit, int server_unit)
{
    ...
    rv = bcm_rx_trap_type_create(client_unit, 0, bcmRxTrapUserDefine, &dnx_oam_server_client_endpoint_info_glb.trap_code_up_ing);
    if (rv != BCM_E_NONE) {
        printf("(%s) \n", bcm_errmsg(rv));
        return rv;
    }
    ...
    rv = bcm_rx_trap_set(client_unit, dnx_oam_server_client_endpoint_info_glb.trap_code_up_ing, dnx_oam_server_client_endpoint_info_glb.trap_to_server_oamp);
    if (rv != BCM_E_NONE) {
        printf("(%s) \n", bcm_errmsg(rv));
        return rv;
    }
...
int oamp_server_create_traps(int server_unit, int client_unit) {
    ...
    rv = bcm_rx_trap_type_create(client_unit, 0, bcmRxTrapUserDefine, &dnx_oam_server_client_endpoint_info_glb.trap_code);
    if (rv != BCM_E_NONE) {
        printf("(%s) \n", bcm_errmsg(rv));
        return rv;
    }
    ...
    rv = port_to_system_port(server_unit, dnx_oam_server_client_endpoint_info_glb.server_oamp_port, &dnx_oam_server_client_endpoint_info_glb.trap_to_server_oamp.dest_port);
    ...
    rv = bcm_rx_trap_set(client_unit, dnx_oam_server_client_endpoint_info_glb.trap_code, dnx_oam_server_client_endpoint_info_glb.trap_to_server_oamp);
    if (rv != BCM_E_NONE) {
        printf("(%s) \n", bcm_errmsg(rv));
        return rv;
    }
    ...
    rv = bcm_rx_trap_type_create(server_unit, BCM_RX_TRAP_WITH_ID, bcmRxTrapUserDefine, &dnx_oam_server_client_endpoint_info_glb.trap_code);
    if (rv != BCM_E_NONE) {
        printf("(%s) \n", bcm_errmsg(rv));
        return rv;
    }

    rv = bcm_rx_trap_set(server_unit, dnx_oam_server_client_endpoint_info_glb.trap_code, dnx_oam_server_client_endpoint_info_glb.trap_to_server_oamp);
    if (rv != BCM_E_NONE) {
        printf("(%s) \n", bcm_errmsg(rv));
        return rv;
    }
    ...
    rv = create_special_ingress_trap_for_upmep(client_unit, server_unit);
    if (rv != BCM_E_NONE) {
        printf("(%s) \n", bcm_errmsg(rv));
        return rv;
    }
    rv = bcm_rx_trap_type_create(client_unit, 0, bcmRxTrapEgTxOamUpMEPDest2, &dnx_oam_server_client_endpoint_info_glb.trap_code_up);
    if (rv != BCM_E_NONE) {
        printf("(%s) \n", bcm_errmsg(rv));
    }
    ...
    rv = bcm_rx_trap_set(client_unit, dnx_oam_server_client_endpoint_info_glb.trap_code_up, dnx_oam_server_client_endpoint_info_glb.trap_to_server_oamp);
    if (rv != BCM_E_NONE) {
        printf("(%s) \n", bcm_errmsg(rv));
        return rv;
    }
...
int oamp_server_example(int server_unit, int client_unit, int server_port1, int server_port2, int client_port1, int client_port2) {
     ...
     */
    rv = set_counter_resource(client_unit, client_port1, counter_if_0, 1, &dnx_oam_server_client_endpoint_info_glb.counter_base_id_downmep);
    if (rv != BCM_E_NONE)
    {
        printf("Error no %d, in set_counter_resource.\n", rv);
        return rv;
    }
    rv = set_counter_resource(client_unit, client_port2, counter_if_1, 1, &dnx_oam_server_client_endpoint_info_glb.counter_base_id_upmep);
    if (rv != BCM_E_NONE)
    {
        printf("Error no %d, in set_counter_resource.\n", rv);
        return rv;
    ...
    rv = bcm_oam_group_create(server_unit, &dnx_oam_server_client_endpoint_info_glb.group_info_short_ma_server);
    if (rv != BCM_E_NONE) {
        printf("(%s) \n",bcm_errmsg(rv));
        return rv;
    }
    ...
    rv = bcm_oam_group_create(client_unit, &dnx_oam_server_client_endpoint_info_glb.group_info_short_ma_client);
    if (rv != BCM_E_NONE) {
        printf("(%s) \n",bcm_errmsg(rv));
        return rv;
    }
...
int oamp_server_switch_upmep_tx_unit(int server_unit, int server_upmep_id, int new_tx_unit, int new_tx_port, int new_entering_vlan) {
    ...
    bcm_oam_endpoint_info_t_init(dnx_oam_server_client_endpoint_info_glb.ep_server_up);
    rv = bcm_oam_endpoint_get(server_unit, server_upmep_id, &dnx_oam_server_client_endpoint_info_glb.ep_server_up);
    if (rv != BCM_E_NONE) {
        printf("(%s) \n", bcm_errmsg(rv));
        return rv;
    }
    ...
    rv = port_to_system_port(new_tx_unit, recycle_port, &dnx_oam_server_client_endpoint_info_glb.ep_server_up.tx_gport); /* After recycling, source port (on PTCH) will be new_tx_gport*/
    if (rv != BCM_E_NONE) {
        printf("(%s) \n", bcm_errmsg(rv));
        return rv;
    }
...
int field_oam_advanced_features(int unit) {
    ...
    result = field__prge_action_code_add_entry(unit, grp_tcam, dnx_oam_server_client_endpoint_info_glb.trap_code, 232/*dest_port (OAMP PP port)*/,
                                               qual_id, 3 /*prge_action_code_oam_end_tlv_wa*/);
    if (BCM_E_NONE != result) {
        printf("Error in prge_end_tlv_add_entry\n");
        return result;
...
int oamp_multi_servers_clients_example(int server_unit, int client_unit, int server_port1, int server_port2, int client_port1, int client_port2, int is_up) {
    ...
    if (is_up) {
        ...
        bcm_vswitch_cross_connect_t_init(&dnx_oam_server_client_endpoint_info_glb.client_cross_connect);
        dnx_oam_server_client_endpoint_info_glb.client_cross_connect.port1 = dnx_oam_server_client_endpoint_info_glb.client_vp1.vlan_port_id;
        dnx_oam_server_client_endpoint_info_glb.client_cross_connect.port2 = client_vp3.vlan_port_id;
        rv = bcm_vswitch_cross_connect_add(client_unit, &dnx_oam_server_client_endpoint_info_glb.client_cross_connect);
        if (rv != BCM_E_NONE) {
            printf("(%s) \n",bcm_errmsg(rv));
            return rv;
