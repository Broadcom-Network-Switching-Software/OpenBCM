    ...
    int unit)
{
    ...
    rv = bcm_multicast_create(unit, (flags | BCM_MULTICAST_WITH_ID), &l2_mact_table_info1.mc_id);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = bcm_multicast_add(unit, l2_mact_table_info1.mc_id, flags, 2, replications);
    if (rv != BCM_E_NONE)
    {
