...
int e2e_composite_se_setup(int unit, int kbits_sec_max_port, int port_idx)
{
    ...
    rv = bcm_cosq_scheduler_gport_add(unit, default_flags, params, &c4_gport_ucast_scheduler[idx]);
    if (rv != BCM_E_NONE) {
    ...
    rv = bcm_cosq_scheduler_gport_add(unit, default_flags, params, &c4_gport_ucast_scheduler1[idx]);
    if (rv != BCM_E_NONE) {
        printf("bcm_cosq_scheduler_gport_add scheduler failed $rv\n");
        return rv;
    }
    ...
    rv = bcm_cosq_scheduler_gport_add(unit, default_flags, params, &c4_gport_ucast_scheduler_fq0[idx]);
    ...
    rv = bcm_cosq_scheduler_gport_add(unit, default_flags, params, &c4_gport_ucast_scheduler_fq1[idx]);
    if (rv != BCM_E_NONE) {
        printf("bcm_cosq_scheduler_gport_add scheduler failed $rv\n");
        return rv;
    }
    ...
    rv = bcm_cosq_scheduler_gport_add(unit, default_flags, params, &c4_gport_ucast_scheduler_fq2[idx]);
    if (rv != BCM_E_NONE) {
        printf("bcm_cosq_scheduler_gport_add scheduler failed $rv\n");
        return rv;
    }
    ...
    rv = bcm_cosq_scheduler_gport_add(unit, default_flags, params, &c4_gport_ucast_scheduler_fq3[idx]);
    if (rv != BCM_E_NONE) {
        printf("bcm_cosq_scheduler_gport_add scheduler failed $rv\n");
        return rv;
    }
    ...
    rv = bcm_cosq_ingress_queue_bundle_gport_add(unit, &conf, &c4_gport_ucast_queue_group0[idx]);
    if (rv != BCM_E_NONE) {
    ...
    rv = bcm_cosq_ingress_queue_bundle_gport_add(unit, &conf, &c4_gport_ucast_queue_group1[idx]);
    if (rv != BCM_E_NONE) {
        printf("bcm_cosq_ingress_queue_bundle_gport_add failed\n");
        return rv;
    }
...
e2e_composite_se_verify(int unit, int kbits_sec_max_port, int port_idx)
{
    ...
    rc = bcm_cosq_scheduler_gport_get(unit, 0, c4_e2e_gport[idx], &params_get);
    if (rc != BCM_E_NONE) {
    ...
    for (nbr_sched = 0; nbr_sched < C4_NBR_SCHEDULERS; nbr_sched++) {
        ...
        rc = bcm_cosq_scheduler_gport_get(unit, 0, gport_ucast_scheduler, &params_get);
        if (rc != BCM_E_NONE) {
