    ...
    bcm_port_t port)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_trunk_create(unit, BCM_TRUNK_FLAG_DONT_ALLOCATE_PP_PORTS, &Cint_field_trunk_port_quals_trunk_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_trunk_pp_port_allocation_set(unit, Cint_field_trunk_port_quals_trunk_id, 0, &trunk_pp_port_aloc_info));


    bcm_trunk_pp_port_allocation_info_t_init(&trunk_pp_port_aloc_info_get);
    BCM_IF_ERROR_RETURN(bcm_trunk_pp_port_allocation_get(unit, Cint_field_trunk_port_quals_trunk_id, 0, &trunk_pp_port_aloc_info_get));
    ...
    BCM_IF_ERROR_RETURN(bcm_switch_control_indexed_port_set(unit, Cint_field_trunk_port_quals_trunk_gport, switch_control_key_info, switch_control_info));
    ...
    BCM_IF_ERROR_RETURN(bcm_trunk_set(unit, Cint_field_trunk_port_quals_trunk_id, &trunk_info, 1, trunk_members_info));
    ...
    bcm_gport_t trunk_gport)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &Cint_field_trunk_port_quals_fg_id));


    printf("Field Group ID %d was created. \n", Cint_field_trunk_port_quals_fg_id);

    
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, Cint_field_trunk_port_quals_fg_id, context_id, &attach_info));
    ...
    bcm_port_t out_port)
{
    ...
    BCM_IF_ERROR_RETURN(cint_field_trunk_port_quals_trunk_config(unit, out_port));
    ...
    BCM_IF_ERROR_RETURN(bcm_l2_addr_add(unit, l2_addr_info));


    BCM_IF_ERROR_RETURN(cint_field_trunk_port_quals_group_config(unit, FALSE, core, bcmFieldStageEgress, context_id, bcmFieldQualifyOutPort, 0x1FF, Cint_field_trunk_port_quals_trunk_gport));
    ...
    bcm_port_t out_port)
{
    ...
    BCM_IF_ERROR_RETURN(cint_field_trunk_port_quals_group_config(unit, FALSE, core, bcmFieldStageEgress, context_id, bcmFieldQualifyDstPort, 0xFFFF, Cint_field_trunk_port_quals_trunk_gport));
...
int cint_field_trunk_port_quals_in_port_main(
    ...
    bcm_port_t in_port)
{
    BCM_IF_ERROR_RETURN(cint_field_trunk_port_quals_trunk_config(unit, in_port));

    BCM_IF_ERROR_RETURN(cint_field_trunk_port_quals_group_config(unit, FALSE, core, bcmFieldStageIngressPMF1, context_id, bcmFieldQualifyInPort, 0x1FF, Cint_field_trunk_port_quals_trunk_gport));
    ...
    bcm_port_t in_port)
{
    ...
    BCM_IF_ERROR_RETURN(cint_field_trunk_port_quals_group_config(unit, FALSE, core, bcmFieldStageIngressPMF1, context_id, bcmFieldQualifySrcPort, 0xFFFF, Cint_field_trunk_port_quals_trunk_gport));
    ...
    int port_class)
{
    ...
    BCM_IF_ERROR_RETURN(cint_field_trunk_port_quals_group_config(unit, FALSE, core, stage, context_id, bcmFieldQualifyPortClassPacketProcessing, 0xFFFFFF, port_class));


    if (stage == bcmFieldStageEgress)
    {
        BCM_IF_ERROR_RETURN(bcm_port_class_get(unit, Cint_field_trunk_port_quals_trunk_gport, bcmPortClassFieldEgressPacketProcessingPort, &returned_class_id));
    ...
    {
        BCM_IF_ERROR_RETURN(bcm_port_class_get(unit, Cint_field_trunk_port_quals_trunk_gport, bcmPortClassFieldIngressPMF1PacketProcessingPort, &returned_class_id));
        if (returned_class_id != port_class)
        {
    ...
    int port_class)
{
    ...
    BCM_IF_ERROR_RETURN(cint_field_trunk_port_quals_group_config(unit, FALSE, core, stage, context_id, bcmFieldQualifyPortClassTrafficManagement, 0xFFFFFF, port_class));


    if (stage == bcmFieldStageEgress)
    {
        BCM_IF_ERROR_RETURN(bcm_port_class_get(unit, Cint_field_trunk_port_quals_trunk_gport, bcmPortClassFieldEgressTrafficManagementPort, &returned_class_id));
        if (returned_class_id != port_class)
        {
    ...
    {
        BCM_IF_ERROR_RETURN(bcm_port_class_get(unit, Cint_field_trunk_port_quals_trunk_gport, bcmPortClassFieldIngressPMF1TrafficManagementPort, &returned_class_id));
        if (returned_class_id != port_class)
        {
...
int cint_field_trunk_port_quals_destroy(
    ...
    bcm_field_context_t context_id)
{
    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, Cint_field_trunk_port_quals_fg_id, NULL, Cint_field_trunk_port_quals_entry_handle));
    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, Cint_field_trunk_port_quals_fg_id, context_id));
    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, Cint_field_trunk_port_quals_fg_id));
    BCM_IF_ERROR_RETURN(bcm_trunk_destroy(unit, Cint_field_trunk_port_quals_trunk_id));
