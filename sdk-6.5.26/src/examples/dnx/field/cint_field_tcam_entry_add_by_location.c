...
int field_tcam_entry_add_by_location(int unit, bcm_field_context_t context_id)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &cint_field_tcam_entry_add_by_location_fg_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, cint_field_tcam_entry_add_by_location_fg_id, context_id, &attach_info));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, cint_field_tcam_entry_add_by_location_fg_id, &ent_info, &cint_field_tcam_entry_add_by_location_entry_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, cint_field_tcam_entry_add_by_location_fg_id, &ent_info, &cint_field_tcam_entry_add_by_location_entry_id_2));
...
{
    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, cint_field_tcam_entry_add_by_location_fg_id, context_id));

    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, cint_field_tcam_entry_add_by_location_fg_id, NULL, cint_field_tcam_entry_add_by_location_entry_id));

    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, cint_field_tcam_entry_add_by_location_fg_id, NULL, cint_field_tcam_entry_add_by_location_entry_id_2));

    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, cint_field_tcam_entry_add_by_location_fg_id));
