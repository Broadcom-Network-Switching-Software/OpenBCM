...
{
    printf("Running: cint_field_external_payload_positioning_choose_placement()\n");
    ...
    int unit)
{
    ...
    char *tmp_ptr;
    int fg_id_index;
    printf("Running: cint_field_external_payload_positioning_fg_add()\n");
    ...
    for (fg_id_index = 0; fg_id_index < cint_field_external_payload_positioning_nof_fg; fg_id_index++)
    {
        ...
        BCM_IF_ERROR_RETURN(bcm_field_action_create(unit, 0, &action_info, &(cint_field_external_payload_positioning_fg_info[fg_id_index].action_types[0])));
        ...
        BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &cint_field_external_payload_positioning_fg_info[fg_id_index], &cint_field_external_payload_positioning_fg_id[fg_id_index]));
    ...
    bcm_field_AppType_t external_app_type)
{
    ...
    int fg_id_index;
    printf("Running: cint_field_external_payload_positioning_fg_attach()\n");
    ...
    for (fg_id_index = 0; fg_id_index < cint_field_external_payload_positioning_nof_fg; fg_id_index++)
    {
        ...
        BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, cint_field_external_payload_positioning_fg_id[fg_id_index], context_id, &group_attach_info));
    }
    ...
    int unit)
{
    ...
    printf("Running: cint_field_external_payload_positioning_ipmf1()\n");
    
    bcm_field_context_info_t_init(&context_info);
    dest_char = &(context_info.name[0]);
    sal_strncpy_s(dest_char, "ext_PMF_test", sizeof(context_info.name));
    BCM_IF_ERROR_RETURN(bcm_field_context_create(unit, 0, bcmFieldStageIngressPMF1, &context_info, &context_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_presel_set(unit, 0, &p_entry, &p_data));
    ...
    for (fg_id_index = 0; fg_id_index < cint_field_external_payload_positioning_nof_fg; fg_id_index++)
    {
        ...
        BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info, &fg_info.qual_types[qual_index_payload]));
    }
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, BCM_FIELD_FLAG_MSB_RESULT_ALIGN, &fg_info, &cint_field_external_payload_positioning_fg_id_pmf));
    ...
    for (fg_id_index = 0; fg_id_index < cint_field_external_payload_positioning_nof_fg; fg_id_index++)
    {
        ...
        BCM_IF_ERROR_RETURN(bcm_field_group_action_offset_get(unit, 0, cint_field_external_payload_positioning_fg_id[fg_id_index], cint_field_external_payload_positioning_fg_info[fg_id_index].action_types[0], &action_offset_in_fg));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, cint_field_external_payload_positioning_fg_id_pmf, context_id, &attach_info));
...
cint_field_external_payload_positioning_main(int unit)
{
    ...
    printf("Running: cint_field_external_payload_positioning_main()\n");
    ...
    BCM_IF_ERROR_RETURN(cint_field_external_payload_positioning_fg_add(unit));

    /** Choose payload_id and payload_offset.*/
    BCM_IF_ERROR_RETURN(cint_field_external_payload_positioning_choose_placement(unit));

    BCM_IF_ERROR_RETURN(cint_field_external_payload_positioning_fg_attach(unit, cint_field_external_payload_positioning_external_app_type_1));
    BCM_IF_ERROR_RETURN(cint_field_external_payload_positioning_fg_attach(unit, cint_field_external_payload_positioning_external_app_type_2));

    BCM_IF_ERROR_RETURN(bcm_switch_control_set(unit, bcmSwitchExternalTcamSync, 0));

    BCM_IF_ERROR_RETURN(cint_field_external_payload_positioning_ipmf1(unit));
