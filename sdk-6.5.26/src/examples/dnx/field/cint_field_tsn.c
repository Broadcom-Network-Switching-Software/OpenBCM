 ...
 *
  ...
  cint_field_tsn_field_info.gate_mode=1;
  cint_field_tsn_field_info.gate_id=0xff;
  cint_field_tsn_field_info.max_frame_size=0xff;
  cint_field_tsn_field_info.meter_id=0xfffff;
  cint_field_tsn_field_info.counter_id=0xfffff;
  cint_field_tsn_field_info.admit_profile=0x7;
...
int cint_field_tsn_main(int unit)
{
    ...
    fg_info.qual_types[2] = bcmFieldQualifyInInterface;
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &cint_field_tsn_fg_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, cint_field_tsn_fg_id, cint_field_tsn_context_id, &attach_info));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, cint_field_tsn_fg_id, &ent_info, &cint_field_tsn_ent_id));
...
{
    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, cint_field_tsn_fg_id, NULL, cint_field_tsn_ent_id));

    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, cint_field_tsn_fg_id, cint_field_tsn_context_id));
    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, cint_field_tsn_fg_id));
    return BCM_E_NONE;
}
