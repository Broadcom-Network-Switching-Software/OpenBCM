    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_context_create(unit, 0, bcmFieldStageExternal, &context_info, &app_type_user_1_as_context));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_context_create(unit, 0, bcmFieldStageExternal, &context_info, &app_type_user_2_as_context));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_presel_set(unit, 0, &cint_field_external_ud_apptype_presel_entry_id_info_1_predef, &presel_entry_data));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_presel_set(unit, 0, &cint_field_external_ud_apptype_presel_entry_id_info_2_user_1, &presel_entry_data));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_presel_set(unit, 0, &cint_field_external_ud_apptype_presel_entry_id_info_3_user_2_1, &presel_entry_data));
    ...
    presel_entry_data.qual_data[0].qual_mask = 0x1F;
    BCM_IF_ERROR_RETURN(bcm_field_presel_set(unit, 0, &cint_field_external_ud_apptype_presel_entry_id_info_3_user_2_2, &presel_entry_data));
    ...
    bcm_field_group_t * fg_id_p)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_action_create(unit, 0, &action_info, &cint_field_external_ud_apptype_external_uda_predef));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, fg_info_p, fg_id_p));
    ...
    bcm_field_group_t * fg_id_p)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_action_create(unit, 0, &action_info, &cint_field_external_ud_apptype_external_uda_user_1));
    ...
    bcm_field_group_t * fg_id_p)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_action_create(unit, 0, &action_info, &cint_field_external_ud_apptype_external_uda_user_2));
    ...
    bcm_field_entry_t * entry_id_p)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, external_fg_id, &entry_info, entry_id_p));
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_context_create(unit, 0, bcmFieldStageIngressPMF1, &context_info, &cint_field_external_ud_apptype_ipmf1_context_1));
    bcm_field_context_info_t_init(&context_info);
    dest_char = &(context_info.name[0]);
    sal_strncpy_s(dest_char, "ext_PMF_test_2", sizeof(context_info.name));
    BCM_IF_ERROR_RETURN(bcm_field_context_create(unit, 0, bcmFieldStageIngressPMF1, &context_info, &cint_field_external_ud_apptype_ipmf1_context_2));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_presel_set(unit, 0, &cint_field_external_ud_apptype_presel_entry_id_1, &ipmf1_p_data));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_presel_set(unit, 0, &cint_field_external_ud_apptype_presel_entry_id_2, &ipmf1_p_data));
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_action_info_get(unit, cint_field_external_ud_apptype_ipmf2_action, bcmFieldStageIngressPMF2, &action_info));
    qual_info.size = action_info.size;
    dest_char = &(qual_info.name[0]);
    sal_strncpy_s(dest_char, "ext_iPMF2", sizeof(qual_info.name));
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_external_ud_apptype_ipmf2_payload_qual));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &cint_field_external_ud_apptype_fg_id_ipmf2));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, cint_field_external_ud_apptype_fg_id_ipmf2, cint_field_external_ud_apptype_ipmf1_context_1, &attach_info));
...
cint_field_external_ud_apptype_main(int unit)
{
    ...
    BCM_IF_ERROR_RETURN(cint_field_external_ud_apptype_apptype_create(unit));

    BCM_IF_ERROR_RETURN(cint_field_external_ud_apptype_fg_add_predef(unit, &fg_info_predef, &cint_field_external_ud_apptype_fg_id_predef));
    BCM_IF_ERROR_RETURN(cint_field_external_ud_apptype_fg_add_user_1(unit, &fg_info_user_1, &cint_field_external_ud_apptype_fg_id_user_1));
    BCM_IF_ERROR_RETURN(cint_field_external_ud_apptype_fg_add_user_2(unit, &fg_info_user_2, &cint_field_external_ud_apptype_fg_id_user_2));

    BCM_IF_ERROR_RETURN(cint_field_external_ud_apptype_fg_attach(unit, cint_field_external_ud_apptype_fg_id_predef, &fg_info_predef, cint_field_external_ud_apptype_external_app_type_predef, cint_field_external_ud_apptype_payload_id, cint_field_external_ud_apptype_payload_offset));
    BCM_IF_ERROR_RETURN(cint_field_external_ud_apptype_fg_attach(unit, cint_field_external_ud_apptype_fg_id_user_1, &fg_info_user_1, cint_field_external_ud_apptype_external_app_type_user_1, cint_field_external_ud_apptype_payload_id, cint_field_external_ud_apptype_payload_offset));
    BCM_IF_ERROR_RETURN(cint_field_external_ud_apptype_fg_attach(unit, cint_field_external_ud_apptype_fg_id_user_2, &fg_info_user_2, cint_field_external_ud_apptype_external_app_type_user_2, cint_field_external_ud_apptype_payload_id, cint_field_external_ud_apptype_payload_offset));

    BCM_IF_ERROR_RETURN(bcm_switch_control_set(unit, bcmSwitchExternalTcamSync, 0));

    BCM_IF_ERROR_RETURN(cint_field_external_ud_apptype_entry_add(unit, cint_field_external_ud_apptype_fg_id_predef, &fg_info_predef, cint_field_external_ud_apptype_payload_value_predef, &cint_field_external_ud_apptype_entry_id_predef));
    BCM_IF_ERROR_RETURN(cint_field_external_ud_apptype_entry_add(unit, cint_field_external_ud_apptype_fg_id_user_1, &fg_info_user_1, cint_field_external_ud_apptype_payload_value_user_1, &cint_field_external_ud_apptype_entry_id_user_1));
    BCM_IF_ERROR_RETURN(cint_field_external_ud_apptype_entry_add(unit, cint_field_external_ud_apptype_fg_id_user_2, &fg_info_user_2, cint_field_external_ud_apptype_payload_value_user_2, &cint_field_external_ud_apptype_entry_id_user_2));
    ...
    BCM_IF_ERROR_RETURN(cint_field_external_ud_apptype_context_ipmf1_create(unit));
    
    BCM_IF_ERROR_RETURN(cint_field_external_ud_apptype_fg_ipmf2_add(unit));
...
cint_field_external_ud_apptype_destroy(int unit)
{
     ...
     */
    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, cint_field_external_ud_apptype_fg_id_predef, NULL, cint_field_external_ud_apptype_entry_id_predef));
    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, cint_field_external_ud_apptype_fg_id_user_1, NULL, cint_field_external_ud_apptype_entry_id_user_1));
    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, cint_field_external_ud_apptype_fg_id_user_2, NULL, cint_field_external_ud_apptype_entry_id_user_2));

    bcm_field_presel_entry_data_info_init(&presel_entry_data);
    presel_entry_data.entry_valid = FALSE;
    presel_entry_data.context_id = 0;
    BCM_IF_ERROR_RETURN(bcm_field_presel_set(unit, 0, &cint_field_external_ud_apptype_presel_entry_id_1, &presel_entry_data));
    BCM_IF_ERROR_RETURN(bcm_field_presel_set(unit, 0, &cint_field_external_ud_apptype_presel_entry_id_2, &presel_entry_data));
    BCM_IF_ERROR_RETURN(bcm_field_presel_set(unit, 0, &cint_field_external_ud_apptype_presel_entry_id_info_1_predef, &presel_entry_data));
    BCM_IF_ERROR_RETURN(bcm_field_presel_set(unit, 0, &cint_field_external_ud_apptype_presel_entry_id_info_2_user_1, &presel_entry_data));
    BCM_IF_ERROR_RETURN(bcm_field_presel_set(unit, 0, &cint_field_external_ud_apptype_presel_entry_id_info_3_user_2_1, &presel_entry_data));
    BCM_IF_ERROR_RETURN(bcm_field_presel_set(unit, 0, &cint_field_external_ud_apptype_presel_entry_id_info_3_user_2_2, &presel_entry_data));
