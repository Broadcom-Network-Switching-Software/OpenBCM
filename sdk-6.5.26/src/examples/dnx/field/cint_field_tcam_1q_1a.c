...
int cint_tcam_1q_1a_entry_add(int unit, uint32 qual_val, uint32 act_val, bcm_field_entry_t *entry_id)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, tcam_1q_1a_fg_id, &ent_info, entry_id));
...
int cint_tcam_1q_1a_main(int unit, bcm_field_stage_t stage,bcm_field_context_t context_id)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &tcam_1q_1a_fg_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, tcam_1q_1a_fg_id, context_id, &attach_info));
...
{
    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, tcam_1q_1a_fg_id, NULL, entry_id));
    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, tcam_1q_1a_fg_id, context_id));
    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit,tcam_1q_1a_fg_id));
