    ...
    int expected_tc)
{
    ...
    BCM_IF_ERROR_RETURN(cint_field_group_const_main(unit, bcmFieldStageIngressPMF2,ipmf2_context,bcmFieldActionContainer,0 , "container_exmpl"));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &ipmf2_fg_info, &IPMF2_FG_ID));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, IPMF2_FG_ID, ipmf2_context, &attach_info));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, IPMF2_FG_ID, &ent_info, IPMF2_ENTRY_HANDLE));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &ipmf3_fg_info, &IPMF3_FG_ID));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, IPMF3_FG_ID, ipmf3_context, &attach_info));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, IPMF3_FG_ID, &ent_info, IPMF3_ENTRY_HANDLE));
...
cint_field_cascaded_destroy(
    ...
    bcm_field_context_t ipmf3_context)
{
    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, IPMF2_FG_ID, ipmf2_context));
    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, IPMF3_FG_ID, ipmf3_context));

    /*Deleting Field group should delete entries as well*/
    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit,IPMF2_FG_ID));
    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit,IPMF3_FG_ID));

    BCM_IF_ERROR_RETURN(cint_field_group_const_destroy(unit,ipmf2_context));
