...
int cint_field_crps_records_main(int unit)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &cint_in_port_qual_fg_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, cint_in_port_qual_fg_id, crps_records_context_id, &attach_info));
...
int cint_field_crps_records_entry_add(int unit, uint32 in_port, uint32 out_port, uint32 out_lif)
{
    ...
    printf("Adding Entry\n");
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, cint_in_port_qual_fg_id, &ent_info, &cint_entry_1_id));
...
{
    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, cint_in_port_qual_fg_id, NULL, cint_entry_1_id));
    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, cint_in_port_qual_fg_id, crps_records_context_id));
    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, cint_in_port_qual_fg_id));
