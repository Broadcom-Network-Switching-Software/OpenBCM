    ...
    int unit)
{
    ...
    qual_info.size = 1;
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info, &Cint_field_compare_specific_offset_get_qual_id));
    ...
    */
    ...
    BCM_IF_ERROR_RETURN(bcm_field_context_create(unit, 0, bcmFieldStageIngressPMF1, &context_info, &Cint_field_compare_specific_offset_get_context_id_ipmf1));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_presel_set(unit, 0, &Cint_field_compare_specific_offset_get_presel_entry_id_ipmf1, &presel_entry_data));
    ...
    */
    BCM_IF_ERROR_RETURN(bcm_field_context_compare_create(unit, 0, bcmFieldStageIngressPMF1, Cint_field_compare_specific_offset_get_context_id_ipmf1, 0, &compare_info));
    ...
    */
    ...
    BCM_IF_ERROR_RETURN(bcm_field_context_compare_create(unit, 0, bcmFieldStageIngressPMF1, Cint_field_compare_specific_offset_get_context_id_ipmf1, 1, &compare_info));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_context_create(unit, 0, bcmFieldStageIngressPMF2, &context_info, &Cint_field_compare_specific_offset_get_context_id_ipmf2));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_presel_set(unit, 0, &Cint_field_compare_specific_offset_get_presel_entry_id_ipmf2, &presel_entry_data));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &Cint_field_compare_specific_offset_get_fg_id));

    printf("5. step: Create FG(%d) on ipmf2 \n", Cint_field_compare_specific_offset_get_fg_id);

    BCM_IF_ERROR_RETURN(bcm_field_group_qualifier_offset_get(unit, 0, Cint_field_compare_specific_offset_get_fg_id, Cint_field_compare_specific_offset_get_qual_id, &ud_qual_offset));

    printf("6. step: Get the user defines qualifier offset(%d)\n", ud_qual_offset);

    BCM_IF_ERROR_RETURN(bcm_field_qualifier_info_get(unit, bcmFieldQualifyCompareKeysResult0, bcmFieldStageIngressPMF2, &qual_info_get));

    printf("7. step: Get the bcmFieldQualifyCompareKeysResult0 qualifier offset(%d)\n", qual_info_get.offset);
    BCM_IF_ERROR_RETURN(bcm_field_compare_operand_offset_get(unit, 0, bcmFieldCompareOperandFirstKeyNotBigger, &op_offset1));

    printf("8.a. step: Get the operand offset for first pair(%d)\n", op_offset1);
    BCM_IF_ERROR_RETURN(bcm_field_compare_operand_offset_get(unit, 1, bcmFieldCompareOperandNotEqual, &op_offset2));
   ...
   BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, Cint_field_compare_specific_offset_get_fg_id, Cint_field_compare_specific_offset_get_context_id_ipmf2, &attach_info));
   ...
   BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, Cint_field_compare_specific_offset_get_fg_id, &entry_info, &Cint_field_compare_specific_offset_get_entry_id));
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_presel_set(unit, 0, &Cint_field_compare_specific_offset_get_presel_entry_id_ipmf1, &presel_entry_data));
    BCM_IF_ERROR_RETURN(bcm_field_presel_set(unit, 0, &Cint_field_compare_specific_offset_get_presel_entry_id_ipmf2, &presel_entry_data));
    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, Cint_field_compare_specific_offset_get_fg_id, NULL, Cint_field_compare_specific_offset_get_entry_id));
    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, Cint_field_compare_specific_offset_get_fg_id, Cint_field_compare_specific_offset_get_context_id_ipmf2));
    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, Cint_field_compare_specific_offset_get_fg_id));
    BCM_IF_ERROR_RETURN(bcm_field_context_compare_destroy(unit, bcmFieldStageIngressPMF1, Cint_field_compare_specific_offset_get_context_id_ipmf1, 0));
    BCM_IF_ERROR_RETURN(bcm_field_context_compare_destroy(unit, bcmFieldStageIngressPMF1, Cint_field_compare_specific_offset_get_context_id_ipmf1, 1));
    BCM_IF_ERROR_RETURN(bcm_field_context_destroy(unit, bcmFieldStageIngressPMF2, Cint_field_compare_specific_offset_get_context_id_ipmf2));
    BCM_IF_ERROR_RETURN(bcm_field_context_destroy(unit, bcmFieldStageIngressPMF1, Cint_field_compare_specific_offset_get_context_id_ipmf1));
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_destroy(unit, Cint_field_compare_specific_offset_get_qual_id));
