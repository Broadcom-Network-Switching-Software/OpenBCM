...
int cint_field_alternate_marking_ingress_node_entry_add(int unit, bcm_field_entry_t *entry_handle)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit,0,cint_field_am_ingress_fg_id,&ent_info,entry_handle));
...
int cint_field_alternate_marking_ingress_node_iPMF1(int unit)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &cint_field_am_ipmf1_ing_node_fg_info, &cint_field_am_ingress_fg_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_context_create(unit, 0, bcmFieldStageIngressPMF1, &context_info, &cint_field_am_ingress_ctx_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, cint_field_am_ingress_fg_id, cint_field_am_ingress_ctx_id, &attach_info));
    ...
    if (tod_append_mode ==2)
    {
         ...
         */
        BCM_IF_ERROR_RETURN( appl_dnx_field_flow_id_init(unit,cint_field_am_ingress_ctx_id));
    }
...
int cint_field_alternate_marking_ingress_node_ePMF(int unit)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &cint_field_am_egress_fg_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_context_create(unit, 0, bcmFieldStageEgress, &context_info, &cint_field_am_egress_ctx_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, cint_field_am_egress_fg_id, cint_field_am_egress_ctx_id, &attach_info));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit,0,cint_field_am_egress_fg_id,&ent_info,&cint_field_am_egress_entr_id));
...
int cint_field_alternate_marking_period_change(int unit,int profile, int l_bit_set)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_context_param_set(unit, 0, bcmFieldStageIngressPMF1,cint_field_am_ingress_ctx_id,&context_params));
...
int cint_field_alternate_marking_i_o_e_node_create_quals_mpls_labels(int unit)
{
    ...
    for(idx = 0; idx < NOF_MPLS_QUALS; idx++)
    {
        ...
        BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit,0,&qual_info,&cint_field_am_mpls_quals[idx]));
    }
...
int cint_field_alternate_marking_inter_or_egress_node_iPMF1_entry_add(int unit,bcm_field_entry_t *entry_handle)
{
    ...
    for (qual_idx= 0; qual_idx< NOF_MPLS_QUALS; ++qual_idx)
    {
        ...
        BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, cint_field_am_i_o_e_iPMF1_fg_id, &ent_info, entry_handle));
    }
...
int cint_field_alternate_marking_inter_or_egress_node_iPMF1(int unit, int is_inter_pe)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_action_create(unit, 0 ,&action_info, &cint_field_am_i_o_e_void_action));
    ...
    BCM_IF_ERROR_RETURN(cint_field_alternate_marking_i_o_e_node_create_quals_mpls_labels(unit));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &cint_field_am_i_o_e_iPMF1_fg_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_context_create(unit, 0, bcmFieldStageIngressPMF1, &context_info, &cint_field_am_i_o_e_iPMF1_ctx_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, cint_field_am_i_o_e_iPMF1_fg_id, cint_field_am_i_o_e_iPMF1_ctx_id, &attach_info));
...
int cint_field_alternate_marking_inter_or_egress_node_iPMF2_flow_entry_add(int unit,bcm_field_entry_t *entry_handle)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit,0,cint_field_am_i_o_e_iPMF2_flow_fg_id,&ent_info,entry_handle));
...
int cint_field_alternate_marking_inter_or_egress_node_iPMF2_D_entry_add(int unit,bcm_field_entry_t *entry_handle)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit,0,cint_field_am_i_o_e_iPMF2_D_fg_id,&ent_info,entry_handle));
...
int cint_field_alternate_marking_inter_or_egress_node_iPMF2_fg_add(int unit)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit,0,&qual_info,&cint_field_am_i_o_e_D_bit_qual_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit,0,&qual_info,&cint_field_am_i_o_e_Flow_label_qual_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &cint_field_am_i_o_e_iPMF2_flow_fg_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &cint_field_am_i_o_e_iPMF2_D_fg_id));
...
int cint_field_alternate_marking_inter_or_egress_iPMF2_attach_per_context(int unit, int index)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_context_create(unit, 0, bcmFieldStageIngressPMF2, &context_info, &cint_field_am_i_o_e_iPMF2_ctx_id[index]));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, cint_field_am_i_o_e_iPMF2_flow_fg_id, cint_field_am_i_o_e_iPMF2_ctx_id[index], &attach_info));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, cint_field_am_i_o_e_iPMF2_D_fg_id, cint_field_am_i_o_e_iPMF2_ctx_id[index], &attach_info));
...
int cint_field_alternate_marking_inter_or_egress_iPMF2_attach(int unit)
{
    ...
    {
        printf(" [idx]");
        BCM_IF_ERROR_RETURN(cint_field_alternate_marking_inter_or_egress_iPMF2_attach_per_context(unit,idx));
    }
    printf("\n");
    return BCM_E_NONE;
}
...
int cint_field_alternate_marking_inter_or_egress_node_main(int unit)
{
    ...
    BCM_IF_ERROR_RETURN(cint_field_alternate_marking_inter_or_egress_node_iPMF1(unit));
    printf("I o E Node iPMF1 configuration Done! \n");

    BCM_IF_ERROR_RETURN(cint_field_alternate_marking_inter_or_egress_node_iPMF2_fg_add(unit));
    printf("I o E Node iPMF2 FG_ADD Done! \n");

    BCM_IF_ERROR_RETURN(cint_field_alternate_marking_inter_or_egress_iPMF2_attach(unit));
    printf("I o E Node iPMF2 Attach Done! \n");

    BCM_IF_ERROR_RETURN(cint_field_alternate_marking_inter_or_egress_node_iPMF1_entry_add(unit,&entry_handle));

    BCM_IF_ERROR_RETURN(cint_field_alternate_marking_inter_or_egress_node_iPMF2_flow_entry_add(unit,&entry_handle));

    BCM_IF_ERROR_RETURN(cint_field_alternate_marking_inter_or_egress_node_iPMF2_D_entry_add(unit,&entry_handle));
    ...
    int unit)
{
    ...
    if (ifit_enable && cint_field_am_i_pe_fieh_ext_qual_id[0] == 0) {
        ...
        for (idx = 0; idx < nof_fieh_ext; idx ++) {
            ...
            BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info, (cint_field_am_i_pe_fieh_ext_qual_id + idx)));
        }
    }
    ...
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_am_i_pe_Flow_label_qual_id));
    ...
    if (!ifit_enable) {
        ...
        BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_am_i_pe_Flow_label_ind_qual_id));
    }

    bcm_field_qualifier_info_create_t_init(&qual_info);
    qual_info.size = 8;
    sal_strncpy_s(dest_char, "AM_i_pe_udh_size_q", sizeof(qual_info.name));
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_am_i_pe_udh_size_qual_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &cint_field_am_i_pe_iPMF2_fg_id));
    ...
    for(idx = 0; idx < NOF_MPLS_QUALS; idx++)
    {
        ...
        BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, cint_field_am_i_pe_iPMF2_fg_id, cint_field_am_i_o_e_iPMF2_ctx_id[idx], &attach_info));
    ...
    int unit)
{
     ...
     */
    BCM_IF_ERROR_RETURN(cint_field_udh_cascading_group_config(unit, cint_field_am_i_pe_udh_epmf_fg_info_array[0]));
