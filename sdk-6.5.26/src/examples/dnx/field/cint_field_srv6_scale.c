    ...
    bcm_field_group_t * fg_id_p)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_action_create(unit, 0, &action_info, &cint_field_external_pmf_external_uda_0));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_action_create(unit, 0, &action_info, &cint_field_external_pmf_external_uda_1));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_action_create(unit, 0, &action_info, &cint_field_external_pmf_external_uda_2));
    ...
    bcm_field_group_t * fg_id_p)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info, &ue_term_ext_qual));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_action_create(unit, 0, &action_info, &cint_field_external_pmf_external_uda_term_hit));
    ...
    bcm_field_group_info_t *fg_info_p)
{
    ...
    while (entry_index < max_entry_index)
    {
        ...
        BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, external_fg_id, &entry_info, &cint_field_external_pmf_entry_id));
    ...
    bcm_field_group_info_t *fg_info_p)
{
    ...
    while (entry_index < max_entry_index)
    {
        ...
        entry_info.priority = cint_field_external_pmf_priority;
        printf(" (%d),",entry_index);
        BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, external_fg_id, &entry_info, &cint_field_external_pmf_entry_id_term));
...
{bcm_field_context_info_t context_info;
    ...
    BCM_IF_ERROR_RETURN(bcm_field_presel_set(unit, 0, &presel_entry_id, &ipmf1_p_data));
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_external_pmf_ipmf2_ue_qual));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_external_pmf_ipmf2_udhbase_qual));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_action_create(unit, 0, &action_info, &cint_field_external_pmf_ipmf2_udh2_action));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_action_offset_get(unit, 0, cint_field_external_pmf_fg_id, cint_field_external_pmf_external_uda_0, &action_offset_in_fg));
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info, &cint_ipmf2_black_hole_qual));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &cint_field_term_fg_id_ipmf2));
    ...
    */
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, cint_field_term_fg_id_ipmf2, cint_field_term_ipmf1_context, &attach_info));
                    ...
                    bcm_field_group_info_t fg_info_term)
{
     ...
     */
    BCM_IF_ERROR_RETURN(cint_field_external_pmf_fg_add(unit, &fg_info_encap, &cint_field_external_pmf_fg_id));


    cint_field_external_pmf_external_app_type = is_ipv6_flow ? bcmFieldAppTypeIp6UcastRpf : bcmFieldAppTypeIp4UcastRpf;
    BCM_IF_ERROR_RETURN(cint_field_external_pmf_fg_attach(unit, cint_field_external_pmf_fg_id, &fg_info_encap, cint_field_external_pmf_external_app_type, cint_field_external_pmf_payload_id, cint_field_external_pmf_payload_offset));


    /*
     * Configure KBP for Term
     */
    BCM_IF_ERROR_RETURN(cint_field_external_pmf_fg_add_term(unit, &fg_info_term, &cint_field_external_pmf_fg_id_term));

    BCM_IF_ERROR_RETURN(cint_field_external_pmf_fg_attach_term(unit, cint_field_external_pmf_fg_id_term, &fg_info_term, cint_field_external_pmf_external_app_type_term, cint_field_external_pmf_payload_id, cint_field_external_pmf_payload_offset));

    BCM_IF_ERROR_RETURN(bcm_switch_control_set(unit, bcmSwitchExternalTcamSync, 0));

    BCM_IF_ERROR_RETURN(cint_field_external_pmf_entry_add(unit, cint_field_external_pmf_fg_id, &fg_info_encap));

    BCM_IF_ERROR_RETURN(cint_field_external_pmf_entry_add_term(unit, cint_field_external_pmf_fg_id_term, &fg_info_term));
                            ...
                            bcm_field_group_info_t fg_info)
{
    ...
    BCM_IF_ERROR_RETURN(cint_field_external_pmf_context_ipmf1_create_term(unit));

    BCM_IF_ERROR_RETURN(cint_field_external_pmf_fg_ipmf2_add_term(unit));
...
cint_field_external_pmf_main(int unit)
{
    ...
    BCM_IF_ERROR_RETURN(cint_field_srv6_kbp_config(unit, fg_info_encap, fg_info_term));

    BCM_IF_ERROR_RETURN(cint_field_srv6_pmf_config_encap(unit, fg_info_encap));

    BCM_IF_ERROR_RETURN(cint_field_srv6_pmf_config_term(unit, fg_info_term));
