...
int cint_field_vid_qual_main(int unit,int vid_value, bcm_field_action_t action_type, int action_value)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_context_create(unit, 0, bcmFieldStageIngressPMF1, &context_info, &cint_field_vid_qual_context_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &cint_field_vid_qual_fg_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, cint_field_vid_qual_fg_id, cint_field_vid_qual_context_id, &attach_info));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, cint_field_vid_qual_fg_id, &ent_info, &cint_field_vid_qual_entry_id));
...
int cint_field_vid_qual_destroy(int unit)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, cint_field_vid_qual_fg_id, cint_field_vid_qual_context_id));

    BCM_IF_ERROR_RETURN(bcm_field_context_destroy(unit,bcmFieldStageIngressPMF1,cint_field_vid_qual_context_id));

    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit,cint_field_vid_qual_fg_id,entry_qual_info,cint_field_vid_qual_entry_id));

    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit,cint_field_vid_qual_fg_id));
