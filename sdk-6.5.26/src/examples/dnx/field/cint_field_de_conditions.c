    ...
    int compare_mode)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_context_create(unit, 0, bcmFieldStageIngressPMF1, &context_info, &cint_field_de_conditions_context_id_ipmf1));
        ...
        int unit)
{
    ...
    BCM_IF_ERROR_RETURN(cint_field_de_conditions_context_config(unit, TRUE));

    BCM_IF_ERROR_RETURN(cint_field_de_conditions_compare_and_fem_create_uda_udq(unit));

    BCM_IF_ERROR_RETURN(cint_field_de_conditions_compare_and_fem_comapre_config(unit));

    BCM_IF_ERROR_RETURN(cint_field_de_conditions_compare_and_fem_fg_config(unit));

    BCM_IF_ERROR_RETURN(cint_field_de_conditions_compare_and_fem_cascading_fg_config(unit));
    return BCM_E_NONE;
}
        ...
        int unit)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_de_conditions_smaller_than_udq));
    /*
     * 1 bit qualifier for bigger-than condition
     */
    sal_strncpy_s(dest_char, "QUAL_1_BIT_BIGGER", sizeof(qual_info.name));
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_de_conditions_bigger_than_udq));
    /*
    ...
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_de_conditions_vid_const_qual));
    /*
    ...
    BCM_IF_ERROR_RETURN(bcm_field_action_create(unit, 0, &action_info, &cint_field_de_conditions_void_ttl_uda));
    bcm_field_action_info_t_init(&action_info);
    action_info.action_type = bcmFieldActionVoid;
    dest_char = &(action_info.name[0]);
    ...
    action_info.prefix_size = 0;
    action_info.prefix_value = 0;
    BCM_IF_ERROR_RETURN(bcm_field_action_create(unit, 0, &action_info, &cint_field_de_conditions_void_ranges_uda));
    /*
    ...
    action_info.prefix_size = 0;
    action_info.prefix_value = 0;
    BCM_IF_ERROR_RETURN(bcm_field_action_create(unit, 0, &action_info, &cint_field_de_conditions_padding_uda));
        ...
        int unit)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_context_compare_create(unit, 0, bcmFieldStageIngressPMF1,
       ...
       int unit)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &cint_field_de_conditions_fg_id_ipmf2));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_fem_action_add(unit,0 , cint_field_de_conditions_fg_id_ipmf2, action_priority, &fem_action_info));

    /**
     * Retrieve the desired result offset of the CompareKeysResult0 qualifier.
     */
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_info_get(unit, bcmFieldQualifyCompareKeysResult0, bcmFieldStageIngressPMF2, &compare0_qual_info_get));
     ...
     */
    BCM_IF_ERROR_RETURN(bcm_field_compare_operand_offset_get(unit, cint_field_de_conditions_first_pair_id,
                                                        bcmFieldCompareOperandFirstKeySmaller, &key_smaller_offset));

    /*
     * Get the same offset for bigger-than condition
     */
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_info_get(unit, bcmFieldQualifyCompareKeysResult1, bcmFieldStageIngressPMF2, &compare1_qual_info_get));

    BCM_IF_ERROR_RETURN(bcm_field_compare_operand_offset_get(unit, cint_field_de_conditions_second_pair_id,
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, cint_field_de_conditions_fg_id_ipmf2, cint_field_de_conditions_context_id_ipmf1, &attach_info));
    return BCM_E_NONE;
}
       ...
       int unit)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_context_create(unit, 0, bcmFieldStageIngressPMF3, &context_info, &cint_field_de_conditions_context_id_ipmf3));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &cint_field_de_conditions_fg_id_ipmf3));
    bcm_field_group_attach_info_t_init(&attach_info);
    ...
    attach_info.payload_info.action_types[1] = fg_info.action_types[1];
    attach_info.key_info.qual_info[0].input_type = bcmFieldInputTypeMetaData;
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, cint_field_de_conditions_fg_id_ipmf3, cint_field_de_conditions_context_id_ipmf3, &attach_info));
    return BCM_E_NONE;
}
        ...
        int unit)
{
    ...
    p_id.stage = bcmFieldStageIngressPMF1;
    BCM_IF_ERROR_RETURN(bcm_field_presel_set(unit, 0, &p_id, &p_data));
    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, cint_field_de_conditions_fg_id_ipmf2, cint_field_de_conditions_context_id_ipmf1));

    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, cint_field_de_conditions_fg_id_ipmf2));
    BCM_IF_ERROR_RETURN(bcm_field_action_destroy(unit, cint_field_de_conditions_void_ttl_uda));
    BCM_IF_ERROR_RETURN(bcm_field_action_destroy(unit, cint_field_de_conditions_void_ranges_uda));
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_destroy(unit, cint_field_de_conditions_smaller_than_udq));
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_destroy(unit, cint_field_de_conditions_bigger_than_udq));
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_destroy(unit, cint_field_de_conditions_vid_const_qual));
    BCM_IF_ERROR_RETURN(bcm_field_context_compare_destroy(unit, bcmFieldStageIngressPMF1, cint_field_de_conditions_context_id_ipmf1, 0));
    BCM_IF_ERROR_RETURN(bcm_field_context_compare_destroy(unit, bcmFieldStageIngressPMF1, cint_field_de_conditions_context_id_ipmf1, 1));
    BCM_IF_ERROR_RETURN(bcm_field_context_destroy(unit, bcmFieldStageIngressPMF1, cint_field_de_conditions_context_id_ipmf1));
    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, cint_field_de_conditions_fg_id_ipmf3, cint_field_de_conditions_context_id_ipmf3));
    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, cint_field_de_conditions_fg_id_ipmf3));
    ...
    p_id.stage = bcmFieldStageIngressPMF3;
    BCM_IF_ERROR_RETURN(bcm_field_presel_set(unit, 0, &p_id, &p_data));
    BCM_IF_ERROR_RETURN(bcm_field_context_destroy(unit, bcmFieldStageIngressPMF3, cint_field_de_conditions_context_id_ipmf3));
    return BCM_E_NONE;
}
...
int cint_field_de_conditions_range_and_efes_example(
        int unit)
{
    BCM_IF_ERROR_RETURN(cint_field_de_conditions_context_config(unit, FALSE));
    BCM_IF_ERROR_RETURN(cint_field_de_conditions_range_and_efes_create_uda_udq(unit));
    BCM_IF_ERROR_RETURN(cint_field_de_conditions_range_and_efes_set_range(unit));
    /*
     * Config DE field group in IPMF2 and add EFESs actions
     */
    BCM_IF_ERROR_RETURN(cint_field_de_conditions_range_and_efes_fg_config(unit));
        ...
        int unit)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_info_get(unit, bcmFieldQualifyIp4Ttl, cint_field_de_conditions_stage, &ttl_qual_info_get));

    BCM_IF_ERROR_RETURN(bcm_field_qualifier_info_get(unit, bcmFieldQualifyL4PortRangeCheck, cint_field_de_conditions_stage, &range_qual_info_get));
    /*
     * get TTL action size
     */
    BCM_IF_ERROR_RETURN(bcm_field_action_info_get(unit, action, cint_field_de_conditions_stage, &action_info));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, BCM_FIELD_FLAG_32_RESULT_MSB_ALIGN,
    ...
    for(ii = 0; ii < 2; ii++)
    {
        BCM_IF_ERROR_RETURN(bcm_field_group_action_offset_get(unit, 0, cint_field_de_conditions_fg_id_ipmf2,
                cint_field_de_conditions_const_64_uda[ii], &const_64_action_offset_within_fg[ii]));

        BCM_IF_ERROR_RETURN(bcm_field_group_action_offset_get(unit, 0,
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_action_offset_get(unit, 0, cint_field_de_conditions_fg_id_ipmf2, cint_field_de_conditions_condition_uda, &condition_action_offset_within_fg));
    ...
    for (ii = 0; ii < 2; ii++)
    {
        ...
        */
        ...
        BCM_IF_ERROR_RETURN(bcm_field_efes_action_add(unit, 0, cint_field_de_conditions_fg_id_ipmf2, cint_field_de_conditions_context_id_ipmf1, &action_priority, &efes_action_info));
    }
    return BCM_E_NONE;
}
        ...
        int unit)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_range_set(unit, 0, bcmFieldStageIngressPMF2, cint_field_de_conditions_range_id_0, &range_info));

    bcm_field_range_info_t_init(&range_info);
    range_info.range_type = bcmFieldRangeTypeL4SrcPort;
    range_info.min_val = 2000;
    range_info.max_val = 3000;
    BCM_IF_ERROR_RETURN(bcm_field_range_set(unit, 0, bcmFieldStageIngressPMF2, cint_field_de_conditions_range_id_1, &range_info));
    return BCM_E_NONE;
}
        ...
        int unit)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_action_create(unit, 0, &action_info, &cint_field_de_conditions_valid_bit_1_uda[0]));

    sal_strncpy_s(dest_char, "ACTION_VALID_BIT_1_RANGE_1", sizeof(action_info.name));
    BCM_IF_ERROR_RETURN(bcm_field_action_create(unit, 0, &action_info, &cint_field_de_conditions_valid_bit_1_uda[1]));

    dest_char = &(action_info.name[0]);
    sal_strncpy_s(dest_char, "ACTION_VALID_BIT_2_RANGE_0", sizeof(action_info.name));
    BCM_IF_ERROR_RETURN(bcm_field_action_create(unit, 0, &action_info, &cint_field_de_conditions_valid_bit_2_uda[0]));

    sal_strncpy_s(dest_char, "ACTION_VALID_BIT_2_RANGE_1", sizeof(action_info.name));
    BCM_IF_ERROR_RETURN(bcm_field_action_create(unit, 0, &action_info, &cint_field_de_conditions_valid_bit_2_uda[1]));

    dest_char = &(action_info.name[0]);
    sal_strncpy_s(dest_char, "ACTION_VALID_BIT_3_RANGE_0", sizeof(action_info.name));
    BCM_IF_ERROR_RETURN(bcm_field_action_create(unit, 0, &action_info, &cint_field_de_conditions_valid_bit_3_uda[0]));

    sal_strncpy_s(dest_char, "ACTION_VALID_BIT_3_RANGE_1", sizeof(action_info.name));
    BCM_IF_ERROR_RETURN(bcm_field_action_create(unit, 0, &action_info, &cint_field_de_conditions_valid_bit_3_uda[1]));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_action_create(unit, 0, &action_info, &cint_field_de_conditions_condition_uda));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_action_create(unit, 0, &action_info, &cint_field_de_conditions_double_uda[0]));

    sal_strncpy_s(dest_char, "ACTION_DOUBLE_PLUS_ONE_ACTION", sizeof(action_info.name));
    BCM_IF_ERROR_RETURN(bcm_field_action_create(unit, 0, &action_info, &cint_field_de_conditions_double_uda[1]));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_action_create(unit, 0, &action_info, &cint_field_de_conditions_const_64_uda[0]));

    sal_strncpy_s(dest_char, "ACTION_CONST_65", sizeof(action_info.name));
    BCM_IF_ERROR_RETURN(bcm_field_action_create(unit, 0, &action_info, &cint_field_de_conditions_const_64_uda[1]));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_action_create(unit, 0, &action_info, &cint_field_de_conditions_const_128_uda[0]));

    sal_strncpy_s(dest_char, "ACTION_CONST_129", sizeof(action_info.name));
    BCM_IF_ERROR_RETURN(bcm_field_action_create(unit, 0, &action_info, &cint_field_de_conditions_const_128_uda[1]));

    bcm_field_qualifier_info_create_t_init(&qual_info);
    qual_info.size = 1;
    dest_char = &(qual_info.name[0]);
    sal_strncpy_s(dest_char, "QUAL_VALID_BIT_1_RANGE_0", sizeof(qual_info.name));
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_de_conditions_valid_bit_1_udq[0]));

    sal_strncpy_s(dest_char, "QUAL_VALID_BIT_1_RANGE_1", sizeof(qual_info.name));
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_de_conditions_valid_bit_1_udq[1]));

    dest_char = &(qual_info.name[0]);
    sal_strncpy_s(dest_char, "QUAL_VALID_BIT_2_RANGE_0", sizeof(qual_info.name));
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_de_conditions_valid_bit_2_udq[0]));

    sal_strncpy_s(dest_char, "QUAL_VALID_BIT_2_RANGE_1", sizeof(qual_info.name));
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_de_conditions_valid_bit_2_udq[1]));

    dest_char = &(qual_info.name[0]);
    sal_strncpy_s(dest_char, "QUAL_VALID_BIT_3_RANGE_0", sizeof(qual_info.name));
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_de_conditions_valid_bit_3_udq[0]));

    sal_strncpy_s(dest_char, "QUAL_VALID_BIT_3_RANGE_1", sizeof(qual_info.name));
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_de_conditions_valid_bit_3_udq[1]));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_de_conditions_const_64_udq[0]));

    sal_strncpy_s(dest_char, "QUAL_CONST_65", sizeof(qual_info.name));
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_de_conditions_const_64_udq[1]));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_de_conditions_const_128_udq[0]));

    sal_strncpy_s(dest_char, "QUAL_CONST_129", sizeof(qual_info.name));
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_de_conditions_const_128_udq[1]));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_de_conditions_action_udq[0]));
    sal_strncpy_s(dest_char, "QUAL_ACTION_1", sizeof(qual_info.name));
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_de_conditions_action_udq[1]));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_de_conditions_double_udq[0]));

    sal_strncpy_s(dest_char, "QUAL_DOUBLE_PLUS_ONE_CONST", sizeof(qual_info.name));
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_de_conditions_double_udq[1]));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit, 0, &qual_info, &cint_field_de_conditions_condition_udq));
        ...
        int unit)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, cint_field_de_conditions_fg_id_ipmf2, cint_field_de_conditions_context_id_ipmf1));
    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, cint_field_de_conditions_fg_id_ipmf2));
    BCM_IF_ERROR_RETURN(bcm_field_action_destroy(unit, cint_field_de_conditions_condition_uda));
    for (ii = 0; ii < 2; ii++) {
        BCM_IF_ERROR_RETURN(bcm_field_action_destroy(unit, cint_field_de_conditions_double_uda[ii]));
        BCM_IF_ERROR_RETURN(bcm_field_action_destroy(unit, cint_field_de_conditions_const_64_uda[ii]));
        BCM_IF_ERROR_RETURN(bcm_field_action_destroy(unit, cint_field_de_conditions_const_128_uda[ii]));
        BCM_IF_ERROR_RETURN(bcm_field_action_destroy(unit, cint_field_de_conditions_valid_bit_1_uda[ii]));
        BCM_IF_ERROR_RETURN(bcm_field_action_destroy(unit, cint_field_de_conditions_valid_bit_2_uda[ii]));
        BCM_IF_ERROR_RETURN(bcm_field_action_destroy(unit, cint_field_de_conditions_valid_bit_3_uda[ii]));
        BCM_IF_ERROR_RETURN(bcm_field_qualifier_destroy(unit, cint_field_de_conditions_double_udq[ii]));
        BCM_IF_ERROR_RETURN(bcm_field_qualifier_destroy(unit, cint_field_de_conditions_const_64_udq[ii]));
        BCM_IF_ERROR_RETURN(bcm_field_qualifier_destroy(unit, cint_field_de_conditions_const_128_udq[ii]));
        BCM_IF_ERROR_RETURN(bcm_field_qualifier_destroy(unit, cint_field_de_conditions_valid_bit_1_udq[ii]));
        BCM_IF_ERROR_RETURN(bcm_field_qualifier_destroy(unit, cint_field_de_conditions_valid_bit_2_udq[ii]));
        BCM_IF_ERROR_RETURN(bcm_field_qualifier_destroy(unit, cint_field_de_conditions_valid_bit_3_udq[ii]));
        BCM_IF_ERROR_RETURN(bcm_field_qualifier_destroy(unit, cint_field_de_conditions_action_udq[ii]));
    }
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_destroy(unit, cint_field_de_conditions_condition_udq));
