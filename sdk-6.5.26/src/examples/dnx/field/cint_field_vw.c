    ...
    int ipv4_header_offset_in_layer)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_name_to_id(unit, 0, &name_to_id_info, &nof_ids, ids));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &Cint_field_vw_fg_id_ipmf2));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, Cint_field_vw_fg_id_ipmf2, context_id_ipmf2, &attach_info));
    ...
    int ipv4_header_offset_in_layer)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &Cint_field_vw_fg_id_ipmf3));
    ...
    attach_info.payload_info.nof_actions = fg_info.nof_actions;
    attach_info.payload_info.action_types[0] = fg_info.action_types[0];
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, Cint_field_vw_fg_id_ipmf3, context_id_ipmf3, &attach_info));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, Cint_field_vw_fg_id_ipmf3, &entry_info, &Cint_field_vw_entry_id_ipmf3));
    ...
    int ipv4_header_offset_in_layer)
{
    ...
    BCM_IF_ERROR_RETURN(field_vw_ipmf2(unit, context_id_ipmf2, ipv4_header_layer, ipv4_header_offset_in_layer));


    BCM_IF_ERROR_RETURN(field_vw_ipmf3(unit, context_id_ipmf3, ipv4_header_layer, ipv4_header_offset_in_layer));
    ...
    bcm_field_context_t context_id_ipmf3)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, Cint_field_vw_fg_id_ipmf2, context_id_ipmf2));

    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, Cint_field_vw_fg_id_ipmf2));

    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, Cint_field_vw_fg_id_ipmf3, NULL, Cint_field_vw_entry_id_ipmf3));

    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, Cint_field_vw_fg_id_ipmf3, context_id_ipmf3));

    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, Cint_field_vw_fg_id_ipmf3));
