...
int field_static_sa_move_main(int unit)
{
    ...
    /* Create drop action */
    BCM_IF_ERROR_RETURN(cint_field_action_drop_main(unit,bcmFieldStageIngressPMF1, &action_drop));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &cint_attach_fg_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_context_create(unit, 0, bcmFieldStageIngressPMF1, &context_info, &cint_attach_context_id_eth));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, cint_attach_fg_id, cint_attach_context_id_eth, &attach_info));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, cint_attach_fg_id, &ent_info, &cint_attach_entry_id));
...
int field_static_sa_move_destroy(int unit)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, cint_attach_fg_id, cint_attach_context_id_eth));

    BCM_IF_ERROR_RETURN(bcm_field_context_destroy(unit,bcmFieldStageIngressPMF1,cint_attach_context_id_eth));

    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit,cint_attach_fg_id,entry_qual_info,cint_attach_entry_id));

    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit,cint_attach_fg_id));

    BCM_IF_ERROR_RETURN(bcm_field_action_destroy(unit, action_drop));
