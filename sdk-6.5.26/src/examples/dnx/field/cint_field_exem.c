...
int cint_field_exem_entry_update(int unit, bcm_field_stage_t stage, int new_action_value_2)
{
 ...
 BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, BCM_FIELD_FLAG_UPDATE, Cint_field_exem_fg_id, &entry_info, NULL));
 ...
 */
 int cint_field_exem_main(int unit, bcm_field_stage_t stage, bcm_field_context_t context_id, int action_value_1, int action_value_2)
 {
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &Cint_field_exem_fg_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, Cint_field_exem_fg_id, context_id, &attach_info));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, Cint_field_exem_fg_id, &entry_info, NULL));
...
int cint_field_exem_destroy(int unit, bcm_field_stage_t stage, bcm_field_context_t context_id)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, Cint_field_exem_fg_id, entry_qual_info, 0));
    printf("Deleted an entry of field group ID %d. Context %d.\n", Cint_field_exem_fg_id, context_id);

    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, Cint_field_exem_fg_id, context_id));
    printf("Detach field group ID %d from context %d.\n", Cint_field_exem_fg_id, context_id);

    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, Cint_field_exem_fg_id));
