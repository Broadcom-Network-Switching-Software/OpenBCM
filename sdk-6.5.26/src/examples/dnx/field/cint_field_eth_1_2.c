    ...
    bcm_field_context_t context_id)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &fg_eth_1_2_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, fg_eth_1_2_id, context_id, &attach_info));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, fg_eth_1_2_id, &ent_eth_1_2_info, &ent_eth_1_2_id));
    ...
    bcm_field_context_t context_id)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, fg_eth_1_2_id, NULL, ent_eth_1_2_id));

    printf("Detaching eth_1_2 FG from default context...\r\n");
    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, fg_eth_1_2_id, context_id));

    printf("Deleting eth_1_2 FG...\r\n");
    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, fg_eth_1_2_id));
