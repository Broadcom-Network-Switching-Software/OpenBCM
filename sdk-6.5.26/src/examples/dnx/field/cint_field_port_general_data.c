    ...
    uint32 general_data_msb)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_port_class_get(unit, gport_in, bcmPortClassFieldIngressPMF1PacketProcessingPortGeneralData, &Port_general_data_lsb_old_value));

    BCM_IF_ERROR_RETURN(bcm_port_class_get(unit, gport_in, bcmPortClassFieldIngressPMF1PacketProcessingPortGeneralDataHigh, &Port_general_data_msb_old_value));

    /* Set the general data.*/
    BCM_IF_ERROR_RETURN(bcm_port_class_set(unit, gport_in, bcmPortClassFieldIngressPMF1PacketProcessingPortGeneralData, general_data_lsb));

    BCM_IF_ERROR_RETURN(bcm_port_class_set(unit, gport_in, bcmPortClassFieldIngressPMF1PacketProcessingPortGeneralDataHigh, general_data_msb));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &Port_general_data_fg_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, Port_general_data_fg_id, context_id, &attach_info));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, Port_general_data_fg_id, &entry_info, &Port_general_data_entry_handle));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, Port_general_data_fg_id, &entry_info, &Port_general_data_entry_handle_default));
    ...
    int in_port)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, Port_general_data_fg_id, &entry_qual_info, Port_general_data_entry_handle));


    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, Port_general_data_fg_id, &entry_qual_info, Port_general_data_entry_handle_default));


    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, Port_general_data_fg_id, context_id));


    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, Port_general_data_fg_id));


    BCM_IF_ERROR_RETURN(bcm_port_class_set(unit, gport_in, bcmPortClassFieldIngressPMF1PacketProcessingPortGeneralData, Port_general_data_lsb_old_value));

    BCM_IF_ERROR_RETURN(bcm_port_class_set(unit, gport_in, bcmPortClassFieldIngressPMF1PacketProcessingPortGeneralDataHigh, Port_general_data_msb_old_value));
