...
int cint_field_user_qual_header_main(int unit)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_qualifier_create(unit,0,&qual_info,&cint_field_user_qual_header_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &cint_field_user_qual_header_fg_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_context_create(unit, 0, stage, &context_info, &cint_field_user_qual_header_context_id_eth));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, cint_field_user_qual_header_fg_id, cint_field_user_qual_header_context_id_eth, &attach_info));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, cint_field_user_qual_header_fg_id, &ent_info, &(cint_field_user_qual_header_entry_id[0])));
...
int cint_field_user_qual_header_destroy(int unit)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, cint_field_user_qual_header_fg_id, cint_field_user_qual_header_context_id_eth));

    BCM_IF_ERROR_RETURN(bcm_field_context_destroy(unit,bcmFieldStageEgress,cint_field_user_qual_header_context_id_eth));

    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit,cint_field_user_qual_header_fg_id,entry_qual_info,cint_field_user_qual_header_entry_id[0]));

    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit,cint_field_user_qual_header_fg_id));

    BCM_IF_ERROR_RETURN(bcm_field_qualifier_destroy(unit,cint_field_user_qual_header_id));
