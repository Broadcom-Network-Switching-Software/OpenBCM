    ...
    bcm_port_t dest_port)
{
    ...
    BCM_IF_ERROR_RETURN(get_first_fec_in_range_which_not_in_ecmp_range(unit, 0,0, &egress_intf_id));

    BCM_IF_ERROR_RETURN(bcm_port_class_set(unit, in_port, bcmPortClassId, 1));

    BCM_IF_ERROR_RETURN(cint_field_utils_ports_create(unit, l3_config));


    BCM_IF_ERROR_RETURN(cint_field_utils_l3_intf_create(unit, l3_config, &ingress_intf_id));

    BCM_IF_ERROR_RETURN(cint_field_utils_l3_ingress_create(unit, l3_config, &ingress_intf_id));
    ...
    BCM_IF_ERROR_RETURN(cint_utils_rx_trap_create_and_set(unit, 0, bcmRxTrapUserDefine, &trap_config, &Cint_field_DstGport_ipmf3_qual_trap_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_l3_egress_create(unit, BCM_L3_WITH_ID | BCM_L3_EGRESS_ONLY, &egress_intf, &eg_arp_intf));
    ...
    egress_intf.encap_id = *dnxc_data_get(unit, "l3", "rif", "nof_rifs", NULL) + 0x4;
    BCM_IF_ERROR_RETURN(bcm_l3_egress_create(unit, BCM_L3_WITH_ID | BCM_L3_INGRESS_ONLY, &egress_intf, &egress_intf_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_l3_route_add(unit, &l3route));
    ...
    bcm_port_t dest_port)
{
    ...
    /** Configure FEC with trap gport destination. */
    BCM_IF_ERROR_RETURN(cint_field_DstGport_ipmf3_trap_dest_create(unit, vid, in_port, dest_port));


    /** Create FWD context. */
    BCM_IF_ERROR_RETURN(field_presel_fwd_layer_main(unit, Cint_field_DstGport_ipmf3_qual_presel_id, bcmFieldStageIngressPMF3,
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &Cint_field_DstGport_ipmf3_qual_fg_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, Cint_field_DstGport_ipmf3_qual_fg_id, Cint_field_DstGport_ipmf3_qual_context_id, &attach_info));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, Cint_field_DstGport_ipmf3_qual_fg_id, &ent_info, &Cint_field_DstGport_ipmf3_qual_entry_id));
...
int cint_field_DstGport_ipmf3_qual_destroy(
    int unit)
{
    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, Cint_field_DstGport_ipmf3_qual_fg_id, NULL, Cint_field_DstGport_ipmf3_qual_entry_id));

    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, Cint_field_DstGport_ipmf3_qual_fg_id, Cint_field_DstGport_ipmf3_qual_context_id));

    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, Cint_field_DstGport_ipmf3_qual_fg_id));

    BCM_IF_ERROR_RETURN(field_presel_fwd_layer_destroy(unit, Cint_field_DstGport_ipmf3_qual_presel_id, bcmFieldStageIngressPMF3,
                                        Cint_field_DstGport_ipmf3_qual_context_id));

    BCM_IF_ERROR_RETURN(bcm_rx_trap_type_destroy(unit, Cint_field_DstGport_ipmf3_qual_trap_id));
