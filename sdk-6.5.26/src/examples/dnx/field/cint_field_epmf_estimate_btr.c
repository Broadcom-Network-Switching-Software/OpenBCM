    ...
    int estimate_btr_value)
{
         ...
         (epmf_estimate_btr_context_id == BCM_FIELD_ID_INVALID))
    {
        ...
        BCM_IF_ERROR_RETURN(bcm_field_context_create(unit, 0, bcmFieldStageEgress, &context_info, &epmf_estimate_btr_context_id));
        ...
        BCM_IF_ERROR_RETURN(bcm_field_action_create(unit, 0, &action_info, &action_id));
        ...
        BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &epmf_estimate_btr_fg_id));
        ...
        BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, epmf_estimate_btr_fg_id, epmf_estimate_btr_context_id, &attach_info));
    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, epmf_estimate_btr_fg_id, epmf_estimate_btr_context_id));

    printf("TCAM Field Group %d was detach from context %d. \n", epmf_estimate_btr_fg_id, epmf_estimate_btr_context_id);

    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, epmf_estimate_btr_fg_id));

    printf("TCAM Field Group %d was deleted. \n", epmf_estimate_btr_fg_id);

    BCM_IF_ERROR_RETURN(bcm_field_context_destroy(unit, bcmFieldStageEgress, epmf_estimate_btr_context_id));
