    ...
    int core_port2)
{
    ...
    if (rv != BCM_E_NONE)
    {
        printf("Error(%d), in vxlan_roo_basic_l3_forwarding\n", rv);
        return rv;
    }
    ...
    int unit)
{
    ...
    rv = add_host_ipv4(unit, cint_vxlan_roo_basic_info.route_dip_into_overlay, cint_vxlan_roo_basic_info.access_eth_vrf, cint_vxlan_roo_basic_info.core_native_fec_id1, 0, 0);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = add_host_ipv4(unit, cint_vxlan_roo_basic_info.route_dip_out_of_overlay, cint_vxlan_roo_basic_info.tunnel_termination_vrf, cint_vxlan_roo_basic_info.access_fec_id1, 0, 0);
    if (rv != BCM_E_NONE)
    {
    ...
    /*
     * Add Host entry for core to access traffic     */
    rv = add_host_ipv4(unit, cint_vxlan_roo_basic_info.route_dip_out_of_overlay+1, cint_vxlan_roo_basic_info.tunnel_termination_vrf, cint_vxlan_roo_basic_info.access_fec_id2, 0, 0);
    if (rv != BCM_E_NONE)
    {
    ...
    {
        rv = add_host_ipv4(unit, cint_vxlan_roo_basic_info.public_dip_ipv4, 0, cint_vxlan_roo_basic_info.access_fec_id_public, 0, 0);
        if (rv != BCM_E_NONE)
        {
           printf("Error, in add_host_ipv43, \n");
           return rv;
    ...
    else 
    {
        ...
        rv = dnx_utils_l3_route_ipv4_add(unit, &route_ipv4_structure);
        if (rv != BCM_E_NONE)
        {
           printf("Error, in add_host_ipv43, \n");
           return rv;
     ...
     * Add Route entry
     */
    rv = add_host_ipv4(unit, cint_vxlan_roo_basic_info.route_dip_into_mpls,
    ...
    rv = dnx_utils_l3_route_ipv6_add(unit, &route_ipv6_structure);
    if (rv != BCM_E_NONE)
    {
        printf("Error, in function dnx_utils_l3_route_ipv6_add, err_id = %d \n", rv);
        return rv;
    }
     ...
     * Add Host entry
     */
    rv = add_host_ipv6(unit, cint_vxlan_roo_basic_info.hostv6_dip_out_of_overlay, cint_vxlan_roo_basic_info.tunnel_termination_vrf, cint_vxlan_roo_basic_info.access_fec_id1);
    if (rv != BCM_E_NONE)
    {
        printf("Error, in function add_host_ipv6, err_id = %d \n", rv);
        return rv;
    }
     ...
     */
    rv = add_host_ipv6(unit, cint_vxlan_roo_basic_info.dip_to_tunnel, cint_vxlan_roo_basic_info.tunnel_termination_vrf, cint_vxlan_roo_basic_info.ipv6_provider_fec);
    if (rv != BCM_E_NONE)
    {
        printf("Error, in function add_host_ipv6, err_id = %d \n", rv);
        return rv;
    ...
    rv = dnx_utils_l3_vpbr_ipv4_add(unit, &vpbr_ipv4_structure);
    if (rv != BCM_E_NONE)
    {
        printf("Error, in dnx_utils_l3_vpbr_ipv4_add, \n");
        return rv;
    }
    /*
     * Add vpbr Host
     */
    rv = add_host_ipv4(unit, cint_vxlan_roo_basic_info.host_dip_out_of_overlay, cint_vxlan_roo_basic_info.vpbr_vrf, cint_vxlan_roo_basic_info.access_fec_id1, 0, 0);
    if (rv != BCM_E_NONE)
    {
        printf("Error, in add_host_ipv42, \n");
        return rv;
     ...
     * Add Host entry
     */
    rv = add_host_ipv4(unit, cint_vxlan_roo_basic_info.host_dip_tunnel_out_of_overlay, cint_vxlan_roo_basic_info.tunnel_termination_vrf, cint_vxlan_roo_basic_info.mpls2_fec_id, 0, 0);
    if (rv != BCM_E_NONE)
    {
        printf("Error, in add_host_ipv43, \n");
        return rv;
     ...
     * Add Host entry
     */
    rv = add_host_ipv4(unit, cint_vxlan_roo_basic_info.host_dip_into_mpls_stack, cint_vxlan_roo_basic_info.tunnel_termination_vrf, cint_vxlan_roo_basic_info.mpls3_fec_id, 0, 0);
    if (rv != BCM_E_NONE)
    {
     ...
     */
    rv = add_host_ipv6(unit, cint_vxlan_roo_basic_info.dip_to_mpls, cint_vxlan_roo_basic_info.tunnel_termination_vrf, cint_vxlan_roo_basic_info.mpls3_fec_id);
    if (rv != BCM_E_NONE)
    {
        printf("%s(): Error, in function add_host_ipv6, err_id = %d \n", rv);
        return rv;
    }
    ...
    if (rv != BCM_E_NONE)
    {
        printf("%s(): Error, in function dnx_utils_l3_route_ipv6_add, err_id = %d \n", rv);
        return rv;
    }
    return rv;
}
    ...
    int core_port2)
{
    ...
    rv = dnx_utils_l3_port_set(unit, &l3_port_structure);
    if (rv != BCM_E_NONE)
    {
        printf("Error, access_port dnx_utils_l3_port_set\n");
        return rv;
    }
    ...
    if (rv != BCM_E_NONE)
    {
        printf("Error, core_port dnx_utils_l3_port_set\n");
        return rv;
    }
    ...
    int unit)
{
    ...
    if (rv != BCM_E_NONE)
    {
        printf("Error, dnx_utils_l3_eth_rif_create core_overlay_eth_rif\n");
        return rv;
    }
    ...
    bcm_if_t * tunnel_id)
{
    ...
    else
    {
        ...
        for (i = 5; i >= 0; i -= 2)
        {
            ...
            rv = bcm_mpls_tunnel_initiator_create(unit, 0, 4, label_array);
            if (rv != BCM_E_NONE)
            {
                printf("Error, in bcm_mpls_tunnel_initiator_create i %d\n",i);
                return rv;
