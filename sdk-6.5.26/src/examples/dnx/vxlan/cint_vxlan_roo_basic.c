 ...
 * int core_port = 203;
 * int is_ipv6_vxlan = 0;
 * print vxlan_roo_basic(unit,is_ipv6_vxlan,access_port,core_port);
 *
    ...
    int unit)
{
    ...
    rv = l3__egress_only_fec__create(unit, cint_vxlan_roo_basic_info.core_native_fec_id,
                                     ...
                                     cint_vxlan_roo_basic_info.core_native_arp_id, gport, flags, fwd_flag);
    ...
    int core_port)
{
    ...
    rv = vxlan_roo_basic(unit, is_ipv6_vxlan, access_port, 0, core_port);
    if (rv != BCM_E_NONE)
    {
