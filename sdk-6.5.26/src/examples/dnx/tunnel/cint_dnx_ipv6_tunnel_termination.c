    ...
    int access_port)
{
     ...
     */
    if (cint_ipv6_tunnel_info.tunnel_type != bcmTunnelTypeVxlan6Gpe && cint_ipv6_tunnel_info.tunnel_type != bcmTunnelTypeVxlan6)
    {
    ...
    int bcm_tunnel_type)
{
    ...
    if(cint_ipv6_tunnel_info.forwarding_type == IPv6TerminationForwardTypeIPv4 || cint_ipv6_tunnel_info.forwarding_type == IPv6TerminationForwardTypeIPv6)
    {
