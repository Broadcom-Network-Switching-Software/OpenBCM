...
int NOF_DIPS = END_POINT_TO_T_INSERT_FWD+1;
                    ...
                    int is_default)
{
    ...
    int rv, flags = (is_default) ? BCM_TUNNEL_TERM_CASCADED_MISS_DISABLE_TERM : 0;
    ...
    if (is_default)
    {
       ...
       sal_memcpy(tunnel_term_set.dip6, ip6_dip, 16);
       sal_memcpy(tunnel_term_set.sip6, ip6_sip, 16);
       sal_memcpy(tunnel_term_set.dip6_mask, ip6_mask_func, 16);
       sal_memcpy(tunnel_term_set.sip6_mask, ip6_mask, 16);
       tunnel_term_set.vrf = vrf;
       tunnel_term_set.ingress_qos_model.ingress_ttl = bcmQosIngressModelPipe;
                    ...
                    int is_default)          /** If set, USIDwith cascaded lookup is performed */
{
    ...
    /** SRV6 Ingress Tunnel out-port SA - Here creating not Out-RIF, we don't need it SRv6 Tunnel, but VSI (with SA MAC) and its VID of END-Point1, to tie it to ARP+AC  */
    rv = intf_eth_rif_create(unit, cint_srv6_tunnel_info.tunnel_vid[EGRESS_VID], cint_srv6_tunnel_info.intf_out_mac_address[INGRESS]);
    if (rv != BCM_E_NONE)
    {
        printf("%s(): Error, intf_eth_rif_create intf_out\n",proc_name);
        return rv;
    ...
    if(*dnxc_data_get(unit, "l3", "fwd", "host_entry_support", NULL))
    {
        ...
        rv = l3__egress_only_fec__create_inner(unit, cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_IPV6_TUNNEL_FEC_ID], 0 , srv6_basic_lif_encode, gport, 0, fec_flags2,
                                               0, 0,&encoded_fec);
        if (rv != BCM_E_NONE)
        {
    ...
    else
    {
        ...
        BCM_L3_ITF_SET(srv6_basic_lif_encode, BCM_L3_ITF_TYPE_LIF, cint_srv6_tunnel_info.tunnel_global_lif[INGRESS_IPV6_TUNNEL_GLOBAL_LIF]);
        BCM_GPORT_LOCAL_SET(gport, out_port);
        rv = l3__egress_only_fec__create_inner(unit, cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_IPV6_TUNNEL_FEC_ID_2ND_HIER], srv6_basic_lif_encode, 0, gport, BCM_L3_2ND_HIERARCHY, fec_flags2,
                                               0, 0,&encoded_fec);
        ...
        rv = l3__egress_only_fec__create_inner(unit, cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_IPV6_TUNNEL_FEC_ID], 0, cint_srv6_tunnel_info.tunnel_arp_id[INGRESS], gport, 0, fec_flags2, 0, 0, NULL);
        if (rv != BCM_E_NONE)
        {
    ...
    rv = l3__egress_only_fec__create(unit, cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID], cint_srv6_tunnel_info.eth_rif_intf_out[END_POINT_1], cint_srv6_tunnel_info.tunnel_arp_id[END_POINT_1], gport, 0, fec_flags2);
    if (rv != BCM_E_NONE)
    {
        printf
    ...
    rv = l3__egress_only_fec__create(unit, cint_srv6_tunnel_info.tunnel_fec_id[T_INSERT_FEC_ID], srv6_basic_lif_encode, 0, gport, 0, fec_flags2);
    if (rv != BCM_E_NONE)
    {
        printf
            ("%s(): Error, create egress object FEC only for End-Point with t insert fec = %d, intf_out = %d, encap_id = %d, out_port = %d, err_id = %d\n",
             proc_name, cint_srv6_tunnel_info.tunnel_fec_id[T_INSERT_FEC_ID], cint_srv6_tunnel_info.eth_rif_intf_out[END_POINT_1], cint_srv6_tunnel_info.t_insert_global_id, out_port_end1, rv);
        return rv;
    }
    ...
    if(*dnxc_data_get(unit, "l3", "fwd", "host_entry_support", NULL))
    {
        ...
        rv = l3__egress_only_fec__create_inner(unit, cint_srv6_tunnel_info.tunnel_fec_id[EGRESS_FEC_ID], 0 , cint_srv6_tunnel_info.tunnel_arp_id[EGRESS], gport, 0, fec_flags2, 0, 0,&encoded_fec);
        if (rv != BCM_E_NONE)
        {
            printf("%s(): Error, create egress object FEC only\n",proc_name);
            return rv;
    ...
    else
    {
        ...
        BCM_GPORT_LOCAL_SET(gport, out_port_egress);
        rv = l3__egress_only_fec__create_inner(unit, cint_srv6_tunnel_info.tunnel_fec_id[EGRESS_FEC_ID_2ND_HIER], 0 , cint_srv6_tunnel_info.tunnel_arp_id[EGRESS], gport, BCM_L3_2ND_HIERARCHY, fec_flags2, 0, 0,&encoded_fec);
        ...
        /** Create FEC in first hierarchy and set its properties*/
        BCM_GPORT_FORWARD_PORT_SET(gport, encoded_fec);
        rv = l3__egress_only_fec__create_inner(unit, cint_srv6_tunnel_info.tunnel_fec_id[EGRESS_FEC_ID], 0 , cint_srv6_tunnel_info.eth_rif_intf_out[EGRESS], gport, 0, fec_flags2, 0, 0, NULL);
        if (rv != BCM_E_NONE)
        {
            printf("%s(): Error, create egress object FEC only\n",proc_name);
            return rv;
    ...
    if (*dnxc_data_get(unit, "l3", "fwd", "host_entry_support", NULL))
    {
        ...
        if(is_default)
        {
            ...
            /** add End-Point-1's next IP (u-SID) as host to do forwarding on to FEC (same VRF lookup as End-Point-1) */
            rv = add_host_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[END_POINT_3_DIP], cint_srv6_tunnel_info.vrf_in[NO_DEFAULT], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
            if (rv != BCM_E_NONE)
            {
            ...
            rv = add_host_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[END_POINT_4_DIP], cint_srv6_tunnel_info.vrf_in[NO_DEFAULT], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
            if (rv != BCM_E_NONE)
            {
            ...
            rv = add_host_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[END_POINT_5_DIP], cint_srv6_tunnel_info.vrf_in[NO_DEFAULT], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
            if (rv != BCM_E_NONE)
            {
            ...
            rv = add_host_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[EGRESS_DIP], cint_srv6_tunnel_info.vrf_in[NO_DEFAULT], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
            if (rv != BCM_E_NONE)
            {
            ...
            rv = add_host_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[END_POINT_CLASSIC], cint_srv6_tunnel_info.vrf_in[NO_DEFAULT], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
            if (rv != BCM_E_NONE)
            {
            ...
            rv = add_host_ipv4(unit, cint_srv6_tunnel_info.route_ipv4_dip, cint_srv6_tunnel_info.vrf_in[NO_DEFAULT], _l3_itf, cint_srv6_tunnel_info.eth_rif_intf_out[EGRESS], 0);
            if (rv != BCM_E_NONE)
            {
                printf("%s(): Error, in function add_host_ipv4() for SRV6 Ingress Tunnel\n",proc_name);
                return rv;
            ...
            rv = add_host_ipv6_encap_dest(unit, cint_srv6_tunnel_info.route_ipv6_dip, cint_srv6_tunnel_info.vrf_in[NO_DEFAULT], _l3_itf, cint_srv6_tunnel_info.eth_rif_intf_out[EGRESS], 0);
            if (rv != BCM_E_NONE)
            {
            ...
            rv = add_host_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[END_POINT_5_DIP], cint_srv6_tunnel_info.vrf_in[EGRESS], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
            if (rv != BCM_E_NONE)
            {
                printf("%s(): Error, in function add_host_ipv6 for End-Point-Classic: vrf = %d, fec = %d, err_id = %d\n", proc_name, cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID], rv);
                return rv;
        ...
        else
        {
           ...
           /**Add last dip destination, when the packet is egress node, but the layer above is TCP, so no TT will occur */
           rv = add_host_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[EGRESS_DIP], cint_srv6_tunnel_info.vrf_in[EGRESS], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
           if (rv != BCM_E_NONE)
           {
               printf("%s(): Error, in function add_host_ipv6 for End-Point-Classic: vrf = %d, fec = %d, err_id = %d\n", proc_name, cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID], rv);
               return rv;
        ...
        rv = add_host_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[END_POINT_TO_T_INSERT_FWD], cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[T_INSERT_FEC_ID]);
        if (rv != BCM_E_NONE)
        {
            printf("%s(): Error, in function add_host_ipv6 for End-Point-Classic: vrf = %d, fec = %d, err_id = %d\n", proc_name, cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID], rv);
            return rv;
    ...
    else
    {
        ...
        /** SRV6 Tunnel Ingress Forwarding for IPv4 as next header over SRv6 to FEC Hierarchy to bring out IPV6, SRH, SIDs - not including OUT-ETH-RIF entry */
       rv = add_route_ipv4(unit, cint_srv6_tunnel_info.route_ipv4_dip, ip4_mask, cint_srv6_tunnel_info.vrf_in[INGRESS], cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_IPV6_TUNNEL_FEC_ID]);
       if (rv != BCM_E_NONE)
       {
            printf("%s(): Error, in function add_route_ipv4() for SRV6 Ingress Tunnel\n",proc_name);
            return rv;
       }

       /** SRV6 Tunnel Ingress Forwarding for IPv6 as next header over SRv6 to FEC Hierarchy to bring out IPV6, SRH, SIDs - not including OUT-ETH-RIF entry */
       rv = add_route_ipv6(unit, cint_srv6_tunnel_info.route_ipv6_dip, ip6_mask, cint_srv6_tunnel_info.vrf_in[INGRESS], cint_srv6_tunnel_info.tunnel_fec_id[INGRESS_IPV6_TUNNEL_FEC_ID]);
       if (rv != BCM_E_NONE)
       {
           printf("%s(): Error, in function add_host_ipv6_encap_dest() for SRV6 Ingress Tunnel\n",proc_name);
           return rv;
        ...
        /** add End-Point-1's next IP (u-SID) as host to do forwarding on to FEC */
        rv = add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[END_POINT_2_DIP], ip6_mask, cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
        if (rv != BCM_E_NONE)
        {
            printf("%s(): Error, in function add_host_ipv6 for End-Point-2: vrf = %d, fec = %d, err_id = %d\n", proc_name, cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID], rv);
            return rv;
        ...
        /** add End-Point-2's next IP (u-SID) as host to do forwarding on to FEC (same VRF lookup as End-Point-1) */
        rv = add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[END_POINT_3_DIP], ip6_mask, cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
        if (rv != BCM_E_NONE)
        {
            printf("%s(): Error, in function add_host_ipv6 for End-Point-3: vrf = %d, fec = %d, err_id = %d\n", proc_name, cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID], rv);
            return rv;
        ...
        /** add End-Point-3's next IP (u-SID) as host to do forwarding on to FEC (same VRF lookup as End-Point-1) */
        rv = add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[END_POINT_4_DIP], ip6_mask, cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
        if (rv != BCM_E_NONE)
        {
            printf("%s(): Error, in function add_host_ipv6 for End-Point-4: vrf = %d, fec = %d, err_id = %d\n", proc_name, cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID], rv);
            return rv;
        ...
        /** add End-Point-4's next IP (u-SID) as host to do forwarding on to FEC (same VRF lookup as End-Point-1) */
        rv = add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[END_POINT_5_DIP], ip6_mask, cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
        if (rv != BCM_E_NONE)
        {
            printf("%s(): Error, in function add_host_ipv6 for End-Point-5: vrf = %d, fec = %d, err_id = %d\n", proc_name, cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID], rv);
            return rv;
        ...
        /** add End-Point-Classic case as host to do forwarding on to FEC - using the uSID Egress VRF (cause classic SID happens when SL > 0 and uSID Egress) */
        rv = add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[END_POINT_CLASSIC], ip6_mask, cint_srv6_tunnel_info.vrf_in[EGRESS], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
        if (rv != BCM_E_NONE)
        {
            printf("%s(): Error, in function add_host_ipv6 for End-Point-Classic: vrf = %d, fec = %d, err_id = %d\n", proc_name, cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID], rv);
            return rv;
        ...
        /** add End-Point-5's (u-SID) as host to do forwarding on to FEC (same VRF lookup as End-Point-1) */
        rv = add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[EGRESS_DIP], ip6_mask, cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
        if (rv != BCM_E_NONE)
        {
            printf("%s(): Error, in function add_host_ipv6 for End-Point-1: vrf = %d, fec = %d, err_id = %d\n", proc_name, cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID], rv);
            return rv;
        ...
        /**Add last dip destination, when the packet is egress node, but the layer above is TCP, so no TT will occur */
        rv = add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[EGRESS_DIP], ip6_mask, cint_srv6_tunnel_info.vrf_in[EGRESS], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
        if (rv != BCM_E_NONE)
        {
            printf("%s(): Error, in function add_host_ipv6 for End-Point-Classic: vrf = %d, fec = %d, err_id = %d\n", proc_name, cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID], rv);
            return rv;
        ...
        rv = add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[END_POINT_5_DIP], ip6_mask, cint_srv6_tunnel_info.vrf_in[EGRESS], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID]);
        if (rv != BCM_E_NONE)
        {
            printf("%s(): Error, in function add_host_ipv6 for End-Point-Classic: vrf = %d, fec = %d, err_id = %d\n", proc_name, cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID], rv);
            return rv;
        ...
        /**Add dip destination for usid into T_insert flow */
        rv = add_route_ipv6(unit, cint_srv6_tunnel_info.tunnel_ip6_dip[END_POINT_TO_T_INSERT_FWD], ip6_mask, cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[T_INSERT_FEC_ID]);
        if (rv != BCM_E_NONE)
        {
            printf("%s(): Error, in function add_host_ipv6 for End-Point-Classic: vrf = %d, fec = %d, err_id = %d\n", proc_name, cint_srv6_tunnel_info.vrf_in[END_POINT_1], cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_1_FEC_ID], rv);
            return rv;
        ...
        /** add Egress 2nd-Pass, IPv4 Packet DIP as host to do forwarding on to FEC when IPv4 is next header over SRv6*/
        rv = add_route_ipv4(unit, cint_srv6_tunnel_info.route_ipv4_dip, ip4_mask, cint_srv6_tunnel_info.vrf_in[RCH], _l3_itf);
        if (rv != BCM_E_NONE)
        {
            printf("%s(): Error, in function add_host_ipv4(), \n",proc_name);
            return rv;
        ...
        /** add Egress 2nd-Pass, IPv6 Packet DIP as host to do forwarding on to FEC when IPv6 is next header over SRv6 */
        rv = add_route_ipv6(unit, cint_srv6_tunnel_info.route_ipv6_dip, ip6_mask, cint_srv6_tunnel_info.vrf_in[RCH], _l3_itf);
        if (rv != BCM_E_NONE)
        {
            printf("%s(): Error, in function add_route_ipv6_encap_dest(), \n",proc_name);
            return rv;
        }
    }
     ...
     */
    {
        ...
        srv6_tunnel_termination(unit, END_POINT_1_DIP, 0, srh_present, cint_srv6_tunnel_info.vrf_in[END_POINT_1], tunnel_type_endpoint, is_default);

        /** End-Point-2: Add MyDIP of current End-Point, getting same VRF for all End-Points */
        srv6_tunnel_termination(unit, END_POINT_2_DIP, 0, srh_present, cint_srv6_tunnel_info.vrf_in[END_POINT_1], tunnel_type_endpoint, is_default);

        /** End-Point-3: Add MyDIP of current End-Point, getting same VRF for all End-Points */
        srv6_tunnel_termination(unit, END_POINT_3_DIP, 0, srh_present, cint_srv6_tunnel_info.vrf_in[END_POINT_1], tunnel_type_endpoint, is_default);

        /** End-Point-4: Add MyDIP of current End-Point, getting same VRF for all End-Points */
        srv6_tunnel_termination(unit, END_POINT_4_DIP, 0, srh_present, cint_srv6_tunnel_info.vrf_in[END_POINT_1], tunnel_type_endpoint, is_default);

        /** End-Point-5: Add MyDIP of current End-Point, getting same VRF for all End-Points */
        srv6_tunnel_termination(unit, END_POINT_5_DIP, 0, srh_present, cint_srv6_tunnel_info.vrf_in[END_POINT_1], tunnel_type_endpoint, is_default);

        /** End-Point-5: Add MyDIP of current End-Point, getting same VRF for all End-Points */
        srv6_tunnel_termination(unit, END_POINT_TO_T_INSERT, 0, srh_present, cint_srv6_tunnel_info.vrf_in[END_POINT_1], tunnel_type_endpoint, is_default);

        /** Egress: Add MyDIP according to the SIDs, because we need to terminate the IPV6 header with the current SID */
        srv6_tunnel_termination(unit, EGRESS_DIP, 1, srh_present, cint_srv6_tunnel_info.vrf_in[EGRESS], egress_tunnel_type, is_default);

        /** no default */
        srv6_tunnel_termination(unit, END_POINT_5_DIP, 0, srh_present, cint_srv6_tunnel_info.vrf_in[EGRESS], tunnel_type_endpoint, is_default);
