...
{
    bcmIPv4EncapsulationForwardTypeIPv4 = 0,
    bcmIPv4EncapsulationForwardTypeIPv6 = 1,
    bcmIPv4EncapsulationForwardTypeMPLS = 2
};

enum ipv4_encap_gre_type_e
{
    bcmIPv4EncapsulationGRE4 = 0,
    bcmIPv4EncapsulationGRE8 = 1,
    bcmIPv4EncapsulationMPLSoGRE = 2
};
 ...
 *         gre_type         - bcmIPv4EncapsulationGRE4/bcmIPv4EncapsulationGRE8/bcmIPv4EncapsulationMPLSoGRE;
 */
int
    ...
    int gre_type)
{
    ...
    if (gre_type == bcmIPv4EncapsulationGRE8)
    {
    ...
    if (gre_type == bcmIPv4EncapsulationMPLSoGRE )
    {
    ...
    if (forward_type == bcmIPv4EncapsulationForwardTypeMPLS)
    {
        /*
    ...
    else if (forward_type == bcmIPv4EncapsulationForwardTypeIPv4)
    {
        /*
         * Add Host entry
         */
    ...
    int udp_dst_port)
{
    ...
    rv = ip_tunnel_encap_with_various_fwd(unit, access_port, provider_port, bcmIPv4EncapsulationForwardTypeIPv4, bcmIPv4EncapsulationGRE4);
    if (rv != BCM_E_NONE)
    {
...
{
    int rv = BCM_E_NONE;
    rv = ip_tunnel_encap_with_various_fwd(unit, access_port, provider_port, bcmIPv4EncapsulationForwardTypeMPLS, bcmIPv4EncapsulationGRE4);
    if (rv != BCM_E_NONE)
    {
        printf("Error, ip_tunnel_encap_with_various_fwd\n");
        return rv;
    ...
    int provider_port)
{
    ...
    rv = ip_tunnel_encap_with_various_fwd(unit, access_port, provider_port, bcmIPv4EncapsulationForwardTypeIPv6, bcmIPv4EncapsulationGRE4);
    if (rv != BCM_E_NONE)
    {
        printf("Error, ip_tunnel_encap_with_various_fwd\n");
        return rv;
    ...
    int provider_port)
{
    ...
    rv = ip_tunnel_encap_with_various_fwd(unit, access_port, provider_port, bcmIPv4EncapsulationForwardTypeIPv4, bcmIPv4EncapsulationMPLSoGRE);
    if (rv != BCM_E_NONE)
    {
        printf("Error, ip_tunnel_encap_with_various_fwd\n");
        return rv;
    ...
    int provider_port)
{
    ...
    rv = ip_tunnel_encap_with_various_fwd(unit, access_port, provider_port, bcmIPv4EncapsulationForwardTypeIPv4, bcmIPv4EncapsulationGRE8);
    if (rv != BCM_E_NONE)
    {
        printf("Error, ip_tunnel_encap_with_various_fwd\n");
        return rv;
...
{
    int rv = BCM_E_NONE;
    rv = ip_tunnel_encap_with_various_fwd(unit, access_port, provider_port, bcmIPv4EncapsulationForwardTypeMPLS, bcmIPv4EncapsulationGRE8);
    if (rv != BCM_E_NONE)
    {
        printf("Error, ip_tunnel_encap_with_various_fwd\n");
        return rv;
