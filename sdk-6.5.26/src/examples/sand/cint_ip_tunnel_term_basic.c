 ...
 * 
 ...
 Copyright 2007-2022 Broadcom Inc. All rights reserved. File: cint_ip_tunnel_term_basic.c Purpose: Various examples for IPTunnels.
 *
 * FL-TUNNEL-IPV4
 */
 ...
 * print rv;
 *
 * tx 1 psrc=200 data=0x000c0002000000110000011208004500002e000000000b2f58bdac000001ab000001000008004500002e000000000b11abfaa0a1a1a2c080010100000000001ab3a3000102030405060708090a0b0c0d0e0f1011990d6899
 *
 ...
 *   |    |00:0C:00:02:00:00|00:11:00:00:01:12||    172.0.0.1    ||    171.0.0.1    ||       ||    192.128.1.1    ||  160.161.161.162   ||
 *   |    +-+-+-+-+-+-+-+-+-+-+-+-+-+--+-+-+-+-+-+-+-+-++-+-+-+-+-+-+-+-+-+-+-+-+-+--+-+-+-+-+-+-+-+-+-+-+-++-+-+-+-+-+-+-+-+-+-+-+-+-+-+
 *   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 *
 ...
 *   |    |00:00:00:00:CD:1D|00:0C:00:02:00:01||    192.128.1.1    ||  160.161.161.162   ||
 *   |    +-+-+-+-+-+-+-+-+-+-+-+-+-+--+-+-+-+-+-+-+-+-++-+-+-+-+-+-+-+-+-+-+-+-+-+--+-+-+-+-+-+-+-+-+-+-+-+-+-+-++-+-+-+-+-+-+-+
 *   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * ################################################################################################################################
 *
 * Egress packet:
 * Data: 0x00000000cd1d000c000200018100006408004500002e000000000a11acfac0800101a0a1a1a200000000001ab3a3000102030405060708090a0b0c0d0e0f1011
 *
 */
...
/*
 *  indicate wide_data support, support on J2C and above
 */
int is_tunnel_contain_wide_data = 0;
/*
    ...
    int access_port)
{
    ...
    rv = ip_tunnel_term_basic(unit, provider_port, access_port, 0);
    ...
    int unit)
{
    ...
    if (is_tunnel_contain_wide_data)
    {
