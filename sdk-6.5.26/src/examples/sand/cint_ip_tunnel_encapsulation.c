 ...
 * 
 ...
 Copyright 2007-2022 Broadcom Inc. All rights reserved. File: cint_ip_tunnel_encapsulation.c Purpose: Various examples for IPTunnels.
 *
 * FL-TUNNEL-IPV4
 */
 ...
 *
 *  tx 1 psrc=200 data=0x000c000200560050000012348847005b0141000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f202122232425262728291efb7906
 *
 *  ###############################################################################################################################
 ...
 *
 *   Egress packet:
 *   Data: 00020000CD1D000C000200568100A0640800450A004A00000000382F4159A0000011A100001100008847005B0140000102030405060708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F202122232425262728291EFB7906
 *
 *  ###############################################################################################################################
 *
 * cint;
 ...
 * int access_port = 200;
 * int provider_port = 201;
 * rv = ip_tunnel_mpls_o_gre_encap_with_ipvx_fwd(unit,access_port,provider_port,0);
 * print rv;
 *
 *  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 *  Send the following traffic:
 *
 *  tx 1 psrc=200 data=0x000c0002005600500000123486dd60000000001611363ffe000000000000fa4f57fffe720000e1e2e3e4e5e6e7e8e9eaebecedeeefec021f00030016d36f000102030405060708090a0b0c0dda3de37f
 *
 *  ###############################################################################################################################
 *  Receiving packet on access port == 200 :   ----------->
 *   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 *   |    |00:02:00:00:CD:1D||00:0C:00:02:00:56||    160.0.0.17   ||    161.0.0.17   ||  4   ||    200     || e1e2:e3e4:e5e6:e7e8: ||
 *   |    |                 ||                 ||                 ||                 || 8847 ||            || :e9ea:ebec:edee:efec ||
 *   |    +-+-+-+-+-+-+-+-+-+-+-+-+-+--+-+-+-+-+-+-+-+-++-+-+-+-+-+-+-+-+-+-+-+-+-+--+-+-+-+-+-+-+-+-+-+-+-++-+-+-+-+-+-+-+-+-+-+-+-
 *   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 *
 *   Egress packet:
 *   Data:0x00020000cd1d000c000200568100a0640800450a005a00000000382f4149a0000011a100001100008847000c814360000000001611353ffe000000000000fa4f57fffe720000e1e2e3e4e5e6e7e8e9eaebecedeeefec021f00030016d36f000102030405060708090a0b0c0d
 *
 *  ################################################################################################################################
 *
 * cint;
 ...
 * int access_port = 200;
 * int provider_port = 201;
 * rv = ip_tunnel_gre8_lb_key_encap_with_mpls_fwd(unit,access_port,provider_port);
 * print rv;
 *
 *  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 *   |    +-+-+-+-+-+-+-+-+-+-+-+-+-++-+-+-+-+-+-+-+-+-++-+-+-+-+-+-+-+-+-+-+-+-+-++-+-+-+-+-+-+-+-+-+-+-+-++-+-+-+-+-+-+-+-+-+-+-+
 *   |    |      DA         ||      SA         || IPv4 tunnel SIP || IPv4 tunnel DIP ||  GRE   ||   MPLS LABEL    ||
 *   |    |00:02:00:00:CD:1D||00:0C:00:02:00:56||    160.0.0.17   ||    161.0.0.17   ||   8    ||     1456        ||
 *   |    |                 ||                 ||    A0.00.00.11  ||    A1.00.00.11  ||  8847  ||                 ||
 *   |    +-+-+-+-+-+-+-+-+-+-+-+-+-+--+-+-+-+-+-+-+-+-++-+-+-+-+-+-+-+-+-+-+-+-+-+--+-+-+-+-+-+-+-+-+-+-+-++-+-+-+-+-+-+-+-+-+-+-+
 *   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 *
 *   Egress packet:
 *   Data: 0x00020000cd1d000c000200568100a0640800450a004e00000000382f4155a0000011a100001120008847000000f3005b0140000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f202122232425262728291efb7906
 *
 *  ###############################################################################################################################
 *
 * cint;
 ...
 * int access_port = 200;
 * int provider_port = 201;
 * rv = ip_tunnel_gre8_lb_key_encap_with_ipvx_fwd(unit,access_port,provider_port);
 * print rv;
 *
 *  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 *   |    |00:02:00:00:CD:1D||00:0C:00:02:00:56||   160.0.0.17  ||   161.0.0.17  ||  8   ||            127.255.255.03             ||
 ...
 *
 *   Egress packet:
 *   Data: 0x00020000cd1d000c000200568100a0640800450a005a00000000382f4149a0000011a1000011200086dd0000002860000000001611353ffe000000000000fa4f57fffe720000e1e2e3e4e5e6e7e8e9eaebecedeeefec021f00030016d36f000102030405060708090a0b0c0d
 *
 *  ###############################################################################################################################
 *
 * cint;
 ...
 *   |    +-+-+-+-+-+-+-+-+-+-+-+-+-++-+-+-+-+-+-+-+-+-++-+-+-+-+-+-+-+-+-+-+-+-+-++-+-+-+-+-+-+-+-+-+-+-+-++-+-+-+-+-+-+-+-+-+-+-+
 *   |    |      DA         ||      SA         ||IPv4 tunnel SIP||IPv4 tunnel DIP|| GRE  || MPLS LABEL ||       IPvX DIP       ||
 *   |    |00:02:00:00:CD:1D||00:0C:00:02:00:56||   160.0.0.17  ||   161.0.0.17  ||  4   ||     200    ||    127.255.255.03    ||
 *        |                 ||                 ||   A0.00.00.11 ||   A1.00.00.11 || 8847 ||            || e1e2:e3e4:e5e6:e7e8: ||
 *        |                 ||                 ||               ||               ||      ||            || :e9ea:ebec:edee:efec ||
 *   |    +-+-+-+-+-+-+-+-+-+-+-+-+-+--+-+-+-+-+-+-+-+-++-+-+-+-+-+-+-+-+-+-+-+-+-+--+-+-+-+-+-+-+-+-+-+-+-++-+-+-+-+-+-+-+-+-+-+-+
 *   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 *
