 ...
 *
 * Test Scenario: Entropy label imposition
 *
 * SOC properties:
 * - Jericho/QMX only
 * mpls_egress_label_entropy_indicator_enable=1
 *
 * ./bcm.user
 ...
 * cint ../../../../src/examples/sand/cint_l2_mact.c
 ...
 * cint
 * mpls_entropy_label_inserting_example(0,201,203,0,0);
 * exit;
 *
 * cint
 * ip_to_mpls_tunnel_with_entropy_label_on_2_mpls_enc(0,201,203,2,2,1,0);
 * exit;
 *
 ...
 *
 * cint
 * ip_to_mpls_tunnel_with_entropy_label_on_2_mpls_enc(0,201,203,2,2,0,0);
 * exit;
 *
 * tx 1 psrc=201 data=0x0000000000110000e7ec428e81000064080045000054000000008000a7910a0a0a0a7fffff052008011800000000000300040000000a0000000a0000000100010203040500000001020304050000000300040000000a0000000a000000010001020304050000
 *
 ...
 *
 * cint
 * ip_to_mpls_tunnel_with_entropy_label_on_2_mpls_enc(0,201,203,2,1,0,0);
 * exit;
 *
 * tx 1 psrc=201 data=0x0000000000110000e7ec428e81000064080045000054000000008000a7910a0a0a0a7fffff052008011800000000000300040000000a0000000a0000000100010203040500000001020304050000000300040000000a0000000a000000010001020304050000
 *
 ...
 *
 * cint
 * ip_to_mpls_tunnel_with_entropy_label_on_1_mpls_enc(0,201,203,2,0,0);
 * exit;
 *
 * tx 1 psrc=201 data=0x0000000000110000e7ec428e81000064080045000054000000008000a7910a0a0a0a7fffff052008011800000000000300040000000a0000000a0000000100010203040500000001020304050000000300040000000a0000000a000000010001020304050000
 *
 ...
 *
 * cint
 * ip_to_mpls_tunnel_with_entropy_label_on_2_mpls_enc(0,201,203,1,2,0,0);
 * exit;
 *
 * tx 1 psrc=201 data=0x0000000000110000e7ec428e81000064080045000054000000008000a7910a0a0a0a7fffff052008011800000000000300040000000a0000000a0000000100010203040500000001020304050000000300040000000a0000000a000000010001020304050000
 *
 ...
 *
 * Test Scenario: additional MPLS label with/without entropy labels
 *
 * SOC properties:
 * - Jericho/QMX only
 * mpls_egress_label_entropy_indicator_enable=1
 * - all Jericho family devices
