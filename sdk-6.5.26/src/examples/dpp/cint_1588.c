 ...
 * 4) Enable parser of 1588oUDP
 *      custom_feature_ptp_udp_parser_enable=1
 *    (without this soc property, 1588oUDP won't be indentified as 1588 packets)
 *
 * For 1588 traffic send and receive on 1588 Firmware
 * 1) Add a dedicated CPU port 204 to receive 1588 traffic on ARM core
 *      custom_feature_ptp_cosq_port.BCM88650=204
 *      ucode_port_204.BCM88650=CPU.32:core_0.104
 *    The following is an example of adding CPU port 204 on QUX
 *      config add port_priorities.BCM88270=2
 *      config add ucode_port_0.BCM88270=CPU.0:core_0.0
 *      config add ucode_port_200.BCM88270=CPU.2:core_0.100
 *      config add ucode_port_201.BCM88270=CPU.4:core_0.101
 *      config add ucode_port_202.BCM88270=CPU.6:core_0.102
 *      config add ucode_port_203.BCM88270=CPU.8:core_0.103
 *      config add ucode_port_204.BCM88270=CPU.10:core_0.104
 *    The following is another exmaple of remove CPU port 203 and add 204
 *      config delete ucode_port_203.BCM88675
 *      config delete ucode_port_203.BCM88470
 *      config delete ucode_port_203.BCM88650
 *      config delete ucode_port_203.BCM88270
 *      config add ucode_port_204.BCM88270=CPU.32:core_0.104
 *    Please NOTE 1588 Firmware often receive traffic on CMC1
 *    CMIC RX cos is required to be enabled on the corresponding channel on CMC1
 * 2)1588 Firmware receive 1588 traffic without Dune system headers
 *      tm_port_header_type_in_204.BCM88650=ETH
 *      tm_port_header_type_out_204.BCM88650=ETH
 * 3) 1588 Firmware injects 1588 traffic into CPU port 0 with PTCH header
 *      tm_port_header_type_in_0.BCM88650=INJECTED_2
 * 4) Enable external_1588_mac mode on CPU port 0\204, 1588 CorrectionField won't be updated in external_1588_mac mode
 *      ext_1588_mac_enable_0.BCM88650=1
 *      ext_1588_mac_enable_204.BCM88650=1
 * In case the system contain more than one device, need to run Broadsync application (see 'Broadsync' section below).
 *
