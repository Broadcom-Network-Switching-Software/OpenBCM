    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_pph_group_context_attach
                    (unit, fg_id,
                     ...
                     FLAG_BIT_ITMH_1588_PPH_FHEI_CONTEXT | FLAG_BIT_ITMH_1588_PPH_FHEI_VLAN_CONTEXT, &attach_info));
    ...
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_pph_group_context_attach
                    (unit, fg_id,
                     ...
                     FLAG_BIT_ITMH_1588_PPH_FHEI_VLAN_CONTEXT | FLAG_BIT_PPH_FHEI_VLAN_CONTEXT, &attach_info));
    ...
    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_pph_group_context_attach
                    (unit, fg_id,
                     ...
                     FLAG_BIT_ITMH_1588_PPH_CONTEXT, &attach_info));
