...
extern cint_ast_t* cint_ast_if(cint_ast_t* str_if, cint_ast_t* expr, cint_ast_t* statements, cint_ast_t* _else); 
extern cint_ast_t* cint_ast_case(cint_ast_t* expr, cint_ast_t* statements); 
extern cint_ast_t* cint_ast_switch(cint_ast_t* str_switch, cint_ast_t* expr, cint_ast_t* statements); 
...
extern char* (*cint_ast_get_file_f)(void); 
