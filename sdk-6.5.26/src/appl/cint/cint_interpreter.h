...
extern int cint_interpreter_parse(void* handle, const char* prompt, int argc, char** argv, const char* file_name);
extern cint_ast_t* cint_interpreter_parse_string(const char* expr); 
extern int cint_interpreter_parse_and_eval_string(const char* expr, cint_error_t *cint_err);
#endif
