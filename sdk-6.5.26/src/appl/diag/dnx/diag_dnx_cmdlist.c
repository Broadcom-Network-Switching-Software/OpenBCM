...
static sh_sand_cmd_t sh_dnx_commands[] = {
  /* Name                 | Leaf Action          | Junction Array Pointer         | Options for Leaf         | Usage */
    ...
    {"counter",           cmd_dnxc_counter,      NULL,                            dnxc_counter_options,      &sh_dnx_counter_man        , NULL, NULL, CTEST_POSTCOMMIT * SH_CMD_SKIP_MEMORY_CHECK},
    ...
    {"DEviceReset",       sh_dnx_reset_cmd,      NULL,                            sh_dnx_reset_options,      &sh_dnx_reset_man          , NULL, NULL, CTEST_POSTCOMMIT * SH_CMD_NO_XML_VERIFY * SH_CMD_INIT_REQUIRED},
    ...
    {"FLexE",             NULL,                  sh_dnx_diag_flexe_cmds,          NULL,                      &sh_dnx_diag_flexe_man     , NULL, NULL, CTEST_POSTCOMMIT * SH_CMD_CONDITIONAL * SH_CMD_NO_XML_VERIFY * SH_CMD_NOT_RELEASE, sh_cmd_is_framer_available},
#ifndef NO_FRAMER_LIB_BUILD
    {"Framer",            NULL,                  sh_dnx_diag_framer_cmds,         NULL,                      &sh_dnx_diag_framer_man    , NULL, NULL, CTEST_POSTCOMMIT * SH_CMD_CONDITIONAL * SH_CMD_NO_XML_VERIFY, sh_cmd_is_framer_available},
#endif
    ...
    {"lsm",               NULL,                  Dnx_lsm_cmds,                    NULL,                      &Dnx_lsm_man               , NULL, NULL, CTEST_POSTCOMMIT},
...
#endif
    {"SER",               NULL,                  sh_dnx_diag_ser_cmds,            NULL,                      &sh_dnxc_diag_ser_man      , NULL, NULL, CTEST_POSTCOMMIT},
    {"show",              NULL,                  sh_dnxc_show_cmds,               NULL,                      &sh_dnxc_show_man          , NULL, NULL, CTEST_POSTCOMMIT * SH_CMD_INIT_REQUIRED},
    ...
    {"THreaD",            NULL,                  sh_dnxc_thread_cmds,             NULL,                      &sh_dnxc_thread_man        , NULL, NULL, SH_CMD_SKIP_EXEC * SH_CMD_NO_XML_VERIFY},
