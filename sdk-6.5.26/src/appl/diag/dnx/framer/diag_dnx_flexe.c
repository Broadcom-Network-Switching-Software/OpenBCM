    ...
    dnx_algo_port_type_e port_type)
{
    ...
    SHR_IF_ERR_EXIT(dnx_algo_framer_66bsw_block_id_get(unit, port_type, 0, &src_info.block_id));
    /*
    ...
    _SHR_PBMP_ITER(src_port_pbmp, src_logical_port)
    {
         ...
         */
        if (port_type == DNX_ALGO_PORT_TYPE_FRAMER_SAR)
        {
    ...
    sh_sand_control_t * sand_control)
{
    ...
    bcm_pbmp_t phy_ports, group_ports, client_ports, client_macs;
