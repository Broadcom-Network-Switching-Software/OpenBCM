...
{
    char *begin = NULL, *dot = NULL, *bracket = NULL;
    ...
    if (array)
    {
        if (array[0] != '\0')
        {
            SHR_IF_ERR_EXIT_NO_MSG(framer_symbol_array2index(unit, array, &aidx));
...
{
    int i, j, rv, found = 0;
    J2X_MODULE_INST_S *mi = sm->mi;
    J2X_MODULE_S *module = mi->module;
    J2X_C *inst_name = mi->inst_name;
