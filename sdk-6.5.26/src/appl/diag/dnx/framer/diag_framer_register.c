...
static int setreg_debug = 0;
static int modreg_debug = 0;
    ...
    void *user_data)
{
    ...
    int midx;
    uint32 *data = NULL;
    uint32 gflags = *(uint32 *) user_data;
    ...
    cli_out("\n");
    if ((gflags & FRAMER_SYMBOL_DISPLAY_F_BRIEF) == 0)
    {
        ud.pfx = "\t";
        ud.sfx = NULL;
        ud.dw = sym->count;
