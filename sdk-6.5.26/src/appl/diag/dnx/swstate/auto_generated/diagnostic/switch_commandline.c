...
sh_sand_cmd_t sh_dnx_swstate_switch_cmds[] = {
    ...
    {"wide_data_extension_key_mode", NULL, sh_dnx_swstate_switch_wide_data_extension_key_mode_cmds, NULL, &dnx_swstate_switch_wide_data_extension_key_mode_man},
    {"wide_data_extension_key_ffc_base_offset", NULL, sh_dnx_swstate_switch_wide_data_extension_key_ffc_base_offset_cmds, NULL, &dnx_swstate_switch_wide_data_extension_key_ffc_base_offset_man},
    {"per_port_special_label_termination_disabled", NULL, sh_dnx_swstate_switch_per_port_special_label_termination_disabled_cmds, NULL, &dnx_swstate_switch_per_port_special_label_termination_disabled_man},
...
sh_sand_cmd_t sh_dnx_swstate_switch_wide_data_extension_key_mode_cmds[] = {
    {"dump", sh_dnx_swstate_switch_wide_data_extension_key_mode_dump_cmd, NULL, dnx_swstate_switch_wide_data_extension_key_mode_dump_options, &dnx_swstate_switch_wide_data_extension_key_mode_dump_man},
    {"size_get", sh_dnx_swstate_switch_wide_data_extension_key_mode_size_get_cmd, NULL, dnx_swstate_switch_wide_data_extension_key_mode_size_get_options, &dnx_swstate_switch_wide_data_extension_key_mode_size_get_man},
    {NULL}
};


sh_sand_man_t dnx_swstate_switch_wide_data_extension_key_mode_man = {
    cmd_dnx_swstate_switch_wide_data_extension_key_mode_desc,
    NULL,
    NULL,
    NULL,
};
...
const char cmd_dnx_swstate_switch_wide_data_extension_key_mode_desc[] = "switch_db wide_data_extension_key_mode commands";
...
sh_sand_option_t dnx_swstate_switch_wide_data_extension_key_mode_dump_options[] = {
    {"nocontent",      SAL_FIELD_TYPE_BOOL, "Decision if to perform content dump or to print the access tree.",  "false"},
    {"typefilter",     SAL_FIELD_TYPE_STR,  "Filter for the variable type.",         ""},
    {"namefilter",     SAL_FIELD_TYPE_STR,  "Filter for the variable name.",         ""},
    {NULL}
...
sh_sand_man_t dnx_swstate_switch_wide_data_extension_key_mode_dump_man = {
    "swstate dump",
    "print the variable value",
    "switch_db wide_data_extension_key_mode dump []\n",
    "switch_db wide_data_extension_key_mode dump nocontent=false typefilter="" namefilter="" ",
};
...
shr_error_e sh_dnx_swstate_switch_wide_data_extension_key_mode_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(switch_db_info[unit], switch_db_layout_str, SWITCH_DB_INFO_NOF_ENTRIES, "SWITCH_DB~WIDE_DATA_EXTENSION_KEY_MODE~", sizeof(((switch_sw_state_t*)sw_state_roots_array[unit][SWITCH_MODULE_ID])->wide_data_extension_key_mode));
    dnx_sw_state_size_print(size);
...
sh_sand_option_t dnx_swstate_switch_wide_data_extension_key_mode_size_get_options[] = {
    {NULL}
};


sh_sand_man_t dnx_swstate_switch_wide_data_extension_key_mode_size_get_man = {
    "swstate size_get",
    "print the variable size",
    "switch_db wide_data_extension_key_mode size_get",
    "switch_db wide_data_extension_key_mode size_get",
};



sh_sand_cmd_t sh_dnx_swstate_switch_wide_data_extension_key_ffc_base_offset_cmds[] = {
    {"dump", sh_dnx_swstate_switch_wide_data_extension_key_ffc_base_offset_dump_cmd, NULL, dnx_swstate_switch_wide_data_extension_key_ffc_base_offset_dump_options, &dnx_swstate_switch_wide_data_extension_key_ffc_base_offset_dump_man},
    {"size_get", sh_dnx_swstate_switch_wide_data_extension_key_ffc_base_offset_size_get_cmd, NULL, dnx_swstate_switch_wide_data_extension_key_ffc_base_offset_size_get_options, &dnx_swstate_switch_wide_data_extension_key_ffc_base_offset_size_get_man},
    {NULL}
};


sh_sand_man_t dnx_swstate_switch_wide_data_extension_key_ffc_base_offset_man = {
    cmd_dnx_swstate_switch_wide_data_extension_key_ffc_base_offset_desc,
    NULL,
    NULL,
    NULL,
};
...
const char cmd_dnx_swstate_switch_wide_data_extension_key_ffc_base_offset_desc[] = "switch_db wide_data_extension_key_ffc_base_offset commands";
...
sh_sand_option_t dnx_swstate_switch_wide_data_extension_key_ffc_base_offset_dump_options[] = {
    {"nocontent",      SAL_FIELD_TYPE_BOOL, "Decision if to perform content dump or to print the access tree.",  "false"},
    {"typefilter",     SAL_FIELD_TYPE_STR,  "Filter for the variable type.",         ""},
    {"namefilter",     SAL_FIELD_TYPE_STR,  "Filter for the variable name.",         ""},
    {NULL}
...
sh_sand_man_t dnx_swstate_switch_wide_data_extension_key_ffc_base_offset_dump_man = {
    "swstate dump",
    "print the variable value",
    "switch_db wide_data_extension_key_ffc_base_offset dump []\n",
    "switch_db wide_data_extension_key_ffc_base_offset dump nocontent=false typefilter="" namefilter="" ",
};
...
shr_error_e sh_dnx_swstate_switch_wide_data_extension_key_ffc_base_offset_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(switch_db_info[unit], switch_db_layout_str, SWITCH_DB_INFO_NOF_ENTRIES, "SWITCH_DB~WIDE_DATA_EXTENSION_KEY_FFC_BASE_OFFSET~", sizeof(((switch_sw_state_t*)sw_state_roots_array[unit][SWITCH_MODULE_ID])->wide_data_extension_key_ffc_base_offset));
    dnx_sw_state_size_print(size);
...
sh_sand_option_t dnx_swstate_switch_wide_data_extension_key_ffc_base_offset_size_get_options[] = {
    {NULL}
};


sh_sand_man_t dnx_swstate_switch_wide_data_extension_key_ffc_base_offset_size_get_man = {
    "swstate size_get",
    "print the variable size",
    "switch_db wide_data_extension_key_ffc_base_offset size_get",
    "switch_db wide_data_extension_key_ffc_base_offset size_get",
};



sh_sand_cmd_t sh_dnx_swstate_switch_per_port_special_label_termination_disabled_cmds[] = {
    {"dump", sh_dnx_swstate_switch_per_port_special_label_termination_disabled_dump_cmd, NULL, dnx_swstate_switch_per_port_special_label_termination_disabled_dump_options, &dnx_swstate_switch_per_port_special_label_termination_disabled_dump_man},
    {"size_get", sh_dnx_swstate_switch_per_port_special_label_termination_disabled_size_get_cmd, NULL, dnx_swstate_switch_per_port_special_label_termination_disabled_size_get_options, &dnx_swstate_switch_per_port_special_label_termination_disabled_size_get_man},
    {NULL}
};


sh_sand_man_t dnx_swstate_switch_per_port_special_label_termination_disabled_man = {
    cmd_dnx_swstate_switch_per_port_special_label_termination_disabled_desc,
    NULL,
    NULL,
    NULL,
};
...
const char cmd_dnx_swstate_switch_per_port_special_label_termination_disabled_desc[] = "switch_db per_port_special_label_termination_disabled commands";
...
sh_sand_option_t dnx_swstate_switch_per_port_special_label_termination_disabled_dump_options[] = {
    {"nocontent",      SAL_FIELD_TYPE_BOOL, "Decision if to perform content dump or to print the access tree.",  "false"},
    {"typefilter",     SAL_FIELD_TYPE_STR,  "Filter for the variable type.",         ""},
    {"namefilter",     SAL_FIELD_TYPE_STR,  "Filter for the variable name.",         ""},
    {NULL}
...
sh_sand_man_t dnx_swstate_switch_per_port_special_label_termination_disabled_dump_man = {
    "swstate dump",
    "print the variable value",
    "switch_db per_port_special_label_termination_disabled dump []\n",
    "switch_db per_port_special_label_termination_disabled dump nocontent=false typefilter="" namefilter="" ",
};
...
shr_error_e sh_dnx_swstate_switch_per_port_special_label_termination_disabled_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(switch_db_info[unit], switch_db_layout_str, SWITCH_DB_INFO_NOF_ENTRIES, "SWITCH_DB~PER_PORT_SPECIAL_LABEL_TERMINATION_DISABLED~", sizeof(((switch_sw_state_t*)sw_state_roots_array[unit][SWITCH_MODULE_ID])->per_port_special_label_termination_disabled));
    dnx_sw_state_size_print(size);
...
sh_sand_option_t dnx_swstate_switch_per_port_special_label_termination_disabled_size_get_options[] = {
    {NULL}
};


sh_sand_man_t dnx_swstate_switch_per_port_special_label_termination_disabled_size_get_man = {
    "swstate size_get",
    "print the variable size",
    "switch_db per_port_special_label_termination_disabled size_get",
    "switch_db per_port_special_label_termination_disabled size_get",
};
