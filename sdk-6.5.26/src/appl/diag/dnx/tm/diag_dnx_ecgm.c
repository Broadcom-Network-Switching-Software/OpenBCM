    ...
    sh_sand_control_t * sand_control)
{
    ...
    uint32 max_nof_egr_ifs_to_get = 0;
    PRT_INIT_VARS;
    SHR_FUNC_INIT_VARS(unit);
    ...
    {
        /** Go over only interfaces that can be allocated for special interfaces and NIF, FlexE are not presented */
        max_nof_egr_ifs_to_get =
        ...
        for (interface = 0; interface < max_nof_egr_ifs_to_get; interface++)
        {
