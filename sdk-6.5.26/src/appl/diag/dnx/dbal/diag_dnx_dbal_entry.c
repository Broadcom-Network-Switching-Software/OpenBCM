 ...
 * TYPEDEFS  *
 *************/
extern int diag_table_is_allocator_field_used(
    int unit,
    ...
    char *cmd)
{
    ...
    SH_SAND_GET_ITERATOR(sand_arg)
    {
        ...
        if (is_key == TRUE)
        {
            ...
            else if (diag_table_is_allocator_field_used(unit, table_id) && (table->allocator_field_id == field_id))
            {
                uint8 is_allocated;
                /*
                ...
                else
                {
                     ...
                     */
                    SHR_IF_ERR_EXIT(dnx_algo_res_dbal_is_allocated(unit, core_id,
                                                                   0, field_value, table_id, res_type, field_id, FALSE,
                                                                   &is_allocated));
                    if (!is_allocated)
                    {
                        /*
