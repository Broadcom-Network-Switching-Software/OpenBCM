...
#define BCM_FIELD_NAME_TO_ID_MAX_IDS    10         /* Maximum number of field
                                                      IDs returned by
...
/* Macros for field entry config create */
#define BCM_FIELD_ENTRY_CREATE_WITH_ID  (1 << 0)   /* Create an entry with given
                                                      entry Id */

/* Macros for field entry config create */
#define BCM_FIELD_ENTRY_CREATE_WITH_PRIORITY (1 << 1)   /* Create an entry with
                                                          given priority */

/* Macros for field entry config create */
#define BCM_FIELD_ENTRY_CREATE_AS_DEFAULT   (1 << 2)   /* Create an entry as
                                                          default entry of given
                                                          group for ExactMatch
                                                          or FlowTracker stage */

/* Macros for field entry config get */
#define BCM_FIELD_ENTRY_STATUS_INSTALLED    (1 << 0)   /* The requested entry is
                                                          installed */

/* Macros for field entry config get */
#define BCM_FIELD_ENTRY_STATUS_ENABLED  (1 << 1)   /* The requested entry is
                                                      enabled */

/* Macros for field entry config get */
#define BCM_FIELD_ENTRY_STATUS_DEFAULT_ENTRY (1 << 2)   /* The requested entry is
                                                          an ExactMatch default
                                                          entry */

/* Macros for field entry config get */
#define BCM_FIELD_ENTRY_STATUS_FLEXCTR_ATTACHED (1 << 3)   /* The requested entry
                                                          has flex counter
                                                          attached */

/* Macros for field entry config get */
#define BCM_FIELD_ENTRY_STATUS_POLICER_ATTACHED (1 << 4)   /* The requested entry
                                                          has policer attached */
...
/* Stat OAM LM Index. */
typedef enum bcm_field_stat_oam_lm_index_e {
    bcmFieldStatOamLmIndex0 = 0,        /* Stat oam lm index 0 */
    bcmFieldStatOamLmIndex1 = 1,        /* Stat oam lm index 1 */
    bcmFieldStatOamLmIndex2 = 2,        /* Stat oam lm index 2 */
    bcmFieldStatOamLmIndexInvalid = 3,  /* Stat oam lm index invalid */
    bcmFieldStatOamLmIndexCount = 4     /* Always Last. Not a usable value. */
} bcm_field_stat_oam_lm_index_t;

#define BCM_FIELD_STAT_OAM_LM_INDEX_STRINGS \
{ \
    "0", \
    "1", \
    "2", \
...
#define BCM_FIELD_IP_HDR_OFFSET_ZERO        0x0001     /* IP Header offset zero */
...
#define BCM_FIELD_IP_HDR_SIP_LT_DIP         0x0010     /* Source Ip address is
                                                          ...
                                                          Ip address. */
#define BCM_FIELD_IP_HDR_SIP_EQ_DIP         0x0020     /* Source Ip address is
                                                          equal to destination
                                                          Ip address. */
#define BCM_FIELD_IP_HDR_BCAST_DIP          0x0040     /* Destination Ip address
                                                          is broadcast. */
#define BCM_FIELD_IP_HDR_MCAST_DIP          0x0080     /* Destination Ip address
                                                          is multicast. */
...
#define BCM_FIELD_IP_HDR_BFD_LOOPBACK_DIP   0x0200     /* Destionation Ip
                                                          address is BFD
                                                          loopback. */
#define BCM_FIELD_IP_HDR_FRAG_FLAGS_OFFSET_ONE 0x0400     /* IP Fragment flags
                                                          offset is one */
...
#define BCM_FIELD_IP_HDR_FRAG_FLAGS_OFFSET_NON_ZERO 0x040000   /* IP Fragment flags
                                                          offset is nonzero */
...
#define BCM_FIELD_LOOPBACK_ROUTED_PKT       0x0002     /* Loopback packet is a
                                                          routed packet. */
#define BCM_FIELD_LOOPBACK_RECIRCLE_HDR_PKT 0x0004     /* Loopback packet is a
                                                          egress NIH header
                                                          packet. */
...
/* 
 * CML flag (for bcmFieldActionCmlFlagsNew and
 * bcmFieldActionCmlFlagsMove).
 */
#define BCM_FIELD_CML_FLAG_DROP         0x0001     /* Set CML flag as Drop. */
#define BCM_FIELD_CML_FLAG_COPY_TO_CPU  0x0002     /* Set CML flag as Copy to
                                                      CPU. */
#define BCM_FIELD_CML_FLAG_LEARN        0x0004     /* Set CML flag as Learn. */
...
/* Packet Resolution Values (for bcm_field_qualify_PacketRes). */
#define BCM_FIELD_FWD_PKT_RES_MC    0x0        /* Multicast. */
#define BCM_FIELD_FWD_PKT_RES_L3BC  0x1        /* L3 broadcast. */
#define BCM_FIELD_FWD_PKT_RES_L3UC  0x2        /* L3 unicast. */
#define BCM_FIELD_FWD_PKT_RES_L2BC  0x4        /* L2 broadcast. */
#define BCM_FIELD_FWD_PKT_RES_L2UC  0x8        /* L2 unicast. */
...
#define BCM_FIELD_INT_POOL_BUFFER_AVAILABLE 0x3        /* Buffer available in
                                                          pool request. */
#define BCM_FIELD_INT_MIN_BUFFER_AVAILABLE  0x4        /* Minimum buffer
                                                          available in pool
                                                          request. */

/* 
 * Override trace event action values for action
 * bcmFieldActionOverrideTraceEvent
 */
#define BCM_FIELD_TRACE_EVENT_DO_NOT_MIRROR 0x1        /* Override trace do not
                                                          mirror event */
#define BCM_FIELD_TRACE_EVENT_DO_NOT_COPY_TO_CPU 0x2        /* Override trace do not
                                                          copy to cpu event */

/* 
 * Post operation egress action values for action
 * bcmFieldActionEgressPostOperation
 */
#define BCM_FIELD_EGRESS_OPR_DEFAULT        0x0        /* Default Egress
                                                          Operation */
#define BCM_FIELD_EGRESS_OPR_RECIRCLE_HDR_ENABLE 0x1        /* Enable ep nih header
                                                          for recirculation */
#define BCM_FIELD_EGRESS_OPR_IFA_DELETE     0x2        /* Delete IFA operation */

/* Inband telemetry control (for bcm_field_qualify_IntCtrl). */
#define BCM_FIELD_INT_CTRL_INSERT_IFA_RECORD 0x0001     /* Insert IFA recored. */
#define BCM_FIELD_INT_CTRL_DELETE_IFA_TRACE 0x0002     /* Delete IFA trace. */
...
typedef enum bcm_field_qualify_e {
    ...
    bcmFieldQualifyIp6NextHeader = bcmFieldQualifyIpProtocol, /*  Match on Ipv6 last extension
                                           header(or protocol type). */
    ...
    bcmFieldQualifyHiGigDoNotFlags = 572, /* Don't Learn(do not perform MAC
                                           learning) and Don't Modify(Send the
    ...
    bcmFieldQualifyBfdPktVersionOne = 738, /* Match on BFD Version One. The data
                                           '1' indicates the version as 1, 0
                                           indicates version other than 1. */
    ...
    bcmFieldQualifyInnerBfdPktVersionOne = 743, /* Match on Inner BFD Version One. The
                                           data '1' indicates the version as 1,
                                           0 indicates version other than 1. */
    ...
    bcmFieldQualifyEgressForwardingClassId = 779, /* Qualifies on the Class Identifier
                                           ...
                                           forwarding tables. */
    bcmFieldQualifyPktFlowType = 780,   /* Pseudo Qualifier to define the flow
    ...
    bcmFieldQualifyCompareKeysResult0 = 827, /* Qualifies on the Result of comparing
                                           the first pair of initial keys */
    bcmFieldQualifyCompareKeysResult1 = 828, /* Qualifies on the Result of comparing
                                           the second pair of initial keys */
    bcmFieldQualifyCompareKeysTcam0 = 829, /* Qualifies on the Result of comparing
                                           initial key and TCAM result 0 */
    bcmFieldQualifyCompareKeysTcam1 = 830, /* Qualifies on the Result of comparing
                                           initial key and TCAM result 1. */
    ...
    bcmFieldQualifyTrunkLoadBalanceKey = 843, /* Qualifies on the LAG Load Balancing
                                           Key. */
    bcmFieldQualifyForward = 844,       /* Raw data for destination. */
    ...
    bcmFieldQualifyVrfValue = 961,      /* VRF value part of the forwarding
                                           domain, not including the forwarding
                                           domain type. */
    ...
    bcmFieldQualifyTunnelAltEtherType = 1015, /* Alternate tunnel EtherType, for
                                           ...
                                           termination flows it carries inner L2
                                           header EtherType. */
    bcmFieldQualifyTunnelAltSrcIp = 1016, /* Alternate tunnel source Ipv4, for
                                           ...
                                           flows it carries inner L3 header
                                           SrcIp4. */
    ...
    bcmFieldQualifyTunnelAltDstIp = 1018, /* Alternate tunnel destination Ipv4,
                                           ...
                                           termination flows it carries inner L3
                                           header DstIp4. */
    ...
    bcmFieldQualifyTunnelAltL4SrcPort = 1021, /* Alternate tunnel source L4 port, for
                                           ...
                                           termination flows it carries inner L4
                                           header src port. */
    bcmFieldQualifyTunnelAltL4DstPort = 1022, /* Alternate tunnel destination L4 port,
                                           for termination flows this is outer
                                           L4 header dest port and for non
                                           termination flows it carries inner L4
                                           header dest port. */
    ...
    bcmFieldQualifyL5PayloadByte1 = 1053, /* L5 byte1 of forwarding header. For
                                           ...
                                           header, in case of termination it is
                                           inner header. */
    ...
    bcmFieldQualifyInnerVlanRangeMatch = 1097, /* Inner vlan matched with one of
                                           configured min/max values in range
                                           map. */
    bcmFieldQualifyTunnelHeaderDstMac = 1098, /* Destination MAC address in tunnel
                                           initiation header */
    bcmFieldQualifyTunnelHeaderSrcMac = 1099, /* Source MAC address in tunnel
                                           initiation header */
    bcmFieldQualifyTunnelHeaderSip = 1100, /* IPv4 source address in tunnel
                                           initiation header */
    bcmFieldQualifyTunnelHeaderDip = 1101, /* IPv4 destination address in tunnel
                                           initiation header */
    bcmFieldQualifyTunnelHeaderSip6 = 1102, /* IPv6 source address in tunnel
                                           initiation header */
    bcmFieldQualifyTunnelHeaderDip6 = 1103, /* IPv6 destination address in tunnel
                                           initiation header */
    bcmFieldQualifyTunnelHeaderIpProtocol = 1104, /* IP Protocol value in tunnel
                                           initiation header */
    bcmFieldQualifyMHPriority = 1105,   /* Module Header Priority */
    bcmFieldQualifyEgressPortCtrlType = 1106, /* Egress port control type */
    bcmFieldQualifySubportGroupIds = 1107, /* Subport group IDs */
    bcmFieldQualifyStageAggregateMmuFlowtracker = 1108, /* Qualifies on Stage Aggregate MMU
                                           Flowtracker */
    bcmFieldQualifyStageAggregateEgressFlowtracker = 1109, /* Qualifies on Stage Aggregate Egress
                                           Flowtracker */
    bcmFieldQualifyFlowtrackerAggregateClass = 1110, /* Qualifies on Aggregate Flowtracker
                                           Class */
    bcmFieldQualifyFlowtrackerClassIdSource1 = 1111, /* Qualifies on Flowtracker Class from
                                           Source 1 */
    bcmFieldQualifyFlowtrackerClassIdSource2 = 1112, /* Qualifies on Flowtracker Class from
                                           Source 2 */
    bcmFieldQualifyApplSignatureId = 1113, /* Qualifies on Application signature */
    bcmFieldQualifyInnerApplSignatureId = 1114, /* Qualifies on Application signature */
    bcmFieldQualifyCosQueueId = 1115,   /* Qualifies on Cos Queue */
    bcmFieldQualifyCongestionExperienced = 1116, /* Qualifies on Congestion experienced
                                           status */
    bcmFieldQualifyCongestionMarked = 1117, /* Qualifies on Congestion Marked status */
    bcmFieldQualifyIsUcastCosQueue = 1118, /* Qualifies on Status if packet is in
                                           unicast Cos queue */
    bcmFieldQualifyEgressPortQueue = 1119, /* Qualifies on Egress Port Cos queue
                                           Value */
    bcmFieldQualifyLearnExtensionPresent = 1120, /* Whether or not we have PPH learn
                                           extension */
    bcmFieldQualifyL3EgressIntf = 1121, /* L3 Egress Interface */
    bcmFieldQualifyForwardCode = 1122,  /* Matches on Forwarding code */
    bcmFieldQualifyPktFwdType = 1123,   /* Matches on Packet Forwarding type */
    bcmFieldQualifyStatOamLMRaw = 1124, /* Qualify on OAM LM counter raw value. */
    bcmFieldQualifyRangeFirstHit0 = 1125, /* Qualifies on L4 OPS Extended Encoder
                                           0 first hit */
    bcmFieldQualifyRangeFirstHit1 = 1126, /* Qualifies on L4 OPS Extended Encoder
                                           1 first hit */
    bcmFieldQualifyRangeFirstHit2 = 1127, /* Qualifies on L4 OPS Extended Encoder
                                           2 first hit */
    bcmFieldQualifyRangeFirstHit3 = 1128, /* Qualifies on L4 OPS Extended Encoder
                                           3 first hit */
    bcmFieldQualifyIfaCurrentLengthEqualToZero = 1129, /* If set, matches if IFA metadata
                                           header current length equals to 0. */
    bcmFieldQualifyIfaHopLimitEqualToZero = 1130, /* If set, matches if IFA metadata
                                           header hop limit equals to 0. */
    bcmFieldQualifyIfaVersion2 = 1131,  /* If set, matches if IFA version is 2. */
    bcmFieldQualifyIfaGlobalNameSpace = 1132, /* Qualifies on IFA Global Name Space */
    bcmFieldQualifyIfaLocalNameSpace = 1133, /* Qualifies on IFA Local Name Space. */
    bcmFieldQualifyIfaCurrentLength = 1134, /* Qualifies on IFA metadata header
                                           current length. */
    bcmFieldQualifyIfaRequestVector = 1135, /* Qualifies on IFA metadata header
                                           request vector. */
    bcmFieldQualifyDstType = 1136,      /* Qualifies on packet destination type
                                           in pipeline. */
    bcmFieldQualifyLoopbackHdrDstType = 1137, /* Qualifies on destination type in
                                           loopback pkt header. */
    bcmFieldQualifyOverlayNetworkTagType = 1138, /* Qualifies on Overlay Network tag
                                           type. */
    bcmFieldQualifyOverlayIpOptionHdrType = 1139, /* Qualifies on overlay IP optional
                                           header type. */
    bcmFieldQualifyIpOptionHdrType = 1140, /* Qualifies on IP optional header type. */
    bcmFieldQualifyFirstDropReason = 1141, /* Qualifies on first drop reason. */
    bcmFieldQualifyDropReason = 1142,   /* Qualifies on drop reason. */
    bcmFieldQualifyCopyToCpuReasonLow = 1143, /* Qualifies on Copy to cpu reasons 0 to
                                           31. */
    bcmFieldQualifyRtag7CHashLower = 1144, /* Qualifies on Lower half of RTAG7 hash
                                           C result. */
    bcmFieldQualifyRtag7CHashUpper = 1145, /* Qualifies on Upper half of RTAG7 hash
                                           C result. */
    bcmFieldQualifyAppTypeRaw = 1146,   /* Qualifies on packet Application type
                                           used by the ACL lookup. Can be either
                                           predefined or user defined. Input
                                           expects raw value. */
    bcmFieldQualifyAppTypePredefinedRaw = 1147, /* Qualifies on the predefined AppType
                                           used by the forwarding lookup. Input
                                           expects raw value. */
    bcmFieldQualifyForwardingTypeRaw = 1148, /* Qualifies on packet forwarding type.
                                           Input expects raw value. */
    bcmFieldQualifyContextIdRaw = 1149, /* Qualifies on the Forwarding Context
                                           value. Input expects raw value.
                                           Relevant for egress stage only. */
    bcmFieldQualifyOverlayEgressClass = 1150, /* Qualifies on Overlay Egress ClassId. */
    bcmFieldQualifyEgressL3TunnelGport = 1151, /* Qualifies on Egress L3 Tunnel Gport. */
    bcmFieldQualifyEgressMcastPktReason = 1152, /* Qualifies on Egress Mcast Pkt Reason. */
    bcmFieldQualifyEgressPktQueueNotification = 1153, /* Qualifies on Egress Pkt Queue
                                           Notification. */
    bcmFieldQualifyEgressDOPTrigger = 1154, /* Qualifies on Egress DOP Trigger */
    bcmFieldQualifyEgressTunnelIpHeaderFlowLabel = 1155, /* Qualifies on Egress Tunnel IP
                                           HeaderFlowLabel. */
    bcmFieldQualifyEgressTunnelIpHeaderEcn = 1156, /* Qualifies on Egress Tunnel IP Header
                                           Ecn. */
    bcmFieldQualifyEgressTunnelIpHeaderDscp = 1157, /* Qualifies on Egress Tunnel IP Header
                                           Dscp. */
    bcmFieldQualifyIpExtHdr2Protocol = 1158, /* Qualifies on next header field in Ip
                                           Ext Hdr2 */
    bcmFieldQualifyL2EgrIntfEfpCtrlId = 1159, /* Qualifies on L2 OIF EFP CTRL ID */
    bcmFieldQualifyIfaFlags = 1160,     /* Qualifies on IFA Flags */
    bcmFieldQualifyIfaMaxLength = 1161, /* Qualifies on IFA Max length */
    bcmFieldQualifyIfaActionVector = 1162, /* Qualifies on IFA Action vector */
    bcmFieldQualifyStateTableDataWrite = 1163, /* Qualifies on value written to state
                                           table. */
    bcmFieldQualifyCopyToCpuReasonHigh = 1164, /* Qualifies on Copy to cpu reasons 32
                                           to 47. */
    bcmFieldQualifyInnerTcpControl = 1165, /* Qualifies on TCP control field in
                                           inner header of the incoming packet. */
    bcmFieldQualifyTunnelTerminationProcessingProfile = 1166, /*  Qualify tunnel termination
                                           processing profile. */
    bcmFieldQualifyIntFlags = 1167,     /*  Qualifies on INT flags field in
                                           INT-DP/IOAM/IFA header. */
    bcmFieldQualifyIntHdrType = 1168,   /*  Qualifies on INT packet type, can be
                                           None/INT-DP/IFA/IOAM. */
    bcmFieldQualifyIntUdpChecksumEqualsZero = 1169, /*  Qualifies on UDP header checksum
                                           equals to zero. */
    bcmFieldQualifyIntMetadataHdrType = 1170, /*  Qualifies on INT metadata header
                                           type. */
    bcmFieldQualifyIntHdrPresent = 1171, /*  Qualifies on location of INT header
                                           in the packet */
    bcmFieldQualifyCompressionSrcHit = 1172, /*  Qualifies on ALPM source compression
                                           table hit. */
    bcmFieldQualifyCompressionDstHit = 1173, /*  Qualifies on ALPM destination
                                           compression table hit.. */
    bcmFieldQualifyIpTunnelTypeRaw = 1174, /* Raw value for
                                           FieldQualifyIpTunnelType. */
    bcmFieldQualifySampledPkt = 1175,   /*  Qualify sFlow sampled packets. */
    bcmFieldQualifySrcIp6SrhValid = 1176, /*  Qualify packet with IPv6 segment
                                           routing header. */
    bcmFieldQualifyFtmhAsePresent = 1177, /* Qualify packet on FTMH ASE present
                                           field. */
    bcmFieldQualifyFtmhAseType = 1178,  /* Qualify packet on FTMH ASE type
                                           value. */
    bcmFieldQualifyHiGig3Pkt = 1179,    /* Qualify on incoming packet from
                                           HiGig3 Device Port. */
    bcmFieldQualifyLoopbackLagFailoverPkt = 1180, /* Qualify on Loopback Lag failover
                                           packet. */
    bcmFieldQualifyPktMiscCtrl = 1181,  /* Qualify on Packet Misc controls
                                           defined under
                                           bcm_field_pkt_misc_ctrl_t. */
    bcmFieldQualifyForwardingOuterVlanPri = 1182, /* Qualify on forwarding outer vlan
                                           priority. */
    bcmFieldQualifyForwardingOuterTpid = 1183, /* Qualify on forwarding outer TPID. */
    bcmFieldQualifyIncomingVlanFormat = 1184, /* Qualify on incoming VLAN format. */
    bcmFieldQualifyBfdMultiplierLen = 1185, /* Qualify on BFD Multiplier Length. */
    bcmFieldQualifyBfdVerFlags = 1186,  /* Qualify on BFD Version and Flags. */
    bcmFieldQualifyGpeFlags = 1187,     /* Qualify on GPE Flags. */
    bcmFieldQualifyGpeNetworkId = 1188, /* Qualify on GPE Network Id. */
    bcmFieldQualifyGpeProtocol = 1189,  /* Qualify on GPE Protocol. */
    bcmFieldQualifyGpeReserved0 = 1190, /* Qualify on GPE Reserved 0. */
    bcmFieldQualifyGpeReserved1 = 1191, /* Qualify on GPE Reserved 1. */
    bcmFieldQualifyIfaAttrOpaqData = 1192, /* Qualify on IFA Attribute Opaqaue
                                           Data. */
    bcmFieldQualifyIgmpMaxRespTime = 1193, /* Qualify on IGMP Max response time. */
    bcmFieldQualifyMplsTopHeader = 1194, /* Qualify on MPLS Top Header. */
    bcmFieldQualifyMplsVcLabelHeader = 1195, /* Qualify on MPLS VC Label Header. */
    bcmFieldQualifyTcpAckNum = 1196,    /* Qualify on TCP Acknowledgement
                                           Number. */
    bcmFieldQualifyTcpSequenceNum = 1197, /* Qualify on TCP Sequence Number. */
    bcmFieldQualifyUdpLength = 1198,    /* Qualify on UDP Length. */
    bcmFieldQualifyPtpReserved1 = 1199, /* Qualify on PTP Reserved1. */
    bcmFieldQualifyPtpTransportSpec = 1200, /* Qualify on PTP Transport Spec. */
    bcmFieldQualifyLoopbackIfaSwitchCopyDrop = 1201, /* Qualify on Loopback header drop
                                           indicator for IFA switch probe copy */
    bcmFieldQualifyVipValid = 1202,     /* Checks if SLLB VIP_ID is valid. */
    bcmFieldQualifyVipId = 1203,        /* Qualifies on SLLB VIP_ID. */
    bcmFieldQualifyVIPMemberReference = 1204, /* Qualifies on SLLB ECMP
                                           MEMBER_REFERENCE. */
    bcmFieldQualifyPccHit = 1205,       /* Qualifies on SLLB PCC table hit
                                           status. */
    bcmFieldQualifyPdelayReq = 1206,    /* Qualify on the PDELAY_REQ packet. */
    bcmFieldQualifyPphType = 1207,      /* Qualifies on PPH type. */
    bcmFieldQualifyRxTrapProfile = 1208, /* Qualifies on Trap profile. The Trap
                                           profile is set by bcm_rx_trap_set
                                           using
                                           BCM_RX_TRAP_FLAGS2_UPDATE_ACL_PROFILE */
    bcmFieldQualifyDstMultipathLevel1 = 1209, /* Qualify on Level 1 ECMP groups */
    bcmFieldQualifyDstMultipathLevel2 = 1210, /* Qualify on Level 2 ECMP groups */
    bcmFieldQualifySvtag = 1211,        /* Qualifies on svtag */
    bcmFieldQualifyRecircleHdrFirstDropReason = 1212, /* Qualifies on redirect header first
                                           drop reason. */
    bcmFieldQualifyRecircleHdrDropReason = 1213, /* Qualifies on redirect header highest
                                           drop reason. */
    bcmFieldQualifyRecircleHdrCode = 1214, /* Qualifies on redirect header
                                           recirculation code. */
    bcmFieldQualifyMacSecOpaque = 1215, /* Qualifies on opaque object available
                                           to egress assigned by IP */
    bcmFieldQualifyMirrorOnDrop = 1216, /* Qualifies on mirrored copy of MMU
                                           dropped packet */
    bcmFieldQualifyMirrorOnDropReason = 1217, /* Qualifies on drop reason of mirrored
                                           copy of MMU dropped packet */
    bcmFieldQualifyIntCtrl = 1218,      /* Inband telemetry control */
    bcmFieldQualifyIfaHopCount = 1219,  /* Qualifies on IFA Hop Count */
    bcmFieldQualifyIfaHopLimit = 1220,  /* Qualifies on IFA Hop Limit */
    bcmFieldQualifyL2SrcMiscClassId = 1221, /* Qualify on Level 2 source
                                           miscellaneous class ID */
    bcmFieldQualifyL2DstMiscClassId = 1222, /* Qualify on Level 2 destination
                                           miscellaneous class ID */
    bcmFieldQualifyL3SrcMiscClassId = 1223, /* Qualify on Level 3 source
                                           miscellaneous class ID */
    bcmFieldQualifyL3DstMiscClassId = 1224, /* Qualify on Level 3 destination
                                           miscellaneous class ID */
    bcmFieldQualifyRawResidenceTime = 1225, /* Qualify on raw residence time */
    bcmFieldQualifyIpFragInfo = 1226,   /* Qualify on IPv4/v6 fragmentation info
                                           including flags and offset */
    bcmFieldQualifyInDscpExp = 1227,    /* Qualify on In-DSCP-EXP */
    bcmFieldQualifyAcInLifWideDataExtended = 1228, /* Qualify on the Ac in-lif
                                           wide(generic) extended data. */
    bcmFieldQualifyIfaNextHdr = 1229,   /*  Qualify on IFA next header */
    bcmFieldQualifyIfaVersion = 1230,   /*  Qualify on IFA version */
    bcmFieldQualifyIngressL2InterfaceOpaqueCtrlId1 = 1231, /* Opaque control id 1 from L2_IIF
                                           table. */
    bcmFieldQualifyIngressL2InterfaceFlexDigestCtrlIdA = 1232, /* Flex digest control id A from L2_IIF
                                           table. */
    bcmFieldQualifyIngressL2InterfaceFlexDigestCtrlIdB = 1233, /* Flex digest control id B from L2_IIF
                                           table. */
    bcmFieldQualifyAcInLifWideDataExtendedRaw = 1234, /* Qualify on the Ac in-lif
                                           wide(generic) extended data. Input
                                           expects raw value. */
    bcmFieldQualifyForwardingPacketRes = 1235, /* Qualifies on Forwarding packet
                                           resolution */
    bcmFieldQualifySrcCompressionClassId = 1236, /* L3_SRC Class ID from ALPM */
    bcmFieldQualifyDstCompressionClassId = 1237, /* L3_DST Class ID from ALPM */
    bcmFieldQualifyIPv6FragmentedNonFirst = 1238, /* Qualify on IPv6 packets where the IP
                                           Header is both fragmented and also
                                           not the first fragment. */
    bcmFieldQualifyRecircleHdrOpaqueCtrlIdC = 1239, /* Qualify on EP NIH header opaque
                                           control id C */
    bcmFieldQualifyIp6SecondAdditionalHeaderExist = 1240, /* Qualify on IPv6 packets second
                                           additional header exists. */
    bcmFieldQualifyMplsForwardingControlWord = 1241, /*  MPLS Forwarding control word. */
    bcmFieldQualifyMplsCtrlPktType = 1242, /*  MPLS control word packet type. */
    bcmFieldQualifyFirstDropReasonIngressCopy = 1243, /* Qualifies on first drop reason code
                                           from IP passed to EP. */
    bcmFieldQualifyDropReasonIngressCopy = 1244, /* Qualifies on highest drop reason from
                                           IP passed to EP. */
    bcmFieldQualifyMirrorEncapCtrlType = 1245, /* Qualifies on mirror encap control
                                           type. */
    bcmFieldQualifyOverlayL3Routable = 1246, /* Qualifies on overlay L3 routable
                                           status of the packets. */
    bcmFieldQualifyOverlayOpaqueTag = 1247, /* Qualifies on overlay opaque tag. */
    bcmFieldQualifyOverlayOuterTpid = 1248, /* Qualifies on inner L2 / overlay outer
                                           TPID. */
    bcmFieldQualifyPweInLifWideData = 1249, /* Qualifies on PWE Inlif wide data. */
    bcmFieldQualifyIPv4FragmentedNonFirst = 1250, /* Qualify on IPv4 packets where the IP
                                           Header is both fragmented and also
                                           not the first fragment. */
    bcmFieldQualifyCpuTxDestType = 1251, /* Qualify on Destination type of a CPU
                                           transmitted packet. */
    bcmFieldQualifyCpuTxFlowType = 1252, /* Qualify on Flow type of a CPU
                                           transmitted packet. */
    bcmFieldQualifyIpMcFallbacktoBridge = 1253, /* Indicate IP MC fallback to bridge
                                           scenario. */
    bcmFieldQualifyMirrorEncapId = 1254, /* Qualify on Mirror Encap ID. */
    bcmFieldQualifyIngressL2InterfaceVfi = 1255, /* Qualify on Vfi from Ingress L2
                                           interface. */
    bcmFieldQualifyLoopbackCustomSubtype = 1256, /* Qualify on Custom Loopback subtype */
    bcmFieldQualifyMplsEsiLabel0to15 = 1257, /* Qualify on MPLS ESI Label 0 to 15
                                           bytes */
    bcmFieldQualifyMplsEsiLabel16to31 = 1258, /* Qualify on MPLS ESI Label 16 to 31
                                           bytes */
    bcmFieldQualifyRchTimeStamp = 1259, /* Qualify on RCH timestamp */
    bcmFieldQualifyRchForwardingAdditioalInfo = 1260, /* Qualify on the RCH forwarding
                                           additional info */
    bcmFieldQualifyRchType = 1261,      /* Qualify on the type of RCH flow */
    bcmFieldQualifyRchVisibility = 1262, /* Qualify on whether visibility for RCH
                                           is set */
    bcmFieldQualifyStormCtrlMeterEnable = 1263, /*  Qualify on Storm control meter
                                           enable. */
    bcmFieldQualifyL3HdrErrorCheck = 1264, /*  Qualify on L3 Header Error check. */
    bcmFieldQualifyL3TtlErrorCheck = 1265, /*  Qualify on L3 TTL Error check. */
    bcmFieldQualifyL3IPv4OptionsPkt = 1266, /*  Qualify on L3 IPv4 Options. */
    bcmFieldQualifyIp6FirstAdditionalHeader = 1267, /* Qualify on IPv6 packets first
                                           additional header. */
    bcmFieldQualifyIp6SecondAdditionalHeader = 1268, /* Qualify on IPv6 packets second
                                           additional header. */
    bcmFieldQualifyIpTunnelInLifWideData = 1269, /* Qualifies on IPvX tunnel wide data. */
    bcmFieldQualifyIfaMaxLengthValid = 1270, /* Qualify on IFA max length check
                                           passed indicator. */
    bcmFieldQualifyIfaHopLimitReached = 1271, /* Qualifies on IFA hop limit reached. */
    bcmFieldQualifyForwardingTos = 1272, /* Qualifies Final type of service.
                                           Taken from payload in
                                                           case of
                                           encapsulation. */
    bcmFieldQualifyForwardingTrafficClass = 1273, /* Qualifies bitmap for traffic class
                                           used for
                                                           forwarding lookup. */
    bcmFieldQualifyEtagVid = 1274,      /* Qualifies ETAG Virtual ID. */
    bcmFieldQualifyEtagSvid = 1275,     /* Qualifies ETAG Source Virtual ID. */
    bcmFieldQualifyEtagPcp = 1276,      /* Qualifies ETAG PCP. */
    bcmFieldQualifyEtagDei = 1277,      /* Qualifies ETAG Drop Eligible
                                           Indicator. */
    bcmFieldQualifyEtagReserved1 = 1278, /* Qualifies ETAG Reserved1 field. */
    bcmFieldQualifyEtagAction = 1279,   /* Qualifies ETAG Action. */
    bcmFieldQualifyEtagAddReplaceControl = 1280, /* Qualifies ETAG Add Replace Control. */
    bcmFieldQualifyPreserveTtl = 1281,  /* Qualify on preserve TTL. */
    bcmFieldQualifyTunnelEgressFlowEncap = 1282, /* Qualifies on Tunnel Egress Flow Encap */
    bcmFieldQualifyForwardIpType = 1283, /* Qualifies on Forward IP Type */
    bcmFieldQualifyEgrForwardingEditStatus = 1284, /* To qualify on egress forwarding
                                           status. If data is 1, it matches on
                                           forwarding without modification and 0
                                           matches on forwarded with
                                           modification */
    bcmFieldQualifyCount = 1285         /* Always Last. Not a usable value. */
} bcm_field_qualify_t;
...
{ \
    ...
    "TunnelHeaderSip6", \
    "TunnelHeaderDip6", \
    "TunnelHeaderIpProtocol", \
    "MHPriority", \
    "EgressPortCtrlType", \
    "SubportGroupIds", \
    "StageAggregateMmuFlowtracker", \
    "StageAggregateEgressFlowtracker", \
    "FlowtrackerAggregateClass", \
    "FlowtrackerClassIdSource1", \
    "FlowtrackerClassIdSource2", \
    "ApplSignatureId", \
    "InnerApplSignatureId", \
    "CosQueueId", \
    "CongestionExperienced", \
    "CongestionMarked", \
    "IsUcastCosQueue", \
    "EgressPortQueue", \
    "LearnExtensionPresent", \
    "L3EgressIntf", \
    "ForwardCode", \
    "PktFwdType", \
    "StatOamLMRaw", \
    ...
    "RangeFirstHit2", \
    "RangeFirstHit3", \
    "IfaCurrentLengthEqualToZero", \
    "IfaHopLimitEqualToZero", \
    "IfaVersion2", \
    "IfaGlobalNameSpace", \
    "IfaLocalNameSpace", \
    "IfaCurrentLength", \
    ...
    "DstType", \
    "LoopbackHdrDstType", \
    "OverlayNetworkTagType", \
    "OverlayIpOptionHdrType", \
    "IpOptionHdrType", \
    "FirstDropReason", \
    "DropReason", \
    "CopyToCpuReasonLow", \
    ...
    "Rtag7CHashUpper", \
    "AppTypeRaw", \
    "AppTypePredefinedRaw", \
    "ForwardingTypeRaw", \
    "ContextIdRaw", \
    "OverlayEgressClass", \
    "EgressL3TunnelGport", \
    "EgressMcastPktReason", \
    "EgressPktQueueNotification", \
    "EgressDOPTrigger", \
    "EgressTunnelIpHeaderFlowLabel", \
    "EgressTunnelIpHeaderEcn", \
    "EgressTunnelIpHeaderDscp", \
    "IpExtHdr2Protocol", \
    "L2EgrIntfEfpCtrlId", \
    "IfaFlags", \
    "IfaMaxLength", \
    ...
    "CopyToCpuReasonHigh", \
    "InnerTcpControl", \
    "TunnelTerminationProcessingProfile", \
    "IntFlags", \
    "IntHdrType", \
    "IntUdpChecksumEqualsZero", \
    "IntMetadataHdrType", \
    "IntHdrPresent", \
    "CompressionSrcHit", \
    "CompressionDstHit", \
    ...
    "FtmhAseType", \
    "HiGig3Pkt", \
    "LoopbackLagFailoverPkt", \
    "PktMiscCtrl", \
    "ForwardingOuterVlanPri", \
    "ForwardingOuterTpid", \
    "IncomingVlanFormat", \
    "BfdMultiplierLen", \
    "BfdVerFlags", \
    ...
    "DstMultipathLevel2", \
    "Svtag", \
    "RecircleHdrFirstDropReason", \
    "RecircleHdrDropReason", \
    "RecircleHdrCode", \
    "MacSecOpaque", \
    "MirrorOnDrop", \
    "MirrorOnDropReason", \
    ...
    "IpFragInfo", \
    "InDscpExp", \
    "AcInLifWideDataExtended", \
    "IfaNextHdr", \
    "IfaVersion", \
    "IngressL2InterfaceOpaqueCtrlId1", \
    "IngressL2InterfaceFlexDigestCtrlIdA", \
    "IngressL2InterfaceFlexDigestCtrlIdB", \
    "AcInLifWideDataExtendedRaw", \
    "ForwardingPacketRes", \
    "SrcCompressionClassId", \
    "DstCompressionClassId", \
    "IPv6FragmentedNonFirst", \
    "RecircleHdrOpaqueCtrlIdC", \
    "Ip6SecondAdditionalHeaderExist", \
    "MplsForwardingControlWord", \
    "MplsCtrlPktType", \
    "FirstDropReasonIngressCopy", \
    "DropReasonIngressCopy", \
    "MirrorEncapCtrlType", \
    "OverlayL3Routable", \
    "OverlayOpaqueTag", \
    "OverlayOuterTpid", \
    "PweInLifWideData", \
    "IPv4FragmentedNonFirst", \
    "CpuTxDestType", \
    "CpuTxFlowType", \
    "IpMcFallbacktoBridge", \
    "MirrorEncapId", \
    "IngressL2InterfaceVfi", \
    "LoopbackCustomSubtype", \
    "MplsEsiLabel0to15", \
    "MplsEsiLabel16to31", \
    "RchTimeStamp", \
    "RchForwardingAdditioalInfo", \
    "RchType", \
    "RchVisibility", \
    "StormCtrlMeterEnable", \
    "L3HdrErrorCheck", \
    "L3TtlErrorCheck", \
    "L3IPv4OptionsPkt", \
    "Ip6FirstAdditionalHeader", \
    "Ip6SecondAdditionalHeader", \
    "IpTunnelInLifWideData", \
    "IfaMaxLengthValid", \
    "IfaHopLimitReached", \
    "ForwardingTos", \
    "ForwardingTrafficClass", \
    "EtagVid", \
    "EtagSvid", \
    "EtagPcp", \
    "EtagDei", \
    "EtagReserved1", \
    "EtagAction", \
    "EtagAddReplaceControl", \
    "PreserveTtl", \
    "TunnelEgressFlowEncap", \
    "ForwardIpType", \
    "EgrForwardingEditStatus"  \
}
...
typedef enum bcm_field_stage_e {
    ...
    bcmFieldStageAggregateMmuFlowtracker = 16, /* Aggregate Mmu Flowtracker Stage. */
    bcmFieldStageAggregateEgressFlowtracker = 17, /* Aggregate Egress Flowtracker Stage. */
    bcmFieldStageEgressExtension = 18,  /* Extension of the egress field stage,
                                           performing actions later. */
    bcmFieldStageCount = 19             /* Always Last. Not a usable value. */
} bcm_field_stage_t;
...
{ \
    ...
    "Lookup", \
    "Class", \
    "AggregateMmuFlowtracker", \
    "AggregateEgressFlowtracker", \
    "EgressExtension"  \
}

/* CPU Tx Destination Type. */
typedef enum bcm_field_cpu_tx_dest_type_e {
    bcmFieldCpuTxDestTypeDglp = 0,      /* DGLP */
    bcmFieldCpuTxDestTypeNhi = 1,       /* Next Hop Index */
    bcmFieldCpuTxDestTypeEcmp = 2,      /* ECMP */
    bcmFieldCpuTxDestTypeEcmpMember = 3, /* ECMP Member */
    bcmFieldCpuTxDestTypeIpmc = 4,      /* IP Multicast */
    bcmFieldCpuTxDestTypeL2mc = 5,      /* L2 Multicast */
    bcmFieldCpuTxDestTypeBcast = 6,     /* Broadcast */
    bcmFieldCpuTxDestTypeCount = 7      /* Always Last. Not a usable value. */
} bcm_field_cpu_tx_dest_type_t;

#define BCM_FIELD_CPU_TX_DEST_TYPE_STRINGS \
{ \
    "Dglp", \
    "Nhi", \
    "Ecmp", \
...
/* CPU Tx Flow Type. */
typedef enum bcm_field_cpu_tx_flow_type_e {
    bcmFieldCpuTxFlowTypeNone = 0,      /* Not a CPU packet */
    bcmFieldCpuTxFlowTypeCpuMasquerade = 1, /* CPU Masquerade */
    bcmFieldCpuTxFlowTypeCpuTx = 2,     /* CPU Tx */
    bcmFieldCpuTxFlowTypeCount = 3      /* Always Last. Not a usable value. */
} bcm_field_cpu_tx_flow_type_t;

#define BCM_FIELD_CPU_TX_FLOW_TYPE_STRINGS \
{ \
    "None", \
    "CpuMasquerade", \
    "CpuTx"  \
...
typedef enum bcm_field_AppType_e {
    ...
    bcmFieldAppTypeIp6McastL3Ssm = 43,  /* IPv6 L3 Source Specific Multicast
                                           forwarding. */
    bcmFieldAppTypeIp6McastL3SsmCompressSip = 44, /* IPv6 L3 Source Specific Multicast
                                           compress SIP. */
    bcmFieldAppTypeVip4 = 45,           /* SLLB Virtual IPv4 forwarding. */
    bcmFieldAppTypeVip6 = 46,           /* SLLB Virtual IPv6 forwarding. */
    bcmFieldAppTypeVip4Direct = 47,     /* SLLB non-VIP IPv4 forwarding on VIP
                                           enabled interfaces. */
    bcmFieldAppTypeVip6Direct = 48,     /* SLLB non-VIP IPv6 forwarding on VIP
                                           enabled interfaces. */
    bcmFieldAppTypeSrv6Endpoint = 49,   /* SRv6 classical Endpoint node. */
    bcmFieldAppTypeSrv6UsidEndpoint = 50, /* SRv6 micro-SID Endpoint node. */
    bcmFieldAppTypeSrv6GsidEndpoint = 51, /* SRv6 G-SID Endpoint node. */
    bcmFieldAppTypeCount = 52           /* Always Last. Not a usable value. */
} bcm_field_AppType_t;
...
typedef enum bcm_field_LoopbackType_e {
    ...
    bcmFieldLoopbackTypeMasqueradeWithSwitchDropIndication = 20, /* Loopback header with switch probe
                                           Drop Indicator */
    bcmFieldLoopbackTypeIfaVxLanDecapPayload = 21, /* VxLan tunnel termination with IFA
                                           Payload */
    bcmFieldLoopbackTypeGeneric = 22,   /* CPU transmitted packet with header
                                           type set to GIH Generic */
    bcmFieldLoopbackTypeCount = 23      /* Always Last. Not a usable value. */
...
{ \
    ...
    "Masquerade", \
    "L2Tunnel2ndPassFlow", \
    "MasqueradeWithSwitchDropIndication", \
    "IfaVxLanDecapPayload", \
    "Generic"  \
}
...
/* 
 * Field Qualifier Destination Type (for
 * bcm_field_qualify_DstType/bcm_field_qualify_LoopbackHdrDstType).
 */
...
#define BCM_FIELD_DSTTYPE_STRINGS \
{ \
    "L2EgrIntf", \
    "Vp", \
    "Ecmp", \
...
typedef enum bcm_field_TunnelTerminationProcessingProfile_e {
    bcmFieldTunnelTerminationProcessingProfilePppoe = 5, /* Don't care. */
    bcmFieldTunnelTerminationProcessingProfileL2tp = 3 /* Standard Fibre Channel header. */
} bcm_field_TunnelTerminationProcessingProfile_t;

#define BCM_FIELD_TUNNELTERMINATIONPROCESSINGPROFILE_STRINGS \
{ \
    "", \
    "", \
    "", \
...
typedef enum bcm_field_TunnelType_e {
    ...
    bcmFieldTunnelTypeNsh = 21,         /* Network Service Header (NSH) Tunnel
                                           Packet. */
    bcmFieldTunnelTypeSRv6 = 22,        /* Ipv6 Segment Routing Tunnel Packet. */
    bcmFieldTunnelTypeGre4 = 23,        /* Gre4 */
    bcmFieldTunnelTypeGre8WithKey = 24, /* Gre with key */
    bcmFieldTunnelTypeGre12 = 25,       /* Gre12 */
    bcmFieldTunnelTypeUdp = 26,         /* Udp */
    bcmFieldTunnelTypeL2TPv3OverUdp = 27, /* L2TPv3 over UDP. */
    bcmFieldTunnelTypeEsp = 28,         /* ESP */
    bcmFieldTunnelTypeEspOverUdp = 29,  /* ESP UDP. */
    bcmFieldTunnelTypeCount = 30        /* Always Last. Not a usable value. */
...
/* Field Qualifier ForwardIpType (for bcm_field_qualify_ForwardIpType). */
typedef enum bcm_field_ForwardIpType_e {
    bcmFieldForwardIpTypeIpv4 = 0,  /* IPv4 packet. */
    bcmFieldForwardIpTypeIpv6 = 1,  /* IPv6 packet. */
    bcmFieldForwardIpTypeCount = 2  /* Always Last. Not a usable value. */
} bcm_field_ForwardIpType_t;
...
typedef enum bcm_field_oam_drop_mep_type_e {
    ...
    bcmFieldOamDropLSPMepData = 21,     /* Drop Reasons for LSP MEP data
                                           packets. */
    bcmFieldOamDropPwMepControl = 22,   /* Drop Reasons for PseudoWire MEP
                                           control packets. */
    bcmFieldOamDropPwMepData = 23,      /* Drop Reasons for PseudoWire MEP data
                                           packets. */
...
/* 
 * Field Qualifier Packet Forward Type (for
 * bcm_field_qualify_PktFwdType).
 */
typedef enum bcm_field_PktFwdType_e {
    bcmFieldPktFwdTypeL2 = 0,           /* Packet forward type is L2. */
    bcmFieldPktFwdTypeL3Ucast = 1,      /* Packet forward type is L3 unicast. */
    bcmFieldPktFwdTypeL3Mcast = 2,      /* Packet forward type is IP multicast. */
    bcmFieldPktFwdTypeCopyToCpu = 3,    /* Packet forward type is copy to cpu. */
    bcmFieldPktFwdTypeL2Ucast = 4,      /* Packet forward type is L2 unicast. */
    bcmFieldPktFwdTypeL2Mcast = 5,      /* Packet forward type is L2 multicast. */
    bcmFieldPktFwdTypeL3Any = 6,        /* Packet forward type is L3 Any. */
    bcmFieldPktFwdTypeCount = 7         /* Always Last. Not a usable value. */
} bcm_field_PktFwdType_t;

#define BCM_FIELD_PKTFWDTYPE_STRINGS \
{ \
    "L2", \
    "L3Ucast", \
    "L3Mcast", \
...
/* 
 * Field action Redirection.
 * Used to specify the Redirection type in
 * bcm_field_action_redirect_config_set or destination_type in
...
typedef enum bcm_field_redirect_destination_type_e {
    ...
    bcmFieldRedirectDestinationL3Multicast = 4, /* Destination L3 Multicast. */
    bcmFieldRedirectDestinationCount = 5 /* Always Last. Not a usable value. */
...
typedef enum bcm_field_flow_timestamp_type_e {
    bcmFieldFlowTimestampIngress = 0,   /* Ingress Timestamp selected. */
    bcmFieldFlowTimestampEgress = 1,    /* Egress Timestamp selected. */
    bcmFieldFlowTimestampCount = 2      /* Always Last. Not a usable value. */
} bcm_field_flow_timestamp_type_t;

#define BCM_FIELD_FLOW_TIMESTAMP_TYPE_STRINGS \
{ \
    "Ingress", \
    "Egress"  \
}
...
typedef enum bcm_field_flow_timestamp_source_e {
    bcmFieldFlowTimestampSourceLegacy = 0, /* Legacy source */
    bcmFieldFlowTimestampSourceNTP = 1, /* Network Time Protocol source */
    bcmFieldFlowTimestampSourcePTP = 2, /* Precision Time Protocol source */
    bcmFieldFlowTimestampSourceCount = 3 /* Always Last. Not a usable value. */
} bcm_field_flow_timestamp_source_t;

#define BCM_FIELD_FLOW_TIMESTAMP_SOURCE_STRINGS \
{ \
    "Legacy", \
    "NTP", \
    "PTP"  \
...
/* 
 * Field Qualifier Ip6 Additional Header (for
 * bcm_field_qualify_Ip6AdditionalHeader).
 */
typedef enum bcm_field_ip6_additional_header_type_e {
    bcmFieldIp6AdditionalHeaderNotAvailable = 0, /* Not available. */
    bcmFieldIp6AdditionalHeaderGre4 = 1, /* Gre4. */
    bcmFieldIp6AdditionalHeaderGre8 = 2, /* Gre8. */
    bcmFieldIp6AdditionalHeaderGre12 = 3, /* Gre12. */
    bcmFieldIp6AdditionalHeaderUdp = 4, /* Udp. */
    bcmFieldIp6AdditionalHeaderL2tpv3 = 5, /* L2tpv3. */
    bcmFieldIp6AdditionalHeaderVxlan = 6, /* Vxlan. */
    bcmFieldIp6AdditionalHeaderVxlanGpe = 7, /* Vxlan Gpe. */
    bcmFieldIp6AdditionalHeaderEspUdp = 8, /* Esp Udp. */
    bcmFieldIp6AdditionalHeaderSrv6 = 9, /* Srv6. */
    bcmFieldIp6AdditionalHeaderSrv6Sl0 = 10, /* Srv6 Sl 0. */
    bcmFieldIp6AdditionalHeaderExtensionHopByHop = 11, /* Extension Hop by Hop. */
    bcmFieldIp6AdditionalHeaderExtensionFragment = 12, /* Extension Fragment. */
    bcmFieldIp6AdditionalHeaderExtensionEsp = 13, /* Extension Esp. */
    bcmFieldIp6AdditionalHeaderExtensionAuth = 14, /* Extension Auth. */
    bcmFieldIp6AdditionalHeaderExtensionDestination = 15, /* Extension Destination options. */
    bcmFieldIp6AdditionalHeaderExtensionMobility = 16, /* Extension Mobility. */
    bcmFieldIp6AdditionalHeaderExtensionHostProtocol = 17, /* Extension Host Identify Protocol. */
    bcmFieldIp6AdditionalHeaderExtensionShim6 = 18, /* Extension Shim6. */
    bcmFieldIp6AdditionalHeaderCount = 19 /* Always Last. Not a usable value. */
} bcm_field_ip6_additional_header_type_t;

#define BCM_FIELD_IP6_ADDITIONAL_HEADER_STRINGS \
{ \
    "NotAvailable", \
    "Gre4", \
    "Gre8", \
...
/* Packet Rep Copy Type. */
typedef enum bcm_field_rep_copy_type_e {
    bcmFieldRepCopyTypeForward = 0,     /* Forward. */
    bcmFieldRepCopyTypeSnoop = 1,       /* Snoop. */
    bcmFieldRepCopyTypeMirror = 2,      /* Mirror. */
    bcmFieldRepCopyTypeStatSample = 3,  /* Stat Sample. */
    bcmFieldRepCopyTypeCount = 4        /* Always Last. Not a usable value. */
} bcm_field_rep_copy_type_t;

#define BCM_FIELD_REP_COPY_TYPE_STRINGS \
{ \
    "Forward", \
    "Snoop", \
    "Mirror", \
...
typedef enum bcm_field_action_e {
    ...
    bcmFieldActionMirrorIngress = 42,   /* Ingress mirror; param0: Dest modid (0
                                           if param1 is mirror gport); param1:
                                           Dest port/tgid/mirror gport. For
                                           HSDK, param0 is not considered and
                                           param1 should be mirror gport created
                                           with destination mirror index. */
    bcmFieldActionMirrorEgress = 43,    /* Egress mirror; param0: Dest modid; (0
                                           if param1 is mirror gport); param1:
                                           Dest port/tgid/mirror gport. For
                                           HSDK, param0 is not considered and
                                           param1 should be mirror gport created
                                           from destination mirror index. */
    ...
    bcmFieldActionEgressMirrorDisable = 217, /* Disable Egress Mirror for matching
                                           packet. On BCM5688x and BCM5678x
                                           devices this action will disable both
    ...
    bcmFieldActionIntEncapEnable = 502, /* This action triggers to insert INT
                                           ...
                                           INT packet.
                                           In BCM5688x and BCM5678x devices, if
                                           IFA is used for telemetry, It insert
                                           IFA record and for IOAM, It enables
                                           insert operation. */
    ...
    bcmFieldActionIntEncapUpdate = 514, /* This action triggers to update
                                           ...
                                           In BCM5688x and BCM5678x devices, if
                                           IFA is used for telemetry, It update
                                           IFA base header. */
    ...
    bcmFieldActionIntEncapDisable = 519, /* This action triggers to disable the
                                           ...
                                           In BCM5688x and BCM5678x devices, if
                                           IFA is used for telemetry, It deletes
                                           IFA record and for IOAM, It enables
                                           delete operation. */
    ...
    bcmFieldActionIngressDstTypeSelect = 697, /* To set, packet destination type. */
    bcmFieldActionIngressDstVal = 698,  /* To set, packet destination value. */
    ...
    bcmFieldActionDlbTrunkMonitorEnable = 703, /* To enable Dynamic Load Balancing LAG 
                                           monitoring. */
    bcmFieldActionSrcNetworkGroup = 704, /* To set Source Network group. */
    ...
    bcmFieldActionIntStatReq1 = 727,    /* Inband telemetry stat request 1
                                           actions. */
    bcmFieldActionSvtagSignature = 728, /* This action adds SVTAG signature in
                                           the SVTAG header. */
    bcmFieldActionSvtagOffset = 729,    /* This action adds payload offset in
                                           the SVTAG header. */
    bcmFieldActionSvtagPrio = 730,      /* This action adds priority in the
                                           SVTAG header. */
    bcmFieldActionSvtagDeviceId = 731,  /* This action adds device id in the
                                           SVTAG header. */
    bcmFieldActionSvtagPktType = 732,   /* This action adds packet type in the
                                           SVTAG header. It can be MACSEC packet
                                           type also */
    bcmFieldActionSvtagSubportNum = 733, /* This action adds channel or subport
                                           number in the SVTAG header. */
    bcmFieldActionSvtagEnable = 734,    /* This action enables SVTAG addition to
                                           the packet. */
    bcmFieldActionFlowtrackerAggregateIngressGroupId = 735, /* This action associates Aggregate
                                           Ingress Flowtracker Group. */
    bcmFieldActionFlowtrackerAggregateMmuGroupId = 736, /* This action associates Aggregate MMU
                                           Flowtracker Group. */
    bcmFieldActionFlowtrackerAggregateEgressGroupId = 737, /* This action associates Aggregate
                                           Egress Flowtracker Group. */
    bcmFieldActionFlowtrackerAggregateClass = 738, /* This action associates Flowtracker
                                           Aggregate Class. */
    bcmFieldActionFlowtrackerAggregateIngressFlowIndex = 739, /* This action associates Aggregate
                                           Ingress Flowtracker Flow Index. */
    bcmFieldActionFlowtrackerAggregateMmuFlowIndex = 740, /* This action associates Aggregate Mmu
                                           Flowtracker Flow Index. */
    bcmFieldActionFlowtrackerAggregateEgressFlowIndex = 741, /* This action associates Aggregate
                                           Egress Flowtracker Flow Index. */
    bcmFieldActionFlexSampleProfile = 742, /* Flex Sample Profile index. */
    bcmFieldActionStatOamLMRaw = 743,   /* Updates OAM LM counter with raw
                                           value. */
    bcmFieldActionLearnKey0 = 744,      /* Update learn info, first part of the
                                           key. */
    bcmFieldActionLearnKey1 = 745,      /* Update learn info, second part of the
                                           key. */
    bcmFieldActionLearnKey2 = 746,      /* Update learn info, third part of the
                                           key, plus ap_db_index. */
    bcmFieldActionLearnKey2Raw = 747,   /* Update learn info, third part of the
                                           key, plus ap_db_index. */
    bcmFieldActionLearnPayload0 = 748,  /* Update learn info, first part of the
                                           payload. */
    bcmFieldActionLearnPayload1 = 749,  /* Update learn info, second part of the
                                           payload. */
    bcmFieldActionLearnEntryFormatIndex = 750, /* Update learn info, entry format
                                           index. */
    bcmFieldActionLearnOrTransplant = 751, /* Update learn info, learn or
                                           transplant bit. */
    bcmFieldActionEncapIfaMetadataHdr = 752, /* Encapsulation of IFA header along
                                           with Metadata header. */
    bcmFieldActionStatGroupWithoutCounterIndex = 753, /* Flag in ASETs to indicate stat group
                                           usage with the group, without
                                           specifying a counter index */
    bcmFieldActionPrioInputNew = 754,   /* The input_priority to be used for PG
                                           mapping in MMU for accounting. User
                                           should create a profile using
                                           bcm_cosq_priority_group_mapping_profile_set
                                           API and configure the input priority
                                           for a specific type of packets. */
    bcmFieldActionOuterVlanTagActions = 755, /* controls the forwarding L2 header
                                           otag. */
    bcmFieldActionInnerVlanTagActions = 756, /* controls the forwarding L2 header
                                           itag. */
    bcmFieldActionTunnelOuterVlanTagActions = 757, /* Controls the tunnel L2 header otag. */
    bcmFieldActionEgressIFAMetadataProfileIndex = 758, /* Profile index for egr_metadata SF
                                           (used in INT or IFA delete operation) */
    bcmFieldActionFlowTimestampType = 759, /* Flex Flow Timestamp select type.
                                           Timestamp select type is defined by
                                           bcm_field_flow_timestamp_type_t. */
    bcmFieldActionFlowTimestampSource0 = 760, /* Flex Flow Timestamp source zero.
                                           Timestamp source is defined by
                                           bcm_field_flow_timestamp_source_t. */
    bcmFieldActionFlowTimestampSource1 = 761, /* Flex Flow Timestamp source one.
                                           Timestamp source is defined by
                                           bcm_field_flow_timestamp_source_t. */
    bcmFieldActionCmlFlagsNew = 762,    /* CML flags for a newly learned MAC
                                           address */
    bcmFieldActionCmlFlagsMove = 763,   /* CML flags for a moved MAC address */
    bcmFieldActionOpaqueCtrlId = 764,   /* Opaque control ID */
    bcmFieldActionMirrorOnDropDisable = 765, /* Disable Mirror on Drop control */
    bcmFieldActionMirrorFlowClass = 766, /* Enable and set the mirror flow class
                                           value */
    bcmFieldActionIntActionProfileSet = 767, /* Set the INT action profile Id */
    bcmFieldActionIntTermActionProfileSet = 768, /* Set the INT tunnel termination action
                                           profile Id */
    bcmFieldActionIntFlowClassSet = 769, /* Set to derive flow specific opaque
                                           metadata */
    bcmFieldActionIntApplyOnSampledPkt = 770, /* Set to apply INT actions only to
                                           sampled packets */
    bcmFieldActionIntLoopbackProfileSet = 771, /* Set an index to loop back profile for
                                           INT. */
    bcmFieldActionL3TunnelTypeSet = 772, /* Set L3 tunnel type */
    bcmFieldActionL3TunnelAuto = 773,   /* Set L3 tunnel auto configure */
    bcmFieldActionUseOuterHeaderDscp = 774, /* Use outer header's DSCP */
    bcmFieldActionUseOuterHeaderTtl = 775, /* Use outer header's TTL */
    bcmFieldActionDisableInnerHeaderDscpChange = 776, /* Disable changing inner header's DSCP */
    bcmFieldActionPhbRemapTableEntryId = 777, /* Derive internal QoS parameters from
                                           the DSCP values
                                                              of the incoming L3
                                           packet, using the PHB DSCP to
                                           internal
                                                              proirity remap
                                           table entry */
    bcmFieldActionBfdEnable = 778,      /* Enable BFD */
    bcmFieldActionDscpMask = 779,       /* Mask some bits from the packets DSCP
                                           value */
    bcmFieldActionEcnMask = 780,        /* Mask some bits from the packets ECN
                                           value. */
    bcmFieldActionVxlanGbpEnable = 781, /* Action to enable VXLAN GBP. */
    bcmFieldActionAssignVxlanGbpId = 782, /* Assign VXLAN Group Based Policy ID. */
    bcmFieldActionDstL3ClassIdNew = 783, /* Assign Destination L3 Class ID. */
    bcmFieldActionVlanTagPreserve = 784, /* Preserve VLAN Tag. Use
                                           BCM_FIELD_xx_VLAN_TAG_PRESERVE macros
                                           as param0 */
    bcmFieldActionGpStatGroup = 785,    /* Count green colored packets */
    bcmFieldActionYpStatGroup = 786,    /* Count yellow colored packets */
    bcmFieldActionRpStatGroup = 787,    /* Count red colored packets */
    bcmFieldActionGpOpaqueCtrlId = 788, /* Assign Opaque control ID for green
                                           colored packets */
    bcmFieldActionYpOpaqueCtrlId = 789, /* Assign Opaque control ID for yellow
                                           colored packets */
    bcmFieldActionRpOpaqueCtrlId = 790, /* Assign Opaque control ID for red
                                           colored packets */
    bcmFieldActionMatchedRule = 791,    /* Assign Matched rule for copy to cpu
                                           packets */
    bcmFieldActionRedirectEgrNextHopUnderlay = 792, /* Redirect packet to next hop underlay;
                                           param0: ECMP or next hop info. */
    bcmFieldActionAssignIfaHeaderFields = 793, /* Assign IFP header field values. */
    bcmFieldActionRespondPdelayReq = 794, /* Respond to Pdelay_Req with
                                           Pdelay_Resp message */
    bcmFieldActionSendPacketBack = 795, /* Send packet back to the original
                                           receiving port */
    bcmFieldActionAssignRecircleHdrOpaqueObject = 796, /* EP Recirculation Opaque Object A */
    bcmFieldActionRecircleHdrCode = 797, /* EP Recirculation Code */
    bcmFieldActionRecircleHdrOpaqueCtrlId = 798, /* EP Recirculation Opaque Ctrl A */
    bcmFieldActionOverrideTraceEvent = 799, /* Override trace event action */
    bcmFieldActionPktLengthAdjustProfileIndex = 800, /* Index to packet length adjust profile */
    bcmFieldActionIpTunnelProtocolNew = 801, /* Tunnel IPv4 Protocol or v6 Next
                                           Header Field. Used for IpinIp Tunnel
                                           Encap Flow */
    bcmFieldActionEgressPostOperation = 802, /* Egress post profile operation. */
    bcmFieldActionAssignMacSecOpaque = 803, /* Assign macsec opaque object. */
    bcmFieldActionEgressMembershipCheck = 804, /* Enable egress membership check */
    bcmFieldActionEgrTimestampProfileIndex = 805, /* Egress timestamp profile index. */
    bcmFieldActionPolicerCancel = 806,  /* Cancel policer actions. Use
                                           BCM_POLICER_CANCEL_xxx macros as
                                           param0 */
    bcmFieldActionPrioInputCopyIntPrio = 807, /* Copy input priority from internal
                                           priority. */
    bcmFieldActionSrcPruningDisable = 808, /* Disable source pruning. */
    bcmFieldActionL3SwitchAndResetOverlayNextHop = 809, /* L3-switch packet, resetting overlay
                                           next hop index;
                                                              param0: ECMP or
                                           next hop info. */
    bcmFieldActionRedirectEgrNextHopAndResetOverlayNextHop = 810, /* Redirect packet to next hop,
                                           resettting overlay next
                                                              hop; param0: ECMP
                                           or next hop info. */
    bcmFieldActionNetworkLoadBalanceKey = 811, /* Overwrite the network load balance
                                           key. */
    bcmFieldActionEstimatedStartPacketStrip = 812, /* Estimated bytes to remove at start of
                                           packet. */
    bcmFieldActionDropMaskControlProfile = 813, /* Drop Mask Control Profile Select */
    bcmFieldActionPrtQualifier = 814,   /* Prt qualifer */
    bcmFieldActionLoopbackCustomSubtype = 815, /* Custom Loopback SubType */
    bcmFieldActionStormControlMeterEnable = 816, /* Enable Storm control meter support */
    bcmFieldActionMirrorTruncateControl = 817, /* Set the EFP assisted IFA
                                           truncation.Enable to update the
                                           header length with the EFP supplied
                                           value */
    bcmFieldActionTruncateIpLength = 818, /* IPv4 total_length value or IPv6
                                           payload_length field for assisted IFA
                                           truncation. */
    bcmFieldActionTruncateUdpLength = 819, /* UDP packet-length field for assisted
                                           IFA truncation. */
    bcmFieldActionDstClassField = 820,  /* Destination Class */
    bcmFieldActionSrcClassField = 821,  /* Source Class */
    bcmFieldActionClassField = 822,     /* global class. */
    bcmFieldActionYpProtocolPktCopyToCpuCancel = 823, /* Cancels copy to cpu from
                                           protocol_pkt_forward_table for yellow
                                           packets */
    bcmFieldActionRpProtocolPktCopyToCpuCancel = 824, /* Cancels copy to cpu from
                                           protocol_pkt_forward_table for red
                                           packets */
    bcmFieldActionGpProtocolPktCopyToCpuCancel = 825, /* Cancels copy to cpu from
                                           protocol_pkt_forward_table for green
                                           packets */
    bcmFieldActionCbts = 826,           /* Sets configuration for Tunnel
                                           Priority for Class Based Tunnel
                                           Selection. */
    bcmFieldActionRepCopy = 827,        /* Packet copy type. */
    bcmFieldActionAggregateL3Switch = 828, /* L3-switch packet with metadata info.
                                                              param0: Next hop
                                           info.
                                                              param1: Host
                                           number start offset.
                                                              param2: Host
                                           number stride size. */
    bcmFieldActionAggregateRedirectEgrNextHop = 829, /* Redirect packet to next hop with
                                           metadata info.
                                                              param0: Next hop
                                           info.
                                                              param1: Host
                                           number start offset.
                                                              param2: Host
                                           number stride size. */
    bcmFieldActionTunnelPayloadIp4Enable = 830, /* Set tunnel payload type IPv4. */
    bcmFieldActionTunnelPayloadIp6Enable = 831, /* Set tunnel payload type IPv6. */
    bcmFieldActionEtagVid = 832,        /* Set ETAG VID. */
    bcmFieldActionEtagSvid = 833,       /* Set ETAG SVID. */
    bcmFieldActionEtagPcp = 834,        /* Set ETAG PCP. */
    bcmFieldActionEtagDei = 835,        /* Set ETAG DEI. */
    bcmFieldActionEtagControlSet = 836, /* Set ETAG Control Set. */
    bcmFieldActionL3MtuAdjustProfile = 837, /* Set the index to L3 MTU adjustment
                                           profile table to apply the MTU
                                           adjustment on incoming packet.
                                                              param0 : profile
                                           index */
    bcmFieldActionCount = 838           /* Always Last. Not a usable value. */
} bcm_field_action_t;
...
{ \
    ...
    "SvtagSubportNum", \
    "SvtagEnable", \
    "FlowtrackerAggregateIngressGroupId", \
    "FlowtrackerAggregateMmuGroupId", \
    "FlowtrackerAggregateEgressGroupId", \
    "FlowtrackerAggregateClass", \
    "FlowtrackerAggregateIngressFlowIndex", \
    "FlowtrackerAggregateMmuFlowIndex", \
    "FlowtrackerAggregateEgressFlowIndex", \
    "FlexSampleProfile", \
    "StatOamLMRaw", \
    "LearnKey0", \
    "LearnKey1", \
    ...
    "LearnPayload0", \
    "LearnPayload1", \
    "LearnEntryFormatIndex", \
    "LearnOrTransplant", \
    "EncapIfaMetadataHdr", \
    "StatGroupWithoutCounterIndex", \
    "PrioInputNew", \
    "OuterVlanTagActions", \
    "InnerVlanTagActions", \
    "TunnelOuterVlanTagActions", \
    "EgressIFAMetadataProfileIndex", \
    "FlowTimestampType", \
    "FlowTimestampSource0", \
    "FlowTimestampSource1", \
    "CmlFlagsNew", \
    "CmlFlagsMove", \
    "OpaqueCtrlId", \
    "MirrorOnDropDisable", \
    "MirrorFlowClass", \
    "IntActionProfileSet", \
    "IntTermActionProfileSet", \
    "IntFlowClassSet", \
    "IntApplyOnSampledPkt", \
    "IntLoopbackProfileSet", \
    "L3TunnelTypeSet", \
    "L3TunnelAuto", \
    "UseOuterHeaderDscp", \
    "UseOuterHeaderTtl", \
    "DisableInnerHeaderDscpChange", \
    "PhbRemapTableEntryId", \
    "BfdEnable", \
    "DscpMask", \
    "EcnMask", \
    "VxlanGbpEnable", \
    ...
    "RpOpaqueCtrlId", \
    "MatchedRule", \
    "RedirectEgrNextHopUnderlay", \
    "AssignIfaHeaderFields", \
    "RespondPdelayReq", \
    "SendPacketBack", \
    "AssignRecircleHdrOpaqueObject", \
    "RecircleHdrCode", \
    "RecircleHdrOpaqueCtrlId", \
    "OverrideTraceEvent", \
    "PktLengthAdjustProfileIndex", \
    "IpTunnelProtocolNew", \
    "EgressPostOperation", \
    "AssignMacSecOpaque", \
    "EgressMembershipCheck", \
    "EgrTimestampProfileIndex", \
    "PolicerCancel", \
    "PrioInputCopyIntPrio", \
    "SrcPruningDisable", \
    "L3SwitchAndResetOverlayNextHop", \
    "RedirectEgrNextHopAndResetOverlayNextHop", \
    "NetworkLoadBalanceKey", \
    "EstimatedStartPacketStrip", \
    "DropMaskControlProfile", \
    "PrtQualifier", \
    "LoopbackCustomSubtype", \
    "StormControlMeterEnable", \
    "MirrorTruncateControl", \
    "TruncateIpLength", \
    "TruncateUdpLength", \
    "DstClassField", \
    "SrcClassField", \
    "ClassField", \
    "YpProtocolPktCopyToCpuCancel", \
    "RpProtocolPktCopyToCpuCancel", \
    "GpProtocolPktCopyToCpuCancel", \
    "Cbts", \
    "RepCopy", \
    "AggregateL3Switch", \
    "AggregateRedirectEgrNextHop", \
    "TunnelPayloadIp4Enable", \
    "TunnelPayloadIp6Enable", \
    "EtagVid", \
    "EtagSvid", \
    "EtagPcp", \
    "EtagDei", \
...
/* Enum to define Mirror truncation types */
typedef enum bcm_field_mirror_truncation_e {
    bcmFieldMirrorTruncationIpLength = 0, /* Update IPv4 total_length or IPv6
                                           payload length */
    bcmFieldMirrorTruncationUdpLength = 1, /* Update UDP pkt_length */
    bcmFieldMirrorTruncationCount = 2   /* Always last. Not to be used. */
} bcm_field_mirror_truncation_t;
...
typedef enum bcm_field_macsec_pkt_type_e {
    ...
    bcmFieldMacSecPktTypeMacSecMgmt = 2, /* Both BPDU, KaY tagged and Control
                                           packets */
    bcmFieldMacSecPktTypeKaYFrames = 3, /* MACSEC packets with SecTAG.TCI.E=1
                                           and SecTAG.TCI.C=0 */
    bcmFieldMacSecPktTypeCount = 4      /* Always last. Not to be used. */
} bcm_field_macsec_pkt_type_t;
...
typedef enum bcm_field_egress_port_ctrl_e {
    bcmFieldEgressPortCtrlTypeSubportSvtagEncrypt = 0, /* Subport SVTAG encrypt port control
                                           type */
    bcmFieldEgressPortCtrlTypeCount = 1 /* Always last. Not to be used. */
...
typedef struct bcm_field_presel_config_s {
    ...
    bcm_field_presel_t presel_id;       /* Preselection ID created based on
                                           flags set. */
    bcm_field_qset_t group_conflict_qset; /* Conflicting group qualifier set for
                                           this presel. */
...
typedef enum bcm_field_control_e {
    ...
    bcmFieldControlTrunkDlbMonitorIngressRandomSeed = 35, /* Set RNG seed for DLB flow monitoring
                                           for IFP. This RNG seed overwrites the
                                           RNG seed set by the switch
                                           bcmSwitchDlbMonitorIngressRandomSeed.
                                           This seed is used by the device for
                                           the flow which matches IFP entries
                                           with action
                                           bcmFieldActionDlbTrunkMonitorEnable. */
    bcmFieldControlRedirectPortFloodEnable = 36, /* This Field control enables flooding
                                           on egress ports by disabling block
                                           mask check for ingress ports when IFP
                                           action
                                           bcmFieldActionEgressMembershipCheck
                                           is applied on the matched packet. */
    bcmFieldControlRedirectVlanFloodEnable = 37, /* This Field control enables flooding
                                           on egress ports by disabling block
                                           mask check for vlan when IFP action
                                           bcmFieldActionEgressMembershipCheck
                                           is applied on the matched packet. */
    bcmFieldControlRedirectSystemPortFloodEnable = 38, /* This Field control enables flooding
                                           on egress ports by disabling block
                                           mask check for system ports when IFP
                                           action
                                           bcmFieldActionEgressMembershipCheck
                                           is applied on the matched packet. */
    bcmFieldControlRedirectIfpFloodEnable = 39, /* This Field control enables flooding
                                           on egress ports by disabling block
                                           mask check for IFP when IFP action
                                           bcmFieldActionEgressMembershipCheck
                                           is applied on the matched packet. */
    bcmFieldControlDropMask = 40,       /* This Field control programs Drop Mask
                                           for the given Drop profile which can
                                           alter match behavior of
                                           bcmFieldQualifyDrop in IFP. */
    bcmFieldControlCount = 41           /* Always last. Not a usable value. */
} bcm_field_control_t;
...
{ \
    ...
    "GbpSrcMacMcastBitSet", \
    "TrunkDlbMonitorIngressRandomSeed", \
    "RedirectPortFloodEnable", \
    "RedirectVlanFloodEnable", \
    "RedirectSystemPortFloodEnable", \
    "RedirectIfpFloodEnable", \
    "DropMask"  \
}
...
#define BCM_FIELD_EGRESS_CLASS_SELECT_EM_CLASS_ID 12         
#define BCM_FIELD_EGRESS_CLASS_SELECT_COMPRESSION_ID_A 13         
#define BCM_FIELD_EGRESS_CLASS_SELECT_COMPRESSION_ID_B 14         

/* Parameter for bcmFieldActionL3TunnelTypeSet */
#define BCM_FIELD_L3_TUNNEL_TYPE_IP6TOIP4   0          /* IP6TOIP4 tunnel */
#define BCM_FIELD_L3_TUNNEL_TYPE_ISATAP     1          /* ISATAP tunnel */
#define BCM_FIELD_L3_TUNNEL_TYPE_IP6TOIP4SECURE 2          /* IP6TOIP4SECURE tunnel */
...
#define BCM_FIELD_GROUP_CREATE_WITH_COMPRESSION (1 << 18)  /* Create field group
                                                          ...
                                                          in the group's QSET */
#define BCM_FIELD_GROUP_ENT_LVL_ACTION_RESOLVE (1 << 19)  /* Flag to enable action
                                                          resolution on per
                                                          entry level. */
#define BCM_FIELD_GROUP_CREATE_WITH_SRC_IP_COMPRESSION (1 << 20)  /* Enable compression
                                                          support. This triggers
                                                          to compress the source
                                                          IP4 related qualifiers */
#define BCM_FIELD_GROUP_CREATE_WITH_SRC_IP6_COMPRESSION (1 << 21)  /* Enable compression
                                                          support. This triggers
                                                          to compress the source
                                                          IP6 related qualifiers */
#define BCM_FIELD_GROUP_CREATE_WITH_DST_IP_COMPRESSION (1 << 22)  /* Enable compression
                                                          support. This triggers
                                                          to compress the
                                                          destination IP4
                                                          related qualifiers */
#define BCM_FIELD_GROUP_CREATE_WITH_DST_IP6_COMPRESSION (1 << 23)  /* Enable compression
                                                          support. This triggers
                                                          to compress the
                                                          destination IP6
                                                          related qualifiers */
#define BCM_FIELD_GROUP_CREATE_SLICE_SHARE_ENABLE (1 << 24)  /* Enable slice sharing
                                                          among same priority
                                                          groups with similar
                                                          properties */
#define BCM_FIELD_GROUP_ENTRY_AVOID_HW_INSTALL (1 << 25)  /* Create field group in
                                                          which main entries
                                                          will not be installed
                                                          in hardware */
#define BCM_FIELD_GROUP_CREATE_AUTO_EXPANSION_DISABLE (1 << 26)  /* Create field group
                                                          with disabled Group
                                                          auto expansion */
#define BCM_FIELD_GROUP_CREATE_SHARED_POLICER_POOL (1 << 27)  /* Create field group in
                                                          which policer pools
                                                          can be shared with
                                                          other groups */
#define BCM_FIELD_GROUP_CREATE_ENT_LEVEL_POLICER_POOL (1 << 28)  /* Create field group in
                                                          which policer pools
                                                          can be specified
                                                          during attach */
...
/* Presel config create API optional flags. */
#define BCM_FIELD_PRESEL_CREATE_WITH_ID (1 << 0)   /* If set, preselection ID
                                                      passed by the user will be
                                                      used. */
...
typedef enum bcm_field_drop_reason_e {
    bcmFieldDropReasonNoDrop = 0,       /* Drop reason No Drop */
    bcmFieldDropReasonCMLFlags = 1,     /* Ingress drop reason CML flags */
    bcmFieldDropReasonL2SrcStaticMove = 2, /* Ingress drop reason L2 src static
                                           move */
    bcmFieldDropReasonL2SrcDiscard = 3, /* Ingress drop reason L2 src discard */
    bcmFieldDropReasonMacSaMulticast = 4, /* Ingress drop reason MacSa Multicast */
    bcmFieldDropReasonOuterTpidCheckFailed = 5, /* Ingress drop reason Outer TPID check
                                           failed */
    bcmFieldDropReasonIncomingPvlanCheckFailed = 6, /* Ingress drop reason Incoming PVLAN
                                           check failed */
    bcmFieldDropReasonPktIntegrityCheckFailed = 7, /* Ingress drop reason Pkt integrity
                                           check failed */
    bcmFieldDropReasonProtocolPktDrop = 8, /* Ingress drop reason Protocol packet
                                           drop */
    bcmFieldDropReasonMembershipCheckFailed = 9, /* Ingress drop reason Membership check
                                           failed */
    bcmFieldDropReasonSpanningTreeCheckFailed = 10, /* Ingress drop reason spanning tree
                                           check failed */
    bcmFieldDropReasonL2DstLookupMiss = 11, /* Ingress drop reason L2 Dst lookup
                                           miss */
    bcmFieldDropReasonL2DstDiscard = 12, /* Ingress drop reason L2 Dst discard */
    bcmFieldDropReasonL3DstLookupMiss = 13, /* Ingress drop reason L3 Dst lookup
                                           miss */
    bcmFieldDropReasonL3DstDiscard = 14, /* Ingress drop reason L3 Dst discard */
    bcmFieldDropReasonL3HdrError = 15,  /* Ingress drop reason L3 header Error */
    bcmFieldDropReasonL3TTLError = 16,  /* Ingress drop reason L3 TTL error */
    bcmFieldDropReasonIPMCL3IIFOrRPAIDCheckFailed = 17, /* Ingress drop reason IPMC L3 IIF or
                                           RPA ID check failed */
    bcmFieldDropReasonTunnelTTLCheckFailed = 18, /* Ingress drop reason Tunnel TTL check
                                           failed */
    bcmFieldDropReasonTunnelShimHdrError = 19, /* Ingress drop reason Tunnel Shim
                                           header error */
    bcmFieldDropReasonTunnelObjectValidationFailed = 20, /* Ingress drop reason Tunnel object
                                           validation failed */
    bcmFieldDropReasonTunnelAdaptDrop = 21, /* Ingress drop reason Tunnel adapt drop */
    bcmFieldDropReasonPVLANDrop = 22,   /* Ingress drop reason PVLAN Drop */
    bcmFieldDropReasonVFP = 23,         /* Ingress drop reason VFP */
    bcmFieldDropReasonIFP = 24,         /* Ingress drop reason IFP */
    bcmFieldDropReasonIFPMeter = 25,    /* Ingress drop reason IFP Meter */
    bcmFieldDropReasonDSTFP = 26,       /* Ingress drop reason Destination FP */
    bcmFieldDropReasonMplsProtectionDrop = 27, /* Ingress drop reason Mpls protection
                                           drop */
    bcmFieldDropReasonMplsLabelActionInvalid = 28, /* Ingress drop reason Mpls label action
                                           invalid */
    bcmFieldDropReasonMplsTermPolicySelectTableDrop = 29, /* Ingress drop reason Mpls term policy
                                           select table drop */
    bcmFieldDropReasonMPLSReservedLabelExposed = 30, /* Ingress drop reason Mpls reserved
                                           label exposed */
    bcmFieldDropReasonMplsTTLError = 31, /* Ingress drop reason Mpls TTL error */
    bcmFieldDropReasonMplsEcnError = 32, /* Ingress drop reason Mpls Ecn error */
    bcmFieldDropReasonEMFT = 33,        /* Ingress drop reason EM FT */
    bcmFieldDropReasonIVXLT = 34,       /* Ingress drop reason IVXLT */
    bcmFieldDropReasonUrpfCheckFailed = 35, /* Ingress drop reason Urpf check failed */
    bcmFieldDropReasonSrcPortKnockoutDrop = 36, /* Ingress drop reason Srcport knockout
                                           drop */
    bcmFieldDropReasonLagFailoverPortDown = 37, /* Ingress drop reason Lag failover port
                                           down */
    bcmFieldDropReasonSplitHorizonCheckFailed = 38, /* Ingress drop reason Split horizon
                                           check failed */
    bcmFieldDropReasonDstLinkDown = 39, /* Ingress drop reason Dst linkdown */
    bcmFieldDropReasonBlockMaskDrop = 40, /* Ingress drop reason Block mask drop */
    bcmFieldDropReasonL3MtuCheckFailed = 41, /* Ingress drop reason L3 Mtu check
                                           failed */
    bcmFieldDropReasonSeqNumCheckFailed = 42, /* Ingress drop reason Seq num check
                                           failed */
    bcmFieldDropReasonL3IIFEqL3OIF = 43, /* Ingress drop reason L3 IIF Equals L3
                                           OIF */
    bcmFieldDropReasonStormControlDrop = 44, /* Ingress drop reason Storm control
                                           drop */
    bcmFieldDropReasonEgrMembershipCheckFailed = 45, /* Ingress drop reason Egr membership
                                           check failed */
    bcmFieldDropReasonEgrSpanningTreeCheckFailed = 46, /* Ingress drop reason Egr spanning tree
                                           check failed */
    bcmFieldDropReasonDstPBMZero = 47,  /* Ingress drop reason Dst PBM zero */
    bcmFieldDropReasonMplsCtrlPktDrop = 48, /* Ingress drop reason Mpls ctrl pkt
                                           drop */
    bcmFieldDropReasonL2OIFDrop = 49,   /* Egress drop reason L2 OIF */
    bcmFieldDropReasonEgrMembershipDrop = 50, /* Egress drop reason due to membership
                                           check */
    bcmFieldDropReasonDvpMembershipDrop = 51, /* Egress drop reason dvp membsership
                                           check */
    bcmFieldDropReasonTtlDrop = 52,     /* Egress drop reason ttl drop */
    bcmFieldDropReasonL3SameIntfDrop = 53, /* Egress drop reason l3 same interface */
    bcmFieldDropReasonL2SamePortDrop = 54, /* Egress drop reason l2 same port */
    bcmFieldDropReasonSplitHorizonDrop = 55, /* Egress drop reason split horizon */
    bcmFieldDropReasonSpanningTreeDisableDrop = 56, /* Egress drop reason spanning tree
                                           disabled */
    bcmFieldDropReasonSpanningTreeBlockDrop = 57, /* Egress drop reason spanning tree
                                           blocked */
    bcmFieldDropReasonEFP = 58,         /* Egress drop reason filter processor */
    bcmFieldDropReasonEgrMeterDrop = 59, /* Egress drop reason meter drop */
    bcmFieldDropReasonEgrMtuDrop = 60,  /* Egress drop reason MTU check */
    bcmFieldDropReasonEgrVxltDrop = 61, /* Egress drop reason vlan translate */
    bcmFieldDropReasonEgrCellTooLargeDrop = 62, /* Egress drop reason cell is too large */
    bcmFieldDropReasonEgrCellTooSmallDrop = 63, /* Egress drop reason cell is too small */
    bcmFieldDropReasonQosRemarkingDrop = 64, /* Egress drop reason qos remarking */
    bcmFieldDropReasonSvpEqualDvpDrop = 65, /* Egress drop reason svp is equal to
                                           dvp */
    bcmFieldDropReasonInvalid1588Pkt = 66, /* Egress drop reason invalid 1588
                                           packet */
    bcmFieldDropReasonFlexEditorDrop = 67, /* Egress drop reason flex editor */
    bcmFieldDropReasonEgrRecircleHdrDrop = 68, /* Egress drop reason EP NIH */
    bcmFieldDropReasonIfaMdDeleteDrop = 69, /* Egress drop reason IFA MD delete */
    bcmFieldDropReasonIngLimit = 70,    /* MMU drop reason ingress limit */
    bcmFieldDropReasonSharedPoolLimit = 71, /* MMU drop reason shared pool limit */
    bcmFieldDropReasonEgrPortServicePoolSharedLimit = 72, /* MMU drop reason egress port service
                                           pool shared limit */
    bcmFieldDropReasonEgrQueueSharedLimit = 73, /* MMU drop reason egress queue shared
                                           limit */
    bcmFieldDropReasonWREDCheck = 74,   /* MMU drop reason WRED check */
    bcmFieldDropReasonIngRecircleHdrDrop = 75, /* Ingress drop reason EP NIH packet */
    bcmFieldDropReasonForteIpv4Gateway = 76, /* Ingress drop reason FORTE IPV4
                                           gateway */
    bcmFieldDropReasonLastCount = 77    /* Always Last. Not a usable value. */
} bcm_field_drop_reason_t;

#define BCM_FIELD_DROP_REASON \
{ \
    "NoDrop", \
    "CMLFlags", \
    "L2SrcStaticMove", \
    "L2SrcDiscard", \
    "MacSaMulticast", \
    "OuterTpidCheckFailed", \
    "IncomingPvlanCheckFailed", \
    "PktIntegrityCheckFailed", \
    "ProtocolPktDrop", \
    "MembershipCheckFailed", \
    "SpanningTreeCheckFailed", \
    "L2DstLookupMiss", \
    "L2DstDiscard", \
    "L3DstLookupMiss", \
    "L3DstDiscard", \
    "L3HdrError", \
    "L3TTLError", \
    "IPMCL3IIFOrRPAIDCheckFailed", \
    "TunnelTTLCheckFailed", \
    "TunnelShimHdrError", \
    "TunnelObjectValidationFailed", \
    "TunnelAdaptDrop", \
    "PVLANDrop", \
    "VFP", \
    "IFP", \
    ...
    "DSTFP", \
    "MplsProtectionDrop", \
    "MplsLabelActionInvalid", \
    "MplsTermPolicySelectTableDrop", \
    "MPLSReservedLabelExposed", \
    "MplsTTLError", \
    "MplsEcnError", \
    "EMFT", \
    "IVXLT", \
    ...
    "L3IIFEqL3OIF", \
    "StormControlDrop", \
    "EgrMembershipCheckFailed", \
    "EgrSpanningTreeCheckFailed", \
    "DstPBMZero", \
    "MplsCtrlPktDrop", \
    "L2OIFDrop", \
    "EgrMembershipDrop", \
    ...
    "L2SamePortDrop", \
    "SplitHorizonDrop", \
    "SpanningTreeDisableDrop", \
    "SpanningTreeBlockDrop", \
    "EFP", \
    "EgrMeterDrop", \
    "EgrMtuDrop", \
    "EgrVxltDrop", \
...
/* Field destination action flags. */
#define BCM_FIELD_DESTINATION_ACTION_REDIRECT 1          /* Indicate a new
                                                          destination. */
#define BCM_FIELD_DESTINATION_ACTION_COLOR  2          /* Indicate a new color. */
#define BCM_FIELD_DESTINATION_ACTION_MIRROR 4          /* Indicate a mirror
                                                          destination. */
#define BCM_FIELD_DESTINATION_ACTION_COS    8          /* Indicate new COSs. */

/* Field destination entry options. */
#define BCM_FIELD_DESTINATION_OPTIONS_REPLACE 1          /*  Field destination
                                                          entry replace. */

/* Field destination match. */
typedef struct bcm_field_destination_match_s {
    ...
    uint8 elephant_notify;              /* Indicator that flow exceeds the
                                           elephant threshold byte count and
                                           becomes an elephant flow. */
...
typedef struct bcm_field_destination_action_s {
    uint32 flags;                       /* BCM_FIELD_DESTINATION_ACTION_xxx
                                           flags. */
...
/* 
 * Field group mode types.
 * 
 * Possible values for mode_type in bcm_field_group_config_t
 */
typedef enum bcm_field_group_mode_type_e {
    bcmFieldGroupModeTypeAuto = 0,      /* Default. */
    bcmFieldGroupModeTypeL2Single = 1,  /* L2 Single. */
    bcmFieldGroupModeTypeL3Single = 2,  /* L3 Single. */
    bcmFieldGroupModeTypeL3SingleAny = 3, /* L3 Single Any. */
    bcmFieldGroupModeTypeL3Double = 4,  /* L3 Double. */
    bcmFieldGroupModeTypeL3DoubleAny = 5, /* L3 Double Any. */
    bcmFieldGroupModeTypeL3DoubleAlternate = 6, /* L3 Double Alternate. */
    bcmFieldGroupModeTypeCount = 7      /* Always Last. Not a usable value. */
} bcm_field_group_mode_type_t;

#define BCM_FIELD_GROUP_MODE_TYPE_STRINGS \
{ \
    "Auto", \
    "L2Single", \
    "L3Single", \
...
/* 
 * Field group packet types.
 * 
 * Possible values for packet_type in bcm_field_group_config_t
 */
typedef enum bcm_field_group_packet_type_e {
    bcmFieldGroupPacketTypeDefault = 0, /* Default. */
    bcmFieldGroupPacketTypeIp = 1,      /* PORT_ANY_PACKET_IP. */
    bcmFieldGroupPacketTypeNonIp = 2,   /* PORT_ANY_PACKET_NONIP. */
    bcmFieldGroupPacketTypeIp4 = 3,     /* PORT_ANY_PACKET_IPV4. */
    bcmFieldGroupPacketTypeIp6 = 4,     /* PORT_ANY_PACKET_IPV46. */
    bcmFieldGroupPacketTypeHigig = 5,   /* PORT_HIGIG_PACKET_ANY. */
    bcmFieldGroupPacketTypeFrontPanel = 6, /* PORT_FRONT_PACKET_ANY. */
    bcmFieldGroupPacketTypeLoopback = 7, /* PORT_LOOPBACK_PACKET_ANY. */
    bcmFieldGroupPacketTypeAuto = 8,    /* Auto. */
    bcmFieldGroupPacketTypeCount = 9    /* Always Last. Not a usable value. */
} bcm_field_group_packet_type_t;

#define BCM_FIELD_GROUP_PACKET_TYPE_STRINGS \
{ \
    "Default", \
    "Ip", \
    "NonIp", \
...
typedef struct bcm_field_group_config_s {
    ...
    bcm_field_group_mode_type_t mode_type; /* Field group mode type. */
    bcm_field_group_packet_type_t packet_type; /* Field group packet type. */
 ...
 * specific attributes.
 */
typedef struct bcm_field_entry_config_s {
    ...
    bcm_field_qset_t qset;          /* Entry Qualifier Set. */
...
extern int bcm_field_entry_config_create(
    int unit, 
    bcm_field_entry_config_t *entry_config);

/* Retrieve the information of an entry. */
extern int bcm_field_entry_config_get(
    int unit, 
    bcm_field_entry_config_t *entry_config);
...
/* Set Match Criteria for Destination Type of CPU Transmitted packet */
extern int bcm_field_qualify_CpuTxDestType(
    int unit, 
    bcm_field_entry_t entry, 
    bcm_field_cpu_tx_dest_type_t dest_type);

/* Get Match Criteria for Destination Type of CPU Transmitted packet. */
extern int bcm_field_qualify_CpuTxDestType_get(
    int unit, 
    bcm_field_entry_t entry, 
    bcm_field_cpu_tx_dest_type_t *dest_type);

/* Set Match Criteria for Flow Type of CPU Transmitted packet */
extern int bcm_field_qualify_CpuTxFlowType(
    int unit, 
    bcm_field_entry_t entry, 
    bcm_field_cpu_tx_flow_type_t flow_type);

/* Get Match Criteria for Flow Type of CPU Transmitted packet. */
extern int bcm_field_qualify_CpuTxFlowType_get(
    int unit, 
    bcm_field_entry_t entry, 
    bcm_field_cpu_tx_flow_type_t *flow_type);
...
extern int bcm_field_qualify_SampledPkt(
    int unit, 
    bcm_field_entry_t entry, 
    uint8 data, 
    uint8 mask);
...
extern int bcm_field_qualify_SrcIp6SrhValid(
    int unit, 
    bcm_field_entry_t entry, 
    uint8 data, 
    uint8 mask);
...
/* 
 * Get match criteria for bcmFieldQualifySampledPkt
 *                qualifier from the field entry.
 */
extern int bcm_field_qualify_SampledPkt_get(
    int unit, 
    bcm_field_entry_t entry, 
    uint8 *data, 
    uint8 *mask);
...
/* 
 * Get match criteria for bcmFieldQualifySrcIp6SrhValid
 *                qualifier from the field entry.
 */
extern int bcm_field_qualify_SrcIp6SrhValid_get(
    int unit, 
    bcm_field_entry_t entry, 
    uint8 *data, 
    uint8 *mask);
...
/* 
 * Create a preselection specification using a specific ID for a specific
 * stage
 */
...
typedef enum bcm_field_hint_type_e {
    ...
    bcmFieldHintTypeIngressFlowtracker = 5, /* Hint Type for Ingress Flowtracker. */
    bcmFieldHintTypeFlexCtrOpaqueObjectSel = 6, /* Hint type for specifying the opaque
                                           object to be used by
                                           bcmFieldActionStatGroup. */
    bcmFieldHintTypePolicerPoolSel = 7, /* Hint type for specifying the policer
                                           pool. Supported modes are
                                           bcmPolicerPoolxxx */
    bcmFieldHintTypeGroupExpandFlexCtrAction = 8, /* Hint type for Creating auto
                                           expandable group with Flex Counter
                                           support */
    bcmFieldHintTypePolicerPoolExpand = 9, /* Hint type for specifying the policer
                                           pools to be used for expansion.
                                           Supported modes are bcmPolicerPoolxxx */
    bcmFieldHintTypeConflictQset = 10,  /* Hint type for specifying conflicting
                                           (mutually exclusive) qualifiers for a
                                           group */
    bcmFieldHintTypeCount = 11          /* Always Last. Not a usable value. */
...
{ \
    ...
    "IngressFlowtracker", \
    "FlexCtrOpaqueObjectSel", \
    "PolicerPoolSel", \
    "GroupExpandFlexCtrAction", \
    "PolicerPoolExpand", \
    "ConflictQset"  \
}
...
#define BCM_FIELD_HINT_EXACT_MATCH_GROUP_PRIORITY (1 << 4)   /* Set Hint for Exact
                                                          Match Group. */
#define BCM_FIELD_HINT_INGRESS_FLOWTRACKER_GROUP_SECONDARY_SLICE (1 << 5)   /* Set Hint to use
                                                          secondary slice for
                                                          group in ingress
                                                          flowtracker stage. */
#define BCM_FIELD_HINT_QUALIFIER_MACROS_SELECT (1 << 6)   /* Set flag to select the
                                                          qualifier macros for
                                                          hint type
                                                          bcmFieldHintTypeExtraction. */
#define BCM_FIELD_HINT_PBMP_SELECT          (1 << 7)   /* Set flag to select the
                                                          pbmp mask for hint
                                                          type
                                                          bcmFieldHintTypeExtraction. */
...
typedef struct bcm_field_hint_s {
    ...
    int value;                          /* Value to be set for specific hint
                                           types. */
    bcm_pbmp_t pbmp;                    /* Port bitmap corresponding to hint
                                           flag BCM_FIELD_HINT_PBMP_SELECT */
...
typedef enum bcm_field_group_oper_mode_e {
    ...
    bcmFieldGroupOperModePipeLocal = 1, /* Group Operational Pipe Local Mode
                                           Value. */
    bcmFieldGroupOperModeGlobalPipeAware = 2, /* Group Operational Global Pipe Aware
                                           Mode Value. */
    bcmFieldGroupOperModeCount = 3      /* Always last. Not a usable value. */
...
/* 
 * Configure match criteria for bcmFieldQualifyMixedSrcClassId qualifier
 * for the preselection field entry
 */
...
/* 
 * Get match criteria for bcmFieldQualifyMixedSrcClassId qualifier
 * from the preselection field entry
 */
...
typedef enum bcm_field_sys_hdr_type_e {
    ...
    bcmFieldSysHdrRecircle = 22,        /* Egress Pipeline NPL internal header */
    bcmFieldSysHdrHiGig3 = 23,          /* HiGig3 */
    bcmFieldSysHdrHiGig3Multicast = 24, /* HiGig3 Multicast */
    bcmFieldSysHdrLastCount = 25        /* Always Last. Not a usable value. */
...
#define BCM_FIELD_ARP_RARP_TERM_ALLOWED     (1 << 5)   /* Enabling arp/rarp
                                                          termination */
#define BCM_FIELD_L3_TNL_TERM_ALLOWED       (1 << 6)   /* Enabling L3 tunnel
                                                          termination */
...
typedef enum bcm_field_l2_pkt_type_e {
    ...
    bcmFieldL2PktTypeSnapOrLLC = 3, /* SNAP or LLC L2 packet type. */
    bcmFieldL2PktTypeAny = 4,       /* Any L2 packet type. */
    bcmFieldL2PktTypeHG3Base = 5,   /* HG3 Base L2 packet type */
    bcmFieldL2PktTypeHG3Ext0 = 6,   /* HG3 Ext0 L2 packet type */
    bcmFieldL2PktTypeSvtag = 7,     /* SVTAG L2 packet type */
    bcmFieldL2PktTypeRspan = 8,     /* RSPAN L2 packet type */
    bcmFieldL2PktTypeLastCount = 9  /* Always Last. Not a usable value. */
...
typedef enum bcm_field_pkt_type_e {
    ...
    bcmFieldPktTypeTcpINT = 103,        /* INT (Inband-Telemtry) Packet over
                                           IP-TCP packet */
    bcmFieldPktTypeTcpIfa = 104,        /* IFA (Inband-Flow Analyzer) Packet
                                           over IP-TCP packet */
    bcmFieldPktTypeUdpIfa = 105,        /* IFA (Inband-Flow Analyzer) Packet
                                           over IP-UDP packet */
    bcmFieldPktTypeIpBfd = 106,         /* BFD Over IP Packet Type */
    bcmFieldPktTypeEthertype = 107,     /* Packet with EtherType */
    bcmFieldPktTypeIpIcmp = 108,        /* IP-ICMP Packet */
    bcmFieldPktTypeIpIgmp = 109,        /* IP-IGMP Packet */
    bcmFieldPktTypeIpTcp = 110,         /* IP-TCP Packet */
    bcmFieldPktTypeIpUdp = 111,         /* IP-UDF Packet */
    bcmFieldPktTypeUnknownL3 = 112,     /* Packet with Unknown L3 */
    bcmFieldPktTypeUnknownL4 = 113,     /* Packet with Unknown L4 */
    bcmFieldPktTypeUnknownL5 = 114,     /* Packet with Unknown L5 */
    bcmFieldPktTypeIpGpe = 115,         /* GPE Over IP Packet Type */
    bcmFieldPktTypeIpGre = 116,         /* GRE over IP Packet Type */
    bcmFieldPktTypeIpGreChksum = 117,   /* GRE checksum over IP Packet Type */
    bcmFieldPktTypeIpGreKey = 118,      /* GRE key over IP Packet Type */
    bcmFieldPktTypeIpGreRout = 119,     /* GRE Rout over IP Packet Type */
    bcmFieldPktTypeIpGreSeq = 120,      /* GRE seq over IP Packet Type */
    bcmFieldPktTypeIpIfa = 121,         /* IFA (Inband-Flow Analyzer) Packet
                                           over IP packet */
    bcmFieldPktTypeMplsAch = 122,       /* Mpls Ach packet type */
    bcmFieldPktTypeIpVxlan = 123,       /* VXLAN Over IP Packet Type */
    bcmFieldPktTypeIpv4IOAME2E = 124,   /* IPv4 IOAM (Inband-OAM) E2E Packet */
    bcmFieldPktTypeIpv6IOAME2E = 125,   /* IPv6 IOAM (Inband-OAM) E2E Packet */
    bcmFieldPktTypeIOAME2E = 126,       /* IOAM (Inband-OAM) E2E Packet over any
                                           IP Packet */
    bcmFieldPktTypeUdpManyInOne = 127,  /* UDP Flows like UDP-IFA, VxLan,
                                           1588-UDP and IP-UDP., */
    bcmFieldPktTypeTcpManyInOne = 128,  /* TCP Flows like TCP-IFA and IP-TCP., */
    bcmFieldPktTypeGtp8Byte = 129,      /* GTP 8-byte., */
    bcmFieldPktTypeGtp12Byte = 130,     /* GTP 12-byte., */
    bcmFieldPktTypeLastCount = 131      /* Not in use - Last Count */
...
typedef enum bcm_field_ip_option_hdr_type_e {
    ...
    bcmFieldIpOptionHdrTypeAHExt2 = 15, /* Authentication Header type Ext hdr 2 */
    bcmFieldIpOptionHdrTypeFragExt2 = 16, /* Fragment type Ext header 2 */
    bcmFieldIpOptionHdrTypeLastCount = 17 /* Last count */
...
typedef enum bcm_field_TunnelSubType_e {
    ...
    bcmFieldTunnelSubTypeUnknown = 3,   /* Subtype Unknown or None. */
    bcmFieldTunnelSubTypeCount = 4      /* Always Last. Not a usable value. */
...
/* 
 * Indicates the maximum number of context selection qualifiers which can
...
#define BCM_FIELD_NUMBER_OF_HASH_KEYS       (8)        /* Default constant for
                                                          number of hash keys
                                                          per hash context. */
...
typedef enum bcm_field_tcam_bank_allocation_mode_e {
    ...
    bcmFieldTcamBankAllocationModeSelect = 1, /*  Select TCAM bank allocation mode:
                                           For field groups with this type of
                                           allocation mode, user may supply an
                                           additional array when adding the
                                           field group to allocate certain bank
                                           ids. User can also later use the
                                           function 'bcm_field_tcam_bank_add()'
                                           to add banks to the field group
                                           allocated banks list */
    bcmFieldTcamBankAllocationModeSelectWithLocation = 2, /*  Select with location TCAM bank
                                           allocation mode: For field groups
                                           with this type of allocation mode, in
                                           addition to supplying banks to
                                           allocate array when adding the field
                                           group, per entry adding, priority
                                           acts as the location to insert the
                                           entry to. */
    bcmFieldTcamBankAllocationModeCount = 3 /* Always last. Not a usable value. */
...
#define BCM_FIELD_MAX_SHORT_NAME_LEN    (72)       
...
/* 
 * This enum contains all Cache Modes that can be passed to
 * bcm_field_group_cache() function.
 */
typedef enum bcm_field_group_cache_mode_e {
    bcmFieldGroupCacheModeFirst = 0,    /* Invalid Param. */
    bcmFieldGroupCacheModeStart = bcmFieldGroupCacheModeFirst, /* Start cache mode. */
    bcmFieldGroupCacheModeInstall = 1,  /* Install all pending entries to the
                                           hardware tables. */
    bcmFieldGroupCacheModeClear = 2,    /* Clear cache. */
    bcmFieldGroupCacheModeCount = 3     /* Always last. Not a usable value. */
} bcm_field_group_cache_mode_t;

#ifndef BCM_HIDE_DISPATCHABLE

/* Set cache mode for TCAM field group entries. */
extern int bcm_field_group_cache(
    int unit, 
    uint32 flags, 
    bcm_field_group_t fg_id, 
...
/* 
 * This flag is used for external TCAM field groups, to indicate that
 * consecutive qualifers whose size in bits is not a multiplier of 8,
 * should be attemped to be combined to a single segment.
 */
#define BCM_FIELD_FLAG_QUAL_PACKING (1 << 6)   
...
typedef struct bcm_field_qualify_attach_info_s {
    bcm_field_input_types_t input_type; /* The base of qualifier, indicates from
                                           where the info is taken, relevant for
                                           all type of qualifiers. */
    int input_arg;                      /* Dedicated argument for specified
                                           input_type. */
    int offset;                         /* Additional offset for header
                                           qualifiers / offset for user defined
                                           qualifiers. */
...
typedef struct bcm_field_entry_qual_s {
    ...
    uint32 max_value[BCM_FIELD_QUAL_WIDTH_IN_WORDS]; /* Sets the maximum value for ranged
                                           qualify (lookup key). */
    uint32 mask[BCM_FIELD_QUAL_WIDTH_IN_WORDS]; /* Mask that dictates which of the value
                                           bits are relevant for lookup. */
 ...
 * a non-predefined, it indicated the size and gets a qualifier ID.
 */
...
typedef enum bcm_field_name_to_id_type_e {
    bcmFieldNameToIdGroup = 0,      /* Field group. */
    bcmFieldNameToIdQualifier = 1,  /* Qualifier. */
    bcmFieldNameToIdAction = 2,     /* Action. */
    bcmFieldNameToIdContext = 3,    /* Context. */
    bcmFieldNameToIdAceFormat = 4,  /* Context. */
    bcmFieldNameToIdCount = 5       /* Always last. Not a usable value.. */
} bcm_field_name_to_id_type_t;

/* 
 * Information for mapping name to ID. used by
 * bcm_field_object_name_to_id().
 */
typedef struct bcm_field_name_to_id_info_s {
    bcm_field_stage_t stage;            /* Field stage of the object. Relevant
                                           for contexts. */
    bcm_field_name_to_id_type_t name_to_id_type; /* What type of object to translate
                                           (e.g. field group, qualifier,
                                           action). */
    uint8 name[BCM_FIELD_MAX_SHORT_NAME_LEN]; /* Name of the object. */
} bcm_field_name_to_id_info_t;

/* Initialize the bcm_field_name_to_id_info_t structure. */
extern void bcm_field_name_to_id_info_t_init(
...
typedef struct bcm_field_context_hash_info_s {
    bcm_field_context_key_info_t key_info; /* The Hash key information, describing
                                           the qualifiers and template of the
                                           constructed key */
    ...
    int nof_additional_hash_config;     /* Number of additional hashing
                                           configuration */
    bcm_field_context_hash_config_t additional_hash_config[BCM_FIELD_NUMBER_OF_HASH_KEYS]; /* Additional hashing configuration
                                           params. */
...
/* 
 * Evacuates the given fg_id OR pp_app from the bank IDs that are given
 * in evac_info struct.
 * The evacuation process involves moving the entries of the given fg_id
 * from the targeted banks to other banks allocated by the fg_id,
 * if not enough space is available for moving the entries, this function
 * fails.
 */
...
/* 
 * Adds the given bank IDs to the given fg_id OR pp_app that are given in
 * add_info struct.
 */
extern int bcm_field_tcam_bank_add(
    int unit, 
    uint32 flags, 
...
/* Define for maximum number of DBs (FGs/PP-APPs) allowed on a TCAM bank */
#define BCM_FIELD_TCAM_BANK_DBS_MAX 32         

/* Output structure for bcm_field_tcam_bank_status_get */
typedef struct bcm_field_tcam_bank_status_info_s {
    bcm_field_group_t fg_ids[BCM_FIELD_TCAM_BANK_DBS_MAX+1]; /* List of FG-IDs registered on the TCAM
                                           bank for the specified core,
                                           terminated by BCM_FIELD_ID_INVALID */
    bcm_field_app_db_t pp_app_ids[BCM_FIELD_TCAM_BANK_DBS_MAX+1]; /* List of PP-APPs registered on the
                                           TCAM bank for the specified core,
                                           terminated by bcmFieldAppDbInvalid */
    uint32 nof_fg_entries[BCM_FIELD_TCAM_BANK_DBS_MAX+1]; /* Number of entries per FG on the TCAM
                                           bank for the specified core */
    uint32 nof_pp_app_entries[BCM_FIELD_TCAM_BANK_DBS_MAX+1]; /* Number of entries per PP-APP on the
                                           TCAM bank for the specified core */
    uint32 nof_free_half_entries;       /* Number of available half key-size
                                           entries on the TCAM bank for the
                                           specified core */
    uint32 nof_free_single_entries;     /* Number of available single key-size
                                           entries on the TCAM bank for the
                                           specified core */
    uint32 nof_free_double_entries;     /* Number of available double key-size
                                           entries on the TCAM bank for the
                                           specified core */
} bcm_field_tcam_bank_status_info_t;

#ifndef BCM_HIDE_DISPATCHABLE

/* 
 * Returns the list of field groups/PP APPs along with their entry count
 * on the given TCAM bank for the given core, also returns the number of
 * available entries per key-size on the given TCAM bank for the given
 * core
 */
extern int bcm_field_tcam_bank_status_get(
    int unit, 
    bcm_core_t core, 
    uint32 bank_id, 
...
typedef enum bcm_field_context_param_type_e {
    ...
    bcmFieldContextParamTypeKeyVal = 2, /* Set a constant value that can be used
                                           ...
                                           the context. */
    bcmFieldContextParamTypeFlushLearnEnable = 3, /* Enable Flush learning. */
    bcmFieldContextParamCount = 4       /* Always last. Not a usable value. */
...
extern int bcm_field_efes_action_add(
    int unit, 
    uint32 flags, 
    bcm_field_group_t fg_id, 
    bcm_field_context_t context_id, 
...
/* 
 * This function give the caller all info concerning contents of an EFES
 * that was added with bcm_field_efes_action_add().
 */
extern int bcm_field_efes_action_info_get(
    int unit, 
    bcm_field_group_t fg_id, 
    bcm_field_context_t context_id, 
    bcm_field_action_priority_t encoded_position, 
...
/* 
 * This function deletes an EFES that was added with
 * bcm_field_efes_action_add().
 */
extern int bcm_field_efes_action_delete(
    int unit, 
    bcm_field_group_t fg_id, 
    bcm_field_context_t context_id, 
    bcm_field_action_priority_t bcm_field_action_priority_t);
...
#define BCM_FIELD_ACTION_POSITION(_array_id_, _position_)  \
    (((((bcm_field_action_priority_t) (_position_)) & BCM_FIELD_ACTION_POSITION_MASK) | \
      ((((bcm_field_action_priority_t) (_array_id_)) & BCM_FIELD_ACTION_ARRAY_MASK) \
        ...
        (1U << BCM_FIELD_ACTION_VALID_OFFSET)))) 
...
typedef enum bcm_field_range_type_e {
    ...
    bcmFieldRangeTypeL4OpsPacketHeaderSize = 4, /* Packet Header Size Range Qualifier
                                           for L4 OPS. */
    bcmFieldRangeTypeInTTL = 5,         /* In TTL Range Qualifier */
    bcmFieldRangeTypeUserDefined1Low = 6, /* User-Defined-1 Low (16b) Range
                                           Qualifier */
    bcmFieldRangeTypeUserDefined1High = 7, /* User-Defined-1 High (16b) Range
                                           Qualifier */
    bcmFieldRangeTypeUserDefined2Low = 8, /* User-Defined-2 Low (16b) Range
                                           Qualifier */
    bcmFieldRangeTypeUserDefined2High = 9, /* User-Defined-2 High (16b) Range
                                           Qualifier */
    bcmFieldRangeTypeCount = 10         /* Always last. Not a usable value. */
} bcm_field_range_type_t;

#define BCM_FIELD_RANGE_TYPE_STR \
{ \
    "L4SrcPort", \
    "L4DstPort", \
    "OutVport", \
    "PacketHeaderSize", \
    "L4OpsPacketHeaderSize", \
    "InTTL", \
    "UserDefined1Low", \
    "UserDefined1High", \
    "UserDefined2Low", \
...
typedef enum bcm_field_layer_type_e {
    ...
    bcmFieldLayerTypeSctp = 32, 
    bcmFieldLayerTypeForwardingMPLS = 33, 
    bcmFieldLayerTypeGtp = 34, 
    bcmFieldLayerTypeMplsIfit = 35, 
    bcmFieldLayerTypeEthEnd = 36, 
    bcmFieldLayerTypeMplsEnd = 37, 
    bcmFieldLayerTypeSrv6EndpointPsp = 38, 
    bcmFieldLayerTypeSrv6UspExtPsp = 39, 
    bcmFieldLayerTypeCount = 40         /* Always last. Not a usable value. */
...
/* Forwarding Context. */
typedef enum bcm_field_forward_context_e {
    bcmFieldForwardContextFirst = 0, 
    bcmFieldForwardContextEth = bcmFieldForwardContextFirst, 
    bcmFieldForwardContextMirrorOrSs = 1, 
    bcmFieldForwardContextIPv4UcR0 = 2, 
    bcmFieldForwardContextIPv4McR0 = 3, 
    bcmFieldForwardContextIPv6UcR0 = 4, 
    bcmFieldForwardContextIPv6McR0 = 5, 
    bcmFieldForwardContextBierMpls = 6, 
    bcmFieldForwardContextBierTi = 7, 
    bcmFieldForwardContextIngressTrapLegacy = 8, 
    bcmFieldForwardContextCpuPort = 9, 
    bcmFieldForwardContextRchEnc = 10, 
    bcmFieldForwardContextRchPtchEnc = 11, 
    bcmFieldForwardContextStackingPort = 12, 
    bcmFieldForwardContextFcoeFcf = 13, 
    bcmFieldForwardContextFcoeFcfVft = 14, 
    bcmFieldForwardContextSrv6Endpoint = 15, 
    bcmFieldForwardContextSrv6EndpointPsp = 16, 
    bcmFieldForwardContextSrv6TunnelTerm = 17, 
    bcmFieldForwardContextTm = 18, 
    bcmFieldForwardContextRawProcessing = 19, 
    bcmFieldForwardContextTdm = 20, 
    bcmFieldForwardContextMplsInjectedFromOamp = 21, 
    bcmFieldForwardContextErppTrap = 22, 
    bcmFieldForwardContextDoNotEdit = 23, 
    bcmFieldForwardContextMpls = 24, 
    bcmFieldForwardContextIpv4UcR1 = 25, 
    bcmFieldForwardContextIpv4McR1 = 26, 
    bcmFieldForwardContextIpv6UcR1 = 27, 
    bcmFieldForwardContextIpv6McR1 = 28, 
    bcmFieldForwardContextCount = 29    /* Always last. Not a usable value. */
} bcm_field_forward_context_t;

#define BCM_FIELD_FORWARD_CONTEXT_STRINGS \
{ \
    "Eth", \
    "MirrorOrSs", \
    "IPv4UcR0", \
...
/* 
 * Base value for Flow Tracker based Field Processor stage
 * Group/Entry/Presel Ids.
 */
#define BCM_FIELD_FT_ID_BASE    (0x04000000) 
...
/* Parameters for bcmFieldActionDlbTrunkMonitorEnable */
#define BCM_FIELD_DLB_TRUNK_MON_DISABLE (1 << 0)   /* Enabling Dlb Trunk Monitor
                                                      support */
#define BCM_FIELD_DLB_TRUNK_MON_ENABLE  (1 << 1)   /* Disabling Dlb Trunk
                                                      Monitor support */
...
typedef enum bcm_field_egress_flow_control_e {
    ...
    bcmFieldEgressFlowControlIfaCopyToCpuWithMetadata = 16, /* Copy to cpu IFA packet with metadata */
    bcmFieldEgressFlowControlIfaLastNodeWithMetadata = 17, /* IFA Last node with Metadata */
    bcmFieldEgressFlowControlIfaProbeSecondPass = 18, /* IFA probe second pass */
    bcmFieldEgressFlowControlTunnelDecap = 19, /* Tunnel Decap */
    bcmFieldEgressFlowControlNshInsert = 20, /* Insertion of NSH header */
    bcmFieldEgressFlowControlNshTerminate = 21, /* NSH Termination */
    bcmFieldEgressFlowControlNshTermMdClassPayload = 22, /* Add NSH Termination metadata class
                                           payload */
    bcmFieldEgressFlowControlIfaHdrInsertionOverTrunk = 23, /* Insert IFA Header Over trunk */
    bcmFieldEgressFlowControlVxlanGbpSrcIdInherit = 24, /* Inherit GBP SID from one VXLAN tunnel
                                           to another */
    bcmFieldEgressFlowControlIfaProbeInit = 25, /* IFA probe Initialization */
    bcmFieldEgressFlowControlIfaProbeInitOverTrunk = 26, /* IFA probe Initialization over trunk */
    bcmFieldEgressFlowControlIfaSingleNode = 27, /* IFA single node */
    bcmFieldEgressFlowControlIfaOverTrunkCopyToCpuSingleNode = 28, /* IFA over trunk copy to cpu single
                                           node */
    bcmFieldEgressFlowControlIfaMetadataAfterVxLanDecap = 29, /* IFA Metadata After VxLan tunnel
                                           temrination */
    bcmFieldEgressFlowControlIfaLastNodeVxLanDecapWithPayload = 30, /* IFA Last node VxLan tunnel temination
                                           with payload */
    bcmFieldEgressFlowControlIfaOverTrunkUdpUpdate = 31, /* IFA over trunk UDP update */
    bcmFieldEgressFlowControlMplsEvpnEsiFilter = 32, /* MPLS EVPN ESI Filter */
    bcmFieldEgressFlowControlCount = 33 /* Always last. Not to be used. */
...
typedef enum bcm_field_egress_flow_encap_e {
    ...
    bcmFieldEgressFlowEncapMacsecEncryptRxControlPktSvtagAdd = 4, /* Set control bit in SVTAG for MACSEC
                                           RX Control Packets. */
    bcmFieldEgressFlowEncapIfaCopyToCpuWithMetadata = 5, /* Copy to cpu IFA packet with Metadata */
    bcmFieldEgressFlowEncapIfaUdpHdrUpdate = 6, /* IFA UDP header update */
    bcmFieldEgressFlowEncapIntReply = 7, /* INT metadata header insertion */
    bcmFieldEgressFlowEncapIOAME2EEnable = 8, /* IOAM E2E Enable */
    bcmFieldEgressFlowEncapTunnelDecap = 9, /* Tunnel Decap */
    bcmFieldEgressFlowEncapNshMdTypeEqualToOne = 10, /* NSH Metadata type equal to One */
    bcmFieldEgressFlowEncapNshMdTypeEqualToTwo = 11, /* NSH Metadata type equal to Two */
    bcmFieldEgressFlowEncapIfaCopyToCpuWithMetadataOverTrunk = 12, /* Copy to CPU IFA with Metadata over
                                           trunk */
    bcmFieldEgressFlowEncapIfaOverTrunkEnable = 13, /* Enable IFA over trunk */
    bcmFieldEgressFlowEncapIfaProbeInitUntagWithUdpUpdate = 14, /* IFA Probe Init Untag With UDP Update */
    bcmFieldEgressFlowEncapIfaProbeInitStagWithUdpUpdate = 15, /* IFA Probe Init STAG With UDP Update */
    bcmFieldEgressFlowEncapIfaProbeInitDtagWithUdpUpdate = 16, /* IFA Probe Init DTAG With UDP Update */
    bcmFieldEgressFlowEncapIfaProbeInitOverTrunkUntagWithUdpUpdate = 17, /* IFA Probe Init over trunk UNTAG With
                                           UDP Update */
    bcmFieldEgressFlowEncapIfaProbeInitOverTrunkStagWithUdpUpdate = 18, /* IFA Probe Init over trunk STAG With
                                           UDP Update */
    bcmFieldEgressFlowEncapIfaProbeInitOverTrunkDtagWithUdpUpdate = 19, /* IFA Probe Init over trunk DTAG With
                                           UDP Update */
    bcmFieldEgressFlowEncapIfaSingleNodeUntag = 20, /* IFA Single Node UNTAG */
    bcmFieldEgressFlowEncapIfaSingleNodeStag = 21, /* IFA Single Node STAG */
    bcmFieldEgressFlowEncapIfaSingleNodeDtag = 22, /* IFA Single Node DTAG */
    bcmFieldEgressFlowEncapIfaProbeInitUntag = 23, /* IFA Probe Init Untag */
    bcmFieldEgressFlowEncapIfaProbeInitStag = 24, /* IFA Probe Init Stag */
    bcmFieldEgressFlowEncapIfaProbeInitDtag = 25, /* IFA Probe Init Dtag */
    bcmFieldEgressFlowEncapIfaOverTrunkCopyToCpuSingleNodeUntag = 26, /* IFA Over Trunk Copy To CPU Single
                                           Node Untag */
    bcmFieldEgressFlowEncapIfaOverTrunkCopyToCpuSingleNodeStag = 27, /* IFA Over Trunk Copy To CPU Single
                                           Node Stag */
    bcmFieldEgressFlowEncapIfaOverTrunkCopyToCpuSingleNodeDtag = 28, /* IFA Over Trunk Copy To CPU Single
                                           Node Dtag */
    bcmFieldEgressFlowEncapIfaMetadataAfterVxLanDecap = 29, /* IFA Metadata after VxLan tunnel
                                           termination */
    bcmFieldEgressFlowEncapIfaMetadataAfterVxLanDecapWithUdpUpdate = 30, /* IFA Metadata after VxLan tunnel
                                           termination with UDP Update */
    bcmFieldEgressFlowEncapIfaLastNodeVxLanDecapWithPayload = 31, /* IFA Last node VxLAN tunnel
                                           termination With Payload */
    bcmFieldEgressFlowEncapIfaLastNodeVxLanDecapWithPayloadWithUdpUpdate = 32, /* IFA Last node VxLAN tunnel
                                           termination With Payload with UDP
                                           Update */
    bcmFieldEgressFlowEncapIfaOverTrunkUdpUpdate = 33, /* IFA Over trunk with UDP Update */
    bcmFieldEgressFlowEncapIfaHdrInsertionOverTrunkUdpUpdate = 34, /* IFA Header insertion Over trunk with
                                           UDP Update */
    bcmFieldEgressFlowEncapCount = 35   /* Always last. Not to be used. */
} bcm_field_egress_flow_encap_t;

/* Tunnel Egress Flow Encap. */
typedef enum bcm_field_tunnel_egress_flow_encap_e {
    bcmFieldTunnelEgressFlowEncapIpv4IpInIp = 0, /* IPIP V4 */
    bcmFieldTunnelEgressFlowEncapIpv6IpInIp = 1, /* IPIP V6 */
    bcmFieldTunnelEgressFlowEncapIpv4IpGre = 2, /* IPGRE V4 */
    bcmFieldTunnelEgressFlowEncapIpv6IpGre = 3, /* IPGRE V6 */
    bcmFieldTunnelEgressFlowEncapMpls = 4, /* MPLS */
    bcmFieldTunnelEgressFlowEncapIpv4Vxlan = 5, /* IPv4 VxLan */
    bcmFieldTunnelEgressFlowEncapIpv6Vxlan = 6, /* IPv6 VxLan */
    bcmFieldTunnelEgressFlowEncapCount = 7 /* Always last. Not to be used. */
} bcm_field_tunnel_egress_flow_encap_t;
...
typedef enum bcm_field_ace_context_e {
    ...
    bcmFieldAceContextReflector = 1,    /* Ace context which is used for L3 UDP
                                           swap. */
    ...
    bcmFieldAceContextTmToCOE = 5,      /* ACE context which is used for TM to
                                           COE */
    bcmFieldAceContextMplsTransitCCMSignal = 6, /* ACE context which is used for CCM
                                           packet to send back the signal defect */
    bcmFieldAceContextAlternateMarkingIntermediate = 7, /* ACE context which is used for set the
                                           context selection for ENCAP_1 for
                                           intermidiate PE note */
    bcmFieldAceContextReflectorL2Int = 8, /* ACE context which is used for L2 UC
                                           internal reflector */
    bcmFieldAceContextReflectorL2IntIpSwap = 9, /* ACE context which is used for L2
                                           internal reflector with IP swap */
    bcmFieldAceContextReflectorL2IntIpUdpSwap = 10, /* ACE context which is used for L2
                                           internal reflector with IP+UDP swap */
    bcmFieldAceContextReflectorL2IntMc = 11, /* ACE context which is used for L2 MC
                                           internal reflector */
    bcmFieldAceContextIpfixRx = 12,     /* ACE context which is used for Ipfix
                                           packet RX - sent to eventor */
    bcmFieldAceContextCount = 13        /* Always last. Not a usable value. */
...
{ \
    ...
    "AlternateMarking", \
    "TmToCOE", \
    "MplsTransitCCMSignal", \
    "AlternateMarkingIntermediate", \
    "ReflectorL2Int", \
    "ReflectorL2IntIpSwap", \
    "ReflectorL2IntIpUdpSwap", \
    "ReflectorL2IntMc", \
    "IpfixRx"  \
}
...
typedef struct bcm_field_flexctr_config_s {
    ...
    uint32 counter_index;       /* Index to the counters associated to the flex
                                   counter action. */
    uint8 color;                /* Packet color to be counted,
                                   BCM_FIELD_COUNT_xxx */
 ...
 * field entry. The counter index in the 'bcm_field_flexctr_config_t'
 * structure should be in the range of maximum counters associated to the
 * flexctr action.
 */
extern int bcm_field_entry_flexctr_attach(
    int unit, 
    bcm_field_entry_t entry, 
    bcm_field_flexctr_config_t *flexctr_cfg);

/* Detach the flexctr for a given field entry. */
extern int bcm_field_entry_flexctr_detach(
    int unit, 
    bcm_field_entry_t entry, 
    bcm_field_flexctr_config_t *flexctr_cfg);
...
/* Field Policer Indexes. */
typedef enum bcm_field_policer_index_e {
    bcmFieldPolicerIndex0 = 0,      /* Field Policer index 0. */
    bcmFieldPolicerIndex1 = 1,      /* Field Policer index 1. */
    bcmFieldPolicerIndexCount = 2   /* Always Last. Not a usable value. */
} bcm_field_policer_index_t;

#define BCM_FIELD_POLICER_INDEX_STRINGS \
{ \
    "0", \
    "1"  \
}
...
/* 
 * Field policer configuration structure. Used to attach or detach the
 * policer to field entry.
 */
typedef struct bcm_field_policer_config_s {
    bcm_policer_t policer_id;           /* Policer ID. */
    bcm_policer_pool_num_t pool_id;     /* Policer pool to use. */
    bcm_field_policer_index_t index;    /* Field policer index to use. */
} bcm_field_policer_config_t;
...
extern int bcm_field_name_to_id(
    int unit, 
    uint32 flags, 
    bcm_field_name_to_id_info_t *name_to_id_info, 
    int *nof_ids, 
...
extern int bcm_field_presel_config_create(
    int unit, 
    bcm_field_presel_config_t *presel_config);
...
typedef int (*bcm_field_destination_entry_traverse_cb)(
    int unit, 
...
/* 
 * This structure is used to configure one FFC for user-defined range
 * type
 */
typedef struct bcm_field_range_qual_info_s {
    bcm_field_qualify_t qual_type;      /* BCM level qualifier look at
                                           bcm_field_qualify_t for more info. */
    bcm_field_qualify_attach_info_t qual_info; /* Indicate how to read the relevant
                                           qualifier from PBUS. */
...
extern int bcm_field_range_type_config_set(
    int unit, 
    uint32 flags, 
    bcm_field_stage_t stage, 
    bcm_field_context_t context_id, 
...
extern int bcm_field_range_type_config_get(
    int unit, 
    uint32 flags, 
    bcm_field_stage_t stage, 
    bcm_field_context_t context_id, 
...
typedef enum bcm_field_mpls_ctrl_pkt_type_e {
    bcmFieldMplsCtrlPktTypeNone = 0,    /* MPLS Control packet type none. */
    bcmFieldMplsCtrlPktTypePwVccv4 = 1, /* MPLS Control packet type
                                           PW_VCCV_TYPE_4. */
    bcmFieldMplsCtrlPktTypeGAch = 2,    /* MPLS Control packet type G_ACH. */
    bcmFieldMplsCtrlPktTypeLastCount = 3 /* Always Last. Not a usable value. */
} bcm_field_mpls_ctrl_pkt_type_t;

#define BCM_FIELD_MPLS_CTRL_PKT_TYPE \
{ \
    "None", \
    "PwVccv4", \
    "GAch"  \
...
/* Copy to cpu Reason (for bcm_field_qualify_CopyToCpuReasonLow). */
#define BCM_FIELD_COPY_TO_CPU_REASON_NO_COPY_TO_CPU (1 << 0)   /* Copytocpu reason No
                                                          copy to cpu */
#define BCM_FIELD_COPY_TO_CPU_REASON_CML_FLAGS (1 << 1)   /* Copytocpu reason CML
                                                          flags */
#define BCM_FIELD_COPY_TO_CPU_REASON_L2_SRC_STATIC_MOVE (1 << 2)   /* Copytocpu reason L2
                                                          src static move */
#define BCM_FIELD_COPY_TO_CPU_REASON_L2_SRC_DISCARD (1 << 3)   /* Copytocpu reason L2
                                                          src discard */
#define BCM_FIELD_COPY_TO_CPU_REASON_MACSA_MULTICAST (1 << 4)   /* Copytocpu reason Macsa
                                                          multicast */
#define BCM_FIELD_COPY_TO_CPU_REASON_PKT_INTEGRITY_CHECK_FAILED (1 << 5)   /* Copytocpu reason Pkt
                                                          intergrity check
                                                          failed */
#define BCM_FIELD_COPY_TO_CPU_REASON_PROTOCOL_PKT (1 << 6)   /* Copytocpu reason
                                                          Protocol pkt */
#define BCM_FIELD_COPY_TO_CPU_REASON_MEMBERSHIP_CHECK_FAILED (1 << 7)   /* Copytocpu reason
                                                          Membership check
                                                          failed */
#define BCM_FIELD_COPY_TO_CPU_REASON_SPANNING_TREE_CHECK_FAILED (1 << 8)   /* Copytocpu reason
                                                          Spanning tree check
                                                          failed */
#define BCM_FIELD_COPY_TO_CPU_REASON_L2_DST_LOOKUP_MISS (1 << 9)   /* Copytocpu reason L2
                                                          dst lookup miss */
#define BCM_FIELD_COPY_TO_CPU_REASON_L2_DST_LOOKUP (1 << 10)  /* Copytocpu reason L2
                                                          dst lookup */
#define BCM_FIELD_COPY_TO_CPU_REASON_L3_DST_LOOKUP_MISS (1 << 11)  /* Copytocpu reason L3
                                                          dst lookup miss */
#define BCM_FIELD_COPY_TO_CPU_REASON_L3_DST_LOOKUP (1 << 12)  /* Copytocpu reason L3
                                                          dst lookup */
#define BCM_FIELD_COPY_TO_CPU_REASON_L3_HDR_ERROR (1 << 13)  /* Copytocpu reason L3
                                                          hdr error */
#define BCM_FIELD_COPY_TO_CPU_REASON_L3_TTL_ERROR (1 << 14)  /* Copytocpu reason L3
                                                          TTL error */
#define BCM_FIELD_COPY_TO_CPU_REASON_IPMC_L3_IIF_OR_RPA_ID_CHECK_FAILED (1 << 15)  /* Copytocpu reason IOMC
                                                          L3 IIF Or RPA Id check
                                                          failed */
#define BCM_FIELD_COPY_TO_CPU_REASON_LEARN_CACHE_FULL (1 << 16)  /* Copytocpu reason Learn
                                                          cache full */
#define BCM_FIELD_COPY_TO_CPU_REASON_VFP    (1 << 17)  /* Copytocpu reason VFP */
#define BCM_FIELD_COPY_TO_CPU_REASON_IFP    (1 << 18)  /* Copytocpu reason IFP */
#define BCM_FIELD_COPY_TO_CPU_REASON_IFP_METER (1 << 19)  /* Copytocpu reason IFP
                                                          Meter */
#define BCM_FIELD_COPY_TO_CPU_REASON_DST_FP (1 << 20)  /* Copytocpu reason
                                                          Destination FP */
#define BCM_FIELD_COPY_TO_CPU_REASON_SVP    (1 << 21)  /* Copytocpu reason SVP */
#define BCM_FIELD_COPY_TO_CPU_REASON_EM_FT  (1 << 22)  /* Copytocpu reason EM FT */
#define BCM_FIELD_COPY_TO_CPU_REASON_IVXLT  (1 << 23)  /* Copytocpu reason IVXLT */
#define BCM_FIELD_COPY_TO_CPU_REASON_MIRROR_SAMPLER_SAMPLED (1 << 24)  /* Copytocpu reason
                                                          Mirror sampler sampled */
#define BCM_FIELD_COPY_TO_CPU_REASON_MIRROR_SAMPLER_EGR_SAMPLED (1 << 25)  /* Copytocpu reason
                                                          Mirror sampler egr
                                                          sampled */
#define BCM_FIELD_COPY_TO_CPU_REASON_SER_DROP (1 << 26)  /* Copytocpu reason Ser
                                                          drop */
#define BCM_FIELD_COPY_TO_CPU_REASON_URPF_CHECK_FAILED (1 << 27)  /* Copytocpu reason Urpf
                                                          check failed */
#define BCM_FIELD_COPY_TO_CPU_REASON_L3_IIF_EQ_L3_OIF (1 << 28)  /* Copytocpu reason L3
                                                          IIF Equals L3 OIF */
#define BCM_FIELD_COPY_TO_CPU_REASON_DLB_ECMP_MONITOR_EN_OR_MEMBER_REASSINED (1 << 29)  /* Copytocpu reason Dlb
                                                          Ecmp Monitor En Or
                                                          Member Reassined */
#define BCM_FIELD_COPY_TO_CPU_REASON_DLB_LAG_MONITOR_EN_OR_MEMBER_REASSINED (1 << 30)  /* Copytocpu reason Dlb
                                                          Lag Monitor En Or
                                                          Member Reassined */
#define BCM_FIELD_COPY_TO_CPU_REASON_MPLS_CTRL_PKT_TO_CPU (1U << 31) /* Copytocpu reason Mpls
                                                          ctrl pkt to cpu */

/* Copy to cpu Reason (for bcm_field_qualify_CopyToCpuReasonHigh). */
#define BCM_FIELD_COPY_TO_CPU_REASON_HIGH_MATCHED_RULE_BIT_0 (1 << 0)   /* Copytocpu reason
                                                          Matched rule bit 0 */
#define BCM_FIELD_COPY_TO_CPU_REASON_HIGH_MATCHED_RULE_BIT_1 (1 << 1)   /* Copytocpu reason
                                                          Matched rule bit 1 */
#define BCM_FIELD_COPY_TO_CPU_REASON_HIGH_MATCHED_RULE_BIT_2 (1 << 2)   /* Copytocpu reason
                                                          Matched rule bit 2 */
#define BCM_FIELD_COPY_TO_CPU_REASON_HIGH_MATCHED_RULE_BIT_3 (1 << 3)   /* Copytocpu reason
                                                          Matched rule bit 3 */
#define BCM_FIELD_COPY_TO_CPU_REASON_HIGH_MATCHED_RULE_BIT_4 (1 << 4)   /* Copytocpu reason
                                                          Matched rule bit 4 */
#define BCM_FIELD_COPY_TO_CPU_REASON_HIGH_MATCHED_RULE_BIT_5 (1 << 5)   /* Copytocpu reason
                                                          Matched rule bit 5 */
#define BCM_FIELD_COPY_TO_CPU_REASON_HIGH_MATCHED_RULE_BIT_6 (1 << 6)   /* Copytocpu reason
                                                          Matched rule bit 6 */
#define BCM_FIELD_COPY_TO_CPU_REASON_HIGH_MATCHED_RULE_BIT_7 (1 << 7)   /* Copytocpu reason
                                                          Matched rule bit 7 */
#define BCM_FIELD_COPY_TO_CPU_REASON_HIGH_TRACE_DO_NOT_MIRROR (1 << 8)   /* Copytocpu reason Trace
                                                          do not mirror */
#define BCM_FIELD_COPY_TO_CPU_REASON_HIGH_TRACE_DO_NOT_COPY_TO_CPU (1 << 9)   /* Copytocpu reason Trace
                                                          do not CopyToCpu */
#define BCM_FIELD_COPY_TO_CPU_REASON_HIGH_TRACE_DOP (1 << 10)  /* Copytocpu reason Trace
                                                          dop */

/* bcm_field_mirror_on_drop_reason_e */
typedef enum bcm_field_mirror_on_drop_reason_e {
    bcmFieldMirrorOnDropReasonIngressLimit = 0, /* MMU drop reason is due to ingress
                                           limit */
    bcmFieldMirrorOnDropReasonSharedPoolLimit = 1, /* MMU drop reason is due to shared pool
                                           limit */
    bcmFieldMirrorOnDropReasonEgressPortServicePoolSharedLimit = 2, /* MMU drop reason is due to egress port
                                           service pool shared limit */
    bcmFieldMirrorOnDropReasonEgressQueueSharedLimit = 3, /* MMU drop reason is due to egress
                                           queue shared limit */
    bcmFieldMirrorOnDropReasonWREDCheck = 4, /* MMU drop reason is due to WRED check */
    bcmFieldMirrorOnDropReasonLastCount = 5 /* Always Last. Not a usable value. */
} bcm_field_mirror_on_drop_reason_t;

#define BCM_FIELD_MIRROR_ON_DROP_REASON \
{ \
    "IngressLimit", \
    "SharedPoolLimit", \
    "EgressPortServicePoolSharedLimit", \
    "EgressQueueSharedLimit", \
    "WREDCheck"  \
}

/* bcm_field_pkt_queue_notif_e */
typedef enum bcm_field_pkt_queue_notif_e {
    bcmFieldPktQueueNotifCongestionIndication = 0, /* Congestion Experienced indication
                                           from MMU */
    bcmFieldPktQueueNotifUnicastQueuing = 1 /* Unicast Queuing */
} bcm_field_pkt_queue_notif_t;

#define BCM_FIELD_PKT_QUEUE_NOTIF \
{ \
...
/* bcm_field_l2_pkt_type_e */
typedef enum bcm_field_mcast_pkt_reason_e {
    bcmFieldMcastPktReasonSwitchCopy = 0, /* Switch copy indication from MMU */
    bcmFieldMcastPktReasonReplicatedCopy = 1, /* L3IPMC replicated copy indication
                                           from MMU */
    bcmFieldMcastPktReasonL3Only = 2,   /* L3 ONLY indication from MMU */
    bcmFieldMcastPktReasonLastCount = 3 /* Always Last. Not a usable value. */
} bcm_field_mcast_pkt_reason_t;

#define BCM_FIELD_MAST_PKT_REASON \
{ \
    "SwitchCopy", \
    "ReplicatedCopy", \
    "L3Only", \
...
typedef enum bcm_field_vlan_tag_action_e {
    bcmFieldVlanTagActionDelete = 0,    /* Delete Vlan Tag */
    bcmFieldVlanTagActionAddOrReplace = 1, /* Add or replace Vlan tag. */
    bcmFieldVlanTagActionLastCount = 2  /* Always last. Not to be used. */
} bcm_field_vlan_tag_action_t;

/* Enums for Drop Mask Profiles */
typedef enum bcm_field_drop_mask_control_profile_e {
    bcmFieldDropMaskControlProfile0 = 0, /* Profile 0 */
    bcmFieldDropMaskControlProfile1 = 1, /* Profile 1 */
    bcmFieldDropMaskControlLastCount = 2 /* Always last. Not to be used. */
} bcm_field_drop_mask_control_profile_t;

/* Enums for Drop Mask Reasons */
typedef enum bcm_field_drop_mask_reason_e {
    bcmFieldDropMaskReasonControlFrame = 0, /* Control frame */
    bcmFieldDropMaskReasonL3DosAttack = 1, /* L3 Dos Attack */
    bcmFieldDropMaskReasonHiGigLoopback = 2, /* HiGig Loopback */
    bcmFieldDropMaskReasonHiGigUnknownOpcode = 3, /* HiGig Unknown Opcode */
    bcmFieldDropMaskReasonHiGigHdrError = 4, /* HiGig Hdr Error */
    bcmFieldDropMaskReasonLagFailLoopback = 5, /* LAG Fail Loopback */
    bcmFieldDropMaskReasonSrcMacEqualsDstMac = 6, /* Source Mac Address Equals to
                                           Destionation Mac Address */
    bcmFieldDropMaskReasonL4DosAttack = 7, /* L4 DOS Attack */
    bcmFieldDropMaskReasonNivDot1p = 8, /* Niv Dot1p */
    bcmFieldDropMaskReasonNivVntagPresent = 9, /* Niv Vntag Present */
    bcmFieldDropMaskReasonNivVntagNotPresent = 10, /* Niv Vntag not Present */
    bcmFieldDropMaskReasonNivVntagFormat = 11, /* Niv Vntag format */
    bcmFieldDropMaskReasonUnknownSubtendingPort = 12, /* Unknown Subtending Port */
    bcmFieldDropMaskReasonHostPostureAssementSrcMacCheckFail = 13, /* HostPostureAssementSrcMacCheckFail */
    bcmFieldDropMaskReasonTunnelObjectValidationFail = 14, /* TunnelObjectValidationFail */
    bcmFieldDropMaskReasonTunnelShimHdrError = 15, /* TunnelShimHdrError */
    bcmFieldDropMaskReasonTunnelTtlCheckFail = 16, /* TunnelTtlCheckFail */
    bcmFieldDropMaskReasonMplsInvalidAction = 17, /* MplsInvalidAction */
    bcmFieldDropMaskReasonMplsLabelMiss = 18, /* MplsLabelMiss */
    bcmFieldDropMaskReasonMplsEntropyLabel = 19, /* MplsEntropyLabel */
    bcmFieldDropMaskReasonMplsInvalidPayload = 20, /* MplsInvalidPayload */
    bcmFieldDropMaskReasonMplsGalIsNotBos = 21, /* MplsGalIsNotBos */
    bcmFieldDropMaskReasonMplsControlPkt = 22, /* MplsControlPkt */
    bcmFieldDropMaskReasonTunnelInterfaceCheckFail = 23, /* TunnelInterfaceCheckFail */
    bcmFieldDropMaskReasonMimTunnelProcessFail = 24, /* MimTunnelProcessFail */
    bcmFieldDropMaskReasonIpInIpTunnelProcessFail = 25, /* IpInIpTunnelProcessFail */
    bcmFieldDropMaskReasonFieldStageIngressDrop = 26, /* FieldStageIngressDrop */
    bcmFieldDropMaskReasonInvalidVlan = 27, /* InvalidVlan */
    bcmFieldDropMaskReasonInportNotInVlan = 28, /* InportNotInVlan */
    bcmFieldDropMaskReasonInvalidTpid = 29, /* InvalidTpid */
    bcmFieldDropMaskReasonPvlanVlanIdMismatch = 30, /* PvlanVlanIdMismatch */
    bcmFieldDropMaskReasonFcoeVft = 31, /* FcoeVft */
    bcmFieldDropMaskReasonFcoeSrcBindCheck = 32, /* FcoeSrcBindCheck */
    bcmFieldDropMaskReasonFcoeSrcFpmaCheck = 33, /* FcoeSrcFpmaCheck */
    bcmFieldDropMaskReasonVfiPointToPoint = 34, /* VfiPointToPoint */
    bcmFieldDropMaskReasonSpanningTreeCheckFail = 35, /* SpanningTreeCheckFail */
    bcmFieldDropMaskReasonMulticastIndexError = 36, /* MulticastIndexError */
    bcmFieldDropMaskReasonBpduDrop = 37, /* BpduDrop */
    bcmFieldDropMaskReasonCmlCheckFail = 38, /* CmlCheckFail */
    bcmFieldDropMaskReasonSrcMacIsMulticast = 39, /* SrcMacIsMulticast */
    bcmFieldDropMaskReasonL2SrcLookupFail = 40, /* L2SrcLookupFail */
    bcmFieldDropMaskReasonL2SrcStaticMoveDrop = 41, /* L2SrcStaticMoveDrop */
    bcmFieldDropMaskReasonL2DstLookupFail = 42, /* L2DstLookupFail */
    bcmFieldDropMaskReasonL3DisableDrop = 43, /* L3DisableDrop */
    bcmFieldDropMaskReasonSrcMacIsZero = 44, /* SrcMacIsZero */
    bcmFieldDropMaskReasonL3FwdLookupMissOrNonUcastPktDrop = 45, /* L3FwdLookupMissOrNonUcastPktDrop */
    bcmFieldDropMaskReasonClassBasedLearningDrop = 46, /* ClassBasedLearningDrop */
    bcmFieldDropMaskReasonTimeSyncPkt = 47, /* TimeSyncPkt */
    bcmFieldDropMaskReasonIpmcProcessDrop = 48, /* IpmcProcessDrop */
    bcmFieldDropMaskReasonMyStationDrop = 49, /* MyStationDrop */
    bcmFieldDropMaskReasonVpBasedPvlanDrop = 50, /* VpBasedPvlanDrop */
    bcmFieldDropMaskReasonL3DstLookup = 51, /* L3DstLookup */
    bcmFieldDropMaskReasonTunnelDecapEcn = 52, /* TunnelDecapEcn */
    bcmFieldDropMaskReasonL3SrcLookup = 53, /* L3SrcLookup */
    bcmFieldDropMaskReasonFcoeZoneLookupMiss = 54, /* FcoeZoneLookupMiss */
    bcmFieldDropMaskReasonL3TtlError = 55, /* L3TtlError */
    bcmFieldDropMaskReasonL3HdrError = 56, /* L3HdrError */
    bcmFieldDropMaskReasonL2HdrError = 57, /* L2HdrError */
    bcmFieldDropMaskReasonL2RpfCheckFail = 58, /* L2RpfCheckFail */
    bcmFieldDropMaskReasonPfmCheckFail = 59, /* PfmCheckFail */
    bcmFieldDropMaskReasonTagUntagDiscard = 60, /* TagUntagDiscard */
    bcmFieldDropMaskReasonEcmpResolutionError = 61, /* EcmpResolutionError */
    bcmFieldDropMaskReasonStromControlDrop = 62, /* StromControlDrop */
    bcmFieldDropMaskReasonFcoeZoneCheckFail = 63, /* FcoeZoneCheckFail */
    bcmFieldDropMaskReasonMulticastDrop = 64, /* MulticastDrop */
    bcmFieldDropMaskReasonTunnelError = 65, /* TunnelError */
    bcmFieldDropMaskReasonNextHopDrop = 66, /* NextHopDrop */
    bcmFieldDropMaskReasonUrpfCheckFail = 67, /* UrpfCheckFail */
    bcmFieldDropMaskReasonNatDrop = 68, /* NatDrop */
    bcmFieldDropMaskReasonProtectionDataDrop = 69, /* ProtectionDataDrop */
    bcmFieldDropMaskReasonFieldStageLookupDrop = 70, /* FieldStageLookupDrop */
    bcmFieldDropMaskReasonInterfaceClassMplsLookup1Miss = 71, /* InterfaceClassMplsLookup1Miss */
    bcmFieldDropMaskReasonInterfaceClassMplsLookup2Miss = 72, /* InterfaceClassMplsLookup2Miss */
    bcmFieldDropMaskReasonInterfaceClassMplsLookup3Miss = 73, /* InterfaceClassMplsLookup3Miss */
    bcmFieldDropMaskReasonInterfaceClassL3TunnelMiss = 74, /* InterfaceClassL3TunnelMiss */
    bcmFieldDropMaskReasonLastCount = 75 /* Always last. Not to be used. */
} bcm_field_drop_mask_reason_t;

/* Field Drop reason mask bitmap */
typedef struct bcm_field_drop_mask_reason_bmp_s {
    SHR_BITDCL w[_SHR_BITDCLSIZE(bcmFieldDropMaskReasonLastCount)]; 
} bcm_field_drop_mask_reason_bmp_t;

#define BCM_FIELD_DROP_MASK_BMP_ADD(drop_mask_set, q)  SHR_BITSET(((drop_mask_set).w), (q)) 

#define BCM_FIELD_DROP_MASK_BMP_REMOVE(drop_mask_set, q)  SHR_BITCLR(((drop_mask_set).w), (q)) 

#define BCM_FIELD_DROP_MASK_BMP_TEST(drop_mask_set, q)  SHR_BITGET(((drop_mask_set).w), (q)) 

#define BCM_FIELD_DROP_MASK_BMP_INIT(drop_mask_set)  \
    sal_memset(&(drop_mask_set), 0, sizeof(bcm_field_drop_mask_reason_bmp_t)) 

/* Field Control Config */
typedef struct bcm_field_control_config_s {
    uint32 flags;                       /* flags. */
    bcm_field_drop_mask_control_profile_t profile; /* Drop Mask Profile */
    bcm_field_drop_mask_reason_bmp_t drop_mask_set; /* Drop Mask Reason Bitmap */
    uint32 state;                       /* Value needed to be configured for
                                           Field Control. */
} bcm_field_control_config_t;

/* bcm_field_compression_map_type_e */
typedef enum bcm_field_compression_map_type_e {
    bcmFieldCompressionDirectMapTypeTtl = 0, /* Compression type TTL to match
                                           qualifier bcmFieldQualifyTtl. */
    bcmFieldCompressionDirectMapTypeTos = 1, /* Compression type to match qualifier
                                           bcmFieldQualifyTosLower4Bits. */
    bcmFieldCompressionDirectMapTypeTcp = 2, /* Compression type TCP flags to match
                                           qualifier bcmFieldQualifyTcpControl */
    bcmFieldCompressionIndexMapTypeEthertype = 3, /* Compression type Ethertype to match
                                           qualifier bcmFieldQualifyEtherType. */
    bcmFieldCompressionIndexMapTypeIpProtocol = 4, /* Compression type IP Protocol to match
                                           qualifier
                                           bcmFieldQualifyExtensionHeaderType. */
    bcmFieldCompressionDirectMapTypeTtlZero = 5, /* Compression type TTL to match
                                           qualifier
                                           bcmFieldQualifyTtlClassZero. */
    bcmFieldCompressionDirectMapTypeTtlOne = 6, /* Compression type TTL to match
                                           qualifier bcmFieldQualifyTtlClassOne. */
    bcmFieldCompressionDirectMapTypeTosZero = 7, /* Compression type to match qualifier
                                           bcmFieldQualifyTosClassZero. */
    bcmFieldCompressionDirectMapTypeTosOne = 8, /* Compression type to match qualifier
                                           bcmFieldQualifyTosClassOne. */
    bcmFieldCompressionDirectMapTypeTcpZero = 9, /* Compression type TCP flags to match
                                           qualifier bcmFieldQualifyTcpClassZero */
    bcmFieldCompressionDirectMapTypeTcpOne = 10, /* Compression type TCP flags to match
                                           qualifier bcmFieldQualifyTcpClassOne */
    bcmFieldCompressionDirectMapTypeIpTunnelTtl = 11, /* Compression type Tunnel TTL to match
                                           qualifier bcmFieldQualifyIpTunnelTtl. */
    bcmFieldCompressionDirectMapTypeIpProtocol = 12, /* Compression type IP Protocol to match
                                           qualifier
                                           bcmFieldQualifyIpProtocolClass. */
    bcmFieldCompressionDirectMapTypeL4SrcPort = 13, /* Compression Type for L4SrcPort Class
                                           ID for qualifier
                                           bcmFieldQualifyL4SrcPortClass. */
    bcmFieldCompressionDirectMapTypeL4DstPort = 14, /* Compression Type for L4DstPort Class
                                           ID for qualifier
                                           bcmFieldQualifyL4DstPortClass. */
    bcmFieldCompressionLastMapTypeCount = 15 /* Always Last. Not a usable value. */
} bcm_field_compression_map_type_t;

#define BCM_FIELD_COMPRESSION_TYPE \
{ \
    "DirectMapTypeTtl", \
    "DirectMapTypeTos", \
    "DirectMapTypeTcp", \
    "IndexMapTypeEthertype", \
    "IndexMapTypeIpProtocol", \
    "DirectMapTypeTtlZero", \
    "DirectMapTypeTtlOne", \
    "DirectMapTypeTosZero", \
    "DirectMapTypeTosOne", \
    "DirectMapTypeTcpZero", \
    "DirectMapTypeTcpOne", \
    "DirectMapTypeIpTunnelTtl", \
    "DirectMapTypeIpProtocol", \
    "DirectMapTypeL4SrcPort", \
    "DirectMapTypeL4DstPort"  \
}

#ifndef BCM_HIDE_DISPATCHABLE

/* 
 * Set match criteria for IntFlags
 *                qualifier.
 */
extern int bcm_field_qualify_IntFlags(
    int unit, 
    bcm_field_entry_t entry, 
    uint8 data, 
    uint8 mask);
...
/* 
 * Get match criteria for IntFlags
 *                qualifier.
 */
extern int bcm_field_qualify_IntFlags_get(
    int unit, 
    bcm_field_entry_t entry, 
    uint8 *data, 
    uint8 *mask);
...
/* 
 * Set match criteria for IntUdpChecksumEqualsZero
 *                qualifier.
 */
extern int bcm_field_qualify_IntUdpChecksumEqualsZero(
    int unit, 
    bcm_field_entry_t entry, 
    uint8 data, 
    uint8 mask);
...
/* 
 * Get match criteria for IntUdpChecksumEqualsZero
 *                qualifier.
 */
extern int bcm_field_qualify_IntUdpChecksumEqualsZero_get(
    int unit, 
    bcm_field_entry_t entry, 
    uint8 *data, 
    uint8 *mask);
...
/* 
 * Set match criteria for IntMetadataHdrType
 *                qualifier.
 */
extern int bcm_field_qualify_IntMetadataHdrType(
    int unit, 
    bcm_field_entry_t entry, 
    uint8 data, 
    uint8 mask);
...
/* 
 * Get match criteria for IntMetadataHdrType
 *                qualifier.
 */
extern int bcm_field_qualify_IntMetadataHdrType_get(
    int unit, 
    bcm_field_entry_t entry, 
    uint8 *data, 
    uint8 *mask);
...
/* 
 * Set match criteria for CompressionDstHit
 *                qualifier.
 */
extern int bcm_field_qualify_CompressionDstHit(
    int unit, 
    bcm_field_entry_t entry, 
    uint8 data, 
    uint8 mask);
...
/* 
 * Get match criteria for CompressionDstHit
 *                qualifier.
 */
extern int bcm_field_qualify_CompressionDstHit_get(
    int unit, 
    bcm_field_entry_t entry, 
    uint8 *data, 
    uint8 *mask);
...
/* 
 * Set match criteria for CompressionSrcHit
 *                qualifier.
 */
extern int bcm_field_qualify_CompressionSrcHit(
    int unit, 
    bcm_field_entry_t entry, 
    uint8 data, 
    uint8 mask);
...
/* 
 * Get match criteria for CompressionSrcHit
 *                qualifier.
 */
extern int bcm_field_qualify_CompressionSrcHit_get(
    int unit, 
    bcm_field_entry_t entry, 
    uint8 *data, 
    uint8 *mask);
...
typedef enum bcm_field_IntHdr_Location_e {
    bcmfieldIntHdrLocationInner = 0,    /* INT header location is inner payload. */
    bcmfieldIntHdrLocationOuter = 1,    /* INT header location is outer payload. */
    bcmfieldIntHdrLocationBoth = 2,     /* INT header location is both inner and
                                           outer payload. */
    bcmfieldIntHdrLocationCount = 3     /* Always Last. Not a usable value. */
} bcm_field_IntHdr_Location_t;

#define BCM_FIELD_INT_HEADER_LOCATION \
{ \
    "bcmfieldIntHdrLocationInner", \
    "bcmfieldIntHdrLocationOuter", \
    "bcmfieldIntHdrLocationBoth"  \
}

/* bcm_field_IntHdr_Type_e */
typedef enum bcm_field_IntHdr_Type_e {
    bcmfieldIntHdrTypeNone = 0,     /* INT header type NONE. */
    bcmfieldIntHdrTypeINTDP = 1,    /* INT header type INT_DP. */
    bcmfieldIntHdrTypeIFA = 2,      /* INT header type IFA. */
    bcmfieldIntHdrTypeIOAM = 3,     /* INT header type IOAM. */
    bcmfieldIntHdrTypeCount = 4     /* Always Last. Not a usable value. */
} bcm_field_IntHdr_Type_t;

#define BCM_FIELD_INT_HEADER_TYPE \
{ \
    "bcmfieldIntHdrTypeNone", \
    "bcmfieldIntHdrTypeINTDP", \
    "bcmfieldIntHdrTypeIFA", \
    "bcmfieldIntHdrTypeIOAM"  \
}

#ifndef BCM_HIDE_DISPATCHABLE

/* 
 * Set match criteria for IntHdrType
 *                qualifier.
 */
extern int bcm_field_qualify_IntHdrType(
    int unit, 
    bcm_field_entry_t entry, 
    bcm_field_IntHdr_Type_t int_type);

/* 
 * Get match criteria for IntHdrType
 *                qualifier.
 */
extern int bcm_field_qualify_IntHdrType_get(
    int unit, 
    bcm_field_entry_t entry, 
    bcm_field_IntHdr_Type_t *int_type);

/* 
 * Set match criteria for IntHdrPresent
 *                qualifier.
 */
extern int bcm_field_qualify_IntHdrPresent(
    int unit, 
    bcm_field_entry_t entry, 
    bcm_field_IntHdr_Location_t int_type);

/* 
 * Get match criteria for IntHdrPresent
 *                qualifier.
 */
extern int bcm_field_qualify_IntHdrPresent_get(
    int unit, 
    bcm_field_entry_t entry, 
    bcm_field_IntHdr_Location_t *int_type);
...
typedef enum bcm_field_pkt_misc_ctrl_e {
    bcmFieldPktMiscCtrlNone = 0,        /* No operation */
    bcmFieldPktMiscCtrlGoodIpPkt = 1,   /* Good IP packet. */
    bcmFieldPktMiscCtrlNotGoodIpPkt = 2, /* Not Good IP packet. */
    bcmFieldPktMiscCtrlBpduPkt = 3,     /* BPDU packet. */
    bcmFieldPktMiscCtrlNotBpduPkt = 4,  /* Not BPDU packet. */
    bcmFieldPktMiscCtrlPimBidirPkt = 5, /* PIM Bidirectional Flow. */
    bcmFieldPktMiscCtrlNotPimBidirPkt = 6, /* Not PIM Bidirectional Flow. */
    bcmFieldPktMiscCtrlHiGig3MirrorPkt = 7, /* HiGig3 Mirror Packet. */
    bcmFieldPktMiscCtrlNotHiGig3MirrorPkt = 8, /* Not HiGig3 Mirror Packet. */
    bcmFieldPktMiscCtrlLastCount = 9    /* Always Last. Not a usable value. */
} bcm_field_pkt_misc_ctrl_t;

/* Macros for VLAN Tag Preserve */
#define BCM_FIELD_OUTER_VLAN_TAG_PRESERVE   (1 << 0)   /* Preserve Outer VLAN
                                                          Tag */
#define BCM_FIELD_INNER_VLAN_TAG_PRESERVE   (1 << 1)   /* Preserve Inner VLAN
                                                          Tag */

/* 
 * Structure holds a qualifier to be qualified upon as part of the entry
 * in the field flush machine TCAM.
 */
typedef struct bcm_field_flush_entry_qual_s {
    bcm_field_qualify_t type;           /* Qualifier type. */
    uint32 value[BCM_FIELD_QUAL_WIDTH_IN_WORDS]; /* Set value for qualify (lookup key). */
    uint32 mask[BCM_FIELD_QUAL_WIDTH_IN_WORDS]; /* Mask value that dictates which of the
                                           value bits are relevant for lookup. */
} bcm_field_flush_entry_qual_t;

/* 
 *  Structure holds an action to be qualified upon as part of the entry
 * in the field flush machine TCAM, or to be modified as part of the
 * payload.
 */
typedef struct bcm_field_flush_entry_action_s {
    bcm_field_action_t type;            /* Action type. */
    uint32 value[BCM_FIELD_ACTION_WIDTH_IN_WORDS]; /* Set value for action (lookup key) or
                                           new value to be modified (in
                                           payload). */
    uint32 mask[BCM_FIELD_ACTION_WIDTH_IN_WORDS]; /* Mask that dictates which of the value
                                           bits are relevant for lookup, (in
                                           key) or to be changed (in action). */
    uint8 valid_bit_value;              /* What value of valid bit to expect in
                                           key or written in payload (if there
                                           is a valid bit for the action). */
    uint8 valid_bit_mask;               /* Whether to qualify upon the valid bit
                                           value in key or whether to change the
                                           valid bit in payload (if there is a
                                           valid bit for the action). */
} bcm_field_flush_entry_action_t;

/* Structure holds flush profile information. */
typedef struct bcm_field_flush_profile_info_s {
    uint32 high_threshold_value;    /* when age-counter is higher than this
                                       threshold, flow is considered as High
                                       Flow */
    uint32 low_threshold_value;     /* when age-counter is lower than this
                                       threshold, flow is considered as Low Flow */
    uint32 increment_value;         /* the age-counter increment value */
    uint32 decrement_value;         /* the age-counter decrement value */
    uint32 maximal_value;           /* the age-counter maximum value
                                       (age-counter upper limit value) */
    uint32 out_value;               /* the age-counter age-out value
                                       (age-counter value for deleting an entry
                                       from database) */
    uint32 init_value;              /* age-counter initial value for new entry */
} bcm_field_flush_profile_info_t;

/* Structure holds flush entry key to qualify upon. */
typedef struct bcm_field_flush_entry_key_s {
    int nof_entry_quals;                /* Number of valid qualifiers in the
                                           flush rule Field entry. */
    bcm_field_flush_entry_qual_t entry_qual[BCM_FIELD_NUMBER_OF_QUALS_PER_GROUP]; /* Entry qualifiers info including type,
                                           value, and mask, used to qualify upon
                                           what entry was hit. */
    int nof_entry_actions;              /* Number of valid actions in the flush
                                           rule Field entry. */
    bcm_field_flush_entry_action_t entry_action[BCM_FIELD_NUMBER_OF_ACTIONS_PER_GROUP]; /* Entry actions info including type,
                                           value, and mask, used to qualify upon
                                           what entry was hit. */
    uint8 hit;                          /* the hit value. */
    uint8 hit_mask;                     /* the mask to be applied on hit field. */
} bcm_field_flush_entry_key_t;

/* Structure holds flush action information. */
typedef struct bcm_field_flush_entry_payload_s {
    uint8 hit_clear_cmd;                /* Clear hit bit of the entry. */
    uint8 delete_cmd;                   /* Remove the entry. */
    uint8 transplant_cmd;               /* Edit the entry. */
    int nof_entry_actions;              /* Number of valid actions in the flush
                                           action Field entry. */
    bcm_field_flush_entry_action_t entry_action[BCM_FIELD_NUMBER_OF_ACTIONS_PER_GROUP]; /* Entry actions info including type,
                                           value to be changed (by mask).
                                           Relevant if transplant is true. */
} bcm_field_flush_entry_payload_t;

/* Structure holds flush entry information. */
typedef struct bcm_field_flush_entry_info_s {
    bcm_field_flush_entry_key_t key;    /* Flush entry key to be compared by the
                                           TCAM. */
    bcm_field_flush_entry_payload_t payload; /* Flush entry payload for actions to be
                                           performed, including changing the
                                           payload of the EXEM entry. */
} bcm_field_flush_entry_info_t;

#ifndef BCM_HIDE_DISPATCHABLE

/* 
 * This function allocates a flush profile, sets it and installs it to
 * HW.
 */
extern int bcm_field_flush_profile_create(
    int unit, 
    uint32 flags, 
...
extern int bcm_field_flush_profile_get(
    int unit, 
    uint32 flags, 
    uint32 flush_profile_id, 
    bcm_field_flush_profile_info_t *flush_profile_info);
...
/* 
 * This function de-allocates a flush profile and sets the HW back to
 * default values.
 */
extern int bcm_field_flush_profile_destroy(
    int unit, 
    uint32 flags, 
    uint32 flush_profile_id);

/* This function attaches a field-group to a flush profile. */
extern int bcm_field_flush_profile_attach(
    int unit, 
    uint32 flags, 
    bcm_field_group_t fg_id, 
    uint32 flush_profile_id);
...
/* 
 * This function creates, sets and installs to HW a single flush machine
 * entry (rule and action) for a specific field group.
 */
extern int bcm_field_flush_entry_add(
    int unit, 
    uint32 flags, 
    bcm_field_group_t fg_id, 
    int entry_id, 
...
/* 
 * Gets the a single flush machine entry (rule and action) for a specific
 * field group.
 */
extern int bcm_field_flush_entry_get(
    int unit, 
    uint32 flags, 
    bcm_field_group_t fg_id, 
    int entry_id, 
...
/* 
 * Clears a single flush machine entry (rule and action) for a specific
 * field group.
 */
extern int bcm_field_flush_entry_delete(
    int unit, 
    uint32 flags, 
    bcm_field_group_t fg_id, 
    int entry_id);
...
extern void bcm_field_flush_entry_info_t_init(
    bcm_field_flush_entry_info_t *flush_entry_info);

/* Initialize the field flush profile structure. */
extern void bcm_field_flush_profile_info_t_init(
    bcm_field_flush_profile_info_t *flush_profile_info);

#ifndef BCM_HIDE_DISPATCHABLE

/* Fetch qset details for a mode and packet type. */
extern int bcm_field_group_mode_qset_get(
    int unit, 
...
/* 
 * bcm_field_mirror_encap_ctrl_type_e.
 * Used to specify the mirror encap type in
 * bcm_field_qualify_MirrorEncapCtrlType for qualifier
 * bcmFieldQualifyMirrorEncapCtrlType.
 */
typedef enum bcm_field_mirror_encap_ctrl_type_e {
    bcmFieldMirrorEncapCtrlTypeWithoutEncap = 0, /* No Encap. */
    bcmFieldMirrorEncapCtrlTypeWithEncap = 1, /* With Encap for eg. ERSPAN, SFLOW,
                                           VXLAN, PSAMP etc. */
    bcmFieldMirrorEncapCtrlTypeInsertRspan = 2, /* With Insert RSPAN Encap. */
    bcmFieldMirrorEncapCtrlTypeEncapErspan1 = 3, /* With ERSPANv1 Encap. In case of Vxlan
                                           flow both ERSPAN and VXLAN header are
                                           added by mirror profile limited to
                                           max encap size of 80b. */
    bcmFieldMirrorEncapCtrlTypeEncapPsamp = 4, /* With PSAMP Encap. */
    bcmFieldMirrorEncapCtrlTypeEncapSflow = 5, /* With SFLOW Encap. */
    bcmFieldMirrorEncapCtrlTypeEncapErspan3 = 6, /* With ERSPANv3 Encap. */
    bcmFieldMirrorEncapCtrlTypeEncapMoD = 7, /* With MoD Encap. */
    bcmFieldMirrorEncapCtrlTypeEncapVxlan = 8, /* With VXLAN Encap. Used only in case
                                           of VXLAN IPv6 encap with GSH Header
                                           as max encap size reaches 82b.
                                           For all other VXLAN flow cases
                                           MirrorEncapCtrlTypeErspan1 should be
                                           used. */
    bcmFieldMirrorEncapCtrlTypeEncapMoDv2 = 9, /* With MoDV2 Encap. */
    bcmFieldMirrorEncapCtrlTypeNoEncapLoopbackPort = 10, /* No Encap Loopback Port. */
    bcmFieldMirrorEncapCtrlTypeInsertIfa1Probe = 11, /* With Insert IFA1 Probe Encap. */
    bcmFieldMirrorEncapCtrlTypeEncapIfaLoopback = 12, /* With IFA Loopback Encap. */
    bcmFieldMirrorEncapCtrlTypeEncapIfaL3Tunnel = 13, /* With IFA L3 Tunnel Encap. */
    bcmFieldMirrorEncapCtrlTypeCount = 14 /* Always Last. Not a usable value. */
} bcm_field_mirror_encap_ctrl_type_t;

#define BCM_FIELD_MIRROR_ENCAP_CTRL_TYPE_STRINGS \
{ \
    "WithoutEncap", \
    "WithEncap", \
    "InsertRspan", \
...
typedef enum bcm_field_svtag_pkt_type_e {
    bcmFieldSvtagPktTypeNonMacSec = 0,  /* Unsecure data packet (Untag Control
                                           Port packet) */
    bcmFieldSvtagPktTypeMacSec = 1,     /* Secure data packet (Tag Controlled
                                           Port packet) */
    bcmFieldSvtagPktTypeKaYFrames = 2,  /* KaY Frame (KaY Uncontrolled Port
                                           packet) */
    bcmFieldSvtagPktTypeNonKaYFrames = 3, /* Management packet (non-KaY
                                           Uncontrolled Port packet) */
    bcmFieldSvtagPktTypeIKEFrames = 4,  /* IKE Frame (IKE Uncontrolled Port
                                           packet) */
    bcmFieldSvtagPktTypeNonIKEFrames = 5, /* Management packet (non-IKE
                                           Uncontrolled Port packet) */
    bcmFieldSvtagPktTypeCount = 6       /* Always last. Not to be used. */
} bcm_field_svtag_pkt_type_t;

/* Macros for ETAG Actions */
#define BCM_FIELD_ETAG_ACTION_PE_CB_FLOW    (1 << 0)   /* ETAG Action PE CB Flow */
#define BCM_FIELD_ETAG_ACTION_DELETE        (1 << 1)   /* ETAG Action ETAG
                                                          Delete */
#define BCM_FIELD_ETAG_ACTION_ADD           (1 << 2)   /* ETAG Action ETAG Add */
