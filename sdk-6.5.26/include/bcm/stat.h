...
typedef enum bcm_custom_stat_trigger_e {
    ...
    bcmDbgCntRxStatefulModSecondPassDrop = 218, /* Rx: Enable to count switch copies
                                           ...
                                           stateful MOD. */
    bcmDbgCntRxGshDrop = 219,           /* Rx: Enable to count packets dropped
                                           due to the drop configuration on GSH
                                           packets. */
    bcmDbgCntRxNonGshDrop = 220,        /* Rx: Enable to count packets dropped
...
typedef struct bcm_stat_counter_value_s {
    ...
    uint64 rate;    /* Fill rate of one statistic mbps */
