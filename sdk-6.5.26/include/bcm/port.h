...
typedef struct bcm_port_interface_info_s {
    ...
    uint32 flags;               /* flags for interface info. */
...
typedef struct bcm_port_mapping_info_s {
    ...
    uint32 in_tm_port;          /* in tm port id */
    uint32 pp_dsp;              /* pp dsp id */
    uint32 out_tm_port;         /* out tm port id */
    uint32 in_channel;          /* logical port in channel. */
    uint32 out_channel;         /* logical port out_channel. */
    bcm_port_t forward_port;    /* Forward logical port, applicable to
                                   mirror_rcy ports only. */
    uint32 flags;               /* flags for mapping info. */
...
#define BCM_PORT_IF_OTN                     _SHR_PORT_IF_OTN 
...
#define BCM_PORT_ADD_STIF_AND_DATA_PORT     0x800000   /* Indicate it is a
                                                          ...
                                                          capabilities */
#define BCM_PORT_ADD_STAT_ONLY              0x1000000  /* Indicate it is a port
                                                          for FLEX MAC statistic
                                                          only */
#define BCM_PORT_ADD_FLR_FIRMWARE_SUPPORT   0x2000000  /* Indicate Fast Link
                                                          Recovery firmware is
                                                          supported for the port */
#define BCM_PORT_ADD_MC_PORT                0x4000000  /* Indicate added port is
                                                          for MC traffic */
#define BCM_PORT_ADD_IF_FRAMER_MGMT         0x8000000  /* Indicate the interface
                                                          is used for framer
                                                          overhead/oam/PTP
                                                          interface */
#define BCM_PORT_ADD_OTN_SAR                0x10000000 /* Indicate the SAR port
                                                          is only for OTN */
#define BCM_PORT_ADD_TXPI_MODE_EXT          0x20000000 /* Indicate the TXPI mode
                                                          is external mode */
#define BCM_PORT_ADD_FRAME_PREEMPTABLE      0x40000000 /* Enable frame
                                                          preemption on the port */
#define BCM_PORT_ADD_FLEXE_UNAWARE          0x80000000 /* Indicate it is a port
                                                          for FlexE unaware
                                                          interface */

/* Port add flags for bcm_port_interface_info_t. */
#define BCM_PORT_ADD_FLEXE_PROTECTION   0x1        /* Indicate this port is only
                                                      for protection. Relevant
                                                      for FlexE MAC client only */
...
typedef enum bcm_port_pcs_e {
    ...
    bcmPortPCS256b257b15T1xNRsFec = 9, 
    bcmPortPCS256b257b15T2xNRsFec = 10 
} bcm_port_pcs_t;
...
/* bcm_port_force_vlan_config_s */
typedef struct bcm_port_force_vlan_config_s {
    bcm_port_t port;    /* Port number. */
    bcm_vlan_t vlan;    /* VLAN identifier. */
    uint32 flags;       /* BCM_PORT_FORCE_VLAN_xxx. */
} bcm_port_force_vlan_config_t;

/* Initialize a Force VLAN Configuration structure. */
extern void bcm_port_force_vlan_config_t_init(
    bcm_port_force_vlan_config_t *config);

#ifndef BCM_HIDE_DISPATCHABLE

/* Set/Get force VLAN attribute. */
extern int bcm_port_force_vlan_config_set(
    int unit, 
    bcm_port_force_vlan_config_t *config);

/* Set/Get force VLAN attribute. */
extern int bcm_port_force_vlan_config_get(
    int unit, 
    bcm_port_force_vlan_config_t *config);
...
/* Read or write PHY registers associated with a port. */
extern int bcm_port_phy_multicast_set(
    int unit, 
    bcm_port_t port, 
    uint32 mdio_buses, 
    uint32 flags, 
...
/* PHY PCS scramble mode */
#define BCM_PORT_PHY_SCRAMBLE_OFF       _SHR_PORT_PHY_SCRAMBLE_OFF 
#define BCM_PORT_PHY_SCRAMBLE_ON        _SHR_PORT_PHY_SCRAMBLE_ON 
#define BCM_PORT_PHY_SCRAMBLE_DEFAULT   _SHR_PORT_PHY_SCRAMBLE_DEFAULT 
...
typedef enum bcm_port_tag_struct_type_e {
    ...
    bcmTagStructTypeSPrioTag = 7,   /* Type S prio tag */
    bcmNofTagStructType = 8         /* Number of tag structure types */
...
typedef enum bcm_port_class_e {
    ...
    bcmPortClassFieldEgressTrafficManagementPort = 36, /* Class for traffic management
                                           processing port in Field stage ePMF */
    bcmPortClassFieldEgressTrafficManagementPortCs = 37, /* Context selection class for traffic
                                           management processing port in Field
                                           stage ePMF */
    bcmPortClassFieldExternalTrafficManagementPortCs = 38, /* Context selection class for traffic
                                           management port in Field stage
                                           external */
    bcmPortClassFieldIngressPMF1PacketProcessingPortGeneralData = 39, /* Extra constant to assign to a packet
                                           processing port, up to 32lsb. Field
                                           stage iPMF1. */
    bcmPortClassFieldIngressPMF1PacketProcessingPortGeneralDataHigh = 40, /* Extra constant to assign to a packet
                                           processing port, beyond the first 32
                                           bits. Field stage iPMF1. */
    bcmPortClassFieldIngressPMF3PacketProcessingPortGeneralData = 41, /* Extra constant to assign to a packet
                                           processing port, first 32 bits. Field
                                           stage iPMF3. */
    bcmPortClassFieldIngressPMF3PacketProcessingPortGeneralDataHigh = 42, /* Extra constant to assign to a packet
                                           processing port, beyond the first 32
                                           bits. Field stage iPMF3. */
    bcmPortClassOpaqueCtrlId = 43,      /* Opaque control ID available for IFP
                                           key selection */
    bcmPortClassEgressOpaqueCtrlId = 44, /* Opaque control ID available for EFP
                                           key selection */
    bcmPortClassOpaqueCtrlId1 = 45,     /* Opaque control ID available for VFP
                                           key selection */
    bcmPortClassOpaqueCtrlId2 = 46,     /* Opaque control ID A for flex digest
                                           and VFP key selection. */
    bcmPortClassOpaqueCtrlId3 = 47,     /* Opaque control ID B for flex digest
                                           and VFP key selection. */
    bcmPortClassMplsForwardIngress = 48, /* Class for ingress MPLS forwarding */
    bcmPortClassFieldEgressVportCs = 49, /* Context selection class for LIF
                                           encoded as Gport in the Field stage
                                           ePMF */
    bcmPortClassI2EOpaqueObj0 = 50,     /* Ingress opaque object 0 passed to
                                           egress pipeline. */
    bcmPortClassCount = 51              /* Last enum value. */
} bcm_port_class_t;
...
typedef enum bcm_port_control_e {
    ...
    bcmPortControlDataRate = 430,       /* Retrieve port's data rate instead of
                                           lane rate, for get API only. */
    bcmPortControlMplsLabelDeleteAllEnable = 431, /* Enable removal of all MPLS labels on
                                           the ingress port */
    bcmPortControlFlowCountClassId = 432, /* Set flow count class ID to calculate
                                           port context for flex counter index
                                           derivation. */
    bcmPortControlIbch1Enable = 433,    /* Enable or disable Ibch1 header on
                                           ingress port */
    bcmPortControlStartTxThreshold = 434, /* Configure start Tx on port Tx MLF.
                                           Please consult with BRCM before
                                           changing this value. */
    bcmPortControlSaMulticastEnable = 435, /* Enable or disable SA multicast trap
                                           on ingress port. */
    bcmPortControlLinkFaultLocalForce = 436, /* Force local fault in LSS message */
    bcmPortControlLinkFaultRemoteForce = 437, /* Force Remote fault in LSS message */
    bcmPortControlMacTxOnLoopback = 438, /* Enable or disable leak traffic on MAC
                                           loopback port */
    bcmPortControlIpFixRxEnable = 439,  /*  Enable IPFIX on Collector RX port */
    bcmPortControlIpmcL3IngressLookup = 440, /* Enable to include L3 ingress
                                           interface as part of the key when
                                           searching IPMC route table. */
    bcmPortControlStatEventToCpu = 441, /* Enable copying stat events to CPU. */
    bcmPortControlExtenderSvpAssignKeySelection = 442, /* Key selection for extender port SVP
                                           assignment. */
    bcmPortControlSarJitterToleranceLevel = 443, /* The tolerance level for SAR Jitter
                                           FIFO in SAR Rx. Each level will
                                           increase ~3us Jitter tolerance. The
                                           SAR packet latency will also be
                                           increased if increasing this level. */
    bcmPortControlSrv6Enable = 444,     /* Enable SRv6 protocol for the port. */
    bcmPortControlIngInnerTpidEnable = 445, /* Enable/Disable ingress Inner TPID
                                           comparison checks. Enabled by
                                           default. */
    bcmPortControlIngOuterTpidEnable = 446, /* Enable/Disable check to allow ingress
                                           outer TPID values at given TPID
                                           indices . TPID indices 0 to 3 are
                                           valid.
                                           Default value :1  to allow ingress
                                           outer TPID values at TPID index 0. */
    bcmPortControlEgrInnerTpidEnable = 447, /* Enable/Disable egress Inner TPID
                                           comparison checks. Enabled by
                                           default. */
    bcmPortControlEgrOuterTpidEnable = 448, /* Enable/Disable check to allow egress
                                           outer TPID values at given TPID
                                           indices . TPID indices 0 to 3 are
                                           valid.
                                           Default value :1  to allow egress
                                           outer TPID values at TPID index 0. */
    bcmPortControlPortmodLinkRecoveryEnable = 449, /* Enable/Disable portmod link recovery
                                           workaround. Disabled by default. */
    bcmPortControlSignalQualityErDegradeThreshold = 450, /* Signal quality degrade threshold */
    bcmPortControlSignalQualityErDegradeRecoverThreshold = 451, /* Signal quality degrade recover
                                           threshold */
    bcmPortControlSignalQualityErFailThreshold = 452, /* Signal quality fail threshold */
    bcmPortControlSignalQualityErFailRecoverThreshold = 453, /* Signal quality fail recover threshold */
    bcmPortControlSignalQualityErMeasureMode = 454, /* Signal quality fail measure mode */
    bcmPortControlSignalQualityErInterval = 455, /* Signal quality sampling interval */
    bcmPortControlSignalQualityErActionEnable = 456, /* Control whether to react by a
                                           specific action to a 'fail threshold'
                                           event */
    bcmPortControlFlexeDeskewAlmTriggerLocalFault = 457, /* Control whether to trigger Local
                                           Fault insertion during FlexE group
                                           deskew alarm */
    bcmPortControlPfcRxStatEnable = 458, /* Enable/disable the gathering of
                                           received PFC statistics on the port */
    bcmPortControlUdf = 459,            /* Enable/disable UDF lookup on the port */
    bcmPortControlFilterIngressExactMatch = 460, /* Enable/disable ingress exact match
                                           Field Processor on the port. */
    bcmPortControlSignalQualityErHoldOffInterval = 461, /* Signal quality hold off interval,
                                           during this interval fail and degrade
                                           recover event will be masked */
    bcmPortControlIngressSampleMode = 462, /* Set ingress sFlow sample mode in
                                           bcm_mirror_sample_mode_t. */
    bcmPortControlL1EthToOtnMapTranscodeType = 463, /* Apply different cl49<->cl82
                                           transcoder configurations for
                                           different OTN map for path L1 ETH ->
                                           OTN map. */
    bcmPortControlOtnMapToL1EthTranscodeType = 464, /* Apply different cl49<->cl82
                                           transcoder configurations for
                                           different OTN map for path OTN map ->
                                           L1 ETH. */
    bcmPortControlSarToIngressCellMode = 465, /* The SAR cell mode from SAR to
                                           ingress. */
    bcmPortControlEgressToSarCellMode = 466, /* The SAR cell mode from Egress to SAR. */
    bcmPortControlL3TunnelTermEnable = 467, /* Enable L3 tunnel termination. */
    bcmPortControlL2GreVpnIdSize = 468, /* Set per port VPNID size(bits) for
                                           L2GRE: 24(default) or 32. */
    bcmPortControlHonorL2SrcDiscardOnStationMove = 469, /* Honor L2 Src Discard in case of
                                           station move. */
    bcmPortControlEpRecircEnable = 470, /* Enable EP recirculation. */
    bcmPortControlFlexHashEnable = 471, /* Enable flexible hash. */
    bcmPortControlTxCrcMode = 472,      /* Set TX CRC mode. */
    bcmPortControlCrcErrorFramesPurge = 473 /* Enable/disable CRC error frames
                                           detection and drop. */
} bcm_port_control_t;

#define BCM_PORT_CONTROL_STR \
    "bcmPortControlBridge", \
    "bcmPortControlTrunkHashSet", \
    "bcmPortControlFabricTrunkHashSet", \
    "bcmPortControlECMPHashSet", \
    "bcmPortControlLoadBalanceHashSet", \
    "bcmPortControlLoadBalancingNumber", \
    "bcmPortControlErrorSymbolDetect", \
    "bcmPortControlErrorSymbolCount", \
    "bcmPortControlIP4", \
    "bcmPortControlIP6", \
    "bcmPortControlIP4Mcast", \
    "bcmPortControlIP6Mcast", \
    "bcmPortControlIP4McastL2", \
    "bcmPortControlIP6McastL2", \
    "bcmPortControlMpls", \
    "bcmPortControlPassControlFrames", \
    "bcmPortControlFilterLookup", \
    "bcmPortControlFilterIngress", \
    "bcmPortControlFilterEgress", \
    "bcmPortControlFrameSpacingStretch", \
    "bcmPortControlPreservePacketPriority", \
    "bcmPortControlLearnClassEnable", \
    "bcmPortControlTrustIncomingVlan", \
    "bcmPortControlDoNotCheckVlan", \
    "bcmPortControlDoNotCheckVlanFromCpu", \
    "bcmPortControlIEEE8021ASEnableIngress", \
    "bcmPortControlIEEE8021ASEnableEgress", \
    "bcmPortControlPrbsMode", \
    "bcmPortControlPrbsPolynomial", \
    "bcmPortControlPrbsTxInvertData", \
    "bcmPortControlPrbsForceTxError", \
    "bcmPortControlPrbsTxEnable", \
    "bcmPortControlPrbsRxEnable", \
    "bcmPortControlPrbsRxStatus", \
    "bcmPortControlSerdesDriverStrength", \
    "bcmPortControlSerdesDriverEqualization", \
    ...
    "bcmPortControlSrcBmacMissToCpu", \
    "bcmPortControlOamLoopback", \
    "bcmPortControlEgressVlanPriUsesPktPri", \
    "", \
    "bcmPortControlPacketFlowMode", \
    "bcmPortControlTrain", \
    "bcmPortControlRxEnable", \
    "bcmPortControlTxEnable", \
    "bcmPortControlRxLink", \
    "bcmPortControlTxLink", \
    "bcmPortControlIpfixRate", \
    "bcmPortControlOAMEnable", \
    "bcmPortControlCustomerQueuing", \
    "bcmPortControlFabricKnockoutId", \
    "bcmPortControlLanes", \
    "bcmPortControlEgressNonUnicastLossless", \
    "bcmPortControlPFCEthertype", \
    "bcmPortControlPFCOpcode", \
    "bcmPortControlPFCReceive", \
    "bcmPortControlPFCTransmit", \
    "bcmPortControlPFCClasses", \
    "bcmPortControlPFCPassFrames", \
    "bcmPortControlPFCDestMacOui", \
    "bcmPortControlPFCDestMacNonOui", \
    "bcmPortControlPFCRefreshTime", \
    "bcmPortControlVrf", \
    "bcmPortControlL3Ingress", \
    "", \
    "bcmPortControlL2Learn", \
    "bcmPortControlL2Move", \
    "bcmPortControlForwardStaticL2MovePkt", \
    "bcmPortControlLinkFaultLocalEnable", \
    "bcmPortControlLinkFaultRemoteEnable", \
    "bcmPortControlLinkFaultLocal", \
    "bcmPortControlLinkFaultRemote", \
    "bcmPortControlTimestampTransmit", \
    "bcmPortControlTimestampEnable", \
    "bcmPortControlTCPriority", \
    "bcmPortControlDropPrecedence", \
    "bcmPortControlFabricQueue", \
    "bcmPortControlLinkdownTransmit", \
    "bcmPortControlEEETransmitWakeTime", \
    "bcmPortControlEEEReceiveWakeTime", \
    "bcmPortControlEEETransmitSleepTime", \
    "bcmPortControlEEEReceiveSleepTime", \
    "bcmPortControlEEETransmitQuietTime", \
    "bcmPortControlEEEReceiveQuietTime", \
    "bcmPortControlEEETransmitRefreshTime", \
    ...
    "bcmPortControlStatOversizeIsError", \
    "bcmPortControlEEEEnable", \
    "bcmPortControlEEEStatisticsClear", \
    ...
    "bcmPortControlEEETransmitIdleTimeHund", \
    "bcmPortControlEEETransmitWakeTimeHund", \
    "bcmPortControlEEETransmitMinLPITime", \
    "bcmPortControlEEETransmitMinLPITimeHund", \
    "bcmPortControlNivAccessVirtualInterfaceId", \
    "bcmPortControlNivNonVntagDrop", \
    "bcmPortControlNivVntagDrop", \
    "bcmPortControlNivNonVntagAdd", \
    "bcmPortControlNivVntagIngressReplace", \
    "bcmPortControlNivVntagEgressReplace", \
    "bcmPortControlNivVntagIngressDelete", \
    "bcmPortControlNivVntagEgressDelete", \
    "bcmPortControlNivRpfCheck", \
    "bcmPortControlNivSourceKnockout", \
    "bcmPortControlNivForwardPort", \
    "bcmPortControlNivType", \
    "bcmPortControlNivNameSpace", \
    "bcmPortControlRemoteCpuEnable", \
    "bcmPortControlRemoteCpuTcMapping", \
    "bcmPortControlArbiterActive", \
    "bcmPortControlArbiterForceDown", \
    "", \
    "bcmPortControlTrill", \
    "bcmPortControlTrillAllow", \
    "bcmPortControlNonTrillAllow", \
    "bcmPortControlTrillCoreISISToCPU", \
    "bcmPortControlTrillHashSelect", \
    "bcmPortControlFabricHeaderFormat", \
    "", \
    "bcmPortControlFabricSourceKnockout", \
    "bcmPortControlFaultResponseLocalDataAndIdle", \
    "bcmPortControlFaultResponseLocalDataAndRf", \
    "bcmPortControlFaultResponseLocalDataAndLf", \
    "bcmPortControlFaultResponseLocalNoDataIdle", \
    "bcmPortControlFaultResponseLocalNoDataRf", \
    "bcmPortControlFaultResponseLocalNoDataLf", \
    "bcmPortControlFaultResponseRemoteDataAndIdle", \
    "bcmPortControlFaultResponseRemoteDataAndRf", \
    "bcmPortControlFaultResponseRemoteDataAndLf", \
    "bcmPortControlFaultResponseRemoteNoDataIdle", \
    "bcmPortControlFaultResponseRemoteNoDataRf", \
    "bcmPortControlFaultResponseRemoteNoDataLf", \
    "bcmPortControlPCS", \
    "bcmPortControlLinkDownPowerOn", \
    "bcmPortControlRegex", \
    "bcmPortControlRegexTcp", \
    "bcmPortControlRegexUdp", \
    "bcmPortControlPonEncryptKeyExpiryTime", \
    "bcmPortControlPonHoldoverState", \
    "bcmPortControlPonHoldoverTime", \
    "bcmPortControlPonMultiLlid", \
    "bcmPortControlPonFecMode", \
    "bcmPortControlPonUserTraffic", \
    "bcmPortControlEthPortAutoNegFailureAlarmState", \
    "bcmPortControlEthPortLosAlarmState", \
    "bcmPortControlEthPortFailureAlarmState", \
    "bcmPortControlEthPortLoopbackAlarmState", \
    "bcmPortControlEthPortCongestionAlarmState", \
    "bcmPortControlMplsEntropyHashSet", \
    "bcmPortControlStripCRC", \
    "bcmPortControlPrivateVlanIsolate", \
    "bcmPortControlFloodUnknownUcastGroup", \
    "bcmPortControlFloodUnknownMcastGroup", \
    "bcmPortControlFloodBroadcastGroup", \
    "bcmPortControlDefaultQueue", \
    "bcmPortControlL2GreEnable", \
    "bcmPortControlL2GreTunnelbasedVpnId", \
    "bcmPortControlL2GreDefaultTunnelEnable", \
    "bcmPortControlL2SaAuthenticaion", \
    "bcmPortControlUnknownMacDaAction", \
    "bcmPortControlDiscardMacSaAction", \
    "bcmPortControlManagementPacketIp6Reserved", \
    "bcmPortControlManagementPacketIp4Reserved", \
    "bcmPortControlManagementPacketLinkConstrained", \
    "bcmPortControlManagementPacketGarp", \
    "bcmPortControlManagementPacketCos", \
    "bcmPortControlManagementPacketColor", \
    "bcmPortControlTaggedL3PacketPktPri", \
    "bcmPortControlTaggedMPLSPacketPktPri", \
    "bcmPortControlTaggedMPLSL3PacketPktPri", \
    "bcmPortControlEEEEventCountSymmetric", \
    "bcmPortControlEEELinkActiveDuration", \
    "bcmPortControlEsmEligibility", \
    "bcmPortControlTrillDesignatedVlan", \
    "bcmPortControlMplsFRREnable", \
    "bcmPortControlMplsContextSpecificLabelEnable", \
    "bcmPortControlVxlanEnable", \
    "bcmPortControlVxlanTunnelbasedVnId", \
    "bcmPortControlVxlanDefaultTunnelEnable", \
    "bcmPortControlFieldEgressClassSelect", \
    "bcmPortControlPonMpcpDiscoveryRate", \
    "bcmPortControlPonMpcpDiscoveryGrantLength", \
    "bcmPortControlPonMpcpOneRegistrationPerGrant", \
    "bcmPortControlPonOamHeartbeatRate", \
    "bcmPortControlPonMaxLinks", \
    "bcmPortControlPonRamanMitigationMode", \
    "bcmPortControlPonLoopTimeMinPropDelay", \
    "bcmPortControlPonLoopTimeMaxPropDelay", \
    "bcmPortControlPonLoopTimeOnuDelay", \
    "bcmPortControlPonLoopTimeNullGrantSize", \
    "bcmPortControlPonLoopTimeOltDelay", \
    "bcmPortControlPonSfecAllowedBitErrors", \
    "bcmPortControlPonTfecAllowedBitErrors", \
    "bcmPortControlPonFecRxBypass", \
    "bcmPortControlPonSyncTime", \
    "bcmPortControlPonEncryptionMode", \
    "bcmPortControlPonEncryptionDirection", \
    "bcmPortControlPonOamKeyExchangeMsgBypass", \
    "bcmPortControlTunnelIdIngressSource", \
    "bcmPortControlTunnelIdEgressAdd", \
    "bcmPortControlPonOamHeartbeatTimeout", \
    "bcmPortControlPonMpcpReportTimeout", \
    "bcmPortControlPon1GDiscoveryWindow", \
    "bcmPortControlPon10GDiscoveryWindow", \
    "bcmPortControlExtendedPortVid", \
    "bcmPortControlNonEtagDrop", \
    "bcmPortControlEtagDrop", \
    "bcmPortControlNonEtagAdd", \
    "bcmPortControlEtagIngressReplace", \
    "bcmPortControlEtagEgressReplace", \
    "bcmPortControlEtagIngressDelete", \
    "bcmPortControlEtagEgressDelete", \
    "bcmPortControlExtenderRpfCheck", \
    "bcmPortControlExtenderSourceKnockout", \
    "bcmPortControlExtenderForwardPort", \
    "bcmPortControlExtenderType", \
    "bcmPortControlExtenderNameSpace", \
    "bcmPortControlEtagPcpDeSelect", \
    "bcmPortControlEtagPcp", \
    "bcmPortControlEtagDe", \
    "bcmPortControlUseEtagPri", \
    "bcmPortControlProhibitedDot1p", \
    "bcmPortControlEgressFilterDisable", \
    "bcmPortControlLLFCReceive", \
    "bcmPortControlLLFCTransmit", \
    "bcmPortControlSAFCReceive", \
    "bcmPortControlSAFCTransmit", \
    "bcmPortControlMacSwap", \
    "", \
    "", \
    "bcmPortControlOverlayRecycle", \
    "bcmPortControlEvbType", \
    "bcmPortControlOamLookupWithDvp", \
    "bcmPortControlSubportTagEnable", \
    "", \
    "", \
    "bcmPortControlVMac", \
    "bcmPortControlEgressModifyDscp", \
    "bcmPortControlFcoeRouteEnable", \
    "bcmPortControlFcoeVftEnable", \
    "bcmPortControlFcoeZoneCheckEnable", \
    "bcmPortControlFcoeSourceBindCheckEnable", \
    "bcmPortControlFcoeFpmaPrefixCheckEnable", \
    "bcmPortControlFcoeDoNotLearn", \
    "bcmPortControlFcoeNetworkPort", \
    "bcmPortControlFcoeFabricSel", \
    "bcmPortControlFcoeFabricId", \
    "bcmPortControlFcoeFabricPri", \
    "bcmPortControlFcoeFcCrcAction", \
    "bcmPortControlFcoeFcCrcRecompute", \
    "bcmPortControlFcoeFcEofIgnore", \
    "bcmPortControlMcastGroupRemap", \
    "bcmPortControlLocalSwitching", \
    "bcmPortControlFecErrorDetectEnable", \
    "bcmPortControlLowLatencyLLFCEnable", \
    "bcmPortControlErspanEnable", \
    "bcmPortControlPFCXOffTime", \
    "bcmPortControlOamDefaultProfile", \
    "bcmPortControlSubportPktTagDrop", \
    "bcmPortControlNoSubportPktTagDrop", \
    "bcmPortControlUseSubportPktTagPri", \
    "bcmPortControlVlanVpGroupEgress", \
    "bcmPortControlVlanVpGroupIngress", \
    "bcmPortControlEEEMode", \
    "bcmPortControlProbeSerdesReset", \
    "bcmPortControlIPMC4Ucast", \
    "bcmPortControlIPMC6Ucast", \
    "bcmPortControlWredDropCountUpdateEnableQueueMask", \
    "bcmPortControlWredDropCountUpdateEnableColorMask", \
    "bcmPortControlReserved280", \
    "bcmPortControlReserved281", \
    "bcmPortControlRxFastLOS", \
    "bcmPortControlFcoeTranslateKeyFirst", \
    "bcmPortControlFcoeTranslateKeySecond", \
    "bcmPortControlMmuDrain", \
    "bcmPortControlMmuTrafficEnable", \
    "bcmPortControlStatCollectionEnable", \
    "bcmPortControlLlfcCellsCongestionIndEnable", \
    "bcmPortControlTrunkLoadBalancingRandomizer", \
    "bcmPortControlECMPLevel1LoadBalancingRandomizer", \
    "bcmPortControlECMPLevel2LoadBalancingRandomizer", \
    "bcmPortControlMplsExplicitNullEnable", \
    "bcmPortControlExtenderEnable", \
    "bcmPortControlSubportTagSize", \
    "bcmPortControlSystemPortOverride", \
    "bcmPortControlOamDefaultProfileEgress", \
    "bcmPortControlPadToSize", \
    "bcmPortControlVxlanVpnAssignmentCriteria", \
    "bcmPortControlVxlanTerminationMatchCriteria", \
    "bcmPortControlVxlanGportAssignmentCriteria", \
    "bcmPortControlOOBFCTxReportIngEnable", \
    "bcmPortControlOOBFCTxReportEgrEnable", \
    "bcmPortControlMplsEncapsulateExtendedLabel", \
    "bcmPortControlSampleIngressDest", \
    "bcmPortControlSampleFlexDest", \
    "bcmPortControlSampleFlexRate", \
    "bcmPortControlExternalBufferEnable", \
    "bcmPortControlTrustMimlPri", \
    "bcmPortControlTrustCustomHeaderPri", \
    "bcmPortControlCustomHeaderEncapEnable", \
    "bcmPortControlLinkPhyEnable", \
    "bcmPortControlOlpEnable", \
    "bcmPortControlPortMacOui", \
    "bcmPortControlPortMacNonOui", \
    "bcmPortControlSatEnable", \
    "bcmPortControl1588P2PDelay", \
    "bcmPortControlSampleIngressEnable", \
    "bcmPortControlSampleEgressEnable", \
    "bcmPortControlSampleIngressRate", \
    "bcmPortControlSampleEgressRate", \
    "bcmPortControlMplsSpeculativeParse", \
    "bcmPortControlFieldHiGigClassSelect", \
    "bcmPortControlDvpGroupId", \
    "bcmPortControlDvpGroupKnockoutEnable", \
    "bcmPortControlUntaggedVlanMember", \
    "bcmPortControlMPLSEncapsulateAdditionalLabel", \
    "bcmPortControlPreserveDscpIngress", \
    "bcmPortControlPreserveDscpEgress", \
    "bcmPortControlPWETerminationPortModeEnable", \
    "bcmPortControlOuterPolicerRemark", \
    "bcmPortControlInnerPolicerRemark", \
    "bcmPortControlAllowTtlInheritance", \
    "bcmPortControlAllowQosInheritance", \
    "bcmPortControlPacketTimeStampInsertRx", \
    "bcmPortControlPacketTimeStampInsertTx", \
    "bcmPortControlPacketTimeStampSrcPortInsertCancel", \
    "bcmPortControlPacketTimeStampDestPortInsertCancel", \
    "bcmPortControlPacketTimeStampRxId", \
    "bcmPortControlPacketTimeStampTxId", \
    "bcmPortControlPacketTimeStampByteMeterAdjust", \
    "bcmPortControlDoNotCheckVlanEgress", \
    "bcmPortControlE2EFCTransmitEnable", \
    "bcmPortControlE2EFCReceiveEnable", \
    "bcmPortControlE2EFCCopyToCpuEnable", \
    "bcmPortControlE2EFCDestMacOui", \
    "bcmPortControlE2EFCDestMacNonOui", \
    "bcmPortControlE2EFCSrcMacOui", \
    "bcmPortControlE2EFCSrcMacNonOui", \
    "bcmPortControlE2EFCEtherType", \
    "bcmPortControlE2EFCOpcode", \
    "bcmPortControlForceBridgeForwarding", \
    "bcmPortControlIlknRxPathEnable", \
    "bcmPortControlEgressAclTwoPassEditing", \
    "bcmPortControlLLFCAfterFecEnable", \
    "bcmPortControlResetSerdes", \
    "bcmPortControlPONEnable", \
    "bcmPortControlLogicalInterfaceSameFilter", \
    "bcmPortControlIPv6TerminationCascadedModeEnable", \
    "bcmPortControlMimUcastTermEnable", \
    "bcmPortControlMimMcastTermEnable", \
    "bcmPortControlTXPISDMOverride", \
    "bcmPortControlTXPISDMStatus", \
    "bcmPortControlBicastPort", \
    "bcmPortControlObmClassifierPriority", \
    "bcmPortControlObmClassifierEnableDscp", \
    "bcmPortControlObmClassifierEnableMpls", \
    "bcmPortControlObmClassifierEnableEtag", \
    "bcmPortControlObmClassifierEtagEthertype", \
    "bcmPortControlObmClassifierVntagEthertype", \
    "bcmPortControlControlCellsFecBypassEnable", \
    "bcmPortControlPrbsRxInvertData", \
    "bcmPortControlFcoeTranslateKeyFirstEgress", \
    "bcmPortControlFcoeTranslateKeySecondEgress", \
    "bcmPortControlIntEnable", \
    "bcmPortControlIntPortMetaData", \
    "bcmPortControlIntTurnaround", \
    "bcmPortControlQosRemarkResolution", \
    "bcmPortControlObmClassifierInternal", \
    "bcmPortControlWirelessCosMapSelect", \
    "bcmPortControlHiGigCosSelect", \
    "bcmPortControlTpidSrc", \
    "bcmPortControlInternalLoopback", \
    "bcmPortConrolEgressVlanPortArpPointed", \
    "bcmPortControlVrrpScalingPort", \
    "bcmPortControlObmInterruptTypeDropPreempt", \
    "bcmPortControlObmInterruptTypeDropExpress", \
    "bcmPortControlObmInterruptTypeOverflowPreempt", \
    "bcmPortControlObmInterruptTypeOverflowExpress", \
    "bcmPortControlForwardNetworkGroup", \
    "bcmPortControlIngressQosModelRemark", \
    "bcmPortControlIngressQosModelPhb", \
    "bcmPortControlIngressQosModelTtl", \
    "bcmPortControlMetadata", \
    "bcmPortControlFirstHeaderSize", \
    "bcmPortControlDistributeLearnMessageMode", \
    "bcmPortControlDiscardEgress", \
    "bcmPortControlIngressEnable", \
    "bcmPortControlRuntThreshold", \
    "bcmPortControlReflectorL2", \
    "bcmPortControlRxPriority", \
    "bcmPortControlIP4TunnelTermEnable", \
    "bcmPortControlIP6TunnelTermEnable", \
    "bcmPortControlQoSRemarkEgressEnable", \
    "bcmPortControlBridgeEgress", \
    "bcmPortControlLatencyEcnEnable", \
    "bcmPortControlModEnable", \
    "bcmPortControlModProfileId", \
    "bcmPortControlLinkFaultLocalClear", \
    "bcmPortControlLinkFaultRemoteClear", \
    "bcmPortControlIngressSampleProfile", \
    "bcmPortControlPFCFromLLFCEnable", \
    "bcmPortControlFirstHeaderSizeAfterInjected", \
    "bcmPortControlFlexeDoubleNbTdmSlotEnable", \
    "bcmPortControlRecycleApp", \
    "bcmPortControlSystemPortInjectedMap", \
    "bcmPortControlPacketTimeStampIngressInsertTx", \
    "bcmPortControlPacketTimeStampIngressInsertTxCancel", \
    "bcmPortControlEgressVlanPriSrc", \
    "bcmPortControlTxStall", \
    "bcmPortControlTxByteState", \
    "bcmPortControlPacketProcssingPort", \
    "bcmPortControlIfaEnable", \
    "bcmPortControlIoamEnable", \
    "bcmPortControlPFCStatus", \
    "bcmPortControlRoeLinkdownTransmit", \
    "bcmPortControlRoeLinkdownReceive", \
    "bcmPortControlEgressPktPriCfiCopyIngressEnable", \
    "bcmPortControlEgressTosCopyIngressEnable", \
    "bcmPortControlEgressL2OpaqueTag", \
    "bcmPortControlDataRate", \
    "bcmPortControlMplsLabelDeleteAllEnable", \
    "bcmPortControlFlowCountClassId", \
    "bcmPortControlIbch1Enable", \
    "bcmPortControlStartTxThreshold", \
    "bcmPortControlSaMulticastEnable", \
    "bcmPortControlLinkFaultLocalForce", \
    "bcmPortControlLinkFaultRemoteForce", \
    "bcmPortControlMacTxOnLoopback", \
    "bcmPortControlIpFixRxEnable", \
    "bcmPortControlIpmcL3IngressLookup", \
    "bcmPortControlStatEventToCpu", \
    "bcmPortControlExtenderSvpAssignKeySelection", \
    "bcmPortControlSarJitterToleranceLevel", \
    "bcmPortControlSrv6Enable", \
    "bcmPortControlIngInnerTpidEnable", \
    "bcmPortControlIngOuterTpidEnable", \
    "bcmPortControlEgrInnerTpidEnable", \
    "bcmPortControlEgrOuterTpidEnable", \
    "bcmPortControlPortmodLinkRecoveryEnable", \
    "bcmPortControlSignalQualityErDegradeThreshold", \
    "bcmPortControlSignalQualityErDegradeRecoverThreshold", \
    "bcmPortControlSignalQualityErFailThreshold", \
    "bcmPortControlSignalQualityErFailRecoverThreshold", \
    "bcmPortControlSignalQualityErMeasureMode", \
    "bcmPortControlSignalQualityErInterval", \
    "bcmPortControlSignalQualityErActionEnable", \
    "bcmPortControlFlexeDeskewAlmTriggerLocalFault", \
    "bcmPortControlPfcRxStatEnable", \
    "bcmPortControlUdf", \
    "bcmPortControlFilterIngressExactMatch", \
    "bcmPortControlSignalQualityErHoldOffInterval", \
    "bcmPortControlIngressSampleMode", \
    "bcmPortControlL1EthToOtnMapTranscodeType", \
    "bcmPortControlOtnMapToL1EthTranscodeType", \
    "bcmPortControlSarToIngressCellMode", \
    "bcmPortControlEgressToSarCellMode", \
    "bcmPortControlL3TunnelTermEnable", \
    "bcmPortControlL2GreVpnIdSize", \
    "bcmPortControlHonorL2SrcDiscardOnStationMove", \
    "bcmPortControlEpRecircEnable", \
    "bcmPortControlFlexHashEnable", \
    "bcmPortControlTxCrcMode", \
    "bcmPortControlCrcErrorFramesPurge" 
...
/* Types of MAC throttle mode. */
typedef enum bcm_port_throttle_mode_e {
    bcmPortThrottleMode10gTo5g = 256,   /* Throttle speed from 10G to 5G */
    bcmPortThrottleMode10gTo2p5g = 257  /* Throttle speed from 10G to 2.5G */
} bcm_port_throttle_mode_t;

/* OTN map types */
typedef enum bcm_port_control_otn_map_type_e {
    bcmPortControlOtnMapNone = 0,   /* Disable OTN map configuration */
    bcmPortControlOtnMapImp = 1,    /* OTN map is IMP map */
    bcmPortControlOtnMapGmp = 2,    /* OTN map is GMP map */
    bcmPortControlOtnMapBmp = 3,    /* OTN map is BMP map */
    bcmPortControlOtnMapGfp = 4,    /* OTN map is GFP map */
    bcmPortControlOtnMapCount = 5   /* OTN map count */
} bcm_port_control_otn_map_type_t;

/* SAR cell modes */
typedef enum bcm_port_control_sar_cell_mode_e {
    bcmPortSarCell15x66bAnd13x66b = 0,  /* The SAR cell is
                                           OH+15*66b+PAD+13*66b+PAD, length is
                                           256B. */
    bcmPortSarCell15x66bAnd14x66b = 1,  /* The SAR cell is
                                           OH+15*66b+PAD+14*66b+PAD, length is
                                           256B. */
    bcmPortSarCell28x66b = 2,           /* The SAR cell is OH+28*66b+PAD, length
                                           is 256B. */
    bcmPortSarCell29x66b = 3,           /* The SAR cell is OH+29*66b+PAD, length
                                           is 256B. */
    bcmPortSarCell30x66bAnd28x66b = 4,  /* The SAR cell is
                                           OH+30*66b+PAD+28*66b+PAD, length is
                                           512B. */
    bcmPortSarCell30x66bAnd29x66b = 5,  /* The SAR cell is
                                           OH+30*66b+PAD+29*66b+PAD, length is
                                           512B. */
    bcmPortSarCell30x66bAnd30x66b = 6,  /* The SAR cell is
                                           OH+30*66b+PAD+30*66b+PAD, length is
                                           512B. */
    bcmPortSarCell28x65b = 7,           /* The SAR cell is OH+28*65b+PAD, length
                                           is 256B. */
    bcmPortSarCell29x65b = 8,           /* The SAR cell is OH+29*65b+PAD, length
                                           is 256B. */
    bcmPortSarCell30x65b = 9,           /* The SAR cell is OH+30*65b+PAD, length
                                           is 256B. */
    bcmPortSarCell31x65bAnd29x65b = 10, /* The SAR cell is
                                           OH+31*65b+PAD+29*65b+PAD, length is
                                           512B. */
    bcmPortSarCell31x65bAnd30x65b = 11, /* The SAR cell is
                                           OH+31*65b+PAD+30*65b+PAD, length is
                                           512B. */
    bcmPortSarCellCount = 12            /* SAR cell mode count */
} bcm_port_control_sar_cell_mode_t;

/* tx CRC modes */
typedef enum bcm_port_control_tx_crc_mode_e {
    bcmPortControlTxCrcModeAppend = 0,  /* CRC is computed on incoming packet
                                           data and appended. */
    bcmPortControlTxCrcModeKeep = 1,    /* Incoming packet CRC is passed 
                                           through without modifications. */
    bcmPortControlTxCrcModeReplace = 2, /* Incoming packet CRC is replaced with
                                           the CRC value computed by the MAC. */
    bcmPortControlTxCrcModeAuto = 3,    /* The CRC mode is determined by the
                                           inputs pins on the port side. */
    bcmPortControlTxCrcModeCount = 4    /* Tx CRC mode count */
} bcm_port_control_tx_crc_mode_t;
...
#define BCM_PORT_PHY_CONTROL_FEC_UNCORRECTED_CODEWORD_COUNT _SHR_PORT_PHY_CONTROL_FEC_UNCORRECTED_CODEWORD_COUNT /* CL91 FEC uncorrected
                                                          code word count. */
#define BCM_PORT_PHY_CONTROL_RS_FEC_BIT_ERROR_COUNT _SHR_PORT_PHY_CONTROL_RS_FEC_BIT_ERROR_COUNT /* RS FEC bit error
                                                          count. */
...
#define BCM_PORT_PHY_CONTROL_FIRMWARE_OS_DFE_ENABLE _SHR_PORT_PHY_CONTROL_FIRMWARE_OS_DFE_ENABLE /* enabling Over Sample
                                                          DFE */
#define BCM_PORT_PHY_CONTROL_TX_PATTERN_GEN_CONFIG _SHR_PORT_PHY_CONTROL_TX_PATTERN_GEN_CONFIG /* config TX Pattern type */
#define BCM_PORT_PHY_CONTROL_RX_DC_OFFSET   _SHR_PORT_PHY_CONTROL_RX_DC_OFFSET /* Get PHY RX DC offset */
...
#define BCM_PORT_PHY_CONTROL_CODEC_MODE_CL49 _SHR_PORT_PHY_CONTROL_CODEC_MODE_CL49 /* cl49 codec mode */
#define BCM_PORT_PHY_CONTROL_CODEC_MODE_CL82 _SHR_PORT_PHY_CONTROL_CODEC_MODE_CL82 /* cl82 codec_mode */
#define BCM_PORT_PHY_CONTROL_CODEC_MODE_REDUCED_IPG _SHR_PORT_PHY_CONTROL_CODEC_MODE_REDUCED_IPG /* Reduced IPG codec_mode */

#define BCM_PORT_PHY_CONTROL_AN_LINK_FAIL_INHIBIT_TIMER_LT_PAM4 _SHR_PORT_PHY_CONTROL_AN_LINK_FAIL_INHIBIT_TIMER_LT_PAM4 /* config AN link fail
                                                          inhibit timer, the
                                                          unit of timer is
                                                          microsecond */
...
#define BCM_PORT_PHY_CONTROL_TX_PATTERN_GEN_INVALID _SHR_PORT_PHY_TX_PATTERN_GEN_INVALID /* Invalid tx test
                                                          pattern */
#define BCM_PORT_PHY_CONTROL_TX_PATTERN_GEN_OFF _SHR_PORT_PHY_TX_PATTERN_GEN_OFF /* tx test pattern off */
#define BCM_PORT_PHY_CONTROL_TX_PATTERN_GEN_PAM4_JP03B _SHR_PORT_PHY_TX_PATTERN_GEN_PAM4_JP03B /* PAM4 tx pattern JP03B */
#define BCM_PORT_PHY_CONTROL_TX_PATTERN_GEN_PAM4_LINEAR _SHR_PORT_PHY_TX_PATTERN_GEN_PAM4_LINEAR /* PAM4 tx pattern linear */
#define BCM_PORT_PHY_CONTROL_TX_PATTERN_GEN_CUSTOM _SHR_PORT_PHY_TX_PATTERN_GEN_CUSTOM /* custom tx pattern */
...
#define BCM_PORT_MATCH_MIM_SERVICE_SMAC 0x00000010 /* Match contains a BSA
                                                      ...
                                                      ISID). */
#define BCM_PORT_MATCH_REPLACE          0x00000020 /* Replace port for an
                                                      existing match */
...
#define BCM_PORT_TIMESYNC_EXTERNAL_MAC_ENABLE 0x00000020 /* enable external mac
                                                          for the port */
#define BCM_PORT_TIMESYNC_F1588             0x00000040 /* Port Fabric PTP
                                                          configuration */
...
#define BCM_PORT_PHY_TIMESYNC_ONE_STEP_ENABLE _SHR_PORT_PHY_TIMESYNC_ONE_STEP_ENABLE /* Enable One-Step
                                                          timestamping */
#define BCM_PORT_PHY_TIMESYNC_TWO_STEP_ENABLE _SHR_PORT_PHY_TIMESYNC_TWO_STEP_ENABLE /* Enable two-Step
                                                          timestamping */
#define BCM_PORT_PHY_TIMESYNC_SELECT_SFD    _SHR_PORT_PHY_TIMESYNC_SELECT_SFD /* Select SFD as
                                                          timestamp location.
                                                          Otherwise Check MAC_DA
                                                          flag. */
#define BCM_PORT_PHY_TIMESYNC_COMP_MODE_ON  _SHR_PORT_PHY_TIMESYNC_COMP_MODE_ON /* Turn on the
                                                          Compensation Mode.
                                                          Check LATEST_LANE bit */
#define BCM_PORT_PHY_TIMESYNC_COMP_MODE_LATEST_LANE _SHR_PORT_PHY_TIMESYNC_COMP_MODE_LATEST_LANE /* This bit is  Valid
                                                          Only when COMP_MODE_ON
                                                          is set.  Compensation
                                                          Latest Lane Mode 1.
                                                          Compensation Earliest
                                                          Lane Mode 0 */
#define BCM_PORT_PHY_TIMESYNC_SELECT_MAC_DA _SHR_PORT_PHY_TIMESYNC_SELECT_MAC_DA /* Valid when SFD is off.
                                                          Select MAC_DA as
                                                          timestamp location.
                                                          Otherwise SOP. */
...
/* AM norm modes for aggregated port speeds */
#define BCM_PORT_PHY_TIMESYNC_COMPENSATION_MODE_NONE _SHR_PORT_PHY_TIMESYNC_COMPENSATION_MODE_NONE /* No compensation */
#define BCM_PORT_PHY_TIMESYNC_COMPENSATION_MODE_EARLIEST_LANE _SHR_PORT_PHY_TIMESYNC_COMPENSATION_MODE_EARLIEST_LANE /* Compensate based on
                                                          the earliest lane */
#define BCM_PORT_PHY_TIMESYNC_COMPENSATION_MODE_LATEST_LANE _SHR_PORT_PHY_TIMESYNC_COMPENSATION_MODE_LATEST_LANE /* Compensate based on
                                                          the latest lane. */
...
/* Set the port configuration for the specified device. */
...
typedef struct bcm_port_extender_mapping_info_s {
    ...
    int fc_channel_id;          /* Flow control channel ID */
...
#define BCM_PORT_RESOURCE_TVCO_PRIORITIZE_26P562G 0x20       /* If set, prioritize
                                                          using 26.562G TVCO
                                                          instead of 25.781G. */
#define BCM_PORT_RESOURCE_ECGM_AUTO_ADJUST_DISABLE 0x40       /* If set, the auto
                                                          adjustment of the
                                                          port's ECGM thresholds
                                                          will be skipped. */
#define BCM_PORT_RESOURCE_G_HAO             0x80       /* If set, performs G.HAO
                                                          speed change. */
...
typedef struct bcm_port_resource_s {
    ...
    int logical_otn_lane;           /* First framer logical OTN lane. "-1" means
                                       the OTN lanes are allocated by SW.
                                       Positive means specifying the logical otn
                                       lanes by customers */
} bcm_port_resource_t;
...
typedef enum bcm_port_flexe_phy_slot_mode_e {
    bcmPortFlexePhySlot5G = 0,          /* FlexE physical interface 5G slot mode */
    bcmPortFlexePhySlot1P25G = 1,       /* FlexE physical interface 1.25G slot
                                           mode */
    bcmPortFlexePhySlot1G = 2,          /* FlexE physical interface 1G slot mode */
    bcmPortFlexePhySlotModeCount = 3    /* The FlexE phy slot mode count */
} bcm_port_flexe_phy_slot_mode_t;

/* FlexE PHY info structure. */
typedef struct bcm_port_flexe_group_phy_info_s {
    bcm_port_t port;                    /* Logical port ID for FlexE physical
                                           port */
    int logical_phy_id;                 /* Logical PHY ID for FlexE PHY */
    bcm_port_flexe_phy_slot_mode_t slot_mode; /* Configure the slot mode for FlexE
                                           physical interface. */
...
/* FlexE overhead alarm status structure. */
typedef struct bcm_port_flexe_oh_alarm_s {
    ...
    uint8 sc_mismatch;                  /* Sync config mismatch alarm in
                                           overhead */
    uint8 unequipped_alarm;             /* FlexE group ID unequipped alarm */
...
typedef enum bcm_port_flexe_oam_control_type_e {
    ...
    bcmPortSarOamControlSar2IlknBypassEnable = 20, /* Enable SAR OAM bypass, direction:
                                           SAR-to-ILKN */
    bcmPortFlexeOamControlInsertRdi = 21, /* Insert RDI(remote defect indication)
                                           to client signal */
    bcmPortFlexeOamControlCount = 22    /* FlexE OAM control count */
...
/* Port BER Projection Mode */
typedef enum bcm_port_ber_proj_mode_e {
    bcmPortBerProjModePrbs = 0, /* Run BER Projection in PRBS Mode */
    bcmPortBerProjModeFec = 1   /* Run BER Projection in FEC Mode */
} bcm_port_ber_proj_mode_t;
...
typedef struct bcm_port_ber_proj_params_s {
    ...
    int interval_second;            /* Measurement time that PRBS errors are
                                       accumulated */
    bcm_port_phy_fec_t fec_type;    /* fec_type for port */
    bcm_port_ber_proj_mode_t mode;  /* BER Projection mode */
} bcm_port_ber_proj_params_t;

/* Initialize a BER Projection input parameter structure. */
extern void bcm_port_ber_proj_params_t_init(
    bcm_port_ber_proj_params_t *params);
...
/* Port network group direction. */
typedef enum bcm_port_network_group_direction_e {
    bcmPortNetworkGroupDirectionIngress = 0, /* Ingress port network group */
    bcmPortNetworkGroupDirectionEgress = 1, /* Egress port network group */
    bcmPortNetworkGroupDirectionCount = 2 /* Always last one */
} bcm_port_network_group_direction_t;

/* Port network group structure. */
typedef struct bcm_port_network_group_s {
    bcm_switch_network_group_t network_group_id; /* Split Horizon network group
                                           identifier */
} bcm_port_network_group_t;

/* Initialize the bcm_port_network_group_t structure */
extern void bcm_port_network_group_t_init(
    bcm_port_network_group_t *group);

#ifndef BCM_HIDE_DISPATCHABLE

/* Add a port into a network group. */
extern int bcm_port_network_group_add(
    int unit, 
    bcm_gport_t gport, 
    bcm_port_network_group_direction_t direction, 
    bcm_port_network_group_t *group);

/* Delete a port from a network group. */
extern int bcm_port_network_group_delete(
    int unit, 
    bcm_gport_t gport, 
    bcm_port_network_group_direction_t direction, 
    bcm_port_network_group_t *group);

/* Get all network groups of a port. */
extern int bcm_port_network_group_get_all(
    int unit, 
    bcm_gport_t gport, 
    bcm_port_network_group_direction_t direction, 
    int array_size, 
    bcm_port_network_group_t *group_array, 
    int *count);
...
/* Initialize a Port Flight Data Recorder Configuration structure. */
extern void bcm_port_fdr_config_t_init(
...
typedef struct bcm_port_fdr_stats_s {
    ...
    uint64 end_time;            /* indicate the time when the last statistics
                                   are collected */
    uint64 num_uncorrect_cws;   /* indicate the total number of uncorrectable
                                   code words */
    uint64 num_cws;             /* total number of code words used for the
                                   statistics collection */
    uint64 num_symb_errs;       /* total number of symbol errors detected */
    uint64 cw_s0_errs;          /* Number of Code Words with S + 0 symbol errors
                                   ...
                                   on the chip. */
    uint64 cw_s1_errs;          /* Number of Code Words with S + 1 symbol errors
                                   where S is the selected value via
                                   symb_err_stats_sel in bcm_port_fdr_config_t.
                                   If symb_err_stats_sel is 0, S is 0. If
                                   symb_err_stats_sel is 1, S = 9 or S = 8 based
                                   on the chip. */
    uint64 cw_s2_errs;          /* Number of Code Words with S + 2 symbol errors
                                   where S is the selected value via
                                   symb_err_stats_sel in bcm_port_fdr_config_t.
                                   If symb_err_stats_sel is 0, S is 0. If
                                   symb_err_stats_sel is 1, S = 9 or S = 8 based
                                   on the chip. */
    uint64 cw_s3_errs;          /* Number of Code Words with S + 3 symbol errors
                                   where S is the selected value via
                                   symb_err_stats_sel in bcm_port_fdr_config_t.
                                   If symb_err_stats_sel is 0, S is 0. If
                                   symb_err_stats_sel is 1, S = 9 or S = 8 based
                                   on the chip. */
    uint64 cw_s4_errs;          /* Number of Code Words with S + 4 symbol errors
                                   where S is the selected value via
                                   symb_err_stats_sel in bcm_port_fdr_config_t.
                                   If symb_err_stats_sel is 0, S is 0. If
                                   symb_err_stats_sel is 1, S = 9 or S = 8 based
                                   on the chip. */
    uint64 cw_s5_errs;          /* Number of Code Words with S + 5 symbol errors
                                   where S is the selected value via
                                   symb_err_stats_sel in bcm_port_fdr_config_t.
                                   If symb_err_stats_sel is 0, S is 0. If
                                   symb_err_stats_sel is 1, S = 9 or S = 8 based
                                   on the chip. */
    uint64 cw_s6_errs;          /* Number of Code Words with S + 6 symbol errors
                                   where S is the selected value via
                                   symb_err_stats_sel in bcm_port_fdr_config_t.
                                   If symb_err_stats_sel is 0, S is 0. If
                                   symb_err_stats_sel is 1, S = 9 or S = 8 based
                                   on the chip. */
    uint64 cw_s7_errs;          /* Number of Code Words with S + 7 symbol errors
                                   where S is the selected value via
                                   symb_err_stats_sel in bcm_port_fdr_config_t.
                                   If symb_err_stats_sel is 0, S is 0. If
                                   symb_err_stats_sel is 1, S = 9 or S = 8 based
                                   on the chip. */
    uint64 cw_s8_errs;          /* Number of Code Words with S + 8 symbol errors
                                   where S is the selected value via
                                   symb_err_stats_sel in bcm_port_fdr_config_t.
                                   If symb_err_stats_sel is 0, S is 0. If
                                   symb_err_stats_sel is 1, S = 9 or S = 8 based
                                   on the chip. */
    uint64 cw_s9_errs;          /* Number of Code Words with S + 9 symbol errors
                                   where S is the selected value via
                                   symb_err_stats_sel in bcm_port_fdr_config_t.
                                   If symb_err_stats_sel is 0, S is 0. If
                                   symb_err_stats_sel is 1, S = 9 or S = 8 based
                                   on the chip. */
    uint64 cw_s10_errs;         /* Number of Code Words with S + 10 symbol
                                   errors where S is the selected value via
                                   symb_err_stats_sel in bcm_port_fdr_config_t.
                                   If symb_err_stats_sel is 0, S is 0. If
                                   symb_err_stats_sel is 1, S = 9 or S = 8 based
                                   on the chip. */
    uint64 cw_s11_errs;         /* Number of Code Words with S + 11 symbol
                                   errors where S is the selected value via
                                   symb_err_stats_sel in bcm_port_fdr_config_t.
                                   If symb_err_stats_sel is 0, S is 0. If
                                   symb_err_stats_sel is 1, S = 9 or S = 8 based
                                   on the chip. */
    uint64 cw_s12_errs;         /* Number of Code Words with S + 12 symbol
                                   errors where S is the selected value via
                                   symb_err_stats_sel in bcm_port_fdr_config_t.
                                   If symb_err_stats_sel is 0, S is 0. If
                                   symb_err_stats_sel is 1, S = 9 or S = 8 based
                                   on the chip. */
    uint64 cw_s13_errs;         /* Number of Code Words with S + 13 symbol
                                   errors where S is the selected value via
                                   symb_err_stats_sel in bcm_port_fdr_config_t.
                                   If symb_err_stats_sel is 0, S is 0. If
                                   symb_err_stats_sel is 1, S = 9 or S = 8 based
                                   on the chip. */
    uint64 cw_s14_errs;         /* Number of Code Words with S + 14 symbol
                                   errors where S is the selected value via
                                   symb_err_stats_sel in bcm_port_fdr_config_t.
                                   If symb_err_stats_sel is 0, S is 0. If
                                   symb_err_stats_sel is 1, S = 9 or S = 8 based
                                   on the chip. */
    uint64 cw_s15_errs;         /* Number of Code Words with S + 15 symbol
                                   errors where S is the selected value via
                                   symb_err_stats_sel in bcm_port_fdr_config_t.
                                   If symb_err_stats_sel is 0, S is 0. If
                                   symb_err_stats_sel is 1, S = 9 or S = 8 based
                                   on the chip. */
    uint64 cw_s16_errs;         /* Number of Code Words with S + 16 symbol
                                   errors where S is the selected value via
                                   symb_err_stats_sel in bcm_port_fdr_config_t.
                                   If symb_err_stats_sel is 0, S is 0. If
                                   symb_err_stats_sel is 1, S = 9 or S = 8 based
...
#define BCM_PORT_MAX_LANES      16         

/* port lane mapping */
typedef struct bcm_port_lane_map_s {
    int num_lanes;                      /* number of lanes in the PM core. */
    uint8 rx_physical_lane[BCM_PORT_MAX_LANES]; /* rx physical lane, rx_physical_lane[0]
                                           is the rx physical lane for logic
                                           lane 0, etc. */
    uint8 tx_physical_lane[BCM_PORT_MAX_LANES]; /* tx physical lane, tx_physical_lane[0]
                                           is the tx physical lane for logic
                                           lane 0, etc. */
} bcm_port_lane_map_t;

#ifndef BCM_HIDE_DISPATCHABLE

/* Get or set the lane mapping for the port. */
extern int bcm_port_lane_map_get(
    int unit, 
    bcm_port_t port, 
    bcm_port_lane_map_t *lane_map);

/* Get or set the lane mapping for the port. */
extern int bcm_port_lane_map_set(
    int unit, 
    bcm_port_t port, 
    bcm_port_lane_map_t *lane_map);
...
/* FLR timeout type */
typedef enum bcm_port_flr_timeout_e {
    bcmPortFlrTimeoutInvaild = 0,   /* Timeout value Invaild */
    bcmPortFlrTimeout50ms = 1,      /* Timeout value 50ms */
    bcmPortFlrTimeout75ms = 2,      /*  Timeout value 75ms */
    bcmPortFlrTimeout100ms = 3,     /* Timeout value 100ms */
    bcmPortFlrTimeout150ms = 4,     /* Timeout value 150ms */
    bcmPortFlrTimeout250ms = 5,     /* Timeout value 250ms */
    bcmPortFlrTimeout500ms = 6,     /* Timeout value 500ms */
    bcmPortFlrTimeoutCount = 7      /* Timeout type count */
} bcm_port_flr_timeout_t;

#ifndef BCM_HIDE_DISPATCHABLE

/* Set fast link recovery for the port. */
extern int bcm_port_fast_link_recovery_enable_set(
    int unit, 
    bcm_port_t port, 
    int enable, 
...
typedef struct bcm_port_pmd_rx_lock_status_s {
    uint32 rx_lock_bmp;         /* The lane bitmap indicates PMD RX lock status. */
    uint32 rx_lock_change_bmp;  /* The lane bitmap indicates PMD RX lock status
                                   has changed since last read. */
} bcm_port_pmd_rx_lock_status_t;

#ifndef BCM_HIDE_DISPATCHABLE

/* Get the PMD RX lock status on a given port. */
extern int bcm_port_pmd_rx_lock_status_get(
    int unit, 
    bcm_port_t port, 
...
typedef struct bcm_port_phy_signal_detect_status_s {
    uint32 signal_detect_bmp;           /* The lane bitmap indicates PHY signal
                                           detect status. Bit 0 indicates the
                                           lane 0 of the port. */
    uint32 signal_detect_change_bmp;    /* The lane bitmap indicates PHY signal
                                           detect status has changed since last
                                           read. Bit 0 indicates the lane 0 of
                                           the port. */
} bcm_port_phy_signal_detect_status_t;

#ifndef BCM_HIDE_DISPATCHABLE

/* Get the PHY signal detect status on a given port. */
extern int bcm_port_phy_signal_detect_status_get(
    int unit, 
    bcm_port_t port, 
...
/* Signal Quality error rate state */
typedef enum bcm_port_signal_quality_error_rate_state_e {
    BCM_PORT_SIGNAL_QUALITY_ERROR_RATE_STATE_DEGRADE_RECOVER = 0, /* indicates a state in which no
                                           threshod was crossed */
    BCM_PORT_SIGNAL_QUALITY_ERROR_RATE_STATE_DEGRADE = 1, /* indicates a state in which error rate
                                           crossed only degrade threshold, and
                                           previous state was DEGRADE_RECOVER */
    BCM_PORT_SIGNAL_QUALITY_ERROR_RATE_STATE_FAIL_RECOVER = 2, /* indicates a state in which error rate
                                           crossed only degrade threshold, and
                                           previous state was FAIL */
    BCM_PORT_SIGNAL_QUALITY_ERROR_RATE_STATE_FAIL = 3 /* indicates a state in which both
                                           thresholds were crossed */
} bcm_port_signal_quality_error_rate_state_t;

/* Signal Quality error rate measure mode */
typedef enum bcm_port_signal_quality_error_rate_measure_mode_e {
    BCM_PORT_SIGNAL_QUALITY_ERROR_RATE_MEASURE_MODE_DISABLED = 0, /* indicates that the error rate
                                           sampling is disabled */
    BCM_PORT_SIGNAL_QUALITY_ERROR_RATE_MEASURE_MODE_SER = 1, /* indicates that the error rate
                                           sampling and calculations are based
                                           on SER values */
    BCM_PORT_SIGNAL_QUALITY_ERROR_RATE_MEASURE_MODE_BER = 2, /* indicates that the error rate
                                           sampling and calculations are based
                                           on BER values */
    BCM_PORT_SIGNAL_QUALITY_ERROR_RATE_MEASURE_MODE_LAST = 3 /* Maximal value of measure mode */
} bcm_port_signal_quality_error_rate_measure_mode_t;

#ifndef BCM_HIDE_DISPATCHABLE

/* Get fast link recovery configuration on a given port. */
extern int bcm_port_fast_link_recovery_enable_get(
    int unit, 
    bcm_port_t port, 
    int *enable, 
    bcm_port_flr_timeout_t *timeout);
...
/* Framer module IDs */
typedef enum bcm_port_framer_module_e {
    bcmPortFramerModuleNormalFlexe = 0, /* Normal FlexE module */
    bcmPortFramerModuleVirtualFlexe = 1, /* Virtual FlexE module */
    bcmPortFramerModuleMac1 = 2,        /* Framer MAC1 module */
    bcmPortFramerModuleMac2 = 3,        /* Framer MAC2 module */
    bcmPortFramerModuleCount = 4        /* Module count */
} bcm_port_framer_module_t;

/* Port framer flags. */
#define BCM_PORT_FRAMER_CHANNEL_RX  0x1        /* Indicate it is for Framer Rx
                                                  channel */
#define BCM_PORT_FRAMER_CHANNEL_TX  0x2        /* Indicate it is for Framer Tx
                                                  channel */

#ifndef BCM_HIDE_DISPATCHABLE

/* Reserve the framer channel for specific module. */
extern int bcm_port_framer_channel_reserve(
    int unit, 
    uint32 flags, 
    bcm_port_framer_module_t module_id, 
    int *channel);

/* Free the framer channel for specific module. */
extern int bcm_port_framer_channel_free(
    int unit, 
    uint32 flags, 
    bcm_port_framer_module_t module_id, 
    int channel);
...
/* FEC degraded ability and SER status for local and remote. */
typedef struct bcm_port_signal_quality_ser_status_s {
    uint8 fec_degraded_ser;     /* FEC Degraded SER */
    uint8 rx_local_degraded;    /* Local degraded SER received */
    uint8 rx_remote_degraded;   /* Remote degraded SER received */
    uint8 rx_am_status_field;   /* Alignment marker status field */
} bcm_port_signal_quality_ser_status_t;

/* FEC degraded SER configuration. */
typedef struct bcm_port_signal_quality_ser_config_s {
    uint8 enable;                   /* FEC degrade function enable/disable */
    uint32 activate_threshold;      /* FEC degraded SER activation threshold in
                                       symbol errors per interval */
    uint32 deactivate_threshold;    /* FEC degraded SER deactivate threshold in
                                       symbol errors per interval */
    uint32 interval;                /* FEC degraded SER interval in codewords */
} bcm_port_signal_quality_ser_config_t;

#ifndef BCM_HIDE_DISPATCHABLE

/* Get FEC degraded ability and SER status for local and remote. */
extern int bcm_port_signal_quality_ser_status_get(
    int unit, 
    bcm_port_t port, 
    bcm_port_signal_quality_ser_status_t *status);

/* Get FEC Degraded SER configuration. */
extern int bcm_port_signal_quality_ser_config_get(
    int unit, 
    bcm_port_t port, 
    bcm_port_signal_quality_ser_config_t *config);

/* Set FEC Degraded SER configuration. */
extern int bcm_port_signal_quality_ser_config_set(
    int unit, 
    bcm_port_t port, 
    bcm_port_signal_quality_ser_config_t *config);
...
/* Link mask. the corresponding event will be masked if the bit is set. */
#define BCM_PORT_FLR_LOS_DOWN_MASK      (1<<0)     /* If this bit is set, the
                                                      LOS/SF signal from optical
                                                      module will be masked. */
#define BCM_PORT_FLR_CDR_LOCK_DOWN_MASK (1<<1)     /* If this bit is set, the
                                                      CDR Unlock signal from
                                                      serdes will be masked. */
#define BCM_PORT_FLR_CDR_OOL_DOWN_MASK  (1<<2)     /* If this bit is set, the
                                                      CDR OOL signal from framer
                                                      will be masked. */

/* FLR link configuration */
typedef struct bcm_port_flr_link_config_s {
    uint32 link_mask;           /* see BCM_PORT_FLR_* */
    uint32 link_stable_timer;   /* The timer for link stable checking. The unit
                                   is Microsecond. Value 0 means to disable the
                                   timer */
} bcm_port_flr_link_config_t;

#ifndef BCM_HIDE_DISPATCHABLE

/* Set link mask and link stable timer for Fast link recovery. */
extern int bcm_port_fast_link_recovery_link_config_set(
    int unit, 
    bcm_port_t port, 
    uint32 flags, 
    bcm_port_flr_link_config_t *config);

/* Get link mask and link stable timer for Fast link recovery. */
extern int bcm_port_fast_link_recovery_link_config_get(
    int unit, 
    bcm_port_t port, 
    uint32 flags, 
    bcm_port_flr_link_config_t *config);
...
/* 
 * The callback function will notify the user upon a link condition
 * update
 */
typedef void (*bcm_port_signal_quality_callback_t)(
    int unit, 
    bcm_port_t port, 
    bcm_port_signal_quality_error_rate_state_t state, 
    uint32 err_stat, 
    void *user_data);

#ifndef BCM_HIDE_DISPATCHABLE

/* Register signal quality callback routine */
extern int bcm_port_signal_quality_callback_register(
    int unit, 
    bcm_port_signal_quality_callback_t f, 
    void *user_data);

/* Unregister a signal quality callback routine */
extern int bcm_port_signal_quality_callback_unregister(
    int unit, 
    bcm_port_signal_quality_callback_t f, 
    void *user_data);
