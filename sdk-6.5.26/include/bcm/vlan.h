...
typedef enum bcm_vlan_translate_key_e {
    ...
    bcmVlanTranslateEgressKeyVxlanSubChannel = 40, /* Use DGPP, O-VID[11:0] and I-VID[11:0]
                                           for VxLAN encap. */
    bcmVlanTranslateEgressKeyPortGroupVfiDoubleTagPreserve = 41, /* Use port-group ID, VFI, OTAG-Preserve
                                           and ITAG-Preserve. */
    bcmVlanTranslateKeyPortGroupDefaultVlan = 42, /* Use Port-Group and port default VLAN
                                           ID or VPN ID. */
    bcmVlanTranslateEgressKeyVpnPortGroupIngressPort = 43, /*  Use VPN, port group ID and ingress
                                           port. */
    bcmVlanTranslateKeyPortEtagOuter = 44, /*  Use Port, VID[11:0] in the ETAG
                                           header, O-VID[11:0]. */
    bcmVlanTranslateKeyPortEtagInner = 45, /*  Use Port, VID[11:0] in the ETAG
                                           header, I-VID[11:0]. */
    bcmVlanTranslateEgressKeyPortGroupVfiDoubleTagPreserveIngressPort = 46, /* Use port-group ID, VFI,
                                           OTAG-Preserve, ITAG-Preserve and
                                           ingress port. */
    bcmVlanTranslateEgressKeyVpnPortGroupIngressPortGroup = 47, /*  Use VPN, port group ID and ingress
                                           port group ID. */
    bcmVlanTranslateEgressKeyPortGroupVfiDoubleTagPreserveIngressPortGroup = 48, /* Use port-group ID, VFI,
                                           OTAG-Preserve, ITAG-Preserve and
                                           ingress port group ID. */
    bcmVlanTranslateEgressKeyVpnPortGroupOuterTagIngressPort = 49, /* Use VPN, port group ID, incoming
                                           OVID, and ingress port. */
    bcmVlanTranslateKeyPortGroupEtag = 50 /* Use Port-Group, ETAG */
...
#define BCM_VLAN_CONTROL_STR \
    ...
    "", \
    "", \
    "bcmVlanMemberMismatchLearn", \
    "bcmVlanMemberMismatchToCpu", \
    "bcmVlanNativeVplsServiceTaggedMiss", \
    "bcmVlanControlTranslateIngressMissDrop", \
    "bcmVlanControlTranslateIngressMissCopyToCpu", \
    "bcmVlanControlTranslateEgressMissDrop" 
...
typedef enum bcm_vlan_translate_egress_key_e {
    ...
    bcmVlanTranslateEgressKeyVpnGportGroupKey2Gport = 10, /* Requires BROADCOM_PREMIUM license */
    bcmVlanTranslateEgressKeyVpnGportGroupKey2VpnGport = 11, /* Requires BROADCOM_PREMIUM license */
    bcmVlanTranslateEgressKeyVpnGportGroupKey2Vpn = 12, /* Requires BROADCOM_PREMIUM license */
    bcmVlanTranslateEgressKeyVpnGportKey2Gport = 13, /* Requires BROADCOM_PREMIUM license */
    bcmVlanTranslateEgressKeyVpnGportKey2VpnGport = 14, /* Requires BROADCOM_PREMIUM license */
    bcmVlanTranslateEgressKeyVpnGportKey2Vpn = 15, /* Requires BROADCOM_PREMIUM license */
    bcmVlanTranslateEgressKey2Gport = 16, /* Requires BROADCOM_PREMIUM license */
    bcmVlanTranslateEgressKey2VpnGport = 17, /* Requires BROADCOM_PREMIUM license */
    bcmVlanTranslateEgressKey2Vpn = 18, /* Requires BROADCOM_PREMIUM license */
    bcmVlanTranslateEgressKeyVpnKey2Gport = 19, /* Requires BROADCOM_PREMIUM license */
    bcmVlanTranslateEgressKeyVpnKey2VpnGport = 20, /* Requires BROADCOM_PREMIUM license */
    bcmVlanTranslateEgressKeyVpnKey2Vpn = 21, /* Requires BROADCOM_PREMIUM license */
    bcmVlanTranslateEgressKeyCount = 22 /* Egress VLAN translation key count.
                                           Always the last. */
...
typedef enum bcm_vlan_control_port_e {
    ...
    bcmVlanPortTranslateEgressL2TunnelMissDrop = 31, /* Enable to drop packets if egress
                                           ...
                                           tunnel decapsulation flow. */
    bcmVlanPortTranslateEgressKeyDoubleTagPreserveEnable = 32 /* Enable OTAG-Preserve and
                                           ITAG-Preserve as egress vlan
                                           translation keys. */
} bcm_vlan_control_port_t;
...
typedef enum bcm_vlan_vp_mc_ctrl_e {
    ...
    bcmVlanVPMcControlEnable = 1,       /* Enable VP Multicast replication and
                                           also copy VLAN members as multicast
                                           replication ports */
    bcmVlanVPMcControlDisable = 2,      /* Disable VP Multicast replication */
    bcmVlanVPMcControlNoVlanMemberCopy = 3, /* Enable VP Multicast replication but
                                           do not copy VLAN members as multicast
                                           replication ports */
    bcmVlanVPMcControlCount = 4         /* This should be the last one */
...
#define BCM_VLAN_FLAGS2_UNKNOWN_DEST        0x00000020 /* Configure the default
                                                          destination with
                                                          unknown_dest */
#define BCM_VLAN_FLAGS2_EGRESS_TRANSLATION_INGRESS_PORT_ENABLE 0x00000040 /* Enable the ingress
                                                          port key in egress
                                                          VLAN translation */
#define BCM_VLAN_FLAGS2_UNKNOWN_UCAST_TO_L3_LOOKUP 0x00000080 /* Try L3 forwarding when
                                                          packet L2 lookup miss */
#define BCM_VLAN_FLAGS2_EGRESS_TRANSLATION_OUTER_VLAN_ENABLE 0x00000100 /* Enable the incoming
                                                          packet's ovid key in
                                                          egress VLAN
                                                          translation */
...
/* bcm_vlan_cross_connect_control_t */
typedef enum bcm_vlan_cross_connect_control_e {
    bcmVlanCrossConnectControlStatic = 0, /* Set the static bit. */
    bcmVlanCrossConnectControlOpaqueValue = 1, /* Set a generic value to identify the
                                           entry. */
    bcmVlanCrossConnectControlClassId = 2 /* Assign a class_id. */
} bcm_vlan_cross_connect_control_t;

#define BCM_VLAN_CROSS_CONNECT_CONTROL_STR \
    "bcmVlanCrossConnectControlStatic", \
    "bcmVlanCrossConnectControlOpaqueValue", \
    "bcmVlanCrossConnectControlClassId" 

#ifndef BCM_HIDE_DISPATCHABLE

/* Configure VLAN cross-connect. */
extern int bcm_vlan_cross_connect_control_set(
    int unit, 
    bcm_vlan_t outer_vlan, 
    bcm_vlan_t inner_vlan, 
    bcm_vlan_cross_connect_control_t type, 
    int arg);

/* Configure VLAN cross-connect. */
extern int bcm_vlan_cross_connect_control_get(
    int unit, 
    bcm_vlan_t outer_vlan, 
    bcm_vlan_t inner_vlan, 
    bcm_vlan_cross_connect_control_t type, 
...
/* VLAN cross-connect information flags */
#define BCM_VLAN_CROSS_CONNECT_INFO_STATIC  (1 << 0)   /* Indicate static entry */

/* flags for bcm_vlan_cross_connect_replace parameter options */
#define BCM_VLAN_CROSS_CONNECT_REPLACE_DELETE (1 << 0)   /* Indicate delete action */
#define BCM_VLAN_CROSS_CONNECT_REPLACE_DOUBLE_TAGS (1 << 1)   /* Indicate for vlan
                                                          double cross-connect
                                                          type */

/* VLAN cross-connect replace action information structure. */
typedef struct bcm_vlan_cross_connect_info_s {
    bcm_vlan_t outer_vlan;  /* Outer VLAN ID */
    bcm_vlan_t inner_vlan;  /* Inner VLAN ID */
    bcm_gport_t port_1;     /* First port/GPORT (global port) identifier */
    bcm_gport_t port_2;     /* Second port/GPORT (global port) identifier */
    int opaque_value;       /* A generic field, can be used to identify the
                               entry */
    int class_id;           /* The class_id */
    int int_pri;            /* The internal priority */
    uint32 flags;           /* BCM_VLAN_CROSS_CONNECT_INFO_xxx */
} bcm_vlan_cross_connect_info_t;

/* Configure VLAN cross-connect. */
extern void bcm_vlan_cross_connect_info_t_init(
    bcm_vlan_cross_connect_info_t *info);

#ifndef BCM_HIDE_DISPATCHABLE

/* Configure VLAN cross-connect. */
extern int bcm_vlan_cross_connect_replace(
    int unit, 
    uint32 options, 
...
#define BCM_VLAN_PORT_RECYCLE               0x10000000 /* Creates ingress only
                                                          control lif. */
#define BCM_VLAN_PORT_EGRESS_SVTAG_PORT_ENABLE 0x20000000 /* Enable the SVTAG
                                                          lookup for the
                                                          VLAN-Port with port as
                                                          the APP ID. */
#define BCM_VLAN_PORT_EGRESS_SVTAG_ENABLE   0x40000000 /* Enable the SVTAG
                                                          lookup for the
                                                          VLAN-Port. */
#define BCM_VLAN_PORT_IVL                   0x80000000 /* Creates an IVL type
                                                          vlan port. */

/* Flags2 for logical layer 2 port. */
#define BCM_VLAN_PORT_FLAGS2_OAM_TRUNK_MEMBER 0x00000001 /* Identify OAM endpoint
                                                          to be per Trunk
                                                          member. */
...
#define BCM_VLAN_ACTION_SET_HIGIG3_EXTENSION_ADD 0x00200000 /* Add a HIGIG3 extension
                                                          header. */
#define BCM_VLAN_ACTION_SET_PAYLOAD_OUTER_TAG_STATUS_PRESERVE 0x00400000 /* Preserve the parsing
                                                          outer tag status of
                                                          payload for L2 tunnel
                                                          encapsulation. */
#define BCM_VLAN_ACTION_SET_OUTER_TAG_ACTION_DISABLE 0x00800000 /* Disable the action
                                                          configured on
                                                          outer_tag. */
#define BCM_VLAN_ACTION_SET_INNER_TAG_ACTION_DISABLE 0x01000000 /* Disable the action
                                                          configured on
                                                          inner_tag. */
#define BCM_VLAN_ACTION_SET_OUTER_TAG_DISABLE 0x02000000 /* Disable the outer tag
                                                          value including VLAN
                                                          ID/priority/CFI. */
#define BCM_VLAN_ACTION_SET_ENHANCED_EGRESS_TAG_ACTION 0x04000000 /* Extend the egress
                                                          translation tag
                                                          actions to include nop
                                                          and replace. */
#define BCM_VLAN_ACTION_SET_COPY_IDOT1P_TO_ODOT1P 0x08000000 /* Copy the inner dot1p
                                                          to outer dot1p. */
...
typedef enum bcm_vlan_match_e {
    ...
    BCM_VLAN_MATCH_PORT_ETAG_VLAN = 3,  /* Match on port, ETAG VLAN ID and outer
                                           VLAN ID */
    BCM_VLAN_MATCH_PORT_ETAG_INNER_VLAN = 4, /* Match on port, ETAG VLAN ID and inner
                                           VLAN ID */
    BCM_VLAN_MATCH_PORT_ETAG_VLAN_STACKED = 5, /* Match on port, ETAG VLAN ID, outer
                                           and inner VLAN ID */
    BCM_VLAN_MATCH_PORT_CLASS_ETAG_VLAN = 6, /* Match on port-group, ETAG VLAN ID and
                                           outer VLAN ID */
    BCM_VLAN_MATCH_PORT_CLASS_ETAG_INNER_VLAN = 7, /* Match on port-group, ETAG VLAN ID and
                                           inner VLAN ID */
    BCM_VLAN_MATCH_PORT_CLASS_ETAG_VLAN_STACKED = 8, /* Match on port-group, ETAG VLAN ID,
                                           outer and inner VLAN ID */
    BCM_VLAN_MATCH_PORT_CLASS_ETAG = 9, /* Match on port-group and ETAG VLAN ID */
    BCM_VALN_MATCH_COUNT = 10           /* Must be Last */
} bcm_vlan_match_t;
...
typedef struct bcm_vlan_match_info_s {
    ...
    bcm_vlan_t etag_vlan;   /* Match VLAN ID in the ETAG header */
    bcm_vlan_t outer_vlan;  /* Match outer VLAN ID */
    bcm_vlan_t inner_vlan;  /* Match inner VLAN ID */
...
typedef struct bcm_vlan_translate_egress_key_config_s {
    ...
    bcm_vlan_t ingress_outer_vlan;      /* Incoming packet's Outer VLAN ID to
                                           match. */
...
/* 
 * Attach a flex counter into a given egress VLAN translation table with
 * additional keys.
 */
extern int bcm_vlan_translate_egress_flexctr_extended_attach(
    int unit, 
    bcm_vlan_translate_egress_key_config_t *key_config, 
    bcm_vlan_flexctr_config_t *config);

/* 
 * Detach a flex counter from a given egress VLAN translation table with
 * additional keys.
 */
extern int bcm_vlan_translate_egress_flexctr_extended_detach(
    int unit, 
    bcm_vlan_translate_egress_key_config_t *key_config, 
    bcm_vlan_flexctr_config_t *config);

/* 
 * Detach all flex counters from a given egress VLAN translation table
 * with additional keys.
 */
extern int bcm_vlan_translate_egress_flexctr_extended_detach_all(
    int unit, 
    bcm_vlan_translate_egress_key_config_t *key_config);

/* 
 * Get the attached flex counters from a given egress VLAN translation
 * table with additional keys.
 */
extern int bcm_vlan_translate_egress_flexctr_extended_get(
    int unit, 
    bcm_vlan_translate_egress_key_config_t *key_config, 
    int array_size, 
    bcm_vlan_flexctr_config_t *config_array, 
...
/* Initialize a bcm_vlan_svtag_config_t structure. */
extern void bcm_vlan_svtag_config_t_init(
    bcm_vlan_svtag_config_t *svtag);
