...
typedef enum bcm_tsn_taf_status_e {
    ...
    bcmTsnTafStatusMaxCalendarEntries = 5, /* The max entries could be support in
                                           calendar table. */
    bcmTsnTafStatusGatMaxBytesLeft = 6, /* Lower 32-bit value of bytes available
                                           that can pass through that gate
                                           during current open state. */
    bcmTsnTafStatusGatMaxBytesLeftHigh = 7, /* Higher 32-bit value of bytes
                                           available that can pass through that
                                           gate during current open state. */
    bcmTsnTafStatusCount = 8            /* This should be the last one. */
...
#define BCM_TSN_TAF_CALENDAR_TABLE_SIZE (128)      
