...
typedef enum bcm_pstats_session_element_type_e {
    ...
    bcmPStatsSessionRqePool = 13,       /* PSTATS session element type for RQE
                                           pool */
    bcmPstatsSessionRqeQueuePacket = 14, /* RQE queue size on packet */
    bcmPstatsSessionRqePoolPacket = 15, /* RQE pool size on packet */
    bcmPStatsSessionTypeCount = 16      /* Max value defined for this enum */
