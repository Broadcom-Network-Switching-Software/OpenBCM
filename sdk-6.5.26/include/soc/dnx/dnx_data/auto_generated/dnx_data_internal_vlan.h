...
int dnx_data_vlan_esem_feature_get(
    int unit,
...
typedef enum
{
    ...
    _dnx_data_vlan_esem_define_nof
} dnx_data_vlan_esem_define_e;
...
typedef enum
{
    ...
    _dnx_data_vlan_esem_table_nof
} dnx_data_vlan_esem_table_e;
