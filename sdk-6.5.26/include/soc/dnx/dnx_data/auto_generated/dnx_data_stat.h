...
typedef enum
{
    dnx_data_stat_stat_pp_epp_combined_interfaces,
    dnx_data_stat_stat_pp_full_stat_support,
    dnx_data_stat_stat_pp_erpp_counter_profile_per_outlif,
    dnx_data_stat_stat_pp_reduced_fec_stat_cmd,
    dnx_data_stat_stat_pp_fec_protection_stat_id_is_minus_one,
    dnx_data_stat_stat_pp_protection_direct_stat_only,
...
typedef uint32(
    *dnx_data_stat_stat_pp_supported_egress_interface_counter_enum_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_stat_stat_pp_supported_egress_interface_counter_enum_get_f supported_egress_interface_counter_enum_get;
