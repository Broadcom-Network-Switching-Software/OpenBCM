...
typedef struct
{
    ...
    bcm_pbmp_t val;
} dnx_data_lane_map_otn_logical_lanes_t;
...
typedef struct
{
    ...
    int val;
} dnx_data_lane_map_otn_logical_otn_lane_t;
...
typedef enum
{
    ...
    _dnx_data_lane_map_otn_feature_nof
} dnx_data_lane_map_otn_feature_e;



typedef int(
    *dnx_data_lane_map_otn_feature_get_f) (
    int unit,
    dnx_data_lane_map_otn_feature_e feature);


typedef const dnx_data_lane_map_otn_logical_lanes_t *(
    *dnx_data_lane_map_otn_logical_lanes_get_f) (
    int unit,
    int port);


typedef const dnx_data_lane_map_otn_logical_otn_lane_t *(
    *dnx_data_lane_map_otn_logical_otn_lane_get_f) (
    int unit,
    int port);
...
typedef struct
{
    ...
    dnx_data_lane_map_otn_feature_get_f feature_get;
    
    dnx_data_lane_map_otn_logical_lanes_get_f logical_lanes_get;
    
    dnxc_data_table_info_get_f logical_lanes_info_get;
    
    dnx_data_lane_map_otn_logical_otn_lane_get_f logical_otn_lane_get;
    
    dnxc_data_table_info_get_f logical_otn_lane_info_get;
} dnx_data_if_lane_map_otn_t;
...
typedef struct
{
    ...
    dnx_data_if_lane_map_otn_t otn;
