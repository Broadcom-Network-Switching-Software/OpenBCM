...
typedef uint32(
    *dnx_data_gtimer_fdt_block_index_size_get_f) (
    int unit);


typedef uint32(
    *dnx_data_gtimer_fdt_block_index_max_value_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_gtimer_fdt_block_index_size_get_f block_index_size_get;
    
    dnx_data_gtimer_fdt_block_index_max_value_get_f block_index_max_value_get;
...
typedef uint32(
    *dnx_data_gtimer_dhc_block_index_size_get_f) (
    int unit);


typedef uint32(
    *dnx_data_gtimer_dhc_block_index_max_value_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_gtimer_dhc_block_index_size_get_f block_index_size_get;
    
    dnx_data_gtimer_dhc_block_index_max_value_get_f block_index_max_value_get;
...
typedef enum
{
    dnx_data_gtimer_msw_is_supported,

    
    _dnx_data_gtimer_msw_feature_nof
} dnx_data_gtimer_msw_feature_e;



typedef int(
    *dnx_data_gtimer_msw_feature_get_f) (
    int unit,
    dnx_data_gtimer_msw_feature_e feature);


typedef uint32(
    *dnx_data_gtimer_msw_block_index_size_get_f) (
    int unit);


typedef uint32(
    *dnx_data_gtimer_msw_block_index_max_value_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_gtimer_msw_feature_get_f feature_get;
    
    dnx_data_gtimer_msw_block_index_size_get_f block_index_size_get;
    
    dnx_data_gtimer_msw_block_index_max_value_get_f block_index_max_value_get;
} dnx_data_if_gtimer_msw_t;
...
typedef enum
{
    dnx_data_gtimer_arb_is_supported,

    
    _dnx_data_gtimer_arb_feature_nof
} dnx_data_gtimer_arb_feature_e;



typedef int(
    *dnx_data_gtimer_arb_feature_get_f) (
    int unit,
    dnx_data_gtimer_arb_feature_e feature);


typedef uint32(
    *dnx_data_gtimer_arb_block_index_size_get_f) (
    int unit);


typedef uint32(
    *dnx_data_gtimer_arb_block_index_max_value_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_gtimer_arb_feature_get_f feature_get;
    
    dnx_data_gtimer_arb_block_index_size_get_f block_index_size_get;
    
    dnx_data_gtimer_arb_block_index_max_value_get_f block_index_max_value_get;
} dnx_data_if_gtimer_arb_t;
...
typedef enum
{
    dnx_data_gtimer_ofr_is_supported,

    
    _dnx_data_gtimer_ofr_feature_nof
} dnx_data_gtimer_ofr_feature_e;



typedef int(
    *dnx_data_gtimer_ofr_feature_get_f) (
    int unit,
    dnx_data_gtimer_ofr_feature_e feature);


typedef uint32(
    *dnx_data_gtimer_ofr_block_index_size_get_f) (
    int unit);


typedef uint32(
    *dnx_data_gtimer_ofr_block_index_max_value_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_gtimer_ofr_feature_get_f feature_get;
    
    dnx_data_gtimer_ofr_block_index_size_get_f block_index_size_get;
    
    dnx_data_gtimer_ofr_block_index_max_value_get_f block_index_max_value_get;
} dnx_data_if_gtimer_ofr_t;
...
typedef enum
{
    dnx_data_gtimer_oft_is_supported,

    
    _dnx_data_gtimer_oft_feature_nof
} dnx_data_gtimer_oft_feature_e;



typedef int(
    *dnx_data_gtimer_oft_feature_get_f) (
    int unit,
    dnx_data_gtimer_oft_feature_e feature);


typedef uint32(
    *dnx_data_gtimer_oft_block_index_size_get_f) (
    int unit);


typedef uint32(
    *dnx_data_gtimer_oft_block_index_max_value_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_gtimer_oft_feature_get_f feature_get;
    
    dnx_data_gtimer_oft_block_index_size_get_f block_index_size_get;
    
    dnx_data_gtimer_oft_block_index_max_value_get_f block_index_max_value_get;
} dnx_data_if_gtimer_oft_t;
...
typedef enum
{
    dnx_data_gtimer_frwa_is_supported,

    
    _dnx_data_gtimer_frwa_feature_nof
} dnx_data_gtimer_frwa_feature_e;



typedef int(
    *dnx_data_gtimer_frwa_feature_get_f) (
    int unit,
    dnx_data_gtimer_frwa_feature_e feature);


typedef uint32(
    *dnx_data_gtimer_frwa_block_index_size_get_f) (
    int unit);


typedef uint32(
    *dnx_data_gtimer_frwa_block_index_max_value_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_gtimer_frwa_feature_get_f feature_get;
    
    dnx_data_gtimer_frwa_block_index_size_get_f block_index_size_get;
    
    dnx_data_gtimer_frwa_block_index_max_value_get_f block_index_max_value_get;
} dnx_data_if_gtimer_frwa_t;
...
typedef enum
{
    dnx_data_gtimer_frwbc_is_supported,

    
    _dnx_data_gtimer_frwbc_feature_nof
} dnx_data_gtimer_frwbc_feature_e;



typedef int(
    *dnx_data_gtimer_frwbc_feature_get_f) (
    int unit,
    dnx_data_gtimer_frwbc_feature_e feature);


typedef uint32(
    *dnx_data_gtimer_frwbc_block_index_size_get_f) (
    int unit);


typedef uint32(
    *dnx_data_gtimer_frwbc_block_index_max_value_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_gtimer_frwbc_feature_get_f feature_get;
    
    dnx_data_gtimer_frwbc_block_index_size_get_f block_index_size_get;
    
    dnx_data_gtimer_frwbc_block_index_max_value_get_f block_index_max_value_get;
} dnx_data_if_gtimer_frwbc_t;
...
typedef enum
{
    dnx_data_gtimer_wb_is_supported,

    
    _dnx_data_gtimer_wb_feature_nof
} dnx_data_gtimer_wb_feature_e;



typedef int(
    *dnx_data_gtimer_wb_feature_get_f) (
    int unit,
    dnx_data_gtimer_wb_feature_e feature);


typedef uint32(
    *dnx_data_gtimer_wb_block_index_size_get_f) (
    int unit);


typedef uint32(
    *dnx_data_gtimer_wb_block_index_max_value_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_gtimer_wb_feature_get_f feature_get;
    
    dnx_data_gtimer_wb_block_index_size_get_f block_index_size_get;
    
    dnx_data_gtimer_wb_block_index_max_value_get_f block_index_max_value_get;
} dnx_data_if_gtimer_wb_t;
...
typedef enum
{
    dnx_data_gtimer_w40_is_supported,

    
    _dnx_data_gtimer_w40_feature_nof
} dnx_data_gtimer_w40_feature_e;



typedef int(
    *dnx_data_gtimer_w40_feature_get_f) (
    int unit,
    dnx_data_gtimer_w40_feature_e feature);


typedef uint32(
    *dnx_data_gtimer_w40_block_index_size_get_f) (
    int unit);


typedef uint32(
    *dnx_data_gtimer_w40_block_index_max_value_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_gtimer_w40_feature_get_f feature_get;
    
    dnx_data_gtimer_w40_block_index_size_get_f block_index_size_get;
    
    dnx_data_gtimer_w40_block_index_max_value_get_f block_index_max_value_get;
} dnx_data_if_gtimer_w40_t;
...
typedef enum
{
    dnx_data_gtimer_msu_is_supported,

    
    _dnx_data_gtimer_msu_feature_nof
} dnx_data_gtimer_msu_feature_e;



typedef int(
    *dnx_data_gtimer_msu_feature_get_f) (
    int unit,
    dnx_data_gtimer_msu_feature_e feature);


typedef uint32(
    *dnx_data_gtimer_msu_block_index_size_get_f) (
    int unit);


typedef uint32(
    *dnx_data_gtimer_msu_block_index_max_value_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_gtimer_msu_feature_get_f feature_get;
    
    dnx_data_gtimer_msu_block_index_size_get_f block_index_size_get;
    
    dnx_data_gtimer_msu_block_index_max_value_get_f block_index_max_value_get;
} dnx_data_if_gtimer_msu_t;
...
typedef enum
{
    dnx_data_gtimer_pmu_is_supported,

    
    _dnx_data_gtimer_pmu_feature_nof
} dnx_data_gtimer_pmu_feature_e;



typedef int(
    *dnx_data_gtimer_pmu_feature_get_f) (
    int unit,
    dnx_data_gtimer_pmu_feature_e feature);


typedef uint32(
    *dnx_data_gtimer_pmu_block_index_size_get_f) (
    int unit);


typedef uint32(
    *dnx_data_gtimer_pmu_block_index_max_value_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_gtimer_pmu_feature_get_f feature_get;
    
    dnx_data_gtimer_pmu_block_index_size_get_f block_index_size_get;
    
    dnx_data_gtimer_pmu_block_index_max_value_get_f block_index_max_value_get;
} dnx_data_if_gtimer_pmu_t;
...
typedef enum
{
    dnx_data_gtimer_nbu_is_supported,

    
    _dnx_data_gtimer_nbu_feature_nof
} dnx_data_gtimer_nbu_feature_e;



typedef int(
    *dnx_data_gtimer_nbu_feature_get_f) (
    int unit,
    dnx_data_gtimer_nbu_feature_e feature);


typedef uint32(
    *dnx_data_gtimer_nbu_block_index_size_get_f) (
    int unit);


typedef uint32(
    *dnx_data_gtimer_nbu_block_index_max_value_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_gtimer_nbu_feature_get_f feature_get;
    
    dnx_data_gtimer_nbu_block_index_size_get_f block_index_size_get;
    
    dnx_data_gtimer_nbu_block_index_max_value_get_f block_index_max_value_get;
} dnx_data_if_gtimer_nbu_t;
...
typedef enum
{
    dnx_data_gtimer_mgu_is_supported,

    
    _dnx_data_gtimer_mgu_feature_nof
} dnx_data_gtimer_mgu_feature_e;



typedef int(
    *dnx_data_gtimer_mgu_feature_get_f) (
    int unit,
    dnx_data_gtimer_mgu_feature_e feature);


typedef uint32(
    *dnx_data_gtimer_mgu_block_index_size_get_f) (
    int unit);


typedef uint32(
    *dnx_data_gtimer_mgu_block_index_max_value_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_gtimer_mgu_feature_get_f feature_get;
    
    dnx_data_gtimer_mgu_block_index_size_get_f block_index_size_get;
    
    dnx_data_gtimer_mgu_block_index_max_value_get_f block_index_max_value_get;
} dnx_data_if_gtimer_mgu_t;
...
typedef enum
{
    dnx_data_gtimer_ipw_is_supported,

    
    _dnx_data_gtimer_ipw_feature_nof
} dnx_data_gtimer_ipw_feature_e;



typedef int(
    *dnx_data_gtimer_ipw_feature_get_f) (
    int unit,
    dnx_data_gtimer_ipw_feature_e feature);


typedef uint32(
    *dnx_data_gtimer_ipw_block_index_size_get_f) (
    int unit);


typedef uint32(
    *dnx_data_gtimer_ipw_block_index_max_value_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_gtimer_ipw_feature_get_f feature_get;
    
    dnx_data_gtimer_ipw_block_index_size_get_f block_index_size_get;
    
    dnx_data_gtimer_ipw_block_index_max_value_get_f block_index_max_value_get;
} dnx_data_if_gtimer_ipw_t;
...
typedef struct
{
    ...
    dnx_data_if_gtimer_msw_t msw;
    
    dnx_data_if_gtimer_arb_t arb;
    
    dnx_data_if_gtimer_ofr_t ofr;
    
    dnx_data_if_gtimer_oft_t oft;
    
    dnx_data_if_gtimer_frwa_t frwa;
    
    dnx_data_if_gtimer_frwbc_t frwbc;
    
    dnx_data_if_gtimer_wb_t wb;
    
    dnx_data_if_gtimer_w40_t w40;
    
    dnx_data_if_gtimer_msu_t msu;
    
    dnx_data_if_gtimer_pmu_t pmu;
    
    dnx_data_if_gtimer_nbu_t nbu;
    
    dnx_data_if_gtimer_mgu_t mgu;
    
    dnx_data_if_gtimer_ipw_t ipw;
