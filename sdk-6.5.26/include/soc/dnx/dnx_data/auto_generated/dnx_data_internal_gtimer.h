...
typedef enum
{
    ...
    dnx_data_gtimer_submodule_msw,
    dnx_data_gtimer_submodule_arb,
    dnx_data_gtimer_submodule_ofr,
    dnx_data_gtimer_submodule_oft,
    dnx_data_gtimer_submodule_frwa,
    dnx_data_gtimer_submodule_frwbc,
    dnx_data_gtimer_submodule_wb,
    dnx_data_gtimer_submodule_w40,
    dnx_data_gtimer_submodule_msu,
    dnx_data_gtimer_submodule_pmu,
    dnx_data_gtimer_submodule_nbu,
    dnx_data_gtimer_submodule_mgu,
    dnx_data_gtimer_submodule_ipw,
...
typedef enum
{
    dnx_data_gtimer_fdt_define_block_index_size,
    dnx_data_gtimer_fdt_define_block_index_max_value,
...
uint32 dnx_data_gtimer_fdt_block_index_size_get(
    int unit);


uint32 dnx_data_gtimer_fdt_block_index_max_value_get(
    int unit);
...
typedef enum
{
    dnx_data_gtimer_dhc_define_block_index_size,
    dnx_data_gtimer_dhc_define_block_index_max_value,
...
uint32 dnx_data_gtimer_dhc_block_index_size_get(
    int unit);


uint32 dnx_data_gtimer_dhc_block_index_max_value_get(
    int unit);
...
int dnx_data_gtimer_msw_feature_get(
    int unit,
...
typedef enum
{
    dnx_data_gtimer_msw_define_block_index_size,
    dnx_data_gtimer_msw_define_block_index_max_value,

    
    _dnx_data_gtimer_msw_define_nof
} dnx_data_gtimer_msw_define_e;



uint32 dnx_data_gtimer_msw_block_index_size_get(
    int unit);


uint32 dnx_data_gtimer_msw_block_index_max_value_get(
    int unit);
...
typedef enum
{
    ...
    _dnx_data_gtimer_msw_table_nof
} dnx_data_gtimer_msw_table_e;
...
int dnx_data_gtimer_arb_feature_get(
    int unit,
...
typedef enum
{
    dnx_data_gtimer_arb_define_block_index_size,
    dnx_data_gtimer_arb_define_block_index_max_value,

    
    _dnx_data_gtimer_arb_define_nof
} dnx_data_gtimer_arb_define_e;



uint32 dnx_data_gtimer_arb_block_index_size_get(
    int unit);


uint32 dnx_data_gtimer_arb_block_index_max_value_get(
    int unit);
...
typedef enum
{
    ...
    _dnx_data_gtimer_arb_table_nof
} dnx_data_gtimer_arb_table_e;
...
int dnx_data_gtimer_ofr_feature_get(
    int unit,
...
typedef enum
{
    dnx_data_gtimer_ofr_define_block_index_size,
    dnx_data_gtimer_ofr_define_block_index_max_value,

    
    _dnx_data_gtimer_ofr_define_nof
} dnx_data_gtimer_ofr_define_e;



uint32 dnx_data_gtimer_ofr_block_index_size_get(
    int unit);


uint32 dnx_data_gtimer_ofr_block_index_max_value_get(
    int unit);
...
typedef enum
{
    ...
    _dnx_data_gtimer_ofr_table_nof
} dnx_data_gtimer_ofr_table_e;
...
int dnx_data_gtimer_oft_feature_get(
    int unit,
...
typedef enum
{
    dnx_data_gtimer_oft_define_block_index_size,
    dnx_data_gtimer_oft_define_block_index_max_value,

    
    _dnx_data_gtimer_oft_define_nof
} dnx_data_gtimer_oft_define_e;



uint32 dnx_data_gtimer_oft_block_index_size_get(
    int unit);


uint32 dnx_data_gtimer_oft_block_index_max_value_get(
    int unit);
...
typedef enum
{
    ...
    _dnx_data_gtimer_oft_table_nof
} dnx_data_gtimer_oft_table_e;
...
int dnx_data_gtimer_frwa_feature_get(
    int unit,
...
typedef enum
{
    dnx_data_gtimer_frwa_define_block_index_size,
    dnx_data_gtimer_frwa_define_block_index_max_value,

    
    _dnx_data_gtimer_frwa_define_nof
} dnx_data_gtimer_frwa_define_e;



uint32 dnx_data_gtimer_frwa_block_index_size_get(
    int unit);


uint32 dnx_data_gtimer_frwa_block_index_max_value_get(
    int unit);
...
typedef enum
{
    ...
    _dnx_data_gtimer_frwa_table_nof
} dnx_data_gtimer_frwa_table_e;
...
int dnx_data_gtimer_frwbc_feature_get(
    int unit,
...
typedef enum
{
    dnx_data_gtimer_frwbc_define_block_index_size,
    dnx_data_gtimer_frwbc_define_block_index_max_value,

    
    _dnx_data_gtimer_frwbc_define_nof
} dnx_data_gtimer_frwbc_define_e;



uint32 dnx_data_gtimer_frwbc_block_index_size_get(
    int unit);


uint32 dnx_data_gtimer_frwbc_block_index_max_value_get(
    int unit);
...
typedef enum
{
    ...
    _dnx_data_gtimer_frwbc_table_nof
} dnx_data_gtimer_frwbc_table_e;
...
int dnx_data_gtimer_wb_feature_get(
    int unit,
...
typedef enum
{
    dnx_data_gtimer_wb_define_block_index_size,
    dnx_data_gtimer_wb_define_block_index_max_value,

    
    _dnx_data_gtimer_wb_define_nof
} dnx_data_gtimer_wb_define_e;



uint32 dnx_data_gtimer_wb_block_index_size_get(
    int unit);


uint32 dnx_data_gtimer_wb_block_index_max_value_get(
    int unit);
...
typedef enum
{
    ...
    _dnx_data_gtimer_wb_table_nof
} dnx_data_gtimer_wb_table_e;
...
int dnx_data_gtimer_w40_feature_get(
    int unit,
...
typedef enum
{
    dnx_data_gtimer_w40_define_block_index_size,
    dnx_data_gtimer_w40_define_block_index_max_value,

    
    _dnx_data_gtimer_w40_define_nof
} dnx_data_gtimer_w40_define_e;



uint32 dnx_data_gtimer_w40_block_index_size_get(
    int unit);


uint32 dnx_data_gtimer_w40_block_index_max_value_get(
    int unit);
...
typedef enum
{
    ...
    _dnx_data_gtimer_w40_table_nof
} dnx_data_gtimer_w40_table_e;
...
int dnx_data_gtimer_msu_feature_get(
    int unit,
...
typedef enum
{
    dnx_data_gtimer_msu_define_block_index_size,
    dnx_data_gtimer_msu_define_block_index_max_value,

    
    _dnx_data_gtimer_msu_define_nof
} dnx_data_gtimer_msu_define_e;



uint32 dnx_data_gtimer_msu_block_index_size_get(
    int unit);


uint32 dnx_data_gtimer_msu_block_index_max_value_get(
    int unit);
...
typedef enum
{
    ...
    _dnx_data_gtimer_msu_table_nof
} dnx_data_gtimer_msu_table_e;
...
int dnx_data_gtimer_pmu_feature_get(
    int unit,
...
typedef enum
{
    dnx_data_gtimer_pmu_define_block_index_size,
    dnx_data_gtimer_pmu_define_block_index_max_value,

    
    _dnx_data_gtimer_pmu_define_nof
} dnx_data_gtimer_pmu_define_e;



uint32 dnx_data_gtimer_pmu_block_index_size_get(
    int unit);


uint32 dnx_data_gtimer_pmu_block_index_max_value_get(
    int unit);
...
typedef enum
{
    ...
    _dnx_data_gtimer_pmu_table_nof
} dnx_data_gtimer_pmu_table_e;
...
int dnx_data_gtimer_nbu_feature_get(
    int unit,
...
typedef enum
{
    dnx_data_gtimer_nbu_define_block_index_size,
    dnx_data_gtimer_nbu_define_block_index_max_value,

    
    _dnx_data_gtimer_nbu_define_nof
} dnx_data_gtimer_nbu_define_e;



uint32 dnx_data_gtimer_nbu_block_index_size_get(
    int unit);


uint32 dnx_data_gtimer_nbu_block_index_max_value_get(
    int unit);
...
typedef enum
{
    ...
    _dnx_data_gtimer_nbu_table_nof
} dnx_data_gtimer_nbu_table_e;
...
int dnx_data_gtimer_mgu_feature_get(
    int unit,
...
typedef enum
{
    dnx_data_gtimer_mgu_define_block_index_size,
    dnx_data_gtimer_mgu_define_block_index_max_value,

    
    _dnx_data_gtimer_mgu_define_nof
} dnx_data_gtimer_mgu_define_e;



uint32 dnx_data_gtimer_mgu_block_index_size_get(
    int unit);


uint32 dnx_data_gtimer_mgu_block_index_max_value_get(
    int unit);
...
typedef enum
{
    ...
    _dnx_data_gtimer_mgu_table_nof
} dnx_data_gtimer_mgu_table_e;
...
int dnx_data_gtimer_ipw_feature_get(
    int unit,
...
typedef enum
{
    dnx_data_gtimer_ipw_define_block_index_size,
    dnx_data_gtimer_ipw_define_block_index_max_value,

    
    _dnx_data_gtimer_ipw_define_nof
} dnx_data_gtimer_ipw_define_e;



uint32 dnx_data_gtimer_ipw_block_index_size_get(
    int unit);


uint32 dnx_data_gtimer_ipw_block_index_max_value_get(
    int unit);
...
typedef enum
{
    ...
    _dnx_data_gtimer_ipw_table_nof
} dnx_data_gtimer_ipw_table_e;
