...
typedef enum
{
    ...
    dnx_data_ecgm_submodule_queue_resources,
    dnx_data_ecgm_submodule_interface_resources,
...
typedef enum
{
    ...
    dnx_data_ecgm_general_define_max_fadt_references,
...
uint32 dnx_data_ecgm_general_max_fadt_references_get(
    int unit);
...
typedef enum
{
    ...
    dnx_data_ecgm_core_resources_define_nof_tc_dp_admission_profiles,
...
uint32 dnx_data_ecgm_core_resources_nof_tc_dp_admission_profiles_get(
    int unit);
...
int dnx_data_ecgm_queue_resources_feature_get(
    int unit,
...
typedef enum
{
    ...
    _dnx_data_ecgm_queue_resources_define_nof
} dnx_data_ecgm_queue_resources_define_e;
...
typedef enum
{
    ...
    _dnx_data_ecgm_queue_resources_table_nof
} dnx_data_ecgm_queue_resources_table_e;
...
int dnx_data_ecgm_interface_resources_feature_get(
    int unit,
...
typedef enum
{
    ...
    _dnx_data_ecgm_interface_resources_define_nof
} dnx_data_ecgm_interface_resources_define_e;
...
typedef enum
{
    ...
    _dnx_data_ecgm_interface_resources_table_nof
} dnx_data_ecgm_interface_resources_table_e;
