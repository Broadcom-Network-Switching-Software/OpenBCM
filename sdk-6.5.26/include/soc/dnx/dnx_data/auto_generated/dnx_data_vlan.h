...
typedef enum
{
    dnx_data_vlan_esem_ac_info,

    
    _dnx_data_vlan_esem_feature_nof
} dnx_data_vlan_esem_feature_e;



typedef int(
    *dnx_data_vlan_esem_feature_get_f) (
    int unit,
...
typedef struct
{
    ...
    dnx_data_vlan_esem_feature_get_f feature_get;
} dnx_data_if_vlan_esem_t;
