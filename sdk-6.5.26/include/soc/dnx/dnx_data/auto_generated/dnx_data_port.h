...
typedef enum
{
    ...
    dnx_data_port_general_is_phy_rx_taps_supported,
...
typedef enum
{
    ...
    _dnx_data_port_fabric_signal_quality_feature_nof
} dnx_data_port_fabric_signal_quality_feature_e;



typedef int(
    *dnx_data_port_fabric_signal_quality_feature_get_f) (
    int unit,
    dnx_data_port_fabric_signal_quality_feature_e feature);


typedef uint32(
    *dnx_data_port_fabric_signal_quality_max_interval_in_cycles_get_f) (
    int unit);


typedef uint32(
    *dnx_data_port_fabric_signal_quality_max_degrade_threshold_get_f) (
    int unit);


typedef uint32(
    *dnx_data_port_fabric_signal_quality_min_degrade_threshold_get_f) (
    int unit);


typedef uint32(
    *dnx_data_port_fabric_signal_quality_max_fail_threshold_get_f) (
    int unit);


typedef uint32(
    *dnx_data_port_fabric_signal_quality_min_fail_threshold_get_f) (
    int unit);


typedef uint32(
    *dnx_data_port_fabric_signal_quality_max_interval_get_f) (
    int unit);


typedef uint32(
    *dnx_data_port_fabric_signal_quality_min_interval_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_port_fabric_signal_quality_feature_get_f feature_get;
    
    dnx_data_port_fabric_signal_quality_max_interval_in_cycles_get_f max_interval_in_cycles_get;
    
    dnx_data_port_fabric_signal_quality_max_degrade_threshold_get_f max_degrade_threshold_get;
    
    dnx_data_port_fabric_signal_quality_min_degrade_threshold_get_f min_degrade_threshold_get;
    
    dnx_data_port_fabric_signal_quality_max_fail_threshold_get_f max_fail_threshold_get;
    
    dnx_data_port_fabric_signal_quality_min_fail_threshold_get_f min_fail_threshold_get;
    
    dnx_data_port_fabric_signal_quality_max_interval_get_f max_interval_get;
    
    dnx_data_port_fabric_signal_quality_min_interval_get_f min_interval_get;
} dnx_data_if_port_fabric_signal_quality_t;
...
typedef struct
{
    ...
    dnx_data_if_port_fabric_signal_quality_t fabric_signal_quality;
} dnx_data_if_port_t;
