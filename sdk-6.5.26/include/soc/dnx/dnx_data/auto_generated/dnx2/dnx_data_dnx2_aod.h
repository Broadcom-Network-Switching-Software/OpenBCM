...
typedef struct
{
    ...
    char *image;
} dnx_data_dnx2_aod_tables_INGRESS_PRT_INFO___image_t;
...
typedef struct
{
    ...
    char *PORT_TERMINATION_PTC_PROFILE;
    
    uint32 PORT_TERMINATION_PTC_PROFILE_mask;
    
    uint32 PORT_TERMINATION_PTC_PROFILE_valid;
    
    char *RECYCLE_CMD_PRT_PROFILE;
    
    uint32 RECYCLE_CMD_PRT_PROFILE_mask;
    
    uint32 RECYCLE_CMD_PRT_PROFILE_valid;
    
    uint32 FFC_0_Input_Offset;
    
    uint32 FFC_0_Input_Offset_valid;
    
    uint32 FFC_0_Offset;
    
    uint32 FFC_0_Offset_valid;
    
    uint32 FFC_0_Width;
    
    uint32 FFC_0_Width_valid;
    
    uint32 FFC_1_Input_Offset;
    
    uint32 FFC_1_Input_Offset_valid;
    
    uint32 FFC_1_Offset;
    
    uint32 FFC_1_Offset_valid;
    
    uint32 FFC_1_Width;
    
    uint32 FFC_1_Width_valid;
    
    uint32 FFC_2_Input_Offset;
    
    uint32 FFC_2_Input_Offset_valid;
    
    uint32 FFC_2_Offset;
    
    uint32 FFC_2_Offset_valid;
    
    uint32 FFC_2_Width;
    
    uint32 FFC_2_Width_valid;
    
    uint32 FFC_3_Input_Offset;
    
    uint32 FFC_3_Input_Offset_valid;
    
    uint32 FFC_3_Offset;
    
    uint32 FFC_3_Offset_valid;
    
    uint32 FFC_3_Width;
    
    uint32 FFC_3_Width_valid;
    
    uint32 FFC_4_Input_Offset;
    
    uint32 FFC_4_Input_Offset_valid;
    
    uint32 FFC_4_Offset;
    
    uint32 FFC_4_Offset_valid;
    
    uint32 FFC_4_Width;
    
    uint32 FFC_4_Width_valid;
    
    uint32 FFC_5_Input_Offset;
    
    uint32 FFC_5_Input_Offset_valid;
    
    uint32 FFC_5_Offset;
    
    uint32 FFC_5_Offset_valid;
    
    uint32 FFC_5_Width;
    
    uint32 FFC_5_Width_valid;
    
    uint32 Layer_Offset;
    
    uint32 Layer_Offset_valid;
    
    uint32 PP_Port_enable;
    
    uint32 PP_Port_enable_valid;
    
    uint32 PRT_Qualifier_KBR_Key;
    
    uint32 PRT_Qualifier_KBR_Key_valid;
    
    uint32 PRT_Qualifier_Mode;
    
    uint32 PRT_Qualifier_Mode_valid;
    
    uint32 Parser_Context_KBR_Key;
    
    uint32 Parser_Context_KBR_Key_valid;
    
    uint32 Parser_Context_Select;
    
    uint32 Parser_Context_Select_valid;
    
    uint32 Parsing_Start_Offset_KBR_Key;
    
    uint32 Parsing_Start_Offset_KBR_Key_valid;
    
    uint32 Source_System_Port_KBR_Key;
    
    uint32 Source_System_Port_KBR_Key_valid;
    
    uint32 Source_System_Port_PRT_Mode;
    
    uint32 Source_System_Port_PRT_Mode_valid;
    
    uint32 TCAM_Mode_Full_enable;
    
    uint32 TCAM_Mode_Full_enable_valid;
    
    uint32 VP_TCAM_or_PP_Port_Direct_KBR_Key;
    
    uint32 VP_TCAM_or_PP_Port_Direct_KBR_Key_valid;
} dnx_data_dnx2_aod_tables_INGRESS_PRT_INFO_t;
...
typedef const dnx_data_dnx2_aod_tables_INGRESS_PRT_INFO___image_t *(
    *dnx_data_dnx2_aod_tables_INGRESS_PRT_INFO___image_get_f) (
    int unit);


typedef const dnx_data_dnx2_aod_tables_INGRESS_PRT_INFO_t *(
    *dnx_data_dnx2_aod_tables_INGRESS_PRT_INFO_get_f) (
    int unit,
    int index);
...
typedef struct
{
    ...
    dnx_data_dnx2_aod_tables_INGRESS_PRT_INFO___image_get_f INGRESS_PRT_INFO___image_get;
    
    dnxc_data_table_info_get_f INGRESS_PRT_INFO___image_info_get;
    
    dnx_data_dnx2_aod_tables_INGRESS_PRT_INFO_get_f INGRESS_PRT_INFO_get;
    
    dnxc_data_table_info_get_f INGRESS_PRT_INFO_info_get;
