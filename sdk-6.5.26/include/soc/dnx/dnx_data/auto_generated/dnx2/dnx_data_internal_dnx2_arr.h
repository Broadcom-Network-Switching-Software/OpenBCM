...
typedef enum
{
    ...
    dnx_data_dnx2_arr_prefix_define_ETPP_ETPS_FORMATS___prefix_Empty2,
    ...
    dnx_data_dnx2_arr_prefix_define_ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_ARP_PLUS_AC,
    ...
    dnx_data_dnx2_arr_prefix_define_IRPP_IN_LIF_FORMATS___prefix_Parser_Context_IPvX_DEMUX_or_ETH_B1__4b_Prefix,
    dnx_data_dnx2_arr_prefix_define_IRPP_IN_LIF_FORMATS___prefix_Empty2,
...
uint32 dnx_data_dnx2_arr_prefix_ETPP_ETPS_FORMATS___prefix_Empty2_get(
    int unit);
...
uint32 dnx_data_dnx2_arr_prefix_ETPP_ETPS_FORMATS___prefix_ESEM_COMMAND_ARP_PLUS_AC_get(
    int unit);
...
uint32 dnx_data_dnx2_arr_prefix_IRPP_IN_LIF_FORMATS___prefix_Parser_Context_IPvX_DEMUX_or_ETH_B1__4b_Prefix_get(
    int unit);


uint32 dnx_data_dnx2_arr_prefix_IRPP_IN_LIF_FORMATS___prefix_Empty2_get(
    int unit);
