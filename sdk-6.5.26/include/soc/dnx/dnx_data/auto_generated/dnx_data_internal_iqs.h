...
typedef enum
{
    ...
    dnx_data_iqs_submodule_general,
...
int dnx_data_iqs_general_feature_get(
    int unit,
...
typedef enum
{
    ...
    _dnx_data_iqs_general_define_nof
} dnx_data_iqs_general_define_e;
...
typedef enum
{
    ...
    _dnx_data_iqs_general_table_nof
} dnx_data_iqs_general_table_e;
