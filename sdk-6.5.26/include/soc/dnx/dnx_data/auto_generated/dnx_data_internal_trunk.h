...
typedef enum
{
    ...
    dnx_data_trunk_submodule_flow_agg,
...
int dnx_data_trunk_flow_agg_feature_get(
    int unit,
...
typedef enum
{
    dnx_data_trunk_flow_agg_define_flow_aggs_in_bundle,
    dnx_data_trunk_flow_agg_define_nof_flow_aggs,
    dnx_data_trunk_flow_agg_define_nof_flow_agg_bundles,
    dnx_data_trunk_flow_agg_define_first_flow_agg_id,

    
    _dnx_data_trunk_flow_agg_define_nof
} dnx_data_trunk_flow_agg_define_e;



uint32 dnx_data_trunk_flow_agg_flow_aggs_in_bundle_get(
    int unit);


uint32 dnx_data_trunk_flow_agg_nof_flow_aggs_get(
    int unit);


uint32 dnx_data_trunk_flow_agg_nof_flow_agg_bundles_get(
    int unit);


uint32 dnx_data_trunk_flow_agg_first_flow_agg_id_get(
    int unit);
...
typedef enum
{
    ...
    _dnx_data_trunk_flow_agg_table_nof
} dnx_data_trunk_flow_agg_table_e;
