...
typedef enum
{
    ...
    dnx_data_elk_general_define_nof_dbs_per_core,
...
uint32 dnx_data_elk_general_nof_dbs_per_core_get(
    int unit);
...
typedef enum
{
    dnx_data_elk_application_define_large_mc_mode1,
    dnx_data_elk_application_define_large_mc_mode2,
    dnx_data_elk_application_define_large_mc_mode3,
...
uint32 dnx_data_elk_application_large_mc_mode1_get(
    int unit);


uint32 dnx_data_elk_application_large_mc_mode2_get(
    int unit);


uint32 dnx_data_elk_application_large_mc_mode3_get(
    int unit);
