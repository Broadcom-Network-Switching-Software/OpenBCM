...
typedef enum
{
    ...
    dnx_data_dram_hbm_define_sbus_execute_delay_default,
    dnx_data_dram_hbm_define_enable_dram_bist_on_init,
...
uint32 dnx_data_dram_hbm_sbus_execute_delay_default_get(
    int unit);


uint32 dnx_data_dram_hbm_enable_dram_bist_on_init_get(
    int unit);
...
typedef enum
{
    ...
    dnx_data_dram_gddr6_define_ck_termination_mr_conf_val,
    dnx_data_dram_gddr6_define_ck_termination_ca_conf_val,
    dnx_data_dram_gddr6_define_wck_granularity,
    dnx_data_dram_gddr6_define_ref_clk_bitmap,
    dnx_data_dram_gddr6_define_ca_termination_conf_val,
...
uint32 dnx_data_dram_gddr6_ck_termination_mr_conf_val_get(
    int unit);


uint32 dnx_data_dram_gddr6_ck_termination_ca_conf_val_get(
    int unit);
...
uint32 dnx_data_dram_gddr6_ca_termination_conf_val_get(
    int unit);
...
typedef enum
{
    ...
    dnx_data_dram_gddr6_table_ca_system_config_fields,
...
const dnx_data_dram_gddr6_ca_system_config_fields_t * dnx_data_dram_gddr6_ca_system_config_fields_get(
    int unit,
    int index);
...
shr_error_e dnx_data_dram_gddr6_ca_system_config_fields_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
const dnxc_data_table_info_t * dnx_data_dram_gddr6_ca_system_config_fields_info_get(
    int unit);
...
typedef enum
{
    ...
    dnx_data_dram_general_info_define_tertw,
...
uint32 dnx_data_dram_general_info_tertw_get(
    int unit);
