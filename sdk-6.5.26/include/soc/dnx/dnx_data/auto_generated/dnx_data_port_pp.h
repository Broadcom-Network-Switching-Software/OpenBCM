...
typedef uint32(
    *dnx_data_port_pp_general_rcy_info_prt_qualifier_eth_over_append64_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_port_pp_general_rcy_info_prt_qualifier_eth_over_append64_get_f rcy_info_prt_qualifier_eth_over_append64_get;
