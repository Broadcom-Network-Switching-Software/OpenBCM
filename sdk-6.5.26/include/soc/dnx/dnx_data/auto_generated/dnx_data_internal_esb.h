...
typedef enum
{
    ...
    dnx_data_esb_general_define_nif_credits_resolution,
    dnx_data_esb_general_define_nif_credits_rate_resolution,
...
uint32 dnx_data_esb_general_nif_credits_resolution_get(
    int unit);


uint32 dnx_data_esb_general_nif_credits_rate_resolution_get(
    int unit);
