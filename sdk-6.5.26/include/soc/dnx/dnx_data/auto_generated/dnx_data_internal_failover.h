...
typedef enum
{
    ...
    dnx_data_failover_path_select_define_ingress_mc_size,
    ...
    dnx_data_failover_path_select_define_ing_mc_no_protection,
    ...
    dnx_data_failover_path_select_define_nof_fec_path_select_banks_in_hw,
...
uint32 dnx_data_failover_path_select_ingress_mc_size_get(
    int unit);
...
uint32 dnx_data_failover_path_select_ing_mc_no_protection_get(
    int unit);
...
uint32 dnx_data_failover_path_select_nof_fec_path_select_banks_in_hw_get(
    int unit);
