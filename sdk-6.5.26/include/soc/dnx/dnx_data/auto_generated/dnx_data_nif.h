...
typedef uint32(
    *dnx_data_nif_global_max_nof_mgmt_ports_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_nif_global_max_nof_mgmt_ports_get_f max_nof_mgmt_ports_get;
...
typedef enum
{
    ...
    dnx_data_nif_mac_client_sb_fifo_force_supported,
...
typedef enum
{
    ...
    dnx_data_nif_features_txpi_supported_in_pm8x50,
