...
#define DNX_ERR_RECOVERY_REGRESSION_API_SKIP_RESET(_unit)\
    dnx_er_regress_sim_reset(_unit)
...
typedef struct dnx_er_regress_d
{
    ...
    dnx_er_regress_transaction_info_t trans_info[DNX_ERR_RECOVERY_MAX_NOF_ACTIVE_TRANSACTION];
} dnx_er_regress_t;
