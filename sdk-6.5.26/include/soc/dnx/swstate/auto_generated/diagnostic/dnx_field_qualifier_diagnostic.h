...
int dnx_field_qual_sw_db_predefined_dump(
    int unit, int predefined_idx_0, dnx_sw_state_dump_filters_t filters);

int dnx_field_qual_sw_db_predefined_field_id_dump(
    int unit, int predefined_idx_0, dnx_sw_state_dump_filters_t filters);

int dnx_field_qual_sw_db_layer_record_dump(
    int unit, int layer_record_idx_0, dnx_sw_state_dump_filters_t filters);

int dnx_field_qual_sw_db_layer_record_field_id_dump(
    int unit, int layer_record_idx_0, dnx_sw_state_dump_filters_t filters);
