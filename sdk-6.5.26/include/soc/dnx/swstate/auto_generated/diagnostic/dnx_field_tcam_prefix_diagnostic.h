...
int dnx_field_tcam_prefix_sw_banks_prefix_core_prefix_map_dump(
    int unit, int banks_prefix_idx_0, int core_prefix_map_idx_0, dnx_sw_state_dump_filters_t filters);

int dnx_field_tcam_prefix_sw_banks_prefix_core_prefix_map_prefix_handler_map_dump(
    int unit, int banks_prefix_idx_0, int core_prefix_map_idx_0, int prefix_handler_map_idx_0, dnx_sw_state_dump_filters_t filters);
