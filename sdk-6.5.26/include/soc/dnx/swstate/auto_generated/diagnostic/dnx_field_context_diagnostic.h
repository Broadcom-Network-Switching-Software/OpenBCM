...
typedef enum {
    ...
    DNX_FIELD_CONTEXT_SW_SCE_INFO_DATA_KEY_TEMPLATE_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_DATA_KEY_TEMPLATE_KEY_QUAL_MAP_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_DATA_KEY_TEMPLATE_KEY_QUAL_MAP_QUAL_TYPE_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_DATA_KEY_TEMPLATE_KEY_QUAL_MAP_LSB_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_DATA_KEY_TEMPLATE_KEY_QUAL_MAP_SIZE_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_DATA_KEY_TEMPLATE_KEY_SIZE_IN_BITS_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_DATA_KEY_ID_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_DATA_KEY_ID_ID_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_DATA_KEY_ID_OFFSET_ON_FIRST_KEY_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_DATA_KEY_ID_NOF_BITS_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_DATA_ATTACH_INFO_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_DATA_ATTACH_INFO_INPUT_TYPE_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_DATA_ATTACH_INFO_INPUT_ARG_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_DATA_ATTACH_INFO_OFFSET_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_DATA_ATTACH_INFO_BASE_QUAL_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_ADDRESS_KEY_TEMPLATE_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_ADDRESS_KEY_TEMPLATE_KEY_QUAL_MAP_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_ADDRESS_KEY_TEMPLATE_KEY_QUAL_MAP_QUAL_TYPE_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_ADDRESS_KEY_TEMPLATE_KEY_QUAL_MAP_LSB_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_ADDRESS_KEY_TEMPLATE_KEY_QUAL_MAP_SIZE_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_ADDRESS_KEY_TEMPLATE_KEY_SIZE_IN_BITS_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_ADDRESS_KEY_ID_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_ADDRESS_KEY_ID_ID_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_ADDRESS_KEY_ID_OFFSET_ON_FIRST_KEY_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_ADDRESS_KEY_ID_NOF_BITS_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_ADDRESS_ATTACH_INFO_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_ADDRESS_ATTACH_INFO_INPUT_TYPE_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_ADDRESS_ATTACH_INFO_INPUT_ARG_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_ADDRESS_ATTACH_INFO_OFFSET_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_ADDRESS_ATTACH_INFO_BASE_QUAL_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_OPCODE_BASED_QUAL_KEY_TEMPLATE_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_OPCODE_BASED_QUAL_KEY_TEMPLATE_KEY_QUAL_MAP_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_OPCODE_BASED_QUAL_KEY_TEMPLATE_KEY_QUAL_MAP_QUAL_TYPE_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_OPCODE_BASED_QUAL_KEY_TEMPLATE_KEY_QUAL_MAP_LSB_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_OPCODE_BASED_QUAL_KEY_TEMPLATE_KEY_QUAL_MAP_SIZE_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_OPCODE_BASED_QUAL_KEY_TEMPLATE_KEY_SIZE_IN_BITS_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_OPCODE_BASED_QUAL_KEY_ID_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_OPCODE_BASED_QUAL_KEY_ID_ID_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_OPCODE_BASED_QUAL_KEY_ID_OFFSET_ON_FIRST_KEY_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_OPCODE_BASED_QUAL_KEY_ID_NOF_BITS_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_OPCODE_BASED_QUAL_ATTACH_INFO_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_OPCODE_BASED_QUAL_ATTACH_INFO_INPUT_TYPE_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_OPCODE_BASED_QUAL_ATTACH_INFO_INPUT_ARG_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_OPCODE_BASED_QUAL_ATTACH_INFO_OFFSET_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_OPCODE_BASED_QUAL_ATTACH_INFO_BASE_QUAL_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_CURRENT_STATE_ACTIONS_ON_PAYLOAD_INFO_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_CURRENT_STATE_ACTIONS_ON_PAYLOAD_INFO_DNX_ACTION_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_CURRENT_STATE_ACTIONS_ON_PAYLOAD_INFO_DONT_USE_VALID_BIT_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_CURRENT_STATE_ACTIONS_ON_PAYLOAD_INFO_LSB_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_NEXT_STATE_ACTIONS_ON_PAYLOAD_INFO_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_NEXT_STATE_ACTIONS_ON_PAYLOAD_INFO_DNX_ACTION_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_NEXT_STATE_ACTIONS_ON_PAYLOAD_INFO_DONT_USE_VALID_BIT_INFO,
    DNX_FIELD_CONTEXT_SW_SCE_INFO_NEXT_STATE_ACTIONS_ON_PAYLOAD_INFO_LSB_INFO,
...
int dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_key_info_key_id_offset_on_first_key_dump(
    int unit, int context_info_idx_0, int key_info_idx_0, dnx_sw_state_dump_filters_t filters);

int dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_key_info_key_id_nof_bits_dump(
    int unit, int context_info_idx_0, int key_info_idx_0, int nof_bits_idx_0, dnx_sw_state_dump_filters_t filters);
...
int dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_1_key_info_attach_info_base_qual_dump(
    int unit, int context_info_idx_0, int key_info_idx_0, int attach_info_idx_0, dnx_sw_state_dump_filters_t filters);
...
int dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_2_key_info_key_id_offset_on_first_key_dump(
    int unit, int context_info_idx_0, int key_info_idx_0, dnx_sw_state_dump_filters_t filters);

int dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_2_key_info_key_id_nof_bits_dump(
    int unit, int context_info_idx_0, int key_info_idx_0, int nof_bits_idx_0, dnx_sw_state_dump_filters_t filters);
...
int dnx_field_context_sw_context_info_context_ipmf1_info_compare_info_pair_2_key_info_attach_info_base_qual_dump(
    int unit, int context_info_idx_0, int key_info_idx_0, int attach_info_idx_0, dnx_sw_state_dump_filters_t filters);
...
int dnx_field_context_sw_context_info_context_ipmf1_info_hashing_info_key_info_key_id_offset_on_first_key_dump(
    int unit, int context_info_idx_0, dnx_sw_state_dump_filters_t filters);

int dnx_field_context_sw_context_info_context_ipmf1_info_hashing_info_key_info_key_id_nof_bits_dump(
    int unit, int context_info_idx_0, int nof_bits_idx_0, dnx_sw_state_dump_filters_t filters);
...
int dnx_field_context_sw_context_info_context_ipmf1_info_hashing_info_key_info_attach_info_base_qual_dump(
    int unit, int context_info_idx_0, int attach_info_idx_0, dnx_sw_state_dump_filters_t filters);
