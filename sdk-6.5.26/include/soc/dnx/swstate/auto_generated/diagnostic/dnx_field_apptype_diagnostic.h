...
int dnx_field_apptype_sw_predef_info_nof_fwd2_context_ids_dump(
    int unit, int predef_info_idx_0, dnx_sw_state_dump_filters_t filters);

int dnx_field_apptype_sw_predef_info_fwd2_context_ids_dump(
    int unit, int predef_info_idx_0, int fwd2_context_ids_idx_0, dnx_sw_state_dump_filters_t filters);
