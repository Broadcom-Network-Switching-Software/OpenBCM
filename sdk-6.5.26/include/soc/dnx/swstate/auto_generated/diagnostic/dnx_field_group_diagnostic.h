...
int dnx_field_group_sw_fg_info_context_info_qual_attach_info_base_qual_dump(
    int unit, int fg_info_idx_0, int context_info_idx_0, int qual_attach_info_idx_0, dnx_sw_state_dump_filters_t filters);
...
int dnx_field_group_sw_fg_info_tcam_info_cache_mode_dump(
    int unit, int fg_info_idx_0, dnx_sw_state_dump_filters_t filters);

int dnx_field_group_sw_fg_info_tcam_info_nof_valid_entries_dump(
    int unit, int fg_info_idx_0, dnx_sw_state_dump_filters_t filters);
...
int dnx_field_group_sw_ace_format_info_use_ppmc_range_dump(
    int unit, int ace_format_info_idx_0, dnx_sw_state_dump_filters_t filters);
