...
typedef enum {
    ...
    DNX_IQS_DB_DELETE_CREDIT_REQUEST_PROFILE_INFO,
...
int dnx_iqs_db_delete_credit_request_profile_dump(
    int unit, dnx_sw_state_dump_filters_t filters);

int dnx_iqs_db_delete_credit_request_profile_valid_dump(
    int unit, dnx_sw_state_dump_filters_t filters);

int dnx_iqs_db_delete_credit_request_profile_id_dump(
    int unit, dnx_sw_state_dump_filters_t filters);
