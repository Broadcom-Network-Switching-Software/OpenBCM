...
#ifndef __DNX_DBAL_DIAGNOSTIC_H__
#define __DNX_DBAL_DIAGNOSTIC_H__
...
typedef enum {
    ...
    DBAL_DB_FIELD_NAMES_OVERRIDE_STRINGS_STRING_INFO,
...
int dbal_db_field_names_override_locations_dump(
    int unit, dnx_sw_state_dump_filters_t filters);

int dbal_db_field_names_override_strings_dump(
    int unit, int field_names_override_strings_idx_0, dnx_sw_state_dump_filters_t filters);

int dbal_db_field_names_override_strings_string_dump(
    int unit, int field_names_override_strings_idx_0, int string_idx_0, dnx_sw_state_dump_filters_t filters);
