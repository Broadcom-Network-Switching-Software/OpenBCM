...
typedef int (*dbal_db_sw_tables_hash_table_create_cb)(
    int unit, uint32 sw_tables_idx_0, sw_state_idx_htbl_init_info_t *init_info);
...
typedef int (*dbal_db_sw_tables_hash_table_get_next_cb)(
    int unit, uint32 sw_tables_idx_0, SW_STATE_INDEX_HASH_TABLE_ITER *iter, const dbal_sw_state_hash_key *key, const uint32 *data_index);
