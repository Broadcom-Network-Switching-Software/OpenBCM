...
typedef int (*local_outlif_info_logical_phase_info_first_no_ll_bank_set_cb)(
    int unit, uint32 logical_phase_info_idx_0, uint32 first_no_ll_bank);


typedef int (*local_outlif_info_logical_phase_info_first_no_ll_bank_get_cb)(
    int unit, uint32 logical_phase_info_idx_0, uint32 *first_no_ll_bank);


typedef int (*local_outlif_info_logical_phase_info_last_no_ll_bank_set_cb)(
    int unit, uint32 logical_phase_info_idx_0, uint32 last_no_ll_bank);


typedef int (*local_outlif_info_logical_phase_info_last_no_ll_bank_get_cb)(
    int unit, uint32 logical_phase_info_idx_0, uint32 *last_no_ll_bank);
...
typedef struct {
    local_outlif_info_logical_phase_info_first_no_ll_bank_set_cb set;
    local_outlif_info_logical_phase_info_first_no_ll_bank_get_cb get;
} local_outlif_info_logical_phase_info_first_no_ll_bank_cbs;


typedef struct {
    local_outlif_info_logical_phase_info_last_no_ll_bank_set_cb set;
    local_outlif_info_logical_phase_info_last_no_ll_bank_get_cb get;
} local_outlif_info_logical_phase_info_last_no_ll_bank_cbs;
...
typedef struct {
    ...
    local_outlif_info_logical_phase_info_first_no_ll_bank_cbs first_no_ll_bank;
    
    local_outlif_info_logical_phase_info_last_no_ll_bank_cbs last_no_ll_bank;
