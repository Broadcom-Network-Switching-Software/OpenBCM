...
typedef int (*dnx_field_apptype_sw_predef_info_nof_fwd2_context_ids_set_cb)(
    int unit, uint32 predef_info_idx_0, uint8 nof_fwd2_context_ids);


typedef int (*dnx_field_apptype_sw_predef_info_nof_fwd2_context_ids_get_cb)(
    int unit, uint32 predef_info_idx_0, uint8 *nof_fwd2_context_ids);


typedef int (*dnx_field_apptype_sw_predef_info_fwd2_context_ids_set_cb)(
    int unit, uint32 predef_info_idx_0, uint32 fwd2_context_ids_idx_0, uint8 fwd2_context_ids);


typedef int (*dnx_field_apptype_sw_predef_info_fwd2_context_ids_get_cb)(
    int unit, uint32 predef_info_idx_0, uint32 fwd2_context_ids_idx_0, uint8 *fwd2_context_ids);
...
typedef struct {
    dnx_field_apptype_sw_predef_info_nof_fwd2_context_ids_set_cb set;
    dnx_field_apptype_sw_predef_info_nof_fwd2_context_ids_get_cb get;
} dnx_field_apptype_sw_predef_info_nof_fwd2_context_ids_cbs;


typedef struct {
    dnx_field_apptype_sw_predef_info_fwd2_context_ids_set_cb set;
    dnx_field_apptype_sw_predef_info_fwd2_context_ids_get_cb get;
} dnx_field_apptype_sw_predef_info_fwd2_context_ids_cbs;
...
typedef struct {
    ...
    dnx_field_apptype_sw_predef_info_nof_fwd2_context_ids_cbs nof_fwd2_context_ids;
    
    dnx_field_apptype_sw_predef_info_fwd2_context_ids_cbs fwd2_context_ids;
