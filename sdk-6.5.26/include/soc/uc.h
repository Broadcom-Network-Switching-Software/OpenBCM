...
extern int soc_uc_m0_status_version(int unit, int uC, int *status,
        uint32 *version, char *buf, uint32 max_buf_size);
extern int soc_uc_m0_reset(int unit, int uC);

extern int soc_uc_timeofday_set(int unit, int uC, uint64 timeofday, uint64 ts, sal_usecs_t timeout);
extern int soc_uc_timeofday_get(int unit, int uC, uint64 *tod, sal_usecs_t timeout);
