...
#define SHMOO_AND28_PHY_TYPE_F4                     0xF4
...
#define SHMOO_AND28_RD_EN_ECC                       29
#define SHMOO_AND28_RD_EXTENDED_ECC                 59
#define SHMOO_AND28_WR_EXTENDED_ECC                 69
#define SHMOO_AND28_DDR3_SEQUENCE_COUNT             5
#define SHMOO_AND28_DDR3_ECC_32P4_SEQUENCE_COUNT    8
#define SHMOO_AND28_DDR3L_SEQUENCE_COUNT            5
#define SHMOO_AND28_DDR3L_ECC_32P4_SEQUENCE_COUNT   8
#define SHMOO_AND28_DDR4_SEQUENCE_COUNT             5
#define SHMOO_AND28_DDR4_ECC_32P4_SEQUENCE_COUNT    8
/* BEGIN: EXTRA */
/* END: EXTRA */
...
#define SHMOO_AND28_INTERFACE_RSVP                  -1
    ...
    #define SHMOO_AND28_BYTES_PER_INTERFACE         5
#else
...
typedef struct and28_f4_shmoo_dram_info_s
{
    uint32 ctl_type;
    uint32 dram_type;
    uint32 dram_bitmap;
...
extern int soc_and28_f4_shmoo_dram_info_set(int unit, CONST and28_f4_shmoo_dram_info_t *sdi);
extern int soc_and28_f4_shmoo_phy_init(int unit, int drc_ndx);
extern int soc_and28_f4_shmoo_ctl(int unit, int phy_ndx, int shmoo_type, int stat, int plot, int action, and28_shmoo_config_param_t *config_param);

extern int iproc28_enable_ecc(int unit);
extern int iproc28_read_ecc_syndrome(int unit);
extern int iproc28_clear_ecc_syndrome(int unit);
