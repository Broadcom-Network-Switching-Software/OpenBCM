...
soc_driver_t *soc_dnxf_chip_driver_find(
    int unit,
    uint16 pci_dev_id,
    uint8 pci_rev_id);
...
int soc_dnxf_init_device_reset(
    int unit);

int soc_dnxf_init_device_reset_deinit(
    int unit);
...
int soc_dnxf_interrupts_deinit(
    int unit);
...
int soc_dnxf_block_instance_bmp_valid_get(
    int unit,
    int block_type,
    soc_pbmp_t * block_bmp);

int soc_dnxf_block_instance_first_valid_get(
    int unit,
    int block_type,
    int *block_id);
