...
#error "This file is for use by DNXF1 family only!"
#endif
...
shr_error_e soc_ramon_sr_cell_send(
    int unit,
    const dnxc_vsc256_sr_cell_t * cell);

shr_error_e soc_ramon_dest_routed_cell_send(
    int unit,
    dnxc_dest_routed_cell_t * cell);

shr_error_e soc_ramon_control_cell_filter_set(
    int unit,
    uint32 flags,
...
shr_error_e soc_ramon_control_cell_filter_clear(
    int unit);

shr_error_e soc_ramon_control_cell_filter_receive(
    int unit,
    soc_dnxc_captured_control_cell_t * data_out);

shr_error_e soc_ramon_fabric_cell_get(
    int unit,
    soc_dnxc_fabric_cell_entry_t entry);

shr_error_e soc_ramon_fabric_cell_parse_table_get(
    int unit,
    soc_dnxc_fabric_cell_entry_t entry,
    soc_dnxc_fabric_cell_type_t * cell_type,
    soc_dnxc_fabric_cell_parse_table_t * parse_table);

shr_error_e soc_ramon_cell_filter_init(
    int unit);

shr_error_e soc_ramon_cell_filter_set(
    int unit,
    uint32 flags,
    uint32 array_size,
...
shr_error_e soc_ramon_cell_filter_count_get(
    int unit,
    int *count);

shr_error_e soc_ramon_cell_filter_clear(
    int unit);
