...
typedef enum {
    ...
    DNXF_STATE_SIGNAL_QUALITY_INFO,
...
int dnxf_state_info_soft_init_reg_above_64_val_dump(
    int unit, int soft_init_reg_above_64_val_idx_0, dnx_sw_state_dump_filters_t filters);
...
int dnxf_state_signal_quality_dump(
    int unit, dnx_sw_state_dump_filters_t filters);

int dnxf_state_signal_quality_fmac_config_dump(
    int unit, int fmac_config_idx_0, dnx_sw_state_dump_filters_t filters);

int dnxf_state_signal_quality_fmac_config_degrade_thr_dump(
    int unit, int fmac_config_idx_0, dnx_sw_state_dump_filters_t filters);

int dnxf_state_signal_quality_fmac_config_degrade_cu_thr_dump(
    int unit, int fmac_config_idx_0, dnx_sw_state_dump_filters_t filters);

int dnxf_state_signal_quality_fmac_config_fail_thr_dump(
    int unit, int fmac_config_idx_0, dnx_sw_state_dump_filters_t filters);

int dnxf_state_signal_quality_fmac_config_fail_cu_thr_dump(
    int unit, int fmac_config_idx_0, dnx_sw_state_dump_filters_t filters);

int dnxf_state_signal_quality_fmac_config_interval_dump(
    int unit, int fmac_config_idx_0, dnx_sw_state_dump_filters_t filters);

int dnxf_state_signal_quality_action_enabled_dump(
    int unit, dnx_sw_state_dump_filters_t filters);

int dnxf_state_signal_quality_enabled_ports_dump(
    int unit, dnx_sw_state_dump_filters_t filters);

int dnxf_state_signal_quality_measure_mode_dump(
    int unit, dnx_sw_state_dump_filters_t filters);
