...
typedef int (*dnxf_state_signal_quality_fmac_config_set_cb)(
    int unit, uint32 fmac_config_idx_0, CONST soc_dnxf_signal_quality_fmac_config_t *fmac_config);


typedef int (*dnxf_state_signal_quality_fmac_config_get_cb)(
    int unit, uint32 fmac_config_idx_0, soc_dnxf_signal_quality_fmac_config_t *fmac_config);


typedef int (*dnxf_state_signal_quality_fmac_config_alloc_cb)(
    int unit, uint32 nof_instances_to_alloc_0);


typedef int (*dnxf_state_signal_quality_fmac_config_degrade_thr_set_cb)(
    int unit, uint32 fmac_config_idx_0, uint32 degrade_thr);


typedef int (*dnxf_state_signal_quality_fmac_config_degrade_thr_get_cb)(
    int unit, uint32 fmac_config_idx_0, uint32 *degrade_thr);


typedef int (*dnxf_state_signal_quality_fmac_config_degrade_cu_thr_set_cb)(
    int unit, uint32 fmac_config_idx_0, uint32 degrade_cu_thr);


typedef int (*dnxf_state_signal_quality_fmac_config_degrade_cu_thr_get_cb)(
    int unit, uint32 fmac_config_idx_0, uint32 *degrade_cu_thr);


typedef int (*dnxf_state_signal_quality_fmac_config_fail_thr_set_cb)(
    int unit, uint32 fmac_config_idx_0, uint32 fail_thr);


typedef int (*dnxf_state_signal_quality_fmac_config_fail_thr_get_cb)(
    int unit, uint32 fmac_config_idx_0, uint32 *fail_thr);


typedef int (*dnxf_state_signal_quality_fmac_config_fail_cu_thr_set_cb)(
    int unit, uint32 fmac_config_idx_0, uint32 fail_cu_thr);


typedef int (*dnxf_state_signal_quality_fmac_config_fail_cu_thr_get_cb)(
    int unit, uint32 fmac_config_idx_0, uint32 *fail_cu_thr);


typedef int (*dnxf_state_signal_quality_fmac_config_interval_set_cb)(
    int unit, uint32 fmac_config_idx_0, uint32 interval);


typedef int (*dnxf_state_signal_quality_fmac_config_interval_get_cb)(
    int unit, uint32 fmac_config_idx_0, uint32 *interval);


typedef int (*dnxf_state_signal_quality_action_enabled_set_cb)(
    int unit, bcm_pbmp_t action_enabled);


typedef int (*dnxf_state_signal_quality_action_enabled_get_cb)(
    int unit, bcm_pbmp_t *action_enabled);


typedef int (*dnxf_state_signal_quality_action_enabled_pbmp_neq_cb)(
    int unit, _shr_pbmp_t input_pbmp, uint8 *result);


typedef int (*dnxf_state_signal_quality_action_enabled_pbmp_eq_cb)(
    int unit, _shr_pbmp_t input_pbmp, uint8 *result);


typedef int (*dnxf_state_signal_quality_action_enabled_pbmp_member_cb)(
    int unit, uint32 _input_port, uint8 *result);


typedef int (*dnxf_state_signal_quality_action_enabled_pbmp_not_null_cb)(
    int unit, uint8 *result);


typedef int (*dnxf_state_signal_quality_action_enabled_pbmp_is_null_cb)(
    int unit, uint8 *result);


typedef int (*dnxf_state_signal_quality_action_enabled_pbmp_count_cb)(
    int unit, int *result);


typedef int (*dnxf_state_signal_quality_action_enabled_pbmp_xor_cb)(
    int unit, _shr_pbmp_t input_pbmp);


typedef int (*dnxf_state_signal_quality_action_enabled_pbmp_remove_cb)(
    int unit, _shr_pbmp_t input_pbmp);


typedef int (*dnxf_state_signal_quality_action_enabled_pbmp_assign_cb)(
    int unit, _shr_pbmp_t input_pbmp);


typedef int (*dnxf_state_signal_quality_action_enabled_pbmp_get_cb)(
    int unit, _shr_pbmp_t *output_pbmp);


typedef int (*dnxf_state_signal_quality_action_enabled_pbmp_and_cb)(
    int unit, _shr_pbmp_t input_pbmp);


typedef int (*dnxf_state_signal_quality_action_enabled_pbmp_negate_cb)(
    int unit, _shr_pbmp_t input_pbmp);


typedef int (*dnxf_state_signal_quality_action_enabled_pbmp_or_cb)(
    int unit, _shr_pbmp_t input_pbmp);


typedef int (*dnxf_state_signal_quality_action_enabled_pbmp_clear_cb)(
    int unit);


typedef int (*dnxf_state_signal_quality_action_enabled_pbmp_port_add_cb)(
    int unit, uint32 _input_port);


typedef int (*dnxf_state_signal_quality_action_enabled_pbmp_port_flip_cb)(
    int unit, uint32 _input_port);


typedef int (*dnxf_state_signal_quality_action_enabled_pbmp_port_remove_cb)(
    int unit, uint32 _input_port);


typedef int (*dnxf_state_signal_quality_action_enabled_pbmp_port_set_cb)(
    int unit, uint32 _input_port);


typedef int (*dnxf_state_signal_quality_action_enabled_pbmp_ports_range_add_cb)(
    int unit, uint32 _first_port, uint32 _range);


typedef int (*dnxf_state_signal_quality_action_enabled_pbmp_fmt_cb)(
    int unit, char* _buffer);


typedef int (*dnxf_state_signal_quality_enabled_ports_set_cb)(
    int unit, bcm_pbmp_t enabled_ports);


typedef int (*dnxf_state_signal_quality_enabled_ports_get_cb)(
    int unit, bcm_pbmp_t *enabled_ports);


typedef int (*dnxf_state_signal_quality_enabled_ports_pbmp_neq_cb)(
    int unit, _shr_pbmp_t input_pbmp, uint8 *result);


typedef int (*dnxf_state_signal_quality_enabled_ports_pbmp_eq_cb)(
    int unit, _shr_pbmp_t input_pbmp, uint8 *result);


typedef int (*dnxf_state_signal_quality_enabled_ports_pbmp_member_cb)(
    int unit, uint32 _input_port, uint8 *result);


typedef int (*dnxf_state_signal_quality_enabled_ports_pbmp_not_null_cb)(
    int unit, uint8 *result);


typedef int (*dnxf_state_signal_quality_enabled_ports_pbmp_is_null_cb)(
    int unit, uint8 *result);


typedef int (*dnxf_state_signal_quality_enabled_ports_pbmp_count_cb)(
    int unit, int *result);


typedef int (*dnxf_state_signal_quality_enabled_ports_pbmp_xor_cb)(
    int unit, _shr_pbmp_t input_pbmp);


typedef int (*dnxf_state_signal_quality_enabled_ports_pbmp_remove_cb)(
    int unit, _shr_pbmp_t input_pbmp);


typedef int (*dnxf_state_signal_quality_enabled_ports_pbmp_assign_cb)(
    int unit, _shr_pbmp_t input_pbmp);


typedef int (*dnxf_state_signal_quality_enabled_ports_pbmp_get_cb)(
    int unit, _shr_pbmp_t *output_pbmp);


typedef int (*dnxf_state_signal_quality_enabled_ports_pbmp_and_cb)(
    int unit, _shr_pbmp_t input_pbmp);


typedef int (*dnxf_state_signal_quality_enabled_ports_pbmp_negate_cb)(
    int unit, _shr_pbmp_t input_pbmp);


typedef int (*dnxf_state_signal_quality_enabled_ports_pbmp_or_cb)(
    int unit, _shr_pbmp_t input_pbmp);


typedef int (*dnxf_state_signal_quality_enabled_ports_pbmp_clear_cb)(
    int unit);


typedef int (*dnxf_state_signal_quality_enabled_ports_pbmp_port_add_cb)(
    int unit, uint32 _input_port);


typedef int (*dnxf_state_signal_quality_enabled_ports_pbmp_port_flip_cb)(
    int unit, uint32 _input_port);


typedef int (*dnxf_state_signal_quality_enabled_ports_pbmp_port_remove_cb)(
    int unit, uint32 _input_port);


typedef int (*dnxf_state_signal_quality_enabled_ports_pbmp_port_set_cb)(
    int unit, uint32 _input_port);


typedef int (*dnxf_state_signal_quality_enabled_ports_pbmp_ports_range_add_cb)(
    int unit, uint32 _first_port, uint32 _range);


typedef int (*dnxf_state_signal_quality_enabled_ports_pbmp_fmt_cb)(
    int unit, char* _buffer);


typedef int (*dnxf_state_signal_quality_measure_mode_set_cb)(
    int unit, bcm_pbmp_t measure_mode);


typedef int (*dnxf_state_signal_quality_measure_mode_get_cb)(
    int unit, bcm_pbmp_t *measure_mode);


typedef int (*dnxf_state_signal_quality_measure_mode_pbmp_neq_cb)(
    int unit, _shr_pbmp_t input_pbmp, uint8 *result);


typedef int (*dnxf_state_signal_quality_measure_mode_pbmp_eq_cb)(
    int unit, _shr_pbmp_t input_pbmp, uint8 *result);


typedef int (*dnxf_state_signal_quality_measure_mode_pbmp_member_cb)(
    int unit, uint32 _input_port, uint8 *result);


typedef int (*dnxf_state_signal_quality_measure_mode_pbmp_not_null_cb)(
    int unit, uint8 *result);


typedef int (*dnxf_state_signal_quality_measure_mode_pbmp_is_null_cb)(
    int unit, uint8 *result);


typedef int (*dnxf_state_signal_quality_measure_mode_pbmp_count_cb)(
    int unit, int *result);


typedef int (*dnxf_state_signal_quality_measure_mode_pbmp_xor_cb)(
    int unit, _shr_pbmp_t input_pbmp);


typedef int (*dnxf_state_signal_quality_measure_mode_pbmp_remove_cb)(
    int unit, _shr_pbmp_t input_pbmp);


typedef int (*dnxf_state_signal_quality_measure_mode_pbmp_assign_cb)(
    int unit, _shr_pbmp_t input_pbmp);


typedef int (*dnxf_state_signal_quality_measure_mode_pbmp_get_cb)(
    int unit, _shr_pbmp_t *output_pbmp);


typedef int (*dnxf_state_signal_quality_measure_mode_pbmp_and_cb)(
    int unit, _shr_pbmp_t input_pbmp);


typedef int (*dnxf_state_signal_quality_measure_mode_pbmp_negate_cb)(
    int unit, _shr_pbmp_t input_pbmp);


typedef int (*dnxf_state_signal_quality_measure_mode_pbmp_or_cb)(
    int unit, _shr_pbmp_t input_pbmp);


typedef int (*dnxf_state_signal_quality_measure_mode_pbmp_clear_cb)(
    int unit);


typedef int (*dnxf_state_signal_quality_measure_mode_pbmp_port_add_cb)(
    int unit, uint32 _input_port);


typedef int (*dnxf_state_signal_quality_measure_mode_pbmp_port_flip_cb)(
    int unit, uint32 _input_port);


typedef int (*dnxf_state_signal_quality_measure_mode_pbmp_port_remove_cb)(
    int unit, uint32 _input_port);


typedef int (*dnxf_state_signal_quality_measure_mode_pbmp_port_set_cb)(
    int unit, uint32 _input_port);


typedef int (*dnxf_state_signal_quality_measure_mode_pbmp_ports_range_add_cb)(
    int unit, uint32 _first_port, uint32 _range);


typedef int (*dnxf_state_signal_quality_measure_mode_pbmp_fmt_cb)(
    int unit, char* _buffer);
...
typedef struct {
    dnxf_state_signal_quality_fmac_config_degrade_thr_set_cb set;
    dnxf_state_signal_quality_fmac_config_degrade_thr_get_cb get;
} dnxf_state_signal_quality_fmac_config_degrade_thr_cbs;


typedef struct {
    dnxf_state_signal_quality_fmac_config_degrade_cu_thr_set_cb set;
    dnxf_state_signal_quality_fmac_config_degrade_cu_thr_get_cb get;
} dnxf_state_signal_quality_fmac_config_degrade_cu_thr_cbs;


typedef struct {
    dnxf_state_signal_quality_fmac_config_fail_thr_set_cb set;
    dnxf_state_signal_quality_fmac_config_fail_thr_get_cb get;
} dnxf_state_signal_quality_fmac_config_fail_thr_cbs;


typedef struct {
    dnxf_state_signal_quality_fmac_config_fail_cu_thr_set_cb set;
    dnxf_state_signal_quality_fmac_config_fail_cu_thr_get_cb get;
} dnxf_state_signal_quality_fmac_config_fail_cu_thr_cbs;


typedef struct {
    dnxf_state_signal_quality_fmac_config_interval_set_cb set;
    dnxf_state_signal_quality_fmac_config_interval_get_cb get;
} dnxf_state_signal_quality_fmac_config_interval_cbs;


typedef struct {
    dnxf_state_signal_quality_fmac_config_set_cb set;
    dnxf_state_signal_quality_fmac_config_get_cb get;
    dnxf_state_signal_quality_fmac_config_alloc_cb alloc;
    
    dnxf_state_signal_quality_fmac_config_degrade_thr_cbs degrade_thr;
    
    dnxf_state_signal_quality_fmac_config_degrade_cu_thr_cbs degrade_cu_thr;
    
    dnxf_state_signal_quality_fmac_config_fail_thr_cbs fail_thr;
    
    dnxf_state_signal_quality_fmac_config_fail_cu_thr_cbs fail_cu_thr;
    
    dnxf_state_signal_quality_fmac_config_interval_cbs interval;
} dnxf_state_signal_quality_fmac_config_cbs;


typedef struct {
    dnxf_state_signal_quality_action_enabled_set_cb set;
    dnxf_state_signal_quality_action_enabled_get_cb get;
    dnxf_state_signal_quality_action_enabled_pbmp_neq_cb pbmp_neq;
    dnxf_state_signal_quality_action_enabled_pbmp_eq_cb pbmp_eq;
    dnxf_state_signal_quality_action_enabled_pbmp_member_cb pbmp_member;
    dnxf_state_signal_quality_action_enabled_pbmp_not_null_cb pbmp_not_null;
    dnxf_state_signal_quality_action_enabled_pbmp_is_null_cb pbmp_is_null;
    dnxf_state_signal_quality_action_enabled_pbmp_count_cb pbmp_count;
    dnxf_state_signal_quality_action_enabled_pbmp_xor_cb pbmp_xor;
    dnxf_state_signal_quality_action_enabled_pbmp_remove_cb pbmp_remove;
    dnxf_state_signal_quality_action_enabled_pbmp_assign_cb pbmp_assign;
    dnxf_state_signal_quality_action_enabled_pbmp_get_cb pbmp_get;
    dnxf_state_signal_quality_action_enabled_pbmp_and_cb pbmp_and;
    dnxf_state_signal_quality_action_enabled_pbmp_negate_cb pbmp_negate;
    dnxf_state_signal_quality_action_enabled_pbmp_or_cb pbmp_or;
    dnxf_state_signal_quality_action_enabled_pbmp_clear_cb pbmp_clear;
    dnxf_state_signal_quality_action_enabled_pbmp_port_add_cb pbmp_port_add;
    dnxf_state_signal_quality_action_enabled_pbmp_port_flip_cb pbmp_port_flip;
    dnxf_state_signal_quality_action_enabled_pbmp_port_remove_cb pbmp_port_remove;
    dnxf_state_signal_quality_action_enabled_pbmp_port_set_cb pbmp_port_set;
    dnxf_state_signal_quality_action_enabled_pbmp_ports_range_add_cb pbmp_ports_range_add;
    dnxf_state_signal_quality_action_enabled_pbmp_fmt_cb pbmp_fmt;
} dnxf_state_signal_quality_action_enabled_cbs;


typedef struct {
    dnxf_state_signal_quality_enabled_ports_set_cb set;
    dnxf_state_signal_quality_enabled_ports_get_cb get;
    dnxf_state_signal_quality_enabled_ports_pbmp_neq_cb pbmp_neq;
    dnxf_state_signal_quality_enabled_ports_pbmp_eq_cb pbmp_eq;
    dnxf_state_signal_quality_enabled_ports_pbmp_member_cb pbmp_member;
    dnxf_state_signal_quality_enabled_ports_pbmp_not_null_cb pbmp_not_null;
    dnxf_state_signal_quality_enabled_ports_pbmp_is_null_cb pbmp_is_null;
    dnxf_state_signal_quality_enabled_ports_pbmp_count_cb pbmp_count;
    dnxf_state_signal_quality_enabled_ports_pbmp_xor_cb pbmp_xor;
    dnxf_state_signal_quality_enabled_ports_pbmp_remove_cb pbmp_remove;
    dnxf_state_signal_quality_enabled_ports_pbmp_assign_cb pbmp_assign;
    dnxf_state_signal_quality_enabled_ports_pbmp_get_cb pbmp_get;
    dnxf_state_signal_quality_enabled_ports_pbmp_and_cb pbmp_and;
    dnxf_state_signal_quality_enabled_ports_pbmp_negate_cb pbmp_negate;
    dnxf_state_signal_quality_enabled_ports_pbmp_or_cb pbmp_or;
    dnxf_state_signal_quality_enabled_ports_pbmp_clear_cb pbmp_clear;
    dnxf_state_signal_quality_enabled_ports_pbmp_port_add_cb pbmp_port_add;
    dnxf_state_signal_quality_enabled_ports_pbmp_port_flip_cb pbmp_port_flip;
    dnxf_state_signal_quality_enabled_ports_pbmp_port_remove_cb pbmp_port_remove;
    dnxf_state_signal_quality_enabled_ports_pbmp_port_set_cb pbmp_port_set;
    dnxf_state_signal_quality_enabled_ports_pbmp_ports_range_add_cb pbmp_ports_range_add;
    dnxf_state_signal_quality_enabled_ports_pbmp_fmt_cb pbmp_fmt;
} dnxf_state_signal_quality_enabled_ports_cbs;


typedef struct {
    dnxf_state_signal_quality_measure_mode_set_cb set;
    dnxf_state_signal_quality_measure_mode_get_cb get;
    dnxf_state_signal_quality_measure_mode_pbmp_neq_cb pbmp_neq;
    dnxf_state_signal_quality_measure_mode_pbmp_eq_cb pbmp_eq;
    dnxf_state_signal_quality_measure_mode_pbmp_member_cb pbmp_member;
    dnxf_state_signal_quality_measure_mode_pbmp_not_null_cb pbmp_not_null;
    dnxf_state_signal_quality_measure_mode_pbmp_is_null_cb pbmp_is_null;
    dnxf_state_signal_quality_measure_mode_pbmp_count_cb pbmp_count;
    dnxf_state_signal_quality_measure_mode_pbmp_xor_cb pbmp_xor;
    dnxf_state_signal_quality_measure_mode_pbmp_remove_cb pbmp_remove;
    dnxf_state_signal_quality_measure_mode_pbmp_assign_cb pbmp_assign;
    dnxf_state_signal_quality_measure_mode_pbmp_get_cb pbmp_get;
    dnxf_state_signal_quality_measure_mode_pbmp_and_cb pbmp_and;
    dnxf_state_signal_quality_measure_mode_pbmp_negate_cb pbmp_negate;
    dnxf_state_signal_quality_measure_mode_pbmp_or_cb pbmp_or;
    dnxf_state_signal_quality_measure_mode_pbmp_clear_cb pbmp_clear;
    dnxf_state_signal_quality_measure_mode_pbmp_port_add_cb pbmp_port_add;
    dnxf_state_signal_quality_measure_mode_pbmp_port_flip_cb pbmp_port_flip;
    dnxf_state_signal_quality_measure_mode_pbmp_port_remove_cb pbmp_port_remove;
    dnxf_state_signal_quality_measure_mode_pbmp_port_set_cb pbmp_port_set;
    dnxf_state_signal_quality_measure_mode_pbmp_ports_range_add_cb pbmp_ports_range_add;
    dnxf_state_signal_quality_measure_mode_pbmp_fmt_cb pbmp_fmt;
} dnxf_state_signal_quality_measure_mode_cbs;


typedef struct {
    
    dnxf_state_signal_quality_fmac_config_cbs fmac_config;
    
    dnxf_state_signal_quality_action_enabled_cbs action_enabled;
    
    dnxf_state_signal_quality_enabled_ports_cbs enabled_ports;
    
    dnxf_state_signal_quality_measure_mode_cbs measure_mode;
} dnxf_state_signal_quality_cbs;
...
typedef struct {
    ...
    dnxf_state_signal_quality_cbs signal_quality;
} dnxf_state_cbs;
