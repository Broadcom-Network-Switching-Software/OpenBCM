...
typedef enum
{
    ...
    _dnxf_data_port_signal_quality_feature_nof
} dnxf_data_port_signal_quality_feature_e;



typedef int(
    *dnxf_data_port_signal_quality_feature_get_f) (
    int unit,
    dnxf_data_port_signal_quality_feature_e feature);


typedef uint32(
    *dnxf_data_port_signal_quality_max_interval_in_cycles_get_f) (
    int unit);


typedef uint32(
    *dnxf_data_port_signal_quality_max_degrade_threshold_get_f) (
    int unit);


typedef uint32(
    *dnxf_data_port_signal_quality_min_degrade_threshold_get_f) (
    int unit);


typedef uint32(
    *dnxf_data_port_signal_quality_max_fail_threshold_get_f) (
    int unit);


typedef uint32(
    *dnxf_data_port_signal_quality_min_fail_threshold_get_f) (
    int unit);


typedef uint32(
    *dnxf_data_port_signal_quality_max_interval_get_f) (
    int unit);


typedef uint32(
    *dnxf_data_port_signal_quality_min_interval_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnxf_data_port_signal_quality_feature_get_f feature_get;
    
    dnxf_data_port_signal_quality_max_interval_in_cycles_get_f max_interval_in_cycles_get;
    
    dnxf_data_port_signal_quality_max_degrade_threshold_get_f max_degrade_threshold_get;
    
    dnxf_data_port_signal_quality_min_degrade_threshold_get_f min_degrade_threshold_get;
    
    dnxf_data_port_signal_quality_max_fail_threshold_get_f max_fail_threshold_get;
    
    dnxf_data_port_signal_quality_min_fail_threshold_get_f min_fail_threshold_get;
    
    dnxf_data_port_signal_quality_max_interval_get_f max_interval_get;
    
    dnxf_data_port_signal_quality_min_interval_get_f min_interval_get;
} dnxf_data_if_port_signal_quality_t;
...
typedef struct
{
    ...
    dnxf_data_if_port_signal_quality_t signal_quality;
} dnxf_data_if_port_t;
