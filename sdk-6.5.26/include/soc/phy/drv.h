...
typedef struct phy_driver_s {
    ...
    int  (*pd_phy_signal_detect_status_get)(int, soc_port_t, soc_phy_signal_detect_status_t *);
} phy_driver_t;
...
#define PHY_SIGNAL_DETECT_STATUS_GET(_pd, _u, _p, _v) \
            _PHY_CALL((_pd), pd_phy_signal_detect_status_get, ((_u),(_p),(_v)))
