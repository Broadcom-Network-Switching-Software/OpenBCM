...
typedef enum
{
    ...
    DNXC_SERDES_REF_CLOCK_DISABLE = -1,

    DNXC_SERDES_REF_CLOCK_125 = 0,

    DNXC_SERDES_REF_CLOCK_156_25 = 1,

    DNXC_SERDES_REF_CLOCK_25 = 2,

    DNXC_SERDES_REF_CLOCK_312_5 = 3,

    DNXC_SERDES_REF_CLOCK_BYPASS = 4,

    DNXC_SERDES_REF_CLOCK_NOF = 5
} DNXC_SERDES_REF_CLOCK_TYPE;
