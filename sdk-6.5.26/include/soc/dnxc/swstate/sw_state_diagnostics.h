...
#define DNXC_SW_STATE_ALLOC_FUNCTION_CHECK(function) \
    ...
    function == DNX_SW_STATE_DIAG_SEM_CREATE || function == DNX_SW_STATE_DIAG_OCC_BM_CREATE || function == DNX_SW_STATE_DIAG_HTB_CREATE || function == DNX_SW_STATE_DIAG_INDEX_HTB_CREATE || function == DNX_SW_STATE_DIAG_LL_CREATE || \
    ...
    do { \
        if ((dnxc_sw_state_diag_is_on(unit) && !sw_state_is_done_init(unit)) && (DNXC_SW_STATE_ALLOC_FUNCTION_CHECK(function))) { \
            ...
            if (function == DNX_SW_STATE_DIAG_FREE) { \
                ...
                dnxc_sw_state_layout_node_total_size_update(unit, node_id, layout_address, allocated_size, 0);\
                ...
                dnxc_sw_state_layout_node_total_size_update(unit, node_id, layout_address, _actual_size, 1);\
