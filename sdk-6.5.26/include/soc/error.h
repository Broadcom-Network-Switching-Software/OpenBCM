...
#include <soc/sand/sand_gen_err.h>
#endif
...
typedef enum {
    ...
    SOC_SWITCH_EVENT_SIGNAL_QUALITY_CHANGE = _SHR_SWITCH_EVENT_SIGNAL_QUALITY_CHANGE,
...
/*
 * Event IDs for I/O error on system level
 *
 * TIMEOUT: No response from HW, cold-boot might be needed.
 * NO_DATA: Interrupt raised or DONE set, but no valid data in buffer or DCB.
 */
typedef enum {
    SOC_SWITCH_PCI_RESET_COLD_BOOT = 1,
    SOC_SWITCH_PCI_RESET_WARM_BOOT,
    SOC_SWITCH_PKTDMA_RX_RESTART,
    SOC_SWITCH_COUNTER_RESTART,
} soc_switch_io_error_action_id_t;

typedef enum {
    SOC_SWITCH_EVENT_IO_ERROR_PCI_TIMEOUT = 1,
    SOC_SWITCH_EVENT_IO_ERROR_SCHANPIO_TIMEOUT,
    SOC_SWITCH_EVENT_IO_ERROR_SCHANFIFO_TIMEOUT,
    SOC_SWITCH_EVENT_IO_ERROR_CCMDMA_TIMEOUT,
    SOC_SWITCH_EVENT_IO_ERROR_SBUSDMA_TIMEOUT,
    SOC_SWITCH_EVENT_IO_ERROR_SBUSDMA_NO_DATA,
    SOC_SWITCH_EVENT_IO_ERROR_FIFODMA_NO_DATA,
    ...
    SOC_SWITCH_EVENT_IO_ERROR_SBUSDMA_ADDR_DECODE_ERR,
} soc_switch_io_error_t;
