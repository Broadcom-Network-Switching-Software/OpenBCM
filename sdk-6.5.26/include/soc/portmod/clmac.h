...
typedef enum clmac_tx_crc_mode_e {
    CLMAC_TX_CRC_MODE_APPEND = 0,
    CLMAC_TX_CRC_MODE_KEEP = 1,
    CLMAC_TX_CRC_MODE_REPLACE = 2,
    CLMAC_TX_CRC_MODE_AUTO = 3,
    CLMAC_TX_CRC_MODE_COUNT
} clmac_tx_crc_mode_t;
