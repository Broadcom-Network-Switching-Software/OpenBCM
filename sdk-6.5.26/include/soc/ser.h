...
extern int soc_ser_single_bit_error_enable_set(int unit, int enable);
extern int soc_ser_single_bit_error_enable_get(int unit, int *enable);
extern int soc_ser_single_bit_sw_correction_enable_set(int unit, int enable);
extern int soc_ser_single_bit_sw_correction_enable_get(int unit, int *enable);
