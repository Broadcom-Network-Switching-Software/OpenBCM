 ...
 *   * None
 */
shr_error_e appl_dnx_sys_ports_init(
    int unit);
 ...
 *   * None
 */
shr_error_e appl_dnx_sys_ports_port_create_and_connect(
    int unit,
    int system_port_id,
 ...
 *   * None
 */
shr_error_e appl_dnx_sys_ports_port_create(
    int unit,
    int system_port_id,
    const system_port_mapping_t * sys_port_map);
 ...
 *   * None
 */
shr_error_e appl_dnx_sys_port_voq_create(
    int unit,
    int system_port_id,
    const system_port_mapping_t * sys_port_map);

/**
 * \brief - modify existing VOQs for given system port
 *
 * \param [in] unit - Unit ID
 * \param [in] system_port_id - system port ID
 * \param [in] sys_port_map - system port mapping info
 ...
 *   * None
 */
shr_error_e appl_dnx_sys_port_voq_modify(
    int unit,
    int system_port_id,
    const system_port_mapping_t * sys_port_map);
 ...
 *   * None
 */
shr_error_e appl_dnx_sys_ports_voq_destroy(
    int unit,
    int system_port_id);
 ...
 *   * None
 */
int appl_dnx_logical_port_to_sysport_get(
    int unit,
    bcm_module_t modid,
    bcm_port_t port,
    int *sysport);
...
/**
 * \brief - Convert system port id to ftmh_pp_dsp and internal modid index.
 *
 * \param [in] unit - Unit ID
 * \param [in] sys_port_map - sysport map strcture representing the corresponding system port
 * \param [Out] ftmh_pp_dsp - ftmh pp dsp
 * \param [Out] modid_index - Internal modid index (a consecutive number within the device)
 *
 * \return
 *   int
 *
 ...
 * \param [in] unit - Unit ID
 * \param [in] port - logical port
 * \param [Out] sys_port_map - sysport map strcture representing the corresponding local logical port
 *
 * \return
 *   int
 *
