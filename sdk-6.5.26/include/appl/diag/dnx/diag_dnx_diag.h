 ...
 *  MACROES  *
 *************/
#define DNX_DIAG_COUNTER_REG_NOF_REGS (11)
/** Length of graphical print buffer */
#define DNX_DIAG_GRAPHICAL_PRINT_BUFFER_LENGTH 100
/** Length of block name */
#define DNX_DIAG_BLOCK_NAME_LENGTH 8
/** Macro INVALID_CORE is used in diag XML file, don't use the "DNX..." prefix */
 ...
 * \brief
 *   For DNX device only
 *   get FDR drop reason string according to register/field
 * \param [in] unit - Unit #
 * \param [in] reg - error counter register
 * \param [in] field - error counter field
 * \param [in] cdsp - error counter per core
 ...
 *      Standard error handling
 */
shr_error_e dnx_fdr_drop_reason_to_str(
    int unit,
    soc_reg_t reg,
    soc_field_t field,
    int cdsp,
