...
#ifdef BCM_PETRA_SUPPORT
#if defined(BCM_PETRA_SUPPORT)
/* implemented by: sw_state_dpp_soc_arad_pp_oam_lb_tst_up_trap_used_cnt_set */
typedef int (*sw_state_dpp_soc_arad_pp_oam_lb_tst_up_trap_used_cnt_set_cb)(
    int unit, uint32 lb_tst_up_trap_used_cnt);
#endif /* defined(BCM_PETRA_SUPPORT)*/ 
#endif /* BCM_PETRA_SUPPORT*/ 

#ifdef BCM_PETRA_SUPPORT
#if defined(BCM_PETRA_SUPPORT)
/* implemented by: sw_state_dpp_soc_arad_pp_oam_lb_tst_up_trap_used_cnt_get */
typedef int (*sw_state_dpp_soc_arad_pp_oam_lb_tst_up_trap_used_cnt_get_cb)(
    int unit, uint32 *lb_tst_up_trap_used_cnt);
#endif /* defined(BCM_PETRA_SUPPORT)*/ 
#endif /* BCM_PETRA_SUPPORT*/ 
...
#ifdef BCM_PETRA_SUPPORT
#if defined(BCM_PETRA_SUPPORT)
/* implemented by: sw_state_dpp_soc_arad_pp_oam_lb_tst_up_trap_used_cnt_verify */
typedef int (*sw_state_dpp_soc_arad_pp_oam_lb_tst_up_trap_used_cnt_verify_cb)(
    int unit);
#endif /* defined(BCM_PETRA_SUPPORT)*/ 
#endif /* BCM_PETRA_SUPPORT*/ 
...
#ifdef BCM_PETRA_SUPPORT
#if defined(BCM_PETRA_SUPPORT)
typedef struct sw_state_dpp_soc_arad_pp_oam_lb_tst_up_trap_used_cnt_cbs_s {
    sw_state_dpp_soc_arad_pp_oam_lb_tst_up_trap_used_cnt_set_cb set;
    sw_state_dpp_soc_arad_pp_oam_lb_tst_up_trap_used_cnt_get_cb get;
    sw_state_dpp_soc_arad_pp_oam_lb_tst_up_trap_used_cnt_verify_cb verify;
} sw_state_dpp_soc_arad_pp_oam_lb_tst_up_trap_used_cnt_cbs_t;
#endif /* defined(BCM_PETRA_SUPPORT)*/ 
#endif /* BCM_PETRA_SUPPORT*/ 
...
typedef struct sw_state_dpp_soc_arad_pp_oam_cbs_s {
    ...
    sw_state_dpp_soc_arad_pp_oam_lb_tst_up_trap_used_cnt_cbs_t lb_tst_up_trap_used_cnt;
