...
extern void shr_bitop_range_clear(SHR_BITDCL *a, CONST int b, CONST int c) SAI_LIB_DLL_EXPORTED;
#define SHR_BITCLR_RANGE(_a, _b, _c)            \
    (shr_bitop_range_clear(_a, _b, _c))

/* set _c bits starting from _b in bit array _a */
extern void shr_bitop_range_set(SHR_BITDCL *a, CONST int b, CONST int c) SAI_LIB_DLL_EXPORTED;
...
extern void shr_bitop_range_copy(SHR_BITDCL *a,
                                 ...
                                 CONST SHR_BITDCL *c,
                                 CONST int d,
                                 CONST int e) SAI_LIB_DLL_EXPORTED;
...
extern void shr_bitop_range_and(CONST SHR_BITDCL *bits1,
                                ...
                                CONST int first,
                                CONST int bit_count,
                                SHR_BITDCL *dest) SAI_LIB_DLL_EXPORTED;
...
extern int shr_bitop_range_null(CONST SHR_BITDCL *a, CONST int first, CONST int bit_count) SAI_LIB_DLL_EXPORTED;

extern int shr_bitop_range_eq(CONST SHR_BITDCL *bits1, CONST SHR_BITDCL *bits2,
                         CONST int first, CONST int range) SAI_LIB_DLL_EXPORTED;

extern void shr_bitop_range_count(CONST SHR_BITDCL *bits, CONST int first,
                                 CONST int range, int *count) SAI_LIB_DLL_EXPORTED;
