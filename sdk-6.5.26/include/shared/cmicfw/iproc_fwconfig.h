...
/**************************************
 * Allocated SRAM for HR4 MACSEC WAR.
 **************************************/

/* Offset = 0x1C000 size = 16KB. */
#define M0SSQ_SRAM_HR4_MACSEC_WAR_CFG_SIZE       (16 * 1024)
#define M0SSQ_SRAM_HR4_MACSEC_WAR_CFG_OFFSET     \
    (M0SSQ_SHMEM_SIZE - M0SSQ_SRAM_HR4_MACSEC_WAR_CFG_SIZE)

/* Offset = 0x18000 size = 16KB. */
#define M0SSQ_SRAM_HR4_MACSEC_WAR_DATA_SIZE      (16 * 1024)
#define M0SSQ_SRAM_HR4_MACSEC_WAR_DATA_OFFSET    \
    (M0SSQ_SRAM_HR4_MACSEC_WAR_CFG_OFFSET - M0SSQ_SRAM_HR4_MACSEC_WAR_DATA_SIZE)
