...
* PON_TAG : 
*           |    |           |         |
*           |8100|SUBPORT_ID |TUNNEL_ID|
*           |    |           |         |
*
* -- DNX_ALGO_PORT_APP_FLAG_PON_CHAN_MODE_1:
*           |    |           |         |
*           |8100|SUBPORT_ID |TUNNEL_ID|
*           |    |   14:12   |   11:0  |
*    the value PON_TAG [14:12]&0x7 will be key to mapping table PRT_VIRTUAL_PORT_TCAM
*
* -- DNX_ALGO_PORT_APP_FLAG_PON_CHAN_MODE_2:
*           |    |          |          |
*           |8100|SUBPORT_ID|TUNNEL_ID |
*           |    |   14:13  |   12:0   |
*    the value PON_TAG [14:12]&0x6 will be key to mapping table PRT_VIRTUAL_PORT_TCAM
* 
*/

#define DNX_PORT_IS_PON_PORT_MODE_1(flags)              (flags & DNX_ALGO_PORT_APP_FLAG_PON_CHAN_MODE_1)
#define DNX_PORT_IS_PON_PORT_MODE_2(flags)              (flags & DNX_ALGO_PORT_APP_FLAG_PON_CHAN_MODE_2)

#define DNX_PON_PORT_MODE_1                             0x1
#define DNX_PON_PORT_MODE_2                             0x2

#define DNX_PORT_IS_PON_PORT_MODE_2(flags)              (flags & DNX_ALGO_PORT_APP_FLAG_PON_CHAN_MODE_2)

#define PON_SUBPORT_ID_MASK(mode)                       ((0x7 << (mode-1)) & 0x7)

/** define the port type for opeartion */
#define DNX_PORT_TYPE_PON                               0x0
#define DNX_PORT_TYPE_COE                               0x1

#define DNX_MAX_PON_SUBPORT_ID                          (15)
#define PON_SUBPORT_ID_GET(tunnel_id,mode)              ((tunnel_id >> 12) & PON_SUBPORT_ID_MASK(mode))
#define PON_CHANNEL_ID_GET(tunnel_id,mode)              (((mode-1)<<12)|(tunnel_id & 0xfff))
...
/** define invalid FC channel ID */
#define FC_CHAN_ID_INVALID                              -1

/*enum of field sub_type_format in dbal table EEDB_OUT_AC
 * it is only used for result_type=ETPS_AC_TRIPLE_TAG
 * 0:extender port
 * 1:PON port 
 */
typedef enum
{
    EEDB_OUT_AC_SUB_TYPE_FORMAT_INVALID = -1,
    EEDB_OUT_AC_SUB_TYPE_FORMAT_EXTENDER_PORT = 0,
    EEDB_OUT_AC_SUB_TYPE_FORMAT_PON_PORT,
} eedb_out_ac_sub_type_format_e;
 ...
 *   * None
 */
shr_error_e dnx_port_sit_coe_port_to_trunk_group_add(
    int unit,
    bcm_port_t port,
 ...
 *   * None
 */
shr_error_e dnx_port_sit_coe_port_to_trunk_group_del(
    int unit,
    bcm_port_t port,
    bcm_trunk_t trunk_id);
