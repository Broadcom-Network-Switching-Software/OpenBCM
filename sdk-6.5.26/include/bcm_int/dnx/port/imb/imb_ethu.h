 ...
 *
 * \param [in] unit - chip unit id
 * \param [in] current_mac_mode - ETHU current mac mode
 * \param [in] first_lane_local - first lane inside the ETHU
 * \param [in] nof_phys - number of phys
 * \param [out] mac_mode - new mac mode calculated
 *
 * \return
 *   int - seee _SHR_E_*
 *
 ...
 *   * None
 */
int imb_ethu_port_mac_mode_calc(
    int unit,
...
int imb_ethu_mac_ports_get(
    int unit,
    bcm_port_t port,
    bcm_pbmp_t * mac_ports);

int imb_ethu_mac_mode_config_ports_get(
    int unit,
    bcm_port_t port,
    bcm_pbmp_t * mac_ports);

int imb_ethu_mac_nof_ports_get(
    int unit,
    bcm_port_t port,
    int *mac_nof_ports);

int imb_ethu_mac_mode_config_nof_ports_get(
    int unit,
    bcm_port_t port,
 ...
 *
 * \param [in] unit - chip unit id
 * \param [in] port - logical port for which to enable forcing of PFC signal
 ...
 *   * None
 */
int imb_ethu_port_pfc_force_enable_set(
    int unit,
    bcm_port_t port,
    int pfc,
    uint32 enable);
...
/**
 * \brief - Enable / Disable PFC ignore when RX link is down
 *
 * \param [in] unit - chip unit id
 * \param [in] imb_info - IMB info
 * \param [in] enable - enable indication
 ...
 *   * None
 */
int imb_ethu_pfc_mask_on_link_fail_enable_set(
    int unit,
    const imb_create_info_t * imb_info,
    uint32 enable);
 ...
 *   * None
 */
int imb_ethu_port_mib_counter_get(
    int unit,
    bcm_port_t port,
    int counter_type,
    uint64 *counter_val);
...
/**
 * \brief
 *   Check if Number of lanes + FEC + Speed combination is supported.
 *   This function only validates part of FEC + Speed combinations.
 *   portmod will validate the rest FEC + Speed combinations.
 *
 * \param [in] unit - chip unit id
 * \param [in] pm_type - portmod type
 * \param [in] nof_lanes - number of lanes
 * \param [in] fec_type - fec type
 * \param [in] speed - speed
 * \param [in] for_autoneg - consider combinations supporting autoneg only
 * \param [out] is_valid - is the combination valid
 *
 */
int imb_ethu_port_fec_speed_is_valid_get(
    int unit,
 ...
 *   * None
 */
int imb_ethu_instru_synced_counters_config_set(
    int unit,
    int imb_id,
    uint8 nof_intervals,
    uint8 is_continuous);
 ...
 *   * None
 */
int imb_ethu_instru_synced_counters_last_write_get(
    int unit,
    bcm_port_t port,
    uint32 *last_write,
    uint32 *nof_writes);
 ...
 *   * None
 */
int imb_ethu_instru_synced_counters_per_record_get(
    int unit,
    bcm_port_t port,
    int record_index,
    int nof_counters,
...
/**
 * \brief - Reset per port (for entire IMB) instrumentation traffic counters
 *
 * \param [in] unit - chip unit id
 * \param [in] imb_info - IMB info
 * \return
 ...
 *   * None
 */
int imb_ethu_instru_traffic_counters_reset(
    int unit,
    const imb_create_info_t * imb_info);

/**
 * \brief - Reset per port instrumentation counters for instrumentation traffic mechanism
 *
 * \param [in] unit - chip unit id
 * \param [in] port - logical port
 * \return
 ...
 *   * None
 */
int imb_ethu_port_instru_traffic_counters_reset(
    int unit,
    bcm_port_t port);
 ...
 *   * None
 */
int imb_ethu_instru_pfc_deadlock_counters_reset(
    int unit,
    const imb_create_info_t * imb_info);
 ...
 *   * None
 */
int imb_ethu_port_instru_pfc_deadlock_counters_reset(
    int unit,
    bcm_port_t port);
 ...
 *   * None
 */
int imb_ethu_port_timesync_tx_info_get(
    int unit,
    bcm_port_t port,
 ...
 *   * None
 */
int imb_ethu_prd_port_last_packet_priority_get(
    int unit,
    bcm_port_t port,
    uint32 *priority,
    uint32 *tdm,
