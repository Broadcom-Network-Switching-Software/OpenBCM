 ...
 */
#define TAG_FORMAT_NONE DBAL_ENUM_FVAL_INCOMING_TAG_STRUCTURE_UNTAGGED_1
 ...
 *
 * \brief - Initialization function for Ingress PP Port
 *     Allocate an Ingress LLVP classification profile per PP port
 *
 * \param [in] unit - Relevant unit.
 * \param [in] pp_port - Ingress pp port.
 ...
 * None
 */
shr_error_e dnx_port_tpid_class_ingress_default_per_pp_port_init(
    int unit,
    uint32 pp_port,
    bcm_core_t core_id);
...
/**
 *
 * \brief - Free the allocated Ingress LLVP classification profile per PP port
 *
 * \param [in] unit - Relevant unit.
 ...
 * None
 */
shr_error_e dnx_port_tpid_class_ingress_default_per_pp_port_deinit(
    int unit,
    uint32 pp_port,
    bcm_core_t core_id,
 ...
 *  
 * \brief - De-Initialization function for egress PP Port
 * This function frees and deallocates an egress LLVP classification profile per PP port
 *
 * \param [in] unit - Relevant unit.
 * \param [in] pp_port - PP port
 * \param [in] core_id - Core id
 ...
 * None.
 */
shr_error_e dnx_port_tpid_class_egress_default_per_pp_port_deinit(
    int unit,
    uint32 pp_port,
    bcm_core_t core_id,
    uint8 tpid_ref_dealloc);
