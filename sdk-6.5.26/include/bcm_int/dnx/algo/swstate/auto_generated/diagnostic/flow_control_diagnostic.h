...
#ifndef __DNX_FLOW_CONTROL_DIAGNOSTIC_H__
#define __DNX_FLOW_CONTROL_DIAGNOSTIC_H__
...
int flow_control_db_rmc_thresholds_dump(
    int unit, dnx_sw_state_dump_filters_t filters);

#endif /* DNX_SW_STATE_DIAGNOSTIC */

#endif /* __DNX_FLOW_CONTROL_DIAGNOSTIC_H__ */
