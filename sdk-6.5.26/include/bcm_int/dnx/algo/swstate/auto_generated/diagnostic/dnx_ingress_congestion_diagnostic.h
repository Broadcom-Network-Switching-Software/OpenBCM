...
typedef enum {
    ...
    DNX_INGRESS_CONGESTION_DB_GLOBAL_VSQ_OCCUPANCY_INFO,
...
int dnx_ingress_congestion_db_global_vsq_occupancy_dump(
    int unit, dnx_sw_state_dump_filters_t filters);

int dnx_ingress_congestion_db_global_vsq_occupancy_shared_size_max_dump(
    int unit, int shared_size_max_idx_0, int shared_size_max_idx_1, dnx_sw_state_dump_filters_t filters);

int dnx_ingress_congestion_db_global_vsq_occupancy_guaranteed_size_max_dump(
    int unit, int guaranteed_size_max_idx_0, int guaranteed_size_max_idx_1, dnx_sw_state_dump_filters_t filters);

int dnx_ingress_congestion_db_global_vsq_occupancy_headroom_size_max_dump(
    int unit, int headroom_size_max_idx_0, dnx_sw_state_dump_filters_t filters);
