...
/**
 * implemented by: algo_failover_db_ing_mc_path_select_set
 */
typedef int (*algo_failover_db_ing_mc_path_select_set_cb)(
    int unit, dnx_algo_res_t ing_mc_path_select);

/**
 * implemented by: algo_failover_db_ing_mc_path_select_get
 */
typedef int (*algo_failover_db_ing_mc_path_select_get_cb)(
    int unit, dnx_algo_res_t *ing_mc_path_select);

/**
 * implemented by: algo_failover_db_ing_mc_path_select_create
 */
typedef int (*algo_failover_db_ing_mc_path_select_create_cb)(
    int unit, dnx_algo_res_create_data_t * data, void *extra_arguments);

/**
 * implemented by: algo_failover_db_ing_mc_path_select_allocate_single
 */
typedef int (*algo_failover_db_ing_mc_path_select_allocate_single_cb)(
    int unit, uint32 flags, void *extra_arguments, int *element);

/**
 * implemented by: algo_failover_db_ing_mc_path_select_free_single
 */
typedef int (*algo_failover_db_ing_mc_path_select_free_single_cb)(
    int unit, int element, void *extra_arguments);

/**
 * implemented by: algo_failover_db_ing_mc_path_select_is_allocated
 */
...
/**
 * This structure holds the access functions for the variable ing_mc_path_select
 */
typedef struct {
...
typedef struct {
    ...
    /**
     * Access struct for ing_mc_path_select
     */
