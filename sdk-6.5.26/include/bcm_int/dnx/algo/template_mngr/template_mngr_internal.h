...
#define DNX_ALGO_TEMP_MNGR_EXCHANGE(node_id, algo_temp, flags, profile_data, old_profile,extra_arguments, new_profile, first_reference, last_reference)\
        SHR_IF_ERR_EXIT(dnx_algo_template_exchange(unit, node_id, algo_temp, flags, profile_data, old_profile, \
