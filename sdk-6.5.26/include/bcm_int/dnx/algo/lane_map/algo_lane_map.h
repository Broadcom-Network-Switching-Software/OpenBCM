...
/**
 * \brief - 
 *  Get the nif or fabric lane to serdes mapping info from lane map database by lane id.
 * 
 * \param [in] unit - unit #.
 * \param [in] type - the lane map type.
 *        support types:
 ...
 *   * None
 */
shr_error_e dnx_algo_lane_map_lane_id_to_serdes_map_get(
    int unit,
    dnx_algo_lane_map_type_e type,
    int lane,
    soc_dnxc_lane_map_db_map_t * lane2serdes);
...
/**
 * \brief - 
 * Get OTN logical lane.
 *
 * \param [in] unit - Unit #.
 * \param [in] logical_port - logical port #.
 * \param [in] max_nof_lanes - the depth of physical lane arrary.
 * \param [inout] lanes - physical lane array
 * \param [out] nof_lanes - number of physical lanes
 * 
 * \return
 *   see shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_algo_lane_map_otn_lanes_get(
    int unit,
...
/**
 * \brief - 
 * Find OTN logical lane.
 *
 * \param [in] unit - Unit #.
 * \param [in] logical_port - logical port #.
 * \param [in] first_phy - the first physical lane number #.
 * \param [in] nof_logical_lanes - Number of logical lanes #.
 * \param [in] start - the start logical otn lane number #.
 * \param [in] end - the end logical otn lane number #.
 * \param [out] first - first logical otn lane
 * 
 * \return
 *   see shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_algo_lane_map_otn_logical_lane_find(
    int unit,
    bcm_port_t logical_port,
    int first_phy,
 ...
 * \param [in] unit - Unit #.
 * \param [in] logical_port - logical port #.
 * \param [out] nof_lanes - number of logical otn lane
 * \param [out] first - first logical otn lane
 * 
 * \return
 *   see shr_error_e
 ...
 *   * None
 */
shr_error_e dnx_algo_lane_map_otn_logical_lane_get(
    int unit,
    bcm_port_t logical_port,
    int *nof_lanes,
    int *first);
...
/**
 * \brief - 
 * Allocate the OTN logical lanes.
 *
 * \param [in] unit - Unit #.
 * \param [in] logical_port - logical port #.
 * \param [in] first - the first logical lane #.
 * \param [in] nof_logical_lanes - Number of logical lanes #.
 * \param [out] logical_lanes - logical otn lane array
 * 
 * \return
 *   see shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_algo_lane_map_otn_logical_lane_alloc(
    int unit,
    bcm_port_t logical_port,
    int first,
    int nof_logical_lanes,
...
/**
 * \brief - 
 * Free the OTN logical lanes associated to a logical port.
 *
 * \param [in] unit - Unit #.
 * \param [in] logical_port - logical port #.
 * 
 ...
 *   * None
 */
shr_error_e dnx_algo_lane_map_otn_logical_lane_free(
    int unit,
    bcm_port_t logical_port);
