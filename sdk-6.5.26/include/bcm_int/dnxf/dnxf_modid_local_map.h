...
int dnxf_modid_local_map_clear(
    int unit);

int dnxf_modid_local_map_module_clear(
    int unit,
    bcm_module_t local_module_id);

int dnxf_modid_local_map_is_valid(
    int unit,
    bcm_module_t local_module_id,
    int *is_valid);

int dnxf_modid_local_map_add(
    int unit,
    bcm_module_t local_module_id,
    bcm_module_t module_id,
    int allow_override);

int dnxf_modid_local_map_get(
    int unit,
    bcm_module_t local_module_id,
    bcm_module_t * module_id);

int dnxf_modid_local_map_modid_to_local(
    int unit,
    bcm_module_t module_id,
    bcm_module_t * local_module_id);
