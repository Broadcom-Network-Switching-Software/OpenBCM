...
/* SFlow Sequence Number encap info */
typedef struct bcm_instru_sflow_sn_encap_info_s {
    uint32 flags;           /* See BCM_INSTRU_SFLOW_ENCAP_XXX flags definitions. */
    int counter_if_id;      /* Counter Interface ID */
    int counter_base_id;    /* Counter base ID */
    int sflow_sn_encap_id;  /* Global lif */
} bcm_instru_sflow_sn_encap_info_t;

/* SFlow Sequence Number encap callback function prototype */
typedef int (*bcm_instru_sflow_sn_encap_traverse_cb)(
    int unit, 
    bcm_instru_sflow_sn_encap_info_t *sflow_sn_encap_info, 
    void *user_data);
