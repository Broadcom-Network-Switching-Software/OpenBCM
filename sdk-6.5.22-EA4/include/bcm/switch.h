...
typedef enum bcm_switch_control_e {
    ...
    bcmSwitchCollectModeEnable = 1461,  /* Enable/disable DBAL collect mode per
                                           module. */
    bcmSwitchCollectModeCommitLast = 1462, /*  Indicates that last collection entry
                                           was committed. */
    bcmSwitchFlexe1588RxDestMacOui = 1463, /* The upper 3 bytes for matching FlexE
                                           1588 destination MAC from external
                                           processor. */
    bcmSwitchFlexe1588RxDestMacNonOui = 1464, /* The lower 3 bytes for matching FlexE
                                           1588 destination MAC from external
                                           processor. */
    bcmSwitchFlexe1588RxSrcMacOui = 1465, /* The upper 3 bytes for matching FlexE
                                           1588 source MAC from external
                                           processor. */
    bcmSwitchFlexe1588RxSrcMacNonOui = 1466, /* The lower 3 bytes for matching FlexE
                                           1588 source MAC from external
                                           processor. */
    bcmSwitchFlexe1588TxDestMacOui = 1467, /* The upper 3 bytes for FlexE 1588
                                           destination MAC encapsulation to
                                           external processor */
    bcmSwitchFlexe1588TxDestMacNonOui = 1468, /* The lower 3 bytes for FlexE 1588
                                           destination MAC encapsulation to
                                           external processor. */
    bcmSwitchFlexe1588TxSrcMacOui = 1469, /* The upper 3 bytes for FlexE 1588
                                           source MAC encapsulation to external
                                           processor. */
    bcmSwitchFlexe1588TxSrcMacNonOui = 1470, /* The lower 3 bytes for FlexE 1588
                                           source MAC encapsulation to external
                                           processor. */
    bcmSwitchIFA2TruncationHdrLenUpdate = 1471, /* Enable IP header length update for
                                           truncated IFA2 packet. */
    bcmSwitchIFA2OverLAG = 1472,        /* Enable IFA2 over LAG, two-pass model. */
    bcmSwitchMplsLastTermMode = 1473,   /* MPLS last termination mode. */
    bcmSwitchMplsEvpnEnable = 1474,     /* Enable mpls evpn feature. */
    bcmSwitchMplsEvpnEsiFilterEnable = 1475, /* Enable mpls evpn ESI filter. */
    bcmSwitchMplsEvpnVlanAwareModeEnable = 1476, /* Enable mpls evpn vlan aware mode. */
    bcmSwitchExternalTablePropXlDb = 1477, /* XL DB property for external tables. */
    bcmSwitchIngressVlanEditClassNull = 1478, /* Enable/Disable a reserved value to be
                                           a NULL vlan edit class. */
    bcmSwitchFlexeBasOamToExtProcessorEnable = 1479, /* Enable FlexE BAS OAM to external
                                           processor */
    bcmSwitch__Count = 1480             /* Must be last.  Not a usable value. */
...
typedef enum bcm_switch_pkt_trace_drop_reason_e {
    ...
    bcmSwitchPktTraceDropReasonL3NextHopDrop = 68, /* Packcet dropped due to L3 nexthop
                                           drop. */
    bcmSwitchPktTraceDropReasonCount = 69 
