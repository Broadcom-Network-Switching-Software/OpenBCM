...
#define BCM_OAM_OPCODE_DMM_IN_HW            0x40000    /* Endpoint is DM */
#define BCM_OAM_OPCODE_SLM_IN_HW            0x80000    /* Endpoint is SLM */
#define BCM_OAM_OPCODE_1DM_IN_HW            0x100000   /* Endpoint is 1DM */
...
typedef enum bcm_oam_control_type_e {
    ...
    bcmOamControlEthDmacMdlMatchCheck = 36, /* Enable/Disable checking the match
                                           ...
                                           OAM */
    bcmOAMControlCount = 37             /* Always Last. Not a usable value. */
