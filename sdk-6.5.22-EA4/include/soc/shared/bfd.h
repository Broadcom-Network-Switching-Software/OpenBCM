...
#define SHR_BFD_SESS_SET_F_VRF_BASED_SESS       0x04000000
#define SHR_BFD_SESS_SET_F_LOCAL_STATE_DOWN     0x08000000
#define SHR_BFD_SESS_SET_F_MPLS_TP_RESET_REMOTE_DISCR  0x10000000
/*
 * BFD sampling flags
 */
...
typedef enum shr_bfd_uc_match_id_type_e {
    ...
    SHR_BFD_UC_VXLAN = 16,                /* BFD over VXLAN */
    SHR_BFD_UC_INNER_SINGLE_TAG = 17,     /* BFD VXLAN with inner single vlan tag. */
    SHR_BFD_UC_INNER_DOUBLE_TAG = 18,     /* BFD VXLAN with inner double vlan tag. */
    SHR_BFD_UC_MATCH_ID_TYPE_COUNT = 19
