 ...
 */
/**
 * \brief Init default data structure - dnx_data_if_headers
 * 
 * \param [in] unit - Unit #
 * 
 * \return
...
/*
 * SUBMODULE INTERFACE DNX_DATA_IF_HEADERS - FTMH:
 * {
 */
/**
 * \brief Interface for headers ftmh data
 */
typedef struct
{
    /**
...
/*
 * SUBMODULE INTERFACE DNX_DATA_IF_HEADERS - TSH:
 * {
 */
/**
 * \brief Interface for headers tsh data
 */
typedef struct
{
    /**
    ...
    /**
     * returns define data of time_stamp_offset
     */
    dnx_data_headers_tsh_time_stamp_offset_get_f time_stamp_offset_get;
    /**
     * returns define data of time_stamp_bits
     */
...
/*
 * SUBMODULE  - OTSH:
 * tsh header parameters in legacy device
 * {
 */
/*
 * Table value structure
...
/*
 * SUBMODULE INTERFACE DNX_DATA_IF_HEADERS - OTSH:
 * {
 */
/**
 * \brief Interface for headers otsh data
 */
typedef struct
{
    /**
 ...
 * optimized ftmh header parameters
 * {
 */
/*
 * Table value structure
...
{
    /**
     * Indicate if FTMH_OPT parsing is supported
     */
...
/*
 * SUBMODULE INTERFACE DNX_DATA_IF_HEADERS - OPTIMIZED_FTMH:
 * {
 */
/**
 * \brief Interface for headers optimized_ftmh data
 */
typedef struct
{
    /**
    ...
    /**
     * returns define data of packet_size_7_0_offset
     */
...
{
    /**
     * Indicate if header signal visibility is global or regular visibility
     */
...
/*
 * SUBMODULE INTERFACE DNX_DATA_IF_HEADERS - INTERNAL:
 * {
 */
/**
 * \brief Interface for headers internal data
 */
typedef struct
{
    /**
 ...
 * internal header parameters  in legacy device
 * {
 */
/*
 * Table value structure
...
/*
 * SUBMODULE INTERFACE DNX_DATA_IF_HEADERS - INTERNAL_LEGACY:
 * {
 */
/**
 * \brief Interface for headers internal_legacy data
 */
typedef struct
{
    /**
    ...
    /**
     * returns define data of eei_ext_present_offset
     */
    dnx_data_headers_internal_legacy_eei_ext_present_offset_get_f eei_ext_present_offset_get;
    /**
     * returns define data of eei_ext_present_bits
     */
 ...
 * fhei header parameters of fhei_size sz1, fhei_type trap or sniff
 * {
 */
/*
 * Table value structure
...
/*
 * SUBMODULE INTERFACE DNX_DATA_IF_HEADERS - FHEI_SZ1_TRAP_SNIFF:
 * {
 */
/**
 * \brief Interface for headers fhei_sz1_trap_sniff data
 */
typedef struct
{
    /**
 ...
 * ffhei header parameters of type trap or sniff in legacy devices
 * {
 */
/*
 * Table value structure
...
/*
 * SUBMODULE INTERFACE DNX_DATA_IF_HEADERS - FHEI_TRAP_SNIFF_LEGACY:
 * {
 */
/**
 * \brief Interface for headers fhei_trap_sniff_legacy data
 */
typedef struct
{
    /**
...
/*
 * SUBMODULE INTERFACE DNX_DATA_IF_HEADERS - UDH:
 * {
 */
/**
 * \brief Interface for headers udh data
 */
typedef struct
{
    /**
...
/*
 * SUBMODULE INTERFACE DNX_DATA_IF_HEADERS - FTMH_LEGACY:
 * {
 */
/**
 * \brief Interface for headers ftmh_legacy data
 */
typedef struct
{
    /**
    ...
    /**
     * returns define data of otsh_en_offset
     */
    ...
    /**
     * returns define data of outbound_mirr_disable_offset
     */
    ...
    /**
     * returns define data of dsp_ext_present_offset
     */
    ...
    /**
     * returns define data of exclude_source_offset
     */
    ...
    /**
     * returns define data of dsp_ext_header_offset
     */
    ...
    /**
     * returns define data of otsh_en_bits
     */
    ...
    /**
     * returns define data of outbound_mirr_disable_bits
     */
    ...
    /**
     * returns define data of dsp_ext_present_bits
     */
    ...
    /**
     * returns define data of exclude_source_bits
     */
    dnx_data_headers_ftmh_legacy_exclude_source_bits_get_f exclude_source_bits_get;
    /**
     * returns define data of dsp_ext_header_bits
     */
    ...
    /**
     * returns define data of dsp_ext_header_size
     */
...
/*
 * SUBMODULE INTERFACE DNX_DATA_IF_HEADERS - OTSH_LEGACY:
 * {
 */
/**
 * \brief Interface for headers otsh_legacy data
 */
typedef struct
{
    /**
...
{
    /**
     * indicate if IBCH1 header supported
     */
...
/*
 * SUBMODULE INTERFACE DNX_DATA_IF_HEADERS - SYSTEM_HEADERS:
 * {
 */
/**
 * \brief Interface for headers system_headers data
 */
typedef struct
{
    /**
...
{
    /**
     * Enable/Disable OTMH. '1' means that otmh is supported, '0' means no support.
     */
...
/*
 * SUBMODULE INTERFACE DNX_DATA_IF_HEADERS - OTMH:
 * {
 */
/**
 * \brief Interface for headers otmh data
 */
typedef struct
{
    /**
...
/*
 * SUBMODULE  - PPH:
 * Packet proccessing header values
 * {
 */
/*
 * Table value structure
...
/*
 * SUBMODULE INTERFACE DNX_DATA_IF_HEADERS - PPH:
 * {
 */
/**
 * \brief Interface for headers pph data
 */
typedef struct
{
    /**
    ...
    /**
     * returns define data of pph_vsi_selection_size
     */
...
{
    /**
     * PPH Forwarding Header Offset calculation. '1' means calculation uses egress parsing index, '0' means not use egress parsing index.
     */
    dnx_data_headers_general_fwd_header_offset_calc_with_egress_pars_idx,
    /**
     * Jericho system header support. '1' means support, '0' means not support.
     */
...
/*
 * SUBMODULE INTERFACE DNX_DATA_IF_HEADERS - GENERAL:
 * {
 */
/**
 * \brief Interface for headers general data
 */
typedef struct
{
    /**
...
{
    /**
     * If set, means MPLS command in FHEI is from EEI[23:20], else configured globally
     */
    dnx_data_headers_feature_fhei_mpls_cmd_from_eei,
    /**
     * If set, FAI[0] indicates forwarding lookup result, else FAI[0] is not for unknown address
     */
    dnx_data_headers_feature_unknown_address,
    /**
     * If set, Flow_ID_Ext should be created when TSH is injected
     */
...
/*
 * SUBMODULE INTERFACE DNX_DATA_IF_HEADERS - FEATURE:
 * {
 */
/**
 * \brief Interface for headers feature data
 */
typedef struct
{
    /**
    ...
    /**
     * returns define data of fhei_mpls_swap_remark_size
     */
...
/*
 * MODULE INTERFACE DNX_DATA_IF_HEADERS:
 * {
 */
/**
 * \brief Interface for headers data
 */
typedef struct
{
    /**
     * Interface for headers ftmh data
     */
    dnx_data_if_headers_ftmh_t ftmh;
    /**
     * Interface for headers tsh data
     */
    dnx_data_if_headers_tsh_t tsh;
    /**
     * Interface for headers otsh data
     */
    dnx_data_if_headers_otsh_t otsh;
    /**
     * Interface for headers optimized_ftmh data
     */
    dnx_data_if_headers_optimized_ftmh_t optimized_ftmh;
    /**
     * Interface for headers internal data
     */
    dnx_data_if_headers_internal_t internal;
    /**
     * Interface for headers internal_legacy data
     */
    dnx_data_if_headers_internal_legacy_t internal_legacy;
    /**
     * Interface for headers fhei_sz1_trap_sniff data
     */
    dnx_data_if_headers_fhei_sz1_trap_sniff_t fhei_sz1_trap_sniff;
    /**
     * Interface for headers fhei_trap_sniff_legacy data
     */
    dnx_data_if_headers_fhei_trap_sniff_legacy_t fhei_trap_sniff_legacy;
    /**
     * Interface for headers udh data
     */
    dnx_data_if_headers_udh_t udh;
    /**
     * Interface for headers ftmh_legacy data
     */
    dnx_data_if_headers_ftmh_legacy_t ftmh_legacy;
    /**
     * Interface for headers otsh_legacy data
     */
    dnx_data_if_headers_otsh_legacy_t otsh_legacy;
    /**
     * Interface for headers system_headers data
     */
    dnx_data_if_headers_system_headers_t system_headers;
    /**
     * Interface for headers otmh data
     */
    dnx_data_if_headers_otmh_t otmh;
    /**
     * Interface for headers pph data
     */
    dnx_data_if_headers_pph_t pph;
    /**
     * Interface for headers general data
     */
    dnx_data_if_headers_general_t general;
    /**
     * Interface for headers feature data
     */
