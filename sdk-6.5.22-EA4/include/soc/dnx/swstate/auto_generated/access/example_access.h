...
/**
 * implemented by: example_occ2_create
 */
typedef int (*example_occ2_create_cb)(
    int unit, sw_state_occ_bitmap_init_info_t * init_info);

/**
 * implemented by: example_occ2_get_next
 */
typedef int (*example_occ2_get_next_cb)(
    int unit, uint32 *place, uint8 *found);

/**
 * implemented by: example_occ2_get_next_in_range
 */
typedef int (*example_occ2_get_next_in_range_cb)(
    int unit, uint32 start, uint32 end, uint8 forward, uint8 val, uint32 *place, uint8 *found);

/**
 * implemented by: example_occ2_status_set
 */
typedef int (*example_occ2_status_set_cb)(
    int unit, uint32 place, uint8 occupied);

/**
 * implemented by: example_occ2_is_occupied
 */
typedef int (*example_occ2_is_occupied_cb)(
    int unit, uint32 place, uint8 *occupied);

/**
 * implemented by: example_occ2_alloc_next
 */
typedef int (*example_occ2_alloc_next_cb)(
    int unit, uint32 *place, uint8 *found);

/**
 * implemented by: example_occ2_clear
 */
typedef int (*example_occ2_clear_cb)(
    int unit);

/**
 * implemented by: example_occ2_print
 */
...
/**
 * implemented by: example_defragmented_chunk_example_offset_unreserve
 */
...
/**
 * implemented by: example_defragmented_chunk_example_offset_reserve
 */
typedef int (*example_defragmented_chunk_example_offset_reserve_cb)(
    int unit, uint32 defragmented_chunk_example_idx_0, uint32 slots_in_offset, uint32 piece_offset);

/**
 * implemented by: example_defragmented_chunk_example_defrag
 */
...
/**
 * This structure holds the access functions for the variable occ2
 */
typedef struct {
