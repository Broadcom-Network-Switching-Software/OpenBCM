/** \file dnx/swstate/auto_generated/access/dnx_iqs_access.h
 *
...
/**
 * implemented by: dnx_iqs_db_is_init
 */
typedef int (*dnx_iqs_db_is_init_cb)(
    int unit, uint8 *is_init);

/**
 * implemented by: dnx_iqs_db_init
 */
typedef int (*dnx_iqs_db_init_cb)(
    int unit);

/**
 * implemented by: dnx_iqs_db_credit_request_profile_alloc
 */
typedef int (*dnx_iqs_db_credit_request_profile_alloc_cb)(
    int unit);

/**
 * implemented by: dnx_iqs_db_credit_request_profile_valid_set
 */
typedef int (*dnx_iqs_db_credit_request_profile_valid_set_cb)(
    int unit, uint32 credit_request_profile_idx_0, int valid);

/**
 * implemented by: dnx_iqs_db_credit_request_profile_valid_get
 */
typedef int (*dnx_iqs_db_credit_request_profile_valid_get_cb)(
    int unit, uint32 credit_request_profile_idx_0, int *valid);

/**
 * implemented by: dnx_iqs_db_credit_request_profile_thresholds_set
 */
...
/**
 * This structure holds the access functions for the variable thresholds
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable dnx_iqs_credit_request_profile_db_t
 */
typedef struct {
    ...
    /**
     * Access struct for thresholds
     */
    dnx_iqs_db_credit_request_profile_thresholds_cbs thresholds;
} dnx_iqs_db_credit_request_profile_cbs;

/**
 * This structure holds the access functions for the variable queue_min
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable queue_max
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable retransmit_th
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable delete_th
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable dnx_iqs_credit_watchdog_db_t
 */
typedef struct {
    /**
     * Access struct for queue_min
     */
    dnx_iqs_db_credit_watchdog_queue_min_cbs queue_min;
    /**
     * Access struct for queue_max
     */
