    ...
    int egress_unit)
{
     ...
     */
    rv = vxlan_port_add(ingress_unit, cint_vxlan_roo_mc_info.pe1_port, cint_vxlan_roo_mc_info.vxlan_tunnel_if, &vxlan_port_id);
    if (rv != BCM_E_NONE) 
    {
    ...
    rv = vxlan_port_add(egress_unit, cint_vxlan_roo_mc_info.pe2_port, cint_vxlan_roo_mc_info.pe2_vxlan_tunnel_if, &vxlan_port_id);
    if (rv != BCM_E_NONE)
    {
        printf("%s(): Error, vxlan_port_add \n", proc_name);
        return rv;
