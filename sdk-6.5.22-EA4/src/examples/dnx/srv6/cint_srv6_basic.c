...
int
srv6_endpoint_tunnel(int unit, uint8 next_protocol_is_l2, uint8 is_termination, uint8 lif_cs_profile)
{
 ...
 */
int
srv6_gsid_endpoint_tunnel_cross_connect(int unit, int out_port, int fec, uint8 next_protocol_is_l2)
{
