...
cint_srv6_tunnel_info_s cint_srv6_tunnel_info =
{
        ...
        {{ 0xAA, 0xAA, 0xBB, 0xBB, 0xCC, 0xCC, 0x11, 0x11, 0xBB, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
         ...
         { 0xAA, 0xAA, 0xBB, 0xBB, 0xCC, 0xCC, 0x33, 0x33, 0xAA, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
                        ...
                        uint8 is_gsid_eoc)        /** if set, the last GSID in SID is EOC */
{
...

   {
     ...
     */
    {
        ...
        srv6_tunnel_termination(unit, DIP_ENDPOINT_GSID1, 0, cint_srv6_tunnel_info.vrf_in[ENDPOINT_GSID1], 0, 1, 0);
        srv6_tunnel_termination(unit, DIP_ENDPOINT_GSID0, 0, cint_srv6_tunnel_info.vrf_in[ENDPOINT_GSID0], 0, 1, is_gsid_eoc);
        ...
        if (next_header_is_eth)
        {
            ...
            srv6_tunnel_termination(unit, DIP_EGRESS, 1, cint_srv6_tunnel_info.vrf_in[EGRESS], cint_srv6_tunnel_info.l2_termination_vsi, 1, 0);
            /** to allow termination of GSID because of SL == 0 && EOC */
            srv6_tunnel_termination(unit, DIP_EGRESS_EOC, 1, cint_srv6_tunnel_info.vrf_in[EGRESS], cint_srv6_tunnel_info.l2_termination_vsi, 1, is_gsid_eoc);
        }
        else
        {
            /** to allow termination of GSID because of SL == 0 && SI==0 */
            srv6_tunnel_termination(unit, DIP_EGRESS, 1, cint_srv6_tunnel_info.vrf_in[EGRESS], 0, 1, 0);
            /** to allow termination of GSID because of SL == 0 && EOC */
            srv6_tunnel_termination(unit, DIP_EGRESS_EOC, 1, cint_srv6_tunnel_info.vrf_in[EGRESS], 0, 1, is_gsid_eoc);
        }
