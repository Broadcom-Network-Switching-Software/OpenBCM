 ...
 * cint                                                                                                                                             *
 * int unit = 0;                                                                                                                                    *
 * ddnx_ac_learn_p2p_to_mp_with_ports__start_run(int unit, int in_port, int out_port)                                                               *
 *                                                                                                                                                  *
...
int dnx_ac_learn_p2p_to_mp__cleanup(int unit) {
    ...
    for (in_ac_idx = 0; in_ac_idx <= NOF_IN_ACS; in_ac_idx++)
    {
        rv = vlan_port__delete(unit, g_dnx_ac_learn_p2p_to_mp.ac_vswitch_info[in_ac_idx].ac_type_flags,
                               NULL, g_dnx_ac_learn_p2p_to_mp.ac_vswitch_info[in_ac_idx].gport);
        if (rv != BCM_E_NONE) {
