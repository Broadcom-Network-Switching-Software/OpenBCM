...
int cint_field_srv6_alternate_marking_ingress_node_iPMF3_entry_add(int unit, bcm_field_entry_t *entry_handle)
{
    ...
    g_cint_field_srv6_am_ing_ent.flow_id_2_lsb_in_trunk_hash = (flow_id_w_L_bit & 0x3)<<6;  /* 2 LSB of flow id should be put into trunk hash key[7:6] */
    g_cint_field_srv6_am_ing_ent.flow_id_16_msb_in_network_hash = flow_id_w_L_bit >> 2;     /* 16 MSB of  flow id should be put into network hash key[16:0] */
