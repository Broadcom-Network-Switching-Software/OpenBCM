...
int cint_field_sniff_destroy(int unit, bcm_field_context_t ipmf1_context_id, bcm_field_context_t epmf_context_id)
{
    ...
    rv = bcm_field_group_context_detach(unit, cint_field_sniff_ingress_fg_id, ipmf1_context_id);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = bcm_field_group_context_detach(unit, cint_field_sniff_egress_fg_id, epmf_context_id);
    if (rv != BCM_E_NONE)
    {
...
int cint_field_sniff_ingress_main(int unit, bcm_field_context_t ipmf1_context_id)
{
    ...
    rv = bcm_field_group_context_attach(unit, 0, cint_field_sniff_ingress_fg_id, ipmf1_context_id, &attach_info);
    if (rv != BCM_E_NONE)
    {
...
int cint_field_sniff_egress_main(int unit, bcm_field_context_t epmf_context_id)
{
    ...
    rv = bcm_field_group_context_attach(unit, 0, cint_field_sniff_egress_fg_id, epmf_context_id, &attach_info);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d), in bcm_field_group_context_attach\n", rv);
        return rv;
...
int cint_field_sniff_ingress_config(int unit, int destroy_config, bcm_field_context_t ipmf1_context_id)
{
    ...
    rv = cint_field_sniff_ingress_main(unit, ipmf1_context_id);
    if (rv != BCM_E_NONE)
    {
...
int cint_field_sniff_egress_config(int unit, int destroy_config, bcm_field_context_t epmf_context_id)
{
    ...
    rv = cint_field_sniff_egress_main(unit, epmf_context_id);
    if (rv != BCM_E_NONE)
    {
...
int cint_field_sniff_example(int unit, int destroy_config, bcm_field_context_t ipmf1_context_id, bcm_field_context_t epmf_context_id)
{
    ...
    rv = cint_field_sniff_ingress_config(unit, destroy_config, ipmf1_context_id);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = cint_field_sniff_egress_config(unit, destroy_config, epmf_context_id);
    if (rv != BCM_E_NONE)
    {
    ...
    if(destroy_config)
    {
        ...
        rv = cint_field_sniff_destroy(unit,ipmf1_context_id,epmf_context_id);
        if (rv != BCM_E_NONE)
        {
