    ...
    pbmp_t * okay_pbmp)
{
    ...
    /*
     * Check if the ports beening probed are: 1. Whitin a valid range 2. Member of the supported phys PBMP
     */
    ...
    BCM_PBMP_ITER(pbmp, port)
    {
        SHR_IF_ERR_EXIT(MBCM_DNXF_DRIVER_CALL(unit, mbcm_dnxf_port_speed_max,
                                              (unit, port, &(SOC_INFO(unit).port_speed_max[port]))));
    }
    ...
    int enable)
{
    ...
    {
        SHR_IF_ERR_EXIT(MBCM_DNXF_DRIVER_CALL(unit, mbcm_dnxf_fabric_links_aldwp_config, (unit, port)));
    }
    else
    {
        SHR_IF_ERR_EXIT(rc);
     ...
     */
    SHR_IF_ERR_EXIT(MBCM_DNXF_DRIVER_CALL(unit, mbcm_dnxf_port_pump_enable_set, (unit, port, enable)));
    ...
    int *speed)
{
    ...
    SHR_IF_ERR_EXIT(MBCM_DNXF_DRIVER_CALL(unit, mbcm_dnxf_port_speed_max, (unit, port, speed)));
