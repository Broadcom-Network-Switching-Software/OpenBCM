    ...
    bcm_port_mapping_info_t *mapping)
{
    if (mapping != NULL) {
        ...
        mapping->base_hr = -1;
        mapping->tm_port = -1;
        mapping->in_tm_port = -1;
        mapping->out_tm_port = -1;
        mapping->pp_dsp = -1;
    }
    return;
}
 ...
 * Purpose:
 *      Initialize fdr_config parameters data structure.
 * Parameters:
 *      fdr_config - Pointer to bcm_port_fdr_config_t data structure to
 *                 be initialized.
 * Returns:
 *      None
 */
void
bcm_port_fdr_config_t_init(bcm_port_fdr_config_t *fdr_config)
{
    if (fdr_config != NULL) {
        sal_memset(fdr_config, 0, sizeof (*fdr_config));
    }
    return;
}
...
/*
 * Function:
 *      bcm_port_network_group_t_init
 * Purpose:
 *      Initialize group parameters data structure.
 * Parameters:
 *      fdr_config - Pointer to bcm_port_network_group_t data structure to
 *                 be initialized.
 * Returns:
 *      None
 */
void
bcm_port_network_group_t_init(bcm_port_network_group_t *group)
{
    if (group != NULL) {
...
/*
 * Function:
 *      bcm_port_force_vlan_config_t_init
 * Purpose:
 *      Initialize force VLAN configuration structure.
 * Parameters:
 *      config - Pointer to bcm_port_force_vlan_config_t data structure to
 *                 be initialized.
 * Returns:
 *      None
 */
void
bcm_port_force_vlan_config_t_init(bcm_port_force_vlan_config_t *config)
{
    if (config != NULL) {
        sal_memset(config, 0, sizeof (*config));
    }
