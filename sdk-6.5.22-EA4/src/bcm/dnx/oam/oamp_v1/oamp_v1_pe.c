    ...
    if (*first_instruction == DNX_OAMP_PE_NOT_SET)
    {
        *first_instruction = *next_instruction_index;
        ...
        INSTR_LABEL(CE1_COPY(IN_FIFO, DEFAULT, INST_CONST, INST_CONST, CONCATENATE),
                    CE2_COPY(FDBK_FIFO, DEFAULT, INST_CONST, 3B), ALU_NOP, CMN(READ, NONE, 0x1, ALWAYS_NEVER, NXT_JMP),
        ...
        INSTR_LABEL(CE1_COPY(IN_FIFO, DEFAULT, INST_CONST, INST_CONST, CONCATENATE),
                    CE2_COPY(FDBK_FIFO, DEFAULT, INST_CONST, 2B), ALU_NOP, CMN(READ, NONE, 0x2, ALWAYS_NEVER, NXT_JMP),
        ...
        INSTR_LABEL(CE1_COPY(IN_FIFO, DEFAULT, INST_CONST, INST_CONST, CONCATENATE),
                    CE2_COPY(FDBK_FIFO, DEFAULT, INST_CONST, 1B), ALU_NOP, CMN(READ, NONE, 0x3, ALWAYS_NEVER, NXT_JMP),
    ...
    oamp_pe_func_config_t * func_config)
{
    ...
    if (saved_prog_index == DNX_OAMP_PE_NOT_SET)
    {
        ...
        INSTR(CE1_NOP, CE2_COPY(IN_FIFO, DEFAULT, INST_CONST, 1B), ALU_SET(FEM, TMP_REG1),
              CMN(NONE, NONE, 0x10, NEVER_NEVER, NXT_JMP));

        
        INSTR(CE1_NOP, CE2_COPY(IN_FIFO, DEFAULT, INST_CONST, 1B), ALU_SET(FEM, TMP_REG2),
    ...
    int *first_instruction)
{
    ...
    if (*first_instruction == DNX_OAMP_PE_NOT_SET)
    {
        *first_instruction = *next_instruction_index;
        ...
        INSTR(CE1_COPY(IN_FIFO, PPH_EXIST_UPDATE, VLD_B, VLD_B, FEM), CE2_COPY(IN_FIFO, DEFAULT, INST_CONST, 2B),
        ...
        INSTR(CE1_COPY(IN_FIFO, DEFAULT, INST_CONST, INST_CONST, OR), CE2_COPY(TMP_REG3, DEFAULT, TMP_REG3, 1B),
        ...
        INSTR(CE1_NOP, CE2_COPY(PROG_VAR, DEFAULT, INST_CONST, 4B), ALU_SET(FEM, TMP_REG2),
        ...
        INSTR(CE1_COPY(TMP_REG4, DEFAULT, NONE, INST_CONST, CONCATENATE), CE2_COPY(TMP_REG3, DEFAULT, NONE, 2B),
        ...
        INSTR(CE1_COPY(NONE, DEFAULT, NONE, INST_CONST, CONCATENATE), CE2_COPY(IN_FIFO, DEFAULT, INST_CONST, 1B),
    ...
    int *first_instruction)
{
    ...
    if (*first_instruction == DNX_OAMP_PE_NOT_SET)
    {
        *first_instruction = *next_instruction_index;
        ...
        INSTR(CE1_NOP, CE2_COPY(NS_16_VAR_0, VSI_GEN_MEM_OFFSET_JR1, INST_CONST, 2B), ALU_SET(FEM, TMP_REG4),
              CMN(NONE, NONE, 0x20, NEVER_NEVER, NXT_JMP));

        
        INSTR(CE1_COPY(IN_FIFO, PPH_EXIST_UPDATE_JR1, VLD_B, VLD_B, FEM), CE2_COPY(IN_FIFO, DEFAULT, INST_CONST, 2B),
              ALU_SET(FEM, TMP_REG2), CMN(READ, NONE, 0x20, ALWAYS_NEVER, NXT_JMP));
        ...
        INSTR(CE1_COPY(IN_FIFO, DEFAULT, NONE, INST_CONST, OR), CE2_COPY(TMP_REG3, DEFAULT, NONE, 2B), ALU_NOP,
              CMN(NONE, NONE, 0x2, ALWAYS_NEVER, NXT_JMP));
        ...
        INSTR(CE1_COPY(PROG_VAR, DEFAULT, INST_CONST, INST_CONST, OR),
              CE2_COPY(NS_8, OUTLIF_VSI_LSB_SHIFT_JR1, INST_CONST, 1B), ALU_NOP, CMN(NONE, NONE, 0x21, ALWAYS_NEVER,
                                                                                      NXT_JMP));
    ...
    int *first_instruction)
{
    ...
    if (*first_instruction == DNX_OAMP_PE_NOT_SET)
    {
        *first_instruction = *next_instruction_index;
        ...
        INSTR(CE1_NOP, CE2_COPY(IN_FIFO, DEFAULT, INST_CONST, 4B), ALU_NOP,
        ...
        if (system_headers_mode == DBAL_ENUM_FVAL_SYSTEM_HEADERS_MODE_JERICHO_MODE)
        {
            ...
            INSTR(CE1_COPY(TC_DP_LOCAL_PORT, ITMH_DP_JR1, INST_CONST, INST_CONST, OR),
                  CE2_COPY(NS_16_VAR_0, DEFAULT, NONE, 2B), ALU_NOP, CMN(NONE, NONE, 0x22, ALWAYS_NEVER, NXT_JMP));
        }
        else
        {
        ...
        INSTR(CE1_COPY(TC_DP_LOCAL_PORT, ITMH_TC, INST_CONST, INST_CONST, OR),
              CE2_COPY(NS_16_VAR_1, DEFAULT, NONE, 2B), ALU_NOP, CMN(NONE, NONE, 0x22, ALWAYS_NEVER, NXT_JMP));
    ...
    int *first_instruction)
{
    ...
    if (*first_instruction == DNX_OAMP_PE_NOT_SET)
    {
        *first_instruction = *next_instruction_index;
        ...
        INSTR(CE1_COPY(IN_FIFO, DEFAULT, NONE, INST_CONST, FEM), CE2_COPY(IN_FIFO, DEFAULT, INST_CONST, 2B),
              ALU_SET(FEM, TMP_REG3), CMN(READ, NONE, 0x21, ALWAYS_NEVER, NXT_JMP));
        
        INSTR(CE1_NOP, CE2_COPY(PROG_VAR, DEFAULT, NONE, 2B), ALU_SET(FEM, TMP_REG4),
        ...
        INSTR(CE1_NOP, CE2_COPY(NS_16_VAR_0, TLV_DATA_OFFSET, INST_CONST, 2B), ALU_SET(FEM, TMP_REG4),
              CMN(NONE, NONE, 0x20, NEVER_NEVER, NXT_JMP));
        ...
        INSTR(CE1_COPY(TMP_REG2, DEFAULT, NONE, VLD_B, CONCATENATE), CE2_COPY(TMP_REG3, DEFAULT, NONE, 2B),
    ...
    int *first_instruction)
{
    ...
    if (*first_instruction == DNX_OAMP_PE_NOT_SET)
    {
        *first_instruction = *next_instruction_index;
        ...
        INSTR(CE1_NOP, CE2_COPY(NS_16_VAR_0, TLV_DATA_OFFSET_RSP, INST_CONST, 2B), ALU_SET(FEM, TMP_REG4),
              CMN(NONE, NONE, 0x20, NEVER_NEVER, NXT_JMP));
    ...
    int *first_instruction)
{
    ...
    if (*first_instruction == DNX_OAMP_PE_NOT_SET)
    {
        *first_instruction = *next_instruction_index;
        ...
        INSTR(CE1_NOP, CE2_COPY(IN_FIFO, DEFAULT, NONE, 1B), ALU_SET(FEM, TMP_REG4),
              CMN(NONE, NONE, 1, NEVER_NEVER, NXT_JMP));
        
        INSTR(CE1_COPY(IN_FIFO, DEFAULT, INST_CONST, INST_CONST, FEM), CE2_NOP, ALU_NOP,
              CMN(NONE, NONE, 1, ALWAYS_NEVER, NXT_JMP));
        
        INSTR(CE1_NOP, CE2_COPY(IN_FIFO, DEFAULT, INST_CONST, 2B), ALU_SET(FEM, TMP_REG1),
              CMN(NONE, NONE, 0x10, NEVER_NEVER, NXT_JMP));
    ...
    int *first_instruction)
{
    ...
    if (*first_instruction == DNX_OAMP_PE_NOT_SET)
    {
        *first_instruction = *next_instruction_index;
        ...
        INSTR(CE1_NOP, CE2_COPY(NS_16_VAR_0, DEFAULT, INST_CONST, 2B), ALU_SET(FEM, TMP_REG4),
        ...
        INSTR_LABEL(CE1_NOP, CE2_COPY(TMP_REG1, DEFAULT, INST_CONST, 2B), ALU_NOP,
    ...
    int *first_instruction)
{
    ...
    if (*first_instruction == DNX_OAMP_PE_NOT_SET)
    {
        *first_instruction = *next_instruction_index;
        ...
        INSTR(CE1_COPY(IN_FIFO, DEFAULT, NONE, INST_CONST, FEM), CE2_COPY(IN_FIFO, DEFAULT, NONE, 2B),
    ...
    int *first_instruction)
{
    ...
    if (*first_instruction == DNX_OAMP_PE_NOT_SET)
    {
        *first_instruction = *next_instruction_index;
        ...
        INSTR_LABEL(CE1_COPY(IN_FIFO, DEFAULT, NONE, INST_CONST, FEM), CE2_COPY(IN_FIFO, DEFAULT, INST_CONST, 2B),
                    ALU_SET(FEM, TMP_REG3), CMN(READ, NONE, 0x21, ALWAYS_NEVER, NXT_JMP),
        ...
        INSTR(CE1_COPY(IN_FIFO, DEFAULT, NONE, VLD_B, FEM), CE2_COPY(IN_FIFO, DEFAULT, NONE, 1B),
        ...
        INSTR(CE1_COPY(IN_FIFO, DEFAULT, NONE, VLD_B, FEM), CE2_COPY(IN_FIFO, DEFAULT, NONE, 2B),
        ...
        INSTR(CE1_COPY(TMP_REG3, DEFAULT, NONE, INST_CONST, CONCATENATE), CE2_COPY(FDBK_FIFO, DEFAULT, INST_CONST, 2B),
        ...
        INSTR_LABEL(CE1_COPY(IN_FIFO, DEFAULT, NONE, VLD_B, FEM), CE2_COPY(IN_FIFO, DEFAULT, NONE, 2B),
