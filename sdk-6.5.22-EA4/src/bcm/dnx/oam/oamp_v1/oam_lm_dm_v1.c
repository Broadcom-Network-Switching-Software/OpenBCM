    ...
    bcm_oam_loss_t * loss_ptr)
{
    ...
    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_ccm_endpoint_get(unit, loss_ptr->id, 0, ccm_mep_db_entry));
    mpls_pwe_mep = DNX_OAM_MEP_TYPE_IS_MPLS_TP_OR_PWE(ccm_mep_db_entry->mep_type);
    offloaded = (ccm_mep_db_entry->flags & DNX_OAMP_OAM_CCM_MEP_LM_DM_OFFLOADED) ? 1 : 0;
...
/* } */
    ...
    if ((loss_ptr->pkt_pri_bitmap != 0xff) && (loss_ptr->pkt_pri_bitmap != 0))
    {
        if (piggy_back_lm)
        {
            SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_ccm_endpoint_get(unit, mep_id, 0, ccm_mep_db_entry_o));
...
/* } */
    ...
    if (ccm_mep_db_entry->mep_type != DBAL_ENUM_FVAL_OAMP_MEP_TYPE_RFC_6374)
    {
        ...
        SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_scan_count_calc(unit, delay_ptr->id, is_jumbo_tlv_dm, (ccm_mep_db_entry->flags & DNX_OAMP_OAM_CCM_MEP_Q_ENTRY), ccm_mep_db_entry->ccm_interval, 0       /* don't
                                                                                                                                                                                                 * * care
                                                                                                                                                                                                 * * for * 
                                                                                                                                                                                                 * * * * * 
                                                                                                                                                                                                 * * * *
    ...
    bcm_oam_delay_t * delay_ptr)
{
    ...
    SHR_IF_ERR_EXIT(dnx_oam_oamp_v1_mep_db_ccm_endpoint_get(unit, delay_ptr->id, 0, ccm_mep_db_entry));
