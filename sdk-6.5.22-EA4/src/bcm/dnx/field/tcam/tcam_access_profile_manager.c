    ...
    int access_profile_id)
{
    ...
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_FIELD_ACCESS_PROFILE_ID, access_profile_id);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_KEY_SIZE, INST_SINGLE, 0);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_IS_DIRECT, INST_SINGLE, 0);
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_PREFIX, INST_SINGLE, 0);
