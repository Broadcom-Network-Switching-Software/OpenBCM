...
#define DNX_CRPS_BACKGROUND_THREAD_ITER_MIN      (1)
    ...
    bcm_stat_eviction_t * eviction)
{
    ...
    is_B_engine = (engine_info->nof_counters == B_TYPE_ENGINE_SIZE(unit));
    ...
    bcm_stat_eviction_t * eviction)
{
    ...
    {
        /** not relevant fieldes for network eviction in used */
    ...
    if (opcode == 0)
    {
        ...
        if (err_ind == FALSE)
        {
            ...
            if (is_zero == FALSE)
            {
                ...
                /** extract the core_id */
                SHR_IF_ERR_EXIT(utilex_bitstream_get_field
                                (curr_entry, rcd_format->core_id_offset, rcd_format->core_id_size,
                                 (uint32 *) (&core_id)));
