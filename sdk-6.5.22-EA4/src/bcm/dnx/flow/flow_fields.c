    ...
    void *field_data)
{
    uint32 ttl_mode;
    uint32 profile;
    uint8 is_last_profile_ref = FALSE;
    dbal_enum_value_field_encap_qos_model_e encap_qos_model;
    bcm_qos_egress_model_t model;
    ...
    rv = dbal_tables_field_info_get_no_err(unit, gport_hw_resources.outlif_dbal_table_id, DBAL_FIELD_ENCAP_QOS_MODEL, 0,
                                           gport_hw_resources.outlif_dbal_result_type, 0, &field_info);
    ...
    if (rv == _SHR_E_NONE)
    {
        ...
        if ((encap_qos_model == DBAL_ENUM_FVAL_ENCAP_QOS_MODEL_PIPE_NEXT_SPACE) ||
            ...
            (encap_qos_model == DBAL_ENUM_FVAL_ENCAP_QOS_MODEL_PIPE_ECN))
        {
            SHR_IF_ERR_EXIT_NO_MSG(dnx_flow_field_value32_get(unit, entry_handle_id, DBAL_FIELD_NWK_QOS_IDX, &profile));
...
static shr_error_e
dnx_flow_field_l2_learn_info_type_set(
    int unit,
    bcm_flow_handle_info_t * flow_handle_info,
    dnx_algo_gpm_gport_hw_resources_t * gport_hw_resources,
    bcm_flow_terminator_info_t * terminator_info,
...
static shr_error_e
dnx_flow_field_l2_learn_info_forward_information_set(
    int unit,
    bcm_flow_handle_info_t * flow_handle_info,
    bcm_flow_terminator_info_t * terminator_info,
    uint32 lif_gport,
    ...
    dnx_algo_gpm_forward_info_t * forward_info)
{
     ...
     */
    SHR_IF_ERR_EXIT(algo_gpm_gport_l2_forward_info_add(unit, is_replace, lif_gport, forward_info));
...
static void
dnx_flow_field_l2_learn_info_context_get(
    int unit,
    bcm_flow_handle_info_t * flow_handle_info,
    bcm_flow_terminator_info_t * terminator_info,
    dnx_algo_gpm_forward_info_t * forward_info,
...
static shr_error_e
dnx_flow_field_l2_learn_info_set_to_hw(
    int unit,
    uint32 entry_handle_id,
    ...
    void *field_data)
{
    ...
    SHR_IF_ERR_EXIT(dnx_flow_field_l2_learn_info_type_set
     ...
     */
    SHR_IF_ERR_EXIT(dnx_flow_field_l2_learn_info_forward_information_set
                    (unit, flow_handle_info, terminator_info, gport_hw_resources.global_out_lif, FALSE, &forward_info));
     ...
     */
    dnx_flow_field_l2_learn_info_context_get(unit, flow_handle_info, terminator_info, &forward_info,
     ...
     * Select the learn info struct and fill it according to the learn info type
     */
    SHR_IF_ERR_EXIT(dnx_flow_field_l2_learn_info_set_to_hw(unit, entry_handle_id, l2_learn_info, learn_info_type));
