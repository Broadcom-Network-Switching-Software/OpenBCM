...
flexe_std_client_add(
    ...
    int nof_flexe_core_ports)
{
    SHR_BITDCL global_ts_bitmap[_SHR_BITDCLSIZE(FLEXE_CORE_NOF_TIMESLOTS)];
    int is_bypass = 0;
    int phy_speed = 0;
    int group = 0;
    ...
    SHR_IF_ERR_EXIT(flexe_std_port_ts_mask_to_global
                    (unit, flexe_core_port_array, ts_mask, nof_flexe_core_ports, global_ts_bitmap));
    ...
    if (is_bypass)
    {
        ...
        SHR_IF_ERR_EXIT(soc_flexe_std_channel_bypass_set(unit, client_channel, global_ts_bitmap, 1));
    ...
    if (flags & BCM_PORT_FLEXE_RX)
    {
        SHR_IF_ERR_EXIT(soc_flexe_std_channel_rx_add(unit, client_channel, global_ts_bitmap, cal_id));
    }

    if (flags & BCM_PORT_FLEXE_TX)
    {
        SHR_IF_ERR_EXIT(soc_flexe_std_channel_tx_add(unit, client_channel, global_ts_bitmap, ts_mask, cal_id));
    }
    ...
    int nof_flexe_core_ports)
{
    ...
    if (is_bypass)
    {
        ...
        SHR_IF_ERR_EXIT(soc_flexe_std_channel_bypass_set(unit, client_channel, global_ts_bitmap, 0));
    ...
    if (flags & BCM_PORT_FLEXE_RX)
    {
        SHR_IF_ERR_EXIT(soc_flexe_std_channel_rx_del(unit, client_channel, global_ts_bitmap, cal_id));
    }

    if (flags & BCM_PORT_FLEXE_TX)
    {
        SHR_IF_ERR_EXIT(soc_flexe_std_channel_tx_del(unit, client_channel, global_ts_bitmap, ts_mask, cal_id));
