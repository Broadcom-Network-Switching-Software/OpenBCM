    ...
    int instance)
{
    ...
    {
        SHR_IF_ERR_EXIT(dnx_algo_flexe_core_db.resource_alloc.instance.free_single(unit, ii, NULL));
    }
    ...
    SHR_BITDCL * lphy_bitmap)
{
    ...
    {
        SHR_IF_ERR_EXIT(dnx_algo_flexe_core_db.resource_alloc.lphy.free_single(unit, lphy, NULL));
    }
