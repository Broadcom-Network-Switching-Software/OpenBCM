    ...
    int oamp_entry_index)
{
    ...
    if (oamp_entry_index >= full_entry_threshold)
    {
        ...
        if ((oamp_entry_index % short_entries_in_full) == 0)
        {
            for (short_index = 0; short_index < short_entries_in_full; short_index++)
            {
                ...
                SHR_IF_ERR_EXIT(algo_oamp_db.oamp_mep_db_entry.free_single(unit, oamp_entry_index + short_index, NULL));
            }
        }
        else
        {
    ...
    {
        /** Free 1 (short) entry */
        SHR_IF_ERR_EXIT(algo_oamp_db.oamp_mep_db_entry.free_single(unit, oamp_entry_index, NULL));
    }
