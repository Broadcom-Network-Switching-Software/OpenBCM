...
/**
 * \brief
 * Returns template manager information;
 * the tag and the nof allocated elements in the grain of the ECMP profile requested.
 * Full header description in \ref dnx_algo_res_advanced_algorithm_info_get_cb
 *
 * \see
 *  dnx_algo_res_create_cb
 *  resource_tag_bitmap_create
 */
shr_error_e dnx_algo_l3_ecmp_info_get(
    int unit,
    uint32 module_id,
    resource_tag_bitmap_t res_tag_bitmap,
    void *tag_info);
