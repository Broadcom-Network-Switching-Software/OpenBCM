    ...
    int unit)
{
    ...
    int nof_ingress_profile_bits = 0, system_headers_mode = 0;
    SHR_FUNC_INIT_VARS(unit);
    ...
    default_template_data.cs_in_lif_profile_flags = 0;
    ...
    {
        /** Relevant for devices with not fixed size of egress bits */
