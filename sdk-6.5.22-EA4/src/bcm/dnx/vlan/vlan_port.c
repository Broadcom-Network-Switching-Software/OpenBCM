    ...
    int is_virtual_ac)
{
    ...
    supported_flags =
        ...
        BCM_VLAN_PORT_RECYCLE | BCM_VLAN_PORT_EGRESS_SVTAG_ENABLE | BCM_VLAN_PORT_EXTENDED | BCM_VLAN_PORT_IVL;
    ...
    bcm_vlan_port_t * old_vlan_port)
{
    ...
    supported_flags =
        ...
        BCM_VLAN_PORT_EGRESS_SVTAG_ENABLE | BCM_VLAN_PORT_EXTENDED;
