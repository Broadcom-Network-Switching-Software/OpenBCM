    ...
    uint32 exact_value)
{
    ...
    /** verify */
    SHR_INVOKE_VERIFY_DNX(dnx_fabric_cgm_control_adaptive_enable_hw_set_verify(unit, exact_value));
    ...
    uint32 exact_value)
{
    ...
    /** verify */
    SHR_INVOKE_VERIFY_DNX(dnx_fabric_cgm_control_static_enable_hw_set_verify(unit, exact_value));
