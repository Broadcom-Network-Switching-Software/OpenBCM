    ...
    int unit)
{
    ...
    if (dnx_l2_cpu_learn_thread_info[unit])
    {
    ...
    int lpkgv_one_outlif)
{
    ...
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_LEARN_PAYLOAD_CONTEXT,
                               DBAL_ENUM_FVAL_LEARN_PAYLOAD_CONTEXT_ASYMMETRIC_LIF_BASIC_SVL);
    ...
    int lpkgv_one_outlif)
{
    ...
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_LEARN_PAYLOAD_CONTEXT,
                               DBAL_ENUM_FVAL_LEARN_PAYLOAD_CONTEXT_ASYMMETRIC_LIF_EXTENDED_SVL);
