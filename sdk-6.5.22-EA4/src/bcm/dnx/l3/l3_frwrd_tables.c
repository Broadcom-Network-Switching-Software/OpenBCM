...
/*
 * Define the list of supported flags for L3 Route APIs
 */
#define L3_SUPPORTED_BCM_L3_FLAGS_ROUTE (BCM_L3_IP6 | BCM_L3_REPLACE | BCM_L3_ENCAP_SPACE_OPTIMIZED | BCM_L3_HIT_CLEAR | BCM_L3_HIT | BCM_L3_SRC_DISCARD | BCM_L3_INTERNAL_ROUTE)
/*
...
/*
 * Define the list of supported BCM_L3_FLAGS2_* flags for L3 Route APIs.
 */
#define L3_FORWARD_SUPPORTED_BCM_L3_FLAGS2_ROUTE (BCM_L3_FLAGS2_RAW_ENTRY | BCM_L3_FLAGS2_FWD_ONLY | BCM_L3_FLAGS2_RPF_ONLY | BCM_L3_FLAGS2_SCALE_ROUTE | BCM_L3_FLAGS2_NO_PAYLOAD)
/*
    ...
    uint8 is_kbp_split_rpf_in_use)
{
    ...
    if (_SHR_IS_FLAG_SET(info->l3a_flags, ~L3_SUPPORTED_BCM_L3_FLAGS_ROUTE))
    {
    ...
    if (_SHR_IS_FLAG_SET(info->l3a_flags2, ~L3_FORWARD_SUPPORTED_BCM_L3_FLAGS2_ROUTE))
    {
...
{
    SHR_FUNC_INIT_VARS(unit);
    if (flags != 0 && _SHR_IS_FLAG_SET(flags, ~L3_SUPPORTED_BCM_L3_FLAGS_ROUTE))
    {
