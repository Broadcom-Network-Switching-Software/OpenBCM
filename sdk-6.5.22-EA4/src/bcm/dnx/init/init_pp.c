...
static const layer_type_to_mpls_upper_layer_protocol_t layer_type_to_mpls_upper_layer_protocol[] = {
    ...
    {DBAL_ENUM_FVAL_LAYER_TYPES_BIER_NON_MPLS, DBAL_ENUM_FVAL_ERPP_1ST_PARSER_PARSER_CONTEXT_BIER_NON_MPLS_A1},
    {DBAL_ENUM_FVAL_LAYER_TYPES_IN_BIER_BASE_EG_BIER_MPLS, DBAL_ENUM_FVAL_ERPP_1ST_PARSER_PARSER_CONTEXT_BIER_MPLS_A1},
