...
static field_itmh_pph_qual_info_t field_itmh_pph_cmp0_first_key_qual_info_array[ITMH_PPH_NOF_CMP0_FIRST_KEY_QUALIFIERS] = {
  
    {"fhei_trap_type_q_pph", 0, FHEI_TRAP_TYPE_QUAL_LENGTH, {bcmFieldInputTypeLayerAbsolute, 3, FHEI_TRAP_TYPE_QUAL_OFFSET}},
    {"fhei_trap_size_q_pph", 0, FHEI_SIZE_QUAL_LENGTH, {bcmFieldInputTypeLayerAbsolute, 3, FHEI_SIZE_QUAL_OFFSET}},
};
static field_itmh_pph_qual_info_t field_itmh_pph_cmp0_second_key_qual_info_array[ITMH_PPH_NOF_CMP0_SECOND_KEY_QUALIFIERS] = {
    {"key_gen_var_trap_q_pph", 0, 6, {bcmFieldInputTypeMetaData, 0, CMP0_SECOND_KEY_GEN_OFFSET}}
};


static field_itmh_pph_qual_info_t field_itmh_pph_cmp1_first_key_qual_info_array[ITMH_PPH_NOF_CMP1_FIRST_KEY_QUALIFIERS] = {
  
    {"fhei_vlan_type_q_pph", 0, FHEI_VLAN_TYPE_QUAL_LENGTH, {bcmFieldInputTypeLayerAbsolute, 3, FHEI_VLAN_TYPE_QUAL_OFFSET}},
    {"fhei_vlan_size_q_pph", 0, FHEI_SIZE_QUAL_LENGTH, {bcmFieldInputTypeLayerAbsolute, 3, FHEI_SIZE_QUAL_OFFSET}},
};
static field_itmh_pph_qual_info_t field_itmh_pph_cmp1_second_key_qual_info_array[ITMH_PPH_NOF_CMP1_SECOND_KEY_QUALIFIERS] = {
    {"key_gen_var_vlan_q_pph", 0, 3, {bcmFieldInputTypeMetaData, 0, CMP1_SECOND_KEY_GEN_OFFSET}}
};
...
static field_itmh_pph_qual_info_t field_itmh_pph_ipmf2_fg3_qual_info_array[ITMH_PPH_NOF_IPMF2_FG3_QUALIFIERS] = {
    ...
    {"tsh_inj_q_pph", 0, TSH_INJ_QUAL_LENGTH,
        {bcmFieldInputTypeLayerAbsolute, 0, TSH_INJ_QUAL_OFFSET}}
};


static field_itmh_pph_qual_info_t field_itmh_pph_ipmf2_fg4_qual_info_array[ITMH_PPH_NOF_IPMF2_FG4_QUALIFIERS] = {
...
static field_itmh_pph_qual_info_t field_itmh_pph_ipmf2_fg5_qual_info_array[ITMH_PPH_NOF_IPMF2_FG5_QUALIFIERS] = {
...
static field_itmh_pph_action_info_t field_itmh_pph_ipmf2_fg3_action_info_array[ITMH_PPH_NOF_IPMF2_FG3_ACTIONS] = {
    ...
    {"tsh_with_flow_id_valid_bit_a_pph", 0, {0, bcmFieldActionLatencyFlowId, TSH_INJ_ACTION_LENGTH,
        23, 0, {0}}, FALSE, BCM_FIELD_ACTION_DONT_CARE},
};


static field_itmh_pph_action_info_t field_itmh_pph_ipmf2_fg4_action_info_array[ITMH_PPH_NOF_IPMF2_FG4_ACTIONS] = {

    {NULL, bcmFieldActionTrapRaw, {0}, TRUE, BCM_FIELD_ACTION_PRIORITY(0,20)},
};


static field_itmh_pph_action_info_t field_itmh_pph_ipmf2_fg5_action_info_array[ITMH_PPH_NOF_IPMF2_FG5_ACTIONS] = {
...
static field_itmh_pph_fg_info_t itmh_pph_fg_info_array[ITMH_PPH_NOF_FG] = {
    ...
    
    {
        ...
        bcmFieldStageIngressPMF2,   
        bcmFieldGroupTypeDirectExtraction,  
        ITMH_PPH_NOF_IPMF2_FG4_QUALIFIERS,  
        ITMH_PPH_NOF_IPMF2_FG4_ACTIONS, 
        field_itmh_pph_ipmf2_fg4_qual_info_array,   
        field_itmh_pph_ipmf2_fg4_action_info_array, 
        NULL,  
        TRUE, FALSE
    },
    
    {
        ...
        bcmFieldStageIngressPMF2,   
        bcmFieldGroupTypeDirectExtraction,  
        ITMH_PPH_NOF_IPMF2_FG5_QUALIFIERS,  
        ITMH_PPH_NOF_IPMF2_FG5_ACTIONS, 
        field_itmh_pph_ipmf2_fg5_qual_info_array,   
        field_itmh_pph_ipmf2_fg5_action_info_array, 
        NULL,  
        FALSE, TRUE
    },
...
static field_itmh_pph_cmp_key_info_t itmh_pph_cmp_key_info_array[ITMH_PPH_NOF_CMP_KEY] = {
        
        {
            0,   
            2,   
            1,   
            field_itmh_pph_cmp0_first_key_qual_info_array,  
            field_itmh_pph_cmp0_second_key_qual_info_array  
        },
        
        {
            ...
            2,   
            1,   
            field_itmh_pph_cmp1_first_key_qual_info_array,  
            field_itmh_pph_cmp1_second_key_qual_info_array  
        },
};
...
appl_dnx_field_itmh_pph_cmp_key_config(
    ...
    field_itmh_pph_cmp_key_info_t * itmh_pph_cmp_key_info)
{
    int qual_index;
    ...
    for (qual_index = 0; qual_index < itmh_pph_cmp_key_info->nof_first_key_quals; qual_index++)
    {
        if (itmh_pph_cmp_key_info->itmh_pph_first_key_qual_info[qual_index].name != NULL)
        {
            SHR_IF_ERR_EXIT(appl_dnx_field_itmh_pph_user_qual_config
                            (unit, &(itmh_pph_cmp_key_info->itmh_pph_first_key_qual_info[qual_index])));
        }
    }
    for (qual_index = 0; qual_index < itmh_pph_cmp_key_info->nof_second_key_quals; qual_index++)
    {
        if (itmh_pph_cmp_key_info->itmh_pph_first_key_qual_info[qual_index].name != NULL)
        {
            SHR_IF_ERR_EXIT(appl_dnx_field_itmh_pph_user_qual_config
                            (unit, &(itmh_pph_cmp_key_info->itmh_pph_second_key_qual_info[qual_index])));
        }
    }
    ...
    compare_info.first_key_info.nof_quals = itmh_pph_cmp_key_info->nof_first_key_quals;
    for (qual_index = 0; qual_index < itmh_pph_cmp_key_info->nof_first_key_quals; qual_index++)
    {
        compare_info.first_key_info.qual_types[qual_index] =
            itmh_pph_cmp_key_info->itmh_pph_first_key_qual_info[qual_index].qual_id;
        compare_info.first_key_info.qual_info[qual_index].input_type =
            itmh_pph_cmp_key_info->itmh_pph_first_key_qual_info[qual_index].qual_attach_info.input_type;
        compare_info.first_key_info.qual_info[qual_index].input_arg =
            itmh_pph_cmp_key_info->itmh_pph_first_key_qual_info[qual_index].qual_attach_info.input_arg;
        compare_info.first_key_info.qual_info[qual_index].offset =
            itmh_pph_cmp_key_info->itmh_pph_first_key_qual_info[qual_index].qual_attach_info.offset;
    }
    ...
    compare_info.second_key_info.nof_quals = itmh_pph_cmp_key_info->nof_second_key_quals;
    for (qual_index = 0; qual_index < itmh_pph_cmp_key_info->nof_second_key_quals; qual_index++)
    {
        compare_info.second_key_info.qual_types[qual_index] =
            itmh_pph_cmp_key_info->itmh_pph_second_key_qual_info[qual_index].qual_id;
        compare_info.second_key_info.qual_info[qual_index].input_type =
            itmh_pph_cmp_key_info->itmh_pph_second_key_qual_info[qual_index].qual_attach_info.input_type;
        compare_info.second_key_info.qual_info[qual_index].input_arg =
            itmh_pph_cmp_key_info->itmh_pph_second_key_qual_info[qual_index].qual_attach_info.input_arg;
        compare_info.second_key_info.qual_info[qual_index].offset =
            qual_info_get.offset +
            itmh_pph_cmp_key_info->itmh_pph_second_key_qual_info[qual_index].qual_attach_info.offset;
    }

   
    SHR_IF_ERR_EXIT(bcm_field_context_compare_create
                    (unit, 0, bcmFieldStageIngressPMF1, context_id, itmh_pph_cmp_key_info->pair_id, &compare_info));
    ...
    bcm_field_context_t ipmf2_context_id)
{
    ...
    param_info.param_val = 0x92C9;
    param_info.param_arg = 0;
    SHR_IF_ERR_EXIT(bcm_field_context_param_set(unit, 0, bcmFieldStageIngressPMF1, context_id, &param_info));

    for (cmp_key_index = 0; cmp_key_index < ITMH_PPH_NOF_CMP_KEY; cmp_key_index++)
    {
        SHR_IF_ERR_EXIT(appl_dnx_field_itmh_pph_cmp_key_config
                        (unit, context_id, &itmh_pph_cmp_key_info_array[cmp_key_index]));
    }
    ...
    bcm_field_context_info_t_init(&context_info);
    sal_strncpy_s((char *) (context_info.name), "ITMH_PPH_IPMF2", sizeof(context_info.name));
    context_info.cascaded_from = context_id;
    SHR_IF_ERR_EXIT(bcm_field_context_create
                    (unit, BCM_FIELD_FLAG_WITH_ID, bcmFieldStageIngressPMF2, &context_info, &ipmf2_context_id));
    ...
    SHR_IF_ERR_EXIT(bcm_field_context_param_set(unit, 0, bcmFieldStageIngressPMF2, ipmf2_context_id, &param_info));

    bcm_field_presel_entry_id_info_init(&presel_entry_id);
    presel_entry_id.presel_id = dnx_data_field.preselector.default_itmh_pph_presel_id_ipmf2_get(unit);
    presel_entry_id.stage = bcmFieldStageIngressPMF2;

    bcm_field_presel_entry_data_info_init(&presel_entry_data);
    presel_entry_data.nof_qualifiers = 1;
    presel_entry_data.context_id = ipmf2_context_id;
    presel_entry_data.entry_valid = TRUE;
    ...
    presel_entry_data.qual_data[0].qual_type = bcmFieldQualifyContextId;
    presel_entry_data.qual_data[0].qual_arg = 0;
    presel_entry_data.qual_data[0].qual_value = ipmf2_context_id;
    presel_entry_data.qual_data[0].qual_mask = 0x3F;
    SHR_IF_ERR_EXIT(bcm_field_presel_set(unit, 0, &presel_entry_id, &presel_entry_data));
    ...
    field_itmh_pph_fg_info_t * itmh_pph_fg_info)
{
    ...
    bcm_field_context_t context_id, ipmf2_context_id;
    bcm_field_qualifier_info_get_t qual_info_get;
    int op_offset;
    ...
    ipmf2_context_id = dnx_data_field.context.default_itmh_pph_ipmf2_context_get(unit);
    ...
    int unit)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    flow_id = dnx_data_headers.feature.feature_get(unit, dnx_data_headers_feature_flow_id_ext_enable);
    context_id = dnx_data_field.context.default_itmh_pph_context_get(unit);
    ipmf2_context_id = dnx_data_field.context.default_itmh_pph_ipmf2_context_get(unit);

    SHR_IF_ERR_EXIT(appl_dnx_field_itmh_pph_context(unit, context_id, ipmf2_context_id));
    
    for (fg_index = 0; fg_index < ITMH_PPH_NOF_FG; fg_index++)
    {
        
        if (!flow_id && fg_index == 2)
        {
            continue;
        }
