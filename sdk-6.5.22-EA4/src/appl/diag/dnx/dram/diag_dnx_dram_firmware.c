...
static sh_sand_enum_t sand_diag_dram_firmware_operation_enum[] = {
    ...
    {"run_extest",                       DNX_HBMC_FIRMWARE_OPERATION_RUN_EXTEST,                      "#"},
...
static sh_sand_man_t sh_dnx_firmware_aapl_man = {
    ...
    .full = "HBM PHY firmware AAPL\n"
            ...
            "By default the command runs on both HBMs.\n"
            "Add \"-addr :<hbm_index>:fd\" to run on a specific HBM.",
    .examples = "command=\"hbm -hbm-diag\"\n"
                "command=\"hbm -hbm-diag -addr :0:fd\""
};
