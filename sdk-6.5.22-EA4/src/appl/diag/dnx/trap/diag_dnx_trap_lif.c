...
const sh_dnx_trap_lif_table_info_t In_lif_tables[] = {
    ...
    {DBAL_TABLE_IN_LIF_FORMAT_LSP, DBAL_FIELD_IN_LIF, DNX_ALGO_GPM_GPORT_HW_RESOURCES_DPC_LOCAL_LIF_INGRESS},
    {DBAL_TABLE_IN_LIF_FORMAT_PWE, DBAL_FIELD_IN_LIF, DNX_ALGO_GPM_GPORT_HW_RESOURCES_DPC_LOCAL_LIF_INGRESS},
    {DBAL_TABLE_IN_LIF_FORMAT_EVPN, DBAL_FIELD_IN_LIF, DNX_ALGO_GPM_GPORT_HW_RESOURCES_DPC_LOCAL_LIF_INGRESS},
    {DBAL_TABLE_IN_LIF_IPvX_TUNNELS, DBAL_FIELD_IN_LIF, DNX_ALGO_GPM_GPORT_HW_RESOURCES_DPC_LOCAL_LIF_INGRESS},
    {DBAL_TABLE_IN_AC_INFO_DB, DBAL_FIELD_IN_LIF, DNX_ALGO_GPM_GPORT_HW_RESOURCES_SBC_LOCAL_LIF_INGRESS},
};

const sh_dnx_trap_lif_table_info_t Out_lif_tables[] = {
    {DBAL_TABLE_EEDB_ARP, DBAL_FIELD_OUT_LIF, DNX_ALGO_GPM_GPORT_HW_RESOURCES_LOCAL_LIF_EGRESS},
    {DBAL_TABLE_EEDB_IPV4_TUNNEL, DBAL_FIELD_OUT_LIF, DNX_ALGO_GPM_GPORT_HW_RESOURCES_LOCAL_LIF_EGRESS},
    {DBAL_TABLE_EEDB_IPV6_TUNNEL, DBAL_FIELD_OUT_LIF, DNX_ALGO_GPM_GPORT_HW_RESOURCES_LOCAL_LIF_EGRESS},
    {DBAL_TABLE_EEDB_MPLS_TUNNEL, DBAL_FIELD_OUT_LIF, DNX_ALGO_GPM_GPORT_HW_RESOURCES_LOCAL_LIF_EGRESS},
    {DBAL_TABLE_EEDB_PWE, DBAL_FIELD_OUT_LIF, DNX_ALGO_GPM_GPORT_HW_RESOURCES_LOCAL_LIF_EGRESS},
    {DBAL_TABLE_EEDB_EVPN, DBAL_FIELD_OUT_LIF, DNX_ALGO_GPM_GPORT_HW_RESOURCES_LOCAL_LIF_EGRESS},
    {DBAL_TABLE_EEDB_OUT_AC, DBAL_FIELD_OUT_LIF, DNX_ALGO_GPM_GPORT_HW_RESOURCES_LOCAL_LIF_EGRESS},
...
const sh_dnx_trap_lif_table_info_t Out_rif_tables[] = {
    ...
    {DBAL_TABLE_EEDB_EVPN, DBAL_FIELD_OUT_LIF, DNX_ALGO_GPM_GPORT_HW_RESOURCES_LOCAL_LIF_EGRESS},
    {DBAL_TABLE_EEDB_OUT_AC, DBAL_FIELD_OUT_LIF, DNX_ALGO_GPM_GPORT_HW_RESOURCES_LOCAL_LIF_EGRESS},
    {DBAL_TABLE_EEDB_RIF_BASIC, DBAL_FIELD_OUT_RIF, DNX_ALGO_GPM_GPORT_HW_RESOURCES_LOCAL_LIF_EGRESS},
};
    ...
    sh_sand_control_t * sand_control)
{
    ...
    int table_index = 0, is_end = 0, trap_id = -1;
    char *lif_name = NULL;
        ...
        for (table_index = 0; table_index < nof_tables; table_index++)
        {
            ...
            while (!is_end)
            {
                ...
                else
                {
                    ...
                    {
                        SHR_IF_ERR_EXIT(dnx_algo_gpm_gport_from_lif
                                        (unit, dbal_tables_arr[table_index].algo_gpm_flag, _SHR_CORE_ALL, local_lif,
                                         &gport));
                    }
