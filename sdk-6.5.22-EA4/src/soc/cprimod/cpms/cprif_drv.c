                                 ...
                                 cprif_rsvd4_encap_decap_data_entry_t *entry)
{
    ...
    if (dir == CPRIMOD_DIR_RX) {
        ...
        soc_mem_field_get(unit, local_mem, rd_data_ptr, BRCM_RESERVED_CPM_331_0f, &field_buf);
        ...
        soc_mem_field_get(unit, local_mem, rd_data_ptr, BRCM_RESERVED_CPM_331_1f, &field_buf);
        entry->gsm_extra_pad_size = field_buf;

        soc_mem_field_get(unit, local_mem, rd_data_ptr, BRCM_RESERVED_CPM_331_2f, &field_buf);
        entry->gsm_pad_enable = field_buf;

        soc_mem_field_get(unit, local_mem, rd_data_ptr, BRCM_RESERVED_CPM_331_3f, &field_buf);
...
int cprif_drv_tx_framer_tgen_enable_set (int unit, int port,
                                         uint32 enable)
{
    uint64 reg_val;
    uint64 write_val;
...
int cprif_drv_tx_framer_tgen_enable_get (int unit, int port,
                                         uint32 *enable)
{
    uint64 reg_val;

    SOC_IF_ERROR_RETURN
        (READ_CPRI_TXFRM_TGEN_CFG2r(unit, port, &reg_val));
    *enable = soc_reg64_field32_get(unit, CPRI_TXFRM_TGEN_CFG2r, reg_val,
                                     TX_TGEN_ENABLEf);
    return SOC_E_NONE;
}
                                        ...
                                        int value)
{
    ...
    switch (field) {
    case CPRIMOD_RX_CONFIG_8B10B_ALLOW_SEED_CHANGE:
        soc_reg64_field_set(unit, CPRI_RXPCS_CTRLr, &data,
                            RXPCS_8B10B_ALLOW_SEED_CHANGEf, write_val);
        break;
    case CPRIMOD_RX_CONFIG_8B10B_DESCRAMBLER_HW_CONTROL:
        soc_reg64_field_set(unit, CPRI_RXPCS_CTRLr, &data,
                            RXPCS_8B10B_DESCR_HWf, write_val);
        break;
    case CPRIMOD_RX_CONFIG_8B10B_DESCRAMBLER_EN:
        soc_reg64_field_set(unit, CPRI_RXPCS_CTRLr, &data,
                            RXPCS_8B10B_DESCR_ENf, write_val);
        break;
    case CPRIMOD_RX_CONFIG_LINK_ACQ_SW_MODE:
        soc_reg64_field_set(unit, CPRI_RXPCS_CTRLr, &data,
                            RXPCS_LINK_ACQ_SW_MODEf, write_val);
        break;
    case CPRIMOD_RX_CONFIG_64B66B_LOS_OPTION:
        soc_reg64_field_set(unit, CPRI_RXPCS_CTRLr, &data,
                            RXPCS_64B66B_LOS_OPTIONf, write_val);
        break;
    case CPRIMOD_RX_CONFIG_8B10B_FORCE_COMMA_ALIGN_EN:
        soc_reg64_field_set(unit, CPRI_RXPCS_CTRLr, &data,
                            RXPCS_8B10B_FORCE_COMMA_ALIGN_ENf, write_val);
        break;
    case CPRIMOD_RX_CONFIG_64B66B_BER_WINDOW_LIMIT:
        soc_reg64_field_set(unit, CPRI_RXPCS_CTRLr, &data,
                            RXPCS_64B66B_BER_WINDOW_LIMITf, write_val);
        break;
    case CPRIMOD_RX_CONFIG_64B66B_BER_LIMIT:
        soc_reg64_field_set(unit, CPRI_RXPCS_CTRLr, &data,
                            RXPCS_64B66B_BER_LIMITf, write_val);
        break;
    case CPRIMOD_RX_CONFIG_TEST_MODE:
        soc_reg64_field_set(unit, CPRI_RXPCS_CTRLr, &data,
                            RXPCS_TEST_MODEf, write_val);
        break;
    case CPRIMOD_RX_CONFIG_64B66B_INVALID_SYNC_HEADER_CNT:
        soc_reg64_field_set(unit, CPRI_RXPCS_CTRLr, &data,
                            RXPCS_64B66B_INVALID_SH_CNTf, write_val);
        break;
    case CPRIMOD_RX_CONFIG_64B66B_VALID_SYNC_HEADER_CNT:
        soc_reg64_field_set(unit, CPRI_RXPCS_CTRLr, &data,
                                           ...
                                           uint32 value)
{
    ...
    switch (field) {
    case CPRIMOD_TX_CONFIG_AGNOSTIC_MODE:
        SOC_IF_ERROR_RETURN(READ_CPRI_TXPCS_CTRLr(unit, port, &data));
        soc_reg64_field_set(unit, CPRI_TXPCS_CTRLr, &data,
                            BRCM_RESERVED_CPM_11_8f, write_val);
        SOC_IF_ERROR_RETURN(WRITE_CPRI_TXPCS_CTRLr(unit, port, data));
        break;
    case CPRIMOD_TX_CONFIG_TX_PMD_DISBALE_OVERRIDE_VAL:
        SOC_IF_ERROR_RETURN(READ_CPRI_TXPCS_CTRLr(unit, port, &data));
        soc_reg64_field_set(unit, CPRI_TXPCS_CTRLr, &data,
                            TX_PCS_TXPMD_DISABLE_OVERRIDE_VALf, write_val);
        SOC_IF_ERROR_RETURN(WRITE_CPRI_TXPCS_CTRLr(unit, port, data));
        break;
    case CPRIMOD_TX_CONFIG_TX_PMD_DISBALE_OVERRIDE_EN:
        SOC_IF_ERROR_RETURN(READ_CPRI_TXPCS_CTRLr(unit, port, &data));
        soc_reg64_field_set(unit, CPRI_TXPCS_CTRLr, &data,
                            TX_PCS_TXPMD_DISABLE_OVERRIDE_ENf, write_val);
        SOC_IF_ERROR_RETURN(WRITE_CPRI_TXPCS_CTRLr(unit, port, data));
        break;
    case CPRIMOD_TX_CONFIG_SCRAMBLER_BYPASS:
        SOC_IF_ERROR_RETURN(READ_CPRI_TXPCS_CTRLr(unit, port, &data));
        soc_reg64_field_set(unit, CPRI_TXPCS_CTRLr, &data,
                            TX_PCS_SCRAMBLE_BYPASSf, write_val);
        SOC_IF_ERROR_RETURN(WRITE_CPRI_TXPCS_CTRLr(unit, port, data));
        break;
    case CPRIMOD_TX_CONFIG_SCRAMBLER_SEED_8B10B:
        SOC_IF_ERROR_RETURN(READ_CPRI_TXPCS_CTRLr(unit, port, &data));
        soc_reg64_field_set(unit, CPRI_TXPCS_CTRLr, &data,
                            TX_PCS_SEED_8B10Bf, write_val);
        SOC_IF_ERROR_RETURN(WRITE_CPRI_TXPCS_CTRLr(unit, port, data));
        break;
    case CPRIMOD_TX_CONFIG_CWA_SCRABMLER_EN_8B10B:
...
int cprif_drv_rx_tag_config_get ( int unit, int port,
                                  uint32 *default_tag,
                                  uint32 *no_match_tag)
{
    uint32 reg_val;
    ...
    *default_tag    = soc_reg_field_get(unit, BRCM_RESERVED_CPM_318r, reg_val,
                                        BRCM_RESERVED_CPM_318_1f);

    *no_match_tag   = soc_reg_field_get(unit, BRCM_RESERVED_CPM_318r, reg_val,
                                        BRCM_RESERVED_CPM_318_2f);
...
int cprif_drv_tx_control_single_tunnel_msg_config_get(int unit, int port,
                                            uint32 *crc_option)
{
  uint64 reg_val;
    ...
    *crc_option = soc_reg64_field32_get(unit, BRCM_RESERVED_CPM_5r,
                                        reg_val, BRCM_RESERVED_CPM_5_6f);
                                                   ...
                                                   uint32* node)
{
    ...
    *header_subnode = field_buf & 0x1F;
    ...
    soc_mem_field_get(unit, local_mem, rd_data_ptr, BRCM_RESERVED_CPM_48_0f, &field_buf);
    *node = field_buf;
exit:
    sal_free(rd_data_ptr);
    SOC_FUNC_RETURN;
