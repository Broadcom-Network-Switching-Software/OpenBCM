    ...
    int unit)
{
...

    {
        ...
        soc_mem_field32_set(unit, IPPD_FEC_ARR_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_FEC_ENTRY_FORMAT___prefix_6_get(unit));
...

    {
        ...
        soc_mem_field32_set(unit, IPPA_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_2_get(unit));
...

    {
        ...
        soc_mem_field32_set(unit, IPPF_VTT_PREFIX_INDEX_TABLEm, data, PREFIXf, dnx_data_dnx2_arr.prefix.IRPP_IN_LIF_FORMATS___prefix_2_get(unit));
