 ...
 */
static shr_error_e
q2a_a0_dnx_data_system_red_info_resource_set(
    int unit)
{
    int type_index;
    ...
    if (DNX_SYSTEM_RED_RESOURCE_SRAM_PDBS < table->keys[0].size)
    {
        ...
        data->hw_resolution_nof_bits = 10;
    }
    ...
    int unit)
{
    ...
    table->set = q2a_a0_dnx_data_system_red_info_resource_set;
