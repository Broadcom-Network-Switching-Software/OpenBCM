 ...
 */
static shr_error_e
q2a_a0_dnx_data_mdb_em_mdb_emp_dbal_phy_tables_info_set(
    int unit)
{
    int mdb_table_index;
 ...
 */
static shr_error_e
q2a_a0_dnx_data_mdb_direct_mdb_fec_mdb_phy_tables_info_set(
    int unit)
{
    int mdb_table_index;
    ...
    int unit)
{
    ...
    table = &submodule->tables[data_index];
    table->set = q2a_a0_dnx_data_mdb_em_mdb_emp_dbal_phy_tables_info_set;
    /*
    ...
    table = &submodule->tables[data_index];
    table->set = q2a_a0_dnx_data_mdb_direct_mdb_fec_mdb_phy_tables_info_set;
    /*
