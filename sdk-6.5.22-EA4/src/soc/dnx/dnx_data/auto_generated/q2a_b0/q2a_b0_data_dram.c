 ...
 */
/**
 * \brief device level function which set define readout_to_readout_prd
 * define info:
...
/**
 * \brief device level function which set define refresh_to_readout_prd
 * define info:
...
/**
 * \brief device level function which set define readout_done_to_done_prd
 * define info:
