 ...
 */
static shr_error_e
j2p_a0_dnx_data_mpls_general_per_lif_speculative_parsing_supported_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_mpls;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_mpls_general_per_lif_speculative_parsing_supported_set;
