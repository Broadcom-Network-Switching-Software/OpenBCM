...
/**
 * \brief device level function which set define dir_ext_single_key_size
 * define info:
...
/**
 * \brief device level function which set numeric fes_key_select_for_zero_bit
 * numeric info:
...
/**
 * \brief device level function which set numeric fes_shift_for_zero_bit
 * numeric info:
...
/**
 * \brief device level function which set define kbp_extra_offset_after_layer_record_offset
 * define info:
 ...
 */
/**
 * \brief device level function which set define address_size_entry_max
 * define info:
...
/**
 * \brief device level function which set define address_max_entry_max
 * define info:
...
/**
 * \brief device level function which set define opcode_size_rmw
 * define info:
...
/**
 * \brief device level function which set numeric data_size
 * numeric info:
...
/**
 * \brief device level function which set numeric state_table_stage_key
 * numeric info:
...
/**
 * \brief device level function which set numeric key_size
 * numeric info:
 ...
 */
/**
 * \brief device level function which set values for table sexem_flush_tcam_tcam_memories
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_field_exem_learn_flush_machine_sexem_flush_tcam_tcam_memories_t, (1 + 1 /* to store default value */ ), "data of dnx_data_field_exem_learn_flush_machine_table_sexem_flush_tcam_tcam_memories");
...
/**
 * \brief device level function which set values for table lexem_flush_tcam_tcam_memories
    ...
    int unit)
{
    ...
    table->values[9].default_val = "ITEM_1_1f";
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_field_exem_learn_flush_machine_lexem_flush_tcam_tcam_memories_t, (1 + 1 /* to store default value */ ), "data of dnx_data_field_exem_learn_flush_machine_table_lexem_flush_tcam_tcam_memories");
...
/**
 * \brief device level function which set values for table sexem_flush_tcam_data_rules
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_field_exem_learn_flush_machine_sexem_flush_tcam_data_rules_t, (1 + 1 /* to store default value */ ), "data of dnx_data_field_exem_learn_flush_machine_table_sexem_flush_tcam_data_rules");
...
/**
 * \brief device level function which set values for table lexem_flush_tcam_data_rules
    ...
    int unit)
{
    ...
    table->values[3].default_val = "ITEM_4_63f";
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_field_exem_learn_flush_machine_lexem_flush_tcam_data_rules_t, (1 + 1 /* to store default value */ ), "data of dnx_data_field_exem_learn_flush_machine_table_lexem_flush_tcam_data_rules");
...
/**
 * \brief device level function which set define nof_configurable_ranges
 * define info:
 ...
 */
/**
 * \brief device level function which set define fec_dest
 * define info:
...
/**
 * \brief device level function which set define l4_trap
 * define info:
 * APP for L4 Trap
 * 
 * \param [in] unit - Unit #
...
/**
 * \brief device level function which set define oam_stat
 * define info:
...
/**
 * \brief device level function which set define roo
 * define info:
 * APP for Roo
 * 
 * \param [in] unit - Unit #
...
/**
 * \brief device level function which set define jr1_ipmc_inlif
 * define info:
 * APP for IPMC In LIF
 * 
 * \param [in] unit - Unit #
...
/**
 * \brief device level function which set define j1_learning
 * define info:
 * APP for J1 Learning
 * 
 * \param [in] unit - Unit #
...
/**
 * \brief device level function which set define parsing_start_offset_msb_meaningless
 * define info:
...
/**
 * \brief device level function which set define state_table_ipmf1_key_select
 * define info:
...
/**
 * \brief device level function which set define state_table_acr_bus
 * define info:
...
/**
 * \brief device level function which set define state_table_atomic_rmw
 * define info:
...
/**
 * \brief device level function which set define hitbit_volatile
 * define info:
...
/**
 * \brief device level function which set define fem_replace_msb_instead_lsb
 * define info:
...
/**
 * \brief device level function which set define no_parser_resources
 * define info:
...
/**
 * \brief device level function which set define dir_ext_epmf
 * define info:
...
/**
 * \brief device level function which set define hashing_process_lsb_to_msb
 * define info:
...
/**
 * \brief device level function which set define exem_age_flush_scan
 * define info:
...
/**
 * \brief device level function which set define epmf_outlif_profile_map
 * define info:
...
/**
 * \brief device level function which set define parsing_start_offset_size
 * define info:
 * 
 * \param [in] unit - Unit #
 * 
 ...
 */
/**
 * \brief device level function which set define learn_info_actions_structure_change
 * define info:
 * 
 * \param [in] unit - Unit #
 * 
...
/**
 * \brief device level function which set define ingress_time_stamp_increased
 * define info:
 * 
 * \param [in] unit - Unit #
 * 
...
/**
 * \brief device level function which set define ace_debug_signals_exist
 * define info:
 * 
 * \param [in] unit - Unit #
 * 
...
/**
 * \brief device level function which set define epmf_debug_rely_on_tcam0
 * define info:
 * 
 * \param [in] unit - Unit #
 * 
    ...
    int unit)
{
     ...
     */
    /*
     * Attach submodule: exem_learn_flush_machine
     */
