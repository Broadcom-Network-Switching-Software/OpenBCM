/** \file j2p_a0_data_techsupport.c
 * 
 ...
 */
static shr_error_e
j2p_a0_dnx_data_techsupport_tm_tm_mem_set(
    int unit)
{
    int block_index;
    int index_index;
 ...
 */
shr_error_e
j2p_a0_data_techsupport_attach(
    int unit)
{
    ...
    table->set = j2p_a0_dnx_data_techsupport_tm_tm_mem_set;
