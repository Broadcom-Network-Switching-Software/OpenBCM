 ...
 */
static shr_error_e
j2p_a0_dnx_data_meter_expansion_expansion_for_uuc_umc_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_meter;
    ...
    int unit)
{
    ...
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_meter_expansion_expansion_for_uuc_umc_support_set;
