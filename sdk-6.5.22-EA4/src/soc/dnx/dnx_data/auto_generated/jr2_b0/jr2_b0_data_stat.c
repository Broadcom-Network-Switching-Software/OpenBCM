 ...
 */
static shr_error_e
jr2_b0_dnx_data_stat_stat_pp_max_irpp_profile_value_set(
    int unit)
{
 ...
 */
static shr_error_e
jr2_b0_dnx_data_stat_stat_pp_max_etpp_profile_value_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_stat;
 ...
 */
static shr_error_e
jr2_b0_dnx_data_stat_stat_pp_max_erpp_profile_value_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_stat;
 ...
 */
static shr_error_e
jr2_b0_dnx_data_stat_stat_pp_etpp_reversed_stat_cmd_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_stat;
 ...
 */
static shr_error_e
jr2_b0_dnx_data_stat_stat_pp_etpp_enc_stat_cmd_is_reversed_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_stat;
 ...
 */
static shr_error_e
jr2_b0_dnx_data_stat_stat_pp_etpp_egress_vsi_always_pushed_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_stat;
 ...
 */
static shr_error_e
jr2_b0_dnx_data_stat_stat_pp_irpp_start_profile_value_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_stat;
 ...
 */
static shr_error_e
jr2_b0_dnx_data_stat_stat_pp_erpp_start_profile_value_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_stat;
 ...
 */
static shr_error_e
jr2_b0_dnx_data_stat_stat_pp_etpp_start_profile_value_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_stat;
 ...
 */
static shr_error_e
jr2_b0_dnx_data_stat_drop_reasons_nof_drop_reasons_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_stat;
 ...
 */
static shr_error_e
jr2_b0_dnx_data_stat_drop_reasons_group_drop_reason_index_set(
    int unit)
{
    int group_index;
 ...
 */
static shr_error_e
jr2_b0_dnx_data_stat_drop_reasons_drop_reason_index_set(
    int unit)
{
 ...
 */
static shr_error_e
jr2_b0_dnx_data_stat_drop_reasons_drop_reasons_groups_set(
    int unit)
{
    int name_index;
    ...
    int unit)
{
    ...
    define->set = jr2_b0_dnx_data_stat_stat_pp_max_irpp_profile_value_set;
    data_index = dnx_data_stat_stat_pp_define_max_etpp_profile_value;
    define = &submodule->defines[data_index];
    define->set = jr2_b0_dnx_data_stat_stat_pp_max_etpp_profile_value_set;
    data_index = dnx_data_stat_stat_pp_define_max_erpp_profile_value;
    define = &submodule->defines[data_index];
    define->set = jr2_b0_dnx_data_stat_stat_pp_max_erpp_profile_value_set;
    data_index = dnx_data_stat_stat_pp_define_etpp_reversed_stat_cmd;
    define = &submodule->defines[data_index];
    define->set = jr2_b0_dnx_data_stat_stat_pp_etpp_reversed_stat_cmd_set;
    data_index = dnx_data_stat_stat_pp_define_etpp_enc_stat_cmd_is_reversed;
    define = &submodule->defines[data_index];
    define->set = jr2_b0_dnx_data_stat_stat_pp_etpp_enc_stat_cmd_is_reversed_set;
    data_index = dnx_data_stat_stat_pp_define_etpp_egress_vsi_always_pushed;
    define = &submodule->defines[data_index];
    define->set = jr2_b0_dnx_data_stat_stat_pp_etpp_egress_vsi_always_pushed_set;
    data_index = dnx_data_stat_stat_pp_define_irpp_start_profile_value;
    define = &submodule->defines[data_index];
    define->set = jr2_b0_dnx_data_stat_stat_pp_irpp_start_profile_value_set;
    data_index = dnx_data_stat_stat_pp_define_erpp_start_profile_value;
    define = &submodule->defines[data_index];
    define->set = jr2_b0_dnx_data_stat_stat_pp_erpp_start_profile_value_set;
    data_index = dnx_data_stat_stat_pp_define_etpp_start_profile_value;
    define = &submodule->defines[data_index];
    define->set = jr2_b0_dnx_data_stat_stat_pp_etpp_start_profile_value_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_b0_dnx_data_stat_drop_reasons_nof_drop_reasons_set;
    ...
    table->set = jr2_b0_dnx_data_stat_drop_reasons_group_drop_reason_index_set;
    data_index = dnx_data_stat_drop_reasons_table_drop_reason_index;
    table = &submodule->tables[data_index];
    table->set = jr2_b0_dnx_data_stat_drop_reasons_drop_reason_index_set;
    data_index = dnx_data_stat_drop_reasons_table_drop_reasons_groups;
    table = &submodule->tables[data_index];
    table->set = jr2_b0_dnx_data_stat_drop_reasons_drop_reasons_groups_set;
