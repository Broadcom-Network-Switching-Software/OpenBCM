    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_mpls_general_define_bit_number_disable_speculative_parsing].name = "bit_number_disable_speculative_parsing";
    submodule_data->defines[dnx_data_mpls_general_define_bit_number_disable_speculative_parsing].doc = "indicate bit number in LIF generic data0 for disable speculative parsing";
    /* Set data type flag */
    submodule_data->defines[dnx_data_mpls_general_define_bit_number_disable_speculative_parsing].flags |= DNXC_DATA_F_NUMERIC;
...
uint32
dnx_data_mpls_general_bit_number_disable_speculative_parsing_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_mpls, dnx_data_mpls_submodule_general, dnx_data_mpls_general_define_bit_number_disable_speculative_parsing);
}
