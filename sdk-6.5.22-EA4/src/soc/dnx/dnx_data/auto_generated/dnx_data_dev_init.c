    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_dev_init_general_dnx2_device].name = "dnx2_device";
    submodule_data->features[dnx_data_dev_init_general_dnx2_device].doc = "indicates whether the device is DNX2 family";
    submodule_data->features[dnx_data_dev_init_general_dnx2_device].flags |= DNXC_DATA_F_FEATURE;
