/** \file jr2_a0_data_techsupport.c
 * 
 * DEVICE DATA - TECHSUPPORT
 * 
 * Device Data
 ...
 */
/**
 * \brief device level function which set define num_of_tables_per_block
 * define info:
 ...
 */
static shr_error_e
jr2_a0_dnx_data_techsupport_tm_num_of_tables_per_block_set(
    int unit)
{
...
/**
 * \brief device level function which set define num_of_tm_command
 * define info:
 ...
 */
static shr_error_e
jr2_a0_dnx_data_techsupport_tm_num_of_tm_command_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_techsupport;
 ...
 */
/**
 * \brief device level function which set values for table tm_block
 ...
 */
static shr_error_e
jr2_a0_dnx_data_techsupport_tm_tm_block_set(
    int unit)
{
    int block_index;
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_techsupport_tm_tm_block_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_techsupport_tm_table_tm_block");
...
/**
 * \brief device level function which set values for table tm_command
 ...
 */
static shr_error_e
jr2_a0_dnx_data_techsupport_tm_tm_command_set(
    int unit)
{
    int index_index;
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_techsupport_tm_tm_command_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_techsupport_tm_table_tm_command");
...
/**
 * \brief device level function which set values for table tm_mem
 ...
 */
static shr_error_e
jr2_a0_dnx_data_techsupport_tm_tm_mem_set(
    int unit)
{
    int block_index;
    int index_index;
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_techsupport_tm_tm_mem_t, (1 * (table->keys[0].size) * (table->keys[1].size) + 1 /* to store default value */ ), "data of dnx_data_techsupport_tm_table_tm_mem");
    ...
    if (dnx_techsupport_cgm < table->keys[0].size && 0 < table->keys[1].size)
    {
        ...
        data->name = "CGM_AUTO_DOC_NAME_87";
    }
    if (dnx_techsupport_cgm < table->keys[0].size && 1 < table->keys[1].size)
    {
        ...
        data->name = "CGM_VOQ_DRAM_BOUND_PRMS_EXT";
    }
    ...
    if (dnx_techsupport_cgm < table->keys[0].size && 19 < table->keys[1].size)
    {
        data = (dnx_data_techsupport_tm_tm_mem_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_techsupport_cgm, 19);
        data->name = "CGM_PP_RJCT_MASK";
    }
    if (dnx_techsupport_cgm < table->keys[0].size && 20 < table->keys[1].size)
    {
        data = (dnx_data_techsupport_tm_tm_mem_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_techsupport_cgm, 20);
 ...
 */
shr_error_e
jr2_a0_data_techsupport_attach(
    int unit)
{
    ...
    define->set = jr2_a0_dnx_data_techsupport_tm_num_of_tables_per_block_set;
    data_index = dnx_data_techsupport_tm_define_num_of_tm_command;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_techsupport_tm_num_of_tm_command_set;
    ...
    table->set = jr2_a0_dnx_data_techsupport_tm_tm_block_set;
    data_index = dnx_data_techsupport_tm_table_tm_command;
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_techsupport_tm_tm_command_set;
    data_index = dnx_data_techsupport_tm_table_tm_mem;
    table = &submodule->tables[data_index];
    table->set = jr2_a0_dnx_data_techsupport_tm_tm_mem_set;
