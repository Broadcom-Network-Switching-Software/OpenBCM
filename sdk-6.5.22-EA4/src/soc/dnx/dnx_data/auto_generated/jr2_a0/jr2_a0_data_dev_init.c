...
/**
 * \brief device level function which set numeric emul_ext_init
 * numeric info:
 ...
 */
/**
 * \brief device level function which set define name_max
 * define info:
 ...
 */
static shr_error_e
jr2_a0_dnx_data_dev_init_general_dnx2_device_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_dev_init;
    int submodule_index = dnx_data_dev_init_submodule_general;
    int feature_index = dnx_data_dev_init_general_dnx2_device;
    SHR_FUNC_INIT_VARS(unit);
...
/**
 * \brief device level function which set numeric error_recovery_support
 * numeric info:
 ...
 */
/**
 * \brief device level function which set define cmc_num
 * define info:
...
/**
 * \brief device level function which set define num_cpu_cosq
 * define info:
...
/**
 * \brief device level function which set numeric cmc_pci
 * numeric info:
...
/**
 * \brief device level function which set numeric pci_cmc_num
 * numeric info:
...
/**
 * \brief device level function which set numeric cmc_uc0
 * numeric info:
...
/**
 * \brief device level function which set numeric cmc_uc1
 * numeric info:
 * CMC in CMICx used by the micro controller 0
 * 
 * \param [in] unit - Unit #
...
/**
 * \brief device level function which set numeric num_queues_pci
 * numeric info:
...
/**
 * \brief device level function which set numeric num_queues_uc0
 * numeric info:
...
/**
 * \brief device level function which set numeric num_queues_uc1
 * numeric info:
    ...
    int unit)
{
    ...
    data_index = dnx_data_dev_init_general_dnx2_device;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_dev_init_general_dnx2_device_set;
