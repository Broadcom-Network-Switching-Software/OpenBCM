...
/**
 * \brief device level function which set values for table kaps_tcam_scan
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_intr_ser_kaps_tcam_scan_t, (1 + 1 /* to store default value */ ), "data of dnx_data_intr_ser_table_kaps_tcam_scan");
    ...
    /*
     * Value Property - uncorrectable_action
     */
    ...
    /*
     * Value Property - correctable_action
     */
