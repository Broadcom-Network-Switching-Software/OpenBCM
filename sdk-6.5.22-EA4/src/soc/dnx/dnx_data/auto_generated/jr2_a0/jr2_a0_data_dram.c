...
/**
 * \brief device level function which set numeric output_enable_length
 * numeric info:
...
/**
 * \brief device level function which set numeric output_enable_delay
 * numeric info:
...
/**
 * \brief device level function which set define default_model_part_num
 * define info:
...
/**
 * \brief device level function which set define nof_channel_dwords
 * define info:
...
/**
 * \brief device level function which set values for table bist
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_hbm_bist_t, (1 + 1 /* to store default value */ ), "data of dnx_data_dram_hbm_table_bist");
...
/**
 * \brief device level function which set values for table hbc_sbus_chain
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_hbm_hbc_sbus_chain_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_dram_hbm_table_hbc_sbus_chain");
...
/**
 * \brief device level function which set numeric max_dram_index
 * numeric info:
...
/**
 * \brief device level function which set numeric min_dram_index
 * numeric info:
...
/**
 * \brief device level function which set define nof_tdus_per_dram
 * define info:
...
/**
 * \brief device level function which set define max_tdu_index
 * define info:
 * Maximum TDU index
 * 
 * \param [in] unit - Unit #
...
/**
 * \brief device level function which set numeric wmr_decrement_thr_factor
 * numeric info:
...
/**
 * \brief device level function which set numeric wpr_increment_thr_factor
 * numeric info:
 ...
 */
/**
 * \brief device level function which set values for table wpr_leaky_bucket_increment_th
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_dram_block_wpr_leaky_bucket_increment_th_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_dram_dram_block_table_wpr_leaky_bucket_increment_th");
 ...
 */
/**
 * \brief device level function which set define hbm_trc_nof_bits
 * define info:
...
/**
 * \brief device level function which set define wpr_increment_threshold_nof_bits
 * define info:
...
/**
 * \brief device level function which set define hbm_pll_pdiv_nof_bits
 * define info:
...
/**
 * \brief device level function which set define hbm_pll_ch_mdiv_nof_bits
 * define info:
...
/**
 * \brief device level function which set define hbm_pll_frefeff_info_nof_bits
 * define info:
...
/**
 * \brief device level function which set define hbm_pll_aux_post_enableb_nof_bits
 * define info:
...
/**
 * \brief device level function which set define hbm_pll_ch_enableb_nof_bits
 * define info:
...
/**
 * \brief device level function which set define hbm_pll_aux_post_diffcmos_en_nof_bits
 * define info:
...
/**
 * \brief device level function which set numeric hbmc_index_nof_bits
 * numeric info:
...
/**
 * \brief device level function which set numeric hbmc_tdu_index_nof_bits
 * numeric info:
