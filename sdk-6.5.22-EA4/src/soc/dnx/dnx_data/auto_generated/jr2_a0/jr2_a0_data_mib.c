 ...
 */
/**
 * \brief device level function which set define nof_row_per_cdu_lane
 * define info:
    ...
    int unit)
{
    ...
    if (snmpBcmRxRsFecSymbolError < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_map_data_t *) dnxc_data_mgmt_table_data_get(unit, table, snmpBcmRxRsFecSymbolError, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->counters_to_add_array[0] = dnx_mib_counter_rx_rs_fec_symbol_error_rate;
    }
    ...
    int unit)
{
    ...
    if (dnx_mib_counter_rx_rs_fec_symbol_error_rate < table->keys[0].size && DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH < table->keys[1].size)
    {
        data = (dnx_data_mib_controlled_counters_set_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_rs_fec_symbol_error_rate, DNX_ALGO_PORT_MIB_COUNTER_SET_TYPE_NIF_ETH);
        data->get_cb = dnx_mib_nif_counter_get;
        data->clear_cb = dnx_mib_nif_counter_clear;
    }
    ...
    int unit)
{
    ...
    if (dnx_mib_counter_rx_fec_1_symbol_error_per_frame < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_fec_1_symbol_error_per_frame, 0);
        data->offset_in_row = 0;
        data->doc = "RX FEC 1 symbol error per frame";
    }
    if (dnx_mib_counter_rx_fec_2_symbol_error_per_frame < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_fec_2_symbol_error_per_frame, 0);
        data->offset_in_row = 1;
        data->doc = "RX FEC 2 symbol error per frame";
    }
    if (dnx_mib_counter_rx_fec_3_symbol_error_per_frame < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_fec_3_symbol_error_per_frame, 0);
        data->offset_in_row = 2;
        data->doc = "RX FEC 3 symbol error per frame";
    }
    if (dnx_mib_counter_rx_fec_4_symbol_error_per_frame < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_fec_4_symbol_error_per_frame, 0);
        data->offset_in_row = 3;
        data->doc = "RX FEC 4 symbol error per frame";
    }
    if (dnx_mib_counter_rx_fec_5_symbol_error_per_frame < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_fec_5_symbol_error_per_frame, 0);
        data->offset_in_row = 4;
        data->doc = "RX FEC 5 symbol error per frame";
    }
    if (dnx_mib_counter_rx_fec_6_symbol_error_per_frame < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_fec_6_symbol_error_per_frame, 0);
        data->offset_in_row = 5;
        data->doc = "RX FEC 6 symbol error per frame";
    }
    if (dnx_mib_counter_rx_fec_7_symbol_error_per_frame < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_fec_7_symbol_error_per_frame, 0);
        data->offset_in_row = 6;
        data->doc = "RX FEC 7 symbol error per frame";
    }
    if (dnx_mib_counter_rx_fec_8_symbol_error_per_frame < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_fec_8_symbol_error_per_frame, 0);
        data->offset_in_row = 7;
        data->doc = "RX FEC 8 symbol error per frame";
    }
    if (dnx_mib_counter_rx_fec_9_symbol_error_per_frame < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_fec_9_symbol_error_per_frame, 0);
        data->offset_in_row = 8;
        data->doc = "RX FEC 9 symbol error per frame";
    }
    if (dnx_mib_counter_rx_fec_10_symbol_error_per_frame < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_fec_10_symbol_error_per_frame, 0);
        data->offset_in_row = 9;
        data->doc = "RX FEC 10 symbol error per frame";
    }
    if (dnx_mib_counter_rx_fec_11_symbol_error_per_frame < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_fec_11_symbol_error_per_frame, 0);
        data->offset_in_row = 10;
        data->doc = "RX FEC 11 symbol error per frame";
    }
    if (dnx_mib_counter_rx_fec_12_symbol_error_per_frame < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_fec_12_symbol_error_per_frame, 0);
        data->offset_in_row = 11;
        data->doc = "RX FEC 12 symbol error per frame";
    }
    if (dnx_mib_counter_rx_fec_13_symbol_error_per_frame < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_fec_13_symbol_error_per_frame, 0);
        data->offset_in_row = 12;
        data->doc = "RX FEC 13 symbol error per frame";
    }
    if (dnx_mib_counter_rx_fec_14_symbol_error_per_frame < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_fec_14_symbol_error_per_frame, 0);
        data->offset_in_row = 13;
        data->doc = "RX FEC 14 symbol error per frame";
    }
    if (dnx_mib_counter_rx_fec_15_symbol_error_per_frame < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_fec_15_symbol_error_per_frame, 0);
        data->offset_in_row = 14;
        data->doc = "RX FEC 15 symbol error per frame";
    }
    if (dnx_mib_counter_rx_fec_uncorrrectable_errors_per_frame < table->keys[0].size)
    {
        data = (dnx_data_mib_controlled_counters_counter_data_t *) dnxc_data_mgmt_table_data_get(unit, table, dnx_mib_counter_rx_fec_uncorrrectable_errors_per_frame, 0);
        data->offset_in_row = 15;
        data->doc = "RX FEC uncorrectable error per frame";
    }
