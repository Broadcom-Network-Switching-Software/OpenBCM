...
/**
 * \brief device level function which set define ifa2_is_in_hl
 * define info:
...
/**
 * \brief device level function which set define is_extra_words_copy
 * define info:
...
/**
 * \brief device level function which set define period_adjusting_clk_bits
 * define info:
...
/**
 * \brief device level function which set define period_adjusting_ns_bits
 * define info:
...
/**
 * \brief device level function which set define max_interval_period_size
 * define info:
...
/**
 * \brief device level function which set define cgm_write_counter_wrap_around
 * define info:
...
/**
 * \brief device level function which set define bytes_in_word
 * define info:
