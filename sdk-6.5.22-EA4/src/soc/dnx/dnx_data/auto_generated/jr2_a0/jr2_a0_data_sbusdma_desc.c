/** \file jr2_a0_data_sbusdma_desc.c
 * 
 * DEVICE DATA - SBUSDMA_DESC
 * 
 * Device Data
 ...
 */
/**
 * \brief device level function which set values for table enable_module_desc_dma
    ...
    int unit)
{
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_sbusdma_desc_global_enable_module_desc_dma_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnx_data_sbusdma_desc_global_table_enable_module_desc_dma");
