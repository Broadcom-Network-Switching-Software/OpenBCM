 ...
 */
/**
 * \brief device level function which set define min_nof_terminated_sids_psp
 * define info:
 ...
 */
static shr_error_e
j2c_a0_dnx_data_srv6_termination_min_nof_terminated_sids_psp_set(
    int unit)
{
...
/**
 * \brief device level function which set define min_nof_terminated_sids_usp
 * define info:
 ...
 */
static shr_error_e
j2c_a0_dnx_data_srv6_termination_min_nof_terminated_sids_usp_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_srv6;
    ...
    int unit)
{
    ...
    define->set = j2c_a0_dnx_data_srv6_termination_min_nof_terminated_sids_psp_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_srv6_termination_min_nof_terminated_sids_usp_set;
