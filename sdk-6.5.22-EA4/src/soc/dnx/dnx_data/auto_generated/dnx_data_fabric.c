    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_fabric_links_isolation_needed_before_disable].name = "isolation_needed_before_disable";
    submodule_data->features[dnx_data_fabric_links_isolation_needed_before_disable].doc = "";
    submodule_data->features[dnx_data_fabric_links_isolation_needed_before_disable].flags |= DNXC_DATA_F_FEATURE;
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_fabric_cell_define_pcp_force_no_packing].name = "pcp_force_no_packing";
    submodule_data->defines[dnx_data_fabric_cell_define_pcp_force_no_packing].doc = "Force no_packing pcp mode";
    /* Set data type flag */
    submodule_data->defines[dnx_data_fabric_cell_define_pcp_force_no_packing].flags |= DNXC_DATA_F_NUMERIC;
...
uint32
dnx_data_fabric_cell_pcp_force_no_packing_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_fabric, dnx_data_fabric_submodule_cell, dnx_data_fabric_cell_define_pcp_force_no_packing);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    /*
     * Table - dtq_fc_fabric_thresholds
     */
