...
{
    if (((int) asic_block < DBAL_ENUM_FVAL_PP_ASIC_BLOCK_IPPA)
        || ((int) asic_block > DBAL_ENUM_FVAL_PP_ASIC_BLOCK_ETPPC))
    {
    ...
    uint32 flags)
{
    ...
    SHR_IF_ERR_EXIT(dnx_debug_mem_clear(unit, 0, DBAL_ENUM_FVAL_PP_ASIC_BLOCK_IPPA, 0));
    SHR_IF_ERR_EXIT(dnx_debug_mem_get(unit, 0, DBAL_ENUM_FVAL_PP_ASIC_BLOCK_IPPA, 0, &reset_val));
    if (reset_val != 0)
    {
