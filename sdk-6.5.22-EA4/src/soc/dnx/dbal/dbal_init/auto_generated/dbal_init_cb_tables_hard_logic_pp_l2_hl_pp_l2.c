...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_FULL_KEY_VALUE(unit, eh, full_key_value);
    /** size of VSI_LEARNING_PROFILE field  */
    full_result_size += 5;
...
uint32 * offset)
{
    ...
    uint32 instance_idx;
    SHR_FUNC_INIT_VARS(unit);
    /** size of LEARN_FFC_INSTRUCTION field  */
...
uint32 * offset)
{
    ...
    /** sizes of MACT_APP_DB_IDX + VLAN_SOURCE fields  */
...
uint32 * offset)
{
    ...
    /** size of LEARN_FORMAT_INDEX field  */
    full_result_size += 2;
