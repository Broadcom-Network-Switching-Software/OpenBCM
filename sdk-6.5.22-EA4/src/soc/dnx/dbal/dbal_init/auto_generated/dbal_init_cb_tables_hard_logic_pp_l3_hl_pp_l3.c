/** \file dbal_init_cb_tables_hard_logic_pp_l3_hl_pp_l3.c
 * Logical DB enums \n 
...
uint32 * offset)
{
    ...
    /** sizes of STRENGTH_NON_DEFAULT + STRENGTH_DEFAULT fields  */
...
uint32 * offset)
{
    ...
    /** sizes of STRENGTH_NON_DEFAULT + STRENGTH_DEFAULT fields  */
    full_result_size += 3 + 3;
    /** size of STRENGTH_NON_DEFAULT field  */
