...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_SRV6_SID_FORMATS_PER_TUNNEL_GPORT_SW /* table id*/, is_valid /* is valid*/, "SRV6_SID_FORMATS_PER_TUNNEL_GPORT_SW" /* table name*/, DBAL_ACCESS_METHOD_SW_STATE /* access method*/));
    /** maturity level  */
    ...
    /** interface results  */
    {
        ...
        /** interface result fields init  */
        {
            ...
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_mandatory_values(unit, DBAL_FIELD_SRV6_SID_FORMATS /* field id*/, DBAL_FIELD_TYPE_DEF_SRV6_SID_FORMATS /* Type*/, dbal_db_field));
            dbal_db_init_table_field_params_init(&db_field);
    ...
    dbal_db_init_sw_state_set_indirect_table_size(unit, table_entry, srv6_sid_formats_per_tunnel_gport_sw_indirect_table_size_0_cb /* table property size*/, DBAL_DB_INVALID /* table property size as int*/);
