/** \file dbal_init_cb_tables_hard_logic_tm_hl_tm_imb_definition.c
 * Logical DB enums \n 
...
uint32 * offset)
{
    ...
    {
        /** size of IS_TDM field  */
        full_result_size += 1;
    }
    /** size of PRIORITY field  */
    full_result_size += 2;
...
uint32 * offset)
{
    ...
    /** sizes of ETHER_TYPE_CODE + ETHER_TYPE_CODE_MASK + ENTRY_OFFSETS_VALUE + ENTRY_OFFSETS_MASK + PRIORITY + VALID fields  */
