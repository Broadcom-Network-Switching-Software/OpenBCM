...
dbal_logical_table_t * table_info)
{
    ...
    dbal_db_init_sw_state_set_indirect_table_size(unit, table_entry, NULL /* table property size*/, dnx_data_qos.qos.nof_ingress_profiles_get(unit) /* table property size as int*/);
