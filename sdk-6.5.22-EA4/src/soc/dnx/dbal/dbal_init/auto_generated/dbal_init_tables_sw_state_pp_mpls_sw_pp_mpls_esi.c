/** \file dbal_init_tables_sw_state_pp_mpls_sw_pp_mpls_esi.c
 * Logical DB enums \n 
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_MPLS_LABEL_RANGE_INFO_SW /* table id*/, is_valid /* is valid*/, "MPLS_LABEL_RANGE_INFO_SW" /* table name*/, DBAL_ACCESS_METHOD_SW_STATE /* access method*/));
    /** maturity level  */
    ...
    dbal_db_init_sw_state_set_indirect_table_size(unit, table_entry, NULL /* table property size*/, dnx_data_mpls.general.nof_mpls_range_elements_get(unit) /* table property size as int*/);
