...
dbal_logical_table_t * table_info)
{
    ...
    /** interface keys  */
    {
        ...
        {
            dbal_db_field = &table_entry->keys_info[field_index];
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_mandatory_values(unit, DBAL_FIELD_PON_CHANNEL_ID /* field id*/, DBAL_FIELD_TYPE_DEF_UINT /* Type*/, dbal_db_field));
            dbal_db_init_table_field_params_init(&db_field);
            db_field.size = 16;
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_optional_or_default_values(unit, table_entry, dbal_db_field, &db_field, TRUE));
            field_index += dbal_db_field->nof_instances;
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    /** set app to phy db for sw access  */
    dbal_db_init_sw_state_set_indirect_table_size(unit, table_entry, vlan_port_match_key_sw_indirect_table_size_0_cb /* table property size*/, DBAL_DB_INVALID /* table property size as int*/);
