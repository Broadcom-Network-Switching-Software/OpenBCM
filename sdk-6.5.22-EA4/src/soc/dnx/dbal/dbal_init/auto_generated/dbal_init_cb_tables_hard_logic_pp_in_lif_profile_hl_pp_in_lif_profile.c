/** \file dbal_init_cb_tables_hard_logic_pp_in_lif_profile_hl_pp_in_lif_profile.c
 * Logical DB enums \n 
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_IN_LIF_PROFILE, key_value__in_lif_profile);
    /** size of CS_IN_LIF_VTT_PROFILE field  */
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_IN_LIF_PROFILE, key_value__in_lif_profile);
    /** size of CS_IN_LIF_FWD_PROFILE field  */
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_IN_LIF_PROFILE, key_value__in_lif_profile);
    /** size of OAM_DEFAULT_PROFILE field  */
...
uint32 * offset)
{
    ...
    {
        /** size of JR_MODE_IN_LIF_PROFILE field  */
...
uint32 * offset)
{
    ...
    {
        /** size of MC_BRIDGE_FALLBACK_ALLOW field  */
...
uint32 * offset)
{
    ...
    {
        /** size of JR_IN_LIF_ORIENTATION field  */
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_FULL_KEY_VALUE(unit, eh, full_key_value);
    /** size of ROUTING_ENABLERS_PROFILE field  */
