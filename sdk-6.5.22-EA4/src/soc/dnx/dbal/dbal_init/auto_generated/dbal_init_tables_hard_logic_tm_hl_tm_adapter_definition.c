/** \file dbal_init_tables_hard_logic_tm_hl_tm_adapter_definition.c
 * Logical DB enums \n 
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_ADAPTER_EGQ_IF_PORT_MAP /* table id*/, is_valid /* is valid*/, "ADAPTER_EGQ_IF_PORT_MAP" /* table name*/, DBAL_ACCESS_METHOD_HARD_LOGIC /* access method*/));
    if (!is_valid)
    {
        SHR_EXIT();
    }
    ...
    /** interface results  */
    {
        ...
        /** interface result fields init  */
        {
            ...
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_mandatory_values(unit, DBAL_FIELD_FIRST_PHY /* field id*/, DBAL_FIELD_TYPE_DEF_UINT /* Type*/, dbal_db_field));
            dbal_db_init_table_field_params_init(&db_field);
    ...
    /** build access hl direct  */
    {
        ...
        {
            /** set (hl direct) accesses for field: FIRST_PHY  */
            {
