...
/**
 * \brief device level function which set define max_bucket_fill_rate
 * define info:
...
/**
 * \brief device level function which set define link_mask
 * define info:
...
/**
 * \brief device level function which set define aldwp_max_val
 * define info:
...
/**
 * \brief device level function which set define speed_max
 * define info:
...
/**
 * \brief device level function which set numeric fw_load_method
 * numeric info:
...
/**
 * \brief device level function which set numeric fw_crc_check
 * numeric info:
...
/**
 * \brief device level function which set numeric fw_load_verify
 * numeric info:
...
/**
 * \brief device level function which set numeric mac_bucket_fill_rate
 * numeric info:
    ...
    int unit)
{
    ...
    DNXC_DATA_ALLOC(table->data, dnxf_data_port_general_supported_phys_t, (1 + 1 /* to store default value */ ), "data of dnxf_data_port_general_table_supported_phys");
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnxf_data_port_general_fmac_bus_size_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnxf_data_port_general_table_fmac_bus_size");
 ...
 */
/**
 * \brief device level function which set numeric thread_interval
 * numeric info:
...
/**
 * \brief device level function which set numeric thread_flags
 * numeric info:
...
/**
 * \brief device level function which set numeric thread_counter_pri
 * numeric info:
...
/**
 * \brief device level function which set numeric thread_timeout
 * numeric info:
 ...
 */
/**
 * \brief device level function which set values for table port_info
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnxf_data_port_static_add_port_info_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnxf_data_port_static_add_table_port_info");
    ...
    /*
     * Value Property - connected_to_repeater
     */
    ...
    /*
     * Value Property - tx_pam4_precoder
     */
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnxf_data_port_static_add_serdes_lane_config_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnxf_data_port_static_add_table_serdes_lane_config");
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnxf_data_port_static_add_serdes_tx_taps_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnxf_data_port_static_add_table_serdes_tx_taps");
...
/**
 * \brief device level function which set values for table quad_info
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnxf_data_port_static_add_quad_info_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnxf_data_port_static_add_table_quad_info");
 ...
 */
/**
 * \brief device level function which set define lane_map_bound
 * define info:
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnxf_data_port_lane_map_info_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnxf_data_port_lane_map_table_info");
 ...
 */
/**
 * \brief device level function which set define nof_lcpll
 * define info:
 * Number of LCPLL.
 * 
 * \param [in] unit - Unit #
...
/**
 * \brief device level function which set define nof_port_in_lcpll
 * define info:
...
/**
 * \brief device level function which set define nof_plls_per_pm
 * define info:
...
/**
 * \brief device level function which set define nof_config_words
 * define info:
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnxf_data_port_pll_info_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnxf_data_port_pll_table_info");
    ...
    /*
     * Value Property - fabric_ref_clk_in
     */
    ...
    /*
     * Value Property - fabric_ref_clk_out
     */
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnxf_data_port_pll_force_single_pll_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnxf_data_port_pll_table_force_single_pll");
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnxf_data_port_pll_config_t, (1 * (table->keys[0].size) * (table->keys[1].size) + 1 /* to store default value */ ), "data of dnxf_data_port_pll_table_config");
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnxf_data_port_synce_cfg_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnxf_data_port_synce_table_cfg");
    ...
    /*
     * Value Property - source_clock_divider
     */
 ...
 */
/**
 * \brief device level function which set values for table links_connection
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnxf_data_port_retimer_links_connection_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnxf_data_port_retimer_table_links_connection");
