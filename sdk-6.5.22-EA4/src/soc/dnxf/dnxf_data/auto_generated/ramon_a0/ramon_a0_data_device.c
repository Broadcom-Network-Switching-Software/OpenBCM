    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnxf_data_device_blocks_fsrd_sbus_chain_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnxf_data_device_blocks_table_fsrd_sbus_chain");
    ...
    int unit)
{
    ...
    /* Allocate data buffer */
    DNXC_DATA_ALLOC(table->data, dnxf_data_device_blocks_fmac_sbus_chain_t, (1 * (table->keys[0].size) + 1 /* to store default value */ ), "data of dnxf_data_device_blocks_table_fmac_sbus_chain");
