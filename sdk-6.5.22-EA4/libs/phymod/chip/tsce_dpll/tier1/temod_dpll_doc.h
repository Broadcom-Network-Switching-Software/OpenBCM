...
\section temod-intro Introduction to TEMod
...
\li temod_cfg_seq.c
\li temod_enum_defines.c

\li temod_defines.h
\li temod_enum_defines.h
\li temod_doc.h
...
In validation (pre-silicon DV) platforms, TEMod has a structure (temod_st) which
encapsulates information needed to configure the TEMod. temod_st is created
...
The list of Tier1 functions and documentation is in temod_cfg_seq.c 
