 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors).
 */
err_code_t blackhawk7_l8p2_INTERNAL_configure_20P625_pll(srds_access_t *sa__,
                                                enum blackhawk7_l8p2_pll_refclk_enum refclk,
                                                enum blackhawk7_l8p2_pll_div_enum srds_div,
                                                enum blackhawk7_l8p2_pll_option_enum pll_option);
 ...
 * @param[in] range_250 determines the range 0 = +/-150mV, 1 = +/-250mV (ignored for 7).
 * @param[in] slicer_sel slicer for which ladder threshold needs to be calculated. (Required for 7, unused (can be zero) for all other IPs).
...
/** Get a string representation of an blackhawk7_l8p2_osr_mode_enum enum value.
 * @param[in] osr_val a blackhawk7_l8p2_osr_mode_enum value.
 ...
 * @param[out] dbgfb_stats pointer of type blackhawk7_l8p2_dbgfb_stats_st.
 * @return Error Code generated by API (ERR_CODE_NONE if no errors).
 */
err_code_t blackhawk7_l8p2_collect_dbgfb_stats(srds_access_t *sa__, uint32_t time_in_us, blackhawk7_l8p2_dbgfb_stats_st *dbgfb_stats); 
#endif /* SMALL_FOOTPRINT */
