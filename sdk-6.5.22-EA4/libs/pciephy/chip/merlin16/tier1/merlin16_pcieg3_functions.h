...
/***********************************************************************************
 ***********************************************************************************
 *  File Name  :  merlin16_pcieg3_functions.h                                           *
...
#ifndef MERLIN16_PCIEG3_API_FUNCTIONS_H
#define MERLIN16_PCIEG3_API_FUNCTIONS_H
    ...
    do  { \
        ...
        *(__ERR) = (expr); \
        if (*(__ERR) != ERR_CODE_NONE) { \
            return merlin16_pcieg3_error_report(sa__, *(__ERR)); \
        }\
        (void)__err; \
    }   while(0)
/**
