 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon16_tsc_reg_dump(srds_access_t *sa__, char reg_buffer[][250]);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon16_tsc_uc_core_var_dump(srds_access_t *sa__, char ram_buffer[][250]);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon16_tsc_uc_lane_var_dump(srds_access_t *sa__, char ram_buffer[][250]);
