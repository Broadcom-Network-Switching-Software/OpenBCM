...
#define SOC_IS_DNX(unit)                ((SOC_INFO(unit).chip_type == SOC_INFO_CHIP_TYPE_JERICHO_2) || (SOC_INFO(unit).chip_type == SOC_INFO_CHIP_TYPE_J2C))
#define SOC_IS_DNX_TYPE(dev_type)       (SOC_IS_JERICHO_2_TYPE(dev_type) || SOC_IS_J2C_TYPE(dev_type))
#define SOC_IS_JERICHO_2_A0(unit)       (SOC_INFO(unit).driver_type == SOC_CHIP_BCM88690_A0)
#define SOC_IS_JERICHO_2_B(unit)        (SOC_INFO(unit).driver_type == SOC_CHIP_BCM88690_B0)
#define SOC_IS_JERICHO_2_B1_ONLY(unit)       ((SOC_INFO(unit).driver_type == SOC_CHIP_BCM88690_B0) && CMDEV(unit).dev.rev_id == BCM88690_B1_REV_ID)
#define SOC_IS_JERICHO_2_B0_ONLY(unit)  ((SOC_INFO(unit).driver_type == SOC_CHIP_BCM88690_B0) && CMDEV(unit).dev.rev_id == BCM88690_B0_REV_ID)
#define SOC_IS_JERICHO_2_ONLY(unit)     (SOC_INFO(unit).chip_type == SOC_INFO_CHIP_TYPE_JERICHO_2)
/* SKU Support*/
...
#define SOC_IS_J2C_TYPE(dev_type)       ((dev_type) == BCM88800_DEVICE_ID)
#else
#define SOC_IS_DNX(unit)                (0)
#define SOC_IS_DNX_TYPE(dev_type)       (0)
#define SOC_IS_JERICHO_2_A0(unit)       (0)
#define SOC_IS_JERICHO_2_B(unit)        (0)
#define SOC_IS_JERICHO_2_B1_ONLY(unit)       (0)
#define SOC_IS_JERICHO_2_B0_ONLY(unit)  (0)
#define SOC_IS_JERICHO_2_ONLY(unit)     (0)
...
#define SOC_IS_RAMON_TYPE(dev_type) (((dev_type) & BCM_DNXF_DEVID_MASK) == BCM88790_DEVICE_ID)
...
#define SOC_IS_ESW(unit) (!SOC_IS_SAND(unit))
...
#define MACSEC_BLOCK(unit)              (SOC_INFO(unit).macsec_block)
...
#define SOC_MAX_NUM_CDMAC_BLKS 24
...
#define ESB_BLOCK(unit) (SOC_INFO(unit).esb_block)
