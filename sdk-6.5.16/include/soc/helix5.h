...
typedef int (*_soc_hx5_bst_hw_cb)(int unit);
extern int soc_hx5_set_bst_callback(int unit, _soc_hx5_bst_hw_cb cb);
extern int _soc_hx5_process_mmu_bst(int unit, int xpe, soc_field_t field);
...
#define _HX5_MMU_PSTATS_ENABLE          0x0001 /* Packetized/OOB Stat mode is enabled */
#define _HX5_MMU_PSTATS_PKT_MOD         0x0002 /* Packetized mode is enabled. OOB Stat mode is disabled */
#define _HX5_MMU_PSTATS_HWM_MOD         0x0004 /* Report High Watermark values */
#define _HX5_MMU_PSTATS_RESET_ON_READ   0x0008 /* Enable Hardware clear-on read */
#define _HX5_MMU_PSTATS_MOR_EN          0x0010 /* Enable MOR capability */
#define _HX5_MMU_PSTATS_SYNC            0x8000 /* Read from device else the buffer */
...
extern void soc_helix5_mmu_pstats_tbl_config(int unit);
extern int  soc_helix5_mmu_pstats_mode_set(int unit, uint32 flags);
extern int  soc_helix5_mmu_pstats_mode_get(int unit, uint32 *flags);
extern int  soc_helix5_mmu_pstats_mor_enable(int unit);
extern int  soc_helix5_mmu_pstats_mor_disable(int unit);
