...
/*!
 * @enum cprimod_supported_port_speed_e
 * @brief   Supported CPRI speeds .  
 */ 
typedef enum cprimod_supported_port_speed_e {
    cprimodSupportedSpd1228p8,
    cprimodSupportedSpd2457p6,
    cprimodSupportedSpd3072p0,
    cprimodSupportedSpd4915p2,
    cprimodSupportedSpd6144p0,
    cprimodSupportedSpd9830p4,
    cprimodSupportedSpd10137p6,
    cprimodSupportedSpd12165p12,
    cprimodSupportedSpd24330p24,
    cprimodSupportedSpdCount
} cprimod_supported_port_speed_t;

#ifdef CPRIMOD_DIAG
extern enum_mapping_t cprimod_supported_port_speed_t_mapping[];
#endif /*CPRIMOD_DIAG*/

/* cprimod_supported_port_speed_t validation */
int cprimod_supported_port_speed_t_validate(cprimod_supported_port_speed_t cprimod_supported_port_speed);
 ...
 * @param [in]  enable          - enable
 */
int cprimod_cpri_tunnel_mode_basic_frame_config_set(int unit, int port, cprimod_direction_t dir, int enable);
 ...
 */
int cprimod_cpri_port_rx_tunnel_mode_set(int unit, int port, int enable, uint32 payload_size);
/*! 
 ...
 * @param [in]  payload_size    - Payload Size in bits
 */
int cprimod_cpri_port_tx_agnostic_mode_set(int unit, int port, int enable, cprimod_agnostic_mode_type_t mode, uint32 payload_size);
/*! 
