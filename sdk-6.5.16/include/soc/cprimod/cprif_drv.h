...
int cprif_drv_tx_framer_tgen_enable (int unit, int port, uint8 enable);
int cprif_drv_tx_framer_tgen_offset_set (int unit, int port, uint64  offset);
int cprif_drv_tx_framer_tgen_offset_get (int unit, int port, uint64*  offset);
...
int cprif_drv_tx_framer_tgen_next_hfn_config_get (int unit, int port,
                                                  uint32*  hfn);
int cprif_drv_tx_framer_next_bfn_get (int unit, int port, uint32*  bfn);
int cprif_drv_tx_framer_next_hfn_get (int unit, int port, uint32*  bfn);
