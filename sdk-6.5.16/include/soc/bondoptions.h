...
typedef enum {
    ...
    socBondInfoBskSessionDepth8k, /* BROADSCAN Session table depth 8k */
    socBondInfoBskSessionDepth16k, /* BROADSCAN Session table depth 16k */
    socBondInfoBskSessionDepth32k, /* BROADSCAN Session table depth 32k */
