 ...
 * Value of 1 indicates PM4x10Q is in GMII mode
 */
...
/* Dram temperature restore traffic threshold. When going below this temperature, the traffic redirect to the DRAM */
#define spn_DRAM_TEMPERATURE_THRESHOLD_RESTORE_TRAFFIC  "dram_temperature_threshold_restore_traffic"

/* Dram temperature stop traffic threshold. When going beyond this temperature, SDK stop redirect traffic to the DRAM */
#define spn_DRAM_TEMPERATURE_THRESHOLD_STOP_TRAFFIC  "dram_temperature_threshold_stop_traffic"

/* Dram temperature power down threshold. When going beyond this temperature, DRAM is shut down */
...
/* Enable L4 protocols participation in Load Balancing hashing */
#define spn_L4_PROTOCOLS_LOAD_BALANCING_ENABLE  "l4_protocols_load_balancing_enable"
/*
...
{ \
  ...
  "l3_vrrp_max_vid", \
  "l4_protocols_load_balancing_enable", \
  "lane_to_serdes_map", \
  "lanes_swap", \
