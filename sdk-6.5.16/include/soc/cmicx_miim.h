...
#define MIIM_INTERNAL_EXTERNAL_DELAY_INVALID    -1
 ...
 */
extern int soc_cmicx_miim_operation(int unit, int is_write, int clause,
                  int int_delay, int ext_delay, uint32 phy_id,
