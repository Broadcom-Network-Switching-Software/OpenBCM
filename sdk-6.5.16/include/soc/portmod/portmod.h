...
/*! 
 * portmod_ilkn_core_lane_map_callback_get_f
 *
 ...
 */
typedef int (*portmod_ilkn_core_lane_map_callback_get_f)(int unit, int port, int nof_lanes, int* rx_lane_map, int* tx_lane_map);
...
typedef struct portmod_ilkn_os_create_info_s {
    ...
    uint32 core_clock_khz; /**< core clock Khz */
    portmod_ilkn_core_lane_map_callback_get_f ilkn_core_lane_map_get; /**< ilkn core lane map get function */
 ...
 *
 * @brief Get lane phymod access structure via pm id. can be used for per lane operations 
 *
 * @param [in]  unit            - unit id
...
#ifdef CPRIMOD_SUPPORT
typedef _shr_cpri_cw_l1_protocol_info_t portmod_cpri_cw_l1_protocol_info_t;

#endif /* CPRIMOD_SUPPORT */
/*! 
 * portmod_cpri_port_rx_cw_l1_signal_info_get
 *
 * @brief Get L1 portocol information.  
 *
 * @param [in]  unit            - unit id
 * @param [in]  port            - logical port
 * @param [out]  l1_info         - L1 information
 */
#ifdef CPRIMOD_SUPPORT
...
#ifdef CPRIMOD_SUPPORT
typedef _shr_cpri_cw_l1_config_info_t portmod_cpri_cw_l1_config_info_t;

#endif /* CPRIMOD_SUPPORT */
/*! 
 * portmod_cpri_port_tx_cw_l1_config_set
 *
 * @brief  CPRI Tx Control Word information.  
 *
 * @param [in]  unit            - unit id
 * @param [in]  port            - logical port
 * @param [in]  control_info    - Control Word info..
 */
#ifdef CPRIMOD_SUPPORT
...
/*! 
 * portmod_cpri_port_interrupt_process
 *
 * @brief  Get the CPRI Port interrupt status.  
 *
 * @param [in]  unit            - unit id
...
/*! 
 * portmod_cpri_port_ecc_interrupt_status_get
 *
