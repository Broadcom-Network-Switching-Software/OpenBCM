...
extern int bcm_client_field_tcam_bank_evacuate(int,uint32,bcm_field_group_t,bcm_field_tcam_bank_evacuate_info_t *);
...
extern int bcm_client_instru_vis_mode_get(int,bcm_vis_mode_t *);
extern int bcm_client_instru_vis_mode_set(int,bcm_vis_mode_t);
#ifdef	INCLUDE_INT
...
#endif	/* INCLUDE_PTP */
extern int bcm_client_qos_control_get(int,bcm_qos_control_type_t,int *);
extern int bcm_client_qos_control_set(int,bcm_qos_control_type_t,int);
...
extern int bcm_client_tunnel_terminator_config_traverse(int,bcm_tunnel_terminator_config_traverse_cb,void *);
