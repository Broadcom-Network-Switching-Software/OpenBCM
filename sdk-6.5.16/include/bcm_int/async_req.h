...
typedef struct bcm_async_req_s {
	...
	union {
		...
		} flowtracker_group_cpu_notification_get;
		struct {
			int unit;
			bcm_flowtracker_group_t id;
			bcm_flowtracker_cpu_notification_info_t * info;
		} flowtracker_group_cpu_notification_set;
		struct {
			int unit;
			uint32 options;
			bcm_flowtracker_group_t * flow_group_id;
	...
	/* bcm_module_name has a non int return type */
		...
		} srv6_terminator_next_protocol_add;
		struct {
			int unit;
			bcm_srv6_terminator_next_protocol_mapping_t * info;
		} srv6_terminator_next_protocol_delete;
		struct {
			int unit;
			bcm_srv6_terminator_next_protocol_mapping_t * info;
		} srv6_terminator_next_protocol_get;
		struct {
			int unit;
			bcm_srv6_terminator_next_protocol_traverse_info_t additional_info;
			bcm_srv6_terminator_next_protocol_traverse_cb cb;
			void * user_data;
		} srv6_terminator_next_protocol_traverse;
		struct {
			int unit;
			bcm_port_t port;
		} stat_clear;
...
typedef enum {
	...
	BCM_ASYNC_ENTRY_FLOWTRACKER_GROUP_CPU_NOTIFICATION_GET,
	BCM_ASYNC_ENTRY_FLOWTRACKER_GROUP_CPU_NOTIFICATION_SET,
	...
	BCM_ASYNC_ENTRY_INSTRU_VIS_MODE_GET,
	BCM_ASYNC_ENTRY_INSTRU_VIS_MODE_SET,
	...
	BCM_ASYNC_ENTRY_SRV6_TERMINATOR_NEXT_PROTOCOL_ADD,
	BCM_ASYNC_ENTRY_SRV6_TERMINATOR_NEXT_PROTOCOL_DELETE,
	BCM_ASYNC_ENTRY_SRV6_TERMINATOR_NEXT_PROTOCOL_GET,
	BCM_ASYNC_ENTRY_SRV6_TERMINATOR_NEXT_PROTOCOL_TRAVERSE,
