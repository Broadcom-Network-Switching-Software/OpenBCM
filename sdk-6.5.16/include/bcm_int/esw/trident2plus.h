...
#define BCMI_L3_INTF_ENT_PER_BANK(_u_)   ((SOC_IS_HELIX5(_u_)) ? 1024 : 2048)
#define BCMI_L3_INTF_BANKS_MAX(_u_)       ((SOC_IS_HELIX5(_u_)) ? 8 : 6)

/* L3 next hop banks values */
#define BCMI_L3_NH_ENT_PER_BANK(_u_)     ((SOC_IS_HELIX5(_u_)) ? 2048 : 4096)
#define BCMI_L3_NH_BANKS_MAX             12

/* L3 ECMP banks values */
#define BCMI_L3_ECMP_GROUP_PER_BANK(_u_) ((SOC_IS_HELIX5(_u_)) ? 256 : 512)
#define BCMI_L3_ECMP_PER_BANK(_u_)       ((SOC_IS_HELIX5(_u_)) ? 1024 : 4096)
#define BCMI_L3_ECMP_MAX_BANKS(_u_)      ((SOC_IS_HELIX5(_u_)) ? 4 : 8)
