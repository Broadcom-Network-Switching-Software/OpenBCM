...
#define BCM_FIELD_WB_DEFAULT_VERSION            BCM_FIELD_WB_VERSION_1_28
#endif
...
typedef struct _field_ft_info_s {
    SHR_BITDCL key_type_bmp[_SHR_BITDCLSIZE(_BCM_FIELD_FT_GROUP_KEY_TYPE_MAX)];
...
typedef enum _bcm_field_internal_element_e {
    ...
    _bcmFieldInternalElementCount = 387
...
typedef enum _bcmFieldActionNoParam_e {
    ...
    _bcmFieldActionNoParamCount /* 62 */
