 ...
 *
 *-----------------------------------------------------------------------------*/
#ifndef _ALPM_LIB_TRIE4_H_
#define _ALPM_LIB_TRIE4_H_
...
extern int alpm_lib_trie_traverse(alpm_lib_trie_t *trie, alpm_lib_trie_callback_f cb, void *user_data, alpm_lib_trie_traverse_order_t order);
...
extern int _alpm_lib_trie_v6_skip_node_free(alpm_lib_trie_node_t *trie,
                            uint32 *key,
                            uint32 length);
