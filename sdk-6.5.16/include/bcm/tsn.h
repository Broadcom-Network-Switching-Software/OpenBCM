...
/* Initialize a STU profile configuration structure */
...
/* 
 * Initialize the bcm_tsn_taf_profile_t structure. Clear the content to
 * zero.
 */
...
/* 
 * Initialize the bcm_tsn_taf_profile_status_t structure. Clear the
 * content to zero
 */
