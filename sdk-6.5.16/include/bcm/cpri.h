...
#define BCM_RSVD4_SYNC_MODE_MSG_OFFSET      _shrRsvd4SyncModeMsgOffset /* Sync On Message Offset */
...
#define BCM_RSVD4_SYNC_MODE_TS_NO_SYNC      _shrRsvd4SyncModeTsNoSync /* Sync On any message
                                                          timestamp, GSM Only */
#define BCM_RSVD4_SYNC_MODE_TS_MSG_OFFSET   _shrRsvd4SyncModeTsMsgOffset /* Sync On Msg Offset 
                                                          timestamp, GSM Only */
...
/* Layer 1 Control Word protocol information. */
typedef struct bcm_cpri_cw_l1_protocol_info_s {
    uint32 protocol_ver;    /* Protocol Version */
    uint32 hdlc_rate;       /* HDLC data rate */
    int reset;              /* DL request, UL ack */
    int l1_lof;             /* Layer 1 LOF */
    int l1_los;             /* Layer 1 LOS */
    int l1_sdi;             /* Layer 1 SDI */
    int l1_rai;             /* Layer 1 RAI */
    uint32 eth_pointer;     /*  ETH Control location 010100 - 11111 */
} bcm_cpri_cw_l1_protocol_info_t;
...
typedef struct bcm_cpri_cw_l1_config_info_s {
