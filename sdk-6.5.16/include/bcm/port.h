...
/* Create VLAN tag classification */
...
/* Delete VLAN tag classification */
...
typedef enum bcm_port_class_e {
    ...
    bcmPortClassCount = 42              /* Last enum value. */
} bcm_port_class_t;
...
typedef enum bcm_port_control_e {
    ...
    bcmPortControlngressEnable = 397    /* enable/disable single ingress port. */
} bcm_port_control_t;
...
/* retrieve autonegotiation settings for a port. */
...
/* retrieve autonegotiation settings for a remote link partner */
...
/* 
 * Retrieve the valid operating modes of a port including speed and FEC,
 * etc...
 */
...
/* Port bitmap of affected ports from the given resource. */
extern int bcm_port_resource_speed_config_validate(
    int unit, 
    bcm_port_resource_t *resource, 
    bcm_pbmp_t *pbmp);

/* Get the speed for a given port. */
extern int bcm_port_resource_speed_get(
    int unit, 
    bcm_gport_t port, 
    bcm_port_resource_t *resource);

/* Modify the speed for a given port. */
...
/* Initialize the port flooding group structure */
extern void bcm_port_flood_group_t_init(
    bcm_port_flood_group_t *flood_groups);

#ifndef BCM_HIDE_DISPATCHABLE

/* Set the flooding groups for port or InLIF. */
...
/* Get the flood groups for port or InLiF. */
...
/* Initialize the bcm_port_rlm_config_t structure. */
extern void bcm_port_rlm_config_t_init(
    bcm_port_rlm_config_t *rlm_config);

#ifndef BCM_HIDE_DISPATCHABLE

/* Modify RLM config and enable/disable for a given port */
...
/* Get RLM config for a given port */
...
/* Get RLM status for a given port */
