...
typedef enum bcm_custom_stat_trigger_e {
    ...
    bcmDbgCntNum = 177                  /* Must be last one. */
...
typedef enum bcm_stat_group_mode_attr_e {
    ...
    bcmStatGroupModeAttrMaxValue = 30   /* This should be the maximum value
...
/* Create mapping between created class and the combined type Attributes */
...
/* Destroy mapping between created class and the combined type Attributes */
