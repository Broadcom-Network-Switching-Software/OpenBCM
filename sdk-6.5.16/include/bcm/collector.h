...
/* Createa a collector export profile with given export profile info. */
...
/* Gets a collector export profile information with ID. */
extern int bcm_collector_export_profile_get(
    int unit, 
    int export_profile_id, 
    bcm_collector_export_profile_t *export_profile_info);

/* Gets the list of all configured collector export profile IDs. */
...
/* Destroys a collector export profile with ID. */
...
/* Get the list of all collectors configured. */
