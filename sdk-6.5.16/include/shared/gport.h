...
#define _SHR_GPORT_TYPE_FLOW_PORT          44   /* FLOW gport */
#define _SHR_GPORT_TYPE_VPLAG_PORT         45   /* VPLAG gport */
#define _SHR_GPORT_TYPE_MAX _SHR_GPORT_TYPE_VPLAG_PORT   /* Used for sanity */
                                                /*
                                                 * checks only.  
                                                 */
 /*
...
#define _SHR_COSQ_GPORT_TYPE_COMPOSITE_SF2_SCHED 10
...
#define _SHR_COSQ_GPORT_TYPE_COMPOSITE_SF2_CONN  25
#define _SHR_COSQ_GPORT_TYPE_SHARED_SHAPER_ELEM  26
...
#define _SHR_COSQ_GPORT_SCHED_CIR_MASK                  0x3FFFF /* WAS 0xFFFFF */
#define _SHR_COSQ_GPORT_SCHED_CIR_CORE_SHIFT            18
#define _SHR_COSQ_GPORT_SCHED_CIR_CORE_MASK             _SHR_COSQ_GPORT_COMMON_CORE_MASK
#define _SHR_COSQ_GPORT_SCHED_PIR_SHIFT                 0
#define _SHR_COSQ_GPORT_SCHED_PIR_MASK                  0x3FFFF /* WAS 0xFFFFF */
#define _SHR_COSQ_GPORT_SCHED_PIR_CORE_SHIFT            18
...
#define _SHR_COSQ_GPORT_VOQ_CONNECTOR_ID_MASK           0x3FFFF
#define _SHR_GPORT_VOQ_CONNECTOR_CORE_SHIFT             18
...
#define _SHR_COSQ_GPORT_COMPOSITE_SF2_CORE_SHIFT        18
...
#define _SHR_COSQ_GPORT_SHARED_SHAPER_ELEM_FLOW_SHIFT        0
#define _SHR_COSQ_GPORT_SHARED_SHAPER_ELEM_FLOW_MASK         0x3FFFF
#define _SHR_COSQ_GPORT_SHARED_SHAPER_ELEM_CORE_SHIFT        18
#define _SHR_COSQ_GPORT_SHARED_SHAPER_ELEM_CORE_MASK         _SHR_COSQ_GPORT_COMMON_CORE_MASK
...
#define _SHR_COSQ_GPORT_IS_COMPOSITE_SF2(_gport) \
        (_SHR_GPORT_IS_COSQ(_gport) &&                                                 \
        ((((_gport) >> _SHR_COSQ_GPORT_TYPE_SHIFT) & _SHR_COSQ_GPORT_TYPE_MASK) ==     \
                                                _SHR_COSQ_GPORT_TYPE_COMPOSITE_SF2_SCHED || \
        ((((_gport) >> _SHR_COSQ_GPORT_TYPE_SHIFT) & _SHR_COSQ_GPORT_TYPE_MASK) ==     \
         _SHR_COSQ_GPORT_TYPE_COMPOSITE_SF2_CONN )))
...
#define _SHR_COSQ_GPORT_RESERVED_TYPE_GET(_gport) \
    (((((_gport) >> _SHR_COSQ_GPORT_TYPE_SHIFT) & _SHR_COSQ_GPORT_TYPE_MASK) == _SHR_COSQ_GPORT_TYPE_COMPOSITE_SF2_CONN) ? \
     _SHR_COSQ_GPORT_RESERVED_VOQ_CONNECTOR : _SHR_COSQ_GPORT_RESERVED_SCHEDULER)
...
#define _SHR_COSQ_GPORT_COMPOSITE_SF2_CORE_SET(_gport_sf2, gport, _core_id) \
    if (_SHR_GPORT_IS_SCHEDULER(gport))  { \
        (_gport_sf2) = ((_SHR_GPORT_TYPE_COSQ << _SHR_GPORT_TYPE_SHIFT) |                                       \
                        (_SHR_COSQ_GPORT_TYPE_COMPOSITE_SF2_SCHED << _SHR_COSQ_GPORT_TYPE_SHIFT) |                    \
             ...
             (_gport_sf2) = ((_SHR_GPORT_TYPE_COSQ << _SHR_GPORT_TYPE_SHIFT) |                                       \
                          (_SHR_COSQ_GPORT_TYPE_COMPOSITE_SF2_CONN << _SHR_COSQ_GPORT_TYPE_SHIFT) |                       \
...
#define _SHR_COSQ_GPORT_IS_SHARED_SHAPER_ELEM(_gport)                                  \
        (_SHR_GPORT_IS_COSQ(_gport) &&                                                 \
        ((((_gport) >> _SHR_COSQ_GPORT_TYPE_SHIFT) & _SHR_COSQ_GPORT_TYPE_MASK) ==     \
                                                _SHR_COSQ_GPORT_TYPE_SHARED_SHAPER_ELEM))

#define _SHR_COSQ_GPORT_SHARED_SHAPER_ELEM_SET(_gport, _sched_gport, _core_id)              \
        ((_gport) = (_SHR_GPORT_TYPE_COSQ << _SHR_GPORT_TYPE_SHIFT)   |           \
         (_SHR_COSQ_GPORT_TYPE_SHARED_SHAPER_ELEM << _SHR_COSQ_GPORT_TYPE_SHIFT)   |           \
         ( ((_SHR_GPORT_SCHEDULER_GET(_sched_gport)) & _SHR_COSQ_GPORT_SHARED_SHAPER_ELEM_FLOW_MASK)  << _SHR_COSQ_GPORT_SHARED_SHAPER_ELEM_FLOW_SHIFT) | \
         (((_SHR_CORE_ID2FIELD(_core_id)) & _SHR_COSQ_GPORT_SHARED_SHAPER_ELEM_CORE_MASK) << _SHR_COSQ_GPORT_SHARED_SHAPER_ELEM_CORE_SHIFT) )

#define _SHR_COSQ_GPORT_SHARED_SHAPER_ELEM_FLOW_GET(_gport)                                         \
        (((_gport) >> _SHR_COSQ_GPORT_SHARED_SHAPER_ELEM_FLOW_SHIFT) & _SHR_COSQ_GPORT_SHARED_SHAPER_ELEM_FLOW_MASK)

#define  _SHR_COSQ_GPORT_SHARED_SHAPER_ELEM_CORE_GET(_gport) \
        _SHR_CORE_FIELD2ID((((_gport) >> _SHR_COSQ_GPORT_SHARED_SHAPER_ELEM_CORE_SHIFT) & _SHR_COSQ_GPORT_SHARED_SHAPER_ELEM_CORE_MASK))
