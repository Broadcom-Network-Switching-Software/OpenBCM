...
{        
    ...
    cprimod_decap_ordering_info_entry->seq_reserve_value = 0;
...
{        
    SOC_INIT_FUNC_DEFS;
    if(cprimod_supported_port_speed >= cprimodSupportedSpdCount) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("Parameter is out of range"));
    }
...
{        
    SOC_INIT_FUNC_DEFS;
    if(cprimod_rsvd4_rx_config_field >= cprimodRsvd4RxConfigCount) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("Parameter is out of range"));
    }
...
{        
    SOC_INIT_FUNC_DEFS;
    if(cprimod_rsvd4_tx_config_field >= cprimodRsvd4TxConfigCount) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("Parameter is out of range"));
    }
...
int cprimod_port_rsvd4_rx_frame_optional_config_set(int unit, int port, cprimod_rsvd4_rx_config_field_t field, int value)
{
    ...
    if(SOC_E_NONE != cprimod_rsvd4_rx_config_field_t_validate(field)) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("field validation failed"));
    }
...
int cprimod_port_rsvd4_tx_frame_optional_config_set(int unit, int port, cprimod_rsvd4_tx_config_field_t field, int value)
{
    ...
    if(SOC_E_NONE != cprimod_rsvd4_tx_config_field_t_validate(field)) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("field validation failed"));
    }
...
int cprimod_cpri_rx_control_word_l1_signal_info_get(int unit, int port, cprimod_cpri_cw_l1_protocol_info_t* l1_info)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_cpri_rx_control_word_l1_signal_info_get) {
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_cpri_rx_control_word_l1_signal_info_get(unit, port, l1_info);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("cprimod_cpri_rx_control_word_l1_signal_info_get isn't implemented for driver type"));
    }
...
int cprimod_cpri_port_tx_control_word_set(int unit, int port, const cprimod_cpri_cw_l1_config_info_t* control_info)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_cpri_port_tx_control_word_set) {
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_cpri_port_tx_control_word_set(unit, port, control_info);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("cprimod_cpri_port_tx_control_word_set isn't implemented for driver type"));
    }
...
int cprimod_cpri_tunnel_mode_basic_frame_config_set(int unit, int port, cprimod_direction_t dir, int enable)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_cpri_tunnel_mode_basic_frame_config_set) {
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_cpri_tunnel_mode_basic_frame_config_set(unit, port, dir, enable);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
int cprimod_cpri_port_rx_tunnel_mode_set(int unit, int port, int enable, uint32 payload_size)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_cpri_port_rx_tunnel_mode_set) {
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_cpri_port_rx_tunnel_mode_set(unit, port, enable, payload_size);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
int cprimod_cpri_port_tx_agnostic_mode_set(int unit, int port, int enable, cprimod_agnostic_mode_type_t mode, uint32 payload_size)
{
    ...
    if(NULL != __cprimod__dispatch__[__type__]->f_cprimod_cpri_port_tx_agnostic_mode_set) {
        __rv__ = __cprimod__dispatch__[__type__]->f_cprimod_cpri_port_tx_agnostic_mode_set(unit, port, enable, mode, payload_size);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
