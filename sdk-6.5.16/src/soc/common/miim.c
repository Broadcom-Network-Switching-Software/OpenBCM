                   ...
                   uint32 phy_reg_addr, uint16 phy_wr_data)
{
    ...
    if (soc_feature(unit, soc_feature_cmicx)) {
        return soc_cmicx_miim_operation(unit, TRUE, clause, MIIM_INTERNAL_EXTERNAL_DELAY_INVALID, MIIM_INTERNAL_EXTERNAL_DELAY_INVALID, phy_id,
...
#ifdef BCM_CMICX_SUPPORT
    if (soc_feature(unit, soc_feature_cmicx)) {
        return soc_cmicx_miim_operation(unit, FALSE, clause, MIIM_INTERNAL_EXTERNAL_DELAY_INVALID, MIIM_INTERNAL_EXTERNAL_DELAY_INVALID, phy_id,
...
#ifdef BCM_CMICX_SUPPORT
    if (soc_feature(unit, soc_feature_cmicx)) {
        return soc_cmicx_miim_operation(unit, TRUE, SOC_CLAUSE_22, MIIM_INTERNAL_EXTERNAL_DELAY_INVALID, MIIM_INTERNAL_EXTERNAL_DELAY_INVALID, phy_id,
                        phy_reg_addr, &phy_wr_data);
    }
#endif /* BCM_CMICX_SUPPORT */
#if defined(BCM_TRIDENT_SUPPORT) || defined(BCM_CMICM_SUPPORT)
...
#ifdef BCM_CMICX_SUPPORT
    if (soc_feature(unit, soc_feature_cmicx)) {
        return soc_cmicx_miim_operation(unit, FALSE, SOC_CLAUSE_22, MIIM_INTERNAL_EXTERNAL_DELAY_INVALID, MIIM_INTERNAL_EXTERNAL_DELAY_INVALID, phy_id,
                        phy_reg_addr, phy_rd_data);
    }
#endif /* BCM_CMICX_SUPPORT */
...
#ifdef BCM_CMICX_SUPPORT
        if (soc_feature(unit, soc_feature_cmicx)) {
            return soc_cmicx_miim_operation(unit, TRUE, SOC_CLAUSE_45, MIIM_INTERNAL_EXTERNAL_DELAY_INVALID, MIIM_INTERNAL_EXTERNAL_DELAY_INVALID, phy_id,
...
#ifdef BCM_CMICX_SUPPORT
        if (soc_feature(unit, soc_feature_cmicx)) {
            return soc_cmicx_miim_operation(unit, FALSE, SOC_CLAUSE_45, MIIM_INTERNAL_EXTERNAL_DELAY_INVALID, MIIM_INTERNAL_EXTERNAL_DELAY_INVALID, phy_id,
