...
#ifdef PORTMOD_PM4X10_QTC_SUPPORT
    /*pm4x10_qtc dirver includes pm4x10_qtc and pm4x10 init.*/
...
int _portmod_os_ilkn_add(int unit, const portmod_pm_create_info_t *pm_add_info)
{
    ...
    os_ilkn_create_info.pm_specific_info.os_ilkn.ilkn_core_lane_map_get = pm_add_info->pm_specific_info.os_ilkn.ilkn_core_lane_map_get;
