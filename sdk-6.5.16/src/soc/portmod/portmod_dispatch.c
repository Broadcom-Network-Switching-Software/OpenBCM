...
int portmod_pm8x50_fabric_create_info_t_init(int unit, portmod_pm8x50_fabric_create_info_t* portmod_pm8x50_fabric_create_info)
{
    ...
    portmod_pm8x50_fabric_create_info->force_single_pll = 0;
...
int portmod_ilkn_os_create_info_t_init(int unit, portmod_ilkn_os_create_info_t* portmod_ilkn_os_create_info)
{
    ...
    portmod_ilkn_os_create_info->ilkn_core_lane_map_get = NULL;
...
int portmod_core_add(int unit, int pm_id, const portmod_port_add_info_t* add_info)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_core_add) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_from_pm_id_get(unit, pm_id, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_core_add(unit, pm_id, pm_info, add_info);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
int portmod_pm_enable(int unit, int pm_id, int enable)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_pm_enable) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_from_pm_id_get(unit, pm_id, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_pm_enable(unit, pm_id, pm_info, enable);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
...
#ifdef CPRIMOD_SUPPORT
int portmod_cpri_port_rx_cw_l1_signal_info_get(int unit, int port, portmod_cpri_cw_l1_protocol_info_t* l1_info)
{
    ...
    if(l1_info == NULL) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("l1_info NULL parameter"));
    }
    /* Dispatch */
    _SOC_IF_ERR_EXIT(portmod_port_pm_type_get(unit, port, &port, &__type__));
    if(__type__ >= portmodDispatchTypeCount) { 
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_cpri_port_rx_cw_l1_signal_info_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_cpri_port_rx_cw_l1_signal_info_get(unit, port, pm_info, l1_info);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_cpri_port_rx_cw_l1_signal_info_get isn't implemented for driver type"));
    }
...
#ifdef CPRIMOD_SUPPORT
int portmod_cpri_port_tx_cw_l1_config_set(int unit, int port, const portmod_cpri_cw_l1_config_info_t* control_info)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_cpri_port_tx_cw_l1_config_set) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_cpri_port_tx_cw_l1_config_set(unit, port, pm_info, control_info);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_cpri_port_tx_cw_l1_config_set isn't implemented for driver type"));
    }
...
#ifdef CPRIMOD_SUPPORT
int portmod_cpri_port_interrupt_process(int unit, int port)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_cpri_port_interrupt_process) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_cpri_port_interrupt_process(unit, port, pm_info);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_cpri_port_interrupt_process isn't implemented for driver type"));
    }
...
#ifdef CPRIMOD_SUPPORT
int portmod_cpri_port_ecc_interrupt_status_get(int unit, int port, const portmod_cpri_ecc_intr_info_t* ecc_err_info)
{
    ...
    if(NULL != __portmod__dispatch__[__type__]->f_portmod_cpri_port_ecc_interrupt_status_get) {
        pm_info_t pm_info;
        _SOC_IF_ERR_EXIT(portmod_pm_info_get(unit, port, &pm_info));
        __rv__ = __portmod__dispatch__[__type__]->f_portmod_cpri_port_ecc_interrupt_status_get(unit, port, pm_info, ecc_err_info);
        _SOC_IF_ERR_EXIT(__rv__);
    } else { 
        _SOC_EXIT_WITH_ERR(SOC_E_UNAVAIL, ("portmod_cpri_port_ecc_interrupt_status_get isn't implemented for driver type"));
    }
