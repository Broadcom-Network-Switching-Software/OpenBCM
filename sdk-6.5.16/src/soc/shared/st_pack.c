...
shr_st_msg_ctrl_init_unpack(uint8 *buf, shr_st_msg_ctrl_init_t *msg)
{
    ...
    _SHR_UNPACK_U32(buf, msg->init_time_u);
    _SHR_UNPACK_U32(buf, msg->init_time_l);
    _SHR_UNPACK_U16(buf, msg->max_export_pkt_length);
    _SHR_UNPACK_U16(buf, msg->num_instances);
    _SHR_UNPACK_U16(buf, msg->num_collectors);
 ...
 */
uint8*
shr_st_msg_ctrl_collector_create_pack(uint8* buf, shr_st_msg_ctrl_collector_create_t *msg)
{
    int i;
 ...
 */
uint8*
shr_st_msg_ctrl_collector_create_unpack(uint8* buf, shr_st_msg_ctrl_collector_create_t *msg)
{
    int i;
    ...
    _SHR_UNPACK_U16(buf, msg->num_port_in_pkt);
