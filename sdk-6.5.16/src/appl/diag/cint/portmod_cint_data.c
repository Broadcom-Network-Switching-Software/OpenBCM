...
__cint_fpointer__portmod_mac_soft_reset_f(int unit, int port, portmod_call_back_action_type_t action)
{
    ...
    cint_interpreter_callback(__cint_function_pointers+2, 3, 1, &unit, &port, &action, &returnval);
    return returnval;
}
...
__cint_fpointer__portmod_phy_external_reset_f(int unit, int port, uint32 in_reset)
{
    ...
    cint_interpreter_callback(__cint_function_pointers+3, 3, 1, &unit, &port, &in_reset, &returnval);
    return returnval;
}
...
__cint_fpointer__portmod_egress_buffer_reset_f(int unit, int port)
{
    ...
    cint_interpreter_callback(__cint_function_pointers+4, 2, 1, &unit, &port, &returnval);
    return returnval;
}
...
__cint_maddr__portmod_pm8x50_fabric_create_info_t(void* p, int mnum, cint_struct_type_t* parent)
{
    ...
    switch(mnum)
    {
        ...
        case 11: rv = &(s->is_rx_ctrl_bypass_supported);break;
        default: rv = NULL; break;
    }
    return rv;
}
