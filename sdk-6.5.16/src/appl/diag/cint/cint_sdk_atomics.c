 ...
 */           
        ...
        { "int32", "int32_t", 0, 0 }, 
#ifdef INCLUDE_XFLOW_MACSEC
        { "uint32", "xflow_macsec_secure_chan_id_t", 0, 0 }, 
        { "int", "XFLOW_MACSEC_CRYPTO_NONE", 0, 0 },
        { "int", "XFLOW_MACSEC_CRYPTO_AES_128_GCM", 0, 0 },
        { "int", "XFLOW_MACSEC_CRYPTO__COUNT", 0, 0 },
        { "int", "xflowMacsecCryptoAes128GcmIntegrityOnly", 0, 0 },
        { "int", "xflowMacsecCryptoAes128Gcm", 0, 0 },
        { "int", "xflowMacsecCryptoAes128GcmXpnIntegrityOnly", 0, 0 },
        { "int", "xflowMacsecCryptoAes128GcmXpn", 0, 0 },
        { "int", "xflowMacsecCryptoCount", 0, 0 },
        { "int", "xflowMacsecMtu0", 0, 0 },
        { "int", "xflowMacsecMtu1", 0, 0 },
        { "int", "xflowMacsecMtu2", 0, 0 },
        { "int", "xflowMacsecMtu3", 0, 0 },
        { "int", "xflowMacsecMtuCount", 0, 0 },
        { "int", "xflowMacsecSecTagEtype0", 0, 0 },
        { "int", "xflowMacsecSecTagEtype1", 0, 0 },
        { "int", "xflowMacsecSecTagEtype2", 0, 0 },
        { "int", "xflowMacsecSecTagEtype3", 0, 0 },
        { "int", "xflowMacsecSecTagEtypeCount", 0, 0 },
        { "int", "xflow_macsec_crypto_t", 0, 0 },
        { "int", "xflow_macsec_mtu_t", 0, 0 },
        { "int", "xflow_macsec_sectag_ethertype_t", 0, 0 },
        { "uint32", "xflow_macsec_secure_chan_id_t", 0, 0 },
        { "uint32", "xflow_macsec_secure_assoc_num_t", 0, 0 },
        { "uint32", "xflow_macsec_secure_assoc_id_t", 0, 0 },
        { "int", "xflowMacsecSecureAssocAnNormal", 0, 0 },
        { "int", "xflowMacsecSecureAssocAnRollover", 0, 0 },
        { "int", "xflowMacsecSecureAssocAnAuto", 0, 0 },
        { "int", "xflowMacsecSecureAssocAnCount", 0, 0 },
        { "int", "xflow_macsec_secure_assoc_an_control_t", 0, 0 },
        { "uint32", "xflow_macsec_policy_id_t", 0, 0 },
        { "uint32", "xflow_macsec_flow_id_t", 0, 0 },
        { "uint32", "xflow_macsec_instance_id_t", 0, 0 },
        { "uint32", "xflow_macsec_flow_info_t", 0, 0 },
        { "uint32", "xflow_macsec_mac_addr_info_t", 0, 0 },
        { "int", "xflowMacsecDecyptFlowAny", 0, 0 },
        { "int", "xflowMacsecDecyptFlowNonMacsec", 0, 0 },
        { "int", "xflowMacsecDecyptFlowMacSec", 0, 0 },
        { "int", "xflowMacsecDecyptFlowManagement", 0, 0 },
        { "int", "xflowMacsecDecyptFlowKay", 0, 0 },
        { "int", "xflowMacsecDecyptFlowCount", 0, 0 },
        { "int", "xflowMacsecFlowEtypeAny", 0, 0 },
        { "int", "xflowMacsecFlowEtypeEII", 0, 0 },
        { "int", "xflowMacsecFlowEtypeSnap", 0, 0 },
        { "int", "xflowMacsecFlowEtypeLlc", 0, 0 },
        { "int", "xflowMacsecFlowEtypeMpls", 0, 0 },
        { "int", "xflowMacsecFlowEtypeCount", 0, 0 },
        { "uint32", "xflow_macsec_subport_num_t", 0, 0 },
        { "int", "xflow_macsec_flow_pkt_type_t", 0, 0 },
        { "int", "xflow_macsec_flow_etype_t", 0, 0 },
        { "int", "xflowMacsecTagAny", 0, 0 },
        { "int", "xflowMacsecTagUntaggedVlan", 0, 0 },
        { "int", "xflowMacsecTagSingleVlan", 0, 0 },
        { "int", "xflowMacsecTagDoubleVlan", 0, 0 },
        { "int", "xflowMacsecTagOneMplsLabel", 0, 0 },
        { "int", "xflowMacsecTagTwoMplsLabel", 0, 0 },
        { "int", "xflowMacsecTagThreeMplsLabel", 0, 0 },
        { "int", "xflowMacsecTagCount", 0, 0 },
        { "int", "xflow_macsec_vlan_mpls_tag_status_t", 0, 0 },
        { "int", "xflowMacsecControlDecryptPadThreshold", 0, 0 },
        { "int", "xflowMacsecControlDecryptSectagC1E0Error", 0, 0 },
        { "int", "xflowMacsecControlDecryptFailSwitchToCpu", 0, 0 },
        { "int", "xflowMacsecControlEncryptFailSwitchToCpu", 0, 0 },
        { "int", "xflowMacsecControlCount", 0, 0 },
        { "int", "xflow_macsec_control_t", 0, 0 },
        { "int", "xflow_macsec_mac_addr_control_t", 0, 0 },
        { "int", "xflowMacsecStatTypeInvalid", 0, 0 },
        { "int", "xflowMacsecUnctrlPortInOctets", 0, 0 },
        { "int", "xflowMacsecUnctrlPortInUcastPkts", 0, 0 },
        { "int", "xflowMacsecUnctrlPortInMulticastPkts", 0, 0 },
        { "int", "xflowMacsecUnctrlPortInBroadcastPkts", 0, 0 },
        { "int", "xflowMacsecUnctrlPortInDiscards", 0, 0 },
        { "int", "xflowMacsecUnctrlPortOutOctets", 0, 0 },
        { "int", "xflowMacsecUnctrlPortOutUcastPkts", 0, 0 },
        { "int", "xflowMacsecUnctrlPortOutMulticastPkts", 0, 0 },
        { "int", "xflowMacsecUnctrlPortOutBroadcastPkts", 0, 0 },
        { "int", "xflowMacsecUnctrlPortOutErrors", 0, 0 },
        { "int", "xflowMacsecCtrlPortInOctets", 0, 0 },
        { "int", "xflowMacsecCtrlPortInUcastPkts", 0, 0 },
        { "int", "xflowMacsecCtrlPortInMulticastPkts", 0, 0 },
        { "int", "xflowMacsecCtrlPortInBroadcastPkts", 0, 0 },
        { "int", "xflowMacsecCtrlPortInDiscards", 0, 0 },
        { "int", "xflowMacsecCtrlPortInErrors", 0, 0 },
        { "int", "xflowMacsecCtrlPortOutOctets", 0, 0 },
        { "int", "xflowMacsecCtrlPortOutUcastPkts", 0, 0 },
        { "int", "xflowMacsecCtrlPortOutMulticastPkts", 0, 0 },
        { "int", "xflowMacsecCtrlPortOutBroadcastPkts", 0, 0 },
        { "int", "xflowMacsecCtrlPortOutErrors", 0, 0 },
        { "int", "xflowMacsecSecyStatsTxUntaggedPkts", 0, 0 },
        { "int", "xflowMacsecSecyStatsTxTooLongPkts", 0, 0 },
        { "int", "xflowMacsecSecyStatsRxUntaggedPkts", 0, 0 },
        { "int", "xflowMacsecSecyStatsRxNoTagPkts", 0, 0 },
        { "int", "xflowMacsecSecyStatsRxBadTagPkts", 0, 0 },
        { "int", "xflowMacsecSecyStatsRxUnknownSCIPkts", 0, 0 },
        { "int", "xflowMacsecSecyStatsRxNoSCIPkts", 0, 0 },
        { "int", "xflowMacsecSecyStatsRxOverrunPkts", 0, 0 },
        { "int", "xflowMacsecSecyTxSCStatsProtectedPkts", 0, 0 },
        { "int", "xflowMacsecSecyTxSCStatsEncryptedPkts", 0, 0 },
        { "int", "xflowMacsecSecyTxSCStatsOctetsProtected", 0, 0 },
        { "int", "xflowMacsecSecyTxSCStatsOctetsEncrypted", 0, 0 },
        { "int", "xflowMacsecSecyRxSCStatsUnusedSAPkts", 0, 0 },
        { "int", "xflowMacsecSecyRxSCStatsNotUsingSAPkts", 0, 0 },
        { "int", "xflowMacsecSecyRxSCStatsLatePkts", 0, 0 },
        { "int", "xflowMacsecSecyRxSCStatsNotValidPkts", 0, 0 },
        { "int", "xflowMacsecSecyRxSCStatsInvalidPkts", 0, 0 },
        { "int", "xflowMacsecSecyRxSCStatsDelayedPkts", 0, 0 },
        { "int", "xflowMacsecSecyRxSCStatsUncheckedPkts", 0, 0 },
        { "int", "xflowMacsecSecyRxSCStatsOKPkts", 0, 0 },
        { "int", "xflowMacsecSecyRxSCStatsOctetsValidated", 0, 0 },
        { "int", "xflowMacsecSecyRxSCStatsOctetsValidated", 0, 0 },
        { "int", "xflowMacsecSecyRxSCStatsOctetsDecrypted", 0, 0 },
        { "int", "xflowMacsecSecyTxSAStatsProtectedPkts", 0, 0 },
        { "int", "xflowMacsecSecyTxSAStatsEncryptedPkts", 0, 0 },
        { "int", "xflowMacsecSecyRxSAStatsUnusedSAPkts", 0, 0 },
        { "int", "xflowMacsecSecyRxSAStatsNotUsingSAPkts", 0, 0 },
        { "int", "xflowMacsecSecyRxSAStatsNotValidPkts", 0, 0 },
        { "int", "xflowMacsecSecyRxSAStatsInvalidPkts", 0, 0 },
        { "int", "xflowMacsecSecyRxSAStatsOKPkts", 0, 0 },
        { "int", "xflowMacsecInMgmtPkts", 0, 0 },
        { "int", "xflowMacsecFlowTcamHitCntr", 0, 0 },
        { "int", "xflowMacsecFlowTcamMissCntr", 0, 0 },
        { "int", "xflowMacsecScTcamHitCntr", 0, 0 },
        { "int", "xflowMacsecScTcamMissCntr", 0, 0 },
        { "int", "xflowMacsecOutMgmtPkts", 0, 0 },
        { "int", "xflowMacsecInPacketDropCntr", 0, 0 },
        { "int", "xflowMacsecOutPacketDropCntr", 0, 0 },
        { "int", "xflowMacsecBadOlpHdrCntr", 0, 0 },
        { "int", "xflowMacsecStatTypeCount", 0, 0 },
        { "int", "xflow_macsec_stat_type_t", 0, 0 },
        { "uint32", "xflow_macsec_id_t", 0, 0 },
#endif
#ifdef CPRIMOD_SUPPORT
...
#ifdef INCLUDE_XFLOW_MACSEC
static void*
__cint_maddr_xflow_macsec_secure_chan_info_t(void* p, int mnum, cint_struct_type_t* parent)
{
    void* rv;
    xflow_macsec_secure_chan_info_t *s = (xflow_macsec_secure_chan_info_t*) p;

    switch(mnum)
        {
        case 0: rv = &(s->sci); break;
        case 1: rv = &(s->crypto); break;
        case 2: rv = &(s->confidentiality_offset); break;
        case 3: rv = &(s->active_an); break;
        case 4: rv = &(s->flags); break;
        case 5: rv = &(s->tci); break;
        case 6: rv = &(s->sectag_offset); break;
        case 7: rv = &(s->mtu_sel); break;
        case 8: rv = &(s->sectag_etype_sel); break;
        case 9: rv = &(s->sci_mask); break;
        case 10: rv = &(s->replay_protect_window_size); break;
        case 11: rv = &(s->policy_id); break;
        case 12: rv = &(s->first_auth_range_offset_start); break;
        case 13: rv = &(s->first_auth_range_offset_end); break;
        default: rv = NULL; break;
    }
...
static void*
__cint_maddr_xflow_macsec_mac_addr_info_t(void* p, int mnum, cint_struct_type_t* parent)
{
    void* rv;
    xflow_macsec_mac_addr_info_t *s = (xflow_macsec_mac_addr_info_t*) p;

    switch(mnum)
        {
        case 0: rv = &(s->mac_addr); break;
        default: rv = NULL; break;
    }
...
static cint_parameter_desc_t __cint_struct_members_xflow_macsec_secure_chan_info_t[] =
{
        { "uint64", "sci", 0, 0 },
        { "xflow_macsec_crypto_t", "crypto", 0, 0 },
        { "uint32", "confidentiality_offset", 0, 0 },
        { "uint32", "active_an", 0, 0 },
        { "uint32", "flags", 0, 0 },
        { "uint8", "tci", 0, 0 },
        { "uint32", "sectag_offset", 0, 0 },
        { "xflow_macsec_mtu_t", "mtu_sel", 0, 0 },
        { "xflow_macsec_sectag_ethertype_t", "sectag_etype_sel", 0, 0 },
        { "uint64", "sci_mask", 0, 0 },
        { "uint32", "replay_protect_window_size", 0, 0 },
        { "xflow_macsec_policy_id_t", "policy_id", 0, 0 },
        { "uint8", "first_auth_range_offset_start", 0, 0 },
        { "uint8", "first_auth_range_offset_end", 0, 0 },
        { NULL }
};

static cint_parameter_desc_t __cint_struct_members_xflow_macsec_mac_addr_info_t[] =
{
        { "bcm_mac_t", "mac_addr", 0, 0 },
        { NULL }
};

static void*
__cint_maddr_xflow_macsec_crypto_aes128_gcm_t(void* p, int mnum, cint_struct_type_t* parent)
{
    void* rv;
    xflow_macsec_crypto_aes128_gcm_t *s = (xflow_macsec_crypto_aes128_gcm_t *) p;
...
static cint_parameter_desc_t __cint_struct_members_xflow_macsec_crypto_aes128_gcm_t[] =
{
        { "uint8", "key", 0, 16 },
        { NULL }
};
...
static void*
__cint_maddr_xflow_macsec_secure_assoc_info_t(void* p, int mnum, cint_struct_type_t* parent)
{
    void* rv;
    xflow_macsec_secure_assoc_info_t *s = (xflow_macsec_secure_assoc_info_t *) p;

    switch(mnum)
        {
        case 0: rv = &(s->an); break;
        case 1: rv = &(s->aes); break;
        case 2: rv = &(s->an_control); break;
        case 3: rv = &(s->next_pkt_num); break;
        case 4: rv = &(s->next_pkt_num_upper); break;
        case 5: rv = &(s->salt); break;
        case 6: rv = &(s->ssci); break;
...
static cint_parameter_desc_t __cint_struct_members_xflow_macsec_secure_assoc_info_t[] =
{
        { "xflow_macsec_secure_assoc_num_t", "an", 0, 0 },
        { "xflow_macsec_crypto_aes128_gcm_t", "aes", 0, 0 },
        { "xflow_macsec_secure_assoc_an_control_t", "an_control", 0, 0 },
        { "uint32", "next_pkt_num", 0, 0 },
        { "uint32", "next_pkt_num_upper", 0, 0 },
        { "uint8", "salt", 0, 12 },
        { "uint32", "ssci", 0, 0 },
        { "uint32", "flags", 0, 0 },
        { NULL }
...
static void*
__cint_maddr_xflow_macsec_policy_info_t(void* p, int mnum, cint_struct_type_t* parent)
{
    void* rv;
    xflow_macsec_policy_info_t *s = (xflow_macsec_policy_info_t *) p;

    switch(mnum)
        {
        case 0: rv = &(s->flags); break;
        case 1: rv = &(s->sectag_offset); break;
        case 2: rv = &(s->sci); break;
        case 3: rv = &(s->mtu_sel); break;
        case 4: rv = &(s->etype_sel); break;
        default: rv = NULL; break;
    }
...
static cint_parameter_desc_t __cint_struct_members_xflow_macsec_policy_info_t[] =
{
        { "uint32", "flags", 0, 0 },
        { "uint32", "sectag_offset", 0, 0 },
        { "uint64", "sci", 0, 0 },
        { "xflow_macsec_mtu_t", "mtu_sel", 0, 0 },
        { "xflow_macsec_sectag_ethertype_t", "etype_sel", 0, 0 },
        { NULL }
};

static void*
__cint_maddr_xflow_macsec_flow_info_t(void* p, int mnum, cint_struct_type_t* parent)
{
    void* rv;
    xflow_macsec_flow_info_t *s = (xflow_macsec_flow_info_t *) p;

    switch(mnum)
        {
        case 0: rv = &(s->flags); break;
        case 1: rv = &(s->pkt_type); break;
        case 2: rv = &(s->tpid); break;
        case 3: rv = &(s->tpid_mask); break;
        case 4: rv = &(s->vlan_mpls_tag_status); break;
        case 5: rv = &(s->etype_sel); break;
        case 6: rv = &(s->src_mac); break;
        case 7: rv = &(s->src_mac_mask); break;
        case 8: rv = &(s->dst_mac); break;
        case 9: rv = &(s->dst_mac_mask); break;
        case 10: rv = &(s->src_port); break;
        case 11: rv = &(s->src_port_mask); break;
        case 12: rv = &(s->udf); break;
        case 13: rv = &(s->udf_mask); break;
        case 14: rv = &(s->policy_id); break;
        case 15: rv = &(s->set_management_pkt); break;
        default: rv = NULL; break;
    }
...
static void*
__cint_maddr_xflow_macsec_vlan_tpid_t(void* p, int mnum, cint_struct_type_t* parent)
{
    void* rv;
    xflow_macsec_vlan_tpid_t *s = (xflow_macsec_vlan_tpid_t *) p;

    switch(mnum)
        {
        case 0: rv = &(s->enable); break;
        case 1: rv = &(s->tpid); break;
        default: rv = NULL; break;
    }
...
static cint_parameter_desc_t __cint_struct_members_xflow_macsec_flow_info_t[] =
{
        { "uint32", "flags", 0, 0 },
        { "xflow_macsec_flow_pkt_type_t", "pkt_type", 0, 0 },
        { "uint32", "tpid", 0, 0 },
        { "uint32", "tpid_mask", 0, 0 },
        { "xflow_macsec_vlan_mpls_tag_status_t", "vlan_mpls_tag_status", 0, 0 },
        { "xflow_macsec_flow_etype_t", "etype_sel", 0, 0 },
        { "bcm_mac_t", "src_mac", 0, 0 },
        { "bcm_mac_t", "src_mac_mask", 0, 0 },
        { "bcm_mac_t", "dst_mac", 0, 0 },
        { "bcm_mac_t", "dst_mac_mask", 0, 0 },
        { "bcm_port_t", "src_port", 0, 0 },
        { "uint32", "src_port_mask", 0, 0 },
        { "xflow_macsec_flow_udf_param_t", "udf", 0, 0 },
        { "xflow_macsec_flow_udf_param_t", "udf_mask", 0, 0 },
        { "xflow_macsec_policy_id_t", "policy_id", 0, 0 },
        { "uint8", "set_management_pkt", 0, 0 },
        { NULL }
};

static cint_parameter_desc_t __cint_struct_members_xflow_macsec_vlan_tpid_t[] =
{
        { "int", "enable", 0, 4 },
        { "uint32", "tpid", 0, 4 },
        { NULL }
...
static void*
__cint_maddr_xflow_macsec_flow_info_mpls_t(void* p, int mnum, cint_struct_type_t* parent)
{
    void* rv;
    xflow_macsec_flow_info_mpls_t *s = (xflow_macsec_flow_info_mpls_t *) p;

    switch(mnum)
        {
        case 0: rv = &(s->mpls_label); break;
        case 1: rv = &(s->mpls_exp); break;
        default: rv = NULL; break;
    }
...
static cint_parameter_desc_t __cint_struct_members_xflow_macsec_flow_info_mpls_t[] =
{
        { "bcm_mpls_label_t", "mpls_label", 0, 0 },
        { "uint8", "mpls_exp", 0, 0 },
        { NULL }
};

static void*
__cint_maddr_xflow_macsec_flow_udf_param_t(void* p, int mnum, cint_struct_type_t* parent)
{
    void* rv;
    xflow_macsec_flow_udf_param_t *s = (xflow_macsec_flow_udf_param_t *) p;

    switch(mnum)
        {
        case 0: rv = &(s->ethertype); break;
        case 1: rv = &(s->first_vlan); break;
        case 2: rv = &(s->first_vlan_priority); break;
        case 3: rv = &(s->second_vlan); break;
        case 4: rv = &(s->second_vlan_priority); break;
        case 5: rv = &(s->first_mpls); break;
        case 6: rv = &(s->second_mpls); break;
        case 7: rv = &(s->payload); break;
        default: rv = NULL; break;
    }
...
static cint_parameter_desc_t __cint_struct_members_xflow_macsec_flow_udf_param_t[] =
{
        { "uint32", "ethertype", 0, 0 },
        { "bcm_vlan_t", "first_vlan", 0, 0 },
        { "uint8", "first_vlan_priority", 0, 0 },
        { "bcm_vlan_t", "second_vlan", 0, 0 },
        { "uint8", "second_vlan_priority", 0, 0 },
        { "xflow_macsec_flow_info_mpls_t", "first_mpls", 0, 0 },
        { "xflow_macsec_flow_info_mpls_t", "second_mpls", 0, 0 },
        { "uint8", "payload", 0, 64 },
        { NULL }
};
...
static void*
__cint_maddr__shr_cpri_cw_l1_protocol_info_t(void* p, int mnum,
                                             cint_struct_type_t* parent)
{
    void* rv;
    _shr_cpri_cw_l1_protocol_info_t* s = (_shr_cpri_cw_l1_protocol_info_t*) p;

    switch(mnum)
        {
        case 0: rv = &(s->protocol_ver); break;
        case 1: rv = &(s->hdlc_rate); break;
        case 2: rv = &(s->reset); break;
        case 3: rv = &(s->l1_lof); break;
        case 4: rv = &(s->l1_los); break;
        case 5: rv = &(s->l1_sdi); break;
        case 6: rv = &(s->l1_rai); break;
        case 7: rv = &(s->eth_pointer); break;
        default: rv = NULL; break;
    }
...
static cint_parameter_desc_t
       __cint_struct_members__shr_cpri_cw_l1_protocol_info_t[] =
{
...
static void*
__cint_maddr__shr_cpri_cw_l1_config_info_t(void* p, int mnum,
                                           cint_struct_type_t* parent)
{
    void* rv;
    _shr_cpri_cw_l1_config_info_t* s = (_shr_cpri_cw_l1_config_info_t*) p;
...
static cint_parameter_desc_t
       __cint_struct_members__shr_cpri_cw_l1_config_info_t[] =
{
    { "uint32", "enet_ptr", 0, 0 },
    { "uint32", "l1_fun", 0, 0 },
    { "uint32", "hdlc_rate", 0, 0 },
...
cint_struct_type_t __cint_sdk_structures[] = 
    {
...
#ifdef INCLUDE_XFLOW_MACSEC
        {
            ...
            sizeof(xflow_macsec_secure_chan_info_t),
            __cint_struct_members_xflow_macsec_secure_chan_info_t,
            __cint_maddr_xflow_macsec_secure_chan_info_t
        },
        {
            "xflow_macsec_crypto_aes128_gcm_t",
            sizeof(xflow_macsec_crypto_aes128_gcm_t),
            __cint_struct_members_xflow_macsec_crypto_aes128_gcm_t,
            __cint_maddr_xflow_macsec_crypto_aes128_gcm_t
        },
        {
            "xflow_macsec_secure_assoc_info_t",
            sizeof(xflow_macsec_secure_assoc_info_t),
            __cint_struct_members_xflow_macsec_secure_assoc_info_t,
            __cint_maddr_xflow_macsec_secure_assoc_info_t
        },
        {
            "xflow_macsec_policy_info_t",
            sizeof(xflow_macsec_policy_info_t),
            __cint_struct_members_xflow_macsec_policy_info_t,
            __cint_maddr_xflow_macsec_policy_info_t
        },
        {
            "xflow_macsec_flow_info_t",
            sizeof(xflow_macsec_flow_info_t),
            __cint_struct_members_xflow_macsec_flow_info_t,
            __cint_maddr_xflow_macsec_flow_info_t
        },
        {
            "xflow_macsec_vlan_tpid_t",
            sizeof(xflow_macsec_vlan_tpid_t),
            __cint_struct_members_xflow_macsec_vlan_tpid_t,
            __cint_maddr_xflow_macsec_vlan_tpid_t
        },
        {
            "xflow_macsec_mac_addr_info_t",
            sizeof(xflow_macsec_mac_addr_info_t),
            __cint_struct_members_xflow_macsec_mac_addr_info_t,
            __cint_maddr_xflow_macsec_mac_addr_info_t
        },
        {
            "xflow_macsec_flow_info_mpls_t",
            sizeof(xflow_macsec_flow_info_mpls_t),
            __cint_struct_members_xflow_macsec_flow_info_mpls_t,
            __cint_maddr_xflow_macsec_flow_info_mpls_t
        },
        {
            "xflow_macsec_flow_udf_param_t",
            sizeof(xflow_macsec_flow_udf_param_t),
            __cint_struct_members_xflow_macsec_flow_udf_param_t,
            __cint_maddr_xflow_macsec_flow_udf_param_t
        },
#endif
#ifdef CPRIMOD_SUPPORT
        {
        ...
        },
        {
            ...
            sizeof(_shr_cpri_cw_l1_protocol_info_t),
            __cint_struct_members__shr_cpri_cw_l1_protocol_info_t,
            __cint_maddr__shr_cpri_cw_l1_protocol_info_t,
        },
        {
...

        {
            ...
            sizeof(_shr_cpri_cw_l1_config_info_t),
            __cint_struct_members__shr_cpri_cw_l1_config_info_t,
            __cint_maddr__shr_cpri_cw_l1_config_info_t,
        },
        {
