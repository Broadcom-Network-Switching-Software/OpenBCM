...
#undef BB_DEBUG
    ...
    if(!sal_strncasecmp(function,"voltage",sal_strlen(function))) {
...
#if defined BCM_APACHE_SUPPORT || defined BCM_HELIX5_SUPPORT
        if ((soc_get_board_id() == G50) || (soc_get_board_id() == G51) ||
		    ...
		    /* Invoke I2C_LTC_IOC_SET_RCONFIG for Helix5 to setup sense_resistor_data */
		    if (soc_get_board_id() == G65) {
