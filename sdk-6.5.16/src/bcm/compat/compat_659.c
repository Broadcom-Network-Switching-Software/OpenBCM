 ...
 */
STATIC void
_bcm_compat659out_vlan_control_vlan_t(bcm_vlan_control_vlan_t *from,
...
{
    int rv;
    bcm_vlan_control_vlan_t *new_vlan_control = NULL;

    if (NULL != control) {
        /* Create from heap to avoid the stack to bloat */
        new_vlan_control = (bcm_vlan_control_vlan_t *)
            sal_alloc(sizeof(bcm_vlan_control_vlan_t), "New vlan control vlan");
    ...
    /* Call the BCM API with new format */
    rv = bcm_vlan_control_vlan_selective_set(unit, vlan, valid_fields,
                                             new_vlan_control);
                                 ...
                                 bcm_compat659_vlan_control_vlan_t *control)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_vlan_control_vlan_selective_get(unit, vlan, valid_fields,
                                             new_vlan_control);
                                              ...
                                              bcm_compat659_vlan_control_vlan_t control)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_vlan_control_vlan_set(unit, vlan, *new_vlan_control);
                                 ...
                                 bcm_compat659_vlan_control_vlan_t *control)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_vlan_control_vlan_get(unit, vlan, new_vlan_control);
