    ...
    if (SOC_IS_TOMAHAWK3(unit)) {
        ...
        switch (type) {
            ...
            case bcmSwitchIntL4DestPort2:
                ...
                break;
            case bcmSwitchIntProbeMarker1:
                field_len = soc_reg_field_length(unit, INT_DETECT_CONFIG_1r, PROBE_MARKER1f);
                COMPILER_64_SET(max_val, 0, (uint32)((1 << field_len) - 1));
                if (COMPILER_64_GT(arg64, max_val)) {
                    rv = BCM_E_PARAM;
                }
                ...
                break;
            case bcmSwitchIntProbeMarker2:
                field_len = soc_reg_field_length(unit, INT_DETECT_CONFIG_2r, PROBE_MARKER2f);
                COMPILER_64_SET(max_val, 0, (uint32)((1 << field_len) - 1));
                if (COMPILER_64_GT(arg64, max_val)) {
                    rv = BCM_E_PARAM;
                }
            ...
            case bcmSwitchIntVersion:
                ...
                break;
            case bcmSwitchIntRequestVectorValue:
                field_len = soc_reg_field_length(unit, INT_REQUEST_VECTOR_CONFIGr, REQUEST_VECTOR_VALUEf);
                COMPILER_64_SET(max_val, 0, (uint32)((1 << field_len) - 1));
                if (COMPILER_64_GT(arg64, max_val)) {
                    rv = BCM_E_PARAM;
                }
                ...
                break;
            case bcmSwitchIntRequestVectorMask:
                field_len = soc_reg_field_length(unit, INT_REQUEST_VECTOR_CONFIGr, REQUEST_VECTOR_MASKf);
                COMPILER_64_SET(max_val, 0, (uint32)((1 << field_len) - 1));
                if (COMPILER_64_GT(arg64, max_val)) {
                    rv = BCM_E_PARAM;
                }
