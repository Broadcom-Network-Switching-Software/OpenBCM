...
STATIC int
_bcm_xgs5_ft_v2_ip_headers_get(bcm_collector_info_t *collector_info,
                               uint16 *etype,
                               shr_ipv4_header_t *ipv4)
{
    int ip_protocol;
                       ...
                       shr_ft_msg_ctrl_collector_create_t *collector_create_msg)
{
    ...
    if (collector_int_info.collector_info.transport_type ==
                     bcmFlowtrackerCollectorTransportTypeIpfixIpv4Udp) {
        BCM_IF_ERROR_RETURN
            (_bcm_xgs5_ft_ip_headers_get(&(collector_int_info.collector_info),
                                          &etype,
                                          &ipv4));
    }
                       ...
                       shr_ft_msg_ctrl_collector_create_t *collector_create_msg)
{
    ...
    if (collector_info.transport_type == bcmCollectorTransportTypeIpv4Udp) {
        BCM_IF_ERROR_RETURN
            (_bcm_xgs5_ft_v2_ip_headers_get(&collector_info,
                                          &etype,
                                          &ipv4));
    }
