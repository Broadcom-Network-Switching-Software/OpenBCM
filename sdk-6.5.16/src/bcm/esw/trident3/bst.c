...
#define SOC_HX5_DOWNLINK_PORTQ_BASE      416
...
#ifdef BCM_HELIX5_SUPPORT
        if (SOC_IS_HELIX5(unit)) {
            if (index > SOC_HX5_DOWNLINK_PORTQ_BASE - 1) {
                index = index - SOC_HX5_DOWNLINK_PORTQ_BASE;
...
bcm_bst_td3_init(int unit)
{
    ...
    _BCM_BST_STAT_INFO2(pres, stat_mem, stat_mem, stat_reg, stat_reg, stat_field);
