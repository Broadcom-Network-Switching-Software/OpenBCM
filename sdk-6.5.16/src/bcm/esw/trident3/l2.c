...
#define _BCM_TD3_EXLATE_CHANGE_L2_FIELDS_KEY_TYPE 0x11
    ...
    uint32 *entry)
{
    ...
    soc_mem_field32_set(unit, mem, entry, KEY_TYPEf,
        _BCM_TD3_EXLATE_CHANGE_L2_FIELDS_KEY_TYPE);
    soc_mem_field32_set(unit, mem, entry, DATA_TYPEf,
        _BCM_TD3_EXLATE_CHANGE_L2_FIELDS_DATA_TYPE);
...
_bcm_td3_l2_change_fields_reinit(int unit)
{
    ...
    for (i = index_min; i <= index_max; i++) {
        ...
        if (entry_type == _BCM_TD3_EXLATE_CHANGE_L2_FIELDS_DATA_TYPE) {
