 ...
 *      BCM_E_XXX
 * Notes:
 *      If 'sample_rate' is specified as 0, monitoring will not be enabled,
                                   ...
                                   bcm_l3_ecmp_dlb_mon_cfg_t *dlb_mon_cfg)
{
     ...
     */
    if ((enable) && (dlb_mon_cfg->sample_rate > 0)) {
 ...
 *    BCM_E_XXX
 * Notes:
 * 1. Sample rates are calculated only if MONITOR_EN is set for a DLB id.
