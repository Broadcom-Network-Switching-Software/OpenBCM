...
/** @file merlin7_tsc_debug_functions.h
...
#ifndef MERLIN7_TSC_DEBUG_FUNCTIONS_H
#define MERLIN7_TSC_DEBUG_FUNCTIONS_H
...
/** Reads current pmd lane status and populates the provided structure of type #merlin7_tsc_detailed_lane_status_st.
 * @param sa__ is an opaque state vector passed through to device access functions.
...
/** Displays the lane status stored in the input struct of type #merlin7_tsc_detailed_lane_status_st.
 * @param sa__ is an opaque state vector passed through to device access functions.
