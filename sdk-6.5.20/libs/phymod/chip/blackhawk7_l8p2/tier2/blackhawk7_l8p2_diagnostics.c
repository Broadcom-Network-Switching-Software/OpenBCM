...
int blackhawk7_l8p2_phy_linkcat(const phymod_phy_access_t* phy, phymod_linkCAT_op_mode_t mode) {
    ...
    return(blackhawk7_l8p2_LinkCat(&phy_acc, &linkcat_config, &linkcat_status));
#else
    return PHYMOD_E_UNAVAIL;
