...
/*********************************************************************************
 *********************************************************************************
 *  File Name  :  blackhawk7_l8p2_functions.h
...
#ifndef BLACKHAWK7_L8P2_API_FUNCTIONS_H
#define BLACKHAWK7_L8P2_API_FUNCTIONS_H
    ...
    do  { \
        *(__ERR) = (expr); \
        if (*(__ERR) != ERR_CODE_NONE) { \
            return blackhawk7_l8p2_error_report(sa__, *(__ERR)); \
        }\
        (void)srds_err_code; \
    }   while(0)
