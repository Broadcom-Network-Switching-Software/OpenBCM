...
/** Returns whether PMD rx lock status changed for current lane since previous invocation of this API
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *pmd_rx_lock_change PMD_RX_LOCK change for current lane returned by API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk_tsc_pmd_lock_change(srds_access_t *sa__, uint8_t *pmd_rx_lock_change);
