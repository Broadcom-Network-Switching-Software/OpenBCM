...
int blackhawk_core_init(const phymod_core_access_t* core, const phymod_core_init_config_t* init_config, const phymod_core_status_t* core_status)
{
    ...
    unsigned short blackhawk_ucode_crc;
    ...
    if (ams_version < 0xc0) {
        ...
        blackhawk_ucode_crc = blackhawk_ucode_crc_rev0;
    } else {
        ...
        blackhawk_ucode_crc = blackhawk_ucode_crc_rev1;
    }
    ucode.crc_value = blackhawk_ucode_crc;
