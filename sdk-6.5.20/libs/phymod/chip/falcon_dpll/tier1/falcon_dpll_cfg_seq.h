...
err_code_t falcon2_monterey_lane_soft_reset_release(const phymod_access_t *pa, uint32_t enable);   /* pmd core soft reset */
...
err_code_t falcon2_monterey_rx_squelch_set(const phymod_access_t *pc, int enable);
err_code_t falcon2_monterey_rx_squelch_get(const phymod_access_t *pc, int* enable);
err_code_t falcon2_monterey_tx_squelch_set(const phymod_access_t *pc, int enable);
err_code_t falcon2_monterey_tx_squelch_get(const phymod_access_t *pc, int* enable);
