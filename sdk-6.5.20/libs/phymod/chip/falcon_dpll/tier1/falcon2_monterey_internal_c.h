...
*  Revision      :  $Id: falcon2_monterey_internal.c 1575 2017-11-09 20:25:47Z kirand $ *
*                                                                                 *
...
static char* _error_val_2_str (const phymod_access_t *pa, uint8_t val){
	...
	case INVALID_VCO_RATE_REQUEST:
		return ("INVALID_VCO_RATE_REQUEST");
...
SDK_STATIC err_code_t _falcon2_monterey_read_core_state (const phymod_access_t *pa, falcon2_monterey_core_state_st *istate){
	...
	EFUN(falcon2_monterey_version(pa, &state.api_version));
