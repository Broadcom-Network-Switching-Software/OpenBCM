...
/**************************************************************************************
 **************************************************************************************
 *  File Name     :  blackhawk7_v1l8p1_field_access.h                                        *
...
/** @file blackhawk7_v1l8p1_field_access.h
...
#ifndef BLACKHAWK7_V1L8P1_API_FIELD_ACCESS_H
#define BLACKHAWK7_V1L8P1_API_FIELD_ACCESS_H
...
/*---------------------------------------------------------------------------------------------------*/
/* "Serdes ACCess" (_acc_) API dependency "wrapper" functions for blackhawk7_v1l8p1_dependencies.c          */
 ...
 * NOTE: This should be used instead of the API Dedendency function blackhawk7_v1l8p1_pmd_rdt_reg().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] addr 16-bit register address.
 ...
 * NOTE: This should be used instead of the API Dedendency function blackhawk7_v1l8p1_pmd_wr_reg().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * NOTE: This should be used instead of the API Dedendency function blackhawk7_v1l8p1_pmd_mwr_reg().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * @return Error code generated by write function (returns ERR_CODE_NONE if no errors).
 */
err_code_t blackhawk7_v1l8p1_acc_wr_pram(srds_access_t *sa__, uint8_t val);
...
#define blackhawk7_v1l8p1_acc_get_physical_lane blackhawk7_v1l8p1_acc_get_lane
...
#define blackhawk7_v1l8p1_acc_set_physical_lane blackhawk7_v1l8p1_acc_set_lane
 ...
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @return Returns a pointer to the blackhawk7_v1l8p1 info table.
 */
