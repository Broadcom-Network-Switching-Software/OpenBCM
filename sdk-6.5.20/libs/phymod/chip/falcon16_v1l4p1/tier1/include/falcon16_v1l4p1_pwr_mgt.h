...
/** @file falcon16_v1l4p1_pwr_mgt.h
 * Power management functions provided to IP User
 */
#ifndef FALCON16_V1L4P1_API_PWR_MGT_H
#define FALCON16_V1L4P1_API_PWR_MGT_H
 ...
 * Note: User also needs to configure all lanes through falcon16_v1l4p1_lane_config_for_iddq()
 ...
 * Along with falcon16_v1l4p1_core_pwrdn(), all lanes powerdowns should also be issued using
 * falcon16_v1l4p1_lane_pwrdn() to complete a Core Powerdown.
 * @param sa__ is an opaque state vector passed through to device access functions.
 ...
 * Note: User needs to configure all lanes through falcon16_v1l4p1_lane_config_for_iddq() and also call falcon16_v1l4p1_core_config_for_iddq()
 * before enabling IDDQ by asserting IDDQ pin.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
