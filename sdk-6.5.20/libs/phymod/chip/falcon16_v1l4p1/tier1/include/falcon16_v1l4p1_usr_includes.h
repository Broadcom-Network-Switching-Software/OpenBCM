...
/**************************************************************************************
 *  File Name     :  falcon16_v1l4p1_usr_includes.h                                        *
...
/** @file falcon16_v1l4p1_usr_includes.h
...
#ifndef FALCON16_V1L4P1_API_USR_INCLUDES_H
#define FALCON16_V1L4P1_API_USR_INCLUDES_H
...
# endif
#define USR_DELAY_MS(stuff) falcon16_v1l4p1_delay_ms(sa__,stuff)
#define USR_DELAY_US(stuff) falcon16_v1l4p1_delay_us(sa__,stuff)
#define USR_DELAY_NS(stuff) falcon16_v1l4p1_delay_ns(sa__,stuff)
#else
# ifndef NO_VARIADIC_MACROS
...
# endif
#define USR_DELAY_MS(stuff) falcon16_v1l4p1_delay_ms(stuff)
#define USR_DELAY_US(stuff) falcon16_v1l4p1_delay_us(stuff)
#define USR_DELAY_NS(stuff) falcon16_v1l4p1_delay_ns(stuff)
#endif
...
#define USR_DELAY_MS(var) falcon16_v1l4p1_delay_ms(var)
#define USR_DELAY_US(var) falcon16_v1l4p1_delay_us(var)
#define USR_DELAY_NS(var) falcon16_v1l4p1_delay_ns(var)
