...
/** @file falcon16_v1l4p1_diag.h
 * Diagnostic functions provided to IP User
 */

#ifndef FALCON16_V1L4P1_API_DIAG_H
#define FALCON16_V1L4P1_API_DIAG_H

#include "falcon16_v1l4p1_internal.h"
...
struct falcon16_v1l4p1_eyescan_options_st {
...
/** Column definition header for falcon16_v1l4p1_display_core_state() API output.
 * To be called before falcon16_v1l4p1_display_core_state_line() API.
 ...
 * Call falcon16_v1l4p1_display_core_state_hdr() API before and falcon16_v1l4p1_display_core_state_legend() after
...
/** Detailed description of each column in falcon16_v1l4p1_display_core_state_line() API output.
 * To be called after falcon16_v1l4p1_display_core_state_line() API to display the legends.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * This function only initiates the processor actions.  User must use falcon16_v1l4p1_read_eye_scan_stripe() function
 ...
 * falcon16_v1l4p1_start_ber_scan_test(), falcon16_v1l4p1_read_ber_scan_data(), falcon16_v1l4p1_display_ber_scan_data().
 *
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param rate specifies the data rate in Hz
 * @param ber_scan_mode the type of test used to take the data(use #srds_diag_ber_mode_enum)
 ...
 * \n Note: Call functions falcon16_v1l4p1_display_lane_state_hdr() before and falcon16_v1l4p1_display_lane_state_legend() after
...
/** Column definition header for falcon16_v1l4p1 display state.
 * To be called before falcon16_v1l4p1_display_lane_state() function.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon16_v1l4p1_display_lane_state_hdr(void);

/** Detailed explanation of each column in falcon16_v1l4p1 display state.
 * To be called after falcon16_v1l4p1_display_lane_state() function to display the legends.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * This function is required to be implemented by upper level software to enable falcon16_v1l4p1 support.
 * @param sa__ is an opaque state vector passed through to device access functions.
...
/** Parameterized diagnostic function which access to all falcon16_v1l4p1 control and status bits
 * This function is required to be implemented by upper level software to enable falcon16_v1l4p1 support.
 * @param sa__ is an opaque state vector passed through to device access functions.
