...
/*---------------------------------------*/
enum merlin16_pcieg3_prbs_chk_timer_selection_enum {
    USE_HW_TIMERS = 0,
    USE_SW_TIMERS = 1
};
 ...
 */
err_code_t merlin16_pcieg3_INTERNAL_get_BER_data(srds_access_t *sa__, uint16_t time_ms, struct ber_data_st *ber_data, enum merlin16_pcieg3_prbs_chk_timer_selection_enum timer_sel);

#if defined(MERLIN16_PCIEG3_PRBS_CHK_HARDWARE_TIMERS)
 ...
 * @return Error code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_pcieg3_INTERNAL_get_prbs_timeout_count_from_time(uint16_t time_ms, uint16_t * time_ms_adjusted, struct prbs_chk_hw_timer_ctrl_st * const prbs_chk_hw_timer_ctrl) ;
 ...
 * @return Serdes Info pointer
 */
srds_info_t *merlin16_pcieg3_INTERNAL_get_merlin16_pcieg3_info_ptr(srds_access_t *sa__);

/** Get Serdes Info pointer and initialize it if signature doesn't match 
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @return Serdes Info pointer
 */
srds_info_t *merlin16_pcieg3_INTERNAL_get_merlin16_pcieg3_info_ptr_with_check(srds_access_t *sa__);

/** Checks to see if the stored ucode_version in merlin16_pcieg3_info is matching with the current thread ucode
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @return Error Code generated if uC does not become active (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_pcieg3_INTERNAL_match_ucode_from_info(srds_access_t *sa__);

/** Verify the internal merlin16_pcieg3_info.
 * @param *merlin16_pcieg3_info_ptr Info_table to be verified
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @return Error code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_pcieg3_INTERNAL_verify_merlin16_pcieg3_info(srds_info_t *merlin16_pcieg3_info_ptr, srds_access_t *sa__);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_pcieg3_INTERNAL_calc_patt_gen_mode_sel(srds_access_t *sa__, uint8_t *mode_sel, uint8_t *zero_pad_len, uint8_t patt_length);
 ...
 */
err_code_t merlin16_pcieg3_INTERNAL_compute_bin(srds_access_t *sa__, char var, char bin[]);
 ...
 */
err_code_t merlin16_pcieg3_INTERNAL_compute_hex(srds_access_t *sa__, char bin[], uint8_t *hex);
 ...
 * @return Usigned 32bit number
 */
uint32_t merlin16_pcieg3_INTERNAL_float12_to_uint32(uint8_t input, uint8_t multi);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_pcieg3_INTERNAL_get_rx_pf_main(srds_access_t *sa__, uint8_t *val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_pcieg3_INTERNAL_get_rx_pf2(srds_access_t *sa__, uint8_t *val);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_pcieg3_INTERNAL_get_rx_vga(srds_access_t *sa__, uint8_t *val);
 ...
 */
uint8_t merlin16_pcieg3_INTERNAL_is_big_endian(void);
...
int merlin16_pcieg3_INTERNAL_get_endian_offset(uint8_t *addr);
...
/** Extract the refclk frequency in Hz, based on a merlin16_pcieg3_pll_refclk_enum value. */
err_code_t _merlin16_pcieg3_get_refclk_in_hz(srds_access_t *sa__,  enum merlin16_pcieg3_pll_refclk_enum refclk, uint32_t *refclk_in_hz);
 ...
 ** @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin16_pcieg3_INTERNAL_display_info_table(srds_access_t *sa__);
