...
#define merlin16_pcieg3_get_physical_lane merlin16_pcieg3_get_lane
...
#define merlin16_pcieg3_set_physical_lane merlin16_pcieg3_set_lane



#if defined(SERDES_EXTERNAL_INFO_TABLE_EN)
/** Returns address of merlin16_pcieg3 info table stored in upper level software.
 * @param sa__ is an opaque state vector passed through to device access functions.
 */
srds_info_t *merlin16_pcieg3_get_info_table_address(srds_access_t *sa__);
#endif
