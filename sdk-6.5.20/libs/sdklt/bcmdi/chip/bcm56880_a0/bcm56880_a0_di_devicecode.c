/*! \file bcm56880_a0_di_devicecode.c
 *
...
#include "bcm56880_a0_di_devicecode.h"
...
uft_hash_init(int unit)
{
    ...
    IFTA90_E2T_02_SHARED_BANKS_CONTROLm_t i90_sbctl2;
    IFTA90_E2T_03_SHARED_BANKS_CONTROLm_t i90_sbctl3;
    ...
    IFTA90_E2T_02_SHARED_BANKS_CONTROLm_CLR(i90_sbctl2);
    IFTA90_E2T_03_SHARED_BANKS_CONTROLm_CLR(i90_sbctl3);
    ...
    IFTA90_E2T_02_SHARED_BANKS_CONTROLm_B0_HASH_OFFSETf_SET(i90_sbctl2, 0x6);
    IFTA90_E2T_03_SHARED_BANKS_CONTROLm_B0_HASH_OFFSETf_SET(i90_sbctl3, 0x6);
    ...
    IFTA90_E2T_02_SHARED_BANKS_CONTROLm_B1_HASH_OFFSETf_SET(i90_sbctl2, 0xc);
    IFTA90_E2T_03_SHARED_BANKS_CONTROLm_B1_HASH_OFFSETf_SET(i90_sbctl3, 0xc);
    ...
    ioerr += bcmdi_pt_write(unit, IFTA90_E2T_01_SHARED_BANKS_CONTROLm, 0, -1,
                            (uint32_t *)&i90_sbctl1);
    ioerr += bcmdi_pt_write(unit, IFTA90_E2T_02_SHARED_BANKS_CONTROLm, 0, -1,
                            (uint32_t *)&i90_sbctl2);
    ioerr += bcmdi_pt_write(unit, IFTA90_E2T_03_SHARED_BANKS_CONTROLm, 0, -1,
                            (uint32_t *)&i90_sbctl3);
...
static int
bcm56880_a0_di_devicecode_extra(int unit) {
...
static int
bcm56880_a0_di_devicecode_extra_post(int unit)
{
    SHR_FUNC_ENTER(unit);
...
static uint32_t
bcm56880_a0_di_devicecode_buff_base(int unit)
{
 ...
 */
int
bcm56880_a0_di_dvc_drv_attach(int unit, bcmdi_dvc_drv_t *drv)
{

    drv->file = &bcm56880_a0_di_devicecode_file;
    drv->extra = &bcm56880_a0_di_devicecode_extra;
    drv->extra_post = &bcm56880_a0_di_devicecode_extra_post;
    drv->buff_base = &bcm56880_a0_di_devicecode_buff_base;
