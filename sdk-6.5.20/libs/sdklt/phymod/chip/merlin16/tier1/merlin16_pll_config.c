...
err_code_t merlin16_INTERNAL_configure_pll(srds_access_t *sa__,
    ...
    EFUN(merlin16_INTERNAL_resolve_pll_parameters(refclk, &refclk_freq_hz, &srds_div, &vco_freq_khz, MERLIN16_PLL_OPTION_NONE));
...
err_code_t merlin16_INTERNAL_read_pll_div(srds_access_t *sa__, uint32_t *srds_div) {
    uint16_t ndiv_int;
    uint32_t ndiv_frac;
