/*********************************************************************************
 *********************************************************************************
 *  File Name  :  blackhawk_tsc_functions.h
...
#ifndef BLACKHAWK_TSC_API_FUNCTIONS_H
#define BLACKHAWK_TSC_API_FUNCTIONS_H
    ...
    do  { \
        ...
        *(__ERR) = (expr); \
        if (*(__ERR) != ERR_CODE_NONE) { \
            return blackhawk_tsc_error_report(sa__, *(__ERR)); \
        }\
        (void)__err; \
    }   while(0)
