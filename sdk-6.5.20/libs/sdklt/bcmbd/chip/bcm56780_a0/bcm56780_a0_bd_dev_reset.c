...
bcm56780_a0_bd_dev_reset(int unit)
{
    ...
    macsec_tmp_config = bcmbd_config_get(unit, def_val,
                                         "MACSEC_TMP_CONFIG",
                                         "ENABLE");
    ...
    if ((bcmdrd_dev_flags_get(unit) & CHIP_FLAG_MACSEC) &&
         macsec_tmp_config) {
        /* Step 1: TOP_MACSEC_CTRL_ */
        TOP_MACSEC_CTRL0r_SET(macsecreset, 0x1ffffff);

        val = bcmbd_config_get(unit, def_val,
                               "MACSEC_TMP_CONFIG",
                               "MACSEC_SRC_PM0_OVER_PM6");
        TOP_MACSEC_CTRL0r_MACSEC_SRC_PM0_OR_PM6f_SET(macsecreset, val);
        val = bcmbd_config_get(unit, def_val,
                               "MACSEC_TMP_CONFIG",
                               "MACSEC_SRC_PM1_OVER_PM7");
        TOP_MACSEC_CTRL0r_MACSEC_SRC_PM1_OR_PM7f_SET(macsecreset, val);
        val = bcmbd_config_get(unit, def_val,
                               "MACSEC_TMP_CONFIG",
                               "MACSEC_SRC_PM2_OVER_PM8");
        TOP_MACSEC_CTRL0r_MACSEC_SRC_PM2_OR_PM8f_SET(macsecreset, val);
        val = bcmbd_config_get(unit, def_val,
                               "MACSEC_TMP_CONFIG",
                               "MACSEC_SRC_PM3_OVER_PM9");
        TOP_MACSEC_CTRL0r_MACSEC_SRC_PM3_OR_PM9f_SET(macsecreset, val);
        val = bcmbd_config_get(unit, def_val,
                               "MACSEC_TMP_CONFIG",
                               "MACSEC_SRC_PM10_OVER_PM16");
        TOP_MACSEC_CTRL0r_MACSEC_SRC_PM10_OR_PM16f_SET(macsecreset, val);
        val = bcmbd_config_get(unit, def_val,
                               "MACSEC_TMP_CONFIG",
                               "MACSEC_SRC_PM11_OVER_PM17");
        TOP_MACSEC_CTRL0r_MACSEC_SRC_PM11_OR_PM17f_SET(macsecreset, val);
        val = bcmbd_config_get(unit, def_val,
                               "MACSEC_TMP_CONFIG",
                               "MACSEC_SRC_PM12_OVER_PM18");
        TOP_MACSEC_CTRL0r_MACSEC_SRC_PM12_OR_PM18f_SET(macsecreset, val);
        val = bcmbd_config_get(unit, def_val,
                               "MACSEC_TMP_CONFIG",
                               "MACSEC_SRC_PM13_OVER_PM19");
        TOP_MACSEC_CTRL0r_MACSEC_SRC_PM13_OR_PM19f_SET(macsecreset, val);
        val = bcmbd_config_get(unit, def_val,
                               "MACSEC_TMP_CONFIG", "MACSEC0_ACTIVE");
        TOP_MACSEC_CTRL0r_MACSEC0_ACTIVEf_SET(macsecreset, val);
        val = bcmbd_config_get(unit, def_val,
                               "MACSEC_TMP_CONFIG", "MACSEC1_ACTIVE");
        TOP_MACSEC_CTRL0r_MACSEC1_ACTIVEf_SET(macsecreset, val);
        val = bcmbd_config_get(unit, def_val,
                               "MACSEC_TMP_CONFIG", "MACSEC2_ACTIVE");
        TOP_MACSEC_CTRL0r_MACSEC2_ACTIVEf_SET(macsecreset, val);
        val = bcmbd_config_get(unit, def_val,
                               "MACSEC_TMP_CONFIG", "MACSEC3_ACTIVE");
        TOP_MACSEC_CTRL0r_MACSEC3_ACTIVEf_SET(macsecreset, val);
        val = bcmbd_config_get(unit, def_val,
                               "MACSEC_TMP_CONFIG", "MACSEC4_ACTIVE");
        TOP_MACSEC_CTRL0r_MACSEC4_ACTIVEf_SET(macsecreset, val);
        val = bcmbd_config_get(unit, def_val,
                               "MACSEC_TMP_CONFIG", "MACSEC5_ACTIVE");
        TOP_MACSEC_CTRL0r_MACSEC5_ACTIVEf_SET(macsecreset, val);
    ...
    for (idx = 0; (bcmdrd_dev_flags_get(unit) & CHIP_FLAG_MACSEC) &&
         (idx < 6); idx++) {
