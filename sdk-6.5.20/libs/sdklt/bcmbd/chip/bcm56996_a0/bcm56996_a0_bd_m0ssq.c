/*! \file bcm56996_a0_bd_m0ssq.c
 *
 * bcm56996_a0 device-specific M0SSQ driver.
 */
/*
...
static bcmbd_m0ssq_drv_t bcm56996_a0_m0ssq_drv;

/*******************************************************************************
 * M0SSQ CMICX M0SSQ Driver
 */
static int
bcm56996_a0_m0ssq_init(int unit)
{
    ...
    /* Invoke base driver to init M0SSQ. */
...
bcm56996_a0_bd_m0ssq_drv_init(int unit)
{
    ...
    sal_memcpy(&bcm56996_a0_m0ssq_drv, base_drv, sizeof(bcmbd_m0ssq_drv_t));

    /* Override chip-specific method. */
    bcm56996_a0_m0ssq_drv.init = bcm56996_a0_m0ssq_init;

    SHR_IF_ERR_EXIT
        (bcmbd_m0ssq_drv_init(unit, &bcm56996_a0_m0ssq_drv));
