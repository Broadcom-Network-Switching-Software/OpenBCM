 ...
 * Local defines.
 */
#define SWITCH_CORE_FREQ_HZ    (1325 * 1000000)
...
/* Device-specific LED driver. */
static bcmbd_led_drv_t bcm56996_a0_bd_led_drv;

/*******************************************************************************
 * Device-specific driver.
 */
static int
bcm56996_a0_bd_led_init(int unit)
{
...
bcm56996_a0_bd_led_drv_init(int unit)
{
    ...
    sal_memcpy(&bcm56996_a0_bd_led_drv, base_drv, sizeof(bcmbd_led_drv_t));

    /* Override with chip-specific driver methods. */
    bcm56996_a0_bd_led_drv.init = bcm56996_a0_bd_led_init;

    /* Install driver methods. */
    SHR_IF_ERR_EXIT
        (bcmbd_led_drv_init(unit, &bcm56996_a0_bd_led_drv));
