...
#ifndef BCMBD_CMICD_SCHAN_H
#define BCMBD_CMICD_SCHAN_H
...
extern int bcmbd_cmicd_schan_op(int unit, schan_msg_t *msg,
                                int dwc_write, int dwc_read); 

/*! \endcond */

#endif  /* BCMBD_CMICD_SCHAN_H */
