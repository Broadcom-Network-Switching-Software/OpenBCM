...
#define BCMPKT_RXPMD_DOP_TRIGGER                 92
/*! From EPRE. If mirror pkt then == MIRROR_ENCAP_INDEx else == eparse_extract_offsets[3:0]. */
#define BCMPKT_RXPMD_EPARSE_EXTRACT_OFFSETS_3_0_OR_MIRROR_ENCAP_INDEX 93
/*! Eparse_extract_offsets[7:4]. */
#define BCMPKT_RXPMD_EPARSE_EXTRACT_OFFSETS_7_4  94
/*! Valid for non-BFD packet */
#define BCMPKT_RXPMD_ING_L3_INTF_VALID           95
/*! Overlay next hop. */
#define BCMPKT_RXPMD_O_NHI                       96
/*!  */
#define BCMPKT_RXPMD_CONGESTION_CLASS            97
/*!  */
#define BCMPKT_RXPMD_DROP_PRECEDENCE             98
/*!  */
#define BCMPKT_RXPMD_PPD0_OPCODE                 99
/*!  */
#define BCMPKT_RXPMD_PPD_TYPE                    100
/*!  */
#define BCMPKT_RXPMD_TRAFFIC_CLASS               101
/*! If set, don't touch the 802.1 priority/CFI of the outermost L2 header */
#define BCMPKT_RXPMD_PPD0_PRESERVE_DOT1P         102
/*! If set, don't touch the DSCP of the outermost IP header */
#define BCMPKT_RXPMD_PPD0_PRESERVE_DSCP          103
/*! Outer Vlan Id. */
#define BCMPKT_RXPMD_PPD0_OUTER_VID              104
/*! VFI */
#define BCMPKT_RXPMD_PPD0_VFI                    105
/*! Indicates that the packet is L3 switched */
#define BCMPKT_RXPMD_PPD0_L3                     106
/*! Indicates that packet has been switched and only needs to be mirrored */
#define BCMPKT_RXPMD_PPD0_MIRROR                 107
/*! Indicates if the packet was tagged when it originally ingress XGS system. */
#define BCMPKT_RXPMD_PPD0_INGRESS_TAGGED         108
/*! When set, it indicates that the packet is redirected by a LAG failover.  The packet must not be redirected again by LAG failover. */
#define BCMPKT_RXPMD_PPD0_LAG_FAILOVER           109
/*! When set, do not perform MAC learning */
#define BCMPKT_RXPMD_PPD0_DO_NOT_LEARN           110
/*! If set, don't touch the 802.1 priority/CFI of the outermost L2 header */
#define BCMPKT_RXPMD_PPD2_PRESERVE_DOT1P         111
/*! If set, don't touch the DSCP of the outermost IP header */
#define BCMPKT_RXPMD_PPD2_PRESERVE_DSCP          112
/*! The upper 3-bits of the VNI */
#define BCMPKT_RXPMD_PPD2_VNI_HIGH               113
/*! mh opcode. */
#define BCMPKT_RXPMD_PPD2_OPCODE                 114
/*! When set, it indicates that the packet is redirected by a LAG failover.  The packet must not be redirected again by LAG failover. */
#define BCMPKT_RXPMD_PPD2_LAG_FAILOVER           115
/*! When set, do not perform MAC learning */
#define BCMPKT_RXPMD_PPD2_DO_NOT_LEARN           116
/*! Indicates that packet has been switched and only needs to be mirrored */
#define BCMPKT_RXPMD_PPD2_MIRROR                 117
/*! The source VP from which the packet originally enters the system.  Used for MAC learning and source knockout */
#define BCMPKT_RXPMD_PPD2_SOURCE_VP              118
/*! The destination VP index or multicast index for egress chip packet modifications and encapsulation */
#define BCMPKT_RXPMD_PPD2_DEST_VP                119
/*! The lower 10-bits of the VNI */
#define BCMPKT_RXPMD_PPD2_VNI_LOW                120
/*! Indicates the forwarding type of the packet */
#define BCMPKT_RXPMD_PPD2_FWD_TYPE               121
/*! Indicates whether the packet is sent to a single point or multipoint tree */
#define BCMPKT_RXPMD_PPD2_MULTIPOINT             122
/*! Source Port or Trunk */
#define BCMPKT_RXPMD_SRC_PORT_TGID               123
/*! When MCST=0, destination port ID, when MCST=1, these are the LSBs of MGID */
#define BCMPKT_RXPMD_DST_PORT_MGIDL              124
/*! When MCST=0, destination module ID, when MCST=1, MSBs of MGID */
#define BCMPKT_RXPMD_DST_MODID_MGIDH             125
/*! Start of frame indicator (must be set to 0xFB) */
#define BCMPKT_RXPMD_START                       126
/*! Indicating format type */
#define BCMPKT_RXPMD_HDR_TYPE                    127
/*! Inner Entropy Used indication */
#define BCMPKT_RXPMD_IEU                         128
/*! IEU indication is valid */
#define BCMPKT_RXPMD_IEU_VALID                   129
/*! RXPMD FIELD ID NUMBER */
#define BCMPKT_RXPMD_FID_COUNT                   130
/*! \} */
...
#define BCMPKT_RXPMD_FIELD_NAME_MAP_INIT \
    ...
    {"CONGESTION_CLASS", BCMPKT_RXPMD_CONGESTION_CLASS},\
    {"DROP_PRECEDENCE", BCMPKT_RXPMD_DROP_PRECEDENCE},\
    {"PPD0::OPCODE", BCMPKT_RXPMD_PPD0_OPCODE},\
    {"PPD_TYPE", BCMPKT_RXPMD_PPD_TYPE},\
    {"TRAFFIC_CLASS", BCMPKT_RXPMD_TRAFFIC_CLASS},\
    {"PPD0::PRESERVE_DOT1P", BCMPKT_RXPMD_PPD0_PRESERVE_DOT1P},\
    {"PPD0::PRESERVE_DSCP", BCMPKT_RXPMD_PPD0_PRESERVE_DSCP},\
    {"PPD0::OUTER_VID", BCMPKT_RXPMD_PPD0_OUTER_VID},\
    {"PPD0::VFI", BCMPKT_RXPMD_PPD0_VFI},\
    {"PPD0::L3", BCMPKT_RXPMD_PPD0_L3},\
    {"PPD0::MIRROR", BCMPKT_RXPMD_PPD0_MIRROR},\
    {"PPD0::INGRESS_TAGGED", BCMPKT_RXPMD_PPD0_INGRESS_TAGGED},\
    {"PPD0::LAG_FAILOVER", BCMPKT_RXPMD_PPD0_LAG_FAILOVER},\
    {"PPD0::DO_NOT_LEARN", BCMPKT_RXPMD_PPD0_DO_NOT_LEARN},\
    {"PPD2::PRESERVE_DOT1P", BCMPKT_RXPMD_PPD2_PRESERVE_DOT1P},\
    {"PPD2::PRESERVE_DSCP", BCMPKT_RXPMD_PPD2_PRESERVE_DSCP},\
    {"PPD2::VNI_HIGH", BCMPKT_RXPMD_PPD2_VNI_HIGH},\
    {"PPD2::OPCODE", BCMPKT_RXPMD_PPD2_OPCODE},\
    {"PPD2::LAG_FAILOVER", BCMPKT_RXPMD_PPD2_LAG_FAILOVER},\
    {"PPD2::DO_NOT_LEARN", BCMPKT_RXPMD_PPD2_DO_NOT_LEARN},\
    {"PPD2::MIRROR", BCMPKT_RXPMD_PPD2_MIRROR},\
    {"PPD2::SOURCE_VP", BCMPKT_RXPMD_PPD2_SOURCE_VP},\
    {"PPD2::DEST_VP", BCMPKT_RXPMD_PPD2_DEST_VP},\
    {"PPD2::VNI_LOW", BCMPKT_RXPMD_PPD2_VNI_LOW},\
    {"PPD2::FWD_TYPE", BCMPKT_RXPMD_PPD2_FWD_TYPE},\
    {"PPD2::MULTIPOINT", BCMPKT_RXPMD_PPD2_MULTIPOINT},\
    {"SRC_PORT_TGID", BCMPKT_RXPMD_SRC_PORT_TGID},\
    {"DST_PORT_MGIDL", BCMPKT_RXPMD_DST_PORT_MGIDL},\
    {"DST_MODID_MGIDH", BCMPKT_RXPMD_DST_MODID_MGIDH},\
    {"START", BCMPKT_RXPMD_START},\
    {"HDR_TYPE", BCMPKT_RXPMD_HDR_TYPE},\
...
/*!
 * \name BCMPKT_RXPMD_DROP_PRECEDENCE encodings.
 * \anchor BCMPKT_RXPMD_DROP_PRECEDENCE_XXX
 */
/*! \{ */
/*! Green */
#define BCMPKT_RXPMD_DROP_PRECEDENCE_GREEN       0
/*! Red */
#define BCMPKT_RXPMD_DROP_PRECEDENCE_RED         1
/*! Yellow */
#define BCMPKT_RXPMD_DROP_PRECEDENCE_YELLOW      3
/*! \} */

/*! BCMPKT_RXPMD_DROP_PRECEDENCE encoding name strings for debugging. */
#define BCMPKT_RXPMD_DROP_PRECEDENCE_NAME_MAP_INIT \
    {"GREEN", BCMPKT_RXPMD_DROP_PRECEDENCE_GREEN},\
    {"RED", BCMPKT_RXPMD_DROP_PRECEDENCE_RED},\
    {"RESERVED_COUNTER", 2},\
    {"YELLOW", BCMPKT_RXPMD_DROP_PRECEDENCE_YELLOW},\

/*!
 * \name BCMPKT_RXPMD_PPD0_OPCODE encodings.
 * \anchor BCMPKT_RXPMD_PPD0_OPCODE_XXX
 */
/*! \{ */
/*! Copy To Cpu */
#define BCMPKT_RXPMD_PPD0_OPCODE_CPU_TO_CPU      0
/*! Unicast */
#define BCMPKT_RXPMD_PPD0_OPCODE_UNICAST         1
/*! Broadcast/DLF */
#define BCMPKT_RXPMD_PPD0_OPCODE_BCAST_DLF       2
/*! L2 multicast */
#define BCMPKT_RXPMD_PPD0_OPCODE_L2MC            3
/*! Ip Multicast */
#define BCMPKT_RXPMD_PPD0_OPCODE_IPMC            4
/*! Next Hop Processing */
#define BCMPKT_RXPMD_PPD0_OPCODE_NHOP_PROC       5
/*! \} */

/*! BCMPKT_RXPMD_PPD0_OPCODE encoding name strings for debugging. */
#define BCMPKT_RXPMD_PPD0_OPCODE_NAME_MAP_INIT \
    {"CPU_TO_CPU", BCMPKT_RXPMD_PPD0_OPCODE_CPU_TO_CPU},\
    {"UNICAST", BCMPKT_RXPMD_PPD0_OPCODE_UNICAST},\
    {"BCAST_DLF", BCMPKT_RXPMD_PPD0_OPCODE_BCAST_DLF},\
    {"L2MC", BCMPKT_RXPMD_PPD0_OPCODE_L2MC},\
    {"IPMC", BCMPKT_RXPMD_PPD0_OPCODE_IPMC},\
    {"NHOP_PROC", BCMPKT_RXPMD_PPD0_OPCODE_NHOP_PROC},\

/*!
 * \name BCMPKT_RXPMD_PPD_TYPE encodings.
 * \anchor BCMPKT_RXPMD_PPD_TYPE_XXX
 */
/*! \{ */
/*! PPD Type 0 */
#define BCMPKT_RXPMD_PPD_T_PPD0                  0
/*! PPD Type 2 */
#define BCMPKT_RXPMD_PPD_T_PPD2                  2
/*! \} */

/*! BCMPKT_RXPMD_PPD_TYPE encoding name strings for debugging. */
#define BCMPKT_RXPMD_PPD_TYPE_NAME_MAP_INIT \
    {"PPD0", BCMPKT_RXPMD_PPD_T_PPD0},\
    {"RESERVED_COUNTER", 1},\
    {"PPD2", BCMPKT_RXPMD_PPD_T_PPD2},\

/*!
 * \name BCMPKT_RXPMD_TRAFFIC_CLASS encodings.
 * \anchor BCMPKT_RXPMD_TRAFFIC_CLASS_XXX
 */
/*! \{ */
/*! Data Priority 0 */
#define BCMPKT_RXPMD_TRAFFIC_CLASS_COS0          0
/*! Data Priority 1 */
#define BCMPKT_RXPMD_TRAFFIC_CLASS_COS1          1
/*! Data Priority 2 */
#define BCMPKT_RXPMD_TRAFFIC_CLASS_COS2          2
/*! Data Priority 3 */
#define BCMPKT_RXPMD_TRAFFIC_CLASS_COS3          3
/*! Data Priority 4 */
#define BCMPKT_RXPMD_TRAFFIC_CLASS_COS4          4
/*! Data Priority 5 */
#define BCMPKT_RXPMD_TRAFFIC_CLASS_COS5          5
/*! Data Priority 6 */
#define BCMPKT_RXPMD_TRAFFIC_CLASS_COS6          6
/*! Data Priority 7 */
#define BCMPKT_RXPMD_TRAFFIC_CLASS_COS7          7
/*! System Control */
#define BCMPKT_RXPMD_TRAFFIC_CLASS_SC            14
/*! QoS Management */
#define BCMPKT_RXPMD_TRAFFIC_CLASS_QM            15
/*! \} */

/*! BCMPKT_RXPMD_TRAFFIC_CLASS encoding name strings for debugging. */
#define BCMPKT_RXPMD_TRAFFIC_CLASS_NAME_MAP_INIT \
    {"COS0", BCMPKT_RXPMD_TRAFFIC_CLASS_COS0},\
    {"COS1", BCMPKT_RXPMD_TRAFFIC_CLASS_COS1},\
    {"COS2", BCMPKT_RXPMD_TRAFFIC_CLASS_COS2},\
    {"COS3", BCMPKT_RXPMD_TRAFFIC_CLASS_COS3},\
    {"COS4", BCMPKT_RXPMD_TRAFFIC_CLASS_COS4},\
    {"COS5", BCMPKT_RXPMD_TRAFFIC_CLASS_COS5},\
    {"COS6", BCMPKT_RXPMD_TRAFFIC_CLASS_COS6},\
    {"COS7", BCMPKT_RXPMD_TRAFFIC_CLASS_COS7},\
    {"RESERVED_COUNTER", 8},\
    {"RESERVED_COUNTER", 9},\
    {"RESERVED_COUNTER", 10},\
    {"RESERVED_COUNTER", 11},\
    {"RESERVED_COUNTER", 12},\
    {"RESERVED_COUNTER", 13},\
    {"SC", BCMPKT_RXPMD_TRAFFIC_CLASS_SC},\
    {"QM", BCMPKT_RXPMD_TRAFFIC_CLASS_QM},\

/*!
 * \name BCMPKT_RXPMD_PPD2_OPCODE encodings.
 * \anchor BCMPKT_RXPMD_PPD2_OPCODE_XXX
 */
/*! \{ */
/*! Copy To Cpu */
#define BCMPKT_RXPMD_PPD2_OPCODE_CPU_TO_CPU      0
/*! Unicast */
#define BCMPKT_RXPMD_PPD2_OPCODE_UNICAST         1
/*! Broadcast/DLF */
#define BCMPKT_RXPMD_PPD2_OPCODE_BCAST_DLF       2
/*! L2 multicast */
#define BCMPKT_RXPMD_PPD2_OPCODE_L2MC            3
/*! Ip Multicast */
#define BCMPKT_RXPMD_PPD2_OPCODE_IPMC            4
/*! Next Hop Processing */
#define BCMPKT_RXPMD_PPD2_OPCODE_NHOP_PROC       5
/*! \} */

/*! BCMPKT_RXPMD_PPD2_OPCODE encoding name strings for debugging. */
#define BCMPKT_RXPMD_PPD2_OPCODE_NAME_MAP_INIT \
    {"CPU_TO_CPU", BCMPKT_RXPMD_PPD2_OPCODE_CPU_TO_CPU},\
    {"UNICAST", BCMPKT_RXPMD_PPD2_OPCODE_UNICAST},\
    {"BCAST_DLF", BCMPKT_RXPMD_PPD2_OPCODE_BCAST_DLF},\
    {"L2MC", BCMPKT_RXPMD_PPD2_OPCODE_L2MC},\
    {"IPMC", BCMPKT_RXPMD_PPD2_OPCODE_IPMC},\
    {"NHOP_PROC", BCMPKT_RXPMD_PPD2_OPCODE_NHOP_PROC},\

/*!
 * \name BCMPKT_RXPMD_START encodings.
 * \anchor BCMPKT_RXPMD_START_XXX
 */
/*! \{ */
/*!  */
#define BCMPKT_RXPMD_START_INTERNAL              2
/*! \} */

/*! BCMPKT_RXPMD_START encoding name strings for debugging. */
#define BCMPKT_RXPMD_START_NAME_MAP_INIT \
    {"RESERVED_COUNTER", 0},\
    {"RESERVED_COUNTER", 1},\
    {"INTERNAL", BCMPKT_RXPMD_START_INTERNAL},\
