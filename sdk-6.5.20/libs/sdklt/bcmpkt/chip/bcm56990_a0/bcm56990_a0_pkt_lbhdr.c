...
static void bcmpkt_lbhdr_start_set(uint32_t *data, uint32_t val)
{
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Set field BCMPKT_LBHDR_START with value %u on device BCM56990_A0.\n"), val));
...
static uint32_t bcmpkt_lbhdr_start_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Get field BCMPKT_LBHDR_START value %u from device BCM56990_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Set field BCMPKT_LBHDR_HEADER_TYPE with value %u on device BCM56990_A0.\n"), val));
...
static uint32_t bcmpkt_lbhdr_header_type_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Get field BCMPKT_LBHDR_HEADER_TYPE value %u from device BCM56990_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Set field BCMPKT_LBHDR_INPUT_PRIORITY with value %u on device BCM56990_A0.\n"), val));
...
static uint32_t bcmpkt_lbhdr_input_priority_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Get field BCMPKT_LBHDR_INPUT_PRIORITY value %u from device BCM56990_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Set field BCMPKT_LBHDR_PKT_PROFILE with value %u on device BCM56990_A0.\n"), val));
...
static uint32_t bcmpkt_lbhdr_pkt_profile_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Get field BCMPKT_LBHDR_PKT_PROFILE value %u from device BCM56990_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Set field BCMPKT_LBHDR_VISIBILITY_PKT with value %u on device BCM56990_A0.\n"), val));
...
static uint32_t bcmpkt_lbhdr_visibility_pkt_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Get field BCMPKT_LBHDR_VISIBILITY_PKT value %u from device BCM56990_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Set field BCMPKT_LBHDR_SOURCE with value %u on device BCM56990_A0.\n"), val));
...
static uint32_t bcmpkt_lbhdr_source_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Get field BCMPKT_LBHDR_SOURCE value %u from device BCM56990_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Set field BCMPKT_LBHDR_SOURCE_TYPE with value %u on device BCM56990_A0.\n"), val));
...
static uint32_t bcmpkt_lbhdr_source_type_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Get field BCMPKT_LBHDR_SOURCE_TYPE value %u from device BCM56990_A0.\n"), val));
    return val;
}
...
static void bcmpkt_lbhdr_trill_ac_cng_set(uint32_t *data, uint32_t val)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Set field BCMPKT_LBHDR_TRILL_AC_CNG with value %u on device BCM56990_A0.\n"), val));
...
static uint32_t bcmpkt_lbhdr_trill_ac_cng_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Get field BCMPKT_LBHDR_TRILL_AC_CNG value %u from device BCM56990_A0.\n"), val));
    return val;
}
...
static void bcmpkt_lbhdr_trill_ac_tc_set(uint32_t *data, uint32_t val)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Set field BCMPKT_LBHDR_TRILL_AC_TC with value %u on device BCM56990_A0.\n"), val));
...
static uint32_t bcmpkt_lbhdr_trill_ac_tc_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Get field BCMPKT_LBHDR_TRILL_AC_TC value %u from device BCM56990_A0.\n"), val));
    return val;
}
...
static void bcmpkt_lbhdr_trill_nw_cng_set(uint32_t *data, uint32_t val)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Set field BCMPKT_LBHDR_TRILL_NW_CNG with value %u on device BCM56990_A0.\n"), val));
    WORD_FIELD_SET(data[3], 4, 2, val);
}
...
static uint32_t bcmpkt_lbhdr_trill_nw_cng_get(uint32_t *data)
{
    ...
    val = WORD_FIELD_GET(data[3], 4, 2);
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Get field BCMPKT_LBHDR_TRILL_NW_CNG value %u from device BCM56990_A0.\n"), val));
    return val;
}
...
static void bcmpkt_lbhdr_trill_nw_tc_set(uint32_t *data, uint32_t val)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Set field BCMPKT_LBHDR_TRILL_NW_TC with value %u on device BCM56990_A0.\n"), val));
    WORD_FIELD_SET(data[3], 0, 4, val);
}
...
static uint32_t bcmpkt_lbhdr_trill_nw_tc_get(uint32_t *data)
{
    ...
    val = WORD_FIELD_GET(data[3], 0, 4);
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Get field BCMPKT_LBHDR_TRILL_NW_TC value %u from device BCM56990_A0.\n"), val));
    return val;
}
...
static void bcmpkt_lbhdr_eth_dest_type_set(uint32_t *data, uint32_t val)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Set field BCMPKT_LBHDR_ETH_DEST_TYPE with value %u on device BCM56990_A0.\n"), val));
...
static uint32_t bcmpkt_lbhdr_eth_dest_type_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Get field BCMPKT_LBHDR_ETH_DEST_TYPE value %u from device BCM56990_A0.\n"), val));
    return val;
}
...
static void bcmpkt_lbhdr_eth_dest_set(uint32_t *data, uint32_t val)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Set field BCMPKT_LBHDR_ETH_DEST with value %u on device BCM56990_A0.\n"), val));
...
static uint32_t bcmpkt_lbhdr_eth_dest_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Get field BCMPKT_LBHDR_ETH_DEST value %u from device BCM56990_A0.\n"), val));
    return val;
}
...
static void bcmpkt_lbhdr_eth_dp_set(uint32_t *data, uint32_t val)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Set field BCMPKT_LBHDR_ETH_DP with value %u on device BCM56990_A0.\n"), val));
...
static uint32_t bcmpkt_lbhdr_eth_dp_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Get field BCMPKT_LBHDR_ETH_DP value %u from device BCM56990_A0.\n"), val));
    return val;
}
...
static void bcmpkt_lbhdr_eth_ecmp_member_id_set(uint32_t *data, uint32_t val)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Set field BCMPKT_LBHDR_ETH_ECMP_MEMBER_ID with value %u on device BCM56990_A0.\n"), val));
...
static uint32_t bcmpkt_lbhdr_eth_ecmp_member_id_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Get field BCMPKT_LBHDR_ETH_ECMP_MEMBER_ID value %u from device BCM56990_A0.\n"), val));
    return val;
}
...
static void bcmpkt_lbhdr_eth_int_cn_set(uint32_t *data, uint32_t val)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Set field BCMPKT_LBHDR_ETH_INT_CN with value %u on device BCM56990_A0.\n"), val));
...
static uint32_t bcmpkt_lbhdr_eth_int_cn_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Get field BCMPKT_LBHDR_ETH_INT_CN value %u from device BCM56990_A0.\n"), val));
    return val;
}
...
static void bcmpkt_lbhdr_eth_int_pri_set(uint32_t *data, uint32_t val)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Set field BCMPKT_LBHDR_ETH_INT_PRI with value %u on device BCM56990_A0.\n"), val));
...
static uint32_t bcmpkt_lbhdr_eth_int_pri_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Get field BCMPKT_LBHDR_ETH_INT_PRI value %u from device BCM56990_A0.\n"), val));
    return val;
}
...
static void bcmpkt_lbhdr_eth_mcast_lb_index_set(uint32_t *data, uint32_t val)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Set field BCMPKT_LBHDR_ETH_MCAST_LB_INDEX with value %u on device BCM56990_A0.\n"), val));
...
static uint32_t bcmpkt_lbhdr_eth_mcast_lb_index_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Get field BCMPKT_LBHDR_ETH_MCAST_LB_INDEX value %u from device BCM56990_A0.\n"), val));
    return val;
}
...
static void bcmpkt_lbhdr_eth_mcast_lb_index_vld_set(uint32_t *data, uint32_t val)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Set field BCMPKT_LBHDR_ETH_MCAST_LB_INDEX_VLD with value %u on device BCM56990_A0.\n"), val));
...
static uint32_t bcmpkt_lbhdr_eth_mcast_lb_index_vld_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Get field BCMPKT_LBHDR_ETH_MCAST_LB_INDEX_VLD value %u from device BCM56990_A0.\n"), val));
    return val;
}
...
static void bcmpkt_lbhdr_eth_pp_port_set(uint32_t *data, uint32_t val)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Set field BCMPKT_LBHDR_ETH_PP_PORT with value %u on device BCM56990_A0.\n"), val));
...
static uint32_t bcmpkt_lbhdr_eth_pp_port_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Get field BCMPKT_LBHDR_ETH_PP_PORT value %u from device BCM56990_A0.\n"), val));
    return val;
}
...
static void bcmpkt_lbhdr_eth_qos_fields_vld_set(uint32_t *data, uint32_t val)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Set field BCMPKT_LBHDR_ETH_QOS_FIELDS_VLD with value %u on device BCM56990_A0.\n"), val));
...
static uint32_t bcmpkt_lbhdr_eth_qos_fields_vld_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Get field BCMPKT_LBHDR_ETH_QOS_FIELDS_VLD value %u from device BCM56990_A0.\n"), val));
    return val;
}
...
static void bcmpkt_lbhdr_eth_routed_pkt_set(uint32_t *data, uint32_t val)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Set field BCMPKT_LBHDR_ETH_ROUTED_PKT with value %u on device BCM56990_A0.\n"), val));
...
static uint32_t bcmpkt_lbhdr_eth_routed_pkt_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Get field BCMPKT_LBHDR_ETH_ROUTED_PKT value %u from device BCM56990_A0.\n"), val));
    return val;
}
...
static void bcmpkt_lbhdr_eth_subflow_type_set(uint32_t *data, uint32_t val)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Set field BCMPKT_LBHDR_ETH_SUBFLOW_TYPE with value %u on device BCM56990_A0.\n"), val));
...
static uint32_t bcmpkt_lbhdr_eth_subflow_type_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Get field BCMPKT_LBHDR_ETH_SUBFLOW_TYPE value %u from device BCM56990_A0.\n"), val));
    return val;
}
...
static void bcmpkt_lbhdr_ethernet_vrf_set(uint32_t *data, uint32_t val)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Set field BCMPKT_LBHDR_ETHERNET_VRF with value %u on device BCM56990_A0.\n"), val));
...
static uint32_t bcmpkt_lbhdr_ethernet_vrf_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Get field BCMPKT_LBHDR_ETHERNET_VRF value %u from device BCM56990_A0.\n"), val));
    return val;
}
...
static void bcmpkt_lbhdr_ethernet_vrf_valid_set(uint32_t *data, uint32_t val)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Set field BCMPKT_LBHDR_ETHERNET_VRF_VALID with value %u on device BCM56990_A0.\n"), val));
...
static uint32_t bcmpkt_lbhdr_ethernet_vrf_valid_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR,
              (BSL_META("Get field BCMPKT_LBHDR_ETHERNET_VRF_VALID value %u from device BCM56990_A0.\n"), val));
    return val;
}

static uint32_t bcmpkt_lbhdr_i_size_get(uint32_t *data, uint32_t **addr)
{
    LOG_DEBUG(BSL_LS_BCMPKT_LBHDR, (BSL_META("Get BCMPKT_LBHDR_I_SIZE on device BCM56990_A0.\n")));
    return 4;
}
