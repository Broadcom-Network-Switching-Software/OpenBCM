/*! \file bcm56990_a0_pkt_trace_internal.c
 *
...
const bcmpkt_trace_pt_to_dop_info_get_t bcm56990_a0_trace_pt_to_dop_info_get = {
    {
        NULL,
        NULL,
        NULL,
...
static int
bcm56990_a0_trace_init(int unit)
{
...
static int
bcm56990_a0_trace_data_get(int unit, int port, uint32_t *len, uint8_t *data)
{
...
static int
bcm56990_a0_trace_get_txpmd_val(uint32_t dev_type, int fid, int *val)
{
...
static int
bcm56990_a0_trace_get_lbpipe(int unit, int pipe, int *lbpipe)
{
    if (pipe % 2 == 0) {
        *lbpipe = pipe + 1;
    }
...
int
bcm56990_a0_trace_drv_attach(bcmpkt_trace_drv_t *trace_drv)
{
    if (trace_drv == NULL) {
        return SHR_E_FAIL;
    }

    trace_drv->profile_init = bcm56990_a0_trace_init;
    trace_drv->get_lbpipe = bcm56990_a0_trace_get_lbpipe;
    trace_drv->data_read = bcm56990_a0_trace_data_get;
    trace_drv->get_txpmd_val = bcm56990_a0_trace_get_txpmd_val;
