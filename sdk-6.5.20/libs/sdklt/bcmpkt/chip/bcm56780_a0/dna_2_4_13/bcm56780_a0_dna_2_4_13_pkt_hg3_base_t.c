...
static uint32_t bcmpkt_hg3_base_t_system_source_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_HG3_BASE_T_SYSTEM_SOURCE with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_hg3_base_t_system_source_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_HG3_BASE_T_SYSTEM_SOURCE with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_hg3_base_t_ext_hdr_present_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_HG3_BASE_T_EXT_HDR_PRESENT with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_hg3_base_t_ext_hdr_present_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_HG3_BASE_T_EXT_HDR_PRESENT with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_hg3_base_t_cn_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_HG3_BASE_T_CN with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_hg3_base_t_cn_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_HG3_BASE_T_CN with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_hg3_base_t_hg3_reserved_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_HG3_BASE_T_HG3_RESERVED with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_hg3_base_t_hg3_reserved_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_HG3_BASE_T_HG3_RESERVED with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_hg3_base_t_mirror_copy_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_HG3_BASE_T_MIRROR_COPY with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_hg3_base_t_mirror_copy_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_HG3_BASE_T_MIRROR_COPY with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_hg3_base_t_l3_routed_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_HG3_BASE_T_L3_ROUTED with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_hg3_base_t_l3_routed_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_HG3_BASE_T_L3_ROUTED with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_hg3_base_t_cng_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_HG3_BASE_T_CNG with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_hg3_base_t_cng_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_HG3_BASE_T_CNG with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_hg3_base_t_reserved_etype_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_HG3_BASE_T_RESERVED_ETYPE with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_hg3_base_t_reserved_etype_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_HG3_BASE_T_RESERVED_ETYPE with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_hg3_base_t_version_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_HG3_BASE_T_VERSION with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_hg3_base_t_version_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_HG3_BASE_T_VERSION with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_hg3_base_t_system_destination_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_HG3_BASE_T_SYSTEM_DESTINATION with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_hg3_base_t_system_destination_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_HG3_BASE_T_SYSTEM_DESTINATION with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_hg3_base_t_entropy_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_HG3_BASE_T_ENTROPY with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_hg3_base_t_entropy_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_HG3_BASE_T_ENTROPY with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_hg3_base_t_tc_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_HG3_BASE_T_TC with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_hg3_base_t_tc_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_HG3_BASE_T_TC with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_hg3_base_t_system_destination_type_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_HG3_BASE_T_SYSTEM_DESTINATION_TYPE with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_hg3_base_t_system_destination_type_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_HG3_BASE_T_SYSTEM_DESTINATION_TYPE with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_hg3_base_t_i_support_get(uint32_t *data, uint32_t **addr) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_HG3_BASE_T_I_SUPPORT on device BCM56780_A0_DNA_2_4_13\n")));
    return true;
}

const bcmpkt_hg3_base_t_fget_t bcm56780_a0_dna_2_4_13_hg3_base_t_fget = {
    {
...
const bcmpkt_hg3_base_t_fset_t bcm56780_a0_dna_2_4_13_hg3_base_t_fset = {
    {
...
const bcmpkt_hg3_base_t_figet_t bcm56780_a0_dna_2_4_13_hg3_base_t_figet = {
    {
        bcmpkt_hg3_base_t_i_support_get
    }
};

static shr_enum_map_t bcm56780_a0_dna_2_4_13_hg3_base_t_view_types[] = {
    {NULL, -1},
};

/* -2: unsupported, -1: global, others: view's value */
static int bcm56780_a0_dna_2_4_13_hg3_base_t_view_infos[BCMPKT_HG3_BASE_T_FID_COUNT] = {
    -1,
    -1,
    -1,
    -1,
...
void bcm56780_a0_dna_2_4_13_hg3_base_t_view_info_get(bcmpkt_pmd_view_info_t *info)
{
    info->view_infos = bcm56780_a0_dna_2_4_13_hg3_base_t_view_infos;
    info->view_types = bcm56780_a0_dna_2_4_13_hg3_base_t_view_types;
