...
static uint32_t bcmpkt_gpe_t_next_protocol_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_GPE_T_NEXT_PROTOCOL with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_gpe_t_next_protocol_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_GPE_T_NEXT_PROTOCOL with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_gpe_t_flags_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_GPE_T_FLAGS with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_gpe_t_flags_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_GPE_T_FLAGS with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_gpe_t_reserved1_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_GPE_T_RESERVED1 with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_gpe_t_reserved1_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_GPE_T_RESERVED1 with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_gpe_t_reserved0_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_GPE_T_RESERVED0 with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_gpe_t_reserved0_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_GPE_T_RESERVED0 with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_gpe_t_vni_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_GPE_T_VNI with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_gpe_t_vni_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_GPE_T_VNI with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_gpe_t_i_support_get(uint32_t *data, uint32_t **addr) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_GPE_T_I_SUPPORT on device BCM56780_A0_DNA_2_4_13\n")));
    return true;
}

const bcmpkt_gpe_t_fget_t bcm56780_a0_dna_2_4_13_gpe_t_fget = {
    {
...
const bcmpkt_gpe_t_fset_t bcm56780_a0_dna_2_4_13_gpe_t_fset = {
    {
...
const bcmpkt_gpe_t_figet_t bcm56780_a0_dna_2_4_13_gpe_t_figet = {
    {
        bcmpkt_gpe_t_i_support_get
    }
};

static shr_enum_map_t bcm56780_a0_dna_2_4_13_gpe_t_view_types[] = {
    {NULL, -1},
};

/* -2: unsupported, -1: global, others: view's value */
static int bcm56780_a0_dna_2_4_13_gpe_t_view_infos[BCMPKT_GPE_T_FID_COUNT] = {
    -1,
    -1,
    -1,
    -1,
...
void bcm56780_a0_dna_2_4_13_gpe_t_view_info_get(bcmpkt_pmd_view_info_t *info)
{
    info->view_infos = bcm56780_a0_dna_2_4_13_gpe_t_view_infos;
    info->view_types = bcm56780_a0_dna_2_4_13_gpe_t_view_types;
