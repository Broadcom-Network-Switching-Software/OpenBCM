...
static uint32_t bcmpkt_bfd_t_detectmult_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_BFD_T_DETECTMULT with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_bfd_t_detectmult_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_BFD_T_DETECTMULT with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_bfd_t_cpi_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_BFD_T_CPI with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_bfd_t_cpi_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_BFD_T_CPI with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_bfd_t_ap_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_BFD_T_AP with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_bfd_t_ap_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_BFD_T_AP with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_bfd_t_mpt_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_BFD_T_MPT with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_bfd_t_mpt_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_BFD_T_MPT with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_bfd_t_desmintxintv_get(uint32_t *data) {
    ...
    val = SHR_E_PARAM;
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_BFD_T_DESMINTXINTV with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_bfd_t_desmintxintv_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_BFD_T_DESMINTXINTV with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_bfd_t_reqminrxintv_get(uint32_t *data) {
    ...
    val = SHR_E_PARAM;
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_BFD_T_REQMINRXINTV with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_bfd_t_reqminrxintv_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_BFD_T_REQMINRXINTV with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_bfd_t_mydiscrim_get(uint32_t *data) {
    ...
    val = SHR_E_PARAM;
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_BFD_T_MYDISCRIM with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_bfd_t_mydiscrim_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_BFD_T_MYDISCRIM with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_bfd_t_poll_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_BFD_T_POLL with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_bfd_t_poll_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_BFD_T_POLL with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_bfd_t_bfd_length_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_BFD_T_BFD_LENGTH with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_bfd_t_bfd_length_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_BFD_T_BFD_LENGTH with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_bfd_t_minechorxintv_get(uint32_t *data) {
    ...
    val = SHR_E_PARAM;
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_BFD_T_MINECHORXINTV with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_bfd_t_minechorxintv_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_BFD_T_MINECHORXINTV with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_bfd_t_sta_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_BFD_T_STA with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_bfd_t_sta_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_BFD_T_STA with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_bfd_t_diag_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_BFD_T_DIAG with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_bfd_t_diag_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_BFD_T_DIAG with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_bfd_t_version_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_BFD_T_VERSION with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_bfd_t_version_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_BFD_T_VERSION with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_bfd_t_dem_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_BFD_T_DEM with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_bfd_t_dem_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_BFD_T_DEM with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_bfd_t_urdiscrim_get(uint32_t *data) {
    ...
    val = SHR_E_PARAM;
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_BFD_T_URDISCRIM with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_bfd_t_urdiscrim_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_BFD_T_URDISCRIM with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_bfd_t_fin_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_BFD_T_FIN with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_bfd_t_fin_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_BFD_T_FIN with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_bfd_t_i_support_get(uint32_t *data, uint32_t **addr) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_BFD_T_I_SUPPORT on device BCM56780_A0_DNA_2_4_13\n")));
    return true;
}

const bcmpkt_bfd_t_fget_t bcm56780_a0_dna_2_4_13_bfd_t_fget = {
    {
...
const bcmpkt_bfd_t_fset_t bcm56780_a0_dna_2_4_13_bfd_t_fset = {
    {
...
const bcmpkt_bfd_t_figet_t bcm56780_a0_dna_2_4_13_bfd_t_figet = {
    {
        bcmpkt_bfd_t_i_support_get
    }
};

static shr_enum_map_t bcm56780_a0_dna_2_4_13_bfd_t_view_types[] = {
    {NULL, -1},
};

/* -2: unsupported, -1: global, others: view's value */
static int bcm56780_a0_dna_2_4_13_bfd_t_view_infos[BCMPKT_BFD_T_FID_COUNT] = {
    -2,
    -1,
    -1,
    -1,
...
void bcm56780_a0_dna_2_4_13_bfd_t_view_info_get(bcmpkt_pmd_view_info_t *info)
{
    info->view_infos = bcm56780_a0_dna_2_4_13_bfd_t_view_infos;
    info->view_types = bcm56780_a0_dna_2_4_13_bfd_t_view_types;
