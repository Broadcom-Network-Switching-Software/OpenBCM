...
static uint32_t bcmpkt_ifa_metadata_t_hop_limit_current_length_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_IFA_METADATA_T_HOP_LIMIT_CURRENT_LENGTH with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_ifa_metadata_t_hop_limit_current_length_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_IFA_METADATA_T_HOP_LIMIT_CURRENT_LENGTH with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_ifa_metadata_t_request_vector_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_IFA_METADATA_T_REQUEST_VECTOR with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_ifa_metadata_t_request_vector_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_IFA_METADATA_T_REQUEST_VECTOR with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_ifa_metadata_t_action_vector_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_IFA_METADATA_T_ACTION_VECTOR with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_ifa_metadata_t_action_vector_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_IFA_METADATA_T_ACTION_VECTOR with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_ifa_metadata_t_metadata_get(uint32_t *data) {
    ...
    val = SHR_E_PARAM;
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_IFA_METADATA_T_METADATA with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_ifa_metadata_t_metadata_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_IFA_METADATA_T_METADATA with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_ifa_metadata_t_i_support_get(uint32_t *data, uint32_t **addr) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_IFA_METADATA_T_I_SUPPORT on device BCM56780_A0_DNA_2_4_13\n")));
    return true;
}

const bcmpkt_ifa_metadata_t_fget_t bcm56780_a0_dna_2_4_13_ifa_metadata_t_fget = {
    {
...
const bcmpkt_ifa_metadata_t_fset_t bcm56780_a0_dna_2_4_13_ifa_metadata_t_fset = {
    {
...
const bcmpkt_ifa_metadata_t_figet_t bcm56780_a0_dna_2_4_13_ifa_metadata_t_figet = {
    {
        bcmpkt_ifa_metadata_t_i_support_get
    }
};

static shr_enum_map_t bcm56780_a0_dna_2_4_13_ifa_metadata_t_view_types[] = {
    {NULL, -1},
};

/* -2: unsupported, -1: global, others: view's value */
static int bcm56780_a0_dna_2_4_13_ifa_metadata_t_view_infos[BCMPKT_IFA_METADATA_T_FID_COUNT] = {
    -1,
    -1,
    -1,
    -1,
...
void bcm56780_a0_dna_2_4_13_ifa_metadata_t_view_info_get(bcmpkt_pmd_view_info_t *info)
{
    info->view_infos = bcm56780_a0_dna_2_4_13_ifa_metadata_t_view_infos;
    info->view_types = bcm56780_a0_dna_2_4_13_ifa_metadata_t_view_types;
