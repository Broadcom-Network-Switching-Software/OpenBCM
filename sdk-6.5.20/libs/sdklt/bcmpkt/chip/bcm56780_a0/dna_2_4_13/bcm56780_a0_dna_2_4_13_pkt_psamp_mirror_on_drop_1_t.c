...
static uint32_t bcmpkt_psamp_mirror_on_drop_1_t_user_meta_data_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_PSAMP_MIRROR_ON_DROP_1_T_USER_META_DATA with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_psamp_mirror_on_drop_1_t_user_meta_data_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_PSAMP_MIRROR_ON_DROP_1_T_USER_META_DATA with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_psamp_mirror_on_drop_1_t_sampled_length_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_PSAMP_MIRROR_ON_DROP_1_T_SAMPLED_LENGTH with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_psamp_mirror_on_drop_1_t_sampled_length_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_PSAMP_MIRROR_ON_DROP_1_T_SAMPLED_LENGTH with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_psamp_mirror_on_drop_1_t_var_len_indicator_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_PSAMP_MIRROR_ON_DROP_1_T_VAR_LEN_INDICATOR with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_psamp_mirror_on_drop_1_t_var_len_indicator_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_PSAMP_MIRROR_ON_DROP_1_T_VAR_LEN_INDICATOR with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_psamp_mirror_on_drop_1_t_mirror_on_drop_obj_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_PSAMP_MIRROR_ON_DROP_1_T_MIRROR_ON_DROP_OBJ with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_psamp_mirror_on_drop_1_t_mirror_on_drop_obj_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_PSAMP_MIRROR_ON_DROP_1_T_MIRROR_ON_DROP_OBJ with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_psamp_mirror_on_drop_1_t_mmu_drop_ctrl_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_PSAMP_MIRROR_ON_DROP_1_T_MMU_DROP_CTRL with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_psamp_mirror_on_drop_1_t_mmu_drop_ctrl_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_PSAMP_MIRROR_ON_DROP_1_T_MMU_DROP_CTRL with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_psamp_mirror_on_drop_1_t_ing_drop_reason_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_PSAMP_MIRROR_ON_DROP_1_T_ING_DROP_REASON with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_psamp_mirror_on_drop_1_t_ing_drop_reason_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_PSAMP_MIRROR_ON_DROP_1_T_ING_DROP_REASON with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_psamp_mirror_on_drop_1_t_i_support_get(uint32_t *data, uint32_t **addr) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_PSAMP_MIRROR_ON_DROP_1_T_I_SUPPORT on device BCM56780_A0_DNA_2_4_13\n")));
    return true;
}

const bcmpkt_psamp_mirror_on_drop_1_t_fget_t bcm56780_a0_dna_2_4_13_psamp_mirror_on_drop_1_t_fget = {
    {
...
const bcmpkt_psamp_mirror_on_drop_1_t_fset_t bcm56780_a0_dna_2_4_13_psamp_mirror_on_drop_1_t_fset = {
    {
...
const bcmpkt_psamp_mirror_on_drop_1_t_figet_t bcm56780_a0_dna_2_4_13_psamp_mirror_on_drop_1_t_figet = {
    {
        bcmpkt_psamp_mirror_on_drop_1_t_i_support_get
    }
};

static shr_enum_map_t bcm56780_a0_dna_2_4_13_psamp_mirror_on_drop_1_t_view_types[] = {
    {NULL, -1},
};

/* -2: unsupported, -1: global, others: view's value */
static int bcm56780_a0_dna_2_4_13_psamp_mirror_on_drop_1_t_view_infos[BCMPKT_PSAMP_MIRROR_ON_DROP_1_T_FID_COUNT] = {
    -1,
    -1,
    -1,
    -1,
...
void bcm56780_a0_dna_2_4_13_psamp_mirror_on_drop_1_t_view_info_get(bcmpkt_pmd_view_info_t *info)
{
    info->view_infos = bcm56780_a0_dna_2_4_13_psamp_mirror_on_drop_1_t_view_infos;
    info->view_types = bcm56780_a0_dna_2_4_13_psamp_mirror_on_drop_1_t_view_types;
