...
static uint32_t bcmpkt_tcp_last_16bytes_t_hdr_len_and_flags_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_TCP_LAST_16BYTES_T_HDR_LEN_AND_FLAGS with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_tcp_last_16bytes_t_hdr_len_and_flags_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_TCP_LAST_16BYTES_T_HDR_LEN_AND_FLAGS with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_tcp_last_16bytes_t_seq_num_get(uint32_t *data) {
    ...
    val = SHR_E_PARAM;
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_TCP_LAST_16BYTES_T_SEQ_NUM with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_tcp_last_16bytes_t_seq_num_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_TCP_LAST_16BYTES_T_SEQ_NUM with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_tcp_last_16bytes_t_checksum_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_TCP_LAST_16BYTES_T_CHECKSUM with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_tcp_last_16bytes_t_checksum_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_TCP_LAST_16BYTES_T_CHECKSUM with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_tcp_last_16bytes_t_ack_num_get(uint32_t *data) {
    ...
    val = SHR_E_PARAM;
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_TCP_LAST_16BYTES_T_ACK_NUM with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_tcp_last_16bytes_t_ack_num_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_TCP_LAST_16BYTES_T_ACK_NUM with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_tcp_last_16bytes_t_urgent_ptr_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_TCP_LAST_16BYTES_T_URGENT_PTR with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_tcp_last_16bytes_t_urgent_ptr_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_TCP_LAST_16BYTES_T_URGENT_PTR with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_tcp_last_16bytes_t_win_size_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_TCP_LAST_16BYTES_T_WIN_SIZE with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static void bcmpkt_tcp_last_16bytes_t_win_size_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_TCP_LAST_16BYTES_T_WIN_SIZE with value %u on device BCM56780_A0_DNA_2_4_13\n"), val));
...
static uint32_t bcmpkt_tcp_last_16bytes_t_i_support_get(uint32_t *data, uint32_t **addr) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_TCP_LAST_16BYTES_T_I_SUPPORT on device BCM56780_A0_DNA_2_4_13\n")));
    return true;
}

const bcmpkt_tcp_last_16bytes_t_fget_t bcm56780_a0_dna_2_4_13_tcp_last_16bytes_t_fget = {
    {
...
const bcmpkt_tcp_last_16bytes_t_fset_t bcm56780_a0_dna_2_4_13_tcp_last_16bytes_t_fset = {
    {
...
const bcmpkt_tcp_last_16bytes_t_figet_t bcm56780_a0_dna_2_4_13_tcp_last_16bytes_t_figet = {
    {
        bcmpkt_tcp_last_16bytes_t_i_support_get
    }
};

static shr_enum_map_t bcm56780_a0_dna_2_4_13_tcp_last_16bytes_t_view_types[] = {
    {NULL, -1},
};

/* -2: unsupported, -1: global, others: view's value */
static int bcm56780_a0_dna_2_4_13_tcp_last_16bytes_t_view_infos[BCMPKT_TCP_LAST_16BYTES_T_FID_COUNT] = {
    -1,
    -1,
    -1,
    -1,
...
void bcm56780_a0_dna_2_4_13_tcp_last_16bytes_t_view_info_get(bcmpkt_pmd_view_info_t *info)
{
    info->view_infos = bcm56780_a0_dna_2_4_13_tcp_last_16bytes_t_view_infos;
    info->view_types = bcm56780_a0_dna_2_4_13_tcp_last_16bytes_t_view_types;
