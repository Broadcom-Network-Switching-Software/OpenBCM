...
static uint32_t bcmpkt_rarp_t_hardware_type_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_RARP_T_HARDWARE_TYPE with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_rarp_t_hardware_type_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_RARP_T_HARDWARE_TYPE with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_rarp_t_sender_ha_get(uint32_t *data) {
    ...
    val = SHR_E_PARAM;
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_RARP_T_SENDER_HA with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_rarp_t_sender_ha_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_RARP_T_SENDER_HA with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_rarp_t_hardware_len_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_RARP_T_HARDWARE_LEN with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_rarp_t_hardware_len_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_RARP_T_HARDWARE_LEN with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_rarp_t_target_ha_get(uint32_t *data) {
    ...
    val = SHR_E_PARAM;
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_RARP_T_TARGET_HA with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_rarp_t_target_ha_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_RARP_T_TARGET_HA with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_rarp_t_target_ip_get(uint32_t *data) {
    ...
    val = SHR_E_PARAM;
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_RARP_T_TARGET_IP with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_rarp_t_target_ip_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_RARP_T_TARGET_IP with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_rarp_t_operation_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_RARP_T_OPERATION with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_rarp_t_operation_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_RARP_T_OPERATION with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_rarp_t_sender_ip_get(uint32_t *data) {
    ...
    val = SHR_E_PARAM;
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_RARP_T_SENDER_IP with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_rarp_t_sender_ip_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_RARP_T_SENDER_IP with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_rarp_t_prot_addr_len_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_RARP_T_PROT_ADDR_LEN with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_rarp_t_prot_addr_len_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_RARP_T_PROT_ADDR_LEN with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_rarp_t_protocol_type_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_RARP_T_PROTOCOL_TYPE with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_rarp_t_protocol_type_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_RARP_T_PROTOCOL_TYPE with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_rarp_t_i_support_get(uint32_t *data, uint32_t **addr) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_RARP_T_I_SUPPORT on device BCM56780_A0_INA_2_4_13\n")));
    return true;
}

const bcmpkt_rarp_t_fget_t bcm56780_a0_ina_2_4_13_rarp_t_fget = {
    {
...
const bcmpkt_rarp_t_fset_t bcm56780_a0_ina_2_4_13_rarp_t_fset = {
    {
...
const bcmpkt_rarp_t_figet_t bcm56780_a0_ina_2_4_13_rarp_t_figet = {
    {
        bcmpkt_rarp_t_i_support_get
    }
};

static shr_enum_map_t bcm56780_a0_ina_2_4_13_rarp_t_view_types[] = {
    {NULL, -1},
};

/* -2: unsupported, -1: global, others: view's value */
static int bcm56780_a0_ina_2_4_13_rarp_t_view_infos[BCMPKT_RARP_T_FID_COUNT] = {
    -1,
    -1,
    -1,
    -1,
...
void bcm56780_a0_ina_2_4_13_rarp_t_view_info_get(bcmpkt_pmd_view_info_t *info)
{
    info->view_infos = bcm56780_a0_ina_2_4_13_rarp_t_view_infos;
    info->view_types = bcm56780_a0_ina_2_4_13_rarp_t_view_types;
