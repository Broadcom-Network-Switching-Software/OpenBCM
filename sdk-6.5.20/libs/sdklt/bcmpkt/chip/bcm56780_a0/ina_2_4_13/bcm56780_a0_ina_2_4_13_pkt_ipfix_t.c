...
static uint32_t bcmpkt_ipfix_t_length_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_IPFIX_T_LENGTH with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_ipfix_t_length_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_IPFIX_T_LENGTH with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_ipfix_t_version_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_IPFIX_T_VERSION with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_ipfix_t_version_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_IPFIX_T_VERSION with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_ipfix_t_sequence_num_get(uint32_t *data) {
    ...
    val = SHR_E_PARAM;
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_IPFIX_T_SEQUENCE_NUM with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_ipfix_t_sequence_num_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_IPFIX_T_SEQUENCE_NUM with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_ipfix_t_export_time_get(uint32_t *data) {
    ...
    val = SHR_E_PARAM;
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_IPFIX_T_EXPORT_TIME with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_ipfix_t_export_time_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_IPFIX_T_EXPORT_TIME with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_ipfix_t_obs_domain_id_get(uint32_t *data) {
    ...
    val = SHR_E_PARAM;
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_IPFIX_T_OBS_DOMAIN_ID with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_ipfix_t_obs_domain_id_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_IPFIX_T_OBS_DOMAIN_ID with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_ipfix_t_i_support_get(uint32_t *data, uint32_t **addr) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_IPFIX_T_I_SUPPORT on device BCM56780_A0_INA_2_4_13\n")));
    return true;
}

const bcmpkt_ipfix_t_fget_t bcm56780_a0_ina_2_4_13_ipfix_t_fget = {
    {
...
const bcmpkt_ipfix_t_fset_t bcm56780_a0_ina_2_4_13_ipfix_t_fset = {
    {
...
const bcmpkt_ipfix_t_figet_t bcm56780_a0_ina_2_4_13_ipfix_t_figet = {
    {
        bcmpkt_ipfix_t_i_support_get
    }
};

static shr_enum_map_t bcm56780_a0_ina_2_4_13_ipfix_t_view_types[] = {
    {NULL, -1},
};

/* -2: unsupported, -1: global, others: view's value */
static int bcm56780_a0_ina_2_4_13_ipfix_t_view_infos[BCMPKT_IPFIX_T_FID_COUNT] = {
    -1,
    -1,
    -1,
    -1,
...
void bcm56780_a0_ina_2_4_13_ipfix_t_view_info_get(bcmpkt_pmd_view_info_t *info)
{
    info->view_infos = bcm56780_a0_ina_2_4_13_ipfix_t_view_infos;
    info->view_types = bcm56780_a0_ina_2_4_13_ipfix_t_view_types;
