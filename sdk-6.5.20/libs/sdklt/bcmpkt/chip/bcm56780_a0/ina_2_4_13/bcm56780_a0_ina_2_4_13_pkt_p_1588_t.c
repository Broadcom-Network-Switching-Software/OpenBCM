...
static uint32_t bcmpkt_p_1588_t_msg_type_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_P_1588_T_MSG_TYPE with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_p_1588_t_msg_type_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_P_1588_T_MSG_TYPE with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_p_1588_t_correction_get(uint32_t *data) {
    ...
    val = SHR_E_PARAM;
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_P_1588_T_CORRECTION with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_p_1588_t_correction_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_P_1588_T_CORRECTION with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_p_1588_t_srcportid_get(uint32_t *data) {
    ...
    val = SHR_E_PARAM;
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_P_1588_T_SRCPORTID with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_p_1588_t_srcportid_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_P_1588_T_SRCPORTID with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_p_1588_t_cntrl_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_P_1588_T_CNTRL with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_p_1588_t_cntrl_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_P_1588_T_CNTRL with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_p_1588_t_reserved1_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_P_1588_T_RESERVED1 with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_p_1588_t_reserved1_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_P_1588_T_RESERVED1 with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_p_1588_t_reserved3_get(uint32_t *data) {
    ...
    val = SHR_E_PARAM;
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_P_1588_T_RESERVED3 with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_p_1588_t_reserved3_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_P_1588_T_RESERVED3 with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_p_1588_t_reserved2_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_P_1588_T_RESERVED2 with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_p_1588_t_reserved2_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_P_1588_T_RESERVED2 with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_p_1588_t_seq_id_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_P_1588_T_SEQ_ID with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_p_1588_t_seq_id_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_P_1588_T_SEQ_ID with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_p_1588_t_logmsginterval_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_P_1588_T_LOGMSGINTERVAL with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_p_1588_t_logmsginterval_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_P_1588_T_LOGMSGINTERVAL with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_p_1588_t_domain_nb_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_P_1588_T_DOMAIN_NB with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_p_1588_t_domain_nb_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_P_1588_T_DOMAIN_NB with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_p_1588_t_msg_length_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_P_1588_T_MSG_LENGTH with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_p_1588_t_msg_length_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_P_1588_T_MSG_LENGTH with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_p_1588_t_version_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_P_1588_T_VERSION with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_p_1588_t_version_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_P_1588_T_VERSION with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_p_1588_t_transportspec_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_P_1588_T_TRANSPORTSPEC with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_p_1588_t_transportspec_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_P_1588_T_TRANSPORTSPEC with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_p_1588_t_flags_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_P_1588_T_FLAGS with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_p_1588_t_flags_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_P_1588_T_FLAGS with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_p_1588_t_i_support_get(uint32_t *data, uint32_t **addr) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_P_1588_T_I_SUPPORT on device BCM56780_A0_INA_2_4_13\n")));
    return true;
}

const bcmpkt_p_1588_t_fget_t bcm56780_a0_ina_2_4_13_p_1588_t_fget = {
    {
...
const bcmpkt_p_1588_t_fset_t bcm56780_a0_ina_2_4_13_p_1588_t_fset = {
    {
...
const bcmpkt_p_1588_t_figet_t bcm56780_a0_ina_2_4_13_p_1588_t_figet = {
    {
        bcmpkt_p_1588_t_i_support_get
    }
};

static shr_enum_map_t bcm56780_a0_ina_2_4_13_p_1588_t_view_types[] = {
    {NULL, -1},
};

/* -2: unsupported, -1: global, others: view's value */
static int bcm56780_a0_ina_2_4_13_p_1588_t_view_infos[BCMPKT_P_1588_T_FID_COUNT] = {
    -1,
    -1,
    -2,
    -1,
...
void bcm56780_a0_ina_2_4_13_p_1588_t_view_info_get(bcmpkt_pmd_view_info_t *info)
{
    info->view_infos = bcm56780_a0_ina_2_4_13_p_1588_t_view_infos;
    info->view_types = bcm56780_a0_ina_2_4_13_p_1588_t_view_types;
