...
static uint32_t bcmpkt_sflow_shim_2_t_user_meta_data_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_SFLOW_SHIM_2_T_USER_META_DATA with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_sflow_shim_2_t_user_meta_data_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_SFLOW_SHIM_2_T_USER_META_DATA with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_sflow_shim_2_t_sequence_num_get(uint32_t *data) {
    ...
    val = SHR_E_PARAM;
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_SFLOW_SHIM_2_T_SEQUENCE_NUM with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_sflow_shim_2_t_sequence_num_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_SFLOW_SHIM_2_T_SEQUENCE_NUM with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_sflow_shim_2_t_i_support_get(uint32_t *data, uint32_t **addr) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_SFLOW_SHIM_2_T_I_SUPPORT on device BCM56780_A0_INA_2_4_13\n")));
    return true;
}

const bcmpkt_sflow_shim_2_t_fget_t bcm56780_a0_ina_2_4_13_sflow_shim_2_t_fget = {
    {
...
const bcmpkt_sflow_shim_2_t_fset_t bcm56780_a0_ina_2_4_13_sflow_shim_2_t_fset = {
    {
...
const bcmpkt_sflow_shim_2_t_figet_t bcm56780_a0_ina_2_4_13_sflow_shim_2_t_figet = {
    {
        bcmpkt_sflow_shim_2_t_i_support_get
    }
};

static shr_enum_map_t bcm56780_a0_ina_2_4_13_sflow_shim_2_t_view_types[] = {
    {NULL, -1},
};

/* -2: unsupported, -1: global, others: view's value */
static int bcm56780_a0_ina_2_4_13_sflow_shim_2_t_view_infos[BCMPKT_SFLOW_SHIM_2_T_FID_COUNT] = {
    -1,
    -1,
};

void bcm56780_a0_ina_2_4_13_sflow_shim_2_t_view_info_get(bcmpkt_pmd_view_info_t *info)
{
    info->view_infos = bcm56780_a0_ina_2_4_13_sflow_shim_2_t_view_infos;
    info->view_types = bcm56780_a0_ina_2_4_13_sflow_shim_2_t_view_types;
