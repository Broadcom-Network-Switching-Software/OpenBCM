...
static uint32_t bcmpkt_psamp_mirror_on_drop_0_t_ingress_port_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_PSAMP_MIRROR_ON_DROP_0_T_INGRESS_PORT with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_psamp_mirror_on_drop_0_t_ingress_port_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_PSAMP_MIRROR_ON_DROP_0_T_INGRESS_PORT with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_psamp_mirror_on_drop_0_t_egress_mod_port_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_PSAMP_MIRROR_ON_DROP_0_T_EGRESS_MOD_PORT with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_psamp_mirror_on_drop_0_t_egress_mod_port_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_PSAMP_MIRROR_ON_DROP_0_T_EGRESS_MOD_PORT with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_psamp_mirror_on_drop_0_t_switch_id_get(uint32_t *data) {
    ...
    val = SHR_E_PARAM;
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_PSAMP_MIRROR_ON_DROP_0_T_SWITCH_ID with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_psamp_mirror_on_drop_0_t_switch_id_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_PSAMP_MIRROR_ON_DROP_0_T_SWITCH_ID with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_psamp_mirror_on_drop_0_t_length_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_PSAMP_MIRROR_ON_DROP_0_T_LENGTH with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_psamp_mirror_on_drop_0_t_length_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_PSAMP_MIRROR_ON_DROP_0_T_LENGTH with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_psamp_mirror_on_drop_0_t_obs_time_s_get(uint32_t *data) {
    ...
    val = SHR_E_PARAM;
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_PSAMP_MIRROR_ON_DROP_0_T_OBS_TIME_S with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_psamp_mirror_on_drop_0_t_obs_time_s_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_PSAMP_MIRROR_ON_DROP_0_T_OBS_TIME_S with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_psamp_mirror_on_drop_0_t_template_id_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_PSAMP_MIRROR_ON_DROP_0_T_TEMPLATE_ID with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_psamp_mirror_on_drop_0_t_template_id_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_PSAMP_MIRROR_ON_DROP_0_T_TEMPLATE_ID with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_psamp_mirror_on_drop_0_t_obs_time_ns_get(uint32_t *data) {
    ...
    val = SHR_E_PARAM;
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_PSAMP_MIRROR_ON_DROP_0_T_OBS_TIME_NS with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_psamp_mirror_on_drop_0_t_obs_time_ns_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_PSAMP_MIRROR_ON_DROP_0_T_OBS_TIME_NS with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_psamp_mirror_on_drop_0_t_i_support_get(uint32_t *data, uint32_t **addr) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_PSAMP_MIRROR_ON_DROP_0_T_I_SUPPORT on device BCM56780_A0_INA_2_4_13\n")));
    return true;
}

const bcmpkt_psamp_mirror_on_drop_0_t_fget_t bcm56780_a0_ina_2_4_13_psamp_mirror_on_drop_0_t_fget = {
    {
...
const bcmpkt_psamp_mirror_on_drop_0_t_fset_t bcm56780_a0_ina_2_4_13_psamp_mirror_on_drop_0_t_fset = {
    {
...
const bcmpkt_psamp_mirror_on_drop_0_t_figet_t bcm56780_a0_ina_2_4_13_psamp_mirror_on_drop_0_t_figet = {
    {
        bcmpkt_psamp_mirror_on_drop_0_t_i_support_get
    }
};

static shr_enum_map_t bcm56780_a0_ina_2_4_13_psamp_mirror_on_drop_0_t_view_types[] = {
    {NULL, -1},
};

/* -2: unsupported, -1: global, others: view's value */
static int bcm56780_a0_ina_2_4_13_psamp_mirror_on_drop_0_t_view_infos[BCMPKT_PSAMP_MIRROR_ON_DROP_0_T_FID_COUNT] = {
    -1,
    -1,
    -1,
    -1,
...
void bcm56780_a0_ina_2_4_13_psamp_mirror_on_drop_0_t_view_info_get(bcmpkt_pmd_view_info_t *info)
{
    info->view_infos = bcm56780_a0_ina_2_4_13_psamp_mirror_on_drop_0_t_view_infos;
    info->view_types = bcm56780_a0_ina_2_4_13_psamp_mirror_on_drop_0_t_view_types;
