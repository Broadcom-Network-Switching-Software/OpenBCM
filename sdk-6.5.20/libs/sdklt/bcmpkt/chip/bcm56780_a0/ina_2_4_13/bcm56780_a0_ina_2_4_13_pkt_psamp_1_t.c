...
static uint32_t bcmpkt_psamp_1_t_user_meta_data_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_PSAMP_1_T_USER_META_DATA with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_psamp_1_t_user_meta_data_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_PSAMP_1_T_USER_META_DATA with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_psamp_1_t_sampled_length_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_PSAMP_1_T_SAMPLED_LENGTH with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_psamp_1_t_sampled_length_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_PSAMP_1_T_SAMPLED_LENGTH with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_psamp_1_t_dlb_id_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_PSAMP_1_T_DLB_ID with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_psamp_1_t_dlb_id_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_PSAMP_1_T_DLB_ID with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_psamp_1_t_ingress_port_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_PSAMP_1_T_INGRESS_PORT with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_psamp_1_t_ingress_port_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_PSAMP_1_T_INGRESS_PORT with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_psamp_1_t_egress_port_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_PSAMP_1_T_EGRESS_PORT with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_psamp_1_t_egress_port_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_PSAMP_1_T_EGRESS_PORT with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_psamp_1_t_epoch_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_PSAMP_1_T_EPOCH with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_psamp_1_t_epoch_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_PSAMP_1_T_EPOCH with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_psamp_1_t_variable_flag_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_PSAMP_1_T_VARIABLE_FLAG with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static void bcmpkt_psamp_1_t_variable_flag_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_PSAMP_1_T_VARIABLE_FLAG with value %u on device BCM56780_A0_INA_2_4_13\n"), val));
...
static uint32_t bcmpkt_psamp_1_t_i_support_get(uint32_t *data, uint32_t **addr) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_PSAMP_1_T_I_SUPPORT on device BCM56780_A0_INA_2_4_13\n")));
    return true;
}

const bcmpkt_psamp_1_t_fget_t bcm56780_a0_ina_2_4_13_psamp_1_t_fget = {
    {
...
const bcmpkt_psamp_1_t_fset_t bcm56780_a0_ina_2_4_13_psamp_1_t_fset = {
    {
...
const bcmpkt_psamp_1_t_figet_t bcm56780_a0_ina_2_4_13_psamp_1_t_figet = {
    {
        bcmpkt_psamp_1_t_i_support_get
    }
};

static shr_enum_map_t bcm56780_a0_ina_2_4_13_psamp_1_t_view_types[] = {
    {NULL, -1},
};

/* -2: unsupported, -1: global, others: view's value */
static int bcm56780_a0_ina_2_4_13_psamp_1_t_view_infos[BCMPKT_PSAMP_1_T_FID_COUNT] = {
    -1,
    -1,
    -1,
    -1,
...
void bcm56780_a0_ina_2_4_13_psamp_1_t_view_info_get(bcmpkt_pmd_view_info_t *info)
{
    info->view_infos = bcm56780_a0_ina_2_4_13_psamp_1_t_view_infos;
    info->view_types = bcm56780_a0_ina_2_4_13_psamp_1_t_view_types;
