...
static uint32_t bcmpkt_sflow_shim_1_t_reserved_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_SFLOW_SHIM_1_T_RESERVED with value %u on device BCM56880_A0_DNA_4_6_6\n"), val));
...
static void bcmpkt_sflow_shim_1_t_reserved_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_SFLOW_SHIM_1_T_RESERVED with value %u on device BCM56880_A0_DNA_4_6_6\n"), val));
...
static uint32_t bcmpkt_sflow_shim_1_t_sys_opcode_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_SFLOW_SHIM_1_T_SYS_OPCODE with value %u on device BCM56880_A0_DNA_4_6_6\n"), val));
...
static void bcmpkt_sflow_shim_1_t_sys_opcode_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_SFLOW_SHIM_1_T_SYS_OPCODE with value %u on device BCM56880_A0_DNA_4_6_6\n"), val));
...
static uint32_t bcmpkt_sflow_shim_1_t_flag_src_sample_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_SFLOW_SHIM_1_T_FLAG_SRC_SAMPLE with value %u on device BCM56880_A0_DNA_4_6_6\n"), val));
...
static void bcmpkt_sflow_shim_1_t_flag_src_sample_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_SFLOW_SHIM_1_T_FLAG_SRC_SAMPLE with value %u on device BCM56880_A0_DNA_4_6_6\n"), val));
...
static uint32_t bcmpkt_sflow_shim_1_t_flag_discarded_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_SFLOW_SHIM_1_T_FLAG_DISCARDED with value %u on device BCM56880_A0_DNA_4_6_6\n"), val));
...
static void bcmpkt_sflow_shim_1_t_flag_discarded_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_SFLOW_SHIM_1_T_FLAG_DISCARDED with value %u on device BCM56880_A0_DNA_4_6_6\n"), val));
...
static uint32_t bcmpkt_sflow_shim_1_t_flag_flex_sample_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_SFLOW_SHIM_1_T_FLAG_FLEX_SAMPLE with value %u on device BCM56880_A0_DNA_4_6_6\n"), val));
...
static void bcmpkt_sflow_shim_1_t_flag_flex_sample_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_SFLOW_SHIM_1_T_FLAG_FLEX_SAMPLE with value %u on device BCM56880_A0_DNA_4_6_6\n"), val));
...
static uint32_t bcmpkt_sflow_shim_1_t_flag_truncated_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_SFLOW_SHIM_1_T_FLAG_TRUNCATED with value %u on device BCM56880_A0_DNA_4_6_6\n"), val));
...
static void bcmpkt_sflow_shim_1_t_flag_truncated_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_SFLOW_SHIM_1_T_FLAG_TRUNCATED with value %u on device BCM56880_A0_DNA_4_6_6\n"), val));
...
static uint32_t bcmpkt_sflow_shim_1_t_flag_dest_sample_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_SFLOW_SHIM_1_T_FLAG_DEST_SAMPLE with value %u on device BCM56880_A0_DNA_4_6_6\n"), val));
...
static void bcmpkt_sflow_shim_1_t_flag_dest_sample_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_SFLOW_SHIM_1_T_FLAG_DEST_SAMPLE with value %u on device BCM56880_A0_DNA_4_6_6\n"), val));
...
static uint32_t bcmpkt_sflow_shim_1_t_flag_mcast_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_SFLOW_SHIM_1_T_FLAG_MCAST with value %u on device BCM56880_A0_DNA_4_6_6\n"), val));
...
static void bcmpkt_sflow_shim_1_t_flag_mcast_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_SFLOW_SHIM_1_T_FLAG_MCAST with value %u on device BCM56880_A0_DNA_4_6_6\n"), val));
...
static uint32_t bcmpkt_sflow_shim_1_t_i_support_get(uint32_t *data, uint32_t **addr) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_SFLOW_SHIM_1_T_I_SUPPORT on device BCM56880_A0_DNA_4_6_6\n")));
    return true;
}

const bcmpkt_sflow_shim_1_t_fget_t bcm56880_a0_dna_4_6_6_sflow_shim_1_t_fget = {
    {
...
const bcmpkt_sflow_shim_1_t_fset_t bcm56880_a0_dna_4_6_6_sflow_shim_1_t_fset = {
    {
...
const bcmpkt_sflow_shim_1_t_figet_t bcm56880_a0_dna_4_6_6_sflow_shim_1_t_figet = {
    {
        bcmpkt_sflow_shim_1_t_i_support_get
    }
};

static shr_enum_map_t bcm56880_a0_dna_4_6_6_sflow_shim_1_t_view_types[] = {
    {NULL, -1},
};

/* -2: unsupported, -1: global, others: view's value */
static int bcm56880_a0_dna_4_6_6_sflow_shim_1_t_view_infos[BCMPKT_SFLOW_SHIM_1_T_FID_COUNT] = {
    -1,
    -1,
    -1,
    -1,
...
void bcm56880_a0_dna_4_6_6_sflow_shim_1_t_view_info_get(bcmpkt_pmd_view_info_t *info)
{
    info->view_infos = bcm56880_a0_dna_4_6_6_sflow_shim_1_t_view_infos;
    info->view_types = bcm56880_a0_dna_4_6_6_sflow_shim_1_t_view_types;
