...
static uint32_t bcmpkt_gre_t_version_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_GRE_T_VERSION with value %u on device BCM56880_A0_DNA_4_6_6\n"), val));
...
static void bcmpkt_gre_t_version_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_GRE_T_VERSION with value %u on device BCM56880_A0_DNA_4_6_6\n"), val));
...
static uint32_t bcmpkt_gre_t_reserved_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_GRE_T_RESERVED with value %u on device BCM56880_A0_DNA_4_6_6\n"), val));
...
static void bcmpkt_gre_t_reserved_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_GRE_T_RESERVED with value %u on device BCM56880_A0_DNA_4_6_6\n"), val));
...
static uint32_t bcmpkt_gre_t_protocol_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_GRE_T_PROTOCOL with value %u on device BCM56880_A0_DNA_4_6_6\n"), val));
...
static void bcmpkt_gre_t_protocol_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_GRE_T_PROTOCOL with value %u on device BCM56880_A0_DNA_4_6_6\n"), val));
...
static uint32_t bcmpkt_gre_t_c_r_k_s_get(uint32_t *data) {
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_GRE_T_C_R_K_S with value %u on device BCM56880_A0_DNA_4_6_6\n"), val));
...
static void bcmpkt_gre_t_c_r_k_s_set(uint32_t *data, uint32_t val) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Set field BCMPKT_GRE_T_C_R_K_S with value %u on device BCM56880_A0_DNA_4_6_6\n"), val));
...
static uint32_t bcmpkt_gre_t_i_support_get(uint32_t *data, uint32_t **addr) {
    LOG_DEBUG(BSL_LS_BCMPKT_FLEX_HDR,
        (BSL_META("Get field BCMPKT_GRE_T_I_SUPPORT on device BCM56880_A0_DNA_4_6_6\n")));
    return true;
}

const bcmpkt_gre_t_fget_t bcm56880_a0_dna_4_6_6_gre_t_fget = {
    {
...
const bcmpkt_gre_t_fset_t bcm56880_a0_dna_4_6_6_gre_t_fset = {
    {
...
const bcmpkt_gre_t_figet_t bcm56880_a0_dna_4_6_6_gre_t_figet = {
    {
        bcmpkt_gre_t_i_support_get
    }
};

static shr_enum_map_t bcm56880_a0_dna_4_6_6_gre_t_view_types[] = {
    {NULL, -1},
};

/* -2: unsupported, -1: global, others: view's value */
static int bcm56880_a0_dna_4_6_6_gre_t_view_infos[BCMPKT_GRE_T_FID_COUNT] = {
    -1,
    -1,
    -1,
    -2,
...
void bcm56880_a0_dna_4_6_6_gre_t_view_info_get(bcmpkt_pmd_view_info_t *info)
{
    info->view_infos = bcm56880_a0_dna_4_6_6_gre_t_view_infos;
    info->view_types = bcm56880_a0_dna_4_6_6_gre_t_view_types;
