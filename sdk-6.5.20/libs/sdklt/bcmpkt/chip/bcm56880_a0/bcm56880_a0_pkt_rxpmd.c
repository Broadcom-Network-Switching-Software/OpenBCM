 ...
 *
 * This file provides RXPMD access functions for BCM56880_A0.
 */
...
static void bcmpkt_rxpmd_unicast_queue_set(uint32_t *data, uint32_t val)
{
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Set field BCMPKT_RXPMD_UNICAST_QUEUE with value %u on device BCM56880_A0.\n"), val));
...
static uint32_t bcmpkt_rxpmd_unicast_queue_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Get field BCMPKT_RXPMD_UNICAST_QUEUE value %u from device BCM56880_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Set field BCMPKT_RXPMD_QUEUE_NUM with value %u on device BCM56880_A0.\n"), val));
...
static uint32_t bcmpkt_rxpmd_queue_num_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Get field BCMPKT_RXPMD_QUEUE_NUM value %u from device BCM56880_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Set field BCMPKT_RXPMD_PKT_LENGTH with value %u on device BCM56880_A0.\n"), val));
...
static uint32_t bcmpkt_rxpmd_pkt_length_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Get field BCMPKT_RXPMD_PKT_LENGTH value %u from device BCM56880_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Set field BCMPKT_RXPMD_SRC_PORT_NUM with value %u on device BCM56880_A0.\n"), val));
...
static uint32_t bcmpkt_rxpmd_src_port_num_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Get field BCMPKT_RXPMD_SRC_PORT_NUM value %u from device BCM56880_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Set field BCMPKT_RXPMD_L3ONLY with value %u on device BCM56880_A0.\n"), val));
...
static uint32_t bcmpkt_rxpmd_l3only_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Get field BCMPKT_RXPMD_L3ONLY value %u from device BCM56880_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Set field BCMPKT_RXPMD_IP_ROUTED with value %u on device BCM56880_A0.\n"), val));
    WORD_FIELD_SET(data[3], 17, 1, val);
}

static uint32_t bcmpkt_rxpmd_ip_routed_get(uint32_t *data)
{
    uint32_t val;
    val = WORD_FIELD_GET(data[3], 17, 1);
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Get field BCMPKT_RXPMD_IP_ROUTED value %u from device BCM56880_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Set field BCMPKT_RXPMD_UC_SW_COPY_DROPPED with value %u on device BCM56880_A0.\n"), val));
...
static uint32_t bcmpkt_rxpmd_uc_sw_copy_dropped_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Get field BCMPKT_RXPMD_UC_SW_COPY_DROPPED value %u from device BCM56880_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Set field BCMPKT_RXPMD_SWITCH with value %u on device BCM56880_A0.\n"), val));
...
static uint32_t bcmpkt_rxpmd_switch_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Get field BCMPKT_RXPMD_SWITCH value %u from device BCM56880_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Set field BCMPKT_RXPMD_REPLICATION_OR_NHOP_INDEX with value %u on device BCM56880_A0.\n"), val));
...
static uint32_t bcmpkt_rxpmd_replication_or_nhop_index_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Get field BCMPKT_RXPMD_REPLICATION_OR_NHOP_INDEX value %u from device BCM56880_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Set field BCMPKT_RXPMD_MATCH_ID_LO with value %u on device BCM56880_A0.\n"), val));
    data[2] = val;
}
...
static uint32_t bcmpkt_rxpmd_match_id_lo_get(uint32_t *data)
{
    ...
    return data[2];
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Get field BCMPKT_RXPMD_MATCH_ID_LO value %u from device BCM56880_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Set field BCMPKT_RXPMD_MATCH_ID_HI with value %u on device BCM56880_A0.\n"), val));
...
static uint32_t bcmpkt_rxpmd_match_id_hi_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Get field BCMPKT_RXPMD_MATCH_ID_HI value %u from device BCM56880_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Set field BCMPKT_RXPMD_MPB_FLEX_DATA_TYPE with value %u on device BCM56880_A0.\n"), val));
...
static uint32_t bcmpkt_rxpmd_mpb_flex_data_type_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Get field BCMPKT_RXPMD_MPB_FLEX_DATA_TYPE value %u from device BCM56880_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Set field BCMPKT_RXPMD_INT_CN with value %u on device BCM56880_A0.\n"), val));
...
static uint32_t bcmpkt_rxpmd_int_cn_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Get field BCMPKT_RXPMD_INT_CN value %u from device BCM56880_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Set field BCMPKT_RXPMD_CNG with value %u on device BCM56880_A0.\n"), val));
...
static uint32_t bcmpkt_rxpmd_cng_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Get field BCMPKT_RXPMD_CNG value %u from device BCM56880_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Set field BCMPKT_RXPMD_EGR_ZONE_REMAP_CTRL with value %u on device BCM56880_A0.\n"), val));
...
static uint32_t bcmpkt_rxpmd_egr_zone_remap_ctrl_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Get field BCMPKT_RXPMD_EGR_ZONE_REMAP_CTRL value %u from device BCM56880_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Set field BCMPKT_RXPMD_DMA_HEADER_VERSION with value %u on device BCM56880_A0.\n"), val));
...
static uint32_t bcmpkt_rxpmd_dma_header_version_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Get field BCMPKT_RXPMD_DMA_HEADER_VERSION value %u from device BCM56880_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Set field BCMPKT_RXPMD_MULTICAST with value %u on device BCM56880_A0.\n"), val));
    WORD_FIELD_SET(data[3], 16, 1, val);
}
...
static uint32_t bcmpkt_rxpmd_multicast_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Get field BCMPKT_RXPMD_MULTICAST value %u from device BCM56880_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Set field BCMPKT_RXPMD_COPY_TO_CPU with value %u on device BCM56880_A0.\n"), val));
...
static uint32_t bcmpkt_rxpmd_copy_to_cpu_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Get field BCMPKT_RXPMD_COPY_TO_CPU value %u from device BCM56880_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Set field BCMPKT_RXPMD_TRUNCATE_CPU_COPY with value %u on device BCM56880_A0.\n"), val));
...
static uint32_t bcmpkt_rxpmd_truncate_cpu_copy_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD,
              (BSL_META("Get field BCMPKT_RXPMD_TRUNCATE_CPU_COPY value %u from device BCM56880_A0.\n"), val));
    return val;
}

static uint32_t bcmpkt_rxpmd_i_size_get(uint32_t *data, uint32_t **addr)
{
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD, (BSL_META("Get BCMPKT_RXPMD_I_SIZE on device BCM56880_A0.\n")));
    return 18;
}

static uint32_t bcmpkt_rxpmd_i_flex_data_get(uint32_t *data, uint32_t **addr)
{
    LOG_DEBUG(BSL_LS_BCMPKT_RXPMD, (BSL_META("Get field BCMPKT_RXPMD_I_FLEX_DATA address on device BCM56880_A0.\n")));
    *addr = data + 4;
    return 13;
}

void bcm56880_a0_rx_reason_encode(const bcmpkt_rx_reasons_t *reasons, uint32_t *data)
{
}
void bcm56880_a0_rx_reason_decode(const uint32_t *data, bcmpkt_rx_reasons_t *reasons)
{
}

const bcmpkt_rxpmd_fget_t bcm56880_a0_rxpmd_fget = {
    {
...
const bcmpkt_rxpmd_fset_t bcm56880_a0_rxpmd_fset = {
    {
...
const bcmpkt_rxpmd_figet_t bcm56880_a0_rxpmd_figet = {
    {
...
static shr_enum_map_t bcm56880_a0_rxpmd_view_types[] = {
    {NULL, -1},
};

/* -2: unsupported, -1: global, others: view's value */
static int bcm56880_a0_rxpmd_view_infos[BCMPKT_RXPMD_FID_COUNT] = {
     -1, -1, -2, -2, -2, -1, -1, -2, -2, -2, -2, -2, -2, -2, -2, -2,
     -2, -2, -2, -2, -2, -2, -2, -2, -2, -1, -1, -2, -2, -1, -1, -2,
     -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2,
     -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2,
     -2, -1, -2, -2, -2, -2, -2, -2, -2, -1, -1, -2, -1, -1, -1, -2,
     -2, -2, -1, -1, -2, -2, -2, -2, -1, -1, -1, -2, -2, -2, -2, -2,
     -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2,
     -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2, -2,
     -2, -2,
};
...
void bcm56880_a0_rxpmd_view_info_get(bcmpkt_pmd_view_info_t *info)
{
    info->view_infos = bcm56880_a0_rxpmd_view_infos;
    info->view_types = bcm56880_a0_rxpmd_view_types;
