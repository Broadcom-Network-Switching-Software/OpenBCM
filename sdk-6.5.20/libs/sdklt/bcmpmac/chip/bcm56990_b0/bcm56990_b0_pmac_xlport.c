/*! \file bcm56990_b0_pmac_xlport.c
 *
 * The XLPORT driver for BCM56990.
 */
/*
...
#include <bcmpmac/chip/bcm56990_b0_xlport_defs.h>
...
static int
bcm56990_b0_xlport_port_init(bcmpmac_access_t *pa, bcmpmac_pport_t port,
                             uint32_t init)
{
    int rv, ioerr = 0;
...
bcmpmac_drv_t bcm56990_b0_pmac_xlport = {
    .name = "xlport",
    ...
    .port_init = bcm56990_b0_xlport_port_init,
