/*! \file bcm56996_a0_pmac_cdport.c
 *
 * The CDPORT driver for BCM56996_A0.
 *
 * Each CDPORT on BCM56996_A0 only has 4 block ports, and its lane combination
...
#include <bcmpmac/chip/bcm56996_a0_cdport_defs.h>
...
static int
bcm56996_a0_cdport_tx_flush(bcmpmac_access_t *pa, bcmpmac_pport_t port,
                            uint32_t flush)
{
    int ioerr = 0;
    shr_timeout_t to;
...
static int
bcm56996_a0_cdport_op_exec(bcmpmac_access_t *pa, bcmpmac_pport_t port,
                           const char *op, uint32_t op_param)
{
    ...
    const bcmpmac_drv_op_hdl_t ops[] = {
        ...
        { "tx_flush", bcm56996_a0_cdport_tx_flush },
...
static int
bcm56996_a0_cdport_port_init(bcmpmac_access_t *pa, bcmpmac_pport_t port,
                             uint32_t init)
{
    int rv, ioerr = 0;
    CDMAC_TX_CTRLr_t tx_ctrl;
    ...
    /* Set TX_THRESHOLD as 2 for BCM56996. */
    ioerr += READ_CDMAC_TX_CTRLr(pa, port, &tx_ctrl);
...
bcmpmac_drv_t bcm56996_a0_pmac_cdport = {
    .name = "cdport",
    ...
    .port_init = bcm56996_a0_cdport_port_init,
    ...
    .core_mode_set = cdport_gen3_8x100_core_mode_set,
    .op_exec = bcm56996_a0_cdport_op_exec,
    ...
    .port_mode_set = cdport_gen3_8x100_port_mode_set,
