/*! \file bcm56880_a0_pmac_cdport.c
 *
 * The CDPORT driver for BCM56880.
 */
/*
...
#include <bcmpmac/chip/bcm56880_a0_cdport_defs.h>
...
static int
bcm56880_a0_cdport_port_init(bcmpmac_access_t *pa, bcmpmac_pport_t port,
                             uint32_t init)
{
    int rv, ioerr = 0;
...
static int
bcm56880_a0_cdport_tx_flush(bcmpmac_access_t *pa, bcmpmac_pport_t port,
                            uint32_t flush)
{
    int ioerr = 0;
    shr_timeout_t to;
...
static int
bcm56880_a0_cdport_op_exec(bcmpmac_access_t *pa, bcmpmac_pport_t port,
                           const char *op, uint32_t op_param)
{
    ...
    const bcmpmac_drv_op_hdl_t ops[] = {
        ...
        { "tx_flush", bcm56880_a0_cdport_tx_flush },
...
static inline int
bcm56880_a0_cdmac_control_set(bcmpmac_access_t *pa, bcmpmac_pport_t port,
                              uint32_t reset)
{
    int ioerr = 0;
...
static inline int
bcm56880_a0_cdmac_control_get(bcmpmac_access_t *pa, bcmpmac_pport_t port,
                              uint32_t *reset)
{
    int ioerr = 0;
    CDPORT_MAC_CONTROLr_t pmac_ctrl;
...
bcmpmac_drv_t bcm56880_a0_pmac_cdport = {
    .name = "cdport",
    ...
    .port_init = bcm56880_a0_cdport_port_init,
    ...
    .op_exec = bcm56880_a0_cdport_op_exec,
    ...
    .port_mac_control_set = bcm56880_a0_cdmac_control_set,
    .port_mac_control_get = bcm56880_a0_cdmac_control_get,
