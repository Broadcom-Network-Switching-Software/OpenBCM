...
#include <bcmltx/bcmport/bcmltx_port_vlan_xlate_icfi_mapped.h>

#define BSL_LOG_MODULE BSL_LS_BCMLTX_PORT

/*
 * \brief PORT_VLAN_XLATE.ICFI_MAPPED array forward transform
 *
                                             ...
                                             const bcmltd_transform_arg_t *arg)
{
    ...
    LOG_VERBOSE(BSL_LOG_MODULE,
                (BSL_META_U(unit,
                            "\t bcmltx_port_vlan_xlate_icfi_mapped_transform\n")));
    out->count = 0;
...
/*
 * \brief PORT_VLAN_XLATE.ICFI_MAPPED array reverse transform
 *
 * \param [in]  unit            Unit number.
 ...
 */
int
bcmltx_port_vlan_xlate_icfi_mapped_rev_transform(int unit,
                                                 const bcmltd_fields_t *in,
                                                 bcmltd_fields_t *out,
                                                 const bcmltd_transform_arg_t *arg)
{
