/*! \file bcmltx_l2_fdb_vlan_static_dest.c
 *
...
#include <bcmltx/bcml2/bcmltx_l2_fdb_vlan_static_dest.h>
                                         ...
                                         const bcmltd_transform_arg_t *arg)
{
    ...
    LOG_VERBOSE(BSL_LOG_MODULE,
                (BSL_META_U(unit,
                            "\t bcml2_fdb_vlan_static_dest_transform\n")));
                                             ...
                                             const bcmltd_transform_arg_t *arg)
{
    ...
    LOG_VERBOSE(BSL_LOG_MODULE,
                (BSL_META_U(unit,
                            "\t bcml2_fdb_vlan_static_dest_rev_transform\n")));
    for (i = 0; i < in->count; i++) {
