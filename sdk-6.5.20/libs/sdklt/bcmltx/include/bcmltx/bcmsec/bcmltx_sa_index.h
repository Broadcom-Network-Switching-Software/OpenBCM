/*! \file bcmltx_sa_index.h
 *
 * SEC SA related table's index transform handler
 */
/*
...
#ifndef BCMLTX_SA_INDEX_H
#define BCMLTX_SA_INDEX_H
 ...
 */
extern int
bcmltx_sa_index_rev_transform(int unit,
                              const bcmltd_fields_t *in,
                              bcmltd_fields_t *out,
                              const bcmltd_transform_arg_t *arg);

#endif /* BCMLTX_SA_INDEX_H */
