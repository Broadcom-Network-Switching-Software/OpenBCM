/*! \file bcmltx_lb_hash_table_select_dlb.h
 *
...
#ifndef BCMLTX_LB_HASH_TABLE_SELECT_DLB_TRUNK_H
#define BCMLTX_LB_HASH_TABLE_SELECT_DLB_TRUNK_H
...
bcmltx_lb_hash_table_select_dlb_rev_transform(int unit,
                                              ...
                                              bcmltd_fields_t *out,
                                              const bcmltd_transform_arg_t *arg);
#endif /* BCMLTX_LB_HASH_TABLE_SELECT_DLB_TRUNK_H */
