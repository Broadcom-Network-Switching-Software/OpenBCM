/*! \file bcmtm_imm_q_assignment_info.c
 *
 * IMM interface for TM_Q_ASSIGNMENT_INFO logical table.
 */
/*
 ...
 */
static int
bcmtm_q_assignment_info_validate(int unit,
                                 bcmltd_sid_t sid,
...
bcmtm_q_assignment_info_imm_register(int unit)
{
    bcmimm_lt_cb_t bcmtm_q_assign_imm_cb = {
        .validate = bcmtm_q_assignment_info_validate,
    };
