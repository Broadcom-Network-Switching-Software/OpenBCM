...
#ifndef BCM56996_A0_TM_THD_INTERNAL_H
#define BCM56996_A0_TM_THD_INTERNAL_H


/*! Alpha values for dynamic threshold. */
typedef enum soc_th4g_drop_limit_alpha_value_e {
    SOC_TH4G_COSQ_DROP_LIMIT_ALPHA_1_128, /* 1/128 */
    SOC_TH4G_COSQ_DROP_LIMIT_ALPHA_1_64,  /* 1/64 */
    SOC_TH4G_COSQ_DROP_LIMIT_ALPHA_1_32,  /* 1/32 */
    SOC_TH4G_COSQ_DROP_LIMIT_ALPHA_1_16,  /* 1/16 */
    SOC_TH4G_COSQ_DROP_LIMIT_ALPHA_1_8,   /* 1/8 */
    SOC_TH4G_COSQ_DROP_LIMIT_ALPHA_1_4,   /* 1/4 */
    SOC_TH4G_COSQ_DROP_LIMIT_ALPHA_1_2,   /* 1/2 */
    SOC_TH4G_COSQ_DROP_LIMIT_ALPHA_1,     /* 1 */
    SOC_TH4G_COSQ_DROP_LIMIT_ALPHA_2,     /* 2 */
    SOC_TH4G_COSQ_DROP_LIMIT_ALPHA_4,     /* 4 */
    SOC_TH4G_COSQ_DROP_LIMIT_ALPHA_8,     /* 8 */
    SOC_TH4G_COSQ_DROP_LIMIT_ALPHA_COUNT  /* Must be last! */
} soc_th4g_drop_limit_alpha_value_t;
...
#define TH4G_MMU_PORTS_OFFSET_PER_PIPE   32
/*! MMU ports per device. */
#define TH4G_MMU_PORTS_PER_DEV           (32 * 16)
/*! MMU max packet length. */
#define TH4G_MMU_MAX_PACKET_BYTES        9416
/*! MMU packet header length. */
#define TH4G_MMU_PACKET_HEADER_BYTES     48
/*! MMU jumbo packet length. */
#define TH4G_MMU_JUMBO_FRAME_BYTES       9216
/*! MMU default MTU length. */
#define TH4G_MMU_DEFAULT_MTU_BYTES       1536

/*! MMU physical cells per itm. */
#define TH4G_MMU_PHYSICAL_CELLS_PER_ITM  243712
/*! MMU total cells per itm. */
#define TH4G_MMU_TOTAL_CELLS_PER_ITM     231446
/*! MMU reserved cfap cells per itm. */
#define TH4G_MMU_RSVD_CELLS_CFAP_PER_ITM 716

/*! MMU thdi buffer max sp cell limit . */
#define TH4G_THDI_BUFFER_CELL_LIMIT_SP_MAX           TH4G_MMU_TOTAL_CELLS_PER_ITM
/*! MMU thdi headroom buffer max cell limit . */
#define TH4G_THDI_HDRM_BUFFER_CELL_LIMIT_HP_MAX      TH4G_MMU_TOTAL_CELLS_PER_ITM

/*! MMU bytes per cell. */
#define TH4G_MMU_BYTES_PER_CELL          254
/*! MMU priority group number. */
#define TH4G_MMU_NUM_PG                  8
/*! MMU pool number. */
#define TH4G_MMU_NUM_POOL                4
/*! MMU rqe queue number. */
#define TH4G_MMU_NUM_RQE_QUEUES          9
/*! MMU internal priority number. */
#define TH4G_MMU_NUM_INT_PRI             16
/*! MMU profile max number. */
#define TH4G_MMU_NUM_MAX_PROFILES        8

/*! MMU queue group max number. */
#define SOC_TH4G_MMU_CFG_QGROUP_MAX      272

/*! MMU jumbo packet length. */
#define TH4G_MMU_JUMBO_PACKET_SIZE TH4G_MMU_CFG_MMU_BYTES_TO_CELLS( TH4G_MMU_JUMBO_FRAME_BYTES + \
                                                               TH4G_MMU_PACKET_HEADER_BYTES, \
                                                               TH4G_MMU_BYTES_PER_CELL)

/*! MMU cpu queue number. */
#define SOC_TH4G_NUM_CPU_QUEUES          48
/*! Num UC Q's Per pipe 16 * 12 */
#define SOC_TH4G_NUM_UC_QUEUES_PER_PIPE  192
/*! Num MC Q's Per pipe (16 * 6)  + 48 CPU queues */
#define SOC_TH4G_NUM_MC_QUEUES_PER_PIPE  144

/*! MMU mcq entry per itm. */
#define SOC_TH4G_MMU_MCQ_ENTRY_PER_ITM   16384
/*! MMU rqe entry per itm. */
#define SOC_TH4G_MMU_RQE_ENTRY_PER_ITM   3072
/*! MMU reserved rqe entry per itm. */
#define SOC_TH4G_MMU_RQE_ENTRY_RSVD_PER_ITM 215

/*! MMU max physical port per pipe. */
#define SOC_TH4G_MAX_PHY_PORTS_PER_PIPE  16
/*! MMU max device port per pipe. */
#define SOC_TH4G_MAX_DEV_PORTS_PER_PIPE  17
/*! MMU port stride per pipe. */
#define SOC_TH4G_MMU_PORT_STRIDE         32
/*! MMU physical port per device. */
#define SOC_TH4G_PHY_PORTS_PER_DEV          \
    ( SOC_TH4G_MAX_PHY_PORTS_PER_PIPE * TH4G_PIPES_PER_DEV)
/*! MMU device port per device. */
#define SOC_TH4G_DEV_PORTS_PER_DEV          \
    ( SOC_TH4G_MAX_DEV_PORTS_PER_PIPE * TH4G_PIPES_PER_DEV)
/*! MMU port per device. */
#define SOC_TH4G_MMU_PORTS_PER_DEV          \
    ( SOC_TH4G_MAX_DEV_PORTS_PER_PIPE * TH4G_PIPES_PER_DEV)

/*! MMU mcq entry per itm. */
#define TH4G_MMU_TOTAL_MCQ_ENTRY(unit)   SOC_TH4G_MMU_MCQ_ENTRY_PER_ITM
/*! MMU rqe entry per itm. */
#define TH4G_MMU_TOTAL_RQE_ENTRY(unit)   SOC_TH4G_MMU_RQE_ENTRY_PER_ITM

/*! Default values for thresholds */
/*! MMU cfap bank full limit. */
#define TH4G_CFAP_BANK_FULL_LIMIT                3580
/*! MMU last packet accept default mode. */
#define TH4G_LAST_PKT_ACCEPT_MODE_DEFAULT        1
/*! MMU pool last packet accept default mode. */
#define TH4G_LAST_PKT_ACCEPT_MODE_POOL_DEFAULT   15
/*! MMU default color aware. */
#define TH4G_COLOR_AWARE_DEFAULT                 0
/*! MMU default headroom limit. */
#define TH4G_HDRM_LIMIT_DEFAULT                  0
/*! MMU spid override enable default mode. */
#define TH4G_SPID_OVERRIDE_ENABLE_DEFAULT        0
/*! MMU default spap yellow offset. */
#define TH4G_SPAP_YELLOW_OFFSET_DEFAULT          0
/*! MMU default spap red offset. */
#define TH4G_SPAP_RED_OFFSET_DEFAULT             0
/*! MMU default mc queue mode. */
#define TH4G_MC_Q_MODE_DEFAULT                   2
/*! Default pause enable. */
#define TH4G_PAUSE_EN_DEFAULT                    0
/*! Default spid. */
#define TH4G_SPID_DEFAULT                        0

/*! Oversub XON/XOFF Threshold */
#define TH4G_OBM_ENTRY_LEN          64

/*! XON 10G Threshold */
#define TH4G_XON_THRESHOLD_10G      73  * TH4G_OBM_ENTRY_LEN
/*! XON 25G Threshold */
#define TH4G_XON_THRESHOLD_25G      73  * TH4G_OBM_ENTRY_LEN
/*! XON 50G Threshold */
#define TH4G_XON_THRESHOLD_50G      73  * TH4G_OBM_ENTRY_LEN
/*! XON 100G Threshold */
#define TH4G_XON_THRESHOLD_100G     186 * TH4G_OBM_ENTRY_LEN
/*! XON 200G Threshold */
#define TH4G_XON_THRESHOLD_200G     376 * TH4G_OBM_ENTRY_LEN
/*! XON 400G Threshold */
#define TH4G_XON_THRESHOLD_400G     760 * TH4G_OBM_ENTRY_LEN

/*! XOFF 10G Threshold */
#define TH4G_XOFF_THRESHOLD_10G     81  * TH4G_OBM_ENTRY_LEN
/*! XOFF 25G Threshold */
#define TH4G_XOFF_THRESHOLD_25G     81  * TH4G_OBM_ENTRY_LEN
/*! XOFF 50G Threshold */
#define TH4G_XOFF_THRESHOLD_50G     81  * TH4G_OBM_ENTRY_LEN
/*! XOFF 100G Threshold */
#define TH4G_XOFF_THRESHOLD_100G    194 * TH4G_OBM_ENTRY_LEN
/*! XOFF 200G Threshold */
#define TH4G_XOFF_THRESHOLD_200G    384 * TH4G_OBM_ENTRY_LEN
/*! XOFF 400G Threshold */
#define TH4G_XOFF_THRESHOLD_400G    768 * TH4G_OBM_ENTRY_LEN

/*! PG headroom 10G linerate. */
#define TH4G_PG_HEADROOM_LINERATE_10G   173
/*! PG headroom 25G linerate. */
#define TH4G_PG_HEADROOM_LINERATE_25G   262
/*! PG headroom 50G linerate. */
#define TH4G_PG_HEADROOM_LINERATE_50G   366
/*! PG headroom 100G linerate. */
#define TH4G_PG_HEADROOM_LINERATE_100G  585
/*! PG headroom 200G linerate. */
#define TH4G_PG_HEADROOM_LINERATE_200G  1071
/*! PG headroom 400G linerate. */
#define TH4G_PG_HEADROOM_LINERATE_400G  1982


/*! PG headroom 10G oversub. */
#define TH4G_PG_HEADROOM_OVERSUB_10G    \
    ( TH4G_PG_HEADROOM_LINERATE_10G + ceiling( TH4G_XOFF_THRESHOLD_10G,64))
/*! PG headroom 25G oversub. */
#define TH4G_PG_HEADROOM_OVERSUB_25G    \
    ( TH4G_PG_HEADROOM_LINERATE_25G + ceiling( TH4G_XOFF_THRESHOLD_25G,64))
/*! PG headroom 50G oversub. */
#define TH4G_PG_HEADROOM_OVERSUB_50G    \
    ( TH4G_PG_HEADROOM_LINERATE_50G + ceiling( TH4G_XOFF_THRESHOLD_50G,64))
/*! PG headroom 100G oversub. */
#define TH4G_PG_HEADROOM_OVERSUB_100G    \
    ( TH4G_PG_HEADROOM_LINERATE_100G + ceiling( TH4G_XOFF_THRESHOLD_100G,64))
/*! PG headroom 200G oversub. */
#define TH4G_PG_HEADROOM_OVERSUB_200G    \
    ( TH4G_PG_HEADROOM_LINERATE_200G + ceiling( TH4G_XOFF_THRESHOLD_200G,64))
/*! PG headroom 400G oversub. */
#define TH4G_PG_HEADROOM_OVERSUB_400G    \
    ( TH4G_PG_HEADROOM_LINERATE_400G + ceiling( TH4G_XOFF_THRESHOLD_400G,64))
...
#define TH4G_MMU_CFG_MMU_BYTES_TO_CELLS(byte,cellhdr) (((byte) + (cellhdr) - 1) / (cellhdr))

/*! MMU rqe queue number. */
#define TH4G_MMU_RQE_QUEUE_NUM 9
/*! MMU rqe configuration value. */
#define TH4G_THDR_QE_CONFIG1_VALUE 0x7
/*! MMU rqe priority limit. */
#define TH4G_THDR_QE_CONIFG_PRI_LIMIT 8
/*! MMU rqe min limit. */
#define TH4G_THDR_QE_LIMIT_MIN 7
/*! MMU rqe reset offset. */
#define TH4G_MMU_THDR_QE_RESET_OFFSET 0xe
/*! MMU rqe sp shared limit. */
#define TH4G_THDR_QE_SP_SHARED_LIMIT 0xbc1
/*! MMU rqe sp resume limit. */
#define TH4G_THDR_QE_SP_RESUME_LIMIT 0xbb3

/*! TH4G granularity. */
#define TH4G_GRANULARITY 8
/*! Ceiling function. */
#define CEILING(a, b) ((a - 1 + b) / b)

/*! Piped memory index calculation function. */
extern uint32_t
th4g_piped_mem_index(int unit, int port, bcmdrd_sid_t mem, int arr_off);
...
extern int
bcm56996_a0_tm_ing_pool_shared_limit_lt_update(int unit, int itm, int pool,
                                               uint32_t fval);
...
th4g_soc_mmu_buf_cfg_alloc(int unit);
...
extern int
th4g_default_pg_headroom(int unit, int port);
#endif /* BCM56996_A0_TM_THD_INTERNAL_H */
