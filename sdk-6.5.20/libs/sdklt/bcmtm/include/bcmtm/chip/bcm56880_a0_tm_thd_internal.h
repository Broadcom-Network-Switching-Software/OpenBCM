...
/* MMU port */
#define TD4_MMU_PORTS_OFFSET_PER_PIPE  32
#define TD4_MMU_PORTS_PER_DEV          (32 * 8)

#define TD4_SECTION_SIZE                32768
...
#define TD4_MMU_NUM_MAX_PROFILES        8

#define SOC_TD4_MMU_CFG_QGROUP_MAX       160

#define TD4_MMU_JUMBO_PACKET_SIZE TD4_MMU_CFG_MMU_BYTES_TO_CELLS( TD4_MMU_JUMBO_FRAME_BYTES + \
                                                               TD4_MMU_PACKET_HEADER_BYTES, \
                                                               TD4_MMU_BYTES_PER_CELL)

#define SOC_TD4_NUM_CPU_QUEUES           48
/* Num UC Q's Per pipe 33 * 10 */
#define SOC_TD4_NUM_UC_QUEUES_PER_PIPE   330 /
/* Num MC Q's Per pipe (33 * 10)  + 48 CPU queues */
#define SOC_TD4_NUM_MC_QUEUES_PER_PIPE   378

#define SOC_TD4_MMU_MCQ_ENTRY_PER_ITM    20480
#define SOC_TD4_MMU_RQE_ENTRY_PER_ITM    6144
#define SOC_TD4_MMU_RQE_ENTRY_RSVD_PER_ITM 215

#define SOC_TD4_MAX_PHY_PORTS_PER_PIPE 32
#define SOC_TD4_MAX_DEV_PORTS_PER_PIPE 20
#define SOC_TD4_MMU_PORT_STRIDE          32
#define SOC_TD4_PHY_PORTS_PER_DEV          \
    ( SOC_TD4_MAX_PHY_PORTS_PER_PIPE * TD4_PIPES_PER_DEV)
#define SOC_TD4_DEV_PORTS_PER_DEV          \
    ( SOC_TD4_MAX_DEV_PORTS_PER_PIPE * TD4_PIPES_PER_DEV)
#define SOC_TD4_MMU_PORTS_PER_DEV          \
    ( SOC_TD4_MAX_DEV_PORTS_PER_PIPE * TD4_PIPES_PER_DEV)

#define TD4_MMU_TOTAL_MCQ_ENTRY(unit)   SOC_TD4_MMU_MCQ_ENTRY_PER_ITM
#define TD4_MMU_TOTAL_RQE_ENTRY(unit)   SOC_TD4_MMU_RQE_ENTRY_PER_ITM

/* Default values for thresholds */
#define TD4_CFAP_BANK_FULL_LIMIT 4092
#define TD4_LAST_PKT_ACCEPT_MODE_DEFAULT 1
#define TD4_LAST_PKT_ACCEPT_MODE_POOL_DEFAULT 15
#define TD4_COLOR_AWARE_DEFAULT 0
#define TD4_HDRM_LIMIT_DEFAULT 0
#define TD4_SPID_OVERRIDE_ENABLE_DEFAULT 0
#define TD4_SPAP_YELLOW_OFFSET_DEFAULT 0
#define TD4_SPAP_RED_OFFSET_DEFAULT 0
#define TD4_MC_Q_MODE_DEFAULT 2
#define TD4_OUTPUT_PORT_EN_DEFAULT 1048575
#define TD4_PAUSE_EN_DEFAULT 0
#define TD4_SPID_DEFAULT 0
...
#define TD4_MMU_CFG_MMU_BYTES_TO_CELLS(byte,cellhdr) (((byte) + (cellhdr) - 1) / (cellhdr))
...
#define SOC_TD4_MMU_PIPED_MEM_INDEX(u,p,m,off) \
                    td4_piped_mem_index((u),(p),(m),(off))

#define TD4_MMU_RQE_QUEUE_NUM 9
