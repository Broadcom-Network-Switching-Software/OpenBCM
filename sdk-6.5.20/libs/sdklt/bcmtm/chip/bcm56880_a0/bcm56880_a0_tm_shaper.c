/*! \file bcm56880_a0_tm_shaper.c
 *
 * Shaper related api and function for bcm56880_a0.
 */
/*
 ...
 */
static int
bcm56880_a0_tm_shaper_port_set(int unit,
        bcmtm_lport_t lport,
        bcmltd_sid_t ltid,
 ...
 */
static int
bcm56880_a0_tm_shaper_node_set(int unit,
        bcmtm_lport_t lport,
        ...
        bcmtm_shaper_cfg_t *shaper_cfg)
{
    ...
    SHR_IF_ERR_EXIT
        (bcm56880_a0_tm_sched_node_l0_map_get(unit, shaper_cfg->profile_id,
                                              sched_node_id, &l0_node_id));

    if (bcmtm_lport_is_mgmt(unit, lport)) {
        index = TD4_TM_MGMT_Q_OFFSET + l0_node_id;
    } else if (bcmtm_lport_is_lb(unit, lport)) {
        index = TD4_TM_LB_Q_OFFSET + l0_node_id;
    } else {
        index = mport * TD4_TM_NUM_Q + l0_node_id;
    }
 ...
 */
static int
bcm56880_a0_tm_shaper_cpu_node_set(int unit,
        uint32_t sched_node_id,
        uint32_t sched_level,
        bcmltd_sid_t ltid,
        bcmtm_shaper_cfg_t *shaper_cfg)
 ...
 */
static int
bcm56880_a0_tm_shaper_config_init(int unit)
{
...
{
    bcmtm_shaper_drv_t bcm56880_a0_shaper_drv = {
        .port_set = bcm56880_a0_tm_shaper_port_set,
        .node_set = bcm56880_a0_tm_shaper_node_set,
        .cpu_node_set = bcm56880_a0_tm_shaper_cpu_node_set,
        .rate_to_bucket = bcm56880_a0_tm_shaper_rate_to_bucket,
        .bucket_to_rate = bcm56880_a0_tm_shaper_bucket_to_rate
    };
    SHR_FUNC_ENTER(unit);

    SHR_NULL_CHECK(shaper_drv, SHR_E_INTERNAL);
    *((bcmtm_shaper_drv_t *)shaper_drv) = bcm56880_a0_shaper_drv;
exit:
    SHR_FUNC_EXIT();
}
...
bcm56880_a0_tm_shaper_chip_init(int unit, bool warm)
{
    ...
    if (!warm) {
        SHR_IF_ERR_EXIT
            (bcm56880_a0_tm_shaper_config_init(unit));
    }
exit:
    SHR_FUNC_EXIT();
}
