...
static int
bcm56880_a0_tm_obm_pc_pm_pkt_parse_set(int unit,
                          bcmltd_sid_t ltid,
                          int pm_num,
                          bcmtm_obm_pc_pm_pkt_parse_cfg_t *obm_pc_pm_pkt_parse_cfg)
{
    ...
    reg_idx = pm_num % TD4_PBLKS_PER_PIPE;
    inst = pm_num / TD4_PBLKS_PER_PIPE;
    for (i = 0 ; i < 4 ;i++) {
         sid = upt0[reg_idx];
         BCMTM_PT_DYN_INFO(pt_dyn_info, i , inst);
         fid = MAC_ADDRf;
...
static int
bcm56880_a0_tm_obm_port_pkt_parse_set(int unit,
                          bcmltd_sid_t ltid,
                          bcmtm_lport_t lport,
                          bcmtm_obm_port_pkt_parse_cfg_t *obm_pc_cfg)
{
    ...
    sub_port = td4_get_subp_from_phy_port(pport);
...
static int
bcm56880_a0_tm_obm_fc_set(int unit,
                          bcmltd_sid_t ltid,
                          bcmtm_lport_t lport,
...
static int
bcm56880_a0_tm_obm_pkt_pri_tc_set(int unit,
                                  bcmltd_sid_t ltid,
                                  bcmtm_lport_t lport,
                                  uint8_t pri_type,
                                  uint8_t pkt_pri,
                                  uint8_t tc)
{
    bcmdrd_sid_t obm_pri_map_sid[4][8] =
    ...
    bcmdrd_sid_t obm_dscp_map_sid[4][8] =
   ...
   bcmdrd_sid_t obm_mpls_map_sid[4][8] =
   ...
   bcmdrd_sid_t obm_etag_map_sid[4][8] =
...
static int
bcm56880_a0_tm_obm_port_usg_set(int unit,
                                bcmltd_sid_t ltid,
                                bcmtm_lport_t lport,
                                uint64_t flags,
...
static int
bcm56880_a0_tm_obm_port_usg_get(int unit,
                                bcmltd_sid_t ltid,
                                bcmtm_lport_t lport,
                                uint64_t flags,
                                bcmtm_obm_usg_cfg_t *obm_usg_cfg)
...
static int
bcm56880_a0_tm_obm_port_validation(int unit, bcmtm_lport_t lport)
{
 ...
 */
int
bcm56880_a0_tm_obm_drv_get(int unit, void *obm_drv)
{
    bcmtm_obm_drv_t bcm56880_a0_obm_drv = {
        .fc_set = bcm56880_a0_tm_obm_fc_set,
        .pkt_pri_tc_set = bcm56880_a0_tm_obm_pkt_pri_tc_set,
        .port_usg_set = bcm56880_a0_tm_obm_port_usg_set,
        .port_usg_get = bcm56880_a0_tm_obm_port_usg_get,
        .port_pkt_parse_set = bcm56880_a0_tm_obm_port_pkt_parse_set,
        .policy_set = bcm56880_a0_tm_obm_pc_pm_pkt_parse_set,
        .port_validation = bcm56880_a0_tm_obm_port_validation
    };

    SHR_FUNC_ENTER(unit);

    SHR_NULL_CHECK(obm_drv, SHR_E_INTERNAL);
    *((bcmtm_obm_drv_t *)obm_drv) = bcm56880_a0_obm_drv;
exit:
    SHR_FUNC_EXIT();
}

int
bcm56880_a0_tm_obm_init(int unit, bool warm)
{
    SHR_FUNC_ENTER(unit);
    SHR_IF_ERR_EXIT
