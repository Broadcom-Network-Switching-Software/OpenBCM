/*! \file bcm56880_a0_tm_oobfc.c
 *
 * TM OOBFC TD4 specific functions.
 */
/*
 ...
 * Local definitions
 */
static bcmdrd_fid_t oobfc_bit_offset[] = {
...
static bcmdrd_fid_t oobfc_cng_notify[] = {
 ...
 */
static int
bcm56880_a0_oobfc_port_set_hw(int unit, int port, int oob_port)
{
    ...
    SHR_FUNC_ENTER(unit);
    BCMTM_PT_DYN_INFO(pt_dyn_info, port, 0);
    SHR_IF_ERR_EXIT
        (bcmtm_pt_indexed_read(unit, sid, -1,
                            (void *)&pt_dyn_info,
                            &ltm_buf));
    SHR_IF_ERR_EXIT
        (bcmtm_field_set(unit, sid, fid, &ltm_buf, (uint32_t *)&oob_port));
    SHR_IF_ERR_EXIT
...
/*!
 * \brief TD4 queue oobfc profile map.
 *
 ...
 */
static int
bcm56880_a0_tm_oobfc_q_profile_set(int unit,
                                   bcmltd_sid_t ltid,
                                   uint8_t profile_id,
                                   uint8_t q_id,
...
/*!
 * \brief TD4 multicast queue oobfc profile map.
 *
 * Profile configuration to map the queue in the OOBFC message.
 *
 * \param [in] unit Logical unit number.
 ...
 */
static int
bcm56880_a0_tm_oobfc_mcq_profile_set(int unit,
                                     bcmltd_sid_t ltid,
                                     uint8_t profile_id,
                                     uint8_t mcq_id,
                                     bcmtm_oobfc_q_profile_t *mcq_profile)
{
    ...
    mcq_base =  bcm56880_a0_tm_num_uc_q_non_cpu_port_get(unit);
    mcq_id += mcq_base;

    SHR_IF_ERR_EXIT
        (bcm56880_a0_tm_oobfc_q_profile_set(unit, ltid, profile_id,
                                           mcq_id, mcq_profile));
exit:
    SHR_FUNC_EXIT();
}
 ...
 */
static int
bcm56880_a0_tm_oobfc_port_set(int unit,
                              bcmltd_sid_t ltid,
                              bcmtm_lport_t lport,
                              bcmtm_oobfc_port_cfg_t *port_cfg)
{
    ...
    /* OOB port */
    SHR_IF_ERR_EXIT
        (bcm56880_a0_oobfc_port_set_hw(unit, chip_port, port_cfg->oob_port));

    /* Profile ID */
    sid = MMU_INTFO_OOBFC_ENG_PORT_PSELm;
    fid = ENG_PORT_PROFILE_SELf;
    BCMTM_PT_DYN_INFO(pt_dyn_info, chip_port, 0);
 ...
 */
static int
bcm56880_a0_tm_oobfc_egr_sp_set (int unit,
                                 bcmltd_sid_t ltid,
                                 uint8_t spid,
...
bcm56880_a0_tm_oobfc_drv_get(int unit, void *oobfc_drv)
{
    ...
    bcmtm_oobfc_drv_t bcm56880_a0_oobfc_drv = {
        .ucq_profile_set = bcm56880_a0_tm_oobfc_q_profile_set,
        .mcq_profile_set = bcm56880_a0_tm_oobfc_mcq_profile_set,
        .port_set = bcm56880_a0_tm_oobfc_port_set,
        .egr_sp_set = bcm56880_a0_tm_oobfc_egr_sp_set
    };

    SHR_FUNC_ENTER(unit);

    SHR_NULL_CHECK(oobfc_drv, SHR_E_INTERNAL);
    *((bcmtm_oobfc_drv_t *)oobfc_drv) = bcm56880_a0_oobfc_drv;
exit:
    SHR_FUNC_EXIT();
}
