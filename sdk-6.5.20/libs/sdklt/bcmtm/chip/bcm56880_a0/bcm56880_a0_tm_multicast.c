/*! \file bcm56880_a0_tm_multicast.c
 *
 ...
 */
static int
bcm56880_a0_mc_icc_set (int unit, int mc_head_id, int repl_count)
{
#define BCM56880_A0_IPMC_MAX_INTF_COUNT_PER_ENTRY 64
    bcmdrd_sid_t sid;
    bcmdrd_fid_t fid;
    ...
    icc_entry_ptr = mc_head_id / BCM56880_A0_IPMC_MAX_INTF_COUNT_PER_ENTRY;
    icc_field_index = mc_head_id % BCM56880_A0_IPMC_MAX_INTF_COUNT_PER_ENTRY;


    BCMTM_PT_DYN_INFO(pt_dyn_info, icc_entry_ptr, 0);
 ...
 */
static int
bcm56880_a0_mc_icc_get (int unit, int mc_head_id, int *repl_count)
{
#define BCM56880_A0_IPMC_MAX_INTF_COUNT_PER_ENTRY 64
    bcmdrd_sid_t sid;
    bcmdrd_fid_t fid;
 ...
 */
static int
bcm56880_a0_mc_dynamic_repl_set(int unit,
 ...
 */
static int
bcm56880_a0_mc_repl_head_entry_get (int unit,
                                    uint32_t mc_head_id,
                                    uint32_t *start_ptr)
{
    bcmdrd_sid_t sid;
    ...
    sid = MMU_REPL_HEAD_TBL_MMU_ITM0_ITM0m;
 ...
 */
static int
bcm56880_a0_mc_repl_head_entry_set (int unit,
                                    uint32_t mc_head_id,
                                    uint32_t start_ptr)
{
    bcmdrd_sid_t sid[] = { MMU_REPL_HEAD_TBL_MMU_ITM0_ITM0m,
                           MMU_REPL_HEAD_TBL_MMU_ITM1_ITM1m };
    bcmdrd_fid_t fid;
    uint32_t ltmbuf[BCMTM_MC_MAX_ENTRY_WSIZE] = {0};
    bcmtm_pt_info_t pt_dyn_info = {0};
    bcmltd_sid_t ltid = -1;
    ...
    SHR_IF_ERR_EXIT
        (bcmtm_field_set(unit, sid[0], fid, ltmbuf, (uint32_t *) &start_ptr));
    for (itm = 0; itm < 2; itm++ ) {
        if (SHR_SUCCESS(bcm56880_a0_tm_check_valid_itm(unit, itm))) {
            SHR_IF_ERR_EXIT
                (bcmtm_pt_indexed_write(unit, sid[itm], ltid,
 ...
 */
static int
bcm56880_a0_mc_repl_head_copy(int unit,
                              ...
                              int repl_count)
{
#define TD4_MC_RESERVED_HEAD_ENTRY 147296
    int num_entry, icc_count;
    uint32_t head_id = 0;
    uint32_t dup_head_id = TD4_MC_RESERVED_HEAD_ENTRY;
    uint32_t list_ptr = 0;
    ...
    *base_ptr = dup_head_id;
    ...
    for (num_entry = 0; num_entry < mc_group_info->num_entries; num_entry++) {
        ...
        if (head_id == (uint32_t)repl_head_info->index) {
            ...
            SHR_IF_ERR_EXIT
                (bcm56880_a0_mc_repl_head_entry_get(unit, head_id, &list_ptr));
            SHR_IF_ERR_EXIT
                (bcm56880_a0_mc_icc_get(unit, head_id, &icc_count));
        }
        SHR_IF_ERR_EXIT
            (bcm56880_a0_mc_repl_head_entry_set(unit, dup_head_id, list_ptr));
        SHR_IF_ERR_EXIT
            (bcm56880_a0_mc_icc_set(unit, dup_head_id, icc_count));
        head_id++;
        dup_head_id++;
    }
exit:
 ...
 */
static int
bcm56880_a0_mc_repl_group_entry_set (int unit, uint32_t mc_group_id,
                                     bcmtm_mc_repl_group_info_t *mc_group_info)
{
    bcmdrd_sid_t sid;
    bcmdrd_fid_t fid;
    ...
    if (mc_group_info->rqe_flush) {
        ...
        SHR_IF_ERR_EXIT
            (bcm56880_a0_tm_rqe_port_flush(unit));
    }
exit:
    SHR_FUNC_EXIT();
}
 ...
 */
static int
bcm56880_a0_mc_repl_group_entry_get (int unit,
                                     uint32_t mc_group_id,
                                     bcmtm_mc_repl_group_info_t *mc_group_info)
{
    bcmdrd_sid_t sid;
 ...
 */
static int
bcm56880_a0_mc_repl_list_update(int unit,
                                bcmtm_mc_repl_head_info_t *repl_head_info,
                                uint32_t start_ptr,
                                int repl_count)
{
     ...
     */
    SHR_IF_ERR_EXIT
        (bcm56880_a0_mc_repl_group_entry_get(unit, mc_group_id, &mc_group_info));
    SHR_IF_ERR_EXIT
        (bcm56880_a0_mc_repl_head_copy(unit, &mc_group_info,
    ...
    SHR_IF_ERR_EXIT
        (bcm56880_a0_mc_repl_group_entry_set(unit, 0, &mc_group_info));
     ...
     */
    SHR_IF_ERR_EXIT
        (bcm56880_a0_mc_dynamic_repl_set(unit, mc_group_id, 1));
    /*
 ...
 */
static int
bcm56880_a0_mc_repl_list_update_cleanup(int unit)
{
    int idx = 0;
    bool psim, asim, emul;
    bcmtm_mc_repl_group_info_t mc_group_info;
     ...
     */
    SHR_IF_ERR_EXIT
        (bcm56880_a0_mc_dynamic_repl_set(unit, 0, 0));
    ...
    /* Clear head list */
    SHR_IF_ERR_EXIT
        (bcm56880_a0_mc_repl_group_entry_get(unit, 0, &mc_group_info));
    base_ptr = mc_group_info.base_ptr;
    for (idx = 0; idx < mc_group_info.num_entries; idx++) {
        SHR_IF_ERR_EXIT
            (bcm56880_a0_mc_repl_head_entry_set(unit, base_ptr, 0));
        SHR_IF_ERR_EXIT
            (bcm56880_a0_mc_icc_set(unit, base_ptr, 0));
        base_ptr++;
    }
 ...
 */
static int
bcm56880_a0_mc_repl_list_entry_set (int unit,
                                    bcmtm_mc_repl_list_entry_t *mc_list_entry)
{
    bcmdrd_sid_t sid_list[] = {
        MMU_REPL_LIST_TBL_MMU_ITM0_ITM0m,
        MMU_REPL_LIST_TBL_MMU_ITM1_ITM1m };
    bcmdrd_sid_t sid;
    bcmdrd_fid_t fid;
    ...
    for (itm = 0; itm < 2; itm++) {
        if (SHR_SUCCESS(bcm56880_a0_tm_check_valid_itm(unit, itm))) {
            SHR_IF_ERR_EXIT
                (bcmtm_pt_indexed_write(unit, sid_list[itm], ltid,
                                        &pt_dyn_info, ltmbuf));
        }
    }
exit:
 ...
 */
static int
bcm56880_a0_mc_repl_list_entry_get (int unit,
                                    bcmtm_mc_repl_list_entry_t *mc_list_entry)
{
    bcmdrd_sid_t sid;
    bcmdrd_fid_t fid;
    ...
    sid = MMU_REPL_LIST_TBL_MMU_ITM0_ITM0m;
 ...
 */
static int
bcm56880_a0_mc_repl_list_in_use_get (int unit,
                                     int repl_entry_ptr,
                                     bool *in_use)
{
    bcmdrd_sid_t sid;
 ...
 */
static int
bcm56880_a0_mc_ipmc_set (int unit,
                         int mc_group_id,
 ...
 */
static int
bcm56880_a0_mc_ipmc_get (int unit,
                         int mc_group_id,
                         bcmtm_mc_ipmc_info_t *ipmc_info)
{
    bcmdrd_sid_t sid;
 ...
 */
static int
bcm56880_a0_mc_repl_head_index_count_get(int unit, int *num_index)
{
    int max, min;
    SHR_FUNC_ENTER(unit);
    SHR_NULL_CHECK(num_index, SHR_E_PARAM);
    max = bcmdrd_pt_index_max(unit, MMU_REPL_HEAD_TBL_MMU_ITM0_ITM0m);
    min = bcmdrd_pt_index_min(unit, MMU_REPL_HEAD_TBL_MMU_ITM0_ITM0m);
    *num_index = max - min + 1;
exit:
    SHR_FUNC_EXIT();
}
 ...
 */
static int
bcm56880_a0_mc_nhop_index_count_get(int unit, int *num_index)
{
 ...
 */
static int
bcm56880_a0_mc_nhops_per_repl_index_sparse_mode_get(int unit, int *num_index)
{
    SHR_FUNC_ENTER(unit);
    SHR_NULL_CHECK(num_index, SHR_E_PARAM);
    *num_index = TD4_NHOPS_PER_REPL_INDEX_SPARSE_MODE;
exit:
    SHR_FUNC_EXIT();
}
 ...
 */
static int
bcm56880_a0_mc_max_packet_replication_get(int unit, int *num_index)
{
    SHR_FUNC_ENTER(unit);
    *num_index = TD4_MAX_MC_PKT_REPL;
    SHR_FUNC_EXIT();
}
 ...
 */
static int
bcm56880_a0_mc_repl_list_free_count(int unit, uint64_t *free_count)
{
    int in_use = 0;
    bcmtm_mc_dev_info_t *mc_dev;
    int tc = TD4_MAX_REPL_LIST_COUNT;
    ...
    *free_count = TD4_MAX_REPL_LIST_COUNT - in_use;
exit:
    SHR_FUNC_EXIT();
}
...
{
    bcmtm_mc_drv_t bcm56880_a0_mc_drv = {
        .mc_repl_group_entry_set = bcm56880_a0_mc_repl_group_entry_set,
        .mc_repl_group_entry_get = bcm56880_a0_mc_repl_group_entry_get,
        .mc_repl_head_entry_set = bcm56880_a0_mc_repl_head_entry_set,
        .mc_repl_head_entry_get = bcm56880_a0_mc_repl_head_entry_get,
        .mc_repl_list_entry_set = bcm56880_a0_mc_repl_list_entry_set,
        .mc_repl_list_entry_get = bcm56880_a0_mc_repl_list_entry_get,
        .mc_repl_list_in_use_get = bcm56880_a0_mc_repl_list_in_use_get,
        .mc_repl_icc_set = bcm56880_a0_mc_icc_set,
        .mc_ipmc_set = bcm56880_a0_mc_ipmc_set,
        .mc_ipmc_get = bcm56880_a0_mc_ipmc_get,
        .mc_repl_head_index_count_get = bcm56880_a0_mc_repl_head_index_count_get,
        .mc_nhop_index_count_get = bcm56880_a0_mc_nhop_index_count_get,
        .mc_nhops_per_repl_index_sparse_mode_get =
                            bcm56880_a0_mc_nhops_per_repl_index_sparse_mode_get,
        .mc_max_packet_replication_get =
                            bcm56880_a0_mc_max_packet_replication_get,
        .mc_repl_list_update = bcm56880_a0_mc_repl_list_update,
        .mc_repl_list_update_cleanup = bcm56880_a0_mc_repl_list_update_cleanup,
        .mc_repl_list_free_count = bcm56880_a0_mc_repl_list_free_count,
    };
    SHR_FUNC_ENTER(unit);
    SHR_NULL_CHECK(mc_drv, SHR_E_INTERNAL);

    *((bcmtm_mc_drv_t *)mc_drv) = bcm56880_a0_mc_drv;
exit:
    SHR_FUNC_EXIT();
}
