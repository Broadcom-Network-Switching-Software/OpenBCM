/*! \file bcm56880_a0_tm_ing_port_pri_grp.c
 *
...
static int
tm_ing_port_pri_grp_delete(int unit, bcmltd_sid_t sid, int lport, int pg)
{
    ...
    SHR_IF_ERR_EXIT
        (tm_ing_port_pri_grp_update(unit, sid, lport, pg, data_fields,
                                    &dummy_fields));
                          ...
                          bcmltd_fields_t *output_fields)
{
    ...
    switch (event_reason) {
        ...
        case BCMIMM_ENTRY_UPDATE:
            SHR_IF_ERR_EXIT
                (tm_ing_port_pri_grp_update(unit, sid, lport, pg,
                                            data_fields, output_fields));
            break;
        case BCMIMM_ENTRY_DELETE:
            SHR_IF_ERR_EXIT
                (tm_ing_port_pri_grp_delete(unit, sid, lport, pg));
            break;
        default:
            SHR_ERR_EXIT(SHR_E_PARAM);
    }
...
int
bcm56880_a0_tm_ing_port_pri_grp_register(int unit)
{
    ...
    tm_thd_cb_handler.stage    = tm_ing_port_pri_grp_stage;
...
int
bcm56880_a0_tm_ing_port_pri_grp_populate(int unit)
{
    int lport;
    int pg, rv;
    const bcmlrd_map_t *map = NULL;
...
int
bcm56880_a0_tm_ing_port_pri_grp_update(int unit, int pport, int up)
{
    int lport, pg, rv;
    const bcmlrd_map_t *map = NULL;
