 ...
 * Local definitions
 */
#define BCM56990_B0_CT_VALID_SPEED_COUNT   7
#define BCM56990_B0_SAF_COMMIT_ID_COUNT   16
#define BCM56990_B0_CT_MAX_FACTOR          4
#define BCM56990_B0_CT_MAX_SPEED         400000
#define BCM56990_B0_CT_CLASS_VALID_NUM     8

#define BCM56990_B0_CT_SPEED_CLASS_VALIDATE(class) \
    if (class > BCM56990_B0_CT_CLASS_VALID_NUM) \
        SHR_ERR_EXIT(SHR_E_PARAM);

typedef enum bcm56990_b0_pipe_bandwidth_config_e {
...
}bcm56990_b0_pipe_bandwidth_config_t;

typedef struct
bcm56990_b0_saf_commit_config_s {
    uint16_t saf_commit_id[BCM56990_B0_SAF_COMMIT_ID_COUNT];
}bcm56990_b0_saf_commit_config_t;

static const
bcm56990_b0_saf_commit_config_t
bcm56990_b0_saf_commit_config_tbl = {
    {1, 2, 3, 3, 4, 5, 6, 6, 7, 8, 8, 9, 10, 11, 12, 13}
};

typedef enum bcm56990_b0_ct_speed_encoding_e {
    BCM56990_B0_SPEED_ID_RESERVED = 0,
    BCM56990_B0_SPEED_ID_10G,
    BCM56990_B0_SPEED_ID_25G,
    BCM56990_B0_SPEED_ID_40G,
    BCM56990_B0_SPEED_ID_50G,
    BCM56990_B0_SPEED_ID_100G,
    BCM56990_B0_SPEED_ID_200G,
    BCM56990_B0_SPEED_ID_400G,
    BCM56990_B0_SPEED_ID_ERROR,
}bcm56990_b0_ct_speed_enconding_t;
 ...
 */
static int
bcm56990_b0_tm_ct_speed_encoding_get(int port_speed)
{
    switch (port_speed) {
        case 10000:
            return BCM56990_B0_SPEED_ID_10G;
        case 25000:
            return BCM56990_B0_SPEED_ID_25G;
        case 40000:
            return BCM56990_B0_SPEED_ID_40G;
        case 50000:
            return BCM56990_B0_SPEED_ID_50G;
        case 100000:
        /* for handling max src port speed for 40G */
        case 160000:
            return BCM56990_B0_SPEED_ID_100G;
        case 200000:
            return BCM56990_B0_SPEED_ID_200G;
        case 400000:
            return BCM56990_B0_SPEED_ID_400G;
        default:
            return BCM56990_B0_SPEED_ID_ERROR;
    }
}

static int
bcm56990_b0_tm_ct_rl_config_set(int unit)
{
    bcmdrd_sid_t sid;
    bcmdrd_fid_t fid;
    bcmtm_pt_info_t pt_dyn_info = {0};
    uint32_t ltmbuf[2] = {0, 0};
    static struct bcm56990_b0_mmu_rl_config_s {
...
static int
bcm56990_b0_tm_ct_fifo_thd_set(int unit)
{
    bcmdrd_sid_t sid = MMU_EBCTM_CT_SPEED_CFGr;
    bcmtm_pt_info_t pt_dyn_info = {0};
    bcmdrd_fid_t fid = CT_FIFO_THRESHOLDf;
    uint32_t ltmbuf = 0;
    uint32_t fval[3][BCM56990_B0_CT_VALID_SPEED_COUNT] = {
        /* frequence 950 */
    ...
    for (idx = 0; idx < BCM56990_B0_CT_VALID_SPEED_COUNT; idx++) {
        ltmbuf = 0;
        SHR_IF_ERR_EXIT(
...
static int
bcm56990_b0_tm_ebpts_ebshp_config_set(int unit)
{
    bcmdrd_sid_t sid;
    bcmdrd_fid_t fid;
    uint32_t ltmbuf[2] = { 0 };
...
static int
bcm56990_b0_tm_tct_config_set(int unit)
{
    bcmdrd_sid_t sid;
    bcmdrd_fid_t fid;
    uint32_t ltmbuf[2] = {0, 0};
    bcmtm_drv_info_t *drv_info;
    static struct bcm56990_b0_tct_config_s {
    ...
    } tct_config [3][BCM56990_B0_CT_VALID_SPEED_COUNT] = {
        { /*   frequency 950 */
...
static int
bcm56990_b0_tm_saf_commitment_config_set(int unit, int pipe)
{
    bcmdrd_sid_t sid;
    bcmdrd_fid_t fid;
    bcmtm_pt_info_t pt_dyn_info = {0};
    uint32_t ltmbuf = 0;
    int idx;
    const bcm56990_b0_saf_commit_config_t *saf_config;
    ...
    saf_config = &bcm56990_b0_saf_commit_config_tbl;

    for (idx = 0; idx < BCM56990_B0_SAF_COMMIT_ID_COUNT; idx++) {
        SHR_IF_ERR_EXIT(
                bcmtm_field_set(unit, sid, fid, &ltmbuf,
...
static int
bcm56990_b0_tm_ct_port_enable(int unit,
                              bcmlrd_sid_t ltid,
                              bcmpc_lport_t lport,
                              int port_speed,
                              uint32_t ct_enable)
{
    ...
    dst_speed_encode = bcm56990_b0_tm_ct_speed_encoding_get(port_speed);
    max_src_speed_encode = bcm56990_b0_tm_ct_speed_encoding_get(
            MIN((port_speed * BCM56990_B0_CT_MAX_FACTOR), BCM56990_B0_CT_MAX_SPEED));

    BCM56990_B0_CT_SPEED_CLASS_VALIDATE(dst_speed_encode);
    BCM56990_B0_CT_SPEED_CLASS_VALIDATE(max_src_speed_encode);
 ...
 */
static int
bcm56990_b0_tm_ct_port_mode_set(int unit,
                                bcmlrd_sid_t ltid,
                                bcmpc_lport_t lport,
                                uint32_t ct_enable)
{
    ...
    if (ct_enable) {
        /* Cut Through Enable*/
        SHR_IF_ERR_EXIT(
            bcm56990_b0_tm_ct_port_enable(unit, ltid, lport,
...
static int
bcm56990_b0_tm_ct_port_info_get(int unit,
                                bcmlrd_sid_t ltid,
                                uint64_t flags,
                                bcmpc_lport_t lport,
                                bcmtm_ct_port_info_t *ct_info)
{
    ...
    local_idx = (lport % TH4_B0_DEV_PORTS_PER_PIPE) * TH4_B0_EDB_MAX_CT_CLASSES;
    SHR_IF_ERR_EXIT
...
{
    bcmtm_ct_drv_t bcm56990_b0_ct_drv = {
        .port_set = bcm56990_b0_tm_ct_port_mode_set,
        .port_info_get = bcm56990_b0_tm_ct_port_info_get,
    };

    SHR_FUNC_ENTER(unit);
    SHR_NULL_CHECK(ct_drv, SHR_E_INTERNAL);
    *((bcmtm_ct_drv_t *)ct_drv) = bcm56990_b0_ct_drv;
exit:
    SHR_FUNC_EXIT();
}
...
bcm56990_b0_tm_ct_init(int unit)
{
    ...
    SHR_IF_ERR_EXIT(bcm56990_b0_tm_ct_rl_config_set(unit));

    /* CT FIFO threshold configurations. */
    SHR_IF_ERR_EXIT(bcm56990_b0_tm_ct_fifo_thd_set(unit));

    /* Transition CT configurations. */
    SHR_IF_ERR_EXIT(bcm56990_b0_tm_tct_config_set(unit));

    SHR_IF_ERR_EXIT
        (bcm56990_b0_tm_ebpts_ebshp_config_set(unit));
    ...
    while (pipe_map) {
        if (pipe_map & 1) {
            SHR_IF_ERR_EXIT(
                bcm56990_b0_tm_saf_commitment_config_set(unit, pipe));
            mport_offset = TH4_B0_MMU_PORTS_PER_PIPE * pipe;
            for (idx = 0; idx < TH4_B0_FP_PORTS_PER_PIPE; idx++) {
