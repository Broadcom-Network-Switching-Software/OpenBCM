/*! \file bcm56996_a0_tm_scheduler_shaper.h
 *
 * TM scheduler shaper functions for BCM56996_A0.
 */
/*
...
#ifndef BCM56996_A0_TM_SCHEDULER_SHAPER_H
#define BCM56996_A0_TM_SCHEDULER_SHAPER_H
...
#define TH4G_TM_CPU_Q_OFFSET   192
#define TH4G_TM_LB_Q_OFFSET    192
#define TH4G_TM_MGMT_Q_OFFSET  192
#define TH4G_TM_NUM_Q          12
#define TH4G_NUM_L0_NODE       12
#define TH4G_NUM_SCHED_PROFILE 8
 ...
 */
typedef struct bcm56996_a0_tm_cos_l0_map_s {
    int map[TH4G_NUM_L0_NODE];
} bcm56996_a0_tm_cos_l0_map_t;


/*!
 * \brief Scheduler shaper chip init function for bcm56996_a0.
 *
...
/*!
 * \brief shaper chip init function for bcm56996_a0 for corresponding LT.
 *
 * \param [in] unit Unit number.
...
/*!
 * \brief Scheduler chip init function for bcm56996_a0 for corresponding LT.
 *
 * \param [in] unit Unit number.
 ...
 * mmu_q_num before calling the api. For TH4G size is 2.
 *
 * \param [in] unit Unit number.
...
/*!
 * \brief Initialize cos to l0 scheduler node mapping for BCM56996.
 *
 * \param [in] unit Unit number.
...
#endif /* BCM56996_A0_TM_SCHEDULER_SHAPER_H */
