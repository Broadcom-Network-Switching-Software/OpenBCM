/*! \file bcm56996_a0_tm_thd_mc_egr_service_pool.c
 *
...
mc_cqe_shared_buffer_update(int unit, int itm, int pool, uint32_t new_limit)
{
    ...
    unused_buf = SOC_TH4G_MMU_MCQ_ENTRY_PER_ITM;
...
int
bcm56996_a0_tm_thd_mc_egr_service_pool_register(int unit)
{
...
int
bcm56996_a0_tm_thd_mc_egr_service_pool_populate(int unit)
{
    int itm, pool, rv;
    const bcmlrd_map_t *map = NULL;
    SHR_FUNC_ENTER(unit);
