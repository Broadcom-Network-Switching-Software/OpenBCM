...
static int
bcm56996_a0_tm_obm_pc_pm_pkt_parse_set(int unit,
                          bcmltd_sid_t ltid,
                          int pm_num,
                          bcmtm_obm_pc_pm_pkt_parse_cfg_t *obm_pc_pm_pkt_parse_cfg)
{
    ...
    for (i = 0; i < 4; i++) {
        if (pm_num == 64) { /* Management port OBM */
            ...
            sid = upt0[pm_num / TH4G_IDBS_PER_DEV];
            BCMTM_PT_DYN_INFO(pt_dyn_info, i , pm_num % TH4G_IDBS_PER_DEV);
        }
        fid = MAC_ADDRf;
        ...
        if (pm_num == 64) { /* Management port OBM */
            ...
            sid = upt1[pm_num / TH4G_IDBS_PER_DEV];
            BCMTM_PT_DYN_INFO(pt_dyn_info, i , pm_num % TH4G_IDBS_PER_DEV);
        }
        fid = MAC_ADDR_MASKf;
        ...
        if (pm_num == 64) { /* Management port OBM */
            ...
            sid = upt2[pm_num / TH4G_IDBS_PER_DEV];
            BCMTM_PT_DYN_INFO(pt_dyn_info, i , pm_num % TH4G_IDBS_PER_DEV);
        }
        fid = ENABLEf;
    ...
    if (pm_num == 64) { /* Management port OBM */
        ...
        sid = innertp[pm_num / TH4G_IDBS_PER_DEV];
        BCMTM_PT_DYN_INFO(pt_dyn_info, 0 , pm_num % TH4G_IDBS_PER_DEV);
    }
    fid = TPIDf;
    ...
    if (pm_num == 64) { /* Management port OBM */
        ...
        sid = outertp0[pm_num / TH4G_IDBS_PER_DEV];
        BCMTM_PT_DYN_INFO(pt_dyn_info, 0 , pm_num % TH4G_IDBS_PER_DEV);
    }
    fid = TPIDf;
    ...
    if (pm_num == 64) { /* Management port OBM */
        ...
        sid = outertp1[pm_num / TH4G_IDBS_PER_DEV];
    }
    fid = TPIDf;
    ...
    if (pm_num == 64) { /* Management port OBM */
        ...
        sid = outertp2[pm_num / TH4G_IDBS_PER_DEV];
        BCMTM_PT_DYN_INFO(pt_dyn_info, 0 , pm_num % TH4G_IDBS_PER_DEV);
    }
    fid = TPIDf;
    ...
    if (pm_num == 64) { /* Management port OBM */
        ...
        sid = outertp3[pm_num / TH4G_IDBS_PER_DEV];
        BCMTM_PT_DYN_INFO(pt_dyn_info, 0 , pm_num % TH4G_IDBS_PER_DEV);
    }
    fid = TPIDf;
    ...
    if (pm_num == 64) { /* Management port OBM */
        ...
        sid = etageth[pm_num / TH4G_IDBS_PER_DEV];
        BCMTM_PT_DYN_INFO(pt_dyn_info, 0 , pm_num % TH4G_IDBS_PER_DEV);
    }
    fid = ETHERTYPEf;
    ...
    if (pm_num == 64) { /* Management port OBM */
        ...
        sid = vntageth[pm_num / TH4G_IDBS_PER_DEV];
        BCMTM_PT_DYN_INFO(pt_dyn_info, 0 , pm_num % TH4G_IDBS_PER_DEV);
    }
    fid = ETHERTYPEf;
    ...
    if (pm_num == 64) { /* Management port OBM */
        ...
        sid = gsheth[pm_num / TH4G_IDBS_PER_DEV];
        BCMTM_PT_DYN_INFO(pt_dyn_info, 0 , pm_num % TH4G_IDBS_PER_DEV);
    }
    fid = ETHERTYPEf;
...
static int
bcm56996_a0_tm_obm_port_pkt_parse_set(int unit,
                          bcmltd_sid_t ltid,
                          bcmtm_lport_t lport,
                          bcmtm_obm_port_pkt_parse_cfg_t *obm_pc_cfg)
{
    ...
    sub_port = th4g_get_subp_from_phy_port(pport);
...
static int
bcm56996_a0_tm_obm_fc_set(int unit,
                          bcmltd_sid_t ltid,
                          bcmtm_lport_t lport,
...
static int
bcm56996_a0_tm_obm_pkt_pri_tc_set(int unit,
                                  bcmltd_sid_t ltid,
                                  bcmtm_lport_t lport,
                                  uint8_t pri_type,
                                  uint8_t pkt_pri,
...
static int
bcm56996_a0_tm_obm_port_usg_set(int unit,
                                bcmltd_sid_t ltid,
                                bcmtm_lport_t lport,
                                uint64_t flags,
...
static int
bcm56996_a0_tm_obm_port_usg_get(int unit,
                                bcmltd_sid_t ltid,
                                bcmtm_lport_t lport,
                                uint64_t flags,
                                bcmtm_obm_usg_cfg_t *obm_usg_cfg)
...
static int
bcm56996_a0_tm_obm_port_validation(int unit, bcmtm_lport_t lport)
{
    if ((!bcmtm_lport_is_fp(unit, lport)) &&
 ...
 */
int
bcm56996_a0_tm_obm_drv_get(int unit, void *obm_drv)
{
    bcmtm_obm_drv_t bcm56996_a0_obm_drv = {
        .fc_set = bcm56996_a0_tm_obm_fc_set,
        .pkt_pri_tc_set = bcm56996_a0_tm_obm_pkt_pri_tc_set,
        .port_usg_set = bcm56996_a0_tm_obm_port_usg_set,
        .port_usg_get = bcm56996_a0_tm_obm_port_usg_get,
        .port_pkt_parse_set = bcm56996_a0_tm_obm_port_pkt_parse_set,
        .policy_set = bcm56996_a0_tm_obm_pc_pm_pkt_parse_set,
        .port_validation = bcm56996_a0_tm_obm_port_validation
    };
    SHR_FUNC_ENTER(unit);
    SHR_NULL_CHECK(obm_drv, SHR_E_INTERNAL);
    *((bcmtm_obm_drv_t *)obm_drv) = bcm56996_a0_obm_drv;
exit:
    SHR_FUNC_EXIT();
}

int
bcm56996_a0_tm_obm_init(int unit, bool warm)
{
    SHR_FUNC_ENTER(unit);
    SHR_IF_ERR_EXIT
