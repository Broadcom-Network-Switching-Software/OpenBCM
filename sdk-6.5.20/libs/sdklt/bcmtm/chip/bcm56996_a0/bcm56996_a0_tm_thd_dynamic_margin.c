/*! \file bcm56996_a0_tm_thd_dynamic_margin.c
 *
...
tm_thd_dynamic_margin_populate_entry(int unit, int instance, int pool_id)
{
    ...
    for (margin_level = 0; margin_level < 10; margin_level++) {
        margin = margin_base[margin_level] * 1024 * 1024 / TH4G_MMU_BYTES_PER_CELL;
...
int
bcm56996_a0_tm_thd_dynamic_margin_register(int unit)
{
...
int
bcm56996_a0_tm_thd_dynamic_margin_populate(int unit)
{
    int itm, pool, rv;
    const bcmlrd_map_t *map = NULL;
