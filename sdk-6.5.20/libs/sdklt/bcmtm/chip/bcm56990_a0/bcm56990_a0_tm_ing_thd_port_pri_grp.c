/*! \file bcm56990_a0_tm_ing_thd_port_pri_grp.c
 *
                               ...
                               uint8_t action)
{
    ...
    th4_mmu_config_buf_prigroup_get(unit, lport, pg,
    ...
    while (data_ptr) {
        if (data_ptr->id == TM_ING_THD_PORT_PRI_GRPt_MIN_GUARANTEE_CELLSf) {
            ...
            SHR_IF_ERR_EXIT
                (bcm56990_a0_tm_thdi_pg_to_pool_mapping_get(unit, lport, pg,
                                                            &itm, &pool, FALSE));
