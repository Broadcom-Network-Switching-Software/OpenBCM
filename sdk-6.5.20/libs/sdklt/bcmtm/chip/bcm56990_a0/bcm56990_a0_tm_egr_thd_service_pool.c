/*! \file bcm56990_a0_tm_egr_thd_service_pool.c
 *
    ...
    while (data_ptr) {
        switch (data_ptr->id) {
            ...
            case TM_EGR_THD_SERVICE_POOLt_SHARED_LIMIT_CELLSf:
                ...
                rv = bcm56990_a0_tm_shared_buffer_update(unit, itm, pool, delta,
...
int
bcm56990_a0_tm_egr_pool_shared_limit_lt_update(int unit, int itm, int pool,
                                               uint32_t fval)
{
    bcmltd_fields_t in;
    bcmltd_fields_t out;
