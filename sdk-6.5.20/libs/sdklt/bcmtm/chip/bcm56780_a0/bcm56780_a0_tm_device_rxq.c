/*! \file bcm56780_a0_tm_device_rxq.c
 *
 ...
 */
static int
bcm56780_a0_tm_rxq_bmp_pt_update(int unit,
                                 bcmltd_sid_t ltid,
                                 uint32_t channel,
                                 uint8_t action,
                                 uint64_t *cos_bmp)
 ...
 */
static int
bcm56780_a0_tm_rxq_bmp_pt_get(int unit,
                              bcmltd_sid_t ltid,
                              uint32_t channel,
                              uint64_t *cos_bmp)
{
    ...
    SHR_FUNC_ENTER(unit);
    SHR_IF_ERR_EXIT
        (bcm56780_a0_tm_rxq_bmp_pt_update(unit, ltid, channel, 1, cos_bmp));
exit:
    SHR_FUNC_EXIT();
}
 ...
 */
static int
bcm56780_a0_tm_rxq_bmp_pt_set(int unit,
                              bcmltd_sid_t ltid,
                              uint32_t channel,
                              uint64_t cos_bmp)
{
    SHR_FUNC_ENTER(unit);
    SHR_IF_ERR_EXIT
        (bcm56780_a0_tm_rxq_bmp_pt_update(unit, ltid, channel, 0, &cos_bmp));
exit:
    SHR_FUNC_EXIT();
}
 ...
 */
int
bcm56780_a0_tm_rxq_drv_get(int unit, void *rxq_drv)
{
    bcmtm_device_rxq_drv_t bcm56780_a0_rxq_drv = {
        .rxq_bmp_pt_get = bcm56780_a0_tm_rxq_bmp_pt_get,
        .rxq_bmp_pt_set = bcm56780_a0_tm_rxq_bmp_pt_set
    };

    SHR_FUNC_ENTER(unit);
    SHR_NULL_CHECK(rxq_drv, SHR_E_INTERNAL);

    *((bcmtm_device_rxq_drv_t *)rxq_drv) = bcm56780_a0_rxq_drv;
exit:
    SHR_FUNC_EXIT();
}
