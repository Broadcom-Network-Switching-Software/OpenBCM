/*! \file bcm56990_b0_pc_drv_attach.c
 *
 * BCM56990_B0 device specific PC driver.
 */
/*
...
#include <bcmpmac/chip/bcm56990_b0_pmac_drv_list.h>
...
#include "bcm56990_b0_pc_internal.h"
#include "bcm56990_b0_pc_miim.h"
 ...
 */
static int
bcm56990_b0_tsce_reg_write(void *user_acc, uint32_t phy_addr,
 ...
 */
static int
bcm56990_b0_tsce_reg_read(void *user_acc, uint32_t phy_addr,
                          uint32_t reg_addr, uint32_t *val)
{
    int rv, unit, port, idx;
    uint32_t data[16];
 ...
 */
static int
bcm56990_b0_tscbh_reg_write(void *user_acc, uint32_t phy_addr,
                            uint32_t reg_addr, uint32_t val)
{
    int rv, unit, port, idx;
    uint32_t data[16];
 ...
 */
static int
bcm56990_b0_tscbh_reg_read(void *user_acc, uint32_t phy_addr,
                           uint32_t reg_addr, uint32_t *val)
{
    int rv, unit, port, idx;
    uint32_t data[16];
...
static int
bcm56990_b0_pc_phy_addr_get(int unit, bcmpc_pport_t pport);
 ...
 */
static int
bcm56990_b0_tsce_raw_reg_read(int unit, bcmpc_pport_t base_port,
                               uint32_t reg_addr, uint32_t *val)
{
    int rv = SHR_E_NONE;
    uint32_t data[16];
    ...
    phy_addr = (uint32_t)bcm56990_b0_pc_phy_addr_get(unit, base_port);
    TSC_REG_ADDR_TSCID_SET(reg_addr, phy_addr);
    data[0] = reg_addr & 0xffffffff ;
    data[2] = 0;
 ...
 */
static int
bcm56990_b0_tsce_raw_reg_write(int unit, bcmpc_pport_t base_port,
                               uint32_t reg_addr, uint32_t val)
{
    int rv = SHR_E_NONE;
    uint32_t data[16];
 ...
 */
static int
bcm56990_b0_tscbh_raw_reg_read(int unit, bcmpc_pport_t base_port,
                               uint32_t reg_addr, uint32_t *val)
{
    int rv = SHR_E_NONE;
    uint32_t data[16];
 ...
 */
static int
bcm56990_b0_tscbh_raw_reg_write(int unit, bcmpc_pport_t base_port,
                                uint32_t reg_addr, uint32_t val)
{
    int rv = SHR_E_NONE;
    uint32_t data[16];
 ...
 */
static int
bcm56990_b0_raw_reg_read(int unit, bcmpc_pport_t base_port,
                               uint32_t reg_addr, uint32_t *val)
{
    SHR_FUNC_ENTER(unit);
    ...
    if (base_port == 257) {
       SHR_IF_ERR_EXIT
            (bcm56990_b0_tsce_raw_reg_read(unit, base_port,  reg_addr, val));
    } else {
        SHR_IF_ERR_EXIT
            (bcm56990_b0_tscbh_raw_reg_read(unit, base_port,  reg_addr, val));
    }
 ...
 */
static int
bcm56990_b0_raw_reg_write(int unit, bcmpc_pport_t base_port,
                          uint32_t reg_addr, uint32_t val)
{
    SHR_FUNC_ENTER(unit);
    ...
    if (base_port == 257) {
        SHR_IF_ERR_EXIT
            (bcm56990_b0_tsce_raw_reg_write(unit, base_port, reg_addr, val));
    } else {
        SHR_IF_ERR_EXIT
            (bcm56990_b0_tscbh_raw_reg_write(unit, base_port, reg_addr, val));
    }
 ...
 */
static int
bcm56990_b0_tscbh_mem_read(void *user_acc, phymod_mem_type_t mem_type,
 ...
 */
static int
bcm56990_b0_tscbh_mem_write(void *user_acc, phymod_mem_type_t mem_type,
...
static phymod_bus_t bcm56990_b0_tsce_bus = {
    .bus_name = "TSCE Bus",
    .mutex_take = bcmpc_phymod_bus_mutex_take,
    .mutex_give = bcmpc_phymod_bus_mutex_give,
    .read = bcm56990_b0_tsce_reg_read,
    .write = bcm56990_b0_tsce_reg_write,
    .bus_capabilities = PHYMOD_BUS_CAP_WR_MODIFY | PHYMOD_BUS_CAP_LANE_CTRL
};

static phymod_bus_t bcm56990_b0_tscbh_bus = {
    .bus_name = "TSCBH Bus",
    .mutex_take = bcmpc_phymod_bus_mutex_take,
    .mutex_give = bcmpc_phymod_bus_mutex_give,
    .read = bcm56990_b0_tscbh_reg_read,
    .write = bcm56990_b0_tscbh_reg_write,
    .mem_read = bcm56990_b0_tscbh_mem_read,
    .mem_write = bcm56990_b0_tscbh_mem_write,
    .bus_capabilities = PHYMOD_BUS_CAP_WR_MODIFY | PHYMOD_BUS_CAP_LANE_CTRL
};
 ...
 */
static void
bcm56990_b0_pc_fdr_intr_func(int unit, uint32_t intr_param)
{
    int rv;
...
static int
bcm56990_b0_fdr_interrupt_control(int unit, int pport,
...
static void
bcm56990_b0_pc_port_intr_func(int unit, uint32_t intr_param)
{
    int rv, i;
    bcmpc_lport_t lport = BCMPC_INVALID_LPORT;
    bcmpc_pport_t pport = PORT_INTR_INST_GET(intr_param);
...
static int
bcm56990_b0_fdr_port_enable_set(int unit, int pport, bool enable)
{
    uint32_t wsize;
...
static int
bcm56990_b0_pm_type_create(int unit)
{
...
static int
bcm56990_b0_pm_instance_create(int unit, bool warm)
{
...
static int
bcm56990_b0_type_destroy(int unit, int tid, bcmpc_topo_type_t *tinfo,
                         void *cookie)
{
...
static int
bcm56990_b0_inst_destroy(int unit, int pm_id, bcmpc_topo_t *pm_info,
                         void *cookie)
{
...
static int
bcm56990_b0_pc_pblk_get(int unit, bcmpc_pport_t pport,
...
bcm56990_b0_pc_phy_addr_get(int unit, bcmpc_pport_t pport)
{
    ...
    if (pport >= 257) {
        ...
        return (1 + BCM56990_B0_PC_MIIM_IBUS(ibus));
    } else {
        /* Every continous 64 PM8x50 ports use one bus. */
        ibus = (pport - 1) / 64;
        offset = ibus * 64 + 1;
        /* Each PM8x50, 4 ports share one MDIO address. */
        return ((pport - offset) / 4 + 1 + BCM56990_B0_PC_MIIM_IBUS(ibus));
    }
...
static phymod_bus_t *
bcm56990_b0_pc_phy_bus_get(int unit, bcmpc_pport_t pport)
{
    int rv, pm_id;
    bcmpc_topo_t pm_info;
    ...
    if (pm_info.tid == TH4_PM_TYPE_PM4X10) {
        ...
        if (bcmdrd_feature_enabled(unit, BCMDRD_FT_PHYMOD_SIM)) {
            ...
            phymod_sim_bus->mem_read = bcm56990_b0_tscbh_mem_read;
            phymod_sim_bus->mem_write = bcm56990_b0_tscbh_mem_write;
            return phymod_sim_bus;
        }
        return &bcm56990_b0_tscbh_bus;
    }
...
bcm56990_b0_pc_phy_drv_get(int unit, bcmpc_pport_t pport)
{
    int rv, pm_id;
    bcmpc_topo_t pm_info;
...
bcm56990_b0_pc_pmac_drv_get(int unit, bcmpc_pport_t pport)
{
    int rv, pm_id;
    bcmpc_topo_t pm_info;
    ...
    if (pm_info.tid == TH4_PM_TYPE_PM4X10) {
        return &bcm56990_b0_pmac_xlport;
    } else if (pm_info.tid == TH4_PM_TYPE_PM8X50) {
        return &bcm56990_b0_pmac_cdport;
    }
...
static uint8_t
bcm56990_b0_pc_phy_pll_idx_get(int unit, bcmpc_pport_t pport,
...
static bool
bcm56990_b0_pc_link_update_required(int unit, bcmpc_pport_t pport)
{
    int rv, pm_id;
    bcmpc_topo_t pm_info;
...
bcm56990_b0_pc_port_up_prof_get(int unit, bcmpc_pport_t pport)
{
    ...
    if (!bcm56990_b0_pc_link_update_required(unit, pport)) {
        return NULL;
    }
...
static bcmpc_cfg_profile_t *
bcm56990_b0_pc_port_down_prof_get(int unit, bcmpc_pport_t pport)
{
...
static bcmpc_cfg_profile_t *
bcm56990_b0_pc_port_resume_prof_get(int unit, bcmpc_pport_t pport)
{
...
static bcmpc_cfg_profile_t *
bcm56990_b0_pc_port_suspend_prof_get(int unit, bcmpc_pport_t pport)
{
...
static int
bcm56990_b0_pc_topo_init(int unit, bool warm)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_EXIT
        (bcm56990_b0_pm_type_create(unit));

    SHR_IF_ERR_EXIT
        (bcm56990_b0_pm_instance_create(unit, warm));
...
static int
bcm56990_b0_pc_dev_init(int unit, bool pre_load, bool warm)
{
    SHR_FUNC_ENTER(unit);
    ...
    if (!warm && pre_load) {
        SHR_IF_ERR_EXIT
            (bcm56990_b0_phy_firmware_loader(unit, 0 , 0, NULL));
    }
...
static int
bcm56990_b0_pc_dev_cleanup(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_EXIT
        (bcmpc_topo_traverse(unit, bcm56990_b0_inst_destroy, NULL));

    SHR_IF_ERR_EXIT
        (bcmpc_topo_type_traverse(unit, bcm56990_b0_type_destroy, NULL));
...
static void
bcm56990_b0_pc_pm_pport_get(int unit, bcmpc_pport_t pport, int *pm_pport)
{
...
static void
bcm56990_b0_pc_port_lbmp_get(int unit,
                             bcmpc_pport_t pport,
                             int pm_phys_port,
                             uint32_t *lbmp)
{
...
static int
bcm56990_b0_pc_pm_firmware_loader(int unit, bcmpc_pport_t pport,
                                  ...
                                  phymod_firmware_loader_f *fw_loader)
{
    ...
    port = pport;
    SHR_IF_ERR_EXIT
        (bcm56990_b0_phy_firmware_loader(unit, port, fw_loader_req, fw_loader));
exit:
    SHR_FUNC_EXIT();
}

static int
bcm56990_b0_is_internal_port(int unit, bcmpc_pport_t pport,
                             bool *is_internal)
{
    int rv, pm_id;
    bcmpc_topo_t pm_info;
...
static int
bcm56990_b0_num_phys_ports_get(int unit, bcmpc_pport_t pport,
...
static int
bcm56990_b0_max_num_ports_get(int unit, uint32_t *max_pport,
                              uint32_t *max_lport)
{
...
static int
bcm56990_b0_is_internal_pm(int unit, int pm_id, bool *is_internal)
{
    int rv;
    bcmpc_topo_t pm_info;
...
bcm56990_b0_unsupported_abilities_get(int unit, bcmpc_pport_t pport, int *abil_size)
{
...
static int
bcm56990_b0_link_sequence_exec_timeout_get(int unit, uint32_t *to_up,
                                           uint32_t *to_down)
{
...
static int
bcm56990_b0_dev_revision_b0_get(int unit, bool *rev_id_b0)
{
    int rv = SHR_E_NONE;
    bcmdrd_dev_id_t dev_id;

    rv = bcmdrd_dev_id_get(unit, &dev_id);
    if (dev_id.revision == BCM56990_REV_B0) {
        *rev_id_b0 = true;
    } else {
        *rev_id_b0 = false;
    }
...
static int
bcm56990_b0_is_stall_tx_supported(int unit, bcmpc_pport_t pport,
                                  bool *is_supported)
{
    int rv, pm_id;
    bcmpc_topo_t pm_info;
...
static int
bcm56990_b0_is_sec_supported (int unit)
{
    return 0;
}

static int
bcm56990_b0_is_pm_sec_enabled(int unit, int pm_id)
{
    return 0;
}

static int
bcm56990_b0_port_to_mac_rsv_mask(int unit, bcmpc_pport_t pport,
...
static int
bcm56990_b0_mac_to_port_rsv_mask(int unit, bcmpc_pport_t pport,
                                 uint32_t in_flags, uint32_t in_value,
                                 uint32_t *out_flags, uint32_t *out_value)
{
    int rv, pm_id;
...
static int
bcm56990_b0_port_fdr_control_get(int unit, bcmpc_pport_t pport,
...
static int
bcm56990_b0_port_fdr_control_set(int unit, bcmpc_pport_t pport,
                                 bcmpc_fdr_port_control_t fdr_ctrl)
{
    int pm_id;
    bcmpc_topo_t pm_info;
    ...
    if (SHR_BITGET(fdr_ctrl.fbmp, BCMPC_FDR_CTRL_LT_FLD_FDR_INTR_ENABLE)) {
        if (fdr_ctrl.interrupt_enable) {
            bcm56990_b0_fdr_interrupt_control(unit, pport, INTR_ENABLE);
        } else {
            bcm56990_b0_fdr_interrupt_control(unit, pport, INTR_DISABLE);
        }
    }

    /* Enable/Disable FDR on port if configured.*/
    SHR_IF_ERR_EXIT
        (bcm56990_b0_fdr_port_enable_set(unit, pport, fdr_ctrl.enable));
...
static int
bcm56990_b0_port_fdr_stats_get(int unit, bcmpc_pport_t pport,
...
static int
bcm56990_b0_pm_offset_get(int unit, int pm_id, uint32_t *pm_offset)
{
    /*
...
static int
bcm56990_b0_port_interrupt_set(int unit, bcmpc_pport_t pport,
                               bool intr_op)
{
    uint32_t i = 0;
    int pm_id;
    ...
    SHR_IF_ERR_EXIT
        (bcm56990_b0_is_internal_port(unit, pport, &is_internal));
...
static bcmpc_drv_t bcm56990_b0_pc_drv = {
    .topology_init = bcm56990_b0_pc_topo_init,
    .dev_init = bcm56990_b0_pc_dev_init,
    .dev_cleanup = bcm56990_b0_pc_dev_cleanup,
    .phy_addr_get = bcm56990_b0_pc_phy_addr_get,
    .pblk_get = bcm56990_b0_pc_pblk_get,
    .phy_bus_get = bcm56990_b0_pc_phy_bus_get,
    .pmac_bus_get = bcmpc_cmicx_pmac_bus_get,
    .phy_drv_get = bcm56990_b0_pc_phy_drv_get,
    .pmac_drv_get = bcm56990_b0_pc_pmac_drv_get,
    .phy_pll_idx_get = bcm56990_b0_pc_phy_pll_idx_get,
    .port_up_prof_get = bcm56990_b0_pc_port_up_prof_get,
    .port_down_prof_get = bcm56990_b0_pc_port_down_prof_get,
    .port_suspend_prof_get = bcm56990_b0_pc_port_suspend_prof_get,
    .port_resume_prof_get = bcm56990_b0_pc_port_resume_prof_get,
    .pm_pport_get = bcm56990_b0_pc_pm_pport_get,
    .port_lbmp_get = bcm56990_b0_pc_port_lbmp_get,
    .pm_firmware_loader = bcm56990_b0_pc_pm_firmware_loader,
    .pm_phy_raw_read = bcm56990_b0_raw_reg_read,
    .pm_phy_raw_write = bcm56990_b0_raw_reg_write,
    .is_internal_port = bcm56990_b0_is_internal_port,
    .num_phys_ports_get = bcm56990_b0_num_phys_ports_get,
    .max_num_ports_get = bcm56990_b0_max_num_ports_get,
    .is_internal_pm = bcm56990_b0_is_internal_pm,
    .dev_unsupported_abilities_get = bcm56990_b0_unsupported_abilities_get,
    .link_sequence_exec_timeout_get =
                           bcm56990_b0_link_sequence_exec_timeout_get,
    .dev_revision_a0_get = bcm56990_b0_dev_revision_b0_get,
    .is_stall_tx_supported = bcm56990_b0_is_stall_tx_supported,
    .is_sec_supported = bcm56990_b0_is_sec_supported,
    .is_pm_sec_enabled = bcm56990_b0_is_pm_sec_enabled,
    .port_to_mac_rsv = bcm56990_b0_port_to_mac_rsv_mask,
    .mac_to_port_rsv = bcm56990_b0_mac_to_port_rsv_mask,
    .fdr_control_get = bcm56990_b0_port_fdr_control_get,
    .fdr_control_set = bcm56990_b0_port_fdr_control_set,
    .fdr_stats_get = bcm56990_b0_port_fdr_stats_get,
    .pm_offset_get = bcm56990_b0_pm_offset_get,
    .interrupt_set = bcm56990_b0_port_interrupt_set,
};
...
int
bcm56990_b0_pc_drv_attach(int unit)
{
    return bcmpc_drv_set(unit, &bcm56990_b0_pc_drv);
}
