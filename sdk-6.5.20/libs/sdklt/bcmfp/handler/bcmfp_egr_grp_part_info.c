/*! \file bcmfp_egr_grp_part_info.c
 *
...
#include <bcmfp/bcmfp_egr_grp_part_info.h>

#define BSL_LOG_MODULE BSL_LS_BCMFP_DEV

int
bcmfp_egr_grp_part_info_lookup(int unit,
...
int
bcmfp_egr_grp_part_info_insert(int unit,
                               const bcmltd_op_arg_t *op_arg,
                               const bcmltd_fields_t *in,
                               bcmltd_fields_t *out,
                               const bcmltd_generic_arg_t *arg)
...
int
bcmfp_egr_grp_part_info_update(int unit,
                               const bcmltd_op_arg_t *op_arg,
                               const bcmltd_fields_t *in,
                               bcmltd_fields_t *out,
                               const bcmltd_generic_arg_t *arg)
...
int
bcmfp_egr_grp_part_info_delete(int unit,
                               const bcmltd_op_arg_t *op_arg,
                               const bcmltd_fields_t *in,
                               bcmltd_fields_t *out,
                               const bcmltd_generic_arg_t *arg)
...
int
bcmfp_egr_grp_part_info_validate(int unit,
...
int
bcmfp_egr_grp_part_info_first(int unit,
                              const bcmltd_op_arg_t *op_arg,
                              const bcmltd_fields_t *in,
                              bcmltd_fields_t *out,
                              const bcmltd_generic_arg_t *arg)
...
int
bcmfp_egr_grp_part_info_next(int unit,
                             const bcmltd_op_arg_t *op_arg,
                             const bcmltd_fields_t *in,
                             bcmltd_fields_t *out,
                             const bcmltd_generic_arg_t *arg)
