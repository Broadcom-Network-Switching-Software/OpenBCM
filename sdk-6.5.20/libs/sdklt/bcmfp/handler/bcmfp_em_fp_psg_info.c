/*! \file bcmfp_em_fp_psg_info.c
 *
 * APIs for FP presel group info template LTs custom handler.
 *
 * This file contains functions to insert, update,
 * delete, lookup or validate group config provided
 * using group info template LTs.
 */
/*
...
#include <bcmfp/bcmfp_em_fp_psg_info.h>

#define BSL_LOG_MODULE BSL_LS_BCMFP_DEV

int
bcmfp_em_fp_psg_info_lookup(int unit,
...
int
bcmfp_em_fp_psg_info_insert(int unit,
                         const bcmltd_op_arg_t *op_arg,
                         const bcmltd_fields_t *in,
                         bcmltd_fields_t *out,
                         const bcmltd_generic_arg_t *arg)
...
int
bcmfp_em_fp_psg_info_update(int unit,
                         const bcmltd_op_arg_t *op_arg,
                         const bcmltd_fields_t *in,
                         bcmltd_fields_t *out,
                         const bcmltd_generic_arg_t *arg)
...
int
bcmfp_em_fp_psg_info_delete(int unit,
                         const bcmltd_op_arg_t *op_arg,
                         const bcmltd_fields_t *in,
                         bcmltd_fields_t *out,
                         const bcmltd_generic_arg_t *arg)
...
int
bcmfp_em_fp_psg_info_validate(int unit,
...
int
bcmfp_em_fp_psg_info_first(int unit,
                        const bcmltd_op_arg_t *op_arg,
                        const bcmltd_fields_t *in,
                        bcmltd_fields_t *out,
                        const bcmltd_generic_arg_t *arg)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmfp_psg_info_first_search(unit,
                                     op_arg->trans_id,
...
int
bcmfp_em_fp_psg_info_next(int unit,
                       const bcmltd_op_arg_t *op_arg,
                       const bcmltd_fields_t *in,
                       bcmltd_fields_t *out,
                       const bcmltd_generic_arg_t *arg)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmfp_psg_info_next_search(unit,
                                    op_arg->trans_id,
                                    BCMFP_STAGE_ID_EXACT_MATCH,
                                    in,
                                    out,
