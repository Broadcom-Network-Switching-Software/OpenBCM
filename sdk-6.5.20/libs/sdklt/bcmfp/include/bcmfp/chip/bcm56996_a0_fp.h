/*! \file bcm56996_a0_fp.h
 *
 * Tomahawk-4G(56996_A0) specific functions assigned to common function pointers.
 */
/*
...
#ifndef BCM56996_A0_FP_H
#define BCM56996_A0_FP_H

extern int
bcmfp_bcm56996_a0_fn_ptrs_init(int unit,
 ...
 */
extern int
bcm56996_a0_fp_ing_alpm_fids_init(int unit,
                                  bcmfp_stage_t *stage);
/*!
 * \brief Initialize all logical table IDs and other FIDs
...
bcmfp_bcm56996_a0_ext_codes_init(int unit,
                                 ...
                                 uint32_t *kgp_entry);
extern int
bcmfp_bcm56996_a0_ingress_ext_cfg_db_init(int unit,
                                          bcmfp_stage_t *stage);
...
bcmfp_bcm56996_a0_ingress_action_cfg_db_init(int unit,
                                             bcmfp_stage_t *stage);
extern int
bcmfp_bcm56996_a0_ingress_action_cfg_conflict_check(int unit,
...
bcmfp_bcm56996_a0_vlan_action_cfg_conflict_check(int unit,
                                                 ...
                                                 bcmfp_action_t action);
extern int
bcmfp_bcm56996_a0_egress_action_cfg_conflict_check(int unit,
                                                   bcmfp_action_t action1,
                                                   bcmfp_action_t action);
extern int
...
bcmfp_bcm56996_a0_em_qual_cfg_db_init(int unit,
                                      bcmfp_stage_t *stage);
extern int
bcmfp_bcm56996_a0_em_src_class_mode_set(int unit,
                                        uint32_t trans_id,
                                        bcmltd_sid_t sid,
                                        int pipe_id,
                                        uint32_t mode);
extern int
bcmfp_bcm56996_a0_ingress_src_class_mode_set(int unit,
                                     uint32_t trans_id,
                                     bcmltd_sid_t sid,
                                     int pipe_id,
                                     uint32_t mode);
extern int
bcm56996_a0_fp_vlan_qual_enum_set(int unit,
                                  bcmfp_qualifier_t qual,
                                  bool is_presel,
                                  int value,
                                  uint32_t *data,
                                  uint32_t *mask);
extern int
bcm56996_a0_fp_vlan_qual_enum_get(int unit,
                                  bcmfp_qualifier_t qual,
                                  bool is_presel,
                                  uint32_t data,
                                  uint32_t mask,
...
bcmfp_bcm56996_a0_vlan_qual_cfg_db_init(int unit,
                                        bcmfp_stage_t *stage);
extern int
bcmfp_bcm56996_a0_vlan_device_consts_init(int unit,
                                          bcmfp_stage_t *stage);
extern int
...
bcmfp_bcm56996_a0_egress_entry_key_match_type_set(int unit,
                               ...
                               uint32_t **ekw);
extern int
bcmfp_bcm56996_a0_em_ext_cfg_db_init(int unit,
                                     bcmfp_stage_t *stage);
extern int
bcmfp_bcm56996_a0_exactmatch_device_consts_init(int unit,
                                                bcmfp_stage_t *stage);
extern int
...
bcmfp_bcm56996_a0_em_presel_action_cfg_db_init(int unit,
                                               bcmfp_stage_t *stage);
extern int
bcmfp_bcm56996_a0_em_profiles_install(int unit,
                                      uint32_t stage_id,
                                      uint32_t trans_id,
                                      uint32_t flags,
                                      bcmfp_group_id_t group_id,
                                      ...
                                      bcmfp_buffers_t *buffers);
extern int
bcmfp_bcm56996_a0_em_profiles_uninstall(int unit,
                                        uint32_t stage_id,
                                        uint32_t trans_id,
                                        uint32_t flags,
                                        bcmfp_group_id_t group_id,
                                        bcmfp_group_oper_info_t *opinfo);
extern int
bcmfp_bcm56996_a0_em_buffers_custom_set(int unit,
                                   uint32_t trans_id,
                                   uint32_t flags,
                                   bcmfp_stage_t *stage,
                                   bcmfp_group_oper_info_t *opinfo,
...
bcmfp_bcm56996_a0_ingress_meter_actions_set(int unit,
                                            ...
                                            uint32_t **edw);
extern int
bcmfp_bcm56996_a0_egress_meter_actions_set(int unit,
                                           bcmfp_group_id_t group_id,
                                           bcmfp_pdd_id_t pdd_id,
                                           bcmfp_group_oper_info_t *opinfo,
                                           bcmcth_meter_fp_policy_fields_t *meter_entry,
                                           uint32_t **edw);
extern int
bcmfp_bcm56996_a0_vlan_meter_actions_set(int unit,
                                         bcmfp_group_id_t group_id,
                                         bcmfp_pdd_id_t pdd_id,
                                         bcmfp_group_oper_info_t *opinfo,
                                         bcmcth_meter_fp_policy_fields_t *meter_entry,
...
bcmfp_bcm56996_a0_em_meter_actions_set(int unit,
                                       ...
                                       uint32_t **edw);
extern int
bcmfp_bcm56996_a0_ingress_counter_actions_set(int unit,
                                              bcmfp_stage_id_t stage_id,
                                              bcmfp_group_id_t group_id,
                                              bcmfp_pdd_id_t pdd_id,
                                              bcmfp_group_oper_info_t *opinfo,
                                              ...
                                              uint32_t **edw);
extern int
bcmfp_bcm56996_a0_egress_counter_actions_set(int unit,
                                             bcmfp_stage_id_t stage_id,
                                             bcmfp_group_id_t group_id,
                                             bcmfp_pdd_id_t pdd_id,
                                             bcmfp_group_oper_info_t *opinfo,
...
extern int
bcmfp_bcm56996_a0_egress_counter_hw_idx_set(int unit,
                                            bcmfp_stage_id_t stage_id,
                                            uint32_t ctr_id,
                                            uint32_t pipe_id,
                                            uint32_t pool_id,
 ...
 */
extern int
bcm56996_a0_fp_em_pdd_profile_entry_get(int unit,
                                        uint32_t trans_id,
                                        bcmfp_stage_id_t stage_id,
                                        bcmfp_pdd_id_t pdd_id,
                                        bcmfp_group_id_t group_id,
