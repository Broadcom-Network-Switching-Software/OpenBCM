/*! \file bcmfp_vlan_grp_part_info.h
 *
...
#ifndef BCMFP_VLAN_GRP_PART_INFO_H
#define BCMFP_VLAN_GRP_PART_INFO_H
 ...
 */
extern int
bcmfp_vlan_grp_part_info_validate(int unit,
 ...
 */
extern int
bcmfp_vlan_grp_part_info_insert(int unit,
 ...
 */
extern int
bcmfp_vlan_grp_part_info_update(int unit,
                               const bcmltd_op_arg_t *op_arg,
                               const bcmltd_fields_t *in,
                               bcmltd_fields_t *out,
                               const bcmltd_generic_arg_t *arg);
 ...
 */
extern int
bcmfp_vlan_grp_part_info_delete(int unit,
                               const bcmltd_op_arg_t *op_arg,
                               const bcmltd_fields_t *in,
                               bcmltd_fields_t *out,
                               const bcmltd_generic_arg_t *arg);
 ...
 */
extern int
bcmfp_vlan_grp_part_info_lookup(int unit,
                               const bcmltd_op_arg_t *op_arg,
                               const bcmltd_fields_t *in,
                               bcmltd_fields_t *out,
                               const bcmltd_generic_arg_t *arg);
 ...
 */
extern int
bcmfp_vlan_grp_part_info_first(int unit,
                              const bcmltd_op_arg_t *op_arg,
                              const bcmltd_fields_t *in,
                              bcmltd_fields_t *out,
                              const bcmltd_generic_arg_t *arg);
 ...
 */
extern int
bcmfp_vlan_grp_part_info_next(int unit,
                             const bcmltd_op_arg_t *op_arg,
                             const bcmltd_fields_t *in,
                             bcmltd_fields_t *out,
                             const bcmltd_generic_arg_t *arg);
#endif /* BCMFP_VLAN_GRP_PART_INFO_H */
