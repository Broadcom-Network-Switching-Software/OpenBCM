 ...
 */
static int
bcmfp_em_ft_grp_config_stage(int unit,
                             bcmltd_sid_t sid,
 ...
 */
static int
bcmfp_em_ft_rule_config_stage(int unit,
                              bcmltd_sid_t sid,
                              const bcmltd_op_arg_t *op_arg,
                              bcmimm_entry_event_t event_reason,
                              const bcmltd_field_t *key,
 ...
 */
static int
bcmfp_em_ft_policy_config_stage(int unit,
                                bcmltd_sid_t sid,
                                const bcmltd_op_arg_t *op_arg,
                                bcmimm_entry_event_t event_reason,
                                const bcmltd_field_t *key,
 ...
 */
static int
bcmfp_em_ft_entry_config_stage(int unit,
                               bcmltd_sid_t sid,
                               const bcmltd_op_arg_t *op_arg,
                               bcmimm_entry_event_t event_reason,
                               const bcmltd_field_t *key,
 ...
 */
static int
bcmfp_em_ft_entry_lookup(int unit,
                         bcmltd_sid_t sid,
                         const bcmltd_op_arg_t *op_arg,
                         void *context,
                         ...
                         bcmltd_fields_t *out)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmfp_ltd_buffers_clear(unit, BCMFP_STAGE_ID_FLOW_TRACKER));
 ...
 */
static int
bcmfp_em_ft_pse_lookup(int unit,
                       bcmltd_sid_t sid,
                       const bcmltd_op_arg_t *op_arg,
                       void *context,
                       bcmimm_lookup_type_t lkup_type,
 ...
 */
static int
bcmfp_em_ft_pse_config_stage(int unit,
                             bcmltd_sid_t sid,
                             const bcmltd_op_arg_t *op_arg,
                             bcmimm_entry_event_t event_reason,
                             const bcmltd_field_t *key,
 ...
 */
static int
bcmfp_em_ft_psg_config_stage(int unit,
                             bcmltd_sid_t sid,
                             const bcmltd_op_arg_t *op_arg,
                             bcmimm_entry_event_t event_reason,
                             const bcmltd_field_t *key,
 ...
 */
static int
bcmfp_em_ft_pdd_config_stage(int unit,
                             bcmltd_sid_t sid,
                             const bcmltd_op_arg_t *op_arg,
                             bcmimm_entry_event_t event_reason,
                             const bcmltd_field_t *key,
 ...
 */
static int
bcmfp_em_ft_sbr_config_stage(int unit,
                             bcmltd_sid_t sid,
                             const bcmltd_op_arg_t *op_arg,
                             bcmimm_entry_event_t event_reason,
                             const bcmltd_field_t *key,
 ...
 */
static int
bcmfp_em_ft_src_class_stage(int unit,
                            bcmltd_sid_t sid,
                            const bcmltd_op_arg_t *op_arg,
                            bcmimm_entry_event_t event_reason,
                            const bcmltd_field_t *key,
 ...
 */
static int
bcmfp_em_ft_range_check_group_stage(int unit,
                                    bcmltd_sid_t sid,
                                    const bcmltd_op_arg_t *op_arg,
                                    bcmimm_entry_event_t event_reason,
                                    const bcmltd_field_t *key,
 ...
 */
static bcmimm_lt_cb_t bcmfp_em_ft_grp_config_imm_callback = {

  /*! Validate function. */
  .validate = NULL,

  /*! Staging function. */
  .op_stage = bcmfp_em_ft_grp_config_stage,

  /*! Commit function. */
  .commit = bcmfp_em_ft_trans_commit,

  /*! Abort function. */
  .abort = bcmfp_em_ft_trans_abort
};
 ...
 */
static bcmimm_lt_cb_t bcmfp_em_ft_rule_config_imm_callback = {

  /*! Validate function. */
  .validate = NULL,

  /*! Staging function. */
  .op_stage = bcmfp_em_ft_rule_config_stage,
 ...
 */
static bcmimm_lt_cb_t bcmfp_em_ft_policy_config_imm_callback = {

  /*! Validate function. */
  .validate = NULL,

  /*! Staging function. */
  .op_stage = bcmfp_em_ft_policy_config_stage,
 ...
 */
static bcmimm_lt_cb_t bcmfp_em_ft_entry_config_imm_callback = {

  /*! Validate function. */
  .validate = NULL,

  /*! Staging function. */
  .op_stage = bcmfp_em_ft_entry_config_stage,
  ...
  /*! Lookup function. */
  .op_lookup = bcmfp_em_ft_entry_lookup
};
 ...
 */
static bcmimm_lt_cb_t bcmfp_em_ft_pse_imm_callback = {

  /*! Validate function. */
  .validate = NULL,

  /*! Staging function. */
  .op_stage = bcmfp_em_ft_pse_config_stage,
  ...
  /*! Lookup function. */
  .op_lookup = bcmfp_em_ft_pse_lookup
};
 ...
 */
static bcmimm_lt_cb_t bcmfp_em_ft_psg_imm_callback = {

  /*! Validate function. */
  .validate = NULL,

  /*! Staging function. */
  .op_stage = bcmfp_em_ft_psg_config_stage,
 ...
 */
static bcmimm_lt_cb_t bcmfp_em_ft_pdd_imm_callback = {

  /*! Validate function. */
  .validate = NULL,

  /*! Staging function. */
  .op_stage = bcmfp_em_ft_pdd_config_stage,
 ...
 */
static bcmimm_lt_cb_t bcmfp_em_ft_sbr_imm_callback = {

  /*! Validate function. */
  .validate = NULL,

  /*! Staging function. */
  .op_stage = bcmfp_em_ft_sbr_config_stage,
 ...
 */
static bcmimm_lt_cb_t bcmfp_em_ft_src_class_imm_callback = {

  /*! Validate function. */
  .validate = NULL,

  /*! Staging function. */
  .op_stage = bcmfp_em_ft_src_class_stage,
 ...
 */
static bcmimm_lt_cb_t bcmfp_em_ft_range_check_group_imm_callback = {

  /*! Validate function. */
  .validate = NULL,

  /*! Staging function. */
  .op_stage = bcmfp_em_ft_range_check_group_stage,
...
bcmfp_em_ft_imm_register(int unit)
{
    ...
    if (stage->tbls.group_tbl != NULL) {
        ...
        if (SHR_SUCCESS(rv)) {
            cb = &bcmfp_em_ft_grp_config_imm_callback;
            SHR_IF_ERR_VERBOSE_EXIT
    ...
    if (stage->tbls.rule_tbl != NULL) {
        ...
        rv = bcmlrd_map_get(unit, tbl_id, &map);
        if (SHR_SUCCESS(rv)) {
            cb = &bcmfp_em_ft_rule_config_imm_callback;
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmimm_lt_event_reg(unit, tbl_id, cb, NULL));
        }
    }
    ...
    if (stage->tbls.policy_tbl != NULL) {
        ...
        rv = bcmlrd_map_get(unit, tbl_id, &map);
        if (SHR_SUCCESS(rv)) {
            cb = &bcmfp_em_ft_policy_config_imm_callback;
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmimm_lt_event_reg(unit, tbl_id, cb, NULL));
        }
    }
    ...
    if (stage->tbls.entry_tbl != NULL) {
        ...
        rv = bcmlrd_map_get(unit, tbl_id, &map);
        if (SHR_SUCCESS(rv)) {
            cb = &bcmfp_em_ft_entry_config_imm_callback;
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmimm_lt_event_reg(unit, tbl_id, cb, NULL));
        }
    }
    ...
    if (stage->tbls.pse_tbl != NULL) {
        ...
        rv = bcmlrd_map_get(unit, tbl_id, &map);
        if (SHR_SUCCESS(rv)) {
            cb = &bcmfp_em_ft_pse_imm_callback;
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmimm_lt_event_reg(unit, tbl_id, cb, NULL));
        }
    }
    ...
    if (stage->tbls.psg_tbl != NULL) {
        ...
        rv = bcmlrd_map_get(unit, tbl_id, &map);
        if (SHR_SUCCESS(rv)) {
            cb = &bcmfp_em_ft_psg_imm_callback;
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmimm_lt_event_reg(unit, tbl_id, cb, NULL));
        }
    }
    ...
    if (stage->tbls.pdd_tbl != NULL) {
        ...
        rv = bcmlrd_map_get(unit, tbl_id, &map);
        if (SHR_SUCCESS(rv)) {
            cb = &bcmfp_em_ft_pdd_imm_callback;
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmimm_lt_event_reg(unit, tbl_id, cb, NULL));
        }
    }
    ...
    if (stage->tbls.sbr_tbl != NULL) {
        ...
        rv = bcmlrd_map_get(unit, tbl_id, &map);
        if (SHR_SUCCESS(rv)) {
            cb = &bcmfp_em_ft_sbr_imm_callback;
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmimm_lt_event_reg(unit, tbl_id, cb, NULL));
        }
    }
    ...
    if (stage->tbls.src_class_tbl != NULL) {
        ...
        rv = bcmlrd_map_get(unit, tbl_id, &map);
        if (SHR_SUCCESS(rv)) {
            cb = &bcmfp_em_ft_src_class_imm_callback;
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmimm_lt_event_reg(unit, tbl_id, cb, NULL));
        }
    }
    ...
    if (stage->tbls.range_check_group_tbl != NULL) {
        ...
        rv = bcmlrd_map_get(unit, tbl_id, &map);
        if (SHR_SUCCESS(rv)) {
            cb = &bcmfp_em_ft_range_check_group_imm_callback;
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmimm_lt_event_reg(unit, tbl_id, cb, NULL));
        }
    }
