/*! \file bcm56990_a0_fp_vlan_qual_enum.c
 *
...
STATIC int
bcm56990_a0_fp_vlan_qual_ipprotocolcommon_set(int unit,
                                              int ipprotocol,
                                              uint32_t *data,
                                              uint32_t *mask)
{
...
STATIC int
bcm56990_a0_fp_vlan_qual_ipprotocolcommon_get(int unit,
                                              uint32_t data,
                                              uint32_t mask,
                                              int *ipprotocol)
{
...
STATIC int
bcm56990_a0_fp_vlan_qual_ipfrag_set(int unit,
                                    int frag_info,
                                    uint32_t *data,
                                    uint32_t *mask)
{
...
STATIC int
bcm56990_a0_fp_vlan_qual_ipfrag_get(int unit,
                                    uint32_t data,
                                    uint32_t mask,
                                    int *frag_info)
{
...
STATIC int
bcm56990_a0_fp_vlan_main_qual_enum_set(int unit,
                                       ...
                                       uint32_t *mask)
{
    ...
    switch (qual) {
        ...
        case FP_VLAN_GRP_TEMPLATEt_QUAL_INNER_IP_FRAGf:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56990_a0_fp_vlan_qual_ipfrag_set(unit,
                                                     value,
                                                     data,
                                                     mask));
            break;
        ...
        case FP_VLAN_GRP_TEMPLATEt_QUAL_IP_PROTO_COMMONf:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56990_a0_fp_vlan_qual_ipprotocolcommon_set(unit,
                                                               value,
                                                               data,
                                                               mask));
            break;
                                  ...
                                  uint32_t *mask)
{
    ...
    if (is_presel == FALSE) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56990_a0_fp_vlan_main_qual_enum_set(unit,
                                                    qual,
                                                    value,
                                                    data,
                                                    mask));
...
STATIC int
bcm56990_a0_fp_vlan_main_qual_enum_get(int unit,
                                       bcmfp_qualifier_t qual,
                                       uint32_t data,
                                       uint32_t mask,
                                       int *value)
{
    ...
    switch (qual) {
        ...
        case FP_VLAN_GRP_TEMPLATEt_QUAL_INNER_IP_FRAGf:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56990_a0_fp_vlan_qual_ipfrag_get(unit,
                                                     data,
                                                     mask,
                                                     value));
            break;
        ...
        case FP_VLAN_GRP_TEMPLATEt_QUAL_IP_PROTO_COMMONf:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56990_a0_fp_vlan_qual_ipprotocolcommon_get(unit,
                                                               data,
                                                               mask,
                                                               value));
            break;
                                  ...
                                  int *value)
{
    ...
    if (is_presel == FALSE) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56990_a0_fp_vlan_main_qual_enum_get(unit,
                                                    qual,
                                                    data,
                                                    mask,
                                                    value));
