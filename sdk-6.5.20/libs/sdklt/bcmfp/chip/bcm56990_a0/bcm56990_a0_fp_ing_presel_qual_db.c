/*! \file bcm56990_a0_fp_ing_presel_qual_db.c
 *
                                                  ...
                                                  bcmfp_stage_t *stage)
{
    ...
    BCMFP_PRESEL_QUAL_CFG_ONE_OFFSET_ADD(unit, stage,
        fid,
        LD_QUAL_OFFSET_NO_EM_SUPPORT,
                                             ...
                                             bcmfp_stage_t *stage)
{
    ...
    fid = FP_EM_PRESEL_ENTRY_TEMPLATEt_QUAL_LOOPBACK_TYPEf;
    BCMFP_PRESEL_QUAL_CFG_ONE_OFFSET_ADD(unit, stage, fid,
        qual_flags, BCMFP_EXT_SECTION_DISABLE, 0,
        1, loopback_type_offset, 0);
