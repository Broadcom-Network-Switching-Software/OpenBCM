/*! \file bcm56990_a0_fp_counter_actions_set.c
 *
...
int
bcm56990_a0_fp_counter_actions_set(int unit,
                                   bcmfp_stage_t *stage,
    ...
    switch (stage_id) {
        case BCMFP_STAGE_ID_INGRESS:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmfp_bcm56990_a0_ingress_counter_actions_set(unit,
                                                               stage->stage_id,
                                                               group_id,
                                                               pdd_id,
                                                               opinfo,
        ...
        case BCMFP_STAGE_ID_LOOKUP:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmfp_bcm56990_a0_vlan_counter_actions_set(unit,
                                                            stage->stage_id,
                                                            group_id,
                                                            pdd_id,
                                                            opinfo,
        ...
        case BCMFP_STAGE_ID_EGRESS:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmfp_bcm56990_a0_egress_counter_actions_set(unit,
                                                              stage->stage_id,
                                                              group_id,
                                                              pdd_id,
                                                              opinfo,
        ...
        case BCMFP_STAGE_ID_EXACT_MATCH:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmfp_bcm56990_a0_em_counter_actions_set(unit,
                                                          stage->stage_id,
                                                          group_id,
                                                          pdd_id,
                                                          opinfo,
