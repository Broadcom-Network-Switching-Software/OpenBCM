/*! \file bcm56990_a0_fp_profiles_uninstall.c
 *
...
int
bcm56990_a0_fp_profiles_uninstall(int unit,
    ...
    switch (stage_id) {
        case BCMFP_STAGE_ID_INGRESS:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmfp_bcm56990_a0_ingress_profiles_uninstall(unit,
                                                              stage_id,
                                                              op_arg->trans_id,
                                                              flags,
                                                              group_id,
        ...
        case BCMFP_STAGE_ID_EXACT_MATCH:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmfp_bcm56990_a0_em_profiles_uninstall(unit,
                                                         stage_id,
                                                         op_arg->trans_id,
                                                         flags,
                                                         group_id,
