/*! \file bcm56990_a0_fp_meter_actions_set.c
 *
...
int
bcm56990_a0_fp_meter_actions_set(int unit,
                                 bcmfp_stage_t *stage,
    ...
    switch (stage_id) {
        case BCMFP_STAGE_ID_INGRESS:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmfp_bcm56990_a0_ingress_meter_actions_set(unit,
                                                             group_id,
                                                             pdd_id,
                                                             opinfo,
                                                             meter_entry,
        ...
        case BCMFP_STAGE_ID_EXACT_MATCH:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmfp_bcm56990_a0_em_meter_actions_set(unit,
                                                        group_id,
                                                        pdd_id,
                                                        opinfo,
                                                        meter_entry,
