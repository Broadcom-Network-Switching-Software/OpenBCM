/*! \file bcm56996_a0_fp_variant_attach.c
 *
 * BCMFP variant attach function for device bcm56996_a0.
 */
/*
...
int
bcm56996_a0_di_fp_variant_attach(int unit)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmfp_bcm56996_a0_ing_tbls_init(unit, stage));

    stage_id = BCMFP_STAGE_ID_EGRESS;
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmfp_stage_get(unit, stage_id, &stage));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmfp_bcm56996_a0_egress_tbls_init(unit, stage));

    stage_id = BCMFP_STAGE_ID_LOOKUP;
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmfp_stage_get(unit, stage_id, &stage));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmfp_bcm56996_a0_vlan_tbls_init(unit, stage));

    stage_id = BCMFP_STAGE_ID_EXACT_MATCH;
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmfp_stage_get(unit, stage_id, &stage));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmfp_bcm56996_a0_em_tbls_init(unit, stage));
exit:
    SHR_FUNC_EXIT();
}
