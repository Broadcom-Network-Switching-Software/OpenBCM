/*! \file bcm56996_a0_fp_ing_stage.c
 *
 * API to initialize stage attributes for Tomahawk-4G(56996_A0) device.
 */
/*
...
int
bcmfp_bcm56996_a0_ingress_device_consts_init(int unit,
                                             bcmfp_stage_t *stage,
                                             bool warm)
{
    ...
    if (!warm)  {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmfp_bcm56996_a0_ifp_spare_debug_set(unit));
    }
