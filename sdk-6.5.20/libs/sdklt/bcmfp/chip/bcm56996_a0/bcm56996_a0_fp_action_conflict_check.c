/*! \file bcm56996_a0_fp_action_conflict_check.c
 *
...
int
bcm56996_a0_fp_action_conflict_check(int unit,
                                     bcmfp_stage_t *stage,
    ...
    switch (stage_id) {
        case BCMFP_STAGE_ID_INGRESS:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmfp_bcm56996_a0_ingress_action_cfg_conflict_check(unit,
                                                                     action1,
                                                                     action2));
            break;
        case BCMFP_STAGE_ID_LOOKUP:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmfp_bcm56996_a0_vlan_action_cfg_conflict_check(unit,
                                                                  action1,
                                                                  action2));
            break;
        case BCMFP_STAGE_ID_EGRESS:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmfp_bcm56996_a0_egress_action_cfg_conflict_check(unit,
                                                                    action1,
                                                                    action2));
            break;
        case BCMFP_STAGE_ID_EXACT_MATCH:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmfp_bcm56996_a0_em_action_cfg_conflict_check(unit,
                                                                action1,
                                                                action2));
            break;
        default:
