/*! \file bcm56996_a0_fp_vlan_tbls.c
 *
...
bcm56996_a0_vlan_group_qualifiers_fid_info[FP_VLAN_GRP_TEMPLATEt_FIELD_COUNT];

bcmfp_tbl_qualifier_fid_info_t
bcm56996_a0_vlan_rule_qualifiers_fid_info[FP_VLAN_RULE_TEMPLATEt_FIELD_COUNT];

bcmfp_tbl_action_fid_info_t
bcm56996_a0_vlan_policy_actions_fid_info[FP_VLAN_POLICY_TEMPLATEt_FIELD_COUNT];

static void bcmfp_bcm56996_a0_vlan_group_qualifiers_map(void);
static void bcmfp_bcm56996_a0_vlan_rule_qualifiers_map(void);
static void bcmfp_bcm56996_a0_vlan_policy_actions_map(void);

bcmfp_tbl_group_t bcm56996_a0_vlan_group_tbl = {
    ...
    .qualifiers_fid_info = bcm56996_a0_vlan_group_qualifiers_fid_info,
...
bcmfp_tbl_group_info_t bcm56996_a0_vlan_group_info_tbl = {
...
static void
bcmfp_bcm56996_a0_vlan_group_qualifiers_map(void)
{
    uint32_t fid;
    bcmfp_tbl_qualifier_fid_info_t *group_qualifiers_fid_info = NULL;

    group_qualifiers_fid_info = bcm56996_a0_vlan_group_qualifiers_fid_info;
...
static void
bcmfp_bcm56996_a0_vlan_rule_qualifiers_map(void)
{
    uint32_t fid;
    uint32_t map_fid;
    ...
    rule_qualifiers_fid_info = bcm56996_a0_vlan_rule_qualifiers_fid_info;
    group_qualifiers_fid_info = bcm56996_a0_vlan_group_qualifiers_fid_info;
...
static void
bcmfp_bcm56996_a0_vlan_policy_actions_map(void)
{
    uint32_t fid;
    bcmfp_tbl_action_fid_info_t *policy_actions_fid_info = NULL;

    policy_actions_fid_info = bcm56996_a0_vlan_policy_actions_fid_info;
...
int
bcmfp_bcm56996_a0_vlan_tbls_init(int unit,
                                 bcmfp_stage_t *stage)
{
    SHR_FUNC_ENTER(unit);
    ...
    stage->tbls.group_tbl = &bcm56996_a0_vlan_group_tbl;
    stage->tbls.group_info_tbl = &bcm56996_a0_vlan_group_info_tbl;
    stage->tbls.rule_tbl = &bcm56996_a0_vlan_rule_tbl;
    stage->tbls.policy_tbl = &bcm56996_a0_vlan_policy_tbl;
    stage->tbls.entry_tbl = &bcm56996_a0_vlan_entry_tbl;
    (void)bcmfp_bcm56996_a0_vlan_group_qualifiers_map();
    (void)bcmfp_bcm56996_a0_vlan_rule_qualifiers_map();
    (void)bcmfp_bcm56996_a0_vlan_policy_actions_map();
