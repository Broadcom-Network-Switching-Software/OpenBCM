/*! \file bcm56996_a0_fp_em_action_db.c
 *
 * EM action configuration DB initialization function for Tomahawk-4G(56996_A0).
 */
/*
...
/* Action set's supported in 56996_A0 in the
...
static uint16_t bcm56996_a0_em_pdd_container_size[] = {
    16, /* IFP_METER_SET */
...
int
bcmfp_bcm56996_a0_em_action_cfg_db_init(int unit,
                                        bcmfp_stage_t *stage)
{
    ...
    if (BCMFP_STAGE_FLAGS_TEST(stage, BCMFP_STAGE_KEY_TYPE_PRESEL)) {
        SHR_IF_ERR_EXIT(
            bcmfp_bcm56996_a0_em_presel_action_cfg_db_init(unit, stage));
    }
    ...
    BCMFP_ACTION_CFG_OFFSET_ADD(2, 16, 18, 4, 6);
    ...
    /* BCMFP_ACTION_SWITCH_TO_ECMP_RESET_OVERLAY_NHOP_ID */
    BCMFP_ACTION_CFG_INIT(unit);
    BCMFP_ACTION_CFG_OFFSET_ADD(0, 16, 0, 12, -1);
    BCMFP_ACTION_CFG_OFFSET_ADD(1, 16, 16, 1, 1);
    BCMFP_ACTION_CFG_OFFSET_ADD(2, 16, 17, 1, 1);
    BCMFP_ACTION_CFG_OFFSET_ADD(3, 16, 18, 4, 6);
    fid = FP_EM_POLICY_TEMPLATEt_ACTION_SWITCH_TO_ECMP_RESET_OVERLAY_NHOP_IDf;
    BCMFP_ACTION_CFG_INSERT(unit, stage, fid, flags);

    /* BCMFP_ACTION_ECMP_HASH */
    BCMFP_ACTION_CFG_INIT(unit);
    BCMFP_ACTION_CFG_OFFSET_ADD(0, 16, 13, 3, -1);
    BCMFP_ACTION_CFG_OFFSET_ADD(1, 16, 18, 4, 6);
    fid = FP_EM_POLICY_TEMPLATEt_ACTION_ECMP_HASHf;
    BCMFP_ACTION_CFG_INSERT(unit, stage, fid, flags);

    /* BCMFP_ACTION_L3_SWITCH_CANCEL */
    BCMFP_ACTION_CFG_INIT(unit);
    BCMFP_ACTION_CFG_OFFSET_ADD(0, 16, 18, 4, 7);
    ...
    BCMFP_ACTION_CFG_OFFSET_ADD(1, 16, 18, 4, 8);
    ...
    BCMFP_ACTION_CFG_INIT(unit);
    BCMFP_ACTION_CFG_OFFSET_ADD(0, 16, 0, 12, -1);
    BCMFP_ACTION_CFG_OFFSET_ADD(1, 16, 18, 4, 9);
    ...
    BCMFP_ACTION_CFG_INIT(unit);
    BCMFP_ACTION_CFG_OFFSET_ADD(0, 12, 0, 9, -1);
    BCMFP_ACTION_CFG_OFFSET_ADD(1, 12, 15 , 1, 0);
    BCMFP_ACTION_CFG_OFFSET_ADD(2, 12, 22, 3, 0);
    BCMFP_ACTION_CFG_OFFSET_ADD(3, 12, 16, 3, 1);
    ...
    BCMFP_ACTION_CFG_INIT(unit);
    BCMFP_ACTION_CFG_OFFSET_ADD(0, 12, 0, 9, -1);
    BCMFP_ACTION_CFG_OFFSET_ADD(1, 12, 15, 1, 1);
    BCMFP_ACTION_CFG_OFFSET_ADD(2, 12, 22, 3, 0);
    BCMFP_ACTION_CFG_OFFSET_ADD(3, 12, 16, 3, 1);
    ...
    BCMFP_ACTION_CFG_OFFSET_ADD(0, 12, 0, 9, -1);
    BCMFP_ACTION_CFG_OFFSET_ADD(1, 12, 15, 1, 0);
    BCMFP_ACTION_CFG_OFFSET_ADD(2, 12, 22, 3, 1);
    BCMFP_ACTION_CFG_OFFSET_ADD(3, 12, 16, 3, 1);
    ...
    BCMFP_ACTION_CFG_INIT(unit);
    BCMFP_ACTION_CFG_OFFSET_ADD(0, 12, 0, 15, -1);
    BCMFP_ACTION_CFG_OFFSET_ADD(1, 12, 22, 3, 2);
    BCMFP_ACTION_CFG_OFFSET_ADD(2, 12, 16, 3, 1);
    fid = FP_EM_POLICY_TEMPLATEt_ACTION_REDIRECT_TO_NHOPf;
    BCMFP_ACTION_CFG_INSERT(unit, stage, fid, flags);

    /* BCMFP_ACTION_REDIRECT_TO_ECMP */
    BCMFP_ACTION_CFG_INIT(unit);
    BCMFP_ACTION_CFG_OFFSET_ADD(0, 12, 0, 12, -1);
    BCMFP_ACTION_CFG_OFFSET_ADD(1, 12, 22, 3, 3);
    BCMFP_ACTION_CFG_OFFSET_ADD(2, 12, 16, 3, 1);
    ...
    BCMFP_ACTION_CFG_INIT(unit);
    BCMFP_ACTION_CFG_OFFSET_ADD(0, 12, 19, 2, 2);
    BCMFP_ACTION_CFG_OFFSET_ADD(1, 12, 16, 3, 3);
    BCMFP_ACTION_CFG_OFFSET_ADD(2, 12, 0, 10, -1);
    fid = FP_EM_POLICY_TEMPLATEt_ACTION_REDIRECT_L2_MC_GROUP_IDf;
    BCMFP_ACTION_CFG_INSERT(unit, stage, fid, flags);

    /* BCMFP_ACTION_REDIRECT_L3_MC_NHOP_ID */
    BCMFP_ACTION_CFG_INIT(unit);
    BCMFP_ACTION_CFG_OFFSET_ADD(0, 12, 19, 2, 3);
    BCMFP_ACTION_CFG_OFFSET_ADD(1, 12, 16, 3, 3);
    BCMFP_ACTION_CFG_OFFSET_ADD(2, 12, 0, 9, -1);
    ...
    /* BCMFP_ACTION_DISABLE_SRC_PRUNING */
    BCMFP_ACTION_CFG_INIT(unit);
    BCMFP_ACTION_CFG_OFFSET_ADD(0, 0, 15, 1, 1);
    fid = FP_EM_POLICY_TEMPLATEt_ACTION_DISABLE_SRC_PRUNINGf;
    BCMFP_ACTION_CFG_INSERT(unit, stage, fid, flags);
    ...
    /* CTR_ING_EFLEX_CONTAINER_ID */
    BCMFP_ACTION_CFG_INIT(unit);
    BCMFP_ACTION_CFG_OFFSET_ADD(0, 3, 19, 22, -1);
    fid = FP_EM_POLICY_TEMPLATEt_CTR_ING_EFLEX_CONTAINER_IDf;
    BCMFP_ACTION_CFG_INSERT(unit, stage, fid, flags);
    ...
    BCMFP_ACTION_CFG_INIT(unit);
    BCMFP_ACTION_CFG_OFFSET_ADD(0, 5, 7, 1, 1);
    ...
    BCMFP_ACTION_CFG_INIT(unit);
    BCMFP_ACTION_CFG_OFFSET_ADD(0, 6, 7, 1, 1);
    ...
    stage->action_cfg_db->container_size =
           bcm56996_a0_em_pdd_container_size;
