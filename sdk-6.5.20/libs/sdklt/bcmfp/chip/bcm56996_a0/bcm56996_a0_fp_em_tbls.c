/*! \file bcm56996_a0_fp_em_tbls.c
 *
 * API to initialize exact match FP stage logical tables and
 * some FIDs in each of those logical table for Tomahawk-4GG(56996_A0).
 */
/*
...
bcm56996_a0_em_group_qualifiers_fid_info[FP_EM_GRP_TEMPLATEt_FIELD_COUNT];

bcmfp_tbl_qualifier_fid_info_t
bcm56996_a0_em_rule_qualifiers_fid_info[FP_EM_RULE_TEMPLATEt_FIELD_COUNT];

bcmfp_tbl_action_fid_info_t
bcm56996_a0_em_policy_actions_fid_info[FP_EM_POLICY_TEMPLATEt_FIELD_COUNT];

bcmfp_tbl_action_fid_info_t
bcm56996_a0_em_pdd_actions_fid_info[FP_EM_PDD_TEMPLATEt_FIELD_COUNT];

bcmfp_tbl_qualifier_fid_info_t
bcm56996_a0_em_pse_qualifiers_fid_info
                          [FP_EM_PRESEL_ENTRY_TEMPLATEt_FIELD_COUNT];

static void bcmfp_bcm56996_a0_em_group_qualifiers_map(void);
static void bcmfp_bcm56996_a0_em_rule_qualifiers_map(void);
static void bcmfp_bcm56996_a0_em_policy_actions_map(void);
static void bcmfp_bcm56996_a0_em_pdd_actions_map(void);
static void bcmfp_bcm56996_a0_em_pse_qualifiers_map(void);

bcmfp_tbl_group_t bcm56996_a0_em_group_tbl = {
    ...
    .qualifiers_fid_info = bcm56996_a0_em_group_qualifiers_fid_info,
    .enable_fid = FP_EM_GRP_TEMPLATEt_ENABLEf,
    .fid_count = FP_EM_GRP_TEMPLATEt_FIELD_COUNT,
};

bcmfp_tbl_group_info_t bcm56996_a0_em_group_info_tbl = {
...
bcmfp_tbl_rule_t bcm56996_a0_em_rule_tbl = {
    .sid = FP_EM_RULE_TEMPLATEt,
    .key_fid = FP_EM_RULE_TEMPLATEt_FP_EM_RULE_TEMPLATE_IDf,
    .qualifiers_fid_info = bcm56996_a0_em_rule_qualifiers_fid_info,
    .fid_count = FP_EM_RULE_TEMPLATEt_FIELD_COUNT,
};

bcmfp_tbl_policy_t bcm56996_a0_em_policy_tbl = {
    ...
    .actions_fid_info = bcm56996_a0_em_policy_actions_fid_info,
    .fid_count = FP_EM_POLICY_TEMPLATEt_FIELD_COUNT,
};

bcmfp_tbl_pdd_t bcm56996_a0_em_pdd_tbl = {
    .sid = FP_EM_PDD_TEMPLATEt,
    .key_fid = FP_EM_PDD_TEMPLATEt_FP_EM_PDD_TEMPLATE_IDf,
    .actions_fid_info = bcm56996_a0_em_pdd_actions_fid_info,
    .fid_count = FP_EM_PDD_TEMPLATEt_FIELD_COUNT,
};

bcmfp_tbl_pse_t bcm56996_a0_em_pse_tbl = {
    ...
    .qualifiers_fid_info = bcm56996_a0_em_pse_qualifiers_fid_info,
};

bcmfp_tbl_entry_t bcm56996_a0_em_entry_tbl = {
    .sid = FP_EM_ENTRYt,
...
bcmfp_tbl_src_class_t bcm56996_a0_em_src_class_tbl = {
...
bcmfp_tbl_meter_t bcm56996_a0_em_meter_tbl = {
...
static void
bcmfp_bcm56996_a0_em_group_qualifiers_map(void)
{
    uint32_t fid;
    bcmfp_tbl_qualifier_fid_info_t *group_qualifiers_fid_info = NULL;

    group_qualifiers_fid_info = bcm56996_a0_em_group_qualifiers_fid_info;
...
static void
bcmfp_bcm56996_a0_em_rule_qualifiers_map(void)
{
    uint32_t fid;
    uint32_t map_fid;
    bcmfp_tbl_qualifier_fid_info_t *rule_qualifiers_fid_info = NULL;

    rule_qualifiers_fid_info = bcm56996_a0_em_rule_qualifiers_fid_info;
...
static void
bcmfp_bcm56996_a0_em_policy_actions_map(void)
{
    uint32_t fid;
    bcmfp_tbl_action_fid_info_t *policy_actions_fid_info = NULL;

    policy_actions_fid_info = bcm56996_a0_em_policy_actions_fid_info;
...
static void
bcmfp_bcm56996_a0_em_pdd_actions_map(void)
{
    uint32_t fid;
    uint32_t map_fid;
    bcmfp_tbl_action_fid_info_t *policy_actions_fid_info = NULL;
    ...
    policy_actions_fid_info = bcm56996_a0_em_policy_actions_fid_info;
    pdd_actions_fid_info = bcm56996_a0_em_pdd_actions_fid_info;
...
static void
bcmfp_bcm56996_a0_em_pse_qualifiers_map(void)
{
    uint32_t fid;
    uint32_t map_fid;
...
int
bcmfp_bcm56996_a0_em_tbls_init(int unit,
                               bcmfp_stage_t *stage)
{
    SHR_FUNC_ENTER(unit);
    ...
    stage->tbls.group_tbl = &bcm56996_a0_em_group_tbl;
    stage->tbls.group_info_tbl = &bcm56996_a0_em_group_info_tbl;
    stage->tbls.rule_tbl = &bcm56996_a0_em_rule_tbl;
    stage->tbls.policy_tbl = &bcm56996_a0_em_policy_tbl;
    stage->tbls.entry_tbl = &bcm56996_a0_em_entry_tbl;
    stage->tbls.pse_tbl = &bcm56996_a0_em_pse_tbl;
    stage->tbls.pdd_tbl = &bcm56996_a0_em_pdd_tbl;
    stage->tbls.src_class_tbl = &bcm56996_a0_em_src_class_tbl;
    stage->tbls.meter_tbl = &bcm56996_a0_em_meter_tbl;
    (void)bcmfp_bcm56996_a0_em_group_qualifiers_map();
    (void)bcmfp_bcm56996_a0_em_rule_qualifiers_map();
    (void)bcmfp_bcm56996_a0_em_policy_actions_map();
    (void)bcmfp_bcm56996_a0_em_pdd_actions_map();
    (void)bcmfp_bcm56996_a0_em_pse_qualifiers_map();
