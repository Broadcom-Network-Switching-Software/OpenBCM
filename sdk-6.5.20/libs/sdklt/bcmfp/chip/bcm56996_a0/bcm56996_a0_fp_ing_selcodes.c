/*! \file bcm56996_a0_fp_ing_selcodes.c
 *
...
int
bcmfp_bcm56996_a0_ingress_profiles_install(int unit,
                                           uint32_t stage_id,
                                           uint32_t trans_id,
                                           uint32_t flags,
                                           ...
                                           bcmfp_buffers_t *buffers)
{
    ...
    if (opinfo->group_mode == BCMFP_GROUP_MODE_DBLINTRA)  {
        ...
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmfp_bcm56996_a0_ext_codes_init(unit,
                                              ext_codes,
                                              part,
                                              kgp_sid,
                                              prof_entry));
...
int
bcmfp_bcm56996_a0_ingress_profiles_uninstall(int unit,
                                             uint32_t stage_id,
                                             uint32_t trans_id,
                                             uint32_t flags,
                                             bcmfp_group_id_t group_id,
