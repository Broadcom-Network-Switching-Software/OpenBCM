...
STATIC int
bcmfp_bcm56996_a0_keygen_mask_init(int unit,
                                   uint32_t trans_id,
                                   bcmfp_stage_t *stage,
...
STATIC int
bcmfp_bcm56996_a0_em_keygen_install(int unit,
                                    uint32_t trans_id,
                                    bcmfp_stage_t *stage,
                                    void *group_opinfo,
                                    uint8_t num_parts)
{
    ...
    for (part = 0; part < num_parts; part++) {
        ...
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmfp_bcm56996_a0_keygen_mask_init(unit,
                                                trans_id,
                                                stage,
                                                group_id,
                                                opinfo,
...
STATIC int
bcmfp_bcm56996_a0_em_keygen_uninstall(int unit,
                                      uint32_t trans_id,
                                      void *group_opinfo,
                                      bcmfp_stage_t *stage,
                                      uint8_t num_parts)
...
STATIC int
bcmfp_bcm56996_a0_em_pdd_profile_install(int unit,
                                         uint32_t trans_id,
                                         bool default_entry,
                                         void *group_opinfo,
                                         bcmfp_stage_t *stage,
...
STATIC int
bcmfp_bcm56996_a0_em_pdd_profile_uninstall(int unit,
                                           uint32_t trans_id,
                                           bool default_entry,
                                           void *group_opinfo,
                                           bcmfp_stage_t *stage)
...
STATIC int
bcmfp_bcm56996_a0_em_qos_profile_install(int unit,
                                         uint32_t trans_id,
                                         bool default_entry,
                                         bcmfp_stage_t *stage,
                                         void *group_opinfo,
...
STATIC int
bcmfp_bcm56996_a0_em_qos_profile_uninstall(int unit,
                                           uint32_t trans_id,
                                           bool default_entry,
                                           bcmfp_stage_t *stage,
                                           void *group_opinfo)
...
STATIC int
bcmfp_bcm56996_a0_em_dpolicy_install(int unit,
                                  uint32_t trans_id,
                                  bcmfp_stage_t *stage,
                                  void *group_opinfo,
                                  uint32_t *edw)
...
STATIC int
bcmfp_bcm56996_a0_em_dpolicy_uninstall(int unit,
                                       uint32_t trans_id,
                                       void *group_opinfo,
                                       bcmfp_stage_t *stage)
{
                                      ...
                                      bcmfp_buffers_t *buffers)
{
    ...
    if (flags & BCMFP_GROUP_INSTALL_KEYGEN_PROFILE) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmfp_bcm56996_a0_em_keygen_install(unit,
                                                 trans_id,
                                                 stage,
                                                 (void *)opinfo,
                                                 num_parts));
    ...
    if (flags & BCMFP_GROUP_INSTALL_PDD_PROFILE) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmfp_bcm56996_a0_em_pdd_profile_install(unit,
                                                 trans_id,
                                                 FALSE,
                                                 (void *)opinfo,
                                                 stage,
    ...
    if (flags & BCMFP_GROUP_INSTALL_QOS_PROFILE) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmfp_bcm56996_a0_em_qos_profile_install(unit,
                                                 trans_id,
                                                 FALSE,
                                                 stage,
                                                 (void *)opinfo,
    ...
    if (flags & BCMFP_GROUP_INSTALL_DPOLICY) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmfp_bcm56996_a0_em_dpolicy_install(unit,
                                                 trans_id,
                                                 stage,
                                                 (void *)opinfo,
                                                 buffers->dedw[0]));
                                        ...
                                        bcmfp_group_oper_info_t *opinfo)
{
    ...
    if (flags & BCMFP_GROUP_INSTALL_KEYGEN_PROFILE) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmfp_bcm56996_a0_em_keygen_uninstall(unit,
                                                   trans_id,
                                                   (void *)opinfo,
                                                   stage,
                                                   num_parts));
    ...
    if (flags & BCMFP_GROUP_INSTALL_PDD_PROFILE) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmfp_bcm56996_a0_em_pdd_profile_uninstall(unit,
                                                   trans_id,
                                                   FALSE,
                                                   (void *)opinfo,
                                                   stage));
    ...
    if (flags & BCMFP_GROUP_INSTALL_QOS_PROFILE) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmfp_bcm56996_a0_em_qos_profile_uninstall(unit,
                                                   trans_id,
                                                   FALSE,
                                                   stage,
                                                   (void *)opinfo));
    ...
    if (flags & BCMFP_GROUP_INSTALL_DPOLICY) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmfp_bcm56996_a0_em_dpolicy_uninstall(unit,
                                                   trans_id,
                                                   (void *)opinfo,
                                                   stage));
    }
