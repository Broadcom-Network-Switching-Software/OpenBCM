/*! \file bcm56996_a0_fp_src_class_mode_set.c
 *
...
int
bcm56996_a0_fp_src_class_mode_set(int unit,
    ...
    switch (stage_id) {
        case BCMFP_STAGE_ID_INGRESS:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmfp_bcm56996_a0_ingress_src_class_mode_set(unit,
                                                              op_arg->trans_id,
                                                              sid,
                                                              pipe_id,
                                                              mode));
        ...
        case BCMFP_STAGE_ID_EXACT_MATCH:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcmfp_bcm56996_a0_em_src_class_mode_set(unit,
                                                         op_arg->trans_id,
                                                         sid,
                                                         pipe_id,
                                                         mode ));
