/*! \file bcm56996_a0_fp_ing_action_db.c
 *
 *  IFP action configuration DB initialization function for Tomahawk-4G(56996_A0).
 */
/*
...
int
bcmfp_bcm56996_a0_ingress_action_cfg_db_init(int unit,
                                             bcmfp_stage_t *stage)
{
    ...
    uint32_t ddrop_offset = 0;                     /* Offset of IFP_DELAYED_DROP_SET. */
    uint32_t dredirect_offset = 0;                 /* Offset of IFP_DELAYED_REDIRECT_SET. */
    ...
    if (BCMFP_STAGE_FLAGS_TEST(stage, BCMFP_STAGE_KEY_TYPE_PRESEL)) {
        SHR_IF_ERR_EXIT(
               bcmfp_bcm56996_a0_ingress_presel_action_cfg_db_init(unit,
                                                                   stage));
    }
    ...
    ctr_offset             = 63; /* REDIRECT_SET(38b) +
                                  * CHANGE_CPU_COS_SET(8b) +
                                  * COPY_TO_CPU_SET(17b) */
    cutthrough_offset      = 92; /* REDIRECT_SET(38b) +
                                  * CHANGE_CPU_COS_SET(8b) +
                                  * COPY_TO_CPU_SET(17b) +
                                  * COUNTER_SET(29b) */
    dcn_offset             = 93; /* REDIRECT_SET(38b) +
                                  * CHANGE_CPU_COS_SET(8b) +
                                  * COPY_TO_CPU_SET(17b) +
                                  * COUNTER_SET(29b) +
                                  * CUT_THRU_OVERRIDE_SET(1b) */
    ddrop_offset           = 95; /* REDIRECT_SET(38b) +
                                  * CHANGE_CPU_COS_SET(8b) +
                                  * COPY_TO_CPU_SET(17b) +
                                  * COUNTER_SET(29b) +
                                  * CUT_THRU_OVERRIDE_SET(1b) +
                                  * DCN_ACTIONS_SET((2b) */
    dredirect_offset       = 103;/* REDIRECT_SET(38b) +
                                  * CHANGE_CPU_COS_SET(8b) +
                                  * COPY_TO_CPU_SET(17b) +
                                  * COUNTER_SET(29b) +
                                  * CUT_THRU_OVERRIDE_SET(1b) +
    ...
    dlb_ecmp_monitor_offset = 130; /* REDIRECT_SET(38b) +
                                    * CHANGE_CPU_COS_SET(8b) +
                                    * COPY_TO_CPU_SET(17b) +
                                    * COUNTER_SET(29b) +
                                    * CUT_THRU_OVERRIDE_SET(1b) +
    ...
    drop_offset             = 134; /* REDIRECT_SET(38b) +
                                    * CHANGE_CPU_COS_SET(8b) +
                                    * COPY_TO_CPU_SET(17b) +
                                    * COUNTER_SET(29b) +
                                    * CUT_THRU_OVERRIDE_SET(1b) +
                                    ...
                                    * DLB_ECMP_MONITOR_SET(2b) +
                                    * DLB_ECMP_SET(2b) */
    elephant_trap_offset    = 140; /* REDIRECT_SET(38b) +
                                    * CHANGE_CPU_COS_SET(8b) +
                                    * COPY_TO_CPU_SET(17b) +
                                    * COUNTER_SET(29b) +
                                    * CUT_THRU_OVERRIDE_SET(1b) +
                                    ...
                                    * DROP_SET(6b) */
    green_to_pid_offset     = 146; /* REDIRECT_SET(38b) +
                                    * CHANGE_CPU_COS_SET(8b) +
                                    * COPY_TO_CPU_SET(17b) +
                                    * COUNTER_SET(29b) +
                                    * CUT_THRU_OVERRIDE_SET(1b) +
                                    ...
                                    * DROP_SET(6b) +
                                    * ELEPHANT_TRAP_SET(6b) */
    ifp_mirror_on_drop_set  = 147; /* REDIRECT_SET(38b) +
                                    * CHANGE_CPU_COS_SET(8b) +
                                    * COPY_TO_CPU_SET(17b) +
                                    * COUNTER_SET(29b) +
                                    * CUT_THRU_OVERRIDE_SET(1b) +
                                    ...
                                    * ELEPHANT_TRAP_SET(6b) +
                                    * GREEN_TO_PID_SET(1b) */
    ifp_multiple_mirror_dst_offset = 152; /* REDIRECT_SET(38b) +
                                           * CHANGE_CPU_COS_SET(8b) +
                                           * COPY_TO_CPU_SET(17b) +
                                           * COUNTER_SET(29b) +
                                           * CUT_THRU_OVERRIDE_SET(1b) +
                                           ...
                                           * IFP_MIRROR_ON_DROP_SET (5b) +
                                           * ELEPHANT_TRAP_SET(6b) */
    inband_telemetry_offset = 159; /* REDIRECT_SET(38b) +
                                    * CHANGE_CPU_COS_SET(8b) +
                                    * COPY_TO_CPU_SET(17b) +
                                    * COUNTER_SET(29b) +
                                    * CUT_THRU_OVERRIDE_SET(1b) +
    ...
    debug_offset           = 191;  /* REDIRECT_SET(38b) +
                                    * CHANGE_CPU_COS_SET(8b) +
                                    * COPY_TO_CPU_SET(17b) +
                                    * COUNTER_SET(29b) +
                                    * CUT_THRU_OVERRIDE_SET(1b) +
    ...
    l3swl2change_offset    = 192;  /* REDIRECT_SET(38b) +
                                    * CHANGE_CPU_COS_SET(8b) +
                                    * COPY_TO_CPU_SET(17b) +
                                    * COUNTER_SET(29b) +
                                    * CUT_THRU_OVERRIDE_SET(1b) +
    ...
    lb_offset              = 214;  /* REDIRECT_SET(38b) +
                                    * CHANGE_CPU_COS_SET(8b) +
                                    * COPY_TO_CPU_SET(17b) +
                                    * COUNTER_SET(29b) +
                                    * CUT_THRU_OVERRIDE_SET(1b) +
                                    ...
                                    * INBAND_TELEMETRY_SET(32b) +
                                    * INSTRUMENTATION_SET(1b) +
                                    * L3SW_CHANGE_L2_SET(22b) */
    mirror_override_offset = 232;  /* REDIRECT_SET(38b) +
                                    * CHANGE_CPU_COS_SET(8b) +
                                    * COPY_TO_CPU_SET(17b) +
                                    * COUNTER_SET(29b) +
                                    * CUT_THRU_OVERRIDE_SET(1b) +
                                    ...
                                    * LB_CONTROLS_SET(2b) +
                                    * METER_SET(16b) */
    mirror_offset          = 233;  /* REDIRECT_SET(38b) +
                                    * CHANGE_CPU_COS_SET(8b) +
                                    * COPY_TO_CPU_SET(17b) +
                                    * COUNTER_SET(29b) +
                                    * CUT_THRU_OVERRIDE_SET(1b) +
    ...
    profile_one_offset     = 252;  /* REDIRECT_SET(38b) +
                                    * CHANGE_CPU_COS_SET(8b) +
                                    * COPY_TO_CPU_SET(17b) +
                                    * COUNTER_SET(29b) +
                                    * CUT_THRU_OVERRIDE_SET(1b) +
                                    ...
                                    * MIRROR_OVERRIDE_SET(1b) +
                                    * MIRROR_SET(15b) */
    profile_two_offset     = 308;  /* REDIRECT_SET(38b) +
                                    * CHANGE_CPU_COS_SET(8b) +
                                    * COPY_TO_CPU_SET(17b) +
                                    * COUNTER_SET(29b) +
                                    * CUT_THRU_OVERRIDE_SET(1b) +
    ...
    protect_sw_offset      = 357,   /* REDIRECT_SET(38b) +
                                    ...
                                    * PROFILE_SET_1(56b) +
                                    * PROFILE_SET_2(52b) */
    sflow_offset           = 361;  /* REDIRECT_SET(38b) +
                                    * CHANGE_CPU_COS_SET(8b) +
                                    * COPY_TO_CPU_SET(17b) +
                                    * COUNTER_SET(29b) +
                                    * CUT_THRU_OVERRIDE_SET(1b) +
    ...
    timestamp_offset       = 368;  /* REDIRECT_SET(38b) +
                                    * CHANGE_CPU_COS_SET(8b) +
                                    * COPY_TO_CPU_SET(17b) +
                                    * COUNTER_SET(29b) +
                                    * CUT_THRU_OVERRIDE_SET(1b) +
    ...
    ttl_offset             = 372;  /* REDIRECT_SET(38b) +
                                    * CHANGE_CPU_COS_SET(8b) +
                                    * COPY_TO_CPU_SET(17b) +
                                    * COUNTER_SET(29b) +
                                    * CUT_THRU_OVERRIDE_SET(1b) +
    ...
    BCMFP_ACTION_CFG_ADD_THREE(unit, stage,
                               ...
                               0,
                               offset + 0, 15, -1,
                               offset + 22, 3, 2, offset + 16, 3, 1);
    fid = FP_ING_POLICY_TEMPLATEt_ACTION_REDIRECT_TO_ECMP_RESET_OVERLAY_NHOP_IDf;
    BCMFP_ACTION_CFG_ADD_FOUR(unit, stage,
                               fid,
                               0,
                               0,
                               offset + 0, 12, -1, offset + 21, 1, 1,
                               offset + 22, 3, 3, offset + 16, 3, 1);
    ...
    BCMFP_ACTION_CFG_ADD_ONE(unit, stage, fid,
                             0, 0,
                             offset + 0, 8, -1);
    fid = FP_ING_POLICY_TEMPLATEt_ACTION_DISABLE_SRC_PRUNINGf;
    BCMFP_ACTION_CFG_ADD_ONE(unit, stage, fid,
                             0, 0,
                             offset + 15, 1, 1);
    ...
    BCMFP_ACTION_CFG_ADD_FOUR(unit, stage, fid,
                               0,
                               0,
                               offset + 0, 12, -1, offset + 16, 1, 1,
                               offset + 17, 1, 1, offset + 18, 4, 6);
    ...
    BCMFP_ACTION_CFG_ADD_ONE(unit, stage, fid,
            0, 0,
            offset + 5, 14, -1);
    fid = FP_ING_POLICY_TEMPLATEt_CTR_ING_EFLEX_CONTAINER_IDf;
    BCMFP_ACTION_CFG_ADD_ONE(unit, stage, fid,
            0, 0,
            offset + 19, 4, -1);
