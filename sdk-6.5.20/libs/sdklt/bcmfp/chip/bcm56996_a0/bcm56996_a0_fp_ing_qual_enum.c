/*! \file bcm56996_a0_fp_ing_qual_enum.c
 *
 ...
 */
STATIC int
bcm56996_a0_fp_ing_qual_stpstate_set(int unit,
                                     int stp_state,
                                     uint32_t *data,
                                     uint32_t *mask)
{
 ...
 */
STATIC int
bcm56996_a0_fp_ing_qual_stpstate_get(int unit,
                                     uint32_t data,
                                     uint32_t mask,
                                     int *stp_state)
 ...
 */
STATIC int
bcm56996_a0_fp_ing_qual_loopback_type_set(int unit,
                                          int type,
                                          uint32_t *data,
                                          uint32_t *mask)
{
 ...
 */
STATIC int
bcm56996_a0_fp_ing_qual_loopback_type_get(int unit,
                                          uint32_t data,
                                          uint32_t mask,
                                          int *type)
{
 ...
 */
STATIC int
bcm56996_a0_fp_ing_qual_tunnel_type_set(int unit,
                                        int type,
                                        uint32_t *data,
                                        uint32_t *mask)
{
 ...
 */
STATIC int
bcm56996_a0_fp_ing_qual_tunnel_type_get(int unit,
                                        uint32_t data,
                                        uint32_t mask,
                                        int *type)
{
 ...
 */
STATIC int
bcm56996_a0_fp_ing_qual_mpls_fwd_lbl_action_set(int unit,
                                                int action,
                                                uint32_t *data,
                                                uint32_t *mask)
{
 ...
 */
STATIC int
bcm56996_a0_fp_ing_qual_mpls_fwd_lbl_action_get(int unit,
                                                uint32_t data,
                                                uint32_t mask,
                                                int *action)
{
 ...
 */
STATIC int
bcm56996_a0_fp_ing_presel_qual_enum_set(int unit,
                                        ...
                                        uint32_t *mask)
{
    ...
    switch (qual) {
        ...
        case FP_ING_PRESEL_ENTRY_TEMPLATEt_QUAL_ING_STP_STATEf:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56996_a0_fp_ing_qual_stpstate_set(unit,
                                                      value,
                                                      data,
                                                      mask));
            break;
        case FP_ING_PRESEL_ENTRY_TEMPLATEt_QUAL_LOOPBACK_TYPEf:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56996_a0_fp_ing_qual_loopback_type_set(unit,
                                                           value,
                                                           data,
                                                           mask));
            break;
        case FP_ING_PRESEL_ENTRY_TEMPLATEt_QUAL_TNL_TYPEf:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56996_a0_fp_ing_qual_tunnel_type_set(unit,
                                                         value,
                                                         data,
                                                         mask));
            break;
 ...
 */
STATIC int
bcm56996_a0_fp_ing_main_qual_enum_set(int unit,
                                      bcmfp_qualifier_t qual,
                                      int value,
                                      uint32_t *data,
                                      uint32_t *mask)
{
    ...
    switch (qual) {
        ...
        case FP_ING_GRP_TEMPLATEt_QUAL_MPLS_FWD_LABEL_ACTION_BITMAPf:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56996_a0_fp_ing_qual_mpls_fwd_lbl_action_set(unit,
                                                                 value,
                                                                 data,
                                                                 mask));
            break;
 ...
 */
int
bcm56996_a0_fp_ing_qual_enum_set(int unit,
                                 bcmfp_qualifier_t qual,
                                 bool is_presel,
                                 int value,
                                 uint32_t *data,
                                 uint32_t *mask)
{
    ...
    if (is_presel == TRUE) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56996_a0_fp_ing_presel_qual_enum_set(unit,
                                                     qual,
                                                     value,
                                                     data,
                                                     mask));
        ...
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56996_a0_fp_ing_main_qual_enum_set(unit,
                                                   qual,
                                                   value,
                                                   data,
                                                   mask));
 ...
 */
STATIC int
bcm56996_a0_fp_ing_main_qual_enum_get(int unit,
                                      bcmfp_qualifier_t qual,
                                      uint32_t data,
                                      uint32_t mask,
                                      int *value)
{
    ...
    switch (qual) {
        ...
        case FP_ING_GRP_TEMPLATEt_QUAL_ING_STP_STATE_BITMAPf:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56996_a0_fp_ing_qual_stpstate_get(unit,
                                                      data,
                                                      mask,
                                                      value));
            break;
        case FP_ING_GRP_TEMPLATEt_QUAL_LOOPBACK_TYPE_BITMAPf:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56996_a0_fp_ing_qual_loopback_type_get(unit,
                                                           data,
                                                           mask,
                                                           value));
            break;
        case FP_ING_GRP_TEMPLATEt_QUAL_TNL_TYPE_BITMAPf:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56996_a0_fp_ing_qual_tunnel_type_get(unit,
                                                         data,
                                                         mask,
                                                         value));
            break;
        case FP_ING_GRP_TEMPLATEt_QUAL_MPLS_FWD_LABEL_ACTION_BITMAPf:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56996_a0_fp_ing_qual_mpls_fwd_lbl_action_get(unit,
                                                                 data,
                                                                 mask,
                                                                 value));
            break;
 ...
 */
STATIC int
bcm56996_a0_fp_ing_presel_qual_enum_get(int unit,
                                        bcmfp_qualifier_t qual,
                                        uint32_t data,
                                        uint32_t mask,
                                        int *value)
 ...
 */
int
bcm56996_a0_fp_ing_qual_enum_get(int unit,
                                 bcmfp_qualifier_t qual,
                                 bool is_presel,
                                 uint32_t data,
                                 uint32_t mask,
                                 int *value)
{
    ...
    if (is_presel == TRUE) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56996_a0_fp_ing_presel_qual_enum_get(unit,
                                                     qual,
                                                     data,
                                                     mask,
                                                     value));
        ...
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56996_a0_fp_ing_main_qual_enum_get(unit,
                                                   qual,
                                                   data,
                                                   mask,
                                                   value));
