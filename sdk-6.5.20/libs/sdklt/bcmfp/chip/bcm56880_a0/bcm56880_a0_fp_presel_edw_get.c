/*! \file bcm56880_a0_fp_presel_edw_get.c
 *
...
int
bcm56880_a0_fp_presel_edw_get(int unit,
    ...
    switch (stage_id) {
        case BCMFP_STAGE_ID_INGRESS:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56880_a0_fp_ing_presel_edw_get(unit,
                                                   stage_id,
                                                   group_id,
                                                   opinfo,
                                                   edw));
        ...
        case BCMFP_STAGE_ID_LOOKUP:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56880_a0_fp_vlan_presel_edw_get(unit,
                                                    stage_id,
                                                    group_id,
                                                    opinfo,
                                                    edw));
        ...
        case BCMFP_STAGE_ID_EGRESS:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56880_a0_fp_egr_presel_edw_get(unit,
                                                   stage_id,
                                                   group_id,
                                                   opinfo,
                                                   edw));
        ...
        case BCMFP_STAGE_ID_FLOW_TRACKER:
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56880_a0_fp_em_presel_edw_get(unit,
                                                  stage_id,
                                                  group_id,
                                                  opinfo,
                                                  edw));
