/*! \file bcm56880_a0_fp_em_custom_buffers.c
 *
...
STATIC int
bcm56880_a0_keygen_mask_init(int unit,
                             uint32_t trans_id,
                             bcmfp_stage_t *stage,
...
STATIC int
bcm56880_a0_em_keymask_install(int unit,
                               uint32_t trans_id,
                               bcmfp_stage_t *stage,
                               void *group_opinfo)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_keygen_mask_init(unit,
                                      trans_id,
                                      stage,
                                      group_id,
                                      opinfo,
...
STATIC int
bcm56880_a0_em_keymask_uninstall(int unit,
                                 uint32_t trans_id,
                                 void *group_opinfo,
                                 bcmfp_stage_t *stage)
{
...
STATIC int
bcm56880_a0_em_dpolicy_install(int unit,
                               uint32_t trans_id,
                               bcmfp_stage_t *stage,
                               void *group_opinfo,
                               uint32_t *edw)
{
    ...
    for (idx = 0; idx < r_cnt; idx++) {
        ...
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56880_a0_fp_em_bank_lookup_id_get(unit,
                                                  ptsid_arr[idx],
                                                  &lookup_id));
...
STATIC int
bcm56880_a0_em_dpolicy_uninstall(int unit,
                                 uint32_t trans_id,
                                 void *group_opinfo,
                                 bcmfp_stage_t *stage)
{
...
STATIC int
bcm56880_a0_em_psg_profile_install(int unit,
                                   uint32_t trans_id,
                                   bcmfp_stage_t *stage,
                                   void *group_opinfo,
                                   uint32_t *psg_data)
...
STATIC int
bcm56880_a0_em_psg_profile_uninstall(int unit,
                                     uint32_t trans_id,
                                     bcmfp_stage_t *stage,
                                     void *group_opinfo)
{
...
STATIC int
bcm56880_a0_em_pdd_profile_install(int unit,
                                   uint32_t trans_id,
                                   bool default_entry,
                                   void *group_opinfo,
                                   bcmfp_stage_t *stage,
...
STATIC int
bcm56880_a0_em_pdd_profile_uninstall(int unit,
                                     uint32_t trans_id,
                                     bool default_entry,
                                     void *group_opinfo,
                                     bcmfp_stage_t *stage)
...
STATIC int
bcm56880_a0_em_key_attrib_install(int unit,
                                  uint32_t trans_id,
                                  bcmfp_stage_t *stage,
                                  void *group_opinfo)
{
    ...
    if (group_mode == BCMFP_GROUP_MODE_SINGLE) {
        num_key_entries = BCM56880_A0_FP_EM_KEY_ONE_BASE_ENTRY;
        num_data_entries = BCM56880_A0_FP_EM_DATA_ZERO_BASE_ENTRY;
        key_width = (((opinfo->key_size + key_type_size + 3) / 4) - 1);
        ext_codes->num_base_entries = 1;
    } else if (group_mode == BCMFP_GROUP_MODE_DBLINTER) {
        num_key_entries = BCM56880_A0_FP_EM_KEY_TWO_BASE_ENTRY;
        ...
        num_key_entries = BCM56880_A0_FP_EM_KEY_THREE_BASE_ENTRY;
        if (opinfo->key_size >
        ...
        num_data_entries = BCM56880_A0_FP_EM_DATA_ONE_BASE_ENTRY;
...
STATIC int
bcm56880_a0_em_key_attrib_uninstall(int unit,
                                    uint32_t trans_id,
                                    bcmfp_stage_t *stage,
                                    void *group_opinfo)
{
                                   ...
                                   bcmfp_buffers_t *buffers)
{
    ...
    if (flags & BCMFP_GROUP_INSTALL_PSG_PROFILE) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56880_a0_em_psg_profile_install(unit,
                                                trans_id,
                                                stage,
                                                (void *)opinfo,
                                                buffers->psg[0]));
    ...
    if (flags & BCMFP_GROUP_INSTALL_KEY_ATTRIB_PROFILE) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56880_a0_em_key_attrib_install(unit,
                                               trans_id,
                                               stage,
                                               (void *)opinfo));
    }
    ...
    if (flags & BCMFP_GROUP_INSTALL_KEYGEN_PROFILE) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56880_a0_em_keymask_install(unit,
                                            trans_id,
                                            stage,
                                            (void *)opinfo));
    }
    ...
    if (flags & BCMFP_GROUP_INSTALL_PDD_PROFILE) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56880_a0_em_pdd_profile_install(unit,
                                                trans_id,
                                                FALSE,
                                                (void *)opinfo,
                                                stage,
    ...
    if (flags & BCMFP_GROUP_INSTALL_DPOLICY) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56880_a0_em_dpolicy_install(unit,
                                            trans_id,
                                            stage,
                                            (void *)opinfo,
                                            buffers->dedw[0]));
                                     ...
                                     bcmfp_group_oper_info_t *opinfo)
{
    ...
    if (flags & BCMFP_GROUP_INSTALL_PSG_PROFILE) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56880_a0_em_psg_profile_uninstall(unit,
                                                  trans_id,
                                                  stage,
                                                  (void *)opinfo));
    }
    ...
    if (flags & BCMFP_GROUP_INSTALL_KEY_ATTRIB_PROFILE) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56880_a0_em_key_attrib_uninstall(unit,
                                                 trans_id,
                                                 stage,
                                                 (void *)opinfo));
    }
    ...
    if (flags & BCMFP_GROUP_INSTALL_KEYGEN_PROFILE) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56880_a0_em_keymask_uninstall(unit,
                                              trans_id,
                                              (void *)opinfo,
                                              stage));
    }
    ...
    if (flags & BCMFP_GROUP_INSTALL_PDD_PROFILE) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56880_a0_em_pdd_profile_uninstall(unit,
                                                  trans_id,
                                                  FALSE,
                                                  (void *)opinfo,
                                                  stage));
    ...
    if (flags & BCMFP_GROUP_INSTALL_DPOLICY) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56880_a0_em_dpolicy_uninstall(unit,
                                              trans_id,
                                              (void *)opinfo,
                                              stage));
    }
                                     ...
                                     bcmfp_buffers_t *buffers)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_fp_common_buffers_custom_set(unit,
                                                  trans_id,
                                                  flags,
                                                  stage,
                                                  opinfo,
    ...
    if (group_mode == BCMFP_GROUP_MODE_SINGLE) {
        ...
        ext_codes->key_field_sbit[0] = BCM56880_A0_FP_EM_KEY_TYPE_SBIT;
        ext_codes->key_field_width[0] = (value + BCM56880_A0_FP_EM_KEY_TYPE_WIDTH);
        ...
        ext_codes->key_field_width[0] = (value +
                                         BCM56880_A0_FP_EM_KEY_TYPE_WIDTH);
        ext_codes->num_key_fields = 1;
...
STATIC int
bcm56880_a0_em_dpolicies_copy(int unit,
                             uint32_t trans_id,
                             bcmfp_stage_t *stage)
{
    uint32_t data_size = 0;
...
STATIC int
bcm56880_a0_em_keymasks_copy(int unit,
                             uint32_t trans_id,
                             bcmfp_stage_t *stage)
{
    uint32_t data_size = 0;
...
STATIC int
bcm56880_a0_em_key_attribs_copy(int unit,
                                   uint32_t trans_id,
                                   bcmfp_stage_t *stage)
{
    bcmfp_ref_count_t *ref_counts = NULL;
...
STATIC int
bcm56880_a0_em_psg_profiles_copy(int unit,
                                   uint32_t trans_id,
                                   bcmfp_stage_t *stage)
{
    bcmfp_ref_count_t *ref_counts = NULL;
...
STATIC int
bcm56880_a0_em_pdd_profiles_copy(int unit,
                                   uint32_t trans_id,
                                   bcmfp_stage_t *stage)
{
    bcmfp_ref_count_t *ref_counts = NULL;
...
STATIC int
bcm56880_a0_em_existing_presels_copy_to_new_banks(int unit,
                                                  bcmfp_stage_id_t stage_id,
                                                  uint32_t trans_id)
{
    uint32_t    bnk_idx = 0;
    ...
    SHR_IF_ERR_VERBOSE_EXIT
     ...
     for (ptidx = BCMFP_EM_PTID_MIN; ptidx < BCMFP_EM_PTID_COUNT; ptidx++) {
        ...
        if (!(ptidx == BCMFP_EM_LTS_TCAM_PTID ||
            ptidx == BCMFP_EM_LTS_DATA_FLOP_PTID ||
            ptidx == BCMFP_EM_LTS_DATA_PTID ||
            ptidx == BCMFP_EM_LTS_DATA_EXT_PTID)) {
            continue;
        }
                                ...
                                bcmfp_stage_t *stage)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_em_psg_profiles_copy(unit,
                                         trans_id,
                                         stage));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_em_key_attribs_copy(unit,
                                           trans_id,
                                           stage));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_em_keymasks_copy(unit,
                                        trans_id,
                                        stage));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_em_pdd_profiles_copy(unit,
                                         trans_id,
                                         stage));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_em_dpolicies_copy(unit,
                                        trans_id,
                                        stage));
   SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_em_existing_presels_copy_to_new_banks(unit,
                                                           stage->stage_id,
                                                           trans_id));
exit:
    SHR_FUNC_EXIT();
