/*! \file bcm56880_a0_fp_vlan_stage.c
 *
                                       ...
                                       bcmfp_stage_t *stage)
{
    ...
    hw_entry_info->presel_sid = IFTA40_T4T_01_LTS_TCAM_0_ONLYm;
    hw_entry_info->presel_sid_data_only = IFTA40_T4T_01_LTS_TCAM_0_DATA_ONLYm;
    ...
    stage->pdd_hw_info->pdd_bitmap_size = 121;
    ...
    section_info->section_end_bit[1] = 120;
    ...
    stage->sbr_hw_info->priority_field_info[0].width[0] = 300;
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_fp_vlan_bank_info_set(unit, stage));
exit:
    SHR_FUNC_EXIT();
}
