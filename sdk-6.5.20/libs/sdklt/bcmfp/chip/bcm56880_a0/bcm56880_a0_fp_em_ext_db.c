/*! \file bcm56880_a0_fp_em_ext_db.c
 *
                              ...
                              bcmfp_stage_t *stage)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_fp_em_ext_db_init_single(unit, stage));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_fp_em_ext_db_init_dblinter(unit, stage));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_fp_em_ext_db_init_quad(unit, stage));
exit:
    SHR_FUNC_EXIT();
}
