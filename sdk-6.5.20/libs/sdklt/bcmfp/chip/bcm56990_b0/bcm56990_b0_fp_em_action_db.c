/*! \file bcm56990_b0_fp_em_action_db.c
 *
 * EM action configuration DB initialization function for Tomahawk-4 B0(56990_B0).
 */
/*
...
/* Action set's supported in 56990_B0 in the
...
static uint16_t bcm56990_b0_em_pdd_container_size[] = {
    16, /* IFP_METER_SET */
                                        ...
                                        bcmfp_stage_t *stage)
{
    ...
    if (BCMFP_STAGE_FLAGS_TEST(stage, BCMFP_STAGE_KEY_TYPE_PRESEL)) {
        SHR_IF_ERR_EXIT(
            bcmfp_bcm56990_b0_em_presel_action_cfg_db_init(unit, stage));
    }
    ...
    stage->action_cfg_db->container_size =
           bcm56990_b0_em_pdd_container_size;
