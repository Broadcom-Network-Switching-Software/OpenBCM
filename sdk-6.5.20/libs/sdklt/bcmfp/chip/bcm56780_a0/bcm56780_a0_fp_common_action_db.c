/*! \file bcm56780_a0_fp_common_action_db.c
 *
...
uint16_t bcm56780_a0_ifp_pdd_containers_size[BCMFP_PDD_MAX_CONTAINERS];
uint16_t bcm56780_a0_efp_pdd_containers_size[BCMFP_PDD_MAX_CONTAINERS];
uint16_t bcm56780_a0_vfp_pdd_containers_size[BCMFP_PDD_MAX_CONTAINERS];
uint16_t bcm56780_a0_fp_em_pdd_containers_size[BCMFP_PDD_MAX_CONTAINERS];


STATIC int
bcm56780_a0_fp_aux_actions_init(int unit,
                                bcmfp_stage_t *stage,
                                  ...
                                  bcmfp_stage_t *stage)
{
    ...
    if (stage->stage_id == BCMFP_STAGE_ID_INGRESS) {
        pdd_containers_size = bcm56780_a0_ifp_pdd_containers_size;
    } else if (stage->stage_id == BCMFP_STAGE_ID_EGRESS) {
        pdd_containers_size = bcm56780_a0_efp_pdd_containers_size;
    } else if (stage->stage_id == BCMFP_STAGE_ID_LOOKUP) {
        pdd_containers_size = bcm56780_a0_vfp_pdd_containers_size;
    } else if (stage->stage_id == BCMFP_STAGE_ID_EXACT_MATCH ||
               stage->stage_id == BCMFP_STAGE_ID_FLOW_TRACKER) {
        pdd_containers_size = bcm56780_a0_fp_em_pdd_containers_size;
    } else {
        SHR_ERR_EXIT(SHR_E_INTERNAL);
    }
    ...
    /* Aux actions init */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_fp_aux_actions_init(unit, stage, &cont_id));
    ...
    SHR_IF_ERR_VERBOSE_EXIT(bcm56780_a0_fp_common_presel_action_db_init
                                (unit, stage));
exit:
    SHR_FUNC_EXIT();
}
