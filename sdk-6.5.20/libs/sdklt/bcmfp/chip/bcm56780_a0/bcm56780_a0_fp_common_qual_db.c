/*! \file bcm56780_a0_fp_common_qual_db.c
 *
                                ...
                                bcmfp_stage_t *stage)
{
    ...
    if (stage->stage_id == BCMFP_STAGE_ID_INGRESS) {
       tile_id = BCMDRD_BCM56780_A0_TILE_IFTA100;
    } else if (stage->stage_id == BCMFP_STAGE_ID_EGRESS) {
       tile_id = BCMDRD_BCM56780_A0_TILE_EFTA30;
    } else if (stage->stage_id == BCMFP_STAGE_ID_LOOKUP) {
       tile_id = BCMDRD_BCM56780_A0_TILE_IFTA40;
    } else {
        SHR_IF_ERR_EXIT(SHR_E_INTERNAL);
    }
