/*! \file bcm56780_a0_fp_egr_stage.c
 *
                              ...
                              bcmfp_stage_t *stage)
{
    ...
    hw_entry_info->presel_sid = EFTA30_T4T_00_LTS_TCAM_0m;
    ...
    section_info->section_end_bit[0] = 62;
    section_info->section_is_lsb[0] = TRUE;
    section_info->section_align_bits[0] = 16;
    section_info->section_id[1] = 1;
    section_info->section_start_bit[1] = 63;
    section_info->section_end_bit[1] = 121;
    section_info->section_is_lsb[1] = TRUE;
    section_info->section_align_bits[1] = 16;
    section_info->section_id[2] = 2;
    section_info->section_start_bit[2] = 122;
