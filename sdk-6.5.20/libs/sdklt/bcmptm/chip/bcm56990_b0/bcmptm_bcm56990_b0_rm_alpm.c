...
static void
bcm56990_b0_l1_lpm_vt_decode(int u, int sub_prio, int vrf,
...
{
    if (format_type == FORMAT_ROUTE) {
        bcm56990_b0_ln_route_format_encode(u, format_value, kshift, arg, entry);
    } else {
        bcm56990_b0_ln_pivot_format_encode(u, format_value, kshift, arg, entry);
    }
    return SHR_E_NONE;
}
...
bcm56990_b0_l1_fmt0_narrow_lpm_decode_n1(int u, alpm_arg_t *arg, UNPAIR0_T *de)
{
    ...
    bcm56990_b0_l1_lpm_vt_decode(u, sub_prio, vrf, vrf_mask, arg);
