/*! \file bcmptm_bcm56996_a0_rm_tcam.c
 *
...
static const bcmdrd_sid_t bcm56996_a0_list[BCMPTM_RM_TCAM_SID_COUNT] = {
 ...
 */
static int
bcm56996_a0_rm_tcam_memreg_read(int unit,
                              bcmltd_sid_t ltid,
 ...
 */
int
bcm56996_a0_rm_tcam_memreg_oper(int unit,
                              bcmltd_sid_t ltid,
                              bcmptm_rm_tcam_sid_type_t sid_type,
                              ...
                              bcmptm_rm_tcam_sid_info_t *sid_info)
{
    ...
    if (sid_oper == BCMFP_RM_TCAM_SID_OPER_READ) {
        SHR_ERR_EXIT(bcm56996_a0_rm_tcam_memreg_read(unit,
                                                        ltid,
                                                        sid_type,
                                                        sid_info));
    }
...
int
bcm56996_a0_rm_tcam_prio_only_hw_key_info_init(int unit,
                            bcmltd_sid_t ltid,
