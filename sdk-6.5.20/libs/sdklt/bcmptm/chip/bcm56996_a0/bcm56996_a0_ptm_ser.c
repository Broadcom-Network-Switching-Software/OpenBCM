...
static bcmptm_ser_mem_clr_list_t bcm56996_a0_mem_clr_lst[] = {
 ...
 */
static bcmptm_ser_ctrl_reg_info_t bcm56996_a0_clear_mem_before_ser_enable_info[] = {
    /* Clear ING SER FIFO */
 ...
 */
static bcmptm_ser_ctrl_reg_info_t bcm56996_a0_clear_mem_after_ser_enable_info[] = {
 ...
 */
static bcmptm_ser_ctrl_reg_info_t bcm56996_a0_tcam_scan_ctrl_reg_lst_en[] = {
 ...
 */
static bcmptm_ser_ctrl_reg_info_t bcm56996_a0_tcam_scan_ctrl_reg_lst_dis[] = {
...
static bcmptm_ser_fld_info_t bcm56996_a0_ing_ser_ctrl_fld_lst[] = {
 ...
 */
static bcmptm_ser_ctrl_reg_info_t bcm56996_a0_ser_ctrl_info[] = {
    {CPU_CONTROL_0r, 0, &bcm56996_a0_ing_ser_ctrl_fld_lst[0], 1, 0},
};

/*!
 * Can't enable parity checking for some memory tables.
 */
static bcmdrd_sid_t  bcm56996_a0_mem_ser_mute[] = {
    INVALIDm
};

/* Field list of status registers for  BCMPTM_SER_INFO_TYPE_ECC, except ECC_ERR. */
static bcmdrd_fid_t bcm56996_a0_ecc_status_fields[] = {
    MULTIPLE_ERRf,
    ENTRY_IDXf,
    DOUBLE_BIT_ERRf,
    INVALIDf /* must */
...
static bcmptm_ser_ecc_status_fld_t bcm56996_a0_ecc_status_flds = {
    ECC_ERRf, bcm56996_a0_ecc_status_fields
};

/* Field list of registers which are used to enable SER function. */
static bcmdrd_fid_t bcm56996_a0_edb_ctrl_buffer_ecc_en_fields[] = {
    PM3_ECC_ENf,
    PM2_ECC_ENf,
    PM1_ECC_ENf,
    PM0_ECC_ENf,
...
static bcmdrd_fid_t bcm56996_a0_edb_data_buffer_en_fields[] = {
    PM3_ECC_ENf,
    PM2_ECC_ENf,
    PM1_ECC_ENf,
    PM0_ECC_ENf,
...
static bcmdrd_fid_t bcm56996_a0_edb_ctrl_data_buffer_1b_en_fields[] = {
    PM3_ENf,
    PM2_ENf,
    PM1_ENf,
    PM0_ENf,
...
static bcmdrd_fid_t bcm56996_a0_edb_data_buffer_1b_en_fields[] = {
    PM3_ENf,
    PM2_ENf,
    PM1_ENf,
    PM0_ENf,
...
static bcmptm_ser_buf_bus_ctrl_reg_t bcm56996_a0_idb_obm0_status_reg[] = {
...
static bcmptm_ser_buf_bus_ctrl_reg_t bcm56996_a0_idb_obm1_status_reg[] = {
...
static bcmptm_ser_buf_bus_ctrl_reg_t bcm56996_a0_idb_obm2_status_reg[] = {
...
static bcmptm_ser_buf_bus_ctrl_reg_t bcm56996_a0_idb_obm3_status_reg[] = {
...
static bcmdrd_fid_t bcm56996_a0_idb_pfc_mon_en_fields[] = {
    PFC_MON_EN_COR_ERR_RPTf,
    PFC_MON_ECC_ENABLEf,
    INVALIDf /* must */
};

static bcmdrd_fid_t bcm56996_a0_idb_ca_aux_en_fields[] = {
    CA_AUX_FIFO_EN_COR_ERR_RPTf,
    CA_AUX_FIFO_ECC_ENABLEf,
    INVALIDf /* must */
};

static bcmdrd_fid_t bcm56996_a0_idb_ca_fifo_en_fields[] = {
    CA_FIFO_EN_COR_ERR_RPTf,
    CA_FIFO_ECC_ENABLEf,
    INVALIDf /* must */
};

static bcmdrd_fid_t bcm56996_a0_idb_obm_en_fields[] = {
    MON_EN_COR_ERR_RPTf,
    MON_ECC_ENABLEf,
...
static bcmptm_ser_mac_status_fld_t bcm56996_a0_cdmac_ecc_tx_1bit_flds[] = {
    { TX_CDC_SINGLE_BIT_ERRf, INVALIDf, 1, BCMPTM_SER_CLR_INTR_READ },
    { INVALIDf, INVALIDf, -1 } /* must */
};

static bcmptm_ser_mac_status_fld_t bcm56996_a0_cdmac_ecc_tx_2bit_flds[] = {
    { TX_CDC_DOUBLE_BIT_ERRf, INVALIDf, 0, BCMPTM_SER_CLR_INTR_READ },
    { INVALIDf, INVALIDf, -1 } /* must */
};

static bcmptm_ser_mac_status_fld_t bcm56996_a0_cdmac_ecc_mib_1bit_flds[] = {
    { MIB_COUNTER_SINGLE_BIT_ERRf, INVALIDf, 1, BCMPTM_SER_CLR_INTR_READ },
    { INVALIDf, INVALIDf, -1 } /* must */
};

static bcmptm_ser_mac_status_fld_t bcm56996_a0_cdmac_ecc_mib_2bit_flds[] = {
    { MIB_COUNTER_DOUBLE_BIT_ERRf, INVALIDf, 0, BCMPTM_SER_CLR_INTR_READ },
    { INVALIDf, INVALIDf, -1 } /* must */
};

static bcmptm_ser_mac_status_fld_t bcm56996_a0_cdmac_ecc_mib_multi_flds[] = {
    { MIB_COUNTER_MULTIPLE_ERRf, INVALIDf, 2, BCMPTM_SER_CLR_INTR_READ },
    { INVALIDf, INVALIDf, -1 } /* must */
};

static bcmdrd_fid_t bcm56996_a0_cdmac_ecc_ctrl_flds[] = {
    TX_CDC_ECC_CTRL_ENf,
    MIB_COUNTER_ECC_CTRL_ENf,
    INVALIDf /* must */
};

static bcmptm_ser_buf_bus_ctrl_reg_t bcm56996_a0_pm_xlp_rx_status_reg[] = {
    { XLPORT_MIB_RSC0_ECC_STATUSr, "XLP MIB RSC0 ECC", -1, -1 },
    { XLPORT_MIB_RSC1_ECC_STATUSr, "XLP MIB RSC1 ECC", -1, -1 },
    { INVALIDr } /* must */
};

static bcmptm_ser_buf_bus_ctrl_reg_t bcm56996_a0_pm_xlp_tx_status_reg[] = {
    { XLPORT_MIB_TSC0_ECC_STATUSr, "XLP MIB TSC0 ECC", -1, -1 },
    { XLPORT_MIB_TSC1_ECC_STATUSr, "XLP MIB TSC1 ECC", -1, -1 },
    { INVALIDr } /* must */
};

static bcmptm_ser_mac_status_fld_t bcm56996_a0_xlmac_rx_cdc_1bit_err[] = {
    { RX_CDC_SINGLE_BIT_ERRf, CLEAR_RX_CDC_SINGLE_BIT_ERRf, 1, BCMPTM_SER_CLR_INTR_RAISE_EDGE },
    { INVALIDf, INVALIDf, -1 } /* must */
};

static bcmptm_ser_mac_status_fld_t bcm56996_a0_xlmac_rx_cdc_2bit_err[] = {
    { RX_CDC_DOUBLE_BIT_ERRf, CLEAR_RX_CDC_DOUBLE_BIT_ERRf, 0, BCMPTM_SER_CLR_INTR_RAISE_EDGE },
    { INVALIDf, INVALIDf, -1 } /* must */
};

static bcmptm_ser_mac_status_fld_t bcm56996_a0_xlmac_tx_cdc_1bit_err[] = {
    { TX_CDC_SINGLE_BIT_ERRf, CLEAR_TX_CDC_SINGLE_BIT_ERRf, 1, BCMPTM_SER_CLR_INTR_RAISE_EDGE },
    { INVALIDf, INVALIDf, -1 } /* must */
};

static bcmptm_ser_mac_status_fld_t bcm56996_a0_xlmac_tx_cdc_2bit_err[] = {
    { TX_CDC_DOUBLE_BIT_ERRf, CLEAR_TX_CDC_DOUBLE_BIT_ERRf, 0, BCMPTM_SER_CLR_INTR_RAISE_EDGE },
    { INVALIDf, INVALIDf, -1 } /* must */
};

static bcmdrd_fid_t bcm56996_a0_xlmac_ecc_ctrl_flds[] = {
    TX_CDC_ECC_CTRL_ENf,
    RX_CDC_ECC_CTRL_ENf,
    INVALIDf /* must */
};

static bcmdrd_fid_t bcm56996_a0_xlport_ecc_ctrl_flds[] = {
    MIB_TSC_MEM_ENf,
    MIB_RSC_MEM_ENf,
    INVALIDf /* must */
};

static bcmptm_ser_ctrl_en_t bcm56996_a0_ser_blocks_ctrl_regs[] = {
    { CDMAC_ECC_CTRLr, INVALIDf, bcm56996_a0_cdmac_ecc_ctrl_flds },

    { XLMAC_ECC_CTRLr, INVALIDf, bcm56996_a0_xlmac_ecc_ctrl_flds },

    { XLPORT_ECC_CONTROLr, INVALIDf, bcm56996_a0_xlport_ecc_ctrl_flds },

    { EDB_CONTROL_BUFFER_ECC_ENr, INVALIDf, bcm56996_a0_edb_ctrl_buffer_ecc_en_fields },

    { EDB_DATA_BUFFER_ECC_ENr, INVALIDf, bcm56996_a0_edb_data_buffer_en_fields },

    { EDB_CONTROL_BUFFER_EN_COR_ERR_RPTr, INVALIDf, bcm56996_a0_edb_ctrl_data_buffer_1b_en_fields },

    { EDB_DATA_BUFFER_EN_COR_ERR_RPTr, INVALIDf, bcm56996_a0_edb_data_buffer_1b_en_fields },

    { IDB_PFC_MON_SER_CONTROLr, INVALIDf, bcm56996_a0_idb_pfc_mon_en_fields },

    { IDB_CA_AUX_SER_CONTROLr, INVALIDf, bcm56996_a0_idb_ca_aux_en_fields },

    { IDB_CA3_SER_CONTROLr, INVALIDf, bcm56996_a0_idb_ca_fifo_en_fields },

    { IDB_OBM3_SER_CONTROLr, INVALIDf, bcm56996_a0_idb_obm_en_fields },

    { IDB_CA2_SER_CONTROLr, INVALIDf, bcm56996_a0_idb_ca_fifo_en_fields },

    { IDB_OBM2_SER_CONTROLr, INVALIDf, bcm56996_a0_idb_obm_en_fields },

    { IDB_CA1_SER_CONTROLr, INVALIDf, bcm56996_a0_idb_ca_fifo_en_fields },

    { IDB_OBM1_SER_CONTROLr, INVALIDf, bcm56996_a0_idb_obm_en_fields },

    { IDB_CA0_SER_CONTROLr, INVALIDf, bcm56996_a0_idb_ca_fifo_en_fields },

    { IDB_OBM0_SER_CONTROLr, INVALIDf, bcm56996_a0_idb_obm_en_fields }
};

/*
 * field list of memory ING_SER_FIFOm etc.
 */
bcmdrd_fid_t  bcm56996_a0_ser_ing_egr_fifo_fld[] = {
    VALIDf,
    ECC_PARITYf,
    MEM_TYPEf,
    ADDRESSf,
 ...
 */
static bcmdrd_fid_t bcm56996_a0_mem_fail_addr_flds[] = {
    ERR_MULTf,
    ERR_TYPEf,
    EADDRf
};

static bcmptm_serc_fifo_t bcm56996_a0_serc_mmu_info[] = {
    {
        MMU_GLBCFG_MEM_SER_FIFO_STSr, EMPTYf,
        MMU_GLBCFG_MEM_FAIL_ADDR_64m, bcm56996_a0_mem_fail_addr_flds,
        MMU_GLBCFG_MEM_FAIL_INT_CTRr, BLKTYPE_MMU_GLB, "MMU_GLB"
    },
    {
        MMU_ITMCFG_MEM_SER_FIFO_STSr, EMPTYf,
        MMU_ITMCFG_MEM_FAIL_ADDR_64m, bcm56996_a0_mem_fail_addr_flds,
        MMU_ITMCFG_MEM_FAIL_INT_CTRr, BLKTYPE_MMU_ITM, "MMU_ITM"
    },
    {
        MMU_EBCFG_MEM_SER_FIFO_STSr, EMPTYf,
        MMU_EBCFG_MEM_FAIL_ADDR_64m, bcm56996_a0_mem_fail_addr_flds,
        MMU_EBCFG_MEM_FAIL_INT_CTRr, BLKTYPE_MMU_EB, "MMU_EB"
    }
};

static bcmptm_ser_mac_status_fld_t bcm56996_a0_ing_dii_intr_stat_flds[] = {
    { EVENT_FIFO_SER_ERRf, EVENT_FIFO_SER_ERRf, 0, BCMPTM_SER_CLR_INTR_WRITE_ZERO },
    { INVALIDf, INVALIDf, -1 } /* must */
};

static bcmptm_ser_mac_status_fld_t bcm56996_a0_egr_dii_intr_stat_flds[] = {
    { EVENT_FIFO_SER_ERRf, EVENT_FIFO_SER_ERRf, 0, BCMPTM_SER_CLR_INTR_WRITE_ZERO },
    { INVALIDf, INVALIDf, -1 } /* must */
};

/* Write EGR_DII_INTR_STATUSr to 0 to clear interrupt */
static bcmptm_serc_non_fifo_t bcm56996_a0_serc_egr_dii_info[] = {
    {
        INVALIDr, INVALIDf,
        0, EGR_DII_INTR_STATUSr, NULL, EGR_DII_INTR_STATUSr,
        NULL, bcm56996_a0_egr_dii_intr_stat_flds, NULL,
...
static bcmptm_serc_non_fifo_t bcm56996_a0_serc_ing_dii_info[] = {
    {
        INVALIDr, INVALIDf,
        0, ING_DII_INTR_STATUSr, NULL, ING_DII_INTR_STATUSr,
        NULL, bcm56996_a0_ing_dii_intr_stat_flds, NULL,
...
static bcmptm_serc_non_fifo_t bcm56996_a0_serc_cdp_info[] = {
    {
        INVALIDr, INVALIDf,
        0, CDMAC_ECC_STATUSr, NULL, INVALIDr,
        NULL, bcm56996_a0_cdmac_ecc_tx_1bit_flds, NULL,
        BLKTYPE_CDPORT, "CDMAC SER error"
    },
    {
        INVALIDr, INVALIDf,
        0, CDMAC_ECC_STATUSr, NULL, INVALIDr,
        NULL, bcm56996_a0_cdmac_ecc_tx_2bit_flds, NULL,
        BLKTYPE_CDPORT, "CDMAC SER error"
    },
    {
        INVALIDr, INVALIDf,
        0, CDMAC_ECC_STATUSr, NULL, INVALIDr,
        NULL, bcm56996_a0_cdmac_ecc_mib_1bit_flds, NULL,
        BLKTYPE_CDPORT, "CDMAC SER error"
    },
    {
        INVALIDr, INVALIDf,
        0, CDMAC_ECC_STATUSr, NULL, INVALIDr,
        NULL, bcm56996_a0_cdmac_ecc_mib_2bit_flds, NULL,
        BLKTYPE_CDPORT, "CDMAC SER error"
    },
    {
        INVALIDr, INVALIDf,
        0, CDMAC_ECC_STATUSr, NULL, INVALIDr,
        NULL, bcm56996_a0_cdmac_ecc_mib_multi_flds, NULL,
        BLKTYPE_CDPORT, "CDMAC SER error"
    }
};

static bcmptm_serc_non_fifo_t bcm56996_a0_serc_xlp_info[] = {
    {
        INVALIDr, INVALIDf,
        0, XLMAC_RX_CDC_ECC_STATUSr, NULL, XLMAC_CLEAR_ECC_STATUSr,
        NULL, bcm56996_a0_xlmac_rx_cdc_1bit_err, NULL,
        BLKTYPE_XLPORT, "XLP MAC RX 1 bit error"
    },
    {
        INVALIDr, INVALIDf,
        0, XLMAC_RX_CDC_ECC_STATUSr, NULL, XLMAC_CLEAR_ECC_STATUSr,
        NULL, bcm56996_a0_xlmac_rx_cdc_2bit_err, NULL,
        BLKTYPE_XLPORT, "XLP MAC RX 2 bit error"
    },
    {
        INVALIDr, INVALIDf,
        0, XLMAC_TX_CDC_ECC_STATUSr, NULL, XLMAC_CLEAR_ECC_STATUSr,
        NULL, bcm56996_a0_xlmac_tx_cdc_1bit_err, NULL,
        BLKTYPE_XLPORT, "XLP MAC TX 1 bit error"
    },
    {
        INVALIDr, INVALIDf,
        0, XLMAC_TX_CDC_ECC_STATUSr, NULL, XLMAC_CLEAR_ECC_STATUSr,
        NULL, bcm56996_a0_xlmac_tx_cdc_2bit_err, NULL,
        BLKTYPE_XLPORT, "XLP MAC TX 2 bit error"
    },
    /* W1TC */
    {
        XLPORT_INTR_STATUSr, MIB_TX_MEM_ERRf,
        1, INVALIDr, bcm56996_a0_pm_xlp_tx_status_reg, INVALIDr,
        &bcm56996_a0_ecc_status_flds, NULL, NULL,
        BLKTYPE_XLPORT, "XLP MIB TX Statistic Counter memory"
    },
    /* W1TC */
    {
        XLPORT_INTR_STATUSr, MIB_RX_MEM_ERRf,
        1, INVALIDr, bcm56996_a0_pm_xlp_rx_status_reg, INVALIDr,
        &bcm56996_a0_ecc_status_flds, NULL, NULL,
        BLKTYPE_XLPORT, "XLP MIB RX Statistic Counter memory"
    }
};

static bcmptm_serc_fifo_t bcm56996_a0_serc_dlb_info[] = {
    {
        DLB_ECMP_INTR_STATUSr, SER_FIFO_NON_EMPTYf,
        DLB_ECMP_SER_FIFOm, bcm56996_a0_ser_ing_egr_fifo_fld,
        INVALIDr, BLKTYPE_IPIPE, "IPIPE"
    }
};

static bcmptm_serc_fifo_t bcm56996_a0_serc_ip_info[] = {
    {
        INVALIDr, INVALIDf,
        ING_DOI_SER_FIFOm, bcm56996_a0_ser_ing_egr_fifo_fld,
        INVALIDr, BLKTYPE_IPIPE, "IPIPE"
    },
    {
        FLEX_CTR_ING_INTR_STATUSr, SER_FIFO_NON_EMPTYf,
        FLEX_CTR_ING_SER_FIFOm, bcm56996_a0_ser_ing_egr_fifo_fld,
        INVALIDr, BLKTYPE_FLEX_CTR, "IPIPE"
    },
    {
        IP4_INTR_STATUSr, ISWf,
        ING_SER_FIFOm, bcm56996_a0_ser_ing_egr_fifo_fld,
        INVALIDr, BLKTYPE_IPIPE, "IPIPE"
    }
};

static bcmptm_serc_fifo_t bcm56996_a0_serc_ep_info[] = {
    {
        INVALIDr, INVALIDf,
        EGR_SER_FIFO_2m, bcm56996_a0_ser_ing_egr_fifo_fld,
        INVALIDr, BLKTYPE_EPIPE, "EPIPE"
    },
    {
        INVALIDr, INVALIDf,
        EGR_DOI_SER_FIFOm, bcm56996_a0_ser_ing_egr_fifo_fld,
        INVALIDr, BLKTYPE_EPIPE, "EPIPE"
    },
    {
        FLEX_CTR_EGR_INTR_STATUSr, SER_FIFO_NON_EMPTYf,
        FLEX_CTR_EGR_SER_FIFOm, bcm56996_a0_ser_ing_egr_fifo_fld,
        INVALIDr, BLKTYPE_FLEX_CTR, "EPIPE"
    }
};

static bcmptm_serc_non_fifo_t bcm56996_a0_serc_idb_info[] = {
    {
        INVALIDr, INVALIDf,
    ...
    {
        INVALIDr, INVALIDf,
        1, INVALIDr, bcm56996_a0_idb_obm3_status_reg, INVALIDr,
        &bcm56996_a0_ecc_status_flds, NULL, NULL,
    ...
    {
        INVALIDr, INVALIDf,
        1, INVALIDr, bcm56996_a0_idb_obm2_status_reg, INVALIDr,
        &bcm56996_a0_ecc_status_flds, NULL, NULL,
    ...
    {
        INVALIDr, INVALIDf,
        1, INVALIDr, bcm56996_a0_idb_obm1_status_reg, INVALIDr,
        &bcm56996_a0_ecc_status_flds, NULL, NULL,
    ...
    {
        INVALIDr, INVALIDf,
        1, INVALIDr, bcm56996_a0_idb_obm0_status_reg, INVALIDr,
        &bcm56996_a0_ecc_status_flds, NULL, NULL,
        BLKTYPE_PORT_IF, "IDB OBM0 packet data memory"
    }
};

static bcmptm_serc_fifo_t bcm56996_a0_serc_edb_info[] = {
    {
        EDB_INTR_STATUSr, SER_FIFO_NON_EMPTYf,
        EDB_SER_FIFOm, bcm56996_a0_ser_ing_egr_fifo_fld,
        INVALIDr, BLKTYPE_PORT_IF, "EPIPE EDB"
    }
};

static bcmptm_ser_intr_route_info_t bcm56996_a0_intr_map[] = {
    {
        ...
        (void *)bcm56996_a0_serc_mmu_info, COUNTOF(bcm56996_a0_serc_mmu_info), 1
    },
    {
        ...
        (void *)bcm56996_a0_serc_ing_dii_info, COUNTOF(bcm56996_a0_serc_ing_dii_info), 0
    },
    {
        BCMPTM_SER_IPEP_INTR_FLG,
        {
        ...
        (void *)bcm56996_a0_serc_egr_dii_info, COUNTOF(bcm56996_a0_serc_egr_dii_info), 0
    },
    {
        BCMPTM_SER_IPEP_INTR_FLG,
        ...
        (void *)bcm56996_a0_serc_dlb_info, COUNTOF(bcm56996_a0_serc_dlb_info), 1
    },
    {
        BCMPTM_SER_IPEP_INTR_FLG,
        ...
        (void *)bcm56996_a0_serc_ip_info, COUNTOF(bcm56996_a0_serc_ip_info), 1
    },
    {
        BCMPTM_SER_IPEP_INTR_FLG,
        ...
        (void *)bcm56996_a0_serc_ep_info, COUNTOF(bcm56996_a0_serc_ep_info), 1
    },
    {
        ...
        (void *)bcm56996_a0_serc_idb_info, COUNTOF(bcm56996_a0_serc_idb_info), 0
    },
    {
        BCMPTM_SER_EDB_IDB_INTR_FLG,
        ...
        (void *)bcm56996_a0_serc_edb_info, COUNTOF(bcm56996_a0_serc_edb_info), 1
    },
    /* Use to clear SER error */
    {
        ...
        (void *)bcm56996_a0_serc_cdp_info, COUNTOF(bcm56996_a0_serc_cdp_info), 0
    },
    {
        BCMPTM_SER_PORT_INTR_FLG,
        {
        ...
        (void *)bcm56996_a0_serc_xlp_info, COUNTOF(bcm56996_a0_serc_xlp_info), 0
    }
};
 ...
 */
static bcmptm_ser_buffer_bus_info_t bcm56996_a0_ser_hwmem_base_info[] = {
...
static bcmptm_ser_ctrl_reg_info_t bcm56996_a0_clear_refresh_registers[] = {
...
static bcmptm_ser_acctype_info_t bcm56996_a0_acctype_info[] = {
...
static bcmptm_ser_blk_map_t bcm56996_a0_blktype_info[] = {
...
static const bcmdrd_sid_t bcm56996_a0_idb_obm_mem_list[] = {
 ...
 */
static int
bcm56996_a0_ser_mem_clr_list_get(int unit,
                                 bcmptm_ser_mem_clr_list_t **mem_list,
                                 int *entry_num)
{
    *mem_list = bcm56996_a0_mem_clr_lst;
    *entry_num = COUNTOF(bcm56996_a0_mem_clr_lst);

    return SHR_E_NONE;
}

static int
bcm56996_a0_ser_clear_mem_before_ser_enable(int unit,
                                            bcmptm_ser_ctrl_reg_info_t **reg_ctrl_lst,
                                            int *reg_num)
{
    *reg_ctrl_lst = bcm56996_a0_clear_mem_before_ser_enable_info;
    *reg_num = COUNTOF(bcm56996_a0_clear_mem_before_ser_enable_info);
    return SHR_E_NONE;
}

static int
bcm56996_a0_ser_clear_mem_after_ser_enable(int unit,
                                           bcmptm_ser_ctrl_reg_info_t **reg_ctrl_lst,
                                           int *reg_num)
{
    *reg_ctrl_lst = bcm56996_a0_clear_mem_after_ser_enable_info;
    *reg_num = COUNTOF(bcm56996_a0_clear_mem_after_ser_enable_info);

    return SHR_E_NONE;
}

static int
bcm56996_a0_ser_tcam_hw_scan_ctrl_info_get(int unit, int enable,
                                           bcmptm_ser_ctrl_reg_info_t **reg_ctrl_lst,
                                           int *reg_num)
{
    if (enable) {
        *reg_ctrl_lst = bcm56996_a0_tcam_scan_ctrl_reg_lst_en;
        *reg_num = COUNTOF(bcm56996_a0_tcam_scan_ctrl_reg_lst_en);
    } else {
        *reg_ctrl_lst = bcm56996_a0_tcam_scan_ctrl_reg_lst_dis;
        *reg_num = COUNTOF(bcm56996_a0_tcam_scan_ctrl_reg_lst_dis);
    }
    return SHR_E_NONE;
}

static int
bcm56996_a0_ser_mem_mute_list_get(int unit,
                                  bcmdrd_sid_t **mem_ser_mute_list,
                                  int *mem_ser_mute_num)
{
    *mem_ser_mute_list = bcm56996_a0_mem_ser_mute;
    *mem_ser_mute_num = COUNTOF(bcm56996_a0_mem_ser_mute);

    return SHR_E_NONE;
}

static int
bcm56996_a0_ser_blk_ctrl_get(int unit,
                             bcmptm_ser_ctrl_en_t **ser_blks_ctrl_regs,
                             int *ctrl_item_num)
{
    *ser_blks_ctrl_regs = bcm56996_a0_ser_blocks_ctrl_regs;
    *ctrl_item_num = COUNTOF(bcm56996_a0_ser_blocks_ctrl_regs);

    return SHR_E_NONE;
}

static int
bcm56996_a0_ser_intr_map_get(int unit,
                             int *cdmac_inst,
                             bcmptm_ser_intr_route_info_t **intr_map,
                             int *intr_map_num)
{
    *intr_map = bcm56996_a0_intr_map;
    *intr_map_num = COUNTOF(bcm56996_a0_intr_map);
...
static int
bcm56996_a0_ser_blk_type_map(int unit,
                             int blk_type, int *blk_type_overlay,
                             int *ser_blk_type)
{
    int count = COUNTOF(bcm56996_a0_blktype_info);
    int i = 0, index = -1;

    for (i = 0; i < count; i++) {
        if (blk_type == bcm56996_a0_blktype_info[i].blk_type) {
            index = i;
            break;
        }
    }
    if (index >= 0) {
        if (ser_blk_type != NULL) {
            *ser_blk_type = bcm56996_a0_blktype_info[index].ser_blk_type;
        }
        if (blk_type_overlay != NULL) {
            for (i = 0; i < BCMPTM_SER_OVERLAY_BLK_TYPE_NUM; i++) {
                blk_type_overlay[i] =
                    bcm56996_a0_blktype_info[index].blk_type_overlay[i];
            }
        }
        return SHR_E_NONE;
    } else {
...
static void
bcm56996_a0_ser_lp_intr_enable(int unit, int sync, int cmicx_intr_num, int enable)
{
    if (enable) {
...
static int
bcm56996_a0_ser_lp_intr_func_set(int unit,
...
static int
bcm56996_a0_ser_cmicx_adext_get(int unit, bcmptm_cmic_adext_info_t adext_info,
                                uint32_t *adext)
{
...
static int
bcm56996_a0_ser_acc_type_get(int unit, bcmdrd_sid_t sid,
                             uint32_t *acc_type, const char **acctype_str)
{
    int rv = SHR_E_NONE;
    bcmdrd_sym_info_t sym_info, *sinfo = &sym_info;
    uint32_t blkacc = 0, acctype_tmp = 0;
    int i = 0, acctype_num = COUNTOF(bcm56996_a0_acctype_info);
    bcmptm_ser_acctype_info_t *acctype_info = bcm56996_a0_acctype_info;
...
static bool
bcm56996_a0_ser_pt_inst_remap(int unit, bcmdrd_sid_t sid,
...
static int
bcm56996_a0_ser_cmicx_schan_opcode_get(int unit, int cmd, int blk_num,
...
static int
bcm56996_a0_ser_hwmem_base_info_get(int unit, int membase, int stage_id,
                                    char **bd_bb_name, char **bb_name, bool *mem)
{
    int base_num = COUNTOF(bcm56996_a0_ser_hwmem_base_info), i = 0;
    bcmptm_ser_buffer_bus_info_t *hwmem_info = bcm56996_a0_ser_hwmem_base_info;
...
static int
bcm56996_a0_ser_hw_info_remap(int unit, uint32_t address, int blk_type,
...
static int
bcm56996_a0_ser_mmu_phy2log_mem_remap(int unit, bcmptm_ser_correct_info_t *spci)
{
...
static int
bcm56996_a0_ser_mmu_mem_remap(int unit, bcmptm_ser_correct_info_t *spci,
                              uint32_t adext, int blk_inst)
{
    return bcm56996_a0_ser_mmu_phy2log_mem_remap(unit, spci);
}


static int
bcm56996_a0_ser_ip_ep_sram_remap(int unit, bcmdrd_sid_t sid, bcmdrd_sid_t *remap_sid)
{
...
static int
bcm56996_a0_ser_data_split_mem_test_field_get(int unit, bcmdrd_sid_t sid,
...
static int
bcm56996_a0_ser_alpm_bank_num_get(int unit)
{
    int index_count = 0;
...
static int
bcm56996_a0_ser_em_info_get(int unit, bcmdrd_sid_t sid, uint32_t index,
...
static int
bcm56996_a0_ser_alpm_info_get(int unit, bcmdrd_sid_t sid, uint32_t index,
                              bcmptm_ser_sram_info_t *sram_info)
{
    int bank_num = 0;
    ...
    bank_num = bcm56996_a0_ser_alpm_bank_num_get(unit);
    if (bank_num == 0) {
...
static int
bcm56996_a0_ser_tcam_remap(int unit, bcmdrd_sid_t tcam_sid,
...
static int
bcm56996_a0_ser_mem_ecc_info_get(int unit, bcmdrd_sid_t sid_fv, int index_fv,
                                 bcmdrd_sid_t *sid, int *index, int *ecc_checking)
{
    ...
    (void)bcm56996_a0_ser_tcam_remap(unit, sid_fv, &sid_tcam_only,
...
static int
bcm56996_a0_ser_refresh_regs_info_get(int unit,
                                      bcmptm_ser_ctrl_reg_info_t **mem_refresh_info,
                                      uint32_t *info_num)
{
    *mem_refresh_info = bcm56996_a0_clear_refresh_registers;
    *info_num = COUNTOF(bcm56996_a0_clear_refresh_registers);

    return SHR_E_NONE;
}

static int
bcm56996_a0_ser_ecc_status_translate(int unit,
                                     ...
                                     uint32_t *sid_num)
{
    ...
    *sid_num = 0;
    ...
    if (found) {
        *corrected_sids = &bcm56996_a0_idb_obm_mem_list[idx];
        *index = spci->index[0];
        *sid_num = 1;
    }
    return SHR_E_NONE;
...
static int
bcm56996_a0_ser_mem_xor_info_get(int unit, bcmdrd_sid_t sid, uint32_t index,
                                 bcmptm_ser_sram_info_t *sram_info)
{
    int rv = SHR_E_UNAVAIL;

    if (EXACT_MATCH_ECCm == sid) {
        rv = bcm56996_a0_ser_em_info_get(unit, sid, index, sram_info);
    } else if (L3_DEFIP_ALPM_LEVEL3_ECCm == sid) {
        rv = bcm56996_a0_ser_alpm_info_get(unit, sid, index, sram_info);
    } else {
        rv = SHR_E_UNAVAIL;
    }
    return rv;
...
static int
bcm56996_a0_ser_sram_ctrl_register_get(int unit, bcmdrd_sid_t sid, uint32_t index,
                                       bcmptm_ser_control_reg_info_t *sram_ctrl_reg_info)
{
   /*
    ...
    (void)bcm56996_a0_ser_mem_ecc_info_get(unit, sid, index, &sid_ecc, &index_ecc, NULL);
...
static int
bcm56996_a0_ser_sram_scan_mem_skip(int unit, bcmdrd_sid_t sid, bool *skip)
{
    ...
    (void)bcm56996_a0_ser_mem_ecc_info_get(unit, sid, 0, &sid_ecc,
                                           &index_ecc, NULL);
    if (sid != sid_ecc) {
        *skip = TRUE;
    } else {
...
static int
bcm56996_a0_ser_copy_to_cpu_regs_info_get(int unit,
                                         bcmptm_ser_ctrl_reg_info_t **reg_ctrl_lst,
                                         int *reg_num)
{
    *reg_ctrl_lst = bcm56996_a0_ser_ctrl_info;
    *reg_num = COUNTOF(bcm56996_a0_ser_ctrl_info);
    return SHR_E_NONE;
}

static int
bcm56996_a0_ser_expected_value_get(int unit, bcmdrd_sid_t sid,
...
static int
bcm56996_a0_num_bit_interleave_get(int unit, bcmdrd_sid_t sid,
...
static int
bcm56996_a0_ser_status_field_parse(int unit, bcmdrd_sid_t sid,
...
static int
bcm56996_a0_ser_force_error_value_get(int unit, bcmdrd_sid_t sid,
                                      bcmdrd_fid_t fid, uint32_t *value)
{
    *value = 1;
...
bcmdrd_sid_t bcm56996_a0_tcam_ctrl_lst[] = {
...
static int
bcm56996_a0_ser_tcam_ctrl_reg_list_get(int unit, bcmdrd_sid_t **mem_list,
                                       int *entry_num, bcmdrd_fid_t *fid)
{
    *mem_list = bcm56996_a0_tcam_ctrl_lst;
    *entry_num = COUNTOF(bcm56996_a0_tcam_ctrl_lst);
    *fid = AUTO_CORRECT_1BIT_ECC_ENf;

    return SHR_E_NONE;
}

static const bcmptm_ser_data_driver_t bcm56996_a0_data_driver = {

    .mem_clr_list_get = bcm56996_a0_ser_mem_clr_list_get,

    .clear_mem_after_ser_enable = bcm56996_a0_ser_clear_mem_after_ser_enable,

    .clear_mem_before_ser_enable = bcm56996_a0_ser_clear_mem_before_ser_enable,

    .tcam_ser_hw_scan_reg_info_get = bcm56996_a0_ser_tcam_hw_scan_ctrl_info_get,

    .acc_type_map_info_get = NULL,

    .tcam_cmic_ser_info_get = NULL,

    .mute_mem_list_get = bcm56996_a0_ser_mem_mute_list_get,

    .blk_ctrl_regs_get = bcm56996_a0_ser_blk_ctrl_get,

    .intr_map_get = bcm56996_a0_ser_intr_map_get,

    .blk_type_map = bcm56996_a0_ser_blk_type_map,

    .ser_intr_enable = bcm56996_a0_ser_lp_intr_enable,

    .intr_cb_func_set = bcm56996_a0_ser_lp_intr_func_set,
    ...
    .cmic_adext_get = bcm56996_a0_ser_cmicx_adext_get,

    .pt_acctype_get = bcm56996_a0_ser_acc_type_get,

    .pt_inst_remap = bcm56996_a0_ser_pt_inst_remap,

    .cmic_schan_opcode_get = bcm56996_a0_ser_cmicx_schan_opcode_get,

    .hwmem_base_info_get = bcm56996_a0_ser_hwmem_base_info_get,

    .ip_ep_hw_info_remap = bcm56996_a0_ser_hw_info_remap,

    .mmu_mem_remap = bcm56996_a0_ser_mmu_mem_remap,

    .ip_ep_mem_remap = bcm56996_a0_ser_ip_ep_sram_remap,

    .data_split_mem_test_fid_get = bcm56996_a0_ser_data_split_mem_test_field_get,

    .mem_ecc_info_get = bcm56996_a0_ser_mem_ecc_info_get,

    .tcam_remap = bcm56996_a0_ser_tcam_remap,

    .refresh_regs_info_get = bcm56996_a0_ser_refresh_regs_info_get,

    .ser_status_reg_translate = bcm56996_a0_ser_ecc_status_translate,

    .sram_ctrl_reg_get = bcm56996_a0_ser_sram_ctrl_register_get,

    .xor_lp_mem_info_get = bcm56996_a0_ser_mem_xor_info_get,

    .sram_scan_mem_skip = bcm56996_a0_ser_sram_scan_mem_skip,

    .copy_to_cpu_regs_info_get = bcm56996_a0_ser_copy_to_cpu_regs_info_get,

    .expected_value_get = bcm56996_a0_ser_expected_value_get,

    .num_bit_interleave_get = bcm56996_a0_num_bit_interleave_get,

    .ser_status_field_parse = bcm56996_a0_ser_status_field_parse,

    .force_error_value_get = bcm56996_a0_ser_force_error_value_get,

    .tcam_ctrl_reg_list_get = bcm56996_a0_ser_tcam_ctrl_reg_list_get
};
...
{
    return &bcm56996_a0_data_driver;
}
