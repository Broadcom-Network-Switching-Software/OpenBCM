...
#include "bcm56996_a0_ptm_uft_be.h"
 ...
 */
static int
bcm56996_a0_uft_be_device_info_init(int unit,
...
int
bcm56996_a0_uft_be_driver_register(int unit, uft_be_driver_t *drv)
{
    SHR_FUNC_ENTER(unit);

    if (drv) {
        drv->device_info_init  =  bcm56996_a0_uft_be_device_info_init;
    } else {
