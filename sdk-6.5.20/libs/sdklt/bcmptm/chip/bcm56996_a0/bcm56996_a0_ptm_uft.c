...
#define UFT_56996_EM_GRP_MAX       9
#define UFT_56996_PHY_BANKS_MAX    27
...
static uft_grp_info_t grps_info[UFT_56996_EM_GRP_MAX] = {
           {0},
           /* L2_HASH_GROUP */
...
static uft_bank_info_t banks_info[UFT_56996_PHY_BANKS_MAX] = {
           {0},
           {.bank_id = L2_BANK0,
            .grp_cnt = 1,
...
static bcmptm_uft_bank_map_t grps_a_bmp_arr[UFT_56996_EM_GRP_MAX];
                      ...
                      uft_regs_info_t *regs)
{
    ...
    for (idx = 0; idx < bank_cnt; idx++) {
        regs->reg_map[0].f_ids[f_cnt]  = l2_uft_fids[idx];
        regs->reg_map[0].f_data[f_cnt] = grp->bank[idx] - UFT_BANK0;
        f_cnt++;
    }
    regs->reg_map[0].f_cnt = f_cnt;
 ...
 */
static int
bcm56996_a0_regs_init(int unit,
                      uft_dev_info_t *dev,
                      uft_regs_info_t *regs)
{
    int cnt = 0;
 ...
 */
static int
bcm56996_a0_device_info_init(int unit,
                             ...
                             uft_dev_info_t *dev)
{
    ...
    if (dev) {
        dev->max_grps = UFT_56996_EM_GRP_MAX;
        dev->max_banks = UFT_56996_PHY_BANKS_MAX;
...
static int
bcm56996_a0_uft_tbl_em_ctrl_validate(int unit,
...
static int
bcm56996_a0_uft_dev_em_grp_validate(int unit,
                                    uft_dev_em_grp_t *grp,
                                    uft_dev_info_t *dev)
{
    int idx, b_cnt = 0;
...
static int
bcm56996_a0_uft_dev_em_grp_set(int unit,
                               uft_dev_em_grp_t *grp,
                               uft_dev_info_t *dev,
                               uft_regs_info_t *regs)
{
...
static int
bcm56996_a0_uft_dev_em_bank_validate(int unit, uft_dev_em_bank_t *bank)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56996_a0_uft_dev_em_bank_set(int unit,
...
int
bcm56996_a0_uft_driver_register(int unit, uft_driver_t *drv)
{
    SHR_FUNC_ENTER(unit);

    if (drv) {
        drv->regs_init            = bcm56996_a0_regs_init;
        drv->device_info_init     = bcm56996_a0_device_info_init;
        drv->tbl_em_ctrl_validate = bcm56996_a0_uft_tbl_em_ctrl_validate;
        drv->dev_em_grp_validate  = bcm56996_a0_uft_dev_em_grp_validate;
        drv->dev_em_grp_set       = bcm56996_a0_uft_dev_em_grp_set;
        drv->dev_em_bank_validate = bcm56996_a0_uft_dev_em_bank_validate;
        drv->dev_em_bank_set      = bcm56996_a0_uft_dev_em_bank_set;
    } else {
        SHR_ERR_EXIT(SHR_E_INIT);
    }
