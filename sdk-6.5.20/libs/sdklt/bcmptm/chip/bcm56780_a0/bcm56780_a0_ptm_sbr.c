...
static int
bcm56780_a0_sbr_default_profiles_init(int unit,
                                      const bcmptm_sbr_var_drv_t *vi,
                                      sbr_dev_info_t *dev)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56780_a0_sbr_device_info_init(int unit,
                                 const bcmptm_sbr_var_drv_t *vi,
                                 sbr_dev_info_t *dev)
{
    ...
    dev->invalid_ptid = BCM56780_A0_ENUM_COUNT;
...
static int
bcm56780_a0_sbr_device_deinit(int unit)
{
    SHR_FUNC_ENTER(unit);
    SHR_FREE(spt_state[unit]);
    SHR_FREE(spt_estate[unit]);
...
bcm56780_a0_sbr_driver_register(int unit, sbr_driver_t *drv)
{
    SHR_FUNC_ENTER(unit);
    if (drv) {
        drv->device_info_init = bcm56780_a0_sbr_device_info_init;
        drv->device_deinit = bcm56780_a0_sbr_device_deinit;
        drv->default_profiles_init = bcm56780_a0_sbr_default_profiles_init;
    } else {
