...
my_init(int unit, bool warm)
{
    ...
    tmp_rv = bcmptm_cth_uft_be_init(unit, warm);
    if (SHR_FAILURE(tmp_rv)) {
        LOG_ERROR(BSL_LOG_MODULE,
            (BSL_META_U(unit, "bcmptm_cth_uft_be_init FAILED(rv = %0d)\n"),
             tmp_rv));
 ...
 */
static shr_sysm_rv_t
cth_uft_be_sysm_init(shr_sysm_categories_t instance_category,
                     int unit,
                     void *comp_data,
                     bool warm,
                     uint32_t *blocking_component)
 ...
 */
static shr_sysm_rv_t
cth_uft_be_sysm_comp_config(shr_sysm_categories_t instance_category,
                            int unit,
                            void *comp_data,
                            bool warm,
                            uint32_t *blocking_component)
 ...
 */
static shr_sysm_rv_t
cth_uft_be_sysm_pre_config(shr_sysm_categories_t instance_category,
                           int unit,
                           void *comp_data,
                           bool warm,
                           uint32_t *blocking_component)
 ...
 */
static void
cth_uft_be_sysm_run(shr_sysm_categories_t instance_category,
                    int unit,
                    void *comp_data)
{
    return;
 ...
 */
static shr_sysm_rv_t
cth_uft_be_sysm_stop(shr_sysm_categories_t instance_category,
                     int unit,
                     void *comp_data,
                     bool graceful,
                     uint32_t *blocking_component)
...
/* Phase: shutdown */
static shr_sysm_rv_t
cth_uft_be_sysm_shutdown(shr_sysm_categories_t instance_category,
                         int unit,
                         void *comp_data,
                         bool graceful,
                         uint32_t *blocking_component)
{
    ...
    if (SHR_FAILURE(bcmptm_cth_uft_be_cleanup(unit, graceful))) {
        return SHR_SYSM_RV_ERROR;
    }
...
bcmptm_cth_uft_be_start(void)
{
    ...
    funcs.init = cth_uft_be_sysm_init;
    funcs.comp_config = cth_uft_be_sysm_comp_config;
    funcs.pre_config = cth_uft_be_sysm_pre_config;
    funcs.run = cth_uft_be_sysm_run;
    funcs.stop = cth_uft_be_sysm_stop;
    funcs.shutdown = cth_uft_be_sysm_shutdown;
    SHR_IF_ERR_EXIT(
        shr_sysm_register(BCMMGMT_UFT_BE_COMP_ID,
                          SHR_SYSM_CAT_UNIT,
                          &funcs,
                          NULL));
exit:
