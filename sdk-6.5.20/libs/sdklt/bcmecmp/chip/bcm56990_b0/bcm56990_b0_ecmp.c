 ...
 */
typedef enum bcm56990_b0_weighted_size_e {
    BCM56990_WEIGHTED_SIZE_0_511 = 2,
    BCM56990_WEIGHTED_SIZE_1K = 5,
    BCM56990_WEIGHTED_SIZE_2K = 6,
    BCM56990_WEIGHTED_SIZE_4K = 7,
    BCM56990_WEIGHTED_SIZE_COUNT
} bcm56990_b0_weighted_size_t;

/*!
 * \brief overlay weighted ECMP group size.
 */
typedef enum bcm56990_b0_ovlay_weighted_size_e {
    BCM56990_OVLAY_WEIGHTED_SIZE_0_127 = 3,
    BCM56990_OVLAY_WEIGHTED_SIZE_COUNT
} bcm56990_b0_ovlay_weighted_size_t;
...
typedef struct bcm56990_b0_ecmp_memb_drd_fields_s {
...
} bcm56990_b0_ecmp_memb_drd_fields_t;

typedef struct bcm56990_b0_ecmp_grp_drd_fields_s {
...
} bcm56990_b0_ecmp_grp_drd_fields_t;
 ...
 */
static void
bcm56990_b0_ecmp_grp_drd_fields_t_init(bcm56990_b0_ecmp_grp_drd_fields_t *gdrd)
{
    if (gdrd) {
...
static void
bcm56990_b0_ecmp_memb_drd_fields_t_init(bcm56990_b0_ecmp_memb_drd_fields_t *mdrd)
{
    if (mdrd) {
...
static void
bcm56990_b0_ecmp_grp_ltd_fields_t_init(bcmecmp_grp_ltd_fields_t *gltd)
{
    if (gltd) {
...
static void
bcm56990_b0_ecmp_lt_field_attrs_t_init(bcmecmp_lt_field_attrs_t *fattrs)
{
    if (fattrs) {
...
static void
bcm56990_b0_ecmp_pt_op_info_t_init(bcmecmp_pt_op_info_t *pt_op_info)
{
...
static int
bcm56990_b0_ecmp_lt_entry_memb_write(int unit, bcmecmp_lt_entry_t *lt_ent,
                                     ...
                                     uint32_t *buf)
{
    ...
    bcm56990_b0_ecmp_pt_op_info_t_init(&op_info);
...
static int
bcm56990_b0_ecmp_lt_entry_memb_read(int unit, bcmecmp_lt_entry_t *lt_ent,
                                    int ent_idx, int ent_num, bool dma_en,
                                    uint32_t *buf)
{
    bcmecmp_pt_op_info_t op_info;
...
static int
bcm56990_b0_ecmp_lt_entry_grp_write(int unit, bcmecmp_lt_entry_t *lt_ent,
                                    uint32_t *buf)
{
    bcmecmp_pt_op_info_t op_info;
...
static int
bcm56990_b0_ecmp_lt_entry_grp_read(int unit, bcmecmp_lt_entry_t *lt_ent,
                                   uint32_t *buf)
{
    bcmecmp_pt_op_info_t op_info;
...
static int
bcm56990_b0_ecmp_dfrag_memb_write(int unit, bcmecmp_grp_defrag_t *dfrag,
                                  int ent_idx, int ent_num, bool dma_en,
                                  uint32_t *buf)
{
    bcmecmp_pt_op_info_t op_info;
...
static int
bcm56990_b0_ecmp_dfrag_memb_read(int unit, bcmecmp_grp_defrag_t *dfrag,
                                 int ent_idx, int ent_num, bool dma_en,
                                 uint32_t *buf)
{
    bcmecmp_pt_op_info_t op_info;
...
static int
bcm56990_b0_ecmp_dfrag_grp_write(int unit, bcmecmp_grp_defrag_t *dfrag,
                                 uint32_t *buf)
{
    bcmecmp_pt_op_info_t op_info;
...
static int
bcm56990_b0_ecmp_dfrag_grp_read(int unit, bcmecmp_grp_defrag_t *dfrag,
                                uint32_t *buf)
{
    bcmecmp_pt_op_info_t op_info;
...
static int
bcm56990_b0_ecmp_info_print(int unit)
{
...
static int
bcm56990_b0_ecmp_sids_init(int unit)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56990_b0_ecmp_sids_clear(int unit)
{
    SHR_FUNC_ENTER(unit);
    ...
    switch (BCMECMP_MODE(unit)) {
        case BCMECMP_MODE_HIER:
            ...
            /* Not support Pre-IFP ECMP tables. */
            BCMECMP_TBL_DRD_SID
...
static int
bcm56990_b0_ecmp_memb_bank_decode(int unit,
...
static int
bcm56990_b0_ecmp_ovlay_bank_read(int unit, uint8_t *num_o_memb_bank)
{
    ...
    bcm56990_b0_ecmp_memb_bank_decode(unit, &l3_bank);
...
static void
bcm56990_b0_ecmp_hw_memb_tbls_range_init(int unit, uint8_t num_o_memb_bank)
{
...
static int
bcm56990_b0_ecmp_hw_tbls_range_init(int unit, bool warm)
{
    ...
    /* Not support ECMP config register. */
    ...
    if (warm) {
        SHR_IF_ERR_EXIT
            (bcm56990_b0_ecmp_ovlay_bank_read(unit, &num_o_memb_bank));
    }
    bcm56990_b0_ecmp_hw_memb_tbls_range_init(unit, num_o_memb_bank);
...
static int
bcm56990_b0_ecmp_hw_tbls_range_clear(int unit)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56990_b0_ecmp_overlay_lt_flds_init(int unit,
                                      const bcmlrd_map_t *map)
{
    bcm56990_b0_ecmp_grp_drd_fields_t *gdrd_fields = NULL;  /* Group tbl DRD info. */
    bcm56990_b0_ecmp_memb_drd_fields_t *mdrd_fields = NULL; /* Member tbl DRD info. */
    ...
    bcm56990_b0_ecmp_memb_drd_fields_t_init(mdrd_fields);
    ...
    bcm56990_b0_ecmp_grp_drd_fields_t_init(gdrd_fields);
    ...
    bcm56990_b0_ecmp_lt_field_attrs_t_init(grp_attrs);
     ...
     */
    bcm56990_b0_ecmp_grp_ltd_fields_t_init(lt_fids);
...
static int
bcm56990_b0_ecmp_underlay_lt_flds_init(int unit,
                                      const bcmlrd_map_t *map)
{
    bcm56990_b0_ecmp_grp_drd_fields_t *gdrd_fields = NULL;  /* Group tbl DRD info. */
    bcm56990_b0_ecmp_memb_drd_fields_t *mdrd_fields = NULL; /* Member tbl DRD info. */
...
static int
bcm56990_b0_ecmp_grps_flds_cleanup(int unit, bcmecmp_grp_type_t grp_type)
{
    bcm56990_b0_ecmp_grp_drd_fields_t *gdrd_fields = NULL;  /* Group tbl DRD info. */
    bcm56990_b0_ecmp_memb_drd_fields_t *mdrd_fields = NULL; /* Member tbl DRD info. */
...
static int
bcm56990_b0_ecmp_ovlay_weighted_lt_flds_init(int unit,
                                             const bcmlrd_map_t *map)
{
    bcm56990_b0_ecmp_grp_drd_fields_t *gdrd_fields = NULL;  /* Group tbl DRD info. */
    bcm56990_b0_ecmp_memb_drd_fields_t *mdrd_fields = NULL; /* Member tbl DRD info. */
    ...
    grp_attrs->min_weighted_size = BCM56990_OVLAY_WEIGHTED_SIZE_0_127;
    grp_attrs->max_weighted_size = BCM56990_OVLAY_WEIGHTED_SIZE_0_127;
    grp_attrs->def_weighted_size = BCM56990_OVLAY_WEIGHTED_SIZE_0_127;
...
static int
bcm56990_b0_ecmp_unlay_weighted_lt_flds_init(int unit,
                                             const bcmlrd_map_t *map)
{
    bcm56990_b0_ecmp_grp_drd_fields_t *gdrd_fields = NULL;  /* Group tbl DRD info. */
    bcm56990_b0_ecmp_memb_drd_fields_t *mdrd_fields = NULL; /* Member tbl DRD info. */
...
static int
bcm56990_b0_ecmp_fields_init(int unit)
{
    ...
    SHR_NULL_CHECK(map, SHR_E_INTERNAL);
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56990_b0_ecmp_overlay_lt_flds_init(unit, map));
    ...
    SHR_NULL_CHECK(map, SHR_E_INTERNAL);
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56990_b0_ecmp_ovlay_weighted_lt_flds_init(unit, map));
    ...
    SHR_NULL_CHECK(map, SHR_E_INTERNAL);
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56990_b0_ecmp_underlay_lt_flds_init(unit, map));
    ...
    SHR_NULL_CHECK(map, SHR_E_INTERNAL);
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56990_b0_ecmp_unlay_weighted_lt_flds_init(unit, map));

exit:
    LOG_VERBOSE(BSL_LOG_MODULE,
                (BSL_META_U(unit,
                            "rv=%d"),
                bcm56990_b0_ecmp_info_print(unit)));

    SHR_FUNC_EXIT();
}

static int
bcm56990_b0_ecmp_fields_cleanup(int unit)
{
    ...
    switch (BCMECMP_MODE(unit)) {
        case BCMECMP_MODE_HIER:
            ...
            bcm56990_b0_ecmp_grps_flds_cleanup(unit, BCMECMP_GRP_TYPE_OVERLAY);

            /* Cleanup Overlay weighted ECMP resolution LT fields information. */
            bcm56990_b0_ecmp_grps_flds_cleanup
                                     (unit, BCMECMP_GRP_TYPE_OVERLAY_WEIGHTED);

            /* Cleanup Underlay ECMP resolution LT fields information. */
            bcm56990_b0_ecmp_grps_flds_cleanup(unit, BCMECMP_GRP_TYPE_UNDERLAY);
...
static int
bcm56990_b0_ecmp_itbm_grp_lists_init(int unit)
{
...
static int
bcm56990_b0_ecmp_itbm_memb_lists_init(int unit)
{
    shr_itbm_list_params_t params;
    shr_itbm_list_hdl_t list_hdl = NULL;
    int rv = SHR_E_NONE;
...
static int
bcm56990_b0_ecmp_itbm_lists_init(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_EXIT
        (bcm56990_b0_ecmp_itbm_grp_lists_init(unit));
    SHR_IF_ERR_EXIT
        (bcm56990_b0_ecmp_itbm_memb_lists_init(unit));
...
static int
bcm56990_b0_ecmp_itbm_grp_lists_cleanup(int unit)
{
...
static int
bcm56990_b0_ecmp_itbm_memb_lists_cleanup(int unit)
{
    shr_itbm_list_hdl_t list_hdl;
    int rv = SHR_E_NONE;
    bcmecmp_tbl_prop_t *tbl_prop = NULL;
...
static int
bcm56990_b0_ecmp_itbm_lists_cleanup(int unit)
{
    SHR_FUNC_ENTER(unit);
    SHR_IF_ERR_EXIT
        (bcm56990_b0_ecmp_itbm_grp_lists_cleanup(unit));
    SHR_IF_ERR_EXIT
        (bcm56990_b0_ecmp_itbm_memb_lists_cleanup(unit));
...
static int
bcm56990_b0_ecmp_itbm_olay_memb_lists_increase(int unit, uint8_t num_o_memb_bank,
...
exit:
    if (SHR_FUNC_ERR()) {
        bcm56990_b0_ecmp_hw_memb_tbls_range_init(unit, old_num_o_memb_bank);
...
static int
bcm56990_b0_ecmp_itbm_olay_memb_lists_reduce(int unit, uint8_t num_o_memb_bank,
                                             uint8_t old_num_o_memb_bank)
{
    bcmecmp_info_t *ecmp_info = &(ecmp_ctrl_local[unit]->ecmp_info);
    shr_itbm_list_hdl_t list_hdl;
...
static int
bcm56990_b0_ecmp_itbm_memb_lists_resize(int unit, uint8_t num_o_memb_bank)
{
    ...
    if (num_o_memb_bank > old_num_o_memb_bank) {
        SHR_IF_ERR_EXIT
            (bcm56990_b0_ecmp_itbm_olay_memb_lists_increase(unit,
                                                            num_o_memb_bank,
                                                          old_num_o_memb_bank));
    } else {
        SHR_IF_ERR_EXIT
            (bcm56990_b0_ecmp_itbm_olay_memb_lists_reduce(unit,
                                                          num_o_memb_bank,
                                                          old_num_o_memb_bank));
    }
...
static int
bcm56990_b0_itbm_group_cleanup(int unit)
{
...
static int
bcm56990_b0_ecmp_db_init(int unit, bool warm)
{
...
static int
bcm56990_b0_ecmp_db_clear(int unit)
{
    bcmecmp_tbl_prop_t *tbl_ptr; /* Pointer to ECMP hardware table info. */
...
static int
bcm56990_b0_ecmp_abort_db_init(int unit, bool warm)
{
    bcmecmp_tbl_prop_t *tbl_ptr; /* Pointer to ECMP hardware table info. */
    size_t tbl_size; /* ECMP group or member table size. */
    uint32_t ha_alloc_sz = 0; /* Size of allocated HA memory block. */
...
static int
bcm56990_b0_ecmp_abort_db_clear(int unit)
{
    bcmecmp_tbl_prop_t *tbl_ptr; /* Pointer to ECMP hardware table info. */
...
static int
bcm56990_b0_ecmp_entries_init(int unit, bool warm)
{
    size_t tbl_size;
    bcmecmp_info_t *ecmp_info = NULL;
...
static int
bcm56990_b0_ecmp_entries_cleanup(int unit)
{
    bcmecmp_info_t *ecmp_info = NULL;
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56990_b0_itbm_group_cleanup(unit));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56990_b0_ecmp_db_clear(unit));

    /* Clear atomic transaction related SW database info. */
    if (BCMECMP_ATOMIC_TRANS(unit)) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56990_b0_ecmp_abort_db_clear(unit));
    }
...
static int bcm56990_b0_ecmp_lt_entry_alloc(int unit)
{
    SHR_FUNC_ENTER(unit);
...
static void bcm56990_b0_ecmp_lt_entry_free(int unit)
{
...
static int
bcm56990_b0_ecmp_info_init(int unit, bool warm)
{
    SHR_FUNC_ENTER(unit);
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56990_b0_ecmp_tables_init(unit, warm));
     ...
     */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56990_b0_ecmp_entries_init(unit, warm));

    /* Allocate LT entry. */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56990_b0_ecmp_lt_entry_alloc(unit));
...
static int
bcm56990_b0_ecmp_mode_config(int unit)
{
    return SHR_E_NONE;
}

static int
bcm56990_b0_ecmp_memb_ent_range_get(int start_idx, int num_nhop, int nh_per_entry,
...
static int
bcm56990_b0_ecmp_memb_table_pio_write(int unit, bcmecmp_lt_entry_t *lt_ent,
                                      bool rh_mode)
{
    bcm56990_b0_ecmp_memb_drd_fields_t *memb_flds;
    ...
    memb_flds = (bcm56990_b0_ecmp_memb_drd_fields_t *)BCMECMP_TBL_DRD_FIELDS
                                                          (unit, member, gtype);
    ...
    SHR_IF_ERR_EXIT
        (bcm56990_b0_ecmp_memb_ent_range_get(start_idx, max_paths,
    ...
    while (max_paths > 0) {
        ...
        if (ent_offset != 0 || max_paths < NHOPS_PER_MEMB_ENTRY) {
            SHR_IF_ERR_EXIT
                (bcm56990_b0_ecmp_lt_entry_memb_read(unit, lt_ent, ent_idx, 1,
                                                     false, pt_entry_buff));
        }
        ...
        SHR_IF_ERR_EXIT
            (bcm56990_b0_ecmp_lt_entry_memb_write(unit, lt_ent, ent_idx, 1,
                                                  false, pt_entry_buff));
...
static int
bcm56990_b0_ecmp_memb_table_dma_write(int unit, bcmecmp_lt_entry_t *lt_ent,
                                      bool rh_mode, int nh_per_ent, bool ovlay)
{
    ...
    SHR_IF_ERR_EXIT
        (bcm56990_b0_ecmp_memb_ent_range_get(start_idx, max_paths, nh_per_ent,
    ...
    while (max_paths > 0) {
        ...
        if (ent_offset != 0 || max_paths < nh_per_ent) {
            SHR_IF_ERR_EXIT
                (bcm56990_b0_ecmp_lt_entry_memb_read(unit, lt_ent, ent_idx, 1, false,
    ...
    SHR_IF_ERR_EXIT
        (bcm56990_b0_ecmp_lt_entry_memb_write(unit, lt_ent, start_idx, ent_num,
                                              true, dma_buf));
...
static int
bcm56990_b0_ecmp_memb_table_pio_clear(int unit, bcmecmp_lt_entry_t *lt_ent,
                                      bool rh_mode)
{
    bcm56990_b0_ecmp_memb_drd_fields_t *memb_flds;
    bcmecmp_grp_type_t gtype;
...
static int
bcm56990_b0_ecmp_memb_table_dma_clear(int unit, bcmecmp_lt_entry_t *lt_ent,
                                      bool rh_mode, int nh_per_ent, bool ovlay)
{
    bcm56990_b0_ecmp_memb_drd_fields_t *memb_flds;
    bcmecmp_grp_type_t gtype;
    ...
    while (max_paths > 0) {
        ...
        if (ent_offset != 0 || max_paths < nh_per_ent) {
            SHR_IF_ERR_EXIT
                (bcm56990_b0_ecmp_lt_entry_memb_read
...
static int
bcm56990_b0_ecmp_memb_table_pio_read(int unit, bcmecmp_lt_entry_t *lt_ent,
                                     bool rh_mode)
{
    bcm56990_b0_ecmp_memb_drd_fields_t *memb_flds;
    bcmecmp_grp_type_t gtype;
...
static int
bcm56990_b0_ecmp_memb_table_dma_read(int unit, bcmecmp_lt_entry_t *lt_ent,
                                     bool rh_mode, int nh_per_ent, bool ovlay)
{
    bcm56990_b0_ecmp_memb_drd_fields_t *memb_flds;
    bcmecmp_grp_type_t gtype;
    ...
    SHR_IF_ERR_EXIT
        (bcm56990_b0_ecmp_lt_entry_memb_read(unit, lt_ent, ent_idx, ent_num,
                                             true, dma_buf));
...
static int
bcm56990_b0_ecmp_grp_table_write(int unit, bcmecmp_lt_entry_t *lt_ent,
                                 bool rh_mode)
{
    bcmecmp_grp_type_t gtype;
    bcm56990_b0_ecmp_grp_drd_fields_t *grp_flds;
    uint32_t *pt_entry_buff = NULL;
    ...
    grp_flds = (bcm56990_b0_ecmp_grp_drd_fields_t *)BCMECMP_TBL_DRD_FIELDS
                                                        (unit, group, gtype);
        ...
        if (lt_ent->num_paths) {
            if (BCMECMP_GRP_TYPE_UNDERLAY_WEIGHTED != gtype ||
                (BCMECMP_LT_GRP_IS_MEMBER_WEIGHT(unit, lt_ent) &&
                 BCM56990_WEIGHTED_SIZE_0_511 == lt_ent->weighted_size)) {
    ...
    SHR_IF_ERR_EXIT
        (bcm56990_b0_ecmp_lt_entry_grp_write(unit, lt_ent, pt_entry_buff));
...
static int
bcm56990_b0_ecmp_grp_table_clear(int unit, bcmecmp_lt_entry_t *lt_ent,
                                 bool rh_mode)
{
    uint32_t *pt_entry_buff = NULL;
...
static uint32_t
bcm56990_b0_weight_size_to_max_paths(uint32_t weighted_size)
{
    uint32_t num_paths;

    switch (weighted_size) {
        case BCM56990_OVLAY_WEIGHTED_SIZE_0_127:
            num_paths = 128;
            break;
        case BCM56990_WEIGHTED_SIZE_0_511:
            num_paths = 512;
            break;
        case BCM56990_WEIGHTED_SIZE_1K:
            num_paths = 1024;
            break;
        case BCM56990_WEIGHTED_SIZE_2K:
            num_paths = 2048;
            break;
        case BCM56990_WEIGHTED_SIZE_4K:
            num_paths = 4096;
            break;
        default:
            num_paths = 0;
...
static int
bcm56990_b0_ecmp_grp_table_read(int unit, bcmecmp_lt_entry_t *lt_ent,
                                bool rh_mode)
{
    ...
    SHR_IF_ERR_EXIT
        (bcm56990_b0_ecmp_lt_entry_grp_read(unit, lt_ent, pt_entry_buff));
    ...
    if (!BCMECMP_GRP_IS_WEIGHTED(gtype)) {
        ...
        } else if (lb_mode[0] >= BCM56990_WEIGHTED_SIZE_0_511
                                + MEMBER_WEIGHT_WEIGHTED_SIZE_HW_FIELD_OFFSET) {
    ...
    if (rh_mode) {
        lt_ent->rh_entries_cnt = (1 << num_paths[0]);
               ...
               (lt_ent->weighted_size != BCM56990_WEIGHTED_SIZE_0_511 &&
                lt_ent->weighted_size != BCM56990_OVLAY_WEIGHTED_SIZE_0_127)) {
        if (lb_mode[0] != 0) {
            lt_ent->num_paths = bcm56990_b0_weight_size_to_max_paths
...
static int
bcm56990_b0_ecmp_mw_memb_table_dma_read(int unit, bcmecmp_lt_entry_t *lt_ent)
{
    return SHR_E_UNAVAIL;
}

static int
bcm56990_b0_ecmp_mw_memb_table_dma_write(int unit, bcmecmp_lt_entry_t *lt_ent,
                                         bool ovlay)
{
    ...
    if (!ovlay) {
        ...
        if (lt_ent->num_paths > 0) {
            ...
            BCMECMP_ALLOC(m_idx_arr, sizeof(int) * lt_ent->num_paths,
                          "bcmecmpBcm56990GrpDmaWriteMidxArr");
    ...
    start_idx = lt_ent->mstart_idx;
    SHR_IF_ERR_EXIT
        (bcm56990_b0_ecmp_lt_entry_memb_write(unit, lt_ent, start_idx,
...
static int
bcm56990_b0_ecmp_mw_memb_table_dma_clear(int unit, bcmecmp_lt_entry_t *lt_ent)
{
    bcmecmp_grp_type_t gtype;
    uint32_t *dma_buf = NULL;
...
static int
bcm56990_b0_ecmp_mw_memb_dma_cpy(int unit,
                                 ...
                                 bcmecmp_grp_defrag_t *sfrag)
{
    ...
    SHR_IF_ERR_EXIT
        (bcm56990_b0_ecmp_dfrag_memb_read(unit, sfrag, sfrag->mstart_idx,
    ...
    SHR_IF_ERR_EXIT
        (bcm56990_b0_ecmp_dfrag_memb_write(unit, dfrag, dfrag->mstart_idx,
...
static int
bcm56990_b0_ecmp_mw_memb_dma_clr(int unit, bcmecmp_grp_defrag_t *frag)
{
    bcmecmp_grp_type_t gtype;
    bcmecmp_wal_info_t *wali = NULL;
    uint32_t *dma_buf = NULL;
    ...
    /* Write to destination fragment. */
    SHR_IF_ERR_EXIT
        (bcm56990_b0_ecmp_dfrag_memb_write(unit, frag, frag->mstart_idx, frag->gsize,
                                           true, dma_buf));
...
static int
bcm56990_b0_ecmp_grp_ins(int unit, void *info)
{
    ...
    if (BCMECMP_USE_DMA(unit)) {
        if (bcmecmp_grp_is_overlay(lt_ent->grp_type)) {
            if (BCMECMP_LT_GRP_IS_MEMBER_WEIGHT(unit, lt_ent)) {
                SHR_IF_ERR_EXIT
                    (bcm56990_b0_ecmp_mw_memb_table_dma_write(unit, lt_ent,
                                                              true));
            } else {
                SHR_IF_ERR_EXIT
                    (bcm56990_b0_ecmp_memb_table_dma_write
                         (unit, lt_ent, false,
            ...
            if (BCMECMP_LT_GRP_IS_MEMBER_WEIGHT(unit, lt_ent)) {
                ...
                SHR_IF_ERR_EXIT
                    (bcm56990_b0_ecmp_memb_table_dma_write(unit, lt_ent, false,
        ...
        if (bcmecmp_grp_is_overlay(lt_ent->grp_type)) {
            ...
            if (BCMECMP_LT_GRP_IS_MEMBER_WEIGHT(unit, lt_ent)) {
                ...
                SHR_IF_ERR_EXIT
                    (bcm56990_b0_ecmp_memb_table_pio_write(unit, lt_ent, false));
            }
        }
    }
    ...
    if (lt_ent->num_paths != 0) {
        SHR_IF_ERR_EXIT
            (bcm56990_b0_ecmp_grp_table_write(unit, lt_ent, false));
    } else {
        SHR_IF_ERR_EXIT
            (bcm56990_b0_ecmp_grp_table_clear(unit, lt_ent, false));
    }
...
static int
bcm56990_b0_ecmp_grp_del(int unit, void *info)
{
    bcmecmp_lt_entry_t *lt_ent = NULL;
    ...
    if (BCMECMP_USE_DMA(unit)) {
        if (BCMECMP_GRP_IS_MEMBER_WEIGHT(unit, lt_ent->ecmp_id)) {
            SHR_IF_ERR_EXIT
                (bcm56990_b0_ecmp_mw_memb_table_dma_clear(unit, lt_ent));
        } else {
            if (bcmecmp_grp_is_overlay(lt_ent->grp_type)) {
                /* Clean overlay ECMP*/
                SHR_IF_ERR_EXIT
                    (bcm56990_b0_ecmp_memb_table_dma_clear
                         (unit, lt_ent, false,
                          NHOPS_PER_MEMB_ENTRY_OVERLAY,
                          true));
            } else {
                SHR_IF_ERR_EXIT
                    (bcm56990_b0_ecmp_memb_table_dma_clear(unit, lt_ent, false,
                                                           NHOPS_PER_MEMB_ENTRY,
                                                           false));
            }
        }
        ...
        if (BCMECMP_GRP_IS_MEMBER_WEIGHT(unit, lt_ent->ecmp_id)) {
            ...
            if (bcmecmp_grp_is_overlay(lt_ent->grp_type)) {
                ...
                SHR_IF_ERR_EXIT
                    (bcm56990_b0_ecmp_memb_table_pio_clear(unit, lt_ent, false));
            }
        }
    }
...
static int
bcm56990_b0_ecmp_grp_get(int unit, void *info)
{
    bcmecmp_lt_entry_t *lt_ent = NULL;
    ...
    /* Program ECMP Group table. */
    SHR_IF_ERR_EXIT
        (bcm56990_b0_ecmp_grp_table_read(unit, lt_ent, false));

    /* Program ECMP Member table. */
    if (BCMECMP_USE_DMA(unit)) {
        if (BCMECMP_LT_GRP_IS_MEMBER_WEIGHT(unit, lt_ent)) {
            SHR_IF_ERR_EXIT
                (bcm56990_b0_ecmp_mw_memb_table_dma_read(unit, lt_ent));
        } else {
            if (bcmecmp_grp_is_overlay(lt_ent->grp_type)) {
                SHR_IF_ERR_EXIT
                    (bcm56990_b0_ecmp_memb_table_dma_read
                         (unit, lt_ent, false,
                          NHOPS_PER_MEMB_ENTRY_OVERLAY,
                          true));
            } else {
                SHR_IF_ERR_EXIT
                    (bcm56990_b0_ecmp_memb_table_dma_read(unit, lt_ent, false,
                                                          NHOPS_PER_MEMB_ENTRY,
                                                          false));
            }
        }
        ...
        if (BCMECMP_LT_GRP_IS_MEMBER_WEIGHT(unit, lt_ent)) {
            ...
            if (bcmecmp_grp_is_overlay(lt_ent->grp_type)) {
                ...
                SHR_IF_ERR_EXIT
                    (bcm56990_b0_ecmp_memb_table_pio_read(unit, lt_ent, false));
            }
        }
    }
...
static int
bcm56990_b0_ecmp_rh_grp_ins(int unit, void *info)
{
    bcmecmp_lt_entry_t *lt_ent = NULL;
    ...
    if (BCMECMP_USE_DMA(unit)) {
        if (bcmecmp_grp_is_overlay(lt_ent->grp_type)) {
            ...
            SHR_IF_ERR_EXIT
                (bcm56990_b0_ecmp_memb_table_dma_write(unit, lt_ent, true,
                                                       NHOPS_PER_MEMB_ENTRY,
                                                       false));
        }
    } else {
        if (bcmecmp_grp_is_overlay(lt_ent->grp_type)) {
            ...
            SHR_IF_ERR_EXIT
                (bcm56990_b0_ecmp_memb_table_pio_write(unit, lt_ent, true));
        }
    }
    ...
    if (lt_ent->rh_num_paths != 0) {
        SHR_IF_ERR_EXIT
            (bcm56990_b0_ecmp_grp_table_write(unit, lt_ent, true));
    } else {
        SHR_IF_ERR_EXIT
            (bcm56990_b0_ecmp_grp_table_clear(unit, lt_ent, true));
    }
...
static int
bcm56990_b0_ecmp_rh_grp_del(int unit, void *info)
{
    bcmecmp_lt_entry_t *lt_ent = NULL;
    ...
    if (BCMECMP_USE_DMA(unit)) {
        ...
        if (bcmecmp_grp_is_overlay(lt_ent->grp_type)) {
            ...
            SHR_IF_ERR_EXIT
                (bcm56990_b0_ecmp_memb_table_pio_clear(unit, lt_ent, true));
        }
    }
...
static int
bcm56990_b0_ecmp_rh_grp_get(int unit, void *info)
{
    bcmecmp_lt_entry_t *lt_ent = NULL;
    ...
    /* Program ECMP Group table. */
    SHR_IF_ERR_EXIT
        (bcm56990_b0_ecmp_grp_table_read(unit, lt_ent, true));
    ...
    if (BCMECMP_USE_DMA(unit)) {
        if (bcmecmp_grp_is_overlay(lt_ent->grp_type)) {
            ...
            SHR_IF_ERR_EXIT
                (bcm56990_b0_ecmp_memb_table_dma_read(unit, lt_ent, true,
                                                      NHOPS_PER_MEMB_ENTRY, false));
        }
    } else {
        if (bcmecmp_grp_is_overlay(lt_ent->grp_type)) {
            ...
            SHR_IF_ERR_EXIT
                (bcm56990_b0_ecmp_memb_table_pio_read(unit, lt_ent, true));
        }
    }
...
static int
bcm56990_b0_ecmp_memb_dma_cpy(int unit,
                              bcmecmp_grp_defrag_t *dfrag,
                              bcmecmp_grp_defrag_t *sfrag,
                              int nh_per_ent,
                              bool ovlay)
{
    ...
    if (ovlay) {
        BCMECMP_ALLOC(o_nhop_arr, sizeof(uint32_t) * sfrag->gsize,
                  "bcmecmp56990L3EcmpDmaCpyOvlay");
        BCMECMP_ALLOC(u_ecmp_nhop_arr, sizeof(uint32_t) * sfrag->gsize,
                  "bcmecmp56990L3EcmpDmaCpyUnlay");
    }
    ...
    SHR_IF_ERR_EXIT
        (bcm56990_b0_ecmp_dfrag_memb_read(unit, sfrag, ent_idx, ent_num,
                                          true, dma_buf));
    ...
    while (max_paths > 0) {
        ...
        if (ent_offset != 0 || max_paths < nh_per_ent) {
            SHR_IF_ERR_EXIT
                (bcm56990_b0_ecmp_dfrag_memb_read(unit, dfrag, ent_idx, 1, false,
                                                  &dma_buf[dma_buf_idx * ent_size]));
        }
    ...
    SHR_IF_ERR_EXIT
        (bcm56990_b0_ecmp_dfrag_memb_write(unit, dfrag, start_idx, ent_num,
                                           true, dma_buf));
...
static int
bcm56990_b0_ecmp_memb_cpy(int unit,
                          const void *mdest,
                          const void *msrc)
{
    ...
    if (BCMECMP_USE_DMA(unit)) {
        if (BCMECMP_GRP_IS_MEMBER_WEIGHT(unit, sfrag.ecmp_id)) {
            SHR_IF_ERR_EXIT
                (bcm56990_b0_ecmp_mw_memb_dma_cpy(unit, &dfrag, &sfrag));
        } else {
            if (bcmecmp_grp_is_overlay(sfrag.gtype)) {
                SHR_IF_ERR_EXIT
                    (bcm56990_b0_ecmp_memb_dma_cpy
                         (unit, &dfrag, &sfrag,
                          NHOPS_PER_MEMB_ENTRY_OVERLAY, true));
            } else {
                SHR_IF_ERR_EXIT
                    (bcm56990_b0_ecmp_memb_dma_cpy(unit, &dfrag, &sfrag,
                                                   NHOPS_PER_MEMB_ENTRY, false));
            }
        }
    } else {
...
static int
bcm56990_b0_ecmp_memb_dma_clr(int unit, bcmecmp_grp_defrag_t *mclr,
                              int nh_per_ent, bool ovlay)
{
    ...
    while (max_paths > 0) {
        ...
        if (ent_offset != 0 || max_paths < nh_per_ent) {
            SHR_IF_ERR_EXIT
                (bcm56990_b0_ecmp_dfrag_memb_read(unit, mclr, ent_idx, 1, false,
                                                  &dma_buf[dma_buf_idx * ent_size]));
    ...
    SHR_IF_ERR_EXIT
        (bcm56990_b0_ecmp_dfrag_memb_write(unit, mclr, start_idx, ent_num,
                                           true, dma_buf));
...
static int
bcm56990_b0_ecmp_memb_clr(int unit, const void *mfrag)
{
    ...
    if (BCMECMP_USE_DMA(unit)) {
        if (BCMECMP_GRP_IS_MEMBER_WEIGHT(unit, my_frag.ecmp_id)) {
            SHR_IF_ERR_EXIT
                (bcm56990_b0_ecmp_mw_memb_dma_clr(unit, &my_frag));
        } else {
            if (bcmecmp_grp_is_overlay(my_frag.gtype)) {
                ...
                SHR_IF_ERR_EXIT
                    (bcm56990_b0_ecmp_memb_dma_clr(unit, &my_frag,
                                                   NHOPS_PER_MEMB_ENTRY, false));
            }
        }
    } else {
...
static int
bcm56990_b0_ecmp_gmstart_updt(int unit, const void *ginfo)
{
    ...
    SHR_IF_ERR_EXIT
        (bcm56990_b0_ecmp_dfrag_grp_read(unit, gupdt, pt_entry_buff));
    ...
    SHR_IF_ERR_EXIT
        (bcm56990_b0_ecmp_dfrag_grp_write(unit, gupdt, pt_entry_buff));
...
bcm56990_b0_ecmp_share_group_type_get(bcmecmp_grp_type_t gtype)
{
    if (gtype == BCMECMP_GRP_TYPE_OVERLAY) {
...
static int
bcm56990_weighted_underlay_group_lt_fields_fill(int unit,
                                      const void *in_fld,
                                      void *ltentry)
{
    ...
    switch (fid) {
        ...
        case ECMP_WEIGHTED_UNDERLAYt_WEIGHTED_SIZEf:
            ...
            lt_entry->max_paths = bcm56990_b0_weight_size_to_max_paths(fval);
            break;
...
static int
bcm56990_b0_underlay_grp_lt_fields_fill(int unit,
                                        const void *in_fld,
                                        void *ltentry)
{
    uint32_t fid;  /* Field identifier value. */
    ...
    if (lt_entry->grp_type == BCMECMP_GRP_TYPE_UNDERLAY_WEIGHTED) {
        SHR_IF_ERR_EXIT(
            bcm56990_weighted_underlay_group_lt_fields_fill
                (unit, in_fld, ltentry));
        SHR_EXIT();
    }
...
static int
becm56990_weighted_overlay_group_lt_fields_fill(int unit,
                                                const void *in_fld,
                                                void *ltentry)
{
    uint32_t fid;  /* Field identifier value. */
 ...
 */
static int
bcm56990_b0_overlay_grp_lt_fields_fill(int unit,
                                       const void *in_fld,
                                       void *ltentry)
{
    uint32_t fid;  /* Field identifier value. */
    ...
    if (lt_entry->grp_type == BCMECMP_GRP_TYPE_OVERLAY_WEIGHTED) {
        SHR_IF_ERR_EXIT
            (becm56990_weighted_overlay_group_lt_fields_fill
                (unit, in_fld, ltentry));
        SHR_EXIT();
    }
...
static int
bcm56990_b0_ecmp_memb_bank_encode(int unit,
                             bcmecmp_limit_t *l3_bank)
{
    int off_set = 0;
...
static int
bcm56990_b0_ecmp_memb_bank_set(int unit,
                               ...
                               void *l3_limit)
{
    ...
    bcm56990_b0_ecmp_memb_bank_encode(unit, l3_bank);
...
static int
bcm56990_b0_ecmp_memb_bank_get(int unit,
                               const bcmltd_op_arg_t *op_arg,
                               bcmltd_sid_t lt_id,
                               void *l3_limit)
{
...
static int
bcm56990_b0_grp_member_fields_count_get(int unit, void *lt_entry)
{
 ...
 */
int
bcm56990_b0_ecmp_attach(int unit)
{
    ...
    BCMECMP_FNCALL(unit, info_init) = &bcm56990_b0_ecmp_info_init;

    /* Setup device ECMP component clean-up function. */
    BCMECMP_FNCALL(unit, info_cleanup) = &bcm56990_b0_ecmp_info_cleanup;

    /* Setup device ECMP resolution mode hardware config function. */
    BCMECMP_FNCALL(unit, mode_config) = &bcm56990_b0_ecmp_mode_config;

    /* Initialize device ECMP group management function pointers. */
    BCMECMP_FNCALL(unit, grp_ins) = &bcm56990_b0_ecmp_grp_ins;
    BCMECMP_FNCALL(unit, grp_del) = &bcm56990_b0_ecmp_grp_del;
    BCMECMP_FNCALL(unit, grp_get) = &bcm56990_b0_ecmp_grp_get;
    BCMECMP_FNCALL(unit, rh_grp_ins) = &bcm56990_b0_ecmp_rh_grp_ins;
    BCMECMP_FNCALL(unit, rh_grp_del) = &bcm56990_b0_ecmp_rh_grp_del;
    BCMECMP_FNCALL(unit, rh_grp_get) = &bcm56990_b0_ecmp_rh_grp_get;
    BCMECMP_FNCALL(unit, rh_pre_config) = &bcmecmp_rh_groups_preconfig_with_itbm;
    BCMECMP_FNCALL(unit, memb_cpy) = &bcm56990_b0_ecmp_memb_cpy;
    BCMECMP_FNCALL(unit, memb_clr) = &bcm56990_b0_ecmp_memb_clr;
    BCMECMP_FNCALL(unit, gmstart_updt) = &bcm56990_b0_ecmp_gmstart_updt;
    BCMECMP_FNCALL(unit, member_weight_index_width) = NULL;
    BCMECMP_FNCALL(unit, grp_ol_lt_fields_fill) =
                            &bcm56990_b0_overlay_grp_lt_fields_fill;
    BCMECMP_FNCALL(unit, grp_ul_lt_fields_fill) =
                            &bcm56990_b0_underlay_grp_lt_fields_fill;
    BCMECMP_FNCALL(unit, grp_member_fields_count_get) =
                                       &bcm56990_b0_grp_member_fields_count_get;
    ecmp_drv->shr_grp_type_get = &bcm56990_b0_ecmp_share_group_type_get;
    ecmp_drv->weight_size_to_max_paths = &bcm56990_b0_weight_size_to_max_paths;
    ecmp_drv->itbm_memb_lists_update = &bcm56990_b0_ecmp_itbm_memb_lists_resize;
    ecmp_drv->memb_bank_set= &bcm56990_b0_ecmp_memb_bank_set;
    ecmp_drv->memb_bank_get = &bcm56990_b0_ecmp_memb_bank_get;
 ...
 */
int
bcm56990_b0_ecmp_detach(int unit)
{
    bcmecmp_drv_t *ecmp_drv = bcmecmp_drv_get(unit);
