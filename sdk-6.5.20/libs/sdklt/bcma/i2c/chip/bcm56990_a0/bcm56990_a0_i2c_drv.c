...
/*! BCM56990_A0 base board ID. */
#define TOMAHAWK_4_A0   0xC5
...
static bcma_i2c_base_board_t bcm56990_a0_base_board_type[] = {
    {"TOMAHAWK 4 A0 Platform",  TOMAHAWK_4_A0},
    {"\0", 0}
};

/* Board specific sense resistor configuration */
static i2c_ltc_t bcm56990_a0_sense_resistor_config[LTC2974_TOTAL_CHANNEL] = {
...
static bb_voltage_profile_t bcm56990_a0_bb_voltage_profile[] = {
...
static dac_calibrate_t bcm56990_a0_adc_cali_data[] = {
...
/* Board ID chip info */
static i2c_device_t bcm56990_a0_board_id[] = {
    I2CDEV(PCF8574, 0x27, pcf8574)
};

/* Mux info before voltage regulator */
static i2c_device_t bcm56990_a0_voltage_mux[] = {
    I2CDEV(MUX9548, 0x73, pca9548)
};

/* All voltage regulator devices */
static i2c_device_t bcm56990_a0_voltage_devices[] = {
...
static i2c_device_t bcm56990_a0_temperature_devices[] = {
    I2CDEV(MAX669X, 0x18, max669x),
    I2CDEV(MAX669X, 0x19, max669x)
};

/* Complete list of supported I2C devices. */
static i2c_device_t bcm56990_a0_i2c_devices[] = {
...
bcm56990_a0_i2c_platform_info_get(int unit)
{
    return (bcm56990_a0_base_board_type);
}

static int
bcm56990_a0_bb_voltage_dev_get(int unit, bb_i2c_device_t *dev_info)
{
    if (dev_info) {
        dev_info->p_cnt = sizeof(bcm56990_a0_bb_voltage_profile) /
                          sizeof(bb_voltage_profile_t);
        dev_info->voltage_profile = bcm56990_a0_bb_voltage_profile;

        dev_info->m_cnt = sizeof(bcm56990_a0_voltage_mux) /
                          sizeof(i2c_device_t);
        dev_info->mux_device = bcm56990_a0_voltage_mux;

        dev_info->id_cnt = sizeof(bcm56990_a0_board_id) /
                           sizeof(i2c_device_t);
        dev_info->id_device = bcm56990_a0_board_id;

        dev_info->v_cnt = sizeof(bcm56990_a0_voltage_devices) /
                          sizeof(i2c_device_t);
        dev_info->v_device = bcm56990_a0_voltage_devices;

        dev_info->sensor_cnt = sizeof(bcm56990_a0_sense_resistor_config) /
                               sizeof(i2c_ltc_t);
        dev_info->sensor_config = bcm56990_a0_sense_resistor_config;

        dev_info->cali_cnt = sizeof(bcm56990_a0_adc_cali_data) /
                             sizeof(dac_calibrate_t);
        dev_info->cali_record = bcm56990_a0_adc_cali_data;
...
static int
bcm56990_a0_temperature_dev_get(int unit, int *total, i2c_device_t *dev_info)
{
    if (*total == 0) {
        *total = sizeof(bcm56990_a0_temperature_devices) / sizeof(i2c_device_t);
    }

    if (dev_info) {
        *total = sizeof(bcm56990_a0_temperature_devices) / sizeof(i2c_device_t);
        sal_memcpy(dev_info,
                   &bcm56990_a0_temperature_devices,
                   sizeof(bcm56990_a0_temperature_devices));
    }
    return SHR_E_NONE;
}

static int
bcm56990_a0_i2c_dev_get(int unit, int *total, i2c_device_t *dev_info)
{
    if (*total == 0) {
        *total = sizeof(bcm56990_a0_i2c_devices) / sizeof(i2c_device_t);
    }

    if (dev_info) {
        *total = sizeof(bcm56990_a0_i2c_devices) / sizeof(i2c_device_t);
        sal_memcpy(dev_info,
                   &bcm56990_a0_i2c_devices,
                   sizeof(bcm56990_a0_i2c_devices));
    }
    return SHR_E_NONE;
}

static bcma_i2c_device_drv_t bcm56990_a0_i2c_dev_drv = {
    .platform_get    = bcm56990_a0_i2c_platform_info_get,
    .dev_get         = bcm56990_a0_i2c_dev_get,
    .voltage_dev_get = bcm56990_a0_bb_voltage_dev_get,
    .temp_dev_get    = bcm56990_a0_temperature_dev_get
};
...
bcm56990_a0_i2c_drv_get(int unit)
{
   return &bcm56990_a0_i2c_dev_drv;
}
