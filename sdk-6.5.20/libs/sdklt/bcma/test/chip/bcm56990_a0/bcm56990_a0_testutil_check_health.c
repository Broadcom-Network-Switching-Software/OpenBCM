/*! \file bcm56990_a0_testutil_check_health.c
 *
...
static const check_health_info_t th4_check_health_ipep_sids[] = {
    ...
    {ING_DOI_INTR_STATUSr, EVENT_FIFO_0_UNCORRECTED_ECC_ERRf, {0x0, 0x0}},
    {ING_DOI_INTR_STATUSr, CELL_QUEUE_0_UNCORRECTED_ECC_ERRf, {0x0, 0x0}},
    {ING_DOI_INTR_STATUSr, SLOT_PIPELINE_0_UNCORRECTED_ECC_ERRf, {0x0, 0x0}},
    {ING_DOI_INTR_STATUSr, EVENT_FIFO_1_READ_FAILf, {0x0, 0x0}},
    {ING_DOI_INTR_STATUSr, EVENT_FIFO_1_WRITE_FAILf, {0x0, 0x0}},
    {ING_DOI_INTR_STATUSr, EVENT_FIFO_1_UNCORRECTED_ECC_ERRf, {0x0, 0x0}},
    {ING_DOI_INTR_STATUSr, CELL_QUEUE_1_UNCORRECTED_ECC_ERRf, {0x0, 0x0}},
    {ING_DOI_INTR_STATUSr, SLOT_PIPELINE_1_UNCORRECTED_ECC_ERRf, {0x0, 0x0}},
    {ING_DOI_INTR_STATUSr, EVENT_FIFO_2_READ_FAILf, {0x0, 0x0}},
    {ING_DOI_INTR_STATUSr, EVENT_FIFO_2_WRITE_FAILf, {0x0, 0x0}},
    {ING_DOI_INTR_STATUSr, EVENT_FIFO_2_UNCORRECTED_ECC_ERRf, {0x0, 0x0}},
    {ING_DOI_INTR_STATUSr, CELL_QUEUE_2_UNCORRECTED_ECC_ERRf, {0x0, 0x0}},
    {ING_DOI_INTR_STATUSr, SLOT_PIPELINE_2_UNCORRECTED_ECC_ERRf, {0x0, 0x0}},
    {ING_DOI_INTR_STATUSr, EVENT_FIFO_3_READ_FAILf, {0x0, 0x0}},
    {ING_DOI_INTR_STATUSr, EVENT_FIFO_3_WRITE_FAILf, {0x0, 0x0}},
    {ING_DOI_INTR_STATUSr, EVENT_FIFO_3_UNCORRECTED_ECC_ERRf, {0x0, 0x0}},
    {ING_DOI_INTR_STATUSr, CELL_QUEUE_3_UNCORRECTED_ECC_ERRf, {0x0, 0x0}},
    {ING_DOI_INTR_STATUSr, SLOT_PIPELINE_3_UNCORRECTED_ECC_ERRf, {0x0, 0x0}},
    {ING_DOI_INTR_STATUSr, PKT_BUFFER_0_UNCORRECTED_ECC_ERRf, {0x0, 0x0}},
    {ING_DOI_INTR_STATUSr, PKT_BUFFER_1_UNCORRECTED_ECC_ERRf, {0x0, 0x0}},
    {ING_DOI_INTR_STATUSr, PKT_BUFFER_2_UNCORRECTED_ECC_ERRf, {0x0, 0x0}},
    {ING_DOI_INTR_STATUSr, PKT_BUFFER_3_UNCORRECTED_ECC_ERRf, {0x0, 0x0}},
    ...
    {EGR_DOI_INTR_STATUSr, EVENT_FIFO_2_READ_FAILf, {0x0, 0x0}},
    {EGR_DOI_INTR_STATUSr, EVENT_FIFO_2_WRITE_FAILf, {0x0, 0x0}},
    {EGR_DOI_INTR_STATUSr, EVENT_FIFO_3_READ_FAILf, {0x0, 0x0}},
    {EGR_DOI_INTR_STATUSr, EVENT_FIFO_3_WRITE_FAILf, {0x0, 0x0}},
...
int
bcm56990_a0_check_health(int unit, bool *test_result)
{
    int err = 0, check_err = 0;

    SHR_FUNC_ENTER(unit);
    LOG_INFO(BSL_LOG_MODULE,
                    (BSL_META_U(unit, "Calling Check Health for TH4 \n")));
