/*! \file bcm56880_a0_testutil_drv.c
 *
...
static bcmdrd_sid_t bcm56880_a0_reg_reset_skip_pt[] = {
...
static bcmdrd_sid_t bcm56880_a0_reg_wr_skip_pt[] = {
    AVS_PMB_SLAVE_AVS_ROSC_LVT11_THRESHOLDr,
    AVS_PMB_SLAVE_AVS_ROSC_LVT8_THRESHOLDr,
    AVS_PMB_SLAVE_AVS_ROSC_SVT11_THRESHOLDr,
    AVS_PMB_SLAVE_AVS_ROSC_SVT8_THRESHOLDr,
    ...
    PBLOCK_MISC_IP8_1_BYPASS_CONTROLr,
    PBLOCK_MISC_IP9_0_BYPASS_CONTROLr,
    PBLOCK_MISC_IP9_1_BYPASS_CONTROLr,
};

static bcmdrd_sid_t bcm56880_a0_mem_skip_pt[] = {
    /*
    ...
    IFTA90_E2T_03_KEY_ATTRIBUTESm,
    IFTA30_E2T_00_KEY_ATTRIBUTESm,
    IFTA80_E2T_01_KEY_ATTRIBUTESm,
    IFTA90_E2T_02_KEY_ATTRIBUTESm,
    ...
    MMU_MB_PAYLOAD_SER_CH0_MMU_ITM0_ITM0m,
    MMU_MB_PAYLOAD_SER_CH1_MMU_ITM0_ITM0m,
    MMU_MB_PAYLOAD_SER_CH2_MMU_ITM0_ITM0m,
    MMU_MB_PAYLOAD_SER_CH3_MMU_ITM0_ITM0m,

    /* Write only. */
    FT_COMMANDm,
    MEMDB_IFTA10_MEM0_MEM1m,
    MEMDB_IFTA110_MEM0_MEM1m,
    MEMDB_IFTA120_MEM0_MEM1m,
    MEMDB_IFTA120_MEM2_MEM3m,
    MEMDB_IFTA120_MEM4_MEM5m,
    MEMDB_IFTA120_MEM6_MEM7m,
    MEMDB_IFTA130_MEM0_MEM1m,
    MEMDB_IFTA130_MEM2_MEM3m,
    MEMDB_IFTA130_MEM4_MEM5m,
    MEMDB_IFTA130_MEM6_MEM7m,
    MEMDB_IFTA140_MEM0_MEM1m,
    MEMDB_IFTA20_MEM0_MEM1m,
    MEMDB_IFTA50_MEM0_MEM1m,
    MEMDB_IFTA50_MEM2_MEM3m,
    MEMDB_IFTA60_MEM0_MEM1m,
    MEMDB_IFTA60_MEM2_MEM3m,
    MEMDB_IFTA60_MEM4_MEM5m,
    MEMDB_IFTA70_MEM0_MEM1m,
    MEMDB_IFTA70_MEM2_MEM3m,
...
static shr_enum_map_t bcm56880_a0_blktype_name_id_map[] = {
    {"avs", BLKTYPE_AVS},
...
static bcmdrd_sid_t bcm56880_a0_tr144_skip_pt_list[] = {
    ...
    MMU_MB_PAYLOAD_SER_CH0_MMU_ITM0_ITM0m,
    MMU_MB_PAYLOAD_SER_CH0_MMU_ITM1_ITM1m,
    MMU_MB_PAYLOAD_SER_CH1_MMU_ITM0_ITM0m,
    MMU_MB_PAYLOAD_SER_CH1_MMU_ITM1_ITM1m,
    MMU_MB_PAYLOAD_SER_CH2_MMU_ITM0_ITM0m,
    MMU_MB_PAYLOAD_SER_CH2_MMU_ITM1_ITM1m,
    MMU_MB_PAYLOAD_SER_CH3_MMU_ITM0_ITM0m,
    MMU_MB_PAYLOAD_SER_CH3_MMU_ITM1_ITM1m,
};

static bcmdrd_sid_t bcm56880_a0_tr901_skip_pt_list[] = {
    CDMIB_MEMm,
    /* can't be written successfully */
    ...
    TOP_CPU2TAP_DMA_CMD_MEMm,
    TOP_CPU2TAP_DMA_RESULT_ERROR_MEMm,
    EGR_COMPOSITES_EGR_COMPOSITES_BUFFERm,
...
static const bcma_testutil_pkt_lt_cfg_t bcm56880_a0_pkt_traffic_lt_cfg[] = {
    {"ING_DVP_TABLE",
    ...
    {"ING_L3_NEXT_HOP_2_STRENGTH_PROFILE",
     ...
     BCMLT_OPCODE_INSERT},
    {"PORT", {{"PORT_ID", 21}, {"ING_SYSTEM_PORT_TABLE_ID", 21}}, BCMLT_OPCODE_INSERT},
    {"PORT", {{"PORT_ID", 2}, {"ING_SYSTEM_PORT_TABLE_ID", 2}}, BCMLT_OPCODE_INSERT},
    {"PORT_PROPERTY",
     {{"PORT_ID", 21}, {"PORT_PARSER", 3}, {"PORT_TYPE", 1}}, BCMLT_OPCODE_INSERT},
    {"PORT_PROPERTY",
     {{"PORT_ID", 2}, {"PORT_PARSER", 3}, {"PORT_TYPE", 1}}, BCMLT_OPCODE_INSERT},
    {"ING_SYSTEM_PORT_TABLE",
     {{"SYSTEM_SOURCE", 21}, {"OUTER_L2HDR_OTPID_ENABLE", 0xf}, {"L2_IIF", 0x2},
      {"L2_IIF_STRENGTH", 1}, {"INGRESS_PP_PORT", 21}},
     BCMLT_OPCODE_INSERT},
    {"ING_SYSTEM_PORT_TABLE",
    ...
    {"VLAN_ING_MEMBER_PROFILE",
     {{"VLAN_ING_MEMBER_PROFILE_ID", 1}, {"MEMBER_PORTS", 1, NULL, 22, 0}},
     BCMLT_OPCODE_INSERT},
    {"VLAN_ING_STG_PROFILE",
     {{"VLAN_ING_STG_PROFILE_ID", 1}, {"STATE", 0, "FORWARD", 22, 0}}, BCMLT_OPCODE_INSERT},
    {"VLAN_ING_STG_PROFILE",
     {{"VLAN_ING_STG_PROFILE_ID", 1}, {"STATE", 0, "LEARN", 22, 21}}, BCMLT_OPCODE_UPDATE},
    {"VLAN_ING_EGR_MEMBER_PORTS_PROFILE",
     {{"VLAN_ING_EGR_MEMBER_PORTS_PROFILE_ID", 1}, {"EGR_MEMBER_PORTS", 1, NULL, 22, 0}},
     BCMLT_OPCODE_INSERT},
    {"VLAN_ING_EGR_STG_MEMBER_PROFILE",
     {{"VLAN_ING_EGR_STG_MEMBER_PROFILE_ID", 1}, {"STATE", 0, "FORWARD", 22, 0}, {"COMPARED_STATE", 0, "FORWARD", 1, 0}},
     BCMLT_OPCODE_INSERT},
    {"DEVICE_EM_TILE",
    ...
    {"L2_HOST_TABLE",
     {{"MAC_ADDR", 0xBBBBBB}, {"VFI", 0x2}, {"STRENGTH_PROFILE_INDEX", 7}, {"DESTINATION", 21},
    ...
    {"ING_SYSTEM_DESTINATION_TABLE",
     {{"SYSTEM_DESTINATION_PORT", 21}, {"L2_OIF", 21}, {"L2_OIF_STRENGTH", 1}}, BCMLT_OPCODE_INSERT},
    {"ING_SYSTEM_DESTINATION_TABLE",
     {{"SYSTEM_DESTINATION_PORT", 2}, {"L2_OIF", 2}, {"L2_OIF_STRENGTH", 1}}, BCMLT_OPCODE_INSERT},
    {"L2_EIF_SYSTEM_DESTINATION", {{"L2_EIF_ID", 21}, {"IS_TRUNK", 0}, {"SYSTEM_PORT", 21}}, BCMLT_OPCODE_INSERT},
    {"L2_EIF_SYSTEM_DESTINATION", {{"L2_EIF_ID", 2}, {"IS_TRUNK", 0}, {"SYSTEM_PORT", 2}}, BCMLT_OPCODE_INSERT},
    {"PORT_SYSTEM_DESTINATION",
     {{"PORT_SYSTEM_ID", 21}, {"IS_TRUNK_SYSTEM", 0}, {"PORT_ID", 21}}, BCMLT_OPCODE_INSERT},
    {"PORT_SYSTEM_DESTINATION",
    ...
    {"VLAN_EGR_MEMBER_PROFILE",
     {{"VLAN_EGR_MEMBER_PROFILE_ID", 2}, {"MEMBER_PORTS", 1, NULL, 22, 0}}, BCMLT_OPCODE_INSERT},
    {"VLAN_EGR_STG_PROFILE",
     {{"VLAN_EGR_STG_PROFILE_ID", 2}, {"STATE", 0, "FORWARD", 22, 0}}, BCMLT_OPCODE_INSERT},
    {"EGR_L2_OIF",
     {{"L2_OIF", 21}, {"EDIT_CTRL_ID", 2}, {"TPID_0", 0x8100}, {"TPID_1", 0x9100}}, BCMLT_OPCODE_INSERT},
    {"EGR_L2_OIF",
     {{"L2_OIF", 2}, {"EDIT_CTRL_ID", 2}, {"TPID_0", 0x8100}, {"TPID_1", 0x9100}}, BCMLT_OPCODE_INSERT},
    {"PC_PORT", {{"PORT_ID", 21}, {"LOOPBACK_MODE", 0, "PC_LPBK_MAC"}}, BCMLT_OPCODE_UPDATE},
    {"PC_PORT", {{"PORT_ID", 2}, {"LOOPBACK_MODE", 0, "PC_LPBK_MAC"}}, BCMLT_OPCODE_UPDATE},
    {"LM_PORT_CONTROL", {{"PORT_ID", 21}}, BCMLT_OPCODE_INSERT},
    {"LM_PORT_CONTROL", {{"PORT_ID", 2}}, BCMLT_OPCODE_INSERT},
    {"LM_LINK_STATE", {{"PORT_ID", 21}}, BCMLT_OPCODE_LOOKUP},
    {"LM_LINK_STATE", {{"PORT_ID", 2}}, BCMLT_OPCODE_LOOKUP},
};

static uint8_t bcm56880_a0_pkt_raw_data[] = {
...
static uint32_t bcm56880_a0_tx_pmd[][3] = {
    {0x81000000, 0x2, 0x6000},
};

static const bcma_testutil_pkt_data_t bcm56880_a0_pkt_data = {
    bcm56880_a0_tx_pmd,
    sizeof(bcm56880_a0_tx_pmd),
    NULL, 0, NULL, 0,
    bcm56880_a0_pkt_raw_data,
    sizeof(bcm56880_a0_pkt_raw_data)
};

bcmdrd_ser_rmr_id_t bcm56880_a0_bb_skip_pt[9] = {0};

static bool
bcm56880_a0_pt_skip(int unit, bcmdrd_sid_t sid, bcma_testutil_pt_type_t type)
{
    ...
    case BCMA_TESTUTIL_PT_REG_RESET:
        skip_pt = bcm56880_a0_reg_reset_skip_pt;
        count = COUNTOF(bcm56880_a0_reg_reset_skip_pt);
        break;

    case BCMA_TESTUTIL_PT_REG_RD_WR:
        skip_pt = bcm56880_a0_reg_wr_skip_pt;
        count = COUNTOF(bcm56880_a0_reg_wr_skip_pt);
        break;
    ...
    case BCMA_TESTUTIL_PT_MEM_DMA_RD_WR:
        ...
        case BLKTYPE_PORT_IF:
            skip_pt = bcm56880_a0_mem_skip_pt;
            count = COUNTOF(bcm56880_a0_mem_skip_pt);
            break;
        default:
            return TRUE;
        }
    ...
    case BCMA_TESTUTIL_PT_MEM_TR_144:
        skip_pt = bcm56880_a0_tr144_skip_pt_list;
        count = COUNTOF(bcm56880_a0_tr144_skip_pt_list);
        break;

    case BCMA_TESTUTIL_PT_MEM_TR_143:
        bcmdrd_pt_ser_name_to_rmr(unit, "CENTRAL_EVICTION_FIFO", &bcm56880_a0_bb_skip_pt[0]);
        bcmdrd_pt_ser_name_to_rmr(unit, "EGR_DOI_SLOT_PIPELINE_0", &bcm56880_a0_bb_skip_pt[1]);
        bcmdrd_pt_ser_name_to_rmr(unit, "EGR_DOI_SLOT_PIPELINE_1", &bcm56880_a0_bb_skip_pt[2]);
        bcmdrd_pt_ser_name_to_rmr(unit, "FT_LEARN_FIFO", &bcm56880_a0_bb_skip_pt[3]);
        bcmdrd_pt_ser_name_to_rmr(unit, "FT_PT_HWY_FIFO", &bcm56880_a0_bb_skip_pt[4]);
        bcmdrd_pt_ser_name_to_rmr(unit, "ING_DII_EVENT_FIFO_0", &bcm56880_a0_bb_skip_pt[5]);
        bcmdrd_pt_ser_name_to_rmr(unit, "ING_DII_EVENT_FIFO_1", &bcm56880_a0_bb_skip_pt[6]);
        bcmdrd_pt_ser_name_to_rmr(unit, "ING_DOI_SLOT_PIPELINE_0", &bcm56880_a0_bb_skip_pt[7]);
        bcmdrd_pt_ser_name_to_rmr(unit, "ING_DOI_SLOT_PIPELINE_1", &bcm56880_a0_bb_skip_pt[8]);
        skip_pt = bcm56880_a0_bb_skip_pt;
        count = COUNTOF(bcm56880_a0_bb_skip_pt);
        break;

    case BCMA_TESTUTIL_PT_MEM_TR_901:
        skip_pt = bcm56880_a0_tr901_skip_pt_list;
        count = COUNTOF(bcm56880_a0_tr901_skip_pt_list);
        break;
    ...
    if (bcmdrd_feature_is_sim(unit) == true) {
        ...
        skip_pt = bcm56880_a0_mem_ecc;
        count = COUNTOF(bcm56880_a0_mem_ecc);
        for (idx = 0; idx < count; idx++) {
            if (sid == skip_pt[idx]) {
                return TRUE;
            }
...
static int
bcm56880_a0_pt_mask_override(int unit, bcmdrd_sid_t sid, int index,
...
static int
bcm56880_a0_pt_entity_override(int unit, bcmdrd_sid_t sid,
...
static void
bcm56880_a0_pkt_cfg_data_get(int unit, const bcma_testutil_pkt_lt_cfg_t **pkt_lt_cfg,
                             int *lt_cfg_num,
                             const bcma_testutil_pkt_data_t **pkt_data)
{
    *lt_cfg_num = COUNTOF(bcm56880_a0_pkt_traffic_lt_cfg);
    *pkt_lt_cfg = bcm56880_a0_pkt_traffic_lt_cfg;

    *pkt_data = &bcm56880_a0_pkt_data;
}
...
static int
bcm56880_a0_pt_hw_update(int unit, const char *name,
...
uft_init(int unit)
{
    ...
    IFTA90_E2T_02_HASH_CONTROLm_t ifta90_e2t_02_hash_control;
    IFTA90_E2T_03_HASH_CONTROLm_t ifta90_e2t_03_hash_control;
    ...
    IFTA90_E2T_02_SHARED_BANKS_CONTROLm_t ifta90_02_sb_ctrl;
    IFTA90_E2T_03_SHARED_BANKS_CONTROLm_t ifta90_03_sb_ctrl;
    ...
    IFTA90_E2T_02_HASH_CONTROLm_CLR(ifta90_e2t_02_hash_control);
    IFTA90_E2T_03_HASH_CONTROLm_CLR(ifta90_e2t_03_hash_control);
    LPM_IP_CONTROLm_CLR(lpm_ip_control);

    /* HASH_CONTROL HASH_TABLE_BANK_CONFIG. */
    IFTA90_E2T_00_HASH_CONTROLm_HASH_TABLE_BANK_CONFIG_LANE0f_SET(ifta90_e2t_00_hash_control, 0x1);
    IFTA90_E2T_01_HASH_CONTROLm_HASH_TABLE_BANK_CONFIG_LANE0f_SET(ifta90_e2t_01_hash_control, 0x1);
    IFTA90_E2T_02_HASH_CONTROLm_HASH_TABLE_BANK_CONFIG_LANE0f_SET(ifta90_e2t_02_hash_control, 0x1);
    IFTA90_E2T_03_HASH_CONTROLm_HASH_TABLE_BANK_CONFIG_LANE0f_SET(ifta90_e2t_03_hash_control, 0x1);
    IFTA90_E2T_00_HASH_CONTROLm_HASH_TABLE_BANK_CONFIG_LANE1f_SET(ifta90_e2t_00_hash_control, 0x2);
    IFTA90_E2T_01_HASH_CONTROLm_HASH_TABLE_BANK_CONFIG_LANE1f_SET(ifta90_e2t_01_hash_control, 0x2);
    IFTA90_E2T_02_HASH_CONTROLm_HASH_TABLE_BANK_CONFIG_LANE1f_SET(ifta90_e2t_02_hash_control, 0x2);
    IFTA90_E2T_03_HASH_CONTROLm_HASH_TABLE_BANK_CONFIG_LANE1f_SET(ifta90_e2t_03_hash_control, 0x2);

    /* HASH_CONTROL DUP_SBUS_WRITE_TO_ALL_BANKS. */
    IFTA90_E2T_00_HASH_CONTROLm_DUP_SBUS_WRITE_TO_ALL_BANKSf_SET(ifta90_e2t_00_hash_control, 0x1);
    IFTA90_E2T_01_HASH_CONTROLm_DUP_SBUS_WRITE_TO_ALL_BANKSf_SET(ifta90_e2t_01_hash_control, 0x1);
    IFTA90_E2T_02_HASH_CONTROLm_DUP_SBUS_WRITE_TO_ALL_BANKSf_SET(ifta90_e2t_02_hash_control, 0x1);
    IFTA90_E2T_03_HASH_CONTROLm_DUP_SBUS_WRITE_TO_ALL_BANKSf_SET(ifta90_e2t_03_hash_control, 0x1);
    ...
    ioerr += WRITE_IFTA90_E2T_02_HASH_CONTROLm(unit, 0, ifta90_e2t_02_hash_control);
    ioerr += WRITE_IFTA90_E2T_03_HASH_CONTROLm(unit, 0, ifta90_e2t_03_hash_control);
    ...
    IFTA90_E2T_02_SHARED_BANKS_CONTROLm_CLR(ifta90_02_sb_ctrl);
    IFTA90_E2T_03_SHARED_BANKS_CONTROLm_CLR(ifta90_03_sb_ctrl);
    ...
    IFTA90_E2T_02_SHARED_BANKS_CONTROLm_B0_HASH_OFFSETf_SET(ifta90_02_sb_ctrl, 0x6);
    IFTA90_E2T_03_SHARED_BANKS_CONTROLm_B0_HASH_OFFSETf_SET(ifta90_03_sb_ctrl, 0x6);
    ...
    IFTA90_E2T_02_SHARED_BANKS_CONTROLm_B1_HASH_OFFSETf_SET(ifta90_02_sb_ctrl, 0xC);
    IFTA90_E2T_03_SHARED_BANKS_CONTROLm_B1_HASH_OFFSETf_SET(ifta90_03_sb_ctrl, 0xC);
    ...
    ioerr += WRITE_IFTA90_E2T_02_SHARED_BANKS_CONTROLm(unit, 0, ifta90_02_sb_ctrl);
    ioerr += WRITE_IFTA90_E2T_03_SHARED_BANKS_CONTROLm(unit, 0, ifta90_03_sb_ctrl);

    return ioerr;
}

static int
alpm_level3_init(int unit)
{
    int ioerr = 0;
    ...
    IFTA90_E2T_02_SHARED_BANKS_CONTROLm_BANK_BYPASS_LPf_SET(ifta90_02_sb_ctrl, 0x3);
    IFTA90_E2T_03_SHARED_BANKS_CONTROLm_BANK_BYPASS_LPf_SET(ifta90_03_sb_ctrl, 0x3);
...
static int
bcm56880_a0_mem_address_adjust(int unit, bcmdrd_sid_t sid,
                               ...
                               bcma_testutil_pt_type_t type)
{
    ...
    case IFTA90_E2T_02_B0_LPm:
    case IFTA90_E2T_02_B1_LPm:
    case IFTA90_E2T_03_B0_LPm:
    case IFTA90_E2T_03_B1_LPm:
        *index_end =
            bcmdrd_chip_mem_maxidx(bcmdrd_dev_chip_info_get(unit), sid, *index_end);
        break;
...
static int
bcm56880_a0_cmc_chan_get(int unit, int *cmc_num, int *cmc_chan_num)
{
    if (cmc_num != NULL) {
        *cmc_num = CMC_NUM;
    }
...
static int
bcm56880_a0_chip_blktype_get(int unit, const char *blktype_name,
                             int *blktype_id)
{
    int count = COUNTOF(bcm56880_a0_blktype_name_id_map), block;

    block = bcma_testutil_name2id(bcm56880_a0_blktype_name_id_map,
                                  count, blktype_name);
...
static const bcmdrd_sid_t bcm56880_a0_becchmark_reg[] = {
    ING_DOP_CTRL_0_64r, /* socreg */
    CMIC_RPE_PKT_VLANr  /* cmicreg */
};

static const bcmdrd_sid_t bcm56880_a0_becchmark_mem[] = {
    /* not support lookup/insert/delete in PT, so skip hash type memory */
    IPARSER2_HME_INIT_PROFILEm, /* index */
    EDIT_CTRL_TCAM_0_A_ONLYm    /* tcam */
};

static int
bcm56880_a0_benchmark_reglist_get(int unit, const bcmdrd_sid_t **reg_arr,
                                  int *reg_cnt)
{
    SHR_FUNC_ENTER(unit);
    ...
    *reg_arr = bcm56880_a0_becchmark_reg;
    *reg_cnt = COUNTOF(bcm56880_a0_becchmark_reg);
...
static int
bcm56880_a0_benchmark_memlist_get(int unit, const bcmdrd_sid_t **mem_arr,
                                  int *mem_cnt)
{
    SHR_FUNC_ENTER(unit);
    ...
    *mem_arr = bcm56880_a0_becchmark_mem;
    *mem_cnt = COUNTOF(bcm56880_a0_becchmark_mem);
...
static int
bcm56880_a0_mem_cambist_info(int unit, bcmdrd_sid_t sid, bool *is_bist,
                             bcma_testutil_mem_cambist_entry_t *info)
{
#define CAMBIST_STATUS_EXPECTED (0x7)
...
bcma_testutil_drv_power_op_t bcm56880_a0_power_op = {
    .power_help         = bcm56880_a0_power_help,
    .power_init         = bcm56880_a0_power_init,
    .power_port_set     = bcm56880_a0_power_port_set,
    .power_config_set   = bcm56880_a0_power_config_set,
    .power_txrx         = bcm56880_a0_power_txrx
};

static int
bcm56880_a0_mem_mbist_preconfig(int unit)
{
    SHR_FUNC_ENTER(unit);

    /* Stop M0 FW */
    SHR_IF_ERR_EXIT
        (bcmbd_cmicx_m0ssq_fw_led_cleanup(unit, 0));

    SHR_IF_ERR_EXIT
        (bcmbd_cmicx_m0ssq_fw_linkscan_cleanup(unit, 0));
...
int
bcm56880_a0_testutil_drv_attach(int unit)
{
    ...
    testutil_drv->pt_skip = bcm56880_a0_pt_skip;
    testutil_drv->pt_hw_update = bcm56880_a0_pt_hw_update;
    testutil_drv->pt_mask_override = bcm56880_a0_pt_mask_override;
    testutil_drv->pt_entity_override = bcm56880_a0_pt_entity_override;
    testutil_drv->mem_address_adjust = bcm56880_a0_mem_address_adjust;
    ...
    testutil_drv->mem_mbist_preconfig= bcm56880_a0_mem_mbist_preconfig;
    testutil_drv->mem_mbist_info = bcm56880_a0_mem_mbist_info;
    testutil_drv->mem_mbist_dma_info = bcm56880_a0_mem_mbist_dma_info;
    testutil_drv->cmc_chan_get = bcm56880_a0_cmc_chan_get;
    testutil_drv->benchmark_reglist_get = bcm56880_a0_benchmark_reglist_get;
    testutil_drv->benchmark_memlist_get = bcm56880_a0_benchmark_memlist_get;
    testutil_drv->mem_cambist_info= bcm56880_a0_mem_cambist_info;
    ...
    testutil_drv->chip_blktype_get = bcm56880_a0_chip_blktype_get;
    testutil_drv->check_health = bcm56880_a0_check_health;
    testutil_drv->pkt_cfg_data_get = bcm56880_a0_pkt_cfg_data_get;
    testutil_drv->flex_lt_op_get = bcma_testutil_xfs_flex_lt_op_get;
    testutil_drv->flex_traffic_op_get = bcm56880_a0_flex_traffic_op_get;
    testutil_drv->traffic_expeceted_rate_get = bcm56880_a0_traffic_get_expeceted_rate;
    testutil_drv->traffic_fixed_packet_list_get = bcm56880_a0_traffic_get_fixed_packet_list;
    testutil_drv->traffic_random_packet_list_get = bcm56880_a0_traffic_get_random_packet_list;
    testutil_drv->traffic_worstcase_pktlen_get = bcm56880_a0_traffic_get_worstcase_pktlen;
    testutil_drv->power_op_get = &bcm56880_a0_power_op;
