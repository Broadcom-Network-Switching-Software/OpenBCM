/*! \file bcm56996_a0_testutil_drv.c
 *
...
#define UFT_BANK_ENTRIES (32 * 1024)
#define MPLS_BANK_ENTRIES (4 * 1024)
#define L3_TUNNEL_BANK_ENTRIES (4 * 1024)
#define EGR_ADAPT_BANK_ENTRIES (8 * 1024)

#define CDMIB_MEM_FMT "MIB_MEMORY_ROW"

static bcmdrd_sid_t bcm56996_a0_reg_reset_skip_pt[] = {
...
static bcmdrd_sid_t bcm56996_a0_reg_wr_skip_pt[] = {
    /* These registers should be added NOTEST flag. */
    AVS_TMON_SPARE_0r,
...
static bcmdrd_sid_t bcm56996_a0_mem_skip_pt[] = {
...
static bcmdrd_sid_t bcm56996_a0_mem_reset_skip_pt[] = {
...
static shr_enum_map_t bcm56996_a0_blktype_name_id_map[] = {
    {"avs", BLKTYPE_AVS},
...
static bcmdrd_sid_t bcm56996_a0_tr144_skip_pt_list[] = {
...
static bcmdrd_sid_t bcm56996_a0_tr901_skip_pt_list[] = {
    MPLS_ENTRY_DOUBLEm
};

static bcmdrd_sid_t bcm56996_a0_tr901_hc_skip_pt_list[] = {
    MPLS_ENTRY_DOUBLEm,
    L2_ENTRY_UFT_SINGLEm,
    L2_ENTRY_UFT_ECCm,
    EGR_VFI_MEMBERSHIPm,
    EGR_VFI_MEMBERSHIP_2m,
    VFI_MEMBERSHIP_PROFILE_TABm,
    STG_TAB_Am,
    STG_TAB_Bm,
    EGR_VFI_STG_Am,
    EGR_VFI_STG_Bm
...
static const bcma_testutil_pkt_lt_cfg_t bcm56996_a0_pkt_traffic_lt_cfg[] = {
    ...
    {"VFI_STG", {{"VFI_STG_ID", 1}, {"STATE", 0, "FORWARD", 3, 1}}, BCMLT_OPCODE_INSERT},
    {"VFI_STG", {{"VFI_STG_ID", 1}, {"STATE", 0, "FORWARD", 37, 36}}, BCMLT_OPCODE_UPDATE},
    ...
    {"VFI_ING_EGR_MEMBER_PORTS_PROFILE",
     {{"VFI_ING_EGR_MEMBER_PORTS_PROFILE_ID", 1},{"EGR_MEMBER_PORTS", 1, NULL, 3, 1}},
     BCMLT_OPCODE_INSERT},
    {"VFI_ING_EGR_MEMBER_PORTS_PROFILE",
     {{"VFI_ING_EGR_MEMBER_PORTS_PROFILE_ID", 1},{"EGR_MEMBER_PORTS", 1, NULL, 37, 36}},
     BCMLT_OPCODE_UPDATE},
    {"VFI_ING_MEMBER_PORTS_PROFILE",
     {{"VFI_ING_MEMBER_PORTS_PROFILE_ID", 1},{"MEMBER_PORTS", 1, NULL, 3, 1}},
     BCMLT_OPCODE_INSERT},
    {"VFI_ING_MEMBER_PORTS_PROFILE",
     {{"VFI_ING_MEMBER_PORTS_PROFILE_ID", 1},{"MEMBER_PORTS", 1, NULL, 37, 36}},
     BCMLT_OPCODE_UPDATE},
    {"VFI_EGR_MEMBER_PORTS_PROFILE",
     {{"VFI_EGR_MEMBER_PORTS_PROFILE_ID", 1},{"MEMBER_PORTS", 1, NULL, 3, 1}},
     BCMLT_OPCODE_INSERT},
    {"VFI_EGR_MEMBER_PORTS_PROFILE",
     {{"VFI_EGR_MEMBER_PORTS_PROFILE_ID", 1},{"MEMBER_PORTS", 1, NULL, 37, 36}},
     BCMLT_OPCODE_UPDATE},
    ...
    {"VFI_EGR_UNTAGGED_MEMBER_PORTS_PROFILE",
     ...
     BCMLT_OPCODE_UPDATE},
    {"VFI",
     {{"VFI_ID", 2}, {"VFI_STG_ID", 1}, {"VFI_ING_EGR_MEMBER_PORTS_PROFILE_ID", 1}},
     BCMLT_OPCODE_INSERT},
    {"PORT",
    ...
    {"PORT",
     ...
     BCMLT_OPCODE_INSERT},
    {"L2_VFI_FDB_STATIC",
     {{"VFI_ID", 2}, {"VFI_ID_MASK", 0xfff}, {"MAC_ADDR", 0x000000BBBBBB},
      {"MAC_ADDR_MASK", 0xFFFFFFFFFFFF}, {"MODPORT", 36}, {"COPY_TO_CPU", 1}},
     BCMLT_OPCODE_INSERT},
};

static uint8_t bcm56996_a0_pkt_raw_data[] = {
...
static uint32_t bcm56996_a0_tx_pmd[][3] = {
    {0x81000000, 0x1, 0x4000}
};

bcmdrd_ser_rmr_id_t bcm56996_a0_bb_skip_pt[8] = {0};

static const bcma_testutil_pkt_data_t bcm56996_a0_pkt_data = {
    bcm56996_a0_tx_pmd,
    sizeof(bcm56996_a0_tx_pmd),
    NULL, 0, NULL, 0,
    bcm56996_a0_pkt_raw_data,
    sizeof(bcm56996_a0_pkt_raw_data)
};

static const uint32_t default_all_zero[BCMDRD_MAX_PT_WSIZE] = {0x0};

static bool
bcm56996_a0_pt_skip(int unit, bcmdrd_sid_t sid, bcma_testutil_pt_type_t type)
{
    ...
    bool emul;
    const char *pt_name;
    uint32_t ipep_valid_pipes = 0;

    switch (type) {
    case BCMA_TESTUTIL_PT_REG_RESET:
        skip_pt = bcm56996_a0_reg_reset_skip_pt;
        count = COUNTOF(bcm56996_a0_reg_reset_skip_pt);
        break;

    case BCMA_TESTUTIL_PT_REG_RD_WR:
        skip_pt = bcm56996_a0_reg_wr_skip_pt;
        count = COUNTOF(bcm56996_a0_reg_wr_skip_pt);
        break;
    ...
    case BCMA_TESTUTIL_PT_MEM_DMA_RD_WR:
        ...
        case BLKTYPE_PFC_COLLECTOR:
            skip_pt = bcm56996_a0_mem_skip_pt;
            count = COUNTOF(bcm56996_a0_mem_skip_pt);
            break;
        default:
            return TRUE;
        }
    ...
    case BCMA_TESTUTIL_PT_MEM_RESET:
        ...
        case BLKTYPE_MGMT_OBM:
        case BLKTYPE_PFC_COLLECTOR:
            skip_pt = bcm56996_a0_mem_reset_skip_pt;
            count = COUNTOF(bcm56996_a0_mem_reset_skip_pt);
            break;
        default:
            return TRUE;
        }
    ...
    case BCMA_TESTUTIL_PT_MEM_TR_144:
        skip_pt = bcm56996_a0_tr144_skip_pt_list;
        count = COUNTOF(bcm56996_a0_tr144_skip_pt_list);
        break;
    case BCMA_TESTUTIL_PT_MEM_TR_143:
        bcmdrd_pt_ser_name_to_rmr(unit, "EGR_DII_EVENT_FIFO_0", &bcm56996_a0_bb_skip_pt[0]);
        bcmdrd_pt_ser_name_to_rmr(unit, "EGR_DII_EVENT_FIFO_1", &bcm56996_a0_bb_skip_pt[1]);
        bcmdrd_pt_ser_name_to_rmr(unit, "EGR_DII_EVENT_FIFO_2", &bcm56996_a0_bb_skip_pt[2]);
        bcmdrd_pt_ser_name_to_rmr(unit, "EGR_DII_EVENT_FIFO_3", &bcm56996_a0_bb_skip_pt[3]);
        bcmdrd_pt_ser_name_to_rmr(unit, "ING_DII_EVENT_FIFO_0", &bcm56996_a0_bb_skip_pt[4]);
        bcmdrd_pt_ser_name_to_rmr(unit, "ING_DII_EVENT_FIFO_1", &bcm56996_a0_bb_skip_pt[5]);
        bcmdrd_pt_ser_name_to_rmr(unit, "ING_DII_EVENT_FIFO_2", &bcm56996_a0_bb_skip_pt[6]);
        bcmdrd_pt_ser_name_to_rmr(unit, "ING_DII_EVENT_FIFO_3", &bcm56996_a0_bb_skip_pt[7]);
        skip_pt = bcm56996_a0_bb_skip_pt;
        count = COUNTOF(bcm56996_a0_bb_skip_pt);
        break;
    case BCMA_TESTUTIL_PT_MEM_TR_901:
        ...
        if (ipep_valid_pipes < 0xf) {
            skip_pt = bcm56996_a0_tr901_hc_skip_pt_list;
            count = COUNTOF(bcm56996_a0_tr901_hc_skip_pt_list);
        } else {
            skip_pt = bcm56996_a0_tr901_skip_pt_list;
            count = COUNTOF(bcm56996_a0_tr901_skip_pt_list);
        }
        break;
...
static void
bcm56996_a0_pkt_cfg_data_get(int unit, const bcma_testutil_pkt_lt_cfg_t **pkt_lt_cfg,
                             int *lt_cfg_num,
                             const bcma_testutil_pkt_data_t **pkt_data)
{
    *lt_cfg_num = COUNTOF(bcm56996_a0_pkt_traffic_lt_cfg);
    *pkt_lt_cfg = bcm56996_a0_pkt_traffic_lt_cfg;

    *pkt_data = &bcm56996_a0_pkt_data;
}
...
static int
bcm56996_a0_pt_hw_update(int unit, const char *name,
 ...
 */
static int
uft_entries_calculate(int unit, int *l2_entries, int *l2_uft_entries,
                      int *egr_adapt_entries, int *em_entries,
                      int *mpls_entries, int *l3tnl_entries)
{
    bcmdrd_sid_t sid;
    int banks;
    ...
    /* bit[1:0] is for L2 Dedicated bank, bit[2:5] is for UFT Banks. */
    *l2_entries = L2_BANK_ENTRIES * (banks & 0x3);
    *l2_uft_entries = UFT_BANK_ENTRIES * ((banks >> 2) & 0xf);

    sid = EXACT_MATCH_HASH_CONTROLm;
    banks = uft_bank_num_get(unit, sid);
    *em_entries = UFT_BANK_ENTRIES * banks;
...
uft_init(int unit, bcmdrd_sid_t sid)
{
    ...
    case L2_ENTRY_ECCm:
    case L2_ENTRY_UFT_SINGLEm:
    case L2_ENTRY_UFT_ECCm:
...
static int
bcm56996_a0_mem_address_adjust(int unit, bcmdrd_sid_t sid,
                               int *index_start, int *index_end,
                               bcma_testutil_pt_type_t type)
{
    static int inited = 0;
    static int l2_entries = 0;
    static int l2_uft_entries = 0;
    ...
    if (!inited) {
        SHR_IF_ERR_EXIT
            (uft_entries_calculate(unit, &l2_entries, &l2_uft_entries,
                                   &egr_adapt_entries, &em_entries,
                                   &mpls_entries, &l3tnl_entries));
        inited = 1;
    }
...
static int
bcm56996_a0_cmc_chan_get(int unit, int *cmc_num, int *cmc_chan_num)
{
    if (cmc_num != NULL) {
        *cmc_num = CMC_NUM;
    }
...
static int
bcm56996_a0_chip_blktype_get(int unit, const char *blktype_name,
                             int *blktype_id)
{
    int count = COUNTOF(bcm56996_a0_blktype_name_id_map), block;

    block = bcma_testutil_name2id(bcm56996_a0_blktype_name_id_map,
                                  count, blktype_name);
...
static int
bcm56996_a0_mem_hash_data_adjust(int unit, bcmdrd_sid_t sid,
                      ...
                      int wsize)
{
    ...
    for (fid_idx = 0; fid_idx < num_fid; fid_idx++) {
        ...
        /* ALLOWED_PORT_BITMAP_PROFILEm and VFI_MEMBERSHIP_PROFILE_TABm */
...
static int
bcm56996_a0_pt_mask_override(int unit, bcmdrd_sid_t sid, int index,
                             uint32_t *mask, int wsize)
{
    ...
    case VFI_MEMBERSHIP_PROFILE_TABm:
    case EGR_VFI_MEMBERSHIPm:
    case EGR_VFI_MEMBERSHIP_2m:
    case EGR_VFI_STG_Am:
    case STG_TAB_Am:
    case EGR_VFI_STG_Bm:
    case STG_TAB_Bm:
...
static int
bcm56996_a0_mem_range_write(int unit, bcmdrd_sid_t sid, int index_start,
...
static int
bcm56996_a0_mem_range_read(int unit, bcmdrd_sid_t sid, int index_start,
                           int index_end, int tbl_inst, uint64_t buf)
{
    bool psim = bcmdrd_feature_enabled(unit, BCMDRD_FT_PASSIVE_SIM);
    bool asim = bcmdrd_feature_enabled(unit, BCMDRD_FT_ACTIVE_SIM);
...
static const bcmdrd_sid_t bcm56996_a0_becchmark_reg[] = {
    VFI_CTRLr,         /* socreg */
    CMIC_RPE_PKT_CTRLr /* cmicreg */
};

static const bcmdrd_sid_t bcm56996_a0_becchmark_mem[] = {
    EGR_VFIm,         /* index */
...
static int
bcm56996_a0_benchmark_reglist_get(int unit, const bcmdrd_sid_t **reg_arr,
                                  int *reg_cnt)
{
    SHR_FUNC_ENTER(unit);
    ...
    *reg_arr = bcm56996_a0_becchmark_reg;
    *reg_cnt = COUNTOF(bcm56996_a0_becchmark_reg);
...
static int
bcm56996_a0_benchmark_memlist_get(int unit, const bcmdrd_sid_t **mem_arr,
                                  int *mem_cnt)
{
    SHR_FUNC_ENTER(unit);
    ...
    *mem_arr = bcm56996_a0_becchmark_mem;
    *mem_cnt = COUNTOF(bcm56996_a0_becchmark_mem);
...
static int
bcm56996_a0_mem_cambist_info(int unit, bcmdrd_sid_t sid, bool *is_bist,
...
#define CAMBIST_STATUS_EXPECTED (0x1f)
    ...
    *is_bist = false;
    ...
    for (i = 0; i < fields_num; i++) {
        ...
        /*
         * For TH4G, there should be only one enable/reset/mode field
         * in the register
         */
        if (sal_strstr(finfo.name, "BIST_EN") != NULL) {
            ...
            } else if (sal_strstr(control_name, "L3_DEFIP_NEW_CAM")) {
...
static int
bcm56996_a0_pt_entity_override(int unit, bcmdrd_sid_t sid,
                               bcmbd_pt_dyn_info_t *dyn_info,
...
bcm56996_a0_pt_default_value_get(int unit, bcmdrd_sid_t sid)
{
    /*
...
bcma_testutil_drv_power_op_t bcm56996_a0_power_op = {
    .power_help         = bcm56996_a0_power_help,
    .power_init         = bcm56996_a0_power_init,
    .power_port_set     = bcm56996_a0_power_port_set,
    .power_config_set   = bcm56996_a0_power_config_set,
    .power_txrx         = bcm56996_a0_power_txrx
};

int
bcm56996_a0_testutil_drv_attach(int unit)
{
    ...
    testutil_drv->pt_skip = bcm56996_a0_pt_skip;
    testutil_drv->pt_hw_update = bcm56996_a0_pt_hw_update;
    testutil_drv->mem_address_adjust = bcm56996_a0_mem_address_adjust;
    testutil_drv->mem_hash_data_adjust = bcm56996_a0_mem_hash_data_adjust;
    testutil_drv->mem_range_write = bcm56996_a0_mem_range_write;
    testutil_drv->mem_range_read = bcm56996_a0_mem_range_read;
    testutil_drv->mem_mbist_info = NULL;
    testutil_drv->mem_mbist_dma_info = NULL;
    testutil_drv->cmc_chan_get = bcm56996_a0_cmc_chan_get;
    testutil_drv->benchmark_reglist_get = bcm56996_a0_benchmark_reglist_get;
    testutil_drv->benchmark_memlist_get = bcm56996_a0_benchmark_memlist_get;
    testutil_drv->mem_cambist_info = bcm56996_a0_mem_cambist_info;
    testutil_drv->vlan_op_get = bcma_testutil_xgs_vfi_op_get;
    testutil_drv->l2_op_get = bcma_testutil_xgs_vfi_l2_op_get;
    ...
    testutil_drv->traffic_expeceted_rate_get = bcm56996_a0_traffic_get_expeceted_rate;
    testutil_drv->traffic_fixed_packet_list_get = bcm56996_a0_traffic_get_fixed_packet_list;
    testutil_drv->traffic_random_packet_list_get = bcm56996_a0_traffic_get_random_packet_list;
    testutil_drv->traffic_worstcase_pktlen_get = bcm56996_a0_traffic_get_worstcase_pktlen;
    testutil_drv->power_op_get = &bcm56996_a0_power_op;
    testutil_drv->traffic_default_pktcnt = 1200;
    testutil_drv->chip_blktype_get = bcm56996_a0_chip_blktype_get;
    testutil_drv->pkt_cfg_data_get = bcm56996_a0_pkt_cfg_data_get;
    testutil_drv->pt_mask_override = bcm56996_a0_pt_mask_override;
    testutil_drv->pt_entity_override = bcm56996_a0_pt_entity_override;
    testutil_drv->pt_write = bcm56996_a0_pt_write;
    testutil_drv->pt_read = bcmbd_pt_read;
    testutil_drv->qos_lt_op_get = bcma_testutil_xgs_qos_lt_op_get;
    testutil_drv->check_health = bcm56996_a0_check_health;
    testutil_drv->pt_default_value_get = bcm56996_a0_pt_default_value_get;
