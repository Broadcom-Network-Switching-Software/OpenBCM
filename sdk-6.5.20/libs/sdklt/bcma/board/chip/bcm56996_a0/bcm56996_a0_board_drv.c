...
static int
bcm56996_a0_board_avs_voltage_set(int unit, uint32_t otp_voltage_val)
{
    char *regulator_name;
    int rv = SHR_E_NONE;
    double voltage;
...
static int
bcm56996_a0_board_avs_configure(int unit)
{
    uint32_t voltage = 0;
    shr_pb_t *pb;
    ...
    if (avs_initialized == FALSE) {
        ...
        SHR_IF_ERR_EXIT
            (bcm56996_a0_board_avs_voltage_set(unit, voltage));
...
static int
bcm56996_a0_board_init(int unit)
{
    ...
    SHR_IF_ERR_EXIT
        (bcm56996_a0_board_avs_configure(unit));

exit:
    SHR_FUNC_EXIT();
}

static bcma_board_drv_t bcm56996_a0_board_drv = {
    .board_init = bcm56996_a0_board_init
};

bcma_board_drv_t *
bcm56996_a0_board_drv_get(int unit)
{
    return &bcm56996_a0_board_drv;
}
