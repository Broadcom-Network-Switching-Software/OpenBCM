/*! \file bcma_bcmbdcmd_cmicd_lookup.h
 *
 * CLI 'lookup' command for CMICd
 */
/*
...
#ifndef BCMA_BCMBDCMD_CMICD_LOOKUP_H
#define BCMA_BCMBDCMD_CMICD_LOOKUP_H

#include <bcma/cli/bcma_cli.h>

/*! Brief description for CLI command. */
#define BCMA_BCMBDCMD_CMICD_LOOKUP_DESC \
    "Lookup chip hash table entry."

/*! Syntax for CLI command. */
#define BCMA_BCMBDCMD_CMICD_LOOKUP_SYNOP \
    "[raw] [cf] <expr> <value> ... | <field>=<value> ... | all=<value>"

/*! Help for CLI command. */
#define BCMA_BCMBDCMD_CMICD_LOOKUP_HELP \
...
#define BCMA_BCMBDCMD_CMICD_LOOKUP_EXAMPLES \
    "L2Xm L2:VLAN_ID=2 L2:MAC_ADDR=0x010203040506"

/*!
 * \brief CLI 'lookup' command implementation for CMICd.
 *
 ...
 */
extern int
bcma_bcmbdcmd_cmicd_lookup(bcma_cli_t *cli, bcma_cli_args_t *args);

#endif /* BCMA_BCMBDCMD_CMICD_LOOKUP_H */
