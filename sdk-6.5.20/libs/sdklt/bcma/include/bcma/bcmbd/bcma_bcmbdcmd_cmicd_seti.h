/*! \file bcma_bcmbdcmd_cmicd_seti.h
 *
...
#ifndef BCMA_BCMBDCMD_CMICD_SETI_H
#define BCMA_BCMBDCMD_CMICD_SETI_H

#include <bcma/cli/bcma_cli.h>

/*! Brief description for CLI command. */
#define BCMA_BCMBDCMD_CMICD_SETI_DESC \
    "Modify chip register/memory contents (raw)."

/*! Syntax for CLI command. */
#define BCMA_BCMBDCMD_CMICD_SETI_SYNOP \
    "<access-type> <addr> <value>[:<value2>[:<value3> ... ]] [<size>]"

/*! Help for CLI command. */
#define BCMA_BCMBDCMD_CMICD_SETI_HELP \
...
#define BCMA_BCMBDCMD_CMICD_SETI_EXAMPLES \
    "mem 0x01900002 0x4\n" \
    "mem 0x06700000 0x112233:0x44550000:0x8 3"

/*!
 * \brief CLI 'seti' command implementation for CMICd.
 *
...
#endif /* BCMA_BCMBDCMD_CMICD_SETI_H */
