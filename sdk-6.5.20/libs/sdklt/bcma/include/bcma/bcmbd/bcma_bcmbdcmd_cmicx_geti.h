/*! \file bcma_bcmbdcmd_cmicx_geti.h
 *
...
#ifndef BCMA_BCMBDCMD_CMICX_GETI_H
#define BCMA_BCMBDCMD_CMICX_GETI_H

#include <bcma/cli/bcma_cli.h>

/*! Brief description for CLI command. */
#define BCMA_BCMBDCMD_CMICX_GETI_DESC \
    "Get chip register/memory contents (raw)."

/*! Syntax for CLI command. */
#define BCMA_BCMBDCMD_CMICX_GETI_SYNOP \
    "<access-type> <address> [<size>]"

/*! Help for CLI command. */
#define BCMA_BCMBDCMD_CMICX_GETI_HELP \
...
/*!
 * \brief CLI 'geti' command implementation for CMICx.
 *
...
#endif /* BCMA_BCMBDCMD_CMICX_GETI_H */
