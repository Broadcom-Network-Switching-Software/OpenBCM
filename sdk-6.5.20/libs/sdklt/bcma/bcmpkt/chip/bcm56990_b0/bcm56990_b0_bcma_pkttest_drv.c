/*! \file bcm56990_b0_bcma_pkttest_drv.c
 *
...
static bcma_bcmpkt_test_drv_t bcm56990_b0_pkttest_drv = {
...
int
bcma_bcmpkt_test_bcm56990_b0_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_EXIT
        (bcma_bcmpkt_test_drv_set(unit, &bcm56990_b0_pkttest_drv));
