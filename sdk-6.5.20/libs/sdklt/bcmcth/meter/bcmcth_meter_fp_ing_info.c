/*! \file bcmcth_meter_fp_ing_info.c
 *
 * This file contains IFP Meter device info handler functions.
 */
/*
...
static int
meter_fp_ing_device_info(int unit,
                         ...
                         const bcmltd_generic_arg_t *arg)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmlrd_field_count_get(unit, METER_ING_FP_DEVICE_INFOt, &num_fid));
    ...
    for (idx = 0; idx < count; idx++) {
        ...
        switch (fid) {
        case METER_ING_FP_DEVICE_INFOt_NUM_METER_POOLSf:
            foutlist[idx].data = attr->num_pools;
            break;
        case METER_ING_FP_DEVICE_INFOt_NUM_METERS_PER_POOLf:
            foutlist[idx].data = attr->num_meters_per_pool;
            break;
        case METER_ING_FP_DEVICE_INFOt_NUM_METERS_PER_PIPEf:
            foutlist[idx].data = attr->num_meters_per_pipe;
            break;
        case METER_ING_FP_DEVICE_INFOt_NUM_METERSf:
            ...
            break;
        case METER_ING_FP_DEVICE_INFOt_NUM_METERS_IN_USEf:
            foutlist[idx].data = entries_in_use;
            break;
        case METER_ING_FP_DEVICE_INFOt_NUM_GRANULARITYf:
...
static int
meter_fp_ing_gran_info(int unit,
                       const bcmltd_op_arg_t *op_arg,
                       uint32_t gran,
                       bcmltd_fields_t *out,
                       const bcmltd_generic_arg_t *arg)
{
    ...
    for (i = 0; i < count; i++) {
        ...
        foutlist[i].id = fid;
        switch (i) {
        case METER_ING_FP_GRANULARITY_INFOt_METER_ING_FP_GRANULARITY_INFO_IDf:
            foutlist[i].data = gran;
            break;
        case METER_ING_FP_GRANULARITY_INFOt_MIN_RATE_KBPSf:
            foutlist[i].data = gran_info_bytes[gran].min_rate;
            break;
        case METER_ING_FP_GRANULARITY_INFOt_MAX_RATE_KBPSf:
            foutlist[i].data = gran_info_bytes[gran].max_rate;
            break;
        case METER_ING_FP_GRANULARITY_INFOt_MIN_BURST_KBITSf:
            foutlist[i].data = (gran_info_bytes[gran].min_burst / 1000);
            if (foutlist[i].data == 0) {
                foutlist[i].data = 1;
            }
            break;
        case METER_ING_FP_GRANULARITY_INFOt_MAX_BURST_KBITSf:
            max_burst = ((gran_info_bytes[gran].min_burst *
                          attr->max_bucket_size) / 1000);
            foutlist[i].data = max_burst;
            break;
        case METER_ING_FP_GRANULARITY_INFOt_MIN_RATE_PPSf:
            foutlist[i].data = gran_info_pkts[gran].min_rate;
            break;
        case METER_ING_FP_GRANULARITY_INFOt_MAX_RATE_PPSf:
            foutlist[i].data = gran_info_pkts[gran].max_rate;
            break;
        case METER_ING_FP_GRANULARITY_INFOt_MIN_BURST_PKTSf:
            foutlist[i].data = (gran_info_pkts[gran].min_burst / 1000);
            if (foutlist[i].data == 0) {
                foutlist[i].data = 1;
            }
            break;
        case METER_ING_FP_GRANULARITY_INFOt_MAX_BURST_PKTSf:
...
int
bcmcth_meter_fp_ing_info_validate(int unit,
...
int
bcmcth_meter_fp_ing_info_insert(int unit,
                                const bcmltd_op_arg_t *op_arg,
                                const bcmltd_fields_t *in,
                                bcmltd_fields_t *out,
                                const bcmltd_generic_arg_t *arg)
...
int
bcmcth_meter_fp_ing_info_lookup(int unit,
                                const bcmltd_op_arg_t *op_arg,
                                const bcmltd_fields_t *in,
                                bcmltd_fields_t *out,
                                const bcmltd_generic_arg_t *arg)
{
    ...
    switch (sid) {
    case METER_ING_FP_DEVICE_INFOt:
        SHR_IF_ERR_VERBOSE_EXIT
            (meter_fp_ing_device_info(unit, op_arg, out, arg));
        break;
    case METER_ING_FP_GRANULARITY_INFOt:
        fid = METER_ING_FP_GRANULARITY_INFOt_METER_ING_FP_GRANULARITY_INFO_IDf;
        SHR_IF_ERR_VERBOSE_EXIT
            (bcmcth_meter_entry_field_value_get(unit, in, fid, &gran));
        SHR_IF_ERR_VERBOSE_EXIT
            (meter_fp_ing_gran_info(unit, op_arg, gran, out, arg));
        break;
    default:
        break;
    }
...
int
bcmcth_meter_fp_ing_info_delete(int unit,
                                const bcmltd_op_arg_t *op_arg,
                                const bcmltd_fields_t *in,
                                bcmltd_fields_t *out,
                                const bcmltd_generic_arg_t *arg)
...
int
bcmcth_meter_fp_ing_info_update(int unit,
                                const bcmltd_op_arg_t *op_arg,
                                const bcmltd_fields_t *in,
                                bcmltd_fields_t *out,
                                const bcmltd_generic_arg_t *arg)
...
int
bcmcth_meter_fp_ing_info_first(int unit,
                               const bcmltd_op_arg_t *op_arg,
                               const bcmltd_fields_t *in,
                               bcmltd_fields_t *out,
                               const bcmltd_generic_arg_t *arg)
...
int
bcmcth_meter_fp_ing_info_next(int unit,
                              const bcmltd_op_arg_t *op_arg,
                              const bcmltd_fields_t *in,
                              bcmltd_fields_t *out,
                              const bcmltd_generic_arg_t *arg)
