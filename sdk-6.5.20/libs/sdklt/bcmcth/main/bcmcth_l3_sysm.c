/*! \file bcmcth_l3_sysm.c
 *
 * Tunnel component interface to system manager.
 * This file implements the L3 interface to system manager.
 */
/*
 ...
 */
/*!
 * \brief Initializes L3 feature on this BCM unit.
 *
...
cth_l3_sysm_comp_config(shr_sysm_categories_t inst_cat,
                        int unit,
                        void *comp_data,
                        bool warm,
                        uint32_t *blocking_comp)
{
    ...
    if (SHR_FAILURE(bcmcth_l3_init(unit, warm))) {
...
/*!
 * \brief Shutsdown L3 feature on this BCM unit.
 *
 ...
 */
static shr_sysm_rv_t
cth_l3_sysm_shutdown(shr_sysm_categories_t inst_cat,
                     int unit,
                     void *comp_data,
                     bool graceful,
                     uint32_t *blocking_comp)
{
    if (SHR_FAILURE(bcmcth_l3_cleanup(unit))) {
        return SHR_SYSM_RV_ERROR;
    }
...
/*!
 * \brief BCMCTH L3 System manager init struct.
 */
static shr_sysm_cb_func_set_t cth_l3_sysm_handler = {

    /*! Component configuration. */
    .comp_config = cth_l3_sysm_comp_config,

    /*! Shutdown. */
    .shutdown    = cth_l3_sysm_shutdown
};
...
bcmcth_l3_start(void)
{
    ...
    SHR_IF_ERR_EXIT
        (shr_sysm_register(BCMMGMT_L3_COMP_ID,
                           SHR_SYSM_CAT_UNIT,
                           &cth_l3_sysm_handler,
                           NULL));
exit:
