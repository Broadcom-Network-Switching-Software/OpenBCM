/*! \file bcmcth_dlb_util.c
 *
 * DLB component data management.
 *
 * This file implements the DLB component data management.
 */
/*
 ...
 */
int
bcmcth_dlb_pt_dma_write(int unit, bcmcth_dlb_pt_op_info_t *op_info,
                        uint32_t *buf)
{
    SHR_FUNC_ENTER(unit);
 ...
 */
int
bcmcth_dlb_ireq_write(int unit, bcmltd_sid_t lt_id,
