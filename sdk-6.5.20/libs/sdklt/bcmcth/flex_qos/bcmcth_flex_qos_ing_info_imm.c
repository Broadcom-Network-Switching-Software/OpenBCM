/*! \file bcmcth_flex_qos_ing_info_imm.c
 *
 * FlexQoS interfaces to ingress IMM info table.
 */
/*
 ...
 */
static int
flex_qos_ing_info_tbl_cb(int unit,
                         bcmltd_sid_t sid,
...
static bcmimm_lt_cb_t flex_qos_ing_info_tbl_callback = {

    /*! Validate function. */
    .validate = flex_qos_ing_info_tbl_cb,
...
bcmcth_flex_qos_ing_info_imm_register(int unit, int table_id)
{
    ...
    /*
     * To register callback for Flex QoS LTs here.
     */
    ...
    if (SHR_SUCCESS(rv) && map) {
        SHR_IF_ERR_EXIT
            (bcmimm_lt_event_reg(unit,
                                 table_id,
                                 &flex_qos_ing_info_tbl_callback,
                                 NULL));
    }
