/*! \file bcm56780_a0_cth_meter_fp_egr_action_drv.c
 *
...
bcmcth_meter_action_drv_t *bcm56780_a0_cth_meter_egr_action_drv_get(int unit);

static int bcm56780_a0_meter_fp_egr_action_db_init(int unit)
{
    ...
    drv = bcm56780_a0_cth_meter_egr_action_drv_get(unit);
    if (drv == NULL) {
...
bcmcth_meter_action_pdd_pt_info_t bcm56780_a0_meter_fp_egr_action_pdd_pt_info = {
...
bcmcth_meter_action_sbr_pt_info_t bcm56780_a0_meter_fp_egr_action_sbr_pt_info = {
...
uint32_t bcm56780_a0_meter_fp_egr_action_table[] = {
    EFP_METER_COLOR_TABLE_0m,
};

bcmcth_meter_action_pt_info_t bcm56780_a0_meter_fp_egr_action_pt_info = {
    .pt_id = bcm56780_a0_meter_fp_egr_action_table,
    .pt_width = 40,
};

bcmcth_meter_action_drv_t bcm56780_a0_meter_fp_egr_action_drv = {
    .init = &bcm56780_a0_meter_fp_egr_action_db_init,
    .num_action_lts = 0,
    .pdd_lt_info = NULL,
    .pdd_pt_info = &bcm56780_a0_meter_fp_egr_action_pdd_pt_info,
    .sbr_lt_info = NULL,
    .sbr_pt_info = &bcm56780_a0_meter_fp_egr_action_sbr_pt_info,
    .action_lt_info = NULL,
    .action_pt_info = &bcm56780_a0_meter_fp_egr_action_pt_info,

};

bcmcth_meter_action_drv_t *
bcm56780_a0_cth_meter_egr_action_drv_get(int unit)
{
    return &bcm56780_a0_meter_fp_egr_action_drv;
}
