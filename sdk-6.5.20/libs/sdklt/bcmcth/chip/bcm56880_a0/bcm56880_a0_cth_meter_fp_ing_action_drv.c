/*! \file bcm56880_a0_cth_meter_fp_ing_action_drv.c
 *
...
#include "bcm56880_a0_cth_meter_fp_ing_action_tbls.h"
...
static int bcm56880_a0_meter_fp_ing_action_db_init(int unit)
{
    ...
    drv = bcm56880_a0_cth_meter_ing_action_drv_get(unit);
    if (drv == NULL) {
...
bcmcth_meter_action_pdd_pt_info_t bcm56880_a0_meter_fp_ing_action_pdd_pt_info = {
...
bcmcth_meter_action_sbr_pt_info_t bcm56880_a0_meter_fp_ing_action_sbr_pt_info = {
...
uint32_t bcm56880_a0_meter_fp_ing_action_table[] = {
...
bcmcth_meter_action_pt_info_t bcm56880_a0_meter_fp_ing_action_pt_info = {
    .pt_id = bcm56880_a0_meter_fp_ing_action_table,
    .pt_width = 40,
};

bcmcth_meter_action_drv_t bcm56880_a0_meter_fp_ing_action_drv = {
    .init = &bcm56880_a0_meter_fp_ing_action_db_init,
    .num_action_lts = 0,
    .pdd_lt_info = NULL,
    .pdd_pt_info = &bcm56880_a0_meter_fp_ing_action_pdd_pt_info,
    .sbr_lt_info = NULL,
    .sbr_pt_info = &bcm56880_a0_meter_fp_ing_action_sbr_pt_info,
    .action_lt_info = NULL,
    .action_pt_info = &bcm56880_a0_meter_fp_ing_action_pt_info,
};

bcmcth_meter_action_drv_t *
bcm56880_a0_cth_meter_ing_action_drv_get(int unit)
{
    return &bcm56880_a0_meter_fp_ing_action_drv;
}
