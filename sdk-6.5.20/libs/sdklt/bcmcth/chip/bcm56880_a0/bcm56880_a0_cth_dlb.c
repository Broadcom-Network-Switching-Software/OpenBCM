...
static int
bcm56880_a0_dlb_ecmp_port_member_set(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    int i;
...
static int
bcm56880_a0_dlb_ecmp_alternate_port_member_set(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    int i;
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t field_value = 0;
...
static int
bcm56880_a0_dlb_ecmp_port_bitmap_set(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    int i;
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t *buf_ptr = NULL;
...
static int
bcm56880_a0_flow_set_base_get(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
...
static int
bcm56880_a0_dlb_ecmp_flow_set_alloc(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    SHR_FUNC_ENTER(unit);

    if (lt_entry->flow_set_size != lt_entry->prev_flow_set_size) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56880_a0_flow_set_base_get(unit, lt_entry));
    }
...
static int
bcm56880_a0_dlb_ecmp_flow_set_init(int unit,
                                   ...
                                   bool flow_set_init)
{
    ...
    rv = bcm56880_a0_dlb_ecmp_flow_set_alloc(unit, lt_entry);
    if (rv != SHR_E_NONE) {
        if (cleared) {
...
static int
bcm56880_a0_dlb_ecmp_grp_ctrl_set(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t field_value = 0;
    uint32_t *buf_ptr = NULL;
...
static int
bcm56880_a0_dlb_ecmp_enable(int unit, bcmcth_dlb_ecmp_t *lt_entry, bool enable)
{
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t *buf_ptr = NULL;
...
static int
bcm56880_a0_dlb_ecmp_port_member_clr(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    int i;
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t *buf_ptr = NULL;
...
static int
bcm56880_a0_dlb_ecmp_alternate_port_member_clr(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    int i;
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t *buf_ptr = NULL;
...
static int
bcm56880_a0_dlb_ecmp_grp_ctrl_clr(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t *buf_ptr = NULL;
...
static int
bcm56880_a0_dlb_ecmp_port_bitmap_clr(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t *buf_ptr = NULL;
    DLB_ECMP_GROUP_MEMBERSHIPm_t group_membership_entry;
...
static int
bcm56880_a0_dlb_ecmp_flow_set_cleanup(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    int flow_set_base;
    int num_blocks;
...
static int
bcm56880_a0_dlb_ecmp_link_ctrl_set(int unit, bcmcth_dlb_ecmp_pctl_t *lt_entry)
{
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t *buf_ptr = NULL;
...
static int
bcm56880_a0_dlb_ecmp_link_ctrl_clr(int unit, bcmcth_dlb_ecmp_pctl_t *lt_entry)
{
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t *buf_ptr = NULL;
    DLB_ECMP_LINK_CONTROLm_t   link_ctrl_entry;
...
static int
bcm56880_a0_dlb_trunk_enable(int unit,
 ...
 */
static int
bcm56880_a0_dlb_trunk_port_bitmap_set(int unit,
 ...
 */
static int
bcm56880_a0_dlb_trunk_flow_set_base_get(int unit,
                                        bcmcth_dlb_trunk_blk_t *blk_ptr,
                                        bcmcth_dlb_trunk_t *dlb_trunk)
{
 ...
 */
static void
bcm56880_a0_dlb_trunk_flow_set_release(int unit,
                                      bcmcth_dlb_trunk_blk_t *blk_ptr,
                                      bcmcth_dlb_trunk_t *dlb_trunk,
                                      bool flow_set_init)
{
 ...
 */
static int
bcm56880_a0_dlb_trunk_flow_set_assign(int unit,
                                      bcmcth_dlb_trunk_blk_t *blk_ptr,
                                      bcmcth_dlb_trunk_t *dlb_trunk)
{
    int block_base_ptr;
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_dlb_trunk_flow_set_base_get(unit, blk_ptr, dlb_trunk));
 ...
 */
static int
bcm56880_a0_dlb_trunk_grp_ctrl_set(int unit,
                                   bcmcth_dlb_trunk_t *dlb_trunk)
{
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t field_value = 0;
 ...
 */
static int
bcm56880_a0_dlb_trunk_group_clear(int unit,
                                  bcmltd_sid_t sid,
                                  bcmcth_dlb_trunk_t *dlb_trunk)
{
    bcmcth_dlb_pt_op_info_t pt_op_info;
...
static void
bcm56880_a0_dlb_enable(int unit)
{
...
static int
bcm56880_a0_dlb_trunk_port_member_set(int unit, bcmcth_dlb_trunk_t *dlb_trunk)
{
    int i;
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t field_value = 0;
...
static int
bcm56880_a0_dlb_trunk_alternate_port_member_set(int unit, bcmcth_dlb_trunk_t *dlb_trunk)
{
    int i;
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t field_value = 0;
...
static int
bcm56880_a0_dlb_trunk_port_member_clr(int unit, bcmcth_dlb_trunk_t *dlb_trunk)
{
    int i;
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t *buf_ptr = NULL;
...
static int
bcm56880_a0_dlb_trunk_alternate_port_member_clr(int unit, bcmcth_dlb_trunk_t *dlb_trunk)
{
    int i;
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t *buf_ptr = NULL;
 ...
 */
static int
bcm56880_a0_cth_dlb_ecmp_grp_info_recover(
    int unit,
...
static int
bcm56880_a0_cth_dlb_ecmp_init(int unit,
                              bool warm,
                              bcmcth_dlb_ecmp_entry_info_t *entry_info)
{
    int mem_tbl_size;
     ...
     */
    if (!warm) {
        (void)bcm56880_a0_dlb_enable(unit);
    } else {
        SHR_IF_ERR_EXIT
            (bcm56880_a0_cth_dlb_ecmp_grp_info_recover(unit, entry_info));
    }
...
static int
bcm56880_a0_cth_dlb_ecmp_cleanup(int unit)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56880_a0_cth_dlb_grp_cnt_get(int unit, int *grp_cnt)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56880_a0_cth_dlb_ecmp_set(int unit,
                             bcmcth_dlb_ecmp_t *lt_entry,
                             bool flow_set_init)
{
    SHR_FUNC_ENTER(unit);
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_dlb_ecmp_flow_set_init(unit, lt_entry, flow_set_init));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_dlb_ecmp_port_member_set(unit, lt_entry));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_dlb_ecmp_alternate_port_member_set(unit, lt_entry));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_dlb_ecmp_port_bitmap_set(unit, lt_entry));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_dlb_ecmp_grp_ctrl_set(unit, lt_entry));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_dlb_ecmp_enable(unit, lt_entry, true));
exit:
    SHR_FUNC_EXIT();
}

static int
bcm56880_a0_cth_dlb_ecmp_del(int unit,
                             bcmcth_dlb_ecmp_t *lt_entry)
{
    SHR_FUNC_ENTER(unit);
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_dlb_ecmp_enable(unit, lt_entry, false));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_dlb_ecmp_port_member_clr(unit, lt_entry));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_dlb_ecmp_alternate_port_member_clr(unit, lt_entry));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_dlb_ecmp_port_bitmap_clr(unit, lt_entry));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_dlb_ecmp_grp_ctrl_clr(unit, lt_entry));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_dlb_ecmp_flow_set_cleanup(unit, lt_entry));
exit:
    SHR_FUNC_EXIT();
}

static int
bcm56880_a0_cth_dlb_ecmp_pctl_set(int unit,
                                  bcmcth_dlb_ecmp_pctl_t *lt_entry)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_dlb_ecmp_link_ctrl_set(unit, lt_entry));
exit:
    SHR_FUNC_EXIT();
}

static int
bcm56880_a0_cth_dlb_ecmp_pctl_del(int unit,
                                  bcmcth_dlb_ecmp_pctl_t *lt_entry)
{
    SHR_FUNC_ENTER(unit);
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_dlb_ecmp_link_ctrl_clr(unit, lt_entry));
exit:
    SHR_FUNC_EXIT();
}
                          ...
                          bool flow_set_init)
{
    ...
    bcm56880_a0_dlb_trunk_flow_set_release(
                                   unit,
                                   blk_ptr,
                                   dlb_trunk,
                                   flow_set_init);
    ...
    if (flow_set_init) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56880_a0_dlb_trunk_flow_set_assign(unit, blk_ptr, dlb_trunk));
    }

    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_dlb_trunk_port_member_set(unit, dlb_trunk));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_dlb_trunk_alternate_port_member_set(unit, dlb_trunk));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_dlb_trunk_port_bitmap_set(unit, dlb_trunk));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_dlb_trunk_grp_ctrl_set(unit, dlb_trunk));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_dlb_trunk_enable(unit, blk_ptr, dlb_trunk, true));
 ...
 */
static int
bcm56880_a0_cth_dlb_trunk_del(int unit,
                              bcmcth_dlb_trunk_blk_t *blk_ptr,
                              bcmcth_dlb_trunk_t *dlb_trunk)
{
    int num_blocks;
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_dlb_trunk_enable(unit, blk_ptr, dlb_trunk, false));

    /* Clear the trunk port members. */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_dlb_trunk_port_member_clr(unit, dlb_trunk));

    /* Clear the trunk alternate port members. */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_dlb_trunk_alternate_port_member_clr(unit, dlb_trunk));
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_dlb_trunk_group_clear(unit,
                                           DLB_LAG_GROUP_MEMBERSHIPm,
                                           dlb_trunk));
 ...
 */
static int
bcm56880_a0_cth_dlb_trunk_pctl_set(int unit,
...
static int
bcm56880_a0_cth_dlb_trunk_param_get(int unit, int *grp_cnt, int *flow_set_blk_cnt)
{
...
static bcmcth_dlb_drv_t bcm56880_a0_cth_dlb_drv = {
    .ecmp_init            = bcm56880_a0_cth_dlb_ecmp_init,
    .ecmp_cleanup         = bcm56880_a0_cth_dlb_ecmp_cleanup,
    .grp_cnt_get          = bcm56880_a0_cth_dlb_grp_cnt_get,
    .ecmp_set             = bcm56880_a0_cth_dlb_ecmp_set,
    .ecmp_del             = bcm56880_a0_cth_dlb_ecmp_del,
    .ecmp_pctl_set        = bcm56880_a0_cth_dlb_ecmp_pctl_set,
    .ecmp_pctl_del        = bcm56880_a0_cth_dlb_ecmp_pctl_del,
    .ecmp_recover         = bcm56880_a0_cth_dlb_ecmp_grp_info_recover,
    .trunk_grp_param_get  = bcm56880_a0_cth_dlb_trunk_param_get,
    .trunk_set            = bcm56880_a0_cth_dlb_trunk_set,
    .trunk_del            = bcm56880_a0_cth_dlb_trunk_del,
    .trunk_pctl_set       = bcm56880_a0_cth_dlb_trunk_pctl_set
};
...
bcmcth_dlb_drv_t *
bcm56880_a0_cth_dlb_drv_get(int unit)
{
    return &bcm56880_a0_cth_dlb_drv;
}
