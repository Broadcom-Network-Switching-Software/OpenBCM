...
static int
bcm56880_a0_cth_ecn_exp_to_ecn_map_ecn_set(int unit, bcmcth_ecn_exp_to_ecn_map_t *lt_entry)
{
...
static int
bcm56880_a0_cth_ecn_exp_to_ecn_map_drop_set(int unit, bcmcth_ecn_exp_to_ecn_map_t *lt_entry)
{
    bcmcth_pt_op_info_t pt_op_info;
    uint32_t *buf_ptr = NULL;
    uint32_t offset = 0;
...
static int
bcm56880_a0_cth_ecn_exp_to_ecn_map_set(int unit, bcmcth_ecn_exp_to_ecn_map_t *lt_entry)
{
    SHR_FUNC_ENTER(unit);
    ...
    SHR_IF_ERR_EXIT
        (bcm56880_a0_cth_ecn_exp_to_ecn_map_ecn_set(unit, lt_entry));
    SHR_IF_ERR_EXIT
        (bcm56880_a0_cth_ecn_exp_to_ecn_map_drop_set(unit, lt_entry));
...
static bcmcth_ecn_drv_t bcm56880_a0_cth_ecn_drv = {
    .exp_to_ecn_map_set = bcm56880_a0_cth_ecn_exp_to_ecn_map_set
};
...
bcmcth_ecn_drv_t *
bcm56880_a0_cth_ecn_drv_get(int unit)
{
    return &bcm56880_a0_cth_ecn_drv;
}
