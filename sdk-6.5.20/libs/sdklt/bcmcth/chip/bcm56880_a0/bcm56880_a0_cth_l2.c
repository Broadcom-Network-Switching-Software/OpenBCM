/*! \file bcm56880_a0_cth_l2.c
 *
 * L2 drivers for bcm56880 A0.
 */
/*
...
#include <bcmbd/chip/bcm56880_a0_ipep_intr.h>
...
typedef struct bcm56880_learn_cache_s {
...
typedef struct bcm56880_learn_cache_data_s {
    /* ENTRY_NEW,  ENTRY_PENDING, ENTRY_HW_LEARN, ENTRY_SW_DEL */
    l2_sw_fifo_entry_status_t status;

    /* L2 learn data. */
    LEARN_CACHE_CACHEm_t      data;
} bcm56880_sw_cache_data_t;

typedef struct bcm56880_learn_cache_pipe_info_s {
    ...
    /* Learn cache FIFO. */
    bcm56880_sw_cache_data_t *learn_cache_fifo;
    ...
    bcm56880_sw_cache_t *lt_entry_status;
...
} bcm56880_learn_cache_pipe_info_t;

typedef struct bcm56880_learn_cache_info_s {

    bcm56880_learn_cache_pipe_info_t pipe_learn_cache[MAX_PIPE_NUM];

} bcm56880_learn_cache_info_t;

static bcm56880_learn_cache_info_t learn_cache_info[BCML2_DEV_NUM_MAX];

typedef struct bcm56880_cache_fld_s {
    /* Cache field ID */
    uint32_t    fld_id;
    /* Start bit position */
    uint8_t     start_bit;
    /* End bit position */
    uint8_t     end_bit;
} bcm56880_cache_fld_t;

static bcm56880_cache_fld_t learn_cache_fld[] = {
...
static int l2_learn_intr[] = {
    QUAD0_IP_TO_CMIC_INTR,
    QUAD1_IP_TO_CMIC_INTR,
    QUAD2_IP_TO_CMIC_INTR,
    QUAD3_IP_TO_CMIC_INTR
};
...
learn_data_is_duplicate(int end, int start, LEARN_CACHE_CACHEm_t *lc_entry,
                        bcm56880_sw_cache_data_t *cache_fifo)
{
                                      ...
                                      LEARN_CACHE_CACHEm_t *fifo_entry)
{
    ...
    LEARN_CACHE_CACHEm_VALIDf_SET(*lc_entry, 1);
...
static void
bcm56880_a0_cth_l2_learn_cache_info_deinit(int unit)
{
    bcmcth_l2_drv_t *drv;
    bcmcth_l2_pipe_info_t *pi;
    bcm56880_learn_cache_info_t *cache_ptr = &learn_cache_info[unit];
    bcm56880_learn_cache_pipe_info_t *pipe_cache_ptr = NULL;
...
static int
bcm56880_a0_cth_l2_cleanup(int unit)
{
    SHR_FUNC_ENTER(unit);
    ...
    bcm56880_a0_cth_l2_learn_cache_info_deinit(unit);

    SHR_FUNC_EXIT();
}

static int
bcm56880_a0_cth_l2_intr_enable(int unit, int enable)
{
    bcmcth_l2_drv_t *drv;
    bcmcth_l2_pipe_info_t *pi;
    uint32_t pipe;
...
static int
bcm56880_a0_cth_l2_intr_handler_set(
    int unit,
...
static int
bcm56880_a0_cth_l2_learn_cache_dma_read(int unit, int pipe)
{
    bcmcth_l2_drv_t *drv;
    bcmcth_l2_pipe_info_t *pi;
    int rv = SHR_E_NONE;
    ...
    if (sim == 0) {
        ...
        for (i = 0; i < pi->tbl_size; i++) {
            ...
            if (!LEARN_CACHE_CACHEm_VALIDf_GET(*lc_entry)) {
                break;
            }
...
static void
bcm56880_a0_cth_l2_learn_fifo_status_set(int unit, int pipe,
                                         int fifo_index)
{
    bcm56880_learn_cache_info_t *cache_ptr = &learn_cache_info[unit];
    bcm56880_learn_cache_pipe_info_t *pipe_cache_ptr = NULL;
...
static void
bcm56880_a0_cth_l2_learn_pend_index_calc(int unit, int pipe)
{
    int pend, head, tail;
    bcm56880_learn_cache_info_t *cache_ptr = &learn_cache_info[unit];
    bcm56880_learn_cache_pipe_info_t *pipe_cache_ptr = NULL;
...
static bool
bcm56880_a0_cth_l2_learn_cache_fifo_push(int unit, int pipe,
                                         LEARN_CACHE_CACHEm_t *lc_entry)
{
    bcmcth_l2_drv_t *drv;
    bcmcth_l2_pipe_info_t *pi;
    ...
    uint32_t i;
    bcm56880_sw_cache_data_t *cache_fifo = NULL;
    bool full = false;
...
static bool
bcm56880_a0_cth_l2_learn_cache_fifo_pop(int unit, int pipe,
...
static bool
bcm56880_a0_cth_l2_lt_entry_index_find(int unit, int pipe, int *index)
{
    bcmcth_l2_drv_t *drv;
    bcmcth_l2_pipe_info_t *pi;
    bcm56880_learn_cache_info_t *cache_ptr = &learn_cache_info[unit];
    bcm56880_learn_cache_pipe_info_t *pipe_cache_ptr = NULL;
    bcm56880_sw_cache_t *lt_entry_status = NULL;
    uint32_t i;
...
static int
bcm56880_a0_cth_l2_cache_traverse(int unit, l2_trav_status_t *status)
{
    bcmcth_l2_drv_t *drv;
    bcmcth_l2_pipe_info_t *pi;
    int rv  = 0, lt_index;
    ...
    SHR_BIT_ITER(pi->map, pi->max_idx + 1, pipe) {
        ...
        rv = bcm56880_a0_cth_l2_learn_cache_dma_read(unit, pipe);
        if (SHR_FAILURE(rv)) {
        ...
        bcm56880_a0_cth_l2_learn_pend_index_calc(unit, pipe);

        lc_entry = (LEARN_CACHE_CACHEm_t *)pipe_cache_ptr->buf_laddr;
        full = bcm56880_a0_cth_l2_learn_cache_fifo_push(unit, pipe, lc_entry);
        if (full) {
            LOG_VERBOSE(BSL_LOG_MODULE,
                        (BSL_META_U(unit,
        ...
        while (insert_time < pi->tbl_size * 2) {
            lt_no_full = bcm56880_a0_cth_l2_lt_entry_index_find(unit, pipe, &lt_index);
            if (!lt_no_full) {
                LOG_VERBOSE(BSL_LOG_MODULE,
                            (BSL_META_U(unit,
            ...
            empty = bcm56880_a0_cth_l2_learn_cache_fifo_pop(unit, pipe,
                                                            &learn_cache_data,
                                                            &fifo_index);
            if (empty) {
                LOG_VERBOSE(BSL_LOG_MODULE,
...
static int
bcm56880_a0_cth_l2_entry_delete(int unit, void *data)
{
    bcmcth_l2_drv_t *drv;
    bcmcth_l2_pipe_info_t *pi;
    ...
    bcm56880_a0_cth_l2_learn_fifo_status_set(unit, pipe,
...
static int
bcm56880_a0_cth_l2_entry_parse(int unit, const bcmltd_field_t *key,
...
static int
bcm56880_a0_cth_l2_hw_enable(int unit, uint32_t trans_id, bool enable)
{
    ...
    LEARN_CACHE_CTRLr_CACHE_INTERRUPT_CTRLf_SET(cache_ctrl, enable);
...
static int
bcm56880_a0_cth_l2_learn_cache_sync(int unit)
{
    bcmcth_l2_drv_t *drv;
    bcmcth_l2_pipe_info_t *pi;
    ...
    SHR_BIT_ITER(pi->map, pi->max_idx + 1, pipe) {
        ...
        for (index = 0; index < max_index; index++) {
            ...
            full = bcm56880_a0_cth_l2_learn_cache_fifo_push(unit, pipe,
                                                            lc_fifo_entry);
            if (full) {
                SHR_IF_ERR_EXIT(SHR_E_INTERNAL);
            }
...
static int
bcm56880_a0_cth_l2_learn_cache_info_init(int unit)
{
    bcmcth_l2_drv_t *drv;
    bcmcth_l2_pipe_info_t *pi;
    bcm56880_learn_cache_info_t *cache_ptr = &learn_cache_info[unit];
    ...
    for (pipe = 0; pipe < MAX_PIPE_NUM; pipe++) {
        pipe_cache_ptr = &cache_ptr->pipe_learn_cache[pipe];
        sal_memset(pipe_cache_ptr, 0, sizeof(bcm56880_learn_cache_pipe_info_t));

        req_size =  pi->tbl_size * 2;
        req_size *= sizeof(bcm56880_sw_cache_t);
        ...
        req_size = L2_LEARN_CACHE_DEPTH * sizeof(bcm56880_sw_cache_data_t);
...
static int
bcm56880_a0_cth_l2_init(int unit, bool warm)
{
    uint32_t index;
    ...
    SHR_IF_ERR_EXIT
        (bcm56880_a0_cth_l2_learn_cache_info_init(unit));

    if (warm) {
        SHR_IF_ERR_EXIT
            (bcm56880_a0_cth_l2_learn_cache_sync(unit));
    } else {
        profile_depth =
...
exit:
    if (SHR_FUNC_ERR()) {
        (void)bcm56880_a0_cth_l2_cleanup(unit);
    }
    SHR_FUNC_EXIT();
}
 ...
 */
int
bcm56880_a0_cth_l2_attach(int unit)
{
    ...
    drv->init = bcm56880_a0_cth_l2_init;
    drv->cleanup = bcm56880_a0_cth_l2_cleanup;
    drv->hw_enable = bcm56880_a0_cth_l2_hw_enable;
    drv->intr_enable = bcm56880_a0_cth_l2_intr_enable;
    drv->intr_handler_set = bcm56880_a0_cth_l2_intr_handler_set;
    drv->cache_traverse = bcm56880_a0_cth_l2_cache_traverse;
    drv->entry_delete = bcm56880_a0_cth_l2_entry_delete;
    drv->entry_parse = bcm56880_a0_cth_l2_entry_parse;
