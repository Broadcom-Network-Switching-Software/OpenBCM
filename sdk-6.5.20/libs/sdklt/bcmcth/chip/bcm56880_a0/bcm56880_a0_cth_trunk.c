...
static int
bcm56880_a0_trunk_localport_get(int unit,
...
static int
bcm56880_a0_trunk_block_mask_set(int unit,
                                 const bcmltd_op_arg_t *op_arg,
                                 bcmltd_sid_t lt_id,
                                 ...
                                 bool  *nonuc_egr_block)
{
    ...
    if (new_cnt > 0) {
        ...
        for (idx = 0; idx < new_cnt; idx++) {
            local_port_type = FALSE;
            local_port = 0;
            SHR_IF_ERR_VERBOSE_EXIT(bcm56880_a0_trunk_localport_get(
                            unit,
                            op_arg,
                            lt_id,
...
static int
bcm56880_a0_trunk_grp_add(int unit,
                          const bcmltd_op_arg_t *op_arg,
                          bcmltd_sid_t lt_id,
                          ...
                          uint32_t base_ptr)
{
    ...
    for (px = 0; px < param->nonuc_cnt; px++) {
        ...
        if (param->nonuc_system_port_valid[px]) {
             SHR_IF_ERR_VERBOSE_EXIT(
                   bcm56880_a0_trunk_localport_get(
                            unit,
                            op_arg,
                            lt_id,
    ...
    if (BCMDRD_PBMP_NOT_NULL(new_trunk_bmp)) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56880_a0_trunk_block_mask_set(unit,
                                              op_arg,
                                              lt_id,
                                              old_trunk_bmp,
                                              new_trunk_bmp,
...
static int
bcm56880_a0_trunk_grp_del(int unit,
                          const bcmltd_op_arg_t *op_arg,
                          bcmltd_sid_t lt_id,
                          bcmcth_trunk_imm_grp_bk_t *grp_bk,
                          bcmcth_trunk_group_param_t *param)
...
static int
bcm56880_a0_trunk_grp_move(int unit,
                           const bcmltd_op_arg_t *op_arg,
                           bcmltd_sid_t lt_id,
                           bcmcth_trunk_imm_grp_bk_t *grp_bk,
...
static int
bcm56880_a0_trunk_grp_update(int unit,
                             const bcmltd_op_arg_t *op_arg,
                             bcmltd_sid_t lt_id,
                             bcmcth_trunk_imm_grp_bk_t *grp_bk,
                             bcmcth_trunk_group_param_t *param,
...
static int
bcm56880_a0_trunk_grp_init(int unit,
                           bcmcth_trunk_imm_grp_bk_t *grp_bk)
{
...
static int
bcm56880_a0_sys_trunk_grp_add(int unit,
                              const bcmltd_op_arg_t *op_arg,
                              bcmltd_sid_t lt_id,
...
static int
bcm56880_a0_sys_trunk_grp_del(int unit,
                              const bcmltd_op_arg_t *op_arg,
                              bcmltd_sid_t lt_id,
                              bcmcth_trunk_sys_grp_bk_t *grp_bk,
                              bcmcth_trunk_sys_grp_param_t *param)
...
static int
bcm56880_a0_sys_trunk_grp_move(int unit,
                               const bcmltd_op_arg_t *op_arg,
                               bcmltd_sid_t lt_id,
                               bcmcth_trunk_sys_grp_bk_t *grp_bk,
                               bcmcth_trunk_grp_defrag_t *src,
...
static int
bcm56880_a0_sys_trunk_grp_update(int unit,
                                 const bcmltd_op_arg_t *op_arg,
                                 bcmltd_sid_t lt_id,
                                 bcmcth_trunk_sys_grp_bk_t *grp_bk,
                                 bcmcth_trunk_sys_grp_param_t *param,
...
static int
bcm56880_a0_sys_trunk_grp_init(int unit, bcmcth_trunk_sys_grp_bk_t *grp_bk)
{
    int max, min, rv = SHR_E_NONE;
    shr_itbm_list_params_t params;
    shr_itbm_list_hdl_t lag_member_itbm_hdl = NULL;
 ...
 */
static void
bcm56880_a0_pt_op_info_t_init(bcmcth_trunk_vp_pt_op_info_t *pt_op_info)
{
...
static int
bcm56880_a0_trunk_vp_get_hw_lb_mode(int unit, bcmcth_trunk_vp_lb_mode_t lb_mode,
                                uint32_t *hw_lb_mode) {
    SHR_FUNC_ENTER(unit);
    switch (lb_mode) {
 ...
 */
static int
bcm56880_a0_trunk_vp_pt_write(int unit,
 ...
 */
static int
bcm56880_a0_trunk_vp_pt_read(int unit,
                         bcmcth_trunk_vp_pt_op_info_t *op_info,
                         uint32_t *buf)
{
 ...
 */
static int
bcm56880_a0_trunk_vp_sids_init(int unit,
      ...
      if ((member0_info != NULL) &&
        ...
        for (i = 0;
            ...
            if (i == MEMBER_LEVEL0) {
                ...
                vp_drv_var->mem0[i];
                BCMCTH_TRUNK_VP_TBL_DRD_SID
                (unit, member2, BCMCTH_TRUNK_VP_GRP_TYPE_WEIGHTED_0) =
                vp_drv_var->mem0[i];
            } else {
                SHR_ERR_EXIT(SHR_E_INTERNAL);
            }
 ...
 */
static int
bcm56880_a0_trunk_vp_olay_lt_flds_init(int unit,
 ...
 */
static int
bcm56880_a0_trunk_vp_fields_init(int unit,
                                 const bcmcth_trunk_drv_var_ids_t *ids)
{
    ...
    if (SHR_SUCCESS(rv)) {
         ...
         */
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56880_a0_trunk_vp_olay_lt_flds_init(unit, map, wmap, ids));
...
static int
bcm56880_a0_trunk_vp_itbm_lists_cleanup(int unit)
{
...
static int
bcm56880_a0_trunk_vp_itbm_lists_init(int unit)
{
    shr_itbm_list_params_t params;
    ...
    params.max = BCMCTH_TRUNK_VP_TBL_IDX_MAX
        (unit, member, BCMCTH_TRUNK_VP_GRP_TYPE_OVERLAY) +
        BCMCTH_TRUNK_VP_TBL_IDX_MAX
        (unit, member2, BCMCTH_TRUNK_VP_GRP_TYPE_OVERLAY) + 1;
    params.first = BCMCTH_TRUNK_VP_TBL_IDX_MIN
        (unit, member, BCMCTH_TRUNK_VP_GRP_TYPE_OVERLAY);
    params.last = BCMCTH_TRUNK_VP_TBL_IDX_MAX
        (unit, member, BCMCTH_TRUNK_VP_GRP_TYPE_OVERLAY) +
 ...
 */
static int
bcm56880_a0_trunk_vp_hw_tbls_range_init(int unit)
{
    ...
    wsize = bcmdrd_pt_entry_wsize(unit,
                                  BCMCTH_TRUNK_VP_TBL_DRD_SID
                                        (unit, member2,
                                         BCMCTH_TRUNK_VP_GRP_TYPE_OVERLAY));
    BCMCTH_TRUNK_VP_TBL_ENT_SIZE
        (unit, member2, BCMCTH_TRUNK_VP_GRP_TYPE_OVERLAY) = wsize;
    if (wsize > BCMCTH_TRUNK_VP_TBL_ENT_SIZE_MAX(unit)) {
        BCMCTH_TRUNK_VP_TBL_ENT_SIZE_MAX(unit) = wsize;
    }
    BCMCTH_TRUNK_VP_TBL_ENT_SIZE
    ...
    BCMCTH_TRUNK_VP_TBL_IDX_MAX_USED
        (unit, member2, BCMCTH_TRUNK_VP_GRP_TYPE_OVERLAY) = memb_imin;

    BCMCTH_TRUNK_VP_TBL_IDX_MIN
        (unit, member2, BCMCTH_TRUNK_VP_GRP_TYPE_OVERLAY) = memb_imin;
    BCMCTH_TRUNK_VP_TBL_IDX_MAX
        (unit, member2, BCMCTH_TRUNK_VP_GRP_TYPE_OVERLAY) = memb_imax;

    tbl_sz = (BCMCTH_TRUNK_VP_TBL_IDX_MAX
                (unit, member2, BCMCTH_TRUNK_VP_GRP_TYPE_OVERLAY)
                - BCMCTH_TRUNK_VP_TBL_IDX_MIN
                    (unit, member2, BCMCTH_TRUNK_VP_GRP_TYPE_OVERLAY)) + 1;
    BCMCTH_TRUNK_VP_TBL_SIZE
          (unit, member2, BCMCTH_TRUNK_VP_GRP_TYPE_OVERLAY) = tbl_sz;
    BCMCTH_TRUNK_VP_TBL_SIZE
          (unit, member2, BCMCTH_TRUNK_VP_GRP_TYPE_WEIGHTED_0) = tbl_sz;
    ...
    BCMCTH_TRUNK_VP_TBL_IDX_MAX_USED
        ...
        = BCMCTH_TRUNK_VP_TBL_IDX_MAX_USED
              (unit, member2, BCMCTH_TRUNK_VP_GRP_TYPE_OVERLAY);
    bcm56880_a0_trunk_vp_itbm_lists_init(unit);
 ...
 */
static int
bcm56880_a0_trunk_vp_tables_init(int unit,
                                 const bcmcth_trunk_vp_drv_var_t *vp_drv_var)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_trunk_vp_sids_init(unit, vp_drv_var));

    /* Initialize TRUNK_VP hardware tables size and index range info. */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_trunk_vp_hw_tbls_range_init(unit));

    /* Initialize TRUNK_VP tables logical and physical field details. */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_trunk_vp_fields_init(unit, vp_drv_var->ids));
 ...
 */
static int
bcm56880_a0_trunk_vp_db_init(int unit, bool warm)
{
 ...
 */
static int
bcm56880_a0_trunk_vp_abort_db_init(int unit, bool warm)
{
 ...
 */
static int
bcm56880_a0_trunk_vp_entries_init(int unit, bool warm)
{
    SHR_FUNC_ENTER(unit);
 ...
 */
static int
bcm56880_a0_trunk_vp_info_init(int unit,
                               bool warm,
                               const bcmcth_trunk_drv_var_t *drv_var)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_trunk_vp_tables_init(unit, drv_var->trunk_vp_var));
     ...
     */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_trunk_vp_entries_init(unit, warm));
 ...
 */
static int
bcm56880_a0_trunk_vp_olay_grps_flds_cleanup(int unit)
{
    bcmcth_trunk_vp_grp_drd_fields_t *ogdrd_fields = NULL;
 ...
 */
static int
bcm56880_a0_trunk_vp_fields_cleanup(int unit)
{

    SHR_FUNC_ENTER(unit);

    /* Cleanup TRUNK_VP LT fields information. */
    bcm56880_a0_trunk_vp_olay_grps_flds_cleanup(unit);
 ...
 */
static int
bcm56880_a0_trunk_vp_db_clear(int unit)
{
 ...
 */
static int
bcm56880_a0_trunk_vp_hw_tbls_range_clear(int unit)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_trunk_vp_itbm_lists_cleanup(unit));
 ...
 */
static int
bcm56880_a0_trunk_vp_sids_clear(int unit)
{
    SHR_FUNC_ENTER(unit);
 ...
 */
static int
bcm56880_a0_trunk_vp_tables_clear(int unit)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_trunk_vp_fields_cleanup(unit));

    /* Clear TRUNK_VP hardware tables size and index range info. */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_trunk_vp_hw_tbls_range_clear(unit));

    /* Clear TRUNK_VP tables DRD-SID and LTD-SID details. */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_trunk_vp_sids_clear(unit));
 ...
 */
static int
bcm56880_a0_trunk_vp_abort_db_clear(int unit)
{
    /* Pointer to TRUNK_VP hardware table info. */
    bcmcth_trunk_vp_tbl_prop_t *tbl_ptr;
 ...
 */
static int
bcm56880_a0_trunk_vp_itbm_groups_cleanup(int unit)
{
 ...
 */
static int
bcm56880_a0_trunk_vp_entries_cleanup(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT(
      bcm56880_a0_trunk_vp_itbm_groups_cleanup(unit));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_trunk_vp_db_clear(unit));

    /* Clear atomic transaction related SW database info. */
    if (BCMCTH_TRUNK_VP_ATOMIC_TRANS(unit)) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56880_a0_trunk_vp_abort_db_clear(unit));
    }
 ...
 */
static int
bcm56880_a0_trunk_vp_info_cleanup(int unit)
{
    SHR_FUNC_ENTER(unit);
     ...
     */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_trunk_vp_entries_cleanup(unit));

    /* Clear TRUNK_VP tables information stored in SW. */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_trunk_vp_tables_clear(unit));
 ...
 */
static int
bcm56880_a0_trunk_vp_grp_dma_del(int unit,
                                 void *info)
{
    ...
    if (mstart_idx > BCMCTH_TRUNK_VP_TBL_IDX_MAX(unit, member, gtype)) {
        op_info.drd_sid = BCMCTH_TRUNK_VP_TBL_DRD_SID(unit, member2, gtype);
        op_info.dyn_info.index = mstart_idx - BCMCTH_TRUNK_VP_TBL_SIZE(unit,
                      member, gtype);
    } else {
        op_info.drd_sid = BCMCTH_TRUNK_VP_TBL_DRD_SID(unit, member, gtype);
        if (mstart_idx + (int)(lt_ent->max_members) - 1 >
                 (int)(BCMCTH_TRUNK_VP_TBL_IDX_MAX(unit, member, gtype))) {
            op_info.ecount =
               BCMCTH_TRUNK_VP_TBL_SIZE(unit, member, gtype)
                 - mstart_idx;
            overlap_mem = 1;
        }
    }
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_trunk_vp_pt_write(unit, &op_info, dma_buf));

    if (overlap_mem) {
        op_info.drd_sid = BCMCTH_TRUNK_VP_TBL_DRD_SID(unit, member2, gtype);
        op_info.dyn_info.index = 0;
        op_info.ecount = lt_ent->max_members - op_info.ecount;
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56880_a0_trunk_vp_pt_write(unit, &op_info, dma_buf));
    }
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_trunk_vp_pt_write(unit, &op_info, pt_entry_buff));
 ...
 */
static int
bcm56880_a0_trunk_vp_grp_pio_del(int unit,
                             void *info)
{
    ...
    LOG_INFO(BSL_LOG_MODULE,
             (BSL_META_U(unit,
                         "bcm56880_a0_trunk_vp_grp_pio_del.\n")));
    ...
    BCMCTH_TRUNK_VP_ALLOC(pt_entry_buff,
                  BCMCTH_TRUNK_VP_TBL_ENT_SIZE_MAX(unit) * sizeof(uint32_t),
                  "bcmcthTrunkVpBcm56880GrpPioDelPtBuf");
   ...
   if (start_idx > (int) BCMCTH_TRUNK_VP_TBL_IDX_MAX(unit, member, gtype)) {
        op_info.drd_sid = BCMCTH_TRUNK_VP_TBL_DRD_SID(unit, member2, gtype);
        start_idx -= BCMCTH_TRUNK_VP_TBL_IDX_MAX(unit, member, gtype);;
    } else {
        op_info.drd_sid = BCMCTH_TRUNK_VP_TBL_DRD_SID(unit, member, gtype);
    }
 ...
 */
static int
bcm56880_a0_trunk_vp_grp_dma_ins(int unit,
                                 void *info,
                                 const bcmcth_trunk_vp_drv_var_t *vp_drv_var)
{
    bcmcth_trunk_vp_grp_type_t gtype = BCMCTH_TRUNK_VP_GRP_TYPE_COUNT;
        ...
        if (lt_ent->member_cnt) {
            ...
            if (mstart_idx > BCMCTH_TRUNK_VP_TBL_IDX_MAX(unit, member, gtype)) {
                ...
                op_info.dyn_info.index = lt_ent->mstart_idx -
                       (BCMCTH_TRUNK_VP_TBL_IDX_MAX(unit, member, gtype) + 1);
            } else if ((int)(mstart_idx + lt_ent->member_cnt - 1) >
                             BCMCTH_TRUNK_VP_TBL_IDX_MAX(unit, member, gtype)) {
                op_info.ecount = (BCMCTH_TRUNK_VP_TBL_IDX_MAX(unit, member, gtype) + 1)
                                 - lt_ent->mstart_idx;
                overlap_mem = 1;
            }

            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56880_a0_trunk_vp_pt_read(unit, &op_info, dma_buf));

            if (overlap_mem) {
                size_read = (op_info.ecount * op_info.wsize);
                op_info.drd_sid = BCMCTH_TRUNK_VP_TBL_DRD_SID(unit, member2, gtype);
                op_info.ecount = lt_ent->member_cnt - op_info.ecount;
                op_info.dyn_info.index = 0;
                SHR_IF_ERR_EXIT
                    (bcm56880_a0_trunk_vp_pt_read(unit, &op_info, (dma_buf + size_read)));
            }
        }
    }
    /* Initialize op_info structure member values. */
    ...
    if (overlap_mem) {
        size_write = (op_info.ecount * op_info.wsize);
        op_info.drd_sid = BCMCTH_TRUNK_VP_TBL_DRD_SID(unit, member2, gtype);
        op_info.dyn_info.index = 0;
        op_info.ecount = lt_ent->max_members - op_info.ecount;
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56880_a0_trunk_vp_pt_write(unit,
                                           &op_info,
                                           (dma_buf + size_write)));
    }
    ...
    if (BCMCTH_TRUNK_VP_GRP_TYPE_WEIGHTED_0 != gtype) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56880_a0_trunk_vp_get_hw_lb_mode(unit,
 ...
 */
static int
bcm56880_a0_trunk_vp_grp_pio_ins(int unit,
                                 void *info,
                                 const bcmcth_trunk_vp_drv_var_t *vp_drv_var)
{
    bcmcth_trunk_vp_grp_type_t gtype = BCMCTH_TRUNK_VP_GRP_TYPE_COUNT;
    ...
    BCMCTH_TRUNK_VP_ALLOC(pt_entry_buff,
                  BCMCTH_TRUNK_VP_TBL_ENT_SIZE_MAX(unit) * sizeof(uint32_t),
                  "bcmcthTrunkVpBcm56880GrpPioInsPtBuf");
    ...
    if (mstart_idx > BCMCTH_TRUNK_VP_TBL_IDX_MAX(unit, member, gtype)) {
        op_info.drd_sid = BCMCTH_TRUNK_VP_TBL_DRD_SID(unit, member2, gtype);
        mstart_idx -= BCMCTH_TRUNK_VP_TBL_SIZE(unit, member, gtype);
    } else {
        op_info.drd_sid = BCMCTH_TRUNK_VP_TBL_DRD_SID(unit, member, gtype);
    }
    op_info.dyn_info.index = (mstart_idx);
 ...
 */
static int
bcm56880_a0_trunk_vp_grp_ins(int unit,
                             void *info,
                             const bcmcth_trunk_drv_var_t *drv_var)
{
    ...
    if (BCMCTH_TRUNK_VP_USE_DMA(unit)) {
        SHR_ERR_EXIT
            (bcm56880_a0_trunk_vp_grp_dma_ins(
                                unit,
                                info,
                                drv_var->trunk_vp_var));
    } else {
        SHR_ERR_EXIT
            (bcm56880_a0_trunk_vp_grp_pio_ins(
                                unit,
                                info,
                                drv_var->trunk_vp_var));
    }
 ...
 */
static int
bcm56880_a0_trunk_vp_grp_del(int unit,
                         void *info)
{
    SHR_FUNC_ENTER(unit);
    SHR_NULL_CHECK(info, SHR_E_PARAM);
    ...
    LOG_INFO(BSL_LOG_MODULE,
             (BSL_META_U(unit,
                         "bcm56880_a0_trunk_vp_grp_del.\n")));

    if (BCMCTH_TRUNK_VP_USE_DMA(unit)) {
        SHR_ERR_EXIT
            (bcm56880_a0_trunk_vp_grp_dma_del(unit, info));
    } else {
        SHR_ERR_EXIT
            (bcm56880_a0_trunk_vp_grp_pio_del(unit, info));
    }
exit:
    SHR_FUNC_EXIT();
}
 ...
 */
static int
bcm56880_a0_trunk_vp_memb_dma_cpy(int unit,
                              const void *mdest,
                              const void *msrc)
{
    ...
    dma_alloc_sz = (BCMCTH_TRUNK_VP_TBL_ENT_SIZE
                        (unit, member, gtype) * sizeof(uint32_t) *
                         sfrag->gsize);
    BCMCTH_TRUNK_VP_ALLOC(dma_buf,
                    dma_alloc_sz, "bcmcthTrunkVp56880L3EcmpDmaCpy");
    ...
    if (sfrag->mstart_idx > BCMCTH_TRUNK_VP_TBL_IDX_MAX(unit, member, gtype)) {
        op_info.drd_sid = BCMCTH_TRUNK_VP_TBL_DRD_SID(unit, member2, gtype);
        op_info.dyn_info.index = sfrag->mstart_idx -
               (BCMCTH_TRUNK_VP_TBL_IDX_MAX(unit, member, gtype) + 1);
    } else if ((int)(sfrag->mstart_idx + sfrag->gsize - 1) >
                     BCMCTH_TRUNK_VP_TBL_IDX_MAX(unit, member, gtype)) {
            op_info.ecount = (BCMCTH_TRUNK_VP_TBL_IDX_MAX(unit, member, gtype) + 1)
                             - sfrag->mstart_idx;
            overlap_mem = 1;
    ...
    if (overlap_mem) {
        uint32_t size_read;
        size_read = (op_info.wsize * op_info.ecount);
        op_info.drd_sid = BCMCTH_TRUNK_VP_TBL_DRD_SID(unit, member2, gtype);
    ...
    if (dfrag->mstart_idx > BCMCTH_TRUNK_VP_TBL_IDX_MAX(unit, member, gtype)) {
        op_info.drd_sid = BCMCTH_TRUNK_VP_TBL_DRD_SID(unit, member2, gtype);
        op_info.dyn_info.index = dfrag->mstart_idx -
                 (BCMCTH_TRUNK_VP_TBL_IDX_MAX(unit, member, gtype) + 1);
    } else if ((int)(dfrag->mstart_idx + dfrag->gsize - 1)
                > BCMCTH_TRUNK_VP_TBL_IDX_MAX(unit, member, gtype)) {
            op_info.ecount = (BCMCTH_TRUNK_VP_TBL_IDX_MAX(unit, member, gtype)  + 1) -
                             dfrag->mstart_idx;
            overlap_mem = 1;
    ...
    if (overlap_mem) {
        uint32_t size_wr;
        op_info.drd_sid = BCMCTH_TRUNK_VP_TBL_DRD_SID(unit, member2, gtype);
        size_wr = (op_info.wsize * op_info.ecount);
        op_info.ecount = dfrag->gsize - op_info.ecount;
        op_info.dyn_info.index = 0;
        SHR_IF_ERR_EXIT
            (bcm56880_a0_trunk_vp_pt_write(unit, &op_info, dma_buf + size_wr));
    }
 ...
 */
static int
bcm56880_a0_trunk_vp_memb_pio_cpy(int unit,
                              const void *mdest,
                              const void *msrc)
{
    SHR_FUNC_ENTER(unit);
 ...
 */
static int
bcm56880_a0_trunk_vp_memb_cpy(int unit,
                          const void *mdest,
                          const void *msrc)
{
    SHR_FUNC_ENTER(unit);
    ...
    if (BCMCTH_TRUNK_VP_USE_DMA(unit)) {
        SHR_ERR_EXIT
            (bcm56880_a0_trunk_vp_memb_dma_cpy(unit, mdest, msrc));
    } else {
        SHR_ERR_EXIT
            (bcm56880_a0_trunk_vp_memb_pio_cpy(unit, mdest, msrc));
    }
 ...
 */
static int
bcm56880_a0_trunk_vp_memb_dma_clr(int unit,
                              const void *mfrag)
{
    ...
    LOG_VERBOSE(BSL_LOG_MODULE,
                (BSL_META_U(unit,
                            "bcm56880_a0_trunk_vp_memb_dma_clr.\n")));
    ...
    dma_alloc_sz = (BCMCTH_TRUNK_VP_TBL_ENT_SIZE
                        (unit, member, gtype) * sizeof(uint32_t) *
                         mclr->gsize);
    BCMCTH_TRUNK_VP_ALLOC(dma_buf,
              dma_alloc_sz, "bcmcthTrunkVp56880DmaClr");
    ...
    if (mclr->mstart_idx > BCMCTH_TRUNK_VP_TBL_IDX_MAX(unit, member, gtype)) {
        op_info.drd_sid = BCMCTH_TRUNK_VP_TBL_DRD_SID(unit, member2, gtype);
        op_info.dyn_info.index = mclr->mstart_idx -
                      (BCMCTH_TRUNK_VP_TBL_IDX_MAX(unit, member, gtype) + 1);
    } else if ((int)(mclr->mstart_idx + mclr->gsize - 1) >
               BCMCTH_TRUNK_VP_TBL_IDX_MAX(unit, member, gtype)) {
            op_info.ecount = (BCMCTH_TRUNK_VP_TBL_IDX_MAX(unit, member, gtype)
                             + 1) -
                             mclr->mstart_idx ;
            overlap_mem = 1;
    }
 ...
 */
static int
bcm56880_a0_trunk_vp_memb_pio_clr(int unit,
                             const void *mfrag)
{
    SHR_FUNC_ENTER(unit);
 ...
 */
static int
bcm56880_a0_trunk_vp_memb_clr(int unit,
                          const void *mfrag)
{
    SHR_FUNC_ENTER(unit);
    ...
    if (BCMCTH_TRUNK_VP_USE_DMA(unit)) {
        SHR_ERR_EXIT
            (bcm56880_a0_trunk_vp_memb_dma_clr(unit, mfrag));
    } else {
        SHR_ERR_EXIT
            (bcm56880_a0_trunk_vp_memb_pio_clr(unit, mfrag));
    }
exit:
    SHR_FUNC_EXIT();
}
 ...
 */
static int
bcm56880_a0_trunk_vp_gmstart_updt(int unit,
                              const void *ginfo)
{
    ...
    BCMCTH_TRUNK_VP_ALLOC(pt_entry_buff,
                  BCMCTH_TRUNK_VP_TBL_ENT_SIZE_MAX(unit) * sizeof(uint32_t),
                  "bcmcthTrunkVp56880GrpMstartUpdt");
    ...
    sal_memset(pt_entry_buff, 0,
               BCMCTH_TRUNK_VP_TBL_ENT_SIZE_MAX(unit) * sizeof(uint32_t));
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56880_a0_trunk_vp_pt_read(unit, &op_info, pt_entry_buff));
    if (wali->gwsize == 0) {
 ...
 */
static int
bcm56880_a0_trunk_vp_group_lt_fields_fill(
                                     int unit,
 ...
 */
static int
bcm56880_a0_trunk_vp_weighted_group_lt_fields_fill(
                                     int unit,
                                     const bcmltd_field_t *in,
                                     const bcmcth_trunk_vp_drv_var_t *vp_drv_var,
                                     bcmcth_trunk_vp_lt_entry_t *lt_entry)
 ...
 */
static int
bcm56880_a0_trunk_vp_lt_fields_fill(int unit,
                                    const void *in_field,
                                    const bcmcth_trunk_drv_var_t *drv_var,
                                    void *entry)
{
...
static bcmcth_trunk_drv_t bcm56880_a0_cth_trunk_drv =  {
    .fn_imm_grp_add          = &bcm56880_a0_trunk_grp_add,
    .fn_imm_grp_update       = &bcm56880_a0_trunk_grp_update,
    .fn_imm_grp_del          = &bcm56880_a0_trunk_grp_del,
    .fn_imm_grp_move         = &bcm56880_a0_trunk_grp_move,
    .fn_imm_grp_init         = &bcm56880_a0_trunk_grp_init,
    .fn_sys_grp_add          = &bcm56880_a0_sys_trunk_grp_add,
    .fn_sys_grp_del          = &bcm56880_a0_sys_trunk_grp_del,
    .fn_sys_grp_update       = &bcm56880_a0_sys_trunk_grp_update,
    .fn_sys_grp_move         = &bcm56880_a0_sys_trunk_grp_move,
    .fn_sys_grp_init         = &bcm56880_a0_sys_trunk_grp_init,
    .info_init               = &bcm56880_a0_trunk_vp_info_init,
    .info_cleanup            = &bcm56880_a0_trunk_vp_info_cleanup,
    .grp_ins                 = &bcm56880_a0_trunk_vp_grp_ins,
    .grp_del                 = &bcm56880_a0_trunk_vp_grp_del,
    .memb_cpy                = &bcm56880_a0_trunk_vp_memb_cpy,
    .memb_clr                = &bcm56880_a0_trunk_vp_memb_clr,
    .gmstart_updt            = &bcm56880_a0_trunk_vp_gmstart_updt,
    .lt_fields_fill          = &bcm56880_a0_trunk_vp_lt_fields_fill
};
...
bcmcth_trunk_drv_t *
bcm56880_a0_cth_trunk_drv_get(int unit)
{
    return &bcm56880_a0_cth_trunk_drv;
}
