...
static int
bcm56996_a0_cth_mirror_ctr_flex_sflow_write(
    int unit,
...
static int
bcm56996_a0_cth_mirror_ctr_flex_sflow_read(
    int unit,
    bcmcth_mirror_flex_sflow_stat_t *info)
{
    bcmbd_pt_dyn_info_t pt_dyn_info = {0};
...
static int
bcm56996_a0_cth_mirror_ctr_flex_field_init(int unit)
{
...
static int
bcm56996_a0_cth_mirror_deinit(int unit)
{
    ...
    int unit, int warm, const bcmcth_mirror_data_t *data)
{
    ...
    SHR_IF_ERR_EXIT
        (bcm56996_a0_cth_mirror_ctr_flex_field_init(unit));
...
static bcmcth_mirror_drv_t bcm56996_a0_cth_mirror_drv = {
    .init = bcm56996_a0_cth_mirror_init,
    .deinit = bcm56996_a0_cth_mirror_deinit,
    .ctr_flex_sflow_write = &bcm56996_a0_cth_mirror_ctr_flex_sflow_write,
    .ctr_flex_sflow_read = &bcm56996_a0_cth_mirror_ctr_flex_sflow_read,
};
 ...
 */
bcmcth_mirror_drv_t *
bcm56996_a0_cth_mirror_drv_get(int unit)
{
    return &bcm56996_a0_cth_mirror_drv;
}
