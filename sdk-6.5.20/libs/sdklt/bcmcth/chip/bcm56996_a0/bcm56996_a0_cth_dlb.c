...
bcmcth_dlb_pt_op_info_t_init(bcmcth_dlb_pt_op_info_t *pt_op_info)
{
    if (pt_op_info) {
        ...
        pt_op_info->drd_sid = BCM56996_A0_ENUM_COUNT;
        pt_op_info->trans_id = BCMPORT_INVALID;
        pt_op_info->req_lt_sid = BCM56996_A0_ENUM_COUNT;
        pt_op_info->rsp_lt_sid = BCM56996_A0_ENUM_COUNT;
...
static int
bcm56996_a0_dlb_ecmp_nhi_member_set(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    int i;
...
static int
bcm56996_a0_dlb_ecmp_port_member_set(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    int i;
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t field_value = 0;
...
static int
bcm56996_a0_dlb_ecmp_alternate_nhi_member_set(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    int i;
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t field_value = 0;
...
static int
bcm56996_a0_dlb_ecmp_alternate_port_member_set(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    int i;
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t field_value = 0;
...
static int
bcm56996_a0_dlb_ecmp_port_bitmap_set(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    int i;
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t *buf_ptr = NULL;
...
static int
bcm56996_a0_flow_set_base_get(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
...
static int
bcm56996_a0_dlb_ecmp_flow_set_alloc(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    SHR_FUNC_ENTER(unit);

    if (lt_entry->flow_set_size != lt_entry->prev_flow_set_size) {
        SHR_IF_ERR_EXIT
            (bcm56996_a0_flow_set_base_get(unit, lt_entry));
    }
...
static int
bcm56996_a0_dlb_ecmp_flow_set_init(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    ...
    rv = bcm56996_a0_dlb_ecmp_flow_set_alloc(unit, lt_entry);
    if (rv != SHR_E_NONE) {
...
static int
bcm56996_a0_dlb_ecmp_grp_ctrl_set(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t field_value = 0;
    uint32_t *buf_ptr = NULL;
...
static int
bcm56996_a0_dlb_ecmp_enable(int unit, bcmcth_dlb_ecmp_t *lt_entry, bool enable)
{
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t *buf_ptr = NULL;
...
static int
bcm56996_a0_dlb_ecmp_nhi_member_clr(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    int i;
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t *buf_ptr = NULL;
...
static int
bcm56996_a0_dlb_ecmp_port_member_clr(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    int i;
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t *buf_ptr = NULL;
...
static int
bcm56996_a0_dlb_ecmp_alternate_nhi_member_clr(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    int i;
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t *buf_ptr = NULL;
...
static int
bcm56996_a0_dlb_ecmp_alternate_port_member_clr(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    int i;
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t *buf_ptr = NULL;
...
static int
bcm56996_a0_dlb_ecmp_grp_ctrl_clr(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t *buf_ptr = NULL;
...
static int
bcm56996_a0_dlb_ecmp_port_bitmap_clr(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t *buf_ptr = NULL;
    DLB_ECMP_GROUP_MEMBERSHIPm_t group_membership_entry;
...
static int
bcm56996_a0_dlb_ecmp_flow_set_cleanup(int unit, bcmcth_dlb_ecmp_t *lt_entry)
{
    int flow_set_base;
    int num_blocks;
...
static int
bcm56996_a0_dlb_ecmp_link_ctrl_set(int unit, bcmcth_dlb_ecmp_pctl_t *lt_entry)
{
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t *buf_ptr = NULL;
...
static int
bcm56996_a0_dlb_ecmp_link_ctrl_clr(int unit, bcmcth_dlb_ecmp_pctl_t *lt_entry)
{
    bcmcth_dlb_pt_op_info_t pt_op_info;
    uint32_t *buf_ptr = NULL;
    DLB_ECMP_LINK_CONTROLm_t   link_ctrl_entry;
...
static void
bcm56996_a0_dlb_enable(int unit)
{
 ...
 */
static int
bcm56996_a0_cth_dlb_ecmp_grp_info_recover(
...
static int
bcm56996_a0_cth_dlb_ecmp_init(int unit,
                              bool warm,
                              bcmcth_dlb_ecmp_entry_info_t *entry_info)
{
    ...
    if (!warm) {
        (void)bcm56996_a0_dlb_enable(unit);
    } else {
        SHR_IF_ERR_EXIT
            (bcm56996_a0_cth_dlb_ecmp_grp_info_recover(unit, entry_info));
    }
...
static int
bcm56996_a0_cth_dlb_ecmp_cleanup(int unit)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56996_a0_cth_dlb_grp_cnt_get(int unit, int *grp_cnt)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56996_a0_cth_dlb_ecmp_set(int unit,
                             ...
                             bool flow_set_init)
{
    ...
    SHR_IF_ERR_EXIT
        (bcm56996_a0_dlb_ecmp_flow_set_init(unit, lt_entry));

    SHR_IF_ERR_EXIT
        (bcm56996_a0_dlb_ecmp_nhi_member_set(unit, lt_entry));

    SHR_IF_ERR_EXIT
        (bcm56996_a0_dlb_ecmp_port_member_set(unit, lt_entry));

    SHR_IF_ERR_EXIT
        (bcm56996_a0_dlb_ecmp_alternate_nhi_member_set(unit, lt_entry));

    SHR_IF_ERR_EXIT
        (bcm56996_a0_dlb_ecmp_alternate_port_member_set(unit, lt_entry));

    SHR_IF_ERR_EXIT
        (bcm56996_a0_dlb_ecmp_port_bitmap_set(unit, lt_entry));

    SHR_IF_ERR_EXIT
        (bcm56996_a0_dlb_ecmp_grp_ctrl_set(unit, lt_entry));

    SHR_IF_ERR_EXIT
        (bcm56996_a0_dlb_ecmp_enable(unit, lt_entry, true));
...
static int
bcm56996_a0_cth_dlb_ecmp_del(int unit,
                             bcmcth_dlb_ecmp_t *lt_entry)
{
    SHR_FUNC_ENTER(unit);
    ...
    SHR_IF_ERR_EXIT
        (bcm56996_a0_dlb_ecmp_enable(unit, lt_entry, false));

    SHR_IF_ERR_EXIT
        (bcm56996_a0_dlb_ecmp_nhi_member_clr(unit, lt_entry));

    SHR_IF_ERR_EXIT
        (bcm56996_a0_dlb_ecmp_port_member_clr(unit, lt_entry));

    SHR_IF_ERR_EXIT
        (bcm56996_a0_dlb_ecmp_alternate_nhi_member_clr(unit, lt_entry));

    SHR_IF_ERR_EXIT
        (bcm56996_a0_dlb_ecmp_alternate_port_member_clr(unit, lt_entry));

    SHR_IF_ERR_EXIT
        (bcm56996_a0_dlb_ecmp_port_bitmap_clr(unit, lt_entry));

    SHR_IF_ERR_EXIT
        (bcm56996_a0_dlb_ecmp_grp_ctrl_clr(unit, lt_entry));

    SHR_IF_ERR_EXIT
        (bcm56996_a0_dlb_ecmp_flow_set_cleanup(unit, lt_entry));
...
static int
bcm56996_a0_cth_dlb_ecmp_pctl_set(int unit,
                                  bcmcth_dlb_ecmp_pctl_t *lt_entry)
{
    ...
    SHR_IF_ERR_EXIT
        (bcm56996_a0_dlb_ecmp_link_ctrl_set(unit, lt_entry));
...
static int
bcm56996_a0_cth_dlb_ecmp_pctl_del(int unit,
                                  bcmcth_dlb_ecmp_pctl_t *lt_entry)
{
    SHR_FUNC_ENTER(unit);
    ...
    SHR_IF_ERR_EXIT
        (bcm56996_a0_dlb_ecmp_link_ctrl_clr(unit, lt_entry));
...
static int
bcm56996_a0_cth_dlb_ecmp_stats_set(int unit,
...
static int
bcm56996_a0_cth_dlb_ecmp_stats_get(int unit,
                                   bcmcth_dlb_ecmp_stats_t *lt_entry)
{
    DLB_ECMP_GROUP_STATS_INST0m_t dlb_ecmp_group_stats_buf;
    bcmdrd_sid_t dlb_ecmp_group_stats_sid[2] = {DLB_ECMP_GROUP_STATS_INST0m,
...
static bcmcth_dlb_drv_t bcm56996_a0_cth_dlb_drv = {
    .ecmp_init = bcm56996_a0_cth_dlb_ecmp_init,
    .ecmp_cleanup = bcm56996_a0_cth_dlb_ecmp_cleanup,
    .grp_cnt_get = bcm56996_a0_cth_dlb_grp_cnt_get,
    .ecmp_set = bcm56996_a0_cth_dlb_ecmp_set,
    .ecmp_del = bcm56996_a0_cth_dlb_ecmp_del,
    .ecmp_pctl_set = bcm56996_a0_cth_dlb_ecmp_pctl_set,
    .ecmp_pctl_del = bcm56996_a0_cth_dlb_ecmp_pctl_del,
    .ecmp_recover = bcm56996_a0_cth_dlb_ecmp_grp_info_recover,
    .ecmp_stats_set = bcm56996_a0_cth_dlb_ecmp_stats_set,
    .ecmp_stats_get = bcm56996_a0_cth_dlb_ecmp_stats_get,
};
...
bcmcth_dlb_drv_t *
bcm56996_a0_cth_dlb_drv_get(int unit)
{
    return &bcm56996_a0_cth_dlb_drv;
}
