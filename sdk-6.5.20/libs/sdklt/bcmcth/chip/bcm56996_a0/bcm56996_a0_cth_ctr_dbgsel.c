/*! \file bcm56996_a0_cth_ctr_dbgsel.c
 *
 * BCM56996 A0 device specific ING/EGR Debug Counter Trigger Selection Driver.
 */
/*
...
static void
bcm56996_a0_ctr_dbgsel_enum2bit_map_init(bool ingress, int *enum2bit)
{
    if (ingress) {
...
static int
bcm56996_a0_ctr_ing_dbgsel_set(int unit, int op, uint8_t ridx, int *enum2bit,
...
static int
bcm56996_a0_ctr_egr_dbgsel_set(int unit, int op, uint8_t ridx, int *enum2bit,
                               ctr_dbgsel_trigger_t *trigger_array)
{
...
static int
bcm56996_a0_ctr_dbgsel_set(int unit,
                           bool ingress,
                           int op,
                           uint8_t idx,
                           ctr_dbgsel_trigger_t *trigger_array)
{
    ...
    bcm56996_a0_ctr_dbgsel_enum2bit_map_init(ingress, enum2bit);

    if (ingress) {
        SHR_IF_ERR_EXIT
            (bcm56996_a0_ctr_ing_dbgsel_set(unit, op, idx, enum2bit,
                                            trigger_array));
    } else {
        SHR_IF_ERR_EXIT
            (bcm56996_a0_ctr_egr_dbgsel_set(unit, op, idx, enum2bit,
                                            trigger_array));
    }
...
static bcmcth_ctr_dbgsel_drv_t bcm56996_a0_ctr_dbgsel_drv = {
   .dbgsel_set = &bcm56996_a0_ctr_dbgsel_set,
};
...
bcm56996_a0_cth_ctr_dbgsel_drv_get(int unit)
{
    return &bcm56996_a0_ctr_dbgsel_drv;
}
