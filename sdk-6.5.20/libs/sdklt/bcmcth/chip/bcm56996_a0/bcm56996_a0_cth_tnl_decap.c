/*! \file bcm56996_a0_cth_tnl_decap.c
 *
 * This file defines the detach, attach routines of
 * TNL decap driver for bcm56996_a0.
 */
/*
...
#define BCM56996_A0_BOS_ACTION_L3_IIF                   2
#define BCM56996_A0_BOS_ACTION_SWAP_NHI                 3
#define BCM56996_A0_BOS_ACTION_L3_NHI                   4
#define BCM56996_A0_BOS_ACTION_L3_ECMP                  5
#define BCM56996_A0_BOS_ACTION_SWAP_ECMP                6

#define BCM56996_A0_NON_BOS_ACTION_POP                  1
#define BCM56996_A0_NON_BOS_ACTION_PHP_NHI              2
#define BCM56996_A0_NON_BOS_ACTION_SWAP_NHI             3
#define BCM56996_A0_NON_BOS_ACTION_SWAP_ECMP            4
#define BCM56996_A0_NON_BOS_ACTION_PHP_ECMP             5

uint32_t bcm56996_a0_tnl_mpls_decap_hw_sid[] = {
    MPLS_ENTRY_SINGLEm,
    L3_TUNNEL_SINGLEm,
};

bcmptm_rm_hash_entry_mode_t bcm56996_a0_tnl_mpls_entry_attrs_list[] = {
 ...
 */
static int
bcm56996_a0_tnl_mpls_decap_lt_fid_to_hw_fid(int unit,
                                            uint32_t lt_fid,
                                            uint32_t bos_action,
                                            ...
                                            uint32_t *hw_fid)
{
    ...
    switch (lt_fid) {
        ...
        case TNL_MPLS_DECAPt_L3_IIF_IDf:
            if (bos_action != BCM56996_A0_BOS_ACTION_L3_IIF) {
                SHR_ERR_EXIT(SHR_E_PARAM);
            }
            *hw_fid = MPLSv_L3_IIFf;
            break;
        case TNL_MPLS_DECAPt_NHOP_IDf:
            if ((bos_action != BCM56996_A0_BOS_ACTION_SWAP_NHI) &&
                (bos_action != BCM56996_A0_BOS_ACTION_L3_NHI) &&
                (non_bos_action != BCM56996_A0_NON_BOS_ACTION_PHP_NHI) &&
                (non_bos_action != BCM56996_A0_NON_BOS_ACTION_SWAP_NHI)) {
                SHR_ERR_EXIT(SHR_E_PARAM);
            }
            *hw_fid = MPLSv_NEXT_HOP_INDEXf;
            break;
        case TNL_MPLS_DECAPt_ECMP_IDf:
            if ((bos_action != BCM56996_A0_BOS_ACTION_L3_ECMP) &&
                (bos_action != BCM56996_A0_BOS_ACTION_SWAP_ECMP) &&
                (non_bos_action != BCM56996_A0_NON_BOS_ACTION_SWAP_ECMP) &&
                (non_bos_action != BCM56996_A0_NON_BOS_ACTION_PHP_ECMP)) {
                SHR_ERR_EXIT(SHR_E_PARAM);
            }
...
static int
bcm56996_a0_tnl_mpls_decap_trunk_lt_fid_to_hw_fid(int unit,
                                                  uint32_t lt_fid,
                                                  uint32_t bos_action,
                                                  uint32_t non_bos_action,
                                                  uint32_t *hw_fid)
...
static int
bcm56996_a0_tnl_decap_lt_to_hw_map(int unit,
                                   bcmltd_sid_t lt_sid,
                                   bcmdrd_sid_t sid,
                                   ...
                                   uint32_t **edw)
{
    ...
    for (i = 0; i < count; i++) {
        ...
        if (lt_sid == TNL_MPLS_DECAPt) {
            rv = bcm56996_a0_tnl_mpls_decap_lt_fid_to_hw_fid(unit,
                                                             fid,
                                                             bos_action,
                                                             non_bos_action,
                                                             &hw_fid);
        } else if (lt_sid == TNL_MPLS_DECAP_TRUNKt) {
            rv = bcm56996_a0_tnl_mpls_decap_trunk_lt_fid_to_hw_fid(unit,
                                                                   fid,
                                                                   bos_action,
                                                                   non_bos_action,
                                                                   &hw_fid);
...
static int
bcm56996_a0_tnl_decap_hw_to_lt_map(int unit,
                                   bcmltd_sid_t lt_sid,
                                   bcmdrd_sid_t sid,
                                   uint32_t **ekw,
                                   uint32_t **edw,
...
bcmcth_tnl_decap_drv_t bcm56996_a0_tnl_decap_drv = {
    .sid_count = 2,
    .sid_list = bcm56996_a0_tnl_mpls_decap_hw_sid,
    .entry_attrs_list = bcm56996_a0_tnl_mpls_entry_attrs_list,
    .mpls_decap_lt_to_hw_map = bcm56996_a0_tnl_decap_lt_to_hw_map,
    .mpls_decap_hw_to_lt_map = bcm56996_a0_tnl_decap_hw_to_lt_map,
};

bcmcth_tnl_decap_drv_t *
bcm56996_a0_cth_tnl_decap_drv_get(int unit)
{
    return &bcm56996_a0_tnl_decap_drv;
}
