/*! \file bcm56996_a0_cth_ctr_eflex.c
 *
...
/*! Slim counters are organised coloumn wise . */
...
static bcmcth_ctr_eflex_device_info_t bcm56996_a0_device_info = {
...
static int
bcm56996_a0_cth_ctr_eflex_ctr_table_get(int unit,
                                        bool ingress,
...
static int
bcm56996_a0_cth_ctr_eflex_device_info_get(
    int unit,
    bcmcth_ctr_eflex_device_info_t **device_info)
{
    SHR_FUNC_ENTER(unit);

    *device_info = &bcm56996_a0_device_info;
...
static int
bcm56996_a0_cth_ctr_eflex_action_reg_set(int unit,
                                         bool enable,
...
static int
bcm56996_a0_cth_ctr_eflex_action_table_0_write(
    int unit,
    ctr_eflex_action_profile_data_t *entry)
{
    bcmbd_pt_dyn_info_t pt_dyn_info = {0};
...
static int
bcm56996_a0_cth_ctr_eflex_action_table_1_write(
    int unit,
    ctr_eflex_action_profile_data_t *entry)
{
    bcmbd_pt_dyn_info_t pt_dyn_info = {0};
...
static int
bcm56996_a0_cth_ctr_eflex_action_table_write(
    int unit,
    ctr_eflex_action_profile_data_t *entry)
{
    SHR_FUNC_ENTER(unit);
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56996_a0_cth_ctr_eflex_action_table_0_write(unit, entry));

    /* Write ACTION_TABLE_1 entry */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56996_a0_cth_ctr_eflex_action_table_1_write(unit, entry));
...
static int
bcm56996_a0_cth_ctr_eflex_op_profile_write(
    int unit,
...
static int
bcm56996_a0_cth_ctr_eflex_range_chk_write(
    int unit,
...
static int
bcm56996_a0_cth_ctr_eflex_trigger_write(
    int unit,
...
static int
bcm56996_a0_cth_ctr_eflex_trigger_read(
    int unit,
    ctr_eflex_trigger_data_t *entry)
{
    bcmbd_pt_dyn_info_t pt_dyn_info = {0};
...
/*! Get object id */
static int
bcm56996_a0_cth_ctr_eflex_object_id_get(int unit, int sel, uint64_t data)
{
...
/*! Get object index */
static int
bcm56996_a0_cth_ctr_eflex_object_idx_get(int unit, int sel, int data)
{
    int obj_sz;
    int val, rt;
...
static int
bcm56996_a0_cth_ctr_eflex_action_zone_get(int unit, int sel, uint32_t action)
{
...
static int
bcm56996_a0_cth_state_eflex_group_action_write(
    int unit,
    ctr_eflex_group_action_data_t *entry)
{
    ...
    num_insts = bcm56996_a0_device_info.num_pipe_instance;
...
static int
bcm56996_a0_cth_ctr_eflex_error_stats_write(
    int unit,
...
static int
bcm56996_a0_cth_ctr_eflex_error_stats_read(
    int unit,
    ctr_eflex_error_stats_data_t *entry)
{
    bcmbd_pt_dyn_info_t pt_dyn_info = {0};
...
static int
bcm56996_a0_cth_ctr_eflex_pipe_valid_check(int unit,
                                           bool ingress,
                                           uint32_t pipe,
                                           bool *valid)
{
 ...
 */
static int
bcm56996_a0_cth_ctr_eflex_update_control_get(
        int unit,
        bool ingress,
...
static int
bcm56996_a0_cth_ctr_eflex_obj_quant_write(int unit,
 ...
 */
static int
bcm56996_a0_cth_ctr_eflex_obj_quant_imm_reg(int unit, bool *imm_reg)
{
    SHR_FUNC_ENTER(unit);
...
static bcmcth_ctr_eflex_drv_t bcm56996_a0_cth_ctr_eflex_drv = {
    .device_info_get_fn = bcm56996_a0_cth_ctr_eflex_device_info_get,
    .ctr_table_get_fn   = bcm56996_a0_cth_ctr_eflex_ctr_table_get,
    .action_reg_set_fn  = bcm56996_a0_cth_ctr_eflex_action_reg_set,
    .action_table_write_fn = bcm56996_a0_cth_ctr_eflex_action_table_write,
    .op_profile_write_fn = bcm56996_a0_cth_ctr_eflex_op_profile_write,
    .range_chk_write_fn = bcm56996_a0_cth_ctr_eflex_range_chk_write,
    .trigger_write_fn = bcm56996_a0_cth_ctr_eflex_trigger_write,
    .trigger_read_fn = bcm56996_a0_cth_ctr_eflex_trigger_read,
    .object_id_get_fn = bcm56996_a0_cth_ctr_eflex_object_id_get,
    .object_idx_get_fn = bcm56996_a0_cth_ctr_eflex_object_idx_get,
    .action_zone_get_fn = bcm56996_a0_cth_ctr_eflex_action_zone_get,
    .group_action_write_fn = bcm56996_a0_cth_state_eflex_group_action_write,
    .error_stats_write_fn = bcm56996_a0_cth_ctr_eflex_error_stats_write,
    .error_stats_read_fn = bcm56996_a0_cth_ctr_eflex_error_stats_read,
    .pipe_valid_check_fn = bcm56996_a0_cth_ctr_eflex_pipe_valid_check,
    .update_control_get_fn = bcm56996_a0_cth_ctr_eflex_update_control_get,
    .obj_quant_write_fn = bcm56996_a0_cth_ctr_eflex_obj_quant_write,
    .obj_quant_imm_reg_fn = bcm56996_a0_cth_ctr_eflex_obj_quant_imm_reg
};
...
bcm56996_a0_cth_ctr_eflex_drv_get(int unit)
{
    return &bcm56996_a0_cth_ctr_eflex_drv;
}

bcmcth_state_eflex_drv_t *
bcm56996_a0_cth_state_eflex_drv_get(int unit)
{
    return NULL;
}
