...
#define BCM56996_FAST_TRUNK_SIZE 64
...
static bcmdrd_fid_t mem_fids[BCM56996_FAST_TRUNK_SIZE] = {
...
static int
bcm56996_a0_trunk_block_mask_set(int unit,
...
static int
bcm56996_a0_trunk_fast_grp_populate(int unit, const bcmltd_op_arg_t *op_arg,
                                    bcmltd_sid_t lt_id,
                                    bcmcth_trunk_fast_group_param_t *param)
{
    ...
    trunk_id =  param->id;
    /* On TH4G, fast trunk hw table are split into two tables. */
...
static int
bcm56996_a0_trunk_fast_grp_add(int unit,
                               const bcmltd_op_arg_t *op_arg,
                               bcmltd_sid_t lt_id,
                               bcmcth_trunk_fast_group_param_t *param)
{
    ...
    trunk_id = param->id;
    SHR_IF_ERR_EXIT
        (bcm56996_a0_trunk_fast_grp_populate(unit, op_arg, lt_id, param));
    ...
    if (BCMDRD_PBMP_NOT_NULL(new_trunk_bmp)) {
        SHR_IF_ERR_EXIT
            (bcm56996_a0_trunk_block_mask_set(unit,
                                              op_arg,
                                              lt_id,
                                              old_trunk_bmp,
                                              new_trunk_bmp,
...
static int
bcm56996_a0_trunk_fast_grp_del(int unit,
                               const bcmltd_op_arg_t *op_arg,
                               bcmltd_sid_t lt_id,
                               bcmcth_trunk_fast_group_param_t *param,
                               bcmcth_trunk_fast_group_t *grp)
{
    ...
    if (BCMDRD_PBMP_NOT_NULL(old_trunk_bmp)) {
        SHR_IF_ERR_EXIT
            (bcm56996_a0_trunk_block_mask_set(unit, op_arg, lt_id,
...
static int
bcm56996_a0_trunk_fast_grp_update(int unit,
                                  const bcmltd_op_arg_t *op_arg,
                                  bcmltd_sid_t lt_id,
                                  bcmcth_trunk_fast_group_param_t *param,
                                  bcmcth_trunk_fast_group_t *grp)
...
static int
bcm56996_a0_trunk_fast_grp_init(int unit, bcmcth_trunk_fgrp_bk_t *fgrp_bk)
{
    SHR_FUNC_ENTER(unit);
    fgrp_bk->max_members = BCM56996_FAST_TRUNK_SIZE;
...
static int
bcm56996_a0_trunk_failover_add(int unit,
                               const bcmltd_op_arg_t *op_arg,
                               bcmltd_sid_t lt_id,
...
static int
bcm56996_a0_trunk_failover_del(int unit,
                               const bcmltd_op_arg_t *op_arg,
                               bcmltd_sid_t lt_id,
                               bcmcth_trunk_failover_param_t *param)
{
...
static int
bcm56996_a0_trunk_failover_update(int unit,
                                  const bcmltd_op_arg_t *op_arg,
                                  bcmltd_sid_t lt_id,
                                  bcmcth_trunk_failover_param_t *param,
...
static int
bcm56996_a0_trunk_failover_init(int unit,
...
static bcmcth_trunk_drv_t bcm56996_a0_cth_trunk_drv = {
    .fn_trunk_mode_set   = NULL,
    .fn_grp_add          = NULL,
    .fn_grp_update       = NULL,
    .fn_grp_del          = NULL,
    .fn_grp_init         = NULL,
    .fn_fast_grp_add     = &bcm56996_a0_trunk_fast_grp_add,
    .fn_fast_grp_del     = &bcm56996_a0_trunk_fast_grp_del,
    .fn_fast_grp_update  = &bcm56996_a0_trunk_fast_grp_update,
    .fn_fast_grp_init    = &bcm56996_a0_trunk_fast_grp_init,
    .fn_failover_add     = &bcm56996_a0_trunk_failover_add,
    .fn_failover_del     = &bcm56996_a0_trunk_failover_del,
    .fn_failover_update  = &bcm56996_a0_trunk_failover_update,
    .fn_failover_init    = &bcm56996_a0_trunk_failover_init
};
...
bcmcth_trunk_drv_t *
bcm56996_a0_cth_trunk_drv_get(int unit)
{
    return &bcm56996_a0_cth_trunk_drv;
}
