/*! \file bcm56996_a0_cth_tnl_mpls_prot.c
 *
 * This file defines the detach, attach routines of
 * TNL mpls protection switching driver for bcm56996_a0.
 */
/*
 ...
 */
static int
bcm56996_a0_tnl_mpls_prot_enable_set(int unit, const bcmltd_op_arg_t *op_arg,
 ...
 */
static int
bcm56996_a0_tnl_mpls_prot_enable_get(int unit, const bcmltd_op_arg_t *op_arg,
                                     bcmltd_sid_t lt_id, uint32_t nhop_id,
                                     bool *prot)
{
    PROT_NHI_TABLE_1m_t prot_buf;
 ...
 */
/* Driver structure. */
bcmcth_tnl_mpls_prot_drv_t bcm56996_a0_tnl_mpls_prot_drv = {
    .mpls_prot_set = bcm56996_a0_tnl_mpls_prot_enable_set,
    .mpls_prot_get = bcm56996_a0_tnl_mpls_prot_enable_get,
};

bcmcth_tnl_mpls_prot_drv_t *
bcm56996_a0_cth_tnl_mpls_prot_drv_get(int unit)
{
    return &bcm56996_a0_tnl_mpls_prot_drv;
}
