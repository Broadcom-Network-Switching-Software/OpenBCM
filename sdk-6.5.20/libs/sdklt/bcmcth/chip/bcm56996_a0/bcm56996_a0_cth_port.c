/*! \file bcm56996_a0_cth_port.c
 *
 * bcm56996_a0 PORT drivers.
 */
/*
...
/* Every TH4G port mirror reported block carries this signature */
#define BCM_CTH_PORT_BLK_SIGNATURE  0x96996ABC
/*******************************************************************************
 * Typedefs
 */
...
static int
bcm56996_a0_port_mirror_generic_port_tab_pt_write(int unit,
                                                  bool is_port_tab,
                                                  bcmltd_sid_t lt_id,
...
static int
bcm56996_a0_port_mirror_port_tab_pt_write(int unit,
                                          bcmltd_sid_t lt_id,
                                          const bcmltd_op_arg_t *op_arg,
                                          shr_port_t port,
                                          uint32_t container,
                                          bool mirror_enable)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56996_a0_port_mirror_generic_port_tab_pt_write(unit,
                                                           TRUE,
                                                           lt_id,
                                                           op_arg,
...
static int
bcm56996_a0_port_mirror_lport_tab_pt_write(int unit,
                                           bcmltd_sid_t lt_id,
                                           const bcmltd_op_arg_t *op_arg,
                                           int tbl_inst,
                                           ...
                                           bool mirror_enable)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56996_a0_port_mirror_generic_port_tab_pt_write(
             unit,
             FALSE,
             lt_id,
             op_arg,
...
static int
bcm56996_a0_port_i_mirror_control_pt_write(int unit,
                                           bcmltd_sid_t lt_id,
                                           const bcmltd_op_arg_t *op_arg,
                                           shr_port_t port,
                                           uint32_t container,
...
static int
bcm56996_a0_port_e_mirror_control_pt_write(int unit,
                                           bcmltd_sid_t lt_id,
                                           const bcmltd_op_arg_t *op_arg,
                                           shr_port_t port,
                                           uint32_t container,
...
static int
bcm56996_a0_port_emirror_control_pt_write(int unit,
                                          bcmltd_sid_t lt_id,
                                          const bcmltd_op_arg_t *op_arg,
                                          shr_port_t iport,
                                          shr_port_t eport,
...
static int
bcm56996_a0_port_tab_fields_set(
    int unit,
    const bcmltd_op_arg_t *op_arg,
    bcmltd_sid_t lt_id,
    shr_port_t port,
...
static int
bcm56996_a0_egr_port_fields_set(
    int unit,
    const bcmltd_op_arg_t *op_arg,
    bcmltd_sid_t lt_id,
    shr_port_t port,
...
static int
bcm56996_a0_ing_en_efilter_bmp_fields_set(
    int unit,
    const bcmltd_op_arg_t *op_arg,
    bcmltd_sid_t lt_id,
    shr_port_t port,
...
static int
bcm56996_a0_cth_port_membership_policy_get(int unit, const bcmltd_op_arg_t *op_arg,
...
static int
bcm56996_a0_cth_port_membership_policy_set(
    int unit,
    const bcmltd_op_arg_t *op_arg,
    bcmltd_sid_t lt_id,
    shr_port_t port,
    port_membership_policy_info_t *lt_info)
{
    ...
    if (port_tab_update) {
        SHR_IF_ERR_EXIT
            (bcm56996_a0_port_tab_fields_set(unit,
                                             op_arg,
                                             lt_id,
                                             port,
                                             lt_info));
    ...
    if (egr_port_update) {
        SHR_IF_ERR_EXIT
            (bcm56996_a0_egr_port_fields_set(unit,
                                             op_arg,
                                             lt_id,
                                             port,
                                             lt_info));
    ...
    if (ing_en_efilter_bitmap_update) {
        SHR_IF_ERR_EXIT
            (bcm56996_a0_ing_en_efilter_bmp_fields_set(unit,
                                                       op_arg,
                                                       lt_id,
                                                       port,
                                                       lt_info));
...
static int
bcm56996_a0_cth_port_bridge_get(int unit,
                                const bcmltd_op_arg_t *op_arg,
                                bcmltd_sid_t lt_id,
                                shr_port_t port,
                                bool *bridge)
...
static int
bcm56996_a0_cth_port_bridge_set(int unit,
                                const bcmltd_op_arg_t *op_arg,
                                bcmltd_sid_t lt_id,
                                shr_port_t port,
                                bool bridge)
...
static int
bcm56996_a0_cth_port_ingress_mirror_set(int unit,
                                        const bcmltd_op_arg_t *op_arg,
                                        bcmltd_sid_t lt_id,
                                        port_imirror_t *cfg,
                                        bool mirror_enable)
{
    ...
    /* Update PORT_TABm */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56996_a0_port_mirror_port_tab_pt_write(unit,
                                                   lt_id,
                                                   op_arg,
                                                   iport,
                                                   container,
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56996_a0_port_i_mirror_control_pt_write(unit,
                                                    lt_id,
                                                    op_arg,
                                                    iport,
                                                    container,
...
static int
bcm56996_a0_cth_port_egress_mirror_set(int unit,
                                       const bcmltd_op_arg_t *op_arg,
                                       bcmltd_sid_t lt_id,
                                       port_emirror_t *cfg,
                                       bool mirror_enable)
{
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56996_a0_port_emirror_control_pt_write(unit,
                                                   lt_id,
                                                   op_arg,
                                                   iport,
                                                   eport,
    ...
    if (mirror_enable || update_emtp) {
        SHR_IF_ERR_VERBOSE_EXIT
            (bcm56996_a0_port_e_mirror_control_pt_write(unit,
                                                        lt_id,
                                                        op_arg,
                                                        eport,
                                                        container,
...
static int
bcm56996_a0_cth_port_system_ing_mirror_profile_set(
    int unit,
    const bcmltd_op_arg_t *op_arg,
    bcmltd_sid_t lt_id,
    int tbl_inst,
    ...
    bool mirror_enable)
{
    ...
    /* Update LPORT_TABm */
    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56996_a0_port_mirror_lport_tab_pt_write(unit,
                                                    lt_id,
                                                    op_arg,
                                                    tbl_inst,
                                                    port_system_profile_id,
...
static int
bcm56996_a0_cth_port_svp_ingress_mirror_set(int unit,
                                            const bcmltd_op_arg_t *op_arg,
                                            bcmltd_sid_t lt_id,
                                            port_imirror_t *cfg,
                                            bool mirror_enable)
...
static int
bcm56996_a0_cth_port_svp_ingress_mirror_get(int unit,
                                            const bcmltd_op_arg_t *op_arg,
                                            bcmltd_sid_t lt_id,
                                            port_imirror_t *cfg,
                                            bool *mirror_enable)
...
static int
bcm56996_a0_cth_port_deinit(int unit)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56996_a0_cth_port_init(int unit, bool warm)
{
...
bcm56996_a0_cth_port_drv = {
   .port_init = bcm56996_a0_cth_port_init,
   .port_deinit = bcm56996_a0_cth_port_deinit,
   .port_bridge_get = bcm56996_a0_cth_port_bridge_get,
   .port_bridge_set = bcm56996_a0_cth_port_bridge_set,
   .port_membership_policy_get = bcm56996_a0_cth_port_membership_policy_get,
   .port_membership_policy_set = bcm56996_a0_cth_port_membership_policy_set,
   .port_egress_mirror_set = bcm56996_a0_cth_port_egress_mirror_set,
   .port_ingress_mirror_set = bcm56996_a0_cth_port_ingress_mirror_set,
   .port_modid_get = NULL,
   .port_system_ing_mirror_profile_set =
       bcm56996_a0_cth_port_system_ing_mirror_profile_set,
   .port_svp_ingress_mirror_set = bcm56996_a0_cth_port_svp_ingress_mirror_set,
   .port_svp_ingress_mirror_get = bcm56996_a0_cth_port_svp_ingress_mirror_get,
};
 ...
 */
bcmcth_port_drv_t *
bcm56996_a0_cth_port_drv_get(int unit)
{
    return &bcm56996_a0_cth_port_drv;
}
