/*! \file bcm56996_a0_cth_l3_bank.c
 *
 * This file defines the chip-specific routines of
 * L3 bank driver for bcm56996_a0.
 */
/*
...
static bcmltd_sid_t bcm56996_a0_cth_l3_nhop_lt_sid[] = {
    L3_UC_NHOPt,
    L3_MC_NHOPt,
...
static bcmltd_sid_t bcm56996_a0_cth_l3_eif_lt_sid[] = {
    L3_EIFt
};
/*******************************************************************************
 * Private functions
 ...
 */
static int
bcm56996_a0_l3_bank_encode(int unit,
 ...
 */
static int
bcm56996_a0_l3_bank_decode(int unit,
                           bcmcth_l3_bank_t *l3_bank)
{
   int count = 0;
 ...
 */
static int
bcm56996_a0_l3_bank_set(int unit,
 ...
 */
static int
bcm56996_a0_l3_bank_get(int unit,
                        const bcmltd_op_arg_t *op_arg,
                        bcmltd_sid_t lt_id,
                        bcmcth_l3_bank_t *l3_bank,
                        bool ireq)
 ...
 */
/* Driver structure. */
static bcmcth_l3_bank_drv_t bcm56996_a0_cth_l3_bank_drv = {
    .nhop_lt_id_count = NHOP_BANK_LT_SID_COUNT,
    .nhop_lt_id_list = bcm56996_a0_cth_l3_nhop_lt_sid,
    .eif_lt_id_count = EIF_BANK_LT_SID_COUNT,
    .eif_lt_id_list = bcm56996_a0_cth_l3_eif_lt_sid,
    .nhop_bank_index_offset = NHOP_BANK_INDEX_OFFSET,
    .eif_bank_index_offset = EIF_BANK_INDEX_OFFSET,
    .l3_bank_encode = bcm56996_a0_l3_bank_encode,
    .l3_bank_decode = bcm56996_a0_l3_bank_decode,
    .l3_bank_set = bcm56996_a0_l3_bank_set,
    .l3_bank_get = bcm56996_a0_l3_bank_get,
};

bcmcth_l3_bank_drv_t *
bcm56996_a0_cth_l3_bank_drv_get(int unit)
{
    return &bcm56996_a0_cth_l3_bank_drv;
}
