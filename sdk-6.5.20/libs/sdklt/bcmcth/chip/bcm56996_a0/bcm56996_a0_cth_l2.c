/*! \file bcm56996_a0_cth_l2.c
 *
 * L2 learn drivers for bcm56996 A0.
 */
/*
...
static int
bcm56996_a0_cth_l2_intr_enable(int unit, int enable)
{
    bcmcth_l2_drv_t *drv;
...
static int
bcm56996_a0_cth_l2_intr_handler_set(int unit, bcmcth_l2_drv_intr_handler_f cb)
{
    bcmcth_l2_drv_t *drv;
    bcmcth_l2_pipe_info_t *pi;
    uint32_t idx;
...
static int
bcm56996_a0_cth_l2_hw_enable(int unit, uint32_t trans_id, bool enable)
{
...
static int
bcm56996_a0_cth_l2_cache_traverse(int unit, l2_trav_status_t *status)
{
    bcmcth_l2_drv_t *drv;
    bcmcth_l2_pipe_info_t *pi;
...
static int
bcm56996_a0_cth_l2_entry_delete(int unit, void *data)
{
    bcmcth_l2_drv_t *drv;
    bcmcth_l2_pipe_info_t *pi;
...
static int
bcm56996_a0_cth_l2_entry_parse(int unit, const bcmltd_field_t *key,
...
static int
bcm56996_a0_cth_l2_init(int unit, bool warm)
{
    bcmcth_l2_drv_t *drv;
    bcmcth_l2_pipe_info_t *pi;
...
static int
bcm56996_a0_cth_l2_cleanup(int unit)
{
    SHR_FUNC_ENTER(unit);
...
int
bcm56996_a0_cth_l2_attach(int unit)
{
    ...
    drv->init = bcm56996_a0_cth_l2_init;
    drv->cleanup = bcm56996_a0_cth_l2_cleanup;
    drv->hw_enable = bcm56996_a0_cth_l2_hw_enable;
    drv->intr_enable = bcm56996_a0_cth_l2_intr_enable;
    drv->intr_handler_set = bcm56996_a0_cth_l2_intr_handler_set;
    drv->cache_traverse = bcm56996_a0_cth_l2_cache_traverse;
    drv->entry_delete = bcm56996_a0_cth_l2_entry_delete;
    drv->entry_parse = bcm56996_a0_cth_l2_entry_parse;
