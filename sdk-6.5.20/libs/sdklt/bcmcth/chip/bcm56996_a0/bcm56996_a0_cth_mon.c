    ...
    bcmcth_mon_ctr_t *entry)
{
    ...
    switch (op) {
        case BCMCTH_MON_CTR_OP_CLR:
            SHR_IF_ERR_EXIT
                (bcm56996_a0_cth_mon_ctr_clr(unit, trans_id, lt_id));
            break;
        case BCMCTH_MON_CTR_OP_GET:
            SHR_NULL_CHECK(entry, SHR_E_PARAM);
            SHR_IF_ERR_EXIT
                (bcm56996_a0_cth_mon_ctr_get(unit, trans_id, lt_id, entry));
            break;
        default:
            break;
    }
...
static int
bcm56996_a0_mon_telemetry_attrs_info_get(
    int unit,
...
static int
bcm56996_a0_mon_telemetry_field_info_index_map(int unit, uint32_t fld_enum,
                                               uint32_t *fld_index)
{
...
static int
bcm56996_a0_mon_telemetry_field_info_get(
    int unit,
    bcmcth_mon_inband_telemetry_metadata_field_t *field_info)
{
    ...
    SHR_FUNC_ENTER(unit);
    SHR_IF_ERR_EXIT
        (bcm56996_a0_mon_telemetry_field_info_index_map(unit,
                                                        field_info->fld_enum,
                                                        &index));
...
static int
bcm56996_a0_cth_mon_deinit(int unit)
{
    return SHR_E_NONE;
}

static int
bcm56996_a0_cth_mon_init(int unit, bool warm)
{
    return SHR_E_NONE;
}
...
static bcmcth_mon_drv_t bcm56996_a0_cth_mon_drv = {
   .mon_init = &bcm56996_a0_cth_mon_init,
   .mon_deinit = &bcm56996_a0_cth_mon_deinit,
   .ctr_op = &bcm56996_a0_cth_mon_ctr_op,
   .telemetry_attrs_info = &bcm56996_a0_mon_telemetry_attrs_info_get,
   .telemetry_field_info = &bcm56996_a0_mon_telemetry_field_info_get,
};
...
bcmcth_mon_drv_t *
bcm56996_a0_cth_mon_drv_get(int unit)
{
    return &bcm56996_a0_cth_mon_drv;
}
