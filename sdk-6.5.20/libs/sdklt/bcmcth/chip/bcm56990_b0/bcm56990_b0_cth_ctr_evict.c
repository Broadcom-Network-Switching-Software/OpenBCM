/*! \file bcm56990_b0_cth_ctr_evict.c
 *
...
static int
bcm56990_b0_cth_ctr_evict_entry_update(int unit,
                                    bcmltd_sid_t ltid,
                                    uint32_t trans_id,
...
static int
bcm56990_b0_cth_ctr_evict_init(int unit)
{
    bcmdrd_sid_t        sid;
    uint32_t            *entry_buf = NULL;
    uint32_t            entry_sz;
...
static bcmcth_ctr_evict_drv_t bcm56990_b0_cth_ctr_evict_drv = {
        .evict_init_fn = &bcm56990_b0_cth_ctr_evict_init,
        .evict_entry_update_fn = &bcm56990_b0_cth_ctr_evict_entry_update,
};
...
bcm56990_b0_cth_ctr_evict_drv_get(int unit)
{
    return &bcm56990_b0_cth_ctr_evict_drv;
}
