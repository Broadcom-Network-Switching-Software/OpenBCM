...
#include <bcmdrd/chip/bcm56996_a0_sig.h>

/* Block types */
const char *bcm56996_a0_drd_blktype_names[] = {
    "null",
    "avs",
    "cdport",
    "cmic",
...
/* Block structures */
bcmdrd_block_t bcm56996_a0_drd_blocks[] =
{
    ...
    { BLKTYPE_CDPORT,                   102,   {{0x00000000}} },
    { BLKTYPE_CDPORT,                   103,   {{0x00000000}} },
    { BLKTYPE_CDPORT,                   104,   {{0x00000000}} },
    { BLKTYPE_CDPORT,                   105,   {{0x00000000}} },
    { BLKTYPE_CDPORT,                   106,   {{0x00000000}} },
    { BLKTYPE_CDPORT,                   107,   {{0x00000000}} },
    { BLKTYPE_CDPORT,                   108,   {{0x00000000}} },
    { BLKTYPE_CDPORT,                   109,   {{0x00000000}} },
...
const int bcm56996_a0_drd_blktype_start_idx[] = {
    0, 89, 0, 0, 82, 90, 81, 88, 72, 93, 84, 85, 83, 92, 91, 87, 86, 80
};

/* Symbol table */
#if BCMDRD_CONFIG_INCLUDE_CHIP_SYMBOLS == 1
extern bcmdrd_symbols_t bcm56996_a0_drd_symbols;
#endif

/* Declare function first to prevent compiler warnings */
extern uint32_t
bcm56996_a0_drd_blockport_addr(int block, int lane, uint32_t offset,
                               uint32_t idx);
...
/* Declare function first to prevent compiler warnings */
extern int
bcm56996_a0_drd_addr_decode(const bcmdrd_symbol_t *symbol,
...
bcm56996_a0_drd_port_num_domain(bcmdrd_sid_t sid, int blktype);
...
/* Declare function first to prevent compiler warnings */
extern int
bcm56996_a0_drd_blktype_from_porttype(bcmdrd_port_type_t ptype);
...
/* Declare function first to prevent compiler warnings */
extern uint32_t
bcm56996_a0_drd_pipe_info(const bcmdrd_chip_info_t *cinfo,
...
bcmdrd_numel_info_t bcm56996_a0_drd_numel_info = {
    _numel_ranges,
    _numel_encodings
};

/* Chip information structure */
bcmdrd_chip_info_t bcm56996_a0_drd_chip_info = {

    /* Register file digest. */
    BCM56996_A0_SIGNATURE,
    ...
    18,
    bcm56996_a0_drd_blktype_names,
    bcm56996_a0_drd_blktype_start_idx,

    /* Other (non-HMI) blocks */
    94,
    bcm56996_a0_drd_blocks,
    ...
    &bcm56996_a0_drd_symbols,
#endif

    /* Variable register array info */
    &bcm56996_a0_drd_numel_info,

    /* Chip profile */
    NULL,

    /* Address calculation override */
    bcm56996_a0_drd_blockport_addr,

    /* Address decoder override */
    bcm56996_a0_drd_addr_decode,

    /* Port number domain */
    bcm56996_a0_drd_port_num_domain,

    /* Get device-specific block type from generic port type */
    bcm56996_a0_drd_blktype_from_porttype,

    /* Pipe info */
    bcm56996_a0_drd_pipe_info
