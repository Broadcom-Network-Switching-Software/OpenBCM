/*! \file bcm56996_a0_lm_drv_attach.c
 *
 * Linkscan chip-specific driver for BCM56996.
 */
/*
...
static int
bcm56996_a0_fault_check_enabled(int unit, int *enabled)
{
    *enabled = TRUE;
...
static int
bcm56996_a0_lm_port_validate(int unit, shr_port_t port)
{
 ...
 */
int
bcm56996_a0_lm_drv_attach(bcmlm_drv_t *drv)
{
    ...
    drv->fault_check_enabled = bcm56996_a0_fault_check_enabled;
    drv->port_validate = bcm56996_a0_lm_port_validate;
 ...
 */
int
bcm56996_a0_lm_drv_detach(bcmlm_drv_t *drv)
{
