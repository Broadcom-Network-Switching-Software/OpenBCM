/*! \file bcm56990_b0_lm_drv_attach.c
 *
 * Linkscan chip-specific driver for BCM56990 B0.
 */
/*
...
/* HMI base driver. */
static bcmlm_drv_t bcm56990_b0_lm_drv;

/* Remapping linkscan register bits. */
static bcmlm_fw_pport_to_lsbit_t bcm56990_b0_pport_to_lsbit[] = {
    /* pport   lsbit */
    {  258,    259 } /* Management port. */
};

static int
bcm56990_b0_fault_check_enabled(int unit, int *enabled)
{
    *enabled = TRUE;
...
static int
bcm56990_b0_lm_port_validate(int unit, shr_port_t port)
{
...
static int
bcm56990_b0_fw_linkscan_config(int unit, bcmdrd_pbmp_t pbm)
{
    int i;
    bcmlm_fw_pport_to_lsbit_t *map;

    /* Remapping physical port to linkscan bit offset. */
    map = bcm56990_b0_pport_to_lsbit;
    for (i = 0; i < COUNTOF(bcm56990_b0_pport_to_lsbit); i++) {
    ...
    return bcm56990_b0_lm_drv.hw_config(unit, pbm);
}

static int
bcm56990_b0_fw_linkscan_link_get(int unit, bcmdrd_pbmp_t *pbm)
{
    int i;
    bcmlm_fw_pport_to_lsbit_t *map;
    ...
    SHR_IF_ERR_EXIT
        (bcm56990_b0_lm_drv.hw_link_get(unit, pbm));
 ...
 */
int
bcm56990_b0_lm_drv_attach(bcmlm_drv_t *drv)
{
    ...
    sal_memcpy(&bcm56990_b0_lm_drv, drv, sizeof(bcmlm_drv_t));

    /* Install chip specific callback. */
    drv->hw_config = bcm56990_b0_fw_linkscan_config;
    drv->hw_link_get = bcm56990_b0_fw_linkscan_link_get;
    drv->fault_check_enabled = bcm56990_b0_fault_check_enabled;
    drv->port_validate = bcm56990_b0_lm_port_validate;
 ...
 */
int
bcm56990_b0_lm_drv_detach(bcmlm_drv_t *drv)
{
