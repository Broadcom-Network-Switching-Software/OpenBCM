/*! \file bcmcfg_config.h
 *
 * Config Table Handler
 *
 * This file contains the config table handler,
 */
/*
...
#ifndef BCMCFG_CONFIG_H
#define BCMCFG_CONFIG_H

#include <bcmltd/bcmltd_handler.h>

/*!
 * \brief Config table validation
 *
...
/*!
 * \brief Config table traverse first
 *
 * \param [in]  unit          Unit Number.
 * \param [in]  op_arg        Operation arguments.
...
/*!
 * \brief Config table traverse next
 *
 * \param [in]  unit          Unit Number.
 * \param [in]  op_arg        Operation arguments.
 * \param [in]  in            Input field values.
