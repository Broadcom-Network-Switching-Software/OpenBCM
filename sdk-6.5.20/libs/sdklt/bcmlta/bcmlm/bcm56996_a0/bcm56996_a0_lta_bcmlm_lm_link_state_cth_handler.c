...
/* Handler: bcm56996_a0_lta_bcmlm_lm_link_state_cth_handler */
...
bcm56996_a0_lta_bcmlm_lm_link_state_cth_handler_arg = {
    .sid = LM_LINK_STATEt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
...
bcm56996_a0_lta_bcmlm_lm_link_state_cth_handler = {
    ...
    .ha       = NULL,
    .arg      = &bcm56996_a0_lta_bcmlm_lm_link_state_cth_handler_arg
};
