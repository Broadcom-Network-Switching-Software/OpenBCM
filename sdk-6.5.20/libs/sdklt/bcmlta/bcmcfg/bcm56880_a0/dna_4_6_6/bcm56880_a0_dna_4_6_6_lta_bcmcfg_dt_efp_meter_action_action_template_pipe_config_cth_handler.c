...
bcm56880_a0_dna_4_6_6_lta_bcmcfg_dt_efp_meter_action_action_template_pipe_config_cth_handler_arg = {
    .sid = BCM56880_A0_DNA_4_6_6_DT_EFP_METER_ACTION_ACTION_TEMPLATE_PIPE_CONFIGt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcm56880_a0_dna_4_6_6_lta_bcmcfg_dt_efp_meter_action_action_template_pipe_config_cth_handler = {
    ...
    .ha       = NULL,
    .arg      = &bcm56880_a0_dna_4_6_6_lta_bcmcfg_dt_efp_meter_action_action_template_pipe_config_cth_handler_arg
};
