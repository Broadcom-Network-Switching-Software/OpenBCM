...
/* Handler: bcm56996_a0_lta_bcmimm_ser_log_status_cth_handler */
...
bcm56996_a0_lta_bcmimm_ser_log_status_cth_handler_arg = {
    .sid = SER_LOG_STATUSt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56996_a0_lta_bcmimm_ser_log_status_cth_handler_arg
};
