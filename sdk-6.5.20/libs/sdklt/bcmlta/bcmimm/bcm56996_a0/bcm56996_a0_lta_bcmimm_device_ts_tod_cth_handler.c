...
/* Handler: bcm56996_a0_lta_bcmimm_device_ts_tod_cth_handler */
...
bcm56996_a0_lta_bcmimm_device_ts_tod_cth_handler_arg = {
    .sid = DEVICE_TS_TODt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56996_a0_lta_bcmimm_device_ts_tod_cth_handler_arg
};
