...
/* Handler: bcm56996_a0_lta_bcmimm_tm_pfc_egr_cth_handler */
...
bcm56996_a0_lta_bcmimm_tm_pfc_egr_cth_handler_arg = {
    .sid = TM_PFC_EGRt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56996_a0_lta_bcmimm_tm_pfc_egr_cth_handler_arg
};
