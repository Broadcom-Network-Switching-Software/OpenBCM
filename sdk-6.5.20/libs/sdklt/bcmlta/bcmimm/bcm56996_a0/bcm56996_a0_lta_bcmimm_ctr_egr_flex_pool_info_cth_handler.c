...
/* Handler: bcm56996_a0_lta_bcmimm_ctr_egr_flex_pool_info_cth_handler */
...
bcm56996_a0_lta_bcmimm_ctr_egr_flex_pool_info_cth_handler_arg = {
    .sid = CTR_EGR_FLEX_POOL_INFOt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56996_a0_lta_bcmimm_ctr_egr_flex_pool_info_cth_handler_arg
};
