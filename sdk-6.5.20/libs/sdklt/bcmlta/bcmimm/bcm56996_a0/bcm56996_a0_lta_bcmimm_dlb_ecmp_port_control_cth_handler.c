...
/* Handler: bcm56996_a0_lta_bcmimm_dlb_ecmp_port_control_cth_handler */
...
bcm56996_a0_lta_bcmimm_dlb_ecmp_port_control_cth_handler_arg = {
    .sid = DLB_ECMP_PORT_CONTROLt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56996_a0_lta_bcmimm_dlb_ecmp_port_control_cth_handler_arg
};
