...
/* Handler: bcm56996_a0_lta_bcmimm_pc_port_phys_map_cth_handler */
...
bcm56996_a0_lta_bcmimm_pc_port_phys_map_cth_handler_arg = {
    .sid = PC_PORT_PHYS_MAPt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56996_a0_lta_bcmimm_pc_port_phys_map_cth_handler_arg
};
