...
/* Handler: bcm56996_a0_lta_bcmimm_ctr_ing_eflex_range_chk_profile_cth_handler */
...
bcm56996_a0_lta_bcmimm_ctr_ing_eflex_range_chk_profile_cth_handler_arg = {
    .sid = CTR_ING_EFLEX_RANGE_CHK_PROFILEt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56996_a0_lta_bcmimm_ctr_ing_eflex_range_chk_profile_cth_handler_arg
};
