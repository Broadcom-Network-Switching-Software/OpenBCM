...
/* Handler: bcm56996_a0_lta_bcmimm_ctr_mirror_ing_flex_sflow_cth_handler */
...
bcm56996_a0_lta_bcmimm_ctr_mirror_ing_flex_sflow_cth_handler_arg = {
    .sid = CTR_MIRROR_ING_FLEX_SFLOWt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56996_a0_lta_bcmimm_ctr_mirror_ing_flex_sflow_cth_handler_arg
};
