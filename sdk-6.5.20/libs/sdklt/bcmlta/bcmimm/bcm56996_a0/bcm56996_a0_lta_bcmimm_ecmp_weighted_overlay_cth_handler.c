...
static uint32_t
bcm56996_a0_lta_bcmimm_ecmp_weighted_overlay_cth_handler_component_arg[1] = {
    4096,
};


const bcmltd_generic_arg_t
bcm56996_a0_lta_bcmimm_ecmp_weighted_overlay_cth_handler_arg = {
    .sid = ECMP_WEIGHTED_OVERLAYt,
    .values = 1,
    .value = bcm56996_a0_lta_bcmimm_ecmp_weighted_overlay_cth_handler_component_arg,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56996_a0_lta_bcmimm_ecmp_weighted_overlay_cth_handler_arg
};
