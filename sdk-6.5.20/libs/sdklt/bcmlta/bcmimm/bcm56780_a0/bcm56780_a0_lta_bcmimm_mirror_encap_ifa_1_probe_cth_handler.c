...
bcm56780_a0_lta_bcmimm_mirror_encap_ifa_1_probe_cth_handler_arg = {
    .sid = MIRROR_ENCAP_IFA_1_PROBEt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_lta_bcmimm_mirror_encap_ifa_1_probe_cth_handler_arg
};
