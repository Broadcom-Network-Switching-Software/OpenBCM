...
/* Handler: bcm56780_a0_lta_bcmimm_tm_oobfc_uc_q_map_profile_cth_handler */
...
bcm56780_a0_lta_bcmimm_tm_oobfc_uc_q_map_profile_cth_handler_arg = {
    .sid = TM_OOBFC_UC_Q_MAP_PROFILEt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_lta_bcmimm_tm_oobfc_uc_q_map_profile_cth_handler_arg
};
