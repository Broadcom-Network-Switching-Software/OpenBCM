...
bcm56780_a0_lta_bcmimm_oam_bfd_ipv6_endpoint_status_cth_handler_arg = {
    .sid = OAM_BFD_IPV6_ENDPOINT_STATUSt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_lta_bcmimm_oam_bfd_ipv6_endpoint_status_cth_handler_arg
};
