...
bcm56780_a0_lta_bcmimm_mon_flowtracker_hw_learn_flow_action_control_cth_handler_arg = {
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_lta_bcmimm_mon_flowtracker_hw_learn_flow_action_control_cth_handler_arg
};
