...
bcm56780_a0_lta_bcmimm_ctr_event_sync_state_control_cth_handler_arg = {
    .sid = CTR_EVENT_SYNC_STATE_CONTROLt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_lta_bcmimm_ctr_event_sync_state_control_cth_handler_arg
};
