...
/* Handler: bcm56780_a0_lta_bcmimm_vlan_ing_egr_stg_member_profile_cth_handler */
...
bcm56780_a0_lta_bcmimm_vlan_ing_egr_stg_member_profile_cth_handler_arg = {
    .sid = VLAN_ING_EGR_STG_MEMBER_PROFILEt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_lta_bcmimm_vlan_ing_egr_stg_member_profile_cth_handler_arg
};
