...
bcm56780_a0_ina_2_4_13_lta_bcmimm_mon_ing_drop_event_cth_handler_arg = {
    .sid = MON_ING_DROP_EVENTt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_ina_2_4_13_lta_bcmimm_mon_ing_drop_event_cth_handler_arg
};
