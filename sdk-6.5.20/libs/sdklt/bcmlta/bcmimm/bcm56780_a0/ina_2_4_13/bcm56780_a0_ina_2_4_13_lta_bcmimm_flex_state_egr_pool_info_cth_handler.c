...
/* Handler: bcm56780_a0_ina_2_4_13_lta_bcmimm_flex_state_egr_pool_info_cth_handler */
...
bcm56780_a0_ina_2_4_13_lta_bcmimm_flex_state_egr_pool_info_cth_handler_arg = {
    .sid = FLEX_STATE_EGR_POOL_INFOt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_ina_2_4_13_lta_bcmimm_flex_state_egr_pool_info_cth_handler_arg
};
