...
bcm56780_a0_ina_2_4_13_lta_bcmimm_dt_em_fp_presel_grp_template_cth_handler_arg = {
    .sid = BCM56780_A0_INA_2_4_13_DT_EM_FP_PRESEL_GRP_TEMPLATEt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_ina_2_4_13_lta_bcmimm_dt_em_fp_presel_grp_template_cth_handler_arg
};
