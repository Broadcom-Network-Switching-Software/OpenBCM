...
bcm56780_a0_ina_2_4_13_lta_bcmimm_learn_cache_data_cth_handler_arg = {
    .sid = LEARN_CACHE_DATAt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_direct_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_ina_2_4_13_lta_bcmimm_learn_cache_data_cth_handler_arg
};
