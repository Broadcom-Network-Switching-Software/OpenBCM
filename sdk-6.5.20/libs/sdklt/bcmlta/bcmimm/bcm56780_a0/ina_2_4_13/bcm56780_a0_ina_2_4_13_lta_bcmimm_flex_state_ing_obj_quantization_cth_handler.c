...
bcm56780_a0_ina_2_4_13_lta_bcmimm_flex_state_ing_obj_quantization_cth_handler_arg = {
    .sid = BCM56780_A0_INA_2_4_13_FLEX_STATE_ING_OBJ_QUANTIZATIONt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_ina_2_4_13_lta_bcmimm_flex_state_ing_obj_quantization_cth_handler_arg
};
