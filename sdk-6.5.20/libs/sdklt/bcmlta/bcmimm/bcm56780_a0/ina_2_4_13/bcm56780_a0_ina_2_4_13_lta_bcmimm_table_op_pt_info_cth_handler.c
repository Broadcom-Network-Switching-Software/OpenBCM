...
bcm56780_a0_ina_2_4_13_lta_bcmimm_table_op_pt_info_cth_handler_arg = {
    .sid = TABLE_OP_PT_INFOt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_ina_2_4_13_lta_bcmimm_table_op_pt_info_cth_handler_arg
};
