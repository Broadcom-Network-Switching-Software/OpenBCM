...
bcm56780_a0_dna_2_4_13_lta_bcmimm_flex_qos_ing_info_cth_handler_arg = {
    .sid = BCM56780_A0_DNA_2_4_13_FLEX_QOS_ING_INFOt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_dna_2_4_13_lta_bcmimm_flex_qos_ing_info_cth_handler_arg
};
