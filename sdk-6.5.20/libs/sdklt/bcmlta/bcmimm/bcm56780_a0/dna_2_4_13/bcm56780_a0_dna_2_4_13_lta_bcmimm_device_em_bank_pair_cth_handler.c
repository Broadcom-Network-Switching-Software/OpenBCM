...
bcm56780_a0_dna_2_4_13_lta_bcmimm_device_em_bank_pair_cth_handler_arg = {
    .sid = DEVICE_EM_BANK_PAIRt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_dna_2_4_13_lta_bcmimm_device_em_bank_pair_cth_handler_arg
};
