...
bcm56780_a0_dna_2_4_13_lta_bcmimm_device_em_tile_mode_info_cth_handler_arg = {
    .sid = DEVICE_EM_TILE_MODE_INFOt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_dna_2_4_13_lta_bcmimm_device_em_tile_mode_info_cth_handler_arg
};
