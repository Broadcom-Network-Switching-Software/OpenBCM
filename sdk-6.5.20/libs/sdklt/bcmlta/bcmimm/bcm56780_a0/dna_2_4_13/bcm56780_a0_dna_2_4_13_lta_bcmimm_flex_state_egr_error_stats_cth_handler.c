...
/* Handler: bcm56780_a0_dna_2_4_13_lta_bcmimm_flex_state_egr_error_stats_cth_handler */
...
bcm56780_a0_dna_2_4_13_lta_bcmimm_flex_state_egr_error_stats_cth_handler_arg = {
    .sid = FLEX_STATE_EGR_ERROR_STATSt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_dna_2_4_13_lta_bcmimm_flex_state_egr_error_stats_cth_handler_arg
};
