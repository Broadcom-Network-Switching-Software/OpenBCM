...
bcm56780_a0_dna_2_4_13_lta_bcmimm_ctr_egr_eflex_obj_quantization_cth_handler_arg = {
    .sid = BCM56780_A0_DNA_2_4_13_CTR_EGR_EFLEX_OBJ_QUANTIZATIONt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_dna_2_4_13_lta_bcmimm_ctr_egr_eflex_obj_quantization_cth_handler_arg
};
