...
/* Handler: bcm56780_a0_dna_2_4_13_lta_bcmimm_ctr_egr_eflex_operand_profile_cth_handler */
...
bcm56780_a0_dna_2_4_13_lta_bcmimm_ctr_egr_eflex_operand_profile_cth_handler_arg = {
    .sid = CTR_EGR_EFLEX_OPERAND_PROFILEt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_dna_2_4_13_lta_bcmimm_ctr_egr_eflex_operand_profile_cth_handler_arg
};
