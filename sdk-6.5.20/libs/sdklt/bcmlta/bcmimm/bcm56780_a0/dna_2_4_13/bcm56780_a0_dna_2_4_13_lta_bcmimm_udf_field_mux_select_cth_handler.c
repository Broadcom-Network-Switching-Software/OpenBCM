...
/* Handler: bcm56780_a0_dna_2_4_13_lta_bcmimm_udf_field_mux_select_cth_handler */
...
bcm56780_a0_dna_2_4_13_lta_bcmimm_udf_field_mux_select_cth_handler_arg = {
    .sid = UDF_FIELD_MUX_SELECTt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_dna_2_4_13_lta_bcmimm_udf_field_mux_select_cth_handler_arg
};
