...
bcm56780_a0_lta_bcmimm_flex_digest_hash_salt_cth_handler_arg = {
    .sid = FLEX_DIGEST_HASH_SALTt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_lta_bcmimm_flex_digest_hash_salt_cth_handler_arg
};
