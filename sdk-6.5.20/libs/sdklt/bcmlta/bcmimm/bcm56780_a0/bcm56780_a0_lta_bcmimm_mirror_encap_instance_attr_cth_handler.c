...
/* Handler: bcm56780_a0_lta_bcmimm_mirror_encap_instance_attr_cth_handler */
...
bcm56780_a0_lta_bcmimm_mirror_encap_instance_attr_cth_handler_arg = {
    .sid = MIRROR_ENCAP_INSTANCE_ATTRt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_lta_bcmimm_mirror_encap_instance_attr_cth_handler_arg
};
