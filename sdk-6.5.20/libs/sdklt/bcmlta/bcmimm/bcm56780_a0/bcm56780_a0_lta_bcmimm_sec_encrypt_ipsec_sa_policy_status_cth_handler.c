...
bcm56780_a0_lta_bcmimm_sec_encrypt_ipsec_sa_policy_status_cth_handler_arg = {
    .sid = SEC_ENCRYPT_IPSEC_SA_POLICY_STATUSt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_lta_bcmimm_sec_encrypt_ipsec_sa_policy_status_cth_handler_arg
};
