...
/* Handler: bcm56780_a0_lta_bcmimm_mon_collector_ipv4_cth_handler */
...
bcm56780_a0_lta_bcmimm_mon_collector_ipv4_cth_handler_arg = {
    .sid = MON_COLLECTOR_IPV4t,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_lta_bcmimm_mon_collector_ipv4_cth_handler_arg
};
