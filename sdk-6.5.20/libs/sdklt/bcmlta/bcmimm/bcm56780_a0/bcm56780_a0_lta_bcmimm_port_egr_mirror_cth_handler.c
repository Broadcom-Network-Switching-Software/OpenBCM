...
/* Handler: bcm56780_a0_lta_bcmimm_port_egr_mirror_cth_handler */
...
bcm56780_a0_lta_bcmimm_port_egr_mirror_cth_handler_arg = {
    .sid = PORT_EGR_MIRRORt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56780_a0_lta_bcmimm_port_egr_mirror_cth_handler_arg
};
