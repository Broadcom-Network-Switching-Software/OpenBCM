...
/* Handler: bcm56990_a0_lta_bcmimm_tm_ing_port_cth_handler */
...
bcm56990_a0_lta_bcmimm_tm_ing_port_cth_handler_arg = {
    .sid = TM_ING_PORTt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56990_a0_lta_bcmimm_tm_ing_port_cth_handler_arg
};
