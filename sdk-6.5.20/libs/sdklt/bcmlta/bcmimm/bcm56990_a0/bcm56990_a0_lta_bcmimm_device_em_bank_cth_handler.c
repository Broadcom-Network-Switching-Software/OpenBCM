...
/* Handler: bcm56990_a0_lta_bcmimm_device_em_bank_cth_handler */
...
bcm56990_a0_lta_bcmimm_device_em_bank_cth_handler_arg = {
    .sid = DEVICE_EM_BANKt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56990_a0_lta_bcmimm_device_em_bank_cth_handler_arg
};
