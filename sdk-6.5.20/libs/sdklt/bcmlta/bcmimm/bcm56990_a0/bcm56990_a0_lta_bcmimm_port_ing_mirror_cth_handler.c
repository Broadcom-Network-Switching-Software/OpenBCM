...
/* Handler: bcm56990_a0_lta_bcmimm_port_ing_mirror_cth_handler */
...
bcm56990_a0_lta_bcmimm_port_ing_mirror_cth_handler_arg = {
    .sid = PORT_ING_MIRRORt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56990_a0_lta_bcmimm_port_ing_mirror_cth_handler_arg
};
