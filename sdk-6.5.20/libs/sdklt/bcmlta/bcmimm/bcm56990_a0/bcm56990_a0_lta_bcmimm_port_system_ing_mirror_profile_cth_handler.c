...
bcm56990_a0_lta_bcmimm_port_system_ing_mirror_profile_cth_handler_arg = {
    .sid = PORT_SYSTEM_ING_MIRROR_PROFILEt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56990_a0_lta_bcmimm_port_system_ing_mirror_profile_cth_handler_arg
};
