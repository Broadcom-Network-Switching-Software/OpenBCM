...
bcm56990_a0_lta_bcmimm_tm_bst_event_source_ing_cth_handler_arg = {
    .sid = TM_BST_EVENT_SOURCE_INGt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56990_a0_lta_bcmimm_tm_bst_event_source_ing_cth_handler_arg
};
