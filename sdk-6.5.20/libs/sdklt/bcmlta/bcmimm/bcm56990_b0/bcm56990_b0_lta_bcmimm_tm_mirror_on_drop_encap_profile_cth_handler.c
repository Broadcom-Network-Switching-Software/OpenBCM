...
/* Handler: bcm56990_b0_lta_bcmimm_tm_mirror_on_drop_encap_profile_cth_handler */
...
bcm56990_b0_lta_bcmimm_tm_mirror_on_drop_encap_profile_cth_handler_arg = {
    .sid = TM_MIRROR_ON_DROP_ENCAP_PROFILEt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56990_b0_lta_bcmimm_tm_mirror_on_drop_encap_profile_cth_handler_arg
};
