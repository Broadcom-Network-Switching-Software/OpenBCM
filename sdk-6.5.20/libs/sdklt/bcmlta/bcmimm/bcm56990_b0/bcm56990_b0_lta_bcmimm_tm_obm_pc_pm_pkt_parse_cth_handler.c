...
/* Handler: bcm56990_b0_lta_bcmimm_tm_obm_pc_pm_pkt_parse_cth_handler */
...
bcm56990_b0_lta_bcmimm_tm_obm_pc_pm_pkt_parse_cth_handler_arg = {
    .sid = TM_OBM_PC_PM_PKT_PARSEt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56990_b0_lta_bcmimm_tm_obm_pc_pm_pkt_parse_cth_handler_arg
};
