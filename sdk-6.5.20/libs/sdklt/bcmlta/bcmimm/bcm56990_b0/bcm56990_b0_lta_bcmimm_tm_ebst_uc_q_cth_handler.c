...
/* Handler: bcm56990_b0_lta_bcmimm_tm_ebst_uc_q_cth_handler */
...
bcm56990_b0_lta_bcmimm_tm_ebst_uc_q_cth_handler_arg = {
    .sid = TM_EBST_UC_Qt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56990_b0_lta_bcmimm_tm_ebst_uc_q_cth_handler_arg
};
