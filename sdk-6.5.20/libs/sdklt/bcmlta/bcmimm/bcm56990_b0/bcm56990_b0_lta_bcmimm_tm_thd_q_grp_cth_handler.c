...
/* Handler: bcm56990_b0_lta_bcmimm_tm_thd_q_grp_cth_handler */
...
bcm56990_b0_lta_bcmimm_tm_thd_q_grp_cth_handler_arg = {
    .sid = TM_THD_Q_GRPt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
...
bcmimm_direct_table_entry_limit_handler = {
    ...
    .arg  = &bcm56990_b0_lta_bcmimm_tm_thd_q_grp_cth_handler_arg
};
