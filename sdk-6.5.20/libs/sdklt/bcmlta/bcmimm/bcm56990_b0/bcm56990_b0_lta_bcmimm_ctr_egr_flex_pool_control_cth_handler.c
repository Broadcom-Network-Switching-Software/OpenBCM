...
/* Handler: bcm56990_b0_lta_bcmimm_ctr_egr_flex_pool_control_cth_handler */
...
bcm56990_b0_lta_bcmimm_ctr_egr_flex_pool_control_cth_handler_arg = {
    .sid = CTR_EGR_FLEX_POOL_CONTROLt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56990_b0_lta_bcmimm_ctr_egr_flex_pool_control_cth_handler_arg
};
