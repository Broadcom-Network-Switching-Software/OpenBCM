...
bcm56880_a0_lta_bcmimm_mon_flowtracker_hw_learn_flow_action_state_cth_handler_arg = {
    .sid = MON_FLOWTRACKER_HW_LEARN_FLOW_ACTION_STATEt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56880_a0_lta_bcmimm_mon_flowtracker_hw_learn_flow_action_state_cth_handler_arg
};
