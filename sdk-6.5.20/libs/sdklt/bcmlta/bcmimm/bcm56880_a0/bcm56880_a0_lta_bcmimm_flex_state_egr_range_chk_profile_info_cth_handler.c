...
bcm56880_a0_lta_bcmimm_flex_state_egr_range_chk_profile_info_cth_handler_arg = {
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56880_a0_lta_bcmimm_flex_state_egr_range_chk_profile_info_cth_handler_arg
};
