...
bcm56880_a0_dna_4_6_6_lta_bcmimm_dt_vfp_action_template_cth_handler_arg = {
    .sid = BCM56880_A0_DNA_4_6_6_DT_VFP_ACTION_TEMPLATEt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56880_a0_dna_4_6_6_lta_bcmimm_dt_vfp_action_template_cth_handler_arg
};
