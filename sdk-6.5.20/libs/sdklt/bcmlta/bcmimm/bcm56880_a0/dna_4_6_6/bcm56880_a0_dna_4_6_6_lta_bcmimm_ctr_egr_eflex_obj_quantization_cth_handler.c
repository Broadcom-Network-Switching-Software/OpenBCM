...
bcm56880_a0_dna_4_6_6_lta_bcmimm_ctr_egr_eflex_obj_quantization_cth_handler_arg = {
    .sid = BCM56880_A0_DNA_4_6_6_CTR_EGR_EFLEX_OBJ_QUANTIZATIONt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56880_a0_dna_4_6_6_lta_bcmimm_ctr_egr_eflex_obj_quantization_cth_handler_arg
};
