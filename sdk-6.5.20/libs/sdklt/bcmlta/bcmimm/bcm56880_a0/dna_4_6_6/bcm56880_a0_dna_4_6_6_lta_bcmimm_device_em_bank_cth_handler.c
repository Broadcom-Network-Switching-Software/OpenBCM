...
/* Handler: bcm56880_a0_dna_4_6_6_lta_bcmimm_device_em_bank_cth_handler */
...
bcm56880_a0_dna_4_6_6_lta_bcmimm_device_em_bank_cth_handler_arg = {
    .sid = DEVICE_EM_BANKt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56880_a0_dna_4_6_6_lta_bcmimm_device_em_bank_cth_handler_arg
};
