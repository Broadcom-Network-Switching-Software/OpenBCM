...
/* Handler: bcm56880_a0_dna_4_6_6_lta_bcmimm_table_em_info_cth_handler */
...
bcm56880_a0_dna_4_6_6_lta_bcmimm_table_em_info_cth_handler_arg = {
    .sid = TABLE_EM_INFOt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56880_a0_dna_4_6_6_lta_bcmimm_table_em_info_cth_handler_arg
};
