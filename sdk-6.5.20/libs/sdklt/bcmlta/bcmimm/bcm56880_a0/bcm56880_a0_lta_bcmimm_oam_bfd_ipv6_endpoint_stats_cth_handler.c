...
/* Handler: bcm56880_a0_lta_bcmimm_oam_bfd_ipv6_endpoint_stats_cth_handler */
...
bcm56880_a0_lta_bcmimm_oam_bfd_ipv6_endpoint_stats_cth_handler_arg = {
    .sid = OAM_BFD_IPV6_ENDPOINT_STATSt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56880_a0_lta_bcmimm_oam_bfd_ipv6_endpoint_stats_cth_handler_arg
};
