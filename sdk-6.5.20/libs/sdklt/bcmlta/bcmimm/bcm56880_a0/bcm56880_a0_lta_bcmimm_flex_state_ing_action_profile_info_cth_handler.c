...
bcm56880_a0_lta_bcmimm_flex_state_ing_action_profile_info_cth_handler_arg = {
    .sid = FLEX_STATE_ING_ACTION_PROFILE_INFOt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56880_a0_lta_bcmimm_flex_state_ing_action_profile_info_cth_handler_arg
};
