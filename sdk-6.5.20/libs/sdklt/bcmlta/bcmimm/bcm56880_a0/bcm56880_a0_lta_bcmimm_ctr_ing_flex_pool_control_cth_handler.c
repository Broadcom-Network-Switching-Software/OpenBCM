...
bcm56880_a0_lta_bcmimm_ctr_ing_flex_pool_control_cth_handler_arg = {
    .sid = CTR_ING_FLEX_POOL_CONTROLt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56880_a0_lta_bcmimm_ctr_ing_flex_pool_control_cth_handler_arg
};
