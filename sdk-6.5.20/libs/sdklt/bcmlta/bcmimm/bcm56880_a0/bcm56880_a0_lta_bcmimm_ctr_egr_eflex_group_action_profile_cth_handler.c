...
bcm56880_a0_lta_bcmimm_ctr_egr_eflex_group_action_profile_cth_handler_arg = {
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56880_a0_lta_bcmimm_ctr_egr_eflex_group_action_profile_cth_handler_arg
};
