...
/* Handler: bcm56880_a0_lta_bcmimm_ser_pt_control_cth_handler */
...
bcm56880_a0_lta_bcmimm_ser_pt_control_cth_handler_arg = {
    .sid = SER_PT_CONTROLt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
...
bcmimm_basic_table_entry_limit_handler = {
    ...
    .arg  = &bcm56880_a0_lta_bcmimm_ser_pt_control_cth_handler_arg
};
