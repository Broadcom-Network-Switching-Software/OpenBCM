...
bcm56880_a0_dna_4_6_6_lta_bcmfp_dt_em_ft_action_template_container_info_cth_handler_arg = {
    .sid = BCM56880_A0_DNA_4_6_6_DT_EM_FT_ACTION_TEMPLATE_CONTAINER_INFOt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
};
...
bcm56880_a0_dna_4_6_6_lta_bcmfp_dt_em_ft_action_template_container_info_cth_handler = {
    ...
    .ha       = NULL,
    .arg      = &bcm56880_a0_dna_4_6_6_lta_bcmfp_dt_em_ft_action_template_container_info_cth_handler_arg
};
