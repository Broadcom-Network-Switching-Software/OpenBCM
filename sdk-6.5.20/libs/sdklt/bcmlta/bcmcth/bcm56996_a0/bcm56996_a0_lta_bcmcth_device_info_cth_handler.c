...
/* Handler: bcm56996_a0_lta_bcmcth_device_info_cth_handler */
...
bcm56996_a0_lta_bcmcth_device_info_cth_handler_arg = {
    .sid = DEVICE_INFOt,
    .values = 0,
    .value = NULL,
    .user_data = NULL
...
bcm56996_a0_lta_bcmcth_device_info_cth_handler = {
    ...
    .ha       = NULL,
    .arg      = &bcm56996_a0_lta_bcmcth_device_info_cth_handler_arg
};
