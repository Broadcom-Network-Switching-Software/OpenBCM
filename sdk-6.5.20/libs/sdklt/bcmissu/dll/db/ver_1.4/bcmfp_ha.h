...
typedef struct {
   ...
   /*! presel group operational information array size. */
   uint16_t presel_group_oper_info_size;
   ...
   /*! PDD operational information array size. */
   uint16_t pdd_oper_info_size;
...
typedef struct {
   ...
   /*! Number of bits in hardware policy used to save action values in each part. */
   bcmfp_ha_blk_info_t data_width_info;
   /*! Width of the hardware policy to be used for this pdd type. */
