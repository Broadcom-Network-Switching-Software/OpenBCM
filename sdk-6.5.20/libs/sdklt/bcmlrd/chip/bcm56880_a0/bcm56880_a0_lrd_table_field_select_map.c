...
static const bcmlrd_field_data_t bcm56880_a0_lrd_table_field_select_map_field_data_mmd[] = {
    { /* 0 TABLE_ID */
...
const bcmlrd_map_field_data_t bcm56880_a0_lrd_table_field_select_map_field_data = {
    .fields = 7,
    .field = bcm56880_a0_lrd_table_field_select_map_field_data_mmd
};

static const bcmlrd_map_table_attr_t bcm56880_a0_lrd_table_field_selectt_attr_entry[] = {
    { /* 0 */
...
static const bcmlrd_map_attr_t bcm56880_a0_lrd_table_field_selectt_attr_group = {
    .attributes = 1,
    .attr = bcm56880_a0_lrd_table_field_selectt_attr_entry,
};

static const bcmlrd_map_group_t bcm56880_a0_lrd_table_field_select_map_group[] = {
    {
        .dest = {
            .kind = BCMLRD_MAP_LTM,
            .id = 0,
...
const bcmlrd_map_t bcm56880_a0_lrd_table_field_select_map = {
    .src_id = TABLE_FIELD_SELECTt,
    .field_data = &bcm56880_a0_lrd_table_field_select_map_field_data,
    .groups = 1,
    .group  = bcm56880_a0_lrd_table_field_select_map_group,
    .table_attr = &bcm56880_a0_lrd_table_field_selectt_attr_group,
