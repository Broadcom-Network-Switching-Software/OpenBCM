...
static const bcmlrd_field_data_t bcm56880_a0_lrd_table_info_map_field_data_mmd[] = {
    { /* 0 TABLE_ID */
...
const bcmlrd_map_field_data_t bcm56880_a0_lrd_table_info_map_field_data = {
    .fields = 16,
    .field = bcm56880_a0_lrd_table_info_map_field_data_mmd
};

static const bcmlrd_map_table_attr_t bcm56880_a0_lrd_table_infot_attr_entry[] = {
    { /* 0 */
...
static const bcmlrd_map_attr_t bcm56880_a0_lrd_table_infot_attr_group = {
    .attributes = 1,
    .attr = bcm56880_a0_lrd_table_infot_attr_entry,
};

const bcmlrd_field_selector_t bcm56880_a0_lrd_table_info_map_select[] = {
...
const bcmlrd_field_selector_data_t bcm56880_a0_lrd_table_info_map_select_data = {
    .num_field_selector = 4,
    .field_selector = bcm56880_a0_lrd_table_info_map_select,
};

static const bcmlrd_map_group_t bcm56880_a0_lrd_table_info_map_group[] = {
    {
        .dest = {
            .kind = BCMLRD_MAP_LTM,
            .id = 0,
...
const bcmlrd_map_t bcm56880_a0_lrd_table_info_map = {
    .src_id = TABLE_INFOt,
    .field_data = &bcm56880_a0_lrd_table_info_map_field_data,
    .groups = 1,
    .group  = bcm56880_a0_lrd_table_info_map_group,
    .table_attr = &bcm56880_a0_lrd_table_infot_attr_group,
    .entry_ops = BCMLRD_MAP_TABLE_ENTRY_OPERATION_LOOKUP | BCMLRD_MAP_TABLE_ENTRY_OPERATION_TRAVERSE,
    .sel = &bcm56880_a0_lrd_table_info_map_select_data,
};
