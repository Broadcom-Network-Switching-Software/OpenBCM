...
static const bcmlrd_field_data_t bcm56990_a0_lrd_table_field_info_map_field_data_mmd[] = {
    { /* 0 TABLE_ID */
    ...
    { /* 1 FIELD_ID */
      ...
      .depth = 0,
      .width = 32,
      .edata = BCM56990_A0_LRD_LFID_T_DATA,
    },
    { /* 2 SYMBOL */
    ...
    { /* 6 SYMBOL_DEFAULT */
      ...
      .depth = 0,
      .width = 32,
      .edata = BCM56990_A0_LRD_ENUM_NAME_T_DATA,
    },
    { /* 7 KEY */
      .flags = BCMLRD_FIELD_F_READ_ONLY,
      .min = &bcm56990_a0_lrd_ifd_is_true_0x0,
...
const bcmlrd_map_field_data_t bcm56990_a0_lrd_table_field_info_map_field_data = {
    .fields = 15,
    .field = bcm56990_a0_lrd_table_field_info_map_field_data_mmd
};

static const bcmlrd_map_table_attr_t bcm56990_a0_lrd_table_field_infot_attr_entry[] = {
    { /* 0 */
...
static const bcmlrd_map_attr_t bcm56990_a0_lrd_table_field_infot_attr_group = {
    .attributes = 1,
    .attr = bcm56990_a0_lrd_table_field_infot_attr_entry,
};

const bcmlrd_field_selector_t bcm56990_a0_lrd_table_field_info_map_select[] = {
...
const bcmlrd_field_selector_data_t bcm56990_a0_lrd_table_field_info_map_select_data = {
    .num_field_selector = 3,
    .field_selector = bcm56990_a0_lrd_table_field_info_map_select,
};

static const bcmlrd_map_group_t bcm56990_a0_lrd_table_field_info_map_group[] = {
    {
        .dest = {
            .kind = BCMLRD_MAP_LTM,
            .id = 0,
...
const bcmlrd_map_t bcm56990_a0_lrd_table_field_info_map = {
    .src_id = TABLE_FIELD_INFOt,
    .field_data = &bcm56990_a0_lrd_table_field_info_map_field_data,
    .groups = 1,
    .group  = bcm56990_a0_lrd_table_field_info_map_group,
    .table_attr = &bcm56990_a0_lrd_table_field_infot_attr_group,
    .entry_ops = BCMLRD_MAP_TABLE_ENTRY_OPERATION_LOOKUP | BCMLRD_MAP_TABLE_ENTRY_OPERATION_TRAVERSE,
    .sel = &bcm56990_a0_lrd_table_field_info_map_select_data,
};
