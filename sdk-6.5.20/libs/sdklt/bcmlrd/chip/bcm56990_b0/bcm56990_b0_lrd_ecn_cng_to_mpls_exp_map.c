 ...
 *    INTERNAL/fltg/xgs/ecn/bcm56990_b0/bcm56990_b0_ECN_CNG_TO_MPLS_EXP.map.ltl for
 *      bcm56990_b0
 *
...
static const bcmlrd_field_data_t bcm56990_b0_lrd_ecn_cng_to_mpls_exp_map_field_data_mmd[] = {
...
const bcmlrd_map_field_data_t bcm56990_b0_lrd_ecn_cng_to_mpls_exp_map_field_data = {
    .fields = 9,
    .field = bcm56990_b0_lrd_ecn_cng_to_mpls_exp_map_field_data_mmd
};

static const bcmlrd_map_table_attr_t bcm56990_b0_lrd_ecn_cng_to_mpls_expt_attr_entry[] = {
    { /* 0 */
...
static const bcmlrd_map_attr_t bcm56990_b0_lrd_ecn_cng_to_mpls_expt_attr_group = {
    .attributes = 3,
    .attr = bcm56990_b0_lrd_ecn_cng_to_mpls_expt_attr_entry,
};

static const bcmlrd_map_entry_t bcm56990_b0_lrd_ecn_cng_to_mpls_expt_egr_int_cn_to_exp_mapping_table_map_entry[] = {
    { /* 0 */
...
static const bcmlrd_map_group_t bcm56990_b0_lrd_ecn_cng_to_mpls_exp_map_group[] = {
    {
        .dest = {
        ...
        .entries = 9,
        .entry = bcm56990_b0_lrd_ecn_cng_to_mpls_expt_egr_int_cn_to_exp_mapping_table_map_entry
    },
};
const bcmlrd_map_t bcm56990_b0_lrd_ecn_cng_to_mpls_exp_map = {
    .src_id = ECN_CNG_TO_MPLS_EXPt,
    .field_data = &bcm56990_b0_lrd_ecn_cng_to_mpls_exp_map_field_data,
    .groups = 1,
    .group  = bcm56990_b0_lrd_ecn_cng_to_mpls_exp_map_group,
    .table_attr = &bcm56990_b0_lrd_ecn_cng_to_mpls_expt_attr_group,
