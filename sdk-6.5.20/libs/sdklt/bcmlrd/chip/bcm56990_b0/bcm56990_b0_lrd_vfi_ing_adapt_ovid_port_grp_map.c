 ...
 *    INTERNAL/fltg/xgs/vfi/bcm56990_b0/bcm56990_b0_VFI_ING_ADAPT_OVID_PORT_GRP.map.ltl for
 *      bcm56990_b0
 *
...
static const bcmlrd_field_data_t bcm56990_b0_lrd_vfi_ing_adapt_ovid_port_grp_map_field_data_mmd[] = {
    { /* 0 OVID */
...
const bcmlrd_map_field_data_t bcm56990_b0_lrd_vfi_ing_adapt_ovid_port_grp_map_field_data = {
    .fields = 6,
    .field = bcm56990_b0_lrd_vfi_ing_adapt_ovid_port_grp_map_field_data_mmd
};

static const bcmlrd_map_table_attr_t bcm56990_b0_lrd_vfi_ing_adapt_ovid_port_grpt_attr_entry[] = {
    { /* 0 */
...
static const bcmlrd_map_attr_t bcm56990_b0_lrd_vfi_ing_adapt_ovid_port_grpt_attr_group = {
    .attributes = 2,
    .attr = bcm56990_b0_lrd_vfi_ing_adapt_ovid_port_grpt_attr_entry,
};

static const bcmlrd_map_entry_t bcm56990_b0_lrd_vfi_ing_adapt_ovid_port_grpt_mpls_entry_single_map_entry[] = {
    { /* 0 */
...
static const bcmlrd_map_group_t bcm56990_b0_lrd_vfi_ing_adapt_ovid_port_grp_map_group[] = {
    {
        .dest = {
        ...
        .entries = 8,
        .entry = bcm56990_b0_lrd_vfi_ing_adapt_ovid_port_grpt_mpls_entry_single_map_entry
    },
};
const bcmlrd_map_t bcm56990_b0_lrd_vfi_ing_adapt_ovid_port_grp_map = {
    .src_id = VFI_ING_ADAPT_OVID_PORT_GRPt,
    .field_data = &bcm56990_b0_lrd_vfi_ing_adapt_ovid_port_grp_map_field_data,
    .groups = 1,
    .group  = bcm56990_b0_lrd_vfi_ing_adapt_ovid_port_grp_map_group,
    .table_attr = &bcm56990_b0_lrd_vfi_ing_adapt_ovid_port_grpt_attr_group,
