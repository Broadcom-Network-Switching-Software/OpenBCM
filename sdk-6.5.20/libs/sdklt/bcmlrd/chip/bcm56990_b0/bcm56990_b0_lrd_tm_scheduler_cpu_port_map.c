 ...
 *    INTERNAL/fltg/xgs/tm/bcm56990_b0/bcm56990_b0_TM_SCHEDULER_CPU_PORT.map.ltl for
 *      bcm56990_b0
 *
...
static const bcmlrd_field_data_t bcm56990_b0_lrd_tm_scheduler_cpu_port_map_field_data_mmd[] = {
    { /* 0 WRR */
      .flags = 0,
...
const bcmlrd_map_field_data_t bcm56990_b0_lrd_tm_scheduler_cpu_port_map_field_data = {
    .fields = 3,
    .field = bcm56990_b0_lrd_tm_scheduler_cpu_port_map_field_data_mmd
};

static const bcmlrd_map_table_attr_t bcm56990_b0_lrd_tm_scheduler_cpu_portt_attr_entry[] = {
    { /* 0 */
...
static const bcmlrd_map_attr_t bcm56990_b0_lrd_tm_scheduler_cpu_portt_attr_group = {
    .attributes = 1,
    .attr = bcm56990_b0_lrd_tm_scheduler_cpu_portt_attr_entry,
};

static const bcmlrd_map_entry_t bcm56990_b0_lrd_tm_scheduler_cpu_portt_mmu_qsch_cpu_port_config_map_entry[] = {
    { /* 0 */
...
const bcmlrd_field_selector_t bcm56990_b0_lrd_tm_scheduler_cpu_port_map_select[] = {
...
const bcmlrd_field_selector_data_t bcm56990_b0_lrd_tm_scheduler_cpu_port_map_select_data = {
    .num_field_selector = 3,
    .field_selector = bcm56990_b0_lrd_tm_scheduler_cpu_port_map_select,
};

static const bcmlrd_map_group_t bcm56990_b0_lrd_tm_scheduler_cpu_port_map_group[] = {
    {
        .dest = {
        ...
        .entries = 3,
        .entry = bcm56990_b0_lrd_tm_scheduler_cpu_portt_mmu_qsch_cpu_port_config_map_entry
    },
};
const bcmlrd_map_t bcm56990_b0_lrd_tm_scheduler_cpu_port_map = {
    .src_id = TM_SCHEDULER_CPU_PORTt,
    .field_data = &bcm56990_b0_lrd_tm_scheduler_cpu_port_map_field_data,
    .groups = 1,
    .group  = bcm56990_b0_lrd_tm_scheduler_cpu_port_map_group,
    .table_attr = &bcm56990_b0_lrd_tm_scheduler_cpu_portt_attr_group,
    .entry_ops = BCMLRD_MAP_TABLE_ENTRY_OPERATION_LOOKUP | BCMLRD_MAP_TABLE_ENTRY_OPERATION_TRAVERSE | BCMLRD_MAP_TABLE_ENTRY_OPERATION_INSERT | BCMLRD_MAP_TABLE_ENTRY_OPERATION_UPDATE | BCMLRD_MAP_TABLE_ENTRY_OPERATION_DELETE,
    .sel = &bcm56990_b0_lrd_tm_scheduler_cpu_port_map_select_data,
};
