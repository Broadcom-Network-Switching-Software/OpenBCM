 ...
 *    INTERNAL/fltg/xgs/l3/bcm56990_b0/bcm56990_b0_L3_IPV4_UC_ROUTE_OVERRIDE.map.ltl for
 *      bcm56990_b0
 *
...
static const bcmlrd_field_data_t bcm56990_b0_lrd_l3_ipv4_uc_route_override_map_field_data_mmd[] = {
    { /* 0 IPV4 */
...
const bcmlrd_map_field_data_t bcm56990_b0_lrd_l3_ipv4_uc_route_override_map_field_data = {
    .fields = 26,
    .field = bcm56990_b0_lrd_l3_ipv4_uc_route_override_map_field_data_mmd
};

static const bcmlrd_map_table_attr_t bcm56990_b0_lrd_l3_ipv4_uc_route_overridet_attr_entry[] = {
    { /* 0 */
...
static const bcmlrd_map_attr_t bcm56990_b0_lrd_l3_ipv4_uc_route_overridet_attr_group = {
    .attributes = 3,
    .attr = bcm56990_b0_lrd_l3_ipv4_uc_route_overridet_attr_entry,
};

static const bcmlrd_map_entry_t bcm56990_b0_lrd_l3_ipv4_uc_route_overridet_l3_defip_level1_map_entry[] = {
    { /* 0 */
    ...
    { /* 4 */
        ...
        .u = {
            .mapped = {
                .src = {
                    .field_id = L3_IPV4_UC_ROUTE_OVERRIDEt_IPV4f,
                    .field_idx = 0,
                    .minbit    = 0,
                    .maxbit    = 31,
                    .entry_idx = 0,
    ...
    { /* 5 */
        ...
        .u = {
            .mapped = {
                .src = {
                    .field_id = L3_IPV4_UC_ROUTE_OVERRIDEt_IPV4_MASKf,
                    .field_idx = 0,
                    .minbit    = 0,
                    .maxbit    = 31,
                    .entry_idx = 0,
    ...
    { /* 11 */
        ...
        .u = {
            .mapped = {
                .src = {
                    .field_id = L3_IPV4_UC_ROUTE_OVERRIDEt_REPLACE_INT_PRIf,
                    .field_idx = 0,
                    .minbit    = 0,
                    .maxbit    = 0,
                    .entry_idx = 0,
    ...
    { /* 12 */
        ...
        .u = {
            .mapped = {
                .src = {
                    .field_id = L3_IPV4_UC_ROUTE_OVERRIDEt_INT_PRIf,
                    .field_idx = 0,
                    .minbit    = 0,
                    .maxbit    = 3,
                    .entry_idx = 0,
    ...
    { /* 13 */
        ...
        .u = {
            .mapped = {
                .src = {
                    .field_id = L3_IPV4_UC_ROUTE_OVERRIDEt_DROP_ON_DIP_MATCHf,
                    .field_idx = 0,
                    .minbit    = 0,
                    .maxbit    = 0,
                    .entry_idx = 0,
    ...
    { /* 14 */
        ...
        .u = {
            .mapped = {
                .src = {
                    .field_id = L3_IPV4_UC_ROUTE_OVERRIDEt_CLASS_IDf,
                    .field_idx = 0,
                    .minbit    = 0,
                    .maxbit    = 5,
                    .entry_idx = 0,
    ...
    { /* 16 */
        ...
        .u = {
            .mapped = {
                .src = {
                    .field_id = L3_IPV4_UC_ROUTE_OVERRIDEt_CTR_ING_EFLEX_OBJECTf,
                    .field_idx = 0,
                    .minbit    = 0,
                    .maxbit    = 14,
                    .entry_idx = 0,
    ...
    { /* 17 */
        ...
        .u = {
            .mapped = {
                .src = {
                    .field_id = L3_IPV4_UC_ROUTE_OVERRIDEt_L3_IPV4_UC_ROUTE_CTR_ING_EFLEX_ACTION_IDf,
                    .field_idx = 0,
                    .minbit    = 0,
                    .maxbit    = 0,
                    .entry_idx = 0,
    ...
    { /* 18 */
        ...
        .u = {
            .mapped = {
                .src = {
                    .field_id = L3_IPV4_UC_ROUTE_OVERRIDEt_HITf,
                    .field_idx = 0,
                    .minbit    = 0,
                    .maxbit    = 0,
                    .entry_idx = 0,
    ...
    { /* 20 */
        ...
        .u = {
            .mapped = {
                .src = {
                    .field_id = L3_IPV4_UC_ROUTE_OVERRIDEt_MON_INBAND_TELEMETRY_ACTION_PROFILE_IDf,
                    .field_idx = 0,
                    .minbit    = 0,
                    .maxbit    = 2,
                    .entry_idx = 0,
    ...
    { /* 21 */
        ...
        .u = {
            .mapped = {
                .src = {
                    .field_id = L3_IPV4_UC_ROUTE_OVERRIDEt_MON_INBAND_TELEMETRY_OPAQUE_DATA_PROFILE_IDf,
                    .field_idx = 0,
                    .minbit    = 0,
                    .maxbit    = 8,
                    .entry_idx = 0,
...
bcm56990_b0_lrd_bcmltx_l3_ipv4_uc_route_override_validate_entry[] = {
    { /* 0 */
        ...
        .u = {
            /* handler: bcm56990_b0_lta_bcmltx_l3_ipv4_uc_route_override_std_val_fv_handler */
            .handler_id = BCMLTD_VALIDATE_BCM56990_B0_LTA_BCMLTX_L3_IPV4_UC_ROUTE_OVERRIDE_STD_VAL_FV_HANDLER_ID
        }
    },
};
const bcmlrd_field_selector_t bcm56990_b0_lrd_l3_ipv4_uc_route_override_map_select[] = {
    ...
    { /* Node:1, Type:Directmap, NHOP_ID:L3_DEFIP_LEVEL1.ASSOC_DATA0_LPM_ASSOC_DATA_FULL_DESTINATION */
        ...
        .selection_parent = 0,
        .group = 0,
        .selector_id = L3_IPV4_UC_ROUTE_OVERRIDEt_ECMP_NHOPf,
...
const bcmlrd_field_selector_data_t bcm56990_b0_lrd_l3_ipv4_uc_route_override_map_select_data = {
    .num_field_selector = 3,
    .field_selector = bcm56990_b0_lrd_l3_ipv4_uc_route_override_map_select,
};

static const bcmlrd_map_group_t bcm56990_b0_lrd_l3_ipv4_uc_route_override_map_group[] = {
    {
        .dest = {
        ...
        .entries = 22,
        .entry = bcm56990_b0_lrd_l3_ipv4_uc_route_overridet_l3_defip_level1_map_entry
    },
    {
        .dest = {
        ...
        .entries = 1,
        .entry = bcm56990_b0_lrd_bcmltx_l3_ipv4_uc_route_override_validate_entry
    },
};
const bcmlrd_map_t bcm56990_b0_lrd_l3_ipv4_uc_route_override_map = {
    .src_id = L3_IPV4_UC_ROUTE_OVERRIDEt,
    .field_data = &bcm56990_b0_lrd_l3_ipv4_uc_route_override_map_field_data,
    .groups = 2,
    .group  = bcm56990_b0_lrd_l3_ipv4_uc_route_override_map_group,
    .table_attr = &bcm56990_b0_lrd_l3_ipv4_uc_route_overridet_attr_group,
    .entry_ops = BCMLRD_MAP_TABLE_ENTRY_OPERATION_LOOKUP | BCMLRD_MAP_TABLE_ENTRY_OPERATION_TRAVERSE | BCMLRD_MAP_TABLE_ENTRY_OPERATION_INSERT | BCMLRD_MAP_TABLE_ENTRY_OPERATION_UPDATE | BCMLRD_MAP_TABLE_ENTRY_OPERATION_DELETE,
    .sel = &bcm56990_b0_lrd_l3_ipv4_uc_route_override_map_select_data,
};
