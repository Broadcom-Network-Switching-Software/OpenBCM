 ...
 *    INTERNAL/fltg/xgs/port/bcm56990_b0/bcm56990_b0_PORT_EGR_TS_PTP.map.ltl for
 *      bcm56990_b0
 *
...
static const bcmlrd_field_data_t bcm56990_b0_lrd_port_egr_ts_ptp_map_field_data_mmd[] = {
    { /* 0 PORT_ID */
    ...
    { /* 3 CF_UPDATE_MODE */
      ...
      .depth = 0,
      .width = 2,
      .edata = BCM56990_B0_LRD_TS_CF_UPDATE_MODE_T_DATA,
    },
...
const bcmlrd_map_field_data_t bcm56990_b0_lrd_port_egr_ts_ptp_map_field_data = {
    .fields = 9,
    .field = bcm56990_b0_lrd_port_egr_ts_ptp_map_field_data_mmd
};

static const bcmlrd_map_table_attr_t bcm56990_b0_lrd_port_egr_ts_ptpt_attr_entry[] = {
    { /* 0 */
...
static const bcmlrd_map_attr_t bcm56990_b0_lrd_port_egr_ts_ptpt_attr_group = {
    .attributes = 3,
    .attr = bcm56990_b0_lrd_port_egr_ts_ptpt_attr_entry,
};

static const bcmlrd_map_entry_t bcm56990_b0_lrd_port_egr_ts_ptpt_egr_1588_egress_ctrl_map_entry[] = {
    { /* 0 */
...
static const bcmlrd_map_entry_t bcm56990_b0_lrd_port_egr_ts_ptpt_egr_1588_sa_map_entry[] = {
    { /* 0 */
        .entry_type = BCMLRD_MAP_ENTRY_MAPPED_KEY,
        .desc = {
...
static const bcmlrd_map_group_t bcm56990_b0_lrd_port_egr_ts_ptp_map_group[] = {
    {
        .dest = {
        ...
        .entries = 8,
        .entry = bcm56990_b0_lrd_port_egr_ts_ptpt_egr_1588_egress_ctrl_map_entry
    },
    {
        .dest = {
            .kind = BCMLRD_MAP_PHYSICAL,
        ...
        .entries = 2,
        .entry = bcm56990_b0_lrd_port_egr_ts_ptpt_egr_1588_sa_map_entry
    },
};
const bcmlrd_map_t bcm56990_b0_lrd_port_egr_ts_ptp_map = {
    .src_id = PORT_EGR_TS_PTPt,
    .field_data = &bcm56990_b0_lrd_port_egr_ts_ptp_map_field_data,
    .groups = 2,
    .group  = bcm56990_b0_lrd_port_egr_ts_ptp_map_group,
    .table_attr = &bcm56990_b0_lrd_port_egr_ts_ptpt_attr_group,
