 ...
 *    INTERNAL/fltg/xgs/lb_hash/bcm56990_b0/bcm56990_b0_LB_HASH_PORT_TRUNK_OUTPUT_SELECTION.map.ltl for
 *      bcm56990_b0
 *
...
static const bcmlrd_field_data_t bcm56990_b0_lrd_lb_hash_port_trunk_output_selection_map_field_data_mmd[] = {
    { /* 0 PORT_ID */
...
const bcmlrd_map_field_data_t bcm56990_b0_lrd_lb_hash_port_trunk_output_selection_map_field_data = {
    .fields = 7,
    .field = bcm56990_b0_lrd_lb_hash_port_trunk_output_selection_map_field_data_mmd
};

static const bcmlrd_map_table_attr_t bcm56990_b0_lrd_lb_hash_port_trunk_output_selectiont_attr_entry[] = {
    { /* 0 */
...
static const bcmlrd_map_attr_t bcm56990_b0_lrd_lb_hash_port_trunk_output_selectiont_attr_group = {
    .attributes = 3,
    .attr = bcm56990_b0_lrd_lb_hash_port_trunk_output_selectiont_attr_entry,
};

static const bcmlrd_map_entry_t bcm56990_b0_lrd_lb_hash_port_trunk_output_selectiont_rtag7_port_based_hash_map_entry[] = {
    { /* 0 */
...
static const bcmlrd_map_group_t bcm56990_b0_lrd_lb_hash_port_trunk_output_selection_map_group[] = {
    {
        .dest = {
        ...
        .entries = 7,
        .entry = bcm56990_b0_lrd_lb_hash_port_trunk_output_selectiont_rtag7_port_based_hash_map_entry
    },
};
const bcmlrd_map_t bcm56990_b0_lrd_lb_hash_port_trunk_output_selection_map = {
    .src_id = LB_HASH_PORT_TRUNK_OUTPUT_SELECTIONt,
    .field_data = &bcm56990_b0_lrd_lb_hash_port_trunk_output_selection_map_field_data,
    .groups = 1,
    .group  = bcm56990_b0_lrd_lb_hash_port_trunk_output_selection_map_group,
    .table_attr = &bcm56990_b0_lrd_lb_hash_port_trunk_output_selectiont_attr_group,
