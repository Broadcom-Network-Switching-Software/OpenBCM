...
static const bcmlrd_map_entry_t bcm56990_b0_lrd_tnl_l2_vxlan_decap_ovid_dst_ipv6_emt_l3_tunnel_double_map_entry[] = {
    ...
    { /* 5 */
        ...
        .desc = {
            .field_id  = VXLAN_DIP_V6v_PAYLOAD_IPV6f,
            .field_idx = 0,
            .minbit    = 204,
            .maxbit    = 204,
            .entry_idx = 0,
        ...
        .u = {
            .mapped = {
                .src = {
                    .field_id = TNL_L2_VXLAN_DECAP_OVID_DST_IPV6_EMt_IPV6_PAYLOADf,
                    .field_idx = 0,
                    .minbit    = 0,
                    .maxbit    = 0,
                    .entry_idx = 0,
    ...
    { /* 6 */
        .entry_type = BCMLRD_MAP_ENTRY_MAPPED_VALUE,
        .desc = {
            .field_id  = VXLAN_DIP_V6v_PAYLOAD_IPV4f,
            .field_idx = 0,
            .minbit    = 205,
            .maxbit    = 205,
            .entry_idx = 0,
        ...
        .u = {
            .mapped = {
                .src = {
                    .field_id = TNL_L2_VXLAN_DECAP_OVID_DST_IPV6_EMt_IPV4_PAYLOADf,
                    .field_idx = 0,
                    .minbit    = 0,
                    .maxbit    = 0,
                    .entry_idx = 0,
