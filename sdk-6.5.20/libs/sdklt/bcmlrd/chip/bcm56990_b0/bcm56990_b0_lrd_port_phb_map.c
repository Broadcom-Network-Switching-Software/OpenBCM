 ...
 *    INTERNAL/fltg/xgs/port/bcm56990_b0/bcm56990_b0_PORT_PHB.map.ltl for
 *      bcm56990_b0
 *
...
/* PORT_PHB field init */
static const bcmlrd_field_data_t bcm56990_b0_lrd_port_phb_map_field_data_mmd[] = {
    { /* 0 PORT_ID */
...
const bcmlrd_map_field_data_t bcm56990_b0_lrd_port_phb_map_field_data = {
    .fields = 14,
    .field = bcm56990_b0_lrd_port_phb_map_field_data_mmd
};

static const bcmlrd_map_table_attr_t bcm56990_b0_lrd_port_phbt_attr_entry[] = {
    { /* 0 */
...
static const bcmlrd_map_attr_t bcm56990_b0_lrd_port_phbt_attr_group = {
    .attributes = 3,
    .attr = bcm56990_b0_lrd_port_phbt_attr_entry,
};

static const bcmlrd_map_entry_t bcm56990_b0_lrd_port_phbt_egr_port_map_entry[] = {
    { /* 0 */
...
static const bcmlrd_map_entry_t bcm56990_b0_lrd_port_phbt_egr_vlan_control_1_map_entry[] = {
    { /* 0 */
        .entry_type = BCMLRD_MAP_ENTRY_MAPPED_KEY,
        .desc = {
...
static const bcmlrd_map_entry_t bcm56990_b0_lrd_port_phbt_egr_vlan_control_2_map_entry[] = {
    { /* 0 */
        .entry_type = BCMLRD_MAP_ENTRY_MAPPED_KEY,
        .desc = {
            .field_id  = BCMLRD_FIELD_PORT,
...
static const bcmlrd_map_entry_t bcm56990_b0_lrd_port_phbt_egr_vlan_control_3_map_entry[] = {
    { /* 0 */
        .entry_type = BCMLRD_MAP_ENTRY_MAPPED_KEY,
        .desc = {
            .field_id  = BCMLRD_FIELD_PORT,
...
static const bcmlrd_map_entry_t bcm56990_b0_lrd_port_phbt_port_tab_map_entry[] = {
    { /* 0 */
        .entry_type = BCMLRD_MAP_ENTRY_MAPPED_KEY,
        .desc = {
            .field_id  = BCMLRD_FIELD_INDEX,
...
static const bcmlrd_map_group_t bcm56990_b0_lrd_port_phb_map_group[] = {
    {
        .dest = {
        ...
        .entries = 2,
        .entry = bcm56990_b0_lrd_port_phbt_egr_port_map_entry
    },
    {
        .dest = {
            .kind = BCMLRD_MAP_PHYSICAL,
        ...
        .entries = 3,
        .entry = bcm56990_b0_lrd_port_phbt_egr_vlan_control_1_map_entry
    },
    {
        .dest = {
            .kind = BCMLRD_MAP_PHYSICAL,
        ...
        .entries = 3,
        .entry = bcm56990_b0_lrd_port_phbt_egr_vlan_control_2_map_entry
    },
    {
        .dest = {
            .kind = BCMLRD_MAP_PHYSICAL,
        ...
        .entries = 1,
        .entry = bcm56990_b0_lrd_port_phbt_egr_vlan_control_3_map_entry
    },
    {
        .dest = {
            .kind = BCMLRD_MAP_PHYSICAL,
        ...
        .entries = 6,
        .entry = bcm56990_b0_lrd_port_phbt_port_tab_map_entry
    },
};
const bcmlrd_map_t bcm56990_b0_lrd_port_phb_map = {
    .src_id = PORT_PHBt,
    .field_data = &bcm56990_b0_lrd_port_phb_map_field_data,
    .groups = 5,
    .group  = bcm56990_b0_lrd_port_phb_map_group,
    .table_attr = &bcm56990_b0_lrd_port_phbt_attr_group,
