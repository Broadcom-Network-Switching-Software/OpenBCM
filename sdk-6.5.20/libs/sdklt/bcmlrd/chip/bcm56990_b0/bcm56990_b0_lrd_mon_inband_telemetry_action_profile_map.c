 ...
 *    INTERNAL/fltg/xgs/mon/bcm56990_b0/bcm56990_b0_MON_INBAND_TELEMETRY_ACTION_PROFILE.map.ltl for
 *      bcm56990_b0
 *
...
static const bcmlrd_field_data_t bcm56990_b0_lrd_mon_inband_telemetry_action_profile_map_field_data_mmd[] = {
    ...
    { /* 2 O_BIT_UPDATE_MODE */
      ...
      .depth = 0,
      .width = 2,
      .edata = BCM56990_B0_LRD_INBAND_TELEMETRY_O_BIT_UPDATE_MODE_T_DATA,
    },
    { /* 3 UPDATE_IP_LENGTH */
      .flags = 0,
      .min = &bcm56990_b0_lrd_ifd_is_true_0x0,
    ...
    { /* 4 TIMESTAMP_MODE */
      ...
      .depth = 0,
      .width = 1,
      .edata = BCM56990_B0_LRD_INBAND_TELEMETRY_TIMESTAMP_MODE_T_DATA,
    },
    { /* 5 RESIDENCE_TIME_FORMAT */
      ...
      .depth = 0,
      .width = 1,
      .edata = BCM56990_B0_LRD_INBAND_TELEMETRY_RESIDENCE_TIME_FORMAT_T_DATA,
    },
    { /* 6 METADATA_INSERT_MODE */
      ...
      .depth = 0,
      .width = 2,
      .edata = BCM56990_B0_LRD_INBAND_TELEMETRY_METADATA_INSERT_MODE_T_DATA,
    },
...
const bcmlrd_map_field_data_t bcm56990_b0_lrd_mon_inband_telemetry_action_profile_map_field_data = {
    .fields = 9,
    .field = bcm56990_b0_lrd_mon_inband_telemetry_action_profile_map_field_data_mmd
};

static const bcmlrd_map_table_attr_t bcm56990_b0_lrd_mon_inband_telemetry_action_profilet_attr_entry[] = {
    { /* 0 */
...
static const bcmlrd_map_attr_t bcm56990_b0_lrd_mon_inband_telemetry_action_profilet_attr_group = {
    .attributes = 3,
    .attr = bcm56990_b0_lrd_mon_inband_telemetry_action_profilet_attr_entry,
};

static const bcmlrd_map_entry_t bcm56990_b0_lrd_mon_inband_telemetry_action_profilet_egr_int_action_profile_map_entry[] = {
    { /* 0 */
...
static const bcmlrd_map_group_t bcm56990_b0_lrd_mon_inband_telemetry_action_profile_map_group[] = {
    {
        .dest = {
        ...
        .entries = 9,
        .entry = bcm56990_b0_lrd_mon_inband_telemetry_action_profilet_egr_int_action_profile_map_entry
    },
};
const bcmlrd_map_t bcm56990_b0_lrd_mon_inband_telemetry_action_profile_map = {
    .src_id = MON_INBAND_TELEMETRY_ACTION_PROFILEt,
    .field_data = &bcm56990_b0_lrd_mon_inband_telemetry_action_profile_map_field_data,
    .groups = 1,
    .group  = bcm56990_b0_lrd_mon_inband_telemetry_action_profile_map_group,
    .table_attr = &bcm56990_b0_lrd_mon_inband_telemetry_action_profilet_attr_group,
