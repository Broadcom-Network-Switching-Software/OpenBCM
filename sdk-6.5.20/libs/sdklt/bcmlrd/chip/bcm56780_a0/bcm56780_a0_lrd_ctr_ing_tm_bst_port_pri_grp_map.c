...
const bcmltd_field_desc_t
bcm56780_a0_lrd_bcmltx_track_index_src_field_desc_s8[2] = {
    {
        .field_id  = CTR_ING_TM_BST_PORT_PRI_GRPt_PORT_IDf,
        .field_idx = 0,
        .minbit    = 0,
...
const bcmlrd_field_xfrm_desc_t
bcm56780_a0_lta_bcmltx_track_index_xfrm_handler_fwd_s8_d0_desc = {
    .handler_id = BCMLTD_TRANSFORM_BCM56780_A0_LTA_BCMLTX_TRACK_INDEX_XFRM_HANDLER_FWD_S8_D0_ID,
    .src_fields = 2,
    .src = bcm56780_a0_lrd_bcmltx_track_index_src_field_desc_s8,
    .dst_fields = 1,
    .dst = bcm56780_a0_lrd_bcmltx_track_index_ctr_ing_tm_bst_port_pri_grp_dst_field_desc_d0,
};

const bcmlrd_field_xfrm_desc_t
bcm56780_a0_lta_bcmltx_track_index_xfrm_handler_rev_s8_d0_desc = {
    .handler_id = BCMLTD_TRANSFORM_BCM56780_A0_LTA_BCMLTX_TRACK_INDEX_XFRM_HANDLER_REV_S8_D0_ID,
    .src_fields = 1,
    .src = bcm56780_a0_lrd_bcmltx_track_index_ctr_ing_tm_bst_port_pri_grp_dst_field_desc_d0,
    .dst_fields = 2,
    .dst = bcm56780_a0_lrd_bcmltx_track_index_src_field_desc_s8,
};
...
static const bcmlrd_map_entry_t bcm56780_a0_lrd_ctr_ing_tm_bst_port_pri_grpt_mmu_thdi_port_pg_shared_bst_map_entry[] = {
    { /* 0 */
        ...
        .u = {
            .xfrm = {
                /* handler: bcm56780_a0_lta_bcmltx_track_index_xfrm_handler_fwd_s8_d0 */
                .desc = &bcm56780_a0_lta_bcmltx_track_index_xfrm_handler_fwd_s8_d0_desc,
            },
        },
    },
    { /* 1 */
        ...
        .u = {
            .xfrm = {
                /* handler: bcm56780_a0_lta_bcmltx_track_index_xfrm_handler_rev_s8_d0 */
                .desc = &bcm56780_a0_lta_bcmltx_track_index_xfrm_handler_rev_s8_d0_desc,
            },
        },
    },
    { /* 2 */
