/*! \file bcmsec_imm_sa_policy.c
 *
 * In-memory call back function for SA policy related IMM LTs.
 */
/*
                        ...
                        sa_policy_info_t *sa_policy)
{
    ...
    SHR_NULL_CHECK(drv->sa_policy_get, SHR_E_UNAVAIL);

    /* update physical table. */
    if (drv->sa_policy_get) {
        SHR_IF_ERR_EXIT
            (drv->sa_policy_get(unit, ltid, pt_dyn_info, sa_policy, encrypt));
    }
exit:
    SHR_FUNC_EXIT();
}
...
/*!
 * \brief  SA policy physical table configuration
                        ...
                        bcmltd_field_t *in)
{
    ...
    SHR_IF_ERR_EXIT(bcmsec_drv_get(unit, &drv));
    SHR_NULL_CHECK(drv->sa_policy_set, SHR_E_UNAVAIL);

    /* update physical table. */
    if (drv->sa_policy_set) {
        SHR_IF_ERR_EXIT
            (drv->sa_policy_set(unit, ltid, pt_dyn_info, in, encrypt));
    }
exit:
    SHR_FUNC_EXIT();
}
                                  ...
                                  bool ipsec)
{
    ...
    ltid = ipsec ? SEC_ENCRYPT_IPSEC_SA_POLICYt :
    ...
    fid = ipsec ? SEC_ENCRYPT_IPSEC_SA_POLICYt_SEC_BLOCK_IDf :
                  SEC_ENCRYPT_MACSEC_SA_POLICYt_SEC_BLOCK_IDf;
    SHR_IF_ERR_EXIT
        (bcmsec_field_list_set(unit, &in, fid, 0, blk_id));

    fid = ipsec ?
            SEC_ENCRYPT_IPSEC_SA_POLICYt_SEC_ENCRYPT_IPSEC_SA_POLICY_IDf:
            SEC_ENCRYPT_MACSEC_SA_POLICYt_SEC_ENCRYPT_MACSEC_SA_POLICY_IDf;
    SHR_IF_ERR_EXIT
...
/*!
 * \brief SEC_ENCRYPT_MACSEC_SA_POLICY logical table staging function.
 *
 * Handle SEC_ENCRYPT_MACSEC_SA_POLICY IMM table change events.
 *
 * \param [in] unit Unit number.
 ...
 */
static int
bcmsec_sa_policy_encrypt_stage(int unit,
                       bcmltd_sid_t ltid,
                       uint32_t trans_id,
                       ...
                       bcmltd_fields_t *output_fields)
{
    ...
    SHR_FUNC_ENTER(unit);
    ipsec = (ltid == SEC_ENCRYPT_MACSEC_SA_POLICYt) ? 0 : 1;

    fid = ipsec ?
            SEC_ENCRYPT_IPSEC_SA_POLICYt_SEC_BLOCK_IDf:
            SEC_ENCRYPT_MACSEC_SA_POLICYt_SEC_BLOCK_IDf;
    SHR_IF_ERR_EXIT
 ...
 */
static int
bcmsec_sa_policy_encrypt_lookup(int unit,
                          bcmltd_sid_t ltid,
                          uint32_t trans_id,
                          void *context,
                          ...
                          bcmltd_fields_t *out)
{
    ...
    SHR_IF_ERR_EXIT
        (bcmsec_sa_policy_pt_get(unit, ltid, &pt_dyn_info, true,
                                 &sa_policy));

    fid = ipsec ?
            SEC_ENCRYPT_IPSEC_SA_POLICYt_NEXT_PKT_NUMBERf:
            SEC_ENCRYPT_MACSEC_SA_POLICYt_NEXT_PKT_NUMBERf;
    ...
    fid = ipsec ?
            ...
            SEC_ENCRYPT_MACSEC_SA_POLICYt_IN_USEf;
    ...
    fid = ipsec ?
            ...
            SEC_ENCRYPT_MACSEC_SA_POLICYt_IN_USE_START_TIMEf;
    ...
    fid = ipsec ?
            ...
            SEC_ENCRYPT_MACSEC_SA_POLICYt_IN_USE_STOP_TIMEf;
...
{
    /*!
     * Inmemory callback functions for SEC_ENCRYPT_MACSEC_SA_POLICY
     * logical table.
     */
    bcmimm_lt_cb_t bcmsec_sa_policy_imm_cb = {
        /*! Staging function. */
        .stage = bcmsec_sa_policy_encrypt_stage,

        /*! Lookup function. */
        .lookup = bcmsec_sa_policy_encrypt_lookup,
    };
    ...
    /* SEC_ENCRYPT_MACSEC_SA_POLICYt */
    rv = bcmlrd_map_get(unit, SEC_ENCRYPT_MACSEC_SA_POLICYt, &map);
    ...
    SHR_IF_ERR_EXIT
        (bcmimm_lt_event_reg(unit, SEC_ENCRYPT_MACSEC_SA_POLICYt,
                             &bcmsec_sa_policy_imm_cb, NULL));

    /* SEC_ENCRYPT_IPSEC_SA_POLICYt */
    rv = bcmlrd_map_get(unit, SEC_ENCRYPT_IPSEC_SA_POLICYt, &map);
    SHR_IF_ERR_EXIT_EXCEPT_IF(rv, SHR_E_UNAVAIL);
    ...
    /*! Registers callback functions for decrypt port settings. */
    SHR_IF_ERR_EXIT
        (bcmimm_lt_event_reg(unit, SEC_ENCRYPT_IPSEC_SA_POLICYt,
                             &bcmsec_sa_policy_imm_cb, NULL));
exit:
    SHR_FUNC_EXIT();
}
