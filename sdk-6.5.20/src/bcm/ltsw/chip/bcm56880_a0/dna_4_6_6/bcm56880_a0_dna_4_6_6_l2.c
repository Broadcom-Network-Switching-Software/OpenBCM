/*! \file bcm56880_a0_dna_4_6_6_l2.c
 *
 * BCM56880_A0 DNA_4_6_6 L2 driver.
 */
/*
...
bcmint_l2_id_map_t l2_host_table_map[] = {
    {
        ...
        .val = BCM56880_A0_DNA_4_6_6_L2_HOST_TABLEt
    },
    {
        .idx = BCMINT_L2_HOST_FLD_MAC_ADDR,
        .val = BCM56880_A0_DNA_4_6_6_L2_HOST_TABLEt_MAC_ADDRf
    },
    {
        .idx = BCMINT_L2_HOST_FLD_VFI,
        .val = BCM56880_A0_DNA_4_6_6_L2_HOST_TABLEt_VFIf
    },
    {
        .idx = BCMINT_L2_HOST_FLD_STRENGTH_PROFILE_INDEX,
        .val = BCM56880_A0_DNA_4_6_6_L2_HOST_TABLEt_STRENGTH_PROFILE_INDEXf
    },
    {
        .idx = BCMINT_L2_HOST_FLD_DESTINATION,
        .val = BCM56880_A0_DNA_4_6_6_L2_HOST_TABLEt_DESTINATIONf
    },
    {
        .idx = BCMINT_L2_HOST_FLD_DESTINATION_TYPE,
        .val = BCM56880_A0_DNA_4_6_6_L2_HOST_TABLEt_DESTINATION_TYPEf
    },
    {
        .idx = BCMINT_L2_HOST_FLD_CLASS_ID,
        .val = BCM56880_A0_DNA_4_6_6_L2_HOST_TABLEt_CLASS_IDf
    },
    {
        .idx = BCMINT_L2_HOST_FLD_DST_PVLAN_PORT_TYPE,
        .val = BCM56880_A0_DNA_4_6_6_L2_HOST_TABLEt_DST_PVLAN_PORT_TYPEf
    },
    {
        .idx = BCMINT_L2_HOST_FLD_DST_VP_GROUP,
        .val = BCM56880_A0_DNA_4_6_6_L2_HOST_TABLEt_DST_VP_GROUPf
    },
    {
        .idx = BCMINT_L2_HOST_FLD_COMMUNITY_PVLAN_ID,
        .val = BCM56880_A0_DNA_4_6_6_L2_HOST_TABLEt_COMMUNITY_PVLAN_IDf
    },
    {
        .idx = BCMINT_L2_HOST_FLD_NHOP_2_OR_ECMP_GROUP_INDEX_1,
        .val = BCM56880_A0_DNA_4_6_6_L2_HOST_TABLEt_NHOP_2_OR_ECMP_GROUP_INDEX_1f
    },
    {
        .idx = BCMINT_L2_HOST_FLD_ECMP_AND_PROT_SWT_SFC_PROFILE_INDEX,
        .val = BCM56880_A0_DNA_4_6_6_L2_HOST_TABLEt_ECMP_AND_PROT_SWT_SFC_PROFILE_INDEXf
    },
    {
        .idx = BCMINT_L2_HOST_FLD_FLEX_CTR_ACTION,
        .val = BCM56880_A0_DNA_4_6_6_L2_HOST_TABLEt_FLEX_CTR_ACTIONf
    },
    {
        .idx = BCMINT_L2_HOST_FLD_MISC_CTRL_0,
        .val = BCM56880_A0_DNA_4_6_6_L2_HOST_TABLEt_MISC_CTRL_0f
    },
    {
        .idx = BCMINT_L2_HOST_FLD_MISC_CTRL_1,
        .val = BCM56880_A0_DNA_4_6_6_L2_HOST_TABLEt_MISC_CTRL_1f
    },
    {
        .idx = BCMINT_L2_HOST_FLD_DST_ENTRY_INDEX,
        .val = BCM56880_A0_DNA_4_6_6_L2_HOST_TABLEt_DST_ENTRY_INDEXf
    },
    {
        .idx = BCMINT_L2_HOST_FLD_SRC_ENTRY_INDEX,
        .val = BCM56880_A0_DNA_4_6_6_L2_HOST_TABLEt_SRC_ENTRY_INDEXf
    },
    {
...
bcmint_l2_id_map_t l2_host_narrow_table_map[] = {
    {
        ...
        .val = BCM56880_A0_DNA_4_6_6_L2_HOST_NARROW_TABLEt
    },
    {
        .idx = BCMINT_L2_HOST_NARROW_FLD_MAC_ADDR,
        .val = BCM56880_A0_DNA_4_6_6_L2_HOST_NARROW_TABLEt_MAC_ADDRf
    },
    {
        .idx = BCMINT_L2_HOST_NARROW_FLD_VFI,
        .val = BCM56880_A0_DNA_4_6_6_L2_HOST_NARROW_TABLEt_VFIf
    },
    {
    ...
    },
    {
        ...
        .val = BCM56880_A0_DNA_4_6_6_L2_HOST_NARROW_TABLEt_DESTINATIONf
    },
    {
        .idx = BCMINT_L2_HOST_NARROW_FLD_DESTINATION_TYPE,
        .val = BCM56880_A0_DNA_4_6_6_L2_HOST_NARROW_TABLEt_DESTINATION_TYPEf
    },
    {
        .idx = BCMINT_L2_HOST_NARROW_FLD_MISC_CTRL_0,
        .val = BCM56880_A0_DNA_4_6_6_L2_HOST_NARROW_TABLEt_MISC_CTRL_0f
    },
    {
        .idx = BCMINT_L2_HOST_NARROW_FLD_MISC_CTRL_1,
        .val = BCM56880_A0_DNA_4_6_6_L2_HOST_NARROW_TABLEt_MISC_CTRL_1f
    },
    {
        .idx = BCMINT_L2_HOST_NARROW_FLD_FLEX_CTR_ACTION,
        .val = BCM56880_A0_DNA_4_6_6_L2_HOST_NARROW_TABLEt_FLEX_CTR_ACTIONf
    },
    {
        .idx = BCMINT_L2_HOST_NARROW_FLD_DST_ENTRY_INDEX,
        .val = BCM56880_A0_DNA_4_6_6_L2_HOST_NARROW_TABLEt_DST_ENTRY_INDEXf
    },
    {
        .idx = BCMINT_L2_HOST_NARROW_FLD_SRC_ENTRY_INDEX,
        .val = BCM56880_A0_DNA_4_6_6_L2_HOST_NARROW_TABLEt_SRC_ENTRY_INDEXf
    },
    {
 ...
 */
static int
bcm56880_a0_dna_4_6_6_ltsw_l2_map_db_init(int unit,
...
/*!
 * \brief L2 driver function variable for bcm56880_a0 DNA_4_6_6 device.
 */
static mbcm_ltsw_l2_drv_t bcm56880_a0_dna_4_6_6_ltsw_l2_drv = {
    .l2_map_db_init = bcm56880_a0_dna_4_6_6_ltsw_l2_map_db_init
};
...
int
bcm56880_a0_dna_4_6_6_ltsw_l2_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_l2_drv_set(unit, &bcm56880_a0_dna_4_6_6_ltsw_l2_drv));
