/*! \file bcm56880_a0_dna_4_6_6_field.c
 *
 * BCM56880_A0 DNA_4_6_6 FIELD driver.
 */
/*
...
#include <bcm_int/ltsw/chip/bcm56880_a0/dna_4_6_6/bcm56880_a0_dna_4_6_6_field_lt_map.h>
 ...
 */
static int
bcm56880_a0_dna_4_6_6_ltsw_field_stage_db_init(int unit,
                                         bcmint_field_stage_info_t *stage_info)
{
    ...
    if (stage_info->stage_id == bcmiFieldStageIngress) {
        ...
        stage_info->qual_db_count = (sizeof(bcm56880_a0_dna_4_6_6_ifp_qual_data)) /
                                            (sizeof(bcm_field_qual_map_t));
        stage_info->presel_qual_db_count =
                                   (sizeof(bcm56880_a0_dna_4_6_6_ifp_presel_qual_data)) /
                                   (sizeof(bcm_field_qual_map_t));
        stage_info->action_db_count = (sizeof(bcm56880_a0_dna_4_6_6_ifp_action_data)) /
                                            (sizeof(bcm_field_action_map_t));

        /* Initialise lt map db */
        stage_info->qual_lt_map_db = bcm56880_a0_dna_4_6_6_ifp_qual_data;
        stage_info->presel_qual_lt_map_db = bcm56880_a0_dna_4_6_6_ifp_presel_qual_data;
        stage_info->action_lt_map_db = bcm56880_a0_dna_4_6_6_ifp_action_data;
        ...
        stage_info->presel_qual_db_count =
                                   (sizeof(bcm56880_a0_dna_4_6_6_ifp_presel_qual_data)) /
                                   (sizeof(bcm_field_qual_map_t));
        stage_info->action_db_count = (sizeof(bcm56880_a0_dna_4_6_6_em_action_data)) /
                                            (sizeof(bcm_field_action_map_t));
        ...
        stage_info->action_lt_map_db = bcm56880_a0_dna_4_6_6_em_action_data;
        ...
        /* Initialise qual db counts */
        stage_info->qual_db_count = (sizeof(bcm56880_a0_dna_4_6_6_efp_qual_data)) /
                                            (sizeof(bcm_field_qual_map_t));
        stage_info->presel_qual_db_count =
                                   (sizeof(bcm56880_a0_dna_4_6_6_efp_presel_qual_data)) /
                                                 (sizeof(bcm_field_qual_map_t));
        stage_info->action_db_count = (sizeof(bcm56880_a0_dna_4_6_6_efp_action_data)) /
                                            (sizeof(bcm_field_action_map_t));

        /* Initialise lt map db */
        stage_info->qual_lt_map_db = bcm56880_a0_dna_4_6_6_efp_qual_data;

        stage_info->presel_qual_lt_map_db = bcm56880_a0_dna_4_6_6_efp_presel_qual_data;

        stage_info->action_lt_map_db = bcm56880_a0_dna_4_6_6_efp_action_data;
        ...
        /* Initialise qual db counts */
        stage_info->qual_db_count = (sizeof(bcm56880_a0_dna_4_6_6_vfp_qual_data)) /
                                            (sizeof(bcm_field_qual_map_t));
        stage_info->presel_qual_db_count =
                                    (sizeof(bcm56880_a0_dna_4_6_6_vfp_presel_qual_data)) /
                                            (sizeof(bcm_field_qual_map_t));
        stage_info->action_db_count = (sizeof(bcm56880_a0_dna_4_6_6_vfp_action_data)) /
                                               (sizeof(bcm_field_action_map_t));

        /* Initialise lt map db */
        stage_info->qual_lt_map_db = bcm56880_a0_dna_4_6_6_vfp_qual_data;

        stage_info->presel_qual_lt_map_db = bcm56880_a0_dna_4_6_6_vfp_presel_qual_data;

        stage_info->action_lt_map_db = bcm56880_a0_dna_4_6_6_vfp_action_data;
    } else {
        /* Do nothing */
    }
...
static int
bcm56880_a0_dna_4_6_6_ltsw_field_control_lt_info_init(
        int unit,
...
static int
bcm56880_a0_dna_4_6_6_ltsw_field_manual_enum_to_lt_enum_value_get(
        int unit,
...
static int
bcm56880_a0_dna_4_6_6_ltsw_field_manual_lt_enum_value_to_enum_get(
        int unit,
        bcm_field_entry_t entry,
        bcm_field_qualify_t qual,
        bcm_qual_field_t *qual_info,
...
/*!
 * \brief field driver function variable for bcm56880_a0 DNA_4_6_6 device.
 */
static mbcm_ltsw_field_drv_t bcm56880_a0_dna_4_6_6_ltsw_field_drv = {
    .field_stage_db_init = bcm56880_a0_dna_4_6_6_ltsw_field_stage_db_init,
    .field_control_lt_info_init =
                    bcm56880_a0_dna_4_6_6_ltsw_field_control_lt_info_init,
    .field_auto_enum_to_lt_enum_value_get =
           bcm56880_a0_dna_4_6_6_ltsw_field_auto_enum_to_lt_enum_value_get,
    .field_auto_lt_enum_value_to_enum_get =
            bcm56880_a0_dna_4_6_6_ltsw_field_auto_lt_enum_value_to_enum_get,
...
int
bcm56880_a0_dna_4_6_6_ltsw_field_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_field_drv_set(unit, &bcm56880_a0_dna_4_6_6_ltsw_field_drv));
