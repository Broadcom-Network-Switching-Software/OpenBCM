/*! \file bcm56880_a0_dna_4_6_6_pktio.c
 *
 * BCM56880_A0 DNA_4_6_6 PKTIO Driver.
 */
/*
...
static
bcmint_pktio_fid_info_t bcm56880_a0_dna_4_6_6_rxpmd_flex_db[] = {
    {
    ...
    },
    {
        ...
        .lt_fid = BCMPKT_RXPMD_FLEX_INGRESS_QOS_REMAP_VALUE_OR_IFP_OPAQUE_OBJ_15_0,
        .profile_bmp = 0x3c,
    },
    {
    ...
    },
    {
        ...
        .lt_fid = BCMPKT_RXPMD_FLEX_EM_FT_OPAQUE_OBJ_OR_IFP_OPAQUE_OBJ_15_0,
        .profile_bmp = 0xc,
    },
    {
    ...
    },
    {
        ...
        .lt_fid = BCMPKT_RXPMD_FLEX_EVENT_TRACE_VECTOR_31_0,
        .profile_bmp = 0x3c,
    },
    {
        .fid = BCM_PKTIO_RXPMD_FLEX_ING_TIMESTAMP_31_0,
        .lt_fid = BCMPKT_RXPMD_FLEX_ING_TIMESTAMP_31_0,
        .profile_bmp = 0x3c,
    },
    {
        .fid = BCM_PKTIO_RXPMD_FLEX_MPLS_LABEL_DECAP_COUNT_3_0,
        .lt_fid = BCMPKT_RXPMD_FLEX_MPLS_LABEL_DECAP_COUNT_3_0,
        .profile_bmp = 0x3c,
    },
    {
        /* Always last. */
...
static
bcmint_pktio_fid_info_t bcm56880_a0_dna_4_6_6_generic_loopback_db[] = {
    {
...
static
bcmint_pktio_fid_info_t bcm56880_a0_dna_4_6_6_hg3_db[] = {
    {
...
static
bcmint_pktio_fid_info_t bcm56880_a0_dna_4_6_6_rxpmd_flex_reason_db[] = {
    {
    ...
    },
    {
        ...
        .lt_fid = BCMPKT_RXPMD_FLEX_REASON_NO_COPY_TO_CPU,
    },
    {
        .fid = BCM_PKTIO_RXPMD_FLEX_REASON_L2_SRC_DISCARD,
        .lt_fid = BCMPKT_RXPMD_FLEX_REASON_L2_SRC_DISCARD,
    },
    {
        .fid = BCM_PKTIO_RXPMD_FLEX_REASON_MACSA_MULTICAST,
        .lt_fid = BCMPKT_RXPMD_FLEX_REASON_MACSA_MULTICAST,
    },
    {
        .fid = BCM_PKTIO_RXPMD_FLEX_REASON_MEMBERSHIP_CHECK_FAILED,
        .lt_fid = BCMPKT_RXPMD_FLEX_REASON_MEMBERSHIP_CHECK_FAILED,
    },
    {
        .fid = BCM_PKTIO_RXPMD_FLEX_REASON_SPANNING_TREE_CHECK_FAILED,
        .lt_fid = BCMPKT_RXPMD_FLEX_REASON_SPANNING_TREE_CHECK_FAILED,
    },
    {
        .fid = BCM_PKTIO_RXPMD_FLEX_REASON_MIRROR_SAMPLER_SAMPLED,
        .lt_fid = BCMPKT_RXPMD_FLEX_REASON_MIRROR_SAMPLER_SAMPLED,
    },
    {
        .fid = BCM_PKTIO_RXPMD_FLEX_REASON_MIRROR_SAMPLER_EGR_SAMPLED,
        .lt_fid = BCMPKT_RXPMD_FLEX_REASON_MIRROR_SAMPLER_EGR_SAMPLED,
    },
    {
        .fid = BCM_PKTIO_RXPMD_FLEX_REASON_SER_DROP,
        .lt_fid = BCMPKT_RXPMD_FLEX_REASON_SER_DROP,
    },
    {
        .fid = BCM_PKTIO_RXPMD_FLEX_REASON_URPF_CHECK_FAILED,
        .lt_fid = BCMPKT_RXPMD_FLEX_REASON_URPF_CHECK_FAILED,
    },
    {
        .fid = BCM_PKTIO_RXPMD_FLEX_REASON_L3_IIF_EQ_L3_OIF,
        .lt_fid = BCMPKT_RXPMD_FLEX_REASON_L3_IIF_EQ_L3_OIF,
    },
    {
        .fid = BCM_PKTIO_RXPMD_FLEX_REASON_DLB_ECMP_MONITOR_EN_OR_MEMBER_REASSINED,
        .lt_fid = BCMPKT_RXPMD_FLEX_REASON_DLB_ECMP_MONITOR_EN_OR_MEMBER_REASSINED,
    },
    {
        .fid = BCM_PKTIO_RXPMD_FLEX_REASON_DLB_LAG_MONITOR_EN_OR_MEMBER_REASSINED,
        .lt_fid = BCMPKT_RXPMD_FLEX_REASON_DLB_LAG_MONITOR_EN_OR_MEMBER_REASSINED,
    },
    {
        .fid = BCM_PKTIO_RXPMD_FLEX_REASON_MPLS_CTRL_PKT_TO_CPU,
        .lt_fid = BCMPKT_RXPMD_FLEX_REASON_MPLS_CTRL_PKT_TO_CPU,
    },
    {
        .fid = BCM_PKTIO_RXPMD_FLEX_REASON_TRACE_DOP,
        .lt_fid = BCMPKT_RXPMD_FLEX_REASON_TRACE_DOP,
    },
    {
        /* Always last. */
        .fid = BCM_PKTIO_FID_INVALID,
...
static
bcmint_pktio_fid_info_t bcm56880_a0_dna_4_6_6_match_id_db[] = {
    {
...
static int
bcm56880_a0_dna_4_6_6_ltsw_pktio_fid_support_get(
    int unit,
    ...
    bcm_pktio_bitmap_t *support)
{
    ...
    switch (hdr_info->pmd_type) {
        case bcmPktioPmdTypeRxFlex:
            fid_p = fid_db = bcm56880_a0_dna_4_6_6_rxpmd_flex_db;
            break;

        case bcmPktioPmdTypeGih:
            fid_p = fid_db = bcm56880_a0_dna_4_6_6_generic_loopback_db;
            break;

        case bcmPktioPmdTypeHigig3:
            fid_p = fid_db = bcm56880_a0_dna_4_6_6_hg3_db;
            break;
...
static int
bcm56880_a0_dna_4_6_6_ltsw_pktio_fid_info_get(
    int unit,
    bcmint_pktio_hdr_info_t *hdr_info,
    bcmint_pktio_fid_info_t **fid_info)
{
    ...
    switch (hdr_info->pmd_type) {
        ...
        case bcmintPktioPmdTypeMatchId:
            fid_p = fid_db = bcm56880_a0_dna_4_6_6_match_id_db;
            break;
...
static int
bcm56880_a0_dna_4_6_6_ltsw_pktio_fid_info_lookup(
    int unit,
    int opcode,
    bcmint_pktio_hdr_info_t *hdr_info,
    bcmint_pktio_fid_info_t **fid_info)
{
    ...
    switch (hdr_info->pmd_type) {
        case bcmPktioPmdTypeRxFlex:
            fid_p = fid_db = bcm56880_a0_dna_4_6_6_rxpmd_flex_reason_db;
            break;
...
/*!
 * \brief Pktio driver function variable for bcm56880_a0_dna_4_6_6 device.
 */
static mbcm_ltsw_pktio_drv_t bcm56880_a0_dna_4_6_6_ltsw_pktio_drv = {
    .pktio_fid_support_get = bcm56880_a0_dna_4_6_6_ltsw_pktio_fid_support_get,
    .pktio_fid_info_get = bcm56880_a0_dna_4_6_6_ltsw_pktio_fid_info_get,
    .pktio_fid_info_lookup = bcm56880_a0_dna_4_6_6_ltsw_pktio_fid_info_lookup
};
...
int
bcm56880_a0_dna_4_6_6_ltsw_pktio_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_pktio_drv_set(unit, &bcm56880_a0_dna_4_6_6_ltsw_pktio_drv));
