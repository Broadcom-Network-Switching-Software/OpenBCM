...
#include <bcm_int/ltsw/chip/bcm56880_a0/udf.h>
...
static mbcm_ltsw_udf_drv_t bcm56880_a0_ltsw_udf_drv = {
    .udf_init               = bcm56880_a0_ltsw_udf_init,           /* UDF init */
...
/* UDF table info */
bcmint_udf_lt_tbls_info_t bcm56880_a0_udf_tbls_info = {
    .udf_sid             = "UDF_POLICY",
 ...
 */
static char *bcm56880_a0_abstr_fmt_ltmap[bcmUdfAbstractPktFormatLastCount] = {
    ...
    NULL                                  /* bcmUdfAbstractPktFormatRecircleHdr */
};
...
int
bcm56880_a0_ltsw_udf_drv_attach(int unit)
{
   return mbcm_ltsw_udf_drv_set(unit, &bcm56880_a0_ltsw_udf_drv);
}
...
bcm56880_a0_ltsw_udf_init(int unit)
{
    ...
    for (fmt = 0; fmt < bcmUdfAbstractPktFormatLastCount; fmt++) {
        if (bcm56880_a0_abstr_fmt_ltmap[fmt] != NULL) {
            lt_info = NULL;
    ...
    udf_tbls_info[unit] = &bcm56880_a0_udf_tbls_info;
