...
static int
bcmgene_clear_handle(bcmgene_handle_t *hndl)
{
    bcmgene_table_desc_t *tbl = NULL;
    ...
    tbl = hndl->tbl;
    SHR_IF_ERR_VERBOSE_EXIT
        (bcmi_lt_clear(hndl->unit, tbl->table));
 ...
 */
int
bcm56880_a0_gene_sub_feature_get(
    int unit,
    bcmgene_desc_t *gene,
    uint32_t func,
    uint32_t *sub_f)
...
int
bcm56880_a0_gene_batch_handle_create(bcmgene_handle_t *hndl)
{
    return bcmgene_batch_handle_create(hndl);
}

int
bcm56880_a0_gene_batch_handle_destroy(bcmgene_handle_t *hndl)
{
    return bcmgene_batch_handle_destroy(hndl);
}

int
bcm56880_a0_gene_handle_create(bcmgene_handle_t *hndl)
{
    return bcmgene_handle_create(hndl);
}

int
bcm56880_a0_gene_handle_destroy(bcmgene_handle_t *hndl)
{
    return bcmgene_handle_destroy(hndl);
}

int
bcm56880_a0_gene_validate_tag(
    bcmgene_handle_t *hndl,
    int blk,
    int offset)
{
...
int
bcm56880_a0_gene_validate_field(
    bcmgene_handle_t *hndl,
    int blk,
    int offset,
    uint64_t value)
...
int
bcm56880_a0_gene_validate_field_array(
    bcmgene_handle_t *hndl,
    int blk,
    int offset,
    int index,
...
int
bcm56880_a0_gene_fill_field_array(
    bcmgene_handle_t *hndl,
    int blk,
    int offset,
    uint32_t index,
...
int
bcm56880_a0_gene_fill_callback(
    bcmgene_handle_t *hndl,
    int (*cb)(bcmgene_handle_t *hndl, void *user_data))
{
...
int
bcm56880_a0_gene_fill_priority(
    bcmgene_handle_t *hndl,
    int priority)
{
...
int
bcm56880_a0_gene_fill_batch_handle(bcmgene_handle_t *hndl)
{
    return bcmgene_fill_batch_handle(hndl);
}

int
bcm56880_a0_gene_commit(bcmgene_handle_t *hndl)
{
    return bcmgene_commit(hndl);
}

int
bcm56880_a0_gene_commit_done(bcmgene_handle_t *hndl)
{
    return bcmgene_commit_done(hndl);
}

int
bcm56880_a0_gene_commit_batch(bcmgene_handle_t *hndl)
{
    return bcmgene_commit_batch(hndl);
}

int
bcm56880_a0_gene_edit(bcmgene_handle_t *hndl)
{
    return bcmgene_edit(hndl);
}

int
bcm56880_a0_gene_unset(bcmgene_handle_t *hndl)
{
    return bcmgene_unset(hndl);
}

int
bcm56880_a0_gene_lookup(bcmgene_handle_t *hndl)
{
    return bcmgene_lookup(hndl);
}

int
bcm56880_a0_gene_lookup_key(
    bcmgene_handle_t *hndl,
    int index,
    uint64_t *value)
{
...
int
bcm56880_a0_gene_lookup_field_array(
    bcmgene_handle_t *hndl,
    int blk,
    int offset,
    uint32_t index,
...
int
bcm56880_a0_gene_lookup_done(bcmgene_handle_t *hndl)
{
    return bcmgene_lookup_done(hndl);
}

int
bcm56880_a0_gene_traverse(
    bcmgene_handle_t *hndl,
    void *user_data)
{
...
int
bcm56880_a0_gene_clear_handle(bcmgene_handle_t *hndl)
{
    return bcmgene_clear_handle(hndl);
}

int
bcm56880_a0_gene_error_return(
    bcmgene_handle_t *hndl,
    int rv)
{
...
int
bcm56880_a0_gene_func_traverse(
    int unit,
    bcmgene_desc_t *gene,
    uint32_t function,
    int (*cb)(bcmgene_handle_t *hndl, void *user_data),
