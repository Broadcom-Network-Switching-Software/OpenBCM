 ...
 */
static int
bcm56780_a0_ltsw_rate_alloc_midx(
    int unit,
    uint32_t *sc_id)
{
    int i;
 ...
 */
static int
bcm56780_a0_ltsw_rate_free_midx(
    int unit,
    uint32_t id)
{
...
static int
bcm56780_a0_ltsw_rate_init(int unit)
{
    uint32_t sc_id;
...
static int
bcm56780_a0_ltsw_rate_deinit(int unit)
{
    int i;
...
static int
bcm56780_a0_ltsw_rate_clear(int unit)
{
    SHR_FUNC_ENTER(unit);
    ...
    bcmint_rate_info_t *rate_info)
{
    ...
    if (rate_info->all_port) {
        ...
        if (sc_id != RATE_SC_METER_ID_DEFAULT &&
            ...
            bcm56780_a0_ltsw_rate_free_midx(unit, sc_id);
        }
        ...
        if (sc_id == RATE_SC_METER_ID_DEFAULT ||
            ...
            SHR_IF_ERR_VERBOSE_EXIT
                (bcm56780_a0_ltsw_rate_alloc_midx(unit, &sc_id));
        }
    }
...
static int
bcm56780_a0_ltsw_rate_meter_adjust_set(
    int unit,
    bcm_port_t port,
    int value)
{
...
static int
bcm56780_a0_ltsw_rate_meter_adjust_get(
    int unit,
    bcm_port_t port,
    int *value)
{
...
static int
bcm56780_a0_ltsw_rate_shaper_adjust_set(
    int unit,
    bcm_port_t port,
    int value)
{
...
static int
bcm56780_a0_ltsw_rate_shaper_adjust_get(
    int unit,
    bcm_port_t port,
    int *value)
{
...
/*!
 * \brief Rate driver function variable for bcm56780_a0 device.
 */
static mbcm_ltsw_rate_drv_t bcm56780_a0_ltsw_rate_drv = {
    .rate_init = bcm56780_a0_ltsw_rate_init,
    .rate_deinit = bcm56780_a0_ltsw_rate_deinit,
    .rate_clear = bcm56780_a0_ltsw_rate_clear,
    .rate_set = bcm56780_a0_ltsw_rate_set,
    .rate_get = bcm56780_a0_ltsw_rate_get,
    .rate_dev_set = bcm56780_a0_ltsw_rate_dev_set,
    .rate_dev_get = bcm56780_a0_ltsw_rate_dev_get,
    .rate_meter_adjust_set = bcm56780_a0_ltsw_rate_meter_adjust_set,
    .rate_meter_adjust_get = bcm56780_a0_ltsw_rate_meter_adjust_get,
    .rate_shaper_adjust_set = bcm56780_a0_ltsw_rate_shaper_adjust_set,
    .rate_shaper_adjust_get = bcm56780_a0_ltsw_rate_shaper_adjust_get
};
...
int
bcm56780_a0_ltsw_rate_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_rate_drv_set(unit, &bcm56780_a0_ltsw_rate_drv));
