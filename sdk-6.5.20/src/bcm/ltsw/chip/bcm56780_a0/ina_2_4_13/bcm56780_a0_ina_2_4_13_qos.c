/*! \file bcm56780_a0_ina_2_4_13_qos.c
 *
 * BCM56780_A0 INA_2_4_13 QoS driver.
 */
/*
...
typedef enum qos_ing_policy_id_e {
    FLEX_QOS_QOS_DISABLE_ECN_DISABLE_2_INDEX            = 0,
    FLEX_QOS_QOS_DISABLE_ECN_DISABLE_1_INDEX            = 1,
    FLEX_QOS_QOS_L3_IIF_DSCP_L3_TUNNEL_ECN_INDEX        = 2,
    FLEX_QOS_QOS_L3_IIF_DSCP_L2_TUNNEL_ECN_INDEX        = 3,
    FLEX_QOS_QOS_L3_IIF_DSCP_NON_TUNNEL_ECN_INDEX       = 4,
    FLEX_QOS_QOS_SVP_DSCP_L3_TUNNEL_ECN_INDEX           = 5,
    FLEX_QOS_QOS_SVP_DSCP_L2_TUNNEL_ECN_INDEX           = 6,
    FLEX_QOS_QOS_SVP_DSCP_NON_TUNNEL_ECN_INDEX          = 7,
    FLEX_QOS_QOS_SVP_IDOT1P_CFI_L3_TUNNEL_ECN_INDEX     = 8,
    FLEX_QOS_QOS_SVP_IDOT1P_CFI_L2_TUNNEL_ECN_INDEX     = 9,
    FLEX_QOS_QOS_SVP_IDOT1P_CFI_NON_TUNNEL_ECN_INDEX    = 10,
    FLEX_QOS_QOS_SVP_IDOT1P_CFI_ECN_DISABLE_INDEX       = 11,
    FLEX_QOS_QOS_SVP_ODOT1P_CFI_L3_TUNNEL_ECN_INDEX     = 12,
    FLEX_QOS_QOS_SVP_ODOT1P_CFI_L2_TUNNEL_ECN_INDEX     = 13,
    FLEX_QOS_QOS_SVP_ODOT1P_CFI_NON_TUNNEL_ECN_INDEX    = 14,
    FLEX_QOS_QOS_SVP_ODOT1P_CFI_ECN_DISABLE_INDEX       = 15,
    FLEX_QOS_QOS_L2_IIF_DSCP_L3_TUNNEL_ECN_INDEX        = 16,
    FLEX_QOS_QOS_L2_IIF_DSCP_L2_TUNNEL_ECN_INDEX        = 17,
    FLEX_QOS_QOS_L2_IIF_DSCP_NON_TUNNEL_ECN_INDEX       = 18,
    FLEX_QOS_QOS_L2_IIF_IDOT1P_CFI_L3_TUNNEL_ECN_INDEX  = 19,
    FLEX_QOS_QOS_L2_IIF_IDOT1P_CFI_L2_TUNNEL_ECN_INDEX  = 20,
    FLEX_QOS_QOS_L2_IIF_IDOT1P_CFI_NON_TUNNEL_ECN_INDEX = 21,
    FLEX_QOS_QOS_L2_IIF_IDOT1P_CFI_ECN_DISABLE_INDEX    = 22,
    FLEX_QOS_QOS_L2_IIF_ODOT1P_CFI_L3_TUNNEL_ECN_INDEX  = 23,
    FLEX_QOS_QOS_L2_IIF_ODOT1P_CFI_L2_TUNNEL_ECN_INDEX  = 24,
    FLEX_QOS_QOS_L2_IIF_ODOT1P_CFI_NON_TUNNEL_ECN_INDEX = 25,
    FLEX_QOS_QOS_L2_IIF_ODOT1P_CFI_ECN_DISABLE_INDEX    = 26,
    FLEX_QOS_QOS_DISABLE_ECN_DISABLE_0_INDEX            = 27,
    FLEX_QOS_ING_POLICY_ID_CNT                          = 28
} qos_ing_policy_id_t;
...
typedef enum qos_egr_policy_id_e {
    FLEX_QOS_QOS_REMARK_L3_TUNNEL_ENCAP_D1P_TOS_COPY_INDEX      = 0,
    FLEX_QOS_QOS_REMARK_L3_TUNNEL_ENCAP_D1P_COPY_INDEX          = 1,
    FLEX_QOS_QOS_REMARK_L2_L3_TUNNEL_ENCAP_TOS_COPY_1_INDEX     = 2,
    FLEX_QOS_QOS_REMARK_L2_L3_TUNNEL_ENCAP_1_INDEX              = 3,
    FLEX_QOS_QOS_REMARK_L2_TUNNEL_ENCAP_D1P_TOS_COPY_INDEX      = 4,
    FLEX_QOS_QOS_REMARK_L2_TUNNEL_ENCAP_D1P_COPY_INDEX          = 5,
    FLEX_QOS_QOS_REMARK_L2_L3_TUNNEL_ENCAP_TOS_COPY_0_INDEX     = 6,
    FLEX_QOS_QOS_REMARK_L2_L3_TUNNEL_ENCAP_0_INDEX              = 7,
    FLEX_QOS_QOS_REMARK_L2_L3_FORWARDING_D1P_TOS_COPY_INDEX     = 8,
    FLEX_QOS_QOS_REMARK_L2_L3_FORWARDING_D1P_COPY_INDEX         = 9,
    FLEX_QOS_QOS_REMARK_L2_L3_FORWARDING_TOS_COPY_INDEX         = 10,
    FLEX_QOS_QOS_REMARK_L2_L3_FORWARDING_INDEX                  = 11,
    FLEX_QOS_EGR_POLICY_ID_CNT                                  = 12
} qos_egr_policy_id_t;
 ...
 */
static int
bcm56780_a0_ina_2_4_13_ltsw_qos_ctrl_info_init(int unit,
...
/*!
 * \brief QoS driver function variable for bcm56780_a0 INA_2_4_13 device.
 */
static mbcm_ltsw_qos_drv_t bcm56780_a0_ina_2_4_13_ltsw_qos_drv = {
    .qos_ctrl_info_init = bcm56780_a0_ina_2_4_13_ltsw_qos_ctrl_info_init
};
...
int
bcm56780_a0_ina_2_4_13_ltsw_qos_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_qos_drv_set(unit, &bcm56780_a0_ina_2_4_13_ltsw_qos_drv));
