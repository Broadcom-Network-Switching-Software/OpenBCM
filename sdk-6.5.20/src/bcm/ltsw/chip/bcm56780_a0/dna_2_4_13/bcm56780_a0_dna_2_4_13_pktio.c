/*! \file bcm56780_a0_dna_2_4_13_pktio.c
 *
 * BCM56780_A0 DNA_2_4_13 PKTIO Driver.
 */
/*
...
static
bcmint_pktio_fid_info_t bcm56780_a0_dna_2_4_13_rxpmd_flex_db[] = {
    {
...
static
bcmint_pktio_fid_info_t bcm56780_a0_dna_2_4_13_generic_loopback_db[] = {
    {
...
static
bcmint_pktio_fid_info_t bcm56780_a0_dna_2_4_13_hg3_db[] = {
    {
...
static
bcmint_pktio_fid_info_t bcm56780_a0_dna_2_4_13_rxpmd_flex_reason_db[] = {
    {
...
static int
bcm56780_a0_dna_2_4_13_ltsw_pktio_fid_support_get(
    int unit,
    ...
    bcm_pktio_bitmap_t *support)
{
    ...
    switch (hdr_info->pmd_type) {
        case bcmPktioPmdTypeRxFlex:
            fid_p = fid_db = bcm56780_a0_dna_2_4_13_rxpmd_flex_db;
            break;

        case bcmPktioPmdTypeGih:
            fid_p = fid_db = bcm56780_a0_dna_2_4_13_generic_loopback_db;
            break;

        case bcmPktioPmdTypeHigig3:
            fid_p = fid_db = bcm56780_a0_dna_2_4_13_hg3_db;
            break;
...
static int
bcm56780_a0_dna_2_4_13_ltsw_pktio_fid_info_get(
    int unit,
    bcmint_pktio_hdr_info_t *hdr_info,
...
static int
bcm56780_a0_dna_2_4_13_ltsw_pktio_fid_info_lookup(
    int unit,
    int opcode,
    bcmint_pktio_hdr_info_t *hdr_info,
    bcmint_pktio_fid_info_t **fid_info)
{
    ...
    switch (hdr_info->pmd_type) {
        case bcmPktioPmdTypeRxFlex:
            fid_p = fid_db = bcm56780_a0_dna_2_4_13_rxpmd_flex_reason_db;
            break;
...
/*!
 * \brief Pktio driver function variable for bcm56780_a0_dna_2_4_13 device.
 */
static mbcm_ltsw_pktio_drv_t bcm56780_a0_dna_2_4_13_ltsw_pktio_drv = {
    .pktio_fid_support_get = bcm56780_a0_dna_2_4_13_ltsw_pktio_fid_support_get,
    .pktio_fid_info_get = bcm56780_a0_dna_2_4_13_ltsw_pktio_fid_info_get,
    .pktio_fid_info_lookup = bcm56780_a0_dna_2_4_13_ltsw_pktio_fid_info_lookup
};
...
int
bcm56780_a0_dna_2_4_13_ltsw_pktio_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_pktio_drv_set(unit, &bcm56780_a0_dna_2_4_13_ltsw_pktio_drv));
