/*! \file bcm56780_a0_dna_2_4_13_sbr.c
 *
 * Management of strength profile table and strength field for strength
 * based-resolution (SBR) in BCM56780_A0 DNA_2_4_13.
 */
/*
...
bcmint_sbr_profile_fld_t destination_fp_strength_profile_flds_0[] = {
    ...
    {
        .name = INGRESS_QOS_REMARK_CTRL_STRENGTHs,
        .val  = 0
    },
    {
        .name = INGRESS_QOS_REMAP_VALUE_STRENGTHs,
        .val  = 0
    }
};
...
/* Fields for EGR_IFA_ATTRIBUTES_STR_PROFILE. */
static const
bcmint_sbr_profile_fld_t egr_ifa_attributes_str_profile_flds_0[] = {
    {
        .name = IFA_ATTR_STRs,
        .val  = 3
    }
...
/* Fields for ECMP_LEVEL1_STRENGTH_PROFILE. */
static const
bcmint_sbr_profile_fld_t ing_ecmp_level_1_strength_profile_flds_0[] = {
    {
        .name = DISABLE_OBJ_0s,
        .val  = 0
    },
    ...
    {
        .name = DISABLE_CTRL_INFO_0s,
        .val  = 0
    },
    {
        .name = DISABLE_CTRL_INFO_1s,
        .val  = 0
    },
    {
        .name = DISABLE_CTRL_INFO_2s,
        .val  = 0
    }
};
...
/* Fields for ECMP_LEVEL1_STRENGTH_PROFILE. */
static const
bcmint_sbr_profile_fld_t ing_ecmp_level_1_strength_profile_flds_1[] = {
    {
        .name = DISABLE_OBJ_0s,
        .val  = 0
    },
...
/* Entry for EGR_IFA_ATTRIBUTES_STR_PROFILE. */
static
bcmint_sbr_profile_ent_t egr_ifa_attributes_str_profile_ent[] = {
    {
        .index    = 0,
        .ent_type = BCMI_LTSW_SBR_PET_DEF,
        .key_name = EGR_IFA_ATTRIBUTES_STR_PROFILE_INDEXs,
        .fld_info = egr_ifa_attributes_str_profile_flds_0,
        .fld_num  = 1,
        .dummy    = 0
    }
};
...
/* Entry for ECMP_LEVEL1_STRENGTH_PROFILE. */
static
bcmint_sbr_profile_ent_t ing_ecmp_level_1_strength_profile_ent[] = {
    {
        .index    = 1,
        .ent_type = BCMI_LTSW_SBR_PET_DEF,
        .key_name = ECMP_LEVEL1_STRENGTH_PROFILE_INDEXs,
        .fld_info = ing_ecmp_level_1_strength_profile_flds_0,
        .fld_num  = 6,
        .dummy    = 0,
        .flags    = BCMINT_SBR_CTRL_FIXED_ENT_IDX
    },
    {
        .index    = 2,
        .ent_type = BCMI_LTSW_SBR_PET_NONE,
        .key_name = ECMP_LEVEL1_STRENGTH_PROFILE_INDEXs,
        .fld_info = ing_ecmp_level_1_strength_profile_flds_1,
        .fld_num  = 6,
        .dummy    = 0,
        .flags    = BCMINT_SBR_CTRL_FIXED_ENT_IDX
    }
...
bcmint_sbr_profile_tbl_t sbr_profile_tbl_db[BCMI_LTSW_SBR_PTH_COUNT] = {
    ...
    [BCMI_LTSW_SBR_PTH_EGR_IFA_ATTRIBUTES] = {
        .shr_hdl   = BCMI_LTSW_SBR_PTH_EGR_IFA_ATTRIBUTES,
        .name      = EGR_IFA_ATTRIBUTES_STR_PROFILEs,
        .ent_info  = egr_ifa_attributes_str_profile_ent,
        .ent_num   = 1
    },
    ...
    [BCMI_LTSW_SBR_PTH_ING_ECMP_MEMBER_1] = {
        ...
        .name      = ECMP_LEVEL1_STRENGTH_PROFILEs,
        .ent_info  = ing_ecmp_level_1_strength_profile_ent,
        .ent_num   = 2
    },
 ...
 */
static int
bcm56780_a0_dna_2_4_13_ltsw_sbr_db_get(int unit, bcmint_sbr_db_t *sbr_db)
{
    SHR_FUNC_ENTER(unit);
    ...
    SHR_BITSET
        (sbr_db->profile_tbl_bmp, BCMI_LTSW_SBR_PTH_EGR_IFA_ATTRIBUTES);
    SHR_BITSET
...
/*!
 * \brief SBR driver function variable for bcm56780_a0 DNA_2_4_13 device.
 */
static mbcm_ltsw_sbr_drv_t bcm56780_a0_dna_2_4_13_ltsw_sbr_drv = {
    .sbr_db_get = bcm56780_a0_dna_2_4_13_ltsw_sbr_db_get
};
...
int
bcm56780_a0_dna_2_4_13_ltsw_sbr_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_sbr_drv_set(unit, &bcm56780_a0_dna_2_4_13_ltsw_sbr_drv));
