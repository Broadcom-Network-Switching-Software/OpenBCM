/*! \file virtual.c
 *
 * BCM56780_A0 virtual management Driver.
 */
/*
...
/*!
 * \brief Virtual driver function variable for bcm56780_a0 device.
 */
static mbcm_ltsw_virtual_drv_t bcm56780_a0_ltsw_virtual_drv = {
...
int
bcm56780_a0_ltsw_virtual_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_EXIT
        (mbcm_ltsw_virtual_drv_set(unit, &bcm56780_a0_ltsw_virtual_drv));
