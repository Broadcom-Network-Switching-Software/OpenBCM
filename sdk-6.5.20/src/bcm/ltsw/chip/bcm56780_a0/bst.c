...
static int
bcm56780_a0_ltsw_cosq_bst_profile_get(
    int unit,
    bcm_gport_t gport,
...
static int
bcm56780_a0_ltsw_cosq_bst_profile_set(
    int unit,
    bcm_gport_t gport,
    bcm_cos_queue_t cosq,
    bcm_bst_stat_id_t bid,
...
static int
bcm56780_a0_ltsw_cosq_bst_stat_get(
    int unit,
    bcm_gport_t gport,
    bcm_cos_queue_t cosq,
...
static int
bcm56780_a0_ltsw_cosq_bst_stat_clear(
    int unit,
    bcm_gport_t gport,
    bcm_cos_queue_t cosq,
    bcm_cosq_buffer_id_t buffer,
...
static int
bcm56780_a0_ltsw_cosq_bst_stat_sync(
    int unit,
    bcm_bst_stat_id_t bid)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56780_a0_ltsw_cosq_bst_init(int unit)
{
    static tm_ltsw_bst_chip_driver_t bcm56780_a0_bst_drv_cb = {
    ...
    SHR_IF_ERR_VERBOSE_EXIT
        (tm_ltsw_bst_chip_driver_register(unit, &bcm56780_a0_bst_drv_cb));
...
static int
bcm56780_a0_ltsw_cosq_bst_detach(int unit)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56780_a0_ltsw_cosq_bst_enable_set(
    int unit,
    int arg)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56780_a0_ltsw_cosq_bst_enable_get(
    int unit,
    int *arg)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56780_a0_ltsw_cosq_bst_tracking_mode_set(
    int unit,
    int arg)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56780_a0_ltsw_cosq_bst_tracking_mode_get(
    int unit,
    int *arg)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56780_a0_ltsw_cosq_bst_snapshot_enable_set(
    int unit,
    int arg)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56780_a0_ltsw_cosq_bst_snapshot_enable_get(
    int unit,
    int *arg)
{
    SHR_FUNC_ENTER(unit);
...
/*!
 * \brief Cosq_bst driver function variable for bcm56780_a0 device.
 */
static mbcm_ltsw_cosq_bst_drv_t bcm56780_a0_ltsw_cosq_bst_drv = {
    .cosq_bst_profile_get = bcm56780_a0_ltsw_cosq_bst_profile_get,
    .cosq_bst_profile_set = bcm56780_a0_ltsw_cosq_bst_profile_set,
    .cosq_bst_stat_get = bcm56780_a0_ltsw_cosq_bst_stat_get,
    .cosq_bst_stat_clear = bcm56780_a0_ltsw_cosq_bst_stat_clear,
    .cosq_bst_stat_sync = bcm56780_a0_ltsw_cosq_bst_stat_sync,
    .cosq_bst_init = bcm56780_a0_ltsw_cosq_bst_init,
    .cosq_bst_detach = bcm56780_a0_ltsw_cosq_bst_detach,
    .cosq_bst_enable_set = bcm56780_a0_ltsw_cosq_bst_enable_set,
    .cosq_bst_enable_get = bcm56780_a0_ltsw_cosq_bst_enable_get,
    .cosq_bst_tracking_mode_set = bcm56780_a0_ltsw_cosq_bst_tracking_mode_set,
    .cosq_bst_tracking_mode_get = bcm56780_a0_ltsw_cosq_bst_tracking_mode_get,
    .cosq_bst_snapshot_enable_set = bcm56780_a0_ltsw_cosq_bst_snapshot_enable_set,
    .cosq_bst_snapshot_enable_get = bcm56780_a0_ltsw_cosq_bst_snapshot_enable_get
};
...
int
bcm56780_a0_ltsw_cosq_bst_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_cosq_bst_drv_set(unit, &bcm56780_a0_ltsw_cosq_bst_drv));
