...
static int
bcm56780_a0_ltsw_l3_egress_init(int unit)
{
    int profile_id;
...
static int
bcm56780_a0_l3_secmp_clear(int unit)
{
    int i, num;
    const char *ltname[] = {
        ECMP_SRC_L3_GROUP_0s,
        ECMP_SRC_L3_GROUP_1s
    };
...
/*!
 * \brief Fill entry handle of ECMP_SRC_L3_GROUP_0/1t.
 *
 * \param [in] unit Unit number
 * \param [in] eh LT entry handle.
 * \param [in] cfg Data of ECMP_SRC_L3_GROUP_0/1t.
 *
...
lt_ecmp_src_fill(int unit, bcmlt_entry_handle_t eh, ecmp_src_cfg_t *cfg)
{
    ...
    static const char *l3_oif_str[] = {OBJ_0s,
                                       OBJ_1s,
                                       OBJ_2s,
                                       OBJ_3s,
                                       OBJ_0s,
    ...
    if (cfg->start_idx >= 0 && cfg->start_idx < ECMP_SRC_GROUP_TABLE_MAX_MEMBER) {
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(eh, ECMP_SRC_L3_GROUP_0_IDs,
                                   cfg->l3_src_ecmp_group_index));
    } else if (cfg->start_idx >= ECMP_SRC_GROUP_TABLE_MAX_MEMBER &&
               cfg->start_idx < ECMP_SRC_GROUP_MAX_MEMBER){
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(eh, ECMP_SRC_L3_GROUP_1_IDs,
                                   cfg->l3_src_ecmp_group_index));
    } else {
        SHR_IF_ERR_EXIT(SHR_E_PARAM);
    }
    ...
    if (cfg->fld_bmp & ES_FLD_COUNT) {
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(eh, CMD_0s,
                                   (cfg->count > 0) ? (cfg->count - 1) : 0));
    }

    if (cfg->fld_bmp & ES_FLD_COUNT_GT8) {
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_add(eh, CMD_1s, cfg->count_gt8));
    }
...
/*!
 * \brief Parse entry handle of ECMP_SRC_L3_GROUP_0/1t.
 *
 * \param [in] unit Unit number
 * \param [in] eh LT entry handle.
 * \param [out] cfg Data of ECMP_SRC_L3_GROUP_0/1t.
 *
 * \retval SHR_E_NONE No errors.
 * \retval !SHR_E_NONE Failure.
 */
...
lt_ecmp_src_parse(int unit, bcmlt_entry_handle_t eh, ecmp_src_cfg_t *cfg)
{
    ...
    if (cfg->start_idx >= 0 && cfg->start_idx < ECMP_SRC_GROUP_TABLE_MAX_MEMBER) {
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_get(eh, ECMP_SRC_L3_GROUP_0_IDs,
                                   &cfg->l3_src_ecmp_group_index));
    } else if (cfg->start_idx >= ECMP_SRC_GROUP_TABLE_MAX_MEMBER &&
               cfg->start_idx < ECMP_SRC_GROUP_MAX_MEMBER) {
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_get(eh, ECMP_SRC_L3_GROUP_1_IDs,
                                   &cfg->l3_src_ecmp_group_index));
    } else {
        SHR_IF_ERR_EXIT(SHR_E_PARAM);
    }
    ...
    if (cfg->fld_bmp & ES_FLD_COUNT) {
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_get(eh, CMD_0s, &cfg->count));
    ...
    if (cfg->fld_bmp & ES_FLD_COUNT_GT8) {
        SHR_IF_ERR_EXIT
            (bcmlt_entry_field_get(eh, CMD_1s, &cfg->count_gt8));
    }
 ...
 */
static int
bcm56780_a0_l3_secmp_set(
    int unit,
    int idx,
    bcm_l3_egress_ecmp_t *ecmp_info,
    bcmi_ltsw_l3_ecmp_member_info_t *member, int count)
{
    int i = 0;
    ...
    SHR_IF_ERR_EXIT
        (bcmlt_entry_allocate(dunit, ECMP_SRC_L3_GROUP_1s, &eh));
 ...
 */
static int
bcm56780_a0_l3_secmp_del(int unit, int idx)
{
    int dunit;
    bcmlt_entry_handle_t eh = BCMLT_INVALID_HDL;
    ...
    SHR_IF_ERR_EXIT
        (bcmlt_entry_allocate(dunit, ECMP_SRC_L3_GROUP_0s, &eh));

    SHR_IF_ERR_EXIT
        (bcmlt_entry_field_add(eh, ECMP_SRC_L3_GROUP_0_IDs, idx));
    ...
    SHR_IF_ERR_EXIT
        (bcmlt_entry_field_add(eh, ECMP_SRC_L3_GROUP_1_IDs, idx));
 ...
 */
static int
bcm56780_a0_l3_secmp_member_add(
    int unit,
    int idx,
 ...
 */
static int
bcm56780_a0_l3_secmp_member_del(
    int unit,
    int idx,
    bcmi_ltsw_l3_ecmp_member_info_t *member,
    int count,
 ...
 */
static int
bcm56780_a0_l3_secmp_member_del_all(int unit, int idx)
{
    int dunit;
    ecmp_src_cfg_t secmp;
    bcmlt_entry_handle_t eh = BCMLT_INVALID_HDL;
...
static mbcm_ltsw_l3_egress_drv_t bcm56780_a0_ltsw_l3_egr_drv = {
    .l3_egress_l2_rsv = xfs_ltsw_l3_egress_l2_rsv,
    .l3_egress_init = bcm56780_a0_ltsw_l3_egress_init,
    ...
    .l3_secmp_clear = bcm56780_a0_l3_secmp_clear,
    .l3_secmp_set = bcm56780_a0_l3_secmp_set,
    .l3_secmp_del = bcm56780_a0_l3_secmp_del,
    .l3_secmp_member_add = bcm56780_a0_l3_secmp_member_add,
    .l3_secmp_member_del = bcm56780_a0_l3_secmp_member_del,
    .l3_secmp_member_del_all = bcm56780_a0_l3_secmp_member_del_all,
};
...
int
bcm56780_a0_ltsw_l3_egress_drv_attach(int unit)
{
    return mbcm_ltsw_l3_egress_drv_set(unit, &bcm56780_a0_ltsw_l3_egr_drv);
}
