...
static int
bcm56780_a0_ltsw_mirror_ctrl_info_init(
    int unit,
    bcmint_mirror_ctrl_info_t *mirror_ctrl)
{
    ...
    * Mirror container:
    * 0--egress port, sampler, ingress vp, ingress port, EP Recirculate
...
static int
bcm56780_a0_ltsw_mirror_init(int unit)
{
    SHR_FUNC_ENTER(unit);
    ...
    /* Variant database init. */
    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_mirror_db_init(unit));
...
static int
bcm56780_a0_ltsw_mirror_deinit(int unit)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56780_a0_ltsw_mirror_encap_add(
    int unit,
    bool egr,
...
static int
bcm56780_a0_ltsw_mirror_encap_delete(
    int unit,
    bcm_mirror_destination_t *mirror_dest,
    int index)
{
...
static int
bcm56780_a0_ltsw_mirror_encap_get(
    int unit,
    int index,
    bcm_mirror_destination_t *mirror_dest)
{
...
static int
bcm56780_a0_ltsw_mirror_session_add(
    int unit,
    int session_id,
...
static int
bcm56780_a0_ltsw_mirror_session_delete(
    int unit,
    int session_id,
    bool egr,
    bool cosq_mod)
...
static int
bcm56780_a0_ltsw_mirror_session_get(
    int unit,
    int session_id,
    bcmint_mirror_session_entry_t *session)
{
...
static int
bcm56780_a0_ltsw_mirror_session_stat_get(
    int unit,
    int session_id,
    bool sync,
    uint64_t *value)
...
static int
bcm56780_a0_ltsw_mirror_session_stat_set(
    int unit,
    int session_id,
    uint64_t value)
{
...
static int
bcm56780_a0_ltsw_mirror_enable_get(
    int unit,
...
static int
bcm56780_a0_ltsw_mirror_enable_set(
    int unit,
    bcmint_mirror_source_t *source,
    int mc_bmp,
    int enable,
...
static int
bcm56780_a0_ltsw_mirror_misc_init(int unit)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56780_a0_ltsw_mirror_misc_deinit(int unit)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56780_a0_ltsw_mirror_sample_profile_init(int unit)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56780_a0_ltsw_mirror_sample_profile_deinit(int unit)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56780_a0_ltsw_mirror_egress_sampler_rate_range_max(
    int unit,
    int *range_max)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56780_a0_ltsw_mirror_sampler_seed_set(
    int unit,
...
static int
bcm56780_a0_ltsw_mirror_sampler_seed_get(
    int unit,
    bcmi_ltsw_mirror_sampler_seed_type_t type,
    int *value)
{
...
static int
bcm56780_a0_ltsw_mirror_mc_cos_set(
    int unit,
    int mc_cos)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56780_a0_ltsw_mirror_mc_cos_get(
    int unit,
    int *mc_cos)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56780_a0_ltsw_mirror_cpu_cos_set(
    int unit,
    int cpu_cos)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56780_a0_ltsw_mirror_cpu_cos_get(
    int unit,
    int *cpu_cos)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56780_a0_ltsw_mirror_destination_validate(
    int unit,
    bcm_mirror_destination_t *mirror_dest)
{
...
static int
bcm56780_a0_ltsw_mirror_sample_profile_set(
    int unit,
...
static int
bcm56780_a0_ltsw_mirror_sample_profile_get(
    int unit,
    bcmint_mirror_sample_type_t type,
    int profile_id,
    bcm_mirror_sample_profile_t *profile)
...
static int
bcm56780_a0_ltsw_mirror_sample_stat_attach(
    int unit,
    bcmint_mirror_sample_type_t type,
...
static int
bcm56780_a0_ltsw_mirror_sample_stat_detach(
    int unit,
    bcmint_mirror_sample_type_t type,
    uint32_t stat_counter_id)
{
...
static int
bcm56780_a0_ltsw_mirror_truncate_length_profile_create(
    int unit,
    uint32_t options,
    int *profile_id,
...
static int
bcm56780_a0_ltsw_mirror_truncate_length_profile_destroy(
    int unit,
    int profile_id)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56780_a0_ltsw_mirror_truncate_length_profile_get(
    int unit,
    int profile_id,
    bcm_mirror_truncate_length_profile_t *profile)
{
...
static int
bcm56780_a0_ltsw_mirror_switch_control_set(
    int unit,
    ...
    int arg)
{
    ...
    SHR_IF_ERR_EXIT
        (xfs_ltsw_mirror_switch_control_set(unit, type, arg));
...
static int
bcm56780_a0_ltsw_mirror_switch_control_get(
    int unit,
    bcm_switch_control_t type,
    int *arg)
{
    ...
    SHR_IF_ERR_EXIT
        (xfs_ltsw_mirror_switch_control_get(unit, type, arg));
...
/*!
 * \brief Mirror driver function variable for bcm56780_a0 device.
 */
static mbcm_ltsw_mirror_drv_t bcm56780_a0_ltsw_mirror_drv = {
    .mirror_ctrl_info_init = bcm56780_a0_ltsw_mirror_ctrl_info_init,
    .mirror_init = bcm56780_a0_ltsw_mirror_init,
    .mirror_deinit = bcm56780_a0_ltsw_mirror_deinit,
    .mirror_encap_add = bcm56780_a0_ltsw_mirror_encap_add,
    .mirror_encap_delete = bcm56780_a0_ltsw_mirror_encap_delete,
    .mirror_encap_get = bcm56780_a0_ltsw_mirror_encap_get,
    .mirror_session_add = bcm56780_a0_ltsw_mirror_session_add,
    .mirror_session_delete = bcm56780_a0_ltsw_mirror_session_delete,
    .mirror_session_get = bcm56780_a0_ltsw_mirror_session_get,
    .mirror_session_stat_get = bcm56780_a0_ltsw_mirror_session_stat_get,
    .mirror_session_stat_set = bcm56780_a0_ltsw_mirror_session_stat_set,
    .mirror_enable_get = bcm56780_a0_ltsw_mirror_enable_get,
    .mirror_enable_set = bcm56780_a0_ltsw_mirror_enable_set,
    .mirror_misc_init = bcm56780_a0_ltsw_mirror_misc_init,
    .mirror_misc_deinit = bcm56780_a0_ltsw_mirror_misc_deinit,
    .mirror_sample_profile_init = bcm56780_a0_ltsw_mirror_sample_profile_init,
    .mirror_sample_profile_deinit = bcm56780_a0_ltsw_mirror_sample_profile_deinit,
    .mirror_egress_sampler_rate_range_max = bcm56780_a0_ltsw_mirror_egress_sampler_rate_range_max,
    .mirror_sampler_seed_set = bcm56780_a0_ltsw_mirror_sampler_seed_set,
    .mirror_sampler_seed_get = bcm56780_a0_ltsw_mirror_sampler_seed_get,
    .mirror_mc_cos_set = bcm56780_a0_ltsw_mirror_mc_cos_set,
    .mirror_mc_cos_get = bcm56780_a0_ltsw_mirror_mc_cos_get,
    .mirror_cpu_cos_set = bcm56780_a0_ltsw_mirror_cpu_cos_set,
    .mirror_cpu_cos_get = bcm56780_a0_ltsw_mirror_cpu_cos_get,
    .mirror_destination_validate = bcm56780_a0_ltsw_mirror_destination_validate,
    .mirror_sample_profile_set = bcm56780_a0_ltsw_mirror_sample_profile_set,
    .mirror_sample_profile_get = bcm56780_a0_ltsw_mirror_sample_profile_get,
    .mirror_sample_stat_attach = bcm56780_a0_ltsw_mirror_sample_stat_attach,
    .mirror_sample_stat_detach = bcm56780_a0_ltsw_mirror_sample_stat_detach,
    .mirror_truncate_length_profile_create = bcm56780_a0_ltsw_mirror_truncate_length_profile_create,
    .mirror_truncate_length_profile_destroy = bcm56780_a0_ltsw_mirror_truncate_length_profile_destroy,
    .mirror_truncate_length_profile_get = bcm56780_a0_ltsw_mirror_truncate_length_profile_get,
    .mirror_switch_control_set = bcm56780_a0_ltsw_mirror_switch_control_set,
    .mirror_switch_control_get = bcm56780_a0_ltsw_mirror_switch_control_get
};
...
int
bcm56780_a0_ltsw_mirror_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_mirror_drv_set(unit, &bcm56780_a0_ltsw_mirror_drv));

    SHR_IF_ERR_VERBOSE_EXIT
        (bcm56780_a0_ltsw_variant_drv_attach(unit, BCM56780_A0_LTSW_VARIANT_MIRROR));
