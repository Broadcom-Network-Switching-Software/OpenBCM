/*! \file bcm56996_a0_feature.c
 *
 * BCM56996_A0 feature driver.
 */
/*
...
static int
bcm56996_a0_ltsw_feature_init(int unit)
{
    SHR_FUNC_ENTER(unit);
...
/*!
 * \brief Feature driver function variable for bcm56996_a0 device.
 */
static mbcm_ltsw_feature_drv_t bcm56996_a0_ltsw_feature_drv = {
    .feature_init = bcm56996_a0_ltsw_feature_init
};
...
int
bcm56996_a0_ltsw_feature_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_feature_drv_set(unit, &bcm56996_a0_ltsw_feature_drv));
