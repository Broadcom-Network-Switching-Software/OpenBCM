/*! \file bcm56996_a0_field.c
 *
 * BCM56996_A0 field subordinate driver.
 */
/*
...
#include <bcm_int/ltsw/chip/bcm56990_a0/bcm56996_a0/bcm56996_a0_field_lt_map.h>
...
static
bcmint_field_compress_tbls_info_t bcm56996_a0_compress_tbls_info = {
...
bcmint_field_tbls_info_t bcm56996_a0_ifp_tbls_info = {
...
bcmint_field_tbls_info_t bcm56996_a0_efp_tbls_info = {
...
bcmint_field_tbls_info_t bcm56996_a0_vfp_tbls_info = {
...
bcmint_field_tbls_info_t bcm56996_a0_em_tbls_info = {
...
bcm_field_qual_map_t bcm56996_a0_udf_qual_data[] = {
    {
...
static int
bcm56996_a0_ltsw_efp_group_mode_port_pkt_type_init(
        int unit,
...
static int
bcm56996_a0_ltsw_field_stage_info_init(int unit,
                                       bcmint_field_stage_info_t *stage_info)
{
    SHR_FUNC_ENTER(unit);
    ...
    if (stage_info->stage_id == bcmiFieldStageIngress) {
        ...
        stage_info->tbls_info = &bcm56996_a0_ifp_tbls_info;

        /* Initialise qual db counts */
        stage_info->qual_db_count = (sizeof(bcm56990_a0_bcm56996_a0_ifp_qual_data)) /
                                            (sizeof(bcm_field_qual_map_t));
        stage_info->group_qual_db_count = (sizeof(bcm56990_a0_bcm56996_a0_ifp_group_qual_data)) /
                                            (sizeof(bcm_field_qual_map_t));
        stage_info->udf_qual_db_count = (sizeof(bcm56996_a0_udf_qual_data)) /
                                            (sizeof(bcm_field_qual_map_t));
        stage_info->presel_qual_db_count =
                                   (sizeof(bcm56990_a0_bcm56996_a0_ifp_presel_qual_data)) /
                                   (sizeof(bcm_field_qual_map_t));
        stage_info->action_db_count = (sizeof(bcm56990_a0_bcm56996_a0_ifp_action_data)) /
                                            (sizeof(bcm_field_action_map_t));

        /* Initialise lt map db */
        stage_info->qual_lt_map_db = bcm56990_a0_bcm56996_a0_ifp_qual_data;

        stage_info->group_qual_lt_map_db = bcm56990_a0_bcm56996_a0_ifp_group_qual_data;

        stage_info->presel_qual_lt_map_db = bcm56990_a0_bcm56996_a0_ifp_presel_qual_data;

        stage_info->udf_qual_lt_map_db = bcm56996_a0_udf_qual_data;

        stage_info->action_lt_map_db = bcm56990_a0_bcm56996_a0_ifp_action_data;
        ...
        /* Initialise lt table info */
        stage_info->tbls_info = &bcm56996_a0_efp_tbls_info;

        /* Initialise qual db counts */
        stage_info->qual_db_count = (sizeof(bcm56990_a0_bcm56996_a0_efp_qual_data)) /
                                            (sizeof(bcm_field_qual_map_t));
        stage_info->group_qual_db_count = (sizeof(bcm56990_a0_bcm56996_a0_efp_group_qual_data)) /
                                            (sizeof(bcm_field_qual_map_t));
        stage_info->presel_qual_db_count =
                                   (sizeof(bcm56990_a0_bcm56996_a0_efp_presel_qual_data)) /
                                                 (sizeof(bcm_field_qual_map_t));
        stage_info->action_db_count = (sizeof(bcm56990_a0_bcm56996_a0_efp_action_data)) /
                                            (sizeof(bcm_field_action_map_t));

        /* Initialise lt map db */
        stage_info->qual_lt_map_db = bcm56990_a0_bcm56996_a0_efp_qual_data;

        stage_info->group_qual_lt_map_db = bcm56990_a0_bcm56996_a0_efp_group_qual_data;

        stage_info->presel_qual_lt_map_db = bcm56990_a0_bcm56996_a0_efp_presel_qual_data;

        stage_info->action_lt_map_db = bcm56990_a0_bcm56996_a0_efp_action_data;

        SHR_IF_ERR_EXIT
            (bcm56996_a0_ltsw_efp_group_mode_port_pkt_type_init(unit, stage_info));
        ...
        /* Initialise lt table info */
        stage_info->tbls_info = &bcm56996_a0_vfp_tbls_info;

        /* Initialise qual db counts */
        stage_info->qual_db_count = (sizeof(bcm56990_a0_bcm56996_a0_vfp_qual_data)) /
                                            (sizeof(bcm_field_qual_map_t));
        stage_info->group_qual_db_count = (sizeof(bcm56990_a0_bcm56996_a0_vfp_group_qual_data)) /
                                            (sizeof(bcm_field_qual_map_t));
        stage_info->udf_qual_db_count = (sizeof(bcm56996_a0_udf_qual_data)) /
                                            (sizeof(bcm_field_qual_map_t));
        stage_info->presel_qual_db_count =
                                    (sizeof(bcm56990_a0_bcm56996_a0_vfp_presel_qual_data)) /
                                            (sizeof(bcm_field_qual_map_t));
        stage_info->action_db_count = (sizeof(bcm56990_a0_bcm56996_a0_vfp_action_data)) /
                                               (sizeof(bcm_field_action_map_t));

        /* Initialise lt map db */
        stage_info->qual_lt_map_db = bcm56990_a0_bcm56996_a0_vfp_qual_data;

        stage_info->group_qual_lt_map_db = bcm56990_a0_bcm56996_a0_vfp_group_qual_data;

        stage_info->presel_qual_lt_map_db = bcm56990_a0_bcm56996_a0_vfp_presel_qual_data;

        stage_info->udf_qual_lt_map_db = bcm56996_a0_udf_qual_data;

        stage_info->action_lt_map_db = bcm56990_a0_bcm56996_a0_vfp_action_data;
        ...
        /* Initialise lt table info */
        stage_info->tbls_info = &bcm56996_a0_em_tbls_info;
...
static int
bcm56996_a0_ltsw_field_control_lt_info_init(
        int unit,
        bcmint_field_control_info_t *control_info)
{
    ...
    control_info->comp_tbls_info = &bcm56996_a0_compress_tbls_info;
...
/*!
 * \brief Field sub driver functions for bcm56996_a0.
 */
static mbcm_ltsw_field_drv_t bcm56996_a0_field_sub_drv = {
    .field_stage_info_init = bcm56996_a0_ltsw_field_stage_info_init,
    .field_control_lt_info_init = bcm56996_a0_ltsw_field_control_lt_info_init,
    .field_auto_enum_to_lt_enum_value_get =
        bcm56990_a0_bcm56996_a0_ltsw_field_auto_enum_to_lt_enum_value_get,
    .field_auto_lt_enum_value_to_enum_get =
        bcm56990_a0_bcm56996_a0_ltsw_field_auto_lt_enum_value_to_enum_get,
};
...
int
bcm56996_a0_field_sub_drv_attach(int unit, void *hdl)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_field_drv_set(unit, &bcm56996_a0_field_sub_drv));
