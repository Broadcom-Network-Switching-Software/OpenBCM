/*! \file bcm5699x_l3_aacl.c
 *
 * BCM5699x L3 AACL subordinate driver.
 */
/*
...
int
bcm5699x_a0_ltsw_l3_aacl_tbl_db_get(
    int unit,
...
/*!
 * \brief L3_aacl sub driver functions for bcm5699x_a0.
 */
static mbcm_ltsw_l3_aacl_drv_t bcm5699x_a0_l3_aacl_sub_drv = {
    .l3_aacl_tbl_db_get = bcm5699x_a0_ltsw_l3_aacl_tbl_db_get,
};
...
int
bcm5699x_l3_aacl_sub_drv_attach(int unit, void *hdl)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_l3_aacl_drv_set(unit, &bcm5699x_a0_l3_aacl_sub_drv));
