/*! \file bcm56990_a0_mirror.c
 *
 * BCM56990_A0 mirror subordinate driver.
 */
/*
 ...
 */
static bcmint_mirror_ingress_mod_event_map_info_t bcm56990_a0_ltsw_mirror_ingress_mod_event_map_tab[] = {
 ...
 */
static int
bcm56990_a0_ltsw_mirror_ctrl_info_init(
    int unit,
    bcmint_mirror_ctrl_info_t *mirror_ctrl)
{
    ...
    */
    ...
    mirror_ctrl->ingress_mod_event_map_tab =
        bcm56990_a0_ltsw_mirror_ingress_mod_event_map_tab;
    mirror_ctrl->ingress_mod_event_map_tab_size =
        COUNTOF(bcm56990_a0_ltsw_mirror_ingress_mod_event_map_tab);

    return SHR_E_NONE;
}

/*!
 * \brief Mirror sub driver functions for bcm56990_a0.
 */
static mbcm_ltsw_mirror_drv_t bcm56990_a0_mirror_sub_drv = {
    .mirror_ctrl_info_init = bcm56990_a0_ltsw_mirror_ctrl_info_init,
};
...
int
bcm56990_a0_mirror_sub_drv_attach(int unit, void *hdl)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_mirror_drv_set(unit, &bcm56990_a0_mirror_sub_drv));
