...
static int
bcm56990_a0_ltsw_tunnel_sc_info_get(
    int unit,
...
/*!
 * \brief Tunnel sub driver functions for bcm56990_a0.
 */
static mbcm_ltsw_tunnel_drv_t bcm56990_a0_tunnel_sub_drv = {
    .tunnel_sc_info_get = bcm56990_a0_ltsw_tunnel_sc_info_get,
};
...
int
bcm56990_a0_tunnel_sub_drv_attach(int unit, void *hdl)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_tunnel_drv_set(unit, &bcm56990_a0_tunnel_sub_drv));
