...
static int
bcm56990_a0_ltsw_cosq_ebst_threshold_profile_get(
    int unit,
...
static int
bcm56990_a0_ltsw_cosq_ebst_threshold_profile_set(
    int unit,
    bcm_cosq_object_id_t *object_id,
    bcm_bst_stat_id_t bid,
    bcm_cosq_ebst_threshold_profile_t *profile)
...
static int
bcm56990_a0_ltsw_cosq_ebst_control_get(
    int unit,
...
static int
bcm56990_a0_ltsw_cosq_ebst_control_set(
    int unit,
    bcm_cosq_ebst_control_t type,
    int arg)
{
...
static int
bcm56990_a0_ltsw_cosq_ebst_monitor_get(
    int unit,
    bcm_cosq_object_id_t *object_id,
    bcm_bst_stat_id_t bid,
...
static int
bcm56990_a0_ltsw_cosq_ebst_monitor_set(
    int unit,
    bcm_cosq_object_id_t *object_id,
    bcm_bst_stat_id_t bid,
    bcm_cosq_ebst_monitor_t *monitor)
...
static int
bcm56990_a0_ltsw_cosq_ebst_data_stat_info_get(
    int unit,
    bcm_cosq_object_id_t *object_id,
...
static int
bcm56990_a0_ltsw_cosq_ebst_data_get(
    int unit,
    bcm_cosq_object_id_t *object_id,
    bcm_bst_stat_id_t bid,
    int array_size,
...
static int
bcm56990_a0_ltsw_cosq_ebst_enable_set(
    int unit,
    int enable)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56990_a0_ltsw_cosq_ebst_enable_get(
    int unit,
    int *enable)
{
    SHR_FUNC_ENTER(unit);
...
static int
bcm56990_a0_ltsw_cosq_ebst_init(int unit)
{
    static tm_ltsw_ebst_chip_driver_t bcm56990_a0_ebst_drv_cb = {
    ...
    SHR_IF_ERR_EXIT
        (tm_ltsw_ebst_chip_driver_register(unit, &bcm56990_a0_ebst_drv_cb));
...
static int
bcm56990_a0_ltsw_cosq_ebst_detach(int unit)
{
    SHR_FUNC_ENTER(unit);
...
/*!
 * \brief Cosq_ebst driver function variable for bcm56990_a0 device.
 */
static mbcm_ltsw_cosq_ebst_drv_t bcm56990_a0_ltsw_cosq_ebst_drv = {
    .cosq_ebst_threshold_profile_get = bcm56990_a0_ltsw_cosq_ebst_threshold_profile_get,
    .cosq_ebst_threshold_profile_set = bcm56990_a0_ltsw_cosq_ebst_threshold_profile_set,
    .cosq_ebst_control_get = bcm56990_a0_ltsw_cosq_ebst_control_get,
    .cosq_ebst_control_set = bcm56990_a0_ltsw_cosq_ebst_control_set,
    .cosq_ebst_monitor_get = bcm56990_a0_ltsw_cosq_ebst_monitor_get,
    .cosq_ebst_monitor_set = bcm56990_a0_ltsw_cosq_ebst_monitor_set,
    .cosq_ebst_data_stat_info_get = bcm56990_a0_ltsw_cosq_ebst_data_stat_info_get,
    .cosq_ebst_data_get = bcm56990_a0_ltsw_cosq_ebst_data_get,
    .cosq_ebst_enable_set = bcm56990_a0_ltsw_cosq_ebst_enable_set,
    .cosq_ebst_enable_get = bcm56990_a0_ltsw_cosq_ebst_enable_get,
    .cosq_ebst_init = bcm56990_a0_ltsw_cosq_ebst_init,
    .cosq_ebst_detach = bcm56990_a0_ltsw_cosq_ebst_detach
};
...
int
bcm56990_a0_ltsw_cosq_ebst_drv_attach(int unit)
{
    SHR_FUNC_ENTER(unit);

    SHR_IF_ERR_VERBOSE_EXIT
        (mbcm_ltsw_cosq_ebst_drv_set(unit, &bcm56990_a0_ltsw_cosq_ebst_drv));
...
int _vn##_ltsw_cosq_ebst_drv_attach(int unit) \
{ \
    SHR_FUNC_ENTER(unit); \
    SHR_IF_ERR_VERBOSE_EXIT \
        (mbcm_ltsw_cosq_ebst_drv_set(unit, &bcm56990_a0_ltsw_cosq_ebst_drv)); \
