 ...
 *
 * This file provides TXPMD access functions for BCM56980_A0.
 */
...
static void bcmpkt_txpmd_start_set(uint32_t *data, uint32_t val)
{
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Set field BCMPKT_TXPMD_START with value %u on device BCM56980_A0.\n"), val));
...
static uint32_t bcmpkt_txpmd_start_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Get field BCMPKT_TXPMD_START value %u from device BCM56980_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Set field BCMPKT_TXPMD_HEADER_TYPE with value %u on device BCM56980_A0.\n"), val));
...
static uint32_t bcmpkt_txpmd_header_type_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Get field BCMPKT_TXPMD_HEADER_TYPE value %u from device BCM56980_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Set field BCMPKT_TXPMD_PKT_LENGTH with value %u on device BCM56980_A0.\n"), val));
...
static uint32_t bcmpkt_txpmd_pkt_length_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Get field BCMPKT_TXPMD_PKT_LENGTH value %u from device BCM56980_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Set field BCMPKT_TXPMD_IPCF_PTR with value %u on device BCM56980_A0.\n"), val));
...
static uint32_t bcmpkt_txpmd_ipcf_ptr_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Get field BCMPKT_TXPMD_IPCF_PTR value %u from device BCM56980_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Set field BCMPKT_TXPMD_SOP with value %u on device BCM56980_A0.\n"), val));
...
static uint32_t bcmpkt_txpmd_sop_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Get field BCMPKT_TXPMD_SOP value %u from device BCM56980_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Set field BCMPKT_TXPMD_EOP with value %u on device BCM56980_A0.\n"), val));
...
static uint32_t bcmpkt_txpmd_eop_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Get field BCMPKT_TXPMD_EOP value %u from device BCM56980_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Set field BCMPKT_TXPMD_CELL_LENGTH with value %u on device BCM56980_A0.\n"), val));
...
static uint32_t bcmpkt_txpmd_cell_length_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Get field BCMPKT_TXPMD_CELL_LENGTH value %u from device BCM56980_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Set field BCMPKT_TXPMD_CELL_ERROR with value %u on device BCM56980_A0.\n"), val));
...
static uint32_t bcmpkt_txpmd_cell_error_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Get field BCMPKT_TXPMD_CELL_ERROR value %u from device BCM56980_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Set field BCMPKT_TXPMD_LOCAL_DEST_PORT with value %u on device BCM56980_A0.\n"), val));
...
static uint32_t bcmpkt_txpmd_local_dest_port_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Get field BCMPKT_TXPMD_LOCAL_DEST_PORT value %u from device BCM56980_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Set field BCMPKT_TXPMD_SRC_MODID with value %u on device BCM56980_A0.\n"), val));
...
static uint32_t bcmpkt_txpmd_src_modid_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Get field BCMPKT_TXPMD_SRC_MODID value %u from device BCM56980_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Set field BCMPKT_TXPMD_COS with value %u on device BCM56980_A0.\n"), val));
...
static uint32_t bcmpkt_txpmd_cos_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Get field BCMPKT_TXPMD_COS value %u from device BCM56980_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Set field BCMPKT_TXPMD_INPUT_PRI with value %u on device BCM56980_A0.\n"), val));
...
static uint32_t bcmpkt_txpmd_input_pri_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Get field BCMPKT_TXPMD_INPUT_PRI value %u from device BCM56980_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Set field BCMPKT_TXPMD_UNICAST with value %u on device BCM56980_A0.\n"), val));
...
static uint32_t bcmpkt_txpmd_unicast_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Get field BCMPKT_TXPMD_UNICAST value %u from device BCM56980_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Set field BCMPKT_TXPMD_RQE_Q_NUM with value %u on device BCM56980_A0.\n"), val));
...
static uint32_t bcmpkt_txpmd_rqe_q_num_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Get field BCMPKT_TXPMD_RQE_Q_NUM value %u from device BCM56980_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Set field BCMPKT_TXPMD_SET_L2BM with value %u on device BCM56980_A0.\n"), val));
...
static uint32_t bcmpkt_txpmd_set_l2bm_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Get field BCMPKT_TXPMD_SET_L2BM value %u from device BCM56980_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Set field BCMPKT_TXPMD_IEEE1588_ONE_STEP_ENABLE with value %u on device BCM56980_A0.\n"), val));
...
static uint32_t bcmpkt_txpmd_ieee1588_one_step_enable_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Get field BCMPKT_TXPMD_IEEE1588_ONE_STEP_ENABLE value %u from device BCM56980_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Set field BCMPKT_TXPMD_IEEE1588_REGEN_UDP_CHECKSUM with value %u on device BCM56980_A0.\n"), val));
...
static uint32_t bcmpkt_txpmd_ieee1588_regen_udp_checksum_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Get field BCMPKT_TXPMD_IEEE1588_REGEN_UDP_CHECKSUM value %u from device BCM56980_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Set field BCMPKT_TXPMD_IEEE1588_INGRESS_TIMESTAMP_SIGN with value %u on device BCM56980_A0.\n"), val));
...
static uint32_t bcmpkt_txpmd_ieee1588_ingress_timestamp_sign_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Get field BCMPKT_TXPMD_IEEE1588_INGRESS_TIMESTAMP_SIGN value %u from device BCM56980_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Set field BCMPKT_TXPMD_IEEE1588_TIMESTAMP_HDR_OFFSET with value %u on device BCM56980_A0.\n"), val));
...
static uint32_t bcmpkt_txpmd_ieee1588_timestamp_hdr_offset_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Get field BCMPKT_TXPMD_IEEE1588_TIMESTAMP_HDR_OFFSET value %u from device BCM56980_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Set field BCMPKT_TXPMD_TX_TS with value %u on device BCM56980_A0.\n"), val));
...
static uint32_t bcmpkt_txpmd_tx_ts_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Get field BCMPKT_TXPMD_TX_TS value %u from device BCM56980_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Set field BCMPKT_TXPMD_SPID_OVERRIDE with value %u on device BCM56980_A0.\n"), val));
...
static uint32_t bcmpkt_txpmd_spid_override_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Get field BCMPKT_TXPMD_SPID_OVERRIDE value %u from device BCM56980_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Set field BCMPKT_TXPMD_SPID with value %u on device BCM56980_A0.\n"), val));
...
static uint32_t bcmpkt_txpmd_spid_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Get field BCMPKT_TXPMD_SPID value %u from device BCM56980_A0.\n"), val));
    return val;
}
...
{
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Set field BCMPKT_TXPMD_SPAP with value %u on device BCM56980_A0.\n"), val));
...
static uint32_t bcmpkt_txpmd_spap_get(uint32_t *data)
{
    ...
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD,
              (BSL_META("Get field BCMPKT_TXPMD_SPAP value %u from device BCM56980_A0.\n"), val));
    return val;
}

static uint32_t bcmpkt_txpmd_i_size_get(uint32_t *data, uint32_t **addr)
{
    LOG_DEBUG(BSL_LS_BCMPKT_TXPMD, (BSL_META("Get BCMPKT_TXPMD_I_SIZE on device BCM56980_A0.\n")));
    return 4;
}


const bcmpkt_txpmd_fget_t bcm56980_a0_txpmd_fget = {
    {
...
const bcmpkt_txpmd_fset_t bcm56980_a0_txpmd_fset = {
    {
...
const bcmpkt_txpmd_figet_t bcm56980_a0_txpmd_figet = {
    {
        bcmpkt_txpmd_i_size_get
    }
};

static shr_enum_map_t bcm56980_a0_txpmd_view_types[] = {
    {NULL, -1},
};

/* -2: unsupported, -1: global, others: view's value */
static int bcm56980_a0_txpmd_view_infos[BCMPKT_TXPMD_FID_COUNT] = {
...
void bcm56980_a0_txpmd_view_info_get(bcmpkt_pmd_view_info_t *info)
{
    info->view_infos = bcm56980_a0_txpmd_view_infos;
    info->view_types = bcm56980_a0_txpmd_view_types;
