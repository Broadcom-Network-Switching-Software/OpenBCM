...
mbcm_functions_t mbcm_hurricane4_driver = {
    /*  L2 functions */
    bcm_tr_l2_init,
    bcm_tr_l2_term,
    bcm_tr_l2_addr_get,
    ...
    bcm_hr4_cosq_discard_set,
    bcm_hr4_cosq_discard_get,
...
#else  /* BCM_HURRICANE4_SUPPORT */
typedef int bcm_esw_hurricane4_mbcm_not_empty; /* Make ISO compilers happy. */
