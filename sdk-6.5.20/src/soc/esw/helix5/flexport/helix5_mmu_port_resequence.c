 ...
 *
 * File:        helix5_mmu_port_resequence.c
 * Purpose:
 * Requires:
 */
...
/*! @fn int soc_helix5_mmu_set_mmu_to_phy_port_mapping(int unit,
    ...
    int unit,soc_port_resource_t *port_resource_t,soc_port_schedule_state_t *port_schedule_state)
{
    ...
    if (port_resource_t->physical_port == -1) {
        phy_port_new = HX5_INVALID_PHY_PORT_NUMBER; /* All 1's */
        logical_port_new = HX5_INVALID_PHY_PORT_NUMBER;
    }
    else {
...
/*! @fn int soc_helix5_mmu_vbs_port_flush(int unit,
 ...
 */
int
soc_helix5_mmu_vbs_port_flush(int unit,soc_port_schedule_state_t *port_schedule_state_t,
...
/*! @fn int soc_helix5_mmu_rqe_port_flush(int unit,
 ...
 */
int
soc_helix5_mmu_rqe_port_flush(int unit,int pipe,
                                 uint64 set_val)
{
...
/*! @fn int soc_helix5_mmu_mtro_port_flush(int unit,
 *              soc_port_resource_t *port_resource_t, int set_val)
 *  @param unit Device number
 *  @param *port_resource_t Port Resource Struct
 *  @param set_val Value to be set to the snapshot register
 ...
 */
int
soc_helix5_mmu_mtro_port_flush(int unit,soc_port_resource_t *port_resource_t,
                                  uint64 set_val)
{
...
/*Not suppported in HX5*/
/*! @fn int soc_helix5_mmu_disable_ct(int unit,
 *              soc_port_resource_t *port_resource_t)
 *  @param unit Device number
 *  @param *port_resource_t Port Resource Struct
 ...
 */
/*int
*soc_helix5_mmu_disable_ct(int                  unit,
*                            soc_port_resource_t  *port_resource_t)
*{
