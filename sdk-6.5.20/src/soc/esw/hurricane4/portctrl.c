...
#define SOC_HR4_PM4X10_COUNT            1
#define SOC_HR4_PM4X10_QTC_COUNT        2
#define SOC_HR4_PM4X25_COUNT            1
#define SOC_HR4_MAX_PHYS                72    /*  56 GXPORTS + 12 XLPORTS + 4 CLPORTS */
#define SOC_HR4_SUB_PHYS_IN_QSGMII      4


static uint32_t _hr4_pm4x10_addr[SOC_HR4_PM4X10_COUNT] = {
    0xA9
};

static uint32_t _hr4_pm4x10_core_num[SOC_HR4_PM4X10_COUNT] = {
    HR4_PHY_PORT_SERDERS(61)
};

static uint32_t _hr4_pm4x10_port[SOC_HR4_PM4X10_COUNT] = {
    61
};

#ifdef PORTMOD_PM4X10_QTC_SUPPORT
static uint32_t _hr4_pm4x10q_addr[SOC_HR4_PM4X10_QTC_COUNT] = {
    0xA1, /* PM4x10Q Inst 0 */
    0xA5, /* PM4x10Q Inst 1 */
};

static uint32_t _hr4_pm4x10q_core_num[SOC_HR4_PM4X10_QTC_COUNT] = {
    HR4_PHY_PORT_SERDERS(25), HR4_PHY_PORT_SERDERS(41)
};

static uint32_t _hr4_pm4x10q_port[SOC_HR4_PM4X10_QTC_COUNT] = {
    25, 41
};
#endif /* PORTMOD_PM4X10_QTC_SUPPORT */

static uint32_t _hr4_pm4x25_addr[SOC_HR4_PM4X25_COUNT] = {
    0xC1
};

static uint32_t _hr4_pm4x25_core_num[SOC_HR4_PM4X25_COUNT] = {
    HR4_PHY_PORT_SERDERS(57)
};

static uint32_t _hr4_pm4x25_port[SOC_HR4_PM4X25_COUNT] = {
    57
};


static portmod_pm_instances_t hr4_pm_types[] = {
#ifdef PORTMOD_PM4X10_SUPPORT
        {portmodDispatchTypePm4x10,  SOC_HR4_PM4X10_COUNT},
#endif
#ifdef PORTMOD_PM4X25_SUPPORT
        {portmodDispatchTypePm4x25,  SOC_HR4_PM4X25_COUNT},
#endif
#ifdef PORTMOD_PM4X10_QTC_SUPPORT
        {portmodDispatchTypePm4x10_qtc, SOC_HR4_PM4X10_QTC_COUNT},
#endif
};

#ifdef PORTMOD_PM4X10_SUPPORT
static portmod_default_user_access_t *pm4x10_hr4_user_acc[SOC_MAX_NUM_DEVICES];
#endif /* PORTMOD_PM4X10_SUPPORT */

#ifdef PORTMOD_PM4X10_QTC_SUPPORT
static portmod_default_user_access_t *pm4x10q_hr4_user_acc[SOC_MAX_NUM_DEVICES];
static portmod_default_user_access_t *pm4x10q_4x10_hr4_user_acc[SOC_MAX_NUM_DEVICES];
#endif /* PORTMOD_PM4X10_QTC_SUPPORT */

#ifdef PORTMOD_PM4X25_SUPPORT
static portmod_default_user_access_t *pm4x25_hr4_user_acc[SOC_MAX_NUM_DEVICES];
#endif /* PORTMOD_PM4X25_SUPPORT */

#define SOC_HR4_CORE_FREQ_KHZ_DEFAULT 50000  /* HR4 default core freq is 50MHz*/

extern int soc_hr4_portctrl_pm_portmod_init(int unit);
extern int soc_hr4_portctrl_pm_portmod_deinit(int unit);
extern int soc_hr4_portctrl_pm_port_config_get(int unit, soc_port_t port, void *port_config_info);
extern int soc_hr4_portctrl_pm_port_phyaddr_get(int unit, soc_port_t port);
extern int soc_hr4_portctrl_pm_type_get(int unit, soc_port_t phy_port, int* pm_type);

soc_portctrl_functions_t soc_hr4_portctrl_func = {
    soc_hr4_portctrl_pm_portmod_init,
    soc_hr4_portctrl_pm_portmod_deinit,
    soc_hr4_portctrl_pm_port_config_get,
    soc_hr4_portctrl_pm_port_phyaddr_get,
    NULL /* soc_hr4_portctrl_port_ability_update*/,
    soc_hr4_portctrl_pm_type_get,
    NULL,
    NULL
};

STATIC int
_soc_hr4_portctrl_pm_init(int unit, int *max_phys,
                           portmod_pm_instances_t **pm_types,
                           int *pms_arr_len)
{
    *max_phys = SOC_HR4_MAX_PHYS;
    *pm_types = hr4_pm_types;
    *pms_arr_len = (sizeof(hr4_pm_types) / sizeof(portmod_pm_instances_t));

    return SOC_E_NONE;
}

STATIC int
_soc_hr4_portctrl_device_addr_port_get(int unit, int pm_type,
                                        uint32_t **addr,
                                        uint32_t **port,
                                        uint32_t **core_num)
{
    ...
    *core_num = NULL;
    ...
    if (pm_type == portmodDispatchTypePm4x10) {
        *addr = _hr4_pm4x10_addr;
        *port = _hr4_pm4x10_port;
        *core_num = _hr4_pm4x10_core_num;
    } else if (pm_type == portmodDispatchTypePm4x25){
        *addr = _hr4_pm4x25_addr;
        *port = _hr4_pm4x25_port;
        *core_num = _hr4_pm4x25_core_num;
#ifdef PORTMOD_PM4X10_QTC_SUPPORT
    } else if (pm_type == portmodDispatchTypePm4x10_qtc){
        *addr = _hr4_pm4x10q_addr;
        *port = _hr4_pm4x10q_port;
        *core_num = _hr4_pm4x10q_core_num;
#endif /*PORTMOD_PM4X10_QTC_SUPPORT */
    }
...
STATIC int
_soc_hr4_portctrl_pm_user_acc_flag_set(int unit,
 ...
 */
STATIC
void hr4_pm_port_polarity_get(int unit, int physical_port, int lane,
 ...
 */
STATIC
void hr4_pm_port_lanemap_get (int unit, int physical_port,
...
STATIC int
_soc_hr4_portctrl_pm4x10_portmod_init(int unit, int num_of_instances)
{
#ifdef PORTMOD_PM4X10_SUPPORT
    int rv = SOC_E_NONE;
    ...
    SOC_IF_ERROR_RETURN
        (_soc_hr4_portctrl_device_addr_port_get(unit,
    ...
    for (pmid = 0; PORTMOD_SUCCESS(rv) && (pmid < num_of_instances); pmid++) {
        ...
        rv = portmod_default_user_access_t_init(unit,
                                                &(pm4x10_hr4_user_acc[unit][pmid]));
        if (PORTMOD_FAILURE(rv)) {
            break;
        }

        SOC_IF_ERROR_RETURN(
            _soc_hr4_portctrl_pm_user_acc_flag_set(unit,
                &(pm4x10_hr4_user_acc[unit][pmid])));

        PORTMOD_USER_ACCESS_FW_LOAD_REVERSE_SET((&(pm4x10_hr4_user_acc[unit][pmid])));
        pm4x10_hr4_user_acc[unit][pmid].unit = unit;
        pm4x10_hr4_user_acc[unit][pmid].blk_id = blk;
        pm4x10_hr4_user_acc[unit][pmid].mutex = sal_mutex_create("core mutex");
        if (pm4x10_hr4_user_acc[unit][pmid].mutex == NULL) {
            rv = SOC_E_MEMORY;
            break;
        }
    ...
    if (PORTMOD_FAILURE(rv)) {
        for (pmid=0; pmid < num_of_instances; pmid++) {
            if (pm4x10_hr4_user_acc[unit][pmid].mutex) {
                sal_mutex_destroy(pm4x10_hr4_user_acc[unit][pmid].mutex);
                pm4x10_hr4_user_acc[unit][pmid].mutex = NULL;
            }
        }
    }
...
STATIC int
_soc_hr4_portctrl_pm4x10_qtc_pm_qtc_init(int unit, int instance_id, portmod_pm_qtc_create_info_t *pm_qtc_info)
{
#ifdef PORTMOD_PM4X10_QTC_SUPPORT
    int rv = SOC_E_NONE;
    ...
    /* Init user_acc for phymod access struct */
    rv = portmod_default_user_access_t_init(unit,
                                            &(pm4x10q_hr4_user_acc[unit][instance_id]));
    if (PORTMOD_FAILURE(rv)) {
        return rv;
    }

    /* for Qmode.  */
    pm4x10q_hr4_user_acc[unit][instance_id].unit = unit;
    pm4x10q_hr4_user_acc[unit][instance_id].blk_id = blk;
    pm4x10q_hr4_user_acc[unit][instance_id].mutex = sal_mutex_create("core mutex");
    if (pm4x10q_hr4_user_acc[unit][instance_id].mutex == NULL) {
        return SOC_E_MEMORY;
    }
    ...
    PORTMOD_USER_ACCESS_FW_LOAD_REVERSE_SET((&(pm4x10q_hr4_user_acc[unit][instance_id])));
    pm_qtc_info->access.user_acc = &pm4x10q_hr4_user_acc[unit][instance_id];
    ...
    pm_qtc_info->core_clock_khz  = SOC_HR4_CORE_FREQ_KHZ_DEFAULT;
...
STATIC int
_soc_hr4_portctrl_pm4x10_qtc_pm4x10_init(int unit, int instance_id, portmod_pm4x10_create_info_t *pm4x10_info)
{
#ifdef PORTMOD_PM4X10_QTC_SUPPORT
    int rv = SOC_E_NONE;
    int blk, is_sim, found;
    ...
    /* Init user_acc for phymod access struct */
    rv = portmod_default_user_access_t_init(unit,
                                            &(pm4x10q_4x10_hr4_user_acc[unit][instance_id]));
    if (PORTMOD_FAILURE(rv)) {
        return rv;
    }
    pm4x10q_4x10_hr4_user_acc[unit][instance_id].unit = unit;
    pm4x10q_4x10_hr4_user_acc[unit][instance_id].blk_id = blk;
    pm4x10q_4x10_hr4_user_acc[unit][instance_id].mutex = sal_mutex_create("core mutex");
    if (pm4x10q_4x10_hr4_user_acc[unit][instance_id].mutex == NULL) {
        return SOC_E_MEMORY;
    }
    ...
    PORTMOD_USER_ACCESS_FW_LOAD_REVERSE_SET((&(pm4x10q_4x10_hr4_user_acc[unit][instance_id])));
    pm4x10_info->access.user_acc = &pm4x10q_4x10_hr4_user_acc[unit][instance_id];
...
STATIC int
_soc_hr4_portctrl_pm4x10_qtc_portmod_init(int unit, int num_of_instances)
{
#ifdef PORTMOD_PM4X10_QTC_SUPPORT
    int rv = SOC_E_NONE;
    ...
    SOC_IF_ERROR_RETURN
        (soc_esw_portctrl_pm_user_access_alloc(unit, num_of_instances,
                                               &pm4x10q_hr4_user_acc[unit]));
    /* Allocate PMs */
    SOC_IF_ERROR_RETURN
        (soc_esw_portctrl_pm_user_access_alloc(unit, num_of_instances,
                                               &pm4x10q_4x10_hr4_user_acc[unit]));
    ...
    for (instance_id = 0; PORTMOD_SUCCESS(rv) && (instance_id < num_of_instances); instance_id++) {
        ...
        /*pm_qtc infomration*/
        rv = _soc_hr4_portctrl_pm4x10_qtc_pm_qtc_init(unit, instance_id,
        ...
        /*pm4x10 infomration*/
        rv = _soc_hr4_portctrl_pm4x10_qtc_pm4x10_init(unit, instance_id,
    ...
    if (PORTMOD_FAILURE(rv)) {
        for (instance_id=0; instance_id < num_of_instances; instance_id++) {
            if (pm4x10q_hr4_user_acc[unit][instance_id].mutex) {
                sal_mutex_destroy(pm4x10q_hr4_user_acc[unit][instance_id].mutex);
                pm4x10q_hr4_user_acc[unit][instance_id].mutex = NULL;
            }

            if (pm4x10q_4x10_hr4_user_acc[unit][instance_id].mutex) {
                sal_mutex_destroy(pm4x10q_4x10_hr4_user_acc[unit][instance_id].mutex);
                pm4x10q_4x10_hr4_user_acc[unit][instance_id].mutex = NULL;
            }
        }
    }
...
STATIC int
_soc_hr4_portctrl_pm4x25_portmod_init(int unit, int num_of_instances)
{
#ifdef PORTMOD_PM4X25_SUPPORT
    int rv = SOC_E_NONE;
    portmod_pm_create_info_t pm_info;
    ...
    for (pmid = 0; PORTMOD_SUCCESS(rv) && (pmid < num_of_instances); pmid++) {
        ...
        /* Init user_acc for phymod access struct */
        rv = portmod_default_user_access_t_init(unit,
                                                &(pm4x25_hr4_user_acc[unit][pmid]));
        if (PORTMOD_FAILURE(rv)) {
            break;
        }

        PORTMOD_USER_ACCESS_FW_LOAD_REVERSE_SET((&(pm4x25_hr4_user_acc[unit][pmid])));
        pm4x25_hr4_user_acc[unit][pmid].unit = unit;
        pm4x25_hr4_user_acc[unit][pmid].blk_id = blk;
        pm4x25_hr4_user_acc[unit][pmid].mutex = sal_mutex_create("core mutex");
        if (pm4x25_hr4_user_acc[unit][pmid].mutex == NULL) {
            rv = SOC_E_MEMORY;
            break;
        }
    ...
    if (PORTMOD_FAILURE(rv)) {
        for (pmid=0; pmid < num_of_instances; pmid++) {
            if (pm4x25_hr4_user_acc[unit][pmid].mutex) {
                sal_mutex_destroy(pm4x25_hr4_user_acc[unit][pmid].mutex);
                pm4x25_hr4_user_acc[unit][pmid].mutex = NULL;
            }
        }
    }
 ...
 */
int
soc_hr4_portctrl_pm_portmod_init(int unit)
{
    uint32 flags = 0;
    ...
    SOC_IF_ERROR_RETURN(
        _soc_hr4_portctrl_pm_init(unit, &max_phys,
 ...
 */
int
soc_hr4_portctrl_pm_portmod_deinit(int unit)
{
    ...
    /* Free PMs structures */
#ifdef PORTMOD_PM4X10_SUPPORT
    if (pm4x10_hr4_user_acc[unit] != NULL) {
        sal_free(pm4x10_hr4_user_acc[unit]);
        pm4x10_hr4_user_acc[unit] = NULL;
    }
#endif /* PORTMOD_PM4X10_SUPPORT */

    /* Free PMs structures */
#ifdef PORTMOD_PM4X10_QTC_SUPPORT
    if (pm4x10q_hr4_user_acc[unit] != NULL) {
        sal_free(pm4x10q_hr4_user_acc[unit]);
        pm4x10q_hr4_user_acc[unit] = NULL;
    }
#endif /* PORTMOD_PM4X10_SUPPORT */

#ifdef PORTMOD_PM4X25_SUPPORT
    if (pm4x25_hr4_user_acc[unit] != NULL) {
        sal_free(pm4x25_hr4_user_acc[unit]);
        pm4x25_hr4_user_acc[unit] = NULL;
    }
#endif /* PORTMOD_PM4X25_SUPPORT */
...
int
soc_hr4_portctrl_pm_port_config_get(int unit, soc_port_t port, void *port_config)
{
#ifdef PORTMOD_PM4X10_SUPPORT
    ...
    pm_found = 0;
    core_index = HR4_PHY_PORT_SERDERS(phy);

#ifdef PORTMOD_PM4X10_QTC_SUPPORT
    for (i=0; i<SOC_HR4_PM4X10_QTC_COUNT; i++) {
        if (core_index == _hr4_pm4x10q_core_num[i]) {
            type = portmodDispatchTypePm4x10_qtc;
            SOC_IF_ERROR_RETURN
                (_soc_hr4_portctrl_device_addr_port_get(unit, type,
                                              &pAddr, &pPort, &pCoreNum));
            pmid = i;
            pm_found = 1;
            break;
    ...
    if (!pm_found) {
        ...
        for (i=0; i<SOC_HR4_PM4X10_COUNT; i++) {
            if (core_index == _hr4_pm4x10_core_num[i]) {
    ...
    if (!pm_found) {
        for (i=0; i<SOC_HR4_PM4X25_COUNT; i++) {
            if (core_index == _hr4_pm4x25_core_num[i]) {
    ...
    for (lane = 0; lane < max_index; lane++) {
        ...
        hr4_pm_port_polarity_get(unit, phy_port, lane, &tx_polarity, &rx_polarity);
    ...
    hr4_pm_port_lanemap_get(unit, phy_port, &txlane_map, &rxlane_map);
...
int
soc_hr4_portctrl_pm_port_phyaddr_get(int unit, soc_port_t port)
{
    int phy, core_index;
...
#define PORT_IS_PM4X10(unit, phy_port) \
        ((phy_port  >= 61) && (phy_port <= 64)) ? 1 : 0

#define PORT_IS_PM4X10_QTC(unit, phy_port) \
        ((phy_port  >= 25) && (phy_port <= 56)) ? 1 : 0

int
soc_hr4_portctrl_pm_type_get(int unit, soc_port_t phy_port,
                            int* pm_type)
{
