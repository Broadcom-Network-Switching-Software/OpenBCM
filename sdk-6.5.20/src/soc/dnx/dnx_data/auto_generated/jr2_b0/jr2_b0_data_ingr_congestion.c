...
static shr_error_e
jr2_b0_dnx_data_ingr_congestion_info_latency_based_admission_reject_flow_profile_value_set(
    int unit)
{
...
static shr_error_e
jr2_b0_dnx_data_ingr_congestion_info_latency_based_admission_max_supported_profile_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ingr_congestion;
    ...
    int unit)
{
    ...
    define->set = jr2_b0_dnx_data_ingr_congestion_info_latency_based_admission_reject_flow_profile_value_set;
    data_index = dnx_data_ingr_congestion_info_define_latency_based_admission_max_supported_profile;
    define = &submodule->defines[data_index];
    define->set = jr2_b0_dnx_data_ingr_congestion_info_latency_based_admission_max_supported_profile_set;
