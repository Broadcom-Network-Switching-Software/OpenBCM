...
static shr_error_e
q2a_a0_dnx_data_l2_age_and_flush_machine_filter_rules_set(
    int unit)
{
    ...
    table->values[2].default_val = "ITEM_8_263f";
    table->values[3].default_val = "ITEM_274_529f";
    table->values[4].default_val = "ITEM_264_266f";
    table->values[5].default_val = "ITEM_530_532f";
    table->values[6].default_val = "ITEM_2_7f";
    table->values[7].default_val = "ITEM_268_273f";
    table->values[8].default_val = "ITEM_1_1f";
    table->values[9].default_val = "ITEM_267_267f";
    ...
    default_data->entry_mask = ITEM_8_263f;
    default_data->entry_filter = ITEM_274_529f;
    default_data->src_mask = ITEM_264_266f;
    default_data->src_filter = ITEM_530_532f;
    default_data->appdb_id_mask = ITEM_2_7f;
    default_data->appdb_id_filter = ITEM_268_273f;
    default_data->accessed_mask = ITEM_1_1f;
    default_data->accessed_filter = ITEM_267_267f;
...
static shr_error_e
q2a_a0_dnx_data_l2_age_and_flush_machine_data_rules_set(
    int unit)
{
...
static shr_error_e
q2a_a0_dnx_data_l2_age_and_flush_machine_flush_set(
    int unit)
{
    ...
    int unit)
{
    ...
    table->set = q2a_a0_dnx_data_l2_age_and_flush_machine_filter_rules_set;
    data_index = dnx_data_l2_age_and_flush_machine_table_data_rules;
    table = &submodule->tables[data_index];
    table->set = q2a_a0_dnx_data_l2_age_and_flush_machine_data_rules_set;
    data_index = dnx_data_l2_age_and_flush_machine_table_flush;
    table = &submodule->tables[data_index];
    table->set = q2a_a0_dnx_data_l2_age_and_flush_machine_flush_set;
