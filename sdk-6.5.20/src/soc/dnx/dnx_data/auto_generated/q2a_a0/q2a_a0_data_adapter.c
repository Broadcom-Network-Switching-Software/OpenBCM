...
#include <src/bcm/dnx/rx/auto_generated/rx_internal_q2a_a0.h>
...
static shr_error_e
q2a_a0_dnx_data_adapter_rx_packet_header_signal_id_set(
    int unit)
{
    ...
    define->default_data = PACKET_HEADER_SIGNAL_ID_Q2A_A0;

    
    define->data = PACKET_HEADER_SIGNAL_ID_Q2A_A0;
    ...
    int unit)
{
    ...
    define->set = q2a_a0_dnx_data_adapter_rx_packet_header_signal_id_set;
