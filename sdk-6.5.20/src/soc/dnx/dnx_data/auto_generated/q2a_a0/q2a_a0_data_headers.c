...
static shr_error_e
q2a_a0_dnx_data_headers_feature_tsh_ext_with_flow_id_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_headers;
...
static shr_error_e
q2a_a0_dnx_data_headers_feature_fhei_mpls_swap_remark_profile_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_headers;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_headers_feature_fhei_mpls_swap_remark_profile_size_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_headers_feature_tsh_ext_with_flow_id_set;
