...
static shr_error_e
q2a_a0_dnx_data_ingr_reassembly_context_rcy_interleaving_between_priorities_set(
    int unit)
{
...
static shr_error_e
q2a_a0_dnx_data_ingr_reassembly_context_nof_contexts_set(
    int unit)
{
...
static shr_error_e
q2a_a0_dnx_data_ingr_reassembly_context_context_map_set(
    int unit)
{
    int port_type_index;
    ...
    if (DNX_ALGO_PORT_TYPE_FLEXE_MAC < table->keys[0].size)
    {
...
static shr_error_e
q2a_a0_dnx_data_ingr_reassembly_ilkn_is_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_ingr_reassembly;
...
static shr_error_e
q2a_a0_dnx_data_ingr_reassembly_dbal_reassembly_context_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ingr_reassembly;
...
static shr_error_e
q2a_a0_dnx_data_ingr_reassembly_dbal_interface_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ingr_reassembly;
...
static shr_error_e
q2a_a0_dnx_data_ingr_reassembly_dbal_interface_max_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ingr_reassembly;
...
static shr_error_e
q2a_a0_dnx_data_ingr_reassembly_dbal_context_map_base_address_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ingr_reassembly;
...
static shr_error_e
q2a_a0_dnx_data_ingr_reassembly_dbal_context_map_base_address_max_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ingr_reassembly;
...
static shr_error_e
q2a_a0_dnx_data_ingr_reassembly_dbal_interleaved_interface_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ingr_reassembly;
...
shr_error_e
q2a_a0_data_ingr_reassembly_attach(
    int unit)
{
    ...
    define->set = q2a_a0_dnx_data_ingr_reassembly_context_nof_contexts_set;

    
    data_index = dnx_data_ingr_reassembly_context_rcy_interleaving_between_priorities;
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_ingr_reassembly_context_rcy_interleaving_between_priorities_set;

    
    data_index = dnx_data_ingr_reassembly_context_table_context_map;
    table = &submodule->tables[data_index];
    table->set = q2a_a0_dnx_data_ingr_reassembly_context_context_map_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_ingr_reassembly_ilkn_is_supported_set;
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_ingr_reassembly_dbal_reassembly_context_bits_set;
    data_index = dnx_data_ingr_reassembly_dbal_define_interface_bits;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_ingr_reassembly_dbal_interface_bits_set;
    data_index = dnx_data_ingr_reassembly_dbal_define_interface_max;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_ingr_reassembly_dbal_interface_max_set;
    data_index = dnx_data_ingr_reassembly_dbal_define_context_map_base_address_bits;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_ingr_reassembly_dbal_context_map_base_address_bits_set;
    data_index = dnx_data_ingr_reassembly_dbal_define_context_map_base_address_max;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_ingr_reassembly_dbal_context_map_base_address_max_set;
    data_index = dnx_data_ingr_reassembly_dbal_define_interleaved_interface_bits;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_ingr_reassembly_dbal_interleaved_interface_bits_set;
