...
static shr_error_e
j2p_a0_dnx_data_qos_feature_egress_remark_or_keep_enabler_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_qos;
...
static shr_error_e
j2p_a0_dnx_data_qos_feature_fwd_eve_pcp_diff_encap_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_qos;
...
static shr_error_e
j2p_a0_dnx_data_qos_feature_phb_rm_ffc_extend_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_qos;
...
static shr_error_e
j2p_a0_dnx_data_qos_feature_hdr_qual_after_mpls_available_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_qos;
...
static shr_error_e
j2p_a0_dnx_data_qos_feature_phb_rm_ffc_bits_width_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_qos;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_qos_feature_phb_rm_ffc_bits_width_set;

    
    data_index = dnx_data_qos_feature_egress_remark_or_keep_enabler;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_qos_feature_egress_remark_or_keep_enabler_set;
    data_index = dnx_data_qos_feature_fwd_eve_pcp_diff_encap;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_qos_feature_fwd_eve_pcp_diff_encap_set;
    data_index = dnx_data_qos_feature_phb_rm_ffc_extend;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_qos_feature_phb_rm_ffc_extend_set;
    data_index = dnx_data_qos_feature_hdr_qual_after_mpls_available;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_qos_feature_hdr_qual_after_mpls_available_set;
