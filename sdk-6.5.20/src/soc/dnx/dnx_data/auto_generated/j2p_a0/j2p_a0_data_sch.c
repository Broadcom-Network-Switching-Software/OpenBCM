...
static shr_error_e
j2p_a0_dnx_data_sch_general_port_priority_propagation_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_sch;
...
static shr_error_e
j2p_a0_dnx_data_sch_general_port_priority_propagation_enable_set(
    int unit)
{
...
static shr_error_e
j2p_a0_dnx_data_sch_flow_cl_num_to_quartet_offset_set(
    int unit)
{
    int cl_num_index;
...
static shr_error_e
j2p_a0_dnx_data_sch_flow_quartet_offset_to_cl_num_set(
    int unit)
{
...
static shr_error_e
j2p_a0_dnx_data_sch_sch_alloc_region_set(
    int unit)
{
...
static shr_error_e
j2p_a0_dnx_data_sch_sch_alloc_se_per_region_type_set(
    int unit)
{
    int flow_type_index;
    int region_type_index;
...
static shr_error_e
j2p_a0_dnx_data_sch_sch_alloc_se_set(
    int unit)
{
    int flow_type_index;
...
static shr_error_e
j2p_a0_dnx_data_sch_sch_alloc_composite_se_per_region_type_set(
    int unit)
{
    int flow_type_index;
    int region_type_index;
...
static shr_error_e
j2p_a0_dnx_data_sch_sch_alloc_composite_se_set(
    int unit)
{
    int flow_type_index;
    ...
    int unit)
{
    ...
    define->set = j2p_a0_dnx_data_sch_general_port_priority_propagation_enable_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_sch_general_port_priority_propagation_supported_set;
    ...
    table->set = j2p_a0_dnx_data_sch_flow_cl_num_to_quartet_offset_set;
    data_index = dnx_data_sch_flow_table_quartet_offset_to_cl_num;
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_sch_flow_quartet_offset_to_cl_num_set;
    ...
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_sch_sch_alloc_region_set;
    data_index = dnx_data_sch_sch_alloc_table_se_per_region_type;
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_sch_sch_alloc_se_per_region_type_set;
    data_index = dnx_data_sch_sch_alloc_table_se;
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_sch_sch_alloc_se_set;
    data_index = dnx_data_sch_sch_alloc_table_composite_se_per_region_type;
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_sch_sch_alloc_composite_se_per_region_type_set;
    data_index = dnx_data_sch_sch_alloc_table_composite_se;
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_sch_sch_alloc_composite_se_set;
