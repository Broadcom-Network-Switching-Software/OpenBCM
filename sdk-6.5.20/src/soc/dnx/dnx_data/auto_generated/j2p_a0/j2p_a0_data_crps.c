...
static shr_error_e
j2p_a0_dnx_data_crps_eviction_narrow_counters_is_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_crps;
    int submodule_index = dnx_data_crps_submodule_eviction;
    int feature_index = dnx_data_crps_eviction_narrow_counters_is_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
j2p_a0_dnx_data_crps_expansion_itm_types_set(
    int unit)
{
    ...
    int unit)
{
    ...
    data_index = dnx_data_crps_eviction_narrow_counters_is_supported;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_crps_eviction_narrow_counters_is_supported_set;
    ...
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_crps_expansion_itm_types_set;
