...
static shr_error_e
j2p_a0_dnx_data_ipq_queues_voq_resolution_per_dp_set(
    int unit)
{
...
static shr_error_e
j2p_a0_dnx_data_ipq_queues_tc_profile_from_tm_command_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_ipq;
...
static shr_error_e
j2p_a0_dnx_data_ipq_queues_nof_queues_set(
    int unit)
{
...
static shr_error_e
j2p_a0_dnx_data_ipq_queues_queue_id_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ipq;
...
static shr_error_e
j2p_a0_dnx_data_ipq_queues_voq_offset_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ipq;
...
static shr_error_e
j2p_a0_dnx_data_ipq_queues_tc_profile_from_tm_command_nof_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ipq;
...
static shr_error_e
j2p_a0_dnx_data_ipq_queues_flow_quartet_nof_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ipq;
...
static shr_error_e
j2p_a0_dnx_data_ipq_regions_nof_queues_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ipq;
...
static shr_error_e
j2p_a0_dnx_data_ipq_tc_map_nof_voq_flow_profiles_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ipq;
...
static shr_error_e
j2p_a0_dnx_data_ipq_tc_map_voq_flow_profiles_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ipq;
...
static shr_error_e
j2p_a0_dnx_data_ipq_tc_map_voq_resolution_type_max_value_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ipq;
    ...
    int unit)
{
    ...
    define->set = j2p_a0_dnx_data_ipq_queues_nof_queues_set;
    data_index = dnx_data_ipq_queues_define_queue_id_bits;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_ipq_queues_queue_id_bits_set;
    data_index = dnx_data_ipq_queues_define_voq_offset_bits;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_ipq_queues_voq_offset_bits_set;
    data_index = dnx_data_ipq_queues_define_tc_profile_from_tm_command_nof_bits;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_ipq_queues_tc_profile_from_tm_command_nof_bits_set;
    data_index = dnx_data_ipq_queues_define_flow_quartet_nof_bits;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_ipq_queues_flow_quartet_nof_bits_set;

    
    data_index = dnx_data_ipq_queues_voq_resolution_per_dp;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_ipq_queues_voq_resolution_per_dp_set;
    data_index = dnx_data_ipq_queues_tc_profile_from_tm_command;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_ipq_queues_tc_profile_from_tm_command_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_ipq_regions_nof_queues_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_ipq_tc_map_nof_voq_flow_profiles_set;
    data_index = dnx_data_ipq_tc_map_define_voq_flow_profiles_bits;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_ipq_tc_map_voq_flow_profiles_bits_set;
    data_index = dnx_data_ipq_tc_map_define_voq_resolution_type_max_value;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_ipq_tc_map_voq_resolution_type_max_value_set;
