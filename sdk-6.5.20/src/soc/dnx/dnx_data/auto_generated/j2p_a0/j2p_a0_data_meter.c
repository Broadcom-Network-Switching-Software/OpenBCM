...
static shr_error_e
j2p_a0_dnx_data_meter_profile_ir_mant_nof_bits_set(
    int unit)
{
...
static shr_error_e
j2p_a0_dnx_data_meter_diag_rate_measurements_support_set(
    int unit)
{
...
static shr_error_e
j2p_a0_dnx_data_meter_meter_db_tcsm_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_meter;
...
static shr_error_e
j2p_a0_dnx_data_meter_mem_mgmt_meter_pointer_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_meter;
...
static shr_error_e
j2p_a0_dnx_data_meter_mem_mgmt_invalid_bank_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_meter;
...
static shr_error_e
j2p_a0_dnx_data_meter_mem_mgmt_bank_id_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_meter;
...
static shr_error_e
j2p_a0_dnx_data_meter_mem_mgmt_sections_offset_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_meter;
...
static shr_error_e
j2p_a0_dnx_data_meter_expansion_expansion_based_on_tc_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_meter;
...
static shr_error_e
j2p_a0_dnx_data_meter_expansion_max_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_meter;
    ...
    int unit)
{
    ...
    define->set = j2p_a0_dnx_data_meter_profile_ir_mant_nof_bits_set;
    ...
    feature->set = j2p_a0_dnx_data_meter_diag_rate_measurements_support_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_meter_meter_db_tcsm_support_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_meter_mem_mgmt_meter_pointer_size_set;
    data_index = dnx_data_meter_mem_mgmt_define_invalid_bank_id;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_meter_mem_mgmt_invalid_bank_id_set;
    data_index = dnx_data_meter_mem_mgmt_define_bank_id_size;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_meter_mem_mgmt_bank_id_size_set;
    data_index = dnx_data_meter_mem_mgmt_define_sections_offset;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_meter_mem_mgmt_sections_offset_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_meter_expansion_max_size_set;

    
    data_index = dnx_data_meter_expansion_expansion_based_on_tc_support;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_meter_expansion_expansion_based_on_tc_support_set;
