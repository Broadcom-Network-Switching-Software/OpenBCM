...
static shr_error_e
j2p_a0_dnx_data_iqs_credit_watchdog_fixed_period_set(
    int unit)
{
...
static shr_error_e
j2p_a0_dnx_data_iqs_credit_fmq_shp_zero_rate_allowed_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_iqs;
...
static shr_error_e
j2p_a0_dnx_data_iqs_credit_max_worth_set(
    int unit)
{
...
static shr_error_e
j2p_a0_dnx_data_iqs_deq_default_dqcq_fc_to_dram_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_iqs;
...
static shr_error_e
j2p_a0_dnx_data_iqs_dqcq_8_priorities_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_iqs;
...
static shr_error_e
j2p_a0_dnx_data_iqs_dqcq_nof_priorities_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_iqs;
...
static shr_error_e
j2p_a0_dnx_data_iqs_dbal_ipt_counters_nof_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_iqs;
    ...
    int unit)
{
    ...
    define->set = j2p_a0_dnx_data_iqs_credit_max_worth_set;

    
    data_index = dnx_data_iqs_credit_watchdog_fixed_period;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_iqs_credit_watchdog_fixed_period_set;
    data_index = dnx_data_iqs_credit_fmq_shp_zero_rate_allowed;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_iqs_credit_fmq_shp_zero_rate_allowed_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_iqs_deq_default_dqcq_fc_to_dram_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_iqs_dqcq_nof_priorities_set;

    
    data_index = dnx_data_iqs_dqcq_8_priorities;
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_iqs_dqcq_8_priorities_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_iqs_dbal_ipt_counters_nof_bits_set;
