...
static shr_error_e
j2p_a0_dnx_data_device_general_production_ready_set(
    int unit)
{
...
static shr_error_e
j2p_a0_dnx_data_device_general_ext_encap_is_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_device;
    ...
    int unit)
{
    ...
    feature->set = j2p_a0_dnx_data_device_general_production_ready_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_device_general_ext_encap_is_supported_set;
