...
static shr_error_e
j2c_a0_dnx_data_gtimer_tdu_block_index_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_gtimer;
...
static shr_error_e
j2c_a0_dnx_data_gtimer_tdu_block_index_max_value_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_gtimer;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_gtimer_tdu_block_index_size_set;
    data_index = dnx_data_gtimer_tdu_define_block_index_max_value;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_gtimer_tdu_block_index_max_value_set;
