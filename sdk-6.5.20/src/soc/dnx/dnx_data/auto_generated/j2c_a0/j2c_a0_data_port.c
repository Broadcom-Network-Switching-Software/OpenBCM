    ...
    int unit)
{
    ...
    table->values[0].property.nof_mapping = 15;
    ...
    table->values[0].property.mapping[14].name = "STACKING";
    table->values[0].property.mapping[14].val = BCM_SWITCH_PORT_HEADER_TYPE_STACKING;
    ...
    table->values[1].property.mapping[9].name = "INJECTED";
    table->values[1].property.mapping[9].val = BCM_SWITCH_PORT_HEADER_TYPE_INJECTED;
    table->values[1].property.mapping[10].name = "STACKING";
    table->values[1].property.mapping[10].val = BCM_SWITCH_PORT_HEADER_TYPE_STACKING;
