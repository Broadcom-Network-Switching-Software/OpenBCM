...
static shr_error_e
j2c_a0_dnx_data_synce_general_synce_no_sdm_mode_set(
    int unit)
{
...
static shr_error_e
j2c_a0_dnx_data_synce_general_synce_nmg_chain_select_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_synce;
...
static shr_error_e
j2c_a0_dnx_data_synce_general_fabric_div_min_set(
    int unit)
{
...
static shr_error_e
j2c_a0_dnx_data_synce_general_fabric_div_max_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_synce;
...
static shr_error_e
j2c_a0_dnx_data_synce_general_cfg_set(
    int unit)
{
    ...
    table->values[2].property.doc =
        ...
        "For NIF and Fabric synce, the available value is,\n"
        "2: 25Mhz.\n"
        "\n"
    ;
...
static shr_error_e
j2c_a0_dnx_data_synce_general_nmg_chain_map_set(
    int unit)
{
    ...
    {
        data = (dnx_data_synce_general_nmg_chain_map_t *) dnxc_data_mgmt_table_data_get(unit, table, 5, 0);
        data->chain_id = 0;
    }
    if (6 < table->keys[0].size)
    {
        data = (dnx_data_synce_general_nmg_chain_map_t *) dnxc_data_mgmt_table_data_get(unit, table, 6, 0);
        data->chain_id = 0;
    }
    if (7 < table->keys[0].size)
    {
        data = (dnx_data_synce_general_nmg_chain_map_t *) dnxc_data_mgmt_table_data_get(unit, table, 7, 0);
        data->chain_id = 0;
    }
    if (8 < table->keys[0].size)
    {
        data = (dnx_data_synce_general_nmg_chain_map_t *) dnxc_data_mgmt_table_data_get(unit, table, 8, 0);
        data->chain_id = 1;
    }
    if (9 < table->keys[0].size)
    {
        data = (dnx_data_synce_general_nmg_chain_map_t *) dnxc_data_mgmt_table_data_get(unit, table, 9, 0);
        data->chain_id = 1;
    }
    ...
    int unit)
{
    ...
    define->set = j2c_a0_dnx_data_synce_general_fabric_div_min_set;
    data_index = dnx_data_synce_general_define_fabric_div_max;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_synce_general_fabric_div_max_set;

    
    data_index = dnx_data_synce_general_synce_no_sdm_mode;
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_synce_general_synce_no_sdm_mode_set;
    data_index = dnx_data_synce_general_synce_nmg_chain_select;
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_synce_general_synce_nmg_chain_select_set;

    
    data_index = dnx_data_synce_general_table_cfg;
    table = &submodule->tables[data_index];
    table->set = j2c_a0_dnx_data_synce_general_cfg_set;
    data_index = dnx_data_synce_general_table_nmg_chain_map;
    table = &submodule->tables[data_index];
    table->set = j2c_a0_dnx_data_synce_general_nmg_chain_map_set;
