    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                access_params->access_field_id = DBAL_FIELD_FWD_METADATA_SIZE + instance_index;
                SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_field(unit, access_params, 0 , 0 , DBAL_VALUE_FIELD_ENCODE_NONE , 0 ));
        ...
        
        {
            ...
            
            {
                ...
                access_params->access_field_id = DBAL_FIELD_FWD_METADATA_SHIFT + instance_index;
                SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_field(unit, access_params, 0 , 0 , DBAL_VALUE_FIELD_ENCODE_NONE , 0 ));
        ...
        
        {
            ...
            
            {
                ...
                access_params->access_field_id = DBAL_FIELD_FWD_PLUS_ONE_METADATA_SIZE + instance_index;
                SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_field(unit, access_params, 0 , 0 , DBAL_VALUE_FIELD_ENCODE_NONE , 0 ));
        ...
        
        {
            ...
            
            {
                ...
                access_params->access_field_id = DBAL_FIELD_FWD_PLUS_ONE_METADATA_SHIFT + instance_index;
                SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_field(unit, access_params, 0 , 0 , DBAL_VALUE_FIELD_ENCODE_NONE , 0 ));
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                access_params->access_field_id = DBAL_FIELD_FEC_TAKE_PRIMARY + instance_index;
                SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_field(unit, access_params, 0 , 0 , DBAL_VALUE_FIELD_ENCODE_NONE , 0 ));
