        ...
        if (DBAL_IS_J2C_A0 || DBAL_IS_Q2A_A0 || DBAL_IS_Q2A_B0)
        {
            
            {
                ...
                
                {
                    ...
                    access_params->access_field_id = DBAL_FIELD_FIRST_PHY + instance_index;
                    ...
                    
                    {
                        ...
                        regMemHwEntityId = ECI_RESERVED_48m;
                        
                        fieldHwEntityId = ITEM_0_31f;
