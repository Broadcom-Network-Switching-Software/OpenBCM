...
dbal_logical_table_t * table_info)
{
    ...
    
    {
        ...
        {
            dbal_db_field = &table_entry->multi_res_info[result_type_counter].results_info[field_index];
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_mandatory_values(unit, DBAL_FIELD_ZERO_PADDING_ARRAY , DBAL_FIELD_TYPE_DEF_ZERO_PADDING_ARRAY , dbal_db_field));
            dbal_db_init_table_field_params_init(&db_field);
    ...
    
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, "ETPS_AC" , sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
...
dbal_logical_table_t * table_info)
{
    ...
    
    {
        ...
        }
        {
            ...
            dbal_db_init_table_field_params_init(&db_field);
            db_field.size = 2;
            dbal_db_init_table_set_field_arr_prefix(unit, &db_field, dnx_data_arr.prefix.ETPP_ETPS_FORMATS___prefix_15_get(unit) , 8 );
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_optional_or_default_values(unit, table_entry, dbal_db_field, &db_field, FALSE));
            field_index += dbal_db_field->nof_instances;
        }
    ...
    
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, "ETPS_MPLS_1" , sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
