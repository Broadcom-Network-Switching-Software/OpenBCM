...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_ECGM_TM_PORT_TO_PORT_PROFILE_MAP , is_valid , "ECGM_TM_PORT_TO_PORT_PROFILE_MAP" , DBAL_ACCESS_METHOD_HARD_LOGIC ));
    ...
    
    {
        ...
        dbal_table_field_info_t * dbal_db_field;
        table_db_field_params_struct_t db_field;
        SHR_ALLOC_SET_ZERO(table_entry->keys_info, 2 * sizeof(dbal_table_field_info_t), "key fields info allocation", "%s%s%s\r\n", "ECGM_TM_PORT_TO_PORT_PROFILE_MAP" , EMPTY, EMPTY);
    ...
    
    {
        ...
        uint8 is_compatible_with_all_images = TRUE;
        DBAL_DB_INIT_TABLE_IMAGE_SPECIFIC_TABLE_INDICATION_SET(table_entry, is_standard_1, is_compatible_with_all_images);
        SHR_IF_ERR_EXIT(dbal_db_init_table_set_table_incompatible_image_sw_state_indication(unit, DBAL_TABLE_ECGM_TM_PORT_TO_PORT_PROFILE_MAP, is_standard_1, is_compatible_with_all_images));
    }
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_table_add(unit, cur_table_param, DBAL_TABLE_ECGM_TM_PORT_TO_PORT_PROFILE_MAP, table_info));
exit:
    SHR_FUNC_EXIT;
}
