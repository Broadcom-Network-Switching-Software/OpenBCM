...
dbal_logical_table_t * table_info)
{
    ...
    
    {
        ...
        dbal_table_field_info_t * dbal_db_field;
        table_db_field_params_struct_t db_field;
        SHR_ALLOC_SET_ZERO(table_entry->keys_info, 1 * sizeof(dbal_table_field_info_t), "key fields info allocation", "%s%s%s\r\n", "ETPP_TRAP_SNIF_MAP" , EMPTY, EMPTY);
...
dbal_logical_table_t * table_info)
{
    ...
    
    {
        ...
        dbal_table_field_info_t * dbal_db_field;
        table_db_field_params_struct_t db_field;
        SHR_ALLOC_SET_ZERO(table_entry->keys_info, 1 * sizeof(dbal_table_field_info_t), "key fields info allocation", "%s%s%s\r\n", "ETPP_TRAP_STRENGTH_MAP" , EMPTY, EMPTY);
        ...
        
        {
            ...
            
            {
                ...
                
                {
                    ...
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HW_ENTITY_GROUP_ETPP_MTU_MAP_TABLE , regMemHwEntityId , fieldHwEntityId , INVALIDm ));
                }
            }
        }
...
dbal_logical_table_t * table_info)
{
    ...
    
    {
        ...
        dbal_table_field_info_t * dbal_db_field;
        table_db_field_params_struct_t db_field;
        SHR_ALLOC_SET_ZERO(table_entry->keys_info, 1 * sizeof(dbal_table_field_info_t), "key fields info allocation", "%s%s%s\r\n", "ETPP_TRAP_MTU_LAYER_TYPE_MAP" , EMPTY, EMPTY);
        ...
        
        {
            ...
            
            {
                ...
                
                {
                    ...
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HW_ENTITY_GROUP_ETPP_PROTOCOL_TYPE_COMPRESSED_MAP , regMemHwEntityId , fieldHwEntityId , INVALIDm ));
                }
            }
        }
...
dbal_logical_table_t * table_info)
{
    ...
    
    {
        ...
        dbal_table_field_info_t * dbal_db_field;
        table_db_field_params_struct_t db_field;
        SHR_ALLOC_SET_ZERO(table_entry->keys_info, 1 * sizeof(dbal_table_field_info_t), "key fields info allocation", "%s%s%s\r\n", "ETPP_TRAP_LIF_ACTION_PROFILE" , EMPTY, EMPTY);
