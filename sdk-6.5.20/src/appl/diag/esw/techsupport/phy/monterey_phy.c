...
/* "phy" feature's diag command list valid only for Monterey */
char * techsupport_phy_monterey_diag_cmdlist[] = {
     "phy ce *",
     "phy xe *",
     "phy roe *",
     "phy ce *", /* repeat to get some of the sticky information. */
     "phy xe *",
     "phy roe *",
     "phy diag xe AN",
     "phy diag ce AN",
     "phy diag xe dsc all",
     "phy diag ce dsc all",
     "phy diag roe dsc all",
     "phy diag xe dsc all",  /* repeat DSC commands to show live status. */
     "phy diag ce dsc all",
     "phy diag roe dsc all",
...
/* "phy" feature's software dump command list valid only for Monterey */
char * techsupport_phy_monterey_sw_dump_cmdlist[] = {
    NULL /* Must be the last element in this structure */
};
 ...
 * "phy" feature for Monterey chipset. */
static soc_mem_t techsupport_phy_monterey_memory_table_list[] = {
   PORT_TABm,
   MAC_BLOCKm,
   VLAN_MACm,
   LINK_STATUSm,
 ...
 * "phy" feature for Monterey chipset. */
techsupport_reg_t techsupport_phy_monterey_reg_list[] = {
 ...
 * "phy" feature for Monterey chipset. */
techsupport_data_t techsupport_phy_monterey_data = {
    techsupport_phy_diag_cmdlist,
    techsupport_phy_monterey_reg_list,
    techsupport_phy_monterey_memory_table_list,
    techsupport_phy_monterey_diag_cmdlist
#ifndef BCM_SW_STATE_DUMP_DISABLE
    , techsupport_phy_sw_dump_cmdlist,
    techsupport_phy_monterey_sw_dump_cmdlist
#endif /* BCM_SW_STATE_DUMP_DISABLE */
};
