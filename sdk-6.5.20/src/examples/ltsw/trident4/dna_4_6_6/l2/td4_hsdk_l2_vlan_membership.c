 ...
 */
/*
 * Feature  : verify vlan membership check on TD4
 *
 * Usage    : BCM.0> cint td4_hsdk_vlan_membership.c
 *
 * config   : bcm56880_a0-generic-l2.config.yml
 *
 * Log file : td4_hsdk_vlan_membership_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
 ...
 * Summary:
 * ========
 * cint script to demonstrate vlan membership check on TD4
 *
