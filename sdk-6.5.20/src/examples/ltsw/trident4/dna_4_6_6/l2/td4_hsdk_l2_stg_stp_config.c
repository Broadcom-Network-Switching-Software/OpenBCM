 ...
 */
/*
 * Feature  : Verify vlan based STP,STG configuration on TD4
 *
 * Usage    : BCM.0> cint td4_hsdk_stg_stp_config.c
 *
 * config   : bcm56880_a0-generic-l2.config.yml
 *
 * Log file : td4_hsdk_stg_stp_config_log.txt
 *
 * Test Topology :
 *
 *
 * Summary:
 * ========
 * cint script to configure STP,STG on TD4
 *
