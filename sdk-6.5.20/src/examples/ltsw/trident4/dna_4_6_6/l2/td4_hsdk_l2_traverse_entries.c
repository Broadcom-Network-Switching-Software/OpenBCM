 ...
 */
/*
 * Feature  : L2 entries display using traverse function
 *
 * Usage    : BCM.0> cint td4_hsdk_l2_traverse_entries.c
 *
 * config   : bcm56880_a0-generic-l2.config.yml
 *
 * Log file : td4_hsdk_l2_traverse_entries_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
 ...
 * Summary:
 * ========
 * cint script to demonstrate L2 traverse function for entries present in L2 HOST TABLE
 *
