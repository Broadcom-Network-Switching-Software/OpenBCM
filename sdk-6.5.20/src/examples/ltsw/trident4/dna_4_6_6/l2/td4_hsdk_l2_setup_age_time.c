 ...
 */
/*
 * Feature  : L2 age function
 *
 * Usage    : BCM.0> cint td4_hsdk_l2_setup_age_time.c
 *
 * config   : bcm56880_a0-generic-l2.config.yml
 *
 * Log file : td4_hsdk_l2_setup_age_time_log.txt
 *
 * Test Topology :
 *
 *                      +-------------------+
 ...
 * Summary:
 * ========
 * cint script to demonstrate L2 age function with setup forwarding for ingress untagged
