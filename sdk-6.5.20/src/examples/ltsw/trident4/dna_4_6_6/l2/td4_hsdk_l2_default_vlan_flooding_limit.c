 ...
 */
/*
 * Feature  : Verifying vlan creation limit set by "vlan_flooding_l2mc_num_reserved" for vlan dlf flooding
 *
 * Usage    : BCM.0> cint td4_hsdk_l2_default_vlan_flooding_limit.c
 *
 * config   : bcm56880_a0-generic-default_vlan_flooding_config.yml
 *
 * Log file : td4_hsdk_l2_default_vlan_flooding_limit_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
 ...
 * Summary:
 * ========
 * cint script to demonstrate vlan creation limit set by "vlan_flooding_l2mc_num_reserved" config variable for vlan dlf flooding domain.
 *
