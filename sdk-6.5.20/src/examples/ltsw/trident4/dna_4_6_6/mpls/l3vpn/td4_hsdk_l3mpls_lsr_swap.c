 ...
 */
/*
 * Feature  : L3 MPLS LSR Label Swap functionality(BCM_MPLS_SWITCH_ACTION_SWAP)
 *
 * Usage    : BCM.0> cint td4_hsdk_l3mpls_lsr_swap.c
 *
 * config   : bcm56880_a0-generic-32x400.mpls-config.yml
 *
 * Log file : td4_hsdk_l3mpls_lsr_swap_log.txt
 *
 * Test Topology :
 *
 *                  +-------------------+
