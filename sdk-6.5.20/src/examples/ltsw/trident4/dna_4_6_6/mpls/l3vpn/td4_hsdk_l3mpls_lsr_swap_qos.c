 ...
 */
/*
 * Feature  : L3 MPLS LSR Label Swap functionality with EXP remarking
 *
 * Usage    : BCM.0> cint td4_hsdk_l3mpls_lsr_swap_qos.c
 *
 * config   : bcm56880_a0-generic-32x400.mpls-config.yml
 *
 * Log file : td4_hsdk_l3mpls_lsr_swap_qos_log.txt
 *
 * Test Topology :
 *
 *                  +-------------------+
 ...
 *   functionality long with label exp remarking
 *
 ...
 *   In Packet:
 *   ----------
 *   0000 0000 1303 0000 0000 00aa 8100 600c
 ...
 *   Out Packet:
 *   -----------
 *   0000 0000 2222 0000 0000 1111 8100 6016
...
verify(int unit)
{
    ...
    snprintf(str, 512, "tx 1 pbm=%d data=0x0000000013030000000000AA8100600C884700301140450000400000000040FF9B0B0A0A0A01C0A80A01000102030405060708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F202122232425262728292A2BE3128EDB; sleep quiet 3", ingress_port);
    bshell(unit, str);
    bshell(unit, "show c");
