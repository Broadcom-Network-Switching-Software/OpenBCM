...
/*
 * Feature  : TD4(56880) VPLS (L2 MPLS) tunnel initiation flow with port group
 *            inner VLAN ID as match criteria
 *            (BCM_MPLS_PORT_MATCH_PORT_GROUP_INNER_VLAN)
 *
 * Usage    : BCM.0> cint td4_hsdk_mpls_vpls_AtoN_MatchPortGroupInnerVlan.c
 *
 * config   : bcm56880_a0-generic-32x400.config.yml
 *
 * Log file : td4_hsdk_mpls_vpls_AtoN_MatchPortGroupInnerVlan_log.txt
 *
 * Test Topology :
 *
 *                    +-------------------+
 ...
 * Summary:
 * ========
 *   Cint script to demonstrate VPLS (L2 MPLS) tunnel initiation with port
 *   group & inner VLAN as match criteria.
 *
 ...
 *
 *      b) Transmit packets with VLAN-11/VLAN-31 and VLAN-11/VLAN-28 on
 *         ing_acc_port_1.
 *         The contents of the packet are printed on screen.
 *
 *      c) Expected Result:
 *      ===================
 *         We can see that customer packet with VLAN-11/VLAN-31 egress as VPLS
 *         tunnel packet on network port and packet with VLAN-11/VLAN-28
 *         dropped in ingress access port.
 *         'show c' & bcm_stat_get used to check the Tx/Rx packet
 *         stats/counters.
 *
 *   Ingress Packets : ing_acc_port_1
 *   0000 0000 0022 0000 0000 0011 8100 000b
 *   8100 001f 0800 4500 0036 0000 0000 40ff
 *   65ac 0a00 0014 0a00 000a 0001 0203 0405
 *   0607 0809 0a0b 0c0d 0e0f 1011 1213 1415
 *   1617 1819 1a1b 1c1d 1e1f 2021 2394 12f0
 *
 *   0000 0000 0022 0000 0000 0011 8100 000b
 *   8100 001c 0800 4500 0036 0000 0000 40ff
 *   65ac 0a00 0014 0a00 000a 0001 0203 0405
 *   0607 0809 0a0b 0c0d 0e0f 1011 1213 1415
 *   1617 1819 1a1b 1c1d 1e1f 2021 2394 12f0
 *
 ...
 *   8847 0011 1016 0044 4116 0000 0000 0022
 *   0000 0000 0011 8100 000b 8100 001f 0800
...
verify(int unit)
{
    ...
    snprintf(str, 512, "tx 1 pbm=%d data=0x0000000000220000000000118100000B8100001F0800450000360000000040FF65AC0A0000140A00000A000102030405060708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F2021239412F0; sleep quiet 3", ing_acc_port_1);
    bshell(unit, str);
    snprintf(str, 512, "tx 1 pbm=%d data=0x0000000000220000000000118100000B8100001C0800450000360000000040FF65AC0A0000140A00000A000102030405060708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F2021239412F0; sleep quiet 3", ing_acc_port_1);
    bshell(unit, str);
                     ...
                     l2vpn_acc_cfg_t *l2vpn_acc_cfg)
{
    ...
    acc_mpls_port.match_inner_vlan = l2vpn_acc_cfg->acc_inner_vlan;
...
setup_vpls(int unit)
{
	...
	l2vpn_acc_cfg_t l2vpn_acc_1 = {
        ...
        0x0,                       /* Access VP gport */
		11,                        /* Access VLAN */
        31,                        /* Access inner VLAN */
        "00:00:00:00:00:11",       /* HOST mac */
        "00:00:00:00:00:22",       /* Remote HOST mac */
        BCM_MPLS_PORT_MATCH_PORT_GROUP_INNER_VLAN, /* Access match criteria */
