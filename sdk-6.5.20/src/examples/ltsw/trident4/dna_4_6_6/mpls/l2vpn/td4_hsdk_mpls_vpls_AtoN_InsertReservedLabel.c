...
/*
 * Feature  : TD4(56880) VPLS (L2 MPLS) tunnel initiation flow with reserved/special
 *            label support
 *
 * Usage    : BCM.0> cint td4_hsdk_mpls_vpls_AtoN_InsertReservedLabel.c
 *
 * config   : bcm56880_a0-generic-32x400.mpls-config.yml
 *
 * Log file : td4_hsdk_mpls_vpls_AtoN_InsertReservedLabel_log.txt
 *
 * Test Topology :
 *
 *                    +-------------------+
 ...
 * Summary:
 * ========
 *   Cint script to demonstrate VPLS (L2 MPLS) tunnel initiation flow with
 ...
 *   0000 0000 0011 8100 00e6 0800 4500 0036
...
setup_vpls(int unit)
{
    ...
    special_label = l2vpn_net_1.vc_label_init;
    rv = mpls_insert_reserve_label(unit, special_label, l2vpn_net_1.exp, l2vpn_net_1.ttl);
    if (BCM_FAILURE(rv)) {
        printf("\nError in mpls_insert_reserved_label: %s.\n", bcm_errmsg(rv));
        return rv;
    }
    special_label = l2vpn_net_2.vc_label_init;
    rv = mpls_insert_reserve_label(unit, special_label, l2vpn_net_2.exp, l2vpn_net_2.ttl);
    if (BCM_FAILURE(rv)) {
        printf("\nError in mpls_insert_reserved_label: %s.\n", bcm_errmsg(rv));
        return rv;
    }
