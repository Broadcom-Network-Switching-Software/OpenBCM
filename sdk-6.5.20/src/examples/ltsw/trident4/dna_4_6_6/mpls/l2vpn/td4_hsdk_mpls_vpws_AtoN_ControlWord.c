 ...
 *            control word (BCM_MPLS_PORT_CONTROL_WORD)
 *
 * Usage    : BCM.0> cint td4_hsdk_mpls_vpws_AtoN_ControlWord.c
 *
 * config   : bcm56880_a0-generic-32x400.mpls-config.yml
 *
 * Log file : td4_hsdk_mpls_vpws_AtoN_ControlWord_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
 ...
 *   8847 0011 1010 0044 4110 0000 0000 0000
                          ...
                          bcm_if_t tunnel_id)
{
    ...
    net_mpls_port.flags =  BCM_MPLS_PORT_NETWORK | BCM_MPLS_PORT_ENCAP_WITH_ID | BCM_MPLS_PORT_CONTROL_WORD;
