 ...
 *            & VLAN as match criteria (BCM_MPLS_PORT_MATCH_PORT_GROUP_VLAN)
 *
 * Usage    : BCM.0> cint td4_hsdk_mpls_vpls_AtoN_MatchPortGroupVlan.c
 *
 * config   : bcm56880_a0-generic-32x400.config.yml
 *
 * Log file : td4_hsdk_mpls_vpls_AtoN_MatchPortGroupVlan_log.txt
 *
 * Test Topology :
 *
 *                    +-------------------+
 ...
 *
 *      b) Transmit packets with VLAN-11 and VLAN-6 on ing_acc_port_1.
 *         The contents of the packet are printed on screen.
 *
 *      c) Expected Result:
 *      ===================
 *         We can see that customer packet with VLAN-11 egress as VPLS tunnel
 *         packet on network port and packet with VLAN-6 dropped in ingress
 *         access port.
 ...
 *   0000 0000 0011 8100 000b 0800 4500 0036
