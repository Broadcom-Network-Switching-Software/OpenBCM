...
/*
 * Feature  : TD4(56880) VPLS (L2 MPLS) tunnel initiation unicast flow with
 *            port as match criteria
 *
 * Usage    : BCM.0> cint td4_hsdk_mpls_vpls_AtoN_MatchPort_uc.c
 *
 * config   : bcm56880_a0-generic-32x400.config.yml
 *
 * Log file : td4_hsdk_mpls_vpls_AtoN_MatchPort_uc_log.txt
 *
 * Test Topology :
 *
 *                    +-------------------+
 ...
 * Summary:
 * ========
 *   Cint script to demonstrate VPLS (L2 MPLS) tunnel initiation unicast flow
 *   with port as match criteria.
 *
 ...
 *
 *      b) Transmit the known unicast customer packet on ing_acc_port_1.
 *         The contents of the packet are printed on screen.
 *
 *      c) Expected Result:
 *      ===================
 *         We can see that VPLS tunnel packet out on network port 1 alone.
 ...
 *   0000 0000 0011 0800 4500 0036 0000 0000
