 ...
 */
/*
 * Feature  : VPWS (L2 MPLS) tunnel initiation flow with port as match
 *            criteria (BCM_MPLS_PORT_MATCH_PORT)
 *
 * Usage    : BCM.0> cint td4_hsdk_mpls_vpws_AtoN_MatchPort.c
 *
 * config   : bcm56880_a0-generic-32x400.mpls-config.yml
 *
 * Log file : td4_hsdk_mpls_vpws_AtoN_MatchPort_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
 ...
 * Summary:
 * ========
 * Cint script to demonstrate VPWS (L2 MPLS) tunnel initiation flow with port
 * as match criteria.
 *
