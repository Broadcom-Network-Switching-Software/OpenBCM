 ...
 */
/*
 * Feature  : L2 MPLS LSR Label Swap functionality
 *
 * Usage    : BCM.0> cint td4_hsdk_l2mpls_lsr_swap.c
 *
 * config   : bcm56880_a0-generic-32x400.mpls-config.yml
 *
 * Log file : td4_hsdk_l2mpls_lsr_swap_log.txt
 *
 * Test Topology :
 *
 *                  +-------------------+
 ...
 *   8847 1234 593f 0000 0000 0011 0000 0000
 *   0022 8100 000b 0800 4500 0036 0000 0000
 *   40ff 65ac 0a00 0014 0a00 000a 0001 0203
 *   0405 0607 0809 0a0b 0c0d 0e0f 1011 1213
 *   1415 1617 1819 1a1b 1c1d 1e1f 2021 2394
...
verify(int unit)
{
    ...
    snprintf(str, 512, "tx 1 pbm=%d data=0x0000000013030000000000AA8100000C8847003011400000000000110000000000228100000b0800450000360000000040ff65ac0a0000140a00000a000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f2021239412f0; sleep quiet 3", ingress_port);
    bshell(unit, str);
    bshell(unit, "show c");
    bshell(unit, "l2 show");
...
config_l2_mpls_lsr(int unit)
{
    ...
    l3_egress.mpls_label = 0x12345;
    l3_egress.mpls_exp = 0x4;
