 ...
 *            word sequence (BCM_MPLS_PORT_SEQUENCED)
 *
 * Usage    : BCM.0> cint td4_hsdk_mpls_vpls_AtoN_ControlWordSequence.c
 *
 * config   : bcm56880_a0-generic-32x400.config.yml
 *
 * Log file : td4_hsdk_mpls_vpls_AtoN_ControlWordSequence_log.txt
 *
 * Test Topology :
 *
 *                    +-------------------+
 ...
 *         network port with control word 00000001 (4-byte).
 ...
 *   8847 0011 1016 0044 4116 0000 0001 0000
                      ...
                      l2vpn_net_cfg_t *l2vpn_net_cfg)
{
    ...
    /* BCM_MPLS_PORT_SEQUENCED - pw_seq_number as control word */
    net_mpls_port.flags |= BCM_MPLS_PORT_SEQUENCED;
    net_mpls_port.pw_seq_number = 0x01;
