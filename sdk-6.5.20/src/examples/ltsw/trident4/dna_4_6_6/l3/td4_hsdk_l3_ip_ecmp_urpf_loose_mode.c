...
/*
 * Feature  : L3 IP Urpf Loose mode for ECMP
 *
 * Usage    : BCM.0> cint td4_hsdk_l3_ip_ecmp_urpf_loose_mode.c 
 *
 * config   : bcm56880_a0-generic-32x400.config.yml 
 *
 * Log file : td4_hsdk_l3_ip_ecmp_urpf_loose_mode_log.txt
 *
 * Test Topology :
 *
 *                    +------------------------------+          DMAC 0xfe02
 * ingress_port_1 cd0 |                              |          SMAC 0x02 and VLAN 13 
 * +------------------+ ECMP_1                       |          egress_port_1 cd2          
 * VLAN 11            |                              |        +-------------------+             
 * DMAC 0x1           |                              | ECMP_3 | DIP 10.58.66.115 
 * DIP 10.58.66.115   |          SWITCH-TD4          +--------+   
 * SIP_E 10.58.64.1   |                              |        | SIP 10.58.64.1 
 * SIP_U 10.58.96.1   |                              |        +-------------------+
 * VLAN 12            |                              |          egress_port_1 cd3 
 * +------------------+ ECMP_2                       |          DMAC 0xfe03
 * ingress_port_2 cd1 |                              |          SMAC 0x03 and VLAN 14
 *                    +------------------------------+
 *                                                                        
 * Summary:
 * ========
 *   This Cint example to show configuration of the IP Urpf Loose mode for ECMP
 *   BCM APIs.
 *
 ...
 *        four ports, two ports are used as ingress_ports and the other two ports as
 *        egress_ports.
 *
 ...
 *
 *      e) Create ingress interface with Losse mode and egress interface for ingress interface_1 
 *         and bind ingress interface with ingress vlan_1.
 *
 *      f) Create ingress interface with Losse mode and egress interface for ingress interface_2 
 *         and bind ingress interface with ingress vlan_2.
 *
 *      g) Create ingress interface with Losse mode and egress interface for egress interface 
 *         and bind ingress interface with egress vlan_1.
 *
 *      h) Create ingress interface with Losse mode and egress interface for egress interface
 *         and bind ingress interface with egress vlan_2.
 *
 *      i) Create egress object for ingress interface_1. 
 *
 *      j) Create egress object for ingress interface_2. 
 *
 *      k) Create egress object for egress interface_1. 
 *
 *      l) Create egress object for egress interface_2.
 *
 *      m) Create ECMP object for ingress inteface_1 with egress object_1 as member.
 * 
 *      n) Create ECMP object for ingress inteface_2 with egress object_2 as member.
 *
 *      o) Create ECMP object for egress inteface with two egress objects as members.
 *
 *      p) Add host for SIP with ingress ECMP object_1.
 *
 *      q) Add host for DIP with egress ECMP object.
 *
 *      r) Create station MAC entry for L3 forwarding.
 *
...
/*
 * Configure IP Urpf Loose mode functionality.
 */
int
configure_ip_urpf_mode(int unit)
{
  ...
  bcm_vlan_t      egress_vlan_1 = 13;
  bcm_vlan_t      egress_vlan_2 = 14;
  bcm_vrf_t       vrf = 1;
  ...
  bcm_mac_t       router_mac_out_2 = {0x00, 0x00, 0x00, 0x00, 0x00, 0x04};
  bcm_mac_t       mac_in_1 = {0x00, 0x00, 0x00, 0x00, 0xfe, 0x01};
  bcm_mac_t       mac_in_2 = {0x00, 0x00, 0x00, 0x00, 0xfe, 0x03};
  bcm_mac_t       mac_out_1 = {0x00, 0x00, 0x00, 0x00, 0xfe, 0x02};
  bcm_mac_t       mac_out_2 = {0x00, 0x00, 0x00, 0x00, 0xfe, 0x04};
  ...
  bcm_if_t        l3_egr_if_out_1 = 300;
  bcm_if_t        l3_egr_if_out_2 = 400;

  bcm_if_t        ingress_if_in_1 = 100;
  bcm_if_t        ingress_if_in_2 = 200;
  bcm_if_t        ingress_if_out_1 = 300;
  bcm_if_t        ingress_if_out_2 = 400;

  bcm_l3_intf_t    l3_intf_in_1;
  bcm_l3_intf_t    l3_intf_in_2;
  bcm_l3_intf_t    l3_intf_out_1;
  bcm_l3_intf_t    l3_intf_out_2;
  ...
  bcm_if_t                ecmp_obj_in_1;
  bcm_if_t                ecmp_obj_in_2;
  ...
  /* Add egress port member of egress vlan_1 */
  ...
  /* Add egress port member of egress vlan_2 */
  ...
  bcm_l3_intf_t_init(&l3_intf_out_1);
  l3_intf_out_1.l3a_flags   = BCM_L3_WITH_ID;
  l3_intf_out_1.l3a_intf_id = l3_egr_if_out_1;
  l3_intf_out_1.l3a_vid     = egress_vlan_1;
  sal_memcpy(l3_intf_out_1.l3a_mac_addr, router_mac_out_1, sizeof(router_mac_out_1));
  rv = bcm_l3_intf_create(unit, &l3_intf_out_1);
  if (BCM_FAILURE(rv)) {
      printf("Error executing bcm_l3_intf_create(): %s.\n", bcm_errmsg(rv));
      return rv;
  }
  ...
  bcm_l3_intf_t_init(&l3_intf_out_2);
  l3_intf_out_2.l3a_flags   = BCM_L3_WITH_ID;
  l3_intf_out_2.l3a_intf_id = l3_egr_if_out_2;
  l3_intf_out_2.l3a_vid     = egress_vlan_2;
  sal_memcpy(l3_intf_out_2.l3a_mac_addr, router_mac_out_2, sizeof(router_mac_out_2));
  rv = bcm_l3_intf_create(unit, &l3_intf_out_2);
  if (BCM_FAILURE(rv)) {
      printf("Error executing bcm_l3_intf_create(): %s.\n", bcm_errmsg(rv));
      return rv;
  }
  ...
  l3_ingress.vrf       = vrf;
  l3_ingress.urpf_mode = bcmL3IngressUrpfLoose; /* IP URPF Loose mode */
  ...
  /* Create L3 ingress interface for egress interface with same l3_egr_if_out_1 & ingress_if_out_1 */
  bcm_l3_ingress_t_init(&l3_ingress);
  l3_ingress.flags     = BCM_L3_INGRESS_WITH_ID;
  l3_ingress.vrf       = vrf;
  l3_ingress.urpf_mode = bcmL3IngressUrpfLoose; /* IP URPF Loose mode */ 
  rv = bcm_l3_ingress_create(unit, &l3_ingress, &ingress_if_out_1);
  if (BCM_FAILURE(rv)) {
      printf("Error executing bcm_l3_ingress_create(): %s.\n", bcm_errmsg(rv));
      return rv;
  }

  /* Config egress vlan_1 to L3_IIF binding */
  bcm_vlan_control_vlan_t_init(&vlan_ctrl);
  vlan_ctrl.ingress_if = ingress_if_out_1;
  rv = bcm_vlan_control_vlan_selective_set(unit, egress_vlan_1, BCM_VLAN_CONTROL_VLAN_INGRESS_IF_MASK, &vlan_ctrl);
  if (BCM_FAILURE(rv)) {
      printf("Error executing bcm_vlan_control_vlan_selective_set(): %s.\n", bcm_errmsg(rv));
      return rv;
  }

  /* Create L3 ingress interface for egress interface with same l3_egr_if_out_2 & ingress_if_out_2 */
  bcm_l3_ingress_t_init(&l3_ingress);
  l3_ingress.flags     = BCM_L3_INGRESS_WITH_ID;
  l3_ingress.vrf       = vrf;
  l3_ingress.urpf_mode = bcmL3IngressUrpfLoose; /* IP URPF Loose mode */
  rv = bcm_l3_ingress_create(unit, &l3_ingress, &ingress_if_out_2);
  if (BCM_FAILURE(rv)) {
      printf("Error executing bcm_l3_ingress_create(): %s.\n", bcm_errmsg(rv));
      return rv;
  }

  /* Config egress vlan_2 to L3_IIF binding */
  bcm_vlan_control_vlan_t_init(&vlan_ctrl);
  vlan_ctrl.ingress_if = ingress_if_out_2;
  rv = bcm_vlan_control_vlan_selective_set(unit, egress_vlan_2, BCM_VLAN_CONTROL_VLAN_INGRESS_IF_MASK, &vlan_ctrl);
  if (BCM_FAILURE(rv)) {
      printf("Error executing bcm_vlan_control_vlan_selective_set(): %s.\n", bcm_errmsg(rv));
      return rv;
  }
  ...
  /* Create ECMP object for ingress interface_1 */
  bcm_l3_ecmp_member_t_init(&ecmp_member_array[0]);
  ecmp_member_array[0].egress_if = egr_obj_in_1;

  bcm_l3_egress_ecmp_t_init(&ecmp_grp);
  ecmp_grp.max_paths = 64;  /* MAX members allowed for this group */
  rv = bcm_l3_ecmp_create(unit, 0, &ecmp_grp, 1, ecmp_member_array);
  if (BCM_FAILURE(rv)) {
      printf("Error executing bcm_l3_ecmp_create(): %s.\n", bcm_errmsg(rv));
      return rv;
  }
  ecmp_obj_in_1 = ecmp_grp.ecmp_intf;
  print ecmp_obj_in_1;

  /* Create ECMP object for ingress interface_2 */
  bcm_l3_ecmp_member_t_init(&ecmp_member_array[0]);
  ecmp_member_array[0].egress_if = egr_obj_in_2;
  ...
  ecmp_obj_in_2 = ecmp_grp.ecmp_intf;
  print ecmp_obj_in_2;
  ...
  bcm_l3_egress_ecmp_t_init(&ecmp_grp);
  ecmp_grp.max_paths = 64;  /* MAX members allowed for this group */
  rv = bcm_l3_ecmp_create(unit, 0, &ecmp_grp, 2, ecmp_member_array);
  if (BCM_FAILURE(rv)) {
      printf("Error executing bcm_l3_ecmp_create(): %s.\n", bcm_errmsg(rv));
      return rv;
  }
