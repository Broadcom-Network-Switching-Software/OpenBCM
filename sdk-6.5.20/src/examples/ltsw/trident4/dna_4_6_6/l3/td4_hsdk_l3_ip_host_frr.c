...
/*
 * Feature  : L3 IPv4 host entry protection path
 *
 * Usage    : BCM.0> cint td4_hsdk_l3_ip_host_frr.c 
 *
 * config   : bcm56880_a0-generic-l3.config.yml  
 *
 * Log file : td4_hsdk_l3_ip_host_frr_log.txt
 *
 * Test Topology :
 *
 *                   +------------------------------+
 ...
 * Summary:
 * ========
 *   This Cint example to show configuration of the IPv4 host with failover
 ...
 *
 *   2) Step2 - Configuration (Done in config_l3_ipv4_host_frr()):
 *   ==============================================================
 ...
 *
 *      g) Add host entry for DIP by primary L3 egress object.
 *
 ...
 *        'l3 intf show', 'l3 egress show', 'l3 host show'.
 *
...
config_l3_host_frr(int unit)
{
  ...
  host.l3a_intf     = l3_egr_id_primary;
  host.l3a_vrf      = vrf;
 ...
 *  a) test setup
 *  b) actual configuration (Done in config_l3_ipv4_host_frr())
...
execute(void)
{
    ...
    print "~~~ #2) config_l3_host_frr(): ** start **";
    if (BCM_FAILURE((rv = config_l3_host_frr(unit)))) {
        printf("config_l3_host_frr() failed.\n");
        return -1;
    }
    print "~~~ #2) config_l3_host_frr(): ** end **";
