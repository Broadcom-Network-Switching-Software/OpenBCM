...
/*
 * Feature  : L3 IPv4 host entry
 *
 * Usage    : BCM.0> cint td4_hsdk_l3_ipuc_ipv4_host_L3DstMiscClassId.c 
 *
 * config   : bcm56880_a0-generic-l3.config.yml 
 *
 * Log file : td4_hsdk_l3_ipuc_ipv4_host_L3DstMiscClassId.txt
 *
 * Test Topology :
 *
 *                  +------------------------------+
 ...
 * Summary:
 * ========
 *   This Cint example to demo L3DstMiscClassId concep with host route.
 *
 ...
 *        egress_port.
 *
 *     b) Install an IFP rule along with L3DstMiscClassId qualifier to copy incoming and outgoing packets 
 *       to CPU and start packet watcher to display packet contents.
 *
 *
 ...
 *       stats/counters. Also IFP rule with L3DstMiscClassId was hit and copied to CPU
 *       wih reason code as IFP.
 */
...
ingress_port_setup(int unit, bcm_port_t port)
{
   ...
   /* Qualify MiscClassId from host table */
    BCM_FIELD_QSET_ADD(group_config.qset, bcmFieldQualifyL3DstMiscClassId);
   ...
   /* Qualify host.l3a_opaque_ctrl_id configured in host entry */
    BCM_IF_ERROR_RETURN(bcm_field_qualify_L3DstMiscClassId(unit, entry, 6, 0x7));
...
configure_host(int unit, bcm_ip_t ip_address, bcm_if_t egr_if, bcm_vrf_t vrf)
{
    ...
    host.l3a_vrf     = vrf;
    /* Configure opaque_ctrl_id which can be qualifed as 
     * bcmFieldQualifyL3DstMiscClassId at IFP */
    host.l3a_opaque_ctrl_id = 6;
