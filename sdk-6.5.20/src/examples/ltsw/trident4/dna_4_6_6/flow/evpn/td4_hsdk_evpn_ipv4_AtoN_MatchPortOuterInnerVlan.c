...
/*
 * Feature  : TD4(56880) Vxlan EVPN Bridging, IPv4 access to network tunnel
 *            initiation flow with PORT + OUTER VLAN + INNER VLAN as a flow
 *            match criteria.
 *
 * Usage    : BCM.0> cint Wtd4_hsdk_evpn_ipv4_AtoN_MatchPortOuterInnerVlan.c
 *
 * config   : bcm56880_a0-generic-32x400.config.yml
 *
*  Log file : td4_hsdk_evpn_ipv4_AtoN_MatchPortOuterInnerVlan_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
 ...
 *
 *
 *   On Trident-4 (DNA_4_4_11), ingress interface at access side is represented
 *   by L2 interface.
