 ...
 *            termination flow for UUC/BC/UMC.
 *
 * Usage    : BCM.0> cint td4_hsdk_evpn_ipv4_NtoA_umc.c
 *
 * config   : bcm56880_a0-generic-32x400.config.yml
 *
 * Log file : td4_hsdk_evpn_ipv4_NtoA_umc_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
 ...
 *             - network to access(decap flow) UUC/BC/UMC traffic
 *
 ...
 *
 *     b) Transmit the unknown multicast packet. The contents of the packet
...
Packet Dump:
data[0000]: 0100 5e01 0103 0000 0000 eeee 8100 0015
...
verify(int unit)
{
	...
	snprintf(str, 512, "tx 1 pbm=%d data=; sleep quiet 1", ing_net_port_1);
	bshell(unit, str);
	bshell(unit, "show c");
