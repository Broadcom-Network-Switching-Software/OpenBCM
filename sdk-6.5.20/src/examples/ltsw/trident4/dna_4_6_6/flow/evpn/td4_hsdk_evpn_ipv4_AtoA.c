...
/*
 * Feature  : TD4(56880) Vxlan EVPN Bridging, IPv4 access to access flow.
 *
 * Usage    : BCM.0> cint td4_hsdk_evpn_ipv4_AtoA.c
 *
 * config   : bcm56880_a0-generic-32x400.config.yml
 *
 * Log file : td4_hsdk_evpn_ipv4_AtoA_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
 ...
 *
 *     b) Transmit the known unicast, known multicast, unknown unicas,
