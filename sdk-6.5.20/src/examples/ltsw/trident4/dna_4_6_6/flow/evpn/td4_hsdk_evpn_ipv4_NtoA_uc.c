 ...
 *            termination flow for unicast traffic.
 *
 * Usage    : BCM.0> cint td4_hsdk_evpn_ipv4_NtoA_uc.c
 *
 * config   : bcm56880_a0-generic-32x400.config.yml
 *
 * Log file : td4_hsdk_evpn_ipv4_NtoA_uc_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
 ...
 *             - network to access(decap flow) known unicast traffic
 *
