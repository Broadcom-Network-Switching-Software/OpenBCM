...
/*
 * Feature  : TD4(56880) Vxlan Bridging Bud mode: 
 ...
 *
 *
 * Usage    : BCM.0> cint td4_hsdk_vxlan_gbp_ipv4_NtoA_bud_pass1_ifp.c
 *
 * config   : bcm56880_a0-generic-32x400.config_lb.yml
 *
 * Log file : td4_hsdk_vxlan_gbp_ipv4_NtoA_bud_pass1_ifp.c
 *
 * Test Topology :
 *
 *                                  +----------------------+
