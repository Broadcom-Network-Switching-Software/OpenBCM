...
/*
 * Feature  : TD4(56880) Vxlan Bridging, access to network unknown multicast IPv4 tunnel initiation
 *            with Vxlan GBP-SID assignment in FP exact match entry
 *
 * Usage    : BCM.0> cint td4_hsdk_vxlan_gbp_ipv4_AtoN_mc_em_fp.c
 *
 * config   : bcm56880_a0-generic-32x400.config_em.yml
 *
 * Log file : td4_hsdk_vxlan_gbp_ipv4_AtoN_mc_em_fp_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
