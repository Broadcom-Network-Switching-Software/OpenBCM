 ...
 *
 * Usage    : BCM.0> cint td4_hsdk_vxlan_gbp_ipv4_NtoA_mc_l3.c
 *
 * config   : bcm56880_a0-generic-32x400.config_em.yml
 *
 * Log file : td4_hsdk_vxlan_gbp_ipv4_NtoA_mc_l3_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
 ...
 *
 *     b) Transmit the known unicast VxLAN packet with valid GBP-SID and IPMC payload. The contents of the packet
 *        are printed on screen.
 *        As GBP match occurs, decapsulated packet should successfully egress out after hitting IPMC entry.
 *
