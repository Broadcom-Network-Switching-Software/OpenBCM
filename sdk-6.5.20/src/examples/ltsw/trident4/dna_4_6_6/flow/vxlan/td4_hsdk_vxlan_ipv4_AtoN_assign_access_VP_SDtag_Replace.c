...
/*
 * Feature  : TD4(56880) Vxlan Bridging , IPv4 access to network tunnel initiation Flow,
 *            replace sdtag in payload while egressing on network port
 *
 * Usage    : BCM.0> cint td4_hsdk_vxlan_ipv4_AtoN_assign_access_VP_SDtag_Replace.c
 *
 * config   : bcm56880_a0-generic-32x400_vxlan.config.yml
 *
 * Log file : td4_hsdk_vxlan_ipv4_AtoN_assign_access_VP_SDtag_Replace_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
 ...
 * Summary:
 * ========
 *   Cint example to demonstrate replacing SDtag in payload for VXLAN IPv4 tunnel
 *   initiation flow(i.e access to network flow)
 ...
 *       and vlan tag is replaced in payload.
 */
...
[bcmPWN.0]Packet[2]: data[0040]: bbbb 8100 0064 0800 4500 002e 0000 0000 <<< VLAN is replaced with 100.
