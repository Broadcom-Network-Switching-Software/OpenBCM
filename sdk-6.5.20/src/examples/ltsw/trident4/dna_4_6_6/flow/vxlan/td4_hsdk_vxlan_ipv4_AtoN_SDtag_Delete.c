...
/*
 * Feature  : TD4(56880) Vxlan Bridging , IPv4 access to network tunnel initiation Flow, delete sd tag in payload while egressing on network port
 *
 * Usage    : BCM.0> cint TD4_HSDK_VxLAN_ipv4_AtoN_SDtag_Delete.c
 *
 * config   : bcm56880_a0-generic-32x400_vxlan.config.yml
 *
 * Log file : TD4_HSDK_VxLAN_ipv4_AtoN_SDtag_Delete_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
 ...
 *   0800 4500 0064 0000 0000 3f11 a5d5 0a0a 
 *   0a01 c0a8 0101 c000 12b5 0050 0000 0800 
 *   0000 0123 4500 0000 0000 aaaa 0000 0000 
 *   bbbb 0800 4500 002e 0000 0000 4011 74ba 
 *   0101 0101 0202 0202 0035 0036 001a b0f8 
