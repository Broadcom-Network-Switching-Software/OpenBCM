...
/*
 * Feature  : TD4(56880) Vxlan Bridging , IPv4 access to network tunnel initiation Flow, add sd tag (100) in payload while egressing on network port
 *
 * Usage    : BCM.0> cint TD4_HSDK_VxLAN_ipv4_AtoN_SDtag_Add.c
 *
 * config   : bcm56880_a0-generic-32x400_vxlan.config.yml
 *
 * Log file : TD4_HSDK_VxLAN_ipv4_AtoN_SDtag_Add_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
