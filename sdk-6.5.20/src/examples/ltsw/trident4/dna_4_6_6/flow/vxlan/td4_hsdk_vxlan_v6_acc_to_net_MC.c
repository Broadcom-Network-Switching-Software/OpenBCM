...
/*
 * Feature  : TD4(56880) Vxlan Bridging ,  access to  network known & unknown multicast Flow
 *  with port+vlan as a flow match criteria
 *
 * Usage    : BCM.0> cint TD4_HSDK_VXLAN_v6_acc_to_net_MC.c
 *
 * config   : bcm56880_a0-generic-32x400.config.yml
 *
 * Log file : TD4_HSDK_VXLAN_v6_acc_to_net_MC_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
