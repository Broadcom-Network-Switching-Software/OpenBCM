 ...
 *
 * Usage    : BCM.0> cint TD4_HSDK_ipv4_riot_AtoN_uc_DSCP_remark.c
 *
 * config   : bcm56880_a0-generic-32x400.config.yml
 *
 * Log file : TD4_HSDK_ipv4_riot_AtoN_uc_DSCP_remark_logs.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
...
data[0040]: 0101 0800 451c 002e 0000 0000 3fff db62 
...
*
*...0800 451c 002e...  DSCP is remarked as 7.
*/
...
/* Create DSCP PROFILE to remark DSCP */
