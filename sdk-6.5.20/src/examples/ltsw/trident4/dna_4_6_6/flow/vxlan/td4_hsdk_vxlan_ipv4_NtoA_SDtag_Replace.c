...
/*
 * Feature  : TD4(56880) Vxlan Bridging , IPv4 network to access tunnel termination flow, replace the payload outer vlan tag while egressing on access port
 *
 * Usage    : BCM.0> cint TD4_HSDK_VxLAN_ipv4_NtoA_SDtag_Replace.c
 *
 * config   : bcm56880_a0-generic-32x400_vxlan.config.yml
 *
 * Log file : TD4_HSDK_VxLAN_ipv4_NtoA_SDtag_Replace_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
