 ...
 * Log file : TD4_HSDK_EBST_queue_mode_ucq_test.log
 *
 ...
 *   - TM_EBST_DATA
 * 
 * Test Method (UC Case): Apply the following scripts one by one in sequence:
 *   1. TD4_HSDK_EBST_queue_mode.c
 *   2. TD4_HSDK_EBST_test_run_uc.c
 *   3. TD4_HSDK_EBST_checker_ucq.c 
