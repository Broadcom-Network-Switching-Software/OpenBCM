 ...
 *            using vlan translate table(ING_VLAN_XLATE_1_TABLE)
 *
 * Usage    : BCM.0> cint td4_hsdk_vlan_vfi_from_port_ovid.c
 *
 * config   : bcm56880_a0-generic-vlan.config.yml
 *
 * Log file : td4_hsdk_vlan_vfi_from_port_ovid_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
...
vlan_xlate_entry_setup(int unit,bcm_gport_t port,bcm_vlan_t outer_vlan, bcm_vlan_t fwd_vfi)
{
    ...
    action.outer_tag = bcmVlanActionNone;  /* preserve outer tag */
