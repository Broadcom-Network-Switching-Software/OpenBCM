 ...
 */
/*
 * Feature  : Verify egress vlan membership check on TD4
 *
 * Usage    : BCM.0> cint td4_hsdk_vlan_egress_membership_check.c
 *
 * config   : bcm56880_a0-generic-vlan.config.yml
 *
 * Log file : td4_hsdk_vlan_egress_membership_check_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
 ...
 * Summary:
 * ========
 * cint script to demonstrate egress vlan membership check on TD4
 *
