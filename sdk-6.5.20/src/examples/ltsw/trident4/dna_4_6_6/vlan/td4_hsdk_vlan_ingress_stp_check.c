 ...
 */
/*
 * Feature  : Verify vlan based ingress STP checks on TD4
 *
 * Usage    : BCM.0> cint td4_hsdk_vlan_ingress_stp_check.c
 *
 * config   : bcm56880_a0-generic-vlan.config.yml
 *
 * Log file : td4_hsdk_vlan_ingress_stp_check_log.txt
 *
 * Test Topology :
 *                      +-------------------+
 *                      |                   |
 ...
 * Summary:
 * ========
 * cint script to verify vlan based ingress STP config on TD4
 *
