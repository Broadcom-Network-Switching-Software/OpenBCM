 ...
 *
 * Usage    : BCM.0> cint TD4_HSDK_Mirror_add_Vxlan_Encapsulation.c
 *
 * config   : bcm56880_a0-generic-32x400.config.yml
 *
 * Log file : TD4_HSDK_Mirror_add_Vxlan_Encapsulation_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
...
verify(int unit)
{
    ...
    bshell(unit, "clear c");
    printf("\n\n\nSending to ingress_port %d, packet will be forwarded to port %d and mirrored out from port %d in vxlan format\n", ingress_port, egress_port, mtp_port);
    snprintf(str, 512, "tx 1 pbm=%d data=;  sleep quiet 3", ingress_port);
