...
/*
 * Feature  : TD3(56870) Vxlan Bridging ,  access to network tunnel initiation(ipv6 tunnel) Flow with port+vlan as a flow match criteria
 *
 * Usage    : BCM.0> cint ipv6_AtoN_UC_MatchPortVlan.c
 *
 * config   : BCM56275_A1-BRIDGE-FLEXFLOW.bcm
 *
 * Log file : ipv6_AtoN_UC_MatchPortVlan_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
...
data[0010]: 86dd 6240 0000 006e 113f 0101 0101 3500
data[0020]: 7000 0000 1009 0807 0605 0202 0202 3600
data[0030]: 7000 0000 0102 0304 0506 ffff 2118 006e
data[0040]: 0000 0000 0000 0123 4500 0000 0000 aaaa
...
data[00a0]: 7465 7374 7465 7374 6370 5a58
