 ...
 *            with default network SVP assignment
 *
 * Usage    : BCM.0> cint ipv4_NtoA_net_default_SVP.c
 *
 * config   : BCM56277_A1-PORT-FLEXFLOW.bcm
 *
 * Log file : ipv4_NtoA_net_default_SVP_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
...
/*
*   We are assigning the default SVP and do not setup the SIP lookup
