...
/*  Feature  : Usage of HINT APIs in Hurricane4 style FP
 *
 ...
 * Summary:
 *  ========
 *      Cint example to show configuration of Hurricane4 IFP using BCM APIs.
 ...
 *      for Hurricane4. It shows extracting the user specified number of bits in
