 ...
 */
/*
 Test Setup: TH3 in 64x100G (NRZ) mode
 external loopback to connect ce6(7)<-> ce28(64), ce7(8) <-> ce29(65)
 */
...
bshell(0, "tx 1000 length=512 dm=0x2 vlanprio=4 vlantag=1");
bshell(0, "tx 1000 length=512 dm=0x2 vlanprio=5 vlantag=1");
bshell(0, "tx 1000 length=512 dm=0x2 vlanprio=6 vlantag=1");
bshell(0, "tx 1000 length=512 dm=0x2 vlanprio=7 vlantag=1");
bshell (0, "sleep 1");
