...
/* Change scheduler to have 6UC+6MC queues for each port*/
bshell(0, "config add mmu_port_num_mc_queue=3");
bshell(0, "rc");
...
cosq_mapping_arr[2].strict_priority=1;
cosq_mapping_arr[2].fc_is_uc_only=1;
cosq_mapping_arr[3].cosq=3;
cosq_mapping_arr[3].num_ucq=1;
cosq_mapping_arr[3].num_mcq=1;
cosq_mapping_arr[3].strict_priority=1;
...
config_array1[2].pfc_optimized = 1;
...
config_array1[6].cos_list_bmp |= 1 << 0;
config_array1[6].pfc_optimized = 0;
config_array1[7].pfc_enable = 1;
config_array1[7].cos_list_bmp |= 1 << 0;
...
/*
   Table 5-5 of Queue Model mapping doc
 Cos    MMUQ0    MMUQ1    FC_UC    SP    PFC_opt    EB_grp(cos)  EB_group0  EB_group1  SP(0)  SP(1)
  5       5      11         0      1       0           8           8          8         1      1
  4       4      10         0      1       1           7           7          7         1      1
  3       3       9         0      1       0           6           6          6         1      1
  2       2       8         1      1       2           5           5          4         1      0
  1       1       7         0      0       0           4           4          4         0      0
  0       0       6         0      0       0           3           3          3         0      0
...
/* Enable PFC receive and transmit on the PFC partners */
print bcm_port_control_set(0, tx_port2, bcmPortControlPFCTransmit, 1);
print bcm_port_control_set(0, rx_port2, bcmPortControlPFCReceive, 1);
...
cosq_mapping_arr[4].num_mcq=1;
cosq_mapping_arr[4].strict_priority=1;
cosq_mapping_arr[4].fc_is_uc_only=1;
cosq_mapping_arr[5].cosq=5;
cosq_mapping_arr[5].num_ucq=1;
cosq_mapping_arr[5].num_mcq=1; 
cosq_mapping_arr[5].strict_priority=1;
...
config_array1[2].pfc_optimized = 1;
config_array1[3].pfc_enable = 1;
config_array1[3].cos_list_bmp |= (1 << 3 | 1 <<4);
config_array1[3].pfc_optimized = 1;
config_array1[4].pfc_enable = 1;
config_array1[4].cos_list_bmp |= (1 << 4 | 1 <<3);
config_array1[4].pfc_optimized = 1;
config_array1[5].pfc_enable = 1;
config_array1[5].cos_list_bmp |= 1 << 5;
config_array1[5].pfc_optimized = 0;
...
/* Map rx_port to use profile 1*/
print bcm_cosq_port_profile_set(0, rx_port2, bcmCosqProfilePFCAndQueueHierarchy,
        profile_id);

/*
   Table 5-7 example in Queue Mappig Model doc
 Cos    MMUQ0    MMUQ1    FC_UC    SP    PFC_opt    EB_grp(cos)  EB_group0  EB_group1  SP(0)  SP(1)
  5       5      11         0      1       0           8           8          8         1      1
  4       4      10         1      1       1           7           7          5         1      0
  3       3       9         1      1       1           7           7          5         1      0
  2       2       8         0      1       2           6           6          6         1      1
  1       1       7         0      0       0           5           5          5         0      0
  0       0       6         0      0       0           4           4          4         0      0
 */
