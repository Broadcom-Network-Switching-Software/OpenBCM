...
knet_setup(int unit)
{
    ...
    printf("DONE; don't forget \"ifconfig virt-intf 192.168.2.254 netmask 255.255.255.0 up\"\n");
    return rv;
}
...
void verify(int unit)
{
    ...
    printf("2. Configure IP address to knet interface \"ifconfig virt-intf 192.168.2.254 netmask 255.255.255.0 up\" \n");
