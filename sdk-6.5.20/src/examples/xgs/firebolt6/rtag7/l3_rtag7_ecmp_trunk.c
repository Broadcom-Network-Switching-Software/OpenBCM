...
bcm_port_t      Egress_port_1_1 = 22,Egress_port_1_2 = 23,Egress_port_1_3 = 24;
bcm_port_t      Egress_port_2_1 = 25,Egress_port_2_2 = 26,Egress_port_2_3 = 27;
...
bcm_error_t test_setup(int unit)
{
  ...
  BCM_IF_ERROR_RETURN(bcm_port_loopback_set(unit, Egress_port_1_1, BCM_PORT_LOOPBACK_MAC));
  BCM_IF_ERROR_RETURN(bcm_port_discard_set(unit, Egress_port_1_1, BCM_PORT_DISCARD_ALL));

  sprintf(cmd, "dmirror %d mode=ingress dp=cpu0 dm=0",  Egress_port_1_1); bshell(unit, cmd);


  BCM_IF_ERROR_RETURN(bcm_port_loopback_set(unit, Egress_port_1_2, BCM_PORT_LOOPBACK_MAC));
  BCM_IF_ERROR_RETURN(bcm_port_discard_set(unit, Egress_port_1_2, BCM_PORT_DISCARD_ALL));

  sprintf(cmd, "dmirror %d mode=ingress dp=cpu0 dm=0",  Egress_port_1_2); bshell(unit, cmd);


  BCM_IF_ERROR_RETURN(bcm_port_loopback_set(unit, Egress_port_1_3, BCM_PORT_LOOPBACK_MAC));
  BCM_IF_ERROR_RETURN(bcm_port_discard_set(unit, Egress_port_1_3, BCM_PORT_DISCARD_ALL));

  sprintf(cmd, "dmirror %d mode=ingress dp=cpu0 dm=0",  Egress_port_1_3); bshell(unit, cmd);


  BCM_IF_ERROR_RETURN(bcm_port_loopback_set(unit, Egress_port_2_1, BCM_PORT_LOOPBACK_MAC));
  BCM_IF_ERROR_RETURN(bcm_port_discard_set(unit, Egress_port_2_1, BCM_PORT_DISCARD_ALL));

  sprintf(cmd, "dmirror %d mode=ingress dp=cpu0 dm=0",  Egress_port_2_1); bshell(unit, cmd);


  BCM_IF_ERROR_RETURN(bcm_port_loopback_set(unit, Egress_port_2_2, BCM_PORT_LOOPBACK_MAC));
  BCM_IF_ERROR_RETURN(bcm_port_discard_set(unit, Egress_port_2_2, BCM_PORT_DISCARD_ALL));

  sprintf(cmd, "dmirror %d mode=ingress dp=cpu0 dm=0",  Egress_port_2_2); bshell(unit, cmd);


  BCM_IF_ERROR_RETURN(bcm_port_loopback_set(unit, Egress_port_2_3, BCM_PORT_LOOPBACK_MAC));
  BCM_IF_ERROR_RETURN(bcm_port_discard_set(unit, Egress_port_2_3, BCM_PORT_DISCARD_ALL));

  sprintf(cmd, "dmirror %d mode=ingress dp=cpu0 dm=0",  Egress_port_2_3); bshell(unit, cmd);
