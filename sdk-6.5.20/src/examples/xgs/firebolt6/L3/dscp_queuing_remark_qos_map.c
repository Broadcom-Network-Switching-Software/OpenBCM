 ...
 *
 * Usage    : BCM.0> cint dscp_queuing_remark_qos_map.c
 *
 * config   : l3_config.bcm
 *
 * Log file : dscp_queuing_remark_qos_map_log.txt
 *
 * Test Topology :
 *
 *                  +------------------------------+
                             ...
                             bcm_vlan_t ing_vlan, bcm_vlan_t egr_vlan)
{
    ...
    int station_id = 0;
    int ing_qos_id;
    uint8 srccp = 63, mapcp = 10, int_pri = 4; /* pkt_dscp, new_dscp, internal priority */
    int cosq = 2;
    uint8 egr_pkt_dscp = 5;  /* dscp remark at egress if needed, else pkt egress with mapcp value */
