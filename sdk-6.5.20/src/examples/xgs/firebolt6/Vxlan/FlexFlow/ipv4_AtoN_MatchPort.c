...
/*
 * Feature  : FB6(56470) Vxlan Bridging , IPv4 access to network tunnel initiation Flow with port as a flow match criteria(BCM_FLOW_MATCH_CRITERIA_PORT)
 *
 * Usage    : BCM.0> cint ipv4_AtoN_MatchPort.c
 *
 * config   : config_fb6_flex.bcm
 *
 * Log file : ipv4_AtoN_MatchPort_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
