...
/*
 * Feature  : Vxlan Bridging , IPv4 access to network VP LAG (LAG of virtual network ports) unicast Flow - L2 learning on VPLAG
 *
 * Usage    : BCM.0> cint vxlan_v4_vplag_acc_to_net_learning.c
 *
 * config   : config_fb6_flex.bcm
 *
 * Log file : vxlan_v4_vplag_acc_to_net_learning_log.txt
 *
 * Test Topology :
 *                   ACCESS        +----------------------+       NETWORK
 * SMAC 00::bb:b1                 |                      |
 ...
 * SMAC 00::bb:b2                 |                      |
 *          +---+          VLAN=22|                      |
 * Host(acc)|   +-----------------+                      |                          Underlay+NextHop
 *          +---+  ingress_port[1]|                      |  VLAN=26   egress_port        +---+
 *                                |                      +-------------------------------+   |
 * SMAC 00::bb:b3                 |     Firebolt-6       |00::22:22                      +---+
 *          +---+          VLAN=23|                      |                               00::02
 * Host(acc)|   +-----------------+                      |
 *          +---+  ingress_port[2]|                      |
 *                                |                      |
...
ACCESS-TO-NETWORK:-
Encap-case: packets sent from ingress_ports(access) to egress_port(network)
...
Header Info
  ...
  ###[ Ethernet ]###
    ...
    src= 00:00:00:00:bb:b1, 00:00:00:00:bb:b2, 00:00:00:00:bb:b3, 00:00:00:00:bb:b4, 00:00:00:00:bb:b5 <== 5 packets' changing contents
    type= 0x8100
  ###[ 802.1Q ]###
     vlan= 21, 22, 23, 24, 25
     type= 0x800
  ###[ IP ]###
        version= 4
        proto= udp
        src= 1.1.1.1, 1.1.1.2, 1.1.1.5, 1.1.1.6, 1.1.1.20 <== 5 packets' changing contents
        dst= 2.2.2.2
  ###[ UDP ]###
          sport= 53
          dport= 54
...
Ingress Hex Packet:
tx port=1 data=0x00000000AAAA00000000BBB18100001508004500002E00000000401174BA010101010202020200350036001AB0F8000102030405060708090A0B0C0D0E0F101133CF192C

tx port=1 data=0x00000000AAAA00000000BBB28100001608004500002E00000000401174B9010101020202020200350036001AB0F7000102030405060708090A0B0C0D0E0F1011975E7DF7

tx port=1 data=0x00000000AAAA00000000BBB38100001708004500002E00000000401174b6010101050202020200350036001AB0F8000102030405060708090A0B0C0D0E0F101133CF192C

tx port=1 data=0x00000000AAAA00000000BBB48100001808004500002E00000000401174B5010101060202020200350036001AB0F3000102030405060708090A0B0C0D0E0F101196025567

tx port=1 data=0x00000000AAAA00000000BBB58100001908004500002E00000000401174a7010101140202020200350036001AB0F8000102030405060708090A0B0C0D0E0F101133CF192C
...
Header Info
  ...
  ###[ Ethernet ]###
                 dst= 00:00:00:00:aa:aa
                 src= 00:00:00:00:bb:b1, 00:00:00:00:bb:b2, 00:00:00:00:bb:b3, 00:00:00:00:bb:b4, 00:00:00:00:bb:b5
                 type= 0x800
  ###[ 802.1Q ]###
     vlan= 21
     type= 0x800
...
Packet Dump
Egress packet#1 -
data[0000]: {000000000002} {000000002222} 8100 001a
data[0010]: 0800 4500 0064 0000 0000 3f11 a5d3 0a0a
data[0020]: 0a02 c0a8 0102 ffff 2118 0050 0000 0000
data[0030]: 0000 0123 4500 0000 0000 aaaa 0000 0000
data[0040]: bbb1 0800 4500 002e 0000 0000 4011 74ba
data[0050]: 0101 0101 0202 0202 0035 0036 001a b0f8
data[0060]: 0001 0203 0405 0607 0809 0a0b 0c0d 0e0f
data[0070]: 1011 33cf 192c d837 a7ee

Egress packet#2 -
data[0000]: {000000000002} {000000002222} 8100 001a
data[0010]: 0800 4500 0064 0001 0000 3f11 a5d2 0a0a
data[0020]: 0a02 c0a8 0102 ffff 2118 0050 0000 0000
data[0030]: 0000 0123 4500 0000 0000 aaaa 0000 0000
data[0040]: bbb2 0800 4500 002e 0000 0000 4011 74b9
data[0050]: 0101 0102 0202 0202 0035 0036 001a b0f7
data[0060]: 0001 0203 0405 0607 0809 0a0b 0c0d 0e0f
data[0070]: 1011 975e 7df7 3f8b 906f

Egress packet#3 -
data[0000]: {000000000002} {000000002222} 8100 001a
data[0010]: 0800 4500 0064 0002 0000 3f11 a5d1 0a0a
data[0020]: 0a02 c0a8 0102 ffff 2118 0050 0000 0000
data[0030]: 0000 0123 4500 0000 0000 aaaa 0000 0000
data[0040]: bbb3 0800 4500 002e 0000 0000 4011 74b6
data[0050]: 0101 0105 0202 0202 0035 0036 001a b0f8
data[0060]: 0001 0203 0405 0607 0809 0a0b 0c0d 0e0f
data[0070]: 1011 33cf 192c dea3 be67

Egress packet#4 -
data[0000]: {000000000002} {000000002222} 8100 001a
data[0010]: 0800 4500 0064 0003 0000 3f11 a5d0 0a0a
data[0020]: 0a02 c0a8 0102 ffff 2118 0050 0000 0000
data[0030]: 0000 0123 4500 0000 0000 aaaa 0000 0000
data[0040]: bbb4 0800 4500 002e 0000 0000 4011 74b5
data[0050]: 0101 0106 0202 0202 0035 0036 001a b0f3
data[0060]: 0001 0203 0405 0607 0809 0a0b 0c0d 0e0f
data[0070]: 1011 9602 5567 b0f4 8eb6

Egress packet#5 -
data[0000]: {000000000002} {000000002222} 8100 001a
data[0010]: 0800 4500 0064 0004 0000 3f11 a5cf 0a0a
data[0020]: 0a02 c0a8 0102 ffff 2118 0050 0000 0000
data[0030]: 0000 0123 4500 0000 0000 aaaa 0000 0000
data[0040]: bbb5 0800 4500 002e 0000 0000 4011 74a7
data[0050]: 0101 0114 0202 0202 0035 0036 001a b0f8
data[0060]: 0001 0203 0405 0607 0809 0a0b 0c0d 0e0f
data[0070]: 1011 33cf 192c fa3c f028
*/
...
struct rtag7_cfg_t {
    ...
    int block_n_offset_a;           /*Block (A0 or A1) and offset to be used for unicast VP LAG*/
...
verify(int unit)
{
    ...
    snprintf(pkt_data[0],512,"%s","00000000AAAA00000000BBB18100001508004500002E00000000401174BA010101010202020200350036001AB0F8000102030405060708090A0B0C0D0E0F101133CF192C");

    snprintf(pkt_data[1],512,"%s","00000000AAAA00000000BBB28100001608004500002E00000000401174B9010101020202020200350036001AB0F7000102030405060708090A0B0C0D0E0F1011975E7DF7");

    snprintf(pkt_data[2],512,"%s","00000000AAAA00000000BBB38100001708004500002E00000000401174b6010101050202020200350036001AB0F8000102030405060708090A0B0C0D0E0F101133CF192C");

    snprintf(pkt_data[3],512,"%s","00000000AAAA00000000BBB48100001808004500002E00000000401174B5010101060202020200350036001AB0F3000102030405060708090A0B0C0D0E0F101196025567");

    snprintf(pkt_data[4],512,"%s","00000000AAAA00000000BBB58100001908004500002E00000000401174a7010101140202020200350036001AB0F8000102030405060708090A0B0C0D0E0F101133CF192C");
...
config_vxlan_ipv4_vtep(int unit)
{
    ...
    vxlan_acc_cfg_t vxlan_acc[NO_OF_VPLAG_MEMBERS] = { /*Parameters of all Access ports that form VPLAG */
        {
            ingress_phy_gport[0], /* port */
            21,/*vlan */
        ...
        {
            ingress_phy_gport[2], /* port */
            23,/*vlan */
            "00:00:00:00:11:13",/*local mac */
            "00:00:00:00:00:03",/* remote mac */
            0
        },
        {
            ingress_phy_gport[3], /* port */
            24,/*vlan */
            "00:00:00:00:11:14",/*local mac */
            "00:00:00:00:00:04",/* remote mac */
            0
        },
        {
            ingress_phy_gport[4], /* port */
            25,/*vlan */
            "00:00:00:00:11:15",/*local mac */
    ...
    bcm_gport_t   acc_flow_port[NO_OF_VPLAG_MEMBERS];
    ...
    for(i=0;i<NO_OF_VPLAG_MEMBERS;i++) {
        rv = config_vxlan_access(unit, &vxlan_cfg, &vxlan_acc[i], &acc_flow_port[i]);
        if (BCM_FAILURE(rv)) {
            printf("\nError in access config: %s.\n", bcm_errmsg(rv));
            return rv;
        }
    ...
    rv = config_vplag(unit,&vplag_id,acc_flow_port);
    if (BCM_FAILURE(rv)) {
