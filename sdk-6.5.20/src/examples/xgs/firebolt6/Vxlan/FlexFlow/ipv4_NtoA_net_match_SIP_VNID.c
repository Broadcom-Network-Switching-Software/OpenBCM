 ...
 *            with network port match criteria based on SIP+VN_ID
 *
 * Usage    : BCM.0> cint ipv4_NtoA_net_match_SIP_VNID.c
 *
 * config   : config_fb6_flex.bcm
 *
 * Log file : ipv4_NtoA_net_match_SIP_VNID_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
...
Input Hex (network):

...
verify(int unit)
{
    ...
    printf("\nSending known unicast packet to ingress_port network side:%d\n", ingress_port_2);
    snprintf(str, 1184, "tx 1 pbm=%d data=; sleep quiet 1", ingress_port_2);
    bshell(unit, str);
    bshell(unit, "show c");
