...
/*
 * Feature  : Vxlan Bridging , IPv4 network to access VP LAG (LAG of virtual access ports) unicast Flow
 *
 * Usage    : BCM.0> cint vxlan_v4_vplag_net_to_acc_uc.c
 *
 * config   : config_fb6_flex.bcm
 *
 * Log file : vxlan_v4_vplag_net_to_acc_uc_log.txt
 *
 * Test Topology :
 *                    NETWORK                                       ACCESS
 *
 *                     VLAN=22   +----------------------+          VLAN=21              +---+
 *                               |                      +-------------------------------+   | Host(acc)
 * Underlay+NextHop              |                      |egress_port[0]                 +---+
 *                               |                      |
 *         +---+        00::22:22                       |                               +---+
 *         |   +-----------------+                      +-------------------------------+   | Host(acc)
 *         +---+    ingress_port |                      |egress_port[1]                 +---+
 *        00::02                 |                      |
 *                               |                      |
 *                               |                      |                               +---+
 *                               |                      +-------------------------------+   | Host(acc)
 *                               |     Firebolt-6       |egress_port[2]                 +---+
 *                               |                      |
 *                               |                      |
 *                               |                      |                               +---+
 *                               |                      +-------------------------------+   | Host(acc)
...
======
  ...
  ###[ IP ]###
                 version= 4
                 proto= udp
                    src= 2.2.2.1, 2.2.2.2, 2.2.2.6, 2.2.2.7, 2.2.2.20 <== 5 packets' only changing contents
                    dst= 1.1.1.1
  ###[ UDP ]###

Ingress Hex Packets (network):
======
tx port=1 data=

tx port=1 data=

tx port=1 data=

tx port=1 data=

tx port=1 data=
...
Header Info
  ...
  ###[ IP ]###
        version= 4
        proto= udp
        src= 2.2.2.1, 2.2.2.2, 2.2.2.6, 2.2.2.7, 2.2.2.20 <== 5 packets' contents
        dst= 1.1.1.1
  ###[ UDP ]###
          sport= 53
          dport= 54
...
verify(int unit)
{
    ...
    snprintf(pkt_data[2],512,"%s","");
...
config_vxlan_ipv4_vtep(int unit)
{
    ...
    vxlan_acc_cfg_t vxlan_acc[NO_OF_VPLAG_MEMBERS] = { /*Parameters of all Access ports that form VPLAG */
        ...
        },
        {
            ...
            "00:00:00:00:00:20",/* remote mac */
            0
        },
        {
            egress_phy_gport[2], /* port */
            21,/*vlan */
            "00:00:00:00:11:13",/*local mac */
            "00:00:00:00:00:30",/* remote mac */
            0
        },
        {
            egress_phy_gport[3], /* port */
            21,/*vlan */
            "00:00:00:00:11:14",/*local mac */
            "00:00:00:00:00:40",/* remote mac */
            0
        },
        {
            egress_phy_gport[4], /* port */
            21,/*vlan */
            "00:00:00:00:11:15",/*local mac */
            "00:00:00:00:00:50",/* remote mac */
            0
        },
    };

    vxlan_net_cfg_t vxlan_net = {
        ingress_phy_gport, /* Egress port */
        22, /* vlan */
    ...
    printf("Network-to-Access: Add payload-dest-mac Address => Access-VPLAG.\n");
    rv = add_lag_to_l2_table(unit, "00:00:00:00:bb:bb", vxlan_cfg.vxlan_vpn, vplag_id);
    if (BCM_FAILURE(rv)) {
