...
/*
 * Feature  : FB6(56470) Vxlan Bridging , IPv4 network to access tunnel termination flow, replace vlan tag in payload while egressing on access port
 *
 * Usage    : BCM.0> cint ipv4_NtoA_SDtag_Replace.c
 *
 * config   : config_fb6_flex.bcm
 *
 * Log file : ipv4_NtoA_SDtag_Replace_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
