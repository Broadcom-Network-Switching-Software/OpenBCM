...
/*
 * Feature  : Vxlan Riot, IPv4 network to network initiate new tunnel
 *
 * Usage    : BCM.0> cint ipv4_riot_NtoN_uc_tunnel.c
 *
 * config   : config_fb6_flex_riot.bcm
 *
 * Log file : ipv4_riot_NtoN_uc_tunnel_log.txt
 *
 * Test Topology :
 *
 *                  +----------------------+
 ...
 *                  |                      +--------------------+   |
 *                  |                      |00::bb:bb           +---+
 *                  |     Firebolt-6       |                   vnid 0x12345
 *                  |                      |
 *                  |                      |   VLAN-14        Underlay-NextHop
 *                  |                      |  egress_port       +---+
 *                  |                      +--------------------+   |
 *                  |                      |00::a4:a4           +---+
 *                  |                      |                   vnid 0x12567
 ...
 * Summary:
 * ========
 * Cint example to demonstrate VxLAN Riot configuration for tunnel termination and
...
Packet Dump
{00000000a4a4} {00000000b4b4} 8100 000e
0800 4500 0068 0000 0000 3f11 3f66 0a0a
0a01 1414 1401 ffff 2118 0054 0000 0000
0000 0125 6700 0000 0003 0303 0000 0013
1313 8100 000d 0800 4500 002a 0000 0000
3fff db82 c0a8 1401 c0a8 0a01 0000 0000
0000 0000 0000 0000 0000 0000 0000 0000
0000 0000 0000 0000 0000 4cba 36c0
 */
...
config_vxlan_tunnel(int unit,vxlan_cfg_t *vxlan_cfg, vxlan_net_cfg_t *vxlan_net,
                    bcm_gport_t net_flow_port, int tunnel_in,
...
config_vxlan_network(int unit,vxlan_cfg_t *vxlan_cfg,vxlan_acc_cfg_t *vxlan_acc,
                     ...
                     int tunnel_in,bcm_flow_handle_t flow_handle)
{
    ...
    if(tunnel_in) {
        ...
        rv = l2_station_add(unit,vxlan_net->net_ul_mac,vxlan_net->net_ul_vlan,
                            0xFFF,BCM_L2_STATION_IPV4 | BCM_L2_STATION_UNDERLAY,
                            &l2_station_net_ul);
        if (BCM_FAILURE(rv)) {
            printf("\nError in l2_station_add: %s\n", bcm_errmsg(rv));
            return rv;
        ...
        printf("Network: add the overlay l3 route\n");
...
config_vxlan_ipv4_vtep(int unit)
{
    ...
    vxlan_acc_cfg_t vxlan_acc = {
        egress_port_1,            /*access physical port*/
    ...
    vxlan_net_cfg_t vxlan_net_2 = {
        ...
        13,                      /*overlay payload vlan*/
        "00:00:00:13:13:13",     /*overlay payload src mac*/
        "00:00:00:03:03:03",     /*overlay payload dst mac*/
        14,                      /*tunnel vid*/
        "00:00:00:00:b4:b4",     /*tunnel src mac*/
        "00:00:00:00:a4:a4",     /*tunnel remote mac*/
        0,                       /*network vpn*/
    ...
    /*create network flow port with vnid 0x12567*/
    printf("\nSetup network VP on port %d\n", vxlan_net_2.net_port);
    rv = config_vxlan_network(unit,&vxlan_cfg,&vxlan_acc,&vxlan_net_2,
                              &net_flow_port_2,0,flow_handle);
    if (BCM_FAILURE(rv)) {
        printf("\nError in config_vxlan_network: %s\n", bcm_errmsg(rv));
        return rv;
    }
