...
/*
 * Feature  : FB6(56470) Vxlan Riot, IPv6 network to access tunnel termination flow
 *
 * Usage    : BCM.0> cint ipv6_riot_NtoA_uc.c
 *
 * config   : config_fb6_flex_riot.bcm
 *
 * Log file : ipv6_riot_NtoA_uc_log.txt
 *
 * Test Topology :
 *
 *                                  +----------------------+
...
=============
    ...
    86dd 6240 0000 0050 113f 0202 0202 3600
    7000 0000 0102 0304 0506 0101 0101 3500
    7000 0000 1009 0807 0605 ffff 2118 0050
    0000 0000 0000 0123 4500 0000 0001 0101
    0000 0002 0202 0800 4500 002e 0000 0000
    3fff db7e c0a8 1401 c0a8 0a01 0000 0000
    0000 0000 0000 0000 0000 0000 0000 0000
    0000 0000 0000 0000 0000 61f6 f5e9 1a30
    dd90

Egress Packet:
=============
    0000 0011 1111 0000 0022 2222 8100 000a
    0800 4500 002e 0000 0000 3eff dc7e c0a8
    1401 c0a8 0a01 0000 0000 0000 0000 0000
    0000 0000 0000 0000 0000 0000 0000 0000
    0000 0000 61f6 f5e9 b984 30e8
...
verify(int unit)
{
    ...
    bshell(unit, "clear c");
    printf("\nSending vxlan packet to ingress network port side:%d\n",
                                                                ingress_port);
    snprintf(str, 512, "tx 1 pbm=%d data=; sleep quiet 1", ingress_port);
