...
/*
 * Feature  : UTT Mode A configuration
 *
 * Usage    : BCM.0> cint utt_mode_a_configuration.c
 *
 * config   : utt_mode_a_config.bcm
 *
 * Log file : utt_mode_a_configuration_log.txt
 *
 * Test Topology :
 *
 *                  +------------------------------+
 ...
 *   Mode A: IFP TCAMs - 72, LPM TCAMS - 24
 *
