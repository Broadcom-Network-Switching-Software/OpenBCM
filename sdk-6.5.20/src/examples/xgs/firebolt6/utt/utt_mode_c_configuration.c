...
/*
 * Feature  : UTT Mode C configuration
 *
 * Usage    : BCM.0> cint utt_mode_c_configuration.c
 *
 * config   : utt_mode_c_config.bcm
 *
 * Log file : utt_mode_c_configuration_log.txt
 *
 * Test Topology :
 *
 *                  +------------------------------+
 ...
 *   Mode C: IFP TCAMs - 36, LPM TCAMS - 56
 *
