                  ...
                  bcm_multicast_t mcg)
{
    ...
    printf(" Dump REPL GROUP INFO table\n");
    print bshell(0,"d chg MMU_REPL_GROUP_INFO_TBL_PIPE0");
...
config_efp(int unit)
{
    ...
    print bcm_field_entry_install(unit,entry);
/*
    print bcm_field_action_add(unit, entry, bcmFieldActionSvtagPktType, bcmFieldMacSecPktTypeControlPkt, 0);
    print bcm_field_entry_install(unit,entry);
*/
...
int main(int unit)
{
    ...
    /* L3 encap */
    print create_mc_egr_obj(unit, tunnel_obj_egr_1, subport_gport, ipmc_group);
