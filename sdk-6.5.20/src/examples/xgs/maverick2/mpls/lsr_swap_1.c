...
/*
 * Feature  : L3 MPLS LSR label Swa scenario -Method2 (using _l3_egress_create API)
 *
 * Usage    : BCM.0> cint lsr_swap_1.c
 *
 * config   : mpls_config.bcm
 *
 * Log file : lsr_swap_1_log.txt
 *
 * Test Topology :
 *
 *                  +------------------------------+
...
config_lsr_swap_1(int unit)
{
    ...
    l3_egress.mpls_label = out_tunnel_label; /* Out MPLS label */
