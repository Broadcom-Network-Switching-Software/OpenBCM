 ...
 *
 * Main Function:
 *      cint_rx_trap_etpp_mtu_trap_lif_main(unit,out_lif,fwd_layer_type,compressed_layer_type,trap_id,fwd_strength,snp_strength,mtu_val);
 * Destroy Function:
 *      cint_rx_trap_etpp_mtu_trap_lif_destroy(unit,out_lif,fwd_layer_type,compressed_layer_type);
 *
    ...
    int mtu_profile)
{
    ...
    rv = cint_etpp_mtu_trap_mtu_lif_set(unit, lif_gport, trap_gport, mtu_val, fwd_layer_type, compressed_layer_type, mtu_profile);
    if(rv != BCM_E_NONE)
    {
