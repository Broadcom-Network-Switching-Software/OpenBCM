...
struct kaps_sw_model_kaps_config
{
    ...
    uint16_t total_num_small_bb[KAPS_HW_MAX_NUM_DB_GROUPS]; 
    uint16_t total_num_ads2_blks; 
    uint16_t total_num_bb[KAPS_HW_MAX_NUM_DB_GROUPS];  
    uint16_t num_rows_in_rpb[KAPS_HW_MAX_NUM_RPB_BLOCKS]; 
    uint16_t num_rows_in_small_bb[KAPS_HW_MAX_NUM_DB_GROUPS]; 
    uint16_t num_rows_in_bb[KAPS_HW_MAX_NUM_DB_GROUPS]; 
