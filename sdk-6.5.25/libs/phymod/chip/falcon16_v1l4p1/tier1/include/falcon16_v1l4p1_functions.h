...
/***********************************************************************************
 ***********************************************************************************
 *  File Name  :  falcon16_v1l4p1_functions.h                                           *
 *  Created On :  29/04/2013                                                       *
 *  Created By :  Kiran Divakar                                                    *
 *  Description:  Protoypes of all API functions for engineering use               *
 *  Revision   :   *
 *                                                                                 *
 ***********************************************************************************
 **********************************************************************************/
...
#ifndef FALCON16_V1L4P1_API_FUNCTIONS_H
#define FALCON16_V1L4P1_API_FUNCTIONS_H
...
#include "falcon16_v1l4p1_internal_error.h"
    ...
    do  { \
        ...
        *(__ERR) = (expr); \
        if (*(__ERR) != ERR_CODE_NONE) { \
            return falcon16_v1l4p1_error_report(sa__, *(__ERR)); \
        }\
        (void)__err; \
    }   while(0)
/**
 ...
 *  Only used in falcon16_v1l4p1_INTERNAL_print_triage_info() and requires __err to be declared.
 */
