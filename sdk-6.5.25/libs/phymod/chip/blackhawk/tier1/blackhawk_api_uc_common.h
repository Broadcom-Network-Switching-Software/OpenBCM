 ...
 */
enum blackhawk_tsc_flr_timeout_enum {
  BLACKHAWK_TSC_FLR_TIMEOUT_50MS  = 0,
  BLACKHAWK_TSC_FLR_TIMEOUT_75MS  = 1,
  BLACKHAWK_TSC_FLR_TIMEOUT_100MS = 2,
  BLACKHAWK_TSC_FLR_TIMEOUT_150MS = 3,
  BLACKHAWK_TSC_FLR_TIMEOUT_250MS = 4,
  BLACKHAWK_TSC_FLR_TIMEOUT_500MS = 5
};
