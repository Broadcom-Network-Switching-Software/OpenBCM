...
#define XMOD_PAUSE_ADDR_GET                         0x50
#define XMOD_PAUSE_ADDR_SET                         0x51
#define XMOD_ETHERNET_CMDS_COUNT                    0x52   /* LAST ENTRY */
...
typedef struct xmod_pause_addr_s {
    uint8_t mac[6];
    uint8_t sys_side; /**< System side port */
} COMPILER_ATTRIBUTE((packed)) xmod_pause_addr_t;
...
#define XMOD_PAUSE_ADDR_GET_OUT_LEN                 (sizeof(xmod_pause_addr_t))
#define XMOD_PAUSE_ADDR_GET_IN_LEN                  (sizeof(uint32_t))
#define XMOD_PAUSE_ADDR_SET_OUT_LEN                 (0)
#define XMOD_PAUSE_ADDR_SET_IN_LEN                  (sizeof(xmod_pause_addr_t))
