...
#define rd_ams_rx_eq2_deq2()                                    blackhawk7_l8p2_acc_rde_field_u8(sa__, 0xd0c0,0,15,__ERR)
#define wr_ams_rx_eq2_deq2(wr_val)                              blackhawk7_l8p2_acc_mwr_reg_u8(sa__, 0xd0c0,0x8000,15,wr_val)
#define rd_ams_rx_eq1_deq2()                                    blackhawk7_l8p2_acc_rde_field_u8(sa__, 0xd0c0,1,15,__ERR)
#define wr_ams_rx_eq1_deq2(wr_val)                              blackhawk7_l8p2_acc_mwr_reg_u8(sa__, 0xd0c0,0x4000,14,wr_val)
...
#define rd_fast_lt_prbs_en()                                    blackhawk7_l8p2_acc_rde_field_u8(sa__, 0xd1ae,3,15,__ERR)
#define wr_fast_lt_prbs_en(wr_val)                              blackhawk7_l8p2_acc_mwr_reg_u8(sa__, 0xd1ae,0x1000,12,wr_val)
#define rd_clkcal_restart_on_fail()                             blackhawk7_l8p2_acc_rde_field_u8(sa__, 0xd1ae,5,15,__ERR)
#define wr_clkcal_restart_on_fail(wr_val)                       blackhawk7_l8p2_acc_mwr_reg_u8(sa__, 0xd1ae,0x0400,10,wr_val)
...
#define rd_clkcal_retry_on_fail()                               blackhawk7_l8p2_acc_rde_field_u8(sa__, 0xd1ae,9,15,__ERR)
#define wr_clkcal_retry_on_fail(wr_val)                         blackhawk7_l8p2_acc_mwr_reg_u8(sa__, 0xd1ae,0x0040,6,wr_val)
...
#define exc_AMS_PLL_COM_PLL_CONTROL_3__ams_pll_i_clkchnl_2(reg_value)                                                     blackhawk7_l8p2_ex_uapi_ams_pll_i_clkchnl_2(reg_value)
#define exc_AMS_PLL_COM_PLL_CONTROL_3__ams_pll_cm_clkchnl_2(reg_value)                                                    extract_field((reg_value),10,8)
#define exc_AMS_PLL_COM_PLL_CONTROL_3__ams_pll_swind_clkchnl_2(reg_value)                                                 blackhawk7_l8p2_ex_uapi_ams_pll_swind_clkchnl_2(reg_value)
...
#define ex_AMS_RX_RXCONTROL_9__ams_rx_ibias_pibuf(reg_value)                                                              blackhawk7_l8p2_ex_uapi_ams_rx_ibias_pibuf(reg_value)
...
#define exc_AMS_PLL_COM_PLL_CONTROL_3__ams_pll_cap_clkchnl_1(reg_value)                                                   blackhawk7_l8p2_ex_uapi_ams_pll_cap_clkchnl_1(reg_value)
#define exc_AMS_PLL_COM_PLL_CONTROL_3__ams_pll_cap_clkchnl_1_3(reg_value)                                                 blackhawk7_l8p2_ex_uapi_ams_pll_cap_clkchnl_1_3(reg_value)
#define ex_AMS_RX_RXCONTROL_7__ams_rx_eq2_ctrl4(reg_value)                                                                blackhawk7_l8p2_ex_uapi_ams_rx_eq2_ctrl4(reg_value)
