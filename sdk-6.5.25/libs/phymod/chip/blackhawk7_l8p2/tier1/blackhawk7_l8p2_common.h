 ...
 *
 */
typedef struct blackhawk7_l8p2_txfir {
 ...
 *
 */
typedef struct blackhawk7_l8p2_dbgfb_stats_s {
...
} blackhawk7_l8p2_dbgfb_data_st;

/*! Debug feedback data
 *
 */
typedef struct blackhawk7_l8p2_dbgfb_data_s {
    uint32_t time_in_us;
    blackhawk7_l8p2_dbgfb_data_st data;
    uint8_t pam4es_en;
    uint8_t temp[3];
} blackhawk7_l8p2_dbgfb_stats_st;
