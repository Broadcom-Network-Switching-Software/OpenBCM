...
/**************************************************************************************
 *  File Name     :  blackhawk7_l2p2_usr_includes.h                                        *
...
#ifndef BLACKHAWK7_L2P2_API_USR_INCLUDES_H
#define BLACKHAWK7_L2P2_API_USR_INCLUDES_H
...
#endif
#define USR_DELAY_MS(stuff) blackhawk7_l2p2_acc_delay_ms(sa__,stuff)
#define USR_DELAY_US(stuff) blackhawk7_l2p2_acc_delay_us(sa__,stuff)
#define USR_DELAY_NS(stuff) blackhawk7_l2p2_acc_delay_ns(sa__,stuff)
