...
#ifndef BLACKHAWK7_L2P2_API_TYPES_H
#define BLACKHAWK7_L2P2_API_TYPES_H
 ...
 *
 */
typedef struct blackhawk7_l2p2_triage_info_st {
   uint32_t     api_ver;
   uint32_t     ucode_ver;
   uint8_t      core;
   uint8_t      lane;
...
} blackhawk7_l2p2_triage_info;



#if !defined(EXCLUDE_FOR_SWIG)
#define SIZE_OF_DBGFB_STATS_STRUCT 296  /* Change the size if blackhawk7_l2p2_dbgfb_stats_st size changes */
/*! Used for maintaining correctness of SIZE_OF_DBGFB_STATS_STRUCT
 *
 */
typedef struct {
    uint8_t dbgfb_tmp[sizeof(blackhawk7_l2p2_dbgfb_stats_st)==SIZE_OF_DBGFB_STATS_STRUCT ? 1: -1];
} blackhawk7_l2p2_dbgfb_stats_st_size_check;
#endif /* EXCLUDE_FOR_SWIG */

/*! Used for debug feedback APIs
 *
 */
typedef struct blackhawk7_l2p2_dbgfb_cfg_s {
    uint8_t y;
    uint8_t x;
    uint32_t time_in_us;
    int32_t data1;
 ...
 *
 */
struct blackhawk7_l2p2_uc_lane_config_field_st {
 ...
 *
 */
struct blackhawk7_l2p2_uc_core_config_field_st {
  uint8_t  vco_rate          ;
 ...
 *
 */
struct  blackhawk7_l2p2_uc_lane_config_st {
  struct blackhawk7_l2p2_uc_lane_config_field_st field;
  uint16_t word;
};
 ...
 *
 */
struct  blackhawk7_l2p2_uc_core_config_st {
  struct blackhawk7_l2p2_uc_core_config_field_st field;
  uint16_t word;
 ...
 *
 */
struct blackhawk7_l2p2_usr_ctrl_func_st {
 ...
 *
 */
struct blackhawk7_l2p2_usr_ctrl_dfe_func_st {
 ...
 *
 */
struct blackhawk7_l2p2_usr_ctrl_disable_functions_st {
  struct blackhawk7_l2p2_usr_ctrl_func_st field;
  uint16_t word;
};
 ...
 *
 */
struct blackhawk7_l2p2_usr_ctrl_disable_dfe_functions_st {
  struct blackhawk7_l2p2_usr_ctrl_dfe_func_st field;
  uint8_t  byte;
};
/*! Used in BER APIs
 *
 */
struct blackhawk7_l2p2_ber_data_st {
    uint64_t num_errs;
    uint64_t num_bits;
    uint8_t lcklost;
    uint8_t prbs_chk_en;
 ...
 *
 */
struct blackhawk7_l2p2_check_platform_info_st {
    char c;
    uint32_t d;
};
 ...
 */
struct blackhawk7_l2p2_detailed_lane_status_st {
    /* =========== 32-bit variables start =========== */
    /** PRBS Error Count */
    uint32_t prbs_chk_errcnt;
    blackhawk7_l2p2_dbgfb_stats_st dbgfb_stats;
    ...
    /* =========== 8-bit variables end ============== */
};  /* struct blackhawk7_l2p2_detailed_lane_status_st  for BLACKHAWK7 */
/* Change the size if blackhawk7_l2p2_detailed_lane_status_st size changes */
 ...
 */
typedef struct {
    uint8_t extended_lane_st_tmp[sizeof(struct blackhawk7_l2p2_detailed_lane_status_st)==SIZE_OF_EXTENDED_LANE_STATE ? 1: -1];
} blackhawk7_l2p2_detailed_lane_status_st_size_check;
#endif /* EXCLUDE_FOR_SWIG */
