...
/**************************************************************************************
 **************************************************************************************
 *  File Name     :  blackhawk7_l2p2_field_access.h                                        *
...
#ifndef BLACKHAWK7_L2P2_API_FIELD_ACCESS_H
#define BLACKHAWK7_L2P2_API_FIELD_ACCESS_H
...
/*---------------------------------------------------------------------------------------------------*/
/* "Serdes ACCess" (_acc_) API dependency "wrapper" functions for blackhawk7_l2p2_dependencies.c          */
 ...
 * NOTE: This should be used instead of the API Dedendency function blackhawk7_l2p2_pmd_rdt_reg().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] addr 16-bit register address.
 ...
 * NOTE: This should be used instead of the API Dedendency function blackhawk7_l2p2_pmd_wr_reg().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * NOTE: This should be used instead of the API Dedendency function blackhawk7_l2p2_pmd_mwr_reg().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * @return Error code generated by write function (returns ERR_CODE_NONE if no errors).
 */
err_code_t blackhawk7_l2p2_acc_wr_pram(srds_access_t *sa__, uint8_t val);
...
#define blackhawk7_l2p2_acc_get_physical_lane blackhawk7_l2p2_acc_get_lane
...
#define blackhawk7_l2p2_acc_set_physical_lane blackhawk7_l2p2_acc_set_lane
...
/** Returns address of blackhawk7_l2p2 info table stored in upper level software.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @return Returns a pointer to the blackhawk7_l2p2 info table.
 */
