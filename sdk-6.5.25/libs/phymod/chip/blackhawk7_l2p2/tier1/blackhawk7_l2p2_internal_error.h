...
#ifndef BLACKHAWK7_L2P2_API_INTERNAL_ERROR_H
#define BLACKHAWK7_L2P2_API_INTERNAL_ERROR_H
...
#define blackhawk7_l2p2_error_report(sa__, err_code) \
        blackhawk7_l2p2_INTERNAL_print_err_msg_and_triage_info(sa__, (err_code), __FILE__, API_FUNCTION_NAME, (uint16_t)__LINE__)
#else
#define blackhawk7_l2p2_error_report(sa__, err_code) (err_code)
#endif
/* Prints error code, containing function, file and line number */
#ifndef SMALL_FOOTPRINT
#define blackhawk7_l2p2_error(sa__, err_code) \
        blackhawk7_l2p2_INTERNAL_print_err_msg(sa__, (err_code), __FILE__, API_FUNCTION_NAME, (uint16_t)__LINE__)
#else
#define blackhawk7_l2p2_error(sa__, err_code) (err_code)
#endif
#ifndef SMALL_FOOTPRINT
 ...
 * @return Error Code.
 */
err_code_t blackhawk7_l2p2_INTERNAL_print_err_msg(srds_access_t *sa__, uint16_t err_code, const char *filename, const char *func_name, uint16_t line);
 ...
 * @return Error Code.
 */
err_code_t blackhawk7_l2p2_INTERNAL_print_err_msg_and_triage_info(srds_access_t *sa__, uint16_t err_code, const char *filename, const char *func_name, uint16_t line);
 ...
 */
const char* blackhawk7_l2p2_INTERNAL_e2s_err_code(err_code_t err_code);
