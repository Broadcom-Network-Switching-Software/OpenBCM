...
enum blackhawk7_v1l8p1_pll_div_enum {
    ...
    BLACKHAWK7_V1L8P1_PLL_DIV_137P721519 = (int)0xB8B58089, /*!< Divide by 137.721519 */
    BLACKHAWK7_V1L8P1_PLL_DIV_140        = (int)0x0000008C, /*!< Divide by 140        */
    BLACKHAWK7_V1L8P1_PLL_DIV_142P0253165= (int)0x067B408E, /*!< Divide by 142.0253165*/
    BLACKHAWK7_V1L8P1_PLL_DIV_144        = (int)0x00000090, /*!< Divide by 144        */
    BLACKHAWK7_V1L8P1_PLL_DIV_152        = (int)0x00000098, /*!< Divide by 152        */
    BLACKHAWK7_V1L8P1_PLL_DIV_165P7770801= (int)0xC6EEC0A5, /*!< Divide by 165.7770801*/
    BLACKHAWK7_V1L8P1_PLL_DIV_170P800628 = (int)0xCCF600AA, /*!< Divide by 170.800628 */
    BLACKHAWK7_V1L8P1_PLL_DIV_179P7348805= (int)0xBC2140B3, /*!< Divide by 179.7348805*/
    BLACKHAWK7_V1L8P1_PLL_DIV_179P7356828= (int)0xBC55C0B3, /*!< Divide by 179.7356828*/
    BLACKHAWK7_V1L8P1_PLL_DIV_180P5309734= (int)0x87EDC0B4, /*!< Divide by 180.5309734*/
...
/*! @def BLACKHAWK7_V1L8P1_PLL_OPTION_REFCLK_MASK
 * Mask used for REFCLK options within enum blackhawk7_v1l8p1_pll_option_enum.
...
enum blackhawk7_v1l8p1_pll_option_enum {
    ...
    BLACKHAWK7_V1L8P1_PLL_OPTION_POWERDOWN         =  1<<4,
    BLACKHAWK7_V1L8P1_PLL_OPTION_DISABLE_VERIFY    =  1<<5
};
