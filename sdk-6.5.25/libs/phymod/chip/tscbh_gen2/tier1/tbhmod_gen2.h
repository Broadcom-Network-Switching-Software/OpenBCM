...
#define TBHMOD_GEN2_UI_25P00G_NRZ_OSX1 0x0a3d70a3
#define TBHMOD_GEN2_UI_25P00G_NRZ_OSX2 0x147ae147
...
#define TBHMOD_GEN2_FCLK_PERIOD_25P00G 0x51eb  /* clk = 25/8. fclk period = 0.32. Convert to 32 bits ==> 1,374,389,534 hex value = 51EB 851E. Use MSB 16 bits = 0x51eb */
...
#define TSCBH_GEN2_FEC_OVERRIDE_BIT_SHIFT 0
#define TSCBH_GEN2_FEC_OVERRIDE_MASK  0x1

#define TSCBH_GEN2_TS_OFFSET_SOP        0
#define TSCBH_GEN2_TS_OFFSET_SFD        7
#define TSCBH_GEN2_TS_OFFSET_MAC_DA     8
#define TSCBH_GEN2_TS_RPM_OFFSET        4

extern int tbhmod_gen2_pcs_ts_config(PHYMOD_ST* pc, int ts_offset);
...
extern int tbhmod_gen2_ts_offset_rx_set(PHYMOD_ST* pc, uint32_t vco, int os_mode, int pam4, int tbl_ln, uint32_t *table);
extern int tbhmod_gen2_tx_ts_info_unpack_tx_ts_tbl_entry(uint32_t *tx_ts_tbl_entry, phymod_ts_fifo_status_t *tx_ts_info);
extern int tbhmod_gen2_fec_override_set(PHYMOD_ST* pc, uint32_t enable);
extern int tbhmod_gen2_fec_override_get(PHYMOD_ST* pc, uint32_t* enable);
extern int tbhmod_gen2_fec_align_status_get(PHYMOD_ST* pc, uint32_t *fec_status_live);
...
extern int tbhmod_gen2_1588_ts_valid_get(PHYMOD_ST* pc, uint16_t* ts_valid);
