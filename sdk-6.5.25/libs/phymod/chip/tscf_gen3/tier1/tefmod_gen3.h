...
extern int tefmod_gen3_set_override_0(PHYMOD_ST *pc, uint32_t per_field_override_en);
extern int tefmod_gen3_set_override_1(PHYMOD_ST *pc, uint32_t per_field_override_en);
...
extern int tefmod_gen3_1588_ts_offset_get(PHYMOD_ST *pc, uint32_t *offset);
...
extern int tefmod_gen3_fec_error_inject_get(PHYMOD_ST *pc,
                                            uint16_t* error_control_map,
                                            tefmod_gen3_fec_error_mask_t* bit_error_mask);
extern int tefmod_gen3_port_start_lane_get(PHYMOD_ST *pc,
