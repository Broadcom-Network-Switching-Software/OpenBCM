...
#ifndef MERLIN7_PCIEG3_API_DIAG_H
#define MERLIN7_PCIEG3_API_DIAG_H
...
struct merlin7_pcieg3_eyescan_options_st {
...
/** Column definition header for merlin7_pcieg3_display_core_state() API output.
 * To be called before merlin7_pcieg3_display_core_state_line() API.
 * @param sa__ is an opaque state vector passed through to device access functions.
 ...
 * Call merlin7_pcieg3_display_core_state_hdr() API before and merlin7_pcieg3_display_core_state_legend() after
...
/** Detailed description of each column in merlin7_pcieg3_display_core_state_line() API output.
 * To be called after merlin7_pcieg3_display_core_state_line() API to display the legends.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * This function only initiates the processor actions.  User must use merlin7_pcieg3_read_eye_scan_stripe() function
 ...
 * merlin7_pcieg3_start_ber_scan_test(), merlin7_pcieg3_read_ber_scan_data(), merlin7_pcieg3_display_ber_scan_data().
 *
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param rate specifies the data rate in Hz
 * @param ber_scan_mode the type of test used to take the data(use #srds_diag_ber_mode_enum)
 ...
 * \n Note: Call functions merlin7_pcieg3_display_lane_state_hdr(sa__) before and merlin7_pcieg3_display_lane_state_legend() after
...
/** Column definition header for merlin7_pcieg3 display state.
 * To be called before merlin7_pcieg3_display_lane_state() function.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin7_pcieg3_display_lane_state_hdr(srds_access_t *sa__);

/** Detailed explanation of each column in merlin7_pcieg3 display state.
 * To be called after merlin7_pcieg3_display_lane_state() function to display the legends.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * This function is required to be implemented by upper level software to enable merlin7_pcieg3 support.
 * @param sa__ is an opaque state vector passed through to device access functions.
...
/** Parameterized diagnostic function which access to all merlin7_pcieg3 control and status bits
 * This function is required to be implemented by upper level software to enable merlin7_pcieg3 support.
 * @param sa__ is an opaque state vector passed through to device access functions.
