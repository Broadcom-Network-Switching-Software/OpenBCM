...
/** Enum for different types of block registers mapping */
typedef enum
{
    /** Each device core has a separate block instance, which is accessed by the 'port' argument of the reg_get function (Default mapping) */
    dnx_block_mapping_core_to_block_idx = 0,
    /** Device has one block instance and counters for different cores are accessed by the 'index' argument of the reg_get function */
    dnx_block_mapping_core_to_numel_idx,
    /** Device has nof_cores/2 block instances and the first half of the cores are in block instance 0 and are iterated by numels, 
     * the second half are in block instance 1 and are also iterated by numels ('index' argument).
     */
    dnx_block_mapping_half_cores_to_block_idx
} dnx_diag_graphical_block_mapping_e;
