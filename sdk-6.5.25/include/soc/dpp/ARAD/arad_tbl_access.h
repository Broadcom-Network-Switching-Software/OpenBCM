...
uint32
  arad_pp_ihp_parser_ipv6_next_protocol_size_tbl_get_unsafe(
    SOC_SAND_IN  int             unit,
    SOC_SAND_IN  uint32          entry_offset,
    SOC_SAND_OUT ARAD_PP_IHP_PARSER_IPV6_NEXT_PROTOCOLS_SIZE_TBL_DATA *tbl_data
  );

uint32
  arad_pp_ihp_parser_ipv6_next_protocol_size_tbl_set_unsafe(
    SOC_SAND_IN  int             unit,
    SOC_SAND_IN  uint32          entry_offset,
    SOC_SAND_IN  ARAD_PP_IHP_PARSER_IPV6_NEXT_PROTOCOLS_SIZE_TBL_DATA *tbl_data
  );
