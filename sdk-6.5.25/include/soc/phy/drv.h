...
typedef struct phy_driver_s {
    ...
    int  (*pd_timesync_tx_info_get)(int, soc_port_t, soc_port_timesync_tx_info_t *);
    int  (*pd_diag_stats_get)(int, soc_port_t, soc_phy_diag_stats_t *);
    int  (*pd_pause_addr_set)(int, soc_port_t, bcm_mac_t);
    int  (*pd_pause_addr_get)(int, soc_port_t, bcm_mac_t);
} phy_driver_t;
...
#define PHY_TIMESYNC_TX_INFO__GET(_pd, _u, _p, _i) \
        _PHY_CALL((_pd), pd_timesync_tx_info_get, ((_u), (_p), (_i)))

#define PHY_DIAG_STATS_GET(_pd, _u, _p, _i) \
        _PHY_CALL((_pd), pd_diag_stats_get, ((_u), (_p), (_i)))

#define PHY_PAUSE_ADDR_SET(_pd, _u, _p, _v) \
        _PHY_CALL((_pd), pd_pause_addr_set, ((_u),(_p),(_v)))

#define PHY_PAUSE_ADDR_GET(_pd, _u, _p, _v) \
        _PHY_CALL((_pd), pd_pause_addr_get, ((_u),(_p),(_v)))
