...
int cpm4x25_port_lane_map_set(int unit, int port, pm_info_t pm_info, uint32 flags, const phymod_lane_map_t* lane_map);
int cpm4x25_port_lane_map_get(int unit, int port, pm_info_t pm_info, uint32 flags, phymod_lane_map_t* lane_map);
...
/*set/get TGEN Enable configuration.*/
#ifdef CPRIMOD_SUPPORT
...
/* Get Control Message Configuration.. */
#ifdef CPRIMOD_SUPPORT
...
/* Set/Get Fast Ethernet configuration.. */
#ifdef CPRIMOD_SUPPORT
...
/* Get member information from  the Tx Control Flow Group.. */
#ifdef CPRIMOD_SUPPORT
int cpm4x25_rsvd4_tx_control_flow_group_member_get(int unit, int port, pm_info_t pm_info, uint32 group_id, uint32 priority, uint32* queue_num, portmod_control_msg_proc_type_t* proc_type);
#endif /* CPRIMOD_SUPPORT */

/* Get Group member information from  the Tx Control Flow Group.. */
#ifdef CPRIMOD_SUPPORT
...
/* Set/Get RSVD4 Single Raw Control Message Configuration.. */
#ifdef CPRIMOD_SUPPORT
...
#endif /* CPRIMOD_SUPPORT */
#ifdef CPRIMOD_SUPPORT
int cpm4x25_rsvd4_tx_single_tunnel_message_config_get(int unit, int port, pm_info_t pm_info, portmod_cpri_crc_option_t* crc_option);
#endif /* CPRIMOD_SUPPORT */
...
/* Set/Get CPRI port RoE frame formation configuration.*/
#ifdef CPRIMOD_SUPPORT
int cpm4x25_cpri_port_frame_config_set(int unit, int port, pm_info_t pm_info, const portmod_cpri_port_frame_config_t* config);
#endif /* CPRIMOD_SUPPORT */
#ifdef CPRIMOD_SUPPORT
int cpm4x25_cpri_port_frame_config_get(int unit, int port, pm_info_t pm_info, portmod_cpri_port_frame_config_t* config);
#endif /* CPRIMOD_SUPPORT */
