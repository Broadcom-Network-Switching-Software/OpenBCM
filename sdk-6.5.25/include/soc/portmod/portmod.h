...
typedef enum portmod_vco_type_e {
    ...
    portmodVCO21P41845 = 28,
    portmodVCO22P09821 = 29,
    portmodVCO22P19145 = 30,
    portmodVCO25P78165 = 31,
    portmodVCO26P56291 = 32,
    portmodVCO27P95249 = 33,
    portmodVCO28P07617 = 34,
    portmodVCO27P95236 = 35,
    portmodVCOCount
} portmod_vco_type_t;
...
/* portmod_pm8x100_fabric_create_info_t initialization and validation */
...
/* portmod_pm8x50_flexe_gen2_create_info_t initialization and validation */
int portmod_pm8x50_flexe_gen2_create_info_t_validate(int unit, const portmod_pm8x50_flexe_gen2_create_info_t* portmod_pm8x50_flexe_gen2_create_info);
int portmod_pm8x50_flexe_gen2_create_info_t_init(int unit, portmod_pm8x50_flexe_gen2_create_info_t* portmod_pm8x50_flexe_gen2_create_info);
...
/* portmod_pm8x100_gen2_create_info_t initialization and validation */
