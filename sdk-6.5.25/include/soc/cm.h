...
#define SOC_CM_CMIC_BAR_START64(_d) ((VOL uint64 *)(SOC_CM_MEMORY_BASE+(SOC_CM_MEMORY_OFFSET*_d)))
#define	CMREAD(_d,_a)	\
	(SOC_CM_CMIC_BAR_START(_d)[(_a)/4])
#define	CMWRITE(_d,_a,_data)	\
	((CMREAD(_d,_a) = _data), _SSOC_CMREAD(_d,_a))
#define CMREAD64(d, a) CMREAD(d, a)
#define CMWRITE64(d, a, data) CMWRITE(d, a, data)
#else
#ifdef	SOC_CM_MEMORY
...
#define	CMWRITE(_d,_a,_data)	\
	((CMREAD(_d,_a) = _data), _SSOC_CMREAD(_d,_a))
#define	CMREAD64(_d,_a)	\
	(*(VOL uint64*)(((VOL uint8*)CMVEC(_d).base_address)+(_a)))
#define	CMWRITE64(_d,_a,_data)	\
	((CMREAD64(_d,_a) = _data), _SSOC_CMREAD(_d,_a))
#else
...
#define	CMREAD64(_d,_a)	\
	(CMVEC(_d).read64(&CMDEV(_d).dev, _a))
#define	CMWRITE64(_d,_a,_data)	\
	((CMVEC(_d).write64(&CMDEV(_d).dev, _a, _data)), _SSOC_CMREAD(_d,_a))
#else
#define SOC_CM_CMIC_BAR_START(_d) ((VOL uint32 *)CMVEC(_d).base_address)
#define SOC_CM_CMIC_BAR_START64(_d) ((VOL uint64 *)CMVEC(_d).base_address)
#define	CMREAD(_d,_a)	\
...
#define	CMWRITE64(_d,_a,_data)	\
	(CMVEC(_d).base_address ? \
	    ((void)(*(VOL uint64*)(((VOL uint8*)CMVEC(_d).base_address)+(_a)) = _data), _SSOC_CMREAD(_d,_a)) : \
	    (CMVEC(_d).write64(&CMDEV(_d).dev, _a, _data), _SSOC_CMREAD(_d,_a)))
