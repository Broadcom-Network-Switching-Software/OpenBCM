...
#define DBAL_ENTRY_ATTR_INVALID          SAL_BIT(7)   
#define DBAL_ENTRY_ATTR_NO_PAYLOAD       SAL_BIT(8)   
...
#define DBAL_ATTR_FLAG_INVALID                   SAL_BIT(0) 
#define DBAL_ATTR_FLAG_NO_PAYLOAD                SAL_BIT(1) 
