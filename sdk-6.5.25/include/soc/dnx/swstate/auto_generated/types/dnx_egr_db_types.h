...
typedef struct {
    ...
    uint8 egr_if_credits_configured[DNX_DATA_MAX_DEVICE_GENERAL_NOF_CORES][DNX_DATA_MAX_EGR_QUEUING_PARAMS_NOF_EGR_INTERFACES];
    
    int total_esb_queues_allocated[DNX_DATA_MAX_DEVICE_GENERAL_NOF_CORES];
    
    int nof_negative_compensation_ports[DNX_DATA_MAX_DEVICE_GENERAL_NOF_CORES];
} dnx_egr_db_t;
