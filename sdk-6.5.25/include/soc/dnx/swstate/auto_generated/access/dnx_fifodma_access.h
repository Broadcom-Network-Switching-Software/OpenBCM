...
typedef int (*dnx_fifodma_info_fifodma_thread_shr_thread_manager_handler_set_cb)(
    int unit, shr_thread_manager_handler_t fifodma_thread_shr_thread_manager_handler);


typedef int (*dnx_fifodma_info_fifodma_thread_shr_thread_manager_handler_get_cb)(
    int unit, shr_thread_manager_handler_t *fifodma_thread_shr_thread_manager_handler);
...
typedef struct {
    dnx_fifodma_info_fifodma_thread_shr_thread_manager_handler_set_cb set;
    dnx_fifodma_info_fifodma_thread_shr_thread_manager_handler_get_cb get;
} dnx_fifodma_info_fifodma_thread_shr_thread_manager_handler_cbs;
...
typedef struct {
    ...
    dnx_fifodma_info_fifodma_thread_shr_thread_manager_handler_cbs fifodma_thread_shr_thread_manager_handler;
