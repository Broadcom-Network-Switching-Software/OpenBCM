...
typedef uint32(
    *dnx_data_field_external_tcam_payload_offset_granularity_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_field_external_tcam_payload_offset_granularity_get_f payload_offset_granularity_get;
...
typedef uint32(
    *dnx_data_field_features_epmf_inlif_profile_map_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_field_features_epmf_inlif_profile_map_get_f epmf_inlif_profile_map_get;
