...
typedef enum
{
    ...
    dnx_data_port_general_is_nrz_supported,
...
typedef uint32(
    *dnx_data_port_general_prt_ibch1_explicit_offset_en_get_f) (
    int unit);
...
typedef uint32(
    *dnx_data_port_general_prt_configuration_ptch2_ibch1_default_index_get_f) (
    int unit);


typedef uint32(
    *dnx_data_port_general_prt_configuration_ptch1_ibch1_default_index_get_f) (
    int unit);


typedef uint32(
    *dnx_data_port_general_prt_configuration_eth_ibch1_default_index_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_port_general_prt_ibch1_explicit_offset_en_get_f prt_ibch1_explicit_offset_en_get;
    ...
    dnx_data_port_general_prt_configuration_ptch2_ibch1_default_index_get_f prt_configuration_ptch2_ibch1_default_index_get;
    
    dnx_data_port_general_prt_configuration_ptch1_ibch1_default_index_get_f prt_configuration_ptch1_ibch1_default_index_get;
    
    dnx_data_port_general_prt_configuration_eth_ibch1_default_index_get_f prt_configuration_eth_ibch1_default_index_get;
