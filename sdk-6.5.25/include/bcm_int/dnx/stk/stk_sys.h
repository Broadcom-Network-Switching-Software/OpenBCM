 ...
 *   * None
 */
shr_error_e dnx_stk_sys_pp_dsp_to_modport_convert(
    int unit,
    bcm_core_t core_id,
    int pp_dsp,
    int *modid,
...
/**
 * \brief
 * Convert core and PP DSP to modport gport
 *
 * \param [in] unit - Unit #
 * \param [in] core_id - local core #
 * \param [in] pp_dsp - PP DSP
 ...
 *   * None
 */
shr_error_e dnx_stk_sys_pp_dsp_to_modport_gport_convert(
    int unit,
    bcm_core_t core_id,
    int pp_dsp,
 ...
 *   * None
 */
shr_error_e dnx_stk_sys_modport_gport_to_pp_dsp_convert(
    int unit,
    bcm_gport_t modport_gport,
    bcm_core_t * core_id,
    int *pp_dsp);
 ...
 *   * None
 */
shr_error_e dnx_stk_sys_modport_to_pp_dsp_convert(
    int unit,
    int modid,
    int ftmh_pp_dsp,
    bcm_core_t * core_id,
 ...
 * \param [in] modid - destination FAP
 * \param [in] ftmh_pp_dsp - destination as appears in FTMH
 *
 * \return
 *     see shr_error_e
 * \remark
 ...
 * \param [in] skip_standalone_state_modify - 0 means standalone_state should be modifies, 1 means standalone_state should not be modifies
 *
 * \return
 *   shr_error_e
 *
