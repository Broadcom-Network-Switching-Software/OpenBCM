 ...
 */
#define DNX_ALGO_PORT_CHANNELS_F_MASK (DNX_ALGO_PORT_CHANNELS_F_TDM_BYPASS_ONLY | DNX_ALGO_PORT_CHANNELS_F_NON_TDM_BYPASS_ONLY | DNX_ALGO_PORT_CHANNELS_F_TDM_BYPASS_OR_L1_ONLY | DNX_ALGO_PORT_CHANNELS_F_PER_OUT_TM)
...
#define _DNX_ALGO_GET_MACRO(a, b, c, d, e, NAME, ...) NAME
#define DNX_ALGO_PORT_TYPE_INCLUDE(...) _DNX_ALGO_GET_MACRO(__VA_ARGS__, _DNX_ALGO_PORT_TYPE_MASK_5, _DNX_ALGO_PORT_TYPE_MASK_4, _DNX_ALGO_PORT_TYPE_MASK_3, _DNX_ALGO_PORT_TYPE_MASK_2, _DNX_ALGO_PORT_TYPE_MASK_1, dummy)(__VA_ARGS__)
/**
...
/**
 * \brief return true if port type represents ETH SAR port
 */
#define DNX_ALGO_PORT_TYPE_IS_ETH_SAR(unit, port_info) (port_info.port_type == DNX_ALGO_PORT_TYPE_ETH_SAR)
/**
 * \brief return true if port type represents OTN SAR port
 */
#define DNX_ALGO_PORT_TYPE_IS_OTN_SAR(unit, port_info) (port_info.port_type == DNX_ALGO_PORT_TYPE_OTN_SAR)
/**
 * \brief return true if port type represents Flexe/ETH/OTN SAR port
 */
#define DNX_ALGO_PORT_TYPE_IS_SAR(unit, port_info) \
    ((port_info.port_type == DNX_ALGO_PORT_TYPE_FLEXE_SAR) \
    || (port_info.port_type == DNX_ALGO_PORT_TYPE_ETH_SAR) \
    || (port_info.port_type == DNX_ALGO_PORT_TYPE_OTN_SAR))
/**
