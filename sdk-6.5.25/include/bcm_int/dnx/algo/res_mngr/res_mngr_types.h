 ...
 *   please update the array that represent the enum by strings in
 *   dnx_algo_resource_ADVANCED_ALGORITHM_str in resource_tag_bitmap.c
 */
typedef enum
{
    ...
    DNX_ALGO_RESOURCE_ADVANCED_ALGORITHM_FLOW_INLIF_ALGO,
