...
/**
 * implemented by: multicast_db_group_is_sar_set
 */
typedef int (*multicast_db_group_is_sar_set_cb)(
    int unit, dnx_algo_res_t group_is_sar);

/**
 * implemented by: multicast_db_group_is_sar_get
 */
typedef int (*multicast_db_group_is_sar_get_cb)(
    int unit, dnx_algo_res_t *group_is_sar);

/**
 * implemented by: multicast_db_group_is_sar_create
 */
typedef int (*multicast_db_group_is_sar_create_cb)(
    int unit, dnx_algo_res_create_data_t * data, void *extra_arguments);

/**
 * implemented by: multicast_db_group_is_sar_allocate_single
 */
typedef int (*multicast_db_group_is_sar_allocate_single_cb)(
    int unit, uint32 flags, void *extra_arguments, int *element);

/**
 * implemented by: multicast_db_group_is_sar_allocate_several
 */
typedef int (*multicast_db_group_is_sar_allocate_several_cb)(
    int unit, uint32 flags, uint32 nof_elements, void *extra_arguments, int *element);

/**
 * implemented by: multicast_db_group_is_sar_free_single
 */
typedef int (*multicast_db_group_is_sar_free_single_cb)(
    int unit, int element, void *extra_arguments);

/**
 * implemented by: multicast_db_group_is_sar_free_several
 */
typedef int (*multicast_db_group_is_sar_free_several_cb)(
    int unit, uint32 nof_elements, int element, void *extra_arguments);

/**
 * implemented by: multicast_db_group_is_sar_is_allocated
 */
typedef int (*multicast_db_group_is_sar_is_allocated_cb)(
    int unit, int element, uint8 *is_allocated);

/**
 * implemented by: multicast_db_group_is_sar_clear
 */
typedef int (*multicast_db_group_is_sar_clear_cb)(
    int unit);

/**
 * implemented by: multicast_db_group_is_sar_nof_free_elements_get
 */
typedef int (*multicast_db_group_is_sar_nof_free_elements_get_cb)(
    int unit, int *nof_free_elements);

/**
 * implemented by: multicast_db_group_is_sar_get_next
 */
typedef int (*multicast_db_group_is_sar_get_next_cb)(
    int unit, int *element);

/**
 * implemented by: multicast_db_group_is_sar_dump_info_get
 */
typedef int (*multicast_db_group_is_sar_dump_info_get_cb)(
    int unit, dnx_algo_res_dump_data_t * info);

/**
 * implemented by: multicast_db_group_is_sar_nof_allocated_elements_in_range_get
 */
typedef int (*multicast_db_group_is_sar_nof_allocated_elements_in_range_get_cb)(
    int unit, int range_start, int nof_elements_in_range, int *nof_allocated_elements);

/**
 * implemented by: multicast_db_group_is_sar_advanced_algorithm_info_set
 */
typedef int (*multicast_db_group_is_sar_advanced_algorithm_info_set_cb)(
    int unit, void *algorithm_info);

/**
 * implemented by: multicast_db_group_is_sar_advanced_algorithm_info_get
 */
typedef int (*multicast_db_group_is_sar_advanced_algorithm_info_get_cb)(
    int unit, void *algorithm_info);

/**
 * implemented by: multicast_db_key_2_mcdb_id_hash_create
 */
typedef int (*multicast_db_key_2_mcdb_id_hash_create_cb)(
    int unit, sw_state_htbl_init_info_t *init_info);

/**
 * implemented by: multicast_db_key_2_mcdb_id_hash_find
 */
typedef int (*multicast_db_key_2_mcdb_id_hash_find_cb)(
    int unit, const mcdb_hash_table_key_t *key, uint32 *value, uint8 *found);

/**
 * implemented by: multicast_db_key_2_mcdb_id_hash_insert
 */
typedef int (*multicast_db_key_2_mcdb_id_hash_insert_cb)(
    int unit, const mcdb_hash_table_key_t *key, const uint32 *value, uint8 *success);

/**
 * implemented by: multicast_db_key_2_mcdb_id_hash_get_next
 */
typedef int (*multicast_db_key_2_mcdb_id_hash_get_next_cb)(
    int unit, SW_STATE_HASH_TABLE_ITER *iter, const mcdb_hash_table_key_t *key, const uint32 *value);

/**
 * implemented by: multicast_db_key_2_mcdb_id_hash_clear
 */
typedef int (*multicast_db_key_2_mcdb_id_hash_clear_cb)(
    int unit);

/**
 * implemented by: multicast_db_key_2_mcdb_id_hash_delete
 */
...
/**
 * This structure holds the access functions for the variable group_is_sar
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable key_2_mcdb_id_hash
 */
typedef struct {
    ...
    multicast_db_key_2_mcdb_id_hash_clear_cb clear;
...
typedef struct {
    ...
    /**
     * Access struct for group_is_sar
     */
    multicast_db_group_is_sar_cbs group_is_sar;
    /**
     * Access struct for key_2_mcdb_id_hash
     */
