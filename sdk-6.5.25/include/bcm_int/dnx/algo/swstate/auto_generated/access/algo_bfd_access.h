...
#ifdef BCM_DNX2_SUPPORT
/**
 * implemented by: algo_bfd_db_bfd_oamp_v1_seamless_udp_sport_set
 */
typedef int (*algo_bfd_db_bfd_oamp_v1_seamless_udp_sport_set_cb)(
    int unit, dnx_algo_template_t bfd_oamp_v1_seamless_udp_sport);
#endif /*BCM_DNX2_SUPPORT*/

#ifdef BCM_DNX2_SUPPORT
/**
 * implemented by: algo_bfd_db_bfd_oamp_v1_seamless_udp_sport_get
 */
typedef int (*algo_bfd_db_bfd_oamp_v1_seamless_udp_sport_get_cb)(
    int unit, dnx_algo_template_t *bfd_oamp_v1_seamless_udp_sport);
#endif /*BCM_DNX2_SUPPORT*/

#ifdef BCM_DNX2_SUPPORT
/**
 * implemented by: algo_bfd_db_bfd_oamp_v1_seamless_udp_sport_create
 */
typedef int (*algo_bfd_db_bfd_oamp_v1_seamless_udp_sport_create_cb)(
    int unit, dnx_algo_template_create_data_t * data, void *extra_arguments);
#endif /*BCM_DNX2_SUPPORT*/

#ifdef BCM_DNX2_SUPPORT
/**
 * implemented by: algo_bfd_db_bfd_oamp_v1_seamless_udp_sport_allocate_single
 */
typedef int (*algo_bfd_db_bfd_oamp_v1_seamless_udp_sport_allocate_single_cb)(
    int unit, uint32 flags, uint16 *profile_data, void *extra_arguments, int *profile, uint8 *first_reference);
#endif /*BCM_DNX2_SUPPORT*/

#ifdef BCM_DNX2_SUPPORT
/**
 * implemented by: algo_bfd_db_bfd_oamp_v1_seamless_udp_sport_free_single
 */
typedef int (*algo_bfd_db_bfd_oamp_v1_seamless_udp_sport_free_single_cb)(
    int unit, int profile, uint8 *last_reference);
#endif /*BCM_DNX2_SUPPORT*/

#ifdef BCM_DNX2_SUPPORT
/**
 * implemented by: algo_bfd_db_bfd_oamp_v1_seamless_udp_sport_profile_data_get
 */
typedef int (*algo_bfd_db_bfd_oamp_v1_seamless_udp_sport_profile_data_get_cb)(
    int unit, int profile, int *ref_count, uint16 *profile_data);
#endif /*BCM_DNX2_SUPPORT*/
...
#ifdef BCM_DNX2_SUPPORT
/**
 * This structure holds the access functions for the variable bfd_oamp_v1_seamless_udp_sport
 */
typedef struct {
    algo_bfd_db_bfd_oamp_v1_seamless_udp_sport_set_cb set;
    algo_bfd_db_bfd_oamp_v1_seamless_udp_sport_get_cb get;
    algo_bfd_db_bfd_oamp_v1_seamless_udp_sport_create_cb create;
    algo_bfd_db_bfd_oamp_v1_seamless_udp_sport_allocate_single_cb allocate_single;
    algo_bfd_db_bfd_oamp_v1_seamless_udp_sport_free_single_cb free_single;
    algo_bfd_db_bfd_oamp_v1_seamless_udp_sport_profile_data_get_cb profile_data_get;
} algo_bfd_db_bfd_oamp_v1_seamless_udp_sport_cbs;
#endif /*BCM_DNX2_SUPPORT*/
...
#ifdef BCM_DNX2_SUPPORT
    /**
     * Access struct for bfd_oamp_v1_seamless_udp_sport
     */
    algo_bfd_db_bfd_oamp_v1_seamless_udp_sport_cbs bfd_oamp_v1_seamless_udp_sport;
#endif /*BCM_DNX2_SUPPORT*/
#ifdef BCM_DNX2_SUPPORT
    /**
