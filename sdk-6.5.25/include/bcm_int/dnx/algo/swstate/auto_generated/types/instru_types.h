...
/**
 * SW structs for Synched Trigger Config.
 */
typedef struct {
    /**
     * configuration flags
    ...
    uint32 flags;
    /**
     * ns value for start time
     */
    uint64 start_time;
    /**
     * number of nanoseconds between triggers
     */
    ...
    uint32 nof_triggers;
    /**
     * trigger status 1- enable, 0 - disable.
     */
    uint32 enable;
