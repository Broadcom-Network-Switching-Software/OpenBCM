...
/** Defines for encoding the elements of the hash key.of
  * hash table for destination to MCDB entry mapping
  * Construct the 80bit key for the hash table from the
  * following elements:
     * 18-0  -> Destination
     * 19-23 -> Reference number
     * 24-25 -> Destination type
     * 26-57 -> Encapsulation ID
     * 58-76 -> Group ID
     * 77    -> Is_Ingress
     * 78-79 -> Core ID */
#define DNX_MULTICAST_HASH_KEY_DESTINATION_START_BIT 0
#define DNX_MULTICAST_HASH_KEY_DESTINATION_NOF_BITS 19
#define DNX_MULTICAST_HASH_KEY_REFERENCE_NUM_START_BIT 19
#define DNX_MULTICAST_HASH_KEY_REFERENCE_NUM_NOF_BITS 5
#define DNX_MULTICAST_HASH_KEY_DESTINATION_TYPE_START_BIT 24
#define DNX_MULTICAST_HASH_KEY_DESTINATION_TYPE_NOF_BITS 2
#define DNX_MULTICAST_HASH_KEY_ENCAPSULATION_ID_START_BIT 26
#define DNX_MULTICAST_HASH_KEY_ENCAPSULATION_ID_NOF_BITS 32
#define DNX_MULTICAST_HASH_KEY_GROUP_ID_START_BIT 58
#define DNX_MULTICAST_HASH_KEY_GROUP_ID_NOF_BITS 19
#define DNX_MULTICAST_HASH_KEY_IS_INGRESS_START_BIT 77
#define DNX_MULTICAST_HASH_KEY_IS_INGRESS_NOF_BITS 1
#define DNX_MULTICAST_HASH_KEY_CORE_ID_START_BIT 78
#define DNX_MULTICAST_HASH_KEY_CORE_ID_NOF_BITS 2
