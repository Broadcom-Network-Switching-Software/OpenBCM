...
/**
 * \brief - Set Queue id for queue manual operation.
 *
 * \param [in] unit - unit index
 * \param [in] core - device core id
 ...
 *   * None
 */
shr_error_e dnx_iqs_queue_manual_operation_queue_id_set(
    int unit,
    int core,
    uint32 voq);

/**
 * \brief - Trigger manual credit
 * (Queue id to be flushed is specified in dnx_iqs_queue_manual_operation_queue_id_set)
 *
 * \param [in] unit - unit index
 * \param [in] core - device core id
 * \param [in] enable - trigger the manual credit
 *
 * \return
 *   shr_error_e
 * \see
 *   * None
 */
shr_error_e dnx_iqs_queue_manual_credit_trigger_set(
    int unit,
    int core,
    uint32 enable);
...
/**
 * \brief -
 * Polling manual credit process is done
 *
 * \param [in] unit -  Unit-ID
 * \param [in] core - device core id
 *
 ...
 *   * None
 */
shr_error_e dnx_iqs_queue_manual_credit_trigger_down_polling(
    int unit,
    int core);
...
/**
 * \brief -
 * Enable/disable profile as delete profile
 *
 * \param [in] unit -  Unit-ID
 * \param [in] profile_id - credit request profile id
 * \param [in] enable - enable delete profile
 *
 * \return
 *   See shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_iqs_delete_profile_set(
    int unit,
    int profile_id,
    uint32 enable);
 ...
 * \param [in] unit -  Unit-ID
 * \param [in] profile_id - credit request profile id
 * \param [in] enable - is delete profile
 *
 * \return
 *   See shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_iqs_delete_profile_get(
    int unit,
    int *profile_id,
    uint32 *enable);
 ...
 */
shr_error_e dnx_iqs_credit_request_credit_balance_resolution_get(
    int unit,
