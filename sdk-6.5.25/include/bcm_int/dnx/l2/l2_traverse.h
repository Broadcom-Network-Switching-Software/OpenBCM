...
/**
 * \brief - Creates the l2 traverse semaphore
 *  this semaphore protects  the overflow buffer that can be accessed by the main thread and the traverse thread
 *
 * \param [in] unit - unit id
 *
 * \return
 ...
 *   * None
 */
shr_error_e dnx_l2_traverse_thread_sem_create(
    int unit);

/**
 * \brief - Destroys the l2 traverse semaphore
 *
 * \param [in] unit - unit id
 *
 * \return
 ...
 */
void dnx_l2_traverse_thread_sem_destroy(
    int unit);
