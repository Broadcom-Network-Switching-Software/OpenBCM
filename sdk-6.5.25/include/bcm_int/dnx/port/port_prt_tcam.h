 ...
 * {
 */
/** define PRT tcam app db id */
#define PRT_TCAM_APP_DB_COE                             4
#define PRT_TCAM_APP_DB_PON                             10
 ...
 * \param [in] fc_chan_id - COE FC channel ID
 ...
 * \param [out] fc_chan_id - coe FC channel ID
 *
 * \return
 *   \retval  Zero if no error was detected
 *   \retval  Negative if error was detected. See \ref shr_error_e
 ...
 * \param [in] pp_port - Result.pp_port of TCAM entry
 * \param [in] sys_port - Result.sys_port of TCAM entry, useless for COE
 * \param [in] fc_chan_id - FC channel ID
 *
 * \return
 *   \retval  Zero if no error was detected
 *   \retval  Negative if error was detected. See \ref shr_error_e
