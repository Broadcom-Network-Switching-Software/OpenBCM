...
#define TD3X1_MAX_VS_CONFIG   8
static i2c_ltc_t sense_resistor_config_56175[TD3X1_MAX_VS_CONFIG]={
    { 0, "Analog",   I2C_LTC2974_63, I2C_LTC2974_CH0, 0xDA80,  0 },
    { 1, "0.8V",     I2C_LTC2974_63, I2C_LTC2974_CH1, 0xEA20,  0 },
    { 2, "1.2V",     I2C_LTC2974_63, I2C_LTC2974_CH2, 0xEA20,  0 },
    { 3, "1.8V",     I2C_LTC2974_63, I2C_LTC2974_CH3, 0xEA20,  0 },
    { 4, "2.5V",     I2C_LTC2974_64, I2C_LTC2974_CH0, 0xEA20,  0 },
    { 5, "3.3V_Dut", I2C_LTC2974_64, I2C_LTC2974_CH1, 0xDA80,  0 },
    { 6, "3.3V",     I2C_LTC2974_64, I2C_LTC2974_CH2, 0xDA80,  0 },
    { 7, "5.0V",     I2C_LTC2974_64, I2C_LTC2974_CH3, 0xEA20,  0 }
};
...
static _ltc_board_resistor_map_t board_resistor_map[] = {
    ...
    {27, sense_resistor_config_56175},   /* TRIDENT3X1(G69) */
};
              ...
              void* data, int len)
{
    ...
    sal_mutex_take(ioctl_lock, sal_mutex_FOREVER);
     ...
     switch (opcode) {
	     ...
	     if ((SOC_CONTROL(unit)->board_type != 0x98) && (SOC_CONTROL(unit)->board_type != 0xAA) &&
                 ...
                 (SOC_CONTROL(unit)->board_type != 0xC0) && (SOC_CONTROL(unit)->board_type != 0xCD) &&
                 (SOC_CONTROL(unit)->board_type != 0xCE)) {
     ...
     || defined(BCM_FIRELIGHT_SUPPORT) || defined(BCM_FIREBOLT6_SUPPORT)
             if ((SOC_CONTROL(unit)->board_type == 0x98)  || (SOC_CONTROL(unit)->board_type == 0xAA) ||
                  ...
                  (SOC_CONTROL(unit)->board_type == 0xCD) || (SOC_CONTROL(unit)->board_type == 0xCE)) {
                  data8 =0x1E;
             }
#endif
    ...
    || defined(BCM_FIRELIGHT_SUPPORT) || defined(BCM_FIREBOLT6_SUPPORT)
                 ...
                 (SOC_CONTROL(unit)->board_type == 0xCE))
             {
                 ...
                 if ((SOC_CONTROL(unit)->board_type == 0xB0) || (SOC_CONTROL(unit)->board_type == 0xB3) ||
                     (SOC_CONTROL(unit)->board_type == 0xB6) || (SOC_CONTROL(unit)->board_type == 0xBB) ||
                     (SOC_CONTROL(unit)->board_type == 0xBC) || (SOC_CONTROL(unit)->board_type == 0xBF) ||
                     (SOC_CONTROL(unit)->board_type == 0xC2) || (SOC_CONTROL(unit)->board_type == 0xCD) ||
                     (SOC_CONTROL(unit)->board_type == 0xCE)) {
    ...
    case I2C_LTC_IOC_SET_VOUT:
        ...
        if (DEV_DAC_PARAMS(dev)) {
            ...
            if ((SOC_CONTROL(unit)->board_type == 0xCD) ||
                (SOC_CONTROL(unit)->board_type == 0xCE)) {
                max_vs_config = TD3X1_MAX_VS_CONFIG;
            }
