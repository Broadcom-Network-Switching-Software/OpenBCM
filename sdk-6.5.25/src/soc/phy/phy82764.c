 ...
 */
STATIC int
_phy82764_is_write_disabled(void* user_acc,  uint32_t *val)
{
...
phy82764_probe(int unit, phy_ctrl_t *pc)
{
    ...
    core_bus.is_write_disabled = _phy82764_is_write_disabled;
