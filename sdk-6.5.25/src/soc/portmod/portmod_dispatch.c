...
{        
    SOC_INIT_FUNC_DEFS;
    if(portmod_pm8x50_flexe_gen2_create_info == NULL) {
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("NULL parameter"));
    }
...
{        
    ...
    if(portmod_pm8x50_flexe_gen2_create_info == NULL){
        _SOC_EXIT_WITH_ERR(SOC_E_PARAM, ("portmod_pm8x50_flexe_gen2_create_info NULL parameter"));
    }
    sal_memset(portmod_pm8x50_flexe_gen2_create_info, 0, sizeof(portmod_pm8x50_flexe_gen2_create_info_t));
    portmod_pm8x50_flexe_gen2_create_info->ref_clk = phymodRefClkCount;
    phymod_phy_access_t_init(&portmod_pm8x50_flexe_gen2_create_info->access);
    phymod_lane_map_t_init(&portmod_pm8x50_flexe_gen2_create_info->lane_map);
    portmod_pm8x50_flexe_gen2_create_info->fw_load_method = phymodFirmwareLoadMethodCount;
    portmod_pm8x50_flexe_gen2_create_info->external_fw_loader = NULL;
    portmod_pm8x50_flexe_gen2_create_info->portmod_mac_soft_reset = NULL;
    portmod_pm8x50_flexe_gen2_create_info->core_num = 0;
    phymod_afe_pll_t_init(&portmod_pm8x50_flexe_gen2_create_info->afe_pll);
    portmod_pm8x50_flexe_gen2_create_info->is_master_pm = -1;
    portmod_pm8x50_flexe_gen2_create_info->pm_offset = 0;
    portmod_pm8x50_flexe_gen2_create_info->flexible_pll_required = 0;
