...
int pm12x10_port_faults_status_get(int unit, int port, pm_info_t pm_info,
                                   portmod_port_fault_status_t* faults)
{
    ...
    _SOC_IF_ERR_EXIT(
        PM_4X25_DRIVER(pm_info)->f_portmod_port_local_fault_status_get(unit,
                                         port, PM_4X25_INFO(pm_info),
                                         &faults->local));

    _SOC_IF_ERR_EXIT(
        PM_4X25_DRIVER(pm_info)->f_portmod_port_remote_fault_status_get(unit,
                                         port, PM_4X25_INFO(pm_info),
                                         &faults->remote));
