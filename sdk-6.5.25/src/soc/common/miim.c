 ...
 */
int 
soc_rcpu_miim_write(int unit, uint32 phy_id,
...
int
soc_rcpu_miim_read(int unit, uint32 phy_id,
...
int 
soc_rcpu_miimc45_write(int unit, uint32 phy_id, uint8 phy_devad,
...
int
soc_rcpu_miimc45_read(int unit, uint32 phy_id, uint8 phy_devad,
...
int
soc_miim_modify(int unit, uint32 phy_id, uint16 phy_reg_addr, 
...
int
soc_miimc45_modify(int unit, uint32 phy_id, uint8 phy_devad,
...
int 
soc_miim_write(int unit, uint32 phy_id,
               uint8 phy_reg_addr, uint16 phy_wr_data)
{
    int                 rv = SOC_E_NONE;
...
int
soc_miim_read(int unit, uint32 phy_id,
              uint8 phy_reg_addr, uint16 *phy_rd_data)
{
    int                 rv = SOC_E_NONE;
#if defined(BCM_ESW_SUPPORT) || defined(BCM_DFE_SUPPORT)
...
int 
__soc_miimc45_write(int unit, uint32 phy_id, uint8 phy_devad,
...
int
soc_miimc45_write(int unit, uint32 phy_id, uint8 phy_devad,
                  uint16 phy_reg_addr, uint16 phy_wr_data)
{
...
int
soc_miimc45_read(int unit, uint32 phy_id, uint8 phy_devad,
                 uint16 phy_reg_addr, uint16 *phy_rd_data)
{
    int                 rv = SOC_E_NONE;
    assert(!sal_int_context());
...
int
soc_sbus_mdio_write(int unit, uint32 phy_id,
...
int
soc_sbus_mdio_read(int unit, uint32 phy_id,
