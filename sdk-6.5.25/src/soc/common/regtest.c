                             ...
                             ser_reg_test_data_t *reg_test_data)
{
    ...
    sal_strlcpy(reg_test_data->reg_name, SOC_REG_NAME(unit, reg_test_data->reg), sizeof(reg_test_data->reg_name));
    /* coverity[secure_coding] */
    sal_strlcpy(reg_test_data->field_name,
               _SER_TEST_REG_SOC_FIELD_NAME(unit, reg_test_data->test_field), sizeof(reg_test_data->field_name));
#else
