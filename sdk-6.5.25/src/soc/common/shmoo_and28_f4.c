 ...
 *
 * 28nm DDR PHY F4 version Support
 */
...
#ifdef BCM_AND28_F4_SUPPORT
#include <soc/shmoo_and28.h>
#include <soc/phy/phy_and28_f4.h>
#include <soc/phy/ydc_ddr_bist.h>
#define SOC_DDR4_SUPPORT
#define PHY_AND28_F4
/* #define PHY_AND28_F2 if not B0 chip */
#define SHMOO_AND28_PHY_BITWIDTH_IS_32          ABC

static and28_f4_shmoo_dram_info_t shmoo_dram_info =
{
    /*.ctl_type =*/ 0,
    /*.dram_type =*/ 0,
...
static const uint32 shmoo_order_and28_ddr3[SHMOO_AND28_DDR3_ECC_32P4_SEQUENCE_COUNT] =
{
    SHMOO_AND28_RD_EN,
    ...
    SHMOO_AND28_RD_EN_ECC,
    SHMOO_AND28_RD_EXTENDED_ECC,
    SHMOO_AND28_WR_EXTENDED_ECC
};

static const uint32 shmoo_order_and28_ddr3l[SHMOO_AND28_DDR3L_ECC_32P4_SEQUENCE_COUNT] =
{
    SHMOO_AND28_RD_EN,
    SHMOO_AND28_RD_EXTENDED,
    SHMOO_AND28_WR_EXTENDED,
...
static const uint32 shmoo_order_and28_ddr4[SHMOO_AND28_DDR4_ECC_32P4_SEQUENCE_COUNT] =
{
    SHMOO_AND28_RD_EN,
    SHMOO_AND28_RD_EXTENDED,
    SHMOO_AND28_WR_EXTENDED,
...
_initialize_bist(int unit, int phy_ndx, int bit, and28_shmoo_container_t *scPtr)
{
    ...
    switch ((*scPtr).shmooType) {
        ...
        case SHMOO_AND28_RD_EN_ECC:
            ...
            bist_info.prbs_mode = 1;
            break;
        case SHMOO_AND28_RD_EXTENDED_ECC:
            bist_info.write_weight = 255;
            bist_info.read_weight = 255;
            bist_info.bist_timer_us = 0;
            bist_info.bist_num_actions = 51510;
            ...
            bist_info.prbs_mode = 1;
            break;
        case SHMOO_AND28_WR_EXTENDED_ECC:
            bist_info.write_weight = 255;
            bist_info.read_weight = 255;
            bist_info.bist_timer_us = 0;
            bist_info.bist_num_actions = 51510;
    ...
    return soc_gh2_ydc_ddr_bist_config_set(unit, phy_ndx, &bist_info);
}
...
_run_bist(int unit, int phy_ndx, and28_shmoo_container_t *scPtr, and28_shmoo_error_array_t *seaPtr)
{
    ...
    switch ((*scPtr).shmooType) {
        case SHMOO_AND28_RD_EN:
            SOC_IF_ERROR_RETURN(soc_gh2_ydc_ddr_bist_run(unit, phy_ndx, &be));
        ...
        case SHMOO_AND28_CTRL_EXTENDED:
            ...
            break;
        case SHMOO_AND28_RD_EN_ECC:
            iproc28_clear_ecc_syndrome(unit);
            SOC_IF_ERROR_RETURN(soc_gh2_ydc_ddr_bist_run(unit, phy_ndx, &be));

            if(be.bist_err_occur || iproc28_read_ecc_syndrome(unit))
            {
                (*seaPtr)[0] = 0xFFFFFFFF;
            }
            else
...
_shmoo_and28_rd_en(int unit, int phy_ndx, and28_shmoo_container_t *scPtr)
{
    ...
    for(y = yCapMin; y < yCapMax; y++)
    {
        ...
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQ0Pr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQ0Nr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQ1Pr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQ1Nr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQ2Pr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQ2Nr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQ3Pr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQ3Nr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQ4Pr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQ4Nr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQ5Pr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQ5Nr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQ6Pr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQ6Nr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQ7Pr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQ7Nr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQ7Pr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DMPr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DMNr(unit, data));

        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQ0Pr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQ0Nr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQ1Pr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQ1Nr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQ2Pr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQ2Nr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQ3Pr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQ3Nr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQ4Pr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQ4Nr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQ5Pr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQ5Nr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQ6Pr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQ6Nr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQ7Pr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQ7Nr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQ7Pr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DMPr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DMNr(unit, data));

        if(shmoo_dram_info.interface_bitwidth == 32)
        {
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQ0Pr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQ0Nr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQ1Pr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQ1Nr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQ2Pr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQ2Nr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQ3Pr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQ3Nr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQ4Pr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQ4Nr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQ5Pr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQ5Nr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQ6Pr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQ6Nr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQ7Pr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQ7Nr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQ7Pr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DMPr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DMNr(unit, data));

            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQ0Pr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQ0Nr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQ1Pr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQ1Nr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQ2Pr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQ2Nr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQ3Pr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQ3Nr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQ4Pr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQ4Nr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQ5Pr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQ5Nr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQ6Pr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQ6Nr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQ7Pr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQ7Nr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQ7Pr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DMPr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DMNr(unit, data));
        }
        ...
        for(x = 0; x < (*scPtr).sizeX; x++)
        {
            ...
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_EN_CS0r(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_EN_CS0r(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_EN_CS1r(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_EN_CS1r(unit, data));

            if(shmoo_dram_info.interface_bitwidth == 32)
            {
                SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_EN_CS0r(unit, data));
                SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_EN_CS0r(unit, data));
                SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_EN_CS1r(unit, data));
                SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_EN_CS1r(unit, data));
            }

            data = 0;
            DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_BYTE_LANE_0, READ_FIFO_CLEAR, CLEAR, 1);
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_READ_FIFO_CLEARr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_READ_FIFO_CLEARr(unit, data));

            if(shmoo_dram_info.interface_bitwidth == 32)
            {
                SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_READ_FIFO_CLEARr(unit, data));
                SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_READ_FIFO_CLEARr(unit, data));
            }

#if (defined(PHY_AND28_F4))
            if(shmoo_dram_info.ecc_32p4)
            {
                SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_READ_FIFO_CLEARr(unit, data));
            }
#endif
...
static int
_shmoo_and28_rd_en_ecc(int unit, int phy_ndx, and28_shmoo_container_t *scPtr)
{
#if (defined(PHY_AND28_F4))
    uint32 x;
    uint32 y;
    ...
    (*scPtr).yCapMin = yCapMin;
    (*scPtr).yCapMax = yCapMax;
    (*scPtr).shmooType = SHMOO_AND28_RD_EN_ECC;
    ...
    {
        data = 0;
        DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_ECC_LANE, VDL_CONTROL_RD_DQ0P, FORCE, 1);
        DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_ECC_LANE, VDL_CONTROL_RD_DQ0P, VDL_STEP, y << jump);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ0Pr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ0Nr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ1Pr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ1Nr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ2Pr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ2Nr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ3Pr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ3Nr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ4Pr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ4Nr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ5Pr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ5Nr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ6Pr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ6Nr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ7Pr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ7Nr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DMPr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DMNr(unit, data));

        for(x = 0; x < (*scPtr).sizeX; x++)
        {
            data = 0;
            DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_ECC_LANE, VDL_CONTROL_RD_EN_CS0, FORCE, 1);
            DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_ECC_LANE, VDL_CONTROL_RD_EN_CS0, VDL_STEP, x);

            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_EN_CS0r(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_EN_CS1r(unit, data));
...
_shmoo_and28_wr_extended(int unit, int phy_ndx, and28_shmoo_container_t *scPtr)
{
    ...
    for(x = 0; x < (*scPtr).sizeX; x++)
    {
        ...
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_WR_DQ0r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_WR_DQ1r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_WR_DQ2r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_WR_DQ3r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_WR_DQ4r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_WR_DQ5r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_WR_DQ6r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_WR_DQ7r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_WR_DMr(unit, data));

        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_WR_DQ0r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_WR_DQ1r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_WR_DQ2r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_WR_DQ3r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_WR_DQ4r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_WR_DQ5r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_WR_DQ6r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_WR_DQ7r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_WR_DMr(unit, data));

        if(shmoo_dram_info.interface_bitwidth == 32)
        {
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_WR_DQ0r(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_WR_DQ1r(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_WR_DQ2r(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_WR_DQ3r(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_WR_DQ4r(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_WR_DQ5r(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_WR_DQ6r(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_WR_DQ7r(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_WR_DMr(unit, data));

            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_WR_DQ0r(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_WR_DQ1r(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_WR_DQ2r(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_WR_DQ3r(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_WR_DQ4r(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_WR_DQ5r(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_WR_DQ6r(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_WR_DQ7r(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_WR_DMr(unit, data));
        }
...
static int
_shmoo_and28_wr_extended_ecc(int unit, int phy_ndx, and28_shmoo_container_t *scPtr)
{
#if (defined(PHY_AND28_F4))
    uint32 x;
    uint32 data;
    ...
    (*scPtr).yCapMin = 0;
    (*scPtr).yCapMax = 1;
    (*scPtr).shmooType = SHMOO_AND28_WR_EXTENDED_ECC;
    ...
    {
        data = 0;
        DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_ECC_LANE, VDL_CONTROL_WR_DQ0, FORCE, 1);
        DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_ECC_LANE, VDL_CONTROL_WR_DQ0, VDL_STEP, x);

        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_WR_DQ0r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_WR_DQ1r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_WR_DQ2r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_WR_DQ3r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_WR_DQ4r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_WR_DQ5r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_WR_DQ6r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_WR_DQ7r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_WR_DMr(unit, data));
...
_shmoo_and28_rd_extended(int unit, int phy_ndx, and28_shmoo_container_t *scPtr)
{
    ...
    rd_dqs_pos2 = rd_dqs_pos3 = rd_en_pos2 = rd_en_pos3 = rd_dqs_delta2 = rd_dqs_delta3 = 0;
    ...
    SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQSPr(unit, data));
    SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQSNr(unit, data));
    SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQSPr(unit, data));
    SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQSNr(unit, data));

    if(shmoo_dram_info.interface_bitwidth == 32)
    {
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQSPr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQSNr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQSPr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQSNr(unit, data));
    }
    ...
    for(y = yCapMin; y < yCapMax; y++)
    {
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VREF_DAC_CONTROLr(unit, &data));
        ...
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VREF_DAC_CONTROLr(unit, data));
...
static int
_shmoo_and28_rd_extended_ecc(int unit, int phy_ndx, and28_shmoo_container_t *scPtr)
{
#if (defined(PHY_AND28_F4))
    uint32 x;
    uint32 y;
    ...
    (*scPtr).yCapMax = yCapMax;
    (*scPtr).yJump = 0;
    (*scPtr).shmooType = SHMOO_AND28_RD_EXTENDED_ECC;

    SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQSPr(unit, &data));
    rd_dqs_pos4 = DDR_PHY_GET_FIELD(data, DDR34_CORE_PHY_ECC_LANE, VDL_CONTROL_RD_DQSP, VDL_STEP);

    SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_EN_CS0r(unit, &data));
    rd_en_pos4 = DDR_PHY_GET_FIELD(data, DDR34_CORE_PHY_ECC_LANE, VDL_CONTROL_RD_EN_CS0, VDL_STEP);

    _initialize_bist(unit, phy_ndx, -1, scPtr);

    x = 0;
    data = 0;
    DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_ECC_LANE, VDL_CONTROL_RD_DQSP, FORCE, 1);
    DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_ECC_LANE, VDL_CONTROL_RD_DQSP, VDL_STEP, x);

    SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQSPr(unit, data));
    SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQSNr(unit, data));
    ...
    if(temp & 0x80000000)
    {
        DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_ECC_LANE, VDL_CONTROL_RD_EN_CS0, VDL_STEP, 0);
    }
    else if(temp >= SHMOO_AND28_MAX_VDL_LENGTH)
    {
        DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_ECC_LANE, VDL_CONTROL_RD_EN_CS0, VDL_STEP, SHMOO_AND28_MAX_VDL_LENGTH - 1);
    }
    else
    {
        DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_ECC_LANE, VDL_CONTROL_RD_EN_CS0, VDL_STEP, temp);
    }
    SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_EN_CS0r(unit, data));
    SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_EN_CS1r(unit, data));
    ...
    for(x = 0; x < (*scPtr).sizeX; x++)
    {
        data = 0;
        DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_ECC_LANE, VDL_CONTROL_RD_DQ0P, FORCE, 1);
        DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_ECC_LANE, VDL_CONTROL_RD_DQ0P, VDL_STEP, x);
        if(rd_dq_fail_count4 <= SHMOO_AND28_RD_DQ_FAIL_CAP)
        {
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ0Pr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ0Nr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ1Pr(unit, data));
...
_shmoo_and28_addr_extended(int unit, int phy_ndx, and28_shmoo_container_t *scPtr)
{
    ...
    for(x = 0; x < (*scPtr).sizeX; x++)
    {
        ...
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AD00r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AD01r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AD02r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AD03r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AD04r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AD05r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AD06r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AD07r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AD08r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AD09r(unit, data));
...
_shmoo_and28_ctrl_extended(int unit, int phy_ndx, and28_shmoo_container_t *scPtr)
{
    ...
    for(x = 0; x < (*scPtr).sizeX; x++)
    {
        ...
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AD10r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AD11r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AD12r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AD13r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AD14r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AD15r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VDL_CONTROL_BA0r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VDL_CONTROL_BA1r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VDL_CONTROL_BA2r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AUX0r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AUX1r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AUX2r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VDL_CONTROL_CS0r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VDL_CONTROL_CS1r(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VDL_CONTROL_PARr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VDL_CONTROL_RAS_Nr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VDL_CONTROL_CAS_Nr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VDL_CONTROL_CKEr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VDL_CONTROL_RST_Nr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VDL_CONTROL_ODTr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VDL_CONTROL_WE_Nr(unit, data));
...
_shmoo_and28_do(int unit, int phy_ndx, and28_shmoo_container_t *scPtr)
{
    switch ((*scPtr).shmooType) {
        ...
        case SHMOO_AND28_CTRL_EXTENDED:
            ...
            break;
        case SHMOO_AND28_RD_EN_ECC:
            return _shmoo_and28_rd_en_ecc(unit, phy_ndx, scPtr);
        case SHMOO_AND28_RD_EXTENDED_ECC:
            return _shmoo_and28_rd_extended_ecc(unit, phy_ndx, scPtr);
        case SHMOO_AND28_WR_EXTENDED_ECC:
            return _shmoo_and28_wr_extended_ecc(unit, phy_ndx, scPtr);
        default:
            LOG_ERROR(BSL_LS_SOC_DDR, (BSL_META_U(unit, "Unsupported shmoo type: %02lu\n"), (long unsigned int)(*scPtr).shmooType));
            return SOC_E_FAIL;
    }
...
/*  engageUIshift = (*scPtr).engageUIshift; */
    ...
    switch ((*scPtr).shmooType) {
        ...
        case SHMOO_AND28_CTRL_EXTENDED:
            if(SHMOO_AND28_QUICK_SHMOO_CTRL_EXTENDED)
            {
                SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AD00r(unit, &data));
                DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_CONTROL_REGS, VDL_CONTROL_AD00, FORCE, 1);
        ...
        case SHMOO_AND28_RD_EN_ECC:
            ...
            switch(calibMode)
            {
                ...
                case SHMOO_AND28_WORD:
                    data = 0;
                    DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_ECC_LANE, VDL_CONTROL_RD_EN_CS0, FORCE, 1);
                    DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_ECC_LANE, VDL_CONTROL_RD_EN_CS0, VDL_STEP, (*scPtr).resultData[0] & 0xFFFF);
        ...
        case SHMOO_AND28_RD_EXTENDED_ECC:
            ...
            switch(calibMode)
            {
                ...
                case SHMOO_AND28_WORD:
                    ...
                    data = 0;
                    DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_ECC_LANE, VDL_CONTROL_RD_DQSP, FORCE, 1);
                    DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_ECC_LANE, VDL_CONTROL_RD_DQSP, VDL_STEP, val);
        ...
        case SHMOO_AND28_WR_EXTENDED_ECC:
            ...
            switch(calibMode)
            {
                ...
                case SHMOO_AND28_WORD:
                    data = 0;
                    DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_ECC_LANE, VDL_CONTROL_WR_DQ0, FORCE, 1);
                    DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_ECC_LANE, VDL_CONTROL_WR_DQ0, VDL_STEP, (*scPtr).resultData[0] & 0xFFFF);
...
_and28_calculate_step_size(int unit, int phy_ndx, and28_step_size_t *ssPtr)
{
    ...
    data = 0;
    SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VDL_CALIBRATEr(unit, data));
    sal_usleep(SHMOO_AND28_SHORT_SLEEP);
    ...
    do
    {
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VDL_CALIB_STATUS1r(unit, &data));
        ...
        if (timeout == 0)
        {
            LOG_ERROR(BSL_LS_SOC_DDR, (BSL_META_U(unit, "     VDL calibration failed!!! (Timeout) data = 0x%x\n"), data));
...
_and28_zq_calibration(int unit, int phy_ndx)
{
    ...
    uint32 aq_p_drive, aq_n_drive = 0;

    SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VREF_DAC_CONTROLr(unit, &vref_dac));
    if(shmoo_dram_info.dram_type == SHMOO_AND28_DRAM_TYPE_DDR4)
    {
        data = vref_dac;
    ...
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_ZQ_CALr(unit, &data));
#if (defined(PHY_AND28_F4))
    DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_CONTROL_REGS, ZQ_CAL, ZQ_RXENB, 1);
    DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_CONTROL_REGS, ZQ_CAL, ZQ_RX_ITRIM, 3);
    DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_CONTROL_REGS, ZQ_CAL, ZQ_RX_LSTRIM, 0xA);
#else
...
#endif
    SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_ZQ_CALr(unit, data));
    sal_usleep(SHMOO_AND28_SHORT_SLEEP);
...
#if (defined(PHY_AND28_F4))
    DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_CONTROL_REGS, ZQ_CAL, ZQ_RXENB, 0);
#else
    ...
    for(i = 0; i < SHMOO_AND28_MAX_ZQ_CAL_RANGE; i++)
    {
        ...
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_ZQ_CALr(unit, &data));
#if (defined(PHY_AND28_F4))
        LOG_VERBOSE(BSL_LS_SOC_DDR, (BSL_META_U(unit, "     P Code - Iteration %2d / Status: %ld\n"),
                    i, (long unsigned int)DDR_PHY_GET_FIELD(data, DDR34_CORE_PHY_CONTROL_REGS, ZQ_CAL, ZQ_STATUS)));
        if(DDR_PHY_GET_FIELD(data, DDR34_CORE_PHY_CONTROL_REGS, ZQ_CAL, ZQ_STATUS))
#else
...
#if (defined(PHY_AND28_F4))
        if(((shmoo_dram_info.dram_type != SHMOO_AND28_DRAM_TYPE_DDR4) && (i >= (SHMOO_AND28_MAX_ZQ_CAL_RANGE / 3)))
            || (i >= (SHMOO_AND28_MAX_ZQ_CAL_RANGE >> 1))
            || (i == 0))
#else
...
#if (defined(PHY_AND28_F4))
    DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_CONTROL_REGS, ZQ_CAL, ZQ_DRIVE_P, p_drive);
#else
    ...
    for(i = 0; i < SHMOO_AND28_MAX_ZQ_CAL_RANGE; i++)
    {
        ...
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_ZQ_CALr(unit, &data));
#if (defined(PHY_AND28_F4))
        LOG_VERBOSE(BSL_LS_SOC_DDR, (BSL_META_U(unit, "     N Code - Iteration %2d / Status: %ld\n"),
                    i, (long unsigned int)DDR_PHY_GET_FIELD(data, DDR34_CORE_PHY_CONTROL_REGS, ZQ_CAL, ZQ_STATUS)));
        if(!DDR_PHY_GET_FIELD(data, DDR34_CORE_PHY_CONTROL_REGS, ZQ_CAL, ZQ_STATUS))
#else
...
#if (defined(PHY_AND28_F4))
    if(((shmoo_dram_info.dram_type == SHMOO_AND28_DRAM_TYPE_DDR4) && (i >= (SHMOO_AND28_MAX_ZQ_CAL_RANGE / 3)))
            || (i >= ((SHMOO_AND28_MAX_ZQ_CAL_RANGE << 1) / 3))
            || (i == 0))
#else
    if(i == SHMOO_AND28_MAX_ZQ_CAL_RANGE)
#endif
    ...
    DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_CONTROL_REGS, ZQ_CAL, ZQ_IDDQ, 1);
    DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_CONTROL_REGS, ZQ_CAL, ZQ_DRIVE_P, 0);
    DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_CONTROL_REGS, ZQ_CAL, ZQ_DRIVE_N, 0);
    SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_ZQ_CALr(unit, data));
    sal_usleep(SHMOO_AND28_SHORT_SLEEP);
    ...
    SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_DRIVE_PAD_CTLr(unit, data));
#if (defined(PHY_AND28_F0) || defined(PHY_AND28_F2) || defined(PHY_AND28_F4))
    SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_DRIVE_PAD_CTL_2Tr(unit, data));
#endif
    ...
    SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_DRIVE_PAD_CTLr(unit, data));
    SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_DRIVE_PAD_CTLr(unit, data));

    if(shmoo_dram_info.interface_bitwidth == 32)
    {
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_DRIVE_PAD_CTLr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_DRIVE_PAD_CTLr(unit, data));
    }
#if (defined(PHY_AND28_F4))
    if(shmoo_dram_info.ecc_32p4)
    {
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_DRIVE_PAD_CTLr(unit, data));
    }
#endif
    ...
    SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_CK_DRIVE_PAD_CTLr(unit, data));
    SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_DQSP_DRIVE_PAD_CTLr(unit, data));
    SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_DQSN_DRIVE_PAD_CTLr(unit, data));
    SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_DQSP_DRIVE_PAD_CTLr(unit, data));
    SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_DQSN_DRIVE_PAD_CTLr(unit, data));

    if(shmoo_dram_info.interface_bitwidth == 32)
    {
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_DQSP_DRIVE_PAD_CTLr(unit, data));
	    SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_DQSN_DRIVE_PAD_CTLr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_DQSP_DRIVE_PAD_CTLr(unit, data));
	    SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_DQSN_DRIVE_PAD_CTLr(unit, data));
    }
#if (defined(PHY_AND28_F4))
    if(shmoo_dram_info.ecc_32p4)
    {
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_DQSP_DRIVE_PAD_CTLr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_DQSN_DRIVE_PAD_CTLr(unit, data));
    }
#endif

#if (defined(PHY_AND28_F0) || defined(PHY_AND28_F2))
    data = 0;
    ...
    SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_ALERT_DRIVE_PAD_CTLr(unit, data));
    SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_ALERT_DRIVE_PAD_CTLr(unit, data));

    if(shmoo_dram_info.interface_bitwidth == 32)
    {
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_ALERT_DRIVE_PAD_CTLr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_ALERT_DRIVE_PAD_CTLr(unit, data));
    }
#endif
#endif
    ...
    SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_RD_EN_DRIVE_PAD_CTLr(unit, data));
    SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_RD_EN_DRIVE_PAD_CTLr(unit, data));

    if(shmoo_dram_info.interface_bitwidth == 32)
    {
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_RD_EN_DRIVE_PAD_CTLr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_RD_EN_DRIVE_PAD_CTLr(unit, data));
    }
#if (defined(PHY_AND28_F4))
    if(shmoo_dram_info.ecc_32p4)
    {
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_RD_EN_DRIVE_PAD_CTLr(unit, data));
    }
#endif

    if(shmoo_dram_info.dram_type == SHMOO_AND28_DRAM_TYPE_DDR4)
    {
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VREF_DAC_CONTROLr(unit, vref_dac));
        sal_usleep(SHMOO_AND28_SHORT_SLEEP);
    }
...
_shmoo_and28_entry(int unit, int phy_ndx, and28_shmoo_container_t *scPtr, uint32 mode)
{
    ...
    /*R04*/ SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VREF_DAC_CONTROLr(unit, &data));
            if(shmoo_dram_info.dram_type == SHMOO_AND28_DRAM_TYPE_DDR4)
            {
                DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_CONTROL_REGS, VREF_DAC_CONTROL, DAC0, 32);
    ...
    /*R08*/ if(shmoo_dram_info.sim_system_mode) {
            ...
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_READ_CONTROLr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_READ_CONTROLr(unit, data));

            if(shmoo_dram_info.interface_bitwidth == 32)
            {
                SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_READ_CONTROLr(unit, data));
                SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_READ_CONTROLr(unit, data));
            }
#if (defined(PHY_AND28_F4))
            if(shmoo_dram_info.ecc_32p4)
            {
                SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_READ_CONTROLr(unit, data));
            }
#endif
            ...
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_RD_EN_DLY_CYCr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_RD_EN_DLY_CYCr(unit, data));

            if(shmoo_dram_info.interface_bitwidth == 32)
            {
                SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_RD_EN_DLY_CYCr(unit, data));
                SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_RD_EN_DLY_CYCr(unit, data));
            }
#if (defined(PHY_AND28_F4))
            if(shmoo_dram_info.ecc_32p4)
            {
                SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_RD_EN_DLY_CYCr(unit, data));
            }
#endif
            ...
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_WR_CHAN_DLY_CYCr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_WR_CHAN_DLY_CYCr(unit, data));

            if(shmoo_dram_info.interface_bitwidth == 32)
            {
                SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_WR_CHAN_DLY_CYCr(unit, data));
                SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_WR_CHAN_DLY_CYCr(unit, data));
            }
#if (defined(PHY_AND28_F4))
            if(shmoo_dram_info.ecc_32p4)
            {
                SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_WR_CHAN_DLY_CYCr(unit, data));
            }
#endif
...
_shmoo_and28_save(int unit, int phy_ndx, and28_shmoo_config_param_t *config_param)
{
    ...
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AD01r(unit, &data));
    (*config_param).control_regs_ad[1] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AD02r(unit, &data));
    (*config_param).control_regs_ad[2] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AD03r(unit, &data));
    (*config_param).control_regs_ad[3] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AD04r(unit, &data));
    (*config_param).control_regs_ad[4] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AD05r(unit, &data));
    (*config_param).control_regs_ad[5] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AD06r(unit, &data));
    (*config_param).control_regs_ad[6] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AD07r(unit, &data));
    (*config_param).control_regs_ad[7] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AD08r(unit, &data));
    (*config_param).control_regs_ad[8] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AD09r(unit, &data));
    (*config_param).control_regs_ad[9] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AD10r(unit, &data));
    (*config_param).control_regs_ad[10] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AD11r(unit, &data));
    (*config_param).control_regs_ad[11] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AD12r(unit, &data));
    (*config_param).control_regs_ad[12] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AD13r(unit, &data));
    (*config_param).control_regs_ad[13] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AD14r(unit, &data));
    (*config_param).control_regs_ad[14] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AD15r(unit, &data));
    (*config_param).control_regs_ad[15] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VDL_CONTROL_BA0r(unit, &data));
    (*config_param).control_regs_ba[0] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VDL_CONTROL_BA1r(unit, &data));
    (*config_param).control_regs_ba[1] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VDL_CONTROL_BA2r(unit, &data));
    (*config_param).control_regs_ba[2] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AUX0r(unit, &data));
    (*config_param).control_regs_aux[0] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AUX1r(unit, &data));
    (*config_param).control_regs_aux[1] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VDL_CONTROL_AUX2r(unit, &data));
    (*config_param).control_regs_aux[2] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VDL_CONTROL_CS0r(unit, &data));
    (*config_param).control_regs_cs[0] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VDL_CONTROL_CS1r(unit, &data));
    (*config_param).control_regs_cs[1] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VDL_CONTROL_PARr(unit, &data));
    (*config_param).control_regs_par = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VDL_CONTROL_RAS_Nr(unit, &data));
    (*config_param).control_regs_ras_n = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VDL_CONTROL_CAS_Nr(unit, &data));
    (*config_param).control_regs_cas_n = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VDL_CONTROL_CKEr(unit, &data));
    (*config_param).control_regs_cke = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VDL_CONTROL_RST_Nr(unit, &data));
    (*config_param).control_regs_rst_n = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VDL_CONTROL_ODTr(unit, &data));
    (*config_param).control_regs_odt = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VDL_CONTROL_WE_Nr(unit, &data));
    (*config_param).control_regs_we_n = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VREF_DAC_CONTROLr(unit, &data));
    (*config_param).control_regs_vref_dac_control = data;

#if (defined(PHY_AND28_F0) || defined(PHY_AND28_F2) || defined(PHY_AND28_F4))
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_WR_DQSr(unit, &data));
    (*config_param).wr_vdl_dqsp[0] = (uint16) data;
#endif
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_WR_DQ0r(unit, &data));
    (*config_param).wr_vdl_dq[0][0] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_WR_DQ1r(unit, &data));
    (*config_param).wr_vdl_dq[0][1] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_WR_DQ2r(unit, &data));
    (*config_param).wr_vdl_dq[0][2] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_WR_DQ3r(unit, &data));
    (*config_param).wr_vdl_dq[0][3] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_WR_DQ4r(unit, &data));
    (*config_param).wr_vdl_dq[0][4] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_WR_DQ5r(unit, &data));
    (*config_param).wr_vdl_dq[0][5] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_WR_DQ6r(unit, &data));
    (*config_param).wr_vdl_dq[0][6] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_WR_DQ7r(unit, &data));
    (*config_param).wr_vdl_dq[0][7] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_WR_DMr(unit, &data));
    (*config_param).wr_vdl_dm[0] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_WR_CHAN_DLY_CYCr(unit, &data));
    (*config_param).wr_chan_dly_cyc[0] = (uint8) data;

    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQSPr(unit, &data));
    (*config_param).rd_vdl_dqsp[0] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQSNr(unit, &data));
    (*config_param).rd_vdl_dqsn[0] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQ0Pr(unit, &data));
    (*config_param).rd_vdl_dqp[0][0] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQ1Pr(unit, &data));
    (*config_param).rd_vdl_dqp[0][1] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQ2Pr(unit, &data));
    (*config_param).rd_vdl_dqp[0][2] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQ3Pr(unit, &data));
    (*config_param).rd_vdl_dqp[0][3] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQ4Pr(unit, &data));
    (*config_param).rd_vdl_dqp[0][4] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQ5Pr(unit, &data));
    (*config_param).rd_vdl_dqp[0][5] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQ6Pr(unit, &data));
    (*config_param).rd_vdl_dqp[0][6] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQ7Pr(unit, &data));
    (*config_param).rd_vdl_dqp[0][7] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQ0Nr(unit, &data));
    (*config_param).rd_vdl_dqn[0][0] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQ1Nr(unit, &data));
    (*config_param).rd_vdl_dqn[0][1] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQ2Nr(unit, &data));
    (*config_param).rd_vdl_dqn[0][2] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQ3Nr(unit, &data));
    (*config_param).rd_vdl_dqn[0][3] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQ4Nr(unit, &data));
    (*config_param).rd_vdl_dqn[0][4] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQ5Nr(unit, &data));
    (*config_param).rd_vdl_dqn[0][5] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQ6Nr(unit, &data));
    (*config_param).rd_vdl_dqn[0][6] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DQ7Nr(unit, &data));
    (*config_param).rd_vdl_dqn[0][7] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DMPr(unit, &data));
    (*config_param).rd_vdl_dmp[0] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_DMNr(unit, &data));
    (*config_param).rd_vdl_dmn[0] = (uint16) data;

    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_EN_CS0r(unit, &data));
    (*config_param).rd_en_vdl_cs[0][0] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_RD_EN_CS1r(unit, &data));
    (*config_param).rd_en_vdl_cs[0][1] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_RD_EN_DLY_CYCr(unit, &data));
    (*config_param).rd_en_dly_cyc[0] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_READ_CONTROLr(unit, &data));
    (*config_param).rd_control[0] = (uint8) data;

#if (defined(PHY_AND28_F0) || defined(PHY_AND28_F2) || defined(PHY_AND28_F4))
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_WR_DQSr(unit, &data));
    (*config_param).wr_vdl_dqsp[1] = (uint16) data;
#endif

    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_WR_DQ0r(unit, &data));
    (*config_param).wr_vdl_dq[1][0] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_WR_DQ1r(unit, &data));
    (*config_param).wr_vdl_dq[1][1] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_WR_DQ2r(unit, &data));
    (*config_param).wr_vdl_dq[1][2] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_WR_DQ3r(unit, &data));
    (*config_param).wr_vdl_dq[1][3] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_WR_DQ4r(unit, &data));
    (*config_param).wr_vdl_dq[1][4] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_WR_DQ5r(unit, &data));
    (*config_param).wr_vdl_dq[1][5] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_WR_DQ6r(unit, &data));
    (*config_param).wr_vdl_dq[1][6] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_WR_DQ7r(unit, &data));
    (*config_param).wr_vdl_dq[1][7] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_WR_DMr(unit, &data));
    (*config_param).wr_vdl_dm[1] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_WR_CHAN_DLY_CYCr(unit, &data));
    (*config_param).wr_chan_dly_cyc[1] = (uint8) data;

    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQSPr(unit, &data));
    (*config_param).rd_vdl_dqsp[1] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQSNr(unit, &data));
    (*config_param).rd_vdl_dqsn[1] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQ0Pr(unit, &data));
    (*config_param).rd_vdl_dqp[1][0] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQ1Pr(unit, &data));
    (*config_param).rd_vdl_dqp[1][1] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQ2Pr(unit, &data));
    (*config_param).rd_vdl_dqp[1][2] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQ3Pr(unit, &data));
    (*config_param).rd_vdl_dqp[1][3] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQ4Pr(unit, &data));
    (*config_param).rd_vdl_dqp[1][4] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQ5Pr(unit, &data));
    (*config_param).rd_vdl_dqp[1][5] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQ6Pr(unit, &data));
    (*config_param).rd_vdl_dqp[1][6] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQ7Pr(unit, &data));
    (*config_param).rd_vdl_dqp[1][7] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQ0Nr(unit, &data));
    (*config_param).rd_vdl_dqn[1][0] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQ1Nr(unit, &data));
    (*config_param).rd_vdl_dqn[1][1] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQ2Nr(unit, &data));
    (*config_param).rd_vdl_dqn[1][2] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQ3Nr(unit, &data));
    (*config_param).rd_vdl_dqn[1][3] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQ4Nr(unit, &data));
    (*config_param).rd_vdl_dqn[1][4] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQ5Nr(unit, &data));
    (*config_param).rd_vdl_dqn[1][5] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQ6Nr(unit, &data));
    (*config_param).rd_vdl_dqn[1][6] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DQ7Nr(unit, &data));
    (*config_param).rd_vdl_dqn[1][7] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DMPr(unit, &data));
    (*config_param).rd_vdl_dmp[1] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_DMNr(unit, &data));
    (*config_param).rd_vdl_dmn[1] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_EN_CS0r(unit, &data));
    (*config_param).rd_en_vdl_cs[1][0] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_RD_EN_CS1r(unit, &data));
    (*config_param).rd_en_vdl_cs[1][1] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_RD_EN_DLY_CYCr(unit, &data));
    (*config_param).rd_en_dly_cyc[1] = (uint16) data;
    SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_1_READ_CONTROLr(unit, &data));
    (*config_param).rd_control[1] = (uint8) data;

    if(shmoo_dram_info.interface_bitwidth == 32)
    {
#if (defined(PHY_AND28_F0) || defined(PHY_AND28_F2) || defined(PHY_AND28_F4))
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_WR_DQSr(unit, &data));
        (*config_param).wr_vdl_dqsp[2] = (uint16) data;
#endif
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_WR_DQ0r(unit, &data));
        (*config_param).wr_vdl_dq[2][0] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_WR_DQ1r(unit, &data));
        (*config_param).wr_vdl_dq[2][1] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_WR_DQ2r(unit, &data));
        (*config_param).wr_vdl_dq[2][2] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_WR_DQ3r(unit, &data));
        (*config_param).wr_vdl_dq[2][3] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_WR_DQ4r(unit, &data));
        (*config_param).wr_vdl_dq[2][4] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_WR_DQ5r(unit, &data));
        (*config_param).wr_vdl_dq[2][5] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_WR_DQ6r(unit, &data));
        (*config_param).wr_vdl_dq[2][6] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_WR_DQ7r(unit, &data));
        (*config_param).wr_vdl_dq[2][7] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_WR_DMr(unit, &data));
        (*config_param).wr_vdl_dm[2] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_WR_CHAN_DLY_CYCr(unit, &data));
        (*config_param).wr_chan_dly_cyc[2] = (uint8) data;

        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQSPr(unit, &data));
        (*config_param).rd_vdl_dqsp[2] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQSNr(unit, &data));
        (*config_param).rd_vdl_dqsn[2] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQ0Pr(unit, &data));
        (*config_param).rd_vdl_dqp[2][0] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQ1Pr(unit, &data));
        (*config_param).rd_vdl_dqp[2][1] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQ2Pr(unit, &data));
        (*config_param).rd_vdl_dqp[2][2] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQ3Pr(unit, &data));
        (*config_param).rd_vdl_dqp[2][3] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQ4Pr(unit, &data));
        (*config_param).rd_vdl_dqp[2][4] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQ5Pr(unit, &data));
        (*config_param).rd_vdl_dqp[2][5] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQ6Pr(unit, &data));
        (*config_param).rd_vdl_dqp[2][6] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQ7Pr(unit, &data));
        (*config_param).rd_vdl_dqp[2][7] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQ0Nr(unit, &data));
        (*config_param).rd_vdl_dqn[2][0] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQ1Nr(unit, &data));
        (*config_param).rd_vdl_dqn[2][1] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQ2Nr(unit, &data));
        (*config_param).rd_vdl_dqn[2][2] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQ3Nr(unit, &data));
        (*config_param).rd_vdl_dqn[2][3] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQ4Nr(unit, &data));
        (*config_param).rd_vdl_dqn[2][4] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQ5Nr(unit, &data));
        (*config_param).rd_vdl_dqn[2][5] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQ6Nr(unit, &data));
        (*config_param).rd_vdl_dqn[2][6] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DQ7Nr(unit, &data));
        (*config_param).rd_vdl_dqn[2][7] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DMPr(unit, &data));
        (*config_param).rd_vdl_dmp[2] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_DMNr(unit, &data));
        (*config_param).rd_vdl_dmn[2] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_EN_CS0r(unit, &data));
        (*config_param).rd_en_vdl_cs[2][0] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_RD_EN_CS1r(unit, &data));
        (*config_param).rd_en_vdl_cs[2][1] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_RD_EN_DLY_CYCr(unit, &data));
        (*config_param).rd_en_dly_cyc[2] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_2_READ_CONTROLr(unit, &data));
        (*config_param).rd_control[2] = (uint8) data;

#if (defined(PHY_AND28_F0) || defined(PHY_AND28_F2) || defined(PHY_AND28_F4))
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_WR_DQSr(unit, &data));
        (*config_param).wr_vdl_dqsp[3] = (uint16) data;
#endif
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_WR_DQ0r(unit, &data));
        (*config_param).wr_vdl_dq[3][0] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_WR_DQ1r(unit, &data));
        (*config_param).wr_vdl_dq[3][1] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_WR_DQ2r(unit, &data));
        (*config_param).wr_vdl_dq[3][2] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_WR_DQ3r(unit, &data));
        (*config_param).wr_vdl_dq[3][3] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_WR_DQ4r(unit, &data));
        (*config_param).wr_vdl_dq[3][4] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_WR_DQ5r(unit, &data));
        (*config_param).wr_vdl_dq[3][5] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_WR_DQ6r(unit, &data));
        (*config_param).wr_vdl_dq[3][6] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_WR_DQ7r(unit, &data));
        (*config_param).wr_vdl_dq[3][7] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_WR_DMr(unit, &data));
        (*config_param).wr_vdl_dm[3] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_WR_CHAN_DLY_CYCr(unit, &data));
        (*config_param).wr_chan_dly_cyc[3] = (uint8) data;

        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQSPr(unit, &data));
        (*config_param).rd_vdl_dqsp[3] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQSNr(unit, &data));
        (*config_param).rd_vdl_dqsn[3] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQ0Pr(unit, &data));
        (*config_param).rd_vdl_dqp[3][0] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQ1Pr(unit, &data));
        (*config_param).rd_vdl_dqp[3][1] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQ2Pr(unit, &data));
        (*config_param).rd_vdl_dqp[3][2] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQ3Pr(unit, &data));
        (*config_param).rd_vdl_dqp[3][3] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQ4Pr(unit, &data));
        (*config_param).rd_vdl_dqp[3][4] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQ5Pr(unit, &data));
        (*config_param).rd_vdl_dqp[3][5] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQ6Pr(unit, &data));
        (*config_param).rd_vdl_dqp[3][6] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQ7Pr(unit, &data));
        (*config_param).rd_vdl_dqp[3][7] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQ0Nr(unit, &data));
        (*config_param).rd_vdl_dqn[3][0] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQ1Nr(unit, &data));
        (*config_param).rd_vdl_dqn[3][1] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQ2Nr(unit, &data));
        (*config_param).rd_vdl_dqn[3][2] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQ3Nr(unit, &data));
        (*config_param).rd_vdl_dqn[3][3] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQ4Nr(unit, &data));
        (*config_param).rd_vdl_dqn[3][4] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQ5Nr(unit, &data));
        (*config_param).rd_vdl_dqn[3][5] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQ6Nr(unit, &data));
        (*config_param).rd_vdl_dqn[3][6] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DQ7Nr(unit, &data));
        (*config_param).rd_vdl_dqn[3][7] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DMPr(unit, &data));
        (*config_param).rd_vdl_dmp[3] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_DMNr(unit, &data));
        (*config_param).rd_vdl_dmn[3] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_EN_CS0r(unit, &data));
        (*config_param).rd_en_vdl_cs[3][0] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_RD_EN_CS1r(unit, &data));
        (*config_param).rd_en_vdl_cs[3][1] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_RD_EN_DLY_CYCr(unit, &data));
        (*config_param).rd_en_dly_cyc[3] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_3_READ_CONTROLr(unit, &data));
        (*config_param).rd_control[3] = (uint8) data;
    }
#if (defined(PHY_AND28_F4))
    if(shmoo_dram_info.ecc_32p4)
    {
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_WR_DQSr(unit, &data));
        (*config_param).wr_vdl_dqsp[4] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_WR_DQ0r(unit, &data));
        (*config_param).wr_vdl_dq[4][0] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_WR_DQ1r(unit, &data));
        (*config_param).wr_vdl_dq[4][1] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_WR_DQ2r(unit, &data));
        (*config_param).wr_vdl_dq[4][2] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_WR_DQ3r(unit, &data));
        (*config_param).wr_vdl_dq[4][3] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_WR_DQ4r(unit, &data));
        (*config_param).wr_vdl_dq[4][4] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_WR_DQ5r(unit, &data));
        (*config_param).wr_vdl_dq[4][5] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_WR_DQ6r(unit, &data));
        (*config_param).wr_vdl_dq[4][6] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_WR_DQ7r(unit, &data));
        (*config_param).wr_vdl_dq[4][7] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_WR_DMr(unit, &data));
        (*config_param).wr_vdl_dm[4] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_WR_CHAN_DLY_CYCr(unit, &data));
        (*config_param).wr_chan_dly_cyc[4] = (uint8) data;

        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQSPr(unit, &data));
        (*config_param).rd_vdl_dqsp[4] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQSNr(unit, &data));
        (*config_param).rd_vdl_dqsn[4] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ0Pr(unit, &data));
        (*config_param).rd_vdl_dqp[4][0] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ1Pr(unit, &data));
        (*config_param).rd_vdl_dqp[4][1] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ2Pr(unit, &data));
        (*config_param).rd_vdl_dqp[4][2] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ3Pr(unit, &data));
        (*config_param).rd_vdl_dqp[4][3] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ4Pr(unit, &data));
        (*config_param).rd_vdl_dqp[4][4] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ5Pr(unit, &data));
        (*config_param).rd_vdl_dqp[4][5] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ6Pr(unit, &data));
        (*config_param).rd_vdl_dqp[4][6] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ7Pr(unit, &data));
        (*config_param).rd_vdl_dqp[4][7] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ0Nr(unit, &data));
        (*config_param).rd_vdl_dqn[4][0] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ1Nr(unit, &data));
        (*config_param).rd_vdl_dqn[4][1] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ2Nr(unit, &data));
        (*config_param).rd_vdl_dqn[4][2] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ3Nr(unit, &data));
        (*config_param).rd_vdl_dqn[4][3] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ4Nr(unit, &data));
        (*config_param).rd_vdl_dqn[4][4] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ5Nr(unit, &data));
        (*config_param).rd_vdl_dqn[4][5] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ6Nr(unit, &data));
        (*config_param).rd_vdl_dqn[4][6] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ7Nr(unit, &data));
        (*config_param).rd_vdl_dqn[4][7] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DMPr(unit, &data));
        (*config_param).rd_vdl_dmp[4] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DMNr(unit, &data));
        (*config_param).rd_vdl_dmn[4] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_EN_CS0r(unit, &data));
        (*config_param).rd_en_vdl_cs[4][0] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_EN_CS1r(unit, &data));
        (*config_param).rd_en_vdl_cs[4][1] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_RD_EN_DLY_CYCr(unit, &data));
        (*config_param).rd_en_dly_cyc[4] = (uint16) data;
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_ECC_LANE_READ_CONTROLr(unit, &data));
...
_shmoo_and28_restore(int unit, int phy_ndx, and28_shmoo_config_param_t *config_param)
{
    ...
    SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_VDL_CONTROL_WR_DQSr(unit, data));
#endif
    ...
    SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_VDL_CONTROL_WR_DQSr(unit, data));
#endif
    ...
    if(shmoo_dram_info.interface_bitwidth == 32)
    {
        ...
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_VDL_CONTROL_WR_DQSr(unit, data));
#endif
        ...
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_VDL_CONTROL_WR_DQSr(unit, data));
#endif
    ...
    if(shmoo_dram_info.ecc_32p4)
    {
        data = SET_WR_VDL_FORCE((uint32) (*config_param).wr_vdl_dqsp[4]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_WR_DQSr(unit, data));
        data = SET_WR_VDL_FORCE((uint32) (*config_param).wr_vdl_dq[4][0]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_WR_DQ0r(unit, data));
        data = SET_WR_VDL_FORCE((uint32) (*config_param).wr_vdl_dq[4][1]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_WR_DQ1r(unit, data));
        data = SET_WR_VDL_FORCE((uint32) (*config_param).wr_vdl_dq[4][2]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_WR_DQ2r(unit, data));
        data = SET_WR_VDL_FORCE((uint32) (*config_param).wr_vdl_dq[4][3]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_WR_DQ3r(unit, data));
        data = SET_WR_VDL_FORCE((uint32) (*config_param).wr_vdl_dq[4][4]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_WR_DQ4r(unit, data));
        data = SET_WR_VDL_FORCE((uint32) (*config_param).wr_vdl_dq[4][5]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_WR_DQ5r(unit, data));
        data = SET_WR_VDL_FORCE((uint32) (*config_param).wr_vdl_dq[4][6]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_WR_DQ6r(unit, data));
        data = SET_WR_VDL_FORCE((uint32) (*config_param).wr_vdl_dq[4][7]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_WR_DQ7r(unit, data));
        data = SET_WR_VDL_FORCE((uint32) (*config_param).wr_vdl_dm[4]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_WR_DMr(unit, data));
        data = SET_WR_CHAN_DLY_CYC_FORCE((uint32) (*config_param).wr_chan_dly_cyc[4]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_WR_CHAN_DLY_CYCr(unit, data));

        data = SET_RD_VDL_FORCE((uint32) (*config_param).rd_vdl_dqsp[4]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQSPr(unit, data));
        data = SET_RD_VDL_FORCE((uint32) (*config_param).rd_vdl_dqsn[4]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQSNr(unit, data));
        data = SET_RD_VDL_FORCE((uint32) (*config_param).rd_vdl_dqp[4][0]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ0Pr(unit, data));
        data = SET_RD_VDL_FORCE((uint32) (*config_param).rd_vdl_dqp[4][1]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ1Pr(unit, data));
        data = SET_RD_VDL_FORCE((uint32) (*config_param).rd_vdl_dqp[4][2]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ2Pr(unit, data));
        data = SET_RD_VDL_FORCE((uint32) (*config_param).rd_vdl_dqp[4][3]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ3Pr(unit, data));
        data = SET_RD_VDL_FORCE((uint32) (*config_param).rd_vdl_dqp[4][4]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ4Pr(unit, data));
        data = SET_RD_VDL_FORCE((uint32) (*config_param).rd_vdl_dqp[4][5]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ5Pr(unit, data));
        data = SET_RD_VDL_FORCE((uint32) (*config_param).rd_vdl_dqp[4][6]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ6Pr(unit, data));
        data = SET_RD_VDL_FORCE((uint32) (*config_param).rd_vdl_dqp[4][7]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ7Pr(unit, data));
        data = SET_RD_VDL_FORCE((uint32) (*config_param).rd_vdl_dqn[4][0]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ0Nr(unit, data));
        data = SET_RD_VDL_FORCE((uint32) (*config_param).rd_vdl_dqn[4][1]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ1Nr(unit, data));
        data = SET_RD_VDL_FORCE((uint32) (*config_param).rd_vdl_dqn[4][2]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ2Nr(unit, data));
        data = SET_RD_VDL_FORCE((uint32) (*config_param).rd_vdl_dqn[4][3]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ3Nr(unit, data));
        data = SET_RD_VDL_FORCE((uint32) (*config_param).rd_vdl_dqn[4][4]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ4Nr(unit, data));
        data = SET_RD_VDL_FORCE((uint32) (*config_param).rd_vdl_dqn[4][5]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ5Nr(unit, data));
        data = SET_RD_VDL_FORCE((uint32) (*config_param).rd_vdl_dqn[4][6]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ6Nr(unit, data));
        data = SET_RD_VDL_FORCE((uint32) (*config_param).rd_vdl_dqn[4][7]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DQ7Nr(unit, data));
        data = SET_RD_VDL_FORCE((uint32) (*config_param).rd_vdl_dmp[4]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DMPr(unit, data));
        data = SET_RD_VDL_FORCE((uint32) (*config_param).rd_vdl_dmn[4]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_DMNr(unit, data));
        data = SET_RD_VDL_FORCE((uint32) (*config_param).rd_en_vdl_cs[4][0]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_EN_CS0r(unit, data));
        data = SET_RD_VDL_FORCE((uint32) (*config_param).rd_en_vdl_cs[4][1]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_VDL_CONTROL_RD_EN_CS1r(unit, data));
        data = SET_RD_EN_DLY_CYC_FORCE((uint32) (*config_param).rd_en_dly_cyc[4]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_RD_EN_DLY_CYCr(unit, data));
        data = SET_RD_CONTROL((uint32) (*config_param).rd_control[4]);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_READ_CONTROLr(unit, data));
    }
#endif
...
int
soc_and28_f4_shmoo_ctl(int unit, int phy_ndx, int shmoo_type, int stat, int plot, int action, and28_shmoo_config_param_t *config_param)
{
    ...
    if(!stat)
    {
        scPtr = sal_alloc(sizeof(and28_shmoo_container_t), "AND28 F4 Shmoo Container");
        if(scPtr == NULL)
        {
            return SOC_E_MEMORY;
        }
                    ...
                    case SHMOO_AND28_CTL_TYPE_1:
                        switch(dramType)
                        {
                            case SHMOO_AND28_DRAM_TYPE_DDR3:
                                ...
                                if(shmoo_dram_info.ecc_32p4)
                                {
                                    seqCount = SHMOO_AND28_DDR3_ECC_32P4_SEQUENCE_COUNT;
                                }
                                else
                                {
                            ...
                            case SHMOO_AND28_DRAM_TYPE_DDR3L:
                                ...
                                if(shmoo_dram_info.ecc_32p4)
                                {
                                    seqCount = SHMOO_AND28_DDR3L_ECC_32P4_SEQUENCE_COUNT;
                                }
                                else
                                {
                            ...
                            case SHMOO_AND28_DRAM_TYPE_DDR4:
                                ...
                                if(shmoo_dram_info.ecc_32p4)
                                {
                                    seqCount = SHMOO_AND28_DDR4_ECC_32P4_SEQUENCE_COUNT;
                                }
                                else
                                {
...
int
soc_and28_f4_shmoo_dram_info_set(int unit, CONST and28_f4_shmoo_dram_info_t *sdi)
{
...
static int
_soc_and28_f4_shmoo_phy_cfg_pll(int unit, int phy_ndx)
{
    int ndx, ndxEnd;
    uint32 data;
    uint32 timeout;
    ...
    {
        case 800:
#if defined(PHY_AND28_F2)
            pll_config = 0x01890012;
#else
            pll_config = 0x5A510012;
#endif
    ...
    for(; ndx < ndxEnd; ndx++)
    {
        ...
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_PLL_CONFIGr(unit, pll_config));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_PLL_CONTROL2r(unit, pll_control2));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_PLL_DIVIDERSr(unit, pll_dividers));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_PLL_FRAC_DIVIDERr(unit, pll_frac_divider));

        SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_PLL_CONFIGr(unit, &data));
        DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_CONTROL_REGS, PLL_CONFIG, RESET, 0);
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_PLL_CONFIGr(unit, data));

        timeout = 2000;
        do
        {
            SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_PLL_STATUSr(unit, &data));
...
int
soc_and28_f4_shmoo_phy_init(int unit, int phy_ndx)
{
    int ndx, ndxEnd;
    uint32 data;
    uint32 dfi_ctrl;
...
/*A01*/ LOG_VERBOSE(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A01. Turn off CK\n")));
        dfi_ctrl = 0;
...
#if (defined(PHY_AND28_E2) || defined(PHY_AND28_F4))
...
#endif
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_DFI_CNTRLr(unit, dfi_ctrl));
        sal_usleep(SHMOO_AND28_SHORT_SLEEP);
...
/*A02*/ LOG_VERBOSE(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A02. Configure timing parameters\n")));
        ...
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_DRAM_CONFIGr(unit, dram_config));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_DRAM_TIMING1r(unit, dram_timing1));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_DRAM_TIMING2r(unit, dram_timing2));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_DRAM_TIMING3r(unit, dram_timing3));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_DRAM_TIMING4r(unit, dram_timing4));
        sal_usleep(SHMOO_AND28_SHORT_SLEEP);

/*A03*/ LOG_VERBOSE(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A03. Configure PHY PLL\n")));
        _soc_and28_f4_shmoo_phy_cfg_pll(unit, ndx);
        sal_usleep(SHMOO_AND28_SHORT_SLEEP);
...
/*A07*/ LOG_VERBOSE(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A07. Disable Virtual VTT\n")));
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_VIRTUAL_VTT_CONTROLr(unit, &data));
        ...
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_VIRTUAL_VTT_CONTROLr(unit, data));
...
/*A09*/ LOG_VERBOSE(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A09. Configure Static Pad Control\n")));
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_STATIC_PAD_CTLr(unit, &data));
        if(shmoo_dram_info.dram_type == SHMOO_AND28_DRAM_TYPE_DDR4)
        {
        ...
        if(shmoo_dram_info.dram_type == SHMOO_AND28_DRAM_TYPE_DDR4)
        {
            DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_CONTROL_REGS, STATIC_PAD_CTL, RX_MODE, 0x1);
            DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_CONTROL_REGS, STATIC_PAD_CTL, TX_MODE, 0x20);
        }
#endif
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_STATIC_PAD_CTLr(unit, data));

#if (defined(PHY_AND28_F4))
        if(shmoo_dram_info.dram_type == SHMOO_AND28_DRAM_TYPE_DDR4)
        {
            SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_STATIC_PAD_CTL_2Tr(unit, &data));
            DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_CONTROL_REGS, STATIC_PAD_CTL_2T, TX_MODE, 0x20);
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_STATIC_PAD_CTL_2Tr(unit, data));
        }
#endif

#ifdef SOC_DDR4_SUPPORT
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_STATIC_PAD_CTLr(unit, &data));
        #if (defined(PHY_AND28_F4))
            DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_BYTE_LANE_0, STATIC_PAD_CTL, DM_MODE, 0);
            if(shmoo_dram_info.dram_type == SHMOO_AND28_DRAM_TYPE_DDR4)
            {
                DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_BYTE_LANE_0, STATIC_PAD_CTL, RX_MODE, 0x1);
                DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_BYTE_LANE_0, STATIC_PAD_CTL, TX_MODE, 0x20);
            }
        #else
            DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_BYTE_LANE_0, STATIC_PAD_CTL, DM_INVERT, 0);
        #endif
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_STATIC_PAD_CTLr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_STATIC_PAD_CTLr(unit, data));
        if(shmoo_dram_info.interface_bitwidth == 32)
        {
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_STATIC_PAD_CTLr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_STATIC_PAD_CTLr(unit, data));
        }
        #if (defined(PHY_AND28_F4))
            if(shmoo_dram_info.ecc_32p4)
            {
                SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_STATIC_PAD_CTLr(unit, data));
            }
        #endif
        if(shmoo_dram_info.dram_type == SHMOO_AND28_DRAM_TYPE_DDR4)
        {
            SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_ABI_PAR_CNTRLr(unit, &data));
            DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_CONTROL_REGS, ABI_PAR_CNTRL, PAR_ENABLE, 1);
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_ABI_PAR_CNTRLr(unit, data));
        }

        #if (defined(PHY_AND28_F4))
            SOC_IF_ERROR_RETURN(READ_DDR_PHY_CONTROL_REGS_RX_TRIMr(unit, &data));
            if(shmoo_dram_info.dram_type == SHMOO_AND28_DRAM_TYPE_DDR4)
            {
                DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_CONTROL_REGS, RX_TRIM, SE_ITRIM, 3);
                DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_CONTROL_REGS, RX_TRIM, DF_ITRIM, 3);
            }
            else
            {
                DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_CONTROL_REGS, RX_TRIM, SE_ITRIM, 3);
            ...
            DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_CONTROL_REGS, RX_TRIM, SE_LSTRIM, 0xA);
            DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_CONTROL_REGS, RX_TRIM, DF_LSTRIM, 0xA);
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_RX_TRIMr(unit, data));

            SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_DQ_RX_TRIMr(unit, &data));
            if(shmoo_dram_info.dram_type == SHMOO_AND28_DRAM_TYPE_DDR4)
            {
                DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_BYTE_LANE_0, DQ_RX_TRIM, TERM_ITRIM, 3);
                DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_BYTE_LANE_0, DQ_RX_TRIM, IDLE_ITRIM, 3);
                DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_BYTE_LANE_0, DQ_RX_TRIM, ITRIM, 3);
            }
            else
            {
                DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_BYTE_LANE_0, DQ_RX_TRIM, TERM_ITRIM, 3);
            ...
            DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_BYTE_LANE_0, DQ_RX_TRIM, TERM_LSTRIM, 0xA);
            DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_BYTE_LANE_0, DQ_RX_TRIM, IDLE_LSTRIM, 0xA);
            DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_BYTE_LANE_0, DQ_RX_TRIM, LSTRIM, 0xA);
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_DQ_RX_TRIMr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_DQ_RX_TRIMr(unit, data));
            if(shmoo_dram_info.interface_bitwidth == 32)
            {
                SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_DQ_RX_TRIMr(unit, data));
                SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_DQ_RX_TRIMr(unit, data));
            }
            #if (defined(PHY_AND28_F4))
                if(shmoo_dram_info.ecc_32p4)
                {
                    SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_DQ_RX_TRIMr(unit, data));
                }
            #endif

            SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_MISC_RX_TRIMr(unit, &data));
            if(shmoo_dram_info.dram_type == SHMOO_AND28_DRAM_TYPE_DDR4)
            {
                DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_BYTE_LANE_0, MISC_RX_TRIM, TERM_ITRIM, 3);
                DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_BYTE_LANE_0, MISC_RX_TRIM, IDLE_ITRIM, 3);
                DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_BYTE_LANE_0, MISC_RX_TRIM, ITRIM, 3);
            }
            else
            {
                DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_BYTE_LANE_0, MISC_RX_TRIM, TERM_ITRIM, 3);
            ...
            DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_BYTE_LANE_0, MISC_RX_TRIM, TERM_LSTRIM, 0xA);
            DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_BYTE_LANE_0, MISC_RX_TRIM, IDLE_LSTRIM, 0xA);
            DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_BYTE_LANE_0, MISC_RX_TRIM, LSTRIM, 0xA);
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_MISC_RX_TRIMr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_MISC_RX_TRIMr(unit, data));
            if(shmoo_dram_info.interface_bitwidth == 32)
            {
                SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_MISC_RX_TRIMr(unit, data));
                SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_MISC_RX_TRIMr(unit, data));
            }
            #if (defined(PHY_AND28_F4))
                if(shmoo_dram_info.ecc_32p4)
                {
                    SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_MISC_RX_TRIMr(unit, data));
                }
            #endif

            SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_DQS_RX_TRIMr(unit, &data));
            if(shmoo_dram_info.dram_type == SHMOO_AND28_DRAM_TYPE_DDR4)
            {
                DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_BYTE_LANE_0, DQS_RX_TRIM, TERM_ITRIM, 3);
                DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_BYTE_LANE_0, DQS_RX_TRIM, IDLE_ITRIM, 3);
                DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_BYTE_LANE_0, DQS_RX_TRIM, ITRIM, 3);
            }
            else
            {
                DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_BYTE_LANE_0, DQS_RX_TRIM, TERM_ITRIM, 3);
            ...
            DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_BYTE_LANE_0, DQS_RX_TRIM, TERM_LSTRIM, 0xA);
            DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_BYTE_LANE_0, DQS_RX_TRIM, IDLE_LSTRIM, 0xA);
            DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_BYTE_LANE_0, DQS_RX_TRIM, LSTRIM, 0xA);
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_DQS_RX_TRIMr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_DQS_RX_TRIMr(unit, data));
            if(shmoo_dram_info.interface_bitwidth == 32)
            {
                SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_DQS_RX_TRIMr(unit, data));
                SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_DQS_RX_TRIMr(unit, data));
            }
            #if (defined(PHY_AND28_F4))
                if(shmoo_dram_info.ecc_32p4)
                {
                    SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_DQS_RX_TRIMr(unit, data));
                }
            #endif
        #endif
#endif /* SOC_DDR4_SUPPORT */
        sal_usleep(SHMOO_AND28_SHORT_SLEEP);
...
/*A10*/ LOG_VERBOSE(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A10. Configure ODT\n")));
...
#endif
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_WRITE_ODT_CNTRLr(unit, data));
        ...
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_ODT_CONTROLr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_ODT_CONTROLr(unit, data));
        if(shmoo_dram_info.interface_bitwidth == 32)
        {
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_ODT_CONTROLr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_ODT_CONTROLr(unit, data));
        }
        #if (defined(PHY_AND28_F4))
        if(shmoo_dram_info.ecc_32p4)
        {
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_ODT_CONTROLr(unit, data));
        }
        #endif
        sal_usleep(SHMOO_AND28_SHORT_SLEEP);

/*A11*/ LOG_VERBOSE(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A11. Configure Write Pre-/Post-amble\n")));
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_WR_PREAMBLE_MODEr(unit, &data));
        ...
        #if (defined(PHY_AND28_F4))
            DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_BYTE_LANE_0, WR_PREAMBLE_MODE, DM_POSTAM_BITS, 1);
            DDR_PHY_SET_FIELD(data, DDR34_CORE_PHY_BYTE_LANE_0, WR_PREAMBLE_MODE, DM_PREAM_BITS, 1);
        #endif
        ...
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_WR_PREAMBLE_MODEr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_WR_PREAMBLE_MODEr(unit, data));
        if(shmoo_dram_info.interface_bitwidth == 32)
        {
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_WR_PREAMBLE_MODEr(unit, data));
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_WR_PREAMBLE_MODEr(unit, data));
        }
        #if (defined(PHY_AND28_F4))
        if(shmoo_dram_info.ecc_32p4)
        {
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_WR_PREAMBLE_MODEr(unit, data));
        }
        #endif
        sal_usleep(SHMOO_AND28_SHORT_SLEEP);

/*A12*/ LOG_VERBOSE(BSL_LS_SOC_DDR, (BSL_META_U(unit, "A12. Configure Auto Idle\n")));
        SOC_IF_ERROR_RETURN(READ_DDR_PHY_BYTE_LANE_0_IDLE_PAD_CONTROLr(unit, &data));
        ...
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_0_IDLE_PAD_CONTROLr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_1_IDLE_PAD_CONTROLr(unit, data));
        if(shmoo_dram_info.interface_bitwidth != 32)
        {
        ...
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_2_IDLE_PAD_CONTROLr(unit, data));
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_BYTE_LANE_3_IDLE_PAD_CONTROLr(unit, data));
#if (defined(PHY_AND28_F4))
        if(shmoo_dram_info.ecc_32p4)
        {
            SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_ECC_LANE_IDLE_PAD_CONTROLr(unit, data));
        }
#endif

#if (defined(PHY_AND28_F0) || defined(PHY_AND28_F2) || defined(PHY_AND28_F4))
        SOC_IF_ERROR_RETURN(WRITE_DDR_PHY_CONTROL_REGS_STANDBY_CONTROLr(unit, 0));
#endif
        sal_usleep(SHMOO_AND28_SHORT_SLEEP);
