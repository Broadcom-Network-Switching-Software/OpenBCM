...
/* *INDENT-OFF* */
shr_error_e dnx_kbp_db_counter_read_initiate(int unit, int *db){DNX_KBP_DUMMY_PROTOTYPE_ERR_MSG("dnx_kbp_db_counter_read_initiate")}
shr_error_e dnx_kbp_entry_get_counter_value(int unit, int *db, int *entry, uint64 *value){DNX_KBP_DUMMY_PROTOTYPE_ERR_MSG("dnx_kbp_entry_get_counter_value")}
shr_error_e dnx_kbp_db_is_counter_read_complete(int unit, int *db, int *is_complete){DNX_KBP_DUMMY_PROTOTYPE_ERR_MSG("dnx_kbp_db_is_counter_read_complete")}
