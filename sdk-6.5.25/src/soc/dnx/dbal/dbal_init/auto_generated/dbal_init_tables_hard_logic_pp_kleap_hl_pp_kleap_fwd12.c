...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_KLEAP_FWD12_EXEM_MUX, is_valid, "KLEAP_FWD12_EXEM_MUX", DBAL_ACCESS_METHOD_HARD_LOGIC));
    ...
    dbal_db_init_table_db_struct_access_clear(cur_table_param, table_entry);
    {
        ...
        SHR_IF_ERR_EXIT(dbal_db_init_table_set_table_incompatible_image_sw_state_indication(unit, DBAL_TABLE_KLEAP_FWD12_EXEM_MUX, is_standard_1, is_compatible_with_all_images));
    }
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_FFC_GROUP_0_QUAD_0m, INVALIDf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
            ...
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_FFC_GROUP_1_QUAD_0m, INVALIDf));
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
            ...
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_FFC_GROUP_2_QUADm, INVALIDf));
                    {
            ...
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_FFC_GROUP_3_QUADm, INVALIDf));
                    {
                        access_params->array_offset.formula_int = 0;
                    }
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
            ...
            }
            {
                ...
                access_params->nof_conditions = condition_index;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPB_FLPLE_FFC_GROUP_4_QUADm, INVALIDf));
                    {
                        access_params->array_offset.formula_int = 0;
                    }
                    access_params->entry_offset.formula_cb = kleap_fwd12_ffc_quad_is_acl_ffc_quad_is_acl_entryoffset_0_cb;
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_KLEAP_FWD_CONTEXT_PROFILE, is_valid, "KLEAP_FWD_CONTEXT_PROFILE", DBAL_ACCESS_METHOD_HARD_LOGIC));
    table_entry->maturity_level = DBAL_MATURITY_HIGH;
    table_entry->table_type = DBAL_TABLE_TYPE_DIRECT;
    table_entry->nof_labels = 1;
    DBAL_DB_INIT_TABLE_LABELS_ALLOC(table_entry)
    ...
    dbal_db_init_table_db_struct_access_clear(cur_table_param, table_entry);
    {
        ...
        uint8 is_compatible_with_all_images = TRUE;
        DBAL_DB_INIT_TABLE_IMAGE_SPECIFIC_TABLE_INDICATION_SET(table_entry, is_standard_1, is_compatible_with_all_images);
        SHR_IF_ERR_EXIT(dbal_db_init_table_set_table_incompatible_image_sw_state_indication(unit, DBAL_TABLE_KLEAP_FWD_CONTEXT_PROFILE, is_standard_1, is_compatible_with_all_images));
    }
    table_entry->core_mode = DBAL_CORE_MODE_SBC;
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
