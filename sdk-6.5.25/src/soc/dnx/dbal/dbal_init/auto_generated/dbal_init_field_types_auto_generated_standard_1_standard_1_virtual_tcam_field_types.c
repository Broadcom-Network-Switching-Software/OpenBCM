...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_field_type_general_info_set(unit, cur_field_types_info, "PRTTCAM_KEY_VP_COE", 14, is_valid, FALSE, DBAL_FIELD_PRINT_TYPE_STRUCTURE, 1, TRUE));
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_field_type_db_struct_clear(unit, cur_field_type_param);
    SHR_IF_ERR_EXIT(dbal_db_init_field_type_general_info_set(unit, cur_field_types_info, "PRTTCAM_KEY_VP_PON", 13, is_valid, FALSE, DBAL_FIELD_PRINT_TYPE_STRUCTURE, 1, TRUE));
    ...
    cur_field_types_info->struct_field_info[1].length = dnx_data_dnx2_mdb_app_db.fields.numeric_mdb_field___VIRT_TCAM___PRTTCAM_KEY_VP_PONPTC_get(unit);
    cur_field_types_info->struct_field_info[2].struct_field_id = DBAL_FIELD_ZERO_PADDING;
    cur_field_types_info->struct_field_info[2].length = dnx_data_dnx2_mdb_app_db.fields.numeric_mdb_field___VIRT_TCAM___PRTTCAM_KEY_VP_PONZERO_PADDING_get(unit);
    dbal_init_field_type_default_restrict_values(cur_field_type_param);
    SHR_IF_ERR_EXIT(dbal_db_init_field_type_add(unit, cur_field_type_param, cur_field_types_info));
exit:
    SHR_FUNC_EXIT;
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_field_type_db_struct_clear(unit, cur_field_type_param);
    SHR_IF_ERR_EXIT(dbal_db_init_field_type_general_info_set(unit, cur_field_types_info, "PRTTCAM_KEY_VP_SPA", 16, is_valid, FALSE, DBAL_FIELD_PRINT_TYPE_STRUCTURE, 1, TRUE));
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_field_type_db_struct_clear(unit, cur_field_type_param);
    SHR_IF_ERR_EXIT(dbal_db_init_field_type_general_info_set(unit, cur_field_types_info, "PRT_KBR_INFO_HALF", 17, is_valid, FALSE, DBAL_FIELD_PRINT_TYPE_UINT32, 1, TRUE));
