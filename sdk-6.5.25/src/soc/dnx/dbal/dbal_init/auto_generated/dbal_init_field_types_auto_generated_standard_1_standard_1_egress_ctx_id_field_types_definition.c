...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    if (DBAL_IS_J2C_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___DUMMY12].value_from_mapping = 24;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___IPT_TAIL].value_from_mapping = 25;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___DUMMY4].value_from_mapping = 26;
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    DBAL_INIT_FIELD_TYPES_ENUMS_CLEAR(cur_field_type_param);
    {
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___DUMMY3, "GENERAL___DUMMY3");
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_FWD_CONTEXT_ID_MPLS___DUMMY2, "MPLS___DUMMY2");
    ...
    if (DBAL_IS_J2C_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___DO_NOT_EDIT_AND_POP_ETPS].value_from_mapping = 22;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___IPT_TAIL_AM].value_from_mapping = 23;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___IPT_TAIL].value_from_mapping = 24;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___DUMMY3].value_from_mapping = 25;
            ...
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_MPLS___SWAP].value_from_mapping = 37;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_MPLS___DUMMY2].value_from_mapping = 39;
            ...
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_MPLS___SWAP_WO_ETPS_POP].value_from_mapping = 38;
