    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, EVNT_TX_ENG_EVPCK_PADDING_ENABLEr, INVALIDf));
        ...
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, EVNT_TX_ENG_CONTEXT_QUEUE_TIMEOUT_VALUEr, INVALIDf));
        ...
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, EVNT_TX_ENG_CONTEXT_QUEUE_MAX_SIZEr, INVALIDf));
                    access_params->array_offset.formula_cb = eventor_tx_eng_cfg_padding_enable_dataoffset_0_cb;
                }
            }
        }
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, EVNT_TX_ENG_CONTEXT_QUEUE_TYPEr, INVALIDf));
            ...
            {
                {
                    ...
                    for (field_instance = 0; field_instance < dnx_data_instru.eventor.nof_contexts_get(unit); field_instance++)
                    {
                        ...
                        {
                            SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, EVNT_RX_TO_TX_BUFFERr, INVALIDf));
            ...
            {
                {
                    ...
                    for (field_instance = 0; field_instance < dnx_data_instru.eventor.nof_contexts_get(unit); field_instance++)
                    {
                        ...
                        access_params->inst_idx = field_instance;
                        {
                            SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, EVNT_TX_CONTEXT_IS_FIFO_DMAr, INVALIDf));
                            access_params->data_offset.formula_cb = kleap_fwd12_resources_mapping_kbr_selector_dataoffset_0_cb;
                        }
                    }
                }
            ...
            {
                {
                    ...
                    for (field_instance = 0; field_instance < dnx_data_instru.eventor.nof_contexts_get(unit); field_instance++)
                    {
                        ...
                        access_params->inst_idx = field_instance;
                        {
                            SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, EVNT_TX_MAIN_BUFFER_THr, INVALIDf));
            ...
            {
                {
                    ...
                    for (field_instance = 0; field_instance < dnx_data_instru.eventor.nof_contexts_get(unit); field_instance++)
                    {
                        ...
                        access_params->inst_idx = field_instance;
                        {
                            SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, EVNT_RX_MAIN_BUFFER_THr, INVALIDf));
                            access_params->data_offset.formula_cb = eventor_tx_context_main_buffer_th_tx_buffer_th_dataoffset_0_cb;
                        }
                    }
                }
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, EVNT_EVPCK_HEADER_STACK_SIZEr, INVALIDf));
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, EVNT_TRANSMIT_HEADER_STACK_SIZEr, INVALIDf));
        ...
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, EVNT_TRANSMIT_HEADER_STACKr, INVALIDf));
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, EVNT_MAIN_MEM_BANK_TYPEr, INVALIDf));
            ...
            {
                {
                    ...
                    for (field_instance = 0; field_instance < 2; field_instance++)
                    {
                        ...
                        access_params->inst_idx = field_instance;
                        {
                            SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, EVNT_CONTEXT_PROPERTIESm, INVALIDf));
                            access_params->array_offset.formula_cb = eventor_space_regions_buffer_start_addr_arrayoffset_0_cb;
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, EVNT_SHARED_CMIC_ENG_POOLr, INVALIDf));
                }
            }
        }
        cur_table_param->hl_access[map_idx].nof_access = access_counter;
