...
shr_error_e
_dbal_init_tables_hard_logic_tm_hl_tm_ecgm_thresholds_ecgm_unicast_port_thresholds_wo_profile_init(
int unit,
table_db_struct_t * cur_table_param,
dbal_logical_table_t * table_info)
{
    dbal_logical_table_t * table_entry = table_info + DBAL_TABLE_ECGM_UNICAST_PORT_THRESHOLDS_WO_PROFILE;
    int is_valid = !dnx_data_ecgm.port_resources.feature_get(unit, dnx_data_ecgm_port_resources_profile_management);
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_ECGM_UNICAST_PORT_THRESHOLDS_WO_PROFILE, is_valid, "ECGM_UNICAST_PORT_THRESHOLDS_WO_PROFILE", DBAL_ACCESS_METHOD_HARD_LOGIC));
    if (!is_valid)
    {
        SHR_EXIT();
    }
    ...
    dbal_db_init_table_db_struct_access_clear(cur_table_param, table_entry);
    {
        ...
        uint8 is_compatible_with_all_images = TRUE;
        DBAL_DB_INIT_TABLE_IMAGE_SPECIFIC_TABLE_INDICATION_SET(table_entry, is_standard_1, is_compatible_with_all_images);
        SHR_IF_ERR_EXIT(dbal_db_init_table_set_table_incompatible_image_sw_state_indication(unit, DBAL_TABLE_ECGM_UNICAST_PORT_THRESHOLDS_WO_PROFILE, is_standard_1, is_compatible_with_all_images));
    }
    table_entry->core_mode = DBAL_CORE_MODE_DPC;
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_table_add(unit, cur_table_param, DBAL_TABLE_ECGM_UNICAST_PORT_THRESHOLDS_WO_PROFILE, table_info));
exit:
    SHR_FUNC_EXIT;
}
...
shr_error_e
_dbal_init_tables_hard_logic_tm_hl_tm_ecgm_thresholds_ecgm_multicast_port_thresholds_wo_profile_init(
int unit,
table_db_struct_t * cur_table_param,
dbal_logical_table_t * table_info)
{
    dbal_logical_table_t * table_entry = table_info + DBAL_TABLE_ECGM_MULTICAST_PORT_THRESHOLDS_WO_PROFILE;
    int is_valid = !dnx_data_ecgm.port_resources.feature_get(unit, dnx_data_ecgm_port_resources_profile_management);
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_ECGM_MULTICAST_PORT_THRESHOLDS_WO_PROFILE, is_valid, "ECGM_MULTICAST_PORT_THRESHOLDS_WO_PROFILE", DBAL_ACCESS_METHOD_HARD_LOGIC));
    if (!is_valid)
    {
        SHR_EXIT();
    }
    ...
    dbal_db_init_table_db_struct_access_clear(cur_table_param, table_entry);
    {
        ...
        uint8 is_compatible_with_all_images = TRUE;
        DBAL_DB_INIT_TABLE_IMAGE_SPECIFIC_TABLE_INDICATION_SET(table_entry, is_standard_1, is_compatible_with_all_images);
        SHR_IF_ERR_EXIT(dbal_db_init_table_set_table_incompatible_image_sw_state_indication(unit, DBAL_TABLE_ECGM_MULTICAST_PORT_THRESHOLDS_WO_PROFILE, is_standard_1, is_compatible_with_all_images));
    }
    table_entry->core_mode = DBAL_CORE_MODE_DPC;
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_table_add(unit, cur_table_param, DBAL_TABLE_ECGM_MULTICAST_PORT_THRESHOLDS_WO_PROFILE, table_info));
exit:
    SHR_FUNC_EXIT;
}
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(_dbal_init_tables_hard_logic_tm_hl_tm_ecgm_thresholds_ecgm_unicast_port_thresholds_wo_profile_init(unit, cur_table_param, table_info));
    ...
    SHR_IF_ERR_EXIT(_dbal_init_tables_hard_logic_tm_hl_tm_ecgm_thresholds_ecgm_multicast_port_thresholds_wo_profile_init(unit, cur_table_param, table_info));
