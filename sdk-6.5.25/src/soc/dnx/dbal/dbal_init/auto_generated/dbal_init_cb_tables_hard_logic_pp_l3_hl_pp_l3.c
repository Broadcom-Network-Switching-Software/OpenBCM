...
uint32 * offset)
{
    ...
    *offset = key_value__ecmp_id/dnx_data_l3.ecmp.nof_extended_ecmp_per_failover_bank_get(unit)-32768/dnx_data_l3.ecmp.nof_extended_ecmp_per_failover_bank_get(unit);
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_ECMP_ID, key_value__ecmp_id);
    *offset = key_value__ecmp_id % dnx_data_l3.ecmp.nof_extended_ecmp_per_failover_bank_get(unit);
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_ECMP_ID, key_value__ecmp_id);
    *offset = 16+key_value__ecmp_id/dnx_data_l3.ecmp.nof_extended_ecmp_per_failover_bank_get(unit)-32768/dnx_data_l3.ecmp.nof_extended_ecmp_per_failover_bank_get(unit);
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_ECMP_ID, key_value__ecmp_id);
    *offset = key_value__ecmp_id/dnx_data_l3.ecmp.ecmp_bank_size_get(unit);
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
