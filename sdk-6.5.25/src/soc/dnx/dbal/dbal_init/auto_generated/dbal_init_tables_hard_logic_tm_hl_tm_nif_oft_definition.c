...
shr_error_e
_dbal_init_tables_hard_logic_tm_hl_tm_nif_oft_definition_nif_oft_reset_credits_counter_init(
int unit,
table_db_struct_t * cur_table_param,
dbal_logical_table_t * table_info)
{
    dbal_logical_table_t * table_entry = table_info + DBAL_TABLE_NIF_OFT_RESET_CREDITS_COUNTER;
    int is_valid = dnx_data_nif.oft.feature_get(unit, dnx_data_nif_oft_is_supported);
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_NIF_OFT_RESET_CREDITS_COUNTER, is_valid, "NIF_OFT_RESET_CREDITS_COUNTER", DBAL_ACCESS_METHOD_HARD_LOGIC));
    if (!is_valid)
    {
        SHR_EXIT();
    }
    ...
    dbal_db_init_table_db_struct_access_clear(cur_table_param, table_entry);
    {
        ...
        uint8 is_compatible_with_all_images = TRUE;
        DBAL_DB_INIT_TABLE_IMAGE_SPECIFIC_TABLE_INDICATION_SET(table_entry, is_standard_1, is_compatible_with_all_images);
        SHR_IF_ERR_EXIT(dbal_db_init_table_set_table_incompatible_image_sw_state_indication(unit, DBAL_TABLE_NIF_OFT_RESET_CREDITS_COUNTER, is_standard_1, is_compatible_with_all_images));
    }
    table_entry->core_mode = DBAL_CORE_MODE_SBC;
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    ...
                    access_params->data_offset.formula_cb = nif_oft_reset_credits_counter_port_reset_dataoffset_0_cb;
                }
            }
        }
        cur_table_param->hl_access[map_idx].nof_access = access_counter;
    }
    SHR_IF_ERR_EXIT(dbal_db_init_table_add(unit, cur_table_param, DBAL_TABLE_NIF_OFT_RESET_CREDITS_COUNTER, table_info));
exit:
    SHR_FUNC_EXIT;
}
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_MEMORY;
                {
                    ...
                    access_params->entry_offset.formula_cb = nif_oft_reset_credits_counter_port_reset_dataoffset_0_cb;
                }
            }
            {
                access_params = &cur_table_param->hl_access[map_idx].access[access_counter];
...
shr_error_e
_dbal_init_tables_hard_logic_tm_hl_tm_nif_oft_definition_nif_oft_enable_memories_init(
int unit,
table_db_struct_t * cur_table_param,
dbal_logical_table_t * table_info)
{
    dbal_logical_table_t * table_entry = table_info + DBAL_TABLE_NIF_OFT_ENABLE_MEMORIES;
    int is_valid = dnx_data_nif.oft.feature_get(unit, dnx_data_nif_oft_is_supported);
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_NIF_OFT_ENABLE_MEMORIES, is_valid, "NIF_OFT_ENABLE_MEMORIES", DBAL_ACCESS_METHOD_HARD_LOGIC));
    if (!is_valid)
    {
        SHR_EXIT();
    }
    ...
    dbal_db_init_table_db_struct_access_clear(cur_table_param, table_entry);
    {
        ...
        uint8 is_compatible_with_all_images = TRUE;
        DBAL_DB_INIT_TABLE_IMAGE_SPECIFIC_TABLE_INDICATION_SET(table_entry, is_standard_1, is_compatible_with_all_images);
        SHR_IF_ERR_EXIT(dbal_db_init_table_set_table_incompatible_image_sw_state_indication(unit, DBAL_TABLE_NIF_OFT_ENABLE_MEMORIES, is_standard_1, is_compatible_with_all_images));
    }
    table_entry->core_mode = DBAL_CORE_MODE_SBC;
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, OFT_ENABLE_DYNAMIC_MEMORY_ACCESSr, ENABLE_DYNAMIC_MEMORY_ACCESS_TMC_RD_FIFOS_DESCRIPTORSf));
                }
            }
            {
                access_params = &cur_table_param->hl_access[map_idx].access[access_counter];
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, OFT_ENABLE_DYNAMIC_MEMORY_ACCESSr, ENABLE_DYNAMIC_MEMORY_ACCESS_TMC_WR_FIFOS_DESCRIPTORSf));
                }
            }
        }
        cur_table_param->hl_access[map_idx].nof_access = access_counter;
    }
    SHR_IF_ERR_EXIT(dbal_db_init_table_add(unit, cur_table_param, DBAL_TABLE_NIF_OFT_ENABLE_MEMORIES, table_info));
exit:
    SHR_FUNC_EXIT;
}
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(_dbal_init_tables_hard_logic_tm_hl_tm_nif_oft_definition_nif_oft_reset_credits_counter_init(unit, cur_table_param, table_info));
    ...
    SHR_IF_ERR_EXIT(_dbal_init_tables_hard_logic_tm_hl_tm_nif_oft_definition_nif_oft_enable_memories_init(unit, cur_table_param, table_info));
exit:
    SHR_FUNC_EXIT;
}
