...
dbal_db_tables_properties_table_status_dump(int  unit,  int  tables_properties_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DBAL_MODULE_ID, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->tables_properties))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DBAL_MODULE_ID, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->tables_properties) == 0)
        {
            SHR_EXIT();
        }
...
dbal_db_dbal_dynamic_tables_table_id_dump(int  unit,  int  dbal_dynamic_tables_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DBAL_MODULE_ID, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_tables))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DBAL_MODULE_ID, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_tables) == 0)
        {
            SHR_EXIT();
        }
...
dbal_db_dbal_dynamic_xml_tables_table_id_dump(int  unit,  int  dbal_dynamic_xml_tables_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DBAL_MODULE_ID, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_xml_tables))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DBAL_MODULE_ID, ((dnx_dbal_sw_state_t*)sw_state_roots_array[unit][DBAL_MODULE_ID])->dbal_dynamic_xml_tables) == 0)
        {
            SHR_EXIT();
        }
...
dbal_db_dbal_fields_field_id_dump(int  unit,  int  dbal_fields_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if (i0 == -1) {
            I0 = DNX_DATA_MAX_FIELD_QUAL_USER_NOF+DNX_DATA_MAX_FIELD_ACTION_USER_NOF+DNX_DATA_MAX_FIELD_QUAL_PREDEFINED_NOF+DNX_DATA_MAX_FIELD_ACTION_PREDEFINED_NOF;
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
        ...
        if(i0 >= DNX_DATA_MAX_FIELD_QUAL_USER_NOF+DNX_DATA_MAX_FIELD_ACTION_USER_NOF+DNX_DATA_MAX_FIELD_QUAL_PREDEFINED_NOF+DNX_DATA_MAX_FIELD_ACTION_PREDEFINED_NOF)
        {
        ...
        if(DNX_DATA_MAX_FIELD_QUAL_USER_NOF+DNX_DATA_MAX_FIELD_ACTION_USER_NOF+DNX_DATA_MAX_FIELD_QUAL_PREDEFINED_NOF+DNX_DATA_MAX_FIELD_ACTION_PREDEFINED_NOF == 0)
        {
            SHR_EXIT();
        }
