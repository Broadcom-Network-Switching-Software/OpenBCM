...
dnx_field_tcam_prefix_sw_banks_prefix_core_prefix_map_prefix_handler_map_dump(int  unit,  int  banks_prefix_idx_0,  int  core_prefix_map_idx_0,  int  prefix_handler_map_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_FIELD_TCAM_PREFIX_MODULE_ID, ((dnx_field_tcam_prefix_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_PREFIX_MODULE_ID])->banks_prefix[i0].core_prefix_map))
            {
                LOG_CLI((BSL_META("dnx_field_tcam_prefix_sw[]->((dnx_field_tcam_prefix_sw_t*)sw_state_roots_array[][DNX_FIELD_TCAM_PREFIX_MODULE_ID])->banks_prefix[].core_prefix_map[].prefix_handler_map[]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_FIELD_TCAM_PREFIX_MODULE_ID, ((dnx_field_tcam_prefix_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_PREFIX_MODULE_ID])->banks_prefix[i0].core_prefix_map) == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                if(i2 >= dnx_sw_state_get_nof_elements(unit, DNX_FIELD_TCAM_PREFIX_MODULE_ID, ((dnx_field_tcam_prefix_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_PREFIX_MODULE_ID])->banks_prefix[i0].core_prefix_map[i1].prefix_handler_map))
                {
                    LOG_CLI((BSL_META("dnx_field_tcam_prefix_sw[]->((dnx_field_tcam_prefix_sw_t*)sw_state_roots_array[][DNX_FIELD_TCAM_PREFIX_MODULE_ID])->banks_prefix[].core_prefix_map[].prefix_handler_map[]: ")));
                    LOG_CLI((BSL_META("Invalid index: %d \n"),i2));
                    SHR_EXIT();
                ...
                if(dnx_sw_state_get_nof_elements(unit, DNX_FIELD_TCAM_PREFIX_MODULE_ID, ((dnx_field_tcam_prefix_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_PREFIX_MODULE_ID])->banks_prefix[i0].core_prefix_map[i1].prefix_handler_map) == 0)
                {
                    SHR_EXIT();
                }
