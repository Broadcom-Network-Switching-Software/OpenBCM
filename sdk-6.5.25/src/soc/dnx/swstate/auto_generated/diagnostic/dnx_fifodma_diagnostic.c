...
dnx_fifodma_info_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(dnx_fifodma_info_fifodma_thread_shr_thread_manager_handler_dump(unit, filters));
...
int
dnx_fifodma_info_fifodma_thread_shr_thread_manager_handler_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    DNXC_SW_STATE_FUNC_RETURN;
}
...
const char* dnx_fifodma_info_layout_str[DNX_FIFODMA_INFO_INFO_NOF_ENTRIES] = {
    ...
    "DNX_FIFODMA_INFO~FIFODMA_THREAD_SHR_THREAD_MANAGER_HANDLER~",
};
#endif 
