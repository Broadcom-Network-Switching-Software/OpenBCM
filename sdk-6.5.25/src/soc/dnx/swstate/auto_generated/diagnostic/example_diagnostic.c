...
example_bitmap_include_only_example_dump(int  unit,  int  bitmap_include_only_example_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, EXAMPLE_MODULE_ID, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->bitmap_include_only_example))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, EXAMPLE_MODULE_ID, ((sw_state_example*)sw_state_roots_array[unit][EXAMPLE_MODULE_ID])->bitmap_include_only_example) == 0)
        {
            SHR_EXIT();
        }
