    ...
    int unit)
{
    ...
    table->keys[0].size = 319;
    table->info_get.key_size[0] = 319;
...
static shr_error_e
j2c_a0_dnx_data_intr_general_skip_clear_on_init_set(
    int unit)
{
    int offset_index;
    ...
    int unit)
{
    ...
    table->keys[0].size = 153;
    table->info_get.key_size[0] = 153;
...
static shr_error_e
j2c_a0_dnx_data_intr_ser_severity_mem_set(
    int unit)
{
    int index_index;
    ...
    table->keys[0].size = 24;
    table->info_get.key_size[0] = 24;
    ...
    int unit)
{
    ...
    table = &submodule->tables[data_index];
    table->set = j2c_a0_dnx_data_intr_general_skip_clear_on_init_set;
    ...
    table = &submodule->tables[data_index];
    table->set = j2c_a0_dnx_data_intr_ser_severity_mem_set;
