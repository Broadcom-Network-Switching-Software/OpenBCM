...
static shr_error_e
jr2_a0_dnx_data_qos_feature_ingress_ttl_uniform_small_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_qos;
    int submodule_index = dnx_data_qos_submodule_feature;
    int feature_index = dnx_data_qos_feature_ingress_ttl_uniform_small;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_qos_feature_ingress_ttl_uniform_small;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_qos_feature_ingress_ttl_uniform_small_set;
