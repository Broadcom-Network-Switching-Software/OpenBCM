...
static shr_error_e
jr2_a0_dnx_data_trunk_egress_trunk_is_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trunk;
    int submodule_index = dnx_data_trunk_submodule_egress_trunk;
    int feature_index = dnx_data_trunk_egress_trunk_is_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_trunk_flow_agg_flow_aggs_in_bundle_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_trunk;
    int submodule_index = dnx_data_trunk_submodule_flow_agg;
    int define_index = dnx_data_trunk_flow_agg_define_flow_aggs_in_bundle;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_trunk_flow_agg_nof_flow_aggs_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_trunk;
...
static shr_error_e
jr2_a0_dnx_data_trunk_flow_agg_nof_flow_agg_bundles_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_trunk;
    int submodule_index = dnx_data_trunk_submodule_flow_agg;
    int define_index = dnx_data_trunk_flow_agg_define_nof_flow_agg_bundles;
    SHR_FUNC_INIT_VARS(unit);

    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    
    define->default_data = dnx_data_trunk.flow_agg.nof_flow_aggs_get(unit) / dnx_data_trunk.flow_agg.flow_aggs_in_bundle_get(unit);

    
    define->data = dnx_data_trunk.flow_agg.nof_flow_aggs_get(unit) / dnx_data_trunk.flow_agg.flow_aggs_in_bundle_get(unit);
...
static shr_error_e
jr2_a0_dnx_data_trunk_flow_agg_first_flow_agg_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_trunk;
    int submodule_index = dnx_data_trunk_submodule_flow_agg;
    int define_index = dnx_data_trunk_flow_agg_define_first_flow_agg_id;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_trunk_egress_trunk_is_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_trunk_egress_trunk_is_supported_set;
    ...
    data_index = dnx_data_trunk_flow_agg_define_flow_aggs_in_bundle;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_trunk_flow_agg_flow_aggs_in_bundle_set;
    data_index = dnx_data_trunk_flow_agg_define_nof_flow_aggs;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_trunk_flow_agg_nof_flow_aggs_set;
    data_index = dnx_data_trunk_flow_agg_define_nof_flow_agg_bundles;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_trunk_flow_agg_nof_flow_agg_bundles_set;
    data_index = dnx_data_trunk_flow_agg_define_first_flow_agg_id;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_trunk_flow_agg_first_flow_agg_id_set;
