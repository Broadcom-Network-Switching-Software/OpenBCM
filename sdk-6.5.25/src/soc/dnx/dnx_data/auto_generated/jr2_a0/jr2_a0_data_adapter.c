    ...
    int unit)
{
    ...
    data->mdb = DBAL_PHYSICAL_TABLE_EOEM_1;
    data->interface = "3";
    data = (dnx_data_adapter_mdb_lookup_caller_id_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 669, DNX_PP_STAGE_IFWD2+100*DBAL_PHYSICAL_TABLE_EOEM_1);
    data->stage = DNX_PP_STAGE_IFWD2;
    data->mdb = DBAL_PHYSICAL_TABLE_EOEM_1;
    data->interface = "0";
    data = (dnx_data_adapter_mdb_lookup_caller_id_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 670, DNX_PP_STAGE_IFWD2+100*DBAL_PHYSICAL_TABLE_EOEM_1);
    data->stage = DNX_PP_STAGE_IFWD2;
    data->mdb = DBAL_PHYSICAL_TABLE_EOEM_1;
    data->interface = "1";
    data = (dnx_data_adapter_mdb_lookup_caller_id_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 671, DNX_PP_STAGE_IFWD2+100*DBAL_PHYSICAL_TABLE_EOEM_1);
    data->stage = DNX_PP_STAGE_IFWD2;
    data->mdb = DBAL_PHYSICAL_TABLE_EOEM_1;
    data->interface = "2";
    data = (dnx_data_adapter_mdb_lookup_caller_id_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 672, DNX_PP_STAGE_IFWD2+100*DBAL_PHYSICAL_TABLE_EOEM_1);
    data->stage = DNX_PP_STAGE_IFWD2;
    data->mdb = DBAL_PHYSICAL_TABLE_EOEM_1;
    data->interface = "3";
