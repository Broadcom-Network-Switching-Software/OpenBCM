...
static shr_error_e
jr2_a0_dnx_data_switch_load_balancing_fwd_hashing_method_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_switch;
    int submodule_index = dnx_data_switch_submodule_load_balancing;
    int feature_index = dnx_data_switch_load_balancing_fwd_hashing_method;
    SHR_FUNC_INIT_VARS(unit);

    feature = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].features[feature_index];
    
    feature->default_data = DNX_SWITCH_LB_FWD_HASH_METHOD_CRC_FUNCTION;

    
    feature->data = DNX_SWITCH_LB_FWD_HASH_METHOD_CRC_FUNCTION;
...
static shr_error_e
jr2_a0_dnx_data_switch_load_balancing_layer_record_mode_selection_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_switch;
    int submodule_index = dnx_data_switch_submodule_load_balancing;
    int feature_index = dnx_data_switch_load_balancing_layer_record_mode_selection;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_switch_load_balancing_seed_config_per_pp_port_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_switch;
    int submodule_index = dnx_data_switch_submodule_load_balancing;
    int feature_index = dnx_data_switch_load_balancing_seed_config_per_pp_port;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_switch_load_balancing_nof_bits_mpls_protocol_identifier_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_switch;
    int submodule_index = dnx_data_switch_submodule_load_balancing;
    int define_index = dnx_data_switch_load_balancing_define_nof_bits_mpls_protocol_identifier;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_switch_load_balancing_seed_configuration_per_pp_port_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_switch;
    int submodule_index = dnx_data_switch_submodule_load_balancing;
    int define_index = dnx_data_switch_load_balancing_define_seed_configuration_per_pp_port;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    if (DBAL_ENUM_FVAL_HASH_FIELD_ENABLERS_HEADER_IP6 < table->keys[0].size)
    {
        data = (dnx_data_switch_load_balancing_lb_field_enablers_t *) dnxc_data_mgmt_table_data_get(unit, table, DBAL_ENUM_FVAL_HASH_FIELD_ENABLERS_HEADER_IP6, 0);
...
static shr_error_e
jr2_a0_dnx_data_switch_load_balancing_sim_device_enum_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_switch;
...
static shr_error_e
jr2_a0_dnx_data_switch_svtag_svtag_init_valid_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_switch;
    int submodule_index = dnx_data_switch_submodule_svtag;
    int define_index = dnx_data_switch_svtag_define_svtag_init_valid;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_switch_load_balancing_define_nof_bits_mpls_protocol_identifier;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_switch_load_balancing_nof_bits_mpls_protocol_identifier_set;
    data_index = dnx_data_switch_load_balancing_define_seed_configuration_per_pp_port;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_switch_load_balancing_seed_configuration_per_pp_port_set;

    
    data_index = dnx_data_switch_load_balancing_fwd_hashing_method;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_switch_load_balancing_fwd_hashing_method_set;
    data_index = dnx_data_switch_load_balancing_layer_record_mode_selection;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_switch_load_balancing_layer_record_mode_selection_set;
    data_index = dnx_data_switch_load_balancing_seed_config_per_pp_port;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_switch_load_balancing_seed_config_per_pp_port_set;
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_switch_load_balancing_sim_device_enum_set;
    ...
    data_index = dnx_data_switch_svtag_define_svtag_init_valid;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_switch_svtag_svtag_init_valid_set;
