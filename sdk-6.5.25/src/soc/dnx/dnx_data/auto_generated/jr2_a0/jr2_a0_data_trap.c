...
static shr_error_e
jr2_a0_dnx_data_trap_etpp_oam_traps_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_trap;
    int submodule_index = dnx_data_trap_submodule_etpp;
    int feature_index = dnx_data_trap_etpp_oam_traps_support;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_trap_etpp_oam_traps_support;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_trap_etpp_oam_traps_support_set;
