    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_lane_map_nif_table_mapping].labels[0] = "j2x_notrev";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_lane_map_fabric_define_resolution].labels[0] = "j2x_notrev";
    ...
    submodule_data->tables[dnx_data_lane_map_fabric_table_mapping].labels[0] = "j2x_notrev";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_lane_map_ilkn_table_remapping].labels[0] = "j2x_notrev";
