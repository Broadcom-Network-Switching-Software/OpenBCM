    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->doc = "techsupport tm/all.";
    ...
    submodule_data->defines[dnx_data_techsupport_tm_define_num_of_tables_per_block].doc = "number of tables per block";
    ...
    submodule_data->defines[dnx_data_techsupport_tm_define_num_of_tm_command].doc = "number of tm command";
    ...
    submodule_data->tables[dnx_data_techsupport_tm_table_tm_block].doc = "tm block information";
    ...
    submodule_data->tables[dnx_data_techsupport_tm_table_tm_block].keys[0].doc = "block information";
    ...
    submodule_data->tables[dnx_data_techsupport_tm_table_tm_command].doc = "tm command information";
    ...
    submodule_data->tables[dnx_data_techsupport_tm_table_tm_command].keys[0].doc = "running index";
    ...
    submodule_data->tables[dnx_data_techsupport_tm_table_tm_mem].doc = "tm memory table information";
    ...
    submodule_data->tables[dnx_data_techsupport_tm_table_tm_mem].keys[0].doc = "block information";
    submodule_data->tables[dnx_data_techsupport_tm_table_tm_mem].keys[1].name = "index";
    submodule_data->tables[dnx_data_techsupport_tm_table_tm_mem].keys[1].doc = "index in block";
