...
static shr_error_e
q2a_b0_dnx_data_switch_load_balancing_sim_device_enum_set(
    int unit)
{
    ...
    int unit)
{
    ...
    define->set = q2a_b0_dnx_data_switch_load_balancing_sim_device_enum_set;
