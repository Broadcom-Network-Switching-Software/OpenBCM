    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_iqs_credit_profile_is_rate_class].doc = "indicate if credit profile is unified with rate class profile";
    ...
    submodule_data->defines[dnx_data_iqs_credit_define_profile_nof_bits].doc = "nof bits of supported profiles";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_iqs_deq_default_dequeue_params_configuration].doc = "indicate if dequeue params should be configured";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_iqs_dbal_define_credit_worth_nof_bits].doc = "nof bits for credit received from different devices";
