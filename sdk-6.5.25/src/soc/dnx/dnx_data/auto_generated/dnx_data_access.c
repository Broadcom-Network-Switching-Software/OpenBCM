    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_access_mdio_define_nof_pms_per_ring].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_access_mdio_define_ring_offset].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_access_mdio_define_ext_divisor].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_access_mdio_define_int_divisor].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_access_mdio_define_int_div_out_delay].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_access_mdio_define_ext_div_out_delay].labels[0] = "j2x_notrev";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_access_rcpu_table_rx].labels[0] = "j2x_notrev";
