    ...
    int unit)
{
    ...
    table->keys[0].size = 41;
    table->info_get.key_size[0] = 41;
    table->keys[1].size = 24;
    table->info_get.key_size[1] = 24;
    ...
    data->mdb = DBAL_PHYSICAL_TABLE_TCAM;
    data->interface = "UnknownInterface";
    data = (dnx_data_adapter_mdb_lookup_caller_id_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 8, DNX_PP_STAGE_IPMF1+100*DBAL_PHYSICAL_TABLE_TCAM);
    data->stage = DNX_PP_STAGE_IPMF1;
    data->mdb = DBAL_PHYSICAL_TABLE_TCAM;
    data->interface = "UnknownInterface";
