...
static shr_error_e
j2p_a0_dnx_data_pll_general_ts_phase_initial_hi_config_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_pll;
...
static shr_error_e
j2p_a0_dnx_data_pll_general_ts_phase_initial_lo_set(
    int unit)
{
...
static shr_error_e
j2p_a0_dnx_data_pll_general_ts_phase_initial_hi_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_pll;
...
static shr_error_e
j2p_a0_dnx_data_pll_general_ts_nof_bits_hi_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_pll;
    ...
    int unit)
{
    ...
    define->set = j2p_a0_dnx_data_pll_general_ts_phase_initial_lo_set;
    data_index = dnx_data_pll_general_define_ts_phase_initial_hi;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_pll_general_ts_phase_initial_hi_set;
    data_index = dnx_data_pll_general_define_ts_nof_bits_hi;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_pll_general_ts_nof_bits_hi_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_pll_general_ts_phase_initial_hi_config_set;
