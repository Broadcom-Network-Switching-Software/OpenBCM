    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_esb_general_add_remove_queues_support].doc = "Indication if Egress Shared Buffers queues can be added or removed";
    ...
    submodule_data->features[dnx_data_esb_general_flexe_l1_dest_dedicated_queue_support].doc = "Support for dedicated identifier for FlexE L1 Ports queues to agreggate them  in the MUX";
    ...
    submodule_data->features[dnx_data_esb_general_graceful_calendar_switching].doc = "Support for graceful calendar switching - having active and non-active calendars for switching of configurations.";
    ...
    submodule_data->features[dnx_data_esb_general_per_priority_queues_mapping].doc = "Support for per priority mapping of ESB queues to EGQ TXQs.";
    ...
    submodule_data->defines[dnx_data_esb_general_define_nof_eth_lp_queues].doc = "Number of ESB queue IDs dedicated for ETH Low priority traffic";
    ...
    submodule_data->defines[dnx_data_esb_general_define_nof_ilkn_tdm_or_lp_queues].doc = "Number of ESB queue IDs dedicated for ILKN TDM interleave or Low priority traffic";
    ...
    submodule_data->defines[dnx_data_esb_general_define_mux_cal_window_size].doc = "Calendar window size for the ESB MUX calendar - how many slots are in a single calendar entry";
    ...
    submodule_data->defines[dnx_data_esb_general_define_flexe_queue_id_base].doc = "Base for start of FlexE queues.";
    ...
    submodule_data->defines[dnx_data_esb_general_define_ilkn_queue_id_base].doc = "Base for start of ILKN queues.";
    ...
    submodule_data->defines[dnx_data_esb_general_define_ilkn_tdm_or_lp_queue_id_base].doc = "Base for start of ILKN TDM interleave queues or Low priority traffic.";
    ...
    submodule_data->defines[dnx_data_esb_general_define_eth_lp_queue_id_base].doc = "Base for start of ETH Low priority traffic queues.";
    ...
    submodule_data->defines[dnx_data_esb_general_define_nof_egr_txi_interfaces].doc = "Number of EGQ TXI interfaces that can be mapped to ESB queues.";
    ...
    submodule_data->defines[dnx_data_esb_general_define_max_queue_to_map_to_nif].doc = "Max ESB queue ID that can be mapped to NIF port.";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_esb_dbal_define_credit_size_bits].doc = "Size in bits of EPNI TXI initial credit size value.";
    ...
    submodule_data->defines[dnx_data_esb_dbal_define_txi_irdy_thresh_size].doc = "Size in bits of EPNI TXI IRDY threshold value.";
