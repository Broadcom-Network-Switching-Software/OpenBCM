    ...
    int unit)
{
    ...
    dnx_data_port.general.prt_configuration_ptch2_ibch1_default_index_get = dnx_data_port_general_prt_configuration_ptch2_ibch1_default_index_get;
    dnx_data_port.general.prt_configuration_ptch1_ibch1_default_index_get = dnx_data_port_general_prt_configuration_ptch1_ibch1_default_index_get;
    dnx_data_port.general.prt_configuration_eth_ibch1_default_index_get = dnx_data_port_general_prt_configuration_eth_ibch1_default_index_get;
    ...
    dnx_data_ecgm.pool_db_size.feature_get = dnx_data_ecgm_pool_db_size_feature_get;

    
    dnx_data_ecgm.pool_db_size.uc_pool_db_max_size_get = dnx_data_ecgm_pool_db_size_uc_pool_db_max_size_get;
    dnx_data_ecgm.pool_db_size.mc_pool_db_max_size_get = dnx_data_ecgm_pool_db_size_mc_pool_db_max_size_get;
