    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_ecgm_general_global_receive_admission_and_drop_test].name = "global_receive_admission_and_drop_test";
    submodule_data->features[dnx_data_ecgm_general_global_receive_admission_and_drop_test].doc = "Indicate if the table of ECGM static core thresholds exists. ";
    submodule_data->features[dnx_data_ecgm_general_global_receive_admission_and_drop_test].flags |= DNXC_DATA_F_FEATURE;
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_ecgm_port_resources_profile_management].name = "profile_management";
    submodule_data->features[dnx_data_ecgm_port_resources_profile_management].doc = "Whether ECGM port resources are managed with profile";
    submodule_data->features[dnx_data_ecgm_port_resources_profile_management].flags |= DNXC_DATA_F_FEATURE;
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_ecgm_info_fc_egr_if_vector_select].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_ecgm_info_define_fc_q_pair_vector_select_nof_bits].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_ecgm_info_define_fc_q_pair_vector_nof_presented].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_ecgm_info_define_fc_egr_if_vector_select_nof_bits].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_ecgm_info_define_fc_egr_if_vector_nof_presented].labels[0] = "j2x_notrev";
...
static shr_error_e
dnx_data_ecgm_pool_db_size_init(
    int unit,
    dnxc_data_submodule_t *submodule_data)
{
    SHR_FUNC_INIT_VARS(unit);

    submodule_data->name = "pool_db_size";
    submodule_data->doc = "data buffer values for ECGM pool size";
    
    submodule_data->nof_features = _dnx_data_ecgm_pool_db_size_feature_nof;
    DNXC_DATA_ALLOC(submodule_data->features, dnxc_data_feature_t,  submodule_data->nof_features, "_dnxc_data ecgm pool_db_size features");

    submodule_data->features[dnx_data_ecgm_pool_db_size_pool_db_size].name = "pool_db_size";
    submodule_data->features[dnx_data_ecgm_pool_db_size_pool_db_size].doc = "Indicate if table of pool data buffer size for ECGM exists. ";
    submodule_data->features[dnx_data_ecgm_pool_db_size_pool_db_size].flags |= DNXC_DATA_F_FEATURE;

    
    submodule_data->nof_defines = _dnx_data_ecgm_pool_db_size_define_nof;
    DNXC_DATA_ALLOC(submodule_data->defines, dnxc_data_define_t, submodule_data->nof_defines, "_dnxc_data ecgm pool_db_size defines");

    submodule_data->defines[dnx_data_ecgm_pool_db_size_define_uc_pool_db_max_size].name = "uc_pool_db_max_size";
    submodule_data->defines[dnx_data_ecgm_pool_db_size_define_uc_pool_db_max_size].doc = "Uni-Cast pool data buffer max size for ECGM ";
    
    submodule_data->defines[dnx_data_ecgm_pool_db_size_define_uc_pool_db_max_size].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_ecgm_pool_db_size_define_mc_pool_db_max_size].name = "mc_pool_db_max_size";
    submodule_data->defines[dnx_data_ecgm_pool_db_size_define_mc_pool_db_max_size].doc = "Multi-Cast pool data buffer max size for ECGM";
    
    submodule_data->defines[dnx_data_ecgm_pool_db_size_define_mc_pool_db_max_size].flags |= DNXC_DATA_F_DEFINE;

    
    submodule_data->nof_tables = _dnx_data_ecgm_pool_db_size_table_nof;
    DNXC_DATA_ALLOC(submodule_data->tables, dnxc_data_table_t, submodule_data->nof_tables, "_dnxc_data ecgm pool_db_size tables");
...
int
dnx_data_ecgm_pool_db_size_feature_get(
    int unit,
    dnx_data_ecgm_pool_db_size_feature_e feature)
{
    return dnxc_data_mgmt_feature_data_get(unit, dnx_data_module_ecgm, dnx_data_ecgm_submodule_pool_db_size, feature);
}


uint32
dnx_data_ecgm_pool_db_size_uc_pool_db_max_size_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_ecgm, dnx_data_ecgm_submodule_pool_db_size, dnx_data_ecgm_pool_db_size_define_uc_pool_db_max_size);
}

uint32
dnx_data_ecgm_pool_db_size_mc_pool_db_max_size_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_ecgm, dnx_data_ecgm_submodule_pool_db_size, dnx_data_ecgm_pool_db_size_define_mc_pool_db_max_size);
}
    ...
    dnxc_data_module_t *module_data)
{
    ...
    SHR_IF_ERR_EXIT(dnx_data_ecgm_pool_db_size_init(unit, &module_data->submodules[dnx_data_ecgm_submodule_pool_db_size]));
