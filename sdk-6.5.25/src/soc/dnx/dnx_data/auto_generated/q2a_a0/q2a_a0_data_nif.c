...
static shr_error_e
q2a_a0_dnx_data_nif_flexe_sar_jitter_tolerance_max_level_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_flexe;
    int define_index = dnx_data_nif_flexe_define_sar_jitter_tolerance_max_level;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
q2a_a0_dnx_data_nif_flexe_mac_pad_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_flexe;
    int define_index = dnx_data_nif_flexe_define_mac_pad_size;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
q2a_a0_dnx_data_nif_flexe_sar_jitter_fifo_levels_set(
    int unit)
{
    int tolerance_level_index;
    dnx_data_nif_flexe_sar_jitter_fifo_levels_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_flexe;
    int table_index = dnx_data_nif_flexe_table_sar_jitter_fifo_levels;
    SHR_FUNC_INIT_VARS(unit);
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_nif_flexe_sar_jitter_fifo_levels_t, (1 * (table->keys[0].size) + 1  ), "data of dnx_data_nif_flexe_table_sar_jitter_fifo_levels");

    
    default_data = (dnx_data_nif_flexe_sar_jitter_fifo_levels_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    ...
    {
        data = (dnx_data_nif_flexe_sar_jitter_fifo_levels_t *) dnxc_data_mgmt_table_data_get(unit, table, tolerance_level_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
    
    if (0 < table->keys[0].size)
    {
        data = (dnx_data_nif_flexe_sar_jitter_fifo_levels_t *) dnxc_data_mgmt_table_data_get(unit, table, 0, 0);
        data->low_level = 0;
        data->high_level = 2;
    }
    if (1 < table->keys[0].size)
    {
        data = (dnx_data_nif_flexe_sar_jitter_fifo_levels_t *) dnxc_data_mgmt_table_data_get(unit, table, 1, 0);
        data->low_level = 0;
        data->high_level = 4;
    }
    if (2 < table->keys[0].size)
    {
        data = (dnx_data_nif_flexe_sar_jitter_fifo_levels_t *) dnxc_data_mgmt_table_data_get(unit, table, 2, 0);
        data->low_level = 1;
        data->high_level = 5;
    }
    if (3 < table->keys[0].size)
    {
        data = (dnx_data_nif_flexe_sar_jitter_fifo_levels_t *) dnxc_data_mgmt_table_data_get(unit, table, 3, 0);
        data->low_level = 2;
        data->high_level = 6;
    }
    if (4 < table->keys[0].size)
    {
        data = (dnx_data_nif_flexe_sar_jitter_fifo_levels_t *) dnxc_data_mgmt_table_data_get(unit, table, 4, 0);
        data->low_level = 2;
        data->high_level = 7;
    }
    if (5 < table->keys[0].size)
    {
        data = (dnx_data_nif_flexe_sar_jitter_fifo_levels_t *) dnxc_data_mgmt_table_data_get(unit, table, 5, 0);
        data->low_level = 2;
        data->high_level = 8;
    }
    if (6 < table->keys[0].size)
    {
        data = (dnx_data_nif_flexe_sar_jitter_fifo_levels_t *) dnxc_data_mgmt_table_data_get(unit, table, 6, 0);
        data->low_level = 3;
        data->high_level = 9;
    }
    if (7 < table->keys[0].size)
    {
        data = (dnx_data_nif_flexe_sar_jitter_fifo_levels_t *) dnxc_data_mgmt_table_data_get(unit, table, 7, 0);
        data->low_level = 3;
        data->high_level = 11;
    }
    ...
    int unit)
{
    ...
    data_index = dnx_data_nif_flexe_define_sar_jitter_tolerance_max_level;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_nif_flexe_sar_jitter_tolerance_max_level_set;
    data_index = dnx_data_nif_flexe_define_mac_pad_size;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_nif_flexe_mac_pad_size_set;
    ...
    data_index = dnx_data_nif_flexe_table_sar_jitter_fifo_levels;
    table = &submodule->tables[data_index];
    table->set = q2a_a0_dnx_data_nif_flexe_sar_jitter_fifo_levels_set;
