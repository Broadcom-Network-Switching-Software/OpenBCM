    ...
    int unit)
{
    ...
    table->keys[1].size = 20;
    table->info_get.key_size[1] = 20;
    ...
    data->mdb = DBAL_PHYSICAL_TABLE_TCAM;
    data->interface = "UnknownInterface";
    data = (dnx_data_adapter_mdb_lookup_caller_id_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 241, DNX_PP_STAGE_IPMF3+100*DBAL_PHYSICAL_TABLE_TCAM);
