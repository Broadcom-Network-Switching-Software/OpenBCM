...
static shr_error_e
j2x_a0_dnx_data_device_general_production_ready_set(
    int unit)
{
    ...
    int unit)
{
    ...
    feature->property.doc = 
        "\n"
        "Stop on error (1) or not (0) during SDK access init.\n"
        "Can be 0,1\n"
        "Default: 1 - Stop on error during SDK access init.\n"
        "\n"
    ;
    feature->property.method = dnxc_data_property_method_suffix_enable;
    feature->property.method_str = "suffix_enable";
    ...
    int unit)
{
    ...
    feature->set = j2x_a0_dnx_data_device_general_production_ready_set;
