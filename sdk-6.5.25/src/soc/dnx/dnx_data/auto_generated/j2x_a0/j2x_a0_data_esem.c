...
static shr_error_e
j2x_a0_dnx_data_esem_access_cmd_app_di_id_size_in_bits_set(
    int unit)
{
...
static shr_error_e
j2x_a0_dnx_data_esem_feature_etps_properties_assignment_set(
    int unit)
{
...
static shr_error_e
j2x_a0_dnx_data_esem_feature_key_with_sspa_contains_member_id_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_esem;
    ...
    int unit)
{
    ...
    define->set = j2x_a0_dnx_data_esem_access_cmd_app_di_id_size_in_bits_set;
    ...
    feature->set = j2x_a0_dnx_data_esem_feature_etps_properties_assignment_set;
    data_index = dnx_data_esem_feature_key_with_sspa_contains_member_id;
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_esem_feature_key_with_sspa_contains_member_id_set;
