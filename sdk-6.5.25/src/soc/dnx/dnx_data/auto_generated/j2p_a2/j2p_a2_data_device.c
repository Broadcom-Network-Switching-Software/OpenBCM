...
static shr_error_e
j2p_a2_dnx_data_device_general_production_ready_set(
    int unit)
{
...
static shr_error_e
j2p_a2_dnx_data_device_general_device_id_set(
    int unit)
{
    ...
    int unit)
{
    ...
    define->set = j2p_a2_dnx_data_device_general_device_id_set;

    
    data_index = dnx_data_device_general_production_ready;
    feature = &submodule->features[data_index];
    feature->set = j2p_a2_dnx_data_device_general_production_ready_set;
