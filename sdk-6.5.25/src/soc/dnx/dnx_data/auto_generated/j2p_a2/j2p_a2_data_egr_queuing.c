...
shr_error_e
j2p_a2_data_egr_queuing_attach(
    int unit)
{
    ...
    data_index = dnx_data_egr_queuing_params_wfq_mode;
    feature = &submodule->features[data_index];
    feature->set = j2p_a2_dnx_data_egr_queuing_params_wfq_mode_set;
