    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->doc = "Definitions related to load balancing simulator.";
    ...
    submodule_data->defines[dnx_data_switch_load_balancing_sim_define_device_enum].doc = "The device ID according to cint_load_balancing_sim_device_type_e";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_switch_svtag_egress_svtag_enable_by_context].doc = "indicates that the egress svtag is enabled via specific MACSEC context";
