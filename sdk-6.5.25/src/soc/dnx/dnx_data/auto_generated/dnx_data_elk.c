    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_elk_general_is_egw_support_rr].labels[0] = "j2x_notrev";
    ...
    submodule_data->features[dnx_data_elk_general_is_kbp_traffic_supported].labels[0] = "j2x_notrev";
    ...
    submodule_data->features[dnx_data_elk_general_is_kbp_supported].doc = "Indicate if kbp is supported";
    submodule_data->features[dnx_data_elk_general_is_kbp_supported].labels[0] = "j2x_notrev";
    ...
    submodule_data->features[dnx_data_elk_general_elk_nif_if_type_sel].doc = "Indicate egw support NIf Interface type selector";
    submodule_data->features[dnx_data_elk_general_elk_nif_if_type_sel].labels[0] = "j2x_notrev";
    ...
    submodule_data->features[dnx_data_elk_general_back_pressure_bit_exists].doc = "Indicates if EGW has back pressure bit";
    ...
    submodule_data->defines[dnx_data_elk_general_define_max_ports].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_elk_general_define_rop_fifo_depth].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_elk_general_define_flp_full_treshold].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_elk_general_define_max_lane_id].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_elk_general_define_egw_max_opcode].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_elk_general_define_max_kbp_instance].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_elk_general_define_lookup_timeout_delay].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_elk_general_define_trans_timer_delay].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_elk_general_define_device_type].labels[0] = "j2x_notrev";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_elk_application_ipv4].labels[0] = "j2x_notrev";
    ...
    submodule_data->features[dnx_data_elk_application_ipv6].labels[0] = "j2x_notrev";
    ...
    submodule_data->features[dnx_data_elk_application_nat].labels[0] = "j2x_notrev";
    ...
    submodule_data->features[dnx_data_elk_application_sllb].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_elk_application_define_large_mc_mode1].doc = "ipv4/ipv6 large multicast mode 1";
    submodule_data->defines[dnx_data_elk_application_define_large_mc_mode1].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_elk_application_define_large_mc_mode2].doc = "ipv4/ipv6 large multicast mode 2";
    submodule_data->defines[dnx_data_elk_application_define_large_mc_mode2].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_elk_application_define_large_mc_mode3].doc = "ipv4/ipv6 large multicast mode 3";
    submodule_data->defines[dnx_data_elk_application_define_large_mc_mode3].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_elk_application_define_optimized_result].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_elk_application_define_split_rpf].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_elk_application_define_thread_safety].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_elk_application_define_ipv4_large_mc_enable].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_elk_application_define_ipv6_large_mc_enable].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_elk_application_define_ipv4_mc_hash_table_size].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_elk_application_define_ipv6_mc_hash_table_size].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_elk_application_define_ipv4_mc_table_size].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_elk_application_define_ipv6_mc_table_size].labels[0] = "j2x_notrev";
    ...
    submodule_data->tables[dnx_data_elk_application_table_db_property].labels[0] = "j2x_notrev";
    ...
    submodule_data->tables[dnx_data_elk_application_table_db_property].nof_values = 7;
    ...
    submodule_data->tables[dnx_data_elk_application_table_db_property].values[2].doc = "Indication that large optimized result is used";
    ...
    submodule_data->tables[dnx_data_elk_application_table_db_property].values[3].doc = "Property value for extra large DB";
    ...
    submodule_data->tables[dnx_data_elk_application_table_db_property].values[4].doc = "Property value for DB locality";
    ...
    submodule_data->tables[dnx_data_elk_application_table_db_property].values[5].doc = "Indication if zero_size_ad needs to be initialized (OP2 suppot only)";
    ...
    submodule_data->tables[dnx_data_elk_application_table_db_property].values[6].name = "dbal_none_direct_optimized";
    submodule_data->tables[dnx_data_elk_application_table_db_property].values[6].type = "int";
    submodule_data->tables[dnx_data_elk_application_table_db_property].values[6].doc = "Indicates if the DBAL NONE_DIRECT_OPTIMIZED indication should be set to the table for improving the insertion rate";
    submodule_data->tables[dnx_data_elk_application_table_db_property].values[6].offset = UTILEX_OFFSETOF(dnx_data_elk_application_db_property_t, dbal_none_direct_optimized);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_elk_connectivity_define_connect_mode].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_elk_connectivity_define_blackhole].labels[0] = "j2x_notrev";
    ...
    submodule_data->tables[dnx_data_elk_connectivity_table_mdio].labels[0] = "j2x_notrev";
    ...
    submodule_data->tables[dnx_data_elk_connectivity_table_ilkn_reverse].labels[0] = "j2x_notrev";
    ...
    submodule_data->tables[dnx_data_elk_connectivity_table_topology].labels[0] = "j2x_notrev";
    ...
    submodule_data->tables[dnx_data_elk_connectivity_table_kbp_serdes_tx_taps].labels[0] = "j2x_notrev";
    ...
    submodule_data->tables[dnx_data_elk_connectivity_table_kbp_lane_serdes_tx_taps].labels[0] = "j2x_notrev";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_elk_recovery_define_enable].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_elk_recovery_define_iteration].labels[0] = "j2x_notrev";
