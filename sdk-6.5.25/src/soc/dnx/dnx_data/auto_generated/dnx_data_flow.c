    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->doc = "SRV6 tunnel data";
    ...
    submodule_data->features[dnx_data_flow_srv6_use_flow_lif_init].name = "use_flow_lif_init";
    submodule_data->features[dnx_data_flow_srv6_use_flow_lif_init].doc = "Use flow lif to configure init tunnels";
    submodule_data->features[dnx_data_flow_srv6_use_flow_lif_init].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_flow_srv6_use_flow_lif_term].name = "use_flow_lif_term";
    submodule_data->features[dnx_data_flow_srv6_use_flow_lif_term].doc = "Use flow lif to configure term tunnels";
    submodule_data->features[dnx_data_flow_srv6_use_flow_lif_term].flags |= DNXC_DATA_F_FEATURE;
