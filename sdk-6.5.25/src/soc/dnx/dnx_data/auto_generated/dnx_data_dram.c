    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_dram_hbm_channel_wds_inflight_threshold].doc = "A threshold needs to be set upon the Write Data Storage memory in order to prevent WDS overflow";
    ...
    submodule_data->features[dnx_data_dram_hbm_is_freeze_boot_supported].doc = "Loading the device in freezing temperature is supported, and the DRAM initialization can be skipped in freezing temperature.";
    ...
    submodule_data->features[dnx_data_dram_hbm_hbm2e_support].doc = "Indicates support for the HBM2E standard";
    ...
    submodule_data->features[dnx_data_dram_hbm_is_coherency_enforcer_supported].doc = "Support for read-write ordering enforcement";
    ...
    submodule_data->defines[dnx_data_dram_hbm_define_driver_strength].doc = "nominal driver strength";
    ...
    submodule_data->defines[dnx_data_dram_hbm_define_t_rdlat_offset].doc = "PHY FIFO read latency param";
    ...
    submodule_data->defines[dnx_data_dram_hbm_define_nof_channel_dwords].doc = "Number of DWORDs in a channel";
    ...
    submodule_data->defines[dnx_data_dram_hbm_define_wds_size].doc = "Size of the Write Data Storage memory";
    ...
    submodule_data->tables[dnx_data_dram_hbm_table_bist].values[1].doc = "Number of commands to the same row (for each bank)";
    ...
    submodule_data->tables[dnx_data_dram_hbm_table_hbc_sbus_chain].doc = "The order of FSRDs in the SBUS chain";
    ...
    submodule_data->tables[dnx_data_dram_hbm_table_hbc_sbus_chain].keys[0].doc = "hbc channel";
    ...
    submodule_data->tables[dnx_data_dram_hbm_table_hbc_sbus_chain].values[0].doc = "The index of SBUS chain";
    ...
    submodule_data->tables[dnx_data_dram_hbm_table_dll_and_qc_conf_vals_per_freq_range].doc = "Table to match DLL and QC Delay configuration values to frequency range. See HBM2e PHY spec for details";
    ...
    submodule_data->tables[dnx_data_dram_hbm_table_dll_and_qc_conf_vals_per_freq_range].keys[0].doc = "index";
    ...
    submodule_data->tables[dnx_data_dram_hbm_table_dll_and_qc_conf_vals_per_freq_range].values[0].doc = "The upper limit where a range ends (2 * freq)";
    ...
    submodule_data->tables[dnx_data_dram_hbm_table_dll_and_qc_conf_vals_per_freq_range].values[1].doc = "The value to write to the SBUS DLL_CONFIG_CLK register";
    ...
    submodule_data->tables[dnx_data_dram_hbm_table_dll_and_qc_conf_vals_per_freq_range].values[2].doc = "The value for PHY write to param CONFIG_QC_CK_DELAY";
    ...
    submodule_data->tables[dnx_data_dram_hbm_table_dll_and_qc_conf_vals_per_freq_range].values[3].doc = "The value for PHY write to param CONFIG_QC_WR_DELAY";
    ...
    submodule_data->tables[dnx_data_dram_hbm_table_dll_and_qc_conf_vals_per_freq_range].values[4].doc = "The value for PHY param CONFIG_QC_RD_DELAY";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_dram_gddr6_enable_temp_read_samsung].doc = "Enable temperature read from external Samsung DRAM";
    ...
    submodule_data->features[dnx_data_dram_gddr6_enable_temp_read_micron].doc = "Enable temperature read from external Micron DRAM";
    ...
    submodule_data->defines[dnx_data_dram_gddr6_define_ck_termination].name = "ck_termination";
    submodule_data->defines[dnx_data_dram_gddr6_define_ck_termination].doc = "Determines CK line termination. See GDDR JEDEC for details";
    
    submodule_data->defines[dnx_data_dram_gddr6_define_ck_termination].flags |= DNXC_DATA_F_NUMERIC;

    submodule_data->defines[dnx_data_dram_gddr6_define_wck_granularity].name = "wck_granularity";
    submodule_data->defines[dnx_data_dram_gddr6_define_wck_granularity].doc = "Data bandwidth for each WCK (byte or 2 bytes), see GDDR JEDEC for details";
    ...
    submodule_data->defines[dnx_data_dram_gddr6_define_ref_clk_bitmap].doc = "Indicates which DRAM is master in relation to reference clock (that is, which PHY interface is connected to reference clock)";
...
uint32
dnx_data_dram_gddr6_ck_termination_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_dram, dnx_data_dram_submodule_gddr6, dnx_data_dram_gddr6_define_ck_termination);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_dram_general_info_define_write_latency_hbm2e].doc = "write latency for HBM2E DRAM";
    ...
    submodule_data->defines[dnx_data_dram_general_info_define_read_latency_hbm2e].doc = "read latency for HBM2E DRAM";
    ...
    submodule_data->defines[dnx_data_dram_general_info_define_read_data_enable_delay].doc = "read data enable delay";
    ...
    submodule_data->defines[dnx_data_dram_general_info_define_supported_dram_bitmap].doc = "bitmap indicating which dram indexes are supported for the device";
    ...
    submodule_data->defines[dnx_data_dram_general_info_define_dram_bitmap_internal].doc = "bitmap of currently available drams";
    ...
    submodule_data->tables[dnx_data_dram_general_info_table_timing_params].values[10].doc = "tras timing parameter for HBM2E DRAM";
    ...
    submodule_data->tables[dnx_data_dram_general_info_table_timing_params].values[11].doc = "trc timing parameter";
    ...
    submodule_data->tables[dnx_data_dram_general_info_table_timing_params].values[12].doc = "twtrl timing parameter";
    ...
    submodule_data->tables[dnx_data_dram_general_info_table_timing_params].values[13].doc = "twtrs timing parameter";
    ...
    submodule_data->tables[dnx_data_dram_general_info_table_timing_params].values[14].doc = "trtw timing parameter";
    ...
    submodule_data->tables[dnx_data_dram_general_info_table_timing_params].values[15].doc = "tccdr timing parameter";
    ...
    submodule_data->tables[dnx_data_dram_general_info_table_timing_params].values[16].doc = "tccds timing parameter";
    ...
    submodule_data->tables[dnx_data_dram_general_info_table_timing_params].values[17].doc = "tccdl timing parameter";
    ...
    submodule_data->tables[dnx_data_dram_general_info_table_timing_params].values[18].doc = "trrefd timing parameter";
    ...
    submodule_data->tables[dnx_data_dram_general_info_table_timing_params].values[19].doc = "trfcsb timing parameter";
    ...
    submodule_data->tables[dnx_data_dram_general_info_table_timing_params].values[20].doc = "trfc timing parameter";
    ...
    submodule_data->tables[dnx_data_dram_general_info_table_timing_params].values[21].doc = "tmrd timing parameter";
    ...
    submodule_data->tables[dnx_data_dram_general_info_table_timing_params].values[22].doc = "tmod timing parameter";
    ...
    submodule_data->tables[dnx_data_dram_general_info_table_timing_params].values[23].doc = "twtrtr timing parameter";
    ...
    submodule_data->tables[dnx_data_dram_general_info_table_timing_params].values[24].doc = "twrwtr timing parameter";
    ...
    submodule_data->tables[dnx_data_dram_general_info_table_timing_params].values[25].doc = "treftr timing parameter";
    ...
    submodule_data->tables[dnx_data_dram_general_info_table_timing_params].values[26].doc = "trdtlt timing parameter";
    ...
    submodule_data->tables[dnx_data_dram_general_info_table_timing_params].values[27].doc = "trcdwtr timing parameter";
    ...
    submodule_data->tables[dnx_data_dram_general_info_table_timing_params].values[28].doc = "trcdrtr timing parameter";
    ...
    submodule_data->tables[dnx_data_dram_general_info_table_timing_params].values[29].doc = "trcdltr timing parameter";
    ...
    submodule_data->tables[dnx_data_dram_general_info_table_timing_params].values[30].doc = "tltrtr timing parameter";
    ...
    submodule_data->tables[dnx_data_dram_general_info_table_timing_params].values[31].doc = "tltltr timing parameter";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_dram_address_translation_define_max_tdu_index].doc = "Maximum TDU index";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_dram_dram_block_table_gddr6_average_read_inflights_leaky_bucket_config_params].name = "gddr6_average_read_inflights_leaky_bucket_config_params";
    submodule_data->tables[dnx_data_dram_dram_block_table_gddr6_average_read_inflights_leaky_bucket_config_params].doc = "Configuration params for the inflight average read inflights DRAM block setting";
    submodule_data->tables[dnx_data_dram_dram_block_table_gddr6_average_read_inflights_leaky_bucket_config_params].flags |= DNXC_DATA_F_TABLE;
    submodule_data->tables[dnx_data_dram_dram_block_table_gddr6_average_read_inflights_leaky_bucket_config_params].size_of_values = sizeof(dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_t);
    submodule_data->tables[dnx_data_dram_dram_block_table_gddr6_average_read_inflights_leaky_bucket_config_params].entry_get = dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_entry_str_get;

    
    submodule_data->tables[dnx_data_dram_dram_block_table_gddr6_average_read_inflights_leaky_bucket_config_params].nof_keys = 1;
    submodule_data->tables[dnx_data_dram_dram_block_table_gddr6_average_read_inflights_leaky_bucket_config_params].keys[0].name = "index";
    submodule_data->tables[dnx_data_dram_dram_block_table_gddr6_average_read_inflights_leaky_bucket_config_params].keys[0].doc = "param index";

    
    submodule_data->tables[dnx_data_dram_dram_block_table_gddr6_average_read_inflights_leaky_bucket_config_params].nof_values = 2;
    DNXC_DATA_ALLOC(submodule_data->tables[dnx_data_dram_dram_block_table_gddr6_average_read_inflights_leaky_bucket_config_params].values, dnxc_data_value_t, submodule_data->tables[dnx_data_dram_dram_block_table_gddr6_average_read_inflights_leaky_bucket_config_params].nof_values, "_dnx_data_dram_dram_block_table_gddr6_average_read_inflights_leaky_bucket_config_params table values");
    submodule_data->tables[dnx_data_dram_dram_block_table_gddr6_average_read_inflights_leaky_bucket_config_params].values[0].name = "dbal_field_id";
    submodule_data->tables[dnx_data_dram_dram_block_table_gddr6_average_read_inflights_leaky_bucket_config_params].values[0].type = "uint32";
    submodule_data->tables[dnx_data_dram_dram_block_table_gddr6_average_read_inflights_leaky_bucket_config_params].values[0].doc = "field ID for field in table DBAL_TABLE_GDDR6_TDU_DRAM_BLOCK_AVERAGE_READ_INFLIGHTS_LEAKY_BUCKET_CONFIG";
    submodule_data->tables[dnx_data_dram_dram_block_table_gddr6_average_read_inflights_leaky_bucket_config_params].values[0].offset = UTILEX_OFFSETOF(dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_t, dbal_field_id);
    submodule_data->tables[dnx_data_dram_dram_block_table_gddr6_average_read_inflights_leaky_bucket_config_params].values[1].name = "field_val";
    submodule_data->tables[dnx_data_dram_dram_block_table_gddr6_average_read_inflights_leaky_bucket_config_params].values[1].type = "uint32";
    submodule_data->tables[dnx_data_dram_dram_block_table_gddr6_average_read_inflights_leaky_bucket_config_params].values[1].doc = "value to write to dbal field";
    submodule_data->tables[dnx_data_dram_dram_block_table_gddr6_average_read_inflights_leaky_bucket_config_params].values[1].offset = UTILEX_OFFSETOF(dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_t, field_val);
...
const dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_t *
dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_get(
    int unit,
    int index)
{
    char *data;
    ...
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_dram, dnx_data_dram_submodule_dram_block, dnx_data_dram_dram_block_table_gddr6_average_read_inflights_leaky_bucket_config_params);
    
    data = dnxc_data_mgmt_table_data_get(unit, table, index, 0);
    return (const dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_t *) data;
...
shr_error_e
dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
{
    dnxc_data_table_t *table;
    const dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_t *data;
    SHR_FUNC_INIT_VARS(unit);

    
    table = dnxc_data_mgmt_table_get(unit, dnx_data_module_dram, dnx_data_dram_submodule_dram_block, dnx_data_dram_dram_block_table_gddr6_average_read_inflights_leaky_bucket_config_params);
    data = (const dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_t *) dnxc_data_mgmt_table_data_diag_get(unit, table, key0, 0);
    switch (value_index)
    {
        case 0:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->dbal_field_id);
            break;
        case 1:
...
const dnxc_data_table_info_t *
dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_info_get(
    int unit)
{

    
    return dnxc_data_mgmt_table_info_get(unit, dnx_data_module_dram, dnx_data_dram_submodule_dram_block, dnx_data_dram_dram_block_table_gddr6_average_read_inflights_leaky_bucket_config_params);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_dram_dbal_define_hbm_write_latency_nof_bits].doc = "Number of bits in HBM_WRITE_LATENCY field";
    ...
    submodule_data->defines[dnx_data_dram_dbal_define_hbm_output_enable_delay_nof_bits].doc = "Number of bits in OUTPUT_ENABLE_DELAY field";
    ...
    submodule_data->defines[dnx_data_dram_dbal_define_hbm_rd_data_en_delay_nof_bits].doc = "Number of bits in RD_DATA_EN_DELAY field";
    ...
    submodule_data->defines[dnx_data_dram_dbal_define_hbm_c_u_nof_bits].doc = "Number of bits in C_UI_0/1 field";
    ...
    submodule_data->defines[dnx_data_dram_dbal_define_hbm_r_u_nof_bits].doc = "Number of bits in R_UI_0/1 field";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_dram_firmware_table_rom].keys[0].doc = "HBM generation (for example: HBM, HBM2E)";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_dram_apd_phy_table_pll].values[2].doc = "Enable channels and internal dividers";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->doc = "parameters for dram ctests";
    ...
    submodule_data->tables[dnx_data_dram_ctests_table_rate].doc = "parameters for rate ctest";
    ...
    submodule_data->tables[dnx_data_dram_ctests_table_rate].values[0].doc = "Type of ports in the snake";
    ...
    submodule_data->tables[dnx_data_dram_ctests_table_rate].values[1].doc = "Number of NIF lanes in the snake";
    ...
    submodule_data->tables[dnx_data_dram_ctests_table_rate].values[2].doc = "Expected measured rate in mbps";
    ...
    submodule_data->tables[dnx_data_dram_ctests_table_rate].values[3].doc = "Expected DRAM measured rate in mbps";
