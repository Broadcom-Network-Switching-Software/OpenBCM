    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_pll_general_ts_phase_initial_hi_config].name = "ts_phase_initial_hi_config";
    submodule_data->features[dnx_data_pll_general_ts_phase_initial_hi_config].doc = "Indication if configuring initial phase values high 32 is supported";
    submodule_data->features[dnx_data_pll_general_ts_phase_initial_hi_config].flags |= DNXC_DATA_F_FEATURE;

    submodule_data->features[dnx_data_pll_general_ts_refclk_source_internal].name = "ts_refclk_source_internal";
    submodule_data->features[dnx_data_pll_general_ts_refclk_source_internal].doc = "Internal or external (1 for internal) reference clock for TS PLL1";
    ...
    submodule_data->defines[dnx_data_pll_general_define_ts_nof_bits_hi].name = "ts_nof_bits_hi";
    submodule_data->defines[dnx_data_pll_general_define_ts_nof_bits_hi].doc = "Number of high bits for presenting phase values";
    
    submodule_data->defines[dnx_data_pll_general_define_ts_nof_bits_hi].flags |= DNXC_DATA_F_NUMERIC;

    submodule_data->defines[dnx_data_pll_general_define_ts_nof_bits_right_shift_ns].name = "ts_nof_bits_right_shift_ns";
    submodule_data->defines[dnx_data_pll_general_define_ts_nof_bits_right_shift_ns].doc = "Number of bits to right shift to get nanoseconds.";
    
    submodule_data->defines[dnx_data_pll_general_define_ts_nof_bits_right_shift_ns].flags |= DNXC_DATA_F_NUMERIC;

    submodule_data->defines[dnx_data_pll_general_define_ts_ptp_fref].name = "ts_ptp_fref";
    submodule_data->defines[dnx_data_pll_general_define_ts_ptp_fref].doc = "PTP Timestamping PLL value for fref parameter";
...
uint32
dnx_data_pll_general_ts_nof_bits_hi_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_pll, dnx_data_pll_submodule_general, dnx_data_pll_general_define_ts_nof_bits_hi);
}

uint32
dnx_data_pll_general_ts_nof_bits_right_shift_ns_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_pll, dnx_data_pll_submodule_general, dnx_data_pll_general_define_ts_nof_bits_right_shift_ns);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_pll_pll4_pll_in_frac_mode].doc = "Indication that some of the PLL need to be configured in fractional mode.";
    ...
    submodule_data->defines[dnx_data_pll_pll4_define_nif_tsc_pll4_id].doc = "Index of the NIF TSC PLL4, used for DBAL access";
    ...
    submodule_data->defines[dnx_data_pll_pll4_define_framer_pll4_id].doc = "Index of the Framer PLL4, used for DBAL access";
    ...
    submodule_data->defines[dnx_data_pll_pll4_define_sar_pll4_id].doc = "Index of the SAR PLL4, used for DBAL access";
    ...
    submodule_data->tables[dnx_data_pll_pll4_table_config].values[8].doc = "Enable Np and Nq dividers in fraction mode";
    ...
    submodule_data->tables[dnx_data_pll_pll4_table_config].values[9].doc = "Np divider of PLL4";
    ...
    submodule_data->tables[dnx_data_pll_pll4_table_config].values[10].doc = "Nq divider of PLL4";
    ...
    submodule_data->tables[dnx_data_pll_pll4_table_config].values[11].doc = "N divider of PLL4";
    ...
    submodule_data->tables[dnx_data_pll_pll4_table_config].values[12].doc = "Enable differential reference clock to CMOS";
    ...
    submodule_data->tables[dnx_data_pll_pll4_table_config].values[13].doc = "M-divider for channel 0 of PLL4";
    ...
    submodule_data->tables[dnx_data_pll_pll4_table_config].values[14].doc = "M-divider for channel 1 of PLL4";
    ...
    submodule_data->tables[dnx_data_pll_pll4_table_config].values[15].doc = "M-divider for channel 2 of PLL4";
    ...
    submodule_data->tables[dnx_data_pll_pll4_table_config].values[16].doc = "M-divider for channel 3 of PLL4";
    ...
    submodule_data->tables[dnx_data_pll_pll4_table_config].values[17].doc = "M-divider for channel 6 of PLL4";
