    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_meter_profile_define_large_bucket_mode_exp_add].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_meter_profile_define_max_regular_bucket_mode_burst].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_meter_profile_define_rev_exp_min].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_meter_profile_define_rev_exp_max].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_meter_profile_define_burst_size_min].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_meter_profile_define_nof_valid_global_meters].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_meter_profile_define_nof_dp_command_max].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_meter_profile_define_global_engine_hw_stat_database_id].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_meter_profile_define_ir_mant_nof_bits].labels[0] = "j2x_notrev";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_meter_diag_rate_measurements_support].labels[0] = "j2x_notrev";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_meter_meter_db_refresh_disable_required].labels[0] = "j2x_notrev";
    ...
    submodule_data->features[dnx_data_meter_meter_db_tcsm_support].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_meter_meter_db_define_nof_ingress_db].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_meter_meter_db_define_nof_egress_db].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_meter_meter_db_define_meter_ids_in_group].labels[0] = "j2x_notrev";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_meter_mem_mgmt_define_adrress_range_resolution].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_meter_mem_mgmt_define_object_stat_pointer_base_resolution].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_meter_mem_mgmt_define_base_big_engine_for_meter].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_meter_mem_mgmt_define_ingress_single_bucket_engine].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_meter_mem_mgmt_define_egress_single_bucket_engine].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_meter_mem_mgmt_define_meter_pointer_size].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_meter_mem_mgmt_define_meter_pointer_map_size].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_meter_mem_mgmt_define_invalid_bank_id].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_meter_mem_mgmt_define_ptr_map_table_resolution].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_meter_mem_mgmt_define_bank_id_size].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_meter_mem_mgmt_define_nof_bank_ids].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_meter_mem_mgmt_define_sections_offset].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_meter_mem_mgmt_define_nof_single_buckets_per_entry].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_meter_mem_mgmt_define_nof_dual_buckets_per_entry].labels[0] = "j2x_notrev";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_meter_compensation_table_ingress_port_delta_value].labels[0] = "j2x_notrev";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_meter_expansion_expansion_based_on_tc_support].labels[0] = "j2x_notrev";
    ...
    submodule_data->features[dnx_data_meter_expansion_expansion_for_uuc_umc_support].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_meter_expansion_define_max_size].labels[0] = "j2x_notrev";
