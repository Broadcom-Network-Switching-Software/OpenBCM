    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->doc = "COSQ AQM general definitions";
    ...
    submodule_data->features[dnx_data_cosq_aqm_general_is_aqm_supported].doc = "is AQM supported";
    ...
    submodule_data->defines[dnx_data_cosq_aqm_general_define_profile_nof].doc = "Number of AQM profiles";
    ...
    submodule_data->defines[dnx_data_cosq_aqm_general_define_flows_nof].doc = "Number AQM flow IDs";
    ...
    submodule_data->defines[dnx_data_cosq_aqm_general_define_reserved_flows_nof].doc = "Amount of AQM flow ids reserved for more than a single OTM+TC to a global voq aggregation";
