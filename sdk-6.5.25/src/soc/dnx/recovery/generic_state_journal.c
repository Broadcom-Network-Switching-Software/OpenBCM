    ...
    dbal_tables_e table_id)
{
    ...
    SHR_IF_ERR_EXIT(dnx_generic_state_journal_entry_new(unit,
                                                        ...
                                                        (uint8 *) (&entry),
                                                        sizeof(dnx_generic_state_journal_dbal_table_entry_t),
                                                        &dnx_generic_state_journal_rollback_dbal_table_create, FALSE));
    ...
    uint8 is_comparison)
{
    ...
    if (is_comparison)
    {
        SHR_IF_ERR_EXIT(dnx_rollback_journal_clear
                        (unit, er_thread_id, only_head_clear, DNX_GENERIC_STATE_COMPARISON_JOURNAL_HANDLE));
    }
    else
    {
        SHR_IF_ERR_EXIT(dnx_rollback_journal_clear
    ...
    uint8 is_comparison)
{
    ...
    SHR_IF_ERR_EXIT(dnx_generic_state_journal_clear_internal(unit, er_thread_id, only_head_clear, is_comparison));
