  ...
  )
{
 ...
 soc_reg_t
  ...
  if (SOC_IS_JERICHO(unit))  {
    ...
    fld_val = soc_property_get(unit, spn_MPLS_LSP_DESTINATION_DISABLE, 0);
    SOC_SAND_SOC_IF_ERROR_RETURN_ERR_VAL(res,  241,  exit, ARAD_REG_ACCESS_ERR,soc_reg_above_64_field32_modify(unit, IHP_VTT_GENERAL_CONFIGS_0r, REG_PORT_ANY, 0, DISABLE_LSP_DESTINATIONf, fld_val));
