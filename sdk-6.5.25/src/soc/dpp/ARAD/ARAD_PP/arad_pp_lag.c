    ...
    Arad_pp_lb_hash_map_table_new_lb_scheme[] =
{
  ...
  { ARAD_PP_PORT_PROFILE_DC, DPP_PFC_IPV4_IPV4_ETH,  ARAD_PP_PLC_PROFILE_OFF, ARAD_PP_LB_VECTOR_INDEX_NONE, ARAD_PP_LB_VECTOR_INDEX_NONE, ARAD_PP_LB_VECTOR_INDEX_IPV4,     ARAD_PP_LB_VECTOR_INDEX_IPV4,          ARAD_PP_LB_VECTOR_INDEX_ETHERNET},
  { ARAD_PP_PORT_PROFILE_DC, DPP_PFC_IPV4_IPV4_ETH,  ARAD_PP_PLC_PROFILE_ON,  ARAD_PP_LB_VECTOR_INDEX_NONE, ARAD_PP_LB_VECTOR_INDEX_L4,   ARAD_PP_LB_VECTOR_INDEX_IPV4,     ARAD_PP_LB_VECTOR_INDEX_IPV4,          ARAD_PP_LB_VECTOR_INDEX_ETHERNET},
...
CONST STATIC ARAD_PP_LB_HASH_FIELD_INFO Arad_pp_lag_hash_field_info []=
{
    ...
    {ARAD_PP_LB_VECTOR_INDEX_IPV6, 2, {14,15,0,0,0,0}},
    
    {ARAD_PP_LB_VECTOR_INDEX_IPV6, 1, {13,0,0,0,0,0}},
};
  ...
  )
{
  ...
  hash_info.mask |= SOC_PPC_HASH_MASKS_IPV6_LABLE_LO | SOC_PPC_HASH_MASKS_IPV6_LABLE_HI;
  ...
  )
{
  ...
  case SOC_PPC_HASH_MASKS_L4_DEST_PORT:
    ...
    case SOC_PPC_HASH_MASKS_IPV6_LABLE_HI:
    case SOC_PPC_HASH_MASKS_IPV6_LABLE_LO:
    default:
        return field;
    }
