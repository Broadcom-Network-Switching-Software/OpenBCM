...
#define ARAD_PP_ISEM_ACCESS_KEY_GPON_VD_TUNNEL_VID_VID_TUNNEL_MSB                    (ARAD_PP_ISEM_ACCESS_KEY_GPON_VD_TUNNEL_VID_VID_TUNNEL_LSB + 11)
...
#define ARAD_PP_ISEM_ACCESS_KEY_GPON_VD_TUNNEL_VID_VID_INNER_VID_LSB                 (ARAD_PP_ISEM_ACCESS_KEY_GPON_VD_TUNNEL_VID_VID_OUTER_VID_LSB + ARAD_PP_ISEM_ACCESS_KEY_GPON_VD_TUNNEL_VID_VID_OUTER_VID_NOF_BITS)
#define ARAD_PP_ISEM_ACCESS_KEY_GPON_VD_TUNNEL_VID_VID_INNER_VID_MSB                 (ARAD_PP_ISEM_ACCESS_KEY_GPON_VD_TUNNEL_VID_VID_INNER_VID_LSB + 11)
#define ARAD_PP_ISEM_ACCESS_KEY_GPON_VD_TUNNEL_VID_VID_INNER_VID_NOF_BITS            (ARAD_PP_ISEM_ACCESS_KEY_GPON_VD_TUNNEL_VID_VID_INNER_VID_MSB - ARAD_PP_ISEM_ACCESS_KEY_GPON_VD_TUNNEL_VID_VID_INNER_VID_LSB + 1)
  ...
  )
{
    ...
    res = sw_state_access[unit].dpp.soc.arad.pp.vtt.tt_programs.get(unit, PROG_TT_MC_PPPOE_PROG, &prog_used);
    SOC_SAND_CHECK_FUNC_RESULT(res, PROG_TT_MC_PPPOE_PROG, exit);
    if (prog_used != -1)
    {
        SET_TT_PROGRAM_SELECTION(prog_indx);
        tt_dbal_program_selection[ARAD_PP_DBAL_TT_PROG_SELECTION_MC_PPPOE].priority[unit]  = prog_indx;
        tt_dbal_program_selection[ARAD_PP_DBAL_TT_PROG_SELECTION_MC_PPPOE].prog_name[unit] = ARAD_PP_DBAL_TT_PROG_MC_PPPOE;
    }
    ...
    {
        SET_TT_PROGRAM_SELECTION(prog_indx);
        res = arad_pp_vtt_prog_sel_cam_key_program_2nd_tt_ip_router_compatiblemc_2nd_prog_set(unit,prog_indx,prog_used,0,1);
        SOC_SAND_CHECK_FUNC_RESULT(res, PROG_TT_BRIDGE_STAR_2ND_PROG, exit);
    }
    ...
    if (prog_used != -1)
    {
        ...
        if(SOC_IS_JERICHO(unit) && (prog_soc_prop->oam_enable || soc_property_suffix_num_get(unit, -1, spn_CUSTOM_FEATURE, "mim_spb_enable", 0))){
            SET_TT_PROGRAM_SELECTION(prog_indx);
 ...
 if (SOC_DPP_CONFIG(unit)->pp.custom_feature_vxlan_port_termination)
  ...
  if (SOC_DPP_CONFIG(unit)->extender.port_extender_init_status) {
    ...
    if (SOC_DPP_PPPOE_IS_ENABLE(unit)) {
        ...
        SET_TT_PROGRAM_ID(PROG_TT_MC_PPPOE_PROG);
        tt_dbal_programs[ARAD_PP_DBAL_TT_PROG_MC_PPPOE].prog_used[unit] = (last_tt_program_id - 1);
    }
  ...
  case ARAD_PP_ISEM_ACCESS_KEY_TYPE_VD_PCP_VID_VID:
	...
	nof_bits = (gpon_enable ? ARAD_PP_ISEM_ACCESS_KEY_GPON_VD_TUNNEL_VID_VID_OUTER_VID_NOF_BITS : ARAD_PP_ISEM_ACCESS_KEY_PON_VD_TUNNEL_VID_VID_OUTER_VID_NOF_BITS(unit));
      ...
      case ARAD_PP_ISEM_ACCESS_KEY_TYPE_PON_VD_TUNNEL_VID_VID:
        ...
        lsb = (gpon_enable ? ARAD_PP_ISEM_ACCESS_KEY_GPON_VD_TUNNEL_VID_VID_INNER_VID_LSB : ARAD_PP_ISEM_ACCESS_KEY_PON_VD_TUNNEL_VID_VID_INNER_VID_LSB(unit));
        nof_bits = (gpon_enable ? ARAD_PP_ISEM_ACCESS_KEY_GPON_VD_TUNNEL_VID_VID_INNER_VID_NOF_BITS : ARAD_PP_ISEM_ACCESS_KEY_PON_VD_TUNNEL_VID_VID_INNER_VID_NOF_BITS(unit));
        res = soc_sand_bitstream_set_any_field(&isem_key->key_info.l2_pon.inner_vid, lsb, nof_bits, buffer);
...
#define prog_soc_prop g_prog_soc_prop[unit]
  ...
  case ARAD_PP_ISEM_ACCESS_KEY_TYPE_PON_VD_TUNNEL_VID_VID:
  {
    ...
    { 
      lsb = (gpon_enable ? ARAD_PP_ISEM_ACCESS_KEY_GPON_VD_TUNNEL_VID_VID_INNER_VID_LSB : ARAD_PP_ISEM_ACCESS_KEY_PON_VD_TUNNEL_VID_VID_INNER_VID_LSB(unit));
      nof_bits = (gpon_enable ? ARAD_PP_ISEM_ACCESS_KEY_GPON_VD_TUNNEL_VID_VID_INNER_VID_NOF_BITS : ARAD_PP_ISEM_ACCESS_KEY_PON_VD_TUNNEL_VID_VID_INNER_VID_NOF_BITS(unit));
      res = soc_sand_bitstream_get_any_field(buffer, lsb, nof_bits, &isem_key->key_info.l2_pon.inner_vid); 
  ...
  )
{
    ...
    case PROG_TT_PPPOE_PROG:
        ...
        break;
    case PROG_TT_MC_PPPOE_PROG:
        prog_name = "PROG_TT_MC_PPPOE_PROG";
        break;
	case PROG_TT_L2TP:
