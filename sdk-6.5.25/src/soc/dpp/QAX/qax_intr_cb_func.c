...
void qax_interrupt_cb_init(int unit)
{
    ...
    dcmn_intr_add_handler(unit, QAX_INT_EDB_ESEM_ONE_ESEM_ERROR_TABLE_COHERENCY, 0,0,dcmn_interrupt_handle_EDB_EsemErrorTableCoherency_Int,NULL);
    dcmn_intr_add_handler(unit, QAX_INT_EDB_GLEM_ONE_GLEM_ERROR_TABLE_COHERENCY, 0,0,dcmn_interrupt_handle_EDB_GlemErrorTableCoherency_Int,NULL);
