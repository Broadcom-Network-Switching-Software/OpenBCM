    ...
    uint8 is_comparison)
{
    ...
    if(is_comparison)
    {
        ...
        distinct_rv = dnx_rollback_journal_distinct(unit, er_thread_id, DNXC_SW_STATE_COMPARISON_JOURNAL_HANDLE, &dnxc_sw_state_journal_entries_are_distinct);
    ...
    uint8 is_comparison)
{
    ...
    SHR_IF_ERR_EXIT(dnxc_sw_state_journal_roll_back_internal(unit, er_thread_id, only_head_rollback, is_comparison));
    ...
    uint8 is_comparison)
{
    ...
    if(is_comparison)
    {
        SHR_IF_ERR_EXIT(dnx_rollback_journal_clear(unit, er_thread_id, only_head_clear, DNXC_SW_STATE_COMPARISON_JOURNAL_HANDLE));
    }
    else
    {
        SHR_IF_ERR_EXIT(dnx_rollback_journal_clear(unit, er_thread_id, only_head_clear, DNXC_SW_STATE_ROLLBACK_JOURNAL_HANDLE));
    }
    ...
    uint8 is_comparison)
{
    ...
    SHR_IF_ERR_EXIT(dnxc_sw_state_journal_clear_internal(unit, er_thread_id, only_head_clear, is_comparison));
    ...
    uint8 **ptr_location)
{
    ...
    SHR_IF_ERR_EXIT(dnxc_sw_state_journal_log_free_internal(unit, er_thread_id, module_id, nof_elements, element_size, ptr_location, is_er, is_cmp));
    ...
    uint8 **ptr_location)
{
    ...
    SHR_IF_ERR_EXIT(dnxc_sw_state_journal_log_alloc_internal(unit, er_thread_id, module_id, ptr_location, is_er, is_cmp));
    ...
    uint8 *ptr)
{
    ...
    SHR_IF_ERR_EXIT(dnxc_sw_state_journal_log_memcpy_internal(unit, er_thread_id, module_id, size, ptr, is_er, is_cmp));
    ...
    SW_STATE_HASH_TABLE_KEY * const key)
{
    ...
    SHR_IF_ERR_EXIT(dnxc_sw_state_journal_log_htbl_internal(unit, er_thread_id, module_id, hash_table, key));
    ...
    sw_state_mutex_t *ptr_mtx)
{
    ...
    SHR_IF_ERR_EXIT(dnxc_sw_state_journal_mutex_create_internal(unit, er_thread_id, module_id, ptr_mtx, is_er, is_cmp));
    ...
    sw_state_mutex_t *ptr_mtx)
{
    ...
    SHR_IF_ERR_EXIT(dnxc_sw_state_journal_mutex_destroy_internal(unit, er_thread_id, module_id, ptr_mtx, is_er, is_cmp));
    ...
    uint32 usec)
{
    ...
    SHR_IF_ERR_EXIT(dnxc_sw_state_journal_mutex_take_internal(unit, er_thread_id, module_id, ptr_mtx, usec, is_er, is_cmp));
    ...
    sw_state_sem_t *ptr_sem)
{
    ...
    SHR_IF_ERR_EXIT(dnxc_sw_state_journal_sem_create_internal(unit, er_thread_id, module_id, ptr_sem, is_er, is_cmp));
    ...
    int initial_count)
{
    ...
    SHR_IF_ERR_EXIT(dnxc_sw_state_journal_sem_destroy_internal(unit, er_thread_id, module_id, ptr_sem, is_binary, initial_count ,is_er, is_cmp));
    ...
    uint32 usec)
{
    ...
    SHR_IF_ERR_EXIT(dnxc_sw_state_journal_sem_take_internal(unit, er_thread_id, module_id, ptr_sem, usec, is_er, is_cmp));
    ...
    sw_state_mutex_t *ptr_mtx)
{
    ...
    SHR_IF_ERR_EXIT(dnxc_sw_state_journal_mutex_give_internal(unit, er_thread_id, module_id, ptr_mtx, is_er, is_cmp));
    ...
    sw_state_sem_t *ptr_sem)
{
    ...
    SHR_IF_ERR_EXIT(dnxc_sw_state_journal_sem_give_internal(unit, er_thread_id, module_id, ptr_sem, is_er, is_cmp));
    ...
    uint32 *seq_id)
{
    ...
    SHR_IF_ERR_EXIT(dnxc_sw_state_journal_get_head_seq_id_internal(unit, er_thread_id, is_comparison, seq_id));
