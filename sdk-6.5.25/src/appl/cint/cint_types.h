...
typedef struct tm cint_tm_t;

#endif /* CINT_CONFIG_INCLUDE_POSIX_TIMER == 1 */
...
#define CINT_PARAM_IS_VP(flags) (flags & CINT_PARAM_VP)
#define CINT_PARAM_IS_VL(flags) (flags & CINT_PARAM_VL)
...
#include <src/appl/cint/cint_wrappers.h>
