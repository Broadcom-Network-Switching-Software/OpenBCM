...
CINT_FWRAPPER_CREATE_RP5(int, int, 0, 0,
                         ...
                         int, int, port, 0, 0,
                         uint32, uint32, queue_num, 0, 0,
                         cprimod_cpri_roe_frame_format_t, cprimod_cpri_roe_frame_format_t, frame_format, 0, 0,
...
CINT_FWRAPPER_CREATE_RP6(int, int, 0, 0,
                         ...
                         uint32, uint32, priority, 0, 0,
                         uint32*, uint32, queue_num, 1, 0,
                         cprimod_control_msg_proc_type_t*, cprimod_control_msg_proc_type_t, proc_type, 1, 0);
...
CINT_FWRAPPER_CREATE_RP4(int, int, 0, 0,
                         ...
                         int, int, port, 0, 0,
                         uint32, uint32, group_id, 0, 0,
                         cprimod_rsvd4_control_group_entry_t*, cprimod_rsvd4_control_group_entry_t, group_config, 1, 0);
...
CINT_FWRAPPER_CREATE_RP3(int, int, 0, 0,
                         ...
                         int, int, unit, 0, 0,
                         int, int, port, 0, 0,
                         cprimod_cpri_crc_option_t*, cprimod_cpri_crc_option_t, crc_option, 1, 0);
...
{
    CINT_FWRAPPER_ENTRY(cprimod_init),
    CINT_FWRAPPER_ENTRY(cprimod_deinit),
    CINT_FWRAPPER_ENTRY(cprimod_mutex_take),
    CINT_FWRAPPER_ENTRY(cprimod_mutex_give),
    ...
    CINT_FWRAPPER_ENTRY(cprimod_tx_framer_tgen_enable_get),
    CINT_FWRAPPER_ENTRY(cprimod_tx_framer_tgen_enable_set),
    ...
    CINT_FWRAPPER_ENTRY(cprimod_header_compare_entry_for_flow_get),
    ...
    CINT_FWRAPPER_ENTRY(cprimod_rx_tag_config_get),
    ...
    CINT_FWRAPPER_ENTRY(cprimod_rsvd4_tx_control_flow_group_member_get),
    CINT_FWRAPPER_ENTRY(cprimod_rsvd4_tx_control_flow_group_member_get_all),
    ...
    CINT_FWRAPPER_ENTRY(cprimod_rsvd4_tx_single_tunnel_message_config_get),
    ...
    CINT_FWRAPPER_ENTRY(cprimod_rsvd4_fast_eth_config_get),
    ...
    CINT_FWRAPPER_ENTRY(cprimod_cpri_port_clock_disable_set),
    ...
    CINT_FWRAPPER_ENTRY(cprimod_cpri_port_lane_map_get),
    { NULL }
};
...
static cint_constants_t __cint_constants[] =
{
    ...
    { "CPRIMOD_RX_CONFIG_8B10B_ALLOW_SEED_CHANGE", CPRIMOD_RX_CONFIG_8B10B_ALLOW_SEED_CHANGE },
    { "CPRIMOD_RX_CONFIG_8B10B_DESCRAMBLER_HW_CONTROL", CPRIMOD_RX_CONFIG_8B10B_DESCRAMBLER_HW_CONTROL },
    { "CPRIMOD_RX_CONFIG_8B10B_DESCRAMBLER_EN", CPRIMOD_RX_CONFIG_8B10B_DESCRAMBLER_EN },
    { "CPRIMOD_RX_CONFIG_LINK_ACQ_SW_MODE", CPRIMOD_RX_CONFIG_LINK_ACQ_SW_MODE },
    { "CPRIMOD_RX_CONFIG_64B66B_LOS_OPTION", CPRIMOD_RX_CONFIG_64B66B_LOS_OPTION },
    { "CPRIMOD_RX_CONFIG_8B10B_FORCE_COMMA_ALIGN_EN", CPRIMOD_RX_CONFIG_8B10B_FORCE_COMMA_ALIGN_EN },
    { "CPRIMOD_RX_CONFIG_64B66B_BER_WINDOW_LIMIT", CPRIMOD_RX_CONFIG_64B66B_BER_WINDOW_LIMIT },
    { "CPRIMOD_RX_CONFIG_64B66B_BER_LIMIT", CPRIMOD_RX_CONFIG_64B66B_BER_LIMIT },
    { "CPRIMOD_RX_CONFIG_TEST_MODE", CPRIMOD_RX_CONFIG_TEST_MODE },
    { "CPRIMOD_RX_CONFIG_64B66B_INVALID_SYNC_HEADER_CNT", CPRIMOD_RX_CONFIG_64B66B_INVALID_SYNC_HEADER_CNT },
    { "CPRIMOD_RX_CONFIG_64B66B_VALID_SYNC_HEADER_CNT", CPRIMOD_RX_CONFIG_64B66B_VALID_SYNC_HEADER_CNT },
    { "CPRIMOD_RX_CONFIG_COUNT", CPRIMOD_RX_CONFIG_COUNT },
    ...
    { "CPRIMOD_TX_CONFIG_AGNOSTIC_MODE", CPRIMOD_TX_CONFIG_AGNOSTIC_MODE },
    { "CPRIMOD_TX_CONFIG_TX_PMD_DISBALE_OVERRIDE_VAL", CPRIMOD_TX_CONFIG_TX_PMD_DISBALE_OVERRIDE_VAL },
    { "CPRIMOD_TX_CONFIG_TX_PMD_DISBALE_OVERRIDE_EN", CPRIMOD_TX_CONFIG_TX_PMD_DISBALE_OVERRIDE_EN },
    { "CPRIMOD_TX_CONFIG_SCRAMBLER_BYPASS", CPRIMOD_TX_CONFIG_SCRAMBLER_BYPASS },
    { "CPRIMOD_TX_CONFIG_SCRAMBLER_SEED_8B10B", CPRIMOD_TX_CONFIG_SCRAMBLER_SEED_8B10B },
    { "CPRIMOD_TX_CONFIG_CWA_SCRABMLER_EN_8B10B", CPRIMOD_TX_CONFIG_CWA_SCRABMLER_EN_8B10B },
    { "CPRIMOD_TX_CONFIG_COUNT", CPRIMOD_TX_CONFIG_COUNT },
...
static cint_parameter_desc_t __cint_typedefs[] =
{
    ...
    {"_shr_rx_config_field_t", "cprimod_rx_config_field_t" , 0 , 0},
    {"_shr_rsvd4_tx_config_t", "cprimod_rsvd4_tx_config_field_t" , 0 , 0},
    {"_shr_tx_config_field_t", "cprimod_tx_config_field_t" , 0 , 0},
    ...
    {"_shr_rsvd4_control_group_entry_t", "cprimod_rsvd4_control_group_entry_t" , 0 , 0},
