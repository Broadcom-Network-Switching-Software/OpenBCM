...
sh_sand_man_t dnx_swstate_mdb_kaps_search_instruction_info_dump_man = {
    "swstate dump",
    "print the variable value",
    "mdb_kaps_db search_instruction_info dump []\n",
    "mdb_kaps_db search_instruction_info dump nocontent=false typefilter="" namefilter="" ",
};
...
sh_sand_man_t dnx_swstate_mdb_kaps_search_instruction_info_inst_p_dump_man = {
    "swstate dump",
    "print the variable value",
    "mdb_kaps_db search_instruction_info inst_p dump []\n",
    "mdb_kaps_db search_instruction_info inst_p dump nocontent=false typefilter="" namefilter="" ",
};
...
shr_error_e sh_dnx_swstate_mdb_kaps_search_instruction_info_inst_p_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(mdb_kaps_db_info[unit], mdb_kaps_db_layout_str, MDB_KAPS_DB_INFO_NOF_ENTRIES, "MDB_KAPS_DB~SEARCH_INSTRUCTION_INFO~INST_P~", sizeof(((mdb_kaps_sw_state_t*)sw_state_roots_array[unit][MDB_KAPS_MODULE_ID])->search_instruction_info.inst_p));
    dnx_sw_state_size_print(size);
