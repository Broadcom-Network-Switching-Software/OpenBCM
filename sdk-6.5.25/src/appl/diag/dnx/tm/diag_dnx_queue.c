    ...
    sh_sand_control_t * sand_control)
{
    ...
    PRT_COLUMN_ADD("Dest FTMH PP DSP");
...
/* *INDENT-OFF* */
    ...
    {"count",       sh_dnx_tm_queue_count_cmd,          NULL,   sh_dnx_tm_queue_count_options,          &sh_dnx_tm_queue_count_man, NULL, NULL, SH_CMD_CONDITIONAL, sh_dnx_tm_queue_count_skip},
