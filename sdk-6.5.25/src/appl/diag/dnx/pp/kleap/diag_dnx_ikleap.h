...
#define KLEAP_NOF_PDS_MAX                           22

#define KLEAP_NOF_KBRS_MAX                          20

#define KLEAP_NOF_STAGES_MAX                        10

#define KLEAP_STAGE_NAME_LEN                        5
...
typedef enum
{
    ...
    IF_2 = 2,
    IF_3 = 3,
    MAX_NUM_INTERFACES_PER_PHY_DB = 4,
...
typedef enum
{
    ...
    SHARED_PD_0 = 2,
    SHARED_PD_1 = 3
} kleap_pd_stage_mapping_types_e;

 /** \brief Types of KLEAP stage. single or double stage */
typedef enum
{
    INVALID_STAGE_TYPE = -1,
    SINGLE_STAGE_TYPE = 0,
    DOUBLE_STAGE_TYPE = 1,

    KLEAP_NOF_STAGE_TYPES = 2
} kleap_stage_types_e;
...
typedef struct stage_s
{
    ...
    dbal_fields_e dbal_stage_context_id[KLEAP_NOF_STAGE_TYPES];
    dbal_tables_e dbal_stage_context_properties[KLEAP_NOF_STAGE_TYPES];
    ...
    dbal_physical_tables_e kbr2physical[KLEAP_NOF_KBRS_MAX];
    /**+++++++++++++ Visibility +++++++++++++++*/
    interfaces_index_per_phyDb_e kbr_if_id[KLEAP_NOF_KBRS_MAX];
    /**+++++++++++++ Visibility +++++++++++++++*/
    /**+++++++++++++ Visibility +++++++++++++++*/
    uint32 nof_ffc;
    /**+++++++++++++ Visibility +++++++++++++++*/
...
typedef struct kleap_stages_header_qualifiert_s
{
    char *sub_stage_name;
    kleap_layer_to_pparse_t **header;
    kleap_layer_to_pparse_t **qualifier;
} kleap_stages_header_qualifiert_t;
...
stage_t dnx_ikleap_stages_get(
    int unit,
    int stage_index);

stage_t dnx_ikleap_stages_get_by_name(
    int unit,
    char *stage_name);
