    ...
    sh_sand_control_t * sand_control)
{
    ...
    for (i = 0; i < mesh_topology_info.nof_diag; i++)
    {
        /*
        ...
        PRT_ROW_ADD(PRT_ROW_SEP_NONE);
        PRT_CELL_SET("1");
        PRT_CELL_SET("%u", mesh_topology_info.mesh_topology_diag[i].indication_1);

        PRT_ROW_ADD(PRT_ROW_SEP_NONE);
        PRT_CELL_SET("2");
        PRT_CELL_SET("%u", mesh_topology_info.mesh_topology_diag[i].indication_2);

        PRT_ROW_ADD(PRT_ROW_SEP_NONE);
        PRT_CELL_SET("3");
        PRT_CELL_SET("%u", mesh_topology_info.mesh_topology_diag[i].indication_3);

        PRT_ROW_ADD(PRT_ROW_SEP_NONE);
        PRT_CELL_SET("4");
        PRT_CELL_SET("%u", mesh_topology_info.mesh_topology_diag[i].indication_4);
        ...
        PRT_CELL_SET("%u", mesh_topology_info.mesh_topology_diag[i].rx_control_cells_type1);

        PRT_ROW_ADD(PRT_ROW_SEP_NONE);
        PRT_CELL_SET("rx_control_cells_type2");
        PRT_CELL_SET("%u", mesh_topology_info.mesh_topology_diag[i].rx_control_cells_type2);

        PRT_ROW_ADD(PRT_ROW_SEP_NONE);
        PRT_CELL_SET("control_cells_type3");
        PRT_CELL_SET("%u", mesh_topology_info.mesh_topology_diag[i].control_cells_type3);
        ...
        for (link_idx = 0; link_idx < mesh_topology_info.mesh_topology_diag[i].link_list_count; link_idx++)
        {
            ...
            if (mesh_topology_info.mesh_topology_diag[i].type2_list[link_idx] != -1)
            {
                PRT_CELL_SET("0x%x", mesh_topology_info.mesh_topology_diag[i].type2_list[link_idx]);
            }
            else
            {
                PRT_CELL_SET("N/A");
         ...
         */
        LOG_CLI(("status 1:\n"));
        LOG_CLI(("status_1 %u \n", mesh_topology_info.mesh_topology_diag[i].status_1));
        LOG_CLI(("status_1_id1 %u \n", mesh_topology_info.mesh_topology_diag[i].status_1_id1));
        LOG_CLI(("status_1_id2 %u \n", mesh_topology_info.mesh_topology_diag[i].status_1_id2));
        /*
         * Print mesh topology Status table 1 }
         */
         ...
         */
        LOG_CLI(("status 2:\n"));
        LOG_CLI(("status_2 %u \n", mesh_topology_info.mesh_topology_diag[i].status_2));
        LOG_CLI(("status_2_id1 %u \n", mesh_topology_info.mesh_topology_diag[i].status_2_id1));
        LOG_CLI(("status_2_id2 %u \n\n", mesh_topology_info.mesh_topology_diag[i].status_2_id2));
        /*
         * Print mesh topology Status table 2 }
         */
    }
