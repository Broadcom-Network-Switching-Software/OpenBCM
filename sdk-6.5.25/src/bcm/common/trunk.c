...
/*
 * Function:
 *      bcm_trunk_multiset_info_t_init
 * Purpose:
 *      Initialize the bcm_trunk_multiset_info_t structure
 * Parameters:
 *      trunk_multiset_info - Pointer to structure which should be initialized
 * Returns:
 *      NONE
 */
void
bcm_trunk_multiset_info_t_init(bcm_trunk_multiset_info_t *trunk_multiset_info)
{
    if (NULL != trunk_multiset_info) {
        sal_memset(trunk_multiset_info, 0, sizeof (*trunk_multiset_info));
    }
    return;
}
...
/*
 * Function:
 *      bcm_trunk_member_block_key_t_init
 * Purpose:
 *      Initialize the bcm_trunk_member_block_key_t structure
 * Parameters:
 *      trunk_member - Pointer to structure which should be initialized
 * Returns:
 *      NONE
 */
void
bcm_trunk_member_block_key_t_init(bcm_trunk_member_block_key_t *key)
{
    if (NULL != key) {
