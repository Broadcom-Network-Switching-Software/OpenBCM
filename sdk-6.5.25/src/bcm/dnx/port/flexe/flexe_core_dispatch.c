...
#if (0)
/* { Currently UNUSED. Leave since it may be used in the future */
int
    ...
    int enable)
{
    ...
    {
        __rv__ =
            __flexe_core__dispatch__[__type__]->f_flexe_core_phy_default_config_set(unit, flexe_core_port, speed,
                                                                                    enable);
        SHR_IF_ERR_EXIT(__rv__);
    }
    else
