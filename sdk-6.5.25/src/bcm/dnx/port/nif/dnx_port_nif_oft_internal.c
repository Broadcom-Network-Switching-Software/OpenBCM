...
shr_error_e
dnx_port_oft_reset_counters_and_port_set(
    int unit,
    ...
    int in_reset)
{
    ...
    /*
     * Reset / taking out of reset OFT PACK
     */
    ...
    int in_reset)
{
     ...
     * alloc DBAL table handle
     */
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_NIF_OFT_RESET_CREDITS_COUNTER, &entry_handle_id));
