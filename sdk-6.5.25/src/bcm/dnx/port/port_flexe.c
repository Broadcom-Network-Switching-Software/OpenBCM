    ...
    int is_set)
{
    ...
    if (is_set)
    {
        max_tolerance_level = dnx_data_nif.flexe.sar_jitter_tolerance_max_level_get(unit);
    ...
    int value)
{
     ...
     */
    fifo_level.high_level = dnx_data_nif.flexe.sar_jitter_fifo_levels_get(unit, value)->high_level;
    fifo_level.low_level = dnx_data_nif.flexe.sar_jitter_fifo_levels_get(unit, value)->low_level;
