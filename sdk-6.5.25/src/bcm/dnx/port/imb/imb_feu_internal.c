 ...
 */
static shr_error_e
imb_feu_internal_mac_access_control_set_er_rollback(
    int unit,
    int er_thread_id,
    uint8 *metadata,
    uint8 *payload,
 ...
 */
int
imb_feu_internal_mac_access_control_set_er_journal_insert(
    int unit,
    int port)
{
    SHR_FUNC_INIT_VARS(unit);
    ...
    SHR_IF_ERR_EXIT(dnx_generic_state_journal_entry_new(unit,
                                                        ...
                                                        (uint8 *) &port,
                                                        sizeof(int),
                                                        &imb_feu_internal_mac_access_control_set_er_rollback, FALSE));
exit:
    SHR_FUNC_EXIT;
}
 ...
 */
int
imb_feu_internal_lf_rf_li_encap_enable_set(
    int unit,
    int enable)
{
    uint32 entry_handle_id;
