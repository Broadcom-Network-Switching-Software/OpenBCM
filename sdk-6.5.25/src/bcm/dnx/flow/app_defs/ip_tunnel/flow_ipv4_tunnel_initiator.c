...
static shr_error_e
flow_ipv4_tunnel_initiator_tunnel_type_get(
    int unit,
    ...
    bcm_flow_special_fields_t * special_fields)
{
    ...
    SHR_IF_ERR_EXIT(flow_ipv4_tunnel_initiator_tunnel_type_get(unit, special_fields, &tunnel_type));
    ...
    bcm_flow_special_fields_t * special_fields)
{
    ...
    if (is_field_valid)
    {
        SPECIAL_FIELD_SYMBOL_DATA_ADD(special_fields, FLOW_S_F_IPV4_TUNNEL_TYPE, bcmTunnelTypeGreAnyIn4);
    ...
    if (is_field_valid)
    {
        SPECIAL_FIELD_SYMBOL_DATA_ADD(special_fields, FLOW_S_F_IPV4_TUNNEL_TYPE, bcmTunnelTypeUdp);
    ...
    if (is_field_valid)
    {
        ...
        {
            SPECIAL_FIELD_SYMBOL_DATA_ADD(special_fields, FLOW_S_F_IPV4_TUNNEL_TYPE, bcmTunnelTypeVxlanGpe);
        }
        else
        {
            SPECIAL_FIELD_SYMBOL_DATA_ADD(special_fields, FLOW_S_F_IPV4_TUNNEL_TYPE, bcmTunnelTypeVxlan);
        }
        SHR_EXIT();
    }
    ...
    bcm_flow_special_fields_t * special_fields)
{
    ...
    SHR_IF_ERR_EXIT(flow_ipv4_tunnel_initiator_tunnel_type_get(unit, &prev_special_fields, &tunnel_type));
    ...
    SHR_IF_ERR_EXIT(flow_ipvx_tunnel_initiator_lif_ahp_replace
