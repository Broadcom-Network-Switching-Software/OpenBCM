...
extern const dnx_flow_app_config_t dnx_flow_app_ipv6_tunnel_initiator;
extern const dnx_flow_app_config_t dnx_flow_app_ipvx_tunnel_terminator;
extern const dnx_flow_app_config_t dnx_flow_app_ipv4_tunnel_p2p_em_term_match;
extern const dnx_flow_app_config_t dnx_flow_app_ipv4_tunnel_mp_em_term_match;
extern const dnx_flow_app_config_t dnx_flow_app_ipv6_tunnel_mp_tcam_term_match;
extern const dnx_flow_app_config_t dnx_flow_app_ipv6_tunnel_p2p_em_term_match;
...
extern const dnx_flow_app_config_t dnx_flow_app_vlan_port_ll_ac_untagged_term_match;
...
extern const dnx_flow_app_config_t dnx_flow_app_vlan_port_esem_initiator;
...
extern const dnx_flow_app_config_t dnx_flow_app_rch_initiator;
...
const dnx_flow_app_config_t *dnx_flow_objects[] = {
    ...
    &dnx_flow_app_ipv6_tunnel_initiator,
    &dnx_flow_app_ipvx_tunnel_terminator,
    &dnx_flow_app_ipv4_tunnel_p2p_em_term_match,
    &dnx_flow_app_ipv4_tunnel_mp_em_term_match,
    &dnx_flow_app_ipv6_tunnel_mp_tcam_term_match,
    &dnx_flow_app_ipv6_tunnel_p2p_em_term_match,
    ...
    &dnx_flow_app_vlan_port_ll_ac_untagged_term_match,
    ...
    &dnx_flow_app_vlan_port_esem_initiator,
...
extern dnx_flow_common_field_desc_t
    ...
    dnx_flow_common_field_learn_enable, dnx_flow_common_field_l2_egress_info, dnx_flow_common_field_tpid_class_id;
...
dnx_flow_common_field_desc_t *dnx_flow_init_common_fields[] = {
    ...
    &dnx_flow_common_field_failover_id,
    &dnx_flow_common_field_failover_state,
    &dnx_flow_common_field_tpid_class_id,
