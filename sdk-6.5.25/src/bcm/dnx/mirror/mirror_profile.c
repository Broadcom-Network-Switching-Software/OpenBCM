    ...
    bcm_mirror_destination_t * mirror_dest)
{
    ...
    uint32 snif_type, dest, snif_probability, crop_enable, crop_size, tc, tc_ow, dp, dp_ow,
        in_port, in_port_ow, drop_fwd_if_snif_dropped,
        drop_snif_if_fwd_dropped, st_vsq_ptr, st_vsq_ptr_ow, lag_lb_key,
        lag_lb_key_ow, admit_profile, admit_profile_ow, metadata_ow, ext_stat_opcode_ow = 0,
        ext_stat_data_ow = 0, ext_stat_valid_ow = 0, cud_type;
