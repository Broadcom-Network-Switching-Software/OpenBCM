    ...
    uint32 mc_pd_sp)
{
    ...
    if (dnx_data_ecgm.port_resources.feature_get(unit, dnx_data_ecgm_port_resources_profile_management))
    {
    ...
    else
    {
        ...
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_BASE_Q_PAIR, base_qpair_or_port_profile);
    }
    ...
    const dnx_ecgm_uc_thresholds_t * thresholds)
{
    ...
    {
        SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_ECGM_UNICAST_PORT_THRESHOLDS_WO_PROFILE, &entry_handle_id));
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_OUT_TM_PORT, out_tm_port_or_portprofile);
    }
    ...
    const dnx_ecgm_mc_drop_thresholds_t * thresholds)
{
    ...
    {
        SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC
                        (unit, DBAL_TABLE_ECGM_MULTICAST_PORT_THRESHOLDS_WO_PROFILE, &entry_handle_id));
        dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_OUT_TM_PORT, tm_port_or_port_profile);
    }
