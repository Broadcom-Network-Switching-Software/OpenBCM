    ...
    int unit)
{
    ...
    }
    {
        ...
        SHR_IF_ERR_EXIT(dnx_dbal_gen_set(unit, DBAL_TABLE_EGQ_SHAPER_OTM_CALENDAR_CRDT_TABLE,
                                         ...
                                         GEN_DBAL_RANGE32, DBAL_FIELD_CORE_ID, DBAL_RANGE_ALL, DBAL_RANGE_ALL,
                                         GEN_DBAL_FIELD32, DBAL_FIELD_OTM_CAL_CRDT_TO_ADD, INST_SINGLE, field32_value,
                                         GEN_DBAL_FIELD32, DBAL_FIELD_OTM_CAL_MAX_BURST, INST_SINGLE, field32_value,
                                         GEN_DBAL_FIELD_LAST_MARK));
    }
    DNXCMN_CORES_ITER(unit, BCM_CORE_ALL, core)
    {
    ...
    int alt_cal_alg)
{
    ...
    {
        /** recalculate calcal */
        SHR_IF_ERR_EXIT(dnx_ofp_rates_calcal_config(unit, core, alt_cal_alg));
    ...
    int alt_cal_alg)
{
    ...
    for (chan_arb_i = 0; chan_arb_i < dnx_data_egr_queuing.params.nof_calendars_get(unit); chan_arb_i++)
    {
        ...
        COMPILER_64_ADD_32(egq_calcal_chan_arb_rate_requested, egq_calcal_rates[chan_arb_i]);
    }
    ...
    bcm_core_t core)
{
    ...
    /** Select the non-active set. */
    SHR_IF_ERR_EXIT(dnx_ofp_rates_set_select_get(unit, core, DNX_OFP_RATES_EGQ_CAL_CHAN_ARB, &fld_val));
    egq_to_set = (fld_val == DNX_OFP_RATES_CAL_SET_A) ? DNX_OFP_RATES_CAL_SET_B : DNX_OFP_RATES_CAL_SET_A;

    /** Reset non-active calendar to default */
    SHR_IF_ERR_EXIT(dnx_ofp_rates_otm_calendar_clear(unit, core, egq_to_set));
