    ...
    bcm_gport_t * gport)
{
    ...
    /** verify parameters */
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_ingress_queue_bundle_gport_add_verify(unit, config, gport));
    ...
    bcm_gport_t ingress_queue)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_sysport_ingress_queue_map_set_verify(unit, flags, sysport, ingress_queue));
    ...
    bcm_gport_t * ingress_queue)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_sysport_ingress_queue_map_get_verify(unit, flags, sysport, ingress_queue));
    ...
    bcm_cos_queue_t cosq)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_mapping_set_verify(unit, priority, cosq));
    ...
    bcm_cos_queue_t * cosq)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_mapping_get_verify(unit, priority, cosq));
    ...
    bcm_cosq_queue_offset_t * offset_array)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_gport_queue_offset_mapping_set_verify(unit, flags, gport, count,
    ...
    bcm_cosq_queue_offset_t * offset_array)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_gport_queue_offset_mapping_get_verify(unit, flags, gport, count,
                                                                          key_array, offset_array));
