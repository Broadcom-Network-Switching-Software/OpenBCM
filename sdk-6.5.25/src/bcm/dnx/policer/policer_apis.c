    ...
    bcm_policer_expansion_group_t * expansion_group)
{
    ...
    /** Verify parameters */
    SHR_INVOKE_VERIFY_DNXC(dnx_policer_expansion_groups_set_verify(unit, flags, core_id, expansion_group));
    ...
    bcm_policer_expansion_group_t * expansion_group)
{
    ...
    DNX_ERR_RECOVERY_START(unit);
    /** Verify parameters */
    SHR_INVOKE_VERIFY_DNXC(dnx_policer_expansion_groups_get_verify(unit, flags, core_id, expansion_group));
    ...
    bcm_policer_database_config_t * config)
{
    ...
    DNX_ERR_RECOVERY_START(unit);
    /** Verify parameters */
    SHR_INVOKE_VERIFY_DNXC(dnx_policer_database_create_verify(unit, flags, policer_database_handle, config));
...
static shr_error_e
bcm_dnx_policer_database_destroy_verify(
    int unit,
    int policer_database_handle)
{
    int core_id, is_ingress, database_id, use_single_bucket_bank;
    uint32 nof_banks;
    SHR_FUNC_INIT_VARS(unit);
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_policer_database_handle_verify(unit, policer_database_handle));

    /*
     * All engines should be detached, nof_meters should equal 0 and use_single_bucket_bank should equal 0
     */
    ...
    if (nof_banks != 0 || use_single_bucket_bank != FALSE)
    {
        SHR_ERR_EXIT(_SHR_E_CONFIG, "Invalid operation. All engines should be detached before destroy the database");
    }
    ...
    int policer_database_handle)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(bcm_dnx_policer_database_destroy_verify(unit, policer_database_handle));
    is_ingress = _SHR_POLICER_DATABASE_HANDLE_IS_INGRESS_GET(policer_database_handle);
    database_id = _SHR_POLICER_DATABASE_HANDLE_DATABASE_ID_GET(policer_database_handle);
    is_global = _SHR_POLICER_DATABASE_HANDLE_IS_GLOBAL_GET(policer_database_handle);
    ...
    uint32 arg)
{
    ...
    DNX_ERR_RECOVERY_START(unit);
    /** Verify parameters */
    SHR_INVOKE_VERIFY_DNXC(dnx_policer_control_set_verify(unit, flags, policer_database_handle, type, arg));
    ...
    uint32 *arg)
{
    ...
    DNX_ERR_RECOVERY_START(unit);
    /** Verify parameters */
    SHR_INVOKE_VERIFY_DNXC(dnx_policer_control_get_verify(unit, flags, policer_database_handle, type, arg));
    ...
    bcm_policer_database_attach_config_t * config)
{
    ...
    /** verify that correct engine_id is used for ingress/egress single bucket meter*/
    if ((single_bucket_engine == TRUE)
        && _SHR_POLICER_DATABASE_HANDLE_IS_INGRESS_GET(config->policer_database_handle) == 1)
    {
        if (engine->engine_id != dnx_data_meter.mem_mgmt.ingress_single_bucket_engine_get(unit))
        {
            SHR_ERR_EXIT(_SHR_E_PARAM, "engine_id=%d cannot be used for ingress single bucket mode\n",
                         engine->engine_id);
        }
    }
    else if ((single_bucket_engine == TRUE)
             && _SHR_POLICER_DATABASE_HANDLE_IS_INGRESS_GET(config->policer_database_handle) == 0)
    {
        if (engine->engine_id != dnx_data_meter.mem_mgmt.egress_single_bucket_engine_get(unit))
        {
            SHR_ERR_EXIT(_SHR_E_PARAM, "engine_id=%d cannot be used for egress single bucket mode\n",
                         engine->engine_id);
        }
    }
    ...
    bcm_policer_database_attach_config_t * config)
{
    ...
    DNX_ERR_RECOVERY_START(unit);
    /** Verify parameters */
    SHR_INVOKE_VERIFY_DNXC(dnx_policer_engine_database_attach_verify(unit, flags, engine, config));
    ...
    bcm_policer_database_attach_config_t * config)
{
    ...
    /** Verify parameters */
    SHR_INVOKE_VERIFY_DNXC(dnx_policer_engine_database_get_verify(unit, flags, engine, config));
    ...
    bcm_policer_engine_t * engine)
{
    ...
    DNX_ERR_RECOVERY_START(unit);
    /** Verify parameters */
    SHR_INVOKE_VERIFY_DNXC(dnx_policer_engine_database_detach_verify(unit, flags, engine));
    ...
    int enable)
{
    ...
    DNX_ERR_RECOVERY_START(unit);
    /** Verify parameters */
    SHR_INVOKE_VERIFY_DNXC(dnx_policer_database_enable_set_get_verify(unit, flags, policer_database_handle, &enable));
    ...
    bcm_policer_config_t * pol_cfg)
{
    ...
    /** Verify parameters */
    SHR_INVOKE_VERIFY_DNXC(dnx_policer_set_verify(unit, policer_id, (pol_cfg->flags | BCM_POLICER_REPLACE), pol_cfg));
    ...
    bcm_policer_config_t * pol_cfg)
{
    ...
    DNX_ERR_RECOVERY_START(unit);
    /** Verify parameters */
    SHR_INVOKE_VERIFY_DNXC(dnx_policer_get_verify(unit, policer_id, pol_cfg));
    ...
    bcm_policer_t * policer_id)
{
    ...
    DNX_ERR_RECOVERY_START(unit);
    /** Verify parameters */
    SHR_INVOKE_VERIFY_DNXC(dnx_policer_set_verify(unit, *policer_id, pol_cfg->flags, pol_cfg));
...
static shr_error_e
dnx_policer_primary_color_resolution_config_verify(
    int unit,
    int is_ingress,
    bcm_policer_primary_color_resolution_config_t * config)
{
    ...
    nof_databases =
        (is_ingress ==
         FALSE) ? dnx_data_meter.meter_db.nof_egress_db_get(unit) : dnx_data_meter.meter_db.nof_ingress_db_get(unit);

    for (i = 0; i < nof_databases; i++)
    {
        if (config->policer_color[i] > bcmColorBlack)
        {
            SHR_ERR_EXIT(_SHR_E_PARAM, "invalid  config.policer_color[%d] (=%d). max value is %d\n",
                         i, config->policer_color[i], bcmColorBlack);
        }
        if (config->policer_update_bucket[i] > bcmPolicerColorRed)
        {
            SHR_ERR_EXIT(_SHR_E_PARAM, "invalid  config.policer_update_bucket[%d] (=%d). max value is %d\n",
                         i, config->policer_update_bucket[i], bcmPolicerColorRed);
        }
        if (config->policer_count[i] != FALSE && config->policer_count[i] != TRUE)
        {
            SHR_ERR_EXIT(_SHR_E_PARAM, "invalid  config->policer_count[%d] (=%d). value is TRUE\\FALSE\n",
                         i, config->policer_count[i]);
        }
    }
    if (config->resolved_color > bcmColorBlack)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "invalid  config.resolved_color (=%d). max value is %d\n",
    ...
    bcm_policer_primary_color_resolution_config_t * config)
{
    ...
    SHR_IF_ERR_EXIT(dnx_policer_primary_color_resolution_config_verify(unit, key->is_ingress, config));
    ...
    bcm_policer_primary_color_resolution_config_t * config)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_policer_primary_color_resolution_set_verify(unit, flags, key, config));
    ...
    bcm_policer_primary_color_resolution_config_t * config)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_policer_primary_color_resolution_get_verify(unit, flags, key, config));
    ...
    bcm_policer_color_resolution_t * policer_color_resolution)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_policer_color_resolution_set_verify(unit, policer_color_resolution));
    ...
    bcm_policer_color_resolution_t * policer_color_resolution)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_policer_color_resolution_get_verify(unit, policer_color_resolution));
    ...
    uint64 *value)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_policer_stat_get_verify(unit, policer_id, stat));
