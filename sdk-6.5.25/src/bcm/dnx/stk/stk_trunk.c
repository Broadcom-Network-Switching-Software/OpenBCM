    ...
    uint32 stack_lag)
{
    ...
    /** Verify */
    SHR_INVOKE_VERIFY_DNXC(dnx_stk_trunk_fec_map_stack_lag_set_verify(unit, tm_domain, entry, stack_lag));
    ...
    uint32 base_queue)
{
    ...
    /** Verify */
    SHR_INVOKE_VERIFY_DNXC(dnx_stk_trunk_stack_lag_packets_base_queue_id_set_verify
                           (unit, tm_domain, entry, base_queue));
    ...
    uint32 *base_queue)
{
    ...
    /** Verify */
    SHR_INVOKE_VERIFY_DNXC(dnx_stk_trunk_stack_lag_packets_base_queue_id_get_verify
                           (unit, tm_domain, entry, base_queue));
    ...
    bcm_trunk_member_t * member_array)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_stk_trunk_stacking_set_verify(unit, trunk_id, member_count, member_array));
    ...
    int *member_count)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_stk_trunk_stacking_get_verify(unit, trunk_id, member_max, member_array, member_count));
    ...
    bcm_trunk_member_t * member)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_stk_trunk_stacking_member_add_verify(unit, trunk_id, member));
    ...
    bcm_trunk_member_t * member)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_stk_trunk_stacking_member_delete_verify(unit, trunk_id, member));
