...
#define SWITCH_LB_FORCE_L2_LAYER_TYPE_MASK  0

#define SWITCH_LB_FORCE_L2_LAYER_QULIFIER   0

#define SWITCH_LB_FORCE_L2_LAYER_QULIFIER_MASK  0xffff

#define SWITCH_LB_FORCE_L2_INDEX    0
    ...
    dnx_switch_hash_header_attr_t * header_info)
{
    ...
    switch (type)
    {
        ...
        case bcmSwitchHashIP6Field:
        {
            ...
            header_info->field_enablers_header_id = DBAL_ENUM_FVAL_HASH_FIELD_ENABLERS_HEADER_IP6;
            break;
        }
        ...
        case bcmSwitchHashL4Field:
        {
            ...
            {
                header_info->field_flags[field_counter].flag_fields[header_info->
                                                                    field_flags[field_counter].nof_fields++] =
...
shr_error_e
dnx_port_load_balancing_switch_hash_seed_by_pp_port_set(
    int unit,
    int pp_port,
    int core_id,
    uint16 arg)
{
    ...
    dbal_entry_value_field16_set(unit, entry_handle_id, DBAL_FIELD_SEED, INST_SINGLE, arg);
    ...
    int unit)
{
    ...
    }
    {
        ...
        sal_memset(&mpls_identification.mpls_identification, 0,
                   sizeof(mpls_identification.mpls_identification[0]) * SWITCH_MPLS_IDENTIFICATION_SIZE_IN_UINT32);

        mpls_identification.mpls_identification[DBAL_ENUM_FVAL_LAYER_TYPES_MPLS / SAL_UINT32_NOF_BITS] |=
            SAL_BIT(dnx_init_pp_layer_types_value_get(unit, DBAL_ENUM_FVAL_LAYER_TYPES_MPLS % SAL_UINT32_NOF_BITS));
        mpls_identification.mpls_identification[DBAL_ENUM_FVAL_LAYER_TYPES_MPLS_UNTERM / SAL_UINT32_NOF_BITS] |=
            SAL_BIT(dnx_init_pp_layer_types_value_get
                    (unit, DBAL_ENUM_FVAL_LAYER_TYPES_MPLS_UNTERM % SAL_UINT32_NOF_BITS));
...

    {
        ...
        bcm_switch_control_t headers[] = { bcmSwitchHashIP4OuterField, bcmSwitchHashIP4InnerField,
            bcmSwitchHashIP6Field, bcmSwitchHashL2OuterField, bcmSwitchHashL2InnerField,
            bcmSwitchHashL4Field, bcmSwitchHashMPLSField0
        };
        dnx_switch_hash_header_attr_t header_info;
        int header_id;
    ...
    dnx_switch_lb_mpls_identification_t * mpls_identification_p)
{
    uint32 entry_handle_id;
    uint32 bit_count = 0;
    uint32 bit_stream[SWITCH_MPLS_IDENTIFICATION_SIZE_IN_UINT32];
    int mpls_index;
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FUNC_INIT_VARS(unit);
    SHR_NULL_CHECK(mpls_identification_p, _SHR_E_PARAM, "mpls_identification_p");

    sal_memcpy(bit_stream, mpls_identification_p->mpls_identification,
               sizeof(mpls_identification_p->mpls_identification[0]) * SWITCH_MPLS_IDENTIFICATION_SIZE_IN_UINT32);

    for (mpls_index = 0; mpls_index < SWITCH_MPLS_IDENTIFICATION_SIZE_IN_UINT32; mpls_index++)
    {
        bit_count += utilex_nof_on_bits_in_long(bit_stream[mpls_index]);
    }
    if (bit_count > dnx_data_switch.load_balancing.num_valid_mpls_protocols_get(unit))
    {
        SHR_ERR_EXIT(_SHR_E_PARAM,
                     "\r\n"
                     "Number of MPLS protocols on input (%d) is larger than max allowed (%d).\r\n"
                     "  This is illegal. Quit.\r\n", bit_count,
                     dnx_data_switch.load_balancing.num_valid_mpls_protocols_get(unit));
    }

    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_MPLS_LAYER_IDENTIFICATION_BITMAP_CFG, &entry_handle_id));

    dbal_entry_value_field_arr32_set(unit,
    ...
    dnx_switch_lb_mpls_identification_t * mpls_identification_p)
{
    ...
    SHR_IF_ERR_EXIT(dbal_entry_handle_value_field_arr32_get(unit,
                                                            entry_handle_id, DBAL_FIELD_MPLS_BIT_IDENTIFIER,
                                                            INST_SINGLE, mpls_identification_p->mpls_identification));
exit:
    DBAL_FUNC_FREE_VARS;
    SHR_FUNC_EXIT;
}
    ...
    bcm_switch_mpls_next_protocol_t * disable_protocol)
{
    ...
    switch (nibble)
    {
        ...
        case 4:
        {
            ...
            *disable_protocol = bcmSwitchMplsNextProtocolDefault;
            *dbal_field = DBAL_FIELD_VALUE_OF_4_EN;
            break;
        }
        case 5:
        {
            ...
            *disable_protocol = bcmSwitchMplsNextProtocolDefault;
            *dbal_field = DBAL_FIELD_VALUE_OF_5_EN;
            break;
        }
        case 6:
        {
            ...
            *disable_protocol = bcmSwitchMplsNextProtocolDefault;
            *dbal_field = DBAL_FIELD_VALUE_OF_6_EN;
            break;
        }
        case BCM_SWITCH_DEFAULT_NIBBLE_INDEX:
        {
            ...
            *dbal_field = DBAL_FIELD_VALUE_OF_0_EN;
            break;
        }
        case BCM_SWITCH_DEFAULT_IPVX_NIBBLE_INDEX:
        {
            *enable_protocol = bcmSwitchMplsNextProtocolEthernet;
            *disable_protocol = bcmSwitchMplsNextProtocolNone;
            *dbal_field = DBAL_FIELD_VALUE_OF_ROW_EN;
            break;
        }
        default:
...
shr_error_e
dnx_switch_control_load_balancing_hash_force_l2_set(
    int unit,
    uint32 valid)
{
    uint32 entry_handle_id;
    uint32 entry_access_id = SWITCH_LB_FORCE_L2_INDEX;

    SHR_FUNC_INIT_VARS(unit);
    DBAL_FUNC_INIT_VARS(unit);

    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_FORCE_LOAD_BALANCING_LAYER, &entry_handle_id));
    dbal_entry_key_field32_masked_set(unit, entry_handle_id, DBAL_FIELD_FORCE_LB_LAYER_TYPE,
                                      DBAL_ENUM_FVAL_LAYER_TYPES_ETHERNET, SWITCH_LB_FORCE_L2_LAYER_TYPE_MASK);
    dbal_entry_key_field32_masked_set(unit, entry_handle_id, DBAL_FIELD_FORCE_LB_LAYER_QUALIFER,
                                      SWITCH_LB_FORCE_L2_LAYER_QULIFIER, SWITCH_LB_FORCE_L2_LAYER_QULIFIER_MASK);
...
shr_error_e
dnx_switch_control_load_balancing_hash_force_l2_get(
    int unit,
    uint32 *valid)
{
    uint32 entry_handle_id;
