    ...
    int arg)
{
    ...
    switch (type)
    {
        ...
        case bcmStatControlCounterThreadEnable:
            ...
            break;
        case bcmStatControlCounterNetworkEvictionPktSize:
            if (!dnx_data_crps.eviction.
                supported_eviction_destination_get(unit, bcmStatEvictionDestinationNetwork)->valid)
            {
                SHR_ERR_EXIT(_SHR_E_PARAM, "Type=bcmStatControlCounterNetworkEvictionPktSize is not supported");
            }
            if (arg != 3 && arg != 6 && arg != 12)
            {
                SHR_ERR_EXIT(_SHR_E_PARAM,
                             " Incorrect arg=%d\n, type=bcmStatControlCounterNetworkEvictionPktSize - arg value should be 3, 6 or 12",
                             arg);
            }
            break;
        case bcmStatControlEgressL2FwdPlusOneMetadataEnable:
            if (flags != 0)
            {
                SHR_ERR_EXIT(_SHR_E_PARAM,
                             " Incorrect flags=%d\n, expected flags=0 for type=bcmStatControlEgressL2FwdPlusOneMetadataEnable",
                             flags);
            }
            if ((arg != TRUE) && (arg != FALSE))
            {
                SHR_ERR_EXIT(_SHR_E_PARAM,
                             " Incorrect arg=%d\n, type=bcmStatControlEgressL2FwdPlusOneMetadataEnable - arg value should be TRUE or FALSE",
                             arg);
            }
            break;
        default:
    ...
    int arg)
{
    ...
    /** Verify parameters */
    SHR_INVOKE_VERIFY_DNXC(dnx_stat_control_set_verify(unit, flags, type, arg));
    ...
    switch (type)
    {
        ...
        case bcmStatControlCounterThreadEnable:
            ...
            break;
        case bcmStatControlCounterNetworkEvictionPktSize:
            SHR_IF_ERR_EXIT(dnx_crps_mgmt_network_eviction_pkt_size_set(unit, arg));
            break;
        case bcmStatControlEgressL2FwdPlusOneMetadataEnable:
            SHR_IF_ERR_EXIT(dnx_stat_pp_egress_l2_fwd_plus_one_metadata_enable_set(unit, arg));
            break;
        default:
            SHR_ERR_EXIT(_SHR_E_PARAM, " invalid stat control type (=%d)\n", type);
            break;
    ...
    int *arg)
{
    ...
    if (type == bcmStatControlCounterNetworkEvictionPktSize &&
    ...
    int *arg)
{
    ...
    DNX_ERR_RECOVERY_NOT_NEEDED(unit);
    /** Verify parameters */
    SHR_INVOKE_VERIFY_DNXC(dnx_stat_control_get_verify(unit, flags, type, arg));
    ...
    switch (type)
    {
        ...
        case bcmStatControlCounterThreadEnable:
            ...
            break;
        case bcmStatControlCounterNetworkEvictionPktSize:
            SHR_IF_ERR_EXIT(dnx_crps_mgmt_network_eviction_pkt_size_get(unit, arg));
            break;
        case bcmStatControlEgressL2FwdPlusOneMetadataEnable:
            SHR_IF_ERR_EXIT(dnx_stat_pp_egress_l2_fwd_plus_one_metadata_enable_get(unit, arg));
            break;
        default:
            SHR_ERR_EXIT(_SHR_E_PARAM, " invalid stat control type (=%d)\n", type);
            break;
    ...
    int enable)
{
    ...
    if (flags == BCM_STAT_EXTERNAL)
    {
        ...
        SHR_INVOKE_VERIFY_DNXC(dnx_stif_mgmt_pkt_size_adjust_select_set_verify(unit, key, select_type, enable));
    ...
    else
    {
        ...
        SHR_INVOKE_VERIFY_DNXC(dnx_crps_ingress_pkt_size_adjust_select_set_verify
    ...
    int *enable)
{
    ...
    {
        /** STIF pkt size adjust */
        SHR_INVOKE_VERIFY_DNXC(dnx_stif_mgmt_pkt_size_adjust_select_verify(unit, key, select_type));
    ...
    {
        /** CRPS pkt size adjust */
        SHR_INVOKE_VERIFY_DNXC(dnx_crps_ingress_pkt_size_adjust_select_get_verify
                               (unit, flags, key, select_type, enable));
    ...
    int unit)
{
    ...
    for (instance_id = 0; instance_id < bcmStatCounterGroupFilterCount; instance_id++)
    {
        ...
        if (group_index->index == DNX_STAT_NO_SUPPORT)
        {
            continue;
        }
    ...
    int is_active)
{
    ...
    if (flags == BCM_STAT_EXTERNAL)
    {
        SHR_INVOKE_VERIFY_DNXC(dnx_stif_mgmt_filter_group_set_verify(unit, key, filter, is_active));
        SHR_IF_ERR_EXIT(dnx_stif_mgmt_filter_group_set(unit, key, filter, is_active));
    }
    /** Use case 1 : CRPS */
    else
    {
        SHR_INVOKE_VERIFY_DNXC(dnx_crps_mgmt_filter_group_set_verify(unit, flags, key, filter, is_active));
    ...
    int *is_active)
{
    ...
    if (flags == BCM_STAT_EXTERNAL)
    {
        SHR_INVOKE_VERIFY_DNXC(dnx_stif_mgmt_filter_group_verify(unit, key, filter));
        SHR_IF_ERR_EXIT(dnx_stif_mgmt_filter_group_get(unit, key, filter, is_active));
    }
    /** Use case 1 : CRPS */
    else
    {
        SHR_INVOKE_VERIFY_DNXC(dnx_crps_mgmt_filter_group_get_verify(unit, flags, key, filter, is_active));
    ...
    int *stat_id)
{
    ...
    SHR_IF_ERR_EXIT(dnx_algo_port_pp_dsp_get(unit, key->port, &core_id, dsp_pp_port));
    ...
    *stat_id = 0;
    ...
    SHR_IF_ERR_EXIT(utilex_bitstream_set_any_field(dsp_pp_port, dnx_data_crps.latency.stat_id_port_offset_get(unit),
                                                   utilex_log2_round_up(dnx_data_port.general.nof_pp_dsp_get(unit)),
                                                   (uint32 *) stat_id));
    ...
    int *drop_reasons_count)
{
    ...
    if ((int) group < 0 || group >= bcmStatCounterGroupFilterCount)
    {
    ...
    int *drop_reasons_count)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_stat_group_drop_reasons_get_verify
    ...
    int drop_reasons_count)
{
    ...
    {
        /** Check the type is valid for the current device */
        if ((int) (drop_reasons_array[drop_reason_id]) < 0
    ...
    int drop_reasons_count)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_stat_group_drop_reasons_set_verify
