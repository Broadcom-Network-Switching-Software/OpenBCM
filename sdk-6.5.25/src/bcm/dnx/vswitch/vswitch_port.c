    ...
    bcm_gport_t port)
{
    ...
    if (dnx_data_flow.vlan_port.feature_get(unit, dnx_data_flow_vlan_port_flow_in_use))
    {
        SHR_IF_ERR_EXIT(dnx_vswitch_port_flow_add(unit, vsi, learn_enable, port));
    }
    else
    {
    ...
    bcm_vlan_t * vsi)
{
    ...
    if (dnx_data_flow.vlan_port.feature_get(unit, dnx_data_flow_vlan_port_flow_in_use))
    {
        SHR_IF_ERR_EXIT(dnx_vswitch_port_flow_get(unit, port, vsi));
    }
    else
    {
    ...
    bcm_gport_t port)
{
    ...
    if (dnx_data_flow.vlan_port.feature_get(unit, dnx_data_flow_vlan_port_flow_in_use))
    {
        SHR_IF_ERR_EXIT(dnx_vswitch_port_flow_add(unit, DNX_VSI_DEFAULT, learn_enable, port));
    }
    else
    {
