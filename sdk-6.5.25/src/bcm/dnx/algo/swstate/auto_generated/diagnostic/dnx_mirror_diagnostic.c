...
dnx_mirror_db_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(dnx_mirror_db_mirror_on_drop_profile_dump(unit, -1, -1, filters));
 ...
 */
int
dnx_mirror_db_mirror_on_drop_profile_dump(int  unit,  int  mirror_on_drop_profile_idx_0,  int  mirror_on_drop_profile_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = mirror_on_drop_profile_idx_0, I0 = mirror_on_drop_profile_idx_0 + 1;
    int i1 = mirror_on_drop_profile_idx_1, I1 = mirror_on_drop_profile_idx_1 + 1, org_i1 = mirror_on_drop_profile_idx_1;
    char *s0 = "", *s1 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    else
    {
        ...
        if (i0 == -1) {
            I0 = BCM_MIRROR_ADMIT_PROFILES_NOF;
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
        ...
        if(i0 >= BCM_MIRROR_ADMIT_PROFILES_NOF)
        {
        ...
        if(BCM_MIRROR_ADMIT_PROFILES_NOF == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if (i1 == -1) {
                ...
                i1 = dnx_sw_state_dump_check_all_the_same(unit,
                    ((dnx_mirror_db_t*)sw_state_roots_array[unit][DNX_MIRROR_MODULE_ID])->mirror_on_drop_profile[i0]
                    , sizeof(*((dnx_mirror_db_t*)sw_state_roots_array[unit][DNX_MIRROR_MODULE_ID])->mirror_on_drop_profile[i0]), I1, &s1) ? I1 - 1 : 0;
            }

            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_MIRROR_MODULE_ID, ((dnx_mirror_db_t*)sw_state_roots_array[unit][DNX_MIRROR_MODULE_ID])->mirror_on_drop_profile[i0]))
            {
                LOG_CLI((BSL_META("dnx_mirror_db[]->((dnx_mirror_db_t*)sw_state_roots_array[][DNX_MIRROR_MODULE_ID])->mirror_on_drop_profile[][]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_MIRROR_MODULE_ID, ((dnx_mirror_db_t*)sw_state_roots_array[unit][DNX_MIRROR_MODULE_ID])->mirror_on_drop_profile[i0]) == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                DNX_SW_STATE_PRINT_MONITOR(
                    unit,
                    "dnx_mirror_db[%d]->","((dnx_mirror_db_t*)sw_state_roots_array[%d][DNX_MIRROR_MODULE_ID])->","mirror_on_drop_profile[%s%d][%s%d]: ", s0, i0, s1, i1);
                ...
                dnx_sw_state_print_int(
                    unit,
                    &((dnx_mirror_db_t*)sw_state_roots_array[unit][DNX_MIRROR_MODULE_ID])->mirror_on_drop_profile[i0][i1]);
