...
dnx_sec_db_control_sec_power_down_info_is_powered_down_dump(int  unit,  int  power_down_info_idx_0,  int  is_powered_down_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, SEC_MODULE_ID, ((dnx_sec_t*)sw_state_roots_array[unit][SEC_MODULE_ID])->control_sec.power_down_info[i0].is_powered_down))
            {
                LOG_CLI((BSL_META("dnx_sec_db[]->((dnx_sec_t*)sw_state_roots_array[][SEC_MODULE_ID])->control_sec.power_down_info[].is_powered_down[]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, SEC_MODULE_ID, ((dnx_sec_t*)sw_state_roots_array[unit][SEC_MODULE_ID])->control_sec.power_down_info[i0].is_powered_down) == 0)
            {
                SHR_EXIT();
            }
...
dnx_sec_db_stat_sec_stat_info_value_info_dump(int  unit,  int  stat_info_idx_0,  int  stat_info_idx_1,  int  value_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, SEC_MODULE_ID, ((dnx_sec_t*)sw_state_roots_array[unit][SEC_MODULE_ID])->stat_sec.stat_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, SEC_MODULE_ID, ((dnx_sec_t*)sw_state_roots_array[unit][SEC_MODULE_ID])->stat_sec.stat_info) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, SEC_MODULE_ID, ((dnx_sec_t*)sw_state_roots_array[unit][SEC_MODULE_ID])->stat_sec.stat_info[i0]))
            {
                LOG_CLI((BSL_META("dnx_sec_db[]->((dnx_sec_t*)sw_state_roots_array[][SEC_MODULE_ID])->stat_sec.stat_info[][].value_info[]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, SEC_MODULE_ID, ((dnx_sec_t*)sw_state_roots_array[unit][SEC_MODULE_ID])->stat_sec.stat_info[i0]) == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                if(i2 >= dnx_sw_state_get_nof_elements(unit, SEC_MODULE_ID, ((dnx_sec_t*)sw_state_roots_array[unit][SEC_MODULE_ID])->stat_sec.stat_info[i0][i1].value_info))
                {
                    LOG_CLI((BSL_META("dnx_sec_db[]->((dnx_sec_t*)sw_state_roots_array[][SEC_MODULE_ID])->stat_sec.stat_info[][].value_info[]: ")));
                    LOG_CLI((BSL_META("Invalid index: %d \n"),i2));
                    SHR_EXIT();
                ...
                if(dnx_sw_state_get_nof_elements(unit, SEC_MODULE_ID, ((dnx_sec_t*)sw_state_roots_array[unit][SEC_MODULE_ID])->stat_sec.stat_info[i0][i1].value_info) == 0)
                {
                    SHR_EXIT();
                }
...
dnx_sec_db_wrapper_sec_wrapper_info_subscribed_speed_dump(int  unit,  int  wrapper_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, SEC_MODULE_ID, ((dnx_sec_t*)sw_state_roots_array[unit][SEC_MODULE_ID])->wrapper_sec.wrapper_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, SEC_MODULE_ID, ((dnx_sec_t*)sw_state_roots_array[unit][SEC_MODULE_ID])->wrapper_sec.wrapper_info) == 0)
        {
            SHR_EXIT();
        }
...
dnx_sec_db_wrapper_sec_nif_port_info_sec_port_dump(int  unit,  int  nif_port_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, SEC_MODULE_ID, ((dnx_sec_t*)sw_state_roots_array[unit][SEC_MODULE_ID])->wrapper_sec.nif_port_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, SEC_MODULE_ID, ((dnx_sec_t*)sw_state_roots_array[unit][SEC_MODULE_ID])->wrapper_sec.nif_port_info) == 0)
        {
            SHR_EXIT();
        }
