 ...
 */
int
lif_table_mngr_db_valid_fields_per_no_local_lif_egress_htb_create(int unit, sw_state_htbl_init_info_t *init_info)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_LOG(
        ...
        LIF_TABLE_MNGR_MODULE_ID,
        &((lif_table_mngr_sw_state_t*)sw_state_roots_array[unit][LIF_TABLE_MNGR_MODULE_ID])->valid_fields_per_no_local_lif_egress_htb,
        "lif_table_mngr_db[%d]->valid_fields_per_no_local_lif_egress_htb",
        unit);
 ...
 */
int
lif_table_mngr_db_valid_fields_per_no_local_lif_egress_htb_find(int unit, const int *key, local_lif_info_t *value, uint8 *found)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
lif_table_mngr_db_valid_fields_per_no_local_lif_egress_htb_insert(int unit, const int *key, const local_lif_info_t *value, uint8 *success)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
lif_table_mngr_db_valid_fields_per_no_local_lif_egress_htb_get_next(int unit, SW_STATE_HASH_TABLE_ITER *iter, const int *key, const local_lif_info_t *value)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
lif_table_mngr_db_valid_fields_per_no_local_lif_egress_htb_clear(int unit)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
lif_table_mngr_db_valid_fields_per_no_local_lif_egress_htb_delete(int unit, const int *key)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
lif_table_mngr_db_flow_ingress_virtual_gport_id_set(int unit, dnx_algo_res_t flow_ingress_virtual_gport_id)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    DNX_SW_STATE_SET(
        ...
        dnx_algo_res_t,
        0,
        "lif_table_mngr_db_flow_ingress_virtual_gport_id_set");
    ...
    DNX_SW_STATE_LOG(
        ...
        LIF_TABLE_MNGR_MODULE_ID,
        &flow_ingress_virtual_gport_id,
        "lif_table_mngr_db[%d]->flow_ingress_virtual_gport_id",
        unit);
 ...
 */
int
lif_table_mngr_db_flow_ingress_virtual_gport_id_get(int unit, dnx_algo_res_t *flow_ingress_virtual_gport_id)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    *flow_ingress_virtual_gport_id = ((lif_table_mngr_sw_state_t*)sw_state_roots_array[unit][LIF_TABLE_MNGR_MODULE_ID])->flow_ingress_virtual_gport_id;
    DNX_SW_STATE_LOG(
        unit,
        DNX_SW_STATE_GET_LOGGING,
        BSL_LS_SWSTATEDNX_GET,
 ...
 */
int
lif_table_mngr_db_flow_ingress_virtual_gport_id_create(int unit, dnx_algo_res_create_data_t * data, void *extra_arguments)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
lif_table_mngr_db_flow_ingress_virtual_gport_id_allocate_single(int unit, uint32 flags, void *extra_arguments, int *element)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
lif_table_mngr_db_flow_ingress_virtual_gport_id_free_single(int unit, int element, void *extra_arguments)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
lif_table_mngr_db_flow_ingress_virtual_gport_id_is_allocated(int unit, int element, uint8 *is_allocated)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
lif_table_mngr_db_cbs lif_table_mngr_db = 	{
	...
	,
		...
		lif_table_mngr_db_valid_fields_per_no_local_lif_egress_htb_create,
		lif_table_mngr_db_valid_fields_per_no_local_lif_egress_htb_find,
		lif_table_mngr_db_valid_fields_per_no_local_lif_egress_htb_insert,
		lif_table_mngr_db_valid_fields_per_no_local_lif_egress_htb_get_next,
		lif_table_mngr_db_valid_fields_per_no_local_lif_egress_htb_clear,
		lif_table_mngr_db_valid_fields_per_no_local_lif_egress_htb_delete}
	,
#ifdef BCM_DNX2_SUPPORT
		{
	...
	,
		...
		lif_table_mngr_db_flow_ingress_virtual_gport_id_set,
		lif_table_mngr_db_flow_ingress_virtual_gport_id_get,
		lif_table_mngr_db_flow_ingress_virtual_gport_id_create,
		lif_table_mngr_db_flow_ingress_virtual_gport_id_allocate_single,
		lif_table_mngr_db_flow_ingress_virtual_gport_id_free_single,
		lif_table_mngr_db_flow_ingress_virtual_gport_id_is_allocated}
	}
;
