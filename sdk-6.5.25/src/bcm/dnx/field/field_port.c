    ...
    uint32 field_profile)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_map_port_profile_info_get_dispatch(unit, port_class, &port_profile_info));
    ...
    uint32 field_profile)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_map_port_profile_type_get_dispatch(unit, port_class, &port_profile_type));
