...
const dnxf_init_step_t dnxf_ha_modules_init_deinit_seq[] = {
    ...
    {DNXF_INIT_STEP_HA,                  "HA Init",              soc_dnxf_ha_init,             soc_dnxf_ha_deinit,                  0,                NULL},
    {DNXF_INIT_STEP_SW_STATE,            "SW_State",             soc_dnxf_sw_state_init,       soc_dnxf_sw_state_deinit,            0,                NULL},
...
const dnxf_init_step_t dnxf_soc_init_deinit_seq[] = {
   /* STEP_ID,                          STEP_NAME,             STEP_INIT,                     STEP_DEINIT,                         STEP_FLAGS       SUB_STEP_LIST_PTR     */
    ...
    {DNXF_INIT_STEP_SOC_INFO_LEGACY,   "Soc Info",             soc_dnxf_soc_info_get,         NULL,                                0,               NULL},
#ifdef ADAPTER_SERVER_MODE
    {DNXF_INIT_STEP_ADAPTER_REG_ACC,   "Adapter",              dnxf_adapter_reg_access_init,  dnxf_adapter_reg_access_deinit,      0,               NULL},
#endif
    {DNXF_INIT_STEP_DEVICE_RESET,      "Device reset",         soc_dnxf_init_device_reset,    soc_dnxf_init_device_reset_deinit,   0,               NULL},
    {DNXF_INIT_STEP_LINK_MAPPING,      "Link Mapping",         soc_dnxf_init_link_mapping,    NULL,                                0,               NULL},
    {DNXF_INIT_STEP_BLOCKS_RESET,      "Blocks Reset",         soc_dnxf_init_blocks_config,   NULL,                                TIME_PER_DEV,    NULL},
    {DNXF_INIT_STEP_COUNTER_ATTACH,    "Counter attach",       soc_dnxf_counter_attach,       soc_dnxf_counter_dettach,            0,               NULL},
    {DNXF_INIT_STEP_INTERRUPTS,        "Interrupts",           soc_dnxf_interrupts_init,      soc_dnxf_interrupts_deinit,          0,               NULL},
    {DNXF_INIT_STEP_SOC_INIT_DONE,     "SOC Init Done",        _soc_dnxf_soc_init_done,       soc_dnxf_soc_init_done_deinit,       0,               NULL},
    {DNXF_INIT_STEP_LAST_STEP,         "Last Step",            NULL,                          NULL,                                0,               NULL}
...
const dnxf_init_step_t dnxf_init_deinit_seq[] = {
  ...
  /*                                                              V                             |                                                       */
    ...
    {DNXF_INIT_STEP_LINKSCAN,          "Linkscan",             dnxf_linkscan_init,            dnxf_linkscan_deinit,               0,                NULL},
    {DNXF_INIT_STEP_STAT,              "Stat",                 dnxf_stat_init,                dnxf_stat_deinit,                   0,                NULL},
    {DNXF_INIT_STEP_STACK,             "Stack",                dnxf_stk_init,                 dnxf_stk_deinit,                    0,                NULL},
    {DNXF_INIT_STEP_MULTICAST,         "Multicast",            dnxf_multicast_init,           dnxf_multicast_deinit,              0,                NULL},
    {DNXF_INIT_STEP_FABRIC,            "Fabric",               dnxf_fabric_init,              dnxf_fabric_deinit,                 TIME_PER_DEV,     NULL},
    {DNXF_INIT_STEP_RX,                "RX",                   dnxf_rx_init,                  dnxf_rx_deinit,                     0,                NULL},
    {DNXF_INIT_STEP_TUNE,              "Tune",                 dnxf_tune_init,                NULL,                               WB_SKIP,          NULL},
    {DNXF_INIT_STEP_INIT_DONE,         "Init Done",            dnxf_init_done_init,           dnxf_init_done_deinit,              0,                NULL},
    {DNXF_INIT_STEP_LAST_STEP,         "Last Step",            NULL,                          NULL,                               0,                NULL}
};
/* *INDENT-ON* */
