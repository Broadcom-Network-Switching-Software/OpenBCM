 ...
 * FE3200 is backward compatible with DNX legacy generation (ARAD).
...
cint_fe3200_interop_example(int unit)
{
    ...
    rv = cint_fe3200_interop(unit, legacy_ports,  nof_legacy_ports, speed, pcs, cl72, remote_pipe_mapping, nof_remote_pipes);
    if (BCM_FAILURE(rv))
    {
