    ...
    bcm_field_presel_t presel_id_ipmf3)
{
     ...
     */
    BCM_IF_ERROR_RETURN(cint_field_outbound_mirror_save_iqm_ipmf1_config(unit, port_profile, presel_id_ipmf1));
    ...
    {
        BCM_IF_ERROR_RETURN(cint_field_outbound_mirror_save_iqm_ipmf3_config(unit, presel_id_ipmf3));
    }
     ...
     */
    BCM_IF_ERROR_RETURN(cint_field_outbound_mirror_save_iqm_ipmf3_config_pst(unit, presel_id_ipmf3));
    ...
    bcm_field_presel_t presel_id)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_context_create(unit, 0, outbound_mirror_save_iqm_stage_ipmf1, &context_info, &outbound_mirror_save_iqm_context_id_ipmf1));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &outbound_mirror_save_iqm_tcam_fg_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, outbound_mirror_save_iqm_tcam_fg_id, outbound_mirror_save_iqm_context_id_ipmf1, &attach_info));
    ...
    bcm_field_presel_t presel_id)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_field_context_create(unit, 0, outbound_mirror_save_iqm_stage_ipmf3, &context_info, &outbound_mirror_save_iqm_context_id_ipmf3));
     ...
     */
    BCM_IF_ERROR_RETURN(bcm_field_action_info_get(unit, bcmFieldActionRepCopy, outbound_mirror_save_iqm_stage_ipmf3, &action_info_get_size));
    ...
    */
    ...
    BCM_IF_ERROR_RETURN(bcm_field_action_create(unit, 0, &action_info, &outbound_mirror_save_iqm_action_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &outbound_mirror_save_iqm_const_fg_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, outbound_mirror_save_iqm_const_fg_id, outbound_mirror_save_iqm_context_id_ipmf3, &attach_info));
    ...
    bcm_field_presel_t presel_id)
{
     ...
     * Get bcmFieldActionRepCopy size for the const field group
     */
    BCM_IF_ERROR_RETURN(bcm_field_action_info_get(unit, bcmFieldActionParsingStartTypeRaw, outbound_mirror_save_iqm_stage_ipmf3, &action_info_get_size));
    ...
    */
     ...
     * Packet was mirrored and not forwarded
     */
    action_info.prefix_value = (0x1D << 1) | 1; /* parsing_start_type=1, parsing_start_type_valid=1 */
    action_info.size = 0;
    action_info.stage = outbound_mirror_save_iqm_stage_ipmf3;
    BCM_IF_ERROR_RETURN(bcm_field_action_create(unit, 0, &action_info, &outbound_mirror_save_iqm_pst_action_id));
    ...
    BCM_IF_ERROR_RETURN(bcm_field_group_add(unit, 0, &fg_info, &outbound_mirror_save_iqm_const_pst_fg_id));
    ...
    attach_info.payload_info.nof_actions = fg_info.nof_actions;
    attach_info.payload_info.action_types[0] = fg_info.action_types[0];
    BCM_IF_ERROR_RETURN(bcm_field_group_context_attach(unit, 0, outbound_mirror_save_iqm_const_pst_fg_id, outbound_mirror_save_iqm_context_id_ipmf3, &attach_info));
    ...
    bcm_gport_t mirror_dest_id)
{
    ...
    BCM_IF_ERROR_RETURN(bcm_mirror_destination_get(unit, mirror_dest_id, &mirror_dest));
     ...
     */
    BCM_IF_ERROR_RETURN(bcm_field_entry_add(unit, 0, outbound_mirror_save_iqm_tcam_fg_id, &entry_info, &outbound_mirror_save_iqm_entry_ids[mirror_id]));
    ...
    bcm_gport_t mirror_dest_id)
{
    ...
    */
    BCM_IF_ERROR_RETURN(bcm_field_entry_delete(unit, outbound_mirror_save_iqm_tcam_fg_id, NULL, outbound_mirror_save_iqm_entry_ids[mirror_id]));
...
int cint_field_outbound_mirror_save_iqm_pmf_config_destroy(
    ...
    bcm_field_presel_t presel_id_ipmf3)
{
    BCM_IF_ERROR_RETURN(cint_field_outbound_mirror_save_iqm_ipmf3_config_destroy(unit, presel_id_ipmf3));
    BCM_IF_ERROR_RETURN(cint_field_outbound_mirror_save_iqm_ipmf1_config_destroy(unit, presel_id_ipmf1));
    ...
    bcm_field_presel_t presel_id)
{
     ...
     */
    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, outbound_mirror_save_iqm_tcam_fg_id, outbound_mirror_save_iqm_context_id_ipmf1));
    printf("TCAM Field Group %d was detach from context %d. \n", outbound_mirror_save_iqm_tcam_fg_id, outbound_mirror_save_iqm_context_id_ipmf1);

    /*
     * Delete the TCAM field group
     */
    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, outbound_mirror_save_iqm_tcam_fg_id));
    printf("TCAM Field Group %d was deleted. \n", outbound_mirror_save_iqm_tcam_fg_id);

    /*
     * Delete the context from ipmf1
     */
    BCM_IF_ERROR_RETURN(bcm_field_context_destroy(unit, outbound_mirror_save_iqm_stage_ipmf1, outbound_mirror_save_iqm_context_id_ipmf1));
    ...
    bcm_field_presel_t presel_id)
{
    ...
    if (outbound_mirror_save_iqm_const_fg_id != BCM_FIELD_ID_INVALID) {
        ...
        */
        BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, outbound_mirror_save_iqm_const_fg_id, outbound_mirror_save_iqm_context_id_ipmf3));
        printf("Const Field Group %d was detach from context %d. \n", outbound_mirror_save_iqm_const_fg_id, outbound_mirror_save_iqm_context_id_ipmf3);

        /*
        * Delete the const field group
        */
        BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, outbound_mirror_save_iqm_const_fg_id));
    ...
    * Detach the const field group from its context
    */
    BCM_IF_ERROR_RETURN(bcm_field_group_context_detach(unit, outbound_mirror_save_iqm_const_pst_fg_id, outbound_mirror_save_iqm_context_id_ipmf3));
    printf("Const Field Group %d was detach from context %d. \n", outbound_mirror_save_iqm_const_pst_fg_id, outbound_mirror_save_iqm_context_id_ipmf3);

    /*
    * Delete the const field group
    */
    BCM_IF_ERROR_RETURN(bcm_field_group_delete(unit, outbound_mirror_save_iqm_const_pst_fg_id));
    printf("Const Field Group %d was deleted. \n", outbound_mirror_save_iqm_const_pst_fg_id);

    /*
     * Delete the context from ipmf3
     */
    BCM_IF_ERROR_RETURN(bcm_field_context_destroy(unit, outbound_mirror_save_iqm_stage_ipmf3, outbound_mirror_save_iqm_context_id_ipmf3));
    printf("Context %d was deleted from IPMF3. \n", outbound_mirror_save_iqm_context_id_ipmf3);

    if (outbound_mirror_save_iqm_action_id != BCM_FIELD_ID_INVALID) {
        BCM_IF_ERROR_RETURN(bcm_field_action_destroy(unit, outbound_mirror_save_iqm_action_id));
    }

    BCM_IF_ERROR_RETURN(bcm_field_action_destroy(unit, outbound_mirror_save_iqm_pst_action_id));
