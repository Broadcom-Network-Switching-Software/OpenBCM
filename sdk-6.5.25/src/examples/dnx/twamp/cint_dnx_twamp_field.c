 ...
 *
 */
int cint_field_twamp_reflector_2nd_pass_set_ipmf1(int unit, int is_ipv6, int is_lag,  
    uint32 local_ip_addr, uint32 remote_ip_addr, 
    bcm_ip6_t *local_ip6_addr, bcm_ip6_t *remote_ip6_addr,
    int ref_mem_link_id1, int ref_mem_link_id2,
    ...
    fg_info.action_types[3] = twamp_reflector_pass_act_id;
    fg_info.action_with_valid_bit[3] = FALSE;
    fg_info.action_types[4] = twamp_reflector_dest_act_id;
    dest_char = &(fg_info.name[0]);
    ...
    for (i = 0; i < ent_nums; i++) {
        ...
        ent_info.entry_action[4].value[0] = gport_fec & 0x3FFFF;
 ...
 *
 */
int cint_field_twamp_reflector_rule(int unit, int is_ipv6, int is_lag,  
    uint32 local_ip_addr, uint32 remote_ip_addr,
    bcm_ip6_t *local_ip6_addr, bcm_ip6_t *remote_ip6_addr,
    int ref_mem_link_id1, int ref_mem_link_id2,
    bcm_gport_t gport_trap1, bcm_gport_t gport_trap2,
    ...
    rv = cint_field_twamp_reflector_2nd_pass_set_ipmf1(unit, is_ipv6, is_lag, local_ip_addr, remote_ip_addr, 
