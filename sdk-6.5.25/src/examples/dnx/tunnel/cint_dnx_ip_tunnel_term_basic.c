 ...
 * 
 ...
 Copyright 2007-2021 Broadcom Inc. All rights reserved. File: cint_ip_tunnel_term_basic.c Purpose: Various examples for IPTunnels.
 */
...
*/
    ...
    rv = l3__egress_only_fec__create(unit, cint_ip_tunnel_basic_info.fec_id,
                                     ...
                                     cint_ip_tunnel_basic_info.arp_id, access_port, 0, BCM_L3_FLAGS2_FWD_ONLY);
