    ...
    int unit)
{
    ...
    BCM_IF_ERROR_RETURN(stif_billing_generate_pp_stat_object(unit, core_id, in_port_core_0, stat_id[0], command_id[0], type_id));
    BCM_IF_ERROR_RETURN(stif_billing_generate_pp_stat_object(unit, core_id, in_port_core_0, stat_id[1], command_id[1], type_id));
    BCM_IF_ERROR_RETURN(stif_billing_generate_pp_stat_object(unit, core_id, in_port_core_0, stat_id[2], command_id[2], type_id));
    if (nof_cores > 1)
    {
        core_id = 1;
        BCM_IF_ERROR_RETURN(stif_billing_generate_pp_stat_object(unit, core_id, in_port_core_1, stat_id[0], command_id[0], type_id));
    }
