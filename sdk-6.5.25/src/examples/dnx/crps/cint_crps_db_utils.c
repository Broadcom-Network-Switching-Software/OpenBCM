    ...
    int is_meter)
{
    ...
    rv = bcm_field_group_add(unit, 0, &fg_info, &fg_id[CRPS_INGRESS_STAT_ID]);
    if (rv != BCM_E_NONE)
    {
    ...
    {
        rv = crps_field_context_create(unit);

        if (rv != BCM_E_NONE)
        {
            printf("Error (%d), in crps_field_context_create\n", rv);
            return rv;
        }
    }
    ...
    crps_trap_stage_t stage)
{
    ...
    if(stage == CRPS_TRAP_STAGE_IRPP)
    {
        ...
        bcm_rx_trap_action_profile_clear(unit,bcmRxTrapEgDiscardFrameTypeFilter);
        if (rv != BCM_E_NONE)
        {
    ...
    int metadata_value)
{
    ...
    rv = bcm_field_group_add(unit, 0, &fg_info, &fg_id[CRPS_INGRESS_META_DATA]);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d), in bcm_field_group_add\n", rv);
        return rv;
    ...
    int *stat_ids)
{
    ...
    rv = bcm_field_group_add(unit, 0, &fg_info, &erpp_fg_id_0);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d), in bcm_field_group_add\n", rv);
        return rv;
    ...
    rv = bcm_field_group_context_attach(unit, 0, erpp_fg_id_0, cint_crps_context_id_epmf, &attach_info);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d), in bcm_field_group_context_attach\n", rv);
        return rv;
    ...
    rv = bcm_field_entry_add(unit, 0, erpp_fg_id_0, &ent_info, &erpp_ent_id_0);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d), in bcm_field_entry_add\n", rv);
        return rv;
    ...
    if (nof_ids == 2)
    {
        ...
        rv = bcm_field_group_add(unit, 0, &fg_info, &erpp_fg_id_1);
        if (rv != BCM_E_NONE)
        {
            printf("Error (%d), in bcm_field_group_add\n", rv);
            return rv;
        }
        rv = bcm_field_group_context_attach(unit, 0, erpp_fg_id_1, cint_crps_context_id_epmf, &attach_info);
        if (rv != BCM_E_NONE)
        {
            printf("Error (%d), in bcm_field_group_context_attach\n", rv);
            return rv;
        ...
        rv = bcm_field_entry_add(unit, 0, erpp_fg_id_0, &ent_info, &erpp_ent_id_1);
        if (rv != BCM_E_NONE)
        {
            printf("Error (%d), in bcm_field_entry_add\n", rv);
            return rv;
    ...
    else
    {
        ...
        rv = bcm_field_action_info_get(unit, (bcmFieldActionStatProfile0 + other_command_id), bcmFieldStageEgress, &action_info_get);
        ...
        rv = bcm_field_action_create(unit, 0, &action_info, &action_disable_counter);
        if(rv != BCM_E_NONE)
        {
        ...
        rv = bcm_field_group_add(unit, 0, &fg_info, &erpp_fg_id_const);
        if (rv != BCM_E_NONE)
        {
            printf("Error (%d), in bcm_field_group_add\n", rv);
            return rv;
        ...
        attach_info.payload_info.nof_actions = fg_info.nof_actions;
        attach_info.payload_info.action_types[0] = fg_info.action_types[0];
        rv = bcm_field_group_context_attach(unit, 0, erpp_fg_id_const, cint_crps_context_id_epmf, &attach_info);
        if (rv != BCM_E_NONE)
        {
            printf("Error (%d), in bcm_field_group_context_attach\n", rv);
            return rv;
                          ...
                          crps_config_field_group_t i)
{
    ...
    if(i  == CRPS_ERPP_STAT_ID)
    {
        ...
        {
            rv = bcm_field_entry_delete(unit, erpp_fg_id_0, NULL, erpp_ent_id_0);
            if (rv != BCM_E_NONE)
            {
                printf("Error (%d), in bcm_field_entry_delete  fg %d \n", rv, erpp_fg_id_0);
                return rv;
            }
            rv = bcm_field_group_context_detach(unit, erpp_fg_id_0, ctx);
            if (rv != BCM_E_NONE)
            {
                printf("Error (%d), in bcm_field_group_context_detach fg %d from context %d stage %s\n", rv, erpp_fg_id_0, 0);
                return rv;
            }
            rv = bcm_field_group_delete(unit, erpp_fg_id_0);
            if (rv != BCM_E_NONE)
            {
        ...
        {
            rv = bcm_field_entry_delete(unit, erpp_fg_id_1, NULL, erpp_ent_id_1);
            if (rv != BCM_E_NONE)
            {
                printf("Error (%d), in bcm_field_entry_delete  fg %d \n", rv, erpp_fg_id_1);
                return rv;
            }
            rv = bcm_field_group_context_detach(unit, erpp_fg_id_1, ctx);
            if (rv != BCM_E_NONE)
            {
                printf("Error (%d), in bcm_field_group_context_detach fg %d from context %d stage %s\n", rv, erpp_fg_id_1, 0);
                return rv;
            }
            rv = bcm_field_group_delete(unit, erpp_fg_id_1);
            if (rv != BCM_E_NONE)
            {
                printf("Error (%d), in bcm_field_group_delete  fg %d \n", rv, erpp_fg_id_1);
                return rv;
        ...
        {
            rv = bcm_field_group_context_detach(unit, erpp_fg_id_const, ctx);
            if (rv != BCM_E_NONE)
            {
                printf("Error (%d), in bcm_field_group_context_detach fg %d from context %d stage %s\n", rv, erpp_fg_id_const, 0);
                return rv;
            }
            rv = bcm_field_group_delete(unit, erpp_fg_id_const);
            if (rv != BCM_E_NONE)
            {
                printf("Error (%d), in bcm_field_group_delete  fg %d \n", rv, erpp_fg_id_const);
                return rv;
            ...
            rv = bcm_field_action_destroy(unit, action_disable_counter);
            if (rv != BCM_E_NONE)
            {
