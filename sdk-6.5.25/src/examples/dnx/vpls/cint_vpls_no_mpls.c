 ...
 * 
 ...
 Copyright 2007-2021 Broadcom Inc. All rights reserved. File: cint_vpls_no_mpls.c Purpose: utility for VPLS without MPLS.
 */
    ...
    int port2)
{
     ...
     * Configure fec entry 
     */
    rv = l3__egress_only_fec__create(unit, ac_port.encap_fec_id, 0, pwe_port.arp, pwe_port.port, mpls_tunnel_in_eei?BCM_L3_ENCAP_SPACE_OPTIMIZED:0,0);
    if (rv != BCM_E_NONE)
    {
