/* $Id: cint_dnx_vswitch_cross_connect_p2p_ac_pwe.c,
 ...
 * cint ../../../../src/examples/dnx/utility/cint_dnx_utils_vpws.c                                                                                *
 * cint ../../../../src/examples/dnx/cint_dnx_ip_route_basic.c                                                                                         *
 * cint ../../../../src/examples/dnx/cint_dnx_advanced_vlan_translation_mode.c                                                                          *
 * cint ../../../../src/examples/dnx/vpls/cint_dnx_vswitch_cross_connect_p2p_ac_pwe.c                                                                       *
 * cint                                                                                                                                             *
 * int unit = 0;                                                                                                                                    *
 * int rv = 0;                                                                                                                                      *
 * int port1 = 200;                                                                                                                                 *
    ...
    vswitch_cross_connect_p2p_ac_pwe_s * param)
{
    ...
    rv = get_first_fec_in_range_which_not_in_ecmp_range(unit, 0, 0, &cint_pwe_basic_info.mpls_encap_fec_id);
    if (rv != BCM_E_NONE)
    {
    ...
    vswitch_cross_connect_p2p_ac_pwe_s * param)
{
    ...
    cint_pwe_basic_info.mpls_port_id_egress = 18879;
    cint_pwe_basic_info.encap_id = 18879;
    cint_pwe_basic_info.core_arp_id = 12292;
    cint_pwe_basic_info.mpls_encap_fec_id += 6;
    cint_pwe_basic_info.pwe_arp_next_hop_mac = da;
    cint_pwe_basic_info.mpls_tunnel_id = 58391;
    ...
    */
    ...
    if ((*dnxc_data_get(unit, "dev_init", "general", "application_v2", NULL)) == 1)
    {
        return rv;
    }
