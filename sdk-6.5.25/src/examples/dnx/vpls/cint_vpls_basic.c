    ...
    int extend_example)
{
    ...
    if (extend_example)
    {
        ...
        mpls_encap_tunnel_1[1].encap_access = bcmEncapAccessTunnel2;
        ...
        pwe_encap_2.encap_access = bcmEncapAccessTunnel1;
...
{
    int rv = BCM_E_NONE;
    int estimate_encap_size_required = *dnxc_data_get(rx_unit, "dev_init", "general", "egress_estimated_bta_btr_config", NULL);
    int first_fec_in_hier;
