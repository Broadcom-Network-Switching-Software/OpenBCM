 ...
 * 
 ...
 Copyright 2007-2021 Broadcom Inc. All rights reserved. File: cint_dnx_utils_vpls.c Purpose: utility for VPLS. 
 */
    ...
    int unit)
{
    ...
    estimate_encap_size_required = *dnxc_data_get(unit, "dev_init", "general", "egress_estimated_bta_btr_config", NULL);
    ...
    mpls_tunnel_initiator_create_s * mpls_tunnel)
{
    ...
    estimate_encap_size_required = estimate_encap_size_required = *dnxc_data_get(unit, "dev_init", "general", "egress_estimated_bta_btr_config", NULL);
