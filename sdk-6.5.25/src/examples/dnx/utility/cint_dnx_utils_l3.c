...
void dnx_utils_l3_host_ipv4_s_common_init(int unit, uint32 flags, dnx_utils_l3_host_ipv4_s *host_ipv4_structure, bcm_ip_t addr, bcm_vrf_t vrf, uint32 l3_flags, uint32 l3_flags2, bcm_if_t fec_id)
{
