    ...
    sh_sand_control_t * sand_control)
{
    ...
    (int) diag_sand_reg_get_all(unit, 1, NULL);
...
sh_sand_cmd_t sh_dnxc_techsupport_cmds[] = {
     ...
     */
    {"init", techsupport_init_cmd, NULL, NULL, &techsupport_init_man, NULL, NULL, SH_CMD_SKIP_EXEC},
    {"tm", techsupport_tm_cmd, NULL, NULL, &techsupport_tm_man, NULL, NULL, SH_CMD_SKIP_EXEC},
    {NULL}
};
/* *INDENT-ON* */
