    ...
    int *num_of_counters)
{
    ...
    nof_counters_in_a_engine = (dnx_data_crps.engine.engines_info_get(unit, 0)->nof_counters) * 2;
    nof_counters_in_b_engine = (dnx_data_crps.engine.engines_info_get(unit, first_b_engine_id)->nof_counters) * 2;
    nof_counters_in_c_engine = (dnx_data_crps.engine.engines_info_get(unit, first_c_engine_id)->nof_counters) * 2;
...
{                                                                                                    \
    ...
    nof_of_counter_c_engine = dnx_data_crps.engine.engines_info_get(unit, first_c_engine_id)->nof_counters;
