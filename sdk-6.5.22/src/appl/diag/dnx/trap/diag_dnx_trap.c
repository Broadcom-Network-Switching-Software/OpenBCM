...
shr_error_e
diag_dnx_rx_trap_eth_inrif_create_example(
    int unit,
    bcm_if_t * rif_p)
{
    ...
    l3if.l3a_intf_id = l3if.l3a_vid = 20;
    /*
...
sh_sand_cmd_t sh_dnx_trap_cmds[] = {
    ...
    ,
    {"PRoGram", NULL, sh_dnx_trap_prog_cmds, NULL, &sh_dnx_trap_prog_man, NULL, NULL, SH_CMD_NO_XML_VERIFY}
    ,
    {"PRoTocol", NULL, sh_dnx_trap_protocol_cmds, NULL, &sh_dnx_trap_protocol_man, NULL, NULL, SH_CMD_NO_XML_VERIFY}
    ,
    {"MTU", NULL, sh_dnx_trap_mtu_cmds, NULL, &sh_dnx_trap_mtu_cmd_man, NULL, NULL, SH_CMD_NO_XML_VERIFY}
    ,
    {"LIF", sh_dnx_trap_lif_cmd, NULL, NULL, &sh_dnx_trap_lif_cmd_man, NULL, NULL, SH_CMD_NO_XML_VERIFY}
    ,
    {"LAST", NULL, sh_dnx_trap_last_pkt_cmds, NULL, &sh_dnx_trap_last_pkt_man}
    ,
    {"SVTag", sh_dnx_trap_svtag_cmd, NULL, NULL, &sh_dnx_trap_svtag_cmd_man, NULL, NULL, SH_CMD_NO_XML_VERIFY}
    ,
    {NULL}
};
