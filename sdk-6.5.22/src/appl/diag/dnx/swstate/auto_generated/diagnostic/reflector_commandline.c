...
sh_sand_cmd_t sh_dnx_swstate_reflector_cmds[] = {
    ...
    {"uc_l2_int", NULL, sh_dnx_swstate_reflector_uc_l2_int_cmds, NULL, &dnx_swstate_reflector_uc_l2_int_man},
    {"uc_l2_int_onepass", NULL, sh_dnx_swstate_reflector_uc_l2_int_onepass_cmds, NULL, &dnx_swstate_reflector_uc_l2_int_onepass_man},
...
sh_sand_cmd_t sh_dnx_swstate_reflector_uc_l2_int_cmds[] = {
    {"encap_id", NULL, sh_dnx_swstate_reflector_uc_l2_int_encap_id_cmds, NULL, &dnx_swstate_reflector_uc_l2_int_encap_id_man},
    {"is_allocated", NULL, sh_dnx_swstate_reflector_uc_l2_int_is_allocated_cmds, NULL, &dnx_swstate_reflector_uc_l2_int_is_allocated_man},
    {"dump", sh_dnx_swstate_reflector_uc_l2_int_dump_cmd, NULL, dnx_swstate_reflector_uc_l2_int_dump_options, &dnx_swstate_reflector_uc_l2_int_dump_man},
    {"size_get", sh_dnx_swstate_reflector_uc_l2_int_size_get_cmd, NULL, dnx_swstate_reflector_uc_l2_int_size_get_options, &dnx_swstate_reflector_uc_l2_int_size_get_man},
    {"diagnostic_operation_counters", sh_dnx_swstate_reflector_uc_l2_int_diagnostic_operation_counters_cmd, NULL, dnx_swstate_reflector_uc_l2_int_diagnostic_operation_counters_options, &dnx_swstate_reflector_uc_l2_int_diagnostic_operation_counters_man},
    {NULL}
};


sh_sand_man_t dnx_swstate_reflector_uc_l2_int_man = {
    cmd_dnx_swstate_reflector_uc_l2_int_desc,
    NULL,
    NULL,
    NULL,
};
...
const char cmd_dnx_swstate_reflector_uc_l2_int_desc[] = "reflector_sw_db_info uc_l2_int commands";
...
sh_sand_option_t dnx_swstate_reflector_uc_l2_int_dump_options[] = {
    {"nocontent",      SAL_FIELD_TYPE_BOOL, "Decision if to perform content dump or to print the access tree.",  "false"},
    {"typefilter",     SAL_FIELD_TYPE_STR,  "Filter for the variable type.",         ""},
    {"namefilter",     SAL_FIELD_TYPE_STR,  "Filter for the variable name.",         ""},
    {NULL}
...
sh_sand_man_t dnx_swstate_reflector_uc_l2_int_dump_man = {
    "swstate dump",
    "print the variable value",
    "reflector_sw_db_info uc_l2_int dump []\n",
    "reflector_sw_db_info uc_l2_int dump nocontent=false typefilter="" namefilter="" ",
};
...
shr_error_e sh_dnx_swstate_reflector_uc_l2_int_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(reflector_sw_db_info_info[unit], reflector_sw_db_info_layout_str, REFLECTOR_SW_DB_INFO_INFO_NOF_ENTRIES, "REFLECTOR_SW_DB_INFO~UC_L2_INT~", sizeof(((reflector_sw_db_info_t*)sw_state_roots_array[unit][REFLECTOR_MODULE_ID])->uc_l2_int));
    dnx_sw_state_size_print(size);
...
sh_sand_option_t dnx_swstate_reflector_uc_l2_int_size_get_options[] = {
    {NULL}
};


sh_sand_man_t dnx_swstate_reflector_uc_l2_int_size_get_man = {
    "swstate size_get",
    "print the variable size",
    "reflector_sw_db_info uc_l2_int size_get",
    "reflector_sw_db_info uc_l2_int size_get",
};
...
shr_error_e sh_dnx_swstate_reflector_uc_l2_int_diagnostic_operation_counters_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    dnx_sw_state_diagnostic_operation_counters_print(reflector_sw_db_info_info[unit], reflector_sw_db_info_layout_str, REFLECTOR_SW_DB_INFO_INFO_NOF_ENTRIES, "REFLECTOR_SW_DB_INFO~UC_L2_INT~");
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
sh_sand_option_t dnx_swstate_reflector_uc_l2_int_diagnostic_operation_counters_options[] = {
    {NULL}
};


sh_sand_man_t dnx_swstate_reflector_uc_l2_int_diagnostic_operation_counters_man = {
    "swstate diagnostic_operation_counters",
    "print the diagnostic operation counters",
    "reflector_sw_db_info uc_l2_int diagnostic_operation_counters",
    "reflector_sw_db_info uc_l2_int diagnostic_operation_counters",
};



sh_sand_cmd_t sh_dnx_swstate_reflector_uc_l2_int_encap_id_cmds[] = {
    {"dump", sh_dnx_swstate_reflector_uc_l2_int_encap_id_dump_cmd, NULL, dnx_swstate_reflector_uc_l2_int_encap_id_dump_options, &dnx_swstate_reflector_uc_l2_int_encap_id_dump_man},
    {"size_get", sh_dnx_swstate_reflector_uc_l2_int_encap_id_size_get_cmd, NULL, dnx_swstate_reflector_uc_l2_int_encap_id_size_get_options, &dnx_swstate_reflector_uc_l2_int_encap_id_size_get_man},
    {"diagnostic_operation_counters", sh_dnx_swstate_reflector_uc_l2_int_encap_id_diagnostic_operation_counters_cmd, NULL, dnx_swstate_reflector_uc_l2_int_encap_id_diagnostic_operation_counters_options, &dnx_swstate_reflector_uc_l2_int_encap_id_diagnostic_operation_counters_man},
    {NULL}
};


sh_sand_man_t dnx_swstate_reflector_uc_l2_int_encap_id_man = {
    cmd_dnx_swstate_reflector_uc_l2_int_encap_id_desc,
    NULL,
    NULL,
    NULL,
};
...
const char cmd_dnx_swstate_reflector_uc_l2_int_encap_id_desc[] = "reflector_sw_db_info uc_l2_int encap_id commands";
...
sh_sand_option_t dnx_swstate_reflector_uc_l2_int_encap_id_dump_options[] = {
    {"nocontent",      SAL_FIELD_TYPE_BOOL, "Decision if to perform content dump or to print the access tree.",  "false"},
    {"typefilter",     SAL_FIELD_TYPE_STR,  "Filter for the variable type.",         ""},
    {"namefilter",     SAL_FIELD_TYPE_STR,  "Filter for the variable name.",         ""},
    {NULL}
...
sh_sand_man_t dnx_swstate_reflector_uc_l2_int_encap_id_dump_man = {
    "swstate dump",
    "print the variable value",
    "reflector_sw_db_info uc_l2_int encap_id dump []\n",
    "reflector_sw_db_info uc_l2_int encap_id dump nocontent=false typefilter="" namefilter="" ",
};
...
shr_error_e sh_dnx_swstate_reflector_uc_l2_int_encap_id_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(reflector_sw_db_info_info[unit], reflector_sw_db_info_layout_str, REFLECTOR_SW_DB_INFO_INFO_NOF_ENTRIES, "REFLECTOR_SW_DB_INFO~UC_L2_INT~ENCAP_ID~", sizeof(((reflector_sw_db_info_t*)sw_state_roots_array[unit][REFLECTOR_MODULE_ID])->uc_l2_int.encap_id));
    dnx_sw_state_size_print(size);
...
sh_sand_option_t dnx_swstate_reflector_uc_l2_int_encap_id_size_get_options[] = {
    {NULL}
};


sh_sand_man_t dnx_swstate_reflector_uc_l2_int_encap_id_size_get_man = {
    "swstate size_get",
    "print the variable size",
    "reflector_sw_db_info uc_l2_int encap_id size_get",
    "reflector_sw_db_info uc_l2_int encap_id size_get",
};
...
shr_error_e sh_dnx_swstate_reflector_uc_l2_int_encap_id_diagnostic_operation_counters_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    dnx_sw_state_diagnostic_operation_counters_print(reflector_sw_db_info_info[unit], reflector_sw_db_info_layout_str, REFLECTOR_SW_DB_INFO_INFO_NOF_ENTRIES, "REFLECTOR_SW_DB_INFO~UC_L2_INT~ENCAP_ID~");
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
sh_sand_option_t dnx_swstate_reflector_uc_l2_int_encap_id_diagnostic_operation_counters_options[] = {
    {NULL}
};


sh_sand_man_t dnx_swstate_reflector_uc_l2_int_encap_id_diagnostic_operation_counters_man = {
    "swstate diagnostic_operation_counters",
    "print the diagnostic operation counters",
    "reflector_sw_db_info uc_l2_int encap_id diagnostic_operation_counters",
    "reflector_sw_db_info uc_l2_int encap_id diagnostic_operation_counters",
};



sh_sand_cmd_t sh_dnx_swstate_reflector_uc_l2_int_is_allocated_cmds[] = {
    {"dump", sh_dnx_swstate_reflector_uc_l2_int_is_allocated_dump_cmd, NULL, dnx_swstate_reflector_uc_l2_int_is_allocated_dump_options, &dnx_swstate_reflector_uc_l2_int_is_allocated_dump_man},
    {"size_get", sh_dnx_swstate_reflector_uc_l2_int_is_allocated_size_get_cmd, NULL, dnx_swstate_reflector_uc_l2_int_is_allocated_size_get_options, &dnx_swstate_reflector_uc_l2_int_is_allocated_size_get_man},
    {"diagnostic_operation_counters", sh_dnx_swstate_reflector_uc_l2_int_is_allocated_diagnostic_operation_counters_cmd, NULL, dnx_swstate_reflector_uc_l2_int_is_allocated_diagnostic_operation_counters_options, &dnx_swstate_reflector_uc_l2_int_is_allocated_diagnostic_operation_counters_man},
    {NULL}
};


sh_sand_man_t dnx_swstate_reflector_uc_l2_int_is_allocated_man = {
    cmd_dnx_swstate_reflector_uc_l2_int_is_allocated_desc,
    NULL,
    NULL,
    NULL,
};
...
const char cmd_dnx_swstate_reflector_uc_l2_int_is_allocated_desc[] = "reflector_sw_db_info uc_l2_int is_allocated commands";
...
sh_sand_option_t dnx_swstate_reflector_uc_l2_int_is_allocated_dump_options[] = {
    {"nocontent",      SAL_FIELD_TYPE_BOOL, "Decision if to perform content dump or to print the access tree.",  "false"},
    {"typefilter",     SAL_FIELD_TYPE_STR,  "Filter for the variable type.",         ""},
    {"namefilter",     SAL_FIELD_TYPE_STR,  "Filter for the variable name.",         ""},
    {NULL}
...
sh_sand_man_t dnx_swstate_reflector_uc_l2_int_is_allocated_dump_man = {
    "swstate dump",
    "print the variable value",
    "reflector_sw_db_info uc_l2_int is_allocated dump []\n",
    "reflector_sw_db_info uc_l2_int is_allocated dump nocontent=false typefilter="" namefilter="" ",
};
...
shr_error_e sh_dnx_swstate_reflector_uc_l2_int_is_allocated_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(reflector_sw_db_info_info[unit], reflector_sw_db_info_layout_str, REFLECTOR_SW_DB_INFO_INFO_NOF_ENTRIES, "REFLECTOR_SW_DB_INFO~UC_L2_INT~IS_ALLOCATED~", sizeof(((reflector_sw_db_info_t*)sw_state_roots_array[unit][REFLECTOR_MODULE_ID])->uc_l2_int.is_allocated));
    dnx_sw_state_size_print(size);
...
sh_sand_option_t dnx_swstate_reflector_uc_l2_int_is_allocated_size_get_options[] = {
    {NULL}
};


sh_sand_man_t dnx_swstate_reflector_uc_l2_int_is_allocated_size_get_man = {
    "swstate size_get",
    "print the variable size",
    "reflector_sw_db_info uc_l2_int is_allocated size_get",
    "reflector_sw_db_info uc_l2_int is_allocated size_get",
};
...
shr_error_e sh_dnx_swstate_reflector_uc_l2_int_is_allocated_diagnostic_operation_counters_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    dnx_sw_state_diagnostic_operation_counters_print(reflector_sw_db_info_info[unit], reflector_sw_db_info_layout_str, REFLECTOR_SW_DB_INFO_INFO_NOF_ENTRIES, "REFLECTOR_SW_DB_INFO~UC_L2_INT~IS_ALLOCATED~");
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
sh_sand_option_t dnx_swstate_reflector_uc_l2_int_is_allocated_diagnostic_operation_counters_options[] = {
    {NULL}
};


sh_sand_man_t dnx_swstate_reflector_uc_l2_int_is_allocated_diagnostic_operation_counters_man = {
    "swstate diagnostic_operation_counters",
    "print the diagnostic operation counters",
    "reflector_sw_db_info uc_l2_int is_allocated diagnostic_operation_counters",
    "reflector_sw_db_info uc_l2_int is_allocated diagnostic_operation_counters",
};



sh_sand_cmd_t sh_dnx_swstate_reflector_uc_l2_int_onepass_cmds[] = {
    {"encap_id", NULL, sh_dnx_swstate_reflector_uc_l2_int_onepass_encap_id_cmds, NULL, &dnx_swstate_reflector_uc_l2_int_onepass_encap_id_man},
    {"is_allocated", NULL, sh_dnx_swstate_reflector_uc_l2_int_onepass_is_allocated_cmds, NULL, &dnx_swstate_reflector_uc_l2_int_onepass_is_allocated_man},
    {"dump", sh_dnx_swstate_reflector_uc_l2_int_onepass_dump_cmd, NULL, dnx_swstate_reflector_uc_l2_int_onepass_dump_options, &dnx_swstate_reflector_uc_l2_int_onepass_dump_man},
    {"size_get", sh_dnx_swstate_reflector_uc_l2_int_onepass_size_get_cmd, NULL, dnx_swstate_reflector_uc_l2_int_onepass_size_get_options, &dnx_swstate_reflector_uc_l2_int_onepass_size_get_man},
    {"diagnostic_operation_counters", sh_dnx_swstate_reflector_uc_l2_int_onepass_diagnostic_operation_counters_cmd, NULL, dnx_swstate_reflector_uc_l2_int_onepass_diagnostic_operation_counters_options, &dnx_swstate_reflector_uc_l2_int_onepass_diagnostic_operation_counters_man},
    {NULL}
};


sh_sand_man_t dnx_swstate_reflector_uc_l2_int_onepass_man = {
    cmd_dnx_swstate_reflector_uc_l2_int_onepass_desc,
    NULL,
    NULL,
    NULL,
};
...
const char cmd_dnx_swstate_reflector_uc_l2_int_onepass_desc[] = "reflector_sw_db_info uc_l2_int_onepass commands";
...
sh_sand_option_t dnx_swstate_reflector_uc_l2_int_onepass_dump_options[] = {
    {"nocontent",      SAL_FIELD_TYPE_BOOL, "Decision if to perform content dump or to print the access tree.",  "false"},
    {"typefilter",     SAL_FIELD_TYPE_STR,  "Filter for the variable type.",         ""},
    {"namefilter",     SAL_FIELD_TYPE_STR,  "Filter for the variable name.",         ""},
    {NULL}
...
sh_sand_man_t dnx_swstate_reflector_uc_l2_int_onepass_dump_man = {
    "swstate dump",
    "print the variable value",
    "reflector_sw_db_info uc_l2_int_onepass dump []\n",
    "reflector_sw_db_info uc_l2_int_onepass dump nocontent=false typefilter="" namefilter="" ",
};
...
shr_error_e sh_dnx_swstate_reflector_uc_l2_int_onepass_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(reflector_sw_db_info_info[unit], reflector_sw_db_info_layout_str, REFLECTOR_SW_DB_INFO_INFO_NOF_ENTRIES, "REFLECTOR_SW_DB_INFO~UC_L2_INT_ONEPASS~", sizeof(((reflector_sw_db_info_t*)sw_state_roots_array[unit][REFLECTOR_MODULE_ID])->uc_l2_int_onepass));
    dnx_sw_state_size_print(size);
...
sh_sand_option_t dnx_swstate_reflector_uc_l2_int_onepass_size_get_options[] = {
    {NULL}
};


sh_sand_man_t dnx_swstate_reflector_uc_l2_int_onepass_size_get_man = {
    "swstate size_get",
    "print the variable size",
    "reflector_sw_db_info uc_l2_int_onepass size_get",
    "reflector_sw_db_info uc_l2_int_onepass size_get",
};
...
shr_error_e sh_dnx_swstate_reflector_uc_l2_int_onepass_diagnostic_operation_counters_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    dnx_sw_state_diagnostic_operation_counters_print(reflector_sw_db_info_info[unit], reflector_sw_db_info_layout_str, REFLECTOR_SW_DB_INFO_INFO_NOF_ENTRIES, "REFLECTOR_SW_DB_INFO~UC_L2_INT_ONEPASS~");
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
sh_sand_option_t dnx_swstate_reflector_uc_l2_int_onepass_diagnostic_operation_counters_options[] = {
    {NULL}
};


sh_sand_man_t dnx_swstate_reflector_uc_l2_int_onepass_diagnostic_operation_counters_man = {
    "swstate diagnostic_operation_counters",
    "print the diagnostic operation counters",
    "reflector_sw_db_info uc_l2_int_onepass diagnostic_operation_counters",
    "reflector_sw_db_info uc_l2_int_onepass diagnostic_operation_counters",
};



sh_sand_cmd_t sh_dnx_swstate_reflector_uc_l2_int_onepass_encap_id_cmds[] = {
    {"dump", sh_dnx_swstate_reflector_uc_l2_int_onepass_encap_id_dump_cmd, NULL, dnx_swstate_reflector_uc_l2_int_onepass_encap_id_dump_options, &dnx_swstate_reflector_uc_l2_int_onepass_encap_id_dump_man},
    {"size_get", sh_dnx_swstate_reflector_uc_l2_int_onepass_encap_id_size_get_cmd, NULL, dnx_swstate_reflector_uc_l2_int_onepass_encap_id_size_get_options, &dnx_swstate_reflector_uc_l2_int_onepass_encap_id_size_get_man},
    {"diagnostic_operation_counters", sh_dnx_swstate_reflector_uc_l2_int_onepass_encap_id_diagnostic_operation_counters_cmd, NULL, dnx_swstate_reflector_uc_l2_int_onepass_encap_id_diagnostic_operation_counters_options, &dnx_swstate_reflector_uc_l2_int_onepass_encap_id_diagnostic_operation_counters_man},
    {NULL}
};


sh_sand_man_t dnx_swstate_reflector_uc_l2_int_onepass_encap_id_man = {
    cmd_dnx_swstate_reflector_uc_l2_int_onepass_encap_id_desc,
    NULL,
    NULL,
    NULL,
};
...
const char cmd_dnx_swstate_reflector_uc_l2_int_onepass_encap_id_desc[] = "reflector_sw_db_info uc_l2_int_onepass encap_id commands";
...
sh_sand_option_t dnx_swstate_reflector_uc_l2_int_onepass_encap_id_dump_options[] = {
    {"nocontent",      SAL_FIELD_TYPE_BOOL, "Decision if to perform content dump or to print the access tree.",  "false"},
    {"typefilter",     SAL_FIELD_TYPE_STR,  "Filter for the variable type.",         ""},
    {"namefilter",     SAL_FIELD_TYPE_STR,  "Filter for the variable name.",         ""},
    {NULL}
...
sh_sand_man_t dnx_swstate_reflector_uc_l2_int_onepass_encap_id_dump_man = {
    "swstate dump",
    "print the variable value",
    "reflector_sw_db_info uc_l2_int_onepass encap_id dump []\n",
    "reflector_sw_db_info uc_l2_int_onepass encap_id dump nocontent=false typefilter="" namefilter="" ",
};
...
shr_error_e sh_dnx_swstate_reflector_uc_l2_int_onepass_encap_id_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(reflector_sw_db_info_info[unit], reflector_sw_db_info_layout_str, REFLECTOR_SW_DB_INFO_INFO_NOF_ENTRIES, "REFLECTOR_SW_DB_INFO~UC_L2_INT_ONEPASS~ENCAP_ID~", sizeof(((reflector_sw_db_info_t*)sw_state_roots_array[unit][REFLECTOR_MODULE_ID])->uc_l2_int_onepass.encap_id));
    dnx_sw_state_size_print(size);
...
sh_sand_option_t dnx_swstate_reflector_uc_l2_int_onepass_encap_id_size_get_options[] = {
    {NULL}
};


sh_sand_man_t dnx_swstate_reflector_uc_l2_int_onepass_encap_id_size_get_man = {
    "swstate size_get",
    "print the variable size",
    "reflector_sw_db_info uc_l2_int_onepass encap_id size_get",
    "reflector_sw_db_info uc_l2_int_onepass encap_id size_get",
};
...
shr_error_e sh_dnx_swstate_reflector_uc_l2_int_onepass_encap_id_diagnostic_operation_counters_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    dnx_sw_state_diagnostic_operation_counters_print(reflector_sw_db_info_info[unit], reflector_sw_db_info_layout_str, REFLECTOR_SW_DB_INFO_INFO_NOF_ENTRIES, "REFLECTOR_SW_DB_INFO~UC_L2_INT_ONEPASS~ENCAP_ID~");
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
sh_sand_option_t dnx_swstate_reflector_uc_l2_int_onepass_encap_id_diagnostic_operation_counters_options[] = {
    {NULL}
};


sh_sand_man_t dnx_swstate_reflector_uc_l2_int_onepass_encap_id_diagnostic_operation_counters_man = {
    "swstate diagnostic_operation_counters",
    "print the diagnostic operation counters",
    "reflector_sw_db_info uc_l2_int_onepass encap_id diagnostic_operation_counters",
    "reflector_sw_db_info uc_l2_int_onepass encap_id diagnostic_operation_counters",
};



sh_sand_cmd_t sh_dnx_swstate_reflector_uc_l2_int_onepass_is_allocated_cmds[] = {
    {"dump", sh_dnx_swstate_reflector_uc_l2_int_onepass_is_allocated_dump_cmd, NULL, dnx_swstate_reflector_uc_l2_int_onepass_is_allocated_dump_options, &dnx_swstate_reflector_uc_l2_int_onepass_is_allocated_dump_man},
    {"size_get", sh_dnx_swstate_reflector_uc_l2_int_onepass_is_allocated_size_get_cmd, NULL, dnx_swstate_reflector_uc_l2_int_onepass_is_allocated_size_get_options, &dnx_swstate_reflector_uc_l2_int_onepass_is_allocated_size_get_man},
    {"diagnostic_operation_counters", sh_dnx_swstate_reflector_uc_l2_int_onepass_is_allocated_diagnostic_operation_counters_cmd, NULL, dnx_swstate_reflector_uc_l2_int_onepass_is_allocated_diagnostic_operation_counters_options, &dnx_swstate_reflector_uc_l2_int_onepass_is_allocated_diagnostic_operation_counters_man},
    {NULL}
};


sh_sand_man_t dnx_swstate_reflector_uc_l2_int_onepass_is_allocated_man = {
    cmd_dnx_swstate_reflector_uc_l2_int_onepass_is_allocated_desc,
    NULL,
    NULL,
    NULL,
};
...
const char cmd_dnx_swstate_reflector_uc_l2_int_onepass_is_allocated_desc[] = "reflector_sw_db_info uc_l2_int_onepass is_allocated commands";
...
sh_sand_option_t dnx_swstate_reflector_uc_l2_int_onepass_is_allocated_dump_options[] = {
    {"nocontent",      SAL_FIELD_TYPE_BOOL, "Decision if to perform content dump or to print the access tree.",  "false"},
    {"typefilter",     SAL_FIELD_TYPE_STR,  "Filter for the variable type.",         ""},
    {"namefilter",     SAL_FIELD_TYPE_STR,  "Filter for the variable name.",         ""},
    {NULL}
...
sh_sand_man_t dnx_swstate_reflector_uc_l2_int_onepass_is_allocated_dump_man = {
    "swstate dump",
    "print the variable value",
    "reflector_sw_db_info uc_l2_int_onepass is_allocated dump []\n",
    "reflector_sw_db_info uc_l2_int_onepass is_allocated dump nocontent=false typefilter="" namefilter="" ",
};
...
shr_error_e sh_dnx_swstate_reflector_uc_l2_int_onepass_is_allocated_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(reflector_sw_db_info_info[unit], reflector_sw_db_info_layout_str, REFLECTOR_SW_DB_INFO_INFO_NOF_ENTRIES, "REFLECTOR_SW_DB_INFO~UC_L2_INT_ONEPASS~IS_ALLOCATED~", sizeof(((reflector_sw_db_info_t*)sw_state_roots_array[unit][REFLECTOR_MODULE_ID])->uc_l2_int_onepass.is_allocated));
    dnx_sw_state_size_print(size);
...
sh_sand_option_t dnx_swstate_reflector_uc_l2_int_onepass_is_allocated_size_get_options[] = {
    {NULL}
};


sh_sand_man_t dnx_swstate_reflector_uc_l2_int_onepass_is_allocated_size_get_man = {
    "swstate size_get",
    "print the variable size",
    "reflector_sw_db_info uc_l2_int_onepass is_allocated size_get",
    "reflector_sw_db_info uc_l2_int_onepass is_allocated size_get",
};
...
shr_error_e sh_dnx_swstate_reflector_uc_l2_int_onepass_is_allocated_diagnostic_operation_counters_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    dnx_sw_state_diagnostic_operation_counters_print(reflector_sw_db_info_info[unit], reflector_sw_db_info_layout_str, REFLECTOR_SW_DB_INFO_INFO_NOF_ENTRIES, "REFLECTOR_SW_DB_INFO~UC_L2_INT_ONEPASS~IS_ALLOCATED~");
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
sh_sand_option_t dnx_swstate_reflector_uc_l2_int_onepass_is_allocated_diagnostic_operation_counters_options[] = {
    {NULL}
};


sh_sand_man_t dnx_swstate_reflector_uc_l2_int_onepass_is_allocated_diagnostic_operation_counters_man = {
    "swstate diagnostic_operation_counters",
    "print the diagnostic operation counters",
    "reflector_sw_db_info uc_l2_int_onepass is_allocated diagnostic_operation_counters",
    "reflector_sw_db_info uc_l2_int_onepass is_allocated diagnostic_operation_counters",
};
