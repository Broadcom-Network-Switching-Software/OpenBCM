...
char cmd_dnx_knet_usage[] = "Usages:\n"
    ...
    "          [AddSVTagNone=yes|no] - Add NULL svtag before sending packet to switch port\n"
    ...
    args_t * args)
{
    ...
    if (sal_strcasecmp(subcmd, "netif") == 0)
    {
        ...
        if (sal_strcasecmp(subcmd, "create") == 0)
        {
            ...
            parse_table_add(&pt, "AddSVTagNone", PQ_DFL | PQ_BOOL, 0, &if_addsvtagnone, 0);
