...
/**
* \brief
*  Translates adapter stage index to kleap stages
* \ param [in] unit - Unit #
* \ param [in] adapter_stage_index - stage index as in pipe (i.e. FWD1=6)
* \ return ikleap stage.
*/
kleap_stages_e dnx_ikleap_adapter_stage_to_ikleap_stage(
    int unit,
    int adapter_stage_index);

/**
* \brief
*  Get interface index of a MDB signal.
* \ param [in] unit - Unit #
* \ param [in] adapter_stage_index - stage index as in pipe (i.e. FWD1=6)
* \ param [in] kbr_index
* \ param [in] default_res_index - default index for cases of unknown interface index.
* \ param [out] res - result address.
* \ return shr_error_e Standard error handeling
*/
shr_error_e dnx_ikleap_stages_get_interface_index(
    int unit,
    int adapter_stage_index,
    int kbr_index,
    char *res);
