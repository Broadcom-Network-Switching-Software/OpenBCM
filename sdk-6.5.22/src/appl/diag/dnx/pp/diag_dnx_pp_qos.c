    ...
    uint32 *final_qos_value)
{
    ...
    SHR_CLI_EXIT_IF_ERR(sand_signal_output_find
                        (unit, core, 0, "IRPP", dnx_data_pp.debug.from_signal_str_get(unit)->ingress_layers, "FWD1",
    ...
    *fwd_layer_index = list_element->value[0];
     ...
     */
    SHR_CLI_EXIT_IF_ERR(sand_signal_output_find
                        (unit, core, 0, "IRPP", dnx_data_pp.debug.from_signal_str_get(unit)->ingress_qos, "FWD1",
