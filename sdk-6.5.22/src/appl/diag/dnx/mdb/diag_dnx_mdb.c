                         ...
                         cluster_idx++)
                    {
                        ...
                        if (mdb_physical_table_id != MDB_NOF_PHYSICAL_TABLES)
                        {
                            dbal_physical_table_id =
                                dnx_data_mdb.pdbs.mdb_pdb_info_get(unit, mdb_physical_table_id)->physical_to_logical;
...
static sh_sand_option_t dnx_mdb_lpm_options[] = {
    ...
    {"payload_size", SAL_FIELD_TYPE_UINT32, "The KAPS payload size(Jer2-20bits, Jer3 up to 120bits)", "20"},
    {"payload", SAL_FIELD_TYPE_ARRAY32, "The KAPS payload(Jer2-20bits, Jer3 up to 120bits)", "0"},
    ...
    sh_sand_control_t * sand_control)
{
    ...
    if (MDB_EM_TABLE_IS_EMP(dnx_data_mdb.pdbs.dbal_pdb_info_get(unit, dbal_physical_table_id)->logical_to_physical))
    {
