    ...
    sh_sand_control_t * sand_control)
{
    ...
    for (stage_index = stage_lower; stage_index <= stage_upper; stage_index++)
    {
        ...
        pp_stages[0] = field_map_stage_info.pp_stage;
        ...
        while (1)
        {
            ...
            else
            {
                ...
                for (action_id = 0; action_id < nof_ids; action_id++)
                {
                    ...
                    rv = dnx_field_map_action_bcm_to_dnx_int(unit, field_stage, FALSE, ids[action_id], &dnx_action,
                                                             &action_map_entry);
                    ...
                    else
                    {
                        ...
                        DIAG_DNX_FIELD_UTILS_STR_INPUT_VERIFY(NULL, "%s (%d) [%d:%d]\n",
                                                              ...
                                                              ids[action_id], bits_on_signal_lsb, bits_on_signal_msb);
    ...
    for (stage_index = stage_lower; stage_index <= stage_upper; stage_index++)
    {
        ...
        for (signal_index = 0; signal_index < signals_nof; signal_index++)
        {
            ...
            if (action_found)
            {
                 ...
                 */
                bits_covered_by_act_string[sal_strnlen
                                           (bits_covered_by_act_string, sizeof(bits_covered_by_act_string)) - 1] = '\0';
