    ...
    sh_sand_control_t * sand_control)
{
    ...
    RHITERATOR(cs_dnx_dump, cs_dnx_dump_list)
    {
        ...
        cs_qual_map_p = &field_map_stage_info.cs_qual_map[cs_dnx_dump->bcm_qual];
        /**
        ...
        else
        {
            ...
            RHITERATOR(cs_dnx_dump_raw, cs_dnx_dump_list)
            {
                ...
                cs_qual_map_raw_p = &field_map_stage_info.cs_qual_map[cs_dnx_dump_raw->bcm_qual];
...
sh_sand_cmd_t Sh_dnx_field_qualifier_cmds[] = {
    ...
    {"USeR",     diag_dnx_field_qualifier_user_list_cb, NULL, Field_qualifier_user_list_options,    &Field_qualifier_user_list_man, NULL, NULL, SH_CMD_NO_XML_VERIFY},
