    ...
    char *presel_qual_arg_p)
{
    ...
    cs_qual_map_p = &field_map_stage_info.cs_qual_map[qual_data.qual_type];
    ...
    uint8 *apptype_found_p)
{
    ...
    */
    ...
    if (sal_strncmp(presel_ids_string, "", sizeof(presel_ids_string)))
    {
         ...
         */
        presel_ids_string[sal_strnlen(presel_ids_string, sizeof(presel_ids_string)) - 2] = '\0';
        PRT_CELL_SET("%s", presel_ids_string);
        /**
         * Extract last 2 symbols of the constructed string
         * to not present comma and empty space or '\n'  ", " at the end of it.
         */
        presel_quals_string[sal_strnlen(presel_quals_string, sizeof(presel_quals_string)) - 2] = '\0';
    ...
    sh_sand_control_t * sand_control)
{
    ...
    if (do_display)
    {
         ...
         * to not present comma and space ", " at the end of it.
         */
        fwd_ctx_string[sal_strnlen(fwd_ctx_string, sizeof(fwd_ctx_string)) - 2] = '\0';
        PRT_CELL_SET("%s", fwd_ctx_string);
        /**
         * Extract last 2 symbols of the constructed string
         * to not present comma and space ", " at the end of it.
         */
        acl_ctx_string[sal_strnlen(acl_ctx_string, sizeof(acl_ctx_string)) - 2] = '\0';
