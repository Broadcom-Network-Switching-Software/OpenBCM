...
/**/
void find_filename_in_sdk_path(char * filename, char * file_location)
{
    int rv;
...
/** Open file in SDK in given mode */
...
/** Delete a file in the SDK provided using its directory in SDK and filename */
