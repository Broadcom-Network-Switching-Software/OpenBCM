...
static field_itmh_qual_info_t field_itmh_ipmf2_fg3_qual_info_array[ITMH_NOF_IPMF2_FG3_QUALIFIERS] = {
  /** qual_name  |  qual_id   |   qual_size     |  input_type    |    input_arg  |  qual_offset  */
    ...
    {"itmh_fwd_l_idx_1588", 0, J2_ITMH_FWD_LAYER_INDEX_QUAL_LENGTH, {bcmFieldInputTypeConst, 0x1, 0}},
};

/** IPMF2 FG2 Qualifiers info. */
static field_itmh_qual_info_t field_itmh_ipmf2_sys_hdr_fg_qual_info_array[ITMH_NOF_IPMF2_SYS_HDR_FG_QUALIFIERS] = {
  /** qual_name  |  qual_id   |   qual_size     |  input_type    |    input_arg  |  qual_offset  */
    {"itmh_fbr_hdr_set_qual", 0, 4, {bcmFieldInputTypeConst, 0x1, 0}},
};
...
/** {action_name}   |  action_id  |    { stage | action_type | size | prefix_size | prefix_value | name  } */
    ...
    {NULL, bcmFieldActionFabricHeaderSetRaw, {0}, TRUE, {SYS_HDR_PRIO_TSH, 1}},
...
static field_itmh_action_info_t field_itmh_ipmf2_sys_hdr_fg_action_info_array[ITMH_NOF_IPMF2_SYS_HDR_FG_ACTIONS] = {
/** {action_name}   |  action_id  |    { stage | action_type | size | prefix_size | prefix_value | name  } */
    {NULL, bcmFieldActionFabricHeaderSetRaw, {0}, FALSE, {SYS_HDR_PRIO_ITMH, 1}},
};
...
static field_itmh_fg_info_t itmh_fg_info_array[ITMH_NOF_FG] = {
    ...
    /** IPMF2 system header field group info */
    {
        0,   /** Field group ID */
        bcmFieldStageIngressPMF2,   /** Field stage */
        bcmFieldGroupTypeDirectExtraction,  /** Field group type */
        ITMH_NOF_IPMF2_SYS_HDR_FG_QUALIFIERS,  /** Number of tested qualifiers */
        ITMH_NOF_IPMF2_SYS_HDR_FG_ACTIONS, /** Number of tested actions */
        field_itmh_ipmf2_sys_hdr_fg_qual_info_array,   /** Qualifiers info */
        field_itmh_ipmf2_sys_hdr_fg_action_info_array, /** Actions info */
        NULL,  /** FEM actions info */
        TRUE, FALSE
    }
};
    ...
    int unit)
{
    ...
    bcm_field_context_t itmh_context_id, itmh_pph_context_id, itmh_pph_fhei_context_id;
    bcm_field_context_t itmh_pph_lif_context_id, itmh_pph_fhei_lif_context_id;
    uint8 is_alloc;
 ...
 */
    ...
    SHR_IF_ERR_EXIT(dnx_field_context_id_is_allocated(unit, DNX_FIELD_STAGE_IPMF1, itmh_pph_context_id, &is_alloc));
    if (is_alloc)
    {
        /********************************
    ...
    int flow_id)
{
    ...
    bcm_field_context_t itmh_pph_lif_context_id = dnx_data_field.context.default_itmh_pph_lif_ipmf2_context_get(unit);
    bcm_field_context_t itmh_pph_fhei_lif_context_id =
        dnx_data_field.context.default_itmh_pph_fhei_lif_ipmf2_context_get(unit);
    SHR_FUNC_INIT_VARS(unit);
    ...
    if (itmh_fg_info->itmh_context)
    {
        ...
        SHR_IF_ERR_EXIT(dnx_field_context_id_is_allocated
                        (unit, DNX_FIELD_STAGE_IPMF2, itmh_pph_lif_context_id, &is_alloc));
        if (is_alloc)
        {
            SHR_IF_ERR_EXIT(bcm_field_group_context_attach
                            (unit, 0, itmh_fg_info->fg_id, itmh_pph_lif_context_id, &attach_info));
            SHR_IF_ERR_EXIT(bcm_field_group_context_attach
                            (unit, 0, itmh_fg_info->fg_id, itmh_pph_fhei_lif_context_id, &attach_info));
        }
    }
    ...
    int unit)
{
    ...
    for (fg_index = 0; fg_index < ITMH_NOF_FG; fg_index++)
    {
        ...
        SHR_IF_ERR_EXIT(field_itmh_group_config(unit, &itmh_fg_info_array[fg_index], flow_id));
    }
