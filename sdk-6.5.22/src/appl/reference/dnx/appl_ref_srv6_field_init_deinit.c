    ...
    field_srv6_endpoint_gsid_info_t * appl_ref_field_srv6_gsid_endpoint_info)
{
    ...
    appl_ref_field_srv6_gsid_endpoint_info->pmf2_container_zero_a = bcmFieldQualifyCount;
    appl_ref_field_srv6_gsid_endpoint_info->container_void_action = bcmFieldQualifyCount;
    ...
    field_srv6_endpoint_psp_info_t * appl_ref_field_srv6_endpoint_psp_info)
{
    ...
    appl_ref_field_srv6_endpoint_psp_info->container_void_action = bcmFieldQualifyCount;
    appl_ref_field_srv6_endpoint_psp_info->tcam_void_action = bcmFieldQualifyCount;
    appl_ref_field_srv6_endpoint_psp_info->psp_parsing_start_void_action = bcmFieldQualifyCount;
    appl_ref_field_srv6_endpoint_psp_info->endpoint_parsing_start_void_action = bcmFieldQualifyCount;
    ...
    field_srv6_endpoint_psp_info_t * appl_ref_field_srv6_endpoint_psp_ext_cut_info)
{
    ...
    appl_ref_field_srv6_endpoint_psp_ext_cut_info->container_void_action = bcmFieldQualifyCount;
    appl_ref_field_srv6_endpoint_psp_ext_cut_info->tcam_void_action = bcmFieldQualifyCount;
    appl_ref_field_srv6_endpoint_psp_ext_cut_info->psp_parsing_start_void_action = bcmFieldQualifyCount;
    appl_ref_field_srv6_endpoint_psp_ext_cut_info->endpoint_parsing_start_void_action = bcmFieldQualifyCount;
    ...
    field_srv6_endpoint_psp_info_t * appl_ref_field_srv6_endpoint_usp_ext_cut_info)
{
    ...
    appl_ref_field_srv6_endpoint_usp_ext_cut_info->container_void_action = bcmFieldQualifyCount;
    appl_ref_field_srv6_endpoint_usp_ext_cut_info->tcam_void_action = bcmFieldQualifyCount;
    appl_ref_field_srv6_endpoint_usp_ext_cut_info->psp_parsing_start_void_action = bcmFieldQualifyCount;
    appl_ref_field_srv6_endpoint_usp_ext_cut_info->endpoint_parsing_start_void_action = bcmFieldQualifyCount;
    ...
    field_srv6_egress_usd_info_t * appl_ref_field_srv6_egress_usd_info)
{
    ...
    appl_ref_field_srv6_egress_usd_info->large_parsing_start_offset_action = bcmFieldQualifyCount;
    appl_ref_field_srv6_egress_usd_info->large_bytes_to_remove_action = bcmFieldActionCount;
    appl_ref_field_srv6_egress_usd_info->srh_next_header_pmf2_qual = bcmFieldActionCount;
    appl_ref_field_srv6_egress_usd_info->srh_next_header_pmf3_qual = bcmFieldQualifyCount;
    appl_ref_field_srv6_egress_usd_info->pmf2_esi_1st_pass_udh3_size = bcmFieldActionCount;
    appl_ref_field_srv6_egress_usd_info->pmf2_esi_1st_pass_udh3_data = bcmFieldQualifyCount;
    appl_ref_field_srv6_egress_usd_info->pmf2_udh3_esi_user_action = bcmFieldQualifyCount;
    appl_ref_field_srv6_egress_usd_info->parsing_start_offset_zero_qual = bcmFieldQualifyCount;
    appl_ref_field_srv6_egress_usd_info->large_parsing_start_offset_sids_qual = bcmFieldActionCount;
    ...
    field_srv6_egress_usp_info_t * appl_ref_field_srv6_egress_usp_info)
{
    ...
    appl_ref_field_srv6_egress_usp_info->container_void_action = bcmFieldQualifyCount;
 ...
 */
        ...
        if (!dnx_data_field.features.tcam_result_half_payload_on_msb_get(unit) &&
            !dnx_data_field.features.tcam_result_half_payload_on_msb_get(unit))
        {
            tcam_fg_info.nof_actions = 2;
            tcam_fg_info.action_types[0] = bcmFieldActionVoid;
            tcam_fg_info.action_types[1] = appl_ref_field_srv6_endpoint_psp_info->tcam_void_action;
            tcam_fg_info.action_with_valid_bit[0] = FALSE;
            tcam_fg_info.action_with_valid_bit[1] = FALSE;
        }
        else
        {
    ...
    field_srv6_endpoint_gsid_info_t * appl_ref_field_srv6_gsid_endpoint_info)
{
    ...
    SHR_IF_ERR_EXIT(bcm_field_group_add(unit, BCM_FIELD_FLAG_MSB_RESULT_ALIGN, &fg_info,
                                        &appl_ref_field_srv6_gsid_endpoint_info->ipmf2_tcam_fg));
 ...
 */
    ...
    SHR_IF_ERR_EXIT(bcm_field_group_add(unit, BCM_FIELD_FLAG_MSB_RESULT_ALIGN, &fg_info,
                                        &appl_ref_field_srv6_egress_usd_info.ipmf3_tcam_fg));
    ...
    bcm_field_context_t * context_id)
{
    ...
    bcm_field_context_info_t_init(&context_info);
    dest_char = &(context_info.name[0]);
    sal_strncpy_s(dest_char, "SRv6_EGRS_usd_eBTR_ipmf1", sizeof(context_info.name));
    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(field_srv6_pmf1_egress_usd_presel_set(unit, appl_ref_field_srv6_egress_usd_info.ipmf1_context_id,
                                                          dnx_data_field.
    ...
    int unit)
{
    ...
    bcm_field_context_info_t_init(&context_info);
    dest_char = &(context_info.name[0]);
    sal_strncpy_s(dest_char, "SRv6_EGRS_usd_eBTR_epmf", sizeof(context_info.name));
    ...
    int unit)
{
    ...
    if (dnx_data_dev_init.general.feature_get(unit, dnx_data_dev_init_general_egress_estimated_bta_btr_config))
    {
        ...
        bcm_field_context_info_t_init(&context_info);
        dest_char = &(context_info.name[0]);
        sal_strncpy_s(dest_char, "SRv6_EP_PSP_eBTR_epmf", sizeof(context_info.name));
        SHR_IF_ERR_EXIT(bcm_field_context_create(unit, 0, bcmFieldStageEgress, &context_info, &context_id));
    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(field_srv6_pmf1_egress_usp_presel_set(unit, appl_ref_field_srv6_egress_usp_info.ipmf1_context_id,
                                                          dnx_data_field.
    ...
    SHR_IF_ERR_EXIT(field_srv6_pmf1_egress_usp_presel_set
                    (unit, appl_ref_field_srv6_egress_usp_info.ipmf1_context_id,
                     dnx_data_field.preselector.srv6_egress_usp_tcp_presel_id_ipmf1_get(unit), bcmFieldLayerTypeTcp,
                     0));
    SHR_IF_ERR_EXIT(field_srv6_pmf1_egress_usp_presel_set
                    (unit, appl_ref_field_srv6_egress_usp_info.ipmf1_context_id,
                     dnx_data_field.preselector.srv6_egress_usp_icmp_presel_id_ipmf1_get(unit), bcmFieldLayerTypeIcmp,
                     0));
    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(field_srv6_pmf1_egress_usp_presel_set
                    (unit, appl_ref_field_srv6_endpoint_usp_ext_cut_info.ipmf1_context_id,
                     dnx_data_field.preselector.srv6_endpoint_usp_tcp_extended_cut_presel_id_ipmf1_get(unit),
                     bcmFieldLayerTypeTcp, 1));
    SHR_IF_ERR_EXIT(field_srv6_pmf1_egress_usp_presel_set
                    (unit, appl_ref_field_srv6_endpoint_usp_ext_cut_info.ipmf1_context_id,
                     dnx_data_field.preselector.srv6_endpoint_usp_icmp_extended_cut_presel_id_ipmf1_get(unit),
                     bcmFieldLayerTypeIcmp, 1));
