...
shr_error_e dnxf_adapter_reg_access_init(
    int unit);
shr_error_e dnxf_adapter_reg_access_deinit(
    int unit);
#endif
...
#ifdef ADAPTER_SERVER_MODE
    {DNXF_INIT_STEP_ADAPTER_REG_ACC,   "Adapter",              dnxf_adapter_reg_access_init,  dnxf_adapter_reg_access_deinit,     0},
#endif
