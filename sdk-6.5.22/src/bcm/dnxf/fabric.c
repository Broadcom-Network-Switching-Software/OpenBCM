    ...
    bcm_module_t * modid_array)
{
    ...
    SHR_INVOKE_VERIFY_DNXF(dnxf_fabric_modid_group_set_verify(unit, group, modid_count, modid_array));
    ...
    int *modid_count)
{
    ...
    SHR_INVOKE_VERIFY_DNXF(dnxf_fabric_modid_group_get_verify(unit, group, modid_max_count, modid_array, modid_count));
    ...
    bcm_module_t * group)
{
    ...
    SHR_INVOKE_VERIFY_DNXF(dnxf_fabric_modid_group_find_verify(unit, modid, group));
    ...
    bcm_module_t modid)
{
    ...
    SHR_INVOKE_VERIFY_DNXF(dnxf_fabric_modid_local_mapping_set_verify(unit, local_modid, modid));
    ...
    bcm_module_t * modid)
{
    ...
    SHR_INVOKE_VERIFY_DNXF(dnxf_fabric_modid_local_mapping_get_verify(unit, local_modid, modid));
    ...
    bcm_port_t * links_array)
{
    ...
    SHR_INVOKE_VERIFY_DNXF(dnxf_fabric_link_topology_config_set_verify
    ...
    bcm_port_t * links_array)
{
    ...
    SHR_INVOKE_VERIFY_DNXF(dnxf_fabric_link_topology_config_get_verify
    ...
    bcm_module_t * destid_array)
{
    ...
    SHR_INVOKE_VERIFY_DNXF(dnxf_fabric_multicast_set_verify(unit, group, flags, destid_count, destid_array));
    ...
    bcm_module_t * destid_array)
{
    ...
    SHR_INVOKE_VERIFY_DNXF(dnxf_fabric_multicast_get_verify
    ...
    bcm_fabric_module_vector_t * dest_array)
{
    ...
    SHR_INVOKE_VERIFY_DNXF(dnxf_fabric_multicast_multi_get_verify(unit, flags, ngroups, groups, dest_array));
    ...
    int *local_route_array)
{
    ...
    SHR_INVOKE_VERIFY_DNXF(dnxf_fabric_multicast_multi_config_set_verify
                           (unit, flags, nof_groups, groups, dest_array, local_route_array));
    ...
    bcm_fabric_module_vector_t * dest_array)
{
    ...
    SHR_INVOKE_VERIFY_DNXF(dnxf_fabric_multicast_multi_set_verify(unit, flags, ngroups, groups, dest_array));
    ...
    int *enable)
{
    ...
    SHR_INVOKE_VERIFY_DNXF(dnxf_fabric_multicast_local_route_set_verify(unit, flags, nof_groups, groups, enable));
    ...
    int *enable)
{
    ...
    SHR_INVOKE_VERIFY_DNXF(dnxf_fabric_multicast_local_route_get_verify(unit, flags, nof_groups, groups, enable));
    ...
    int *arg)
{
    ...
    switch (type)
    {
        ...
        case bcmFabricLinkPcpEnable:
            ...
            break;
        case bcmFabricLinkRepeaterEnable:
            SHR_IF_ERR_EXIT(MBCM_DNXF_DRIVER_CALL(unit, mbcm_dnxf_fabric_link_repeater_enable_get, (unit, link, arg)));
            break;
        case bcmFabricLinkRetimerConnect:
            if (!dnxf_data_port.retimer.feature_get(unit, dnxf_data_port_retimer_is_supported))
            {
    ...
    uint32 *data_in)
{
...
#else
    {
        ...
        soc_route.dest_device_type = route->dest_device_type;
    ...
    void *cookie)
{
    ...
    if (tx_pkt->pkt_data->len > DNXC_VSC256_DESTINATION_ROUTED_CELL_PAYLOAD_DATA_SIZE_BYTES)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "Payload size may be up to %d bytes! Provided value is %d ",
                     DNXC_VSC256_DESTINATION_ROUTED_CELL_PAYLOAD_DATA_SIZE_BYTES, tx_pkt->pkt_data->len);
    }
