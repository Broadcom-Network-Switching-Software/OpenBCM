    ...
    bcm_compat6517_port_mapping_info_t *mapping_info)
{
    ...
    bcm_compat6520_port_mapping_info_t *new_mapping_info = NULL;
    ...
    if (interface_info != NULL && mapping_info != NULL) {
        ...
        new_mapping_info = (bcm_compat6520_port_mapping_info_t *)
                     sal_alloc(sizeof(bcm_compat6520_port_mapping_info_t),
                     "New mapping_info");
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6520_port_add(unit, port, flags, new_interface_info, new_mapping_info);
    ...
    bcm_compat6517_port_mapping_info_t *mapping_info)
{
    ...
    /* Call the BCM API with new format */
    rv = bcm_compat6520_port_get(unit, port, flags, new_interface_info, new_mapping_info);
