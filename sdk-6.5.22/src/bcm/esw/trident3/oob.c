...
#define _TD3_NUM_TC  8
/* Number of OOB FC Rx Interface */
#define _TD3_NUM_OOB_FC_RX_INTF    4
/* Maximum Value of Channel Base Value */
#define _TD3_MAX_CHANNEL_BASE    63

/* Total number of Indexes in OOBFC RX memory */
#define _TD3_MAX_RX_MEM_ENTRY    96

/* Maximum Value of OOB Stats Config_ID */
#define _TD3_MAX_STATS_CONFIG_ID 3

/* Total number of Indexes in OOB Stats Service Pool List */
#define _TD3_MAX_IDX_STATS_POOL_LIST    8

/* Total number of Indexes in OOB Stats UC Queue List */
#define _TD3_MAX_IDX_STATS_QUEUE_LIST     1320

/* Total number of UC Queue per port. */
#define _TD3_NUM_UCAST_QUEUE_PER_PORT 10

/* Total number of pipes per slice */
#define _TD3_NUM_PIPE_PER_SLICE       2

/* 0xF is the end of reporting of OOB Pool Stats */
#define _TD3_OOB_STATS_END_POOL_REPORT   0xF

/* 0x7FF is the end of reporting of OOB Queue Stats */
#define _TD3_OOB_STATS_END_QUEUE_REPORT   0x7FF

/* if OOBFC_CHANNEL_BASE.POOL_EN is not valid then use
 * OOBFC_CHANNEL_BASE.MC_EN; functionality is same based on
 * Architecture team*/
#define _TD3_OOB_FC_TX_POOL_EN_SUPPORT 0
#define _TD3_OOB_FC_TX_MC_EN_SUPPORT   1

typedef struct _bcm_td3_oob_fc_rx_intf_info_s {
...
} _bcm_td3_oob_fc_rx_intf_info_t;
    
/*
 * Function:
 *      _bcm_td3_oob_fc_tx_config_flags_set
 * Purpose:
 ...
 */
STATIC int
_bcm_td3_oob_fc_tx_config_flags_set(int unit, uint32 flags)
{
    uint32 rval = 0;
    uint64 rval64;
    uint64 field64;
    ...
    soc_reg64_field_set(unit, OOBFC_CHANNEL_BASE_64r, &rval64,
                        ENG_ENf, field64);
    if (_TD3_OOB_FC_TX_POOL_EN_SUPPORT) {
        COMPILER_64_ZERO(field64);
    ...
    } else if (_TD3_OOB_FC_TX_MC_EN_SUPPORT) {
        COMPILER_64_ZERO(field64);
        if (flags & BCM_OOB_FC_TX_POOL_EN) {
            COMPILER_64_SET(field64, 0, 1);
        }
...
/*
 * Function:
 *      _bcm_td3_oob_fc_tx_config_ipg_set
 * Purpose:
 ...
 */
STATIC int
_bcm_td3_oob_fc_tx_config_ipg_set(int unit, uint8 ipg)
{
    uint32 rval;
...
/*
 * Function:
 *      _bcm_td3_oob_fc_tx_config_gcs_id_set
 * Purpose:
 ...
 */
STATIC int
_bcm_td3_oob_fc_tx_config_gcs_id_set(int unit,
...
/*
 * Function:
 *      _bcm_td3_oob_fc_tx_config_egr_mode_set
 * Purpose:
 ...
 */
STATIC int
_bcm_td3_oob_fc_tx_config_egr_mode_set(int unit,
...
/*
 * Function:
 *      _bcm_td3_oob_fc_tx_config_flags_get
 * Purpose:
 ...
 */
STATIC int
_bcm_td3_oob_fc_tx_config_flags_get(int unit,
...
/*
 * Function:
 *      _bcm_td3_oob_fc_tx_config_ipg_get
 * Purpose:
 ...
 */
STATIC int
_bcm_td3_oob_fc_tx_config_ipg_get(int unit,
                            bcm_oob_fc_tx_config_t *config)
{
    uint32 rval;
...
/*
 * Function:
 *      _bcm_td3_oob_fc_tx_config_gcs_id_get
 * Purpose:
 ...
 */
STATIC int
_bcm_td3_oob_fc_tx_config_gcs_id_get(int unit,
                              bcm_oob_fc_tx_config_t *config)
{
    uint32 rval;
 ...
 */
STATIC int
_bcm_td3_oob_fc_tx_config_egr_mode_get(int unit,
                                  bcm_oob_fc_tx_config_t *config)
{
    uint64 rval64;
...
/*
 * Function:
 *      _bcm_td3_oob_localport_resolve
 * Purpose:
 ...
 */
STATIC int
_bcm_td3_oob_localport_resolve(int unit, bcm_gport_t gport,
...
/*
 * Function:
 *      _bcm_td3_oob_fc_rx_get_intf_info
 * Purpose:
 ...
 */
STATIC int
_bcm_td3_oob_fc_rx_get_intf_info(int unit, _bcm_td3_oob_fc_rx_intf_info_t *info,
                            bcm_oob_fc_rx_intf_id_t intf_id)
{
    uint32 rval = 0x0;
    soc_reg_t cfg_reg[_TD3_NUM_OOB_FC_RX_INTF] = {OOBFC_CHIF_CFG0r,
                                                 OOBFC_CHIF_CFG1r,
                                                 OOBFC_CHIF_CFG2r,
                                                 OOBFC_CHIF_CFG3r};
...
/*
 * Function:
 *      _bcm_td3_oob_fc_rx_disable_intf
 * Purpose:
 ...
 */
STATIC int
_bcm_td3_oob_fc_rx_disable_intf(int unit,
                           bcm_oob_fc_rx_intf_id_t intf_id)
{
    uint32 rval = 0x0;
    soc_reg_t cfg_reg[_TD3_NUM_OOB_FC_RX_INTF] = {OOBFC_CHIF_CFG0r,
...
/*
 * Function:
 *      _bcm_td3_oob_fc_rx_enable_intf
 * Purpose:
 ...
 */
STATIC int
_bcm_td3_oob_fc_rx_enable_intf(int unit,
                          bcm_oob_fc_rx_intf_id_t intf_id)
{
    uint32 rval = 0x0;
    soc_reg_t cfg_reg[_TD3_NUM_OOB_FC_RX_INTF] = {OOBFC_CHIF_CFG0r,
...
/*
 * Function:
 *      _bcm_td3_oob_fc_rx_intf_get_lookup_base
 * Purpose:
 ...
 */
STATIC int
_bcm_td3_oob_fc_rx_intf_get_lookup_base(int unit,
                                bcm_oob_fc_rx_intf_id_t intf_id,
                                uint32 *lookup_base)
{
    uint32 rval = 0x0;
 ...
 */
int
bcm_td3_oob_fc_tx_config_set(int unit,
                            bcm_oob_fc_tx_config_t *config)
{
    if (config == NULL) {
        return BCM_E_PARAM;
    ...
    if ((config->gcs_id < 0) && (config->gcs_id >= _TD3_MMU_NUM_POOL)) {
        return BCM_E_PARAM;
    }
    ...
    BCM_IF_ERROR_RETURN
        (_bcm_td3_oob_fc_tx_config_flags_set(unit, config->flags));

    /* Setting Inter packet Gap between two HCFC message */
    BCM_IF_ERROR_RETURN
        (_bcm_td3_oob_fc_tx_config_ipg_set(unit, config->inter_pkt_gap));

    /* Setting service pool id whose congestion state will be
       reported in every HCFC message */
    BCM_IF_ERROR_RETURN
        (_bcm_td3_oob_fc_tx_config_gcs_id_set(unit, config->gcs_id));

    /* Setting Egress mode for reporting OOBFC message. */
    BCM_IF_ERROR_RETURN
        (_bcm_td3_oob_fc_tx_config_egr_mode_set(unit, config->egr_mode));
 ...
 */
int
bcm_td3_oob_fc_tx_config_get(int unit,
                            bcm_oob_fc_tx_config_t *config)
{
    if (config == NULL) {
        return BCM_E_PARAM;
    ...
    BCM_IF_ERROR_RETURN
        (_bcm_td3_oob_fc_tx_config_flags_get(unit, config));

    /* Get the configured Inter Packet Gap between OOBFC Tx message.*/
    BCM_IF_ERROR_RETURN
        (_bcm_td3_oob_fc_tx_config_ipg_get(unit, config));

    /* Setting service pool id whose congestion state will be
       reported in every HCFC message */
    BCM_IF_ERROR_RETURN
        (_bcm_td3_oob_fc_tx_config_gcs_id_get(unit, config));

    /* Get the configured Egress mode of OOBFC Tx side */
    BCM_IF_ERROR_RETURN
        (_bcm_td3_oob_fc_tx_config_egr_mode_get(unit, config));
...
/*
 * Function:
 *      _bcm_td3_oob_fc_tx_port_control_set
 * Purpose:
 ...
 */
int
_bcm_td3_oob_fc_tx_port_control_set(int unit, bcm_port_t localport,
                              int status, int dir)
{
    uint32 rval = 0;
    uint64 rval64;
...
/*
 * Function:
 *      _bcm_td3_oob_fc_tx_port_control_get
 * Purpose:
 ...
 */
int
_bcm_td3_oob_fc_tx_port_control_get(int unit, bcm_port_t localport,
                                 int *status, int dir)
{
    uint32 rval = 0;
    uint64 rval64;
...
*/
int
bcm_td3_oob_fc_tx_info_get(int unit, bcm_oob_fc_tx_info_t *info)
{
    uint64 rval64;
...
/*
 * Function:
 *      _bcm_td3_oob_fc_rx_config_enable_set
 * Purpose:
 ...
 */
STATIC int
_bcm_td3_oob_fc_rx_config_enable_set(int unit,
                            bcm_oob_fc_rx_intf_id_t intf_id,
                            uint8 channel_base,
                            int array_count,
                            bcm_gport_t *gport_array)
{
    _bcm_td3_oob_fc_rx_intf_info_t info[_TD3_NUM_OOB_FC_RX_INTF];
    char *sysport_buf, *tc2pri_buf;
    uint32 sysport_list[_TD3_MAX_RX_MEM_ENTRY];
    ...
    sal_memset(info, 0, sizeof(_bcm_td3_oob_fc_rx_intf_info_t) *
               _TD3_NUM_OOB_FC_RX_INTF);
    sal_memset(sysport_list, 0, sizeof(uint32) *
               _TD3_MAX_RX_MEM_ENTRY);

    /* Backup the per OOBFC Rx interface configuration */
    for (i = 0; i < _TD3_NUM_OOB_FC_RX_INTF; i++) {
        BCM_IF_ERROR_RETURN
            (_bcm_td3_oob_fc_rx_get_intf_info(unit, &info[i], i));
    ...
    if ((total_num_ports + array_count) > _TD3_MAX_RX_MEM_ENTRY) {
        return BCM_E_PARAM;
    }
    ...
    sysport_buf = soc_cm_salloc(unit, _TD3_MAX_RX_MEM_ENTRY * mem_wsz,
                                "oob sysport_buf");
    if (sysport_buf == NULL) {
        return BCM_E_MEMORY;
    }
    ...
    if (soc_mem_read_range(unit, MMU_CHFC_SYSPORT_MAPPINGm, MEM_BLOCK_ALL,
                           0, _TD3_MAX_RX_MEM_ENTRY - 1, sysport_buf)) {
        rv = BCM_E_INTERNAL;
    ...
    tc2pri_buf = soc_cm_salloc(unit, _TD3_MAX_RX_MEM_ENTRY * mem_wsz,
                               "oob tc2pri_buf");
    if (tc2pri_buf == NULL) {
        rv = BCM_E_MEMORY;
        soc_cm_sfree(unit, sysport_buf);
    ...
    if (soc_mem_read_range(unit, MMU_INTFO_TC2PRI_MAPPINGm, MEM_BLOCK_ALL,
                           0, _TD3_MAX_RX_MEM_ENTRY - 1, tc2pri_buf)) {
        rv = BCM_E_INTERNAL;
    ...
    for (i = 0; i < array_count; i++) {
        rv = _bcm_td3_oob_localport_resolve(unit, gport_array[i],
                                           &localport);
        if (rv != BCM_E_NONE) {
            soc_cm_sfree(unit, tc2pri_buf);
            soc_cm_sfree(unit, sysport_buf);
...
/*
 * Function:
 *      _bcm_td3_oob_fc_rx_port_offset_get
 * Purpose:
 ...
 */
STATIC int
_bcm_td3_oob_fc_rx_port_offset_get(int unit,
                         bcm_oob_fc_rx_intf_id_t intf_id,
                         bcm_gport_t gport,
                         uint32 *offset)
{
    bcm_oob_fc_rx_config_t config;
    bcm_gport_t gport_array[_TD3_MAX_RX_MEM_ENTRY] = {0x0};
    int array_count = 0, i = 0;

    /* Get the configured list of gport array
       and array count*/
    BCM_IF_ERROR_RETURN
        (bcm_td3_oob_fc_rx_config_get(unit, intf_id, &config,
                                     _TD3_MAX_RX_MEM_ENTRY, gport_array,
                                     &array_count));
...
/*
 * Function:
 *      _bcm_td3_oob_fc_rx_tc_mapping_get
 * Purpose:
 ...
 */
STATIC int
_bcm_td3_oob_fc_rx_tc_mapping_get(int unit,
                        bcm_oob_fc_rx_intf_id_t intf_id,
...
/*
 * Function:
 *      _bcm_td3_oob_fc_rx_tc_mapping_set
 * Purpose:
 ...
 */
STATIC int
_bcm_td3_oob_fc_rx_tc_mapping_set(int unit,
                          ...
                          uint32 pri_bmp, uint32 idx)
{
    ...
    rv = _bcm_td3_oob_fc_rx_disable_intf(unit, intf_id);
    if (rv != BCM_E_NONE) {
        soc_cm_sfree(unit, tc2pri_buf);
        return rv;
    }
    ...
    rv = _bcm_td3_oob_fc_rx_enable_intf(unit, intf_id);
    if (rv != BCM_E_NONE) {
        soc_cm_sfree(unit, tc2pri_buf);
        return rv;
    }
...
/*
 * Function:
 *      _bcm_td3_oob_fc_rx_config_disable_set
 * Purpose:
 ...
 */
STATIC int
_bcm_td3_oob_fc_rx_config_disable_set(int unit,
                            bcm_oob_fc_rx_intf_id_t intf_id)
{
    _bcm_td3_oob_fc_rx_intf_info_t old_info[_TD3_NUM_OOB_FC_RX_INTF];
    _bcm_td3_oob_fc_rx_intf_info_t new_info[_TD3_NUM_OOB_FC_RX_INTF];
    char *sysport_buf, *tc2pri_buf;
    uint32 old_sysport_list[_TD3_MAX_RX_MEM_ENTRY];
    uint64 old_tc2pri_list[_TD3_MAX_RX_MEM_ENTRY];
    uint32 new_sysport_list[_TD3_MAX_RX_MEM_ENTRY];
    uint64 new_tc2pri_list[_TD3_MAX_RX_MEM_ENTRY];
    int rv = BCM_E_INTERNAL;
    int mem_wsz = 0;
    int i = 0, j = 0, k = 0;
    void *pentry;
    ...
    sal_memset(old_info, 0, sizeof(_bcm_td3_oob_fc_rx_intf_info_t) *
               _TD3_NUM_OOB_FC_RX_INTF);
    sal_memset(new_info, 0, sizeof(_bcm_td3_oob_fc_rx_intf_info_t) *
               _TD3_NUM_OOB_FC_RX_INTF);
    ...
    for (i = 0; i < _TD3_NUM_OOB_FC_RX_INTF; i++) {
        BCM_IF_ERROR_RETURN
            (_bcm_td3_oob_fc_rx_get_intf_info(unit, &old_info[i], i));
    }
    ...
    for (i = 0; i < _TD3_MAX_RX_MEM_ENTRY; i++) {
        pentry = soc_mem_table_idx_to_pointer(unit,
                                              MMU_CHFC_SYSPORT_MAPPINGm,
                                              void*, sysport_buf, i);
    ...
    for (i = 0; i < _TD3_NUM_OOB_FC_RX_INTF; i++) {
        if (old_info[i].enable == 1) {
            rv = _bcm_td3_oob_fc_rx_disable_intf(unit, i);
            if (rv != BCM_E_NONE) {
                soc_cm_sfree(unit, tc2pri_buf);
                soc_cm_sfree(unit, sysport_buf);
                return rv;
 ...
 */
STATIC int
_bcm_td3_oob_fc_rx_config_get(int unit,
                 bcm_oob_fc_rx_intf_id_t intf_id,
                 bcm_oob_fc_rx_config_t *config,
                 int array_max,
                 bcm_gport_t *gport_array,
                 int *array_count)
{
    _bcm_td3_oob_fc_rx_intf_info_t info;
    int rv = BCM_E_INTERNAL;
    char *sysport_buf;
    void *pentry;
    int mem_wsz = 0;
    ...
    /* Store all the OOBFC Rx interface configuration */
    BCM_IF_ERROR_RETURN
            (_bcm_td3_oob_fc_rx_get_intf_info(unit, &info, intf_id));
 ...
 */
int
bcm_td3_oob_fc_rx_config_set(int unit,
                     bcm_oob_fc_rx_intf_id_t intf_id,
                     bcm_oob_fc_rx_config_t *config,
                     int array_count,
                     bcm_gport_t *gport_array)
{
    if ((intf_id < 0) || (intf_id >= _TD3_NUM_OOB_FC_RX_INTF)) {
        return BCM_E_PARAM;
    }
    ...
    if ((config->enable == 1) &&
        ...
        (array_count > _TD3_MAX_RX_MEM_ENTRY))) {
        return BCM_E_PARAM;
    }

    if ((config->enable == 1) &&
        ((config->channel_base > _TD3_MAX_CHANNEL_BASE))) {
        return BCM_E_PARAM;
    }
    ...
    if (config->enable == 1) {
        ...
        BCM_IF_ERROR_RETURN
            (_bcm_td3_oob_fc_rx_config_enable_set(unit, intf_id,
                                                 config->channel_base,
                                                 array_count, gport_array));
    } else {
        /* Remove entries from MMU_CHFC_SYSPORT_MAPPING memory */
        BCM_IF_ERROR_RETURN
            (_bcm_td3_oob_fc_rx_config_disable_set(unit, intf_id));
    }
 ...
 */
int
bcm_td3_oob_fc_rx_config_get(int unit,
                     bcm_oob_fc_rx_intf_id_t intf_id,
                     bcm_oob_fc_rx_config_t *config,
                     int array_max,
                     bcm_gport_t *gport_array,
                     int *array_count)
{
    ...
    BCM_IF_ERROR_RETURN
        (_bcm_td3_oob_fc_rx_config_get(unit, intf_id,
                                      config, array_max,
                                      gport_array,
                                      array_count));
...
/*
 * Function:
 *      bcm_td3_oob_fc_rx_port_tc_mapping_multi_set
 * Purpose:
 ...
 */
int
bcm_td3_oob_fc_rx_port_tc_mapping_multi_set(int unit,
                                 bcm_oob_fc_rx_intf_id_t intf_id,
                                 bcm_gport_t gport,
                                 int array_count,
                                 uint32 *tc,
                                 uint32 *pri_bmp)
{
    ...
    if ((array_count < 1) || (array_count > _TD3_NUM_TC)) {
        return BCM_E_PARAM;
    }
    ...
    for (i = 0; i < array_count; i++) {
        if ((tc[i] > (_TD3_NUM_TC - 1)) || (pri_bmp[i] > 0xFF)) {
            return BCM_E_PARAM;
        }
    }
    ...
    for (i = 0; i < array_count; i++) {
        BCM_IF_ERROR_RETURN
            (bcm_td3_oob_fc_rx_port_tc_mapping_set(unit, intf_id,
                                                  gport, tc[i],
                                                  pri_bmp[i]));
    }
...
/*
 * Function:
 *      bcm_td3_oob_fc_rx_port_tc_mapping_multi_get
 * Purpose:
 ...
 */
int
bcm_td3_oob_fc_rx_port_tc_mapping_multi_get(int unit,
                                     bcm_oob_fc_rx_intf_id_t intf_id,
                                     bcm_gport_t gport,
                                     int array_max,
                                     uint32 *tc,
                                     ...
                                     int *array_count)
{
    ...
    if (array_max > _TD3_NUM_TC) {
        *array_count = _TD3_NUM_TC;
    } else {
        *array_count = array_max;
    }

    for (i = 0; i < *array_count; i++) {
        if (tc[i] > (_TD3_NUM_TC - 1)) {
            return BCM_E_PARAM;
        }
    }
    ...
    for (i = 0; i < *array_count; i++) {
        BCM_IF_ERROR_RETURN
            (bcm_td3_oob_fc_rx_port_tc_mapping_get(unit, intf_id,
                                                  gport, tc[i],
                                                  &pri_bmp[i]));
    }
    return BCM_E_NONE;
...
/*
 * Function:
 *      bcm_td3_oob_fc_rx_port_tc_mapping_set
 * Purpose:
 *      Set the per port traffic class to priority
 *      mapping for each OOB FC Rx Interface.
 * Parameters:
 ...
 */
int
bcm_td3_oob_fc_rx_port_tc_mapping_set(int unit,
                                 bcm_oob_fc_rx_intf_id_t intf_id,
                                 bcm_gport_t gport,
                                 uint32 tc,
                                 uint32 pri_bmp)
{
    ...
    if ((tc > (_TD3_NUM_TC - 1)) || (pri_bmp > 0xFF)) {
        return BCM_E_PARAM;
    }

    BCM_IF_ERROR_RETURN
        (_bcm_td3_oob_fc_rx_port_offset_get(unit, intf_id,
                                           gport, &offset));

    /* Get lookup base */
    BCM_IF_ERROR_RETURN
        (_bcm_td3_oob_fc_rx_intf_get_lookup_base(unit, intf_id,
                                                &lookup_base));

    idx = offset + lookup_base;

    BCM_IF_ERROR_RETURN
        (_bcm_td3_oob_fc_rx_tc_mapping_set(unit, intf_id, tc,
                                          pri_bmp, idx));
...
/*
 * Function:
 *      bcm_td3_oob_fc_rx_port_tc_mapping_get
 * Purpose:
 *      Set the per port traffic class to priority
 *      mapping for each OOB FC Rx Interface.
 * Parameters:
 ...
 */
int
bcm_td3_oob_fc_rx_port_tc_mapping_get(int unit,
                                 bcm_oob_fc_rx_intf_id_t intf_id,
                                 bcm_gport_t gport,
                                 uint32 tc,
                                 uint32 *pri_bmp)
{
    ...
    BCM_IF_ERROR_RETURN
        (_bcm_td3_oob_fc_rx_tc_mapping_get(unit, intf_id, tc,
                                          pri_bmp, idx));
...
/*
 * Function:
 *      bcm_td3_oob_fc_rx_port_offset_get
 * Purpose:
 *      Get the Channel offset value for a given port
 ...
 */
int
bcm_td3_oob_fc_rx_port_offset_get(int unit,
                             bcm_oob_fc_rx_intf_id_t intf_id,
                             bcm_gport_t gport,
                             uint32 *offset)
{
...
/*
 * Function:
 *      _bcm_td3_oob_stats_config_flags_set
 * Purpose:
 ...
 */
STATIC int
_bcm_td3_oob_stats_config_flags_set(int unit, uint32 flags)
{
    uint32 rval = 0;
...
/*
 * Function:
 *      _bcm_td3_oob_stats_config_ipg_set
 * Purpose:
 ...
 */
STATIC int
_bcm_td3_oob_stats_config_ipg_set(int unit, uint8 ipg)
{
    uint32 rval = 0;
...
/*
 * Function:
 *      _bcm_td3_oob_stats_config_cfg_id_set
 * Purpose:
 *      Set the inter packet gap for OOB STATS.
 * Parameters:
 *      unit - (IN) StrataSwitch unit number
 ...
 */
STATIC int
_bcm_td3_oob_stats_config_cfg_id_set(int unit, uint8 cfg_id)
{
    uint32 rval = 0;
...
/*
 * Function:
 *      _bcm_td3_oob_stats_config_flags_get
 * Purpose:
 ...
 */
STATIC int
_bcm_td3_oob_stats_config_flags_get(int unit,
...
/*
 * Function:
 *      _bcm_td3_oob_stats_config_ipg_get
 * Purpose:
 ...
 */
STATIC int
_bcm_td3_oob_stats_config_ipg_get(int unit,
                        bcm_oob_stats_config_t *config)
{
    uint32 rval = 0;
...
/*
 * Function:
 *      _bcm_td3_oob_stats_config_cfg_id_get
 * Purpose:
 ...
 */
STATIC int
_bcm_td3_oob_stats_config_cfg_id_get(int unit,
                        bcm_oob_stats_config_t *config)
{
    uint32 rval = 0;
...
/*
 * Function:
 *      _bcm_td3_oob_stats_pool_mapping_set
 * Purpose:
 ...
 */
STATIC int
_bcm_td3_oob_stats_pool_mapping_set(int unit,
...
/*
 * Function:
 *      _bcm_td3_oob_stats_pool_mapping_get
 * Purpose:
 ...
 */
STATIC int
_bcm_td3_oob_stats_pool_mapping_get(int unit,
                        int offset, uint32 *spid)
{
    uint32 entry[SOC_MAX_MEM_WORDS];
...
/*
 * Function:
 *      _bcm_td3_oob_stats_queue_mapping_set
 * Purpose:
 ...
 */
STATIC int
_bcm_td3_oob_stats_queue_mapping_set(int unit,
                        int offset, int pipe_id, int queue_id)
{
    uint32 entry[SOC_MAX_MEM_WORDS];
...
/*
 * Function:
 *      _bcm_td3_oob_stats_queue_mapping_get
 * Purpose:
 ...
 */
STATIC int
_bcm_td3_oob_stats_queue_mapping_get(int unit, int offset,
                         bcm_gport_t *gport)
{
    ...
    pipe_id = soc_mem_field32_get(unit, STATS_INTF_QUEUE_LISTm, entry,
                                  PIPE_IDf);

    if (logical_queue_id == _TD3_OOB_STATS_END_QUEUE_REPORT) {
        *gport = _TD3_OOB_STATS_END_QUEUE_REPORT;
    } else {
        si = &SOC_INFO(unit);
        ...
        cosq = logical_queue_id % _TD3_NUM_UCAST_QUEUE_PER_PORT;
        mmu_port = (pipe_id * (SOC_TD3_MMU_PORT_STRIDE + 1))
                    + (logical_queue_id / _TD3_NUM_UCAST_QUEUE_PER_PORT); 

        phy_port = si->port_m2p_mapping[mmu_port];
        logical_port = si->port_p2l_mapping[phy_port];
        BCM_IF_ERROR_RETURN
            (_bcm_td3_cosq_port_cos_resolve(unit, logical_port, cosq,
 ...
 *      BCM_E_XXX
 */
int bcm_td3_oob_stats_config_set(int unit,
                bcm_oob_stats_config_t *config)
{
    if (config == NULL) {
        return BCM_E_PARAM;
    ...
    if (config->config_id > _TD3_MAX_STATS_CONFIG_ID) {
        return BCM_E_PARAM;
    }

    BCM_IF_ERROR_RETURN
        (_bcm_td3_oob_stats_config_flags_set(unit, config->flags));

    BCM_IF_ERROR_RETURN
        (_bcm_td3_oob_stats_config_ipg_set(unit,
                                          config->inter_pkt_gap));

    BCM_IF_ERROR_RETURN
        (_bcm_td3_oob_stats_config_cfg_id_set(unit,
                                             config->config_id));
 ...
 *      BCM_E_XXX
 */
int bcm_td3_oob_stats_config_get(int unit,
                bcm_oob_stats_config_t *config)
{
    if (config == NULL) {
        return BCM_E_PARAM;
    ...
    BCM_IF_ERROR_RETURN
        (_bcm_td3_oob_stats_config_flags_get(unit, config));

    BCM_IF_ERROR_RETURN
        (_bcm_td3_oob_stats_config_ipg_get(unit, config));

    BCM_IF_ERROR_RETURN
        (_bcm_td3_oob_stats_config_cfg_id_get(unit, config));
...
/*
 * Function:
 *      bcm_td3_oob_stats_pool_mapping_multi_set
 * Purpose:
 *      Set the service pool id at a given index in the memory
 *      so that OOB Stats will be reported in the same order
 *      as the service pool ids are programmed in the memory.
 ...
 *      BCM_E_XXX
 */
int bcm_td3_oob_stats_pool_mapping_multi_set(int unit,
                        int array_count, int *offset_array,
                        uint8 *dir_array, bcm_service_pool_id_t *pool_array)
{
    int idx = 0;

    if ((array_count < 0) || (array_count > _TD3_MAX_IDX_STATS_POOL_LIST)) {
        return BCM_E_PARAM;
    }
    ...
    for (idx = 0; idx < array_count; idx++) {
        if ((offset_array[idx] < 0) &&
            (offset_array[idx] >= _TD3_MAX_IDX_STATS_POOL_LIST)) {
            return BCM_E_PARAM;
        }
    }
    ...
    for (idx = 0; idx < array_count; idx++) {
        BCM_IF_ERROR_RETURN
            (bcm_td3_oob_stats_pool_mapping_set(unit, offset_array[idx],
                                               dir_array[idx],
                                               pool_array[idx]));
    }
...
/*
 * Function:
 *      bcm_td3_oob_stats_pool_mapping_multi_get
 * Purpose:
 *      Get the service pool id at a given index in the memory.
 *      OOB Stats will be reported in the same order
 *      as the service pool ids are programmed in the memory.
 ...
 *      BCM_E_XXX
 */
int bcm_td3_oob_stats_pool_mapping_multi_get(int unit,
                        ...
                        bcm_service_pool_id_t *pool_array, int *array_count)
{
    ...
    if ((array_max >= 0) && (array_max <= _TD3_MAX_IDX_STATS_POOL_LIST)) {
        *array_count = array_max;
    } else if (array_max > _TD3_MAX_IDX_STATS_POOL_LIST) {
        *array_count = _TD3_MAX_IDX_STATS_POOL_LIST;
    } else {
        return BCM_E_PARAM;
    }
    ...
    for (idx = 0; idx < *array_count; idx++) {
        BCM_IF_ERROR_RETURN
            (bcm_td3_oob_stats_pool_mapping_get(unit, offset_array[idx],
                                               &dir_array[idx],
                                               &pool_array[idx]));
...
/*
 * Function:
 *      bcm_td3_oob_stats_pool_mapping_set
 * Purpose:
 *      Set the service pool id at a given index in the memory
 *      so that OOB Stats will be reported in the same order
 *      as the service pool ids are programmed in the memory.
 ...
 *      BCM_E_XXX
 */
int bcm_td3_oob_stats_pool_mapping_set(int unit,
                        int offset, uint8 dir,
                        bcm_service_pool_id_t pool)
{
    uint32 spid = 0x0;

    if (((pool < 0) || (pool >= _TD3_MMU_NUM_POOL)) &&
        (pool != _TD3_OOB_STATS_END_POOL_REPORT)) {
        return BCM_E_PARAM;
    }

    if ((offset < 0) || (offset >= _TD3_MAX_IDX_STATS_POOL_LIST)) {
        return BCM_E_PARAM;
    }

    if ((dir != BCM_OOB_STATS_INGRESS) &&
        (dir != BCM_OOB_STATS_EGRESS)) {
        if (pool != _TD3_OOB_STATS_END_POOL_REPORT) {
            return BCM_E_PARAM;
        }
    }
    ...
    BCM_IF_ERROR_RETURN
        (_bcm_td3_oob_stats_pool_mapping_set(unit, offset, spid));
...
/*
 * Function:
 *      bcm_td3_oob_stats_pool_mapping_get
 * Purpose:
 *      Get the service pool id at a given index in the memory.
 *      OOB Stats will be reported in the same order
 *      as the service pool ids are programmed in the memory.
 ...
 *      BCM_E_XXX
 */
int bcm_td3_oob_stats_pool_mapping_get(int unit,
                        int offset, uint8 *dir,
                        bcm_service_pool_id_t *pool)
{
    uint32 spid = 0x0;
    ...
    BCM_IF_ERROR_RETURN
        (_bcm_td3_oob_stats_pool_mapping_get(unit, offset, &spid));

    if (spid == _TD3_OOB_STATS_END_POOL_REPORT) {
        *pool = _TD3_OOB_STATS_END_POOL_REPORT;
    } else {
        /* Ingress Service Pool spid value [0, ..., 3]*/
        /* Egress Service Pool spid value [4, ..., 7]*/
...
/*
 * Function:
 *      bcm_td3_oob_stats_queue_mapping_multi_set
 * Purpose:
 *      Set the queue id at a given index in the memory
 *      so that OOB Stats will be reported in the same order
 *      as the service pool ids are programmed in the memory.
 ...
 *      BCM_E_XXX
 */
int bcm_td3_oob_stats_queue_mapping_multi_set(int unit,
                        int array_count, int *offset_array,
                        bcm_gport_t *gport_array)
{
    int idx = 0;

    if ((array_count < 0) || (array_count > _TD3_MAX_IDX_STATS_QUEUE_LIST)) {
        return BCM_E_PARAM;
    }
    ...
    for (idx = 0; idx < array_count; idx++) {
        if ((offset_array[idx] < 0) &&
            (offset_array[idx] >= _TD3_MAX_IDX_STATS_QUEUE_LIST)) {
            return BCM_E_PARAM;
        }
    }
    ...
    for (idx = 0; idx < array_count; idx++) {
        BCM_IF_ERROR_RETURN
            (bcm_td3_oob_stats_queue_mapping_set(unit, offset_array[idx],
                                                gport_array[idx]));
    }
...
/*
 * Function:
 *      bcm_td3_oob_stats_queue_mapping_multi_get
 * Purpose:
 ...
 *      BCM_E_XXX
 */
int bcm_td3_oob_stats_queue_mapping_multi_get(int unit,
                        ...
                        bcm_gport_t *gport_array, int *array_count)
{
    ...
    if ((array_max >= 0) && (array_max <= _TD3_MAX_IDX_STATS_QUEUE_LIST)) {
        *array_count = array_max;
    } else if (array_max > _TD3_MAX_IDX_STATS_QUEUE_LIST) {
        *array_count = _TD3_MAX_IDX_STATS_QUEUE_LIST;
    } else {
        return BCM_E_PARAM;
    }
    ...
    for (idx = 0; idx < *array_count; idx++) {
        BCM_IF_ERROR_RETURN
            (bcm_td3_oob_stats_queue_mapping_get(unit, offset_array[idx],
                                                &gport_array[idx]));
    }
...
/*
 * Function:
 *      bcm_td3_oob_stats_queue_mapping_set
 * Purpose:
 *      Set the queue id at a given index in the memory
 *      so that OOB Stats will be reported in the same order
 *      as the service pool ids are programmed in the memory.
 ...
 *      BCM_E_XXX
 */
int bcm_td3_oob_stats_queue_mapping_set(int unit,
                        int offset, bcm_gport_t gport)
{
    ...
    if ((offset < 0) || (offset >= _TD3_MAX_IDX_STATS_QUEUE_LIST)) {
        return BCM_E_PARAM;
    }

    if (gport == _TD3_OOB_STATS_END_QUEUE_REPORT) {
        logical_queue_id = _TD3_OOB_STATS_END_QUEUE_REPORT;
    } else {
        si = &SOC_INFO(unit);
        ...
        BCM_IF_ERROR_RETURN
            (_bcm_td3_cosq_index_resolve(unit, gport, -1,
                                        _BCM_TD3_COSQ_INDEX_STYLE_UCAST_QUEUE,
        ...
        logical_queue_id = ((mmu_port % (SOC_TD3_MMU_PORT_STRIDE + 1)) *
                           _TD3_NUM_UCAST_QUEUE_PER_PORT) +
                           (hw_index % _TD3_NUM_UCAST_QUEUE_PER_PORT);
    }

    BCM_IF_ERROR_RETURN
        (_bcm_td3_oob_stats_queue_mapping_set(unit, offset, pipe,
                                             logical_queue_id));
...
/*
 * Function:
 *      bcm_td3_oob_stats_queue_mapping_get
 * Purpose:
 *      Get the queue id at a given index in the memory.
 *      OOB Stats will be reported in the same order
 *      as the queue ids are programmed in the memory.
 ...
 *      BCM_E_XXX
 */
int bcm_td3_oob_stats_queue_mapping_get(int unit,
                        int offset, bcm_gport_t *gport)
{
    if ((offset < 0) || (offset >= _TD3_MAX_IDX_STATS_QUEUE_LIST)) {
        return BCM_E_PARAM;
    ...
    BCM_IF_ERROR_RETURN
        (_bcm_td3_oob_stats_queue_mapping_get(unit, offset, gport));
