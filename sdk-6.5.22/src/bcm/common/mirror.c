...
bcm_mirror_payload_zero_offsets_t_init(bcm_mirror_payload_zero_offsets_t *offset)
{
    if (NULL != offset) {
        ...
        offset->l3_offset = -1;
        offset->udp_offset = -1;
        offset->l2_offset_disable = 0;
        offset->l3_offset_disable = 0;
        offset->udp_offset_disable = 0;
    }
...
/*
 * Function:
 *      bcm_mirror_encap_instance_t_init
 * Purpose:
 *      Initialize a mirror encapsulation instance structure.
 * Parameters:
 *      instance - Pointer to mirror encapsulation instance structure
 * Returns:
 *      NONE
 */
void
...
{
    if (NULL != instance) {
        sal_memset(instance, 0, sizeof(bcm_mirror_encap_instance_t));
    }
...
/*
 * Function:
 *      bcm_mirror_encap_info_t_init
 * Purpose:
 *      Initialize a mirror encapsulation information structure.
 * Parameters:
 *      info - Pointer to mirror encapsulation information structure
 * Returns:
 *      NONE
 */
void
...
{
    if (NULL != info) {
        sal_memset(info, 0, sizeof(bcm_mirror_encap_info_t));
    }
