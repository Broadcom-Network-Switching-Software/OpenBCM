...
static shr_error_e
dnx_tunnel_route_configure_tcam_line(
    int unit,
    int tcam_line,
    vtt_stages_e stage,
    int enable)
{
    ...
    switch (stage)
    {
        case (VTT1):
        {
            /** Set entry as invalid in VTT1*/
            /** Read MASK */
            sal_memset(data, 0, sizeof(data));
            data[0] = 2;
            SHR_IF_ERR_EXIT(soc_mem_write(unit, IPPF_VTACS_TCAM_BANK_COMMANDm, -1, 2 * tcam_line + 1, data));
            sal_memset(data, 0, sizeof(data));
            sal_memset(field_data, 0, sizeof(field_data));
            SHR_IF_ERR_EXIT(soc_mem_read(unit, IPPF_VTACS_TCAM_BANK_REPLYm, -1, 2 * tcam_line + 1, data));
            soc_mem_field_get(unit, IPPF_VTACS_TCAM_BANK_REPLYm, data, VTACS_TCAM_CPU_REP_DOUTf, field_data);
            /** Read KEY */
            sal_memset(data, 0, sizeof(data));
            data[0] = 2;
            SHR_IF_ERR_EXIT(soc_mem_write(unit, IPPF_VTACS_TCAM_BANK_COMMANDm, -1, 2 * tcam_line, data));
            sal_memset(data, 0, sizeof(data));
            sal_memset(field_data1, 0, sizeof(field_data1));
            SHR_IF_ERR_EXIT(soc_mem_read(unit, IPPF_VTACS_TCAM_BANK_REPLYm, -1, 2 * tcam_line, data));
            soc_mem_field_get(unit, IPPF_VTACS_TCAM_BANK_REPLYm, data, VTACS_TCAM_CPU_REP_DOUTf, field_data1);
            /** Update entry */
            sal_memset(data, 0, sizeof(data));
            soc_mem_field32_set(unit, IPPF_VTACS_TCAM_BANK_COMMANDm, data, VTACS_TCAM_CPU_CMD_WRf, 1);
            soc_mem_field32_set(unit, IPPF_VTACS_TCAM_BANK_COMMANDm, data, VTACS_TCAM_CPU_CMD_VALIDSf, enable ? 3 : 0);
            soc_mem_field_set(unit, IPPF_VTACS_TCAM_BANK_COMMANDm, data, VTACS_TCAM_CPU_CMD_KEYf, field_data1);
            soc_mem_field_set(unit, IPPF_VTACS_TCAM_BANK_COMMANDm, data, VTACS_TCAM_CPU_CMD_MASKf, field_data);
            SHR_IF_ERR_EXIT(soc_mem_write(unit, IPPF_VTACS_TCAM_BANK_COMMANDm, -1, 2 * tcam_line, data));
            break;
        }
        case (VTT2):
        {
            /** Set entry as invalid in VTT2*/
            /** Read MASK */
            sal_memset(data, 0, sizeof(data));
            data[0] = 2;
            SHR_IF_ERR_EXIT(soc_mem_write(unit, IPPF_VTBCS_TCAM_BANK_COMMANDm, -1, 2 * tcam_line + 1, data));
            sal_memset(data, 0, sizeof(data));
            sal_memset(field_data, 0, sizeof(field_data));
            SHR_IF_ERR_EXIT(soc_mem_read(unit, IPPF_VTBCS_TCAM_BANK_REPLYm, -1, 2 * tcam_line + 1, data));
            soc_mem_field_get(unit, IPPF_VTBCS_TCAM_BANK_REPLYm, data, VTBCS_TCAM_CPU_REP_DOUTf, field_data);
            /** Read KEY */
            sal_memset(data, 0, sizeof(data));
            data[0] = 2;
            SHR_IF_ERR_EXIT(soc_mem_write(unit, IPPF_VTBCS_TCAM_BANK_COMMANDm, -1, 2 * tcam_line, data));
            sal_memset(data, 0, sizeof(data));
            sal_memset(field_data1, 0, sizeof(field_data1));
            SHR_IF_ERR_EXIT(soc_mem_read(unit, IPPF_VTBCS_TCAM_BANK_REPLYm, -1, 2 * tcam_line, data));
            soc_mem_field_get(unit, IPPF_VTBCS_TCAM_BANK_REPLYm, data, VTBCS_TCAM_CPU_REP_DOUTf, field_data1);
            /** Update entry */
            sal_memset(data, 0, sizeof(data));
            soc_mem_field32_set(unit, IPPF_VTBCS_TCAM_BANK_COMMANDm, data, VTBCS_TCAM_CPU_CMD_WRf, 1);
            soc_mem_field32_set(unit, IPPF_VTBCS_TCAM_BANK_COMMANDm, data, VTBCS_TCAM_CPU_CMD_VALIDSf, enable ? 3 : 0);
            soc_mem_field_set(unit, IPPF_VTBCS_TCAM_BANK_COMMANDm, data, VTBCS_TCAM_CPU_CMD_KEYf, field_data1);
            soc_mem_field_set(unit, IPPF_VTBCS_TCAM_BANK_COMMANDm, data, VTBCS_TCAM_CPU_CMD_MASKf, field_data);
            SHR_IF_ERR_EXIT(soc_mem_write(unit, IPPF_VTBCS_TCAM_BANK_COMMANDm, -1, 2 * tcam_line, data));
            break;
        }
        case (VTT3):
        {
            /** Set entry as invalid in VTT3*/
            /** Read MASK */
            sal_memset(data, 0, sizeof(data));
            data[0] = 2;
            SHR_IF_ERR_EXIT(soc_mem_write(unit, IPPF_VTCCS_TCAM_BANK_COMMANDm, -1, 2 * tcam_line + 1, data));
            sal_memset(data, 0, sizeof(data));
            sal_memset(field_data, 0, sizeof(field_data));
            SHR_IF_ERR_EXIT(soc_mem_read(unit, IPPF_VTCCS_TCAM_BANK_REPLYm, -1, 2 * tcam_line + 1, data));
            soc_mem_field_get(unit, IPPF_VTCCS_TCAM_BANK_REPLYm, data, VTCCS_TCAM_CPU_REP_DOUTf, field_data);
            /** Read KEY */
            sal_memset(data, 0, sizeof(data));
            data[0] = 2;
            SHR_IF_ERR_EXIT(soc_mem_write(unit, IPPF_VTCCS_TCAM_BANK_COMMANDm, -1, 2 * tcam_line, data));
            sal_memset(data, 0, sizeof(data));
            sal_memset(field_data1, 0, sizeof(field_data1));
            SHR_IF_ERR_EXIT(soc_mem_read(unit, IPPF_VTCCS_TCAM_BANK_REPLYm, -1, 2 * tcam_line, data));
            soc_mem_field_get(unit, IPPF_VTCCS_TCAM_BANK_REPLYm, data, VTCCS_TCAM_CPU_REP_DOUTf, field_data1);
            /** Update entry */
            sal_memset(data, 0, sizeof(data));
            soc_mem_field32_set(unit, IPPF_VTCCS_TCAM_BANK_COMMANDm, data, VTCCS_TCAM_CPU_CMD_WRf, 1);
            soc_mem_field32_set(unit, IPPF_VTCCS_TCAM_BANK_COMMANDm, data, VTCCS_TCAM_CPU_CMD_VALIDSf, enable ? 3 : 0);
            soc_mem_field_set(unit, IPPF_VTCCS_TCAM_BANK_COMMANDm, data, VTCCS_TCAM_CPU_CMD_KEYf, field_data1);
            soc_mem_field_set(unit, IPPF_VTCCS_TCAM_BANK_COMMANDm, data, VTCCS_TCAM_CPU_CMD_MASKf, field_data);
            SHR_IF_ERR_EXIT(soc_mem_write(unit, IPPF_VTCCS_TCAM_BANK_COMMANDm, -1, 2 * tcam_line, data));
            break;
        }
        case (VTT4):
        {
            /** Set entry as invalid in VTT4*/
            /** Read MASK */
            sal_memset(data, 0, sizeof(data));
            data[0] = 2;
            SHR_IF_ERR_EXIT(soc_mem_write(unit, IPPA_VTDCS_TCAM_BANK_COMMANDm, -1, 2 * tcam_line + 1, data));
            sal_memset(data, 0, sizeof(data));
            sal_memset(field_data, 0, sizeof(field_data));
            SHR_IF_ERR_EXIT(soc_mem_read(unit, IPPA_VTDCS_TCAM_BANK_REPLYm, -1, 2 * tcam_line + 1, data));
            soc_mem_field_get(unit, IPPA_VTDCS_TCAM_BANK_REPLYm, data, VTDCS_TCAM_CPU_REP_DOUTf, field_data);
            /** Read KEY */
            sal_memset(data, 0, sizeof(data));
            data[0] = 2;
            SHR_IF_ERR_EXIT(soc_mem_write(unit, IPPA_VTDCS_TCAM_BANK_COMMANDm, -1, 2 * tcam_line, data));
            sal_memset(data, 0, sizeof(data));
            sal_memset(field_data1, 0, sizeof(field_data1));
            SHR_IF_ERR_EXIT(soc_mem_read(unit, IPPA_VTDCS_TCAM_BANK_REPLYm, -1, 2 * tcam_line, data));
            soc_mem_field_get(unit, IPPA_VTDCS_TCAM_BANK_REPLYm, data, VTDCS_TCAM_CPU_REP_DOUTf, field_data1);
            /** Update entry */
            sal_memset(data, 0, sizeof(data));
            soc_mem_field32_set(unit, IPPA_VTDCS_TCAM_BANK_COMMANDm, data, VTDCS_TCAM_CPU_CMD_WRf, 1);
            soc_mem_field32_set(unit, IPPA_VTDCS_TCAM_BANK_COMMANDm, data, VTDCS_TCAM_CPU_CMD_VALIDSf, enable ? 3 : 0);
            soc_mem_field_set(unit, IPPA_VTDCS_TCAM_BANK_COMMANDm, data, VTDCS_TCAM_CPU_CMD_KEYf, field_data1);
            soc_mem_field_set(unit, IPPA_VTDCS_TCAM_BANK_COMMANDm, data, VTDCS_TCAM_CPU_CMD_MASKf, field_data);
            SHR_IF_ERR_EXIT(soc_mem_write(unit, IPPA_VTDCS_TCAM_BANK_COMMANDm, -1, 2 * tcam_line, data));
            break;
        }
        default:
        {
            SHR_ERR_EXIT(_SHR_E_INTERNAL, "Unsupported stage %d\n", stage);
        }
    }
exit:
    SHR_FUNC_EXIT;
...
dnx_switch_control_tunnel_route_disable_set(
    ...
    int arg)
{
    int ii, stage, counter = 0;
    uint8 tcp_tunnel_route_enable, udp_tunnel_route_enable, icmp_tunnel_route_enable,
        unknown_tunnel_route_enable, gre_keep_alive_tunnel_route_enable, igmp_tunnel_route_enable;

    SHR_FUNC_INIT_VARS(unit);

    SHR_INVOKE_VERIFY_DNX(dnx_switch_control_tunnel_route_disable_set_verify(unit, arg));
    ...
    {
        tcp_tunnel_route_enable = 1;
        udp_tunnel_route_enable = 1;
        icmp_tunnel_route_enable = 1;
        unknown_tunnel_route_enable = 1;
        gre_keep_alive_tunnel_route_enable = 1;
        igmp_tunnel_route_enable = 1;
    }
    else
    {
        tcp_tunnel_route_enable = ((arg & BCM_SWITCH_TUNNEL_ROUTE_DISABLE_TCP) ? 0 : 1);
        udp_tunnel_route_enable = ((arg & BCM_SWITCH_TUNNEL_ROUTE_DISABLE_UDP) ? 0 : 1);
        icmp_tunnel_route_enable = ((arg & BCM_SWITCH_TUNNEL_ROUTE_DISABLE_ICMP) ? 0 : 1);
        unknown_tunnel_route_enable = ((arg & BCM_SWITCH_TUNNEL_ROUTE_DISABLE_UNKNOWN) ? 0 : 1);
        gre_keep_alive_tunnel_route_enable = ((arg & BCM_SWITCH_TUNNEL_ROUTE_DISABLE_GRE_KEEP_ALIVE) ? 0 : 1);
        igmp_tunnel_route_enable = ((arg & BCM_SWITCH_TUNNEL_ROUTE_DISABLE_IGMP) ? 0 : 1);
    }
    /** save in swstate the values of the input flags */
    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled.set(unit, arg));

    /**Iterate over each stage and get the amount of CS lines to me modified*/
    for (stage = 0; stage < NOF_STAGES; stage++)
    {
        SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.tcp_counter.get(unit, stage, &counter));
        for (ii = 0; ii < counter; ii++)
        {
            int tcam_line;
            SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.tcp_ctx.get(unit, stage, ii, &tcam_line));
            SHR_IF_ERR_EXIT(dnx_tunnel_route_configure_tcam_line(unit, tcam_line, stage, tcp_tunnel_route_enable));
        }
        SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.udp_counter.get(unit, stage, &counter));
        for (ii = 0; ii < counter; ii++)
        {
            int tcam_line;
            SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.udp_ctx.get(unit, stage, ii, &tcam_line));
            SHR_IF_ERR_EXIT(dnx_tunnel_route_configure_tcam_line(unit, tcam_line, stage, udp_tunnel_route_enable));
        }
        SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.icmp_counter.get(unit, stage, &counter));
        for (ii = 0; ii < counter; ii++)
        {
            int tcam_line;
            SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.icmp_ctx.get(unit, stage, ii, &tcam_line));
            SHR_IF_ERR_EXIT(dnx_tunnel_route_configure_tcam_line(unit, tcam_line, stage, icmp_tunnel_route_enable));
        }
        SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.igmp_counter.get(unit, stage, &counter));
        for (ii = 0; ii < counter; ii++)
        {
            int tcam_line;
            SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.igmp_ctx.get(unit, stage, ii, &tcam_line));
            SHR_IF_ERR_EXIT(dnx_tunnel_route_configure_tcam_line(unit, tcam_line, stage, igmp_tunnel_route_enable));
        }
        SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.unknown_counter.get(unit, stage, &counter));
        for (ii = 0; ii < counter; ii++)
        {
            int tcam_line;
            SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.unknown_ctx.get(unit, stage, ii, &tcam_line));
            SHR_IF_ERR_EXIT(dnx_tunnel_route_configure_tcam_line(unit, tcam_line, stage, unknown_tunnel_route_enable));
        }
        SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.gre_keep_alive_counter.get(unit, stage, &counter));
        for (ii = 0; ii < counter; ii++)
        {
            int tcam_line;
            SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.gre_keep_alive_ctx.get(unit, stage, ii, &tcam_line));
            SHR_IF_ERR_EXIT(dnx_tunnel_route_configure_tcam_line
                            (unit, tcam_line, stage, gre_keep_alive_tunnel_route_enable));
        }
    }
exit:
    SHR_FUNC_EXIT;
    ...
    int arg)
{
    ...
    switch (type)
    {
        ...
        case bcmSwitchMplsSpeculativeParse:
            SHR_IF_ERR_EXIT(dnx_mpls_in_lif_speculative_parsing_disable_bit_num_set(unit, arg));
            break;
    ...
    int *arg)
{
    ...
    switch (type)
    {
        ...
        case bcmSwitchMplsSpeculativeParse:
            SHR_IF_ERR_EXIT(dnx_mpls_in_lif_speculative_parsing_disable_bit_num_get(unit, arg));
            break;
        case bcmSwitchIngressVlanEditClassNull:
