    ...
    bcm_fabric_wfd_link_config_t * wfd_config)
{
    ...
    SHR_INVOKE_VERIFY_DNX(dnx_fabric_wfd_profile_set_verify(unit, flags, profile_id, links_count, wfd_config));
    ...
    int *links_count)
{
    ...
    SHR_INVOKE_VERIFY_DNX(dnx_fabric_wfd_profile_get_verify
