    ...
    uint32 *errored_token_count)
{
    ...
    SHR_IF_ERR_EXIT(dnx_algo_gpm_gport_phy_info_get(unit, link_id, DNX_ALGO_GPM_GPORT_TO_PHY_OP_LOCAL_IS_MANDATORY, &gport_info));

    SHR_INVOKE_VERIFY_DNX(dnx_fabric_if_link_status_verify(unit, gport_info.local_port, link_status, errored_token_count));
