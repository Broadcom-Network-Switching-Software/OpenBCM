    ...
    for (source_index=0; source_index<nof_sources; source_index++)
    {
        switch (sources[source_index]) {
            case bcmInstruSyncedCountersTypeIcgm:
                ...
                dbal_entry_value_field8_set(unit, entry_handle_id, DBAL_FIELD_CDU_ENABLE, INST_SINGLE, 0); 
                dbal_entry_value_field8_set(unit, entry_handle_id, DBAL_FIELD_CRPS_ENABLE, INST_SINGLE, 0); 
                break;
            case bcmInstruSyncedCountersTypeNif:
                ...
                dbal_entry_value_field8_set(unit, entry_handle_id, DBAL_FIELD_CGM_ENABLE, INST_SINGLE, 0); 
                dbal_entry_value_field8_set(unit, entry_handle_id, DBAL_FIELD_CRPS_ENABLE, INST_SINGLE, 0); 
                break;
    ...
    int mark_context_as_rx)
{
    ...
    switch (context_type) {
        ...
        case bcmEventorContextTypeTx:
            ...
            dnx_instru_eventor_generate_tx_event_eventor_header(unit, context, conf, &eventor_header);
