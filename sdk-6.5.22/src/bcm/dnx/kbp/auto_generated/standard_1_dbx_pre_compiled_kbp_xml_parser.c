...
!!!!\n\
    ...
    <MasterKey>\n\
        ...
        <Field Segment=\"3\" BitSize=\"16\" Name=\"L4_PORT_SOURCE\"/>\n\
        <Field Segment=\"4\" BitSize=\"32\" Name=\"IPV4_DIP\"/>\n\
        <Field Segment=\"5\" BitSize=\"16\" Name=\"L4_PORT_DESTINATION\"/>\n\
    </MasterKey>\n\
    <FwdContexts>\n\
...
<Opcode Name=\"SRV6_ENDPOINT_CLASSIC\" OpCode=\"12\" Valid=\"elk.application.ipv6\" ValidForAdapter=\"1\">\n\
    ...
    <Description>1 lookups (1) ";

const char *jericho2_a0_kbp_auto_generated_standard_1_standard_1_kbp_opcodes_definition_2="in IPv6!!!!Note!!!!\n\
    this is a not a real AppDB\n\
    this is KBP-Command (Master Key)\n\
    it is appear as AppDB in the device PP for the sake of completeness when transferring information to the SDK\n\
!!!!\n\
...
\n\
\n\
<Opcode Name=\"VIRTUAL_IPV4_PRIVATE_UC\" OpCode=\"8\" Valid=\"elk.application.sllb\" ValidForAdapter=\"elk.application.sllb\">\n\
    <OneLineDescription/>\n\
...
\n\
\n\
<Opcode Name=\"VIRTUAL_IPV6_PRIVATE_UC\" OpCode=\"9\" Valid=\"elk.application.sllb\" ValidForAdapter=\"elk.application.sllb\">\n\
...
const char *jericho2_a0_kbp_auto_generated_standard_1_standard_1_kbp_opcodes_definition_3=" Name=\"KBP_PCC_STATE_TABLE\" ResultLocation=\"FWD\" Segments=\"0, 1\"/>\n\
    <MasterKey>\n\
        <Field Segment=\"0\" BitSize=\"16\" Name=\"VIP_ID\"/>\n\
        <Field Segment=\"1\" BitSize=\"32\" Name=\"SIGNATURE\"/>\n\
    </MasterKey>\n\
