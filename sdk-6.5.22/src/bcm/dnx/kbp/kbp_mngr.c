...
shr_error_e kbp_mngr_opcode_to_contexts_get(int unit,uint8 opcode_id,uint8 *fwd_nof_contexts,kbp_mngr_fwd_acl_context_mapping_t fwd_acl_ctx_mapping[DNX_DATA_MAX_FIELD_EXTERNAL_TCAM_MAX_FWD_CONTEXT_NUM_FOR_ONE_APPTYPE]){DNX_KBP_DUMMY_PROTOTYPE_ERR_MSG("kbp_mngr_opcode_to_contexts_get");}
