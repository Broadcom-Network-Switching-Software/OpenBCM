    ...
    bcm_tunnel_terminator_t * info)
{
    ...
    {
        SHR_ERR_EXIT(_SHR_E_PARAM,
                     "tunnel types bcmTunnelTypeEthSR6, bcmTunnelTypeEthIn6 and bcmTunnelTypeEthCascadedFunct must set with a non-zero vlan if P@P flag is not present");
    }
    ...
    uint32 *srv6_flags)
{
     ...
     */
    if (DNX_TUNNEL_TERM_SRV6_IS_SRV6_WITH_GENERALIZED_SEGMENT_ID(info))
    {
        in_lif_profile_info_t in_lif_profile_info;
