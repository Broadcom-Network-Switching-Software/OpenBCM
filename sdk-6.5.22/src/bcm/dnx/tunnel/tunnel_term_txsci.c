 ...
 * {
 */
/** The indication of next header after ESP being IPvX */
#define DNX_TUNNEL_TERM_TXSCI_IP_NIBBLE_PREFIX 1
/** The indication of next header after ESP being UDP */
#define DNX_TUNNEL_TERM_TXSCI_UDP_VXLAN_NIBBLE_PREFIX 0
/*
 * }
 */
/*
 ...
 * {
 */
/** Define header after ESP to be either IP or UDP based on tunnel type*/
#define DNX_TUNNEL_TERM_TXSCI_NIBBLE_PREFIX_SET(tunnel_type) ((tunnel_type == bcmTunnelTypeEsp) ? DNX_TUNNEL_TERM_TXSCI_IP_NIBBLE_PREFIX : DNX_TUNNEL_TERM_TXSCI_UDP_VXLAN_NIBBLE_PREFIX)
/*
 * }
 */
