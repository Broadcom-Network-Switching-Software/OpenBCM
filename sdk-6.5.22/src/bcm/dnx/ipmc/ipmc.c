 ...
 */
#define IPMC_BRIDGE_TABLES_NOF    4
/*
 ...
 */
#define IPMC_IPV6_BRIDGE_TABLES_NOF     2
/*
 * }
 */
    ...
    bcm_ipmc_addr_t * data)
{
    ...
    if (_SHR_IS_FLAG_SET(data->flags, BCM_IPMC_IP6))
    {
        ...
        /** Verify the input for host and route entries */
        if (!_SHR_IS_FLAG_SET(data->flags, BCM_IPMC_TCAM))
        {
            if (!IPMC_IS_IPV6_HOST_ENTRY(data, kaps_public_capacity))
            {
            ...
            /** Verify the input for route entries */
            if (!_SHR_IS_FLAG_SET(data->flags, BCM_IPMC_L2))
            {
                ...
                {
                    SHR_ERR_EXIT(_SHR_E_PARAM,
                                 "Cannot create an IPv6 MC public LEM entry when KAPS2 capacity is not 0.\n");
                }

                if (!IPMC_IS_IPV6_HOST_ENTRY(data, kaps_public_capacity) && data->vrf == 0 && kaps_public_capacity != 0)
                {
                    SHR_ERR_EXIT(_SHR_E_PARAM,
                                 "Cannot create an IPv6 MC public LPM entry when KAPS2 capacity is not 0.\n");
                }
    ...
    else
    {
        ...
        else
        {
            ...
            if (IPMC_IS_IPV4_HOST_ENTRY(data, kaps_public_capacity)
    ...
    else
    {
        ...
        if (dbal_table_type == DBAL_TABLE_TYPE_EM)
        {
            ...
            if (result_type == DBAL_RESULT_TYPE_IPV4_MULTICAST_EM_FORWARD_FWD_DEST
                ...
                || result_type == DBAL_RESULT_TYPE_BRIDGE_IPV4_MULTICAST_IVL_FWD_DEST
                || result_type == DBAL_RESULT_TYPE_BRIDGE_IPV4_MULTICAST_IVL_FWD_DEST_STAT
    ...
    void *user_data)
{
    ...
    uint32 dbal_tables[] = {
        ...
        DBAL_TABLE_IPV4_MULTICAST_TCAM_FORWARD,
        DBAL_TABLE_KBP_IPV4_MULTICAST_TCAM_FORWARD,
        DBAL_TABLE_BRIDGE_IPV4_MULTICAST_IVL, DBAL_TABLE_BRIDGE_IPV4_MULTICAST_SVL,
        DBAL_TABLE_BRIDGE_IPV4_MULTICAST_SOURCE_SPECIFIC_SVL,
        DBAL_TABLE_BRIDGE_IPV4_MULTICAST_SOURCE_SPECIFIC_IVL, DBAL_TABLE_IPV6_MULTICAST_EM_FORWARD,
        DBAL_TABLE_IPV6_MULTICAST_PRIVATE_LPM_FORWARD,
        DBAL_TABLE_IPV6_MULTICAST_TCAM_FORWARD,
        DBAL_TABLE_KBP_IPV6_MULTICAST_TCAM_FORWARD,
        DBAL_TABLE_BRIDGE_IPV6_MULTICAST_SOURCE_SPECIFIC_SVL,
    ...
    if (!_SHR_IS_FLAG_SET(flags, BCM_IPMC_IP6))
    {
         ...
         * This includes SVL and IVL EM and LPM tables.
