    ...
    bcm_sat_gtf_t gtf_id)
{
    ...
    if (is_paired)
    {
        ...
        SHR_INVOKE_VERIFY_DNX(dnx_sat_gtf_destroy_verify(unit, gtf_id + 1));
    ...
    bcm_sat_gtf_bandwidth_t * bw)
{
    ...
    SHR_INVOKE_VERIFY_DNX(dnx_sat_gtf_id_priority_verify(unit, gtf_id, priority));
    ...
    if (!(dnx_bandwidth.flags & BCM_SAT_GTF_RATE_IN_PACKETS) && gtf_rate_factor)
    {

        bw->rate = bw->rate * (DNX_SAT_GTF_RATE_CMP_CONVERSION / gtf_rate_factor);
    }
    ...
    bcm_sat_gtf_bandwidth_t * bw)
{
    ...
    SHR_INVOKE_VERIFY_DNX(dnx_sat_gtf_bandwidth_set_verify(unit, gtf_to_set, bw, gtf_rate_factor));
    ...
    bcm_sat_gtf_rate_pattern_t * config)
{
    ...
    if (priority == bcmSatGtfPriAll)
    {
        SHR_INVOKE_VERIFY_DNX(dnx_sat_evc_rate_pattern_set_verify(unit, gtf_id, config));
    ...
    else
    {
        ...
        SHR_INVOKE_VERIFY_DNX(dnx_sat_gtf_rate_pattern_set_verify(unit, gtf_to_set, config));
