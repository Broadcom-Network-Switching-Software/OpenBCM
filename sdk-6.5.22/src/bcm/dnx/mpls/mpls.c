 ...
 */
shr_error_e
dnx_mpls_in_lif_speculative_parsing_disable_bit_num_set(
    int unit,
    int bit_num)
{
    uint32 entry_handle_id;
    ...
    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_DIS_SPECULATIVE_PARSING_BIT_NUM_IN_GENERAL_DATA,
                                 INST_SINGLE, bit_num);
    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT));
 ...
 */
shr_error_e
dnx_mpls_in_lif_speculative_parsing_disable_bit_num_get(
    int unit,
    int *bit_num)
{
    uint32 entry_handle_id;
    ...
    dbal_value_field32_request(unit, entry_handle_id, DBAL_FIELD_DIS_SPECULATIVE_PARSING_BIT_NUM_IN_GENERAL_DATA,
                               INST_SINGLE, &field_v);
    SHR_IF_ERR_EXIT(dbal_entry_get(unit, entry_handle_id, DBAL_COMMIT));
