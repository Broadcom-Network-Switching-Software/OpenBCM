    ...
    bcm_port_match_info_t * new_match)
{
    ...
    SHR_INVOKE_VERIFY_DNX(dnx_port_match_verify(unit, port, new_match));
    ...
    int esem_cmd)
{
    ...
    else
    {
        ...
        if (port_in_lag)
        {
            ...
            if (_SHR_IS_FLAG_SET(flags, DNX_ALGO_PORT_APP_FLAG_COE))
            {
                uint32 tcam_access_id;
                uint32 key_value;
                /** Get PP port of COE port in LAG */
                SHR_IF_ERR_EXIT(dnx_port_prt_tcam_virtual_port_tcam_coe_lag_sw_get
                                (unit, port, (uint32 *) &core_id, &pp_port, &tcam_access_id, &key_value));
            }
            else
            {
    ...
    bcm_port_match_info_t * match_info)
{
    ...
    SHR_INVOKE_VERIFY_DNX(dnx_port_match_add_verify(unit, port, match_info));
    ...
    bcm_port_match_info_t * match_info)
{
    ...
    SHR_INVOKE_VERIFY_DNX(dnx_port_match_delete_verify(unit, port, match_info));
    ...
    bcm_port_match_info_t * new_match)
{
    ...
    SHR_INVOKE_VERIFY_DNX(dnx_port_match_replace_verify(unit, port, old_match, new_match));
