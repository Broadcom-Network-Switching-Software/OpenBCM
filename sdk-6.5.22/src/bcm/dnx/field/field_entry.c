 ...
 * {
 */
dnx_field_group_tcam_cache_t dnx_field_group_tcam_entry_cache[DNX_DATA_MAX_FIELD_GROUP_NOF_FGS];
/*
 * }
 */
    ...
    dnx_field_entry_t * entry_info_p)
{
    ...
    {
        SHR_IF_ERR_EXIT(dbal_entry_attribute_request(unit, entry_handle_id, DBAL_ENTRY_ATTR_CACHED, cached_indication));
    }
...
*/
static shr_error_e
dnx_field_entry_tcam_access_id_allocate(
    int unit,
    uint32 flags,
    int core,
    uint32 *entry_access_id_p)
{
    ...
    if (flags & DNX_FIELD_GROUP_ADD_FLAG_WITH_ID)
    {
        ...
        access_id = DNX_FIELD_ENTRY_TCAM_INTERNAL_ACCESS_ID(*entry_access_id_p);
    }
     ...
     */
    *entry_access_id_p = DNX_FIELD_ENTRY_TCAM_INTERNAL(access_id, core);
exit:
    SHR_FUNC_EXIT;
}
...
/**
* \brief
*   Verify function. Checks if a TCAM handler is a direct table, and if so fails.
* \param [in] unit             - Device ID
* \param [in] dbal_table_id    - DBAL table. Used for error message only.
* \param [in] tcam_handler_id  - The TCAM handler ID associated with dbal_table_id.
* \return
*   shr_error_e - Error Type
* \remark
*   * None
...
*/
static shr_error_e
dnx_field_entry_verify_dbal_table_not_dt_verify(
    int unit,
    dbal_tables_e dbal_table_id,
    uint32 tcam_handler_id)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_tcam_handler_is_direct(unit, tcam_handler_id, &is_direct_table));
    if (is_direct_table)
    {
        SHR_ERR_EXIT(_SHR_E_PARAM,
                     "DBAL table %d is associated with TCAM handler %d but it is direct table and not TCAM.\n",
                     dbal_table_id, tcam_handler_id);
    }
...
/**
* \brief
*  Allocates place in TCAM at the given core to for the new entry
* \param [in] unit                - Device ID
* \param [in] flags               - dnx_field_entry_add_flags_e flags.
* \param [in] core                - Core ID
...
* \param [in] entry_access_id     -  Unique allocated handle for TCAM entry (see encoding in DNX_FIELD_TCAM_ENTRY)
* \return
*   shr_error_e - Error Type
* \remark
*   * None
...
*/
static shr_error_e
dnx_field_entry_tcam_location_allocate(
    int unit,
    uint32 flags,
    int core,
    dnx_field_group_t fg_id,
    ...
    uint32 *entry_access_id_p)
{
    ...
    SHR_INVOKE_VERIFY_DNX(dnx_field_entry_verify_dbal_table_not_dt_verify(unit, dbal_table_id, tcam_handler_id));

    SHR_IF_ERR_EXIT(dnx_field_entry_tcam_access_id_allocate(unit, 0, core, entry_access_id_p));

    SHR_IF_ERR_EXIT(dnx_field_entry_tcam_location_allocate(unit, 0, core, DNX_DATA_MAX_FIELD_GROUP_NOF_FGS,
...
/**
* \brief
*  This function create Id to be put in HW at the given core.
...
*/
static shr_error_e
dnx_field_entry_pmf_access_id_allocate(
    int unit,
    uint32 flags,
    int core,
    dnx_field_group_type_e fg_type,
    ...
    uint32 *entry_access_id_p)
{
    ...
    if (fg_type == DNX_FIELD_GROUP_TYPE_TCAM)
    {
        ...
        SHR_IF_ERR_EXIT(dnx_field_entry_tcam_access_id_allocate(unit, flags, core, entry_access_id_p));
    }
    else
    {
...
/**
* \brief
*  This function find a place for id to be put in HW at the given core.
*  Only used for TCAM field groups.
*
* \param [in] unit                - Device Id
* \param [in] flags               - dnx_field_entry_add_flags_e flags.
...
* \param [in] entry_access_id     - Access_id that was allocated for this entry
* \return
*   shr_error_e - Error Type
* \remark
*   * none
...
*/
static shr_error_e
dnx_field_entry_pmf_location_allocate(
    int unit,
    uint32 flags,
    int core,
    dnx_field_group_type_e fg_type,
    ...
    uint32 entry_access_id)
{
    ...
    if (fg_type == DNX_FIELD_GROUP_TYPE_TCAM)
    {
        uint32 tcam_handler_id = DNX_FIELD_TCAM_HANDLER_INVALID;
        SHR_IF_ERR_EXIT(dnx_field_group_tcam_handler_id_get(unit, fg_id, &tcam_handler_id));
        SHR_IF_ERR_EXIT(dnx_field_entry_tcam_location_allocate
                        (unit, flags, core, fg_id, tcam_handler_id, priority, entry_access_id));
    }
    else
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "This function does not support FG type %d\r\n", fg_type);
...
/**See H in field_entry.h*/
shr_error_e
dnx_field_entry_access_id_deallocate(
    int unit,
    uint32 entry_access_id)
{
    uint32 access_id;
    ...
    access_id = DNX_FIELD_ENTRY_TCAM_INTERNAL_ACCESS_ID(entry_access_id);
    ...
    uint32 entry_access_id)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_entry_access_id_deallocate(unit, entry_access_id));
    ...
    uint32 *entry_handle_p)
{
    ...
    if (flags & DNX_FIELD_ENTRY_ADD_FLAG_WITH_ID)
    {
        ...
        int handle_core = DNX_FIELD_ENTRY_TCAM_INTERNAL_CORE_ID(*entry_handle_p);
         ...
         * Create clean entry
         */
        clean_entry_handle = DNX_FIELD_ENTRY_TCAM_INTERNAL(access_id, dnx_core);
        /*
    ...
    int new_size)
{
    ...
    sal_memcpy(entry_list, dnx_field_group_tcam_entry_cache[fg_id].tcam_entries,
               dnx_field_group_tcam_entry_cache[fg_id].nof_valid_entries * sizeof(dnx_field_group_tcam_cache_entry_t));

    /*
     * Copy new cache list pointer to global variable
     */
    SHR_FREE(dnx_field_group_tcam_entry_cache[fg_id].tcam_entries);
    dnx_field_group_tcam_entry_cache[fg_id].tcam_entries = NULL;
    dnx_field_group_tcam_entry_cache[fg_id].cache_size = new_size;
    dnx_field_group_tcam_entry_cache[fg_id].tcam_entries = entry_list;
    ...
    uint32 *entry_handle_p)
{
    ...
    /*
     * Skip finding location for access ID for update procedure
     */
    if (!(flags & DNX_FIELD_ENTRY_ADD_FLAG_UPDATE))
    {
        /** Find location for created ID */
        SHR_IF_ERR_EXIT(dnx_field_entry_pmf_location_allocate
    ...
    int *entry_found_p)
{
    ...
    *entry_found_p = FALSE;
    ...
    if (dnx_field_group_tcam_entry_cache[fg_id].tcam_entries != NULL)
    {
        nof_valid_entries = dnx_field_group_tcam_entry_cache[fg_id].nof_valid_entries;
        for (entry_idx = 0; entry_idx < nof_valid_entries; entry_idx++)
        {
            if (dnx_field_group_tcam_entry_cache[fg_id].tcam_entries[entry_idx].entry_handle == entry_handle)
            {
                *entry_found_p = TRUE;
                sal_memcpy(&(dnx_field_group_tcam_entry_cache[fg_id].tcam_entries[entry_idx].entry_info), entry_info_p,
                           sizeof(dnx_field_group_tcam_entry_cache[fg_id].tcam_entries[entry_idx].entry_info));
                break;
            }
        }
    }
    ...
    uint32 *entry_handle_p)
{
    ...
    /** Get the needed information of the Field Group that the entry is being configured for */
    SHR_IF_ERR_EXIT(dnx_field_group_type_get(unit, fg_id, &fg_type));
    cache_mode = dnx_field_group_tcam_entry_cache[fg_id].cache_mode;
    ...
    if (!(flags & DNX_FIELD_ENTRY_ADD_FLAG_UPDATE))
    {
        /** Allocate entry access ID **/
        SHR_IF_ERR_EXIT(dnx_field_entry_pmf_access_id_allocate
                        (unit, flags, entry_info_p->core, fg_type, fg_id, entry_handle_p));
    }

    if (cache_mode != DNX_FIELD_GROUP_CACHE_MODE_START || (flags & DNX_FIELD_ENTRY_ADD_FLAG_UPDATE))
    {
        /*
    ...
    {
        cache_size = dnx_field_group_tcam_entry_cache[fg_id].cache_size;
        nof_valid_entries = dnx_field_group_tcam_entry_cache[fg_id].nof_valid_entries;
         ...
         */
        dnx_field_group_tcam_entry_cache[fg_id].tcam_entries[nof_valid_entries].entry_handle = *entry_handle_p;
        sal_memcpy(&(dnx_field_group_tcam_entry_cache[fg_id].tcam_entries[nof_valid_entries].entry_info), entry_info_p,
                   sizeof(dnx_field_group_tcam_entry_cache[fg_id].tcam_entries[nof_valid_entries].entry_info));
        dnx_field_group_tcam_entry_cache[fg_id].nof_valid_entries++;
    }
exit:
    SHR_FUNC_EXIT;
}
    ...
    uint32 *entry_handle_p)
{
    ...
    *entry_handle_p = DNX_FIELD_ENTRY_TCAM_DT(key, fg_id, entry_info_p->core);
    ...
    uint32 *entry_handle_p)
{
    ...
    /** Verify the input.*/
    SHR_INVOKE_VERIFY_DNX(dnx_field_entry_kbp_add_verify(unit, 0, fg_id, entry_info_p, entry_handle_p));
    ...
    if ((dnx_field_group_tcam_entry_cache[fg_id].cache_mode == DNX_FIELD_GROUP_CACHE_MODE_START) &&
        !(flags & DNX_FIELD_ENTRY_ADD_FLAG_UPDATE))
    {
    ...
    int *entry_found_p)
{
    ...
    *entry_found_p = FALSE;
    ...
    {
        nof_valid_entries = dnx_field_group_tcam_entry_cache[fg_id].nof_valid_entries;
        for (entry_idx = 0; entry_idx < dnx_field_group_tcam_entry_cache[fg_id].nof_valid_entries; entry_idx++)
        {
            if (dnx_field_group_tcam_entry_cache[fg_id].tcam_entries[entry_idx].entry_handle == entry_handle)
            {
                *entry_found_p = TRUE;
        ...
        if (*entry_found_p)
        {
             ...
             */
            dnx_field_group_tcam_entry_cache[fg_id].tcam_entries[entry_idx].entry_handle = DNX_FIELD_KEY_ID_INVALID;
            if (entry_idx != nof_valid_entries - 1)
            {
                sal_memcpy(&(dnx_field_group_tcam_entry_cache[fg_id].tcam_entries[entry_idx].entry_info),
                           &(dnx_field_group_tcam_entry_cache[fg_id].tcam_entries[nof_valid_entries - 1].entry_info),
                           sizeof(dnx_field_group_tcam_entry_cache[fg_id].tcam_entries[entry_idx].entry_info));
                dnx_field_group_tcam_entry_cache[fg_id].tcam_entries[entry_idx].entry_handle =
                    dnx_field_group_tcam_entry_cache[fg_id].tcam_entries[nof_valid_entries - 1].entry_handle;
                dnx_field_group_tcam_entry_cache[fg_id].tcam_entries[nof_valid_entries - 1].entry_handle =
                    DNX_FIELD_KEY_ID_INVALID;
            }
            dnx_field_group_tcam_entry_cache[fg_id].nof_valid_entries--;

            SHR_IF_ERR_EXIT(dnx_field_entry_access_id_deallocate(unit, entry_handle));
        }
    }
exit:
    SHR_FUNC_EXIT;
    ...
    uint32 entry_handle)
{
    ...
    if ((dnx_field_group_tcam_entry_cache[fg_id].cache_mode == DNX_FIELD_GROUP_CACHE_MODE_START) && is_entry_cached)
    {
    ...
    *entry_found_p = FALSE;
    if (dnx_field_group_tcam_entry_cache[fg_id].tcam_entries != NULL)
    {
        ...
        for (entry_idx = 0; entry_idx < nof_valid_entries; entry_idx++)
        {
            ...
            {
                *entry_found_p = TRUE;
                sal_memcpy(entry_info_p, &(dnx_field_group_tcam_entry_cache[fg_id].tcam_entries[entry_idx].entry_info),
                           sizeof(dnx_field_group_tcam_entry_cache[fg_id].tcam_entries[entry_idx].entry_info));
                /*
    ...
    dnx_field_entry_t * entry_info_p)
{
    ...
    if (fg_type == DNX_FIELD_GROUP_TYPE_DIRECT_TABLE_TCAM)
    {
        entry_info_p->core = DNX_FIELD_ENTRY_TCAM_DT_CORE_ID(entry_handle);
    }
    else
    {
        entry_info_p->core = DNX_FIELD_ENTRY_TCAM_INTERNAL_CORE_ID(entry_handle);
    }
    ...
    uint32 entry_handle)
{
    ...
    {
        /** Iterate over valid cores and clear hit info, on all cores, for the given entry. */
    ...
    else
    {
        ...
        core_id = DNX_FIELD_ENTRY_TCAM_INTERNAL_DT_CORE_ID(entry_handle);
