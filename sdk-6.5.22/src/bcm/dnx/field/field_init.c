    ...
    int unit)
{
    ...
    DNXCMN_CORES_ITER(unit, BCM_CORE_ALL, core_id)
    {
        ...
        if (dnx_data_field.map.supported_get(unit))
        {
    ...
    int unit)
{
    ...
    if (dnx_data_field.tests.epmf_debug_rely_on_tcam0_get(unit))
    {
        ...
        {
            SHR_IF_ERR_EXIT(dnx_field_key_kbr_init(unit, field_stage, ctx_id, key_id));
        }
    }
    ...
    int unit)
{
    ...
    */
    if (dnx_data_field.exem.supported_get(unit) || dnx_data_field.map.supported_get(unit))
    {
    ...
    if (dnx_data_field.map.supported_get(unit))
    {
         ...
         */
        map_stage = dnx_data_field.map.pmf_map_stage_get(unit);
    ...
    int unit)
{
    ...
    if (dnx_data_field.features.tcam_cs_enable_get(unit))
    {
    ...
    int unit)
{
    ...
    if (dnx_data_field.udh.supported_get(unit))
    {
    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_group_init(unit));
