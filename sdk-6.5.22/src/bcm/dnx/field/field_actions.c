    ...
    dbal_enum_value_field_field_io_e actions_block)
{
    ...
    if (((int) actions_block < 0) || (actions_block >= DBAL_NOF_ENUM_FIELD_IO_VALUES))
    {
    ...
    unsigned int nof_fes_quartets)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_map_stage_info_get(unit, DNX_FIELD_STAGE_ACE, &field_map_stage_info));
    ...
    dnx_field_actions_fes_single_add_conf_t efes_encoded_extraction[DNX_DATA_MAX_FIELD_COMMON_MAX_VAL_NOF_PROG_PER_FES])
{
    ...
    if (field_stage == DNX_FIELD_STAGE_IPMF1 || field_stage == DNX_FIELD_STAGE_IPMF2)
    {
        ...
        SHR_INVOKE_VERIFY_DNX(dnx_algo_field_fem_priority_verify_contention_inside_context
                              (unit, field_stage, context_id));
    }
    ...
    dnx_field_fem_action_entry_t fem_action_entry[DNX_DATA_MAX_FIELD_COMMON_MAX_VAL_NOF_FEM_MAP_INDEX])
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_fem_action_find_action_types(unit, fg_id, fem_encoded_actions, fem_action_entry));
    {
        ...
        }
        {
            ...
            SHR_INVOKE_VERIFY_DNX(dnx_algo_field_fem_priority_verify_contention_inside_group
...
shr_error_e
dnx_field_action_fem_is_fem_id_availalbe(
    int unit,
    dnx_field_fem_id_t fem_id,
    dnx_field_group_t fg_id,
    dnx_field_group_t second_fg_id,
