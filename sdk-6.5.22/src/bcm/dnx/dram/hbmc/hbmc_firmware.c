    ...
    dnx_hbmc_firmware_aapl_params_t * aapl_params)
{
    ...
    if (aapl_params->pl != DNX_HBMC_FIRMWARE_AAPL_CMD_DEFAULT)
    {
        LOG_CLI((BSL_META("Setting hbm_parity_latency parameter to %d at Sbus addr %s\n"), aapl_params->pl,
                 aapl_addr_to_str(sbus_addr)));
        AAPL_IF_ERR_EXIT(avago_hbm_set_parameter
                         (aapl, sbus_addr, hbm2e ? AVAGO_HBM2E_PHY_CONFIG_PAR_LATENCY : AVAGO_HBM_PARITY_LATENCY,
                          aapl_params->pl));
    }
    ...
    if (aapl_params->t_rdlat_offset != DNX_HBMC_FIRMWARE_AAPL_CMD_DEFAULT)
    {
        LOG_CLI((BSL_META("Setting hbm_t_rdlat_offset parameter to %d at Sbus addr %s\n"), aapl_params->t_rdlat_offset,
                 aapl_addr_to_str(sbus_addr)));
        AAPL_IF_ERR_EXIT(avago_hbm_set_parameter
                         (aapl, sbus_addr, hbm2e ? AVAGO_HBM2E_PHY_CONFIG_T_RDLAT_OFFSET : AVAGO_HBM_T_RDLAT_OFFSET,
                          aapl_params->t_rdlat_offset));
    }
    ...
    if (aapl_params->dll != DNX_HBMC_FIRMWARE_AAPL_CMD_DEFAULT)
    {
        LOG_CLI((BSL_META("Setting dll delay_config to %d at Sbus addr %s\n"), aapl_params->dll,
                 aapl_addr_to_str(sbus_addr)));
        AAPL_IF_ERR_EXIT(avago_hbm_set_parameter
                         (aapl, sbus_addr, hbm2e ? AVAGO_HBM2E_QC_DLL_CONFIG : AVAGO_HBM_DELAY_CONFIG_DLL,
        ...
        || aapl_params->qc_ck != DNX_HBMC_FIRMWARE_AAPL_CMD_DEFAULT)
    {
        ...
        LOG_CLI((BSL_META("Setting phy quarter-cycle to rd:%d wr:%d ck:%d at Sbus addr %s\n"), aapl_params->qc_rd,
                 aapl_params->qc_wr, aapl_params->qc_ck, aapl_addr_to_str(sbus_addr)));
    ...
    {
        LOG_CLI((BSL_META("Setting phy quarter-cycle to rd:%d wr:%d ck:%d at Sbus addr %s\n"), aapl_params->qc,
                 aapl_params->qc, aapl_params->qc, aapl_addr_to_str(sbus_addr)));
        AAPL_IF_ERR_EXIT(avago_hbm_set_phy_quarter_cycle
    ...
    if (aapl_params->mmt_read_repeat != DNX_HBMC_FIRMWARE_AAPL_CMD_DEFAULT)
    {
        ...
        AAPL_IF_ERR_EXIT(avago_hbm_set_parameter
                         (aapl, sbus_addr, hbm2e ? AVAGO_HBM2E_MMT_READ_REPEAT : AVAGO_HBM_MMT_READ_REPEAT,
    ...
    if (aapl_params->mmt_t_rdlat_offset != DNX_HBMC_FIRMWARE_AAPL_CMD_DEFAULT)
    {
        ...
        AAPL_IF_ERR_EXIT(avago_hbm_set_parameter
                         (aapl, sbus_addr, hbm2e ? AVAGO_HBM2E_MMT_T_RDLAT_OFFSET : AVAGO_MMT_T_RDLAT_OFFSET,
    ...
    switch (aapl_cmd)
    {
        ...
        case DNX_HBMC_FIRMWARE_AAPL_CMD_OPERATION:
        {
            ...
            LOG_CLI((BSL_META("Begin HBM%u operation 0x%02x for all channels at Sbus addr %s\n"), dram_index,
                     aapl_params->operation, aapl_addr_to_str(sbus_addr)));
            AAPL_IF_ERR_EXIT(avago_hbm_launch_operation
        ...
        case DNX_HBMC_FIRMWARE_AAPL_CMD_AERR:
        {
            ...
            rc = avago_hbm_launch_operation(aapl, sbus_addr, hbm2e ? AVAGO_HBM2E_OP_BIST_AERR : AVAGO_HBM_OP_AERR_TEST,
                                            &results, aapl_params->operation_timeout);
            AAPL_IF_ERR_EXIT(avago_hbm_print_operation_results(aapl, &results));
            if (rc != 0)
            {
        ...
        case DNX_HBMC_FIRMWARE_AAPL_CMD_AERR_ILB:
        {
            ...
            rc = avago_hbm_launch_operation(aapl, sbus_addr,
                                            hbm2e ? AVAGO_HBM2E_OP_BIST_AERR_ILB : AVAGO_HBM_OP_AERR_ILB, &results,
                                            aapl_params->operation_timeout);
            AAPL_IF_ERR_EXIT(avago_hbm_print_operation_results(aapl, &results));
            if (rc != 0)
            {
        ...
        case DNX_HBMC_FIRMWARE_AAPL_CMD_AERR_SLB:
        {
            ...
            rc = avago_hbm_launch_operation(aapl, sbus_addr,
                                            hbm2e ? AVAGO_HBM2E_OP_BIST_AERR_SLB : AVAGO_HBM_OP_AERR_SLB, &results,
                                            aapl_params->operation_timeout);
            AAPL_IF_ERR_EXIT(avago_hbm_print_operation_results(aapl, &results));
            if (rc != 0)
            {
        ...
        case DNX_HBMC_FIRMWARE_AAPL_CMD_DERR:
        {
            ...
            rc = avago_hbm_launch_operation(aapl, sbus_addr, hbm2e ? AVAGO_HBM2E_OP_BIST_DERR : AVAGO_HBM_OP_DERR_TEST,
                                            &results, aapl_params->operation_timeout);
            AAPL_IF_ERR_EXIT(avago_hbm_print_operation_results(aapl, &results));
            if (rc != 0)
            {
        ...
        case DNX_HBMC_FIRMWARE_AAPL_CMD_DERR_ILB:
        {
            ...
            rc = avago_hbm_launch_operation(aapl, sbus_addr,
                                            hbm2e ? AVAGO_HBM2E_OP_BIST_DERR_ILB : AVAGO_HBM_OP_DERR_ILB, &results,
                                            aapl_params->operation_timeout);
            AAPL_IF_ERR_EXIT(avago_hbm_print_operation_results(aapl, &results));
            if (rc != 0)
            {
        ...
        case DNX_HBMC_FIRMWARE_AAPL_CMD_DERR_SLB:
        {
            ...
            rc = avago_hbm_launch_operation(aapl, sbus_addr,
                                            hbm2e ? AVAGO_HBM2E_OP_BIST_DERR_SLB : AVAGO_HBM_OP_DERR_SLB, &results,
                                            aapl_params->operation_timeout);
            AAPL_IF_ERR_EXIT(avago_hbm_print_operation_results(aapl, &results));
            if (rc != 0)
            {
        ...
        case DNX_HBMC_FIRMWARE_AAPL_CMD_AWORD:
        {
            ...
            rc = avago_hbm_launch_operation(aapl, sbus_addr,
                                            hbm2e ? AVAGO_HBM2E_OP_BIST_AWORD : AVAGO_HBM_OP_AWORD_TEST, &results,
                                            aapl_params->operation_timeout);
            AAPL_IF_ERR_EXIT(avago_hbm_print_operation_results(aapl, &results));
            if (rc != 0)
            {
        ...
        case DNX_HBMC_FIRMWARE_AAPL_CMD_AWORD_ILB:
        {
            ...
            rc = avago_hbm_launch_operation(aapl, sbus_addr,
                                            hbm2e ? AVAGO_HBM2E_OP_BIST_AWORD_ILB : AVAGO_HBM_OP_AWORD_ILB, &results,
                                            aapl_params->operation_timeout);
            AAPL_IF_ERR_EXIT(avago_hbm_print_operation_results(aapl, &results));
            if (rc != 0)
            {
        ...
        case DNX_HBMC_FIRMWARE_AAPL_CMD_AWORD_SLB:
        {
            ...
            rc = avago_hbm_launch_operation(aapl, sbus_addr,
                                            hbm2e ? AVAGO_HBM2E_OP_BIST_AWORD_SLB : AVAGO_HBM_OP_AWORD_SLB, &results,
                                            aapl_params->operation_timeout);
            AAPL_IF_ERR_EXIT(avago_hbm_print_operation_results(aapl, &results));
            if (rc != 0)
            {
        ...
        case DNX_HBMC_FIRMWARE_AAPL_CMD_DWORD_READ:
        {
            ...
            LOG_CLI((BSL_META("Running dword read operation at Sbus address %s\n"), aapl_addr_to_str(sbus_addr)));
            rc = avago_hbm_launch_operation(aapl, sbus_addr,
                                            hbm2e ? AVAGO_HBM2E_OP_BIST_DWORD_READ : AVAGO_HBM_OP_DWORD_READ, &results,
                                            aapl_params->operation_timeout);
            AAPL_IF_ERR_EXIT(avago_hbm_print_operation_results(aapl, &results));
            if (rc != 0)
            {
        ...
        case DNX_HBMC_FIRMWARE_AAPL_CMD_LANE_REPAIR:
        {
            ...
            AAPL_IF_ERR_EXIT(avago_hbm_launch_operation
                             (aapl, sbus_addr, hbm2e ? AVAGO_HBM2E_OP_LANE_REPAIR : AVAGO_HBM_OP_LANE_REPAIR, &results,
                              aapl_params->operation_timeout));
            AAPL_IF_ERR_EXIT(avago_hbm_print_operation_results(aapl, &results));
            AAPL_IF_ERR_EXIT(avago_hbm_print_spare_results(aapl, sbus_addr));
            break;
        ...
        case DNX_HBMC_FIRMWARE_AAPL_CMD_BURN_LANE_REPAIRS:
        {
            ...
            AAPL_IF_ERR_EXIT(avago_hbm_launch_operation
                             (aapl, sbus_addr,
                              hbm2e ? AVAGO_HBM2E_OP_BURN_LANE_REPAIRS : AVAGO_HBM_OP_BURN_HARD_REPAIRS, &results,
                              aapl_params->operation_timeout));
            AAPL_IF_ERR_EXIT(avago_hbm_print_operation_results(aapl, &results));
            break;
        }
        case DNX_HBMC_FIRMWARE_AAPL_CMD_CATTRIP:
        {
            ...
            AAPL_IF_ERR_EXIT(avago_hbm_launch_operation
                             (aapl, sbus_addr, hbm2e ? AVAGO_HBM2E_OP_TEST_CATTRIP : AVAGO_HBM_OP_CATTRIP, &results,
                              aapl_params->operation_timeout));
            AAPL_IF_ERR_EXIT(avago_hbm_print_operation_results(aapl, &results));
            break;
        }
        case DNX_HBMC_FIRMWARE_AAPL_CMD_RESET_MRS:
        {
            ...
            AAPL_IF_ERR_EXIT(avago_hbm_launch_operation
                             (aapl, sbus_addr, hbm2e ? AVAGO_HBM2E_OP_PROGRAM_MRS : AVAGO_HBM_OP_RESET_MODE_REGISTERS,
                              &results, aapl_params->operation_timeout));
            AAPL_IF_ERR_EXIT(avago_hbm_print_operation_results(aapl, &results));
            break;
        }
        case DNX_HBMC_FIRMWARE_AAPL_CMD_RESET_PHY_CONFIG:
        {
            ...
            AAPL_IF_ERR_EXIT(avago_hbm_launch_operation
                             (aapl, sbus_addr,
                              hbm2e ? AVAGO_HBM2E_OP_PROGRAM_PHY_CONFIG_AND_QC : AVAGO_HBM_OP_RESET_PHY_CONFIG,
                              &results, aapl_params->operation_timeout));
            AAPL_IF_ERR_EXIT(avago_hbm_print_operation_results(aapl, &results));
            break;
        }
        case DNX_HBMC_FIRMWARE_AAPL_CMD_SAMSUNG_CHIPPING:
        {
            ...
            AAPL_IF_ERR_EXIT(avago_hbm_launch_operation
                             (aapl, sbus_addr,
                              hbm2e ? AVAGO_HBM2E_OP_TEST_CHIPPING : AVAGO_HBM_OP_SAMSUNG_CHIPPING_TEST, &results,
                              aapl_params->operation_timeout));
            AAPL_IF_ERR_EXIT(avago_hbm_print_operation_results(aapl, &results));
            break;
        }
