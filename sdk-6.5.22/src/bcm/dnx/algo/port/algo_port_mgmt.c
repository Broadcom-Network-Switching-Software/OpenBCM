 ...
 */
shr_error_e
dnx_algo_port_in_tm_port_nof_get(
    int unit,
    bcm_port_t logical_port,
    int *in_tm_port_nof)
{
    ...
    /** Get in tm port nof */
    SHR_IF_ERR_EXIT(dnx_algo_port_db.in_tm.in_tm_port_nof.get(unit, in_tm_handle.h0, in_tm_handle.h1, in_tm_port_nof));
    ...
    dnx_algo_port_mib_counter_set_type_e counter_set_types[DNX_ALGO_PORT_COUNTER_SETS_MAX])
{
    ...
    *nof_types = 0;
    ...
    if (DNX_ALGO_PORT_TYPE_IS_NIF
        (unit, port_info, TRUE /** ELK*/ , TRUE /** STIF */ , TRUE /** L1 */ , TRUE /** FLEXE*/ ))
    {
        /** verify array size to avoid memory corruption */
        SHR_MAX_VERIFY(*nof_types, (DNX_ALGO_PORT_COUNTER_SETS_MAX - 1), _SHR_E_INTERNAL,
                       "Port=%d counter_set_types array size=%d is too small, required=%d",
