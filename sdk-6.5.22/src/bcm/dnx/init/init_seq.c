...
static const  dnx_init_step_t dnx_init_deinit_tm_seq[] = {
  ...
  {DNX_INIT_STEP_FLOW_CONTROL_MODULE,           "Flow Control",         dnx_fc_init,                    NULL,                       fc_skip,           WB_SKIP | TIME_PER_DEV,     NULL},
  ...
  {DNX_INIT_STEP_PFC_DEADLOCK_MODULE,           "PFC Deadlock",         dnx_pfc_deadlock_init,          dnx_pfc_deadlock_deinit,    fc_skip,           0,                          NULL},
