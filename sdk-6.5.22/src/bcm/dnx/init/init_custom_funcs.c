    ...
    uint32 *entry_data)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_map_stage_info_get(unit, DNX_FIELD_STAGE_IPMF3, &field_map_stage_info));
    SHR_IF_ERR_EXIT(dbal_fields_enum_hw_value_get(unit, field_map_stage_info.action_field_id, action_type, &hw_value));
    ...
    uint32 *entry_data)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_map_stage_info_get(unit, DNX_FIELD_STAGE_EPMF, &field_map_stage_info));
    SHR_IF_ERR_EXIT(dbal_fields_enum_hw_value_get(unit, field_map_stage_info.action_field_id, action_type, &hw_value));
    ...
    uint32 *entry_data)
{
     ...
     */
    if (index % 2 == 0 && FIELD_TCAM_LOCATION_IS_VALID(index))
    {
