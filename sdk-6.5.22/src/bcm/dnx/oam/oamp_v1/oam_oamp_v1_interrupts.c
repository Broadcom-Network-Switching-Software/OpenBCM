 ...
 */
shr_error_e
dnx_oam_oamp_v1_event_to_bcm_bfd_event_type(
    int unit,
 ...
 */
shr_error_e
dnx_oam_oamp_v1_event_to_bcm_oam_event_type(
    int unit,
    const dnx_oam_oamp_interrupt_event_data_t event_data,
    ...
    void *host_entry)
{
    ...
    *valid_event_exist = 0;
    ...
    for (instance = 0; instance < max_format_events; instance++)
    {
        ...
        {   /** Update RMEP state */
            event[instance].rmep_state.bfd_state.flags_profile = DNX_OAM_BFD_RMEP_STATE_FLAGS_PROF_GET(rmep_state);
