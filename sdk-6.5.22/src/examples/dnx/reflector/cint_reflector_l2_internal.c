        ...
        bcm_field_context_t epmf_context_id)
{
    ...
    rv = cint_reflector_l2_internal_uc_fp_entry_add(unit, fg_id, &fg_info, in_port, mapping_info_egress.tm_port, 0, ace_entry_handle);
    if (rv != BCM_E_NONE)
    {
        printf("cint_reflector_l2_internal_fp_entry_add failed\n");
        return rv;
        ...
        bcm_field_context_t epmf_context_id)
{
    ...
    rv = cint_reflector_l2_internal_uc_fp_entry_add(unit, fg_id, &fg_info, in_port, mapping_info_egress.tm_port, mapping_info_rcy.tm_port, ace_entry_handle);
    if (rv != BCM_E_NONE)
    {
        printf("cint_reflector_l2_internal_fp_entry_add failed\n");
        return rv;
