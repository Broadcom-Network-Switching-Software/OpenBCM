 ...
 * 
 ...
 Copyright 2007-2021 Broadcom Inc. All rights reserved. File: cint_stat_pp_port_ingress_meter_crps.c Purpose: Statistics examples for SDK ingress APIs using PP port object.
 */
...
struct cint_stat_pp_config_meter_s
{
    ...
    int expand_per_tc;        /* meter expansion is per TC*/
    ...
    cint_stat_pp_config_meter_s cint_stat_pp_config_meter_info)
{
    ...
    rv = policer_generic_meter_database_example(unit,
                                                                                      ...
                                                                                      cint_stat_pp_config_meter_info.expand_per_tc,
