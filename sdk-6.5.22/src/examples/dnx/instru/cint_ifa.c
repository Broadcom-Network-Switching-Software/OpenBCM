 ...
 * 
 ...
 Copyright 2007-2021 Broadcom Inc. All rights reserved. File: cint_ifa.c Purpose: basic examples for ifa 1.0 Datapath.
 */
 ...
 *                   Tail_edit_profile=IPT_PROFILE_IFA1. This chooses IFA_First Context in Term, Forward and ENC1-3.
 ...
 *                   is set to IPT_PROFILE_IFA1. iPMF3 is hit because of the container and then INT is set to 1. The contexts of
