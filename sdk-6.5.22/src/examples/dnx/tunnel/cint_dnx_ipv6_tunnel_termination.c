 ...
 * 
 ...
 Copyright 2007-2021 Broadcom Inc. All rights reserved. File: cint_dnx_ipv6_tunnel_termination.c Purpose: Various examples for IPv6 Tunnels.
 */
...
int ipv6_tunnel_terminator_create(int unit, int is_mp, int *tunnel_term_id)
{
    ...
    {
        tunnel_termination_obj.sci = cint_ipv6_tunnel_info.txsci;
        tunnel_termination_obj.priority =  0;
    }
