 ...
 *        60038ea3007d2b80 123456789abceeffffeecba987654321 aaaabbbbcccc3333dd03000000000003
...
cint_srv6_tunnel_info_s cint_srv6_tunnel_info =
{
         ...
         * tunnel_ip6_dip
         */
        {{ 0xAA, 0xAA, 0xBB, 0xBB, 0xCC, 0xCC, 0x11, 0x11, 0xBB, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
                    ...
                    int default_lif_for_cascading)
{
    ...
    if(default_lif_for_cascading)
    {
        ...
        tunnel_term_set.flags &= ~(BCM_TUNNEL_TERM_GENERALIZED_SEGMENT_ID_END_OF_COMPRESSION|BCM_TUNNEL_TERM_GENERALIZED_SEGMENT_ID);
                        ...
                        uint8 is_gsid_eoc)        /** if set, the last GSID in SID is EOC */
{
    ...
    rv = l3__egress_only_fec__create(unit, cint_srv6_tunnel_info.tunnel_fec_id[END_POINT_2_FEC_ID], cint_srv6_tunnel_info.eth_rif_intf_out[ENDPOINT_GSID0], cint_srv6_tunnel_info.tunnel_arp_id[ENDPOINT_GSID0], gport, 0);
    if (rv != BCM_E_NONE)
    {
        printf
...

   {
     ...
     */
    {
        ...
        srv6_tunnel_termination(unit, DIP_ENDPOINT_GSID1, 0, cint_srv6_tunnel_info.vrf_in[ENDPOINT_GSID1], 0, 1, 0, 0);
        srv6_tunnel_termination(unit, DIP_ENDPOINT_GSID0, 0, cint_srv6_tunnel_info.vrf_in[ENDPOINT_GSID0], 0, 1, is_gsid_eoc, 0);
        ...
        if (next_header_is_eth)
        {
            ...
            srv6_tunnel_termination(unit, DIP_EGRESS, 1, cint_srv6_tunnel_info.vrf_in[EGRESS], cint_srv6_tunnel_info.l2_termination_vsi, 1, 0, 0);
            /** to allow termination of GSID because of SL == 0 && EOC */
            srv6_tunnel_termination(unit, DIP_EGRESS_EOC, 1, cint_srv6_tunnel_info.vrf_in[EGRESS], cint_srv6_tunnel_info.l2_termination_vsi, 1, is_gsid_eoc, 0);
        }
        else
        {
            /** to allow termination of GSID because of SL == 0 && SI==0 */
            srv6_tunnel_termination(unit, DIP_EGRESS, 1, cint_srv6_tunnel_info.vrf_in[EGRESS], 0, 1, 0, 0);
            /** to allow termination of GSID because of SL == 0 && EOC */
            srv6_tunnel_termination(unit, DIP_EGRESS_EOC, 1, cint_srv6_tunnel_info.vrf_in[EGRESS], 0, 1, is_gsid_eoc, 0);
        }
        srv6_tunnel_termination(unit, DIP_ENDPOINT_GSID1, 0, cint_srv6_tunnel_info.vrf_in[ENDPOINT_GSID1], 0, 1, 0, default_tunnel_for_gsid_cascading);
    }
