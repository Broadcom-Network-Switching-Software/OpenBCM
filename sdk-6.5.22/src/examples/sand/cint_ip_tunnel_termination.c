 ...
 * 
 ...
 Copyright 2007-2021 Broadcom Inc. All rights reserved. File: cint_ip_tunnel_termination.c Purpose: Various examples for IPTunnels.
 */
    ...
    int unit)
{
    ...
    if(cint_ip_tunnel_basic_info.esp_term)
    {
        ...
        tunnel_term.sci = cint_ip_tunnel_basic_info.txsci;
    } else {
