    ...
    int access_side_sys_port)
{
    ...
    rv = vxlan_split_horizon_set(core_side_unit, cint_vxlan_roo_info.vpn_id, 0, cint_vxlan_roo_info.vxlan_network_group_id);
    if (rv != BCM_E_NONE)
    {
    ...
    int access_side_sys_port)
{
     ...
     */
    rv = vxlan_port_add(core_side_unit, core_side_sys_port, cint_vxlan_roo_info.vxlan_tunnel_if, &vxlan_port_id);
    if (rv != BCM_E_NONE) 
    {
