...
{
    // Firebolt6 does not have blackhawk ports. Hence FALSE.
    BCM_IF_ERROR_RETURN( Th3TimeConfigSet(ing_port1, egr_port, FALSE) );
    ...
    BCM_FIELD_ASET_ADD(group_config.aset, bcmFieldActionIngressTimeStampInsert);
    BCM_FIELD_ASET_ADD(group_config.aset, bcmFieldActionEgressTimeStampInsert);
