...
/*
 * Feature  : UTT Mode D configuration
 *
 * Usage    : BCM.0> cint utt_mode_d_configuration.c
 *
 * config   : utt_mode_d_config.bcm
 *
 * Log file : utt_mode_d_configuration_log.txt
 *
 * Test Topology :
 *
 *                  +------------------------------+
 ...
 *   Mode D: IFP TCAMs - 24, LPM TCAMS - 64
 *
