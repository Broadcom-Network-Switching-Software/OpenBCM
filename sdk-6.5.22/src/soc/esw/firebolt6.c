...
soc_firebolt6_mem_config(int unit)
{
    ...
    */
    ...
    if (soc_feature(unit, soc_feature_td3x4_ax_reduced_nhop)) {
        sop->memState[ING_L3_NEXT_HOPm].index_max = 32768;
        sop->memState[INITIAL_ING_L3_NEXT_HOPm].index_max = 32768;
        sop->memState[EGR_L3_NEXT_HOPm].index_max = 32768;
    }
    ...
    if (soc_feature(unit, soc_feature_td3x4_ax_reduced_ifp_meter_table)) {
        sop->memState[IFP_METER_TABLEm].index_max = 6144;
        sop->memState[IFP_METER_TABLE_PIPE0m].index_max = 6144;
    }
