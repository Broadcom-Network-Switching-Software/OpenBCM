                                     ...
                                     char *mem_str)
{
    ...
    log_generic.parity_type = SOC_PARITY_TYPE_EDATABUF;
...
soc_td_ser_test(int unit, _soc_ser_test_t test_type)
{
    ...
    soc_acc_type_t acc_type;
    soc_field_t test_field = INVALIDf;
    int default_sleep_time = soc_ser_test_long_sleep_time_us;
#ifdef INCLUDE_MEM_SCAN
    ...
    soc_ser_test_long_sleep_time_us = default_sleep_time;
#ifdef INCLUDE_MEM_SCAN
    if (memscan_running) {
