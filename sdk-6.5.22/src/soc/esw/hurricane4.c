...
soc_hurricane4_mem_config(int unit)
{
    ...
    sop->memState[L2_ENTRY_LPm].index_max = (num_l2_dedicated_banks * 8192) - 1;
    ...
    sop->memState[L3_ENTRY_LPm].index_max = (num_l3_dedicated_banks * 7168) - 1;
    ...
    if (soc_feature(unit, soc_feature_td3x1_reduced_ecmp)) {
        ...
        sop->memState[INITIAL_L3_ECMPm].index_max = 511;
        sop->memState[L3_ECMPm].index_max = 511;
    }
    ...
    if (soc_feature(unit, soc_feature_td3x1_reduced_l3intf)) {
        sop->memState[L3_IIFm].index_max = 1023;
        sop->memState[L3_IIF_ATTRS_1m].index_max = 1023;
        sop->memState[L3_IIF_ATTRS_1m].index_max = 1023;
        sop->memState[EGR_L3_INTFm].index_max = 1023;
    }

    /* Adjust VRF */
    if (soc_feature(unit, soc_feature_td3x1_novrf)) {
        sop->memState[VRF_ATTRS_2m].index_max = -1;
        sop->memState[VRF_PROFILEm].index_max = -1;
    }

    /* Adjust VFI */
    if (soc_feature(unit, soc_feature_td3x1_reduced_vfi)) {
        sop->memState[VFIm].index_max = 511;
        sop->memState[VFI_ATTRS_1m].index_max = 511;
        sop->memState[EGR_VFIm].index_max = 511;
    }
    ...
    if (soc_feature(unit, soc_feature_td3x1_reduced_flex_counter)) {
        ...
        sop->memState[ING_FLEX_CTR_COUNTER_TABLE_16m].index_max = -1;
        sop->memState[ING_FLEX_CTR_COUNTER_TABLE_17m].index_max = -1;
        sop->memState[ING_FLEX_CTR_COUNTER_TABLE_18m].index_max = -1;
        sop->memState[ING_FLEX_CTR_COUNTER_TABLE_19m].index_max = -1;
        sop->memState[ING_FLEX_CTR_COUNTER_TABLE_10_PIPE0m].index_max = -1;
        sop->memState[ING_FLEX_CTR_COUNTER_TABLE_11_PIPE0m].index_max = -1;
        sop->memState[ING_FLEX_CTR_COUNTER_TABLE_12_PIPE0m].index_max = -1;
        sop->memState[ING_FLEX_CTR_COUNTER_TABLE_13_PIPE0m].index_max = -1;
        sop->memState[ING_FLEX_CTR_COUNTER_TABLE_14_PIPE0m].index_max = -1;
        sop->memState[ING_FLEX_CTR_COUNTER_TABLE_15_PIPE0m].index_max = -1;
        sop->memState[ING_FLEX_CTR_COUNTER_TABLE_16_PIPE0m].index_max = -1;
        sop->memState[ING_FLEX_CTR_COUNTER_TABLE_17_PIPE0m].index_max = -1;
        sop->memState[ING_FLEX_CTR_COUNTER_TABLE_18_PIPE0m].index_max = -1;
        sop->memState[ING_FLEX_CTR_COUNTER_TABLE_19_PIPE0m].index_max = -1;
        ...
        sop->memState[ING_FLEX_CTR_OFFSET_TABLE_16m].index_max = -1;
        sop->memState[ING_FLEX_CTR_OFFSET_TABLE_17m].index_max = -1;
        sop->memState[ING_FLEX_CTR_OFFSET_TABLE_18m].index_max = -1;
        sop->memState[ING_FLEX_CTR_OFFSET_TABLE_19m].index_max = -1;
        sop->memState[EGR_FLEX_CTR_COUNTER_TABLE_2m].index_max = -1;
        sop->memState[EGR_FLEX_CTR_COUNTER_TABLE_3m].index_max = -1;
        sop->memState[EGR_FLEX_CTR_COUNTER_TABLE_2_PIPE0m].index_max = -1;
        sop->memState[EGR_FLEX_CTR_COUNTER_TABLE_3_PIPE0m].index_max = -1;
        sop->memState[EGR_FLEX_CTR_OFFSET_TABLE_2m].index_max = -1;
        sop->memState[EGR_FLEX_CTR_OFFSET_TABLE_3m].index_max = -1;
    }
