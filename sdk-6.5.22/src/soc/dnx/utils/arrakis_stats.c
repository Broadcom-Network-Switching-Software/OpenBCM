    ...
    char *sample)
{
    ...
    sal_strncat(stat_family->samples[dimension_idx], sample,
                ARRAKIS_STATS_SAMPLES_STR_MAX_LEN - 1 - sal_strnlen(stat_family->samples[dimension_idx],
                                                                    sizeof(stat_family->samples[dimension_idx])));
    ...
    arrakis_stat_family_t * stat_family)
{
    ...
    for (dim_idx = 0; dim_idx < stat_family->dimensions_nof; dim_idx++)
    {
        ...
        sal_strncat(dimension_str, stat_family->samples[dim_idx],
                    ARRAKIS_STATS_DIMENSION_AND_SAMPLES_STR_MAX_LEN - 1 - sal_strnlen(dimension_str,
                                                                                      sizeof(dimension_str)));
