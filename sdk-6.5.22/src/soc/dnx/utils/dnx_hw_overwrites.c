    ...
    int unit)
{
        ...
        for (ii = 0; ii < 64; ii++)
        {
                 ...
                 || ((field_0 >> 1) == hw_context_id3)) && (field_1 == 1))
            {
                ...
                soc_mem_field32_set(unit, ETPPC_FORWARDING_CONTEXT_SELECTION_CAMm, data,
                                    (soc_is(unit, J2P_DEVICE)) ? TERMINATION_CONTEXT_PROFILEf : TERMINATION_CONTEXTf,
                                    0);
                soc_mem_field32_set(unit, ETPPC_FORWARDING_CONTEXT_SELECTION_CAMm, data,
                                    (soc_is(unit, J2P_DEVICE)) ? TERMINATION_CONTEXT_PROFILE_MASKf :
                                    TERMINATION_CONTEXT_MASKf, 0x3f);
...

    {
        ...
        dbal_enum_value_field_fwd1_context_id_e ipv4uc_context_list[5] = {
            DBAL_ENUM_FVAL_FWD1_CONTEXT_ID_IPV4___NOP_CTX_MACT_SA_LKP,
    ...
    if (is_image_standard_1)
    {
        ...
        int udp_counter = 0;
        int tcp_counter = 0;
        int gre_keep_alive_counter = 0;
        int unknown_counter = 0;
        uint32 context_field = 0;
        uint32 next_layer_type_field = 0;
        uint8 is_init;

        SHR_IF_ERR_EXIT(switch_db.is_init(unit, &is_init));
        if (!is_init)
        {
            switch_db.init(unit);
        }

        SHR_IF_ERR_EXIT(DBAL_HANDLE_CLEAR(unit, DBAL_TABLE_VT1_CONTEXT_SELECTION, entry_handle_id));
        for (ii = 0; ii < 128; ii++)
        {
            int rv = 0;
            SHR_IF_ERR_EXIT(dbal_entry_handle_access_id_set(unit, entry_handle_id, ii));
            ...
            SHR_IF_ERR_EXIT(dbal_entry_handle_value_field32_get
                            (unit, entry_handle_id, DBAL_FIELD_VT2_CONTEXT_ID, 0, &context_field));
            SHR_IF_ERR_EXIT(dbal_entry_handle_key_field_arr32_get
                            (unit, entry_handle_id, DBAL_FIELD_LAYER_TYPE_NEXT_LAYER, &next_layer_type_field));

            if (next_layer_type_field != DBAL_ENUM_FVAL_LAYER_TYPES_INITIALIZATION)
            {
                if ((next_layer_type_field == DBAL_ENUM_FVAL_LAYER_TYPES_ICMP)
                    && (context_field == DBAL_ENUM_FVAL_VT2_CONTEXT_ID_GENERAL___NOP_CTX))
                {
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.icmp_ctx.set(unit, VTT1, icmp_counter++, ii));
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.icmp_counter.set(unit, VTT1, icmp_counter));
                }
                else if ((next_layer_type_field == DBAL_ENUM_FVAL_LAYER_TYPES_IGMP)
                         && (context_field == DBAL_ENUM_FVAL_VT2_CONTEXT_ID_MAC_IN_MAC___LEARN))
                {
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.igmp_ctx.set(unit, VTT1, igmp_counter++, ii));
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.igmp_counter.set(unit, VTT1, igmp_counter));
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_VT2_CONTEXT_ID, 0,
                                                 DBAL_ENUM_FVAL_VT2_CONTEXT_ID_GENERAL___NOP_CTX);
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_CONTEXT_VALID, 0, 1);
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_NASID_VALID, 0, 1);
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_NASID, 0, 2);
                    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT_UPDATE));
                }
                else if ((next_layer_type_field == DBAL_ENUM_FVAL_LAYER_TYPES_UDP)
                         && (context_field == DBAL_ENUM_FVAL_VT2_CONTEXT_ID_MAC_IN_MAC___LEARN))
                {
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.udp_ctx.set(unit, VTT1, udp_counter++, ii));
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.udp_counter.set(unit, VTT1, udp_counter));
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_VT2_CONTEXT_ID, 0,
                                                 DBAL_ENUM_FVAL_VT2_CONTEXT_ID_GENERAL___NOP_CTX);
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_CONTEXT_VALID, 0, 1);
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_NASID_VALID, 0, 1);
                ...
                else if ((next_layer_type_field == DBAL_ENUM_FVAL_LAYER_TYPES_TCP)
                         && (context_field == DBAL_ENUM_FVAL_VT2_CONTEXT_ID_GENERAL___NOP_CTX))
                {
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.tcp_ctx.set(unit, VTT1, tcp_counter++, ii));
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.tcp_counter.set(unit, VTT1, tcp_counter));
                }
                else if ((next_layer_type_field == DBAL_ENUM_FVAL_LAYER_TYPES_UNKNOWN)
                         && (context_field == DBAL_ENUM_FVAL_VT2_CONTEXT_ID_MAC_IN_MAC___LEARN))
                {
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.
                                    gre_keep_alive_ctx.set(unit, VTT1, gre_keep_alive_counter++, ii));
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.
                                    gre_keep_alive_counter.set(unit, VTT1, gre_keep_alive_counter));
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_VT2_CONTEXT_ID, 0,
                                                 DBAL_ENUM_FVAL_VT2_CONTEXT_ID_GENERAL___NOP_CTX);
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_CONTEXT_VALID, 0, 1);
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_NASID_VALID, 0, 1);
                ...
                {
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.
                                    unknown_ctx.set(unit, VTT1, unknown_counter++, ii));
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.
                                    unknown_counter.set(unit, VTT1, unknown_counter));
                }
            }
        }
        ...
        udp_counter = 0;
        tcp_counter = 0;
        gre_keep_alive_counter = 0;
        unknown_counter = 0;
        SHR_IF_ERR_EXIT(DBAL_HANDLE_CLEAR(unit, DBAL_TABLE_VT2_CONTEXT_SELECTION, entry_handle_id));
        for (ii = 0; ii < 128; ii++)
        {
            int rv = 0;
            SHR_IF_ERR_EXIT(dbal_entry_handle_access_id_set(unit, entry_handle_id, ii));
            ...
            SHR_IF_ERR_EXIT(dbal_entry_handle_value_field32_get
                            (unit, entry_handle_id, DBAL_FIELD_VT3_CONTEXT_ID, 0, &context_field));
            SHR_IF_ERR_EXIT(dbal_entry_handle_key_field_arr32_get
                            (unit, entry_handle_id, DBAL_FIELD_LAYER_TYPE_NEXT_LAYER, &next_layer_type_field));
            ...
            {
                if ((next_layer_type_field == DBAL_ENUM_FVAL_LAYER_TYPES_ICMP)
                    && (context_field == DBAL_ENUM_FVAL_VT3_CONTEXT_ID_GENERAL___NOP_CTX))
                {
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.icmp_ctx.set(unit, VTT2, icmp_counter++, ii));
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.icmp_counter.set(unit, VTT2, icmp_counter));
                }
                else if ((next_layer_type_field == DBAL_ENUM_FVAL_LAYER_TYPES_IGMP)
                         && (context_field == DBAL_ENUM_FVAL_VT3_CONTEXT_ID_MPLS___IFIT))
                {
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.igmp_ctx.set(unit, VTT2, igmp_counter++, ii));
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.igmp_counter.set(unit, VTT2, igmp_counter));
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_VT3_CONTEXT_ID, 0,
                                                 DBAL_ENUM_FVAL_VT3_CONTEXT_ID_GENERAL___NOP_CTX);
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_CONTEXT_VALID, 0, 1);
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_NASID_VALID, 0, 1);
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_NASID, 0, 3);
                    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT_UPDATE));
                }
                else if ((next_layer_type_field == DBAL_ENUM_FVAL_LAYER_TYPES_UDP)
                         && (context_field == DBAL_ENUM_FVAL_VT3_CONTEXT_ID_MPLS___IFIT))
                {
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.udp_ctx.set(unit, VTT2, udp_counter++, ii));
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.udp_counter.set(unit, VTT2, udp_counter));
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_VT3_CONTEXT_ID, 0,
                                                 DBAL_ENUM_FVAL_VT3_CONTEXT_ID_GENERAL___NOP_CTX);
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_CONTEXT_VALID, 0, 1);
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_NASID_VALID, 0, 1);
                    ...
                    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT_UPDATE));
                         ...
                         && (context_field == DBAL_ENUM_FVAL_VT3_CONTEXT_ID_GENERAL___NOP_CTX))
                {
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.tcp_ctx.set(unit, VTT2, tcp_counter++, ii));
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.tcp_counter.set(unit, VTT2, tcp_counter));
                }
                else if ((next_layer_type_field == DBAL_ENUM_FVAL_LAYER_TYPES_UNKNOWN)
                         && (context_field == DBAL_ENUM_FVAL_VT3_CONTEXT_ID_MPLS___IFIT))
                {
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.
                                    gre_keep_alive_ctx.set(unit, VTT2, gre_keep_alive_counter++, ii));
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.
                                    gre_keep_alive_counter.set(unit, VTT2, gre_keep_alive_counter));
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_VT3_CONTEXT_ID, 0,
                                                 DBAL_ENUM_FVAL_VT3_CONTEXT_ID_GENERAL___NOP_CTX);
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_CONTEXT_VALID, 0, 1);
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_NASID_VALID, 0, 1);
                ...
                {
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.
                                    unknown_ctx.set(unit, VTT2, unknown_counter++, ii));
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.
                                    unknown_counter.set(unit, VTT2, unknown_counter));
                }
            }
        }
        icmp_counter = 0;
        ...
        SHR_IF_ERR_EXIT(DBAL_HANDLE_CLEAR(unit, DBAL_TABLE_VT3_CONTEXT_SELECTION, entry_handle_id));
        for (ii = 0; ii < 128; ii++)
        {
            int rv = 0;
            SHR_IF_ERR_EXIT(dbal_entry_handle_access_id_set(unit, entry_handle_id, ii));
            ...
            SHR_IF_ERR_EXIT(dbal_entry_handle_value_field32_get
                            (unit, entry_handle_id, DBAL_FIELD_VT4_CONTEXT_ID, 0, &context_field));
            SHR_IF_ERR_EXIT(dbal_entry_handle_key_field_arr32_get
                            (unit, entry_handle_id, DBAL_FIELD_LAYER_TYPE_NEXT_LAYER, &next_layer_type_field));
            ...
            {
                if ((next_layer_type_field == DBAL_ENUM_FVAL_LAYER_TYPES_ICMP)
                    && (context_field == DBAL_ENUM_FVAL_VT4_CONTEXT_ID_GENERAL___NOP_CTX))
                {
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.icmp_ctx.set(unit, VTT3, icmp_counter++, ii));
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.icmp_counter.set(unit, VTT3, icmp_counter));
                }
                else if ((next_layer_type_field == DBAL_ENUM_FVAL_LAYER_TYPES_IGMP)
                         && (context_field == DBAL_ENUM_FVAL_VT4_CONTEXT_ID_MPLS___IFIT))
                {
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.igmp_ctx.set(unit, VTT3, igmp_counter++, ii));
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.igmp_counter.set(unit, VTT3, igmp_counter));
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_VT4_CONTEXT_ID, 0,
                                                 DBAL_ENUM_FVAL_VT3_CONTEXT_ID_GENERAL___NOP_CTX);
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_CONTEXT_VALID, 0, 1);
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_NASID_VALID, 0, 1);
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_NASID, 0, 4);
                    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT_UPDATE));
                }
                else if ((next_layer_type_field == DBAL_ENUM_FVAL_LAYER_TYPES_UDP)
                         && (context_field == DBAL_ENUM_FVAL_VT4_CONTEXT_ID_MPLS___IFIT))
                {
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.udp_ctx.set(unit, VTT3, udp_counter++, ii));
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.udp_counter.set(unit, VTT3, udp_counter));
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_VT4_CONTEXT_ID, 0,
                                                 DBAL_ENUM_FVAL_VT3_CONTEXT_ID_GENERAL___NOP_CTX);
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_CONTEXT_VALID, 0, 1);
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_NASID_VALID, 0, 1);
                    ...
                    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT_UPDATE));
                         ...
                         && (context_field == DBAL_ENUM_FVAL_VT4_CONTEXT_ID_GENERAL___NOP_CTX))
                {
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.tcp_ctx.set(unit, VTT3, tcp_counter++, ii));
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.tcp_counter.set(unit, VTT3, tcp_counter));
                }
                else if ((next_layer_type_field == DBAL_ENUM_FVAL_LAYER_TYPES_UNKNOWN)
                         && (context_field == DBAL_ENUM_FVAL_VT4_CONTEXT_ID_MPLS___IFIT))
                {
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.
                                    gre_keep_alive_ctx.set(unit, VTT3, gre_keep_alive_counter++, ii));
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.
                                    gre_keep_alive_counter.set(unit, VTT3, gre_keep_alive_counter));
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_VT4_CONTEXT_ID, 0,
                                                 DBAL_ENUM_FVAL_VT3_CONTEXT_ID_GENERAL___NOP_CTX);
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_CONTEXT_VALID, 0, 1);
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_NASID_VALID, 0, 1);
                ...
                {
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.
                                    unknown_ctx.set(unit, VTT3, unknown_counter++, ii));
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.
                                    unknown_counter.set(unit, VTT3, unknown_counter));
                }
            }
        }
        ...
        SHR_IF_ERR_EXIT(DBAL_HANDLE_CLEAR(unit, DBAL_TABLE_VT4_CONTEXT_SELECTION, entry_handle_id));
        for (ii = 0; ii < 128; ii++)
        {
            int rv = 0;
            SHR_IF_ERR_EXIT(dbal_entry_handle_access_id_set(unit, entry_handle_id, ii));
            ...
            SHR_IF_ERR_EXIT(dbal_entry_handle_value_field32_get
                            (unit, entry_handle_id, DBAL_FIELD_VT5_CONTEXT_ID, 0, &context_field));
            SHR_IF_ERR_EXIT(dbal_entry_handle_key_field_arr32_get
                            (unit, entry_handle_id, DBAL_FIELD_LAYER_TYPE_NEXT_LAYER, &next_layer_type_field));
            ...
            {
                if ((next_layer_type_field == DBAL_ENUM_FVAL_LAYER_TYPES_ICMP)
                    && (context_field == DBAL_ENUM_FVAL_VT5_CONTEXT_ID_GENERAL___NOP_CTX))
                {
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.icmp_ctx.set(unit, VTT4, icmp_counter++, ii));
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.icmp_counter.set(unit, VTT4, icmp_counter));
                }
                else if ((next_layer_type_field == DBAL_ENUM_FVAL_LAYER_TYPES_IGMP)
                         && (context_field == DBAL_ENUM_FVAL_VT5_CONTEXT_ID_BRIDGE___PON_DTC_S_C_TAG))
                {
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.igmp_ctx.set(unit, VTT4, igmp_counter++, ii));
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.igmp_counter.set(unit, VTT4, igmp_counter));
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_VT5_CONTEXT_ID, 0,
                                                 DBAL_ENUM_FVAL_VT5_CONTEXT_ID_GENERAL___NOP_CTX);
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_CONTEXT_VALID, 0, 1);
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_NASID_VALID, 0, 1);
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_NASID, 0, 5);
                    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT_UPDATE));
                }
                else if ((next_layer_type_field == DBAL_ENUM_FVAL_LAYER_TYPES_UDP)
                         && (context_field == DBAL_ENUM_FVAL_VT5_CONTEXT_ID_BRIDGE___PON_DTC_S_C_TAG))
                {
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.udp_ctx.set(unit, VTT4, udp_counter++, ii));
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.udp_counter.set(unit, VTT4, udp_counter));
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_VT5_CONTEXT_ID, 0,
                                                 DBAL_ENUM_FVAL_VT5_CONTEXT_ID_GENERAL___NOP_CTX);
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_CONTEXT_VALID, 0, 1);
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_NASID_VALID, 0, 1);
                    ...
                    SHR_IF_ERR_EXIT(dbal_entry_commit(unit, entry_handle_id, DBAL_COMMIT_UPDATE));
                         ...
                         && (context_field == DBAL_ENUM_FVAL_VT5_CONTEXT_ID_GENERAL___NOP_CTX))
                {
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.tcp_ctx.set(unit, VTT4, tcp_counter++, ii));
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.tcp_counter.set(unit, VTT4, tcp_counter));
                }
                else if ((next_layer_type_field == DBAL_ENUM_FVAL_LAYER_TYPES_UNKNOWN)
                         && (context_field == DBAL_ENUM_FVAL_VT5_CONTEXT_ID_BRIDGE___PON_DTC_S_C_TAG))
                {
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.
                                    gre_keep_alive_ctx.set(unit, VTT4, gre_keep_alive_counter++, ii));
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.
                                    gre_keep_alive_counter.set(unit, VTT4, gre_keep_alive_counter));
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_VT5_CONTEXT_ID, 0,
                                                 DBAL_ENUM_FVAL_VT5_CONTEXT_ID_GENERAL___NOP_CTX);
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_CONTEXT_VALID, 0, 1);
                    dbal_entry_value_field32_set(unit, entry_handle_id, DBAL_FIELD_NASID_VALID, 0, 1);
                ...
                {
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.
                                    unknown_ctx.set(unit, VTT4, unknown_counter++, ii));
                    SHR_IF_ERR_EXIT(switch_db.tunnel_route_disabled_ctx.
                                    unknown_counter.set(unit, VTT4, unknown_counter));
                }
            }
        }
    }
