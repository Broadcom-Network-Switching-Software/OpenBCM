    ...
    char arr_prefix_dynamic_file[RHFILE_MAX_SIZE])
{
    ...
    sal_strncat(file_name, image_name, RHFILE_MAX_SIZE - sal_strnlen(file_name, sizeof(file_name)) - 1);
    sal_strncat(file_name, "_arr.xml", RHFILE_MAX_SIZE - sal_strnlen(file_name, sizeof(file_name)) - 1);
    ...
    char aod_dynamic_file[RHFILE_MAX_SIZE])
{
    ...
    sal_strncat(file_name, image_name, RHFILE_MAX_SIZE - sal_strnlen(file_name, sizeof(file_name)) - 1);
    sal_strncat(file_name, "_aod.xml", RHFILE_MAX_SIZE - sal_strnlen(file_name, sizeof(file_name)) - 1);
    ...
    char mdb_app_db_dynamic_file[RHFILE_MAX_SIZE])
{
    ...
    sal_strncat(file_name, image_name, RHFILE_MAX_SIZE - sal_strnlen(file_name, sizeof(file_name)) - 1);
    sal_strncat(file_name, "_mdb_app_db.xml", RHFILE_MAX_SIZE - sal_strnlen(file_name, sizeof(file_name)) - 1);
    ...
    char pemal_soc_file[RHFILE_MAX_SIZE])
{
    ...
    sal_strncat(file_name, image_name, RHFILE_MAX_SIZE - sal_strnlen(file_name, sizeof(file_name)) - 1);
    sal_strncat(file_name, "_pemla_soc.xml", RHFILE_MAX_SIZE - sal_strnlen(file_name, sizeof(file_name)) - 1);
    ...
    char aod_sizes_file[RHFILE_MAX_SIZE])
{
    ...
    sal_strncat(file_name, image_name, RHFILE_MAX_SIZE - sal_strnlen(file_name, sizeof(file_name)) - 1);
    sal_strncat(file_name, "_aod_sizes.xml", RHFILE_MAX_SIZE - sal_strnlen(file_name, sizeof(file_name)) - 1);
