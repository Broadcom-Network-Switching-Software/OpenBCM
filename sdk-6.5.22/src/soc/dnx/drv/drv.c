    ...
    int unit)
{
    ...
    }
    {
        SHR_IF_ERR_EXIT(soc_dnxc_cmic_sbus_timeout_set
                        (unit, dnx_data_device.general.core_clock_khz_get(unit), SOC_CONTROL(unit)->schanTimeout));
    }
    ...
    int unit)
{
    ...
    if (disable_hard_reset != 0)
    {
        ...
        {
            SHR_IF_ERR_EXIT(soc_reg32_set(unit, ECI_PIR_CONFIGURATIONSr, REG_PORT_ANY, 0, 7));
        }
