...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    cur_field_type_param->nof_enum_vals = DBAL_ENUM_FVAL_INLIF_ENCODING_AC_MP_LARGE + 1;
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    cur_field_type_param->nof_enum_vals = DBAL_ENUM_FVAL_FWD_DEST_ENCODING_DOUBLE_OUTLIF + 1;
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    cur_field_type_param->nof_enum_vals = DBAL_ENUM_FVAL_SUPER_FEC_ENCODING_W_PROTECTION_W_STAT + 1;
