...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_field_type_db_struct_clear(unit, cur_field_type_param);
    SHR_IF_ERR_EXIT(dbal_db_init_field_type_general_info_set(unit, cur_field_type_param, cur_field_types_info, "RCH_QOS_MODEL" , 1 , is_valid , FALSE , DBAL_FIELD_PRINT_TYPE_ENUM , 0 , 1 , FALSE ));
    ...
    {
        dbal_db_enum_info_struct_t * enum_info = cur_field_type_param->enums;
        sal_strncpy(enum_info[DBAL_ENUM_FVAL_RCH_QOS_MODEL_INITIAL].name_from_interface, "INITIAL", sizeof(enum_info[DBAL_ENUM_FVAL_RCH_QOS_MODEL_INITIAL].name_from_interface));
        sal_strncpy(enum_info[DBAL_ENUM_FVAL_RCH_QOS_MODEL_UNIFORM].name_from_interface, "UNIFORM", sizeof(enum_info[DBAL_ENUM_FVAL_RCH_QOS_MODEL_UNIFORM].name_from_interface));
    }
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    sal_memset(cur_field_type_param->enums, 0x0, cur_field_type_param->nof_enum_vals * sizeof(dbal_db_enum_info_struct_t));
    {
        ...
        sal_strncpy(enum_info[DBAL_ENUM_FVAL_INGRESS_QOS_MAP_INDEX_L2_FIRST_TAG].name_from_interface, "L2_FIRST_TAG", sizeof(enum_info[DBAL_ENUM_FVAL_INGRESS_QOS_MAP_INDEX_L2_FIRST_TAG].name_from_interface));
        sal_strncpy(enum_info[DBAL_ENUM_FVAL_INGRESS_QOS_MAP_INDEX_L2_SECOND_TAG].name_from_interface, "L2_SECOND_TAG", sizeof(enum_info[DBAL_ENUM_FVAL_INGRESS_QOS_MAP_INDEX_L2_SECOND_TAG].name_from_interface));
