...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    cur_field_type_param->nof_enum_vals = DBAL_ENUM_FVAL_MEP_PE_PROFILE_SW_BFD_MPLS_TP_VCCV_FIXED_DIP + 1;
    ...
    sal_memset(cur_field_type_param->enums, 0x0, cur_field_type_param->nof_enum_vals * sizeof(dbal_db_enum_info_struct_t));
    {
        ...
        sal_strncpy(enum_info[DBAL_ENUM_FVAL_MEP_PE_PROFILE_SW_BFD_MPLS_TP_VCCV_FIXED_DIP].name_from_interface, "BFD_MPLS_TP_VCCV_FIXED_DIP", sizeof(enum_info[DBAL_ENUM_FVAL_MEP_PE_PROFILE_SW_BFD_MPLS_TP_VCCV_FIXED_DIP].name_from_interface));
    }
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    sal_memset(cur_field_type_param->enums, 0x0, cur_field_type_param->nof_enum_vals * sizeof(dbal_db_enum_info_struct_t));
    {
        ...
        sal_strncpy(enum_info[DBAL_ENUM_FVAL_OAMP_PE_PROGRAM_ENUM_BFD_MPLS_TP_VCCV_FIXED_DIP].name_from_interface, "BFD_MPLS_TP_VCCV_FIXED_DIP", sizeof(enum_info[DBAL_ENUM_FVAL_OAMP_PE_PROGRAM_ENUM_BFD_MPLS_TP_VCCV_FIXED_DIP].name_from_interface));
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    sal_memset(cur_field_type_param->enums, 0x0, cur_field_type_param->nof_enum_vals * sizeof(dbal_db_enum_info_struct_t));
    {
        ...
        sal_strncpy(enum_info[DBAL_ENUM_FVAL_OAMP_PE_PROG_TCAM_ENUM_BFD_MPLS_TP_VCCV_FIXED_DIP].name_from_interface, "BFD_MPLS_TP_VCCV_FIXED_DIP", sizeof(enum_info[DBAL_ENUM_FVAL_OAMP_PE_PROG_TCAM_ENUM_BFD_MPLS_TP_VCCV_FIXED_DIP].name_from_interface));
    ...
    
    {
        ...
        enum_info[DBAL_ENUM_FVAL_OAMP_PE_PROG_TCAM_ENUM_DEFAULT].value_from_mapping = 49;
    }
