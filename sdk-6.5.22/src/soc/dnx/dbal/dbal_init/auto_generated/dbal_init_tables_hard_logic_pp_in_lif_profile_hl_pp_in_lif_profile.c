...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_ENABLERS_VECTORS , is_valid , "ENABLERS_VECTORS" , DBAL_ACCESS_METHOD_HARD_LOGIC ));
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_IN_LIF_PROFILE_TABLE , is_valid , "IN_LIF_PROFILE_TABLE" , DBAL_ACCESS_METHOD_HARD_LOGIC ));
    ...
    
    {
        ...
        dbal_table_field_info_t * dbal_db_field;
        table_db_field_params_struct_t db_field;
        SHR_ALLOC_SET_ZERO(table_entry->keys_info, 1 * sizeof(dbal_table_field_info_t), "key fields info allocation", "%s%s%s\r\n", "IN_LIF_PROFILE_TABLE" , EMPTY, EMPTY);
    ...
    
    {
        ...
        {
            dbal_db_field = &table_entry->multi_res_info[result_type_counter].results_info[field_index];
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_mandatory_values(unit, DBAL_FIELD_CS_IN_LIF_VTT_PROFILE , DBAL_FIELD_TYPE_DEF_CS_IN_LIF_VTT_PROFILE , dbal_db_field));
            dbal_db_init_table_field_params_init(&db_field);
            db_field.size = 4;
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_optional_or_default_values(unit, table_entry, dbal_db_field, &db_field, FALSE));
            field_index += dbal_db_field->nof_instances;
        ...
        {
            dbal_db_field = &table_entry->multi_res_info[result_type_counter].results_info[field_index];
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_mandatory_values(unit, DBAL_FIELD_CS_IN_LIF_FWD_PROFILE , DBAL_FIELD_TYPE_DEF_CS_IN_LIF_FWD_PROFILE , dbal_db_field));
            dbal_db_init_table_field_params_init(&db_field);
            db_field.size = 4;
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_optional_or_default_values(unit, table_entry, dbal_db_field, &db_field, FALSE));
            field_index += dbal_db_field->nof_instances;
    ...
    
    {
        ...
        
        {
            ...
            
            {
                ...
                access_params->access_field_id = DBAL_FIELD_CS_IN_LIF_VTT_PROFILE;
                access_params->inst_idx = instance_index;
                SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_field(unit, access_params, 0 , 0 , DBAL_VALUE_FIELD_ENCODE_NONE , 0 ));
                ...
                
                {
                    ...
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HW_ENTITY_GROUP_INGRESS_CS_INLIF_PROFILE_MAP_LSB , regMemHwEntityId , fieldHwEntityId , INVALIDr ));
            ...
            
            {
                ...
                
                {
                    ...
                    fieldHwEntityId = INVALIDf;
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HW_ENTITY_GROUP_INGRESS_CS_INLIF_PROFILE_MAP_MSB , regMemHwEntityId , fieldHwEntityId , INVALIDr ));
                    access_params->data_offset.formula_cb = in_lif_profile_table_cs_in_lif_vtt_profile_dataoffset_0_cb;
                }
            }
        }
        
        {
            ...
            
            {
                ...
                access_params->access_field_id = DBAL_FIELD_CS_IN_LIF_FWD_PROFILE;
                access_params->inst_idx = instance_index;
                SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_field(unit, access_params, 0 , 0 , DBAL_VALUE_FIELD_ENCODE_NONE , 0 ));
        ...
        
        {
            ...
            
            {
                ...
                
                {
                    ...
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HW_ENTITY_GROUP_EGRESS_CFG_INLIF_DP_PROFILE_MAP , regMemHwEntityId , fieldHwEntityId , INVALIDm ));
        ...
        
        {
            ...
            
            {
                ...
                
                {
                    ...
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HW_ENTITY_GROUP_INGRESS_LIF_PROFILE_ATTRIBUTES_1 , regMemHwEntityId , fieldHwEntityId , INVALIDm ));
                }
            }
        }
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_VSI_PROFILE_TABLE , is_valid , "VSI_PROFILE_TABLE" , DBAL_ACCESS_METHOD_HARD_LOGIC ));
        ...
        
        {
            ...
            
            {
                ...
                
                {
                    ...
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HW_ENTITY_GROUP_INGRESS_FWD_DOMAIN_CS_PROFILE_MAP , regMemHwEntityId , fieldHwEntityId , INVALIDm ));
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_JR_MODE_INLIF_PROFILE_ORIENTATION_MAP , is_valid , "JR_MODE_INLIF_PROFILE_ORIENTATION_MAP" , DBAL_ACCESS_METHOD_HARD_LOGIC ));
    if (!is_valid)
    {
        SHR_EXIT();
    }
    ...
    
    {
        ...
        dbal_table_field_info_t * dbal_db_field;
        table_db_field_params_struct_t db_field;
        SHR_ALLOC_SET_ZERO(table_entry->keys_info, 1 * sizeof(dbal_table_field_info_t), "key fields info allocation", "%s%s%s\r\n", "JR_MODE_INLIF_PROFILE_ORIENTATION_MAP" , EMPTY, EMPTY);
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_JR_MODE_INLIF_PROFILE_EGRESS_REMAP , is_valid , "JR_MODE_INLIF_PROFILE_EGRESS_REMAP" , DBAL_ACCESS_METHOD_HARD_LOGIC ));
        ...
        
        {
            ...
            
            {
                ...
                
                {
                    ...
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HW_ENTITY_GROUP_EGRESS_CFG_INLIF_PROFILE_MAPPED_IN_JERICHO_MODE , regMemHwEntityId , fieldHwEntityId , INVALIDm ));
                    access_params->entry_offset.formula_cb = field_pmf_small_exem_learning_info_map_format_value_entryoffset_0_cb;
                }
            }
        }
