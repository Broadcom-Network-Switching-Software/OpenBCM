...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    sal_memset(cur_field_type_param->enums, 0x0, cur_field_type_param->nof_enum_vals * sizeof(dbal_db_enum_info_struct_t));
    {
        ...
        sal_strncpy(enum_info[DBAL_ENUM_FVAL_ETPP_ETPS_FORMATS_ETPS_SRV6_NO_SIDS].name_from_interface, "ETPS_SRV6_NO_SIDS", sizeof(enum_info[DBAL_ENUM_FVAL_ETPP_ETPS_FORMATS_ETPS_SRV6_NO_SIDS].name_from_interface));
