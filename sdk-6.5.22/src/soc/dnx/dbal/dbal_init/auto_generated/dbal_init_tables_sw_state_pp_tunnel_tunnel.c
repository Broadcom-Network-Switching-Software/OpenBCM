...
shr_error_e
_dbal_init_tables_sw_state_pp_tunnel_tunnel_srv6_sid_formats_per_tunnel_gport_sw_init(
int unit,
table_db_struct_t * cur_table_param,
dbal_logical_table_t * table_info)
{
    dbal_logical_table_t * table_entry = table_info + DBAL_TABLE_SRV6_SID_FORMATS_PER_TUNNEL_GPORT_SW;
    int is_valid = TRUE;
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_SRV6_SID_FORMATS_PER_TUNNEL_GPORT_SW , is_valid , "SRV6_SID_FORMATS_PER_TUNNEL_GPORT_SW" , DBAL_ACCESS_METHOD_SW_STATE ));
    ...
    
    {
        ...
        
        {
            ...
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_mandatory_values(unit, DBAL_FIELD_SRV6_SID_FORMATS , DBAL_FIELD_TYPE_DEF_SRV6_SID_FORMATS , dbal_db_field));
            dbal_db_init_table_field_params_init(&db_field);
    ...
    
    {
        ...
        SHR_IF_ERR_EXIT(dbal_db_init_table_set_table_incompatible_image_sw_state_indication(unit, DBAL_TABLE_SRV6_SID_FORMATS_PER_TUNNEL_GPORT_SW, is_standard_1, is_compatible_with_all_images));
    }
    ...
    dbal_db_init_sw_state_set_indirect_table_size(unit, table_entry, srv6_sid_formats_per_tunnel_gport_sw_indirect_table_size_0_cb , DBAL_DB_INVALID );
    SHR_IF_ERR_EXIT(dbal_db_init_table_add(unit, cur_table_param, DBAL_TABLE_SRV6_SID_FORMATS_PER_TUNNEL_GPORT_SW, table_info));
exit:
    SHR_FUNC_EXIT;
}
...
{
    SHR_FUNC_INIT_VARS(unit);
    SHR_IF_ERR_EXIT(_dbal_init_tables_sw_state_pp_tunnel_tunnel_srv6_sid_formats_per_tunnel_gport_sw_init(unit, cur_table_param, table_info));
exit:
    SHR_FUNC_EXIT;
}
