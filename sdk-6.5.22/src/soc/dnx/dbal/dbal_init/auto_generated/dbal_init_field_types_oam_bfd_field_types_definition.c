...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_field_type_db_struct_clear(unit, cur_field_type_param);
    SHR_IF_ERR_EXIT(dbal_db_init_field_type_general_info_set(unit, cur_field_type_param, cur_field_types_info, "IVEC_ADDRESS_FACTOR" , 2 , is_valid , FALSE , DBAL_FIELD_PRINT_TYPE_UINT32 , 0 , 1 , FALSE ));
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    cur_field_type_param->nof_enum_vals = DBAL_ENUM_FVAL_MP_TYPE_RESERVED + 1;
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    cur_field_type_param->nof_enum_vals = DBAL_ENUM_FVAL_DM_MODE_DM_MODE_IS_NTP + 1;
