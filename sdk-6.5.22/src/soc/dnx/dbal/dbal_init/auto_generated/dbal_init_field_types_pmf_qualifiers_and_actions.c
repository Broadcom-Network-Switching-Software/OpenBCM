...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    cur_field_types_info->struct_field_info[50].length = dnx_data_field.profile_bits.nof_ing_in_lif_get(unit);
    cur_field_types_info->struct_field_info[51].struct_field_id = DBAL_FIELD_IN_LIF_PROFILE_1;
    cur_field_types_info->struct_field_info[51].length = dnx_data_field.profile_bits.nof_ing_in_lif_get(unit);
    ...
    cur_field_types_info->struct_field_info[91].struct_field_id = DBAL_FIELD_PTC_PMF_DATA;
    ...
    cur_field_types_info->struct_field_info[135].struct_field_id = DBAL_FIELD_PWE_IN_LIF_WIDE_DATA;
    cur_field_types_info->struct_field_info[136].struct_field_id = DBAL_FIELD_NATIVE_AC_IN_LIF_WIDE_DATA;
    cur_field_types_info->struct_field_info[137].struct_field_id = DBAL_FIELD_PP_PORT_PMF_PROFILE;
    cur_field_types_info->struct_field_info[137].length = dnx_data_field.profile_bits.nof_bits_in_port_profile_get(unit);
    cur_field_types_info->struct_field_info[138].struct_field_id = DBAL_FIELD_TM_PORT_PMF_PROFILE;
    cur_field_types_info->struct_field_info[138].length = dnx_data_field.profile_bits.nof_bits_in_port_profile_get(unit);
    cur_field_types_info->struct_field_info[139].struct_field_id = DBAL_FIELD_PP_PORT_PMF_GENERAL_DATA;
    cur_field_types_info->struct_field_info[139].length = dnx_data_field.profile_bits.nof_bits_in_ingress_pp_port_general_data_get(unit);
    cur_field_types_info->struct_field_info[140].struct_field_id = DBAL_FIELD_PMF_ETH_RIF_PROFILE;
    cur_field_types_info->struct_field_info[140].length = dnx_data_field.profile_bits.nof_ing_eth_rif_get(unit);
    ...
    cur_field_types_info->struct_field_info[158].length = dnx_data_field.general_data_qualifiers.mact_entry_grouping_nof_bits_get(unit);
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    cur_field_types_info->nof_struct_fields = 127;
    ...
    cur_field_types_info->struct_field_info[122].struct_field_id = DBAL_FIELD_PRT_QUALIFIER_RAW;
    cur_field_types_info->struct_field_info[123].struct_field_id = DBAL_FIELD_VISIBILITY_CLEAR;
    cur_field_types_info->struct_field_info[124].struct_field_id = DBAL_FIELD_VISIBILITY;
    cur_field_types_info->struct_field_info[125].struct_field_id = DBAL_FIELD_INVALIDATE_NEXT;
    cur_field_types_info->struct_field_info[126].struct_field_id = DBAL_FIELD_INVALID;
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    cur_field_types_info->nof_struct_fields = 131;
    ...
    cur_field_types_info->struct_field_info[31].length = dnx_data_field.profile_bits.nof_ing_in_lif_get(unit);
    cur_field_types_info->struct_field_info[32].struct_field_id = DBAL_FIELD_IN_LIF_PROFILE_1;
    cur_field_types_info->struct_field_info[32].length = dnx_data_field.profile_bits.nof_ing_in_lif_get(unit);
    ...
    cur_field_types_info->struct_field_info[103].struct_field_id = DBAL_FIELD_PTC_PMF_DATA;
    ...
    cur_field_types_info->struct_field_info[112].struct_field_id = DBAL_FIELD_PMF_ETH_RIF_PROFILE;
    cur_field_types_info->struct_field_info[112].length = dnx_data_field.profile_bits.nof_ing_eth_rif_get(unit);
    cur_field_types_info->struct_field_info[113].struct_field_id = DBAL_FIELD_DUAL_QUEUE;
    cur_field_types_info->struct_field_info[113].length = dnx_data_field.signal_sizes.dual_queue_size_get(unit);
    cur_field_types_info->struct_field_info[114].struct_field_id = DBAL_FIELD_ELEPHANT_TRAP_INFO;
    cur_field_types_info->struct_field_info[114].length = 96;
    cur_field_types_info->struct_field_info[115].struct_field_id = DBAL_FIELD_ELEPHANT_LEARN_NEEDED;
    cur_field_types_info->struct_field_info[115].length = 1;
    cur_field_types_info->struct_field_info[116].struct_field_id = DBAL_FIELD_PRT_QUALIFIER_RAW;
    cur_field_types_info->struct_field_info[117].struct_field_id = DBAL_FIELD_ECL_VALID;
    cur_field_types_info->struct_field_info[117].length = 1;
    cur_field_types_info->struct_field_info[118].struct_field_id = DBAL_FIELD_BTK_OFFSET_SOP;
    cur_field_types_info->struct_field_info[118].length = 8;
    cur_field_types_info->struct_field_info[119].struct_field_id = DBAL_FIELD_BTC_OFFSET_SOP;
    cur_field_types_info->struct_field_info[119].length = 9;
    cur_field_types_info->struct_field_info[120].struct_field_id = DBAL_FIELD_BTC_MINUS_BTK;
    cur_field_types_info->struct_field_info[120].length = 9;
    cur_field_types_info->struct_field_info[121].struct_field_id = DBAL_FIELD_LEARN_SRC_MAC;
    cur_field_types_info->struct_field_info[122].struct_field_id = DBAL_FIELD_LEARN_VLAN;
    cur_field_types_info->struct_field_info[123].struct_field_id = DBAL_FIELD_LEARN_VSI;
    cur_field_types_info->struct_field_info[123].length = 18;
    cur_field_types_info->struct_field_info[124].struct_field_id = DBAL_FIELD_LEARN_DATA;
    cur_field_types_info->struct_field_info[124].length = 64;
    cur_field_types_info->struct_field_info[125].struct_field_id = DBAL_FIELD_LEARN_STATION_MOVE;
    cur_field_types_info->struct_field_info[126].struct_field_id = DBAL_FIELD_LEARN_MATCH;
    cur_field_types_info->struct_field_info[127].struct_field_id = DBAL_FIELD_LEARN_FOUND;
    cur_field_types_info->struct_field_info[128].struct_field_id = DBAL_FIELD_LEARN_EXPECTED_WON;
    cur_field_types_info->struct_field_info[129].struct_field_id = DBAL_FIELD_VRF_VALUE;
    cur_field_types_info->struct_field_info[130].struct_field_id = DBAL_FIELD_PP_PORT;
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    cur_field_types_info->struct_field_info[30].struct_field_id = DBAL_FIELD_IN_LIF_PROFILE_0;
    cur_field_types_info->struct_field_info[30].length = dnx_data_field.profile_bits.nof_ing_in_lif_get(unit);
    ...
    cur_field_types_info->struct_field_info[122].struct_field_id = DBAL_FIELD_PMF_ETH_RIF_PROFILE;
    cur_field_types_info->struct_field_info[122].length = dnx_data_field.profile_bits.nof_ing_eth_rif_get(unit);
    cur_field_types_info->struct_field_info[123].struct_field_id = DBAL_FIELD_VRF_VALUE;
    cur_field_types_info->struct_field_info[124].struct_field_id = DBAL_FIELD_UNKNOWN_ADDRESS;
    cur_field_types_info->struct_field_info[124].length = 1;
    cur_field_types_info->struct_field_info[125].struct_field_id = DBAL_FIELD_INGRESS_PROTOCOL_TRAP_IN_LIF_PROFILE;
    cur_field_types_info->struct_field_info[125].length = 8;
    cur_field_types_info->struct_field_info[126].struct_field_id = DBAL_FIELD_VW_VIP_VALID;
    cur_field_types_info->struct_field_info[127].struct_field_id = DBAL_FIELD_VW_VIP_ID;
    cur_field_types_info->struct_field_info[128].struct_field_id = DBAL_FIELD_VW_MEMBER_REFERENCE;
    cur_field_types_info->struct_field_info[129].struct_field_id = DBAL_FIELD_VW_PCC_HIT;
    cur_field_types_info->struct_field_info[130].struct_field_id = DBAL_FIELD_AC_IN_LIF_WIDE_DATA_EXTENDED;
    cur_field_types_info->struct_field_info[131].struct_field_id = DBAL_FIELD_MACT_ENTRY_GROUPING;
    cur_field_types_info->struct_field_info[131].length = dnx_data_field.general_data_qualifiers.mact_entry_grouping_nof_bits_get(unit);
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    cur_field_types_info->nof_struct_fields = 96;
    ...
    cur_field_types_info->struct_field_info[71].length = dnx_data_field.profile_bits.nof_ing_in_lif_get(unit);
    ...
    cur_field_types_info->struct_field_info[81].struct_field_id = DBAL_FIELD_OUT_TM_PORT;
    ...
    cur_field_types_info->struct_field_info[95].struct_field_id = DBAL_FIELD_PPH_VRF_VALUE;
