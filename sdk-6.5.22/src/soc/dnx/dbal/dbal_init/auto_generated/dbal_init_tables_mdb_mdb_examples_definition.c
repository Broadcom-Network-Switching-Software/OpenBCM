...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_EXAMPLE_MDB_WITH_RESULT_TYPE_IN_SW_DIRECT , is_valid , "EXAMPLE_MDB_WITH_RESULT_TYPE_IN_SW_DIRECT" , DBAL_ACCESS_METHOD_MDB ));
    ...
    
    {
        ...
        {
            dbal_db_field = &table_entry->multi_res_info[result_type_counter].results_info[field_index];
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_mandatory_values(unit, DBAL_FIELD_VLAN_EDIT_VID_2 , DBAL_FIELD_TYPE_DEF_VLAN_EDIT_VID_2 , dbal_db_field));
            dbal_db_init_table_field_params_init(&db_field);
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_optional_or_default_values(unit, table_entry, dbal_db_field, &db_field, FALSE));
            field_index += dbal_db_field->nof_instances;
        }
        {
            dbal_db_field = &table_entry->multi_res_info[result_type_counter].results_info[field_index];
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_mandatory_values(unit, DBAL_FIELD_VLAN_EDIT_VID_1 , DBAL_FIELD_TYPE_DEF_VLAN_EDIT_VID_1 , dbal_db_field));
            dbal_db_init_table_field_params_init(&db_field);
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_optional_or_default_values(unit, table_entry, dbal_db_field, &db_field, FALSE));
            field_index += dbal_db_field->nof_instances;
        }
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_EXAMPLE_IN_LIF_FORMAT_DIFFERENT_SIZES , is_valid , "EXAMPLE_IN_LIF_FORMAT_DIFFERENT_SIZES" , DBAL_ACCESS_METHOD_MDB ));
    ...
    
    {
        ...
        dbal_table_field_info_t * dbal_db_field;
        table_db_field_params_struct_t db_field;
        SHR_ALLOC_SET_ZERO(table_entry->keys_info, 1 * sizeof(dbal_table_field_info_t), "key fields info allocation", "%s%s%s\r\n", "EXAMPLE_IN_LIF_FORMAT_DIFFERENT_SIZES" , EMPTY, EMPTY);
    ...
    
    {
        ...
        {
            dbal_db_field = &table_entry->multi_res_info[result_type_counter].results_info[field_index];
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_mandatory_values(unit, DBAL_FIELD_DUMMY_FIELD1 , DBAL_FIELD_TYPE_DEF_ARRAY32 , dbal_db_field));
            dbal_db_init_table_field_params_init(&db_field);
            db_field.size = 100;
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_optional_or_default_values(unit, table_entry, dbal_db_field, &db_field, FALSE));
            field_index += dbal_db_field->nof_instances;
...
shr_error_e
_dbal_init_tables_mdb_mdb_examples_definition_example_in_lif_format_different_sizes_1_init(
int unit,
table_db_struct_t * cur_table_param,
dbal_logical_table_t * table_info)
{
    dbal_logical_table_t * table_entry = table_info + DBAL_TABLE_EXAMPLE_IN_LIF_FORMAT_DIFFERENT_SIZES_1;
    int is_valid = TRUE;
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_EXAMPLE_IN_LIF_FORMAT_DIFFERENT_SIZES_1 , is_valid , "EXAMPLE_IN_LIF_FORMAT_DIFFERENT_SIZES_1" , DBAL_ACCESS_METHOD_MDB ));
    ...
    
    {
        ...
        dbal_table_field_info_t * dbal_db_field;
        table_db_field_params_struct_t db_field;
        SHR_ALLOC_SET_ZERO(table_entry->keys_info, 1 * sizeof(dbal_table_field_info_t), "key fields info allocation", "%s%s%s\r\n", "EXAMPLE_IN_LIF_FORMAT_DIFFERENT_SIZES_1" , EMPTY, EMPTY);
    ...
    
    {
        ...
        result_type_counter = DBAL_RESULT_TYPE_EXAMPLE_IN_LIF_FORMAT_DIFFERENT_SIZES_1_RT1;
        field_index = 0;
        DBAL_DB_INIT_TABLE_NOF_RESULT_FIELDS_SET(table_entry, (table_entry->multi_res_info[result_type_counter]), 2);
        DBAL_DB_INIT_TABLE_INTERFACE_RESULT_FIELDS_ALLOC(table_entry, table_entry->multi_res_info[result_type_counter]);
        ...
        result_type_counter = DBAL_RESULT_TYPE_EXAMPLE_IN_LIF_FORMAT_DIFFERENT_SIZES_1_RT2;
        field_index = 0;
        DBAL_DB_INIT_TABLE_NOF_RESULT_FIELDS_SET(table_entry, (table_entry->multi_res_info[result_type_counter]), 2);
        DBAL_DB_INIT_TABLE_INTERFACE_RESULT_FIELDS_ALLOC(table_entry, table_entry->multi_res_info[result_type_counter]);
        ...
        result_type_counter = DBAL_RESULT_TYPE_EXAMPLE_IN_LIF_FORMAT_DIFFERENT_SIZES_1_RT3;
        field_index = 0;
        DBAL_DB_INIT_TABLE_NOF_RESULT_FIELDS_SET(table_entry, (table_entry->multi_res_info[result_type_counter]), 2);
        DBAL_DB_INIT_TABLE_INTERFACE_RESULT_FIELDS_ALLOC(table_entry, table_entry->multi_res_info[result_type_counter]);
    ...
    
    {
        ...
        uint8 is_compatible_with_all_images = FALSE;
        DBAL_DB_INIT_TABLE_IMAGE_SPECIFIC_TABLE_INDICATION_SET(table_entry, is_standard_1, is_compatible_with_all_images);
        SHR_IF_ERR_EXIT(dbal_db_init_table_set_table_incompatible_image_sw_state_indication(unit, DBAL_TABLE_EXAMPLE_IN_LIF_FORMAT_DIFFERENT_SIZES_1, is_standard_1, is_compatible_with_all_images));
    }
    ...
    DBAL_DB_INIT_RESULT_TYPE_HW_VALUE_SET(table_entry->multi_res_info[DBAL_RESULT_TYPE_EXAMPLE_IN_LIF_FORMAT_DIFFERENT_SIZES_1_RT1], 1)
    DBAL_DB_INIT_RESULT_TYPE_HW_VALUE_SET(table_entry->multi_res_info[DBAL_RESULT_TYPE_EXAMPLE_IN_LIF_FORMAT_DIFFERENT_SIZES_1_RT2], 2)
    DBAL_DB_INIT_RESULT_TYPE_HW_VALUE_SET(table_entry->multi_res_info[DBAL_RESULT_TYPE_EXAMPLE_IN_LIF_FORMAT_DIFFERENT_SIZES_1_RT3], 3)
    SHR_IF_ERR_EXIT(dbal_db_init_table_set_mdb_info(unit, cur_table_param, "INLIF2" , 0 , 0 , DBAL_STAGE_NONE ));
    SHR_IF_ERR_EXIT(dbal_db_init_table_add(unit, cur_table_param, DBAL_TABLE_EXAMPLE_IN_LIF_FORMAT_DIFFERENT_SIZES_1, table_info));
exit:
    SHR_FUNC_EXIT;
}
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(_dbal_init_tables_mdb_mdb_examples_definition_example_in_lif_format_different_sizes_1_init(unit, cur_table_param, table_info));
exit:
    SHR_FUNC_EXIT;
}
