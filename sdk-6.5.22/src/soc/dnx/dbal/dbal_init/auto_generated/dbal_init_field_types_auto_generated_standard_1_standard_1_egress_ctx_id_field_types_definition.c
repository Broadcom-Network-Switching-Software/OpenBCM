...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    cur_field_type_param->nof_enum_vals = DBAL_ENUM_FVAL_PRP2_CONTEXT_ID_OAM___MPLS_DM_INJECTION + 1;
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    sal_memset(cur_field_type_param->enums, 0x0, cur_field_type_param->nof_enum_vals * sizeof(dbal_db_enum_info_struct_t));
    {
        ...
        sal_strncpy(enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___DM_CPU_PORT].name_from_interface, "GENERAL___DM_CPU_PORT", sizeof(enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___DM_CPU_PORT].name_from_interface));
    ...
    if (DBAL_IS_J2C_A0)
    {
        ...
        
        {
            ...
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___DM_CPU_PORT].value_from_mapping = 33;
            
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_MPLS___TRANSIT_CCM_SD].value_from_mapping = 34;
            
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_MPLS___TRANSIT_CCM_SD_1_ADDITIONAL_LABEL].value_from_mapping = 35;
            
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_MPLS___TRANSIT_CCM_SD_2_ADDITIONAL_LABELS].value_from_mapping = 36;
            
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_MPLS___TRANSIT_CCM_SD_3_ADDITIONAL_LABELS].value_from_mapping = 37;
            
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_MPLS___PHP].value_from_mapping = 38;
            
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_MPLS___PHP_1588].value_from_mapping = 39;
            ...
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_REFLECTORS___SEAMLESS_BFD_IPV6].value_from_mapping = 48;
            
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_REFLECTORS___SEAMLESS_BFD].value_from_mapping = 49;
            
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_SRV6___SEGMENT_ENDPOINT].value_from_mapping = 50;
            
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_SRV6___PSP].value_from_mapping = 51;
            
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_SRV6___EXTENDED_PASS].value_from_mapping = 52;
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    sal_memset(cur_field_type_param->enums, 0x0, cur_field_type_param->nof_enum_vals * sizeof(dbal_db_enum_info_struct_t));
    {
        ...
        sal_strncpy(enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_GENERAL___DM_CPU_PORT_TRAPPED].name_from_interface, "GENERAL___DM_CPU_PORT_TRAPPED", sizeof(enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_GENERAL___DM_CPU_PORT_TRAPPED].name_from_interface));
