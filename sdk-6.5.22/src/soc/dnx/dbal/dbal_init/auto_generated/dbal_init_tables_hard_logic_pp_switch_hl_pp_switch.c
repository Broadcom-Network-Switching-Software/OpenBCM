        ...
        
        {
            ...
            
            {
                ...
                
                {
                    ...
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HW_ENTITY_GROUP_ETPP_DEFAULT_SVTAG , regMemHwEntityId , fieldHwEntityId , INVALIDr ));
                }
            }
        }
