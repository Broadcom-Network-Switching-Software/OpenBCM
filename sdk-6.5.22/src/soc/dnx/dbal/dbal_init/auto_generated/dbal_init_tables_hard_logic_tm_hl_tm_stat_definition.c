...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_STAT_RJCT_FILTER_GROUP , is_valid , "STAT_RJCT_FILTER_GROUP" , DBAL_ACCESS_METHOD_HARD_LOGIC ));
