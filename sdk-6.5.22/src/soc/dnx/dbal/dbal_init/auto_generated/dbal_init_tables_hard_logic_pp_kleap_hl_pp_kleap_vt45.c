...
dbal_logical_table_t * table_info)
{
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_KLEAP_VT45_RESOURCES_MAPPING , is_valid , "KLEAP_VT45_RESOURCES_MAPPING" , DBAL_ACCESS_METHOD_HARD_LOGIC ));
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_KLEAP_VT45_FFC_QUAD_IS_ACL , is_valid , "KLEAP_VT45_FFC_QUAD_IS_ACL" , DBAL_ACCESS_METHOD_HARD_LOGIC ));
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_KLEAP_VT45_KBR_INFO , is_valid , "KLEAP_VT45_KBR_INFO" , DBAL_ACCESS_METHOD_HARD_LOGIC ));
    ...
    
    {
        ...
        dbal_table_field_info_t * dbal_db_field;
        table_db_field_params_struct_t db_field;
        SHR_ALLOC_SET_ZERO(table_entry->keys_info, 2 * sizeof(dbal_table_field_info_t), "key fields info allocation", "%s%s%s\r\n", "KLEAP_VT45_KBR_INFO" , EMPTY, EMPTY);
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_KLEAP_VT45_FFC_INSTRUCTION , is_valid , "KLEAP_VT45_FFC_INSTRUCTION" , DBAL_ACCESS_METHOD_HARD_LOGIC ));
    ...
    
    {
        ...
        dbal_table_field_info_t * dbal_db_field;
        table_db_field_params_struct_t db_field;
        SHR_ALLOC_SET_ZERO(table_entry->keys_info, 2 * sizeof(dbal_table_field_info_t), "key fields info allocation", "%s%s%s\r\n", "KLEAP_VT45_FFC_INSTRUCTION" , EMPTY, EMPTY);
...
dbal_logical_table_t * table_info)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_KLEAP_VT45_PD_INFO , is_valid , "KLEAP_VT45_PD_INFO" , DBAL_ACCESS_METHOD_HARD_LOGIC ));
