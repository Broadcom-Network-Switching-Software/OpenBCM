...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    sal_memset(cur_field_type_param->enums, 0x0, cur_field_type_param->nof_enum_vals * sizeof(dbal_db_enum_info_struct_t));
    {
        ...
        sal_strncpy(enum_info[DBAL_ENUM_FVAL_VT1_CONTEXT_ID_GENERAL___FTMH].name_from_interface, "GENERAL___FTMH", sizeof(enum_info[DBAL_ENUM_FVAL_VT1_CONTEXT_ID_GENERAL___FTMH].name_from_interface));
    }
    if (DBAL_IS_JR2_A0)
    {
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    sal_memset(cur_field_type_param->enums, 0x0, cur_field_type_param->nof_enum_vals * sizeof(dbal_db_enum_info_struct_t));
    {
        ...
        sal_strncpy(enum_info[DBAL_ENUM_FVAL_VT3_CONTEXT_ID_IPV4___TT_IPSEC_DOUBLE_UDP].name_from_interface, "IPV4___TT_IPSEC_DOUBLE_UDP", sizeof(enum_info[DBAL_ENUM_FVAL_VT3_CONTEXT_ID_IPV4___TT_IPSEC_DOUBLE_UDP].name_from_interface));
    ...
    if (DBAL_IS_J2P_A0)
    {
        ...
        
        {
            ...
            enum_info[DBAL_ENUM_FVAL_VT3_CONTEXT_ID_IPV6___TT_DIP].value_from_mapping = 12;
            
            enum_info[DBAL_ENUM_FVAL_VT3_CONTEXT_ID_IPV6___2ND_PASS_TT_DIP].value_from_mapping = 13;
            
            enum_info[DBAL_ENUM_FVAL_VT3_CONTEXT_ID_IPV6___TT_DIP_W_IPV6_EH_PARSING_CONTEXT_FIX].value_from_mapping = 16;
            
            enum_info[DBAL_ENUM_FVAL_VT3_CONTEXT_ID_IPV6___2ND_PASS_TT_DIP_W_IPV6_EH_PARSING_CONTEXT_FIX].value_from_mapping = 17;
            
            enum_info[DBAL_ENUM_FVAL_VT3_CONTEXT_ID_IPV6___IPV6_EH_PARSING_CONTEXT_FIX].value_from_mapping = 18;
            
            enum_info[DBAL_ENUM_FVAL_VT3_CONTEXT_ID_MPLS___TT].value_from_mapping = 19;
            
            enum_info[DBAL_ENUM_FVAL_VT3_CONTEXT_ID_MPLS___TT_PER_INTERFACE_LABEL].value_from_mapping = 20;
            
            enum_info[DBAL_ENUM_FVAL_VT3_CONTEXT_ID_MPLS___EVPN_IML].value_from_mapping = 21;
            
            enum_info[DBAL_ENUM_FVAL_VT3_CONTEXT_ID_MPLS___EVPN_FL_AFTER_IML].value_from_mapping = 22;
            
            enum_info[DBAL_ENUM_FVAL_VT3_CONTEXT_ID_MPLS___EVPN_FL_AND_CW_AFTER_IML].value_from_mapping = 23;
            
            enum_info[DBAL_ENUM_FVAL_VT3_CONTEXT_ID_MPLS___SPECULATIVE_PARSING_FIX].value_from_mapping = 24;
            
            enum_info[DBAL_ENUM_FVAL_VT3_CONTEXT_ID_MPLS___P2P_ONLY].value_from_mapping = 25;
            
            enum_info[DBAL_ENUM_FVAL_VT3_CONTEXT_ID_MPLS___SPECIAL_LABEL].value_from_mapping = 26;
            
            enum_info[DBAL_ENUM_FVAL_VT3_CONTEXT_ID_PPPOE___SA_COMPRESSION].value_from_mapping = 28;
            ...
            enum_info[DBAL_ENUM_FVAL_VT3_CONTEXT_ID_MPLS___IFIT].value_from_mapping = 27;
            ...
            enum_info[DBAL_ENUM_FVAL_VT3_CONTEXT_ID_IPV4___TT_IPSEC_DOUBLE_UDP].value_from_mapping = 11;
            
            enum_info[DBAL_ENUM_FVAL_VT3_CONTEXT_ID_IPV6___TT_IPSEC].value_from_mapping = 14;
            
            enum_info[DBAL_ENUM_FVAL_VT3_CONTEXT_ID_IPV6___TT_IPSEC_UDP].value_from_mapping = 15;
        }
    }
    else if (DBAL_IS_JR2_A0)
    {
