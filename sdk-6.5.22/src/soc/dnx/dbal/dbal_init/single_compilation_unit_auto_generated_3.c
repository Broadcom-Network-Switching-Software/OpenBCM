...
#include <src/soc/dnx/dbal/dbal_init/auto_generated/dbal_init_hw_entity_porting.c>
#include <src/soc/dnx/dbal/dbal_init/auto_generated/dbal_init_hw_entity_porting_hw_entity_porting.c>
