    ...
    dbal_physical_tables_e * phy_table_id)
{
    ...
    {
        if (sal_strcasecmp(dnx_data_mdb.pdbs.dbal_pdb_info_get(unit, ii)->dbal_str, str) == 0)
        {
    ...
    int remove_index)
{
    ...
    sal_strncpy(phys_table_string, dbal_physical_table_to_string(unit, phy_table_id), 31);
    ...
    dbal_table_string_t * table_string)
{
    ...
    sal_strncpy_s(table_string->table_name, table->table_name, DBAL_MAX_STRING_LENGTH);
    ...
    sal_strncpy_s(table_string->table_status, str_to_print, DBAL_MAX_SHORT_STRING_LENGTH);
    ...
    sal_strncpy_s(table_string->maturity_level, str_to_print, DBAL_MAX_SHORT_STRING_LENGTH);
    ...
    sal_strncpy_s(table_string->table_type, str_to_print, DBAL_MAX_SHORT_STRING_LENGTH);
    ...
    sal_strncpy_s(table_string->access_method, str_to_print, DBAL_MAX_SHORT_STRING_LENGTH);
    ...
    sal_strncpy_s(table_string->core_mode, str_to_print, DBAL_MAX_SHORT_STRING_LENGTH);
