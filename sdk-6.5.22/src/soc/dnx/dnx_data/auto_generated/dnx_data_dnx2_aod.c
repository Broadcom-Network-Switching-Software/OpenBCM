    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_ERPP_FWD_CONTEXT_FILTER___image].doc = "table related image";
    ...
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_ERPP_FWD_CONTEXT_FILTER].doc = "ERPP_FWD_CONTEXT_FILTER";
    ...
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_ERPP_FWD_CONTEXT_FILTER].keys[0].doc = "entry index";
    ...
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_EGRESS_PER_FORWARD_CODE___image].doc = "table related image";
    ...
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_EGRESS_PER_FORWARD_CODE].doc = "EGRESS_PER_FORWARD_CODE";
    ...
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_EGRESS_PER_FORWARD_CODE].keys[0].doc = "entry index";
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_EGRESS_PER_FORWARD_CODE].keys[1].name = "soc_value";
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_EGRESS_PER_FORWARD_CODE].keys[1].doc = "soc property value";
    ...
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_ERPP_FORWARD_CODE_SELECTION___image].doc = "table related image";
    ...
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_ERPP_FORWARD_CODE_SELECTION].doc = "ERPP_FORWARD_CODE_SELECTION";
    ...
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_ERPP_FORWARD_CODE_SELECTION].keys[0].doc = "entry index";
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_ERPP_FORWARD_CODE_SELECTION].keys[1].name = "soc_value";
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_ERPP_FORWARD_CODE_SELECTION].keys[1].doc = "soc property value";
    ...
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_ETPP_FORWARD_CODE_SELECTION___image].doc = "table related image";
    ...
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_ETPP_FORWARD_CODE_SELECTION].doc = "ETPP_FORWARD_CODE_SELECTION";
    ...
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_ETPP_FORWARD_CODE_SELECTION].keys[0].doc = "entry index";
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_ETPP_FORWARD_CODE_SELECTION].keys[1].name = "soc_value";
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_ETPP_FORWARD_CODE_SELECTION].keys[1].doc = "soc property value";
    ...
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_EGRESS_PARSING_START_TYPE_CONTEXT___image].doc = "table related image";
    ...
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_EGRESS_PARSING_START_TYPE_CONTEXT].doc = "EGRESS_PARSING_START_TYPE_CONTEXT";
    ...
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_EGRESS_PARSING_START_TYPE_CONTEXT].keys[0].doc = "entry index";
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_EGRESS_PARSING_START_TYPE_CONTEXT].keys[1].name = "soc_value";
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_EGRESS_PARSING_START_TYPE_CONTEXT].keys[1].doc = "soc property value";
    ...
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_EGRESS_PARSING_START_TYPE_CONTEXT].values[5].name = "ERPP_1st_Parser_Parser_Context";
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_EGRESS_PARSING_START_TYPE_CONTEXT].values[5].type = "char *";
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_EGRESS_PARSING_START_TYPE_CONTEXT].values[5].doc = "ERPP_1st_Parser_Parser_Context";
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_EGRESS_PARSING_START_TYPE_CONTEXT].values[5].offset = UTILEX_OFFSETOF(dnx_data_dnx2_aod_tables_EGRESS_PARSING_START_TYPE_CONTEXT_t, ERPP_1st_Parser_Parser_Context);
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_EGRESS_PARSING_START_TYPE_CONTEXT].values[6].name = "ERPP_1st_Parser_Parser_Context_valid";
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_EGRESS_PARSING_START_TYPE_CONTEXT].values[6].type = "uint32";
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_EGRESS_PARSING_START_TYPE_CONTEXT].values[6].doc = "ERPP_1st_Parser_Parser_Context_valid";
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_EGRESS_PARSING_START_TYPE_CONTEXT].values[6].offset = UTILEX_OFFSETOF(dnx_data_dnx2_aod_tables_EGRESS_PARSING_START_TYPE_CONTEXT_t, ERPP_1st_Parser_Parser_Context_valid);
    ...
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_EGRESS_PARSING_CONTEXT_MAP_JR1_MODE___image].doc = "table related image";
    ...
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_EGRESS_PARSING_CONTEXT_MAP_JR1_MODE].doc = "EGRESS_PARSING_CONTEXT_MAP_JR1_MODE";
    ...
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_EGRESS_PARSING_CONTEXT_MAP_JR1_MODE].keys[0].doc = "entry index";
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_EGRESS_PARSING_CONTEXT_MAP_JR1_MODE].keys[1].name = "soc_value";
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_EGRESS_PARSING_CONTEXT_MAP_JR1_MODE].keys[1].doc = "soc property value";
    ...
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_EGRESS_PARSING_CONTEXT_MAP_JR1_MODE].values[5].name = "ERPP_1st_Parser_Parser_Context";
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_EGRESS_PARSING_CONTEXT_MAP_JR1_MODE].values[5].type = "char *";
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_EGRESS_PARSING_CONTEXT_MAP_JR1_MODE].values[5].doc = "ERPP_1st_Parser_Parser_Context";
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_EGRESS_PARSING_CONTEXT_MAP_JR1_MODE].values[5].offset = UTILEX_OFFSETOF(dnx_data_dnx2_aod_tables_EGRESS_PARSING_CONTEXT_MAP_JR1_MODE_t, ERPP_1st_Parser_Parser_Context);
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_EGRESS_PARSING_CONTEXT_MAP_JR1_MODE].values[6].name = "ERPP_1st_Parser_Parser_Context_valid";
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_EGRESS_PARSING_CONTEXT_MAP_JR1_MODE].values[6].type = "uint32";
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_EGRESS_PARSING_CONTEXT_MAP_JR1_MODE].values[6].doc = "ERPP_1st_Parser_Parser_Context_valid";
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_EGRESS_PARSING_CONTEXT_MAP_JR1_MODE].values[6].offset = UTILEX_OFFSETOF(dnx_data_dnx2_aod_tables_EGRESS_PARSING_CONTEXT_MAP_JR1_MODE_t, ERPP_1st_Parser_Parser_Context_valid);
    ...
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_MPLS_SPECIAL_LABEL_PROFILE_ATTRIBUTES___image].doc = "table related image";
    ...
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_MPLS_SPECIAL_LABEL_PROFILE_ATTRIBUTES].doc = "MPLS_SPECIAL_LABEL_PROFILE_ATTRIBUTES";
    ...
    submodule_data->tables[dnx_data_dnx2_aod_tables_table_MPLS_SPECIAL_LABEL_PROFILE_ATTRIBUTES].keys[0].doc = "entry index";
