    ...
    int unit)
{
    ...
    int module_index = dnx_data_module_lif;
    int submodule_index = dnx_data_lif_submodule_lif_table_manager;
    int define_index = dnx_data_lif_lif_table_manager_define_skip_in_lif_example_table;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_lif_lif_table_manager_define_skip_in_lif_example_table;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_lif_lif_table_manager_skip_in_lif_example_table_set;
