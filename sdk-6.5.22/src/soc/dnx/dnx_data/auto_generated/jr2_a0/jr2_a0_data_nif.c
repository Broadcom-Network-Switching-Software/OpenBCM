    ...
    int unit)
{
    ...
    if (7 < table->keys[0].size)
    {
        ...
        data->fec_type = bcmPortPhyFecNone;
        data->is_valid = !dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_ilkn_over_fabric_only);
    }
    if (8 < table->keys[0].size)
    {
        ...
        data->is_valid = !dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_ilkn_over_fabric_only) && dnx_data_nif.ilkn.fec_units_per_core_nof_get(unit) > 0 ? TRUE : FALSE;
    }
    if (9 < table->keys[0].size)
    {
    ...
    if (11 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50;
        data->fec_type = bcmPortPhyFecNone;
        data->is_valid = !dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_ilkn_over_fabric_only) && dnx_data_nif.ilkn.is_20G_speed_supported_get(unit) > 0 ? TRUE : FALSE;
    }
    if (12 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50;
        data->fec_type = bcmPortPhyFecRs544;
        data->is_valid = !dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_ilkn_over_fabric_only) && dnx_data_nif.ilkn.is_20G_speed_supported_get(unit) && dnx_data_nif.ilkn.fec_units_per_core_nof_get(unit) > 0 ? TRUE : FALSE;
    }
    if (13 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50;
        data->fec_type = bcmPortPhyFecNone;
        data->is_valid = !dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_ilkn_over_fabric_only) && dnx_data_nif.ilkn.is_25G_speed_supported_get(unit) > 0 ? TRUE : FALSE;
    }
    if (14 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50;
        data->fec_type = bcmPortPhyFecRs544;
        data->is_valid = !dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_ilkn_over_fabric_only) && dnx_data_nif.ilkn.is_25G_speed_supported_get(unit) && dnx_data_nif.ilkn.fec_units_per_core_nof_get(unit) > 0 ? TRUE : FALSE;
    }
    ...
    if (17 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50;
        data->fec_type = bcmPortPhyFecNone;
        data->is_valid = !dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_ilkn_over_fabric_only) && dnx_data_nif.ilkn.is_27G_speed_supported_get(unit) > 0 ? TRUE : FALSE;
    }
    if (18 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50;
        data->fec_type = bcmPortPhyFecRs544;
        data->is_valid = !dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_ilkn_over_fabric_only) && dnx_data_nif.ilkn.is_27G_speed_supported_get(unit) && dnx_data_nif.ilkn.fec_units_per_core_nof_get(unit) > 0 ? TRUE : FALSE;
    }
    if (19 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50;
        data->fec_type = bcmPortPhyFecNone;
        data->is_valid = !dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_ilkn_over_fabric_only) && dnx_data_nif.ilkn.is_28G_speed_supported_get(unit) > 0 ? TRUE : FALSE;
    }
    if (20 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50;
        data->fec_type = bcmPortPhyFecRs544;
        data->is_valid = !dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_ilkn_over_fabric_only) && dnx_data_nif.ilkn.is_28G_speed_supported_get(unit) && dnx_data_nif.ilkn.fec_units_per_core_nof_get(unit) > 0 ? TRUE : FALSE;
    }
    if (21 < table->keys[0].size)
    {
        ...
        data->pm_dispatch_type = portmodDispatchTypePm8x50;
        data->fec_type = bcmPortPhyFecRs544;
        data->is_valid = !dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_ilkn_over_fabric_only) && dnx_data_nif.phys.is_pam4_speed_supported_get(unit) && dnx_data_nif.ilkn.is_53G_speed_supported_get(unit) > 0 ? TRUE : FALSE;
    }
