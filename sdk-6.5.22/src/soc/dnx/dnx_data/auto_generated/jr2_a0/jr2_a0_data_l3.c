...
static shr_error_e
jr2_a0_dnx_data_l3_fec_fer_mux_connection_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l3;
    int submodule_index = dnx_data_l3_submodule_fec;
    int feature_index = dnx_data_l3_fec_fer_mux_connection_supported;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_l3_fec_fer_mux_connection_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_l3_fec_fer_mux_connection_supported_set;
