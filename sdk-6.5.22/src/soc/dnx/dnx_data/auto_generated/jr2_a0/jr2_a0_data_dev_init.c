    ...
    int unit)
{
    ...
    table->keys[0].size = 76;
    table->info_get.key_size[0] = 76;
...
static shr_error_e
jr2_a0_dnx_data_dev_init_general_egress_estimated_bta_btr_config_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_dev_init;
...
static shr_error_e
jr2_a0_dnx_data_dev_init_ha_example_init_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_dev_init;
    int submodule_index = dnx_data_dev_init_submodule_ha;
    int feature_index = dnx_data_dev_init_ha_example_init;
    SHR_FUNC_INIT_VARS(unit);
    ...
    feature->property.suffix = "example_init";
...
static shr_error_e
jr2_a0_dnx_data_dev_init_ha_warmboot_backoff_rate_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
    int submodule_index = dnx_data_dev_init_submodule_ha;
    int define_index = dnx_data_dev_init_ha_define_warmboot_backoff_rate;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_dev_init_ha_nof_guaranteed_reboots_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dev_init;
    int submodule_index = dnx_data_dev_init_submodule_ha;
    int define_index = dnx_data_dev_init_ha_define_nof_guaranteed_reboots;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    table->keys[0].size = 111;
    table->info_get.key_size[0] = 111;
    ...
    int unit)
{
    ...
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_dev_init_general_egress_estimated_bta_btr_config_set;
    ...
    data_index = dnx_data_dev_init_ha_define_warmboot_backoff_rate;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_dev_init_ha_warmboot_backoff_rate_set;
    data_index = dnx_data_dev_init_ha_define_nof_guaranteed_reboots;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_dev_init_ha_nof_guaranteed_reboots_set;
    ...
    data_index = dnx_data_dev_init_ha_example_init;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_dev_init_ha_example_init_set;
