...
static shr_error_e
jr2_a0_dnx_data_mdb_direct_vsi_payload_size_enum_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_mdb;
    int submodule_index = dnx_data_mdb_submodule_direct;
    int define_index = dnx_data_mdb_direct_define_vsi_payload_size_enum;
    SHR_FUNC_INIT_VARS(unit);

    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    
    define->default_data = DBAL_ENUM_FVAL_DIRECT_PAYLOAD_SIZES_90B;

    
    define->data = DBAL_ENUM_FVAL_DIRECT_PAYLOAD_SIZES_90B;
    ...
    int unit)
{
    ...
    table->values[3].default_val = "DEFAULT_KAPS_DB_NAME";
    table->values[4].default_val = "DBAL_NOF_DYNAMIC_AND_STATIC_TABLES";
    table->values[5].default_val = "0";
    table->values[6].default_val = "0";
    table->values[7].default_val = "0";
    table->values[8].default_val = "0";
    ...
    int unit)
{
    ...
    data_index = dnx_data_mdb_direct_define_vsi_payload_size_enum;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_mdb_direct_vsi_payload_size_enum_set;
