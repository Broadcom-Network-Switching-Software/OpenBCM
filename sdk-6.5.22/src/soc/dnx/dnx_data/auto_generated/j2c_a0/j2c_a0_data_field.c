    ...
    int unit)
{
    ...
    if (DNX_FIELD_STAGE_EXTERNAL < table->keys[0].size && DNX_FIELD_IFWD2_QUAL_AC_IN_LIF_WIDE_DATA < table->keys[1].size)
    {
        ...
        data->offset = 1749+dnx_data_field.general_data_qualifiers.ac_in_lif_wide_data_start_bit_get(unit);
    }
    if (DNX_FIELD_STAGE_EXTERNAL < table->keys[0].size && DNX_FIELD_IFWD2_QUAL_AC_IN_LIF_WIDE_DATA_EXTENDED < table->keys[1].size)
    {
        ...
        data->offset = 1749+dnx_data_field.general_data_qualifiers.ac_in_lif_wide_data_extended_start_bit_get(unit);
    }
    if (DNX_FIELD_STAGE_EXTERNAL < table->keys[0].size && DNX_FIELD_IFWD2_QUAL_MACT_ENTRY_GROUPING < table->keys[1].size)
    {
        ...
        data->offset = 1749+dnx_data_field.general_data_qualifiers.mact_entry_grouping_start_bit_get(unit);
    }
    ...
    if (DNX_FIELD_STAGE_EXTERNAL < table->keys[0].size && DNX_FIELD_IFWD2_QUAL_VW_VIP_VALID < table->keys[1].size)
    {
        ...
        data->offset = 1749+dnx_data_field.general_data_qualifiers.vw_vip_valid_start_bit_get(unit);
    }
    if (DNX_FIELD_STAGE_EXTERNAL < table->keys[0].size && DNX_FIELD_IFWD2_QUAL_VW_VIP_ID < table->keys[1].size)
    {
        ...
        data->offset = 1749+dnx_data_field.general_data_qualifiers.vw_vip_id_start_bit_get(unit);
    }
    if (DNX_FIELD_STAGE_EXTERNAL < table->keys[0].size && DNX_FIELD_IFWD2_QUAL_VW_MEMBER_REFERENCE < table->keys[1].size)
    {
        ...
        data->offset = 1749+dnx_data_field.general_data_qualifiers.vw_member_reference_start_bit_get(unit);
    }
    if (DNX_FIELD_STAGE_EXTERNAL < table->keys[0].size && DNX_FIELD_IFWD2_QUAL_VW_PCC_HIT < table->keys[1].size)
    {
        ...
        data->offset = 1749+dnx_data_field.general_data_qualifiers.vw_pcc_hit_start_bit_get(unit);
    }
    ...
    if (DNX_FIELD_STAGE_IPMF1 < table->keys[0].size && DNX_FIELD_IPMF1_QUAL_AC_IN_LIF_WIDE_DATA < table->keys[1].size)
    {
        ...
        data->offset = 2918+dnx_data_field.general_data_qualifiers.ac_in_lif_wide_data_start_bit_get(unit);
    }
    if (DNX_FIELD_STAGE_IPMF1 < table->keys[0].size && DNX_FIELD_IPMF1_QUAL_NATIVE_AC_IN_LIF_WIDE_DATA < table->keys[1].size)
    {
        ...
        data->offset = 2918+dnx_data_field.general_data_qualifiers.native_ac_in_lif_wide_data_start_bit_get(unit);
    }
    if (DNX_FIELD_STAGE_IPMF1 < table->keys[0].size && DNX_FIELD_IPMF1_QUAL_AC_IN_LIF_WIDE_DATA_EXTENDED < table->keys[1].size)
    {
        ...
        data->offset = 2918+dnx_data_field.general_data_qualifiers.ac_in_lif_wide_data_extended_start_bit_get(unit);
    }
    if (DNX_FIELD_STAGE_IPMF1 < table->keys[0].size && DNX_FIELD_IPMF1_QUAL_PWE_IN_LIF_WIDE_DATA < table->keys[1].size)
    {
        data = (dnx_data_field_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_IPMF1, DNX_FIELD_IPMF1_QUAL_PWE_IN_LIF_WIDE_DATA);
        data->offset = 2918+dnx_data_field.general_data_qualifiers.pwe_in_lif_wide_data_start_bit_get(unit);
    }
    if (DNX_FIELD_STAGE_IPMF1 < table->keys[0].size && DNX_FIELD_IPMF1_QUAL_MACT_ENTRY_GROUPING < table->keys[1].size)
    {
        ...
        data->offset = 2918+dnx_data_field.general_data_qualifiers.mact_entry_grouping_start_bit_get(unit);
    }
    ...
    if (DNX_FIELD_STAGE_IPMF1 < table->keys[0].size && DNX_FIELD_IPMF1_QUAL_VW_VIP_VALID < table->keys[1].size)
    {
        ...
        data->offset = 2918+dnx_data_field.general_data_qualifiers.vw_vip_valid_start_bit_get(unit);
    }
    if (DNX_FIELD_STAGE_IPMF1 < table->keys[0].size && DNX_FIELD_IPMF1_QUAL_VW_VIP_ID < table->keys[1].size)
    {
        ...
        data->offset = 2918+dnx_data_field.general_data_qualifiers.vw_vip_id_start_bit_get(unit);
    }
    if (DNX_FIELD_STAGE_IPMF1 < table->keys[0].size && DNX_FIELD_IPMF1_QUAL_VW_MEMBER_REFERENCE < table->keys[1].size)
    {
        ...
        data->offset = 2918+dnx_data_field.general_data_qualifiers.vw_member_reference_start_bit_get(unit);
    }
    if (DNX_FIELD_STAGE_IPMF1 < table->keys[0].size && DNX_FIELD_IPMF1_QUAL_VW_PCC_HIT < table->keys[1].size)
    {
        ...
        data->offset = 2918+dnx_data_field.general_data_qualifiers.vw_pcc_hit_start_bit_get(unit);
    }
