...
static shr_error_e
jr2_b0_dnx_data_dnx2_aod_tables_ERPP_FWD_CONTEXT_FILTER___image_set(
    int unit)
{
...
static shr_error_e
jr2_b0_dnx_data_dnx2_aod_tables_ERPP_FWD_CONTEXT_FILTER_set(
    int unit)
{
    int index_index;
...
static shr_error_e
jr2_b0_dnx_data_dnx2_aod_tables_EGRESS_PER_FORWARD_CODE___image_set(
    int unit)
{
...
static shr_error_e
jr2_b0_dnx_data_dnx2_aod_tables_EGRESS_PER_FORWARD_CODE_set(
    int unit)
{
    int index_index;
    int soc_value_index;
...
static shr_error_e
jr2_b0_dnx_data_dnx2_aod_tables_ERPP_FORWARD_CODE_SELECTION___image_set(
    int unit)
{
...
static shr_error_e
jr2_b0_dnx_data_dnx2_aod_tables_ERPP_FORWARD_CODE_SELECTION_set(
    int unit)
{
    int index_index;
    int soc_value_index;
...
static shr_error_e
jr2_b0_dnx_data_dnx2_aod_tables_ETPP_FORWARD_CODE_SELECTION___image_set(
    int unit)
{
...
static shr_error_e
jr2_b0_dnx_data_dnx2_aod_tables_ETPP_FORWARD_CODE_SELECTION_set(
    int unit)
{
    int index_index;
    int soc_value_index;
...
static shr_error_e
jr2_b0_dnx_data_dnx2_aod_tables_EGRESS_PARSING_START_TYPE_CONTEXT___image_set(
    int unit)
{
...
static shr_error_e
jr2_b0_dnx_data_dnx2_aod_tables_EGRESS_PARSING_START_TYPE_CONTEXT_set(
    int unit)
{
    int index_index;
    int soc_value_index;
...
static shr_error_e
jr2_b0_dnx_data_dnx2_aod_tables_EGRESS_PARSING_CONTEXT_MAP_JR1_MODE___image_set(
    int unit)
{
...
static shr_error_e
jr2_b0_dnx_data_dnx2_aod_tables_EGRESS_PARSING_CONTEXT_MAP_JR1_MODE_set(
    int unit)
{
    int index_index;
    int soc_value_index;
...
static shr_error_e
jr2_b0_dnx_data_dnx2_aod_tables_MPLS_SPECIAL_LABEL_PROFILE_ATTRIBUTES___image_set(
    int unit)
{
...
static shr_error_e
jr2_b0_dnx_data_dnx2_aod_tables_MPLS_SPECIAL_LABEL_PROFILE_ATTRIBUTES_set(
    int unit)
{
    int index_index;
    ...
    int unit)
{
    ...
    table->set = jr2_b0_dnx_data_dnx2_aod_tables_ERPP_FWD_CONTEXT_FILTER___image_set;
    data_index = dnx_data_dnx2_aod_tables_table_ERPP_FWD_CONTEXT_FILTER;
    table = &submodule->tables[data_index];
    table->set = jr2_b0_dnx_data_dnx2_aod_tables_ERPP_FWD_CONTEXT_FILTER_set;
    data_index = dnx_data_dnx2_aod_tables_table_EGRESS_PER_FORWARD_CODE___image;
    table = &submodule->tables[data_index];
    table->set = jr2_b0_dnx_data_dnx2_aod_tables_EGRESS_PER_FORWARD_CODE___image_set;
    data_index = dnx_data_dnx2_aod_tables_table_EGRESS_PER_FORWARD_CODE;
    table = &submodule->tables[data_index];
    table->set = jr2_b0_dnx_data_dnx2_aod_tables_EGRESS_PER_FORWARD_CODE_set;
    data_index = dnx_data_dnx2_aod_tables_table_ERPP_FORWARD_CODE_SELECTION___image;
    table = &submodule->tables[data_index];
    table->set = jr2_b0_dnx_data_dnx2_aod_tables_ERPP_FORWARD_CODE_SELECTION___image_set;
    data_index = dnx_data_dnx2_aod_tables_table_ERPP_FORWARD_CODE_SELECTION;
    table = &submodule->tables[data_index];
    table->set = jr2_b0_dnx_data_dnx2_aod_tables_ERPP_FORWARD_CODE_SELECTION_set;
    data_index = dnx_data_dnx2_aod_tables_table_ETPP_FORWARD_CODE_SELECTION___image;
    table = &submodule->tables[data_index];
    table->set = jr2_b0_dnx_data_dnx2_aod_tables_ETPP_FORWARD_CODE_SELECTION___image_set;
    data_index = dnx_data_dnx2_aod_tables_table_ETPP_FORWARD_CODE_SELECTION;
    table = &submodule->tables[data_index];
    table->set = jr2_b0_dnx_data_dnx2_aod_tables_ETPP_FORWARD_CODE_SELECTION_set;
    data_index = dnx_data_dnx2_aod_tables_table_EGRESS_PARSING_START_TYPE_CONTEXT___image;
    table = &submodule->tables[data_index];
    table->set = jr2_b0_dnx_data_dnx2_aod_tables_EGRESS_PARSING_START_TYPE_CONTEXT___image_set;
    data_index = dnx_data_dnx2_aod_tables_table_EGRESS_PARSING_START_TYPE_CONTEXT;
    table = &submodule->tables[data_index];
    table->set = jr2_b0_dnx_data_dnx2_aod_tables_EGRESS_PARSING_START_TYPE_CONTEXT_set;
    data_index = dnx_data_dnx2_aod_tables_table_EGRESS_PARSING_CONTEXT_MAP_JR1_MODE___image;
    table = &submodule->tables[data_index];
    table->set = jr2_b0_dnx_data_dnx2_aod_tables_EGRESS_PARSING_CONTEXT_MAP_JR1_MODE___image_set;
    data_index = dnx_data_dnx2_aod_tables_table_EGRESS_PARSING_CONTEXT_MAP_JR1_MODE;
    table = &submodule->tables[data_index];
    table->set = jr2_b0_dnx_data_dnx2_aod_tables_EGRESS_PARSING_CONTEXT_MAP_JR1_MODE_set;
    data_index = dnx_data_dnx2_aod_tables_table_MPLS_SPECIAL_LABEL_PROFILE_ATTRIBUTES___image;
    table = &submodule->tables[data_index];
    table->set = jr2_b0_dnx_data_dnx2_aod_tables_MPLS_SPECIAL_LABEL_PROFILE_ATTRIBUTES___image_set;
    data_index = dnx_data_dnx2_aod_tables_table_MPLS_SPECIAL_LABEL_PROFILE_ATTRIBUTES;
    table = &submodule->tables[data_index];
    table->set = jr2_b0_dnx_data_dnx2_aod_tables_MPLS_SPECIAL_LABEL_PROFILE_ATTRIBUTES_set;
