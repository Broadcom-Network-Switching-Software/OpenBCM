...
static shr_error_e
jr2_b0_dnx_data_meter_diag_rate_measurements_support_set(
    int unit)
{
...
static shr_error_e
jr2_b0_dnx_data_meter_expansion_expansion_for_uuc_umc_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_meter;
    ...
    int unit)
{
    ...
    feature->set = jr2_b0_dnx_data_meter_diag_rate_measurements_support_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = jr2_b0_dnx_data_meter_expansion_expansion_for_uuc_umc_support_set;
