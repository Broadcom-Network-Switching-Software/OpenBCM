    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_crps_engine_slim_counters_is_supported].name = "slim_counters_is_supported";
    submodule_data->features[dnx_data_crps_engine_slim_counters_is_supported].doc = "Is slim counters format supported";
    submodule_data->features[dnx_data_crps_engine_slim_counters_is_supported].flags |= DNXC_DATA_F_FEATURE;
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_crps_expansion_table_erpp_types].nof_values = 10;
    ...
    submodule_data->tables[dnx_data_crps_expansion_table_erpp_types].values[0].type = "bcm_stat_expansion_types_t[9]";
    ...
    submodule_data->tables[dnx_data_crps_expansion_table_erpp_types].values[8].name = "pp_discard_offset";
    submodule_data->tables[dnx_data_crps_expansion_table_erpp_types].values[8].type = "uint32";
    submodule_data->tables[dnx_data_crps_expansion_table_erpp_types].values[8].doc = "field offset in the data sent from the source";
    submodule_data->tables[dnx_data_crps_expansion_table_erpp_types].values[8].offset = UTILEX_OFFSETOF(dnx_data_crps_expansion_erpp_types_t, pp_discard_offset);
    submodule_data->tables[dnx_data_crps_expansion_table_erpp_types].values[9].name = "tm_discard_offset";
    submodule_data->tables[dnx_data_crps_expansion_table_erpp_types].values[9].type = "uint32";
    submodule_data->tables[dnx_data_crps_expansion_table_erpp_types].values[9].doc = "field offset in the data sent from the source";
    submodule_data->tables[dnx_data_crps_expansion_table_erpp_types].values[9].offset = UTILEX_OFFSETOF(dnx_data_crps_expansion_erpp_types_t, tm_discard_offset);
    ...
    int value_index)
{
    ...
    {
        case 0:
            DNXC_DATA_MGMT_ARR_STR(buffer, 9, data->valid_types);
            break;
        case 1:
            sal_snprintf(buffer, DNXC_DATA_MGMT_MAX_TABLE_VALUE_LENGTH, "%d", data->total_nof_bits);
            break;
