    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_field_stage_table_stage_info].nof_values = 58;
    ...
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[52].name = "uses_small_exem";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[52].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[52].doc = "Indicated if the stage can perform a SEXEM lookup.";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[52].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, uses_small_exem);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[53].name = "uses_large_exem";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[53].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[53].doc = "Indicated if the stage can perform a LEXEM lookup.";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[53].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, uses_large_exem);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[54].name = "cmp_selection";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[54].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[54].doc = "Compare selection for both keys of 2nd compare, See the CMP_SELECTION field in IPPC_PMF_GENERAL register for additional information";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[54].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, cmp_selection);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[55].name = "nof_bits_main_pbus";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[55].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[55].doc = "Number of bits in the main PBUS of the stage (the one used by METADATA qualifiers). Only iPMF2 uses the iPMF1 PBUs as it's main PBUS.";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[55].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_bits_main_pbus);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[56].name = "nof_bits_native_pbus";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[56].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[56].doc = "Number of bits in the native PBUS of the stage, if it is different from the main PBUS. Only iPMF2 has a separate native PBUS.";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[56].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, nof_bits_native_pbus);
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[57].name = "dir_ext_single_key_size";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[57].type = "int";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[57].doc = "Single key size used for Direct Extraction.";
    submodule_data->tables[dnx_data_field_stage_table_stage_info].values[57].offset = UTILEX_OFFSETOF(dnx_data_field_stage_stage_info_t, dir_ext_single_key_size);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->doc = "KBP/XLTCAM data";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_field_preselector_define_srv6_endpoint_usp_udp_extended_cut_presel_id_ipmf1].name = "srv6_endpoint_usp_udp_extended_cut_presel_id_ipmf1";
    submodule_data->defines[dnx_data_field_preselector_define_srv6_endpoint_usp_udp_extended_cut_presel_id_ipmf1].doc = "Default Presel Id in iPMF1 Id for egress_usp_extended";
    
    submodule_data->defines[dnx_data_field_preselector_define_srv6_endpoint_usp_udp_extended_cut_presel_id_ipmf1].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_field_preselector_define_srv6_endpoint_usp_tcp_extended_cut_presel_id_ipmf1].name = "srv6_endpoint_usp_tcp_extended_cut_presel_id_ipmf1";
    submodule_data->defines[dnx_data_field_preselector_define_srv6_endpoint_usp_tcp_extended_cut_presel_id_ipmf1].doc = "Default Presel Id in iPMF1 Id for egress_usp_extended";
    
    submodule_data->defines[dnx_data_field_preselector_define_srv6_endpoint_usp_tcp_extended_cut_presel_id_ipmf1].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_field_preselector_define_srv6_endpoint_usp_icmp_extended_cut_presel_id_ipmf1].name = "srv6_endpoint_usp_icmp_extended_cut_presel_id_ipmf1";
    submodule_data->defines[dnx_data_field_preselector_define_srv6_endpoint_usp_icmp_extended_cut_presel_id_ipmf1].doc = "Default Presel Id in iPMF1 Id for egress_usp_extended";
    
    submodule_data->defines[dnx_data_field_preselector_define_srv6_endpoint_usp_icmp_extended_cut_presel_id_ipmf1].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->defines[dnx_data_field_preselector_define_srv6_egress_usp_udp_presel_id_ipmf1].name = "srv6_egress_usp_udp_presel_id_ipmf1";
    submodule_data->defines[dnx_data_field_preselector_define_srv6_egress_usp_udp_presel_id_ipmf1].doc = "Default Presel in iPMF1 Id for egress_usp udp";
    
    submodule_data->defines[dnx_data_field_preselector_define_srv6_egress_usp_udp_presel_id_ipmf1].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_field_preselector_define_srv6_egress_usp_tcp_presel_id_ipmf1].name = "srv6_egress_usp_tcp_presel_id_ipmf1";
    submodule_data->defines[dnx_data_field_preselector_define_srv6_egress_usp_tcp_presel_id_ipmf1].doc = "Default Presel in iPMF1 Id for egress_usp udp";
    
    submodule_data->defines[dnx_data_field_preselector_define_srv6_egress_usp_tcp_presel_id_ipmf1].flags |= DNXC_DATA_F_DEFINE;
    ...
    submodule_data->defines[dnx_data_field_preselector_define_srv6_egress_usp_icmp_presel_id_ipmf1].doc = "Default Presel in iPMF1 Id for egress_usp udp";
    ...
    submodule_data->defines[dnx_data_field_preselector_define_srv6_egress_usd_presel_id_ipmf1].name = "srv6_egress_usd_presel_id_ipmf1";
    submodule_data->defines[dnx_data_field_preselector_define_srv6_egress_usd_presel_id_ipmf1].doc = "Default Presel Id in iPMF1 Id for egress usd";
    
    submodule_data->defines[dnx_data_field_preselector_define_srv6_egress_usd_presel_id_ipmf1].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_field_preselector_srv6_endpoint_usp_udp_extended_cut_presel_id_ipmf1_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_preselector, dnx_data_field_preselector_define_srv6_endpoint_usp_udp_extended_cut_presel_id_ipmf1);
}

uint32
dnx_data_field_preselector_srv6_endpoint_usp_tcp_extended_cut_presel_id_ipmf1_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_preselector, dnx_data_field_preselector_define_srv6_endpoint_usp_tcp_extended_cut_presel_id_ipmf1);
}

uint32
dnx_data_field_preselector_srv6_endpoint_usp_icmp_extended_cut_presel_id_ipmf1_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_preselector, dnx_data_field_preselector_define_srv6_endpoint_usp_icmp_extended_cut_presel_id_ipmf1);
}
...
uint32
dnx_data_field_preselector_srv6_egress_usp_udp_presel_id_ipmf1_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_preselector, dnx_data_field_preselector_define_srv6_egress_usp_udp_presel_id_ipmf1);
}

uint32
dnx_data_field_preselector_srv6_egress_usp_tcp_presel_id_ipmf1_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_preselector, dnx_data_field_preselector_define_srv6_egress_usp_tcp_presel_id_ipmf1);
}
...
uint32
dnx_data_field_preselector_srv6_egress_usd_presel_id_ipmf1_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_preselector, dnx_data_field_preselector_define_srv6_egress_usd_presel_id_ipmf1);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_field_udh_define_supported].name = "supported";
    submodule_data->defines[dnx_data_field_udh_define_supported].doc = "If UDH supported";
    
    submodule_data->defines[dnx_data_field_udh_define_supported].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_field_udh_supported_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_udh, dnx_data_field_udh_define_supported);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_field_features_define_tcam_cs_enable].name = "tcam_cs_enable";
    submodule_data->defines[dnx_data_field_features_define_tcam_cs_enable].doc = "TCAM cs Enabled";
    
    submodule_data->defines[dnx_data_field_features_define_tcam_cs_enable].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_field_features_tcam_cs_enable_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_field, dnx_data_field_submodule_features, dnx_data_field_features_define_tcam_cs_enable);
}
