    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_l3_fec_fer_mux_connection_supported].name = "fer_mux_connection_supported";
    submodule_data->features[dnx_data_l3_fec_fer_mux_connection_supported].doc = "Allows different FER mux connectivity.";
    submodule_data->features[dnx_data_l3_fec_fer_mux_connection_supported].flags |= DNXC_DATA_F_FEATURE;
