...
static shr_error_e
q2a_a0_dnx_data_ingr_congestion_info_soft_dram_block_supported_set(
    int unit)
{
...
static shr_error_e
q2a_a0_dnx_data_ingr_congestion_info_latency_based_admission_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_ingr_congestion;
...
static shr_error_e
q2a_a0_dnx_data_ingr_congestion_info_global_ecn_marking_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_ingr_congestion;
...
static shr_error_e
q2a_a0_dnx_data_ingr_congestion_info_latency_based_admission_reject_flow_profile_value_set(
    int unit)
{
...
static shr_error_e
q2a_a0_dnx_data_ingr_congestion_info_latency_based_admission_max_supported_profile_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ingr_congestion;
...
static shr_error_e
q2a_a0_dnx_data_ingr_congestion_info_resource_set(
    int unit)
{
    int type_index;
    ...
    if (DNX_INGRESS_CONGESTION_RESOURCE_TOTAL_BYTES < table->keys[0].size)
    {
        ...
        data->hw_resolution_nof_bits = 23;
...
static shr_error_e
q2a_a0_dnx_data_ingr_congestion_vsq_size_watermark_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_ingr_congestion;
...
static shr_error_e
q2a_a0_dnx_data_ingr_congestion_vsq_vsq_e_hw_nof_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ingr_congestion;
...
static shr_error_e
q2a_a0_dnx_data_ingr_congestion_vsq_vsq_f_hw_nof_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ingr_congestion;
...
static shr_error_e
q2a_a0_dnx_data_ingr_congestion_vsq_nif_vsq_e_nof_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ingr_congestion;
...
static shr_error_e
q2a_a0_dnx_data_ingr_congestion_dbal_admission_test_nof_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ingr_congestion;
...
static shr_error_e
q2a_a0_dnx_data_ingr_congestion_dbal_dram_bdbs_nof_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ingr_congestion;
...
static shr_error_e
q2a_a0_dnx_data_ingr_congestion_dbal_sram_pdbs_nof_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ingr_congestion;
...
static shr_error_e
q2a_a0_dnx_data_ingr_congestion_dbal_sram_buffer_nof_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ingr_congestion;
...
static shr_error_e
q2a_a0_dnx_data_ingr_congestion_dbal_admission_bits_mapping_set(
    int unit)
{
    int rjct_bit_index;
...
static shr_error_e
q2a_a0_dnx_data_ingr_congestion_mirror_on_drop_is_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_ingr_congestion;
...
static shr_error_e
q2a_a0_dnx_data_ingr_congestion_mirror_on_drop_nof_groups_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ingr_congestion;
...
static shr_error_e
q2a_a0_dnx_data_ingr_congestion_mirror_on_drop_aging_clocks_resolution_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_ingr_congestion;
...
shr_error_e
q2a_a0_data_ingr_congestion_attach(
    int unit)
{
    ...
    define->set = q2a_a0_dnx_data_ingr_congestion_info_latency_based_admission_reject_flow_profile_value_set;
    data_index = dnx_data_ingr_congestion_info_define_latency_based_admission_max_supported_profile;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_ingr_congestion_info_latency_based_admission_max_supported_profile_set;

    
    data_index = dnx_data_ingr_congestion_info_soft_dram_block_supported;
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_ingr_congestion_info_soft_dram_block_supported_set;
    data_index = dnx_data_ingr_congestion_info_latency_based_admission;
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_ingr_congestion_info_latency_based_admission_set;
    data_index = dnx_data_ingr_congestion_info_global_ecn_marking_supported;
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_ingr_congestion_info_global_ecn_marking_supported_set;

    
    data_index = dnx_data_ingr_congestion_info_table_resource;
    table = &submodule->tables[data_index];
    table->set = q2a_a0_dnx_data_ingr_congestion_info_resource_set;
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_ingr_congestion_vsq_vsq_e_hw_nof_set;
    data_index = dnx_data_ingr_congestion_vsq_define_vsq_f_hw_nof;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_ingr_congestion_vsq_vsq_f_hw_nof_set;
    data_index = dnx_data_ingr_congestion_vsq_define_nif_vsq_e_nof;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_ingr_congestion_vsq_nif_vsq_e_nof_set;

    
    data_index = dnx_data_ingr_congestion_vsq_size_watermark_support;
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_ingr_congestion_vsq_size_watermark_support_set;
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_ingr_congestion_dbal_admission_test_nof_set;
    data_index = dnx_data_ingr_congestion_dbal_define_dram_bdbs_nof_bits;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_ingr_congestion_dbal_dram_bdbs_nof_bits_set;
    data_index = dnx_data_ingr_congestion_dbal_define_sram_pdbs_nof_bits;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_ingr_congestion_dbal_sram_pdbs_nof_bits_set;
    data_index = dnx_data_ingr_congestion_dbal_define_sram_buffer_nof_bits;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_ingr_congestion_dbal_sram_buffer_nof_bits_set;
    ...
    table = &submodule->tables[data_index];
    table->set = q2a_a0_dnx_data_ingr_congestion_dbal_admission_bits_mapping_set;
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_ingr_congestion_mirror_on_drop_nof_groups_set;
    data_index = dnx_data_ingr_congestion_mirror_on_drop_define_aging_clocks_resolution;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_ingr_congestion_mirror_on_drop_aging_clocks_resolution_set;

    
    data_index = dnx_data_ingr_congestion_mirror_on_drop_is_supported;
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_ingr_congestion_mirror_on_drop_is_supported_set;
