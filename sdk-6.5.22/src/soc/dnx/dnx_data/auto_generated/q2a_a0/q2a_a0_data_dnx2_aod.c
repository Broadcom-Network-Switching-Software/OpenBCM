    ...
    int unit)
{
    ...
    if (1 < table->keys[0].size && 1 < table->keys[1].size)
    {
        data = (dnx_data_dnx2_aod_tables_ERPP_FORWARD_CODE_SELECTION_t *) dnxc_data_mgmt_table_data_get(unit, table, 1, 1);
        data->valid = 1;
        data->FAI = 0;
        data->FAI_mask = 15;
        data->FAI_valid = 1;
    ...
    int unit)
{
    ...
    if (7 < table->keys[0].size && 1 < table->keys[1].size)
    {
        ...
        data->Parsing_Start_Type_mask = 0;
        data->Parsing_Start_Type_valid = 1;
        data->ERPP_1st_Parser_Parser_Context = "BIER_MPLS_A1";
        data->ERPP_1st_Parser_Parser_Context_valid = 1;
    }
    if (8 < table->keys[0].size && 1 < table->keys[1].size)
    {
        ...
        data->Parsing_Start_Type_mask = 0;
        data->Parsing_Start_Type_valid = 1;
        data->ERPP_1st_Parser_Parser_Context = "BIER_NON_MPLS_A1";
        data->ERPP_1st_Parser_Parser_Context_valid = 1;
    }
    if (9 < table->keys[0].size && 1 < table->keys[1].size)
    {
    ...
    if (18 < table->keys[0].size && 1 < table->keys[1].size)
    {
        ...
        data->Parsing_Start_Type_mask = 0;
        data->Parsing_Start_Type_valid = 1;
        data->ERPP_1st_Parser_Parser_Context = "SRv6Endpoint_PSP_A1";
        data->ERPP_1st_Parser_Parser_Context_valid = 1;
    }
    if (19 < table->keys[0].size && 1 < table->keys[1].size)
    {
        ...
        data->Parsing_Start_Type_mask = 0;
        data->Parsing_Start_Type_valid = 1;
        data->ERPP_1st_Parser_Parser_Context = "MPLS_DUMMY";
        data->ERPP_1st_Parser_Parser_Context_valid = 1;
    }
