...
static shr_error_e
q2a_a0_dnx_data_tdm_params_sid_bits_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_tdm;
    int submodule_index = dnx_data_tdm_submodule_params;
    int define_index = dnx_data_tdm_params_define_sid_bits_size;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_tdm_params_define_sid_bits_size;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_tdm_params_sid_bits_size_set;
