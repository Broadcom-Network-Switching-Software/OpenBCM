    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_tdm_params_define_sid_bits_size].name = "sid_bits_size";
    submodule_data->defines[dnx_data_tdm_params_define_sid_bits_size].doc = "how many bits are holding the sid size";
    
    submodule_data->defines[dnx_data_tdm_params_define_sid_bits_size].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_tdm_params_sid_bits_size_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_tdm, dnx_data_tdm_submodule_params, dnx_data_tdm_params_define_sid_bits_size);
}
