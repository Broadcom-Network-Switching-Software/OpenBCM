    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_fabric_pipes_egress_tdm_bypass_supported].name = "egress_tdm_bypass_supported";
    submodule_data->features[dnx_data_fabric_pipes_egress_tdm_bypass_supported].doc = "Indicates if Fabric supports configs for Egress TDM Bypass";
    submodule_data->features[dnx_data_fabric_pipes_egress_tdm_bypass_supported].flags |= DNXC_DATA_F_FEATURE;
