    ...
    int unit)
{
    ...
    dnx_data_field.preselector.srv6_endpoint_usp_tcp_extended_cut_presel_id_ipmf1_get = dnx_data_field_preselector_srv6_endpoint_usp_tcp_extended_cut_presel_id_ipmf1_get;
    dnx_data_field.preselector.srv6_endpoint_usp_icmp_extended_cut_presel_id_ipmf1_get = dnx_data_field_preselector_srv6_endpoint_usp_icmp_extended_cut_presel_id_ipmf1_get;
    ...
    dnx_data_field.preselector.srv6_egress_usp_tcp_presel_id_ipmf1_get = dnx_data_field_preselector_srv6_egress_usp_tcp_presel_id_ipmf1_get;
    ...
    dnx_data_field.udh.supported_get = dnx_data_field_udh_supported_get;
    ...
    dnx_data_field.features.tcam_cs_enable_get = dnx_data_field_features_tcam_cs_enable_get;
    ...
    dnx_data_lif.lif_table_manager.skip_in_lif_example_table_get = dnx_data_lif_lif_table_manager_skip_in_lif_example_table_get;
    ...
    dnx_data_mdb.direct.vsi_payload_size_enum_get = dnx_data_mdb_direct_vsi_payload_size_enum_get;
    ...
    dnx_data_tdm.params.sid_bits_size_get = dnx_data_tdm_params_sid_bits_size_get;
