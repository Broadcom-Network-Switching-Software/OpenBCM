    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_lif_lif_table_manager_define_skip_in_lif_example_table].name = "skip_in_lif_example_table";
    submodule_data->defines[dnx_data_lif_lif_table_manager_define_skip_in_lif_example_table].doc = "Skip initialization of in lif example table - DBAL_TABLE_EXAMPLE_IN_LIF_FORMAT_DIFFERENT_SIZES";
    
    submodule_data->defines[dnx_data_lif_lif_table_manager_define_skip_in_lif_example_table].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_lif_lif_table_manager_skip_in_lif_example_table_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_lif, dnx_data_lif_submodule_lif_table_manager, dnx_data_lif_lif_table_manager_define_skip_in_lif_example_table);
}
