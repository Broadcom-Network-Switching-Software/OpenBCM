...
static shr_error_e
j2p_a0_dnx_data_mdb_em_inaccurate_mode_partial_support_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_mdb;
...
static shr_error_e
j2p_a0_dnx_data_mdb_em_mdb_emp_dbal_phy_tables_info_set(
    int unit)
{
    int mdb_table_index;
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_mdb_em_mdb_emp_dbal_phy_tables_info_t, (1 * (table->keys[0].size) + 1  ), "data of dnx_data_mdb_em_table_mdb_emp_dbal_phy_tables_info");
...
static shr_error_e
j2p_a0_dnx_data_mdb_direct_mdb_fec_mdb_phy_tables_info_set(
    int unit)
{
    int mdb_table_index;
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_mdb_direct_mdb_fec_mdb_phy_tables_info_t, (1 * (table->keys[0].size) + 1  ), "data of dnx_data_mdb_direct_table_mdb_fec_mdb_phy_tables_info");
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_mdb_em_inaccurate_mode_partial_support_set;
    ...
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_mdb_em_mdb_emp_dbal_phy_tables_info_set;
    ...
    table = &submodule->tables[data_index];
    table->set = j2p_a0_dnx_data_mdb_direct_mdb_fec_mdb_phy_tables_info_set;
