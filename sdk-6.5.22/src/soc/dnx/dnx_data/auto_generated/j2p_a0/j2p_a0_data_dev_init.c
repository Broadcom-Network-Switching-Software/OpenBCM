    ...
    int unit)
{
    ...
    {
        data = (dnx_data_dev_init_time_step_thresh_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_INIT_STEP_DRAM_PHY_BIST, 0);
        data->value = 3270000;
    }
    ...
    int unit)
{
    ...
    table->keys[0].size = 63;
    table->info_get.key_size[0] = 63;
    ...
    int unit)
{
    ...
    table->keys[0].size = 131;
    table->info_get.key_size[0] = 131;
