...
static shr_error_e
j2p_a0_dnx_data_access_mdio_nof_pms_per_ring_set(
    int unit)
{
...
static shr_error_e
j2p_a0_dnx_data_access_mdio_ring_offset_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_access;
    ...
    int unit)
{
    ...
    define->set = j2p_a0_dnx_data_access_mdio_nof_pms_per_ring_set;
    data_index = dnx_data_access_mdio_define_ring_offset;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_access_mdio_ring_offset_set;
