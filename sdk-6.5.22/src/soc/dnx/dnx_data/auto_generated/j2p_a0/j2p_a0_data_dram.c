    ...
    int unit)
{
    ...
    table->values[10].default_val = "57";
    table->values[11].default_val = "10";
    table->values[12].default_val = "4";
    table->values[13].default_val = "26";
    ...
    table->values[19].default_val = "UTILEX_DIV_ROUND_UP(260 * DATA(dram, general_info, frequency), 1000)";
    table->values[20].default_val = "8";
    table->values[21].default_val = "18";
