    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_switch_load_balancing_define_padded_layers_crc_buffer].doc = "Indicate if a zeros padding is added to the layer recored CRCs values before the LB keys generation";
    ...
    submodule_data->defines[dnx_data_switch_load_balancing_define_wide_hash_buffer].doc = "The buffer used to generate the header CRC after the header was folded into this size. A wide size is used for non symmetrical IPv6 hashing";
    ...
    submodule_data->defines[dnx_data_switch_load_balancing_define_nof_lb_mpls_stack].doc = "The NOF MPLS stacks supported for the LB key generation";
