    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_mpls_general_define_per_lif_speculative_parsing_supported].name = "per_lif_speculative_parsing_supported";
    submodule_data->defines[dnx_data_mpls_general_define_per_lif_speculative_parsing_supported].doc = "Indicates whether Per LIF speulative parsing supported.";
    
    submodule_data->defines[dnx_data_mpls_general_define_per_lif_speculative_parsing_supported].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_mpls_general_per_lif_speculative_parsing_supported_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_mpls, dnx_data_mpls_submodule_general, dnx_data_mpls_general_define_per_lif_speculative_parsing_supported);
}
