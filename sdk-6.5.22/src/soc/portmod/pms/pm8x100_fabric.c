...
#define PM8X100_FABRIC_SPEED_IS_PAM4(speed) \
    ((speed > 28125)? 1 : 0)

#define PM8X100_FABRIC_FEC_SYNC_MACHINE_N1_PAM4 (10)
#define PM8X100_FABRIC_FEC_SYNC_MACHINE_N2_PAM4 (21)
#define PM8X100_FABRIC_FEC_SYNC_MACHINE_N3_PAM4 (100)
#define PM8X100_FABRIC_FEC_SYNC_MACHINE_K1_PAM4 (1)
#define PM8X100_FABRIC_FEC_SYNC_MACHINE_K2_PAM4 (2)
#define PM8X100_FABRIC_FEC_SYNC_MACHINE_K3_PAM4 (2)

#define PM8X100_FABRIC_FEC_SYNC_MACHINE_N1_NRZ (1)
#define PM8X100_FABRIC_FEC_SYNC_MACHINE_N2_NRZ (7)
#define PM8X100_FABRIC_FEC_SYNC_MACHINE_N3_NRZ (8)
#define PM8X100_FABRIC_FEC_SYNC_MACHINE_K1_NRZ (1)
#define PM8X100_FABRIC_FEC_SYNC_MACHINE_K2_NRZ (7)
#define PM8X100_FABRIC_FEC_SYNC_MACHINE_K3_NRZ (1)

#define PM8X100_FABRIC_FEC_SYNC_MACHINE_IS_TRIPLE_BIT_SLIP(encoding, n1) \
...
#define PM8X100_FABRIC_PREFERRED_NRZ_PLL_INDEX   (0)
#define PM8X100_FABRIC_PREFERRED_PAM4_PLL_INDEX  (1)
...
int pm8x100_fabric_pm_fmac_tx_lane_mapping_set(int unit, int port, pm_info_t pm_info, const phymod_lane_map_t *lane_map)
{
    ...
    PM8X100_FABRIC_PORT_BITMAP_ITER(all_lanes_in_pm_bitmap, lane_index) {
        ...
        rv = PM8X100_FABRIC_LANE_IS_BYPASSED_GET(unit, pm_info, &is_bypass, lane_index);
        SOCDNX_IF_ERR_EXIT(rv);
        /* for bypass lane, the lane-swap in FMAC is aligned to be 1:1 */
        field_val = is_bypass? serdes_index_in_fmac : PM8X100_FABRIC_LANE_INDEX_IN_FMAC_GET(lane_index);
...
int pm8x100_fabric_pm_fmac_tx_lane_mapping_get(int unit, int port, pm_info_t pm_info, phymod_lane_map_t *lane_map)
{
    ...
    PM8X100_FABRIC_PORT_BITMAP_ITER(all_lanes_in_pm_bitmap, serdes_index) {
        ...
        lane_index = field_val + PM8X100_FABRIC_LANE_FMAC_INDEX_GET(serdes_index) * PM8X100_FABRIC_LANES_PER_FMAC;
...
/*
 * pm8x100_fabric_port_fec_sync_machine_config
...
*/
static
int pm8x100_fabric_port_fec_sync_machine_config(int unit, int port, pm_info_t pm_info)
{
    uint32 properties = 0;
    ...
    SOCDNX_IF_ERR_EXIT(pm8x100_fabric_port_encoding_get(unit, port, pm_info, &properties, &pcs));
    if (!PM8X100_FABRIC_ENCODING_IS_RS_FEC(pcs)) {
        SOC_EXIT;
    }

    SOCDNX_IF_ERR_EXIT(pm8x100_fabric_port_speed_config_get(unit, port, pm_info, &speed_config));

    if (PM8X100_FABRIC_SPEED_IS_PAM4(speed_config.speed)) {
        sync_machine_config.n1 = PM8X100_FABRIC_FEC_SYNC_MACHINE_N1_PAM4;
        sync_machine_config.n2 = PM8X100_FABRIC_FEC_SYNC_MACHINE_N2_PAM4;
        sync_machine_config.n3 = PM8X100_FABRIC_FEC_SYNC_MACHINE_N3_PAM4;
        sync_machine_config.k1 = PM8X100_FABRIC_FEC_SYNC_MACHINE_K1_PAM4;
        sync_machine_config.k2 = PM8X100_FABRIC_FEC_SYNC_MACHINE_K2_PAM4;
        sync_machine_config.k3 = PM8X100_FABRIC_FEC_SYNC_MACHINE_K3_PAM4;
    } else { /*NRZ*/
        sync_machine_config.n1 = PM8X100_FABRIC_FEC_SYNC_MACHINE_N1_NRZ;
        sync_machine_config.n2 = PM8X100_FABRIC_FEC_SYNC_MACHINE_N2_NRZ;
        sync_machine_config.n3 = PM8X100_FABRIC_FEC_SYNC_MACHINE_N3_NRZ;
        sync_machine_config.k1 = PM8X100_FABRIC_FEC_SYNC_MACHINE_K1_NRZ;
        sync_machine_config.k2 = PM8X100_FABRIC_FEC_SYNC_MACHINE_K2_NRZ;
        sync_machine_config.k3 = PM8X100_FABRIC_FEC_SYNC_MACHINE_K3_NRZ;
    }

    if (PM8X100_FABRIC_FEC_SYNC_MACHINE_IS_TRIPLE_BIT_SLIP(pcs, sync_machine_config.n1)) {
...
int pm8x100_fabric_port_encoding_set(int unit, int port, pm_info_t pm_info, uint32 properties, portmod_port_pcs_t encoding)
{
    ...
    case PORTMOD_PCS_64B66B_FEC:
        encoding_type = 2;
        slow_read_rate = PM8X100_FABRIC_FEC_BASE_R_SLOW_READ_RATE;
        fmal_width = PM8X100_FABRIC_FEC_BASE_R_FMAL_WIDTH;
        break;
    ...
    if(!PORTMOD_ENCODING_LOW_LATENCY_LLFC_GET(properties) && PM8X100_FABRIC_ENCODING_IS_RS_FEC(encoding)){
    ...
    } else if(PM8X100_FABRIC_ENCODING_IS_RS_FEC(encoding)){
    ...
    SOCDNX_IF_ERR_EXIT(pm8x100_fabric_port_fec_sync_machine_config(unit, port, pm_info));
...
int pm8x100_fabric_port_encoding_get(int unit, int port, pm_info_t pm_info, uint32 *properties, portmod_port_pcs_t *encoding)
{
    ...
    *properties = 0;
    ...
    case 1:
        ...
        *encoding = PORTMOD_PCS_64B66B_FEC;
        break;
    case 2:
        SOCDNX_IF_ERR_EXIT(READ_FMAC_RSF_CONFIGURATIONr(unit, fmac_blk_id, lane_index_in_fmac, reg_above64));
 ...
 */
    ...
    for (speed_index = 0; speed_index < vco_setting->num_speeds; ++speed_index)
    {
        ...
        {
            if ((PM8X100_FABRIC_SPEED_IS_PAM4(vco_setting->speed_config_list[speed_index].speed)))
            {
                /*
                 * IF speed is PAM4 TRY to assign to PLL0
                 */
                preferred_pll_index = PM8X100_FABRIC_PREFERRED_PAM4_PLL_INDEX;
            }
            else
            {
                /*
                ...
                */
                preferred_pll_index = PM8X100_FABRIC_PREFERRED_NRZ_PLL_INDEX;
            }
 ...
 */
        if(pll_vco_rate[PM8X100_FABRIC_PREFERRED_NRZ_PLL_INDEX] == required_vco)
        {
            PHYMOD_SPEED_CONFIG_ONLY_PLL0_IS_ACTIVE_SET(&phymod_speed_config);
        }
    }
    ...
    if (!PORTMOD_SPEED_CONFIG_F_SKIP_FEC_CONFIGURATION_GET(speed_config) && !is_bypass)
    {
        ...
        } else if (PM8X100_FABRIC_ENCODING_IS_RS_FEC(legacy_encoding))
        {
