...
static shr_error_e
soc_dnxc_fabric_single_pm8x50_fabric_add(
    int unit,
    int core,
    int cores_num,
    int phy_offset,
    ...
    portmod_pm_create_info_t * pm_info)
{
    ...
    if (is_sim)
    {
        ...
        PHYMOD_ACC_F_PHYSIM_SET(&pm8x50_fabric_ptr->access);
    }
    ...
    if (SOC_IS_DNX(unit))
    {
        ...
        SHR_IF_ERR_EXIT(dnx_to_phymod_ref_clk(unit, ref_clk_dnx, &pm8x50_fabric_ptr->ref_clk));
#endif
    }
    else
    {
        ...
        SHR_IF_ERR_EXIT(dnxc_soc_to_phymod_ref_clk(unit, ref_clk, &pm8x50_fabric_ptr->ref_clk));
#endif
    }
...
#if 1
    SHR_IF_ERR_EXIT(soc_dnxc_fabric_single_pm8x50_fabric_add
