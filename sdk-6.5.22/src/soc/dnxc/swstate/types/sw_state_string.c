    ...
    char *src)
{
    ...
    offset = sal_strnlen(string,SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH);
    src_len = sal_strnlen(src,SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH);
    ...
    uint32 *size)
{
    ...
    *size = sal_strnlen(string,SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH);
    ...
    char *dest)
{
    ...
    DNX_SW_STATE_MEMREAD(unit, dest, string, 0, sal_strnlen(string,SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH) + 1, DNXC_SW_STATE_NO_FLAGS, "get the string.");
