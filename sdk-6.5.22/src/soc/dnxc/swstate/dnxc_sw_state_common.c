...
int dnxc_sw_state_memcpy_common(
    ...
    if (DNXC_VERIFY_ALLOWED_GET(unit))
    {
        ...
        DNXC_SW_STATE_IF_ERR_EXIT(dnxc_sw_state_memcpy_verify_common(unit, module_id, size, dest, src, flags, dbg_string));
    }
...
int dnxc_sw_state_memset_common(
    ...
    if (DNXC_VERIFY_ALLOWED_GET(unit))
    {
        ...
        DNXC_SW_STATE_IF_ERR_EXIT(dnxc_sw_state_memset_verify_common(unit, module_id, dest, value, size, flags, dbg_string));
    }
