    ...
    char memory_profile_file[RHFILE_MAX_SIZE])
{
    ...
    sal_strncat(file_name, "/data/internal/", RHFILE_MAX_SIZE - 1);
    sal_strncat(file_name, name, RHFILE_MAX_SIZE - sal_strnlen(file_name, sizeof(file_name)) - 1);
    sal_strncat(file_name, "_memory_profile_", RHFILE_MAX_SIZE - sal_strnlen(file_name, sizeof(file_name)) - 1);
    if (memory_footprint_profile != NULL)
    {
        sal_strncat(file_name, memory_footprint_profile,
                    RHFILE_MAX_SIZE - sal_strnlen(file_name, sizeof(file_name)) - 1);
    }
    sal_strncat(file_name, ".xml", RHFILE_MAX_SIZE - sal_strnlen(file_name, sizeof(file_name)) - 1);
