    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnxf_data_port_lane_map_define_lane_map_bound].labels[0] = "data_notrev";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnxf_data_port_pll_define_nof_plls_per_pm].labels[0] = "data_notrev";
