...
int
dnxf_state_modid_group_map_raw_bit_clear(int unit, uint32 group_map_idx_0, uint32 _bit_num)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dnxf_state_modid_group_map_raw_bit_get(int unit, uint32 group_map_idx_0, uint32 _bit_num, uint8* result)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dnxf_state_modid_group_map_raw_bit_range_and(int unit, uint32 group_map_idx_0, uint32 _first, uint32 _count, SHR_BITDCL *input_bmp)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dnxf_state_modid_group_map_raw_bit_range_or(int unit, uint32 group_map_idx_0, uint32 _first, uint32 _count, SHR_BITDCL *input_bmp)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dnxf_state_modid_group_map_raw_bit_range_xor(int unit, uint32 group_map_idx_0, uint32 _first, uint32 _count, SHR_BITDCL *input_bmp)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dnxf_state_modid_group_map_raw_bit_range_remove(int unit, uint32 group_map_idx_0, uint32 _first, uint32 _count, SHR_BITDCL *input_bmp)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dnxf_state_modid_group_map_raw_bit_range_negate(int unit, uint32 group_map_idx_0, uint32 _first, uint32 _count)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dnxf_state_modid_group_map_raw_bit_range_set(int unit, uint32 group_map_idx_0, uint32 _first, uint32 _count)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dnxf_state_modid_group_map_raw_bit_range_null(int unit, uint32 group_map_idx_0, uint32 _first, uint32 _count, uint8 *result)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dnxf_state_modid_group_map_raw_bit_range_test(int unit, uint32 group_map_idx_0, uint32 _first, uint32 _count, uint8 *result)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dnxf_state_modid_group_map_raw_bit_range_eq(int unit, uint32 group_map_idx_0, SHR_BITDCL *input_bmp, uint32 _first, uint32 _count, uint8 *result)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dnxf_state_modid_group_map_raw_bit_range_count(int unit, uint32 group_map_idx_0, uint32 _first, uint32 _range, int *result)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
	...
	dnxf_state_init,
		...
		,
			...
			dnxf_state_modid_group_map_alloc,
				...
				dnxf_state_modid_group_map_raw_bit_clear,
				dnxf_state_modid_group_map_raw_bit_get,
				dnxf_state_modid_group_map_raw_bit_range_read,
				dnxf_state_modid_group_map_raw_bit_range_write,
				dnxf_state_modid_group_map_raw_bit_range_and,
				dnxf_state_modid_group_map_raw_bit_range_or,
				dnxf_state_modid_group_map_raw_bit_range_xor,
				dnxf_state_modid_group_map_raw_bit_range_remove,
				dnxf_state_modid_group_map_raw_bit_range_negate,
				dnxf_state_modid_group_map_raw_bit_range_clear,
				dnxf_state_modid_group_map_raw_bit_range_set,
				dnxf_state_modid_group_map_raw_bit_range_null,
				dnxf_state_modid_group_map_raw_bit_range_test,
				dnxf_state_modid_group_map_raw_bit_range_eq,
				dnxf_state_modid_group_map_raw_bit_range_count}
			}
		,
			{
