    ...
    for (i = 0; i < array_size; i++)
    {
        switch (filter_type_arr[i])
        {
            case soc_dnxc_filter_type_source_id:
                ...
                SOC_REG_ABOVE_64_RANGE_COPY(filter_reg, SOC_RAMON_FABRIC_CELL_MATCH_FILTER_REG_SOURCE_ID_START,
                                            &(filter_type_val[i]), 0,
                                            SOC_RAMON_FABRIC_CELL_MATCH_FILTER_REG_SOURCE_ID_LENGTH);
                SHR_BITCLR_RANGE(mask_reg, SOC_RAMON_FABRIC_CELL_MATCH_FILTER_REG_SOURCE_ID_START,
                                 SOC_RAMON_FABRIC_CELL_MATCH_FILTER_REG_SOURCE_ID_LENGTH);
                break;
            ...
            case soc_dnxc_filter_type_dest_id:
                ...
                SOC_REG_ABOVE_64_RANGE_COPY(filter_reg, SOC_RAMON_FABRIC_CELL_MATCH_FILTER_REG_DEST_ID_START,
                                            &(filter_type_val[i]), 0,
                                            SOC_RAMON_FABRIC_CELL_MATCH_FILTER_REG_DEST_ID_LENGTH);
                SHR_BITCLR_RANGE(mask_reg, SOC_RAMON_FABRIC_CELL_MATCH_FILTER_REG_DEST_ID_START,
                                 SOC_RAMON_FABRIC_CELL_MATCH_FILTER_REG_DEST_ID_LENGTH);
                break;
            ...
            case soc_dnxc_filter_type_priority:
                ...
                SOC_REG_ABOVE_64_RANGE_COPY(filter_reg, SOC_RAMON_FABRIC_CELL_MATCH_FILTER_REG_PRIORITY_TYPE_START,
                                            &(filter_type_val[i]), 0,
                                            SOC_RAMON_FABRIC_CELL_MATCH_FILTER_REG_PRIORITY_TYPE_LENGTH);
                SHR_BITCLR_RANGE(mask_reg, SOC_RAMON_FABRIC_CELL_MATCH_FILTER_REG_PRIORITY_TYPE_START,
                                 SOC_RAMON_FABRIC_CELL_MATCH_FILTER_REG_PRIORITY_TYPE_LENGTH);
                break;
            ...
            case soc_dnxc_filter_type_traffic_cast:
                ...
                SOC_REG_ABOVE_64_RANGE_COPY(filter_reg, SOC_RAMON_FABRIC_CELL_MATCH_FILTER_REG_TRAFFIC_CAST_START,
                                            &(filter_type_val[i]), 0,
                                            SOC_RAMON_FABRIC_CELL_MATCH_FILTER_REG_TRAFFIC_CAST_LENGTH);
                SHR_BITCLR_RANGE(mask_reg, SOC_RAMON_FABRIC_CELL_MATCH_FILTER_REG_TRAFFIC_CAST_START,
                                 SOC_RAMON_FABRIC_CELL_MATCH_FILTER_REG_TRAFFIC_CAST_LENGTH);
                break;
    ...
    int *count)
{
    ...
    uint32 reg32_val;
    soc_reg_t dch_prg_cell_cnt_reg[DNXF_RAMON_FILTER_NOF_COUNTERS] =
        { DCH_PRG_CELL_CNT_0r, DCH_PRG_CELL_CNT_1r, DCH_PRG_CELL_CNT_2r };
    soc_field_t prg_cell_cnt_field[DNXF_RAMON_FILTER_NOF_COUNTERS] =
    ...
    if (*cell_type == soc_dnxc_fabric_cell_type_sr_cell)
    {
        ...
        if (cell_size_bytes <= SOC_RAMON_FABRIC_CAPTURED_CELL_SMALL_CELL_MAX_SIZE)
        {
            ...
            parse_table[line].src_start_bit +=
                BYTES2BITS(SOC_RAMON_FABRIC_CAPTURED_CELL_SMALL_CELL_MAX_SIZE - cell_size_bytes);
...
{
    uint32 header_buf[DNXC_VSC256_DESTINATION_ROUTED_CELL_HEADER_SIZE_UINT32];
    ...
    sal_memset(header_buf, 0, WORDS2BYTES(DNXC_VSC256_DESTINATION_ROUTED_CELL_HEADER_SIZE_UINT32));
    SHR_IF_ERR_EXIT(soc_dnxc_vsc256_dest_routed_cell_build_header
                    (unit, cell, DNXC_VSC256_DESTINATION_ROUTED_CELL_HEADER_SIZE_UINT32, header_buf));
    SOC_REG_ABOVE_64_CLEAR(cell_header_reg);
    SOC_REG_ABOVE_64_RANGE_COPY(cell_header_reg, 0, header_buf, 0,
                                DNXC_VSC256_DESTINATION_ROUTED_CELL_HEADER_SIZE_BITS);
