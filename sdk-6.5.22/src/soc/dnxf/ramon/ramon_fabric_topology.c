    ...
    soc_port_t * links_array)
{
    ...
    SHR_IF_ERR_EXIT(dnxf_state.lb.group_to_first_link.set(unit, destination_local_id, 0, links_array[0]));
    ...
    soc_port_t * links_array)
{
    ...
    SHR_IF_ERR_EXIT(dnxf_state.lb.group_to_first_link.get(unit, destination_local_id, 0, &link));
