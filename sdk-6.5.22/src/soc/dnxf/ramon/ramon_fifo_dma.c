    ...
    int unit)
{
    ...
    if (dnxf_data_fabric.cell.fifo_dma_enable_get(unit))
    {
        ...
        if (dnxf_data_fabric.cell.fifo_dma_buffer_size_get(unit) <
            dnxf_data_fabric.cell.fifo_dma_min_nof_entries_get(unit) *
            dnxf_data_fabric.cell.fifo_dma_entry_size_get(unit)
            || dnxf_data_fabric.cell.fifo_dma_buffer_size_get(unit) >
            dnxf_data_fabric.cell.fifo_dma_max_nof_entries_get(unit) *
            dnxf_data_fabric.cell.fifo_dma_entry_size_get(unit))
        {
