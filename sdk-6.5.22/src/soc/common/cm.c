...
/* { */
    ...
    {
        BCM88850_DEVICE_ID, DNXC_A0_REV_ID | SOC_CM_DEVICE_LARGER_REVID_AND_ANY_LAST_DEVID_DIGIT,
        "BCM88850_A0",
...
/* } */
    ...
    {   /* Trident4 X9 */
        BCM56089_DEVICE_ID, BCM56089_A0_REV_ID,
        "BCM56089_A0",
        BCM56780_DEVICE_ID, BCM56780_A0_REV_ID,
        (SOC_PCI_DEV_TYPE | SOC_SWITCH_DEV_TYPE | SOC_LTSW_DRV_TYPE)
    },
...
{
#if defined(BCM_LTSW_SUPPORT) || defined(BCM_CTSW_SUPPORT)
    return soc_ltsw_ffb_start(from_ver, to_ver);
#else
    return SOC_E_UNAVAIL;
#endif
}
