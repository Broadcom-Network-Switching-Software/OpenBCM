...
#define KCOM_NETIF_F_ADD_SVTAG  (1U << 3)
...
#define KCOM_NETIF_SVTAG_SIZE                   4
...
typedef struct kcom_netif_s {
    ...
    uint8 phys_port;
    uint8 svtag[KCOM_NETIF_SVTAG_SIZE];
} kcom_netif_t;
...
#ifndef KCOM_HW_INIT_OAMP_LOCAL_PORTS_MAX
#define KCOM_HW_INIT_OAMP_LOCAL_PORTS_MAX     4
#endif
...
typedef struct kcom_msg_hw_init_s {
    ...
    uint8 udh_enable;
    uint8 oamp_local_ports_number;
    uint32 oamp_local_ports[KCOM_HW_INIT_OAMP_LOCAL_PORTS_MAX];
} kcom_msg_hw_init_t;
