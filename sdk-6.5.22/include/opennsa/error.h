...
/* Switch SER data error types */
typedef enum bcm_switch_event_data_error_e {
    BCM_SWITCH_EVENT_DATA_ERROR_PARITY             = 1, 
    BCM_SWITCH_EVENT_DATA_ERROR_ECC, 
    BCM_SWITCH_EVENT_DATA_ERROR_UNSPECIFIED, 
    BCM_SWITCH_EVENT_DATA_ERROR_FATAL, 
    BCM_SWITCH_EVENT_DATA_ERROR_CORRECTED, 
    BCM_SWITCH_EVENT_DATA_ERROR_LOG, 
    BCM_SWITCH_EVENT_DATA_ERROR_UNCORRECTABLE, 
    BCM_SWITCH_EVENT_DATA_ERROR_AUTO_CORRECTED, 
    BCM_SWITCH_EVENT_DATA_ERROR_FAILEDTOCORRECT, 
    BCM_SWITCH_EVENT_DATA_ERROR_ECC_1BIT_CORRECTED, 
    BCM_SWITCH_EVENT_DATA_ERROR_ECC_2BIT_CORRECTED, 
    BCM_SWITCH_EVENT_DATA_ERROR_PARITY_CORRECTED, 
    BCM_SWITCH_EVENT_DATA_ERROR_CFAP_MEM_FAIL, 
    BCM_SWITCH_EVENT_DATA_ERROR_COUNT 
} bcm_switch_event_data_error_t;
