...
typedef enum bcm_udf_abstract_pkt_format_e {
    ...
    bcmUdfAbstractPktFormatIfaHeader = 170, /* Start of first byte of IFA header */
    bcmUdfAbstractPktFormatIfaMetadata = 171, /* Start of first byte of IFA Metadata */
    bcmUdfAbstractPktFormatLastCount = 172 /* Unused. Always last in the list */
