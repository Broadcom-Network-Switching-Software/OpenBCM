...
void sal_time_usecs_register(sal_usecs_t (*f)(void)) SAL_ATTR_WEAK;
void sal_time_register(sal_time_t (*f)(void)) SAL_ATTR_WEAK;

/* Relative time in microseconds modulo 2^32 */
extern sal_usecs_t sal_time_usecs(void) SAL_ATTR_WEAK;

/* Absolute time in seconds ala Unix time, interrupt-safe */
extern sal_time_t sal_time(void) SAL_ATTR_WEAK;
 ...
 */
extern double sal_time_double(void) SAL_ATTR_WEAK;
