...
#define BCM_TDPLL_FREQUENCY (625)
 ...
 #define PTP_CONDITIONAL_IS_JERICHO2(unit) \
            ((dnx_data_device.general.device_id_get(unit) & DNXC_DEVID_FAMILY_MASK) == \
            (BCM88690_DEVICE_ID & DNXC_DEVID_FAMILY_MASK))
#else
...
/* define SOC which support internal stack */
    ...
    defined(BCM_QUX_SUPPORT) || defined(BCM_DNX_SUPPORT)
...
#define PTP_MGMTMSG_PAYLOAD_APTS_INPUT_SOURCE_CONFIGS_SIZE_OCTETS       (32)
