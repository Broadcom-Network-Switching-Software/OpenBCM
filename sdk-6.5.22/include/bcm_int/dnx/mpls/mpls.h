...
/** MPLS EVPN Flow-Label and Control-Word enabler.*/
#define MPLS_EVPN_IML_FL_ENABLE         0x1
#define MPLS_EVPN_IML_FL_WITH_CW_ENABLE 0x2
#define MPLS_EVPN_IML_FL_CW_ENABLE      (MPLS_EVPN_IML_FL_ENABLE | MPLS_EVPN_IML_FL_WITH_CW_ENABLE)
 ...
 */
#define DNX_EEI_IDENTIFIER_POP   1
#define DNX_EEI_IDENTIFIER_SWAP  2
#define DNX_EEI_IDENTIFIER_EEI_PHP   8
#define DNX_EEI_IDENTIFIER_EEI_SWAP  9
#define DNX_EEI_IDENTIFIER_VLAN_EDIT 15
...
/**
* \brief
*  Set the bit number in in-LIF general_data to indicate
*  speculative parsing.
*   \param [in] unit         -  Relevant unit.
*   \param [in] bit_num      -  bit number

* \return
*   shr_error_e - Non-zero in case of an error.
*/
shr_error_e dnx_mpls_in_lif_speculative_parsing_disable_bit_num_set(
    int unit,
    int bit_num);

/**
* \brief
*  Get the bit number in in-LIF general_data to indicate
*  speculative parsing.
*   \param [in] unit         -  Relevant unit.
*   \param [out] bit_num      -  bit number

* \return
*   shr_error_e - Non-zero in case of an error.
*/
shr_error_e dnx_mpls_in_lif_speculative_parsing_disable_bit_num_get(
    int unit,
    int *bit_num);

/**
* \brief
*  Enable/Disable the flow label and control word in EVPN.
*   \param [in] unit         -  Relevant unit.
*   \param [in] enablers     -  Enabler for flow label and/or control word are enabled in EVPN.
*
* \return
*   shr_error_e - Non-zero in case of an error.
*/
shr_error_e dnx_mpls_dual_homing_fl_termination_enable_set(
    int unit,
    int enablers);

/**
* \brief
*  Get the enabler status of flow label and conrtol word.
*   \param [in] unit         -  Relevant unit.
*   \param [out] enablers    -  Enabler for flow label and/or control word are enabled in EVPN.
*
* \return
*   shr_error_e - Non-zero in case of an error.
*/
shr_error_e dnx_mpls_dual_homing_fl_termination_enable_get(
    int unit,
    int *enablers);
