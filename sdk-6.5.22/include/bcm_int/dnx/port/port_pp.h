...
/**
 * \brief -
 *  Set speculative parsingp per inLIF.
 *
 * \param [in] unit - the relevant unit.
 * \param [in] gport - port id.
 ...
 *   * None
 */
shr_error_e dnx_port_pp_lif_speculative_parsing_set(
    int unit,
    bcm_port_t gport,
    int enable);
...
/**
 * \brief -
 *  Get speculative parsingp per inLIF.
 *
 * \param [in] unit - the relevant unit.
 * \param [in] gport - port id.
 ...
 *   * None
 */
shr_error_e dnx_port_pp_lif_speculative_parsing_get(
    int unit,
    bcm_port_t gport,
    int *enable);
...
/**
 * \brief -  set estimated bytes to add per pp port
 *
 * \param [in] unit - Relevant unit
 * \param [in] port - Logical port
 ...
 *   * None
 */
shr_error_e dnx_port_pp_estimate_bta_set(
    int unit,
    bcm_port_t port,
    int size);
/*
