...
shr_error_e flexe_dbg_rateadpt_slots_add(
    int unit,
    int client_channel,
    int ts_num);

/*Delete time slots in rate adapter*/
shr_error_e flexe_dbg_rateadpt_slots_delete(
    int unit,
    int client_channel);
...
shr_error_e flexe_dbg_oh_phymap_set(
    int unit,
    int flexe_core_port,
    int logical_phy_id,
    int enable);
...
shr_error_e flexe_dbg_oam_alarm_enable_set(
    int unit,
    int client_channel,
    int alarm_type,
    int enable);
...
shr_error_e flexe_dbg_channel_map_set(
    int unit,
    uint32 flags,
    int flexe_core_port,
    uint32 local_port);
