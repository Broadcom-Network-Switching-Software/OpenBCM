...
/**
 * \brief
 * Gets the full SVTAG value and the accumulation state for a given port
 * \param [in] unit  - The unit number.
 * \param [in] flags - The SVTAG API flags.
 * \param [in] gport - gport
 * \param [out] svtag - The HW SVTAG value
 * \param [out] accumulation - The HW accumulation value
 * \return
 ...
 *  None
 */
shr_error_e dnx_switch_svtag_egress_raw_entry_get(
    int unit,
    uint32 flags,
    bcm_gport_t gport,
    uint32 *svtag,
