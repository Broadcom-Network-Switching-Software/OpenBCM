...
/**
 * implemented by: algo_l3_db_vrrp_exem_exem1_en_set
 */
typedef int (*algo_l3_db_vrrp_exem_exem1_en_set_cb)(
    int unit, uint8 exem1_en);

/**
 * implemented by: algo_l3_db_vrrp_exem_exem1_en_get
 */
typedef int (*algo_l3_db_vrrp_exem_exem1_en_get_cb)(
    int unit, uint8 *exem1_en);

/**
 * implemented by: algo_l3_db_vrrp_exem_exem3_en_set
 */
typedef int (*algo_l3_db_vrrp_exem_exem3_en_set_cb)(
    int unit, uint8 exem3_en);

/**
 * implemented by: algo_l3_db_vrrp_exem_exem3_en_get
 */
typedef int (*algo_l3_db_vrrp_exem_exem3_en_get_cb)(
    int unit, uint8 *exem3_en);
...
/**
 * This structure holds the access functions for the variable exem1_en
 */
typedef struct {
    algo_l3_db_vrrp_exem_exem1_en_set_cb set;
    algo_l3_db_vrrp_exem_exem1_en_get_cb get;
} algo_l3_db_vrrp_exem_exem1_en_cbs;

/**
 * This structure holds the access functions for the variable exem3_en
 */
typedef struct {
    algo_l3_db_vrrp_exem_exem3_en_set_cb set;
    algo_l3_db_vrrp_exem_exem3_en_get_cb get;
} algo_l3_db_vrrp_exem_exem3_en_cbs;
...
typedef struct {
    /**
     * Access struct for exem1_en
     */
    algo_l3_db_vrrp_exem_exem1_en_cbs exem1_en;
    /**
     * Access struct for exem3_en
     */
    algo_l3_db_vrrp_exem_exem3_en_cbs exem3_en;
} algo_l3_db_vrrp_exem_cbs;
...
typedef struct {
    ...
    /**
     * Access struct for vrrp_exem
     */
    algo_l3_db_vrrp_exem_cbs vrrp_exem;
    /**
