 ...
 */
    ...
    uint8 oamp_tx_rate_index;

    uint8 icc_profile;
    dnx_oam_group_icc_profile_data_t icc_profile_data;

    uint8 tlv_profile;
    dnx_oam_oamp_v2_tlv_profile_t tlv_profile_data;

    uint8 delay_histogram_profile;
    dnx_oam_oamp_v2_delay_histogram_profile_t delay_histogram_profile_data;
