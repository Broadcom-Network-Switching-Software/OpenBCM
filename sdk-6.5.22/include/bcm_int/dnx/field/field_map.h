...
typedef enum
{
    ...
    DNX_FIELD_IPMF1_QUAL_PWE_IN_LIF_WIDE_DATA,
...
extern dnx_field_static_opcode_info_t dnx_field_static_opcode_info[DNX_KBP_MAX_STATIC_OPCODES_NOF];
...
#define DNX_FIELD_STAGE_ITERATOR(stage)                                                 \
        stage = DNX_FIELD_STAGE_FIRST; \
        for(dnx_field_map_stage_info_t _field_map_stage_info; stage < DNX_FIELD_STAGE_NOF; stage++)        \
            if(dnx_field_map_stage_info_get(unit, stage, &_field_map_stage_info) == _SHR_E_NONE && _field_map_stage_info.pp_stage != DNX_PP_STAGE_INVALID)

#define DNX_FIELD_STAGE_CS_QUAL_ITERATOR(stage)                                         \
        stage = DNX_FIELD_STAGE_FIRST; \
        for(dnx_field_map_stage_info_t _field_map_stage_info; stage < DNX_FIELD_STAGE_NOF; stage++)        \
            if(dnx_field_map_stage_info_get(unit, stage, &_field_map_stage_info) == _SHR_E_NONE && _field_map_stage_info.cs_qual_map != NULL)

#define DNX_FIELD_STAGE_QUAL_ITERATOR(stage)                                            \
        stage = DNX_FIELD_STAGE_FIRST; \
        for(dnx_field_map_stage_info_t _field_map_stage_info; stage < DNX_FIELD_STAGE_NOF; stage++)        \
            if(dnx_field_map_stage_info_get(unit, stage, &_field_map_stage_info) == _SHR_E_NONE && _field_map_stage_info.meta_qual_map != NULL)

#define DNX_FIELD_STAGE_LAYER_QUAL_ITERATOR(stage)                                      \
        stage = DNX_FIELD_STAGE_FIRST; \
        for(dnx_field_map_stage_info_t _field_map_stage_info; stage < DNX_FIELD_STAGE_NOF; stage++)        \
            if(dnx_field_map_stage_info_get(unit, stage, &_field_map_stage_info) == _SHR_E_NONE && _field_map_stage_info.layer_qual_info != NULL)

#define DNX_FIELD_STAGE_ACTION_ITERATOR(stage)                                          \
        stage = DNX_FIELD_STAGE_FIRST; \
        for(dnx_field_map_stage_info_t _field_map_stage_info; stage < DNX_FIELD_STAGE_NOF; stage++)        \
            if(dnx_field_map_stage_info_get(unit, stage, &_field_map_stage_info) == _SHR_E_NONE && _field_map_stage_info.static_action_id_map != NULL)
...
#define DNX_FIELD_KBP_OPCODE_ITERATOR(_opcode_id)                                           \
        for(_opcode_id = 0; _opcode_id < DNX_KBP_MAX_STATIC_OPCODES_NOF; _opcode_id++) \
...
{ \
    ...
    SHR_IF_ERR_EXIT(dnx_field_apptype_sw.predef_info.nof_context_ids.get(_unit, \
...
{ \
    dnx_field_map_stage_info_t _field_map_stage_info;                                       \
    SHR_IF_ERR_EXIT(dnx_field_map_stage_info_get(unit, stage, &_field_map_stage_info));     \
    if((qual_id < DNX_FIELD_QUAL_ID_FIRST) || (qual_id >= _field_map_stage_info.meta_qual_nof))        \
    {                                                                                       \
...
{ \
    dnx_field_map_stage_info_t _field_map_stage_info;                                       \
    SHR_IF_ERR_EXIT(dnx_field_map_stage_info_get(unit, stage, &_field_map_stage_info));     \
    if(_field_map_stage_info.layer_qual_info == NULL)                             \
    {                                                                                       \
...
/**
* \brief
* Get field map info per stage
*
* \param [in] unit              - Device id
* \param [in] stage             - Stage id
* \param [out] map_stage_info_p - Pointer to field map stage info.
*\return
*   shr_error_e - Error Type
*\see
*   bcm_error_e
