...
typedef struct
{
     ...
     */
    uint8 old_cs_in_lif_profile;
    /**
     * Last CS in_lif FWD profile
     */
    uint8 old_cs_in_lif_fwd_profile;
    /**
...
static const layer_types_enablers_t layer_types_enablers[] = {
    ...
    {DBAL_ENUM_FVAL_LAYER_TYPES_BIER_NON_MPLS, 0, 0},
    {DBAL_ENUM_FVAL_LAYER_TYPES_IN_BIER_BASE_EG_BIER_MPLS, 0, 0},
