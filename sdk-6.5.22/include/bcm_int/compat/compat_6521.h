...
typedef struct bcm_compat6521_trunk_resilient_entry_s {
    uint64 hash_key;    /* Hash key. */
    bcm_trunk_t tid;    /* Trunk. */
    bcm_compat6521_trunk_member_t *member;    /* Trunk member. */
} bcm_compat6521_trunk_resilient_entry_t;

/* Replace Trunk resilient entries matching given criteria. */
extern int bcm_compat6521_trunk_resilient_replace(
    int unit,
    uint32 flags,
