...
typedef struct NlmCmAllocator NlmCmAlloc;       
...
typedef struct NlmCmAllocator__vtbl {
    ...
    NlmCmAllocator__alloc_t m_malloc;   
    NlmCmAllocator__calloc_t m_calloc;  
    NlmCmAllocator__resize_t m_resize;  
    NlmCmAllocator__free_t m_free;      
    NlmCmAllocator__dtor_t m_dtor;      
    const char *className1;     
    NlmCmAllocator__sysMalloc_t m_sysMalloc;    
    NlmCmAllocator__sysFree_t m_sysFree;        
} NlmCmAllocator__vtbl;


struct NlmCmAllocator {
    NlmCmAllocator__vtbl m_vtbl;        
