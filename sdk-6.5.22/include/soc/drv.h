...
#define SOC_MAX_NUM_GCK_WRAP_BLKS 2
#define GCK_WRAP_BLOCK(unit, instance) \
( ((instance >= 0) && (instance < SOC_MAX_NUM_GCK_WRAP_BLKS)) ? \
   SOC_INFO(unit).gck_wrap_block[instance] : (-1))
#define SOC_MAX_NUM_GCK_BLKS 2
#define GCK_BLOCK(unit, instance) \
( ((instance >= 0) && (instance < SOC_MAX_NUM_GCK_BLKS)) ? \
   SOC_INFO(unit).gck_block[instance] : (-1))
...
#define SOC_MAX_NUM_VTMON_BLKS 6
...
#define BRDC_GCK_WRAP_BLOCK(unit)  (SOC_INFO(unit).brdc_gck_wrap_block)
#define BRDC_DTM_BLOCK(unit)  (SOC_INFO(unit).brdc_dtm_block)
#define BRDC_RTP_BLOCK(unit)  (SOC_INFO(unit).brdc_rtp_block)
#define BRDC_GCK_BLOCK(unit)  (SOC_INFO(unit).brdc_gck_block)
...
typedef struct {
    ...
    int             nof_pmqs;
        ...
        int             gck_wrap_block[SOC_MAX_NUM_GCK_WRAP_BLKS];
        int             gck_block[SOC_MAX_NUM_GCK_BLKS];
