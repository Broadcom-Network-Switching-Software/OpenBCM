...
/* Enable async communication when configuring m0 firmware based hardware linkscan. */
#define spn_CMICX_LS_HW_CFG_ASYNC_ENABLE  "cmicx_ls_hw_cfg_async_enable"
/*
...
/* Number of MEPs that allocate 7 or 8 entries from MEP-DB */
#define spn_OAMP_MEP_DB_MAX_NOF_8_LEN_ENTRIES  "oamp_mep_db_max_nof_8_len_entries"
...
/*
 * Select the payload size of the VSI DB
 * Valid values:
 * 60: Each entry will be 60b of size, also address resolution will work in 60b granularity
 * 120: Each entry will be 120b of size, also address resolution will work in 120b granularity
 */
...
{ \
  ...
  "oamp_mep_db_max_nof_8_len_entries", \
