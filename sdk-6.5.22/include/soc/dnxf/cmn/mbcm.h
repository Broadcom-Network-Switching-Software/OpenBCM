...
typedef shr_error_e(
    *mbcm_dnxf_cell_filter_init_f) (
    int unit);

typedef shr_error_e(
    *mbcm_dnxf_cell_filter_set_f) (
    int unit,
    uint32 flags,
    uint32 array_size,
...
typedef shr_error_e(
    *mbcm_dnxf_cell_filter_clear_f) (
    int unit);

typedef shr_error_e(
    *mbcm_dnxf_cell_filter_count_get_f) (
    int unit,
    int *count);
...
typedef shr_error_e(
    *mbcm_dnxf_stk_module_max_all_reachable_verify_f) (
    int unit,
...
typedef shr_error_e(
    *mbcm_dnxf_stk_module_max_fap_verify_f) (
    int unit,
    bcm_module_t max_module);
...
typedef shr_error_e(
    *mbcm_dnxf_stk_valid_module_id_verify_f) (
    int unit,
    bcm_module_t module,
...
typedef shr_error_e(
    *mbcm_dnxf_stat_counter_length_get_f) (
    int unit,
    int counter_id,
    int *length);

typedef shr_error_e(
    *mbcm_dnxf_stat_get_f) (
    int unit,
    bcm_port_t port,
    uint64 *value,
    int *counters,
...
typedef shr_error_e(
    *mbcm_dnxf_fabric_link_device_mode_get_f) (
    int unit,
    soc_port_t port,
    int is_rx,
