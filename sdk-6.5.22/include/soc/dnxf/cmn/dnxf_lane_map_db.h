...
shr_error_e soc_dnxf_lane_map_db_map_set(
    int unit,
    int map_size,
    soc_dnxc_lane_map_db_map_t * lane2serdes,
    int is_init_sequence);

shr_error_e soc_dnxf_lane_map_db_map_get(
    int unit,
    int map_size,
    soc_dnxc_lane_map_db_map_t * lane2serdes);

shr_error_e soc_dnxf_lane_map_db_pm_map_get(
    int unit,
    int pm_index,
    int nof_ports,
    soc_dnxc_lane_map_db_map_t * lane2serdes);

shr_error_e soc_dnxf_lane_map_db_is_lane_mapped_get(
    int unit,
    int lane,
    int *is_lane_mapped);
