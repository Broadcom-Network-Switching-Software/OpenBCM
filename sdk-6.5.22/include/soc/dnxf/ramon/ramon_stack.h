...
shr_error_e soc_ramon_stk_module_max_all_reachable_verify(
    int unit,
    bcm_module_t module);
...
shr_error_e soc_ramon_stk_module_max_fap_verify(
    int unit,
    bcm_module_t module);
...
shr_error_e soc_ramon_stk_valid_module_id_verify(
    int unit,
    bcm_module_t module,
