...
#define MDB_CALC_FEC_ID_START_ADDR_OF_BANK_ID(unit,bank_id) (dnx_data_mdb.direct.nof_fecs_in_super_fec_get(unit)*UTILEX_DIV_ROUND_UP(bank_id*dnx_data_l3.fec.nof_physical_fecs_per_bank_get(unit)*dnx_data_mdb.direct.fec_row_width_get(unit),dnx_data_l3.fec.super_fec_size_get(unit)))
