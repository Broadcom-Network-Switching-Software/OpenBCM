...
typedef uint32(
    *dnx_data_lif_lif_table_manager_skip_in_lif_example_table_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_lif_lif_table_manager_skip_in_lif_example_table_get_f skip_in_lif_example_table_get;
