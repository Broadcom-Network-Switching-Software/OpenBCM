...
typedef enum
{
    ...
    dnx_data_field_preselector_define_srv6_endpoint_usp_tcp_extended_cut_presel_id_ipmf1,
    dnx_data_field_preselector_define_srv6_endpoint_usp_icmp_extended_cut_presel_id_ipmf1,
    ...
    dnx_data_field_preselector_define_srv6_egress_usp_tcp_presel_id_ipmf1,
...
uint32 dnx_data_field_preselector_srv6_endpoint_usp_tcp_extended_cut_presel_id_ipmf1_get(
    int unit);


uint32 dnx_data_field_preselector_srv6_endpoint_usp_icmp_extended_cut_presel_id_ipmf1_get(
    int unit);
...
uint32 dnx_data_field_preselector_srv6_egress_usp_tcp_presel_id_ipmf1_get(
    int unit);
...
typedef enum
{
    dnx_data_field_udh_define_supported,
...
uint32 dnx_data_field_udh_supported_get(
    int unit);
...
typedef enum
{
    dnx_data_field_features_define_tcam_cs_enable,
...
uint32 dnx_data_field_features_tcam_cs_enable_get(
    int unit);
