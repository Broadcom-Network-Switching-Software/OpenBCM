...
typedef uint32(
    *dnx_data_field_context_default_itmh_pph_lif_ipmf2_context_get_f) (
    int unit);


typedef uint32(
    *dnx_data_field_context_default_itmh_pph_fhei_lif_ipmf2_context_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_field_context_default_itmh_pph_lif_ipmf2_context_get_f default_itmh_pph_lif_ipmf2_context_get;
    
    dnx_data_field_context_default_itmh_pph_fhei_lif_ipmf2_context_get_f default_itmh_pph_fhei_lif_ipmf2_context_get;
...
typedef uint32(
    *dnx_data_field_preselector_default_itmh_pph_lif_presel_id_ipmf2_get_f) (
    int unit);


typedef uint32(
    *dnx_data_field_preselector_default_itmh_pph_fhei_lif_presel_id_ipmf2_get_f) (
    int unit);
...
typedef uint32(
    *dnx_data_field_preselector_srv6_endpoint_usp_tcp_extended_cut_presel_id_ipmf1_get_f) (
    int unit);


typedef uint32(
    *dnx_data_field_preselector_srv6_endpoint_usp_icmp_extended_cut_presel_id_ipmf1_get_f) (
    int unit);
...
typedef uint32(
    *dnx_data_field_preselector_srv6_egress_usp_tcp_presel_id_ipmf1_get_f) (
    int unit);
...
typedef uint32(
    *dnx_data_field_preselector_default_itmh_pph_presel_id_vlan_ipmf3_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_field_preselector_default_itmh_pph_lif_presel_id_ipmf2_get_f default_itmh_pph_lif_presel_id_ipmf2_get;
    
    dnx_data_field_preselector_default_itmh_pph_fhei_lif_presel_id_ipmf2_get_f default_itmh_pph_fhei_lif_presel_id_ipmf2_get;
    ...
    dnx_data_field_preselector_srv6_endpoint_usp_tcp_extended_cut_presel_id_ipmf1_get_f srv6_endpoint_usp_tcp_extended_cut_presel_id_ipmf1_get;
    
    dnx_data_field_preselector_srv6_endpoint_usp_icmp_extended_cut_presel_id_ipmf1_get_f srv6_endpoint_usp_icmp_extended_cut_presel_id_ipmf1_get;
    ...
    dnx_data_field_preselector_srv6_egress_usp_tcp_presel_id_ipmf1_get_f srv6_egress_usp_tcp_presel_id_ipmf1_get;
    ...
    dnx_data_field_preselector_default_itmh_pph_presel_id_vlan_ipmf3_get_f default_itmh_pph_presel_id_vlan_ipmf3_get;
...
typedef uint32(
    *dnx_data_field_map_supported_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_field_map_supported_get_f supported_get;
...
typedef uint32(
    *dnx_data_field_udh_supported_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_field_udh_supported_get_f supported_get;
...
typedef uint32(
    *dnx_data_field_exem_supported_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_field_exem_supported_get_f supported_get;
...
typedef uint32(
    *dnx_data_field_exem_learn_flush_machine_supported_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_field_exem_learn_flush_machine_supported_get_f supported_get;
...
typedef uint32(
    *dnx_data_field_features_tcam_cs_enable_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_field_features_tcam_cs_enable_get_f tcam_cs_enable_get;
