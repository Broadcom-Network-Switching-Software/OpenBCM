...
int dnx_field_tcam_cache_shadow_tcam_bank_entry_key_dump(
    int unit, int tcam_bank_idx_0, int tcam_bank_idx_1, int entry_key_idx_0, dnx_sw_state_dump_filters_t filters);

int dnx_field_tcam_cache_shadow_tcam_bank_entry_key_key_data_dump(
    int unit, int tcam_bank_idx_0, int tcam_bank_idx_1, int entry_key_idx_0, int key_data_idx_0, dnx_sw_state_dump_filters_t filters);
...
int dnx_field_tcam_cache_shadow_payload_table_entry_payload_dump(
    int unit, int payload_table_idx_0, int payload_table_idx_1, int entry_payload_idx_0, dnx_sw_state_dump_filters_t filters);

int dnx_field_tcam_cache_shadow_payload_table_entry_payload_payload_data_dump(
    int unit, int payload_table_idx_0, int payload_table_idx_1, int entry_payload_idx_0, int payload_data_idx_0, dnx_sw_state_dump_filters_t filters);
