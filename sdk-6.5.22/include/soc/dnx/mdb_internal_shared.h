...
#define MDB_LPM_DBS_SMALL_BB_SHARE 2
...
#define MDB_EM_TABLE_IS_EMP(_mdb_physical_table_id) (dnx_data_mdb.em.mdb_emp_tables_mapping_get(unit, _mdb_physical_table_id)->emp_age_cfg_table != 0)
...
#define MDB_INIT_IS_FEC_TABLE(_mdb_physical_table_id) ((dnx_data_mdb.pdbs.mdb_pdb_info_get(unit, _mdb_physical_table_id)->db_type == DBAL_ENUM_FVAL_MDB_DB_TYPE_DIRECT) \
                                                    ...
                                                    && (dnx_data_l3.feature.feature_get(unit, dnx_data_l3_feature_fec_init_enable)))
