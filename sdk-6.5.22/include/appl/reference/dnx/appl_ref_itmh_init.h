...
/** Number of Actions (used as array size) */
#define ITMH_NOF_IPMF2_SYS_HDR_FG_ACTIONS           1
/** Number of Data Qualifiers needed (used as array size) */
#define ITMH_NOF_IPMF2_SYS_HDR_FG_QUALIFIERS        1
/** Number of Field Groups needed (used as array size) */
#define ITMH_NOF_FG                      4
...
#define SYS_HDR_PRIO_ITMH              BCM_FIELD_ACTION_PRIORITY(0, 2)
#define SYS_HDR_PRIO_TSH               BCM_FIELD_ACTION_PRIORITY(0, 9)
