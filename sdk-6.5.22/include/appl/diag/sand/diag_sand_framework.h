 ...
 */
#define SH_CMD_SKIP_EXEC     SAL_BIT(4)
/**
 ...
 */
#define SH_CMD_SKIP_ROOT     SAL_BIT(8)
/**
 ...
 */
#define SH_CMD_SKIP_MEMORY_CHECK   SAL_BIT(19)
/**
