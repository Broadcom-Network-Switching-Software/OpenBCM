...
err_code_t blackhawk7_v1l8p1_INTERNAL_configure_pll(srds_access_t *sa__,
    ...
    if (pll_option & BLACKHAWK7_V1L8P1_PLL_OPTION_POWERDOWN) {
    ...
    if (pll_option== BLACKHAWK7_V1L8P1_PLL_OPTION_REFCLK_DOUBLER_EN) {
        EFUN(wrc_ams_pll_refclk_freq2x_en(0x1));
    } else if (pll_option== BLACKHAWK7_V1L8P1_PLL_OPTION_REFCLK_DIV2_EN) {
        EFUN(wrc_ams_pll_refdiv2(1));
        EFUN(wrc_ams_pll_div4_2_sel(1));
    } else if (pll_option== BLACKHAWK7_V1L8P1_PLL_OPTION_REFCLK_DIV4_EN) {
