...
#ifndef MERLIN7_TSC_API_INTERNAL_H
#define MERLIN7_TSC_API_INTERNAL_H
...
/*--------------------------*/
enum merlin7_tsc_rx_pam_mode_enum {
    NRZ,
    PAM4_NR,
    PAM4_ER
};
...
/*---------------------------------------*/
enum merlin7_tsc_prbs_chk_timer_selection_enum {
    USE_HW_TIMERS = 0,
    USE_SW_TIMERS = 1
};
...
typedef struct {
  ...
  /** PLL Divider value.  (Same encoding as enum #merlin7_tsc_pll_div_enum.) */
  uint32_t pll_div;
  /** PLL Lock */
  uint8_t  pll_lock;
  /** PLL Lock Change*/
 ...
 * @param select_rx a flag to select rx or tx (1 -> rx, 0 -> tx)
 ...
 * @param string_size is the size of string in bytes.
 * @return Serdes Info pointer
 */
...
/** Checks to see if the stored ucode_version in merlin7_tsc_info is matching with the current thread ucode
 * @param sa__ is an opaque state vector passed through to device access functions.
...
/** Verify the internal merlin7_tsc_info.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *merlin7_tsc_info_ptr Info_table to be verified
 * @return Error code, if generated (returns ERR_CODE_NONE if no errors)
 */
...
/** Return whether the fraction portion of a #merlin7_tsc_pll_div_enum value is nonzero. */
#define SRDS_INTERNAL_IS_PLL_DIV_FRACTIONAL(div_) (((uint32_t)(div_) & 0xFFFFF000UL) != 0)

/** Extract the integer portion of a #merlin7_tsc_pll_div_enum value. */
#define SRDS_INTERNAL_GET_PLL_DIV_INTEGER(div_) ((uint32_t)(((uint32_t)(div_)) & 0x00000FFFUL))

/** Extract the fraction portion of a #merlin7_tsc_pll_div_enum value.
...
/** Compose a value in the same format as a #merlin7_tsc_pll_div_enum value.
 ...
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param refclk Reference clock frequency (enumerated), or MERLIN7_TSC_PLL_REFCLK_UNKNOWN to auto-compute.
 * @param *refclk_freq_hz Resultant reference clock frequency, in Hz.
 * @param *srds_div Divider value (enumerated), or MERLIN7_TSC_PLL_DIV_UNKNOWN to auto-compute.
 *             The final divider value will be filled in if MERLIN7_TSC_PLL_DIV_UNKNOWN.
 ...
 * as part of merlin7_tsc_display_core_state_line()
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param srds_div Divider value, in the same encoding as enum #merlin7_tsc_pll_div_enum.
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param range_250 determines the range 0 = +/-150mV, 1 = +/-250mV (ignored for 7)
 * @param slicer_sel slicer for which ladder threshold needs to be calculated. (Required for 7, unused (can be zero) for all other IPs)
...
} merlin7_tsc_INTERNAL_event_log_dump_state_t;

/** Callback function for dumping event log, intended to be called by merlin7_tsc_INTERNAL_read_event_log_with_callback.
 *  It must also be called once after, with a byte count of 0, to finish printing.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *arg is a merlin7_tsc_INTERNAL_event_log_dump_state_t pointer for holding state.
...
/*-----------------------------*/
/** Read current merlin7_tsc core status.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *istate Current merlin7_tsc core status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
...
/*-----------------------------*/
/** Read current merlin7_tsc lane status.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *istate Current merlin7_tsc lane status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
err_code_t merlin7_tsc_INTERNAL_get_osr_mode(srds_access_t *sa__, merlin7_tsc_osr_mode_st *mode);
#endif /* SMALL_FOOTPRINT */
 ...
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *sig_det Current merlin7_tsc lane signal_detect status read back and populated by the API
 * @param *sig_det_chg Current merlin7_tsc lane signal_detect_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * Along with merlin7_tsc_core_clkgate(), all lanes should also be clock gated using merlin7_tsc_lane_clkgate() to complete a Core Clockgate
 * @param sa__ is an opaque state vector passed through to device access functions.
 ...
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *pmd_lock Current merlin7_tsc lane pmd_rx_lock status read back and populated by the API
 * @param *pmd_lock_chg Current merlin7_tsc lane pmd_rx_lock_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *pll_lock Current merlin7_tsc lane pll_lock status read back and populated by the API
 * @param *pll_lock_chg Current merlin7_tsc lane pll_lock_change status read back and populated by the API
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * Define macro CUSTOM_REG_POLLING to replace the default implementation provided in merlin7_tsc_internal.c.
 *
 * @param sa__ is an opaque state vector passed through to device access functions.
...
#define get_endian_offset(addr) (merlin7_tsc_INTERNAL_is_big_endian() ? \
                                (\
...
typedef struct {
    uint8_t *mem_ptr;
} merlin7_tsc_INTERNAL_rdblk_callback_arg_t;

/** Callback function for reading uc RAM memory by merlin7_tsc_INTERNAL_rdblk_uc_generic_ram().
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param *arg is a merlin7_tsc_INTERNAL_rdblk_callback_arg_t pointer for holding state.
 ...
 *         indefinitely, until cnt bytes total are read.
 *  In other words, this is the same as merlin7_tsc_INTERNAL_rdblk_uc_generic_ram(), but reading in descending address order.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param block_addr Address of RAM block to be read.
 *                   For program RAM, the upper 16 bits are 0x0000.  Otherwise, the upper 16 bits are 0x2000.
 * @param block_size Length of RAM block to read.
 ...
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param refclk REFCLK input
 * @param *refclk_in_hz REFCLK value in Hz updated by API
