...
err_code_t falcon16_v1l4p1_uc_reset_with_info(srds_access_t *sa__, uint8_t enable, ucode_info_t ucode_info) {
  if (enable) {
    ...
    EFUN(falcon16_v1l4p1_pmd_wr_reg(sa__, 0xD200, 0x0000));
    EFUN(falcon16_v1l4p1_pmd_wr_reg(sa__, 0xD201, 0x0000));
    EFUN(falcon16_v1l4p1_pmd_wr_reg(sa__, 0xD202, 0x0000));
    EFUN(falcon16_v1l4p1_pmd_wr_reg(sa__, 0xD204, 0x0000));
    EFUN(falcon16_v1l4p1_pmd_wr_reg(sa__, 0xD205, 0x0000));
    EFUN(falcon16_v1l4p1_pmd_wr_reg(sa__, 0xD206, 0x0000));
    EFUN(falcon16_v1l4p1_pmd_wr_reg(sa__, 0xD207, 0x0000));
    EFUN(falcon16_v1l4p1_pmd_wr_reg(sa__, 0xD208, 0x0000));
    EFUN(falcon16_v1l4p1_pmd_wr_reg(sa__, 0xD209, 0x0000));
    EFUN(falcon16_v1l4p1_pmd_wr_reg(sa__, 0xD20A, 0x0000));
    EFUN(falcon16_v1l4p1_pmd_wr_reg(sa__, 0xD20B, 0x0000));
    EFUN(falcon16_v1l4p1_pmd_wr_reg(sa__, 0xD20C, 0x0000));
    EFUN(falcon16_v1l4p1_pmd_wr_reg(sa__, 0xD20D, 0x0000));
    EFUN(falcon16_v1l4p1_pmd_wr_reg(sa__, 0xD20E, 0x0000));
    EFUN(falcon16_v1l4p1_pmd_wr_reg(sa__, 0xD211, 0x0000));
    EFUN(falcon16_v1l4p1_pmd_wr_reg(sa__, 0xD212, 0x0000));
    EFUN(falcon16_v1l4p1_pmd_wr_reg(sa__, 0xD213, 0x0000));
    EFUN(falcon16_v1l4p1_pmd_wr_reg(sa__, 0xD214, 0x0000));
    EFUN(falcon16_v1l4p1_pmd_wr_reg(sa__, 0xD215, 0x0000));
    EFUN(falcon16_v1l4p1_pmd_wr_reg(sa__, 0xD216, 0x0007));
    EFUN(falcon16_v1l4p1_pmd_wr_reg(sa__, 0xD217, 0x0000));
    EFUN(falcon16_v1l4p1_pmd_wr_reg(sa__, 0xD218, 0x0000));
    EFUN(falcon16_v1l4p1_pmd_wr_reg(sa__, 0xD219, 0x0000));
    EFUN(falcon16_v1l4p1_pmd_wr_reg(sa__, 0xD21A, 0x0000));
    EFUN(falcon16_v1l4p1_pmd_wr_reg(sa__, 0xD21B, 0x0000));
    EFUN(falcon16_v1l4p1_pmd_wr_reg(sa__, 0xD220, 0x0000));
    EFUN(falcon16_v1l4p1_pmd_wr_reg(sa__, 0xD221, 0x0000));
    EFUN(falcon16_v1l4p1_pmd_wr_reg(sa__, 0xD224, 0x0000));

    EFUN(falcon16_v1l4p1_pmd_wr_reg(sa__, 0xD225, 0x8701));
#endif /* wrc_micro_micro_s_rstb */

    EFUN(falcon16_v1l4p1_pmd_wr_reg(sa__, 0xD226, 0x0000));
    EFUN(falcon16_v1l4p1_pmd_wr_reg(sa__, 0xD228, 0x0101));
    EFUN(falcon16_v1l4p1_pmd_wr_reg(sa__, 0xD229, 0x0000));
    EFUN(falcon16_v1l4p1_pmd_wr_reg(sa__, 0xD22A, 0x0000));  
  }
  else {
#ifdef wrc_micro_micro_s_rstb
