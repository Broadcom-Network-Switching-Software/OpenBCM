...
/* Merlin7 has single micro and so no need for additional definitions of below functions */
#define merlin7_pcieg3_get_micro_idx merlin7_pcieg3_get_pll_idx
#define merlin7_pcieg3_set_micro_idx merlin7_pcieg3_set_pll_idx

#if defined(SERDES_EXTERNAL_INFO_TABLE_EN)
/** Returns address of merlin7_pcieg3 info table stored in upper level software.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @return Pointer to the merlin7_pcieg3 info table.
 */
