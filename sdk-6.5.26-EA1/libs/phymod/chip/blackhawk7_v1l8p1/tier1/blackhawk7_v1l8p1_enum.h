...
enum blackhawk7_v1l8p1_cdr_enum {
    OS,
    BR
};
...
enum blackhawk7_v1l8p1_force_cdr_mode_enum {
    BLACKHAWK7_V1L8P1_OSCDR_FORCE_ENABLE,     /*!< Force OS-CDR mode */
    BLACKHAWK7_V1L8P1_OSCDR_FORCE_DISABLE,    /*!< Disable Force OS-CDR mode */
    BLACKHAWK7_V1L8P1_BRCDR_FORCE_ENABLE,     /*!< Force BR-CDR mode */
    BLACKHAWK7_V1L8P1_BRCDR_FORCE_DISABLE,    /*!< Disable Force BR-CDR mode */
    BLACKHAWK7_V1L8P1_CDR_FORCE_DISABLE       /*!< Disable Force CDR modes */
};
