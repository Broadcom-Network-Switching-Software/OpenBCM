 ...
 * @return Signed-Gray value.
  */
int8_t blackhawk7_v1l8p1_INTERNAL_dfe_tap_sgb2sg(int8_t sgb);
 ...
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_fit_second_order(srds_access_t *sa__, uint8_t n, USR_DOUBLE *x, USR_DOUBLE *y, USR_DOUBLE *a);


/*------------------------------*/
/** Serdes Lane State Structure */
/*------------------------------*/
typedef struct blackhawk7_v1l8p1_lane_state_st{
...
} blackhawk7_v1l8p1_lane_state_st_t;
/*------------------------------*/
 ...
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_test_uc_timestamp_with_print_options(srds_access_t *sa__, uint8_t console_print_options);
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors).
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_check_vco_freq_khz(srds_access_t *sa__, uint32_t vco_freq_khz);
 ...
 * Calls blackhawk7_v1l8p1_core_dp_reset() as needed.
 * Configures PLL registers to obtain the required configuration.
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors).
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_configure_20P625_pll(srds_access_t *sa__,
                                                enum blackhawk7_v1l8p1_pll_refclk_enum refclk,
                                                enum blackhawk7_v1l8p1_pll_div_enum srds_div,
                                                enum blackhawk7_v1l8p1_pll_option_enum pll_option);
 ...
 * @param[in] range_250 determines the range 0 = +/-150mV, 1 = +/-250mV (ignored for 7 and LITE7).
 * @param[in] slicer_sel slicer for which ladder threshold needs to be calculated. (Required for 7 and LITE7, unused (can be zero) for all other IPs).
 ...
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_pam4_to_bin(srds_access_t *sa__, char var, char bin[], size_t bin_size);
 ...
 * @return Error Code generated by invalid hex variable (returns ERR_CODE_NONE if no errors).
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_compute_bin(srds_access_t *sa__, char var, char bin[], size_t bin_size);
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors).
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_read_lane_state(srds_access_t *sa__, blackhawk7_v1l8p1_lane_state_st_t *istate);
 ...
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_eye_scan_setup(srds_access_t *sa__, uint8_t intr_pass_b, int16_t *y_max, int16_t *y_step, uint16_t *usr_diag_status);
...
typedef struct {
    ...
    uint8_t  ram_idx;
    int32_t  count;
}blackhawk7_v1l8p1_INTERNAL_ram_dump_state_t;
...
typedef struct {
    ...
    uint8_t *mem_ptr;
    uint32_t ram_size;
    blackhawk7_v1l8p1_INTERNAL_ram_dump_state_t *dump_state_ptr;
} blackhawk7_v1l8p1_INTERNAL_rdblk_ram_arg_t;

uint32_t _blackhawk7_v1l8p1_INTERNAL_get_addr_from_lane(srds_access_t *sa__, uint16_t addr, uint8_t lane);
uint32_t _blackhawk7_v1l8p1_INTERNAL_get_uc_addr_from_lane(srds_access_t *sa__, uint16_t addr, uint8_t lane);
uint32_t _blackhawk7_v1l8p1_INTERNAL_get_addr_from_core(srds_access_t *sa__, uint16_t addr);

err_code_t blackhawk7_v1l8p1_INTERNAL_rdblk_ram_read_callback(srds_access_t *sa__,void *arg,uint8_t byte_count,uint16_t data);

err_code_t blackhawk7_v1l8p1_INTERNAL_ram_dump_callback(srds_access_t *sa__, void *arg, uint8_t byte_count, uint16_t data);
...
/** Callback function for reading uc RAM memory by blackhawk7_v1l8p1_INTERNAL_rdblk_uc_generic_ram() customized for
 ...
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors).
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_rdblk_ram_callback(srds_access_t *sa__,void *arg,uint8_t byte_count, uint16_t data);
...
/** collects dbgfb stats for all. Newer 7 has feature in uCode, else use the api method.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * @return Error Code generated by API (ERR_CODE_NONE if no errors).
 */
err_code_t blackhawk7_v1l8p1_dbgfb_collect_stats(srds_access_t *sa__, uint32_t time_in_us, blackhawk7_v1l8p1_dbgfb_stats_st *dbgfb_stats);

err_code_t blackhawk7_v1l8p1_dbgfb_collect_stats_api_method(srds_access_t *sa__, uint32_t time_in_us, blackhawk7_v1l8p1_dbgfb_stats_st *dbgfb_stats);
 ...
 */
uint32_t blackhawk7_v1l8p1_osr_mode_enum_to_int_x1000(uint8_t osr_mode);
 ...
 * @return Error Code generated by API (ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_v1l8p1_INTERNAL_is_flr_supported(srds_access_t *sa__, uint8_t *flr_support);
