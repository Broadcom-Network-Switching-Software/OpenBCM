...
enum blackhawk7_l8p2_osr_mode_enum {
  ...
  BLACKHAWK7_L8P2_OSR_UNINITIALIZED = 0x3f
};
...
#define INIT_OSR_ASSOC_TABLE                                                                              \
            {{BLACKHAWK7_L8P2_OSX1, 1000}, {BLACKHAWK7_L8P2_OSX2, 2000}, {BLACKHAWK7_L8P2_OSX2P5, 2500},              \
             {BLACKHAWK7_L8P2_OSX4, 4000}, {BLACKHAWK7_L8P2_OSX8, 8000}, {BLACKHAWK7_L8P2_OSX16, 16000},              \
             {BLACKHAWK7_L8P2_OSX16P5, 16500}, {BLACKHAWK7_L8P2_OSX20P625, 20625}, {BLACKHAWK7_L8P2_OSX21P25, 21250}, \
             {BLACKHAWK7_L8P2_OSX32, 32000}}

#define INIT_OSR_MODE_ENUM {BLACKHAWK7_L8P2_OSX1, BLACKHAWK7_L8P2_OSX2, BLACKHAWK7_L8P2_OSX2P5, \
                            BLACKHAWK7_L8P2_OSX4, BLACKHAWK7_L8P2_OSX8, BLACKHAWK7_L8P2_OSX16, \
                            BLACKHAWK7_L8P2_OSX16P5, BLACKHAWK7_L8P2_OSX20P625, BLACKHAWK7_L8P2_OSX21P25, \
                            BLACKHAWK7_L8P2_OSX32, 0xff}
 ...
 */
enum blackhawk7_l8p2_flr_timeout_enum {
  BLACKHAWK7_L8P2_FLR_TIMEOUT_50MS  = 0,
  BLACKHAWK7_L8P2_FLR_TIMEOUT_75MS  = 1,
  BLACKHAWK7_L8P2_FLR_TIMEOUT_100MS = 2,
  BLACKHAWK7_L8P2_FLR_TIMEOUT_150MS = 3,
  BLACKHAWK7_L8P2_FLR_TIMEOUT_250MS = 4,
  BLACKHAWK7_L8P2_FLR_TIMEOUT_500MS = 5  
};
