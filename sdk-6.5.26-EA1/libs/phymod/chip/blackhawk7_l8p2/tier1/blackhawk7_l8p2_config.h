...
#ifndef BLACKHAWK7_L8P2_API_CONFIG_H
#define BLACKHAWK7_L8P2_API_CONFIG_H
...
if (!(((BLACKHAWK7_L8P2_REVID_MODEL_DEFAULT_A0 == revid) && (BLACKHAWK7_L8P2_REVID2_DEFAULT_A0 == revid2) && ((BLACKHAWK7_L8P2_AFE_IPVERSION_ID_DEFAULT_A0 == ipversion) || (BLACKHAWK7_L8P2_AFE_IPVERSION_ID_DEFAULT_A0_2 == ipversion))) ||   \
      ((BLACKHAWK7_L8P2_REVID_MODEL_DEFAULT_B0 == revid) && (BLACKHAWK7_L8P2_REVID2_DEFAULT_B0 == revid2) && (BLACKHAWK7_L8P2_AFE_IPVERSION_ID_DEFAULT_B0 == ipversion)))) {  \
    EFUN_PRINTF(("ERROR: IP Hardware ID Mismatch. Expected: 0x%08X (A0), 0x%08X (A0_2), or %08X (B0). Actual: 0x%08X.\n",                          \
                (uint32_t)((BLACKHAWK7_L8P2_REVID_MODEL_DEFAULT_A0 << 16) | (BLACKHAWK7_L8P2_REVID2_DEFAULT_A0 << 8) | (BLACKHAWK7_L8P2_AFE_IPVERSION_ID_DEFAULT_A0)),        \
                (uint32_t)((BLACKHAWK7_L8P2_REVID_MODEL_DEFAULT_A0 << 16) | (BLACKHAWK7_L8P2_REVID2_DEFAULT_A0 << 8) | (BLACKHAWK7_L8P2_AFE_IPVERSION_ID_DEFAULT_A0_2)),      \
                (uint32_t)((BLACKHAWK7_L8P2_REVID_MODEL_DEFAULT_B0 << 16) | (BLACKHAWK7_L8P2_REVID2_DEFAULT_B0 << 8) | (BLACKHAWK7_L8P2_AFE_IPVERSION_ID_DEFAULT_B0)),        \
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t blackhawk7_l8p2_get_uc_core_config(srds_access_t *sa__, struct blackhawk7_l8p2_uc_core_config_st *struct_val);
/*------------------------------------------------*/
 ...
 * Note: blackhawk7_l8p2_ucode_load_init() must be called before the first call to blackhawk7_l8p2_ucode_load_write(),
 * and blackhawk7_l8p2_ucode_load_close() must be called after the last call to blackhawk7_l8p2_ucode_load_write().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
...
/** Ends Microcode loading state. Call after the last blackhawk7_l8p2_ucode_load_write().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] pram indicates if the microcode is loaded through the PRAM interface (1 = yes; 0 = no )
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * Note: Micro should be loaded only after issuing a blackhawk7_l8p2_uc_reset(1) followed by asserting and de-asserting
 * core_s_reset. Information table should be intialized with blackhawk7_l8p2_init_blackhawk7_l8p2_info after microcode load.
 ...
 * NOTE: Information table should be intialized with blackhawk7_l8p2_init_blackhawk7_l8p2_info after microcode load.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * Dummy function to maintain compatibility with BHK7 APIs [calls blackhawk7_l8p2_uc_reset(..) internally].
 ...
 * Issues blackhawk7_l8p2_uc_reset followed by blackhawk7_l8p2 core reset (core_s_rstb) after selecting com_clk as micro_clk.
...
/** Initialize the blackhawk7_l8p2_info for the uC.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @return Error Code generated if uC does not become active (returns ERR_CODE_NONE if no errors).
 */
 ...
 * @code
    ...
    EFUN(blackhawk7_l8p2_map_lanes(sa__, 2, tx_lane_map, rx_lane_map));
 * @endcode
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 */
#define blackhawk7_l8p2_configure_pll_refclk_div_vco blackhawk7_l8p2_INTERNAL_configure_pll

#ifndef SMALL_FOOTPRINT
/** PLL Powerdown.
 *
 * Powers down the selected PLL. To power up the PLL, reconfigure the PLL by using
 * one of the "blackhawk7_l8p2_configure_pll_" APIs.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors).
 */
 ...
 * @code
    EFUN(blackhawk7_l8p2_core_dp_reset(sa__, 1));
    EFUN(blackhawk7_l8p2_configure_pll_refclk_div(sa__, BLACKHAWK7_L8P2_PLL_REFCLK_156P25MHZ, BLACKHAWK7_L8P2_PLL_DIV_170));
    EFUN(blackhawk7_l8p2_core_dp_reset(sa__, 0));
 * @endcode
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors).
 */
 ...
 * @code
    EFUN(blackhawk7_l8p2_core_dp_reset(sa__, 1));
    EFUN(blackhawk7_l8p2_configure_pll_refclk_vco(sa__, BLACKHAWK7_L8P2_PLL_REFCLK_156P25MHZ, 25000000));
    EFUN(blackhawk7_l8p2_core_dp_reset(sa__, 0));
 * @endcode
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors).
 */
 ...
 * @code
    EFUN(blackhawk7_l8p2_core_dp_reset(sa__, 1));
    EFUN(blackhawk7_l8p2_configure_pll_refclk_vco(sa__, BLACKHAWK7_L8P2_PLL_DIV_170, 25000000));
    EFUN(blackhawk7_l8p2_core_dp_reset(sa__, 0));
 * @endcode
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors).
 */
 ...
 * This function calls blackhawk7_l8p2_core_dp_reset() as needed.
 * Configures PLL registers to obtain the required configuration.
 ...
 * Note: This API should be used only during configuration under dp_reset (blackhawk7_l8p2_ln_dp_reset()).
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[out] mode An enable/disable option from the enum blackhawk7_l8p2_force_cdr_mode_enum.
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors).
 */
 ...
 * Note: This API should be used only during configuration under dp reset (blackhawk7_l8p2_ln_dp_reset()).
 *       When enabling one mode, this API will disable the other mode.
 * Note: ER-CDR Mode does not apply to 7nm Serdes cores
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] mode An enable/disable option from the enum blackhawk7_l8p2_force_cdr_mode_enum.
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors).
 */
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors).
 */
err_code_t blackhawk7_l8p2_get_uc_lane_cfg(srds_access_t *sa__, struct blackhawk7_l8p2_uc_lane_config_st *struct_val);
#endif /* SMALL_FOOTPRINT */
 ...
 * NOTE: Before asserting TX datapath reset, the TX must be disabled (blackhawk7_l8p2_tx_disable(sa__, 1).
 ...
 * reenabled (blackhawk7_l8p2_tx_disable(sa__, 0).
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * NOTE: Before asserting lane datapath reset, the TX must be disabled (blackhawk7_l8p2_tx_disable(sa__, 1).
 * This is done in order to prevent analog aging circuits from leaking garbage data out the TX.
 ...
 * Note: Calling this API will overwrite any OSR mode value previously programmed through blackhawk7_l8p2_set_osr_mode(),
 *       blackhawk7_l8p2_set_tx_osr_mode(), or blackhawk7_l8p2_set_rx_osr_mode().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * Note: Calling this API will overwrite any OSR mode value previously programmed through blackhawk7_l8p2_set_osr_mode()
 *        or blackhawk7_l8p2_set_rx_osr_mode().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * Note: Calling this API will overwrite any OSR mode value previously programmed through blackhawk7_l8p2_set_osr_mode()
 *        or blackhawk7_l8p2_set_tx_osr_mode().
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * Note: Calling this API will overwrite the blackhawk7_l8p2_set_use_osr_mode_pins_only() setting if it was previously set.
 ...
 * Note: This API returns the control status, not the actual hardware status. Use blackhawk7_l8p2_INTERNAL_get_osr_mode()
...
/** Set the RX osr mode.
 * Note: Calling this API will overwrite the blackhawk7_l8p2_set_use_rx_osr_mode_pins_only() setting if it was previously set.
 * Note: This API should be used for configuring TX and RX osr modes when pins aren't being used. Do not write directly to the following
 *       register fields: rx_osr_mode_frc, rx_osr_mode_frc_val, tx_osr_mode_frc, tx_osr_mode_frc_val, osr_mode_frc, and osr_mode_frc_val.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
...
/** Set the TX osr mode.
 * Note: Calling this API will overwrite the blackhawk7_l8p2_set_use_tx_osr_mode_pins_only() setting if it was previously set.
 * Note: This API should be used for configuring TX and RX osr modes when pins aren't being used. Do not write directly to the following
 *       register fields: rx_osr_mode_frc, rx_osr_mode_frc_val, tx_osr_mode_frc, tx_osr_mode_frc_val, osr_mode_frc, and osr_mode_frc_val.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 ...
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] param selects the parameter to write based on #blackhawk7_l8p2_tx_afe_settings_enum.
 ...
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @param[in] param selects the parameter to read based on #blackhawk7_l8p2_tx_afe_settings_enum.
 ...
 * RX Adaptation needs to be stopped before modifying any of the VGA, PF or DFE taps.
 * To resume RX adaptation, use the blackhawk7_l8p2_stop_rx_adaptation() API.
 * @param[in] sa__ is an opaque state vector passed through to device access functions.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
