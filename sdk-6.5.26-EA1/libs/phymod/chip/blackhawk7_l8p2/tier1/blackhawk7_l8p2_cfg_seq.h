...
#define BLACKHAWK7_L8P2_USR_MISC_CTRL_FORCE_ER      0x1 << 9
/* Bit 10: force NR in AN, default is 0 */
#define BLACKHAWK7_L8P2_USR_MISC_CTRL_FORCE_NR      0x1 << 10
...
err_code_t blackhawk7_l8p2_tsc_usr_misc_ctrl_set(phymod_access_t *sa__, uint32_t bitmask, uint8_t value);
err_code_t blackhawk7_l8p2_tsc_usr_misc_ctrl_get(phymod_access_t *sa__, uint32_t bitmask, uint8_t *value);
err_code_t blackhawk7_l8p2_rx_pmd_lock_status_get(phymod_access_t *sa__, uint32_t *pmd_rx_locked, uint32_t *pmd_lock_changed);
err_code_t blackhawk7_l8p2_tx_pcs_intf_dly_mode_en(phymod_access_t *sa__, uint8_t en);
