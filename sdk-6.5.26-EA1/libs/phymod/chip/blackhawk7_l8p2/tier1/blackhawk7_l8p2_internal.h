...
/*------------------------------*/
typedef struct blackhawk7_l8p2_lane_state_st{
...
} blackhawk7_l8p2_lane_state_st_t;
/*------------------------------*/
...
/*------------------------------------*/
err_code_t blackhawk7_l8p2_INTERNAL_resume_micro_lane_state(srds_access_t *sa__, blackhawk7_l8p2_lane_state_st_t *st);
err_code_t blackhawk7_l8p2_INTERNAL_get_stop_state_lane_state(srds_access_t *sa__, blackhawk7_l8p2_lane_state_st_t *st);
err_code_t blackhawk7_l8p2_INTERNAL_get_pmd_lock_chg_lane_state(srds_access_t *sa__, blackhawk7_l8p2_lane_state_st_t *st);
err_code_t blackhawk7_l8p2_INTERNAL_get_afe_bw_lane_state(srds_access_t *sa__, blackhawk7_l8p2_lane_state_st_t *st);
err_code_t blackhawk7_l8p2_INTERNAL_get_eq_debug1_lane_state(srds_access_t *sa__, blackhawk7_l8p2_lane_state_st_t *st);
err_code_t blackhawk7_l8p2_INTERNAL_get_osr_str_lane_state(srds_access_t *sa__, blackhawk7_l8p2_lane_state_st_t *st);
err_code_t blackhawk7_l8p2_INTERNAL_get_uc_cfg_lane_state(srds_access_t *sa__, blackhawk7_l8p2_lane_state_st_t *st);
err_code_t blackhawk7_l8p2_INTERNAL_get_txfir_lane_state(srds_access_t *sa__, blackhawk7_l8p2_lane_state_st_t *st);
err_code_t blackhawk7_l8p2_INTERNAL_get_uc_sts_decoded_lane_state(srds_access_t *sa__, blackhawk7_l8p2_lane_state_st_t *st);
err_code_t blackhawk7_l8p2_INTERNAL_get_rx_pam_mode_lane_state(srds_access_t *sa__, blackhawk7_l8p2_lane_state_st_t *st);
err_code_t blackhawk7_l8p2_INTERNAL_get_disable_eye_lane_state(srds_access_t *sa__, blackhawk7_l8p2_lane_state_st_t *st);
err_code_t blackhawk7_l8p2_INTERNAL_get_TP0_lane_state(srds_access_t *sa__, blackhawk7_l8p2_lane_state_st_t *st);
err_code_t blackhawk7_l8p2_INTERNAL_get_pf_lane_state(srds_access_t *sa__, blackhawk7_l8p2_lane_state_st_t *st);
err_code_t blackhawk7_l8p2_INTERNAL_get_clk_lane_state(srds_access_t *sa__, blackhawk7_l8p2_lane_state_st_t *st);
err_code_t blackhawk7_l8p2_INTERNAL_get_dfe_lane_state(srds_access_t *sa__, blackhawk7_l8p2_lane_state_st_t *st);
err_code_t blackhawk7_l8p2_INTERNAL_get_afe_bw_metric_lane_state(srds_access_t *sa__, blackhawk7_l8p2_lane_state_st_t *st);
...
typedef struct {
    ...
    uint8_t  ram_idx;
    int32_t  count;
}blackhawk7_l8p2_INTERNAL_ram_dump_state_t;
...
typedef struct {
    ...
    uint8_t *mem_ptr;
    uint32_t ram_size;
    blackhawk7_l8p2_INTERNAL_ram_dump_state_t *dump_state_ptr;
} blackhawk7_l8p2_INTERNAL_rdblk_ram_arg_t;
...
/** Callback function for reading uc RAM memory by blackhawk7_l8p2_INTERNAL_rdblk_uc_generic_ram() customized for
