...
int tefmod_gen3_autoneg_ability_set(PHYMOD_ST* pc, tefmod_gen3_an_adv_ability_t *cl73_adv)
{
    ...
    */
    if((cl73_adv->an_cl72 & 0x1) == 1) {
         ...
         tefmod_gen3_set_override_1(pc, override_v);
    } else {
...
@details
  TBD
*/
int tefmod_gen3_set_override_0(PHYMOD_ST* pc, uint32_t per_field_override_en)
{
    int or_value;
...
@details
  TBD
*/
int tefmod_gen3_set_override_1(PHYMOD_ST* pc, uint32_t per_field_override_en)   /* OVERRIDE_SET */
{
    int or_value;
    override_type_t or_en;
    MAIN0_SETUPr_t                     MAIN0_SETUPr_reg;
...
int tefmod_gen3_hg2_codec_set(PHYMOD_ST* pc, tefmod_gen3_hg2_codec_t hg2_codec)
{
    ...
    case TEFMOD_HG2_CODEC_OFF:
        ...
        PHYMOD_IF_ERR_RETURN(tefmod_gen3_set_override_0(pc, field_override));
        ...
        PHYMOD_IF_ERR_RETURN(tefmod_gen3_set_override_1(pc, field_override));
...
int tefmod_gen3_1588_ts_offset_get(PHYMOD_ST *pc, uint32_t *offset)
{
    MAIN0_TS_TMR_OFFSr_t MAIN0_TS_TMR_OFFSr_reg;
...
int tefmod_gen3_port_start_lane_get(PHYMOD_ST *pc,
                                    ...
                                    int *port_num_lane)
{
    ...
    if (num_of_lane > 1) {
        ...
        *port_num_lane = num_of_lane;
        ...
        PHYMOD_IF_ERR_RETURN
            (_tefmod_gen3_port_lane_config_get(pc,
                                               port_mode_sel_reg,
                                               port_starting_lane,
                                               port_num_lane));
    }
