...
/** @file falcon16_v1l4p1_internal_error.h
 * Internal API error functions
 */

#ifndef FALCON16_V1L4P1_API_INTERNAL_ERROR_H
#define FALCON16_V1L4P1_API_INTERNAL_ERROR_H
 ...
 */
#define falcon16_v1l4p1_error_report(sa__, err_code) \
        falcon16_v1l4p1_INTERNAL_print_err_msg_and_triage_info(sa__, (err_code), __FILE__, API_FUNCTION_NAME, __LINE__)
/**@}*/

/* Prints error code, containing function, file and line number */
#define falcon16_v1l4p1_error(sa__, err_code) \
        falcon16_v1l4p1_INTERNAL_print_err_msg(sa__, (err_code), __FILE__, API_FUNCTION_NAME, __LINE__)
 ...
 * @return Error Code
 */
err_code_t falcon16_v1l4p1_INTERNAL_print_err_msg(srds_access_t *sa__, uint16_t err_code, const char *filename, const char *func_name, uint16_t line);
 ...
 * @return Error Code
 */
err_code_t falcon16_v1l4p1_INTERNAL_print_err_msg_and_triage_info(srds_access_t *sa__, uint16_t err_code, const char *filename, const char *func_name, uint16_t line);
 ...
 */
const char* falcon16_v1l4p1_INTERNAL_e2s_err_code(err_code_t err_code);
