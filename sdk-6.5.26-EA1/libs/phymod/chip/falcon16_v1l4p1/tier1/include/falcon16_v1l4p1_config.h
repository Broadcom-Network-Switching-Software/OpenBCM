...
/** @file falcon16_v1l4p1_config.h
 * Configuration functions provided to IP User
 */

#ifndef FALCON16_V1L4P1_API_CONFIG_H
#define FALCON16_V1L4P1_API_CONFIG_H
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon16_v1l4p1_get_uc_core_config(srds_access_t *sa__, struct falcon16_v1l4p1_uc_core_config_st *struct_val);
 ...
 * \n Note: Micro should be loaded only after issuing a falcon16_v1l4p1_uc_reset(1) followed by asserting and de-asserting
 * core_s_reset. Information table should be intialized with falcon16_v1l4p1_init_falcon16_v1l4p1_info after microcode load.
 ...
 * NOTE: No uC commands should be executed between starting the CRC calculaion [falcon16_v1l4p1_ucode_crc_verify()] and verifying the CRC value [falcon16_v1l4p1_start_ucode_crc_calc()].
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param ucode_len Length of Microcode Image (number of bytes)
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
 ...
 * NOTE: No uC commands should be executed between starting the CRC calculation [falcon16_v1l4p1_ucode_crc_verify()] and verifying the CRC value [falcon16_v1l4p1_start_ucode_crc_calc()].
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param expected_crc_value Expected CRC value of the microcode
 ...
 * NOTE: Information table should be intialized with falcon16_v1l4p1_init_falcon16_v1l4p1_info after microcode load.
 * @param sa__ is an opaque state vector passed through to device access functions.
...
/** Initialize the falcon16_v1l4p1_info for the uC.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @return Error Code generated if uC does not become active (returns ERR_CODE_NONE if no errors)
 */
 ...
 */
#define falcon16_v1l4p1_configure_pll_refclk_div_vco falcon16_v1l4p1_INTERNAL_configure_pll 
/** Configure PLL.
 *
 ...
 * @return Error Code, if generated (returns ERR_CODE_NONE if no errors)
 */
err_code_t falcon16_v1l4p1_get_uc_lane_cfg(srds_access_t *sa__, struct falcon16_v1l4p1_uc_lane_config_st *struct_val);
 ...
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param param selects the parameter to write based on #falcon16_v1l4p1_tx_afe_settings_enum
 ...
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @param param selects the parameter to read based on #falcon16_v1l4p1_tx_afe_settings_enum
 ...
 * RX Adaptation needs to be stopped before modifying any of the VGA, PF or DFE taps.
 * To resume RX adaptation, use the falcon16_v1l4p1_stop_rx_adaptation() API.
 * @param sa__ is an opaque state vector passed through to device access functions.
 * @return Error Code generated by API (returns ERR_CODE_NONE if no errors)
 */
