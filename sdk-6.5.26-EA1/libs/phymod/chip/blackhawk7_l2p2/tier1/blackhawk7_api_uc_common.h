...
#define BLACKHAWK7_L2P2_LANE_TIMER_SHIFT (3)
/* Please note that when adding entries here you should update the #defines in the blackhawk7_l2p2_common.h */
...
/** OSR_MODES Enum */
enum blackhawk7_l2p2_osr_mode_enum {
  ...
  BLACKHAWK7_L2P2_OSX1      = 0,
  BLACKHAWK7_L2P2_OSX2      = 1,
  BLACKHAWK7_L2P2_OSX4      = 2,
  BLACKHAWK7_L2P2_OSX2P5    = 3,
  BLACKHAWK7_L2P2_OSX21P25  = 4,
  BLACKHAWK7_L2P2_OSX8      = 5,
  BLACKHAWK7_L2P2_OSX16P5   = 8,
  BLACKHAWK7_L2P2_OSX16     = 9,
  BLACKHAWK7_L2P2_OSX20P625 = 12,
  BLACKHAWK7_L2P2_OSX32     = 13,
  BLACKHAWK7_L2P2_OSR_UNINITIALIZED = 0x3f
};
...
#define INIT_OSR_ASSOC_TABLE                                                                              \
            {{BLACKHAWK7_L2P2_OSX1, 1000}, {BLACKHAWK7_L2P2_OSX2, 2000}, {BLACKHAWK7_L2P2_OSX2P5, 2500},              \
             {BLACKHAWK7_L2P2_OSX4, 4000}, {BLACKHAWK7_L2P2_OSX8, 8000}, {BLACKHAWK7_L2P2_OSX16, 16000},              \
             {BLACKHAWK7_L2P2_OSX16P5, 16500}, {BLACKHAWK7_L2P2_OSX20P625, 20625}, {BLACKHAWK7_L2P2_OSX21P25, 21250}, \
             {BLACKHAWK7_L2P2_OSX32, 32000}}

#define INIT_OSR_MODE_ENUM {BLACKHAWK7_L2P2_OSX1, BLACKHAWK7_L2P2_OSX2, BLACKHAWK7_L2P2_OSX2P5, \
                            BLACKHAWK7_L2P2_OSX4, BLACKHAWK7_L2P2_OSX8, BLACKHAWK7_L2P2_OSX16, \
                            BLACKHAWK7_L2P2_OSX16P5, BLACKHAWK7_L2P2_OSX20P625, BLACKHAWK7_L2P2_OSX21P25, \
                            BLACKHAWK7_L2P2_OSX32, 0xff}
...
#define OSR_MODE_SUPPORTS_EYE_TESTS(mode) (((mode) <= BLACKHAWK7_L2P2_OSX4) || ((mode) == BLACKHAWK7_L2P2_OSX2P5))

/** CDR mode Enum **/
enum blackhawk7_l2p2_cdr_mode_enum {
  BLACKHAWK7_L2P2_CDR_MODE_OS_ALL_EDGES             = 0,
  BLACKHAWK7_L2P2_CDR_MODE_OS_PATTERN               = 1,
  BLACKHAWK7_L2P2_CDR_MODE_OS_PATTERN_ENHANCED      = 2,
  BLACKHAWK7_L2P2_CDR_MODE_BR_PATTERN               = 3,
  BLACKHAWK7_L2P2_CDR_MODE_PAM4_NR_OS_PATTERN       = 4,
  BLACKHAWK7_L2P2_CDR_MODE_PAM4_NR_BR_PATTERN       = 5,
  BLACKHAWK7_L2P2_CDR_MODE_PAM4_ER_DFE_DATA_PATTERN = 6,
  BLACKHAWK7_L2P2_CDR_MODE_PAM4_ER_PATTERN          = 7
};

/** Lane User Control Clause93/72 Force Value **/
enum blackhawk7_l2p2_cl93n72_frc_val_enum {
  BLACKHAWK7_L2P2_CL93N72_FORCE_OS  = 0,
  BLACKHAWK7_L2P2_CL93N72_FORCE_BR  = 1
};

/** FLR Timeout Time Enum
 *  Please change flr_timeout_time_ary in process_pmd_lane.c to match any changes here.
 */
enum blackhawk7_l2p2_flr_timeout_enum {
  BLACKHAWK7_L2P2_FLR_TIMEOUT_50MS  = 0,
  BLACKHAWK7_L2P2_FLR_TIMEOUT_75MS  = 1,
  BLACKHAWK7_L2P2_FLR_TIMEOUT_100MS = 2,
  BLACKHAWK7_L2P2_FLR_TIMEOUT_150MS = 3,
  BLACKHAWK7_L2P2_FLR_TIMEOUT_250MS = 4,
  BLACKHAWK7_L2P2_FLR_TIMEOUT_500MS = 5  
};
...
/*
 * Macros for identifying UIP (Unified IP) versions for L2P2
 */
#define UIP_VERSION_1     (AMS_VERSION_A0)
#define UIP_VERSION_2     (AMS_VERSION_B0)
#define UIP_VERSION_3     (3)

#define GET_UIP_VERSION(_version, _revid2) (((_revid2) == 0x06) ? UIP_VERSION_3 : (GET_AMS_VERSION((_version))))
