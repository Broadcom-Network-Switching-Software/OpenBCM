...
enum srds_prbs_polynomial_enum {
    ...
    PRBS_31 = 5,
    PRBS_58 = 6,
    PRBS_49 = 7,           /* blackhawk only */
    PRBS_10 = 8,           /* blackhawk only */
    PRBS_20 = 9,           /* blackhawk only */
    PRBS_13 = 10,          /* blackhawk only */
    QPRBS_13 = 11,         /* blackhawk_sinai only */
    PRBS_AUTO_DETECT = 15, /* blackhawk only */
    PRBS_UNKNOWN = 16      /* blackhawk only */
};
