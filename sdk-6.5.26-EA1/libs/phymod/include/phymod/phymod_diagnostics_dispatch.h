...
typedef int (*__dispatch__phymod_phy_tx_pattern_set_f)(const phymod_phy_access_t* phy, phymod_phy_tx_pattern_t tx_pattern);
typedef int (*__dispatch__phymod_phy_tx_pattern_get_f)(const phymod_phy_access_t* phy, phymod_phy_tx_pattern_t* tx_pattern);
...
typedef int (*__dispatch__phymod_phy_linkcat_f)(const phymod_phy_access_t* phy, phymod_linkcat_config_t linkcat_config);
...
typedef int (*__dispatch__phymod_phy_pmd_usr_misc_ctrl_set_f)(const phymod_phy_access_t* phy, phymod_phy_pmd_usr_misc_ctrl_t mode, uint32_t value);
typedef int (*__dispatch__phymod_phy_pmd_usr_misc_ctrl_get_f)(const phymod_phy_access_t* phy, phymod_phy_pmd_usr_misc_ctrl_t mode, uint32_t* value);
typedef int (*__dispatch__phymod_phy_fec_error_inject_set_f)(const phymod_phy_access_t* phy, uint16_t error_control_map, phymod_fec_error_mask_t bit_error_mask);
typedef int (*__dispatch__phymod_phy_fec_error_inject_get_f)(const phymod_phy_access_t* phy, uint16_t* error_control_map, phymod_fec_error_mask_t* bit_error_mask);
typedef int (*__dispatch__phymod_phy_fec_error_bits_counter_get_f)(const phymod_phy_access_t* phy, uint32_t* count);
...
typedef struct __phymod_diagnostics__dispatch__s__ {
    ...
    __dispatch__phymod_phy_tx_pattern_set_f                                          f_phymod_phy_tx_pattern_set;
    __dispatch__phymod_phy_tx_pattern_get_f                                          f_phymod_phy_tx_pattern_get;
    ...
    __dispatch__phymod_phy_pmd_usr_misc_ctrl_set_f                                   f_phymod_phy_pmd_usr_misc_ctrl_set;
    __dispatch__phymod_phy_pmd_usr_misc_ctrl_get_f                                   f_phymod_phy_pmd_usr_misc_ctrl_get;
    __dispatch__phymod_phy_fec_error_inject_set_f                                    f_phymod_phy_fec_error_inject_set;
    __dispatch__phymod_phy_fec_error_inject_get_f                                    f_phymod_phy_fec_error_inject_get;
    __dispatch__phymod_phy_fec_error_bits_counter_get_f                              f_phymod_phy_fec_error_bits_counter_get;
