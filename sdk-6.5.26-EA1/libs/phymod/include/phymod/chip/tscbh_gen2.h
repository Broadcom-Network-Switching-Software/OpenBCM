...
/*Set timesync adjust*/
int tscbh_gen2_timesync_adjust_set(const phymod_phy_access_t* phy, uint32_t flags, const phymod_timesync_adjust_config_info_t* config_info);
...
/* Get am loss of alignment state*/
int tscbh_gen2_phy_am_loss_align_multi_state_get(const phymod_phy_access_t* phy, uint32_t* am_loss_align_multi_state);
