...
CONST mbcm_dpp_functions_t mbcm_qax_driver = {
    ...
    soc_qax_stat_if_queue_range_set,
    soc_qax_stat_if_queue_range_get,
    ...
    soc_qax_sram_drop_threshold_set,
    soc_qax_sram_drop_threshold_get,
    soc_qax_sram_drop_reassembly_context_profile_map_set,
    soc_qax_sram_drop_reassembly_context_profile_map_get,
    soc_qax_sram_drop_profile_priority_map_set,
    soc_qax_sram_drop_profile_priority_map_get,
