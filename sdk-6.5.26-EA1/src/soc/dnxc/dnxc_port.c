...
static shr_error_e
soc_dnxc_port_phy_tx_tap_pre3_supported(
    int unit,
    int *supported)
{
    SHR_FUNC_INIT_VARS(unit);
    ...
    bcm_port_phy_tx_t * tx)
{
    ...
    int serdes_tx_tap_pre3_supported = 0;
    ...
    SHR_IF_ERR_EXIT(soc_dnxc_port_phy_tx_tap_pre3_supported(unit, &serdes_tx_tap_pre3_supported));
    if (serdes_tx_tap_pre3_supported)
    {
