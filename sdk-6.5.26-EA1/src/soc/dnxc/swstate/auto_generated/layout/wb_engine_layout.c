...
wb_engine_init_layout_structure(int unit)
{
    ...
    layout_array_wb_engine[idx].first_child_index = 1;
    layout_array_wb_engine[idx].last_child_index = 1;
    layout_array_wb_engine[idx].next_node_index = 1;
    ...
    layout_array_wb_engine[idx].array_indexes[0].size = SOC_WB_ENGINE_NOF;
    ...
    layout_array_wb_engine[idx].array_indexes[1].size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_wb_engine[idx].first_child_index = 2;
    layout_array_wb_engine[idx].last_child_index = 2;
    layout_array_wb_engine[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_wb_engine[idx].array_indexes[0].size = DNXC_SW_STATE_LAYOUT_INVALID;
