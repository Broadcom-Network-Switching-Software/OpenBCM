...
adapter_init_layout_structure(int unit)
{
    ...
    layout_array_adapter[idx].doc = "Context data of the adapter";
    layout_array_adapter[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_adapter[idx].first_child_index = 1;
    layout_array_adapter[idx].last_child_index = 1;
    layout_array_adapter[idx].next_node_index = 1;
    ...
    layout_array_adapter[idx].doc = "array per nof dies. Each die has its own adapter params, should be DNX_DATA_MAX_ADAPTER_GENERAL_NOF_SUB_UNITS";
    layout_array_adapter[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_adapter[idx].size_of = sizeof(dnxc_adapter_context_params_t);
    layout_array_adapter[idx].array_indexes[0].size = 2;
    layout_array_adapter[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_adapter[idx].parent  = 0;
    layout_array_adapter[idx].first_child_index = 2;
    layout_array_adapter[idx].last_child_index = 11;
    layout_array_adapter[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_adapter[idx].doc = "Param for sending and receiving packets and signals";
    layout_array_adapter[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_adapter[idx].next_node_index = 3;
    ...
    layout_array_adapter[idx].type = "int";
    layout_array_adapter[idx].doc = "Param for accessing the registers and memories";
    layout_array_adapter[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_adapter[idx].size_of = sizeof(int);
    layout_array_adapter[idx].parent  = 1;
    layout_array_adapter[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_adapter[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_adapter[idx].next_node_index = 4;
    layout_array_adapter[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_DONT_DUMP;
    ...
    layout_array_adapter[idx].type = "int";
    layout_array_adapter[idx].doc = "Param for accessing the other tasks";
    layout_array_adapter[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_adapter[idx].size_of = sizeof(int);
    layout_array_adapter[idx].parent  = 1;
    layout_array_adapter[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_adapter[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_adapter[idx].next_node_index = 5;
    layout_array_adapter[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_DONT_DUMP;
    ...
    layout_array_adapter[idx].type = "int";
    layout_array_adapter[idx].doc = "Handler for external events socket";
    layout_array_adapter[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_adapter[idx].size_of = sizeof(int);
    layout_array_adapter[idx].parent  = 1;
    layout_array_adapter[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_adapter[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_adapter[idx].next_node_index = 6;
    layout_array_adapter[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_DONT_DUMP;
    ...
    layout_array_adapter[idx].doc = "UDP port of external event server";
    layout_array_adapter[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_adapter[idx].size_of = sizeof(uint32);
    layout_array_adapter[idx].parent  = 1;
    layout_array_adapter[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_adapter[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_adapter[idx].next_node_index = 7;
    ...
    layout_array_adapter[idx].type = "uint32";
    layout_array_adapter[idx].doc = "adapter server IP address";
    layout_array_adapter[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_adapter[idx].size_of = sizeof(uint32);
    layout_array_adapter[idx].parent  = 1;
    layout_array_adapter[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_adapter[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_adapter[idx].next_node_index = 8;
    ...
    layout_array_adapter[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_adapter[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_adapter[idx].next_node_index = 9;
    ...
    layout_array_adapter[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_adapter[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_adapter[idx].next_node_index = 10;
    ...
    layout_array_adapter[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_adapter[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_adapter[idx].next_node_index = 11;
    ...
    layout_array_adapter[idx].type = "sw_state_mutex_t";
    layout_array_adapter[idx].doc = "Mutex for external events socket";
    layout_array_adapter[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_adapter[idx].size_of = sizeof(sw_state_mutex_t);
    layout_array_adapter[idx].parent  = 1;
    layout_array_adapter[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
