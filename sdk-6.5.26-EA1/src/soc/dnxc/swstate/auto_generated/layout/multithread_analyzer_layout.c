...
multithread_analyzer_init_layout_structure(int unit)
{
    ...
    layout_array_multithread_analyzer[idx].first_child_index = 1;
    layout_array_multithread_analyzer[idx].last_child_index = 1;
    layout_array_multithread_analyzer[idx].next_node_index = 1;
    ...
    layout_array_multithread_analyzer[idx].type = "sw_state_htbl_t";
    layout_array_multithread_analyzer[idx].doc = "Hash Table for log entries.";
    layout_array_multithread_analyzer[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_multithread_analyzer[idx].size_of = sizeof(sw_state_htbl_t);
    ...
    layout_array_multithread_analyzer[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
