    ...
    uint8 *success)
{
    ...
    SHR_IF_ERR_EXIT(sw_state_hash_table_entry_lookup(unit, node_id, hash_table, key, NULL, &old_index, &found));
    ...
    uint32 data_indx)
{
    ...
    SHR_IF_ERR_EXIT(sw_state_hash_table_entry_remove(unit, node_id, hash_table, cur_key));
exit:
    SHR_FUNC_EXIT;
}
    ...
    sw_state_htbl_t hash_table)
{
    ...
    do {
        ...
        if (hash_table->is_index)
        {
            SHR_IF_ERR_EXIT(sw_state_hash_table_get_next(unit, node_id, hash_table, &iter, (SW_STATE_HASH_TABLE_KEY*) cur_key, NULL, (uint32*)data));
        }
        else
        {
            SHR_IF_ERR_EXIT(sw_state_hash_table_get_next(unit, node_id, hash_table, &iter, (SW_STATE_HASH_TABLE_KEY*) cur_key, (SW_STATE_HASH_TABLE_DATA*)data, NULL));
        }
    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(sw_state_hash_table_entry_lookup(unit, node_id, hash_table,
    ...
    {
        SHR_IF_ERR_EXIT(sw_state_hash_table_entry_remove(unit, node_id, hash_table, (SW_STATE_HASH_TABLE_KEY *) hash_table_key));
        hash_table_key[sizeof(hash_table_key) - 1] = hash_table_key[sizeof(hash_table_key) - 1] + 1;
    }
