...
#define DNXC_SWSTATE_JOURNAL_EXIT_IF_OFF(_unit, _er_thread_id, _is_er, _is_cmp)                          \
do {                                                                                                     \
    _is_er = dnx_rollback_journal_is_on(_unit, _er_thread_id, DNXC_SW_STATE_ROLLBACK_JOURNAL_HANDLE);    \
    _is_cmp = dnx_rollback_journal_is_on(_unit, _er_thread_id, DNXC_SW_STATE_COMPARISON_JOURNAL_HANDLE); \
    if((!_is_er) && (!_is_cmp))                                                                          \
    {                                                                                                    \
        SHR_EXIT();                                                                                      \
    }                                                                                                    \
...
#define DNXC_SWSTATE_JOURNAL_CALCULATE_POINTER(unit, entry, offset)\
    dnxc_sw_state_dispatcher[unit][DNXC_SW_STATE_LAYOUT_GET_MODULE_ID(((dnxc_sw_state_journal_entry_t *)(entry))->node_id)].calc_pointer(unit, ((dnxc_sw_state_journal_entry_t *)(entry))->offset)


#define DNXC_SWSTATE_JOURNAL_CALCULATE_DPOINTER(unit, entry, offset)\
    dnxc_sw_state_dispatcher[unit][DNXC_SW_STATE_LAYOUT_GET_MODULE_ID(((dnxc_sw_state_journal_entry_t *)(entry))->node_id)].calc_dpointer(unit, ((dnxc_sw_state_journal_entry_t *)(entry))->offset)
...
#define DNXC_SWSTATE_JOURNAL_ACCESS_NOTIFY(_unit, _thread_id)                                                                    \
    do {                                                                                                             \
        if(NULL != dnxc_sw_state_manager[_unit].journals[DNX_SWSTATE_COMPARISON_JOURNAL_NUM].access_cb) {            \
            dnxc_sw_state_manager[_unit].journals[DNX_SWSTATE_COMPARISON_JOURNAL_NUM].access_cb(_unit, _thread_id);  \
        }                                                                                                            \
        if(NULL != dnxc_sw_state_manager[_unit].journals[DNX_SWSTATE_ROLLBACK_JOURNAL_NUM].access_cb) {              \
            dnxc_sw_state_manager[_unit].journals[DNX_SWSTATE_ROLLBACK_JOURNAL_NUM].access_cb(_unit, _thread_id);    \
        }                                                                                                            \
    } while(0)
#else
...
#define DNXC_SW_STATE_ROLLBACK_JOURNAL_TRANSACTION dnxc_sw_state_manager[unit].journals[DNX_SWSTATE_ROLLBACK_JOURNAL_NUM].transaction[er_thread_id]
#define DNXC_SW_STATE_COMPARISON_JOURNAL_TRANSACTION dnxc_sw_state_manager[unit].journals[DNX_SWSTATE_COMPARISON_JOURNAL_NUM].transaction[er_thread_id]
...
static shr_error_e
dnxc_sw_state_journal_MEMCPY_entries_make_distinct(
    int unit,
...
static shr_error_e
dnxc_sw_state_journal_HTBL_entries_make_distinct(
    int unit,
    dnx_rollback_journal_entry_t *first_entry,
    uint8 *first_metadata,
    uint8 *first_payload,
...
static shr_error_e
dnxc_sw_state_journal_entries_make_distinct(
    int unit,
...
{ 
    ...
    dnxc_sw_state_journal_entry_t *first;
    dnxc_sw_state_journal_entry_t *second;
    ...
    first = (dnxc_sw_state_journal_entry_t *)(first_metadata);
    second = (dnxc_sw_state_journal_entry_t *)(second_metadata);
    ...
    {
        dnxc_sw_state_journal_MEMCPY_entries_make_distinct(unit,
                                                          first_entry,
                                                          first_metadata,
                                                          first_payload,
                                                          second_entry,
    ...
    {
        dnxc_sw_state_journal_HTBL_entries_make_distinct(unit,
                                                        first_entry,
                                                        first_metadata,
                                                        first_payload,
                                                        second_entry,
    ...
    uint8 is_comparison)
{
    ...
    sal_snprintf(comparison_perm_excluded[1], sizeof(comparison_perm_excluded[1]), "dnx_field_tcam_access_sw[%d]->fg_params[10].prefix_value", unit);
    sal_snprintf(comparison_perm_excluded[2], sizeof(comparison_perm_excluded[2]), "algo_bfd_db[%d]->bfd_your_discr_range", unit);
    sal_snprintf(comparison_perm_excluded[3], sizeof(comparison_perm_excluded[3]), "algo_bfd_db[%d]->bfd_oama_action", unit);
    ...
    sal_snprintf(comparison_perm_excluded[6], sizeof(comparison_perm_excluded[6]), "algo_oam_db[%d]->oam_mpls_pwe_exp_ttl_profile", unit);
    sal_snprintf(comparison_perm_excluded[7], sizeof(comparison_perm_excluded[7]), "algo_oam_db[%d]->oamp_itmh_pph_priority_profile", unit);
    sal_snprintf(comparison_perm_excluded[8], sizeof(comparison_perm_excluded[8]), "algo_bfd_db[%d]->bfd_oamp_v1_tx_rate", unit);
    sal_snprintf(comparison_perm_excluded[9], sizeof(comparison_perm_excluded[9]), "algo_oam_db[%d]->oam_mep_profile", unit);
    sal_snprintf(comparison_perm_excluded[10], sizeof(comparison_perm_excluded[10]), "algo_oamp_db[%d]->oamp_2b_maid_full_mep_id", unit);
    sal_snprintf(comparison_perm_excluded[11], sizeof(comparison_perm_excluded[11]), "algo_oamp_db[%d]->oamp_v1_mep_db_entry", unit);
    sal_snprintf(comparison_perm_excluded[12], sizeof(comparison_perm_excluded[12]), "algo_oam_db[%d]->oam_mep_profile", unit);
    sal_snprintf(comparison_perm_excluded[13], sizeof(comparison_perm_excluded[13]), "algo_bfd_db[%d]->bfd_oamp_v1_tx_rate", unit);
    sal_snprintf(comparison_perm_excluded[14], sizeof(comparison_perm_excluded[14]), "algo_oamp_db[%d]->oamp_2b_maid_full_mep_id", unit);
    sal_snprintf(comparison_perm_excluded[15], sizeof(comparison_perm_excluded[15]), "algo_oamp_db[%d]->oamp_full_tuples_mep_id[7]", unit);
    sal_snprintf(comparison_perm_excluded[16], sizeof(comparison_perm_excluded[16]), "algo_bfd_db[%d]->bfd_oamb_action", unit);
    sal_snprintf(comparison_perm_excluded[17], sizeof(comparison_perm_excluded[17]), "algo_oam_db[%d]->oam_trap_tcam_index", unit);
    sal_snprintf(comparison_perm_excluded[18], sizeof(comparison_perm_excluded[18]), "algo_bfd_db[%d]->bfd_oamp_v1_ipv4_src_addr", unit);

    
    sal_snprintf(comparison_perm_excluded[19], sizeof(comparison_perm_excluded[19]), "dnx_algo_port_db[%d]->pp[0][47]", unit);
    ...
    char *stamp)
{
    ...
    if(dnxc_sw_state_journal_is_stamp_excluded(unit, er_thread_id, stamp, TRUE))
    {
        SHR_EXIT();
    }
...
static shr_error_e
dnxc_sw_state_journal_roll_back_update_entry_locations_cb(
    int unit,
    uint8 *entry_raw,
    uint8 *entry_payload_raw,
    uint8 *traversed_raw,
    ...
    char *stamp)
{
    ...
    if(dnxc_sw_state_journal_is_stamp_excluded(unit, er_thread_id, stamp, FALSE))
    {
        SHR_EXIT();
    }
    ...
    char *stamp)
{
    ...
    DNX_SW_STATE_MEMCPY_BASIC(unit, entry->node_id, DNXC_SWSTATE_JOURNAL_CALCULATE_POINTER(unit, entry, data.memcpy_data.offset), payload, payload_size,
    ...
    char *stamp)
{
    ...
    SHR_IF_ERR_EXIT(dnxc_sw_state_dispatcher[unit][DNXC_SW_STATE_LAYOUT_GET_MODULE_ID(node_id)].mutex_create
                    (unit, node_id, (sw_state_mutex_t *)mtx_ptr,"roll back created mutex", DNXC_SW_STATE_JOURNAL_ROLLING_BACK));
    ...
    char *stamp)
{
    ...
    SHR_IF_ERR_EXIT(dnxc_sw_state_dispatcher[unit][DNXC_SW_STATE_LAYOUT_GET_MODULE_ID(node_id)].sem_create
                    (unit, node_id, (sw_state_sem_t *)sem_ptr, entry->data.sem_destroy.is_binary, entry->data.sem_destroy.initial_count, "roll back created semaphore", DNXC_SW_STATE_JOURNAL_ROLLING_BACK));
	...
	uint8 is_comparison)
{
    ...
    if(is_comparison)
    {
        for (idx = 0; idx < DNX_ERR_RECOVERY_MAX_NOF_ACTIVE_TRANSACTION; idx++)
        {
            SHR_IF_ERR_EXIT(dnxc_sw_state_journal_exclude_clear(unit, idx, is_comparison));
        }
    }
    ...
    uint8 is_comparison)
{
    ...
    if(is_comparison)
    {
        ...
        distinct_rv = dnx_rollback_journal_distinct(unit, er_thread_id, DNXC_SW_STATE_COMPARISON_JOURNAL_HANDLE, &dnxc_sw_state_journal_entries_make_distinct);
        rollback_rv = dnx_rollback_journal_rollback(unit, er_thread_id, FALSE, DNXC_SW_STATE_COMPARISON_JOURNAL_HANDLE);
    ...
    {
        SHR_IF_ERR_EXIT(dnx_rollback_journal_rollback(unit, er_thread_id, only_head_rollback, DNXC_SW_STATE_ROLLBACK_JOURNAL_HANDLE));
    }
    ...
    uint8 is_comparison)
{
    ...
    if(is_comparison)
    {
        SHR_IF_ERR_EXIT(dnx_rollback_journal_clear(unit, er_thread_id, DNXC_SW_STATE_COMPARISON_JOURNAL_HANDLE));
    }
    else
    {
        SHR_IF_ERR_EXIT(dnx_rollback_journal_clear(unit, er_thread_id, DNXC_SW_STATE_ROLLBACK_JOURNAL_HANDLE));
    }
    ...
    uint8 is_comparison)
{
    ...
    SHR_IF_ERR_EXIT(dnxc_sw_state_journal_clear_internal(unit, er_thread_id, is_comparison));
    ...
    uint8 **ptr_location)
{
    ...
    DNXC_SWSTATE_JOURNAL_ACCESS_NOTIFY(unit, er_thread_id);

    DNXC_SWSTATE_JOURNAL_EXIT_IF_OFF(unit, er_thread_id, is_er, is_cmp);

    SHR_IF_ERR_EXIT(dnxc_sw_state_journal_log_free_internal(unit, er_thread_id, node_id, nof_elements, element_size, ptr_location, is_er, is_cmp));
    ...
    uint8 **ptr_location)
{
    ...
    SHR_IF_ERR_EXIT(dnxc_sw_state_journal_log_alloc_internal(unit, er_thread_id, node_id, ptr_location, is_er, is_cmp));
    ...
    uint8 *ptr)
{
    ...
    SHR_IF_ERR_EXIT(dnxc_sw_state_journal_log_memcpy_internal(unit, er_thread_id, node_id, size, ptr, is_er, is_cmp));
    ...
    SW_STATE_HASH_TABLE_KEY * const key)
{
    ...
    SHR_IF_ERR_EXIT(sw_state_hash_table_entry_lookup(unit, node_id, hash_table, key, data_section, &data_idx, &found));
    ...
    SW_STATE_HASH_TABLE_KEY * const key)
{
    ...
    if(!dnx_rollback_journal_is_on(unit, er_thread_id, DNXC_SW_STATE_COMPARISON_JOURNAL_HANDLE))
    {
        SHR_EXIT();
    }

    SHR_IF_ERR_EXIT(dnxc_sw_state_journal_log_htbl_internal(unit, er_thread_id, node_id, hash_table, key));
    ...
    sw_state_mutex_t *ptr_mtx)
{
    ...
    SHR_IF_ERR_EXIT(dnxc_sw_state_journal_mutex_create_internal(unit, er_thread_id, node_id, ptr_mtx, is_er, is_cmp));
    ...
    sw_state_mutex_t *ptr_mtx)
{
    ...
    SHR_IF_ERR_EXIT(dnxc_sw_state_journal_mutex_destroy_internal(unit, er_thread_id, node_id, ptr_mtx, is_er, is_cmp));
    ...
    uint32 usec)
{
    ...
    SHR_IF_ERR_EXIT(dnxc_sw_state_journal_mutex_take_internal(unit, er_thread_id, node_id, ptr_mtx, usec, is_er, is_cmp));
    ...
    sw_state_sem_t *ptr_sem)
{
    ...
    SHR_IF_ERR_EXIT(dnxc_sw_state_journal_sem_create_internal(unit, er_thread_id, node_id, ptr_sem, is_er, is_cmp));
    ...
    int initial_count)
{
    ...
    SHR_IF_ERR_EXIT(dnxc_sw_state_journal_sem_destroy_internal(unit, er_thread_id, node_id, ptr_sem, is_binary, initial_count ,is_er, is_cmp));
    ...
    uint32 usec)
{
    ...
    SHR_IF_ERR_EXIT(dnxc_sw_state_journal_sem_take_internal(unit, er_thread_id, node_id, ptr_sem, usec, is_er, is_cmp));
    ...
    sw_state_mutex_t *ptr_mtx)
{
    ...
    SHR_IF_ERR_EXIT(dnxc_sw_state_journal_mutex_give_internal(unit, er_thread_id, node_id, ptr_mtx, is_er, is_cmp));
    ...
    sw_state_sem_t *ptr_sem)
{
    ...
    SHR_IF_ERR_EXIT(dnxc_sw_state_journal_sem_give_internal(unit, er_thread_id, node_id, ptr_sem, is_er, is_cmp));
    ...
    uint32 *seq_id)
{
    ...
    if(is_comparison)
    {
        SHR_IF_ERR_EXIT(dnx_rollback_journal_get_head_seq_id(unit, er_thread_id, seq_id, DNXC_SW_STATE_COMPARISON_JOURNAL_HANDLE));
    }
    else
    {
        SHR_IF_ERR_EXIT(dnx_rollback_journal_get_head_seq_id(unit, er_thread_id, seq_id, DNXC_SW_STATE_ROLLBACK_JOURNAL_HANDLE));
    }
    ...
    va_list args)
{
    ...
    if(dnx_rollback_journal_is_on(unit, er_thread_id, DNXC_SW_STATE_COMPARISON_JOURNAL_HANDLE))
    {
        SHR_IF_ERR_EXIT(dnx_rollback_journal_entries_stamp(unit, er_thread_id, DNXC_SW_STATE_COMPARISON_JOURNAL_HANDLE, str_to_print));
    }

    if(dnx_rollback_journal_is_on(unit, er_thread_id, DNXC_SW_STATE_ROLLBACK_JOURNAL_HANDLE))
    {
        SHR_IF_ERR_EXIT(dnx_rollback_journal_entries_stamp(unit, er_thread_id, DNXC_SW_STATE_ROLLBACK_JOURNAL_HANDLE, str_to_print));
    }
    ...
    va_list args)
{
    ...
    SHR_IF_ERR_EXIT(dnxc_sw_state_journal_entries_stamp_internal(unit, er_thread_id, format, args));
    ...
    int unit)
{
    ...
    return dnx_rollback_journal_is_on(unit, er_thread_id, DNXC_SW_STATE_COMPARISON_JOURNAL_HANDLE)
        || dnx_rollback_journal_is_on(unit, er_thread_id, DNXC_SW_STATE_ROLLBACK_JOURNAL_HANDLE);
#else
    return dnx_rollback_journal_is_on(unit, er_thread_id, DNXC_SW_STATE_COMPARISON_JOURNAL_HANDLE);
#endif
}
    ...
    uint8 is_disable)
{
    ...
    SHR_IF_ERR_EXIT(dnx_rollback_journal_disabled_counter_change(unit, er_thread_id, is_disable, DNXC_SW_STATE_ROLLBACK_JOURNAL_HANDLE, TRUE));
    SHR_IF_ERR_EXIT(dnx_rollback_journal_disabled_counter_change(unit, er_thread_id, is_disable, DNXC_SW_STATE_COMPARISON_JOURNAL_HANDLE, TRUE));
    ...
    uint8 is_disable)
{
    ...
    SHR_IF_ERR_EXIT(dnx_rollback_journal_disabled_counter_change(unit, er_thread_id, is_disable, DNXC_SW_STATE_COMPARISON_JOURNAL_HANDLE, FALSE));
    ...
    uint8 is_comparison)
{
    ...
    sal_strncpy_s(DNXC_SW_STATE_COMPARISON_JOURNAL_TRANSACTION.excluded_stamps[DNXC_SW_STATE_COMPARISON_JOURNAL_TRANSACTION.excluded_stamps_count], stamp, DNXC_SW_STATE_JOURNAL_MAX_STAMP_LENGTH);
    ...
    uint8 is_comparison)
{
    ...
    for(int stamp_idx = 0; stamp_idx < DNXC_SW_STATE_COMPARISON_JOURNAL_TRANSACTION.excluded_stamps_count; stamp_idx++)
    {
        sal_memset(DNXC_SW_STATE_COMPARISON_JOURNAL_TRANSACTION.excluded_stamps[stamp_idx], 0, DNXC_SW_STATE_JOURNAL_MAX_STAMP_LENGTH);
    }
