...
__cprimod__dispatch__t__ cprimod_cprif_driver = {
    ...
    cprif_tx_framer_tgen_enable_set,
    cprif_tx_framer_tgen_enable_get,
    ...
    cprif_header_compare_entry_for_flow_get,
    ...
    cprif_rsvd4_tx_control_flow_group_member_get,
    cprif_rsvd4_tx_control_flow_group_member_get_all,
    ...
    cprif_rsvd4_tx_single_tunnel_message_config_get,
    ...
    cprif_rsvd4_fast_eth_config_get,
    ...
    cprif_cpri_port_clock_disable_set,
    cprif_cpri_init,
