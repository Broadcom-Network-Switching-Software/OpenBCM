...
#define pemladrv_calloc(ARG, ARG2, ARG3) 	  sal_calloc(ARG, ARG2, ARG3)
...
void dnx_pemladrv_set_valid_bit_to_zero(const int unit, const int core_id, const int virtual_row_index, LogicalTcamInfo* tcam_info);
...
int pemladrv_lpm_remove_by_index (const int unit, const int core_id, table_id_t table_id, int index);
