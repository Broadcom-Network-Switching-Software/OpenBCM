    ...
    table_db_access_params_struct_t * access_params)
{
    ...
    else
    {
        ...
        if (DBAL_DEVICE_STATE_UNDER_DEVELOPMENT != dnx_data_dbal.db_init.dbal_device_state_get(unit))
        {
            SHR_IF_ERR_EXIT(dbal_hl_access_regmem_validate
                            (unit, table_id, access_params->reg_mem_hw_entity_id, is_reg));
        }
        else
        {
            SHR_IF_ERR_EXIT_NO_MSG(dbal_hl_access_regmem_validate
                                   (unit, table_id, access_params->reg_mem_hw_entity_id, is_reg));
        }
                 ...
                 jj++)
            {
                ...
                switch (hl_access_type)
                {
                    ...
                    case DBAL_HL_ACCESS_REGISTER:
                        ...
                        {
                            SHR_IF_ERR_EXIT_NO_MSG(dbal_db_init_table_hl_direct_register_post_process(unit,
                                                                                            table,
                                                                                            curr_l2p_field,
                                                                                            result_type_set,
                                                                                            field_in_table, res_type));
