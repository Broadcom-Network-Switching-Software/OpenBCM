...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    DBAL_INIT_FIELD_TYPES_ENUMS_CLEAR(cur_field_type_param);
    {
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___DUMMY5, "GENERAL___DUMMY5");
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___DUMMY21, "GENERAL___DUMMY21");
        DBAL_INIT_FIELD_TYPES_ENUM_INVALID_SET(cur_field_type_param, DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___DUMMY21, !(dnx_data_headers.system_headers.system_headers_mode_get(unit)));
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___DUMMY22, "GENERAL___DUMMY22");
        DBAL_INIT_FIELD_TYPES_ENUM_INVALID_SET(cur_field_type_param, DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___DUMMY22, !(dnx_data_headers.system_headers.system_headers_mode_get(unit)));
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___DUMMY12, "GENERAL___DUMMY12");
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___DUMMY4, "GENERAL___DUMMY4");
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___DUMMY24, "GENERAL___DUMMY24");
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___DUMMY26, "GENERAL___DUMMY26");
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___DUMMY23, "GENERAL___DUMMY23");
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___DUMMY25, "GENERAL___DUMMY25");
    ...
    if (DBAL_IS_J2C_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___DUMMY5].value_from_mapping = 2;
            ...
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___DUMMY21].value_from_mapping = 14;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___DUMMY22].value_from_mapping = 15;
            ...
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___1588].value_from_mapping = 23;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___OAM].value_from_mapping = 24;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___DUMMY12].value_from_mapping = 25;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___IPT_TAIL].value_from_mapping = 26;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___DUMMY4].value_from_mapping = 27;
            ...
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___NOP_CTX].value_from_mapping = 32;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___INGRESS_TRAPPED_OAMP].value_from_mapping = 33;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___CPU_PORT].value_from_mapping = 34;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___MIRROR_OR_SS].value_from_mapping = 35;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___DM_CPU_PORT].value_from_mapping = 36;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___TWAMP_TX].value_from_mapping = 37;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_MPLS___TRANSIT_CCM_SD].value_from_mapping = 38;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_MPLS___TRANSIT_CCM_SD_1_ADDITIONAL_LABEL].value_from_mapping = 39;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_MPLS___TRANSIT_CCM_SD_2_ADDITIONAL_LABELS].value_from_mapping = 40;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_MPLS___TRANSIT_CCM_SD_3_ADDITIONAL_LABELS].value_from_mapping = 41;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_MPLS___PHP].value_from_mapping = 42;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_MPLS___PHP_1588].value_from_mapping = 43;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___SFLOW_SEQUENCE_RESET].value_from_mapping = 44;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_REFLECTORS___TWAMPOIPV4_1ST_PASS].value_from_mapping = 45;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_REFLECTORS___TWAMPOIPV6_1ST_PASS].value_from_mapping = 46;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_REFLECTORS___TWAMP_2ND_PASS].value_from_mapping = 47;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_REFLECTORS___L2_OAM_TERM].value_from_mapping = 48;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_REFLECTORS___IP_UDP_SWAP].value_from_mapping = 49;
            ...
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_REFLECTORS___IPV6_UDP_SWAP].value_from_mapping = 52;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_REFLECTORS___UDP_SWAP].value_from_mapping = 53;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_REFLECTORS___SEAMLESS_BFD].value_from_mapping = 54;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_SRV6___SEGMENT_ENDPOINT].value_from_mapping = 55;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_SRV6___PSP].value_from_mapping = 56;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_TM___TX_INJECT].value_from_mapping = 58;
            ...
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_SRV6___T_OR_B_INSERT_EXTENDED_PASS].value_from_mapping = 57;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___DUMMY24].value_from_mapping = 12;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___DUMMY26].value_from_mapping = 13;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___DUMMY23].value_from_mapping = 16;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___DUMMY25].value_from_mapping = 20;
    ...
    else if (DBAL_IS_JR2_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___DUMMY24].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___DUMMY26].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___DUMMY23].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___DUMMY25].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___IOAM_JP].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_GENERAL___1588_HEADER_SIZE_COMPENSATION].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_TERM_CONTEXT_ID_SRV6___SEGMENT_ENDPOINT_HBH_PT_MIDPOINT].is_invalid_value_from_mapping = TRUE;
        }
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    DBAL_INIT_FIELD_TYPES_ENUMS_CLEAR(cur_field_type_param);
    {
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___DUMMY21, "GENERAL___DUMMY21");
        DBAL_INIT_FIELD_TYPES_ENUM_INVALID_SET(cur_field_type_param, DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___DUMMY21, !(dnx_data_headers.system_headers.system_headers_mode_get(unit)));
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___DUMMY22, "GENERAL___DUMMY22");
        DBAL_INIT_FIELD_TYPES_ENUM_INVALID_SET(cur_field_type_param, DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___DUMMY22, !(dnx_data_headers.system_headers.system_headers_mode_get(unit)));
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___DUMMY24, "GENERAL___DUMMY24");
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___DUMMY26, "GENERAL___DUMMY26");
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___DUMMY23, "GENERAL___DUMMY23");
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___DUMMY25, "GENERAL___DUMMY25");
    ...
    if (DBAL_IS_J2C_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___DUMMY21].value_from_mapping = 14;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___DUMMY22].value_from_mapping = 15;
            ...
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_IPV4___ETPP_FORWARDING_WO_ETPS_POP].value_from_mapping = 32;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_IPV4___ETPP_FORWARDING_WO_ETPS_POP_REMARK_TOS_P1].value_from_mapping = 33;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_IPV6___ETPP_FORWARDING_WO_ETPS_POP].value_from_mapping = 35;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_IPV6___ETPP_FORWARDING_WO_ETPS_POP_REMARK_TOS_P1].value_from_mapping = 36;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_IPV6___ETPP_FORWARDING_HBH_PT_MIDPOINT].value_from_mapping = 37;
            ...
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_REFLECTORS___L2_SWAP].value_from_mapping = 43;
            ...
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_REFLECTORS___IPV4_SWAP].value_from_mapping = 52;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_REFLECTORS___SEAMLESS_BFD_OVER_MPLS].value_from_mapping = 53;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_REFLECTORS___TWAMP_IPV4].value_from_mapping = 54;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_REFLECTORS___TWAMP_IPV6].value_from_mapping = 55;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_SRV6___SRV6_SEGMENT_ENDPOINT].value_from_mapping = 62;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_SRV6___SRV6_SEGMENT_ENDPOINT_PSP].value_from_mapping = 63;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_IPV4___NAT_EDITING].value_from_mapping = 17;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_IPV4___BFD_IPV4_EXTRA_SIP].value_from_mapping = 34;
            ...
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_SRV6___T_INSERT_NO_SIDS_SRV6_ENPOINT_PSP].value_from_mapping = 60;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_SRV6___T_OR_B_INSERT_EXTENDED_PASS].value_from_mapping = 61;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___DUMMY24].value_from_mapping = 12;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___DUMMY26].value_from_mapping = 13;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___DUMMY23].value_from_mapping = 16;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___DUMMY25].value_from_mapping = 20;
    ...
    else if (DBAL_IS_JR2_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___DUMMY24].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___DUMMY26].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___DUMMY23].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___DUMMY25].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___IOAM_JP].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_BRIDGE___ETPP_FORWARDING_SVTAG].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_GENERAL___NOP_ADD_SVTAG].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_FWD_CONTEXT_ID_SRV6___SRV6_SEGMENT_ENDPOINT_HBH_PT_MIDPOINT].is_invalid_value_from_mapping = TRUE;
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    DBAL_INIT_FIELD_TYPES_ENUMS_CLEAR(cur_field_type_param);
    {
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_BIER___DUMMY6, "BIER___DUMMY6");
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_BIER___DUMMY7, "BIER___DUMMY7");
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_GENERAL___DUMMY21, "GENERAL___DUMMY21");
        DBAL_INIT_FIELD_TYPES_ENUM_INVALID_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_GENERAL___DUMMY21, !(dnx_data_headers.system_headers.system_headers_mode_get(unit)));
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_GENERAL___DUMMY22, "GENERAL___DUMMY22");
        DBAL_INIT_FIELD_TYPES_ENUM_INVALID_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_GENERAL___DUMMY22, !(dnx_data_headers.system_headers.system_headers_mode_get(unit)));
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_MPLS___DUMMY3, "MPLS___DUMMY3");
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_MPLS___DUMMY4, "MPLS___DUMMY4");
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_MPLS___DUMMY1, "MPLS___DUMMY1");
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_MPLS___DUMMY2, "MPLS___DUMMY2");
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_TELEMETRY___DUMMY18, "TELEMETRY___DUMMY18");
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_GENERAL___DUMMY24, "GENERAL___DUMMY24");
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_GENERAL___DUMMY25, "GENERAL___DUMMY25");
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_GENERAL___DUMMY23, "GENERAL___DUMMY23");
    ...
    if (DBAL_IS_J2C_A0 || DBAL_IS_Q2A_A0 || DBAL_IS_Q2A_B0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_BIER___DUMMY6].value_from_mapping = 3;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_BIER___DUMMY7].value_from_mapping = 4;
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_GENERAL___DUMMY21].value_from_mapping = 14;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_GENERAL___DUMMY22].value_from_mapping = 15;
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_MPLS___MPLS_RFC8321_IN_AH].value_from_mapping = 32;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_MPLS___DUMMY3].value_from_mapping = 34;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_MPLS___MPLS_1PLUSX].value_from_mapping = 35;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_MPLS___DUMMY4].value_from_mapping = 36;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_MPLS___DUMMY1].value_from_mapping = 37;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_MPLS___PUSH_TWO_MPLS_LABELS_FROM_UDH].value_from_mapping = 38;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_MPLS___MPLS_2PLUSX].value_from_mapping = 39;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_MPLS___DUMMY2].value_from_mapping = 40;
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_TELEMETRY___DUMMY18].value_from_mapping = 62;
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_GENERAL___DUMMY24].value_from_mapping = 12;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_GENERAL___DUMMY25].value_from_mapping = 13;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_GENERAL___DUMMY23].value_from_mapping = 16;
    ...
    else if (DBAL_IS_JR2_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_GENERAL___DUMMY24].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_GENERAL___DUMMY25].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_GENERAL___DUMMY23].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_BRIDGE___ETH_COMPATIBLE_MC_BASIC_SVTAG].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_BRIDGE___ARP_AC_ETH_SVTAG].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_ENCAP_1_CONTEXT_ID_BRIDGE___ARP_PLUS_AC_ETH_SVTAG].is_invalid_value_from_mapping = TRUE;
        }
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    DBAL_INIT_FIELD_TYPES_ENUMS_CLEAR(cur_field_type_param);
    {
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_BIER___DUMMY8, "BIER___DUMMY8");
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_BIER___DUMMY9, "BIER___DUMMY9");
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_GENERAL___DUMMY21, "GENERAL___DUMMY21");
        DBAL_INIT_FIELD_TYPES_ENUM_INVALID_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_GENERAL___DUMMY21, !(dnx_data_headers.system_headers.system_headers_mode_get(unit)));
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_GENERAL___DUMMY22, "GENERAL___DUMMY22");
        DBAL_INIT_FIELD_TYPES_ENUM_INVALID_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_GENERAL___DUMMY22, !(dnx_data_headers.system_headers.system_headers_mode_get(unit)));
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_MPLS___DUMMY1, "MPLS___DUMMY1");
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_MPLS___DUMMY2, "MPLS___DUMMY2");
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_MPLS___DUMMY3, "MPLS___DUMMY3");
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_GENERAL___DUMMY23, "GENERAL___DUMMY23");
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_GENERAL___DUMMY24, "GENERAL___DUMMY24");
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_GENERAL___DUMMY25, "GENERAL___DUMMY25");
    ...
    if (DBAL_IS_J2C_A0 || DBAL_IS_Q2A_A0 || DBAL_IS_Q2A_B0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_BIER___DUMMY8].value_from_mapping = 3;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_BIER___DUMMY9].value_from_mapping = 4;
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_GENERAL___DUMMY21].value_from_mapping = 14;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_GENERAL___DUMMY22].value_from_mapping = 15;
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_MPLS___DUMMY1].value_from_mapping = 31;
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_MPLS___DUMMY2].value_from_mapping = 35;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_MPLS___MPLS_2PLUS2].value_from_mapping = 36;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_MPLS___DUMMY3].value_from_mapping = 37;
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_SRV6___ENCAP_1_SEGMENT].value_from_mapping = 44;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_SRV6___ENCAP_0_SEGMENTS].value_from_mapping = 45;
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_SRV6___ENCAP_T_INSERT_2_SEGMENTS].value_from_mapping = 46;
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_GENERAL___DUMMY23].value_from_mapping = 12;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_GENERAL___DUMMY24].value_from_mapping = 13;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_GENERAL___DUMMY25].value_from_mapping = 16;
    ...
    else if (DBAL_IS_JR2_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_GENERAL___DUMMY23].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_GENERAL___DUMMY24].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_GENERAL___DUMMY25].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_IPV4___TUNNEL_COPY_INNER].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_ENCAP_2_CONTEXT_ID_IPV4___IPV4_DOUBLE_UDP_VXLAN].is_invalid_value_from_mapping = TRUE;
        }
    }
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    DBAL_INIT_FIELD_TYPES_ENUMS_CLEAR(cur_field_type_param);
    {
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_BIER___DUMMY10, "BIER___DUMMY10");
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_BIER___DUMMY11, "BIER___DUMMY11");
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_GENERAL___DUMMY21, "GENERAL___DUMMY21");
        DBAL_INIT_FIELD_TYPES_ENUM_INVALID_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_GENERAL___DUMMY21, !(dnx_data_headers.system_headers.system_headers_mode_get(unit)));
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_GENERAL___DUMMY22, "GENERAL___DUMMY22");
        DBAL_INIT_FIELD_TYPES_ENUM_INVALID_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_GENERAL___DUMMY22, !(dnx_data_headers.system_headers.system_headers_mode_get(unit)));
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_MPLS___DUMMY1, "MPLS___DUMMY1");
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_MPLS___DUMMY2, "MPLS___DUMMY2");
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_GENERAL___DUMMY24, "GENERAL___DUMMY24");
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_GENERAL___DUMMY25, "GENERAL___DUMMY25");
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_GENERAL___DUMMY23, "GENERAL___DUMMY23");
    ...
    if (DBAL_IS_J2C_A0 || DBAL_IS_Q2A_A0 || DBAL_IS_Q2A_B0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_BIER___DUMMY10].value_from_mapping = 3;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_BIER___DUMMY11].value_from_mapping = 4;
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_GENERAL___DUMMY21].value_from_mapping = 14;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_GENERAL___DUMMY22].value_from_mapping = 15;
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_MPLS___MPLS_1PLUS1].value_from_mapping = 33;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_MPLS___MPLS_1PLUS2].value_from_mapping = 34;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_MPLS___MPLS_2PLUS1].value_from_mapping = 35;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_MPLS___DUMMY1].value_from_mapping = 36;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_MPLS___MPLS_2PLUS2].value_from_mapping = 37;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_MPLS___DUMMY2].value_from_mapping = 38;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___TWO_SEGMENTS].value_from_mapping = 39;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___ONE_SEGMENT].value_from_mapping = 40;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___ZERO_SEGMENTS].value_from_mapping = 41;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___SRH_AND_2_SEGMENTS].value_from_mapping = 42;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___SRH_AND_1_SEGMENT].value_from_mapping = 43;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___SRH_AND_0_SEGMENT].value_from_mapping = 44;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV4___KEEP_ORIGINAL_ETH].value_from_mapping = 17;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___T_INSERT_SRH_AND_2_SEGMENTS].value_from_mapping = 45;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_SRV6___T_INSERT_SRH_AND_1_SEGMENT].value_from_mapping = 46;
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_GENERAL___DUMMY24].value_from_mapping = 12;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_GENERAL___DUMMY25].value_from_mapping = 13;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_GENERAL___DUMMY23].value_from_mapping = 16;
    ...
    else if (DBAL_IS_JR2_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_MPLS___2_MPLS_1_AH].value_from_mapping = 13;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_GENERAL___DUMMY21].value_from_mapping = 14;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_GENERAL___DUMMY22].value_from_mapping = 15;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_GENERAL___IPT_IFA2_0_INGRESS].value_from_mapping = 16;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_MPLS___2_MPLS_2_AH].value_from_mapping = 16;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_MPLS___2_MPLS_3_AH].value_from_mapping = 17;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV4___IPV4_VXLAN_ECN].value_from_mapping = 18;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV4___IPV4_GRE_WO_TNI].value_from_mapping = 20;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV4___IPV4_UDP].value_from_mapping = 21;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV4___IPV4_GRE8_GRE12_GENEVE].value_from_mapping = 22;
            ...
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_GENERAL___DUMMY24].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_GENERAL___DUMMY25].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_GENERAL___DUMMY23].is_invalid_value_from_mapping = TRUE;
            enum_info[DBAL_ENUM_FVAL_ENCAP_3_CONTEXT_ID_IPV4___IPV4_DOUBLE_UDP_VXLAN].is_invalid_value_from_mapping = TRUE;
        }
    }
    else if (DBAL_IS_JR2_B0)
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    DBAL_INIT_FIELD_TYPES_ENUMS_CLEAR(cur_field_type_param);
    {
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_GENERAL___DUMMY14, "GENERAL___DUMMY14");
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_GENERAL___DUMMY20, "GENERAL___DUMMY20");
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_GENERAL___DUMMY22, "GENERAL___DUMMY22");
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_GENERAL___DUMMY21, "GENERAL___DUMMY21");
        ...
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_OAM___DUMMY17, "OAM___DUMMY17");
    ...
    if (DBAL_IS_J2C_A0 || DBAL_IS_Q2A_A0 || DBAL_IS_Q2A_B0 || DBAL_IS_J2X_A0)
    {
        dbal_init_field_type_default_restrict_values(cur_field_type_param);
        {
            ...
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_GENERAL___DUMMY14].value_from_mapping = 2;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_GENERAL___DUMMY20].value_from_mapping = 3;
            ...
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_GENERAL___DUMMY22].value_from_mapping = 7;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_GENERAL___PTCH1_FROM_FTMH_SSPA].value_from_mapping = 8;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_GENERAL___DUMMY21].value_from_mapping = 9;
            ...
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_GENERAL___IPT_IFA_FIRST_DP].value_from_mapping = 21;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_TM___JR1_COMP_MACT_LEARNING_JR2_TO_JR1].value_from_mapping = 21;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_GENERAL___RCH_VRF_REDIRECT].value_from_mapping = 22;
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_GENERAL___DM_CPU_PORT_TRAPPED].value_from_mapping = 23;
            ...
            enum_info[DBAL_ENUM_FVAL_TRAP_CONTEXT_ID_OAM___DUMMY17].value_from_mapping = 36;
