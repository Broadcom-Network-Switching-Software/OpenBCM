...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_NIF_PRIORITY, key_value__nif_priority);
    *offset = key_value__nif_priority*9;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_NIF_PRIORITY, key_value__nif_priority);
    *offset = (key_value__nif_priority*1)+72;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_NIF_PRIORITY, key_value__nif_priority);
    *offset = (key_value__nif_priority*1)+80;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_NIF_PRIORITY, key_value__nif_priority);
    *offset = (key_value__nif_priority*dnx_data_egr_queuing.params.nof_bits_in_q_pair_get(unit))+16;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_NIF_PRIORITY, key_value__nif_priority);
    *offset = key_value__nif_priority*1;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_NIF_PRIORITY, key_value__nif_priority);
    *offset = (key_value__nif_priority*1)+8;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_NIF_PRIORITY, key_value__nif_priority);
    *offset = key_value__nif_priority*10;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_NIF_PRIORITY, key_value__nif_priority);
    *offset = (key_value__nif_priority*1)+88;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
{
    dbal_entry_handle_t *  eh = (dbal_entry_handle_t *) entry_handle;
    uint32 key_value__egr_queue;
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_EGR_QUEUE, key_value__egr_queue);
    *offset = key_value__egr_queue;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_EGR_QUEUE, key_value__egr_queue);
    *offset = key_value__egr_queue-dnx_data_egr_queuing.params.nof_q_pairs_get(unit)/2;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
{
    dbal_entry_handle_t *  eh = (dbal_entry_handle_t *) entry_handle;
    uint32 key_value__channel_addr;
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_CHANNEL_ADDR, key_value__channel_addr);
    *offset = key_value__channel_addr;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    uint32 key_value__ilkn_core_id;
    uint32 key_value__ilkn_port_id;
    uint32 key_value__is_tdm;
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_ILKN_CORE_ID, key_value__ilkn_core_id);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_ILKN_PORT_ID, key_value__ilkn_port_id);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_IS_TDM, key_value__is_tdm);
    *offset = (key_value__ilkn_core_id*dnx_data_nif.ilkn.ilkn_unit_if_nof_get(unit))+key_value__ilkn_port_id*2+!key_value__is_tdm;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
