...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_INTERFACE_PROFILE, key_value__interface_profile);
    *offset = key_value__interface_profile;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
{
    dbal_entry_handle_t *  eh = (dbal_entry_handle_t *) entry_handle;
    uint32 key_value__egq_if_wo_flexe;
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_EGQ_IF_WO_FLEXE, key_value__egq_if_wo_flexe);
    *offset = key_value__egq_if_wo_flexe*3;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
...
uint32 * offset)
{
    ...
    SHR_FUNC_INIT_VARS(unit);
    DBAL_FORMULA_CB_GET_KEY_VALUE(unit, eh, DBAL_FIELD_EGQ_IF_WO_FLEXE, key_value__egq_if_wo_flexe);
    *offset = key_value__egq_if_wo_flexe;
    SHR_EXIT();
exit:
    SHR_FUNC_EXIT;
}
