...
shr_error_e
_dbal_init_field_types_auto_generated_profile_field_types_vtt_lif_service_type_temp_init(
int unit,
field_type_db_struct_t * cur_field_type_param,
dbal_field_types_basic_info_t ** field_types_info)
{
    dbal_field_types_basic_info_t * cur_field_types_info = field_types_info[DBAL_FIELD_TYPE_DEF_VTT_LIF_SERVICE_TYPE_TEMP];
    int is_valid = TRUE;
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_field_type_db_struct_clear(unit, cur_field_type_param);
    SHR_IF_ERR_EXIT(dbal_db_init_field_type_general_info_set(unit, cur_field_types_info, "VTT_LIF_SERVICE_TYPE_TEMP", 2, is_valid, FALSE, DBAL_FIELD_PRINT_TYPE_ENUM, 1, FALSE));
    cur_field_type_param->nof_enum_vals = DBAL_ENUM_FVAL_VTT_LIF_SERVICE_TYPE_TEMP_P2P + 1;
    DBAL_INIT_FIELD_TYPES_ENUMS_CLEAR(cur_field_type_param);
    {
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_VTT_LIF_SERVICE_TYPE_TEMP_EXTENDED_P2P_WITH_SOURCE_LOOKUP, "EXTENDED_P2P_WITH_SOURCE_LOOKUP");
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_VTT_LIF_SERVICE_TYPE_TEMP_P2MP, "P2MP");
        DBAL_INIT_FIELD_TYPES_ENUM_NAME_SET(cur_field_type_param, DBAL_ENUM_FVAL_VTT_LIF_SERVICE_TYPE_TEMP_P2P, "P2P");
    }
    dbal_init_field_type_default_restrict_values(cur_field_type_param);
    {
        dbal_db_enum_info_struct_t * enum_info = cur_field_type_param->enums;
        enum_info[DBAL_ENUM_FVAL_VTT_LIF_SERVICE_TYPE_TEMP_EXTENDED_P2P_WITH_SOURCE_LOOKUP].value_from_mapping = 2;
        enum_info[DBAL_ENUM_FVAL_VTT_LIF_SERVICE_TYPE_TEMP_P2MP].value_from_mapping = 0;
        enum_info[DBAL_ENUM_FVAL_VTT_LIF_SERVICE_TYPE_TEMP_P2P].value_from_mapping = 1;
    }
    SHR_IF_ERR_EXIT(dbal_db_init_field_type_add(unit, cur_field_type_param, cur_field_types_info));
exit:
    SHR_FUNC_EXIT;
...
dbal_field_types_basic_info_t ** field_types_info)
{
    ...
    SHR_IF_ERR_EXIT(_dbal_init_field_types_auto_generated_profile_field_types_vtt_lif_service_type_temp_init(unit, cur_field_type_param, field_types_info));
