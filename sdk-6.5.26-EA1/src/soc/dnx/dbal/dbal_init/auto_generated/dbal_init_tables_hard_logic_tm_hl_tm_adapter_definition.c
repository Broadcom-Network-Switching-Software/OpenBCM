...
shr_error_e
_dbal_init_tables_hard_logic_tm_hl_tm_adapter_definition_adapter_egq_if_port_map_init(
int unit,
table_db_struct_t * cur_table_param,
dbal_logical_table_t * table_info)
{
    dbal_logical_table_t * table_entry = table_info + DBAL_TABLE_ADAPTER_EGQ_IF_PORT_MAP;
    int is_valid = dnx_data_nif.ilkn.feature_get(unit, dnx_data_nif_ilkn_is_ilu_supported);
    SHR_FUNC_INIT_VARS(unit);
    dbal_init_table_db_struct_clear(cur_table_param);
    SHR_IF_ERR_EXIT(dbal_db_init_general_info_set(unit, table_entry, DBAL_TABLE_ADAPTER_EGQ_IF_PORT_MAP, is_valid, "ADAPTER_EGQ_IF_PORT_MAP", DBAL_ACCESS_METHOD_HARD_LOGIC));
    if (!is_valid)
    {
        SHR_EXIT();
    }
    ...
    }
    {
        ...
        DBAL_DB_INIT_TABLE_INTERFACE_RESULT_FIELDS_ALLOC(table_entry, table_entry->multi_res_info[result_type_counter]);
        {
            ...
            SHR_IF_ERR_EXIT(dbal_db_init_table_field_set_mandatory_values(unit, DBAL_FIELD_FIRST_PHY, DBAL_FIELD_TYPE_DEF_UINT, dbal_db_field));
            dbal_db_init_table_field_params_init(&db_field);
    ...
    dbal_db_init_table_db_struct_access_clear(cur_table_param, table_entry);
    {
        ...
        SHR_IF_ERR_EXIT(dbal_db_init_table_set_table_incompatible_image_sw_state_indication(unit, DBAL_TABLE_ADAPTER_EGQ_IF_PORT_MAP, is_standard_1, is_compatible_with_all_images));
    }
        ...
        {
            {
                table_db_access_params_struct_t * access_params;
                {
                    ...
                    access_counter++;
                    access_params->access_field_id = DBAL_FIELD_FIRST_PHY;
                    access_params->access_type = DBAL_HL_ACCESS_MEMORY;
                    {
                        SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ECI_RESERVED_48m, ITEM_0_31f));
        ...
        {
            {
                table_db_access_params_struct_t * access_params;
                {
                    ...
                    access_params->access_type = DBAL_HL_ACCESS_MEMORY;
                    {
                        SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, SCH_RESERVED_35m, ITEM_0_8f));
                        access_params->entry_offset.formula_cb = adapter_egq_if_port_map_first_phy_entryoffset_0_cb;
                    }
                }
            }
    ...
    SHR_IF_ERR_EXIT(dbal_db_init_table_add(unit, cur_table_param, DBAL_TABLE_ADAPTER_EGQ_IF_PORT_MAP, table_info));
exit:
    SHR_FUNC_EXIT;
}

shr_error_e
dbal_init_tables_hard_logic_tm_hl_tm_adapter_definition_init(
int unit,
table_db_struct_t * cur_table_param,
dbal_logical_table_t * table_info)
{
    SHR_FUNC_INIT_VARS(unit);
    SHR_IF_ERR_EXIT(_dbal_init_tables_hard_logic_tm_hl_tm_adapter_definition_adapter_egq_if_port_map_init(unit, cur_table_param, table_info));
exit:
    SHR_FUNC_EXIT;
}
