    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_counter++;
                access_params->access_field_id = DBAL_FIELD_UDH_MAP_TYPE_TO_LENGTH;
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HL_ACCESS_HW_ENTITY_INVALID, UDH_MAP_TYPE_TO_LENGHT_0f));
            ...
            }
            {
                ...
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HL_ACCESS_HW_ENTITY_INVALID, UDH_MAP_TYPE_TO_LENGHT_1f));
                    DBAL_DB_INIT_ACCESS_PARAMS_GROUP_SET(access_params, DBAL_HW_ENTITY_GROUP_INGRESS_ITPP_GENERAL_CFG);
                    access_params->data_offset.formula_cb = system_header_global_cfg_udh_udh_map_type_to_length_dataoffset_0_cb;
                }
            }
            {
                ...
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HL_ACCESS_HW_ENTITY_INVALID, UDH_MAP_TYPE_TO_LENGHT_2f));
                    DBAL_DB_INIT_ACCESS_PARAMS_GROUP_SET(access_params, DBAL_HW_ENTITY_GROUP_INGRESS_ITPP_GENERAL_CFG);
                    access_params->data_offset.formula_cb = system_header_global_cfg_udh_udh_map_type_to_length_dataoffset_0_cb;
                }
            }
            {
                ...
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HL_ACCESS_HW_ENTITY_INVALID, UDH_MAP_TYPE_TO_LENGHT_3f));
                    DBAL_DB_INIT_ACCESS_PARAMS_GROUP_SET(access_params, DBAL_HW_ENTITY_GROUP_INGRESS_ITPP_GENERAL_CFG);
                    access_params->data_offset.formula_cb = system_header_global_cfg_udh_udh_map_type_to_length_dataoffset_0_cb;
                }
            }
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPD_UDH_TYPE_TO_SIZE_MAPr, UDH_TYPE_TO_SIZE_MAPf));
                    access_params->data_offset.formula_cb = system_header_global_cfg_udh_udh_map_type_to_length_dataoffset_0_cb;
                }
            }
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, OAMP_HEADER_CONFIGr, UDH_MAP_TYPE_TO_LENGTH_0f));
                    access_params->data_offset.formula_cb = system_header_global_cfg_udh_udh_map_type_to_length_dataoffset_0_cb;
                }
            }
            {
                ...
                access_params->inst_idx = 1;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, OAMP_HEADER_CONFIGr, UDH_MAP_TYPE_TO_LENGTH_1f));
                    access_params->data_offset.formula_cb = system_header_global_cfg_udh_udh_map_type_to_length_dataoffset_0_cb;
                }
            }
            {
                ...
                access_params->inst_idx = 2;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, OAMP_HEADER_CONFIGr, UDH_MAP_TYPE_TO_LENGTH_2f));
                    access_params->data_offset.formula_cb = system_header_global_cfg_udh_udh_map_type_to_length_dataoffset_0_cb;
                }
            }
            {
                ...
                access_params->inst_idx = 3;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, OAMP_HEADER_CONFIGr, UDH_MAP_TYPE_TO_LENGTH_3f));
                    access_params->data_offset.formula_cb = system_header_global_cfg_udh_udh_map_type_to_length_dataoffset_0_cb;
                }
            }
        }
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                dbal_db_init_table_db_struct_hl_access_params_clear(access_params);
                access_counter++;
                access_params->access_field_id = DBAL_FIELD_FTMH_LB_KEY_EXT_SIZE;
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HL_ACCESS_HW_ENTITY_INVALID, FTMH_LB_KEY_EXT_ENf));
        ...
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                dbal_db_init_table_db_struct_hl_access_params_clear(access_params);
                access_counter++;
                access_params->access_field_id = DBAL_FIELD_FTMH_STACKING_EXT_SIZE;
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HL_ACCESS_HW_ENTITY_INVALID, FTMH_STACKING_EXT_ENABLEf));
                    DBAL_DB_INIT_ACCESS_PARAMS_GROUP_SET(access_params, DBAL_HW_ENTITY_GROUP_ECI_FAP_GLOBAL_SYS_HEADER_CFG);
                }
            }
        }
        ...
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                dbal_db_init_table_db_struct_hl_access_params_clear(access_params);
                access_counter++;
                access_params->access_field_id = DBAL_FIELD_USER_HEADER_ENABLE;
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HL_ACCESS_HW_ENTITY_INVALID, USER_HEADER_ENABLEf));
                    DBAL_DB_INIT_ACCESS_PARAMS_GROUP_SET(access_params, DBAL_HW_ENTITY_GROUP_ECI_FAP_GLOBAL_SYS_HEADER_CFG);
                }
            }
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                dbal_db_init_table_db_struct_hl_access_params_clear(access_params);
                access_counter++;
                access_params->access_field_id = DBAL_FIELD_PPH_BASE_SIZE;
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HL_ACCESS_HW_ENTITY_INVALID, PPH_BASE_SIZEf));
                    DBAL_DB_INIT_ACCESS_PARAMS_GROUP_SET(access_params, DBAL_HW_ENTITY_GROUP_INGRESS_ITPP_GENERAL_CFG);
                }
            }
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, OAMP_HEADER_CONFIGr, PPH_BASE_SIZEf));
                }
            }
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                dbal_db_init_table_db_struct_hl_access_params_clear(access_params);
                access_counter++;
                access_params->access_field_id = DBAL_FIELD_OUT_LIF_EXT_SIZE;
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HL_ACCESS_HW_ENTITY_INVALID, OUT_LIF_X_1_EXT_SIZEf));
                    DBAL_DB_INIT_ACCESS_PARAMS_GROUP_SET(access_params, DBAL_HW_ENTITY_GROUP_INGRESS_ITPP_GENERAL_CFG);
                }
            }
            {
                ...
                access_params->inst_idx = 1;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HL_ACCESS_HW_ENTITY_INVALID, OUT_LIF_X_2_EXT_SIZEf));
                    DBAL_DB_INIT_ACCESS_PARAMS_GROUP_SET(access_params, DBAL_HW_ENTITY_GROUP_INGRESS_ITPP_GENERAL_CFG);
                }
            }
            {
                ...
                access_params->inst_idx = 2;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HL_ACCESS_HW_ENTITY_INVALID, OUT_LIF_X_3_EXT_SIZEf));
                    DBAL_DB_INIT_ACCESS_PARAMS_GROUP_SET(access_params, DBAL_HW_ENTITY_GROUP_INGRESS_ITPP_GENERAL_CFG);
                }
            }
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, OAMP_HEADER_CONFIGr, OUT_LIF_X_1_EXT_SIZEf));
                }
            }
            {
                access_params = &cur_table_param->hl_access[map_idx].access[access_counter];
                ...
                access_params->inst_idx = 1;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, OAMP_HEADER_CONFIGr, OUT_LIF_X_2_EXT_SIZEf));
                }
            }
            {
                access_params = &cur_table_param->hl_access[map_idx].access[access_counter];
                ...
                access_params->inst_idx = 2;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, OAMP_HEADER_CONFIGr, OUT_LIF_X_3_EXT_SIZEf));
                }
            }
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                dbal_db_init_table_db_struct_hl_access_params_clear(access_params);
                access_counter++;
                access_params->access_field_id = DBAL_FIELD_IN_LIF_EXT_SIZE;
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HL_ACCESS_HW_ENTITY_INVALID, IN_LIF_EXT_SIZEf));
                    DBAL_DB_INIT_ACCESS_PARAMS_GROUP_SET(access_params, DBAL_HW_ENTITY_GROUP_INGRESS_ITPP_GENERAL_CFG);
                }
            }
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, OAMP_HEADER_CONFIGr, IN_LIF_EXT_SIZEf));
                }
            }
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                dbal_db_init_table_db_struct_hl_access_params_clear(access_params);
                access_counter++;
                access_params->access_field_id = DBAL_FIELD_MAC_IN_MAC_VSI;
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ECI_FAP_GLOBAL_PP_8r, MAC_IN_MAC_VSIf));
                }
            }
        }
        ...
        {
            {
                table_db_access_params_struct_t * access_params;
                {
                    ...
                    dbal_db_init_table_db_struct_hl_access_params_clear(access_params);
                    access_counter++;
                    access_params->access_field_id = DBAL_FIELD_JR_NETWORK_OFFSET;
                    access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                    {
                        SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HL_ACCESS_HW_ENTITY_INVALID, NETWORK_OFFSETf));
                ...
                }
                {
                    ...
                    access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                    {
                        SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, ETPPB_NETWORK_OFFSETr, NETWORK_OFFSETf));
                    }
                }
            }
        }
        ...
        {
            {
                table_db_access_params_struct_t * access_params;
                {
                    ...
                    access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                    {
                        SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HL_ACCESS_HW_ENTITY_INVALID, J_MODE_NETWORK_OFFSETf));
                        DBAL_DB_INIT_ACCESS_PARAMS_GROUP_SET(access_params, DBAL_HW_ENTITY_GROUP_EGRESS_JERICHO_COMPATIBLE_REGISTERS);
                    }
                }
                {
        ...
        }
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                dbal_db_init_table_db_struct_hl_access_params_clear(access_params);
                access_counter++;
                access_params->access_field_id = DBAL_FIELD_JR_NETWORK_OFFSET_FOR_SYSTEM_HEADERS;
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, DBAL_HL_ACCESS_HW_ENTITY_INVALID, J_MODE_NETWORK_OFFSET_FOR_SYSTEM_HEADERSf));
                    DBAL_DB_INIT_ACCESS_PARAMS_GROUP_SET(access_params, DBAL_HW_ENTITY_GROUP_EGRESS_JERICHO_COMPATIBLE_REGISTERS);
                }
            }
        }
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                dbal_db_init_table_db_struct_hl_access_params_clear(access_params);
                access_counter++;
                access_params->access_field_id = DBAL_FIELD_JR_FWD_CODE;
                access_params->access_type = DBAL_HL_ACCESS_MEMORY;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPD_FORWARDING_TYPE_TO_CODEm, CODEf));
                }
            }
        }
        cur_table_param->hl_access[map_idx].nof_access = access_counter;
        ...
        {
            {
                table_db_access_params_struct_t * access_params;
                {
                    ...
                    dbal_db_init_table_db_struct_hl_access_params_clear(access_params);
                    access_counter++;
                    access_params->access_field_id = DBAL_FIELD_JR_VSI_SRC;
                    access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                    {
                        SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPD_PPH_VSI_SOURCEr, DBAL_HL_ACCESS_HW_FIELD_INVALID));
        ...
        {
            {
                table_db_access_params_struct_t * access_params;
                {
                    ...
                    dbal_db_init_table_db_struct_hl_access_params_clear(access_params);
                    access_counter++;
                    access_params->access_field_id = DBAL_FIELD_JR_IN_LIF_SRC;
                    access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                    {
                        SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPD_PPH_VSI_SOURCEr, DBAL_HL_ACCESS_HW_FIELD_INVALID));
    ...
    dbal_db_init_table_add_result_type_physical_values_by_result_type_index(table_entry);
    {
        ...
        sal_strncpy(cur_table_param->hl_access[map_idx].mapping_result_name, EMPTY, sizeof(cur_table_param->hl_access[map_idx].mapping_result_name));
        {
            table_db_access_params_struct_t * access_params;
            {
                ...
                access_params->access_type = DBAL_HL_ACCESS_REGISTER;
                {
                    SHR_IF_ERR_EXIT(dbal_db_init_table_set_access_register_memory(unit, access_params, IPPD_PPH_FHEI_FWD_SIZEr, DBAL_HL_ACCESS_HW_FIELD_INVALID));
