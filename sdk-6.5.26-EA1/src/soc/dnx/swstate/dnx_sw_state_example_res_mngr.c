    ...
    int unit)
{
    ...
    if (dnx_data_infra_tests.res_mngr_example.extra_arg_get(unit))
    {
        ...
        extra_create_info.grain_size[0] = dnx_data_infra_tests.res_mngr_example.grain_size_1_get(unit);
        extra_create_info.grain_size[1] = dnx_data_infra_tests.res_mngr_example.grain_size_2_get(unit);
        extra_create_info.max_tag_value[0] = dnx_data_infra_tests.res_mngr_example.max_tag_value_1_get(unit);
        extra_create_info.max_tag_value[1] = dnx_data_infra_tests.res_mngr_example.max_tag_value_2_get(unit);
