...
dnx_time_sw_state_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_time_sw_state[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_time_sw_state[idx].first_child_index = 1;
    layout_array_dnx_time_sw_state[idx].last_child_index = 6;
    layout_array_dnx_time_sw_state[idx].next_node_index = 1;
    ...
    layout_array_dnx_time_sw_state[idx].next_node_index = 2;
    ...
    layout_array_dnx_time_sw_state[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_time_sw_state[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_time_sw_state[idx].next_node_index = 3;
    ...
    layout_array_dnx_time_sw_state[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_time_sw_state[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_time_sw_state[idx].next_node_index = 4;
    ...
    layout_array_dnx_time_sw_state[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_time_sw_state[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_time_sw_state[idx].next_node_index = 5;
    ...
    layout_array_dnx_time_sw_state[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_time_sw_state[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_time_sw_state[idx].next_node_index = 6;
    ...
    layout_array_dnx_time_sw_state[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_time_sw_state[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_time_sw_state[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
