...
mdb_init_layout_structure(int unit)
{
    ...
    layout_array_mdb[idx].first_child_index = 1;
    layout_array_mdb[idx].last_child_index = 15;
    layout_array_mdb[idx].next_node_index = 1;
    ...
    layout_array_mdb[idx].array_indexes[0].size = DBAL_NOF_PHYSICAL_TABLES;
    layout_array_mdb[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_mdb[idx].parent  = 0;
    layout_array_mdb[idx].first_child_index = 16;
    layout_array_mdb[idx].last_child_index = 22;
    layout_array_mdb[idx].next_node_index = 2;
    ...
    layout_array_mdb[idx].array_indexes[0].size = MDB_NOF_PHYSICAL_TABLES;
    layout_array_mdb[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_mdb[idx].parent  = 0;
    layout_array_mdb[idx].first_child_index = 28;
    layout_array_mdb[idx].last_child_index = 32;
    layout_array_mdb[idx].next_node_index = 3;
    ...
    layout_array_mdb[idx].next_node_index = 4;
    ...
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 5;
    ...
    layout_array_mdb[idx].array_indexes[0].size = DBAL_NOF_PHYSICAL_TABLES;
    layout_array_mdb[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_mdb[idx].array_indexes[1].size = DNX_DATA_MAX_MDB_EM_NOF_ENCODING_TYPES;
    layout_array_mdb[idx].array_indexes[1].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_mdb[idx].parent  = 0;
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 6;
    ...
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 7;
    ...
    layout_array_mdb[idx].array_indexes[0].size = DBAL_NOF_ENUM_MDB_EEDB_PHASE_VALUES;
    layout_array_mdb[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_mdb[idx].parent  = 0;
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 8;
    ...
    layout_array_mdb[idx].parent  = 0;
    layout_array_mdb[idx].first_child_index = 39;
    layout_array_mdb[idx].last_child_index = 46;
    layout_array_mdb[idx].next_node_index = 9;
    ...
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 10;
    ...
    layout_array_mdb[idx].parent  = 0;
    layout_array_mdb[idx].first_child_index = 50;
    layout_array_mdb[idx].last_child_index = 51;
    layout_array_mdb[idx].next_node_index = 11;
    ...
    layout_array_mdb[idx].parent  = 0;
    layout_array_mdb[idx].first_child_index = 52;
    layout_array_mdb[idx].last_child_index = 54;
    layout_array_mdb[idx].next_node_index = 12;
    ...
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 13;
    ...
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 14;
    ...
    layout_array_mdb[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].size_of = sizeof(uint32);
    layout_array_mdb[idx].array_indexes[0].size = 2;
    layout_array_mdb[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_mdb[idx].parent  = 0;
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 15;
    ...
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_mdb[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].size_of = sizeof(uint8);
    layout_array_mdb[idx].array_indexes[0].size = DNX_DATA_MAX_MDB_EM_MAX_NOF_TIDS;
    layout_array_mdb[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_mdb[idx].parent  = 1;
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 17;
    ...
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 18;
    ...
    layout_array_mdb[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].size_of = sizeof(uint32);
    layout_array_mdb[idx].array_indexes[0].size = MDB_EM_MAX_KEYS_PLUS_TID_VALS_SIZE;
    layout_array_mdb[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_mdb[idx].parent  = 1;
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 19;
    ...
    layout_array_mdb[idx].array_indexes[0].size = DNX_DATA_MAX_MDB_PDBS_MAX_NOF_INTERFACE_DHS;
    layout_array_mdb[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_mdb[idx].parent  = 1;
    layout_array_mdb[idx].first_child_index = 23;
    layout_array_mdb[idx].last_child_index = 27;
    layout_array_mdb[idx].next_node_index = 20;
    ...
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 21;
    ...
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 22;
    ...
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 24;
    ...
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 25;
    ...
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 26;
    ...
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 27;
    ...
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 29;
    ...
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 30;
    ...
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 31;
    ...
    layout_array_mdb[idx].array_indexes[0].size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC;
    layout_array_mdb[idx].parent  = 2;
    layout_array_mdb[idx].first_child_index = 33;
    layout_array_mdb[idx].last_child_index = 38;
    layout_array_mdb[idx].next_node_index = 32;
    layout_array_mdb[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
    ...
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 34;
    ...
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 35;
    ...
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 36;
    ...
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 37;
    ...
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 38;
    ...
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 40;
    ...
    layout_array_mdb[idx].array_indexes[0].size = MDB_NOF_MACRO_TYPES;
    layout_array_mdb[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_mdb[idx].array_indexes[1].size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].array_indexes[1].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC;
    layout_array_mdb[idx].parent  = 8;
    layout_array_mdb[idx].first_child_index = 47;
    layout_array_mdb[idx].last_child_index = 48;
    layout_array_mdb[idx].next_node_index = 41;
    ...
    layout_array_mdb[idx].array_indexes[1].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC;
    layout_array_mdb[idx].parent  = 8;
    layout_array_mdb[idx].first_child_index = 49;
    layout_array_mdb[idx].last_child_index = 49;
    layout_array_mdb[idx].next_node_index = 42;
    ...
    layout_array_mdb[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].size_of = sizeof(uint32*);
    layout_array_mdb[idx].array_indexes[0].size = DNX_DATA_MAX_MDB_EEDB_NOF_EEDB_BANKS;
    layout_array_mdb[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_mdb[idx].array_indexes[1].size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 43;
    ...
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 44;
    ...
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 45;
    ...
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 46;
    ...
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 48;
    ...
    layout_array_mdb[idx].array_indexes[0].size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC;
    layout_array_mdb[idx].array_indexes[1].size = DNX_DATA_MAX_MDB_DH_CLUSTER_ROW_WIDTH_UINT32;
    layout_array_mdb[idx].array_indexes[1].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    ...
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 51;
    ...
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 53;
    ...
    layout_array_mdb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb[idx].next_node_index = 54;
