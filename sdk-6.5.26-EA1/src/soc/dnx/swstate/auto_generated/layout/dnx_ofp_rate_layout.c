...
dnx_ofp_rate_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_ofp_rate[idx].doc = "DB for used by algo port rate";
    layout_array_dnx_ofp_rate[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_ofp_rate[idx].first_child_index = 1;
    layout_array_dnx_ofp_rate[idx].last_child_index = 6;
    layout_array_dnx_ofp_rate[idx].next_node_index = 1;
    ...
    layout_array_dnx_ofp_rate[idx].doc = "[core][OTM index], data about OTM port";
    layout_array_dnx_ofp_rate[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_ofp_rate[idx].size_of = sizeof(dnx_ofp_rate_db_otm_t*);
    layout_array_dnx_ofp_rate[idx].array_indexes[0].size = DNX_DATA_MAX_DEVICE_GENERAL_NOF_CORES;
    layout_array_dnx_ofp_rate[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_ofp_rate[idx].array_indexes[1].size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_ofp_rate[idx].first_child_index = 7;
    layout_array_dnx_ofp_rate[idx].last_child_index = 8;
    layout_array_dnx_ofp_rate[idx].next_node_index = 2;
    ...
    layout_array_dnx_ofp_rate[idx].doc = "[core][qpare index], data about qpair shaping parameters";
    layout_array_dnx_ofp_rate[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_ofp_rate[idx].size_of = sizeof(dnx_ofp_rate_db_qpair_shaping_t);
    layout_array_dnx_ofp_rate[idx].array_indexes[0].size = DNX_DATA_MAX_DEVICE_GENERAL_NOF_CORES;
    layout_array_dnx_ofp_rate[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_ofp_rate[idx].array_indexes[1].size = DNX_DATA_MAX_EGR_QUEUING_PARAMS_NOF_Q_PAIRS;
    layout_array_dnx_ofp_rate[idx].array_indexes[1].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_ofp_rate[idx].parent  = 0;
    layout_array_dnx_ofp_rate[idx].first_child_index = 12;
    layout_array_dnx_ofp_rate[idx].last_child_index = 13;
    layout_array_dnx_ofp_rate[idx].next_node_index = 3;
    ...
    layout_array_dnx_ofp_rate[idx].doc = "[core][PS index][TCG index], data about TCG shaping parameters";
    layout_array_dnx_ofp_rate[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_ofp_rate[idx].size_of = sizeof(dnx_ofp_rate_db_tcg_shaping_t);
    layout_array_dnx_ofp_rate[idx].array_indexes[0].size = DNX_DATA_MAX_DEVICE_GENERAL_NOF_CORES;
    layout_array_dnx_ofp_rate[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_ofp_rate[idx].array_indexes[1].size = DNX_DATA_MAX_EGR_QUEUING_PARAMS_NOF_PORT_SCHEDULERS;
    layout_array_dnx_ofp_rate[idx].array_indexes[1].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_ofp_rate[idx].array_indexes[2].size = DNX_DATA_MAX_EGR_QUEUING_PARAMS_NOF_TCG;
    layout_array_dnx_ofp_rate[idx].array_indexes[2].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_ofp_rate[idx].parent  = 0;
    layout_array_dnx_ofp_rate[idx].first_child_index = 14;
    layout_array_dnx_ofp_rate[idx].last_child_index = 15;
    layout_array_dnx_ofp_rate[idx].next_node_index = 4;
    ...
    layout_array_dnx_ofp_rate[idx].doc = "[core][calendar index], info about calendar parameters";
    layout_array_dnx_ofp_rate[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_ofp_rate[idx].size_of = sizeof(dnx_ofp_rate_db_cal_t);
    layout_array_dnx_ofp_rate[idx].array_indexes[0].size = DNX_DATA_MAX_DEVICE_GENERAL_NOF_CORES;
    layout_array_dnx_ofp_rate[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_ofp_rate[idx].array_indexes[1].size = DNX_DATA_MAX_EGR_QUEUING_PARAMS_NOF_CALENDARS;
    layout_array_dnx_ofp_rate[idx].array_indexes[1].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_ofp_rate[idx].parent  = 0;
    layout_array_dnx_ofp_rate[idx].first_child_index = 16;
    layout_array_dnx_ofp_rate[idx].last_child_index = 18;
    layout_array_dnx_ofp_rate[idx].next_node_index = 5;
    ...
    layout_array_dnx_ofp_rate[idx].doc = "[core] Boolean, calcal is modified";
    layout_array_dnx_ofp_rate[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_ofp_rate[idx].next_node_index = 6;
    ...
    layout_array_dnx_ofp_rate[idx].type = "uint32";
    layout_array_dnx_ofp_rate[idx].doc = "[core] calcal length value";
    layout_array_dnx_ofp_rate[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_ofp_rate[idx].size_of = sizeof(uint32);
    layout_array_dnx_ofp_rate[idx].array_indexes[0].size = DNX_DATA_MAX_DEVICE_GENERAL_NOF_CORES;
    layout_array_dnx_ofp_rate[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    ...
    layout_array_dnx_ofp_rate[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_ofp_rate[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_ofp_rate[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_ofp_rate[idx].type = "uint32";
    layout_array_dnx_ofp_rate[idx].doc = "otm calendar instance number";
    layout_array_dnx_ofp_rate[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_ofp_rate[idx].size_of = sizeof(uint32);
    layout_array_dnx_ofp_rate[idx].parent  = 1;
    layout_array_dnx_ofp_rate[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_ofp_rate[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_ofp_rate[idx].next_node_index = 8;
    ...
    layout_array_dnx_ofp_rate[idx].doc = "info about shaping parameters";
    layout_array_dnx_ofp_rate[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_ofp_rate[idx].size_of = sizeof(dnx_ofp_rate_db_otm_shaping_t);
    layout_array_dnx_ofp_rate[idx].parent  = 1;
    layout_array_dnx_ofp_rate[idx].first_child_index = 9;
    layout_array_dnx_ofp_rate[idx].last_child_index = 11;
    layout_array_dnx_ofp_rate[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_ofp_rate[idx].type = "uint32";
    layout_array_dnx_ofp_rate[idx].doc = "rate value";
    layout_array_dnx_ofp_rate[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_ofp_rate[idx].size_of = sizeof(uint32);
    layout_array_dnx_ofp_rate[idx].parent  = 8;
    layout_array_dnx_ofp_rate[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_ofp_rate[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_ofp_rate[idx].next_node_index = 10;
    ...
    layout_array_dnx_ofp_rate[idx].type = "uint32";
    layout_array_dnx_ofp_rate[idx].doc = "burst value";
    layout_array_dnx_ofp_rate[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_ofp_rate[idx].size_of = sizeof(uint32);
    layout_array_dnx_ofp_rate[idx].parent  = 8;
    layout_array_dnx_ofp_rate[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_ofp_rate[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_ofp_rate[idx].next_node_index = 11;
    ...
    layout_array_dnx_ofp_rate[idx].type = "uint32";
    layout_array_dnx_ofp_rate[idx].doc = "Boolean, is valid value";
    layout_array_dnx_ofp_rate[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_ofp_rate[idx].size_of = sizeof(uint32);
    layout_array_dnx_ofp_rate[idx].parent  = 8;
    layout_array_dnx_ofp_rate[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_ofp_rate[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_ofp_rate[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_ofp_rate[idx].next_node_index = 13;
    ...
    layout_array_dnx_ofp_rate[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_ofp_rate[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_ofp_rate[idx].next_node_index = 15;
    ...
    layout_array_dnx_ofp_rate[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_ofp_rate[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_ofp_rate[idx].next_node_index = 17;
    ...
    layout_array_dnx_ofp_rate[idx].type = "uint32";
    layout_array_dnx_ofp_rate[idx].doc = "Boolean, is modified";
    layout_array_dnx_ofp_rate[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_ofp_rate[idx].size_of = sizeof(uint32);
    layout_array_dnx_ofp_rate[idx].parent  = 4;
    layout_array_dnx_ofp_rate[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_ofp_rate[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_ofp_rate[idx].next_node_index = 18;
    ...
    layout_array_dnx_ofp_rate[idx].type = "uint32";
    layout_array_dnx_ofp_rate[idx].doc = "number of calcal instances";
    layout_array_dnx_ofp_rate[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_ofp_rate[idx].size_of = sizeof(uint32);
    layout_array_dnx_ofp_rate[idx].parent  = 4;
    layout_array_dnx_ofp_rate[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
