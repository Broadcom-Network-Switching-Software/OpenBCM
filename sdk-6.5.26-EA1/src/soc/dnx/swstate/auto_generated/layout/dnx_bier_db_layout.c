...
dnx_bier_db_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_bier_db[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_bier_db[idx].first_child_index = 1;
    layout_array_dnx_bier_db[idx].last_child_index = 3;
    layout_array_dnx_bier_db[idx].next_node_index = 1;
    ...
    layout_array_dnx_bier_db[idx].array_indexes[0].size = DNX_DATA_MAX_MULTICAST_PARAMS_NOF_MCDB_ENTRIES;
    ...
    layout_array_dnx_bier_db[idx].next_node_index = 2;
    ...
    layout_array_dnx_bier_db[idx].parent  = 0;
    layout_array_dnx_bier_db[idx].first_child_index = 4;
    layout_array_dnx_bier_db[idx].last_child_index = 4;
    layout_array_dnx_bier_db[idx].next_node_index = 3;
    ...
    layout_array_dnx_bier_db[idx].size_of = sizeof(bier_db_status_t);
    layout_array_dnx_bier_db[idx].parent  = 0;
    layout_array_dnx_bier_db[idx].first_child_index = 5;
    layout_array_dnx_bier_db[idx].last_child_index = 5;
    layout_array_dnx_bier_db[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
