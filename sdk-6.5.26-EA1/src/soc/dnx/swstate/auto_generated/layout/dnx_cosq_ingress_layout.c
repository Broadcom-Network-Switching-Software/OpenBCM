...
dnx_cosq_ingress_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_cosq_ingress[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_cosq_ingress[idx].first_child_index = 1;
    layout_array_dnx_cosq_ingress[idx].last_child_index = 1;
    layout_array_dnx_cosq_ingress[idx].next_node_index = 1;
    ...
    layout_array_dnx_cosq_ingress[idx].first_child_index = 2;
    layout_array_dnx_cosq_ingress[idx].last_child_index = 3;
    layout_array_dnx_cosq_ingress[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_cosq_ingress[idx].next_node_index = 3;
    ...
    layout_array_dnx_cosq_ingress[idx].array_indexes[0].size = DNX_DATA_MAX_DEVICE_GENERAL_NOF_CORES;
    layout_array_dnx_cosq_ingress[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_cosq_ingress[idx].array_indexes[1].size = ((DNX_DATA_MAX_EGR_QUEUING_PARAMS_NOF_EGR_INTERFACES)/SHR_BITWID)+1;
