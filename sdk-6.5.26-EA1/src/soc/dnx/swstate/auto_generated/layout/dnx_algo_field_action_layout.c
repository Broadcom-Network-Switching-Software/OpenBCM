...
dnx_algo_field_action_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_algo_field_action[idx].first_child_index = 1;
    layout_array_dnx_algo_field_action[idx].last_child_index = 4;
    layout_array_dnx_algo_field_action[idx].next_node_index = 1;
    ...
    layout_array_dnx_algo_field_action[idx].first_child_index = 5;
    layout_array_dnx_algo_field_action[idx].last_child_index = 6;
    layout_array_dnx_algo_field_action[idx].next_node_index = 2;
    ...
    layout_array_dnx_algo_field_action[idx].parent  = 0;
    layout_array_dnx_algo_field_action[idx].first_child_index = 11;
    layout_array_dnx_algo_field_action[idx].last_child_index = 12;
    layout_array_dnx_algo_field_action[idx].next_node_index = 3;
    layout_array_dnx_algo_field_action[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
    ...
    layout_array_dnx_algo_field_action[idx].parent  = 0;
    layout_array_dnx_algo_field_action[idx].first_child_index = 17;
    layout_array_dnx_algo_field_action[idx].last_child_index = 18;
    layout_array_dnx_algo_field_action[idx].next_node_index = 4;
    layout_array_dnx_algo_field_action[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
    ...
    layout_array_dnx_algo_field_action[idx].parent  = 0;
    layout_array_dnx_algo_field_action[idx].first_child_index = 23;
    layout_array_dnx_algo_field_action[idx].last_child_index = 23;
    layout_array_dnx_algo_field_action[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_field_action[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
    ...
    layout_array_dnx_algo_field_action[idx].array_indexes[0].size = DNX_DATA_MAX_FIELD_BASE_IPMF2_NOF_FES_INSTRUCTION_PER_CONTEXT;
    ...
    layout_array_dnx_algo_field_action[idx].first_child_index = 7;
    layout_array_dnx_algo_field_action[idx].last_child_index = 9;
    layout_array_dnx_algo_field_action[idx].next_node_index = 6;
    layout_array_dnx_algo_field_action[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
    ...
    layout_array_dnx_algo_field_action[idx].array_indexes[0].size = DNX_DATA_MAX_FIELD_BASE_IPMF2_NOF_CONTEXTS;
    layout_array_dnx_algo_field_action[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_algo_field_action[idx].parent  = 1;
    layout_array_dnx_algo_field_action[idx].first_child_index = 10;
    layout_array_dnx_algo_field_action[idx].last_child_index = 10;
    layout_array_dnx_algo_field_action[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_algo_field_action[idx].array_indexes[0].size = DNX_DATA_MAX_FIELD_COMMON_MAX_VAL_NOF_FES_PROGRAMS;
    layout_array_dnx_algo_field_action[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    ...
    layout_array_dnx_algo_field_action[idx].next_node_index = 8;
    ...
    layout_array_dnx_algo_field_action[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_field_action[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_field_action[idx].next_node_index = 9;
    ...
    layout_array_dnx_algo_field_action[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_field_action[idx].size_of = sizeof(uint8);
    layout_array_dnx_algo_field_action[idx].array_indexes[0].size = DNX_DATA_MAX_FIELD_COMMON_MAX_VAL_NOF_MASKS_PER_FES;
    layout_array_dnx_algo_field_action[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_algo_field_action[idx].parent  = 5;
    layout_array_dnx_algo_field_action[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_field_action[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_algo_field_action[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_field_action[idx].size_of = sizeof(dnx_algo_field_action_fes_state_t);
    layout_array_dnx_algo_field_action[idx].array_indexes[0].size = DNX_DATA_MAX_FIELD_BASE_IPMF3_NOF_FES_INSTRUCTION_PER_CONTEXT;
    layout_array_dnx_algo_field_action[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_algo_field_action[idx].parent  = 2;
    layout_array_dnx_algo_field_action[idx].first_child_index = 13;
    layout_array_dnx_algo_field_action[idx].last_child_index = 15;
    layout_array_dnx_algo_field_action[idx].next_node_index = 12;
    layout_array_dnx_algo_field_action[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
    ...
    layout_array_dnx_algo_field_action[idx].array_indexes[0].size = DNX_DATA_MAX_FIELD_BASE_IPMF3_NOF_CONTEXTS;
    layout_array_dnx_algo_field_action[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_algo_field_action[idx].parent  = 2;
    layout_array_dnx_algo_field_action[idx].first_child_index = 16;
    layout_array_dnx_algo_field_action[idx].last_child_index = 16;
    layout_array_dnx_algo_field_action[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_algo_field_action[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_field_action[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_field_action[idx].next_node_index = 14;
    ...
    layout_array_dnx_algo_field_action[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_field_action[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_field_action[idx].next_node_index = 15;
    ...
    layout_array_dnx_algo_field_action[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_field_action[idx].size_of = sizeof(dnx_algo_field_action_fes_state_t);
    layout_array_dnx_algo_field_action[idx].array_indexes[0].size = DNX_DATA_MAX_FIELD_BASE_EPMF_NOF_FES_INSTRUCTION_PER_CONTEXT;
    layout_array_dnx_algo_field_action[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_algo_field_action[idx].parent  = 3;
    layout_array_dnx_algo_field_action[idx].first_child_index = 19;
    layout_array_dnx_algo_field_action[idx].last_child_index = 21;
    layout_array_dnx_algo_field_action[idx].next_node_index = 18;
    layout_array_dnx_algo_field_action[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
    ...
    layout_array_dnx_algo_field_action[idx].array_indexes[0].size = DNX_DATA_MAX_FIELD_BASE_EPMF_NOF_CONTEXTS;
    layout_array_dnx_algo_field_action[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_algo_field_action[idx].parent  = 3;
    layout_array_dnx_algo_field_action[idx].first_child_index = 22;
    layout_array_dnx_algo_field_action[idx].last_child_index = 22;
    layout_array_dnx_algo_field_action[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_algo_field_action[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_field_action[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_field_action[idx].next_node_index = 20;
    ...
    layout_array_dnx_algo_field_action[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_field_action[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_field_action[idx].next_node_index = 21;
    ...
    layout_array_dnx_algo_field_action[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_field_action[idx].size_of = sizeof(uint8);
    layout_array_dnx_algo_field_action[idx].array_indexes[0].size = DNX_DATA_MAX_FIELD_COMMON_MAX_VAL_NOF_FEM_ID;
    layout_array_dnx_algo_field_action[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_algo_field_action[idx].array_indexes[1].size = DNX_DATA_MAX_FIELD_COMMON_MAX_VAL_NOF_FEM_PROGRAMS;
