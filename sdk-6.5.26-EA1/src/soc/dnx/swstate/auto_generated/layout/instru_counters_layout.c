...
instru_counters_init_layout_structure(int unit)
{
    ...
    layout_array_instru_counters[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_instru_counters[idx].first_child_index = 1;
    layout_array_instru_counters[idx].last_child_index = 2;
    layout_array_instru_counters[idx].next_node_index = 1;
    ...
    layout_array_instru_counters[idx].first_child_index = 3;
    layout_array_instru_counters[idx].last_child_index = 5;
    layout_array_instru_counters[idx].next_node_index = 2;
    ...
    layout_array_instru_counters[idx].parent  = 0;
    layout_array_instru_counters[idx].first_child_index = 7;
    layout_array_instru_counters[idx].last_child_index = 9;
    layout_array_instru_counters[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_instru_counters[idx].next_node_index = 4;
    ...
    layout_array_instru_counters[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_instru_counters[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_instru_counters[idx].next_node_index = 5;
    ...
    layout_array_instru_counters[idx].array_indexes[0].size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_instru_counters[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    layout_array_instru_counters[idx].parent  = 1;
    layout_array_instru_counters[idx].first_child_index = 6;
    layout_array_instru_counters[idx].last_child_index = 6;
    layout_array_instru_counters[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_instru_counters[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_instru_counters[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_instru_counters[idx].next_node_index = 8;
    ...
    layout_array_instru_counters[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_instru_counters[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_instru_counters[idx].next_node_index = 9;
    ...
    layout_array_instru_counters[idx].array_indexes[0].size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_instru_counters[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    layout_array_instru_counters[idx].array_indexes[1].size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_instru_counters[idx].array_indexes[1].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    layout_array_instru_counters[idx].parent  = 2;
    layout_array_instru_counters[idx].first_child_index = 10;
    layout_array_instru_counters[idx].last_child_index = 10;
    layout_array_instru_counters[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
