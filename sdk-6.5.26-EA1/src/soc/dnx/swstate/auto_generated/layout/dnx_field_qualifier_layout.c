...
dnx_field_qualifier_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_field_qualifier[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_field_qualifier[idx].first_child_index = 1;
    layout_array_dnx_field_qualifier[idx].last_child_index = 3;
    layout_array_dnx_field_qualifier[idx].next_node_index = 1;
    ...
    layout_array_dnx_field_qualifier[idx].array_indexes[0].size = DNX_DATA_MAX_FIELD_QUAL_USER_NOF;
    ...
    layout_array_dnx_field_qualifier[idx].first_child_index = 4;
    layout_array_dnx_field_qualifier[idx].last_child_index = 9;
    layout_array_dnx_field_qualifier[idx].next_node_index = 2;
    ...
    layout_array_dnx_field_qualifier[idx].array_indexes[0].size = DNX_DATA_MAX_FIELD_QUAL_PREDEFINED_NOF;
    layout_array_dnx_field_qualifier[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_field_qualifier[idx].parent  = 0;
    layout_array_dnx_field_qualifier[idx].first_child_index = 10;
    layout_array_dnx_field_qualifier[idx].last_child_index = 10;
    layout_array_dnx_field_qualifier[idx].next_node_index = 3;
    layout_array_dnx_field_qualifier[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
    ...
    layout_array_dnx_field_qualifier[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_qualifier[idx].size_of = sizeof(dnx_field_predefined_qual_info_t);
    layout_array_dnx_field_qualifier[idx].array_indexes[0].size = DNX_DATA_MAX_FIELD_QUAL_LAYER_RECORD_NOF;
    layout_array_dnx_field_qualifier[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_field_qualifier[idx].parent  = 0;
    layout_array_dnx_field_qualifier[idx].first_child_index = 11;
    layout_array_dnx_field_qualifier[idx].last_child_index = 11;
    layout_array_dnx_field_qualifier[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_qualifier[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
    ...
    layout_array_dnx_field_qualifier[idx].next_node_index = 5;
    ...
    layout_array_dnx_field_qualifier[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_qualifier[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_qualifier[idx].next_node_index = 6;
    ...
    layout_array_dnx_field_qualifier[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_qualifier[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_qualifier[idx].next_node_index = 7;
    ...
    layout_array_dnx_field_qualifier[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_qualifier[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_qualifier[idx].next_node_index = 8;
    ...
    layout_array_dnx_field_qualifier[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_qualifier[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_qualifier[idx].next_node_index = 9;
