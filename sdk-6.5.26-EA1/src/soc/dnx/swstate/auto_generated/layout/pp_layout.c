...
pp_init_layout_structure(int unit)
{
    ...
    layout_array_pp[idx].first_child_index = 1;
    layout_array_pp[idx].last_child_index = 1;
    layout_array_pp[idx].next_node_index = 1;
    ...
    layout_array_pp[idx].array_indexes[0].size = MAX_NOF_PP_KBR;
    layout_array_pp[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_pp[idx].array_indexes[1].size = MAX_NOF_KBR_SELCTORS;
    ...
    layout_array_pp[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
