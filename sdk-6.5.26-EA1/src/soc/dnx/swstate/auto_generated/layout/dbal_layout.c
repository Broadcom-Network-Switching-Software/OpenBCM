...
dbal_init_layout_structure(int unit)
{
    ...
    layout_array_dbal[idx].first_child_index = 1;
    layout_array_dbal[idx].last_child_index = 12;
    layout_array_dbal[idx].next_node_index = 1;
    ...
    layout_array_dbal[idx].array_indexes[0].size = DBAL_NOF_TABLES;
    layout_array_dbal[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dbal[idx].parent  = 0;
    layout_array_dbal[idx].first_child_index = 13;
    layout_array_dbal[idx].last_child_index = 15;
    layout_array_dbal[idx].next_node_index = 2;
    ...
    layout_array_dbal[idx].parent  = 0;
    layout_array_dbal[idx].first_child_index = 16;
    layout_array_dbal[idx].last_child_index = 16;
    layout_array_dbal[idx].next_node_index = 3;
    ...
    layout_array_dbal[idx].array_indexes[0].size = DBAL_NOF_PHYSICAL_TABLES;
    layout_array_dbal[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dbal[idx].parent  = 0;
    layout_array_dbal[idx].first_child_index = 17;
    layout_array_dbal[idx].last_child_index = 17;
    layout_array_dbal[idx].next_node_index = 4;
    ...
    layout_array_dbal[idx].array_indexes[0].size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    layout_array_dbal[idx].parent  = 0;
    layout_array_dbal[idx].first_child_index = 18;
    layout_array_dbal[idx].last_child_index = 24;
    layout_array_dbal[idx].next_node_index = 5;
    ...
    layout_array_dbal[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    layout_array_dbal[idx].parent  = 0;
    layout_array_dbal[idx].first_child_index = 26;
    layout_array_dbal[idx].last_child_index = 33;
    layout_array_dbal[idx].next_node_index = 6;
    ...
    layout_array_dbal[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    layout_array_dbal[idx].parent  = 0;
    layout_array_dbal[idx].first_child_index = 34;
    layout_array_dbal[idx].last_child_index = 41;
    layout_array_dbal[idx].next_node_index = 7;
    ...
    layout_array_dbal[idx].array_indexes[0].size = DBAL_NOF_DYNAMIC_FIELDS;
    layout_array_dbal[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dbal[idx].parent  = 0;
    layout_array_dbal[idx].first_child_index = 42;
    layout_array_dbal[idx].last_child_index = 44;
    layout_array_dbal[idx].next_node_index = 8;
    ...
    layout_array_dbal[idx].parent  = 0;
    layout_array_dbal[idx].first_child_index = 45;
    layout_array_dbal[idx].last_child_index = 46;
    layout_array_dbal[idx].next_node_index = 9;
    ...
    layout_array_dbal[idx].type = "sw_state_htbl_t";
    layout_array_dbal[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].size_of = sizeof(sw_state_htbl_t);
    layout_array_dbal[idx].parent  = 0;
    ...
    layout_array_dbal[idx].next_node_index = 10;
    ...
    layout_array_dbal[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].next_node_index = 11;
    ...
    layout_array_dbal[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].next_node_index = 12;
    ...
    layout_array_dbal[idx].array_indexes[0].size = DBAL_NOF_FIELD_NAME_OVERRIDE_INSTANCES;
    layout_array_dbal[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dbal[idx].parent  = 0;
    layout_array_dbal[idx].first_child_index = 49;
    layout_array_dbal[idx].last_child_index = 49;
    layout_array_dbal[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dbal[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].next_node_index = 14;
    ...
    layout_array_dbal[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].next_node_index = 15;
    layout_array_dbal[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_ALLOC_EXCEPTION;
    ...
    layout_array_dbal[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].next_node_index = 19;
    ...
    layout_array_dbal[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].next_node_index = 20;
    ...
    layout_array_dbal[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].next_node_index = 21;
    layout_array_dbal[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_COUNTER | DNXC_SW_STATE_LAYOUT_LABEL_DONT_DUMP ;
    ...
    layout_array_dbal[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].next_node_index = 22;
    layout_array_dbal[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_COUNTER;
    ...
    layout_array_dbal[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].next_node_index = 23;
    ...
    layout_array_dbal[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].next_node_index = 24;
    ...
    layout_array_dbal[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    layout_array_dbal[idx].parent  = 4;
    layout_array_dbal[idx].first_child_index = 25;
    layout_array_dbal[idx].last_child_index = 25;
    layout_array_dbal[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dbal[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].next_node_index = 27;
    ...
    layout_array_dbal[idx].array_indexes[0].size = DBAL_MAX_STRING_LENGTH;
    layout_array_dbal[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dbal[idx].parent  = 5;
    layout_array_dbal[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].next_node_index = 28;
    ...
    layout_array_dbal[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].next_node_index = 29;
    ...
    layout_array_dbal[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].next_node_index = 30;
    layout_array_dbal[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_ACCESS_PTR;
    ...
    layout_array_dbal[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].next_node_index = 31;
    layout_array_dbal[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_ACCESS_PTR;
    ...
    layout_array_dbal[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].next_node_index = 32;
    layout_array_dbal[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_ACCESS_PTR;
    ...
    layout_array_dbal[idx].array_indexes[0].size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    layout_array_dbal[idx].array_indexes[1].size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].array_indexes[1].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    layout_array_dbal[idx].parent  = 5;
    layout_array_dbal[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].next_node_index = 33;
    layout_array_dbal[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_ACCESS_PTR;
    ...
    layout_array_dbal[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].next_node_index = 35;
    ...
    layout_array_dbal[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].next_node_index = 36;
    layout_array_dbal[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_ACCESS_PTR;
    ...
    layout_array_dbal[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].next_node_index = 37;
    ...
    layout_array_dbal[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].next_node_index = 38;
    layout_array_dbal[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_ACCESS_PTR;
    ...
    layout_array_dbal[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].next_node_index = 39;
    layout_array_dbal[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_ACCESS_PTR;
    ...
    layout_array_dbal[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].next_node_index = 40;
    layout_array_dbal[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_ACCESS_PTR;
    ...
    layout_array_dbal[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].next_node_index = 41;
    layout_array_dbal[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_ACCESS_PTR;
    ...
    layout_array_dbal[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].next_node_index = 43;
    ...
    layout_array_dbal[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].next_node_index = 44;
    ...
    layout_array_dbal[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].next_node_index = 46;
    ...
    layout_array_dbal[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    layout_array_dbal[idx].parent  = 8;
    layout_array_dbal[idx].first_child_index = 47;
    layout_array_dbal[idx].last_child_index = 48;
    layout_array_dbal[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dbal[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dbal[idx].next_node_index = 48;
    layout_array_dbal[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_ACCESS_PTR;
