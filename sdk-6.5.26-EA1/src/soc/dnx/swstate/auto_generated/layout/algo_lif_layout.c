...
algo_lif_init_layout_structure(int unit)
{
    ...
    layout_array_algo_lif[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_algo_lif[idx].first_child_index = 1;
    layout_array_algo_lif[idx].last_child_index = 6;
    layout_array_algo_lif[idx].next_node_index = 1;
    ...
    layout_array_algo_lif[idx].next_node_index = 2;
    ...
    layout_array_algo_lif[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].next_node_index = 3;
    ...
    layout_array_algo_lif[idx].array_indexes[0].size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC;
    layout_array_algo_lif[idx].parent  = 0;
    layout_array_algo_lif[idx].first_child_index = 7;
    layout_array_algo_lif[idx].last_child_index = 12;
    layout_array_algo_lif[idx].next_node_index = 4;
    ...
    layout_array_algo_lif[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC;
    layout_array_algo_lif[idx].parent  = 0;
    layout_array_algo_lif[idx].first_child_index = 13;
    layout_array_algo_lif[idx].last_child_index = 21;
    layout_array_algo_lif[idx].next_node_index = 5;
    ...
    layout_array_algo_lif[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].next_node_index = 6;
    ...
    layout_array_algo_lif[idx].parent  = 0;
    layout_array_algo_lif[idx].first_child_index = 22;
    layout_array_algo_lif[idx].last_child_index = 24;
    layout_array_algo_lif[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_algo_lif[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].next_node_index = 8;
    ...
    layout_array_algo_lif[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].next_node_index = 9;
    ...
    layout_array_algo_lif[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].next_node_index = 10;
    ...
    layout_array_algo_lif[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].next_node_index = 11;
    ...
    layout_array_algo_lif[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].next_node_index = 12;
    ...
    layout_array_algo_lif[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].size_of = sizeof(uint8);
    layout_array_algo_lif[idx].array_indexes[0].size = MAX_EEDB_BANKS_PER_OUTLIF_BANK;
    ...
    layout_array_algo_lif[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].next_node_index = 14;
    ...
    layout_array_algo_lif[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].next_node_index = 15;
    ...
    layout_array_algo_lif[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].next_node_index = 16;
    ...
    layout_array_algo_lif[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].next_node_index = 17;
    ...
    layout_array_algo_lif[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].next_node_index = 18;
    ...
    layout_array_algo_lif[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].next_node_index = 19;
    ...
    layout_array_algo_lif[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].next_node_index = 20;
    ...
    layout_array_algo_lif[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].next_node_index = 21;
    ...
    layout_array_algo_lif[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].next_node_index = 23;
    ...
    layout_array_algo_lif[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_lif[idx].next_node_index = 24;
