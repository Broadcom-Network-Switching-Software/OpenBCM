...
dnx_field_tcam_hit_indication_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_field_tcam_hit_indication[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_field_tcam_hit_indication[idx].first_child_index = 1;
    layout_array_dnx_field_tcam_hit_indication[idx].last_child_index = 2;
    layout_array_dnx_field_tcam_hit_indication[idx].next_node_index = 1;
    ...
    layout_array_dnx_field_tcam_hit_indication[idx].array_indexes[0].size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_field_tcam_hit_indication[idx].first_child_index = 3;
    layout_array_dnx_field_tcam_hit_indication[idx].last_child_index = 3;
    layout_array_dnx_field_tcam_hit_indication[idx].next_node_index = 2;
    ...
    layout_array_dnx_field_tcam_hit_indication[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    layout_array_dnx_field_tcam_hit_indication[idx].parent  = 0;
    layout_array_dnx_field_tcam_hit_indication[idx].first_child_index = 4;
    layout_array_dnx_field_tcam_hit_indication[idx].last_child_index = 4;
    layout_array_dnx_field_tcam_hit_indication[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_field_tcam_hit_indication[idx].array_indexes[0].size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_tcam_hit_indication[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    layout_array_dnx_field_tcam_hit_indication[idx].array_indexes[1].size = DNXC_SW_STATE_LAYOUT_INVALID;
