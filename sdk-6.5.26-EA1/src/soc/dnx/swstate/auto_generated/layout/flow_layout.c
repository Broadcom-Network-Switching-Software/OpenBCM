...
flow_init_layout_structure(int unit)
{
    ...
    layout_array_flow[idx].doc = "sw state for the flow LIF";
    layout_array_flow[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_flow[idx].size_of = sizeof(flow_sw_state_t);
    layout_array_flow[idx].parent  = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_flow[idx].first_child_index = 1;
    layout_array_flow[idx].last_child_index = 3;
    layout_array_flow[idx].next_node_index = 1;
    ...
    layout_array_flow[idx].doc = "Flow applications common configuration";
    layout_array_flow[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_flow[idx].size_of = sizeof(dnx_flow_app_common_config_t*);
    layout_array_flow[idx].array_indexes[0].size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_flow[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC;
    layout_array_flow[idx].parent  = 0;
    layout_array_flow[idx].first_child_index = 4;
    layout_array_flow[idx].last_child_index = 5;
    layout_array_flow[idx].next_node_index = 2;
    ...
    layout_array_flow[idx].next_node_index = 3;
    ...
    layout_array_flow[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_flow[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_flow[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_flow[idx].doc = "Disable verification on application";
    layout_array_flow[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_flow[idx].size_of = sizeof(uint8);
    layout_array_flow[idx].parent  = 1;
    layout_array_flow[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_flow[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_flow[idx].next_node_index = 5;
    ...
    layout_array_flow[idx].type = "uint8";
    layout_array_flow[idx].doc = "Disable error recovery on application.";
    layout_array_flow[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_flow[idx].size_of = sizeof(uint8);
    layout_array_flow[idx].parent  = 1;
    layout_array_flow[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
