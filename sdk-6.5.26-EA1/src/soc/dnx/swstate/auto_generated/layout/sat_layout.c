...
sat_init_layout_structure(int unit)
{
    ...
    layout_array_sat[idx].first_child_index = 1;
    layout_array_sat[idx].last_child_index = 1;
    layout_array_sat[idx].next_node_index = 1;
    ...
    layout_array_sat[idx].array_indexes[0].size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_sat[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
