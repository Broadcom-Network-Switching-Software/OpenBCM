...
interrupt_init_layout_structure(int unit)
{
    ...
    layout_array_interrupt[idx].doc = "DB for interrupt";
    layout_array_interrupt[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_interrupt[idx].size_of = sizeof(soc_dnx_intr_t);
    layout_array_interrupt[idx].parent  = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_interrupt[idx].first_child_index = 1;
    layout_array_interrupt[idx].last_child_index = 4;
    layout_array_interrupt[idx].next_node_index = 1;
    ...
    layout_array_interrupt[idx].doc = "Interrupt flags";
    layout_array_interrupt[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_interrupt[idx].size_of = sizeof(uint32*);
    layout_array_interrupt[idx].array_indexes[0].size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_interrupt[idx].next_node_index = 2;
    ...
    layout_array_interrupt[idx].type = "uint32*";
    layout_array_interrupt[idx].doc = "Interrupt storm time count value";
    layout_array_interrupt[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_interrupt[idx].size_of = sizeof(uint32*);
    layout_array_interrupt[idx].array_indexes[0].size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_interrupt[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC;
    ...
    layout_array_interrupt[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_interrupt[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_interrupt[idx].next_node_index = 3;
    ...
    layout_array_interrupt[idx].type = "uint32*";
    layout_array_interrupt[idx].doc = "Interrupt time period value";
    layout_array_interrupt[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_interrupt[idx].size_of = sizeof(uint32*);
    layout_array_interrupt[idx].array_indexes[0].size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_interrupt[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC;
    ...
    layout_array_interrupt[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_interrupt[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_interrupt[idx].next_node_index = 4;
    ...
    layout_array_interrupt[idx].type = "uint32";
    layout_array_interrupt[idx].doc = "interrupt storm nominal";
    layout_array_interrupt[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_interrupt[idx].size_of = sizeof(uint32);
    layout_array_interrupt[idx].parent  = 0;
    layout_array_interrupt[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_interrupt[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_interrupt[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
