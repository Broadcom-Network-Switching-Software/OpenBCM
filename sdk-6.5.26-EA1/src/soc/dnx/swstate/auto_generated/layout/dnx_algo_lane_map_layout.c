...
dnx_algo_lane_map_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_algo_lane_map[idx].first_child_index = 1;
    layout_array_dnx_algo_lane_map[idx].last_child_index = 2;
    layout_array_dnx_algo_lane_map[idx].next_node_index = 1;
    ...
    layout_array_dnx_algo_lane_map[idx].array_indexes[0].size = DNX_ALGO_NOF_LANE_MAP_TYPES;
    ...
    layout_array_dnx_algo_lane_map[idx].first_child_index = 3;
    layout_array_dnx_algo_lane_map[idx].last_child_index = 5;
    layout_array_dnx_algo_lane_map[idx].next_node_index = 2;
    ...
    layout_array_dnx_algo_lane_map[idx].parent  = 0;
    layout_array_dnx_algo_lane_map[idx].first_child_index = 10;
    layout_array_dnx_algo_lane_map[idx].last_child_index = 11;
    layout_array_dnx_algo_lane_map[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_algo_lane_map[idx].next_node_index = 4;
    ...
    layout_array_dnx_algo_lane_map[idx].array_indexes[0].size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_lane_map[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC;
    layout_array_dnx_algo_lane_map[idx].parent  = 1;
    layout_array_dnx_algo_lane_map[idx].first_child_index = 6;
    layout_array_dnx_algo_lane_map[idx].last_child_index = 7;
    layout_array_dnx_algo_lane_map[idx].next_node_index = 5;
    ...
    layout_array_dnx_algo_lane_map[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC;
    layout_array_dnx_algo_lane_map[idx].parent  = 1;
    layout_array_dnx_algo_lane_map[idx].first_child_index = 8;
    layout_array_dnx_algo_lane_map[idx].last_child_index = 9;
    layout_array_dnx_algo_lane_map[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_lane_map[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
    ...
    layout_array_dnx_algo_lane_map[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_lane_map[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_lane_map[idx].next_node_index = 7;
    ...
    layout_array_dnx_algo_lane_map[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_lane_map[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_lane_map[idx].next_node_index = 9;
    ...
    layout_array_dnx_algo_lane_map[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_lane_map[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_lane_map[idx].next_node_index = 11;
    ...
    layout_array_dnx_algo_lane_map[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC;
    layout_array_dnx_algo_lane_map[idx].parent  = 2;
    layout_array_dnx_algo_lane_map[idx].first_child_index = 12;
    layout_array_dnx_algo_lane_map[idx].last_child_index = 13;
    layout_array_dnx_algo_lane_map[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_algo_lane_map[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_lane_map[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_lane_map[idx].next_node_index = 13;
