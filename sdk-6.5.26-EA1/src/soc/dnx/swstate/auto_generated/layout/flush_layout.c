...
flush_init_layout_structure(int unit)
{
    ...
    layout_array_flush[idx].doc = "Context data of the flush db";
    layout_array_flush[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_flush[idx].size_of = sizeof(flush_db_t);
    layout_array_flush[idx].parent  = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_flush[idx].first_child_index = 1;
    layout_array_flush[idx].last_child_index = 2;
    layout_array_flush[idx].next_node_index = 1;
    ...
    layout_array_flush[idx].doc = "Number of valid rules in the flush DB";
    layout_array_flush[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_flush[idx].next_node_index = 2;
    ...
    layout_array_flush[idx].doc = "If true flush mode is bulk; otherwise normal mode";
    layout_array_flush[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_flush[idx].size_of = sizeof(uint8);
    layout_array_flush[idx].parent  = 0;
    layout_array_flush[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_flush[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_flush[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
