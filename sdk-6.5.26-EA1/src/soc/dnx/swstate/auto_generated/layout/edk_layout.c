...
edk_init_layout_structure(int unit)
{
    ...
    layout_array_edk[idx].doc = "SW state of EDK";
    layout_array_edk[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_edk[idx].size_of = sizeof(edk_sw_state);
    layout_array_edk[idx].parent  = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_edk[idx].first_child_index = 1;
    layout_array_edk[idx].last_child_index = 1;
    layout_array_edk[idx].next_node_index = 1;
    ...
    layout_array_edk[idx].array_indexes[0].size = EDK_SEQ_MAX;
    layout_array_edk[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_edk[idx].array_indexes[1].size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_edk[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
