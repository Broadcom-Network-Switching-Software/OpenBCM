...
dnx_field_kbp_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_field_kbp[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_field_kbp[idx].first_child_index = 1;
    layout_array_dnx_field_kbp[idx].last_child_index = 1;
    layout_array_dnx_field_kbp[idx].next_node_index = 1;
    ...
    layout_array_dnx_field_kbp[idx].array_indexes[0].size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_field_kbp[idx].first_child_index = 2;
    layout_array_dnx_field_kbp[idx].last_child_index = 3;
    layout_array_dnx_field_kbp[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_field_kbp[idx].first_child_index = 4;
    layout_array_dnx_field_kbp[idx].last_child_index = 5;
    layout_array_dnx_field_kbp[idx].next_node_index = 3;
    layout_array_dnx_field_kbp[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
    ...
    layout_array_dnx_field_kbp[idx].array_indexes[0].size = DNX_FIELD_KBP_MAX_NOF_SEGMENTS_PER_MASTER_KEY;
    ...
    layout_array_dnx_field_kbp[idx].first_child_index = 6;
    layout_array_dnx_field_kbp[idx].last_child_index = 7;
    layout_array_dnx_field_kbp[idx].next_node_index = 5;
    layout_array_dnx_field_kbp[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
    ...
    layout_array_dnx_field_kbp[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_kbp[idx].size_of = sizeof(uint8);
    layout_array_dnx_field_kbp[idx].array_indexes[0].size = DNX_FIELD_KBP_NOF_QUALS_PER_SEGMENT;
    layout_array_dnx_field_kbp[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_field_kbp[idx].parent  = 4;
    layout_array_dnx_field_kbp[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_kbp[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_kbp[idx].next_node_index = 7;
