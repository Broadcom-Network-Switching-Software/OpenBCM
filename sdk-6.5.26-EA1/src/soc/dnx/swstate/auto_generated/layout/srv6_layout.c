...
srv6_init_layout_structure(int unit)
{
    ...
    layout_array_srv6[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_srv6[idx].size_of = sizeof(srv6_modes_struct);
    layout_array_srv6[idx].parent  = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_srv6[idx].first_child_index = 1;
    layout_array_srv6[idx].last_child_index = 3;
    layout_array_srv6[idx].next_node_index = 1;
    ...
    layout_array_srv6[idx].next_node_index = 2;
    ...
    layout_array_srv6[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_srv6[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_srv6[idx].next_node_index = 3;
    ...
    layout_array_srv6[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_srv6[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_srv6[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
