...
dnx_egr_db_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_egr_db[idx].first_child_index = 1;
    layout_array_dnx_egr_db[idx].last_child_index = 6;
    layout_array_dnx_egr_db[idx].next_node_index = 1;
    ...
    layout_array_dnx_egr_db[idx].first_child_index = 7;
    layout_array_dnx_egr_db[idx].last_child_index = 9;
    layout_array_dnx_egr_db[idx].next_node_index = 2;
    ...
    layout_array_dnx_egr_db[idx].array_indexes[0].size = DNX_DATA_MAX_DEVICE_GENERAL_NOF_CORES;
    layout_array_dnx_egr_db[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_egr_db[idx].array_indexes[1].size = DNX_DATA_MAX_EGR_QUEUING_PARAMS_NOF_EGR_INTERFACES;
    ...
    layout_array_dnx_egr_db[idx].next_node_index = 3;
    ...
    layout_array_dnx_egr_db[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_egr_db[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_egr_db[idx].next_node_index = 4;
    ...
    layout_array_dnx_egr_db[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_egr_db[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_egr_db[idx].next_node_index = 5;
    ...
    layout_array_dnx_egr_db[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_egr_db[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_egr_db[idx].next_node_index = 6;
    ...
    layout_array_dnx_egr_db[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_egr_db[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_egr_db[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_egr_db[idx].array_indexes[0].size = DNX_DATA_MAX_DEVICE_GENERAL_NOF_CORES;
    layout_array_dnx_egr_db[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_egr_db[idx].array_indexes[1].size = DNX_DATA_MAX_EGR_QUEUING_PARAMS_NOF_PORT_SCHEDULERS;
    layout_array_dnx_egr_db[idx].array_indexes[1].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_egr_db[idx].parent  = 1;
    layout_array_dnx_egr_db[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_egr_db[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_egr_db[idx].next_node_index = 8;
    ...
    layout_array_dnx_egr_db[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_egr_db[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_egr_db[idx].next_node_index = 9;
