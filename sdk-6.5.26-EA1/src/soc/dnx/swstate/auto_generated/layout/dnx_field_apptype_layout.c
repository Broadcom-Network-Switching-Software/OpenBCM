...
dnx_field_apptype_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_field_apptype[idx].first_child_index = 1;
    layout_array_dnx_field_apptype[idx].last_child_index = 2;
    layout_array_dnx_field_apptype[idx].next_node_index = 1;
    ...
    layout_array_dnx_field_apptype[idx].array_indexes[0].size = bcmFieldAppTypeCount;
    ...
    layout_array_dnx_field_apptype[idx].first_child_index = 3;
    layout_array_dnx_field_apptype[idx].last_child_index = 7;
    layout_array_dnx_field_apptype[idx].next_node_index = 2;
    ...
    layout_array_dnx_field_apptype[idx].array_indexes[0].size = DNX_DATA_MAX_FIELD_EXTERNAL_TCAM_APPTYPE_USER_NOF;
    layout_array_dnx_field_apptype[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_field_apptype[idx].parent  = 0;
    layout_array_dnx_field_apptype[idx].first_child_index = 8;
    layout_array_dnx_field_apptype[idx].last_child_index = 13;
    layout_array_dnx_field_apptype[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_apptype[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
    ...
    layout_array_dnx_field_apptype[idx].next_node_index = 6;
    ...
    layout_array_dnx_field_apptype[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_apptype[idx].size_of = sizeof(uint8);
    layout_array_dnx_field_apptype[idx].array_indexes[0].size = DNX_DATA_MAX_FIELD_EXTERNAL_TCAM_MAX_FWD_CONTEXT_NUM_FOR_ONE_APPTYPE;
    layout_array_dnx_field_apptype[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_field_apptype[idx].parent  = 1;
    layout_array_dnx_field_apptype[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_apptype[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_apptype[idx].next_node_index = 7;
    ...
    layout_array_dnx_field_apptype[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_apptype[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_apptype[idx].next_node_index = 9;
    ...
    layout_array_dnx_field_apptype[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_apptype[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_apptype[idx].next_node_index = 10;
    ...
    layout_array_dnx_field_apptype[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_apptype[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_apptype[idx].next_node_index = 11;
    ...
    layout_array_dnx_field_apptype[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_apptype[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_apptype[idx].next_node_index = 12;
    ...
    layout_array_dnx_field_apptype[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_apptype[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_apptype[idx].next_node_index = 13;
