...
mdb_em_init_layout_structure(int unit)
{
    ...
    layout_array_mdb_em[idx].first_child_index = 1;
    layout_array_mdb_em[idx].last_child_index = 3;
    layout_array_mdb_em[idx].next_node_index = 1;
    ...
    layout_array_mdb_em[idx].array_indexes[0].size = DBAL_NOF_PHYSICAL_TABLES;
    ...
    layout_array_mdb_em[idx].next_node_index = 2;
    ...
    layout_array_mdb_em[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_mdb_em[idx].parent  = 0;
    layout_array_mdb_em[idx].first_child_index = 4;
    layout_array_mdb_em[idx].last_child_index = 8;
    layout_array_mdb_em[idx].next_node_index = 3;
    ...
    layout_array_mdb_em[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb_em[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb_em[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_mdb_em[idx].array_indexes[0].size = DNX_DATA_MAX_MDB_EM_NOF_ENCODING_VALUES;
    layout_array_mdb_em[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_mdb_em[idx].parent  = 2;
    layout_array_mdb_em[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb_em[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb_em[idx].next_node_index = 5;
    ...
    layout_array_mdb_em[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb_em[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb_em[idx].next_node_index = 6;
    ...
    layout_array_mdb_em[idx].array_indexes[0].size = DNX_DATA_MAX_MDB_EM_VMV_NOF_VALUES;
    layout_array_mdb_em[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_mdb_em[idx].parent  = 2;
    layout_array_mdb_em[idx].first_child_index = 9;
    layout_array_mdb_em[idx].last_child_index = 10;
    layout_array_mdb_em[idx].next_node_index = 7;
    ...
    layout_array_mdb_em[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb_em[idx].size_of = sizeof(uint8);
    layout_array_mdb_em[idx].array_indexes[0].size = DNX_DATA_MAX_MDB_EM_MAX_NOF_TIDS;
    layout_array_mdb_em[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_mdb_em[idx].parent  = 2;
    layout_array_mdb_em[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb_em[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb_em[idx].next_node_index = 8;
    ...
    layout_array_mdb_em[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb_em[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_mdb_em[idx].next_node_index = 10;
