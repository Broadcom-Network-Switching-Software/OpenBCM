...
dnx_field_tcam_location_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_field_tcam_location[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_field_tcam_location[idx].first_child_index = 1;
    layout_array_dnx_field_tcam_location[idx].last_child_index = 4;
    layout_array_dnx_field_tcam_location[idx].next_node_index = 1;
    ...
    layout_array_dnx_field_tcam_location[idx].array_indexes[0].size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_field_tcam_location[idx].next_node_index = 2;
    ...
    layout_array_dnx_field_tcam_location[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    layout_array_dnx_field_tcam_location[idx].parent  = 0;
    layout_array_dnx_field_tcam_location[idx].first_child_index = 5;
    layout_array_dnx_field_tcam_location[idx].last_child_index = 7;
    layout_array_dnx_field_tcam_location[idx].next_node_index = 3;
    ...
    layout_array_dnx_field_tcam_location[idx].array_indexes[0].size = DNX_DATA_MAX_DEVICE_GENERAL_NOF_CORES;
    layout_array_dnx_field_tcam_location[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_field_tcam_location[idx].array_indexes[1].size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_tcam_location[idx].array_indexes[1].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    layout_array_dnx_field_tcam_location[idx].parent  = 0;
    layout_array_dnx_field_tcam_location[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_tcam_location[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_tcam_location[idx].next_node_index = 4;
    ...
    layout_array_dnx_field_tcam_location[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_tcam_location[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_tcam_location[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_field_tcam_location[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_tcam_location[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_tcam_location[idx].next_node_index = 6;
    ...
    layout_array_dnx_field_tcam_location[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_tcam_location[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_tcam_location[idx].next_node_index = 7;
