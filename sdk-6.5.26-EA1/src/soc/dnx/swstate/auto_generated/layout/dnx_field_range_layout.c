...
dnx_field_range_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_field_range[idx].first_child_index = 1;
    layout_array_dnx_field_range[idx].last_child_index = 2;
    layout_array_dnx_field_range[idx].next_node_index = 1;
    ...
    layout_array_dnx_field_range[idx].array_indexes[0].size = DNX_DATA_MAX_FIELD_L4_OPS_NOF_EXT_TYPES;
    ...
    layout_array_dnx_field_range[idx].next_node_index = 2;
    ...
    layout_array_dnx_field_range[idx].array_indexes[0].size = DNX_DATA_MAX_FIELD_L4_OPS_NOF_CONFIGURABLE_RANGES;
    layout_array_dnx_field_range[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_field_range[idx].parent  = 0;
    layout_array_dnx_field_range[idx].first_child_index = 3;
    layout_array_dnx_field_range[idx].last_child_index = 4;
    layout_array_dnx_field_range[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_field_range[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_range[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_range[idx].next_node_index = 4;
    ...
    layout_array_dnx_field_range[idx].parent  = 2;
    layout_array_dnx_field_range[idx].first_child_index = 5;
    layout_array_dnx_field_range[idx].last_child_index = 8;
    layout_array_dnx_field_range[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_field_range[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_range[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_range[idx].next_node_index = 6;
    ...
    layout_array_dnx_field_range[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_range[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_range[idx].next_node_index = 7;
    ...
    layout_array_dnx_field_range[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_range[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_range[idx].next_node_index = 8;
