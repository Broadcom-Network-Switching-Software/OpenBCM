...
dnx_visibility_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_visibility[idx].doc = "Visibility information";
    layout_array_dnx_visibility[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_visibility[idx].first_child_index = 1;
    layout_array_dnx_visibility[idx].last_child_index = 1;
    layout_array_dnx_visibility[idx].next_node_index = 1;
    ...
    layout_array_dnx_visibility[idx].doc = "Visibility global mode";
    layout_array_dnx_visibility[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_visibility[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
