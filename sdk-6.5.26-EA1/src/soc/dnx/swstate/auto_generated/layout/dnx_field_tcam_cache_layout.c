...
dnx_field_tcam_cache_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_field_tcam_cache[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_field_tcam_cache[idx].first_child_index = 1;
    layout_array_dnx_field_tcam_cache[idx].last_child_index = 2;
    layout_array_dnx_field_tcam_cache[idx].next_node_index = 1;
    ...
    layout_array_dnx_field_tcam_cache[idx].array_indexes[0].size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_tcam_cache[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    layout_array_dnx_field_tcam_cache[idx].array_indexes[1].size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_field_tcam_cache[idx].first_child_index = 3;
    layout_array_dnx_field_tcam_cache[idx].last_child_index = 3;
    layout_array_dnx_field_tcam_cache[idx].next_node_index = 2;
    ...
    layout_array_dnx_field_tcam_cache[idx].array_indexes[1].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC;
    layout_array_dnx_field_tcam_cache[idx].parent  = 0;
    layout_array_dnx_field_tcam_cache[idx].first_child_index = 5;
    layout_array_dnx_field_tcam_cache[idx].last_child_index = 5;
    layout_array_dnx_field_tcam_cache[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_field_tcam_cache[idx].first_child_index = 4;
    layout_array_dnx_field_tcam_cache[idx].last_child_index = 4;
    layout_array_dnx_field_tcam_cache[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_field_tcam_cache[idx].array_indexes[0].size = BITS2BYTES(DNX_DATA_MAX_FIELD_TCAM_ENTRY_SIZE_SINGLE_KEY_SHADOW);
    ...
    layout_array_dnx_field_tcam_cache[idx].first_child_index = 6;
    layout_array_dnx_field_tcam_cache[idx].last_child_index = 6;
    layout_array_dnx_field_tcam_cache[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_field_tcam_cache[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_tcam_cache[idx].size_of = sizeof(uint8);
    layout_array_dnx_field_tcam_cache[idx].array_indexes[0].size = BITS2BYTES(DNX_DATA_MAX_FIELD_TCAM_ACTION_SIZE_HALF);
    layout_array_dnx_field_tcam_cache[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
