...
kbp_fwd_tcam_access_mapper_init_layout_structure(int unit)
{
    ...
    layout_array_kbp_fwd_tcam_access_mapper[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_kbp_fwd_tcam_access_mapper[idx].first_child_index = 1;
    layout_array_kbp_fwd_tcam_access_mapper[idx].last_child_index = 1;
    layout_array_kbp_fwd_tcam_access_mapper[idx].next_node_index = 1;
    ...
    layout_array_kbp_fwd_tcam_access_mapper[idx].array_indexes[0].size = DNX_KBP_MAX_NOF_TCAM_HASH_TABLE_INDICES;
    ...
    layout_array_kbp_fwd_tcam_access_mapper[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
