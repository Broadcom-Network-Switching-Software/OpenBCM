...
dnx_port_imb_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_port_imb[idx].doc = "DB for IMB management - IMBs info per unit";
    layout_array_dnx_port_imb[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_port_imb[idx].first_child_index = 1;
    layout_array_dnx_port_imb[idx].last_child_index = 5;
    layout_array_dnx_port_imb[idx].next_node_index = 1;
    ...
    layout_array_dnx_port_imb[idx].doc = "counter to track how many imbs are already in use";
    layout_array_dnx_port_imb[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_port_imb[idx].next_node_index = 2;
    ...
    layout_array_dnx_port_imb[idx].doc = "imbs array";
    layout_array_dnx_port_imb[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_port_imb[idx].size_of = sizeof(imb_create_info_t*);
    layout_array_dnx_port_imb[idx].array_indexes[0].size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_port_imb[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC;
    layout_array_dnx_port_imb[idx].parent  = 0;
    layout_array_dnx_port_imb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_port_imb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_port_imb[idx].next_node_index = 3;
    ...
    layout_array_dnx_port_imb[idx].doc = "IMB type for the port";
    layout_array_dnx_port_imb[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_port_imb[idx].size_of = sizeof(imb_dispatch_type_t);
    layout_array_dnx_port_imb[idx].array_indexes[0].size = SOC_MAX_NUM_PORTS;
    layout_array_dnx_port_imb[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_port_imb[idx].parent  = 0;
    layout_array_dnx_port_imb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_port_imb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_port_imb[idx].next_node_index = 4;
    ...
    layout_array_dnx_port_imb[idx].type = "uint32";
    layout_array_dnx_port_imb[idx].doc = "last read PMD lock counter";
    layout_array_dnx_port_imb[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_port_imb[idx].size_of = sizeof(uint32);
    layout_array_dnx_port_imb[idx].array_indexes[0].size = SOC_MAX_NUM_PORTS;
    layout_array_dnx_port_imb[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    ...
    layout_array_dnx_port_imb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_port_imb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_port_imb[idx].next_node_index = 5;
    ...
    layout_array_dnx_port_imb[idx].doc = "mutex to prevent race condition on credit_tx_reset from different threads";
    layout_array_dnx_port_imb[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_port_imb[idx].size_of = sizeof(sw_state_mutex_t);
    layout_array_dnx_port_imb[idx].parent  = 0;
    layout_array_dnx_port_imb[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_port_imb[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_port_imb[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
