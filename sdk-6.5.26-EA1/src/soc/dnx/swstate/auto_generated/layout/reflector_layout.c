...
reflector_init_layout_structure(int unit)
{
    ...
    layout_array_reflector[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_reflector[idx].first_child_index = 1;
    layout_array_reflector[idx].last_child_index = 4;
    layout_array_reflector[idx].next_node_index = 1;
    ...
    layout_array_reflector[idx].first_child_index = 5;
    layout_array_reflector[idx].last_child_index = 6;
    layout_array_reflector[idx].next_node_index = 2;
    ...
    layout_array_reflector[idx].size_of = sizeof(reflector_uc_sw_db_info_t);
    layout_array_reflector[idx].parent  = 0;
    layout_array_reflector[idx].first_child_index = 7;
    layout_array_reflector[idx].last_child_index = 8;
    layout_array_reflector[idx].next_node_index = 3;
    ...
    layout_array_reflector[idx].size_of = sizeof(reflector_uc_sw_db_info_t);
    layout_array_reflector[idx].parent  = 0;
    layout_array_reflector[idx].first_child_index = 9;
    layout_array_reflector[idx].last_child_index = 10;
    layout_array_reflector[idx].next_node_index = 4;
    ...
    layout_array_reflector[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_reflector[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_reflector[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_reflector[idx].next_node_index = 6;
    ...
    layout_array_reflector[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_reflector[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_reflector[idx].next_node_index = 8;
    ...
    layout_array_reflector[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_reflector[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_reflector[idx].next_node_index = 10;
