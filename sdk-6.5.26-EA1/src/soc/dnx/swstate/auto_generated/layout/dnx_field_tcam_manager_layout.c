...
dnx_field_tcam_manager_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_field_tcam_manager[idx].first_child_index = 1;
    layout_array_dnx_field_tcam_manager[idx].last_child_index = 1;
    layout_array_dnx_field_tcam_manager[idx].next_node_index = 1;
    ...
    layout_array_dnx_field_tcam_manager[idx].array_indexes[0].size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_field_tcam_manager[idx].first_child_index = 2;
    layout_array_dnx_field_tcam_manager[idx].last_child_index = 3;
    layout_array_dnx_field_tcam_manager[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_field_tcam_manager[idx].next_node_index = 3;
