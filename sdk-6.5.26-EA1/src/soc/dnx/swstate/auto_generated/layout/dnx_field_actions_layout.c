...
dnx_field_actions_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_field_actions[idx].first_child_index = 1;
    layout_array_dnx_field_actions[idx].last_child_index = 3;
    layout_array_dnx_field_actions[idx].next_node_index = 1;
    ...
    layout_array_dnx_field_actions[idx].array_indexes[0].size = DNX_DATA_MAX_FIELD_ACTION_USER_NOF;
    ...
    layout_array_dnx_field_actions[idx].first_child_index = 4;
    layout_array_dnx_field_actions[idx].last_child_index = 12;
    layout_array_dnx_field_actions[idx].next_node_index = 2;
    ...
    layout_array_dnx_field_actions[idx].array_indexes[0].size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_actions[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    layout_array_dnx_field_actions[idx].parent  = 0;
    layout_array_dnx_field_actions[idx].first_child_index = 13;
    layout_array_dnx_field_actions[idx].last_child_index = 13;
    layout_array_dnx_field_actions[idx].next_node_index = 3;
    ...
    layout_array_dnx_field_actions[idx].array_indexes[0].size = DNX_DATA_MAX_FIELD_ACTION_PREDEFINED_NOF;
    layout_array_dnx_field_actions[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_STATIC;
    layout_array_dnx_field_actions[idx].parent  = 0;
    layout_array_dnx_field_actions[idx].first_child_index = 20;
    layout_array_dnx_field_actions[idx].last_child_index = 20;
    layout_array_dnx_field_actions[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_actions[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
    ...
    layout_array_dnx_field_actions[idx].next_node_index = 5;
    ...
    layout_array_dnx_field_actions[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_actions[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_actions[idx].next_node_index = 6;
    ...
    layout_array_dnx_field_actions[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_actions[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_actions[idx].next_node_index = 7;
    ...
    layout_array_dnx_field_actions[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_actions[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_actions[idx].next_node_index = 8;
    ...
    layout_array_dnx_field_actions[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_actions[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_actions[idx].next_node_index = 9;
    ...
    layout_array_dnx_field_actions[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_actions[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_actions[idx].next_node_index = 10;
    ...
    layout_array_dnx_field_actions[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_actions[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_actions[idx].next_node_index = 11;
    ...
    layout_array_dnx_field_actions[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_actions[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_actions[idx].next_node_index = 12;
    ...
    layout_array_dnx_field_actions[idx].first_child_index = 14;
    layout_array_dnx_field_actions[idx].last_child_index = 19;
    layout_array_dnx_field_actions[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_actions[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_GENERATE_IS_ALLOC;
    ...
    layout_array_dnx_field_actions[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_actions[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_actions[idx].next_node_index = 15;
    layout_array_dnx_field_actions[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_GENERATE_IS_ALLOC;
    ...
    layout_array_dnx_field_actions[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_actions[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_actions[idx].next_node_index = 16;
    ...
    layout_array_dnx_field_actions[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_actions[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_actions[idx].next_node_index = 17;
    ...
    layout_array_dnx_field_actions[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_actions[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_actions[idx].next_node_index = 18;
    ...
    layout_array_dnx_field_actions[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_actions[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_field_actions[idx].next_node_index = 19;
