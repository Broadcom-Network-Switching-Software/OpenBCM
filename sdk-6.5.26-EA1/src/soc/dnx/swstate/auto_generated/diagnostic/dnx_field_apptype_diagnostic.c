...
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_field_apptype_sw_predef_info_nof_fwd2_context_ids_dump(unit, predef_info_idx_0, filters));
    SHR_IF_ERR_EXIT(dnx_field_apptype_sw_predef_info_fwd2_context_ids_dump(unit, predef_info_idx_0, -1, filters));
...
int
dnx_field_apptype_sw_predef_info_nof_fwd2_context_ids_dump(int  unit,  int  predef_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_field_apptype predef_info nof_fwd2_context_ids") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_field_apptype predef_info nof_fwd2_context_ids\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_field_apptype_sw/predef_info/nof_fwd2_context_ids.txt",
            "dnx_field_apptype_sw[%d]->","((dnx_field_apptype_sw_t*)sw_state_roots_array[%d][DNX_FIELD_APPTYPE_MODULE_ID])->","predef_info[].nof_fwd2_context_ids: ");
        ...
        {
            LOG_CLI((BSL_META("dnx_field_apptype_sw[]->((dnx_field_apptype_sw_t*)sw_state_roots_array[][DNX_FIELD_APPTYPE_MODULE_ID])->predef_info[].nof_fwd2_context_ids: ")));
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_MONITOR(
                unit,
                "dnx_field_apptype_sw[%d]->","((dnx_field_apptype_sw_t*)sw_state_roots_array[%d][DNX_FIELD_APPTYPE_MODULE_ID])->","predef_info[%s%d].nof_fwd2_context_ids: ", s0, i0);
            ...
            dnx_sw_state_print_uint8(
                unit,
                &((dnx_field_apptype_sw_t*)sw_state_roots_array[unit][DNX_FIELD_APPTYPE_MODULE_ID])->predef_info[i0].nof_fwd2_context_ids);
...
int
dnx_field_apptype_sw_predef_info_fwd2_context_ids_dump(int  unit,  int  predef_info_idx_0,  int  fwd2_context_ids_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = predef_info_idx_0, I0 = predef_info_idx_0 + 1;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_field_apptype predef_info fwd2_context_ids") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_field_apptype predef_info fwd2_context_ids\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_field_apptype_sw/predef_info/fwd2_context_ids.txt",
            "dnx_field_apptype_sw[%d]->","((dnx_field_apptype_sw_t*)sw_state_roots_array[%d][DNX_FIELD_APPTYPE_MODULE_ID])->","predef_info[].fwd2_context_ids[]: ");
        ...
        if(i0 >= bcmFieldAppTypeCount)
        {
            LOG_CLI((BSL_META("dnx_field_apptype_sw[]->((dnx_field_apptype_sw_t*)sw_state_roots_array[][DNX_FIELD_APPTYPE_MODULE_ID])->predef_info[].fwd2_context_ids[]: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            if (i1 == -1) {
                ...
                i1 = dnx_sw_state_dump_check_all_the_same(unit,
                    ((dnx_field_apptype_sw_t*)sw_state_roots_array[unit][DNX_FIELD_APPTYPE_MODULE_ID])->predef_info[i0].fwd2_context_ids
                    , sizeof(*((dnx_field_apptype_sw_t*)sw_state_roots_array[unit][DNX_FIELD_APPTYPE_MODULE_ID])->predef_info[i0].fwd2_context_ids), I1, &s1) ? I1 - 1 : 0;
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                DNX_SW_STATE_PRINT_MONITOR(
                    unit,
                    "dnx_field_apptype_sw[%d]->","((dnx_field_apptype_sw_t*)sw_state_roots_array[%d][DNX_FIELD_APPTYPE_MODULE_ID])->","predef_info[%s%d].fwd2_context_ids[%s%d]: ", s0, i0, s1, i1);
                ...
                dnx_sw_state_print_uint8(
                    unit,
                    &((dnx_field_apptype_sw_t*)sw_state_roots_array[unit][DNX_FIELD_APPTYPE_MODULE_ID])->predef_info[i0].fwd2_context_ids[i1]);
...
const char* dnx_field_apptype_sw_layout_str[DNX_FIELD_APPTYPE_SW_INFO_NOF_ENTRIES] = {
    ...
    "DNX_FIELD_APPTYPE_SW~PREDEF_INFO~NOF_FWD2_CONTEXT_IDS~",
    "DNX_FIELD_APPTYPE_SW~PREDEF_INFO~FWD2_CONTEXT_IDS~",
