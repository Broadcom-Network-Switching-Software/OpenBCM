...
dnx_field_tcam_manager_sw_tcam_handlers_mode_dump(int  unit,  int  tcam_handlers_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_MANAGER_SW__TCAM_HANDLERS__MODE, ((dnx_field_tcam_manager_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_MANAGER_MODULE_ID])->tcam_handlers))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_MANAGER_SW__TCAM_HANDLERS__MODE, ((dnx_field_tcam_manager_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_MANAGER_MODULE_ID])->tcam_handlers) == 0)
        {
            SHR_EXIT();
        }
...
dnx_field_tcam_manager_sw_tcam_handlers_state_dump(int  unit,  int  tcam_handlers_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_MANAGER_SW__TCAM_HANDLERS__STATE, ((dnx_field_tcam_manager_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_MANAGER_MODULE_ID])->tcam_handlers))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_MANAGER_SW__TCAM_HANDLERS__STATE, ((dnx_field_tcam_manager_sw_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_MANAGER_MODULE_ID])->tcam_handlers) == 0)
        {
            SHR_EXIT();
        }
