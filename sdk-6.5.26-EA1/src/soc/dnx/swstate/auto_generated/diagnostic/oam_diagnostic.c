...
oam_sw_db_info_oam_endpoint_sw_db_info_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(oam_sw_db_info_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_dump(unit, filters));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
int
oam_sw_db_info_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "oam oam_endpoint_sw_db_info oam_endpoint_array_of_mep_linked_lists") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate oam oam_endpoint_sw_db_info oam_endpoint_array_of_mep_linked_lists\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "oam_sw_db_info/oam_endpoint_sw_db_info/oam_endpoint_array_of_mep_linked_lists.txt",
            "oam_sw_db_info[%d]->","((oam_sw_db_info_t*)sw_state_roots_array[%d][OAM_MODULE_ID])->","oam_endpoint_sw_db_info.oam_endpoint_array_of_mep_linked_lists: ");
...
const char* oam_sw_db_info_layout_str[OAM_SW_DB_INFO_INFO_NOF_ENTRIES] = {
    ...
    "OAM_SW_DB_INFO~OAM_ENDPOINT_SW_DB_INFO~OAM_ENDPOINT_ARRAY_OF_MEP_LINKED_LISTS~",
