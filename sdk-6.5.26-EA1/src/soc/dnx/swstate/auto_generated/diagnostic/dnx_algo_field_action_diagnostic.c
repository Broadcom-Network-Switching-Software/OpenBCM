...
int
dnx_algo_field_action_sw_fem_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_algo_field_action_sw_fem_is_priority_position_dump(unit, -1, -1, filters));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
int
dnx_algo_field_action_sw_fem_is_priority_position_dump(int  unit,  int  is_priority_position_idx_0,  int  is_priority_position_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = is_priority_position_idx_0, I0 = is_priority_position_idx_0 + 1;
    int i1 = is_priority_position_idx_1, I1 = is_priority_position_idx_1 + 1, org_i1 = is_priority_position_idx_1;
    char *s0 = "", *s1 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_algo_field_action fem is_priority_position") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_algo_field_action fem is_priority_position\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_algo_field_action_sw/fem/is_priority_position.txt",
            "dnx_algo_field_action_sw[%d]->","((dnx_algo_field_action_sw_t*)sw_state_roots_array[%d][DNX_ALGO_FIELD_ACTION_MODULE_ID])->","fem.is_priority_position[][]: ");
        ...
        if (i0 == -1) {
            I0 = DNX_DATA_MAX_FIELD_COMMON_MAX_VAL_NOF_FEM_ID;
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ((dnx_algo_field_action_sw_t*)sw_state_roots_array[unit][DNX_ALGO_FIELD_ACTION_MODULE_ID])->fem.is_priority_position
                , sizeof(*((dnx_algo_field_action_sw_t*)sw_state_roots_array[unit][DNX_ALGO_FIELD_ACTION_MODULE_ID])->fem.is_priority_position), I0, &s0) ? I0 - 1 : 0;
        }

        if(i0 >= DNX_DATA_MAX_FIELD_COMMON_MAX_VAL_NOF_FEM_ID)
        {
            LOG_CLI((BSL_META("dnx_algo_field_action_sw[]->((dnx_algo_field_action_sw_t*)sw_state_roots_array[][DNX_ALGO_FIELD_ACTION_MODULE_ID])->fem.is_priority_position[][]: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(DNX_DATA_MAX_FIELD_COMMON_MAX_VAL_NOF_FEM_ID == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            if (i1 == -1) {
                I1 = DNX_DATA_MAX_FIELD_COMMON_MAX_VAL_NOF_FEM_PROGRAMS;
                i1 = dnx_sw_state_dump_check_all_the_same(unit,
                    ((dnx_algo_field_action_sw_t*)sw_state_roots_array[unit][DNX_ALGO_FIELD_ACTION_MODULE_ID])->fem.is_priority_position[i0]
                    , sizeof(*((dnx_algo_field_action_sw_t*)sw_state_roots_array[unit][DNX_ALGO_FIELD_ACTION_MODULE_ID])->fem.is_priority_position[i0]), I1, &s1) ? I1 - 1 : 0;
            }

            if(i1 >= DNX_DATA_MAX_FIELD_COMMON_MAX_VAL_NOF_FEM_PROGRAMS)
            {
                LOG_CLI((BSL_META("dnx_algo_field_action_sw[]->((dnx_algo_field_action_sw_t*)sw_state_roots_array[][DNX_ALGO_FIELD_ACTION_MODULE_ID])->fem.is_priority_position[][]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(DNX_DATA_MAX_FIELD_COMMON_MAX_VAL_NOF_FEM_PROGRAMS == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                DNX_SW_STATE_PRINT_MONITOR(
                    unit,
                    "dnx_algo_field_action_sw[%d]->","((dnx_algo_field_action_sw_t*)sw_state_roots_array[%d][DNX_ALGO_FIELD_ACTION_MODULE_ID])->","fem.is_priority_position[%s%d][%s%d]: ", s0, i0, s1, i1);
                ...
                dnx_sw_state_print_uint8(
                    unit,
                    &((dnx_algo_field_action_sw_t*)sw_state_roots_array[unit][DNX_ALGO_FIELD_ACTION_MODULE_ID])->fem.is_priority_position[i0][i1]);
...
const char* dnx_algo_field_action_sw_layout_str[DNX_ALGO_FIELD_ACTION_SW_INFO_NOF_ENTRIES] = {
    ...
    "DNX_ALGO_FIELD_ACTION_SW~FEM~",
    "DNX_ALGO_FIELD_ACTION_SW~FEM~IS_PRIORITY_POSITION~",
};
#endif 
