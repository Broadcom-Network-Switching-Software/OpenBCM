...
dnx_field_action_sw_db_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_action_sw_db_predefined_dump(unit, -1, filters));
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_ENUM(
                unit,
                dnx_field_action_flags_e_get_name(((dnx_field_action_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_ACTIONS_MODULE_ID])->info[i0].flags));
...
dnx_field_action_sw_db_fem_info_fg_id_info_fem_encoded_actions_dump(int  unit,  int  fem_info_idx_0,  int  fg_id_info_idx_0,  int  fem_encoded_actions_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_ACTION_SW_DB__FEM_INFO__FG_ID_INFO__FEM_ENCODED_ACTIONS, ((dnx_field_action_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_ACTIONS_MODULE_ID])->fem_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_ACTION_SW_DB__FEM_INFO__FG_ID_INFO__FEM_ENCODED_ACTIONS, ((dnx_field_action_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_ACTIONS_MODULE_ID])->fem_info) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_ACTION_SW_DB__FEM_INFO__FG_ID_INFO__FEM_ENCODED_ACTIONS, ((dnx_field_action_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_ACTIONS_MODULE_ID])->fem_info[i0].fg_id_info))
            {
                LOG_CLI((BSL_META("dnx_field_action_sw_db[]->((dnx_field_action_sw_db_t*)sw_state_roots_array[][DNX_FIELD_ACTIONS_MODULE_ID])->fem_info[].fg_id_info[].fem_encoded_actions[]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_ACTION_SW_DB__FEM_INFO__FG_ID_INFO__FEM_ENCODED_ACTIONS, ((dnx_field_action_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_ACTIONS_MODULE_ID])->fem_info[i0].fg_id_info) == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                if(i2 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_ACTION_SW_DB__FEM_INFO__FG_ID_INFO__FEM_ENCODED_ACTIONS, ((dnx_field_action_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_ACTIONS_MODULE_ID])->fem_info[i0].fg_id_info[i1].fem_encoded_actions))
                {
                    LOG_CLI((BSL_META("dnx_field_action_sw_db[]->((dnx_field_action_sw_db_t*)sw_state_roots_array[][DNX_FIELD_ACTIONS_MODULE_ID])->fem_info[].fg_id_info[].fem_encoded_actions[]: ")));
                    LOG_CLI((BSL_META("Invalid index: %d \n"),i2));
                    SHR_EXIT();
                ...
                if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_ACTION_SW_DB__FEM_INFO__FG_ID_INFO__FEM_ENCODED_ACTIONS, ((dnx_field_action_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_ACTIONS_MODULE_ID])->fem_info[i0].fg_id_info[i1].fem_encoded_actions) == 0)
                {
                    SHR_EXIT();
                }
...
dnx_field_action_sw_db_fem_info_fg_id_info_second_fg_id_dump(int  unit,  int  fem_info_idx_0,  int  fg_id_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_ACTION_SW_DB__FEM_INFO__FG_ID_INFO__SECOND_FG_ID, ((dnx_field_action_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_ACTIONS_MODULE_ID])->fem_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_ACTION_SW_DB__FEM_INFO__FG_ID_INFO__SECOND_FG_ID, ((dnx_field_action_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_ACTIONS_MODULE_ID])->fem_info) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_ACTION_SW_DB__FEM_INFO__FG_ID_INFO__SECOND_FG_ID, ((dnx_field_action_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_ACTIONS_MODULE_ID])->fem_info[i0].fg_id_info))
            {
                LOG_CLI((BSL_META("dnx_field_action_sw_db[]->((dnx_field_action_sw_db_t*)sw_state_roots_array[][DNX_FIELD_ACTIONS_MODULE_ID])->fem_info[].fg_id_info[].second_fg_id: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_ACTION_SW_DB__FEM_INFO__FG_ID_INFO__SECOND_FG_ID, ((dnx_field_action_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_ACTIONS_MODULE_ID])->fem_info[i0].fg_id_info) == 0)
            {
                SHR_EXIT();
            }
...
dnx_field_action_sw_db_fem_info_fg_id_info_fg_id_dump(int  unit,  int  fem_info_idx_0,  int  fg_id_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_ACTION_SW_DB__FEM_INFO__FG_ID_INFO__FG_ID, ((dnx_field_action_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_ACTIONS_MODULE_ID])->fem_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_ACTION_SW_DB__FEM_INFO__FG_ID_INFO__FG_ID, ((dnx_field_action_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_ACTIONS_MODULE_ID])->fem_info) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_ACTION_SW_DB__FEM_INFO__FG_ID_INFO__FG_ID, ((dnx_field_action_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_ACTIONS_MODULE_ID])->fem_info[i0].fg_id_info))
            {
                LOG_CLI((BSL_META("dnx_field_action_sw_db[]->((dnx_field_action_sw_db_t*)sw_state_roots_array[][DNX_FIELD_ACTIONS_MODULE_ID])->fem_info[].fg_id_info[].fg_id: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_ACTION_SW_DB__FEM_INFO__FG_ID_INFO__FG_ID, ((dnx_field_action_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_ACTIONS_MODULE_ID])->fem_info[i0].fg_id_info) == 0)
            {
                SHR_EXIT();
            }
...
dnx_field_action_sw_db_fem_info_fg_id_info_input_offset_dump(int  unit,  int  fem_info_idx_0,  int  fg_id_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_ACTION_SW_DB__FEM_INFO__FG_ID_INFO__INPUT_OFFSET, ((dnx_field_action_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_ACTIONS_MODULE_ID])->fem_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_ACTION_SW_DB__FEM_INFO__FG_ID_INFO__INPUT_OFFSET, ((dnx_field_action_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_ACTIONS_MODULE_ID])->fem_info) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_ACTION_SW_DB__FEM_INFO__FG_ID_INFO__INPUT_OFFSET, ((dnx_field_action_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_ACTIONS_MODULE_ID])->fem_info[i0].fg_id_info))
            {
                LOG_CLI((BSL_META("dnx_field_action_sw_db[]->((dnx_field_action_sw_db_t*)sw_state_roots_array[][DNX_FIELD_ACTIONS_MODULE_ID])->fem_info[].fg_id_info[].input_offset: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_ACTION_SW_DB__FEM_INFO__FG_ID_INFO__INPUT_OFFSET, ((dnx_field_action_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_ACTIONS_MODULE_ID])->fem_info[i0].fg_id_info) == 0)
            {
                SHR_EXIT();
            }
...
dnx_field_action_sw_db_fem_info_fg_id_info_input_size_dump(int  unit,  int  fem_info_idx_0,  int  fg_id_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_ACTION_SW_DB__FEM_INFO__FG_ID_INFO__INPUT_SIZE, ((dnx_field_action_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_ACTIONS_MODULE_ID])->fem_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_ACTION_SW_DB__FEM_INFO__FG_ID_INFO__INPUT_SIZE, ((dnx_field_action_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_ACTIONS_MODULE_ID])->fem_info) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_ACTION_SW_DB__FEM_INFO__FG_ID_INFO__INPUT_SIZE, ((dnx_field_action_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_ACTIONS_MODULE_ID])->fem_info[i0].fg_id_info))
            {
                LOG_CLI((BSL_META("dnx_field_action_sw_db[]->((dnx_field_action_sw_db_t*)sw_state_roots_array[][DNX_FIELD_ACTIONS_MODULE_ID])->fem_info[].fg_id_info[].input_size: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_ACTION_SW_DB__FEM_INFO__FG_ID_INFO__INPUT_SIZE, ((dnx_field_action_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_ACTIONS_MODULE_ID])->fem_info[i0].fg_id_info) == 0)
            {
                SHR_EXIT();
            }
...
dnx_field_action_sw_db_fem_info_fg_id_info_ignore_actions_dump(int  unit,  int  fem_info_idx_0,  int  fg_id_info_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_ACTION_SW_DB__FEM_INFO__FG_ID_INFO__IGNORE_ACTIONS, ((dnx_field_action_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_ACTIONS_MODULE_ID])->fem_info))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_ACTION_SW_DB__FEM_INFO__FG_ID_INFO__IGNORE_ACTIONS, ((dnx_field_action_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_ACTIONS_MODULE_ID])->fem_info) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_ACTION_SW_DB__FEM_INFO__FG_ID_INFO__IGNORE_ACTIONS, ((dnx_field_action_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_ACTIONS_MODULE_ID])->fem_info[i0].fg_id_info))
            {
                LOG_CLI((BSL_META("dnx_field_action_sw_db[]->((dnx_field_action_sw_db_t*)sw_state_roots_array[][DNX_FIELD_ACTIONS_MODULE_ID])->fem_info[].fg_id_info[].ignore_actions: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_ACTION_SW_DB__FEM_INFO__FG_ID_INFO__IGNORE_ACTIONS, ((dnx_field_action_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_ACTIONS_MODULE_ID])->fem_info[i0].fg_id_info) == 0)
            {
                SHR_EXIT();
            }
...
int
dnx_field_action_sw_db_predefined_dump(int  unit,  int  predefined_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(dnx_field_action_sw_db_predefined_field_id_dump(unit, predefined_idx_0, filters));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
int
dnx_field_action_sw_db_predefined_field_id_dump(int  unit,  int  predefined_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    if (dnx_sw_state_compare(filters.namefilter, "dnx_field_actions predefined field_id") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate dnx_field_actions predefined field_id\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_field_action_sw_db/predefined/field_id.txt",
            "dnx_field_action_sw_db[%d]->","((dnx_field_action_sw_db_t*)sw_state_roots_array[%d][DNX_FIELD_ACTIONS_MODULE_ID])->","predefined[].field_id: ");
        ...
        if (i0 == -1) {
            I0 = DNX_DATA_MAX_FIELD_ACTION_PREDEFINED_NOF;
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ((dnx_field_action_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_ACTIONS_MODULE_ID])->predefined
                , sizeof(*((dnx_field_action_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_ACTIONS_MODULE_ID])->predefined), I0, &s0) ? I0 - 1 : 0;
        }

        if(i0 >= DNX_DATA_MAX_FIELD_ACTION_PREDEFINED_NOF)
        {
            LOG_CLI((BSL_META("dnx_field_action_sw_db[]->((dnx_field_action_sw_db_t*)sw_state_roots_array[][DNX_FIELD_ACTIONS_MODULE_ID])->predefined[].field_id: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(DNX_DATA_MAX_FIELD_ACTION_PREDEFINED_NOF == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            DNX_SW_STATE_PRINT_OPAQUE_MONITOR(
                unit,
                ((dnx_field_action_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_ACTIONS_MODULE_ID])->predefined[i0].field_id,
                "dnx_field_action_sw_db[%d]->","((dnx_field_action_sw_db_t*)sw_state_roots_array[%d][DNX_FIELD_ACTIONS_MODULE_ID])->","predefined[%s%d].field_id: ", s0, i0);
...
const char* dnx_field_action_sw_db_layout_str[DNX_FIELD_ACTION_SW_DB_INFO_NOF_ENTRIES] = {
    ...
    "DNX_FIELD_ACTION_SW_DB~PREDEFINED~",
    "DNX_FIELD_ACTION_SW_DB~PREDEFINED~FIELD_ID~",
};
#endif 
