...
mdb_kaps_db_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(mdb_kaps_db_search_instruction_info_dump(unit, filters));
...
int
mdb_kaps_db_search_instruction_info_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    SHR_IF_ERR_EXIT(mdb_kaps_db_search_instruction_info_inst_p_dump(unit, filters));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
int
mdb_kaps_db_search_instruction_info_inst_p_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    DNXC_SW_STATE_FUNC_RETURN;
}
