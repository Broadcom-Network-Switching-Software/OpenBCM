...
cosq_config_hr_group_bw_dump(int  unit,  int  hr_group_bw_idx_0,  int  hr_group_bw_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_COSQ_CONFIG__HR_GROUP_BW, ((dnx_sch_config_t*)sw_state_roots_array[unit][DNX_SCH_CONFIG_MODULE_ID])->hr_group_bw[i0]))
            {
                LOG_CLI((BSL_META("cosq_config[]->((dnx_sch_config_t*)sw_state_roots_array[][DNX_SCH_CONFIG_MODULE_ID])->hr_group_bw[][]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_COSQ_CONFIG__HR_GROUP_BW, ((dnx_sch_config_t*)sw_state_roots_array[unit][DNX_SCH_CONFIG_MODULE_ID])->hr_group_bw[i0]) == 0)
            {
                SHR_EXIT();
            }
...
cosq_config_ipf_config_mode_dump(int  unit,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        DNX_SW_STATE_PRINT_ENUM(
            unit,
            dnx_sch_ipf_config_mode_e_get_name(((dnx_sch_config_t*)sw_state_roots_array[unit][DNX_SCH_CONFIG_MODULE_ID])->ipf_config_mode));
...
cosq_config_flow_credit_src_weight_dump(int  unit,  int  flow_idx_0,  int  flow_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_COSQ_CONFIG__FLOW__CREDIT_SRC__WEIGHT, ((dnx_sch_config_t*)sw_state_roots_array[unit][DNX_SCH_CONFIG_MODULE_ID])->flow[i0]))
            {
                LOG_CLI((BSL_META("cosq_config[]->((dnx_sch_config_t*)sw_state_roots_array[][DNX_SCH_CONFIG_MODULE_ID])->flow[][].credit_src.weight: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_COSQ_CONFIG__FLOW__CREDIT_SRC__WEIGHT, ((dnx_sch_config_t*)sw_state_roots_array[unit][DNX_SCH_CONFIG_MODULE_ID])->flow[i0]) == 0)
            {
                SHR_EXIT();
            }
...
cosq_config_flow_credit_src_mode_dump(int  unit,  int  flow_idx_0,  int  flow_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_COSQ_CONFIG__FLOW__CREDIT_SRC__MODE, ((dnx_sch_config_t*)sw_state_roots_array[unit][DNX_SCH_CONFIG_MODULE_ID])->flow[i0]))
            {
                LOG_CLI((BSL_META("cosq_config[]->((dnx_sch_config_t*)sw_state_roots_array[][DNX_SCH_CONFIG_MODULE_ID])->flow[][].credit_src.mode: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_COSQ_CONFIG__FLOW__CREDIT_SRC__MODE, ((dnx_sch_config_t*)sw_state_roots_array[unit][DNX_SCH_CONFIG_MODULE_ID])->flow[i0]) == 0)
            {
                SHR_EXIT();
            }
...
cosq_config_connector_num_cos_dump(int  unit,  int  connector_idx_0,  int  connector_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_COSQ_CONFIG__CONNECTOR__NUM_COS, ((dnx_sch_config_t*)sw_state_roots_array[unit][DNX_SCH_CONFIG_MODULE_ID])->connector[i0]))
            {
                LOG_CLI((BSL_META("cosq_config[]->((dnx_sch_config_t*)sw_state_roots_array[][DNX_SCH_CONFIG_MODULE_ID])->connector[][].num_cos: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_COSQ_CONFIG__CONNECTOR__NUM_COS, ((dnx_sch_config_t*)sw_state_roots_array[unit][DNX_SCH_CONFIG_MODULE_ID])->connector[i0]) == 0)
            {
                SHR_EXIT();
            }
...
cosq_config_connector_connection_valid_dump(int  unit,  int  connector_idx_0,  int  connector_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_COSQ_CONFIG__CONNECTOR__CONNECTION_VALID, ((dnx_sch_config_t*)sw_state_roots_array[unit][DNX_SCH_CONFIG_MODULE_ID])->connector[i0]))
            {
                LOG_CLI((BSL_META("cosq_config[]->((dnx_sch_config_t*)sw_state_roots_array[][DNX_SCH_CONFIG_MODULE_ID])->connector[][].connection_valid: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_COSQ_CONFIG__CONNECTOR__CONNECTION_VALID, ((dnx_sch_config_t*)sw_state_roots_array[unit][DNX_SCH_CONFIG_MODULE_ID])->connector[i0]) == 0)
            {
                SHR_EXIT();
            }
...
cosq_config_connector_src_modid_dump(int  unit,  int  connector_idx_0,  int  connector_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_COSQ_CONFIG__CONNECTOR__SRC_MODID, ((dnx_sch_config_t*)sw_state_roots_array[unit][DNX_SCH_CONFIG_MODULE_ID])->connector[i0]))
            {
                LOG_CLI((BSL_META("cosq_config[]->((dnx_sch_config_t*)sw_state_roots_array[][DNX_SCH_CONFIG_MODULE_ID])->connector[][].src_modid: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_COSQ_CONFIG__CONNECTOR__SRC_MODID, ((dnx_sch_config_t*)sw_state_roots_array[unit][DNX_SCH_CONFIG_MODULE_ID])->connector[i0]) == 0)
            {
                SHR_EXIT();
            }
...
cosq_config_se_child_count_dump(int  unit,  int  se_idx_0,  int  se_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_COSQ_CONFIG__SE__CHILD_COUNT, ((dnx_sch_config_t*)sw_state_roots_array[unit][DNX_SCH_CONFIG_MODULE_ID])->se[i0]))
            {
                LOG_CLI((BSL_META("cosq_config[]->((dnx_sch_config_t*)sw_state_roots_array[][DNX_SCH_CONFIG_MODULE_ID])->se[][].child_count: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_COSQ_CONFIG__SE__CHILD_COUNT, ((dnx_sch_config_t*)sw_state_roots_array[unit][DNX_SCH_CONFIG_MODULE_ID])->se[i0]) == 0)
            {
                SHR_EXIT();
            }
