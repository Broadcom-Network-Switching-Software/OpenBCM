    ...
    else
    {
        ...
        if (i0 == -1) {
            I0 = dnx_sw_state_get_nof_elements(unit,
                DNX_SW_STATE_DNX_FIELD_TCAM_HIT_INDICATION__TCAM_ACTION_HIT_INDICATION__BANK_LINE_ID,
                ((dnx_field_tcam_hit_indication_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_HIT_INDICATION_MODULE_ID])->tcam_action_hit_indication);
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_HIT_INDICATION__TCAM_ACTION_HIT_INDICATION__BANK_LINE_ID, ((dnx_field_tcam_hit_indication_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_HIT_INDICATION_MODULE_ID])->tcam_action_hit_indication))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_HIT_INDICATION__TCAM_ACTION_HIT_INDICATION__BANK_LINE_ID, ((dnx_field_tcam_hit_indication_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_HIT_INDICATION_MODULE_ID])->tcam_action_hit_indication) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_HIT_INDICATION__TCAM_ACTION_HIT_INDICATION__BANK_LINE_ID, ((dnx_field_tcam_hit_indication_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_HIT_INDICATION_MODULE_ID])->tcam_action_hit_indication[i0].bank_line_id))
            {
                LOG_CLI((BSL_META("dnx_field_tcam_hit_indication[]->((dnx_field_tcam_hit_indication_t*)sw_state_roots_array[][DNX_FIELD_TCAM_HIT_INDICATION_MODULE_ID])->tcam_action_hit_indication[].bank_line_id[][]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_HIT_INDICATION__TCAM_ACTION_HIT_INDICATION__BANK_LINE_ID, ((dnx_field_tcam_hit_indication_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_HIT_INDICATION_MODULE_ID])->tcam_action_hit_indication[i0].bank_line_id) == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                if(i2 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_HIT_INDICATION__TCAM_ACTION_HIT_INDICATION__BANK_LINE_ID, ((dnx_field_tcam_hit_indication_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_HIT_INDICATION_MODULE_ID])->tcam_action_hit_indication[i0].bank_line_id[i1]))
                {
                    LOG_CLI((BSL_META("dnx_field_tcam_hit_indication[]->((dnx_field_tcam_hit_indication_t*)sw_state_roots_array[][DNX_FIELD_TCAM_HIT_INDICATION_MODULE_ID])->tcam_action_hit_indication[].bank_line_id[][]: ")));
                    LOG_CLI((BSL_META("Invalid index: %d \n"),i2));
                    SHR_EXIT();
                ...
                if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_HIT_INDICATION__TCAM_ACTION_HIT_INDICATION__BANK_LINE_ID, ((dnx_field_tcam_hit_indication_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_HIT_INDICATION_MODULE_ID])->tcam_action_hit_indication[i0].bank_line_id[i1]) == 0)
                {
                    SHR_EXIT();
                }
...
dnx_field_tcam_hit_indication_tcam_action_hit_indication_small_bank_line_id_dump(int  unit,  int  tcam_action_hit_indication_small_idx_0,  int  bank_line_id_idx_0,  int  bank_line_id_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if (i0 == -1) {
            I0 = dnx_sw_state_get_nof_elements(unit,
                DNX_SW_STATE_DNX_FIELD_TCAM_HIT_INDICATION__TCAM_ACTION_HIT_INDICATION_SMALL__BANK_LINE_ID,
                ((dnx_field_tcam_hit_indication_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_HIT_INDICATION_MODULE_ID])->tcam_action_hit_indication_small);
            i0 = dnx_sw_state_dump_check_all_the_same(unit,
                ((dnx_field_tcam_hit_indication_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_HIT_INDICATION_MODULE_ID])->tcam_action_hit_indication_small
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_HIT_INDICATION__TCAM_ACTION_HIT_INDICATION_SMALL__BANK_LINE_ID, ((dnx_field_tcam_hit_indication_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_HIT_INDICATION_MODULE_ID])->tcam_action_hit_indication_small))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_HIT_INDICATION__TCAM_ACTION_HIT_INDICATION_SMALL__BANK_LINE_ID, ((dnx_field_tcam_hit_indication_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_HIT_INDICATION_MODULE_ID])->tcam_action_hit_indication_small) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_HIT_INDICATION__TCAM_ACTION_HIT_INDICATION_SMALL__BANK_LINE_ID, ((dnx_field_tcam_hit_indication_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_HIT_INDICATION_MODULE_ID])->tcam_action_hit_indication_small[i0].bank_line_id))
            {
                LOG_CLI((BSL_META("dnx_field_tcam_hit_indication[]->((dnx_field_tcam_hit_indication_t*)sw_state_roots_array[][DNX_FIELD_TCAM_HIT_INDICATION_MODULE_ID])->tcam_action_hit_indication_small[].bank_line_id[][]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_HIT_INDICATION__TCAM_ACTION_HIT_INDICATION_SMALL__BANK_LINE_ID, ((dnx_field_tcam_hit_indication_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_HIT_INDICATION_MODULE_ID])->tcam_action_hit_indication_small[i0].bank_line_id) == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                if(i2 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_HIT_INDICATION__TCAM_ACTION_HIT_INDICATION_SMALL__BANK_LINE_ID, ((dnx_field_tcam_hit_indication_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_HIT_INDICATION_MODULE_ID])->tcam_action_hit_indication_small[i0].bank_line_id[i1]))
                {
                    LOG_CLI((BSL_META("dnx_field_tcam_hit_indication[]->((dnx_field_tcam_hit_indication_t*)sw_state_roots_array[][DNX_FIELD_TCAM_HIT_INDICATION_MODULE_ID])->tcam_action_hit_indication_small[].bank_line_id[][]: ")));
                    LOG_CLI((BSL_META("Invalid index: %d \n"),i2));
                    SHR_EXIT();
                ...
                if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_HIT_INDICATION__TCAM_ACTION_HIT_INDICATION_SMALL__BANK_LINE_ID, ((dnx_field_tcam_hit_indication_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_HIT_INDICATION_MODULE_ID])->tcam_action_hit_indication_small[i0].bank_line_id[i1]) == 0)
                {
                    SHR_EXIT();
                }
