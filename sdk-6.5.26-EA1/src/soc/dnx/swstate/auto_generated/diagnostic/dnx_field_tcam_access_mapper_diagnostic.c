...
dnx_field_tcam_access_mapper_sw_key_2_location_hash_head_dump(int  unit,  int  key_2_location_hash_idx_0,  int  key_2_location_hash_idx_1,  int  head_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_MAPPER_SW__KEY_2_LOCATION_HASH__HEAD, ((dnx_field_tcam_access_mapper_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MAPPER_MODULE_ID])->key_2_location_hash))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_MAPPER_SW__KEY_2_LOCATION_HASH__HEAD, ((dnx_field_tcam_access_mapper_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MAPPER_MODULE_ID])->key_2_location_hash) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_MAPPER_SW__KEY_2_LOCATION_HASH__HEAD, ((dnx_field_tcam_access_mapper_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MAPPER_MODULE_ID])->key_2_location_hash[i0]))
            {
                LOG_CLI((BSL_META("dnx_field_tcam_access_mapper_sw[]->((dnx_field_tcam_access_mapper_t*)sw_state_roots_array[][DNX_FIELD_TCAM_ACCESS_MAPPER_MODULE_ID])->key_2_location_hash[][].head[]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_MAPPER_SW__KEY_2_LOCATION_HASH__HEAD, ((dnx_field_tcam_access_mapper_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MAPPER_MODULE_ID])->key_2_location_hash[i0]) == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                if(i2 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_MAPPER_SW__KEY_2_LOCATION_HASH__HEAD, ((dnx_field_tcam_access_mapper_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MAPPER_MODULE_ID])->key_2_location_hash[i0][i1].head))
                {
                    LOG_CLI((BSL_META("dnx_field_tcam_access_mapper_sw[]->((dnx_field_tcam_access_mapper_t*)sw_state_roots_array[][DNX_FIELD_TCAM_ACCESS_MAPPER_MODULE_ID])->key_2_location_hash[][].head[]: ")));
                    LOG_CLI((BSL_META("Invalid index: %d \n"),i2));
                    SHR_EXIT();
                ...
                if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_MAPPER_SW__KEY_2_LOCATION_HASH__HEAD, ((dnx_field_tcam_access_mapper_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MAPPER_MODULE_ID])->key_2_location_hash[i0][i1].head) == 0)
                {
                    SHR_EXIT();
                }
...
dnx_field_tcam_access_mapper_sw_key_2_location_hash_next_dump(int  unit,  int  key_2_location_hash_idx_0,  int  key_2_location_hash_idx_1,  int  next_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_MAPPER_SW__KEY_2_LOCATION_HASH__NEXT, ((dnx_field_tcam_access_mapper_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MAPPER_MODULE_ID])->key_2_location_hash))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_MAPPER_SW__KEY_2_LOCATION_HASH__NEXT, ((dnx_field_tcam_access_mapper_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MAPPER_MODULE_ID])->key_2_location_hash) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_MAPPER_SW__KEY_2_LOCATION_HASH__NEXT, ((dnx_field_tcam_access_mapper_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MAPPER_MODULE_ID])->key_2_location_hash[i0]))
            {
                LOG_CLI((BSL_META("dnx_field_tcam_access_mapper_sw[]->((dnx_field_tcam_access_mapper_t*)sw_state_roots_array[][DNX_FIELD_TCAM_ACCESS_MAPPER_MODULE_ID])->key_2_location_hash[][].next[]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_MAPPER_SW__KEY_2_LOCATION_HASH__NEXT, ((dnx_field_tcam_access_mapper_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MAPPER_MODULE_ID])->key_2_location_hash[i0]) == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                if(i2 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_MAPPER_SW__KEY_2_LOCATION_HASH__NEXT, ((dnx_field_tcam_access_mapper_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MAPPER_MODULE_ID])->key_2_location_hash[i0][i1].next))
                {
                    LOG_CLI((BSL_META("dnx_field_tcam_access_mapper_sw[]->((dnx_field_tcam_access_mapper_t*)sw_state_roots_array[][DNX_FIELD_TCAM_ACCESS_MAPPER_MODULE_ID])->key_2_location_hash[][].next[]: ")));
                    LOG_CLI((BSL_META("Invalid index: %d \n"),i2));
                    SHR_EXIT();
                ...
                if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_FIELD_TCAM_ACCESS_MAPPER_SW__KEY_2_LOCATION_HASH__NEXT, ((dnx_field_tcam_access_mapper_t*)sw_state_roots_array[unit][DNX_FIELD_TCAM_ACCESS_MAPPER_MODULE_ID])->key_2_location_hash[i0][i1].next) == 0)
                {
                    SHR_EXIT();
                }
