...
dnx_ofp_rate_db_otm_cal_instance_dump(int  unit,  int  otm_idx_0,  int  otm_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_OFP_RATE_DB__OTM__CAL_INSTANCE, ((dnx_ofp_rate_db_t*)sw_state_roots_array[unit][DNX_OFP_RATE_MODULE_ID])->otm[i0]))
            {
                LOG_CLI((BSL_META("dnx_ofp_rate_db[]->((dnx_ofp_rate_db_t*)sw_state_roots_array[][DNX_OFP_RATE_MODULE_ID])->otm[][].cal_instance: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_OFP_RATE_DB__OTM__CAL_INSTANCE, ((dnx_ofp_rate_db_t*)sw_state_roots_array[unit][DNX_OFP_RATE_MODULE_ID])->otm[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_ofp_rate_db_otm_shaping_rate_dump(int  unit,  int  otm_idx_0,  int  otm_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_OFP_RATE_DB__OTM__SHAPING__RATE, ((dnx_ofp_rate_db_t*)sw_state_roots_array[unit][DNX_OFP_RATE_MODULE_ID])->otm[i0]))
            {
                LOG_CLI((BSL_META("dnx_ofp_rate_db[]->((dnx_ofp_rate_db_t*)sw_state_roots_array[][DNX_OFP_RATE_MODULE_ID])->otm[][].shaping.rate: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_OFP_RATE_DB__OTM__SHAPING__RATE, ((dnx_ofp_rate_db_t*)sw_state_roots_array[unit][DNX_OFP_RATE_MODULE_ID])->otm[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_ofp_rate_db_otm_shaping_burst_dump(int  unit,  int  otm_idx_0,  int  otm_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_OFP_RATE_DB__OTM__SHAPING__BURST, ((dnx_ofp_rate_db_t*)sw_state_roots_array[unit][DNX_OFP_RATE_MODULE_ID])->otm[i0]))
            {
                LOG_CLI((BSL_META("dnx_ofp_rate_db[]->((dnx_ofp_rate_db_t*)sw_state_roots_array[][DNX_OFP_RATE_MODULE_ID])->otm[][].shaping.burst: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_OFP_RATE_DB__OTM__SHAPING__BURST, ((dnx_ofp_rate_db_t*)sw_state_roots_array[unit][DNX_OFP_RATE_MODULE_ID])->otm[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_ofp_rate_db_otm_shaping_valid_dump(int  unit,  int  otm_idx_0,  int  otm_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_OFP_RATE_DB__OTM__SHAPING__VALID, ((dnx_ofp_rate_db_t*)sw_state_roots_array[unit][DNX_OFP_RATE_MODULE_ID])->otm[i0]))
            {
                LOG_CLI((BSL_META("dnx_ofp_rate_db[]->((dnx_ofp_rate_db_t*)sw_state_roots_array[][DNX_OFP_RATE_MODULE_ID])->otm[][].shaping.valid: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_OFP_RATE_DB__OTM__SHAPING__VALID, ((dnx_ofp_rate_db_t*)sw_state_roots_array[unit][DNX_OFP_RATE_MODULE_ID])->otm[i0]) == 0)
            {
                SHR_EXIT();
            }
