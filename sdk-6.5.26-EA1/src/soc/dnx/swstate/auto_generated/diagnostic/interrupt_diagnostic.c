...
intr_db_flags_dump(int  unit,  int  flags_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_INTR_DB__FLAGS, ((soc_dnx_intr_t*)sw_state_roots_array[unit][INTERRUPT_MODULE_ID])->flags))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_INTR_DB__FLAGS, ((soc_dnx_intr_t*)sw_state_roots_array[unit][INTERRUPT_MODULE_ID])->flags) == 0)
        {
            SHR_EXIT();
        }
...
intr_db_storm_timed_count_dump(int  unit,  int  storm_timed_count_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_INTR_DB__STORM_TIMED_COUNT, ((soc_dnx_intr_t*)sw_state_roots_array[unit][INTERRUPT_MODULE_ID])->storm_timed_count))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_INTR_DB__STORM_TIMED_COUNT, ((soc_dnx_intr_t*)sw_state_roots_array[unit][INTERRUPT_MODULE_ID])->storm_timed_count) == 0)
        {
            SHR_EXIT();
        }
...
intr_db_storm_timed_period_dump(int  unit,  int  storm_timed_period_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_INTR_DB__STORM_TIMED_PERIOD, ((soc_dnx_intr_t*)sw_state_roots_array[unit][INTERRUPT_MODULE_ID])->storm_timed_period))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_INTR_DB__STORM_TIMED_PERIOD, ((soc_dnx_intr_t*)sw_state_roots_array[unit][INTERRUPT_MODULE_ID])->storm_timed_period) == 0)
        {
            SHR_EXIT();
        }
