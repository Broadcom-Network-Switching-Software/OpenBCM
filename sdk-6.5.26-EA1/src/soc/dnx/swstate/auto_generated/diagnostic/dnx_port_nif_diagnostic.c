...
dnx_port_nif_db_arb_link_list_nof_sections_allocated_dump(int  unit,  int  nof_sections_allocated_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_PORT_NIF_DB__ARB_LINK_LIST__NOF_SECTIONS_ALLOCATED, ((dnx_port_nif_db_t*)sw_state_roots_array[unit][DNX_PORT_NIF_MODULE_ID])->arb_link_list.nof_sections_allocated))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_PORT_NIF_DB__ARB_LINK_LIST__NOF_SECTIONS_ALLOCATED, ((dnx_port_nif_db_t*)sw_state_roots_array[unit][DNX_PORT_NIF_MODULE_ID])->arb_link_list.nof_sections_allocated) == 0)
        {
            SHR_EXIT();
        }
...
dnx_port_nif_db_oft_link_list_nof_sections_allocated_dump(int  unit,  int  nof_sections_allocated_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_PORT_NIF_DB__OFT_LINK_LIST__NOF_SECTIONS_ALLOCATED, ((dnx_port_nif_db_t*)sw_state_roots_array[unit][DNX_PORT_NIF_MODULE_ID])->oft_link_list.nof_sections_allocated))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_PORT_NIF_DB__OFT_LINK_LIST__NOF_SECTIONS_ALLOCATED, ((dnx_port_nif_db_t*)sw_state_roots_array[unit][DNX_PORT_NIF_MODULE_ID])->oft_link_list.nof_sections_allocated) == 0)
        {
            SHR_EXIT();
        }
...
dnx_port_nif_db_ofr_link_list_nof_sections_allocated_dump(int  unit,  int  nof_sections_allocated_idx_0,  int  nof_sections_allocated_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_PORT_NIF_DB__OFR_LINK_LIST__NOF_SECTIONS_ALLOCATED, ((dnx_port_nif_db_t*)sw_state_roots_array[unit][DNX_PORT_NIF_MODULE_ID])->ofr_link_list.nof_sections_allocated))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_PORT_NIF_DB__OFR_LINK_LIST__NOF_SECTIONS_ALLOCATED, ((dnx_port_nif_db_t*)sw_state_roots_array[unit][DNX_PORT_NIF_MODULE_ID])->ofr_link_list.nof_sections_allocated) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_PORT_NIF_DB__OFR_LINK_LIST__NOF_SECTIONS_ALLOCATED, ((dnx_port_nif_db_t*)sw_state_roots_array[unit][DNX_PORT_NIF_MODULE_ID])->ofr_link_list.nof_sections_allocated[i0]))
            {
                LOG_CLI((BSL_META("dnx_port_nif_db[]->((dnx_port_nif_db_t*)sw_state_roots_array[][DNX_PORT_NIF_MODULE_ID])->ofr_link_list.nof_sections_allocated[][]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_PORT_NIF_DB__OFR_LINK_LIST__NOF_SECTIONS_ALLOCATED, ((dnx_port_nif_db_t*)sw_state_roots_array[unit][DNX_PORT_NIF_MODULE_ID])->ofr_link_list.nof_sections_allocated[i0]) == 0)
            {
                SHR_EXIT();
            }
