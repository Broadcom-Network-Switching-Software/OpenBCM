...
int
dbal_db_field_names_override_locations_create(int unit, sw_state_htbl_init_info_t *init_info)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
...
int
dbal_db_field_names_override_locations_get_next(int unit, SW_STATE_HASH_TABLE_ITER *iter, const dbal_fields_e *key, const uint32 *data_index)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
