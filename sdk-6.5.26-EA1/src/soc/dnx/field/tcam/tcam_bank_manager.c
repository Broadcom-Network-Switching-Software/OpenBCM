    ...
    dnx_field_tcam_access_fg_params_t * fg_params)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_tcam_bank_algo_get_owner_stage(unit, bank_id, core_id, &bank_owner_stage));
    ...
    bcm_core_t core_id)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_tcam_bank_sw.tcam_banks.owner_stage.set(unit, bank_id, core_id, fg_params.stage));
    ...
    if (handler_node != SW_STATE_LL_INVALID)
    {
        *found = TRUE;
        ...
        if (list_size == 0)
        {
            ...
            SHR_IF_ERR_EXIT(dnx_field_tcam_bank_sw.tcam_banks.
                            owner_stage.set(unit, bank_id, core_id, DNX_FIELD_TCAM_STAGE_INVALID));
    ...
    bcm_core_t core_ids[])
{
    ...
    DNXCMN_CORES_ITER(unit, core_ids[0], core_iter)
    {

        SHR_IF_ERR_EXIT(dnx_field_tcam_access_sw.fg_prefix_per_core.get(unit, handler_id, core_iter, &prefix_value));
    }
