    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_ingr_reassembly_context_reassembly_to_in_cgm_port_mapping].doc = "Reassembly is not sent directly to CGM (PP port override) but it is mapped to internal port";
    ...
    submodule_data->defines[dnx_data_ingr_reassembly_context_define_reassembly_timeout].doc = "value of timeout period for reassembly controller";
    ...
    submodule_data->tables[dnx_data_ingr_reassembly_context_table_context_map].keys[1].doc = "is management port";
