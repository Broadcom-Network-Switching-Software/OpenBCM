    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_fc_general_qmlf_rmcs_thresholds_per_profile_support].doc = "QMLF RMCs thresholds are set in profiles and a profile is chosen for each RMC";
    ...
    submodule_data->defines[dnx_data_fc_general_define_nof_rmc_thresholds_profiles].doc = "Number of QMLF thresholds profiles.";
    ...
    submodule_data->defines[dnx_data_fc_general_define_rmc_pfc_set_threshold_default].doc = "PFC SET QMLF threshold default value.";
    ...
    submodule_data->defines[dnx_data_fc_general_define_rmc_pfc_clear_threshold_default].doc = "PFC CLEAR QMLF threshold default value.";
    ...
    submodule_data->defines[dnx_data_fc_general_define_rmc_llfc_set_threshold_default].doc = "LLFC SET QMLF threshold default value.";
    ...
    submodule_data->defines[dnx_data_fc_general_define_rmc_llfc_clear_threshold_default].doc = "LLFC CLEAR QMLF threshold default value.";
    ...
    submodule_data->defines[dnx_data_fc_general_define_nof_bits_in_nif_eth_rmc_id].doc = "Number of bits in RMC ID for NIF Ethernet ports.";
