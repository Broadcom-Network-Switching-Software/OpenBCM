...
static shr_error_e
q2a_a0_dnx_data_crps_expansion_source_metadata_types_set(
    int unit)
{
    int source_index;
...
static shr_error_e
q2a_a0_dnx_data_crps_expansion_source_expansion_info_set(
    int unit)
{
    int source_index;
    ...
    int unit)
{
    ...
    table = &submodule->tables[data_index];
    table->set = q2a_a0_dnx_data_crps_expansion_source_metadata_types_set;
    data_index = dnx_data_crps_expansion_table_source_expansion_info;
    table = &submodule->tables[data_index];
    table->set = q2a_a0_dnx_data_crps_expansion_source_expansion_info_set;
