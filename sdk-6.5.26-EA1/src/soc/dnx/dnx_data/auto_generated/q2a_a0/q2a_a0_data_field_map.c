...
static shr_error_e
q2a_a0_dnx_data_field_map_action_params_set(
    int unit)
{
    int stage_index;
    int action_index;
...
static shr_error_e
q2a_a0_dnx_data_field_map_qual_params_set(
    int unit)
{
    int stage_index;
    int qual_index;
    ...
    {
        data = (dnx_data_field_map_qual_params_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_FIELD_STAGE_IPMF2, DNX_FIELD_QUAL_STATE_ADDRESS);
        data->offset = 925;
...
static shr_error_e
q2a_a0_dnx_data_field_map_qual_special_metadata_qual_set(
    int unit)
{
    int stage_index;
    int qual_index;
...
static shr_error_e
q2a_a0_dnx_data_field_map_qual_layer_record_info_ingress_set(
    int unit)
{
...
static shr_error_e
q2a_a0_dnx_data_field_map_qual_layer_record_info_egress_set(
    int unit)
{
    int layer_record_index;
    ...
    int unit)
{
    ...
    table->set = q2a_a0_dnx_data_field_map_action_params_set;
    ...
    table = &submodule->tables[data_index];
    table->set = q2a_a0_dnx_data_field_map_qual_params_set;
    data_index = dnx_data_field_map_qual_table_special_metadata_qual;
    table = &submodule->tables[data_index];
    table->set = q2a_a0_dnx_data_field_map_qual_special_metadata_qual_set;
    data_index = dnx_data_field_map_qual_table_layer_record_info_ingress;
    table = &submodule->tables[data_index];
    table->set = q2a_a0_dnx_data_field_map_qual_layer_record_info_ingress_set;
    data_index = dnx_data_field_map_qual_table_layer_record_info_egress;
    table = &submodule->tables[data_index];
    table->set = q2a_a0_dnx_data_field_map_qual_layer_record_info_egress_set;
