...
static shr_error_e
q2a_a0_dnx_data_adapter_rx_constant_header_size_set(
    int unit)
{
...
static shr_error_e
q2a_a0_dnx_data_adapter_general_lib_ver_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
q2a_a0_dnx_data_adapter_general_oamp_ms_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
q2a_a0_dnx_data_adapter_general_tx_packet_header_signal_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
q2a_a0_dnx_data_adapter_general_tx_packet_tag_swap_res_signal_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
q2a_a0_dnx_data_adapter_general_tx_packet_recycle_command_signal_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
q2a_a0_dnx_data_adapter_general_tx_packet_recycle_context_signal_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
q2a_a0_dnx_data_adapter_general_tx_packet_valid_bytes_signal_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
q2a_a0_dnx_data_adapter_general_tx_packet_header_signal_width_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
q2a_a0_dnx_data_adapter_general_tx_packet_tag_swap_res_signal_width_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
q2a_a0_dnx_data_adapter_general_tx_packet_recycle_command_signal_width_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
q2a_a0_dnx_data_adapter_general_tx_packet_recycle_context_signal_width_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
q2a_a0_dnx_data_adapter_general_tx_packet_valid_bytes_signal_width_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
q2a_a0_dnx_data_adapter_general_Injection_set(
    int unit)
{
    ...
    table->values[0].default_val = "PRSR_Q2A_A0";
    ...
    default_data->Injected_packet_name = "PRSR_Q2A_A0";
...
static shr_error_e
q2a_a0_dnx_data_adapter_reg_mem_access_cmic_block_index_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
q2a_a0_dnx_data_adapter_reg_mem_access_iproc_block_index_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_adapter;
...
static shr_error_e
q2a_a0_dnx_data_adapter_mdb_lookup_caller_id_mapping_key_map(
    int unit,
    int key0_val,
    int key1_val,
    int *key0_index,
    int *key1_index)
{
    ...
    switch (key1_val)
    {
        ...
        case DNX_PP_STAGE_IPMF2+100*DBAL_PHYSICAL_TABLE_SEXEM_3:
            *key1_index = 6;
            break;
        case DNX_PP_STAGE_EPMF+100*DNX_PP_STAGE_IPMF3:
            *key1_index = 7;
            break;
        ...
        case DNX_PP_STAGE_EPMF+100*DBAL_PHYSICAL_TABLE_LEXEM:
            *key1_index = 22;
            break;
        case DNX_PP_STAGE_IFWD2+100*DBAL_PHYSICAL_TABLE_EOEM_1:
            *key1_index = 23;
            break;
...
static shr_error_e
q2a_a0_dnx_data_adapter_mdb_lookup_caller_id_mapping_key_reverse_map(
    int unit,
    int key0_index,
    int key1_index,
    int *key0_val,
    ...
    switch (key1_index)
    {
        ...
        case 6:
            *key1_val = DNX_PP_STAGE_IPMF2+100*DBAL_PHYSICAL_TABLE_SEXEM_3;
            break;
        case 7:
            *key1_val = DNX_PP_STAGE_EPMF+100*DNX_PP_STAGE_IPMF3;
            break;
        case 8:
        ...
        case 22:
            *key1_val = DNX_PP_STAGE_EPMF+100*DBAL_PHYSICAL_TABLE_LEXEM;
            break;
        case 23:
            *key1_val = DNX_PP_STAGE_IFWD2+100*DBAL_PHYSICAL_TABLE_EOEM_1;
            break;
        case 24:
...
static shr_error_e
q2a_a0_dnx_data_adapter_mdb_lookup_caller_id_mapping_set(
    int unit)
{
    int caller_id_index;
    ...
    table->key_map = q2a_a0_dnx_data_adapter_mdb_lookup_caller_id_mapping_key_map;
    table->key_map_reverse = q2a_a0_dnx_data_adapter_mdb_lookup_caller_id_mapping_key_reverse_map;
    ...
    data->mdb = DBAL_PHYSICAL_TABLE_TCAM;
    data->interface = "UnknownInterface";
    data = (dnx_data_adapter_mdb_lookup_caller_id_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 164, DNX_PP_STAGE_IFWD2+100*DBAL_PHYSICAL_TABLE_EOEM_1);
    ...
    data->mdb = DBAL_PHYSICAL_TABLE_TCAM;
    data->interface = "UnknownInterface";
    data = (dnx_data_adapter_mdb_lookup_caller_id_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 241, DNX_PP_STAGE_IPMF1+100*DBAL_PHYSICAL_TABLE_LEXEM);
    data->stage = DNX_PP_STAGE_IPMF1;
    data->mdb = DBAL_PHYSICAL_TABLE_LEXEM;
    data->interface = "UnknownInterface";
    ...
    data->mdb = DBAL_PHYSICAL_TABLE_LEXEM;
    data->interface = "UnknownInterface";
    data = (dnx_data_adapter_mdb_lookup_caller_id_mapping_t *) dnxc_data_mgmt_table_data_get(unit, table, 12, DNX_PP_STAGE_EPMF+100*DNX_PP_STAGE_IPMF3);
    data->stage = DNX_PP_STAGE_IPMF3;
    data->mdb = DBAL_PHYSICAL_TABLE_LEXEM;
    data->interface = "UnknownInterface";
    ...
    int unit)
{
    ...
    define->set = q2a_a0_dnx_data_adapter_rx_constant_header_size_set;
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_adapter_general_lib_ver_set;
    data_index = dnx_data_adapter_general_define_oamp_ms_id;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_adapter_general_oamp_ms_id_set;
    data_index = dnx_data_adapter_general_define_tx_packet_header_signal_id;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_adapter_general_tx_packet_header_signal_id_set;
    data_index = dnx_data_adapter_general_define_tx_packet_tag_swap_res_signal_id;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_adapter_general_tx_packet_tag_swap_res_signal_id_set;
    data_index = dnx_data_adapter_general_define_tx_packet_recycle_command_signal_id;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_adapter_general_tx_packet_recycle_command_signal_id_set;
    data_index = dnx_data_adapter_general_define_tx_packet_recycle_context_signal_id;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_adapter_general_tx_packet_recycle_context_signal_id_set;
    data_index = dnx_data_adapter_general_define_tx_packet_valid_bytes_signal_id;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_adapter_general_tx_packet_valid_bytes_signal_id_set;
    data_index = dnx_data_adapter_general_define_tx_packet_header_signal_width;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_adapter_general_tx_packet_header_signal_width_set;
    data_index = dnx_data_adapter_general_define_tx_packet_tag_swap_res_signal_width;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_adapter_general_tx_packet_tag_swap_res_signal_width_set;
    data_index = dnx_data_adapter_general_define_tx_packet_recycle_command_signal_width;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_adapter_general_tx_packet_recycle_command_signal_width_set;
    data_index = dnx_data_adapter_general_define_tx_packet_recycle_context_signal_width;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_adapter_general_tx_packet_recycle_context_signal_width_set;
    data_index = dnx_data_adapter_general_define_tx_packet_valid_bytes_signal_width;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_adapter_general_tx_packet_valid_bytes_signal_width_set;
    ...
    table->set = q2a_a0_dnx_data_adapter_general_Injection_set;
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_adapter_reg_mem_access_cmic_block_index_set;
    data_index = dnx_data_adapter_reg_mem_access_define_iproc_block_index;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_adapter_reg_mem_access_iproc_block_index_set;
    ...
    table = &submodule->tables[data_index];
    table->set = q2a_a0_dnx_data_adapter_mdb_lookup_caller_id_mapping_set;
