...
static shr_error_e
q2a_a0_dnx_data_srv6_termination_max_nof_terminated_sids_usd_1pass_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_srv6;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_srv6_termination_max_nof_terminated_sids_usd_1pass_set;
