...
static shr_error_e
q2a_a0_dnx_data_switch_load_balancing_padded_layers_crc_buffer_set(
    int unit)
{
...
static shr_error_e
q2a_a0_dnx_data_switch_load_balancing_wide_hash_buffer_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_switch;
...
static shr_error_e
q2a_a0_dnx_data_switch_load_balancing_nof_lb_mpls_stack_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_switch;
...
static shr_error_e
q2a_a0_dnx_data_switch_load_balancing_sim_device_enum_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_switch;
    ...
    int unit)
{
    ...
    define->set = q2a_a0_dnx_data_switch_load_balancing_padded_layers_crc_buffer_set;
    data_index = dnx_data_switch_load_balancing_define_wide_hash_buffer;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_switch_load_balancing_wide_hash_buffer_set;
    data_index = dnx_data_switch_load_balancing_define_nof_lb_mpls_stack;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_switch_load_balancing_nof_lb_mpls_stack_set;
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_switch_load_balancing_sim_device_enum_set;
