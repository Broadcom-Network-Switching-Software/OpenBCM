...
static shr_error_e
q2a_a0_dnx_data_elk_general_back_pressure_bit_exists_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_elk;
    int submodule_index = dnx_data_elk_submodule_general;
    int feature_index = dnx_data_elk_general_back_pressure_bit_exists;
    ...
    int unit)
{
    ...
    data_index = dnx_data_elk_general_back_pressure_bit_exists;
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_elk_general_back_pressure_bit_exists_set;
