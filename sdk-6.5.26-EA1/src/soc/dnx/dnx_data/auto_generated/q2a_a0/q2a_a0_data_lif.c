...
static shr_error_e
q2a_a0_dnx_data_lif_in_lif_use_in_lif_profile_range_allocation_per_pmf_profiles_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_lif;
    ...
    int unit)
{
    ...
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_lif_in_lif_use_in_lif_profile_range_allocation_per_pmf_profiles_set;
