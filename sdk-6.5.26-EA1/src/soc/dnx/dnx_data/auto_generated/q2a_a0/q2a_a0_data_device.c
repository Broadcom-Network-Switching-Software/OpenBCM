...
static shr_error_e
q2a_a0_dnx_data_device_general_fai_unknown_address_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_device;
...
static shr_error_e
q2a_a0_dnx_data_device_general_disable_maximal_core_bandwidth_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_device;
    int submodule_index = dnx_data_device_submodule_general;
    int feature_index = dnx_data_device_general_disable_maximal_core_bandwidth_support;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
q2a_a0_dnx_data_device_general_enforce_maximal_core_bandwidth_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_device;
    ...
    define->property.doc = 
        "\n"
        "This custom feature defines SDK behavior when user tries to define ports with total speed that exceeds the max bandiwdth limit.\n"
        "0 = only print a warning to log\n"
        "1 = return an error\n"
        "\n"
    ;
    define->property.method = dnxc_data_property_method_suffix_enable;
    define->property.method_str = "suffix_enable";
    define->property.suffix = "enforce_maximal_core_bandwidth";
...
static shr_error_e
q2a_a0_dnx_data_device_otp_otp_instance_attributes_set(
    int unit)
{
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_device_general_enforce_maximal_core_bandwidth_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_device_general_fai_unknown_address_supported_set;
    data_index = dnx_data_device_general_disable_maximal_core_bandwidth_support;
    feature = &submodule->features[data_index];
    feature->set = q2a_a0_dnx_data_device_general_disable_maximal_core_bandwidth_support_set;
    ...
    table = &submodule->tables[data_index];
    table->set = q2a_a0_dnx_data_device_otp_otp_instance_attributes_set;
