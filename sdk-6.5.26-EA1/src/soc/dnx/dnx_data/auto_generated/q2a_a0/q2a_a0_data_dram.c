...
static shr_error_e
q2a_a0_dnx_data_dram_gddr6_ck_termination_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
    int submodule_index = dnx_data_dram_submodule_gddr6;
    int define_index = dnx_data_dram_gddr6_define_ck_termination;
    SHR_FUNC_INIT_VARS(unit);
    ...
    define->property.doc = 
        "\n"
        "Determines CK line termination. See GDDR6 JEDEC for details\n"
        "\n"
    ;
    ...
    int unit)
{
    ...
    define->property.doc = 
        "\n"
        "Determines WCK granularity. See GDDR6 JEDEC for details.\n"
        "\n"
    ;
    define->property.method = dnxc_data_property_method_direct_map;
    define->property.method_str = "direct_map";
...
static shr_error_e
q2a_a0_dnx_data_dram_general_info_dram_bitmap_internal_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
...
static shr_error_e
q2a_a0_dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_set(
    int unit)
{
    int index_index;
    dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnx_data_module_dram;
    int submodule_index = dnx_data_dram_submodule_dram_block;
    int table_index = dnx_data_dram_dram_block_table_gddr6_average_read_inflights_leaky_bucket_config_params;
    SHR_FUNC_INIT_VARS(unit);
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_t, (1 * (table->keys[0].size) + 1  ), "data of dnx_data_dram_dram_block_table_gddr6_average_read_inflights_leaky_bucket_config_params");

    
    default_data = (dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    default_data->dbal_field_id = -1;
    default_data->field_val = -1;
    
    for (index_index = 0; index_index < table->keys[0].size; index_index++)
    {
        data = (dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_t *) dnxc_data_mgmt_table_data_get(unit, table, index_index, 0);
        sal_memcpy(data, default_data, table->size_of_values);
    }
    
    if (0 < table->keys[0].size)
    {
        data = (dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_t *) dnxc_data_mgmt_table_data_get(unit, table, 0, 0);
        data->dbal_field_id = DBAL_FIELD_LEAKY_BUCKET_EN;
        data->field_val = 1;
    }
    if (1 < table->keys[0].size)
    {
        data = (dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_t *) dnxc_data_mgmt_table_data_get(unit, table, 1, 0);
        data->dbal_field_id = DBAL_FIELD_LEAKY_BUCKET_INCREMENT_THRESHOLD_0;
        data->field_val = 450;
    }
    if (2 < table->keys[0].size)
    {
        data = (dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_t *) dnxc_data_mgmt_table_data_get(unit, table, 2, 0);
        data->dbal_field_id = DBAL_FIELD_LEAKY_BUCKET_INCREMENT_THRESHOLD_1;
        data->field_val = 500;
    }
    if (3 < table->keys[0].size)
    {
        data = (dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_t *) dnxc_data_mgmt_table_data_get(unit, table, 3, 0);
        data->dbal_field_id = DBAL_FIELD_LEAKY_BUCKET_INCREMENT_THRESHOLD_2;
        data->field_val = 550;
    }
    if (4 < table->keys[0].size)
    {
        data = (dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_t *) dnxc_data_mgmt_table_data_get(unit, table, 4, 0);
        data->dbal_field_id = DBAL_FIELD_LEAKY_BUCKET_INCREMENT_SIZE_0;
        data->field_val = 2;
    }
    if (5 < table->keys[0].size)
    {
        data = (dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_t *) dnxc_data_mgmt_table_data_get(unit, table, 5, 0);
        data->dbal_field_id = DBAL_FIELD_LEAKY_BUCKET_INCREMENT_SIZE_1;
        data->field_val = 4;
    }
    if (6 < table->keys[0].size)
    {
        data = (dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_t *) dnxc_data_mgmt_table_data_get(unit, table, 6, 0);
        data->dbal_field_id = DBAL_FIELD_LEAKY_BUCKET_INCREMENT_SIZE_2;
        data->field_val = 8;
    }
    if (7 < table->keys[0].size)
    {
        data = (dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_t *) dnxc_data_mgmt_table_data_get(unit, table, 7, 0);
        data->dbal_field_id = DBAL_FIELD_LEAKY_BUCKET_DECREMENT_THRESHOLD_0;
        data->field_val = 450;
    }
    if (8 < table->keys[0].size)
    {
        data = (dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_t *) dnxc_data_mgmt_table_data_get(unit, table, 8, 0);
        data->dbal_field_id = DBAL_FIELD_LEAKY_BUCKET_DECREMENT_THRESHOLD_1;
        data->field_val = 400;
    }
    if (9 < table->keys[0].size)
    {
        data = (dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_t *) dnxc_data_mgmt_table_data_get(unit, table, 9, 0);
        data->dbal_field_id = DBAL_FIELD_LEAKY_BUCKET_DECREMENT_THRESHOLD_2;
        data->field_val = 350;
    }
    if (10 < table->keys[0].size)
    {
        data = (dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_t *) dnxc_data_mgmt_table_data_get(unit, table, 10, 0);
        data->dbal_field_id = DBAL_FIELD_LEAKY_BUCKET_DECREMENT_SIZE_0;
        data->field_val = 1;
    }
    if (11 < table->keys[0].size)
    {
        data = (dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_t *) dnxc_data_mgmt_table_data_get(unit, table, 11, 0);
        data->dbal_field_id = DBAL_FIELD_LEAKY_BUCKET_DECREMENT_SIZE_1;
        data->field_val = 2;
    }
    if (12 < table->keys[0].size)
    {
        data = (dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_t *) dnxc_data_mgmt_table_data_get(unit, table, 12, 0);
        data->dbal_field_id = DBAL_FIELD_LEAKY_BUCKET_DECREMENT_SIZE_2;
        data->field_val = 4;
    }
    if (13 < table->keys[0].size)
    {
        data = (dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_t *) dnxc_data_mgmt_table_data_get(unit, table, 13, 0);
        data->dbal_field_id = DBAL_FIELD_LEAKY_BUCKET_FULL_SIZE;
        data->field_val = 40;
    }
    if (14 < table->keys[0].size)
    {
        data = (dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_t *) dnxc_data_mgmt_table_data_get(unit, table, 14, 0);
        data->dbal_field_id = DBAL_FIELD_LEAKY_BUCKET_ASSERT_THRESHOLD;
        data->field_val = 24;
    }
    if (15 < table->keys[0].size)
    {
        data = (dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_t *) dnxc_data_mgmt_table_data_get(unit, table, 15, 0);
        data->dbal_field_id = DBAL_FIELD_LEAKY_BUCKET_DEASSERT_THRESHOLD;
        data->field_val = 4;
    }
    if (16 < table->keys[0].size)
    {
        data = (dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_t *) dnxc_data_mgmt_table_data_get(unit, table, 16, 0);
        data->dbal_field_id = DBAL_FIELD_LEAKY_BUCKET_RESET_ON_DEASSERT;
        data->field_val = 0;
    }
    if (17 < table->keys[0].size)
    {
        data = (dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_t *) dnxc_data_mgmt_table_data_get(unit, table, 17, 0);
        data->dbal_field_id = DBAL_FIELD_LEAKY_BUCKET_WINDOW_SIZE_LOG_2;
        data->field_val = 12;
    }
    ...
    int unit)
{
    ...
    data_index = dnx_data_dram_gddr6_define_ck_termination;
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_dram_gddr6_ck_termination_set;
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_a0_dnx_data_dram_general_info_dram_bitmap_internal_set;
    ...
    data_index = dnx_data_dram_dram_block_table_gddr6_average_read_inflights_leaky_bucket_config_params;
    table = &submodule->tables[data_index];
    table->set = q2a_a0_dnx_data_dram_dram_block_gddr6_average_read_inflights_leaky_bucket_config_params_set;
