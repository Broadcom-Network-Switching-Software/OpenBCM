    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_tune_ecgm_define_core_flow_control_percentage_ratio].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_tune_ecgm_define_port_queue_uc_flow_control_min_thresh].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_tune_ecgm_define_total_dbs].doc = "total data buffers";
    ...
    submodule_data->defines[dnx_data_tune_ecgm_define_uc_pool_size_global_core_th].doc = "Threshold value for pool unicast size";
    ...
    submodule_data->defines[dnx_data_tune_ecgm_define_mc_pool_size_global_core_th].doc = "Threshold value for pool multicast size";
    ...
    submodule_data->defines[dnx_data_tune_ecgm_define_mc_drop_global_core_th].doc = "Global core multicast drop threshold";
    ...
    submodule_data->defines[dnx_data_tune_ecgm_define_uc_fc_global_core_th].doc = "Global core unicast flow control threhold";
    ...
    submodule_data->tables[dnx_data_tune_ecgm_table_port_dp_ratio].labels[0] = "j2x_notrev";
    ...
    submodule_data->tables[dnx_data_tune_ecgm_table_tc_dp_fadt_th].doc = "tc dp unicast and multicast fadt tune values mapping";
    ...
    submodule_data->tables[dnx_data_tune_ecgm_table_tc_dp_fadt_th].keys[0].doc = "unicast or multicast";
    submodule_data->tables[dnx_data_tune_ecgm_table_tc_dp_fadt_th].keys[1].name = "tc_level";
    submodule_data->tables[dnx_data_tune_ecgm_table_tc_dp_fadt_th].keys[1].doc = "tc value high or low";
    ...
    submodule_data->tables[dnx_data_tune_ecgm_table_tc_dp_fadt_th].values[0].doc = "Min value for th";
    ...
    submodule_data->tables[dnx_data_tune_ecgm_table_tc_dp_fadt_th].values[1].doc = "Max value for th";
    ...
    submodule_data->tables[dnx_data_tune_ecgm_table_tc_dp_fadt_th].values[2].doc = "Alpha value for th";
    ...
    submodule_data->tables[dnx_data_tune_ecgm_table_tc_dp_fadt_th].values[3].doc = "Alpha1 value for th";
    ...
    submodule_data->tables[dnx_data_tune_ecgm_table_interface_general_fadt_th].doc = "general interface enq drop, enq fc hige and enq fc low thresholds";
    ...
    submodule_data->tables[dnx_data_tune_ecgm_table_interface_general_fadt_th].keys[0].doc = "threshold type index";
    submodule_data->tables[dnx_data_tune_ecgm_table_interface_general_fadt_th].keys[1].name = "port_rate";
    submodule_data->tables[dnx_data_tune_ecgm_table_interface_general_fadt_th].keys[1].doc = "port rate";
    ...
    submodule_data->tables[dnx_data_tune_ecgm_table_interface_general_fadt_th].values[0].doc = "Min value for th";
    ...
    submodule_data->tables[dnx_data_tune_ecgm_table_interface_general_fadt_th].values[1].doc = "Max value for th";
    ...
    submodule_data->tables[dnx_data_tune_ecgm_table_interface_general_fadt_th].values[2].doc = "Alpha value for th";
    ...
    submodule_data->tables[dnx_data_tune_ecgm_table_interface_general_fadt_th].values[3].doc = "Alpha1 value for th";
    ...
    submodule_data->tables[dnx_data_tune_ecgm_table_interface_rcy_fadt_th].doc = "recycle interface enq drop, enq fc hige and enq fc low thresholds";
    ...
    submodule_data->tables[dnx_data_tune_ecgm_table_interface_rcy_fadt_th].keys[0].doc = "threshold type index";
    ...
    submodule_data->tables[dnx_data_tune_ecgm_table_interface_rcy_fadt_th].values[0].doc = "Min value for th";
    ...
    submodule_data->tables[dnx_data_tune_ecgm_table_interface_rcy_fadt_th].values[1].doc = "Max value for th";
    ...
    submodule_data->tables[dnx_data_tune_ecgm_table_interface_rcy_fadt_th].values[2].doc = "Alpha value for th";
    ...
    submodule_data->tables[dnx_data_tune_ecgm_table_interface_rcy_fadt_th].values[3].doc = "Alpha1 value for th";
    ...
    submodule_data->tables[dnx_data_tune_ecgm_table_interface_cpu_fadt_th].doc = "cpu interface enq drop, enq fc hige and enq fc low thresholds";
    ...
    submodule_data->tables[dnx_data_tune_ecgm_table_interface_cpu_fadt_th].keys[0].doc = "threshold type index";
    ...
    submodule_data->tables[dnx_data_tune_ecgm_table_interface_cpu_fadt_th].values[0].doc = "Min value for th";
    ...
    submodule_data->tables[dnx_data_tune_ecgm_table_interface_cpu_fadt_th].values[1].doc = "Max value for th";
    ...
    submodule_data->tables[dnx_data_tune_ecgm_table_interface_cpu_fadt_th].values[2].doc = "Alpha value for th";
    ...
    submodule_data->tables[dnx_data_tune_ecgm_table_interface_cpu_fadt_th].values[3].doc = "Alpha1 value for th";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_tune_fabric_cgm_rci_update_egress_th_values].doc = "Update default values for RCI egress thresholds.";
    ...
    submodule_data->defines[dnx_data_tune_fabric_define_cgm_rci_egress_pipe_level_th_base].doc = "base threshold for bcmFabricCgmRciEgressPipeLevelTh";
    ...
    submodule_data->defines[dnx_data_tune_fabric_define_cgm_rci_egress_pipe_level_th_offset].doc = "offset threshold for bcmFabricCgmRciEgressPipeLevelTh";
    ...
    submodule_data->defines[dnx_data_tune_fabric_define_cgm_rci_total_egress_pipe_level_th_base].doc = "base threshold for bcmFabricCgmRciTotalEgressPipeLevelTh";
    ...
    submodule_data->defines[dnx_data_tune_fabric_define_cgm_rci_total_egress_pipe_level_th_offset].doc = "offset threshold for bcmFabricCgmRciTotalEgressPipeLevelTh";
    ...
    submodule_data->tables[dnx_data_tune_fabric_table_cgm_drop_fabric_multicast_th].doc = "Stores the thresholds for all priorities on MC.";
    ...
    submodule_data->tables[dnx_data_tune_fabric_table_cgm_drop_fabric_multicast_th].keys[0].doc = "Fabric priority";
    ...
    submodule_data->tables[dnx_data_tune_fabric_table_cgm_drop_fabric_multicast_th].values[0].doc = "Threshold value";
    ...
    submodule_data->tables[dnx_data_tune_fabric_table_cgm_rci_egress_level_factor].doc = "Stores the scores for all levels [0-2].";
    ...
    submodule_data->tables[dnx_data_tune_fabric_table_cgm_rci_egress_level_factor].keys[0].doc = "Fabric level";
    ...
    submodule_data->tables[dnx_data_tune_fabric_table_cgm_rci_egress_level_factor].values[0].doc = "Score value";
