...
static shr_error_e
q2a_b0_dnx_data_dram_gddr6_enable_temp_read_samsung_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_dram;
...
static shr_error_e
q2a_b0_dnx_data_dram_general_info_crc_read_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_dram;
    ...
    int unit)
{
    ...
    feature = &submodule->features[data_index];
    feature->set = q2a_b0_dnx_data_dram_gddr6_enable_temp_read_samsung_set;
    ...
    define = &submodule->defines[data_index];
    define->set = q2a_b0_dnx_data_dram_general_info_crc_read_set;
