    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_l2_general_learn_payload_res_optimize].doc = "Indicate if learn payload reesources optimize";
    ...
    submodule_data->tables[dnx_data_l2_general_table_lem_table_map_l2_action].doc = "Mapping from logical dbal table to L2 action";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_l2_age_and_flush_machine_define_traverse_thread_priority].doc = "L2 flush match traverse non-blocking thread priority.";
    ...
    submodule_data->tables[dnx_data_l2_age_and_flush_machine_table_flush_pulse].doc = "Flush machine pulse reg maping";
