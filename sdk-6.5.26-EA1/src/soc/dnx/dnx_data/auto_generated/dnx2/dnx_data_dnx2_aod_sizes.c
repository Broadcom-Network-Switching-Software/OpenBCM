    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_aod_sizes_AOD_define_TDM_TRAP_CANDIDATE_HEADER].doc = "TDM_TRAP_CANDIDATE_HEADER bits size";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->defines[dnx_data_dnx2_aod_sizes_AOD_define_TDM_TRAP_CANDIDATE_HEADER___PP_DSP_AG].doc = "TDM_TRAP_CANDIDATE_HEADER bits size of PP_DSP_AG";
