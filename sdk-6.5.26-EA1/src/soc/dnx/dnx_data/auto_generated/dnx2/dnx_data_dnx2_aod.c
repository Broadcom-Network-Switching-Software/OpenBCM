    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->tables[dnx_data_dnx2_aod_tables_table_INGRESS_PRT_INFO___image].doc = "table related image";
    ...
    if (soc_is(unit, DNX2_DEVICE))
    {
        ...
        submodule_data->tables[dnx_data_dnx2_aod_tables_table_INGRESS_PRT_INFO].doc = "INGRESS_PRT_INFO";
        ...
        submodule_data->tables[dnx_data_dnx2_aod_tables_table_INGRESS_PRT_INFO].keys[0].doc = "entry index";
