    ...
    int unit)
{
    ...
    table->values[0].property.doc =
        "\n"
        "Set the hierarchy position relative to the other hierarchies in the preallocated FEC ID range.\n"
        "If no SOC property was used, hierarchy 1 will be first and the second and the third hierarchy will follow it\n"
        "but not necessarily one after the other.\n"
        "The hierarchy key value should be between 0-2 for hierarchies 1-3.\n"
        "\n"
    ;
