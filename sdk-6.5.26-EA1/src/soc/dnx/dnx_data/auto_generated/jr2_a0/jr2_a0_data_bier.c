...
static shr_error_e
jr2_a0_dnx_data_bier_params_hw_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_bier;
    int submodule_index = dnx_data_bier_submodule_params;
    int feature_index = dnx_data_bier_params_hw_supported;
    ...
    int unit)
{
    ...
    feature->default_data = dnx_data_bier.params.nof_bfr_entries_get(unit) > 0 ? TRUE : FALSE;

    
    feature->data = dnx_data_bier.params.nof_bfr_entries_get(unit) > 0 ? TRUE : FALSE;
    ...
    int unit)
{
    ...
    int module_index = dnx_data_module_bier;
    int submodule_index = dnx_data_bier_submodule_params;
    int feature_index = dnx_data_bier_params_egress_only;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_bier_params_ingress_only_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_bier;
    int submodule_index = dnx_data_bier_submodule_params;
    int feature_index = dnx_data_bier_params_ingress_only;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    int module_index = dnx_data_module_bier;
    int submodule_index = dnx_data_bier_submodule_params;
    int feature_index = dnx_data_bier_params_ingress_bfr_pos_msb_start;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_bier_params_bfr_bit_str_in_mcdb_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_bier;
    int submodule_index = dnx_data_bier_submodule_params;
    int feature_index = dnx_data_bier_params_bfr_bit_str_in_mcdb;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    define->property.range_max = 48*1024;
    ...
    int unit)
{
    ...
    data_index = dnx_data_bier_params_hw_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_bier_params_hw_supported_set;
    data_index = dnx_data_bier_params_is_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_bier_params_is_supported_set;
    data_index = dnx_data_bier_params_egress_only;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_bier_params_egress_only_set;
    data_index = dnx_data_bier_params_ingress_only;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_bier_params_ingress_only_set;
    data_index = dnx_data_bier_params_ingress_bfr_pos_msb_start;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_bier_params_ingress_bfr_pos_msb_start_set;
    data_index = dnx_data_bier_params_bfr_bit_str_in_mcdb;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_bier_params_bfr_bit_str_in_mcdb_set;
