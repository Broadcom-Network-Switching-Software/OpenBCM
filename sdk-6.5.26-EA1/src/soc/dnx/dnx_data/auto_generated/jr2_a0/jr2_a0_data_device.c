    ...
    int unit)
{
    ...
    feature->property.doc = 
        "\n"
        "Dsiable gated top level sampling (1) or not (0) during SDK access init.\n"
        "Can be 0,1\n"
        "Default: 1 - top level sampling gate is disabled.\n"
        "\n"
    ;
    feature->property.method = dnxc_data_property_method_suffix_enable;
    feature->property.method_str = "suffix_enable";
...
static shr_error_e
jr2_a0_dnx_data_device_general_nof_dies_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_device;
    int submodule_index = dnx_data_device_submodule_general;
    int define_index = dnx_data_device_general_define_nof_dies;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_device_general_nof_cores_per_die_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_device;
    int submodule_index = dnx_data_device_submodule_general;
    int define_index = dnx_data_device_general_define_nof_cores_per_die;
    SHR_FUNC_INIT_VARS(unit);

    define = &_dnxc_data[unit].modules[module_index].submodules[submodule_index].defines[define_index];
    
    define->default_data = (dnx_data_device.general.nof_cores_get(unit)/dnx_data_device.general.nof_dies_get(unit));

    
    define->data = (dnx_data_device.general.nof_cores_get(unit)/dnx_data_device.general.nof_dies_get(unit));
    ...
    int unit)
{
    ...
    feature->property.doc = 
        ...
        "Enable memory ECC\n"
        "Can be 0,1\n"
        "Default: 0 - ECC is disabled by default\n"
        "\n"
    ;
    feature->property.method = dnxc_data_property_method_suffix_enable;
    feature->property.method_str = "suffix_enable";
    ...
    int unit)
{
    ...
    data_index = dnx_data_device_general_define_nof_dies;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_device_general_nof_dies_set;
    data_index = dnx_data_device_general_define_nof_cores_per_die;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_device_general_nof_cores_per_die_set;
