    ...
    int unit)
{
    ...
    {
        data = (dnx_data_dev_init_time_appl_step_thresh_t *) dnxc_data_mgmt_table_data_get(unit, table, APPL_DNX_STEP_ITMH, 0);
        data->value = 495397;
    }
    ...
    int unit)
{
    ...
    table->keys[0].size = 235;
    table->info_get.key_size[0] = 235;
    ...
    {
        data = (dnx_data_dev_init_properties_unsupported_t *) dnxc_data_mgmt_table_data_get(unit, table, 234, 0);
    ...
    int unit)
{
    ...
    feature->property.doc = 
        "specify if init is allowed to run in multithreaded fashion>\n"
    ;
    ...
    int unit)
{
    ...
    feature->property.name = spn_CUSTOM_FEATURE;
    feature->property.doc = 
        "specify if sw_state diagnostics should be enabled.>\n"
    ;
    feature->property.method = dnxc_data_property_method_suffix_enable;
    feature->property.method_str = "suffix_enable";
