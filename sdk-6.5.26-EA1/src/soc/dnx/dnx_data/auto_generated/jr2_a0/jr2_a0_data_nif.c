    ...
    int unit)
{
    ...
    define->default_data = dnx_data_nif.eth.ethu_nof_per_core_get(unit);

    
    define->data = dnx_data_nif.eth.ethu_nof_per_core_get(unit);
...
static shr_error_e
jr2_a0_dnx_data_nif_signal_quality_is_hw_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_signal_quality;
    int feature_index = dnx_data_nif_signal_quality_is_hw_supported;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    define->property.doc = 
        "\n"
        "Enable printouts and demo callbacks\n"
        "\n"
    ;
    ...
    int unit)
{
    ...
    if (bcmPortPhyFecRsFec < table->keys[0].size)
    {
        ...
        data->max_nof_correctable_symbols = 7;
        data->is_valid = 1;
    }
    ...
    int unit)
{
    ...
    data_index = dnx_data_nif_signal_quality_is_hw_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_nif_signal_quality_is_hw_supported_set;
