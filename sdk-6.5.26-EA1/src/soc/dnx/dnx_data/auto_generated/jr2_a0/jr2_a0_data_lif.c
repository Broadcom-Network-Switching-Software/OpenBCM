    ...
    int unit)
{
    ...
    define->property.name = spn_GLOBAL_LIF_ALLOCATION;
    define->property.doc = 
        "allocated global lif, considering outlif intf\n"
    ;
    define->property.method = dnxc_data_property_method_suffix_enable;
    define->property.method_str = "suffix_enable";
    ...
    int unit)
{
    ...
    define->property.name = spn_GLOBAL_LIF_ALLOCATION;
    define->property.doc = 
        "allocated global lif, considering outlif group\n"
    ;
    define->property.method = dnxc_data_property_method_suffix_enable;
    define->property.method_str = "suffix_enable";
...
static shr_error_e
jr2_a0_dnx_data_lif_feature_global_lif_wide_data_ext_key_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_lif;
    int submodule_index = dnx_data_lif_submodule_feature;
    int feature_index = dnx_data_lif_feature_global_lif_wide_data_ext_key;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_lif_feature_global_lif_wide_data_ext_key;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_lif_feature_global_lif_wide_data_ext_key_set;
