...
static shr_error_e
jr2_a0_dnx_data_qos_feature_seperate_tc_dp_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_qos;
    int submodule_index = dnx_data_qos_submodule_feature;
    int feature_index = dnx_data_qos_feature_seperate_tc_dp;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_qos_feature_initial_qos_selection_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_qos;
    int submodule_index = dnx_data_qos_submodule_feature;
    int feature_index = dnx_data_qos_feature_initial_qos_selection;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_qos_feature_fwd_remark_keep_ecn_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_qos;
    int submodule_index = dnx_data_qos_submodule_feature;
    int feature_index = dnx_data_qos_feature_fwd_remark_keep_ecn;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_qos_feature_ingress_explicit_qos_remark_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_qos;
    int submodule_index = dnx_data_qos_submodule_feature;
    int feature_index = dnx_data_qos_feature_ingress_explicit_qos_remark;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_qos_feature_ttl_uniform_small_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_qos;
    int submodule_index = dnx_data_qos_submodule_feature;
    int feature_index = dnx_data_qos_feature_ttl_uniform_small;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_qos_feature_fwd_plus_1_bit_map_index_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_qos;
    int submodule_index = dnx_data_qos_submodule_feature;
    int feature_index = dnx_data_qos_feature_fwd_plus_1_bit_map_index;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_qos_feature_fwd_plus_1_remark_mpls_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_qos;
    int submodule_index = dnx_data_qos_submodule_feature;
    int feature_index = dnx_data_qos_feature_fwd_plus_1_remark_mpls;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_qos_feature_ingress_mpls_swap_qos_ttl_model_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_qos;
    int submodule_index = dnx_data_qos_submodule_feature;
    int feature_index = dnx_data_qos_feature_ingress_mpls_swap_qos_ttl_model;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_qos_feature_seperate_tc_dp;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_qos_feature_seperate_tc_dp_set;
    data_index = dnx_data_qos_feature_initial_qos_selection;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_qos_feature_initial_qos_selection_set;
    data_index = dnx_data_qos_feature_fwd_remark_keep_ecn;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_qos_feature_fwd_remark_keep_ecn_set;
    data_index = dnx_data_qos_feature_ingress_explicit_qos_remark;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_qos_feature_ingress_explicit_qos_remark_set;
    data_index = dnx_data_qos_feature_ttl_uniform_small;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_qos_feature_ttl_uniform_small_set;
    data_index = dnx_data_qos_feature_fwd_plus_1_bit_map_index;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_qos_feature_fwd_plus_1_bit_map_index_set;
    data_index = dnx_data_qos_feature_fwd_plus_1_remark_mpls;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_qos_feature_fwd_plus_1_remark_mpls_set;
    data_index = dnx_data_qos_feature_ingress_mpls_swap_qos_ttl_model;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_qos_feature_ingress_mpls_swap_qos_ttl_model_set;
