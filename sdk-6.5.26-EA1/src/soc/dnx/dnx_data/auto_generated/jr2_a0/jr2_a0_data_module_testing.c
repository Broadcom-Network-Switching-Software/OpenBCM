...
static shr_error_e
jr2_a0_dnx_data_module_testing_example_tests_default_memory_threshold_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_module_testing;
    int submodule_index = dnx_data_module_testing_submodule_example_tests;
    int define_index = dnx_data_module_testing_example_tests_define_default_memory_threshold;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    if (LIF_MNGR_MODULE_ID < table->keys[0].size)
    {
        ...
        data->memory_threshold = 16771392;
    }
    ...
    if (DBAL_MODULE_ID < table->keys[0].size)
    {
        ...
        data->memory_threshold = 110323536;
    }
    ...
    if (MDB_EM_MODULE_ID < table->keys[0].size)
    {
        ...
        data->memory_threshold = 128390048;
    }
    ...
    int unit)
{
    ...
    data_index = dnx_data_module_testing_example_tests_define_default_memory_threshold;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_module_testing_example_tests_default_memory_threshold_set;
