...
static shr_error_e
jr2_a0_dnx_data_snif_ingress_ext_stat_dedicated_config_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_snif;
    int submodule_index = dnx_data_snif_submodule_ingress;
    int feature_index = dnx_data_snif_ingress_ext_stat_dedicated_config;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_snif_ingress_itpp_delta_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_snif;
    int submodule_index = dnx_data_snif_submodule_ingress;
    int feature_index = dnx_data_snif_ingress_itpp_delta_supported;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_snif_egress_egress_null_profile_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_snif;
    int submodule_index = dnx_data_snif_submodule_egress;
    int feature_index = dnx_data_snif_egress_egress_null_profile;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_snif_egress_mirror_nof_profiles_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_snif;
    int submodule_index = dnx_data_snif_submodule_egress;
    int define_index = dnx_data_snif_egress_define_mirror_nof_profiles;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_snif_egress_snoop_nof_profiles_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_snif;
    int submodule_index = dnx_data_snif_submodule_egress;
    int define_index = dnx_data_snif_egress_define_snoop_nof_profiles;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_snif_egress_prob_nof_bits_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_snif;
    int submodule_index = dnx_data_snif_submodule_egress;
    int define_index = dnx_data_snif_egress_define_prob_nof_bits;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
jr2_a0_dnx_data_snif_egress_crop_size_granularity_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_snif;
    int submodule_index = dnx_data_snif_submodule_egress;
    int define_index = dnx_data_snif_egress_define_crop_size_granularity;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnx_data_snif_ingress_ext_stat_dedicated_config;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_snif_ingress_ext_stat_dedicated_config_set;
    data_index = dnx_data_snif_ingress_itpp_delta_supported;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_snif_ingress_itpp_delta_supported_set;
    ...
    data_index = dnx_data_snif_egress_define_mirror_nof_profiles;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_snif_egress_mirror_nof_profiles_set;
    data_index = dnx_data_snif_egress_define_snoop_nof_profiles;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_snif_egress_snoop_nof_profiles_set;
    ...
    data_index = dnx_data_snif_egress_define_prob_nof_bits;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_snif_egress_prob_nof_bits_set;
    data_index = dnx_data_snif_egress_define_crop_size_granularity;
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_snif_egress_crop_size_granularity_set;

    
    data_index = dnx_data_snif_egress_egress_null_profile;
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_snif_egress_egress_null_profile_set;
