...
static shr_error_e
jr2_a0_dnx_data_fc_general_qmlf_rmcs_thresholds_per_profile_support_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_fc;
...
static shr_error_e
jr2_a0_dnx_data_fc_general_nof_bits_in_nif_eth_rmc_id_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_fc;
    ...
    define->default_data = dnx_data_nif.scheduler.nof_rmc_bits_get(unit);

    
    define->data = dnx_data_nif.scheduler.nof_rmc_bits_get(unit);
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = jr2_a0_dnx_data_fc_general_nof_bits_in_nif_eth_rmc_id_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = jr2_a0_dnx_data_fc_general_qmlf_rmcs_thresholds_per_profile_support_set;
