    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_regression_dvapi_topology_define_nof_pm_force_er].doc = "number of PMs to enable force_er";
    ...
    submodule_data->tables[dnx_data_regression_dvapi_topology_table_pm_force_er].doc = "port macros should enable force er for PAM4 port";
    ...
    submodule_data->tables[dnx_data_regression_dvapi_topology_table_pm_force_er].keys[0].doc = "entry index";
