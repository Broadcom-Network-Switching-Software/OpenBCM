    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_elk_general_are_two_kbps_connected].doc = "Indication that the system configuration has 2 OP2s. Used for tests.";
    ...
    submodule_data->defines[dnx_data_elk_general_define_nof_dbs_per_core].doc = "Number of supported DBs per KBP core";
