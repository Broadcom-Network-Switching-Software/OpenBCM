    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_iqs_dbal_fsm_sn_mask_supported].doc = "FSM SN mask supported";
    ...
    submodule_data->defines[dnx_data_iqs_dbal_define_fsm_sn_mask].doc = "FMS SN mask value";
