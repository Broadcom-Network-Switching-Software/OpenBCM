...
static shr_error_e
j2p_a0_dnx_data_l3_fec_supported_fec_flags_set(
    int unit)
{
...
static shr_error_e
j2p_a0_dnx_data_l3_fec_supported_fec_flags2_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_l3;
...
static shr_error_e
j2p_a0_dnx_data_l3_source_address_custom_sa_use_dual_homing_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_l3;
...
static shr_error_e
j2p_a0_dnx_data_l3_fwd_lpm_strength_profiles_support_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_l3;
...
static shr_error_e
j2p_a0_dnx_data_l3_fwd_nof_lpm_strength_profiles_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_l3;
...
static shr_error_e
j2p_a0_dnx_data_l3_feature_ingress_frag_not_first_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_l3;
    ...
    int unit)
{
    ...
    define->set = j2p_a0_dnx_data_l3_fec_supported_fec_flags_set;
    data_index = dnx_data_l3_fec_define_supported_fec_flags2;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_l3_fec_supported_fec_flags2_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_l3_source_address_custom_sa_use_dual_homing_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_l3_fwd_lpm_strength_profiles_support_set;
    data_index = dnx_data_l3_fwd_define_nof_lpm_strength_profiles;
    define = &submodule->defines[data_index];
    define->set = j2p_a0_dnx_data_l3_fwd_nof_lpm_strength_profiles_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_l3_feature_ingress_frag_not_first_set;
