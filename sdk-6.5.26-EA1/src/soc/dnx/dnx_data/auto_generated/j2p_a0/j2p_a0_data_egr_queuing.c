...
static shr_error_e
j2p_a0_dnx_data_egr_queuing_params_const_rqp_fqp_bubbles_disabled_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_egr_queuing;
    ...
    int unit)
{
    ...
    feature = &submodule->features[data_index];
    feature->set = j2p_a0_dnx_data_egr_queuing_params_const_rqp_fqp_bubbles_disabled_set;
