    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_sch_general_fsm_modes_config_supported].doc = "Flow Status Message modes configuration supported";
    ...
    submodule_data->features[dnx_data_sch_general_tcg_mapping_hardcoded].doc = "is tcg mapping hardcoded in HW";
    ...
    submodule_data->features[dnx_data_sch_general_global_tcg_strict_priority].doc = "is global tcg strict priority supported";
    ...
    submodule_data->features[dnx_data_sch_general_fc_on_channelized_if_only].doc = "is flow-control supported only on channelized interfaces";
    ...
    submodule_data->features[dnx_data_sch_general_priority_propagation_on_channelized_if_only].doc = "is priority propagation supported only on channelized interfaces";
    ...
    submodule_data->features[dnx_data_sch_general_low_rate_connectors_token_count_update].doc = "Indicate if we need to update the token count of low rate connectors during soft reset";
    ...
    submodule_data->features[dnx_data_sch_general_scheduler_allocation_legacy_api_supported].doc = "Indicate if we need to support bcm_cosq_gport_add/get legacy APIs";
    ...
    submodule_data->defines[dnx_data_sch_general_define_port_priority_propagation_version].doc = "Port priority propagation version";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_sch_ps_define_assigned_credit_worth_multiplier].doc = "Used when calculating minimal max burst allowed";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_sch_flow_flex_quartet_supported].doc = "Is flexible Cl-FQ quartet supported";
    ...
    submodule_data->features[dnx_data_sch_flow_interdigitated_supported].doc = "Interdigitated mode is supported";
    ...
    submodule_data->defines[dnx_data_sch_flow_define_nof_flows_in_quartet_order_group].doc = "Number of flows in a quartet order group";
    ...
    submodule_data->defines[dnx_data_sch_flow_define_nof_regions_in_quartet_order_group].doc = "Number of regions in a quartet order group";
    ...
    submodule_data->defines[dnx_data_sch_flow_define_nof_quartet_order_groups].doc = "Number of quartet order groups in a core";
    ...
    submodule_data->defines[dnx_data_sch_flow_define_virtual_flow_mapped_queue].doc = "VOQ that virtual flows should be mapped to";
    ...
    submodule_data->tables[dnx_data_sch_flow_table_quartet_type].doc = "quartet type per group";
    ...
    submodule_data->tables[dnx_data_sch_flow_table_quartet_type].keys[0].doc = "see table doc";
    submodule_data->tables[dnx_data_sch_flow_table_quartet_type].keys[1].name = "group";
    submodule_data->tables[dnx_data_sch_flow_table_quartet_type].keys[1].doc = "see table doc";
    ...
    submodule_data->tables[dnx_data_sch_flow_table_quartet_type].values[0].doc = "see table doc";
    ...
    submodule_data->tables[dnx_data_sch_flow_table_quartet_index_conversion].doc = "conversion of quartet index";
    ...
    submodule_data->tables[dnx_data_sch_flow_table_quartet_index_conversion].keys[0].doc = "quartet type";
    ...
    submodule_data->tables[dnx_data_sch_flow_table_quartet_index_conversion].values[0].doc = "quartet index conversion vector flow to SE";
    ...
    submodule_data->tables[dnx_data_sch_flow_table_quartet_index_conversion].values[1].doc = "quartet index conversion vector SE to flow";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_sch_se_table_quartet_offset_to_cl_num].doc = "mapping quartet index to CL number";
    ...
    submodule_data->tables[dnx_data_sch_se_table_quartet_offset_to_cl_num].keys[0].doc = "quartet offset";
    ...
    submodule_data->tables[dnx_data_sch_se_table_quartet_offset_to_cl_num].values[0].doc = "number of CL in the quartet";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_sch_interface_define_max_calendar_size].doc = "Max size of calendar";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_sch_sch_alloc_table_region].keys[0].doc = "quartet type";
    submodule_data->tables[dnx_data_sch_sch_alloc_table_region].keys[1].name = "region_type";
    submodule_data->tables[dnx_data_sch_sch_alloc_table_region].keys[1].doc = "region type";
    ...
    submodule_data->tables[dnx_data_sch_sch_alloc_table_region].values[2].doc = "[Boolean] CL can be searched on half of the quratet";
    ...
    submodule_data->tables[dnx_data_sch_sch_alloc_table_region].values[3].doc = "[Boolean] FQ can be searched on half of the quratet";
    ...
    submodule_data->tables[dnx_data_sch_sch_alloc_table_region].values[4].doc = "[Boolean] CL and FQ of an enhanced CL share borders";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_sch_dbal_define_flow_shaper_max_burst_bits].doc = "number of bits in flo shaper max burst";
    ...
    submodule_data->defines[dnx_data_sch_dbal_define_token_count_default].doc = "default value of token count";
    ...
    submodule_data->defines[dnx_data_sch_dbal_define_priority_propagation_if_group_max].doc = "Max value for interface groups used for prioririty propagation";
    ...
    submodule_data->defines[dnx_data_sch_dbal_define_max_sch_interfaces_with_fc].doc = "Max number of scheduler inerfaces that supports flow control";
    ...
    submodule_data->defines[dnx_data_sch_dbal_define_priority_propagation_if_group_nof_bits].doc = "number of bits of interface groups used for prioririty propagation";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->doc = "flow control";
    ...
    submodule_data->features[dnx_data_sch_fc_context_based_mapping].doc = "Support sending flow control (port/queue level) to multiple based on a context ID";
