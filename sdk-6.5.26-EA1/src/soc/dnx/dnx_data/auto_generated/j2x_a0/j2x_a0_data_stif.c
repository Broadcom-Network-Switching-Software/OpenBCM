...
static shr_error_e
j2x_a0_dnx_data_stif_port_stif_ethu_select_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_stif;
...
static shr_error_e
j2x_a0_dnx_data_stif_port_stif_lane_mapping_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_stif;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_stif_port_stif_ethu_select_size_set;
    data_index = dnx_data_stif_port_define_stif_lane_mapping_size;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_stif_port_stif_lane_mapping_size_set;
