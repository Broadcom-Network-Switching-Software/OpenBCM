...
static shr_error_e
j2x_a0_dnx_data_stat_stat_pp_max_irpp_profile_value_set(
    int unit)
{
...
static shr_error_e
j2x_a0_dnx_data_stat_stat_pp_max_etpp_profile_value_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_stat;
...
static shr_error_e
j2x_a0_dnx_data_stat_stat_pp_max_erpp_profile_value_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_stat;
...
static shr_error_e
j2x_a0_dnx_data_stat_stat_pp_etpp_reversed_stat_cmd_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_stat;
...
static shr_error_e
j2x_a0_dnx_data_stat_stat_pp_etpp_enc_stat_cmd_is_reversed_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_stat;
...
static shr_error_e
j2x_a0_dnx_data_stat_stat_pp_etpp_egress_vsi_always_pushed_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_stat;
...
static shr_error_e
j2x_a0_dnx_data_stat_stat_pp_irpp_start_profile_value_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_stat;
...
static shr_error_e
j2x_a0_dnx_data_stat_stat_pp_erpp_start_profile_value_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_stat;
...
static shr_error_e
j2x_a0_dnx_data_stat_stat_pp_etpp_start_profile_value_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_stat;
...
static shr_error_e
j2x_a0_dnx_data_stat_drop_reasons_nof_drop_reasons_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_stat;
...
static shr_error_e
j2x_a0_dnx_data_stat_drop_reasons_group_drop_reason_index_set(
    int unit)
{
    int group_index;
...
static shr_error_e
j2x_a0_dnx_data_stat_drop_reasons_drop_reason_index_set(
    int unit)
{
    ...
    if (bcmCosqDropReasonTAFMaxPacketSizeReject < table->keys[0].size)
    {
        data = (dnx_data_stat_drop_reasons_drop_reason_index_t *) dnxc_data_mgmt_table_data_get(unit, table, bcmCosqDropReasonTAFMaxPacketSizeReject, 0);
        data->index = 4;
    }
    if (bcmCosqDropReasonTAFClosedGateReject < table->keys[0].size)
    {
        data = (dnx_data_stat_drop_reasons_drop_reason_index_t *) dnxc_data_mgmt_table_data_get(unit, table, bcmCosqDropReasonTAFClosedGateReject, 0);
        data->index = 5;
    }
    if (bcmCosqDropReasonMacsecErrorReject < table->keys[0].size)
    {
        data = (dnx_data_stat_drop_reasons_drop_reason_index_t *) dnxc_data_mgmt_table_data_get(unit, table, bcmCosqDropReasonMacsecErrorReject, 0);
        data->index = 6;
    }
...
static shr_error_e
j2x_a0_dnx_data_stat_drop_reasons_drop_reasons_groups_set(
    int unit)
{
    int name_index;
    ...
    if (bcmStatCounterGroupFilterMiscDrop < table->keys[0].size)
    {
        ...
        SHR_RANGE_VERIFY(11, 0, DNX_DATA_MAX_STAT_DROP_REASONS_NOF_DROP_REASONS, _SHR_E_INTERNAL, "out of bound access to array")
        ...
        data->drop_reasons[9] = bcmCosqDropReasonTAFMaxPacketSizeReject;
        data->drop_reasons[10] = bcmCosqDropReasonRejectCount;
    }
...
static shr_error_e
j2x_a0_dnx_data_stat_feature_itpp_cud_count_always_stamp_set(
    int unit)
{
    ...
    int unit)
{
    ...
    define->set = j2x_a0_dnx_data_stat_stat_pp_max_irpp_profile_value_set;
    data_index = dnx_data_stat_stat_pp_define_max_etpp_profile_value;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_stat_stat_pp_max_etpp_profile_value_set;
    data_index = dnx_data_stat_stat_pp_define_max_erpp_profile_value;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_stat_stat_pp_max_erpp_profile_value_set;
    data_index = dnx_data_stat_stat_pp_define_etpp_reversed_stat_cmd;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_stat_stat_pp_etpp_reversed_stat_cmd_set;
    data_index = dnx_data_stat_stat_pp_define_etpp_enc_stat_cmd_is_reversed;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_stat_stat_pp_etpp_enc_stat_cmd_is_reversed_set;
    data_index = dnx_data_stat_stat_pp_define_etpp_egress_vsi_always_pushed;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_stat_stat_pp_etpp_egress_vsi_always_pushed_set;
    data_index = dnx_data_stat_stat_pp_define_irpp_start_profile_value;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_stat_stat_pp_irpp_start_profile_value_set;
    data_index = dnx_data_stat_stat_pp_define_erpp_start_profile_value;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_stat_stat_pp_erpp_start_profile_value_set;
    data_index = dnx_data_stat_stat_pp_define_etpp_start_profile_value;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_stat_stat_pp_etpp_start_profile_value_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_stat_drop_reasons_nof_drop_reasons_set;
    ...
    table->set = j2x_a0_dnx_data_stat_drop_reasons_group_drop_reason_index_set;
    data_index = dnx_data_stat_drop_reasons_table_drop_reason_index;
    table = &submodule->tables[data_index];
    table->set = j2x_a0_dnx_data_stat_drop_reasons_drop_reason_index_set;
    data_index = dnx_data_stat_drop_reasons_table_drop_reasons_groups;
    table = &submodule->tables[data_index];
    table->set = j2x_a0_dnx_data_stat_drop_reasons_drop_reasons_groups_set;
    ...
    feature->set = j2x_a0_dnx_data_stat_feature_itpp_cud_count_always_stamp_set;
