...
static shr_error_e
j2x_a0_dnx_data_nif_global_max_nof_mgmt_ports_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_global;
    int define_index = dnx_data_nif_global_define_max_nof_mgmt_ports;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    define->property.doc = 
        "\n"
        "1: OTN supported, limited autoneg\n"
        "0: OTN is not supported, full autoneg\n"
        "\n"
    ;
...
static shr_error_e
j2x_a0_dnx_data_nif_framer_b66switch_block_id_set(
    int unit)
{
    int switch_type_index;
    int channel_index;
    dnx_data_nif_framer_b66switch_block_id_t *data, *default_data;
    dnxc_data_table_t *table;
    int module_index = dnx_data_module_nif;
    int submodule_index = dnx_data_nif_submodule_framer;
    int table_index = dnx_data_nif_framer_table_b66switch_block_id;
    SHR_FUNC_INIT_VARS(unit);
    ...
    table->keys[0].size = DNX_ALGO_FLEXE_NOF_FLOW_TYPES;
    table->info_get.key_size[0] = DNX_ALGO_FLEXE_NOF_FLOW_TYPES;
    table->keys[1].size = dnx_data_nif.framer.b66switch_backup_channels_get(unit) + 1;
    table->info_get.key_size[1] = dnx_data_nif.framer.b66switch_backup_channels_get(unit) + 1;
    ...
    DNXC_DATA_ALLOC(table->data, dnx_data_nif_framer_b66switch_block_id_t, (1 * (table->keys[0].size) * (table->keys[1].size) + 1  ), "data of dnx_data_nif_framer_table_b66switch_block_id");

    
    default_data = (dnx_data_nif_framer_b66switch_block_id_t *) dnxc_data_mgmt_table_data_get(unit, table, -1, -1);
    default_data->src_block_id = -1;
    default_data->dst_block_id = -1;
    
    for (switch_type_index = 0; switch_type_index < table->keys[0].size; switch_type_index++)
    {
        for (channel_index = 0; channel_index < table->keys[1].size; channel_index++)
        {
            data = (dnx_data_nif_framer_b66switch_block_id_t *) dnxc_data_mgmt_table_data_get(unit, table, switch_type_index, channel_index);
            sal_memcpy(data, default_data, table->size_of_values);
        }
    }
    
    if (DNX_ALGO_FLEXE_FLOW_CLIENT2CLENT < table->keys[0].size && 0 < table->keys[1].size)
    {
        data = (dnx_data_nif_framer_b66switch_block_id_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_ALGO_FLEXE_FLOW_CLIENT2CLENT, 0);
        data->src_block_id = 6;
        data->dst_block_id = 6;
    }
    if (DNX_ALGO_FLEXE_FLOW_CLIENT2CLENT < table->keys[0].size && 1 < table->keys[1].size)
    {
        data = (dnx_data_nif_framer_b66switch_block_id_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_ALGO_FLEXE_FLOW_CLIENT2CLENT, 1);
        data->src_block_id = 6;
        data->dst_block_id = 23;
    }
    if (DNX_ALGO_FLEXE_FLOW_CLIENT2MAC < table->keys[0].size && 0 < table->keys[1].size)
    {
        data = (dnx_data_nif_framer_b66switch_block_id_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_ALGO_FLEXE_FLOW_CLIENT2MAC, 0);
        data->src_block_id = 6;
        data->dst_block_id = 9;
    }
    if (DNX_ALGO_FLEXE_FLOW_CLIENT2MAC < table->keys[0].size && 1 < table->keys[1].size)
    {
        data = (dnx_data_nif_framer_b66switch_block_id_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_ALGO_FLEXE_FLOW_CLIENT2MAC, 1);
        data->src_block_id = 6;
        data->dst_block_id = 26;
    }
    if (DNX_ALGO_FLEXE_FLOW_CLIENT2SAR < table->keys[0].size && 0 < table->keys[1].size)
    {
        data = (dnx_data_nif_framer_b66switch_block_id_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_ALGO_FLEXE_FLOW_CLIENT2SAR, 0);
        data->src_block_id = 6;
        data->dst_block_id = 7;
    }
    if (DNX_ALGO_FLEXE_FLOW_MAC2CLIENT < table->keys[0].size && 0 < table->keys[1].size)
    {
        data = (dnx_data_nif_framer_b66switch_block_id_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_ALGO_FLEXE_FLOW_MAC2CLIENT, 0);
        data->src_block_id = 9;
        data->dst_block_id = 6;
    }
    if (DNX_ALGO_FLEXE_FLOW_MAC2CLIENT < table->keys[0].size && 1 < table->keys[1].size)
    {
        data = (dnx_data_nif_framer_b66switch_block_id_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_ALGO_FLEXE_FLOW_MAC2CLIENT, 1);
        data->src_block_id = 9;
        data->dst_block_id = 23;
    }
    if (DNX_ALGO_FLEXE_FLOW_MAC2MAC < table->keys[0].size && 0 < table->keys[1].size)
    {
        data = (dnx_data_nif_framer_b66switch_block_id_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_ALGO_FLEXE_FLOW_MAC2MAC, 0);
        data->src_block_id = 9;
        data->dst_block_id = 9;
    }
    if (DNX_ALGO_FLEXE_FLOW_MAC2MAC < table->keys[0].size && 1 < table->keys[1].size)
    {
        data = (dnx_data_nif_framer_b66switch_block_id_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_ALGO_FLEXE_FLOW_MAC2MAC, 1);
        data->src_block_id = 9;
        data->dst_block_id = 26;
    }
    if (DNX_ALGO_FLEXE_FLOW_MAC2SAR < table->keys[0].size && 0 < table->keys[1].size)
    {
        data = (dnx_data_nif_framer_b66switch_block_id_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_ALGO_FLEXE_FLOW_MAC2SAR, 0);
        data->src_block_id = 9;
        data->dst_block_id = 7;
    }
    if (DNX_ALGO_FLEXE_FLOW_SAR2SAR < table->keys[0].size && 0 < table->keys[1].size)
    {
        data = (dnx_data_nif_framer_b66switch_block_id_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_ALGO_FLEXE_FLOW_SAR2SAR, 0);
        data->src_block_id = 7;
        data->dst_block_id = 7;
    }
    if (DNX_ALGO_FLEXE_FLOW_SAR2MAC < table->keys[0].size && 0 < table->keys[1].size)
    {
        data = (dnx_data_nif_framer_b66switch_block_id_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_ALGO_FLEXE_FLOW_SAR2MAC, 0);
        data->src_block_id = 7;
        data->dst_block_id = 9;
    }
    if (DNX_ALGO_FLEXE_FLOW_SAR2MAC < table->keys[0].size && 1 < table->keys[1].size)
    {
        data = (dnx_data_nif_framer_b66switch_block_id_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_ALGO_FLEXE_FLOW_SAR2MAC, 1);
        data->src_block_id = 7;
        data->dst_block_id = 26;
    }
    if (DNX_ALGO_FLEXE_FLOW_SAR2CLIENT < table->keys[0].size && 0 < table->keys[1].size)
    {
        data = (dnx_data_nif_framer_b66switch_block_id_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_ALGO_FLEXE_FLOW_SAR2CLIENT, 0);
        data->src_block_id = 7;
        data->dst_block_id = 6;
    }
    if (DNX_ALGO_FLEXE_FLOW_SAR2CLIENT < table->keys[0].size && 1 < table->keys[1].size)
    {
        data = (dnx_data_nif_framer_b66switch_block_id_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_ALGO_FLEXE_FLOW_SAR2CLIENT, 1);
        data->src_block_id = 7;
        data->dst_block_id = 23;
    }
    if (DNX_ALGO_FLEXE_FLOW_ETH2SAR < table->keys[0].size && 0 < table->keys[1].size)
    {
        data = (dnx_data_nif_framer_b66switch_block_id_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_ALGO_FLEXE_FLOW_ETH2SAR, 0);
        data->src_block_id = 6;
        data->dst_block_id = 7;
    }
    if (DNX_ALGO_FLEXE_FLOW_SAR2ETH < table->keys[0].size && 0 < table->keys[1].size)
    {
        data = (dnx_data_nif_framer_b66switch_block_id_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_ALGO_FLEXE_FLOW_SAR2ETH, 0);
        data->src_block_id = 7;
        data->dst_block_id = 6;
    }
    if (DNX_ALGO_FLEXE_FLOW_ETH2CLIENT < table->keys[0].size && 0 < table->keys[1].size)
    {
        data = (dnx_data_nif_framer_b66switch_block_id_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_ALGO_FLEXE_FLOW_ETH2CLIENT, 0);
        data->src_block_id = 6;
        data->dst_block_id = 6;
    }
    if (DNX_ALGO_FLEXE_FLOW_ETH2CLIENT < table->keys[0].size && 1 < table->keys[1].size)
    {
        data = (dnx_data_nif_framer_b66switch_block_id_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_ALGO_FLEXE_FLOW_ETH2CLIENT, 1);
        data->src_block_id = 6;
        data->dst_block_id = 23;
    }
    if (DNX_ALGO_FLEXE_FLOW_CLIENT2ETH < table->keys[0].size && 0 < table->keys[1].size)
    {
        data = (dnx_data_nif_framer_b66switch_block_id_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_ALGO_FLEXE_FLOW_CLIENT2ETH, 0);
        data->src_block_id = 6;
        data->dst_block_id = 6;
    }
    if (DNX_ALGO_FLEXE_FLOW_ETH2ETH < table->keys[0].size && 0 < table->keys[1].size)
    {
        data = (dnx_data_nif_framer_b66switch_block_id_t *) dnxc_data_mgmt_table_data_get(unit, table, DNX_ALGO_FLEXE_FLOW_ETH2ETH, 0);
        data->src_block_id = 6;
        data->dst_block_id = 6;
    }
...
static shr_error_e
j2x_a0_dnx_data_nif_mac_client_sb_fifo_force_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
...
static shr_error_e
j2x_a0_dnx_data_nif_mac_client_speed_granularity_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_nif;
    ...
    int unit)
{
    ...
    define->property.doc = 
        ...
        "1G_AND_5G: Only 1G and 5G Flexe slots are supported.\n"
        "1P25G_AND_5G: Only 1.25G and 5G Flexe slots are supported.\n"
        "\n"
    ;
    define->property.method = dnxc_data_property_method_direct_map;
    define->property.method_str = "direct_map";
...
static shr_error_e
j2x_a0_dnx_data_nif_signal_quality_is_ber_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_nif;
    ...
    int unit)
{
    ...
    data_index = dnx_data_nif_global_define_max_nof_mgmt_ports;
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_nif_global_max_nof_mgmt_ports_set;
    ...
    data_index = dnx_data_nif_framer_table_b66switch_block_id;
    table = &submodule->tables[data_index];
    table->set = j2x_a0_dnx_data_nif_framer_b66switch_block_id_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2x_a0_dnx_data_nif_mac_client_speed_granularity_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_nif_mac_client_sb_fifo_force_supported_set;
    ...
    feature = &submodule->features[data_index];
    feature->set = j2x_a0_dnx_data_nif_signal_quality_is_ber_supported_set;
