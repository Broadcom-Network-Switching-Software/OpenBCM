    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_mib_general_mib_counters_statdma_support].doc = "Indicate if mib counters supports getting the counter value for HW in DMA mode";
    ...
    submodule_data->features[dnx_data_mib_general_mib_preempt_counters_support].doc = "Indicate if mib preemption counters are supported";
    ...
    submodule_data->defines[dnx_data_mib_general_define_nof_express_rows_per_cdmib_port].doc = "Indicate number of express row used per port.";
    ...
    submodule_data->defines[dnx_data_mib_general_define_nof_preempt_rows_per_cdmib_port].doc = "Indicate number of preempt row used per port.";
    ...
    submodule_data->defines[dnx_data_mib_general_define_nof_rows_per_cdmib_port].doc = "Indicate total number of row occupied per port.";
    ...
    submodule_data->defines[dnx_data_mib_general_define_nof_cdmib_port_per_pm].doc = "Indicate total number of cdmib port per PM.";
    ...
    submodule_data->defines[dnx_data_mib_general_define_nof_cdmib_port].doc = "Indicate total number of cdmib port.";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_mib_controlled_counters_define_flexmac_mib_general_cnt_len].doc = "Indicate number of bits per general flexmac mib counter.";
    ...
    submodule_data->defines[dnx_data_mib_controlled_counters_define_flexmac_mib_rbyt_cnt_len].doc = "Indicate number of bits rbyt mib counter.";
    ...
    submodule_data->defines[dnx_data_mib_controlled_counters_define_flexmac_mib_rrbyt_cnt_len].doc = "Indicate number of bits rrbyt mib counter.";
    ...
    submodule_data->defines[dnx_data_mib_controlled_counters_define_flexmac_mib_tbyt_cnt_len].doc = "Indicate number of bits per tbyt mib counter.";
    ...
    submodule_data->tables[dnx_data_mib_controlled_counters_table_flexmac_counter_data].doc = "flexmac counter data";
    ...
    submodule_data->tables[dnx_data_mib_controlled_counters_table_flexmac_counter_data].keys[0].doc = "controlled counter id, see - dnx_mib_counter_t'";
