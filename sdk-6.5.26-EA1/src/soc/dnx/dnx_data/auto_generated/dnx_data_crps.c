    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_crps_engine_dynamic_counter_mode_is_supported].doc = "Is counter type can have several modes";
    ...
    submodule_data->defines[dnx_data_crps_engine_define_counter_format_nof_bits].doc = "number of bits to describe the engine counter format (without opcode)";
    ...
    submodule_data->defines[dnx_data_crps_engine_define_counter_mode_nof_bits].doc = "number of bits to describe the engine counter mode (Action)";
    ...
    submodule_data->defines[dnx_data_crps_engine_define_nof_small_meter_shared_engines].doc = "number of small engines can allocate for the meter used";
    ...
    submodule_data->defines[dnx_data_crps_engine_define_nof_mid_meter_shared_engines].doc = "number of medium engines can allocate for the meter used";
    ...
    submodule_data->defines[dnx_data_crps_engine_define_nof_big_meter_shared_engines].doc = "number of big engines can allocate for the meter used";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_crps_expansion_table_source_metadata_types].doc = "Describes the metadata types supports for each crps source";
    ...
    submodule_data->tables[dnx_data_crps_expansion_table_source_metadata_types].keys[0].doc = "The crps interface that send the metadata";
    submodule_data->tables[dnx_data_crps_expansion_table_source_metadata_types].keys[1].name = "metadata_type";
    submodule_data->tables[dnx_data_crps_expansion_table_source_metadata_types].keys[1].doc = "The data type";
    ...
    submodule_data->tables[dnx_data_crps_expansion_table_source_metadata_types].values[0].doc = "The offset of the data type in the metadata record";
    ...
    submodule_data->tables[dnx_data_crps_expansion_table_source_metadata_types].values[1].doc = "The maximum number of bits needed for the specific data type";
    ...
    submodule_data->tables[dnx_data_crps_expansion_table_source_expansion_info].doc = "Describes the source's expantion informasion";
    ...
    submodule_data->tables[dnx_data_crps_expansion_table_source_expansion_info].keys[0].doc = "The crps interface that send the metadata";
    ...
    submodule_data->tables[dnx_data_crps_expansion_table_source_expansion_info].values[0].doc = "nomber of bits in the source metadata";
    ...
    submodule_data->tables[dnx_data_crps_expansion_table_source_expansion_info].values[1].doc = "Does the expansion selection is per type";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_crps_src_interface_etm_count_pp_port_enable_table_is_supported].doc = "The table enable/disable the counter pointer from Egress TM queues is exist";
    ...
    submodule_data->tables[dnx_data_crps_src_interface_table_crps_counting].doc = "Does crps counting is supported per interface source";
    ...
    submodule_data->tables[dnx_data_crps_src_interface_table_crps_counting].keys[0].doc = "interface source";
    ...
    submodule_data->tables[dnx_data_crps_src_interface_table_crps_counting].values[0].doc = "is crps counting suppotrs for the current source";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->doc = "state counters information";
    ...
    submodule_data->defines[dnx_data_crps_state_counters_define_max_wide_state_counters_size].doc = "max Wide state counter size";
    ...
    submodule_data->defines[dnx_data_crps_state_counters_define_max_narrow_state_counters_size].doc = "max Narrow state counter size";
    ...
    submodule_data->defines[dnx_data_crps_state_counters_define_state_counter_data_size_per_full_counter].doc = "data size for state counter in full counter";
    ...
    submodule_data->tables[dnx_data_crps_state_counters_table_counter_size_per_format_type].doc = "The supported counter sizes per state counter format_type";
    ...
    submodule_data->tables[dnx_data_crps_state_counters_table_counter_size_per_format_type].keys[0].doc = "The counter format type";
    submodule_data->tables[dnx_data_crps_state_counters_table_counter_size_per_format_type].keys[1].name = "counter_size";
    submodule_data->tables[dnx_data_crps_state_counters_table_counter_size_per_format_type].keys[1].doc = "The state counters sizes options";
    ...
    submodule_data->tables[dnx_data_crps_state_counters_table_counter_size_per_format_type].values[0].doc = "Is supported counter size for counter format type";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->doc = "general crps data";
    ...
    submodule_data->features[dnx_data_crps_general_crps_expansion_support].doc = "crps expantion is present";
    ...
    submodule_data->features[dnx_data_crps_general_count_mc_as_one_support].doc = "count all coppies as one is present";
    ...
    submodule_data->features[dnx_data_crps_general_crps_compensation_support].doc = "crps compensation is present";
