    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_dram_hbm_sbus_execute_delay].doc = "Support for manually adding delay to the SBus execute signal";
    ...
    submodule_data->defines[dnx_data_dram_hbm_define_sbus_execute_delay_default].doc = "default value for SBust master execute delay";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_dram_general_info_define_tertw].doc = "explicitly given final value of trtw timing parameter";
