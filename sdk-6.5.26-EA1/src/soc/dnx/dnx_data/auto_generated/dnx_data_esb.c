    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_esb_general_internal_offset_mapping_not_supported].doc = "Mapping in EPNI of the internal offset of the port inside the NIF Unit is not supported.";
    ...
    submodule_data->defines[dnx_data_esb_general_define_nif_credits_resolution].doc = "Number of credits to add for each speed resolution.";
    ...
    submodule_data->defines[dnx_data_esb_general_define_nif_credits_rate_resolution].doc = "NIF rate resolution (units: Mbps) for calculating the number of credits.";
