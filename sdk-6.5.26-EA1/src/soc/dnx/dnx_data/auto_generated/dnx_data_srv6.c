    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_srv6_termination_define_max_nof_terminated_sids_usd_1pass].doc = "Max number of SIDs that can be terminated in SRv6 USD Egress node in 1pass";
    ...
    submodule_data->defines[dnx_data_srv6_termination_define_max_nof_locators].doc = "Max number of locators in IPV6 SRv6 Cascaded tunnel types.";
