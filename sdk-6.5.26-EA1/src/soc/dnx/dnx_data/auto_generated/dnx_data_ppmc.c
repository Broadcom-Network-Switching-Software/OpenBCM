    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_ppmc_param_configurable_ppmc_range].doc = "Indicates if ppmc valid index range is configurable";
    ...
    submodule_data->defines[dnx_data_ppmc_param_define_mc_replication_id_offset].doc = "multicast replication index range offset in the PPMC table";
