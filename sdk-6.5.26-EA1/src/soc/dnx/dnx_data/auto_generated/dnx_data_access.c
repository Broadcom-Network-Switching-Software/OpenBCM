...
extern shr_error_e j2p_a0_data_access_attach(
    int unit);

#endif 
#ifdef BCM_DNX2_SUPPORT

extern shr_error_e j2x_a0_data_access_attach(
    int unit);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_access_mdio_define_nof_pms_per_ring].name = "nof_pms_per_ring";
    submodule_data->defines[dnx_data_access_mdio_define_nof_pms_per_ring].doc = "Number of Fabric PMs per MDIO ring.";
    
    submodule_data->defines[dnx_data_access_mdio_define_nof_pms_per_ring].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_access_mdio_define_ring_offset].name = "ring_offset";
    submodule_data->defines[dnx_data_access_mdio_define_ring_offset].doc = "Offset for first fabric ring.";
    
    submodule_data->defines[dnx_data_access_mdio_define_ring_offset].flags |= DNXC_DATA_F_DEFINE;

    submodule_data->defines[dnx_data_access_mdio_define_offset_in_ring].name = "offset_in_ring";
    submodule_data->defines[dnx_data_access_mdio_define_offset_in_ring].doc = "Offset between fabric pms inside a ring.";
    
    submodule_data->defines[dnx_data_access_mdio_define_offset_in_ring].flags |= DNXC_DATA_F_DEFINE;
...
uint32
dnx_data_access_mdio_nof_pms_per_ring_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_access, dnx_data_access_submodule_mdio, dnx_data_access_mdio_define_nof_pms_per_ring);
}

uint32
dnx_data_access_mdio_ring_offset_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_access, dnx_data_access_submodule_mdio, dnx_data_access_mdio_define_ring_offset);
}

uint32
dnx_data_access_mdio_offset_in_ring_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_access, dnx_data_access_submodule_mdio, dnx_data_access_mdio_define_offset_in_ring);
}
    ...
    dnxc_data_module_t *module_data)
{
    ...
    {
        SHR_IF_ERR_EXIT(jr2_a0_data_access_attach(unit));
        SHR_IF_ERR_EXIT(j2p_a0_data_access_attach(unit));
    }
    else
    ...
    {
        SHR_IF_ERR_EXIT(jr2_a0_data_access_attach(unit));
        SHR_IF_ERR_EXIT(j2x_a0_data_access_attach(unit));
    }
    else
