    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_switch_load_balancing_paser_seed_update_supported].doc = "Indicates whether updating the parser seed is possible";
    ...
    submodule_data->defines[dnx_data_switch_load_balancing_define_swig_base_offline_simulation].doc = "Indicate whether the load balancing offline simulation files are using swig";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_switch_svtag_egress_svtag_legacy_api_support].doc = "supports the seperate arguments egress svtag APIs (lookup info is not by struct)";
