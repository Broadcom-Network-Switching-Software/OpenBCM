    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_l3_fec_define_supported_fec_flags].doc = "Supported FEC flags.";
    ...
    submodule_data->defines[dnx_data_l3_fec_define_supported_fec_flags2].doc = "Supported FEC flags2.";
    ...
    submodule_data->tables[dnx_data_l3_fec_table_fec_resource_info].doc = "FEC resource type information; Map the FEC resource type to FEC dbal result type";
    ...
    submodule_data->tables[dnx_data_l3_fec_table_fec_resource_info].nof_values = 3;
    ...
    submodule_data->tables[dnx_data_l3_fec_table_fec_resource_info].values[2].name = "dbal_result_type";
    submodule_data->tables[dnx_data_l3_fec_table_fec_resource_info].values[2].type = "dbal_result_type_t";
    submodule_data->tables[dnx_data_l3_fec_table_fec_resource_info].values[2].doc = "FEC dbal result type.";
    submodule_data->tables[dnx_data_l3_fec_table_fec_resource_info].values[2].offset = UTILEX_OFFSETOF(dnx_data_l3_fec_fec_resource_info_t, dbal_result_type);

    
    submodule_data->tables[dnx_data_l3_fec_table_super_fec_result_types_map].name = "super_fec_result_types_map";
    submodule_data->tables[dnx_data_l3_fec_table_super_fec_result_types_map].doc = "Map FEC dbal result type to an actual FEC type and FEC resource type.";
    ...
    submodule_data->tables[dnx_data_l3_fec_table_fec_hierachy_position_in_range].doc = "Used to set the allocation order of the FEC hierarchies in the FEC IDs range.";
    ...
    submodule_data->tables[dnx_data_l3_fec_table_fec_hierachy_position_in_range].keys[0].doc = "The hierarchy number 0-2.";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_l3_source_address_define_source_address_table_size].doc = "The maximum number of entries in the source address table.";
    ...
    submodule_data->defines[dnx_data_l3_source_address_define_nof_mymac_prefixes].doc = "Number of mymac prefixes, used by VSI.";
    ...
    submodule_data->defines[dnx_data_l3_source_address_define_max_nof_mac_addresses_used_by_arp].doc = "The max number of profiles, used by the ARP in source address map table.";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_l3_fwd_define_ipmc_config_supported_flags].doc = "Supported flags for the IPMC config APIs.";
    ...
    submodule_data->defines[dnx_data_l3_fwd_define_ipmc_config_supported_traverse_flags].doc = "Supported flags for the IPMC config traverse API.";
    ...
    submodule_data->tables[dnx_data_l3_fwd_table_ipmc_compression_mode].keys[1].doc = "The DBAL table type of the IPMC configuration entry.";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_l3_feature_lpm_uses_lart].doc = "The LPM is using LART (LPM A result type).";
    ...
    submodule_data->features[dnx_data_l3_feature_vpbr_used_for_bfd].doc = "Indicates if VPBR TCAM DB is used for BFD too";
    ...
    submodule_data->features[dnx_data_l3_feature_vpbr_tunnel_available].doc = "Indicates if VPBR lookup can be performed in the tunnel termination stage";
