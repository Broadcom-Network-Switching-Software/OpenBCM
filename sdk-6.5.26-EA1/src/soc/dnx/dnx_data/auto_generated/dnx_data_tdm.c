    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_tdm_params_is_egress_bypass_supported].doc = "self explainatory. may imply we have SAR L1 used for tdm traffic";
    ...
    submodule_data->features[dnx_data_tdm_params_is_sid_wide_mode_supported].doc = "whether sid bigger than 14 bit is supported or not. see define sid_max_size";
    ...
    submodule_data->features[dnx_data_tdm_params_egress_bypass_enable].doc = "indicate if egress bypass feature is enabled or disabled";
    ...
    submodule_data->defines[dnx_data_tdm_params_define_sid_max_size].doc = "how many bits are holding the sid";
