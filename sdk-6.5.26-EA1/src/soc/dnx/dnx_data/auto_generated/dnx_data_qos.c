    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_qos_feature_ttl_uniform_small].doc = "select smaller ttl in case ttl mode is uniform";
    ...
    submodule_data->features[dnx_data_qos_feature_ingress_mpls_swap_qos_ttl_model].doc = "ingres mpls swap qos model and ttl model";
