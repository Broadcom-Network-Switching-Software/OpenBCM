    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_snif_ingress_crop_size_config_is_supported].doc = "Crop size is configurable (not predefined size)";
    ...
    submodule_data->features[dnx_data_snif_ingress_mirror_on_drop_admit_profile_supported].doc = "Mirror admit profiles are configurd per admit profile";
    ...
    submodule_data->features[dnx_data_snif_ingress_ext_stat_dedicated_config].doc = "External stat counters dedicated confiugrations are supported";
    ...
    submodule_data->features[dnx_data_snif_ingress_itpp_delta_supported].doc = "ITPP delta supported";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_snif_egress_egress_null_profile].doc = "Egress null profile used as disable profile";
    ...
    submodule_data->features[dnx_data_snif_egress_probability_profiles].doc = "Egress sniffing has probability profiles";
    ...
    submodule_data->features[dnx_data_snif_egress_crop_size_profiles].doc = "Egress sniffing has crop size profiles";
    ...
    submodule_data->features[dnx_data_snif_egress_egress_mirror_mode].doc = "Egress mirror mode";
    ...
    submodule_data->defines[dnx_data_snif_egress_define_mirror_nof_profiles].doc = "Number of mirror profiles supported by egress SNIF";
    ...
    submodule_data->defines[dnx_data_snif_egress_define_snoop_nof_profiles].doc = "Number of snoop profiles supported by egress SNIF";
    ...
    submodule_data->defines[dnx_data_snif_egress_define_prob_nof_bits].doc = "Probabiltiy number of bits";
    ...
    submodule_data->defines[dnx_data_snif_egress_define_probability_nof_profiles].doc = "number of probability profiles";
    ...
    submodule_data->defines[dnx_data_snif_egress_define_crop_size_nof_profiles].doc = "number of crop size profiles";
    ...
    submodule_data->defines[dnx_data_snif_egress_define_crop_size_granularity].doc = "crop size granularity in bytes";
    ...
    submodule_data->tables[dnx_data_snif_egress_table_rcy_mirror_to_forward_port_map].doc = "Mapping between recycle mirror port to forward port";
    ...
    submodule_data->tables[dnx_data_snif_egress_table_rcy_mirror_to_forward_port_map].keys[0].doc = "logical port";
