    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_fifodma_general_define_nof_fifodma_channels].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_fifodma_general_define_min_nof_host_entries].labels[0] = "j2x_notrev";
    ...
    submodule_data->defines[dnx_data_fifodma_general_define_max_nof_host_entries].labels[0] = "j2x_notrev";
    ...
    submodule_data->tables[dnx_data_fifodma_general_table_fifodma_map].labels[0] = "j2x_notrev";
