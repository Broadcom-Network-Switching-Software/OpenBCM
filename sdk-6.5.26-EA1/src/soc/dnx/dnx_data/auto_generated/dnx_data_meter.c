    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_meter_mem_mgmt_define_nof_banks_in_big_engine].doc = "Noumber of banks (sections) in one c-type engine";
    ...
    submodule_data->defines[dnx_data_meter_mem_mgmt_define_nof_single_buckets_per_entry].doc = "Number of single bucket meters in one engine entry";
    ...
    submodule_data->defines[dnx_data_meter_mem_mgmt_define_nof_dual_buckets_per_entry].doc = "Number of dual buckets meters in one engine entry";
    ...
    submodule_data->defines[dnx_data_meter_mem_mgmt_define_bucket_size_nof_bits].doc = "Number of bits represent current amout of bucket's credits";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_meter_expansion_expansion_for_uuc_umc_support].doc = "When doing expansion per L2-Fwd type, is expading per unknown address supported.";
