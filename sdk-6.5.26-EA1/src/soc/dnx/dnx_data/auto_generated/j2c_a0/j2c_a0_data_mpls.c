...
static shr_error_e
j2c_a0_dnx_data_mpls_general_support_alternate_marking_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_mpls;
...
static shr_error_e
j2c_a0_dnx_data_mpls_general_enc2_implicit_null_w_ahp_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnx_data_module_mpls;
    ...
    int unit)
{
    ...
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_mpls_general_support_alternate_marking_set;
    data_index = dnx_data_mpls_general_enc2_implicit_null_w_ahp_supported;
    feature = &submodule->features[data_index];
    feature->set = j2c_a0_dnx_data_mpls_general_enc2_implicit_null_w_ahp_supported_set;
