    ...
    int unit)
{
    ...
    table->values[0].property.nof_mapping = 16;
    ...
    table->values[0].property.mapping[12].name = "RCH_0";
    table->values[0].property.mapping[12].val = BCM_SWITCH_PORT_HEADER_TYPE_RCH_0;
    table->values[0].property.mapping[13].name = "RCH_1";
    table->values[0].property.mapping[13].val = BCM_SWITCH_PORT_HEADER_TYPE_RCH_1;
    table->values[0].property.mapping[14].name = "RCH_SRV6_USP_PSP";
    table->values[0].property.mapping[14].val = BCM_SWITCH_PORT_HEADER_TYPE_RCH_SRV6_USP_PSP;
    table->values[0].property.mapping[15].name = "STACKING";
    table->values[0].property.mapping[15].val = BCM_SWITCH_PORT_HEADER_TYPE_STACKING;
    ...
    table->values[1].property.nof_mapping = 11;
    ...
    table->values[1].property.mapping[5].name = "TDM";
    table->values[1].property.mapping[5].val = BCM_SWITCH_PORT_HEADER_TYPE_TDM;
    table->values[1].property.mapping[6].name = "INJECTED";
    table->values[1].property.mapping[6].val = BCM_SWITCH_PORT_HEADER_TYPE_INJECTED;
    table->values[1].property.mapping[7].name = "STACKING";
    table->values[1].property.mapping[7].val = BCM_SWITCH_PORT_HEADER_TYPE_STACKING;
    table->values[1].property.mapping[8].name = "TM";
    table->values[1].property.mapping[8].val = BCM_SWITCH_PORT_HEADER_TYPE_TM;
    table->values[1].property.mapping[9].name = "MPLS_RAW";
    table->values[1].property.mapping[9].val = BCM_SWITCH_PORT_HEADER_TYPE_MPLS_RAW;
    table->values[1].property.mapping[10].name = "RCH_SRV6_USP_PSP";
    table->values[1].property.mapping[10].val = BCM_SWITCH_PORT_HEADER_TYPE_RCH_SRV6_USP_PSP;
    ...
    table->values[2].property.nof_mapping = 7;
    ...
    table->values[2].property.mapping[4].name = "STACKING";
    table->values[2].property.mapping[4].val = BCM_SWITCH_PORT_HEADER_TYPE_STACKING;
    table->values[2].property.mapping[5].name = "TM";
    table->values[2].property.mapping[5].val = BCM_SWITCH_PORT_HEADER_TYPE_TM;
    table->values[2].property.mapping[6].name = "RCH_SRV6_USP_PSP";
    table->values[2].property.mapping[6].val = BCM_SWITCH_PORT_HEADER_TYPE_RCH_SRV6_USP_PSP;
...
static shr_error_e
j2c_a0_dnx_data_port_general_ffc_instruction_offset_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_port;
...
static shr_error_e
j2c_a0_dnx_data_port_general_ffc_instruction_width_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_port;
...
static shr_error_e
j2c_a0_dnx_data_port_general_ffc_instruction_input_offset_size_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_port;
...
static shr_error_e
j2c_a0_dnx_data_port_general_nof_ptc_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_port;
...
static shr_error_e
j2c_a0_dnx_data_port_general_nof_out_tm_ports_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_port;
...
static shr_error_e
j2c_a0_dnx_data_port_general_nof_pp_dsp_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_port;
...
static shr_error_e
j2c_a0_dnx_data_port_general_reserved_pp_dsp_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_port;
...
static shr_error_e
j2c_a0_dnx_data_port_general_nof_bits_egress_vlan_membership_if_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnx_data_module_port;
    ...
    int unit)
{
    ...
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_port_general_ffc_instruction_offset_size_set;
    data_index = dnx_data_port_general_define_ffc_instruction_width_size;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_port_general_ffc_instruction_width_size_set;
    data_index = dnx_data_port_general_define_ffc_instruction_input_offset_size;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_port_general_ffc_instruction_input_offset_size_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_port_general_nof_ptc_set;
    data_index = dnx_data_port_general_define_nof_out_tm_ports;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_port_general_nof_out_tm_ports_set;
    data_index = dnx_data_port_general_define_nof_pp_dsp;
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_port_general_nof_pp_dsp_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_port_general_reserved_pp_dsp_set;
    ...
    define = &submodule->defines[data_index];
    define->set = j2c_a0_dnx_data_port_general_nof_bits_egress_vlan_membership_if_set;
