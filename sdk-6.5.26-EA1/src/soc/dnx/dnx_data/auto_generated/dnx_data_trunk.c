    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_trunk_parameters_backup_destination].name = "backup_destination";
    submodule_data->features[dnx_data_trunk_parameters_backup_destination].doc = "device is supporting backup destinations for trunk members";
    submodule_data->features[dnx_data_trunk_parameters_backup_destination].flags |= DNXC_DATA_F_FEATURE;
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_trunk_psc_consistant_hashing_max_group].doc = "is Consistant Hashing PSC supported the max group size or max group size minus 1";
    ...
    submodule_data->defines[dnx_data_trunk_psc_define_consistant_hashing_nof_resources].doc = "nof resources that CHM needs to manage - those are the reduced resources";
    ...
    submodule_data->defines[dnx_data_trunk_psc_define_consistant_hashing_resource_to_entries_ratio].doc = "defines how many HW entries each resource represents";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_trunk_egress_trunk_is_supported].doc = "device is supporting egress trunks";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->doc = "data regarding flow aggregation";
    ...
    submodule_data->defines[dnx_data_trunk_flow_agg_define_flow_aggs_in_bundle].doc = "how many flow aggregates are in a single bundle";
    ...
    submodule_data->defines[dnx_data_trunk_flow_agg_define_nof_flow_aggs].doc = "total number of flow aggregates";
    ...
    submodule_data->defines[dnx_data_trunk_flow_agg_define_nof_flow_agg_bundles].doc = "total number of flow aggregate bundles";
    ...
    submodule_data->defines[dnx_data_trunk_flow_agg_define_first_flow_agg_id].doc = "first flow aggregate id, when presented as a general flow";
