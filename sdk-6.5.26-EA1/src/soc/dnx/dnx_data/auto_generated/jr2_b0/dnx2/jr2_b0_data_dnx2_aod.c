...
static shr_error_e
jr2_b0_dnx_data_dnx2_aod_tables_INGRESS_PRT_INFO___image_set(
    int unit)
{
...
static shr_error_e
jr2_b0_dnx_data_dnx2_aod_tables_INGRESS_PRT_INFO_set(
    int unit)
{
    int index_index;
    ...
    int unit)
{
    ...
    table = &submodule->tables[data_index];
    table->set = jr2_b0_dnx_data_dnx2_aod_tables_INGRESS_PRT_INFO___image_set;
    data_index = dnx_data_dnx2_aod_tables_table_INGRESS_PRT_INFO;
    table = &submodule->tables[data_index];
    table->set = jr2_b0_dnx_data_dnx2_aod_tables_INGRESS_PRT_INFO_set;
