    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_pp_stages_define_is_vtt5_supported].doc = "indicated whether VTT5 stage is supported on device";
    ...
    submodule_data->tables[dnx_data_pp_stages_table_params].values[0].doc = "chuck block ID used by PEMLA";
    ...
    submodule_data->tables[dnx_data_pp_stages_table_params].values[1].doc = "stage validity flag";
    ...
    submodule_data->tables[dnx_data_pp_stages_table_params].values[2].doc = "stage name";
    ...
    submodule_data->tables[dnx_data_pp_stages_table_params].values[3].doc = "block name";
    ...
    submodule_data->tables[dnx_data_pp_stages_table_params].values[4].doc = "flag indicating support by Filed Processor";
    ...
    submodule_data->tables[dnx_data_pp_stages_table_params].values[5].doc = "flag indicating kleap processing";
    ...
    submodule_data->tables[dnx_data_pp_stages_table_params].values[6].doc = "flag indicating PEM processing available";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_pp_PEM_define_nof_pem_blocks_per_core].doc = "number of PEM blocks per core";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_pp_debug_table_from_signal_str].doc = "string of the 'from' stage that signals will be taken";
    ...
    submodule_data->tables[dnx_data_pp_debug_table_from_signal_str].values[0].doc = "in_port 'from' stage signal";
    ...
    submodule_data->tables[dnx_data_pp_debug_table_from_signal_str].values[1].doc = "ptc 'from' stage signal";
    ...
    submodule_data->tables[dnx_data_pp_debug_table_from_signal_str].values[2].doc = "in_lif 'from' stage signal";
    ...
    submodule_data->tables[dnx_data_pp_debug_table_from_signal_str].values[3].doc = "fwd_domain 'from' stage signal";
    ...
    submodule_data->tables[dnx_data_pp_debug_table_from_signal_str].values[4].doc = "layers 'from' stage signal";
    ...
    submodule_data->tables[dnx_data_pp_debug_table_from_signal_str].values[5].doc = "ingress_qos 'from' stage signal";
