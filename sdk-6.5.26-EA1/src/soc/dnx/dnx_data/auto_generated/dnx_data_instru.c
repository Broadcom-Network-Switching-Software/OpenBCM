    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_instru_sflow_hard_logic_supported].doc = "SFLOW Hard Logic supported";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_instru_ifa_define_ifa2_is_supported].doc = "IFA2 is supported on device";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->doc = "IPv6 hop-by-hop path-tracing module";
    ...
    submodule_data->defines[dnx_data_instru_hbh_pt_define_Ingress_1588_ToD_LSB_size].doc = "Ingress_1588_ToD_LSB signal size";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_instru_eventor_is_periodic_events_supported].doc = "eventor periodic events is supported indication";
    ...
    submodule_data->defines[dnx_data_instru_eventor_define_tx_builder_limitation_1].doc = "builder threshold size must be a full multiplication of event size or zero, if 0 no limitation";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->doc = "Synchronous triggers Mechanism";
    ...
    submodule_data->defines[dnx_data_instru_synced_triggers_define_synced_trigger_version].doc = "synced trigger version. 0 - J2, J2C, Q2A, 1 - J2P,J2X, 2 - future devices";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_instru_synced_counters_define_cgm_max_nof_intervals].doc = "The number of intervals in one round of the Synced counters instrumentation logic for CGM.";
    ...
    submodule_data->defines[dnx_data_instru_synced_counters_define_nif_max_nof_intervals].doc = "The number of intervals in one round of the Synced counters instrumentation logic for NIF.";
