    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_pvt_general_pvt_lock_support].doc = "Indicate if PVT support lock mechnism";
    ...
    submodule_data->tables[dnx_data_pvt_general_table_pvt_name].labels[0] = "j2x_notrev";
