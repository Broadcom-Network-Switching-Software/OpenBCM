    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_intr_general_define_ser_reset_cb_en_support].doc = "If support soft reset CB function.";
    ...
    submodule_data->tables[dnx_data_intr_general_table_framer_module_map].doc = "framer register module map";
    ...
    submodule_data->tables[dnx_data_intr_general_table_framer_module_map].keys[0].doc = "framer register module index";
