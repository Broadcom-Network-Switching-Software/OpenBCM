    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->doc = "logical lane mapping for OTN";
    ...
    submodule_data->tables[dnx_data_lane_map_otn_table_logical_lanes].doc = "The front panel logical lane bitmap";
    ...
    submodule_data->tables[dnx_data_lane_map_otn_table_logical_lanes].keys[0].doc = "logical port number";
    ...
    submodule_data->tables[dnx_data_lane_map_otn_table_logical_lanes].values[0].doc = "The front panel logical lane bitmap";
    ...
    submodule_data->tables[dnx_data_lane_map_otn_table_logical_otn_lane].doc = "The first framer logical lane";
    ...
    submodule_data->tables[dnx_data_lane_map_otn_table_logical_otn_lane].keys[0].doc = "logical port number";
    ...
    submodule_data->tables[dnx_data_lane_map_otn_table_logical_otn_lane].values[0].doc = "The first framer logical lane number";
