    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnx_data_dev_init_properties_table_unsupported].labels[0] = "j2x_notrev";
    ...
    submodule_data->tables[dnx_data_dev_init_properties_table_unsupported].values[1].doc = "used in case the soc property read using method - suffix";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_dev_init_general_ecologic_container_support].doc = "ecologic container feature is supported";
    ...
    submodule_data->features[dnx_data_dev_init_general_egress_estimated_bta_btr_hw_config].doc = "Set estimated byte to add and estimated byte to remove configuration in egress pipe";
    ...
    submodule_data->features[dnx_data_dev_init_general_outlif_intf_hw_config].doc = "intf used for the global outlif";
    ...
    submodule_data->features[dnx_data_dev_init_general_outlif_group_hw_config].doc = "group id used for the global outlif";
    ...
    submodule_data->tables[dnx_data_dev_init_general_table_clock_power_down].labels[0] = "j2x_notrev";
