    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_failover_path_select_define_ingress_mc_size].doc = "size of ingress multicast path select table";
    ...
    submodule_data->defines[dnx_data_failover_path_select_define_ing_mc_no_protection].doc = "Protection path pointer indicating no protection";
    ...
    submodule_data->defines[dnx_data_failover_path_select_define_nof_fec_path_select_banks_in_hw].doc = "number of banks included in fec protection path select table in HW";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_failover_facility_wcmp_facility_protection_supported].doc = "Indication if the WCMP facility protection feature is supported.";
