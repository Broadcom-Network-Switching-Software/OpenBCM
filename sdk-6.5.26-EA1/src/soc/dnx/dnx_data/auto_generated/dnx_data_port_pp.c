    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_port_pp_general_recycle_app_sbfd_reflector].doc = "Indicates if sbfd reflector recycle application is supported";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_port_pp_filters_egress_filters_enable_per_recycle_port_supported].doc = "Indicate if SDK uses the recycle port to control if egress filters enable";
