    ...
    int unit)
{
    ...
    dnx_data_device.general.nof_dies_get = dnx_data_device_general_nof_dies_get;
    dnx_data_device.general.nof_cores_per_die_get = dnx_data_device_general_nof_cores_per_die_get;
    ...
    dnx_data_egr_queuing_v1.shaping.max_max_burst_value_get = dnx_data_egr_queuing_v1_shaping_max_max_burst_value_get;
    dnx_data_egr_queuing_v1.shaping.max_queue_max_burst_value_get = dnx_data_egr_queuing_v1_shaping_max_queue_max_burst_value_get;
    ...
    dnx_data_field.external_tcam.payload_offset_granularity_get = dnx_data_field_external_tcam_payload_offset_granularity_get;
    ...
    dnx_data_field.features.epmf_inlif_profile_map_get = dnx_data_field_features_epmf_inlif_profile_map_get;
    ...
    dnx_data_field.tests.stub_cmodel_supports_semantic_flush_get = dnx_data_field_tests_stub_cmodel_supports_semantic_flush_get;
    ...
    dnx_data_lif.out_lif.max_nof_prp_outlif_profiles_get = dnx_data_lif_out_lif_max_nof_prp_outlif_profiles_get;
    dnx_data_lif.out_lif.max_prp_outlif_profile_size_get = dnx_data_lif_out_lif_max_prp_outlif_profile_size_get;
    dnx_data_lif.out_lif.nof_prp_outlif_profile_groups_get = dnx_data_lif_out_lif_nof_prp_outlif_profile_groups_get;
    ...
    dnx_data_module_testing.example_tests.default_memory_threshold_get = dnx_data_module_testing_example_tests_default_memory_threshold_get;
    ...
    dnx_data_mpls.general.fwd1_trap_destination_get = dnx_data_mpls_general_fwd1_trap_destination_get;
    dnx_data_mpls.general.fwd1_trap_destination_info_get = dnx_data_mpls_general_fwd1_trap_destination_info_get;
    ...
    dnx_data_nif.global.max_nof_mgmt_ports_get = dnx_data_nif_global_max_nof_mgmt_ports_get;
    ...
    dnx_data_nif.framer.b66switch_block_id_get = dnx_data_nif_framer_b66switch_block_id_get;
    dnx_data_nif.framer.b66switch_block_id_info_get = dnx_data_nif_framer_b66switch_block_id_info_get;
    ...
    dnx_data_nif.mac_client.speed_granularity_get = dnx_data_nif_mac_client_speed_granularity_get;
    ...
    dnx_data_nif.sar_client.speed_granularity_get = dnx_data_nif_sar_client_speed_granularity_get;
