...
extern shr_error_e j2x_a0_data_stat_attach(
    int unit);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnx_data_stat_stat_pp_epp_combined_interfaces].name = "epp_combined_interfaces";
    submodule_data->features[dnx_data_stat_stat_pp_epp_combined_interfaces].doc = "ETPP and ERPP interfaces are combined into EPP";
    submodule_data->features[dnx_data_stat_stat_pp_epp_combined_interfaces].flags |= DNXC_DATA_F_FEATURE;
    ...
    submodule_data->features[dnx_data_stat_stat_pp_erpp_counter_profile_per_outlif].name = "erpp_counter_profile_per_outlif";
    submodule_data->features[dnx_data_stat_stat_pp_erpp_counter_profile_per_outlif].doc = "If true there is a hw table to indicate counter_profile per outlif";
    submodule_data->features[dnx_data_stat_stat_pp_erpp_counter_profile_per_outlif].flags |= DNXC_DATA_F_FEATURE;
    ...
    submodule_data->defines[dnx_data_stat_stat_pp_define_supported_egress_interface_counter_enum].name = "supported_egress_interface_counter_enum";
    submodule_data->defines[dnx_data_stat_stat_pp_define_supported_egress_interface_counter_enum].doc = "Valid enum for egress PP counter interface";
    
    submodule_data->defines[dnx_data_stat_stat_pp_define_supported_egress_interface_counter_enum].flags |= DNXC_DATA_F_NUMERIC;
...
uint32
dnx_data_stat_stat_pp_supported_egress_interface_counter_enum_get(
    int unit)
{
    return dnxc_data_mgmt_define_data_get(unit, dnx_data_module_stat, dnx_data_stat_submodule_stat_pp, dnx_data_stat_stat_pp_define_supported_egress_interface_counter_enum);
}
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnx_data_stat_drop_reasons_define_nof_drop_reasons].labels[0] = "j2x_notrev";
    ...
    submodule_data->tables[dnx_data_stat_drop_reasons_table_group_drop_reason_index].labels[0] = "j2x_notrev";
    ...
    submodule_data->tables[dnx_data_stat_drop_reasons_table_drop_reason_index].labels[0] = "j2x_notrev";
    ...
    submodule_data->tables[dnx_data_stat_drop_reasons_table_drop_reasons_groups].labels[0] = "j2x_notrev";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->nof_features = _dnx_data_stat_feature_feature_nof;
    DNXC_DATA_ALLOC(submodule_data->features, dnxc_data_feature_t,  submodule_data->nof_features, "_dnxc_data stat feature features");

    submodule_data->features[dnx_data_stat_feature_itpp_cud_count_always_stamp].name = "itpp_cud_count_always_stamp";
    submodule_data->features[dnx_data_stat_feature_itpp_cud_count_always_stamp].doc = "";
    submodule_data->features[dnx_data_stat_feature_itpp_cud_count_always_stamp].flags |= DNXC_DATA_F_FEATURE;

    
    submodule_data->nof_defines = _dnx_data_stat_feature_define_nof;
    DNXC_DATA_ALLOC(submodule_data->defines, dnxc_data_define_t, submodule_data->nof_defines, "_dnxc_data stat feature defines");

    
    submodule_data->nof_tables = _dnx_data_stat_feature_table_nof;
    DNXC_DATA_ALLOC(submodule_data->tables, dnxc_data_table_t, submodule_data->nof_tables, "_dnxc_data stat feature tables");
...
int
dnx_data_stat_feature_feature_get(
    int unit,
    dnx_data_stat_feature_feature_e feature)
{
    return dnxc_data_mgmt_feature_data_get(unit, dnx_data_module_stat, dnx_data_stat_submodule_feature, feature);
}
    ...
    dnxc_data_module_t *module_data)
{
    ...
    SHR_IF_ERR_EXIT(dnx_data_stat_feature_init(unit, &module_data->submodules[dnx_data_stat_submodule_feature]));
    ...
    {
        SHR_IF_ERR_EXIT(jr2_a0_data_stat_attach(unit));
        SHR_IF_ERR_EXIT(j2x_a0_data_stat_attach(unit));
    }
    else
