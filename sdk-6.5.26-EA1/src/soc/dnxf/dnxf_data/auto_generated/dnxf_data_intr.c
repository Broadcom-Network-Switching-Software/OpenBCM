    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnxf_data_intr_general_define_ser_reset_cb_en_support].doc = "If support soft reset CB function.";
    submodule_data->defines[dnxf_data_intr_general_define_ser_reset_cb_en_support].labels[0] = "data_notrev";
