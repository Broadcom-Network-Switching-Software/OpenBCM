...
static shr_error_e
ramon_a0_dnxf_data_module_testing_max_test_greater_d3_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_module_testing;
    int submodule_index = dnxf_data_module_testing_submodule_max_test;
    int define_index = dnxf_data_module_testing_max_test_define_greater_d3;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_module_testing_max_test_greater_d1_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_module_testing;
    int submodule_index = dnxf_data_module_testing_submodule_max_test;
    int define_index = dnxf_data_module_testing_max_test_define_greater_d1;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_module_testing_max_test_same_value_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_module_testing;
    int submodule_index = dnxf_data_module_testing_submodule_max_test;
    int define_index = dnxf_data_module_testing_max_test_define_same_value;
    SHR_FUNC_INIT_VARS(unit);
...
static shr_error_e
ramon_a0_dnxf_data_module_testing_max_test_d3_undefined_set(
    int unit)
{
    dnxc_data_define_t *define;
    int module_index = dnxf_data_module_module_testing;
    int submodule_index = dnxf_data_module_testing_submodule_max_test;
    int define_index = dnxf_data_module_testing_max_test_define_d3_undefined;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    submodule_index = dnxf_data_module_testing_submodule_max_test;
    submodule = &module->submodules[submodule_index];

    
    data_index = dnxf_data_module_testing_max_test_define_greater_d3;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_module_testing_max_test_greater_d3_set;
    data_index = dnxf_data_module_testing_max_test_define_greater_d1;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_module_testing_max_test_greater_d1_set;
    data_index = dnxf_data_module_testing_max_test_define_same_value;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_module_testing_max_test_same_value_set;
    data_index = dnxf_data_module_testing_max_test_define_d3_undefined;
    define = &submodule->defines[data_index];
    define->set = ramon_a0_dnxf_data_module_testing_max_test_d3_undefined_set;
