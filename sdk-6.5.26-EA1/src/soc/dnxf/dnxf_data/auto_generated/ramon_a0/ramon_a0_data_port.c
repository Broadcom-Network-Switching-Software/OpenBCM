    ...
    int unit)
{
    ...
    define->property.doc = 
        "\n"
        "Sets the statistics thread flag.\n"
        "0x0 indicates that counter DMA should NOT be used\n"
        "0x1 indicates that counter DMA should be used.\n"
        "\n"
    ;
    define->property.method = dnxc_data_property_method_range;
    define->property.method_str = "range";
...
static shr_error_e
ramon_a0_dnxf_data_port_static_add_serdes_tx_taps_pre3_supported_instead_post3_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnxf_data_module_port;
    int submodule_index = dnxf_data_port_submodule_static_add;
    int feature_index = dnxf_data_port_static_add_serdes_tx_taps_pre3_supported_instead_post3;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    table->values[5].property.doc =
        "\n"
        "Shows if a certain FE link is connected to a device in repeater mode\n"
        "\n"
    ;
...
static shr_error_e
ramon_a0_dnxf_data_port_lane_map_is_quad_swap_supported_set(
    int unit)
{
    dnxc_data_feature_t *feature;
    int module_index = dnxf_data_module_port;
    int submodule_index = dnxf_data_port_submodule_lane_map;
    int feature_index = dnxf_data_port_lane_map_is_quad_swap_supported;
    SHR_FUNC_INIT_VARS(unit);
    ...
    int unit)
{
    ...
    data_index = dnxf_data_port_static_add_serdes_tx_taps_pre3_supported_instead_post3;
    feature = &submodule->features[data_index];
    feature->set = ramon_a0_dnxf_data_port_static_add_serdes_tx_taps_pre3_supported_instead_post3_set;
    ...
    data_index = dnxf_data_port_lane_map_is_quad_swap_supported;
    feature = &submodule->features[data_index];
    feature->set = ramon_a0_dnxf_data_port_lane_map_is_quad_swap_supported_set;
