    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnxf_data_module_testing_unsupported_supported_feature].labels[0] = "data_notrev";
    ...
    submodule_data->features[dnxf_data_module_testing_unsupported_unsupported_feature].labels[0] = "data_notrev";
    ...
    submodule_data->defines[dnxf_data_module_testing_unsupported_define_supported_def].labels[0] = "data_notrev";
    ...
    submodule_data->defines[dnxf_data_module_testing_unsupported_define_unsupported_def].labels[0] = "data_notrev";
    ...
    submodule_data->tables[dnxf_data_module_testing_unsupported_table_supported_table].labels[0] = "data_notrev";
    ...
    submodule_data->tables[dnxf_data_module_testing_unsupported_table_unsupported_table].labels[0] = "data_notrev";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnxf_data_module_testing_types_table_all].labels[0] = "data_notrev";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnxf_data_module_testing_property_methods_feature_enable].labels[0] = "data_notrev";
    ...
    submodule_data->defines[dnxf_data_module_testing_property_methods_define_numeric_range].labels[0] = "data_notrev";
    ...
    submodule_data->tables[dnxf_data_module_testing_property_methods_table_enable].labels[0] = "data_notrev";
    ...
    submodule_data->tables[dnxf_data_module_testing_property_methods_table_port_enable].labels[0] = "data_notrev";
    ...
    submodule_data->tables[dnxf_data_module_testing_property_methods_table_suffix_enable].labels[0] = "data_notrev";
    ...
    submodule_data->tables[dnxf_data_module_testing_property_methods_table_range].labels[0] = "data_notrev";
    ...
    submodule_data->tables[dnxf_data_module_testing_property_methods_table_port_range].labels[0] = "data_notrev";
    ...
    submodule_data->tables[dnxf_data_module_testing_property_methods_table_suffix_range].labels[0] = "data_notrev";
    ...
    submodule_data->tables[dnxf_data_module_testing_property_methods_table_direct_map].labels[0] = "data_notrev";
    ...
    submodule_data->tables[dnxf_data_module_testing_property_methods_table_port_direct_map].labels[0] = "data_notrev";
    ...
    submodule_data->tables[dnxf_data_module_testing_property_methods_table_suffix_direct_map].labels[0] = "data_notrev";
    ...
    submodule_data->tables[dnxf_data_module_testing_property_methods_table_custom].labels[0] = "data_notrev";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->doc = "submodule used to test max define statements";
    ...
    submodule_data->defines[dnxf_data_module_testing_max_test_define_greater_d3].doc = "greater d3";
    ...
    submodule_data->defines[dnxf_data_module_testing_max_test_define_greater_d1].doc = "greater d1";
    ...
    submodule_data->defines[dnxf_data_module_testing_max_test_define_same_value].doc = "same value";
    ...
    submodule_data->defines[dnxf_data_module_testing_max_test_define_d1_undefined].doc = "d1 undefined";
    ...
    submodule_data->defines[dnxf_data_module_testing_max_test_define_d3_undefined].doc = "d3 undefined";
