    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->features[dnxf_data_device_general_serdes_support].labels[0] = "data_notrev";
    ...
    submodule_data->features[dnxf_data_device_general_fabric_support].labels[0] = "data_notrev";
    ...
    submodule_data->features[dnxf_data_device_general_delay_exist].labels[0] = "data_notrev";
    ...
    submodule_data->features[dnxf_data_device_general_cmic_support].labels[0] = "data_notrev";
    ...
    submodule_data->features[dnxf_data_device_general_real_interrupts_support].labels[0] = "data_notrev";
    ...
    submodule_data->features[dnxf_data_device_general_i2c_hw_support].labels[0] = "data_notrev";
    ...
    submodule_data->features[dnxf_data_device_general_hw_support].labels[0] = "data_notrev";
    ...
    submodule_data->features[dnxf_data_device_general_is_not_all_cores_active].doc = "Indicate if only some of the virtual devices are active";
    ...
    submodule_data->defines[dnxf_data_device_general_define_nof_cores].labels[0] = "data_notrev";
    ...
    submodule_data->defines[dnxf_data_device_general_define_adapter_lib_ver].doc = "Indicate the adapter lib version";
    ...
    submodule_data->defines[dnxf_data_device_general_define_nof_mesh_topology_links_data].doc = "Indicates the nof mesh_topology link data";
    ...
    submodule_data->defines[dnxf_data_device_general_define_system_ref_core_clock_khz].labels[0] = "data_notrev";
    ...
    submodule_data->tables[dnxf_data_device_general_table_ctest_full_file_indentifier].doc = "Indicates what is the suffix of tcl/tlist files generated by ctest export full command.";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnxf_data_device_access_define_mdio_int_divisor].labels[0] = "data_notrev";
    ...
    submodule_data->defines[dnxf_data_device_access_define_mdio_ext_divisor].labels[0] = "data_notrev";
    ...
    submodule_data->defines[dnxf_data_device_access_define_mdio_int_div_out_delay].labels[0] = "data_notrev";
    ...
    submodule_data->defines[dnxf_data_device_access_define_mdio_ext_div_out_delay].labels[0] = "data_notrev";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnxf_data_device_blocks_define_nof_all_blocks].labels[0] = "data_notrev";
    ...
    submodule_data->defines[dnxf_data_device_blocks_define_nof_instances_brdc_fsrd].labels[0] = "data_notrev";
    ...
    submodule_data->defines[dnxf_data_device_blocks_define_nof_links_in_rtp].doc = "Number of links for each RTP block.";
    ...
    submodule_data->defines[dnxf_data_device_blocks_define_nof_instances_occg].labels[0] = "data_notrev";
    ...
    submodule_data->defines[dnxf_data_device_blocks_define_nof_instances_eci].labels[0] = "data_notrev";
    ...
    submodule_data->defines[dnxf_data_device_blocks_define_nof_instances_cmic].labels[0] = "data_notrev";
    ...
    submodule_data->defines[dnxf_data_device_blocks_define_nof_instances_mesh_topology].labels[0] = "data_notrev";
    ...
    submodule_data->defines[dnxf_data_device_blocks_define_nof_instances_brdc_fmach].labels[0] = "data_notrev";
    ...
    submodule_data->defines[dnxf_data_device_blocks_define_nof_instances_brdc_fmacl].labels[0] = "data_notrev";
    ...
    submodule_data->defines[dnxf_data_device_blocks_define_nof_instances_lcm].labels[0] = "data_notrev";
    ...
    submodule_data->defines[dnxf_data_device_blocks_define_nof_instances_mct].labels[0] = "data_notrev";
    ...
    submodule_data->defines[dnxf_data_device_blocks_define_nof_instances_pcu].doc = "Number of PCU instances.";
    ...
    submodule_data->defines[dnxf_data_device_blocks_define_nof_instances_ccml].doc = "Number of CCML instances.";
    ...
    submodule_data->defines[dnxf_data_device_blocks_define_nof_instances_dfl].doc = "Number of DFL instances.";
    ...
    submodule_data->defines[dnxf_data_device_blocks_define_nof_instances_dtm].doc = "Number of DTM instances.";
    ...
    submodule_data->defines[dnxf_data_device_blocks_define_nof_instances_pads].doc = "Number of PADS instances.";
    ...
    submodule_data->defines[dnxf_data_device_blocks_define_nof_instances_dfl_fbc].doc = "Number of DFL_FBC instances.";
    ...
    submodule_data->defines[dnxf_data_device_blocks_define_nof_instances_dtl].doc = "Number of DTL instances.";
    ...
    submodule_data->defines[dnxf_data_device_blocks_define_nof_instances_mesh_topology_wrap].doc = "Number of MESH Topology Wrap instances.";
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_override].labels[0] = "data_notrev";
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_fmac_lane_to_block_map].doc = "Maps FMAC lane to other block instances. Some devices intruduce a complex mapping of FMAC lane to core links.";
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_fmac_lane_to_block_map].keys[0].doc = "Table entry index";
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_dch_instances_to_device_stage].doc = "Describres which DCH blocks are facing FAP and which face FE2. information is relevant only for FE13 mode. From this RX infotmation we can deduce what are the values for DCML blocks - they are the oposite.";
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_dch_instances_to_device_stage].keys[0].doc = "Device mode of type soc_dnxf_block_mapping_stage_type_t, 0 - FE1, 1 - FE3";
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_rtp].doc = "Table with registry and fields needed to power down unused per VD blocks. Each block corresponds to a DCH";
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_rtp].keys[0].doc = "Running index";

    
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_rtp].nof_values = 2;
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_rtp].values[0].name = "clock_reg";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_rtp].values[0].type = "int";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_rtp].values[0].doc = "Reg per block of type block_SPECIAL_CLOCK_CONTROLSr to stop the clock to the block";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_rtp].values[0].offset = UTILEX_OFFSETOF(dnxf_data_device_blocks_power_down_per_rtp_t, clock_reg);
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_rtp].values[1].name = "soft_init_fields";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_rtp].values[1].type = "uint32[DNXF_DATA_MAX_DEVICE_BLOCKS_NOF_INSTANCES_RTP]";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_rtp].values[1].doc = "Field inside ECI_BLOCKS_SOFT_INIT to put the block in reset";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_rtp].values[1].offset = UTILEX_OFFSETOF(dnxf_data_device_blocks_power_down_per_rtp_t, soft_init_fields);

    
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dch].name = "power_down_per_dch";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dch].doc = "Table with registry and fields needed to power down unused per VD blocks. Each block corresponds to a DCH";
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dch].keys[0].doc = "Running index";

    
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dch].nof_values = 2;
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dch].values[0].name = "clock_reg";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dch].values[0].type = "int";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dch].values[0].doc = "Reg per block of type block_SPECIAL_CLOCK_CONTROLSr to stop the clock to the block";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dch].values[0].offset = UTILEX_OFFSETOF(dnxf_data_device_blocks_power_down_per_dch_t, clock_reg);
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dch].values[1].name = "soft_init_fields";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dch].values[1].type = "uint32[DNXF_DATA_MAX_DEVICE_BLOCKS_NOF_INSTANCES_DCH]";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dch].values[1].doc = "Field inside ECI_BLOCKS_SOFT_INIT to put the block in reset";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dch].values[1].offset = UTILEX_OFFSETOF(dnxf_data_device_blocks_power_down_per_dch_t, soft_init_fields);

    
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_fmac].name = "power_down_per_fmac";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_fmac].doc = "Table with registry and fields needed to power down unused per VD blocks. Each block corresponds to a FMAC";
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_fmac].keys[0].doc = "Running index";

    
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_fmac].nof_values = 2;
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_fmac].values[0].name = "clock_reg";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_fmac].values[0].type = "int";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_fmac].values[0].doc = "Reg per block of type block_SPECIAL_CLOCK_CONTROLSr to stop the clock to the block";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_fmac].values[0].offset = UTILEX_OFFSETOF(dnxf_data_device_blocks_power_down_per_fmac_t, clock_reg);
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_fmac].values[1].name = "soft_init_fields";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_fmac].values[1].type = "uint32[DNXF_DATA_MAX_DEVICE_BLOCKS_NOF_INSTANCES_FMAC]";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_fmac].values[1].doc = "Field inside ECI_BLOCKS_SOFT_INIT to put the block in reset";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_fmac].values[1].offset = UTILEX_OFFSETOF(dnxf_data_device_blocks_power_down_per_fmac_t, soft_init_fields);

    
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dfl_fbc].name = "power_down_per_dfl_fbc";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dfl_fbc].doc = "Table with registry and fields needed to power down unused per VD blocks. Each block corresponds to a DFL FBC";
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dfl_fbc].keys[0].doc = "Running index";

    
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dfl_fbc].nof_values = 2;
    ...
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dfl_fbc].values[0].name = "clock_reg";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dfl_fbc].values[0].type = "int";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dfl_fbc].values[0].doc = "Reg per block of type block_SPECIAL_CLOCK_CONTROLSr to stop the clock to the block";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dfl_fbc].values[0].offset = UTILEX_OFFSETOF(dnxf_data_device_blocks_power_down_per_dfl_fbc_t, clock_reg);
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dfl_fbc].values[1].name = "soft_init_fields";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dfl_fbc].values[1].type = "uint32[DNXF_DATA_MAX_DEVICE_BLOCKS_NOF_LINKS_IN_DCH]";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dfl_fbc].values[1].doc = "Field inside ECI_BLOCKS_SOFT_INIT to put the block in reset";
    submodule_data->tables[dnxf_data_device_blocks_table_power_down_per_dfl_fbc].values[1].offset = UTILEX_OFFSETOF(dnxf_data_device_blocks_power_down_per_dfl_fbc_t, soft_init_fields);
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnxf_data_device_interrupts_define_nof_interrupts].labels[0] = "data_notrev";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnxf_data_device_custom_features_define_active_core].doc = "The index of the active core";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->tables[dnxf_data_device_properties_table_unsupported].labels[0] = "data_notrev";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnxf_data_device_emulation_define_emulation_system].labels[0] = "data_notrev";
