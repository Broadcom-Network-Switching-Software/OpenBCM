    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnxf_data_dev_init_time_define_init_total_thresh].labels[0] = "data_notrev";
    ...
    submodule_data->defines[dnxf_data_dev_init_time_define_appl_init_total_thresh].labels[0] = "data_notrev";
    ...
    submodule_data->tables[dnxf_data_dev_init_time_table_step_thresh].labels[0] = "data_notrev";
    ...
    submodule_data->tables[dnxf_data_dev_init_time_table_appl_step_thresh].labels[0] = "data_notrev";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnxf_data_dev_init_shadow_define_cache_enable_all].labels[0] = "data_notrev";
    ...
    submodule_data->defines[dnxf_data_dev_init_shadow_define_cache_enable_ecc].labels[0] = "data_notrev";
    ...
    submodule_data->defines[dnxf_data_dev_init_shadow_define_cache_enable_parity].labels[0] = "data_notrev";
    ...
    submodule_data->defines[dnxf_data_dev_init_shadow_define_cache_enable_specific].labels[0] = "data_notrev";
    ...
    submodule_data->defines[dnxf_data_dev_init_shadow_define_cache_disable_specific].labels[0] = "data_notrev";
    ...
    submodule_data->tables[dnxf_data_dev_init_shadow_table_uncacheable_mem].labels[0] = "data_notrev";
    ...
    submodule_data->tables[dnxf_data_dev_init_shadow_table_uncacheable_mem].values[1].doc = "marks if a table entry is valid";
    ...
    dnxc_data_submodule_t *submodule_data)
{
    ...
    submodule_data->defines[dnxf_data_dev_init_ha_define_warmboot_backoff_rate].doc = "Exponential rate at which to skip tests in WarmBoot regression sessions";
    submodule_data->defines[dnxf_data_dev_init_ha_define_warmboot_backoff_rate].labels[0] = "data_notrev";
    ...
    submodule_data->defines[dnxf_data_dev_init_ha_define_nof_guaranteed_reboots].doc = "Specify number of tests at beginning of session to run reboots for";
    submodule_data->defines[dnxf_data_dev_init_ha_define_nof_guaranteed_reboots].labels[0] = "data_notrev";
    ...
    submodule_data->defines[dnxf_data_dev_init_ha_define_warmboot_support].labels[0] = "data_notrev";
    ...
    submodule_data->defines[dnxf_data_dev_init_ha_define_sw_state_max_size].labels[0] = "data_notrev";
    ...
    submodule_data->defines[dnxf_data_dev_init_ha_define_stable_location].labels[0] = "data_notrev";
    ...
    submodule_data->defines[dnxf_data_dev_init_ha_define_stable_size].labels[0] = "data_notrev";
    ...
    submodule_data->tables[dnxf_data_dev_init_ha_table_stable_filename].labels[0] = "data_notrev";
