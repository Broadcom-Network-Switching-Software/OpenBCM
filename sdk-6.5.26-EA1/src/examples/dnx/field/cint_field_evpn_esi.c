...
int cint_field_evpn_ingress(int unit, int inlif_profile)
{
    ...
    if (feature_mpls_term_till_bos) {
        ...
        rv = cint_field_evpn_fl_ingress(unit, inlif_profile);
        if(rv != BCM_E_NONE)
        {
            printf("%s Error in cint_field_evpn_fl_ingress\n", proc_name);
            return rv;
        }
        return BCM_E_NONE;
    }
    ...
    bcm_field_presel_entry_id_t * presel_entry_id)
{
    ...
    proc_name = "cint_field_evpn_fl_ingress_context_create";
    ...
    rv = bcm_field_context_create(unit, 0, bcmFieldStageIngressPMF1, &context_info, context_id_p);
    if(rv != BCM_E_NONE)
    {
        printf("%s: Error in bcm_field_context_create context %d\n", proc_name, *context_id_p);
        return rv;
    }
...
int cint_field_evpn_fl_ingress_pmf1_fg_add(int unit, evpn_fg_info_s *fg)
{
    ...
    proc_name = "cint_field_evpn_fl_ingress_fg_add";
    ...
    */
    ...
    rv = bcm_field_group_add(unit, 0, &ing_fg->fg_info, &ing_fg->fg_id);
    if(rv != BCM_E_NONE)
    {
        printf("%s Error in bcm_field_group_add\n", proc_name);
        return rv;
...
int cint_field_evpn_fl_ingress_pmf1_fg_attach(int unit, evpn_fg_info_s * ing_pmf1_fg)
{
    ...
    rv = bcm_field_group_context_attach(unit, 0, ing_pmf1_fg->fg_id, ing_pmf1_fg->context_id, &attach_info);
    if(rv != BCM_E_NONE)
    {
        printf("Error in cint_field_evpn_fl_ingress_fg_attach fg_id %d context_id %d\n", ing_pmf1_fg->fg_id, ing_pmf1_fg->context_id);
        return rv;
    }
...
int cint_field_evpn_fl_ingress_pmf1_install(int unit, int inlif_profile)
{
    ...
    rv = cint_field_evpn_fl_ingress_pmf1_context_create(unit,
    ...
    if(rv != BCM_E_NONE)
    {
        printf("%s Error in cint_field_evpn_fl_ingress_context_create\n", proc_name);
        return rv;
    }

    rv = cint_field_evpn_fl_ingress_pmf1_fg_add(unit, &dnx_evpn_field_info.ing_pmf1_fg);
    if(rv != BCM_E_NONE)
    {
        printf("%s Error in cint_field_evpn_fl_ingress_fg_add\n", proc_name);
        return rv;
    }

    rv = cint_field_evpn_fl_ingress_pmf1_fg_attach(unit, &dnx_evpn_field_info.ing_pmf1_fg);
    if(rv != BCM_E_NONE)
    {
        printf("%s Error in cint_field_evpn_fl_ingress_fg_attach\n", proc_name);
        return rv;
    }
    ...
    rv = bcm_field_entry_add(unit, 0, dnx_evpn_field_info.ing_pmf1_fg.fg_id, &entry_in_info, &entry_handle);
    if (rv != BCM_E_NONE)
    {
        printf("%s Error (%d), in bcm_field_entry_add for context %d, fg_id %d\n", proc_name, rv,
               dnx_evpn_field_info.ing_pmf1_fg.context_id, dnx_evpn_field_info.ing_pmf1_fg.fg_id);
        return rv;
    }

    /** Store the entry handle for destroy convenience.*/
    rv = cint_field_evpn_field_entry_handle_store(unit, entry_handle, dnx_evpn_field_info.ing_pmf1_fg.entry_handle);
    if (rv != BCM_E_NONE)
    {
        printf("%s Error (%d), in cint_field_evpn_field_entry_handle_store for handle %d\n", proc_name, rv, entry_handle);
        return rv;
    }
    ...
    bcm_field_presel_entry_id_t * presel_entry_id)
{
    ...
    proc_name = "cint_field_evpn_fl_ingress_pmf2_cas_context_create";
    ...
    rv = bcm_field_context_create(unit, 0, bcmFieldStageIngressPMF2, &context_info, context_id_p);
    if(rv != BCM_E_NONE)
    {
        printf("%s: Error in bcm_field_context_create context %d\n", proc_name, *context_id_p);
        return rv;
    ...
    if (rv != BCM_E_NONE)
    {
        printf("%s: Error in bcm_field_context_param_set for context %d\n", proc_name, *context_id_p);
        return rv;
    }
...
int cint_field_evpn_fl_ingress_pmf2_cas_fg_add(int unit, int fl_enable, evpn_fg_info_s *fg)
{
    ...
    proc_name = "cint_field_evpn_fl_ingress_pmf2_cas_fg_add";
    ...
    if (dnx_evpn_field_info.esi_valid_qual == 0) {
        ...
        rv = bcm_field_qualifier_create(unit, 0, &qual_info, &dnx_evpn_field_info.esi_valid_qual);
        if(rv != BCM_E_NONE)
        {
            printf("%s Error in bcm_field_qualifier_create esi_valid_qual\n", proc_name);
            return rv;
        }
    }
...
int cint_field_evpn_fl_ingress_pmf2_cas_fg_attach(int unit, int fl_enable, evpn_fg_info_s * ing_pmf2_fg)
{
    ...
    rv = bcm_field_group_context_attach(unit, 0, ing_pmf2_fg->fg_id, ing_pmf2_fg->context_id, &attach_info);
    if(rv != BCM_E_NONE)
    {
        printf("Error in bcm_field_group_context_attach fg_id %d context_id %d\n", ing_pmf2_fg->fg_id, ing_pmf2_fg->context_id);
        return rv;
    }
...
int cint_field_evpn_fl_ingress_pmf2_install(int unit)
{
    ...
    proc_name = "cint_field_evpn_fl_ingress_pmf2_install";


    printf("Install PMF2 configurations for EVPN with Flow Label.\n");

    rv = cint_field_evpn_fl_ingress_pmf2_cas_context_create(unit, 1,
    ...
    if(rv != BCM_E_NONE)
    {
        printf("%s Error in cint_field_evpn_fl_ingress_pmf2_cas_context_create\n", proc_name);
        return rv;
    }

    rv = cint_field_evpn_fl_ingress_pmf2_cas_fg_add(unit, 1, &dnx_evpn_field_info.ing_pmf2_fg1);
    if(rv != BCM_E_NONE)
    {
        printf("%s Error in cint_field_evpn_fl_ingress_pmf2_cas_fg_add\n", proc_name);
        return rv;
    }

    rv = cint_field_evpn_fl_ingress_pmf2_cas_fg_attach(unit, 1, &dnx_evpn_field_info.ing_pmf2_fg1);
    if(rv != BCM_E_NONE)
    {
        printf("%s Error in cint_field_evpn_fl_ingress_pmf2_cas_fg_attach\n", proc_name);
        return rv;
    }
    ...
    rv = cint_field_evpn_fl_ingress_pmf2_cas_context_create(unit, 0,
                                                            dnx_evpn_field_info.ing_pmf1_fg,
    ...
    rv = cint_field_evpn_fl_ingress_pmf2_cas_fg_add(unit, 0, &dnx_evpn_field_info.ing_pmf2_fg2);
    if(rv != BCM_E_NONE)
    {
        printf("%s Error in cint_field_evpn_fl_ingress_pmf2_cas_fg_add\n", proc_name);
        return rv;
    ...
    rv = cint_field_evpn_fl_ingress_pmf2_cas_fg_attach(unit, 0, &dnx_evpn_field_info.ing_pmf2_fg2);
    if(rv != BCM_E_NONE)
    {
        printf("%s Error in cint_field_evpn_fl_ingress_pmf2_cas_fg_attach\n", proc_name);
        return rv;
...
int cint_field_evpn_fl_ingress(int unit, int inlif_profile)
{
    ...
    rv = cint_field_evpn_fl_ingress_pmf1_install(unit, inlif_profile);
    if(rv != BCM_E_NONE)
    {
        printf("%s Error in cint_field_evpn_fl_ingress_pmf1_install\n", proc_name);
        return rv;
    }

    rv = cint_field_evpn_fl_ingress_pmf2_install(unit);
    if(rv != BCM_E_NONE)
    {
        printf("%s Error in cint_field_evpn_fl_ingress_pmf2_install\n", proc_name);
        return rv;
    }
...
int cint_field_evpn_egress_fg_add(int unit, bcm_field_group_t *fg_id_p)
{
    ...
    */
    ...
    rv = bcm_field_group_add(unit, 0, &dnx_evpn_field_info.egr_fg.fg_info, fg_id_p);
    if(rv != BCM_E_NONE)
    {
        printf("%s Error in bcm_field_group_add\n", proc_name);
        return rv;
...
int cint_field_evpn_etree_ingress_fg_add(int unit)
{
    ...
    rv = bcm_field_group_add(unit, 0, &dnx_evpn_field_info.ing_etree_fg.fg_info, &dnx_evpn_field_info.ing_etree_fg.fg_id);
    if(rv != BCM_E_NONE)
    {
        printf("%s Error in bcm_field_group_add\n", proc_name);
        return rv;
...
int cint_field_evpn_destroy_all_entries(int unit)
{
    ...
    for (entry_idx = 0; entry_idx < max_nof_entry_handles; entry_idx++)
    {
        ...
        {
            rv = bcm_field_entry_delete(unit,dnx_evpn_field_info.ing_fg2.fg_id, NULL, dnx_evpn_field_info.ing_fg2.entry_handle[entry_idx]);
            if (rv != BCM_E_NONE)
            {
                printf("%s Error (%d), in bcm_field_entry_delete for egress for fg_id %d for entry %d\n", proc_name, rv,
                       dnx_evpn_field_info.ing_fg2.fg_id, dnx_evpn_field_info.ing_fg2.entry_handle[entry_idx]);
                return rv;
            }
        }
...
int cint_field_evpn_destroy_all(int unit)
{
    ...
    rv = cint_field_evpn_fg_destroy(unit, dnx_evpn_field_info.ing_pmf1_fg);
    if (rv != BCM_E_NONE)
    {
        printf("%s Error (%d), in cint_field_evpn_fg_destroy for fg_id %d\n", proc_name, rv, dnx_evpn_field_info.ing_fg.fg_id);
        return rv;
    ...
    rv = cint_field_evpn_fg_destroy(unit, dnx_evpn_field_info.ing_pmf2_fg1);
    if (rv != BCM_E_NONE)
    {
        printf("%s Error (%d), in cint_field_evpn_fg_destroy for fg_id %d\n", proc_name, rv, dnx_evpn_field_info.ing_fg.fg_id);
        return rv;
    ...
    rv = cint_field_evpn_fg_destroy(unit, dnx_evpn_field_info.ing_pmf2_fg2);
    if (rv != BCM_E_NONE)
    {
        printf("%s Error (%d), in cint_field_evpn_fg_destroy for fg_id %d\n", proc_name, rv, dnx_evpn_field_info.ing_fg.fg_id);
        return rv;
