    ...
    int is_multi_core)
{
    ...
    char *tmp_ptr;
    uint32 flags;
    proc_name = "cint_field_external_per_port_fg_add";
    ...
    rv = bcm_field_action_create(unit, 0, &action_info, &cint_field_external_per_port_external_uda);
    if (rv != BCM_E_NONE)
    {
    ...
    uint32 payload_offset)
{
    ...
    proc_name = "cint_field_external_per_port_fg_attach";
    ...
    int is_multi_core)
{
    ...
    proc_name = "cint_field_external_per_port_entry_add";
    ...
    rv = bcm_field_entry_add(unit, 0, external_fg_id, &entry_info, &cint_field_external_per_port_entry_id);
    if (rv != BCM_E_NONE)
    {
    ...
    int in_port)
{
    ...
    proc_name = "cint_field_external_per_port_main";
    ...
    rv = cint_field_external_per_port_fg_add(unit, &fg_info, &cint_field_external_per_port_fg_id, is_multi_core);
    if (rv != BCM_E_NONE)
    {
        printf("%s Error (%d), in cint_field_external_per_port_fg_add fg_id %d\n", proc_name, rv, cint_field_external_per_port_fg_id);
        return rv;
    }

    rv = cint_field_external_per_port_fg_attach(unit, cint_field_external_per_port_fg_id, &fg_info, cint_field_external_per_port_external_app_type, cint_field_external_per_port_payload_id, cint_field_external_per_port_payload_offset);
    if (rv != BCM_E_NONE)
    {
        printf("%s Error (%d), in cint_field_external_per_port_fg_attach fg_id %d external_app_type %d\n", proc_name, rv, cint_field_external_per_port_fg_id,  (cint_field_external_per_port_external_app_type & 0x00ff));
        return rv;
    }
    ...
    rv = cint_field_external_per_port_entry_add(unit, cint_field_external_per_port_fg_id, &fg_info, in_port, is_multi_core);
    if (rv != BCM_E_NONE)
    {
        printf("%s Error (%d), in cint_field_external_per_port_entry_add fg_id %d external_app_type %d\n", proc_name, rv, cint_field_external_per_port_fg_id,  (cint_field_external_per_port_external_app_type & 0x00ff));
        return rv;
    }
...
cint_field_external_per_port_destroy(int unit)
{
    ...
    proc_name = "cint_field_external_per_port_destroy";

    /*
     * At this point external field group cannot be deleted, so we only delete the entries.
     */
    rv = bcm_field_entry_delete(unit, cint_field_external_per_port_fg_id, NULL, cint_field_external_per_port_entry_id);
    if (rv != BCM_E_NONE)
    {
