    ...
    cint_field_udh_cascading_fg_info_t * udh_fg_info)
{
    ...
    rv = bcm_field_group_add(unit, 0, &fg_info, &(udh_fg_info->fg_id));
    if (rv != BCM_E_NONE)
    {
    ...
    int unit)
{
    ...
    /** Creating IPMF1 Field Group. */
    rv = cint_field_udh_cascading_group_config(unit, field_udh_cascading_j2_mode_stacking_fg_info_array[0]);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d), in cint_field_udh_cascading_group_config\n", rv);
        return rv;
    ...
    /** Creating EPMF Field Group. */
    rv = cint_field_udh_cascading_group_config(unit, field_udh_cascading_j2_mode_stacking_fg_info_array[1]);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d), in cint_field_udh_cascading_group_config\n", rv);
        return rv;
    ...
    int unit)
{
    ...
    /** Destroying IPMF1 Field Configuration. */
    rv = cint_field_udh_cascading_destroy(unit, field_udh_cascading_j2_mode_stacking_fg_info_array[0], TRUE);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d), in cint_field_udh_cascading_destroy\n", rv);
        return rv;
    ...
    /** Destroying EPMF Field Configuration. */
    rv = cint_field_udh_cascading_destroy(unit, field_udh_cascading_j2_mode_stacking_fg_info_array[1], FALSE);
    if (rv != BCM_E_NONE)
    {
        printf("Error (%d), in cint_field_udh_cascading_destroy\n", rv);
        return rv;
