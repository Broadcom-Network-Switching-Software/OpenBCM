...
int cint_field_srv6_evpn_egress_fg_add(int unit, bcm_field_group_t *fg_id_p)
{
    ...
    rv = bcm_field_group_add(unit, 0, &egress_fg_info, fg_id_p);
    if(rv != BCM_E_NONE)
    {
        printf("%s Error in bcm_field_group_add\n", proc_name);
        return rv;
...
int cint_field_srv6_evpn_egress_btr_comp_fg_add_attach(int unit, bcm_field_context_t context_id)
{
    ...
    rv = bcm_field_group_add(unit, 0, &egress_btr_fg_info, &fg_id);
    if(rv != BCM_E_NONE)
    {
        printf("%s Error in bcm_field_group_add\n", proc_name);
        return rv;
    ...
    int dst_port)
{
    ...
    proc_name = "cint_field_srv6_evpn_esi_encap_egress";
    ...
    rv = bcm_port_class_set(unit, dst_port, bcmPortClassFieldEgressPacketProcessingPortCs, port_class_evpn_epmf);
    if(rv != BCM_E_NONE) {
        printf("%s: Error in bcm_port_class_set port_class %d\n", proc_name, bcmPortClassFieldEgressPacketProcessingPortCs);
        return rv;
    }
    ...
    rv = bcm_field_context_create(unit, 0, bcmFieldStageEgress, &context_info, &field_srv6_evpn_esi_encap_info.egress_context_id);
    if(rv != BCM_E_NONE) {
        printf("%s: Error in bcm_field_context_create\n", proc_name);
        return rv;
    }
    ...
    */
    ...
    rv = bcm_field_group_add(unit, 0, &field_srv6_evpn_esi_encap_info.egress_fg_info, &field_srv6_evpn_esi_encap_info.egress_fg_id);
    if(rv != BCM_E_NONE)
    {
        printf("%s Error in bcm_field_group_add\n", proc_name);
        return rv;
    ...
    rv = bcm_field_ace_format_add(unit, 0, &ace_format_info, &field_srv6_evpn_esi_encap_info.ace_format_id);
    if(rv != BCM_E_NONE)
    {
        printf("%s Error in bcm_field_ace_format_add\n", proc_name);
        return rv;
    }
    ...
    rv = bcm_field_group_context_attach(unit, 0, field_srv6_evpn_esi_encap_info.egress_fg_id, field_srv6_evpn_esi_encap_info.egress_context_id, &attach_info);
    if(rv != BCM_E_NONE)
    {
        printf("Error in bcm_field_group_context_attach fg_id %d context_id %d\n", field_srv6_evpn_esi_encap_info.egress_fg_id, field_srv6_evpn_esi_encap_info.egress_context_id);
        return rv;
    }
    ...
    int esi_tunnel_id)
{
    ...
    proc_name = "cint_field_srv6_evpn_esi_encap_egress_entry_add";

    printf("Adding to EPMF source vp:0x%08X, dest vp:%08X --> esi_tunnel_id:%08X\n",src_vp, dst_vp, esi_tunnel_id);
    ...
    rv = bcm_field_ace_entry_add(unit, 0, field_srv6_evpn_esi_encap_info.ace_format_id, &ace_entry_info, &ace_entry_id);
    if (rv != BCM_E_NONE)
    {
        printf("%s Error (%d), in bcm_field_ace_entry_add for ace format %d, ace_entry_id %d\n", proc_name, rv, field_srv6_evpn_esi_encap_info.ace_format_id, ace_entry_id);
        return rv;
    }
    ...
    */
    ...
    rv = bcm_field_entry_add(unit, 0, field_srv6_evpn_esi_encap_info.egress_fg_id, &entry_in_info, entry_handle);
    if (rv != BCM_E_NONE)
    {
        printf("%s Error (%d), in bcm_field_entry_add for context %d, fg_id %d\n", proc_name, rv, field_srv6_evpn_esi_encap_info.egress_context_id, field_srv6_evpn_esi_encap_info.egress_fg_id);
        return rv;
    }
    ...
    int unit)
{
    int rv = BCM_E_NONE;
    int index;
    char *proc_name = "cint_field_srv6_evpn_esi_encap_egress_destroy";
    ...
    for (index = 0; index < field_srv6_evpn_esi_encap_info.nof_esi_encap_egress_entries; index ++) {
        rv = bcm_field_entry_delete(unit, field_srv6_evpn_esi_encap_info.egress_fg_id, NULL, field_srv6_evpn_esi_encap_info.egress_entry_handles[index]);
        if (rv != BCM_E_NONE)
        {
            printf("%s Error (%d), in bcm_field_entry_delete for egress for fg_id %d for default entry %d\n", proc_name, rv,
                   field_srv6_evpn_esi_encap_info.egress_fg_id, field_srv6_evpn_esi_encap_info.egress_entry_handles[index]);
            return rv;
        }

        rv = bcm_field_ace_entry_delete(unit, field_srv6_evpn_esi_encap_info.ace_entry_id[index]);
        if (rv != BCM_E_NONE)
        {
            printf("%s Error (%d), in bcm_field_ace_entry_delete for egress for ace_entry_id %d \n", proc_name, rv,
                   field_srv6_evpn_esi_encap_info.ace_entry_id[index]);
            return rv;
        }
    }

    /** Delete the ace format*/
    rv = bcm_field_ace_format_delete(unit, field_srv6_evpn_esi_encap_info.ace_format_id);
    if(rv != BCM_E_NONE)
    {
        printf("%s Error in bcm_field_ace_format_delete for ace_format_id \n", proc_name, field_srv6_evpn_esi_encap_info.ace_format_id);
        return rv;
    }


    /** Deattach the context and FG */
    rv = bcm_field_group_context_detach(unit, field_srv6_evpn_esi_encap_info.egress_fg_id, field_srv6_evpn_esi_encap_info.egress_context_id);
    if(rv != BCM_E_NONE)
    {
    ...
    rv = bcm_field_group_delete(unit, field_srv6_evpn_esi_encap_info.egress_fg_id);
    if(rv != BCM_E_NONE)
    {
        printf("%s Error in bcm_field_group_delete for egress fg_id \n", proc_name, field_srv6_evpn_esi_encap_info.egress_fg_id);
        return rv;
    }
    ...
    rv = bcm_field_context_destroy(unit, bcmFieldStageEgress, field_srv6_evpn_esi_encap_info.egress_context_id);
    if(rv != BCM_E_NONE)
    {
        printf("%s Error in bcm_field_context_destroy for egress context %d\n",proc_name, field_srv6_evpn_esi_encap_info.egress_context_id);
        return rv;
    }
