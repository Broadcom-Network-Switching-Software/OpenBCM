 ...
 *          Relevant for untagged and tagged ethernet packets. (When EthType >= 0x800)
 *          In case EthType < 0x800 the cint will not work and bcmFieldQualifyEtherTypeUntagged should be used.
 *
