    ...
    int unit)
{
    ...
    */
     ...
     */
    rv = bcm_field_context_create(unit, 0, bcmFieldStageIngressPMF1, &context_info, &Cint_field_fem_context_id);
    if (rv != BCM_E_NONE)
    {
    ...
    int is_fem_fg)
{
     ...
     * Add the FG.
     */
    rv = bcm_field_group_add(unit, 0, &fg_info, &fem_fg_info_p->fg_id);
    if (rv != BCM_E_NONE)
    {
