    ...
    int unit)
{
    ...
    rv = bcm_rx_trap_type_create(unit, 0, trap_type, &cint_rx_trap_epmf_visibility_qual_trap_action_trap_id);
    if(rv != BCM_E_NONE)
    {
    ...
    rv = bcm_rx_trap_set(unit, cint_rx_trap_epmf_visibility_qual_trap_action_trap_id, &trap_config);
    if(rv != BCM_E_NONE)
    {
    ...
    bcm_field_context_t  context_id)
{
    ...
    rv = bcm_field_group_add(unit, 0, fg_info, &cint_rx_trap_epmf_visibility_qual_trap_action_fg_id);
    if(rv != BCM_E_NONE)
    {
    ...
    rv = bcm_field_group_context_attach(unit, 0, cint_rx_trap_epmf_visibility_qual_trap_action_fg_id, context_id, &attach_info);
    if(rv != BCM_E_NONE)
    {
    ...
    rv = bcm_field_entry_add(unit, 0, cint_rx_trap_epmf_visibility_qual_trap_action_fg_id, &entry_info, &cint_rx_trap_epmf_visibility_qual_trap_action_entry_id);
    if(rv != BCM_E_NONE)
    {
    ...
    bcm_field_context_t  context_id)
{
    ...
    rv = bcm_field_entry_delete(unit, cint_rx_trap_epmf_visibility_qual_trap_action_fg_id, NULL, cint_rx_trap_epmf_visibility_qual_trap_action_entry_id);
    if(rv != BCM_E_NONE)
    {
    ...
    rv = bcm_field_group_context_detach(unit, cint_rx_trap_epmf_visibility_qual_trap_action_fg_id, context_id);
    if(rv != BCM_E_NONE)
    {
    ...
    rv = bcm_field_group_delete(unit, cint_rx_trap_epmf_visibility_qual_trap_action_fg_id);
    if(rv != BCM_E_NONE)
    {
    ...
    rv = bcm_rx_trap_type_destroy(unit, cint_rx_trap_epmf_visibility_qual_trap_action_trap_id);
    if(rv != BCM_E_NONE)
    {
    ...
    bcm_field_context_t context_id)
{
    ...
    rv = cint_rx_trap_epmf_visibility_qual_trap_action_trap_create_and_set(unit);
    if(rv != BCM_E_NONE)
    {
    ...
    rv = cint_rx_trap_epmf_visibility_qual_trap_action_pmf_configuration_create(unit, context_id);
    if(rv != BCM_E_NONE)
    {
      printf("Error in pmf_trap_create_and_set \n");
      return rv;
