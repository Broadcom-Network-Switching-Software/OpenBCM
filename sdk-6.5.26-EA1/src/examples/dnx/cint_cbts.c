    ...
    int port4)
{
    ...
    rv = l3__ecmp_create(unit, cint_mpls_ecmp_basic_info.ecmp_intf, 8, cint_mpls_ecmp_basic_info.fec_ids, BCM_L3_WITH_ID |BCM_L3_2ND_HIERARCHY, BCM_L3_ECMP_DYNAMIC_MODE_DISABLED,&ecmp, 0);
    if (rv != BCM_E_NONE)
    {
