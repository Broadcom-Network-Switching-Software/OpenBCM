 ...
 * 
 ...
 Copyright 2007-2022 Broadcom Inc. All rights reserved. File: cint_dnx_utility_mpls.c Purpose: Various examples for MPLS.
 */
    ...
    int port2)
{
    ...
    /* add vlan to Ac port */
    rv = bcm_vlan_gport_add(unit, vpls_util_advanced_vpn, port1, BCM_VLAN_GPORT_ADD_INGRESS_ONLY);
    if (rv != BCM_E_NONE)
    {
