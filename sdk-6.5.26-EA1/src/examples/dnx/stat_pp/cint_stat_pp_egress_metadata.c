    ...
    int mpls_label)
{
    ...
    rv = cint_stat_pp_config_main(unit, egress_metadata_statistics_config, interface_type, gport, BCM_CORE_ALL, TRUE);
    if (rv != BCM_E_NONE)
    {
    ...
    int vid)
{
    ...
    rv = cint_stat_pp_config_main(unit, egress_metadata_statistics_config, interface_type, 0, BCM_CORE_ALL, FALSE);
    if (rv != BCM_E_NONE)
    {
        printf("egress_metadata_statistics_config failed for etps_1_statistics_config\n");
        return rv;
    ...
    int vid)
{
    ...
    if (rv != BCM_E_NONE)
    {
        printf("Error, in function bcm_stat_pp_metadata_set IPv4 UC \n");
    }
    ...
    if (rv != BCM_E_NONE)
    {
        printf("Error, in function bcm_stat_pp_metadata_set IPv4 MC \n");
    }
    ...
    if (rv != BCM_E_NONE)
    {
        printf("Error, in function bcm_stat_pp_metadata_set IPv6 UC \n");
    }
    ...
    if (rv != BCM_E_NONE)
    {
        printf("Error, in function bcm_stat_pp_metadata_set IPv6 MC \n");
    }
