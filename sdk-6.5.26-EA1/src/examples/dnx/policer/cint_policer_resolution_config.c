    ...
    int burst_size)
{
    ...
    if (rv != BCM_E_NONE)
    {
        printf("Error in bcm_policer_create for meter A_1\n");
        return rv;
    }
    ...
    if (rv != BCM_E_NONE)
    {
        printf("Error in bcm_policer_create for meter A_2\n");
        return rv;
    }
    ...
    if (rv != BCM_E_NONE)
    {
        printf("Error in bcm_policer_create for meter B\n");
        return rv;
    }
    ...
    if (rv != BCM_E_NONE)
    {
        printf("Error in bcm_policer_create for meter C\n");
        return rv;
    }
    ...
    rv = bcm_field_group_add(unit, BCM_FIELD_FLAG_MSB_RESULT_ALIGN, &fg_info, &fg_id_new);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = bcm_field_group_context_attach(unit, 0,fg_id_new , 0, &attach_info);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = bcm_field_entry_add(unit, 0, fg_id_new, &ent_info, &entry_id);
    if (rv != BCM_E_NONE)
    {
        printf("Error in bcm_field_entry_add 1\n");
        return rv;
    }
    ...
    if (rv != BCM_E_NONE)
    {
        printf("Error in bcm_field_entry_add 3\n");
        return rv;
    }
