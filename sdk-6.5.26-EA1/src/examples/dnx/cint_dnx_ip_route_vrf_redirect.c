    ...
    int recycle_port)
{
    ...
    rv = add_host_ipv6_encap_dest(unit, cint_ip_route_basic_ipv6_host, cint_ip_tunnel_basic_info.access_vrf, 0, recycle_entry_encap_id, recycle_port);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = add_host_ipv6(unit, cint_ip_route_basic_ipv6_host, new_vrf, fec_id);
    if (rv != BCM_E_NONE)
    {
