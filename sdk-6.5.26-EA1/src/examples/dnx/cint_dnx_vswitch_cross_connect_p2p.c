/* 
 * $Id: cint_dnx_vswitch_cross_connect_p2p.c
 ...
 * cint cint_dnx_vswitch_cross_connect_p2p.c
 * cint
...
run(int unit, int port1, int type1, int protection1, int second_port1 /* used if protection1 is set */,
    ...
    if (protection1 == 2) {
        ...
        egress_mc = 0;
        rv = multicast__open_mc_group(unit, &cross_connect_info.protection_mc1, 0);
        if (rv != BCM_E_NONE) {
    ...
    /* 1+1 protection */
        ...
        /* create MC for protection */
        egress_mc = 0;
        rv = multicast__open_mc_group(unit, &cross_connect_info.protection_mc2, 0);
        if (rv != BCM_E_NONE) {
            printf("Error, multicast__open_mc_group\n");
            return rv;
        }
