    ...
    int core_port)
{
    ...
    rv = get_first_fec_in_range_which_not_in_ecmp_range(unit, 0, 0, &cint_vpls_roo_basic_info.core_native_fec_id);
    if (rv != BCM_E_NONE)
    {
    ...
    rv = get_first_fec_in_range_which_not_in_ecmp_range(unit, 1, 0, &cint_vpls_roo_basic_info.core_overlay_fec_id);
    if (rv != BCM_E_NONE)
    {
        printf("Error, get_first_fec_in_range_which_not_in_ecmp_range\n");
        return rv;
    }
   rv = get_first_fec_in_range_which_not_in_ecmp_range(unit, 2, 0, &cint_vpls_roo_basic_info.core_overlay_fec_id2);
   if (rv != BCM_E_NONE)
   {
       printf("Error, get_first_fec_in_range_which_not_in_ecmp_range\n");
       return rv;
    ...
    int unit)
{
    ...
    if (rv != BCM_E_NONE)
    {
        printf("Error, intf_eth_rif_create_with_qos \n");
        return rv;
    }
