...
struct cint_vpls_pwe_tagged_mode_extended_p2p_info_s
{
    ...
    bcm_gport_t access_egress_vlan_port_id[4];     /* vlan port id of the access port, used for egress at terination flow */
    ...
    int core_port)
{
    ...
    for (idx = 0; idx < cint_vpls_pwe_tagged_mode_extended_p2p_info.nof_service_tag_types - 1; idx++) {
        /*
         * configure PWE tunnel - ingress flow for nof_service_tags = 0/1/2/x
         */
