    ...
    int user_profile_id)
{
    ...
    {
        if (ecmp_id > *(dnxc_data_get(unit,"l3","ecmp","max_ecmp_basic_mode",NULL)))
        {
...

{
    int rv;
    int iter;
    uint32 nof_offsets_user_profiles;
    ...
    nof_offsets_user_profiles = *(dnxc_data_1d_get(unit, "l3", "ecmp", "consistent_tables_info", "nof_entries", 0));
    ...
    */
    if (cint_ecmp_info.user_profile_id)
    {
        ...
        rv = l3__ecmp_user_profile_create(unit,BCM_L3_WITH_ID,BCM_L3_ECMP_DYNAMIC_MODE_RESILIENT,
                cint_ecmp_info.user_profile_id,nof_offsets_user_profiles,intf_offset,&user_profile_ecmp);
    ...
    if ((cint_ecmp_info.user_profile_id==0) && (is_consistent == 0))
    {
        rv = l3__ecmp_create(unit, ecmp_id, NOF_OF_MEMBERS_ECMP_GROUP, intf_array, BCM_L3_WITH_ID,
                             BCM_L3_ECMP_DYNAMIC_MODE_DISABLED, &ecmp,cint_ecmp_info.user_profile_id);
    }
    else
    {
        rv = l3__ecmp_create(unit, ecmp_id, NOF_OF_MEMBERS_ECMP_GROUP, intf_array, BCM_L3_WITH_ID,
