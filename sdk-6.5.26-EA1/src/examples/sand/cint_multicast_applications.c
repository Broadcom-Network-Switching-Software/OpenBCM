 ...
 *
 * The Configuration assumes only one Soc_petra device and ERP port (for device level) is enabled.
 */
    ...
    int nof_destinations)
{
    ...
    {
        /*
         * When creating bitmap groups in Jericho 2, they need to be added to a linked list group that will point to
         * them.
         *
