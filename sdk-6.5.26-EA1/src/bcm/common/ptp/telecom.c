...
#define PACKET_MASTER_INVALID(PKT_MASTER) \
        ...
        ((1 == _bcm_ptp_telecom_g8265_clock_class_enable)                       \
...
static int _bcm_ptp_telecom_g8265_clock_class_enable = 1;
    ...
    int clock_num)
{
    ...
    _bcm_ptp_telecom_g8265_clock_class_enable = 1;
    return BCM_E_NONE;
}
    ...
    _bcm_ptp_event_t event_type)
{
    ...
    if (event_type == _bcm_ptp_master_unavail_event) {
        PACKET_MASTER(el).ptsf.loss_announce = 1;
        /*
         * PTSF criteria met?
         * Set PTSF timestamp and PTSF occurence counter.
         */
...
int
_bcm_ptp_telecom_g8265_clock_class_enable_set(
    int unit,
    bcm_ptp_stack_id_t ptp_id,
    int clock_num,
    int enable)
{
    ...
    _bcm_ptp_telecom_g8265_clock_class_enable = enable;
