...
/*
 * Function:
 *      bcm_policer_action_config_t_init
 * Purpose:
 *      Initialize the policer action config struct
 * Parameters:
 *      act_cfg - Pointer to the struct to be init'ed
 */
void
bcm_policer_action_config_t_init(bcm_policer_action_config_t *act_cfg)
{
    if (act_cfg != NULL) {
        sal_memset(act_cfg, 0, sizeof(bcm_policer_action_config_t));
    }
    return;
}
...
/*
 * Function:
 *      bcm_policer_action_param_t_init
 * Purpose:
 *      Initialize the policer action struct
 * Parameters:
 *      act_param - Pointer to the struct to be init'ed
 */
void
bcm_policer_action_param_t_init(bcm_policer_action_param_t *act_param)
{
    if (act_param != NULL) {
        sal_memset(act_param, 0, sizeof(bcm_policer_action_param_t));
    }
    return;
}
...
/*
 * Function:
 *      bcm_policer_flexctr_config_t_init
 * Purpose:
 *      Initialize the policer flex counter struct
 * Parameters:
 *      flexctr_cfg - Pointer to the struct to be init'ed
 */
void
bcm_policer_flexctr_config_t_init(bcm_policer_flexctr_config_t *flexctr_cfg)
{
    if (flexctr_cfg != NULL) {
        sal_memset(flexctr_cfg, 0, sizeof(bcm_policer_flexctr_config_t));
    }
    return;
}
