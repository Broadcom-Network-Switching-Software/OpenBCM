 ...
 *      bcm_petra_ptp_clock_port_delay_asymmetry_get
 *      bcm_petra_ptp_clock_port_delay_asymmetry_set
...
int bcm_petra_ptp_clock_port_tlv_config_add(
    int unit,
    bcm_ptp_stack_id_t ptp_id,
    int clock_index,
    uint32 clock_port,
...
int bcm_petra_ptp_clock_port_tlv_config_delete(
    int unit,
    bcm_ptp_stack_id_t ptp_id,
    int clock_index,
    uint32 clock_port,
...
int bcm_petra_ptp_clock_port_tlv_config_delete_all(
    int unit,
    bcm_ptp_stack_id_t ptp_id,
    int clock_index,
    uint32 clock_port)
...
int bcm_petra_ptp_clock_tlv_enable_set(
    int unit,
    bcm_ptp_stack_id_t ptp_id,
    int clock_index,
    uint32 clock_port,
...
int bcm_petra_ptp_clock_tlv_enable_get(
    int unit,
    bcm_ptp_stack_id_t ptp_id,
    int clock_index,
    uint32 clock_port,
