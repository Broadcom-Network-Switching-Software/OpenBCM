    ...
    uint32 alloc_flags)
{
    ...
    extra_create_info.grain_size[0] = tag_grain;
    extra_create_info.max_tag_value[0] = max_tag_value;
    ...
    SHR_IF_ERR_EXIT(resource_tag_bitmap_create(unit, node_id, res_tag_bitmap,
    ...
    void *extra_argument)
{
    ...
    SHR_IF_ERR_EXIT(resource_tag_bitmap_advanced_free
                    (unit, node_id, res_tag_bitmap, &res_tag_bitmap_free_info, element));
    ...
    int *element)
{
    ...
    rc = resource_tag_bitmap_alloc(unit, node_id, res_tag_bitmap, &res_tag_bitmap_alloc_info, element);
