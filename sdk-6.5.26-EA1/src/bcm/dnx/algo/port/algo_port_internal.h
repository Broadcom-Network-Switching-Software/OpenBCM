 ...
 */
#define DNX_ALGO_PORT_INTERFACE_HANDLE1_FOR_OLP(unit, core, interface_id) (core * dnx_data_egr_queuing.params.nof_egr_olp_interfaces_get(unit) + interface_id)
#define DNX_ALGO_PORT_INTERFACE_HANDLE1_FOR_OLP_SIZE(unit) (dnx_data_device.general.nof_cores_get(unit) * dnx_data_egr_queuing.params.nof_egr_olp_interfaces_get(unit))
/**
 * \brief Creating TM interface id (key to TM interface DB) for OLP port.
 */
 ...
 */
#define DNX_ALGO_PORT_INTERFACE_HANDLE1_FOR_RCY(unit, core, interface_id) (core * dnx_data_egr_queuing.params.nof_egr_rcy_interfaces_get(unit) + interface_id)
#define DNX_ALGO_PORT_INTERFACE_HANDLE1_FOR_RCY_SIZE(unit) (dnx_data_device.general.nof_cores_get(unit) * dnx_data_egr_queuing.params.nof_egr_rcy_interfaces_get(unit))
...
#define DNX_ALGO_PORT_INTERFACE_HANDLE1_FOR_FLEXE_CLIENT_SIZE(unit) (dnx_data_nif.flexe.nof_clients_get(unit))
...
#define DNX_ALGO_PORT_INTERFACE_HANDLE1_FOR_FLEXE_SAR_SIZE(unit) (dnx_data_nif.sar_client.nof_clients_get(unit))
...
#define DNX_ALGO_PORT_INTERFACE_HANDLE1_FOR_FLEXE_MAC_SIZE(unit) (dnx_data_nif.mac_client.nof_clients_get(unit))
 ...
 * \param [in] is_out - 1 - out channel, 0 - in channel
 *
 * \return
 *   see shr_error_e
 * \remark
...
/**
 * \brief -
 * Verify that core X out_tm_port are in supported range (per device)
 ...
 * \param [in] interface_handle - interface handle of the port
 *
 * \return
 *   see shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_algo_port_out_tm_port_free_verify(
    int unit,
    dnx_algo_port_info_s port_info,
    bcm_core_t core,
    int out_tm_port,
...
/**
 * \brief -
 * Verify mc attribute is eligible when adding a port
 *
 * \param [in] unit - Unit #.
 * \param [in] logical_port - logical port
 * \param [in] port_info - basic port info
 * \param [in] common_info - common port info
 *
 * \return
 *   see shr_error_e
 * \remark
 ...
 *   * None
 */
shr_error_e dnx_algo_port_mc_add_verify(
    int unit,
    bcm_port_t logical_port,
    dnx_algo_port_info_s port_info,
