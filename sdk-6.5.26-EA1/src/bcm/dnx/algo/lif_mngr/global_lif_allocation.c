    ...
    uint32 alloc_flags)
{
    ...
    extra_create_info.grain_size[0] = dnx_data_lif.global_lif.global_lif_grain_size_get(unit);
    ...
    {
        dnx_global_lif_tag_max_val_get(unit, &extra_create_info.max_tag_value[0]);
    }
    ...
    if (extra_create_info.max_tag_value[0])
    {
