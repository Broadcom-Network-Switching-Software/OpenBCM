    ...
    int unit)
{
     ...
     */
    {
        ...
        extra_create_info.grain_size[0] = dnx_data_l3.ecmp.ecmp_bank_size_get(unit);
        extra_create_info.max_tag_value[0] = dnx_data_mdb.direct.nof_fec_ecmp_hierarchies_get(unit) - 1;
     ...
     */
    {
        ...
        extra_create_info.max_tag_value[0] = dnx_data_mdb.direct.nof_fec_ecmp_hierarchies_get(unit);
    ...
    int unit)
{
     ...
     */
    width_of_compress_id =
        1 + dnx_algo_l3_compress_field_max_size_get(unit, DBAL_TABLE_MAC_ADDRESS_COMPRESSION_DB,
                                                    DBAL_FIELD_COMPRESSED_MAC_ID);
    SHR_IF_ERR_EXIT(algo_l3_db.mac_compress_id_alloc.mac_compress_id_bitmap.alloc_bitmap(unit, width_of_compress_id));
     ...
     */
    width_of_compress_id =
        1 + dnx_algo_l3_compress_field_max_size_get(unit, DBAL_TABLE_IPV6_32MSBS_COMPRESSION,
    ...
    void *tag_info)
{
    ...
    if (((resource_tag_bitmap_tag_info_t *) tag_info)->tags[0] != DBAL_ENUM_FVAL_HIERARCHY_LEVEL_NO_HIERARCHY)
    {
        SHR_IF_ERR_EXIT(resource_tag_bitmap_nof_used_elements_in_grain_get
                        (unit, node_id, res_tag_bitmap, grain_indx, &nof_elements_per_grain));
    }
    ...
    uint32 alloc_flags)
{
    ...
    sal_memset(&extra_create_info, 0, sizeof(extra_create_info));
    extra_create_info.grain_size[0] = grain_size;
    extra_create_info.max_tag_value[0] = dnx_data_mdb.direct.nof_fec_ecmp_hierarchies_get(unit);
