...
dnx_ingress_reassembly_db_alloc_dump(int  unit,  int  alloc_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_INGRESS_REASSEMBLY_DB__ALLOC, ((dnx_ingress_reassembly_db_t*)sw_state_roots_array[unit][DNX_INGRESS_REASSEMBLY_MODULE_ID])->alloc))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_INGRESS_REASSEMBLY_DB__ALLOC, ((dnx_ingress_reassembly_db_t*)sw_state_roots_array[unit][DNX_INGRESS_REASSEMBLY_MODULE_ID])->alloc) == 0)
        {
            SHR_EXIT();
        }
...
dnx_ingress_reassembly_db_mapped_ports_dump(int  unit,  int  mapped_ports_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_INGRESS_REASSEMBLY_DB__MAPPED_PORTS, ((dnx_ingress_reassembly_db_t*)sw_state_roots_array[unit][DNX_INGRESS_REASSEMBLY_MODULE_ID])->mapped_ports))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_INGRESS_REASSEMBLY_DB__MAPPED_PORTS, ((dnx_ingress_reassembly_db_t*)sw_state_roots_array[unit][DNX_INGRESS_REASSEMBLY_MODULE_ID])->mapped_ports) == 0)
        {
            SHR_EXIT();
        }
