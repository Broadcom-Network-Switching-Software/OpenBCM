...
dnx_mirror_db_snif_egress_vlan_profiles_mirror_dump(int  unit,  int  snif_egress_vlan_profiles_mirror_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_MIRROR_DB__SNIF_EGRESS_VLAN_PROFILES_MIRROR, ((dnx_mirror_db_t*)sw_state_roots_array[unit][DNX_MIRROR_MODULE_ID])->snif_egress_vlan_profiles_mirror))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_MIRROR_DB__SNIF_EGRESS_VLAN_PROFILES_MIRROR, ((dnx_mirror_db_t*)sw_state_roots_array[unit][DNX_MIRROR_MODULE_ID])->snif_egress_vlan_profiles_mirror) == 0)
        {
            SHR_EXIT();
        }
...
dnx_mirror_db_snif_ingress_vlan_profiles_mirror_dump(int  unit,  int  snif_ingress_vlan_profiles_mirror_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_MIRROR_DB__SNIF_INGRESS_VLAN_PROFILES_MIRROR, ((dnx_mirror_db_t*)sw_state_roots_array[unit][DNX_MIRROR_MODULE_ID])->snif_ingress_vlan_profiles_mirror))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_MIRROR_DB__SNIF_INGRESS_VLAN_PROFILES_MIRROR, ((dnx_mirror_db_t*)sw_state_roots_array[unit][DNX_MIRROR_MODULE_ID])->snif_ingress_vlan_profiles_mirror) == 0)
        {
            SHR_EXIT();
        }
...
dnx_mirror_db_mirror_on_drop_profile_dump(int  unit,  int  mirror_on_drop_profile_idx_0,  int  mirror_on_drop_profile_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_MIRROR_DB__MIRROR_ON_DROP_PROFILE, ((dnx_mirror_db_t*)sw_state_roots_array[unit][DNX_MIRROR_MODULE_ID])->mirror_on_drop_profile[i0]))
            {
                LOG_CLI((BSL_META("dnx_mirror_db[]->((dnx_mirror_db_t*)sw_state_roots_array[][DNX_MIRROR_MODULE_ID])->mirror_on_drop_profile[][]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_MIRROR_DB__MIRROR_ON_DROP_PROFILE, ((dnx_mirror_db_t*)sw_state_roots_array[unit][DNX_MIRROR_MODULE_ID])->mirror_on_drop_profile[i0]) == 0)
            {
                SHR_EXIT();
            }
