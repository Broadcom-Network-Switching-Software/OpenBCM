...
dnx_crps_db_proc_used_for_meter_dump(int  unit,  int  proc_idx_0,  int  proc_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__USED_FOR_METER, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__USED_FOR_METER, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__USED_FOR_METER, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->proc[][].used_for_meter: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__USED_FOR_METER, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_crps_db_proc_config_started_dump(int  unit,  int  proc_idx_0,  int  proc_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__CONFIG_STARTED, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__CONFIG_STARTED, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__CONFIG_STARTED, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->proc[][].config_started: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__CONFIG_STARTED, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_crps_db_proc_config_done_dump(int  unit,  int  proc_idx_0,  int  proc_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__CONFIG_DONE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__CONFIG_DONE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__CONFIG_DONE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->proc[][].config_done: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__CONFIG_DONE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_crps_db_proc_enablers_counting_enable_dump(int  unit,  int  proc_idx_0,  int  proc_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__ENABLERS__COUNTING_ENABLE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__ENABLERS__COUNTING_ENABLE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__ENABLERS__COUNTING_ENABLE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->proc[][].enablers.counting_enable: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__ENABLERS__COUNTING_ENABLE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_crps_db_proc_enablers_eviction_enable_dump(int  unit,  int  proc_idx_0,  int  proc_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__ENABLERS__EVICTION_ENABLE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__ENABLERS__EVICTION_ENABLE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__ENABLERS__EVICTION_ENABLE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->proc[][].enablers.eviction_enable: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__ENABLERS__EVICTION_ENABLE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_crps_db_proc_interface_next_engine_id_dump(int  unit,  int  proc_idx_0,  int  proc_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__NEXT_ENGINE_ID, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__NEXT_ENGINE_ID, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__NEXT_ENGINE_ID, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->proc[][].interface.next_engine_id: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__NEXT_ENGINE_ID, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_crps_db_proc_interface_prev_engine_id_dump(int  unit,  int  proc_idx_0,  int  proc_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__PREV_ENGINE_ID, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__PREV_ENGINE_ID, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__PREV_ENGINE_ID, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->proc[][].interface.prev_engine_id: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__PREV_ENGINE_ID, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_crps_db_proc_interface_database_id_dump(int  unit,  int  proc_idx_0,  int  proc_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__DATABASE_ID, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__DATABASE_ID, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__DATABASE_ID, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->proc[][].interface.database_id: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__DATABASE_ID, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_crps_db_proc_interface_src_type_dump(int  unit,  int  proc_idx_0,  int  proc_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__SRC_TYPE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__SRC_TYPE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__SRC_TYPE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->proc[][].interface.src_type: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__SRC_TYPE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_crps_db_proc_interface_command_id_dump(int  unit,  int  proc_idx_0,  int  proc_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__COMMAND_ID, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__COMMAND_ID, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__COMMAND_ID, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->proc[][].interface.command_id: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__COMMAND_ID, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_crps_db_proc_interface_format_dump(int  unit,  int  proc_idx_0,  int  proc_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__FORMAT, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__FORMAT, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__FORMAT, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->proc[][].interface.format: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__FORMAT, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]) == 0)
            {
                SHR_EXIT();
            }
...
/*
 *
 * dump function for the variable counter_size
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
dnx_crps_db_proc_interface_counter_size_dump(int  unit,  int  proc_idx_0,  int  proc_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = proc_idx_0, I0 = proc_idx_0 + 1;
    int i1 = proc_idx_1, I1 = proc_idx_1 + 1, org_i1 = proc_idx_1;
    char *s0 = "", *s1 = "";
    ...
    if (dnx_sw_state_compare(filters.namefilter, "crps proc interface counter_size") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate crps proc interface counter_size\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_crps_db/proc/interface/counter_size.txt",
            "dnx_crps_db[%d]->","((dnx_crps_db_t*)sw_state_roots_array[%d][CRPS_MODULE_ID])->","proc[][].interface.counter_size: ");
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__COUNTER_SIZE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc))
        {
            LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->proc[][].interface.counter_size: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__COUNTER_SIZE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__COUNTER_SIZE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->proc[][].interface.counter_size: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__COUNTER_SIZE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]) == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                DNX_SW_STATE_PRINT_MONITOR(
                    unit,
                    "dnx_crps_db[%d]->","((dnx_crps_db_t*)sw_state_roots_array[%d][CRPS_MODULE_ID])->","proc[%s%d][%s%d].interface.counter_size: ", s0, i0, s1, i1);
                ...
                dnx_sw_state_print_int(
                    unit,
                    &((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0][i1].interface.counter_size);
 ...
 */
int
dnx_crps_db_proc_interface_mode_dump(int  unit,  int  proc_idx_0,  int  proc_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = proc_idx_0, I0 = proc_idx_0 + 1;
    int i1 = proc_idx_1, I1 = proc_idx_1 + 1, org_i1 = proc_idx_1;
    char *s0 = "", *s1 = "";
    ...
    if (dnx_sw_state_compare(filters.typefilter, "bcm_stat_counter_mode_t") != TRUE)
    {
         SHR_EXIT();
    }

    if (dnx_sw_state_compare(filters.namefilter, "crps proc interface mode") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate crps proc interface mode\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_crps_db/proc/interface/mode.txt",
            "dnx_crps_db[%d]->","((dnx_crps_db_t*)sw_state_roots_array[%d][CRPS_MODULE_ID])->","proc[][].interface.mode: ");
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__MODE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc))
        {
            LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->proc[][].interface.mode: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__MODE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__MODE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->proc[][].interface.mode: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__MODE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]) == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                DNX_SW_STATE_PRINT_OPAQUE_MONITOR(
                    unit,
                    ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0][i1].interface.mode,
                    "dnx_crps_db[%d]->","((dnx_crps_db_t*)sw_state_roots_array[%d][CRPS_MODULE_ID])->","proc[%s%d][%s%d].interface.mode: ", s0, i0, s1, i1);
...
dnx_crps_db_proc_interface_counter_set_size_dump(int  unit,  int  proc_idx_0,  int  proc_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__COUNTER_SET_SIZE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__COUNTER_SET_SIZE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__COUNTER_SET_SIZE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->proc[][].interface.counter_set_size: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__COUNTER_SET_SIZE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_crps_db_proc_interface_type_hw_valid_dump(int  unit,  int  proc_idx_0,  int  proc_idx_1,  int  type_hw_valid_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__TYPE_HW_VALID, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__TYPE_HW_VALID, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__TYPE_HW_VALID, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->proc[][].interface.type_hw_valid[]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__INTERFACE__TYPE_HW_VALID, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_crps_db_proc_eviction_eviction_type_dump(int  unit,  int  proc_idx_0,  int  proc_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__EVICTION_TYPE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__EVICTION_TYPE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__EVICTION_TYPE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->proc[][].eviction.eviction_type: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__EVICTION_TYPE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_crps_db_proc_eviction_record_format_dump(int  unit,  int  proc_idx_0,  int  proc_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__RECORD_FORMAT, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__RECORD_FORMAT, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__RECORD_FORMAT, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->proc[][].eviction.record_format: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__RECORD_FORMAT, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_crps_db_proc_eviction_eviction_event_id_dump(int  unit,  int  proc_idx_0,  int  proc_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__EVICTION_EVENT_ID, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__EVICTION_EVENT_ID, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__EVICTION_EVENT_ID, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->proc[][].eviction.eviction_event_id: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__EVICTION_EVENT_ID, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_crps_db_proc_eviction_sequential_timer_value_dump(int  unit,  int  proc_idx_0,  int  proc_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__SEQUENTIAL_TIMER_VALUE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__SEQUENTIAL_TIMER_VALUE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__SEQUENTIAL_TIMER_VALUE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->proc[][].eviction.sequential_timer_value: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__SEQUENTIAL_TIMER_VALUE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_crps_db_proc_eviction_dma_fifo_dump(int  unit,  int  proc_idx_0,  int  proc_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__DMA_FIFO, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__DMA_FIFO, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__DMA_FIFO, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->proc[][].eviction.dma_fifo: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__DMA_FIFO, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_crps_db_proc_eviction_eviction_algorithmic_disable_dump(int  unit,  int  proc_idx_0,  int  proc_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__EVICTION_ALGORITHMIC_DISABLE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__EVICTION_ALGORITHMIC_DISABLE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__EVICTION_ALGORITHMIC_DISABLE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->proc[][].eviction.eviction_algorithmic_disable: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__EVICTION_ALGORITHMIC_DISABLE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_crps_db_proc_eviction_conditional_condition_user_data_dump(int  unit,  int  proc_idx_0,  int  proc_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__CONDITIONAL__CONDITION_USER_DATA, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__CONDITIONAL__CONDITION_USER_DATA, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__CONDITIONAL__CONDITION_USER_DATA, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->proc[][].eviction.conditional.condition_user_data: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__CONDITIONAL__CONDITION_USER_DATA, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_crps_db_proc_eviction_conditional_action_flags_dump(int  unit,  int  proc_idx_0,  int  proc_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__CONDITIONAL__ACTION_FLAGS, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__CONDITIONAL__ACTION_FLAGS, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__CONDITIONAL__ACTION_FLAGS, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->proc[][].eviction.conditional.action_flags: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__CONDITIONAL__ACTION_FLAGS, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_crps_db_proc_eviction_conditional_enable_dump(int  unit,  int  proc_idx_0,  int  proc_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__CONDITIONAL__ENABLE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__CONDITIONAL__ENABLE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__CONDITIONAL__ENABLE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->proc[][].eviction.conditional.enable: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__CONDITIONAL__ENABLE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_crps_db_proc_eviction_conditional_condition_source_select_dump(int  unit,  int  proc_idx_0,  int  proc_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__CONDITIONAL__CONDITION_SOURCE_SELECT, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__CONDITIONAL__CONDITION_SOURCE_SELECT, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__CONDITIONAL__CONDITION_SOURCE_SELECT, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->proc[][].eviction.conditional.condition_source_select: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__CONDITIONAL__CONDITION_SOURCE_SELECT, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_crps_db_proc_eviction_conditional_qualifier_dump(int  unit,  int  proc_idx_0,  int  proc_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__CONDITIONAL__QUALIFIER, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__CONDITIONAL__QUALIFIER, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__CONDITIONAL__QUALIFIER, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->proc[][].eviction.conditional.qualifier: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__EVICTION__CONDITIONAL__QUALIFIER, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_crps_db_proc_log_obj_id_range_logical_object_id_first_dump(int  unit,  int  proc_idx_0,  int  proc_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__LOG_OBJ_ID_RANGE__LOGICAL_OBJECT_ID_FIRST, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__LOG_OBJ_ID_RANGE__LOGICAL_OBJECT_ID_FIRST, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__LOG_OBJ_ID_RANGE__LOGICAL_OBJECT_ID_FIRST, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->proc[][].log_obj_id_range.logical_object_id_first: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__LOG_OBJ_ID_RANGE__LOGICAL_OBJECT_ID_FIRST, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_crps_db_proc_log_obj_id_range_logical_object_id_last_dump(int  unit,  int  proc_idx_0,  int  proc_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__LOG_OBJ_ID_RANGE__LOGICAL_OBJECT_ID_LAST, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__LOG_OBJ_ID_RANGE__LOGICAL_OBJECT_ID_LAST, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__LOG_OBJ_ID_RANGE__LOGICAL_OBJECT_ID_LAST, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->proc[][].log_obj_id_range.logical_object_id_last: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__PROC__LOG_OBJ_ID_RANGE__LOGICAL_OBJECT_ID_LAST, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->proc[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_crps_db_database_dump(int  unit,  int  database_idx_0,  int  database_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    SHR_IF_ERR_EXIT(dnx_crps_db_database_set_dump(unit, database_idx_0,database_idx_1, -1, filters));
    DNXC_SW_STATE_FUNC_RETURN;
}
...
dnx_crps_db_database_base_engine_dump(int  unit,  int  database_idx_0,  int  database_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE__BASE_ENGINE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE__BASE_ENGINE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE__BASE_ENGINE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->database[][].base_engine: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE__BASE_ENGINE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_crps_db_database_type_valid_dump(int  unit,  int  database_idx_0,  int  database_idx_1,  int  type_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE__TYPE__VALID, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE__TYPE__VALID, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE__TYPE__VALID, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->database[][].type[].valid: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE__TYPE__VALID, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_crps_db_database_type_offset_dump(int  unit,  int  database_idx_0,  int  database_idx_1,  int  type_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE__TYPE__OFFSET, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE__TYPE__OFFSET, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE__TYPE__OFFSET, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->database[][].type[].offset: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE__TYPE__OFFSET, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_crps_db_database_type_start_dump(int  unit,  int  database_idx_0,  int  database_idx_1,  int  type_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE__TYPE__START, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE__TYPE__START, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE__TYPE__START, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->database[][].type[].start: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE__TYPE__START, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database[i0]) == 0)
            {
                SHR_EXIT();
            }
...
dnx_crps_db_database_type_end_dump(int  unit,  int  database_idx_0,  int  database_idx_1,  int  type_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE__TYPE__END, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE__TYPE__END, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE__TYPE__END, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->database[][].type[].end: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE__TYPE__END, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database[i0]) == 0)
            {
                SHR_EXIT();
            }
...
/*
 *
 * dump function for the variable set
 * AUTO-GENERATED - DO NOT MODIFY
 *
 */
int
dnx_crps_db_database_set_dump(int  unit,  int  database_idx_0,  int  database_idx_1,  int  set_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    DNXC_SW_STATE_INIT_FUNC_DEFS;
 ...
 */
int
dnx_crps_db_database_set_size_dump(int  unit,  int  database_idx_0,  int  database_idx_1,  int  set_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = database_idx_0, I0 = database_idx_0 + 1;
    int i1 = database_idx_1, I1 = database_idx_1 + 1, org_i1 = database_idx_1;
    int i2 = set_idx_0, I2 = set_idx_0 + 1, org_i2 = set_idx_0;
    char *s0 = "", *s1 = "", *s2 = "";
    DNXC_SW_STATE_INIT_FUNC_DEFS;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "crps database set size") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate crps database set size\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_crps_db/database/set/size.txt",
            "dnx_crps_db[%d]->","((dnx_crps_db_t*)sw_state_roots_array[%d][CRPS_MODULE_ID])->","database[][].set[].size: ");
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE__SET__SIZE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database))
        {
            LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->database[][].set[].size: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE__SET__SIZE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE__SET__SIZE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->database[][].set[].size: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE__SET__SIZE, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database[i0]) == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                if (i2 == -1) {
                    I2 = BCM_STAT_MAX_NUMBER_OF_COUNTER_SETS_PER_DB;
                    i2 = dnx_sw_state_dump_check_all_the_same(unit,
                        ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database[i0][i1].set
                        , sizeof(*((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database[i0][i1].set), I2, &s2) ? I2 - 1 : 0;
                }

                if(i2 >= BCM_STAT_MAX_NUMBER_OF_COUNTER_SETS_PER_DB)
                {
                    LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->database[][].set[].size: ")));
                    LOG_CLI((BSL_META("Invalid index: %d \n"),i2));
                    SHR_EXIT();
                ...
                if(BCM_STAT_MAX_NUMBER_OF_COUNTER_SETS_PER_DB == 0)
                {
                    SHR_EXIT();
                }
                ...
                for(; i2 < I2; i2++) {
                    ...
                    DNX_SW_STATE_PRINT_MONITOR(
                        unit,
                        "dnx_crps_db[%d]->","((dnx_crps_db_t*)sw_state_roots_array[%d][CRPS_MODULE_ID])->","database[%s%d][%s%d].set[%s%d].size: ", s0, i0, s1, i1, s2, i2);
                    ...
                    dnx_sw_state_print_int(
                        unit,
                        &((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database[i0][i1].set[i2].size);
 ...
 */
int
dnx_crps_db_database_set_start_dump(int  unit,  int  database_idx_0,  int  database_idx_1,  int  set_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = database_idx_0, I0 = database_idx_0 + 1;
    int i1 = database_idx_1, I1 = database_idx_1 + 1, org_i1 = database_idx_1;
    int i2 = set_idx_0, I2 = set_idx_0 + 1, org_i2 = set_idx_0;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "crps database set start") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate crps database set start\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_crps_db/database/set/start.txt",
            "dnx_crps_db[%d]->","((dnx_crps_db_t*)sw_state_roots_array[%d][CRPS_MODULE_ID])->","database[][].set[].start: ");
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE__SET__START, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database))
        {
            LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->database[][].set[].start: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE__SET__START, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE__SET__START, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->database[][].set[].start: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE__SET__START, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database[i0]) == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                for(; i2 < I2; i2++) {
                    ...
                    DNX_SW_STATE_PRINT_MONITOR(
                        unit,
                        "dnx_crps_db[%d]->","((dnx_crps_db_t*)sw_state_roots_array[%d][CRPS_MODULE_ID])->","database[%s%d][%s%d].set[%s%d].start: ", s0, i0, s1, i1, s2, i2);
                    ...
                    dnx_sw_state_print_uint32(
                        unit,
                        &((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database[i0][i1].set[i2].start);
 ...
 */
int
dnx_crps_db_database_set_end_dump(int  unit,  int  database_idx_0,  int  database_idx_1,  int  set_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    int i0 = database_idx_0, I0 = database_idx_0 + 1;
    int i1 = database_idx_1, I1 = database_idx_1 + 1, org_i1 = database_idx_1;
    int i2 = set_idx_0, I2 = set_idx_0 + 1, org_i2 = set_idx_0;
    ...
    if (dnx_sw_state_compare(filters.namefilter, "crps database set end") != TRUE)
    {
         SHR_EXIT();
    }
    ...
    if (filters.nocontent)
    {
         DNX_SW_STATE_PRINT(unit, "swstate crps database set end\n");
    }
    else
    {
        dnx_sw_state_dump_attach_file(
            unit,
            "dnx_crps_db/database/set/end.txt",
            "dnx_crps_db[%d]->","((dnx_crps_db_t*)sw_state_roots_array[%d][CRPS_MODULE_ID])->","database[][].set[].end: ");
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE__SET__END, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database))
        {
            LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->database[][].set[].end: ")));
            LOG_CLI((BSL_META("Invalid index: %d \n"),i0));
            SHR_EXIT();
        }

        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE__SET__END, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE__SET__END, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database[i0]))
            {
                LOG_CLI((BSL_META("dnx_crps_db[]->((dnx_crps_db_t*)sw_state_roots_array[][CRPS_MODULE_ID])->database[][].set[].end: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE__SET__END, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database[i0]) == 0)
            {
                SHR_EXIT();
            }
            ...
            for(; i1 < I1; i1++) {
                ...
                for(; i2 < I2; i2++) {
                    ...
                    DNX_SW_STATE_PRINT_MONITOR(
                        unit,
                        "dnx_crps_db[%d]->","((dnx_crps_db_t*)sw_state_roots_array[%d][CRPS_MODULE_ID])->","database[%s%d][%s%d].set[%s%d].end: ", s0, i0, s1, i1, s2, i2);
                    ...
                    dnx_sw_state_print_uint32(
                        unit,
                        &((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database[i0][i1].set[i2].end);
...
dnx_crps_db_database_res_dump(int  unit,  int  database_res_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE_RES, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database_res))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_CRPS_DB__DATABASE_RES, ((dnx_crps_db_t*)sw_state_roots_array[unit][CRPS_MODULE_ID])->database_res) == 0)
        {
            SHR_EXIT();
        }
...
const char* dnx_crps_db_layout_str[DNX_CRPS_DB_INFO_NOF_ENTRIES] = {
    ...
    "DNX_CRPS_DB~PROC~INTERFACE~COUNTER_SIZE~",
    "DNX_CRPS_DB~PROC~INTERFACE~MODE~",
    ...
    "DNX_CRPS_DB~DATABASE~SET~",
    "DNX_CRPS_DB~DATABASE~SET~SIZE~",
    "DNX_CRPS_DB~DATABASE~SET~START~",
    "DNX_CRPS_DB~DATABASE~SET~END~",
