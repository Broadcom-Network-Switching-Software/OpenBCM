...
dnx_egq_am_db_egr_tc_dp_mapping_dump(int  unit,  int  egr_tc_dp_mapping_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_EGQ_AM_DB__EGR_TC_DP_MAPPING, ((dnx_egq_am_db_t*)sw_state_roots_array[unit][DNX_EGQ_AM_MODULE_ID])->egr_tc_dp_mapping))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_EGQ_AM_DB__EGR_TC_DP_MAPPING, ((dnx_egq_am_db_t*)sw_state_roots_array[unit][DNX_EGQ_AM_MODULE_ID])->egr_tc_dp_mapping) == 0)
        {
            SHR_EXIT();
        }
...
dnx_egq_am_db_fqp_profile_dump(int  unit,  int  fqp_profile_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_EGQ_AM_DB__FQP_PROFILE, ((dnx_egq_am_db_t*)sw_state_roots_array[unit][DNX_EGQ_AM_MODULE_ID])->fqp_profile))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_DNX_EGQ_AM_DB__FQP_PROFILE, ((dnx_egq_am_db_t*)sw_state_roots_array[unit][DNX_EGQ_AM_MODULE_ID])->fqp_profile) == 0)
        {
            SHR_EXIT();
        }
