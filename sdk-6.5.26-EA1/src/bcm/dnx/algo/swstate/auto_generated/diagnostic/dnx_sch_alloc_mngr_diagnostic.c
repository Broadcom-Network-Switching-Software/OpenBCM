...
sch_alloc_db_sch_flow_alloc_mngr_dump(int  unit,  int  sch_flow_alloc_mngr_idx_0,  int  sch_flow_alloc_mngr_idx_1,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_SCH_ALLOC_DB__SCH_FLOW_ALLOC_MNGR, ((dnx_sch_alloc_db_t*)sw_state_roots_array[unit][DNX_SCH_ALLOC_MNGR_MODULE_ID])->sch_flow_alloc_mngr))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_SCH_ALLOC_DB__SCH_FLOW_ALLOC_MNGR, ((dnx_sch_alloc_db_t*)sw_state_roots_array[unit][DNX_SCH_ALLOC_MNGR_MODULE_ID])->sch_flow_alloc_mngr) == 0)
        {
            SHR_EXIT();
        }
        ...
        for(; i0 < I0; i0++) {
            ...
            if(i1 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_SCH_ALLOC_DB__SCH_FLOW_ALLOC_MNGR, ((dnx_sch_alloc_db_t*)sw_state_roots_array[unit][DNX_SCH_ALLOC_MNGR_MODULE_ID])->sch_flow_alloc_mngr[i0]))
            {
                LOG_CLI((BSL_META("sch_alloc_db[]->((dnx_sch_alloc_db_t*)sw_state_roots_array[][DNX_SCH_ALLOC_MNGR_MODULE_ID])->sch_flow_alloc_mngr[][]: ")));
                LOG_CLI((BSL_META("Invalid index: %d \n"),i1));
                SHR_EXIT();
            ...
            if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_SCH_ALLOC_DB__SCH_FLOW_ALLOC_MNGR, ((dnx_sch_alloc_db_t*)sw_state_roots_array[unit][DNX_SCH_ALLOC_MNGR_MODULE_ID])->sch_flow_alloc_mngr[i0]) == 0)
            {
                SHR_EXIT();
            }
...
sch_alloc_db_interface_dump(int  unit,  int  interface_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_SCH_ALLOC_DB__INTERFACE, ((dnx_sch_alloc_db_t*)sw_state_roots_array[unit][DNX_SCH_ALLOC_MNGR_MODULE_ID])->interface))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_SCH_ALLOC_DB__INTERFACE, ((dnx_sch_alloc_db_t*)sw_state_roots_array[unit][DNX_SCH_ALLOC_MNGR_MODULE_ID])->interface) == 0)
        {
            SHR_EXIT();
        }
...
sch_alloc_db_cl_class_alloc_mngr_dump(int  unit,  int  cl_class_alloc_mngr_idx_0,  dnx_sw_state_dump_filters_t  filters)
{
    ...
    else
    {
        ...
        if(i0 >= dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_SCH_ALLOC_DB__CL_CLASS_ALLOC_MNGR, ((dnx_sch_alloc_db_t*)sw_state_roots_array[unit][DNX_SCH_ALLOC_MNGR_MODULE_ID])->cl_class_alloc_mngr))
        {
        ...
        if(dnx_sw_state_get_nof_elements(unit, DNX_SW_STATE_SCH_ALLOC_DB__CL_CLASS_ALLOC_MNGR, ((dnx_sch_alloc_db_t*)sw_state_roots_array[unit][DNX_SCH_ALLOC_MNGR_MODULE_ID])->cl_class_alloc_mngr) == 0)
        {
            SHR_EXIT();
        }
