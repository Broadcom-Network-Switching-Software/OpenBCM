...
ingress_compensation_init_layout_structure(int unit)
{
    ...
    layout_array_ingress_compensation[idx].first_child_index = 1;
    layout_array_ingress_compensation[idx].last_child_index = 1;
    layout_array_ingress_compensation[idx].next_node_index = 1;
    ...
    layout_array_ingress_compensation[idx].array_indexes[0].size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_ingress_compensation[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
