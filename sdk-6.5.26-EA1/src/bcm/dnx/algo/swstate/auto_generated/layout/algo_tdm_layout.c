...
algo_tdm_init_layout_structure(int unit)
{
    ...
    layout_array_algo_tdm[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_algo_tdm[idx].first_child_index = 1;
    layout_array_algo_tdm[idx].last_child_index = 2;
    layout_array_algo_tdm[idx].next_node_index = 1;
    ...
    layout_array_algo_tdm[idx].next_node_index = 2;
    ...
    layout_array_algo_tdm[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_tdm[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_algo_tdm[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
