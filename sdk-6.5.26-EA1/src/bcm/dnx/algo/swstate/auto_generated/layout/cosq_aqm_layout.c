...
cosq_aqm_init_layout_structure(int unit)
{
    ...
    layout_array_cosq_aqm[idx].first_child_index = 1;
    layout_array_cosq_aqm[idx].last_child_index = 2;
    layout_array_cosq_aqm[idx].next_node_index = 1;
    ...
    layout_array_cosq_aqm[idx].next_node_index = 2;
    ...
    layout_array_cosq_aqm[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_cosq_aqm[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_cosq_aqm[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
