...
cosq_latency_init_layout_structure(int unit)
{
    ...
    layout_array_cosq_latency[idx].first_child_index = 1;
    layout_array_cosq_latency[idx].last_child_index = 4;
    layout_array_cosq_latency[idx].next_node_index = 1;
    ...
    layout_array_cosq_latency[idx].next_node_index = 2;
    ...
    layout_array_cosq_latency[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_cosq_latency[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_cosq_latency[idx].next_node_index = 3;
    ...
    layout_array_cosq_latency[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_cosq_latency[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_cosq_latency[idx].next_node_index = 4;
    ...
    layout_array_cosq_latency[idx].parent  = 0;
    layout_array_cosq_latency[idx].first_child_index = 5;
    layout_array_cosq_latency[idx].last_child_index = 6;
    layout_array_cosq_latency[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_cosq_latency[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_cosq_latency[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_cosq_latency[idx].next_node_index = 6;
