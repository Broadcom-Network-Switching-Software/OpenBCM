...
dnx_algo_flexe_core_init_layout_structure(int unit)
{
    ...
    layout_array_dnx_algo_flexe_core[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    ...
    layout_array_dnx_algo_flexe_core[idx].first_child_index = 1;
    layout_array_dnx_algo_flexe_core[idx].last_child_index = 7;
    layout_array_dnx_algo_flexe_core[idx].next_node_index = 1;
    ...
    layout_array_dnx_algo_flexe_core[idx].next_node_index = 2;
    ...
    layout_array_dnx_algo_flexe_core[idx].parent  = 0;
    layout_array_dnx_algo_flexe_core[idx].first_child_index = 8;
    layout_array_dnx_algo_flexe_core[idx].last_child_index = 14;
    layout_array_dnx_algo_flexe_core[idx].next_node_index = 3;
    ...
    layout_array_dnx_algo_flexe_core[idx].array_indexes[0].size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    layout_array_dnx_algo_flexe_core[idx].parent  = 0;
    layout_array_dnx_algo_flexe_core[idx].first_child_index = 15;
    layout_array_dnx_algo_flexe_core[idx].last_child_index = 17;
    layout_array_dnx_algo_flexe_core[idx].next_node_index = 4;
    ...
    layout_array_dnx_algo_flexe_core[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    layout_array_dnx_algo_flexe_core[idx].parent  = 0;
    layout_array_dnx_algo_flexe_core[idx].first_child_index = 18;
    layout_array_dnx_algo_flexe_core[idx].last_child_index = 27;
    layout_array_dnx_algo_flexe_core[idx].next_node_index = 5;
    ...
    layout_array_dnx_algo_flexe_core[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    layout_array_dnx_algo_flexe_core[idx].parent  = 0;
    layout_array_dnx_algo_flexe_core[idx].first_child_index = 28;
    layout_array_dnx_algo_flexe_core[idx].last_child_index = 28;
    layout_array_dnx_algo_flexe_core[idx].next_node_index = 6;
    ...
    layout_array_dnx_algo_flexe_core[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    layout_array_dnx_algo_flexe_core[idx].parent  = 0;
    layout_array_dnx_algo_flexe_core[idx].first_child_index = 29;
    layout_array_dnx_algo_flexe_core[idx].last_child_index = 32;
    layout_array_dnx_algo_flexe_core[idx].next_node_index = 7;
    layout_array_dnx_algo_flexe_core[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
    ...
    layout_array_dnx_algo_flexe_core[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_DYNAMIC_DNX_DATA;
    layout_array_dnx_algo_flexe_core[idx].parent  = 0;
    layout_array_dnx_algo_flexe_core[idx].first_child_index = 33;
    layout_array_dnx_algo_flexe_core[idx].last_child_index = 35;
    layout_array_dnx_algo_flexe_core[idx].next_node_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_FORCE_INTERFACE_GENERATION;
    ...
    layout_array_dnx_algo_flexe_core[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].next_node_index = 9;
    ...
    layout_array_dnx_algo_flexe_core[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].next_node_index = 10;
    ...
    layout_array_dnx_algo_flexe_core[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].next_node_index = 11;
    ...
    layout_array_dnx_algo_flexe_core[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].next_node_index = 12;
    ...
    layout_array_dnx_algo_flexe_core[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].next_node_index = 13;
    ...
    layout_array_dnx_algo_flexe_core[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].next_node_index = 14;
    ...
    layout_array_dnx_algo_flexe_core[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].next_node_index = 16;
    ...
    layout_array_dnx_algo_flexe_core[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].next_node_index = 17;
    layout_array_dnx_algo_flexe_core[idx].labels = DNXC_SW_STATE_LAYOUT_LABEL_EXPANDED_INTERFACE;
    ...
    layout_array_dnx_algo_flexe_core[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].next_node_index = 19;
    ...
    layout_array_dnx_algo_flexe_core[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].next_node_index = 20;
    ...
    layout_array_dnx_algo_flexe_core[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].next_node_index = 21;
    ...
    layout_array_dnx_algo_flexe_core[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].next_node_index = 22;
    ...
    layout_array_dnx_algo_flexe_core[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].next_node_index = 23;
    ...
    layout_array_dnx_algo_flexe_core[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].next_node_index = 24;
    ...
    layout_array_dnx_algo_flexe_core[idx].array_indexes[0].size = ((DNX_DATA_MAX_NIF_FLEXE_NOF_FLEXE_LPHYS)/SHR_BITWID)+1;
    layout_array_dnx_algo_flexe_core[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_BITMAP;
    layout_array_dnx_algo_flexe_core[idx].parent  = 4;
    layout_array_dnx_algo_flexe_core[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].next_node_index = 25;
    ...
    layout_array_dnx_algo_flexe_core[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].next_node_index = 26;
    ...
    layout_array_dnx_algo_flexe_core[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].next_node_index = 27;
    ...
    layout_array_dnx_algo_flexe_core[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].size_of = sizeof(SHR_BITDCL);
    layout_array_dnx_algo_flexe_core[idx].array_indexes[0].size = ((DNX_DATA_MAX_NIF_MAC_CLIENT_NOF_MAC_TIMESLOTS)/SHR_BITWID)+1;
    layout_array_dnx_algo_flexe_core[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_BITMAP;
    ...
    layout_array_dnx_algo_flexe_core[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].size_of = sizeof(SHR_BITDCL);
    layout_array_dnx_algo_flexe_core[idx].array_indexes[0].size = ((DNX_DATA_MAX_NIF_SAR_CLIENT_NOF_SAR_TIMESLOTS)/SHR_BITWID)+1;
    layout_array_dnx_algo_flexe_core[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_BITMAP;
    layout_array_dnx_algo_flexe_core[idx].parent  = 6;
    layout_array_dnx_algo_flexe_core[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].next_node_index = 30;
    ...
    layout_array_dnx_algo_flexe_core[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].next_node_index = 31;
    ...
    layout_array_dnx_algo_flexe_core[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].next_node_index = 32;
    ...
    layout_array_dnx_algo_flexe_core[idx].total_size = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].size_of = sizeof(SHR_BITDCL);
    layout_array_dnx_algo_flexe_core[idx].array_indexes[0].size = ((DNX_DATA_MAX_NIF_FLEXE_MAX_NOF_SLOTS)/SHR_BITWID)+1;
    layout_array_dnx_algo_flexe_core[idx].array_indexes[0].index_type = DNXC_SWSTATE_ARRAY_INDEX_BITMAP;
    layout_array_dnx_algo_flexe_core[idx].parent  = 7;
    layout_array_dnx_algo_flexe_core[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].next_node_index = 34;
    ...
    layout_array_dnx_algo_flexe_core[idx].first_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].last_child_index = DNXC_SW_STATE_LAYOUT_INVALID;
    layout_array_dnx_algo_flexe_core[idx].next_node_index = 35;
