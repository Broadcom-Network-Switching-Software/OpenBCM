    ...
    uint8 *first_appear)
{
    ...
    if (with_id)
    {
        ...
        SHR_IF_ERR_EXIT(sw_state_hash_table_entry_add_at_index
                        (unit, node_id, multi_set->hash_table, (MULTI_SET_KEY *) key, found_index, &success));
    }
    else
    {
        /*
        ...
        SHR_IF_ERR_EXIT(sw_state_hash_table_entry_add
                        (unit, node_id, multi_set->hash_table, (MULTI_SET_KEY *) key, NULL, &found_index, &success));
    }
    /*
    ...
    uint32 alloc_flags)
{
    ...
    SHR_IF_ERR_EXIT(sw_state_hash_table_create(unit, node_id, &((*multi_set)->hash_table), &hash_table_init_info, member_size, member_size, TRUE, 0     /* nof_members 
                                                                                                                                                         */ , alloc_flags));
    ...
    void *extra_arguments)
{
    ...
    SHR_IF_ERR_EXIT(sw_state_hash_table_destroy(unit, node_id, &((*multi_set)->hash_table)));
    ...
    uint8 *last_appear)
{
    ...
    *last_appear = (ref_counter == 0) ? TRUE : FALSE;
    ...
    if (*last_appear)
    {
        ...
        SHR_IF_ERR_EXIT(sw_state_hash_table_entry_remove_by_index(unit, node_id, multi_set->hash_table, _data_indx));
    }
exit:
    SHR_FUNC_EXIT;
}
    ...
    int *data_indx)
{
    ...
    SHR_IF_ERR_EXIT(sw_state_hash_table_entry_lookup
                    (unit, node_id, multi_set->hash_table, (MULTI_SET_KEY *) key, NULL, (uint32 *) data_indx, &found));
    ...
    void *key)
{
    ...
    SHR_IF_ERR_EXIT(sw_state_hash_table_get_by_index
                    (unit, node_id, multi_set->hash_table, _data_indx, (MULTI_SET_KEY *) key, &found));
    ...
    multi_set_t multi_set)
{
     ...
     * clear mutli-set.
     */
    SHR_IF_ERR_EXIT(sw_state_hash_table_clear(unit, node_id, multi_set->hash_table));
