    ...
    const void *data)
{
    ...
    SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT8, "PHB", template_data->phb, "PHB propagation type",
                                   NULL);

    SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT8, "REMARK", template_data->remark,
                                   "REMARK propagation type", NULL);

    SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT8, "ECN", template_data->ecn, "ECN propagation type",
                                   NULL);

    SW_STATE_PRETTY_PRINT_ADD_LINE(SW_STATE_PRETTY_PRINT_TYPE_UINT8, "TTL", template_data->ttl, "TTL propagation type",
                                   NULL);
    ...
    int unit)
{
    ...
    SHR_IF_ERR_EXIT(dnx_algo_lif_mngr_nof_inlifs_for_hash_get(unit, &template_data.max_references));
