...
static const additional_headers_map_t additional_headers_map[] = {
    ...
    {ADDITIONAL_HEADERS_GENEVE_UDP, 1, CURRENT_NEXT_PROTOCOL_UDP, 1, (UDP_BYTES_TO_ADD + GENEVE_BYTES_TO_ADD),
     ...
     1, 0, 0, 0, COMPILER_64_INIT(0, GENEVE_PROTOCOL_SPECIFIC_INFORMATION),
     DBAL_FIELD_GENEVE_ADDITIONAL_HEADER_SPECIFIC_INFORMATION,

     1, CURRENT_NEXT_PROTOCOL_GENEVE, 1, GENEVE_BYTES_TO_ADD, COMPILER_64_INIT(0, GENEVE_PROTOCOL_SPECIFIC_INFORMATION),
     DBAL_FIELD_UDP_ADDITIONAL_HEADER_SPECIFIC_INFORMATION,
    ...
    int unit)
{
    ...
    egress_mpls_protocol_header_specific_information_get(2, 0, 0, 0, 1, 0, &ioam_fl_protocol_specific_info);

    egress_mpls_protocol_header_specific_information_get(1, 0, 1, 0, 1, 0, &ioam_fli_protocol_specific_info);
    ...
    for (entry = 0; entry < nof_additional_headers_map_tables_entries; entry++)
    {
        ...
        else if (additional_headers_map[entry].additional_headers_profile == ADDITIONAL_HEADERS_IOAM_FL_FLI)
        {
            protocol_specific_information_header_1 = ioam_fl_protocol_specific_info;
            protocol_specific_information_header_2 = ioam_fli_protocol_specific_info;
        }
...
{
    int nof_ahp_entries;
    dbal_enum_value_field_etpp_additional_header_profile_stack_attributes_e entry;
    COMPILER_UINT64 protocol_specific_information_header_1;
    COMPILER_UINT64 protocol_specific_information_header_2;
    COMPILER_UINT64 ioam_fl_protocol_specific_info;
    COMPILER_UINT64 ioam_fli_protocol_specific_info;
    ...
    egress_mpls_protocol_header_specific_information_get(1, special_label_value, 1, 0, 1, 0,
                                                         &ioam_fli_protocol_specific_info);
    ...
    for (entry = 0; entry < nof_ahp_entries; entry++)
    {
        if (additional_headers_map[entry].additional_headers_profile == ADDITIONAL_HEADERS_IOAM_FL_FLI)
        {
