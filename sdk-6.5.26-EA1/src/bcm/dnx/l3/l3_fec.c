    ...
    bcm_if_t * if_id)
{
    ...
    if (_SHR_IS_FLAG_SET(flags, BCM_L3_WITH_ID))
    {
        ...
        if (_SHR_IS_FLAG_SET(flags, BCM_L3_REPLACE))
        {
            ...
            dnx_l3_fec_decide_super_fec_resource_type(unit, is_protected, is_stat_fec, &super_fec_resource_type);
    ...
    bcm_if_t * if_id)
{
    ...
    dnx_l3_fec_decide_super_fec_resource_type(unit, is_protected, is_stat_fec, &fec_resource_type);
