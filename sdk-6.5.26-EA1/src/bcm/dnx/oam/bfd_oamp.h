...
/**These five bits Client MEP on BFD Server unit, so we can
 *  allocate classification entry on the same id.
 *  Endpoint ID with this bit set is the Client MEP of the BFD
 *  server.
 */
#define BFD_MEP_ID_SERVER_CLIENT_BIT_0 24
#define BFD_MEP_ID_SERVER_CLIENT_BIT_1 25
#define BFD_MEP_ID_SERVER_CLIENT_BIT_2 26
#define BFD_MEP_ID_SERVER_CLIENT_BIT_3 27
#define BFD_MEP_ID_SERVER_CLIENT_BIT_4 28

/* Get server device index from endpoint id */
#define DNX_BFD_CLIENT_MEP_SERVER_DEVICE_GET(endpoint) UTILEX_GET_BITS_RANGE(endpoint, BFD_MEP_ID_SERVER_CLIENT_BIT_4, BFD_MEP_ID_SERVER_CLIENT_BIT_0)

/* Encode server device index into endpoint id */
#define DNX_BFD_CLIENT_MEP_SERVER_DEVICE_SET(index) UTILEX_SET_BITS_RANGE(index, BFD_MEP_ID_SERVER_CLIENT_BIT_4, BFD_MEP_ID_SERVER_CLIENT_BIT_0)
 ...
 *   * None
 */
shr_error_e dnx_bfd_seamless_udp_sport_update(
    int unit,
 ...
 * \see
 */
shr_error_e dnx_bfd_oamp_vccv_channel_type_set(
    int unit);
