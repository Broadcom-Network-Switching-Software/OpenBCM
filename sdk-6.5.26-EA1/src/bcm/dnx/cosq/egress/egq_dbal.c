    ...
    uint32 tdm_exist)
{
    ...
    SHR_IF_ERR_EXIT(dnx_dbal_gen_set(unit, DBAL_TABLE_EGQ_MULTICAST_FIFOS, 1, 11,
                                     ...
                                     (uint32) (dnx_data_egr_queuing.params.emr_fifo_get(unit, DNX_EGR_EMR_FIFO_MC_HIGH,
                                                                                        tdm_exist)->almost_full),
                                     GEN_DBAL_FIELD32, DBAL_FIELD_MC_LOW_FIFO_DISCARD_TH, INST_SINGLE,
                                     (uint32) (dnx_data_egr_queuing.params.emr_fifo_get(unit, DNX_EGR_EMR_FIFO_MC_LOW,
                                                                                        tdm_exist)->almost_full),
                                     /*
    ...
    {
        SHR_IF_ERR_EXIT(dnx_dbal_gen_set(unit, DBAL_TABLE_EGQ_MULTICAST_FIFOS, 1, 1,
                                         GEN_DBAL_FIELD32, DBAL_FIELD_CORE_ID, (uint32) core,
