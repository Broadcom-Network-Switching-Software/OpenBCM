    ...
    int interval)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_rate_measurement_interval_set_verify(unit, interval));
    ...
    SHR_IF_ERR_EXIT(dnxc_time_time_to_clock_cycles_get(unit, &time, &hw_interval));
    ...
    int *interval)
{
    ...
    SHR_IF_ERR_EXIT(dnxc_time_clock_cycles_to_time_get(unit, hw_interval, DNXC_TIME_UNIT_USEC, &time));
    ...
    int rate_weight)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_rate_measurement_weight_set_verify(unit, rate_weight));
