    ...
    int unit)
{
    ...
    extra_info.grain_size[0] = data.nof_elements / 2;
    extra_info.max_tag_value[0] = 1;
    SHR_IF_ERR_EXIT(dnx_cosq_latency_db.ingress_latency_res.create(unit, &data, (void *) &extra_info));
    tag_info.element = 0;
    tag_info.nof_elements = extra_info.grain_size[0];
    tag_info.tags[0] = 0;
    ...
    tag_info.element = extra_info.grain_size[0];
    tag_info.nof_elements = extra_info.grain_size[0];
    tag_info.tags[0] = 1;
    tag_info.force_tag = FALSE;
    SHR_IF_ERR_EXIT(dnx_cosq_latency_db.ingress_latency_res.advanced_algorithm_info_set(unit, (void *) &tag_info));
    ...
    int arg)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_latency_end_to_end_profile_set_arg_validate(unit, type, arg));
    ...
    int arg)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_cosq_latency_end_to_end_aqm_control_type_verify(unit, type));
