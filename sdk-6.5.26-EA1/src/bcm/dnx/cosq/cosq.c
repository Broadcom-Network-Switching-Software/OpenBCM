    ...
    int arg)
{
    ...
    else if (BCM_GPORT_IS_LOCAL_INTERFACE(port))
    {
        ...
        switch (type)
        {
            ...
            {
                {
                    SHR_IF_ERR_EXIT(dnx_cosq_egq_control_egress_interface_set(unit, port, cosq, type, arg));
                }
                break;
            }
            default:
    ...
    int *arg)
{
    ...
    else if (BCM_GPORT_IS_LOCAL_INTERFACE(port))
    {
        ...
        switch (type)
        {
            ...
            {
                {
                    SHR_IF_ERR_EXIT(dnx_cosq_egq_control_egress_interface_get(unit, port, cosq, type, arg));
                }
                break;
            }
            default:
