 ...
 */
int dnx_scheduler_port_single_if_rate_hw_set(
    int unit,
    bcm_port_t port,
    int is_remove,
    int alt_cal_alg);
 ...
 * \par :
 *   \param [in] unit - unit
 *   \param [in] port_calendar_type - calendar type
 *   \param [in] rate - in Kbits/sec
 *   \param [out] quanta - in device clocks
 */
shr_error_e dnx_scheduler_port_rate_kbits_per_sec_to_quanta(
    int unit,
 ...
 *   \param [in] unit
 *   \param [in] max_burst
 *   \param [out] internal- internal representation of max_burst
 */
shr_error_e dnx_scheduler_port_shaper_max_burst_to_internal(
    int unit,
    uint32 max_burst,
    uint32 *internal);
 ...
 * \par :
 *   \param [in] unit
 *   \param [in] internal- internal representation of max_burst
 *   \param [out] max_burst
 */
shr_error_e dnx_scheduler_port_shaper_max_burst_from_internal(
    int unit,
    uint32 internal,
    uint32 *max_burst);
