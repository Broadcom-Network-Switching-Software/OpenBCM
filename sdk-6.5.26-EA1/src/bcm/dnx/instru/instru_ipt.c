    ...
    bcm_instru_ipt_t * config)
{
    ...
    SHR_INVOKE_VERIFY_DNXC(dnx_instru_ipt_tail_edit_profile_set_verify(unit, flags, ipt_profile, config));
    ...
    bcm_instru_ipt_t * config)
{
    ...
    /** verify ipt profile */
    SHR_INVOKE_VERIFY_DNXC(dnx_instru_ipt_profile_set_verify(unit, flags, ipt_profile, config));
    ...
    bcm_instru_ipt_t * config)
{
    ...
    /** verify ipt profile */
    SHR_INVOKE_VERIFY_DNXC(dnx_instru_ipt_profile_get_verify(unit, flags, ipt_profile, config));
