     ...
     */
    {
         ...
         */
        {
            ...
            else
            {
                ...
                SHR_IF_ERR_EXIT(dnx_field_map_opcode_to_apptype_dnx_to_bcm(unit, opcode_predefined, &apptype_pre));
            }
            ...
            opcodes_in_group[apptype_index] = opcode_predefined;
            nof_opcodes_in_group = nof_user_defiend_apptypes + 1;
        }
        /*
