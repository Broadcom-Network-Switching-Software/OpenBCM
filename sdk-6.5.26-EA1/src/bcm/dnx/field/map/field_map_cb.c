    ...
    uint32 *dnx_data)
{
    ...
    SHR_IF_ERR_EXIT(dbal_fields_enum_hw_value_get(unit, DBAL_FIELD_STAT_OBJ_LM_READ_INDEX, index, &(dnx_data[0])));
    ...
    uint32 *dnx_data)
{
    ...
    switch (bcm_fwd_ctxt_type)
    {
        ...
        case bcmFieldForwardContextBierMpls:
            enum_val_name = "BIER_MPLS_BFR";
            break;
        case bcmFieldForwardContextBierTi:
            enum_val_name = "BIER_NON_MPLS_BFR";
            break;
    ...
    uint32 *dnx_data)
{
    ...
    SHR_IF_ERR_EXIT(dbal_fields_enum_hw_value_get(unit, DBAL_FIELD_ETH_QUALIFIER_TYPE, dbal_l2_format, &(dnx_data[0])));
    ...
    uint32 *dnx_data)
{
    ...
    SHR_IF_ERR_EXIT(dbal_fields_enum_hw_value_get
                    (unit, DBAL_FIELD_IPV4_QUALIFIER_TUNNEL_TYPE, dbal_tunnel_type, &(dnx_data[0])));
    ...
    uint32 *dnx_data)
{
    ...
    SHR_IF_ERR_EXIT(dbal_fields_enum_hw_value_get
                    (unit, DBAL_FIELD_IPV6_ADDITIONAL_HEADER, dbal_additional_header, &(dnx_data[0])));
