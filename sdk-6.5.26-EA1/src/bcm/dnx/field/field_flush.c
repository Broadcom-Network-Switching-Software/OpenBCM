...
#else
        SHR_ERR_EXIT(_SHR_E_INTERNAL, "Not compiled.\n");
#endif
    }
    ...
    uint32 flush_profile_id)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_flush_sw.flush_profile.is_mapped.set(unit, flush_profile_id, FALSE));
    ...
    uint32 flush_profile_id)
{
     ...
     */
    SHR_IF_ERR_EXIT(dnx_field_flush_sw.flush_profile.is_mapped.get(unit, flush_profile_id, &is_mapped));
    if (is_mapped == TRUE)
    {
    ...
    {
        SHR_IF_ERR_EXIT(dnx_field_flush_sw.flush_profile.is_mapped.get(unit, profile_curr, &is_mapped));
        if (is_mapped)
        {
    ...
    uint32 flush_profile_id)
{
    ...
    /** Set flush-profile SW DB */
    SHR_IF_ERR_EXIT(dnx_field_flush_sw.flush_profile.is_mapped.set(unit, flush_profile_id, TRUE));
    ...
    dnx_field_flush_entry_key_t * flush_entry_key_info_p)
{
     ...
     */
    {
        ...
        SOC_FIND_FIELD(ENTRYf, SOC_MEM_INFO(unit, exem_memory).fields, SOC_MEM_INFO(unit, exem_memory).nFields,
                       field_info);
        SHR_NULL_CHECK(field_info, _SHR_E_INTERNAL, "field_info");
