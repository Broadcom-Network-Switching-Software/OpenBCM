...
*/
static shr_error_e
dnx_flow_field_network_group_id_terminator_verify(
    int unit,
    bcm_switch_network_group_t ingress_network_group_id)
{
    ...
    if ((ingress_network_group_id < 0)
        || ((ingress_network_group_id >= nof_network_group_id) && (ingress_network_group_id != 0)))
    {
        SHR_ERR_EXIT(_SHR_E_PARAM, "Error - ingress_network_group_id = %d, is out of range [0:%d].\n",
                     ingress_network_group_id, (nof_network_group_id - 1));
    }
    ...
    void *field_data)
{
    ...
    SHR_IF_ERR_EXIT(dnx_flow_field_network_group_id_terminator_verify
                    (unit, terminator_info->l2_ingress_info.ingress_network_group_id));
    ...
    void *field_data)
{
        ...
        && (is_valid_dest == FALSE))
    {
        SHR_IF_ERR_EXIT(algo_gpm_gport_flow_convert
                        (unit, terminator_info->dest_info.dest_port, _SHR_GPORT_TYPE_FLOW_LIF,
    ...
    void *field_data)
{
    ...
    SHR_IF_ERR_EXIT(dnx_rx_trap_lif_ingress_trap_profile_allocate_and_hw_update
                    (unit, 0, terminator_info->action_gport, &new_lif_trap_profile));
...
shr_error_e
dnx_flow_field_term_field_class_id_set(
    int unit,
    uint32 entry_handle_id,
    dnx_flow_app_type_e flow_app_type,
    bcm_flow_handle_info_t * flow_handle_info,
...
shr_error_e
dnx_flow_field_term_field_class_id_get(
    int unit,
    uint32 entry_handle_id,
    dnx_flow_app_type_e flow_app_type,
    bcm_flow_handle_info_t * flow_handle_info,
...
const dnx_flow_common_field_desc_t dnx_flow_common_field_term_field_class_id = {
     ...
     * field_cbs
     */
    {dnx_flow_field_term_field_class_id_set, dnx_flow_field_term_field_class_id_get, NULL, NULL},
    /*
     * field_print
     */
    NULL
    ...
    void *field_data)
{
    ...
    /** stub function - set is made in the qos dedicated logic */
    SHR_SET_CURRENT_ERR(_SHR_E_NONE);
    SHR_EXIT();
    ...
    void *field_data)
{
    ...
    /** stub function - get is made in the qos dedicated logic */
    SHR_SET_CURRENT_ERR(_SHR_E_NOT_FOUND);
    SHR_EXIT();
...
const dnx_flow_common_field_desc_t dnx_flow_common_field_qos_ttl = {
     ...
     * field_cbs
     */
    {dnx_flow_field_qos_ttl_set, dnx_flow_field_qos_ttl_get, NULL, NULL},
    /*
     * field_print
     */
    NULL
...
shr_error_e
dnx_flow_field_outlif_group_set(
    int unit,
    uint32 entry_handle_id,
    dnx_flow_app_type_e flow_app_type,
    bcm_flow_handle_info_t * flow_handle_info,
    ...
    void *field_data)
{
    ...
    /** stub function - set is made during the global lif allocation */
    SHR_SET_CURRENT_ERR(_SHR_E_NONE);
    SHR_EXIT();
...
const dnx_flow_common_field_desc_t dnx_flow_common_field_outlif_group = {
     ...
     * field_cbs
     */
    {dnx_flow_field_outlif_group_set, dnx_flow_field_outlif_group_get, NULL, NULL},
    /*
     * field_print
     */
    NULL
    ...
    void *field_data)
{
    ...
    dbal_enum_value_field_learn_payload_context_e opt_learn_contexts[2] = { 0 };
    dnx_algo_gpm_forward_info_t forward_info;
    ...
    else
    {
        ...
        else
        {
            ...
            if (is_set == TRUE)
            {
                ...
                dbal_enum_value_field_learn_payload_context_e expected_learn_context = 0;
                ...
                if (learn_context == expected_learn_context)
                {
                    SHR_IF_ERR_EXIT(dbal_fields_struct_field_decode
                                    (unit, DBAL_FIELD_LEARN_INFO_NO_LIF_BASIC_SYM_LIF_BASIC, DBAL_FIELD_DESTINATION,
    ...
    if ((learn_context != opt_learn_contexts[0]) && (learn_context != opt_learn_contexts[1]))
    {
...
shr_error_e
dnx_flow_field_init_field_class_id_set(
    int unit,
    uint32 entry_handle_id,
    dnx_flow_app_type_e flow_app_type,
    bcm_flow_handle_info_t * flow_handle_info,
...
shr_error_e
dnx_flow_field_init_field_class_id_get(
    int unit,
    uint32 entry_handle_id,
    dnx_flow_app_type_e flow_app_type,
    bcm_flow_handle_info_t * flow_handle_info,
...
const dnx_flow_common_field_desc_t dnx_flow_common_field_init_field_class_id = {
     ...
     * field_cbs
     */
    {dnx_flow_field_init_field_class_id_set, dnx_flow_field_init_field_class_id_get, NULL, NULL},
    /*
     * field_print
     */
    NULL
 ...
 ******************************************************************************************************/
const char *
field_desc_init_field_class_cs_id_cb(
    int unit)
{
...
shr_error_e
dnx_flow_field_init_field_class_cs_id_set(
    int unit,
    uint32 entry_handle_id,
    dnx_flow_app_type_e flow_app_type,
    bcm_flow_handle_info_t * flow_handle_info,
...
shr_error_e
dnx_flow_field_init_field_class_cs_id_get(
    int unit,
    uint32 entry_handle_id,
    dnx_flow_app_type_e flow_app_type,
    bcm_flow_handle_info_t * flow_handle_info,
...
const dnx_flow_common_field_desc_t dnx_flow_common_field_init_field_class_cs_id = {
    /*
     * field_name
     */
    "FIELD_CLASS_CS_ID",
     ...
     * field_cbs
     */
    {dnx_flow_field_init_field_class_cs_id_set, dnx_flow_field_init_field_class_cs_id_get, NULL, NULL},
    /*
     * field_print
     */
    NULL
...
const dnx_flow_common_field_desc_t dnx_flow_common_field_svtag_en = {
     ...
     * field_cbs
     */
    {dnx_flow_field_svtag_en_set, dnx_flow_field_svtag_en_get, NULL, NULL},
    /*
     * field_print
     */
    NULL
