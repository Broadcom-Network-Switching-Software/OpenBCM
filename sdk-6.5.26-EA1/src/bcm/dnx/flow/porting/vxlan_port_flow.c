    ...
    bcm_flow_terminator_info_t * common_fields)
{
    ...
    common_fields->learn_enable = 0x1;
    ...
    /** flags update */
    common_fields->l2_learn_info.l2_learn_info_flags = ((symmetric_flag == TRUE) ?
                                                        BCM_FLOW_HANDLE_INFO_SYMMETRIC_ALLOC : 0);

    /** dest_port */
    common_fields->l2_learn_info.dest_port = vxlan_port->match_port;
    ...
    bcm_vxlan_port_t * vxlan_port)
{
    ...
    /** get the flow_id */
    SHR_IF_ERR_EXIT(algo_gpm_gport_flow_convert(unit, vxlan_port->match_tunnel_id, _SHR_GPORT_TYPE_FLOW_LIF,
    ...
    bcm_vxlan_port_t * vxlan_port)
{
    ...
    /** get the currently data */
    /** get the flow_id */
    SHR_IF_ERR_EXIT(algo_gpm_gport_flow_convert(unit, vxlan_port->egress_tunnel_id, _SHR_GPORT_TYPE_FLOW_LIF,
    ...
    bcm_vxlan_port_t * vxlan_port)
{
    ...
    /** get the flow_id */
    SHR_IF_ERR_EXIT(algo_gpm_gport_flow_convert(unit, vxlan_port->vxlan_port_id, _SHR_GPORT_TYPE_FLOW_LIF,
                                                DNX_ALGO_GPM_CONVERSION_FLAG_FLOW_TERMINATOR,
                                                &flow_handle_info.flow_id));
    ...
    bcm_gport_t vxlan_port_id)
{
    ...
    /** get the flow_id */
    SHR_IF_ERR_EXIT(algo_gpm_gport_flow_convert(unit, vxlan_port_id, _SHR_GPORT_TYPE_FLOW_LIF,
                                                DNX_ALGO_GPM_CONVERSION_FLAG_FLOW_TERMINATOR,
                                                &flow_handle_info.flow_id));
