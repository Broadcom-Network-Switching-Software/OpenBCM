    ...
    uint32 value)
{
    ...
    if (pclass == bcmPortClassForwardIngress)
    {
        ...
        SHR_IF_ERR_EXIT(algo_gpm_gport_flow_convert
                        (unit, gport_lif, _SHR_GPORT_TYPE_FLOW_LIF, DNX_ALGO_GPM_CONVERSION_FLAG_FLOW_TERMINATOR,
    ...
    else if (pclass == bcmPortClassForwardEgress)
    {
        /** Convert the gport to flow id*/
        SHR_IF_ERR_EXIT(algo_gpm_gport_flow_convert
                        (unit, gport_lif, _SHR_GPORT_TYPE_FLOW_LIF, DNX_ALGO_GPM_CONVERSION_FLAG_FLOW_INITIATOR,
                         &flow_handle_info.flow_id));
    ...
    SHR_IF_ERR_EXIT(algo_gpm_gport_flow_convert
                    (unit, gport_lif, _SHR_GPORT_TYPE_FLOW_LIF, gport_flag, &flow_handle_info.flow_id));
    ...
    bcm_port_flood_group_t * flood_groups)
{
    ...
    /** Convert the gport to flow id*/
    SHR_IF_ERR_EXIT(algo_gpm_gport_flow_convert(unit, gport_lif, _SHR_GPORT_TYPE_FLOW_LIF,
