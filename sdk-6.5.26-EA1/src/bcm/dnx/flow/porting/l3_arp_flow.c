    ...
    bcm_l3_egress_t * old_egr)
{
    ...
    if ((flags & (BCM_L3_KEEP_DSTMAC | BCM_L3_KEEP_VLAN)) != (BCM_L3_KEEP_DSTMAC | BCM_L3_KEEP_VLAN))
    {
        ...
        {
            bcm_flow_special_fields_t special_fields_temp;
            ...
            flow_handle_info_get.flags &= ~BCM_FLOW_HANDLE_INFO_WITH_ID;
            SHR_IF_ERR_EXIT(bcm_dnx_flow_initiator_info_get(unit, &flow_handle_info_get, &info, &special_fields_temp));
