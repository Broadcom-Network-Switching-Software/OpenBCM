...
const flow_special_field_info_t flow_special_fields_db[NOF_FLOW_SPECIAL_FIELDS+1] = {
    ...
    {"DUAL_HOMING",                 DBAL_FIELD_DUAL_HOMING,                 FLOW_PAYLOAD_TYPE_UINT32,           FLOW_S_FIELD_DIRECT_MAPPING},
    ...
    {"FORWARD_DOMAIN_ASSIGNMENT_MODE", DBAL_FIELD_FODO_ASSIGNMENT_MODE,     FLOW_PAYLOAD_TYPE_ENUM,             FLOW_S_FIELD_UNLINKED,   flow_special_field_fodo_assignment_mode_desc, flow_special_field_fodo_assignment_mode_print,     FLOW_S_FIELD_NO_INDICATIONS,        FLOW_S_FIELD_NO_MAPPING_CBS},
    ...
    {"IPVX_TUNNEL_TYPE",            FLOW_S_F_UNMAPPED,                      FLOW_PAYLOAD_TYPE_BCM_ENUM,         FLOW_S_FIELD_UNLINKED,   flow_special_field_ipvx_tunnel_desc, flow_special_field_ipvx_tunnel_print,  (FLOW_S_FIELD_LIF_SHOULD_BE_IGNORED | FLOW_S_FIELD_IS_LIF_UNCHANGEABLE), NULL, NULL, NULL, NULL, NULL},
    ...
    {"REFLECTOR_EGRESS_LAST_LAYER", DBAL_FIELD_EGRESS_LAST_LAYER,           FLOW_PAYLOAD_TYPE_UINT32,           FLOW_S_FIELD_DIRECT_MAPPING},
    ...
    {"NEXT_OUTLIF_POINTER",         DBAL_FIELD_NEXT_OUTLIF_POINTER,         FLOW_PAYLOAD_TYPE_UINT32,           FLOW_S_FIELD_UNLINKED,     NULL,                   NULL, FLOW_S_FIELD_NO_INDICATIONS, flow_special_field_next_outlif_pointer_set, flow_special_field_next_outlif_pointer_get, NULL, NULL, NULL},
    ...
    uint8 *is_value_new)
{
    ...
    *is_value_new = UTILEX_NUM2BOOL(rv == _SHR_E_NONE);
    ...
    if (is_replace && !(*is_value_new))
    {
        ...
        sal_memset(special_field_data, 0, sizeof(bcm_flow_special_field_t));
        SHR_IF_ERR_EXIT(dnx_flow_special_field_data_get(unit, prev_special_fields, field_id, special_field_data));
    }
    ...
    bcm_flow_special_fields_t * special_fields)
{
    ...
    if (!dnx_data_tunnel.tunnel_type.udp_tunnel_type_get(unit))
    {
        ...
        tcam_table_key.type = tunnel_type;
    ...
    bcm_flow_special_field_t * special_field)
{
    ...
    SHR_IF_ERR_EXIT(algo_gpm_gport_flow_convert
                    (unit, gport, _SHR_GPORT_TYPE_FLOW_LIF, DNX_ALGO_GPM_CONVERSION_FLAG_FLOW_TERMINATOR, &gport));
    ...
    if ((control_lif != recycle_default_lif_mp) && (control_lif != recycle_default_lif_p2p))
    {
        ...
        else
        {
            SHR_IF_ERR_EXIT(algo_gpm_gport_flow_convert(unit,
                                                        flow_id, _SHR_GPORT_TYPE_FLOW_LIF,
