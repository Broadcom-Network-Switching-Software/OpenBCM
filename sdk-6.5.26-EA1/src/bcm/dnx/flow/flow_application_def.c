...
extern const dnx_flow_app_config_t dnx_legacy_flow_app_ipv4_tunnel_p2p_em_term_match;
extern const dnx_flow_app_config_t dnx_legacy_flow_app_ipv4_tunnel_mp_em_term_match;
extern const dnx_flow_app_config_t dnx_legacy_flow_app_ipv6_tunnel_mp_tcam_term_match;
extern const dnx_flow_app_config_t dnx_legacy_flow_app_ipv6_tunnel_p2p_em_term_match;
...
const dnx_flow_app_config_t *dnx_flow_objects[] = {
    ...
    &dnx_legacy_flow_app_ipv4_tunnel_p2p_em_term_match,
    &dnx_legacy_flow_app_ipv4_tunnel_mp_em_term_match,
    &dnx_legacy_flow_app_ipv6_tunnel_mp_tcam_term_match,
    &dnx_legacy_flow_app_ipv6_tunnel_p2p_em_term_match,
...
extern dnx_flow_common_field_desc_t
    ...
    dnx_flow_common_field_init_field_class_cs_id,
