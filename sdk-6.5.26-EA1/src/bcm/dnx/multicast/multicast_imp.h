...
#define DNX_MULTICAST_BMP_NOF_REPLICATIONS_PER_DEV(unit)              dnx_data_port.general.nof_pp_dsp_get(unit)
...
#define DNX_MULTICAST_IS_SAR(flags) ((flags & BCM_MULTICAST_SAR_GROUP) ? 1 : 0)
#define DNX_MULTICAST_IS_MC_ELEMENT_DYNAMIC(flags) ((flags & BCM_MULTICAST_ELEMENT_DYNAMIC) ? 1 : 0)
#define DNX_MULTICAST_IS_MC_ELEMENT_STATIC(flags) ((flags & BCM_MULTICAST_ELEMENT_STATIC) ? 1 : 0)
...
typedef struct multicast_mcdb_dbal_fields_s
{
    ...
    uint32 bmp_offset;
    uint8 is_last_entry;
    uint8 same_if_disable;
    uint8 split_horizon_disable;
    uint32 forward_group;
    uint8 forward_group_valid;
    uint32 same_if_dspa;
    uint8 same_if_dspa_valid;
    uint32 same_if_outlif;
    uint8 same_if_outlif_valid;
    uint32 protection_pointer;
    dbal_result_type_t format;
 ...
 *   * None
 */
shr_error_e dnx_multicast_v1_group_open_hw_set(
    int unit,
 ...
 *   * None
 */
shr_error_e dnx_multicast_v1_group_open_hw_get(
    int unit,
    bcm_multicast_t group,
    uint32 flags,
    uint32 *is_open);
 ...
 *   * None
 */
shr_error_e dnx_multicast_v1_entry_get(
    int unit,
    uint32 entry_id,
 ...
 *   * None
 */
shr_error_e dnx_multicast_v1_entry_set(
    int unit,
    uint32 entry_id,
    dnx_multicast_mcdb_dbal_field_t * entry_val);
 ...
 *   \param [in] is_dyn_element - is multicast static element
...
/**
 * \brief - Get previous entry pointer of an MCDB entry through DBAL interface
 *
 * \par DIRECT_INPUT:
 *   \param [in] unit -  Unit-ID
 *   \param [in] entry_id - MCDB index
 ...
 *   * None
 */
shr_error_e dnx_multicast_entry_prev_ptr_get(
    int unit,
    uint32 entry_id,
    uint32 *prev_entry_id);
 ...
 *   * None
 */
shr_error_e dnx_multicast_egress_bitmap_reps_to_bmp(
    int unit,
    int rep_count_in,
 ...
 *   * None
 */
shr_error_e dnx_multicast_egress_bitmap_bmp_to_reps(
    int unit,
    uint32 cud,
    uint32 core_id,
    uint32 *bmp,
...
/**
 * \brief -  Moves the old  MCDB entry to the new entry in the Hash table
 *
 * \par DIRECT_INPUT:
 *   \param [in] unit -  Unit-ID
 *   \param [in] old_entry_id - MCDB index of the old entry
 *   \param [in] new_entry_id - MCDB index of the new entry
 *
 * \par INDIRECT INPUT:
 *   * None
 * \par DIRECT OUTPUT:
 ...
 *   * None
 */
shr_error_e dnx_multicast_hash_table_entry_relocate(
    int unit,
    uint32 old_entry_id,
    uint32 new_entry_id);
 ...
 *   * None
 */
shr_error_e dnx_multicast_linklist_rep_remove(
    int unit,
    bcm_multicast_t group,
    uint32 flags,
    int rep_count_in,
...
/**
 * \brief - Set in HW the mapping of a MC group to SAR channel
 *
 * \par DIRECT_INPUT:
 *   \param [in] unit -  Unit ID
 *   \param [in] core_id -  Core ID
 *   \param [in] group - Group ID
 *   \param [in] channel_id - SAR channel ID
 *
 * \par INDIRECT INPUT:
 *   * None
 * \par DIRECT OUTPUT:
 ...
 *   * None
 */
shr_error_e dnx_multicast_sar_group_channel_set(
    int unit,
    bcm_core_t core_id,
    bcm_multicast_t group,
    uint32 channel_id);
...
/**
 * \brief - Get from HW the mapping of a MC group to SAR channel
 *
 * \par DIRECT_INPUT:
 *   \param [in] unit -  Unit ID
 *   \param [in] core_id -  Core ID
 *   \param [in] group - Group ID
 *   \param [out] channel_id - SAR channel ID
 *
 * \par INDIRECT INPUT:
 *   * None
 * \par DIRECT OUTPUT:
 ...
 *   * None
 */
shr_error_e dnx_multicast_sar_group_channel_get(
    int unit,
    bcm_core_t core_id,
    bcm_multicast_t group,
    uint32 *channel_id);
...
/**
 * \brief - Set mapping of a MC group to the SAR channel corresponding to
 *          the given port
 *
 * \par DIRECT_INPUT:
 *   \param [in] unit -  Unit ID
 ...
 *   * None
 */
shr_error_e dnx_multicast_group_sar_port_set(
    int unit,
    bcm_multicast_t group,
    bcm_port_t port);
