...
/**
 * \brief - Return the amount of required MCDB copies of a BFR entry
 * The amount depends whether egress or ingress multicast is required/exists in the system
 *
 * \par DIRECT_INPUT:
 *   \param [in] unit -  Unit-ID
 *
 ...
 *   * None
 */
int dnx_bier_mcdb_copies_per_entry_get(
    int unit);
