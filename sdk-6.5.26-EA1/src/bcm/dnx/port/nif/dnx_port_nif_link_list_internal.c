...
static shr_error_e dnx_port_link_list_db_nof_sections_allocated_get(
    int unit,
    dnx_port_nif_link_list_type_e list_type,
    int client_id,
    uint32 *nof_sections_allocated);
static shr_error_e dnx_port_link_list_db_double_priority_nof_sections_allocated_set(
    int unit,
    dnx_port_nif_link_list_type_e list_type,
    int client_id,
    int priority,
...
static shr_error_e dnx_port_double_priority_link_list_db_free(
    ...
    int priority,
    dnx_port_nif_list_info_t * used_sub_list_info);
static shr_error_e dnx_port_nif_double_priority_link_list_check_if_size_available(
    int unit,
    dnx_port_nif_link_list_type_e list_type,
    int client_id,
    uint8 **sub_lists_data);
...
static shr_error_e dnx_port_nif_link_list_head_get(
    ...
    int *head,
    int *nof_sections);
static shr_error_e dnx_port_nif_double_priority_link_list_head_get(
    int unit,
    dnx_port_nif_link_list_type_e list_type,
    int client,
    int priority,
    ...
    int client_id)
{
    ...
    uint32 new_list_size, nof_sections_allocated, nof_active_sub_lists;
    ...
    for (priority = 0; priority < dnx_data_nif.eth.priority_groups_nof_get(unit); ++priority)
    {
        ...
        SHR_IF_ERR_EXIT(dnx_port_link_list_db_double_priority_nof_sections_allocated_get
                        (unit, list_type, client_id, priority, &nof_sections_allocated));
        ...
        SHR_IF_ERR_EXIT(dnx_port_link_list_db_double_priority_nof_sections_allocated_set
                        (unit, list_type, client_id, priority, new_list_size));
    }
    ...
    int client_id)
{
    ...
    for (priority = 0; priority < nof_priorities; ++priority)
    {
         ...
         */
        SHR_IF_ERR_EXIT(dnx_port_link_list_db_double_priority_nof_sections_allocated_get
                        (unit, list_type, client_id, priority, &nof_allocated_sections));
...
{
    uint32 list_head, list_size;
    int sub_list_index, sub_list_size, sub_list_head;
    int nof_sections_per_group, nof_groups, section_index, current_section, prev_section;
    SHR_FUNC_INIT_VARS(unit);

    SHR_IF_ERR_EXIT(dnx_port_nif_double_priority_link_list_head_get
    ...
    int client_id)
{
     ...
     */
    SHR_IF_ERR_EXIT(dnx_port_double_priority_link_list_db_free
                    (unit, list_type, client_id, priority, used_sub_lists_info));

    SHR_IF_ERR_EXIT(dnx_port_link_list_db_double_priority_nof_sections_allocated_set
                    (unit, list_type, client_id, priority, 0));
...
static shr_error_e
dnx_port_link_list_db_double_priority_nof_sections_allocated_set(
    int unit,
    dnx_port_nif_link_list_type_e list_type,
    int client_id,
    int priority,
    uint32 nof_sections_allocated)
{
    ...
    switch (list_type)
    {
        case DNX_PORT_NIF_OFR_LINK_LIST:
            SHR_IF_ERR_EXIT(dnx_port_nif_db.ofr_link_list.nof_sections_allocated.set(unit, priority, client_id,
...
shr_error_e
dnx_port_link_list_db_double_priority_nof_sections_allocated_get(
    int unit,
    dnx_port_nif_link_list_type_e list_type,
    int client_id,
    int priority,
    uint32 *nof_sections_allocated)
{
    ...
    {
        case DNX_PORT_NIF_OFR_LINK_LIST:
            SHR_IF_ERR_EXIT(dnx_port_nif_db.ofr_link_list.nof_sections_allocated.get(unit, priority, client_id,
                                                                                     nof_sections_allocated));
            break;
    ...
    uint8 **sub_lists_data)
{
    ...
    for (sub_list_index = 0; sub_list_index < nof_sub_lists; ++sub_list_index)
    {
        ...
        for (priority = 0; priority < dnx_data_nif.eth.priority_groups_nof_get(unit); ++priority)
        {
            SHR_IF_ERR_EXIT(dnx_port_link_list_db_double_priority_nof_sections_allocated_get
                            (unit, list_type, client_id, priority, &nof_sections_allocated));
            alloc_size += sub_lists_data[priority][sub_list_index] - nof_sections_allocated;
        }
    ...
    dnx_port_nif_link_list_type_e list_type)
{
    ...
    switch (list_type)
    {
        case DNX_PORT_NIF_ARB_LINK_LIST:
            ...
            SHR_IF_ERR_EXIT(dnx_port_nif_db.arb_link_list.
                            nof_sections_allocated.alloc(unit, dnx_data_nif.arb.nof_contexts_get(unit)));
            break;
        ...
        case DNX_PORT_NIF_OFT_LINK_LIST:
            ...
            SHR_IF_ERR_EXIT(dnx_port_nif_db.oft_link_list.
                            nof_sections_allocated.alloc(unit, dnx_data_nif.oft.nof_contexts_get(unit)));
            break;
...
static shr_error_e
dnx_port_nif_double_priority_link_list_head_get(
    int unit,
    dnx_port_nif_link_list_type_e list_type,
    int client,
    int priority,
    ...
    uint32 *nof_sections)
{
     ...
     * set key fields
     */
    dbal_entry_key_field32_set(unit, entry_handle_id, key_id, rmc_id);

    /*
     * set value fields
     */
    dbal_value_field32_request(unit, entry_handle_id, DBAL_FIELD_FIRST_SECTION, INST_SINGLE, head);
    dbal_value_field32_request(unit, entry_handle_id, DBAL_FIELD_FIFO_SIZE, INST_SINGLE, nof_sections);
