 ...
 */
int
imb_ilu_port_nmg_sch_config_hw_init(
    int unit,
    uint32 ilkn_core_id)
{
    uint32 entry_handle_id;
...
/**
 * \brief - Configure the ILU port in the specified NMG Scheduler
 *
 * see .h file
 */
int
imb_ilu_port_nmg_sch_config_hw_set(
    int unit,
    uint32 ilkn_core_id,
    uint32 ilkn_port_id,
 ...
 */
int
imb_ilu_port_nmg_sch_config_hw_get(
    int unit,
    uint32 ilkn_core_id,
    uint32 ilkn_port_id,
    ...
    uint32 offset_base)
{
     ...
     * alloc DBAL table handle
     */
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_NIF_PRD_ILU_TCAM_KEY_OFFSET_BASE, &entry_handle_id));
    /*
     * set key fields
     */
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_ILKN_CORE_ID, ilkn_access_info.ilkn_core);
    ...
    uint32 ether_type_size)
{
     ...
     * alloc DBAL table handle
     */
    SHR_IF_ERR_EXIT(DBAL_HANDLE_ALLOC(unit, DBAL_TABLE_NIF_PRD_ILU_ETHER_TYPE_CODE_HEADER_SIZE, &entry_handle_id));
    /*
     * set key fields
     */
    dbal_entry_key_field32_set(unit, entry_handle_id, DBAL_FIELD_ILKN_CORE_ID, ilkn_access_info.ilkn_core);
