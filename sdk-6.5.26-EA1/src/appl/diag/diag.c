...
int diag_reg_info_get(int unit, char *name, soc_reg_t *reg_id, soc_block_t *block_instance_id, unsigned int *block_instance_number, unsigned int *array_index)
{
    int rv = SOC_E_NONE;
    soc_regaddrlist_t alist;
    soc_regaddrinfo_t    *ainfo;
 ...
 */
int diag_mem_info_get(int unit, char *name, soc_mem_t *mem_id, soc_block_t *block_instance_id, unsigned int *block_instance_number, unsigned int *array_index)
{
    int         rv = SOC_E_NONE;
