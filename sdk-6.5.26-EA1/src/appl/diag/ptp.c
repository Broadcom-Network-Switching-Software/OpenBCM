...
#define PTP_TELECOM_USAGE_2 \
    ...
    "\t PTP TELecom SLaVe ClkClass [Enable=y/n]\n"                                   \
...
cmd_ptp_telecom(int unit, args_t *a)
{
    ...
    if (!arg) {
        ...
        if (!arg) {
            ...
            _bcm_ptp_telecom_g8265_clock_class_enable_set(unit,
                arg_stack_id, arg_clock_num, arg_ClkClassEnable);
