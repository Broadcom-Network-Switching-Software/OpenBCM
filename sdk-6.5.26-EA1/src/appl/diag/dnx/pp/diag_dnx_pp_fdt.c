    ...
    sh_sand_control_t * sand_control)
{
    ...
    {
        char *stage_list_prt[] =
            { "LLR", "VTT1", "VTT2", "VTT3", "VTT4", DIAG_DNX_PP_VTT5_STAGE_STR(unit), "FWD1", "FWD2", "IPMF1", "FER",
            "IPMF3", "LBP"
        };
        ...
        for (stage_idx = 0; stage_idx < num_of_stages; stage_idx++)
        {
            ...
            if (ISEMPTY(stage_list_prt[stage_idx]))
            {
                continue;
            }
            PRT_CELL_SET("%s",
                         ((sal_strncasecmp
                           (stage_list_prt[stage_idx], "IPMF1",
            ...
            if (sal_strnstr(stage_list_prt[stage_idx], "LBP", SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH))
            {
...

            {
                ...
                if (sal_strnstr(stage_list_prt[stage_idx], "LLR", SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH))
                {
            ...
            if (sal_strnstr(stage_list_prt[stage_idx], "IPMF", SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH))
            {
...

            {
                ...
                if ((sal_strnstr(stage_list_prt[stage_idx], "LLR", SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH))
                    || (sal_strnstr(stage_list_prt[stage_idx], "LBP", SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH)))
                {
                    sal_strncpy(sig_value_str, "N/A", RHNAME_MAX_SIZE - 1);
                }
            ...
            if (sal_strnstr(stage_list_prt[stage_idx], "IPMF3", SHR_SAND_DEFAULT_MAX_STRING_OPERATION_LENGTH))
            {
