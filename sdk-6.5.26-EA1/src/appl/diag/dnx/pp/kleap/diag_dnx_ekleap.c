    ...
    signal_output_t * sig)
{
    ...
    {
        entry_type[0] = 0;
        SHR_IF_ERR_EXIT(dnx_etps_arr_table_id_and_data_type_get(unit, core, arr_history, &table_id, &sw_result_type));
    }
    ...
    if ((arr_history.decode_type != ARR_DECODE_NONE) && (entry_type[0] == 0))
    {
