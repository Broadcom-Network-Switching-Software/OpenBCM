...
sh_sand_cmd_t sh_dnx_swstate_dnx_field_qualifier_cmds[] = {
    ...
    {"predefined", NULL, sh_dnx_swstate_dnx_field_qualifier_predefined_cmds, NULL, &dnx_swstate_dnx_field_qualifier_predefined_man},
    {"layer_record", NULL, sh_dnx_swstate_dnx_field_qualifier_layer_record_cmds, NULL, &dnx_swstate_dnx_field_qualifier_layer_record_man},
...
sh_sand_cmd_t sh_dnx_swstate_dnx_field_qualifier_predefined_cmds[] = {
    {"field_id", NULL, sh_dnx_swstate_dnx_field_qualifier_predefined_field_id_cmds, NULL, &dnx_swstate_dnx_field_qualifier_predefined_field_id_man},
    {"dump", sh_dnx_swstate_dnx_field_qualifier_predefined_dump_cmd, NULL, dnx_swstate_dnx_field_qualifier_predefined_dump_options, &dnx_swstate_dnx_field_qualifier_predefined_dump_man},
    {"size_get", sh_dnx_swstate_dnx_field_qualifier_predefined_size_get_cmd, NULL, dnx_swstate_dnx_field_qualifier_predefined_size_get_options, &dnx_swstate_dnx_field_qualifier_predefined_size_get_man},
    {NULL}
};


sh_sand_man_t dnx_swstate_dnx_field_qualifier_predefined_man = {
    cmd_dnx_swstate_dnx_field_qualifier_predefined_desc,
    NULL,
    NULL,
    NULL,
};
...
const char cmd_dnx_swstate_dnx_field_qualifier_predefined_desc[] = "dnx_field_qual_sw_db predefined commands";
...
shr_error_e sh_dnx_swstate_dnx_field_qualifier_predefined_dump_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    SHR_IF_ERR_EXIT(dnx_field_qual_sw_db_predefined_dump(unit, predefined_idx_0, filters));
...
sh_sand_option_t dnx_swstate_dnx_field_qualifier_predefined_dump_options[] = {
...
sh_sand_man_t dnx_swstate_dnx_field_qualifier_predefined_dump_man = {
    "swstate dump",
    "print the variable value",
    "dnx_field_qual_sw_db predefined dump [,predefined_idx_0=<int>]\n",
    "dnx_field_qual_sw_db predefined dump predefined_idx_0=0 nocontent=false typefilter="" namefilter="" ",
};
...
shr_error_e sh_dnx_swstate_dnx_field_qualifier_predefined_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(dnx_field_qual_sw_db_info[unit], dnx_field_qual_sw_db_layout_str, DNX_FIELD_QUAL_SW_DB_INFO_NOF_ENTRIES, "DNX_FIELD_QUAL_SW_DB~PREDEFINED~", sizeof(((dnx_field_qual_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_QUALIFIER_MODULE_ID])->predefined));
    dnx_sw_state_size_print(size);
...
sh_sand_option_t dnx_swstate_dnx_field_qualifier_predefined_size_get_options[] = {
    {NULL}
};


sh_sand_man_t dnx_swstate_dnx_field_qualifier_predefined_size_get_man = {
    "swstate size_get",
    "print the variable size",
    "dnx_field_qual_sw_db predefined size_get",
    "dnx_field_qual_sw_db predefined size_get",
};



sh_sand_cmd_t sh_dnx_swstate_dnx_field_qualifier_predefined_field_id_cmds[] = {
    {"dump", sh_dnx_swstate_dnx_field_qualifier_predefined_field_id_dump_cmd, NULL, dnx_swstate_dnx_field_qualifier_predefined_field_id_dump_options, &dnx_swstate_dnx_field_qualifier_predefined_field_id_dump_man},
    {"size_get", sh_dnx_swstate_dnx_field_qualifier_predefined_field_id_size_get_cmd, NULL, dnx_swstate_dnx_field_qualifier_predefined_field_id_size_get_options, &dnx_swstate_dnx_field_qualifier_predefined_field_id_size_get_man},
    {NULL}
};


sh_sand_man_t dnx_swstate_dnx_field_qualifier_predefined_field_id_man = {
    cmd_dnx_swstate_dnx_field_qualifier_predefined_field_id_desc,
    NULL,
    NULL,
    NULL,
};
...
const char cmd_dnx_swstate_dnx_field_qualifier_predefined_field_id_desc[] = "dnx_field_qual_sw_db predefined field_id commands";
...
sh_sand_option_t dnx_swstate_dnx_field_qualifier_predefined_field_id_dump_options[] = {
    {"predefined_idx_0", SAL_FIELD_TYPE_INT32, "index", NULL},
    {"nocontent",      SAL_FIELD_TYPE_BOOL, "Decision if to perform content dump or to print the access tree.",  "false"},
    {"typefilter",     SAL_FIELD_TYPE_STR,  "Filter for the variable type.",         ""},
    {"namefilter",     SAL_FIELD_TYPE_STR,  "Filter for the variable name.",         ""},
...
sh_sand_man_t dnx_swstate_dnx_field_qualifier_predefined_field_id_dump_man = {
    "swstate dump",
    "print the variable value",
    "dnx_field_qual_sw_db predefined field_id dump [,predefined_idx_0=<int>]\n",
    "dnx_field_qual_sw_db predefined field_id dump predefined_idx_0=0 nocontent=false typefilter="" namefilter="" ",
};
...
shr_error_e sh_dnx_swstate_dnx_field_qualifier_predefined_field_id_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(dnx_field_qual_sw_db_info[unit], dnx_field_qual_sw_db_layout_str, DNX_FIELD_QUAL_SW_DB_INFO_NOF_ENTRIES, "DNX_FIELD_QUAL_SW_DB~PREDEFINED~FIELD_ID~", sizeof(((dnx_field_qual_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_QUALIFIER_MODULE_ID])->predefined[0].field_id));
    dnx_sw_state_size_print(size);
...
sh_sand_option_t dnx_swstate_dnx_field_qualifier_predefined_field_id_size_get_options[] = {
    {NULL}
};


sh_sand_man_t dnx_swstate_dnx_field_qualifier_predefined_field_id_size_get_man = {
    "swstate size_get",
    "print the variable size",
    "dnx_field_qual_sw_db predefined field_id size_get",
    "dnx_field_qual_sw_db predefined field_id size_get",
};



sh_sand_cmd_t sh_dnx_swstate_dnx_field_qualifier_layer_record_cmds[] = {
    {"field_id", NULL, sh_dnx_swstate_dnx_field_qualifier_layer_record_field_id_cmds, NULL, &dnx_swstate_dnx_field_qualifier_layer_record_field_id_man},
    {"dump", sh_dnx_swstate_dnx_field_qualifier_layer_record_dump_cmd, NULL, dnx_swstate_dnx_field_qualifier_layer_record_dump_options, &dnx_swstate_dnx_field_qualifier_layer_record_dump_man},
    {"size_get", sh_dnx_swstate_dnx_field_qualifier_layer_record_size_get_cmd, NULL, dnx_swstate_dnx_field_qualifier_layer_record_size_get_options, &dnx_swstate_dnx_field_qualifier_layer_record_size_get_man},
    {NULL}
};


sh_sand_man_t dnx_swstate_dnx_field_qualifier_layer_record_man = {
    cmd_dnx_swstate_dnx_field_qualifier_layer_record_desc,
    NULL,
    NULL,
    NULL,
};
...
const char cmd_dnx_swstate_dnx_field_qualifier_layer_record_desc[] = "dnx_field_qual_sw_db layer_record commands";


shr_error_e sh_dnx_swstate_dnx_field_qualifier_layer_record_dump_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    int  layer_record_idx_0 = 0;

    dnx_sw_state_dump_filters_t filters;

    SHR_FUNC_INIT_VARS(unit);

    SH_SAND_GET_INT32("layer_record_idx_0", layer_record_idx_0);

    SH_SAND_GET_BOOL("nocontent", filters.nocontent);
    SH_SAND_GET_STR("typefilter", filters.typefilter);
    SH_SAND_GET_STR("namefilter", filters.namefilter);

    SHR_IF_ERR_EXIT(dnx_field_qual_sw_db_layer_record_dump(unit, layer_record_idx_0, filters));
...
sh_sand_option_t dnx_swstate_dnx_field_qualifier_layer_record_dump_options[] = {
    {"layer_record_idx_0", SAL_FIELD_TYPE_INT32, "index", NULL},
    {"nocontent",      SAL_FIELD_TYPE_BOOL, "Decision if to perform content dump or to print the access tree.",  "false"},
    {"typefilter",     SAL_FIELD_TYPE_STR,  "Filter for the variable type.",         ""},
    {"namefilter",     SAL_FIELD_TYPE_STR,  "Filter for the variable name.",         ""},
    {NULL}
...
sh_sand_man_t dnx_swstate_dnx_field_qualifier_layer_record_dump_man = {
    "swstate dump",
    "print the variable value",
    "dnx_field_qual_sw_db layer_record dump [,layer_record_idx_0=<int>]\n",
    "dnx_field_qual_sw_db layer_record dump layer_record_idx_0=0 nocontent=false typefilter="" namefilter="" ",
};
...
shr_error_e sh_dnx_swstate_dnx_field_qualifier_layer_record_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(dnx_field_qual_sw_db_info[unit], dnx_field_qual_sw_db_layout_str, DNX_FIELD_QUAL_SW_DB_INFO_NOF_ENTRIES, "DNX_FIELD_QUAL_SW_DB~LAYER_RECORD~", sizeof(((dnx_field_qual_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_QUALIFIER_MODULE_ID])->layer_record));
    dnx_sw_state_size_print(size);
...
sh_sand_option_t dnx_swstate_dnx_field_qualifier_layer_record_size_get_options[] = {
    {NULL}
};


sh_sand_man_t dnx_swstate_dnx_field_qualifier_layer_record_size_get_man = {
    "swstate size_get",
    "print the variable size",
    "dnx_field_qual_sw_db layer_record size_get",
    "dnx_field_qual_sw_db layer_record size_get",
};



sh_sand_cmd_t sh_dnx_swstate_dnx_field_qualifier_layer_record_field_id_cmds[] = {
    {"dump", sh_dnx_swstate_dnx_field_qualifier_layer_record_field_id_dump_cmd, NULL, dnx_swstate_dnx_field_qualifier_layer_record_field_id_dump_options, &dnx_swstate_dnx_field_qualifier_layer_record_field_id_dump_man},
    {"size_get", sh_dnx_swstate_dnx_field_qualifier_layer_record_field_id_size_get_cmd, NULL, dnx_swstate_dnx_field_qualifier_layer_record_field_id_size_get_options, &dnx_swstate_dnx_field_qualifier_layer_record_field_id_size_get_man},
    {NULL}
};


sh_sand_man_t dnx_swstate_dnx_field_qualifier_layer_record_field_id_man = {
    cmd_dnx_swstate_dnx_field_qualifier_layer_record_field_id_desc,
    NULL,
    NULL,
    NULL,
};
...
const char cmd_dnx_swstate_dnx_field_qualifier_layer_record_field_id_desc[] = "dnx_field_qual_sw_db layer_record field_id commands";
...
sh_sand_option_t dnx_swstate_dnx_field_qualifier_layer_record_field_id_dump_options[] = {
    {"layer_record_idx_0", SAL_FIELD_TYPE_INT32, "index", NULL},
    {"nocontent",      SAL_FIELD_TYPE_BOOL, "Decision if to perform content dump or to print the access tree.",  "false"},
    {"typefilter",     SAL_FIELD_TYPE_STR,  "Filter for the variable type.",         ""},
    {"namefilter",     SAL_FIELD_TYPE_STR,  "Filter for the variable name.",         ""},
...
sh_sand_man_t dnx_swstate_dnx_field_qualifier_layer_record_field_id_dump_man = {
    "swstate dump",
    "print the variable value",
    "dnx_field_qual_sw_db layer_record field_id dump [,layer_record_idx_0=<int>]\n",
    "dnx_field_qual_sw_db layer_record field_id dump layer_record_idx_0=0 nocontent=false typefilter="" namefilter="" ",
};
...
shr_error_e sh_dnx_swstate_dnx_field_qualifier_layer_record_field_id_size_get_cmd(int unit, args_t *args, sh_sand_control_t *sand_control)
{
    ...
    size = dnx_sw_state_info_size_get(dnx_field_qual_sw_db_info[unit], dnx_field_qual_sw_db_layout_str, DNX_FIELD_QUAL_SW_DB_INFO_NOF_ENTRIES, "DNX_FIELD_QUAL_SW_DB~LAYER_RECORD~FIELD_ID~", sizeof(((dnx_field_qual_sw_db_t*)sw_state_roots_array[unit][DNX_FIELD_QUALIFIER_MODULE_ID])->layer_record[0].field_id));
    dnx_sw_state_size_print(size);
...
sh_sand_option_t dnx_swstate_dnx_field_qualifier_layer_record_field_id_size_get_options[] = {
    {NULL}
};


sh_sand_man_t dnx_swstate_dnx_field_qualifier_layer_record_field_id_size_get_man = {
    "swstate size_get",
    "print the variable size",
    "dnx_field_qual_sw_db layer_record field_id size_get",
    "dnx_field_qual_sw_db layer_record field_id size_get",
};
