    ...
    sh_sand_control_t * sand_control)
{
    ...
    SHR_IF_ERR_EXIT(dnx_err_recovery_common_enable_disable_set(unit, TRUE));
    ...
    sh_sand_control_t * sand_control)
{
    ...
    SHR_IF_ERR_EXIT(dnx_err_recovery_common_enable_disable_set(unit, FALSE));
...
/**
 * \brief - start the rollback journal
 */
static shr_error_e
sh_dnx_err_rec_rollback_jrnl_start_cb(
    int unit)
{
    SHR_FUNC_INIT_VARS(unit);
...
/**
 * \brief - stops the rollback journal without rollbacking
 */
static shr_error_e
sh_dnx_err_rec_rollback_jrnl_end_without_rollback_cb(
    int unit)
{
    SHR_FUNC_INIT_VARS(unit);
...
/**
 * \brief - starts the rollback journal and suppresses it
 */
static shr_error_e
sh_dnx_err_rec_rollback_jrnl_start_and_suppress_cb(
    int unit)
{
...
/**
 * \brief - unsuppress rollback journal and end without rollback
 */
static shr_error_e
sh_dnx_err_rec_rollback_jrnl_unsuppress_and_end_cb(
    int unit)
{
...
/**
 * \brief - start the comparison journal
 */
static shr_error_e
sh_dnx_err_rec_comparison_jrnl_start_cb(
    int unit)
{
 ...
 */
static shr_error_e
sh_dnx_err_rec_comparison_jrnl_end_cb(
    int unit)
{
    SHR_FUNC_INIT_VARS(unit);
...
/**
 * \brief - start the comparison journal and suppress it
 */
static shr_error_e
sh_dnx_err_rec_comparison_jrnl_start_and_suppress_cb(
    int unit)
{
    SHR_FUNC_INIT_VARS(unit);
...
/**
 * \brief - unsuppress the comparison journal and then end and compare
 */
static shr_error_e
sh_dnx_err_rec_comparison_jrnl_unsuppress_and_end_and_compare_cb(
    int unit)
{
    SHR_FUNC_INIT_VARS(unit);
...
/**
 * \brief - suppress the comparison journal
 */
static shr_error_e
...
/**
 * \brief - unsuppress the comparison journal
 */
static shr_error_e
...
static sh_sand_man_t sh_dnx_err_rec_rollback_jrnl_start_man = {
    ...
    .deinit_cb = sh_dnx_err_rec_rollback_jrnl_end_without_rollback_cb
};
...
static sh_sand_man_t sh_dnx_err_rec_rollback_jrnl_rollback_man = {
    ...
    .full =
        "Rollback the current rollback journal transaction. All changes during the transaction will be rolled back.",
    .init_cb = sh_dnx_err_rec_rollback_jrnl_start_cb
};
...
static sh_sand_man_t sh_dnx_err_rec_rollback_jrnl_suppress_man = {
    ...
    .init_cb = sh_dnx_err_rec_rollback_jrnl_start_cb,
    .deinit_cb = sh_dnx_err_rec_rollback_jrnl_unsuppress_and_end_cb
};
...
static sh_sand_man_t sh_dnx_err_rec_rollback_jrnl_unsuppress_man = {
    ...
    .init_cb = sh_dnx_err_rec_rollback_jrnl_start_and_suppress_cb,
    .deinit_cb = sh_dnx_err_rec_rollback_jrnl_end_without_rollback_cb
};
...
static sh_sand_man_t sh_dnx_err_rec_comparison_jrnl_start_man = {
    ...
    .deinit_cb = sh_dnx_err_rec_comparison_jrnl_end_cb
};
...
static sh_sand_man_t sh_dnx_err_rec_comparison_jrnl_end_man = {
    ...
    .init_cb = sh_dnx_err_rec_comparison_jrnl_start_cb
};
...
static sh_sand_man_t sh_dnx_err_rec_comparison_jrnl_suppress_man = {
    ...
    .init_cb = sh_dnx_err_rec_comparison_jrnl_start_cb,
    .deinit_cb = sh_dnx_err_rec_comparison_jrnl_unsuppress_and_end_and_compare_cb
};
...
static sh_sand_man_t sh_dnx_err_rec_comparison_jrnl_unsuppress_man = {
    ...
    .init_cb = sh_dnx_err_rec_comparison_jrnl_start_and_suppress_cb,
    .deinit_cb = sh_dnx_err_rec_comparison_jrnl_end_cb
};
