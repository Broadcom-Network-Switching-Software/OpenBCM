        ...
        for (fg_id_iter = 0; fg_id_iter < allocated_fg_iter; fg_id_iter++)
        {
            ...
            DNXCMN_CORES_ITER(unit, BCM_CORE_ALL, core)
            {
                ...
                SHR_IF_ERR_EXIT(dnx_field_tcam_handler_entries_info
                                (unit, core, fg_info->tcam_handler_id, bank_entries_count, banks_bmp_tmp));
                banks_bmp[0] |= banks_bmp_tmp[0];
                ...
                {
                    DIAG_DNX_FIELD_UTILS_STR_INPUT_VERIFY(bank_entries_count_buff, "core_%d: NA", core);
                    sal_snprintf(bank_entries_count_buff_full_line, sizeof(bank_entries_count_buff_full_line),
                                 "core_%d: NA", core);
                }
