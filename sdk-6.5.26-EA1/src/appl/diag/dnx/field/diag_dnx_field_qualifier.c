    ...
    sh_sand_control_t * sand_control)
{
    ...
    RHITERATOR(cs_dnx_dump, cs_dnx_dump_list)
    {
        ...
        rv = dbal_tables_field_size_get(unit, dnx_field_map_stage_info[stage].cs_table_id, cs_dnx_dump->field_id[stage],
        ...
        else
        {
            ...
            {
                const dnx_field_cs_qual_map_t *cs_qual_map_raw_p;
                ...
                if (BCM_TO_DNX_IS_BAISC_OBJ(cs_qual_map_raw_p->flags) &&
