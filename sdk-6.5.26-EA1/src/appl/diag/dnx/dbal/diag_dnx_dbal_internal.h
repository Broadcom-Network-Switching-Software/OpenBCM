 ...
 */
#define DIAG_DBAL_MIN_IN_LIF_TO_ALLOCATE(_unit)  ((dnx_data_lif.in_lif.feature_get(_unit, dnx_data_lif_in_lif_phy_db_dpc)) ? 4002:(30))
...
typedef enum
{
    ...
    LTT_FLAGS_LTT_DYNAMIC = SAL_BIT(11),
    LTT_FLAGS_NOF_FLAGS = SAL_BIT(13)
} dbal_ltt_flags_e;
...
extern uint32 Ltt_timers_group;
extern dbal_ltt_timers_info_t Ltt_timers_info[LTT_NOF_TIMERS];
