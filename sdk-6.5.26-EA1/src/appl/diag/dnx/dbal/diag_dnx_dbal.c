                    ...
                    else
                    {
                        ...
                        for (field_iter = 0; field_iter < table->nof_key_fields; field_iter++)
                        {
                            ...
                            SHR_IF_ERR_EXIT(dbal_field_in_table_printable_string_get
                                            (unit, table->keys_info[field_iter].field_id, 0, table_id, field_val,
...
static sh_sand_man_t dnx_dbal_last_man = {
    ...
    .full =
        "Returns information regarding to the tables that are Suspicious to be hit by the last packet (only applicable for HL tables).",
    .synopsis =
