...
extern rhhandle_t diag_dnx_8_priorities_soc_h[SOC_MAX_NUM_DEVICES];
shr_error_e cmd_dnx_8_priorities_init_cb(
    int unit);

shr_error_e cmd_dnx_8_priorities_deinit_cb(
    int unit);
...
extern sh_sand_cmd_t sh_dnx_scheduler_fsm_count_cmds[];
extern sh_sand_man_t sh_dnx_scheduler_fsm_count_man;
