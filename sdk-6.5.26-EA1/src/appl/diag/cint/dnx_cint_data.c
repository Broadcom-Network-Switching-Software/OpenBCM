...
CINT_FWRAPPER_CREATE_RP2(int, int, 0, 0,
                         ...
                         int, int, unit, 0, 0,
                         int*, int, interval, 1, 0);

static int __macro___SHR_GPORT_FLOW_LIF_VAL_GET (int* _gport)
{
    return  _SHR_GPORT_FLOW_LIF_VAL_GET ( (*_gport) ); 
}

CINT_FWRAPPER_CREATE2_RP1(int, int, 0, 0,
                          __macro___SHR_GPORT_FLOW_LIF_VAL_GET, \
                          int*,int,_gport,1,0,CINT_PARAM_IN);


static int __macro___SHR_GPORT_FLOW_LIF_VAL_GET_ID (int* _gport)
{
...
static cint_function_t __cint_dnx_functions[] = 
    {
        ...
        CINT_FWRAPPER_NENTRY("_SHR_GPORT_FLOW_LIF_VAL_GET", __macro___SHR_GPORT_FLOW_LIF_VAL_GET),
