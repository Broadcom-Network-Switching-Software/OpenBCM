...
typedef enum bcm_policer_action_e {
    ...
    bcmPolicerActionGpStatGroup = 33,   /* Count green colored packets */
    bcmPolicerActionYpStatGroup = 34,   /* Count yellow colored packets */
    bcmPolicerActionRpStatGroup = 35,   /* Count red colored packets */
    bcmPolicerActionGpOpaqueCtrlId = 36, /* Assign Opaque control ID for green
                                           colored packets */
    bcmPolicerActionYpOpaqueCtrlId = 37, /* Assign Opaque control ID for yellow
                                           colored packets */
    bcmPolicerActionRpOpaqueCtrlId = 38, /* Assign Opaque control ID for red
                                           colored packets */
    bcmPolicerActionGpPrioPktNew = 39,  /* Green packet priority from argument0;
                                           param0: New priority. */
    bcmPolicerActionYpPrioPktNew = 40,  /* Yellow packet priority from
                                           argument0; param0: New priority. */
    bcmPolicerActionRpPrioPktNew = 41,  /* Red packet priority from argument0;
                                           param0: New priority. */
    bcmPolicerActionGpOuterVlanCfiNew = 42, /* Green packet 802.1p CFI from arg;
                                           param0: New CFI bit value. */
    bcmPolicerActionYpOuterVlanCfiNew = 43, /* Yellow packet 802.1p CFI from arg;
                                           param0: New CFI bit value. */
    bcmPolicerActionRpOuterVlanCfiNew = 44, /* Red packet 802.1p CFI from arg;
                                           param0: New CFI bit value. */
    bcmPolicerActionGpCosMapNew = 45,   /* Override the default internal
                                           priority to cosq mapping derived in
                                           ingress pipeline using new IFP Cos
                                           Map for Green Packets only. */
    bcmPolicerActionYpCosMapNew = 46,   /* Override the default internal
                                           priority to cosq mapping derived in
                                           ingress pipeline using new IFP Cos
                                           Map for Yellow Packets only. */
    bcmPolicerActionRpCosMapNew = 47,   /* Override the default internal
                                           priority to cosq mapping derived in
                                           ingress pipeline using new IFP Cos
                                           Map for Red Packets only. */
    bcmPolicerActionCount = 48          /* Last value. Not to be used */
...
typedef struct bcm_policer_flexctr_config_s {
    uint32 flexctr_action_id;   /* Flex counter action id. */
    uint32 counter_index;       /* Flex counter index. */
    uint8 color;                /* Flex counter color. */
} bcm_policer_flexctr_config_t;
...
/* Initialize a policer flex counter structure. */
extern void bcm_policer_flexctr_config_t_init(
    bcm_policer_flexctr_config_t *flexctr_cfg);
...
/* Attach a flex counter to the policer action entry. */
extern int bcm_policer_flexctr_attach(
    int unit, 
    bcm_policer_action_id_t action_id, 
    bcm_policer_flexctr_config_t *flexctr_cfg);

/* Detach a flex counter from the policer action entry. */
extern int bcm_policer_flexctr_detach(
    int unit, 
    bcm_policer_action_id_t action_id, 
    bcm_policer_flexctr_config_t *flexctr_cfg);
