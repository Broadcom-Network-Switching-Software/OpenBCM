...
typedef enum bcm_switch_control_e {
    ...
    bcmSwitchEgressUDHBaseFieldCsMap = 1566, /* Map egress UDH base to UDH base CS
                                           var. */
    bcmSwitchStatEgrL3IntfUnderlayPool = 1567, /* Enable different pool for EgrL3Intf
                                           underlay. */
    bcmSwitchEccSingleBitSwCorrectionEvent = 1568, /* Enable/Disable 1bit ECC error
                                           reporting for memories which 1bit
                                           error can be corrected by SW. */
    bcmSwitchL2GlobalStationMode = 1569, /* L2 global station modes. Default is
                                           disable. */
    bcmSwitchHashUseFlowSelEcmpTertiary = 1570, /* Enable/Disable flow based hashing for
                                           tertiary ECMP. */
    bcmSwitchHashUseFlowSelEcmpSecondaryResilientHash = 1571, /* Enable/Disable flow based hashing for
                                           secondary ECMP resilient hashing. */
    bcmSwitchHashUseFlowSelEcmpWeightedSecondary = 1572, /* Enable/Disable flow based hashing for
                                           secondary weighted ECMP. */
    bcmSwitchEcmpTertiaryRandomSeed = 1573, /* Random seed value for tertiary ECMP. */
    bcmSwitchEcmpWeightedOverlayRandomSeed = 1574, /* Random seed value for overlay
                                           weighted ECMP. */
    bcmSwitchEcmpWeightedRandomSeed = 1575, /* Random seed value for weighted ECMP. */
    bcmSwitchEcmpWeightedSecondaryRandomSeed = 1576, /* Random seed value for secondary
                                           weighted ECMP. */
    bcmSwitchHashUseFlowSelL2EcmpSecondary = 1577, /* Enable/Disable L2 traffic flow based
                                           hashing of secondary ECMP. */
    bcmSwitchMacroFlowHashShuffleRandomSeed = 1578, /* Random seed for flow based RTAG7 hash
                                           shuffling. */
    bcmSwitchWideDataExtKeyMode = 1579, /* wide data extension key mode. */
    bcmSwitchEgressFieldCopyToCpuDropEnable = 1580, /* Enable copy to CPU packets drop in
                                           action bcmFieldActionDrop at egress. */
    bcmSwitchSampleEgressFlexRandomSeed = 1581, /* Set sFlow flex RNG seed at egress. */
    bcmSwitchEgressAdaptEnable = 1582,  /* Enable/disable egress adaptation
                                           table lookup. */
    bcmSwitchL3VpbrTunnel = 1583,       /* In case enabled L3 VPBR tunnel can be
                                           used, note: tunnel Termination TCAM
                                           DB is disabled. */
    bcmSwitch__Count = 1584             /* Must be last.  Not a usable value. */
...
#define BCM_SWITCH_CONTROL_STR \
    ...
    "StatEgrL3IntfUnderlayPool", \
    "EccSingleBitSwCorrectionEvent", \
    "L2GlobalStationMode", \
    "HashUseFlowSelEcmpTertiary", \
    "HashUseFlowSelEcmpSecondaryResilientHash", \
    "HashUseFlowSelEcmpWeightedSecondary", \
    "EcmpTertiaryRandomSeed", \
    "EcmpWeightedOverlayRandomSeed", \
    "EcmpWeightedRandomSeed", \
    "EcmpWeightedSecondaryRandomSeed", \
    "HashUseFlowSelL2EcmpSecondary", \
    "MacroFlowHashShuffleRandomSeed", \
    "WideDataExtKeyMode", \
    "EgressFieldCopyToCpuDropEnable", \
    "SampleEgressFlexRandomSeed", \
    "EgressAdaptEnable", \
    "L3VpbrTunnel" 
...
/* SRv6 GSID prefix length used by bcmSwitchSrv6GsidPrefix1/2. */
#define BCM_SWITCH_SRV6_GSID_INVALID        0          /* SRv6 Compressed SID
                                                          type GSID is not
                                                          valid. */
#define BCM_SWITCH_SRV6_GSID_PREFIX_32BIT   1          /* SRv6 GSID prefix
                                                          length 32 bit. */
#define BCM_SWITCH_SRV6_GSID_PREFIX_48BIT   2          /* SRv6 GSID prefix
                                                          length 48 bit. */
#define BCM_SWITCH_SRV6_GSID_PREFIX_56BIT   3          /* SRv6 GSID prefix
                                                          length 56 bit. */
#define BCM_SWITCH_SRV6_GSID_PREFIX_64BIT   4          /* SRv6 GSID prefix
                                                          length 64 bit. */

/* SRv6 USID prefix length used by bcmSwitchSrv6UsidPrefix1/2. */
#define BCM_SWITCH_SRV6_USID_INVALID        0          /* SRv6 Compressed SID
                                                          type USID is not
                                                          valid. */
#define BCM_SWITCH_SRV6_USID_PREFIX_16BIT   1          /* SRv6 USID prefix
                                                          length 16 bit. */
#define BCM_SWITCH_SRV6_USID_PREFIX_32BIT   2          /* SRv6 USID prefix
                                                          length 32 bit. */
#define BCM_SWITCH_SRV6_USID_PREFIX_48BIT   3          /* SRv6 USID prefix
                                                          length 48 bit. */
...
/* Values passed for setting switch control bcmSwitchL2GlobalStationMode. */
typedef enum bcm_switch_l2_global_station_mode_e {
    bcmSwitchL2GlobalStationDisable = 0, /* Disable L2 global station. */
    bcmSwitchL2GlobalStationUnderlayEnable = 1, /* Enable L2 global station for underlay
                                           termination. */
    bcmSwitchL2GlobalStationUnderlayAndOverlayEnable = 2, /* Enable L2 global station for underlay
                                           and overlay termination. */
    bcmSwitchL2GlobalStationModeCount = 3 /* L2 global station mode count. */
} bcm_switch_l2_global_station_mode_t;
...
/* EgrL3Intf underlay pool numbers. */
#define BCM_SWITCH_STAT_EGR_L3_INTF_UNDERLAY_POOL_DEFAULT (0)        
#define BCM_SWITCH_STAT_EGR_L3_INTF_UNDERLAY_POOL_1 (1)        
#define BCM_SWITCH_STAT_EGR_L3_INTF_UNDERLAY_POOL_2 (2)        
#define BCM_SWITCH_STAT_EGR_L3_INTF_UNDERLAY_POOL_3 (3)        
...
/* This enum specify the modes of wide data extension key */
typedef enum bcm_switch_wide_data_extension_key_mode_e {
    bcmSwitchWideDataExtKeyModeByAcLif = 0, /* key by AC global LIF */
    bcmSwitchWideDataExtKeyModeByFirstLif = 1, /* key by first LIF (AC or RIF) */
    bcmSwitchWideDataExtKeyModeByWideData = 2 /* key by wide data value */
} bcm_switch_wide_data_extension_key_mode_t;
...
#define BCM_SWITCH_WIDE_DATA_EXTENSION_REPLACE 0x01       
#define BCM_SWITCH_WIDE_DATA_EXTENSION_GPORT_KEY 0x02       
#define BCM_SWITCH_WIDE_DATA_EXTENSION_INTF_KEY 0x04       

typedef struct bcm_switch_wide_data_extension_info_s {
    uint32 wide_data_key; 
    bcm_gport_t gport_key; 
    bcm_if_t intf_key; 
...
/* OutLIF profile group properties. */
...
/* Get outlif profile group information per outlif profile group */
...
/* Drop reason count in Ingress and Egress pipe line stage. */
#define BCM_MON_DROP_REASON_COUNT   (512)      

/* An enum that represents pipeline stage. */
typedef enum bcm_switch_stat_stage_e {
    bcmSwitchStatStageIngress = 0,  /* Ingress pipeline stage. */
    bcmSwitchStatStageEgress = 1    /* Egress pipeline stage. */
} bcm_switch_stat_stage_t;

/* Represents the drop reason bitmap. */
typedef struct bcm_switch_stat_event_mon_drop_reasons_s {
    SHR_BITDCL rbits[_SHR_BITDCLSIZE(BCM_MON_DROP_REASON_COUNT)]; 
} bcm_switch_stat_event_mon_drop_reasons_t;

/* 
 * Macro to check if a reason (if a reason (bcmDbgCntRx*) /
 * (bcmEgressDropEvent*)) is included in a set of reasons
 * (bcm_stat_event_mon_drop_reasons_t). Returns: zero => reason is not
 * included in the set non-zero => reason is included in the set
 */
#define BCM_MON_DROP_REASON_GET(_drop_reasons, _drop_reason)  \
   SHR_BITGET(((_drop_reasons)->rbits), (_drop_reason)) 

/* 
 * Macro to add a reason (if a reason (bcmDbgCntRx*) /
 * (bcmEgressDropEvent*)) to a set of reasons
 * (bcm_stat_event_mon_drop_reasons_t).
 */
#define BCM_MON_DROP_REASON_SET(_drop_reasons, _drop_reason)  \
   SHR_BITSET(((_drop_reasons)->rbits), (_drop_reason)) 

/* Macro to clear a set of reasons (bcm_stat_event_mon_drop_reasons_t). */
#define BCM_MON_DROP_REASON_CLEAR_ALL(_drop_reasons)  \
   SHR_BITCLR_RANGE(((_drop_reasons)->rbits), 0, BCM_MON_DROP_REASON_COUNT) 

#ifndef BCM_HIDE_DISPATCHABLE

/* Get stat event monitor drop reasons for ingress/egress pipeline. */
extern int bcm_switch_stat_event_mon_drop_reasons_get(
    int unit, 
    bcm_switch_stat_stage_t switch_stage, 
    bcm_switch_stat_event_mon_drop_reasons_t *drop_reasons);

/* Clear the stat event monitor drop reasons for ingress/egress pipeline */
extern int bcm_switch_stat_event_mon_drop_reasons_clear(
    int unit, 
    bcm_switch_stat_stage_t switch_stage, 
    bcm_switch_stat_event_mon_drop_reasons_t *drop_reasons);
