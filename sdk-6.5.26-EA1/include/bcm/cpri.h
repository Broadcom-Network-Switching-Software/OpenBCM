...
/* Configure tgen for port */
extern int bcm_cpri_port_tx_frame_tgen_config_get(
    int unit, 
    bcm_gport_t port, 
    int *enable, 
    bcm_cpri_tx_frame_tgen_config_t *tgen_config);
...
/* Get RSVD4 Rx master frame sync information */
extern int bcm_cpri_port_rsvd4_rx_bfn_sync_config_get(
    int unit, 
    bcm_gport_t port, 
    uint16 *master_frame_count, 
    uint64 *master_frame_start);
...
extern int bcm_cpri_port_rsvd4_rx_control_flow_get(
    int unit, 
    int port, 
    int control_flow_id, 
    bcm_rsvd4_control_flow_config_t *config);
...
extern int bcm_cpri_port_rsvd4_cm_fast_eth_config_get(
    int unit, 
    int port, 
    bcm_rsvd4_fast_eth_config_info_t *config);
...
extern int bcm_cpri_port_rsvd4_tx_control_flow_group_member_get(
    int unit, 
    int port, 
    bcm_rsvd4_control_group_id_t group_num, 
    bcm_rsvd4_priority_t priority, 
...
/*  RSVD4 Control flow configuration */
typedef struct bcm_rsvd4_control_group_entry_s {
    uint32 valid_mask;                  /*  Valid Mask */
    uint32 queue_num[4];                /*  Queue Number */
    bcm_rsvd4_control_msg_proc_type_t type[4]; /*  Control Message Processing Type */
} bcm_rsvd4_control_group_entry_t;

#ifndef BCM_HIDE_DISPATCHABLE

/* Get all control  flow from rsvd4 tx control group. */
extern int bcm_cpri_port_rsvd4_tx_control_flow_group_member_get_all(
    int unit, 
    int port, 
    bcm_rsvd4_control_group_id_t group_num, 
...
extern int bcm_cpri_port_rsvd4_tx_control_flow_get(
    int unit, 
    int port, 
    int control_flow_id, 
    bcm_rsvd4_tx_control_flow_config_t *config);
...
extern int bcm_cpri_port_rsvd4_tx_cm_tunnel_crc_config_get(
    int unit, 
    int port, 
    bcm_rsvd4_cm_tunnel_crc_option_t *crc_option);
...
extern int bcm_cpri_port_rsvd4_tx_cm_hdr_config_entry_get(
    int unit, 
    int port, 
    int index, 
    bcm_rsvd4_tx_cm_hdr_entry_t *entry);
...
/*  rsvd4 tx control message header look up get. */
extern int bcm_cpri_port_rsvd4_tx_cm_hdr_lkup_entry_get(
    int unit, 
    int port, 
    int flow_id, 
    int *header_index);
...
/* Get the tag to flow mapping. */
extern int bcm_cpri_encap_control_queue_tag_to_flow_id_map_get(
    int unit, 
    int port, 
    uint32 tag_id, 
    uint32 *flow_id);
...
/* Get rx default and no match tag. */
extern int bcm_cpri_port_rx_tag_config_get(
    int unit, 
    int port, 
    bcm_cpri_control_tag_config_t *config);
...
/* Get RoE frame format for the port. */
extern int bcm_cpri_port_frame_config_get(
    int unit, 
    bcm_port_t port, 
    bcm_cpri_port_frame_config_t *config);
...
extern int bcm_cpri_port_rx_8b10b_descrambler_enable_set(
    int unit, 
    bcm_gport_t port, 
    int enable);

/* Get Rx 8b10b descrambler enable */
extern int bcm_cpri_port_rx_8b10b_descrambler_enable_get(
    int unit, 
    bcm_gport_t port, 
    int *enable);

/* Set Tx 8b10b scrambler enable */
extern int bcm_cpri_port_tx_8b10b_scrambler_enable_set(
    int unit, 
    bcm_gport_t port, 
    int enable);

/* Get Tx 8b10b scrambler enable */
extern int bcm_cpri_port_tx_8b10b_scrambler_enable_get(
    int unit, 
    bcm_gport_t port, 
    int *enable);

/* Set Tx 8b10b scrambler seed value */
extern int bcm_cpri_port_tx_8b10b_scrambler_seed_set(
    int unit, 
    bcm_gport_t port, 
    uint32 seed_value);

/* Get Tx 8b10b scrambler seed value */
extern int bcm_cpri_port_tx_8b10b_scrambler_seed_get(
    int unit, 
    bcm_gport_t port, 
    uint32 *seed_value);
