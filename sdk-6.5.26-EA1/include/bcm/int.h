...
typedef enum bcm_int_metadata_field_e {
    ...
    bcmIntMetadataIfaLns = 34,          /* IFA Local namespace. */
    bcmIntMetadataCount = 35            /* Always last. Not a usable value. */
...
typedef struct bcm_int_metadata_field_entry_s {
    ...
    uint32 value;                       /* Value to be assigned to the metadata
                                           field. Only applicable to those
                                           fields whose value can be configured. */
