...
typedef enum bcm_cosq_stat_e {
    ...
    bcmCosqStatMaxCount = 134           /* this should be the last one. */
} bcm_cosq_stat_t;
...
typedef enum bcm_cosq_profile_type_e {
    ...
    bcmCosqProfilePfc = 4,              /*  Profile for setting per-PFC priority
                                           ...
                                           configuration. */
    bcmCosqProfileCount = 5             /* This should be the last one */
...
typedef struct bcm_cosq_pfc_monitor_dataset_info_s {
    ...
    uint32 tod;         /* TOD of data set. */
    uint32 identifier;  /*  Hardware identifier of data set. */
