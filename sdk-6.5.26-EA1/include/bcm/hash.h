...
typedef struct bcm_hash_flex_bin_cmd_s {
    ...
    bcm_hash_flex_bin_object_offset_t obj_offset; /* The offset starts from LSB(Least
                                           Significant Bit) of the selected
                                           object. The only exception is
                                           BCM_HASH_OBJ_OUTER_IPV4_HEADER, the
                                           offset starts at the beginning of the
                                           object. */
