...
#define SHR_BFD_CONTROL_HEADER_LENGTH_AUTH   26
...
#define SHR_BFD_IPV4_HEADER_TTL_OFFSET       8
...
#define SHR_BFD_IPV6_HEADER_HOP_LIMIT_OFFSET 7
...
/* VxLAN */
#define SHR_BFD_VXLAN_HEADER_LENGTH          8
#define SHR_BFD_VXLAN_HEADER_VNID_LENGTH     3
#define SHR_BFD_VXLAN_HEADER_VNID_OFFSET     4

/*! VLAN header length. */
#define SHR_BFD_VLAN_HEADER_LENGTH           4
/*! L2 ether type length. */
#define SHR_BFD_L2_ETYPE_LENGTH              2
/*! Ethernet MAC address length. */
#define SHR_BFD_MAC_ADDR_LENGTH              6
