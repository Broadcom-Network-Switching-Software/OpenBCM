...
typedef int (*dnxf_state_info_soft_init_reg_above_64_val_set_cb)(
    int unit, uint32 soft_init_reg_above_64_val_idx_0, uint32 soft_init_reg_above_64_val);


typedef int (*dnxf_state_info_soft_init_reg_above_64_val_get_cb)(
    int unit, uint32 soft_init_reg_above_64_val_idx_0, uint32 *soft_init_reg_above_64_val);


typedef int (*dnxf_state_info_soft_init_reg_above_64_val_alloc_cb)(
...
typedef struct {
    dnxf_state_info_soft_init_reg_above_64_val_set_cb set;
    dnxf_state_info_soft_init_reg_above_64_val_get_cb get;
    dnxf_state_info_soft_init_reg_above_64_val_alloc_cb alloc;
} dnxf_state_info_soft_init_reg_above_64_val_cbs;
...
typedef struct {
    ...
    dnxf_state_info_soft_init_reg_above_64_val_cbs soft_init_reg_above_64_val;
} dnxf_state_info_cbs;
