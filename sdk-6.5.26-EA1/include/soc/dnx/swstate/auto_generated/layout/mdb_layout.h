...
typedef enum
{
    ...
    DNX_SW_STATE_MDB_DB_INFOS__EM_INTERFACE_BLK,
    ...
    DNX_SW_STATE_MDB_DB_INFOS__EM_KEY_FORMAT__FORMAT_COUNT,
    DNX_SW_STATE_MDB_DB_INFOS__EM_KEY_FORMAT__KEY_TO_FORMAT_MAP,
