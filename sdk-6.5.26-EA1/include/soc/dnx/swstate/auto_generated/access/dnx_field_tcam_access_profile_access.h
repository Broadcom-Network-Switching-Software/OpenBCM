...
typedef int (*dnx_field_tcam_access_profile_sw_access_profiles_bank_ids_bmp_set_cb)(
    int unit, uint32 access_profiles_idx_0, uint32 bank_ids_bmp_idx_0, uint16 bank_ids_bmp);
...
typedef int (*dnx_field_tcam_access_profile_sw_access_profiles_bank_ids_bmp_alloc_cb)(
    int unit, uint32 access_profiles_idx_0);
...
typedef struct {
    ...
    dnx_field_tcam_access_profile_sw_access_profiles_bank_ids_bmp_alloc_cb alloc;
