...
typedef int (*dnx_field_flush_sw_flush_profile_is_mapped_set_cb)(
    int unit, uint32 flush_profile_idx_0, uint8 is_mapped);


typedef int (*dnx_field_flush_sw_flush_profile_is_mapped_get_cb)(
    int unit, uint32 flush_profile_idx_0, uint8 *is_mapped);
...
typedef struct {
    dnx_field_flush_sw_flush_profile_is_mapped_set_cb set;
    dnx_field_flush_sw_flush_profile_is_mapped_get_cb get;
} dnx_field_flush_sw_flush_profile_is_mapped_cbs;
...
typedef struct {
    ...
    dnx_field_flush_sw_flush_profile_is_mapped_cbs is_mapped;
