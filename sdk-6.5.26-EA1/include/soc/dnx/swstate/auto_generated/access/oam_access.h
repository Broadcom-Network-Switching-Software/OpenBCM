...
typedef int (*oam_sw_db_info_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_create_empty_cb)(
    int unit, sw_state_ll_init_info_t *init_info);


typedef int (*oam_sw_db_info_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_nof_elements_cb)(
    int unit, uint32 ll_head_index, uint32 *nof_elements);


typedef int (*oam_sw_db_info_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_node_value_cb)(
    int unit, sw_state_ll_node_t node, bcm_oam_endpoint_t *value);


typedef int (*oam_sw_db_info_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_node_update_cb)(
    int unit, sw_state_ll_node_t node, const bcm_oam_endpoint_t *value);


typedef int (*oam_sw_db_info_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_next_node_cb)(
    int unit, uint32 ll_head_index, sw_state_ll_node_t node, sw_state_ll_node_t *next_node);


typedef int (*oam_sw_db_info_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_previous_node_cb)(
    int unit, uint32 ll_head_index, sw_state_ll_node_t node, sw_state_ll_node_t *prev_node);


typedef int (*oam_sw_db_info_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_add_first_cb)(
    int unit, uint32 ll_head_index, const bcm_oam_endpoint_t *value);


typedef int (*oam_sw_db_info_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_add_last_cb)(
    int unit, uint32 ll_head_index, const bcm_oam_endpoint_t *value);


typedef int (*oam_sw_db_info_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_remove_node_cb)(
    int unit, uint32 ll_head_index, sw_state_ll_node_t node);


typedef int (*oam_sw_db_info_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_get_first_cb)(
    int unit, uint32 ll_head_index, sw_state_ll_node_t *node);
...
typedef struct {
    oam_sw_db_info_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_create_empty_cb create_empty;
    oam_sw_db_info_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_nof_elements_cb nof_elements;
    oam_sw_db_info_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_node_value_cb node_value;
    oam_sw_db_info_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_node_update_cb node_update;
    oam_sw_db_info_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_next_node_cb next_node;
    oam_sw_db_info_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_previous_node_cb previous_node;
    oam_sw_db_info_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_add_first_cb add_first;
    oam_sw_db_info_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_add_last_cb add_last;
    oam_sw_db_info_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_remove_node_cb remove_node;
    oam_sw_db_info_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_get_first_cb get_first;
} oam_sw_db_info_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_cbs;
...
typedef struct {
    ...
    oam_sw_db_info_oam_endpoint_sw_db_info_oam_endpoint_array_of_mep_linked_lists_cbs oam_endpoint_array_of_mep_linked_lists;
