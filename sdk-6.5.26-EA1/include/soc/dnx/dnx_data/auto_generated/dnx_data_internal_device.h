...
typedef enum
{
    ...
    dnx_data_device_general_define_nof_dies,
    dnx_data_device_general_define_nof_cores_per_die,
...
uint32 dnx_data_device_general_nof_dies_get(
    int unit);


uint32 dnx_data_device_general_nof_cores_per_die_get(
    int unit);
