...
typedef enum
{
    ...
    dnx_data_field_features_spn_supported,
...
typedef uint32(
    *dnx_data_field_tests_stub_cmodel_supports_semantic_flush_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_field_tests_stub_cmodel_supports_semantic_flush_get_f stub_cmodel_supports_semantic_flush_get;
