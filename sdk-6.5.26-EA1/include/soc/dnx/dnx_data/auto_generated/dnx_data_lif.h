...
typedef uint32(
    *dnx_data_lif_out_lif_max_nof_prp_outlif_profiles_get_f) (
    int unit);


typedef uint32(
    *dnx_data_lif_out_lif_max_prp_outlif_profile_size_get_f) (
    int unit);


typedef uint32(
    *dnx_data_lif_out_lif_nof_prp_outlif_profile_groups_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_lif_out_lif_max_nof_prp_outlif_profiles_get_f max_nof_prp_outlif_profiles_get;
    
    dnx_data_lif_out_lif_max_prp_outlif_profile_size_get_f max_prp_outlif_profile_size_get;
    
    dnx_data_lif_out_lif_nof_prp_outlif_profile_groups_get_f nof_prp_outlif_profile_groups_get;
...
typedef enum
{
    ...
    dnx_data_lif_feature_global_lif_wide_data_ext_key,
