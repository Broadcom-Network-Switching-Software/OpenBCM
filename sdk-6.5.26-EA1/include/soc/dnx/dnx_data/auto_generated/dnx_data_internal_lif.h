...
typedef enum
{
    ...
    dnx_data_lif_out_lif_define_max_nof_prp_outlif_profiles,
    dnx_data_lif_out_lif_define_max_prp_outlif_profile_size,
    dnx_data_lif_out_lif_define_nof_prp_outlif_profile_groups,
...
uint32 dnx_data_lif_out_lif_max_nof_prp_outlif_profiles_get(
    int unit);


uint32 dnx_data_lif_out_lif_max_prp_outlif_profile_size_get(
    int unit);


uint32 dnx_data_lif_out_lif_nof_prp_outlif_profile_groups_get(
    int unit);
