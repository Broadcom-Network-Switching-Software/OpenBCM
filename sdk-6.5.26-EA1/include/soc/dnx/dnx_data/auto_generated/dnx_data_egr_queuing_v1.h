...
typedef uint32(
    *dnx_data_egr_queuing_v1_shaping_max_max_burst_value_get_f) (
    int unit);


typedef uint32(
    *dnx_data_egr_queuing_v1_shaping_max_queue_max_burst_value_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_egr_queuing_v1_shaping_max_max_burst_value_get_f max_max_burst_value_get;
    
    dnx_data_egr_queuing_v1_shaping_max_queue_max_burst_value_get_f max_queue_max_burst_value_get;
