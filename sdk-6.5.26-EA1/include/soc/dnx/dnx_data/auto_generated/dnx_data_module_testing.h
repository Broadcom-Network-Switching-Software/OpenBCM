...
typedef uint32(
    *dnx_data_module_testing_example_tests_default_memory_threshold_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_module_testing_example_tests_default_memory_threshold_get_f default_memory_threshold_get;
