...
typedef enum
{
    ...
    dnx_data_nif_eth_ethu_nof_per_core_in_table,
...
typedef struct
{
    ...
    int dst_block_id;
} dnx_data_nif_framer_b66switch_block_id_t;
...
typedef const dnx_data_nif_framer_b66switch_block_id_t *(
    *dnx_data_nif_framer_b66switch_block_id_get_f) (
    int unit,
    int switch_type,
    int channel);
...
typedef struct
{
    ...
    dnx_data_nif_framer_b66switch_block_id_get_f b66switch_block_id_get;
    
    dnxc_data_table_info_get_f b66switch_block_id_info_get;
...
typedef uint32(
    *dnx_data_nif_mac_client_speed_granularity_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_nif_mac_client_speed_granularity_get_f speed_granularity_get;
...
typedef uint32(
    *dnx_data_nif_sar_client_speed_granularity_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_nif_sar_client_speed_granularity_get_f speed_granularity_get;
...
typedef enum
{
    ...
    dnx_data_nif_signal_quality_is_hw_supported,
