...
typedef enum
{
    ...
    dnx_data_egr_queuing_v1_shaping_define_max_max_burst_value,
    dnx_data_egr_queuing_v1_shaping_define_max_queue_max_burst_value,
...
uint32 dnx_data_egr_queuing_v1_shaping_max_max_burst_value_get(
    int unit);


uint32 dnx_data_egr_queuing_v1_shaping_max_queue_max_burst_value_get(
    int unit);
