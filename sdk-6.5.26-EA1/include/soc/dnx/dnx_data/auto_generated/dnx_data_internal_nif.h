...
typedef enum
{
    ...
    dnx_data_nif_global_define_max_nof_mgmt_ports,
...
uint32 dnx_data_nif_global_max_nof_mgmt_ports_get(
    int unit);
...
typedef enum
{
    dnx_data_nif_framer_table_b66switch_block_id,
...
const dnx_data_nif_framer_b66switch_block_id_t * dnx_data_nif_framer_b66switch_block_id_get(
    int unit,
    int switch_type,
    int channel);
...
shr_error_e dnx_data_nif_framer_b66switch_block_id_entry_str_get(
    int unit,
    char *buffer,
    int key0,
    int key1,
...
const dnxc_data_table_info_t * dnx_data_nif_framer_b66switch_block_id_info_get(
    int unit);
...
typedef enum
{
    ...
    dnx_data_nif_mac_client_define_speed_granularity,
...
uint32 dnx_data_nif_mac_client_speed_granularity_get(
    int unit);
...
typedef enum
{
    ...
    dnx_data_nif_sar_client_define_speed_granularity,
...
uint32 dnx_data_nif_sar_client_speed_granularity_get(
    int unit);
