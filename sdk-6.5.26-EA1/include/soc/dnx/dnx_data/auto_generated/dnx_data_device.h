...
typedef uint32(
    *dnx_data_device_general_nof_dies_get_f) (
    int unit);


typedef uint32(
    *dnx_data_device_general_nof_cores_per_die_get_f) (
    int unit);
...
typedef struct
{
    ...
    dnx_data_device_general_nof_dies_get_f nof_dies_get;
    
    dnx_data_device_general_nof_cores_per_die_get_f nof_cores_per_die_get;
