...
extern pbmp_t soc_property_get_pbmp_default(int unit, const char *name,
                                            pbmp_t def_pbmp);
#if (SRC_SOC_COMMON_ACTIVATE_UNUSED) || defined(BCM_DFE_SUPPORT)
/* { */
...
#if (SRC_SOC_COMMON_ACTIVATE_UNUSED) || defined(BCM_PETRA_SUPPORT) || defined(BCM_DFE_SUPPORT)
/* { */
...
extern char *soc_property_phy_get_str(int unit, soc_port_t port,
                                      ...
                                      const char *name);
#if (SRC_SOC_COMMON_ACTIVATE_UNUSED) || defined(BCM_ESW_SUPPORT) || defined(BCM_PETRA_SUPPORT)
/* { */
...
/* } */
#endif
#if (SRC_SOC_COMMON_ACTIVATE_UNUSED) || defined(BCM_ESW_SUPPORT) || defined(BCM_PETRA_SUPPORT) || defined(BCM_DFE_SUPPORT)
/* { */
...
extern uint32 soc_property_port_suffix_num_get(int unit, soc_port_t port,
                                          ...
                                          const char *suffix, uint32 defl);
#if (SRC_SOC_COMMON_ACTIVATE_UNUSED) || defined(BCM_PETRA_SUPPORT)
/* { */
...
/* } */
#endif
#if (SRC_SOC_COMMON_ACTIVATE_UNUSED) || defined(BCM_PETRA_SUPPORT) || defined(BCM_DDR3_SUPPORT)
/* { */
