...
/* slot mode */
typedef enum tdm_slot_mode_e {
    TDM_SLOT_MODE_ETH = 0,   /* normalize all speed to Ethernet speed (default) */
    TDM_SLOT_MODE_HIGIG = 1, /* normalize all speed to HiGig speed */
    TDM_SLOT_MODE_MIX = 2    /* HiGig speed consumes more slot than Ethernet speed */
} tdm_slot_mode_t;
...
typedef struct _m_tdm_pipe_info_t {
    ...
    int slot_mode; /* difference of number of slots between Ethernet/HiGig speed */
} m_tdm_pipe_info_t;
