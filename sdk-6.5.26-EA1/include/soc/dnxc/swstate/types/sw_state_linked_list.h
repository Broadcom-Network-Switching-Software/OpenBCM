...
#define SW_STATE_MULTIHEAD_LL_DESTROY(node_id, ll) \
    SHR_IF_ERR_EXIT(sw_state_ll_destroy(unit, node_id, &ll))
...
#define SW_STATE_MULTIHEAD_LL_NODE_KEY(node_id, ll, node, value) \
    SHR_IF_ERR_EXIT(sw_state_ll_node_key(unit, node_id, ll, node, key))
...
#define SW_STATE_MULTIHEAD_LL_NEXT_NODE(node_id, ll, ll_index,node, next_node) \
    SHR_IF_ERR_EXIT(sw_state_ll_next_node(unit, node_id, ll, ll_index, node, next_node))

#define SW_STATE_MULTIHEAD_LL_PREVIOUS_NODE(node_id, ll, ll_index,node, prev_node) \
    SHR_IF_ERR_EXIT(sw_state_ll_previous_node(unit, node_id, ll, ll_index, node, prev_node))
...
#define SW_STATE_LL_DESTROY(node_id, ll) \
    SW_STATE_MULTIHEAD_LL_DESTROY(node_id, ll)
...
#define SW_STATE_LL_NEXT_NODE(node_id, ll, node, next_node) \
    SW_STATE_MULTIHEAD_LL_NEXT_NODE(node_id, ll, 0, node, next_node)

#define SW_STATE_LL_PREVIOUS_NODE(node_id, ll, node, prev_node) \
    SW_STATE_MULTIHEAD_LL_PREVIOUS_NODE(node_id, ll, 0, node, prev_node)
