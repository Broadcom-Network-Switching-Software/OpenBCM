...
#define DNXC_SWSTATE_NO_ARRAY {{"", 0, DNXC_SWSTATE_ARRAY_INDEX_INVALID},{"", 0, DNXC_SWSTATE_ARRAY_INDEX_INVALID}, \
{"", 0, DNXC_SWSTATE_ARRAY_INDEX_INVALID}, {"", 0, DNXC_SWSTATE_ARRAY_INDEX_INVALID},{"", 0, DNXC_SWSTATE_ARRAY_INDEX_INVALID}}
...
typedef struct dnxc_sw_state_layout_s
{
    ...
    dnxc_sw_state_layout_node_id_t next_node_index;
...
shr_error_e dnxc_sw_state_layout_get(
    int unit,
    uint32 node_id,
    dnxc_sw_state_layout_t ** node_access_id);
