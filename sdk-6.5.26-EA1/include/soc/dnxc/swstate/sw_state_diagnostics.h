...
#define DNXC_SW_STATE_ALLOC_FUNCTION_CHECK(function) \
    ...
    function == DNX_SW_STATE_DIAG_SEM_CREATE || function == DNX_SW_STATE_DIAG_OCC_BM_CREATE || function == DNX_SW_STATE_DIAG_HTB_CREATE || function == DNX_SW_STATE_DIAG_LL_CREATE || \
...
#define DNX_SW_STATE_DIAG_INFO_POST(unit, node_id, info_struct, node_idx, function, ptr) \
    DNX_SW_STATE_DIAG_INFO_POST_WITH_FLAGS(unit, node_id, info_struct, node_idx, function, ptr, DNXC_SW_STATE_NO_FLAGS)

#define DNX_SW_STATE_DIAG_INFO_POST_WITH_FLAGS(unit, node_id, info_struct, node_idx, function, ptr, flags) \
    do { \
        if ((dnxc_sw_state_diag_is_on(unit) && !sw_state_is_done_init(unit)) && (DNXC_SW_STATE_ALLOC_FUNCTION_CHECK(function))) { \
