...
typedef enum bcm_egress_drop_event_e {
    ...
    bcmEgressDropEventVpPrune = 28,     /* Packets dropped due to enabling
                                           ...
                                           virtual port */
    bcmEgressDropEventCount = 29        /* Must Be Last. Not A Valid Event */
...
typedef enum bcm_pkt_trace_event_e {
    ...
    bcmPktTraceEventIngressEtagDropToCpu = 46, /* Ingress: ETAG drop to CPU */
    bcmPktTraceEventIngressNonEtagDropToCpu = 47, /* Ingress: Non ETAG drop to CPU */
    bcmPktTraceEventIngressExtenderRpfFailToCpu = 48, /* Ingress: Extender RPF fail to CPU */
    bcmPktTraceEventIngressExtenderInterfaceMissToCpu = 49, /* Ingress: Extender Interface miss to
                                           CPU */
    bcmPktTraceEventCount = 50          /* Must Be Last. Not A Valid Event */
...
typedef enum bcm_cosq_drop_reason_e {
    ...
    bcmCosqDropReasonRejectCount = 47 
