...
#define _SHR_MCAST_GPORT_IS_ELEMENT_STATIC(_gport)                                       \
        (_SHR_GPORT_IS_MCAST(_gport) &&                                                 \
        ((((_gport) >> _SHR_MCAST_GPORT_ELEMENT_ID_TYPE_SHIFT) & _SHR_MCAST_GPORT_ELEMENT_ID_MASK) == TRUE))
...
#define _SHR_MCAST_GPORT_ELEMENT_ID_SET(_gport, _mcast_id, is_static)                \
        ((_gport) = (_SHR_GPORT_TYPE_MCAST << _SHR_GPORT_TYPE_SHIFT)  | \
         ...
         (((is_static) & _SHR_MCAST_GPORT_ELEMENT_ID_MASK) << _SHR_MCAST_GPORT_ELEMENT_ID_TYPE_SHIFT)  | \
         (((_mcast_id) & _SHR_MCAST_GPORT_GROUP_ID_MASK) << _SHR_GPORT_MCAST_SHIFT))
