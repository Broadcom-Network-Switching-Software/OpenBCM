...
#define _DNX_ALGO_GET_MACRO(a, b, c, d, e, f, NAME, ...) NAME
#define DNX_ALGO_PORT_TYPE_INCLUDE(...) _DNX_ALGO_GET_MACRO(__VA_ARGS__, _DNX_ALGO_PORT_TYPE_MASK_6, _DNX_ALGO_PORT_TYPE_MASK_5, _DNX_ALGO_PORT_TYPE_MASK_4, _DNX_ALGO_PORT_TYPE_MASK_3, _DNX_ALGO_PORT_TYPE_MASK_2, _DNX_ALGO_PORT_TYPE_MASK_1, dummy)(__VA_ARGS__)
/**
 ...
 *        filter flexe ports if "include_framer"==True
 */
 ...
 */
#define DNX_ALGO_PORT_TYPE_IS_FLEXE_PHY(unit, port_info) (port_info.is_flexe_phy)
/**
 ...
 */
#define DNX_ALGO_PORT_TYPE_IS_FRAMER_MAC(unit, port_info, include_l1, include_stat) \
 ...
 */
#define DNX_ALGO_PORT_TYPE_IS_FRAMER_CLIENT(unit, port_info) (port_info.is_framer_client)
/**
