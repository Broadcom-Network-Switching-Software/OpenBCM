...
#define SOURCE_ADDRESS_TABLE_DEFAULT_PROFILE 0
...
/** 
 * \brief Identifier of the entry address type.
 *  Each address type takes a different number of profiles in source_address manager.
 *  Dnxdata table is used to map between the address type and the number of profiles taken.
 */
typedef enum
{
    /*
     ...
     */
    source_address_type_default = 0,
    /*
     * mac_prefix address type takes 2 entries in the table
     */
    source_address_type_mac_prefix = 1,
    /*
     * ipv4 address type takes 1 entries in the table
     */
    source_address_type_ipv4 = 2,
    /*
     * ipv6 address type takes 4 entries in the table
     */
    source_address_type_ipv6 = 3,
    /*
     * mac_dual_homing address type takes 2 entries in the table and it is valid only in case custom_sa_use_dual_homing 
     * exists
     */
    source_address_type_mac_dual_homing = 4,
    /*
     * mac_prefix address type takes 2 entries in the table
     */
    source_address_type_full_mac = 5,
    /*
     * The total number of address types used by source_address_map table
     */
    source_address_type_count = 6
