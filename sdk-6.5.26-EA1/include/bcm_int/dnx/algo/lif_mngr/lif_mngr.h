...
#define DNX_ALGO_LIF_MNGR_LOCAL_OUTLIF_UPDATE_DATA_ENTRY_HW               SAL_BIT(19)

#define DNX_ALGO_LIF_MNGR_LOCAL_OUTLIF_FORCE_NEW_BANK_ALLOCATION           SAL_BIT(20)

#define DNX_ALGO_LIF_MNGR_LOCAL_OUTLIF_FORCE_DATA_IN_EEDB_BANKS            SAL_BIT(21)

#define DNX_ALGO_LIF_MNGR_LOCAL_OUTLIF_DONT_ALLOCATE_NEW_BANK               SAL_BIT(22)

#define DNX_ALGO_LIF_MNGR_LOCAL_OUTLIF_REPLACE                              SAL_BIT(23)

#define DNX_ALGO_LIF_MNGR_LOCAL_OUTLIF_RESERVE                              SAL_BIT(24)

#define DNX_ALGO_LIF_MNGR_LOCAL_OUTLIF_FORCE_LINKED_LIST               SAL_BIT(25)

#define DNX_ALGO_LIF_MNGR_LOCAL_OUTLIF_NO_LINKED_LIST               SAL_BIT(26)

#define DNX_ALGO_LIF_MNGR_LOCAL_OUTLIF_IGNORE_PHASE_ALLOC_MISMATCH                 SAL_BIT(27)

#define DNX_ALGO_LIF_MNGR_LOCAL_OUTLIF_WITH_ID               SAL_BIT(28)

#define DNX_ALGO_LIF_MNGR_LOCAL_OUTLIF_RES_IGNORE_TAG               SAL_BIT(29)

#define DNX_ALGO_LIF_MNGR_LOCAL_OUTLIF_DONT_UPDATE_HW               SAL_BIT(30)

#define DNX_ALGO_LIF_MNGR_LOCAL_OUTLIF_REPLACE_ALLOW_LL_MISMIATCH               SAL_BIT(31)
