...
/**
 * implemented by: dnx_crps_db_proc_interface_mode_get
 */
...
/**
 * This structure holds the access functions for the variable counter_size
 */
typedef struct {
...
typedef struct {
    ...
    /**
     * Access struct for counter_size
     */
