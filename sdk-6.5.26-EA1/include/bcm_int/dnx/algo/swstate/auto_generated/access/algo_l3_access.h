...
/**
 * implemented by: algo_l3_db_rif_alloc_intf_rif_res_mngr_get_next
 */
...
/**
 * implemented by: algo_l3_db_ipv6_msb32_compress_ref_get
 */
typedef int (*algo_l3_db_ipv6_msb32_compress_ref_get_cb)(
    int unit, uint32 ipv6_msb32_compress_ref_idx_0, uint32 *ipv6_msb32_compress_ref);

/**
 * implemented by: algo_l3_db_ipv6_msb32_compress_ref_alloc
 */
...
/**
 * This structure holds the access functions for the variable mac_compress_id_bitmap
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable mac_compress_t
 */
typedef struct {
    /**
     * Access struct for mac_compress_id_bitmap
     */
    algo_l3_db_mac_compress_id_alloc_mac_compress_id_bitmap_cbs mac_compress_id_bitmap;
} algo_l3_db_mac_compress_id_alloc_cbs;

/**
 * This structure holds the access functions for the variable ipv6_msb32_compress_id_bitmap
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable ipv6_msb32_compress_t
 */
typedef struct {
    /**
     * Access struct for ipv6_msb32_compress_id_bitmap
     */
...
/**
 * This structure holds the access functions for the variable mac_compress_ref
 */
typedef struct {
...
/**
 * This structure holds the access functions for the variable ipv6_msb32_compress_ref
 */
typedef struct {
