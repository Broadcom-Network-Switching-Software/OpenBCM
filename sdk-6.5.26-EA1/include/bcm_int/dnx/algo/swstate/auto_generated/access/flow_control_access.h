...
/**
 * implemented by: flow_control_db_rmc_thresholds_set
 */
typedef int (*flow_control_db_rmc_thresholds_set_cb)(
    int unit, dnx_algo_template_t rmc_thresholds);

/**
 * implemented by: flow_control_db_rmc_thresholds_get
 */
typedef int (*flow_control_db_rmc_thresholds_get_cb)(
    int unit, dnx_algo_template_t *rmc_thresholds);

/**
 * implemented by: flow_control_db_rmc_thresholds_create
 */
typedef int (*flow_control_db_rmc_thresholds_create_cb)(
    int unit, dnx_algo_template_create_data_t * data, void *extra_arguments);

/**
 * implemented by: flow_control_db_rmc_thresholds_allocate_single
 */
...
/**
 * implemented by: flow_control_db_rmc_thresholds_free_single
 */
typedef int (*flow_control_db_rmc_thresholds_free_single_cb)(
    int unit, int profile, uint8 *last_reference);

/**
 * implemented by: flow_control_db_rmc_thresholds_exchange
 */
typedef int (*flow_control_db_rmc_thresholds_exchange_cb)(
    int unit, uint32 flags, const dnx_rmc_thresholds_t *profile_data, int old_profile, const void *extra_arguments, int *new_profile, uint8 *first_reference, uint8 *last_reference);

/**
 * implemented by: flow_control_db_rmc_thresholds_replace_data
 */
...
/**
 * implemented by: flow_control_db_rmc_thresholds_profile_data_get
 */
...
/**
 * This structure holds the access functions for the variable rmc_thresholds
 */
typedef struct {
...
typedef struct {
    ...
    /**
     * Access struct for rmc_thresholds
     */
