...
/**
 * \brief - Exit with error if provided value is not compatible to the field size after
 *          factoring in 2 complements format of the number.
 *
 * \param [in] unit - unit index
 * \param [in] table_id - dbal table ID
 ...
 *   * None
 */
shr_error_e dnx_cosq_dbal_2_complement_field_value_check(
    int unit,
    dbal_tables_e table_id,
