 ...
 * \param [out] offset_p - bcm_cos_queue_t. This procedure loads pointed memory by priority assigned to outgoing traffic. Must be between 0 and DNX_EGR_NOF_Q_PRIO-1 (7).
 * \return
 *   If zero (_SHR_E_NONE), then no error was encountered.
 *   Otherwise, see shr_error_e
 * \remark
