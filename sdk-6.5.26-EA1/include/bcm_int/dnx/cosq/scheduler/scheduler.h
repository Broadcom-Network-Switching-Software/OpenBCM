...
#define DNX_SCH_QUARTET_GROUP_INDEX_FROM_REGION_INDEX_GET(region_index) ((region_index)/dnx_data_sch.flow.nof_regions_in_quartet_order_group_get(unit))
#define DNX_SCH_QUARTET_GROUP_INDEX_FROM_FLOW_INDEX_GET(flow_id) ((flow_id)/dnx_data_sch.flow.nof_flows_in_quartet_order_group_get(unit))
...
typedef enum
{
     ...
     * 2P Shared shaper
     */
    DNX_SCH_ALLOC_FLOW_TYPE_SHARED_SE_2,
    /*
     * 4P Shared shaper 
     */
...
typedef enum
{
    DNX_SCHEDULER_SHARED_SHAPER_ORDER_NONE = -1,
    DNX_SCHEDULER_SHARED_SHAPER_ORDER_CL_FQ,
    DNX_SCHEDULER_SHARED_SHAPER_ORDER_CL_CL,
    DNX_SCHEDULER_SHARED_SHAPER_ORDER_FQ_CL,
    DNX_SCHEDULER_SHARED_SHAPER_ORDER_CL_FQ_FQ_FQ,
    DNX_SCHEDULER_SHARED_SHAPER_ORDER_CL_FQ_CL_FQ,
    DNX_SCHEDULER_SHARED_SHAPER_ORDER_CL_CL_FQ_FQ,
    DNX_SCHEDULER_SHARED_SHAPER_ORDER_CL_FQ_FQ_CL,
    DNX_SCHEDULER_SHARED_SHAPER_ORDER_FQ_CL_FQ_CL,
    DNX_SCHEDULER_SHARED_SHAPER_ORDER_FQ_FQ_CL_CL,
    DNX_SCHEDULER_SHARED_SHAPER_ORDER_FQ_CL_CL_FQ,
    DNX_SCHEDULER_SHARED_SHAPER_ORDER_NOF
} dnx_scheduler_shared_shaper_order_t;

typedef enum
{
    DNX_SCH_FLOW_QUARTET_TYPE_INVALID = -1,
    DNX_SCH_FLOW_QUARTET_TYPE_CL_FQ_FQ_FQ = 0,
    DNX_SCH_FLOW_QUARTET_TYPE_CL_FQ_CL_FQ,
    DNX_SCH_FLOW_QUARTET_TYPE_CL_CL_FQ_FQ,
    DNX_SCH_FLOW_QUARTET_TYPE_CL_FQ_FQ_CL,
    DNX_SCH_FLOW_QUARTET_TYPE_FQ_CL_FQ_CL,
    DNX_SCH_FLOW_QUARTET_TYPE_FQ_FQ_CL_CL,
    DNX_SCH_FLOW_QUARTET_TYPE_FQ_CL_CL_FQ,
    DNX_SCH_FLOW_QUARTET_TYPE_NOF
} dnx_sch_flow_quartet_type_e;

typedef enum
{
    DNX_SCHEDULER_PORT_PRIORITY_PROPAGATION_NONE = 0,
    DNX_SCHEDULER_PORT_PRIORITY_PROPAGATION_V1,
    DNX_SCHEDULER_PORT_PRIORITY_PROPAGATION_V2
} dnx_scheduler_port_priority_propagation_version_t;
 ...
 */
shr_error_e dnx_scheduler_region_is_enhanced_cl_compact_get(
    int unit,
    int core,
    int region_index,
 ...
 */
shr_error_e dnx_scheduler_element_gport_allocate(
    int unit,
    uint32 flags,
 ...
 */
shr_error_e dnx_scheduler_is_voq_connector_virtual(
    int unit,
