...
/* MACT Payload is MSB aligned in the entry, and is adjusted to 6b VMV
 * | 6b VMV | Payload type(6b) | 21b Dst |  2b Learn Strength | 4b Entry Grouping | 1b Age_Profile | 22b OutLif
 */
#define MACT_ENTRY_OUTLIF_OFFSET_LEARN_RES_OPT       (MACT_ENTRY_SIZE - 6 - 6 - 21 - 2 - 4 - 1 - 22)
