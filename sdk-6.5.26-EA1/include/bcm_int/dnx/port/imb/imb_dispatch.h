...
typedef int (
    *__dispatch__imb_instru_synced_counters_config_set_f) (
    ...
    uint8 is_continuous);
typedef int (
    *__dispatch__imb_instru_sunced_counters_config_get_f) (
    int unit,
    int imb_id,
    uint8 *nof_intervals,
    uint8 *is_continuous);
...
typedef int (
    *__dispatch__imb_port_l1_eth_transcode_set_f) (
    int unit,
    bcm_port_t port,
    int is_rx,
...
typedef struct __imb__dispatch__s__
{
    ...
    __dispatch__imb_instru_sunced_counters_config_get_f f_imb_instru_sunced_counters_config_get;
    ...
    __dispatch__imb_port_l1_eth_transcode_set_f f_imb_port_l1_eth_transcode_set;
