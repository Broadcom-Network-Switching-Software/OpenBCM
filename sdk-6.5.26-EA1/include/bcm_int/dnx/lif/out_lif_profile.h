...
#define DNX_OUT_LIF_PROFILE_DEFAULT_ORIENTATION_PROFILE (dnx_data_lif.out_lif.etpp_out_lif_profile_default_orientation_profile_get(unit))
/**
 * Specify default ETPP Port out_lif profile
 */
#define DNX_OUT_LIF_PROFILE_DEFAULT_PORT_PROFILE (dnx_data_lif.out_lif.etpp_out_lif_profile_default_port_profile_get(unit))
/**
 * Specify default ETPP MPLS out_lif profile
 */
#define DNX_OUT_LIF_PROFILE_DEFAULT_MPLS_PROFILE (dnx_data_lif.out_lif.etpp_out_lif_profile_default_mpls_profile_get(unit))
/**
