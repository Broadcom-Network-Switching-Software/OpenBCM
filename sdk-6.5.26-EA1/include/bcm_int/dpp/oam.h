...
#define _BCM_OAM_EVENT_DATA_WORDS_MAX 8 
...
#define _BCM_OAM_GROUP_MAID_IS_EXTRA_DATA(flags) \
...
typedef enum _bcm_oam_ma_name_type_e{
    ...
    _BCM_OAM_MA_NAME_TYPE_STRING_20_BYTE,
...
int bcm_petra_oam_endpoint_action_set_internal(
    ...
    int is_loss_unset /* 1 - loss delete */);
