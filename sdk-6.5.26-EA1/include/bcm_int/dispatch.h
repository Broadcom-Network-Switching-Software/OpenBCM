...
typedef struct {
	...
	int (*field_qualify_RangeCheckGroup)(int,bcm_field_entry_t,uint32,uint32);
	int (*field_qualify_RangeCheckGroup_get)(int,bcm_field_entry_t,uint32 *,uint32 *);
	...
	int (*policer_flexctr_attach)(int,bcm_policer_action_id_t,bcm_policer_flexctr_config_t *);
	/* bcm_policer_flexctr_config_t_init not dispatchable */
	int (*policer_flexctr_detach)(int,bcm_policer_action_id_t,bcm_policer_flexctr_config_t *);
