 ...
 */
#define LSM_OPERATOR_MAX_STRING_SIZE 3
/**
 * \brief
 ...
 */
#define LSM_MAX_ACTION_BUFFER 300
/**
 * \brief
 ...
 */
#define MAX_NOF_ACTIONS_ENTRIES 1024
/**
 * \brief
...
/**
 * \brief
 *  max number charecters in "lsm show action" diagnostic in the key column
 */
...
typedef enum
{
    ...
    /**
     * an lsm qualifier that is a signal in the device
     */
    lsm_qualifier_signal = lsm_qualifier_first,
    /**
     * an lsm qualifier that is a register in the device
     */
...
appl_ref_lsm_db_interrupt_table_update(
    int unit,
    uint32 nof_interrupts,
    lsm_init_interrupt_t * interrept);
